...
public class tin
  implements ComponentConstant.Event, rxl, tib, tif, tim
{
  private int a;
  ...
  public tin(Activity paramActivity, tia paramtia, VVideoView paramVVideoView, ViolaInstance paramViolaInstance)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewVideoPlayManager.a(paramtia);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewVideoPlayManager.a(this);
    this.jdField_a_of_type_Tia = paramtia;
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewVVideoView = paramVVideoView;
    this.jdField_a_of_type_Tia.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewVideoPlayManager);
    this.jdField_a_of_type_Tia.setEventListener(this);
  ...
  {
    boolean bool = false;
    this.jdField_a_of_type_Tia.a(0, paramBoolean);
    try
    {
  ...
  public void a(VVideoView paramVVideoView, JSONObject paramJSONObject)
  {
    ...
    paramVVideoView = this.jdField_a_of_type_Tia.a();
    try
    {
      paramVVideoView = new til(paramVVideoView, paramJSONObject);
      if (paramVVideoView != null)
      {
        ...
        if (paramVVideoView.b)
        {
          ...
          this.jdField_a_of_type_Tia.a(paramVVideoView);
        }
      }
      else
      {
  ...
  public void a(til paramtil, long paramLong)
  {
    ...
    {
      paramtil = new JSONObject();
      paramtil.put("currentTime", a(paramLong));
      paramtil.put("totalTime", this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewVideoPlayManager.a() / 1000L);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewVVideoView.a("playTimeChange", paramtil);
      return;
    }
    catch (Exception paramtil)
    {
      paramtil.printStackTrace();
    }
  }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Tia.a();
  }
  ...
  public void b(VVideoView paramVVideoView, int paramInt)
  {
    ...
    this.jdField_a_of_type_Tia.setControlType(this.jdField_a_of_type_Int);
  }
  ...
  {
    boolean bool = true;
    this.jdField_a_of_type_Tia.a(1);
    try
    {
      paramVVideoView = new JSONObject();
      if (this.jdField_a_of_type_Int == 2) {}
  ...
  {
    this.jdField_a_of_type_Tia.setFullScreenDisable(paramBoolean);
  }
  ...
  {
    this.jdField_a_of_type_Tia.setEndWithLastFrame(paramBoolean);
  }
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_Tia != null) {
