      ...
      for (;;)
      {
        ...
        if ("getCache".equals(paramString))
        {
          try
          {
            ...
            rtb.a().a(paramJSONObject.getString("url"), paramJSONObject.toString(), new thf(paramOnInovkeCallback));
            return;
          }
          catch (JSONException paramString)
          {
        ...
        else if ("writeCache".equals(paramString))
        {
          try
          {
            ...
            {
              paramJSONObject.put("callid", 0);
              rtb.a().a(paramJSONObject.getString("url"), paramJSONObject.toString(), null, paramJSONObject);
              return;
            }
          }
          catch (JSONException paramString)
