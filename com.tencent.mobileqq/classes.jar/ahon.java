...
public class ahon
  extends alwx
{
  public ahon(NotificationView paramNotificationView) {}
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, List<MessageRecord> paramList)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if (this.a.jdField_a_of_type_Ahoi != null)
          {
            this.a.jdField_a_of_type_Ahoi.a(this.a.jdField_a_of_type_JavaUtilList);
            ...
            if (this.a.b)
            {
              ...
              this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().d(alof.W, 9000, 0 - bafj.a().a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
              bafj.a().a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0);
    ...
    paramList = this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131720546);
