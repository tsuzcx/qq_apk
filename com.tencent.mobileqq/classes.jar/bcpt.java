  ...
  implements Manager
{
  ...
  public ArrayList<bcpu> a;
  protected Queue<String> a;
  
  static
  {
    jdField_a_of_type_JavaLangString = "<{text:'A',action:'',url:'',url_p:'schemel://xxx',actionData:'action:xxxx',actionData_i:'',actionData_a:''}>" + alud.a(2131716186) + "<{text:'B',action:'',url:'',url_p:'schemel://xxx',actionData:'action:xxxx',actionData_i:'',actionData_a:''}>" + alud.a(2131716187) + "<{icon:'/rose',url:'url.qq.com?rose.png',alt:'玫瑰'}>";
  ...
  private void a(GroupOpenSysMsg.SysMsgBody paramSysMsgBody, TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    {
      MessageForArkApp localMessageForArkApp = (MessageForArkApp)azaf.a(-5008);
      ...
      if (paramSysMsgBody.sender.has())
      {
        ...
        localMessageForArkApp.saveExtInfoToExtStr("troop_msg_nick_color", String.valueOf(BaseApplication.getContext().getResources().getColor(2131166927)));
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    boolean bool = localawgf.a(TroopTipsEntity.class.getSimpleName(), localContentValues, "troopUin=? and msgSeq=?", new String[] { paramString1, paramString2 });
    localawgf.a();
    if (bool)
    {
  ...
  public MessageForGrayTips a(TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    do
    {
      ...
      } while (alww.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForGrayTips, false));
  ...
  public MessageRecord a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, int paramInt, long paramLong, boolean paramBoolean1, boolean paramBoolean2, absz paramabsz)
  {
    ...
    do
    {
        ...
        try
        {
          ...
          case 1: 
            if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_redtips.has())
            {
              ...
              {
                a(new bcpu(this, ((TroopTipsEntity)localObject2).troopUin, paramArrayOfByte));
                return null;
              }
              ((TroopTipsEntity)localObject2).currentUin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
              paramQQAppInterface = (MessageForQQWalletTips)azaf.a(-2029);
              ...
              paramQQAppInterface.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), ((TroopTipsEntity)localObject2).troopUin, "", "[QQWallet Tips]", ayzl.a(), -2029, 1, ayzl.a());
            ...
            if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_graytips.uint32_robot_group_opt.has())
            {
              ...
              paramArrayOfByte = (bcpg)paramQQAppInterface.getManager(203);
            }
            ...
            if (j == 3)
            {
              bckt.a(paramQQAppInterface, (TroopTipsEntity)localObject2);
              return null;
            }
            if ((j == 6) && (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_graytips.uint64_receiver_uin.has()))
            {
              ...
              {
                bbtx.a().a(String.valueOf(l1), paramQQAppInterface.getCurrentAccountUin(), true);
                ((amdu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(l1, paramLong);
              }
            }
            for (;;)
            {
              ...
              if ((paramBoolean1) || (!alww.a(paramQQAppInterface, paramArrayOfByte, false))) {
                break label1231;
              }
              return null;
              if (j != 11) {
      ...
      bcpx.a(l1, paramQQAppInterface, paramLong);
      return null;
    ...
    if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_group_notify.has())
    {
      ...
      paramArrayOfByte = ((auga)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(Long.valueOf(l1), true);
      if ((paramArrayOfByte != null) && (1 == paramQQAppInterface.opt_uint32_auto_pull_flag.get()))
      {
        ...
        ((amdu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).notifyUI(67, true, new Object[] { String.valueOf(l1), paramQQAppInterface.opt_bytes_feeds_id.get().toStringUtf8(), Integer.valueOf(paramQQAppInterface.opt_uint32_auto_pull_flag.get()) });
        break label3393;
        if (!paramBoolean2)
        {
          if (paramabsz != null) {
          ...
          {
            paramabsz = (TroopTips0x857.MessageRecallReminder)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_recall.get();
            paramLong = paramabsz.uint64_uin.get();
            paramInt = paramabsz.uint32_op_type.get();
            paramQQAppInterface = new HashMap();
            try
            {
              paramArrayOfByte = new msgrevoke_userdef.MsgInfoUserDef();
              paramArrayOfByte.mergeFrom(paramabsz.bytes_userdef.get().toByteArray());
            ...
            paramabsz = ((ArrayList)paramabsz.uint32_recalled_msg_list.get()).iterator();
            while (paramabsz.hasNext())
            {
              localObject2 = (TroopTips0x857.MessageRecallReminder.MessageMeta)paramabsz.next();
            ...
            {
              paramabsz = (TroopTips0x857.NotifyObjmsgUpdate)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_objmsg_update.get();
              if (paramabsz.bytes_ext_msg.has())
              {
                paramArrayOfByte = new SubMsgType0xaa.MsgBody();
                try
                {
                  paramArrayOfByte.mergeFrom(paramabsz.bytes_ext_msg.get().toByteArray());
                  ((aspf)paramQQAppInterface.getManager(156)).a(paramArrayOfByte, false);
                }
                catch (Exception paramabsz)
                {
                  for (;;)
                  {
                    if (QLog.isColorLevel()) {
                ...
                if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_werewolf_push.has())
                {
                  ...
                  ((bema)paramQQAppInterface.a(107)).a((TroopTips0x857.WereWolfPush)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_werewolf_push.get(), paramArrayOfByte);
                  break label3393;
                  if (QLog.isColorLevel()) {
                  ...
                  if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_stcm_game_state.has())
                  {
                    ...
                    {
                      ((aknt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211)).a(0, 1, Long.toString(l1), paramQQAppInterface);
                      break label3393;
                      if (QLog.isColorLevel()) {
                      ...
                      if (((TroopTips0x857.NotifyMsgBody)localObject1).apllo_msg_push.has())
                      {
                        ...
                        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
                        {
                          ((akos)paramQQAppInterface.getManager(227)).a(1, paramArrayOfByte);
                          break label3393;
                          if (QLog.isColorLevel()) {
                          ...
                          if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_goldtips.has())
                          {
                            ...
                            {
                              aizw.a(1, (TroopTips0x857.GoldMsgTipsElem)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_goldtips.get(), null);
                              break label3393;
                              if (QLog.isColorLevel()) {
                              ...
                              if (paramBoolean1)
                              {
                                ...
                                {
                                  ((amdu)paramQQAppInterface.a(20)).a(String.valueOf(l1), false, "", false, true, false, true);
                                  break label3393;
                                  if (QLog.isColorLevel()) {
                                  ...
                                  {
                                    baic.a(paramQQAppInterface, (TroopTips0x857.TroopFormGrayTipsInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_troopformtips_push.get(), ((TroopTipsEntity)localObject2).troopUin);
                                    break label3393;
                                    if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_media_push.has())
                                    {
                                      atmp.a(paramQQAppInterface, paramInt, paramLong, (TroopTips0x857.MediaChangePushInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_media_push.get());
                                    }
                                    else
                                    {
                                      ...
                                      if (paramBoolean1)
                                      {
                                        try
                                        {
                                          paramabsz = (TroopTips0x857.GeneralGrayTipInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_general_gray_tip.get();
                                          if (paramabsz.uint64_busi_type.has())
                                          {
                                            l1 = paramabsz.uint64_busi_type.get();
                                            if (!paramabsz.uint64_busi_id.has()) {
                                              break label2838;
                                            }
                                            l2 = paramabsz.uint64_busi_id.get();
                                            if (!paramabsz.uint32_ctrl_flag.has()) {
                                              break label2844;
                                            }
                                            paramInt = paramabsz.uint32_ctrl_flag.get();
                                            if (paramabsz.uint32_c2c_type.has()) {
                                              paramabsz.uint32_c2c_type.get();
                                            }
                                            if (paramabsz.uint32_service_type.has()) {
                                              paramabsz.uint32_service_type.get();
                                            }
                                            if (!paramabsz.bytes_pb_reserv.has()) {
                                              break label2849;
                                            }
                                            paramArrayOfByte = paramabsz.bytes_pb_reserv.get().toByteArray();
                                            if (!paramabsz.bytes_content.has()) {
                                              break label2854;
                                            }
                                            paramabsz = paramabsz.bytes_content.get().toByteArray();
                                            localObject1 = "";
                                            if ((paramabsz == null) || (paramabsz.length <= 0)) {
                                              break label2860;
                                            }
                                            paramabsz = new String(paramabsz, "utf-8");
                                            paramInt = aspz.a(paramInt);
                                            paramArrayOfByte = aspz.a(paramQQAppInterface, ((TroopTipsEntity)localObject2).troopUin, 1, paramInt, paramLong, paramabsz, l1, l2, paramArrayOfByte);
                                            if (paramArrayOfByte == null) {
                                              break label3393;
                                            }
                                            ...
                                            paramArrayOfByte.saveExtInfoToExtStr("bytes_content", paramabsz);
                                            azqs.b(paramQQAppInterface, "CliOper", "", "", "0X800A560", "0X800A560", 3, 0, "" + l2, "" + l1, "", "");
                                            aspz.a(paramQQAppInterface, paramArrayOfByte);
                                          }
                                        }
                                      ...
                                      else
                                      {
                                        ...
                                        {
                                          paramArrayOfByte = ((baph)paramQQAppInterface.getManager(339)).a(2);
                                          if (paramArrayOfByte != null) {
                                        ...
                                        else
                                        {
                                          ...
                                          {
                                            paramArrayOfByte = ((baph)paramQQAppInterface.getManager(339)).a(4);
                                            if (paramArrayOfByte != null) {
                                          ...
                                          else
                                          {
                                            ...
                                            if ((paramQQAppInterface != null) && (paramQQAppInterface.uint32_group_honor_switch.has()))
                                            {
                                              ...
                                              paramQQAppInterface = (bcgc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(346);
                                              if (paramInt != 0) {
                                                break label3397;
                                              }
                                              paramBoolean1 = true;
                                              ...
                                              break label3393;
                                              atqk.a(paramQQAppInterface, paramInt, paramLong, (TroopTips0x857.NotifyMsgBody)localObject1);
                                              break label3393;
                                              if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_group_announce_tbc_info.has())
                                              {
                                                paramabsz = (TroopTips0x857.GroupAnnounceTBCInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_group_announce_tbc_info.get();
                                                if (paramabsz != null) {
                                                  if (!paramabsz.feeds_id.has()) {
                                                    break label3406;
                                                  }
                                                }
                                              }
    ...
    label3397:
    label3406:
    for (paramArrayOfByte = paramabsz.feeds_id.get().toStringUtf8();; paramArrayOfByte = null)
    {
      paramLong = paramabsz.group_id.get();
      paramInt = paramabsz.action.get();
      switch (paramInt)
      {
      case 0: 
        bcpa.b(paramQQAppInterface, paramArrayOfByte, String.valueOf(paramLong), 1);
        break;
      case 1: 
      case 2: 
  ...
  public List<TroopTipsEntity> a(String paramString)
  {
    ...
    do
    {
      ...
      paramString = ((awgf)localObject).a(TroopTipsEntity.class, true, "troopUin=? and read=? and currentUin=?", new String[] { paramString, "0", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }, null, null, "time ASC", null);
      ((awgf)localObject).a();
  ...
  public void a(bcpu parambcpu)
  {
    ...
    this.jdField_a_of_type_JavaUtilArrayList.add(parambcpu);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      bcpu localbcpu = (bcpu)localIterator.next();
      TroopTips0x857.RedGrayTipsInfo localRedGrayTipsInfo = localbcpu.jdField_a_of_type_TencentImOidbCmd0x857TroopTips0x857$RedGrayTipsInfo;
      String str = paramQQAppInterface.getCurrentAccountUin();
      MessageForQQWalletTips localMessageForQQWalletTips = (MessageForQQWalletTips)azaf.a(-2029);
      ...
      localMessageForQQWalletTips.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), localbcpu.jdField_a_of_type_JavaLangString, "", "[QQWallet Tips]", ayzl.a(), -2029, 1, ayzl.a());
  ...
  public void a(QQAppInterface paramQQAppInterface, TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    localawgf.a(paramTroopTipsEntity);
    localawgf.a();
  }
  ...
  public void b(QQAppInterface paramQQAppInterface)
  {
    ...
    awgf localawgf = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    Cursor localCursor = localawgf.a(true, TroopTipsEntity.class.getSimpleName(), new String[] { "troopUin" }, "read=?", new String[] { String.valueOf(0) }, "troopUin", null, null, null);
    if (localCursor != null) {}
    for (;;)
    {
      try
