...
public class bcpt
  extends bcpv
{
  private aqwp jdField_a_of_type_Aqwp = new bcpu(this);
  ...
  private Notification a(Intent paramIntent, Bitmap paramBitmap, String paramString1, String paramString2)
  {
    ...
    NotificationCompat.Builder localBuilder = NotificationFactory.createNotificationCompatBuilder("CHANNEL_ID_HIDE_BADGE").setSmallIcon(2130841402).setAutoCancel(true).setOngoing(true).setWhen(System.currentTimeMillis());
  ...
  private Notification a(Intent paramIntent, Bitmap paramBitmap, String paramString1, String paramString2, String paramString3)
  {
    ...
    if ((i >= 512) && (i <= 522))
    {
      ...
      if (antf.u.equals(paramIntent.getStringExtra("uin"))) {
        break label857;
      }
    ...
    for (;;)
    {
      ...
      if ((bool2) && ((k == 1001) || (k == 10002)))
      {
        ...
        if (bhhw.a(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
        {
      ...
      for (;;)
      {
        ...
        if (k == 1030)
        {
          ...
          paramBitmap = bhgm.a(BaseApplication.getContext().getResources(), 2130840347);
        ...
        Bitmap localBitmap = bhgm.a(paramBitmap.getResources(), 2130840347);
  ...
  private void c(ToServiceMsg paramToServiceMsg)
  {
    ...
    Bitmap localBitmap = (Bitmap)paramToServiceMsg.extraData.getParcelable("bitmap");
    boolean bool1 = localIntent.getBooleanExtra("key_notifycation_oneway_message", false);
    Object localObject1;
    int j;
    String str;
    int i;
    ...
    if (!bhvl.e)
    {
      paramToServiceMsg = bhvi.a().a(localIntent, localBitmap, arrayOfString[0], arrayOfString[1], arrayOfString[2], this.c, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      bool2 = SettingCloneUtil.readValue(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), BaseApplication.getContext().getString(2131717560), "qqsetting_notify_showcontent_key", true);
      if (!bool2) {
        break label1259;
      }
      if (j != 1008) {
    ...
    for (;;)
    {
      ...
      else if (j == 1030)
      {
        ...
        Object localObject2 = new bdlg();
        ((bdlg)localObject2).e = "0X800923F";
        ((bdlg)localObject2).d = "Android系统通知曝光";
        if (QLog.isColorLevel()) {
          QLog.d("CampusNoticeManager", 2, new Object[] { "notification url :", localIntent.getStringExtra("url") });
        }
        bdlf.a(localIntent.getStringExtra("url"), (bdlg)localObject2);
        bdlf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (bdlg)localObject2);
        localObject2 = (aqqq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(240);
      ...
      else if ((j == 1035) || (j == 1041) || (j == 1042))
      {
        ...
        axaa.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localIntent.getStringExtra("push_notice_service_id"), localIntent.getStringExtra("push_notice_content_id"), localIntent.getStringExtra("url"), "0X800923F", "Android系统通知曝光");
        if (QLog.isColorLevel()) {
      ...
      else
      {
        if ((j == 0) && (localIntent.getBooleanExtra("key_reactive_push_tip", false))) {
          bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A1BE", "0X800A1BE", 2, 0, "", "", "", "");
        }
        if ((blhw.a(j)) && (blhw.a(str)))
        {
          j = localIntent.getIntExtra("param_notifyid", 0);
          a(275);
  ...
  protected void a()
  {
    ...
    {
      super.a();
      a(new boqd(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new bcue(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new bcqo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new bcrz(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new bcrb(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new bcul());
      bcug localbcug = new bcug();
      a(localbcug);
      localbcug.a(this.jdField_a_of_type_Aqwp);
      a(new bcqi());
      a(new bcuq());
      a(new bcqn());
      ...
      a(new bcqf());
      a(new bcqh());
      a(new nmc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      a(new bcui());
      a(new bcuj());
      a(new bcqe());
      a(new bcuh());
      a(new bcuu(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      super.d();
      return;
    }
    finally
  ...
  {
    awzv.a().a(paramFromServiceMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  
  public void a(ToServiceMsg paramToServiceMsg)
  {
    b(paramToServiceMsg, this.jdField_a_of_type_Aqwp, aqwr.class);
  }
  ...
  protected void a(ToServiceMsg paramToServiceMsg, aqwp paramaqwp, Class<? extends MSFServlet> paramClass)
  {
    ...
    super.a(paramToServiceMsg, paramaqwp, aqwr.class);
  }
  ...
  void a(String paramString1, int paramInt1, Notification paramNotification, String paramString2, int paramInt2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        baou localbaou = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        if (localbaou == null) {
          break label305;
        }
        i = localbaou.a();
      ...
      if (blgq.a(BaseApplicationImpl.getApplication().getApplicationContext())) {
        blgq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), i, paramNotification);
      }
      if (!TextUtils.isEmpty(paramString1))
      {
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Aqwp = null;
    super.c();
  }
}
