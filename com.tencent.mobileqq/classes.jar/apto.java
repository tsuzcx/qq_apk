...
public class apto
{
  ...
  public static void a(Activity paramActivity, File paramFile, String paramString, apts paramapts)
  {
    ...
    if (!paramString.exists()) {
      try
      {
        if (paramString.createNewFile()) {
          b(paramActivity, paramFile, paramString, paramapts);
        }
        return;
      }
      catch (IOException paramFile)
      {
        ...
        apsm.a().a().a("AIOGalleryUtils", 4, "savePic excption = " + paramFile.getMessage());
        return;
      }
    }
    babr.a(paramActivity, 230).setTitle(paramActivity.getString(2131653010)).setMessage(paramActivity.getString(2131629501)).setPositiveButton(paramActivity.getString(2131652888), new aptq(paramActivity, paramFile, paramString, paramapts)).setNegativeButton(paramActivity.getString(2131628983), new aptp()).show();
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, int paramInt, apsr paramapsr, boolean paramBoolean, String paramString3)
  {
    if ((paramapsr == null) || (!AIOPicData.class.isInstance(paramapsr.a))) {
      return;
    }
    bfpy localbfpy = bfpy.a();
    localbfpy.a = paramString1;
    AIOPicData localAIOPicData = (AIOPicData)paramapsr.a;
    paramString1 = localAIOPicData.a;
    if (!paramString1.endsWith("_hd"))
    {
      paramapsr = paramString1 + "_hd";
      if (new File(paramapsr).exists()) {
        paramString1 = paramapsr;
      }
    }
    for (;;)
    {
      paramapsr = localAIOPicData.e;
      long l2 = localAIOPicData.g;
      long l1 = 0L;
      if (paramBoolean) {
        l1 = localAIOPicData.h;
      }
      bfpr.a(paramActivity, localbfpy, paramBoolean, paramString3, paramString2, paramInt, paramString1, paramapsr, l2, l1, -1);
      return;
    }
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, int paramInt1, List<MessageForPic> paramList, int paramInt2)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      i = 1;
      label145:
      paramString1 = axwd.a(localMessageForPic, i, "chatthumb");
      if (paramString1 == null) {
        break label384;
      }
      paramString1 = axoa.d(paramString1.toString());
      if (paramString1 == null) {
        break label366;
      }
    ...
    for (;;)
    {
      ...
      break label112;
      bfpr.a(paramActivity, localbfpy, bool, paramString3, paramString2, paramInt1, localArrayList1, localArrayList2, localArrayList3, localArrayList4, paramInt2);
      return;
    }
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, long paramLong, int paramInt)
  {
    bfpy localbfpy = bfpy.a();
    localbfpy.a = paramString1;
    apsm.a().a().a("AIOGalleryUtils", 4, "fowardToGroupAlbum(),uin:" + paramString1 + " qunId:" + paramString2 + " qunCode:" + paramString3 + " uuid:" + paramString5 + " time:" + paramLong + " path:" + paramInt);
  ...
  public static void a(Activity paramActivity, String paramString, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    bfpr.a(paramActivity, paramString, 0, 0, paramArrayList, paramActivity.getResources().getString(2131652411), paramInt);
  }
  
  private static void b(Activity paramActivity, File paramFile1, File paramFile2, apts paramapts)
  {
    new aptr(paramFile1, paramFile2, paramActivity, paramapts).execute(new Void[0]);
  }
}
