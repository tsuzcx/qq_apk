...
public class lzt
  extends lzk
{
  public lzt(Context paramContext)
  {
    this.jdField_a_of_type_JavaLangString = "SmallScreenVideo";
    this.i = 2131559810;
    this.j = paramContext.getResources().getDimensionPixelSize(2131297913);
    this.k = paramContext.getResources().getDimensionPixelSize(2131297905);
  }
  
  private void a(int paramInt)
  {
    Object localObject = this.jdField_a_of_type_Lzq.a;
    WindowManager.LayoutParams localLayoutParams = this.jdField_a_of_type_Lzq.a();
  ...
  {
    if ((paramBoolean) && (!this.jdField_a_of_type_Lzq.b())) {
      a(paramInt);
    }
