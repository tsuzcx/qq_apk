...
public class nbn
  extends ysc
{
  public nbn(ReadInJoyNativeAdAppContentView paramReadInJoyNativeAdAppContentView, Context paramContext, Activity paramActivity, Intent paramIntent, AppInterface paramAppInterface)
  {
  ...
  {
    paramWebView = this.a.findViewById(2131297114);
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    } while (!mkw.a().a(paramWebView.getUrl(), (String)localObject).booleanValue());
