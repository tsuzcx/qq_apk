...
public class nbn
{
  ...
  public void a()
  {
    this.jdField_a_of_type_Nbq = null;
  ...
  public void a(android.content.Intent paramIntent, com.tencent.qphone.base.remote.FromServiceMsg paramFromServiceMsg)
  {
    ...
    //   89: astore_1
    //   90: aload_0
    //   91: getfield 40	nbn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   94: ifnonnull +14 -> 108
    //   97: aload_0
    //   98: new 42	java/util/ArrayList
    //   101: dup
    //   102: invokespecial 101	java/util/ArrayList:<init>	()V
    //   105: putfield 40	nbn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   108: aload_2
    //   109: invokevirtual 105	com/tencent/qphone/base/remote/FromServiceMsg:getRequestSsoSeq	()I
    //   112: istore 4
    //   114: aload_0
    //   115: getfield 40	nbn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   118: ifnull +737 -> 855
    //   121: aload_0
    //   122: getfield 40	nbn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   125: astore 5
    //   127: aload 5
    //   129: monitorenter
    //   130: aload_0
    //   131: getfield 40	nbn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   156: checkcast 120	nbp
    //   159: astore 7
    //   161: aload 7
    //   163: getfield 123	nbp:jdField_a_of_type_Int	I
    //   166: iload 4
    //   168: if_icmpne -29 -> 139
    //   171: aload 7
    //   173: getfield 126	nbp:jdField_a_of_type_Long	J
    //   176: aload_1
    ...
    //   188: monitorexit
    //   189: aload_0
    //   190: getfield 40	nbn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   193: ifnull +186 -> 379
    //   196: aload_0
    //   197: getfield 40	nbn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   200: astore 5
    //   202: aload 5
    //   204: monitorenter
    //   205: iload_3
    ...
    //   294: athrow
    //   295: aload_0
    //   296: getfield 40	nbn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   311: aload_0
    //   312: aconst_null
    //   313: invokespecial 157	nbp:<init>	(Lnbn;Lnbo;)V
    //   316: astore 6
    //   318: aload 6
    //   320: iload 4
    //   322: putfield 123	nbp:jdField_a_of_type_Int	I
    //   325: aload 6
    //   327: aload_1
    //   328: getfield 129	OnlinePushPack/SvcReqPushMsg:lUin	J
    //   331: putfield 126	nbp:jdField_a_of_type_Long	J
    //   334: aload_0
    //   335: getfield 40	nbn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   338: aload 6
    ...
    //   604: astore 7
    //   606: aload_0
    //   607: getfield 38	nbn:jdField_a_of_type_Nbq	Lnbq;
    //   610: ifnull +85 -> 695
    //   613: aload 7
    //   615: ifnull +80 -> 695
    ...
    //   630: astore 7
    //   632: aload_0
    //   633: getfield 38	nbn:jdField_a_of_type_Nbq	Lnbq;
    //   636: iload_3
    //   637: aload 7
    ...
    //   683: aload_0
    //   684: getfield 40	nbn:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   687: iconst_0
    ...
    //   793: aload_0
    //   794: getfield 38	nbn:jdField_a_of_type_Nbq	Lnbq;
    //   797: ifnull -753 -> 44
    //   800: aload_0
    //   801: getfield 38	nbn:jdField_a_of_type_Nbq	Lnbq;
    //   804: iload_3
    //   805: aload 6
  ...
  public void a(String paramString1, String paramString2, AppRuntime paramAppRuntime, Context paramContext, nbq paramnbq)
  {
    this.b = paramString1;
    this.c = paramString2;
