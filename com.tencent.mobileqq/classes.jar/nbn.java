  ...
  implements BusinessObserver
{
  ...
  private void d(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      mzp localmzp = (mzp)paramObject[4];
      ...
      a(str1, bool, ((Integer)paramObject[10]).intValue(), (RoomInfo)localObject, localmzp, localList1, localList2, i, str2, str3);
      return;
    }
    ...
    do
    {
      do
      {
        do
        {
          ...
          return;
          paramObject = (Object[])paramObject;
          a(paramBoolean, ((Integer)paramObject[0]).intValue(), (String)paramObject[1], (nai)paramObject[2]);
          return;
          paramObject = (Object[])paramObject;
