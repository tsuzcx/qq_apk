  ...
  extends ViewBase
{
  ...
  private RecyclerView.OnScrollListener jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$OnScrollListener = new qkj(this);
  ...
  public qki(VafContext paramVafContext)
  {
  ...
  private void a(Activity paramActivity)
  {
    ...
    localBaseApplication.registerActivityLifecycleCallbacks(new qkn(this, paramActivity));
  }
  
  private void a(VafContext paramVafContext)
  {
    this.jdField_a_of_type_Qks = new qks(paramVafContext);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.setAdapter(this.jdField_a_of_type_Qks);
    this.jdField_a_of_type_Qks.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView);
    this.jdField_a_of_type_Qks.a(new qkk(this));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.addOnChildAttachStateChangeListener(new qkl(this));
  ...
  private void b()
  {
    ...
    {
      return;
      int m = this.jdField_a_of_type_Qks.a();
        ...
        if (m > k)
        {
          ...
          if (i < m)
          {
            ...
            if (i == 0)
            {
              ...
              this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = localContext.getResources().getDrawable(2130849343);
              this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = localContext.getResources().getDrawable(2130849344);
  ...
  private void c()
  {
    if ((this.jdField_e_of_type_Boolean) && (this.jdField_a_of_type_Qkr != null))
    {
      if (this.jdField_a_of_type_Qks.a() > 1)
      {
        this.jdField_a_of_type_Qkr.a();
        this.jdField_a_of_type_Qkr.a(this.jdField_b_of_type_Int);
        this.jdField_a_of_type_Qkr.b(this.jdField_c_of_type_Int);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_Qkr.b();
  }
  ...
  private void d()
  {
    ...
    for (float f1 = 1.0F;; f1 = 0.0F)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.setOnStateChangeListener(new qkp(this));
      return;
    }
  }
  ...
  private boolean g(Object paramObject)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Qks.a(paramObject);
      return true;
    }
    catch (Exception paramObject)
    {
  ...
  {
    this.jdField_a_of_type_Qks.a(parampvc);
    a();
  }
  
  public void a(qkh paramqkh)
  {
  ...
  {
    this.jdField_a_of_type_Qks.a(paramqlb);
  }
  ...
  public void onParseValueFinished()
  {
    ...
    d();
    if ((this.jdField_a_of_type_Int == 1) && (this.jdField_a_of_type_Qkr == null))
    {
      this.jdField_a_of_type_Qkr = new qkr();
      this.jdField_a_of_type_Qkr.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView);
      this.jdField_a_of_type_Qkr.a(new qko(this));
    }
    if (this.jdField_a_of_type_Qld == null)
    {
      this.jdField_a_of_type_Qld = new qld(this.jdField_f_of_type_Boolean, this.jdField_a_of_type_ArrayOfInt[0], this.jdField_a_of_type_ArrayOfInt[1], this.jdField_a_of_type_ArrayOfInt[2], this.jdField_a_of_type_ArrayOfInt[3]);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.addItemDecoration(this.jdField_a_of_type_Qld);
    }
    ...
    for (int i = 0;; i = 8)
    {
      ...
      this.jdField_a_of_type_Qks.a(this.jdField_d_of_type_Boolean);
      c();
      return;
    }
  }
