  ...
  implements View.OnClickListener
{
  ...
  private WeakReference<anqx> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public anqo(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, BaseChatPie paramBaseChatPie)
  {
  ...
  private void a(View paramView)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewViewGroup != paramView)
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131367379));
      this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131365028));
      this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131368233));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131368223));
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131368253));
      this.jdField_b_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131368234));
      this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131368232));
      this.jdField_d_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_c_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131365024));
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131363907));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131363952));
      this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetButton = ((Button)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131363953));
      this.jdField_c_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_d_of_type_AndroidWidgetButton = ((Button)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131363738));
      this.jdField_d_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_d_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131365037));
      this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_d_of_type_AndroidViewViewGroup.findViewById(2131373056));
      this.e = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131373059));
  ...
  private void a(ApolloGameData paramApolloGameData)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = ((amsx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a();
        if ((this.jdField_a_of_type_JavaLangRefWeakReference == null) || (this.jdField_a_of_type_JavaLangRefWeakReference.get() == null))
        {
          localObject2 = new anqx(this);
          this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(localObject2);
          ((anaj)localObject1).a((anal)localObject2);
        }
        ((anqx)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_Int = ((int)(System.currentTimeMillis() / 1000L));
        if (!paramApolloGameData.isGameApp)
        {
          ((anaj)localObject1).a(paramApolloGameData.gameId, ((anqx)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_Int);
          ...
          if (((SparseArray)localObject1).get(2000) != null)
          {
            ...
            if (this.jdField_a_of_type_Anqt != null) {
              this.jdField_a_of_type_Anqt.notifyDataSetChanged();
            }
          }
        }
      }
      ...
      for (int i = 1;; i = 0)
      {
        ...
        for (localObject2 = "1";; localObject2 = "0")
        {
          ...
          return;
          anaf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramApolloGameData, ((anqx)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_Int);
          break;
  ...
  private void b(ApolloGameData paramApolloGameData)
  {
    ...
    bhlq.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690041)).setPositiveButton(2131690029, new anqr(this, paramApolloGameData)).setNegativeButton(2131690030, new anqq(this)).show();
  }
  ...
  private void c(ApolloGameData paramApolloGameData)
  {
    ...
    bhlq.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690031)).setPositiveButton(2131690030, new anqs(this)).show();
  }
  
  private void e()
  {
    QQToast.a(BaseApplicationImpl.getContext(), 1, anzj.a(2131699264), 0).a();
  }
  ...
  public View a()
  {
    ...
    do
    {
      ...
      {
      default: 
        localObject1 = (ViewGroup)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558666, null);
        localObject2 = (XListView)((ViewGroup)localObject1).findViewById(2131367379);
        return localObject1;
      }
      localObject2 = (ViewGroup)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558671, null);
      localTextView = (TextView)((ViewGroup)localObject2).findViewById(2131371860);
      if (amst.a())
      {
        localTextView.setOnClickListener(null);
        localTextView.setText(this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131690050));
        return localObject2;
      }
      localObject1 = localObject2;
    } while (!bhnv.g(this.jdField_a_of_type_AndroidContentContext));
    localTextView.setText(anzj.a(2131699294));
    localTextView.setOnClickListener(new anqp(this));
    return localObject2;
  }
  ...
  public ApolloGameData a()
  {
    ...
    localApolloGameData.name = amys.a("aio.enter.name");
    localApolloGameData.listCoverUrl = amys.a("aio.enter.bg");
    localApolloGameData.isSetting = true;
    localApolloGameData.toolUrl = amys.a("aio.enter");
  ...
  public void a()
  {
    ...
    if ((a()) && (amst.a("apollo_aio_game_guide") == -1))
    {
      amst.a("apollo_aio_game_guide", 1);
      if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      {
        anqx localanqx = (anqx)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localanqx != null)
        {
          ((amsx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a().b(localanqx);
  ...
  public void a(amxp paramamxp)
  {
    ...
    label41:
    for (int i = -1;; i = paramamxp.jdField_a_of_type_Int)
    {
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Anqt == null) {
      this.jdField_a_of_type_Anqt = new anqt(this.jdField_a_of_type_AndroidContentContext, this);
    }
    this.jdField_a_of_type_Anqt.a(this.jdField_b_of_type_JavaUtilList);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Anqt);
    if ((this.jdField_a_of_type_Amxp != null) && (this.jdField_a_of_type_Amxp.jdField_a_of_type_Int > 0) && (this.jdField_b_of_type_JavaUtilList.size() > 1))
    {
      paramView = this.jdField_b_of_type_JavaUtilList.iterator();
      while (paramView.hasNext()) {
        if (((ApolloGameData)paramView.next()).gameId == this.jdField_a_of_type_Amxp.jdField_a_of_type_Int)
        {
          if (QLog.isColorLevel()) {
            QLog.d("ApolloGameViewBinder", 2, new Object[] { "[updatePanel] jump gameId:", Integer.valueOf(this.jdField_a_of_type_Amxp.jdField_a_of_type_Int), ",from:", Integer.valueOf(this.jdField_a_of_type_Amxp.jdField_b_of_type_Int) });
          }
          VipUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "cmshow", "Apollo", "avatar_clk_togame", this.g, this.jdField_a_of_type_Amxp.jdField_b_of_type_Int, new String[] { String.valueOf(this.jdField_a_of_type_Amxp.jdField_a_of_type_Int) });
        }
      }
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(List<ApolloGameData> paramList)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int != 1036) && (paramList != null) && (amys.a("aio.city.game", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == amyt.d)) {
      paramList.add(0, a());
    }
    ...
    this.jdField_c_of_type_JavaUtilList = ((annx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).h(6);
  }
  ...
  public boolean a(int paramInt)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ??? = (annx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
      if (TextUtils.isEmpty(a())) {
        return false;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) {
        this.jdField_c_of_type_JavaUtilList = ((annx)???).a(ApolloGameUtil.a(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      }
  ...
  public void b(List<ApolloGameData> paramList)
  {
    ...
    {
      return;
      if ((paramList != null) && (amys.a("aio.city.game", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == amyt.d)) {
        paramList.add(0, a());
      }
    } while ((this.jdField_b_of_type_JavaUtilList == null) || (paramList == null) || (this.jdField_a_of_type_Anqt == null));
    this.jdField_b_of_type_JavaUtilList.clear();
    this.jdField_b_of_type_JavaUtilList.addAll(paramList);
    this.jdField_a_of_type_Anqt.notifyDataSetChanged();
  }
  ...
  public void d()
  {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      if (amys.a("aio.panel.rank.time") < System.currentTimeMillis() / 1000L)
      {
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0)) {
        ...
        amys.a("aio.panel.rank.time", (int)(System.currentTimeMillis() / 1000L) + 300);
      }
      return;
    }
  }
