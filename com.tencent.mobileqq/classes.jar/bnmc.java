...
public class bnmc
  implements bnji, QQSpecialAVFilter.MusicWaveformSupporter
{
  private int jdField_a_of_type_Int;
  private bnmz jdField_a_of_type_Bnmz;
  private MusicItemInfo jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo;
  private QQFilterRenderManager jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager = bkka.a();
  ...
  public bnmc(List<FilterDesc> paramList, MusicItemInfo paramMusicItemInfo, int paramInt1, int paramInt2, PublishVideoEntry paramPublishVideoEntry)
  {
    if (paramList != null)
    {
  ...
  private void b()
  {
    ...
    for (;;)
    {
      ...
      bnmd localbnmd = new bnmd(this);
      try
      {
        long l = SystemClock.elapsedRealtimeNanos();
        boolean bool = this.jdField_a_of_type_Bnmz.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo, localbnmd, 0);
        if (QLog.isColorLevel()) {
  ...
  public float getCurrentMusicGain()
  {
    try
    {
      if (this.jdField_a_of_type_Bnmz != null)
      {
        ...
        float f = this.jdField_a_of_type_Bnmz.a(this.jdField_a_of_type_Int);
        return f;
      }
    }
    catch (Exception localException)
