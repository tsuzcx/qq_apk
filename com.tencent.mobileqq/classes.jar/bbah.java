  ...
  implements Handler.Callback, bbed
{
  ...
  private volatile WeakReference<bbaj> jdField_b_of_type_MqqUtilWeakReference;
  ...
  public void a(Setting paramSetting)
  {
    ...
    for (;;)
    {
      ...
      paramSetting = "";
      break;
      localObject = bbac.b(paramSetting.uin);
      ...
      if (HttpDownloadUtil.a(a(), new anvt(MsfSdkUtils.insertMtype("friendlist", paramSetting), localFile2, 0), this) == 0) {
        bool1 = true;
      }
      boolean bool2;
      if (bool1)
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (paramMessage = (Drawable)paramMessage.obj;; paramMessage = null)
    {
      ...
      {
        localbbaj = (bbaj)this.jdField_b_of_type_MqqUtilWeakReference.get();
        if (localbbaj != null)
        {
      ...
      {
        localbbaj.a(str, bool, paramMessage);
