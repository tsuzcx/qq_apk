...
public class zea
  implements bhuk
{
  public zea(NewerGuidePlugin paramNewerGuidePlugin, Activity paramActivity, bhuf parambhuf) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      continue;
      paramView = bddf.a();
      paramInt = bddf.b(this.jdField_a_of_type_AndroidAppActivity);
      ...
      {
        paramView = bdzf.a(alof.aX + "photo/");
