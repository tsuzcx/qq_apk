  ...
  extends unf
{
  ...
  public final List<vcw> a;
  public final boolean a;
  public final byte[] a;
  
  public vcv(qqstory_service.RspGetEmoticonPackList paramRspGetEmoticonPackList, byte[] paramArrayOfByte, long paramLong)
  {
    ...
    else
    {
      for (;;)
      {
        ...
        vcw localvcw = new vcw((qqstory_struct.EmoticonPack)paramRspGetEmoticonPackList.next());
        if (localvcw.a())
        {
          localArrayList.add(localvcw);
          continue;
          bool = false;
          break;
        }
        wsv.d("GetEmojiPackInfoListResponse", "found invalid data we ignore it : " + localvcw);
      }
    }
    label151:
