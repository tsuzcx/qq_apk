  ...
  implements VideoConverter.Processor
{
  ...
  vcv(vcr paramvcr, String paramString, int paramInt1, int paramInt2, long paramLong)
  {
  ...
  public VideoConverter.VideoConvertConfig a(int paramInt1, int paramInt2)
  {
    ...
    long l1;
    int m;
    if ((this.jdField_a_of_type_Vcr.b != null) && (this.jdField_a_of_type_Vcr.b.get() != null))
    {
      localObject = SharedPreUtils.r(((QQAppInterface)this.jdField_a_of_type_Vcr.b.get()).getApp(), ((QQAppInterface)this.jdField_a_of_type_Vcr.b.get()).getCurrentAccountUin());
