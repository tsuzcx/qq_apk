  ...
  extends bieo
{
  ...
  public bmgx(SwiftBrowserUIStyleHandler paramSwiftBrowserUIStyleHandler)
  {
    ...
    this.d = bmgr.a(this.jdField_a_of_type_AndroidAppActivity);
  }
  ...
  private void a()
  {
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      localRadioButton.setId(2131374782);
      ...
      localRadioButton.setText(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131716495));
      ...
      localRadioButton.setId(2131374783);
      a(localRadioButton, false);
      localRadioButton.setText(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131716497));
      this.jdField_a_of_type_AndroidWidgetRadioGroup.addView(localRadioButton, localLayoutParams);
    }
    this.jdField_a_of_type_AndroidWidgetRadioGroup.setOnCheckedChangeListener(new bmgz(this));
  ...
  {
    paramRadioButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130846992));
  ...
  private boolean a()
  {
    ...
    {
      bmgm.e("ReaderTitleBarView", bool);
      if (100 != this.jdField_a_of_type_Int) {
        break;
      }
      return true;
  ...
  private void b(int paramInt)
  {
    if (this.leftView == null) {
      bmgm.a("ReaderTitleBarView", "leftView is null");
    }
  ...
  private void c(int paramInt)
  {
    ...
    for (int i = paramInt;; i = 0)
    {
      d(i);
      return;
      bmgp.a(this.c, this.d, "5", "502", "", "3", "", "", "");
      str = this.jdField_a_of_type_JavaLangString;
      paramInt = 0;
      break;
      bmgp.a(this.c, this.d, "5", "2206", "", "3", "", "", "");
      paramInt = 1;
  ...
  public void initTitleContainer()
  {
    ...
    this.leftView.setBackgroundDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130850726));
    int i;
    int j;
    int k;
    int m;
    ...
    if (a())
    {
      ...
      bmgr.a(this.titleContainer, ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidAppActivity));
      if (this.mUIStyleHandler.mHostFragment != null)
      {
        j = this.mUIStyleHandler.mHostFragment.getResources().getDimensionPixelSize(2131299080);
        if (!a()) {
          break label670;
        }
        bmgr.a(this.mUIStyleHandler.mHostFragment.contentView, -i);
      ...
      localDrawable = this.rightViewImg.getResources().getDrawable(2130846970);
      if (!a()) {
        break label794;
      }
      localObject = bheg.a(localDrawable, -1);
      label525:
      this.rightViewImg.setImageDrawable((Drawable)localObject);
      this.rightViewImg.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131693892));
      label554:
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidViewView == null) {
        this.jdField_a_of_type_AndroidViewView = a(2130846971, this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131716496), new bmgy(this));
      }
      return;
      ...
      bmgr.a(this.mUIStyleHandler.mHostFragment.webView, -j - ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidAppActivity));
      break label364;
      label710:
      ...
      localObject = bheg.a(localDrawable, this.mUIStyle.mTitleStyle.leftAndRightBtnColor);
      break label525;
      label828:
      this.rightViewImg.setVisibility(8);
      break label554;
      label840:
      bmgm.a("ReaderTitleBarView", "mTitleBarLeftTabUrl=" + this.jdField_a_of_type_JavaLangString + ",mTitleBarRightTabUrl=" + this.jdField_b_of_type_JavaLangString);
    }
  }
}
