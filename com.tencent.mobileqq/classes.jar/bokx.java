  ...
  extends DynamicTextItem
{
  ...
  public bokx(int paramInt, @NonNull List<String> paramList, Typeface paramTypeface)
  {
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    paramInt = (int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(anvx.a(2131700664));
    this.jdField_b_of_type_AndroidTextStaticLayout = bomr.a(paramString, 0, paramString.length(), this.jdField_a_of_type_AndroidTextTextPaint, paramInt, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, 2);
    this.jdField_a_of_type_AndroidTextStaticLayout = bomr.a(paramString, 0, paramString.length(), this.jdField_b_of_type_AndroidTextTextPaint, paramInt, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, 2);
