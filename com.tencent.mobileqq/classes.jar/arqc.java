...
public class arqc
{
  ...
  private void b(QQAppInterface paramQQAppInterface, Context paramContext, RedTouch paramRedTouch)
  {
    ...
    int i;
    switch (((bhvu)localObject).jdField_a_of_type_Int)
    {
    default: 
      return;
    case 1: 
      i = ((bhvu)localObject).jdField_b_of_type_Int;
      if (i > 99) {
    ...
    case 3: 
      ...
      return;
    case 2: 
      localObject = ((bhvu)localObject).jdField_b_of_type_JavaLangString;
      ...
      localRedTypeInfo.red_content.set(bawz.a(paramContext, 3.0F) + "");
      ...
      return;
    case 4: 
      paramContext = ((bhvu)localObject).jdField_b_of_type_JavaLangString;
  ...
  private void b(QQAppInterface paramQQAppInterface, String paramString, BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    for (int i = 1;; i = 2)
    {
      axqw.b(paramQQAppInterface, "dc00899", "Grp_tribe", "", "dynamic", "exp_tribe", 0, 0, i + "", "", "", "");
      return;
    }
  }
  
  public void a(atxc paramatxc, RedTouch paramRedTouch)
  {
    if (paramRedTouch == null) {
      return;
    }
    this.jdField_a_of_type_Int = paramatxc.d;
    this.jdField_b_of_type_Int = paramatxc.c;
    Object localObject;
    switch (paramatxc.jdField_a_of_type_Int)
    {
    case 1: 
    case 2: 
    case 4: 
    default: 
      ...
      return;
    case 3: 
      paramatxc = (String)paramatxc.jdField_a_of_type_JavaUtilList.get(0);
      localObject = new BusinessInfoCheckUpdate.RedTypeInfo();
      ((BusinessInfoCheckUpdate.RedTypeInfo)localObject).red_type.set(3);
      ((BusinessInfoCheckUpdate.RedTypeInfo)localObject).red_content.set(paramatxc);
    ...
    case 5: 
      ...
      localRedTypeInfo.red_type.set(5);
      localObject = paramatxc.jdField_b_of_type_Int + "";
      if (paramatxc.jdField_b_of_type_Int > 99) {
        localObject = "99+";
      }
      localRedTypeInfo.red_content.set((String)localObject);
      localRedTypeInfo.red_desc.set("{'cn':'#FF0000'}");
    ...
    paramatxc = new BusinessInfoCheckUpdate.RedTypeInfo();
    paramatxc.red_type.set(0);
    paramatxc.red_content.set("");
    paramatxc.red_desc.set("");
    paramRedTouch.a(paramatxc);
  }
  ...
  protected void a(QQAppInterface paramQQAppInterface, Context paramContext, RedTouch paramRedTouch)
  {
    ...
    if (paramQQAppInterface != null)
    {
      if (!amnk.a(paramQQAppInterface, "redpoint_leba_show")) {
        break label357;
      }
      localObject = ((amno)paramQQAppInterface.getManager(269)).b();
      if (localObject == null) {
        break label264;
      }
      localObject = ((amnk)localObject).a(paramQQAppInterface);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      try
      {
        ...
        paramQQAppInterface.setMaxWidth(actn.a(200.0F, paramContext.getResources()));
        paramRedTouch.weight = 1.0F;
        paramRedTouch.width = 0;
        paramRedTouch.rightMargin = actn.a(4.0F, paramContext.getResources());
  ...
  protected void a(QQAppInterface paramQQAppInterface, RedTouch paramRedTouch)
  {
    ...
    paramQQAppInterface = (mxx)paramQQAppInterface.getManager(70);
    ...
    vel.a("dynamic", "exp_story", 0, paramQQAppInterface.b(), new String[0]);
    BusinessInfoCheckUpdate.RedTypeInfo localRedTypeInfo = new BusinessInfoCheckUpdate.RedTypeInfo();
    ...
    case 35: 
      ...
      while (i != -1)
      {
        if (QLog.isColorLevel()) {
          QLog.i("storyRedDotDebug", 2, "更新动态红点:" + mxx.a(localRedDotInfo));
        }
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            veg.d("Q.lebatab.LebaSpecificRedTouch", "tag red dot json parse error , %s", new Object[] { localException.getMessage() });
          }
        }
        ...
        try
        {
          ...
          veg.e("Q.lebatab.LebaSpecificRedTouch", "updateStoryRedTouch() APPID_STORY_IMG: red display=%d", new Object[] { Long.valueOf(l) });
          if (l != 0L) {
            break label445;
          }
          paramRedTouch.b();
        ...
        {
          veg.c("Q.lebatab.LebaSpecificRedTouch", "updateStoryRedTouch() APPID_STORY_IMG: Error parse json: ", paramQQAppInterface);
          i = -1;
        }
      }
      label436:
      veg.b("Q.lebatab.LebaSpecificRedTouch", "updateStoryRedTouch() APPID_STORY_IMG: str_custom_buffer is null");
      label445:
      ...
      for (;;)
      {
        ...
        paramQQAppInterface = "https://p.qlogo.cn/gh/" + localRedDotInfo.uint64_cmd_uin.get() + "/" + localRedDotInfo.uint64_cmd_uin.get() + "/100?t=" + mxx.c;
        localRedTypeInfo.red_content.set(paramQQAppInterface);
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong, RedTouch paramRedTouch, String paramString, Map<Long, Integer> paramMap)
  {
    ...
    if ((paramMap != null) && (bhvu.jdField_a_of_type_JavaLangString.equals(paramMap)))
    {
      b(paramQQAppInterface, paramContext, paramRedTouch);
      a(paramLong, paramRedTouch);
      return true;
    }
    if (String.valueOf(ndh.jdField_a_of_type_Int).equals(paramMap))
    {
      a(paramQQAppInterface, paramRedTouch);
      a(paramLong, paramRedTouch);
      return true;
    }
    if (bciu.jdField_a_of_type_JavaLangString.equals(paramString))
    {
      bciu.a(paramQQAppInterface, paramRedTouch);
      a(paramLong, paramRedTouch);
      return true;
    }
    if (7759L == paramLong)
  ...
  public void b(QQAppInterface paramQQAppInterface, RedTouch paramRedTouch, String paramString1, String paramString2, long paramLong)
  {
    ...
    {
      paramString2 = ((avpq)localObject2).a(paramString1);
      if (paramString2 != null)
      {
        ...
        {
          paramString1 = null;
          localObject2 = ((avpq)localObject2).a(paramString2);
          if (QLog.isColorLevel()) {
