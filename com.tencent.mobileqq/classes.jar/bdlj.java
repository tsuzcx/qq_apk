  ...
  extends anii
{
  ...
  public bdlj(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    bdma localbdma = (bdma)this.app.getManager(304);
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramToServiceMsg = (bdma)this.app.getManager(304);
    boolean bool1 = bool5;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramFromServiceMsg = paramToServiceMsg;
        i2 = i3;
        if (!bdma.a(this.app.getApp(), String.valueOf(l1), "key_groupteamwork_add_timestamp", "").equals(String.valueOf(l2)))
        {
          bool4 = true;
          bool5 = true;
          bool3 = true;
          ...
          paramFromServiceMsg = paramToServiceMsg;
          i2 = i3;
          bdma.a(this.app.getApp(), String.valueOf(l1), "key_groupteamwork_add_timestamp", String.valueOf(l2));
          bool2 = bool4;
          bool1 = bool5;
          paramFromServiceMsg = paramToServiceMsg;
          i2 = i3;
          ((awne)this.mApp.getManager(37)).a(this.mApp.getApp(), String.valueOf(l1), "TIM_GROUP_TM_REDDOT", true);
        }
        bool1 = bool3;
        i1 = i3;
  ...
  public void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   9: istore 9
    //   11: aload_1
    //   12: getstatic 61	bdlj:j	Ljava/lang/String;
    ...
    //   24: pop
    //   25: aload_1
    //   26: getstatic 57	bdlj:i	Ljava/lang/String;
    ...
    //   155: ifeq +13 -> 168
    //   158: getstatic 25	bdlj:a	Ljava/lang/String;
    //   161: iconst_2
    //   162: ldc_w 713
    ...
    //   272: lload 10
    //   274: invokestatic 692	bdlj:a	(Lcom/tencent/mobileqq/teamworkforgroup/GPadInfo;Ltencent/im/oidb/cmd0xae9/group_online_docs$DocInfo;J)V
    //   277: aload 14
    ...
    //   385: ifeq +33 -> 418
    //   388: getstatic 25	bdlj:a	Ljava/lang/String;
    //   391: iconst_2
    ...
    //   479: aastore
    //   480: invokevirtual 582	bdlj:notifyUI	(IZLjava/lang/Object;)V
    //   483: invokestatic 379	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   486: ifeq -482 -> 4
    //   489: getstatic 25	bdlj:a	Ljava/lang/String;
    //   492: iconst_2
    ...
    //   565: iconst_0
    //   566: istore 5
    //   568: getstatic 25	bdlj:a	Ljava/lang/String;
    //   571: iconst_1
    ...
    //   629: ifeq +13 -> 642
    //   632: getstatic 25	bdlj:a	Ljava/lang/String;
    //   635: iconst_2
    //   636: ldc_w 752
      ...
      try
      {
        ...
        if (paramToServiceMsg.uint32_result.has())
        {
          ...
          if (i3 == 0)
          {
            paramFromServiceMsg = paramToServiceMsg;
            i2 = i3;
            localObject = ((bdma)this.app.getManager(304)).a();
            paramObject = paramToServiceMsg;
            i1 = i3;
            paramFromServiceMsg = paramToServiceMsg;
            i2 = i3;
            if (!TextUtils.isEmpty(str))
            {
              ...
              if (((ConcurrentHashMap)localObject).containsKey(str))
              {
                paramFromServiceMsg = paramToServiceMsg;
                i2 = i3;
                ((ConcurrentHashMap)localObject).remove(bdjg.c(str));
                i1 = i3;
                paramObject = paramToServiceMsg;
              }
            }
