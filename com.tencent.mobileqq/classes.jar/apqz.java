  ...
  implements apnr
{
  ...
  public apqz(EmoticonPanelController paramEmoticonPanelController)
  {
    super(paramEmoticonPanelController);
    this.jdField_a_of_type_Apns = new aprc(this);
    this.jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new aprd(this);
  }
  
  public int a(QQAppInterface paramQQAppInterface, String paramString, List<apsm> paramList)
  {
    ...
    for (;;)
    {
      ...
      if (paramList != null)
      {
        paramQQAppInterface = ((aube)paramQQAppInterface.getManager(14)).a(paramString);
        int j;
        int i;
        if ((paramQQAppInterface != null) && ((paramQQAppInterface.jobType == 3) || (paramQQAppInterface.jobType == 5)))
        {
          ...
          paramQQAppInterface = (apsm)paramList.get(i);
  ...
  public int a(String paramString, List<apsm> paramList, boolean paramBoolean)
  {
    ...
    while (i < j)
    {
      Object localObject = (apsm)paramList.get(i);
      if (((apsm)localObject).jdField_a_of_type_Int == 6)
      {
        localObject = ((apsm)localObject).jdField_a_of_type_ComTencentMobileqqDataEmoticonPackage;
  ...
  public void a(EmoticonPackage paramEmoticonPackage)
  {
    ...
    do
    {
      ...
      {
        Object localObject = (apsm)localList.get(i);
        k = j;
        if (localObject != null)
        {
          k = j;
  ...
  public void a(boolean paramBoolean, apqp paramapqp)
  {
    QLog.d("EmoticonPanelMallHelper", 1, "asyncInitPanelDataList begin");
    ThreadManager.post(new EmoticonPanelMallHelper.1(this, paramBoolean, paramapqp), 5, null, true);
  }
