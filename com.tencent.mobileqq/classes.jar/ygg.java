...
public class ygg
{
  ...
  private static final Property<ImageView, Matrix> jdField_a_of_type_AndroidUtilProperty = new ygk(Matrix.class, "animatedTransform");
  ...
  public ygg(Bundle paramBundle, ygo paramygo)
  {
    if ((paramBundle == null) || (paramygo == null)) {
      return;
    }
      ...
      for (;;)
      {
        try
        {
          ...
          if (Build.VERSION.SDK_INT >= 16)
          {
            ...
            localBundle.putString("bundle_key_source_image_param", new ygn((String)localObject, paramInt1, paramInt2).a());
  ...
  private void a()
  {
    if ((this.jdField_a_of_type_Ygf != null) && (this.jdField_a_of_type_Ygf.a())) {
      return;
    }
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (this.jdField_a_of_type_Ygf != null) {
      this.jdField_a_of_type_Ygf.a(2);
    }
    ...
    ((ObjectAnimator)localObject1).addListener(new ygi(this, paramInt4, paramInt3, paramInt1, paramInt2));
    ...
    localObject2 = ObjectAnimator.ofObject(this.jdField_a_of_type_AndroidWidgetImageView, jdField_a_of_type_AndroidUtilProperty, new ygl(), new Matrix[] { localObject2, localObject3 });
    ...
    this.jdField_a_of_type_AndroidAnimationAnimatorSet.addListener(new ygj(this));
  ...
  {
    this.jdField_a_of_type_Ygf = new ygf();
    ...
    this.jdField_a_of_type_Ygn = new ygn();
    this.jdField_a_of_type_Ygn.a(str);
    this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Ygn.jdField_a_of_type_JavaLangString;
    this.jdField_a_of_type_JavaIoFile = new File(this.jdField_a_of_type_JavaLangString);
    this.jdField_a_of_type_Int = this.jdField_a_of_type_Ygn.jdField_a_of_type_Int;
    this.jdField_b_of_type_Int = this.jdField_a_of_type_Ygn.jdField_b_of_type_Int;
  ...
  private void c()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetFrameLayout != null)
    {
      ...
      localLayoutParams.topMargin = this.jdField_a_of_type_Ygo.a();
    ...
    this.jdField_a_of_type_Ygf.a(1);
  }
  
  private void d()
  {
    int[] arrayOfInt = this.jdField_a_of_type_Ygo.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
  ...
  private void e()
  {
    if ((this.jdField_a_of_type_Ygf == null) || (!this.jdField_a_of_type_Ygf.b())) {
      QLog.d("TransitionAnimHelper", 1, "initImageEnterAnimation error!");
    }
    while (this.jdField_b_of_type_AndroidWidgetImageView == null) {
      return;
    }
    this.jdField_b_of_type_AndroidWidgetImageView.getViewTreeObserver().addOnPreDrawListener(new ygh(this));
  }
  ...
  {
    if (this.jdField_a_of_type_Ygf != null) {
      this.jdField_a_of_type_Ygf.a(paramygp);
    }
  }
}
