...
{
  private static otx jdField_a_of_type_Otx;
  private BackgroundColorSpan jdField_a_of_type_AndroidTextStyleBackgroundColorSpan;
  
  public static otx a()
  {
    if (jdField_a_of_type_Otx == null) {
      jdField_a_of_type_Otx = new otx();
    }
    return jdField_a_of_type_Otx;
  }
  ...
  public boolean onTouchEvent(TextView paramTextView, Spannable paramSpannable, MotionEvent paramMotionEvent)
  {
    ...
    if ((i == 1) || (i == 0) || (i == 2) || (i == 3))
    {
      ...
      if ((paramTextView.getTag(2131375973) != null) && ((paramTextView.getTag(2131375973) instanceof Boolean)) && (((Boolean)paramTextView.getTag(2131375973)).booleanValue()))
      {
        ...
        {
          return true;
          ((LinearLayout)paramTextView.getParent()).setBackgroundDrawable(paramTextView.getResources().getDrawable(2130849280));
          continue;
          ((LinearLayout)paramTextView.getParent()).setBackgroundDrawable(paramTextView.getResources().getDrawable(2130849285));
        }
      }
    }
    return false;
