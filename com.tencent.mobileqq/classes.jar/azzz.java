...
public class azzz
{
  ...
  public azzz(ArticleInfo paramArticleInfo, baac parambaac, QQAppInterface paramQQAppInterface, String paramString)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_b_of_type_Boolean = false;
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList(2);
    this.jdField_a_of_type_AndroidOsHandler = new baaa(this, Looper.getMainLooper());
    ...
    this.jdField_a_of_type_Baab = new baab(this, this.jdField_a_of_type_AndroidOsHandlerThread.getLooper());
  ...
  {
    if ((paramArrayOfString == null) || (paramArrayOfString.length == 0) || (this.jdField_a_of_type_Baac == null) || (this.jdField_a_of_type_Boolean)) {}
    while (this.jdField_a_of_type_Double > paramDouble) {
      return;
    }
    Message localMessage = this.jdField_a_of_type_Baab.obtainMessage(2);
  ...
  protected void a(int paramInt)
  {
    ...
    {
      bbbb.a((QQAppInterface)localObject3, str1, "Grp_recite", "Norecognize_Recite_Again_Clk", 0, 0, new String[] { str2, "", localObject2, "" });
      break;
      if (paramInt >= this.jdField_a_of_type_ComTencentMobileqqAppTroopManager.a.jdField_b_of_type_Int) {
        break;
      }
            ...
            if ((paramWordInfo != null) && (paramWordInfo.paragraphPos < this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteDataArticleInfo.paragraphs.size()) && (i != 0))
            {
              ...
              if (i < ((List)localObject).size())
              {
                ...
                if (!localWordInfo.isNormalWord())
                {
                  ...
                  this.jdField_a_of_type_Baac.a(localWordInfo);
  ...
  protected WordInfo b()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 61	azzz:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   6: invokevirtual 331	java/util/ArrayList:isEmpty	()Z
    //   9: ifne +19 -> 28
    //   12: aload_0
    //   13: getfield 61	azzz:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   16: iconst_0
  ...
  public void b()
  {
    ...
    do
    {
      return;
      this.jdField_a_of_type_Boolean = true;
      if (this.jdField_a_of_type_Baac == null) {
        break;
      }
        ...
        if (i < this.jdField_a_of_type_ComTencentMobileqqAppTroopManager.a.jdField_a_of_type_Int)
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteDataWordInfo != null) && (!this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkReciteDataWordInfo.isReminded))
          {
            ...
            if (localObject2 != null)
            {
              ...
              this.jdField_a_of_type_Baac.a((WordInfo)localObject2);
              this.c += 1;
            }
          }
          else
