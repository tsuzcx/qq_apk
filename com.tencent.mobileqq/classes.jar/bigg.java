  ...
  extends WebViewClient
{
  ...
  public void onDetectedBlankScreen(String paramString, int paramInt)
  {
    ...
    if (this.b.jdField_a_of_type_Bifc != null) {
      this.b.jdField_a_of_type_Bifc.onDetectedBlankScreen(paramString, paramInt);
    }
  }
  ...
  public void onPageFinished(WebView paramWebView, String paramString)
  {
    ...
    if (this.b.jdField_a_of_type_Bifc != null) {
      this.b.jdField_a_of_type_Bifc.onPageFinished(paramWebView, paramString);
    }
  ...
  public void onPageStarted(WebView paramWebView, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      if (this.b.jdField_a_of_type_Bifc != null)
      {
        this.b.jdField_a_of_type_Bifc.onPageStarted(paramWebView, paramString, paramBitmap);
        this.b.jdField_a_of_type_Bifc.onWebViewClientImplPageStarted(paramWebView, paramString, paramBitmap);
      }
      paramWebView = ((CustomWebView)paramWebView).getPluginEngine();
      if (paramWebView != null) {
      ...
      try
      {
        ...
        {
          paramWebView = new Bundle();
          paramWebView.putStringArrayList("recognised-text", bihy.a());
  ...
  public void onReceivedError(WebView paramWebView, int paramInt, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      if (this.b.jdField_a_of_type_Bifc != null) {
        this.b.jdField_a_of_type_Bifc.onReceivedError(paramWebView, paramInt, paramString1, paramString2);
      }
      paramWebView = ((CustomWebView)paramWebView).getPluginEngine();
  ...
  public void onReceivedSslError(WebView paramWebView, SslErrorHandler paramSslErrorHandler, SslError paramSslError)
  {
    ...
    {
      QLog.e("WebLog_WebViewWrapper", 1, (String)localObject + ", pageUrl=" + nwo.b(str, new String[0]));
      if (this.b.jdField_a_of_type_Bifc != null) {
        this.b.jdField_a_of_type_Bifc.onReceivedSslError(paramWebView, paramSslError);
      }
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    for (;;)
    {
      afoe.b(this.b.jdField_a_of_type_AndroidContentIntent, str);
      paramString = biit.b(str);
      if ((this.b.jdField_a_of_type_Bifc == null) || (!this.b.jdField_a_of_type_Bifc.beforeWebViewEngineHandleOverrideUrl(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, str))) {
        break label298;
      }
      ...
      break;
      label261:
      QLog.d("WebLog_WebViewWrapper", 2, "shouldOverrideUrlLoading:" + nwo.b(str, new String[0]));
    }
    label298:
    if ((("http".equals(paramString)) || ("data".equals(paramString))) && (!str.contains("/cgi-bin/httpconn?htcmd=0x6ff0080"))) {
      CustomWebView.addContextLog(nwo.b(str, new String[0]));
    }
    try
    {
      ...
      if ((this.b.jdField_a_of_type_Bifc != null) && (this.b.jdField_a_of_type_Bifc.shouldOverrideUrlLoading(paramWebView, str))) {
        return true;
      }
      ...
      else if (this.b.jdField_a_of_type_Bifc != null)
      {
        boolean bool = this.b.jdField_a_of_type_Bifc.afterWebViewEngineHandleOverrideUrl(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, str);
        if (bool) {
          return true;
        }
      }
    ...
    catch (RuntimeException paramWebView)
    {
      ...
      {
        bdla.b(null, "P_CliOper", "BizTechReport", "", "webview", "exception", 0, 1, 0, paramWebView, "", "", "");
