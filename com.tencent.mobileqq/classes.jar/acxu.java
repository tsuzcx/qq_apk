  ...
  implements acxg, Handler.Callback
{
  ...
  public acxu(BaseChatPie paramBaseChatPie)
  {
  ...
  {
    paramString = new aqax(paramChatMessage.frienduin, paramChatMessage.selfuin, paramString, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, -5020, 655392, paramChatMessage.time);
    ...
    aqay.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForUniteGrayTip);
    QLog.e("vip_ptt.helper", 1, "It is need add gray msg and insert success");
  }
  
  private boolean a()
  {
    if ((amir.c().a <= 1) && (adlw.d)) {
      return !baub.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "have_add_ptt_gray_msg", false);
    }
    return false;
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (amir.c().a <= 1)
    {
      a(paramMessage, ajjy.a(2131642923));
      baub.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "have_add_ptt_gray_msg", true);
    }
    return true;
  }
}
