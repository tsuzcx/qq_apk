...
public class aybr
{
  public static void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong, String paramString, int paramInt5, aybt paramaybt)
  {
    ...
    paramString.setObserver(new aybs(paramaybt));
