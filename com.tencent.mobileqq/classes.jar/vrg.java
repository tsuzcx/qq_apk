...
public class vrg
{
  ...
  {
    Object localObject2 = vri.a("touin", paramStFeed.poster.id.get());
    FeedCloudCommon.Entry localEntry1 = vri.a("feedid", paramStFeed.id.get());
    FeedCloudCommon.Entry localEntry2 = vri.a("author_uin", paramStFeed.poster.id.get());
    FeedCloudCommon.Entry localEntry3 = vri.a("video_total_time", String.valueOf(paramStFeed.video.duration.get()));
    Object localObject1;
    if (uxx.c((FeedCloudMeta.StUser)paramStFeed.poster.get()))
    {
      localObject1 = "2";
      localObject1 = new ArrayList(Arrays.asList(new FeedCloudCommon.Entry[] { localObject2, localEntry1, localEntry2, localEntry3, vri.a("video_type", (String)localObject1), vri.a("cubage", String.valueOf(paramStFeed.video.fileSize.get())), vri.a("width", String.valueOf(paramStFeed.video.width.get())), vri.a("height", String.valueOf(paramStFeed.video.height.get())), vri.a("clear", String.valueOf(paramStFeed.video.videoRate.get())), vri.a("play_id", paramStFeed.video.fileId.get()), vri.a("vid", paramStFeed.video.fileId.get()), vri.a("lloc", paramStFeed.cover.picId.get()), vri.a("feed_tag", vse.a(paramStFeed)), vri.a("play_url", paramStFeed.video.playUrl.get()), vri.a("video_tag", paramStFeed.video.playUrl.get()), vri.a("pic_info", paramStFeed.cover.picUrl.get()), vri.a("item_detail", paramStFeed.title.get() + "|" + paramStFeed.content.get()), vri.a("acttime", String.valueOf(System.currentTimeMillis())) }));
    ...
    for (;;)
    {
      try
      {
        ...
        ((ArrayList)localObject1).addAll(Arrays.asList(new FeedCloudCommon.Entry[] { vri.a("feedtype1", String.valueOf(((QQCircleFeedBase.StReportInfoForClient)localObject2).feedtype1.get())), vri.a("feedtype2", String.valueOf(((QQCircleFeedBase.StReportInfoForClient)localObject2).feedtype2.get())), vri.a("feedtype3", String.valueOf(((QQCircleFeedBase.StReportInfoForClient)localObject2).feedtype3.get())) }));
        i = 1;
      }
      ...
      if (i == 0) {
        ((ArrayList)localObject1).addAll(Arrays.asList(new FeedCloudCommon.Entry[] { vri.a("feedtype1", "1"), vri.a("feedtype2", "2") }));
      }
      return localObject1;
      localObject1 = "1";
      break;
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong1, long paramLong2, boolean paramBoolean, String paramString, FeedCloudMeta.StFeed paramStFeed, List<FeedCloudCommon.Entry> paramList, int paramInt5)
  {
    ...
    vrl.a().a().post(new QCircleLpReportDc05507.1(paramList, paramInt1, paramInt2, paramInt3, paramInt5, paramInt4, paramLong1, paramLong2, paramBoolean, paramString, paramStFeed));
  }
  ...
  public static void a(int paramInt1, int paramInt2, ExtraTypeInfo paramExtraTypeInfo, int paramInt3, String paramString)
  {
    ...
    for (;;)
    {
      a(paramString, arrayOfInt[0], arrayOfInt[1], paramInt1, paramInt2, localStFeed.id.get(), localStFeed.poster.id.get(), ((ReportExtraTypeInfo)paramExtraTypeInfo).mPlayScene, paramExtraTypeInfo.mDataPosition, vse.a(localStFeed), localStFeed.video.playUrl.get(), localStFeed.cover.picUrl.get(), localStFeed.title.get() + "|" + localStFeed.content.get(), localStFeed, paramInt3, -1);
      return;
    }
  }
  ...
  public static void a(int paramInt1, int paramInt2, ExtraTypeInfo paramExtraTypeInfo, List<FeedCloudCommon.Entry> paramList, int paramInt3)
  {
    ...
    FeedCloudMeta.StFeed localStFeed = ((ReportExtraTypeInfo)paramExtraTypeInfo).mFeed;
    int[] arrayOfInt = vse.a(localStFeed);
    a(localStFeed.poster.id.get(), arrayOfInt[0], arrayOfInt[1], paramInt1, paramInt2, localStFeed.id.get(), localStFeed.poster.id.get(), ((ReportExtraTypeInfo)paramExtraTypeInfo).mPlayScene, paramExtraTypeInfo.mDataPosition, vse.a(localStFeed), localStFeed.video.playUrl.get(), localStFeed.cover.picUrl.get(), localStFeed.title.get() + "|" + localStFeed.content.get(), localStFeed, "", paramList, paramInt3, -1);
  }
  ...
  public static void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString2, String paramString3, int paramInt5, int paramInt6, String paramString4, String paramString5, String paramString6, String paramString7, FeedCloudMeta.StFeed paramStFeed, String paramString8, List<FeedCloudCommon.Entry> paramList, int paramInt7, int paramInt8)
  {
    ...
    vrl.a().a().post(new QCircleLpReportDc05507.2(paramString1, paramInt3, paramInt4, paramString2, paramString3, paramInt5, paramInt6, paramString4, paramString5, paramString6, paramString7, paramString8, paramInt7, paramInt8, paramList, paramStFeed, paramInt1, paramInt2));
  }
