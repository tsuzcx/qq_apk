  ...
  implements View.OnClickListener
{
  ...
  private zaf jdField_a_of_type_Zaf;
  private View jdField_b_of_type_AndroidViewView;
  private TextView jdField_b_of_type_AndroidWidgetTextView;
  private TextView c;
  private TextView d;
  
  public zad(Activity paramActivity, zaf paramzaf)
  {
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Zaf = paramzaf;
    f();
    a();
  }
  ...
  private void a(View paramView)
  {
    ...
    localObjectAnimator1.setInterpolator(new yzi(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    localObjectAnimator2.setInterpolator(new yzi(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    localObjectAnimator3.setInterpolator(new yzi(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    paramView.setInterpolator(new yzi(0.33F, 0.0F, 0.67F, 1.0F));
  ...
  private void f()
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131374704);
    this.jdField_a_of_type_AndroidViewView.setVisibility(0);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131374700);
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView = ((RecyclerView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374706));
      ...
      this.jdField_a_of_type_Yzr = new yzr(this.jdField_a_of_type_AndroidViewView.getContext(), this, this.jdField_a_of_type_Zaf);
      this.jdField_a_of_type_Yzr.a(yzz.a().a());
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Yzr);
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getRecycledViewPool().setMaxRecycledViews(this.jdField_a_of_type_Yzr.getItemViewType(0), 10);
      this.jdField_a_of_type_Yzr.a(new zae(this));
      new blhq(new yzy(this.jdField_a_of_type_Yzr)).attachToRecyclerView(this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView);
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374707));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374708));
      this.c = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374699));
      this.c.setOnClickListener(this);
      this.d = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131374698));
      this.d.setOnClickListener(this);
      this.jdField_a_of_type_ComTencentBizQqstoryTakevideoSlideshowSlideProgressNotifier = new SlideProgressNotifier(this.jdField_a_of_type_AndroidAppActivity, 2131561447);
      if (a())
      {
        this.jdField_a_of_type_Int = 60000;
        yzz.a().a(this.jdField_a_of_type_Int);
      }
      return;
      i = 0;
      break;
  ...
  public String a()
  {
    if (this.jdField_a_of_type_Yzr != null) {
      return this.jdField_a_of_type_Yzr.a();
    }
    return "";
  }
  ...
  public void a()
  {
    ...
    for (int i1 = localList.size();; i1 = 0)
    {
      ...
      if (i1 > 0)
      {
        ...
        {
          this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167202));
          this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167202));
          if (this.d.getVisibility() != 0)
          {
            localObject = yzz.a().a().iterator();
            i = 0;
            j = 0;
            i2 = 0;
            if (((Iterator)localObject).hasNext())
      ...
      for (;;)
      {
        ...
        if (localSlideItemInfo.jdField_b_of_type_Int == 0)
        {
          ...
          if (m != 0)
          {
            ...
            localObject = "0";
            ykv.a("pic_choose", "exp_autoCut", i3, 0, new String[] { localObject, i2 + "", j + "", i + "" });
            this.d.setVisibility(0);
            if (k == 0) {
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131698926, new Object[] { Integer.valueOf(this.jdField_a_of_type_Int / 1000) }));
            }
            this.jdField_a_of_type_AndroidWidgetTextView.setText(zac.a(l));
          ...
          {
            if (this.jdField_a_of_type_Yzr != null) {
              this.jdField_a_of_type_Yzr.a(localList);
            }
            return;
            i3 = 1;
            break;
            ...
            if (n != 0)
            {
              this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131166931));
              this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167203));
            }
            for (;;)
            {
              this.d.setVisibility(8);
              break;
              this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167363));
            ...
            if (n != 0)
            {
              ...
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131698928));
            }
            for (;;)
            {
              ...
              break label674;
              label753:
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131698927));
            }
            bool = false;
            break label511;
            if (m == 0)
  ...
  {
    if (this.jdField_a_of_type_Yzr != null) {
      this.jdField_a_of_type_Yzr.a(paramInt);
    }
  }
  
  public void b()
  {
    List localList = yzz.a().a();
    if ((this.jdField_a_of_type_AndroidSupportV7WidgetLinearLayoutManager != null) && (this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView != null))
    {
      ...
      while (i <= j)
      {
        ...
        if (localObject != null)
        {
          ...
          if ((localObject instanceof yzu))
          {
            SlideItemInfo localSlideItemInfo1 = (SlideItemInfo)((yzu)localObject).a.getTag();
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131377838: 
      for (;;)
      {
        ...
        i = yzz.a().a().indexOf(localObject1);
        if ((this.jdField_a_of_type_Zaf != null) && (localObject1 != null)) {
          this.jdField_a_of_type_Zaf.a(((SlideItemInfo)localObject1).jdField_b_of_type_JavaLangString);
        }
        a(i);
      }
    case 2131374699: 
      if ((this.jdField_a_of_type_AndroidAppActivity instanceof NewPhotoListActivity))
      {
        ...
        j = 1;
        label130:
        localObject1 = yzz.a().a();
        if ((j == 0) || (i == 0) || (((List)localObject1).size() != 0)) {
          break label347;
        }
        if (this.jdField_a_of_type_Zaf != null) {
          this.jdField_a_of_type_Zaf.a();
        }
        localObject1 = yzz.a().a();
        if ((((List)localObject1).size() >= 1) && (((List)localObject1).size() <= 10) && (((SlideItemInfo)((List)localObject1).get(0)).a() <= 20999L)) {
          yzz.a().a(this.jdField_a_of_type_AndroidAppActivity, null, 2);
        }
      }
      for (;;)
      {
        try
        {
          ...
          if (this.jdField_a_of_type_AndroidAppActivity != null) {
            ykv.a("pic_fictitious", "clk_next", this.jdField_a_of_type_AndroidAppActivity.getIntent(), new String[0]);
          }
          if ((!yzz.a().a()) || (this.jdField_a_of_type_AndroidAppActivity == null)) {
            break;
          }
          ykv.a("video_edit_new", "change_pic", this.jdField_a_of_type_AndroidAppActivity.getIntent(), new String[0]);
        }
        catch (Exception localException) {}
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, bkym.a(localException));
        break;
        i = 1;
        break label117;
        label342:
    ...
    Object localObject2 = yzz.a().a().iterator();
    int k = 0;
    int j = 0;
    int i = 0;
    label462:
    ...
    for (;;)
    {
      ...
      if (localSlideItemInfo.jdField_b_of_type_Int == 0)
      {
        ...
        {
          ykv.a("pic_choose", "clk_autoCut", m, 0, new String[] { localObject2, k + "", j + "", i + "" });
          yzz.a().i();
          break;
          m = 0;
          break label568;
