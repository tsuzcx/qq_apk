  ...
  implements wsp
{
  ...
  public wlb()
  {
    ...
    this.jdField_a_of_type_Wlc = new wld(this);
    Object localObject1 = new wle();
    ((wle)localObject1).a(0);
    localObject1 = ((wle)localObject1).a();
    Object localObject2 = new wle();
    ((wle)localObject2).a(1);
    localObject2 = ((wle)localObject2).a();
    Object localObject3 = new wle();
    ((wle)localObject3).a(2);
    localObject3 = ((wle)localObject3).a();
  ...
  public void a()
  {
    this.jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader.a(this.jdField_a_of_type_Wlc);
  ...
  public void a(int paramInt)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 24	wlb:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   6: iload_1
    ...
    //   41: invokestatic 89	yuk:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   44: aload_0
    //   45: monitorexit
    //   46: return
    //   47: aload_0
    //   48: getfield 29	wlb:jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader	Lcom/tencent/biz/qqstory/base/preload/PreloadDownloader;
    //   51: invokevirtual 92	com/tencent/biz/qqstory/base/preload/PreloadDownloader:a	()I
    //   54: istore_2
    //   55: aload_0
    //   56: getfield 29	wlb:jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader	Lcom/tencent/biz/qqstory/base/preload/PreloadDownloader;
    //   59: invokevirtual 95	com/tencent/biz/qqstory/base/preload/PreloadDownloader:a	()Lwkq;
    //   62: astore 4
    //   64: aload_3
    ...
    //   98: invokestatic 105	yuk:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   101: iload_2
    //   102: iload_1
    //   103: if_icmpne -59 -> 44
    //   106: aload_0
    //   107: getfield 29	wlb:jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader	Lcom/tencent/biz/qqstory/base/preload/PreloadDownloader;
    //   110: aload 4
    //   112: invokevirtual 108	com/tencent/biz/qqstory/base/preload/PreloadDownloader:a	(Lwkq;)V
    //   115: goto -71 -> 44
    //   118: astore_3
    //   119: aload_0
    //   120: monitorexit
  ...
  public void a(List<wkq> paramList, int paramInt, boolean paramBoolean)
  {
    if (paramList == null) {}
    ...
    for (;;)
    {
      ...
      try
      {
        yuk.d("Q.qqstory.download.preload.PreloadDownloaderManager", "setPreloadTaskList , id = %d , size = %d", new Object[] { Integer.valueOf(paramInt), Integer.valueOf(paramList.size()) });
        localPreloadQueue = (PreloadQueue)this.jdField_a_of_type_JavaUtilList.get(paramInt);
        if (localPreloadQueue == null) {
          yuk.d("Q.qqstory.download.preload.PreloadDownloaderManager", "cannot find queue , id = " + paramInt);
        }
      }
      finally {}
    }
    wkq localwkq2 = this.jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader.a();
    if (paramList.size() == 0) {}
    for (wkq localwkq1 = null;; localwkq1 = (wkq)paramList.get(0))
    {
      localPreloadQueue.clearAllTask();
      paramList = paramList.iterator();
      while (paramList.hasNext()) {
        localPreloadQueue.addTask((wkq)paramList.next(), false);
      }
    }
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader.a(localwkq2);
      break;
    }
  }
  ...
  {
    this.jdField_a_of_type_ComTencentBizQqstoryBasePreloadPreloadDownloader.a(paramwku);
  }
