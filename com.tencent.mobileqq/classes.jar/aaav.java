...
public class aaav
{
  ...
  @Nullable
  private static volatile aaav jdField_a_of_type_Aaav;
  @Nullable
  private static volatile aaay jdField_a_of_type_Aaay;
  @NonNull
  private static aabb jdField_a_of_type_Aabb = new aabb();
  public static Vector<aaay> a;
  private static final String b;
  public static Vector<aabd> b;
  public String a;
  ...
  @Nullable
  public static aaav a()
  {
    if (jdField_a_of_type_Aaav == null) {}
    try
    {
      if (jdField_a_of_type_Aaav == null) {
        jdField_a_of_type_Aaav = new aaav();
      }
      return jdField_a_of_type_Aaav;
    }
    finally {}
  }
  ...
  private aaax a()
  {
    aaax localaaax = new aaax(this, null);
    try
    {
      long[] arrayOfLong = jdField_a_of_type_Aabb.a();
      if (arrayOfLong != null)
      {
        aaax.a(localaaax, arrayOfLong[0]);
        aaax.b(localaaax, arrayOfLong[1]);
        aaax.c(localaaax, arrayOfLong[2]);
        aaax.d(localaaax, arrayOfLong[4]);
      }
    }
    catch (Exception localException)
    {
  ...
  private ArrayList<Double> a(int paramInt)
  {
    ...
    //   135: dload_2
    //   136: dstore 8
    //   138: getstatic 56	aaav:jdField_b_of_type_JavaLangString	Ljava/lang/String;
  ...
  private aaay b()
  {
    aaay localaaay = new aaay();
    localaaay.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    localaaay.f = System.currentTimeMillis();
    localaaay.jdField_a_of_type_Long = (localaaay.f / 1000L);
    Object localObject = a();
    long l1;
    label84:
    label106:
    double d;
    if (aaax.a((aaax)localObject) > 0L)
    {
      l1 = aaax.a((aaax)localObject);
      localaaay.c = l1;
      if (aaax.b((aaax)localObject) <= 0L) {
        break label385;
      }
      l1 = aaax.b((aaax)localObject);
      localaaay.d = l1;
      if (aaax.c((aaax)localObject) <= 0L) {
        break label392;
      }
      l1 = aaax.c((aaax)localObject);
      localaaay.e = l1;
      if ((jdField_a_of_type_Long == 0L) || (aaax.d((aaax)localObject) == 9223372036854775807L)) {
        break label399;
      }
      l1 = aaax.d((aaax)localObject) * jdField_a_of_type_Long;
      label142:
      localaaay.jdField_b_of_type_Long = l1;
      if (jdField_a_of_type_Aaay == null) {
        break label462;
      }
      jdField_a_of_type_Aaay.f = localaaay.f;
      jdField_a_of_type_Aaay.jdField_a_of_type_Long = localaaay.jdField_a_of_type_Long;
      if ((jdField_a_of_type_Aaay.c == 9223372036854775807L) || (jdField_a_of_type_Aaay.d == 9223372036854775807L) || (jdField_a_of_type_Aaay.e == 9223372036854775807L)) {
        break label416;
      }
      l1 = localaaay.c;
      long l2 = jdField_a_of_type_Aaay.c;
      long l3 = localaaay.d - jdField_a_of_type_Aaay.d;
      long l4 = localaaay.e;
      long l5 = jdField_a_of_type_Aaay.e;
      if (l3 > 0L)
      {
        localaaay.jdField_a_of_type_Double = ((l1 - l2) * 1.0D / l3);
        localaaay.jdField_b_of_type_Double = (1.0D * (l4 - l5) / l3);
      }
      if (localaaay.jdField_a_of_type_Double <= 0.0D) {
        break label406;
      }
      d = localaaay.jdField_a_of_type_Double;
      label314:
      localaaay.jdField_a_of_type_Double = d;
      if (localaaay.jdField_b_of_type_Double <= 0.0D) {
        break label411;
      }
      d = localaaay.jdField_b_of_type_Double;
      label336:
      localaaay.jdField_b_of_type_Double = d;
    }
    for (;;)
    {
      jdField_a_of_type_Aaay.c = localaaay.c;
      jdField_a_of_type_Aaay.d = localaaay.d;
      jdField_a_of_type_Aaay.e = localaaay.e;
      return localaaay;
      ...
      localaaay.jdField_b_of_type_Double = ((Double)((ArrayList)localObject).get(0)).doubleValue();
      localaaay.jdField_a_of_type_Double = ((Double)((ArrayList)localObject).get(1)).doubleValue();
    }
    label462:
    jdField_a_of_type_Aaay = new aaay();
    jdField_a_of_type_Aaay.f = localaaay.f;
    jdField_a_of_type_Aaay.jdField_a_of_type_Long = localaaay.jdField_a_of_type_Long;
    jdField_a_of_type_Aaay.c = localaaay.c;
    jdField_a_of_type_Aaay.d = localaaay.d;
    jdField_a_of_type_Aaay.e = localaaay.e;
    localaaay.jdField_a_of_type_Double = 0.0D;
    localaaay.jdField_b_of_type_Double = 0.0D;
    return localaaay;
  }
  ...
  public aaay a()
  {
    aaay localaaay = b();
    if (localaaay != null) {
      jdField_a_of_type_JavaUtilVector.add(localaaay);
    }
    return localaaay;
  }
}
