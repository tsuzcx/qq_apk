  ...
  extends aqbe
{
  ...
  protected View a()
  {
    ...
    localFrameLayout.setMinimumHeight(bbll.a(85.0F));
    int j = bbll.a(15.0F);
    ...
    localImageView.setMaxWidth(bbll.a(120.0F));
    localImageView.setMaxHeight(bbll.a(120.0F));
  ...
  protected void e()
  {
    ...
    for (Object localObject = AIOEmotionFragment.a; localObject == null; localObject = adue.a) {
      return;
    }
    localObject = ((aobp)localObject).a("fromAIO", false);
    ((URLDrawable)localObject).setBounds(bbef.a((Drawable)localObject, 36, 100, this.jdField_a_of_type_Float));
    this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
    ((URLDrawable)localObject).setURLDrawableListener(new aqcv(this));
  }
