...
{
  public aapz(RelativePersonalBottomView paramRelativePersonalBottomView) {}
  ...
  public void onCheckedChanged(RadioGroup paramRadioGroup, int paramInt)
  {
    ...
    for (boolean bool = apdr.a(this.a.getContext());; bool = true)
    {
      if (!bool)
      {
        bhlq.b((PublicFragmentActivity)this.a.getContext());
