  ...
  extends WebViewPlugin
{
  ...
  private SparseArray<WeakReference<aaqb>> jdField_a_of_type_AndroidUtilSparseArray;
  ...
  aaqb a(int paramInt)
  {
    ...
    Object localObject = new aaqb(this, null);
    ((aaqb)localObject).jdField_a_of_type_Int = paramInt;
    localObject = new WeakReference(localObject);
    this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, localObject);
    return (aaqb)((WeakReference)localObject).get();
  }
  ...
  boolean a(int paramInt)
  {
    ...
    localObject = (aaqb)((WeakReference)localObject).get();
    if (localObject == null) {
      return false;
    }
    try
  ...
  public void onDestroy()
  {
    ...
    if ((this.jdField_a_of_type_AndroidUtilSparseArray != null) && (this.jdField_a_of_type_AndroidUtilSparseArray.size() > 0))
    {
      ...
      {
        aaqb localaaqb = (aaqb)((WeakReference)this.jdField_a_of_type_AndroidUtilSparseArray.get(i)).get();
        if (localaaqb != null) {
          a(localaaqb.jdField_a_of_type_Int);
        }
        i += 1;
      }
    }
