...
public class ydl
  implements Runnable
{
  public ydl(CameraFilterGLView paramCameraFilterGLView, SVFilterEncodeDoubleCache.SharedMemoryCache paramSharedMemoryCache) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          ThreadManager.getUIHandler().post(new ydm(this, localFile));
    ...
    label279:
    ThreadManager.getUIHandler().post(new ydn(this));
  }
}
