  ...
  implements Manager
{
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    aukn localaukn = paramQQAppInterface.getEntityManagerFactory(paramQQAppInterface.getAccount()).createEntityManager();
    if (localaukn != null)
    {
      NearbyPeopleCard localNearbyPeopleCard = (NearbyPeopleCard)localaukn.a(NearbyPeopleCard.class, "uin=?", new String[] { paramQQAppInterface.getCurrentAccountUin() });
  ...
  {
    atbp.a("Q.nearby", "updateNearbyPeopleCard", new Object[] { paramString, paramCharmEvent, paramNearbyCharmNotify });
    ...
    do
    {
      ...
      if (!bbjw.a(paramString)) {
        paramQQAppInterface = (NearbyPeopleCard)localaukn.a(NearbyPeopleCard.class, "uin=?", new String[] { paramString });
      }
    ...
    for (;;)
    {
      localaukn.a(paramQQAppInterface);
      localaukn.a();
      return;
  ...
  public static boolean a(Activity paramActivity, String paramString1, String paramString2, int paramInt)
  {
    ...
    if (paramInt == 1) {
      axqw.b(null, "dc00899", "grp_lbs", "", "app_down", "exp_msg", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      bbcv.a(paramActivity, 230).setMessage(paramString1).setNegativeButton(ajyc.a(2131707110), new aszf()).setPositiveButton(ajyc.a(2131707113), new asze(paramString2, paramInt, paramActivity)).show();
      return true;
      if (paramInt == 2) {
        axqw.b(null, "dc00899", "grp_lbs", "", "app_down", "exp_pic", 0, 0, "", "", "", "");
      }
    }
  }
  ...
  public int a()
  {
    ...
    {
      localCard = ((ajxn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
  ...
  public void a(int paramInt)
  {
    if (paramInt != this.jdField_b_of_type_Int)
    {
      ...
      atbg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "self_age", Integer.valueOf(this.jdField_b_of_type_Int));
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 31	aszd:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   6: ifnull +19 -> 25
    //   9: aload_0
    //   10: getfield 31	aszd:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    ...
    //   27: return
    //   28: aload_0
    //   29: getfield 31	aszd:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   32: aload_1
    //   33: invokevirtual 287	java/util/concurrent/ConcurrentHashMap:containsKey	(Ljava/lang/Object;)Z
    //   36: ifeq -11 -> 25
    //   39: aload_0
    //   40: getfield 31	aszd:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   43: aload_1
  ...
  public void a(oidb_0x8dd.SelfInfo paramSelfInfo)
  {
    ...
    if (localaukn != null)
    {
      localObject2 = (NearbyPeopleCard)localaukn.a(NearbyPeopleCard.class, "uin=?", new String[] { this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() });
      localObject1 = localObject2;
      if (localObject2 == null)
      {
        localObject1 = localObject2;
        if (paramSelfInfo.uint64_tinyid.get() > 0L) {
          localObject1 = (NearbyPeopleCard)localaukn.a(NearbyPeopleCard.class, "tinyId=?", new String[] { String.valueOf(paramSelfInfo.uint64_tinyid.get()) });
        }
      }
      ...
      localObject1 = ((ajxn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      if (localObject1 != null)
      {
        i = paramSelfInfo.uint32_vote_num.get();
        if ((!paramSelfInfo.uint32_vote_num.has()) || (i <= 0)) {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (j != 0)
      {
        atbg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), ((Card)localObject1).lVoteCount, ((Card)localObject1).iVoteIncrement);
        localaukn.a((aukm)localObject1);
      }
      localaukn.a();
      b(paramSelfInfo.uint32_gender.get());
      a(paramSelfInfo.uint32_age.get());
      atbg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "self_third_line_info", paramSelfInfo.str_third_line_info.get());
      atbg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "self_third_line_icon", paramSelfInfo.str_third_line_icon.get());
      return;
      label482:
  ...
  public boolean a()
  {
    return ((Boolean)atbg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "self_god_flag", Boolean.valueOf(false))).booleanValue();
  }
  ...
  public boolean a(NearbyPeopleCard paramNearbyPeopleCard, String paramString, boolean paramBoolean1, boolean paramBoolean2, int paramInt, boolean paramBoolean3)
  {
    ...
    for (long l = ((Long)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramNearbyPeopleCard.uin)).longValue();; l = ((Long)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramNearbyPeopleCard.uin)).longValue())
    {
      ...
      if (!bbbd.a(paramString, paramNearbyPeopleCard.uin)) {
        break;
      }
      if (l < 300000L) {
        break label316;
    ...
    label316:
    return (!TextUtils.isEmpty(paramNearbyPeopleCard.uin)) && (((atah)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(207)).a(paramNearbyPeopleCard.uin));
  }
    ...
    for (;;)
    {
      if (i != this.jdField_a_of_type_Int)
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null) {
            ((aqye)localObject).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), null, paramInt, NetConnInfoCenter.getServerTime());
          }
        }
        atbg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "self_gender", Integer.valueOf(this.jdField_a_of_type_Int));
      }
      return;
