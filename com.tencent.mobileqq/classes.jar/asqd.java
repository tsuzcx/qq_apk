...
public class asqd
  extends Handler
{
  public asqd(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      ...
      return;
    case 3: 
      this.a.jdField_a_of_type_Asqe.a(1, false);
      return;
    case 4: 
      i = paramMessage.arg1;
      k = paramMessage.arg2;
    ...
    for (;;)
    {
      ...
      if (k == 1)
      {
        paramMessage = (asqy)paramMessage.obj;
        if (paramMessage.a)
        {
          i = 2;
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        {
          this.a.jdField_a_of_type_Asqe.c();
          bool1 = true;
        }
        for (;;)
        {
          ...
          this.a.jdField_a_of_type_Asqe.a(paramMessage, ((Boolean)localObject).booleanValue(), i, bool2, bool1);
          ...
          paramMessage = (asqw)paramMessage.obj;
          if (this.a.b == 0)
          {
          ...
          for (;;)
          {
            ...
            this.a.jdField_c_of_type_JavaUtilHashMap.put(paramMessage.e, Integer.valueOf(i));
            break label444;
            if (this.a.jdField_a_of_type_Anos == null) {
              break;
            }
            this.a.jdField_a_of_type_Anos.a(this.a.app.getCurrentAccountUin(), true);
            ...
            paramMessage = this.a.getResources().getString(2131691943);
            QQToast.a(this.a, 0, paramMessage, 0).b(this.a.getTitleBarHeight());
            return;
            this.a.a();
            return;
            this.a.jdField_a_of_type_Asqe.b();
            return;
            this.a.f();
            return;
            Face2FaceAddFriendActivity.a(this.a, (asqw)paramMessage.obj);
            return;
            Face2FaceAddFriendActivity.a(this.a, paramMessage.arg1);
            return;
            this.a.a((asqt)paramMessage.obj);
            return;
            paramMessage = this.a.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
            while (paramMessage.hasNext())
            {
              localObject = (asqw)paramMessage.next();
              if ((((asqw)localObject).a == 1) && (Face2FaceAddFriendActivity.a(this.a, ((asqw)localObject).e))) {
                Face2FaceAddFriendActivity.a(this.a, ((asqw)localObject).a);
              } else if ((((asqw)localObject).a == 2) && (this.a.a(((asqw)localObject).e))) {
                Face2FaceAddFriendActivity.a(this.a, ((asqw)localObject).a);
              }
            }
            long l = this.a.o;
            paramMessage = new asqx(l + 2396794490L + "", "Member " + this.a.o, 1, 1, "");
            localObject = this.a;
            ...
            return;
            if (!(paramMessage.obj instanceof asqx)) {
              break;
            }
            paramMessage = (asqx)paramMessage.obj;
            this.a.a(paramMessage);
            return;
            if (!(paramMessage.obj instanceof asqx)) {
              break;
            }
            this.a.jdField_a_of_type_JavaUtilArrayList.add((asqx)paramMessage.obj);
            return;
            if (!(paramMessage.obj instanceof asqx)) {
              break;
            }
            Face2FaceAddFriendActivity.a(this.a).a((asqx)paramMessage.obj);
            return;
