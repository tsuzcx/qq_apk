...
{
  ssk(ssi paramssi, Intent paramIntent, Activity paramActivity) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ssi.a(this.jdField_a_of_type_Ssi).dismiss();
    if (paramBoolean) {}
    for (;;)
    {
      try
      ...
      catch (Exception paramBundle)
      {
        ...
        QLog.e(ssi.a(), 2, paramBundle.getMessage());
        continue;
      ...
      QLog.e(ssi.a(), 2, "build struct msg fail");
      return;
