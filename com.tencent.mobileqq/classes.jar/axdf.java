  ...
  implements BusinessObserver
{
  ...
  private boolean a(axdb paramaxdb)
  {
    if ((paramaxdb == null) || (paramaxdb.b == null) || (paramaxdb.a == null)) {}
    while ((paramaxdb.a.equals("")) && (paramaxdb.b.equals(""))) {
      return false;
    }
    return true;
  }
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    localaxdb.b = (str2 + "\n" + str1 + "\n");
    localaxdb.a = str1;
    localaxdb.k = paramBundle;
    localaxdb.j = str8;
    localaxdb.c = (NumberFormat.getNumberInstance().format(l2) + "\n同比:" + str3 + "\n环比:" + str4 + "\n");
    localaxdb.d = str3;
    localaxdb.e = str4;
    localaxdb.f = (NumberFormat.getNumberInstance().format(l3) + "\n同比:" + str5 + "\n环比:" + str6 + "\n");
    localaxdb.g = str5;
    localaxdb.h = str6;
    localaxdb.i = str7;
