...
public class bflj
{
  public static int a(MessageRecord paramMessageRecord)
  {
    ...
    {
      return -1;
      paramMessageRecord = paramMessageRecord.getExtInfoFromExtStr(bbyw.E);
  ...
  private static String a(QQAppInterface paramQQAppInterface, Context paramContext, MessageRecord paramMessageRecord)
  {
    ...
    bgnr.a(paramContext, paramQQAppInterface, localMessage, localMessage.istroop, paramMessageRecord, "", false, false);
  ...
  {
    Object localObject = (bflb)aqlk.a().a(658);
    if (localObject == null) {
      return "";
    }
    localObject = ((bflb)localObject).a(paramInt);
    if (localObject == null) {
      return "";
    }
    if (((bflc)localObject).a == 0) {
      return a(paramQQAppInterface, paramContext, paramInt, paramMessageRecord);
    }
    if (((bflc)localObject).a == 1) {
      return ((bflc)localObject).b;
    }
    if (((bflc)localObject).a == 2) {
  ...
  {
    String str2 = BaseApplicationImpl.getContext().getResources().getString(2131718756);
    String str1 = str2;
  ...
  {
    String str = BaseApplicationImpl.getContext().getResources().getString(2131718755);
    if (paramBoolean) {
      str = BaseApplicationImpl.getContext().getResources().getString(2131718757);
    }
    for (;;)
    {
      Object localObject;
      ...
      do
      {
        do
        {
          do
          {
            ...
            paramMessageRecord = bcwd.a(paramMessageRecord.msgData);
            localObject = str;
      ...
      try
      {
        ...
        if (localMsg.msg_body.has())
        {
          ...
          if (paramBackMsg.rich_text.has())
          {
            ...
            new bbzt().a(paramQQAppInterface, localMsg, paramList, null);
          }
        }
        if ((paramList.size() == 0) && (j > 1))
        {
          ...
          paramQQAppInterface = (MessageForText)bbzh.a(-1000);
        ...
        continue;
        bbzf.a(paramQQAppInterface, paramList, localMsg, false, false, new bepr());
      }
  ...
  public static boolean a(MessageRecord paramMessageRecord)
  {
    ...
    {
      return false;
      paramMessageRecord = paramMessageRecord.getExtInfoFromExtStr(bbyw.D);
  ...
  {
    String str = BaseApplicationImpl.getContext().getResources().getString(2131718754);
    if ((paramMessageRecord instanceof MessageForArkApp))
    {
      paramMessageRecord = ((MessageForArkApp)paramMessageRecord).ark_app_message;
      if (paramMessageRecord == null) {}
  ...
  {
    String str = BaseApplicationImpl.getContext().getResources().getString(2131718759);
    if ((paramMessageRecord instanceof MessageForArkApp))
    {
      paramMessageRecord = ((MessageForArkApp)paramMessageRecord).ark_app_message;
      if (paramMessageRecord != null) {
  ...
  {
    String str = BaseApplicationImpl.getContext().getResources().getString(2131718758);
    if ((paramMessageRecord instanceof MessageForArkApp))
    {
      paramMessageRecord = ((MessageForArkApp)paramMessageRecord).ark_app_message;
