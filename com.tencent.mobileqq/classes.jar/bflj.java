  ...
  implements WXShareHelper.WXShareListener
{
  ...
  protected bflq a;
  protected bhht a;
  binf jdField_a_of_type_Binf = new bfln(this);
  protected bjnw a;
  protected bjok a;
  ...
  public bflj(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData)
  {
    this(paramBaseActivity, paramTroopInfoData, null);
  }
  
  public bflj(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData, bflq parambflq)
  {
    this.jdField_a_of_type_Int = -1;
    this.jdField_b_of_type_Int = -1;
    this.jdField_a_of_type_Andd = new bflm(this);
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData = paramTroopInfoData;
    if (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.addObserver(this.jdField_a_of_type_Binf);
  ...
  public static Bitmap a(String paramString, Resources paramResources, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    catch (OutOfMemoryError paramString)
    {
      ...
      if (paramBoolean)
      {
        ...
        paramResources = bfpx.a(paramResources, 2130839698);
  ...
  public static String a(String paramString, Context paramContext)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      str = paramContext.getString(2131718413);
    }
    return str;
  }
  ...
  public static void a(Activity paramActivity, Bundle paramBundle, int paramInt)
  {
    try
    {
      localAbsShareMsg = new bcgt(StructMsgForGeneralShare.class).c(132).a(paramBundle.getString("summary")).e(paramBundle.getString("targetUrl")).a(1105290942L).a();
      ...
      for (localAbsShareMsg.mSourceName = "NOW";; localAbsShareMsg.mSourceName = "")
      {
        ...
        ((bcgx)localObject).a(paramBundle.getString("imageUrl"), paramBundle.getString("title"), str);
        ...
        atky.a(paramActivity, paramBundle, paramInt);
        return;
  ...
  public static void a(Activity paramActivity, MessageForQQStory paramMessageForQQStory, int paramInt)
  {
    try
    {
      AbsShareMsg localAbsShareMsg = new bcgt(StructMsgForGeneralShare.class).c(80).a(paramMessageForQQStory.brief).e("").a();
      ...
      try
      {
        ...
        atky.a(paramActivity, (Intent)localObject, paramInt);
        if (QLog.isColorLevel())
        {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, int paramInt, Intent paramIntent)
  {
    ...
    localIntent = AIOUtils.setOpenAIOIntent(new Intent(paramActivity, SplashActivity.class), null);
    localIntent.putExtras(new Bundle(paramIntent.getExtras()));
    ForwardUtils.handleAppShareAction(paramQQAppInterface, paramActivity, ForwardUtils.sessionFromIntent(localIntent), localIntent);
    return;
  }
  ...
  public static List<ShareActionSheetBuilder.ActionSheetItem>[] a(Context paramContext, boolean paramBoolean)
  {
    ...
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).label = paramContext.getString(2131695878);
    ...
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).label = paramContext.getString(2131695891);
    ...
    localArrayList.add(localObject);
    localObject = new ShareActionSheetBuilder.ActionSheetItem();
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).label = paramContext.getString(2131695881);
    ...
    localActionSheetItem.label = paramContext.getString(2131695870);
    ...
    if (paramBoolean)
    {
      ...
      localActionSheetItem.label = paramContext.getString(2131716154);
      localActionSheetItem.icon = 2130842473;
      localActionSheetItem.iconNeedBg = true;
  ...
  public static void b(Activity paramActivity, Bundle paramBundle, int paramInt)
  {
    try
    {
      Object localObject = new bcgt(StructMsgForGeneralShare.class);
      if ("action_mqq".equals(paramBundle.getString("jump_action")))
      {
        localObject = ((bcgt)localObject).c(129).a(paramBundle.getString("summary")).a(1104763709L).a();
      ...
      for (;;)
      {
        ...
        String str = paramBundle.getString("summary");
        localbcgx.a(paramBundle.getString("imageUrl"), paramBundle.getString("title"), str);
        ...
        atky.a(paramActivity, paramBundle, 21, -1);
        return;
        localObject = ((bcgt)localObject).c(129).a(paramBundle.getString("summary")).e(paramBundle.getString("targetUrl")).a(1104763709L).a();
        ((AbsShareMsg)localObject).mMsgBrief = paramBundle.getString("summary");
        ((AbsShareMsg)localObject).mContentSummary = paramBundle.getString("summary");
        ((AbsShareMsg)localObject).mContentTitle = paramBundle.getString("title");
        ((AbsShareMsg)localObject).mSourceAction = "";
  ...
  private void h()
  {
    ...
    do
    {
      ...
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 0, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131719201), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      ...
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 0, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131697225), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      localObject = "";
      if (this.jdField_b_of_type_Int == 1)
      ...
      for (;;)
      {
        ...
        bcef.b(localQQAppInterface, "CliOper", "", "", "Grp", (String)localObject, 0, 0, str, "", "", "");
        ...
        if (this.jdField_a_of_type_Bflq != null) {
          this.jdField_a_of_type_Bflq.onShareResp(this.jdField_a_of_type_Int, false);
        }
        this.jdField_a_of_type_Int = -1;
        this.jdField_b_of_type_Int = -1;
    ...
    {
      ((bing)localQQAppInterface.getBusinessHandler(85)).b(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
      return;
    }
    Object localObject = (anca)localQQAppInterface.getBusinessHandler(20);
    ...
    default: 
      return;
    case 0: 
      this.jdField_c_of_type_JavaLangString = beyx.a("", this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, 0);
      l();
      return;
    case 3: 
      i();
  ...
  private void i()
  {
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty((CharSequence)localObject3)) {
        localObject1 = amtj.a(2131714803) + ContactUtils.getTroopMemberNameWithoutRemark(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
      }
      WXShareHelper.getInstance().addObserver(this);
      WXShareHelper.getInstance().shareTroopToWXFriendCircle(this.e, (String)localObject2, localBitmap, (String)localObject1, str);
      if (QLog.isColorLevel()) {
  ...
  private void j()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopName == null)
    {
      ...
      str1 = amtj.a(2131714799) + ContactUtils.getTroopMemberNameWithoutRemark(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
    }
    label337:
    for (;;)
    {
      str1 = a(str1, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
      WXShareHelper.getInstance().shareTroopToWXFriend(str2, localStringBuffer.toString(), localBitmap, str1, str3);
      if (QLog.isColorLevel()) {
  ...
  private void k()
  {
    ...
    if (bool)
    {
      ...
      localObject1 = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131718408), new Object[] { localObject2 }) + "(" + this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin + ")" + a();
      ...
      ((Bundle)localObject3).putString("desc", amtj.a(2131714802) + ContactUtils.getTroopMemberNameWithoutRemark(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin));
    }
    for (;;)
    {
      ...
      this.jdField_b_of_type_Int = -1;
      return;
      localObject1 = beyx.a("", this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, 0) + "100";
      break;
      label539:
  ...
  private void l()
  {
    ...
    for (localObject3 = (String)localObject1 + "(" + ((TroopInfo)localObject3).wMemberNum + ")";; localObject3 = localObject1)
    {
      ...
      AbsShareMsg localAbsShareMsg = new bcgt(StructMsgForGeneralShare.class).c(15).a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131717624) + (String)localObject3).a("web", a(), (String)localObject1, (String)localObject1, (String)localObject1).a();
      ...
      for (;;)
      {
        ...
        localbcla.b(1);
        localbcla.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131695668));
        bcgx localbcgx = bchg.a(2);
        String str = this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.mRichFingerMemo;
        if (TextUtils.isEmpty(str))
        {
          localObject2 = amtj.a(2131714801) + ContactUtils.getTroopMemberNameWithoutRemark(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
          label423:
          localbcgx.a((String)localObject1, (String)localObject3, (String)localObject2, 1);
          localAbsShareMsg.addItem(localbcla);
        ...
        for (int i = 21;; i = 3)
        {
          atky.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (Intent)localObject2, i);
          if ((this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity instanceof TroopCreateLogicActivity)) {
  ...
  private void m()
  {
    ...
    str1 = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131693224), new Object[] { str1, a() });
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131691183), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
      if (this.jdField_a_of_type_Bflq != null) {
        this.jdField_a_of_type_Bflq.onShareResp(this.jdField_a_of_type_Int, true);
      }
      this.jdField_a_of_type_Int = -1;
      this.jdField_b_of_type_Int = -1;
      return;
  ...
  public void a()
  {
    try
    {
      if ((this.jdField_a_of_type_Bhht == null) && (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null))
      {
  ...
  public void a(bflr parambflr)
  {
    ThreadManager.post(new TroopShareUtility.10(this, parambflr), 8, null, false);
  }
  ...
  public void a(TroopInfoData paramTroopInfoData)
  {
    ...
    bcef.b((QQAppInterface)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppRuntime(), "CliOper", "", "", "Grp", "Clk_share_grplink", 0, 0, "", "", "", "");
    this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData = paramTroopInfoData;
    d();
  }
  ...
  protected void b(boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        str1 = "0";
        localbcek = new bcek(null).a("P_CliOper").b("Grp_set").c("Grp_data").d((String)localObject);
    ...
    {
      localbcek.a(new String[] { str2, localObject, str1 }).a();
      return;
  ...
  protected void d()
  {
    ...
    for (int i = 5;; i = 4)
    {
      ...
      while (j <= i)
      {
        ((List)localObject).add(bjok.a(j));
        j += 1;
      }
    }
    if ((this.jdField_a_of_type_Bjok == null) && (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null)) {
      this.jdField_a_of_type_Bjok = new bjok(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
    }
    if (this.jdField_a_of_type_Bjok != null) {
      this.jdField_a_of_type_Bjok.a((List)localObject);
    }
    if (this.jdField_a_of_type_Bjnw == null)
    {
      localObject = new bflk(this);
      if (this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder == null)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setOnDismissListener(new bfll(this));
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.cancel.setVisibility(8);
      return;
    }
    catch (Exception localException)
    {
  ...
  public void e()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.removeObserver(this.jdField_a_of_type_Binf);
  ...
  public void f()
  {
    ...
    localIntent.putExtra("title", amtj.a(2131714798));
    int i;
  ...
  public void onWXShareResp(BaseResp paramBaseResp)
  {
    ...
    if (this.jdField_a_of_type_Bflq != null)
    {
      bflq localbflq = this.jdField_a_of_type_Bflq;
      int i = this.jdField_a_of_type_Int;
      if (paramBaseResp.errCode == 0)
      {
        bool = true;
        localbflq.onShareResp(i, bool);
      }
    }
    else
    {
      ...
      case -1: 
      default: 
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 1, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131718380), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
      }
    }
    for (;;)
    {
      ...
      bool = false;
      break;
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131718398), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
    }
  }
}
