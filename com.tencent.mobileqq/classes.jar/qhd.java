  ...
  extends qhj
{
  ...
  public qhd(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qxn paramqxn, Handler paramHandler)
  {
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      i = qxp.a(paramFromServiceMsg, paramObject, paramToServiceMsg);
    ...
    bjum.a().post(new ReadInJoyDianDianEntranceModule.1(this, paramObject));
  }
  ...
  public void a()
  {
    ...
    localReqBody.uint32_req_recommend_flag.set(omv.a());
    localReqBody.uint64_uin.set(pkh.a());
    String str = (String)bmhv.a(tsp.f, "");
    if (!TextUtils.isEmpty(str)) {
      localReqBody.bytes_entrance_cookie.set(ByteStringMicro.copyFromUtf8(str));
    }
    a(qxp.a("OidbSvc.0x6cf", 1743, 1, localReqBody.toByteArray()));
  ...
  public void b(int paramInt)
  {
    ...
    localObject = qxp.a("OidbSvc.0xdcb", 3531, 0, ((oidb_cmd0xdcb.ReqBody)localObject).toByteArray());
