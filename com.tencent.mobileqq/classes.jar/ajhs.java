  ...
  extends ayoi
{
  ...
  public static URLDrawable a(boolean paramBoolean1, String paramString1, URLDrawable.URLDrawableOptions paramURLDrawableOptions, String paramString2, boolean paramBoolean2)
  {
    ...
    if (!paramBoolean1) {}
    for (String str = ajms.k + "boxcard/" + paramString1;; str = paramString1)
    {
      ...
      if (localURLDrawableOptions.mExtraInfo == null) {
        localURLDrawableOptions.mExtraInfo = new ajht();
      }
      paramBoolean1 = paramBoolean2;
      if ((localURLDrawableOptions.mExtraInfo instanceof ajht))
      {
        paramURLDrawableOptions = (ajht)localURLDrawableOptions.mExtraInfo;
  ...
  public static boolean a(String paramString)
  {
    ...
    {
      return false;
      String str = ajms.k + paramString.substring(paramString.lastIndexOf("/") + 1);
  ...
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    if ((paramDownloadParams.mExtraInfo != null) && ((paramDownloadParams.mExtraInfo instanceof ajht)))
    {
      paramOutputStream = (ajht)paramDownloadParams.mExtraInfo;
      ...
      do
      {
        ...
        bbwu localbbwu = new bbwu(paramOutputStream, paramDownloadParams);
        localbbwu.b = 1;
        localbbwu.p = false;
        localbbwu.q = true;
        localbbwu.r = true;
        i = bbww.a(localbbwu, null);
        if (i != 0) {
          break;
        }
        if (paramURLDrawableHandler != null) {
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    ajht localajht;
    if ((paramFile != null) && (paramDownloadParams.mExtraInfo != null) && ((paramDownloadParams.mExtraInfo instanceof ajht)))
    {
      localajht = (ajht)paramDownloadParams.mExtraInfo;
      if (localajht.jdField_a_of_type_Int != jdField_a_of_type_Int) {
        break label102;
      }
    }
    for (;;)
    {
      try
      {
        ...
        localBitmap = bbef.a(localBitmap, localBitmap.getWidth(), localBitmap.getHeight());
      ...
      } while (localajht.jdField_a_of_type_Int != b);
      if (paramFile.exists())
      {
        ...
        paramURLDrawableHandler.inSampleSize = bbef.a(paramURLDrawableHandler, paramDownloadParams.reqWidth, paramDownloadParams.reqHeight);
        ...
        try
        {
          ...
          if (paramFile != null) {
            if (localajht.jdField_a_of_type_Boolean)
            {
              i = 2130848934;
              paramDownloadParams = bbef.a(paramFile, i, paramDownloadParams.reqWidth, paramDownloadParams.reqHeight, true);
