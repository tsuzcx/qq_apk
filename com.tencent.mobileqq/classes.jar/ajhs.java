  ...
  implements Cloneable
{
  ...
  public ajhs(Context paramContext, boolean paramBoolean)
  {
    this.jdField_a_of_type_JavaLangString = paramContext.getString(2131720820);
    if (paramBoolean) {
      this.jdField_a_of_type_JavaLangString = paramContext.getString(2131720821);
    }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    if (QLog.isColorLevel()) {
      QLog.d(ajhs.class.getSimpleName(), 2, "deSerialize");
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(ajhs.class.getSimpleName(), 2, "serialize");
    }
    return b();
  }
