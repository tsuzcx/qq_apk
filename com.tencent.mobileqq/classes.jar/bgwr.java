...
public class bgwr
  extends bgvv
  implements Handler.Callback, AdapterView.OnItemClickListener, uie
{
  ...
  uic jdField_a_of_type_Uic = null;
  public boolean a;
  int b;
  public String b;
  public boolean b;
  ...
  private void b()
  {
    this.jdField_a_of_type_Sxb = new sxb(this.jdField_a_of_type_AndroidAppActivity);
    ...
    {
      this.jdField_a_of_type_Sxb.a((String)localObject);
      return;
    }
  }
  ...
  View a()
  {
    Object localObject = (SwiftBrowserUIStyleHandler)this.mComponentContext.a().a(2);
    if ((((SwiftBrowserUIStyleHandler)localObject).mUIStyle.isFullScreen) || (((SwiftBrowserUIStyleHandler)localObject).mUIStyle.isTransparentTitle)) {}
    for (int i = 2131363709;; i = 2131378819)
    {
      ...
      {
        localObject = localView;
        if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler != null)
        {
          localObject = localView;
          if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.mRootView != null) {
            localObject = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.contentView;
          }
        }
      }
      return localObject;
  ...
  public String a()
  {
    return this.jdField_a_of_type_Sxb.a();
  }
  ...
  public void a(Uri paramUri, String paramString, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Sxb != null) {
      paramUri = this.jdField_a_of_type_Sxb.c();
    }
    int i;
    for (;;)
    {
      ...
      try
      {
        ...
        bcef.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A69", "0X8006A69", 0, 0, "", paramString, "", "");
        odq.a("0X8006A69", "", "", paramString, "", "");
        if (QLog.isDevelopLevel()) {
    ...
    this.jdField_a_of_type_AndroidGraphicsBitmap = sxa.a(this.jdField_a_of_type_AndroidAppActivity.getWindow(), paramString);
    if (this.jdField_a_of_type_AndroidGraphicsBitmap != null)
    {
      if (this.jdField_a_of_type_Sxb != null) {
        this.jdField_a_of_type_Sxb.a(paramInt);
      }
      if (paramInt != 1) {
        break label477;
      }
    ...
    for (;;)
    {
      ...
      label477:
      if (paramInt == 2) {
        QQToast.a(BaseApplicationImpl.getContext(), 0, 2131694798, 0).b(BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131299076));
      }
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Sxb != null) {
      this.jdField_a_of_type_Sxb.a(paramString);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Sxb != null) {
      this.jdField_a_of_type_Sxb.a(paramString1, paramString2, paramInt);
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Sxb.a().show();
  ...
  {
    if (this.jdField_a_of_type_Sxb != null) {
      this.jdField_a_of_type_Sxb.a(paramJSONArray);
    }
  }
  ...
  void a(boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
        ...
        do
        {
          ...
          if ((this.jdField_a_of_type_AndroidWidgetLinearLayout != null) && ((this.jdField_a_of_type_AndroidWidgetLinearLayout.getTag() instanceof Integer)))
          {
            ...
            if (i != paramInt)
            {
              ...
              localObject = (RelativeLayout)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131363709);
              if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.mRootView != null)) {
                this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.mRootView.findViewById(2131363709);
              }
          ...
          if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
          {
            ...
            this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)LayoutInflater.from(BaseApplicationImpl.getContext()).inflate(2131559637, null));
            localObject = (RelativeLayout)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131363709);
            if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.mRootView != null)) {
              this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.mRootView.findViewById(2131363709);
            }
            ...
            localLayoutParams.setMargins(0, 0, AIOUtils.dp2px(10.0F, BaseApplicationImpl.getContext().getResources()), AIOUtils.dp2px(65.0F, BaseApplicationImpl.getContext().getResources()));
            ...
            if (paramInt == 2)
            {
              localObject = (LinearLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131376851).getLayoutParams();
              ((LinearLayout.LayoutParams)localObject).width = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131297582);
              ((LinearLayout.LayoutParams)localObject).height = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131297583);
            }
            this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131376851).setOnClickListener(new bgwt(this));
          }
          ...
          ((ImageView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131376851)).setImageBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap);
      ...
      ((AlphaAnimation)localObject).setAnimationListener(new bgwu(this));
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Uic != null;
  }
  
  public void b(String paramString)
  {
    if ((this.jdField_a_of_type_Uic == null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      ...
      this.jdField_a_of_type_Uic = new uic(this.jdField_a_of_type_AndroidAppActivity, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
      this.jdField_a_of_type_Uic.a(this);
      localObject = a();
      if (localObject != null)
      {
        ((View)localObject).setDrawingCacheEnabled(true);
        ((View)localObject).getViewTreeObserver().addOnGlobalLayoutListener(new bgws(this, (View)localObject));
      }
      if (QLog.isColorLevel()) {
    ...
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_Sxb != null)) {
      this.jdField_a_of_type_Sxb.c(paramString.replace("|", "｜"));
    }
    while ((this.jdField_a_of_type_Sxb == null) || (!TextUtils.isEmpty(this.jdField_a_of_type_Sxb.b())) || (this.jdField_a_of_type_AndroidAppActivity == null)) {
      return;
    }
    this.jdField_a_of_type_Sxb.c(BaseApplicationImpl.getContext().getResources().getString(2131694796));
  }
  ...
  {
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_Sxb != null)) {
      this.jdField_a_of_type_Sxb.b(paramString);
    }
  }
  ...
  {
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_Sxb != null)) {
      this.jdField_a_of_type_Sxb.e(paramString);
    }
  }
  ...
  public void f(String paramString)
  {
    ...
    paramString.putExtra("EditPicType", this.jdField_a_of_type_Sxb.b());
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          continue;
          bcef.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1001", localException, "", "");
          odq.a("0X8006A1F", "", "1001", localException, "", "");
          if (QLog.isColorLevel())
          {
            QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action friend!");
            continue;
            bcef.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1002", localException, "", "");
            odq.a("0X8006A1F", "", "1002", localException, "", "");
            if (QLog.isColorLevel())
            {
              QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action qzone!");
              continue;
              bcef.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1003", localException, "", "");
              odq.a("0X8006A1F", "", "1003", localException, "", "");
              if (QLog.isColorLevel())
              {
                QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action wechat!");
                continue;
                bcef.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1004", localException, "", "");
                odq.a("0X8006A1F", "", "1004", localException, "", "");
                if (QLog.isColorLevel())
                {
                  QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action wechat circle!");
                  continue;
                  odq.a(null, "", "0X800787A", "0X800787A", 0, 0, localException, str, "", "");
                  bcef.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1005", localException, "", "");
                  odq.a("0X8006A1F", "", "1005", localException, "", "");
                  if (QLog.isColorLevel()) {
  ...
  public void onLifeCycleStateChanged(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      do
      {
        ...
        } while (this.jdField_a_of_type_Sxb == null);
      ...
      return;
      if ((this.jdField_a_of_type_Sxb != null) && (this.jdField_a_of_type_Sxb.a() != null)) {
        this.jdField_a_of_type_Sxb.a().onConfigurationChanged();
      }
