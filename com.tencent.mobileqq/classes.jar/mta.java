...
public class mta
  implements Runnable
{
  public mta(FastWebVideoFeedsPlayManager paramFastWebVideoFeedsPlayManager) {}
  ...
  public void run()
  {
    ...
    do
    {
      do
      {
        ...
        ((ThirdVideoManager)localObject3).a(((FastWebVideoFeedsPlayManager.VideoPlayParam)localObject2).jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebVideoFastWebVideoInfo.jdField_a_of_type_JavaLangString, "PubAccountArticleCenter.GetUrlByVid", new mtb(this, (VideoPlayerWrapper)localObject1, l, (ThirdVideoManager)localObject3));
        return;
