...
{
  public jqh(SmallScreenMultiVideoControlUI paramSmallScreenMultiVideoControlUI) {}
  ...
  protected void b(long paramLong)
  {
    ...
    super.b(paramLong);
    this.a.g();
    this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(new jqk(this), 500L);
  }
  ...
  protected void b(long paramLong1, long paramLong2, int paramInt, boolean paramBoolean)
  {
    ...
    this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().removeCallbacks(this.a.jdField_a_of_type_Jqo);
    this.a.jdField_a_of_type_Jqo.a = "onMemberPPTInOrOut";
    this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(this.a.jdField_a_of_type_Jqo, 1000L);
    return;
  ...
  protected void c(long paramLong)
  {
    ...
    super.c(paramLong);
    this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(new jqi(this, paramLong), 1500L);
  }
  ...
  protected void d()
  {
    ...
    SmallScreenService localSmallScreenService = (SmallScreenService)this.a.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (localSmallScreenService != null) {
      localSmallScreenService.b.post(new jqj(this));
    }
    while (!QLog.isColorLevel()) {
      return;
    }
