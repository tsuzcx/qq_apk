...
{
  private SparseArray<List<bmcy>> a = new SparseArray();
  
  public bmcx(AppRuntime paramAppRuntime)
  {
    super("com.tencent.individuality.individualityremotecommand");
    a(0, new bmcz());
  }
  
  public boolean a(int paramInt, bmcy parambmcy)
  {
    ...
    if (!((List)localObject).contains(parambmcy)) {
      return ((List)localObject).add(parambmcy);
    }
    return false;
  }
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    if (-1 != i)
    {
      ...
      } while (!((bmcy)paramOnInvokeFinishLinstener.next()).a(i, paramBundle));
    }
    label100:
    do
    {
