...
public class bcdn
{
  ...
  public static void a()
  {
    ...
    for (;;)
    {
      ...
      Object localObject = aewr.a;
      if ((localObject == null) || (((aewq)localObject).f != 1)) {
        continue;
      }
      b = true;
  ...
  public static void a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    do
    {
      try
      {
        ...
        aewq localaewq2 = aewr.a;
        localaewq1 = localaewq2;
        if (!a) {
          continue;
        }
        localaewq1 = localaewq2;
      ...
      return;
    } while (localaewq1 != null);
  }
  
  public static void a(String paramString)
  {
    bcdb.a(new Throwable(paramString));
  }
  
  public static void a(String paramString1, String paramString2)
  {
    bcdb.a(new Throwable(paramString1), paramString2);
  }
  ...
  {
    aewq localaewq = aewr.a;
    if ((localaewq != null) && (localaewq.e == 1)) {
