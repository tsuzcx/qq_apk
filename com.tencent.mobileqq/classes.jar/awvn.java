  ...
  implements View.OnClickListener
{
  ...
  {
    Object localObject1 = paramView.findViewById(2131310787);
    if (localObject1 == null) {}
    do
    {
      return;
      paramView = ((View)localObject1).getTag(2131310787);
    ...
    try
    {
      ...
      {
        awqx.b(paramView, "P_CliOper", "Pb_account_lifeservice", localStructMsgForImageShare.uin, "mp_msg_msgpic_click", "aio_morpic_click", 0, 0, "", "", Long.toString(localStructMsgForImageShare.msgId), "");
      ...
      {
        awqx.b(null, "dc00898", "", "", "0X800A28", "0X800A28", 0, 0, "", "4", Long.toString(localStructMsgForImageShare.mSourceAppid), ForwardUtils.b(localStructMsgForImageShare.uinType));
    ...
    catch (AccountNotMatchException paramView)
    {
      ...
      localIntent.putExtra("image_share_by_server", ((awwr)localObject2).a());
      localIntent.putExtra("urlAtServer", ((awwr)localObject2).T);
      localIntent.putExtra("KEY_FILE_ID", ((awwr)localObject2).c);
      localIntent.putExtra("picMD5", ((awwr)localObject2).U);
      localIntent.putExtra("url", ((awwr)localObject2).S);
      ...
      localIntent.putExtra("IS_FROMOTHER_TERMINAL_KEY", bado.c(localStructMsgForImageShare.mIsSend));
      localIntent.putExtra("uin", localStructMsgForImageShare.uin);
      if (localStructMsgForImageShare.mIsSend != 1) {
        break label1351;
      }
    }
    awqx.b(null, "CliOper", "", "", "0X800567A", "0X800567A", 0, 0, localStructMsgForImageShare.mMsgServiceID + "", "", "", "");
    awqx.b(null, "CliOper", "", "", "0X8004B5C", "0X8004B5C", 1, 0, "", "", "", "");
    int i = 0;
    Object localObject2 = localStructMsgForImageShare.getFirstImageElement();
    if (localObject2 != null)
    {
      if ((!bado.b(localStructMsgForImageShare.mIsSend)) && (((awwr)localObject2).a != null))
      {
        paramView = adkt.a(localContext, ((awwr)localObject2).a);
        if (paramView != null) {
      ...
      localIntent.putExtra("fileSize", ((awwr)localObject2).d);
      localIntent.putExtra("KEY_TIME", ((awwr)localObject2).e);
      ...
      localIntent.putExtra("KEY_THUMBNAL_BOUND", xgx.a((View)localObject1));
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        if ((!bado.b(((MessageForPic)localObject2).issend)) || (TextUtils.isEmpty(((MessageForPic)localObject2).path)) || (!new File(((MessageForPic)localObject2).path).exists())) {
          continue;
        }
        ...
        if ((!bado.b(((MessageForPic)localObject2).issend)) || (TextUtils.isEmpty(((MessageForPic)localObject2).path)) || (!TextUtils.isEmpty(((MessageForPic)localObject2).md5)) || (!new File(((MessageForPic)localObject2).path).exists())) {
          continue;
        }
        localAIOImageData.jdField_b_of_type_JavaLangString = ((MessageForPic)localObject2).path;
      ...
      localAIOImageData = adwz.a((MessageForPic)localObject2);
      ...
      if ((localStructMsgForImageShare.mMsgActionData != null) && (localStructMsgForImageShare.mMsgActionData.startsWith("comic_plugin.apk")))
      {
        ...
        localAIOImageData.a = localStructMsgForImageShare.getBytes();
        localObject2 = adww.a(localStructMsgForImageShare);
        localAIOImageData.d = adww.a((String[])localObject2);
        if ((localObject2 != null) && (localObject2.length >= 8))
        {
          if (localObject2[7].equals("link"))
          {
            localObject1 = localObject2[4];
            bezp.a(null, paramView, localContext, "3009", "2", "40054", localObject2[0], new String[] { localObject2[2], localObject2[4], localObject1 });
          }
        }
        else
        {
          ...
          awqx.b(null, "P_CliOper", "Pb_account_lifeservice", localStructMsgForImageShare.uin, "0X80055C7", "0X80055C7", 0, j, "" + localStructMsgForImageShare.msgId, "" + localStructMsgForImageShare.templateIDForPortal, "", localStructMsgForImageShare.mMsgUrl);
          paramView = new StringBuilder().append("MSGID=").append(Long.toString(localStructMsgForImageShare.msgId)).append(";TEPLATEID=").append(localStructMsgForImageShare.templateIDForPortal).append(";ARTICALID=").append("").append(";REFERRER=").append(awul.a(localStructMsgForImageShare.mMsgUrl));
          awqx.b(null, "P_CliOper", "Pb_account_lifeservice", localStructMsgForImageShare.uin, "0X8005D49", "0X8005D49", 0, j, paramView.toString(), "", "", "");
          return;
