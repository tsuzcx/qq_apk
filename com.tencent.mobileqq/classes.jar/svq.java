    ...
    while (localIterator.hasNext())
    {
      ...
      if (svy.a(localJSONObject))
      {
        if (!qny.a().a()) {
          ...
          paramList1 = svy.a(localJSONObject);
        }
      }
      else {
        for (;;)
        {
          paramList1.b = svu.a(paramSparseArray);
          ...
          break;
          paramList1 = svu.a(localJSONObject, paramArticleInfo, paramFastWebArticleInfo);
          paramList1.v = 1;
          paramList1.u = -1;
        }
      }
  ...
  public static void a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, List<BaseData> paramList, List<oidb_cmd0xe7e.ModuleInfo> paramList1, ItemShowDispatcher paramItemShowDispatcher, SparseArray<Float> paramSparseArray)
  {
    ...
    for (;;)
    {
      ...
      while (paramList1.hasNext())
      {
        ...
        try
        {
          ProteusItemData localProteusItemData = svu.a(new JSONObject(paramSparseArray.bytes_json.get().toStringUtf8()), paramArticleInfo, paramFastWebArticleInfo);
          localProteusItemData.v = -99;
          localProteusItemData.b = paramSparseArray.bytes_weight.get();
          swt.a(paramList, localProteusItemData, paramItemShowDispatcher);
        }
