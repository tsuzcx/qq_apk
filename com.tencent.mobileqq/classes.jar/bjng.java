  ...
  extends bjnh
{
  ...
  public bjng(boolean paramBoolean)
  {
    super(paramBoolean);
  ...
  {
    this.d = 0.5228754F;
    ArrayList localArrayList = bjum.a().a(this.jdField_f_of_type_Float, false);
    if (this.jdField_a_of_type_Boolean) {}
    for (Object localObject = bjum.a().a(this.jdField_f_of_type_Float, true);; localObject = null)
    {
  ...
  public void c()
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Bjna != null)
      {
        this.jdField_a_of_type_Bjna.a(this.d);
        this.jdField_a_of_type_Bjna.a(this.jdField_b_of_type_Float, this.jdField_c_of_type_Float);
      }
      ...
      if ((this.jdField_a_of_type_Bjni != null) && (this.d != 1.0F)) {
        this.jdField_a_of_type_Bjni.a((int)this.jdField_f_of_type_Float - i, -this.jdField_b_of_type_Float, -this.jdField_c_of_type_Float, this.d);
      }
      return;
      if (this.jdField_b_of_type_Float >= -this.jdField_g_of_type_Float) {
        break;
  ...
  public void d()
  {
    ...
    {
      int i = 0;
      while (i < this.jdField_a_of_type_Bjnl.size())
      {
        bjnm localbjnm = (bjnm)this.jdField_a_of_type_Bjnl.valueAt(i);
        int j = localbjnm.a();
        if (j > 0)
        {
          GLES20.glBindTexture(3553, j);
          j = c();
          GLES20.glDrawArrays(4, ((int)(this.jdField_f_of_type_Float / 10.0F) - 1 - localbjnm.b()) * 6 + j, 6);
        }
        i += 1;
      }
    }
