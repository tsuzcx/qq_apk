...
public class bhjo
{
  ...
  public static Map<String, String> a()
  {
    try
    {
      Map localMap = a(new FileInputStream("/proc/cpuinfo"), new bhjp());
      return localMap;
    }
  ...
  /* Error */
  private static Map<String, String> a(InputStream paramInputStream, bhjr parambhjr)
  {
    // Byte code:
  ...
  private static void a(Set<String> paramSet, Map<String, String> paramMap)
  {
    ...
    //   57: dup
    //   58: invokestatic 93	bhjo:d	()Ljava/lang/String;
  ...
  private static boolean a()
  {
    ...
    return (bdag.a()) && (!localFile.exists());
  }
  ...
  private static String b(Map<String, String> paramMap, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        paramMap = Long.toString(bdcb.d());
      }
      else if (paramString.equals("ts"))
      {
        paramMap = Long.toString(bdcb.b()[0]);
      }
  ...
  private static Map<String, String> b()
  {
    ...
    {
      return localHashMap;
      a(a(localInputStream, new bhjq()), localHashMap);
  ...
  private static void b()
  {
    ...
    bhin.b(localStringBuilder.toString().substring(1), 110);
  }
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null) {
        try
        {
          ...
          localObject = Base64.encodeToString((bdcb.c() + "_" + Long.toString(l ^ 0xADCD123)).getBytes(), 2);
          return localObject;
        }
        catch (Exception localException) {}
      }
