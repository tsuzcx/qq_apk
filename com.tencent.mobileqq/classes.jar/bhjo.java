...
public class bhjo
{
  ...
  private WeakReference<bhjp> jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(null);
  private String b;
  private String c = "android";
  private String d = "8.4.1";
  ...
  public bhjo(String paramString, int paramInt, bhjp parambhjp)
  {
    this.b = paramString;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambhjp);
  }
  ...
  private bhjg a()
  {
    try
    {
      ...
      if (i == 200)
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            ...
            if (localObject != null) {
              return new bhjg((JSONObject)localObject);
            }
          }
        }
      }
      else
      {
        ...
        localObject = new bhjg();
        ((bhjg)localObject).jdField_a_of_type_Int = i;
        return localObject;
      }
    }
  ...
  {
    if ((parambhjg != null) && (QLog.isColorLevel())) {
      QLog.i("GetRegisterLiangHaoList", 2, "onResponse " + parambhjg);
    }
    ...
    if (parambhjg != null)
    {
      i = parambhjg.jdField_a_of_type_Int;
    ...
    {
      localbctj.a(null, "reg_lh_get_list", bool, l1 - l2, 0L, (HashMap)localObject, "", true);
      localObject = (bhjp)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localObject != null) {
        break label143;
      }
      return;
    ...
    label143:
    ThreadManagerV2.getUIHandlerV2().post(new GetRegisterLiangHaoList.2(this, parambhjg, (bhjp)localObject));
  }
  ...
  private String b()
  {
    ...
    try
    {
      this.jdField_a_of_type_JavaLangString = bkfy.a("ecd027");
