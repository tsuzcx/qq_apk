  ...
  extends WebViewPlugin
{
  ...
  private void a(String paramString)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        aqss localaqss = new aqss(this, (String)localObject);
        i = almh.a().a(localaqss);
        ...
        try
        {
          ...
          {
            almm.a(this.jdField_a_of_type_AndroidAppActivity, str1, paramString, i);
            return;
          }
          if (TextUtils.isEmpty(str2)) {
            break label183;
          }
          bady.a(this.jdField_a_of_type_AndroidAppActivity, str2, null, paramString, i);
          return;
        }
  ...
  public Object handleEvent(String paramString, long paramLong)
  {
    if ((paramLong == 8L) && (paramString != null)) {
      try
      {
        if (((almj)alzw.a().a(416)).a(paramString))
        {
