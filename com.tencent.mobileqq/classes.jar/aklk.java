  ...
  implements View.OnClickListener, aoog
{
  ...
  private aklm jdField_a_of_type_Aklm = new aklm();
  aklr jdField_a_of_type_Aklr;
  protected alno a;
  ...
  public aklk(QQAppInterface paramQQAppInterface, Context paramContext, XListView paramXListView, aklr paramaklr)
  {
    ...
    this.jdField_a_of_type_Aklr = paramaklr;
  }
  
  protected View a()
  {
    return View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131559432, null);
  }
    ...
    do
    {
      ...
      do
      {
        ...
        if (paramDrawable == null)
        {
          localDrawable = paramDrawable;
          if (this.jdField_a_of_type_Alno != null) {
            localDrawable = this.jdField_a_of_type_Alno.a(paramRecentBaseData.getRecentUserType(), paramRecentBaseData.getRecentUserUin());
          }
        }
      } while (this.jdField_a_of_type_Aklm == null);
      try
      {
        this.jdField_a_of_type_Aklm.a(paramView, paramRecentBaseData, this.jdField_a_of_type_AndroidContentContext, localDrawable);
        return;
      }
      catch (Throwable paramView) {}
    } while (!alok.b(this.jdField_a_of_type_AndroidContentContext));
  ...
  {
    if (this.jdField_a_of_type_Alno != null) {
      this.jdField_a_of_type_Alno.a(paramQQAppInterface);
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        ...
        alok.a(this.jdField_a_of_type_AndroidContentContext, false, localThrowable);
        if (!alok.b(this.jdField_a_of_type_AndroidContentContext)) {
          continue;
        }
      ...
      return paramView;
      localObject2 = paramView;
      localObject1 = this.jdField_a_of_type_Aklm.a(paramInt, localObject1, this.jdField_a_of_type_Alno, paramView, paramViewGroup, this.jdField_a_of_type_AndroidContentContext, this, null, null);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject instanceof RecentBaseData))
      {
        ...
        {
          this.jdField_a_of_type_Aklr.a((RecentBaseData)localObject);
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        i = ((Integer)alno.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i, paramString).first).intValue();
        if (i == -2147483648) {
          break label667;
        }
        ...
        {
          l = System.currentTimeMillis();
          paramBitmap = BaseApplication.getContext().getResources().getDrawable(2130840354);
