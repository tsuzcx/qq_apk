  ...
  extends BaseAdapter
{
  ...
  protected ArrayList<vrk> a;
  protected vrk a;
  protected boolean a;
  protected ArrayList<vrk> b;
  
  public vrh(Context paramContext, GridView paramGridView, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    jdField_a_of_type_Int = actj.a(80.0F, paramContext);
    jdField_b_of_type_Int = actj.a(10.0F, paramContext);
    c = actj.a(5.0F, paramContext);
    this.jdField_a_of_type_AndroidWidgetGridView.setColumnWidth(jdField_a_of_type_Int);
    this.jdField_b_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_b_of_type_JavaUtilArrayList.add(vrk.jdField_a_of_type_Vrk);
    if (!paramBoolean1) {
      this.jdField_b_of_type_JavaUtilArrayList.add(vrk.jdField_b_of_type_Vrk);
    }
    if (paramBoolean2) {
      this.jdField_b_of_type_JavaUtilArrayList.add(vrk.c);
    }
  }
  ...
  public int a(vrk paramvrk)
  {
    if (this.jdField_a_of_type_JavaUtilArrayList != null) {
      return this.jdField_a_of_type_JavaUtilArrayList.indexOf(paramvrk);
    }
    return -1;
  }
  ...
  public vrk a()
  {
    return this.jdField_a_of_type_Vrk;
  }
  ...
  public void a()
  {
    ...
    {
      i = j;
      if (this.jdField_a_of_type_JavaUtilArrayList.contains(vrk.c))
      {
        this.jdField_a_of_type_JavaUtilArrayList.remove(vrk.c);
        this.jdField_b_of_type_JavaUtilArrayList.remove(vrk.c);
        i = 1;
      }
    }
    if (i != 0) {
  ...
  public void a(ArrayList<vrk> paramArrayList)
  {
  ...
  {
    vrk localvrk = (vrk)getItem(paramInt);
    if (localvrk == null) {
      return null;
    }
    ...
    if (paramView == null)
    {
      ...
      localTextView.setText(localvrk.jdField_b_of_type_JavaLangString);
      if (localvrk.jdField_b_of_type_Int != 0) {
        break label213;
      }
      localTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130845755, 0, 0);
      if (localvrk.equals(this.jdField_a_of_type_Vrk)) {
    ...
    for (;;)
    {
      ...
      if (localvrk.equals(this.jdField_a_of_type_Vrk))
      {
        ...
        {
          localTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130845759, 0, 0);
          if (localvrk.equals(this.jdField_a_of_type_Vrk)) {
            localTextView.getCompoundDrawables()[1].setColorFilter(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166345), PorterDuff.Mode.MULTIPLY);
          }
          localTextView.setTag(null);
        }
        else if (localvrk.jdField_b_of_type_Int == 2)
        {
          localTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130845752, 0, 0);
          if ((this.jdField_a_of_type_Vrk != null) && (this.jdField_a_of_type_Vrk.jdField_b_of_type_Int == 2)) {
            localTextView.getCompoundDrawables()[1].setColorFilter(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166345), PorterDuff.Mode.MULTIPLY);
          }
          localTextView.setTag(null);
        }
        else
        {
          ...
          if (localvrk.jdField_b_of_type_Int == 4)
          {
            paramView = null;
            paramInt = (int)bbdv.a(this.jdField_a_of_type_AndroidContentContext, 36.0F);
            if (localvrk.jdField_a_of_type_Int > 0)
            {
              paramView = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(localvrk.jdField_a_of_type_Int);
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                catch (Exception paramView)
                {
                  File localFile;
                  byte[] arrayOfByte;
                  paramView = localResources.getDrawable(2130846569);
                  continue;
                  boolean bool = false;
                  continue;
                  paramView = localResources.getDrawable(2130846569);
              ...
              if (paramViewGroup == null)
              {
                ...
                paramView.mFailedDrawable = localResources.getDrawable(2130846569);
                paramView.mLoadingDrawable = localResources.getDrawable(2130846569);
          ...
          {
            if (localvrk.equals(this.jdField_a_of_type_Vrk)) {
              localTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130845754, 0, 0);
            }
            for (;;)
            {
              localTextView.setTag(localvrk);
              break;
    ...
    if ((localvrk.jdField_b_of_type_Int == 2) && (this.jdField_a_of_type_Vrk != null) && (this.jdField_a_of_type_Vrk.jdField_b_of_type_Int == 2))
    {
      localTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166345));
      return localObject;
    }
