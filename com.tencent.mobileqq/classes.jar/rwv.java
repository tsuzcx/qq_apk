  ...
  implements VComponentAdapter
{
  ...
  {
    if ((paramImageAction == null) || (paramImageAction.getTarget() == null) || (paramURLDrawable == null) || (!bbfj.g(paramImageAction.getTarget().getContext()))) {}
    do
    {
      return;
  ...
  private void a(ImageAction paramImageAction, String paramString, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    paramString.setURLDrawableListener(new rwx(this, paramBoolean1, paramImageAction));
  }
  ...
  {
    PullRefreshHeader localPullRefreshHeader = (PullRefreshHeader)LayoutInflater.from(paramVRefreshLayout.getContext()).inflate(2131562307, paramVRefreshLayout, false);
    RefreshAnimView localRefreshAnimView = (RefreshAnimView)localPullRefreshHeader.findViewById(2131375048);
    paramVRefreshLayout.addView(localPullRefreshHeader);
    paramVRefreshLayout.setonRefreshStateChangeListener(new rww(this, localRefreshAnimView, paramVRefreshLayout));
  }
  ...
  public CharSequence setEmoticonText(@NonNull CharSequence paramCharSequence, int paramInt)
  {
    ...
    return new aykk(a(paramCharSequence.toString()), 2, (int)(paramInt / 2.5D));
  }
