  ...
  implements ApngSoLoader
{
  ...
  private bgzd(String paramString)
  {
    super(paramString);
  }
  ...
  public static bgzd a()
  {
    try
    {
      if (jdField_a_of_type_Bgzd == null) {
        jdField_a_of_type_Bgzd = new bgzd("VasApngIPCModule");
      }
      bgzd localbgzd = jdField_a_of_type_Bgzd;
      return localbgzd;
    }
    finally {}
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (bgtl.a(str2, str1, "libAPNG_release_813.so"))
      {
  ...
  public void a(URLDrawableHandler paramURLDrawableHandler, boolean paramBoolean)
  {
    ...
    QIPCClientHelper.getInstance().callServer("VasApngIPCModule", jdField_a_of_type_JavaLangString, null, new bgze(this, paramURLDrawableHandler));
  }
        ...
        if (!TextUtils.isEmpty(str))
        {
          ...
          if (new File(str).exists())
          {
            ...
            catch (Throwable localThrowable)
            {
              ...
              bcst.b(null, "CliOper", "", "", "Font_Mall", "0X80073FE", 0, 0, "101", "", "", "");
              break label206;
            }
          }
