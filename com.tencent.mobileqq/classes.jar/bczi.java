  ...
  extends bcvt
{
  ...
  private GradientDrawable a()
  {
    ...
    localGradientDrawable.setCornerRadius(bgtn.a(2.0F));
    localGradientDrawable.setStroke(bgtn.b(0.25F), s);
  ...
  private ImageView a(Context paramContext, RelativeLayout paramRelativeLayout)
  {
    ...
    localImageView.setId(2131374821);
    int i = bgtn.b(50.0F);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(i * 16 / 9, i);
    localLayoutParams.addRule(15);
    localImageView.setImageDrawable(paramContext.getResources().getDrawable(2130847344));
  ...
  private LinearLayout a(Context paramContext, RelativeLayout paramRelativeLayout)
  {
    ...
    paramContext.setId(2131374822);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.addRule(11);
    localLayoutParams.addRule(8, 2131374821);
  ...
  private RelativeLayout a(Context paramContext)
  {
    ...
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, bgtn.b(74.0F));
  ...
  private TextView a(Context paramContext, RelativeLayout paramRelativeLayout)
  {
    ...
    localTextView.setId(2131374819);
    localTextView.setText(paramContext.getResources().getText(2131716098));
    localTextView.setSingleLine(false);
    localTextView.setMaxLines(2);
    localTextView.setEllipsize(TextUtils.TruncateAt.END);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, -2);
    localLayoutParams.addRule(1, 2131374821);
    localLayoutParams.addRule(0, 2131374822);
    localLayoutParams.addRule(15);
    localLayoutParams.setMargins(bgtn.a(12.0F), 0, bgtn.a(12.0F), 0);
  ...
  private TextView a(Context paramContext, CharSequence paramCharSequence)
  {
    ...
    paramContext.setPadding(bgtn.b(0.8F), 0, 0, bgtn.b(0.8F));
    return paramContext;
  }
  ...
  {
    if (paramInt == 12) {
      paramLinearLayout.addView(a(paramContext, paramContext.getResources().getText(2131716127)));
    }
    paramContext = a(paramContext, paramContext.getResources().getText(2131716126));
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-2, -2);
    localLayoutParams.leftMargin = bgtn.b(2.0F);
  ...
  private void a(Context paramContext, RelativeLayout paramRelativeLayout, ImageView paramImageView, LinearLayout paramLinearLayout, TextView paramTextView)
  {
    ...
    for (akmh localakmh = (akmh)((BaseActivity)paramContext).app.getManager(341);; localakmh = null)
    {
      Object localObject = new AdExposureChecker(null, new WeakReference(paramRelativeLayout));
      if ((localakmh != null) && (localakmh.a() != null) && (localakmh.a().getImageData() != null))
      {
        GdtAd localGdtAd = localakmh.a();
        int i = localGdtAd.getProductType();
        ackj localackj = localGdtAd.getImageData();
        ViewGroup.LayoutParams localLayoutParams = paramImageView.getLayoutParams();
        if ((localackj.jdField_a_of_type_Int != 0) && (localackj.b != 0)) {
          localLayoutParams.width = ((int)(Math.min(Math.max(localackj.jdField_a_of_type_Int * 1.0F / localackj.b, 1.0F), 1.777778F) * localLayoutParams.height));
        }
        localObject = paramContext.getResources().getDrawable(2130847344);
        if (localackj.jdField_a_of_type_Int == localackj.b) {
          localObject = paramContext.getResources().getDrawable(2130847343);
        }
        paramImageView.setImageDrawable(QWalletPicHelper.getNetDrawableForQWallet(localackj.jdField_a_of_type_JavaLangString, (Drawable)localObject, (Drawable)localObject));
        if (QLog.isColorLevel()) {
          QLog.i("QWalletGdtAdManager_StructMsgItemLayout31", 2, "adInfo:,text:" + localGdtAd.getText() + ",url:" + localackj.jdField_a_of_type_JavaLangString + ",width:" + localackj.jdField_a_of_type_Int + ",height:" + localackj.b + ",paramsWidth:" + localLayoutParams.width + ",paramsHeight:" + localLayoutParams.height + ",productType:" + i);
        }
        ...
        if (a == null) {
          a = new bczj(this, localakmh, paramContext, localGdtAd);
        }
        paramImageView.setCallback(new WeakReference(a));
        paramRelativeLayout.setOnClickListener(new bczk(this, localGdtAd, paramContext, localakmh));
        if (QLog.isColorLevel()) {
      ...
      for (paramContext = paramImageView;; paramContext = (Context)localObject)
      {
        ...
        return;
        paramRelativeLayout.setOnClickListener(new bczl(this, paramContext));
      }
    }
  }
  ...
  private void a(Context paramContext, TextView paramTextView)
  {
    ...
    if ((paramContext instanceof BaseActivity))
    {
      paramContext = (akpd)((BaseActivity)paramContext).app.getManager(245);
  ...
  private void a(RelativeLayout paramRelativeLayout)
  {
    ...
    paramRelativeLayout.setBackgroundResource(2130838301);
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.t = (paramContext.getResources().getDimensionPixelSize(2131298900) - bgtn.a(3.0F));
        this.u = (paramContext.getResources().getDimensionPixelSize(2131298901) - bgtn.a(3.0F));
