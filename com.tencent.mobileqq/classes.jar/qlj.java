...
public class qlj
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = qlj.class.getSimpleName();
  }
  
  public static int a(Activity paramActivity, VideoInfo paramVideoInfo)
  {
    int i = qcn.b(paramActivity)[0];
  ...
  public static Bundle a(Intent paramIntent)
  {
    ...
    try
    {
      ...
      localJSONObject3.put("stickySpeed", odw.a());
      localJSONObject3.put("maskLighteness", odw.a());
      localJSONObject3.put("topBarTitle", odw.a());
      JSONObject localJSONObject4 = new JSONObject();
      localJSONObject4.put("from", paramIntent.getIntExtra("VIDEO_FROM_TYPE", -1));
      localJSONObject4.put("kandian_mode_new", new.a());
      localJSONObject4.put("kandian_mode", obz.e());
  ...
  public static VideoInfo a(Bundle paramBundle)
  {
    ...
    {
      return paramBundle;
      localVideoInfo = qcn.a(paramBundle);
      qcn.a(localVideoInfo);
      paramBundle = localVideoInfo;
  ...
  private static JSONObject a(Intent paramIntent)
  {
    ...
    if (m == 11)
    {
      ...
      {
        localJSONObject1.put("videoType", odw.a(localVideoInfo.jdField_b_of_type_Int, localVideoInfo.jdField_c_of_type_Int, localVideoInfo.d));
  ...
  public static void a(Activity paramActivity, View paramView)
  {
    ...
    {
      if (bjeh.b()) {
        paramView.setPadding(paramView.getPaddingLeft(), paramView.getPaddingTop() + bjeh.b(paramActivity), paramView.getPaddingRight(), paramView.getPaddingBottom());
      }
    }
    else {
      return;
  ...
  public static void a(Activity paramActivity, String paramString)
  {
    ...
    obz.a(paramActivity, obb.k + baaw.encodeToString(String.valueOf(paramString).getBytes(), 2));
  }
  
  public static void a(RecyclerView paramRecyclerView, qlk<RecyclerView.ViewHolder> paramqlk)
  {
  ...
  {
    int n = qcn.b(paramActivity)[0];
    int k;
    if (!paramBoolean)
    {
      int m = aciy.a(10.0F, paramActivity.getResources());
      k = aciy.a(10.0F, paramActivity.getResources());
      i = m;
      j = k;
    ...
    if (paramVideoInfo.b() > paramVideoInfo.c())
    {
      i = qcn.b(paramActivity)[1];
      j = qcn.b(paramActivity)[0];
      f = paramVideoInfo.b() / paramVideoInfo.c();
      j = (int)(j * f);
      if (j <= i) {}
      for (i = (i - j) / 2 + aciy.a(16.0F, paramActivity.getResources());; i = aciy.a(16.0F, paramActivity.getResources()))
      {
        j = aciy.a(16.0F, paramActivity.getResources());
        break;
      }
    }
    int j = qcn.b(paramActivity)[0];
    int i = qcn.b(paramActivity)[1];
    float f = paramVideoInfo.c() / paramVideoInfo.b();
    j = (int)(j * f);
    if (j < i) {}
    for (i = (i - j) / 2 + aciy.a(32.0F, paramActivity.getResources());; i = aciy.a(32.0F, paramActivity.getResources()))
    {
      k = aciy.a(10.0F, paramActivity.getResources());
      j = i;
      i = k;
  ...
  {
    paramView.setPadding(paramView.getPaddingLeft() + bjeh.b(paramActivity), paramView.getPaddingTop(), paramView.getPaddingRight() + bjeh.b(paramActivity), paramView.getPaddingBottom());
  }
}
