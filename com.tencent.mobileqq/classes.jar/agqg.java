...
class agqg
  implements bhbb
{
  agqg(agqd paramagqd, boolean paramBoolean) {}
  ...
  public void a(View paramView)
  {
    ...
    float f1 = ((AnimationTextView)localObject).touchL - agqd.e;
    float f2 = ((AnimationTextView)localObject).touchT;
    float f3 = agqd.c;
    if (this.jdField_a_of_type_Boolean) {
      f1 = ((AnimationTextView)localObject).touchL - agqd.f;
    }
    ...
    for (int i = k;; i = -1)
    {
      ...
      {
        EmoticonUtils.clickSmallEmoticon((QQText.EmoticonSpan[])localObject, f1, f2 - f3, bool2, i, j, this.jdField_a_of_type_Agqd.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Agqd.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (Activity)this.jdField_a_of_type_Agqd.jdField_a_of_type_AndroidContentContext, bool1);
        return;
        label307:
        bool2 = false;
        break;
