...
public class amfn
{
  private WeakReference<amfy> jdField_a_of_type_JavaLangRefWeakReference;
  private final ConcurrentHashMap<String, amft> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  
  amfn(amfy paramamfy)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramamfy);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    if (!a())
    {
      paramamfy = (AppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null).getAppRuntime("modular_web");
      if (paramamfy != null)
      {
  ...
  public static void a(amfn paramamfn, AppInterface paramAppInterface, int paramInt, boolean paramBoolean)
  {
    boolean bool2 = true;
    ...
    do
    {
      do
      {
        ...
        Object localObject = new File(amey.a());
        ...
        localObject = new bgoe("https://cmshow.gtimg.cn/qqshow/admindata/comdata/vipApollo_thunder_config/xydata.json", (File)localObject);
        ...
        ((bgoe)localObject).a(new amfp(localSharedPreferences, paramInt, paramamfn));
        paramamfn = (bgog)paramAppInterface.getManager(47);
        paramBoolean = bool2;
        if (paramamfn != null)
        {
          paramamfn = paramamfn.a(3);
          paramBoolean = bool2;
          if (paramamfn != null)
          {
            paramamfn.a((bgoe)localObject, ((bgoe)localObject).a(), null);
            paramBoolean = false;
          }
        }
        if (paramBoolean) {
          ThreadManager.executeOnNetWorkThread(new ApolloSSOConfig.3((bgoe)localObject));
        }
  ...
  private boolean a()
  {
    ...
    Object localObject1 = new File(amey.a());
    Object localObject2;
    int i;
    Object localObject4;
    int i1;
    ...
    if (((File)localObject1).exists())
    {
      try
      {
        localObject2 = amey.a((File)localObject1);
        ...
        localObject2 = new amft();
        ((amft)localObject2).jdField_a_of_type_Int = n;
        ((amft)localObject2).jdField_a_of_type_JavaLangString = ((String)localObject4);
        ...
        if (k < i2)
        {
          ...
          localObject8 = new amfs(null);
          ((amfs)localObject8).jdField_a_of_type_JavaLangString = str1;
          ((amfs)localObject8).jdField_a_of_type_Int = i3;
          ((amfs)localObject8).b = str2;
      ...
      localObject7 = new amfr();
      ((amfr)localObject7).jdField_a_of_type_JavaLangString = ((String)localObject5);
      ((amfr)localObject7).jdField_a_of_type_Int = n;
      ((amfr)localObject7).jdField_a_of_type_JavaUtilList.addAll((Collection)localObject6);
      ((amft)localObject2).jdField_a_of_type_JavaUtilList.add(localObject7);
      break label1055;
      label543:
      ...
      localObject4 = new amfq();
      ((amfq)localObject4).jdField_a_of_type_JavaLangString = str1;
      ((amfq)localObject4).b = str2;
    ...
    for (;;)
    {
      if (k < i1)
      {
        ...
        if (localObject8 != null)
        {
          ...
          if (!TextUtils.isEmpty(str1))
          {
            ...
            localObject8 = new amfs(null);
            ((amfs)localObject8).jdField_a_of_type_JavaLangString = str1;
            ((amfs)localObject8).jdField_a_of_type_Int = i2;
            ((amfs)localObject8).b = str2;
      ...
      {
        ((amfq)localObject4).jdField_a_of_type_JavaUtilList.addAll((Collection)localObject7);
        ...
        if (localObject5 != null)
        {
          ...
          while (((Iterator)localObject6).hasNext())
          {
            ...
            ((amfq)localObject4).jdField_a_of_type_JavaUtilHashMap.put(localObject7, ((JSONObject)localObject5).optString((String)localObject7));
          }
        }
        ((amft)localObject2).b.add(localObject4);
        break label1069;
        label935:
        if (QLog.isColorLevel())
        {
  ...
  public String a(String paramString)
  {
    ...
    {
      paramString = (amft)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
      if (paramString != null) {
  ...
  public List<amfq> a(String paramString)
  {
    paramString = (amft)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    if (paramString != null) {
  ...
  public Set<String> a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      Object localObject = (amft)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
      if (localObject != null)
      {
        paramString = new HashSet();
        localObject = ((amft)localObject).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject).hasNext())
        {
          amfr localamfr = (amfr)((Iterator)localObject).next();
          if ((localamfr != null) && (!TextUtils.isEmpty(localamfr.jdField_a_of_type_JavaLangString))) {
            paramString.add(localamfr.jdField_a_of_type_JavaLangString);
          }
        }
        return paramString;
      }
  ...
  public JSONObject a(String paramString1, String paramString2, String paramString3, AppInterface paramAppInterface)
  {
    ...
    paramString2 = (amft)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString2);
    if (paramString2 != null)
    {
      paramString2 = paramString2.jdField_a_of_type_JavaUtilList.iterator();
      while (paramString2.hasNext())
      {
        amfr localamfr = (amfr)paramString2.next();
        if ((localamfr != null) && (paramString3.equals(localamfr.jdField_a_of_type_JavaLangString))) {
          return localamfr.a(paramString1, paramAppInterface);
        }
      }
    }
    return null;
  ...
  void a(AppInterface paramAppInterface)
  {
    ...
    localObject1 = new NewIntent(paramAppInterface.getApp(), auwo.class);
    ...
    ((NewIntent)localObject1).setObserver(new amfo(this, paramAppInterface));
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    {
      paramString1 = (amft)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString1);
      if (paramString1 != null)
      {
        paramString1 = paramString1.jdField_a_of_type_JavaUtilList.iterator();
        while (paramString1.hasNext())
        {
          amfr localamfr = (amfr)paramString1.next();
          if ((localamfr != null) && (paramString2.equals(localamfr.jdField_a_of_type_JavaLangString))) {
            return true;
          }
        }
      }
