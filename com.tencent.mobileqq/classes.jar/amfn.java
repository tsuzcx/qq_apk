...
{
  public static int a;
  private static amfn jdField_a_of_type_Amfn;
  public static ArrayList<String> a;
  private long jdField_a_of_type_Long;
  private SharedPreferences jdField_a_of_type_AndroidContentSharedPreferences;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private Vector<amfo> jdField_a_of_type_JavaUtilVector;
  public boolean a;
  ...
  {
    if (jdField_a_of_type_Amfn == null) {}
    try
    {
      if (jdField_a_of_type_Amfn == null) {
        jdField_a_of_type_Amfn = new amfn();
      }
      return jdField_a_of_type_Amfn;
    }
    finally {}
  }
  ...
  private void a(int paramInt, zdm paramzdm)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilVector.iterator();
      if (localIterator.hasNext()) {
        ((amfo)localIterator.next()).a(paramInt, paramzdm);
      }
    }
  }
  ...
  private void d()
  {
    ...
    long l2 = (100 - alrv.a().jdField_a_of_type_Int) * Runtime.getRuntime().maxMemory() / 100L;
    ...
    {
      this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putLong("key_use_heap", l1).putString("key_act_name", (String)localObject).putBoolean("key_clear_flag", alrv.a().jdField_a_of_type_Zdl.jdField_a_of_type_Boolean).commit();
  ...
  private void f()
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      localObject = (almv)((QQAppInterface)localObject).getManager(53);
      if (localObject != null)
      {
        i = ((almv)localObject).a().size();
        localStringBuffer.append("dc=");
        localStringBuffer.append(i);
        localStringBuffer.append("&");
        i = ((almv)localObject).b();
  ...
  public void a(long paramLong)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilVector.iterator();
      if (localIterator.hasNext()) {
        ((amfo)localIterator.next()).a(paramLong);
      }
    }
  }
  
  public void a(amfo paramamfo)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.add(paramamfo);
      return;
    }
  }
  
  public boolean a(long paramLong1, long paramLong2, zdl paramzdl, int paramInt)
  {
    zdm localzdm = paramzdl.a(paramInt);
    if ((localzdm != null) && (paramLong1 >= localzdm.jdField_a_of_type_Int * paramLong2 / 100L))
    {
      if (QLog.isColorLevel()) {
        QLog.d("MemoryReporter", 2, "onNeedTrimMemory|maxHeap=" + paramLong2 / 1024L / 1024L + ",totalSize=" + paramLong1 / 1024L / 84L);
      }
      paramzdl.jdField_a_of_type_Int = localzdm.b;
      a(paramInt, localzdm);
      return true;
    }
    return false;
  ...
  public void b(amfo paramamfo)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.remove(paramamfo);
      return;
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    paramMessage = alrv.a().jdField_a_of_type_Zdl;
    zdp.a().c();
    int i;
