...
public class afjk
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, SubMsgType0x87.MsgBody paramMsgBody)
  {
    ...
    Object localObject2 = ajya.a(2131701958);
    String str4 = String.format("%s(%s)", new Object[] { str2, localObject1 });
    String str5 = ajya.a(2131701956);
    if (j == 1) {}
    for (paramMsgBody = ajya.a(2131701950);; paramMsgBody = ajya.a(2131701953))
    {
      String str7 = String.format(str5, new Object[] { paramMsgBody });
      String str6 = String.format("%s(%s)", new Object[] { str3, str1 });
      paramMsgBody = ajya.a(2131701954);
      str5 = ajya.a(2131701951);
      aqvb localaqvb = new aqvb(str1, str1, (String)localObject2 + str4 + str7 + str6 + "的好友列表中。\n不想和他们是好友关系，可选择" + paramMsgBody + "。\n不想再被其他好友克隆，可选择" + str5 + "。", 0, -5040, 2686977, awzy.a());
      ...
      localaqvb.a(j, str5.length() + j, (Bundle)localObject1);
      ...
      paramMsgBody.msg = String.format(ajya.a(2131701955), new Object[] { str2, str3, str1 });
      paramMsgBody.time = awzy.a();
      paramQQAppInterface.a().a(paramMsgBody, paramQQAppInterface.c());
      paramMsgBody = new MessageForUniteGrayTip();
      paramMsgBody.initGrayTipMsg(paramQQAppInterface, new aqvb(str1, str1, ajya.a(2131701952), 0, -5020, 2686977, awzy.a()));
      aqvc.a(paramQQAppInterface, paramMsgBody);
