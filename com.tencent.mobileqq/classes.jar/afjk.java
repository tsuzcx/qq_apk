  ...
  extends BaseAdapter
{
  ...
  public afjk(NearbyProfileFragment paramNearbyProfileFragment) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(paramViewGroup.getContext()).inflate(2130970467, paramViewGroup, false);
      paramView = new afjl(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyProfileFragment);
      paramView.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131366378));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363203));
      paramView.b = ((TextView)localView.findViewById(2131370704));
      paramView.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard$HiWanItem = localHiWanItem;
      localView.setTag(paramView);
    }
    paramView = (afjl)localView.getTag();
