  ...
  implements View.OnClickListener
{
  ...
  public mmj(View paramView, BaseData paramBaseData)
  {
    super(paramView, paramBaseData);
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131362707));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131362983));
  ...
  public void b(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    if (TextUtils.isEmpty(paramBaseData1.jdField_a_of_type_JavaLangString))
    {
      ...
      ReadInJoyUtils.a(paramBaseData1.jdField_b_of_type_JavaLangString, paramBaseData1.d, paramBaseData1.jdField_c_of_type_JavaLangString, paramBaseData1.jdField_e_of_type_JavaLangString, new mmk(this, paramBaseData1));
    }
    paramBaseData2 = URLDrawable.getDrawable(ReadInJoyUtils.a(paramBaseData1.jdField_a_of_type_JavaLangString), paramBaseData2);
    ...
    this.jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(new mmm(this));
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramView.mVideoCoverUrl = ReadInJoyUtils.b(localVideoData.jdField_a_of_type_JavaLangString);
        a(paramView);
        return;
        paramView = "1";
      }
