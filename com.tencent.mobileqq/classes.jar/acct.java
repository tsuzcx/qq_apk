...
public class acct
  implements abzb
{
  private static void a(abxc paramabxc, byte[] paramArrayOfByte, MsgInfo paramMsgInfo)
  {
    boolean bool2 = true;
    ...
    try
    {
      ...
      if (((SubMsgType0xcb.MsgBody)localObject).uint32_anchor_status.get() == 1)
      {
        ...
        paramArrayOfByte.selfuin = paramabxc.a().getCurrentAccountUin();
    ...
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ...
      } while (amwh.a(paramabxc.a(), paramArrayOfByte, true));
      ...
      {
        bool2 = amwh.a(paramMsgInfo);
        int i = abwz.a(paramMsgInfo, paramabxc.a());
        localObject = paramabxc.a().getMessageFacade();
        str = paramabxc.a().getCurrentAccountUin();
        if ((bool2) && (paramabxc.a().isBackgroundStop)) {}
        for (bool1 = true;; bool1 = false)
        {
          ((QQMessageFacade)localObject).addMessage(paramMsgInfo, str, bool1);
          paramabxc.a().getMsgCache().a((int)paramArrayOfByte.time);
          if ((bcoo.a()) || (!bool3)) {
            break;
          }
          paramabxc.a("handleGetBuddyMessageResp", true, i, paramabxc.a().getMsgHandler().a(bool2), false);
          return;
        }
      }
      localObject = paramabxc.a().getMessageFacade().getLastMessage(paramArrayOfByte.frienduin, paramArrayOfByte.istroop);
      if (localObject != null)
      {
        paramabxc.a().getMessageFacade().updateMsgContentByUniseq(paramArrayOfByte.frienduin, paramArrayOfByte.istroop, ((MessageRecord)localObject).uniseq, paramArrayOfByte.msgData);
        paramabxc.a().getMessageFacade().setChangeAndNotify(localObject);
        return;
      }
      bool1 = amwh.a(paramMsgInfo);
      localObject = paramabxc.a().getMessageFacade();
      str = paramabxc.a().getCurrentAccountUin();
      if (!bool1) {
        break label780;
    ...
    if (paramabxc.a().isBackgroundStop) {}
    label780:
  ...
  {
    a(paramabxc, paramMsgType0x210.vProtobuf, paramMsgInfo);
    return null;
  }
}
