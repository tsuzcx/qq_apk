...
public abstract class bcpy
{
  ...
  private ConcurrentHashMap<String, abiv> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  ...
  public abiv a(String paramString)
  {
    ...
    return (abiv)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
  }
  ...
  protected void a(ToServiceMsg paramToServiceMsg, aqwp paramaqwp, Class<? extends MSFServlet> paramClass)
  {
    ...
    paramToServiceMsg = new PeakJceServiceBase.1(this, paramToServiceMsg, paramaqwp, paramClass);
  ...
  public void a(boolean paramBoolean, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Exception paramException)
  {
    ...
    //   4: return
    //   5: aload_0
    //   6: invokevirtual 204	bcpy:a	()Lcom/tencent/common/app/AppInterface;
    //   9: astore 8
    //   11: invokestatic 210	java/lang/System:currentTimeMillis	()J
    //   14: aload_2
    //   15: getfield 74	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   18: ldc 212
    ...
    //   30: iload_1
    //   31: ifeq +220 -> 251
    //   34: invokestatic 91	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   37: ifeq +66 -> 103
    //   40: ldc 93
    //   42: iconst_2
    ...
    //   71: invokevirtual 150	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   74: ldc 230
    //   76: invokevirtual 102	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   79: aload_0
    //   80: getfield 32	bcpy:jdField_a_of_type_JavaTextDecimalFormat	Ljava/text/DecimalFormat;
    //   83: fload 5
    //   85: f2d
    //   86: invokevirtual 234	java/text/DecimalFormat:format	(D)Ljava/lang/String;
    //   89: invokevirtual 102	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   92: ldc 236
    //   94: invokevirtual 102	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   97: invokevirtual 105	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   100: invokestatic 109	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   103: aload_2
    //   104: ldc 238
    ...
    //   130: invokevirtual 250	bcpy:a	(Ljava/lang/String;)Labiv;
    //   133: astore 9
    //   135: iload_1
    //   136: ifeq +323 -> 459
    //   139: aload 9
    ...
    //   146: aload_2
    //   147: aload_3
    //   148: invokevirtual 253	abiv:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;)V
    //   151: aload 9
    //   153: aload_2
    //   154: aload_3
    //   155: invokevirtual 256	abiv:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;)Ljava/lang/Object;
    //   158: astore 4
    //   160: aload_0
    //   161: aload_3
    //   162: invokevirtual 258	bcpy:a	(Lcom/tencent/qphone/base/remote/FromServiceMsg;)V
    //   165: aload 9
    //   167: ifnull -163 -> 4
    //   170: invokestatic 263	anvc:b	()Ljava/util/Map;
    //   173: aload_3
    ...
    //   236: aload_3
    //   237: aload 4
    //   239: invokevirtual 280	anud:onReceive	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;Ljava/lang/Object;)V
    //   242: iload 6
    //   244: iconst_1
    //   245: iadd
    //   246: istore 6
    ...
    //   279: new 39	java/lang/String
    //   282: dup
    //   283: aload 9
    //   285: invokevirtual 296	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   288: invokespecial 299	java/lang/String:<init>	([B)V
    //   291: astore 4
    //   293: invokestatic 91	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   296: ifeq -193 -> 103
    //   299: ldc 93
    //   301: iconst_2
    //   302: new 95	java/lang/StringBuilder
    //   305: dup
    //   306: invokespecial 96	java/lang/StringBuilder:<init>	()V
    //   309: ldc_w 301
    ...
    //   322: ldc 152
    //   324: invokevirtual 102	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   327: aload 4
    //   329: invokevirtual 102	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   332: invokevirtual 105	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   335: invokestatic 109	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   338: goto -235 -> 103
    //   341: invokestatic 91	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   344: ifeq -241 -> 103
    //   347: ldc 93
    //   349: iconst_2
    //   350: new 95	java/lang/StringBuilder
    //   353: dup
    //   354: invokespecial 96	java/lang/StringBuilder:<init>	()V
    //   357: ldc 219
    ...
    //   369: ldc_w 303
    //   372: invokevirtual 102	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   375: aload_3
    //   376: invokevirtual 306	com/tencent/qphone/base/remote/FromServiceMsg:getResultCode	()I
    //   379: invokevirtual 150	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   382: ldc 230
    //   384: invokevirtual 102	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   387: aload_0
    //   388: getfield 32	bcpy:jdField_a_of_type_JavaTextDecimalFormat	Ljava/text/DecimalFormat;
    //   391: fload 5
    //   393: f2d
    ...
    //   405: invokevirtual 105	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   408: invokestatic 309	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   411: goto -308 -> 103
    //   414: invokestatic 91	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   417: ifeq +12 -> 429
    //   420: ldc 93
    //   422: iconst_2
    //   423: ldc_w 311
    //   426: invokestatic 109	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   429: aconst_null
    //   430: astore 4
    //   432: goto -272 -> 160
    //   435: astore 4
    ...
    //   442: invokestatic 91	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   445: ifeq +14 -> 459
    //   448: ldc 93
    //   450: iconst_2
    //   451: ldc_w 315
    ...
    //   472: invokestatic 91	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   475: ifeq -233 -> 242
    //   478: ldc 93
    //   480: iconst_2
    //   481: new 95	java/lang/StringBuilder
    //   484: dup
    //   485: invokespecial 96	java/lang/StringBuilder:<init>	()V
    //   488: aload 10
    ...
    //   496: invokevirtual 102	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   499: ldc_w 329
    //   502: invokevirtual 102	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   505: invokevirtual 105	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   508: aload 11
  ...
  protected boolean a(abiv paramabiv)
  {
    int i = 0;
    String[] arrayOfString = paramabiv.a();
    if ((arrayOfString == null) || (arrayOfString.length == 0)) {
      return false;
    }
    while (i < arrayOfString.length)
    {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(arrayOfString[i], paramabiv);
      i += 1;
    }
    return true;
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, aqwp paramaqwp, Class<? extends MSFServlet> paramClass)
  {
    int i = 1;
    AppInterface localAppInterface = a();
    Object localObject1 = paramToServiceMsg.getServiceCmd();
    abiv localabiv = a((String)localObject1);
    Object localObject2;
    int j;
    if (localabiv != null)
    {
      ...
      if (localabiv.a())
      {
        localObject2 = localabiv.a(paramToServiceMsg);
    ...
    for (;;)
    {
      if (i != 0)
      {
        paramToServiceMsg.actionListener = paramaqwp;
        paramaqwp = new NewIntent(localAppInterface.getApplication(), paramClass);
        paramaqwp.putExtra(ToServiceMsg.class.getSimpleName(), paramToServiceMsg);
        localAppInterface.startServlet(paramaqwp);
      ...
      do
      {
        ...
        {
          return;
          if (!localabiv.a(paramToServiceMsg, (UniPacket)localObject2)) {
            break label314;
          }
          paramToServiceMsg.putWupBuffer(((UniPacket)localObject2).encode());
          break;
        } while (localabiv == null);
        paramaqwp = new FromServiceMsg(localAppInterface.getCurrentAccountUin(), (String)localObject1);
        paramClass = (int[])anvc.a().get(localObject1);
      } while ((paramClass == null) || (paramClass.length <= 0));
      j = paramClass.length;
      i = 0;
      while (i < j)
      {
        localObject1 = (anud)localAppInterface.getBusinessHandler(paramClass[i]);
        if (localObject1 != null) {}
        try
        {
          ((anud)localObject1).onReceive(paramToServiceMsg, paramaqwp, null);
          i += 1;
        }
