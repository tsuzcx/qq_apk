...
public abstract class bcpy
{
  ...
  protected void a(ToServiceMsg paramToServiceMsg, aqtc paramaqtc, Class<? extends MSFServlet> paramClass)
  {
    ...
    paramToServiceMsg = new PeakJceServiceBase.1(this, paramToServiceMsg, paramaqtc, paramClass);
  ...
  public void a(boolean paramBoolean, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Exception paramException)
  {
    ...
    //   130: invokevirtual 250	bcpy:a	(Ljava/lang/String;)Laauq;
    //   133: astore 9
    //   135: iload_1
    //   136: ifeq +323 -> 459
    //   139: aload 9
    ...
    //   146: aload_2
    //   147: aload_3
    //   148: invokevirtual 253	aauq:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;)V
    //   151: aload 9
    //   153: aload_2
    //   154: aload_3
    //   155: invokevirtual 256	aauq:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;)Ljava/lang/Object;
    //   158: astore 4
    //   160: aload_0
    //   161: aload_3
    ...
    //   165: aload 9
    //   167: ifnull -163 -> 4
    //   170: invokestatic 263	anrx:b	()Ljava/util/Map;
    //   173: aload_3
    ...
    //   223: checkcast 276	com/tencent/mobileqq/app/BusinessHandler
    //   226: astore 10
    //   228: aload 10
    //   230: ifnull +12 -> 242
    //   233: aload 10
    ...
    //   236: aload_3
    //   237: aload 4
    //   239: invokevirtual 280	com/tencent/mobileqq/app/BusinessHandler:onReceive	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/qphone/base/remote/FromServiceMsg;Ljava/lang/Object;)V
    //   242: iload 6
    //   244: iconst_1
    //   245: iadd
    //   246: istore 6
    ...
    //   226	263	10	localBusinessHandler	BusinessHandler
  ...
  public void b(ToServiceMsg paramToServiceMsg, aqtc paramaqtc, Class<? extends MSFServlet> paramClass)
  {
    int i = 1;
    AppInterface localAppInterface = a();
    Object localObject1 = paramToServiceMsg.getServiceCmd();
    aauq localaauq = a((String)localObject1);
    Object localObject2;
    int j;
    if (localaauq != null)
    {
      ...
      if (localaauq.a())
      {
        localObject2 = localaauq.a(paramToServiceMsg);
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        {
          return;
          if (!localaauq.a(paramToServiceMsg, (UniPacket)localObject2)) {
            break label314;
          }
          paramToServiceMsg.putWupBuffer(((UniPacket)localObject2).encode());
          break;
        } while (localaauq == null);
        paramaqtc = new FromServiceMsg(localAppInterface.getCurrentAccountUin(), (String)localObject1);
        paramClass = (int[])anrx.a().get(localObject1);
