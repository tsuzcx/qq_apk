  ...
  implements Handler.Callback, bjxx, bkyy, HWDecodeListener
{
  ...
  public bjzg(@NonNull bjxn parambjxn)
  {
    super(parambjxn);
  ...
  public static Bitmap a(Context paramContext, Bitmap paramBitmap, bkyb parambkyb)
  {
    if ((paramBitmap == null) || (parambkyb == null)) {
      return null;
    }
    Object localObject = vzu.a(paramBitmap.getWidth(), paramBitmap.getHeight(), axlk.jdField_a_of_type_Int, axlk.jdField_b_of_type_Int);
    int j = ((Integer)((Pair)localObject).first).intValue();
    int k = ((Integer)((Pair)localObject).second).intValue();
    int i = bkxu.jdField_a_of_type_Int;
    if (k > i) {
      j = (int)(j * i / k);
    }
    for (;;)
    {
      ...
      {
        paramContext = bbef.a(paramContext, bbef.c(paramBitmap), 0.4F, 25.0F);
        parambkyb = paramContext;
        ...
        label205:
        for (parambkyb = paramContext;; parambkyb = paramContext.copy(paramContext.getConfig(), true))
        {
          localCanvas.setBitmap(parambkyb);
          localCanvas.drawColor(Color.parseColor("#3F000000"), PorterDuff.Mode.SRC_OVER);
          parambkyb = paramContext;
          paramContext = vxv.a(vxv.a(parambkyb, j, i, true), paramBitmap);
  ...
  private Bitmap a(@NonNull bjzi parambjzi, boolean paramBoolean)
  {
    long l1 = 0L;
    int i = 180;
    Object localObject2 = bjzi.a(parambjzi);
    long l2 = this.jdField_a_of_type_Bjxn.c() / 1000000L;
    Object localObject1;
    if ((l2 != 0L) && (paramBoolean))
    {
      localObject1 = bkyr.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo, l2);
    ...
    for (;;)
    {
      ...
      label126:
      Object localObject3;
      if (vzu.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo))
      {
        i = 0;
        ...
        localObject1 = a(a(), (Bitmap)localObject1, localbkyb);
        localObject3 = biif.a(biif.jdField_c_of_type_Int);
        localObject2 = localObject1;
        if (localObject3 != null)
        {
          ...
          {
            if (paramBoolean) {
              l1 = this.jdField_a_of_type_Bjxn.c();
            }
            localObject3 = localbkyb.a((Bitmap)localObject1, l1);
            localObject2 = localObject1;
            if (localObject3 != null) {
        ...
        if ((!bjzi.a(parambjzi)) || (!bkya.a(bjzi.a(parambjzi)))) {
          break label635;
        }
        switch (bjzi.a(parambjzi))
        {
        default: 
          localObject1 = null;
          label251:
          if (localObject1 != null)
          {
            ...
            ved.a("Q.qqstory.record.HWEditImportVideoPlayer", "updateFragmentThumbBitmapIfNeeded, filterThumbBitmap = %s", localObject3);
            if (localObject3 != null) {
      ...
      for (;;)
      {
        ...
        {
          localObject2 = localObject1;
          if (bjzi.b(parambjzi) != null)
          {
            bkyf localbkyf = (bkyf)bkya.a(106);
            localbkyf.a(bjzi.b(parambjzi));
            localbkyf.init();
            localObject2 = localbkyb.a((Bitmap)localObject1, localbkyf);
            ved.a("Q.qqstory.record.HWEditImportVideoPlayer", "updateFragmentThumbBitmapIfNeeded, mosaicThumbBitmap = %s", localObject2);
            if (localObject2 != null) {
              localObject1 = localObject2;
            }
            localbkyf.destroy();
        ...
        if ((localObject3 != null) && (localObject3 != bjzi.a(parambjzi)) && (localObject3 != localObject2)) {
          ((Bitmap)localObject3).recycle();
        }
        localbkyb.a();
        localObject1 = localObject2;
        if (i != 0) {
          localObject1 = vzl.a((Bitmap)localObject2, 360 - i);
        }
        localObject2 = localObject1;
        if (this.jdField_e_of_type_Boolean) {
          localObject2 = vzl.a((Bitmap)localObject1, 90.0F);
        }
        if ((localObject2 != bjzi.a(parambjzi)) || (bjzi.a(parambjzi)) || (bjzi.b(parambjzi)))
        {
          return localObject2;
          ...
          {
            localObject2 = this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("vip_forward_name");
            localObject1 = a(localbkyb, (Bitmap)localObject1, a(), a().getString(2131699526, new Object[] { localObject2 }));
            break label126;
          }
          localbkyb.a(((Bitmap)localObject1).getWidth(), ((Bitmap)localObject1).getHeight());
          break label126;
        ...
        return parambjzi.jdField_c_of_type_AndroidGraphicsBitmap;
        localObject1 = localObject2;
        continue;
        label635:
        localObject3 = null;
  ...
  public static Bitmap a(bkyb parambkyb, Bitmap paramBitmap, Context paramContext, String paramString)
  {
    ...
    for (j = (int)(k * i / j);; j = k)
    {
      ...
      i = avte.a(i);
      parambkyb.a(j, i);
      parambkyb = new bkyp(paramContext, paramString);
      parambkyb.a(k, m, j, i);
      paramContext = new GLImage();
      paramContext.loadTextureSync(paramBitmap);
      paramBitmap = GlUtil.captureFrame(parambkyb.a(paramContext.getTexture()), j, i);
      parambkyb.a();
      return paramBitmap;
      i = j;
    }
  ...
  private void a(@NonNull bjzi parambjzi)
  {
    ved.b("Q.qqstory.record.HWEditImportVideoPlayer", "setPlayInfo，index : %d => %d", Integer.valueOf(this.jdField_a_of_type_Int), Integer.valueOf(parambjzi.jdField_c_of_type_Int));
    if (parambjzi.jdField_a_of_type_JavaLangString == null)
    {
      ...
      this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.setPlayRange((int)bjzi.a(parambjzi), (int)bjzi.b(parambjzi));
      if (this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoFilter != null) {
        this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoFilter.a(3, ajya.a(2131705678));
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_Int = parambjzi.jdField_c_of_type_Int;
      return;
      if (!this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.a().equalsIgnoreCase(parambjzi.jdField_a_of_type_JavaLangString))
      {
        this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.c();
        this.jdField_d_of_type_Int = this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
        this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.setFilePath(parambjzi.jdField_a_of_type_JavaLangString, parambjzi.jdField_b_of_type_JavaLangString, true, this.jdField_c_of_type_Boolean, this.jdField_d_of_type_Boolean);
  ...
  private void n()
  {
    ...
    int j;
    float f1;
    if ((this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int == 14) && (this.jdField_a_of_type_Bjxn.a() != null) && (!this.jdField_a_of_type_Bjxn.a().isLandTakePicToVideo()) && ((this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditLocalVideoSource)))
    {
      k = ((EditLocalVideoSource)this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource).jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.rotation;
      j = this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a();
      i = this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.b();
      if ((k == 90) || (k == 270))
      {
        j = Math.min(this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a(), this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.b());
        i = Math.max(this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.a(), this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource.b());
      }
      f1 = j / i;
      j = axlk.jdField_a_of_type_Int;
      i = axlk.jdField_b_of_type_Int;
      if (axlk.a(a())) {
        break label333;
      }
    }
    label333:
    for (int i = axlk.c(a());; i = axlk.jdField_b_of_type_Int)
    {
      k = (int)(j / f1);
  ...
  public int a()
  {
    ...
    {
      bjzi localbjzi = (bjzi)this.jdField_a_of_type_JavaUtilList.get(i);
      if (localbjzi != null) {
        return bjzi.a(localbjzi);
      }
    }
    return 0;
  }
  ...
  public long a(int paramInt)
  {
    ...
    {
      bjzi localbjzi = (bjzi)this.jdField_a_of_type_JavaUtilList.get(paramInt);
      return bjzi.b(localbjzi) - bjzi.a(localbjzi);
    }
    ved.e("Q.qqstory.record.HWEditImportVideoPlayer", "getDurationOfFragment with invalid index = %d", new Object[] { Integer.valueOf(paramInt) });
    return 0L;
  }
  ...
  {
    if (paramInt < this.jdField_a_of_type_JavaUtilList.size()) {
      return a((bjzi)this.jdField_a_of_type_JavaUtilList.get(paramInt), true);
    }
    ved.e("Q.qqstory.record.HWEditImportVideoPlayer", "getDurationOfFragment with invalid index = %d", new Object[] { Integer.valueOf(paramInt) });
    return null;
  }
  ...
  public void a()
  {
    ...
    {
      localObject = (EditLocalVideoSource)this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource;
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mediaWidth == 0) || (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo.mediaHeight == 0))
      {
        ...
        blcj.a(this.jdField_a_of_type_JavaLangString, (blck)localObject);
      ...
      ved.d("Q.qqstory.record.HWEditImportVideoPlayer", "recordMultiVideoFragment = %s, supportMultiVideoFragment = %s", new Object[] { Boolean.valueOf(bool1), Boolean.valueOf(bool2) });
      if ((!bool1) || (!bool2)) {
        break label642;
      }
      bool1 = true;
      ...
      if (this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int == 14) {
        break label647;
      }
      this.jdField_d_of_type_Int = this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
      label334:
      this.jdField_c_of_type_Boolean = this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("extra_is_fit_center", false);
      this.jdField_d_of_type_Boolean = this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("extra_is_need_gaussion_blur", false);
      if (this.jdField_d_of_type_Boolean) {
        if (!vzu.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo)) {
          break label758;
        }
    ...
    for (int i = -90;; i = 0)
    {
      ...
      {
        localObject = (VideoStoryDataBean)this.jdField_a_of_type_Bjxn.jdField_a_of_type_AndroidOsBundle.getSerializable("KEY_VIDEO_STORY_CAMERA_TYPE");
      ...
      else if (this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("is_video_forward", false))
      {
        if (!vzu.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo)) {
          break label753;
        }
      ...
      for (i = j;; i = 0)
      {
        localObject = this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("vip_forward_name");
        this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.a(a().getString(2131699526, new Object[] { localObject }), i);
        ...
        this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.setTrackerCallback(new bjzh(this));
        a(bjxx.class, this);
        ...
        bool1 = false;
        break;
        if (((this.jdField_a_of_type_Bjxn.a() != null) && (this.jdField_a_of_type_Bjxn.a().isLandTakePicToVideo())) || (!vzu.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo))) {
          this.jdField_d_of_type_Int = this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoLocalMediaInfo);
        }
        for (;;)
        {
  ...
  public void a(int paramInt)
  {
    ...
    {
      localbjzi = (bjzi)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_Int);
      if (localbjzi.jdField_a_of_type_JavaLangString == null)
      {
    ...
    for (;;)
    {
      ...
      return;
      ved.b("Q.qqstory.record.HWEditImportVideoPlayer", "setPlayMode change to iframe video");
      a(localbjzi);
      break;
  ...
  public void a(int paramInt1, int paramInt2, float paramFloat)
  {
    ...
    if ((f1 == 0.0F) || (f1 > 0.95F))
    {
      ...
      a(paramInt1);
      ved.a("Q.qqstory.record.HWEditImportVideoPlayer", "setSlideMode lefPlayMode=%s rightMode=%s, offset=%s", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Float.valueOf(paramFloat));
    }
    do
    {
      return;
  ...
  public void a(int paramInt, @NonNull bkld parambkld)
  {
    ...
    if (i > 1) {
      if (paramInt < i)
      {
        localObject = (bjzi)this.jdField_a_of_type_JavaUtilList.get(paramInt);
        parambkld.a.hasFragments = true;
        parambkld.a.videoNeedRotate = false;
        parambkld.a.videoRangeStart = ((int)bjzi.a((bjzi)localObject));
        parambkld.a.videoRangeEnd = ((int)bjzi.b((bjzi)localObject));
        ved.b("Q.qqstory.record.HWEditImportVideoPlayer", "editVideoPrePublish : %s", localObject);
      }
    }
    for (;;)
    {
      parambkld.a.putExtra("local_import", Boolean.valueOf(true));
      parambkld.a.putExtra("video_rotation", Integer.valueOf(this.jdField_d_of_type_Int));
      ...
      parambkld.a.putExtra("landscape_video", Boolean.valueOf(bool));
      parambkld.a.putExtra("extra_is_need_gaussion_blur", Boolean.valueOf(this.jdField_d_of_type_Boolean));
      if (this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("is_video_forward", false))
      {
        localObject = this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.a("vip_forward_name");
        parambkld.a.putExtra("video_forward_watermark", a().getString(2131699526, new Object[] { localObject }));
        parambkld.a.putExtra("is_video_forward", Boolean.valueOf(true));
      }
      return;
      ved.d("Q.qqstory.record.HWEditImportVideoPlayer", "editVideoPrePublish : get invalid fragment index = %d, fragment count = %d", new Object[] { Integer.valueOf(paramInt), Integer.valueOf(i) });
      continue;
      if (i == 1)
      {
        localObject = (bjzi)this.jdField_a_of_type_JavaUtilList.get(paramInt);
        parambkld.a.videoNeedRotate = false;
        parambkld.a.videoRangeStart = this.jdField_b_of_type_Int;
        parambkld.a.videoRangeEnd = this.jdField_c_of_type_Int;
        parambkld.a.hwEncodeRecordVideo = true;
      }
    }
  }
  ...
  public void a(Bitmap paramBitmap, boolean paramBoolean)
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilList.size())
    {
      localbjzi = (bjzi)this.jdField_a_of_type_JavaUtilList.get(i);
      bjzi.a(localbjzi, paramBitmap);
      if ((!bjzi.b(localbjzi)) && (!paramBoolean)) {
        break label73;
      }
    }
    label73:
  ...
  public void a(boolean paramBoolean)
  {
    int i = this.jdField_a_of_type_Bjxn.a();
    if (i < this.jdField_a_of_type_JavaUtilList.size()) {
      bjzi.b((bjzi)this.jdField_a_of_type_JavaUtilList.get(i), paramBoolean);
    }
  ...
  protected boolean a(Message paramMessage)
  {
    ...
    if (paramMessage.what == 6)
    {
      ...
      paramMessage = (bjzi)this.jdField_a_of_type_JavaUtilList.get(i);
      ved.b("Q.qqstory.record.HWEditImportVideoPlayer", "MESSAGE_PLAYING_FRAGMENT_CHANGED : fragment = %s", paramMessage);
      this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.setColorFilterType(b(bjzi.a(paramMessage)));
      a(bjzi.a(paramMessage));
      a(paramMessage);
    ...
    for (;;)
    {
      return false;
      label180:
      ved.e("Q.qqstory.record.HWEditImportVideoPlayer", "MESSAGE_PLAYING_FRAGMENT_CHANGED : get invalid index=%d, video fragment count = %d", new Object[] { Integer.valueOf(i), Integer.valueOf(this.jdField_a_of_type_JavaUtilList.size()) });
    }
  }
  ...
  {
    ved.a("Q.qqstory.record.HWEditImportVideoPlayer", "setPlayMode mode=%s", Integer.valueOf(paramInt));
    int i = this.jdField_a_of_type_Bjxn.a();
    if (i < this.jdField_a_of_type_JavaUtilList.size())
    {
      bjzi localbjzi = (bjzi)this.jdField_a_of_type_JavaUtilList.get(i);
      if (bjzi.a(localbjzi) != paramInt)
      {
        bjzi.a(localbjzi, paramInt);
        bjzi.c(localbjzi, true);
      }
    }
  }
  ...
  public void g()
  {
    ...
    super.g();
    if ((bjjc.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.j > 100) && (this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.c > 0L))
    {
      ...
      if (vei.a((int)f1, 0L, 30L)) {
        vei.a("CamEditFreq", true, 0L, new String[] { String.valueOf(this.jdField_a_of_type_Bjxn.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Int), String.valueOf(f1), vei.b(i), String.valueOf(this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.j), String.valueOf(this.jdField_a_of_type_DovComTencentMobileqqRichmediaMediacodecWidgetVideoFilterPlayView.c) });
      }
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilList.size())
    {
      ...
      if ((localBitmap != null) && (localBitmap != paramMessage.jdField_c_of_type_AndroidGraphicsBitmap))
      {
        ...
        ved.b("Q.qqstory.record.HWEditImportVideoPlayer", "update fragment bitmap : %s", paramMessage);
