...
public class aqsg
{
  private aqnl jdField_a_of_type_Aqnl = new aqsh(this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private LinkedHashMap<Long, aqzu> jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
  
  public aqsg(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(long paramLong1, String paramString, int paramInt, long paramLong2)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 26	aqsg:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   6: lload 5
    ...
    //   37: ireturn
    //   38: aload_0
    //   39: getfield 28	aqsg:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   42: invokevirtual 60	com/tencent/mobileqq/app/QQAppInterface:a	()Laqsc;
    //   45: lload_1
    //   46: aload_3
    //   47: iload 4
    //   49: lload 5
    //   51: invokevirtual 65	aqsc:a	(JLjava/lang/String;IJ)Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   54: astore_3
    //   55: aload_3
    //   56: ifnonnull +9 -> 65
    //   59: iconst_m1
    ...
    //   62: goto -29 -> 33
    //   65: aload_0
    //   66: getfield 26	aqsg:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   69: aload_3
  ...
  public long a(String paramString, long paramLong1, long paramLong2, int paramInt)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 28	aqsg:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6: invokevirtual 60	com/tencent/mobileqq/app/QQAppInterface:a	()Laqsc;
    //   9: lload 4
    //   11: aload_1
    //   12: iload 6
    //   14: invokevirtual 79	aqsc:a	(JLjava/lang/String;I)Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   17: astore 7
    //   19: aload 7
    //   21: ifnull +45 -> 66
    //   24: aload_0
    //   25: getfield 26	aqsg:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   28: aload 7
    ...
    //   65: lreturn
    //   66: aload_0
    //   67: getfield 28	aqsg:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   70: invokevirtual 60	com/tencent/mobileqq/app/QQAppInterface:a	()Laqsc;
    //   73: aload_1
    //   74: lload_2
    //   75: lload 4
    //   77: iload 6
    //   79: invokevirtual 84	aqsc:a	(Ljava/lang/String;JJI)J
    //   82: lstore_2
    //   83: goto -21 -> 62
    //   86: astore_1
    //   87: aload_0
  ...
  public FileManagerEntity a(String paramString)
  {
    ...
    //   20: areturn
    //   21: aload_0
    //   22: getfield 26	aqsg:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    ...
    //   52: astore 4
    //   54: aload_0
    //   55: getfield 26	aqsg:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   58: aload 4
    //   60: invokevirtual 51	java/util/LinkedHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   63: checkcast 53	aqzu
    //   66: astore 4
    //   68: aload_1
    //   69: aload 4
      ...
      try
      {
        ...
        if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)))
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            localObject = (aqzu)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(localObject);
            FileManagerEntity localFileManagerEntity = ((aqzu)localObject).a();
            if ((paramString1.equalsIgnoreCase((String)localFileManagerEntity.mContext)) && (paramString2.equals(localFileManagerEntity.zipInnerPath))) {
              paramString1 = ((aqzu)localObject).a();
            }
          }
          else
          {
  ...
  public void a()
  {
    ...
    try
    {
      i = bicd.a(BaseApplication.getContext());
      if (i == 1) {
        break label596;
      }
      if (i != 2) {
    ...
    while (localIterator.hasNext())
    {
      ...
      localaqzu = (aqzu)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(localLong);
      if (localaqzu == null)
      {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          break;
          if ((localaqzu.a() == 1) || (localaqzu.a() == 8) || (localaqzu.a() == 5) || (localaqzu.a() == 50)) {
            break label614;
          }
          if (localaqzu.a() != 41) {
            break label376;
        ...
        label376:
        str2 = str2 + "type[" + localaqzu.a() + "] is not processed, maxtype is " + 8 + "\n";
        continue;
        label426:
  ...
  public void a(long paramLong)
  {
    try
    {
      aqzu localaqzu = (aqzu)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(Long.valueOf(paramLong));
      if (localaqzu != null) {
        localaqzu.b();
      }
      if (QLog.isColorLevel()) {
  ...
  public void a(long paramLong1, long paramLong2, String paramString, int paramInt1, int paramInt2)
  {
    ...
    if ((localFileManagerEntity1.cloudType != 2) && (localFileManagerEntity1.cloudType != 0))
    {
      ...
      {
        arni.a(BaseApplicationImpl.getContext().getString(2131692939));
    ...
    if ((localFileManagerEntity1.nFileType == 2) && (!localFileManagerEntity1.isZipInnerFile) && (localFileManagerEntity1.cloudType != 2) && ((localFileManagerEntity1.peerType == 3000) || (localFileManagerEntity1.peerType == 0)))
    {
      ...
      aqsz.a(BaseActivity.sTopActivity, new aqsj(this, localFileManagerEntity1));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(true, 3, null);
      return;
    }
  ...
  public void a(long paramLong, aqzu paramaqzu)
  {
    try
    {
      this.jdField_a_of_type_JavaUtilLinkedHashMap.put(Long.valueOf(paramLong), paramaqzu);
  ...
  public void a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (!bdcs.b(paramFileManagerEntity.getFilePath()))
    {
      ...
      for (;;)
      {
        ...
        return;
        if (!arni.b(paramFileManagerEntity.getFilePath()))
        {
          i = 9042;
        ...
        localObject = str;
        if (arni.a(paramFileManagerEntity.getFilePath()) != 0L) {
          break;
        }
        i = 9071;
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(paramFileManagerEntity);
        arni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity.nSessionId, "actFileUp", 0L, "", paramFileManagerEntity.peerUin, paramFileManagerEntity.Uuid, paramFileManagerEntity.strFileMd5, i, "", 0L, 0L, paramFileManagerEntity.fileSize, "", "", 0, (String)localObject, null);
        arni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity.nSessionId, "actFileUpDetail", 0L, "", paramFileManagerEntity.peerUin, paramFileManagerEntity.Uuid, paramFileManagerEntity.strFileMd5, i, "", 0L, 0L, paramFileManagerEntity.fileSize, "", "", 0, (String)localObject, null);
        continue;
        paramFileManagerEntity.status = 0;
        ...
        arni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity.nSessionId, "actFileWyUp", 0L, "", paramFileManagerEntity.peerUin, paramFileManagerEntity.Uuid, paramFileManagerEntity.strFileMd5, i, "", 0L, 0L, paramFileManagerEntity.fileSize, "", "", 0, (String)localObject, null);
      }
    }
    if (paramFileManagerEntity.peerType == 3000) {
      localObject = new aqzo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity);
    }
    for (;;)
    {
      try
      ...
      localObject = (atvt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(16);
      if ((localObject != null) && (((atvt)localObject).a(paramFileManagerEntity.peerUin)))
      {
        ...
        for (i = 0;; i = 16)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramFileManagerEntity.uniseq, paramFileManagerEntity.nSessionId, paramFileManagerEntity.peerUin, paramFileManagerEntity.peerType, 15, null, -1, alpo.a(2131704913));
          return;
        }
      }
      if (paramFileManagerEntity.nOpType == 0)
      {
        if ((aqzy.a().a()) && (paramFileManagerEntity.fileSize > aqzy.a().a())) {
          localObject = new arap(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity);
        } else {
          localObject = new aqtv(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity);
        }
      }
      else {
        localObject = new aqsk(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity);
      }
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      while (((Iterator)localObject2).hasNext()) {
        localArrayList.add(0, (aqzu)((Iterator)localObject2).next());
      }
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        localObject2 = (aqzu)localIterator.next();
        ((aqzu)localObject2).c();
        if (!paramBoolean)
        {
          ((aqzu)localObject2).e();
      ...
      {
        if ((paramBoolean) && (i == 0)) {
          arni.a(BaseApplicationImpl.getContext().getString(2131692967));
        }
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(true, 3, null);
        break;
      }
  ...
  public boolean a(long paramLong)
  {
    ...
    //   30: aload_0
    //   31: getfield 26	aqsg:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   34: lload_1
    ...
    //   41: pop
    //   42: aload_0
    //   43: invokevirtual 239	aqsg:a	()V
    //   46: aload_0
    //   47: getfield 28	aqsg:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   50: invokevirtual 60	com/tencent/mobileqq/app/QQAppInterface:a	()Laqsc;
    //   53: lload_1
    //   54: invokevirtual 243	aqsc:a	(J)Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   57: astore 4
    //   59: aload 4
    //   61: ifnull +87 -> 148
    //   64: aload 4
    ...
    //   96: invokestatic 462	aqsz:a	(Ljava/lang/String;)V
    //   99: aload 4
    ...
    //   123: aload_0
    //   124: getfield 28	aqsg:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   127: invokevirtual 60	com/tencent/mobileqq/app/QQAppInterface:a	()Laqsc;
    //   130: aload 4
    //   132: invokevirtual 258	aqsc:c	(Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;)V
    //   135: aload_0
    //   136: getfield 28	aqsg:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   139: invokevirtual 33	com/tencent/mobileqq/app/QQAppInterface:a	()Laqse;
    //   142: iconst_1
    //   143: iconst_0
    //   144: aconst_null
    //   145: invokevirtual 261	aqse:a	(ZILjava/lang/Object;)V
    //   148: aload 4
    //   150: ifnull +36 -> 186
    //   153: aload 4
    ...
    //   168: aload_0
    //   169: getfield 28	aqsg:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   172: invokevirtual 60	com/tencent/mobileqq/app/QQAppInterface:a	()Laqsc;
    //   175: aload 4
    //   177: invokevirtual 258	aqsc:c	(Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;)V
    //   180: iconst_1
    //   181: istore_3
    //   182: aload_0
    //   183: monitorexit
  ...
  public boolean a(String paramString)
  {
    ...
    //   55: astore 5
    //   57: aload_0
    //   58: getfield 26	aqsg:jdField_a_of_type_JavaUtilLinkedHashMap	Ljava/util/LinkedHashMap;
    //   61: aload 5
    //   63: invokevirtual 51	java/util/LinkedHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   66: checkcast 53	aqzu
  ...
  public boolean a(String paramString, long paramLong, int paramInt)
  {
    ...
    //   11: iload 4
    //   13: ldc2_w 467
    //   16: invokevirtual 65	aqsc:a	(JLjava/lang/String;IJ)Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;
    //   19: astore_1
    //   20: aload_1
    //   21: ifnonnull +11 -> 32
    //   24: iconst_0
    ...
    //   37: invokevirtual 470	aqsg:a	(J)Z
    //   40: istore 5
    //   42: goto -15 -> 27
    //   45: astore_1
    //   46: aload_0
  ...
  public void b(FileManagerEntity paramFileManagerEntity)
  {
    ...
    {
      aqsz.a(BaseActivity.sTopActivity, new aqsi(this, paramFileManagerEntity));
      return;
    }
    if ((paramFileManagerEntity.peerType == 0) && (paramFileManagerEntity.nOpType != 5) && (paramFileManagerEntity.nOpType != 50) && (aqzy.a().b()) && (paramFileManagerEntity.fileSize > aqzy.a().b()) && (!TextUtils.isEmpty(paramFileManagerEntity.Uuid))) {}
    for (Object localObject = new araj(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity);; localObject = new aqsk(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity)) {
      try
      {
        this.jdField_a_of_type_JavaUtilLinkedHashMap.put(Long.valueOf(paramFileManagerEntity.nSessionId), localObject);
  ...
  public void c(FileManagerEntity paramFileManagerEntity)
  {
    ...
    for (;;)
    {
      ...
      aqzu localaqzu = (aqzu)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(Long.valueOf(paramFileManagerEntity.nSessionId));
      if ((localaqzu == null) || (localaqzu.a())) {
        break;
      }
