  ...
  implements View.OnClickListener
{
  ...
  public bjsf(@NonNull bjww parambjww)
  {
    super(parambjww);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetSeekBar.setOnSeekBarChangeListener(new bjsg(this));
  }
  
  public void a(@NonNull bkkm parambkkm)
  {
    if (this.e == -1) {
      if (this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditGifImage.jdField_a_of_type_Boolean)
      {
        parambkkm.a.jdField_b_of_type_Int = ((int)this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditGifImage.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a());
        parambkkm.a.d = this.jdField_a_of_type_Boolean;
        if (QLog.isColorLevel()) {
  ...
  public boolean a()
  {
    ...
    if (this.jdField_a_of_type_Bjww.jdField_a_of_type_Int == 21)
    {
      ...
      if (this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditGifImage.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable != null) {
        this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditGifImage.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a(NativeGifImage.QZONE_DELAY);
      }
      this.e = this.c;
  ...
  public void a_(int paramInt, Object paramObject)
  {
    ...
    if (this.e == -1)
    {
      ...
      paramInt = (int)this.jdField_a_of_type_Bjww.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditGifImage.jdField_a_of_type_CooperationQzoneWidgetFastAnimationDrawable.a();
      this.e = paramInt;
      this.c = paramInt;
    }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131375782: 
      do
      {
        return;
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      } while (this.jdField_a_of_type_Bjww.jdField_a_of_type_Int != 21);
      this.jdField_a_of_type_Bjww.a(0);
      return;
    }
    a();
