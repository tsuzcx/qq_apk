...
public class bfsh
  implements bawr, baxa
{
  private static bfsh jdField_a_of_type_Bfsh;
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  public baws a;
  private bghx jdField_a_of_type_Bghx;
  private String jdField_a_of_type_JavaLangString = miu.a(BaseApplicationImpl.getContext());
  ...
  public void a(int paramInt)
  {
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      this.jdField_a_of_type_JavaLangString = miu.a(BaseApplicationImpl.getContext());
      if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
      {
        QIPCClientHelper.getInstance().getClient().callServer("QzoneIPCModule", "startDownloadVoicechangeSo", null);
        bbmy.a(BaseApplicationImpl.getContext(), ajjy.a(2131647489), 1);
      }
    }
    while (this.jdField_a_of_type_Baws == null) {
      return;
    }
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_Baws.f = paramInt;
    bawv.b(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Baws, this.jdField_a_of_type_JavaLangString, this);
  }
  ...
  public void a(Intent paramIntent, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_Baws = new baws(this.jdField_b_of_type_JavaLangString, i, j, k, 0);
      switch (paramInt)
      {
      default: 
        return;
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    try
    {
      ...
      this.jdField_a_of_type_Bghx.a(this.c, localStringBuilder.toString());
      return;
    }
  ...
  public void a(String paramString, int paramInt, bghx parambghx)
  {
  ...
  public void a(String paramString, bghx parambghx)
  {
    QZLog.d("RecordAndChangeVoiceService", 2, "getMoodVoiceRecordTime");
    if (this.jdField_a_of_type_Baws == null) {
      return;
    }
  ...
  public void b(String paramString, int paramInt, bghx parambghx)
  {
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      this.jdField_a_of_type_JavaLangString = miu.a(BaseApplicationImpl.getContext());
      ...
      {
        QIPCClientHelper.getInstance().getClient().callServer("QzoneIPCModule", "startDownloadVoicechangeSo", null);
        bbmy.a(BaseApplicationImpl.getContext(), ajjy.a(2131647490), 1);
      }
      return;
    }
    QZLog.d("RecordAndChangeVoiceService", 2, "getMoodVoiceData callback" + paramString + " voiceID " + paramInt);
    this.c = paramString;
    this.jdField_a_of_type_Bghx = parambghx;
    bawv.a(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Baws, this.jdField_a_of_type_JavaLangString, this);
    bawv.a(this.jdField_b_of_type_JavaLangString, this);
  }
  ...
  public void e()
  {
    ...
    this.c = null;
    this.jdField_a_of_type_Baws = null;
    this.jdField_a_of_type_Long = -1L;
    this.jdField_b_of_type_Long = -1L;
    this.jdField_a_of_type_Int = -1;
    this.jdField_a_of_type_Bghx = null;
  }
}
