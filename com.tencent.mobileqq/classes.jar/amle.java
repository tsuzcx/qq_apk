...
public class amle
{
  public static int a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    {
      paramMessageRecord = adyf.a(paramQQAppInterface, paramMessageRecord);
      int i;
      ...
      else if ((paramMessageRecord instanceof MessageForTroopFile))
      {
        ...
        if (paramQQAppInterface != null)
        {
          i = apug.a(paramQQAppInterface.g);
          if (i == 0) {
            return 3;
          }
          if (i == 2) {
  ...
  public static final String a(Context paramContext, int paramInt)
  {
    ...
    if (i < 60) {
      return paramContext.getString(2131699361, new Object[] { Integer.valueOf(i) });
    }
    if (i < 3600) {
      return paramContext.getString(2131699362, new Object[] { Integer.valueOf(i / 60), Integer.valueOf(i % 60) });
    }
    paramInt = i / 60;
    return paramContext.getString(2131699363, new Object[] { Integer.valueOf(paramInt / 60), Integer.valueOf(paramInt % 60) });
  }
  ...
  public static void a(boolean paramBoolean1, int paramInt1, int paramInt2, boolean paramBoolean2, String paramString)
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      axrn.a(BaseApplication.getContext()).a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "DanmakuRequestMonitor", paramBoolean1, 0L, 0L, localHashMap, null);
      return;
      str = "0";
      break;
    }
