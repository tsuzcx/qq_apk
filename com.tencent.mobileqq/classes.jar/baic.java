  ...
  extends badc<FrameLayout>
{
  ...
  public baic(@NotNull String paramString, @Nullable baei parambaei, @Nullable azxr paramazxr)
  {
  ...
  @NotNull
  public final bahz a(@Nullable azxr paramazxr)
  {
    if (paramazxr != null) {}
    for (Object localObject1 = paramazxr.jdField_a_of_type_ComTencentMobileqqDataCard; localObject1 == null; localObject1 = null) {
      return new bahz(0L, 0L, null, null, null, null, 63, null);
    }
    ...
    for (;;)
    {
      ...
      localObject1 = new bahw(l1, l2, str2, l3, i, (String)localObject1, (String)localObject2, str1, str3, localCard.wzryHonorInfo, localCard.strExtInfo, localCard.strCurrentBgUrl);
      localObject2 = paramazxr.jdField_a_of_type_ComTencentMobileqqDataCard;
      localObject2 = new bahy(((Card)localObject2).diyText, ((Card)localObject2).diyTextFontId, ((Card)localObject2).diyTextWidth, ((Card)localObject2).diyTextHeight, ((Card)localObject2).diyTextLocX, ((Card)localObject2).diyTextLocY, ((Card)localObject2).diyTextDegree, ((Card)localObject2).diyTextScale, ((Card)localObject2).diyTextTransparency, ((Card)localObject2).diyDefaultText);
      return new bahz(paramazxr.jdField_a_of_type_Long, paramazxr.b, paramazxr.jdField_a_of_type_Azxy, (bahw)localObject1, paramazxr.jdField_a_of_type_Bahx, (bahy)localObject2);
      localObject1 = "";
      break;
      label274:
      localObject2 = "";
  ...
  public final void a(@Nullable String paramString)
  {
    ...
    do
    {
      ...
      i = 0;
      break;
      QAPM.setAbFactor("资料卡背景", paramString, adkr.class);
  ...
  public final boolean a(@Nullable azxr paramazxr)
  {
    bahz localbahz = a(paramazxr);
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_a_of_type_JavaLangString, 4, "vasdata = " + localbahz);
    }
    return a(localbahz) | super.a(paramazxr);
  }
  
  public abstract boolean a(@NotNull bahz parambahz);
