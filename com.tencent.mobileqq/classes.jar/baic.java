  ...
  implements Handler.Callback
{
  ...
  public azzj a;
  private baib jdField_a_of_type_Baib;
  SessionInfo jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
  public CameraCaptureView a;
  private ArrayList<baib> jdField_a_of_type_JavaUtilArrayList;
  ...
  private void c()
  {
    try
    {
      if ((this.jdField_a_of_type_Boolean) && (this.jdField_c_of_type_JavaLangString != null) && (this.jdField_f_of_type_Boolean) && (!this.jdField_c_of_type_Boolean))
      {
        ...
        this.jdField_a_of_type_Azzj.a(201, -1, localBundle);
  ...
  public void a()
  {
    ...
    try
    {
      ...
      Bundle localBundle = a();
      this.jdField_a_of_type_Azzj.a(208, -1, localBundle);
      if (QLog.isColorLevel()) {
  ...
  public void a(baib parambaib, boolean paramBoolean, MediaFormat paramMediaFormat)
  {
    int i = parambaib.a();
    long l = parambaib.a();
    String str = parambaib.a();
    if (QLog.isColorLevel()) {
      QLog.d("SegmentManager", 2, "onEncodeVideoSegment:" + parambaib);
    }
    int j = paramMediaFormat.getInteger("width");
    int k = paramMediaFormat.getInteger("height");
    parambaib = a();
    parambaib.putString("video_slice_path", str);
    parambaib.putInt("video_slice_index", i);
    parambaib.putInt("video_slice_width", j);
    parambaib.putInt("video_slice_height", k);
    parambaib.putLong("video_slice_timestamp", l);
    this.jdField_a_of_type_Azzj.a(200, -1, parambaib);
    if (i == 0) {
    ...
    if (paramBoolean)
    {
      ...
      parambaib = a();
      this.jdField_a_of_type_Azzj.a(204, -1, parambaib);
      c();
    }
  }
  ...
  public void b()
  {
    ...
    Bundle localBundle = a();
    this.jdField_a_of_type_Azzj.a(206, -1, localBundle);
    a();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    try
    {
      ...
      case 1: 
        ...
        this.jdField_a_of_type_Baib = new baib(d(), i);
        this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Baib);
        if (QLog.isColorLevel()) {
          QLog.d("SegmentManager", 2, "Muxer_Start :" + this.jdField_a_of_type_Baib);
        }
        this.jdField_a_of_type_AndroidMediaMediaMuxer = new MediaMuxer(this.jdField_a_of_type_Baib.a(), 0);
    ...
    paramMessage = (baga)paramMessage.obj;
    ...
    for (;;)
    {
      ...
      if (a(l, bool))
      {
        ...
        this.jdField_b_of_type_Long = 0L;
        this.jdField_a_of_type_AndroidMediaMediaMuxer.release();
        a(this.jdField_a_of_type_Baib, false, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a());
        i = this.jdField_a_of_type_JavaUtilArrayList.size();
        this.jdField_a_of_type_Baib = new baib(d(), i);
        this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Baib);
        this.jdField_a_of_type_AndroidMediaMediaMuxer = new MediaMuxer(this.jdField_a_of_type_Baib.a(), 0);
      ...
      this.jdField_a_of_type_Baib.a(paramMessage);
      ...
      return true;
      if (QLog.isColorLevel()) {
        QLog.d("SegmentManager", 2, "Muxer_Stop :" + this.jdField_a_of_type_Baib);
      }
      this.jdField_a_of_type_AndroidMediaMediaMuxer.release();
      a(this.jdField_a_of_type_Baib, true, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureViewCameraCaptureView.a());
      return true;
      return true;
      boolean bool = true;
      continue;
