...
public class aoxo
{
  ...
  private static aoxq jdField_a_of_type_Aoxq;
  ...
  public static void a(int paramInt, aoxq paramaoxq)
  {
    try
    {
      c();
      jdField_a_of_type_Aoxq = paramaoxq;
  ...
  {
    if (jdField_a_of_type_Aoxq != null) {
      jdField_a_of_type_Aoxq.a(paramInt);
    }
  }
              ...
              if (localaoul != null)
              {
                ...
                for (;;)
                {
                  synchronized (jdField_a_of_type_JavaLangObject)
                  {
                    ...
                    {
                      b(1);
                      localaoul.b((String)((Pair)localObject5).first, 0L, new aoxp(str3, str2, str4, str1));
  ...
  private static boolean b(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(paramString3)) && (!TextUtils.isEmpty(paramString4))) {
      try
      {
        ...
        {
          String str = bjkf.a(paramString2);
  ...
  {
    Object localObject1 = apvq.b(186).a();
    ...
    {
      return;
      localObject1 = ((apvm)localObject1).a();
      if (localObject1 == null)
      {
        ArkAppCenter.c("JSDebuggerSoLoader", String.format("updateJSDebuggerConfig, aiKeywordConfig is null", new Object[0]));
        return;
      }
      localObject1 = ((apwd)localObject1).d;
    } while (localObject1 == null);
    jdField_a_of_type_JavaUtilMap.clear();
    localObject1 = ((ArrayList)localObject1).iterator();
    while (((Iterator)localObject1).hasNext())
    {
      Object localObject2 = (apwg)((Iterator)localObject1).next();
      if (localObject2 != null)
      {
        String str1 = ((apwg)localObject2).jdField_a_of_type_JavaLangString;
        String str2 = ((apwg)localObject2).b;
        localObject2 = ((apwg)localObject2).c;
