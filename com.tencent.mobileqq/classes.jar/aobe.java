...
public class aobe
{
  ...
  public static int a(aoai paramaoai, int paramInt1, int paramInt2)
  {
    int i = paramInt2;
    if (paramInt2 == -1) {
      i = 0;
    }
    Camera.CameraInfo localCameraInfo = paramaoai.a()[paramInt1];
    if (localCameraInfo.facing == 1) {
      return (paramaoai.a().a(paramInt1, localCameraInfo.orientation) - i + 360) % 360;
    }
    return (paramaoai.a().a(paramInt1, localCameraInfo.orientation) + i) % 360;
  }
  ...
  public static Bitmap a(Bitmap paramBitmap)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i("Q.camera.CameraUtils", 4, "clipBitmapToScreenRatio bmpWidth=" + j + " bmpHeight=" + i + " screenWidth=" + azkz.a + " screenHeight=" + azkz.b);
    }
    if (i < j) {
      return paramBitmap;
    }
    double d = azkz.b * 1.0D / azkz.a;
    if (d > i * 1.0D / j)
    {
      k = (int)(i / d);
      if (QLog.isColorLevel()) {
  ...
  public static boolean a()
  {
    ...
    for (;;)
    {
      ...
      azri.a(BaseApplication.getContext()).a(null, "qcamera_choice_type", false, 0L, 0L, (HashMap)localObject, "");
  ...
  private static boolean a(SharedPreferences paramSharedPreferences, String paramString, int paramInt)
  {
    ...
    //   115: aload 6
    //   117: astore 5
    //   119: invokestatic 282	aobd:a	()Laobd;
    //   122: invokevirtual 284	aobd:a	()Ljava/lang/String;
    //   125: astore 9
    //   127: aload 6
    //   129: astore 5
  ...
  {
    return Build.VERSION.SDK_INT >= aobc.a().a();
  }
