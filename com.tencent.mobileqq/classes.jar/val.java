  ...
  extends QCircleFakeAdapter
{
  ...
  private vuv jdField_a_of_type_Vuv;
  ...
  public val(Bundle paramBundle, int paramInt)
  {
    super(paramBundle);
    this.b = paramInt;
  ...
  private void a(RecyclerView paramRecyclerView)
  {
    ...
    this.jdField_a_of_type_Vuv = new vuv(a());
    this.jdField_a_of_type_Vuw = new vuw();
    if (jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Vup = new vup(a());
      this.jdField_a_of_type_Vup.a(false, true);
      this.jdField_a_of_type_Vut.a(this.jdField_a_of_type_Vup);
      this.jdField_a_of_type_Vut.a(new vuu());
    }
    this.jdField_a_of_type_Vut.a(this.jdField_a_of_type_Vuv);
    this.jdField_a_of_type_Vut.a(this.jdField_a_of_type_Vuw);
  ...
  public vam a(ViewGroup paramViewGroup, int paramInt)
  {
    switch (paramInt)
    {
    default: 
      return new vam(new QCircleDefaultFeedItemView(getContext(), paramInt));
    case 1001: 
    case 1002: 
    case 1003: 
      paramViewGroup = new QCircleTimeLineFeedItemView(getContext(), paramInt);
      paramViewGroup.setReportBean(a());
      return new vam(paramViewGroup);
    }
    paramViewGroup = new QCircleGridFeedItemView(getContext(), paramInt);
    paramViewGroup.setTag(2131376627, Boolean.valueOf(true));
    paramViewGroup.setReportBean(a());
    return new vam(paramViewGroup);
  }
  ...
  protected void getItemOffsets(Rect paramRect, View paramView, RecyclerView paramRecyclerView, RecyclerView.State paramState)
  {
    ...
    if ((k == 0) && (i == 1))
    {
      paramRect.set(0, zft.b(getContext(), 24.0F), 0, zft.b(getContext(), 1.0F));
      return;
    }
    if (b(paramRecyclerView, k, i, j))
    {
      paramRect.set(0, 0, zft.b(getContext(), 1.0F), 0);
      return;
    }
    if (a(paramRecyclerView, k, i, j))
    {
      paramRect.set(0, 0, 0, zft.b(getContext(), 1.0F));
      return;
    }
    paramRect.set(0, 0, zft.b(getContext(), 1.0F), zft.b(getContext(), 1.0F));
  }
  ...
  {
    if ((this.mDataList != null) && ((paramViewHolder instanceof vam)))
    {
      vam localvam = (vam)paramViewHolder;
      this.mDataList.get(paramInt);
      localvam.a(this.mDataList.get(paramInt), paramInt, this.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo, (var)this.mInteractor);
    }
