  ...
  extends unk
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ume.a("StorySvc.feed_like_list_batch_715");
  }
  
  public val(List<String> paramList, boolean paramBoolean)
  {
  ...
  public unf a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new vam(localRspBatchFeedLike);
    }
