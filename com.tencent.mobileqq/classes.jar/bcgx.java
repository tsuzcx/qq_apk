...
public class bcgx
{
  ...
  public static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    paramString2.putExtra("selfSet_leftViewText", alpo.a(2131713865));
    if (bect.a.containsKey("robotsummary")) {
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, int paramInt)
  {
    ...
    paramString5 = aekt.a(new Intent(paramContext, SplashActivity.class), null);
    if (paramInt == 1)
    {
  ...
  public static void a(BaseActivity paramBaseActivity, String paramString)
  {
    ...
    localIntent.putExtra("selfSet_leftViewText", alpo.a(2131713867));
    if (bect.a.containsKey("robotsummary")) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    do
    {
      ...
      paramString1 = alpo.a(2131713866) + paramString2;
      localObject2 = new azqg(StructMsgForGeneralShare.class).c(14).a(alpo.a(2131713869) + paramString3).a(2).a(1).a("web", paramQQAppInterface, (String)localObject2, (String)localObject1, (String)localObject1).d(paramActivity.getResources().getString(2131719127)).a();
      azui localazui = new azui();
      localazui.b(1);
      localazui.a(alpo.a(2131713868));
      aztc localaztc = new aztc();
      localaztc.b(1);
      localaztc.a(new azsm((String)localObject1));
      localaztc.a(new StructMsgItemTitle(paramString3));
      localaztc.a(new azvd(paramString1));
      ((AbsShareMsg)localObject2).addItem(localazui);
      ...
      arum.a(paramActivity, (Intent)localObject2, paramInt);
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    try
    {
      ...
      azmj.b(paramQQAppInterface, "dc00898", "", "", paramString1, paramString1, 0, 0, paramString2, "", paramString3, "");
      return;
    }
    catch (Exception paramString2)
    {
      azmj.b(paramQQAppInterface, "dc00898", "", "", paramString1, paramString1, 0, 0, "0", "", paramString3, "");
    }
  }
  ...
  public static void a(boolean paramBoolean, String paramString)
  {
    ...
    for (localObject = (QQAppInterface)localObject;; localObject = null)
    {
      ...
      ((bckx)localObject).a(paramBoolean, paramString);
      return;
    }
  }
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    ((alzf)localQQAppInterface.a(20)).a(paramString1, paramString2, paramString3, Boolean.valueOf(paramBoolean));
    return true;
  }
  ...
  public static String b(String paramString)
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface)) {
      return bdbt.a((QQAppInterface)localAppRuntime, paramString, false);
    }
    return null;
  }
