...
class axqa
{
  ...
  {
    if (!axpy.a(this.jdField_a_of_type_Axpy).a()) {}
    for (int i = 2;; i = 5)
    {
      if (paramArrayOfInt != null)
      {
  ...
  FileStorageServerListInfo a()
  {
    ...
    ArrayList localArrayList = axpy.c(this.jdField_a_of_type_Axpy, 16);
    ...
    if (localArrayList != null)
    {
      ...
      if (localArrayList.size() > 0)
      {
        int i = b(axpy.a(this.jdField_a_of_type_Axpy).a(axpy.a(this.jdField_a_of_type_Axpy).b()));
        localObject1 = localObject2;
        if (i > -1)
        {
          localObject1 = localObject2;
  ...
  {
    Object localObject2 = null;
    ArrayList localArrayList = axpy.c(this.jdField_a_of_type_Axpy, paramInt);
    Object localObject1 = localObject2;
    if (localArrayList != null)
    {
      localObject1 = localObject2;
  ...
  void a(FileStoragePushFSSvcList paramFileStoragePushFSSvcList)
  {
    ...
    if (paramFileStoragePushFSSvcList != null)
    {
      ...
      if (i <= 10)
      {
        paramFileStoragePushFSSvcList = axpy.a(this.jdField_a_of_type_Axpy, axpy.a(this.jdField_a_of_type_Axpy, i));
        if (paramFileStoragePushFSSvcList != null) {}
      ...
      if (i <= 15)
      {
        paramFileStoragePushFSSvcList = axpy.b(this.jdField_a_of_type_Axpy, axpy.b(this.jdField_a_of_type_Axpy, i));
        if (paramFileStoragePushFSSvcList != null) {}
        for (j = paramFileStoragePushFSSvcList.size();; j = 0)
        {
          this.jdField_a_of_type_Array2dOfInt[i] = new int[j];
      ...
      paramFileStoragePushFSSvcList = axpy.b(this.jdField_a_of_type_Axpy, axpy.b(this.jdField_a_of_type_Axpy, 17));
      i = k;
      if (paramFileStoragePushFSSvcList != null) {
    ...
    axpy.a(this.jdField_a_of_type_Axpy).a();
  }
