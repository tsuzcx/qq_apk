...
{
  private static bntx jdField_a_of_type_Bntx;
  public bntz a;
  private HashMap<String, bnty> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private Lock jdField_a_of_type_JavaUtilConcurrentLocksLock = new ReentrantLock();
  
  public bntx()
  {
    this.jdField_a_of_type_Bntz = new bntz(this);
  }
  
  public static bntx a()
  {
    if (jdField_a_of_type_Bntx == null) {
      jdField_a_of_type_Bntx = new bntx();
    }
    return jdField_a_of_type_Bntx;
  }
  ...
  private void a(FilterDesc paramFilterDesc, long paramLong, int paramInt)
  {
    ...
    try
    {
      Object localObject2 = ((bmrr)bmql.a(5)).a;
      Object localObject1 = new ArrayList();
      if (localObject2 != null) {
        localObject1 = ((bnuc)localObject2).a(0).c;
      }
      ...
      zxp.a("record_filter_download", zxp.a(paramInt, System.currentTimeMillis() - l, paramFilterDesc.resurl, paramLong, paramFilterDesc.name));
  ...
  private void a(FilterDesc paramFilterDesc, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        bnty localbnty = (bnty)this.jdField_a_of_type_JavaUtilHashMap.get(paramFilterDesc.name);
        if ((localbnty != null) && (localbnty.jdField_a_of_type_JavaUtilArrayList != null))
        {
          i = 0;
          if (i < localbnty.jdField_a_of_type_JavaUtilArrayList.size())
          {
            bnua localbnua = (bnua)((WeakReference)localbnty.jdField_a_of_type_JavaUtilArrayList.get(i)).get();
            if (localbnua != null) {
              localArrayList.add(localbnua);
            }
          }
          else
          {
            localbnty.jdField_a_of_type_JavaUtilArrayList.clear();
        ...
        else
        {
          ...
          if ((localArrayList != null) && (localArrayList.size() > 0))
          {
            ...
            {
              paramFilterDesc = (bnua)localArrayList.get(i);
              if (paramFilterDesc != null) {
  ...
  {
    String str = paramFilterDesc.getResFold(bnxl.b);
    bnub.a();
  ...
  /* Error */
  private boolean a(FilterDesc paramFilterDesc, bnua parambnua)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 26	bntx:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   4: invokeinterface 174 1 0
    //   9: aload_0
    //   10: getfield 21	bntx:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   13: aload_1
    ...
    //   33: dup
    //   34: aload_0
    //   35: invokespecial 254	bnty:<init>	(Lbntx;)V
    //   38: astore 4
    //   40: aload 4
    //   42: aload_1
    //   43: putfield 257	bnty:jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc	Lcom/tencent/mobileqq/richmedia/capture/data/FilterDesc;
    //   46: aload 4
    //   48: getfield 181	bnty:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   62: pop
    //   63: aload_0
    //   64: getfield 21	bntx:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   67: aload_1
    ...
    //   78: istore_3
    //   79: aload_0
    //   80: getfield 26	bntx:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   83: invokeinterface 206 1 0
    //   88: iload_3
    //   89: ireturn
    //   90: aload 4
    //   92: getfield 181	bnty:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   112: astore_1
    //   113: aload_0
    //   114: getfield 26	bntx:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    ...
    //   0	124	2	parambnua	bnua
    //   78	31	3	bool	boolean
    //   23	68	4	localbnty	bnty
    // Exception table:
    //   from	to	target	type
    //   9	25	112	finally
    //   30	77	112	finally
  ...
  public void a(FilterDesc paramFilterDesc, bnua parambnua)
  {
    if (!a(paramFilterDesc, parambnua)) {
      a(paramFilterDesc);
    }
  }
