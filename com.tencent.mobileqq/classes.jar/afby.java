  ...
  implements afal
{
  ...
  public afby(BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    this.jdField_a_of_type_AndroidContentContext = paramBaseChatPie.jdField_a_of_type_AndroidContentContext;
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie = paramBaseChatPie;
    this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
    this.jdField_a_of_type_Bcnj = new afbz(this);
  }
  
  private int a(int paramInt)
  {
    if (paramInt == 4) {
      return aekt.a(-11.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    }
    return 0;
  }
  ...
  private void d()
  {
    Object localObject = (akwq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249);
    akwl localakwl = ((akwq)localObject).a();
    if (localakwl == null) {}
    do
    {
      do
  ...
  public RobotPanelLayoutBase a()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agiu)) {
      localTroopAIORobotLayout = ((agiu)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a;
    }
    while (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agqn)) {
      return localTroopAIORobotLayout;
    }
    return ((agqn)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a;
  }
  ...
  public String a(boolean paramBoolean)
  {
    ...
    if (localRobotPanelLayoutBase.getVisibility() != 0) {
      bcgx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X8009FA1", str, "");
    }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getChildCount() > 0)
      {
        ...
        for (;;)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.setOnMeasureListener(new afca(this, j, i + m));
          return;
          i -= 1;
          break;
          k = -1;
  ...
  public void a(int paramInt, RobotPanelLayoutBase paramRobotPanelLayoutBase, RelativeLayout paramRelativeLayout)
  {
    ...
    do
    {
      ...
      {
        return;
        paramRobotPanelLayoutBase = (TextView)paramRelativeLayout.findViewById(2131370810);
    ...
    ((RelativeLayout.LayoutParams)paramRobotPanelLayoutBase).addRule(2, 2131362376);
  }
  ...
  public void a(View paramView)
  {
    ...
    ((RelativeLayout.LayoutParams)paramView).addRule(2, 2131362376);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131379417);
    ...
    if (paramBoolean)
    {
      ((RelativeLayout.LayoutParams)localObject).addRule(6, 2131362376);
      return;
    }
  ...
  public boolean a()
  {
    return ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agiu)) || ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agqn));
  }
  ...
  public boolean a(MotionEvent paramMotionEvent, boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
        paramMotionEvent = ((akwq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249)).a();
      }
    }
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ...
    else if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agqn))
    {
  ...
  public void b()
  {
    ...
    {
      return;
      ViewGroup localViewGroup = (ViewGroup)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131364137);
      if ((localViewGroup != null) && (this.jdField_a_of_type_AndroidContentContext != null))
      {
        Object localObject1 = (RobotPanelLayoutBase)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131362376);
        if (localObject1 != null)
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agiu)) {
            ((agiu)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a = ((TroopAIORobotLayout)localObject1);
          }
          for (;;)
          {
            ((RobotPanelLayoutBase)localObject1).setListener(this.jdField_a_of_type_Bcnj);
            return;
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agqn)) {
              ((agqn)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a = ((RobotChatPanelLayout)localObject1);
            }
          }
        }
        if (QLog.isColorLevel()) {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agiu)) {
          localObject1 = (TroopAIORobotLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558625, localViewGroup, false);
        }
        for (;;)
        {
          label195:
          ...
          localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131362284);
          int i = 1;
          ...
          {
            ((RobotPanelLayoutBase)localObject1).setListener(this.jdField_a_of_type_Bcnj);
            localObject1 = (afby)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(23);
            if (localObject1 == null) {
              break;
            }
            ((afby)localObject1).a(false);
            return;
            if (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agqn)) {
              break label407;
            }
            localObject1 = (RobotChatPanelLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558606, localViewGroup, false);
            break label195;
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agqn)) {
              ((agqn)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a = ((RobotChatPanelLayout)localObject1);
            }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      return;
      if (((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agiu)) && (((agiu)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).X))
      {
        String str1 = ((agiu)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).g;
        String str2 = ((agiu)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).h;
        ((TroopAIORobotLayout)localRobotPanelLayoutBase).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, str1, str2, (agiu)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, new afcb(this, str1));
        return;
      }
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agqn))
      {
  ...
  public void c()
  {
    ...
    for (;;)
    {
      ...
      Object localObject;
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agiu)) {
        localObject = ((agiu)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a;
      }
      while (localObject != null)
      {
        ...
        return;
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agqn)) {
          localObject = ((agqn)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a;
        } else {
          localObject = null;
        }
      }
