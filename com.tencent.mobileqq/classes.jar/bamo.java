  ...
  extends bame
{
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    do
    {
      ...
      localObject2 = aljq.aX + "avatarPendantDefaultHead" + str;
    ...
    for (;;)
    {
      for (;;)
      {
        if (localObject1 != null)
        {
          ...
          try
          {
            new bapk().a((OutputStream)localObject2, paramDownloadParams, paramURLDrawableHandler);
            ...
            paramOutputStream = new File(aljq.bQ + str);
            if (!paramOutputStream.exists()) {
              paramOutputStream.mkdir();
            }
            long l = Long.valueOf(str.split("/")[1]).longValue();
            localObject1 = bdbg.b(l, 5);
            localObject2 = new File((String)localObject1);
            paramOutputStream = (OutputStream)localObject2;
            if (((File)localObject2).exists()) {
              break;
            }
            localObject2 = bdbg.c(l, 5);
            paramOutputStream = (OutputStream)localObject1;
