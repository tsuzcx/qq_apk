  ...
  extends Handler
{
  ...
  public bciz(ADView paramADView)
  {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        axuh localaxuh = (axuh)this.jdField_a_of_type_ComTencentMobileqqWidgetADView.a.getChildAt(this.jdField_a_of_type_ComTencentMobileqqWidgetADView.a.a()).getTag();
        i = localaxuh.a;
        this.jdField_a_of_type_ComTencentMobileqqWidgetADView.setContentDescription(localaxuh.n);
        i *= 1000;
      }
