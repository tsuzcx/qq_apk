  ...
  extends bcgw
{
  ...
  public bciz()
  {
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new bcja(this);
    this.jdField_a_of_type_JavaLangString = "picture";
    this.jdField_a_of_type_Int = 19;
  }
  
  public bciz(String paramString)
  {
    this();
    this.ac = paramString;
  }
  
  public bciz(String paramString1, String paramString2)
  {
    this();
  ...
  public static Bitmap a(Drawable paramDrawable)
  {
    try
    {
      ...
      for (Object localObject = Bitmap.Config.ARGB_8888;; localObject = Bitmap.Config.RGB_565)
      {
        ...
        paramDrawable = bfvo.a((Bitmap)localObject, i, i, i);
  ...
  public View a(Context paramContext, View paramView, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        Drawable localDrawable1 = ofi.a().a((Resources)localObject3, 2130850385);
      ...
      catch (OutOfMemoryError localOutOfMemoryError)
      {
        for (;;)
        {
          ...
          ((PAHighLightImageView)localObject2).setId(2131368518);
          ((PAHighLightImageView)localObject2).setContentDescription(((Resources)localObject3).getString(2131691134));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          ((PAHighLightImageView)localObject1).setImageDrawable(bfvo.a());
          return localObject2;
        }
        ...
        paramContext.setTag(bfol.b(j, j, j));
      ...
      if ("StructMsgItemCover createView ,exception  = " + paramContext != null)
      {
          ...
          if ((localObject3 instanceof BaseActivity))
          {
            ...
            if (paramView.indexOf("internal_phone") > -1)
            {
              ...
              else
              {
                ...
                paramContext = ((Context)localObject3).getResources().getDrawable(2130842104);
              }
            }
            for (;;)
            {
              ...
              if (ContactUtils.isContainChinese(paramContext))
              {
                i = ((Context)localObject3).getResources().getDimensionPixelSize(2131299015);
                break label944;
              }
              i = ((Context)localObject3).getResources().getDimensionPixelSize(2131299017);
              break label944;
        ...
        {
          ((PAHighLightImageView)localObject1).setImageResource(2130843895);
          return localObject2;
        }
        if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          paramContext.restartDownload();
          break label2045;
          if ((paramView.startsWith(zsf.b)) || (paramView.startsWith(zsf.c)) || (paramView.startsWith(zsf.d)))
          {
            ((PAHighLightImageView)localObject1).setBackgroundDrawable(null);
            i = paramView.lastIndexOf("&uin=");
            paramContext = paramView.substring("&uin=".length() + i);
          ...
          if ((paramView.startsWith("http://imgplat.store.qq.com/bqq_qfpic/520520")) || (paramView.contains(zlv.jdField_a_of_type_JavaLangString)))
          {
            paramBoolean = true;
  ...
  StructMsgForGeneralShare a(View paramView)
  {
    for (paramView = paramView.getParent(); paramView != null; paramView = paramView.getParent())
    {
      ...
      if (paramView.getId() == 2131377871) {
        return (StructMsgForGeneralShare)paramView.getTag(2131377871);
      }
    }
    return null;
  }
  ...
  public void a(View paramView, int paramInt1, int paramInt2)
  {
    ...
    for (localObject2 = null;; localObject2 = ((ChatFragment)localObject2).a())
    {
      ...
      catch (Exception localException)
      {
        ...
        bcef.b((QQAppInterface)localObject2, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D93", "0X8005D93", paramInt2, 1, paramInt1, str, String.valueOf(paramView.msgId), "1", "");
        return;
      }
  ...
  public boolean a(bcin parambcin)
  {
    ...
    do
    {
      ...
      {
        return true;
        str = parambcin.a("cover");
        if (str == null) {
          break;
        }
        this.ac = str;
      } while (this.jdField_a_of_type_Int <= 3);
      this.c = parambcin.a("action");
    ...
    for (;;)
    {
      ...
      this.ad = parambcin.a("needRoundView");
      return true;
      str = "";
      break label18;
