...
final class anfa
  extends bhyn
{
  anfa(File paramFile, amme paramamme, int paramInt1, int paramInt2, AtomicInteger paramAtomicInteger1, AtomicInteger paramAtomicInteger2, AtomicInteger paramAtomicInteger3, anfh paramanfh, String paramString, List paramList) {}
  ...
  public void onDone(bhyo parambhyo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          parambhyo = this.jdField_a_of_type_Anfh;
          if (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() > 0) {
            bool = false;
          }
          parambhyo.a(bool, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaUtilList);
