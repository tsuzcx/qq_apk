  ...
  implements adih, Handler.Callback
{
  ...
  final auoo jdField_a_of_type_Auoo = new aqfu(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajyc.a(2131719414);
  }
  
  public aqft(BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new aqfx(this);
  ...
  public static bbgg a(Activity paramActivity, bbgg parambbgg, BaseChatPie paramBaseChatPie, long paramLong, int paramInt, String paramString)
  {
    ...
    String str = ((QQAppInterface)localObject).getApplication().getString(2131719410);
    if (paramString != null) {}
    for (paramString = str + paramString;; paramString = str)
    {
      str = ((QQAppInterface)localObject).getApplication().getString(2131719416);
      localObject = ((QQAppInterface)localObject).getApplication().getString(2131719411);
      aqfv localaqfv = new aqfv(paramLong, paramInt, paramActivity);
      aqfw localaqfw = new aqfw(paramLong, paramInt, paramActivity, paramBaseChatPie);
      paramBaseChatPie = parambbgg;
      if (parambbgg == null) {
        paramBaseChatPie = bbcv.a(paramActivity, 232, null, str, paramString, (String)localObject, localaqfv, localaqfw);
      }
      paramBaseChatPie.setNegativeButton(paramString, localaqfw);
      paramBaseChatPie.setPositiveButton((String)localObject, localaqfv);
      try
      {
        paramBaseChatPie.show();
        return paramBaseChatPie;
      }
      catch (Throwable parambbgg)
      {
      ...
      QLog.e("ForwardShareByServerHelper", 2, "qbShowShareResultDialog: failed. ", parambbgg);
      return paramBaseChatPie;
    }
  }
  ...
  private AbsStructMsg a()
  {
    ...
    return axuy.a(localIntent.getByteArrayExtra("stuctmsg_bytes"));
  }
  ...
  public static String a(Context paramContext, String paramString)
  {
    try
    {
      ...
      paramContext = bbdm.a(paramString.digest());
  ...
  public static oidb_cmd0xb77.ReqBody a(Bundle paramBundle, String paramString1, String paramString2, oidb_cmd0xb77.ImageInfo paramImageInfo)
  {
    ...
    if (i == 0)
    {
      ...
      {
        paramBundle = str1;
        if (str1.contains(ajyc.a(2131704807))) {
          paramBundle = str1.replace(ajyc.a(2131704834), "");
        }
  ...
  public static void a(long paramLong, int paramInt, Activity paramActivity)
  {
    ...
    nax.a((QQAppInterface)localObject1, "", "choose", paramLong, paramInt, "stay");
    bded.a().a(((QQAppInterface)localObject1).getAccount(), "", String.valueOf(paramLong), "1000", "52", "0", false);
  ...
  public static void a(long paramLong, int paramInt, Activity paramActivity, BaseChatPie paramBaseChatPie)
  {
    ...
    nax.a(localQQAppInterface, "", "choose", paramLong, paramInt, "back");
    bded.a().a(localQQAppInterface.getAccount(), "", String.valueOf(paramLong), "1000", "51", "0", false);
    nax.a(paramActivity, 0, "", "");
  ...
  private void a(Bundle paramBundle)
  {
    ...
    paramBundle = axuy.a(paramBundle);
    if ((paramBundle != null) && ((paramBundle instanceof AbsShareMsg))) {}
    for (paramBundle = (AbsShareMsg)paramBundle;; paramBundle = null)
    {
      this.jdField_a_of_type_Bbgg = a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bbgg, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, paramBundle.mSourceAppid, paramBundle.mMsgServiceID, str);
      return;
    }
  }
  ...
  private void a(Bundle paramBundle, String paramString1, String paramString2)
  {
    ...
    aqgh.a("KEY_STAGE_2_NORMAL_B77");
    mxi.a(paramString2, new aqga(this, paramBundle), paramString1.toByteArray(), "OidbSvc.0xb77_9", 2935, 9, localBundle, 0L);
  }
  
  private void a(auoo paramauoo, AbsStructMsg paramAbsStructMsg)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    Object localObject = new WeakReference(paramauoo);
    ...
    paramauoo = this.jdField_a_of_type_AndroidOsBundle.getString("uin");
    ...
    localObject = (auoo)((WeakReference)localObject).get();
    ...
    AbsShareMsg.sendSdkShareMessageByServer(localQQAppInterface, (AbsShareMsg)paramAbsStructMsg, paramauoo, i, str, (auoo)localObject);
  }
  ...
  public static boolean a()
  {
    amto localamto = amtp.a();
    if (localamto != null) {}
    for (boolean bool = localamto.a();; bool = false)
    {
  ...
  private void b(int paramInt, String paramString1, String paramString2)
  {
    ...
    if ((localBundle != null) && (localBundle.getBoolean("forward_mini_program_ark_from_sdk", false))) {
      axqw.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "dc00898", "", "", "0X8009F7C", "0X8009F7C", 0, 0, "2", String.valueOf(paramInt), "", "");
    }
  ...
  public static boolean b()
  {
    amto localamto = amtp.a();
    if (localamto != null) {}
    for (boolean bool = localamto.b();; bool = false)
    {
  ...
  private void c(String paramString)
  {
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        mye.a().jdField_a_of_type_Boolean = true;
        aaod.b(localQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, localSessionInfo, paramString);
        return;
      }
  ...
  private void e()
  {
    ...
    if (localObject2 != null)
    {
      ...
      {
        localObject1 = axuy.a((Bundle)localObject2);
        if ((localObject1 == null) || (!(localObject1 instanceof AbsShareMsg))) {
          break label421;
        }
        localObject1 = (AbsShareMsg)localObject1;
        this.jdField_a_of_type_Bbgg = a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bbgg, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, ((AbsShareMsg)localObject1).mSourceAppid, ((AbsShareMsg)localObject1).mMsgServiceID, (String)localObject3);
      }
    }
    if ((localObject2 != null) && (((Bundle)localObject2).getBoolean("forward_mini_program_ark_from_sdk", false))) {
      axqw.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "dc00898", "", "", "0X8009F7C", "0X8009F7C", 0, 0, "1", "", "", "");
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
        default: 
          bdjo.a().a(0, "SHARE_TO_QQ", ((QQAppInterface)localObject3).getCurrentAccountUin(), String.valueOf(this.jdField_b_of_type_Long), String.valueOf(i), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, null);
          if (this.jdField_a_of_type_Int == 1)
          {
            localObject1 = "1";
            break label431;
            label274:
            bded.a().a(((QQAppInterface)localObject3).getAccount(), "", this.jdField_b_of_type_Long + "", "10", "12", "0", (String)localObject1, str2, (String)localObject2, false);
            if (!QLog.isColorLevel()) {
              break label448;
            }
  ...
  private void f()
  {
    ...
    {
      this.jdField_a_of_type_AndroidContentBroadcastReceiver = new aqfz(this);
  ...
  protected void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    paramString1 = new aqfy(this, paramInt, paramString2);
    this.jdField_b_of_type_Bbgg.setPositiveButton(2131694793, paramString1);
    ...
    for (boolean bool = ((Bundle)localObject).getBoolean("share_send_msg_by_server", false);; bool = false)
    {
      ...
      if (bool)
      {
        ...
        if ((localObject instanceof AbsShareMsg))
        {
          ...
          axqw.b(null, "dc00898", "", "", "0X8009C93", "0X8009C93", 0, 0, "", str1, str2, paramIntent);
          d();
          a(this.jdField_a_of_type_Auoo, (AbsStructMsg)localObject);
        }
      }
      do
      {
      ...
      localObject = aqcq.a((String)localObject);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    axqw.b(null, "dc00898", "", "", "0X8009CF9", "0X8009CF9", 0, 0, "", "", "", "");
