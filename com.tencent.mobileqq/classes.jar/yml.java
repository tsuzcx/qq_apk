...
public class yml
{
  ...
  public yml()
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new ymm(this);
    this.jdField_a_of_type_MqqAppAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    this.c = false;
  }
  
  public yml(Activity paramActivity)
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new ymm(this);
  ...
  public yml(Activity paramActivity, ymn paramymn)
  {
    this.jdField_a_of_type_MqqObserverBusinessObserver = new ymm(this);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Ymn = paramymn;
    if ((this.jdField_a_of_type_AndroidAppActivity instanceof AppActivity))
    {
      this.jdField_a_of_type_MqqAppAppRuntime = ((AppActivity)this.jdField_a_of_type_AndroidAppActivity).getAppRuntime();
      this.c = true;
  ...
  public static String a(Resources paramResources, LightAppSettingInfo paramLightAppSettingInfo, String paramString)
  {
    ...
    if ((!TextUtils.isEmpty(paramLightAppSettingInfo.b)) && (!TextUtils.isEmpty(paramLightAppSettingInfo.jdField_a_of_type_JavaLangString)) && (bdiw.a(paramLightAppSettingInfo.b))) {
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    {
      bdiw.a(paramActivity, paramString1);
      return;
    }
    ...
    bdev.b(paramActivity, localBundle);
  }
  ...
  private void d()
  {
    ...
    {
      ymx.a((String)localObject, localBundle, this.jdField_a_of_type_MqqAppAppRuntime, this.jdField_a_of_type_MqqObserverBusinessObserver);
      return;
    }
  }
  ...
  public LightAppSettingInfo a(DeviceInfo paramDeviceInfo)
  {
    ...
    if (localLightAppSettingInfo2 == null)
    {
      ...
      if (!this.c)
      {
        ...
        {
          a(((yak)((QQAppInterface)localAppRuntime).a(51)).a());
  ...
  public void a()
  {
    ...
    {
      localObject1 = ((yak)((QQAppInterface)localObject1).a(51)).a();
  ...
  public void a(DeviceInfo paramDeviceInfo, Bundle paramBundle, boolean paramBoolean)
  {
    if (paramDeviceInfo == null)
    {
      if (this.jdField_a_of_type_Ymn != null) {
        this.jdField_a_of_type_Ymn.a(false);
      }
      return;
    }
    if (paramBundle != null) {}
    for (boolean bool = paramBundle.getBoolean("showProgress", true);; bool = true)
    {
      ...
      for (;;)
      {
        if ((str == null) && (0 == 0))
        {
          ...
          ymw.a(null, "Net_LiteApp_Setting", 0, 1, localLightAppSettingInfo.jdField_c_of_type_Int);
          if (str != null) {
            break label713;
          }
          ...
          this.jdField_a_of_type_Ymn.a(true);
          return;
        ...
        for (Intent localIntent = new Intent();; localIntent = null)
        {
          ...
          for (;;)
          {
            ...
            break;
            localIntent.putExtra("uinname", ymx.a(paramDeviceInfo));
          }
          label713:
          ...
          bhvv.a().a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_MqqAppAppRuntime, this.jdField_a_of_type_MqqAppAppRuntime.getAccount(), paramDeviceInfo, str, -1, null, SmartDevicePluginProxyActivity.class);
          break label247;
          label794:
          break;
          ...
          bdid.a().a(2131691576);
          if ((this.jdField_a_of_type_Bcpq != null) && (!this.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
  ...
  protected void b()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Bcpq.c(2131691575);
      this.jdField_a_of_type_Bcpq.show();
    }
    while (this.jdField_a_of_type_MqqAppAppRuntime == null)
    {
      bdht.d("LightAppUtil", "app == null when dologin");
      if (this.jdField_a_of_type_Ymn != null) {
        this.jdField_a_of_type_Ymn.a(false);
      }
      return;
