...
public abstract class aggw
  implements agfv, Handler.Callback, TextWatcher, View.OnClickListener, bfor, bfos, bfub, Observer
{
  static int e;
  ...
  agfz jdField_a_of_type_Agfz;
  private ajxj jdField_a_of_type_Ajxj = new aghb(this);
  akqr jdField_a_of_type_Akqr;
  public Context a;
  ...
  bbkh jdField_a_of_type_Bbkh = new aggy(this);
  ...
  public aggw(Context paramContext, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  private void A()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848769);
  ...
  private void B()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130844030);
      ...
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849072));
      ...
      if ((localObject instanceof RelativeLayout.LayoutParams))
      {
        ...
        ((RelativeLayout.LayoutParams)localObject).width = actj.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        ((RelativeLayout.LayoutParams)localObject).height = actj.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        localImageView.setLayoutParams((ViewGroup.LayoutParams)localObject);
      }
      localImageView.setBackgroundResource(0);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849547));
    ...
    localImageView.setBackgroundResource(0);
    if (axmv.b()) {
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843967));
    }
    for (;;)
    {
      localImageView = (ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131367906);
      localImageView.setBackgroundResource(0);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849548));
      return;
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849073));
    }
  }
  ...
  private void F()
  {
    ...
    List localList1 = this.jdField_a_of_type_Agfw.a();
  ...
  private void a(int paramInt)
  {
    ...
    if (this.jdField_c_of_type_AndroidWidgetTextView == null)
    {
      ...
      ((TextView)localObject1).setId(2131370504);
  ...
  {
    return this.jdField_a_of_type_Agfz.a(paramInt);
  }
  ...
  public SpannableString a(boolean paramBoolean)
  {
    ...
    {
      bool1 = true;
      str1 = bbcz.a(localQQAppInterface, ((SessionInfo)localObject).jdField_a_of_type_Int, ((SessionInfo)localObject).jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo.mSourceMsgSenderUin + "");
    ...
    {
      localObject = bafv.a(localQQAppInterface, localContext, str2, str3, str1, bool1, localXEditTextEx, bool2, true);
  ...
  public View a(LayoutInflater paramLayoutInflater, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364075));
  ...
  protected void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Bbkf = new bbkf(((ViewGroup)((Activity)this.jdField_a_of_type_AndroidContentContext).getWindow().getDecorView().findViewById(16908290)).getChildAt(0), this.jdField_a_of_type_AndroidViewWindowManager.getDefaultDisplay().getHeight(), this.jdField_a_of_type_Bbkh);
    this.jdField_j_of_type_Int = this.jdField_a_of_type_Bbkf.a();
    this.jdField_j_of_type_Int = bbkf.a(this.jdField_j_of_type_Int);
    paramContext = new aggz(this);
    ...
    if ((localAppRuntime instanceof QQAppInterface))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setDispatchKeyEventListener(new agha(this));
      return;
    }
  ...
  public void a(ChatMessage paramChatMessage, int paramInt, long paramLong, String paramString)
  {
    ...
    do
    {
      return;
      if (paramLong == 0L) {
        adyf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, Long.parseLong(paramChatMessage.senderuin));
      }
      paramString = aevd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage, paramInt, paramLong, paramString);
    ...
    paramString = bafy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo, paramInt - k, this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getPaint(), null);
    if (paramString != null)
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setTag(2131372739, paramString);
      ...
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setMovementMethod(bafx.a());
  ...
  protected void a(List<ChatMessage> paramList1, List<ChatMessage> paramList2)
  {
    ...
    this.jdField_a_of_type_Agfw.a(paramList2, null, 0);
  ...
  public boolean a()
  {
    ...
    this.jdField_a_of_type_Agfz = new agfz(this);
    this.jdField_a_of_type_Agfz.a(2);
    b();
    e();
    g();
    d();
    ...
    x();
    a();
    this.jdField_a_of_type_Akqr = new akqr();
    this.jdField_a_of_type_Akqr.a = new acus(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    this.jdField_a_of_type_Akqr.jdField_h_of_type_Boolean = true;
    return true;
  }
  ...
  protected void b(List<ChatMessage> paramList1, List<ChatMessage> paramList2)
  {
    ...
    default: 
      if (localaghk != null) {
        this.jdField_g_of_type_Int = localaghk.a(paramList1, paramList2, this.jdField_g_of_type_Int);
      }
      break;
    }
    for (;;)
    {
      ...
      return;
      k = aghk.b(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, this.jdField_g_of_type_Int, paramList1, paramList2);
      if (k != 0)
      {
      ...
      if (localaghk != null)
      {
        ...
        if (localaghk != null)
        {
          this.jdField_g_of_type_Int = localaghk.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, this.jdField_g_of_type_Int, paramList1, paramList2);
          continue;
          if (localaghk != null)
          {
            localaghk.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, 0, paramList1, paramList2);
            k = paramList1.size();
  ...
  public void beforeTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    if (paramInt3 == 0)
    {
      paramCharSequence = (bafv[])this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getEditableText().getSpans(paramInt1, paramInt1 + paramInt2, bafv.class);
  ...
  protected void d()
  {
    ...
    {
      if (("1103".equals(ThemeUtil.curThemeId)) || ("2920".equals(ThemeUtil.curThemeId))) {
        this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130848969);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130849165);
  }
  ...
  protected void e()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getHeaderViewsCount() == 0)
    {
      ...
      ((View)localObject).setId(2131362314);
    ...
    this.jdField_a_of_type_Agfw.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
    Object localObject = this.jdField_a_of_type_Agfw;
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 3) {}
    for (boolean bool = true;; bool = false)
    {
      ((agfw)localObject).a(bool);
  ...
  protected void g()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131375329));
    ...
    this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131375336));
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 2) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 5))
    {
      ...
      {
        localObject = (RelativeLayout.LayoutParams)localObject;
        ((RelativeLayout.LayoutParams)localObject).width = actj.a(13.5F, this.jdField_a_of_type_AndroidContentContext.getResources());
        ((RelativeLayout.LayoutParams)localObject).height = actj.a(13.5F, this.jdField_a_of_type_AndroidContentContext.getResources());
        localImageView2.setLayoutParams((ViewGroup.LayoutParams)localObject);
      }
      localImageView2.setImageResource(2130849037);
      this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      localImageView1.setImageResource(2130849160);
      if (Build.VERSION.SDK_INT >= 16) {
  ...
  protected void h()
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetXPanelContainer = ((XPanelContainer)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131375493));
    i();
    ...
    try
    {
      ...
      ((PanelIconLinearLayout)localObject).setPanelIconListener(new aggx(this));
      if (this.jdField_d_of_type_Boolean)
      {
        ((PanelIconLinearLayout)localObject).setCustomHeight(actj.a(50.0F, ((PanelIconLinearLayout)localObject).getContext().getResources()));
        ...
        if ((this.jdField_d_of_type_Boolean) && (("1103".equals(ThemeUtil.curThemeId)) || ("2920".equals(ThemeUtil.curThemeId))))
        {
          ...
          if (localObject != null) {
            ((View)localObject).setBackgroundResource(2130848776);
          }
          this.jdField_b_of_type_AndroidViewViewGroup.setBackgroundResource(2130848776);
        ...
        localObject = new aghc(this, null);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      a(paramMessage.arg1);
      continue;
      aebx.a(paramMessage, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
      continue;
      boolean bool = bblj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
      if (QLog.isColorLevel()) {
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, "MSG_EFRESH_FONT_BUBBLE, needRefresh=" + bool);
      }
      if (bool) {
        this.jdField_a_of_type_Agfw.notifyDataSetChanged();
      }
    }
  }
  ...
  public void k()
  {
    ...
    this.jdField_a_of_type_Agfz.a(4);
  ...
  public void l()
  {
    if (this.jdField_d_of_type_Boolean)
    {
      ...
      if ((localakpb != null) && (localakpb.a(this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Int) > 0))
      {
        if (QLog.isColorLevel()) {
  ...
  public void m()
  {
    ...
    this.jdField_a_of_type_Agfz.a(8);
  ...
  public void n()
  {
    this.jdField_a_of_type_Agfz.a(3);
  }
  ...
  public void o()
  {
    ...
    this.jdField_a_of_type_Agfz.a(9);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131368441: 
      ...
      Intent localIntent = actj.a(new Intent(paramView.getContext(), SplashActivity.class), new int[] { 0, 2 });
      ...
      if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface)) {
        ((aggj)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(147)).a();
      }
      aggl.a().d();
    ...
    case 2131366883: 
      ...
      axqy.b(null, "dc00898", "", "", "0X800A194", "0X800A194", k, 1, "", "", "", "");
      return;
    case 2131368186: 
      if (QLog.isColorLevel()) {
    ...
    case 2131362262: 
      ...
      return;
    case 2131370504: 
      this.jdField_g_of_type_Int = this.jdField_a_of_type_Agfw.getCount();
  ...
  {
    paramAbsListView = (aghk)a(1);
    if (paramAbsListView != null) {
      paramAbsListView.a(paramInt1, paramInt2, paramInt3);
    }
    this.jdField_a_of_type_Agfz.a(17);
  }
  ...
  public void p()
  {
    ...
    this.jdField_a_of_type_Agfz.a(11);
  ...
  {
    this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a();
    this.jdField_a_of_type_Agfz.a(10);
  ...
  protected void u()
  {
    ...
    if ((localList != null) && (localList.size() > 0))
    {
      ...
      this.jdField_a_of_type_Agfw.a(localList, null, 0);
    }
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          return;
          if (!(paramObject instanceof akqr)) {
            break;
          }
          paramObservable = (akqr)paramObject;
          paramObject = (acus)paramObservable.a;
  ...
  protected void v()
  {
    if ((this.jdField_a_of_type_Agfw != null) && (this.jdField_a_of_type_Agfw.getCount() > 0))
    {
      this.jdField_a_of_type_Long = SystemClock.uptimeMillis();
      ((acus)this.jdField_a_of_type_Akqr.a).a(this.jdField_a_of_type_Long);
      this.jdField_a_of_type_Akqr.jdField_e_of_type_Boolean = false;
  ...
  protected void w()
  {
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131362262));
    this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(0);
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(this);
    actj.a(this.jdField_a_of_type_AndroidWidgetImageButton, (int)(this.jdField_a_of_type_Float * 5.0F + 0.5F), (int)(this.jdField_a_of_type_Float * 5.0F + 0.5F), 0, 0);
    if (this.jdField_d_of_type_Boolean) {
  ...
  public void x()
  {
    ...
    if ((k != 1033) && (k != 1034))
    {
      ...
      axqf.a(1, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, k);
    }
    aanz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
  ...
  public void z()
  {
    ...
    if (localChatMessage != null) {
      a(localChatMessage, 0, adyf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, Long.parseLong(localChatMessage.senderuin)), null);
    }
  }
}
