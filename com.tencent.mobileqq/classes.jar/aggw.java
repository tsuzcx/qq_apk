  ...
  extends aggs
{
  ...
  private aggz jdField_a_of_type_Aggz = new aggz(this, null);
  public Calendar a;
  Context b;
  public Calendar b;
  
  public aggw(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner, BaseChatPie paramBaseChatPie, aggy paramaggy)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    View localView = ((aghc)localObject).a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage, paramView, paramViewGroup, this.jdField_a_of_type_Aggz);
    if (localView != null) {
    ...
    for (;;)
    {
      ...
      else if (localChatMessage.msgtype == -2039)
      {
        ...
        else if ((localObject instanceof agye))
        {
          ((agye)localObject).a(false);
        }
      }
