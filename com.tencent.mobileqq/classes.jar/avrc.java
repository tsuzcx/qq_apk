...
public class avrc
  implements avqz<FontRecommendRsp>
{
  public int a()
  {
    return 3;
  ...
  {
    return bhyk.a(paramContext, "font", "mvip.gexinghua.mobile.font.client_tab_store");
  }
  
  public String a(FontBubble paramFontBubble)
  {
    return bhyk.a("fontPreview").replace("[id]", Integer.toString(paramFontBubble.fontId));
  }
  
  public List<FontBubble> a(QQAppInterface paramQQAppInterface, FontRecommendRsp paramFontRecommendRsp)
  {
    int j = ((aogu)paramQQAppInterface.a(13)).b();
