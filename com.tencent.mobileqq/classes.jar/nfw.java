  ...
  extends ajfb
{
  ...
  public nfw(AppInterface paramAppInterface)
  {
      ...
      for (;;)
      {
        ...
        if ((localException1 instanceof MessageForStructing))
        {
          ...
          if ((localObject instanceof StructMsgForGeneralShare))
          {
            ...
            {
              localObject = (awul)((StructMsgForGeneralShare)localObject).mStructMsgItemLists.get(0);
              if (localObject != null) {
                l1 = 0L;
              }
            }
        ...
        try
        {
          long l2 = Long.parseLong(((awul)localObject).s);
          l1 = l2;
        }
  ...
  private Set<Long> a()
  {
    ...
    {
      return localHashSet;
      str = agkn.a(this.app.getCurrentAccountUin(), "risk_ids", "");
      if (QLog.isColorLevel()) {
        QLog.i("EcshopAdHandler", 2, "---getRiskAids---" + str);
      }
    } while (baip.a(str));
    return (Set)new Gson().fromJson(str, new nfx(this).getType());
  }
  
  /* Error */
  public static nfz a(nfz paramnfz, MessageRecord paramMessageRecord)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnonnull +5 -> 6
    ...
    //   81: putfield 224	nfz:jdField_a_of_type_Long	J
    //   84: aload_0
    //   85: aload_3
    //   86: putfield 227	nfz:k	Ljava/lang/String;
    //   89: aload_0
    //   90: aload 6
    //   92: putfield 229	nfz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   95: aload_0
    //   96: aload 5
    //   98: putfield 232	nfz:l	Ljava/lang/String;
    //   101: aload_0
    //   102: aload_2
    //   103: putfield 234	nfz:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   106: aload_0
    //   107: iconst_0
    //   108: putfield 237	nfz:jdField_g_of_type_Int	I
    //   111: aload_0
    //   112: areturn
    //   113: astore_3
  ...
  private void a(long paramLong)
  {
    ...
    agkn.a(this.app.getCurrentAccountUin(), "risk_ids", (String)localObject);
  }
  ...
  public static void a(AppInterface paramAppInterface, ChatMessage paramChatMessage, View paramView)
  {
    ...
    try
    {
      paramChatMessage = nfp.a(paramChatMessage);
      if (paramChatMessage != null)
      {
        paramView.setTag(2131313371, new GdtAd(paramChatMessage));
        paramView.setTag(2131313370, new nfy(paramAppInterface));
      }
      return;
    }
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          else if ((localChatFragment != null) && (localChatFragment.a != null))
          {
            ...
            if ((localObject2 != null) && (!((List)localObject2).isEmpty()))
            {
              ...
              if (this.app != null) {
                agkn.a(this.app.getCurrentAccountUin(), "risk_ad_del_time", ache.a(NetConnInfoCenter.getServerTimeMillis(), "yyyyMMdd"));
              }
  ...
  public void a(int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    localnfz.jdField_a_of_type_Int = paramInt;
    a(localnfz, paramMessageRecord);
    a(localnfz, null);
  }
  ...
  public void a(List<Long> paramList, List<Integer> paramList1, boolean paramBoolean, String paramString)
  {
    ...
    try
    {
      String str1 = ache.a(NetConnInfoCenter.getServerTimeMillis(), "yyyyMMdd");
      if (QLog.isColorLevel()) {
        QLog.i("EcshopAdHandler", 2, "currentTs:" + str1);
      }
      String str2 = agkn.a(this.app.getCurrentAccountUin(), "risk_ad_del_time", str1);
      if (QLog.isColorLevel()) {
      ...
      if (!str1.equals(str2))
      {
        ...
        agkn.a(this.app.getCurrentAccountUin(), "risk_ids");
      }
  ...
  public void a(nfz paramnfz, String paramString)
  {
    if (QLog.isColorLevel()) {
      QLog.i("EcshopAdHandler", 2, "do ad report info:" + paramnfz.toString());
    }
    ...
    if (TextUtils.isEmpty(paramString))
    {
      ...
      localQQAdReport.type.set(paramnfz.jdField_a_of_type_Int);
      localObject2 = localQQAdReport.view_id;
      if (paramnfz.jdField_a_of_type_JavaLangString != null) {
        break label627;
      }
      localObject1 = "";
      label84:
      ...
      if (paramnfz.jdField_b_of_type_JavaLangString != null) {
        break label635;
      }
      localObject1 = "";
      label107:
      ...
      if (paramnfz.jdField_c_of_type_JavaLangString != null) {
        break label643;
      }
      localObject1 = "";
      label146:
      ...
      if (paramnfz.jdField_d_of_type_JavaLangString != null) {
        break label651;
      }
      localObject1 = "";
      label169:
      ...
      if (paramnfz.jdField_e_of_type_JavaLangString != null) {
        break label659;
      }
      localObject1 = "";
      label192:
      ...
      if (paramnfz.jdField_f_of_type_JavaLangString != null) {
        break label667;
      }
      localObject1 = "";
      label215:
      ...
      if (paramnfz.jdField_g_of_type_JavaLangString != null) {
        break label675;
      }
      localObject1 = "";
      label238:
      ((PBStringField)localObject2).set((String)localObject1);
      localQQAdReport.feeds_index.set(paramnfz.jdField_b_of_type_Int);
      localQQAdReport.is_impression.set(paramnfz.jdField_a_of_type_Boolean);
      localQQAdReport.is_installed.set(paramnfz.jdField_b_of_type_Boolean);
      ...
      label375:
      ((PBStringField)localObject2).set((String)localObject1);
      localObject2 = babp.c(BaseApplicationImpl.getApplication().getApplicationContext());
      ...
      localQQAdReport.stay_time.set(paramnfz.jdField_c_of_type_Int);
      localQQAdReport.net_type.set(mpl.a());
      localQQAdReport.client_id.set(paramnfz.jdField_d_of_type_Int);
      localQQAdReport.action_id.set(paramnfz.jdField_e_of_type_Int);
      localQQAdReport.msg_floor.set(paramnfz.jdField_f_of_type_Int);
      localQQAdReport.puin.set(paramnfz.jdField_a_of_type_Long);
      localQQAdReport.ad_puin.set(paramnfz.jdField_b_of_type_Long);
      localQQAdReport.version.set("8.2.6");
    ...
    label714:
    label722:
    for (Object localObject1 = "";; localObject1 = paramnfz.l)
    {
      ((PBStringField)localObject2).set((String)localObject1);
      localQQAdReport.get_back.set(false);
      localQQAdReport.source.set(paramnfz.jdField_g_of_type_Int);
      paramnfz = new ToServiceMsg("mobileqq.service", this.app.c(), paramString);
      paramnfz.putWupBuffer(localQQAdReport.toByteArray());
      super.sendPbReq(paramnfz);
      return;
      ajfu.a(paramString, new int[] { 139 });
      break;
      label627:
      localObject1 = paramnfz.jdField_a_of_type_JavaLangString;
      break label84;
      label635:
      localObject1 = paramnfz.jdField_b_of_type_JavaLangString;
      break label107;
      localObject1 = paramnfz.jdField_c_of_type_JavaLangString;
      break label146;
      localObject1 = paramnfz.jdField_d_of_type_JavaLangString;
      break label169;
      localObject1 = paramnfz.jdField_e_of_type_JavaLangString;
      break label192;
      localObject1 = paramnfz.jdField_f_of_type_JavaLangString;
      break label215;
      localObject1 = paramnfz.jdField_g_of_type_JavaLangString;
      break label238;
      localObject1 = paramnfz.h;
      break label297;
      localObject1 = bcez.c();
      break label329;
      localObject1 = paramnfz.i;
      break label352;
      localObject1 = paramnfz.j;
      break label375;
      localObject1 = paramnfz.k;
      break label527;
    }
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (QLog.isColorLevel())
        {
          QLog.i("EcshopAdHandler", 2, "rsp:" + azxx.a(paramToServiceMsg));
          return;
        }
      }
