...
{
  public airn(TroopEnterEffectController paramTroopEnterEffectController) {}
    ...
    if ((paramLong == 25L) && (paramString1.startsWith("groupeffect_item_")) && (paramInt1 == 0))
    {
      ...
      if (paramInt1 > 0)
      {
        ...
        if (TroopGiftUtil.a(new File(TroopEnterEffectController.jdField_a_of_type_JavaLangString + paramInt1))) {
          this.a.jdField_a_of_type_AndroidOsHandler.post(new airo(this, paramInt1, paramString1));
        }
      }
    }
    return;
