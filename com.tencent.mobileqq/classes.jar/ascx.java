  ...
  extends BaseAdapter
{
  ...
  public ascx(SDKSetEmotionPreviewFragment paramSDKSetEmotionPreviewFragment)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559059, null);
      ...
      paramViewGroup = new ascz(this);
      paramViewGroup.a = ((URLImageView)paramView.findViewById(2131365653));
    ...
    for (;;)
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject).mPlayGifImage = awgi.a(str);
      ...
      paramViewGroup.a.setOnClickListener(new ascy(this, str, (View)localObject));
      return paramView;
      paramViewGroup = (ascz)paramView.getTag();
    }
  }
}
