  ...
  extends Observable
{
  ...
  public besf(QQAppInterface paramQQAppInterface, Long paramLong)
  {
    this.jdField_a_of_type_JavaUtilList = Collections.synchronizedList(new ArrayList());
    this.jdField_a_of_type_AndroidOsHandler = new besg(this, Looper.getMainLooper());
    this.jdField_a_of_type_Bfpo = new besh(this);
    this.jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaLangLong = paramLong;
  }
  
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, int paramInt, bfpo parambfpo)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject2).put("muid", MD5.toMD5(bgln.a()));
      ((JSONObject)localObject2).put("carrier", bgln.e());
      ((JSONObject)localObject2).put("conn", nlw.a());
      ...
      if (paramQQAppInterface != null)
      {
        ...
        new bfpn(paramQQAppInterface, "GET", parambfpo, paramInt, null, true).execute(new HashMap[] { localObject2 });
    ...
    for (;;)
    {
      ...
      else
      {
        try
        {
          ...
          {
            localTroopFeedItem.tag = anni.a(2131713987);
            ...
            localObject = new ByteArrayInputStream(bcxm.a(localTroopNotificationCache.xmlBytes, i));
            localbesi = new besi(this);
            SAXParserFactory.newInstance().newSAXParser().parse((InputStream)localObject, localbesi);
            ((InputStream)localObject).close();
            if (localTroopNotificationCache.serviceID == 20)
            {
              localTroopFeedItem.title = localbesi.jdField_a_of_type_JavaLangString;
              localTroopFeedItem.content = "";
              localTroopFeedItem.picPath = localbesi.jdField_b_of_type_JavaLangString;
              localTroopFeedItem.linkUrl = localbesi.jdField_d_of_type_JavaLangString;
          ...
          for (;;)
          {
            localTroopFeedItem.tag = anni.a(2131713988);
            localTroopFeedItem.type = 133;
            break;
            localTroopFeedItem.title = localTroopNotificationCache.title;
            localTroopFeedItem.content = localbesi.jdField_c_of_type_JavaLangString;
            break label282;
            i = 0;
            break;
            i = 0;
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      new bfpn("https://web.qun.qq.com/cgi-bin/announce/get_feed", "GET", this.jdField_a_of_type_Bfpo, paramInt, null, true).execute(new HashMap[] { localObject1 });
  ...
  public void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication();
    ((HashMap)localObject1).put("CONTEXT", MobileQQ.getContext());
    new bfpn("https://web.qun.qq.com/cgi-bin/announce/get_t_list", "GET", this.jdField_a_of_type_Bfpo, paramInt, null, true).execute(new HashMap[] { localObject1 });
    if (QLog.isColorLevel()) {
