  ...
  extends PopupWindow
{
  ...
  public besf(Context paramContext)
  {
  ...
  private void a()
  {
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ...
      localValueAnimator.addUpdateListener(new besi(this));
      localValueAnimator.addListener(new besj(this));
  ...
  private void a(IBinder paramIBinder)
  {
    ...
    this.jdField_a_of_type_AndroidViewView.setOnKeyListener(new besg(this));
    ...
    paramIBinder.addUpdateListener(new besh(this));
    paramIBinder.start();
  }
