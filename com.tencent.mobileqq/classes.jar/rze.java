...
public class rze
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = rze.class.getSimpleName();
  }
  ...
  public static Bundle a(Intent paramIntent)
  {
    ...
    try
    {
      ...
      localJSONObject3.put("stickySpeed", pbn.a());
      localJSONObject3.put("maskLighteness", pbn.a());
      localJSONObject3.put("topBarTitle", pbn.a());
      ...
      localJSONObject4.put("kandian_mode_new", odr.a());
      localJSONObject4.put("kandian_mode", ozs.e());
      ...
      localJSONObject1.put("dynamicAladdinConfig", pbw.b());
      localJSONObject1.put("xgAladdinConfig", pbw.a());
      localJSONObject1.put("protocolExtralParam", paramIntent);
      localJSONObject1.put("autoPlayDisable", bnrf.h());
  ...
  public static VideoInfo a(Bundle paramBundle)
  {
    ...
    {
      return paramBundle;
      localVideoInfo = rpt.a(paramBundle);
      rpt.a(localVideoInfo);
      paramBundle = localVideoInfo;
  ...
  private static String a()
  {
    try
    {
      String str = ReadInJoyUserInfoModule.a(ReadInJoyUserInfoModule.a(ozs.a(), null));
      return str;
    }
  ...
  {
    if (pcf.a(paramInt)) {}
    for (String str1 = tbz.a();; str1 = "https://viola.qq.com/js/VideoFeeds.js?_rij_violaUrl=1&v_tid=15&v_bundleName=VideoFeeds&hideNav=1&v_nav_immer=1&statusColor=1&v_bid=3811&statusBarStyle=1&v_bg_color=000000&v_present_titleHeight=44&v_old_modal=1&_ckey=rij_video_feeds_cache_key")
    {
      String str2 = str1;
  ...
  private static JSONObject a()
  {
    ...
    localJSONObject.put("uint32_youngster_status", bnrf.a("key_sp_is_readinjoy_youngster", Integer.valueOf(0)));
    localJSONObject.put("uint32_req_recommend_flag", odp.a());
    localJSONObject.put("bytes_req_recommend_json", ozs.k());
  ...
  private static JSONObject a(Intent paramIntent)
  {
    ...
    if (k == 11)
    {
      ...
      {
        localJSONObject1.put("videoType", pbn.a(localVideoInfo.jdField_b_of_type_Int, localVideoInfo.jdField_c_of_type_Int, localVideoInfo.jdField_d_of_type_Int));
  ...
  public static JSONObject a(VideoInfo paramVideoInfo, Intent paramIntent)
  {
    ...
    {
      i = 1;
      localObject = ((JSONObject)localObject).put("is_ugc", i).put("like_count", paramVideoInfo.jdField_r_of_type_Int);
      if (!paramVideoInfo.o) {
        break label417;
      }
      i = 1;
      label95:
      JSONObject localJSONObject2 = ((JSONObject)localObject).put("myself_like_status", i).put("thirdIcon", paramVideoInfo.jdField_p_of_type_JavaLangString).put("thirdName", paramVideoInfo.jdField_q_of_type_JavaLangString).put("third_uin", paramVideoInfo.j).put("third_uin_name", paramVideoInfo.k);
    ...
    for (paramIntent = paramIntent.getStringExtra("VIDEO_COMMON_DATA");; paramIntent = "")
    {
      ...
      try
      {
        if (rpt.a(ozs.a(), Long.parseLong(paramVideoInfo.j))) {
          i = 1;
        }
  ...
  public static void a(Activity paramActivity, Intent paramIntent, int paramInt)
  {
    ...
    tbz.a(paramActivity, null, paramIntent, localBundle, true);
  }
  ...
  public static void a(Context paramContext, Intent paramIntent)
  {
    ...
    tbz.a(paramContext, null, paramIntent, localBundle, true);
  }
  ...
  public static void a(BaseArticleInfo paramBaseArticleInfo, Context paramContext)
  {
    ...
    try
    {
      paramContext = rpt.a((Activity)paramContext, paramBaseArticleInfo.mVideoJsonWidth, paramBaseArticleInfo.mVideoJsonHeight);
      ...
      localsuo.jdField_a_of_type_JavaNetURL = paramContext;
      localsuo.jdField_b_of_type_Int = paramBaseArticleInfo.getFirstFrameHeight();
      localsuo.jdField_a_of_type_Int = paramBaseArticleInfo.getFirstFrameWidth();
      localsuo.jdField_b_of_type_Boolean = true;
      sun.a().a(localsuo, new rzf(paramBaseArticleInfo, paramContext));
      return;
    }
