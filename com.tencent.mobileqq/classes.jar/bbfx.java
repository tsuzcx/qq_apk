  ...
  extends bbhb
{
  ...
  private adlo jdField_a_of_type_Adlo = new bbfy(this);
  private ArkViewImplement.LoadCallback jdField_a_of_type_ComTencentArkArkViewImplement$LoadCallback = new bbfz(this);
  ...
  public bbfx(Context paramContext, int paramInt)
  {
  ...
  private adll a(bbga parambbga, Bundle paramBundle)
  {
    ...
    if (QLog.isDebugVersion()) {
      QLog.d("QQCustomArkDialog", 4, "w=" + i + ",h=" + j + ", appName:" + parambbga.jdField_a_of_type_JavaLangString);
    }
    i = paramBundle.getInt("req_type");
    if (ArkFullScreenAppActivity.a(paramBundle))
    {
      this.jdField_a_of_type_Adll.a(parambbga.jdField_a_of_type_JavaLangString, parambbga.b, parambbga.c, parambbga.d, parambbga.jdField_a_of_type_Float, parambbga.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
      if ((this.jdField_e_of_type_Int == 0) || (this.jdField_f_of_type_Int == 0)) {
        break label289;
      }
      this.jdField_a_of_type_Adll.setFixSize(this.jdField_e_of_type_Int, this.jdField_f_of_type_Int);
    }
    for (;;)
    {
      alpd.a = false;
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Adll.a("com.tencent.structmsg", str1, "0.0.0.1", paramBundle, alta.a(), parambbga.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
        break;
        if (i == 4) {
          str1 = "video";
        }
      ...
      label289:
      this.jdField_a_of_type_Adll.setFixSize(this.jdField_d_of_type_Int, this.g);
      this.jdField_a_of_type_Adll.setMaxSize(this.jdField_d_of_type_Int, this.jdField_a_of_type_Int);
      this.jdField_a_of_type_Adll.setMinSize(this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
    }
  }
  ...
  private String a(Bundle paramBundle, String paramString)
  {
    ...
    try
    {
      ...
      {
        str1 = str3;
        if (str3.contains(ajyc.a(2131710192))) {
          str1 = str3.replace(ajyc.a(2131710196), "");
        }
      }
    ...
    for (;;)
    {
      ...
      bbdj.d(str6, paramString + File.separator + str1);
  ...
  private void a(Bundle paramBundle)
  {
    ...
    localbbga.jdField_a_of_type_Float = alta.a();
    paramBundle = a(localbbga, paramBundle);
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Adll.doOnEvent(paramInt);
  }
  ...
  public void a(Context paramContext, Bundle paramBundle)
  {
    try
    {
      ...
      Object localObject1 = localView.findViewById(2131362790);
      ...
      if ((ArkFullScreenAppActivity.a(paramBundle)) && ("card".equals(((ArkAppMessage.Config)localObject1).type))) {
        this.g = alta.jdField_a_of_type_Int;
      }
      ...
      if (bool2)
      {
        ...
        if (localObject2 != null)
        {
          ...
          if ((((ArkAppMessage.Config)localObject1).autoSize != null) && (((ArkAppMessage.Config)localObject1).autoSize.intValue() == 1)) {
            this.jdField_e_of_type_Int = alta.jdField_a_of_type_Int;
          }
  ...
  public void a(String paramString)
  {
    ...
    ((TextView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131378539)).setText(paramString);
  }
