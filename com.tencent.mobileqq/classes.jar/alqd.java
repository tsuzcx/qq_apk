...
public final class alqd
  extends Animation
{
  static final WeakHashMap<View, alqd> jdField_a_of_type_JavaUtilWeakHashMap;
  ...
  public static alqd a(View paramView)
  {
    alqd localalqd2 = (alqd)jdField_a_of_type_JavaUtilWeakHashMap.get(paramView);
    alqd localalqd1;
    if (localalqd2 != null)
    {
      localalqd1 = localalqd2;
      if (localalqd2 == paramView.getAnimation()) {}
    }
    else
    {
      localalqd1 = new alqd(paramView);
      jdField_a_of_type_JavaUtilWeakHashMap.put(paramView, localalqd1);
    }
    return localalqd1;
  }
