  ...
  implements tcm
{
  ...
  protected pjt a;
  private pvq jdField_a_of_type_Pvq = new ori(this, null);
  public pzb a;
  ...
  public orh(int paramInt1, int paramInt2, Activity paramActivity, pyk parampyk)
  {
    super(paramActivity);
    this.jdField_c_of_type_Int = 1;
    this.jdField_d_of_type_Int = paramInt2;
    this.jdField_b_of_type_Int = paramInt1;
    this.jdField_a_of_type_Pzb = ((pzb)parampyk);
    this.jdField_a_of_type_Pjt = new pjt();
    this.jdField_a_of_type_Pjt.jdField_a_of_type_Long = bmhv.a(paramInt1, (QQAppInterface)pkh.a());
  }
  ...
  private void a(List<BaseArticleInfo> paramList, int paramInt)
  {
    ...
    localArrayList.addAll(this.jdField_a_of_type_Pzb.a());
    paramList = qeh.a().a(this.jdField_b_of_type_Int, paramList, localArrayList, paramInt);
    this.jdField_a_of_type_Pzb.a(paramList);
    this.jdField_a_of_type_Pzb.a();
  }
  ...
  private void a(boolean paramBoolean1, int paramInt1, boolean paramBoolean2, int paramInt2)
  {
    ...
    long l = a();
    ArticleInfo localArticleInfo = (ArticleInfo)this.jdField_a_of_type_Pzb.a(0);
    ...
    this.jdField_a_of_type_Pzb.a(paramBoolean1);
    localArrayList = new ArrayList();
    pvj.a().a(this.jdField_b_of_type_Int, (List)localObject, i, true, false, this.jdField_c_of_type_Int, null, -1L, null, a(), 0L, 0L, null, paramInt1, false, null, 0, localArrayList);
    this.jdField_c_of_type_Int += 1;
    if ((a() instanceof ReadInJoyNewFeedsActivity)) {
      a(-2);
    }
    uvs.a(paramInt1, this.jdField_b_of_type_Int, a(), paramBoolean2, paramInt2);
  }
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    boolean bool2 = this.jdField_a_of_type_Pzb.a();
    boolean bool3 = oqy.a(this.jdField_b_of_type_Int);
    Object localObject = (KandianMergeManager)((BaseActivity)a()).app.getManager(QQManagerFactory.KANDIAN_MERGE_MANAGER);
    boolean bool1;
    if (System.currentTimeMillis() - this.jdField_a_of_type_Pjt.d > 300000L)
    {
      bool1 = true;
      boolean bool4 = c();
      ...
      bool1 = oqy.c(this.jdField_b_of_type_Int);
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_Int != 70)
      {
        ...
        if (this.jdField_b_of_type_Int != 56)
        {
          ...
          {
            bool1 = paramBoolean;
            if (!plm.c(this.jdField_b_of_type_Int)) {
              bool1 = true;
            }
          }
        }
    ...
    label377:
    localObject = this.jdField_a_of_type_Pjt;
    if (this.jdField_a_of_type_Pjt.jdField_a_of_type_Long == 0L) {}
    for (;;)
    {
      ((pjt)localObject).jdField_a_of_type_Long = l;
      if (this.jdField_b_of_type_Int == 0) {}
      return false;
      l = this.jdField_a_of_type_Pjt.jdField_a_of_type_Long;
    }
  }
  ...
  {
    this.jdField_a_of_type_Pzb.a();
    this.jdField_a_of_type_Pzb.a(paramBaseArticleInfo, paramInt);
    QQToast.a(this.jdField_a_of_type_AndroidAppActivity, -1, this.jdField_a_of_type_AndroidAppActivity.getString(2131699166), 0).b(((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).getTitleBarHeight());
    if (qeh.a(paramBaseArticleInfo.mRecommendSeq)) {
      qeh.a().a(this.jdField_b_of_type_Int, paramBaseArticleInfo.mRecommendSeq);
    }
    do
    {
      do
      {
        ...
        localDislikeInfo.jdField_a_of_type_JavaLangString = anvx.a(2131712177);
        localDislikeInfo.jdField_a_of_type_Int = 9;
        localDislikeInfo.b = "";
        ArrayList localArrayList = new ArrayList();
        localArrayList.add(localDislikeInfo);
        pvj.a().a(Long.valueOf(str).longValue(), ((ArticleInfo)paramBaseArticleInfo).makeDislikeParam(localArrayList));
        pvj.a().a(this.jdField_b_of_type_Int, paramBaseArticleInfo);
      } while (paramInt != 0);
      paramBaseArticleInfo = (KandianMergeManager)((QQAppInterface)pkh.a()).getManager(QQManagerFactory.KANDIAN_MERGE_MANAGER);
    } while (this.jdField_a_of_type_Pzb.a().size() > 0);
  ...
  public void a(ReadInjoyXRecyclerView paramReadInjoyXRecyclerView, int paramInt)
  {
    ...
    for (;;)
    {
      pvj.a().a(this.jdField_b_of_type_Int, a(), paramInt, 0, i);
  ...
  public void a(ReadInjoyXRecyclerView paramReadInjoyXRecyclerView, boolean paramBoolean)
  {
    ...
    if ((!pnn.a()) || (d()) || (paramBoolean))
    {
      ...
      pvm.a().a(2, null);
      ReadinjoyTabFrame localReadinjoyTabFrame = pqx.a(a());
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Pzb.c();
    } while (!paramBoolean);
    this.jdField_a_of_type_Pzb.b();
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Pzb != null) {
      this.jdField_a_of_type_Pzb.a(a(Integer.valueOf(this.jdField_b_of_type_Int)), b(Integer.valueOf(this.jdField_b_of_type_Int)));
    }
    this.jdField_a_of_type_Pjt.b = System.currentTimeMillis();
  ...
  public void c()
  {
    ...
    do
    {
      ...
      super.c();
    } while (this.jdField_a_of_type_Pzb == null);
    this.jdField_a_of_type_Pzb.a(b(Integer.valueOf(this.jdField_b_of_type_Int)), a(Integer.valueOf(this.jdField_b_of_type_Int)));
  }
  ...
  public void i()
  {
    this.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)pvj.a().a(this.jdField_b_of_type_Int));
    if ((this.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_JavaUtilArrayList.size() == 0)) {
      pvj.a().c(this.jdField_b_of_type_Int);
    }
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
      this.jdField_a_of_type_Pzb.c(this.jdField_a_of_type_JavaUtilArrayList);
    }
    pvj.a().a(this.jdField_b_of_type_Int);
  }
  ...
  public void k()
  {
    if (this.jdField_a_of_type_Pzb != null)
    {
      ...
      Map localMap2 = uvs.a(this.jdField_b_of_type_Int);
      ThreadManager.executeOnSubThread(new ReadInJoyChannelWaterFallViewController.1(this, localMap1, a(Integer.valueOf(this.jdField_b_of_type_Int)), localMap2, prp.a(this.jdField_b_of_type_Int)));
