...
public class bgip
{
  ...
  public static final HashMap<String, bgir> a;
  public static Hashtable<String, TroopBarPublishActivity.Pic_list> a;
  protected static final String b;
  public static final HashMap<String, bgir> b;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anvx.a(2131714591);
    jdField_b_of_type_JavaLangString = anvx.a(2131714601);
    jdField_c_of_type_JavaLangString = anvx.a(2131714582);
    d = anvx.a(2131714578);
  ...
  public static final Uri a(BaseActivity paramBaseActivity, String paramString, int paramInt)
  {
    ...
    QQToast.a(paramBaseActivity, 2131696007, 1).b(paramBaseActivity.getTitleBarHeight());
    return null;
  }
    ...
    if ((paramEditText.getEditableText() instanceof QQTextBuilder))
    {
      ...
      if (localQQTextBuilder != null)
      {
        ...
        if (((localQQTextBuilder instanceof Spanned)) && (Build.VERSION.SDK_INT >= 24)) {
          Arrays.sort((Object[])localObject1, new bgiq(localQQTextBuilder));
        }
        int k = 0;
  ...
  public static final void a(Context paramContext, String paramString1, String paramString2, int paramInt, String paramString3, String paramString4, String paramString5)
  {
    ...
    bdla.b(null, "P_CliOper", "BizTechReport", "", paramString1, paramString2, 0, paramInt, "" + i, paramString3, paramString4, paramString5);
  }
  
  public static void a(Context paramContext, String paramString1, String paramString2, Bundle paramBundle1, String paramString3, int paramInt, Bundle paramBundle2, bghi parambghi, String paramString4)
  {
    if ((paramBundle1 != null) && (!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)))
    {
      paramBundle1.putString("version", "8.4.10");
      ...
      new bghh(paramString3, paramString4, parambghi, paramInt, paramBundle2).execute(new HashMap[] { paramString1 });
    }
  ...
  public static void a(BaseActivity paramBaseActivity, Bundle paramBundle1, String paramString, int paramInt, Bundle paramBundle2, bghi parambghi)
  {
    a(paramBaseActivity, paramBundle1, paramString, paramInt, paramBundle2, parambghi, "GET");
  }
  
  protected static void a(BaseActivity paramBaseActivity, Bundle paramBundle1, String paramString1, int paramInt, Bundle paramBundle2, bghi parambghi, String paramString2)
  {
    AppRuntime localAppRuntime = paramBaseActivity.getAppRuntime();
    String str = localAppRuntime.getAccount();
    a(paramBaseActivity, str, ((TicketManager)localAppRuntime.getManager(2)).getSkey(str), paramBundle1, paramString1, paramInt, paramBundle2, parambghi, paramString2);
  }
  ...
  {
    bdla.b(null, "P_CliOper", paramString1, "", paramString2, paramString3, 0, 0, paramString4, paramString5, paramString6, paramString7);
  }
  ...
  public static void b(BaseActivity paramBaseActivity, Bundle paramBundle1, String paramString, int paramInt, Bundle paramBundle2, bghi parambghi)
  {
    a(paramBaseActivity, paramBundle1, paramString, paramInt, paramBundle2, parambghi, "POST");
  }
  ...
  {
    bdla.b(null, "dc00899", "Grp_tribe", "", paramString1, paramString2, 0, 0, paramString3, paramString4, paramString5, paramString6);
  }
}
