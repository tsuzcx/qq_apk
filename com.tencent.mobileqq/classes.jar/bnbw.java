...
public class bnbw
{
  private static volatile bnbw jdField_a_of_type_Bnbw;
  private Map<String, bnbx> jdField_a_of_type_JavaUtilMap = a(LocalMultiProcConfig.getString("Qz_setting", "NetworkedModuleConfig_cur", ""));
  private Map<String, bnbx> b = new ConcurrentHashMap();
  
  public static bnbw a()
  {
    if (jdField_a_of_type_Bnbw == null) {}
    try
    {
      if (jdField_a_of_type_Bnbw == null) {
        jdField_a_of_type_Bnbw = new bnbw();
      }
      return jdField_a_of_type_Bnbw;
    }
    finally {}
  }
  
  private bnbx a(UPDATE_INFO paramUPDATE_INFO)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject1 = new bnby();
        ((bnby)localObject1).a(str3).b(str5).c(str6).d((String)localObject3).e(str4).f(paramUPDATE_INFO).g((String)localObject4).a(i).a(0L);
        return ((bnby)localObject1).a();
      }
  ...
  static String a(Map<String, bnbx> paramMap)
  {
    if ((paramMap != null) && (paramMap.size() > 0))
    {
      ...
      for (;;)
      {
        if (localIterator.hasNext())
        {
          ...
          localObject = (bnbx)paramMap.get(localObject);
          try
          {
            localJSONObject2.put("module_id", ((bnbx)localObject).jdField_a_of_type_JavaLangString);
            localJSONObject2.put("module_md5", ((bnbx)localObject).e);
            localJSONObject2.put("module_url", ((bnbx)localObject).d);
            localJSONObject2.put("module_version", ((bnbx)localObject).b);
            localJSONObject2.put("module_main_version", ((bnbx)localObject).c);
            localJSONObject2.put("module_key_class_name", ((bnbx)localObject).f);
            localJSONObject2.put("module_class_ids", ((bnbx)localObject).h);
            localJSONObject2.put("module_class_ids_count", ((bnbx)localObject).jdField_a_of_type_Int);
            localJSONObject2.put("module_file_length", ((bnbx)localObject).jdField_a_of_type_Long);
  ...
  static Map<String, bnbx> a(String paramString)
  {
      ...
      try
      {
        ...
        if (paramString != null)
        {
          ...
          while (i < j)
          {
            ...
            {
              localObject2 = new bnby();
              ((bnby)localObject2).a((String)localObject1).b(str3).c(str4).d(str2).e(str1).f(str5).g(str6).a(k).a(l);
              localObject1 = ((bnby)localObject2).a();
              localConcurrentHashMap.put(((bnbx)localObject1).jdField_a_of_type_JavaLangString, localObject1);
            }
            i += 1;
          }
        }
  ...
  public bnbx a(String paramString)
  {
    boolean bool = true;
    label386:
    for (;;)
    {
      try
      {
        bnbx localbnbx1 = (bnbx)this.jdField_a_of_type_JavaUtilMap.get(paramString);
        bnbx localbnbx2 = (bnbx)this.b.get(paramString);
        Object localObject = localbnbx2;
        if (localbnbx2 == null)
        {
          localbnbx2 = QzoneModuleRecordFactory.getInstance().createRecord(paramString);
          ...
          localObject = localbnbx2;
          if (localbnbx2 != null)
          {
            this.b.put(paramString, localbnbx2);
            localObject = localbnbx2;
          }
        }
        if (localbnbx1 != null)
        {
          localbnbx1.jdField_a_of_type_Bnbx = ((bnbx)localObject);
          paramString = localbnbx1;
          localObject = paramString;
          if (paramString != null)
          {
            if ((paramString.jdField_a_of_type_Bnbx != null) && (!TextUtils.isEmpty(paramString.jdField_a_of_type_Bnbx.g)) && (!bmsw.a().equalsIgnoreCase(paramString.jdField_a_of_type_Bnbx.g)))
            {
              QLog.i("QzoneModuleConfigManager", 1, "mNewVersion.mQua=" + paramString.jdField_a_of_type_Bnbx.g + " is not equal QUA=" + bmsw.a());
              paramString.jdField_a_of_type_Bnbx = null;
            }
            localObject = paramString;
            if (!TextUtils.isEmpty(paramString.g))
            {
              localObject = paramString;
              if (!bmsw.a().equalsIgnoreCase(paramString.g))
              {
                QLog.i("QzoneModuleConfigManager", 1, "curRecord.mQua=" + paramString.g + " is not equal QUA=" + bmsw.a());
                if ((paramString.jdField_a_of_type_Bnbx == null) || (!paramString.e.equalsIgnoreCase(paramString.jdField_a_of_type_Bnbx.e))) {
                  continue;
                }
                localObject = paramString.jdField_a_of_type_Bnbx;
                a((bnbx)localObject);
        ...
        else
        {
          ...
          ((bnbx)localObject).jdField_a_of_type_Bnbx = ((bnbx)localObject);
          if (!TextUtils.equals(((bnbx)localObject).e, ((bnbx)localObject).e)) {
            break label386;
          }
          ((bnbx)localObject).jdField_a_of_type_Long = ((bnbx)localObject).jdField_a_of_type_Long;
          break label386;
        }
        localObject = paramString.jdField_a_of_type_Bnbx;
        continue;
  ...
  public ArrayList<UPDATE_INFO> a()
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      bnbx localbnbx = (bnbx)this.jdField_a_of_type_JavaUtilMap.get(str);
      if (localbnbx != null) {}
      for (localUPDATE_INFO.ver = localbnbx.b;; localUPDATE_INFO.ver = "0")
      {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramSQ_CLIENT_UPDATE_RSP.hasNext())
        {
          ...
          if (localObject != null) {
            this.b.put(((bnbx)localObject).jdField_a_of_type_JavaLangString, localObject);
          }
          if (localUPDATE_INFO.actype == 4)
          {
            QLog.w("QzoneModuleConfigManager", 1, "clear module config:" + localUPDATE_INFO.id);
            localObject = (bnbx)this.jdField_a_of_type_JavaUtilMap.get(localUPDATE_INFO.id);
            if (localObject == null) {
              break label508;
            }
            localObject = new File(QzoneModuleConst.getModuleSavePath(BaseApplicationImpl.getApplication(), (bnbx)localObject));
          ...
          bnbx localbnbx = (bnbx)this.jdField_a_of_type_JavaUtilMap.get(localUPDATE_INFO.id);
          if (localbnbx == null) {
            continue;
          }
          this.jdField_a_of_type_JavaUtilMap.remove(localUPDATE_INFO.id);
          if (!localbnbx.e.equalsIgnoreCase(localUPDATE_INFO.md5))
          {
            localObject = new File(QzoneModuleConst.getModuleSavePath(BaseApplicationImpl.getApplication(), localbnbx));
            if (((File)localObject).exists()) {
              ((File)localObject).delete();
            }
  ...
  public void a(bnbx parambnbx)
  {
    if (parambnbx != null) {}
    try
    {
      this.b.remove(parambnbx.jdField_a_of_type_JavaLangString);
      Object localObject = (bnbx)this.jdField_a_of_type_JavaUtilMap.get(parambnbx.jdField_a_of_type_JavaLangString);
      if ((localObject != null) && (!((bnbx)localObject).e.equalsIgnoreCase(parambnbx.e)))
      {
        localObject = new File(QzoneModuleConst.getModuleSavePath(BaseApplicationImpl.getApplication(), (bnbx)localObject));
        if (((File)localObject).exists()) {
          ((File)localObject).delete();
      ...
      localObject = new File(QzoneModuleConst.getModuleSavePath(BaseApplicationImpl.getApplication(), parambnbx));
      if (((File)localObject).exists()) {
        parambnbx.jdField_a_of_type_Long = ((File)localObject).length();
      }
      this.jdField_a_of_type_JavaUtilMap.put(parambnbx.jdField_a_of_type_JavaLangString, parambnbx);
      LocalMultiProcConfig.putString("Qz_setting", "NetworkedModuleConfig_cur", a(this.jdField_a_of_type_JavaUtilMap));
      QzoneModuleConst.clearLastCrashCount(parambnbx.jdField_a_of_type_JavaLangString);
      return;
    }
    finally {}
  }
  
  public void b(bnbx parambnbx)
  {
    try
    {
      this.b.put(parambnbx.jdField_a_of_type_JavaLangString, parambnbx);
      return;
    }
    finally
    {
