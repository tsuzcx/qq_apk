  ...
  extends bndj
{
  ...
  private static final String jdField_b_of_type_JavaLangString = amtj.a(2131702611);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bnbw.class.getSimpleName();
  }
  
  public bnbw(bnee parambnee, int paramInt)
  {
  ...
  private void a(String paramString)
  {
    ...
    for (int i = 1;; i = 2)
    {
      bcef.b(null, "dc00899", "Grp_tribe", "", "video_edit", paramString, i, 0, "", "", "", "");
      return;
    }
  }
  ...
  private void b(String paramString)
  {
    ...
    for (;;)
    {
      paramString.setSpan(new ytn(a(), 2130842604), 0, 1, 33);
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(new bnbx(this));
      return;
      b(jdField_b_of_type_JavaLangString);
    }
  }
  ...
  {
    super.a();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)a(2131364085));
    this.jdField_a_of_type_AndroidViewView = ((ImageView)a(2131378952));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)a(2131365136));
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetTextView.setText(amtj.a(2131702610));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130842605);
    ...
    localObject = bdmy.a(((EditVideoParams)((Activity)a()).getIntent().getParcelableExtra(EditVideoParams.class.getName())).a);
    if (localObject != null)
    {
