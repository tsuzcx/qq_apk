...
public class aqnp
{
  ...
  private aqnm jdField_a_of_type_Aqnm;
  private aqno jdField_a_of_type_Aqno = new aqnq(this);
  private Downloader jdField_a_of_type_ComTencentHlyybDownloaderDownloader;
  private HashMap<String, aqnn> jdField_a_of_type_JavaUtilHashMap;
  Map<String, aqnr> jdField_a_of_type_JavaUtilMap = new HashMap();
  private boolean jdField_a_of_type_Boolean;
  
  static
  {
    jdField_a_of_type_Aqnp = new aqnp();
  }
  ...
  private void c(aqnr paramaqnr)
  {
    DownloaderTask localDownloaderTask = this.jdField_a_of_type_ComTencentHlyybDownloaderDownloader.createNewTask(paramaqnr.b, paramaqnr.g, paramaqnr.h, this.jdField_a_of_type_Aqnm);
    localDownloaderTask.setCategory(DownloaderTaskCategory.Cate_CustomMass1);
    localDownloaderTask.setAppScene(paramaqnr.d);
    if (!TextUtils.isEmpty(paramaqnr.e)) {
      localDownloaderTask.setApkId(paramaqnr.e);
    }
    localDownloaderTask.setNotUseTempFile();
    paramaqnr.a(localDownloaderTask);
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Aqnm != null)
    {
      ...
      this.jdField_a_of_type_Aqnm = null;
    }
  ...
  public void a(Context paramContext)
  {
    ...
    b(paramContext);
    this.jdField_a_of_type_Aqnm = new aqnm(this.jdField_a_of_type_Aqno);
  }
  ...
  public void a(aqnr paramaqnr)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 29	aqnp:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   6: invokeinterface 196 1 0
    //   11: ifne +26 -> 37
    //   14: aload_0
    //   15: aload_1
    //   16: invokevirtual 198	aqnp:b	(Laqnr;)V
    //   19: aload_0
    //   20: getfield 29	aqnp:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   23: aload_1
    //   24: getfield 125	aqnr:b	Ljava/lang/String;
    //   27: aload_1
    ...
    //   52: aload_1
    //   53: getfield 131	aqnr:h	Ljava/lang/String;
    ...
    //   65: aload_0
    //   66: getfield 29	aqnp:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   69: aload_1
    //   70: getfield 125	aqnr:b	Ljava/lang/String;
    //   73: aload_1
  ...
  public void a(String paramString, aqnn paramaqnn)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap == null) {
      this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    }
    this.jdField_a_of_type_JavaUtilHashMap.put(paramString, paramaqnn);
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    bckd.b("DownloadManager_Now_for_qq", "removeDownloadTask---delete unactive halley task, Id:" + localDownloaderTask.getId());
    this.jdField_a_of_type_ComTencentHlyybDownloaderDownloader.deleteTask(localDownloaderTask, paramBoolean);
  }
  
  public void b(aqnr paramaqnr)
  {
    DownloaderTask localDownloaderTask = a(paramaqnr.b);
    try
    {
      str = paramaqnr.b;
      if (TextUtils.isEmpty(str))
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(str))) {
          ((aqnn)this.jdField_a_of_type_JavaUtilHashMap.get(str)).a(-1000, -1, "url is invalid");
        }
      }
      else if ((localDownloaderTask == null) || (!str.equals(localDownloaderTask.getUrl())))
      {
        QLog.i("DownloadManager_Now_for_qq", 4, "startDownload: url is changed, thread = " + Thread.currentThread().getId() + "," + str + "path = " + paramaqnr.h);
        if (localDownloaderTask != null) {}
        c(paramaqnr);
        this.jdField_a_of_type_ComTencentHlyybDownloaderDownloader.addNewTask(paramaqnr.a());
    ...
    catch (Exception localException)
    {
      ...
      if (this.jdField_a_of_type_Int < 3)
      {
        ...
        {
          if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(str))) {
            ((aqnn)this.jdField_a_of_type_JavaUtilHashMap.get(str)).a();
          }
