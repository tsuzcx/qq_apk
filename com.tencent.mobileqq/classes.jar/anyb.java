  ...
  implements Manager
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new anyc(this);
  anvi jdField_a_of_type_Anvi = new anyd(this);
  private awza jdField_a_of_type_Awza = new anye(this);
  private bdvp jdField_a_of_type_Bdvp = new anyf(this);
  ...
  private ArrayList<aixy> jdField_c_of_type_JavaUtilArrayList;
  ...
  public anyb(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_MqqOsMqqHandler = new bkyc(ThreadManager.getSubThreadLooper(), this.jdField_a_of_type_AndroidOsHandler$Callback);
    ...
    if (this.jdField_a_of_type_Awza != null)
    {
      ...
      if (paramQQAppInterface != null) {
        paramQQAppInterface.a(this.jdField_a_of_type_Awza);
      }
    }
  ...
  private int a(List<RecentBaseData> paramList, int paramInt1, int paramInt2)
  {
    if (paramInt1 < 3)
    {
      ...
      if (algc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentBaseData)) {
        break label78;
      }
      paramInt1 += 1;
      label58:
  ...
  private aixy a(oidb_0xc26.TabInfo paramTabInfo)
  {
    aixy localaixy = new aixy();
    localaixy.jdField_a_of_type_Int = paramTabInfo.uint32_tab_id.get();
    localaixy.jdField_b_of_type_Int = paramTabInfo.uint32_recommend_count.get();
    String str;
    if (paramTabInfo.bytes_table_name.has())
    {
      str = paramTabInfo.bytes_table_name.get().toStringUtf8();
      localaixy.jdField_a_of_type_JavaLangString = str;
      if (!paramTabInfo.bytes_icon_url_select.has()) {
        break label116;
      }
      str = paramTabInfo.bytes_icon_url_select.get().toStringUtf8();
      label77:
      localaixy.jdField_b_of_type_JavaLangString = str;
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        if (k < m)
        {
          ...
          {
            localObject1 = (RecentRecommendTroopItem)this.jdField_a_of_type_JavaUtilList.remove(k);
        ...
        else
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a().deleteRecentUserByType(8113);
          return localObject1;
        }
        k += 1;
      }
      ...
      paramString = (RecentUser)((aoxz)localObject2).findRecentUser(paramString, 8113);
      if (paramString != null)
      {
        ((aoxz)localObject2).delRecentUser(paramString);
        continue;
      }
    }
  }
  ...
  private <T extends MayKnowRecommend> ArrayList<T> b(@NonNull ArrayList<T> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if (!localanvk.b(localMayKnowRecommend.uin))
      {
        boolean bool = localanvk.a(localMayKnowRecommend.uin, false, true);
        if (bool) {}
        for (int k = 1;; k = 0)
        {
  ...
  private void c(List<oidb_0xc26.TabInfo> paramList)
  {
    ...
    for (??? = "null";; ??? = Integer.valueOf(paramList.size()))
    {
      ...
      synchronized (this.jdField_d_of_type_JavaLangObject)
      {
        ...
        if (((aixy)localObject2).jdField_a_of_type_Int == 23) {
          ((aixy)localObject2).jdField_b_of_type_Int += c().size();
        }
  ...
  private void d(List<aixy> paramList)
  {
    for (;;)
    {
      SharedPreferences localSharedPreferences;
      ...
      synchronized (this.jdField_e_of_type_JavaLangObject)
      {
        ...
        paramList = paramList.iterator();
        if (paramList.hasNext()) {
          localJSONArray.put(aixy.a((aixy)paramList.next()));
        }
      }
  ...
  private void l()
  {
    ...
    aqxs localaqxs = aqxr.a();
    StringBuilder localStringBuilder;
    if (localaqxs != null)
    {
      this.jdField_g_of_type_Int = localaqxs.jdField_a_of_type_Int;
      this.jdField_a_of_type_JavaLangString = localaqxs.jdField_a_of_type_JavaLangString;
      if (localaqxs.jdField_b_of_type_Int == 1)
      {
        bool1 = true;
    ...
    else
    {
      ...
      {
        ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.FRIENDLIST_HANDLER)).notifyUI(123, true, new Object[] { Integer.valueOf(k) });
    ...
    synchronized (this.jdField_d_of_type_JavaLangObject)
    {
      ...
      synchronized (this.jdField_e_of_type_JavaLangObject)
      {
        ...
        try
        {
          ...
          {
            localArrayList.add(aixy.a(((JSONArray)localObject4).getJSONObject(k)));
            k += 1;
          }
  ...
  public int a()
  {
    ...
    int k = 0;
    p();
    if (!((ajmy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.CTENTRY_MNG)).c()) {}
    for (int m = 1;; m = 0) {
      label149:
      for (;;)
      {
        synchronized (this.jdField_d_of_type_JavaLangObject)
        {
          if (this.jdField_c_of_type_JavaUtilArrayList != null)
          {
            ...
            {
              aixy localaixy = (aixy)localIterator.next();
              if ((localaixy.jdField_a_of_type_Int != 23) && (m == 0)) {
                break label149;
              }
              k = localaixy.jdField_b_of_type_Int + k;
              break label149;
            }
          }
          if (QLog.isColorLevel()) {
  ...
  public ArrayList<aixy> a()
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_d_of_type_JavaLangObject)
      {
        ...
        localaixy = aixy.a((aixy)localIterator.next());
        if (localaixy.jdField_a_of_type_Int == 23)
        {
          localaixy.jdField_a_of_type_Boolean = true;
          localArrayList.add(localaixy);
        }
      }
      localaixy.jdField_a_of_type_Boolean = bool;
    }
    if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        synchronized (this.jdField_d_of_type_JavaLangObject)
        {
          if (this.jdField_c_of_type_JavaUtilArrayList != null)
          {
            ...
            {
              aixy localaixy = (aixy)((Iterator)localObject3).next();
              if ((localaixy.equals(paramList)) && ((localaixy.jdField_b_of_type_Int != paramList.jdField_b_of_type_Int) || (!localaixy.jdField_a_of_type_JavaLangString.equals(paramList.jdField_a_of_type_JavaLangString)) || (!localaixy.jdField_b_of_type_JavaLangString.equals(paramList.jdField_b_of_type_JavaLangString)) || (!localaixy.c.equals(paramList.c))))
              {
                localaixy.jdField_b_of_type_Int = paramList.jdField_b_of_type_Int;
                localaixy.jdField_a_of_type_JavaLangString = paramList.jdField_a_of_type_JavaLangString;
                localaixy.jdField_b_of_type_JavaLangString = paramList.jdField_b_of_type_JavaLangString;
                localaixy.c = paramList.c;
                d(this.jdField_c_of_type_JavaUtilArrayList);
              }
            }
          }
  ...
  public void a(View paramView, Context paramContext, String paramString)
  {
    ...
    if ((paramString.equals("sp_uin_for_title")) && (k == 2131376355))
    {
      paramView = bkzi.a(paramContext);
      paramView.b(2131691229);
      paramView.c(2131690697);
      paramView.a(new anyi(this, paramView));
      paramView.show();
      bdla.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_ellipsis", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      return;
      if ((paramView.getTag() != null) && ((paramView.getTag() instanceof alig)))
      {
        paramView = (alig)paramView.getTag();
        if (paramView.a == null) {
          break;
        }
        ...
        for (paramView = (RecentRecommendTroopItem)paramView.a.mUser.extraInfo; paramView != null; paramView = null)
        {
          ...
          if (k == 2131363938)
          {
            ...
            bdla.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_add", 0, 0, paramView.uin, paramView.recomAlgol, "", "");
            return;
          }
          ...
          for (;;)
          {
            try
            {
              ...
              if (TextUtils.isEmpty(paramView.recommendReason))
              {
                ...
                localObject = ntx.a(paramView);
                if (localObject != null) {
                  paramString.labels = ((ArrayList)localObject);
                }
                paramString.strJoinSig = paramView.authSig;
                TroopUtils.openTroopInfoActivity(paramContext, TroopUtils.getTroopProfileExtra(107, paramString, 10018, false), 2);
                bdla.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_grp", 0, 0, paramView.uin, paramView.recomAlgol, "", "");
                return;
              }
            }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        synchronized (jdField_a_of_type_JavaLangObject)
        {
          ...
          synchronized (this.jdField_c_of_type_JavaUtilArrayList)
          {
            ...
            for (;;)
            {
              ...
              localaixy = (aixy)localIterator.next();
              label218:
              label223:
              synchronized (this.jdField_f_of_type_JavaLangObject)
              {
                ...
                {
                  if (localaixy.jdField_b_of_type_Int <= 0) {
                    break;
                  }
                  k = localaixy.jdField_b_of_type_Int - 1;
                  localaixy.jdField_b_of_type_Int = k;
                }
              }
            }
          }
        ...
        break label218;
        label253:
        Object localObject3 = (ArrayList)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(localaixy.jdField_a_of_type_Int));
        if (localObject3 != null)
        {
          ...
          if (((Iterator)localObject3).hasNext())
          {
            ...
            localaixy.jdField_b_of_type_Int -= 1;
          }
        }
      }
      label337:
  ...
  public void a(@NonNull ArrayList<MayKnowRecommend> paramArrayList)
  {
    ...
    //   1: ifnull +10 -> 11
    //   4: aload_1
    //   5: invokevirtual 349	java/util/ArrayList:isEmpty	()Z
    //   8: ifeq +30 -> 38
    //   11: invokestatic 274	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   14: ifeq +23 -> 37
    //   17: ldc_w 276
    //   20: iconst_2
    //   21: invokestatic 1340	java/util/Locale:getDefault	()Ljava/util/Locale;
    //   24: ldc_w 1342
    //   27: iconst_0
    //   28: anewarray 4	java/lang/Object
    //   31: invokestatic 1346	java/lang/String:format	(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   34: invokestatic 291	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   37: return
    //   38: aload_0
    //   39: aload_1
    //   40: invokespecial 369	anyb:b	(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    //   43: astore 4
    //   45: aload 4
    //   47: astore_3
    //   48: aload 4
    //   50: invokeinterface 204 1 0
    //   55: sipush 1000
    //   58: if_icmple +15 -> 73
    //   61: aload 4
    //   63: iconst_0
    //   64: sipush 1000
    //   67: invokeinterface 1350 3 0
    //   72: astore_3
    //   73: getstatic 48	anyb:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   76: astore 4
    //   78: aload 4
    //   80: monitorenter
    //   81: aload_0
    //   82: getfield 147	anyb:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   85: invokevirtual 1293	java/util/ArrayList:clear	()V
    //   88: aload_0
    //   89: getfield 147	anyb:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   92: aload_3
    //   93: invokevirtual 373	java/util/ArrayList:addAll	(Ljava/util/Collection;)Z
    //   96: pop
    //   97: aload 4
    //   99: monitorexit
    //   100: aload_0
    //   101: getfield 136	anyb:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   104: invokevirtual 379	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   107: astore 4
    //   109: aload 4
    //   111: invokevirtual 384	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   114: aload_0
    //   115: getfield 136	anyb:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   118: ldc_w 738
    //   121: invokevirtual 392	com/tencent/mobileqq/persistence/EntityManager:execSQL	(Ljava/lang/String;)Z
    //   124: pop
    //   125: aload_3
    //   126: invokeinterface 204 1 0
    //   131: ifle +147 -> 278
    //   134: aload_3
    //   135: invokeinterface 577 1 0
    //   140: astore_3
    //   141: aload_3
    //   142: invokeinterface 401 1 0
    //   147: ifeq +131 -> 278
    //   150: aload_0
    //   151: aload_3
    //   152: invokeinterface 405 1 0
    //   157: checkcast 407	com/tencent/mobileqq/data/MayKnowRecommend
    //   160: invokevirtual 1352	anyb:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   163: pop
    //   164: goto -23 -> 141
    //   167: astore_3
    //   168: invokestatic 274	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   171: ifeq +14 -> 185
    //   174: ldc_w 276
    //   177: iconst_2
    //   178: ldc_w 1354
    //   181: aload_3
    //   182: invokestatic 416	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   185: aload 4
    //   187: invokevirtual 419	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   190: iconst_0
    //   191: istore_2
    //   192: aload_0
    //   193: getfield 105	anyb:jdField_f_of_type_JavaLangObject	Ljava/lang/Object;
    //   196: astore_3
    //   197: aload_3
    //   198: monitorenter
    //   199: aload_0
    //   200: getfield 92	anyb:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   203: ifnull +10 -> 213
    //   206: aload_0
    //   207: getfield 92	anyb:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   210: invokevirtual 1355	java/util/HashMap:clear	()V
    //   213: aload_3
    //   214: monitorexit
    //   215: invokestatic 274	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   218: ifeq -181 -> 37
    //   221: ldc_w 276
    //   224: iconst_2
    //   225: invokestatic 1340	java/util/Locale:getDefault	()Ljava/util/Locale;
    //   228: ldc_w 1357
    //   231: iconst_3
    ...
    //   236: iconst_0
    //   237: aload_1
    //   238: invokevirtual 355	java/util/ArrayList:size	()I
    //   241: invokestatic 425	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   244: aastore
    //   245: dup
    //   246: iconst_1
    //   247: aload_0
    //   248: getfield 147	anyb:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   251: invokevirtual 355	java/util/ArrayList:size	()I
    //   254: invokestatic 425	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   257: aastore
    //   258: dup
    //   259: iconst_2
    //   260: iload_2
    //   261: invokestatic 1362	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   264: aastore
    //   265: invokestatic 1346	java/lang/String:format	(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   268: invokestatic 291	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   271: return
    //   272: astore_1
    //   273: aload 4
    //   275: monitorexit
    ...
    //   277: athrow
    //   278: aload 4
    //   280: invokevirtual 435	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   283: aload 4
    //   285: invokevirtual 419	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   288: iconst_1
    //   289: istore_2
    //   290: goto -98 -> 192
    //   293: astore_1
    //   294: aload 4
    //   296: invokevirtual 419	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   299: aload_1
    //   300: athrow
    //   301: astore_1
    //   302: aload_3
  ...
  public void a(List<String> paramList, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    //   1: ifnull +12 -> 13
    //   4: aload_1
    //   5: invokeinterface 600 1 0
    //   10: ifeq +4 -> 14
    //   13: return
    //   14: new 138	java/util/ArrayList
    //   17: dup
    //   18: invokespecial 145	java/util/ArrayList:<init>	()V
    //   21: astore 7
    //   23: getstatic 48	anyb:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   26: astore 8
    //   28: aload 8
    //   30: monitorenter
    //   31: aload_0
    //   32: getfield 147	anyb:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   35: invokevirtual 396	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   38: astore 9
    //   40: aload 9
    //   42: invokeinterface 401 1 0
    //   47: ifeq +92 -> 139
    //   50: aload 9
    //   52: invokeinterface 405 1 0
    //   57: checkcast 407	com/tencent/mobileqq/data/MayKnowRecommend
    //   60: astore 10
    //   62: aload 10
    //   64: ifnull -24 -> 40
    //   67: aload_1
    //   68: aload 10
    //   70: getfield 642	com/tencent/mobileqq/data/MayKnowRecommend:uin	Ljava/lang/String;
    //   73: invokeinterface 1364 2 0
    //   78: ifeq -38 -> 40
    //   81: iload 6
    //   83: ifeq +39 -> 122
    //   86: aload 10
    //   88: getfield 1390	com/tencent/mobileqq/data/MayKnowRecommend:cardDisplayTimestamp	J
    //   91: lload 4
    //   93: ladd
    //   94: lload_2
    //   95: lcmp
    ...
    //   99: aload 10
    //   101: lload_2
    //   102: putfield 1390	com/tencent/mobileqq/data/MayKnowRecommend:cardDisplayTimestamp	J
    //   105: aload 7
    //   107: aload 10
    //   109: invokevirtual 651	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   112: pop
    //   113: goto -73 -> 40
    //   116: astore_1
    //   117: aload 8
    ...
    //   122: aload 10
    //   124: lload_2
    //   125: putfield 1390	com/tencent/mobileqq/data/MayKnowRecommend:cardDisplayTimestamp	J
    //   128: aload 7
    //   130: aload 10
    //   132: invokevirtual 651	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   135: pop
    //   136: goto -96 -> 40
    //   139: aload 8
    //   141: monitorexit
    //   142: aload 7
    //   144: invokevirtual 349	java/util/ArrayList:isEmpty	()Z
    //   147: ifne -134 -> 13
    //   150: aload_0
    //   151: getfield 136	anyb:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   154: invokevirtual 379	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   157: astore_1
    //   158: aload_1
    //   159: invokevirtual 384	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   162: aload 7
    //   164: invokevirtual 396	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   167: astore 7
    //   169: aload 7
    //   171: invokeinterface 401 1 0
    //   176: ifeq +47 -> 223
    //   179: aload 7
    //   181: invokeinterface 405 1 0
    //   186: checkcast 407	com/tencent/mobileqq/data/MayKnowRecommend
    //   189: astore 8
    //   191: aload 8
    //   193: ifnull -24 -> 169
    //   196: aload_0
    //   197: aload 8
    //   199: invokevirtual 1352	anyb:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   202: pop
    //   203: goto -34 -> 169
    //   206: astore 7
    //   208: ldc_w 276
    ...
    //   218: aload_1
    //   219: invokevirtual 419	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   222: return
    //   223: aload_1
    //   224: invokevirtual 435	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   227: aload_1
    //   228: invokevirtual 419	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   231: return
    //   232: astore 7
    //   234: aload_1
    //   235: invokevirtual 419	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   238: aload 7
    //   240: athrow
    // Local variable table:
    //   start	length	slot	name	signature
      ...
      if ((??? != null) && (!???.isEmpty()))
      {
        ...
        while (localIterator2.hasNext())
        {
          ...
          if (localRgroupInfo.uint64_group_code.has())
          {
            ...
            localRecentRecommendTroopItem.labelList = aoce.b(localRgroupInfo.rpt_group_label.get());
  ...
  public boolean a(String paramString)
  {
    ...
    {
      aoxz localaoxz = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a();
      paramString = (RecentUser)localaoxz.findRecentUser(paramString, 8112);
      if (paramString != null)
      {
            ...
            if ((localObject instanceof RecentItemMayKnowFriendData))
            {
              ...
              if (localObject != null)
              {
                ...
                else
                {
                  ...
                  this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a().saveRecentUser(((RecentItemMayKnowFriendData)localObject).mUser);
    ...
    try
    {
      if (this.jdField_c_of_type_JavaUtilArrayList != null)
      {
        ...
        if (!this.jdField_c_of_type_JavaUtilArrayList.isEmpty()) {
          localObject1 = (aixy)this.jdField_c_of_type_JavaUtilArrayList.get(0);
        }
      }
      if (localObject1 != null)
      {
        localObject1 = a(((aixy)localObject1).jdField_a_of_type_Int);
        if (localObject1 != null) {
  ...
  public void b()
  {
    ...
    if (this.jdField_c_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localaixy.jdField_a_of_type_Int != 23)
        {
          a(localaixy.jdField_a_of_type_Int, new ArrayList(0), true);
          a(localaixy.jdField_a_of_type_Int, null);
        }
      }
    }
  }
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_d_of_type_JavaLangObject)
      {
        ...
        if (localIterator.hasNext())
        {
          if (((aixy)localIterator.next()).jdField_a_of_type_Int != paramInt) {
            continue;
          }
          localIterator.remove();
          k = 1;
  ...
  public void c()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        {
          aoxz localaoxz = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a();
          localaoxz.deleteRecentUserByType(8112);
          ??? = (RecentUser)localaoxz.findRecentUser(AppConstants.CONVERSATION_MAY_KNOW_FRIEND_UIN, 8111);
          if (??? != null) {
            localaoxz.delRecentUser((BaseRecentUser)???);
          }
          localaoxz.deleteRecentUserByType(8113);
          Object localObject2 = (RecentUser)localaoxz.findRecentUser("sp_uin_for_title", 8113);
          ??? = localObject2;
          if (localObject2 == null) {
          ...
          localaoxz.saveRecentUser((BaseRecentUser)???);
          ...
          ??? = (RecentUser)localaoxz.findRecentUser(localRecentRecommendTroopItem.uin, 8113);
          if (??? != null) {
            break label414;
          }
  ...
  public void c(String paramString)
  {
    ...
    a(paramString);
    ((aoce)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.RECOMMEND_TROOP_MANAGER)).a(paramString, new anyg(this, paramString));
    ...
    if (this.jdField_e_of_type_Int == 0)
    {
      ...
      bdla.b(null, "dc00899", "Grp_recom", "", "link_top", "clk_hide", 0, 0, "", "", "", "");
    }
  ...
  public void d()
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      localObject1 = (RecentUser)localaoxz.findRecentUser(AppConstants.CONVERSATION_MAY_KNOW_FRIEND_UIN, 8111);
      if (localObject1 != null) {
        localaoxz.delRecentUser((BaseRecentUser)localObject1);
      }
      g(8112);
      localRecentUser = (RecentUser)localaoxz.findRecentUser("sp_uin_for_title", 8112);
      ...
      localaoxz.saveRecentUser((BaseRecentUser)localObject1);
      Iterator localIterator = ((ArrayList)localObject2).iterator();
      if (!localIterator.hasNext()) {
        break label474;
      }
      localMayKnowRecommend = (MayKnowRecommend)localIterator.next();
      localRecentUser = (RecentUser)localaoxz.findRecentUser(localMayKnowRecommend.uin, 8112);
      if (localRecentUser != null) {
        break label491;
      }
    ...
    for (;;)
    {
      ...
      break;
      g(8112);
      localRecentUser = (RecentUser)localaoxz.findRecentUser(AppConstants.CONVERSATION_MAY_KNOW_FRIEND_UIN, 8111);
      if (QLog.isColorLevel()) {
  ...
  public void d(int paramInt)
  {
    if (this.jdField_b_of_type_Int != paramInt) {
      ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.FRIENDLIST_HANDLER)).notifyUI(123, true, new Object[] { Integer.valueOf(paramInt) });
    }
  ...
  public void d(String paramString)
  {
    ...
    ((aoce)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.RECOMMEND_TROOP_MANAGER)).a(paramString, new anyh(this, paramString));
    ...
    {
      bdla.b(null, "dc00899", "Grp_recom", "", "msg_tab", "slide_delete", 0, 0, paramString, (String)localObject, "", "");
      return;
  ...
  public void e()
  {
    ...
    aoxz localaoxz = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a();
    g(8112);
    RecentUser localRecentUser = (RecentUser)localaoxz.findRecentUser(AppConstants.CONVERSATION_MAY_KNOW_FRIEND_UIN, 8111);
    if (QLog.isColorLevel()) {
  ...
  {
    a(paramString);
    ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.FRIENDLIST_HANDLER)).notifyUI(122, true, new Object[] { paramString });
  }
