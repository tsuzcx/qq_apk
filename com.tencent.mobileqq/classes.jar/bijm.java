...
public class bijm
{
  ...
  public bbbc a;
  private bijp jdField_a_of_type_Bijp;
  ...
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler = new bijn(this);
  public boolean a;
  ...
  public bijm(RegisterNewBaseActivity paramRegisterNewBaseActivity, View paramView, int paramInt)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity = paramRegisterNewBaseActivity;
    this.jdField_a_of_type_Bijq = new bijq(paramRegisterNewBaseActivity, this);
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_ComTencentWidgetScrollView = ((ScrollView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376944));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131381178));
  ...
  public static void a(Context paramContext, boolean paramBoolean, String paramString1, String paramString2, Intent paramIntent)
  {
    ...
    if (jdField_a_of_type_Int == 1)
    {
      ...
      for (str = "1";; str = "2")
      {
        bdll.a(null, "new_reg", "setting_page_yes", "result", "", 1, "", "", str, "", "", "", "", "", "");
    ...
    {
      bdll.a(null, "new_reg", "setting_page_no", "result", "", 1, "", "", str, "", "", "", "", "", "");
      break;
    }
    label211:
    if (bool) {
  ...
  public static void a(String paramString, Intent paramIntent)
  {
    ...
    try
    {
      ...
      if (paramIntent.hasExtra("phonenum")) {
        localStringBuilder.append("phoneNum: ").append(bhoe.a(paramIntent.getStringExtra("phonenum"))).append("\r\n");
      }
  ...
  private void e()
  {
    ...
    if (jdField_a_of_type_Int == 1)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton.setText(2131715875);
      ...
      ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372302)).setVisibility(0);
      localClearableEditText1 = (ClearableEditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131371831);
      ClearableEditText localClearableEditText2 = (ClearableEditText)this.jdField_a_of_type_AndroidViewView.findViewById(2131372301);
      ...
      this.jdField_a_of_type_AndroidWidgetFrameLayout.addView(this.jdField_a_of_type_Bijq.a(new biju(localIntent)));
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131363809));
      break;
      label375:
      if (jdField_a_of_type_Int != 2) {
        break label250;
  ...
  {
    Intent localIntent;
    if (this.jdField_a_of_type_Bbbc == null)
    {
      this.jdField_a_of_type_Bbbc = new bbbc(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_Bbbc.a(localIntent);
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetFrameLayout != null)
    {
      if (this.jdField_a_of_type_Bijp != null) {
        this.jdField_a_of_type_AndroidWidgetFrameLayout.removeOnLayoutChangeListener(this.jdField_a_of_type_Bijp);
      }
      this.jdField_a_of_type_Bijp = null;
      this.jdField_a_of_type_AndroidWidgetFrameLayout.removeAllViews();
    }
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((i == 0) && (paramBoolean))
      {
        this.jdField_a_of_type_Bijq.a().a(true);
        return;
      }
      if (i == 0)
      {
        this.jdField_a_of_type_Bijq.a().a(false);
        return;
      }
    ...
    this.jdField_a_of_type_AndroidViewView.findViewById(2131374779).getLocationOnScreen(arrayOfInt);
    j = arrayOfInt[1];
    this.jdField_a_of_type_AndroidViewView.findViewById(2131371831).getLocationOnScreen(arrayOfInt);
    int k = arrayOfInt[1];
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.addView(this.jdField_a_of_type_Bijq.a());
    if (QLog.isColorLevel()) {
      QLog.i(jdField_a_of_type_JavaLangString, 2, String.format(Locale.getDefault(), "miniHeight: %d", new Object[] { Integer.valueOf(i) }));
    }
    if (this.jdField_a_of_type_Bijp == null) {
      this.jdField_a_of_type_Bijp = new bijp(this.jdField_a_of_type_ComTencentWidgetScrollView, this.jdField_b_of_type_Int, null);
    }
    this.jdField_a_of_type_AndroidWidgetFrameLayout.addOnLayoutChangeListener(this.jdField_a_of_type_Bijp);
  }
  
  public void c()
  {
    if (jdField_a_of_type_Int == 1) {
      bdll.a(null, "new_reg", "setting_page_yes", "lianghao_clk", "", 1, "");
    }
    while (jdField_a_of_type_Int != 2) {
      return;
    }
    bdll.a(null, "new_reg", "setting_page_no", "lianghao_clk", "", 1, "");
  }
