...
class bgms
  extends niv
{
  bgms(bgmp parambgmp, String paramString1, String paramString2, String paramString3) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    {
      aukw.a("KEY_STAGE_2_GO_TO_CHAT_D55", bool1);
      this.jdField_a_of_type_Bgmp.c();
      if (!this.jdField_a_of_type_Bgmp.g) {
        break;
      }
      bcst.b(this.jdField_a_of_type_Bgmp.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc01160", "", "", "0X800A40E", "0X800A40E", 0, 0, "", "", this.jdField_a_of_type_Bgmp.jdField_a_of_type_AndroidContentContext.getString(2131698373), "");
    ...
    for (;;)
    {
      if (paramInt <= 1)
      {
        paramBundle = (String)this.jdField_a_of_type_Bgmp.jdField_a_of_type_JavaUtilHashMap.get("uin");
        if ((paramBundle == null) || (paramBundle.length() < 5) || (SearchBaseActivity.b.matcher(paramBundle).matches()))
        {
          QQToast.a(BaseApplicationImpl.getApplication(), 1, 2131698372, 1).a();
          bcst.b(this.jdField_a_of_type_Bgmp.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc01160", "", "", "0X800A40E", "0X800A40E", 0, 0, "", "", this.jdField_a_of_type_Bgmp.jdField_a_of_type_AndroidContentContext.getString(2131698374), "");
          bgmp.c(this.jdField_a_of_type_Bgmp);
          return;
          if (paramInt == 25501) {
            paramInt = 1;
        ...
        {
          bool2 = ((anmw)this.jdField_a_of_type_Bgmp.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(paramBundle);
          paramArrayOfByte = bglf.a(this.jdField_a_of_type_Bgmp.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBundle);
          if ((bool2) && (paramInt == 0))
          {
            localObject = new Intent(this.jdField_a_of_type_Bgmp.jdField_a_of_type_AndroidContentContext, SplashActivity.class);
            ...
            paramBundle = afur.a((Intent)localObject, new int[] { 2 });
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        ...
        bcst.b(this.jdField_a_of_type_Bgmp.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc01160", "", "", "0X800A40F", "0X800A40F", 0, 0, "", "", "", "");
        if (!bool2) {
          break label658;
        }
      ...
      for (;;)
      {
        bgmp.a(this.jdField_a_of_type_Bgmp, (Bundle)localObject);
        bgmp.c(this.jdField_a_of_type_Bgmp);
        return;
        bool1 = false;
        break;
      ...
      bcst.a(this.jdField_a_of_type_Bgmp.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "inter", "skip", "inter_fail", "", 1, "", paramArrayOfByte, "", "", "", "", "", "", "");
      ...
      bgmp.a(this.jdField_a_of_type_Bgmp, paramBundle);
    }
  }
}
