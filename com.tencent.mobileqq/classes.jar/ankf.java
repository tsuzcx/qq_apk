...
public class ankf
{
  ...
  private static NativeMonitorConfig a(SharedPreferences paramSharedPreferences, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramSharedPreferences)) {
      try
      {
        ...
        return (NativeMonitorConfig)arma.a(paramSharedPreferences, NativeMonitorConfig.class);
      }
  ...
  public static void a(android.content.Context paramContext, long paramLong1, String[] paramArrayOfString, long paramLong2, long paramLong3, long paramLong4)
  {
    ...
    //   16: return
    //   17: iconst_1
    //   18: putstatic 125	ankf:b	Z
    //   21: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   24: ifeq +11 -> 35
    //   27: ldc 112
    //   29: iconst_2
    //   30: ldc 127
    //   32: invokestatic 130	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   35: aload_0
    //   36: invokestatic 136	com/tencent/mobileqq/nativememorymonitor/library/NativeMemoryMonitor:getInstance	(Landroid/content/Context;)Lcom/tencent/mobileqq/nativememorymonitor/library/NativeMemoryMonitor;
    //   39: lload_1
    //   40: aload_3
    //   41: lload 4
    //   43: lload 6
    //   45: lload 8
    //   47: invokevirtual 140	com/tencent/mobileqq/nativememorymonitor/library/NativeMemoryMonitor:init	(J[Ljava/lang/String;JJJ)V
    //   50: goto -37 -> 13
    //   53: astore_0
    //   54: ldc 2
    //   56: monitorexit
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, ConfigurationService.Config paramConfig)
  {
    ...
    int i = bbkb.aE(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int k = bbkb.aF(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    int m = AppSetting.a();
    if (QLog.isColorLevel()) {
    ...
    if (k != m)
    {
      bbkb.X(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), m);
      i = 0;
    }
    String str;
    if (j != i)
    {
      str = andt.b(paramConfig, i, paramInt);
    ...
    for (;;)
    {
      try
      {
        ...
        paramConfig = (NativeMonitorConfig)arma.a(paramConfig, NativeMonitorConfig.class);
        if (paramConfig == null)
        {
          a(new NativeMonitorConfig());
          bbkb.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, "");
          bbkb.t(paramQQAppInterface.getApp(), 0);
      ...
      catch (JSONException paramConfig)
      {
        ...
        a(paramConfig);
        bbkb.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, str);
        bbkb.t(paramQQAppInterface.getApp(), paramConfig.soHook);
        continue;
      }
      a(new NativeMonitorConfig());
      bbkb.e(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), j, "");
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      QLog.i("NativeMonitorConfig", 2, "arm: " + paramBoolean + ", useASan: " + AppSetting.h);
      return;
      ...
      if (localNativeMonitorConfig != null)
      {
        ...
        akhl.a(jdField_a_of_type_ComTencentMobileqqDataNativemonitorNativeMonitorConfig.getTmChance());
      }
  ...
  private static String b(java.io.File paramFile)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 383	java/io/File:isFile	()Z
    //   4: ifne +5 -> 9
    //   7: aconst_null
    //   8: areturn
    //   9: sipush 4096
    ...
    //   14: astore 4
    //   16: ldc_w 385
    //   19: invokestatic 390	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   22: astore_3
    //   23: new 392	java/io/FileInputStream
    //   26: dup
    //   27: aload_0
    //   28: invokespecial 395	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   31: astore_2
    //   32: aload_2
    //   33: astore_0
    //   34: aload_2
    ...
    //   38: aload 4
    //   40: arraylength
    //   41: invokevirtual 399	java/io/FileInputStream:read	([BII)I
    //   44: istore_1
    //   45: iload_1
    //   46: iconst_m1
    //   47: if_icmpeq +43 -> 90
    ...
    //   55: iconst_0
    //   56: iload_1
    //   57: invokevirtual 402	java/security/MessageDigest:update	([BII)V
    //   60: goto -28 -> 32
    //   63: astore_3
    //   64: aload_2
    //   65: astore_0
    ...
    //   74: invokestatic 373	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   77: aload_2
    //   78: ifnull -71 -> 7
    //   81: aload_2
    //   82: invokevirtual 405	java/io/FileInputStream:close	()V
    //   85: aconst_null
    //   86: areturn
    //   87: astore_0
    //   88: aconst_null
    ...
    //   91: ifnull +7 -> 98
    //   94: aload_2
    //   95: invokevirtual 405	java/io/FileInputStream:close	()V
    //   98: new 407	java/math/BigInteger
    //   101: dup
    //   102: iconst_1
    //   103: aload_3
    //   104: invokevirtual 411	java/security/MessageDigest:digest	()[B
    //   107: invokespecial 414	java/math/BigInteger:<init>	(I[B)V
    //   110: bipush 16
    //   112: invokevirtual 417	java/math/BigInteger:toString	(I)Ljava/lang/String;
    //   115: areturn
    //   116: astore_2
    //   117: aconst_null
    //   118: astore_0
    ...
    //   120: ifnull +7 -> 127
    //   123: aload_0
    //   124: invokevirtual 405	java/io/FileInputStream:close	()V
    //   127: aload_2
    //   128: athrow
    //   129: astore_0
    //   130: goto -32 -> 98
