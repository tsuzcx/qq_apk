...
public class axgc
{
  ...
  public axgc(AppInterface paramAppInterface, Activity paramActivity, bazp parambazp, Intent paramIntent, boolean paramBoolean)
  {
  ...
  {
    axgd localaxgd = new axgd(this);
    paramTouchWebView.setWebChromeClient(localaxgd);
    this.jdField_a_of_type_Mzd = localaxgd;
  }
  ...
  public TouchWebView a(AppInterface paramAppInterface, Activity paramActivity, Intent paramIntent, boolean paramBoolean)
  {
    ...
    Object localObject2;
    if (axfy.a(paramActivity, paramIntent.getStringExtra("url")))
    {
      localObject2 = axfy.a(paramActivity);
    ...
    for (;;)
    {
      ...
      if (localObject2 == null)
      {
        ...
        String str2 = a(this.jdField_a_of_type_Bazp);
        if (((TouchWebView)localObject1).getX5WebViewExtension() == null) {
          break label891;
        }
        paramBoolean = true;
        QLog.i("WebLog_WebViewWrapper", 1, bbdc.a(str1, str2, paramBoolean));
        localObject3 = new StringBuilder();
        str1 = localWebSettings.getUserAgentString();
        str2 = a(this.jdField_a_of_type_Bazp);
        if (((TouchWebView)localObject1).getX5WebViewExtension() == null) {
          break label897;
        }
        paramBoolean = true;
        localWebSettings.setUserAgentString(bbdc.a(str1, str2, paramBoolean) + (String)localObject2);
      ...
      try
      {
        ...
        this.jdField_a_of_type_Aohh = new aohh(paramAppInterface, paramActivity, (TouchWebView)localObject1);
        this.jdField_a_of_type_Aohh.a(paramBoolean);
        ((TouchWebView)localObject1).setDownloadListener(this.jdField_a_of_type_Aohh);
        CookieSyncManager.createInstance(paramAppInterface.getApplication().getApplicationContext());
        if (((TouchWebView)localObject1).getX5WebViewExtension() != null)
        {
          ((TouchWebView)localObject1).getX5WebViewExtension().setWebViewClientExtension(new axgg(this, (TouchWebView)localObject1, this.jdField_a_of_type_Bazp));
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("WebLog_WebViewWrapper", 2, new Object[] { "sReportPerformance:", Boolean.valueOf(bbca.x), " cost:", Long.valueOf(bbdb.a) });
          }
          return localObject1;
          ...
          paramAppInterface.put("coreInit", String.valueOf(bbdb.a));
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Boolean) {
          axfz.a().a(this.jdField_a_of_type_ComTencentBizUiTouchWebView);
        }
        for (;;)
        {
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {}
    for (Object localObject = new axge(this);; localObject = new axgf(this))
    {
