  ...
  extends tbv
{
  ...
  private LruCache<String, stt> c = new LruCache(200);
  ...
  private DownloadingUrlEntry a(String paramString, int paramInt)
  {
    ...
    localObject = tcw.a(QQStoryContext.a().a().createEntityManager(), DownloadingUrlEntry.class, DownloadingUrlEntry.class.getSimpleName(), "key=?", new String[] { DownloadingUrlEntry.makeKey(paramString, paramInt) });
  ...
  public static String a(String paramString)
  {
    try
    {
      ...
      {
        str = ayxg.a().a(str, 1012);
        return str;
      }
    }
    catch (MalformedURLException localMalformedURLException)
    {
      ved.d("Q.qqstory.DownloadUrlManager", "getIpOfDomain url: %s", new Object[] { paramString });
    }
    return null;
  }
  
  private void a(@NonNull String paramString, @NonNull stu paramstu)
  {
    ved.b("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary , vid = %s", paramString);
    Bosses.get().postJob(new stq(this, "Q.qqstory.DownloadUrlManager", paramString, paramstu));
  }
  ...
  private boolean a(String paramString)
  {
    // Byte code:
    //   0: iconst_5
    //   1: invokestatic 162	tcz:a	(I)Ltch;
    //   4: checkcast 71	tcw
    //   7: aload_1
    //   8: invokevirtual 165	tcw:a	(Ljava/lang/String;)Lcom/tencent/biz/qqstory/model/item/StoryVideoItem;
    //   11: astore_3
    //   12: aload_3
    //   13: ifnonnull +11 -> 24
    //   16: ldc 167
    //   18: aload_1
    //   19: invokestatic 171	ved:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   22: iconst_0
    //   23: ireturn
    //   24: aload_3
    ...
    //   83: invokestatic 206	ved:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   86: new 208	tng
    //   89: dup
    //   90: invokespecial 209	tng:<init>	()V
    //   93: astore 4
    //   95: aload 4
    ...
    //   105: putfield 215	tng:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   108: aload 4
    //   110: getfield 215	tng:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   113: aload_1
    //   114: invokeinterface 219 2 0
    //   119: pop
    //   120: aload 4
    //   122: ldc2_w 220
    //   125: putfield 223	tng:jdField_a_of_type_Long	J
    ...
    //   163: aload 5
    //   165: aload 6
    //   167: invokespecial 234	sts:<init>	(Lstl;Ljava/lang/String;Ljava/lang/Object;Ljava/util/concurrent/atomic/AtomicBoolean;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    //   170: astore_1
    //   171: invokestatic 239	syo:a	()Lsyo;
    //   174: aload 4
    //   176: aload_1
    //   177: invokevirtual 242	syo:a	(Lsys;Lsyq;)V
    //   180: aload_3
    ...
    //   191: ldc 116
    //   193: ldc 244
    //   195: invokestatic 206	ved:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   198: iconst_0
    //   199: ireturn
    //   200: aload_2
    //   201: monitorenter
    //   202: ldc 116
    //   204: ldc 246
    //   206: invokestatic 206	ved:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   209: aload 5
  ...
  private stt b(String paramString, int paramInt)
  {
    paramString = DownloadingUrlEntry.makeKey(paramString, paramInt);
    paramString = (stt)this.c.get(paramString);
  ...
  @Deprecated
  private void b(@NonNull String paramString, @NonNull stu paramstu)
  {
    ved.b("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessaryInner , vid = %s", paramString);
    Object localObject = ((tcw)tcz.a(5)).a(paramString);
    if (localObject == null)
    {
      ved.e("Q.qqstory.DownloadUrlManager", "DownloadUrlQueryResult:: error video is null");
      paramstu.a(false);
      return;
    }
    ...
    ved.d("Q.qqstory.DownloadUrlManager", ((StoryVideoItem)localObject).mVid + " request video url is expire :" + ((StoryVideoItem)localObject).videoUrlExpireTime);
    localObject = new tng();
    ((tng)localObject).jdField_a_of_type_JavaUtilList = new ArrayList(1);
    ((tng)localObject).jdField_a_of_type_JavaUtilList.add(paramString);
    ((tng)localObject).jdField_a_of_type_Long = 10000L;
    paramString = new str(this, paramstu, paramString);
    syo.a().a((sys)localObject, paramString);
  }
  ...
  public List<VideoUrlEntry> a(String paramString)
  {
    ...
    List localList = tcw.a(QQStoryContext.a().a().createEntityManager(), VideoUrlEntry.class, VideoUrlEntry.class.getSimpleName(), "vid=?", new String[] { paramString });
  ...
  public stt a(String paramString, int paramInt)
  {
    vxp.b();
    stt localstt = new stt();
    localstt.jdField_a_of_type_JavaLangString = paramString;
    localstt.jdField_a_of_type_Int = paramInt;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          i = 1;
          localstt.jdField_a_of_type_Boolean = true;
          localObject2 = null;
            ...
            if (a())
            {
              ...
              if (localList != null)
              {
                ...
                if (localList.size() > 0)
                {
                  ...
                  localstt.jdField_b_of_type_Int = 2;
                  localstt.jdField_b_of_type_JavaLangString = ((DownloadingUrlEntry)localObject1).url;
                  localstt.c = ((VideoUrlEntry)localObject2).videoUrlLevel;
                }
              }
            }
          }
          if (localstt.jdField_b_of_type_Int != -1) {
            break label644;
          }
          localObject2 = localtcw.a(paramString);
          ...
          if (paramInt == 0)
          {
            ...
            ((DownloadingUrlEntry)localObject1).key = DownloadingUrlEntry.makeKey(((DownloadingUrlEntry)localObject1).vid, ((DownloadingUrlEntry)localObject1).fileType);
            localstt.jdField_b_of_type_Int = 3;
            localstt.jdField_b_of_type_JavaLangString = ((DownloadingUrlEntry)localObject1).url;
            if ((localObject1 != null) && (!TextUtils.isEmpty(((DownloadingUrlEntry)localObject1).url)))
            {
              localObject2 = suj.a(paramString, paramInt, false, false);
              if ((localObject2 == null) || (!((File)localObject2).exists()))
              {
                ...
                QQStoryContext.a().a().createEntityManager().b((auko)localObject1);
              }
            }
            if (i != 0)
            {
              ved.d("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary: video url have expire,so we need to handle the temOrphan~~");
              paramString = a(paramString, paramInt);
              if ((paramString == null) || (!TextUtils.equals(paramString.url, localstt.jdField_b_of_type_JavaLangString))) {
                break label598;
              }
              ved.d("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary: set isTmpOrphan false,cache entry url=" + paramString.url + " result url=" + localstt.jdField_b_of_type_JavaLangString);
              localstt.jdField_a_of_type_Boolean = false;
            }
            return localstt;
          }
        }
        else
        {
          ...
          localstt.jdField_b_of_type_Int = 0;
          localstt.jdField_b_of_type_JavaLangString = ((DownloadingUrlEntry)localObject1).url;
          localstt.c = ((DownloadingUrlEntry)localObject1).compressLevel;
          return localstt;
        }
        if (paramInt == 1)
        {
      ...
      if (paramString == null)
      {
        ved.d("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary: set isTmpOrphan true,cache entry url");
      }
      else
      {
        ved.d("Q.qqstory.DownloadUrlManager", "pullNewVideoInfoIfNecessary: set isTmpOrphan true,cache entry url :" + paramString.url);
        continue;
        continue;
        i = 0;
      }
  ...
  public stt a(String paramString, int paramInt, boolean paramBoolean)
  {
    vxp.b();
    ...
    for (;;)
    {
      ...
      {
        localstt.a();
        localstt.jdField_a_of_type_Long = System.currentTimeMillis();
        this.c.put(str, localstt);
        this.jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock.unlock();
      }
      ((DownloadingUrlEntry)localObject1).url = ((StoryVideoItem)localObject2).getThumbUrl();
      continue;
  ...
  {
    if ((paramInt != 0) || (vwp.a(paramString))) {
      return;
    }
    Bosses.get().postJob(new sto(this, "Q.qqstory.DownloadUrlManager", paramString, paramInt));
  }
  
  public void a(String paramString, int paramInt, stv paramstv)
  {
    stt localstt = b(paramString, paramInt);
    if (localstt != null)
    {
      paramstv.a(localstt);
      return;
    ...
    if (paramInt == 0)
    {
      a(paramString, new stm(this, paramString, paramInt, paramstv));
      return;
    }
    Bosses.get().postJob(new stn(this, "Q.qqstory.DownloadUrlManager", paramString, paramInt, paramstv));
  }
  ...
  public void a(List<List<VideoUrlEntry>> paramList)
  {
    ...
    ved.a("Q.qqstory.DownloadUrlManager", "update video url:%s", paramList);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localaukp.a(localVideoUrlEntry1, "vid=?", new String[] { localVideoUrlEntry1.vid });
        ...
        if (TextUtils.isEmpty(localVideoUrlEntry2.videoUrl))
        {
          ...
          ved.d("Q.qqstory.DownloadUrlManager", "%s url error!", new Object[] { localVideoUrlEntry2.vid });
          continue;
        }
        localaukp.b(localVideoUrlEntry2);
      }
      finally
      {
        localaukp.a().b();
  ...
  {
    ved.a("Q.qqstory.DownloadUrlManager", "replaceDomain2Ip domain - url: %s", paramString);
    ...
    for (;;)
    {
      try
      {
        ...
        {
          Object localObject = ayxg.a().a(str3, 1012);
          if ((localObject != null) && (((List)localObject).size() > 0))
          {
            ...
            if (i < ((List)localObject).size())
            {
              ...
              else
              {
                ...
                ved.a("Q.qqstory.DownloadUrlManager", "replaceDomain2Ip ip - url: %s", str1);
                i += 1;
                continue;
              }
              str1 = str2 + "&txhost=" + str3;
      ...
      {
        ved.b("Q.qqstory.DownloadUrlManager", "replaceDomain2Ip MalformedURLException: %s", localMalformedURLException);
      }
  ...
  {
    Bosses.get().postJob(new stp(this, "Q.qqstory.DownloadUrlManager", paramString, paramInt));
  }
  ...
  public void c(String paramString, int paramInt)
  {
    try
    {
      ...
      paramString = tcw.a((aukp)localObject, DownloadingUrlEntry.class, DownloadingUrlEntry.class.getSimpleName(), "key=?", new String[] { DownloadingUrlEntry.makeKey(paramString, paramInt) });
      if ((paramString != null) && (paramString.size() > 0))
      {
        paramString = (DownloadingUrlEntry)paramString.get(0);
        paramString.setStatus(1001);
        ((aukp)localObject).b(paramString);
      }
      return;
    }
    finally
