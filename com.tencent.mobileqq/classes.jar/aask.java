  ...
  extends WebViewPlugin
{
  ...
  sjm jdField_a_of_type_Sjm = null;
  ...
  private Boolean a(String paramString)
  {
    ...
    {
      pkh.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, true, "shouldOfflineIntercept", 0, System.currentTimeMillis() - this.jdField_a_of_type_Long);
      return Boolean.valueOf(false);
    }
    biip localbiip = biio.a(this.jdField_b_of_type_JavaLangString);
    if ((localbiip != null) && (!TextUtils.isEmpty(localbiip.jdField_b_of_type_JavaLangString)))
    {
      this.mRuntime.a().loadDataWithBaseURL(paramString, localbiip.jdField_b_of_type_JavaLangString, "text/html", "utf-8", paramString);
      ...
      pkh.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, true, "shouldOfflineIntercept", 1, System.currentTimeMillis() - this.jdField_a_of_type_Long);
  ...
  private String a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Sjm != null)
    {
      ...
      paramString = this.jdField_a_of_type_Sjm.a("CMD_GET_WEB_RENDER_DATA", (Bundle)localObject);
      localObject = str;
      if (paramString != null) {
  ...
  private void a(String paramString1, String paramString2, Map<String, Object> paramMap)
  {
    ...
    for (int i = 1;; i = 0)
    {
      pkh.a(paramString1, true, paramString2, i, System.currentTimeMillis() - this.jdField_a_of_type_Long);
      return;
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  {
    if (!bmhv.q(this.jdField_a_of_type_ComTencentCommonAppAppInterface)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        if (paramLong == 32L)
        {
          ...
          if ((!bmhv.r(this.jdField_a_of_type_ComTencentCommonAppAppInterface)) && (!this.jdField_a_of_type_Boolean)) {
            return a(paramString).booleanValue();
          }
          return this.jdField_a_of_type_Boolean;
        }
      } while ((paramLong != 8589934593L) || (!bmhv.r(this.jdField_a_of_type_ComTencentCommonAppAppInterface)));
  ...
  public void onCreate()
  {
    ...
    if (this.mRuntime != null)
    {
      ...
      this.jdField_b_of_type_Boolean = bmhv.q(this.jdField_a_of_type_ComTencentCommonAppAppInterface);
    }
    if (this.jdField_a_of_type_Sjm == null) {
    ...
    if ((this.mRuntime != null) && (this.jdField_b_of_type_Boolean))
    {
      ...
      if ((localActivity instanceof FragmentActivity))
      {
        ...
        if (localObject != null)
        {
          ...
          {
            this.jdField_b_of_type_JavaLangString = nuz.a((String)localObject, "_bid=" + str);
      ...
      pkh.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, true, "REPORT_EVENT_CREATE", 0, System.currentTimeMillis() - this.jdField_a_of_type_Long);
    }
  }
