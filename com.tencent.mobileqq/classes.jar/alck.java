...
public class alck
{
  private static final String jdField_a_of_type_JavaLangString = anzj.a(2131704334);
  private int jdField_a_of_type_Int = -1;
  private alch jdField_a_of_type_Alch = alcj.a(jdField_a_of_type_JavaLangString);
  private AdapterView.OnItemClickListener jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new alcn(this);
  ...
  private IRedPacket.OnGetSkinListener jdField_a_of_type_ComTencentMobileqqActivityQwalletRedpacketIRedPacket$OnGetSkinListener = new alcm(this);
  private QwAdapter jdField_a_of_type_CooperationQwalletPluginQwAdapter;
  List<alcr> jdField_a_of_type_JavaUtilList = new ArrayList();
  private BusinessObserver jdField_a_of_type_MqqObserverBusinessObserver = new alcl(this);
  private boolean jdField_a_of_type_Boolean;
  private int jdField_b_of_type_Int = -1;
  private List<alch> jdField_b_of_type_JavaUtilList = new ArrayList();
  private boolean jdField_b_of_type_Boolean;
  private List<LinearLayout> c = new ArrayList();
  
  public alck(SendHbActivity paramSendHbActivity)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity = paramSendHbActivity;
    d();
  }
  
  private void a(List<alch> paramList)
  {
    paramList.add(alcj.b(jdField_a_of_type_JavaLangString));
    if ((b()) && (!paramList.contains(this.jdField_a_of_type_Alch)))
    {
      QLog.d("HbSkinLogic", 2, "add vip info to list!");
      paramList.add(this.jdField_a_of_type_Alch);
    }
  }
  
  private void b(List<alch> paramList)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      SkinInfo localSkinInfo = ((alch)paramList.next()).jdField_a_of_type_WalletSkinInfo;
      ...
      localRedPacketInfoBase.isCache = alch.jdField_a_of_type_Boolean;
  ...
  private boolean b()
  {
    if (this.jdField_a_of_type_Aoan != null) {
      return this.jdField_a_of_type_Aoan.a();
    }
    return false;
  }
  ...
  private void d()
  {
    ...
    a(localArrayList);
    this.jdField_a_of_type_CooperationQwalletPluginQwAdapter = new QwAdapter(this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity, localArrayList, 2131560486, new alcq(this));
    this.jdField_a_of_type_Aoan = ((aoan)this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity.getAppRuntime().getManager(131));
  ...
  public int a()
  {
    return alch.a(this.jdField_a_of_type_CooperationQwalletPluginQwAdapter.getList());
  }
  ...
  public void a(alcr paramalcr)
  {
    this.jdField_a_of_type_JavaUtilList.add(paramalcr);
  }
  ...
  public void a(LinearLayout paramLinearLayout)
  {
    ...
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-1, agej.a(226.0F, this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity.getResources()));
    ...
    localHorizontalListView.setDividerWidth(agej.a(12.0F, this.jdField_a_of_type_ComTencentMobileqqActivityQwalletSendHbActivity.getResources()));
  ...
  public void b()
  {
    ...
    if (-2 != i)
    {
      ...
      if (this.jdField_a_of_type_Aoan != null) {
        this.jdField_a_of_type_Aoan.a(0, 0, true);
      }
    }
  }
  ...
  public void c()
  {
    ...
    if (b()) {
      if (!localList.contains(this.jdField_a_of_type_Alch))
      {
        QLog.d("HbSkinLogic", 2, "add vip info to list!");
        localList.add(this.jdField_a_of_type_Alch);
        alch.c = this.jdField_a_of_type_Alch.jdField_a_of_type_WalletSkinInfo.skin_id;
        alch.a(localList);
        this.jdField_a_of_type_CooperationQwalletPluginQwAdapter.notifyDataSetChanged();
      }
    }
    while (!localList.contains(this.jdField_a_of_type_Alch)) {
      return;
    }
    QLog.d("HbSkinLogic", 2, "remove vip info to list!");
    localList.remove(this.jdField_a_of_type_Alch);
    alch.c = 0;
    alch.a(localList);
    this.jdField_a_of_type_CooperationQwalletPluginQwAdapter.notifyDataSetChanged();
  }
