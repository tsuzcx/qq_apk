  ...
  implements amkw
{
  ...
  private ancx jdField_a_of_type_Ancx;
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<Activity> jdField_a_of_type_JavaLangRefWeakReference;
  private HashMap<String, amnv> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public amqt(int paramInt, Activity paramActivity)
  {
    this.jdField_b_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_Anct = new anct(ampj.a(), paramActivity);
    this.jdField_a_of_type_Ancx = new ancx(paramActivity, ampj.a());
  ...
  private void a(long paramLong, int paramInt, amro paramamro)
  {
    ApolloCmdChannel localApolloCmdChannel = ampj.a();
    if (localApolloCmdChannel != null)
    {
      localApolloCmdChannel.callbackFromRequest(paramLong, paramInt, "cs.get_redPacket_result.local", paramamro.a());
      paramamro.jdField_b_of_type_Int = 0;
      paramamro.jdField_a_of_type_Boolean = false;
      return;
    }
    QLog.e("cmgame_process.CmGameSubProcessHandler", 1, "[notifyRedPacketResult] cmdChannel is null");
  }
  
  private void a(long paramLong, String paramString, aded paramaded)
  {
    if (paramaded == null) {
      return;
    }
    ...
    paramaded.a(str, null, new amqy(this, paramString, paramLong));
  }
  
  private void a(long paramLong, String paramString1, String paramString2)
  {
    Object localObject = ampj.a(this.jdField_d_of_type_Int);
    if (localObject == null) {
    ...
    ((ampm)localObject).a(paramLong, paramString1, paramString2);
  }
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_JavaUtilRegexPattern == null)
        {
          ...
          if (localObject != null)
          {
            localObject = ((amrt)localObject).a(this.jdField_d_of_type_Int);
            if (QLog.isColorLevel()) {
  ...
  {
    if ((!paramString1.startsWith("cs.")) && (!paramString1.endsWith(".local")) && (!amla.a(paramString1)) && (a(paramString1))) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          paramString2 = ampj.a(this.jdField_d_of_type_Int);
        ...
        if ("apollo_router_game.game_ad_linkcmd_get_ad".equals(paramString1))
        {
          ...
          ((amst)localObject2).a(paramString1, (String)localObject1, paramLong, 4, bool, paramString2);
          break;
  ...
  private byte[] a(String paramString)
  {
    ...
    try
    {
      ...
      localObject1 = acsa.a((Context)localObject1);
  ...
  private void c()
  {
    ...
    do
    {
      ...
      {
        return;
        Activity localActivity = ((amrk)localObject).a();
  ...
  private void d()
  {
    ...
    if (localActivity != null) {
      ampj.a(this.jdField_d_of_type_Int, localActivity);
    }
  }
  ...
  private void e(long paramLong, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ampj.a(ampj.a(), i, j, this.jdField_d_of_type_Int, k, paramString);
        i = 0;
      }
      catch (Exception paramString)
      {
  ...
  private void f(long paramLong, String paramString)
  {
    ...
    ((amsk)localObject).b(paramLong, paramString);
  }
  ...
  private void h(long paramLong, String paramString)
  {
    ...
    ((amsk)localObject).a(paramLong, paramString);
  }
  ...
  private void h(String paramString)
  {
    ...
    paramString = a();
    if (paramString != null) {
      aufz.a(paramString, localIntent, 20180427);
    }
  }
  ...
  private void i(long paramLong, String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
        localCmGameInitParams = ((amrk)localObject).a();
      } while (localCmGameInitParams == null);
      localObject = ((amrk)localObject).a(localCmGameInitParams.appId, ((amrk)localObject).a());
    } while (localObject == null);
    if (localCmGameInitParams.accessTokenRet != 1)
    {
      ...
      ((aded)localObject).a("login", null, new amqx(this, paramString, paramLong, (aded)localObject, localCmGameInitParams));
      return;
    }
    a(paramLong, paramString, (aded)localObject);
  }
  ...
  private void i(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        amrk localamrk = ampj.a(this.jdField_d_of_type_Int);
        if (localamrk != null)
        {
          localamrk.jdField_c_of_type_Int = 0;
          angn localangn2 = localamrk.a();
          angn localangn1;
          if ((localangn2 != null) && (localangn2.jdField_a_of_type_Long != 0L))
          {
            localangn1 = localangn2;
            if (localangn2.jdField_a_of_type_Int != 0) {}
          }
          else
          {
            localangn1 = this.jdField_a_of_type_Anct.a(paramString);
          }
          if (localangn1 != null)
          {
            this.jdField_a_of_type_Anct.a(localangn1);
            this.jdField_a_of_type_Anct.a(str);
            ThreadManager.getUIHandler().post(new CmGameSubProcessHandler.9(this));
            paramString = localamrk.a();
            if (paramString != null)
            {
  ...
  private void j(long paramLong, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((amro)localObject).jdField_d_of_type_Int = i;
        if ((((amro)localObject).jdField_a_of_type_Int <= 0) || (((amro)localObject).jdField_d_of_type_Int < ((amro)localObject).jdField_a_of_type_Int)) {
          break label345;
        }
        if (QLog.isColorLevel()) {
          QLog.d("cmgame_process.CmGameSubProcessHandler", 2, "[hanldeGetRedPacketResult] score:" + ((amro)localObject).jdField_d_of_type_Int + "info.grabState:" + ((amro)localObject).jdField_b_of_type_Int);
        }
        if (((amro)localObject).jdField_b_of_type_Int == 3)
        {
          a(paramLong, 0, (amro)localObject);
          if (!"0".equals(((amro)localObject).f)) {
            break label429;
          }
          akww.a(((amro)localObject).jdField_b_of_type_JavaLangString, ((amro)localObject).jdField_a_of_type_Long, ((amro)localObject).jdField_d_of_type_Int + "", Integer.parseInt(((amro)localObject).jdField_d_of_type_JavaLangString), bool1, false, this.jdField_d_of_type_Int);
          return;
        }
      }
      catch (Exception paramString)
      ...
      if (((amro)localObject).jdField_b_of_type_Int == 0)
      {
        if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
          akww.a(ampj.a(), ((amro)localObject).g + "", this.jdField_d_of_type_Int + "", i + "", new CmGameSubProcessHandler.4(this, null, paramLong));
        }
        ((amro)localObject).jdField_b_of_type_Int = 1;
        return;
      }
      ((amro)localObject).jdField_a_of_type_Boolean = true;
      return;
      label345:
      a(paramLong, 0, (amro)localObject);
      if ("0".equals(((amro)localObject).f)) {}
  ...
  private void j(String paramString)
  {
    ...
    try
    {
      localamrk = ampj.a(this.jdField_d_of_type_Int);
      if (localamrk == null) {
        return;
      }
      localangn = localamrk.a();
      paramString = new JSONObject(paramString);
    ...
    localangn.jdField_c_of_type_JavaLangString = paramString.optString("extendInfo");
    paramString = localamrk.a();
    if (paramString != null)
    {
      paramString.mRoomId = l;
      localangn.jdField_b_of_type_JavaLangString = paramString.mChineseName;
      localangn.jdField_b_of_type_Int = paramString.mActionId;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString != null)
        {
          ...
          {
            akww.a(ampj.a(), paramString.g + "", this.jdField_d_of_type_Int + "", i + "", new CmGameSubProcessHandler.5(this, null, paramLong));
  ...
  private void k(String paramString)
  {
    ...
    if (localAppInterface != null) {
      ancm.a(localAppInterface, paramString);
    }
  }
  ...
  private void l(long paramLong, String paramString)
  {
    ...
    if (localObject == null) {
      paramString = ampj.a((int)paramLong);
    }
    if (paramString != null)
    {
      ...
      if (localObject != null)
      {
        ...
        paramString.a("login", null, new amqw(this, (CmGameInitParams)localObject, paramLong));
      }
    }
    try
    {
  ...
  private void m(long paramLong, String paramString)
  {
    ...
    {
      ampj.a().callbackFromRequest(paramLong, 6, "cs.xy_device_vibrate.local", "{}");
      QLog.e("cmgame_process.CmGameSubProcessHandler", 1, paramString, new Object[0]);
    }
  }
  ...
  private void n(long paramLong, String paramString)
  {
    ...
    {
      ampj.a().callbackFromRequest(paramLong, 4, "cs.xy_device_gyro_sensor_start.local", "{}");
      QLog.e("cmgame_process.CmGameSubProcessHandler", 1, paramString, new Object[0]);
    }
  }
  ...
  public amlc a(long paramLong, String paramString1, String paramString2)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return null;
        } while ((localamrk == null) || (localamrk.a() == null));
        if (localamrk.a().getLuaState() == paramLong) {
          break;
        }
      ...
      {
        ancm.a(this.jdField_d_of_type_Int, paramString2, a());
        return null;
      }
  ...
  {
    paramString = amtj.a(paramString);
    amrk localamrk = ampj.a(this.jdField_d_of_type_Int);
    if ((paramString == null) || (localamrk == null))
    {
  ...
  public void a(long paramLong, String paramString, amkx paramamkx)
  {
    if ((this.jdField_b_of_type_JavaUtilHashMap != null) && (this.jdField_b_of_type_JavaUtilHashMap.containsKey(paramString))) {
      paramamkx.a((Bitmap)this.jdField_b_of_type_JavaUtilHashMap.get(paramString), 200);
    }
    for (;;)
    {
      return;
      ...
      {
        ThreadManagerV2.excute(new CmGameSubProcessHandler.10(this, ((amnv)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).jdField_a_of_type_JavaLangString, paramamkx, paramString), 128, null, true);
        return;
      }
      paramamkx = ampj.a();
      if (paramamkx != null)
      {
        Object localObject1 = ampj.a(this.jdField_d_of_type_Int);
        if (localObject1 == null)
        {
          QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[getUserInfo], launcher is null, mGameId:" + this.jdField_d_of_type_Int);
          return;
        }
        Object localObject2 = ((amrk)localObject1).a();
        try
        {
          ...
          paramamkx.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject1).toString(), paramLong, jdField_a_of_type_Int);
          if (QLog.isColorLevel())
          {
  ...
  public void a(long paramLong, String paramString, amky paramamky)
  {
    if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))) {
      paramamky.a(((amnv)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).jdField_b_of_type_JavaLangString);
    }
    for (;;)
    {
      return;
      ...
      if (paramamky != null)
      {
        ...
        try
        {
          ...
          ((JSONArray)localObject2).put(paramString);
          ((JSONObject)localObject1).put("uidList", localObject2);
          paramamky.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject1).toString(), paramLong, jdField_b_of_type_Int);
          if (QLog.isColorLevel())
          {
  ...
  public void a(amnv paramamnv)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap != null) {
      this.jdField_a_of_type_JavaUtilHashMap.put(paramamnv.jdField_c_of_type_JavaLangString, paramamnv);
    }
  }
  ...
  {
    int i = this.e;
    if (ancm.a(a(), paramString, this.jdField_d_of_type_Int, i)) {}
    try
    {
  ...
  public void b(String paramString)
  {
    try
    {
      ...
      paramString = ampj.a(this.jdField_d_of_type_Int);
      if (paramString != null) {
        paramString.a(i);
      }
      return;
  ...
  public void c(long paramLong, String paramString)
  {
    ...
    if (localamst != null)
    {
      localObject1 = ampj.a(this.jdField_d_of_type_Int);
      if (localObject1 == null) {
        QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[getUserInfo], launcher is null, mGameId:" + this.jdField_d_of_type_Int);
      }
    }
    ...
    Object localObject1 = ((amrk)localObject1).a();
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          localamst.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject2).toString(), paramLong, jdField_c_of_type_Int, false, null);
          return;
        }
      }
      catch (Exception paramString)
  ...
  {
    Object localObject2 = ampj.b(paramLong);
    Object localObject1 = localObject2;
    if (localObject2 == null) {
      localObject1 = ampj.a((int)paramLong);
    }
    if (localObject1 != null)
    {
      localObject2 = ((amrk)localObject1).a();
      if (localObject2 != null) {
        try
        {
          CmGameInitParams localCmGameInitParams = ((amrk)localObject1).a();
