  ...
  extends aafe
{
  ...
  public bbje(AppInterface paramAppInterface)
  {
  ...
  private boolean b(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (;;)
    {
      ...
      if ((localStatus == AppRuntime.Status.online) && (axvj.a(localSvcReqRegister.uExtOnlineStatus))) {
        localSvcReqRegister.iBatteryStatus = axuy.a(paramToServiceMsg.extraData.getInt("batteryCapacity", 0), paramToServiceMsg.extraData.getInt("powerConnect", -1));
      }
      try
      {
        for (;;)
