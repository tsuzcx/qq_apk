  ...
  implements View.OnClickListener
{
  ...
  private View.OnLongClickListener jdField_a_of_type_AndroidViewView$OnLongClickListener = new ayit(this);
  EditText jdField_a_of_type_AndroidWidgetEditText;
  ImageView jdField_a_of_type_AndroidWidgetImageView;
  LinearLayout jdField_a_of_type_AndroidWidgetLinearLayout;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  TextView jdField_a_of_type_AndroidWidgetTextView;
  private aqul jdField_a_of_type_Aqul = new ayil(this);
  ...
  private TransProcessorHandler jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new ayis(this);
  ...
  private aqul jdField_b_of_type_Aqul = new ayiu(this);
  ...
  public ayih(NearbyPeopleProfileActivity paramNearbyPeopleProfileActivity)
  {
    ...
    if (Build.VERSION.SDK_INT >= 11) {
      this.jdField_a_of_type_Ayiz = new ayiz(this, this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.f);
    }
  ...
  private RelativeLayout a(PicInfo paramPicInfo, Drawable paramDrawable)
  {
    ...
    localRelativeLayout.setBackgroundResource(2130845018);
    ...
    if (Build.VERSION.SDK_INT >= 11)
    {
      ...
      localRelativeLayout.setOnDragListener(this.jdField_a_of_type_Ayiz);
    }
  ...
  private String a()
  {
    ...
    {
      if (!bhbx.a(this.jdField_a_of_type_AndroidWidgetEditText.getText().toString(), this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.nickname)) {
  ...
  {
    if (paramBoolean) {}
    for (int j = 2131167020;; j = 2131167026)
    {
  ...
  private void a(TextView paramTextView, byte[] paramArrayOfByte)
  {
    ...
    label208:
    for (paramArrayOfByte = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Bbvn.a(localRichStatus.actionId, 200);; paramArrayOfByte = bgyo.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getResources(), 2130849591))
    {
  ...
  private void a(URLImageView paramURLImageView, PicInfo paramPicInfo, Drawable paramDrawable)
  {
    ...
    try
    {
      ...
      if ((paramPicInfo.c != null) && (paramPicInfo.c.length() > 0))
      {
        ...
        paramPicInfo.setDecodeHandler(bgxc.a);
  ...
  {
    RelativeLayout localRelativeLayout = new RelativeLayout(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
    localRelativeLayout.setBackgroundResource(2130841395);
    ...
    ((TextView)localObject).setText(anvx.a(2131706768));
  ...
  private boolean e()
  {
    ...
    if (!StringUtil.isEmpty(str))
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.b(anvx.a(2131706803));
        return false;
      }
    }
    else
    {
      this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.b(anvx.a(2131706727));
      return false;
    }
    return true;
  }
  ...
  private void k()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131706825));
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131706793));
    ...
    this.jdField_b_of_type_AndroidViewView.findViewById(2131369231).setVisibility(8);
    TextView localTextView = (TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131369233);
    localTextView.setVisibility(0);
    localTextView.setText(2131690697);
    localTextView.setOnClickListener(new ayim(this));
    localTextView = (TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131369262);
    localTextView.setVisibility(0);
    localTextView.setText(2131692403);
    localTextView.setEnabled(true);
    localTextView.setOnClickListener(new ayin(this));
    this.jdField_b_of_type_AndroidViewView.findViewById(2131376760).setOnClickListener(this);
  }
  ...
  private void l()
  {
    if (this.jdField_a_of_type_JavaUtilLinkedList.size() > 0)
    {
      localObject = new StringBuilder(anvx.a(2131706819));
  ...
  Intent a(String paramString)
  {
    ...
    localIntent.putExtra("PhotoConst.QZONE_COVER_CROP_LEFT_TITLE", anvx.a(2131706821));
  ...
  public void a(int paramInt)
  {
    ...
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X800481F", "0X800481F", 1, 0, "", "", "", "");
  }
  ...
  void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    j = paramInt2 + 1;
    int m = paramInt3 + 1;
    localObject1 = bhbx.a(paramInt2 + 1, paramInt3 + 1);
                    ...
                    if (paramIntent != null)
                    {
                      ...
                      if ((paramInt2 == -1) && (this.jdField_d_of_type_AndroidWidgetEditText != null))
                      {
                        ...
                        if (paramInt2 == -1)
                        {
                          ...
                          try
                          {
                            paramIntent = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Anrz.a((String[])localObject2);
                            if (paramIntent != null)
                            {
  ...
  protected void a(View paramView)
  {
    ...
    paramView.findViewById(2131379056).setVisibility(0);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131379098));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131379031));
    paramView.findViewById(2131369278).setVisibility(4);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131380934));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131373123));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131372671));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378219));
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131371981));
    this.jdField_b_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131367626));
    this.jdField_c_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131362305));
    this.jdField_b_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131363145));
    this.jdField_f_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131381632));
    this.jdField_a_of_type_ComTencentMobileqqWidgetBounceScrollView = ((BounceScrollView)this.jdField_b_of_type_AndroidViewView.findViewById(2131366006));
    this.jdField_a_of_type_ComTencentMobileqqWidgetBounceScrollView.mScrollFlag = 1;
    k();
    bgip.b("profile_edit", "exp", "", "", "", "");
  }
  ...
  public void a(NearbyPeopleCard paramNearbyPeopleCard)
  {
    ...
    {
      j = ((Integer)axqc.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1))).intValue();
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "dc00899", "grp_lbs", "", "data_card", "exp_edit", 0, 0, axql.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_j_of_type_Int), j + "", "", "");
      ...
      this.jdField_a_of_type_JavaLangString = anvx.a(2131706813);
      label318:
      if (!this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.godFlag) {
        break label857;
      }
      this.jdField_e_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694238));
    }
    for (;;)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetEditText.setText(bgzv.b(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.gender));
      ...
      int n = (0xFF00 & k) >> 8;
      int i1 = k & 0xFF;
      paramNearbyPeopleCard = bhbx.a(n, i1);
      ...
      this.jdField_b_of_type_AndroidViewView.findViewById(2131381633).setOnClickListener(this);
      this.jdField_f_of_type_AndroidWidgetEditText.setOnClickListener(this);
      this.jdField_b_of_type_AndroidViewView.findViewById(2131367629).setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetEditText.setOnClickListener(this);
      this.jdField_b_of_type_AndroidViewView.findViewById(2131362307).setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetEditText.setOnClickListener(this);
      this.jdField_b_of_type_AndroidViewView.findViewById(2131363161).setOnClickListener(this);
      this.jdField_b_of_type_ComTencentImageURLImageView.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new ayiy(this));
      this.jdField_f_of_type_AndroidWidgetEditText.addTextChangedListener(new ayij(this));
      this.jdField_a_of_type_AndroidWidgetEditText.getViewTreeObserver().addOnGlobalLayoutListener(new ayik(this));
      return;
      ...
      this.jdField_a_of_type_JavaLangString = anvx.a(2131706764);
      break label318;
      label857:
      if (this.jdField_a_of_type_JavaUtilArrayList.size() > NearbyPeopleProfileActivity.jdField_b_of_type_Int) {
        this.jdField_e_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694239, new Object[] { this.jdField_a_of_type_JavaLangString }));
      }
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (TextUtils.isEmpty(paramString))
    {
      ...
      if (paramInt != 0)
      {
        ...
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8006784", "0X8006784", 0, 0, "", "", "", "");
      }
    }
    else
    {
  ...
  public void c()
  {
    ...
    anrz localanrz = (anrz)this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getManager(QQManagerFactory.CONDITION_SEARCH_MANAGER);
    int j = localanrz.a();
    Object localObject1;
    if (j != 0)
    {
      j = localanrz.a(j, true);
      if (QLog.isColorLevel()) {
        QLog.d("Q.nearby_people_card.", 2, "startLocationSelectActivity | update result = " + j);
      }
      if (j == 2)
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, 2131694255, 0).b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getTitleBarHeight());
        return;
      }
      if (j == 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getResources().getString(2131691033));
        localanrz.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Ansd);
        return;
      }
      this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getResources().getString(2131691033));
    ...
    localIntent.putExtra("param_location_param", localanrz.b((String[])localObject1));
  ...
  public void d()
  {
    ...
    do
    {
      ...
      str = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Anrz.a(arrayOfString);
  ...
  void e()
  {
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004823", "0X8004823", 0, 0, "", "", "", "");
    bgip.b("profile_edit", "suc_edit", a(), "", "", "");
  ...
  void f()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.a(anvx.a(2131706805));
    ArrayList localArrayList = new ArrayList();
    localArrayList.addAll(this.jdField_a_of_type_JavaUtilArrayList);
    if (c())
    {
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 10, 0, "", "", "", "");
    ...
    for (int j = 1;; j = 3)
    {
      ...
      {
        localObject = "1";
        bdla.b(null, "dc00899", "grp_lbs", "", "data_card", "upload_video", 0, 0, "", (String)localObject, "", String.valueOf(j));
        j = ((Integer)axqc.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1))).intValue();
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "dc00899", "grp_lbs", "", "data_card", "suc_edit", 0, 0, axql.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_j_of_type_Int), j + "", "", "");
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null)
        {
          ...
          if (!Arrays.equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.xuanYan, (byte[])this.jdField_f_of_type_AndroidWidgetEditText.getTag()))
          {
            ...
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 2, 0, "", "", "", "");
          }
          ...
          if (!((String)localObject).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.nickname))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_d_of_type_Boolean = true;
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 1, 0, "", "", "", "");
          }
          ...
          if (b1 != this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.gender)
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_d_of_type_Boolean = true;
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 4, 0, "", "", "", "");
          }
          ...
          if (j != this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.birthday)
          {
            ...
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 5, 0, "", "", "", "");
          }
        }
        localObject = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Axqt;
        if (localObject == null) {
          break label679;
        }
        this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.execute(new NearbyProfileEditTribePanel.17(this, (axqt)localObject, localBundle, localArrayList));
      }
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject2;
    int k;
    if ((paramView.getId() == 2131367629) || (paramView == this.jdField_b_of_type_AndroidWidgetEditText))
    {
      localObject1 = bkzi.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
      localObject2 = (DispatchActionMoveScrollView)((bkzi)localObject1).findViewById(2131361981);
      ...
      localObject2 = (IphonePickerView)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity).inflate(2131561188, null);
      ((IphonePickerView)localObject2).a(this.jdField_b_of_type_Aqul);
      if (this.jdField_b_of_type_AndroidWidgetEditText.getTag() != null)
      {
        ...
        ((IphonePickerView)localObject2).setPickListener(new ayii(this, (IphonePickerView)localObject2, (bkzi)localObject1));
        ((bkzi)localObject1).a(new ayiv(this));
        ((bkzi)localObject1).a((View)localObject2, null);
        ((bkzi)localObject1).show();
        a(paramView, ((bkzi)localObject1).a());
    ...
    do
    {
      for (;;)
      {
        ...
        return;
        if ((paramView.getId() == 2131369616) || (paramView == this.jdField_d_of_type_AndroidWidgetEditText))
        {
          g();
        }
        else if (paramView == this.jdField_b_of_type_AndroidWidgetLinearLayout)
        {
          ...
          localObject1 = bkyp.a(bkyp.a(bkyp.a(bkyp.a("https://qun.qq.com/qqweb/m/nearby/pages/school_edit.html", "_bid", "2473"), "_wv", "1031"), "schoolName", (String)localObject1), "isValid", String.valueOf(this.i));
        ...
        else if ((paramView.getId() == 2131368261) || (paramView == this.jdField_e_of_type_AndroidWidgetEditText))
        {
          c();
        }
        else
        {
          if ((paramView.getId() != 2131381633) && (paramView != this.jdField_f_of_type_AndroidWidgetEditText)) {
            break;
          }
          h();
        }
      }
      if ((paramView.getId() != 2131362307) && (paramView != this.jdField_c_of_type_AndroidWidgetEditText)) {
        break;
      }
      localObject1 = bkzi.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
      localObject2 = Calendar.getInstance();
      this.jdField_b_of_type_Int = ((Calendar)localObject2).get(1);
      localObject3 = (DispatchActionMoveScrollView)((bkzi)localObject1).findViewById(2131361981);
      ...
      localObject3 = (IphonePickerView)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity).inflate(2131561188, null);
      ((IphonePickerView)localObject3).a(this.jdField_a_of_type_Aqul);
    ...
    for (j = 0;; j = (j & 0xFF) - 1)
    {
      ...
      ((IphonePickerView)localObject3).setPickListener(new ayiw(this, (IphonePickerView)localObject3, (bkzi)localObject1));
      ...
      ((bkzi)localObject1).a(new ayix(this));
      ((bkzi)localObject1).a((View)localObject3, null);
      ((bkzi)localObject1).show();
      a(paramView, ((bkzi)localObject1).a());
    ...
    {
      if (axqn.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app)) {
        break label882;
      }
      ...
      {
        axqn.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, null, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.videoInfo.jdField_d_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.videoInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.uin, this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.e, true);
        j = 1;
      }
    }
    for (;;)
    {
      axqn.a("clk_video_entry", new String[] { "" + j, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.uin, "1" });
      break;
      axqn.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, 2);
      j = 2;
      continue;
      if (((paramView.getId() != 2131363161) && (paramView != this.jdField_b_of_type_ComTencentImageURLImageView)) || (this.jdField_a_of_type_JavaUtilArrayList == null)) {
        break;
      }
