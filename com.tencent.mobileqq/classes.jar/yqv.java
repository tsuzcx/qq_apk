...
{
  public yqv(EditUniqueTitleActivity paramEditUniqueTitleActivity) {}
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    for (paramEditable = this.a.getResources().getColorStateList(2131167037);; paramEditable = this.a.getResources().getColorStateList(2131166983))
    {
      ...
      this.a.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(String.format(this.a.getString(2131696619), new Object[] { Integer.valueOf(i) }));
      return;
