...
{
  public aftc(ScanTorchActivity paramScanTorchActivity, int paramInt, boolean paramBoolean1, boolean paramBoolean2, long paramLong, boolean paramBoolean3, boolean paramBoolean4, String paramString)
  {
  ...
  public void a(int paramInt, SosoInterface.SosoLbsInfo paramSosoLbsInfo)
  {
    ...
    {
      QQToast.a(this.a.getApplicationContext(), 2131437295, 1).b(this.a.getTitleBarHeight());
      ScanTorchActivity.a(this.a, ScanTorchActivity.a(this.a), false);
      return;
    }
    if (paramInt != 0)
    {
      this.a.runOnUiThread(new aftd(this));
      ScanTorchActivity.a(this.a, ScanTorchActivity.a(this.a), false);
      return;
    }
    if ((paramSosoLbsInfo != null) && (paramSosoLbsInfo.a != null))
    {
      ...
      if (paramSosoLbsInfo != null)
      {
        ...
        paramSosoLbsInfo.a(ScanTorchActivity.b(this.a), d1, d2, 0, 2, 10);
        return;
      }
      ScanTorchActivity.a(this.a, ScanTorchActivity.a(this.a), false);
      return;
