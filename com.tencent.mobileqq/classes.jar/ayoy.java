  ...
  extends aynq
{
  ...
  public ayoy(QQAppInterface paramQQAppInterface, PublicAccountInfo paramPublicAccountInfo, int paramInt)
  {
  ...
  protected long a(String paramString)
  {
    ...
    long l2 = ayvm.b(paramString, this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name, 1073741824L);
    long l1 = l2;
  ...
  public void a(View paramView)
  {
    ...
    do
    {
      ...
      {
        ayvm.a("all_result", "clk_public_uin", new String[] { "" + this.jdField_a_of_type_JavaLangString });
        aysc.a(null, 0, this.c, "0X8009D51", 0, 0, this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin(), null);
      }
      str = this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin();
      bdiu.a(null, "pubAcc_aio_open", str);
      localObject1 = (alzl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56);
      if (!alof.aQ.equals(str)) {
        break;
      }
      tch.a((Context)localObject2, "from_search_result", 1, true);
      ayvm.a(this.jdField_a_of_type_JavaLangString, 50, 0, paramView, str, this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.isOffLine, this.c);
      amcg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
      ayvm.a(this.jdField_a_of_type_JavaLangString, 50, paramView, false);
    ...
    if ((localObject2 instanceof UniteSearchActivity))
    {
      ...
      azqs.b((QQAppInterface)localObject2, "CliOper", "", "", (String)localObject1, (String)localObject1, 0, 1, 0, this.jdField_a_of_type_Int + "", "", str, this.jdField_a_of_type_JavaLangString);
      label285:
      paramView = nru.a();
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (("2747277822".equals(str)) && (asnk.a()))
      {
      ...
      {
        nur.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Context)localObject2, str, ((Context)localObject2).getResources().getString(2131692016));
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a("3046055438", 1008, false);
        break label133;
      }
      if (((localObject1 != null) && (((alzl)localObject1).a(Long.valueOf(str)))) || ((localObject1 == null) && (syb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str))))
      {
        ...
        ((alzl)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo);
        break label133;
      }
      if (TextUtils.isEmpty(str))
      {
  ...
  {
    SpannableString localSpannableString = new ayvb(new ArrayList(), a()).a(ayvm.a(this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.summary));
