...
public class bdvz
  implements bdhd
{
  public bdvz(MiniAppTextArea paramMiniAppTextArea) {}
  ...
  public void onSoftKeyboardOpened(int paramInt)
  {
    ...
    try
    {
      ...
      if (MiniAppTextArea.a(this.a) != null)
      {
        ...
        if ((bdyn.a((Context)localObject)) && (bdyn.a((Activity)localObject)))
        {
          localMiniAppTextArea = this.a;
          paramInt = MiniAppTextArea.b(this.a);
          MiniAppTextArea.a(localMiniAppTextArea, bdyn.c((Context)localObject) + paramInt);
        }
      ...
      {
        ((JSONObject)localObject).put("height", (int)((paramInt + i) / bdyn.a(this.a.getContext()) + 0.5F));
