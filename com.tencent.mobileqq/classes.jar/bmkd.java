...
public class bmkd
  implements Observer
{
  private ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new bmkj(this);
  ...
  public bmkd(QQAppInterface paramQQAppInterface)
  {
  ...
  private Bundle a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Bmkk == null)
      {
      ...
      try
      {
        ...
        paramBundle = this.jdField_a_of_type_Bmkk.a("com.qqdataline.action.notify", paramBundle);
        if (paramBundle != null) {
          paramBundle.setClassLoader(getClass().getClassLoader());
        }
        return paramBundle;
  ...
  private void a(Bundle paramBundle, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Bmkk.a("com.qqdataline.action.notify", paramBundle);
        return;
      }
      catch (Exception paramBundle)
      {
  ...
  private Bundle b(Bundle paramBundle)
  {
    ...
    if (((String)localObject2).equals("DatalineHandler_sendC2CMessage_ToService"))
    {
      ...
      paramBundle.putParcelable("ToServiceMsg", ((anvu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8)).a(l1, (String)localObject1, i, j, k, (byte[])localObject2, l2));
    }
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            {
              ((anvu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8)).sendPbReq((ToServiceMsg)paramBundle.getParcelable("ToServiceMsg"));
              return null;
            }
          ...
          localObject2 = ((apav)localObject2).a();
          paramBundle = (Bundle)localObject1;
      ...
      if (((String)localObject2).equals("DatalineHandler_saveFileManagerEntity"))
      {
        ...
        paramBundle = aunj.a((String)localObject1);
        ...
        localFileManagerEntity.fileSize = aunj.a((String)localObject1);
        localFileManagerEntity.isReaded = true;
        localFileManagerEntity.peerUin = ((String)localObject2);
        if (l1 == 0L) {}
        for (localFileManagerEntity.peerNick = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131693921);; localFileManagerEntity.peerNick = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131693923))
        {
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Bmkk == null) && (!this.jdField_a_of_type_Boolean))
    {
  ...
  private void d()
  {
    ...
    {
      CheckPermission.requestSDCardPermission(BaseActivity.sTopActivity, new bmkf(this));
      return;
    }
    f();
  }
  ...
  private void f()
  {
    a(0);
    this.b = false;
    this.jdField_a_of_type_Bhpc = bhlq.a(BaseActivity.sTopActivity, 230, anzj.a(2131701665), anzj.a(2131701669), 2131693994, 2131719410, new bmkg(this), new bmkh(this));
    this.jdField_a_of_type_Bhpc.setOnDismissListener(new bmki(this));
    TextView localTextView = (TextView)this.jdField_a_of_type_Bhpc.findViewById(2131365519);
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-2, -2);
    localLayoutParams.gravity = 17;
    localTextView.setLayoutParams(localLayoutParams);
    localTextView.setMinHeight(bhgr.a(BaseActivity.sTopActivity, 35.0F));
    ...
    for (;;)
    {
      ...
      while (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
      {
        ...
        try
        {
          ...
          localObject1 = localObject2;
          this.jdField_a_of_type_Bmkk.a("com.qqdataline.action.notify", localBundle);
          localObject1 = localObject2;
          if (!QLog.isColorLevel()) {
            continue;
          }
  ...
  private void i()
  {
    ...
    localPluginCommunicationHandler.register(new bmke(this, "dataline.remotecall"));
  }
  ...
  private void k()
  {
    ...
    bmkb.a(BaseActivity.sTopActivity, (Bundle)localObject, "com.qqdataline.activity.LiteWifiphotoActivity");
  ...
  public bmkc a()
  {
    ...
    bmkc localbmkc = new bmkc();
    localbmkc.jdField_a_of_type_JavaLangString = localBundle.getString("ServerInfo.serverIp");
    localbmkc.jdField_a_of_type_Int = localBundle.getInt("ServerInfo.serverPort");
    return localbmkc;
  }
  ...
  {
    FileManagerEntity localFileManagerEntity = aunj.a(paramMpfileTaskInfo, paramLong);
