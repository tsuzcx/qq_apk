...
public class acsp
{
  ...
  /* Error */
  public static acsj a(java.lang.String paramString)
  {
    // Byte code:
    //   0: aload_0
    ...
    //   212: aload 9
    //   214: iconst_0
    //   215: invokestatic 129	acsp:a	([BI)I
    //   218: istore_3
    //   219: iload_3
    //   220: ifle +10 -> 230
    //   223: iload_3
    ...
    //   555: new 149	acsj
    //   558: dup
    //   559: invokespecial 150	acsj:<init>	()V
    //   562: astore_0
    //   563: aload 7
    //   565: astore 6
    //   567: aload_0
    //   568: aload 8
    //   570: invokestatic 153	acsp:a	(Lacsj;Lmsg/aio_doodle/DoodleMsgProto$DoodleHeader;)V
    //   573: aconst_null
    //   574: astore 8
    //   576: iconst_m1
    //   577: istore_3
    ...
    //   597: aload 9
    //   599: iconst_0
    //   600: invokestatic 129	acsp:a	([BI)I
    //   603: istore 4
    //   605: iload 4
    //   607: ifle +11 -> 618
    //   610: iload 4
    ...
    //   670: iconst_1
    //   671: iconst_0
    //   672: invokevirtual 158	acsj:a	(Lactt;ZZ)V
    //   675: aload 7
    //   677: astore 6
    //   679: aload 7
    ...
    //   713: ifnull -703 -> 10
    //   716: aload_0
    //   717: invokevirtual 163	acsj:a	()Lactc;
    //   720: invokevirtual 168	actc:d	()F
    //   723: fstore_1
    //   724: aload_0
    //   725: invokevirtual 163	acsj:a	()Lactc;
    //   728: invokevirtual 171	actc:c	()F
    //   731: fstore_2
    //   732: fload_1
    //   733: fload_2
    //   734: fcmpl
    //   735: ifle +19 -> 754
    //   738: aload_0
    //   739: invokevirtual 163	acsj:a	()Lactc;
    //   742: fload_1
    //   743: invokevirtual 174	actc:c	(F)V
    //   746: aload_0
    //   747: invokevirtual 163	acsj:a	()Lactc;
    //   750: fload_2
    //   751: invokevirtual 176	actc:d	(F)V
    //   754: aload_0
    //   755: invokestatic 179	acsp:a	(Lacsj;)V
    //   758: aload_0
    //   759: areturn
    //   760: aload 7
    //   762: astore 6
    ...
    //   989: astore 6
    //   991: aload 10
    //   993: invokestatic 188	acsp:a	(Lmsg/aio_doodle/DoodleMsgProto$DoodleData;)I
    //   996: istore 4
    //   998: aload 7
    //   1000: astore 6
    //   1002: ldc 76
    ...
    //   1159: aload 10
    //   1161: iload 5
    //   1163: invokestatic 197	acsp:a	(Lactt;Lmsg/aio_doodle/DoodleMsgProto$DoodleData;Z)V
    //   1166: goto -588 -> 578
    //   1169: aload 8
    //   1171: ifnull +15 -> 1186
    //   1174: aload 7
    ...
    //   1181: iconst_1
    //   1182: iconst_0
    //   1183: invokevirtual 158	acsj:a	(Lactt;ZZ)V
    //   1186: aload 7
    //   1188: astore 6
    //   1190: new 199	actt
    //   1193: dup
    //   1194: invokespecial 200	actt:<init>	()V
    //   1197: astore 8
    //   1199: aload 7
    //   1201: astore 6
    //   1203: aload 8
    //   1205: iload 4
    //   1207: putfield 203	actt:a	I
    //   1210: iconst_1
    //   1211: istore 5
    //   1213: iload 4
    //   1215: istore_3
  ...
  private static DoodleMsgProto.DoodleData a(int paramInt, actt paramactt)
  {
  ...
  private static void a(acsj paramacsj)
  {
    if (paramacsj == null) {}
    ...
    {
      return;
      Iterator localIterator1 = paramacsj.a().iterator();
      while (localIterator1.hasNext())
      {
        actt localactt = (actt)localIterator1.next();
        if (localactt.c() >= 500)
        {
          if (QLog.isColorLevel()) {
            QLog.d("DoodleMsgTranslator", 2, "reduce point before:" + localactt.c());
          }
          paramacsj = null;
          localIterator2 = localactt.a().iterator();
          if (localIterator2.hasNext())
          {
            localactu = (actu)localIterator2.next();
            if (localIterator2.hasNext()) {
              break label157;
            }
          }
          if (QLog.isColorLevel()) {
            QLog.d("DoodleMsgTranslator", 2, "reduce point end:" + localactt.c());
          }
        }
      }
    }
    ...
    {
      break;
      if ((Math.abs(localactu.a() - paramacsj.a()) < 10.0F) && (Math.abs(localactu.b() - paramacsj.b()) < 10.0F)) {
        localIterator2.remove();
      }
    }
  }
  
  private static void a(acsj paramacsj, DoodleMsgProto.DoodleHeader paramDoodleHeader)
  {
    if ((paramacsj == null) || (paramDoodleHeader == null)) {}
    do
    {
      return;
      BaseApplication localBaseApplication = BaseApplicationImpl.getContext();
      if ((paramDoodleHeader.float_draw_area_width.has()) && (paramDoodleHeader.float_draw_area_height.has())) {
        paramacsj.a().a((int)mjg.a(localBaseApplication, paramDoodleHeader.float_draw_area_width.get()), (int)mjg.a(localBaseApplication, paramDoodleHeader.float_draw_area_height.get()));
      }
      if (paramDoodleHeader.float_line_width_max.has()) {
        paramacsj.a().a(mjg.a(localBaseApplication, paramDoodleHeader.float_line_width_max.get()));
      }
      if (paramDoodleHeader.float_line_width_min.has()) {
        paramacsj.a().b(mjg.a(localBaseApplication, paramDoodleHeader.float_line_width_min.get()));
      }
      if (paramDoodleHeader.float_comp_factor_max.has()) {
        paramacsj.a().c(paramDoodleHeader.float_comp_factor_max.get());
      }
      if (paramDoodleHeader.float_comp_factor_min.has()) {
        paramacsj.a().d(paramDoodleHeader.float_comp_factor_min.get());
      }
    } while (!paramDoodleHeader.uint32_time.has());
    paramacsj.a(paramDoodleHeader.uint32_time.get());
  }
  
  private static void a(actt paramactt, DoodleMsgProto.DoodleData paramDoodleData, boolean paramBoolean)
  {
    if ((paramactt == null) || (paramDoodleData == null)) {}
    for (;;)
    {
      return;
      if (paramBoolean)
      {
        if (paramDoodleData.uint32_rgba.has()) {
          paramactt.b(paramDoodleData.uint32_rgba.get());
        }
        if (paramDoodleData.uint32template_id.has())
        {
          paramactt.a(paramDoodleData.uint32template_id.get());
          if (paramactt.a() > 0) {
            paramactt.b(-1);
          }
        }
        ...
        if (paramDoodleData != null)
        {
          ...
          while (paramDoodleData.hasNext())
          {
            ...
            if ((localLineData.float_X.has()) && (localLineData.float_Y.has()) && (localLineData.uint64_tickcount.has())) {
              paramactt.a(mjg.a(localBaseApplication, localLineData.float_X.get()), mjg.a(localBaseApplication, localLineData.float_Y.get()), -1.0F, localLineData.uint64_tickcount.get());
            }
          }
        }
      }
  ...
  private static boolean a(int paramInt, actt paramactt, acsq paramacsq)
  {
    QLog.d("DoodleMsgTranslator", 2, "formatHeader line begin :" + paramInt);
    boolean bool;
    if ((paramacsq == null) || (paramactt == null))
    {
      bool = false;
      return bool;
    }
    ...
    for (int i = localArrayList.size();; i = 0)
    {
      ...
      bool = true;
      int j = 0;
      DoodleMsgProto.DoodleData localDoodleData = a(paramInt, paramactt);
      if (localDoodleData == null)
      {
        if (paramacsq == null) {
          break;
        }
        return paramacsq.a(null);
      }
      int k = 0;
      while ((k + j < i) && (k < 1000))
      {
        DoodleMsgProto.LineData localLineData = new DoodleMsgProto.LineData();
        actu localactu = (actu)localArrayList.get(j + k);
        localLineData.float_X.set(a(localBaseApplication, localactu.a()));
        localLineData.float_X.setHasFlag(true);
        localLineData.float_Y.set(a(localBaseApplication, localactu.b()));
        localLineData.float_Y.setHasFlag(true);
        localLineData.uint64_tickcount.set(localactu.a());
      ...
      if (paramacsq != null) {
        if ((paramacsq.a(localDoodleData)) && (bool)) {
          bool = true;
        }
      }
      for (;;)
  ...
  public static boolean a(acsj paramacsj, acsq paramacsq)
  {
    if ((paramacsj == null) || (paramacsq == null)) {}
    do
    {
      do
      {
        return false;
      } while (paramacsj.a() == null);
      try
      {
        boolean bool1 = b(paramacsj, paramacsq);
        paramacsj = paramacsj.a().iterator();
        int i = 0;
        if (paramacsj.hasNext())
        {
          boolean bool2 = a(i, (actt)paramacsj.next(), paramacsq);
          if ((bool2) && (bool1)) {}
      ...
      catch (Exception paramacsj)
      {
        paramacsj.printStackTrace();
      }
    } while (!QLog.isColorLevel());
    QLog.e("DoodleMsgTranslator", 2, "translate data exception:" + paramacsj);
    return false;
  }
  ...
  public static boolean b(acsj paramacsj, acsq paramacsq)
  {
    boolean bool = false;
    if (paramacsj == null)
    {
      if (paramacsq != null) {
        bool = paramacsq.a(null);
      }
      return bool;
    }
    BaseApplication localBaseApplication = BaseApplicationImpl.getContext();
    ...
    localDoodleHeader.uint32_time.set((int)paramacsj.a());
    localDoodleHeader.uint32_time.setHasFlag(true);
    ArrayList localArrayList = paramacsj.a();
    if (localArrayList != null) {}
    for (int i = localArrayList.size();; i = 0)
    {
      paramacsj = paramacsj.a();
      localDoodleHeader.uint32_line_count.set(i);
      localDoodleHeader.uint32_line_count.setHasFlag(true);
      localDoodleHeader.float_line_width_max.set(a(localBaseApplication, paramacsj.a()));
      localDoodleHeader.float_line_width_max.setHasFlag(true);
      localDoodleHeader.float_line_width_min.set(a(localBaseApplication, paramacsj.b()));
      localDoodleHeader.float_line_width_min.setHasFlag(true);
      localDoodleHeader.float_comp_factor_max.set(paramacsj.c());
      localDoodleHeader.float_comp_factor_max.setHasFlag(true);
      localDoodleHeader.float_comp_factor_min.set(paramacsj.d());
      localDoodleHeader.float_comp_factor_min.setHasFlag(true);
      localDoodleHeader.float_draw_area_width.set(a(localBaseApplication, paramacsj.a().width()));
      localDoodleHeader.float_draw_area_width.setHasFlag(true);
      localDoodleHeader.float_draw_area_height.set(a(localBaseApplication, paramacsj.a().height()));
      localDoodleHeader.float_draw_area_height.setHasFlag(true);
      if (paramacsq == null) {
        break;
      }
      return paramacsq.a(localDoodleHeader);
    }
  }
}
