...
public class aiix
  extends ajxj
{
  public aiix(QQSpecialFriendSettingActivity paramQQSpecialFriendSettingActivity) {}
  ...
  protected void onSetSpecialCareSwitchesOfAPerson(boolean paramBoolean, Object[] paramArrayOfObject)
  {
    ...
    label233:
    for (int i = 2131692215;; i = 2131699491)
    {
      paramArrayOfObject.arg2 = i;
      this.a.a.sendMessage(paramArrayOfObject);
      if ((!paramBoolean) || (j != 0)) {
      ...
      paramArrayOfObject.putExtra("selfSet_leftViewText", this.a.getString(2131695533));
