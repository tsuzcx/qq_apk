...
public class aiix
{
  public static volatile aiiw a;
  
  /* Error */
  public static aiiw a(android.content.Context paramContext, String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   89: ifnull +10 -> 99
    //   92: aload_0
    //   93: invokestatic 55	aiix:a	(Lorg/json/JSONObject;)Laiiw;
    //   96: putstatic 11	aiix:a	Laiiw;
    //   99: getstatic 11	aiix:a	Laiiw;
    //   102: astore_3
    //   103: goto -80 -> 23
    //   106: astore_0
    //   107: ldc 57
  ...
  /* Error */
  public static aiiw a(JSONObject paramJSONObject)
  {
    // Byte code:
    //   0: iconst_1
    //   1: istore_3
    ...
    //   85: invokestatic 102	aiix:a	(Lorg/json/JSONObject;)Laijc;
    //   88: astore 7
    //   90: aload 7
    //   92: ifnull +13 -> 105
    //   95: aload 6
    ...
    //   122: iload_1
    //   123: aload 6
    //   125: invokespecial 113	aiiw:<init>	(ZILjava/util/List;)V
    //   128: areturn
    //   129: astore 5
    //   131: iconst_0
    //   132: istore_1
    ...
    try
    {
      ...
      if (paramJSONObject.has("emos"))
      {
        ...
        while (i < localJSONArray.length())
        {
          ...
          localaija.jdField_a_of_type_JavaLangString = str1;
          localaija.jdField_b_of_type_JavaLangString = str2;
          localaija.jdField_a_of_type_Long = Long.valueOf(l).longValue();
          localaija.jdField_a_of_type_Int = j;
          localaija.jdField_b_of_type_Int = k;
          localaija.c = str3;
          localaija.d = ((String)localObject);
          localArrayList2.add(localaija);
          i += 1;
        }
      }
      return new aijc(localArrayList1, localArrayList2);
    }
  ...
  public static void a(android.content.Context paramContext, String paramString, JSONObject paramJSONObject)
  {
    ...
    //   46: ifnull +59 -> 105
    //   49: aload_2
    //   50: invokestatic 55	aiix:a	(Lorg/json/JSONObject;)Laiiw;
    //   53: putstatic 11	aiix:a	Laiiw;
    //   56: aload_0
    //   57: ifnull +48 -> 105
    //   60: aload_0
    //   61: ldc 13
