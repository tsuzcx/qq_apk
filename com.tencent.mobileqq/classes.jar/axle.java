...
public class axle
{
  private static axle jdField_a_of_type_Axle;
  private int jdField_a_of_type_Int = -1;
  
  public static axle a()
  {
    if (jdField_a_of_type_Axle == null) {
      jdField_a_of_type_Axle = new axle();
    }
    return jdField_a_of_type_Axle;
  }
  ...
  public void a(BoyDataReport paramBoyDataReport)
  {
    ...
    while (paramBoyDataReport.hasNext())
    {
      ...
      {
        localObject2 = (axlf)localHashMap.get(((BoyDataReport.BoyItem)localObject1).mId);
        ((axlf)localObject2).b();
      ...
      else
      {
        ...
        for (int i = 1;; i = 0)
        {
          localObject2 = new axlf(this, (String)localObject2, 1, i);
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      paramBoyDataReport.put(localObject2, String.valueOf(((axlf)localHashMap.get(localObject2)).a()));
    }
    azmz.a(BaseApplicationImpl.getContext()).a(null, "dg_action_match", true, 0L, 0L, paramBoyDataReport, "");
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_Int == 0)
    {
      ...
      localazmz = azmz.a(BaseApplicationImpl.getContext());
    ...
    {
      localazmz.a(null, "dg_entrance_state", bool, 0L, 0L, (HashMap)localObject, "");
