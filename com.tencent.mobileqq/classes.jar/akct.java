...
public class akct
{
  ...
  private ajuv jdField_a_of_type_Ajuv = new akcu(this);
  ...
  public akct(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a()
  {
    ...
    if (aksz.a((ProxyManager)localObject2, "mr_dataline_printer")) {
      ((ProxyManager)localObject2).a((aukn)localObject1);
    }
    long l = 2147483647L;
    if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0) {
      l = ((PrinterItemMsgRecord)this.jdField_a_of_type_JavaUtilArrayList.get(0)).msgId;
    }
    localObject2 = ((aukn)localObject1).a(PrinterItemMsgRecord.class, "select * from mr_dataline_printer where msgid<? order by msgid desc limit 5", new String[] { String.valueOf(l) });
    ((aukn)localObject1).a();
  ...
  {
    if (!ajuo.a(paramSession, "printer")) {}
    Object localObject;
    do
    {
      do
      {
        ...
        ((PrinterItemMsgRecord)localObject).time = awzw.a();
  ...
  public void a(ajuo paramajuo)
  {
    Object localObject = (akfm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(10);
    if ((((akfm)localObject).a() == 0) || (((akfm)localObject).e() != 1))
    {
      paramajuo.a(12, false, null);
      if (this.jdField_a_of_type_JavaUtilHashMap.size() > 0)
      {
        localObject = new Timer();
        ((Timer)localObject).schedule(new PrinterHandler.1(this, paramajuo, (Timer)localObject), 5000L);
      }
    }
  }
  
  public void a(ajuo paramajuo, msg_comm.Msg paramMsg, C2CType0x211_SubC2CType0x9.MsgBody paramMsgBody)
  {
    boolean bool = false;
    int j;
    int i;
    ...
    case 2: 
      do
      {
        ...
        paramMsg = (akcw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(74);
        paramMsg.a(false);
      ...
      if ((((akfm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(10)).a() != 0) && (this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0)) {
        paramMsg.a(true);
      }
      paramajuo.a(12, false, null);
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004022", "0X8004022", 0, 0, "", "", "", "");
      return;
    case 3: 
      j = -1;
    ...
    for (;;)
    {
      ...
      paramajuo.a(18, bool, Long.valueOf(l));
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004021", "0X8004021", (int)l, i, "", "", "", "");
      return;
      ...
      else
      {
        ...
        paramajuo.notifyUI(19, true, new Object[] { Long.valueOf(paramMsg.uint64_printer_din.get()), paramMsg.str_printer_qr_pic_url.get(), paramMsg.str_printer_qr_open_url.get(), paramMsg.str_printer_tip_url.get() });
        return;
      }
      label579:
      l = 0L;
  ...
  public void a(BaseActivity paramBaseActivity, String paramString)
  {
    if (apue.a())
    {
      if (bbdj.a(paramString) > apee.a())
      {
        aptr.a(paramBaseActivity, 2131692672, 2131692677, new akcv(this, paramBaseActivity, paramString));
        return;
      }
      ...
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004059", "0X8004059", 0, 0, "", "", "", "");
      return;
    }
  ...
  public void a(PrinterItemMsgRecord paramPrinterItemMsgRecord)
  {
    ...
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004021", "0X8004021", (int)paramPrinterItemMsgRecord.uSessionID, -2, "", "", "", "");
  ...
  public String[] a()
  {
    if ((((akcw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(74)).a()) && (this.b != null))
    {
