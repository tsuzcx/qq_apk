  ...
  implements Handler.Callback, Manager
{
  ...
  private bkys jdField_a_of_type_Bkys = new bkys(ThreadManagerV2.getSubThreadLooper(), this);
  ...
  public awtm(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    localbdkv.e = paramString4;
    localbdkv.d = paramString5;
    localbdkv.f = paramString1;
    localbdkv.i = paramString2;
    bdku.a(paramString3, localbdkv);
    bdku.a(paramQQAppInterface, localbdkv);
  }
  ...
  private boolean a(SubMsgType0x27.PushPlatform paramPushPlatform, Bundle paramBundle, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = (ajmy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.CTENTRY_MNG);
      if (localObject != null)
      {
        bool2 = ((ajmy)localObject).b();
        bool1 = bool2;
        if (bool2)
        {
          bool1 = bool2;
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bkys.sendEmptyMessageDelayed(1, 30000L);
  }
  ...
  public void a(long paramLong, String arg3, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, String paramString5, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        boolean bool = bhgy.a(paramString2);
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundPause) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundStop) || (bool))
        {
          ...
          synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
          {
            ...
            if (bool)
            {
              ??? = (awto)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.QQLS_DATA_MANAGER);
              if (SettingCloneUtil.readValue(paramString2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString2.getString(2131693714), "qqsetting_lock_screen_whenexit_key", true))
              {
                if (QLog.isColorLevel()) {
  ...
  public void a(SubMsgType0x27.MsgBody paramMsgBody, short paramShort, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramMsgBody = new String(axln.a(paramMsgBody), "UTF-8");
        localObject1 = null;
      ...
      catch (Exception paramMsgBody)
      {
        try
        {
          ...
          this.jdField_a_of_type_Bkys.removeMessages(1);
          localObject4 = new bdkv();
          ((bdkv)localObject4).e = "0X800923D";
          ((bdkv)localObject4).d = "收到Push协议";
          ((bdkv)localObject4).f = (((SubMsgType0x27.ClientReport)localObject3).uint32_service_id.get() + "");
          ((bdkv)localObject4).i = ((SubMsgType0x27.ClientReport)localObject3).str_content_id.get();
          bdku.a(paramMsgBody, (bdkv)localObject4);
          bdku.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (bdkv)localObject4);
          l = bcrg.a();
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqActivityRecentDataRecentItemNoticeData == null)
          {
            ...
            a(paramLong, str, paramMsgBody, (String)localObject2, i, j, ((bdkv)localObject4).f, ((bdkv)localObject4).i, (Bundle)localObject1);
            return;
