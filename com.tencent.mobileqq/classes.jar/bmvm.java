  ...
  implements SurfaceTexture.OnFrameAvailableListener
{
  ...
  private bmvn jdField_a_of_type_Bmvn;
  ...
  public bmvm(int paramInt1, int paramInt2)
  {
  ...
  private void e()
  {
    this.jdField_a_of_type_Bmvn = new bmvn();
    this.jdField_a_of_type_Bmvn.a();
    Log.d("CodecOutputSurface", "textureID=" + this.jdField_a_of_type_Bmvn.a());
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Bmvn.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bmvn = null;
  ...
  {
    this.jdField_a_of_type_Bmvn.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Bmvn.a("before updateTexImage");
