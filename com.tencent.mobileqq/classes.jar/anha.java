...
public class anha
{
  private static volatile anha jdField_a_of_type_Anha;
  private HashMap<String, String> jdField_a_of_type_JavaUtilHashMap;
  private boolean jdField_a_of_type_Boolean;
  
  public static anha a()
  {
    if (jdField_a_of_type_Anha == null) {}
    try
    {
      if (jdField_a_of_type_Anha == null) {
        jdField_a_of_type_Anha = new anha();
      }
      return jdField_a_of_type_Anha;
    }
    finally {}
  }
  ...
  {
    new angy(paramActivity, paramString, paramInt).c();
  }
  ...
  public void a(AVGameAppInterface paramAVGameAppInterface, long paramLong1, long paramLong2, String paramString1, int paramInt1, String paramString2, int paramInt2, anhg paramanhg)
  {
    ...
    paramanhg = new anhd(this, l, localHashMap, paramAVGameAppInterface, paramanhg);
    localHashMap.put(Long.valueOf(l), paramanhg);
    paramAVGameAppInterface.addObserver(paramanhg);
    mzl.a().a(paramLong1, paramLong2, paramString1, paramInt1, paramString2, paramInt2, l);
  }
  ...
  public void a(AVGameAppInterface paramAVGameAppInterface, Activity paramActivity, long paramLong1, long paramLong2, String paramString1, String paramString2, int paramInt)
  {
    ...
    a(paramAVGameAppInterface, paramLong1, paramLong2, paramString1, 2, paramString2, paramInt, new anhc(this, paramActivity, paramLong2, paramLong1, paramInt, paramString1, paramString2));
  }
  ...
  public void a(AVGameAppInterface paramAVGameAppInterface, BaseActivity paramBaseActivity, long paramLong1, long paramLong2, String paramString, int paramInt)
  {
    ...
    a(paramAVGameAppInterface, paramLong1, paramLong2, paramString, 1, "", paramInt, new anhb(this, paramBaseActivity, paramLong2, paramLong1, paramString));
  }
  
  public void a(AppInterface paramAppInterface, String paramString, anhg paramanhg)
  {
    QLog.d("AVGameShareUtil", 1, "requestGetInviteBackflowInfo key: " + paramString);
    mxn localmxn = (mxn)paramAppInterface.getManager(373);
    long l = System.currentTimeMillis();
    HashMap localHashMap = new HashMap();
    paramanhg = new anhe(this, l, localHashMap, paramAppInterface, paramanhg);
    localHashMap.put(Long.valueOf(l), paramanhg);
    paramAppInterface.addObserver(paramanhg);
    if (localmxn != null) {
      localmxn.a(paramString, l);
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString1, long paramLong1, long paramLong2, String paramString2, int paramInt2, String paramString3, int paramInt3)
  {
    ...
    mxn localmxn = (mxn)paramQQAppInterface.getManager(373);
    long l = System.currentTimeMillis();
    HashMap localHashMap = new HashMap();
    paramString1 = new anhf(this, l, localHashMap, paramQQAppInterface, paramInt1, paramString1, paramString2, paramLong2, paramLong1);
    localHashMap.put(Long.valueOf(l), paramString1);
    paramQQAppInterface.addObserver(paramString1);
    if (localmxn != null) {
      localmxn.a(paramLong1, paramLong2, paramString2, paramInt2, paramString3, paramInt3, l);
    }
  }
