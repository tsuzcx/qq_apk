...
{
  public sof(DevlockQuickLoginActivity paramDevlockQuickLoginActivity) {}
  ...
  public void OnCloseCode(String paramString, byte[] paramArrayOfByte1, long paramLong, WUserSigInfo paramWUserSigInfo, byte[] paramArrayOfByte2, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    catch (Exception paramString)
    {
      ...
      if (paramInt == 0)
      {
        QQToast.a(this.a.getApplicationContext(), 2, 2131436614, 0).b(DevlockQuickLoginActivity.a(this.a));
      ...
      if (paramInt == 21)
      {
        paramString = this.a.getString(2131436619);
        paramArrayOfByte1 = this.a.getString(2131436340);
        this.a.a(null, paramString, paramArrayOfByte1, new sog(this));
        return;
      }
      paramString = DevlockQuickLoginActivity.a(this.a, 2131436615);
  ...
  public void OnException(String paramString, int paramInt)
  {
    ...
    this.a.c();
    QQToast.a(DevlockQuickLoginActivity.b(this.a), 1, this.a.getString(2131436618), 0).b(DevlockQuickLoginActivity.d(this.a));
  }
  ...
  public void OnVerifyCode(String paramString, byte[] paramArrayOfByte1, long paramLong, ArrayList paramArrayList, byte[] paramArrayOfByte2, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    if (paramInt == 21)
    {
      paramString = this.a.getString(2131436619);
      paramArrayOfByte1 = this.a.getString(2131436340);
      this.a.a(null, paramString, paramArrayOfByte1, new soh(this));
      return;
    }
    paramString = this.a.getString(2131436615);
