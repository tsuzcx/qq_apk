...
public class aigx
  extends AsyncTask
{
  aigw jdField_a_of_type_Aigw;
  
  public aigx(CameraControl paramCameraControl, aigw paramaigw)
  {
    this.jdField_a_of_type_Aigw = paramaigw;
    LogTag.a();
  }
  ...
  {
    boolean bool2 = false;
    Object localObject3 = this.jdField_a_of_type_Aigw.jdField_a_of_type_ArrayOfByte;
    Object localObject1 = this.jdField_a_of_type_Aigw.jdField_a_of_type_JavaIoFile;
    LogTag.a();
    ...
    {
      i = CameraUtils.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl.jdField_a_of_type_ComTencentMobileqqCameraCameraHolder, this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl.jdField_a_of_type_Int, this.jdField_a_of_type_Aigw.jdField_a_of_type_Int);
      if (QLog.isColorLevel()) {
        QLog.i(CameraControl.b, 2, "[onPictureTaken] mirror=" + this.jdField_a_of_type_Aigw.jdField_a_of_type_Boolean + " frontFlip=" + this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl.jdField_a_of_type_ComTencentMobileqqCameraCameraHolder.a().b() + " jpegRotation=" + i);
      }
    }
    for (;;)
    {
      try
      {
        boolean bool3 = CameraControl.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoMediadeviceCameraControl, this.jdField_a_of_type_Aigw.jdField_a_of_type_AndroidHardwareCamera$Size.width, this.jdField_a_of_type_Aigw.jdField_a_of_type_AndroidHardwareCamera$Size.height, this.jdField_a_of_type_Aigw.jdField_a_of_type_AndroidGraphicsRect.width(), this.jdField_a_of_type_Aigw.jdField_a_of_type_AndroidGraphicsRect.height());
        boolean bool1 = bool2;
        if (this.jdField_a_of_type_Aigw.jdField_a_of_type_Boolean)
        {
          bool1 = bool2;
        ...
        localObject3 = CameraUtils.b((byte[])localObject3, this.jdField_a_of_type_Aigw.jdField_a_of_type_AndroidGraphicsRect, bool1, i);
        NewFlowCameraReporter.a("clip_rotate;");
        ImageUtil.a((Bitmap)localObject3, this.jdField_a_of_type_Aigw.c, (File)localObject1);
        NewFlowCameraReporter.a(false, this.jdField_a_of_type_Aigw.jdField_a_of_type_AndroidHardwareCamera$Size.width, this.jdField_a_of_type_Aigw.jdField_a_of_type_AndroidHardwareCamera$Size.height, this.jdField_a_of_type_Aigw.jdField_a_of_type_AndroidGraphicsRect.width(), this.jdField_a_of_type_Aigw.jdField_a_of_type_AndroidGraphicsRect.height(), bool3, i, bool1);
        NewFlowCameraReporter.a("save jpg;");
        if (0 == 0) {}
      }
      catch (OutOfMemoryError localOutOfMemoryError)
      {
        QLog.e(CameraControl.b, 2, "[onPictureTaken] createBitmap failed orientation:" + this.jdField_a_of_type_Aigw.jdField_a_of_type_Int + ", " + localOutOfMemoryError.getMessage(), localOutOfMemoryError);
        CameraUtils.a(null);
        if (0 == 0) {
          continue;
        }
  ...
  {
    int j = 0;
    byte[] arrayOfByte = this.jdField_a_of_type_Aigw.jdField_a_of_type_ArrayOfByte;
    Object localObject = this.jdField_a_of_type_Aigw.jdField_a_of_type_AndroidGraphicsRect;
    localObject = this.jdField_a_of_type_Aigw.jdField_a_of_type_JavaIoFile;
    if (QLog.isColorLevel()) {
    ...
    int i = j;
    switch (this.jdField_a_of_type_Aigw.jdField_a_of_type_Int % 360)
    {
    default: 
      i = j;
    }
  ...
  {
    if (this.jdField_a_of_type_Aigw.d == 0) {
      return b();
    }
    if (this.jdField_a_of_type_Aigw.d == 1) {
      return a();
    }
    return null;
  }
  ...
  protected void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Aigw.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewCameraCover$PictureCallback != null)
    {
      this.jdField_a_of_type_Aigw.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewCameraCover$PictureCallback.a_(paramString);
