...
public abstract class bggz
{
  ...
  private void a(bghf parambghf, String paramString)
  {
    if (parambghf != null)
    {
      parambghf.jdField_a_of_type_Int = 2;
      parambghf.jdField_a_of_type_JavaLangString = paramString;
    }
  ...
  public int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Object localObject1 = (mxu)paramQQAppInterface.getManager(70);
    int m;
    if (localObject1 != null) {
      m = ((mxu)localObject1).a(paramQQAppInterface);
    }
    for (int k = ((mxu)localObject1).a();; k = 0)
    {
      ...
      {
        n = ((avps)localObject2).b(0);
        localObject1 = ((avps)localObject2).b(0);
        localObject2 = ((avps)localObject2).a();
      ...
      for (;;)
      {
        paramString = (axcj)paramQQAppInterface.getManager(10);
        int i2 = 0;
        i1 = 0;
        if (paramString != null)
        {
  ...
  public boolean a(bghb parambghb, String paramString1, QQAppInterface paramQQAppInterface, String paramString2, int paramInt, long paramLong, int[] paramArrayOfInt, bghf parambghf)
  {
    if (parambghb == null) {
      return false;
    }
    if ((parambghb.jdField_h_of_type_Boolean) && (!a(paramString2)))
    {
      a(parambghf, "preload:fail:notinleba");
      return false;
    }
    if (parambghb.jdField_b_of_type_Boolean)
    {
      int i = a(paramQQAppInterface, paramString1);
      if ((parambghb.jdField_c_of_type_Boolean) && (i == 4))
      {
        a(parambghf, "preload:ok:reddotonly");
        return true;
      }
      if ((parambghb.jdField_d_of_type_Boolean) && ((i == 1) || (i == 4)))
      {
        a(parambghf, "preload:ok:reddot");
        return true;
      }
      if ((parambghb.jdField_e_of_type_Boolean) && (i == 2))
      {
        a(parambghf, "preload:fail:lebareddot");
        return false;
      }
    }
    if ((parambghb.a) && (!a(parambghb.jdField_b_of_type_Int, parambghb.jdField_c_of_type_Int)))
    {
      a(parambghf, "preload:fail:timecontrol");
      return false;
    }
    if ((parambghb.j) && (paramInt < parambghb.jdField_f_of_type_Int))
    {
      a(parambghf, "preload:fail:usedtimeslimit");
      return false;
    }
    if (parambghb.jdField_i_of_type_Boolean)
    {
      long l = parambghb.jdField_e_of_type_Int * 60 * 60 * 1000;
      if (System.currentTimeMillis() - paramLong > l)
      {
        a(parambghf, "preload:fail:notactive");
        return false;
      }
    }
    if (parambghb.jdField_f_of_type_Boolean)
    {
      if ((System.currentTimeMillis() - paramLong) / 1000L <= parambghb.jdField_d_of_type_Int) {
        paramInt = 1;
      }
      while (paramInt != 0) {
        if (parambghb.jdField_g_of_type_Boolean)
        {
          a(parambghf, "preload:ok:cdperiod");
          return true;
          paramInt = 0;
        }
        else
        {
          a(parambghf, "preload:fail:cdperiod");
          return false;
        }
      }
    }
    if ((parambghb.k) && (parambghb.jdField_g_of_type_Int > 0) && (!a(paramString1, paramQQAppInterface.getCurrentAccountUin(), parambghb.jdField_g_of_type_Int, paramArrayOfInt, parambghb.jdField_h_of_type_Int, parambghb.jdField_i_of_type_Int)))
    {
      a(parambghf, "preload:fail:notinuserlearn");
      return false;
    }
    a(parambghf, "preload:ok:normal");
    return true;
  }
  
  public abstract boolean a(bghf parambghf);
  
  public boolean a(String paramString)
  {
    Object localObject = agby.a().b();
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if ((localanec != null) && (localanec.a != null) && (localanec.a.strPkgName != null) && (localanec.a.strPkgName.contains(paramString))) {
        return true;
      }
    }
    return false;
  ...
  public boolean a(String paramString1, String paramString2, int paramInt1, int[] paramArrayOfInt, int paramInt2, int paramInt3)
  {
    ...
    SharedPreferences localSharedPreferences = BaseApplicationImpl.getApplication().getSharedPreferences("ppp_profile", bbjo.a());
  ...
  public int[] a(int[] paramArrayOfInt, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      return null;
      localObject = new bgha(this, paramInt3);
      switch (paramInt2)
      {
      default: 
        return null;
      case 1: 
        paramInt2 = ((bgha)localObject).a(paramArrayOfInt, paramInt1);
      }
    } while (paramInt2 == -1);
    ...
    return localObject;
    return ((bgha)localObject).a(paramArrayOfInt, paramInt1);
  }
  
  public boolean b(bghf parambghf)
  {
    return true;
  }
}
