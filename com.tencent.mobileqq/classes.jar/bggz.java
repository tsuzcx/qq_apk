...
public class bggz
{
  ...
  public bggz(int paramInt, String paramString1, String paramString2, Object paramObject, Bundle paramBundle)
  {
  ...
  {
    if ((paramObject instanceof bggz))
    {
      paramObject = (bggz)paramObject;
      if ((paramObject.jdField_a_of_type_Int == this.jdField_a_of_type_Int) && (bgjw.a(this.jdField_a_of_type_JavaLangString, paramObject.jdField_a_of_type_JavaLangString)) && ((3 != this.jdField_a_of_type_Int) || ((bgjw.a(this.b, paramObject.b)) && (bgjw.a(this.jdField_a_of_type_JavaLangObject, paramObject.jdField_a_of_type_JavaLangObject)) && (bgjw.a(this.jdField_a_of_type_AndroidOsBundle, paramObject.jdField_a_of_type_AndroidOsBundle))))) {
        return true;
      }
    }
    return false;
