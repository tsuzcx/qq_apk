...
public class aspr
{
  ...
  private static void a(BaseActivity paramBaseActivity, aspw paramaspw)
  {
    ThreadManagerV2.postImmediately(new MultiAIOStarter.2(paramBaseActivity, paramaspw), null, false);
  }
  ...
  public static boolean a(Context paramContext, String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    if (!((aspv)BaseApplicationImpl.getApplication().getRuntime().getManager(325)).a())
    {
      if (QLog.isColorLevel()) {
    ...
    if (aspk.a(paramInt))
    {
      ...
      aspw localaspw = aspw.a(localQQAppInterface);
      Bitmap localBitmap = a(paramContext);
      int i = a(paramContext);
      a = true;
      localaspw.a(localBitmap);
      localaspw.a(i);
      a((BaseActivity)paramContext, localaspw);
      localaspw.a((QQAppInterface)localQQAppInterface, (FragmentActivity)paramContext, paramString3, paramInt, paramString1, paramString2);
      localaspw.a(new asps(paramContext));
      localIntent.putExtra("OPEN_MULTI_AIO_CONTEXT", localaspw.a());
      if ("open_from_aio".equals(paramString3)) {
        localIntent.putExtra("OPEN_MULTI_AIO_LIST_VIEW_SPECIFY_BOTTOM", a(paramContext));
      }
      abtu.a(paramContext, localIntent, PublicTransFragmentActivity.class, MultiAIOFragment.class);
      return true;
    }
    return false;
  }
