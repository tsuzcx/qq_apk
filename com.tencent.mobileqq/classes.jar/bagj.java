  ...
  extends badd
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bagk(this);
  private bagf jdField_a_of_type_Bagf = new bagf();
  private float jdField_b_of_type_Float;
  private final int jdField_b_of_type_Int = 500;
  
  public bagj(baei parambaei, azxr paramazxr)
  {
  ...
  private View a(PrivilegeInfo paramPrivilegeInfo, String paramString, float paramFloat1, float paramFloat2, float paramFloat3, Drawable paramDrawable)
  {
    ...
    {
      this.jdField_a_of_type_Bagf.removeMessages(paramPrivilegeInfo.iType);
      ...
      this.jdField_a_of_type_Bagf.sendMessageDelayed(paramDrawable, 500L);
      if (paramPrivilegeInfo.iType == 1) {
        a("0X800B27D", i);
      }
    }
  ...
  private void a(PrivilegeInfo paramPrivilegeInfo, String paramString, LinearLayout paramLinearLayout, int paramInt1, int paramInt2, int paramInt3, Drawable paramDrawable, boolean paramBoolean)
  {
    ...
    if (!TextUtils.isEmpty(paramPrivilegeInfo.strJumpUrl))
    {
      ...
      paramString.setTag(new azvr(93, paramPrivilegeInfo));
    ...
    for (;;)
    {
      ...
      {
        paramPrivilegeInfo = String.valueOf(aokv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), false));
      }
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "qvip", paramString, paramInt1, 0, paramPrivilegeInfo, "", "", "");
      return;
  ...
  {
    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramString, paramString, paramInt, 0, String.valueOf(paramInt), "", "", "");
  }
  ...
  private View b(PrivilegeInfo paramPrivilegeInfo, String paramString, float paramFloat1, float paramFloat2, float paramFloat3, Drawable paramDrawable)
  {
    ...
    if (paramDrawable != null)
    {
      ...
      localURLImageView.setURLDrawableDownListener(new bjbe(localURLImageView, paramString, "showDiamondImage onLoadFailed iconUrl = "));
  ...
  public void a(azxr paramazxr, View paramView)
  {
    if ((paramazxr == null) || (paramazxr.jdField_a_of_type_ComTencentMobileqqDataCard == null) || (paramView == null)) {
      return;
    }
    paramView.setVisibility(0);
    Object localObject3 = paramazxr.jdField_a_of_type_ComTencentMobileqqDataCard;
    Object localObject1 = ((Card)localObject3).getPrivilegeOpenInfo();
    Object localObject2 = ((Card)localObject3).getPrivilegeCloseInfo();
    TextView localTextView = (TextView)paramView.findViewById(2131373080);
    paramView = (LinearLayout)paramView.findViewById(2131365562);
    paramView.removeAllViews();
    StringBuilder localStringBuilder = new StringBuilder(24);
    localStringBuilder.append(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131693013));
    if ((paramazxr.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(paramazxr.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString)))
    {
      ...
      for (;;)
      {
        ...
        localTextView.setText(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131698282));
      ...
      label404:
      paramazxr.addAll((Collection)localObject3);
      paramazxr.addAll(localArrayList);
      a(paramazxr, paramView, false);
    }
    for (;;)
    {
    ...
    paramazxr = ((Card)localObject3).privilegePromptStr;
    if (TextUtils.isEmpty(paramazxr)) {
      localTextView.setText(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131698281));
    }
    for (;;)
    {
  ...
  public void a(@NonNull BaseActivity paramBaseActivity, @Nullable Bundle paramBundle)
  {
    ...
    float f2 = paramBaseActivity.getDimensionPixelSize(2131297176) + paramBaseActivity.getDimensionPixelSize(2131297483) + paramBaseActivity.getDimensionPixelSize(2131297484);
    float f3 = this.jdField_a_of_type_Float;
    int i = paramBaseActivity.getDimensionPixelSize(2131297480);
    int j = paramBaseActivity.getDimensionPixelSize(2131297481);
    float f4 = i;
  ...
  public boolean a(azxr paramazxr)
  {
    ...
    return a((azxr)this.jdField_b_of_type_JavaLangObject, ((azxr)this.jdField_b_of_type_JavaLangObject).d) | bool;
  }
  
  public boolean a(azxr paramazxr, boolean paramBoolean)
  {
    paramBoolean = true;
    boolean bool = true;
    Object localObject;
    ...
    if (0 == 0)
    {
      localObject = this.jdField_a_of_type_Baiy.a("map_key_diamond");
      if (localObject != null) {
        paramBoolean = true;
      }
    }
    for (;;)
    {
      if (localObject == null)
      {
        localObject = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131561448, null);
        paramBoolean = true;
      }
      for (;;)
      {
        this.jdField_a_of_type_JavaLangObject = localObject;
        ImageView localImageView = (ImageView)((View)localObject).findViewById(2131362954);
        View localView = ((View)localObject).findViewById(2131365561);
        if (bool)
        {
          a(paramazxr, localView);
          paramazxr = (ViewGroup.MarginLayoutParams)localView.getLayoutParams();
          paramazxr.leftMargin = 0;
          localView.setLayoutParams(paramazxr);
        }
        for (;;)
        {
          if (bool)
          {
            ((View)localObject).setTag(new azvr(26, null));
