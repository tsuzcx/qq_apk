...
public class wym
  extends Handler
{
  public wym(TroopMemberApiService paramTroopMemberApiService) {}
  
  private void a(Bundle paramBundle)
  {
    Object localObject1 = (QQAppInterface)TroopMemberApiService.d(this.a);
    Object localObject3 = ((askl)TroopMemberApiService.e(this.a).getManager(11)).a();
    String str1 = "";
    Object localObject2 = "";
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    {
      localObject5 = (ajsz)((QQAppInterface)localObject7).a(22);
      localObject6 = (ajzl)((QQAppInterface)localObject7).a(3);
      localObject1 = (akhq)((QQAppInterface)localObject7).a(20);
    }
          ...
          if (localObject1 != null)
          {
            ...
            if (paramMessage.obj != null)
            {
              ...
              if (localObject1 != null)
              {
                ...
                continue;
                this.a.jdField_a_of_type_Akeq = new akeq(((AppRuntime)localObject7).getAccount());
                continue;
                localObject1 = ((Bundle)localObject8).getString("gcode");
                localObject5 = ((Bundle)localObject8).getString("anId");
                localObject6 = mye.a().a((String)localObject1, (String)localObject5);
                if ((!TextUtils.isEmpty((CharSequence)localObject6)) && (!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty((CharSequence)localObject5)))
                {
                  ...
                  if (QLog.isDevelopLevel())
                  {
                    ...
                    if (localObject1 != null)
                    {
                      ((akhq)localObject1).b((String)localObject5);
                      continue;
                      localObject5 = ((Bundle)localObject8).getString("troopUin");
                      localObject6 = ((Bundle)localObject8).getString("troopCode");
                      if (localObject1 != null) {
                        ((akhq)localObject1).a(true, (String)localObject5, (String)localObject6, 0);
                      }
                      if (QLog.isColorLevel())
                      {
                        ...
                        atbr.a((QQAppInterface)localObject7, (String)localObject1, this.a.jdField_a_of_type_Ayvz);
                        continue;
                        ...
                        if ((localObject7 instanceof QQAppInterface))
                        {
                          ...
                          if (!asyu.a((AppInterface)localObject6, (String)localObject1))
                          {
                            l1 = awzw.a();
                            localObject7 = ((QQAppInterface)localObject6).getCurrentAccountUin();
                            localObject5 = axuy.a((byte[])localObject5, -1);
                            if (localObject5 != null)
                            {
                              ((AbsStructMsg)localObject5).mMsgServiceID = 98;
                              localObject8 = (MessageForStructing)axaq.a(-2011);
                              ...
                              asyu.a((AppInterface)localObject6, (String)localObject1);
                              asyu.a((MessageRecord)localObject8, "isFaceScoreBubbleMsg", true);
                              asyu.a((MessageRecord)localObject8, "isFaceScoreSecondMember", true);
                              asyu.a.add(localObject1);
                              if (i == 1) {}
                              for (bool = true;; bool = false)
                              {
                                akpy.a((MessageRecord)localObject8, bool);
                              ...
                              localObject6 = (ajyi)((QQAppInterface)localObject7).a(35);
                              if (localObject6 != null)
                              {
                                localObject8 = new ArrayList();
                                ((List)localObject8).add(Long.valueOf(Long.parseLong((String)localObject5)));
                                ((ajyi)localObject6).a((QQAppInterface)localObject7, (String)localObject1, (List)localObject8, i);
                                continue;
                                ...
                                if (localObject1 != null)
                                {
                                  ((akhq)localObject1).a(l1, l2, l3, (String)localObject5, i, (String)localObject6, (String)localObject7, j);
                                  continue;
                                  localObject5 = ((Bundle)localObject8).getString("troopUin");
                                  if (localObject1 != null)
                                  {
                                    ((akhq)localObject1).n((String)localObject5);
                                    continue;
                                    localObject1 = ((Bundle)localObject8).getString("troopUin");
                                    bool = ((Bundle)localObject8).getBoolean("isChecked");
                                    if (localObject5 != null)
                                    {
                                      ((ajsz)localObject5).b((String)localObject1, bool);
                                      continue;
                                      localObject1 = ((Bundle)localObject8).getString("troopUin");
                                      bool = ((Bundle)localObject8).getBoolean("isChecked");
                                      if (localObject5 != null) {
                                        ((ajsz)localObject5).a((String)localObject1, bool);
                                      }
                                    }
                                  }
                                }
    ...
    case 120: 
      ...
      localObject5 = (ajuo)((QQAppInterface)localObject7).a(8);
      if (localObject5 != null) {
        if (((ajuo)localObject5).a((String)localObject1, 0).longValue() > 0L) {
          bool = true;
        }
      }
      break;
    ...
    for (;;)
    {
      ...
      localObject5 = ((Bundle)localObject8).getString("troopUin");
      if (localObject1 != null) {
        ((akhq)localObject1).j((String)localObject5);
      }
      if (!QLog.isDevelopLevel()) {
        break label708;
      }
      ...
      {
        ((ajzl)localObject6).a(((Bundle)localObject8).getString("areaName"), ((Bundle)localObject8).getInt("lat"), ((Bundle)localObject8).getInt("lon"), ((Bundle)localObject8).getInt("startIndex"), ((Bundle)localObject8).getInt("count"), ((Bundle)localObject8).getInt("iFilterId"));
        break label708;
      }
      if ("getNearbyTroops".equals(localObject1))
      {
        ((ajzl)localObject6).a(((Bundle)localObject8).getBoolean("isFirst"), ((Bundle)localObject8).getInt("lat"), ((Bundle)localObject8).getInt("lon"), ((Bundle)localObject8).getInt("sortType"), ((Bundle)localObject8).getString("strGroupArea"), ((Bundle)localObject8).getInt("iFilterId"));
        break label708;
      }
      if ("getAreaList".equals(localObject1))
      {
        ((ajzl)localObject6).a(((Bundle)localObject8).getInt("lat"), ((Bundle)localObject8).getInt("lon"), ((Bundle)localObject8).getInt("radius"), ((Bundle)localObject8).getBoolean("isClickable"));
        break label708;
      }
      if (!"getNewNearbyTroop".equals(localObject1)) {
        break label708;
      }
      ((ajzl)localObject6).a(((Bundle)localObject8).getInt("lat"), ((Bundle)localObject8).getInt("lon"));
      break label708;
      localObject5 = ((Bundle)localObject8).getString("troopUin");
      ...
      ((akhq)localObject1).notifyUI(144, true, new Object[] { localObject5, localObject6, Integer.valueOf(i) });
      break label708;
      localObject1 = new Bundle();
      ...
      {
        localObject6 = (avpq)((AppRuntime)localObject7).getManager(36);
        if (localObject6 != null)
        {
          ...
          {
            localObject9 = ((avpq)localObject6).a(localObject5[i]);
      ...
      localObject5 = (avpq)((AppRuntime)localObject7).getManager(36);
      if (localObject5 == null) {
        break label708;
      }
      ((avpq)localObject5).b((String)localObject1);
      break label708;
      localObject5 = ((Bundle)localObject8).getString("troopUin");
      ...
      ((akhq)localObject1).b((String)localObject5, (String)localObject6);
      break label708;
      localObject1 = new Bundle();
      ...
      {
        mye.a().a((String)localObject5, l1, i, (String)localObject6, j, "", (String)localObject7);
      ...
      ((akhq)localObject1).a(i, ((Bundle)localObject8).getString("openGroupId"), (String)localObject5, ((Bundle)localObject8).getString("url"), ((Bundle)localObject8).getInt("seq"));
      break label708;
      i = ((Bundle)localObject8).getInt("seq");
      if (this.a.jdField_a_of_type_Aabs == null) {
        this.a.jdField_a_of_type_Aabs = new aabs((AppRuntime)localObject7, this.a);
      }
      this.a.jdField_a_of_type_Aabs.a(116, (Bundle)localObject8, i);
      break label708;
      i = ((Bundle)localObject8).getInt("appid");
      localObject5 = ((Bundle)localObject8).getString("token");
      ((akhq)localObject1).a(i, ((Bundle)localObject8).getString("openId"), (String)localObject5, ((Bundle)localObject8).getInt("seq"));
      break label708;
      bool = ((Bundle)localObject8).getBoolean("isTroopAppListChanged");
      localObject1 = (bail)((AppRuntime)localObject7).getManager(109);
      if (localObject1 == null) {
        break label708;
      }
      ((bail)localObject1).a(bool);
      break label708;
      ...
      localObject5 = (bail)((AppRuntime)localObject7).getManager(109);
      if (localObject5 == null) {
        break label708;
      }
      ((bail)localObject5).a(bool, (String)localObject1);
      break label708;
      localObject5 = ((Bundle)localObject8).getString("troopUin");
      ...
      if (((String)localObject1).equals("g_homework"))
      {
        ...
        localObject1 = "";
        if (bakj.a((QQAppInterface)localObject7, l1)) {
      ...
      bals.a((QQAppInterface)localObject7, this.a, (String)localObject5, true);
      break label708;
      ...
      break label708;
      if (TroopMemberApiService.a((AppRuntime)localObject7, new wyn(this, (Bundle)localObject8))) {
        break label708;
      }
      this.a.a(16, (Bundle)localObject8);
      break label708;
      l1 = ((Bundle)localObject8).getLong("uiResId");
      localObject1 = agca.a().a(l1);
      if ((localObject1 != null) && (((andx)localObject1).jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo != null))
      {
        ((Bundle)localObject8).putString("packageName", ((andx)localObject1).jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.strPkgName);
        ((Bundle)localObject8).putString("imageUrl", ((andx)localObject1).jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.strResURL);
        ((Bundle)localObject8).putString("name", ((andx)localObject1).jdField_a_of_type_ComTencentMobileqqDataLebaPluginInfo.strResName);
        if (((andx)localObject1).jdField_a_of_type_Byte == 0)
        {
          bool = true;
          label3217:
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          localObject9 = (akhq)((QQAppInterface)localObject7).a(20);
          if (localObject9 != null) {
            ((akhq)localObject9).j((String)localObject5);
          }
          ...
          localObject1 = bakj.a((QQAppInterface)localObject7, l1, null, (String)localObject1, (String)localObject5, l2, i);
          ...
          TroopMemberApiService.a(this.a, (QQAppInterface)localObject7, l1, HWTroopFileStatusInfo.parse((azqt)localObject1), (Bundle)localObject5);
          break;
          if ((!(localObject7 instanceof QQAppInterface)) || (localObject8 == null)) {
            break;
          }
          if (this.a.jdField_a_of_type_Seo == null) {
            this.a.jdField_a_of_type_Seo = new seo(this.a, (QQAppInterface)localObject7);
          }
          if (((Bundle)localObject8).getBoolean("is_pic_or_voice"))
          {
            this.a.jdField_a_of_type_Seo.a((Bundle)localObject8);
            break;
          }
          this.a.jdField_a_of_type_Seo.c((Bundle)localObject8);
          break;
          if ((!(localObject7 instanceof QQAppInterface)) || (localObject8 == null)) {
            break;
          }
          ...
          if (((Bundle)localObject8).getBoolean("is_pic_or_voice"))
          {
            this.a.jdField_a_of_type_Seo.b((Bundle)localObject8);
            break;
          }
          this.a.jdField_a_of_type_Seo.d((Bundle)localObject8);
          break;
          if (this.a.jdField_a_of_type_Seo == null) {
            break;
          }
          this.a.jdField_a_of_type_Seo.a();
          break;
          ...
          if ((((bail)localObject1).a(0)) && (!((bail)localObject1).b(0)))
          {
            localObject6 = ((bail)localObject1).a(false, 0);
            if ((localObject6 != null) && (!((List)localObject6).isEmpty()))
            {
              ...
              while (((Iterator)localObject6).hasNext())
              {
                ...
                {
                  bcpw.a(BaseApplication.getContext(), 2, 2131720398, 0).b(this.a.getResources().getDimensionPixelSize(2131298865));
                  return;
                }
              }
            }
            ...
            ((bail)localObject1).a((ArrayList)localObject5, (ArrayList)localObject6);
            break;
          }
          this.a.jdField_a_of_type_Boolean = true;
          ((bail)localObject1).a(true, 0);
          break;
          ...
          ((arju)((QQAppInterface)localObject7).getManager(108)).a(this.a, l1, (String)localObject1, (String)localObject6, (String)localObject5, i);
          break;
          ...
          argb.a((QQAppInterface)localObject7, (String)localObject1, (String)localObject5, (String)localObject6, "web", (String)localObject9, str, (String)localObject8);
          break;
          localObject1 = ((Bundle)localObject8).getString("pluginPackageName");
          localObject5 = ((Bundle)localObject8).getString("appType");
          arfs.a(((QQAppInterface)localObject7).getApp(), (String)localObject1, (String)localObject5).a();
          break;
          try
          {
        ...
        for (;;)
        {
          for (;;)
          {
            for (;;)
            {
              ...
              bahk.a(this.a, (String)localObject2, (String)localObject5);
              break label708;
              localObject2 = ((Bundle)localObject8).getString("troopUin");
              ...
              bals.jdField_a_of_type_Int = ((Bundle)localObject8).getInt("imageMaxWidthPixels", 1080);
              bals.b = ((Bundle)localObject8).getInt("imageMaxHeightPixels", 1920);
              ((bals)((AppRuntime)localObject7).getManager(152)).a((String)localObject2, i, (String)localObject5, (String)localObject6, j);
              break label708;
              ((akhq)localObject2).a(((Bundle)localObject8).getLong("troopUin"), ((Bundle)localObject8).getInt("flag"));
              break label708;
              ...
              localObject5 = ((bals)((AppRuntime)localObject7).getManager(152)).a((String)localObject2, (String)localObject5);
              localObject2 = "";
              if (localObject5 != null) {
              ...
              ((TroopPluginManager)localObject5).a("troop_manage_plugin.apk", new wyq(this, (akhq)localObject2, (String)localObject6, i, (String)localObject7));
              break label708;
              ...
              break label708;
              ((akhq)localObject2).a(((Bundle)localObject8).getString("troopUin"), "", ((Bundle)localObject8).getInt("statOption"), ((Bundle)localObject8).getString("authKey"), null, null, null);
              break label708;
              ...
              localObject5 = ((bbwi)((AppRuntime)localObject7).getManager(47)).a(1);
              localObject6 = new File(aszh.jdField_a_of_type_JavaLangString + File.separator + "nearby_heart.mp4");
              if (!((File)localObject6).exists()) {
                ((File)localObject6).mkdirs();
              }
              for (;;)
              {
                ((bbwl)localObject5).a(new bbwg("http://pub.idqqimg.com/pc/misc/nearby/nearby_heart.gif", (File)localObject6), new wyr(this, (Bundle)localObject2), new Bundle());
                break;
              ...
              if ((localObject7 instanceof QQAppInterface))
              {
                localObject6 = (bahs)((AppRuntime)localObject7).getManager(224);
                if (localObject6 != null)
                {
                  localObject5 = ((bahs)localObject6).a();
                  localObject6 = ((bahs)localObject6).b();
              ...
              bool = axlc.a((QQAppInterface)localObject7, BaseApplicationImpl.getContext());
              if (!QLog.isColorLevel()) {
                break label708;
              }
              ...
              ncm.a().a((String)localObject2, (String)localObject5, (String)localObject6);
              ncm.a().a((QQAppInterface)localObject7);
              ((Bundle)localObject8).putInt("state", ncl.jdField_a_of_type_Int);
              ((Bundle)localObject8).putString("version", ncl.jdField_a_of_type_JavaLangString);
              ((Bundle)localObject8).putLong("size", ncl.jdField_a_of_type_Long);
              ...
              ncm.a().a((String)localObject2, i, (String)localObject5, new wys(this, (Bundle)localObject8, i));
              break label708;
              ((Bundle)localObject8).putInt("currentFragment", SplashActivity.jdField_a_of_type_Int);
              this.a.a(80, (Bundle)localObject8);
              break label708;
              localObject2 = (qvk)((AppRuntime)localObject7).getManager(226);
              ((qvk)localObject2).a(this.a);
              ((qvk)localObject2).a(((Bundle)localObject8).getString("videoPath"), (Bundle)localObject8);
              break label708;
              i = ((Bundle)localObject8).getInt("subCmd");
              localObject2 = (azrw)((QQAppInterface)localObject7).getManager(231);
              switch (i)
              {
              }
              for (;;)
              {
                ...
                break;
                ((azrw)localObject2).a(((Bundle)localObject8).getInt("effectId"), ((Bundle)localObject8).getString("effectName"), ((Bundle)localObject8).getInt("svipLevel"), ((Bundle)localObject8).getInt("svipType"));
                continue;
                localObject5 = ((Bundle)localObject8).getStringArrayList("statusList");
                if (localObject5 != null) {
                  ((azrw)localObject2).a((ArrayList)localObject5);
                }
              }
              localObject2 = ((Bundle)localObject8).getString("troopUin");
              ...
              new aiha((Intent)localObject6).execute(new Void[0]);
              this.a.a(87, (Bundle)localObject8);
              break label708;
              ...
              ((arii)((AppRuntime)localObject7).getManager(306)).a((Bundle)localObject2);
              break label708;
              ((arii)((AppRuntime)localObject7).getManager(306)).a();
              break label708;
              ...
              if (bool)
              {
                VideoEnvironment.a("TroopMemberApiService", ajyc.a(2131715641), null);
                ShortVideoResourceManager.b((QQAppInterface)localObject7, new wyt(this, (AppRuntime)localObject7, (Bundle)localObject8));
                break label708;
              }
              ...
              ((arfe)((AppRuntime)localObject7).getManager(236)).a(this.a, (String)localObject2, ((QQAppInterface)localObject7).getCurrentAccountUin(), i, (String)localObject5, (String)localObject6, (String)localObject9, str, (String)localObject8);
              break label708;
              ((Bundle)localObject8).getString("fromId");
              ((arfe)((AppRuntime)localObject7).getManager(236)).a(null, 10L);
              break label708;
              localObject2 = ((Bundle)localObject8).getString("uin");
              i = ((Bundle)localObject8).getInt("index");
              localObject2 = nje.a().a((String)localObject2);
              if (localObject2 == null) {
                break label708;
              }
              localObject5 = (nji)((AppRuntime)localObject7).getManager(238);
              if (localObject5 == null) {
                break label708;
              }
              ((nji)localObject5).a((niv)localObject2, i);
              break label708;
              ...
              localObject7 = (ajyi)((QQAppInterface)localObject7).a(35);
              if (localObject7 == null) {
                break label708;
              }
              ((ajyi)localObject7).a((String)localObject2, (String)localObject5, (String)localObject6);
              break label708;
              localObject2 = ((Bundle)localObject8).getString("troopCode");
              localObject5 = ((Bundle)localObject8).getString("uin");
              localObject6 = (ajyi)((QQAppInterface)localObject7).a(35);
              ...
              ((ajyi)localObject6).a((String)localObject2, (String)localObject5);
              break label708;
              localObject2 = ((Bundle)localObject8).getString("troopCode");
              localObject5 = (ajyi)((QQAppInterface)localObject7).a(35);
              if (localObject5 == null) {
                break label708;
              }
              ((ajyi)localObject5).a((String)localObject2);
              break label708;
              localObject2 = ((Bundle)localObject8).getString("troopCode");
              localObject5 = ((Bundle)localObject8).getString("uin");
              localObject6 = ((Bundle)localObject8).getString("nick");
              ...
              ((ajyi)localObject7).b((String)localObject2, (String)localObject5, (String)localObject6);
              break label708;
              localObject2 = ((Bundle)localObject8).getString("troopCode");
              localObject5 = ((Bundle)localObject8).getString("uin");
              localObject6 = (ajyi)((QQAppInterface)localObject7).a(35);
              ...
              ((ajyi)localObject6).b((String)localObject2, (String)localObject5);
              break label708;
              ((Bundle)localObject8).getString("troopCode");
              localObject2 = ((Bundle)localObject8).getString("rid");
              localObject5 = new wyv(this, (Bundle)localObject8);
              this.a.jdField_a_of_type_Ajyx = new ajyx((QQAppInterface)localObject7, (ajyy)localObject5, (String)localObject2);
              this.a.jdField_a_of_type_Ajyx.b(10000L);
              break label708;
              ...
              ((ajyi)localObject5).a((ArrayList)localObject2);
              break label708;
              localObject2 = ((Bundle)localObject8).getString("schoolName");
              i = ((Bundle)localObject8).getInt("isValid");
              localObject5 = (atbx)((QQAppInterface)localObject7).a(60);
              if (localObject5 == null) {
                break label708;
              }
              ((atbx)localObject5).a((String)localObject2, i);
              break label708;
              localObject2 = ((Bundle)localObject8).getStringArrayList("preloadList");
              localObject5 = (nlv)((AppRuntime)localObject7).getManager(248);
              if (localObject5 == null) {
                break label708;
              }
              ((nlv)localObject5).a((ArrayList)localObject2);
              break label708;
              localObject2 = (nlv)((AppRuntime)localObject7).getManager(248);
              if (localObject2 == null) {
                break label708;
              }
              ((nlv)localObject2).a();
              ...
              osj.a().d(i, j);
              break label708;
              ((Bundle)localObject8).putInt("readinjoy_to_wx_config", bhvh.t((AppRuntime)localObject7));
              this.a.a(113, (Bundle)localObject8);
              break label708;
              if (this.a.jdField_a_of_type_Pcg == null) {
                this.a.jdField_a_of_type_Pcg = new pcg((AppRuntime)localObject7, this.a);
              }
              this.a.jdField_a_of_type_Pcg.b((Bundle)localObject8);
              break label708;
              ((ssv)((QQAppInterface)localObject7).a(98)).c(((Bundle)localObject8).getInt("reqUserSetEnableAlbumScan"));
              break label708;
              if (this.a.jdField_a_of_type_Pcg == null) {
                this.a.jdField_a_of_type_Pcg = new pcg((AppRuntime)localObject7, this.a);
              }
              this.a.jdField_a_of_type_Pcg.c((Bundle)localObject8);
              break label708;
              if (this.a.jdField_a_of_type_Pcg == null) {
                this.a.jdField_a_of_type_Pcg = new pcg((AppRuntime)localObject7, this.a);
              }
              this.a.jdField_a_of_type_Pcg.d((Bundle)localObject8);
              break label708;
              if (this.a.jdField_a_of_type_Pcg == null) {
                this.a.jdField_a_of_type_Pcg = new pcg((AppRuntime)localObject7, this.a);
              }
              this.a.jdField_a_of_type_Pcg.a((Bundle)localObject8);
              break label708;
              ...
              if ((!TextUtils.isEmpty((CharSequence)localObject5)) && ("group".equals(localObject6)))
              {
                ...
                ((akhq)localObject2).a((String)localObject5, false, "TroopMemberApiService111", true, true, false, false);
                break label708;
              }
              if (QLog.isColorLevel()) {
              ...
              localObject2 = actn.a((Intent)localObject2, null);
              ...
              if ((TextUtils.isEmpty((CharSequence)localObject2)) || (!String.valueOf(1104445552).equals(localObject5)) || (bahk.a((QQAppInterface)localObject7, (String)localObject2) == 0)) {
                break label708;
              }
              bahk.a((QQAppInterface)localObject7, (String)localObject2);
              break label708;
              ...
              localObject7 = (bcat)((AppRuntime)localObject7).getManager(290);
              if (localObject7 != null)
              {
                ((bcat)localObject7).a((String)localObject5, i, j, (String)localObject6, (String)localObject9, str, (String)localObject8, new wyo(this, k, (String)localObject2));
                break label708;
              }
              localObject5 = new Bundle();
              ...
              try
              {
                localObject2 = (bcat)((AppRuntime)localObject7).getManager(290);
                if (localObject2 == null) {
                  break label8076;
                }
                ((bcat)localObject2).a((Bundle)localObject8);
              }
            ...
            break label708;
            Object localObject3 = (bcat)((AppRuntime)localObject7).getManager(290);
            ...
            if (localObject3 != null)
            {
              ((bcat)localObject3).a((String)localObject5, (String)localObject6, (String)localObject7, new wyp(this, i, (String)localObject8));
              break label708;
            }
            ...
            for (localObject3 = BaseActivity.sTopActivity;; localObject4 = this.a.getApplicationContext())
            {
              for (;;)
              {
                ...
                try
                {
                  ...
                  ((Context)localObject3).startActivity(nut.a((Context)localObject3, i));
                }
            ...
            label8405:
            localObject5 = (QQAppInterface)localObject7;
            if (bhvh.a((QQAppInterface)localObject5))
            {
              nut.a((QQAppInterface)localObject5, (Context)localObject4, 2, 0);
              break label708;
            }
            nut.a((Context)localObject4, null, -1L, 2);
            break label708;
            i = ((Bundle)localObject8).getInt("seq");
            localObject4 = (QQAppInterface)localObject7;
            localObject5 = ((ajxn)((AppRuntime)localObject7).getManager(51)).b(((QQAppInterface)localObject4).c());
            if (localObject5 != null)
            {
              if (QLog.isColorLevel()) {
            ...
            localObject4 = azad.a(this.a.getApplicationContext(), (QQAppInterface)localObject7, i, j, k);
            ...
            azad.a((QQAppInterface)localObject7, (String)localObject4, i, j);
            break label708;
            i = ((Bundle)localObject8).getInt("deleteType");
            localObject4 = ((Bundle)localObject8).getString("uin");
            j = ((Bundle)localObject8).getInt("msgType");
            azad.b((QQAppInterface)localObject7, (String)localObject4, i, j);
            break label708;
            bool = ((Bundle)localObject8).getBoolean("isSuccess");
            localObject4 = ((Bundle)localObject8).getString("pkgname");
            osm.a().a(null, 101, bool, new String[] { localObject4 });
            break label708;
            localObject4 = obe.a(2);
            if ((localObject4 == null) || (!(localObject4 instanceof nyj))) {
              break label708;
            }
            ((nyj)localObject4).a((Bundle)localObject8);
            break label708;
            oau.a();
            break label708;
            ...
            break label708;
            localObject4 = ((Bundle)localObject8).getString("uin");
            wte.c(BaseApplicationImpl.getContext(), (String)localObject4, null);
            break label708;
            ...
            try
            {
              ...
              if (this.a.jdField_a_of_type_Ajty == null)
              {
                this.a.jdField_a_of_type_Ajty = ((ajty)((AppRuntime)localObject7).getManager(59));
                this.a.jdField_a_of_type_Ajty.a(this);
              }
              ...
              ((Intent)localObject5).putExtra("param_location_param", this.a.jdField_a_of_type_Ajty.b((String[])localObject4));
          ...
          ((bacv)((AppRuntime)localObject7).getManager(346)).a((String)localObject4, bool);
          break label708;
          bool = false;
        }
        continue;
