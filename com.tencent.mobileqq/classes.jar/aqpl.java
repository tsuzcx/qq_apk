...
public class aqpl
  implements RecyclerView.ItemAnimator.ItemAnimatorFinishedListener, View.OnClickListener, aqpx
{
  private static int jdField_a_of_type_Int = 2131167378;
  private static int jdField_b_of_type_Int = 2131167363;
  private static int jdField_c_of_type_Int = 2130839318;
  ...
  public aqpl(Context paramContext, aqpx paramaqpx)
  {
  ...
  {
    f();
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558950, null);
    this.jdField_a_of_type_ComTencentMobileqqColornoteListColorNoteListLayout = ((ColorNoteListLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364832));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364836));
    this.jdField_a_of_type_ComTencentMobileqqWidgetBounceScrollView = ((BounceScrollView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363759));
    ...
    this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131364835));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new aqpm(this));
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(new aqpn(this));
    localObject = new aqpo(this);
    this.jdField_a_of_type_AndroidViewView.setOnTouchListener((View.OnTouchListener)localObject);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131363759).setOnTouchListener((View.OnTouchListener)localObject);
  ...
  private void e()
  {
    ...
    {
      localViewPropertyAnimator.translationX(f).setDuration(180L).setListener(new aqpt(this)).start();
      return;
    }
  }
  ...
  private void f()
  {
    if (ThemeUtil.isNowThemeIsNight(null, false, null))
    {
      ...
      jdField_c_of_type_Int = 2130839319;
      return;
    }
    jdField_a_of_type_Int = 2131167378;
    jdField_b_of_type_Int = 2131167363;
    jdField_c_of_type_Int = 2130839318;
  }
  ...
  {
    this.jdField_a_of_type_Aqpg.a(paramList);
    a();
  }
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    d();
    this.jdField_a_of_type_Aqpg = new aqpg();
    this.jdField_a_of_type_Aqpg.a(this);
    this.jdField_a_of_type_Aqpg.a(paramBoolean);
    Object localObject1 = ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getProxyManager().a().a();
    this.jdField_a_of_type_Aqpg.a((List)localObject1);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Aqpg);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setVisibility(4);
    this.jdField_a_of_type_Aqpg.a(new aqpp(this));
    Object localObject2;
    if (((List)localObject1).size() > 0)
    {
      localObject2 = (ColorNote)((List)localObject1).get(0);
      if (aqoq.b((ColorNote)localObject2)) {
        bdla.b(null, "dc00898", "", "", "0X800A8AA", "0X800A8AA", aqnq.b(aqoq.a(((ColorNote)localObject2).getServiceType())), 0, "", "", "", "");
      }
    }
    ...
    this.jdField_a_of_type_AndroidViewView.animate().alpha(0.9F).setDuration(200L).setListener(new aqps(this, paramBoolean)).start();
    ...
    for (paramInt2 = i;; paramInt2 = i)
    {
      ...
      paramInt1 = i;
      break;
      bdla.b(null, "dc00898", "", "", "0X800A6CD", "0X800A6CD", 0, 0, ((List)localObject1).size() + "", aqnq.a(paramInt1) + "", "", "");
      localObject1 = ((List)localObject1).iterator();
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (ColorNote)((Iterator)localObject1).next();
        if (aqoq.d((ColorNote)localObject2))
        {
          localObject3 = aimq.a((ColorNote)localObject2);
          if (aqoq.c((ColorNote)localObject2)) {}
          for (paramInt1 = 1;; paramInt1 = 2)
          {
            bdla.b(null, "dc00898", "", "", "0X800AE8E", "0X800AE8E", paramInt1, ((UpComingMsgModel)localObject3).reportType, "", "", "", "");
            break;
          }
        }
      }
  ...
  {
    if (this.jdField_a_of_type_Aqpg.getItemCount() == 0) {
      e();
    }
  }
