  ...
  extends MSFServlet
{
  public static NewIntent a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Object localObject = (bcqt)paramQQAppInterface.getManager(61);
    if (localObject != null) {}
    for (localObject = ((bcqt)localObject).a(paramString);; localObject = null)
    {
      if ((!TextUtils.isEmpty(paramString)) && (!TextUtils.isEmpty((CharSequence)localObject)))
      {
        localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), bcqs.class);
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (bool3)
    {
      try
      {
        Object localObject1 = bgau.b(paramFromServiceMsg.getWupBuffer());
        ...
        bcqk.a = ((cmd0xe34.RspBody)localObject2).ReqInterval.get();
      ...
      for (j = 1;; j = 0)
      {
        ...
        localObject3 = (bcqt)getAppRuntime().getManager(61);
        if (localObject3 != null)
        {
          ((bcqt)localObject3).a((SubAccountMessage)localObject2);
          ((bcqt)localObject3).b((SubAccountMessage)localObject2);
          ((bcqt)localObject3).c(((SubAccountMessage)localObject2).subUin);
        }
        localObject2 = new bcqu();
        ((bcqu)localObject2).b = paramFromServiceMsg.getUin();
        ((bcqu)localObject2).jdField_c_of_type_JavaLangString = String.valueOf(l);
        ((bcqu)localObject2).jdField_c_of_type_Boolean = true;
        ((bcqu)localObject2).d = true;
        ((bcqu)localObject2).a = 0;
  ...
  public void a(Intent paramIntent, Packet paramPacket)
  {
    ...
    do
    {
      ...
      paramPacket.putSendData(bgau.a(((oidb_sso.OIDBSSOPkg)localObject1).toByteArray()));
