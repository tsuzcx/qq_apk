...
public class ache
{
  public static String a(DeviceInfo paramDeviceInfo)
  {
    ...
    {
      localObject = ((abur)((QQAppInterface)localObject).a(51)).a(paramDeviceInfo.productId);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, DeviceInfo paramDeviceInfo, String paramString, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramString))
          {
            ...
            bnrt.a().a((Activity)paramContext, paramQQAppInterface, paramQQAppInterface.getAccount(), paramDeviceInfo, "com.tencent.device.activities.DeviceSquareActivity", 0, null, SmartDevicePluginProxyActivity.class);
            achd.a(null, "Usr_NewDevice_Aio", 2, 0, 0);
            return;
          }
        }
        catch (Exception paramQQAppInterface)
        {
          bjtx.c("SmartDeviceUtil", "jumpLightApp, Exception >>>", paramQQAppInterface);
          return;
        }
      ...
      ((abur)paramQQAppInterface.a(51)).a(paramString);
    ...
    paramBundle = (abur)paramQQAppInterface.a(51);
  ...
  public static void a(QQAppInterface paramQQAppInterface, JSONObject paramJSONObject, String paramString)
  {
    ...
    try
    {
      ...
      paramJSONObject = (StructMsgForGeneralShare)bdow.a((Bundle)localObject);
      localObject = (MessageForStructing)bcry.a(-2011);
  ...
  public static void a(String paramString1, Bundle paramBundle, int paramInt, String paramString2, AppRuntime paramAppRuntime, BusinessObserver paramBusinessObserver)
  {
    ...
    paramBundle.putString("version", "8.4.5");
    ...
    paramString1 = new NewIntent(paramAppRuntime.getApplication(), abku.class);
