...
public final class afur
{
  ...
  private static ThreadLocal<char[]> jdField_a_of_type_JavaLangThreadLocal = new afus();
  ...
  public static int a(bcxj parambcxj, String paramString)
  {
    parambcxj = parambcxj.a(paramString);
    ...
    do
    {
      ...
      try
      {
        int i1 = Integer.parseInt(parambcxj);
        return i1;
      }
  ...
  protected static void a()
  {
    boolean bool = true;
    Object localObject;
    if (afsd.jdField_a_of_type_Int == -1)
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (afsd.jdField_a_of_type_Boolean)
        {
          afsd.jdField_a_of_type_Int = i1;
          if (afsd.jdField_a_of_type_Int == -1) {
            afsd.jdField_a_of_type_Int = 0;
          }
          return;
          label111:
          bool = false;
  ...
  public static final void a(QQAppInterface paramQQAppInterface, BaseChatPie paramBaseChatPie, afwy paramafwy, ChatMessage paramChatMessage)
  {
    
    if (afsd.jdField_a_of_type_Int <= 0) {
      return;
    }
    a(paramQQAppInterface, a(paramBaseChatPie, paramafwy, paramChatMessage));
  }
  
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    if (paramBoolean) {
      ((WebProcessManager)paramQQAppInterface.getManager(13)).a(1, new afut());
    }
  }
  ...
  protected static boolean a(BaseChatPie paramBaseChatPie, afwy paramafwy, ChatMessage paramChatMessage)
  {
    boolean bool2 = false;
    boolean bool1;
    int i2;
    if (paramChatMessage == null)
    {
      ...
      if (paramafwy != null)
      {
        ...
        if (paramafwy.size() > 0)
        {
          ...
          i1 = afsd.jdField_a_of_type_Int;
          if (i2 <= i1) {
            break label121;
          }
          i2 = i1;
          label61:
          if (!(paramBaseChatPie instanceof aidp)) {
            break label162;
          }
        }
      }
    ...
    for (int i1 = 1;; i1 = 0)
    {
      ...
      if (i2 > -1)
      {
        paramBaseChatPie = (ChatMessage)paramafwy.get(i2);
        if (i1 == 0) {
          break label124;
        }
        if (!afsd.a(paramBaseChatPie)) {
          break label140;
        }
        bool1 = true;
      }
      ...
      do
      {
        ...
        break;
        break label61;
        if ((!paramBaseChatPie.isread) && (afsd.a(paramBaseChatPie))) {
          return true;
        }
        i2 -= 1;
        break label76;
        bool1 = bool2;
      } while (!afsd.a(paramChatMessage));
      return true;
    }
  }
  ...
  private static boolean a(BaseActivity paramBaseActivity, QQAppInterface paramQQAppInterface, Intent paramIntent)
  {
    try
    {
      ...
      if (i1 == -1)
      {
        QQToast.a(paramBaseActivity, paramBaseActivity.getString(2131718060), 0).b(paramBaseActivity.getTitleBarHeight());
        return false;
      }
      if (paramIntent.hasExtra("account"))
      {
        bcst.b(paramQQAppInterface, "CliOper", "", "", "Fast_launch", "Fast_launch_msg", 0, 0, "1", "", "", "");
        if (!((anmw)paramQQAppInterface.getManager(51)).b(str))
        {
      ...
      if ((paramIntent.getBooleanExtra("shortcut", false)) && (!((anmw)paramQQAppInterface.getManager(51)).b(str)))
      {
        QQToast.a(paramBaseActivity.getApplicationContext(), paramBaseActivity.getString(2131718061), 0).b(paramBaseActivity.getTitleBarHeight());
        return false;
      }
      return true;
    }
  ...
  {
    bgso.a(null, "AIO_doOnCreate_BeforeEnterCost");
    ...
    do
    {
      do
      {
        ...
        return true;
        if (!aane.a().a(paramIntent, paramBaseActivity, paramQQAppInterface)) {
          break;
        }
      } while (!QLog.isColorLevel());
    ...
    label212:
    bgso.a("AIO_doOnCreate_BeforeEnterCost", null);
    return false;
  }
