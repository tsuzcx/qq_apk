    ...
    for (;;)
    {
      ...
      if (this.a.jdField_a_of_type_Akcy != null)
      {
        ...
        if (this.a.jdField_a_of_type_Akcy != null)
        {
          ...
          this.a.c = false;
          akce.a(this.a).setVisibility(8);
          akce.a(this.a, 0, null);
          this.a.jdField_a_of_type_Akcc.a(akce.a(this.a), this.a.jdField_a_of_type_JavaLangString, this.a.jdField_a_of_type_Long);
          this.a.jdField_a_of_type_Akcc.notifyDataSetChanged();
          this.a.b = 1;
