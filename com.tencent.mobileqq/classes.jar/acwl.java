...
public class acwl
  implements acxd, adjv, Handler.Callback, View.OnClickListener, View.OnTouchListener, bhbw
{
  private int jdField_a_of_type_Int;
  private acwi jdField_a_of_type_Acwi;
  private acwv jdField_a_of_type_Acwv;
  private acww jdField_a_of_type_Acww;
  private adjy jdField_a_of_type_Adjy;
  ajxj jdField_a_of_type_Ajxj = new acwo(this);
  public Context a;
  ...
  public acwl(QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, Context paramContext, String paramString)
  {
    ...
    catch (NumberFormatException paramString)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_AndroidViewView = paramString.findViewById(2131375512);
          this.jdField_b_of_type_AndroidViewView = paramString.findViewById(2131377444);
          this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramString.findViewById(2131362988));
          this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramString.findViewById(2131377408));
          this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramString.findViewById(2131369906));
          if (!this.jdField_h_of_type_Boolean) {
            break label1193;
          }
          localObject = LayoutInflater.from(paramContext).inflate(2131559144, null);
          this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject).findViewById(2131375829));
          ...
          this.jdField_c_of_type_AndroidViewView = ((View)localObject).findViewById(2131364557);
          this.jdField_d_of_type_AndroidViewView = ((View)localObject).findViewById(2131364559);
          this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131364558));
          this.jdField_e_of_type_AndroidViewView = ((View)localObject).findViewById(2131374892);
          this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject).findViewById(2131374890));
          this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131374891));
          this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131374893));
          this.jdField_i_of_type_AndroidViewView = ((View)localObject).findViewById(2131365510);
          ...
          this.jdField_j_of_type_AndroidViewView = ((View)localObject).findViewById(2131369597);
          this.k = ((View)localObject).findViewById(2131369594);
          this.jdField_h_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131369596));
          this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)((View)localObject).findViewById(2131369896));
          ...
          this.jdField_a_of_type_Acww = new acww(this, null);
          this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setDividerWidth(bbll.a(5.0F));
          this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setOverScrollMode(2);
          this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setAdapter(this.jdField_a_of_type_Acww);
          this.jdField_a_of_type_Acwv = new acwv(this, null);
          this.jdField_b_of_type_ComTencentWidgetHorizontalListView.setDividerWidth(bbll.a(5.0F));
          this.jdField_b_of_type_ComTencentWidgetHorizontalListView.setAdapter(this.jdField_a_of_type_Acwv);
          ...
          {
            this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(ajya.a(2131705818));
            this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(ajya.a(2131705828));
            this.jdField_c_of_type_AndroidWidgetImageView.setContentDescription(ajya.a(2131705833));
            this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(ajya.a(2131705831));
          }
        ...
        bool = false;
        continue;
        bool = bhby.b(paramFragmentActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        continue;
        bool = false;
        continue;
        label1171:
        ...
        continue;
        label1200:
        this.jdField_a_of_type_ComTencentMobileqqWidgetBounceScrollView = ((BounceScrollView)paramString.findViewById(2131375662));
  ...
  {
    int i1 = asxb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, paramPrefetchMutualMarkInfo.type, paramPrefetchMutualMarkInfo.level);
    if (i1 == 0) {
      return null;
    }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (String str = asyg.b(paramInt1, paramInt2); (!TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) && (str.equals(this.jdField_c_of_type_JavaLangString)); str = asyg.a(paramInt1, paramInt2)) {
      return;
    }
    Object localObject;
    if (paramInt1 == 3) {
      localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840141);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      return;
      if (paramInt1 == 2) {
        localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840139);
      } else if (paramInt1 == 1) {
        localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840143);
      } else {
        localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840147);
      }
    }
    this.jdField_a_of_type_AndroidViewView.setBackgroundDrawable((Drawable)localObject);
  }
  ...
  private void a(IntimateInfo paramIntimateInfo)
  {
    ...
    if (paramIntimateInfo.beFriendDays >= -1) {
      if (this.jdField_a_of_type_Int == 3)
      {
        ...
        if (paramIntimateInfo.memoryDayInfoList != null)
        {
          ...
          if (this.jdField_a_of_type_Adjy == null)
          {
            this.jdField_a_of_type_Adjy = new adjy(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString);
            this.jdField_a_of_type_Adjy.a(new acwr(this));
          }
          localObject1 = new ArrayList(paramIntimateInfo.memoryDayInfoList);
          this.jdField_a_of_type_Adjy.a(this.jdField_a_of_type_AndroidContentContext, (ArrayList)localObject1);
          if ((this.jdField_a_of_type_Adjy.a() != null) && (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null))
          {
            this.jdField_a_of_type_AndroidWidgetRelativeLayout.removeAllViews();
            this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(this.jdField_a_of_type_Adjy.a());
          }
        }
        ...
        label482:
        if (this.jdField_b_of_type_Boolean) {
          axqy.b(null, "dc00898", "", "", "0X8009F51", "0X8009F51", this.jdField_b_of_type_Int, 0, "", "", "", "");
        }
      }
    }
    for (;;)
    ...
    if (this.jdField_b_of_type_Boolean) {
      axqy.b(null, "dc00898", "", "", "0X8009F52", "0X8009F52", this.jdField_b_of_type_Int, 0, "", "", "", "");
    }
    label909:
    ...
    if (!((ArrayList)localObject1).isEmpty()) {
      if ((paramIntimateInfo.markInfoList == null) || (paramIntimateInfo.markInfoList.isEmpty()))
      {
        ...
        this.jdField_g_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693633));
        this.jdField_f_of_type_AndroidViewView.setVisibility(0);
        this.jdField_a_of_type_Acww.a((List)localObject1);
        this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setVisibility(0);
        this.jdField_g_of_type_Boolean = asxa.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        label1126:
        ...
        localObject1 = null;
        if (this.jdField_a_of_type_Asrs != null) {
          localObject1 = this.jdField_a_of_type_Asrs.a();
        }
        if (localObject1 != null) {
          break label1990;
        }
        localObject1 = adjw.a(this.jdField_a_of_type_AndroidContentContext);
      }
    }
    label1541:
    label1547:
    ...
    for (;;)
    {
      ...
      if (((IntimateInfo.DNAInfo)localObject4).viceTitle != null)
      {
        ...
        if (!TextUtils.isEmpty(((IntimateInfo.DNAInfo)localObject4).linkWording))
        {
          ...
          ((SpannableString)localObject2).setSpan(new acws(this, (IntimateInfo.DNAInfo)localObject4), i2, i3, 33);
      ...
      for (;;)
      {
        ...
        ((LinearLayout.LayoutParams)localObject2).topMargin = bbll.a(16.0F);
          ...
          if (((IntimateInfo.CommonBody)localObject2).cmd == 3436)
          {
            ...
            if ((paramIntimateInfo.friendGiftInfo != null) && (paramIntimateInfo.friendGiftInfo.str_send_times > 0))
            {
              ...
              if (paramIntimateInfo.friendGiftInfo.str_gift_url.size() > 6) {
                this.jdField_a_of_type_Acwv.a(paramIntimateInfo.friendGiftInfo.str_gift_url.subList(0, 6));
              }
              for (;;)
              {
                ...
                axqy.b(null, "dc00898", "", "", "0X800A3B3", "0X800A3B3", this.jdField_b_of_type_Int, 0, "", "", "", "");
                break;
                this.jdField_a_of_type_Acwv.a(paramIntimateInfo.friendGiftInfo.str_gift_url);
              }
            }
      ...
      if (this.jdField_b_of_type_Boolean)
      {
        axqy.b(null, "dc00898", "", "", "0X8009F4D", "0X8009F4D", this.jdField_b_of_type_Int, 0, "", "", "", "");
        if (this.jdField_b_of_type_Int == 2) {
          axqy.b(null, "dc00898", "", "", "0X800A05F", "0X800A05F", 0, 0, "", "", "", "");
        }
      }
  ...
  {
    axqy.b(null, "dc00898", "", "", "0X800A11A", "0X800A11A", this.jdField_b_of_type_Int, 0, "", "", "", "");
    if (this.jdField_a_of_type_ComTencentImageURLDrawable == null)
    {
      c(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131694100));
      URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
    ...
    this.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new acwu(this));
  ...
  private void a(String paramString, int paramInt)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      this.jdField_a_of_type_Aqkh.a(paramString, this.jdField_a_of_type_ComTencentMobileqqDataIntimateInfo.maskType);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      localMessage.what = 1;
      localMessage.obj = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131719767);
  ...
  {
    if (!asxb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMutualMarkInfo.type)) {}
    int i1;
    do
    {
      return false;
      int i2 = asxb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, paramMutualMarkInfo.type, paramMutualMarkInfo.level);
      asyb localasyb = asxb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMutualMarkInfo.type);
      i1 = i2;
      if (localasyb != null)
      {
        i1 = i2;
        if (localasyb.jdField_b_of_type_Boolean) {
          i1 = 0;
        }
      }
  ...
  {
    int i2 = actj.a(45.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  ...
  private void b(String paramString)
  {
    ...
    bhzx localbhzx = new bhzx();
    try
    {
      localbhzx.a(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()), Long.parseLong(paramString));
      return;
    }
  ...
  private void s()
  {
    ...
    axqy.b(null, "dc00898", "", "", "0X800A119", "0X800A119", this.jdField_b_of_type_Int, 0, "", "", "", "");
    this.jdField_a_of_type_Bfpc = bfpc.c(this.jdField_a_of_type_AndroidContentContext);
    String str = asyg.c(this.jdField_a_of_type_ComTencentMobileqqDataIntimateInfo.maskType, this.jdField_a_of_type_ComTencentMobileqqDataIntimateInfo.maskLevel);
    if (!TextUtils.isEmpty(str)) {
      this.jdField_a_of_type_Bfpc.a(2131693645, 0);
    }
    if (this.jdField_e_of_type_Boolean) {
      this.jdField_a_of_type_Bfpc.a(2131693612, 3);
    }
    for (;;)
    {
      this.jdField_a_of_type_Bfpc.a(new acwt(this, str));
      this.jdField_a_of_type_Bfpc.c(2131690596);
      this.jdField_a_of_type_Bfpc.show();
      return;
      this.jdField_a_of_type_Bfpc.a(2131693624, 0);
    }
  }
  ...
  private void t()
  {
    ...
    String str = asyg.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
  ...
  private void u()
  {
    ...
    if (this.jdField_a_of_type_Bbgu == null) {
      this.jdField_a_of_type_Bbgu = bbdj.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 230).setMessage(2131693616).setPositiveButton(2131693615, new acwn(this)).setNegativeButton(2131693614, new acwm(this));
    }
  ...
  private void x()
  {
    ...
    bcql.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 1, ajya.a(2131705819), 1).a();
  }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataIntimateInfo != null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqDataIntimateInfo.memoryDayInfoList != null)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          {
            axqy.b(null, "dc00898", "", "", "0X800A207 ", "0X800A207 ", localMemoryDayInfo.dateType, 0, "", "", "", "");
  ...
  public void c()
  {
    if ((!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) && (bbfj.g(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)))
    {
      if (this.jdField_a_of_type_Aqkh == null) {
        this.jdField_a_of_type_Aqkh = ((aqkh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(153));
      }
      this.jdField_a_of_type_Aqkh.b(this.jdField_a_of_type_JavaLangString);
    }
  }
  ...
  public void d()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 100	acwl:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   4: invokestatic 599	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   7: ifne +55 -> 62
    //   10: aload_0
    //   11: getfield 96	acwl:jdField_a_of_type_AndroidSupportV4AppFragmentActivity	Landroid/support/v4/app/FragmentActivity;
    //   14: invokestatic 1094	bbfj:g	(Landroid/content/Context;)Z
    //   17: ifeq +152 -> 169
    //   20: aload_0
    //   21: getfield 1096	acwl:jdField_a_of_type_Aqkh	Laqkh;
    //   24: ifnonnull +20 -> 44
    //   27: aload_0
    //   28: aload_0
    //   29: getfield 94	acwl:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   32: sipush 153
    //   35: invokevirtual 1099	com/tencent/mobileqq/app/QQAppInterface:a	(I)Lajtb;
    //   38: checkcast 1101	aqkh
    //   41: putfield 1096	acwl:jdField_a_of_type_Aqkh	Laqkh;
    //   44: aload_0
    //   45: getfield 791	acwl:jdField_a_of_type_Asrs	Lasrs;
    //   48: ifnonnull +45 -> 93
    //   51: aload_0
    //   52: getfield 1096	acwl:jdField_a_of_type_Aqkh	Laqkh;
    //   55: aload_0
    //   56: getfield 100	acwl:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   59: invokevirtual 1404	aqkh:a	(Ljava/lang/String;)V
    ...
    //   80: iconst_0
    //   81: aload_0
    //   82: getfield 100	acwl:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   85: aastore
    ...
    //   100: astore 5
    //   102: aload_0
    //   103: getfield 100	acwl:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   112: lstore_3
    //   113: aload_0
    //   114: getfield 1382	acwl:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   133: pop
    //   134: aload_0
    //   135: getfield 1096	acwl:jdField_a_of_type_Aqkh	Laqkh;
    //   138: lload_1
    //   139: aload 5
    //   141: aconst_null
    //   142: invokevirtual 1419	aqkh:a	(JLjava/util/ArrayList;Ljava/lang/Object;)V
    //   145: goto -83 -> 62
    //   148: astore 6
    //   150: lconst_0
    //   151: lstore_1
    ...
    //   166: goto -42 -> 124
    //   169: aload_0
    //   170: getfield 546	acwl:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    ...
    //   184: aload 5
    //   186: aload_0
    //   187: getfield 98	acwl:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   202: aload_0
    //   203: getfield 546	acwl:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   206: aload 5
    ...
    //   224: iconst_0
    //   225: aload_0
    //   226: getfield 100	acwl:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   229: aastore
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        return true;
        w();
        bcql.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 2, 2131693617, 1).a();
        return true;
        d();
        bcql.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 2, 2131693618, 1).a();
        return true;
  ...
  public void i()
  {
    ...
    if (this.jdField_a_of_type_Acwi != null) {
      this.jdField_a_of_type_Acwi.b();
    }
    if (this.jdField_a_of_type_Adjy != null)
    {
      this.jdField_a_of_type_Adjy.a();
      this.jdField_a_of_type_Adjy = null;
    }
  ...
  public void k()
  {
    ...
    for (;;)
    {
      ...
      axqy.b(null, "dc00898", "", "", "0X800A3C1", "0X800A3C1", this.jdField_b_of_type_Int, 0, "", "", "", "");
      return;
      if (this.jdField_a_of_type_Int == 2) {
        i1 = 2;
  ...
  public void l()
  {
    ...
    axqy.b(null, "dc00898", "", "", "0X800A3C2", "0X800A3C2", this.jdField_b_of_type_Int, 0, "", "", "", "");
  }
    ...
    do
    {
      do
      {
        ...
        case 2131364559: 
          ...
          axqy.b(null, "dc00898", "", "", "0X8009F4E", "0X8009F4E", this.jdField_b_of_type_Int, 0, "", "", "", "");
          return;
        }
      ...
      Object localObject = actj.a(new Intent(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, SplashActivity.class), null);
      ...
      axqy.b(null, "dc00898", "", "", "0X8009F4F", "0X8009F4F", this.jdField_b_of_type_Int, 0, "", "", "", "");
      return;
      paramView = new Intent(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, QQBrowserActivity.class);
      localObject = amtf.a().a(this.jdField_a_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
      ...
      if (this.jdField_g_of_type_Boolean)
      {
        ...
        asxa.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      axqy.b(null, "dc00898", "", "", "0X8009F50", "0X8009F50", this.jdField_b_of_type_Int, 0, "", "", "", "");
      return;
      asay.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 2064, "2");
      axqy.b(null, "dc00898", "", "", "0X800A05E", "0X800A05E", 0, 0, "", "", "", "");
      return;
      paramView = new Intent(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, QQBrowserActivity.class);
      ...
      axqy.b(null, "dc00898", "", "", "0X800A3B4", "0X800A3B4", this.jdField_b_of_type_Int, 0, "", "", "", "");
      return;
    } while (this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity == null);
  ...
  public void p()
  {
    ...
    if (this.jdField_a_of_type_Bhzz == null) {
      this.jdField_a_of_type_Bhzz = new bhzz();
    }
    this.jdField_a_of_type_Bhzz.a(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()));
