  ...
  extends ajmm
{
  ...
  public void a(boolean paramBoolean1, List<MessageRecord> paramList, boolean paramBoolean2)
  {
    ...
    boolean bool = acwe.a(this.a).a().e();
    acwe.a(this.a).a().removeMessages(267387140);
    ...
    if (paramBoolean1)
    {
      acwe.a(this.a).a().sendEmptyMessage(267387139);
      if ((localObject1 != null) && (!((List)localObject1).isEmpty()))
      {
        arxu.a().a((List)localObject1);
        aael.a((List)localObject1);
        aael.b((List)localObject1);
        advs.a((MessageRecord)((List)localObject1).get(0));
        localObject2 = (ChatMessage)((List)localObject1).get(0);
        acwe.a(this.a).a().a((ChatMessage)localObject2);
        if (!(localObject2 instanceof MessageForPtt)) {
          break label407;
        }
        localObject1 = (MessageForPtt)((List)localObject1).get(0);
        localObject2 = MediaPlayerManager.a(acwe.a(this.a)).a();
        if ((localObject2 == localObject1) || (((localObject2 instanceof MessageForPtt)) && (((ChatMessage)localObject2).frienduin != null) && (((ChatMessage)localObject2).frienduin.equals(((MessageForPtt)localObject1).frienduin)) && (((ChatMessage)localObject2).uniseq == ((MessageForPtt)localObject1).uniseq))) {
          MediaPlayerManager.a(acwe.a(this.a)).a(true);
        }
      }
      if ((paramBoolean2) && (bool)) {
        awqx.b(acwe.a(this.a), "CliOper", "", "", "0X80056B2", "0X80056B2", 0, 0, "", "", "", "");
      }
    }
    for (;;)
    {
      for (;;)
      {
        ...
        {
          acwe.a(this.a).e(131072);
          adot.a(acwe.a(this.a).a);
          break;
        }
        if ((localObject2 instanceof MessageForStructing))
        {
          ...
          QQPlayerService.c(acwe.a(this.a));
          break;
        }
        if ((localObject2 instanceof MessageForApollo))
        {
          ...
          aisc.a(((MessageForApollo)localObject1).uniseq, acwe.a(this.a), "withdraw_msg");
          if (((MessageForApollo)localObject1).mApolloMessage == null) {
            break;
          }
          bajr.a(acwe.a(this.a), "cmshow", "Apollo", "withdraw_success", ApolloUtil.b(acwe.a(this.a).jdField_a_of_type_Int), 0, new String[] { Integer.toString(((MessageForApollo)localObject1).mApolloMessage.id) });
          break;
        }
        ...
        try
        {
          ...
          acwe.a(this.a).a().b(((ChatMessage)localObject2).frienduin, ((ChatMessage)localObject2).istroop, l, true);
        }
      ...
      break;
      acwe.a(this.a).a().sendEmptyMessage(267387140);
    }
  }
  ...
  public void a(boolean paramBoolean, String[] paramArrayOfString)
  {
    ...
    if ((acwe.a(this.a) == null) || (acwe.a(this.a) == null) || (!paramBoolean)) {
      return;
    }
    ((aifc)acwe.a(this.a).getManager(211)).a(3, acwe.a(this.a).jdField_a_of_type_JavaLangString, acwe.a(this.a).jdField_a_of_type_Int);
  }
  
  public void b(int paramInt)
  {
    if ((acwe.a(this.a).jdField_a_of_type_Int == 0) || (acwe.a(this.a).jdField_a_of_type_Int == 3000) || (acwe.a(this.a).jdField_a_of_type_Int == 1)) {
      acwe.a(this.a).a().post(new AIORevokeMsgHelper.7.1(this, paramInt));
    }
  }
}
