  ...
  implements View.OnTouchListener
{
  ...
  public static final int[] c = { 2130844643, 2130844646 };
  public static final int[] d = { 2131378570, 2131378571 };
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 2131363853, 2131363854 };
    jdField_b_of_type_ArrayOfInt = new int[] { 2130844642, 2130844645 };
  }
  
  public zlk(zln paramzln, View paramView, int paramInt)
  {
  ...
  public void a(CharSequence paramCharSequence)
  {
    ...
    for (CharSequence localCharSequence = this.jdField_a_of_type_AndroidWidgetTextView.getHint();; localCharSequence = paramCharSequence)
    {
      ...
      if (this.jdField_b_of_type_AndroidWidgetTextView.getVisibility() == 0)
      {
        ...
        k = zlx.a(this.jdField_a_of_type_AndroidWidgetTextView.getContext(), 72.5F);
      ...
      for (;;)
      {
        ...
        break;
        label201:
        k = zlx.a(this.jdField_a_of_type_AndroidWidgetTextView.getContext(), 84.0F);
      ...
      if ((n <= k) || (i == arrayOfFloat1.length - 1))
      {
        ...
        yqp.a("Q.qqstory.widget.PollWidgetUtils", "text size = %s", Float.valueOf(arrayOfFloat1[i]));
      }
      for (;;)
      {
        paramCharSequence = zlc.a(this.jdField_a_of_type_AndroidWidgetTextView, 2);
        this.jdField_a_of_type_AndroidWidgetTextView.setText(paramCharSequence);
  ...
  public void a(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130844592);
      return;
    }
  ...
  {
    if ((a()) || (this.jdField_a_of_type_Zlh == null) || (!this.jdField_a_of_type_Zln.a())) {
