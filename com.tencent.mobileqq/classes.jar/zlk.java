  ...
  implements Runnable
{
  ...
  private zlk(GroupIconHelper paramGroupIconHelper)
  {
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      for (;;)
      {
        synchronized (GroupIconHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppGroupIconHelper))
        {
          ...
          localzln = (zln)GroupIconHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppGroupIconHelper).get(localObject7);
          if ((localzln != null) && (localzln.jdField_b_of_type_Int >= 8))
          {
            ...
            QLog.d("Q.qqhead.dih", 2, "CheckDisIcon, maxCreateCnt: " + (String)localObject7 + ",crateIconCount=" + localzln.jdField_b_of_type_Int);
          }
        }
        if ((localzln != null) && (!localzln.e))
        {
          if (QLog.isColorLevel()) {
        ...
        {
          if ((localzln == null) || (localzln.jdField_a_of_type_JavaLangString == null) || (localzln.jdField_a_of_type_Byte == 3)) {
            break label866;
          }
          if ((localzln.jdField_a_of_type_Byte == 1) && (l - localzln.jdField_a_of_type_Long >= GroupIconHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppGroupIconHelper)))
          {
            ...
            j = localzln.jdField_a_of_type_JavaUtilArrayList.size();
            localzln.jdField_a_of_type_Byte = 2;
            if (j <= 0) {
              break label885;
            }
            bool2 = true;
            bool1 = bool2;
            if (localzln.jdField_b_of_type_JavaLangString != null)
            {
              String str = GroupIconHelper.a(localzln.jdField_a_of_type_JavaUtilArrayList, false);
              bool1 = bool2;
              if (localzln.jdField_b_of_type_JavaLangString.equals(str)) {
                bool1 = false;
              }
            }
            bool2 = bool1;
            if (bool1)
            {
              ((ArrayList)localObject4).add(Pair.create(localObject7, localzln));
    ...
    for (boolean bool2 = bool1;; bool2 = false)
    {
      if (QLog.isColorLevel())
      {
        QLog.d("Q.qqhead.dih", 2, "CheckDisIcon expired: " + (String)localObject7 + ", isTryCreate: " + bool2 + localzln.toString());
        break label878;
        if ((localzln.jdField_a_of_type_Byte == 2) && (l - localzln.jdField_a_of_type_Long >= GroupIconHelper.b(this.jdField_a_of_type_ComTencentMobileqqAppGroupIconHelper)))
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.qqhead.dih", 2, "CheckDisIcon timeout: " + (String)localObject7 + localzln.toString());
          }
          ...
          for (;;)
          {
            ...
            if ((this.jdField_a_of_type_Boolean) && (localObject4 != null))
            {
              ...
              while ((j < ((ArrayList)localObject4).size()) && (this.jdField_a_of_type_Boolean))
              {
                ...
                GroupIconHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppGroupIconHelper, (String)((Pair)localObject7).first, (zln)((Pair)localObject7).second, true);
                j += 1;
              }
            }
