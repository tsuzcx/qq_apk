  ...
  extends mxk
{
  public qqstory_struct.ErrorInfo a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    if ((paramInt != 0) || (paramArrayOfByte == null))
    {
      ...
      vel.b("story_net", tnj.a, 0, paramInt, new String[] { "", l + "", vel.a(BaseApplication.getContext()) });
      return null;
    }
    for (;;)
    {
      try
      {
        ...
        if (paramInt == 0)
        {
          ...
          if (paramBundle.mErrorCode == 0) {
            ((tcz)tdc.a(5)).a(paramBundle.mVid, paramBundle);
          }
      ...
      catch (InvalidProtocolBufferMicroException paramArrayOfByte)
      {
        ...
        a(-1, null, null);
        return null;
        ((sto)tdc.a(28)).b((List)localObject1);
