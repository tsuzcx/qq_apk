  ...
  extends BaseAdapter
{
  ...
  private avzp jdField_a_of_type_Avzp;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private ArrayList<AutoReplyText> jdField_a_of_type_JavaUtilArrayList;
  private boolean jdField_a_of_type_Boolean;
  private boolean b;
  
  public avzg(QQAppInterface paramQQAppInterface, Context paramContext, Drawable paramDrawable)
  {
  ...
  {
    paramLayoutInflater = paramLayoutInflater.inflate(2131558421, paramViewGroup, false);
    paramViewGroup = (TextView)paramLayoutInflater.findViewById(2131364770);
    ViewGroup.MarginLayoutParams localMarginLayoutParams = (ViewGroup.MarginLayoutParams)paramViewGroup.getLayoutParams();
    if (getItemViewType(paramInt) == 0)
    {
      localMarginLayoutParams.topMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298280);
      localMarginLayoutParams.bottomMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298277);
      paramViewGroup.setText(2131690351);
      paramViewGroup.setContentDescription(this.jdField_a_of_type_AndroidContentContext.getString(2131690351));
    }
    for (;;)
    {
      paramViewGroup.setLayoutParams(localMarginLayoutParams);
      return paramLayoutInflater;
      localMarginLayoutParams.bottomMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298280);
      localMarginLayoutParams.topMargin = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298277);
      paramViewGroup.setText(2131690357);
      paramViewGroup.setContentDescription(this.jdField_a_of_type_AndroidContentContext.getString(2131690357));
    }
  }
  
  private avzq a(LayoutInflater paramLayoutInflater, int paramInt, View paramView, ViewGroup paramViewGroup, AutoReplyText paramAutoReplyText)
  {
    if ((paramView == null) || (paramView.getTag() == null) || (paramView.getVisibility() == 8))
    {
      paramView = paramLayoutInflater.inflate(2131558418, paramViewGroup, false);
      paramLayoutInflater = paramView.findViewById(2131365348);
      if (ThemeUtil.isDefaultTheme())
      {
        ...
        if ((!ThemeUtil.isDefaultTheme()) && (!ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, null))) {
          paramView.findViewById(2131375612).setBackgroundResource(2130839263);
        }
        paramView.findViewById(2131369345).setPadding(0, 0, 0, 0);
        paramView.findViewById(2131375784).setVisibility(8);
        paramViewGroup = (TextView)paramView.findViewById(2131369366);
        paramViewGroup.setEditableFactory(new avzi(this, paramViewGroup));
        paramLayoutInflater = new avzq(null);
        ...
        paramLayoutInflater.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131375761));
        paramLayoutInflater.b = paramView.findViewById(2131365484);
        paramLayoutInflater.c = paramView.findViewById(2131365485);
        paramLayoutInflater.d = paramView.findViewById(2131377582);
        paramLayoutInflater.jdField_a_of_type_AndroidViewView.setTag(paramLayoutInflater);
        label200:
        paramLayoutInflater.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new avzj(this, paramAutoReplyText));
        paramLayoutInflater.b.setOnClickListener(new avzk(this, paramAutoReplyText));
        ...
        paramView = baiy.a(paramView, paramLayoutInflater.jdField_a_of_type_AndroidWidgetTextView.getPaint(), 3, i, azgq.a - azgq.a(67.0F), true);
        if (QLog.isColorLevel()) {
          QLog.d("AutoReplyAdapter", 2, "Truncate subText: " + paramView);
        }
        paramViewGroup = new baig(paramView, 3, i);
        ...
        paramLayoutInflater.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(new baig(alpo.a(2131701229) + paramView, 3, i));
        paramLayoutInflater.c.setOnClickListener(new avzl(this, paramAutoReplyText, bool));
        paramLayoutInflater.jdField_a_of_type_AndroidViewView.findViewById(2131375612).setOnClickListener(new avzm(this, paramAutoReplyText));
    ...
    label562:
    label567:
    for (paramInt = 0;; paramInt = azgq.a(200.0F))
    {
      ...
      paramInt = 8;
      break;
      paramLayoutInflater = (avzq)paramView.getTag();
      paramLayoutInflater.jdField_a_of_type_AndroidViewView = paramView;
      break label200;
      paramInt = 0;
      break label259;
  ...
  private void a(View paramView, int paramInt)
  {
    ...
    avzn localavzn = new avzn(this, paramView, paramView.getMeasuredHeight());
    localavzn.setAnimationListener(new avzo(this, paramInt));
    localavzn.setDuration(150L);
    paramView.startAnimation(localavzn);
  }
  
  private View b(LayoutInflater paramLayoutInflater, int paramInt, ViewGroup paramViewGroup)
  {
    paramLayoutInflater = paramLayoutInflater.inflate(2131558416, paramViewGroup, false);
    paramLayoutInflater.setOnClickListener(new avzh(this));
    return paramLayoutInflater;
  }
  ...
  private void b(int paramInt)
  {
    ...
    if (((Iterator)localObject).hasNext())
    {
      ...
      if (localAutoReplyText.getTextId() == paramInt)
      {
        ...
        {
          avzp localavzp = this.jdField_a_of_type_Avzp;
          if (localAutoReplyText.getTextId() == 2147483647)
          {
            bool = true;
            localavzp.a(localAutoReplyText, bool);
          }
        }
        else
        {
  ...
  public void a(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      this.b = bool;
      if (this.jdField_a_of_type_Avzp != null) {
        this.jdField_a_of_type_Avzp.a(localObject2, localObject1);
      }
      notifyDataSetChanged();
      return;
    }
  ...
  public void a(@Nullable avzp paramavzp)
  {
    this.jdField_a_of_type_Avzp = paramavzp;
  }
  ...
  public void a(@Nullable AutoReplyText paramAutoReplyText)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Avzp != null) {
        this.jdField_a_of_type_Avzp.a(paramAutoReplyText);
      }
      a();
      this.b = true;
      notifyDataSetChanged();
