...
{
  private static final String jdField_a_of_type_JavaLangString = anni.a(2131711912);
  ...
  public stp(@NonNull Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
  }
  
  public stp(@NonNull Context paramContext, Runnable paramRunnable)
  {
    this(paramContext, 0);
  ...
  private Drawable a()
  {
    float f = afur.a(3.0F, getContext().getResources());
  ...
  private SpannableString a()
  {
    ...
    localSpannableString.setSpan(new stq(this, Color.parseColor("#12B7F5")), i, "《QQ看点用户行为规范》".length() + i, 33);
  ...
  public static boolean a(BaseActivity paramBaseActivity, Runnable paramRunnable)
  {
    ...
    paramRunnable = new stp(paramBaseActivity, paramRunnable);
    paramRunnable.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    paramRunnable.show();
    oat.a(null, "", "0X800992C", "0X800992C", 0, 0, "", "", "", "");
    return false;
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    paramBundle = LayoutInflater.from(getContext()).inflate(2131560146, null);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramBundle.findViewById(2131365028));
    this.jdField_a_of_type_AndroidWidgetTextView.setFocusable(false);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramBundle.findViewById(2131362305));
    this.jdField_a_of_type_AndroidViewView = paramBundle.findViewById(2131364554);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(a());
    this.jdField_a_of_type_AndroidWidgetTextView.setMovementMethod(new str());
    ...
    paramBundle.findViewById(2131363382).setBackgroundDrawable(localDrawable);
    setContentView(paramBundle);
    paramBundle = getWindow().getAttributes();
    paramBundle.height = -2;
    paramBundle.width = afur.a(320.0F, getContext().getResources());
