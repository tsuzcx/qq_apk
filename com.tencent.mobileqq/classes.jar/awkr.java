...
public class awkr
{
  public static long a(String paramString)
  {
    ...
    {
      awiw.b("compress.Utils", "getFileSize()", "path is empty, or file does not exist. path:" + paramString);
      return 0L;
    }
  ...
  public static Bitmap a(Bitmap paramBitmap)
  {
    ...
    awiw.a("compress.Utils", "compositingWhiteBg()", "compositingWhiteBg is success");
    return paramBitmap;
  }
  
  private static awkt a(int paramInt1, int paramInt2, int paramInt3)
  {
    return a(paramInt1, paramInt2, paramInt3, null);
  }
  
  private static awkt a(int paramInt1, int paramInt2, int paramInt3, ThumbWidthHeightDP paramThumbWidthHeightDP)
  {
    int k = 1;
    int m = 0;
    int i;
    ...
    for (;;)
    {
      paramThumbWidthHeightDP = new awkt(null);
      paramThumbWidthHeightDP.a = paramInt2;
      paramThumbWidthHeightDP.b = paramInt1;
      awiw.a("compress.Utils", "getType()", " type=" + paramThumbWidthHeightDP);
  ...
  {
    if ((!TextUtils.isEmpty(paramString)) && (bdhb.a(paramString)))
    {
      String str2 = bbck.a(alof.aX + "thumb/");
    ...
    awiw.a("compress.Utils", "getThumbnailPath()", "realpath is empty, or file does not exist, realpath:" + paramString);
    return "";
  }
  
  public static String a(String paramString, int paramInt)
  {
    if ((!TextUtils.isEmpty(paramString)) && (bdhb.a(paramString)) && (awkk.a(paramInt)))
    {
      int i = paramString.lastIndexOf("/");
      int j = paramString.lastIndexOf(".");
      Object localObject;
    ...
    awiw.a("compress.Utils", "getSendPhotoPath()", "realpath is empty, or file does not exist, or picQuality Illegal realpath:" + paramString + " picQuality:" + paramInt);
    return "";
  }
  ...
  public static void a(Context paramContext, List<CompressInfo> paramList)
  {
    ...
    if (paramList.size() > 1)
    {
      ...
      j = 0;
      localObject1 = "";
      str2 = BaseApplication.getContext().getString(2131691061);
      str3 = BaseApplication.getContext().getString(2131691062);
      str4 = BaseApplication.getContext().getString(2131691057);
      str5 = BaseApplication.getContext().getString(2131691058);
      i1 = 0;
      i = 0;
      str1 = "";
      str6 = BaseApplication.getContext().getString(2131691059);
      str7 = BaseApplication.getContext().getString(2131691060);
      localObject3 = BaseApplication.getContext().getString(2131691064);
      localObject2 = BaseApplication.getContext().getString(2131691065);
  ...
  {
    return bdin.b(BaseApplication.getContext()) == 1;
  }
  ...
  public static boolean a(Bitmap paramBitmap, awkt paramawkt, boolean paramBoolean, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    return a(paramBitmap, paramawkt, paramBoolean, paramString1, paramString2, paramString3, paramString4, paramInt, null);
  }
  
  public static boolean a(Bitmap paramBitmap, awkt paramawkt, boolean paramBoolean, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, ThumbWidthHeightDP paramThumbWidthHeightDP)
  {
    ...
    for (;;)
    {
      ...
      {
        awiw.a("compress.Utils", paramString3, paramString4 + " sample after W:" + k + " H:" + j + " isLongImg:" + a(0, 0, paramInt) + " type:" + paramawkt + " needRotate:" + bool2);
        int i3;
        if (i1 > n) {
          i3 = i1;
        }
        ...
        for (i2 = n;; i2 = i1) {
          ...
          default: 
            bool1 = false;
            paramBoolean = false;
            awiw.a("compress.Utils", paramString3, paramString4 + " destWidth：" + i1 + " destHeight:" + n + " needCut:" + bool1 + " needScale:" + paramBoolean + " needRotate:" + bool2);
            paramBitmap = a(paramBitmap);
            if (paramInt == 3)
            {
              paramBoolean = a(paramBitmap);
              awiw.a("compress.Utils", paramString3, paramString4 + " isDrawGIFSucc：" + paramBoolean);
            }
            ...
            m = arsj.d;
            break label52;
            awiw.a("compress.Utils", paramString3, paramString4 + " type.type2:136");
            if (n > i2)
            {
              j = i2;
              label507:
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                catch (OutOfMemoryError paramString1)
                {
                  ...
                  awiw.b("compress.Utils", paramString3, paramString4 + " cut 3:1 createBitmap OutOfMemoryError, type:" + paramawkt);
                  return false;
                }
              }
              j = n;
          ...
          for (;;)
          {
            ...
            catch (OutOfMemoryError paramString1)
            {
              ...
              catch (OutOfMemoryError paramBitmap)
              {
                ...
                paramBitmap.printStackTrace();
                awiw.b("compress.Utils", paramString3, paramString4 + " case 1: cut createBitmap OutOfMemoryError, type:" + paramawkt);
                return false;
              }
              paramString1 = paramString1;
              paramBitmap.recycle();
              paramString1.printStackTrace();
              awiw.b("compress.Utils", paramString3, paramString4 + " case 1: scale or rotate createBitmap OutOfMemoryError, type:" + paramawkt);
              return false;
            }
            j = i;
            i = m;
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                catch (OutOfMemoryError paramString1)
                {
                  paramBitmap.recycle();
                  paramString1.printStackTrace();
                  awiw.b("compress.Utils", paramString3, paramString4 + " case 2: scale or rotate createBitmap OutOfMemoryError, type:" + paramawkt);
                  return false;
                }
              }
              n = i;
            ...
            catch (OutOfMemoryError paramString1)
            {
              paramBitmap.recycle();
              paramString1.printStackTrace();
              awiw.b("compress.Utils", paramString3, paramString4 + " case 3: rotate createBitmap OutOfMemoryError, type:" + paramawkt);
              return false;
            }
          }
          if (bool2)
          ...
          for (;;)
          {
            ...
            catch (OutOfMemoryError paramString1)
            {
              ...
              catch (OutOfMemoryError paramString1)
              {
                ...
                paramBitmap.recycle();
                paramString1.printStackTrace();
                awiw.b("compress.Utils", paramString3, paramString4 + " case 4: cut createBitmap OutOfMemoryError, type:" + paramawkt);
                return false;
              }
              paramString1 = paramString1;
              paramBitmap.recycle();
              paramString1.printStackTrace();
              awiw.b("compress.Utils", paramString3, paramString4 + " case 4: rotate createBitmap OutOfMemoryError, type:" + paramawkt);
              return false;
            }
            i = i2 * 3;
            continue;
  ...
  private static boolean a(BitmapFactory.Options paramOptions, int paramInt)
  {
    ...
    {
      awiw.b("compress.Utils", "calculateInSampleSizeThumbnail()", "options is null");
      return false;
    }
    ...
    if ((m == 0) || (n == 0))
    {
      awiw.b("compress.Utils", "calculateInSampleSizeThumbnail()", "width == 0 || height ==0");
      return false;
    }
    int j = n;
    int k = m;
    ...
    for (paramInt = paramOptions.inSampleSize;; paramInt = 1)
    {
      ...
      awiw.a("compress.Utils", "calculateInSampleSizeThumbnail()", "options.inSampleSize=" + paramOptions.inSampleSize + " srcWidth:" + m + " srcHeight:" + n);
      return true;
      i *= 2;
      break;
    }
  ...
  public static boolean a(BitmapFactory.Options paramOptions, String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      awiw.b("compress.Utils", "calculateInSampleSize()", "options == null || TextUtils.isEmpty(filepath)");
      return false;
    }
    ...
    bdhj.a(paramString, paramOptions);
    ...
    for (paramInt1 = paramOptions.inSampleSize;; paramInt1 = 1)
    {
      ...
      awiw.a("compress.Utils", "calculateInSampleSize()", "options.inSampleSize=" + paramOptions.inSampleSize);
      return true;
      break;
    }
  }
  ...
  private static boolean a(JpegOptions paramJpegOptions, int paramInt)
  {
    ...
    for (paramInt = paramJpegOptions.inSampleSize;; paramInt = 1)
    {
      ...
      awiw.a("compress.Utils", "calculateInSampleSizeThumbnail()", "options.inSampleSize=" + paramJpegOptions.inSampleSize + " srcWidth:" + m + " srcHeight:" + n);
      return true;
      i *= 2;
      break;
    }
  ...
  public static boolean a(String paramString1, String paramString2, boolean paramBoolean, String paramString3, int paramInt, ThumbWidthHeightDP paramThumbWidthHeightDP)
  {
    ...
    {
      awiw.b("compress.Utils", "compressAIOThumbnail", paramString3 + " infilePath is empty, or outfilePath is empty, or file does not exist. infilePath:" + paramString1 + " outfilePath:" + paramString2);
      return false;
    }
    awiw.a("compress.Utils", "compressAIOThumbnail", paramString3);
    BitmapFactory.Options localOptions = new BitmapFactory.Options();
    localOptions.inJustDecodeBounds = true;
    bdhj.a(paramString1, localOptions);
    int j;
    int i;
    awkt localawkt;
    if (localOptions.outWidth > localOptions.outHeight)
    {
      ...
      localawkt = a(i, j, paramInt, paramThumbWidthHeightDP);
      if (paramThumbWidthHeightDP == null) {
        break label232;
      }
      i = paramThumbWidthHeightDP.maxPx();
    ...
    for (;;)
    {
      ...
      awiw.b("compress.Utils", "compressAIOThumbnail", paramString3 + " calculateInSampleSize fail");
      return false;
    ...
    try
    {
      ...
      {
        awiw.b("compress.Utils", "compressAIOThumbnail", paramString3 + " bm == null, maybe is broken");
        return false;
      }
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      localOutOfMemoryError.printStackTrace();
      awiw.b("compress.Utils", "compressAIOThumbnail", paramString3 + " decodeFile OutOfMemoryError");
      localOptions.inSampleSize *= 2;
      try
      {
        Bitmap localBitmap2 = bdhj.a(paramString1, localOptions);
        i = localBitmap2.getWidth();
        j = localBitmap2.getHeight();
        awiw.a("compress.Utils", "compressAIOThumbnail", paramString3 + " sample after W:" + i + " H:" + j);
        return a(localBitmap2, localawkt, paramBoolean, paramString1, paramString2, "compressAIOThumbnail", paramString3, paramInt, paramThumbWidthHeightDP);
      }
      catch (OutOfMemoryError paramString1)
      {
        paramString1.printStackTrace();
        awiw.b("compress.Utils", "compressAIOThumbnail", paramString3 + " decodeFile OutOfMemoryError, op.inSampleSize:" + localOptions.inSampleSize);
      }
    }
    return false;
  }
  ...
  public static boolean b(String paramString)
  {
    ...
    {
      bool1 = bool3;
      if (!bdhb.b(paramString).equals("jpg")) {}
    }
    try
    {
      ...
      awiw.a("compress.Utils", "isMatchQualityAndSizeCondition()", "getJpegQuality = " + f + ",picSize = " + l + "result = " + bool1);
      return bool1;
    }
    catch (RuntimeException paramString)
    {
      awiw.b("compress.Utils", "isMatchQualityAndSizeCondition()", "getJpegQuality RuntimeException error = " + paramString + ",return false!");
      return false;
    }
    catch (OutOfMemoryError paramString)
    {
      awiw.b("compress.Utils", "isMatchQualityAndSizeCondition()", "getJpegQuality OutOfMemoryError error = " + paramString + ",return false!");
    }
    return false;
  }
  ...
  private static boolean b(String paramString1, Bitmap paramBitmap, int paramInt, String paramString2, CompressInfo paramCompressInfo)
  {
    ...
    {
      awiw.b("compress.Utils", "compressQualityWithProgressive()", paramString2 + " TextUtils.isEmpty(destPath) || bm == null || quality > 100 || quality <= 0");
      return false;
    }
    awiw.a("compress.Utils", "compressQualityWithProgressive()", paramString2 + " quality:" + paramInt);
    ...
    try
    {
      ...
      localObject = new JpegCompressor(new awks((File)localObject, paramCompressInfo));
      ((JpegCompressor)localObject).setParams(paramInt, true, true, false);
      try
      {
        bdif.a();
        ((JpegCompressor)localObject).compress(paramBitmap);
        bdif.a("peak_pgjpeg", "pgjpeg " + paramBitmap.getWidth() + "x" + paramBitmap.getHeight() + " compress");
        awiw.a("compress.Utils", "compressQualityWithProgressive()", paramString2 + " quality:" + paramInt);
        return true;
      }
    ...
    {
      awiw.b("compress.Utils", "compressQualityWithProgressive()", paramString2 + " FileOutputStream FileNotFoundException");
      paramString1.printStackTrace();
      return false;
    }
    catch (IOException paramString1)
    {
      awiw.b("compress.Utils", "compressQualityWithProgressive()", paramString2 + " createNewFile IOException");
      paramString1.printStackTrace();
    }
  }
  ...
  public static boolean b(String paramString1, String paramString2, boolean paramBoolean, String paramString3, int paramInt)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (!bdhb.b(paramString1)))
    {
      awiw.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " infilePath is empty, or outfilePath is empty, or file does not exist. infilePath:" + paramString1 + " outfilePath:" + paramString2);
      return false;
    }
    awiw.a("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3);
    ...
    for (;;)
    {
      ...
      awiw.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " calculateInSampleSize fail");
      return false;
    ...
    try
    {
      ...
      if (localBitmap3 == null)
      {
        awiw.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " bm == null, maybe is broken");
        return false;
      }
    }
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      localOutOfMemoryError.printStackTrace();
      awiw.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " decodeFile OutOfMemoryError");
      ...
      try
      {
        ...
        i = localBitmap2.getWidth();
        j = localBitmap2.getHeight();
        awiw.a("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " sample after W:" + i + " H:" + j);
        return a(localBitmap2, localawkt, paramBoolean, paramString1, paramString2, "compressAIOThumbnailWithTrubo", paramString3, paramInt);
      }
      catch (OutOfMemoryError paramString1)
      {
        paramString1.printStackTrace();
        awiw.b("compress.Utils", "compressAIOThumbnailWithTrubo", paramString3 + " decodeFile OutOfMemoryError, op.inSampleSize:" + localJpegOptions.inSampleSize);
      }
    }
    return false;
  }
  ...
  private static boolean c(String paramString1, Bitmap paramBitmap, int paramInt, String paramString2, CompressInfo paramCompressInfo)
  {
    ...
    //   49: invokestatic 43	awiw:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   52: iconst_0
    //   53: istore 5
    //   55: iload 5
    //   57: ireturn
    ...
    //   87: invokestatic 115	awiw:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   113: pop
    //   114: aload_0
    //   115: invokestatic 684	bdhb:a	(Ljava/lang/String;)Ljava/io/File;
    //   118: pop
    ...
    //   208: aload_0
    //   209: invokestatic 18	bdhb:b	(Ljava/lang/String;)Z
    //   212: ifne -157 -> 55
    //   215: ldc 20
    //   217: ldc_w 681
    ...
    //   240: invokestatic 43	awiw:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   243: iconst_0
    //   244: ireturn
    //   245: astore_1
    //   246: aload 4
    ...
    //   267: ldc_w 681
    //   270: ldc_w 728
    //   273: invokestatic 43	awiw:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   276: goto -78 -> 198
    //   279: astore_0
    //   280: aload 7
    //   282: astore 6
    ...
    //   309: invokestatic 43	awiw:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   312: aload 7
    //   314: astore 6
    //   316: aload_0
    ...
    //   354: ldc_w 681
    //   357: ldc_w 730
    //   360: invokestatic 43	awiw:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   363: goto -165 -> 198
    //   366: astore_0
    //   367: aload 7
    //   369: astore 6
    ...
    //   396: invokestatic 43	awiw:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   399: aload 7
    //   401: astore 6
    //   403: aload_0
