  ...
  implements arfv
{
  ...
  public String a()
  {
    ...
    if (this.jdField_a_of_type_Argj.jdField_a_of_type_ArrayOfJavaLangString == null)
    {
      this.jdField_a_of_type_Boolean = true;
      return this.jdField_a_of_type_Argj.jdField_a_of_type_JavaLangString;
    }
    int i = this.jdField_a_of_type_Int + 1;
    if (i >= this.jdField_a_of_type_Argj.jdField_a_of_type_ArrayOfJavaLangString.length)
    {
      argj localargj = this.jdField_a_of_type_Argj;
      localargj.jdField_a_of_type_Int -= 1;
      if (this.jdField_a_of_type_Argj.jdField_a_of_type_Int <= 0)
      {
        this.jdField_a_of_type_Boolean = true;
        return this.jdField_a_of_type_Argj.jdField_a_of_type_JavaLangString;
      }
      ...
      return this.jdField_a_of_type_Argj.jdField_a_of_type_ArrayOfJavaLangString[(i + 1)];
    }
    return this.jdField_a_of_type_Argj.jdField_a_of_type_ArrayOfJavaLangString[i];
  }
  ...
  public void a(Message paramMessage)
  {
    ...
    if (this.jdField_a_of_type_Argj.jdField_a_of_type_Arfw != null) {
      this.jdField_a_of_type_Argj.jdField_a_of_type_Arfw.a((Bitmap)paramMessage.obj);
    }
    this.jdField_a_of_type_Int += 1;
    ThreadManager.post(this.jdField_a_of_type_JavaLangRunnable, 5, null, true);
  }
  ...
  {
    if (this.jdField_a_of_type_Argj != null) {
      this.jdField_a_of_type_Argj.jdField_a_of_type_JavaLangString = paramString;
    }
  }
