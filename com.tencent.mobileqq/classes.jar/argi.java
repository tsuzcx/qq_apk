...
public class argi
{
  ...
  public argi(String paramString, int paramInt)
  {
  ...
  public static Drawable a(Context paramContext, argo paramargo)
  {
    Object localObject = paramargo.a;
    ...
    for (paramContext = paramContext.getLoadingDrawable("fromAIO", true);; paramContext = null)
    {
      ...
      do
      {
        ...
        localURL = agjt.a((MessageForPic)localObject);
  ...
  private static URLDrawable.URLDrawableOptions a(Context paramContext, int paramInt1, int paramInt2)
  {
    ...
    localURLDrawableOptions.mLoadingDrawable = new aqww(paramInt1, paramInt2);
    return localURLDrawableOptions;
  }
  
  public static EmoticonPackage a(String paramString)
  {
    return ((avsq)((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime()).getManager(14)).a(paramString);
  }
  
  public static PicEmoticonInfo a(MessageForMarketFace paramMessageForMarketFace)
  {
    return ((avsq)((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime()).getManager(14)).a(paramMessageForMarketFace.mMarkFaceMessage);
  }
  ...
  private List<MessageRecord> a(List<MessageRecord> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localObject1 instanceof MessageForPic))
      {
        ...
        if ((!a((MessageForPic)localObject2)) && (agjt.a((MessageForPic)localObject2))) {
        ...
        if (((MessageForMixedMsg)localObject1).msgElemList != null)
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            if ((localObject2 instanceof MessageForPic))
            {
              ...
              ((MessageForPic)localObject2).parse();
              if (agjt.a((MessageForPic)localObject2)) {
  ...
  {
    return ahtj.a(paramMessageForPic);
  }
}
