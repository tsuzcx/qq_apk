...
{
  public abfa(FriendProfileCardActivity paramFriendProfileCardActivity) {}
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                do
                {
                        ...
                        do
                        {
                          do
                          {
                            do
                            {
                              do
                              {
                                do
                                {
                                  do
                                  {
                                    ...
                                    if (i == 1) {
                                      this.a.jdField_a_of_type_Bbkc.a("updateCardByDbEnd", false);
                                    }
                                    for (;;)
                                    {
                                      ...
                                      if ((i == 7) || (i == 8) || (paramMessage.arg2 == 12) || (paramMessage.arg2 == 11)) {
                                        this.a.jdField_a_of_type_Bbkc.a("updateCardBySSOEnd", false);
                                      }
                                    }
                                  ...
                                  this.a.a(this.a.jdField_a_of_type_Auuw);
                                  return true;
                                ...
                                this.a.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqDataContactCard = paramMessage;
                              ...
                              if (this.a.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqDataCard != null)
                              {
                                if (QLog.isColorLevel()) {
                                  QLog.i("Q.profilecard.FrdProfileCard", 2, "initHeaderView timeout");
                                }
                                this.a.jdField_a_of_type_Auuw.jdField_a_of_type_Boolean = true;
                            ...
                            } while (this.a.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqQcallQCallCardInfo == null);
                            if (QLog.isColorLevel()) {
                              QLog.i("Q.profilecard.FrdProfileCard", 2, "initHeaderView timeout");
                            }
                            this.a.jdField_a_of_type_Auuw.jdField_a_of_type_Boolean = true;
                            this.a.jdField_a_of_type_Auuw.jdField_a_of_type_Auvd = null;
                            this.a.a(this.a.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqQcallQCallCardInfo, false);
                            return true;
                          ...
                          } while ((this.a.jdField_a_of_type_Auuw == null) || (this.a.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a.equals(this.a.app.getCurrentAccountUin())));
                          ProfileActivity.a(this.a, paramMessage);
                          return true;
                          Toast.makeText(this.a.getApplicationContext(), 2131695479, 0).show();
                          return true;
                          if (paramMessage.what != 12) {
                            break label1088;
                          }
                        } while ((this.a.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqDataCard == null) || ((auvd.f != this.a.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqDataCard.lCurrentStyleId) && (auvd.h != this.a.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqDataCard.lCurrentStyleId)) || (!(paramMessage.obj instanceof Bitmap)));
                  ...
                  } while (this.a.jdField_a_of_type_Auuw.jdField_a_of_type_ComTencentMobileqqDataCard.lCurrentStyleId != auvd.h);
                  if (QLog.isColorLevel()) {
            ...
            FriendProfileCardActivity.a(this.a).a(this.a.jdField_a_of_type_Auuw);
            return true;
        ...
        localObject1 = this.a.jdField_b_of_type_Bfnk.obtainMessage();
        ((Message)localObject1).what = paramMessage.what;
        ((Message)localObject1).arg1 = (paramMessage.arg1 - 1);
        this.a.jdField_b_of_type_Bfnk.sendMessageDelayed((Message)localObject1, 1000L);
        return true;
        ...
        {
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetProfileCardMoreInfoView.a(this.a.jdField_a_of_type_Auuw, true, new String[] { "map_key_medal" });
          return true;
        }
