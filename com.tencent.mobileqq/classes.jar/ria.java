  ...
  extends BaseAdapter
{
  ...
  public ria(Context paramContext, List<ReadInJoyDraftboxItem> paramList)
  {
  ...
  {
    if (paramView == null) {}
    for (View localView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131560170, null);; localView = paramView)
    {
      Object localObject2 = (TextView)localView.findViewById(2131379582);
      MiddleBracketsTitleTextView localMiddleBracketsTitleTextView = (MiddleBracketsTitleTextView)localView.findViewById(2131379580);
      paramView = (TextView)localView.findViewById(2131379581);
      ImageView localImageView = (ImageView)localView.findViewById(2131369222);
      TextView localTextView = (TextView)localView.findViewById(2131379557);
      ...
      if ((this.jdField_a_of_type_JavaUtilList != null) && (paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size()))
      {
        ...
        paramView.setText(pax.a(localReadInJoyDraftboxItem.time, false));
        paramView = localReadInJoyDraftboxItem.title;
        if (localReadInJoyDraftboxItem.type == 3) {
          paramView = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131717468);
        }
        ...
        if (localReadInJoyDraftboxItem.type == 2) {
          localObject1 = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131717467) + ": " + paramView;
        }
      ...
      for (;;)
      {
        localView.setOnClickListener(new rib(this, localReadInJoyDraftboxItem));
        localTextView.setOnClickListener(new ric(this, localReadInJoyDraftboxItem, paramInt));
