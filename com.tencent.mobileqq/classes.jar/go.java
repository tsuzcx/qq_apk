...
public class go
{
  ...
  public static String a()
  {
    if (TextUtils.isEmpty(jdField_c_of_type_JavaLangString)) {
      jdField_c_of_type_JavaLangString = bhto.a() + jdField_a_of_type_JavaLangString + "default.ttf";
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    try
    {
      bhmi.a(str, bhto.a() + jdField_a_of_type_JavaLangString, false);
  ...
  public static void b()
  {
    if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface))
    {
      ...
      bhto.a((AppInterface)localObject);
  ...
  {
    Object localObject = anzj.a(2131714831);
    int i = ((String)localObject).length();
    paramString = new avpd(paramString, jdField_b_of_type_JavaLangString, (String)localObject, paramInt, -5020, 1179653, bcrg.a());
    paramString.b = new int[] { 1179653 };
    localObject = new Bundle();
    ((Bundle)localObject).putInt("key_action", 1);
    ((Bundle)localObject).putString("key_action_DATA", bhyk.a("myFont"));
  ...
  private static boolean c()
  {
    ...
    //   21: invokestatic 127	bhto:a	()Ljava/lang/String;
    //   24: invokevirtual 26	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   27: getstatic 37	go:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   63: invokespecial 436	java/io/File:<init>	(Ljava/lang/String;)V
    //   66: astore 12
    //   68: new 28	java/io/File
    //   71: dup
    //   72: invokestatic 332	go:a	()Ljava/lang/String;
    //   75: invokespecial 436	java/io/File:<init>	(Ljava/lang/String;)V
    //   78: astore 11
    //   80: ldc 41
    //   82: astore_2
    //   83: aload 12
    ...
    //   132: astore 7
    //   134: aload_1
    //   135: invokevirtual 462	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   138: astore_2
    //   139: aload_2
    //   140: astore 4
    //   142: aload_1
    ...
    //   145: astore_1
    //   146: aload 4
    //   148: invokestatic 123	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   151: ifeq +88 -> 239
    //   154: invokestatic 143	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   157: ifeq +47 -> 204
    //   160: ldc 145
    //   162: iconst_2
    ...
    //   176: aload 12
    //   178: invokevirtual 439	java/io/File:exists	()Z
    ...
    //   190: aload 12
    //   192: invokevirtual 442	java/io/File:isFile	()Z
    ...
    //   204: aload 10
    //   206: invokestatic 468	bhmi:a	(Ljava/lang/String;)V
    //   209: aload_2
    //   210: ifnull +7 -> 217
    //   213: aload_2
    //   214: invokevirtual 471	java/io/BufferedReader:close	()V
    //   217: aload_1
    //   218: ifnull +7 -> 225
    //   221: aload_1
    //   222: invokevirtual 472	java/io/InputStreamReader:close	()V
    //   225: iconst_0
    //   226: ifeq +11 -> 237
    //   229: new 474	java/lang/NullPointerException
    //   232: dup
    //   233: invokespecial 475	java/lang/NullPointerException:<init>	()V
    //   236: athrow
    //   237: iload_0
    //   238: ireturn
    //   239: aload 11
    //   241: invokevirtual 439	java/io/File:exists	()Z
    //   244: ifeq +153 -> 397
    //   247: aload 11
    //   249: invokevirtual 442	java/io/File:isFile	()Z
    //   252: ifeq +145 -> 397
    //   255: new 446	java/io/FileInputStream
    //   258: dup
    //   259: aload 11
    //   261: invokespecial 449	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   264: astore_3
    //   265: aload_3
    //   266: aload 11
    //   268: invokevirtual 477	java/io/File:length	()J
    //   271: invokestatic 483	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   274: invokestatic 488	com/tencent/mobileqq/transfile/StructLongMessageDownloadProcessor:a	([B)Ljava/lang/String;
    //   277: astore 5
    ...
    //   323: aload 5
    //   325: aload 4
    //   327: invokevirtual 496	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   330: istore_0
    //   331: iload_0
    //   332: ifeq +34 -> 366
    //   335: iconst_1
    ...
    //   338: ifnull +7 -> 345
    //   341: aload_2
    //   342: invokevirtual 471	java/io/BufferedReader:close	()V
    //   345: aload_1
    //   346: ifnull +7 -> 353
    //   349: aload_1
    //   350: invokevirtual 472	java/io/InputStreamReader:close	()V
    //   353: aload_3
    //   354: ifnull -117 -> 237
    //   357: aload_3
    //   358: invokevirtual 497	java/io/FileInputStream:close	()V
    //   361: iconst_1
    //   362: ireturn
    //   363: astore_1
    //   364: iconst_1
    ...
    //   367: ifnull +7 -> 374
    //   370: aload_2
    //   371: invokevirtual 471	java/io/BufferedReader:close	()V
    //   374: aload_1
    //   375: ifnull +7 -> 382
    //   378: aload_1
    //   379: invokevirtual 472	java/io/InputStreamReader:close	()V
    //   382: aload_3
    //   383: ifnull +7 -> 390
    //   386: aload_3
    //   387: invokevirtual 497	java/io/FileInputStream:close	()V
    //   390: aload 10
    //   392: invokestatic 468	bhmi:a	(Ljava/lang/String;)V
    //   395: iconst_0
    //   396: ireturn
    //   397: aload 9
    //   399: astore_3
    //   400: invokestatic 143	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   403: ifeq -37 -> 366
    //   406: ldc 145
    //   408: iconst_2
    ...
    //   422: aload 11
    //   424: invokevirtual 439	java/io/File:exists	()Z
    ...
    //   436: aload 11
    //   438: invokevirtual 442	java/io/File:isFile	()Z
    ...
    //   472: aload_3
    //   473: astore 7
    //   475: invokestatic 143	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   478: ifeq +23 -> 501
    //   481: aload 5
    //   483: astore 4
    //   485: aload_1
    ...
    //   502: ifnull +7 -> 509
    //   505: aload_1
    //   506: invokevirtual 471	java/io/BufferedReader:close	()V
    //   509: aload_3
    //   510: ifnull +7 -> 517
    //   513: aload_3
    //   514: invokevirtual 472	java/io/InputStreamReader:close	()V
    //   517: aload 5
    //   519: ifnull -129 -> 390
    //   522: aload 5
    //   524: invokevirtual 497	java/io/FileInputStream:close	()V
    //   527: goto -137 -> 390
    //   530: astore_1
    //   531: goto -141 -> 390
    //   534: astore_3
    ...
    //   544: ifnull +7 -> 551
    //   547: aload_2
    //   548: invokevirtual 471	java/io/BufferedReader:close	()V
    //   551: aload_1
    //   552: ifnull +7 -> 559
    //   555: aload_1
    //   556: invokevirtual 472	java/io/InputStreamReader:close	()V
    //   559: aload 4
    //   561: ifnull +8 -> 569
    //   564: aload 4
    //   566: invokevirtual 497	java/io/FileInputStream:close	()V
    //   569: aload_3
    //   570: athrow
    //   571: astore_2
    //   572: goto -355 -> 217
    ...
    //   695	22	2	localObject7	Object
    //   118	396	3	localObject8	Object
    //   534	91	3	localObject9	Object
    //   630	1	3	localObject10	Object
    //   638	1	3	localObject11	Object
    //   648	11	3	localObject12	Object
    //   663	53	3	localObject13	Object
    //   9	317	4	localObject14	Object
    //   456	7	4	localException19	Exception
    //   467	98	4	localObject15	Object
    //   622	7	4	localObject16	Object
    //   633	81	4	localObject17	Object
    //   3	520	5	str1	String
    //   656	6	5	localObject18	Object
    //   685	9	5	localException20	Exception
    //   697	1	5	localObject19	Object
    //   129	571	6	localObject20	Object
    //   132	508	7	localObject21	Object
    //   6	644	8	localObject22	Object
    //   12	439	9	localObject23	Object
    //   36	355	10	str2	String
