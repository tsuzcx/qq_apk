...
public class go
{
  ...
  public static String a()
  {
    if (TextUtils.isEmpty(jdField_c_of_type_JavaLangString)) {
      jdField_c_of_type_JavaLangString = bgtl.a() + jdField_a_of_type_JavaLangString + "default.ttf";
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      str = gc.jdField_a_of_type_JavaLangString + File.separator + "default.zip";
      if (!atwl.a(str)) {}
    }
    try
    {
      bgmg.a(str, bgtl.a() + jdField_a_of_type_JavaLangString, false);
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      paramQQAppInterface = (gc)paramQQAppInterface.getManager(42);
      if (paramQQAppInterface != null)
      {
  ...
  public static void b()
  {
    if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface))
    {
      ...
      bgtl.a((AppInterface)localObject);
  ...
  {
    Object localObject = anni.a(2131714722);
    int i = ((String)localObject).length();
    paramString = new auxc(paramString, jdField_b_of_type_JavaLangString, (String)localObject, paramInt, -5020, 1179653, bbyp.a());
    paramString.b = new int[] { 1179653 };
    localObject = new Bundle();
    ((Bundle)localObject).putInt("key_action", 1);
    ((Bundle)localObject).putString("key_action_DATA", bgyg.a("myFont"));
  ...
  private static boolean c()
  {
    ...
    //   20: invokestatic 127	bgtl:a	()Ljava/lang/String;
    //   23: invokevirtual 26	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   26: getstatic 37	go:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   70: dup
    //   71: invokestatic 332	go:a	()Ljava/lang/String;
    ...
    //   207: aload 10
    //   209: invokestatic 468	bgmg:a	(Ljava/lang/String;)V
    //   212: aload_2
    //   213: ifnull +7 -> 220
    //   216: aload_2
    ...
    //   393: aload 10
    //   395: invokestatic 468	bgmg:a	(Ljava/lang/String;)V
    //   398: iconst_0
    //   399: ireturn
    //   400: aload 9
    //   402: astore_3
