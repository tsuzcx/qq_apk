  ...
  extends AbsThirdDataSourceAdapter
{
  ...
  public void requestPrepare(String paramString, AbsThirdDataSourceAdapter.OnPreparedCallback paramOnPreparedCallback)
  {
    ...
    this.b = 1;
    paramOnPreparedCallback = onx.a();
    onw localonw = new onw(this);
    if ((this.jdField_a_of_type_Int == 2) || (this.jdField_a_of_type_Int == 6)) {
      paramOnPreparedCallback.a(paramString, "PubAccountArticleCenter.GetUrlByVid", localonw);
    }
    while (this.jdField_a_of_type_Int != 4) {
      return;
    }
    paramOnPreparedCallback.a(paramString, "SQQShopAdSvr.GetUrlByVid", localonw);
  }
}
