...
class onv
{
  ...
  private opm a()
  {
    ...
    if (localAppRuntime != null) {
      return ((ohd)localAppRuntime.getManager(163)).a().a();
    }
    return null;
  }
    ...
    if ((localObject != null) && (((ArrayList)localObject).size() > 0))
    {
      ...
      if (i != -1)
      {
        if ((this.c.containsKey(Integer.valueOf(paramInt1))) && (i < ((ArrayList)this.c.get(Integer.valueOf(paramInt1))).size()))
        {
          ...
          if (localObject != null) {
            ((BaseArticleInfo)localObject).mRecommendSeq = onu.a(1, paramInt2);
          }
          return localObject;
        }
  ...
  void a(int paramInt)
  {
    ...
    Object localObject3 = ((opm)localObject2).a(paramInt);
    ...
    Collections.sort((List)localObject1, new onx(this));
    ...
    localObject2 = ((opm)localObject2).a(paramInt);
  ...
  void c(int paramInt)
  {
    opm localopm = a();
    if (localopm != null) {
      localopm.a(paramInt, this.jdField_a_of_type_Opn);
    }
  }
