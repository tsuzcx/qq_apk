  ...
  extends bkhx
{
  ...
  public bkii(Context paramContext, String paramString)
  {
  ...
  private void d()
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Bkij.sendEmptyMessageDelayed(0, 40L);
      localBitmap = null;
  ...
  public Bitmap a()
  {
    ...
    ArrayList localArrayList = this.jdField_a_of_type_Bkhl.a(this.jdField_a_of_type_Bkhl.a());
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Bkij != null) {
      this.jdField_a_of_type_Bkij.removeCallbacksAndMessages(null);
    }
  }
  ...
  protected void b()
  {
    this.jdField_a_of_type_Bkij = new bkij(new WeakReference(this));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataGifDecoder = new bjez(this.jdField_b_of_type_JavaLangString);
        ...
        this.k = this.jdField_a_of_type_Bkhl.a("offsetX", 0L, 650L, (int)(-i1 * 0.3D), 0, new bkig());
        this.l = this.jdField_a_of_type_Bkhl.a("offsetX", 100L, 650L, (int)(-i1 * 0.3D), 0, new bkig());
        this.m = this.jdField_a_of_type_Bkhl.a("offsetX", 200L, 650L, (int)(-i1 * 0.3D), 0, new bkig());
        this.n = this.jdField_a_of_type_Bkhl.a("alpha", 0L, 370L, 0, 255, new vti(0.33F, 0.0F, 0.67F, 1.0F));
        this.o = this.jdField_a_of_type_Bkhl.a("alpha", 100L, 370L, 0, 255, new vti(0.33F, 0.0F, 0.67F, 1.0F));
        this.p = this.jdField_a_of_type_Bkhl.a("alpha", 200L, 370L, 0, 255, new vti(0.33F, 0.0F, 0.67F, 1.0F));
        return;
      }
  ...
  protected void c()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataGifDecoder != null) && (this.jdField_b_of_type_Boolean)) {
      this.jdField_a_of_type_Bkij.sendEmptyMessage(0);
    }
  }
