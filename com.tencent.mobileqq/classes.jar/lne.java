...
public final class lne
  implements Runnable
{
  public lne(BusinessInfoCheckUpdate.RedTypeInfo paramRedTypeInfo, QQAppInterface paramQQAppInterface) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      break label26;
      label80:
      localObject2 = ((QQMessageFacade)localObject1).b(AppConstants.at, 7220);
