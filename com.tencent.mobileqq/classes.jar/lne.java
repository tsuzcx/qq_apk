...
{
  public lne(ReadInJoyAtlasFragment paramReadInJoyAtlasFragment, ActionSheet paramActionSheet, String paramString) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyAtlasFragment.getString(2131435854).equals(paramView)) {
    ...
    for (;;)
    {
      ...
      return;
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyFragmentReadInJoyAtlasFragment.getString(2131435860).equals(paramView)) {
