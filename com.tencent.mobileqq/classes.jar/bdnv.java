  ...
  extends bdnu
{
  ...
  protected bdnv(Collection<bdnu> paramCollection)
  {
    this.jdField_a_of_type_JavaLangString = "item";
  ...
  public void a(View paramView)
  {
    ...
    default: 
      return;
    case 0: 
      paramView.setBackgroundResource(2130838350);
      return;
    case 1: 
  ...
  {
    if (((parambdnu instanceof bdnw)) && (!b())) {
      ((bdnw)parambdnu).ac = null;
    }
  ...
  public void a(AbsShareMsg paramAbsShareMsg)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext()) {
      ((bdnu)localIterator.next()).a(paramAbsShareMsg);
    }
  }
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    for (;;)
    {
      label182:
      str = b();
      if ((str != null) && (localObject != null) && ((localObject instanceof bdpx)))
      {
        if ((!str.endsWith("Layout4")) && (!str.endsWith("Layout2")) && (!str.endsWith("Layout9"))) {
          break label350;
        }
        ((bdpx)localObject).t = bdpx.jdField_q_of_type_Int;
      }
      int j;
      for (;;)
      {
        ...
        k += 1;
        break;
        localObject = bdoe.a(str);
        j = i;
        if ("button".equals(str))
        {
          ((bdnu)localObject).aa = String.valueOf(i);
          ((bdnu)localObject).ab = this.ab;
          j = i + 1;
        }
        if ((localObject == null) || (!bdnv.class.isInstance(localObject))) {
          break label1041;
        }
        ...
        if (str.endsWith("Layout3")) {
          ((bdpx)localObject).t = bdpx.jdField_r_of_type_Int;
        }
      }
  ...
  public void a(String paramString1, String paramString2, int paramInt, String paramString3)
  {
    ...
    a(new bdpx(paramString1, paramString3));
  ...
  {
    this.jdField_o_of_type_Int = paramInt;
    a(new bdpx(paramString1, paramString4));
    a(new StructMsgItemTitle(paramString2));
    a(new bdsv(paramString3));
  }
  ...
  public void a(XmlSerializer paramXmlSerializer)
  {
    ...
    for (Object localObject = "0";; localObject = String.valueOf(this.jdField_r_of_type_Int))
    {
      ...
      localObject = this.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (((Iterator)localObject).hasNext()) {
        ((bdnu)((Iterator)localObject).next()).a(paramXmlSerializer);
      }
    }
  ...
  public boolean a(bdpl parambdpl)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_d_of_type_JavaLangString = parambdpl.a("actionData");
      this.jdField_e_of_type_JavaLangString = parambdpl.a("a_actionData");
      this.jdField_f_of_type_JavaLangString = parambdpl.a("i_actionData");
      this.b = parambdpl.a("url");
      this.jdField_g_of_type_JavaLangString = parambdpl.a("brief");
      this.jdField_q_of_type_JavaLangString = parambdpl.a("apurl");
      Object localObject1 = parambdpl.a("flag");
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {}
      try
      {
        this.jdField_m_of_type_Int = Integer.parseInt((String)localObject1);
        localObject1 = parambdpl.a("mode");
        if (TextUtils.isEmpty((CharSequence)localObject1)) {}
      }
      catch (NumberFormatException localNumberFormatException11)
      {
        ...
        catch (NumberFormatException localNumberFormatException11)
        {
          try
          {
            ...
            {
              this.jdField_h_of_type_JavaLangString = parambdpl.a("businessData");
              this.jdField_i_of_type_JavaLangString = parambdpl.a("commonData");
              this.jdField_j_of_type_JavaLangString = parambdpl.a("index");
              this.jdField_k_of_type_JavaLangString = parambdpl.a("index_name");
              this.jdField_l_of_type_JavaLangString = parambdpl.a("index_type");
              this.jdField_o_of_type_JavaLangString = parambdpl.a("canvas");
              this.jdField_m_of_type_JavaLangString = parambdpl.a("rurl");
              this.jdField_p_of_type_JavaLangString = parambdpl.a("disType");
              this.n = parambdpl.a("tid");
              if (this.jdField_a_of_type_Int > 10)
              {
                localObject1 = parambdpl.a;
                if (localObject1 != null)
                {
                  localObject3 = ((bdpl)localObject1).a("action_type");
          ...
          catch (IllegalArgumentException localNumberFormatException11)
          {
            try
            {
              ...
              localObject3 = ((bdpl)localObject1).a("dest_type");
              if (TextUtils.isEmpty((CharSequence)localObject3)) {}
            }
            catch (NumberFormatException localNumberFormatException11)
            {
              try
              {
                ...
                localObject3 = ((bdpl)localObject1).a("product_type");
                if (TextUtils.isEmpty((CharSequence)localObject3)) {}
              }
              catch (NumberFormatException localNumberFormatException11)
              {
                try
                {
                  ...
                  this.jdField_r_of_type_JavaLangString = ((bdpl)localObject1).a("advertiser_id");
                  this.s = ((bdpl)localObject1).a("aid");
                  this.t = ((bdpl)localObject1).a("app_download_schema");
                  this.u = ((bdpl)localObject1).a("canvas_json");
                  this.v = ((bdpl)localObject1).a("customized_invoke_url");
                  this.w = ((bdpl)localObject1).a("effect_url");
                  this.x = ((bdpl)localObject1).a("landing_page");
                  this.y = ((bdpl)localObject1).a("landing_page_report_url");
                  this.z = ((bdpl)localObject1).a("noco_id");
                  this.A = ((bdpl)localObject1).a("product_id");
                  this.B = ((bdpl)localObject1).a("rl");
                  this.C = ((bdpl)localObject1).a("subordinate_product_id");
                  this.D = ((bdpl)localObject1).a("traceid");
                  this.E = ((bdpl)localObject1).a("via");
                  this.F = ((bdpl)localObject1).a("video_url");
                  this.G = ((bdpl)localObject1).a("appname");
                  this.H = ((bdpl)localObject1).a("customized_invoke_url");
                  this.I = ((bdpl)localObject1).a("pkg_name");
                  this.J = ((bdpl)localObject1).a("pkgurl");
                  this.jdField_q_of_type_JavaLangString = ((bdpl)localObject1).a("apurl");
                  if (this.jdField_a_of_type_Int > 11)
                  {
                    localObject1 = parambdpl.a;
                    if (localObject1 != null)
                    {
                      this.K = ((bdpl)localObject1).a("api_click_monitor_url");
                      this.L = ((bdpl)localObject1).a("api_exposure_monitor_url");
                      this.M = ((bdpl)localObject1).a("trace_info_aid");
                    }
                  }
                  if (this.jdField_a_of_type_Int > 12)
                  {
                    ...
                    if (localObject1 != null)
                    {
                      this.N = ((bdpl)localObject1).a("corporate_image_name");
                      this.O = ((bdpl)localObject1).a("corporate_logo");
                    }
                  }
                  if (this.jdField_a_of_type_Int > 13)
                  {
                    localObject1 = parambdpl.a.a("mini_program_type");
                    if (TextUtils.isEmpty((CharSequence)localObject1)) {}
                  }
                }
                catch (NumberFormatException localNumberFormatException11)
                {
                  try
                  {
                    ...
                    if (this.jdField_a_of_type_Int > 14)
                    {
                      ...
                      if (localObject1 != null)
                      {
                        localObject3 = ((bdpl)localObject1).a("tab_id");
                  ...
                  catch (NumberFormatException localNumberFormatException11)
                  {
                    try
                    {
                      ...
                      localObject1 = ((bdpl)localObject1).a("is_hidden");
                    ...
                    catch (NumberFormatException localNumberFormatException11)
                    {
                      try
                      {
                        ...
                        {
                          localObject1 = parambdpl.a;
                          this.P = ((bdpl)localObject1).a("negative_feedback_url");
                          this.Q = ((bdpl)localObject1).a("sdk_exposure_monitor_url");
                          this.R = ((bdpl)localObject1).a("sdk_click_monitor_url");
                          localObject3 = ((bdpl)localObject1).a("media_duration");
                          if (StringUtil.isEmpty((String)localObject3)) {}
                        }
                      }
                      catch (NumberFormatException localNumberFormatException11)
                      {
                        try
                        {
                          ...
                          localObject3 = ((bdpl)localObject1).a("video_file_size");
                          if (StringUtil.isEmpty((String)localObject3)) {}
                        }
                        catch (NumberFormatException localNumberFormatException11)
                        {
                          try
                          {
                            ...
                            localObject3 = ((bdpl)localObject1).a("app_score_num");
                            if (StringUtil.isEmpty((String)localObject3)) {}
                          }
                          catch (NumberFormatException localNumberFormatException11)
                          {
                            try
                            {
                              ...
                              localObject3 = ((bdpl)localObject1).a("download_num");
                              if (StringUtil.isEmpty((String)localObject3)) {}
                            }
                            catch (NumberFormatException localNumberFormatException11)
                            {
                              try
                              {
                                for (;;)
                                {
                                  ...
                                  this.S = ((bdpl)localObject1).a("universal_link");
                                  this.T = ((bdpl)localObject1).a("sdk_data");
                                  this.U = ((bdpl)localObject1).a("tencent_video_id");
                                  this.V = ((bdpl)localObject1).a("view_id");
                                  if (this.jdField_a_of_type_Int > 16) {
                                    this.W = parambdpl.a.a("qgg_ext");
                                  }
                                  if (this.jdField_a_of_type_Int > 17)
                                  {
                                    localObject1 = parambdpl.a;
                                    this.X = ((bdpl)localObject1).a("adInfo");
                                    this.Y = ((bdpl)localObject1).a("is_report_click");
                                  }
                                  int k = parambdpl.a();
                                  int i = 0;
                                  for (;;)
                              ...
                              catch (NumberFormatException localNumberFormatException12)
                              {
                                ...
                                for (Object localObject2 = localNumberFormatException12.a("layout");; localObject2 = bdoe.a(localNumberFormatException12.b))
                                {
                                  try
                                  {
                                    ...
                                    {
                                      localObject2 = bdoe.a(j);
                                      bool1 = bool2;
                                      if (localObject2 == null) {
                                        break;
                                      }
                                      bool1 = bool2;
                                      if (!((bdnu)localObject2).a(localNumberFormatException12)) {
                                        break;
                                      }
                                      a((bdnu)localObject2);
                                      break label1126;
  ...
  public void b(View paramView)
  {
    if (!TextUtils.isEmpty(this.b))
    {
      ...
      default: 
        ...
        localObject = paramView.findViewById(2131368676);
    ...
    do
    {
      ...
      paramView.setBackgroundResource(2130838348);
      break;
      paramView = paramView.findViewById(2131378145);
  ...
  public void c(View paramView)
  {
    ...
    for (;;)
    {
      ...
      paramView.setPadding(i, j, k, m);
      return;
      paramView.setBackgroundResource(2130838362);
      continue;
      paramView.setBackgroundResource(2130838365);
      continue;
      paramView.setBackgroundResource(2130838361);
      continue;
      paramView.setBackgroundResource(2130838364);
    }
  }
  ...
  protected void d(View paramView)
  {
    ...
    do
    {
      do
      {
        ...
        if (!TextUtils.isEmpty(this.b))
        {
          this.jdField_q_of_type_Int = 2130838352;
          break;
        }
        this.jdField_q_of_type_Int = 2130838366;
        break;
        if (!TextUtils.isEmpty(this.b))
        {
        ...
        this.jdField_q_of_type_Int = 2130838367;
        break;
        paramView.setBackgroundResource(2130838351);
        return;
      ...
      float f3 = i;
      float f4 = i;
      localStateListDrawable = bdpo.a(paramView.getResources(), this.jdField_p_of_type_Int, new float[] { f1, f2, f3, f4, 0.0F, 0.0F, 0.0F, 0.0F });
