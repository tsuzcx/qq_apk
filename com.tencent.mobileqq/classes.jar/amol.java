...
public class amol
{
  ...
  public static android.graphics.drawable.Drawable a(Context paramContext, int paramInt1, int paramInt2, String paramString)
  {
    ...
    //   22: iload_1
    //   23: iload_2
    //   24: invokespecial 38	arnk:<init>	(IFII)V
    //   27: astore 5
    //   29: new 27	arnk
    //   32: dup
    //   33: ldc 29
    ...
    //   42: iload_1
    //   43: iload_2
    //   44: invokespecial 38	arnk:<init>	(IFII)V
    //   47: astore_0
    //   48: new 27	arnk
    //   51: dup
    //   52: aload_3
    ...
    //   60: iload_1
    //   61: iload_2
    //   62: invokespecial 38	arnk:<init>	(IFII)V
    //   65: astore 4
    //   67: new 27	arnk
    //   70: dup
    ...
    //   108: iload_1
    //   109: iload_2
    //   110: invokespecial 38	arnk:<init>	(IFII)V
    //   113: astore_3
    //   114: aload_3
    //   115: sipush 204
        ...
        if (paramInt1 >= 0)
        {
          ...
          for (;;)
          {
            ...
            if ((((MessageForApollo)localObject2).gameId == paramInt2) && (((MessageForApollo)localObject2).roomId == paramLong))
            {
              ...
              if (a()) {
                localamgz.a().a((MessageForApollo)localObject2);
              }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ApolloGameData paramApolloGameData, int paramInt)
  {
    ...
    if (!bgnw.a(paramContext, paramApolloGameData.gameAppPkgName))
    {
    ...
    ((amhd)paramQQAppInterface.getManager(153)).a().a(paramApolloGameData.gameId, paramApolloGameData.gameAppid, 0, paramSessionInfo.jdField_a_of_type_JavaLangString, paramInt);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localangn.e = 1;
        localangn.d = 3;
        a(paramQQAppInterface, paramString, localangn);
        return;
        localangn.jdField_b_of_type_JavaLangString = anni.a(2131700920);
        i = 0;
      }
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, angn paramangn)
  {
    if ((paramangn == null) || (paramQQAppInterface == null))
    {
      QLog.e("CmGameTemp_CmGameSessionUtil", 1, "[sendGameMsg], errInfo->param is null.");
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("CmGameTemp_CmGameSessionUtil", 2, new Object[] { "[sendGameMsg], gameId:", Integer.valueOf(paramangn.jdField_a_of_type_Int), ",roomId:", Long.valueOf(paramangn.jdField_a_of_type_Long), ",extendInfo:", paramangn.jdField_c_of_type_JavaLangString });
    }
    ApolloMessage localApolloMessage = new ApolloMessage();
    if (!TextUtils.isEmpty(paramangn.jdField_a_of_type_JavaLangString)) {
      localApolloMessage.name = paramangn.jdField_a_of_type_JavaLangString.getBytes();
    }
    if (0 == 0) {}
    for (;;)
    {
      try
      {
        ...
        ((JSONObject)localObject).put("gameId", paramangn.jdField_a_of_type_Int);
        ((JSONObject)localObject).put("gameMode", paramangn.jdField_c_of_type_Int);
        ((JSONObject)localObject).put("roomid", paramangn.jdField_a_of_type_Long);
        if (paramangn.jdField_a_of_type_Int == 1)
        {
          ((JSONObject)localObject).put("msgTyep", 2);
          ((JSONObject)localObject).put("gameName", paramangn.jdField_b_of_type_JavaLangString);
          if (!TextUtils.isEmpty(paramangn.jdField_c_of_type_JavaLangString)) {
            ((JSONObject)localObject).put("gameExtendJson", paramangn.jdField_c_of_type_JavaLangString);
          }
          ((JSONObject)localObject).put("gameStatus", paramangn.e);
          if (localObject != null) {
            localApolloMessage.extStr = ((JSONObject)localObject).toString();
          }
          localObject = ((amhd)paramQQAppInterface.getManager(153)).b(paramQQAppInterface.getCurrentAccountUin());
          localApolloMessage.sender_ts = bgjw.a(((ApolloBaseInfo)localObject).apolloServerTS);
          localApolloMessage.sender_status = ((ApolloBaseInfo)localObject).apolloStatus;
          localObject = ((ancd)paramQQAppInterface.getManager(155)).a(paramangn.jdField_a_of_type_Int);
          if ((localObject == null) || (1 != ((ApolloGameData)localObject).hasOwnArk)) {
            break label511;
          }
          i = 297;
          localApolloMessage.flag = (i | 0x200);
          paramString = bbzh.a(paramQQAppInterface, paramString, paramQQAppInterface.getCurrentAccountUin(), 1036, localApolloMessage);
          if (paramangn.jdField_a_of_type_Int == 1)
          {
            paramString.msgType = 2;
            paramString.gameId = paramangn.jdField_a_of_type_Int;
            paramString.mGameMode = paramangn.jdField_c_of_type_Int;
            paramString.roomId = paramangn.jdField_a_of_type_Long;
            paramString.mApolloMessage.id = paramangn.jdField_b_of_type_Int;
            paramString.gameName = paramangn.jdField_b_of_type_JavaLangString;
            paramString.gameExtendJson = paramangn.jdField_c_of_type_JavaLangString;
            paramString.gameStatus = paramangn.e;
            paramString.extendJson = ("{\"gameStatus\":" + paramangn.e + "}");
        ...
        {
          ((JSONObject)localObject).put("msgTyep", paramangn.d);
          continue;
        }
        paramString.msgType = paramangn.d;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    ((amhd)paramQQAppInterface.getManager(153)).a().b(paramString1, paramString2);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, long paramLong, int paramInt)
  {
    ...
    ApolloGameData localApolloGameData = ((ancd)localObject2).a(paramInt);
    Object localObject1 = anni.a(2131700919);
    if ((localApolloGameData != null) && (!TextUtils.isEmpty(localApolloGameData.name)))
    {
      localObject2 = ((ancd)localObject2).a(localApolloGameData.actionId);
    ...
    for (;;)
    {
      int i = localApolloGameData.actionId;
      localangn.jdField_b_of_type_JavaLangString = localApolloGameData.name;
      localangn.jdField_a_of_type_JavaLangString = ((String)localObject1);
      localangn.jdField_b_of_type_Int = i;
      localangn.jdField_a_of_type_Int = paramInt;
      localangn.jdField_a_of_type_Long = paramLong;
      localangn.e = 0;
      ...
      if (!TextUtils.isEmpty(localangn.jdField_a_of_type_JavaLangString)) {
        ((ApolloMessage)localObject2).name = localangn.jdField_a_of_type_JavaLangString.getBytes();
      }
      localObject1 = null;
      if (0 == 0) {}
      for (;;)
      {
        try
        {
          ...
          ((JSONObject)localObject1).put("gameId", localangn.jdField_a_of_type_Int);
          ((JSONObject)localObject1).put("gameMode", localangn.jdField_c_of_type_Int);
          ((JSONObject)localObject1).put("roomid", localangn.jdField_a_of_type_Long);
          if (localangn.jdField_a_of_type_Int == 1)
          {
            ((JSONObject)localObject1).put("msgTyep", 2);
            ((JSONObject)localObject1).put("gameName", localangn.jdField_b_of_type_JavaLangString);
            if (!TextUtils.isEmpty(localangn.jdField_c_of_type_JavaLangString)) {
              ((JSONObject)localObject1).put("gameExtendJson", localangn.jdField_c_of_type_JavaLangString);
            }
            ((JSONObject)localObject1).put("gameStatus", localangn.e);
            if (localObject1 != null) {
              ((ApolloMessage)localObject2).extStr = ((JSONObject)localObject1).toString();
            }
            localObject1 = ((amhd)paramQQAppInterface.getManager(153)).b(paramQQAppInterface.getCurrentAccountUin());
            ((ApolloMessage)localObject2).sender_ts = bgjw.a(((ApolloBaseInfo)localObject1).apolloServerTS);
            ...
            localObject1 = bbzh.a(paramQQAppInterface, paramString1, paramQQAppInterface.getCurrentAccountUin(), 1036, (ApolloMessage)localObject2);
            if (localangn.jdField_a_of_type_Int != 1) {
              break label698;
            }
            ((MessageForApollo)localObject1).msgType = 2;
            ((MessageForApollo)localObject1).gameId = localangn.jdField_a_of_type_Int;
            ((MessageForApollo)localObject1).mGameMode = localangn.jdField_c_of_type_Int;
            ((MessageForApollo)localObject1).roomId = localangn.jdField_a_of_type_Long;
            ((MessageForApollo)localObject1).mApolloMessage.id = localangn.jdField_b_of_type_Int;
            ((MessageForApollo)localObject1).gameName = localangn.jdField_b_of_type_JavaLangString;
            ((MessageForApollo)localObject1).gameExtendJson = localangn.jdField_c_of_type_JavaLangString;
            ((MessageForApollo)localObject1).gameStatus = localangn.e;
            ((MessageForApollo)localObject1).extendJson = ("{\"gameStatus\":" + localangn.e + ",\"robotOpenId\":" + paramString2 + "}");
            ...
            jdField_a_of_type_Long = System.currentTimeMillis();
            return;
            localangn.jdField_b_of_type_JavaLangString = anni.a(2131700921);
            i = 0;
            break;
          }
          ((JSONObject)localObject1).put("msgTyep", localangn.d);
          continue;
          ((MessageForApollo)localObject1).msgType = localangn.d;
        }
        catch (Throwable paramQQAppInterface)
        {
          QLog.d("CmGameTemp_CmGameSessionUtil", 2, paramQQAppInterface, new Object[0]);
  ...
  public static boolean a()
  {
    if ((BaseActivity.sTopActivity instanceof FragmentActivity))
    {
      ...
      if (localObject != null)
      {
        ...
        if (!(localObject instanceof ahyk)) {}
      }
    }
    for (Object localObject = (ahyk)localObject;; localObject = null) {
      return (localObject != null) && (((ahyk)localObject).E());
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      adrm.b(paramQQAppInterface, localSessionInfo, (ArkAppMessage)localObject);
      return true;
    }
