  ...
  implements View.OnClickListener, CompoundButton.OnCheckedChangeListener
{
  ...
  alzu jdField_a_of_type_Alzu;
  amoo jdField_a_of_type_Amoo;
  public View a;
  ...
  public amol(@NonNull BaseActivity paramBaseActivity, @NonNull ArrayList<QIMNotifyAddFriend> paramArrayList)
  {
    ...
    this.jdField_a_of_type_Alzu = ((alzu)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppInterface().getManager(257));
    ...
    {
      paramArrayList = b();
      azqs.b(null, "dc00898", "", "", "0X8008A9E", "0X8008A9E", 0, 0, "", "", "", "");
      ...
      {
        paramArrayList = (ImageView)paramArrayList.findViewById(2131373311);
    ...
    for (;;)
    {
      ...
      return;
      paramArrayList = a();
      azqs.b(null, "dc00898", "", "", "0X8008AA1", "0X8008AA1", 0, 0, "", "", "", "");
  ...
  private View a()
  {
    ...
    View localView = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131560724, null, false);
    localView.findViewById(2131369194).setOnClickListener(this);
    localView.findViewById(2131364327).setOnClickListener(this);
    TextView localTextView = (TextView)localView.findViewById(2131371112);
    String str = this.jdField_a_of_type_ComTencentMobileqqFlashchatFlashChatManager.c();
    if (!TextUtils.isEmpty(str)) {
      localTextView.setText(str);
    }
    this.jdField_a_of_type_ComTencentWidgetListView = ((XListView)localView.findViewById(2131369519));
    this.jdField_a_of_type_ComTencentWidgetListView.setSelector(new ColorDrawable(0));
    this.jdField_a_of_type_Amoo = new amoo(this, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app);
    this.jdField_a_of_type_Amoo.a(localList);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Amoo);
    ((Button)localView.findViewById(2131364689)).setOnClickListener(this);
    return localView;
  }
  ...
  private View b()
  {
    ...
    RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131560767, null, false);
    localRelativeLayout.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewView = localRelativeLayout;
    Object localObject2 = localRelativeLayout.findViewById(2131365253);
    ((View)localObject2).setOnClickListener(this);
    Object localObject3 = (RelativeLayout.LayoutParams)((View)localObject2).getLayoutParams();
    ((RelativeLayout.LayoutParams)localObject3).width = aepi.a(286.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
    ...
    ((PressDarkImageView)localObject3).setId(2131364327);
    ((PressDarkImageView)localObject3).setImageResource(2130846088);
    Object localObject4 = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject4).addRule(3, 2131365253);
    ((RelativeLayout.LayoutParams)localObject4).addRule(14);
    ((RelativeLayout.LayoutParams)localObject4).topMargin = aepi.a(28.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
    ...
    localObject3 = (TextView)((View)localObject2).findViewById(2131365270);
    ...
    localObject4 = (ImageView)((View)localObject2).findViewById(2131365932);
    Object localObject5 = (TextView)((View)localObject2).findViewById(2131371146);
    localObject3 = (TextView)((View)localObject2).findViewById(2131364614);
    ((View)localObject2).findViewById(2131364689).setOnClickListener(this);
    Object localObject6 = (TextView)((View)localObject2).findViewById(2131375413);
    ((TextView)localObject6).setTag(Long.valueOf(((QIMNotifyAddFriend)localObject1).uin));
    Object localObject7 = this.jdField_a_of_type_Alzu.a(((QIMNotifyAddFriend)localObject1).uin, ((QIMNotifyAddFriend)localObject1).qqUin);
    label410:
    int i;
    int j;
    int k;
    if (TextUtils.isEmpty((CharSequence)localObject7))
    {
      ...
      ((ImageView)localObject4).setImageDrawable(bdbk.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, String.valueOf(((QIMNotifyAddFriend)localObject1).uin), (byte)2));
      ...
      if (i > 0)
      {
        localObject2 = (LinearLayout)((View)localObject2).findViewById(2131377076);
        ((LinearLayout)localObject2).setVisibility(0);
        if (i != 1) {
          break label685;
        }
        localObject3 = new ImageView(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
        i = aepi.a(128.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        j = aepi.a(188.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        k = aepi.a(4.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        ...
        localObject6 = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDrawable(2130839372);
    ...
    for (;;)
    {
      ...
      ((ImageView)localObject3).setOnClickListener(new amom(this, ((QIMNotifyAddFriend.VideoInfo)((QIMNotifyAddFriend)localObject1).videoInfos.get(0)).videoVid));
    ...
    for (;;)
    {
      ...
      if (i < ((List)localObject1).size())
      {
        ...
        j = aepi.a(76.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        k = aepi.a(122.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        int m = aepi.a(4.0F, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources());
        ...
        Drawable localDrawable = this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getResources().getDrawable(2130839372);
      ...
      for (;;)
      {
        ...
        ((URLImageView)localObject5).setOnClickListener(new amon(this, (ArrayList)localObject3, (QIMNotifyAddFriend.VideoInfo)localObject4));
  ...
  public void a()
  {
    Button localButton = (Button)getWindow().findViewById(2131364689);
  ...
  public boolean a(List<QIMNotifyAddFriend> paramList)
  {
    ...
    if (this.jdField_a_of_type_Amoo != null)
    {
      ...
      this.jdField_a_of_type_Amoo.a(this.jdField_a_of_type_JavaUtilList);
      a();
      bool = true;
    }
    return bool;
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131364689: 
      do
      {
        ...
        this.jdField_a_of_type_Alzu.a(this.b);
        if (this.jdField_a_of_type_Int == 1)
        {
          azqs.b(null, "dc00898", "", "", "0X8008A9F", "0X8008A9F", 0, 0, "", "", "", "");
          return;
        }
      } while (this.jdField_a_of_type_Int != 2);
      azqs.b(null, "dc00898", "", "", "0X8008AA2", "0X8008AA2", 0, 0, "", "", "", "");
      return;
    case 2131364327: 
      if (this.jdField_a_of_type_Int == 1) {
        azqs.b(null, "dc00898", "", "", "0X8008AA0", "0X8008AA0", 0, 0, "", "", "", "");
      }
      for (;;)
      {
        dismiss();
        ...
        if (this.jdField_a_of_type_Int == 2) {
          azqs.b(null, "dc00898", "", "", "0X8008AA3", "0X8008AA3", 0, 0, "", "", "", "");
        }
      }
    }
    dismiss();
