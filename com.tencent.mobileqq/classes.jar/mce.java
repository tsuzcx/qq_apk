...
public class mce
  extends ajvl
{
  public mce(ConferenceFlyTicketActivity paramConferenceFlyTicketActivity) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong1, String paramString1, String paramString2, long paramLong2)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        this.a.jdField_a_of_type_Mcf = new mcf(this.a);
        paramString1 = new ArrayList();
        mup localmup = new mup();
        localmup.jdField_a_of_type_JavaLangString = ("http://pubacc.mobile.qq.com/mqqweb-rtx2qq/mqqweb/createConfCallback?feedkey=" + this.a.b);
        ...
        localmup.jdField_a_of_type_JavaLangString = (localmup.jdField_a_of_type_JavaLangString + "&ret=0&ticket=" + this.a.d);
        paramString1.add(localmup);
        this.a.jdField_a_of_type_Mcf.execute(new ArrayList[] { paramString1 });
      }
      return;
    }
    this.a.jdField_a_of_type_Ajvi.c(paramLong2);
    this.a.a(1, paramInt);
  }
  ...
  protected void a(boolean paramBoolean, long paramLong, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (!TextUtils.isEmpty(this.a.h)) {
        ((ajvi)this.a.app.a(6)).a(paramLong);
      }
      return;
    }
    this.a.a(1, paramInt);
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      {
        this.a.c();
        AudioHelper.b(ajyc.a(2131702371));
        ((ajvi)this.a.app.a(6)).a(l);
        return;
      }
      this.a.finish();
      return;
