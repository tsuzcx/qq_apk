  ...
  extends BaseAdapter
{
  ...
  public ashg(SDKSetEmotionPreviewFragment paramSDKSetEmotionPreviewFragment)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559058, null);
      ...
      paramViewGroup = new ashi(this);
      paramViewGroup.a = ((URLImageView)paramView.findViewById(2131365655));
    ...
    for (;;)
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject).mPlayGifImage = awkr.a(str);
      ...
      paramViewGroup.a.setOnClickListener(new ashh(this, str, (View)localObject));
      return paramView;
      paramViewGroup = (ashi)paramView.getTag();
    }
  }
}
