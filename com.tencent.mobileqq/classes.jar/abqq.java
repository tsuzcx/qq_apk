  ...
  extends ajto
{
  ...
  protected void onGetAllowStrangerInviteToGroupSwitch(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    if (!paramBoolean1)
    {
      ...
      Card localCard = ((ajxl)this.a.app.getManager(51)).c(this.a.app.getCurrentAccountUin());
  ...
  protected void onGetCalReactiveDays(boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((paramBoolean1) && (!this.a.isFinishing()))
    {
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem.setRightText(ajya.a(2131699436));
    }
    for (;;)
    {
      ...
      return;
      label106:
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetFormSimpleItem.setRightText(ajya.a(2131699437));
    }
  }
  ...
  protected void onSetMedal(boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      bcql.a(this.a.app.getApp(), 1, this.a.getString(2131719386), 3000).b(this.a.getTitleBarHeight());
      localObject1 = this.a;
    ...
    Object localObject1 = ((ajxl)this.a.app.getManager(51)).c(this.a.app.getCurrentAccountUin());
    ...
    for (;;)
    {
      axqy.b((QQAppInterface)localObject2, "dc00898", "", "", "0X80073A0", "0X80073A0", i, 0, "", "", "", "");
      return;
      label260:
      paramBoolean = false;
      break;
