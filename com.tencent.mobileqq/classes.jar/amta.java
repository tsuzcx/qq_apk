...
{
  public amta(MessageForQQWalletTips paramMessageForQQWalletTips, SoftReference paramSoftReference1, SoftReference paramSoftReference2, QQAppInterface paramQQAppInterface, Context paramContext, acxx paramacxx, agjk paramagjk, int paramInt) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips.bytes_jumpurl))
      {
        ...
        paramView = bfod.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips.bytes_jumpurl, MessageForQQWalletTips.access$100(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), true);
        agwi.a(this.jdField_a_of_type_AndroidContentContext, paramView);
        return;
      }
      if ((MessageForQQWalletTips.access$200(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips) != 524288) || (this.jdField_a_of_type_Acxx == null) || (this.jdField_a_of_type_Agjk == null)) {
        break;
      }
      localObject2 = this.jdField_a_of_type_Agjk.a(MessageForQQWalletTips.access$300(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips));
      if ((localObject2 == null) || (((agjj)localObject2).a) || (((agjj)localObject2).b) || (((agjj)localObject2).a())) {
        break;
      }
      paramView = this.jdField_a_of_type_Agjk.a(((agjj)localObject2).e);
    } while (baip.a(paramView));
    this.jdField_a_of_type_Acxx.b(MessageForQQWalletTips.access$300(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips), paramView, ajjy.a(2131640803));
    return;
