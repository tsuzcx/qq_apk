...
import com.tencent.qqmini.proxyimpl.ChannelProxyImpl.16;
  ...
  implements ChannelProxy
{
  ...
  {
    return new bkny(paramAsyncResult);
  }
  ...
  private void a(Activity paramActivity, PublishMoodInfo paramPublishMoodInfo, MiniAppInfo paramMiniAppInfo)
  {
    ...
    if (paramMiniAppInfo != null)
    {
      ...
      if (paramMiniAppInfo != null)
      {
        ...
        if (!TextUtils.isEmpty(paramPublishMoodInfo.mPath))
        {
          ...
          paramPublishMoodInfo = paramActivity.getResources().getString(2131693990);
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("button_txt", paramActivity.getResources().getString(2131694001));
  ...
  public void JudgeTiming(String paramString1, int paramInt1, int paramInt2, int paramInt3, long paramLong, int paramInt4, String paramString2, int paramInt5, String paramString3, int paramInt6, COMM.StCommonExt paramStCommonExt, String paramString4, String paramString5, AsyncResult paramAsyncResult)
  {
    ...
    MiniAppSSOCmdHelper.sendSSOCmdRequest("LightAppSvc.mini_app_growguard.JudgeTiming", paramString1, paramString4, INTERFACE.StJudgeTimingRsp.class, new bknr(this, paramAsyncResult));
  }
  ...
  public void ReportExecute(String paramString1, int paramInt, String paramString2, String paramString3, AsyncResult paramAsyncResult)
  {
    ...
    MiniAppSSOCmdHelper.sendSSOCmdRequest("LightAppSvc.mini_app_growguard.ReportExecute", paramString1, localStReportExecuteReq, INTERFACE.StReportExecuteRsp.class, new bkns(this, paramAsyncResult));
  }
  ...
  public void addGroupApp(IMiniAppContext paramIMiniAppContext, AsyncResult paramAsyncResult)
  {
    ...
    return;
    label198:
    QIPCClientHelper.getInstance().callServer("MiniAppTransferModule", "query_user_troop_info", new Bundle(), new bknq(this, paramIMiniAppContext, str, paramAsyncResult));
  }
  ...
  {
    akra.a(new FocusMpIdReq(paramString1, paramString2), new bknx(this, paramAsyncResult));
    return true;
  }
  ...
  public void ffmpegExecCommand(String[] paramArrayOfString, ChannelProxy.ICommandListenr paramICommandListenr)
  {
    try
    {
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryUtilsFfmpegFFmpeg.execute(paramArrayOfString, new bknp(this, paramICommandListenr));
      return;
    }
  ...
  {
    MiniAppCmdUtil.getInstance().getAuthList(null, paramString, new bknm(this, paramAuthListResult));
  }
  ...
  public void httpReport(Bundle paramBundle)
  {
    if ((paramBundle != null) && (paramBundle.containsKey("data")))
    {
      ...
      {
        localObject = (aocs)((QQAppInterface)localObject).getBusinessHandler(BusinessHandlerFactory.REPORT_HANDLER);
        if (localObject != null) {
          ((aocs)localObject).a(paramBundle);
        }
      }
    }
  }
  ...
  {
    aeow.a(paramActivity, paramIntent, PublicFragmentActivityForMini.class, AddPhoneNumberFragment.class, paramInt);
  }
  
  public void launchPhoneNumberManagementFragment(Activity paramActivity, Intent paramIntent, int paramInt)
  {
    aeow.a(paramActivity, paramIntent, PublicFragmentActivityForMini.class, PhoneNumberManagementFragment.class, paramInt);
  }
  ...
  public boolean openGroup(Context paramContext, String paramString, AsyncResult paramAsyncResult)
  {
    if ((paramContext instanceof Activity))
    {
      ...
      paramString.addActivityResultListener(new bknw(this, paramString, paramAsyncResult));
  ...
  public boolean openQzonePublish(IMiniAppContext paramIMiniAppContext, Activity paramActivity, String paramString, MiniAppInfo paramMiniAppInfo)
  {
    ...
    paramIMiniAppContext = bkqy.a(a(paramIMiniAppContext, paramString));
    if (paramIMiniAppContext != null) {
  ...
  {
    MiniAppSendSmsCodeServlet.sendSmsCodeRequest(paramString1, paramString2, new bknt(this, paramAsyncResult));
  }
  ...
  {
    MiniAppSendSmsCodeServlet.sendVerifySmsCodeRequest(paramString1, paramString2, paramString3, new bknu(this, paramAsyncResult));
  }
  ...
  public boolean tianshuRequestAdv(Context paramContext, String paramString, int paramInt1, int paramInt2, int paramInt3, AsyncResult paramAsyncResult)
  {
    ...
    paramContext.mPosId = paramInt2;
    paramContext.mNeedCnt = paramInt3;
    paramContext.mExtraData = new HashMap();
    JSONObject localJSONObject = new JSONObject();
    JSONArray localJSONArray = new JSONArray();
    ...
    try
    {
      ...
      paramContext.mExtraData.put("FilterInfo", localJSONObject.toString());
      MiniTianShuManager.requestAdv(Collections.singletonList(paramContext), new bknv(this, paramAsyncResult));
      return true;
    }
