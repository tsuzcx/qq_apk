...
public class bbki
  implements SurfaceTexture.OnFrameAvailableListener, bbkr, AEDecoder
{
  ...
  public bbki(String paramString)
  {
    this.jdField_a_of_type_Bbko = new bbko(paramString, 0, false, false);
  }
  ...
  public void setTexture(int paramInt)
  {
    a();
    this.j = paramInt;
    this.jdField_a_of_type_ComTencentMobileqqRichmediaMediacodecDecoderHWVideoDecoder.a(this.jdField_a_of_type_Bbko, this.k, this, this);
    this.g = 2;
  }
}
