...
public class bedz
{
  public static final LruCache<String, bedz> a;
  public static final AtomicInteger c = new AtomicInteger(1);
  public String a;
  public final CopyOnWriteArrayList<beec> a;
  ...
  /* Error */
  public static bedz a(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   60: astore_0
    //   61: aload_0
    //   62: invokestatic 90	bedz:b	(Ljava/lang/String;)Lbedz;
    //   65: astore_2
    //   66: goto -52 -> 14
    //   69: astore_0
    //   70: aload_0
  ...
  public static bedz b(String paramString)
  {
    ...
    try
    {
      ...
      {
        bedz localbedz = (bedz)jdField_a_of_type_AndroidSupportV4UtilLruCache.get(paramString);
        localObject = localbedz;
        if (localbedz == null)
        {
          localObject = new bedz(paramString);
  ...
  public void a(beec parambeec, String paramString)
  {
    if ((this.b.get() == 3) && (parambeec != null))
    {
      ...
      parambeec.onCheckOfflineFinish(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get());
    }
    do
    {
      return;
      if ((parambeec != null) && (!this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(parambeec))) {
        this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(parambeec);
      }
      parambeec = new SwiftBrowserOfflineHandler.1(this, paramString);
    ...
    ThreadManager.postImmediately(parambeec, new beeb(this), false);
  }
