  ...
  implements aavw
{
  ...
  private void a(Activity paramActivity)
  {
    ...
    try
    {
      localObject2 = BitmapFactory.decodeResource(paramActivity.getResources(), 2130848597);
    ...
    this.jdField_a_of_type_Biqx = new biqx((Bitmap)localObject2, (int)(paramActivity.getResources().getDisplayMetrics().density * 12.0F));
  ...
  public void a()
  {
    ...
    if ((this.b) && (this.jdField_a_of_type_AndroidWidgetImageView.getVisibility() == 4))
    {
      if ((this.jdField_a_of_type_AndroidGraphicsRect.width() == 0) || (this.jdField_a_of_type_AndroidGraphicsRect.height() == 0))
      {
        ...
        this.jdField_a_of_type_Biqx.setBounds(this.jdField_a_of_type_AndroidGraphicsRect);
  ...
  public void a(int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_Biqx.setLevel(paramInt * 100);
      this.jdField_a_of_type_Biqx.invalidateSelf();
      return;
    }
    this.jdField_a_of_type_Biqx.a();
  }
  
  public void a(Activity paramActivity, aavk paramaavk)
  {
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((RelativeLayout)paramaavk.a()).findViewById(2131373257));
    a(paramActivity);
  }
