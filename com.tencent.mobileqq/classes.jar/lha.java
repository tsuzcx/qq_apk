...
{
  public lha(ReadInJoyDeliverBiuActivity paramReadInJoyDeliverBiuActivity) {}
  ...
  public void c(int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      QQToast.a(this.a, 2, this.a.getString(2131438850), 0).b(this.a.getTitleBarHeight());
    ...
    for (;;)
    {
      ...
      if (paramInt == 33)
      {
        QQToast.a(this.a, 1, this.a.getString(2131438851), 0).b(this.a.getTitleBarHeight());
        break;
      }
      QQToast.a(this.a, 1, this.a.getString(2131438849), 0).b(this.a.getTitleBarHeight());
      break;
      label325:
      bool = false;
    }
