  ...
  extends ajtd
{
  ...
  private lgv jdField_a_of_type_Lgv = lgv.a();
  private lgz jdField_a_of_type_Lgz = lgz.a();
  private int b;
  
  public lha(AppInterface paramAppInterface)
  {
  ...
  private AudioTransClientTransInfo.IntHead a(int paramInt1, int paramInt2)
  {
    ...
    localIntHead.str_session_id.set(String.valueOf(this.jdField_a_of_type_Lgz.jdField_a_of_type_Long));
  ...
  private AudioTransClientTransInfo.IntReqBody a(int paramInt1, boolean paramBoolean, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      paramArrayOfByte.uint32_client_ver.set(muf.b());
  ...
  {
    Object localObject1 = this.jdField_a_of_type_Lgv;
    localObject1 = lgv.a(paramArrayOfByte);
    paramArrayOfByte = ((lgw)localObject1).a;
    localObject1 = ((lgw)localObject1).b;
  ...
  public void a(String paramString1, long paramLong, String paramString2, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      lgv locallgv = this.jdField_a_of_type_Lgv;
      localToServiceMsg.putWupBuffer(lgv.a(localIntHead.toByteArray(), paramArrayOfByte.toByteArray()));
      if (bbev.g(this.mApp.getApplication().getApplicationContext())) {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (bool)
    {
      paramObject = this.jdField_a_of_type_Lgv;
      paramObject = lgv.a(paramFromServiceMsg.getWupBuffer());
      ...
      for (;;)
      {
        ...
        else if (j == 6)
        {
          ...
          this.jdField_a_of_type_Lgz.jdField_a_of_type_Int = paramFromServiceMsg.enum_channel_type.get();
          if (AudioHelper.e())
          {
            m = paramFromServiceMsg.uint32_combine_num.get();
            QLog.d("AudioTransClientInterfaceHandler", 2, "enum_channel_type = " + this.jdField_a_of_type_Lgz.jdField_a_of_type_Int);
            ...
            while (paramFromServiceMsg.hasNext())
            {
              ...
              lgv locallgv = this.jdField_a_of_type_Lgv;
              QLog.d("AudioTransClientInterfaceHandler", 2, lgv.a(paramObject.fixed32_IP.get()));
              ...
              locallgv = this.jdField_a_of_type_Lgv;
              QLog.d("AudioTransClientInterfaceHandler", 2, lgv.a(paramObject.fixed32_inner_IP.get()));
            }
          }
        }
      }
