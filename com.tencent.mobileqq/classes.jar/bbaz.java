...
public class bbaz
{
  ...
  private static Handler jdField_a_of_type_AndroidOsHandler = new bbba(ThreadManager.getSubThreadLooper());
  private static bfms<Integer> jdField_a_of_type_Bfms = new bfms(40);
  ...
  private static void c()
  {
    ...
    for (;;)
    {
      ...
      while (i < j)
      {
        ...
        {
          jdField_a_of_type_Bfms.a(localThread3.getId(), Integer.valueOf(localThread3.getPriority()));
  ...
  private static void d()
  {
    ...
    while (i < j)
    {
      ...
      {
        int k = ((Integer)jdField_a_of_type_Bfms.a(localThread.getId(), Integer.valueOf(0))).intValue();
        if (k != 0) {
