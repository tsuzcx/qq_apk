...
public class aqri
{
  ...
  public aqri(aqry paramaqry)
  {
    this.jdField_a_of_type_Aqry = paramaqry;
  }
  
  public aqri(QQAppInterface paramQQAppInterface, aqry paramaqry)
  {
    this(paramaqry);
  ...
  public static Bundle a(int paramInt1, String paramString, boolean paramBoolean, int paramInt2)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1)
    {
      ...
      aqry localaqry = a((QQAppInterface)localObject);
      paramString = null;
      if (localaqry != null) {
        paramString = localaqry.a(str);
      }
      if (paramString != null)
      {
        if (paramBoolean)
      ...
      else
      {
        ...
        localBundle.putBoolean("extra_after_sync_msg", aquy.a());
        paramString = aquy.a((QQAppInterface)localObject);
        localBundle.putInt("key_float_window_position_x", paramString.x);
        localBundle.putInt("key_float_window_position_y", paramString.y);
        aquy.a(((QQAppInterface)localObject).getApp(), 3, true);
  ...
  private static aqry a(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    aqry localaqry = a(paramQQAppInterface);
    ArrayList localArrayList = null;
    if (localaqry != null) {
      localArrayList = localaqry.a(paramQQAppInterface.getCurrentAccountUin(), paramProxyListener);
    }
    aqrm.a(localArrayList);
  }
  ...
  protected static void a(String paramString, int paramInt)
  {
    ...
    for (paramString = ((aqry)localObject1).a(paramString, paramInt);; paramString = null)
    {
      if (paramString == null) {}
      do
      {
        return;
        ((aqry)localObject1).a(((QQAppInterface)localObject2).c(), paramString, null);
        aquy.a(((QQAppInterface)localObject2).getApp(), 3, false);
        ...
        localIntent.putExtra("extra_can_add_colornote", ((aqry)localObject1).a());
        localIntent.putExtras(paramString.parseBundle());
        BaseApplicationImpl.getContext().sendBroadcast(localIntent);
        localObject1 = new ArrayList();
        ((ArrayList)localObject1).add(paramString);
        aqrm.a((ArrayList)localObject1);
  ...
  public static boolean a()
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1)
    {
      ...
      if ((localObject != null) && (((aqry)localObject).a())) {
        bool = true;
      }
    }
    do
  ...
  public static boolean a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1)
    {
      ...
      localObject = ((aqry)localObject).a(false).iterator();
      do
      {
  ...
  private boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return false;
      if (this.jdField_a_of_type_Aqry == null)
      {
        paramQQAppInterface = paramQQAppInterface.a();
        if (paramQQAppInterface != null) {
          this.jdField_a_of_type_Aqry = paramQQAppInterface.a();
        }
      }
    } while (this.jdField_a_of_type_Aqry == null);
    return true;
  }
  ...
  protected static boolean b()
  {
    if (BaseApplicationImpl.sProcessId == 1)
    {
      aqry localaqry = a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
      if ((localaqry != null) && (localaqry.a())) {}
      for (boolean bool = true;; bool = false)
      {
        if (QLog.isColorLevel())
        {
          QLog.d("ColorNoteHelper", 2, "[canAddColorNoteInner] noteProxy: " + localaqry);
          if (localaqry != null) {
            QLog.d("ColorNoteHelper", 2, "[canAddColorNoteInner] canAddColorNote: " + localaqry);
          }
        }
        return bool;
      }
  ...
  protected static boolean b(String paramString1, String paramString2, Object paramObject)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1)
    {
      ...
      aqry localaqry = a(localQQAppInterface);
      if (localaqry != null)
      {
        paramString2 = localaqry.a(localQQAppInterface.c(), paramString1, paramString2, paramObject);
        if (paramString2 != null) {
          bool = true;
        }
      }
  ...
  private static boolean d(ColorNote paramColorNote)
  {
    ...
    aquy.a(localQQAppInterface.getApp(), true, false);
    return localaqry.a(localQQAppInterface.c(), paramColorNote);
  }
  ...
  private boolean e()
  {
    if (!d())
    {
      QLog.e("ColorNoteHelper", 1, "[_updateColorNoteState] app is null" + aqsd.a());
      return false;
    }
    if (!a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
    {
      QLog.e("ColorNoteHelper", 1, "[_updateColorNoteState] proxy is null" + aqsd.a());
      return false;
    }
    return true;
  }
  ...
  private boolean e(ColorNote paramColorNote)
  {
    ...
    for (int i = 1;; i = 0)
    {
      Object localObject = this.jdField_a_of_type_Aqry;
      paramColorNote.animate = true;
      boolean bool1;
      if ((((aqry)localObject).a()) || (i != 0) || (paramColorNote.getServiceType() == 16973824))
      {
        bool1 = ((aqry)localObject).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramColorNote, null, false);
        if (QLog.isColorLevel()) {
          QLog.d("ColorNoteHelper", 2, "addColorNoteInner~~~ " + paramColorNote);
        }
        if (paramColorNote.mExtra != 2)
        {
          localObject = bhsi.a(BaseApplicationImpl.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
          ...
          for (int j = 1;; j = 0)
          {
            if (j != 0)
            {
              aquy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), true, false, paramColorNote);
              if (i != 0) {
                ((SharedPreferences)localObject).edit().putBoolean("color_note_permission_music", false).apply();
              }
            }
            if (i != 0) {
              aquy.a(BaseApplicationImpl.getContext());
            }
            return bool1;
            i = 0;
            break;
      ...
      else
      {
        ...
        QLog.d("ColorNoteHelper", 2, "addColorNoteInner~~~ fail cause count limit, maxCount = " + aqry.a + " , currCount = " + ((aqry)localObject).a());
        return false;
      }
      return bool1;
    }
  ...
  public Bundle a(String paramString, boolean paramBoolean)
  {
    ...
    if (f())
    {
      ...
      paramString = this.jdField_a_of_type_Aqry.a(paramString);
      if (paramString != null)
      {
        if (paramBoolean) {
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        localBundle.putBoolean("extra_after_sync_msg", aquy.a());
        paramString = aquy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        localBundle.putInt("key_float_window_position_x", paramString.x);
        localBundle.putInt("key_float_window_position_y", paramString.y);
        aquy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 3, true);
        return localBundle;
        i = 1;
        break;
      }
  ...
  public boolean a(String paramString)
  {
    ...
    if (f())
    {
      ...
      return a(paramString, this.jdField_a_of_type_Aqry.a(false));
    }
    Bundle localBundle = new Bundle();
  ...
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (this.jdField_a_of_type_Aqry == null) || (bhsr.a(paramString))) {}
    do
    {
      return false;
      paramString = this.jdField_a_of_type_Aqry.a(paramString, paramInt);
    } while (paramString == null);
    this.jdField_a_of_type_Aqry.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramString, null);
    aquy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 3, false);
    Object localObject = paramString.getServiceType() + "";
    String str = paramString.getSubType();
    Intent localIntent = new Intent("key_delete_item_call");
    localIntent.putExtra("key_color_note_servicetype_list", new String[] { localObject });
    localIntent.putExtra("key_color_note_suptype_list", new String[] { str });
    localIntent.putExtra("extra_can_add_colornote", this.jdField_a_of_type_Aqry.a());
    localIntent.putExtras(paramString.parseBundle());
    BaseApplicationImpl.getContext().sendBroadcast(localIntent);
    localObject = new ArrayList();
    ((ArrayList)localObject).add(paramString);
    aqrm.a((ArrayList)localObject);
    return true;
  }
  ...
  boolean b(ColorNote paramColorNote)
  {
    ...
    aquy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), true, false, paramColorNote);
    return this.jdField_a_of_type_Aqry.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramColorNote);
  }
  ...
  public boolean c()
  {
    ...
    for (boolean bool = this.jdField_a_of_type_Aqry.a();; bool = ((EIPCResult)localObject).data.getBoolean("extra_can_add_colornote", true))
    {
      return bool;
      localObject = QIPCClientHelper.getInstance().getClient().callServer("ColorNoteIPCServer", "cmd_can_add_colornote", null);
      if ((localObject == null) || (!((EIPCResult)localObject).isSuccess())) {
  ...
  public boolean c(String paramString1, String paramString2, Object paramObject)
  {
    ...
    do
    {
      ...
      {
        bool1 = bool3;
        if (this.jdField_a_of_type_Aqry.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramString1, paramString2, paramObject) != null) {
          bool1 = true;
        }
      }
      bool2 = bool1;
