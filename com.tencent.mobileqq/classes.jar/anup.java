...
public class anup
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new anuu(this);
  ...
  private boolean a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131495172, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131301767));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131301771));
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131495187, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131301767));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131301768));
      continue;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131495186, null));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131301767));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131301768));
    }
  ...
  private void b(ArrayList<String> paramArrayList)
  {
    ...
    if (localQQAppInterface != null)
    {
      ...
      azwp.a(localQQAppInterface, 1, paramArrayList, 4, (Drawable)localObject, (Drawable)localObject);
    }
  ...
  void b()
  {
    ...
    for (int i = aciy.a(2.0F, ((Context)localObject2).getResources());; i = aciy.a(1.0F, ((Context)localObject2).getResources()))
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setPadding(i, i, i, i);
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(2130844230);
      ...
      try
      {
        ...
        ((ScaleAnimation)localObject1).setAnimationListener(new anuq(this));
  ...
  void c()
  {
    ...
    int j = i - ((Context)localObject1).getResources().getDimensionPixelSize(2131166908);
    if (this.jdField_a_of_type_Int == 2)
    {
      j = ((Context)localObject1).getResources().getDimensionPixelSize(2131166912);
      i -= ((Context)localObject1).getResources().getDimensionPixelSize(2131166910);
    }
    for (;;)
    {
      ...
      localObject3 = new anus(this, (AnimatorSet)localObject1);
      ...
      if (this.jdField_a_of_type_JavaUtilList.size() > 1)
      {
        ...
        for (;;)
        {
          if (j < this.jdField_a_of_type_JavaUtilList.size() - 1)
          {
            ...
            j = ((Context)localObject1).getResources().getDimensionPixelSize(2131166915);
            i -= ((Context)localObject1).getResources().getDimensionPixelSize(2131166913);
            break;
          }
        }
