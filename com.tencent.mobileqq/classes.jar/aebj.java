  ...
  extends ajmm
{
  ...
  protected void a(String paramString1, int paramInt1, int paramInt2, SendMessageHandler paramSendMessageHandler, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    {
      ajke.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSendMessageHandler.a(paramString1), paramString2, true);
      if ((paramInt2 == 112) || (paramInt2 == 113))
      {
        ajko.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, 6);
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      if (this.a.jdField_a_of_type_Aymw != null)
      {
        ...
        if (i != -1)
        {
          ...
          long l = localarom.b(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
          if (((MessageRecord)localObject).uniseq == l) {
            localarom.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, i);
          }
          this.a.jdField_a_of_type_Aymw.a(((MessageRecord)localObject).uniseq);
          if (QLog.isColorLevel())
          {
