  ...
  extends bitr
{
  ...
  public bito(Context paramContext, int paramInt)
  {
  ...
  public View a(int paramInt, ViewGroup paramViewGroup)
  {
    ...
    if (QQStoryContext.a())
    {
      paramViewGroup.setBackgroundColor(this.a.getResources().getColor(2131100756));
      ((View)localObject).setBackgroundColor(this.a.getResources().getColor(2131100756));
      localView.setBackgroundColor(this.a.getResources().getColor(2131100756));
    }
