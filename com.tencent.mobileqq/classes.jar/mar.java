...
{
  public mar(VideoFeedsAdapter paramVideoFeedsAdapter, ActionSheet paramActionSheet, String paramString1, MessageForShortVideo paramMessageForShortVideo, String paramString2, boolean paramBoolean, String paramString3, String paramString4, String paramString5) {}
      ...
      if (paramView.equals(this.b))
      {
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            return;
            QQToast.a(VideoFeedsAdapter.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsAdapter), 0, 2131437392, 0).b(VideoFeedsAdapter.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsAdapter).getResources().getDimensionPixelSize(2131558448));
          }
