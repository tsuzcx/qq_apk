...
public class aagu
{
  public static bfls a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, int paramInt, boolean paramBoolean1, boolean paramBoolean2, aahm paramaahm)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    int i = auea.a(FileUtil.getExtension(paramItem.FileName));
    ...
    for (;;)
    {
      ...
      return a(paramQQAppInterface, paramaahm, paramItem.toByteArray(), "OidbSvc.0x6d6_2", 1750, 2, (Bundle)localObject);
      bool = false;
      break;
      label250:
  ...
  public static bfls a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, aaho paramaaho)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    ...
    ((Bundle)localObject).putString("itemKey", paramItem.Id.toString());
    ((Bundle)localObject).putLong("troopUin", paramLong);
    return a(paramQQAppInterface, paramaaho, localReqBody.toByteArray(), "OidbSvc.0x6d6_1", 1750, 1, (Bundle)localObject);
  }
  
  public static bfls a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, aahq paramaahq)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return null;
    }
    ...
    return a(paramQQAppInterface, paramLong, paramItem.FileName, paramItem.LocalFile, paramItem.ProgressTotal, paramItem.isFromAIO, paramItem.Md5, paramItem.Sha, paramItem.Sha3, paramItem.BusId, paramItem.mParentId, localBundle, paramaahq);
  }
  
  public static bfls a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, int paramInt, aahg paramaahg)
  {
    ...
    return a(paramQQAppInterface, paramaahg, paramString.toByteArray(), "OidbSvc.0x6d8_4", 1752, 4, null);
  }
  
  public static bfls a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, boolean paramBoolean, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString3, int paramInt, String paramString4, Bundle paramBundle, aahq paramaahq)
  {
    ...
    for (paramInt = 5;; paramInt = 4)
    {
      ...
      return a(paramQQAppInterface, paramaahq, paramString1.toByteArray(), "OidbSvc.0x6d6_0", 1750, 0, paramBundle);
      localUploadFileReqBody.str_parent_folder_id.set(paramString4);
      break;
    }
  }
  
  public static bfls a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, String paramString2, long paramLong2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt, String paramString3, Bundle paramBundle, aahq paramaahq)
  {
    if (paramLong1 == 0L) {
      return null;
    }
    return a(paramQQAppInterface, paramLong1, paramString1, paramString2, paramLong2, true, paramArrayOfByte1, paramArrayOfByte2, null, paramInt, paramString3, paramBundle, paramaahq);
  }
  
  private static bfls a(QQAppInterface paramQQAppInterface, ntf paramntf, byte[] paramArrayOfByte, String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    paramArrayOfByte.jdField_a_of_type_Ntf = paramntf;
  ...
  private static String a(TroopFileTransferManager.Item paramItem)
  {
    try
    {
      ...
      Object localObject;
      if (zeb.c(paramItem.middleThumbnailFile)) {
      ...
      for (String str = "mid";; str = "larg")
      {
        ...
        return paramItem.strQRUrl;
        if (!zeb.c(paramItem.largeThumbnailFile)) {
          break;
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, String paramString, int paramInt6, long paramLong2, int paramInt7, ByteStringMicro paramByteStringMicro, aahf paramaahf)
  {
    boolean bool;
    ...
    for (;;)
    {
      ...
      ntb.b(paramQQAppInterface, paramaahf, paramString.toByteArray(), "OidbSvc.0x6d8_1", 1752, 1, paramByteStringMicro);
      return;
      bool = false;
      break;
      label343:
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, Bundle paramBundle, aahn paramaahn)
  {
    a(paramQQAppInterface, paramLong, paramInt1, paramString, paramInt2, paramInt3, paramInt4, paramInt5, paramBoolean, paramBundle, null, paramaahn);
  }
  
  private static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, Bundle paramBundle, msg_ctrl.MsgCtrl paramMsgCtrl, aahn paramaahn)
  {
    ...
    for (;;)
    {
      ...
      ntb.b(paramQQAppInterface, paramaahn, paramMsgCtrl.toByteArray(), "OidbSvc.0x6d9_4", 1753, 4, paramBundle);
      return;
      localFeedsInfo.uint32_feed_flag.set(3);
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, String paramString, long paramLong2, int paramInt2, Bundle paramBundle, aahl paramaahl)
  {
    ...
    ntb.b(paramQQAppInterface, paramaahl, paramString.toByteArray(), "OidbSvc.0x6d9_2", 1753, 2, paramBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt, String paramString, aahi paramaahi)
  {
    ...
    ntb.b(paramQQAppInterface, paramaahi, paramString.toByteArray(), "OidbSvc.0x6d8_0", 1752, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3, aahc paramaahc)
  {
    ...
    ntb.b(paramQQAppInterface, paramaahc, paramString2.toByteArray(), "OidbSvc.0x6d6_3", 1750, 3, (Bundle)localObject);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt, String paramString1, String paramString2, String paramString3, aahj paramaahj)
  {
    ...
    ntb.b(paramQQAppInterface, paramaahj, paramString1.toByteArray(), "OidbSvc.0x6d6_5", 1750, 5);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, aahe paramaahe)
  {
    if (QLog.isDevelopLevel()) {
    ...
    ntb.b(paramQQAppInterface, paramaahe, localReqBody.toByteArray(), "OidbSvc.0x6d8_1", 1752, 2, localBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, aahh paramaahh)
  {
    if (QLog.isDevelopLevel()) {
      QLog.d("TroopFileProtocol", 4, "getFileList" + paramLong);
    }
    ...
    ntb.a(paramQQAppInterface, paramaahh, localReqBody.toByteArray(), "OidbSvc.0x6d8_3", 1752, 3, localBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, bfif parambfif, aahp paramaahp)
  {
    if ((paramLong == 0L) || (parambfif == null)) {
      return;
    }
    ...
    localTransFileReqBody.uint32_bus_id.set(parambfif.a);
    localTransFileReqBody.str_file_id.set(parambfif.b);
    Bundle localBundle = new Bundle();
    localBundle.putLong("troopUin", paramLong);
    localBundle.putString("fileId", parambfif.b);
    parambfif = new oidb_0x6d9.ReqBody();
    parambfif.trans_file_req.set(localTransFileReqBody);
    ntb.b(paramQQAppInterface, paramaahp, parambfif.toByteArray(), "OidbSvc.0x6d9_0", 1753, 0, localBundle);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, aahn paramaahn)
  {
    if ((paramLong == 0L) || (paramItem == null)) {
      return;
    }
    ...
    localObject = avis.a(paramItem.LocalFile, paramItem.width, paramItem.height, (String)localObject);
    a(paramQQAppInterface, paramLong, paramItem.BusId, paramItem.FilePath, paramItem.RandomNum, paramItem.width, paramItem.height, paramItem.duration, true, localBundle, (msg_ctrl.MsgCtrl)localObject, paramaahn);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, aahd paramaahd)
  {
    ...
    ntb.b(paramQQAppInterface, paramaahd, paramString.toByteArray(), "OidbSvc.0x6d7_1", 1751, 1);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, aahb paramaahb)
  {
    ...
    ntb.b(paramQQAppInterface, paramaahb, paramString1.toByteArray(), "OidbSvc.0x6d7_0", 1751, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, aahk paramaahk)
  {
    if ((paramLong == 0L) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      return;
    }
    ...
    ntb.b(paramQQAppInterface, paramaahk, localReqBody.toByteArray(), "OidbSvc.0x6d7_2", 1751, 2, (Bundle)localObject);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, bfls parambfls)
  {
    if ((paramQQAppInterface == null) || (parambfls == null)) {
      return;
    }
    paramQQAppInterface.getTroopFileProtoReqMgr().b(parambfls);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, String paramString5, FileManagerEntity paramFileManagerEntity, aagw paramaagw)
  {
    paramString1 = new bghj("http://" + paramString1 + ":" + paramString2 + "/ftn_compress_list/rkey=" + paramString3 + "&filetype=" + paramInt + "&path=" + bkyp.a(paramString4) + "&", "GET", new aagv(new ArrayList(), paramString4, paramFileManagerEntity, paramQQAppInterface, paramInt, paramaagw), 1000, null);
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, long paramLong1, TroopFileTransferManager.Item paramItem, long paramLong2, long paramLong3, aahl paramaahl)
  {
    ...
    for (;;)
    {
      ...
      ntb.b(paramQQAppInterface, paramaahl, localReqBody.toByteArray(), "OidbSvc.0x6d9_2", 1753, 2, (Bundle)localObject);
      return;
