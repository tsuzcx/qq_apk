  ...
  extends ahzi
{
  ...
  public ahpz(ContactsInnerFrame paramContactsInnerFrame, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  protected boolean a(aiac paramaiac)
  {
    boolean bool2 = super.a(paramaiac);
    boolean bool1 = bool2;
    if ((paramaiac instanceof ahrj))
    {
      paramaiac = (ahrj)paramaiac;
      if ((bool2) && (!paramaiac.jdField_a_of_type_Boolean)) {
        bool1 = true;
      }
    }
    else
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      localView = ahrj.a(paramViewGroup, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater, 2131496808);
    }
    ahrj localahrj = (ahrj)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
      ...
      ahrj.a(this, localahrj, localPhoneContact);
      if (paramInt - 1 < 0)
      {
        paramView = null;
        ...
        localahrj.d.setVisibility(0);
        localahrj.d.setText(localPhoneContact.mobileNo);
        label188:
        localahrj.b.setText(localPhoneContact.name);
        if (!this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b(localahrj.jdField_a_of_type_JavaLangString)) {
          break label394;
        }
        localahrj.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(true);
        label228:
        ...
        localahrj.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(false);
        label271:
        if ((AppSetting.c) && (localahrj.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
        {
          if (!localahrj.jdField_a_of_type_AndroidWidgetCheckBox.isChecked()) {
            break label418;
          }
          localView.setContentDescription(localPhoneContact.name + ajjy.a(2131636770));
        }
      }
      for (;;)
      {
        localahrj.jdField_a_of_type_ComTencentMobileqqDataPhoneContact = localPhoneContact;
        ...
        break label134;
        label381:
        localahrj.d.setVisibility(8);
        break label188;
        label394:
        localahrj.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
        break label228;
        label406:
        localahrj.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(true);
        break label271;
        label418:
        localView.setContentDescription(localPhoneContact.name + ajjy.a(2131636742));
      }
    }
    localahrj.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
    localahrj.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    paramView = String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[i]);
    localahrj.jdField_a_of_type_AndroidWidgetTextView.setText(paramView);
    localahrj.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(String.format(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131626315), new Object[] { paramView.toLowerCase() }));
    return localView;
  }
}
