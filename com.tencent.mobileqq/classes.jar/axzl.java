...
public final class axzl
{
  ...
  public static final Pair<Integer, String> a(@NotNull QQAppInterface paramQQAppInterface, @Nullable Intent paramIntent, @Nullable String paramString)
  {
    ...
    if (paramIntent != null)
    {
      ...
      int j = paramIntent.getIntExtra("param_constellation_id", axyg.b);
      k = k << 16 | m << 8 | n;
      paramIntent = bfre.c(j);
      ...
      axvi.a(paramQQAppInterface, paramIntent);
      if (QLog.isColorLevel()) {
