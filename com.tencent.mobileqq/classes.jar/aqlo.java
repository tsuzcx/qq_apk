  ...
  implements aqmc
{
  ...
  {
    Intent localIntent = new Intent(aqlr.a(aqln.a(this.a)));
    ...
    case 5: 
      for (;;)
      {
        aqln.a(this.a).sendBroadcast(localIntent);
        return;
        ...
        if (aqlr.a(aqln.a(this.a)))
        {
          aqmd.a("2691709");
        }
        else if (aqlr.b(aqln.a(this.a)))
        {
          aqmd.a("2597857");
          continue;
          ...
          else if (aqlr.b(aqln.a(this.a)))
          {
            aqmd.a("2597858");
            continue;
            if ("download".equals(aqln.b(this.a)))
            {
              ...
              aqln.a(this.a, localInstalledPlugin, bool, l);
            }
            if (aqlr.a(aqln.a(this.a)))
            {
              aqmd.a("2691703");
