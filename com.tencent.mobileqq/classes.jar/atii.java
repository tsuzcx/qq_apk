...
{
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new atij(this);
      ...
      for (;;)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramJsBridgeListener))
          {
            ...
            vod.a(localActivity, new VidListPlayInfo(paramJsBridgeListener, paramString3, paramString2, paramString1), 105, null);
            break;
          }
