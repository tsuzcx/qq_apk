  ...
  extends MSFServlet
{
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    txi.a(arrayOfByte, (String)localObject);
    ...
    for (;;)
    {
      try
      {
        ...
        if ((paramIntent.getBooleanExtra("useNewProtocol", false)) || (((super.getAppRuntime() instanceof QQAppInterface)) && (tzo.a((QQAppInterface)super.getAppRuntime(), l + "") != -4)))
        {
