...
public class oaz
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, byte[] paramArrayOfByte, boolean paramBoolean2)
  {
      ...
      try
      {
        ...
        if (((account_detail_dynamic_list.AccountDetailDynamicListResponse)localObject).ret_info.has())
        {
          ...
          if (((account_detail_dynamic_list.AccountDetailDynamicListResponse)localObject).ret_info.ret_code.get() == 0)
          {
            ...
            localArrayList = oay.a(paramQQAppInterface).a(l1);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          i = oay.a(paramQQAppInterface).a(paramArrayOfByte, paramBoolean1, l1, l2, l3, localArrayList, paramBoolean2);
          break;
        }
        i = 5;
        break;
  ...
  private static void a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, int paramInt, aoav paramaoav)
  {
    if (QLog.isColorLevel()) {
    ...
    ((account_detail_dynamic_list.AccountDetailDynamicListRequest)localObject).versionInfo.set("8.4.10,3,4875");
    ...
    if (paramLong2 == 0L)
    {
      ...
      localObject = ((aoan)localObject).a(String.valueOf(paramLong1));
      if (localObject == null) {
        break label351;
      }
      ...
      paramInt = 1;
      i = olh.a(paramQQAppInterface, String.valueOf(paramLong1), (AccountDetail)localObject);
    }
    for (;;)
    {
      ...
      {
        olh.a(null, str1, "0X80077FF", "0X80077FF", 0, 0, "1", str2, (String)localObject, String.valueOf(i), false);
        localNewIntent.setObserver(new oba(paramQQAppInterface, bool, paramaoav));
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, aoav paramaoav)
  {
    oay.a(paramQQAppInterface).a(paramQQAppInterface, paramLong, paramaoav);
    a(paramQQAppInterface, paramLong, 0L, 25, paramaoav);
  }
  
  public static void b(QQAppInterface paramQQAppInterface, long paramLong, aoav paramaoav)
  {
    oao localoao = oay.a(paramQQAppInterface).a(paramLong);
    if ((localoao != null) && (localoao.b > 0L))
    {
      if (a != localoao.b) {
        a(paramQQAppInterface, paramLong, localoao.b, 25, paramaoav);
      }
      return;
    }
    a(paramQQAppInterface, paramLong, paramaoav);
  }
}
