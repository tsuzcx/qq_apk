  ...
  implements View.OnClickListener
{
  ...
  private aiwq jdField_a_of_type_Aiwq = new aiwq(-1, -1);
  ...
  private WeakReference<ajpw> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public ajpn(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, BaseChatPie paramBaseChatPie)
  {
  ...
  private void a(View paramView)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewViewGroup != paramView)
    {
      ...
      this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364674));
      ...
      this.jdField_c_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131364670));
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131363626));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131363669));
      this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetButton = ((Button)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131363670));
      this.jdField_c_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_d_of_type_AndroidWidgetButton = ((Button)this.jdField_b_of_type_AndroidViewViewGroup.findViewById(2131363474));
      this.jdField_d_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_d_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364683));
  ...
  private void a(ApolloGameData paramApolloGameData)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = ((airz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a();
        if ((this.jdField_a_of_type_JavaLangRefWeakReference == null) || (this.jdField_a_of_type_JavaLangRefWeakReference.get() == null))
        {
          localObject2 = new ajpw(this);
          this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(localObject2);
          ((aizk)localObject1).a((aizm)localObject2);
        }
        ((ajpw)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_Int = ((int)(System.currentTimeMillis() / 1000L));
        if (!paramApolloGameData.isGameApp)
        {
          ((aizk)localObject1).a(paramApolloGameData.gameId, ((ajpw)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_Int);
          ...
          if (((SparseArray)localObject1).get(2000) != null)
          {
            ...
            ApolloGameUtil.a(this.jdField_a_of_type_Aukn, paramApolloGameData.gameId, 2000);
            if (this.jdField_a_of_type_Ajps != null) {
              this.jdField_a_of_type_Ajps.notifyDataSetChanged();
            }
          }
        }
      }
      ...
      for (int i = 1;; i = 0)
      {
        ...
        for (localObject2 = "1";; localObject2 = "0")
        {
          ...
          return;
          aizg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_b_of_type_AndroidContentContext, this.jdField_b_of_type_ComTencentMobileqqActivityAioSessionInfo, paramApolloGameData, ((ajpw)this.jdField_a_of_type_JavaLangRefWeakReference.get()).jdField_a_of_type_Int);
          break;
  ...
  private void b(ApolloGameData paramApolloGameData)
  {
    ...
    bbcv.a(this.jdField_b_of_type_AndroidContentContext, 230).setMessage(this.jdField_b_of_type_AndroidContentContext.getResources().getString(2131690114)).setPositiveButton(2131690096, new ajpq(this, paramApolloGameData)).setNegativeButton(2131690097, new ajpp(this)).show();
  }
  ...
  private void c(ApolloGameData paramApolloGameData)
  {
    ...
    bbcv.a(this.jdField_b_of_type_AndroidContentContext, 230).setMessage(this.jdField_b_of_type_AndroidContentContext.getResources().getString(2131690099)).setPositiveButton(2131690097, new ajpr(this)).show();
  }
  
  private void e()
  {
    bcpw.a(BaseApplicationImpl.getContext(), 1, ajyc.a(2131700340), 0).a();
  }
  ...
  public View a()
  {
    ...
    } while (!bbev.g(this.jdField_b_of_type_AndroidContentContext));
    localTextView.setText(ajyc.a(2131700370));
    localTextView.setOnClickListener(new ajpo(this));
    return localObject2;
  }
  ...
  public ApolloGameData a()
  {
    ...
    localApolloGameData.name = aixt.a("aio.enter.name");
    localApolloGameData.listCoverUrl = aixt.a("aio.enter.bg");
    localApolloGameData.isSetting = true;
    localApolloGameData.toolUrl = aixt.a("aio.enter");
  ...
  public void a()
  {
    super.a();
    if (this.jdField_a_of_type_Ajps != null) {
      this.jdField_a_of_type_Ajps.a();
    }
    if ((a()) && (airv.a("apollo_aio_game_guide") == -1))
    {
      airv.a("apollo_aio_game_guide", 1);
      if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      {
        ajpw localajpw = (ajpw)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        if (localajpw != null)
        {
          ((airz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a().b(localajpw);
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Ajps == null) {
      this.jdField_a_of_type_Ajps = new ajps(this.jdField_b_of_type_AndroidContentContext, this);
    }
    this.jdField_a_of_type_Ajps.a(this.jdField_b_of_type_JavaUtilList);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ajps);
    if ((this.jdField_a_of_type_Aiwq != null) && (this.jdField_a_of_type_Aiwq.jdField_a_of_type_Int > 0) && (this.jdField_b_of_type_JavaUtilList.size() > 1))
    {
      paramView = this.jdField_b_of_type_JavaUtilList.iterator();
      while (paramView.hasNext()) {
        if (((ApolloGameData)paramView.next()).gameId == this.jdField_a_of_type_Aiwq.jdField_a_of_type_Int)
        {
          if (QLog.isColorLevel()) {
            QLog.d("ApolloGameViewBinder", 2, new Object[] { "[updatePanel] jump gameId:", Integer.valueOf(this.jdField_a_of_type_Aiwq.jdField_a_of_type_Int), ",from:", Integer.valueOf(this.jdField_a_of_type_Aiwq.jdField_b_of_type_Int) });
          }
          VipUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "cmshow", "Apollo", "avatar_clk_togame", this.jdField_b_of_type_Int, this.jdField_a_of_type_Aiwq.jdField_b_of_type_Int, new String[] { String.valueOf(this.jdField_a_of_type_Aiwq.jdField_a_of_type_Int) });
        }
      }
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(List<ApolloGameData> paramList)
  {
    ...
    if ((this.jdField_b_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int != 1036) && (paramList != null) && (aixt.a("aio.city.game", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == aixu.jdField_d_of_type_Int)) {
      paramList.add(0, a());
    }
    this.jdField_b_of_type_JavaUtilList = paramList;
    this.jdField_a_of_type_AndroidUtilSparseArray = ApolloGameUtil.a(this.jdField_a_of_type_Aukn);
    ...
    this.jdField_c_of_type_JavaUtilList = ((ajmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).g(6);
  }
  ...
  public boolean a(int paramInt)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ??? = (ajmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
      if (TextUtils.isEmpty(a())) {
        return false;
      }
      if (this.jdField_b_of_type_ComTencentMobileqqActivityAioSessionInfo != null) {
        this.jdField_c_of_type_JavaUtilList = ((ajmw)???).a(ApolloGameUtil.a(), this.jdField_b_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      }
  ...
  public void b(List<ApolloGameData> paramList)
  {
    ...
    {
      return;
      if ((paramList != null) && (aixt.a("aio.city.game", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == aixu.jdField_d_of_type_Int)) {
        paramList.add(0, a());
      }
    } while ((this.jdField_b_of_type_JavaUtilList == null) || (paramList == null) || (this.jdField_a_of_type_Ajps == null));
    this.jdField_b_of_type_JavaUtilList.clear();
    this.jdField_b_of_type_JavaUtilList.addAll(paramList);
    this.jdField_a_of_type_Ajps.notifyDataSetChanged();
  }
  ...
  public void d()
  {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      if (aixt.a("aio.panel.rank.time") < System.currentTimeMillis() / 1000L)
      {
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0)) {
        ...
        aixt.a("aio.panel.rank.time", (int)(System.currentTimeMillis() / 1000L) + 300);
      }
      return;
    }
  }
