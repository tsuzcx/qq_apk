  ...
  extends xfp
{
  ...
  {
    if ((ajut.a.equals(paramToServiceMsg.getServiceCmd())) || (ajut.b.equals(paramToServiceMsg.getServiceCmd())))
    {
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (ajut.a.equals(paramToServiceMsg.getServiceCmd()))
    {
    ...
    {
      return true;
      if (ajut.b.equals(paramToServiceMsg.getServiceCmd()))
      {
