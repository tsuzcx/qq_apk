  ...
  extends aczt
{
  ...
  private aczl jdField_a_of_type_Aczl;
  private adys jdField_a_of_type_Adys;
  protected Rect a;
  public View a;
  public bbqt a;
  public String a;
  ...
  public aczk(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  public boolean a(String paramString)
  {
    ...
    localObject = bbdx.a(paramString);
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    this.jdField_a_of_type_Bbqt = ((bbqt)paramVarArgs[6]);
  ...
  public boolean b()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Adys = null;
      this.c = actj.a(Long.valueOf(this.jdField_a_of_type_JavaLangString).longValue(), this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
      localObject = actj.a(actj.a(this.jdField_a_of_type_ComTencentWidgetListView, this.c));
      if ((localObject != null) && ((localObject instanceof adys))) {
        this.jdField_a_of_type_Adys = ((adys)localObject);
      }
      while (this.jdField_a_of_type_Adys == null)
      {
        a(true);
        return false;
        if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_Adys.a != null)
      {
        localObject = this.jdField_a_of_type_Adys.a.a();
    ...
    {
      label284:
      m += (int)(this.jdField_a_of_type_Bbqt.a * k);
      j += (int)(this.jdField_a_of_type_Bbqt.b * i);
      localObject = this.jdField_a_of_type_AndroidGraphicsRect;
      float f = this.jdField_a_of_type_Bbqt.c;
      k = (int)(k * f);
      f = this.jdField_a_of_type_Bbqt.d;
      ...
      if (this.jdField_a_of_type_AndroidViewView == null)
      {
        this.jdField_a_of_type_Aczl = null;
        ...
        localObject = actj.a(actj.a(this.jdField_a_of_type_ComTencentWidgetListView, this.c));
        if ((localObject != null) && ((localObject instanceof aczl)))
        {
          this.jdField_a_of_type_Aczl = ((aczl)localObject);
          label484:
          ...
          j = this.jdField_a_of_type_Aczl.a.getRight() - this.jdField_a_of_type_Aczl.a.getLeft();
          i = this.jdField_a_of_type_Aczl.a.getBottom() - this.jdField_a_of_type_Aczl.a.getTop();
        }
      }
      for (;;)
      {
