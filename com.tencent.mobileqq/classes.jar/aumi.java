...
public class aumi
{
  private static aumi jdField_a_of_type_Aumi;
  ...
  {
    if (jdField_a_of_type_Aumi == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Aumi == null) {
        jdField_a_of_type_Aumi = new aumi();
      }
      return jdField_a_of_type_Aumi;
    }
  }
  ...
  public int a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString, WtloginObserver paramWtloginObserver)
  {
    ...
    return paramQQAppInterface.RegGetSMSVerifyLoginAccount(paramArrayOfByte1, paramArrayOfByte2, paramString, "8.2.8", paramWtloginObserver);
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    localbbgg.setTitle(2131717168);
    localbbgg.setMessage(2131717167);
    paramQQAppInterface = new aumj(this, str, paramActivity, paramQQAppInterface);
    paramActivity = new aumk(this);
    localbbgg.setPositiveButton(2131717166, paramQQAppInterface);
    localbbgg.setNegativeButton(2131690596, paramActivity);
    localbbgg.show();
    return false;
  }
