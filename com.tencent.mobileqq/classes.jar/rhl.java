  ...
  extends LinearLayout
{
  ...
  public rhl(TabLayoutCompat paramTabLayoutCompat, Context paramContext)
  {
    super(paramContext);
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      while ((i != k) || (j != m))
      {
        ...
        ((ValueAnimator)localObject).addUpdateListener(new rhm(this, i, k, j, m));
        ((ValueAnimator)localObject).addListener(new rhn(this, paramInt1));
