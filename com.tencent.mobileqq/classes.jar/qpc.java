...
public class qpc
{
  ...
  private List<qpe> jdField_a_of_type_JavaUtilList = new Vector();
  ...
  public void a(qpe paramqpe)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.add(paramqpe);
      return;
    }
  }
  
  public void b(qpe paramqpe)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      this.jdField_a_of_type_JavaUtilList.remove(paramqpe);
      return;
    }
  }
}
