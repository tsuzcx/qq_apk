  ...
  extends MSFServlet
{
  ...
  public static void a(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, BusinessObserver paramBusinessObserver)
  {
    try
    {
      ...
      a("https://graph.qq.com/face/if_proxy", "application/json", localJSONObject.toString(), new bccm(paramBusinessObserver));
      return;
    }
  ...
  public static void a(int paramInt, byte[] paramArrayOfByte, long paramLong, BusinessObserver paramBusinessObserver)
  {
    try
    {
      ...
      a("https://graph.qq.com/face/available", "application/json", ((JSONObject)localObject).toString(), 2000, 2000, new bccn(paramBusinessObserver));
      return;
    }
  ...
  private static void a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, int paramInt2, byte[] paramArrayOfByte, BusinessObserver paramBusinessObserver)
  {
    ...
    paramArrayOfByte = new NewIntent(paramQQAppInterface.getApp(), bccl.class);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, ayeu paramayeu)
  {
    paramString = new FaceSecureCheck.SecureCheckRequest();
    Object localObject = ptj.a(BaseApplicationImpl.getApplication());
    boolean bool;
    if (localObject != null)
    {
    ...
    for (;;)
    {
      ...
      localObject = new NewIntent(paramQQAppInterface.getApp(), bccl.class);
      ((NewIntent)localObject).setObserver(paramayeu);
  ...
  public static void a(String paramString1, long paramLong, String paramString2, BusinessObserver paramBusinessObserver)
  {
    try
    {
      ...
      a("https://graph.qq.com/face/appconf", "application/json", localJSONObject.toString(), new bcco(paramBusinessObserver));
      return;
    }
    catch (JSONException paramString1)
    {
  ...
  private static void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, bccq parambccq)
  {
    ThreadManager.getNetExcutor().execute(new LoginVerifyServlet.4(paramString1, paramInt1, paramInt2, paramString2, paramString3, parambccq));
  }
  
  private static void a(String paramString1, String paramString2, String paramString3, bccq parambccq)
  {
    a(paramString1, paramString2, paramString3, 10000, 30000, parambccq);
  }
