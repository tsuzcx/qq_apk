...
public class aquy
{
  ...
  public static Point a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      paramQQAppInterface = bhsi.a(paramQQAppInterface.getApp(), paramQQAppInterface.c());
      ...
      {
        j = bhtq.a() - bhtq.a(25.0F);
        i = bhtq.b() / 2 + bhtq.a(25.0F);
      }
  ...
  private static void a(Context paramContext, int paramInt)
  {
    ...
    if ((paramInt == 3) && (aqrl.c())) {}
    while (ColorNoteSmallScreenPermissionDialogFragment.jdField_a_of_type_Boolean) {
      return;
    }
    afez.a(paramContext, PublicTransFragmentActivity.class, ColorNoteSmallScreenPermissionDialogFragment.class);
  }
  ...
  public static void a(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, ColorNote paramColorNote)
  {
    for (;;)
    {
      try
      {
        ...
        if ((!aquk.a(paramContext)) && (paramBoolean1)) {
          a(paramContext, i);
        }
  ...
  public static void b(Context paramContext)
  {
    ...
    //   25: getstatic 77	aquy:jdField_a_of_type_Boolean	Z
    ...
    //   47: astore_1
    //   48: iconst_0
    //   49: putstatic 77	aquy:jdField_a_of_type_Boolean	Z
    //   52: aload_0
    //   53: aload_1
