...
public class aayw
{
  ...
  public aayw(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new mqq.util.WeakReference(paramQQAppInterface);
  }
  
  private static aazj a(JSONObject paramJSONObject)
  {
    if (paramJSONObject == null) {
      return null;
    }
    aazj localaazj = new aazj(null);
    localaazj.jdField_a_of_type_Int = paramJSONObject.optInt("type", -1);
    localaazj.d = paramJSONObject.optString("md5", null);
    localaazj.b = paramJSONObject.optString("url", null);
    localaazj.jdField_a_of_type_JavaLangString = paramJSONObject.optString("name", null);
    localaazj.c = paramJSONObject.optString("identifier", null);
    if (!localaazj.a())
    {
    ...
    if (paramJSONObject != null)
    {
      localaazj.e = paramJSONObject.optString("url");
      localaazj.f = paramJSONObject.optString("diff-md5");
      localaazj.g = paramJSONObject.optString("source-md5");
      if (!localaazj.b()) {
        localaazj.a();
      }
    }
  ...
  private void a(String paramString, aazj paramaazj1, aazj paramaazj2, aazl paramaazl)
  {
    boolean bool = false;
    aazj localaazj = paramaazj1;
    if (!a(paramaazj1)) {
      localaazj = null;
    }
    if (localaazj == null)
    {
      ArkAppCenter.b("ArkApp.Dict.Update", String.format("updateDict, local not exists, full update, name=%s", new Object[] { paramaazj2.jdField_a_of_type_JavaLangString }));
      ArkAppDataReport.a(paramaazj2.jdField_a_of_type_JavaLangString, 1);
      a(paramString, paramaazj2, new aaza(this, paramaazj2, paramaazl));
      return;
    }
    if (localaazj.d.equals(paramaazj2.d))
    {
      ArkAppCenter.b("ArkApp.Dict.Update", String.format("updateDict, file not change, copy from origin, name=%s", new Object[] { paramaazj2.jdField_a_of_type_JavaLangString }));
      paramaazj1 = c(localaazj.jdField_a_of_type_JavaLangString);
      paramString = String.format("%s/%s", new Object[] { paramString, paramaazj2.jdField_a_of_type_JavaLangString });
      if (FileUtils.d(paramaazj1, paramString)) {
        break label284;
      }
      ArkAppCenter.b("ArkApp.Dict.Update", String.format("updateDict, copy file fail, %s->%s", new Object[] { paramaazj1, paramString }));
    }
    for (;;)
    {
      paramaazl.a(bool);
      return;
      if ((paramaazj2.b()) && (localaazj.d.equals(paramaazj2.g)))
      {
        ArkAppCenter.b("ArkApp.Dict.Update", String.format("updateDict, incremental update, name=%s", new Object[] { paramaazj2.jdField_a_of_type_JavaLangString }));
        ArkAppDataReport.a(paramaazj2.jdField_a_of_type_JavaLangString, 3);
        b(paramString, localaazj, paramaazj2, new aazb(this, paramaazj2, paramaazl, paramString));
        return;
      }
      ArkAppCenter.b("ArkApp.Dict.Update", String.format("updateDict, full update, name=%s", new Object[] { paramaazj2.jdField_a_of_type_JavaLangString }));
      a(paramString, paramaazj2, new aazd(this, paramaazl));
      return;
      label284:
      bool = true;
    }
  ...
  private void a(String paramString, aazj paramaazj, aazl paramaazl)
  {
    a(paramaazj.jdField_a_of_type_JavaLangString, paramaazj.b, new aaze(this, paramaazj, paramString, paramaazl));
  }
  
  private void a(String paramString1, String paramString2, aazk paramaazk)
  {
    aazm localaazm = new aazm(null);
    ...
    localaazm.jdField_a_of_type_JavaLangRefWeakReference = new java.lang.ref.WeakReference(localPreDownloadController);
    paramaazk = new aazg(this, paramString2, localaazm, paramaazk);
    if (localQQAppInterface == null)
    {
      ArkAppCenter.b("ArkApp.Dict.Update", "downloadDictFile, qq app interface is null, return");
      return;
    }
    localaazm.jdField_a_of_type_Boolean = localPreDownloadController.a();
    if (localaazm.jdField_a_of_type_Boolean)
    {
      localPreDownloadController.a(10022, "prd", paramString1, 0, paramString2, "", 1, 0, false, new RunnableTask(localQQAppInterface, paramString1, paramaazk, 10000L));
      return;
    }
    paramaazk.run();
  ...
  private void a(JSONObject paramJSONObject1, JSONObject paramJSONObject2)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = new aazn(null);
      ((aazn)localObject1).jdField_a_of_type_Int = ((Map)localObject2).size();
      ((aazn)localObject1).jdField_a_of_type_Boolean = true;
      localObject2 = ((Map)localObject2).values().iterator();
      while (((Iterator)localObject2).hasNext())
      {
        aazj localaazj = (aazj)((Iterator)localObject2).next();
        a(str, (aazj)paramJSONObject1.get(localaazj.jdField_a_of_type_JavaLangString), localaazj, new aayy(this, (aazn)localObject1, localaazj, str, paramJSONObject2));
      }
    }
  }
  
  private static boolean a(aazj paramaazj)
  {
    if (paramaazj == null) {}
    while (!a(c(paramaazj.jdField_a_of_type_JavaLangString), paramaazj.d)) {
      return false;
    }
    return true;
  }
  ...
  private static boolean a(String paramString1, String paramString2)
  {
    ...
    //   80: invokestatic 409	aayw:a	([B)Ljava/lang/String;
    //   83: aload_1
  ...
  private void b(String paramString, aazj paramaazj1, aazj paramaazj2, aazl paramaazl)
  {
    a(paramaazj2.jdField_a_of_type_JavaLangString, paramaazj2.e, new aazf(this, paramaazj2, paramaazj1, paramString, paramaazl));
  }
  ...
  private void c(JSONObject paramJSONObject)
  {
    ...
    } while (a((aazj)localIterator.next()));
    for (int i = 1;; i = 0)
    {
      if (i == 0)
      {
  ...
  public void a()
  {
    ...
    ArkRecommendLogic.a().post(new aayx(this));
  }
