  ...
  extends anus
{
  ...
  public abwx(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager, abww paramabww)
  {
  ...
  private QQMessageFacade.Message a(String paramString, EntityManager paramEntityManager, int paramInt1, int paramInt2)
  {
    ...
    if ((paramString.startsWith("mr_discusssion")) || (paramString.startsWith("mr_troop")))
    {
      ...
      str = "select * from (select count() as unReadNum from %s mr where mr.isread=0),(select count() as hasReply from %s mr where mr.issend=0),%s m where m.isValid=1 and m.msgtype " + abwz.a() + " and m.longMsgId='%d' and m.issend='%d' order by %s limit 1";
      if (!bool) {
        break label177;
      }
      if (i == 0) {
    ...
    do
    {
      do
      {
        do
        {
          ...
          if (!abwz.a(paramMessageRecord1, paramMessageRecord2)) {
            break;
          }
  ...
  private List<MessageRecord> a(String paramString, int paramInt, List<MessageRecord> paramList1, List<MessageRecord> paramList2)
  {
    if (paramList1.size() > 15)
    {
      ...
      if ((!abwz.a(paramString, paramInt, paramList2)) && (!abwz.c(paramList2))) {
        break label207;
      }
      paramInt = 1;
      label60:
  ...
  private void a(String paramString, int paramInt, StatisticCollector.ReportContext paramReportContext, long paramLong)
  {
    if (TextUtils.equals(paramReportContext.OPTSCENE_TAG, "launch"))
    {
      ...
      if ((StatisticCollector.NEEDCOUNTTRANS) && (QLog.isColorLevel()) && (abwz.a(paramString, paramInt))) {
  ...
  private void a(List<MessageRecord> paramList)
  {
    ...
    if (i >= 0)
    {
      String str = abwz.a((MessageRecord)paramList.get(i));
  ...
  private int b(int paramInt)
  {
    ...
    for (;;)
    {
      if ((localObject != null) && (((List)localObject).size() == 0) && (bcsz.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) <= 0))
      {
        localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a();
        RecentUser localRecentUser = (RecentUser)((anuz)localObject).findRecentUserByUin(AppConstants.TROOP_NOTIFICATION_UIN, 9000);
  ...
  private void b(String paramString, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    abwz.a((List)localObject, paramMessageRecord, true);
    if ((localObject != null) && (((List)localObject).size() > 40) && (!abwz.a(paramString))) {
  ...
  private MessageRecord c(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (Object localObject2 = localObject1;; localObject2 = null)
    {
      ...
      if (localObject2 == null)
      {
        ...
        anll.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, paramInt1);
  ...
  private void c(String paramString, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        if ((!localMessageRecord.isread) && (a(paramInt, paramLong, localMessageRecord)) && ((!abwz.b(paramInt)) || (!abwz.n(localMessageRecord.msgtype)))) {
          localMessageRecord.isread = true;
        }
      }
      ...
      if ((paramString != null) && (!paramString.isEmpty()))
      {
        ...
        {
          localObject = (MessageRecord)paramString.next();
          if ((!((MessageRecord)localObject).isread) && (a(paramInt, paramLong, (MessageRecord)localObject)) && ((!abwz.b(paramInt)) || (!abwz.n(((MessageRecord)localObject).msgtype)))) {
            ((MessageRecord)localObject).isread = true;
          }
        }
      }
  ...
  private void c(String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    if (localList != null)
    {
      abwz.a(localList, paramMessageRecord, true);
  ...
  private List<MessageRecord> d(String paramString, int paramInt, StatisticCollector.ReportContext paramReportContext)
  {
    ...
    do
    {
      ...
      {
        localObject1 = abwz.a(paramReportContext, localList).iterator();
        while (((Iterator)localObject1).hasNext()) {
          abwz.a(paramReportContext, (MessageRecord)((Iterator)localObject1).next(), true);
        }
      }
  ...
  private List<MessageRecord> g(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      localObject1 = abwz.a(paramString, (List)localObject1).iterator();
      while (((Iterator)localObject1).hasNext()) {
        abwz.a(paramString, (MessageRecord)((Iterator)localObject1).next(), true);
      }
      label348:
  ...
  private void g()
  {
    ajul localajul = (ajul)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(125);
    localajul.e = null;
    localajul.f = null;
  }
  ...
  public int a(String paramString, int paramInt, long paramLong, MessageRecord paramMessageRecord)
  {
    ...
    if (abwz.d(paramInt))
    {
      paramString = "( msgtype " + abwz.b() + " and isValid=1 ) and ( (time >= ? and time < ?) or (time = ? and longMsgIndex <= ? and _id <= ?))";
  ...
  public int a(String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    if (abwz.d(paramInt))
    {
      paramString = "( msgtype " + abwz.b() + " and isValid=1 ) and ( time < ? or (time = ? and longMsgIndex <= ? and _id <= ?))";
      long l1 = paramMessageRecord.time;
      long l2 = paramMessageRecord.time;
      paramInt = paramMessageRecord.longMsgIndex;
      long l3 = paramMessageRecord.getId();
  ...
  public int a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      localaybz = (aybz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(201);
      Looper localLooper = Looper.getMainLooper();
      if (Thread.currentThread() != localLooper.getThread()) {
        break label95;
      }
      ThreadManager.post(new MsgProxy.1(this, localaybz, paramString, paramInt), 10, null, false);
    }
    label95:
    while (localaybz == null) {
      return i;
    }
    localaybz.a(c(paramString, paramInt), null, null);
    return i;
  }
  ...
  public abww a()
  {
    return this.jdField_a_of_type_Abww;
  }
  ...
  public Cursor a(String paramString, int paramInt)
  {
    ...
    if (paramString.equals(String.valueOf(AppConstants.SYSTEM_MSG_UIN)))
    {
      ...
      return new abwu(this, localArrayList);
    }
    return new abwu(this, (List)((ArrayList)localList).clone());
  }
  ...
  public QQMessageFacade.Message a(String paramString, EntityManager paramEntityManager, int paramInt)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().transSaveLock)
      {
        ...
        ((StringBuilder)localObject1).append(abwz.a());
  ...
  public FullMessageSearchResult.SearchResultItem a(String paramString1, int paramInt1, String paramString2, int paramInt2, anic paramanic)
  {
    ...
    for (;;)
    {
      ...
      long l2 = anih.jdField_a_of_type_Long;
      ...
      try
      {
        paramString2 = a(paramString1, paramInt1, paramString2, paramanic, (Cursor)localObject);
  ...
  protected FullMessageSearchResult.SearchResultItem a(String paramString1, int paramInt, String paramString2, anic paramanic, Cursor paramCursor)
  {
    return anie.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Aybg, paramCursor, paramString1, paramInt, paramString2, paramanic);
  }
  ...
  public ChatHistorySearchData a(SessionInfo paramSessionInfo, String paramString)
  {
    ...
    //   12: astore_3
    //   13: aload_1
    //   14: getfield 1075	com/tencent/mobileqq/activity/aio/SessionInfo:curFriendUin	Ljava/lang/String;
    //   17: invokestatic 1045	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   20: ifne +13 -> 33
    //   23: aload_2
    //   24: invokestatic 1045	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   27: ifeq +8 -> 35
    //   30: aload 4
    //   32: astore_3
    //   33: aload_3
    ...
    //   35: aload_0
    //   36: aload_1
    //   37: getfield 1075	com/tencent/mobileqq/activity/aio/SessionInfo:curFriendUin	Ljava/lang/String;
    //   40: aload_1
    //   41: getfield 1078	com/tencent/mobileqq/activity/aio/SessionInfo:curType	I
    //   44: invokevirtual 548	abwx:c	(Ljava/lang/String;I)Ljava/lang/String;
    //   47: astore_3
    //   48: aload_0
    //   49: invokevirtual 197	abwx:a	()Laybg;
    //   52: iconst_0
    //   53: aload_3
    //   54: aconst_null
    //   55: ldc_w 1170
    ...
    //   73: ldc_w 1058
    //   76: aconst_null
    //   77: invokevirtual 909	aybg:query	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   80: astore 5
    //   82: aload_0
    //   83: aload 5
    //   85: aload_1
    //   86: aload_2
    //   87: invokevirtual 1172	abwx:a	(Landroid/database/Cursor;Lcom/tencent/mobileqq/activity/aio/SessionInfo;Ljava/lang/String;)Lcom/tencent/mobileqq/data/ChatHistorySearchData;
    //   90: astore_1
    //   91: aload_1
    //   92: astore_3
    //   93: aload 5
  ...
  protected String a(Cursor paramCursor, SessionInfo paramSessionInfo, int paramInt)
  {
    ...
    if (bfwr.a(paramCursor.getInt(paramCursor.getColumnIndex("issend")))) {
    ...
    if (localObject1 != null)
    {
      ...
      if (!((List)localObject1).isEmpty())
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if ((!abwz.a(paramInt1)) || (localMessageRecord.versionCode != 3) || (localMessageRecord.shmsgseq != l5) || (l5 == 0L)) {
            for (;;)
            {
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByMsgUniseqFromDB, peerUin[" + aszt.e(paramString) + "] type[" + paramInt + "] uniseq[" + paramLong + "]");
    }
    if (paramLong == 0L)
    {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      localObject = ((aybg)localObject).a(paramString, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
  ...
  protected List<MessageRecord> a(String paramString1, int paramInt1, long paramLong1, int paramInt2, long paramLong2, int paramInt3, String paramString2)
  {
    ...
    paramString2 = bfwn.a(d(paramString1, paramInt1), c(paramString1, paramInt1), paramLong1, paramInt2, paramLong2, paramInt3, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getReadableDatabase(), paramString2);
    if (paramString2 != null)
    {
      if (a(paramString1, paramInt1, true)) {
        this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.transSaveToDatabase(a());
  ...
  public List<MessageRecord> a(String paramString, int paramInt1, long paramLong1, long paramLong2, int paramInt2)
  {
    ...
    for (int i = apse.a(paramInt1, paramInt2) << 3;; i = 0)
    {
      ...
      if (i == 0)
      {
        ...
        localObject1 = ((aybg)localObject1).a((String)localObject2, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, localQQAppInterface);
        if (QLog.isColorLevel())
        {
      ...
      for (paramInt1 = 0;; paramInt1 = ((List)localObject1).size())
      {
        ...
        localObject2 = ((StringBuilder)localObject2).toString();
        localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
        localObject1 = ((aybg)localObject1).a((String)localObject2, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2), String.valueOf(i) }, localQQAppInterface);
        break;
      }
    }
  }
  ...
  public List<MessageRecord> a(String paramString, int paramInt, int[] paramArrayOfInt)
  {
    ...
    for (;;)
    {
      ...
      while (paramArrayOfInt.hasNext())
      {
        ...
        if (((!abwz.a(paramInt)) || (((MessageRecord)localObject).versionCode != 3) || (((MessageRecord)localObject).shmsgseq != l) || (l == 0L)) && ((paramString.contains(Integer.valueOf(((MessageRecord)localObject).msgtype))) || (paramString.isEmpty()))) {
  ...
  {
    return this.jdField_a_of_type_Abww.b();
  }
  
  protected Lock a(String paramString, int paramInt)
  {
    return this.jdField_a_of_type_Abww.a(paramString, paramInt);
  }
  ...
  protected void a(String paramString, int paramInt, long paramLong)
  {
    ...
    for (String str1 = "shmsgseq";; str1 = "time")
    {
      ...
      if ((!abwz.b(paramInt)) || (abwz.d() == null)) {
        break;
      }
      a(paramString, paramInt, str3, localContentValues, String.format("isread=? and %s<=? and " + abwz.d(), new Object[] { str1 }), new String[] { "0", str2 }, null);
      return;
    }
  ...
  protected void a(String paramString, int paramInt1, MessageRecord paramMessageRecord, int paramInt2)
  {
    ...
    paramInt2 = apse.a(paramInt1, paramInt2) << 3;
  ...
  {
    if ((abwz.o(paramMessageRecord.msgtype)) && (!abwz.b(paramMessageRecord.frienduin, paramMessageRecord.istroop))) {}
    while (!paramBoolean2) {
      return;
    }
    if (paramBoolean1)
  ...
  protected void a(String paramString1, String paramString2, List<MessageRecord> paramList, long paramLong)
  {
    ...
    if (bfzg.a())
    {
      bbkq localbbkq2 = (bbkq)bbko.b.get(paramString2);
      bbkq localbbkq1 = localbbkq2;
      if (localbbkq2 == null) {
        localbbkq1 = new bbkq();
      }
      localbbkq1.jdField_a_of_type_JavaLangString = paramString1;
      localbbkq1.jdField_a_of_type_Boolean = false;
      if (!paramList.isEmpty()) {
        bool = true;
      }
      localbbkq1.b = bool;
      localbbkq1.jdField_a_of_type_Long = ((System.nanoTime() - paramLong) / 1000000L);
      bbko.b.put(paramString2, localbbkq1);
    }
  }
  
  public void a(List<MessageRecord> paramList, ProxyListener paramProxyListener)
  {
    b(abwz.a(paramList), paramProxyListener);
  }
  ...
  {
    return bfwn.a(c(paramString, paramInt), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getReadableDatabase());
  }
  ...
  protected boolean a(String paramString1, int paramInt, String paramString2, List<MessageRecord> paramList)
  {
    ...
    if ((!a().containsKey(paramString2)) && (localbahm.a(paramString1)))
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.getMsgQueueLock())
      {
        ...
        if (i < localVector.size())
        {
          ...
          if ((abwz.a(localMsgQueueItem.frindUin, paramString, localMsgQueueItem.type, paramInt)) && ((localMsgQueueItem.action == 1) || (localMsgQueueItem.action == 2) || ((paramBoolean) && (localMsgQueueItem.action == 0))))
          {
            if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.getMsgQueueLock())
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          {
            MessageRecord localMessageRecord = (MessageRecord)localMsgQueueItem.item;
            if ((abwz.a(localMessageRecord.frienduin, paramString, localMessageRecord.istroop, paramInt)) && (localMsgQueueItem.action == 0) && (localMessageRecord.time > paramLong) && (!localMessageRecord.isread) && (!localMessageRecord.isSend())) {
              i += 1;
            }
          }
        }
  ...
  public MessageRecord b(String paramString, int paramInt)
  {
    ...
    if (a(str1, false)) {
      this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.transSaveToDatabase(this.jdField_a_of_type_Aybg);
    }
    String str2 = abwz.b();
    if (abwz.a(paramInt)) {}
  ...
  public MessageRecord b(String paramString1, int paramInt, String paramString2)
  {
    ...
    if (abwz.a(paramInt))
    {
      localStringBuilder = new StringBuilder().append("select * from ").append(c(paramString1, paramInt)).append(" where isValid=1 and msgtype ").append(abwz.a()).append(" ");
      if (paramString2 != null) {}
    ...
    StringBuilder localStringBuilder = new StringBuilder().append("select * from ").append(c(paramString1, paramInt)).append(" where isValid=1 and msgtype ").append(abwz.a()).append(" ");
    if (paramString2 != null) {}
    for (paramString1 = "and " + paramString2;; paramString1 = "")
    {
  ...
  protected List<MessageRecord> b(String paramString, int paramInt, List<Long> paramList)
  {
    ...
    if (QLog.isColorLevel())
    {
      localObject = new StringBuilder().append("queryMessagesByMsgUniseqFromDB, peerUin[").append(aszt.e(paramString)).append("] type[").append(paramInt).append("] uniseqList[");
      if (paramList == null)
      {
        i = 0;
  ...
  protected List<MessageRecord> b(List<MessageRecord> paramList)
  {
    ...
    if (i >= 0)
    {
      if (localHashSet.contains(abwz.a((MessageRecord)paramList.get(i)))) {
      ...
      for (;;)
      {
        i -= 1;
        break;
        localHashSet.add(abwz.a((MessageRecord)paramList.get(i)));
      }
    }
  ...
  protected List<MessageRecord> c(String paramString, int paramInt1, int paramInt2)
  {
    ...
    synchronized (this.jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager.getMsgQueueLock())
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        {
          MessageRecord localMessageRecord = (MessageRecord)localMsgQueueItem.item;
          if ((abwz.a(localMessageRecord.frienduin, paramString, localMessageRecord.istroop, paramInt1)) && (localMsgQueueItem.action == 0) && ((paramInt2 <= 0) || (localMessageRecord.getConfessTopicId() == paramInt2))) {
            localArrayList.add(localMessageRecord);
          }
        }
      }
  ...
  protected List<MessageRecord> c(String paramString1, int paramInt1, long paramLong, int paramInt2, String paramString2)
  {
    ...
    for (;;)
    {
      localObject = a();
      QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
      paramString2 = ((aybg)localObject).a(paramString2, new String[] { String.valueOf(paramLong), String.valueOf(l) }, localQQAppInterface);
      if (paramString2 == null) {
        break label299;
      }
      if (QLog.isColorLevel()) {
  ...
  public List<MessageRecord> c(String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    ...
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = ((aybg)localObject).a(paramString, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, localQQAppInterface);
    paramString = (String)localObject;
    if (localObject == null) {
      paramString = new ArrayList();
    }
  ...
  protected void c(String paramString, int paramInt, List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      List localList = abwz.a((List)localObject1, paramList);
      Iterator localIterator = localList.iterator();
      while (localIterator.hasNext())
      {
      ...
      if (ajul.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt, paramString)) {
      ...
      if ((paramInt == 0) && (((List)localObject1).size() > 0) && (aucg.a((MessageRecord)((List)localObject1).get(0)))) {
        paramInt = localList.size() - 1;
      }
      while (paramInt >= 0)
      {
        abwz.a((List)localObject1, (MessageRecord)localList.get(paramInt), true);
        paramInt -= 1;
        continue;
  ...
  public MessageRecord d(String paramString, int paramInt, long paramLong)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        MessageRecord localMessageRecord = (MessageRecord)((Iterator)localObject).next();
        if ((localMessageRecord.shmsgseq == paramLong) && (!abwz.a(localMessageRecord))) {
          return localMessageRecord;
        }
      }
    }
  ...
  public List<MessageRecord> d(String paramString, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    Object localObject1 = "select * from " + paramString + " where (shmsgseq < ? and msgtype " + abwz.b() + " and isValid=1) order by shmsgseq desc limit ";
    ...
    for (;;)
    {
      ...
      {
        aybz localaybz = (aybz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(201);
        if (localaybz != null)
        {
          localObject1 = localaybz.a().a((String)localObject1 + (paramInt2 - paramString.size()), (String[])localObject2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          if (QLog.isColorLevel())
          {
  ...
  public List<MessageRecord> d(String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    ...
    localObject1 = ((aybg)localObject2).a((String)localObject1, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, (QQAppInterface)localObject3);
    if (QLog.isColorLevel())
    {
  ...
  protected List<MessageRecord> e(String paramString, int paramInt1, int paramInt2)
  {
    ...
    aybg localaybg = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = localaybg.a((String)localObject, new String[] { String.valueOf(-2006), String.valueOf(paramInt2) }, localQQAppInterface);
    if (localObject != null)
    {
      if (QLog.isColorLevel()) {
  ...
  public List<MessageRecord> e(String paramString, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    paramString = "select * from " + (String)localObject2 + " where (shmsgseq >= ? and msgtype " + abwz.b() + " and isValid=1) order by shmsgseq asc limit " + (paramInt2 + 1);
    ...
    for (;;)
    {
      ...
      if (localaybz != null)
      {
        localObject2 = "select * from " + (String)localObject2 + " where (shmsgseq > ? and msgtype " + abwz.b() + " and isValid=1) order by shmsgseq asc limit " + paramInt2;
        localObject1 = localaybz.a().a((String)localObject2, (String[])localObject1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (QLog.isColorLevel())
        {
  ...
  protected List<MessageRecord> e(String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    int i = 0;
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByTimeFromDB, peerUin[" + aszt.e(paramString) + "] type[" + paramInt + "] time[" + paramLong1 + "] uid[" + paramLong2 + "]");
    }
    ...
    aybg localaybg = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = localaybg.a((String)localObject, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, localQQAppInterface);
    if (QLog.isColorLevel())
    {
      paramString = new StringBuilder().append("queryMessagesByTimeFromDB, peerUin[").append(aszt.e(paramString)).append("] type[").append(paramInt).append("] time[").append(paramLong1).append("] uid[").append(paramLong2).append("], list.size():");
      if (localObject != null) {
        break label287;
      }
    }
  ...
  public void e()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 158	abwx:jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager	Lcom/tencent/mobileqq/app/proxy/ProxyManager;
    //   4: invokevirtual 691	com/tencent/mobileqq/app/proxy/ProxyManager:transSaveToDatabase	()V
    //   7: aload_0
    //   8: getfield 158	abwx:jdField_a_of_type_ComTencentMobileqqAppProxyProxyManager	Lcom/tencent/mobileqq/app/proxy/ProxyManager;
    //   11: invokevirtual 2049	com/tencent/mobileqq/app/proxy/ProxyManager:clearMsgQueue	()V
    //   14: aload_0
    //   15: invokevirtual 197	abwx:a	()Laybg;
    //   18: invokevirtual 2053	aybg:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   21: astore 11
    //   23: aload_0
    //   24: getfield 306	abwx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   27: invokevirtual 2056	com/tencent/mobileqq/app/QQAppInterface:getWritableDatabase	()Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   30: astore 12
    //   32: aload 12
    //   34: invokevirtual 2062	com/tencent/mobileqq/app/SQLiteDatabase:getAllTableNameFromCache	()[Ljava/lang/String;
    //   37: astore 13
    //   39: aload 13
    //   41: ifnonnull +4 -> 45
    //   44: return
    //   45: aload_0
    //   46: getfield 306	abwx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   49: sipush 201
    //   52: invokevirtual 823	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   55: checkcast 927	aybz
    //   58: astore 14
    //   60: iconst_0
    //   61: istore_1
    //   62: iload_1
    ...
    //   167: aload 8
    //   169: aconst_null
    //   170: invokevirtual 2073	com/tencent/mobileqq/app/SQLiteDatabase:rawQuery	(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    //   173: astore 9
    //   175: aload 9
    //   177: ifnull +170 -> 347
    //   180: aload 9
    //   182: astore 8
    //   184: aload 9
    //   186: invokeinterface 914 1 0
    //   191: ifle +156 -> 347
    //   194: aload 9
    //   196: astore 8
    //   198: aload 9
    //   200: invokeinterface 1117 1 0
    //   205: pop
    //   206: aload 9
    //   208: astore 8
    //   210: aload 9
    //   212: aload 9
    //   214: ldc_w 2075
    //   217: invokeinterface 2078 2 0
    //   222: invokeinterface 2082 2 0
    //   227: lstore 6
    //   229: aload 9
    //   231: astore 8
    //   233: aload 9
    //   235: aload 9
    //   237: ldc_w 2083
    //   240: invokeinterface 2078 2 0
    //   245: invokeinterface 1373 2 0
    //   250: astore 10
    //   252: aload 9
    //   254: astore 8
    //   256: aload 9
    //   258: aload 9
    //   260: ldc_w 2084
    //   263: invokeinterface 2078 2 0
    //   268: invokeinterface 1157 2 0
    //   273: istore_2
    //   274: aload 9
    //   276: astore 8
    //   278: aload 9
    //   280: aload 9
    //   282: ldc_w 1374
    //   285: invokeinterface 2078 2 0
    //   290: invokeinterface 1157 2 0
    //   295: istore_3
    //   296: lload 6
    //   298: lstore 4
    //   300: aload 9
    //   302: astore 8
    //   304: iload_2
    //   305: invokestatic 142	abwz:a	(I)Z
    //   308: ifne +20 -> 328
    //   311: lload 6
    //   313: lstore 4
    //   315: iload_3
    ...
    //   330: astore 8
    //   332: aload_0
    //   333: getfield 306	abwx:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   336: invokevirtual 312	com/tencent/mobileqq/app/QQAppInterface:getMsgCache	()Lbbko;
    //   339: aload 10
    //   341: iload_2
    //   342: lload 4
    //   344: invokevirtual 2088	bbko:a	(Ljava/lang/String;IJ)V
    //   347: aload 9
    //   349: ifnull +10 -> 359
    //   352: aload 9
    //   354: invokeinterface 917 1 0
    //   359: aload 11
    //   361: ifnull +8 -> 369
    //   364: aload 11
    //   366: invokevirtual 2093	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   369: aload 12
    //   371: aload 15
    //   373: aconst_null
    //   374: aconst_null
    //   375: invokevirtual 2096	com/tencent/mobileqq/app/SQLiteDatabase:delete	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   378: pop
    //   379: aload 11
    //   381: ifnull +8 -> 389
    //   384: aload 11
    //   386: invokevirtual 2099	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   389: aload 11
    //   391: ifnull +8 -> 399
    //   394: aload 11
    //   396: invokevirtual 2102	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   399: aload 14
    //   401: ifnull +13 -> 414
    //   404: aload 14
    //   406: aload 15
    //   408: aconst_null
    //   409: aconst_null
    //   410: invokevirtual 950	aybz:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   413: pop
    //   414: iload_1
    //   415: iconst_1
    //   416: iadd
    ...
    //   428: astore 8
    //   430: aload 10
    //   432: invokevirtual 1154	java/lang/Exception:printStackTrace	()V
    //   435: aload 9
    //   437: ifnull -78 -> 359
    //   440: aload 9
    //   442: invokeinterface 917 1 0
    //   447: goto -88 -> 359
    //   450: astore 9
    //   452: aconst_null
    //   453: astore 8
    ...
    //   457: ifnull +10 -> 467
    //   460: aload 8
    //   462: invokeinterface 917 1 0
    //   467: aload 9
    //   469: athrow
    //   470: astore 8
    //   472: aload 8
    //   474: invokevirtual 1154	java/lang/Exception:printStackTrace	()V
    ...
    //   496: ifnull -97 -> 399
    //   499: aload 11
    //   501: invokevirtual 2102	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   504: goto -105 -> 399
    //   507: astore 8
    //   509: aload 11
    //   511: ifnull +8 -> 519
    //   514: aload 11
    //   516: invokevirtual 2102	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   519: aload 8
    //   521: athrow
    //   522: astore 9
    //   524: goto -69 -> 455
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByShmsgseqFromDB, peerUin[" + aszt.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong1 + "] msgUid[" + paramLong2 + "]");
    }
    ...
    aybg localaybg = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    paramString = localaybg.a(paramString, new String[] { String.valueOf(paramLong1), String.valueOf(paramLong2) }, localQQAppInterface);
    if (paramString != null) {
      return paramString;
    }
    return new ArrayList();
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByShmsgseqFromDB, peerUin[" + aszt.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong + "]");
    }
    ...
    aybg localaybg = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    localObject = localaybg.a((String)localObject, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
    if (QLog.isColorLevel())
    {
      paramString = new StringBuilder().append("queryMessagesByShmsgseqFromDB, peerUin[").append(aszt.e(paramString)).append("] type[").append(paramInt).append("] shmsgseq[").append(paramLong).append("], list.size():");
      if (localObject != null) {
        break label261;
      }
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.MsgProxy", 2, "queryMessagesByShmsgseqFromDB4Troop, peerUin[" + aszt.e(paramString) + "] type[" + paramInt + "] shmsgseq[" + paramLong + "]");
    }
    if ((paramLong == 0L) && (QLog.isColorLevel())) {
    ...
    paramString = "select * from " + c(paramString, paramInt) + " where shmsgseq=? and msgtype " + abwz.c();
    aybg localaybg = a();
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    paramString = localaybg.a(paramString, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
    if ((paramString != null) && (paramString.size() > 0)) {
      return (MessageRecord)paramString.get(0);
    }
    return null;
  ...
  public MessageRecord j(String paramString, int paramInt, long paramLong)
  {
    ...
    Object localObject2 = (aybz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(201);
    if (localObject2 != null)
    {
      if (QLog.isColorLevel()) {
      ...
      localObject2 = ((aybz)localObject2).a();
      QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
      localObject1 = ((aybg)localObject2).a((String)localObject1, new String[] { String.valueOf(paramLong) }, localQQAppInterface);
      if (QLog.isColorLevel())
      {
        paramString = new StringBuilder().append("queryMsgItemHistoryByShmsgseq, slow db return peerUin[").append(aszt.e(paramString)).append("] type[").append(paramInt).append("] shmsgseq[").append(paramLong).append("], list.size():");
        if (localObject1 != null) {
          break label211;
        }
      }
