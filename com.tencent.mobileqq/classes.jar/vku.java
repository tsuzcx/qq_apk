...
public final class vku
  extends AsyncTask
{
  public vku(Context paramContext, int paramInt, URLDrawable paramURLDrawable, QQAppInterface paramQQAppInterface, StructMsgForImageShare paramStructMsgForImageShare, PicMessageExtraData paramPicMessageExtraData) {}
  ...
  protected void a(Integer paramInteger)
  {
    ...
    do
    {
      ...
      {
        QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 2131434567, 0).b(this.jdField_a_of_type_Int);
        return;
      }
      if (paramInteger.intValue() == 2)
      {
        QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, 2131434484, 0).b(this.jdField_a_of_type_Int);
        return;
      }
