...
public class aoee
{
  private static aoee jdField_a_of_type_Aoee;
  ...
  private aoed jdField_a_of_type_Aoed = new aoed();
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  protected Runnable a;
  private ArrayList<aoeg> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private double jdField_b_of_type_Double;
  private long jdField_b_of_type_Long = 1800000L;
  
  private aoee(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRunnable = new EnterpriseQQManager.1(this);
    this.jdField_a_of_type_Akup = new aoef(this, 4, true, true, 0L, false, false, "EnterpriseQQManager");
    if (paramQQAppInterface != null) {
      a(paramQQAppInterface);
    }
  }
  
  public static aoee a(QQAppInterface paramQQAppInterface)
  {
    if (jdField_a_of_type_Aoee == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Aoee == null) {
        jdField_a_of_type_Aoee = new aoee(paramQQAppInterface);
      }
      return jdField_a_of_type_Aoee;
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Aoed != null) {
      return this.jdField_a_of_type_Aoed.a(paramString);
    }
    return null;
  }
  ...
  public void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean, double paramDouble1, double paramDouble2)
  {
    ...
    {
      paramContext = (ajvr)paramQQAppInterface.a(21);
  ...
  {
    if (this.jdField_a_of_type_Aoed == null) {
      this.jdField_a_of_type_Aoed = new aoed();
    }
    if (paramQQAppInterface != null)
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Aoed.a(localEnterpriseQQMenuEntity.uin, localGetCRMMenuResponse.button_info.get(), localEnterpriseQQMenuEntity.seqno, localEnterpriseQQMenuEntity.savedDateTime);
        continue;
        return;
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, StructMsg.GetCRMMenuResponse paramGetCRMMenuResponse)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Aoed.a(paramString) != paramInt) && (paramGetCRMMenuResponse != null))
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Aoed.a(paramString, localList, paramInt, l);
          return;
    ...
    this.jdField_a_of_type_Aoed.a(paramString, l);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    if ((paramQQAppInterface != null) && (!TextUtils.isEmpty(paramString)))
    {
      long l = 0L;
      if (this.jdField_a_of_type_Aoed != null) {
        l = this.jdField_a_of_type_Aoed.a(paramString);
      }
      if ((paramBoolean) || ((!paramBoolean) && (System.currentTimeMillis() - l > 43200000L)))
      {
        paramQQAppInterface = (ajvr)paramQQAppInterface.a(21);
        if (paramQQAppInterface != null) {
