...
public class rqx
{
  ...
  public static rqx a(articlesummary.BuluoInfo paramBuluoInfo)
  {
    rqx localrqx = new rqx();
    String str;
    if (paramBuluoInfo.bytes_wording.has())
    {
      str = paramBuluoInfo.bytes_wording.get().toStringUtf8();
      localrqx.jdField_a_of_type_JavaLangString = str;
      ...
      label55:
      localrqx.d = str;
      localrqx.jdField_a_of_type_Long = paramBuluoInfo.uint64_buluo_id.get();
