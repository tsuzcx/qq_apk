...
public class sqy
  implements spr
{
  private static final String jdField_a_of_type_JavaLangString = sqy.class.getSimpleName();
  ...
  private srb jdField_a_of_type_Srb;
  ...
  {
    if (paramInt1 == 2) {
      swx.a().a(paramString1, new sqz(this, paramString1, paramInt2, paramLong));
    }
    do
    {
      do
      ...
      } while (this.jdField_a_of_type_Srb == null);
      paramString2 = (String)this.jdField_a_of_type_JavaUtilHashMap.get(paramString1);
    } while (TextUtils.isEmpty(paramString2));
    this.jdField_a_of_type_Srb.a(paramString1, 1, paramString2);
  }
  ...
  private void a(String paramString1, String paramString2, long paramLong, int paramInt)
  {
    ...
    if (paramString1 != null) {
      ...
      {
        localObject = ois.a(paramString1);
      }
    }
    ...
    ((TVK_PlayerVideoInfo)localObject).setConfigMap("cache_servers_type", spm.jdField_a_of_type_JavaLangString);
    if (paramLong > 0L) {
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setPreloadCallback(new sra(this));
  }
  ...
  public void a(srb paramsrb)
  {
    this.jdField_a_of_type_Srb = paramsrb;
  }
  ...
  public void b()
  {
    this.jdField_a_of_type_Srb = null;
