  ...
  extends aofy<aokc>
{
  ...
  @NonNull
  public aokc a(int paramInt)
  {
    return new aokc();
  }
  
  @Nullable
  public aokc a(aogf[] paramArrayOfaogf)
  {
    if ((paramArrayOfaogf != null) && (paramArrayOfaogf.length > 0))
    {
      new aokc();
      return aokc.a(paramArrayOfaogf);
    }
    return null;
  }
  ...
  public void a(aokc paramaokc)
  {
    if (QLog.isColorLevel()) {
      QLog.d("MiniAppConfProcessor", 2, "onUpdate " + paramaokc.toString());
    }
    paramaokc = BaseApplicationImpl.getApplication().getRuntime();
    if ((paramaokc instanceof QQAppInterface))
    {
      paramaokc = (MiniAppEntryHandler)((QQAppInterface)paramaokc).a(149);
      if (paramaokc != null) {
        paramaokc.notifyUI(0, true, null);
      }
    }
  }
