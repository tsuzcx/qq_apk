...
public class jwn
  extends BaseAdapter
{
  public jwn(MultiMembersVideoUI paramMultiMembersVideoUI) {}
  
  MultiMembersUI.Holder a(View paramView)
  {
    MultiMembersUI.Holder localHolder = new MultiMembersUI.Holder();
    localHolder.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)paramView.findViewById(2131365943));
    localHolder.c = ((ImageView)paramView.findViewById(2131365944));
    ...
    else if (localHolder.jdField_a_of_type_AndroidViewViewGroup != null)
    {
      ...
      paramView.width = this.a.getResources().getDimensionPixelSize(2131559974);
    }
    for (paramView.height = this.a.getResources().getDimensionPixelSize(2131559975);; paramView.height = this.a.getResources().getDimensionPixelSize(2131559977))
    {
      localHolder.jdField_a_of_type_AndroidViewViewGroup.setLayoutParams(paramView);
      return localHolder;
      localHolder.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.a.getResources().getColor(2131493505));
      break;
      label291:
      paramView.width = this.a.getResources().getDimensionPixelSize(2131559976);
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.a.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130969326, null);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        paramViewGroup.c.setImageResource(2130840266);
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText("更多成员");
        paramView.setContentDescription(MultiMembersVideoUI.d(this.a).getString(2131428927));
        return paramView;
      ...
      for (;;)
      {
        localMVMembersInfo.jdField_a_of_type_AndroidGraphicsBitmap = ((BitmapDrawable)MultiMembersVideoUI.c(this.a).getDrawable(2130840217)).getBitmap();
        localMVMembersInfo.d = true;
        break;
        ...
        localMVMembersInfo.jdField_b_of_type_JavaLangString = null;
        localMVMembersInfo.jdField_a_of_type_JavaLangString = MultiMembersVideoUI.b(this.a).getString(2131428928);
      }
      ...
      if (localMVMembersInfo.jdField_a_of_type_JavaLangString != null)
      {
        ...
        localObject = ((BitmapDrawable)MultiMembersVideoUI.e(this.a).getDrawable(2130840183)).getBitmap();
      ...
      for (;;)
      {
        ...
        label876:
        paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
        paramViewGroup.c.setImageResource(2130839128);
        break label691;
        if (paramViewGroup.d.getVisibility() != 0) {
          break label794;
        }
