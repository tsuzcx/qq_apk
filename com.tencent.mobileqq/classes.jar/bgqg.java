...
public abstract class bgqg
  extends bhhq
  implements Handler.Callback, bghm
{
  public static final String TAG = "BaseRuntimeLoader";
  private boolean hasTaskFailed;
  private boolean isSucceed;
  private Map<String, bhhn> mActivatedTasks;
  private final bgqc mAppStateManager;
  protected Context mContext;
  private final bgpx mEventCenter;
  ...
  /* Error */
  public bgqg(Context paramContext)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 41	bhhq:<init>	()V
    //   4: aload_0
    //   5: new 43	bgpx
    //   8: dup
    //   9: invokespecial 44	bgpx:<init>	()V
    //   12: putfield 46	bgqg:mEventCenter	Lbgpx;
    //   15: aload_0
    //   16: new 48	bgqc
    //   19: dup
    //   20: aload_0
    //   21: invokespecial 51	bgqc:<init>	(Lbgqg;)V
    //   24: putfield 53	bgqg:mAppStateManager	Lbgqc;
    //   27: aload_0
    //   28: aload_1
    //   29: putfield 55	bgqg:mContext	Landroid/content/Context;
    //   32: aload_0
    //   33: new 57	java/util/HashMap
    //   36: dup
    //   37: invokespecial 58	java/util/HashMap:<init>	()V
    //   40: putfield 60	bgqg:mActivatedTasks	Ljava/util/Map;
    //   43: aload_0
    //   44: getfield 46	bgqg:mEventCenter	Lbgpx;
    //   47: aload_0
    //   48: getfield 53	bgqg:mAppStateManager	Lbgqc;
    //   51: invokevirtual 64	bgpx:addObserver	(Ljava/util/Observer;)V
    ...
    //   95: putfield 89	bgqg:mHandler	Landroid/os/Handler;
    //   98: aload_0
    //   99: invokespecial 92	bgqg:initTask	()V
    //   102: return
    //   103: aload_0
    ...
    //   115: putfield 89	bgqg:mHandler	Landroid/os/Handler;
    //   118: goto -20 -> 98
    //   121: astore_3
    //   122: aconst_null
    //   123: astore_2
    ...
    //   158: putfield 89	bgqg:mHandler	Landroid/os/Handler;
    //   161: goto -63 -> 98
    //   164: aload_0
    ...
    //   176: putfield 89	bgqg:mHandler	Landroid/os/Handler;
    //   179: goto -81 -> 98
    //   182: astore_2
    //   183: aconst_null
    //   184: astore_1
    ...
    //   209: putfield 89	bgqg:mHandler	Landroid/os/Handler;
    //   212: aload_2
    //   213: athrow
    //   214: aload_0
    ...
    //   226: putfield 89	bgqg:mHandler	Landroid/os/Handler;
    //   229: goto -17 -> 212
    //   232: astore_2
    //   233: goto -48 -> 185
    //   236: astore_3
  ...
  {
    bhhn[] arrayOfbhhn = createTasks();
    initTasks(arrayOfbhhn);
    if (arrayOfbhhn != null)
    {
      ...
      while (i < j)
      {
        registTaskName(arrayOfbhhn[i]);
        i += 1;
      }
    }
  }
  
  private void registTaskName(bhhn parambhhn)
  {
    if (parambhhn == null) {}
    for (;;)
    {
      ...
      if ((parambhhn != null) && (parambhhn.size() > 0))
      {
        ...
        while (parambhhn.hasNext()) {
          registTaskName((bhhn)parambhhn.next());
        }
      }
    }
  }
  ...
  private void restartFailTaskIfNeed()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 149	bgqg:hasTaskFailed	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifne +6 -> 14
    //   11: aload_0
    ...
    //   14: aload_0
    //   15: iconst_0
    //   16: putfield 149	bgqg:hasTaskFailed	Z
    //   19: aload_0
    //   20: getfield 153	bgqg:mAllTasks	Ljava/util/List;
    ...
    //   44: checkcast 123	bhhn
    //   47: astore_3
    //   48: aload_3
    //   49: invokevirtual 156	bhhn:d	()Z
    //   52: ifne -23 -> 29
    //   55: aload_3
    //   56: invokevirtual 159	bhhn:b	()V
    //   59: aload_0
    //   60: aload_3
    //   61: invokevirtual 162	bgqg:executeTask	(Lbhhn;)V
    //   64: goto -35 -> 29
    //   67: astore_2
    //   68: aload_0
    //   69: monitorexit
  ...
  public void addRuntimeStateObserver(bgpz parambgpz)
  {
    this.mEventCenter.addObserver(parambgpz);
  }
  
  public void addTask(bhhn parambhhn)
  {
    if (parambhhn == null) {
      return;
    }
    String str = parambhhn.getClass().getCanonicalName();
    if (this.mActivatedTasks.containsKey(str))
    {
      QMLog.w("BaseRuntimeLoader", "Failed to add task: duplicated " + str);
      return;
    }
    this.mActivatedTasks.put(str, parambhhn);
  }
  ...
  public bhhn getTask(Class paramClass)
  {
    return (bhhn)this.mActivatedTasks.get(paramClass.getCanonicalName());
  }
  ...
  {
    bgpy localbgpy = bgpy.a(paramInt, this);
    if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
      localbgpy.a = paramVarArgs[0];
    }
    this.mEventCenter.a(localbgpy);
  }
  ...
  public void onTaskDone(bhhn parambhhn)
  {
    ...
    {
      return;
      QMLog.d("BaseRuntimeLoader", "onTaskDone " + parambhhn + " isSucc=" + parambhhn.d());
    } while (parambhhn.d());
    this.hasTaskFailed = true;
  }
  
  public void removeRuntimeStateObserver(bgpz parambgpz)
  {
    this.mEventCenter.deleteObserver(parambgpz);
  }
  
  public void setRuntimeLoadListener(bgqi parambgqi)
  {
    this.mRuntimeLoadListener = parambgqi;
  }
