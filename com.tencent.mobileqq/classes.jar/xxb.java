...
public class xxb
{
  ...
  public static String a(Context paramContext, String paramString, android.graphics.Bitmap paramBitmap)
  {
    ...
    //   9: dup
    //   10: ldc_w 390
    //   13: invokestatic 395	bduw:a	(Ljava/lang/String;)Ljava/lang/String;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, int paramInt, String paramString2, String paramString3, xua paramxua)
  {
    paramString1 = xty.a(paramInt, paramString1);
    ...
    paramString2 = new xxc(paramxua);
    paramContext = new NewIntent(paramContext, xub.class);
