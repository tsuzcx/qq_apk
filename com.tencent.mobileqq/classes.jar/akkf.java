...
public class akkf
  implements Manager
{
  akjz jdField_a_of_type_Akjz = null;
  akkj jdField_a_of_type_Akkj = null;
  ...
  public akkf(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Akkj = new akkj(l);
  }
  ...
  public PromotionConfigInfo a()
  {
    ...
    {
      QLog.w(akkm.jdField_a_of_type_JavaLangString, 1, "getConfigInfo, AR配置还未初始化", new Throwable("打印调用栈"));
  ...
  {
    if (this.jdField_a_of_type_Akkj != null) {
      this.jdField_a_of_type_Akkj.a(paramakkl);
    }
  }
  ...
  public void a(AppInterface paramAppInterface, String paramString)
  {
    if (this.jdField_a_of_type_Akkj != null) {
      if (a())
      {
        ...
        this.jdField_a_of_type_Akkj.a(localPromotionConfigInfo);
        this.jdField_a_of_type_Akkj.a(paramAppInterface, false, paramString, 0);
      }
    }
    do
    {
    ...
    throw new IllegalArgumentException(ajjy.a(2131642728));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, PromotionConfigInfo paramPromotionConfigInfo)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (paramPromotionConfigInfo != null)
      {
        ...
        {
          this.jdField_a_of_type_Akkn.clean();
          this.jdField_a_of_type_Akkn = null;
        }
      }
  ...
  boolean a(String paramString, AppInterface paramAppInterface, akkh paramakkh)
  {
    if ((a()) && (akke.a != -1)) {
      return false;
    }
    Object localObject2 = this.jdField_a_of_type_Akkn;
    ...
    if (localObject2 == null)
    {
      ...
      localObject1 = new akkn(this.jdField_a_of_type_JavaLangString, this.b, paramAppInterface);
      this.jdField_a_of_type_Akkn = ((akkn)localObject1);
    }
    if (((akkn)localObject1).isNeedRunTask())
    {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "异步加载config[" + paramString + "]");
      localObject2 = new ArrayList();
      ((ArrayList)localObject2).add(localObject1);
      baiq.requestSyncTask(null, (ArrayList)localObject2, new akkg(this, paramAppInterface, paramString, paramakkh));
    }
    for (;;)
    {
      return true;
  ...
  {
    if (this.jdField_a_of_type_Akkj != null) {
      this.jdField_a_of_type_Akkj.b(paramakkl);
    }
  }
  ...
  void b(AppInterface paramAppInterface)
  {
    ...
    if (AudioHelper.e()) {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "requestPreDownload, PromotionConfigInfo[" + localPromotionConfigInfo1 + "], isDevicesSupport[" + akke.a() + "]");
    }
    if (!akke.a()) {}
    ...
    this.jdField_a_of_type_Akkj.a(localPromotionConfigInfo2);
    this.jdField_a_of_type_Akkj.a(paramAppInterface, true, localPromotionConfigInfo1.activityid, 0);
  }
  
  void c(AppInterface paramAppInterface)
  {
    awjy.b();
    if (this.jdField_a_of_type_Akjz == null) {
      this.jdField_a_of_type_Akjz = new akjz();
    }
    this.jdField_a_of_type_Akjz.a(paramAppInterface);
  }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Akkj != null)
    {
      this.jdField_a_of_type_Akkj.a();
      this.jdField_a_of_type_Akkj = null;
    }
    if (this.jdField_a_of_type_Akjz != null)
    {
      this.jdField_a_of_type_Akjz.a();
      this.jdField_a_of_type_Akjz = null;
    }
    a(null);
  }
}
