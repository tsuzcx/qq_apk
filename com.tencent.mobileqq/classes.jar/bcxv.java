  ...
  extends bcvs
{
  ...
  public bcxv()
  {
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new bcxw(this);
    this.jdField_a_of_type_JavaLangString = "picture";
    this.jdField_a_of_type_Int = 18;
  }
  
  public bcxv(String paramString)
  {
    this();
    this.aa = paramString;
  }
  
  public bcxv(String paramString1, String paramString2)
  {
    this();
  ...
  public static Bitmap a(Drawable paramDrawable)
  {
    try
    {
      ...
      for (Object localObject = Bitmap.Config.ARGB_8888;; localObject = Bitmap.Config.RGB_565)
      {
        ...
        paramDrawable = bgmo.a((Bitmap)localObject, i, i, i);
  ...
  public View a(Context paramContext, View paramView, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("[@]", 2, "StructMsgItemCover createView start! mUrlString = " + this.aa);
    }
    boolean bool2;
    if (paramBundle != null) {
    ...
    for (;;)
    {
      ...
      try
      {
        Drawable localDrawable1 = ocl.a().a((Resources)localObject3, 2130850447);
        ...
        else
        {
          try
          {
            ...
            ((PAHighLightImageView)localObject1).setImageDrawable(aoch.a(((BaseActivity)paramContext).app, 4, paramBundle.optString("groupcode")));
      ...
      catch (OutOfMemoryError localOutOfMemoryError)
      {
        for (;;)
        {
          ...
          ((PAHighLightImageView)localObject2).setId(2131368420);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          ((PAHighLightImageView)localObject1).setImageDrawable(bgmo.a());
          return localObject2;
        }
        ...
        paramContext.setTag(bgey.b(j, j, j));
      ...
      if ("StructMsgItemCover createView ,exception  = " + paramContext != null)
      {
          ...
          if ((localObject3 instanceof BaseActivity))
          {
            ...
            if (paramView.indexOf("internal_phone") > -1)
            {
              ...
              else
              {
                ...
                if (!bglf.a(paramContext)) {
                  break label997;
                }
                i = ((Context)localObject3).getResources().getDimensionPixelSize(2131298941);
                ((PAHighLightImageView)localObject1).setTextSize(i);
                ((PAHighLightImageView)localObject1).e = paramContext;
                paramContext = ((Context)localObject3).getResources().getDrawable(2130842050);
              }
            }
            for (;;)
            {
              ...
              break;
              i = ((Context)localObject3).getResources().getDimensionPixelSize(2131298943);
              break label944;
              if (bglf.a(paramContext))
              {
                i = ((Context)localObject3).getResources().getDimensionPixelSize(2131298937);
                break label944;
              }
              i = ((Context)localObject3).getResources().getDimensionPixelSize(2131298939);
              break label944;
              if (paramBundle.startsWith("+"))
              {
                paramContext = aoch.b(localQQAppInterface, paramBundle, (byte)3);
              }
              else
              {
                paramContext = aoch.a(11, 3);
                continue;
                paramContext = aoch.a(localQQAppInterface, 1, paramBundle, 3, paramContext, paramContext);
              }
            }
          }
        }
        ...
        {
          ((PAHighLightImageView)localObject1).setImageResource(2130843815);
          return localObject2;
        }
        if (QLog.isColorLevel()) {
        ...
        for (;;)
        {
          for (;;)
          {
            try
            {
              if (this.t == q)
              {
                j = afur.a(70.0F, (Resources)localObject3);
                i = j;
              }
            }
            catch (MalformedURLException paramContext) {}
          ...
          j = afur.a(140.0F, (Resources)localObject3);
          i = j;
          continue;
          paramBundle = null;
          if (paramView.startsWith("https://p.qlogo.cn/gh/"))
          {
            ...
            if ((paramView instanceof BaseActivity))
            {
              ...
              paramBundle = aoch.a(4, 3);
              ((PAHighLightImageView)localObject1).setImageDrawable(aoch.a(paramView, 4, paramContext, 3, paramBundle, paramBundle));
              return localObject2;
            }
            ((PAHighLightImageView)localObject1).setImageDrawable(bgmo.a());
            return localObject2;
      ...
      for (;;)
      {
        ...
        {
          ((PAHighLightImageView)localObject1).setScaleType(ImageView.ScaleType.CENTER_CROP);
          i = afur.a(70.0F, (Resources)localObject3);
          if (!bool1) {
            break label1943;
          }
          ((PAHighLightImageView)localObject1).setBackgroundColor(Color.parseColor("#dddfe2"));
        ...
        for (;;)
        {
          ...
          paramContext.restartDownload();
          break label2045;
          if ((paramView.startsWith(aarp.b)) || (paramView.startsWith(aarp.c)) || (paramView.startsWith(aarp.d)))
          {
            ((PAHighLightImageView)localObject1).setBackgroundDrawable(null);
            i = paramView.lastIndexOf("&uin=");
            paramContext = paramView.substring("&uin=".length() + i);
          ...
          if ((paramView.startsWith("http://imgplat.store.qq.com/bqq_qfpic/520520")) || (paramView.contains(aakz.jdField_a_of_type_JavaLangString)))
          {
            paramBoolean = true;
          ...
          if (this.t == r)
          {
            ...
            i = afur.a(140.0F, (Resources)localObject3);
            break label1367;
          }
          ((PAHighLightImageView)localObject1).setScaleType(ImageView.ScaleType.CENTER);
          break label1367;
  ...
  public void a(View paramView, int paramInt1, int paramInt2)
  {
    ...
    } while ((TextUtils.isEmpty((CharSequence)localObject3)) || (!this.aa.endsWith("gif")));
    localObject1 = "0";
    ...
    for (localObject2 = null;; localObject2 = ((ChatFragment)localObject2).a())
    {
      ...
      catch (Exception localException)
      {
        ...
        bcst.b((QQAppInterface)localObject2, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D93", "0X8005D93", paramInt2, 1, paramInt1, str, String.valueOf(paramView.msgId), "1", "");
        return;
      }
  ...
  {
    paramAbsShareMsg.mContentCover = this.aa;
  }
    ...
    for (String str = "";; str = this.aa)
    {
      ...
      if (this.jdField_a_of_type_Int > 3)
      {
        ...
        if (this.jdField_a_of_type_Int > 5)
        {
          ...
          if ((this.jdField_a_of_type_Int > 8) && (!TextUtils.isEmpty(this.ab))) {
            paramXmlSerializer.attribute(null, "needRoundView", this.ab);
          }
        }
      }
  ...
  public boolean a(bcxj parambcxj)
  {
    ...
    do
    {
      ...
      {
        return true;
        str = parambcxj.a("cover");
        if (str == null) {
          break;
        }
        this.aa = str;
      } while (this.jdField_a_of_type_Int <= 3);
      this.c = parambcxj.a("action");
    ...
    for (;;)
    {
      ...
      this.ab = parambcxj.a("needRoundView");
      return true;
      str = "";
      break label18;
