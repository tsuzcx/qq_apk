...
public class awzc
  extends awxx
{
  public awzc(MusicPlayerActivity paramMusicPlayerActivity) {}
  ...
  public void onPlaySongChanged(SongInfo paramSongInfo)
  {
    if (paramSongInfo != null)
    {
      ...
      localObject = (awzi)MusicPlayerActivity.b().get(localObject);
      paramSongInfo = MusicPlayerActivity.a(this.a, MusicPlayerActivity.a(this.a), paramSongInfo, ((awzi)localObject).a);
      MusicPlayerActivity.a(this.a, (awzi)localObject, paramSongInfo);
    }
    label64:
    ...
    if (localObject != null) {}
    for (int i = ((awxz)localObject).c();; i = 0)
    {
