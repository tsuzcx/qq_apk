  ...
  extends BaseAdapter
{
  ...
  public boolean a;
  public Object b;
  protected List<aicu> b;
  
  static
  {
    jdField_b_of_type_JavaLangString = aicv.class.getSimpleName();
  }
  
  public aibl(Context paramContext, bhoe parambhoe, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  protected ChatHistorySearchData a(ChatHistorySearchData paramChatHistorySearchData, ArrayList<aicu> paramArrayList)
  {
      ...
      do
      {
        ...
        while (i < paramChatHistorySearchData.mSearchData1.size())
        {
          ...
          if (a(localMessageRecord)) {
            paramArrayList.add(new aicu(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord));
          }
          i += 1;
        }
  ...
  public boolean a(MessageRecord paramMessageRecord)
  {
    ...
    {
      return false;
      str = bdbt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramMessageRecord.isSend(), paramMessageRecord.senderuin).toLowerCase(Locale.US);
      paramMessageRecord = aicu.a(paramMessageRecord.msg).toLowerCase(Locale.US);
    } while ((!str.contains(aicu.jdField_a_of_type_JavaLangString)) && (!paramMessageRecord.contains(aicu.jdField_a_of_type_JavaLangString)));
    return true;
  }
  
  public ChatHistorySearchData b(ChatHistorySearchData paramChatHistorySearchData, ArrayList<aicu> paramArrayList)
  {
    int i = 0;
    for (;;)
    {
