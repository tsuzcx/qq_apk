...
public class adlt
  extends aniz
{
  public adlt(AssistantSettingActivity paramAssistantSettingActivity) {}
  ...
  {
    if ((paramBoolean) && (AssistantSettingActivity.a(this.a) != null) && (this.a.jdField_a_of_type_Admr != null) && (this.a.jdField_a_of_type_Admr.a(paramArrayOfShort)))
    {
  ...
  protected void onGetConnectionsSwitch(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (this.a.jdField_a_of_type_Ajld.c()) {
        break label81;
      }
    }
    label81:
  ...
  {
    boolean bool2 = true;
    if (this.a.jdField_a_of_type_Admr == null) {}
    for (ajky localajky = null; localajky == null; localajky = this.a.jdField_a_of_type_Admr.a(paramShort1)) {
      return;
    }
    if (com.tencent.TMG.utils.QLog.isColorLevel()) {
    ...
    if (paramShort2 == 1)
    {
      bool1 = true;
      label91:
      if ((paramBoolean) || (bool1 != localajky.e)) {
        break label148;
      }
      if (localajky.e) {
        break label150;
  ...
  protected void onSetConnectionsSwitch(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (!paramBoolean)
    {
      AssistantSettingActivity.a(this.a, 2131717834, 1);
      localAssistantSettingActivity = this.a;
      if (this.a.jdField_a_of_type_Ajld.c()) {
        break label95;
      }
  ...
  protected void onSetEmotionRecSwitch(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      AssistantSettingActivity.a(this.a, 2131717834, 1);
      AssistantSettingActivity.a(this.a, aijp.a(this.a.app).b(), AssistantSettingActivity.a(this.a));
      return;
    }
    ...
    {
      bcst.b(localQQAppInterface, "dc00898", "", "", "0X800A223", "0X800A223", 0, 0, str, "", "", "");
      return;
    }
  }
  ...
  protected void onSetPttAutoToTxtSwitch(boolean paramBoolean, Object paramObject)
  {
    if (!paramBoolean)
    {
      QQToast.a(BaseApplication.getContext(), 1, anni.a(2131699587), 0).b(this.a.getTitleBarHeight());
