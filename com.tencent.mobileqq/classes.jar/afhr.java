  ...
  implements View.OnClickListener
{
  ...
  {
    if ((!afhq.a(this.a)) || (this.a.a()) || (System.currentTimeMillis() - afhq.a(this.a) < 600L)) {}
    ...
    do
    {
      do
      {
        ...
        {
          return;
          afhq.a(this.a, System.currentTimeMillis());
          localMessageForApollo = (MessageForApollo)((afiv)aepi.a(paramView)).a;
          ...
          {
            QQToast.a(paramView.getContext(), alud.a(2131700724), 0).a();
            return;
          }
          if (!ApolloEngine.a())
          {
      ...
      localObject = (aknx)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
    ...
    for (;;)
    {
      int k = ((aknx)localObject).b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
