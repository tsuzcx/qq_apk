  ...
  public static void a(AppRuntime paramAppRuntime)
  {
    ...
    for (;;)
    {
      ...
      if (i < paramAppRuntime.length())
      {
        ...
        localObject1 = new atyu();
        ((atyu)localObject1).jdField_a_of_type_JavaLangString = ((JSONObject)localObject2).optString("title");
        ((atyu)localObject1).b = ((JSONObject)localObject2).optString("subtitle");
        ((atyu)localObject1).c = ((JSONObject)localObject2).optString("bannerLink");
        ((atyu)localObject1).d = ((JSONObject)localObject2).optString("reportName");
        ((atyu)localObject1).jdField_a_of_type_JavaUtilVector = new Vector();
      ...
      for (;;)
      {
        if (j < ((JSONArray)localObject2).length())
        {
          ...
          ((atyu)localObject1).jdField_a_of_type_JavaUtilVector.add(str);
          break label442;
