...
{
  public static int a;
  private static volatile awnr jdField_a_of_type_Awnr;
  ...
  protected awnh a;
  private awnj jdField_a_of_type_Awnj;
  private awnk jdField_a_of_type_Awnk;
  public awnn a;
  private awno jdField_a_of_type_Awno = new awno(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  private awof jdField_a_of_type_Awof;
  private awql jdField_a_of_type_Awql = awql.a();
  ...
  private awnn b;
  public ConcurrentHashMap<String, awon> b;
  public ConcurrentHashMap<String, awon> c;
  private int d;
  public ConcurrentHashMap<Long, awqr> d;
  private int jdField_e_of_type_Int;
  private String jdField_e_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c();
  public ConcurrentHashMap<Long, awqr> e;
  private int f;
  public ConcurrentHashMap<Long, awoo> f;
  public ConcurrentHashMap<Long, awoo> g;
  ...
  private awnr()
  {
    ...
    this.jdField_a_of_type_Awnh = new awns(this);
    this.jdField_b_of_type_Awnn = new awnu(this);
  ...
  {
    if (jdField_a_of_type_Awnr == null) {}
    try
    {
      if (jdField_a_of_type_Awnr == null) {
        jdField_a_of_type_Awnr = new awnr();
      }
      return jdField_a_of_type_Awnr;
    }
    finally {}
  }
  ...
  private void a(int paramInt)
  {
    ...
    if (paramInt == 6) {
      if (this.jdField_a_of_type_Awnj != null) {
        this.jdField_a_of_type_Awnj.a();
      }
    }
    while (paramInt != 20) {
      return;
  ...
  private void a(awob paramawob)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      QLog.d("MsgBackup.BackupAndMigrateManager", 2, "processPush0x11aSucc: client ip = " + paramawob + ", udpport = " + k + ", tcpport = " + j);
    }
    Object localObject = a();
    ((awql)localObject).d(str1);
    a().b(str2);
    a().a(i);
    ((awql)localObject).b(paramawob);
    ((awql)localObject).b(j);
    ((awql)localObject).a(k);
    if (i == 1)
    {
      ((awql)localObject).g(2);
      ((awql)localObject).f(2);
    }
    for (;;)
    {
      paramawob = new Intent();
      if (BaseActivity.sTopActivity != null) {
        break;
      }
      awqu.a("MsgBackup.BackupAndMigrateManager", "activity is null! please check whether is assigned!", new Object[0]);
      return;
      if (i == 2)
      {
        ((awql)localObject).g(1);
        ((awql)localObject).f(1);
      }
    }
    PublicFragmentActivity.a(BaseActivity.sTopActivity, paramawob, MsgBackupPCConfirmFragment.class, 1000);
  }
  ...
  public awng a()
  {
    if (this.jdField_a_of_type_Awng == null) {
      this.jdField_a_of_type_Awng = awng.a();
    }
    return this.jdField_a_of_type_Awng;
  }
  ...
  public awql a()
  {
    if (this.jdField_a_of_type_Awql == null) {
      this.jdField_a_of_type_Awql = awql.a();
    }
    return this.jdField_a_of_type_Awql;
  }
  ...
  public void a(int paramInt, awnx paramawnx, Object paramObject)
  {
    if (paramawnx.jdField_a_of_type_Int == 0) {}
    while (paramawnx.jdField_a_of_type_Int != 2) {
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_Awql.a(this.jdField_e_of_type_JavaLangString, paramInt, paramString);
  }
  ...
  public void a(long paramLong, int paramInt1, int paramInt2, BaseActivity paramBaseActivity)
  {
    ...
    for (;;)
    {
      localMessage.obj = String.format(str1, new Object[] { str2, awqu.a(paramLong) + "B/s" });
      localMessage.arg1 = paramInt2;
      awng.a().a(paramInt2);
      localMqqHandler.sendMessage(localMessage);
      awql.a().a(null);
      awql.a().a(this.jdField_b_of_type_Awnn);
      a(paramBaseActivity);
  ...
  public void a(awnj paramawnj)
  {
    this.jdField_a_of_type_Awnj = paramawnj;
  }
  
  public void a(awnk paramawnk)
  {
    this.jdField_a_of_type_Awnk = paramawnk;
  }
  ...
  public void a(awnx paramawnx)
  {
    ...
    paramawnx.jdField_a_of_type_Awnl = this;
    this.jdField_a_of_type_Awno.a(paramawnx, 10000);
  }
  
  public void a(awnx paramawnx, Object paramObject)
  {
    if (paramawnx.jdField_a_of_type_Int == 0) {
      if ((paramObject != null) && ((paramObject instanceof awon)))
      {
        paramawnx = (awon)paramObject;
        paramObject = new File(awqu.a(paramawnx.jdField_a_of_type_JavaLangString, awqu.b(paramawnx.jdField_a_of_type_Int), paramawnx.jdField_b_of_type_JavaLangString));
    ...
    label72:
    while ((paramawnx.jdField_a_of_type_Int != 2) || (this.jdField_a_of_type_Awnn == null))
    {
      return;
      paramawnx.jdField_a_of_type_Long = paramObject.length();
      this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(awqu.b(paramawnx.jdField_a_of_type_JavaLangString, awqu.b(paramawnx.jdField_a_of_type_Int)), paramawnx);
      if (QLog.isColorLevel()) {
        QLog.d("MsgBackup.BackupAndMigrateManager", 2, "onProgress, db prepared! result = 0, sessionInfo.uin = " + paramawnx.jdField_a_of_type_JavaLangString);
      }
      a().i(257);
      return;
    }
    this.jdField_a_of_type_Awnn.b(paramawnx.jdField_c_of_type_Int + 1, paramawnx.jdField_b_of_type_Int);
  }
  ...
  public void a(awoi paramawoi)
  {
    ...
    int i = paramawoi.a();
    a().a(i);
    paramawoi = paramawoi.a();
    a().a(paramawoi);
    localIntent.putExtra("0x11bpush_extra", paramawoi);
  ...
  {
    if ((paramObject instanceof awob))
    {
  ...
  {
    if (paramString != null) {
      ((awnf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(162)).c(paramString);
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      a().a(i);
      this.jdField_a_of_type_Awql.a(this.jdField_e_of_type_JavaLangString, paramBoolean);
      return;
      this.jdField_a_of_type_Awof = null;
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Awnh);
    }
  }
  ...
  public void b(awnx paramawnx)
  {
    ...
    paramawnx.jdField_a_of_type_Awnl = this;
    this.jdField_a_of_type_Awno.a(paramawnx, 10001);
  }
  ...
  public void c(awnx paramawnx)
  {
    ...
    paramawnx.jdField_a_of_type_Awnl = this;
    this.jdField_a_of_type_Awno.a(paramawnx, -1);
  }
  
  public void d()
  {
    awqu.a("MsgBackup.BackupAndMigrateManager", "onDestory ......", new Object[0]);
    this.jdField_a_of_type_Awql.b();
    b();
    jdField_b_of_type_Boolean = false;
    this.jdField_a_of_type_Awno.a();
    awqs.c();
  ...
  public void e()
  {
    this.jdField_a_of_type_Awno.b();
    jdField_g_of_type_Boolean = false;
    jdField_a_of_type_Awnr = null;
  }
  ...
  public void g()
  {
    ((awnf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(162)).a();
  }
  
  public void h()
  {
    awqu.b("MsgBackup.BackupAndMigrateManager", "sFileMeta = %s", new Object[] { jdField_a_of_type_JavaLangString });
    if (TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) {}
    ((awnf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(162)).b(jdField_a_of_type_JavaLangString);
  }
  
  public void i()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Awnh);
  }
  
  public void j()
  {
    this.jdField_a_of_type_Awql.a(this.jdField_e_of_type_JavaLangString);
  }
  ...
  public void k()
  {
    ...
    if (this.jdField_a_of_type_MqqAppAppRuntime$InterceptKickListener == null) {
      this.jdField_a_of_type_MqqAppAppRuntime$InterceptKickListener = new awnt(this);
    }
