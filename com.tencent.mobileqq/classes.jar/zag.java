...
{
  public zag(FrameHelperActivity paramFrameHelperActivity) {}
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    if (paramBoolean) {
      ThreadManager.post(new zah(this), 5, null, true);
    }
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    if (this.a.jdField_a_of_type_AndroidViewViewGroup != null) {
      ((ImageView)this.a.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369166)).setImageResource(0);
    }
    Object localObject1 = this.a.jdField_a_of_type_ArrayOfComTencentMobileqqActivityRecentDrawerFrame$IDrawerCallbacks;
    int j = localObject1.length;
    int i = 0;
