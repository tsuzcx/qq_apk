  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    try
    {
      ...
      if (paramFromServiceMsg != null)
      {
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          notifyObserver(paramIntent, 1010, true, localBundle, avvd.class);
          return;
        }
        ...
        notifyObserver(paramIntent, 1010, false, localBundle, avvd.class);
        return;
      }
    }
    catch (Throwable paramIntent)
    {
      ...
      notifyObserver(null, 1010, false, null, avvd.class);
    }
  }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    try
    {
      ...
      arrayOfByte = new zae((COMM.StCommonExt)localObject, l1, l2).encode(paramIntent, -1, a());
