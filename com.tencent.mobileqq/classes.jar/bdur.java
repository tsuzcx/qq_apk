  ...
  extends ajtd
{
  ...
  private List<bduu> jdField_a_of_type_JavaUtilList = new ArrayList();
  private final AtomicInteger jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger();
  
  protected bdur(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Bduv = new bdus(this);
    this.jdField_a_of_type_Bduq = ((bduq)paramQQAppInterface.a(104));
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Bduv);
  ...
  {
    int i = 1;
    String str = this.jdField_a_of_type_Bduq.a();
    if (this.jdField_a_of_type_Bduq.a() == null) {
      if (paramBoolean) {
        i = 2;
      }
    }
    do
    {
      do
      {
        ...
        {
          return i;
        } while (this.jdField_a_of_type_Bduq.a(paramInt1, paramMessageMicro, paramInt2, paramObject));
        return 3;
        if (this.jdField_a_of_type_Bduq.b() != null) {
          break;
        }
        if (paramBoolean) {
          return 4;
  ...
  private void a()
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          bduu localbduu = (bduu)localIterator.next();
          a(localbduu.a(), localbduu.a(), true, localbduu.b(), localbduu.a());
        }
      }
  ...
  private void a(int paramInt1, MessageMicro<?> paramMessageMicro, boolean paramBoolean, int paramInt2, Object paramObject)
  {
    ...
    if (i == 1)
    {
      ...
      if (!paramBoolean) {
        synchronized (this.jdField_a_of_type_JavaLangObject)
        {
          this.jdField_a_of_type_JavaUtilList.add(new bduu(paramInt1, paramMessageMicro, paramInt2, paramObject));
          return;
        }
      }
    }
    else
    {
      ...
      try
      {
        ...
        localObject2 = new Cryptor().encrypt(paramMessageMicro.toByteArray(), this.jdField_a_of_type_Bduq.a());
        paramMessageMicro = new String();
        i = 0;
        while (i < "8.2.8".length())
        {
          ??? = paramMessageMicro;
          if ("8.2.8".charAt(i) != '.') {
            ??? = paramMessageMicro.concat(Character.toString("8.2.8".charAt(i)));
          }
          i += 1;
      ...
      ((im_msg_head.LoginSig)???).bytes_sig.set(ByteStringMicro.copyFrom(this.jdField_a_of_type_Bduq.b()));
      ...
      try
      {
        ...
        ((ayrv)localObject2).a(paramObject);
        ((ayrv)localObject2).jdField_a_of_type_ArrayOfByte = paramMessageMicro;
        ((ayrv)localObject2).jdField_a_of_type_Aysa = new bdut(paramInt1, this, this.jdField_a_of_type_Bduq.a(), paramInt2, paramObject);
        ((ayrv)localObject2).jdField_a_of_type_JavaLangString = ((String)???);
        ((ayrv)localObject2).jdField_a_of_type_Int = 1;
        ((ayrv)localObject2).jdField_a_of_type_JavaUtilHashMap.put("Accept-Encoding", "identity");
  ...
  private void b()
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          bduu localbduu = (bduu)localIterator.next();
          a(localbduu.a(), false, null, localbduu.b(), localbduu.a());
        }
      }
      this.jdField_a_of_type_JavaUtilList.clear();
    }
