...
public class bavg
{
  ...
  public final Queue<bavl> a;
  
  public bavg(SnapshotResultReceiver paramSnapshotResultReceiver)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put("offline_pkg", mzh.b());
  }
  ...
  public static void a(Application paramApplication, String paramString, int paramInt)
  {
    ...
    localEditor.putBoolean("need_set_proxy", true);
    localEditor.commit();
    bbbr.a(paramApplication, "com.tencent.mobileqq:tool");
    if (QLog.isColorLevel())
    {
  ...
  public bavm a(Context paramContext)
  {
    bavm localbavm = new bavm(this);
    localbavm.jdField_a_of_type_JavaLangString = (bbdh.h() + " " + bbdh.d());
    localbavm.jdField_b_of_type_JavaLangString = Build.VERSION.RELEASE;
    localbavm.c = "8.3.0.4480";
    bbdi localbbdi = bbdh.a(paramContext);
    localbavm.d = localbbdi.jdField_a_of_type_JavaLangString;
    localbavm.e = localbbdi.c;
    localbavm.jdField_a_of_type_Int = bbdh.b();
    localbavm.jdField_a_of_type_Long = bbdh.a();
    localbavm.jdField_b_of_type_Long = bbdh.d();
    localbavm.f = bbdh.g();
    localbavm.jdField_a_of_type_Boolean = a(paramContext);
    localbavm.jdField_b_of_type_Int = QbSdk.getTbsVersion(paramContext);
    if (localbavm.jdField_b_of_type_Int == 0) {}
    for (boolean bool = false;; bool = true)
    {
      localbavm.jdField_b_of_type_Boolean = bool;
      return localbavm;
    }
  }
  ...
  public String a()
  {
    bavf localbavf = bave.a("getprop net.dns1");
    if (localbavf.jdField_a_of_type_Boolean)
    {
      if (!localbavf.jdField_a_of_type_JavaUtilList.isEmpty()) {
        return (String)localbavf.jdField_a_of_type_JavaUtilList.get(0);
      }
    }
    else if (QLog.isColorLevel()) {
      QLog.d("UnifiedDebugManager", 2, localbavf.jdField_a_of_type_JavaLangString);
    }
    return "";
  }
  ...
  public String a(long paramLong1, long paramLong2)
  {
    ...
    //   705: aload 22
    //   707: aload 18
    //   709: invokestatic 524	bavq:a	(Ljava/util/List;Ljava/lang/String;)V
    //   712: aload 18
    //   714: areturn
    //   715: astore 19
    //   717: ldc 140
  ...
  public String a(Context paramContext, String paramString)
  {
    ...
    {
      paramString = paramContext.list(new bavj(this, paramString));
      ...
      finally
      {
        try
        {
          ...
          try
          {
            ...
            bavq.a(localArrayList, paramContext);
            bavq.a(localArrayList);
            return paramContext;
          }
  ...
  public String a(Context paramContext, List<String> paramList)
  {
    ...
    if ((((File)localObject1).exists()) && (((File)localObject1).isDirectory()))
    {
      ...
      while (paramList.hasNext())
      {
        localObject2 = ((File)localObject1).list(new bavh(this, c((String)paramList.next()).substring(0, 16)));
  ...
  public String a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    //   11: ldc_w 702
    //   14: ldc_w 383
    //   17: invokestatic 705	bcgq:c	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   79: invokestatic 729	nau:c	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   97: invokestatic 733	nau:b	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   527: aload_1
    //   528: aload 4
    //   530: invokestatic 524	bavq:a	(Ljava/util/List;Ljava/lang/String;)V
    //   533: aload 4
    //   535: areturn
    //   536: astore 4
    //   538: ldc 140
  ...
  public String a(File paramFile, List<String> paramList)
  {
    ...
    bavq.a(paramFile, paramList, str);
    return str;
  }
  ...
  public void a(Context paramContext, String paramString1, int paramInt, long paramLong1, long paramLong2, String paramString2)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      ...
      {
        this.jdField_a_of_type_JavaUtilQueue.offer(new bavl(this, paramString1, paramInt, paramLong1, paramLong2, paramString2));
        return;
      }
  ...
  public void a(Context paramContext, List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = paramContext.listFiles(new bavi(this, c((String)paramList.next()).substring(0, 16)));
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, Handler paramHandler)
  {
    ...
    new bavr(paramQQAppInterface, paramHandler).a(paramLong, str1, paramString);
  }
  ...
  public boolean a(Context paramContext, long paramLong)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      bavl localbavl = (bavl)this.jdField_a_of_type_JavaUtilQueue.poll();
      if ((localbavl != null) && (localbavl.jdField_b_of_type_Long == paramLong))
      {
        localbavl = (bavl)this.jdField_a_of_type_JavaUtilQueue.peek();
        if (localbavl != null)
        {
          b(paramContext, localbavl.jdField_a_of_type_JavaLangString, localbavl.jdField_a_of_type_Int, localbavl.jdField_a_of_type_Long, localbavl.jdField_b_of_type_Long, localbavl.jdField_b_of_type_JavaLangString);
          if (QLog.isColorLevel()) {
            QLog.d("UnifiedDebugManager", 2, "finish once webview debug, start new debug(dequeue one cmd): seq=" + localbavl.jdField_b_of_type_Long);
          }
        }
        while (!QLog.isColorLevel()) {
          return true;
  ...
  {
    paramContext = bavq.a(a(paramContext));
  ...
  public void b(Context paramContext, String paramString, List<String> paramList)
  {
    ...
    if ((paramContext.exists()) && (paramContext.isDirectory()))
    {
      paramString = paramContext.list(new bavk(this, paramString));
      if ((paramString != null) && (paramString.length > 0))
      {
        int j = paramString.length;
        int i = 0;
