  ...
  extends aksv
{
  ...
  public aslu(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  public static MessageRecord a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte)
  {
    ...
    if (((Long)((Pair)localObject2).first).longValue() != 4294967295L)
    {
      ...
      if (((!axas.c(k)) && (k != 208) && (k != 529)) || (!paramArrayOfByte.c2c_cmd.has())) {
        break label554;
      }
    ...
    for (;;)
    {
      ...
      {
        axao.a(localMessageHandler, localArrayList, localMsg);
        break label1259;
        int m = axao.a(localMsg);
        ...
        if (paramArrayOfByte.hasNext())
        {
          ...
          Object localObject1;
          ((MessageRecord)localObject2).vipBubbleID = akfw.a((int)localObject1, m);
          ...
          axao.a(localMessageHandler, localArrayList, localMsg, true, false, null);
          continue;
          label554:
          ...
          if (!paramQQAppInterface.a().a().a(localArrayList, localMsg)) {
            axao.a(localMessageHandler, localArrayList, localMsg, false, false, null);
          }
                ...
                if (((im_msg_body.Elem)localObject2).anon_group_msg.has())
                {
                  ...
                  for (;;)
                  {
                    try
                    {
                      ...
                      {
                        localObject2 = "";
                        localMessageRecord.saveExtInfoToExtStr("anonymous", mye.a(i, paramArrayOfByte, (String)localObject2, j, m, str));
          ...
          axao.a(localMessageHandler, localMsg, localArrayList);
          break label1296;
          label972:
    ...
    for (;;)
    {
      ...
      do
      {
        if (ajsf.z.equals(Long.valueOf(l3)))
        {
          ((MessageRecord)localObject2).istroop = 6000;
          break label452;
        }
        if (ajsf.A.equals(Long.valueOf(l3)))
        {
        ...
        break label452;
        akau.a(localArrayList);
        if (localArrayList.size() > 0) {
          return (MessageRecord)localArrayList.get(0);
        }
        asog.a("MsgBackup_msgproxy", "transToMessageRecord failed.........", new Object[0]);
        return null;
        break label303;
        break label303;
        do
  ...
  public static msg_comm.MsgHead a(MessageRecord paramMessageRecord, long paramLong)
  {
    ...
    Object localObject = akpy.c(paramMessageRecord);
    for (;;)
    {
      try
      {
  ...
  public static im_msg_body.MsgBody a(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface)
  {
    if ((paramMessageRecord.msgtype == -1000) || (paramMessageRecord.msgtype == -10000)) {
      if (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("sens_msg_source_msg_info"))) {
        paramQQAppInterface = axao.a(paramMessageRecord);
      }
    }
    label965:
    for (;;)
    {
      if ((paramQQAppInterface != null) && (!paramQQAppInterface.elems.isEmpty()))
      {
        ...
        if (mye.a(paramMessageRecord))
        {
          ...
          ((im_msg_body.AnonymousGroupMsg)localObject2).uint32_flags.set(localmyf.jdField_a_of_type_Int);
          if (!TextUtils.isEmpty(localmyf.jdField_a_of_type_JavaLangString)) {
            ((im_msg_body.AnonymousGroupMsg)localObject2).str_anon_id.set(ByteStringMicro.copyFrom(localmyf.jdField_a_of_type_JavaLangString.getBytes()));
          }
          if (!TextUtils.isEmpty(localmyf.jdField_b_of_type_JavaLangString)) {
            ((im_msg_body.AnonymousGroupMsg)localObject2).str_anon_nick.set(ByteStringMicro.copyFrom(localmyf.jdField_b_of_type_JavaLangString.getBytes()));
          }
          ((im_msg_body.AnonymousGroupMsg)localObject2).uint32_head_portrait.set(localmyf.jdField_b_of_type_Int);
          ((im_msg_body.AnonymousGroupMsg)localObject2).uint32_expire_time.set(localmyf.jdField_c_of_type_Int);
          if (!TextUtils.isEmpty(localmyf.jdField_c_of_type_JavaLangString)) {
            ((im_msg_body.AnonymousGroupMsg)localObject2).str_rank_color.set(ByteStringMicro.copyFrom(localmyf.jdField_c_of_type_JavaLangString.getBytes()));
          }
        ...
        paramQQAppInterface = axao.a((MessageForText)paramMessageRecord);
        continue;
        if (paramMessageRecord.msgtype == -1049)
        {
          paramQQAppInterface = axao.a((MessageForReplyText)paramMessageRecord);
          continue;
        }
        ...
        {
          paramQQAppInterface = axao.a((MessageForQQStoryComment)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -2000)
        {
          paramQQAppInterface = axao.a((MessageForPic)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -5008)
        {
          paramQQAppInterface = axao.a((MessageForArkApp)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5016)
        {
          paramQQAppInterface = axao.c((MessageForArkBabyqReply)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5017)
        {
          paramQQAppInterface = axao.b((MessageForArkApp)paramMessageRecord, true);
          continue;
        }
        if (paramMessageRecord.msgtype == -5013)
        {
          paramQQAppInterface = axao.c((MessageForArkFlashChat)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -5014)
        {
          paramQQAppInterface = axao.d((MessageForHiBoom)paramMessageRecord);
          continue;
        }
        if (paramMessageRecord.msgtype == -2011)
        {
          paramQQAppInterface = axao.a((MessageForStructing)paramMessageRecord);
        ...
        if (paramMessageRecord.msgtype == -1035)
        {
          ...
          while (i < k)
          {
            ...
            {
              localObject1 = axao.a((MessageForText)localObject1);
        ...
        {
          paramQQAppInterface = axao.a((MessageForLongTextMsg)paramMessageRecord, false);
          continue;
        }
        ...
        else
        {
          ...
          {
            paramQQAppInterface = axao.a((MessageForMarketFace)paramMessageRecord);
            continue;
          }
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    catch (Throwable paramQQAppInterface)
    {
      for (;;)
      {
        ...
        axps.a(paramQQAppInterface, "MsgBackup_msgproxy,mr = " + paramMessageRecord.getClass().getSimpleName());
        paramQQAppInterface = null;
      }
  ...
  public MessageRecord a(@NonNull MsgBackupMsgEntity paramMsgBackupMsgEntity)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject4 = new azmj();
        ((azmj)localObject4).jdField_a_of_type_Int = asog.c(paramMsgBackupMsgEntity.chatType);
        localMessageHandler = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        localObject5 = axao.a(localMessageHandler, localMsg, String.valueOf(l5), String.valueOf(l4));
        if (((Long)((Pair)localObject5).first).longValue() != 4294967295L)
        {
          l1 = ((Long)((Pair)localObject5).first).longValue();
          break label1564;
          localObject5 = new ArrayList();
          if (((!axas.c(i1)) && (i1 != 208) && (i1 != 529)) || (!((msg_comm.MsgHead)localObject2).c2c_cmd.has())) {
            break label827;
          }
          ...
          if (i1 == 208)
          {
            axao.a(localMessageHandler, (List)localObject5, localMsg);
            l1 = l3;
          }
          int m = 0;
          int i2 = axao.a(localMsg);
          ...
          Object localObject1;
          ((MessageRecord)localObject4).vipBubbleID = akfw.a((int)localObject1, i2);
      ...
      axao.a(localMessageHandler, (List)localObject5, localMsg, true, false, (azmj)localObject4);
      continue;
      label827:
      ...
      if (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a((ArrayList)localObject5, localMsg)) {
        axao.a(localMessageHandler, (List)localObject5, localMsg, false, false, (azmj)localObject4);
      }
            ...
            if (((im_msg_body.Elem)localObject4).anon_group_msg.has())
            {
              ...
              for (;;)
              {
                try
                {
                  ...
                  {
                    localObject4 = "";
                    localMessageRecord.saveExtInfoToExtStr("anonymous", mye.a(i, (String)localObject2, (String)localObject4, j, k, str));
                    localMessageRecord.extLong |= 0x3;
                  }
                  else
                  {
      ...
      axao.a(localMessageHandler, localMsg, (List)localObject5);
      break label1603;
    ...
    for (;;)
    {
      ...
      do
      {
        if (ajsf.z.equals(Long.valueOf(l5))) {
  ...
  public MsgBackupMsgEntity a(@NonNull MessageRecord paramMessageRecord)
  {
    ...
    try
    {
      ...
      {
        asog.a("transBackupEntity error,mr = %s ", paramMessageRecord.toString(), new Object[0]);
        return null;
      }
    }
    catch (Throwable localThrowable)
    {
      ...
      {
        QLog.e("MsgBackup_msgproxy", 1, "transToBackupEntity,getMsgBody error mr = " + paramMessageRecord.getClass().getSimpleName());
        axps.a(localThrowable, "MsgBackup_msgproxy,mr = " + paramMessageRecord.getClass().getSimpleName());
        localObject2 = null;
      }
      localMsg.msg_head.set(localMsgHead);
      ...
      ((MsgBackupMsgEntity)localObject2).chatType = asog.b(paramMessageRecord.istroop);
      ((MsgBackupMsgEntity)localObject2).msgType = asog.a(paramMessageRecord.msgtype);
    ...
    if (paramMessageRecord.istroop == 3000)
    {
      ...
      paramMessageRecord = aslj.a(i);
      if (paramMessageRecord != null) {
        break label402;
      }
      paramMessageRecord = localMsg.toByteArray();
      aslj.a(paramMessageRecord);
    }
    label363:
    ...
    {
      return localObject2;
      i = axas.b(paramMessageRecord.msgUid);
