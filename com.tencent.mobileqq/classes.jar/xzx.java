  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if ("com.tencent.device.ble.ACTION_GATT_CONNECTED".equals(paramContext)) {
      ymw.a().a(null, "Net_Bind_BLE_Connect", 0);
    }
    do
    {
      int i;
        ...
        do
        {
          do
          {
            ...
            if (paramContext != null)
            {
              ...
              xzu.b(this.a).remove(paramContext);
              if (this.a.jdField_a_of_type_Ygi == paramContext) {
                this.a.jdField_a_of_type_Ygi = null;
              }
              xzu.a(this.a).remove(paramContext);
              xzu.a(this.a, i);
