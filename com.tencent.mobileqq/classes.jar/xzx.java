  ...
  implements ygp
{
  ...
  protected BaseWidgetView a(ViewGroup paramViewGroup, ydp paramydp)
  {
    if ((a() instanceof SubscribeMultiPicFragment))
    {
      ...
      paramydp = new LinearLayout.LayoutParams(-1, ImmersiveUtils.a(29.0F));
      paramydp.leftMargin = ImmersiveUtils.a(9.0F);
      paramydp.rightMargin = ImmersiveUtils.a(15.0F);
      paramydp.gravity = 16;
      this.jdField_a_of_type_ComTencentBizSubscribeWidgetSubscribeFollowInfoView.setLayoutParams(paramydp);
    ...
    if (this.jdField_a_of_type_Yhg != null) {
      this.jdField_a_of_type_Yhg.a(this.jdField_a_of_type_ComTencentBizSubscribeWidgetRelativevideoRelativeMultiPicHeadItemView.a());
    }
  ...
  {
    if ((paramydp.a() != null) && ("RELATIVE_ADAPTER_UNIQUE_KEY".equals(paramydp.a()))) {
      ((xzz)paramydp).a(new xzy(this));
    }
  }
