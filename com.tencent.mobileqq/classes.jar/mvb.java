...
public class mvb
{
  ...
  public mvb(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_ComTencentAvVideoEffectCoreQqavimageQQAVImageFilter = new mvd();
  ...
  mvc a(QQAVImageFilter paramQQAVImageFilter, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (paramQQAVImageFilter != null)
    {
      ...
      return new mvc(this, paramInt3, paramInt4);
    }
    return new mvc(this, paramInt1, paramInt2);
  }
