...
public class nae
{
  ...
  {
    File localFile = new File(ajsf.aW + "photo/");
    if ((!localFile.exists()) && (!localFile.mkdirs()))
    {
      a();
      bcpw.a(paramActivity, 1, paramActivity.getString(2131690607), 0).a();
      return;
    }
  ...
  private void a(Activity paramActivity, Intent paramIntent, int paramInt)
  {
    ...
    a();
    bcpw.a(paramActivity, 1, paramInt, 0).a();
  }
  ...
  {
    Object localObject = new File(ajsf.aW + "photo/");
  ...
  public void a(Activity paramActivity, int paramInt, ValueCallback<Uri> paramValueCallback, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      if (paramInt != 0)
      {
        paramString2 = bfol.a(paramActivity);
        paramString2.a(new naf(this));
        paramString2.setOnCancelListener(new nag(this));
        if (paramValueCallback.equals("camera"))
        {
          paramString2.a(paramActivity.getString(2131720041), 0);
          paramString2.a(paramActivity.getString(2131692513), 0);
          paramString2.a(new nah(this, paramActivity, paramString1, paramString2));
        }
        for (;;)
        {
          paramString2.show();
          ...
          {
            paramString2.a(paramActivity.getString(2131719277), 0);
            paramString2.a(paramActivity.getString(2131692513), 0);
            paramString2.a(new nai(this, paramActivity, paramString1, paramString2));
          }
          else if (paramValueCallback.equals("microphone"))
          {
            paramString2.a(paramActivity.getString(2131718657), 0);
            paramString2.a(paramActivity.getString(2131692513), 0);
            paramString2.a(new naj(this, paramActivity, paramString1, paramString2));
          }
        }
      }
      a(paramActivity, paramString1);
