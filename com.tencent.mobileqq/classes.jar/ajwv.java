...
public class ajwv
{
  ...
  public ajwv(QQAppInterface paramQQAppInterface, ajwy paramajwy)
  {
    ...
    this.jdField_a_of_type_Ajwy = paramajwy;
    this.jdField_a_of_type_Anyu = new ajww(this);
  ...
  private long a()
  {
    long l = this.jdField_a_of_type_Aobl.a(2);
    if (QLog.isColorLevel()) {
  ...
  private void a(ArrayList<MayKnowRecommend> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      this.jdField_a_of_type_Aobl.a((List)???, l2, l1, true);
  ...
  private void a(List<MayKnowRecommend> paramList)
  {
    ...
    for (String str = "NULL";; str = paramList.toString())
    {
      ...
      this.jdField_a_of_type_Ajwy.a(paramList);
      return;
    }
  }
  ...
  private boolean a()
  {
    ...
    return this.jdField_a_of_type_Aobl.b(2);
  }
  ...
  private boolean a(Bundle paramBundle)
  {
    ...
    return this.jdField_a_of_type_Aobl.a(2, paramBundle);
  }
  ...
  private boolean a(MayKnowRecommend paramMayKnowRecommend)
  {
    ...
    {
      if (!this.jdField_a_of_type_Anyw.b(paramMayKnowRecommend.uin))
      {
        boolean bool = this.jdField_a_of_type_Anyw.a(paramMayKnowRecommend.uin, false, true);
        if (bool) {}
        for (int i = 1;; i = 0)
        {
  ...
  private ArrayList<MayKnowRecommend> c()
  {
    ...
    Collections.sort(localArrayList, new ajwx(this));
    if (QLog.isColorLevel()) {
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Ajwy.a())
    {
      if (a())
      {
        int i;
