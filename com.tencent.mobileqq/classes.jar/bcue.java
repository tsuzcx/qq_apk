  ...
  extends abiv
{
  ...
  public bcue(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Bcut = new bcut(paramAppInterface);
  ...
  private boolean e(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (bool)
    {
      ...
      while (paramToServiceMsg.hasNext())
      {
        ...
        localObject = (bcuc)((Map.Entry)localObject).getValue();
        if ((((bcuc)localObject).a() & i) != 0)
        {
          localObject = ((bcuc)localObject).a(i);
          if (localObject != null)
          {
            if (QLog.isColorLevel()) {
    ...
    paramToServiceMsg = (bcuc)((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface).a.a().get(Integer.valueOf(101));
  ...
  private boolean p(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    anyw localanyw = (anyw)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(51);
