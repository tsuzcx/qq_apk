...
public class bard
  extends barm
{
  public bard(Context paramContext)
  {
    super(paramContext);
  }
  
  private void a(QQAppInterface paramQQAppInterface, bari parambari, boolean paramBoolean, int paramInt, String paramString)
  {
    parambari.jdField_a_of_type_Boolean = paramBoolean;
    if (paramBoolean)
    {
      if (paramInt == 0) {
        parambari.jdField_a_of_type_Int = 0;
      }
    }
    else {
      return;
    ...
    if (paramInt == 3000)
    {
      parambari.jdField_a_of_type_Int = 3000;
      return;
    }
    if (paramInt == 1)
    {
      switch (paramQQAppInterface.b(paramString))
      {
      default: 
        parambari.jdField_a_of_type_Int = 1;
      }
      for (;;)
      {
        parambari.i = 0;
        ...
        parambari.i = paramQQAppInterface.wMemberNum;
        return;
        parambari.jdField_a_of_type_Int = 1;
        continue;
        parambari.jdField_a_of_type_Int = 3;
        continue;
        parambari.jdField_a_of_type_Int = 4;
        continue;
        parambari.jdField_a_of_type_Int = 2;
      }
    }
    parambari.jdField_a_of_type_Int = 9999;
  }
  
  private boolean a(bari parambari, String paramString)
  {
    Object localObject2 = new File(paramString);
    Object localObject1 = atwl.c(paramString);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (paramString.equalsIgnoreCase(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES).getAbsolutePath() + File.separator)) {
          parambari.j = 1002;
        } else if ((((String)localObject1).contains("camera")) || (((String)localObject1).equals("dcim")) || (((String)localObject1).equals("100MEDIA")) || (((String)localObject1).equals("100ANDRO")) || (((String)localObject1).contains(anni.a(2131701673))) || (((String)localObject1).contains(anni.a(2131701672))) || (((String)localObject1).contains(anni.a(2131701674)))) {
          parambari.j = 1007;
        } else if (akgm.a(paramString)) {
          parambari.j = 1005;
        } else {
  ...
  public void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString, barg parambarg)
  {
    parambarg.f = paramInt1;
    if (paramInt2 == 0) {
      parambarg.b = 0;
    }
    for (;;)
    {
      paramAppInterface = (axby)paramAppInterface.getManager(106);
      if (paramAppInterface != null)
      {
        parambarg.d = paramAppInterface.a();
        parambarg.e = paramAppInterface.b();
      }
      parambarg.g = Calendar.getInstance().get(11);
      parambarg.h = bgnt.a(BaseApplication.getContext());
      return;
      if (paramInt2 == 3000)
      {
        parambarg.b = 3000;
      ...
      else
      {
        if (paramInt2 == 1)
        {
          ...
          for (;;)
          {
            ...
            parambarg.c = paramString.wMemberNum;
            break;
            parambarg.b = 1;
            continue;
            parambarg.b = 3;
