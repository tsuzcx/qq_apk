  ...
  extends tln
{
  ...
  public tlj(Context paramContext, int paramInt)
  {
  ...
  private void h()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null)
    {
      ...
      tkj.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, (Activity)this.jdField_a_of_type_AndroidContentContext, nzq.an, nzq.a, 4, null);
    }
  }
  ...
  private void i()
  {
    ...
    tlc.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidWidgetImageView, str1, 8, 30, -1);
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368212));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131365388));
    ...
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131366566));
  }
  ...
  {
    super.a(paramtkv);
    if ((this.jdField_a_of_type_Tkv != null) && (this.jdField_a_of_type_Tkv.a != null))
    {
      this.jdField_a_of_type_Tkv.a(new tll(this));
      this.jdField_a_of_type_Tkv.a.a(new tlm(this));
      e();
    }
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup.setOnClickListener(new tlk(this));
  }
  ...
  public void d()
  {
    ...
    tku.a(false, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, nzq.an, nzq.a, 4);
    super.d();
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Tle != null) {
