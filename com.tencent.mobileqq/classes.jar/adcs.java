...
public class adcs
  extends bcfj
{
  adcs(ConfessHalfScreenActivity.ConfessBrowserFragment paramConfessBrowserFragment) {}
  ...
  public void a()
  {
    ...
    {
      localWebView = this.jdField_a_of_type_Bcdt.a();
    ...
    for (;;)
    {
      this.c.setOnClickListener(new adct(this));
      return;
      label171:
