...
public class oaj
{
  ...
  private static JSONObject a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      localJSONObject1.put("statistics_data_report", oau.a(paramContext, paramAdvertisementInfo, localJSONObject2).toString());
  ...
  private static void a(Activity paramActivity, int paramInt, VideoAdInfo paramVideoAdInfo)
  {
    ...
    AdvertisementInfo localAdvertisementInfo = nmf.a(paramVideoAdInfo);
    ...
    {
      a(paramActivity, paramVideoAdInfo, localAdvertisementInfo, nmf.P, 0, paramInt);
      return;
    }
    a(paramActivity, paramVideoAdInfo, localAdvertisementInfo, nmf.N, 0, paramInt);
  }
  ...
  public static void a(Activity paramActivity, int paramInt, boolean paramBoolean)
  {
    ...
    AdvertisementInfo localAdvertisementInfo = nmf.a(localVideoAdInfo);
    if (QLog.isColorLevel()) {
  ...
  private static void a(Activity paramActivity, VideoAdInfo paramVideoAdInfo, AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    nmf.a(new nyg().a(paramActivity).a(nmf.A).b(paramInt1).a(paramAdvertisementInfo).a(paramVideoAdInfo).e(a(paramActivity, paramAdvertisementInfo, paramInt2, paramInt3)).a());
  }
  ...
  private void a(Activity paramActivity, AdvertisementInfo paramAdvertisementInfo, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    nmf.a(new nyg().a(paramActivity).a(nmf.A).b(paramInt1).a(paramAdvertisementInfo).e(a(paramActivity, paramAdvertisementInfo, paramInt2, paramInt3)).a());
  }
  ...
  {
    boolean bool = "1".equals(bhvh.a("readinjjoy_ad_supplement_config"));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((localObject1 != null) && (((Long)localObject1).longValue() != 0L))
        {
          ...
          AdvertisementInfo localAdvertisementInfo = nmf.a((VideoAdInfo)localObject2);
          if (((VideoAdInfo)localObject2).jdField_c_of_type_Boolean) {
            a(paramActivity, (VideoAdInfo)localObject2, localAdvertisementInfo, nmf.P, (int)(System.currentTimeMillis() - ((Long)localObject1).longValue()), 50);
          } else {
            a(paramActivity, (VideoAdInfo)localObject2, localAdvertisementInfo, nmf.N, (int)(System.currentTimeMillis() - ((Long)localObject1).longValue()), 50);
          }
        }
      }
    }
  ...
  public void a(rap paramrap, Activity paramActivity)
  {
    if ((paramrap == null) || (paramActivity == null) || (this.jdField_c_of_type_Boolean)) {}
    ReadInJoyXListView localReadInJoyXListView;
    List localList;
    do
    {
      return;
      localReadInJoyXListView = (ReadInJoyXListView)paramrap.a();
      localList = paramrap.a();
      i = paramrap.a();
    } while ((localReadInJoyXListView == null) || (localList == null) || (!oau.a(i)));
    c();
    ...
    if (i <= m)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        paramrap = (BaseArticleInfo)localList.get(i - k);
        if (AdvertisementInfo.isAdvertisementInfo(paramrap)) {
          a(localReadInJoyXListView, j, m, i, (AdvertisementInfo)paramrap, paramActivity);
        }
      }
    }
    a(paramActivity);
