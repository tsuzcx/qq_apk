  ...
  implements bccc
{
  ...
  private bgvb jdField_a_of_type_Bgvb = new bgvb(this);
  private JsBridgeListener jdField_a_of_type_ComTencentMobileqqWebviewSwiftJsBridgeListener;
  private ReaderJsCallback jdField_a_of_type_CooperationQqreaderProxyReaderJsCallback = new bguz(this);
  ...
  private void a(JsBridgeListener paramJsBridgeListener, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramJsBridgeListener))
    {
      ...
      paramString.put("graylevel", bgup.a());
      paramString.put("is_update_newstyle", bgup.a());
  ...
  private void b(String paramString)
  {
    ...
    localIntent.putExtras(bgtq.a(localIntent, 2));
  ...
  private void b(String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    if (bgtw.a().a())
    {
      bgwf.e("ReaderJsPlugin", "pluginHandleJS ->  handleJsCall");
      a(paramString1, paramString2, paramString3, paramVarArgs);
      return;
    }
    bgwf.e("ReaderJsPlugin", "js plugin is not ready...");
    ...
    this.jdField_a_of_type_Bgvb.a(paramString1, paramString2, paramString3, paramVarArgs);
  }
  ...
  public bguy a(Handler paramHandler)
  {
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    this.b = paramString2;
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new bgva(this));
  }
  ...
  void a(String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    {
      bgwf.d("ReaderJsPlugin", "create a new js plugin");
      this.jdField_a_of_type_CooperationQqreaderProxyReaderJsPluginProxy = bgtw.a().a(this.jdField_a_of_type_CooperationQqreaderProxyReaderJsCallback);
    }
    if (this.jdField_a_of_type_CooperationQqreaderProxyReaderJsPluginProxy != null)
    {
      ...
      bgwf.d("ReaderJsPlugin", "create a new js ,method=" + paramString3);
    }
    do
    {
      return;
      bgwf.a("ReaderJsPlugin", "handleJsCall mJsPlugin is null!");
  ...
  {
    bgwf.e("ReaderJsPlugin", "handleJsRequest, url=" + paramString1 + " ,pakName=" + paramString2 + " ,method=" + paramString3);
    ...
    else if ("JSContent".equals(paramString2))
    {
      if ("registerWebSearch".equals(paramString3))
      {
        ...
        catch (JSONException paramJsBridgeListener)
        {
          for (;;)
          {
            bgwf.a("ReaderJsPlugin", "Failed to parse json str,json=" + paramVarArgs[0]);
          }
        }
      }
      ...
      if ("JSbookshelf".equals(paramString2))
      {
        if ("getGrayUpdateData".equals(paramString3))
        {
          ...
          catch (Exception paramJsBridgeListener)
          {
            for (;;)
            {
              bgwf.e("ReaderJsPlugin", paramJsBridgeListener.getMessage());
            }
          }
        }
