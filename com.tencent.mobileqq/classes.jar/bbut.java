...
public class bbut
{
  ...
  public bbut(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
  ...
  {
    return new File(aljq.aX + "homework_troop");
  }
  ...
  private void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString = bbuv.a(paramString, "config.cfg");
        if (!paramBoolean) {
          break label162;
        }
        switch (paramInt)
  ...
  public boolean a(Handler paramHandler, int paramInt, boolean paramBoolean)
  {
    ...
    localbaps.jdField_a_of_type_Bapx = new bbuu(this, paramHandler, paramInt, paramBoolean);
    localbaps.jdField_a_of_type_Int = 0;
    localbaps.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
