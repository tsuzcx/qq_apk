...
public class bety
{
  public static void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong, String paramString, int paramInt5, beua parambeua)
  {
    ...
    paramString = new NewIntent(BaseApplicationImpl.getApplication().getApplicationContext(), nta.class);
    ...
    paramString.setObserver(new betz(parambeua));
