  ...
  extends Dialog
{
  ...
  public bety(Context paramContext)
  {
    this(paramContext, 0);
  }
  
  public bety(Context paramContext, int paramInt)
  {
    this(paramContext, paramInt, 2131561235, 48);
  }
  
  public bety(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  public void a(beua parambeua)
  {
    this.jdField_a_of_type_Beua = parambeua;
  }
  ...
  {
    setOnKeyListener(new betz(this, paramBoolean));
  }
  ...
  public void dismiss()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 157	abvb:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 157	abvb:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 157	abvb:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
  ...
  {
    super.onBackPressed();
    if (this.jdField_a_of_type_Beua != null) {
      this.jdField_a_of_type_Beua.a();
    }
  }
