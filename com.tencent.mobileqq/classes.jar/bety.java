...
{
  private beua jdField_a_of_type_Beua;
  private ConcurrentHashMap<Long, beux> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  public AtomicLong a;
  
  public bety(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicLong = new AtomicLong(0L);
    this.jdField_a_of_type_Beua = ((beua)paramQQAppInterface.getManager(355));
  }
    ...
    if (j == 0)
    {
      ...
      if (localRspBody.app.has())
      {
        ...
        while (paramObject.hasNext()) {
          paramFromServiceMsg.add(betv.a((cmd0xe82.App)paramObject.next()));
        }
      }
      paramFromServiceMsg = new betz(l1, k, m, n, i1, l2, paramFromServiceMsg);
      paramObject = (beua)this.app.getManager(355);
      if (i == 1) {}
      for (bool = true;; bool = false)
      {
        ...
        {
          paramToServiceMsg.append(((betv)paramFromServiceMsg.a().get(i)).c()).append("|");
          i += 1;
        }
      }
      if (QLog.isColorLevel()) {
  ...
  {
    betz localbetz = this.jdField_a_of_type_Beua.a(Long.valueOf(paramLong));
    if (localbetz == null) {
      if (QLog.isColorLevel()) {
    ...
    {
      return true;
      if ((localbetz.a().size() <= 0) || (System.currentTimeMillis() <= localbetz.b())) {
        break;
      }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (j == 0)
    {
      ((beua)this.app.getManager(355)).a(l, i, bool);
      if (QLog.isColorLevel()) {
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Long.valueOf(l))) && (((beux)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(l))).a(paramFromServiceMsg, paramObject))) {
  ...
  public void a(long paramLong, int paramInt, Object paramObject)
  {
    ...
    ((cmd0xe82.ClientInfo)localObject).version.set("8.4.8");
  ...
  public void a(long paramLong, int paramInt, boolean paramBoolean)
  {
    ...
    if (((beua)this.app.getManager(355)).a(Long.valueOf(paramLong)) == null) {
      return;
    }
