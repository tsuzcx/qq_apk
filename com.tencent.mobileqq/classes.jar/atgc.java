...
public class atgc
{
  public static List<ChatMessage> a(List<ChatMessage> paramList)
  {
    ...
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if ((!abot.k(localChatMessage.msgtype)) && (!aely.a(localChatMessage))) {
  ...
  {
    aukx.a().jdField_a_of_type_Int = 7;
    ...
    do
    {
      ...
      if (paramIntent.size() > 0)
      {
        ...
        while (paramQQAppInterface.hasNext())
        {
          ...
          aukx.a().jdField_a_of_type_JavaUtilHashMap.put(localObject1, Boolean.valueOf(true));
        }
      }
