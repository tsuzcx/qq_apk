  ...
  extends QIPCModule
{
  ...
  private bhor(String paramString)
  {
    super(paramString);
  }
  
  /* Error */
  public static bhor a()
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 14	bhor:a	Lbhor;
    //   6: ifnonnull +27 -> 33
    //   9: ldc 2
    //   11: monitorenter
    //   12: getstatic 14	bhor:a	Lbhor;
    //   15: ifnonnull +15 -> 30
    //   18: new 2	bhor
    //   21: dup
    //   22: ldc 16
    //   24: invokespecial 17	bhor:<init>	(Ljava/lang/String;)V
    //   27: putstatic 14	bhor:a	Lbhor;
    //   30: ldc 2
    //   32: monitorexit
    //   33: getstatic 14	bhor:a	Lbhor;
    //   36: astore_0
    //   37: ldc 2
    //   39: monitorexit
    //   40: aload_0
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          ((aogw)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(BusinessHandlerFactory.VIPINFO_HANDLER)).notifyUI(5, true, paramBundle);
