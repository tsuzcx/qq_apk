...
public class bhor
  implements bhon, bhop
{
  private static int jdField_a_of_type_Int = 1;
  private bhoo jdField_a_of_type_Bhoo;
  private String jdField_a_of_type_JavaLangString;
  private Map<Integer, bhos> jdField_a_of_type_JavaUtilMap;
  private int b;
  private int c = 65535;
  private int d = 0;
  
  public bhor(bhoo parambhoo)
  {
    bhol localbhol = parambhoo.jdField_a_of_type_Bhol;
    if (localbhol != null) {
      localbhol.setNetTransportEventListener("intchk", this);
    }
  ...
  private intchk.AppInfo a()
  {
    ...
    String str = this.jdField_a_of_type_Bhoo.jdField_a_of_type_AndroidContentContext.getPackageName();
    ...
    for (;;)
    {
      str = bhov.a(this.jdField_a_of_type_Bhoo.jdField_a_of_type_AndroidContentContext);
      int j = i;
      if (str != null)
      {
        j = i;
            ...
            for (i = paramRspBody.uint32_intchk_id.get();; i = 0)
            {
              ...
              for (int j = paramRspBody.uint32_check_item_id.get();; j = 0)
              {
                ...
                for (int k = paramRspBody.uint32_check_type.get();; k = 1)
                {
                  ...
                  localObject2 = this.jdField_a_of_type_Bhoo.jdField_a_of_type_Bhol;
                  if (localObject2 == null) {
                    break;
                  }
                  Object localObject1 = paramRspBody.toByteArray();
                  localObject3 = ((bhol)localObject2).getCodec("intchk");
                  paramRspBody = (intchk.RspBody)localObject1;
                  if (localObject3 != null) {
                    paramRspBody = ((bhom)localObject3).encode(localObject1);
                  }
                  ((bhol)localObject2).send(paramRspBody);
                  return;
                }
              }
            }
  ...
  private void c(String paramString)
  {
    ...
    //   71: putfield 29	bhor:c	I
    //   74: aload_0
    //   75: getfield 29	bhor:c	I
    //   78: tableswitch	default:+345 -> 423, 1:+26->104, 2:+161->239, 3:+216->294
    //   105: getfield 359	bhor:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   108: ifnull -96 -> 12
    //   111: aload_0
    //   112: getfield 359	bhor:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   115: iconst_1
    //   116: invokestatic 363	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   119: invokeinterface 369 2 0
    //   124: ifeq +294 -> 418
    //   127: aload_0
    //   128: getfield 359	bhor:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   131: iconst_1
    //   132: invokestatic 363	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   135: invokeinterface 371 2 0
    //   140: checkcast 373	bhos
    //   143: astore_1
    //   144: aload_1
    //   145: ifnull -133 -> 12
    ...
    //   236: goto -29 -> 207
    //   239: aload_0
    //   240: getfield 359	bhor:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   243: ifnull -231 -> 12
    //   246: aload_2
    //   247: astore_1
    //   248: aload_0
    //   249: getfield 359	bhor:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   252: iconst_2
    //   253: invokestatic 363	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   256: invokeinterface 369 2 0
    //   261: ifeq +20 -> 281
    //   264: aload_0
    //   265: getfield 359	bhor:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   268: iconst_2
    //   269: invokestatic 363	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   272: invokeinterface 371 2 0
    //   277: checkcast 373	bhos
    //   280: astore_1
    //   281: aload_1
    //   282: ifnull -270 -> 12
    //   285: aload_1
    ...
    //   293: return
    //   294: aload_0
    //   295: getfield 359	bhor:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   298: ifnull -286 -> 12
    //   301: aload_0
    //   302: getfield 359	bhor:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   305: iconst_3
    //   306: invokestatic 363	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   309: invokeinterface 369 2 0
    //   314: ifeq +99 -> 413
    //   317: aload_0
    //   318: getfield 359	bhor:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   321: iconst_3
    //   322: invokestatic 363	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   325: invokeinterface 371 2 0
    //   330: checkcast 373	bhos
    //   333: astore_1
    //   334: aload_1
    //   335: ifnull -323 -> 12
    //   338: aload_3
  ...
  public void a(int paramInt, bhos parambhos)
  {
    if (parambhos == null) {
      return;
    }
    ...
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(paramInt), parambhos);
  }
  ...
  public void a(Object paramObject1, Object paramObject2)
  {
    ...
    {
      Object localObject = this.jdField_a_of_type_Bhoo.jdField_a_of_type_Bhol;
      if (localObject != null)
      {
        paramObject1 = null;
        localObject = ((bhol)localObject).getCodec("intchk");
        if (localObject != null) {
          paramObject1 = (byte[])((bhom)localObject).decode(paramObject2);
        }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString.has("strike_result"))
        {
          ...
          if (this.jdField_a_of_type_Bhoo != null)
          {
            bhol localbhol = this.jdField_a_of_type_Bhoo.jdField_a_of_type_Bhol;
            if (localbhol != null)
            {
              localObject = paramString.toByteArray();
              bhom localbhom = localbhol.getCodec("intchk");
              paramString = (String)localObject;
              if (localbhom != null) {
                paramString = localbhom.encode(localObject);
              }
              localbhol.send(paramString);
              return;
            }
          }
        }
