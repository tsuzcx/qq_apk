...
public class amll
{
  ...
  private Comparator<CmGamePushItem> jdField_a_of_type_JavaUtilComparator = new amlm(this);
  ...
  private void a(List<CmGamePushItem> paramList)
  {
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 18	amll:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   18: astore_2
    //   19: aload_2
    //   20: monitorenter
    //   21: aload_0
    //   22: getfield 23	amll:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   25: aload_1
    ...
    //   33: monitorexit
    //   34: aload_0
    //   35: getfield 43	amll:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
  ...
  public void a(CmGamePushItem paramCmGamePushItem)
  {
    ...
    if ((localObject1 != null) && (paramCmGamePushItem.msg_type == 1)) {
      ((baif)((QQAppInterface)localObject1).getManager(36)).c(String.valueOf("103100.103200.103240.103248"));
    }
