  ...
  implements Manager, BusinessObserver
{
  ...
  public amll(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if ((aobf.c()) && (!this.jdField_a_of_type_Boolean))
    {
      if (QLog.isColorLevel()) {
        QLog.d("weatherManager", 2, "updateWeatherInfo  from  LocaleManager.isLocaleUpdatedByUser()");
      }
      this.jdField_a_of_type_Boolean = true;
      amln.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramAppActivity);
    }
    Long localLong;
    do
    {
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Amlm.a(paramInt, paramBoolean, paramBundle);
      return;
      label421:
      if (j == 0) {
