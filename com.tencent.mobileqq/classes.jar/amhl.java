    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          amhk.a(this.a, paramIntent.getBooleanExtra("extra_can_add_colornote", true));
        ...
        } while ((amhk.a(this.a) == null) || (??? == null) || (paramIntent == null) || (???.length != paramIntent.length));
        int i = 0;
        while ((paramIntent != null) && (i < paramIntent.length)) {
          try
          {
            ...
            if (j != -1)
            {
              amgr localamgr = (amgr)amhk.a(this.a).get();
              if (localamgr != null) {
                localamgr.onDeleteColorNote(j, paramIntent[i], false);
              }
            }
            i += 1;
          }
      ...
      } while ((!???.equals("key_after_sync_msg")) || (amhk.b(this.a) == null));
      ??? = (amkh)amhk.b(this.a).get();
    } while (??? == null);
