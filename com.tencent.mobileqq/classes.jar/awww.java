...
public class awww
{
  ...
  private Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new awwx(this);
  ...
  public awww(View paramView)
  {
    if (paramView != null)
    {
      this.jdField_a_of_type_AndroidViewView = paramView;
      this.jdField_a_of_type_Int = bdaq.a(this.jdField_a_of_type_AndroidViewView.getContext(), 15.0F);
