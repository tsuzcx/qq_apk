...
public class bgoa
{
  ...
  public static bgob a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    bgob localbgob = new bgob();
    localbgob.jdField_a_of_type_JavaLangString = a(paramString);
    String str;
    if (!localSharedPreferences.getBoolean("guideEnable", false))
    {
      ...
      localbgob.jdField_a_of_type_Int = 4;
      switch (localbgob.jdField_a_of_type_Int)
      {
      case 3: 
      default: 
        str = "P3";
    ...
    for (;;)
    {
      ...
      if (localSharedPreferences.getInt("guideToastOpen", 0) == 1)
      {
        ...
        for (;;)
        {
          ...
          localbgob.jdField_a_of_type_Int = 1;
          break;
          label258:
      ...
      if (localSharedPreferences.getInt("guidePopupOpen", 0) == 1)
      {
        ...
        if ((i == 0) || (i == 1))
        {
          ...
          {
            localbgob.jdField_a_of_type_Int = 3;
          ...
          for (str = "lastTipTime_";; str = "lastDialogTime_")
          {
            ...
            if (localbgob.jdField_a_of_type_Int == 4) {
              break;
            }
            localSharedPreferences.edit().putLong(str, l).commit();
            break;
            localbgob.jdField_a_of_type_Int = 2;
            break label365;
          }
        }
        localbgob.jdField_a_of_type_Int = 4;
  ...
  public static void a(TrafficResultInfo paramTrafficResultInfo, Bundle paramBundle)
  {
    ...
    boolean bool1 = paramBundle.getBoolean(aneg.i);
    boolean bool3 = paramBundle.getBoolean(aneg.j);
    String str2 = paramBundle.getString(aneg.k);
    String str1 = paramBundle.getString(aneg.l);
  ...
  public static boolean a(Activity paramActivity, int paramInt, bgoc parambgoc, String paramString)
  {
    boolean bool = true;
    ...
    {
      return bool;
      localbgob = a(paramString, false, true);
      if (QLog.isColorLevel()) {
        QLog.i("CUKingCardHelper", 2, "shouldOverrideDialog, popUpType: " + localbgob.jdField_a_of_type_Int);
      }
    } while (localbgob.jdField_a_of_type_Int == 4);
    if (localbgob.jdField_a_of_type_Int == 1)
    {
      if (parambgoc != null) {
        parambgoc.callback(2);
      }
      return false;
    }
    new bgnz(paramActivity, parambgoc, paramInt, paramString, localbgob.jdField_a_of_type_Int).show();
    return false;
  }
