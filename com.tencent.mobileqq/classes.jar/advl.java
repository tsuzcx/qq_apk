  ...
  extends actm
{
  ...
  public advl(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new advm(this);
  }
  
  protected actn a()
  {
    return new advn(this);
  }
  ...
  protected View a(MessageRecord paramMessageRecord, actn paramactn, View paramView, LinearLayout paramLinearLayout, acxj paramacxj)
  {
    ...
    paramMessageRecord = (advn)paramactn;
    Object localObject3 = localPAMessage.items;
    paramactn = (ViewGroup)paramLinearLayout.findViewById(2131371206);
    ...
    for (int i = ((List)localObject1).size();; i = 0)
    {
      ...
      paramactn.setTag(paramMessageRecord);
