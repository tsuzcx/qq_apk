...
class ayqj
{
  ...
  {
    if (!ayqh.a(this.jdField_a_of_type_Ayqh).a()) {}
    for (int i = 2;; i = 5)
    {
      if (paramArrayOfInt != null)
      {
  ...
  FileStorageServerListInfo a()
  {
    ...
    ArrayList localArrayList = ayqh.c(this.jdField_a_of_type_Ayqh, 16);
    ...
    if (localArrayList != null)
    {
      ...
      if (localArrayList.size() > 0)
      {
        int i = b(ayqh.a(this.jdField_a_of_type_Ayqh).a(ayqh.a(this.jdField_a_of_type_Ayqh).b()));
        localObject1 = localObject2;
        if (i > -1)
        {
          localObject1 = localObject2;
  ...
  {
    Object localObject2 = null;
    ArrayList localArrayList = ayqh.c(this.jdField_a_of_type_Ayqh, paramInt);
    Object localObject1 = localObject2;
    if (localArrayList != null)
    {
      localObject1 = localObject2;
  ...
  void a(FileStoragePushFSSvcList paramFileStoragePushFSSvcList)
  {
    ...
    if (paramFileStoragePushFSSvcList != null)
    {
      ...
      if (i <= 10)
      {
        paramFileStoragePushFSSvcList = ayqh.a(this.jdField_a_of_type_Ayqh, ayqh.a(this.jdField_a_of_type_Ayqh, i));
        if (paramFileStoragePushFSSvcList != null) {}
      ...
      if (i <= 15)
      {
        paramFileStoragePushFSSvcList = ayqh.b(this.jdField_a_of_type_Ayqh, ayqh.b(this.jdField_a_of_type_Ayqh, i));
        if (paramFileStoragePushFSSvcList != null) {}
        for (j = paramFileStoragePushFSSvcList.size();; j = 0)
        {
          this.jdField_a_of_type_Array2dOfInt[i] = new int[j];
      ...
      paramFileStoragePushFSSvcList = ayqh.b(this.jdField_a_of_type_Ayqh, ayqh.b(this.jdField_a_of_type_Ayqh, 17));
      i = k;
      if (paramFileStoragePushFSSvcList != null) {
    ...
    ayqh.a(this.jdField_a_of_type_Ayqh).a();
  }
