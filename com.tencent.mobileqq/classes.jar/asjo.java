...
public class asjo
{
  ...
  private Map<Integer, asjq> jdField_a_of_type_JavaUtilMap;
  private AtomicInteger jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger;
  
  public asjo(Activity paramActivity)
  {
  ...
  public int a(String paramString1, String paramString2)
  {
    ...
    localasjq.jdField_a_of_type_JavaLangString = paramString1;
    localasjq.b = paramString2;
    localasjq.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
    if (this.jdField_a_of_type_JavaUtilMap != null) {
      this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(this.jdField_a_of_type_Int), localasjq);
    }
    if (QLog.isColorLevel()) {
  ...
  public boolean a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilMap != null)
    {
      if ((asjq)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt)) != null) {}
  ...
  void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidAppProgressDialog.setOnDismissListener(new asjp(this));
