...
public class uhv
{
  ...
  public static int b;
  public static final Map<Long, Map<Long, uia>> b;
  ...
  public static String a()
  {
    ...
    try
    {
      ...
      localJSONObject.put("channel_id", ozh.b());
  ...
  public static String a(Context paramContext, long paramLong1, long paramLong2, int paramInt1, int paramInt2, String paramString1, String paramString2, int paramInt3, String paramString3)
  {
    try
    {
      ...
      for (;;)
      {
        if (pcl.c(paramInt2))
        {
          paramLong1 = ((Long)bkwm.a("readinjoy_daily_article_first_exposure_" + paramLong1, Long.valueOf(0L))).longValue();
          if (paramLong1 != 0L) {
            localJSONObject.put("daily_article_first_timestamp", paramLong1 + "");
          }
        }
        ofe.a(localJSONObject);
        return localJSONObject.toString();
  ...
  public static Map<Long, uia> a(int paramInt)
  {
  ...
  public static Map<Long, uia> a(long paramLong)
  {
  ...
  public static JSONObject a(BaseArticleInfo paramBaseArticleInfo, int paramInt, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      label171:
      for (long l = paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rer.jdField_a_of_type_Long;; l = 0L)
      {
  ...
  public static pbg a(TemplateBean paramTemplateBean, String paramString)
  {
    ...
    if (paramTemplateBean != null)
    {
      ...
      if ((paramTemplateBean != null) && (paramTemplateBean.entrySet() != null))
      {
        ...
        while ((paramTemplateBean != null) && (paramTemplateBean.hasNext()))
        {
          ...
          localpbg.b((String)paramString.getKey(), paramString.getValue().toString());
        }
      }
    }
    return localpbg;
  ...
  public static void a()
  {
    ...
    localAttributeList.att_value.set(pay.d + "");
    localArrayList.add(localAttributeList);
    ugf.a(10, localArrayList);
    if (QLog.isColorLevel()) {
      QLog.d("ReadinjoyReportUtils", 2, "reportKandianDelete  , foldStatus :  " + pay.d);
    }
  }
  ...
  public static void a(int paramInt1, int paramInt2, long paramLong, HashMap<String, Object> paramHashMap)
  {
    ...
    if (paramHashMap != null)
    {
      ...
      while (paramHashMap.hasNext())
      {
        ...
        if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty((CharSequence)localObject))) {
          localpbg.b(str, (String)localObject);
        }
      }
    }
    paramHashMap = localpbg.a();
    ...
    odq.a(null, "", "0X800ACB9", "0X800ACB9", paramInt2, 0, String.valueOf(paramInt1), String.valueOf(paramLong), "", paramHashMap, false);
  }
  ...
  public static void a(int paramInt, String paramString1, String paramString2, Resources paramResources)
  {
    ...
    {
      if (!bftf.a(paramString2, paramResources.getString(akll.a[3]))) {
        break label57;
      }
      odq.a(null, null, "0X8009884", "0X8009884", 0, 0, "", "", "", a(), false);
    }
    label57:
    while (!bftf.a(paramString2, paramResources.getString(akll.a[2]))) {
      return;
    }
    odq.a(null, null, "0X8009885", "0X8009885", 0, 0, "", "", "", a(), false);
  }
  ...
  {
    ArrayList localArrayList = new ArrayList();
    ple.a().jdField_a_of_type_Plt.a(paramBoolean1);
    long l;
    if (paramBoolean1)
    {
      ple.n();
      ...
      if (paramInt1 == 0)
      {
        ...
        if (pay.d != 1)
        {
          ...
          ((oidb_cmd0x80a.AttributeList)localObject).att_value.set(pay.a.b);
          localArrayList.add(localObject);
          localObject = new oidb_cmd0x80a.AttributeList();
          ((oidb_cmd0x80a.AttributeList)localObject).att_id.set(4);
          ((oidb_cmd0x80a.AttributeList)localObject).att_name.set("AlgorithmID");
          ((oidb_cmd0x80a.AttributeList)localObject).att_value.set(pay.a.jdField_a_of_type_JavaLangString);
          localArrayList.add(localObject);
          paramLong = NetConnInfoCenter.getServerTime();
          l = pay.a.jdField_a_of_type_Long;
          localObject = new oidb_cmd0x80a.AttributeList();
      ...
      label483:
      for (paramLong = System.currentTimeMillis() - ple.a().d();; paramLong = System.currentTimeMillis() - ple.jdField_a_of_type_Long)
      {
        ((oidb_cmd0x80a.AttributeList)localObject).att_value.set(paramLong + "");
        localArrayList.add(localObject);
        paramInt2 = 4;
        ugf.a(paramInt2, localArrayList);
        if (QLog.isColorLevel()) {
    ...
    ((oidb_cmd0x80a.AttributeList)localObject).att_value.set(String.valueOf(ple.a(paramLong)));
    localArrayList.add(localObject);
    localObject = new oidb_cmd0x80a.AttributeList();
    ((oidb_cmd0x80a.AttributeList)localObject).att_id.set(4);
    ...
    localArrayList.add(localObject);
    if (pay.a.jdField_a_of_type_Int != 1)
    {
      localObject = new oidb_cmd0x80a.AttributeList();
      ((oidb_cmd0x80a.AttributeList)localObject).att_id.set(5);
      ((oidb_cmd0x80a.AttributeList)localObject).att_name.set("StrategyID");
    ...
    if (((plt)localObject).jdField_a_of_type_Long > 0L)
    {
      paramLong = ((plt)localObject).jdField_a_of_type_Long - ((plt)localObject).d;
      label971:
      ...
      if (((plt)localObject).c <= 0L) {
        break label1206;
      }
    }
    label1206:
    for (paramLong = ((plt)localObject).e - ((plt)localObject).c;; paramLong = 0L)
    {
      localAttributeList.att_value.set(paramLong + "");
      localArrayList.add(localAttributeList);
      localAttributeList = new oidb_cmd0x80a.AttributeList();
      ...
      localAttributeList.att_value.set(((plt)localObject).a());
      localArrayList.add(localAttributeList);
      localAttributeList = new oidb_cmd0x80a.AttributeList();
      localAttributeList.att_id.set(11);
      localAttributeList.att_name.set("scrollInfoList");
      localAttributeList.att_value.set(((plt)localObject).b());
      localArrayList.add(localAttributeList);
      paramInt2 = 5;
      break;
      paramLong = 0L;
  ...
  public static void a(ArticleInfo paramArticleInfo)
  {
    ...
    if ((pgb.g(paramArticleInfo)) || (pgb.i(paramArticleInfo)) || (pgb.j(paramArticleInfo)) || (pgb.k(paramArticleInfo)))
    {
      ...
      if (paramArticleInfo.mSocialFeedInfo != null)
      {
        ...
        if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj != null) {
          localObject1 = Long.toString(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfj.jdField_a_of_type_Long);
        }
      }
    }
    for (;;)
    {
      ...
      int j = pay.b(paramArticleInfo);
      localObject2 = new JSONObject();
      try
      {
        pay.a((JSONObject)localObject2, paramArticleInfo);
        ((JSONObject)localObject2).put("touin", localObject1);
        ((JSONObject)localObject2).put("entry_mode", String.valueOf(j));
        odq.a(null, "", "0X8009846", "0X8009846", 0, 0, String.valueOf(l1), String.valueOf(l2), String.valueOf(l3), ((JSONObject)localObject2).toString(), false);
        return;
  ...
  public static void a(ArticleInfo paramArticleInfo, int paramInt, boolean paramBoolean)
  {
    ...
    try
    {
      if (qfj.a(paramArticleInfo)) {}
      for (paramInt = 2;; paramInt = 1)
      {
        localJSONObject.put("click_type", paramInt);
        odq.a(null, null, "0X800B1A7", "0X800B1A7", 0, 0, "", "", "", localJSONObject.toString(), false);
        return;
      }
      return;
    }
  ...
  public static void a(BaseArticleInfo paramBaseArticleInfo, int paramInt, boolean paramBoolean)
  {
    if ((paramBaseArticleInfo != null) && (paramBaseArticleInfo.bindShowFollowButton)) {
      odq.a(null, null, "0X800B1A6", "0X800B1A6", 0, 0, "", "", "", a(paramBaseArticleInfo, paramInt, paramBoolean).toString(), false);
    }
  }
  
  public static void a(BaseArticleInfo paramBaseArticleInfo, long paramLong)
  {
    if (((Long)bkwm.a("readinjoy_daily_article_first_exposure_" + paramBaseArticleInfo.mArticleID, Long.valueOf(0L))).longValue() == 0L) {
      bkwm.a("readinjoy_daily_article_first_exposure_" + paramBaseArticleInfo.mArticleID, Long.valueOf(System.currentTimeMillis() / 1000L));
    }
    synchronized (jdField_b_of_type_JavaUtilMap)
    {
      Map localMap2 = a(paramBaseArticleInfo.mChannelID);
      uia localuia = (uia)localMap2.get(Long.valueOf(paramBaseArticleInfo.mArticleID));
      if (localuia != null)
      {
        long l = paramLong;
        if (localuia.jdField_a_of_type_Long > paramLong) {
          l = localuia.jdField_a_of_type_Long;
        }
        localuia.jdField_a_of_type_Long = l;
        return;
      }
      localuia = new uia(pay.d());
      localuia.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructBaseArticleInfo = paramBaseArticleInfo;
      localuia.jdField_a_of_type_Long = paramLong;
      localMap2.put(Long.valueOf(paramBaseArticleInfo.mArticleID), localuia);
    }
  }
  ...
  public static void a(TemplateBean paramTemplateBean, String paramString1, String paramString2)
  {
    ...
    {
      return;
      localpbg = a(paramTemplateBean, paramString1);
      paramTemplateBean = a(paramTemplateBean, paramString1, paramString2);
    } while (paramTemplateBean == null);
    odq.a(null, "CliOper", "", "", paramTemplateBean, paramTemplateBean, 0, 0, "", "", "", localpbg.a(), false);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          odq.a(null, paramQQAppInterface, (String)localObject, (String)localObject, 0, 0, "", "", "", localpbg.a(), false);
          return;
        }
      }
  ...
  public static void a(String paramString)
  {
    ...
    {
      odq.a(null, null, "0X800978D", "0X800978D", 0, 0, "", "", "", a(), false);
      ple.l();
    }
    while (!AppConstants.KANDIAN_DAILY_UIN.equals(paramString)) {
      return;
    }
    odq.a(null, null, "0X8009886", "0X8009886", 0, 0, "", "", "", a(), false);
    ple.m();
  }
  ...
  public static void a(List<ArticleInfo> paramList)
  {
    ...
    do
    {
      ...
      Collections.sort(paramList, new uhy());
  ...
  public static void a(List<ArticleInfo> paramList, List<Long> paramList1, boolean paramBoolean)
  {
    ...
    Collections.sort(paramList, new uhx());
