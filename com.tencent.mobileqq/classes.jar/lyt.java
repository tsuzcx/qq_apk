...
class lyt
  extends lgh<ReqGroupVideo.ReqCreateShareUrl, ReqGroupVideo.RspCreateShareUrl>
{
  lyt(lyr paramlyr) {}
  ...
  public void a(long paramLong, boolean paramBoolean, ReqGroupVideo.ReqCreateShareUrl paramReqCreateShareUrl, ReqGroupVideo.RspCreateShareUrl paramRspCreateShareUrl, Object paramObject)
  {
    ...
    int i = lge.a(paramRspCreateShareUrl);
    ...
    if (i == 0)
    {
      ...
      bhoj.a().a(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.a.b, this.a.c);
    }
    for (;;)
    {
