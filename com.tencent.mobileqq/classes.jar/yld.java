...
public class yld
{
  private static yld jdField_a_of_type_Yld;
  private Context jdField_a_of_type_AndroidContentContext;
  private Map<String, List<yle>> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  
  public yld(Context paramContext)
  {
  ...
  public static yld a(Context paramContext)
  {
    if (jdField_a_of_type_Yld == null) {}
    try
    {
      if (jdField_a_of_type_Yld == null) {
        jdField_a_of_type_Yld = new yld(paramContext);
      }
  ...
  {
    paramContext = (aqcx)apub.a().a(362);
    if (paramContext != null) {}
      ...
      if (!TextUtils.isEmpty(paramContext))
      {
        ...
        try
        {
          ...
          while (i < paramContext.length())
          {
            ...
            {
              yle localyle = new yle();
              JSONObject localJSONObject = ((JSONArray)localObject).getJSONObject(j);
              localyle.a = Integer.parseInt(localJSONObject.getString("tagId"));
              localyle.b = Integer.parseInt(localJSONObject.getString("itemId"));
              localArrayList.add(localyle);
              j += 1;
            }
  ...
  public List<yle> a(String paramString)
  {
    if (this.jdField_a_of_type_JavaUtilMap.size() == 0) {
      a(this.jdField_a_of_type_AndroidContentContext);
    }
