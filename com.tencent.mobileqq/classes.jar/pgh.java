  ...
  implements blih
{
  ...
  private HashMap<Long, pft> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private pgc jdField_b_of_type_Pgc;
  private int jdField_c_of_type_Int;
  public long c;
  private ArrayList<pgg> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  private int d;
  public long d;
  private int e;
  public long e;
  ...
  private pgc a(AbsListView paramAbsListView)
  {
    ...
    paramAbsListView = new pgc(this.jdField_a_of_type_Pfs, null);
    ...
    for (long l = System.currentTimeMillis() - this.jdField_d_of_type_Long;; l = System.currentTimeMillis() - this.jdField_a_of_type_Pgc.jdField_a_of_type_Long)
    {
      paramAbsListView.jdField_b_of_type_Long = l;
      this.jdField_a_of_type_Pgc = paramAbsListView;
      QLog.d("ReadinjoySPEventReport", 2, new Object[] { paramAbsListView });
      return paramAbsListView;
    }
  }
  
  private pgg a(AbsListView paramAbsListView)
  {
    pgg localpgg = new pgg();
    localpgg.jdField_e_of_type_Int = this.jdField_b_of_type_Int;
    localpgg.f = this.jdField_c_of_type_Int;
    if (this.jdField_d_of_type_Int - this.f > 0) {}
    for (int i = this.jdField_d_of_type_Int - this.f;; i = 0)
    {
      localpgg.g = i;
      localpgg.jdField_a_of_type_Int = this.jdField_e_of_type_Int;
      localpgg.jdField_a_of_type_Long = (this.jdField_c_of_type_Long - this.jdField_b_of_type_Long);
      localpgg.h = this.f;
      localpgg.i = paramAbsListView.getWidth();
      localpgg.jdField_a_of_type_ArrayOfFloat = ((float[])((ReadInJoyXListView)paramAbsListView).jdField_a_of_type_ArrayOfFloat.clone());
      localpgg.b = ((float[])((ReadInJoyXListView)paramAbsListView).b.clone());
      return localpgg;
    }
  }
  ...
  public String a()
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      localStringBuilder.append((pft)((Iterator)localObject).next()).append("|");
    }
  ...
  public void a(int paramInt, AbsListView paramAbsListView)
  {
    ...
    //   44: ifle +14 -> 58
    //   47: aload_0
    //   48: getfield 138	pgh:jdField_d_of_type_Long	J
    //   51: lstore_3
    //   52: lload_3
    //   53: lconst_0
    //   54: lcmp
    ...
    //   60: return
    //   61: aload_0
    //   62: getfield 46	pgh:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   65: invokevirtual 265	java/util/ArrayList:size	()I
    //   68: ifle +12 -> 80
    //   71: aload_0
    //   72: getfield 266	pgh:jdField_a_of_type_Int	I
    //   75: iload_1
    //   76: iand
    //   77: ifne -19 -> 58
    //   80: iload_1
    ...
    //   83: ifeq +15 -> 98
    //   86: aload_0
    //   87: getfield 268	pgh:jdField_a_of_type_Boolean	Z
    //   90: ifeq -32 -> 58
    //   93: aload_0
    //   94: iconst_0
    //   95: putfield 268	pgh:jdField_a_of_type_Boolean	Z
    //   98: aload_0
    //   99: aload_0
    //   100: getfield 266	pgh:jdField_a_of_type_Int	I
    //   103: iload_1
    //   104: ior
    //   105: putfield 266	pgh:jdField_a_of_type_Int	I
    //   108: aload_0
    //   109: aload_2
    //   110: invokespecial 270	pgh:a	(Lcom/tencent/widget/AbsListView;)Lpgc;
    //   113: astore_2
    //   114: aload_2
    //   115: ifnull -57 -> 58
    //   118: aload_0
    //   119: aload_2
    //   120: invokevirtual 273	pgh:a	(Lpgc;)V
    //   123: aload_0
    //   124: aload_2
    //   125: invokevirtual 276	pgc:a	()Ljava/util/ArrayList;
    //   128: putfield 46	pgh:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   131: ldc 142
    //   133: iconst_2
    //   134: iconst_1
  ...
  public void a(pgc parampgc)
  {
    if ((parampgc == null) || (this.jdField_d_of_type_Long == 0L)) {
      return;
    }
    Iterator localIterator = parampgc.jdField_a_of_type_JavaUtilArrayList.iterator();
    label23:
    Object localObject;
    long l1;
    float f1;
    ...
    if (localIterator.hasNext())
    {
      ...
      l1 = parampgc.jdField_b_of_type_Long;
      f1 = ((Float)((Pair)localObject).second).floatValue();
      pft localpft = (pft)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(localBaseArticleInfo.mArticleID));
      localObject = localpft;
      if (localpft == null)
      {
        localObject = new pft(this.jdField_a_of_type_Pfs, null);
        ((pft)localObject).jdField_a_of_type_Long = localBaseArticleInfo.mRecommendSeq;
        ((pft)localObject).jdField_b_of_type_Long = localBaseArticleInfo.mArticleID;
        ((pft)localObject).jdField_a_of_type_JavaLangString = localBaseArticleInfo.mTitle;
        this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(localBaseArticleInfo.mArticleID), localObject);
      }
      l2 = ((pft)localObject).jdField_c_of_type_Long;
      if (f1 <= 0.8F) {
        break label204;
      }
    }
    for (;;)
    {
      ((pft)localObject).jdField_c_of_type_Long = (l1 + l2);
      ((pft)localObject).jdField_a_of_type_Float = Math.max(((pft)localObject).jdField_a_of_type_Float, f1);
      break label23;
      break;
      label204:
      l1 = 0L;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Pgc != null)
    {
      localArrayList1 = this.jdField_a_of_type_Pgc.a();
      if (this.jdField_b_of_type_Pgc == null) {
        break label267;
      }
      localArrayList2 = this.jdField_b_of_type_Pgc.a();
      ...
      do
      {
        ...
        localpft = (pft)this.jdField_a_of_type_JavaUtilHashMap.get(localLong);
      } while (localpft == null);
      localpft.jdField_a_of_type_Int = 1;
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(localLong)) {
        break label273;
      }
    }
    for (localpft.jdField_a_of_type_Int = 0;; localpft.jdField_a_of_type_Int = 2) {
      label267:
      label273:
      do
      {
        if (this.jdField_b_of_type_JavaUtilArrayList.contains(localLong)) {
          localpft.jdField_a_of_type_Boolean = true;
        }
        if ((localArrayList2 != null) && (localArrayList2.contains(localLong))) {
          localpft.jdField_b_of_type_Boolean = true;
        }
        if (this.jdField_b_of_type_JavaUtilHashMap.containsKey(localLong)) {
          localpft.jdField_b_of_type_JavaLangString = String.format("%.2f", new Object[] { this.jdField_b_of_type_JavaUtilHashMap.get(localLong) });
        }
        localStringBuilder.append(localpft.toString()).append("\n");
        break label96;
    ...
    this.jdField_a_of_type_Pfs.b = this;
    this.jdField_a_of_type_Pfs.a = new pgh(this.jdField_a_of_type_Pfs);
  }
  ...
  public String b()
  {
    ...
    {
      localStringBuilder.append(((pgg)this.jdField_c_of_type_JavaUtilArrayList.get(i)).a()).append("|");
      i += 1;
    }
    if (localStringBuilder.length() == 0) {
      return "nil";
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    case 0: 
      ...
      localpgg = a(paramAbsListView);
      this.jdField_c_of_type_JavaUtilArrayList.add(localpgg);
      this.jdField_a_of_type_Pgc = a(paramAbsListView);
    ...
    case 1: 
      while ((paramInt <= i) && (paramInt < paramAbsListView.getCount()))
      {
        ...
        this.jdField_a_of_type_Pgc = a(paramAbsListView);
        this.jdField_b_of_type_Pgc = this.jdField_a_of_type_Pgc;
        a(this.jdField_a_of_type_Pgc);
        return;
      }
      QLog.d("ReadinjoySPEventReport", 2, "one scroll " + localpgg.a());
      return;
    }
    this.jdField_a_of_type_Pgc = a(paramAbsListView);
    a(this.jdField_a_of_type_Pgc);
