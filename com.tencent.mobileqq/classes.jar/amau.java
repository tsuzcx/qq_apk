  ...
  extends BaseAdapter
{
  ...
  public amau(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
  }
  
  private amaw a(String paramString, Context paramContext)
  {
    int i = 0;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        int i = Color.parseColor(((amaw)localObject).a);
        int j = Color.parseColor(((amaw)localObject).b);
      ...
      return localView;
      localObject = (amax)paramView.getTag();
      localView = paramView;
