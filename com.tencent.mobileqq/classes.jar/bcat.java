...
public class bcat
{
  ...
  {
    if (((!bcas.jdField_a_of_type_Boolean) && (bcas.a(???))) || ((!bcas.jdField_b_of_type_Boolean) && (bcas.b(???)))) {}
    label182:
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        try
        {
          ...
          bcas.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPluginEngine = WebAccelerateHelper.getInstance().createWebViewPluginEngine(???, null, null, a());
        }
        catch (Exception ???)
        {
          long l1;
        ...
        synchronized (bcas.jdField_a_of_type_JavaLangObject)
        {
          bcas.jdField_a_of_type_JavaLangObject.notifyAll();
          bcas.jdField_a_of_type_Boolean = true;
        ...
        if (bcas.b(???))
        {
          bcas.jdField_b_of_type_ComTencentMobileqqWebviewSwiftWebViewPluginEngine = WebAccelerateHelper.getInstance().createWebViewPluginEngine(???, null, null, a());
          bcas.jdField_b_of_type_Boolean = true;
        }
      }
    }
