...
public class afoo
{
  public static void a(akoj paramakoj, MessageRecord paramMessageRecord, QQMessageFacade paramQQMessageFacade, QQAppInterface paramQQAppInterface)
  {
    if ((paramakoj == null) || (paramMessageRecord == null) || (paramQQMessageFacade == null) || (paramQQAppInterface == null)) {}
    Object localObject;
    int k;
    int i;
    do
    {
      ...
      k = aydd.a().b(paramQQAppInterface);
      if (k <= 0) {
        break;
      }
      int j = 0;
    ...
    try
    {
      paramakoj.a((QQMessageFacade.Message)localObject);
      paramQQMessageFacade.a().unReadNum = k;
      return;
    }
    catch (Throwable paramakoj)
    {
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.d("TroopSuspiciousHelper", 2, "add GroupSuspiciousMsg ERROR", paramakoj);
        }
      }
    }
  ...
  public static void a(akqw paramakqw, QQAppInterface paramQQAppInterface, structmsg.RspNextSystemMsg paramRspNextSystemMsg, String paramString)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        ...
        localMessageRecord.frienduin = ajsd.O;
    ...
    localObject = (asks)paramQQAppInterface.getManager(37);
    boolean bool;
    if (localArrayList.size() > 0)
    {
      if ((localArrayList.size() < 20) && (localObject != null)) {
        ((asks)localObject).b(true);
      }
      ...
      if ((akas.a(localArrayList)) && (paramQQAppInterface.isBackground_Stop))
      {
        bool = true;
    ...
    for (;;)
    {
      paramakqw.a(4019, true, localArrayList);
      return;
      bool = false;
      break;
      if (localObject != null) {
  ...
  public static void a(akqw paramakqw, QQAppInterface paramQQAppInterface, structmsg.RspSystemMsgNew paramRspSystemMsgNew, List<structmsg.StructMsg> paramList, int paramInt, String paramString)
  {
    ...
    aydd.a().b(paramQQAppInterface, paramInt);
    paramRspSystemMsgNew = new ArrayList();
    int i = paramList.size();
    Object localObject = (asks)paramQQAppInterface.getManager(37);
    if (localObject != null) {
      ((asks)localObject).b(false);
    }
    Collections.sort(paramList, new afop());
    paramInt = 0;
    if (paramInt < i)
    {
      localObject = axas.a(-2018);
      ((MessageRecord)localObject).msgtype = -2018;
      ((MessageRecord)localObject).selfuin = paramString;
      ((MessageRecord)localObject).frienduin = ajsd.O;
    ...
    paramQQAppInterface.a().a(ajsd.O, 0);
    if (paramRspSystemMsgNew.size() > 0)
    {
      paramList = paramQQAppInterface.a();
      paramString = String.valueOf(paramString);
      if ((!akas.a(paramRspSystemMsgNew)) || (!paramQQAppInterface.isBackground_Stop)) {
        break label568;
      }
    }
    label568:
    for (boolean bool = true;; bool = false)
    {
      ...
      paramakqw.a(4019, true, paramRspSystemMsgNew);
      return;
    }
  }
  ...
  public static void a(structmsg.StructMsg paramStructMsg, String paramString)
  {
    ...
    {
      bbbp.a("Grp_contacts_news", "notice", paramString, 0, 0, new String[] { str1, str2, paramStructMsg });
      return;
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    List localList = paramQQAppInterface.a().b(ajsd.O, 0);
