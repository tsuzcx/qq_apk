...
{
  public static final pdg a;
  @Nullable
  private Function1<? super String, Unit> jdField_a_of_type_KotlinJvmFunctionsFunction1;
  @NotNull
  private final pds jdField_a_of_type_Pds;
  @Nullable
  private Function1<? super Boolean, Unit> b;
  
  static
  {
    jdField_a_of_type_Pdg = new pdg(null);
  }
  
  public pdf(@NotNull pds parampds)
  {
    this.jdField_a_of_type_Pds = parampds;
  }
  ...
  public final oidb_0xd1e.ReqBody a()
  {
    ...
    pds localpds = this.jdField_a_of_type_Pds;
    localAuthorCommentDeleteReq.article_id.set(localpds.a().c());
    localAuthorCommentDeleteReq.comment_type.set(localpds.a());
    localAuthorCommentDeleteReq.content_src.set(localpds.a().d());
    localAuthorCommentDeleteReq.first_comment_id.set(localpds.a());
    localAuthorCommentDeleteReq.sub_comment_id.set(localpds.b());
    localAuthorCommentDeleteReq.src.set(localpds.a().c());
    localAuthorCommentDeleteReq.business_info.set(localpds.a().d());
  ...
  public final void a()
  {
    ...
    nir.a(pha.a(), (niv)new pdh(this), localReqBody.toByteArray(), "OidbSvc.0xd1e", 3358, 9);
  }
