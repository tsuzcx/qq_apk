...
public class bfne
{
  public static String a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramString1 = FileUtils.fileToBytes(new File(new File(BaseApplicationImpl.getApplication().getFilesDir(), "upgrade_config"), paramString1 + paramString2));
  ...
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      ...
      FileUtils.writeFile(localFile.getAbsolutePath() + "/", paramString1 + paramString2, paramString3);
