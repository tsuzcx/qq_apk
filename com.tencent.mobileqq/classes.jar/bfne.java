...
public class bfne
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bfne.class.getName();
  }
  
  public bfne()
  {
    this.jdField_a_of_type_Bfnf = new bfnf(this, bfbm.a().a(), "agent_cgi_report.db", null, 4);
  }
  
  /* Error */
  private ArrayList<bfnh> a(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: ldc 44
    //   4: ldc 46
    //   6: invokestatic 52	bflp:b	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   18: aload_0
    //   19: aload_0
    //   20: getfield 39	bfne:jdField_a_of_type_Bfnf	Lbfnf;
    //   23: invokevirtual 59	bfnf:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   26: putfield 61	bfne:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   29: aconst_null
    //   30: astore 4
    //   32: aload_0
    //   33: getfield 61	bfne:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    ...
    //   278: aload 12
    //   280: aload_2
    //   281: invokespecial 129	bfnh:<init>	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   302: aload 4
    //   304: astore_3
    //   305: getstatic 18	bfne:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   332: aload_3
    //   333: invokestatic 143	bflp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   336: aload_2
    //   337: ifnull +9 -> 346
    //   340: aload_2
    //   341: invokeinterface 146 1 0
    //   346: aload_0
    //   347: getfield 61	bfne:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    ...
    //   387: invokestatic 52	bflp:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   390: aload_0
    //   391: monitorexit
    //   392: aload 5
    //   394: areturn
    //   395: astore_1
    //   396: getstatic 18	bfne:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   399: ldc 158
    //   401: aload_1
    //   402: invokestatic 143	bflp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   405: goto -15 -> 390
    //   408: aload_3
    //   409: ifnull -63 -> 346
    //   412: aload_3
  ...
  public int a(String paramString)
  {
    try
    {
      ...
      bflp.b(jdField_a_of_type_JavaLangString, "new_table>>count=" + i);
      i += a("olddata_report", paramString);
      bflp.b(jdField_a_of_type_JavaLangString, "all_table>>>count=" + i);
      return i;
    }
    finally
    {
  ...
  public int a(String paramString1, String paramString2)
  {
    ...
    //   29: aload_0
    //   30: aload_0
    //   31: getfield 39	bfne:jdField_a_of_type_Bfnf	Lbfnf;
    //   34: invokevirtual 59	bfnf:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   37: putfield 61	bfne:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   40: aload_0
    //   41: getfield 61	bfne:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   44: aload_1
    //   45: aconst_null
    //   46: aload 5
    //   48: aload_2
    ...
    //   101: athrow
    //   102: astore_1
    //   103: getstatic 18	bfne:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   106: ldc 158
    //   108: aload_1
    //   109: invokestatic 143	bflp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   112: iconst_0
    //   113: istore_3
    //   114: goto -45 -> 69
    //   117: astore_1
    //   118: getstatic 18	bfne:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   121: aload_1
    //   122: invokevirtual 189	java/lang/Exception:getLocalizedMessage	()Ljava/lang/String;
    //   125: aload_1
    //   126: invokestatic 192	bflp:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   129: iconst_0
    //   130: istore_3
    //   131: goto -62 -> 69
    // Local variable table:
  ...
  public int a(ArrayList<bfnh> paramArrayList)
  {
    int i;
    try
    {
      bflp.b("cgi_report_debug", "ReportDataModal backupOldItems count = " + paramArrayList.size());
      ...
      for (;;)
      {
        ...
        {
          bfnh localbfnh = (bfnh)paramArrayList.next();
          ContentValues localContentValues = new ContentValues();
          localContentValues.put("apn", localbfnh.jdField_a_of_type_JavaLangString);
          localContentValues.put("frequency", localbfnh.b);
          localContentValues.put("commandid", localbfnh.c);
          localContentValues.put("resultcode", localbfnh.d);
          localContentValues.put("tmcost", localbfnh.e);
          localContentValues.put("reqsize", localbfnh.f);
          localContentValues.put("rspsize", localbfnh.g);
          localContentValues.put("touin", localbfnh.h);
          localContentValues.put("deviceinfo", localbfnh.i);
          localContentValues.put("detail", localbfnh.j);
          localContentValues.put("appid", localbfnh.k);
          try
          {
            this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase = this.jdField_a_of_type_Bfnf.getWritableDatabase();
          ...
          catch (Exception localException)
          {
            for (;;)
            {
              bflp.c(jdField_a_of_type_JavaLangString, "update>>>", localException);
            }
          }
        }
      }
      bflp.b("cgi_report_debug", "ReportDataModal backupOldItems succ_count = " + i);
    }
    finally {}
    return i;
  }
  
  public ArrayList<bfnh> a(String paramString)
  {
    try
    {
  ...
  public boolean a(String paramString)
  {
    ...
    try
    {
      bflp.b("cgi_report_debug", "ReportDataModal deleteOldItems start");
      try
      {
        this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase = this.jdField_a_of_type_Bfnf.getWritableDatabase();
      ...
      catch (Exception paramString)
      {
        ...
        {
          label75:
          bflp.a(jdField_a_of_type_JavaLangString, "deleteOldItems>>>", paramString);
        }
      }
    }
    finally {}
    try
    {
      ...
      this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase.close();
      bflp.b("cgi_report_debug", "ReportDataModal deleteOldItems success");
      bool = true;
    }
    catch (Exception paramString)
    {
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10)
  {
    ...
    //   113: invokestatic 52	bflp:b	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   432: invokestatic 29	bfbm:a	()Lbfbm;
    //   435: invokevirtual 32	bfbm:a	()Landroid/content/Context;
    //   438: invokestatic 329	bflk:e	(Landroid/content/Context;)Ljava/lang/String;
    ...
    //   468: invokestatic 29	bfbm:a	()Lbfbm;
    //   471: invokevirtual 334	bfbm:a	()J
    ...
    //   533: aload_0
    //   534: aload_0
    //   535: getfield 39	bfne:jdField_a_of_type_Bfnf	Lbfnf;
    //   538: invokevirtual 249	bfnf:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   541: putfield 61	bfne:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   544: aload_0
    //   545: getfield 61	bfne:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   548: ldc 162
    //   550: aconst_null
    //   551: aload_3
    ...
    //   555: pop2
    //   556: aload_0
    //   557: getfield 61	bfne:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   560: invokevirtual 147	android/database/sqlite/SQLiteDatabase:close	()V
    //   563: ldc 44
    //   565: ldc_w 341
    //   568: invokestatic 52	bflp:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   571: iconst_1
    //   572: istore 12
    //   574: aload_0
    //   575: monitorexit
    ...
    //   586: ldc 44
    //   588: ldc_w 343
    //   591: invokestatic 345	bflp:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   594: iconst_0
    //   595: istore 12
    //   597: goto -23 -> 574
    //   600: astore_1
  ...
  public ArrayList<bfnh> b(String paramString)
  {
    try
    {
  ...
  public boolean b(String paramString)
  {
    ...
    try
    {
      bflp.b("cgi_report_debug", "ReportDataModal deleteNewItems start");
      try
      {
        this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase = this.jdField_a_of_type_Bfnf.getWritableDatabase();
      ...
      catch (Exception paramString)
      {
        ...
        {
          label75:
          bflp.a(jdField_a_of_type_JavaLangString, "deleteNewItems>>>", paramString);
        }
      }
    }
    finally {}
    try
    {
      this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase.execSQL(paramString);
      this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase.close();
      bflp.b("cgi_report_debug", "ReportDataModal deleteNewItems success");
      bool = true;
    }
    catch (Exception paramString)
    {
