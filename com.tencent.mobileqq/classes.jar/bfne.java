  ...
  extends anxg
{
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    ...
    bfmz.a(this.a).a(paramInt1, paramInt2);
  }
  ...
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    label123:
    bfmz.a(this.a).a(paramInt1, paramInt2, paramString);
  }
  ...
  protected void a(boolean paramBoolean, long paramLong, int paramInt1, TroopInfo paramTroopInfo, int paramInt2, String paramString)
  {
    ...
    bfmz.a(this.a).a(paramBoolean, paramLong, paramTroopInfo);
  }
  
  protected void a(boolean paramBoolean, long paramLong, RespBatchProcess paramRespBatchProcess, Bundle paramBundle)
  {
    if ((paramRespBatchProcess == null) || (paramRespBatchProcess.batch_response_list == null) || (paramRespBatchProcess.batch_response_list.size() == 0) || (bfmz.a(this.a) == null)) {}
    int j;
    do
    {
      do
      {
        ...
        {
          return;
        } while ((!String.valueOf(paramLong).equals(bfmz.a(this.a).troopUin)) || (bfmz.a(this.a) == null) || (bfmz.a(this.a) == null));
        if (bfmz.a(this.a).a != null) {
          bfmz.a(this.a).a.setCompoundDrawablesWithIntrinsicBounds(null, null, null, null);
        }
      } while (!String.valueOf(paramLong).equals(bfmz.a(this.a).troopUin));
  ...
  protected void a(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, List<TroopClipPic> paramList)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((!paramBoolean) || (!bgjw.a(paramString1, bfmz.a(this.a).troopUin)));
      if (paramInt1 == 0)
      {
    ...
    if ((paramInt1 == 1) || (paramInt1 == 2)) {
      paramString2 = bfmz.a(this.a).getString(2131695370);
    }
    for (;;)
    {
      bfmz.a(this.a).a(paramString2);
      return;
      if (paramInt1 == 19) {
        paramString2 = bfmz.a(this.a).getString(2131695368);
      } else if (paramInt1 == 65) {
        paramString2 = bfmz.a(this.a).getString(2131695369);
      }
    }
  }
  ...
  protected void b(boolean paramBoolean, long paramLong1, int paramInt1, List<oidb_0x899.memberlist> paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    if (paramInt1 != 2) {}
    while ((!paramBoolean) || (bfmz.a(this.a) == null) || (paramList == null) || (paramList.isEmpty())) {
      return;
    }
    bfmz.a(this.a).a(paramLong1, paramList);
  }
  ...
  {
    if ((bfmz.a(this.a) == null) || (bfmz.a(this.a) == null)) {}
    while (!bgjw.a(paramString1, bfmz.a(this.a).troopUin)) {
      return;
    }
    if (paramInt1 == 0)
    {
    ...
    if (TextUtils.isEmpty(paramString2))
    {
      ...
      paramString1 = bfmz.a(this.a).getString(2131695370);
    }
    for (;;)
    {
      bfmz.a(this.a).a(paramString1);
      return;
      label106:
      if (paramInt1 == 2) {
        paramString1 = bfmz.a(this.a).getString(2131695368);
      } else if (paramInt1 == 3) {
        paramString1 = bfmz.a(this.a).getString(2131695381);
      } else if (paramInt1 == 4) {
        paramString1 = bfmz.a(this.a).getString(2131695382);
      } else {
        paramString1 = bfmz.a(this.a).getString(2131695379);
      }
    }
  }
  ...
  {
    if ((paramBoolean) && (bfmz.a(this.a) != null)) {
      bfmz.a(this.a).c(paramString);
    }
  }
  
  protected void c(boolean paramBoolean, String paramString, int paramInt)
  {
    if ((paramBoolean) && (bfmz.a(this.a) != null) && (paramString.equals(bfmz.a(this.a).troopUin))) {
      this.a.a = paramInt;
    }
  }
}
