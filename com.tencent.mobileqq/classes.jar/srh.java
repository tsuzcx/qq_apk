...
{
  private static srh jdField_a_of_type_Srh;
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
  private final ArrayList<srn> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private int jdField_b_of_type_Int;
  private long jdField_b_of_type_Long = 600000L;
  private final ArrayList<sro> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private srh()
  {
    ...
    this.jdField_a_of_type_JavaUtilArrayList.add(new srl());
    this.jdField_b_of_type_JavaUtilArrayList.add(new srm(f));
    a();
  }
  
  public static srh a()
  {
    if (jdField_a_of_type_Srh == null) {}
    try
    {
      if (jdField_a_of_type_Srh == null) {
        jdField_a_of_type_Srh = new srh();
      }
      return jdField_a_of_type_Srh;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    {
      ((ConnectivityManager)BaseApplicationImpl.getApplication().getSystemService("connectivity")).registerNetworkCallback(new NetworkRequest.Builder().build(), new srj(this, null));
      return;
    }
    BaseApplicationImpl.getApplication().registerReceiver(new srk(this, null), new IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
  }
  ...
  private long b()
  {
    ...
    {
      long l2 = ((srn)localIterator.next()).a();
      l1 = l2;
      if (l2 > 0L) {
        l1 = l2;
      }
  ...
  private void b()
  {
    ...
    if (l > this.jdField_a_of_type_Long)
    {
      ...
      if (this.e > this.jdField_a_of_type_Long)
      {
        ...
        while (localIterator.hasNext()) {
          ((sro)localIterator.next()).a(this.e);
        }
      }
      this.e = l;
    }
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        sro localsro = (sro)localIterator.next();
        if (this.e > localsro.jdField_a_of_type_Long) {
          localsro.a(this.e);
        }
      }
      this.e = 0L;
  ...
  private void c()
  {
    ...
    {
      sro localsro = (sro)localIterator.next();
      long l2 = Math.max(localsro.jdField_a_of_type_Long, l1);
      l1 = l2;
      if (QLog.isColorLevel())
      {
        QLog.d("BandwidthPredictor", 2, "predict: predictor=" + localsro + ", currentPrediction=" + localsro.jdField_b_of_type_Long + ", prediction=" + localsro.jdField_a_of_type_Long);
        l1 = l2;
      }
    }
