...
public class arfz
{
  ...
  private void b(Bitmap paramBitmap)
  {
    ...
    if (paramBitmap != null)
    {
      ...
      if ((!paramBitmap.isRecycled()) && (!ardw.a().a().c())) {
        paramBitmap.recycle();
      }
    }
  }
  ...
  public Bitmap a(int paramInt1, int paramInt2)
  {
    ...
    {
      argp.a("BitmapCacheManager", "create bitmap out of memory", localOutOfMemoryError);
    }
    return localObject1;
  }
  ...
  public void a()
  {
    ...
    {
      Bitmap localBitmap = (Bitmap)localIterator.next();
      if ((localBitmap != null) && (!localBitmap.isRecycled()) && (!ardw.a().a().c())) {
        localBitmap.recycle();
      }
    }
