...
public class alwc
  extends MqqHandler
{
  public alwc(ShortVideoPlayActivity paramShortVideoPlayActivity) {}
    ...
    do
    {
      do
      {
        do
        {
          ...
          return;
          paramMessage = bglp.a(this.a.jdField_a_of_type_AndroidContentContext, 232, this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131718104), this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131718103), 2131718087, 2131717317, new alwd(this), new alwe(this));
