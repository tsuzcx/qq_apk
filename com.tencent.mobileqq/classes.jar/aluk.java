  ...
  extends alko
{
  ...
  private alsi jdField_a_of_type_Alsi = new alul(this);
  private alxd jdField_a_of_type_Alxd = new alum(this);
  ...
  public aluk(QQAppInterface paramQQAppInterface)
  {
    ...
    this.app.addObserver(this.jdField_a_of_type_Alxd);
    a();
  }
  ...
  private ToServiceMsg a(boolean paramBoolean, long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    paramString = ayvu.a(this.app, 13, paramString, localaywb, paramLong2, ayvy.b(paramLong1));
  ...
  public void a()
  {
    Object localObject1 = (alxb)this.app.a(10);
    if ((((alxb)localObject1).a() != 0) && (((alxb)localObject1).e() == 1))
    {
