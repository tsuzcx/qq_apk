...
public class atwt
{
  ...
  public static Intent a(QQAppInterface paramQQAppInterface, Activity paramActivity, FileManagerEntity paramFileManagerEntity)
  {
    ...
    paramActivity.putExtra("forward_text", anni.a(2131708482) + atvo.d(paramFileManagerEntity.fileName) + anni.a(2131708494) + atwl.a(paramFileManagerEntity.fileSize) + "。");
    paramActivity.putExtra("k_favorites", atvo.c(paramFileManagerEntity));
    if ((!atwl.b(paramFileManagerEntity.getFilePath())) && ((paramFileManagerEntity.getCloudType() == 6) || (paramFileManagerEntity.getCloudType() == 7)) && (paramFileManagerEntity.nFileType == 0)) {
      paramActivity.putExtra("forward_type", 0);
    }
  ...
  public static Intent a(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
    ...
    bety localbety = bfsj.a(paramQQAppInterface, localFileManagerEntity);
    ...
    if (!TextUtils.isEmpty(localFileManagerEntity.getFilePath())) {
      localForwardFileInfo.a(localbety.jdField_a_of_type_JavaLangString);
    }
    localForwardFileInfo.d(localbety.g);
    localForwardFileInfo.d(localbety.jdField_c_of_type_Long);
    localForwardFileInfo.a(localFileManagerEntity.TroopUin);
    paramFileManagerEntity = localbety.d;
    ...
    for (;;)
    {
      ...
      paramFileManagerEntity.putExtra("forward_text", localbety.g);
      paramFileManagerEntity.putExtra("forward_from_troop_file", true);
      return paramFileManagerEntity;
      if (localbety.jdField_a_of_type_JavaUtilUUID != null) {
        localForwardFileInfo.e(localbety.jdField_a_of_type_JavaUtilUUID.toString());
      }
  ...
  public static SpannableString a(String paramString1, String paramString2, atwb paramatwb)
  {
    ...
    for (int i = Color.parseColor("#A3CCEF");; i = j)
    {
      ...
      paramString1.setSpan(new atxi(new atwu(paramatwb), paramString2), k, k + m, 33);
      return paramString1;
    }
  }
  
  public static bety a(QQAppInterface paramQQAppInterface, long paramLong, besl parambesl)
  {
    bety localbety2 = TroopFileTransferManager.a(paramQQAppInterface, paramLong).a(parambesl.b);
    bety localbety1 = localbety2;
    if (localbety2 == null)
    {
      localbety1 = bfsj.a(paramQQAppInterface, paramLong, parambesl.jdField_a_of_type_JavaUtilUUID.toString(), parambesl.b, parambesl.jdField_c_of_type_JavaLangString, parambesl.jdField_a_of_type_Long, parambesl.jdField_a_of_type_Int);
  ...
  public static String a(Context paramContext, int paramInt1, int paramInt2, TextView paramTextView1, TextView paramTextView2, String paramString1, String paramString2)
  {
    ...
    int i = afur.a(7.0F, paramContext.getResources());
    int j = (int)paramTextView2.measureText(paramString2);
    int k = afur.a(15.0F, paramContext.getResources());
    switch (paramInt1)
    {
    case 1: 
    default: 
  ...
  public static String a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (!TextUtils.isEmpty(paramString2))
    {
      if (localStringBuilder.length() > 0) {
        localStringBuilder.append(paramContext.getString(2131692139));
      }
  ...
  public static String a(Bitmap paramBitmap)
  {
    ...
    localFile = new File(atut.a().b() + ".video_frame/");
    bgmg.a(localFile.getAbsolutePath());
    localFile.mkdirs();
    localFile = new File(localFile.getAbsolutePath(), System.currentTimeMillis() + ".jpg");
    try
    {
      bgmo.a(paramBitmap, localFile);
  ...
  private static String a(AppInterface paramAppInterface, MessageForTroopFile paramMessageForTroopFile)
  {
    ...
    for (;;)
    {
      if ((!TextUtils.isEmpty((CharSequence)localObject)) && (atvo.b((String)localObject)))
      {
        if (QLog.isDebugVersion()) {
      ...
      str1 = str1 + bgmj.a(paramAppInterface.getBytes()) + ".tmp";
      if (atwl.a(str1) > 0L) {
        localObject = str1;
      }
      for (;;)
      {
        if (atvo.b((String)localObject))
        {
          if (QLog.isDebugVersion()) {
        ...
        paramAppInterface = atut.a().c() + bkdr.a(paramAppInterface);
        if (!atvo.b(paramAppInterface)) {
          break;
        }
        if (QLog.isDebugVersion()) {
  ...
  public static String a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2)
  {
    ...
    if (localObject != null)
    {
      if (((bfsk)localObject).a(String.valueOf(paramLong1), String.valueOf(paramLong2))) {
        return anni.a(2131708483);
      }
      localObject = ((bfsk)localObject).a(String.valueOf(paramLong1));
      paramQQAppInterface = (TroopManager)paramQQAppInterface.getManager(52);
      if ((localObject != null) && (((bfsr)localObject).jdField_a_of_type_Long != 0L))
      {
        if (paramQQAppInterface != null)
        {
  ...
  public static void a(Context paramContext, Rect paramRect, ChatMessage paramChatMessage, SessionInfo paramSessionInfo, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, MessageForReplyText paramMessageForReplyText)
  {
    ...
    for (;;)
    {
      ...
      paramBoolean1 = ayfa.a(BaseApplicationImpl.sApplication.getRuntime().getAccount(), 1);
      localBundle.putBoolean("extra.OCR", paramBoolean1);
      if (paramBoolean1)
      {
        paramMessageForReplyText = ayfa.a(BaseApplicationImpl.sApplication.getRuntime().getAccount());
      ...
      try
      {
        ...
        if ((paramChatMessage instanceof MessageForFile))
        {
          if ((paramContext instanceof SplashActivity))
          {
            ...
            bley.a(paramContext, localBundle, new AIOImageProviderService(paramRect, paramChatMessage.frienduin, paramChatMessage.istroop, paramChatMessage), ahth.a(paramChatMessage, paramMessageForReplyText), -1, i);
            return;
          }
        ...
        {
          localBundle.putBoolean("extra.ENTER_NEW_GALLERY", true);
          bley.a(paramContext, localBundle, new AIOImageProviderService(paramRect, paramChatMessage.frienduin, paramChatMessage.istroop, paramChatMessage), ahth.a(paramChatMessage, paramMessageForReplyText), -1, paramSessionInfo.c);
          return;
        }
      }
  ...
  public static void a(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean, atwb paramatwb)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty(paramString2))) {
      if (paramTextView.getWidth() == 0) {
        paramTextView.post(new QFileUtils.2(paramContext, paramTextView, paramString1, paramString2, paramString3, paramString4, paramString5, paramBoolean, paramatwb));
      }
    }
    while (TextUtils.isEmpty(str.replace(" ", "")))
    {
      return;
      b(paramContext, paramTextView, paramString1, paramString2, paramString3, paramString4, paramString5, paramBoolean, paramatwb);
      return;
    }
  ...
  public static void a(Context paramContext, String paramString, atne paramatne)
  {
    if (!bgmg.b(paramString)) {
      return;
    }
    ThreadManagerV2.executeOnSubThread(new QFileUtils.5(paramContext, paramString, paramatne));
  }
  ...
  {
    if (bgnt.a(paramActivity) == 0)
    {
      bfrh.a(paramActivity, paramActivity.getString(2131696888));
      return;
    }
    ...
    aufz.a(paramActivity, paramQQAppInterface, ForwardRecentTranslucentActivity.class, 103);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong1, String paramString1, String paramString2, String paramString3, long paramLong2, int paramInt)
  {
    ...
    {
      return;
      paramString2 = bfsj.a(paramQQAppInterface, paramLong1, paramString1, paramString2, paramString3, paramLong2, paramInt);
    } while (paramString2 == null);
    paramString1 = new Bundle();
    paramString1.putInt("dataline_forward_type", 100);
    if (bgmg.b(paramString2.jdField_a_of_type_JavaLangString)) {
      paramString1.putString("dataline_forward_path", paramString2.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      paramQQAppInterface = (anjx)paramQQAppInterface.a(8);
      paramString2 = new atxb(paramContext);
      paramInt = paramQQAppInterface.a().b(anhk.z, paramString1, paramString2);
      if ((paramString2.a) && (paramInt != 0)) {
        break;
      }
      dc.b(paramContext, paramInt);
      return;
      paramString3 = atvo.a(paramString2);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ChatMessage paramChatMessage, long paramLong1, bety parambety, String paramString, long paramLong2, int paramInt1, int paramInt2, Rect paramRect, boolean paramBoolean1, boolean paramBoolean2)
  {
    a(paramQQAppInterface, paramContext, paramSessionInfo, paramChatMessage, paramLong1, parambety, paramString, paramLong2, paramInt1, paramInt2, paramRect, paramBoolean1, paramBoolean2, false);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ChatMessage paramChatMessage, long paramLong1, bety parambety, String paramString, long paramLong2, int paramInt1, int paramInt2, Rect paramRect, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (;;)
    {
      parambety = new atqc(paramQQAppInterface, paramContext, paramLong1, parambety, paramInt1);
      parambety.a(paramLong2);
      parambety.a(paramString);
      parambety.a(paramSessionInfo);
      parambety.a(paramChatMessage);
      parambety.a(paramBoolean1);
      parambety.b(paramBoolean3);
      ...
      paramContext = new atpy(paramContext, parambety);
  ...
  {
    paramQQAppInterface = new atpw(paramQQAppInterface, paramContext, paramFileManagerEntity, paramInt2);
    new Bundle();
    ...
    paramQQAppInterface = new atpy(paramContext, paramQQAppInterface);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, FileManagerEntity paramFileManagerEntity)
  {
    ...
    do
    {
      ...
      paramFileManagerEntity = (anjx)paramQQAppInterface.a(8);
      localatwz = new atwz(paramContext);
      i = paramFileManagerEntity.a().b(anhk.z, localBundle, localatwz);
    } while ((localatwz.a) && (i != 0));
    dc.b(paramContext, i);
    bcst.b(paramQQAppInterface, "CliOper", "", "", "0X800644B", "0X800644B", 0, 0, "6", "", "", "");
  }
  ...
  {
    if ((paramMessageRecord1 == null) || (!atvo.a(paramMessageRecord1))) {}
    int i;
    do
    {
      String str;
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<besl> paramList, Activity paramActivity, long paramLong)
  {
    ...
    {
      bety localbety = a(paramQQAppInterface, paramLong, (besl)paramList.next());
      FileManagerEntity localFileManagerEntity = atvo.a(localbety);
      localFileManagerEntity.status = 2;
      ...
      {
        localForwardFileInfo.f(localbety.jdField_c_of_type_JavaLangString);
        label209:
        ...
        localArrayList2.add(Uri.parse(localbety.jdField_a_of_type_JavaLangString));
      }
      for (;;)
      {
        long l2 = localbety.jdField_c_of_type_Long;
        localArrayList1.add(localForwardFileInfo);
        l1 = l2 + l1;
        break;
        if (TextUtils.isEmpty(localbety.d)) {
          break label209;
        }
        localForwardFileInfo.f(localbety.d);
        break label209;
        label295:
    ...
    paramQQAppInterface = anni.a(2131708484);
    if (localArrayList1.size() == 1) {
      paramQQAppInterface = anni.a(2131708492) + atvo.d(((ForwardFileInfo)localArrayList1.get(0)).d()) + anni.a(2131708493) + atwl.a(((ForwardFileInfo)localArrayList1.get(0)).d()) + "。";
    }
    for (;;)
    {
      paramList.putExtra("forward_text", paramQQAppInterface);
      paramList.putExtra("k_favorites", false);
      aufz.a(paramActivity, paramList, 103);
      return;
      if (localArrayList1.size() > 1) {
        paramQQAppInterface = anni.a(2131708488) + atvo.d(((ForwardFileInfo)localArrayList1.get(0)).d()) + anni.a(2131708487) + localArrayList1.size() + anni.a(2131708490) + atwl.a(l1) + "。";
      }
    }
  }
  ...
  public static boolean a(Context paramContext, String paramString)
  {
    ...
    String str1 = atvo.a(paramString);
    String str2 = beas.a(paramContext, str1);
  ...
  public static boolean a(Context paramContext, String paramString, Uri paramUri)
  {
    ...
    //   10: istore 4
    //   12: aload_1
    //   13: invokestatic 763	bgmg:b	(Ljava/lang/String;)Z
    //   16: ifne +10 -> 26
    //   19: iload 4
    //   21: istore 5
    //   23: iload 5
  ...
  public static boolean a(Context paramContext, boolean paramBoolean, atwo paramatwo)
  {
    int j = 2;
    boolean bool1;
    ...
    do
    {
      ...
      i = 3;
      bool2 = bhhb.a(localActivity, i, new atwv(paramatwo), "");
      bool1 = bool2;
    } while (!bool2);
    ...
    for (int i = j;; i = 1)
    {
      return bigl.a(paramContext, i, new atww(paramatwo));
      i = 2;
      break;
    }
  }
  ...
  public static int b(String paramString)
  {
    ...
    } while ((TextUtils.isEmpty(paramString)) || (!bdvy.b(paramString)));
    return 2;
  }
  ...
  public static String b(long paramLong)
  {
    ...
    if (paramLong > 1048576L)
    {
      ...
      return anni.a(2131708486) + str + "MB/s";
    }
    if (paramLong > 1024L)
    {
      f = (float)paramLong / 1024.0F;
      str = new DecimalFormat("0.00").format(f);
      return anni.a(2131708485) + str + "KB/s";
    }
    return anni.a(2131708491) + paramLong + "KB/s";
  }
  
  public static void b(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean, atwb paramatwb)
  {
    String str = a(paramContext, paramString1, paramString2, paramString3, paramString4);
    paramString2 = atvo.a(paramTextView, 2, paramString5 + str, paramString2);
    if (!TextUtils.isEmpty(paramString2))
    {
      paramContext = a(paramContext, paramString1, paramString2, paramString3, paramString4);
      paramContext = atvo.a(paramTextView, paramString5 + paramContext);
      paramString1 = a(paramContext, paramString2, anni.a(2131708489));
      if (paramBoolean) {
        paramContext = a(paramContext, paramString1, paramatwb);
      }
    }
    for (;;)
    {
      if (aqyu.c().a())
      {
        ...
        aqyu.c().a(paramContext, paramString4, paramString1);
      }
  ...
  public static void b(QQAppInterface paramQQAppInterface, Activity paramActivity, FileManagerEntity paramFileManagerEntity, boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    {
      atvb.a(paramActivity, 2131692321, 2131692326, new atwx(paramActivity, paramQQAppInterface));
      return;
    }
    aufz.a(paramActivity, paramQQAppInterface, ForwardRecentTranslucentActivity.class, 103);
  }
  ...
  {
    if ((paramMessageRecord1 == null) || (!atvo.a(paramMessageRecord1))) {}
    while ((paramMessageRecord2 == null) || (!atvo.a(paramMessageRecord2))) {
      return;
    }
  ...
  public static boolean b(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      ...
      bgmo.a(paramContext, (String)localObject);
      return true;
      if (i == 2)
      {
  ...
  {
    if (paramFileManagerEntity == null) {}
    while ((6 != paramFileManagerEntity.getCloudType()) || (atwl.b(paramFileManagerEntity.getFilePath()))) {
      return false;
    }
    return true;
  }
  ...
  public static boolean c(Context paramContext, String paramString)
  {
    ...
    atvb.a(paramContext, "", 2131697406, new atwy(paramContext, paramString));
    return false;
  }
}
