...
public class ljx
{
  ...
  {
    lek.c("MagicDataReport", "DOUBLE SCREEN DataReport onStateReport: |" + paramString + "|" + paramLong);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        lek.e("MagicDataReport", localException.getMessage());
        continue;
        paramInt = 3;
        continue;
        paramInt = 4;
  ...
  {
    lek.c("MagicDataReport", "WL_DEBUG reportChangeFace fromType = " + paramInt + ", id = " + paramString);
