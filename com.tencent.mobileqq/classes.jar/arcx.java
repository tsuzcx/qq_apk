  ...
  implements arch, vtk
{
  ...
  private arda jdField_a_of_type_Arda;
  ...
  private String a(faceproto.Request paramRequest, File paramFile)
  {
    ...
    //   3: dup
    //   4: getstatic 50	arcx:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   106: aload_1
    //   107: arraylength
    //   108: invokestatic 233	bbbr:a	(I)[B
    ...
    //   128: l2i
    //   129: invokestatic 233	bbbr:a	(I)[B
    ...
    //   223: aload 4
    //   225: invokestatic 253	bbbr:a	(Ljava/io/Closeable;)V
    //   228: aload_1
    //   229: invokestatic 253	bbbr:a	(Ljava/io/Closeable;)V
    //   232: aconst_null
    //   233: areturn
    //   234: aload 7
    //   236: astore 6
    ...
    //   262: aload 4
    //   264: invokestatic 253	bbbr:a	(Ljava/io/Closeable;)V
    //   267: aload 7
    //   269: invokestatic 253	bbbr:a	(Ljava/io/Closeable;)V
    //   272: aload 8
    ...
    //   302: aload 4
    //   304: invokestatic 253	bbbr:a	(Ljava/io/Closeable;)V
    //   307: aload_1
    //   308: invokestatic 253	bbbr:a	(Ljava/io/Closeable;)V
    //   311: aconst_null
    //   312: areturn
    //   313: astore_1
    //   314: aconst_null
    ...
    //   318: astore 4
    //   320: aload 4
    //   322: invokestatic 253	bbbr:a	(Ljava/io/Closeable;)V
    //   325: aload 6
    //   327: invokestatic 253	bbbr:a	(Ljava/io/Closeable;)V
    //   330: aload_1
    //   331: athrow
    //   332: astore_1
    //   333: aconst_null
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Arda != null) {
      this.jdField_a_of_type_Arda.a();
    }
  }
  ...
  public void a(vto paramvto)
  {
    ...
    {
      paramvto = new File(paramvto.jdField_b_of_type_JavaLangString);
      Object localObject = a(paramvto, this.jdField_d_of_type_Int);
      if (localObject != null)
      {
        paramvto = a((faceproto.Request)localObject, paramvto);
        if (paramvto == null)
        {
          this.jdField_a_of_type_Arcz.a(2, a(211, ajya.a(2131713427), false));
          return;
        }
        localObject = MD5.getFileMd5(paramvto);
        Bundle localBundle = new Bundle();
        localBundle.putString("filePath", paramvto);
        ...
        QIPCClientHelper.getInstance().callServer("IdentificationIpcServer_Model", "action_upload", localBundle, new arcy(this));
        return;
      }
      this.jdField_a_of_type_Arcz.a(2, null);
      return;
    }
    this.jdField_a_of_type_Arcz.a(2, a(213, ajya.a(2131713425), false));
    QLog.e("RequestHelper", 1, "encode video failed: " + paramvto.jdField_a_of_type_Int);
  }
}
