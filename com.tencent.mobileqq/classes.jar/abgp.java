  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    {
      abgm.a(this.a).sendEmptyMessage(1003);
      new absn().a();
      this.a.b = 2;
    }
    long l;
    do
    {
        ...
        do
        {
          do
          {
            do
            {
              ...
              abgm.a(this.a, "DeviceList @@ cache receivechange for ui list:" + paramContext);
            ...
            if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_login"))
            {
              ...
              abgm.a(this.a, "SmartDeviceProxyMgr::receive qq login broadcast!!!resultCode = " + i);
            ...
            if ((paramIntent.getAction().equalsIgnoreCase("mqq.intent.action.LOGOUT")) || (paramIntent.getAction().equalsIgnoreCase("mqq.intent.action.ACCOUNT_CHANGED")))
            {
              if (this.a.a())
              {
                abgm.a(this.a, "SmartDeviceProxyMgr::receive qq logout broadcast!!!");
                this.a.d();
              }
              absn.c();
              return;
            ...
            if (paramIntent.getAction().equalsIgnoreCase("SmartDevice_clickOnDeviceList"))
            {
              ...
              absy.a(null, "Usr_Click_MyDevice", 0, 0, 0);
              return;
            }
      ...
      abgm.a(this.a, 1);
      SettingCloneUtil.writeValueForInt(BaseApplication.getContext(), this.a.app.getCurrentAccountUin(), null, "qqsetting_deviceplugin_bind_flag", abgm.a(this.a));
