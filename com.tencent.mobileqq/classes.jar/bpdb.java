  ...
  extends bpcq
{
  ...
  private bpdc jdField_a_of_type_Bpdc;
  ...
  public bpdb(Context paramContext, String paramString)
  {
  ...
  private void d()
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Bpdc.sendEmptyMessageDelayed(0, 40L);
      localBitmap = null;
  ...
  public Bitmap a()
  {
    ...
    ArrayList localArrayList = this.jdField_a_of_type_Bpcg.a(this.jdField_a_of_type_Bpcg.a());
  ...
  public Bitmap a(long paramLong)
  {
    Bitmap localBitmap = b();
    Canvas localCanvas = new Canvas(localBitmap);
    ArrayList localArrayList = this.jdField_a_of_type_Bpcg.a(paramLong);
    if (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataGifDecoder != null) {
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Bpdc != null) {
      this.jdField_a_of_type_Bpdc.removeCallbacksAndMessages(null);
    }
  }
  ...
  protected void b()
  {
    this.jdField_a_of_type_Bpdc = new bpdc(new WeakReference(this));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataGifDecoder = new bojh(this.jdField_b_of_type_JavaLangString);
        ...
        this.k = this.jdField_a_of_type_Bpcg.a("offsetX", 0L, 650L, (int)(-i1 * 0.3D), 0, new bpcz());
        this.l = this.jdField_a_of_type_Bpcg.a("offsetX", 100L, 650L, (int)(-i1 * 0.3D), 0, new bpcz());
        this.m = this.jdField_a_of_type_Bpcg.a("offsetX", 200L, 650L, (int)(-i1 * 0.3D), 0, new bpcz());
        this.n = this.jdField_a_of_type_Bpcg.a("alpha", 0L, 370L, 0, 255, new yzi(0.33F, 0.0F, 0.67F, 1.0F));
        this.o = this.jdField_a_of_type_Bpcg.a("alpha", 100L, 370L, 0, 255, new yzi(0.33F, 0.0F, 0.67F, 1.0F));
        this.p = this.jdField_a_of_type_Bpcg.a("alpha", 200L, 370L, 0, 255, new yzi(0.33F, 0.0F, 0.67F, 1.0F));
        return;
      }
  ...
  protected void c()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataGifDecoder != null) && (this.jdField_b_of_type_Boolean)) {
      this.jdField_a_of_type_Bpdc.sendEmptyMessage(0);
    }
  }
