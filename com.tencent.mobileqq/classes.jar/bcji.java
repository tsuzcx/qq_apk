  ...
  extends bcgx
{
  ...
  public bcji()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bcjj(this);
  }
  ...
  private FrameLayout a(Context paramContext)
  {
    ...
    localFrameLayout.setId(2131371651);
    if (AppSetting.c) {
  ...
  public static String a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    if ((paramAbsStructMsg instanceof AbsShareMsg))
    {
      ...
      if ((paramAbsStructMsg.getItemCount() > 0) && ((paramAbsStructMsg.getItemByIndex(0) instanceof bcji)))
      {
        paramAbsStructMsg = (bcji)paramAbsStructMsg.getItemByIndex(0);
  ...
  public static boolean a(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage instanceof MessageForStructing))
    {
      ...
      if ((paramChatMessage.structingMsg != null) && ((paramChatMessage.structingMsg instanceof AbsShareMsg)) && (paramChatMessage.structingMsg.mMsgServiceID == 52))
      {
        ...
        if ((paramChatMessage.getItemCount() > 0) && ((paramChatMessage.getItemByIndex(0) instanceof bcji))) {
          return true;
        }
      }
    }
  ...
  {
    paramView.setOnTouchListener(new bcjk(this, paramView));
  }
    ...
    if (((JSONObject)localObject8).has("cMean"))
    {
      ...
      for (i = 0;; i = Integer.valueOf(str5).intValue())
      {
        ...
        do
        {
          ...
          localObject10 = (bcgw)((Iterator)localObject9).next();
        } while (!(localObject10 instanceof bciz));
        localObject9 = ((bciz)localObject10).ac;
        str11 = b(str11);
        String str15 = b((String)localObject7);
        localObject7 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
        Object localObject10 = (amsw)((QQAppInterface)localObject7).getManager(51);
        this.jdField_a_of_type_AndroidOsBundle.putString("sNick", str15);
        if (!bool1)
        {
          if ((localObject10 == null) || (!((amsw)localObject10).b(str7))) {
            break label1479;
          }
          j = 1;
          if (j != 0)
        ...
        if (!bool2)
        {
          if ((localObject10 == null) || (!((amsw)localObject10).b(str6))) {
            break label1484;
          }
          j = 1;
          if (j != 0)
        ...
        localObject4 = (bcgw)((Iterator)localObject6).next();
        str1 = ((bcgw)localObject4).jdField_a_of_type_JavaLangString;
        if (!"remark".equals(str1)) {
          break;
        }
        localObject4 = ((bclu)localObject4).b();
      ...
      {
        localObject4 = ((bclv)localObject4).b();
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (!TextUtils.isEmpty(str1)) {
      if (bool1)
      {
        ...
        amxb.a(((BaseActivity)paramContext).app, (String)localObject1);
        localResources = paramContext.getResources();
        if ((paramView == null) || (!(paramView instanceof FrameLayout)) || (((FrameLayout)paramView).getChildCount() != 2) || (!(((FrameLayout)paramView).getTag() instanceof bcjl))) {
          break label523;
        }
        localObject1 = (FrameLayout)paramView;
        paramView = (bcjl)((FrameLayout)localObject1).getTag();
        if (paramView.c != null) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (((Iterator)localObject2).hasNext())
        {
          ...
          Object localObject4 = ((bcgw)localObject3).jdField_a_of_type_JavaLangString;
          Object localObject5;
          int i;
          if ("title".equals(localObject4))
          {
            ...
            localObject4 = ((bcgw)localObject3).a(paramContext, paramView.c, paramBundle);
            localObject5 = (TextView)((View)localObject4).findViewById(2131379877);
            if (paramView.c == null)
            {
            ...
            for (;;)
            {
              ...
              QLog.i("StructMsgItemLayout12", 2, "getview title:" + ((bcgy)localObject3).b() + " realText:" + ((TextView)localObject5).getText());
              break label288;
              if (bool2)
              {
          ...
          else
          {
            if ("summary".equals(localObject4))
            {
              if ((localObject3 instanceof bclv)) {
                ((bclv)localObject3).b("black");
              }
              localObject4 = ((bcgw)localObject3).a(paramContext, paramView.d, paramBundle);
              localObject5 = (TextView)localObject4;
              if (!TextUtils.isEmpty(str1))
              {
                ((TextView)localObject5).setMaxLines(1);
                if ((localObject3 instanceof bclv)) {
                  ((bclv)localObject3).a(str2);
                }
                if (paramView.d != null) {
                  break label1026;
                }
              ...
              for (;;)
              {
                localObject3 = (bclv)localObject3;
                if ((this.jdField_a_of_type_AndroidOsBundle.size() <= 0) || (!TextUtils.isEmpty(str1))) {
                  break;
                }
                this.jdField_a_of_type_AndroidOsBundle.putString("cMeanPostfix", ((bclv)localObject3).b());
                break;
            ...
            {
              localObject4 = (bciz)localObject3;
              if (!((bciz)localObject4).ac.startsWith("https://sqimg.qq.com/qq_product_operations/flower/images/aio-msg/android/%s".substring(0, 4))) {
                ((bciz)localObject4).ac = String.format("https://sqimg.qq.com/qq_product_operations/flower/images/aio-msg/android/%s", new Object[] { ((bciz)localObject4).ac });
              }
              localObject3 = ((bcgw)localObject3).a(paramContext, paramView.jdField_b_of_type_AndroidViewView, paramBundle);
            ...
            {
              if ((localObject3 instanceof bclu)) {
                ((bclu)localObject3).b("#FF9B9B9B");
              }
              localObject4 = ((bcgw)localObject3).a(paramContext, paramView.e, paramBundle);
              if (paramView.e == null)
              {
              ...
              for (;;)
              {
                localObject4 = (bclu)localObject3;
                if (this.jdField_a_of_type_AndroidOsBundle.size() > 0)
                {
                  this.jdField_a_of_type_AndroidOsBundle.putString("remark", ((bclu)localObject4).b());
                  if (!TextUtils.isEmpty(str1)) {
                    this.jdField_a_of_type_AndroidOsBundle.putString("cMeanPostfix", ((bclu)localObject4).b());
                  }
                }
                if (!QLog.isColorLevel()) {
                  break;
                }
                QLog.i("StructMsgItemLayout12", 2, "getview remark:" + ((bcgy)localObject3).b());
                break;
