...
public class bcji
{
  ...
  public static EIPCResult a(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    ((atxd)paramString.getManager(160)).a(10014);
    paramBundle.code = 0;
    return paramBundle;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, RedTouch paramRedTouch)
  {
    ...
    {
      localObject1 = (atxd)paramQQAppInterface.getManager(160);
      paramQQAppInterface = ((atxd)localObject1).a(10013);
      localObject2 = ((atxd)localObject1).a(10014);
      if (!((atxd)localObject1).a(paramQQAppInterface, false)) {
        break label1102;
      }
    ...
    for (;;)
    {
      int k = i;
      int m = j;
      if (((atxd)localObject1).a((RedTouchItem)localObject2, false))
      {
        k = i;
        m = j;
        ...
        for (;;)
        {
          ...
          if (!TextUtils.isEmpty(paramQQAppInterface.icon))
          {
            if (!TextUtils.isEmpty(paramQQAppInterface.tips))
            {
              ...
              localObject2 = new BusinessInfoCheckUpdate.RedTypeInfo();
              ((BusinessInfoCheckUpdate.RedTypeInfo)localObject2).red_content.set(baxn.a(BaseApplicationImpl.sApplication.getApplicationContext(), 3.0F) + "");
            ...
            try
            {
              ...
              try
              {
                ...
                paramQQAppInterface.setPadding(actj.a(160.0F, paramQQAppInterface.getResources()), paramQQAppInterface.getPaddingTop(), paramQQAppInterface.getPaddingRight(), paramQQAppInterface.getPaddingBottom());
                return;
              }
  ...
  public static EIPCResult b(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    paramString = (atxd)paramString.getManager(160);
