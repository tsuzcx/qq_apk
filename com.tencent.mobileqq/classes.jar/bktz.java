...
public class bktz
{
  ...
  public static void a(String paramString1, String paramString2, String paramString3, EIPCResultCallback paramEIPCResultCallback)
  {
    ...
    {
      QLog.d("LoginHelper", 1, new Object[] { "toWtLoginOnOpenSdk appId=", paramString3, ", uin=", bjqq.a(paramString1) });
  ...
  {
    QLog.d("LoginHelper", 1, new Object[] { "doWtLoginOnOpenSdk appId=", paramString1, ", uin=", bjqq.a(paramString2), ", observer=", paramSSOAccountObserver });
    ...
    Bundle localBundle = new Bundle();
    localBundle.putByteArray("connect_data", bjqq.a(paramString1));
