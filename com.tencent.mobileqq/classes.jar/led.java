...
class led
  implements Runnable
{
  led(lec paramlec, oidb_0x5bd.GuideInfo paramGuideInfo1, oidb_0x5bd.RefreshInfo paramRefreshInfo, oidb_0x5bd.SkinInfo paramSkinInfo, oidb_0x5bd.GuideInfo paramGuideInfo2) {}
  
  public void run()
  {
    int j = (int)(System.currentTimeMillis() / 1000L);
    Object localObject2 = (ReadInJoyOperationManager)this.jdField_a_of_type_Lec.a.app.getManager(270);
    Object localObject1;
    Object localObject3;
    Object localObject4;
    int i;
    if (this.jdField_a_of_type_TencentImOidbCmd0x5bdOidb_0x5bd$GuideInfo.has())
    {
      ...
      localObject3 = this.jdField_a_of_type_Lec.a.app.getEntityManagerFactory().createEntityManager();
      ...
      this.jdField_a_of_type_Lec.a.a(270, "operation_guide", (BaseResData)localObject3);
      ReadInJoyNewFeedsActivity.a(this.jdField_a_of_type_Lec.a, true);
    }
    for (;;)
    {
      i += 1;
      ...
      break;
      label271:
      if ((j <= ((BaseResData)localObject3).endTime) && (NetworkUtil.h(this.jdField_a_of_type_Lec.a))) {
    ...
    label314:
    localObject2 = (ReadInJoyRefreshManager)this.jdField_a_of_type_Lec.a.app.getManager(269);
    if (this.jdField_a_of_type_TencentImOidbCmd0x5bdOidb_0x5bd$RefreshInfo.has())
    {
      ...
      localObject3 = ((ReadInJoyRefreshManager)localObject2).a(this.jdField_a_of_type_Lec.a);
      if (QLog.isColorLevel()) {
      ...
      {
        SharedPreUtils.v(this.jdField_a_of_type_Lec.a, this.jdField_a_of_type_Lec.a.app.getCurrentAccountUin(), null);
      ...
      if ((localObject3 != null) && (j <= ((RefreshData)localObject3).endTime))
      {
        ...
        SharedPreUtils.v(this.jdField_a_of_type_Lec.a.getActivity(), this.jdField_a_of_type_Lec.a.app.getCurrentAccountUin(), ((RefreshData)localObject3).toJson().toString());
      }
      label503:
      localObject2 = (ReadInJoySkinManager)this.jdField_a_of_type_Lec.a.app.getManager(260);
      ...
      if ((ReadInJoyNewFeedsActivity.a(this.jdField_a_of_type_Lec.a)) || (localObject3 == null) || (j < ((GuideData)localObject3).beginTime) || (j > ((GuideData)localObject3).endTime)) {
        break label793;
      }
      this.jdField_a_of_type_Lec.a.a(260, "", (BaseResData)localObject3);
      label644:
      localObject4 = ((ReadInJoySkinManager)localObject2).a(this.jdField_a_of_type_Lec.a);
      if ((localObject1 != null) || (((ReadInJoySkinManager)localObject2).a() != 1)) {
        break label842;
      }
      this.jdField_a_of_type_Lec.a.a = ((ReadInJoySkinManager)localObject2).a();
      SharedPreUtils.u(this.jdField_a_of_type_Lec.a, this.jdField_a_of_type_Lec.a.app.getCurrentAccountUin(), null);
    }
    label716:
    while ((localObject1 == null) || (localObject4 == null) || (!((SkinData)localObject4).id.equals(((SkinData)localObject1).id)) || (((SkinData)localObject4).seq == ((SkinData)localObject1).seq))
    {
      ...
      localObject1 = null;
      break label546;
      if ((localObject3 == null) || (j > ((GuideData)localObject3).endTime) || (!NetworkUtil.h(this.jdField_a_of_type_Lec.a))) {
        break label644;
      }
    ...
    label793:
    label842:
    SharedPreUtils.u(this.jdField_a_of_type_Lec.a, this.jdField_a_of_type_Lec.a.app.getCurrentAccountUin(), ((GuideData)localObject3).skinData.toJson().toString());
    if (((SkinData)localObject1).id.equals(((ReadInJoySkinManager)localObject2).a()))
    {
      this.jdField_a_of_type_Lec.a.a = ((SkinData)localObject1).id;
      return;
    }
