  ...
  implements Handler.Callback, Manager
{
  ...
  private ConcurrentHashMap<Integer, atxe> b = new ConcurrentHashMap();
  ...
  public atxb(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Atxf = new atxa(paramQQAppInterface, this);
    d();
  }
  ...
  private void a(RedTouchItem paramRedTouchItem, int paramInt)
  {
    ...
    if (localRedTouchItem == null)
    {
      ...
      atxg.a(localRedTouchItem, paramRedTouchItem);
    ...
    do
    {
      ...
      j = atxg.a(localRedTouchItem.redtouchType);
      k = atxg.a(paramRedTouchItem.redtouchType);
      if (k > j)
      {
        localRedTouchItem = new RedTouchItem();
        atxg.a(localRedTouchItem, paramRedTouchItem);
  ...
  private void a(RedTouchItem paramRedTouchItem, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Atxf.a(paramRedTouchItem, localRedPointConfig1.redPointId);
  ...
  private void d()
  {
    this.jdField_a_of_type_Atxe = new atxe();
    this.jdField_a_of_type_Atxe.jdField_a_of_type_Int = -1;
    this.b.put(Integer.valueOf(this.jdField_a_of_type_Atxe.jdField_a_of_type_Int), this.jdField_a_of_type_Atxe);
    atxe localatxe1 = new atxe();
    localatxe1.jdField_a_of_type_Int = 10018;
    localatxe1.jdField_a_of_type_Atxe = this.jdField_a_of_type_Atxe;
    this.b.put(Integer.valueOf(localatxe1.jdField_a_of_type_Int), localatxe1);
    localatxe1 = new atxe();
    localatxe1.jdField_a_of_type_Int = -3;
    localatxe1.jdField_a_of_type_Atxe = this.jdField_a_of_type_Atxe;
    this.b.put(Integer.valueOf(localatxe1.jdField_a_of_type_Int), localatxe1);
    localatxe1.jdField_a_of_type_JavaUtilList = new ArrayList();
    Object localObject1 = new atxe();
    ((atxe)localObject1).jdField_a_of_type_Int = -7;
    this.b.put(Integer.valueOf(((atxe)localObject1).jdField_a_of_type_Int), localObject1);
    ((atxe)localObject1).jdField_a_of_type_Atxe = localatxe1;
    localatxe1.jdField_a_of_type_JavaUtilList.add(localObject1);
    ((atxe)localObject1).jdField_a_of_type_JavaUtilList = new ArrayList();
    atxe localatxe2 = new atxe();
    localatxe2.jdField_a_of_type_Int = -4;
    this.b.put(Integer.valueOf(localatxe2.jdField_a_of_type_Int), localatxe2);
    localatxe2.jdField_a_of_type_Atxe = localatxe1;
    localatxe1.jdField_a_of_type_JavaUtilList.add(localatxe2);
    localatxe2.jdField_a_of_type_JavaUtilList = new ArrayList();
    Object localObject2 = new atxe();
    ((atxe)localObject2).jdField_a_of_type_Int = 10015;
    this.b.put(Integer.valueOf(((atxe)localObject2).jdField_a_of_type_Int), localObject2);
    ((atxe)localObject2).jdField_a_of_type_Atxe = ((atxe)localObject1);
    ((atxe)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    localObject2 = new atxe();
    ((atxe)localObject2).jdField_a_of_type_Int = 10016;
    this.b.put(Integer.valueOf(((atxe)localObject2).jdField_a_of_type_Int), localObject2);
    ((atxe)localObject2).jdField_a_of_type_Atxe = ((atxe)localObject1);
    ((atxe)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    localObject2 = new atxe();
    ((atxe)localObject2).jdField_a_of_type_Int = 100601;
    ((atxe)localObject2).jdField_a_of_type_Atxe = ((atxe)localObject1);
    ((atxe)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    this.b.put(Integer.valueOf(100601), localObject2);
    localObject1 = new atxe();
    ((atxe)localObject1).jdField_a_of_type_Int = 10019;
    this.b.put(Integer.valueOf(((atxe)localObject1).jdField_a_of_type_Int), localObject1);
    ((atxe)localObject1).jdField_a_of_type_Atxe = localatxe2;
    localatxe2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new atxe();
    ((atxe)localObject1).jdField_a_of_type_Int = 10020;
    this.b.put(Integer.valueOf(((atxe)localObject1).jdField_a_of_type_Int), localObject1);
    ((atxe)localObject1).jdField_a_of_type_Atxe = localatxe2;
    localatxe2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new atxe();
    ((atxe)localObject1).jdField_a_of_type_Int = 10022;
    this.b.put(Integer.valueOf(((atxe)localObject1).jdField_a_of_type_Int), localObject1);
    ((atxe)localObject1).jdField_a_of_type_Atxe = localatxe2;
    localatxe2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new atxe();
    ((atxe)localObject1).jdField_a_of_type_Int = 10021;
    this.b.put(Integer.valueOf(((atxe)localObject1).jdField_a_of_type_Int), localObject1);
    ((atxe)localObject1).jdField_a_of_type_Atxe = localatxe2;
    localatxe2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new atxe();
    ((atxe)localObject1).jdField_a_of_type_Int = 10023;
    ((atxe)localObject1).jdField_a_of_type_Atxe = localatxe2;
    this.b.put(Integer.valueOf(((atxe)localObject1).jdField_a_of_type_Int), localObject1);
    localatxe2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new atxe();
    ((atxe)localObject1).jdField_a_of_type_Int = 10024;
    ((atxe)localObject1).jdField_a_of_type_Atxe = localatxe2;
    this.b.put(Integer.valueOf(((atxe)localObject1).jdField_a_of_type_Int), localObject1);
    localatxe2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new atxe();
    ((atxe)localObject1).jdField_a_of_type_Int = 10025;
    ((atxe)localObject1).jdField_a_of_type_Atxe = localatxe2;
    this.b.put(Integer.valueOf(((atxe)localObject1).jdField_a_of_type_Int), localObject1);
    localatxe2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new atxe();
    ((atxe)localObject1).jdField_a_of_type_Int = 10026;
    ((atxe)localObject1).jdField_a_of_type_Atxe = localatxe2;
    this.b.put(Integer.valueOf(((atxe)localObject1).jdField_a_of_type_Int), localObject1);
    localatxe2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localatxe2 = new atxe();
    localatxe2.jdField_a_of_type_Int = -2;
    localatxe2.jdField_a_of_type_Atxe = this.jdField_a_of_type_Atxe;
    this.b.put(Integer.valueOf(localatxe2.jdField_a_of_type_Int), localatxe2);
    this.jdField_a_of_type_Atxe.jdField_a_of_type_JavaUtilList = Arrays.asList(new atxe[] { localatxe1, localatxe2 });
    localatxe2.jdField_a_of_type_JavaUtilList = new ArrayList();
    localObject1 = new atxe();
    ((atxe)localObject1).jdField_a_of_type_Int = 100510;
    this.b.put(Integer.valueOf(((atxe)localObject1).jdField_a_of_type_Int), localObject1);
    ((atxe)localObject1).jdField_a_of_type_Atxe = localatxe2;
    localatxe2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localatxe1 = new atxe();
    localatxe1.jdField_a_of_type_Int = 10011;
    localatxe1.jdField_a_of_type_Atxe = ((atxe)localObject1);
    this.b.put(Integer.valueOf(localatxe1.jdField_a_of_type_Int), localatxe1);
    localObject2 = new ArrayList();
    ((List)localObject2).add(localatxe1);
    ((atxe)localObject1).jdField_a_of_type_JavaUtilList = ((List)localObject2);
    localObject1 = new ArrayList();
    localObject2 = new atxe();
    ((atxe)localObject2).jdField_a_of_type_Int = 100523;
    ((atxe)localObject2).jdField_a_of_type_Atxe = localatxe1;
    this.b.put(Integer.valueOf(((atxe)localObject2).jdField_a_of_type_Int), localObject2);
    ((List)localObject1).add(localObject2);
    localObject2 = new atxe();
    ((atxe)localObject2).jdField_a_of_type_Int = 100517;
    ((atxe)localObject2).jdField_a_of_type_Atxe = localatxe1;
    this.b.put(Integer.valueOf(((atxe)localObject2).jdField_a_of_type_Int), localObject2);
    ((List)localObject1).add(localObject2);
    localatxe1.jdField_a_of_type_JavaUtilList = ((List)localObject1);
    localatxe1 = new atxe();
    localatxe1.jdField_a_of_type_Int = -5;
    localatxe1.jdField_a_of_type_Atxe = localatxe2;
    localatxe2.jdField_a_of_type_JavaUtilList.add(localatxe1);
    localatxe1.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.b.put(Integer.valueOf(localatxe1.jdField_a_of_type_Int), localatxe1);
    localatxe1 = new atxe();
    localatxe1.jdField_a_of_type_Int = -6;
    localatxe1.jdField_a_of_type_Atxe = localatxe2;
    localatxe2.jdField_a_of_type_JavaUtilList.add(localatxe1);
    localatxe1.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.b.put(Integer.valueOf(localatxe1.jdField_a_of_type_Int), localatxe1);
    localObject1 = new atxe();
    ((atxe)localObject1).jdField_a_of_type_Int = 10014;
    ((atxe)localObject1).jdField_a_of_type_Atxe = localatxe1;
    localatxe1.jdField_a_of_type_JavaUtilList.add(localObject1);
    this.b.put(Integer.valueOf(((atxe)localObject1).jdField_a_of_type_Int), localObject1);
    localatxe1 = new atxe();
    localatxe1.jdField_a_of_type_Int = 10013;
    localatxe1.jdField_a_of_type_Atxe = localatxe2;
    localatxe2.jdField_a_of_type_JavaUtilList.add(localatxe1);
    this.b.put(Integer.valueOf(localatxe1.jdField_a_of_type_Int), localatxe1);
  }
  ...
  private void e()
  {
    ...
    a();
    ??? = (ConcurrentHashMap)bbdj.a("red_point_configs_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (??? != null)
    {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.putAll((Map)???);
    }
    ??? = (ConcurrentHashMap)bbdj.a("red_point_info_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (??? != null)
    {
      this.c.clear();
      this.c.putAll((Map)???);
  ...
  private void e(int paramInt)
  {
    ...
    if ((localRedTouchItem1 != null) && (localRedTouchItem1.passThroughLevel > 0))
    {
      ...
      {
        atxe localatxe = (atxe)this.b.get(Integer.valueOf(i));
        if ((localatxe == null) || (localatxe.jdField_a_of_type_Atxe == null)) {
          break;
        }
        RedTouchItem localRedTouchItem2 = (RedTouchItem)this.c.get(Integer.valueOf(localatxe.jdField_a_of_type_Atxe.jdField_a_of_type_Int));
        if (localRedTouchItem2 != null) {
          localRedTouchItem2.unReadFlag = false;
        }
        if (localatxe.jdField_a_of_type_Atxe.jdField_a_of_type_JavaUtilList != null)
        {
          i = 0;
          while (i < localatxe.jdField_a_of_type_Atxe.jdField_a_of_type_JavaUtilList.size())
          {
            j = ((atxe)localatxe.jdField_a_of_type_Atxe.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_Int;
            ...
            if ((localRedTouchItem2 != null) && (localRedTouchItem2.unReadFlag) && (!localRedTouchItem2.isClosed) && (localRedTouchItem2.passThroughLevel > 0)) {
              a(localRedTouchItem2, localatxe.jdField_a_of_type_Atxe.jdField_a_of_type_Int);
            }
            i += 1;
          }
        }
        i = localatxe.jdField_a_of_type_Atxe.jdField_a_of_type_Int;
        paramInt += 1;
      }
    }
  }
  ...
  private void f()
  {
    bbdj.a("red_point_info_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.c);
  }
  ...
  private void g()
  {
    ...
    if ((localConcurrentHashMap != null) && (localConcurrentHashMap.size() > 0))
    {
      ...
      {
        ((atxh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a(localArrayList, false);
        long l = SystemClock.elapsedRealtime();
        atbg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "pull_red_touch_time2", Long.valueOf(l));
      }
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    ((atxh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a();
  }
  ...
  public String a()
  {
    if (this.jdField_a_of_type_JavaLangString == null) {
      this.jdField_a_of_type_JavaLangString = ((String)atbg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "red_point_config_version", ""));
    }
    if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    if (this.jdField_a_of_type_JavaUtilVector.size() > 0)
    {
      ...
      f();
      this.jdField_a_of_type_Atxf.a(this.jdField_a_of_type_JavaUtilVector);
  ...
  public void a(int paramInt, boolean paramBoolean1, long paramLong, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (paramBoolean2 = true;; paramBoolean2 = false)
    {
      ...
      ((atxh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a(localArrayList);
      return;
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      atbg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "red_point_config_version", paramString);
    }
  }
  ...
  public void a(cmd0x6f5.RspBody paramRspBody)
  {
    ...
    if ((paramRspBody != null) && (paramRspBody.rpt_task_info != null) && (paramRspBody.rpt_task_info.has()))
    {
      ...
      bbdj.a("red_point_configs_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), localConcurrentHashMap);
    }
  }
  ...
  public void a(short paramShort)
  {
    ...
    long l1 = ((Long)atbg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "pull_red_touch_time2", Long.valueOf(0L))).longValue();
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ...
      for (int i = 0;; i = localRedPointConfig.redPointId)
      {
        ...
        akfi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        this.jdField_a_of_type_Atxf.a(Collections.singletonList(paramArrayOfByte));
        return;
      }
