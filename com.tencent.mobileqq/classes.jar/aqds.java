...
public class aqds
  extends aqbe
{
  private URLDrawableDownListener.Adapter jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new aqdt(this);
  ...
  public aqds(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  private void G()
  {
    ...
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        ...
        acqv.a(this.jdField_a_of_type_AndroidAppActivity, (Intent)localObject, str);
      }
    }
  ...
  private boolean a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    for (;;)
    {
      ...
      {
        axup localaxup = (axup)paramAbsStructMsg.get(j);
  ...
  private View b()
  {
    ...
    for (;;)
    {
      ...
      if (j != 0)
      {
        ...
        LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(bbll.a(8.0F), bbll.a(14.0F));
        localLayoutParams.setMargins(bbll.a(7.0F), 0, 0, 0);
        ...
        localFrameLayout.addView((View)localObject2, new FrameLayout.LayoutParams(-1, bbll.a(33.0F), 16));
        ((View)localObject2).setOnClickListener(new aqdu(this));
        ((View)localObject2).setContentDescription(ajya.a(2131704774));
      }
      ...
      if ((localObject1 != null) && ((this.jdField_a_of_type_Bbgu instanceof aqdd))) {
        ((aqdd)this.jdField_a_of_type_Bbgu).a((String)localObject1);
      }
  ...
  private void b(bbgu parambbgu)
  {
    int k = 1;
    parambbgu.setBodyLayoutNoMargin();
    Object localObject1 = new URLImageView(this.jdField_a_of_type_AndroidAppActivity);
    Object localObject2 = new LinearLayout.LayoutParams(-1, actj.a(152.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
    ...
    {
      ((LinearLayout.LayoutParams)localObject2).leftMargin = actj.a(24.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      ((LinearLayout.LayoutParams)localObject2).rightMargin = actj.a(24.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    }
    ...
    Object localObject3 = aimd.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg, "cover");
    Drawable localDrawable = this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130849353);
    if (!TextUtils.isEmpty((CharSequence)localObject3))
    {
      localObject3 = URLDrawable.getDrawable((String)localObject3, (int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131296763), actj.a(165.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), localDrawable, localDrawable, true);
    ...
    for (;;)
    {
      parambbgu.addView((View)localObject1, (LinearLayout.LayoutParams)localObject2);
      localObject1 = aimd.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg, "title");
      ...
      ((TextView)localObject2).setPadding(actj.a(24.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), actj.a(8.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), actj.a(24.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), actj.a(20.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
      parambbgu.addView((View)localObject2);
      return;
      ((URLImageView)localObject1).setScaleType(ImageView.ScaleType.CENTER_INSIDE);
  ...
  private void e()
  {
    int j = 1;
    if (c() != 0) {}
    for (Object localObject1 = this.jdField_a_of_type_Bbgu.getInputValue();; localObject1 = "")
    {
      ...
      {
        localObject2 = actj.a(new Intent(this.jdField_a_of_type_AndroidAppActivity, SplashActivity.class), new int[] { 2 });
        ...
        {
          localObject3 = axva.a(((Intent)localObject2).getExtras());
          Object localObject5;
          Object localObject6;
          ...
          while (((Iterator)localObject4).hasNext())
          {
            ...
            adgc.a().a((SessionInfo)localObject6, (String)localObject1, k);
            bbjx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((ResultRecord)localObject5).a, ((SessionInfo)localObject6).b, ((ResultRecord)localObject5).a(), (AbsStructMsg)localObject3, null);
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          else if (aqdn.a((Intent)localObject2))
          {
            localObject3 = ForwardUtils.a((Intent)localObject2, ((ResultRecord)localObject3).a, ((ResultRecord)localObject3).a(), ((ResultRecord)localObject3).c);
            ForwardUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, (SessionInfo)localObject3, (Intent)localObject2);
          }
      ...
      for (;;)
      {
        ...
        default: 
          ...
          if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("k_struct_forward", false))
          {
            ...
            axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005456", "0X8005456", 0, 0, (String)localObject4, (String)localObject2, (String)localObject3, "" + j);
          }
        ...
        for (;;)
        {
          ...
          {
            axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", this.jdField_a_of_type_AndroidOsBundle.getString("uin"), "Music_gene", "Music_gene_send", 0, 1, 0, "", "", "", "");
          }
        }
        v();
        return;
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("isWebCompShare", false))
    {
      ...
      localBundle.putString("intext_1", "" + bdey.a(this.jdField_c_of_type_Int));
      localBundle.putString("intext_2", "" + bdey.a(paramBundle.getInt("uintype"), paramBundle.getString("uin")));
      localBundle.putString("intext_3", "1");
      bdes.a().a(localBundle, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
    }
    ...
    for (;;)
    {
      ...
      if ((paramAbsStructMsg != null) && (paramAbsStructMsg.size() != 0))
      {
        ...
        do
        {
          ...
          localObject1 = (axup)paramAbsStructMsg.next();
        } while (!(localObject1 instanceof axxi));
        for (paramAbsStructMsg = (axxi)localObject1;; paramAbsStructMsg = null)
        {
          if (paramAbsStructMsg == null) {
            break label466;
          }
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            paramAbsStructMsg = (axzj)localObject2;
          }
          for (;;)
          {
            break label102;
            ...
            if (j < localStringBuilder.length())
            {
              ...
              if ('ÿ' == localStringBuilder.charAt(j))
              {
                ...
                if (j + 3 < localStringBuilder.length())
                {
                  ...
                  arrayOfInt = anqz.a((char[])localObject1);
                  localObject2 = aykk.c;
                  if (localaskf == null) {
                    break label454;
                  }
            ...
            for (localObject1 = localaskf.a(Integer.toString(arrayOfInt[0]), Integer.toString(arrayOfInt[1]));; localObject1 = null)
            {
              if (localObject1 != null) {}
  ...
  public boolean a()
  {
    ...
    Object localObject = axva.a(this.jdField_a_of_type_AndroidOsBundle.getByteArray("stuctmsg_bytes"));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((Bundle)localObject).putString("intext_1", "" + bdey.a(this.jdField_c_of_type_Int));
        ((Bundle)localObject).putString("intext_3", "1");
        bdes.a().a((Bundle)localObject, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
        return true;
  ...
  protected boolean a(bbgu parambbgu)
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject instanceof StructMsgForAudioShare)) {
        localLayoutParams.setMargins(0, actj.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, actj.a(10.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
      }
      ...
      parambbgu.addView(((AbsStructMsg)localObject).getPreDialogView(this.jdField_a_of_type_AndroidAppActivity, null), localLayoutParams);
      if (!bool) {
        a(((AbsStructMsg)localObject).getSourceName(), parambbgu);
      }
    }
    return true;
  }
  ...
  protected int d()
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (bgpu.a(str).b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), -1, null))) {}
    for (int j = 0;; j = -1)
    {
      if (j == 0) {
  ...
  protected void d()
  {
    ...
    if (this.jdField_a_of_type_AndroidOsBundle.getInt("uintype") == 1)
    {
      ...
      if (((baky)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a((String)localObject1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()))
      {
        bcql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131697657, 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298865));
        return;
      }
    }
    if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("isWebCompShare", false))
    ...
    for (Object localObject1 = this.jdField_a_of_type_Bbgu.getInputValue();; localObject1 = "")
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl.startsWith("http://article.mp.qq.com")) || (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl.startsWith("http://post.mp.qq.com")))
      {
        ...
        nol.a(null, "", "0X8007236", "0X8007236", 0, 0, this.jdField_i_of_type_JavaLangString, "" + this.jdField_d_of_type_Int, (String)localObject2, "");
        nol.a("0X8007236", "", this.jdField_i_of_type_JavaLangString, "" + this.jdField_d_of_type_Int, (String)localObject2, "");
        if ((!TextUtils.isEmpty((CharSequence)localObject1)) || (!"".equals(localObject1))) {
          nol.a(null, "", "0X8007237", "0X8007237", 0, 0, this.jdField_i_of_type_JavaLangString, "" + this.jdField_d_of_type_Int, (String)localObject2, "");
        }
      }
      this.jdField_a_of_type_AndroidContentIntent.getAction();
      Object localObject2 = Boolean.valueOf(this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("key_flag_from_plugin", false));
      ...
      if (((Boolean)localObject2).booleanValue())
      {
        ...
        if (((Boolean)localObject3).booleanValue())
        {
          ...
          adgc.a().a((SessionInfo)localObject4, (String)localObject1, j);
          bbjx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidOsBundle.getString("uin"), ((SessionInfo)localObject4).b, this.jdField_a_of_type_AndroidOsBundle.getInt("uintype"), (AbsStructMsg)localObject3, null);
          if (!TextUtils.isEmpty((CharSequence)localObject1)) {
            myb.a().a = true;
          }
          localObject1 = new Intent();
  ...
  {
    super.r();
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007C3A", "0X8007C3A", 0, 0, "1", "", "", "");
    if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("k_struct_forward", false)) {
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005457", "0X8005457", 0, 0, "", "", "android", "");
    }
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl.startsWith("http://article.mp.qq.com")) || (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl.startsWith("http://post.mp.qq.com")))
    {
      String str = this.jdField_a_of_type_AndroidOsBundle.getString("uin");
      nol.a(null, "", "0X8007235", "0X8007235", 0, 0, this.jdField_i_of_type_JavaLangString, "" + this.jdField_d_of_type_Int, str, "");
    }
  }
