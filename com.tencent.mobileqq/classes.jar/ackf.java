...
{
  public ackf(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, String paramString)
  {
    ...
    for (paramBusiRespHead = paramBusiRespHead.e + "_" + ((Face2FaceGroupProfile)paramBusiRespHead).jdField_b_of_type_JavaLangString;; paramBusiRespHead = paramString)
    {
      ...
      break;
      ReportController.b(null, "P_CliOper", "Grp_set", "", "Radar_grp_guest", "suc_join", 0, 0, paramString, "7.6.3", "", this.a.app.getCurrentAccountUin());
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, List paramList)
  {
    ...
    if (paramList == null)
    {
      ...
      if (this.a.jdField_b_of_type_Int == 1) {
        DialogUtil.b(this.a, 230, this.a.getString(2131434781), "分享失败，请稍后重试", 2131433015, 2131433519, new ackg(this), null).show();
      }
    }
    label176:
    label182:
    ...
    label418:
    DialogUtil.b(this.a, 230, this.a.getString(2131434781), "分享失败，请稍后重试", 2131433015, 2131433519, new ackh(this), null).show();
  }
}
