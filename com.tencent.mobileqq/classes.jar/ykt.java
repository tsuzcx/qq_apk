...
public class ykt
{
  ...
  private static final Property<ImageView, Matrix> jdField_a_of_type_AndroidUtilProperty = new ykx(Matrix.class, "animatedTransform");
  ...
  private yla jdField_a_of_type_Yla;
  private ylb jdField_a_of_type_Ylb;
  private int jdField_b_of_type_Int;
  private ImageView jdField_b_of_type_AndroidWidgetImageView;
  private int c;
  private int d;
  
  public ykt(Bundle paramBundle, ylb paramylb)
  {
    if ((paramBundle == null) || (paramylb == null)) {
      return;
    }
    this.jdField_a_of_type_Ylb = paramylb;
    a(paramBundle);
    a();
    b();
    c();
      ...
      for (;;)
      {
        try
        {
          ...
          if (Build.VERSION.SDK_INT >= 16)
          {
            ...
            localBundle.putString("bundle_key_source_image_param", new yla((String)localObject, paramInt1, paramInt2).a());
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    ((ObjectAnimator)localObject1).addListener(new ykv(this, paramInt4, paramInt3, paramInt1, paramInt2));
    ...
    localObject2 = ObjectAnimator.ofObject(this.jdField_a_of_type_AndroidWidgetImageView, jdField_a_of_type_AndroidUtilProperty, new yky(), new Matrix[] { localObject2, localObject3 });
    ...
    this.jdField_a_of_type_AndroidAnimationAnimatorSet.addListener(new ykw(this));
  ...
  private void a(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_Yla = new yla();
    this.jdField_a_of_type_Yla.a(str);
    this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Yla.jdField_a_of_type_JavaLangString;
    this.jdField_a_of_type_JavaIoFile = new File(this.jdField_a_of_type_JavaLangString);
    this.jdField_a_of_type_Int = this.jdField_a_of_type_Yla.jdField_a_of_type_Int;
    this.jdField_b_of_type_Int = this.jdField_a_of_type_Yla.jdField_b_of_type_Int;
  ...
  private void c()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetFrameLayout != null)
    {
      ...
      localLayoutParams.topMargin = this.jdField_a_of_type_Ylb.a();
  ...
  private void d()
  {
    int[] arrayOfInt = this.jdField_a_of_type_Ylb.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
  ...
  private void e()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.getViewTreeObserver().addOnPreDrawListener(new yku(this));
  }
