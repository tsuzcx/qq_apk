  ...
  implements View.OnClickListener
{
  ...
  public ykt(RelativePersonalDetailHeadItemView paramRelativePersonalDetailHeadItemView, View paramView)
  {
    super(paramView);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378839));
    this.b = ((TextView)paramView.findViewById(2131378861));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131363645));
  ...
  public void a(CertifiedAccountMeta.StQQGroup paramStQQGroup)
  {
    ...
    if (paramStQQGroup != null)
    {
      ...
      this.b.setText(paramStQQGroup.memberNum.get() + alpo.a(2131713754));
    ...
    {
      yvu.a(str, "auth_fan", paramStQQGroup, 0, 0, new String[0]);
      return;
      str = alpo.a(2131713749);
      break;
    }
  }
  ...
  public void onClick(View paramView)
  {
    if ((this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StQQGroup != null) && (paramView != null) && (paramView.getContext() != null))
    {
      ...
      {
        localObject = aekt.a(new Intent(paramView.getContext(), SplashActivity.class), new int[] { 2 });
    ...
    bclo.a(paramView.getContext(), (Bundle)localObject, 2);
  }
}
