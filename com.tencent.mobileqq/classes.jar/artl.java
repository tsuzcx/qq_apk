...
public class artl
  extends arum
{
  public artl(MultiAIOItemFragment paramMultiAIOItemFragment, begh parambegh, ListView paramListView) {}
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Begh.onScrollStateChanged(this.jdField_a_of_type_ComTencentWidgetListView, paramInt);
