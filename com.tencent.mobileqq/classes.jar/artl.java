...
class artl
  extends Handler
{
  private final WeakReference<artj> a;
  
  artl(artj paramartj, Looper paramLooper)
  {
    super(paramLooper);
    this.a = new WeakReference(paramartj);
  }
  
  public void handleMessage(Message paramMessage)
  {
    artj localartj = (artj)this.a.get();
    if (localartj == null) {
    ...
    do
    {
      ...
      artj.a(localartj, paramMessage);
      return;
      paramMessage = paramMessage.getData();
      String str = paramMessage.getString("key_id");
      i = paramMessage.getInt("key_play_state", -1);
      if (QLog.isColorLevel()) {
        QLog.i("QQMusicPlay.QQMusicPlayClient", 2, String.format("--->handleMessage[MSG_FROM_SERVICE_PLAY_STATE_CHANGE] %s %s", new Object[] { str, artd.a(i) }));
      }
      artj.a(localartj, str, i);
    } while ((i != 4) || (!artj.a(localartj)));
    artj.a(localartj);
    return;
    ...
    artj.a(localartj, paramMessage, i, j);
  }
}
