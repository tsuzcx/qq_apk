...
public class bhxi
{
  ...
  public static void a(List<BaseInterface> paramList, WebView paramWebView, String paramString, ausu paramausu)
  {
    if (!bhzp.a(paramString))
    {
      Iterator localIterator = paramList.iterator();
      while (localIterator.hasNext())
      {
        BaseInterface localBaseInterface = (BaseInterface)localIterator.next();
        paramausu.a(localBaseInterface, localBaseInterface.getInterfaceName());
        bhwz.a.put(localBaseInterface.getInterfaceName(), localBaseInterface.getClass());
        localBaseInterface.setCurrentUrl(paramString);
      }
    }
