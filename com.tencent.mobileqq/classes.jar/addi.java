...
public class addi
{
  ...
  /* Error */
  public static addc a(java.lang.String paramString)
  {
    // Byte code:
    //   0: aload_0
    ...
    //   212: aload 9
    //   214: iconst_0
    //   215: invokestatic 129	addi:a	([BI)I
    //   218: istore_3
    //   219: iload_3
    //   220: ifle +10 -> 230
    //   223: iload_3
    ...
    //   555: new 149	addc
    //   558: dup
    //   559: invokespecial 150	addc:<init>	()V
    //   562: astore_0
    //   563: aload 7
    //   565: astore 6
    //   567: aload_0
    //   568: aload 8
    //   570: invokestatic 153	addi:a	(Laddc;Lmsg/aio_doodle/DoodleMsgProto$DoodleHeader;)V
    //   573: aconst_null
    //   574: astore 8
    //   576: iconst_m1
    //   577: istore_3
    ...
    //   597: aload 9
    //   599: iconst_0
    //   600: invokestatic 129	addi:a	([BI)I
    //   603: istore 4
    //   605: iload 4
    //   607: ifle +11 -> 618
    //   610: iload 4
    ...
    //   670: iconst_1
    //   671: iconst_0
    //   672: invokevirtual 158	addc:a	(Ladem;ZZ)V
    //   675: aload 7
    //   677: astore 6
    //   679: aload 7
    ...
    //   713: ifnull -703 -> 10
    //   716: aload_0
    //   717: invokevirtual 163	addc:a	()Laddv;
    //   720: invokevirtual 168	addv:d	()F
    //   723: fstore_1
    //   724: aload_0
    //   725: invokevirtual 163	addc:a	()Laddv;
    //   728: invokevirtual 171	addv:c	()F
    //   731: fstore_2
    //   732: fload_1
    //   733: fload_2
    //   734: fcmpl
    //   735: ifle +19 -> 754
    //   738: aload_0
    //   739: invokevirtual 163	addc:a	()Laddv;
    //   742: fload_1
    //   743: invokevirtual 174	addv:c	(F)V
    //   746: aload_0
    //   747: invokevirtual 163	addc:a	()Laddv;
    //   750: fload_2
    //   751: invokevirtual 176	addv:d	(F)V
    //   754: aload_0
    //   755: invokestatic 179	addi:a	(Laddc;)V
    //   758: aload_0
    //   759: areturn
    //   760: aload 7
    //   762: astore 6
    ...
    //   989: astore 6
    //   991: aload 10
    //   993: invokestatic 188	addi:a	(Lmsg/aio_doodle/DoodleMsgProto$DoodleData;)I
    //   996: istore 4
    //   998: aload 7
    //   1000: astore 6
    //   1002: ldc 76
    ...
    //   1159: aload 10
    //   1161: iload 5
    //   1163: invokestatic 197	addi:a	(Ladem;Lmsg/aio_doodle/DoodleMsgProto$DoodleData;Z)V
    //   1166: goto -588 -> 578
    //   1169: aload 8
    //   1171: ifnull +15 -> 1186
    //   1174: aload 7
    ...
    //   1181: iconst_1
    //   1182: iconst_0
    //   1183: invokevirtual 158	addc:a	(Ladem;ZZ)V
    //   1186: aload 7
    //   1188: astore 6
    //   1190: new 199	adem
    //   1193: dup
    //   1194: invokespecial 200	adem:<init>	()V
    //   1197: astore 8
    //   1199: aload 7
    //   1201: astore 6
    //   1203: aload 8
    //   1205: iload 4
    //   1207: putfield 203	adem:a	I
    //   1210: iconst_1
    //   1211: istore 5
    //   1213: iload 4
    //   1215: istore_3
  ...
  private static DoodleMsgProto.DoodleData a(int paramInt, adem paramadem)
  {
  ...
  private static void a(addc paramaddc)
  {
    if (paramaddc == null) {}
    ...
    {
      return;
      Iterator localIterator1 = paramaddc.a().iterator();
      while (localIterator1.hasNext())
      {
        adem localadem = (adem)localIterator1.next();
        if (localadem.c() >= 500)
        {
          if (QLog.isColorLevel()) {
            QLog.d("DoodleMsgTranslator", 2, "reduce point before:" + localadem.c());
          }
          paramaddc = null;
          localIterator2 = localadem.a().iterator();
          if (localIterator2.hasNext())
          {
            localaden = (aden)localIterator2.next();
            if (localIterator2.hasNext()) {
              break label157;
            }
          }
          if (QLog.isColorLevel()) {
            QLog.d("DoodleMsgTranslator", 2, "reduce point end:" + localadem.c());
          }
        }
      }
    }
    ...
    {
      break;
      if ((Math.abs(localaden.a() - paramaddc.a()) < 10.0F) && (Math.abs(localaden.b() - paramaddc.b()) < 10.0F)) {
        localIterator2.remove();
      }
    }
  }
  
  private static void a(addc paramaddc, DoodleMsgProto.DoodleHeader paramDoodleHeader)
  {
    if ((paramaddc == null) || (paramDoodleHeader == null)) {}
    do
    {
      return;
      BaseApplication localBaseApplication = BaseApplicationImpl.getContext();
      if ((paramDoodleHeader.float_draw_area_width.has()) && (paramDoodleHeader.float_draw_area_height.has())) {
        paramaddc.a().a((int)muf.a(localBaseApplication, paramDoodleHeader.float_draw_area_width.get()), (int)muf.a(localBaseApplication, paramDoodleHeader.float_draw_area_height.get()));
      }
      if (paramDoodleHeader.float_line_width_max.has()) {
        paramaddc.a().a(muf.a(localBaseApplication, paramDoodleHeader.float_line_width_max.get()));
      }
      if (paramDoodleHeader.float_line_width_min.has()) {
        paramaddc.a().b(muf.a(localBaseApplication, paramDoodleHeader.float_line_width_min.get()));
      }
      if (paramDoodleHeader.float_comp_factor_max.has()) {
        paramaddc.a().c(paramDoodleHeader.float_comp_factor_max.get());
      }
      if (paramDoodleHeader.float_comp_factor_min.has()) {
        paramaddc.a().d(paramDoodleHeader.float_comp_factor_min.get());
      }
    } while (!paramDoodleHeader.uint32_time.has());
    paramaddc.a(paramDoodleHeader.uint32_time.get());
  }
  
  private static void a(adem paramadem, DoodleMsgProto.DoodleData paramDoodleData, boolean paramBoolean)
  {
    if ((paramadem == null) || (paramDoodleData == null)) {}
    for (;;)
    {
      return;
      if (paramBoolean)
      {
        if (paramDoodleData.uint32_rgba.has()) {
          paramadem.b(paramDoodleData.uint32_rgba.get());
        }
        if (paramDoodleData.uint32template_id.has())
        {
          paramadem.a(paramDoodleData.uint32template_id.get());
          if (paramadem.a() > 0) {
            paramadem.b(-1);
          }
        }
        ...
        if (paramDoodleData != null)
        {
          ...
          while (paramDoodleData.hasNext())
          {
            ...
            if ((localLineData.float_X.has()) && (localLineData.float_Y.has()) && (localLineData.uint64_tickcount.has())) {
              paramadem.a(muf.a(localBaseApplication, localLineData.float_X.get()), muf.a(localBaseApplication, localLineData.float_Y.get()), -1.0F, localLineData.uint64_tickcount.get());
            }
          }
        }
      }
  ...
  private static boolean a(int paramInt, adem paramadem, addj paramaddj)
  {
    QLog.d("DoodleMsgTranslator", 2, "formatHeader line begin :" + paramInt);
    boolean bool;
    if ((paramaddj == null) || (paramadem == null))
    {
      bool = false;
      return bool;
    }
    ...
    for (int i = localArrayList.size();; i = 0)
    {
      ...
      bool = true;
      int j = 0;
      DoodleMsgProto.DoodleData localDoodleData = a(paramInt, paramadem);
      if (localDoodleData == null)
      {
        if (paramaddj == null) {
          break;
        }
        return paramaddj.a(null);
      }
      int k = 0;
      while ((k + j < i) && (k < 1000))
      {
        DoodleMsgProto.LineData localLineData = new DoodleMsgProto.LineData();
        aden localaden = (aden)localArrayList.get(j + k);
        localLineData.float_X.set(a(localBaseApplication, localaden.a()));
        localLineData.float_X.setHasFlag(true);
        localLineData.float_Y.set(a(localBaseApplication, localaden.b()));
        localLineData.float_Y.setHasFlag(true);
        localLineData.uint64_tickcount.set(localaden.a());
      ...
      if (paramaddj != null) {
        if ((paramaddj.a(localDoodleData)) && (bool)) {
          bool = true;
        }
      }
      for (;;)
  ...
  public static boolean a(addc paramaddc, addj paramaddj)
  {
    if ((paramaddc == null) || (paramaddj == null)) {}
    do
    {
      do
      {
        return false;
      } while (paramaddc.a() == null);
      try
      {
        boolean bool1 = b(paramaddc, paramaddj);
        paramaddc = paramaddc.a().iterator();
        int i = 0;
        if (paramaddc.hasNext())
        {
          boolean bool2 = a(i, (adem)paramaddc.next(), paramaddj);
          if ((bool2) && (bool1)) {}
      ...
      catch (Exception paramaddc)
      {
        paramaddc.printStackTrace();
      }
    } while (!QLog.isColorLevel());
    QLog.e("DoodleMsgTranslator", 2, "translate data exception:" + paramaddc);
    return false;
  }
  ...
  public static boolean b(addc paramaddc, addj paramaddj)
  {
    boolean bool = false;
    if (paramaddc == null)
    {
      if (paramaddj != null) {
        bool = paramaddj.a(null);
      }
      return bool;
    }
    BaseApplication localBaseApplication = BaseApplicationImpl.getContext();
    ...
    localDoodleHeader.uint32_time.set((int)paramaddc.a());
    localDoodleHeader.uint32_time.setHasFlag(true);
    ArrayList localArrayList = paramaddc.a();
    if (localArrayList != null) {}
    for (int i = localArrayList.size();; i = 0)
    {
      paramaddc = paramaddc.a();
      localDoodleHeader.uint32_line_count.set(i);
      localDoodleHeader.uint32_line_count.setHasFlag(true);
      localDoodleHeader.float_line_width_max.set(a(localBaseApplication, paramaddc.a()));
      localDoodleHeader.float_line_width_max.setHasFlag(true);
      localDoodleHeader.float_line_width_min.set(a(localBaseApplication, paramaddc.b()));
      localDoodleHeader.float_line_width_min.setHasFlag(true);
      localDoodleHeader.float_comp_factor_max.set(paramaddc.c());
      localDoodleHeader.float_comp_factor_max.setHasFlag(true);
      localDoodleHeader.float_comp_factor_min.set(paramaddc.d());
      localDoodleHeader.float_comp_factor_min.setHasFlag(true);
      localDoodleHeader.float_draw_area_width.set(a(localBaseApplication, paramaddc.a().width()));
      localDoodleHeader.float_draw_area_width.setHasFlag(true);
      localDoodleHeader.float_draw_area_height.set(a(localBaseApplication, paramaddc.a().height()));
      localDoodleHeader.float_draw_area_height.setHasFlag(true);
      if (paramaddj == null) {
        break;
      }
      return paramaddj.a(localDoodleHeader);
    }
  }
}
