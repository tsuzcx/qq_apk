  ...
  extends WebViewPlugin
{
  ...
  private static final String e = ajjy.a(2131639916);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajjy.a(2131639912);
    jdField_b_of_type_JavaLangString = ajjy.a(2131639911);
    d = ajjy.a(2131639917);
    jdField_c_of_type_JavaLangString = ajjy.a(2131639920);
  }
      ...
      for (;;)
      {
        ...
        try
        {
          if (paramIntent.hasExtra("data"))
          {
            ...
            localJSONObject.put("errMsg", paramIntent.getString("errMsg", ajjy.a(2131639919)));
            localJSONObject.put("idKey", paramIntent.getString("idKey"));
            localJSONObject.put("allResults", localObject1);
          }
          for (;;)
          {
            awqx.b(null, "dc00898", "", "", "0X8009862", "0X8009862", 0, 0, this.jdField_c_of_type_Int + "", "", this.jdField_b_of_type_Int + "", paramInt + "");
            if (QLog.isColorLevel()) {
            ...
            else
            {
              ...
              localJSONObject.put("errMsg", ajjy.a(2131639918));
              localJSONObject.put("allResults", localObject1);
              paramInt = 299;
            }
          }
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    if ("loginVerify".equals(this.k))
    {
      if ((paramJSONObject != null) && (paramJSONObject.has("errMsg")) && (this.jdField_a_of_type_AndroidAppActivity != null))
      {
        ...
        bbmy.a(this.jdField_a_of_type_AndroidAppActivity, paramJSONObject.optString("errMsg"), 0).a();
        return;
      }
