...
public class xbw
{
  public static void a(Context paramContext, LinearLayout paramLinearLayout, int paramInt1, QQUserUIItem paramQQUserUIItem, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    {
      localObject1 = ((LayoutInflater)localObject1).inflate(2131561719, null);
      localObject2 = (CircleImageView)((View)localObject1).findViewById(2131368385);
      ...
      UIUtils.setImageWithAnim((ImageView)localObject2, paramQQUserUIItem.headUrl, i, i, new xpm(null, null));
    ...
    Object localObject2 = ((LayoutInflater)localObject1).inflate(2131561720, null);
    Object localObject3 = (TextView)((View)localObject2).findViewById(2131379010);
    if (paramInt3 > 99) {}
    for (localObject1 = "99+";; localObject1 = paramInt3 + "")
    {
      ((TextView)localObject3).setText((CharSequence)localObject1);
      ((TextView)localObject3).setVisibility(0);
      localObject1 = ((View)localObject2).findViewById(2131368386);
  ...
  public static boolean a(ShareGroupFeedItem paramShareGroupFeedItem)
  {
    if (paramShareGroupFeedItem != null)
    {
      ...
      {
        xvv.b("ShareGroupUtil", "屏蔽掉圈子类型 %s", paramShareGroupFeedItem);
        return true;
      }
    }
    return false;
