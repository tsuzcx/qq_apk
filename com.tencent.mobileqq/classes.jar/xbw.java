...
public class xbw
  implements Runnable
{
  public xbw(GoldMsgPayManager paramGoldMsgPayManager, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          xbx localxbx = new xbx(this, (String)localObject4);
          ...
          localObject3 = new xby(this, (String)localObject3);
          int i = str3.length();
          int j = str3.length();
          ((SpannableString)localObject4).setSpan(localObject3, i, ((String)localObject1).length() + j, 33);
          localObject1 = new ButtonInfo(str4, new ColorDrawable(-15550475), -1, localxbx);
