...
public abstract class nkj
{
  ...
  public nkj(Context paramContext, String paramString)
  {
  ...
  public boolean a(AppInterface paramAppInterface, String paramString)
  {
    try
    {
      ...
      paramAppInterface = ((bhhh)((QQAppInterface)paramAppInterface).getManager(47)).a(1);
      paramString = anhk.ba + a() + ".tmp";
      localObject = new bhhf((String)localObject, new File(paramString));
      ((bhhf)localObject).b = 3;
      Bundle localBundle = new Bundle();
      localBundle.putString("file_path", paramString);
      paramAppInterface.a((bhhf)localObject, new nkk(this), localBundle);
      return true;
    }
