  ...
  extends axun
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new axvr(this);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      paramView = (axun)this.jdField_a_of_type_JavaUtilList.get(j);
      ...
      localView = ((View)localObject).findViewById(2131376568);
      if (localView != null)
      {
        if ((LinearLayout)((View)localObject).findViewById(2131376569) != null) {
          break label231;
        }
    ...
    for (;;)
    {
      ...
      {
        paramView = paramView.a(paramContext, null, paramBundle);
        localObject = new LinearLayout.LayoutParams(-1, actn.a(50.0F, paramContext.getResources()));
        ((TextView)paramView).setGravity(16);
        ((LinearLayout.LayoutParams)localObject).leftMargin = actn.a(12.0F, paramContext.getResources());
        ((LinearLayout.LayoutParams)localObject).rightMargin = 0;
        ((LinearLayout.LayoutParams)localObject).topMargin = 0;
        ((LinearLayout.LayoutParams)localObject).bottomMargin = 0;
        this.jdField_a_of_type_AndroidViewViewGroup.addView(paramView, (ViewGroup.LayoutParams)localObject);
  ...
  public boolean a(axwe paramaxwe)
  {
    ...
    while (i < k)
    {
      ...
      {
        if ("item".equals(localaxwe.b)) {}
        for (Object localObject = localaxwe.a("layout");; localObject = axux.a(localaxwe.b))
        {
          try
          {
            ...
            for (int j = Integer.parseInt((String)localObject);; j = 0)
            {
              ...
              bool1 = bool2;
              if (!((axun)localObject).a(localaxwe)) {
                break;
              }
              a((axun)localObject);
              break label39;
