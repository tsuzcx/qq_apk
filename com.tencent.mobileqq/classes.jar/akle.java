  ...
  implements aklc
{
  ...
  private final String jdField_a_of_type_JavaLangString = ajjy.a(2131634968);
  ...
  public akle(View paramView)
  {
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.jdField_a_of_type_ComTencentMobileqqArARRecordARVideoRecordButtonView = ((ARVideoRecordButtonView)paramView.findViewById(2131303981));
    this.c = paramView.findViewById(2131298345);
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131297182);
    this.jdField_a_of_type_Boolean = akkv.a();
    if (this.jdField_a_of_type_Boolean) {
      this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    }
    this.c.setOnClickListener(null);
    this.c.setOnTouchListener(new aklf(this));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297184));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297183));
  ...
  public void a(akld paramakld)
  {
    this.jdField_a_of_type_Akld = paramakld;
  }
