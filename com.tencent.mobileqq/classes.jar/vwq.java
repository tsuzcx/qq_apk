...
{
  static final String jdField_a_of_type_JavaLangString = sxm.a("StoryGroupSvc.do_group_video_forward");
  public int a;
  akat jdField_a_of_type_Akat = new vws(this);
  public Handler a;
  public QQAppInterface a;
  public MessageForTroopStory a;
  mxh jdField_a_of_type_Mxh = new vwr(this);
  protected boolean a;
  public int b;
  public String b;
  public int c;
  ...
  private vwq(QQAppInterface paramQQAppInterface, Bundle paramBundle, SessionInfo paramSessionInfo)
  {
  ...
  private vwq(QQAppInterface paramQQAppInterface, MessageForTroopStory paramMessageForTroopStory)
  {
  ...
  public static vwq a(QQAppInterface paramQQAppInterface, Bundle paramBundle, SessionInfo paramSessionInfo)
  {
    try
    {
      paramQQAppInterface = new vwq(paramQQAppInterface, paramBundle, paramSessionInfo);
  ...
  public static vwq a(QQAppInterface paramQQAppInterface, MessageForTroopStory paramMessageForTroopStory)
  {
    return new vwq(paramQQAppInterface, paramMessageForTroopStory);
  }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        mxf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Mxh, localReqGroupVideoForward.toByteArray(), jdField_a_of_type_JavaLangString);
        return;
      }
  ...
  public void c()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForTroopStory, this.jdField_a_of_type_Akat);
  }
