...
public class qvy
  extends pkt
{
  public qvy(ComponentHeaderPolymeric paramComponentHeaderPolymeric) {}
  ...
  public void a(long paramLong, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      if ((localArticleInfo.mTopicRecommendFeedsInfo != null) && (localArticleInfo.mTopicRecommendFeedsInfo.a != null)) {
        ((rgc)localArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).c = 1;
      }
    ...
    if ((localArticleInfo.mTopicRecommendFeedsInfo != null) && (localArticleInfo.mTopicRecommendFeedsInfo.a != null)) {
      ((rgc)localArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).c = 0;
    }
    if (localArticleInfo.mPolymericInfo != null)
    {
