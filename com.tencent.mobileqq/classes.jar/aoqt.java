...
public class aoqt
  extends aoqf
{
  public aoqt(QQAppInterface paramQQAppInterface, FriendListHandler paramFriendListHandler)
  {
        ...
        for (paramFromServiceMsg = null;; paramFromServiceMsg = null) {
          for (;;)
          {
            ...
            try
            {
              ...
              paramFromServiceMsg = new bchn().a(new Object[] { paramToServiceMsg.extraData.getString("param_keyword"), paramFromServiceMsg, Integer.valueOf(paramToServiceMsg.extraData.getInt("fromType")) });
              j = m;
            }
