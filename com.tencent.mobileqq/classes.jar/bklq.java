...
public final class bklq
  extends bkkq
  implements Handler.Callback, bklh, bkln, bkma
{
  private Application jdField_a_of_type_AndroidAppApplication;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private bkkk jdField_a_of_type_Bkkk;
  private bkle jdField_a_of_type_Bkle;
  private bklk jdField_a_of_type_Bklk;
  private bklv jdField_a_of_type_Bklv;
  ...
  private ArrayList<bklu> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public bklq(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bklx = new bklx(this.jdField_a_of_type_AndroidAppApplication, this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_CooperationPluginPluginUpdater.a(this);
    this.jdField_a_of_type_Bkle = new bkle(this.jdField_a_of_type_AndroidAppApplication, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    try
    {
      this.jdField_a_of_type_Bklk = new bklk(this.jdField_a_of_type_AndroidAppApplication, bkle.a(this.jdField_a_of_type_AndroidAppApplication).getCanonicalPath());
      label160:
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
      this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
      this.jdField_a_of_type_Bkkk = bkkk.a(this.jdField_a_of_type_AndroidAppApplication);
      this.jdField_a_of_type_Bklv = new bklv(this);
      this.jdField_a_of_type_Bklv.a();
      PluginCommunicationHandler localPluginCommunicationHandler = PluginCommunicationHandler.getInstance();
      localPluginCommunicationHandler.setCommunicationChannel(new bkmb());
      localPluginCommunicationHandler.register(new bkmc(paramQQAppInterface));
  ...
  {
    if (paramBoolean) {}
    for (paramString = amtj.a(2131707396) + paramString + "（" + bkkl.a(paramLong) + amtj.a(2131707393);; paramString = paramString + "（" + bkkl.a(paramLong) + amtj.a(2131707395)) {
      return new AlertDialog.Builder(paramContext).setMessage(paramString).setNegativeButton(amtj.a(2131707394), paramOnClickListener2).setPositiveButton(amtj.a(2131707398), paramOnClickListener1).create();
    }
  }
  ...
  private static ProgressDialog a(Context paramContext, String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    paramContext.setMessage(amtj.a(2131707397));
    paramContext.setCancelable(false);
    paramContext.setButton(-2, amtj.a(2131707399), new bklr(paramOnClickListener));
    return paramContext;
  }
  
  private void a(int paramInt, Context paramContext, bkkz parambkkz, bkkx parambkkx)
  {
    a(paramInt, false, paramContext, parambkkz, parambkkx);
  }
  
  private void a(int paramInt, boolean paramBoolean, Context paramContext, bkkz parambkkz, bkkx parambkkx)
  {
    QLog.d("plugin_tag", 1, "doInstallAndLaunch. confirmCode, pluginId:" + paramInt + "," + parambkkz.b + ", " + this.c);
    if ((!this.c) && (!bkkk.b(parambkkz.b))) {
      if (parambkkx != null) {
    ...
    do
    {
      ...
      localObject1 = this.jdField_a_of_type_Bklk.a(parambkkz.b);
      if ((localObject1 != null) && (((PluginInfo)localObject1).mInstalledPath != null))
      {
        parambkkz.c = ((PluginInfo)localObject1).mInstalledPath;
        parambkkz.a((PluginBaseInfo)localObject1);
      }
      parambkkx.a(true, paramContext, parambkkz);
      return;
      if (paramInt == 4)
      {
        localObject1 = parambkkz.b;
        localObject2 = new bklu();
        ((bklu)localObject2).jdField_a_of_type_AndroidContentContext = paramContext;
        ((bklu)localObject2).jdField_a_of_type_Bkkz = parambkkz;
        ((bklu)localObject2).jdField_a_of_type_Bkkx = parambkkx;
        ((bklu)localObject2).jdField_a_of_type_Boolean = true;
        a((String)localObject1, new bklw(this, (bklu)localObject2));
        return;
      }
      if (paramInt == 1)
      {
        localObject2 = parambkkz.b;
        ...
        {
          bklu localbklu = new bklu();
          localbklu.jdField_a_of_type_AndroidContentContext = paramContext;
          localbklu.jdField_a_of_type_Bkkz = parambkkz;
          localbklu.jdField_a_of_type_Bkkx = parambkkx;
          localbklu.jdField_a_of_type_Boolean = false;
          localbklu.jdField_a_of_type_AndroidAppProgressDialog = a(paramContext, (String)localObject1, new bkls(this, parambkkz.b, null));
          a((String)localObject2, paramBoolean, new bklw(this, localbklu));
          return;
        }
      }
    } while (paramInt != 3);
    Object localObject1 = parambkkz.b;
    Object localObject2 = new bklu();
    ((bklu)localObject2).jdField_a_of_type_AndroidContentContext = paramContext;
    ((bklu)localObject2).jdField_a_of_type_Bkkz = parambkkz;
    ((bklu)localObject2).jdField_a_of_type_Bkkx = parambkkx;
    ((bklu)localObject2).jdField_a_of_type_Boolean = true;
    a((String)localObject1, paramBoolean, new bklw(this, (bklu)localObject2));
  }
  
  private void a(String paramString, bkky parambkky)
  {
    if (QLog.isColorLevel()) {
      QLog.d("plugin_tag", 2, "doQueryPlugin: " + paramString + ", " + parambkky);
    }
    ...
    b();
    parambkky.a(paramString, localPluginInfo1, this);
  }
  ...
  {
    paramString = this.jdField_a_of_type_Bkkk.a(paramString);
    if (paramString == null) {
      return false;
    }
  ...
  private PluginInfo b(String paramString)
  {
    ...
    {
      PluginInfo localPluginInfo = this.jdField_a_of_type_Bklk.a(paramString);
      if (QLog.isColorLevel()) {
  ...
  private void c(Context paramContext, bkkz parambkkz, bkkx parambkkx)
  {
    int j = 2;
    boolean bool2 = false;
    boolean bool3 = true;
    ...
    do
    {
      ...
      {
        return;
        QLog.d("plugin_tag", 1, "checkUpdate:" + parambkkz.b + ", " + parambkkz.e);
        if ((this.c) || (bkkk.b(parambkkz.b))) {
          break;
        }
      } while (parambkkx == null);
      parambkkx.a(false, paramContext, parambkkz);
      return;
      String str = parambkkz.b;
      localPluginInfo2 = this.jdField_a_of_type_CooperationPluginPluginUpdater.a(str);
      if (localPluginInfo2 == null)
      {
        a(0, paramContext, parambkkz, parambkkx);
        return;
      }
      bool4 = this.jdField_a_of_type_Bklk.a(str);
      if (QLog.isColorLevel()) {
        QLog.d("plugin_tag", 2, "installed :" + bool4);
      }
      if (bool4)
      {
        PluginInfo localPluginInfo1 = this.jdField_a_of_type_Bklk.a(str);
        ...
        if (bool1)
        {
          ...
          if (a())
          {
            ...
            {
              if (!bkli.a(localPluginInfo2, this.jdField_a_of_type_AndroidAppApplication)) {
                break label309;
              }
          ...
          for (;;)
          {
            a(i, paramContext, parambkkz, parambkkx);
            return;
            i = 4;
      ...
      if ((!bkli.a(localPluginInfo2, this.jdField_a_of_type_AndroidAppApplication)) || (localObject == null)) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    parambkkz.c = ((PluginInfo)localObject).mInstalledPath;
    parambkkz.a((PluginBaseInfo)localObject);
    parambkkx.a(true, paramContext, parambkkz);
    return;
    ...
    for (;;)
    {
      ...
      a(3, paramContext, parambkkz, parambkkx);
      return;
      bool1 = bool3;
    ...
    {
      parambkkz = new bklt(this, parambkkx, bool1, paramContext, parambkkz, bool4, (String)localObject, null);
      a(paramContext, localPluginInfo2.mName, localPluginInfo2.mLength, parambkkz, parambkkz, bool1).show();
      return;
    }
  }
  ...
  public void a(Context paramContext, bkkz parambkkz, bkkx parambkkx)
  {
    if ((!this.c) && (!bkkk.b(parambkkz.b)))
    {
      if (QLog.isColorLevel()) {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
        {
          ...
          localbklu.jdField_a_of_type_Bkkz = parambkkz;
          localbklu.jdField_a_of_type_Bkkx = parambkkx;
          this.jdField_a_of_type_JavaUtilArrayList.add(localbklu);
          return;
        }
        synchronized (this.jdField_a_of_type_JavaLangObject)
        {
    ...
    c(paramContext, parambkkz, parambkkx);
  }
  ...
  public void a(String paramString, OnPluginInstallListener paramOnPluginInstallListener)
  {
    ...
    if (bkli.a(localPluginInfo, this.jdField_a_of_type_AndroidAppApplication))
    {
    ...
    this.jdField_a_of_type_Bklk.b(localPluginInfo, this);
  }
  ...
  public void a(String paramString1, String paramString2, long paramLong)
  {
    ...
    paramString1 = this.jdField_a_of_type_Bklk.a(paramString1);
  ...
  public void a(String paramString, boolean paramBoolean1, boolean paramBoolean2, OnPluginInstallListener paramOnPluginInstallListener)
  {
    ...
    if (paramBoolean1)
    {
      localPluginInfo1 = this.jdField_a_of_type_Bkkk.a(paramString);
    ...
    for (;;)
    {
      ...
      localPluginInfo1 = localPluginInfo2.a();
      break;
      if (bkli.a(localPluginInfo1, this.jdField_a_of_type_AndroidAppApplication))
      {
      ...
      {
        this.jdField_a_of_type_Bklk.a(localPluginInfo1, this);
        return;
      }
      this.jdField_a_of_type_Bkle.a(localPluginInfo1, this, paramBoolean2);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        bklu localbklu = (bklu)localIterator.next();
        c(localbklu.jdField_a_of_type_AndroidContentContext, localbklu.jdField_a_of_type_Bkkz, localbklu.jdField_a_of_type_Bkkx);
      }
      this.jdField_a_of_type_Bklx.a();
    }
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      this.jdField_a_of_type_Bklk.a((PluginInfo)localObject, this);
    }
    label72:
    do
    {
  ...
  {
    this.jdField_a_of_type_Bkle.a(paramPluginInfo.mID);
    return this.jdField_a_of_type_Bklk.b(paramPluginInfo.mID);
  }
  ...
  {
    this.jdField_a_of_type_Bkle.a(paramString);
    this.jdField_a_of_type_Bklk.b(paramString);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    default: 
      return true;
    case 65536: 
      a(paramMessage.getData().getString("index_for_id"), (bkky)paramMessage.obj);
      return true;
    case 66049: 
      e();
      return true;
