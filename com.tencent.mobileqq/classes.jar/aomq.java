...
class aomq
  implements bgun<WeiyunPB.LibInfoListGetMsgRsp>
{
  aomq(aomp paramaomp, String paramString) {}
  ...
  public void a(int paramInt, String paramString, WeiyunPB.LibInfoListGetMsgRsp paramLibInfoListGetMsgRsp)
  {
    ...
    aomp.a(this.jdField_a_of_type_Aomp).a().a(false, 31, new Object[] { Integer.valueOf(paramInt), paramString, this.jdField_a_of_type_JavaLangString });
  }
  ...
  public void a(WeiyunPB.LibInfoListGetMsgRsp paramLibInfoListGetMsgRsp)
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localWeiYunFileInfo.jdField_b_of_type_JavaLangString = bgwl.a(((WeiyunPB.FileItem)localObject2).pdir_key.get());
      ...
      localWeiYunFileInfo.i = bgwl.a(((WeiyunPB.FileItem)localObject2).file_md5.get());
      localWeiYunFileInfo.j = bgwl.a(((WeiyunPB.FileItem)localObject2).file_sha.get());
      if (!aomp.a(this.jdField_a_of_type_Aomp).containsKey(localWeiYunFileInfo.jdField_a_of_type_JavaLangString))
      {
        aomp.a(this.jdField_a_of_type_Aomp).put(localWeiYunFileInfo.jdField_a_of_type_JavaLangString, localWeiYunFileInfo);
        localArrayList.add(localWeiYunFileInfo);
      }
    }
    localObject1 = aomp.a(this.jdField_a_of_type_Aomp).a();
    Object localObject2 = this.jdField_a_of_type_JavaLangString;
    if (paramLibInfoListGetMsgRsp.finish_flag.get() == 1) {}
    for (boolean bool = true;; bool = false)
    {
      ((aoii)localObject1).a(true, 31, new Object[] { localObject2, Boolean.valueOf(bool), Integer.valueOf(paramLibInfoListGetMsgRsp.FileItem_items.size()), paramLibInfoListGetMsgRsp.server_version.get(), localArrayList, Integer.valueOf(aomp.a(this.jdField_a_of_type_Aomp)) });
      return;
    }
  }
}
