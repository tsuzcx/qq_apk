...
public class afyb
{
  ...
  private Set<afyf> jdField_a_of_type_JavaUtilSet;
  ...
  private void a(Animator paramAnimator, int paramInt)
  {
    ...
    {
      afyf localafyf = (afyf)localIterator.next();
      if (localafyf != null) {
        localafyf.a(paramAnimator, paramInt);
      }
    }
  }
  ...
  private void a(LottieComposition paramLottieComposition, int paramInt, String paramString, Context paramContext)
  {
    ...
    paramContext = new afyh(paramContext, paramString);
  ...
  private void a(LottieDrawable paramLottieDrawable, int paramInt)
  {
    ...
    while (localIterator.hasNext())
    {
      afyf localafyf = (afyf)localIterator.next();
      if (localafyf != null) {
        localafyf.a(paramLottieDrawable, paramInt);
      }
    }
  }
  ...
  public void a(afyf paramafyf)
  {
    this.jdField_a_of_type_JavaUtilSet.add(paramafyf);
  }
  ...
  public void a(LottieDrawable paramLottieDrawable, int paramInt, ImageView paramImageView, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramLottieDrawable.addAnimatorListener(new afyd(this, paramLottieDrawable, paramInt, paramImageView));
    } while (!paramBoolean);
