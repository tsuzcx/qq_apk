...
public class afyb
  implements akse
{
  public afyb(CustomizeStrategyFactory.VoiceResStrategy.1 param1) {}
  ...
  public void onResult(int paramInt, PreloadManager.PathResult paramPathResult)
  {
    ...
    try
    {
      ...
      localObject = SafeBitmapFactory.decodeFile((String)localObject, bgmo.a((String)localObject, (int)(CustomizeStrategyFactory.a * 47.0F + 0.5D)));
      if (localObject != null) {
