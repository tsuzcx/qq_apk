  ...
  extends vbl
{
  ...
  public void a(Canvas paramCanvas, vbm paramvbm, float paramFloat)
  {
    if (paramvbm.jdField_a_of_type_Int == 103) {}
    do
    {
      return;
      if (paramvbm.jdField_a_of_type_Int == 104)
      {
        ...
        this.jdField_a_of_type_AndroidGraphicsPaint.setStrokeWidth(45.0F);
        this.jdField_a_of_type_AndroidGraphicsPaint.setShader(this.jdField_a_of_type_AndroidGraphicsBitmapShader);
        paramCanvas.drawPath(paramvbm.jdField_a_of_type_AndroidGraphicsPath, this.jdField_a_of_type_AndroidGraphicsPaint);
        return;
      }
    } while (paramvbm.jdField_a_of_type_Int != 105);
    ...
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(jdField_a_of_type_Int);
    this.jdField_a_of_type_AndroidGraphicsCanvas.drawPath(paramvbm.jdField_a_of_type_AndroidGraphicsPath, this.jdField_a_of_type_AndroidGraphicsPaint);
  ...
  public void a(uye paramuye, float paramFloat, Bitmap paramBitmap, Rect paramRect)
  {
  ...
  public void a(vbm paramvbm)
  {
    if (paramvbm.jdField_a_of_type_Int == 103)
    {
      DoodleLayout.a("delete_mosaics");
      urq.a("0X80076C2");
      List localList = paramvbm.jdField_a_of_type_JavaUtilList;
      paramvbm = paramvbm.b;
      int k = 0;
      while ((k < localList.size()) && (k < paramvbm.size()))
      {
        e(((Integer)localList.get(k)).intValue(), ((Integer)paramvbm.get(k)).intValue());
        k += 1;
      }
      c();
    }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Vbm = new vbm(new Path(), this.g);
      if (this.jdField_a_of_type_Vbh != null) {
        this.jdField_a_of_type_Vbh.a(this.jdField_a_of_type_Vbm);
      }
      int k;
      int m;
      if (this.g == 103)
      {
        ...
        if ((k >= 0) && (m >= 0))
        {
          this.jdField_a_of_type_Vbm.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(k));
          this.jdField_a_of_type_Vbm.b.add(Integer.valueOf(m));
          d(k, m);
          c();
        }
      }
      ...
      {
        this.jdField_a_of_type_Vbm.jdField_a_of_type_AndroidGraphicsPath.reset();
        this.jdField_a_of_type_Vbm.jdField_a_of_type_AndroidGraphicsPath.moveTo(f1, f2);
        this.jdField_a_of_type_Vbm.jdField_a_of_type_AndroidGraphicsPath.lineTo(f1 + 1.0F, f2 + 1.0F);
      }
      else if (this.g == 105)
      {
        this.jdField_a_of_type_Vbm.jdField_a_of_type_AndroidGraphicsPath.reset();
        ...
        if (this.g == 103)
        {
          k = ((Integer)this.jdField_a_of_type_Vbm.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_Vbm.jdField_a_of_type_JavaUtilList.size() - 1)).intValue();
          m = ((Integer)this.jdField_a_of_type_Vbm.b.get(this.jdField_a_of_type_Vbm.b.size() - 1)).intValue();
          ...
          {
            this.jdField_a_of_type_Vbm.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(n));
            this.jdField_a_of_type_Vbm.b.add(Integer.valueOf(i1));
            d(n, i1);
            c();
          }
        }
        ...
        {
          this.jdField_a_of_type_Vbm.jdField_a_of_type_AndroidGraphicsPath.quadTo(this.jdField_d_of_type_Float, this.jdField_e_of_type_Float, (this.jdField_d_of_type_Float + f1) / 2.0F, (this.jdField_e_of_type_Float + f2) / 2.0F);
          this.jdField_d_of_type_Float = f1;
          this.jdField_e_of_type_Float = f2;
        }
        else if (this.g == 105)
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Uye != null)
    {
      ...
      this.jdField_a_of_type_Uye.a(this.jdField_b_of_type_AndroidGraphicsBitmap, this.jdField_b_of_type_Boolean);
    }
    for (;;)
    {
      ...
      return;
      label50:
      this.jdField_a_of_type_Uye.a(this.jdField_a_of_type_ArrayOfByte, this.jdField_e_of_type_Int, this.f);
    }
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Vbm = null;
    if (this.g == 104) {
      return;
    }
    if (this.g == 105)
