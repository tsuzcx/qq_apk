...
public class amkg
{
  ...
  public static Point a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      paramQQAppInterface = bbjn.a(paramQQAppInterface.getApp(), paramQQAppInterface.c());
      ...
      {
        j = bbkx.a() - bbkx.a(25.0F);
        i = bbkx.b() / 2 + bbkx.a(25.0F);
      }
  ...
  public static void a(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    for (;;)
    {
      try
      {
        ...
        if ((!amju.a(paramContext)) && (paramBoolean1)) {
          c(paramContext);
        }
  ...
  public static void b(Context paramContext)
  {
    ...
    //   25: getstatic 68	amkg:jdField_a_of_type_Boolean	Z
    ...
    //   47: astore_1
    //   48: iconst_0
    //   49: putstatic 68	amkg:jdField_a_of_type_Boolean	Z
    //   52: aload_0
    //   53: aload_1
  ...
  private static void c(Context paramContext)
  {
    ...
    if (!ColorNoteSmallScreenPermissionDialogFragment.jdField_a_of_type_Boolean) {
      abtu.a(paramContext, PublicTransFragmentActivity.class, ColorNoteSmallScreenPermissionDialogFragment.class);
    }
  }
}
