...
{
  private aurk(PortalManager paramPortalManager) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    case 1011: 
      ...
      localObject = aurn.b(paramIntent);
      localObject = bbcz.l(PortalManager.a(this.a), (String)localObject);
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramContext))
      {
        paramIntent = aurn.b(paramContext);
        localObject = PortalManager.a(this.a).a(paramIntent, false);
        if (localObject != null)
        {
          paramIntent = aurn.a((Bitmap)localObject);
        ...
        localObject = new aurj();
        ((aurj)localObject).jdField_a_of_type_JavaLangString = paramContext;
        ((aurj)localObject).b = k;
        ((aurj)localObject).jdField_a_of_type_Int = m;
        this.a.a.put(paramIntent, localObject);
        if ((PortalManager.a(this.a).a(paramIntent, true) != null) || (!QLog.isColorLevel())) {
          break;
        }
        paramIntent = bbcz.j(PortalManager.a(this.a), String.valueOf(paramIntent));
