...
public class aurk
  extends aurm
{
  public aurk(QQAppInterface paramQQAppInterface)
  {
  ...
  private void h(arya paramarya)
  {
    ...
    {
      return;
      Iterator localIterator = paramarya.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        ChatMessage localChatMessage = (ChatMessage)localIterator.next();
        if ((localChatMessage instanceof MessageForMixedMsg)) {
          ((arno)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(174)).a(paramarya.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (MessageForMixedMsg)localChatMessage, false, ((MessageForMixedMsg)localChatMessage).forwardID);
        }
      }
    }
  }
  ...
  protected void d(arya paramarya)
  {
    ...
    {
      paramarya.jdField_a_of_type_JavaUtilHashMap = a(a((QQAppInterface)localObject2, (List)localObject1, bool), localArrayList);
      paramarya.jdField_a_of_type_JavaUtilList = localArrayList;
