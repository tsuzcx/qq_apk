...
public class ndo
{
  private static ndo jdField_a_of_type_Ndo;
  private final int jdField_a_of_type_Int = 8;
  private final long jdField_a_of_type_Long = 86400000L;
  private final String jdField_a_of_type_JavaLangString = ndo.class.getSimpleName();
  private ArrayList<nds> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private HashMap<String, ndr> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private ArrayList<ndr> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private ArrayList<nds> a(QQAppInterface paramQQAppInterface)
  {
    paramQQAppInterface = new ArrayList();
    Iterator localIterator = this.jdField_b_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      ndr localndr = (ndr)localIterator.next();
      paramQQAppInterface.add(new nds(this, localndr.jdField_a_of_type_JavaLangString, localndr.jdField_b_of_type_JavaLangString, localndr.jdField_a_of_type_Boolean));
    }
  ...
  public static ndo a()
  {
    if (jdField_a_of_type_Ndo == null) {}
    try
    {
      jdField_a_of_type_Ndo = new ndo();
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_Ndo.jdField_a_of_type_JavaLangString, 2, "newInstance!");
      }
      return jdField_a_of_type_Ndo;
    }
    finally {}
  }
  
  private void a(QQAppInterface paramQQAppInterface, ndq paramndq)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      paramndq.a(new ArrayList(), null, true);
      return;
    }
  ...
  private void b(QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      if (!TextUtils.isEmpty(paramQQAppInterface)) {
        try
        {
          paramQQAppInterface = rtr.a(paramQQAppInterface);
          if (paramQQAppInterface != null)
          {
            ...
            while (i < paramQQAppInterface.length())
            {
              ...
              localObject = new nds(this, ((JSONObject)localObject).optString("uin"), ((JSONObject)localObject).optString("name"), ((JSONObject)localObject).optBoolean("isPA", true));
  ...
  private void b(QQAppInterface paramQQAppInterface, ndq paramndq)
  {
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_a_of_type_JavaLangString, 2, "sendGetPublicAccountSearchRecommendRequest->begin!");
    }
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication().getApplicationContext(), ndt.class);
    ...
    localGetRecommendPubAccountRequest.version.set(rtr.a());
    ...
    localNewIntent.setObserver(new ndp(this, localNewIntent, paramQQAppInterface, paramndq));
      ...
      if (!TextUtils.isEmpty(paramQQAppInterface)) {
        try
        {
          ...
          if (paramQQAppInterface != null)
          {
            ...
            {
              Object localObject = (JSONObject)paramQQAppInterface.get(i);
              localObject = new ndr(this, ((JSONObject)localObject).optString("uin"), ((JSONObject)localObject).optString("name"), ((JSONObject)localObject).optLong("time"), ((JSONObject)localObject).optBoolean("isPA", true));
              this.jdField_b_of_type_JavaUtilArrayList.add(localObject);
              this.jdField_a_of_type_JavaUtilHashMap.put(((ndr)localObject).jdField_a_of_type_JavaLangString, localObject);
              i += 1;
            }
          }
          return;
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    {
      paramString1 = (ndr)this.jdField_a_of_type_JavaUtilHashMap.get(paramString1);
    ...
    for (;;)
    {
      ...
      {
        paramString1 = (ndr)paramQQAppInterface.next();
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, paramString1.toString());
      }
      break;
      paramString2 = new ndr(this, paramString1, paramString2, l, paramBoolean);
      ...
      if (i > 8)
      {
        paramString1 = (ndr)this.jdField_b_of_type_JavaUtilArrayList.get(i - 1);
        this.jdField_b_of_type_JavaUtilArrayList.remove(paramString1);
  ...
  public void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, ndq paramndq)
  {
    if (QLog.isColorLevel()) {
