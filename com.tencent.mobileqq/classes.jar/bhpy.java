  ...
  extends Dialog
{
  ...
  private bhqe jdField_a_of_type_Bhqe;
  private bhqf jdField_a_of_type_Bhqf;
  ...
  private HashMap<CharSequence, bhpx> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private View.OnClickListener jdField_d_of_type_AndroidViewView$OnClickListener = new bhqb(this);
  ...
  protected bhpy(Context paramContext)
  {
    this(paramContext, false, false);
  }
  
  protected bhpy(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    this(paramContext, paramBoolean1, paramBoolean2, true, -1, null);
  }
  
  @TargetApi(14)
  protected bhpy(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt, ViewGroup.LayoutParams paramLayoutParams)
  {
    super(paramContext, 2131755225);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new bhqc(this);
  ...
  public static bhpy a(Context paramContext)
  {
    paramContext = new bhpy(paramContext, false, false);
  ...
  public static bhpy a(Context paramContext, int paramInt, ViewGroup.LayoutParams paramLayoutParams)
  {
    paramContext = new bhpy(paramContext, false, false, true, paramInt, paramLayoutParams);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755012);
    }
    return paramContext;
  ...
  public static bhpy a(Context paramContext, boolean paramBoolean)
  {
    paramContext = new bhpy(paramContext, false, true, paramBoolean, -1, null);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755012);
    }
    return paramContext;
  ...
  private void a(TextView paramTextView, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramTextView.setContentDescription(getContext().getString(2131691173) + paramTextView.getText());
      return;
    }
    paramTextView.setContentDescription(getContext().getString(2131691175) + paramTextView.getText());
  }
  
  public static bhpy b(Context paramContext)
  {
    paramContext = new bhpy(paramContext, false, true);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755012);
    }
    return paramContext;
  ...
  public static bhpy c(Context paramContext)
  {
    paramContext = new bhpy(paramContext, true, false);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755012);
    }
    return paramContext;
  ...
  public static bhpy d(Context paramContext)
  {
    paramContext = new bhpy(paramContext, true, true);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131755012);
    }
    return paramContext;
  ...
  private void f()
  {
    ...
    if (this.jdField_a_of_type_JavaLangCharSequence != null)
    {
      ...
      ((View)localObject1).setOnClickListener(new bhpz(this));
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        if (i < k)
        {
          ...
          if (((Integer)((Pair)localObject1).second).intValue() == 65537)
          {
            ...
            localObject3 = (TextView)localView.findViewById(2131377213);
            ...
            if ((m >= 0) && (m < ((CharSequence)((Pair)localObject1).first).length()))
            {
              ...
              localView.findViewById(2131363813).setContentDescription(((TextView)localObject2).getText());
              label408:
              bcvq.b(localView.findViewById(2131363813), LinearLayout.class.getName());
              label424:
              if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.size() > 0))
              {
                localObject3 = (bhpx)this.jdField_a_of_type_JavaUtilHashMap.get(((Pair)localObject1).first);
                if ((localObject3 != null) && (((bhpx)localObject3).jdField_b_of_type_Int != 0)) {
                  ((TextView)localObject2).setId(((bhpx)localObject3).jdField_b_of_type_Int);
                }
              }
              ...
              ((RelativeLayout.LayoutParams)localObject4).rightMargin = bcwh.a(this.jdField_a_of_type_AndroidContentContext, 15.0F);
              ...
              {
                ((RelativeLayout.LayoutParams)localObject4).width = bcwh.a(this.jdField_a_of_type_AndroidContentContext, 28.0F);
                ((RelativeLayout.LayoutParams)localObject4).height = bcwh.a(this.jdField_a_of_type_AndroidContentContext, 28.0F);
                ((RelativeLayout.LayoutParams)localObject4).addRule(15);
              }
              ((RelativeLayout.LayoutParams)localObject4).rightMargin = bcwh.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
              ((ImageView)localObject3).setLayoutParams((ViewGroup.LayoutParams)localObject4);
          ...
          for (;;)
          {
            ...
            localObject2 = (TextView)localView.findViewById(2131361915);
            ((TextView)localObject2).setText((CharSequence)((Pair)localObject1).first);
            bcvq.b((View)localObject2, Button.class.getName());
            break label424;
            label1002:
  ...
  public bhpx a(int paramInt)
  {
    return a(a(paramInt));
  }
  
  public bhpx a(CharSequence paramCharSequence)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap == null) {
      return null;
    }
    return (bhpx)this.jdField_a_of_type_JavaUtilHashMap.get(paramCharSequence);
  }
  ...
  public void a(bhpx parambhpx, int paramInt)
  {
    if (parambhpx == null) {
      return;
    }
    this.jdField_a_of_type_JavaUtilHashMap.put(parambhpx.a, parambhpx);
    a(parambhpx.a, paramInt);
  }
  
  public void a(bhqd parambhqd)
  {
    this.jdField_a_of_type_Bhqd = parambhqd;
  }
  ...
  public void a(bhqf parambhqf)
  {
    this.jdField_a_of_type_Bhqf = parambhqf;
  }
  
  public void a(bhqg parambhqg)
  {
    this.jdField_a_of_type_Bhqg = parambhqg;
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      ((VerticalCenterImageSpan)localObject).setPadding(aekt.a(10.0F, this.jdField_a_of_type_AndroidContentResResources), 0);
  ...
  public void dismiss()
  {
    if (this.jdField_a_of_type_Bhqg != null) {
      this.jdField_a_of_type_Bhqg.as_();
    }
    if (this.g)
    {
      this.g = false;
  ...
  public void e()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 712	abqm:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 712	abqm:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 712	abqm:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
