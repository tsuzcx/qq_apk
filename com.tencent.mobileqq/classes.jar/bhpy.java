  ...
  implements DialogInterface.OnDismissListener, View.OnClickListener
{
  ...
  bhso jdField_a_of_type_Bhso = new bhpz(this);
  ...
  public bhpy(Context paramContext, int paramInt)
  {
    ...
    label194:
    for (paramInt = bhsm.a(0);; paramInt = (int)(150.0F * this.jdField_a_of_type_AndroidContentResResources.getDisplayMetrics().density))
    {
  ...
  public String a()
  {
    ...
    Object localObject;
    if ((this.jdField_a_of_type_AndroidWidgetEditText.getText() instanceof behe))
    {
      localObject = (behe)this.jdField_a_of_type_AndroidWidgetEditText.getText();
      if (localObject != null) {
        return ((behe)localObject).a();
      }
    }
    else if ((this.jdField_a_of_type_AndroidWidgetEditText.getText() instanceof begz))
    {
      localObject = (begz)this.jdField_a_of_type_AndroidWidgetEditText.getText();
      if (localObject != null) {
        return ((begz)localObject).a();
      }
    }
  ...
  void a(Context paramContext)
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setCallBack(localbhqh);
    ...
    if (this.h == 7)
    {
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel = new SystemAndEmojiEmoticonPanel(paramContext, localbhqh);
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel = new SystemEmoticonPanel(paramContext, localbhqh);
  }
  ...
  public void c(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidWidgetEditText != null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new bhqg(this, paramInt));
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject2 != null) && ((localObject2 instanceof Integer)) && (((Integer)localObject2).intValue() == 2130840133))
      {
      ...
      else
      {
        ...
        if (this.jdField_a_of_type_Boolean) {
          ((View)localObject1).setMinimumHeight(bhsm.a(0));
        }
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.setEditableFactory(begz.b);
    this.jdField_a_of_type_AndroidWidgetEditText.setSingleLine(this.b);
    this.jdField_a_of_type_AndroidWidgetEditText.setOnTouchListener(new bhqc(this));
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Int = this.jdField_a_of_type_Bhsm.a();
      this.jdField_a_of_type_Int = bhsm.a(this.jdField_a_of_type_Int);
      setOnDismissListener(this);
      a((Context)localObject);
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setDispatchKeyEventListener(new bhqd(this));
    }
    for (;;)
    {
      localObject = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131377108);
      if ((localObject instanceof ScrollView)) {
        this.jdField_a_of_type_AndroidWidgetScrollView = ((ScrollView)localObject);
      }
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.getViewTreeObserver().addOnGlobalLayoutListener(new bhqf(this));
      return;
      a((Context)localObject);
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel.setBackgroundResource(2130838009);
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel.setMinimumHeight(agej.a(150.0F, this.jdField_a_of_type_AndroidContentResResources));
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemEmoticonPanel.setDispatchKeyEventListener(new bhqe(this));
    }
  }
  ...
  public bhpc setNegativeButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.lBtn.setOnClickListener(new bhqa(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  ...
  public bhpc setPositiveButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.rBtn.setOnClickListener(new bhqb(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
