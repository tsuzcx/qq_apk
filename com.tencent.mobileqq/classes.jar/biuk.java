  ...
  implements bitu
{
  ...
  public biuk(Context paramContext, WebView paramWebView, String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
  ...
  {
    bisy.c("AppUpdate", "AppUpdate onException >>> " + paramException.toString());
    if ((!this.jdField_a_of_type_Boolean) && (biub.a(this.jdField_a_of_type_AndroidContentContext))) {
      biui.b(this.jdField_a_of_type_AndroidContentContext);
    }
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    bisy.c("AppUpdate", "AppUpdate onResult >>> " + localJSONObject.toString());
    ...
    for (;;)
    {
      try
      {
        ...
        if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
        {
          ...
          {
            paramJSONObject = (JSONObject)localObject;
            if (biub.a(this.jdField_a_of_type_AndroidContentContext))
            {
              if (localJSONObject.optInt("code", -1) != 0) {
                continue;
              }
              biui.a(this.jdField_a_of_type_AndroidContentContext);
              paramJSONObject = (JSONObject)localObject;
            }
          }
        }
