  ...
  implements acpi
{
  private static void a(QQAppInterface paramQQAppInterface, MsgInfo paramMsgInfo, MsgType0x210 paramMsgType0x210)
  {
    ...
    if (!((aohe)paramQQAppInterface.getManager(QQManagerFactory.MGR_ACTVATE_FRIENDS)).a(paramMsgInfo.shMsgSeq))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          if ((i == 0) || (i == 1))
          {
            ...
            localafno.b((AcsMsg)localObject);
            if (QLog.isColorLevel()) {
              QLog.d("SubType0x118", 2, "do report: QQnotice.list.push");
            }
            bdla.b(paramQQAppInterface, "P_CliOper", "QQnotice", "", "", "QQnotice.list.push", 0, 0, "", "", paramMsgType0x210.optString("msg_id"), "");
            return;
          }
          if (i != 4) {
            break label374;
