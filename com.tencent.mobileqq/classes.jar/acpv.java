...
{
  public acpv(DiscussionInfoCardActivity paramDiscussionInfoCardActivity) {}
  
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    if (AppSetting.c)
    {
      paramCompoundButton = this.a.getString(2131693302);
    ...
    if (!bool)
    {
      ...
      localObject = new azmo(this.a.app).a("dc00899").b("Grp_Dis_set").c("Dis_info");
      if (!bool) {
        break label128;
      }
    }
    ...
    {
      ((azmo)localObject).d(paramCompoundButton).a();
      return;
      paramBoolean = false;
      break;
    }
