...
public class acpv
  extends Handler
{
  public acpv(VisitorsActivity paramVisitorsActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    case 2: 
      ...
      this.a.jdField_a_of_type_ComTencentWidgetSwipListView.springBackOverScrollHeaderView();
      this.a.jdField_a_of_type_ComTencentWidgetSwipListView.springBackOverScrollHeaderView();
      this.a.a(1, this.a.getString(2131694610));
      return;
    case 3: 
      ...
      for (;;)
      {
        ...
        return;
        this.a.jdField_b_of_type_Acqr.notifyDataSetChanged();
      }
    case 5: 
      ...
      if ((paramMessage instanceof Object[]))
      {
        ...
        this.a.jdField_a_of_type_Acqr.a(this.a.jdField_a_of_type_JavaUtilArrayList);
        if (QLog.isColorLevel()) {
          QLog.d("VisitorsActivity", 2, "setDataSet favor UI_ONINIT");
        }
        this.a.jdField_b_of_type_Acqr.a(this.a.jdField_b_of_type_JavaUtilArrayList);
        this.a.jdField_a_of_type_Acqr.notifyDataSetChanged();
        this.a.jdField_b_of_type_Acqr.notifyDataSetChanged();
      }
      ...
      return;
    case 6: 
      this.a.jdField_a_of_type_Avbc.b();
      return;
    case 7: 
      if (QLog.isColorLevel()) {
    ...
    case 9: 
      ...
      this.a.jdField_a_of_type_Avbc.a(paramMessage);
      return;
    case 10: 
    ...
    case 11: 
            ...
            if (paramMessage.length == 2)
            {
              ...
              if (i1 >= i2)
              {
                ...
                if (i1 <= i3)
                {
                  ...
                  if (localObject != null)
                  {
                    localObject = (TextView)((View)localObject).findViewById(2131378416);
                    j = m;
                    if (localObject != null)
                    {
                      int[] arrayOfInt = new int[2];
                      ((TextView)localObject).getLocationInWindow(arrayOfInt);
                      localauww = (auww)paramMessage[1];
                      if (!TextUtils.isEmpty(localauww.jdField_b_of_type_JavaLangString)) {
                        break label929;
                      }
                      j = 1;
                      ...
                      if ((n <= 0) || (localauww.c == null)) {
                        break label961;
                      }
                      this.a.jdField_a_of_type_ComTencentMobileqqNearbyAnimNearbyZanAnimLayout.a(localauww, localauww.c, f1, f2);
                      i -= 1;
                      if (i <= 0) {
                        break label983;
                      }
                      ...
                      i = annd.a[this.a.jdField_a_of_type_JavaUtilRandom.nextInt(annd.a.length)];
      ...
      for (;;)
      {
        ...
        break label542;
        label929:
        j = localauww.jdField_b_of_type_JavaLangString.length() + 1;
        break label718;
        k = ((TextView)localObject).getText().length() * 2;
        break label729;
        this.a.jdField_a_of_type_ComTencentMobileqqNearbyAnimNearbyZanAnimLayout.a(localauww, localauww.jdField_b_of_type_AndroidGraphicsBitmap, f1, f2);
        break label811;
