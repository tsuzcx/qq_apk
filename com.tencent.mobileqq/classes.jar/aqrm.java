...
public class aqrm
{
  ...
  private static final Comparator<PadFaceAd> jdField_a_of_type_JavaUtilComparator = new aqrn();
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajyc.a(2131707861);
  }
  
  public aqrm(AppInterface paramAppInterface)
  {
  ...
  public static aqro a(AppInterface paramAppInterface)
  {
    paramAppInterface = paramAppInterface.getApp().getSharedPreferences("gamecenter_sp" + paramAppInterface.getCurrentAccountUin(), 4);
    aqro localaqro = new aqro();
    localaqro.jdField_b_of_type_Long = paramAppInterface.getLong("pwa_version", 0L);
    localaqro.jdField_a_of_type_Long = paramAppInterface.getLong("last_pwa_version", 0L);
    localaqro.jdField_a_of_type_JavaLangString = paramAppInterface.getString("pwa_url", "");
    return localaqro;
  }
  ...
  private void a()
  {
    ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_Aukn.a(PadFaceAd.class);
  ...
  public void a(int paramInt)
  {
    try
    {
      ...
      if (localPadFaceAd != null)
      {
        this.jdField_a_of_type_Aukn.b(localPadFaceAd);
        ...
        ((bbqp)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(71)).c(paramInt);
        return;
      }
    }
    finally {}
      ...
      try
      {
        ...
        if ((k > 0) && (b(k) == null) && (i < 2))
        {
          ...
          if (i != 0)
          {
            ...
            ((bbqp)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(71)).a(k, j, l);
          }
        }
        else
        {
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    //   99: monitorenter
    //   100: aload_0
    //   101: getfield 256	aqrm:jdField_b_of_type_Boolean	Z
    //   104: ifne +6 -> 110
    //   107: aload_0
    //   108: monitorexit
    //   109: return
    //   110: aload_0
    //   111: getfield 257	aqrm:jdField_b_of_type_Long	J
    //   114: iload 5
    //   116: i2l
    //   117: ldc2_w 377
    //   120: lmul
    ...
    //   129: ldc2_w 377
    //   132: lmul
    //   133: putfield 257	aqrm:jdField_b_of_type_Long	J
    //   136: ldc_w 286
    //   139: iconst_2
    //   140: iconst_2
    ...
    //   163: iload 6
    //   165: aload_0
    //   166: getfield 235	aqrm:jdField_a_of_type_Boolean	Z
    //   169: if_icmpeq +29 -> 198
    //   172: aload_0
    //   173: iload 6
    //   175: putfield 235	aqrm:jdField_a_of_type_Boolean	Z
    //   178: aload_0
    //   179: getfield 235	aqrm:jdField_a_of_type_Boolean	Z
    //   182: ifne +452 -> 634
    //   185: ldc_w 286
    //   188: iconst_2
    //   189: ldc_w 385
    ...
    //   195: goto +439 -> 634
    //   198: aload_0
    //   199: invokevirtual 390	aqrm:a	()J
    //   202: lstore 9
    //   204: lload 9
    //   206: lload 7
    //   208: lcmp
    ...
    //   227: iconst_1
    //   228: aload_0
    //   229: invokevirtual 394	aqrm:a	()Ljava/lang/String;
    //   232: aastore
    //   233: dup
    //   234: iconst_2
    //   235: ldc_w 396
    ...
    //   252: goto +388 -> 640
    //   255: aload_0
    //   256: getfield 130	aqrm:jdField_a_of_type_AndroidContentSharedPreferences	Landroid/content/SharedPreferences;
    ...
    //   283: ifeq +23 -> 306
    //   286: aload_0
    //   287: getfield 235	aqrm:jdField_a_of_type_Boolean	Z
    //   290: ifeq +373 -> 663
    //   293: iconst_1
    //   294: istore_2
    //   295: aload_1
    ...
    //   338: pop
    //   339: aload_0
    //   340: getfield 235	aqrm:jdField_a_of_type_Boolean	Z
    //   343: ifeq +236 -> 579
    //   346: aload 11
    ...
    //   354: aload_0
    //   355: aload 11
    //   357: invokespecial 406	aqrm:a	(Lcom/tencent/mobileqq/gamecenter/data/PadFaceAd;)Z
    //   360: ifne +219 -> 579
    //   363: aload_0
    //   364: getfield 46	aqrm:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   367: aload 11
    ...
    //   382: iload_2
    //   383: aload_0
    //   384: getfield 46	aqrm:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   387: invokeinterface 271 1 0
    //   392: if_icmpge +49 -> 441
    //   395: aload_0
    //   396: getfield 46	aqrm:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   399: iload_2
    ...
    //   464: aload_0
    //   465: getfield 46	aqrm:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   468: aload 12
    //   470: iload_2
    ...
    //   486: goto -33 -> 453
    //   489: aload_0
    //   490: getfield 46	aqrm:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   493: getstatic 36	aqrm:jdField_a_of_type_JavaUtilComparator	Ljava/util/Comparator;
    ...
    //   505: ifnull +122 -> 627
    //   508: aload_0
    //   509: getfield 188	aqrm:jdField_a_of_type_Aukn	Laukn;
    //   512: aload_1
    //   513: invokevirtual 412	aukn:a	(Laukm;)V
    //   516: aload 12
    //   518: invokeinterface 271 1 0
    //   523: ifle +104 -> 627
    //   526: aload_0
    //   527: getfield 188	aqrm:jdField_a_of_type_Aukn	Laukn;
    //   530: astore 11
    //   532: aload 11
    //   534: invokevirtual 415	aukn:a	()Laukp;
    //   537: astore_1
    //   538: aload_1
    //   539: invokevirtual 418	aukp:a	()V
    //   542: iconst_0
    //   543: istore_2
    //   544: iload_2
    //   545: aload 12
    ...
    //   565: checkcast 420	aukm
    //   568: invokevirtual 299	aukn:b	(Laukm;)Z
    //   571: pop
    //   572: iload_2
    //   573: iconst_1
    //   574: iadd
    ...
    //   588: athrow
    //   589: aload_1
    //   590: invokevirtual 422	aukp:c	()V
    //   593: aload_1
    //   594: invokevirtual 424	aukp:b	()V
    //   597: return
    //   598: astore 11
    //   600: ldc_w 286
    //   603: iconst_1
    ...
    //   613: aload_1
    //   614: invokevirtual 424	aukp:b	()V
    //   617: return
    //   618: astore 11
    //   620: aload_1
    //   621: invokevirtual 424	aukp:b	()V
    //   624: aload 11
    //   626: athrow
    //   627: return
    //   628: iconst_0
