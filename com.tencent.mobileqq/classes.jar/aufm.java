  ...
  implements Manager
{
  ...
  static
  {
    ...
    jdField_a_of_type_JavaLangString = alud.a(2131702604);
    jdField_b_of_type_JavaLangString = alud.a(2131702603);
  }
  
  public aufm(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForMarketFace paramMessageForMarketFace)
  {
    ...
    {
      i = ((aufm)paramQQAppInterface.getManager(200)).a(paramMessageForMarketFace.time, String.valueOf(localMarkFaceMessage.dwTabID), localMarkFaceMessage.copywritingContent, localMarkFaceMessage.copywritingType);
      if (i != 0) {
        break label70;
      }
    ...
    for (;;)
    {
      try
      {
        paramMessageForMarketFace.msgData = amrf.a(localMarkFaceMessage);
        return;
      }
