  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public yqr(Activity paramActivity, String paramString1, String paramString2, int paramInt1, WeakReference<AppInterface> paramWeakReference, int paramInt2)
  {
  ...
  {
    if (!bdej.d((AppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get())) {
      return -1002;
    }
    bdej.d(null);
    ...
    ((bddl)localObject).jdField_b_of_type_JavaLangString = paramString1;
    ((bddl)localObject).jdField_a_of_type_JavaLangString = paramString2;
    ...
    for (;;)
    {
      ...
      i = AudioEncoder.a((bddl)localObject);
      ...
      {
        i = HwVideoMerge.merge(paramString3, paramString1, paramString4, 0);
        paramString2.delete();
        if (i != 0)
        {
  ...
  protected void a(Integer paramInteger)
  {
    ...
    a(anvx.a(2131715722) + paramInteger, null);
  }
  
  protected void onPreExecute()
  {
    a(this.jdField_a_of_type_AndroidAppActivity, 2131694652);
  }
}
