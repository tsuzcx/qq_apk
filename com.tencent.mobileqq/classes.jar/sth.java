...
public class sth
  extends pfh
{
  public sth(ReadInJoyDiandianHeaderController paramReadInJoyDiandianHeaderController) {}
  ...
  public void d(boolean paramBoolean, List<DiandianTopConfig> paramList)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        paramList = new stl(this.a, ReadInJoyDiandianHeaderController.b(this.a), j);
          ...
          if (k < paramList.getCount())
          {
            ...
            for (;;)
            {
              try
              {
                ...
                ocd.a(null, "", "0X80092FC", "0X80092FC", 0, 0, ReadInJoyDiandianHeaderController.b(this.a).size() + "", "1", ((DiandianTopConfig)localObject).topicId + "", localJSONObject.toString(), false);
