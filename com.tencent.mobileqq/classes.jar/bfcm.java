...
public class bfcm
{
  private static int a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    if (paramQQAppInterface != null)
    {
      i = j;
      if (localadab != null) {
        i = localadab.a(paramQQAppInterface.frienduin, paramQQAppInterface.istroop);
      }
    }
    return i;
  }
  ...
  {
    Object localObject = paramQQAppInterface.a(1001).a(antf.aj, 1001);
    if (localObject == null)
    {
  ...
  {
    Object localObject1 = paramQQAppInterface.a(1001).a(antf.aj, 1001);
    ...
    for (;;)
    {
      ...
      if (((List)localObject1).size() == ((ArrayList)localObject2).size())
      {
        ...
        paramQQAppInterface.a().a(antf.H, 1001, antf.aj, paramQQAppInterface.getCurrentAccountUin());
        return;
      }
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        paramQQAppInterface.a().a(antf.aj, 1001, (String)localObject2, paramQQAppInterface.getCurrentAccountUin());
      }
    }
  }
  ...
  {
    int i = 0;
    Object localObject = paramQQAppInterface.a(1001).a(antf.H, 1001);
    if (localObject == null)
    {
    ...
    try
    {
      ...
      {
        MessageRecord localMessageRecord = (MessageRecord)((Iterator)localObject).next();
        if (antf.aj.equals(localMessageRecord.senderuin))
        {
          a(paramQQAppInterface, localJSONObject2);
          break label402;
        }
        if ((!antf.al.equals(localMessageRecord.senderuin)) && (!antf.am.equals(localMessageRecord.senderuin)) && (!antf.an.equals(localMessageRecord.senderuin)) && (!antf.ao.equals(localMessageRecord.senderuin)) && (!antf.ap.equals(localMessageRecord.senderuin)))
        {
          localArrayList.add(localMessageRecord);
  ...
  public static final void b(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      default: 
        return;
      case 1: 
        a(paramQQAppInterface, paramString, antf.H);
        return;
      }
      a(paramQQAppInterface, paramString, antf.aj);
      return;
    }
