...
public class apfj
{
  ...
  public static HashMap<String, apfj> a(int paramInt, JSONObject paramJSONObject)
  {
    ...
    if (paramJSONObject.has("animation_sets"))
    {
      ...
      for (;;)
      {
        ...
        if (localObject1 != null)
        {
          ...
          for (localObject1 = apfl.a((JSONObject)localObject1);; localObject1 = apfk.a((JSONObject)localObject1))
          {
            if (localObject1 == null) {
              break label226;
            }
            ((apfj)localObject1).jdField_a_of_type_Int = paramInt;
            paramJSONObject.put(((apfj)localObject1).jdField_a_of_type_JavaLangString, localObject1);
            break;
          }
        }
      }
    ...
    if ((localObject1 != null) && (((HashMap)localObject1).size() > 0)) {
      apec.a().a.put(Integer.valueOf(paramInt), localObject1);
    }
    return localObject1;
  }
