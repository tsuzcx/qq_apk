...
public class aomn
{
  ...
  public static aomn a(String paramString)
  {
    ...
    try
    {
      ...
      localaomn.jdField_a_of_type_Int = paramString.optInt("kCheckSignatureSwitch", 0);
      localaomn.b = paramString.optInt("kDisableChooseSwitch", 0);
      localaomn.c = paramString.optInt("kShowKickDialog", 1);
      localaomn.d = paramString.optInt("kFDHookSwitch", 0);
      localaomn.e = paramString.optInt("kWtloginPowTest", 0);
      ...
      if (paramString != null)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          {
            localaomn.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(str1, str2);
      ...
      QLog.d("QuickAuthorityConfProcessor", 2, "confBean = " + localaomn.toString());
    }
