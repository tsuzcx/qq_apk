  ...
  extends bhyb
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ahkg(this);
  protected View a;
  ...
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new ahkh(this);
  View jdField_b_of_type_AndroidViewView;
  protected List<RecommendTroopItem> b;
  public boolean b;
  private final int jdField_c_of_type_Int = 1;
  private View.OnClickListener jdField_c_of_type_AndroidViewView$OnClickListener = new ahki(this);
  ...
  public ahke(QQAppInterface paramQQAppInterface, Context paramContext, ahjp paramahjp, ahgo paramahgo)
  {
  ...
  private void a(RecommendTroopItem paramRecommendTroopItem)
  {
    ...
    do
    {
      ...
      bdaj.a("Grp_contacts_news", "notice", "recom_exp_grp", 0, 0, new String[] { str1, paramRecommendTroopItem });
  ...
  {
    Object localObject;
    if ((paramView == null) || (!(paramView.getTag() instanceof ahjv)))
    {
      ...
      localObject = (Button)paramView.findViewById(2131378418);
  ...
  public void a(alws paramalws)
  {
    ArrayList localArrayList;
    int i;
    Object localObject;
    if ((this.jdField_a_of_type_JavaUtilList != null) && (paramalws != null))
    {
  ...
  public void a(LinearLayout paramLinearLayout)
  {
    ...
    localURLDrawableOptions.mRequestWidth = aekt.a(238.0F, (Resources)localObject);
    localURLDrawableOptions.mRequestHeight = aekt.a(161.0F, (Resources)localObject);
    ...
    ((ImageView)paramLinearLayout.findViewById(2131367587)).setImageDrawable((Drawable)localObject);
  }
  ...
  public void b()
  {
    ...
    bdaj.a("Grp_contacts_news", "notice", "verify_clk", 3, 0, new String[0]);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (i == 1)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface instanceof QQAppInterface))) {
        paramViewGroup = bcxb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 4, localRecommendTroopItem.uin);
      }
    }
    for (;;)
    {
      ...
      {
        localView = ahad.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_AndroidViewView$OnClickListener, this.jdField_a_of_type_AndroidViewView$OnClickListener, this.jdField_c_of_type_AndroidViewView$OnClickListener);
      }
      ahad.a((ahag)localView.getTag(), localRecommendTroopItem, paramViewGroup);
      a(localRecommendTroopItem);
      return localView;
      if (this.jdField_a_of_type_Bcgv != null)
      {
        paramViewGroup = this.jdField_a_of_type_Bcgv.a(localRecommendTroopItem.uin, true);
        if (paramViewGroup != null)
        {
          ...
          if (i == 2)
          {
            localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131562766, null);
            paramViewGroup = (TextView)localView.findViewById(2131376270);
            if (this.jdField_g_of_type_Boolean) {
              paramView = this.jdField_a_of_type_AndroidContentContext.getString(2131699985);
            }
            for (;;)
            {
              paramViewGroup.setText(paramView);
              localView.setOnClickListener(new ahkf(this));
              paramViewGroup = localView;
              if (this.jdField_c_of_type_Boolean) {
                break;
              }
              bdaj.a("Grp_contacts_news", "notice", "verify_exp", 2, 0, new String[0]);
              this.jdField_c_of_type_Boolean = true;
              return localView;
              if (this.jdField_a_of_type_Int > c() - 2) {
                paramView = alpo.a(2131708015) + this.jdField_a_of_type_Int + alpo.a(2131708017);
              } else {
                paramView = alpo.a(2131708014);
              }
            }
          }
          if (i == 4)
          {
            ...
            this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560498, null);
            this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371013));
            this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131370999);
            if (paramInt != 0)
            {
          ...
          if (i == 5)
          {
            paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131562767, null);
            ((TextView)paramView.findViewById(2131367599)).setText(alpo.a(2131708013));
            ((LinearLayout)paramView.findViewById(2131371249)).setVisibility(8);
            return paramView;
          }
          if (i == 6)
          {
            paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131562767, null);
            ((TextView)paramView.findViewById(2131367599)).setText(alpo.a(2131708012));
            ((LinearLayout)paramView.findViewById(2131371249)).setVisibility(8);
            return paramView;
          }
          if (i == 3)
          {
            paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131562767, null);
            paramViewGroup = (TextView)paramView.findViewById(2131367599);
            paramViewGroup.setText(alpo.a(2131708016));
            paramViewGroup.setVisibility(8);
            paramViewGroup = (LinearLayout)paramView.findViewById(2131371249);
