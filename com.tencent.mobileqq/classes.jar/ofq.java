  ...
  extends ofd<BaseArticleInfo>
{
  ...
  public int a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    {
      aciy.a("DynamicItemViewHelperCompat", "", new IllegalArgumentException(ajjy.a(2131637785)));
      return b;
    }
  ...
  protected TemplateBean a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    try
    {
      ...
      JSONObject localJSONObject = this.jdField_a_of_type_Ouu.a(i, paramBaseArticleInfo);
      localTemplateBean1 = localTemplateBean2;
      localTemplateBean2 = this.jdField_a_of_type_Ouu.a(i, localJSONObject);
      localTemplateBean1 = localTemplateBean2;
  ...
  public void a(ProteusItemView paramProteusItemView, int paramInt1, BaseArticleInfo paramBaseArticleInfo, VafContext paramVafContext, int paramInt2)
  {
    ...
    if (localTemplateBean1 != null)
    {
      ...
      if (localTemplateBean2 != null)
      {
        ...
        if (!localTemplateBean2.equals(localTemplateBean1))
        {
          ...
          if (localObject != null)
          {
            ((Container)localObject).setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841186));
    ...
    if (localTemplateBean2 != null) {
      oag.a(paramBaseArticleInfo, (TemplateBean)localObject, localTemplateBean2);
    }
    oag.a(paramBaseArticleInfo, paramVafContext, localTemplateBean2);
    beoj.a();
  }
