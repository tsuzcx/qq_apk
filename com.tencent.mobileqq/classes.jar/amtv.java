...
public class amtv
  extends amrd
{
  public amtv(CmGameLoadingFragment paramCmGameLoadingFragment, AppInterface paramAppInterface)
  {
  ...
  public void onDownloadConfirm(CmGameStartChecker.StartCheckParam paramStartCheckParam, amre paramamre, long paramLong)
  {
    ...
    do
    {
      ...
      } while (paramamre == null);
      paramamre.a(paramStartCheckParam);
      return;
    ...
    CmGameLoadingFragment.a(this.a).a(paramStartCheckParam, paramamre, paramLong);
  }
  ...
  {
    amwf.a().a(paramStartCheckParam, paramLong, null);
    if (CmGameLoadingFragment.a(this.a) != null) {
    ...
    do
    {
      do
      {
        do
        {
          ...
          amwf.a().a(paramStartCheckParam, paramLong, paramCmGameInitParams);
