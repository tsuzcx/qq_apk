...
public class wim
{
  ...
  public static ij a(String paramString, int paramInt)
  {
    ...
    try
    {
      paramString = ((in)localObject).a(paramString, 0, 0, localEnumMap);
      return paramString;
    }
  ...
  public static void a(int paramInt1, int paramInt2)
  {
    ...
    bcpw.a(localBaseApplication, paramInt1, paramInt2, 1).b(localBaseApplication.getResources().getDimensionPixelSize(2131298865));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, int paramInt, String paramString2, String paramString3, wfl paramwfl)
  {
    paramString1 = wfj.a(paramInt, paramString1);
    ...
    paramString2 = new win(paramwfl);
    paramContext = new NewIntent(paramContext, wfm.class);
