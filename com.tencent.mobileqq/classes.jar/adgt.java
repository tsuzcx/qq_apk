  ...
  implements Handler.Callback
{
  ...
  private adgv jdField_a_of_type_Adgv;
  ...
  private adgv jdField_b_of_type_Adgv;
  private ImageSwitcher jdField_b_of_type_AndroidWidgetImageSwitcher;
  private boolean jdField_b_of_type_Boolean;
  private adgv c;
  private adgv d;
  
  public adgt(ImageSwitcher paramImageSwitcher1, ImageSwitcher paramImageSwitcher2, ImageView paramImageView, MqqHandler paramMqqHandler, QQAppInterface paramQQAppInterface)
  {
  ...
  private adgv a(String paramString)
  {
    if (this.d != null)
    {
  ...
  private String a(int paramInt)
  {
    ...
    case 3: 
    default: 
      return alud.a(2131706398);
    case 0: 
      return alud.a(2131706400);
    case 1: 
      return alud.a(2131706402);
    case 2: 
      return alud.a(2131706401);
    }
    return alud.a(2131706403);
  }
  ...
  private boolean b()
  {
    ...
    if ((this.jdField_a_of_type_Int >= this.jdField_a_of_type_JavaUtilArrayList.size()) || ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_JavaUtilArrayList.size() == 2)) || ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Int >= this.jdField_a_of_type_JavaUtilArrayList.size() - 1))) {
      if ((this.d != null) && (this.jdField_b_of_type_Int != 4))
      {
        ...
        this.c = this.d;
        this.d = null;
        this.jdField_b_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.c.jdField_a_of_type_Bdbk);
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.d.jdField_a_of_type_Bdbk);
        this.jdField_a_of_type_Adgv = this.jdField_b_of_type_Adgv;
        this.jdField_b_of_type_Adgv = this.d;
        this.d = null;
      }
    }
    for (;;)
    {
      ...
      return true;
      label287:
      this.c = adgv.a(str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      break;
      label302:
      ...
      this.jdField_b_of_type_Adgv = adgv.a(str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.jdField_b_of_type_Adgv.jdField_a_of_type_Bdbk);
      continue;
      label478:
      this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.d.jdField_a_of_type_Bdbk);
      this.jdField_a_of_type_Adgv = this.jdField_b_of_type_Adgv;
      ...
      this.d = null;
      if (QLog.isColorLevel()) {
        QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "isPlayFinished play one" + this.jdField_b_of_type_Adgv.jdField_a_of_type_JavaLangString);
      }
    }
    label553:
    return false;
  ...
  private void f()
  {
    if ((this.jdField_a_of_type_Adgv != null) && (!this.jdField_a_of_type_Adgv.a()))
    {
      this.jdField_a_of_type_Adgv.a();
      this.jdField_a_of_type_Adgv = null;
    }
    if ((this.jdField_b_of_type_Adgv != null) && (!this.jdField_b_of_type_Adgv.a()))
    {
      this.jdField_b_of_type_Adgv.a();
      this.jdField_b_of_type_Adgv = null;
    }
    if ((this.c != null) && (!this.c.a()))
    {
      this.c.a();
  ...
  void a()
  {
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilArrayList.size() > 1) && (this.jdField_a_of_type_Int > 0))
        {
          ...
          this.jdField_b_of_type_Adgv = this.c;
          this.c = null;
          localObject = this.jdField_b_of_type_Adgv.a();
          this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable((Drawable)localObject);
          if (QLog.isColorLevel()) {
            QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "play two" + this.jdField_b_of_type_Adgv.jdField_a_of_type_JavaLangString);
          }
          this.c = a((String)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int + 1));
          if (this.c == null) {
            this.c = adgv.a((String)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int + 1), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          }
          ...
          this.d = adgv.a((String)localObject, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          return;
        }
      }
      catch (Throwable localThrowable)
      {
        ...
        bjuz.a(localThrowable, alud.a(2131706399));
        return;
      }
      g();
      continue;
      ...
      if (!this.c.a())
      {
        ...
        continue;
        label541:
        if ((this.jdField_b_of_type_Adgv == null) || ((!this.jdField_b_of_type_Adgv.a()) && (!this.jdField_b_of_type_Adgv.jdField_a_of_type_JavaLangString.equals(localThrowable))))
        {
          this.jdField_b_of_type_Adgv = adgv.a(localThrowable, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          continue;
          label587:
          this.jdField_b_of_type_Adgv = a(localThrowable);
          if (this.jdField_b_of_type_Adgv == null) {
            this.jdField_b_of_type_Adgv = adgv.a(localThrowable, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          }
          bdbk localbdbk = this.jdField_b_of_type_Adgv.a();
          if (localbdbk != null)
          {
            this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(localbdbk);
            if (QLog.isColorLevel()) {
              QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "play one" + this.jdField_b_of_type_Adgv.jdField_a_of_type_JavaLangString);
            }
          }
        }
      }
    ...
    {
      this.d = adgv.a((String)this.jdField_a_of_type_JavaUtilArrayList.get(0), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (this.jdField_a_of_type_Boolean)
      {
        this.c = adgv.a((String)this.jdField_a_of_type_JavaUtilArrayList.get(1), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        return;
        label772:
        if (QLog.isColorLevel())
        {
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 1))
    {
      ...
      this.d = adgv.a(paramArrayList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  void a(boolean paramBoolean)
  {
    ...
    localAlphaAnimation1.setAnimationListener(new adgu(this, paramBoolean));
