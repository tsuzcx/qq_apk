  ...
  extends agkg
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = avec.jdField_a_of_type_JavaLangString + "GameMsgChatHelper";
  }
  
  public agie(BaseChatPie paramBaseChatPie)
  {
  ...
  private avdr a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie == null) || (!(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof aiah)))
    {
      QLog.w(jdField_a_of_type_JavaLangString, 1, " param error.");
      return null;
    }
    return ((aiah)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie).a();
  }
  ...
  protected void a()
  {
    ...
    {
      Object localObject1 = (LinearLayout)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mAIORootView.findViewById(2131367477);
  ...
  {
    super.c();
    LinearLayout localLinearLayout = (LinearLayout)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mAIORootView.findViewById(2131367477);
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      avdr localavdr = a();
      if (localavdr != null) {
        avdu.a(localavdr.c, "1", "145", "920", "92005", "206353", "", "", "20", "0");
      }
    }
  }
}
