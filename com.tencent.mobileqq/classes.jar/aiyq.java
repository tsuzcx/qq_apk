...
public class aiyq
{
  ...
  public void a(VoiceTextPanel paramVoiceTextPanel)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramVoiceTextPanel.findViewById(2131367946));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramVoiceTextPanel.findViewById(2131370633));
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setOnTouchListener(new aiyr(this));
    this.jdField_a_of_type_ComTencentMobileqqActivityAioVoicetextpanelUiVoiceTextEditScrollerView = ((VoiceTextEditScrollerView)paramVoiceTextPanel.findViewById(2131365046));
  }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioVoicetextpanelUiVoiceTextEditScrollerView.setBackgroundDrawable(this.jdField_a_of_type_ComTencentMobileqqActivityAioVoicetextpanelUiVoiceTextPanel.getContext().getResources().getDrawable(2130839482));
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioVoicetextpanelUiVoiceTextEditScrollerView.setBackgroundDrawable(this.jdField_a_of_type_ComTencentMobileqqActivityAioVoicetextpanelUiVoiceTextPanel.getContext().getResources().getDrawable(2130850024));
  }
