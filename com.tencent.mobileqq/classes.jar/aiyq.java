...
public class aiyq
{
  ...
  private static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    ...
    localMessageForText.msg = String.format(anvx.a(2131701452), new Object[] { paramString1, paramString3, paramString2 });
  ...
  private static void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    ...
    Object localObject1 = anvx.a(2131701455);
    String str1 = String.format("%s(%s)", new Object[] { paramString2, paramString1 });
    Object localObject2 = anvx.a(2131701453);
    if (paramInt == 1) {}
    for (paramString2 = anvx.a(2131701447);; paramString2 = anvx.a(2131701450))
    {
      ...
      paramString2 = anvx.a(2131701451);
      paramString4 = anvx.a(2131701448);
      localObject2 = new avhz(paramString3, paramString3, (String)localObject1 + str1 + str2 + str3 + "的好友列表中。\n不想和他们是好友关系，可选择" + paramString2 + "。\n不想再被其他好友克隆，可选择" + paramString4 + "。", 0, -5040, 2686977, bcrg.a());
      ...
      ((avhz)localObject2).a(paramInt, str1.length() + paramInt, localBundle);
      ...
      ((avhz)localObject2).a(paramInt, str3.length() + paramInt, (Bundle)localObject1);
      paramString3 = new Bundle();
      paramString3.putInt("key_action", 45);
      paramString3.putString("key_action_DATA", paramString1);
      paramString3.putString("key_a_action_DATA", String.format(anvx.a(2131701454), new Object[] { str1, str3 }));
      paramInt = paramInt + str3.length() + "的好友列表中。\n不想和他们是好友关系，可选择".length();
      ((avhz)localObject2).a(paramInt, paramString2.length() + paramInt, paramString3);
      ...
      ((avhz)localObject2).a(paramInt, paramString4.length() + paramInt, paramString1);
      localMessageForUniteGrayTip.initGrayTipMsg(paramQQAppInterface, (avhz)localObject2);
  ...
  {
    MessageForUniteGrayTip localMessageForUniteGrayTip = new MessageForUniteGrayTip();
    localMessageForUniteGrayTip.initGrayTipMsg(paramQQAppInterface, new avhz(paramString, paramString, anvx.a(2131701449), 0, -5020, 2686977, bcrg.a()));
    avia.a(paramQQAppInterface, localMessageForUniteGrayTip);
  }
}
