  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      localObject = bbkg.a(paramFromServiceMsg.getWupBuffer());
      if ((localObject != null) && (((List)localObject).size() > 0))
      {
        paramFromServiceMsg = (bboi)paramIntent.getManager(12);
        if (paramFromServiceMsg != null)
        {
          ...
          notifyObserver(null, 10000, true, paramFromServiceMsg, axkt.class);
    ...
    for (;;)
    {
      ...
      notifyObserver(null, 10000, false, paramIntent, axkt.class);
      return;
      if (paramIntent != null)
      {
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    if ((str != null) && (str.equals("gc_get_newandunreadmsg"))) {
      bbkg.a(paramPacket, paramIntent);
    }
  ...
  public void service(Intent paramIntent)
  {
    ...
    if ((str != null) && ("gc_refresh_ui".equals(str)))
    {
      ...
      notifyObserver(null, 10000, true, paramIntent, axkt.class);
