  ...
  extends anud
{
  ...
  public long a;
  private bbjk jdField_a_of_type_Bbjk = new bbjk(paramAppInterface, this.jdField_a_of_type_Bbok);
  private bbok jdField_a_of_type_Bbok = new bbok();
  private Random jdField_a_of_type_JavaUtilRandom = new Random();
  
  public bbol(AppInterface paramAppInterface)
  {
  ...
  private void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    for (long l = Long.valueOf(paramArrayOfByte1).longValue();; l = 0L)
    {
      ...
      {
        if (this.jdField_a_of_type_Bbok.b())
        {
          this.jdField_a_of_type_Bbok.a(2);
          paramArrayOfByte1 = (bbjl)paramArrayOfByte2.get(0);
          this.jdField_a_of_type_Bbjk.a(paramArrayOfByte2);
          this.jdField_a_of_type_Bbjk.a(paramArrayOfByte1, l);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  private void b(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j == 4)
        {
          this.jdField_a_of_type_Bbok.a(0);
  ...
  {
    Object localObject = lfw.a(paramArrayOfByte);
    paramArrayOfByte = ((lfx)localObject).a;
    localObject = ((lfx)localObject).b;
    AudioTransClientTransInfo.IntHead localIntHead = new AudioTransClientTransInfo.IntHead();
    for (;;)
    {
      try
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Bbok.d())
        {
          ...
          this.jdField_a_of_type_Bbjk.a(paramLong);
          return;
        }
        ...
        {
          this.jdField_a_of_type_Bbok.c(4);
          return;
        }
      } while (!this.jdField_a_of_type_Bbok.g());
      this.jdField_a_of_type_Bbok.c(4);
      return;
    } while (this.jdField_a_of_type_Bbok.c());
    this.jdField_a_of_type_Bbok.c(4);
  }
  ...
  public void a(long paramLong, boolean paramBoolean)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Bbok.c();
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = lfw.a(paramString1.toByteArray(), paramString2.toByteArray());
        if (this.jdField_a_of_type_Bbjk == null) {
          break;
        }
        if (this.jdField_a_of_type_Bbjk.a()) {
          break label200;
        }
        if (!QLog.isColorLevel()) {
          break;
    ...
    label200:
    this.jdField_a_of_type_Bbjk.a(paramString1);
  }
  ...
  public void a(String paramString1, String paramString2, byte[] paramArrayOfByte, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    do
    {
      do
      {
        ...
        for (;;)
        {
          ...
          if ("TransInfoCreate.CreateSession".equals(paramString2))
          {
            ...
            if (!this.jdField_a_of_type_Bbok.c())
            {
              if (QLog.isColorLevel()) {
                QLog.e("PeakAudioTransHandler", 2, "sendCmdToService create last session not close state = " + this.jdField_a_of_type_Bbok.a());
              }
              if (paramBoolean) {}
              for (paramInt1 = 0;; paramInt1 = 1)
              {
                this.jdField_a_of_type_Bbok.c(paramInt1);
                return;
              }
            }
            if (this.jdField_a_of_type_Bbjk.a())
            {
              ...
              this.jdField_a_of_type_Bbok.a(1);
              return;
            }
          ...
          if ("TransInfo.JoinSession".equals(paramString2))
          {
            ...
            localToServiceMsg.putWupBuffer(lfw.a(paramString1.toByteArray(), paramString2.toByteArray()));
            if (this.jdField_a_of_type_Bbok.a()) {
              break;
            }
            if (QLog.isColorLevel()) {
              QLog.e("PeakAudioTransHandler", 2, "sendCmdToService other  session not open ! state =" + this.jdField_a_of_type_Bbok.a());
            }
            paramInt1 = -1;
            if (i == 5) {
              if (!paramBoolean) {
      ...
      this.jdField_a_of_type_Bbok.a(3);
      return;
      if (QLog.isColorLevel()) {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      paramObject = lfw.a(paramFromServiceMsg.getWupBuffer());
