...
public class ajzq
{
  private static ajzq jdField_a_of_type_Ajzq;
  ...
  private ajzq()
  {
    ...
    for (;;)
    {
      ...
      if ((Math.abs(l2 - l1) > 86400000L) && (this.b > 2))
      {
        ...
        awrn.a(BaseApplicationImpl.getApplication()).a(null, "ProcReporter", true, 0L, this.b, (HashMap)localObject2, null);
        this.b = 0;
  ...
  public static ajzq a()
  {
    if (jdField_a_of_type_Ajzq == null) {}
    try
    {
      if (jdField_a_of_type_Ajzq == null) {
        jdField_a_of_type_Ajzq = new ajzq();
      }
      return jdField_a_of_type_Ajzq;
    }
    finally {}
  }
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      awrn.a(BaseApplicationImpl.getApplication()).a(null, "ProcKillFailed", true, 0L, 0L, localHashMap, null);
