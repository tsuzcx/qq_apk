...
class xld
  extends Handler
{
  xld(xlb paramxlb, Looper paramLooper)
  {
    super(paramLooper);
  }
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                if ((localObject2 == null) || (!(localObject2 instanceof bchx))) {
                  break;
                }
                if (paramMessage.arg1 != 4) {
                  break label535;
                }
                if ((xlb.jdField_a_of_type_JavaUtilHashMap == null) || (TextUtils.isEmpty(xlb.a(this.a)))) {
                  break;
                }
                localObject1 = (seh)xlb.jdField_a_of_type_JavaUtilHashMap.get(xlb.a(this.a));
                ...
                this.a.jdField_a_of_type_AndroidWidgetTextView.setText(((seh)localObject1).e + paramMessage.arg2 + "%");
                return;
                try
                {
                  ...
                  ((JSONObject)localObject2).put("data", nau.a((String)localObject1));
          ...
          } while ((paramMessage.arg1 != 5) || (xlb.jdField_a_of_type_JavaUtilHashMap == null) || (TextUtils.isEmpty(xlb.a(this.a))));
          localObject2 = (seh)xlb.jdField_a_of_type_JavaUtilHashMap.get(xlb.a(this.a));
        } while (localObject2 == null);
        if (paramMessage.arg2 != 0) {
          break;
        }
        ((seh)localObject2).a(3);
      ...
      if (this.a.jdField_a_of_type_AndroidWidgetTextView != null) {
        this.a.jdField_a_of_type_AndroidWidgetTextView.setText(((seh)localObject2).d);
      }
      if (this.a.jdField_a_of_type_AndroidWidgetProgressBar != null) {
