  ...
  implements arvo
{
    ...
    if (localObject1 != null)
    {
      ...
      if (localJSONArray != null)
      {
        ...
        for (;;)
        {
          ...
          localObject1 = (QQSysAndEmojiResInfo.QQEmoConfigItem)avnn.a((JSONObject)localObject1, QQSysAndEmojiResInfo.QQEmoConfigItem.class);
          try
          {
  ...
  {
    bcst.b(null, "dc00898", "", "", "0X800A7A3", "0X800A7A3", a(paramInt1), 0, String.valueOf(paramInt2), "", "", "");
  }
  
  public boolean a(int paramInt)
  {
    boolean bool = false;
    String str = arvk.a(3, String.format("/emoji_%03d.png", new Object[] { Integer.valueOf(paramInt) }));
