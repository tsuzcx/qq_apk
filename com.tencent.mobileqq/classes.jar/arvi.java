...
{
  arvi(Intent paramIntent, int paramInt, Activity paramActivity, QQAppInterface paramQQAppInterface) {}
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Int == 2) {
          arzk.a(this.jdField_a_of_type_AndroidAppActivity, "shareToQQ", l, 0, arzk.a);
        }
        while (this.jdField_a_of_type_Int == 1)
        {
          ForwardUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X800A740", new String[0]);
          return;
          arzk.a(l, i, this.jdField_a_of_type_AndroidAppActivity, null);
        }
      ...
      while (this.jdField_a_of_type_Int == 1)
      {
        ...
        if (this.jdField_a_of_type_Int == 3) {
          ...
          arzk.a(l, i, this.jdField_a_of_type_AndroidAppActivity);
        }
      }
      if (this.jdField_a_of_type_Int == 0)
      {
