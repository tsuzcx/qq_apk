...
public class odo
  extends apas
{
  public odo(AccountDetailActivity paramAccountDetailActivity) {}
  ...
  public void a(Object paramObject)
  {
    ...
    try
    {
      ...
      avzm.a("follow", paramObject, localArrayList, null);
      if (this.a.f)
      {
        if (this.a.jdField_a_of_type_ComTencentMobileqqDataAccountDetail != null)
        {
          paramObject = this.a.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.uin;
          bdla.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", this.a.e, "mp_msg_sys_12", "scan_via", 0, 0, paramObject, "", "", this.a.jdField_g_of_type_JavaLangString);
        }
      }
      else
      {
        ...
        {
          bdla.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", this.a.jdField_b_of_type_JavaLangString, this.a.jdField_c_of_type_JavaLangString, 0, 0, "", "", this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.a.e);
          if (QLog.isColorLevel()) {
        ...
        if ((this.a.h == 115) && (this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)) {
          ((ook)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.EC_SHOP_REPORT_HANDLER)).a(134247140, this.a.e, null, null, null, 0L, false);
        }
        if (this.a.jdField_a_of_type_AndroidContentIntent.hasExtra("report_business_tvalue"))
        {
          ...
          if (i != -1) {
            ((ook)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.EC_SHOP_REPORT_HANDLER)).a(i, this.a.e, paramObject, null, null, 0L, false);
          }
        }
        return;
      }
