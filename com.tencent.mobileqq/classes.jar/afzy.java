...
public final class afzy
  implements Runnable
{
  public afzy(QQAppInterface paramQQAppInterface, NowHandler paramNowHandler, ChannelResponse paramChannelResponse, SharedPreferences paramSharedPreferences) {}
  ...
  public void run()
  {
    ...
    Object localObject1 = ImageUtil.b(BitmapManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources(), 2130844238), k, i, i);
    ...
    do
    {
      ...
      if ((!bool) || (i == 0))
      {
        ...
        ((DownloaderFactory)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(46)).a(1).a(new DownloadTask(this.jdField_a_of_type_ComTencentMobileqqNowChannelResponse.downloadLink, (File)localObject1), new afzz(this), null);
        return;
      }
