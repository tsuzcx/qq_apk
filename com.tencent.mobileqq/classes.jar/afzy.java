...
{
  private static afzy jdField_a_of_type_Afzy;
  ...
  private afzy(Context paramContext, String paramString, SQLiteDatabase.CursorFactory paramCursorFactory, int paramInt)
  {
    super(paramContext, paramString, paramCursorFactory, paramInt);
  }
  
  public static afzy a(Context paramContext)
  {
    try
    {
      if (jdField_a_of_type_Afzy == null) {
        jdField_a_of_type_Afzy = new afzy(paramContext, "media_scanner_database", null, 2);
      }
      paramContext = jdField_a_of_type_Afzy;
      return paramContext;
    }
    finally {}
  }
  ...
  public int a()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 77	afzy:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   4: ldc 79
    //   6: iconst_1
    ...
    //   62: astore_2
    //   63: aload_0
    //   64: getfield 17	afzy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   67: iconst_2
  ...
  /* Error */
  public agao a(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 77	afzy:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   4: ldc 102
    //   6: getstatic 108	afzx:b	[Ljava/lang/String;
    //   9: ldc 110
    //   11: iconst_1
    ...
    //   42: new 115	agao
    //   45: dup
    //   46: invokespecial 116	agao:<init>	()V
    //   49: astore_2
    //   50: aload_2
    //   51: aload_1
    //   52: aload_1
    ...
    //   65: putfield 127	agao:jdField_a_of_type_Int	I
    //   68: aload_2
    //   69: aload_1
    //   70: aload_1
    //   71: ldc 129
    ...
    //   83: putfield 134	agao:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   86: aload_2
    //   87: aload_1
    //   88: aload_1
    //   89: ldc 136
    ...
    //   101: putfield 143	agao:jdField_a_of_type_Long	J
    //   104: aload_1
    //   105: ifnull +9 -> 114
    //   108: aload_1
    //   109: invokeinterface 95 1 0
    //   114: aload_0
    //   115: invokevirtual 97	afzy:a	()V
    //   118: aload_2
    //   119: areturn
    //   120: astore_3
    //   121: aconst_null
    ...
    //   128: ifeq +33 -> 161
    //   131: aload_0
    //   132: getfield 17	afzy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   135: iconst_2
  ...
  /* Error */
  public java.util.ArrayList<agap> a(String paramString)
  {
    // Byte code:
    ...
    //   7: astore 4
    //   9: aload_0
    //   10: invokevirtual 77	afzy:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   13: ldc 79
    //   15: getstatic 151	afzx:a	[Ljava/lang/String;
    //   18: ldc 153
    //   20: iconst_1
    ...
    //   51: new 162	agap
    //   54: dup
    //   55: invokespecial 163	agap:<init>	()V
    //   58: astore_3
    //   59: aload_2
    //   60: astore_1
    //   61: aload_3
    ...
    //   76: putfield 164	agap:jdField_a_of_type_Int	I
    //   79: aload_2
    //   80: astore_1
    //   81: aload_3
    //   82: aload_2
    ...
    //   96: putfield 167	agap:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   99: aload_2
    //   100: astore_1
    //   101: aload_3
    //   102: aload_2
    ...
    //   116: putfield 172	agap:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   119: aload_2
    //   120: astore_1
    //   121: aload_3
    //   122: aload_2
    ...
    //   136: putfield 175	agap:jdField_a_of_type_Long	J
    //   139: aload_2
    //   140: astore_1
    //   141: aload_3
    //   142: aload_2
    ...
    //   156: putfield 177	agap:jdField_b_of_type_Long	J
    //   159: aload_2
    //   160: astore_1
    //   161: aload_3
    //   162: aload_2
    ...
    //   176: putfield 181	agap:jdField_c_of_type_Long	J
    //   179: aload_2
    //   180: astore_1
    //   181: aload_3
    //   182: aload_2
    ...
    //   196: putfield 185	agap:d	Ljava/lang/String;
    //   199: aload_2
    //   200: astore_1
    //   201: aload_3
    //   202: aload_2
    ...
    //   216: putfield 187	agap:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   219: aload_2
    //   220: astore_1
    //   221: aload_3
    //   222: aload_2
    ...
    //   236: putfield 192	agap:e	Ljava/lang/String;
    //   239: aload_2
    //   240: astore_1
    //   241: aload 4
    //   243: aload_3
    ...
    //   261: astore_1
    //   262: aload_0
    //   263: getfield 17	afzy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   266: iconst_2
  ...
  public HashSet<String> a()
  {
    ...
    //   79: astore_1
    //   80: aload_0
    //   81: getfield 17	afzy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   84: iconst_2
  ...
  public HashSet<String> a(String paramString)
  {
    ...
    //   87: astore_1
    //   88: aload_0
    //   89: getfield 17	afzy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   92: iconst_2
  ...
  public void a(agao paramagao)
  {
    ...
    try
    {
      ...
      localContentValues.put("modifieddate", Long.valueOf(paramagao.jdField_a_of_type_Long));
      localSQLiteDatabase.update("folder_table", localContentValues, "folderpath=?", new String[] { paramagao.jdField_a_of_type_JavaLangString });
      return;
    }
    catch (Exception paramagao)
    {
      if (QLog.isColorLevel()) {
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, "updateMediaScnnerFolderInfo() ERROR Exception:" + paramagao.getMessage());
      }
      return;
    }
    finally
  ...
  public void a(agap paramagap)
  {
    ...
    try
    {
      SQLiteDatabase localSQLiteDatabase = getReadableDatabase();
      ContentValues localContentValues = new ContentValues();
      localContentValues.put("name", paramagap.jdField_a_of_type_JavaLangString);
      localContentValues.put("path", paramagap.jdField_c_of_type_JavaLangString);
      localContentValues.put("filesize", Long.valueOf(paramagap.jdField_a_of_type_Long));
      localContentValues.put("modifieddate", Long.valueOf(paramagap.jdField_b_of_type_Long));
      localContentValues.put("duration", Long.valueOf(paramagap.jdField_c_of_type_Long));
      localContentValues.put("mimetype", paramagap.d);
      localContentValues.put("folderpath", paramagap.jdField_b_of_type_JavaLangString);
      localContentValues.put("md5", paramagap.e);
      localSQLiteDatabase.insert("content_table", null, localContentValues);
      return;
    }
    catch (Exception paramagap)
    {
      if (QLog.isColorLevel()) {
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, "insertMediaScannerInfoByList() ERROR Exception:" + paramagap.getMessage());
      }
      return;
    }
    finally
  ...
  /* Error */
  public void a(java.util.ArrayList<agap> paramArrayList)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnonnull +4 -> 5
    //   4: return
    //   5: aload_0
    //   6: invokevirtual 77	afzy:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   9: astore_2
    //   10: aload_2
    ...
    //   49: ldc 166
    //   51: aload_3
    //   52: getfield 167	agap:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   55: invokevirtual 242	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   58: aload 4
    //   60: ldc 169
    //   62: aload_3
    //   63: getfield 172	agap:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   66: invokevirtual 242	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   69: aload 4
    //   71: ldc 174
    //   73: aload_3
    //   74: getfield 175	agap:jdField_a_of_type_Long	J
    ...
    //   85: ldc 136
    //   87: aload_3
    //   88: getfield 177	agap:jdField_b_of_type_Long	J
    ...
    //   99: ldc 179
    //   101: aload_3
    //   102: getfield 181	agap:jdField_c_of_type_Long	J
    ...
    //   161: ifeq +33 -> 194
    //   164: aload_0
    //   165: getfield 17	afzy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   168: iconst_2
    ...
    //   198: aload_0
    //   199: invokevirtual 97	afzy:a	()V
    //   202: return
    //   203: astore_1
    //   204: invokestatic 50	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   207: ifeq -203 -> 4
    //   210: aload_0
    //   211: getfield 17	afzy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   214: iconst_2
    ...
    //   250: aload_0
    //   251: invokevirtual 97	afzy:a	()V
    //   254: return
    //   255: astore_1
    //   256: aload_2
    //   257: invokevirtual 271	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   260: aload_0
    //   261: invokevirtual 97	afzy:a	()V
    //   264: aload_1
    //   265: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	266	0	this	afzy
    //   0	266	1	paramArrayList	java.util.ArrayList<agap>
    //   9	248	2	localSQLiteDatabase	SQLiteDatabase
    //   37	101	3	localagap	agap
  ...
  /* Error */
  public java.util.ArrayList<agap> b(String paramString)
  {
    // Byte code:
    //   0: new 148	java/util/ArrayList
    //   3: dup
    ...
    //   42: new 162	agap
    //   45: dup
    //   46: invokespecial 163	agap:<init>	()V
    //   49: astore_3
    //   50: aload_2
    //   51: astore_1
    //   52: aload_3
    ...
    //   67: putfield 164	agap:jdField_a_of_type_Int	I
    //   70: aload_2
    //   71: astore_1
    //   72: aload_3
    //   73: aload_2
    ...
    //   87: putfield 167	agap:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   90: aload_2
    //   91: astore_1
    //   92: aload_3
    //   93: aload_2
    ...
    //   107: putfield 172	agap:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   110: aload_2
    //   111: astore_1
    //   112: aload_3
    //   113: aload_2
    ...
    //   127: putfield 175	agap:jdField_a_of_type_Long	J
    //   130: aload_2
    //   131: astore_1
    //   132: aload_3
    //   133: aload_2
    ...
    //   147: putfield 177	agap:jdField_b_of_type_Long	J
    //   150: aload_2
    //   151: astore_1
    //   152: aload_3
    //   153: aload_2
    ...
    //   167: putfield 181	agap:jdField_c_of_type_Long	J
    //   170: aload_2
    //   171: astore_1
    //   172: aload_3
    //   173: aload_2
    ...
    //   187: putfield 185	agap:d	Ljava/lang/String;
    //   190: aload_2
    //   191: astore_1
    //   192: aload_3
    //   193: aload_2
    ...
    //   207: putfield 187	agap:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   210: aload_2
    //   211: astore_1
    //   212: aload_3
    //   213: aload_2
    ...
    //   227: putfield 192	agap:e	Ljava/lang/String;
    //   230: aload_2
    //   231: astore_1
    //   232: aload 4
    //   234: aload_3
    ...
    //   252: astore_1
    //   253: aload_0
    //   254: getfield 17	afzy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   257: iconst_2
  ...
  public void b(agao paramagao)
  {
    ...
    try
    {
      SQLiteDatabase localSQLiteDatabase = getReadableDatabase();
      ContentValues localContentValues = new ContentValues();
      localContentValues.put("folderpath", paramagao.jdField_a_of_type_JavaLangString);
      localContentValues.put("modifieddate", Long.valueOf(paramagao.jdField_a_of_type_Long));
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, "insertMediaScnnerFolderInfo() ERROR Exception:" + paramagao.getMessage());
      }
      return;
    }
    finally
  ...
  public void b(HashSet<String> paramHashSet)
  {
    ...
    //   97: aload_0
    //   98: invokevirtual 97	afzy:a	()V
    //   101: return
    //   102: astore_1
    //   103: invokestatic 50	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   106: ifeq -102 -> 4
    //   109: aload_0
    //   110: getfield 17	afzy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   113: iconst_2
