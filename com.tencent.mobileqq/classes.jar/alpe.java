  ...
  extends alpc
{
  ...
  protected admc a;
  private WeakReference<bbgu> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public alpe(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    this.jdField_a_of_type_Admc = new admc(this.jdField_a_of_type_JavaLangString, 30000L);
  }
  ...
  private void a(long paramLong, String paramString, int paramInt)
  {
    ...
    QQAppInterface localQQAppInterface = aloy.a();
    Object localObject;
    String str2;
    String str1;
    if ((localQQAppInterface != null) && (1 == paramInt))
    {
      localObject = ((ajxl)localQQAppInterface.getManager(51)).b(paramString);
      if (localObject != null)
      {
        str2 = ((Card)localObject).strNick;
        if (((Card)localObject).shGender == 0) {
          str1 = BaseActivity.sTopActivity.getString(2131694074);
        }
      }
    }
    for (;;)
  ...
  private void a(long paramLong1, String paramString, long paramLong2, long paramLong3, int paramInt)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_MqqObserverWtloginObserver == null) {
        this.jdField_a_of_type_MqqObserverWtloginObserver = new alpk(this, paramLong1);
      }
  ...
  public boolean Invoke(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    {
      paramString = "";
      paramArrayOfVariantWrapper = aloy.a();
    ...
    if (paramString.equals("NavigateTo"))
    {
      ...
      if ((paramString != null) && (paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1)) {
        aloy.a(paramString, paramArrayOfVariantWrapper[0].GetString(), true, 0L, null, null, 3, this.jdField_a_of_type_JavaLangString, null);
      }
      return true;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramArrayOfVariantWrapper != null)
        {
          ...
          if ((!(localObject4 instanceof aert)) || (!"biz_src_ads".equals(localObject2))) {
            break label8225;
          }
          localObject3 = sgg.b(((BaseChatPie)localObject4).a.jdField_a_of_type_JavaLangString);
          ...
          localObject4 = (adlj)adlj.a((ark.Container)localObject4).get();
          if ((localObject4 == null) || (!(localObject4 instanceof adli))) {
            break label8219;
          }
          localObject4 = (MessageForArkApp)((adli)localObject4).jdField_a_of_type_JavaLangRefWeakReference.get();
          if (!alqa.a(paramString, (String)localObject1, paramArrayOfVariantWrapper, this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString)) {
            continue;
          }
          altc.a(null, this.jdField_a_of_type_JavaLangString, "FullScreenOrH5ShowForAI", 0, 0, 0L, 0L, 0L, "", "");
          ...
          else
          {
            ...
            if (localObject4 != null)
            {
              l1 = nmh.a(((MessageForArkApp)localObject4).ark_app_message.getAppIdFromMeta(), 0L);
              if (l1 != 0L) {
                continue;
              }
              paramArrayOfVariantWrapper = "";
              axqy.b(null, "dc00898", "", "", "0X800A86C", "0X800A86C", 0, 0, paramArrayOfVariantWrapper, "", "", "");
              paramArrayOfVariantWrapper = paramString;
            }
          }
          Log.d("ark.OpenUrl ", paramArrayOfVariantWrapper);
          altc.a(null, this.jdField_a_of_type_JavaLangString, "FullScreenOrH5Show", 0, 0, 0L, 0L, 0L, "", "");
          return true;
        ...
        {
          if (!aloy.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.BROWSER"))
          {
          ...
          if (paramArrayOfVariantWrapper != null)
          {
            ...
            if (k == 0)
            {
              ...
              QLog.e("ArkApp", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.OpenUrl.http appName=", this.jdField_a_of_type_JavaLangString, ",url=", nau.b(paramString, new String[0]), ", isValid set=true" });
              i = 1;
              j = 2;
              alwg.b(this.jdField_a_of_type_JavaLangString, paramString, k, j, adlj.jdField_c_of_type_JavaLangString);
            }
          }
          else
          {
            ...
            QLog.d("ArkApp", 1, new Object[] { "ArkSafe.OpenUrl check url invalid!, url=", nau.b(paramString, new String[0]), ", app=", this.jdField_a_of_type_JavaLangString });
            return false;
          }
          i = 0;
          continue;
          ...
          catch (JSONException paramArrayOfVariantWrapper)
          {
            ...
            paramArrayOfVariantWrapper = String.valueOf(l1);
            continue;
            aloy.a(localBaseActivity, paramString, true, 0L, null, (String)localObject2, 0, this.jdField_a_of_type_JavaLangString, (String)localObject3);
            continue;
          }
          ...
          if (paramArrayOfVariantWrapper.getChatFragment() != null)
          {
            ...
            if ((paramArrayOfVariantWrapper instanceof aert)) {
              ((aert)paramArrayOfVariantWrapper).a.b();
            }
          }
          else
          {
            ...
            l1 = nmh.a(((MessageForArkApp)localObject4).ark_app_message.getAppIdFromMeta(), 0L);
            aloy.a(localBaseActivity, paramString, true, l1, (MessageForArkApp)localObject4, (String)localObject2, 0, this.jdField_a_of_type_JavaLangString, (String)localObject3);
            ...
            if (((MessageForArkApp)localObject4).buildTypeAndTitle().isSdkShare)
            {
              ...
              paramArrayOfVariantWrapper = "";
              axqy.b(null, "dc00898", "", "", "0X800A869", "0X800A869", 0, 0, paramArrayOfVariantWrapper, "", "", "");
            }
            paramArrayOfVariantWrapper = paramString;
            continue;
            paramVariantWrapper = paramString + "&" + paramArrayOfVariantWrapper;
        ...
        paramVariantWrapper = bbex.a(aloy.a(), localBaseActivity, paramString);
        paramArrayOfVariantWrapper = paramString;
        ...
        if (paramArrayOfVariantWrapper != null)
        {
          ...
          if (k == 0)
          {
            ...
            QLog.e("ArkApp", 1, new Object[] { "ArkSafe.UrlCheck.setDisable.OpenUrl.jump appName=", this.jdField_a_of_type_JavaLangString, ",url=", nau.b(paramString, new String[0]), ", isValid set=true" });
            i = 1;
            j = 2;
            alwg.b(this.jdField_a_of_type_JavaLangString, paramString, k, j, adlj.jdField_c_of_type_JavaLangString);
          }
        ...
        bool1 = false;
        continue;
        QLog.e("ArkApp", 1, new Object[] { "ArkSafe.OpenUrl check url invalid, url=", nau.b(paramString, new String[0]), ", app=", this.jdField_a_of_type_JavaLangString });
        paramArrayOfVariantWrapper = paramString;
        continue;
        if (paramString.equals("OpenVideo"))
        {
          ...
          try
          {
            ...
            if ((!TextUtils.isEmpty((CharSequence)localObject1)) && ((((String)localObject1).equalsIgnoreCase("http")) || (((String)localObject1).equalsIgnoreCase("https"))))
            {
              ...
              paramVariantWrapper.SetBool(true);
              aloy.a(paramString, paramArrayOfVariantWrapper);
              altc.a((QQAppInterface)localObject1, this.jdField_a_of_type_JavaLangString, "AIOArkOpenVideo", 1, 0, 0L, 0L, 0L, paramArrayOfVariantWrapper, "");
            }
            return true;
          }
        ...
        if (paramString.equals("Report"))
        {
          ...
          try
          {
            ...
            axqy.b(paramString, "CliOper", "", (String)localObject1, "0X8005FFE", "0X8005FFE", i, 0, Long.toString(l1), paramVariantWrapper, paramArrayOfVariantWrapper, "");
            altc.a(paramString, this.jdField_a_of_type_JavaLangString, paramArrayOfVariantWrapper, i);
            return true;
          }
          catch (Exception paramVariantWrapper)
          {
            axqy.b(paramString, "CliOper", "", (String)localObject1, "0X8005FFE", "0X8005FFE", i, 0, Long.toString(l1), "0", paramArrayOfVariantWrapper, "");
            continue;
          }
          axqy.b(paramString, "CliOper", "", (String)localObject1, "0X8005FFE", "0X8005FFE", i, 0, Long.toString(l1), "0", paramArrayOfVariantWrapper, "");
          continue;
        ...
        if (paramString.equals("ReportEx"))
        {
          ...
          if (paramVariantWrapper.equals("898")) {
            try
            {
              ...
              axqy.b(null, "dc00898", "", (String)localObject1, paramArrayOfVariantWrapper, paramVariantWrapper, i, j, k, Integer.toString(m), Integer.toString(n), (String)localObject2, (String)localObject3);
              return true;
            }
            catch (JSONException paramArrayOfVariantWrapper)
            {
        ...
        {
          paramArrayOfVariantWrapper = bbdh.c();
        ...
        if (paramString.equals("Log"))
        {
          ...
          j = aloy.a(paramArrayOfVariantWrapper, l1);
          if (i == 0)
          {
        ...
        if (paramString.equals("GetNickName"))
        {
          ...
          if (paramArrayOfVariantWrapper != null)
          {
            ...
            if (l1 == 1L)
            {
              ...
              {
                localObject1 = null;
                if (!TextUtils.isEmpty(adlj.jdField_a_of_type_JavaLangString)) {
                  localObject1 = bbcz.h((QQAppInterface)localObject2, adlj.jdField_a_of_type_JavaLangString, paramString);
                }
                if (localObject1 != null)
                {
                ...
                localObject1 = bbcz.q((QQAppInterface)localObject2, paramString);
                paramArrayOfVariantWrapper = (ark.VariantWrapper[])localObject1;
                if (!TextUtils.isEmpty((CharSequence)localObject1)) {
                  continue;
                }
                paramString = bbcz.a((QQAppInterface)localObject2, paramString, 0);
                paramVariantWrapper.SetString(paramString);
                if (paramString != null) {
        ...
        else if (paramString.equals("GetContainerInfo"))
        {
          ...
          if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1) && (paramArrayOfVariantWrapper[0].IsView()))
          {
            ...
            paramString = (adlj)adlj.a(paramString).get();
            if ((paramString == null) || (!(paramString instanceof adli))) {
              continue;
            }
            paramArrayOfVariantWrapper = ((adli)paramString).a();
            paramString = paramArrayOfVariantWrapper;
            if (paramArrayOfVariantWrapper == null) {
              paramString = aloy.a();
            }
            if (QLog.isColorLevel()) {
              QLog.d("ArkApp", 2, new Object[] { "multiAio.ArkAppModuleReg GetContainerInfo Extra ViewID viewHandle=", Long.valueOf(l1), aloy.a(paramString) });
            }
            if (paramString != null)
            {
          ...
          default: 
            ...
            paramString = aloy.a();
            if (QLog.isColorLevel()) {
              QLog.d("ArkApp", 2, new Object[] { "multiAio.ArkAppModuleReg GetContainerInfo old activity=", BaseActivity.sTopActivity, aloy.a(paramString) });
            }
            break;
          case 1008: 
        ...
        else
        {
          if (paramString.equals("DataRequest"))
          {
            ...
            paramVariantWrapper.CreateObject("DataRequest", new admv(paramString, this.jdField_a_of_type_JavaLangString));
            return true;
          }
          if (paramString.equals("GetPerformance"))
          {
            ...
            paramArrayOfVariantWrapper = adli.a(paramString);
          ...
          {
            if ((this.jdField_a_of_type_Admc == null) || (paramArrayOfVariantWrapper == null) || (paramArrayOfVariantWrapper.length < 1) || (paramArrayOfVariantWrapper[0] == null) || (!paramArrayOfVariantWrapper[0].IsFunction())) {
              return false;
            }
            if (QLog.isColorLevel()) {
            ...
            this.jdField_a_of_type_Admc.b(new alpf(this, l1));
            return true;
          }
          if (paramString.equals("WatchPosition"))
          {
            ...
            l1 = a(paramArrayOfVariantWrapper[0].Copy());
            this.jdField_a_of_type_Admc.a(new alph(this, l1));
            return true;
          }
          ...
          if (paramString.equals("GetCurrentAddress"))
          {
            ...
            l1 = a(paramArrayOfVariantWrapper[0].Copy());
            this.jdField_a_of_type_Admc.a(new alpl(this, l1), true);
            return true;
          }
          if (paramString.equals("SendMessage"))
          {
            ...
            try
            {
              ...
              if ((paramArrayOfVariantWrapper.length >= 3) && (paramArrayOfVariantWrapper[2].IsView()))
              {
                ...
                QLog.d("ArkApp", 2, new Object[] { "multiAio.ArkAppModuleReg SendMessage Extra viewid viewHandle=", Long.valueOf(l1), aloy.a(paramString) });
                break label8248;
              ...
              else
              {
                ...
                QLog.d("ArkApp", 2, new Object[] { "multiAio.ArkAppModuleReg SendMessage old,sessionInfo=", aloy.a(paramString) });
                break label8251;
              }
              ...
              if (TextUtils.isEmpty(((ArkAppMessage)localObject2).promptText)) {
                ((ArkAppMessage)localObject2).promptText = String.format(ajya.a(2131700644), new Object[] { ((ArkAppMessage)localObject2).appDesc });
              }
              ...
              if (bool1)
              {
                if (paramString != null)
                {
                  aanz.b(aloy.a(), paramString, (ArkAppMessage)localObject2);
                  if (QLog.isColorLevel()) {
            ...
            if (bool1)
            {
              ...
              paramString = axas.a(aloy.a(), aloy.a().c(), paramString.jdField_a_of_type_JavaLangString, paramString.b, paramString.jdField_a_of_type_Int, (byte)1, (byte)0, (short)0, paramVariantWrapper);
          ...
          else
          {
            if (paramString.equals("GetPskeyAsync"))
            {
              ...
              if (paramVariantWrapper != null)
              {
                ...
                if (TextUtils.isEmpty((CharSequence)localObject1))
                {
                  ...
                  paramVariantWrapper = new alpm(this, paramArrayOfVariantWrapper, paramVariantWrapper, paramString, l1);
            ...
            {
              if (!aloy.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.LOGIN"))
              {
            ...
            {
              if (!aloy.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.USER_INFORMATION"))
              {
            ...
            {
              if (!aloy.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.OPENVIEW")) {
                return false;
              }
            ...
            {
              if (!aloy.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.SHARE")) {
                return false;
              }
              if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 2) && (paramArrayOfVariantWrapper[0].IsString()) && ((paramArrayOfVariantWrapper[1].IsArray()) || (paramArrayOfVariantWrapper[1].IsTable())))
              {
                ...
                paramArrayOfVariantWrapper = aloy.a(paramArrayOfVariantWrapper);
            ...
            {
              if (!aloy.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.STATUSBAR")) {
                return false;
              }
            ...
            {
              if (lgh.a(BaseApplicationImpl.getContext()))
              {
                i = 1;
              ...
              if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length == 1))
              {
                ...
                if ((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime() != null)
                {
                  ...
                  if (paramString != null)
                  {
                    ...
                    localObject1 = amqq.b(380).a();
                    paramArrayOfVariantWrapper = "";
                    paramString = paramArrayOfVariantWrapper;
                    if (localObject1 != null)
                    {
                      paramString = paramArrayOfVariantWrapper;
                      if (((amqp)localObject1).a() != null) {
                        paramString = ((amqp)localObject1).a().b;
                      }
                    }
                    paramArrayOfVariantWrapper = paramString;
                    if (TextUtils.isEmpty(paramString))
            ...
            else if (paramString.equals("GetNickNameByView"))
            {
              ...
              if (l2 != 0L)
              {
                ...
                paramString = (adlj)adlj.a(paramString).get();
                if (!(paramString instanceof adli)) {
                  continue;
                }
                paramArrayOfVariantWrapper = ((adli)paramString).a();
                paramString = paramArrayOfVariantWrapper;
                ...
                if (QLog.isColorLevel())
                {
                  QLog.d("ArkApp", 2, new Object[] { "ark.GetNickNameByView Extra ViewID viewHandle=", Long.valueOf(l2), aloy.a(paramString) });
                  paramArrayOfVariantWrapper = paramString;
                }
                if (!TextUtils.isEmpty((CharSequence)localObject1))
                {
                  ...
                  paramArrayOfVariantWrapper = bbcz.a((QQAppInterface)localObject2, paramArrayOfVariantWrapper, ((String)localObject1).equals(((QQAppInterface)localObject2).c()), (String)localObject1);
                  if (paramArrayOfVariantWrapper != null)
                  {
                    paramString = paramArrayOfVariantWrapper;
                  ...
                  {
                    paramArrayOfVariantWrapper = bbcz.q((QQAppInterface)localObject2, (String)localObject1);
                    paramString = paramArrayOfVariantWrapper;
                    if (TextUtils.isEmpty(paramArrayOfVariantWrapper)) {
                      paramString = bbcz.a((QQAppInterface)localObject2, (String)localObject1, 0);
                    }
                  }
                  paramVariantWrapper.SetString(paramString);
                  if ((paramString != null) && (QLog.isColorLevel())) {
              ...
              else
              {
                ...
                QLog.d("ArkApp", 2, new Object[] { "ark.GetNickNameByView old activity=", BaseActivity.sTopActivity, aloy.a(paramString) });
                paramArrayOfVariantWrapper = paramString;
                continue;
              }
              return false;
              ...
              if (paramString.equals("SubscribePublicAccount"))
              {
                ...
                try
                {
                  ...
                  if ((int)paramArrayOfVariantWrapper[1].GetDouble() == 0) {
                    wtb.a(BaseApplicationImpl.getContext(), paramString, new alpi(this, l1));
                  } else {
                    wtb.c(BaseApplicationImpl.getContext(), paramString, new alpj(this, l1));
                  }
                }
                catch (Exception paramString)
                {
