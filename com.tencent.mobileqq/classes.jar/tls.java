  ...
  extends syv<tnx>
{
  ...
  public tls(String paramString, List<String> paramList, List<Long> paramList1, List<Integer> paramList2, int paramInt)
  {
  ...
  public String a()
  {
    return sxp.a("StoryGroupSvc.add_video");
  }
  ...
  public syq a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new tnx(localRspAddGroupVideo);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      for (;;)
      {
        veg.b("AddGroupVideoRequest", "decodeResponse", paramArrayOfByte);
      }
    }
  }
