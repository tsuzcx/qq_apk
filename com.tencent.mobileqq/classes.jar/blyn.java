...
public class blyn
{
  ...
  public static blyo a(String paramString)
  {
    int i = 0;
    if (paramString == null) {}
    blyo localblyo;
    ...
    for (;;)
    {
      localblyo.a = paramString.getString("k=");
      localblyo.b = d(paramString.getString("u="));
      localObject = b(paramString.getString("n="));
      if (localObject != null)
      {
        localblyo.c = URLDecoder.decode((String)localObject, "UTF-8");
        if (localblyo.c != null) {}
      }
      for (localblyo.c = localblyo.b;; localblyo.c = localblyo.b)
      {
        localblyo.d = paramString.getString("o=");
        localblyo.e = paramString.getString("p=");
        localblyo.f = paramString.getString("d=");
        if ((localblyo.a == null) || (localblyo.b == null) || (localblyo.d == null)) {
          break;
        }
        return localblyo;
      }
