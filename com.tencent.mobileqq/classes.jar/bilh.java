...
class bilh
  extends bggp
{
  bilh(bilg parambilg, boolean paramBoolean1, boolean paramBoolean2) {}
  
  public void a()
  {
    if ((this.jdField_a_of_type_Bilg.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_Bilg.jdField_a_of_type_JavaLangRefWeakReference.get() != null))
    {
      Bundle localBundle = new Bundle();
      localBundle.putString("gmesdk_event_key", "gmesdk_event_key_exit_room");
      ((bili)this.jdField_a_of_type_Bilg.jdField_a_of_type_JavaLangRefWeakReference.get()).a(localBundle);
    }
  }
  ...
  public void a(int paramInt, String paramString)
  {
    if ((paramInt == 0) || (paramInt == 1003)) {
      biko.a().b(this.jdField_a_of_type_Bilg.d, this.jdField_a_of_type_Boolean, this.b);
    }
    while ((this.jdField_a_of_type_Bilg.jdField_a_of_type_JavaLangRefWeakReference == null) || (this.jdField_a_of_type_Bilg.jdField_a_of_type_JavaLangRefWeakReference.get() == null)) {
      return;
    }
    Bundle localBundle = new Bundle();
  ...
  public void a(int paramInt, String[] paramArrayOfString)
  {
    ...
    for (;;)
    {
      ...
      while (i < paramArrayOfString.length)
      {
        ...
        if (!this.jdField_a_of_type_Bilg.jdField_a_of_type_JavaUtilList.contains(str))
        {
          this.jdField_a_of_type_Bilg.jdField_a_of_type_JavaUtilList.add(str);
          if ((this.jdField_a_of_type_Bilg.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_Bilg.jdField_a_of_type_JavaLangRefWeakReference.get() != null))
          {
            localBundle = new Bundle();
            localBundle.putString("gmesdk_event_key", "gmesdk_event_key_member_info");
      ...
      while (paramInt < paramArrayOfString.length)
      {
        ...
        if (this.jdField_a_of_type_Bilg.jdField_a_of_type_JavaUtilList.contains(str))
        {
          this.jdField_a_of_type_Bilg.jdField_a_of_type_JavaUtilList.remove(str);
          if ((this.jdField_a_of_type_Bilg.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_Bilg.jdField_a_of_type_JavaLangRefWeakReference.get() != null))
          {
            localBundle = new Bundle();
            localBundle.putString("gmesdk_event_key", "gmesdk_event_key_member_info");
