  ...
  implements axaw
{
  ...
  public akfs(AppInterface paramAppInterface)
  {
  ...
  public ReqItem a(int paramInt)
  {
    ...
    for (long l = ((MessageHandler)localObject2).a().e("last_friend_seq_47");; l = 0L)
    {
      ...
      bbmj.a((byte[])localObject2, 0, localObject1.length + 4);
      bbmj.a((byte[])localObject2, 4, (byte[])localObject1, localObject1.length);
