...
public class akfs
  extends BaseAdapter
{
  public akfs(DraggableGridView paramDraggableGridView) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (getItemViewType(paramInt) == DraggableGridView.a())
    {
      if (paramView == null)
      {
        paramViewGroup = (MeasureGridView)LayoutInflater.from(this.a.getContext()).inflate(2130969849, paramViewGroup, false);
        paramViewGroup.setClickable(false);
        paramViewGroup.setNumColumns(DraggableGridView.a(this.a));
        paramViewGroup.setAdapter(new akft(this.a, paramInt / 2));
      ...
      for (;;)
      {
        ...
        ((akft)paramViewGroup.getAdapter()).a(paramInt / 2);
      }
    }
    if (paramView == null) {
