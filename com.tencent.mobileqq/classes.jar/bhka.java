...
public class bhka
{
  ...
  public static bhkb a(byte[] paramArrayOfByte)
  {
    bhkb localbhkb = new bhkb();
    ...
    for (;;)
    {
      try
      {
        ...
        localbhkb.jdField_a_of_type_Int = paramArrayOfByte.get();
        ...
        if (paramArrayOfByte.hasRemaining())
        {
          ...
          localbhkb.c = i;
          localbhkb.jdField_a_of_type_JavaLangString = new String(arrayOfByte);
          if (QLog.isColorLevel()) {
            QLog.d("ActionMsgUtil", 2, "decodeAppShareCookie succes appShareCookie.buissnessType =" + localbhkb.jdField_a_of_type_Int + "appShareCookie.action" + localbhkb.b + "appShareCookie.actionType" + localbhkb.c + "appShareCookie.actionValue" + localbhkb.jdField_a_of_type_JavaLangString);
          }
        }
      }
