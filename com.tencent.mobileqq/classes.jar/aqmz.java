...
public class aqmz
  extends aqnd
{
  public aqmz(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  protected void a(View paramView, aelt paramaelt, ChatMessage paramChatMessage, int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        paramView = arni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView);
    ...
    armf.a(paramView).a(false, this.jdField_a_of_type_AndroidContentContext, new aqna(this, paramView));
  }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          paramChatMessage = arni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
        } while (paramChatMessage == null);
        i = arni.a(paramChatMessage.fileName);
      } while ((i == 0) || (i == 2));
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      default: 
        ...
        if (paramChatMessage.nOpType == 0) {
          ...
          {
            if (bdcs.b(paramChatMessage.strFilePath)) {
              break label447;
            }
          }
        }
      ...
      label447:
      for (boolean bool1 = bool3; (!bool1) || (!bdcs.b(paramChatMessage.strFilePath)); bool1 = false)
      {
        return bool1;
        bool2 = true;
        break label383;
