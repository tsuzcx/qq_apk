  ...
  extends azvl
{
  ...
  public badx(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, TroopChatPie paramTroopChatPie)
  {
    ...
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(actj.a(9.0F, paramBaseActivity.getActivity().getResources()), actj.a(9.0F, paramBaseActivity.getActivity().getResources()));
    localLayoutParams.addRule(7, 2131375334);
    localLayoutParams.addRule(6, 2131375334);
    localLayoutParams.rightMargin = actj.a(4.0F, paramBaseActivity.getActivity().getResources());
    localLayoutParams.topMargin = actj.a(11.0F, paramBaseActivity.getActivity().getResources());
  ...
  public static void a(QQAppInterface paramQQAppInterface, ConfigurationService.Config paramConfig)
  {
    ...
    if (i != j)
    {
      paramConfig = andt.a(paramConfig);
      ...
      if ((paramConfig != null) && (paramConfig.size() > 0))
      {
        ...
        for (;;)
        {
          try
          {
            ...
            if (paramConfig.has("keywordConfigs"))
            {
              ...
              ((baiq)paramQQAppInterface.getManager(262)).a((String)localObject);
            }
        ...
        localObject = (azvm)paramQQAppInterface.getManager(289);
        if ((((azvm)localObject).a instanceof badx)) {
          ((badx)((azvm)localObject).a).a(l1);
        }
        ((baiz)paramQQAppInterface.getManager(109)).a(paramConfig);
        localEditor.apply();
  ...
  {
    bbbp.a(paramQQAppInterface, paramString, "homework", "AioAssign_Show", 0, 0, new String[] { paramString, "", "", bbbp.a(paramQQAppInterface, paramString) });
    bbbp.a(paramQQAppInterface, paramString, "Grp_notice", "CreateNotice_Show", 0, 0, new String[] { paramString, "", "", "" });
  }
  
  private boolean a()
  {
    amta localamta = amtb.a();
    return (localamta != null) && (localamta.g());
  }
  ...
  {
    if ((paramTroopChatPie.jdField_a_of_type_Aeyc != null) && (paramTroopChatPie.jdField_a_of_type_Aeyc.a(paramTroopChatPie.a()))) {}
    do
    {
      return;
      if (!((aruh)paramTroopChatPie.a(33)).c()) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (paramTroopChatPie.jdField_a_of_type_Aeyc == null) {
        paramTroopChatPie.jdField_a_of_type_Aeyc = new aeyc(paramTroopChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      }
      paramTroopChatPie.jdField_a_of_type_Aeyc.a(paramTroopChatPie.a(), true);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean, baia parambaia, TroopChatPie paramTroopChatPie)
  {
    ...
    if ((localTroopInfo != null) && (localTroopInfo.isHomeworkTroop())) {
      if (parambaia != null) {
        bahy.a(paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), parambaia, paramBoolean);
      }
    }
    while (!QLog.isColorLevel())
    {
      return;
      if (this.jdField_a_of_type_Baia == null) {
        this.jdField_a_of_type_Baia = new baeb(this, paramTroopChatPie);
      }
      bahy.a(paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Baia, paramBoolean);
      return;
    }
  ...
  {
    a(paramBoolean, new baea(this), paramTroopChatPie);
  }
  ...
  public void a(boolean paramBoolean1, TroopChatPie paramTroopChatPie, boolean paramBoolean2)
  {
    ...
    {
      if (paramTroopChatPie.jdField_a_of_type_Aeyc != null) {
        paramTroopChatPie.jdField_a_of_type_Aeyc.a(paramTroopChatPie.a(), false);
      }
      e(false);
      b(false);
      return;
  ...
  public void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramBoolean = bahy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "homework_troop_aio_panel_tip_homework");
      if (QLog.isColorLevel()) {
      ...
      {
        a(1, 500L);
        bahy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "homework_troop_aio_panel_tip_homework", true);
        return;
      }
      paramBoolean = bahy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "homework_troop_aio_panel_tip_notification");
      if (QLog.isColorLevel()) {
    ...
    a(2, 500L);
    bahy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "homework_troop_aio_panel_tip_notification", true);
    return;
    label238:
    a();
  }
  ...
  public void c()
  {
    if ((this.jdField_a_of_type_Bfxy != null) && (this.jdField_a_of_type_Bfxy.isShowing()) && (this.jdField_a_of_type_Int > 0)) {
  ...
  public void c(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (paramBoolean))
    {
      if (!a())
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new bady(this));
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843165);
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      bbbp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "homework", "AioSee_Show", 0, 0, new String[] { this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "", "", bbbp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a) });
  ...
  public void d(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (paramBoolean))
    {
      if (this.jdField_a_of_type_ComTencentMobileqqTroopWidgetRedDotAnimateView.getVisibility() != 0) {
        bbbp.a("Grp_edu", "homework", "AioSee_Reddot_Show", 0, 0, new String[] { this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a });
      }
  ...
  public void e(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (paramBoolean))
    {
      int i = bahy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
      if (QLog.isColorLevel()) {
