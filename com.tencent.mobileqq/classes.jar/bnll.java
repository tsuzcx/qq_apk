...
public class bnll
{
  ...
  public bnll()
  {
    this.jdField_a_of_type_Bnlm = new bnlm();
  }
  
  public bnll(JSONObject paramJSONObject)
  {
  ...
  public boolean a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Bnlm.jdField_a_of_type_Int = i;
      this.jdField_a_of_type_Bnlm.jdField_a_of_type_ArrayOfInt = new int[] { j, k, m, n };
      this.jdField_a_of_type_Bnlm.jdField_a_of_type_JavaLangString = ((String)localObject);
      this.jdField_a_of_type_Bnlm.b = i1;
      this.jdField_a_of_type_Bnlm.c = i2;
      this.jdField_a_of_type_Bnlm.d = i3;
      this.jdField_a_of_type_Bnlm.e = i4;
      this.jdField_a_of_type_Bnlm.f = i5;
      return true;
    }
  ...
  {
    return "Item{thumbUrl='" + this.jdField_a_of_type_JavaLangString + '\'' + ", name='" + this.b + '\'' + ", desc='" + this.c + '\'' + ", imageUrl='" + this.d + '\'' + ", imageDrawable=" + this.jdField_a_of_type_AndroidGraphicsDrawableDrawable + ", layoutJson='" + this.e + '\'' + ", params=" + this.jdField_a_of_type_Bnlm + '}';
  }
}
