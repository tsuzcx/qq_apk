...
public class audf
{
  ...
  /* Error */
  private void a(File paramFile1, File paramFile2, aude paramaude)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 7
    ...
    //   25: iconst_1
    //   26: ldc 150
    //   28: invokestatic 54	audf:a	(ILjava/lang/String;)V
    //   31: iconst_0
    //   32: ifeq +11 -> 43
    ...
    //   134: aload_0
    //   135: getfield 29	audf:jdField_a_of_type_Boolean	Z
    //   138: ifne +62 -> 200
    //   141: aload 5
    //   143: aload 7
    //   145: iconst_0
  ...
  private void a(List<String> paramList, aude paramaude)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          this.jdField_b_of_type_Long += FileUtil.getFileSize(str1);
        }
    ...
    if (str2.contains("/.tmp/")) {
      localObject = b(str1) + auea.a(str2);
    }
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ThreadManager.post(new FMSettings.4(this, str2, (File)localObject, j, paramaude), 8, null, false);
          i += 1;
        }
      ...
      if (str2.contains("/.thumbnails/")) {
        localObject = c(str1) + auea.a(str2);
      } else {
        localObject = a(str1) + auea.a(str2);
      }
    }
  }
  ...
  private audl b()
  {
    return (audl)this.jdField_a_of_type_JavaUtilMap.get("sdCard");
  }
  ...
  private audl c()
  {
    ...
    return (audl)this.jdField_a_of_type_JavaUtilMap.get("externalSdCard");
  }
  ...
  private void c()
  {
    ...
    ThreadManager.post(new FMSettings.1(this, b(localaudl.jdField_b_of_type_JavaLangString + localaudl.c)), 8, null, false);
  }
  ...
  private audl d()
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localObject2 = (audl)this.jdField_a_of_type_JavaUtilMap.get(localObject2);
      ((audl)localObject2).a();
      if (((audl)localObject2).jdField_a_of_type_Boolean)
      {
        a(2, "getDefaultStorage[" + ((audl)localObject2).jdField_b_of_type_JavaLangString + "] + ext[" + ((audl)localObject2).c + "]");
        return localObject2;
      }
    }
    a(2, "getDefaultStorage nothing is default refresh!");
    Object localObject2 = (audl)this.jdField_a_of_type_JavaUtilMap.get("sdCard");
    localObject1 = localObject2;
    if (localObject2 == null)
    {
      localObject1 = new audl(this, null);
      ((audl)localObject1).jdField_a_of_type_Boolean = true;
      ((audl)localObject1).jdField_a_of_type_JavaLangString = "SD卡";
      ((audl)localObject1).jdField_b_of_type_JavaLangString = Environment.getExternalStorageDirectory().getPath();
      ((audl)localObject1).c = "";
    }
    ((audl)localObject1).a(BaseApplicationImpl.getContext());
    return localObject1;
  }
  ...
  public audl a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localObject = (audl)this.jdField_a_of_type_JavaUtilMap.get(localObject);
      if (localaudl != localObject) {
        return localObject;
      }
    }
  ...
  public String a()
  {
    ...
    return a(localaudl.jdField_b_of_type_JavaLangString + localaudl.c);
  }
  ...
  public void a()
  {
    ...
    Map localMap = auea.a(localBaseApplication);
    ...
    if (localIterator.hasNext())
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          localaudl = new audl(this, null);
          localaudl.jdField_a_of_type_Boolean = false;
          if (!str2.equalsIgnoreCase("sdCard")) {
            break label402;
          }
          localaudl.jdField_a_of_type_JavaLangString = "SD卡";
          localaudl.jdField_b_of_type_JavaLangString = ((String)localObject);
          localaudl.c = "";
          a(1, "rootPath[" + localaudl.jdField_b_of_type_JavaLangString + "],bDefault[" + localaudl.jdField_a_of_type_Boolean + "]");
          localObject = new StatFs((String)localObject);
          localaudl.jdField_a_of_type_Long = (((StatFs)localObject).getAvailableBlocks() * ((StatFs)localObject).getBlockSize());
          a(4, "defaultRootPath[" + str1 + "].equalsIgnoreCase(si.rootPath[" + localaudl.jdField_b_of_type_JavaLangString + "])");
          if ((localMap.size() == 1) || (str1.equalsIgnoreCase(localaudl.jdField_b_of_type_JavaLangString)))
          {
            a(4, "defaultRootPath.equalsIgnoreCase(si.rootPath) = true");
            localaudl.jdField_a_of_type_Boolean = true;
            localaudl.a(localBaseApplication);
          }
          localaudl.a();
          this.jdField_a_of_type_JavaUtilMap.put(str2, localaudl);
        }
        catch (Exception localException)
        {
          localException.printStackTrace();
        ...
        {
          localaudl.jdField_a_of_type_JavaLangString = "外置SD卡";
          localBaseApplication.getExternalFilesDir(null);
          String str3 = BaseApplicationImpl.sApplication.getPackageName();
          localaudl.jdField_b_of_type_JavaLangString = ((String)localObject);
          localaudl.c = ("/Android/data/" + str3 + "/");
        }
      }
    }
  }
  
  public void a(long paramLong, List<String> arg3, Activity paramActivity, aude paramaude)
  {
    ...
    for (;;)
    {
      ...
      a(1, "showChoosePath, callback[" + paramaude + "]");
      ??? = b();
      audl localaudl = c();
      if (((audl)???).jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_JavaLangString = anvx.a(2131704139);
      }
      ...
      {
        label216:
        paramActivity.runOnUiThread(new FMSettings.5(this, paramActivity, ???, paramaude));
        return;
        if ((localaudl == null) || (!localaudl.jdField_a_of_type_Boolean)) {
          break label216;
        }
        this.jdField_a_of_type_JavaLangString = anvx.a(2131704135);
      }
    }
  }
  ...
  public void a(String paramString)
  {
    try
    {
      if (this.jdField_a_of_type_JavaUtilMap != null)
      {
        ...
        {
          ((audl)this.jdField_a_of_type_JavaUtilMap.get("sdCard")).a(BaseApplicationImpl.getContext());
          return;
        }
      }
    }
  ...
  public long b()
  {
    ...
    localObject = ((audl)localObject).jdField_b_of_type_JavaLangString;
    try
    {
      localObject = new StatFs((String)localObject);
      long l = ((StatFs)localObject).getAvailableBlocks();
