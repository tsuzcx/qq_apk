...
{
  public jme(RandomController paramRandomController) {}
  
  public void a(int paramInt, jmy paramjmy)
  {
    ...
    do
    {
      do
      {
        do
        {
          for (;;)
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.d("RandomController", 2, "rsp.rsptype = " + paramjmy.a + ", errCode = " + paramInt);
            }
            if ((paramjmy.a == 1) || (paramjmy.a == 2))
            {
              switch (paramInt)
              {
              case -2: 
              ...
              case 1: 
                ...
                paramjmy = (jmz)paramjmy;
                RandomController.a(this.a).a(paramjmy);
                RandomController.a(this.a).a().postDelayed(RandomController.a(this.a), paramjmy.h);
                return;
              case 0: 
                RandomController.a(this.a, paramjmy);
                return;
              case -1: 
                RandomController.a(this.a);
                return;
              }
              RandomController.b(this.a, paramjmy);
              return;
            }
            if ((paramjmy.a == -100) || (paramjmy.a == 3))
            {
              if (RandomController.a(this.a) == 1)
              {
                if ((paramInt == 0) && ((paramjmy instanceof jna)))
                {
                  paramjmy = (jna)paramjmy;
                  this.a.jdField_a_of_type_ComTencentAvAppSessionInfo.a.a = paramjmy.a;
                  if (this.a.jdField_a_of_type_ComTencentAvAppSessionInfo.f())
                  {
                    paramjmy = RandomController.a(this.a).iterator();
              ...
              else if (RandomController.a(this.a) == 2)
              {
                Object localObject2;
                Object localObject1;
                if ((paramInt == 0) && ((paramjmy instanceof jnc)))
                {
                  localObject2 = (jnc)paramjmy;
                  if (((jnc)localObject2).f != 0) {
                    if (((jnc)localObject2).f != 2) {
                      break label517;
                    }
                  }
                  for (localObject1 = ((jnc)localObject2).e;; localObject1 = String.valueOf(((jnc)localObject2).jdField_a_of_type_Long))
                  {
                    if (!TextUtils.isEmpty((CharSequence)localObject1))
                    {
                      ...
                      {
                        localGAudioFriends.c = ((jnc)localObject2).c;
                        RandomController.a(this.a).a((String)localObject1, ((jnc)localObject2).b, ((jnc)localObject2).c);
                        if (QLog.isColorLevel()) {
                ...
                if ((paramjmy instanceof jnc))
                {
                  paramjmy = (jnc)paramjmy;
                  if ((!TextUtils.isEmpty(paramjmy.d)) && (TextUtils.isEmpty(this.a.jdField_a_of_type_ComTencentAvAppSessionInfo.a.e)))
                  {
                    this.a.jdField_a_of_type_ComTencentAvAppSessionInfo.a.e = (RandomController.a(this.a).getApp().getResources().getString(2131429350) + " “" + paramjmy.d + "” ");
                    RandomController.a(this.a, paramjmy.d);
                    if (QLog.isColorLevel()) {
            ...
            {
              if ((!(paramjmy instanceof jnd)) || (paramjmy.a != 5)) {
                break label1014;
              }
              if (paramInt != 0) {
                break;
              }
              paramjmy = (jnd)paramjmy;
              if (QLog.isColorLevel()) {
                QLog.d("RandomController", 2, "request room owner room owner change push，uin " + paramjmy.b + " [random room owner]");
              }
        ...
        return;
      } while ((!(paramjmy instanceof jnd)) || (4 != paramjmy.a));
      if (QLog.isColorLevel()) {
      ...
      paramjmy = (jnd)paramjmy;
      long l = paramjmy.jdField_a_of_type_OrgJsonJSONObject.optInt("groupid");
      this.a.jdField_a_of_type_JavaLangString = HexUtil.a(paramjmy.jdField_a_of_type_OrgJsonJSONObject.optString("wording").trim());
      ...
      if (l == this.a.jdField_a_of_type_Long)
      {
        ...
        for (;;)
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.e("RandomController", 2, "[random room owner] KICK_MEMBER fail" + paramjmy.jdField_a_of_type_JavaLangString);
            }
