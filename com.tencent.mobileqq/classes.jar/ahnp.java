...
public class ahnp
{
  ...
  private static ahnp jdField_a_of_type_Ahnp;
  public static final String a;
  public static long b;
  public static final String b;
  public Handler a;
  public HandlerThread a;
  HashMap<String, ahnq> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  public MqqHandler a;
  ahnr[] jdField_a_of_type_ArrayOfAhnr = null;
  private ArrayList[] jdField_a_of_type_ArrayOfJavaUtilArrayList = new ArrayList[6];
  private ArrayList[] b;
  
  static
  {
    jdField_a_of_type_JavaLangString = bigv.a("Tencent/MobileQQ/poke/");
  ...
  private ahnp()
  {
    ...
    this.jdField_a_of_type_ArrayOfAhnr = new ahnr[6];
    ahnr[] arrayOfahnr = this.jdField_a_of_type_ArrayOfAhnr;
    int k = arrayOfahnr.length;
    i = j;
    while (i < k)
    {
      ahnr localahnr = arrayOfahnr[i];
      localahnr = new ahnr(this);
      localahnr.jdField_a_of_type_Int = 1;
      localahnr.jdField_a_of_type_Long = -1L;
      i += 1;
    }
  ...
  {
    if (jdField_a_of_type_Ahnp == null) {}
    try
    {
      if (jdField_a_of_type_Ahnp == null) {
        jdField_a_of_type_Ahnp = new ahnp();
      }
      return jdField_a_of_type_Ahnp;
    }
    finally {}
  }
  ...
  public int a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      localObject1 = new ahnq(this);
      ((ahnq)localObject1).jdField_a_of_type_ArrayOfAhns = new ahns[6];
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, localObject1);
    }
    Object localObject2 = (ahnq)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (localObject2 == null)
    {
      paramQQAppInterface = new HashMap();
      paramQQAppInterface.put(BaseConstants.RDM_NoChangeFailCode, "");
      bdmc.a(BaseApplication.getContext()).a(null, "pokeStrengthNullPoint", false, 0L, 0L, paramQQAppInterface, "");
      return 0;
    }
    Object localObject1 = ((ahnq)localObject2).jdField_a_of_type_ArrayOfAhns;
    paramInt2 = ((ahnq)localObject2).jdField_a_of_type_Int;
    if (paramInt1 - 1 == -1) {
      paramInt1 = 0;
    }
    while ((paramInt1 >= 0) && (paramInt1 < 6))
    {
      ...
      {
        localObject1[paramInt1] = new ahns(this);
      ...
      if (paramInt3 != -1)
      {
        ...
        ((ahnq)localObject2).jdField_a_of_type_Int = paramInt1;
      ...
      else
      {
        ...
        {
          if (paramInt2 != -1) {
            bdll.b(paramQQAppInterface, "CliOper", "", paramString, "0X8008914", "0X8008914", 0, 0, "" + localObject1[paramInt2].jdField_b_of_type_Int, "", "", "");
          }
          localObject1[paramInt1].jdField_a_of_type_Long = l1;
          if (QLog.isColorLevel()) {
    ...
    {
      bdll.b(paramQQAppInterface, "CliOper", "", paramString, "0X8008914", "0X8008914", 0, 0, "" + localObject1[paramInt2].jdField_b_of_type_Int, "", "", "");
      ((ahnq)localObject2).jdField_a_of_type_Int = -1;
    }
    return 0;
  }
  ...
  public void a(View paramView)
  {
    ...
    Object localObject;
    if (ahdx.class.isInstance(paramView))
    {
      localObject = (ahdx)paramView;
      if (QLog.isColorLevel()) {
        QLog.d("GivingHeart", 2, new Object[] { "==>to be remove obj:", Integer.valueOf(((ahdx)localObject).jdField_b_of_type_Int) });
      }
      if ((((ahdx)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage instanceof MessageForPoke))
      {
        paramView = (MessageForPoke)((ahdx)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
        if (ahnt.a(paramView.interactType)) {
          break label82;
        }
      }
    }
    ...
    do
    {
      do
      {
        ...
        } while (!((ahdx)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a());
        localObject = ((ahdx)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.a();
        paramView.mUnlimitedState.jdField_a_of_type_Int = ((ahxe)localObject).jdField_a_of_type_Int;
        paramView.mUnlimitedState.jdField_b_of_type_Int = ((ahxe)localObject).jdField_b_of_type_Int;
        paramView.mUnlimitedState.jdField_a_of_type_Long = ((ahxe)localObject).jdField_a_of_type_Long;
        paramView.mFrameState.c = ((ahxe)localObject).jdField_b_of_type_Boolean;
        paramView.mFrameState.jdField_a_of_type_Boolean = ((ahxe)localObject).jdField_a_of_type_Boolean;
        return;
        localObject = ((ahdx)localObject).jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.getBackground();
  ...
  {
    this.jdField_a_of_type_AndroidOsHandler = new blhq(Looper.getMainLooper(), paramFitSystemWindowsRelativeLayout);
  }
}
