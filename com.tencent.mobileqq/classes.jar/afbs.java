...
public class afbs
{
  ...
  public static afbs a(SharedPreferences paramSharedPreferences, int paramInt)
  {
    ...
    afbs localafbs = new afbs();
    localafbs.jdField_a_of_type_Long = paramSharedPreferences.getLong(str1, 0L);
    if (DateUtils.isToday(localafbs.jdField_a_of_type_Long)) {
      try
      {
        ...
        {
          localafbs.a(paramSharedPreferences.getString(paramInt), paramSharedPreferences.getInt(paramInt + 1));
          paramInt += 2;
          continue;
          localafbs.jdField_a_of_type_Long = System.currentTimeMillis();
        }
      }
  ...
  public static void a(SharedPreferences paramSharedPreferences, afbs paramafbs, int paramInt)
  {
    paramafbs.a();
    Object localObject = new JSONArray();
    Iterator localIterator = paramafbs.jdField_a_of_type_JavaUtilHashMap.entrySet().iterator();
    ...
    if (paramInt == 2)
    {
      ...
      paramSharedPreferences.putLong("web_uin_list_time_millis", paramafbs.jdField_a_of_type_Long);
    }
    for (;;)
    {
      ...
      paramSharedPreferences.putLong("bless_uin_list_time_millis", paramafbs.jdField_a_of_type_Long);
    }
  }
