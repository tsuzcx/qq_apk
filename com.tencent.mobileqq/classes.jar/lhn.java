...
public class lhn
{
  public static boolean a()
  {
    ...
    label132:
    long l;
    if ((!bdek.e()) || (AIManager.installDetector(PTHumanSegmenter.class, (String)localObject2, (String)localObject1)))
    {
      bool1 = true;
      bool2 = lhq.a().a();
      boolean bool4 = lho.a();
    ...
    {
      localObject2 = (lhp)((Iterator)localObject1).next();
      if (localObject2 != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("PanoramaAccessManager", 2, "checkPanoramaAccessEnable CPUinfo = " + ((lhp)localObject2).b + "|" + ((lhp)localObject2).a);
        }
        if ((bool1) || (lpm.a(((lhp)localObject2).b, ((lhp)localObject2).a * 10000, l * 100000000L))) {}
