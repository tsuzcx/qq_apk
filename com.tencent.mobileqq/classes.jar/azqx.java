  ...
  extends Handler
{
  ...
  public azqx(Looper paramLooper, PresendPicMgr paramPresendPicMgr)
  {
    super(paramLooper);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if (localPresendPicMgr != null)
    {
      ...
      default: 
        ...
        return;
      case 1: 
        azpw.a("PresendPicMgr", "PresendHandler", "handleMessage MSG_REGISTER_CLIENT_HANDLER");
        ...
        while (((Iterator)localObject).hasNext()) {
          localArrayList.add(((azqy)((Iterator)localObject).next()).a);
        }
      ...
      azpw.a("PresendPicMgr", "PresendHandler", "handleMessage MSG_UNREGISTER_CLIENT_HANDLER");
      localPresendPicMgr.a = null;
      return;
    }
    azpw.b("PresendPicMgr", "handleMessage", "PresendPicMgr == null!");
  }
}
