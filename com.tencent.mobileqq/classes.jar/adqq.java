...
public class adqq
  extends MqqHandler
{
  public adqq(ChatSettingActivity paramChatSettingActivity) {}
        ...
        do
        {
          do
          {
            ...
            if ((ChatSettingActivity.a(this.a) != 1001) && (ChatSettingActivity.a(this.a) != 10002)) {
              ...
              {
                paramMessage = (awtp)this.a.app.getManager(QQManagerFactory.SHIELD_LIST_MANAGER);
            ...
            for (;;)
            {
              ...
              return;
              paramMessage = ContactUtils.getUinByPhoneNum(this.a.app, ChatSettingActivity.d(this.a));
              ...
              bool1 = false;
              break label309;
              paramMessage = (anvk)this.a.app.getManager(QQManagerFactory.FRIENDS_MANAGER);
              if (paramMessage != null)
              {
