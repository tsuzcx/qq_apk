...
public class astl
{
  ...
  {
    axqy.b(paramQQAppInterface, "dc00898", "", "", "frd_recom", "grp_card_tab_exp", 0, 0, "", "", "", "");
  }
  ...
  private static void a(String paramString1, int paramInt1, QQAppInterface paramQQAppInterface, int paramInt2, String paramString2, int paramInt3, List<RecommendPerson> paramList)
  {
    ...
    axqy.b(paramQQAppInterface, "dc00898", "", paramString2, "frd_recom", paramString1, paramInt2, paramInt1, String.valueOf(paramInt3), "", localJSONObject.toString(), "");
  }
}
