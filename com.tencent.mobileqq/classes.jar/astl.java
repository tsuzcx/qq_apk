...
public class astl
{
  public static final View.OnTouchListener a = new astm();
  
  public static Dialog a(Context paramContext)
  {
    Object localObject3 = null;
    View localView1 = LayoutInflater.from(paramContext).inflate(2131561137, null);
    View localView2 = localView1.findViewById(2131374845);
    View localView3 = localView1.findViewById(2131363902);
    ImageView localImageView = (ImageView)localView1.findViewById(2131374849);
    ...
    try
    {
      ...
      localObject1 = assx.a(str, (BitmapFactory.Options)localObject1);
      ...
      localView2.setOnClickListener(new astn(paramContext, (Dialog)localObject1));
      localView3.setOnClickListener(new asto((Dialog)localObject1));
      return localObject1;
    }
  ...
  {
    Object localObject1 = LayoutInflater.from(paramContext).inflate(2131561136, null);
    Object localObject3 = ((View)localObject1).findViewById(2131363902);
    ((View)localObject3).setOnTouchListener(a);
    ((View)localObject3).setOnClickListener(paramOnClickListener);
    ImageView localImageView = (ImageView)((View)localObject1).findViewById(2131368704);
    TextView localTextView = (TextView)((View)localObject1).findViewById(2131380347);
    Button localButton = (Button)((View)localObject1).findViewById(2131363972);
    ...
    {
    default: 
      localObject1 = assx.a("expand_guide_profile.png");
      paramOnClickListener = anvx.a(2131707946);
      localObject3 = anvx.a(2131707945);
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = assx.a((String)localObject1, (BitmapFactory.Options)localObject3);
        localImageView.setImageBitmap((Bitmap)localObject1);
      ...
      localObject1 = assx.a("expand_guide_switch.png");
      paramOnClickListener = anvx.a(2131707947);
      localObject3 = anvx.a(2131707948);
