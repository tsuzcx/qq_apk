  ...
  extends View
{
  ...
  public ztr(ScreenShot paramScreenShot, Context paramContext)
  {
    super(paramContext);
    ...
    do
    {
      try
      {
        for (;;)
        {
          ...
          Toast.makeText(this.jdField_a_of_type_ComTencentMobileqqAppScreenShot.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 2131433911, 1).show();
          return;
          i = getWidth();
          j = getHeight();
      ...
      if (this.jdField_a_of_type_AndroidGraphicsRect.isEmpty())
      {
        ...
        paramCanvas.drawText(this.jdField_a_of_type_ComTencentMobileqqAppScreenShot.jdField_a_of_type_AndroidContentContext.getString(2131433909), getWidth() / 2, m + 26.0F * f1, this.jdField_b_of_type_AndroidGraphicsPaint);
      }
