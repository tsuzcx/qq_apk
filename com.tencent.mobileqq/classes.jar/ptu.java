...
public class ptu
  extends pqq
{
  public ptu(Context paramContext, baxy parambaxy, ram paramram)
  {
  ...
  public pqq d()
  {
    ...
    if ((this.jdField_a_of_type_Pqp != null) && ((this.jdField_a_of_type_Pqp instanceof ComponentContentThree))) {
      localLinearLayout.addView((ComponentContentThree)this.jdField_a_of_type_Pqp);
    }
  ...
  public pqq g()
  {
    this.jdField_a_of_type_Pqp = new ComponentContentThree(this.jdField_a_of_type_AndroidContentContext);
    return this;
  }
}
