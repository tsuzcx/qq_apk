  ...
  implements Manager
{
  ...
  public bger(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(String paramString)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        {
          if (localFile.exists()) {
            paramString = FileUtils.readFileContent(localFile);
          }
          if (TextUtils.isEmpty(paramString))
          {
            if (!QLog.isColorLevel()) {
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        boolean bool = FileUtils.writeFile(str, paramString1);
        if (!bool) {
          continue;
        }
        bfyz.c(BaseApplicationImpl.getContext(), paramInt, paramString2);
        return;
      }
      finally {}
    }
