...
public class abvj
{
  ...
  {
    abvq localabvq = abvr.a(BaseApplicationImpl.sApplication, "Native");
    if (localabvq != null) {
      UpdateManager.a(localabvq.e());
    }
  }
  ...
  public static boolean a(abvq paramabvq)
  {
    int j = 701;
    String str1 = paramabvq.c();
    ...
    if (700 == i)
    {
      localObject = new File(PatchCommonUtil.getPatchPath(paramabvq.b()));
      if ((((File)localObject).exists()) && (((File)localObject).length() == paramabvq.b())) {
        i = 700;
      }
    }
    for (;;)
  ...
  private static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    if ((localabvq != null) && (localabvq.a(BaseApplicationImpl.sApplication, null)))
    {
      String str = localabvq.b();
      File localFile = new File(PatchCommonUtil.getPatchPath(str));
      int i;
      if ((!localFile.exists()) || (localFile.length() != localabvq.b()))
      {
        i = j;
        if (localFile.exists())
        {
      ...
      {
        if (i != 0) {
          ((abvh)paramQQAppInterface.getManager(120)).a(0, "dex", localabvq);
        }
        return;
