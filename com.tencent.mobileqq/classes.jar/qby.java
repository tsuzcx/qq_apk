...
public class qby
{
  public static void a(String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      if (localObject != null)
      {
        TVK_PlayerVideoInfo localTVK_PlayerVideoInfo = new TVK_PlayerVideoInfo(2, ois.a(paramString), "");
  ...
  public static boolean a(String paramString)
  {
    ...
    Object localObject2 = ois.a(paramString);
    ...
    ((TVK_PlayerVideoInfo)localObject2).setConfigMap("cache_servers_type", spm.a);
