...
public class acxi
{
  ...
  public acxi(SharedPreferences paramSharedPreferences, String paramString)
  {
  ...
  public static acxi a(JSONObject paramJSONObject)
  {
    acxi localacxi = new acxi();
    try
    {
      localacxi.a = paramJSONObject.getString("name").trim();
      localacxi.b = paramJSONObject.getString("ver").trim();
      localacxi.c = paramJSONObject.getString("system").trim();
      localacxi.d = paramJSONObject.getString("driver").trim();
      localacxi.e = paramJSONObject.getString("url").trim();
      localacxi.f = paramJSONObject.getString("type").trim();
      localacxi.h = paramJSONObject.getString("enabled").trim();
      localacxi.k = paramJSONObject.optString("previousPatch", "").trim();
      return localacxi;
    }
    catch (Exception paramJSONObject)
    {
      acwx.a("PatchInfo", "Parse PatchInfo from JSON exception " + paramJSONObject);
    }
    return null;
  }
  ...
  public JSONObject a()
  {
    ...
    {
      acwx.a("PatchInfo", "Get JSON String failed " + localJSONException);
    }
