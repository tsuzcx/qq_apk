...
public class aetu
{
  ...
  private static ameq jdField_a_of_type_Ameq;
  ...
  {
    if (bdfa.a(paramSessionInfo.jdField_a_of_type_Int)) {}
    for (int i = 5;; i = 6)
    {
  ...
  public static int a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, ArrayList<String> paramArrayList, Intent paramIntent1, Intent paramIntent2)
  {
    ...
    if ((paramIntent1 == null) || (!paramIntent1.hasExtra("showFlashPic")))
    {
      ...
      paramIntent2.putExtra("showFlashPic", alse.a(paramSessionInfo.jdField_a_of_type_Int, (HotChatManager)localObject, paramSessionInfo.b));
    }
    ...
    for (;;)
    {
      ...
      paramIntent2.putExtra("ALBUM_ID", bdfa.a(paramActivity));
      paramIntent2.putExtra("ALBUM_NAME", bdfa.b(paramActivity));
      ...
      if ((paramIntent1 != null) && (paramIntent1.getBooleanExtra("ReceiptMsgManager.EXTRA_KEY_IS_RECEIPT", false)))
      {
        ...
        paramIntent2.putExtra("PhotoConst.MAXUM_SELECTED_NUM", Math.min(axln.b(paramQQAppInterface), j));
      }
      paramIntent2.putExtra("session_info", paramSessionInfo);
      ...
      if ((paramActivity instanceof SplashActivity))
      {
        ...
        paramIntent2 = aepi.a(paramIntent2, null);
        ...
        paramIntent2 = aepi.a(paramIntent2, null);
        paramIntent2.putExtra(bdez.h, 80);
        ...
        localztp = (ztp)paramQQAppInterface.a(51);
  ...
  public static void a(Intent paramIntent, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
    if (a(paramSessionInfo, paramQQAppInterface.a(paramSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      ...
      paramIntent.putExtra("binder_presendService", new BinderWarpper(new awka(paramSessionInfo.jdField_a_of_type_Int, paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.b, paramQQAppInterface.getAccount(), paramSessionInfo.jdField_e_of_type_Int).asBinder()));
    }
  }
  ...
  public static void a(AppInterface paramAppInterface, Activity paramActivity, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (!bdeu.a())
      {
        QQToast.a(paramActivity, paramActivity.getResources().getString(2131719547), 0).a();
        return;
      }
      paramAppInterface = alof.bk;
      boolean bool;
      label56:
      Object localObject;
      if (paramInt2 == 1)
  ...
  {
    bjcf.a(paramQQAppInterface, "tenpay.com", new aetx(paramInt1, paramSessionInfo, paramQQAppInterface, paramInt2, paramString, paramActivity));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, ajbs paramajbs, List<ajbs> paramList, int paramInt)
  {
    if (paramajbs == null) {
      return;
    }
    ...
    int i = 0;
    Object localObject2 = "";
    paramList = (aiul)paramQQAppInterface.getManager(125);
    if (paramList != null) {}
    label165:
    label1704:
    label1712:
    for (String str = paramList.a();; str = null)
    {
      ...
      {
        int k;
        if (RedPacketManager.TYPEHBINFOMAP.get(Integer.valueOf(paramajbs.jdField_a_of_type_Int)) == null) {
          k = 1;
        }
        Object localObject3;
        switch (paramajbs.jdField_a_of_type_Int)
        {
        case 8: 
        case 9: 
        case 10: 
        ...
        case 7: 
          for (;;)
          {
            ...
            try
            {
              ...
              ((JSONObject)localObject3).put("bus_type", paramajbs);
              if (j > 0) {
            ...
            catch (JSONException paramajbs)
            {
              for (;;)
              {
                long l;
                paramajbs.printStackTrace();
                continue;
                if (paramInt == 1)
                {
                  aggx.a(paramQQAppInterface, "0X8005FC9", paramSessionInfo.jdField_a_of_type_Int);
                  continue;
            ...
            aggx.a(paramQQAppInterface, "0X8005CAF", paramSessionInfo.jdField_a_of_type_Int);
            if (jdField_a_of_type_Int != 0) {
              break label1666;
            }
            paramActivity = paramList + ".plus";
            azqs.b(paramQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", paramActivity, 0, 0, (String)localObject1, "", "", "");
            return;
            if (paramSessionInfo.jdField_a_of_type_Int == 3000)
            {
              i = 2;
              paramList = "entrance.click.group";
              j = ((alrk)paramQQAppInterface.getManager(53)).a(paramSessionInfo.jdField_a_of_type_JavaLangString);
              break;
            }
            if (paramSessionInfo.jdField_a_of_type_Int == 1)
            {
              ...
              try
              {
                ...
                paramList = (amdu)paramQQAppInterface.a(20);
                if (jdField_a_of_type_Ameq == null) {
                  jdField_a_of_type_Ameq = new aetw(paramSessionInfo);
                }
                paramQQAppInterface.addObserver(jdField_a_of_type_Ameq);
                paramList.b(l, 32, 0);
              }
              ...
              {
                azqs.b(paramQQAppInterface, "CliOper", "", "", "0X8005B9C", "0X8005B9C", 0, 0, "", "", "", "");
                j = 6;
            ...
            for (paramList = paramQQAppInterface.a().l(paramSessionInfo.jdField_a_of_type_JavaLangString);; paramList = paramQQAppInterface.a().m(paramSessionInfo.jdField_a_of_type_JavaLangString))
            {
              ...
              paramList = bdfr.encodeToString(paramList, 2);
              azqs.b(paramQQAppInterface, "CliOper", "", "", "0X8005B9D", "0X8005B9D", 0, 0, "", "", "", "");
              localObject3 = "entrance.click.c2c";
              localObject2 = paramList;
              i = 7;
              j = 1;
              paramList = (List<ajbs>)localObject3;
              break;
            }
            k = ((Integer)RedPacketManager.TYPEHBINFOMAP.get(Integer.valueOf(paramajbs.jdField_a_of_type_Int))).intValue();
            break label165;
            localObject1 = "13140";
            paramajbs = String.valueOf(1);
            continue;
            localObject1 = "13141";
            paramajbs = String.valueOf(2);
            continue;
            localObject3 = "13142";
            paramajbs = (ajbs)localObject1;
            localObject1 = localObject3;
        ...
        case 5: 
          ...
          azqs.b(paramQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "plus.hongbao.click", 0, 0, "", "", "", "");
          return;
        case 3: 
          if (paramajbs.jdField_a_of_type_OrgJsonJSONObject != null) {}
          for (paramajbs = paramajbs.jdField_a_of_type_OrgJsonJSONObject.optString("theme_id", "");; paramajbs = "")
          {
            localIntent.putExtra("theme_type", paramajbs);
        ...
        case 4: 
          ...
          paramList = paramajbs.jdField_a_of_type_OrgJsonJSONObject.optString("url", "");
          paramQQAppInterface = paramList;
          if (paramajbs.jdField_a_of_type_OrgJsonJSONObject.optInt("subtype", 0) == 1) {
        ...
        case 12: 
          paramajbs = paramajbs.jdField_a_of_type_OrgJsonJSONObject.optString("schema");
          if (TextUtils.isEmpty(paramajbs)) {
            break;
          }
          a(paramQQAppInterface, paramActivity, paramSessionInfo, i, j, paramajbs);
          return;
        case 13: 
          paramajbs = paramajbs.jdField_a_of_type_OrgJsonJSONObject.optString("schema", "");
          if (TextUtils.isEmpty(paramajbs)) {
          ...
          paramQQAppInterface = bjcf.a(paramajbs, paramList, true);
          if (QLog.isColorLevel()) {
            QLog.i("PlusPanelUtils", 2, "[go to miniapp] finalSchame: " + paramQQAppInterface);
          }
          ajet.a(paramActivity, paramQQAppInterface);
          return;
        }
      }
    }
  ...
  {
    azqs.b(paramQQAppInterface, "CliOper", "", paramSessionInfo.jdField_a_of_type_JavaLangString, "Music_gene", "Music_gene_AIO", 0, 0, String.valueOf(a(paramSessionInfo.jdField_a_of_type_Int)), "", "", "");
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, ArrayList<String> paramArrayList, Intent paramIntent, HashMap<LocalMediaInfo, LocalMediaInfo> paramHashMap)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        return;
        paramQQAppInterface = aioz.a(paramHashMap);
  ...
  {
    new aetz(paramSessionInfo, paramQQAppInterface, paramContext, bdhj.b(paramContext, paramUri)).execute(new Void[0]);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, boolean paramBoolean, String paramString, BaseChatPie paramBaseChatPie)
  {
    ...
    if (((paramSessionInfo.jdField_a_of_type_Int == 1025) || (paramSessionInfo.jdField_a_of_type_Int == 0) || (paramSessionInfo.jdField_a_of_type_Int == 1000) || (paramSessionInfo.jdField_a_of_type_Int == 1004)) && (((bfyh)paramQQAppInterface.getManager(165)).d(paramSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      arrayOfInt[0] = 5;
      localmwz.b(2131698554);
    }
    for (int i = 1;; i = 0)
    {
      arrayOfInt[i] = 1;
      ...
      localmwz.a(new aetv(paramQQAppInterface));
      localmwz.a(new aety(localmwz, arrayOfInt, paramSessionInfo, paramQQAppInterface, paramBaseChatPie, paramContext, paramString));
      localmwz.show();
      azqs.b(paramQQAppInterface, "CliOper", "", "", "0X8004D68", "0X8004D68", 0, 0, "", "", "", "");
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, boolean paramBoolean, String paramString, Map<String, String> paramMap)
  {
    ...
    for (;;)
    {
      azqs.b(paramQQAppInterface, "CliOper", "", "", str2, str2, 0, 0, str1, "", "", "");
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, int paramInt1, int paramInt2)
  {
    ...
    if (AudioHelper.b(0))
    {
      bdgm.a(paramContext, 230, paramContext.getString(2131698770), paramContext.getString(2131698771), new aeua(), null).show();
      return;
    }
    if (AudioHelper.a(0))
    {
      bdgm.a(paramContext, 230, paramContext.getString(2131698770), paramContext.getString(2131698772), new aeub(), null).show();
      return;
    }
    if (paramQQAppInterface.getApp().checkPermission("android.permission.CAMERA", Process.myPid(), Process.myUid()) != 0)
    {
      bdgm.a(paramContext, 230, paramContext.getString(2131698770), alud.a(2131708700), new aeuc(), null).show();
      return;
    }
    ...
    for (int i = 1;; i = 17000)
    {
      ...
      aagb.a(paramQQAppInterface, Long.parseLong(paramSessionInfo.jdField_a_of_type_JavaLangString), "Usr_AIO_SendMsg", 2, 0, paramInt1);
      return;
    }
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo)
  {
    ...
    bivc.a(paramActivity, paramQQAppInterface.getAccount(), localIntent, -1, false);
    bivo.b(paramQQAppInterface, 3, paramSessionInfo.jdField_a_of_type_Int);
  }
  ...
  {
    Object localObject = (aufv)paramQQAppInterface.getManager(11);
    String str;
    if (paramSessionInfo.jdField_a_of_type_Int == 1006) {
      str = ((aufv)localObject).a(paramSessionInfo.jdField_a_of_type_JavaLangString);
    }
    for (localObject = paramSessionInfo.jdField_a_of_type_JavaLangString; paramString == null; localObject = ((aufv)localObject).b(str))
    {
  ...
  public static void c(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo)
  {
    ...
    paramQQAppInterface.putExtra(bdez.h, 84);
