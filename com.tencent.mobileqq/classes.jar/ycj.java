  ...
  extends BaseAdapter
{
  ...
  public ycj(Context paramContext)
  {
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_Yki = new yki();
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Int = (paramContext.getResources().getDisplayMetrics().heightPixels - zps.a(this.jdField_a_of_type_AndroidContentContext, 60.0F));
    a(true);
  }
  
  private VideoCollectionItem a(int paramInt)
  {
    yuk.c("Q.qqstory.home.BaseStoryTimeLineAdapter", "getSimpleFakeItem");
  ...
  {
    yuk.a("Q.qqstory.home.BaseStoryTimeLineAdapter", "bindview. postion=%d", Integer.valueOf(paramInt));
    paramViewGroup = (VideoCollectionItem)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
    ((yck)paramView.getTag()).a(paramViewGroup, paramView, paramInt);
  }
  ...
  protected void a(VideoCollectionItem paramVideoCollectionItem)
  {
    if (this.jdField_a_of_type_JavaUtilArrayList.indexOf(paramVideoCollectionItem) > 0) {
      yuk.b("Q.qqstory.home.BaseStoryTimeLineAdapter", "data already exist, id=%s, time=%d", paramVideoCollectionItem.collectionId, Long.valueOf(paramVideoCollectionItem.collectionTime));
    }
    do
    {
      return;
  ...
  public abstract void a(String paramString, List<ykj> paramList);
  
  public void a(List<VideoCollectionItem> paramList, boolean paramBoolean)
  {
    yuk.a("Q.qqstory.home.BaseStoryTimeLineAdapter", "setData, dataList size=%d", Integer.valueOf(paramList.size()));
    b();
    b(paramList, paramBoolean);
    notifyDataSetChanged();
  }
  
  public void a(ykl paramykl, ycn paramycn)
  {
    this.jdField_a_of_type_Ykl = paramykl;
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if ((a()) && (paramBoolean))
    {
      ...
      int j = zps.a(this.jdField_a_of_type_AndroidContentContext, 100.0F);
      int k = zps.a(this.jdField_a_of_type_AndroidContentContext, 65.0F);
      int m = zps.a(this.jdField_a_of_type_AndroidContentContext, 150.0F);
  ...
  protected void b(List<VideoCollectionItem> paramList, boolean paramBoolean)
  {
    ...
    do
    {
      return;
      a(false);
      j = this.jdField_a_of_type_Int - zps.a(this.jdField_a_of_type_AndroidContentContext, 100.0F);
      ...
      while (localIterator.hasNext())
      {
        ...
        if (paramList.size() <= 3)
        {
          if (localVideoCollectionItem.collectionType == 0) {
            i -= zps.a(this.jdField_a_of_type_AndroidContentContext, 65.0F);
          }
          for (;;)
          {
            break;
            if (!TextUtils.isEmpty(zof.a(localVideoCollectionItem.collectionTime)[0])) {
              i -= zps.a(this.jdField_a_of_type_AndroidContentContext, 190.0F);
            } else {
              i -= zps.a(this.jdField_a_of_type_AndroidContentContext, 150.0F);
            }
          }
        }
      }
  ...
  protected void d(List<VideoCollectionItem> paramList, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)
    {
      ...
      {
        yuk.d("Q.qqstory.home.BaseStoryTimeLineAdapter", "addData, has fake");
    ...
    yuk.a("Q.qqstory.home.BaseStoryTimeLineAdapter", "addData, new dataList=%s", paramList);
    ...
    if (localObject1 != null)
    {
      ...
      yuk.b("Q.qqstory.home.BaseStoryTimeLineAdapter", "add fake item.");
    }
    a(paramBoolean);
  }
