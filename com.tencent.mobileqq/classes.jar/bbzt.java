  ...
  implements bbzr
{
  ...
  public void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList, bbyn parambbyn)
  {
    ...
    {
      if (!bdbq.a(paramMessageHandler.app)) {
        break label1196;
      }
      m = 1;
      i4 = a(paramMsg);
      ...
      parambbyn = localPtt.bytes_file_md5.get().toByteArray();
    ...
    for (Object localObject4 = ((ByteStringMicro)localObject4).toStringUtf8();; localObject4 = "")
    {
      ...
      localObject1 = bgmj.a((byte[])localObject1);
      Object localObject5 = bgmj.a(parambbyn);
      if (localPtt.bytes_group_file_key.has()) {}
      for (parambbyn = localPtt.bytes_group_file_key.get().toByteArray();; parambbyn = null) {
        try
        {
          parambbyn = new String(parambbyn, "utf-8");
          if (localObject5 == null)
          {
            ...
            if (localPtt.bytes_pb_reserve.has())
            {
              ...
              if (parambbyn != null) {
                ((RichMsg.PttRec)localObject6).group_file_key.set(parambbyn);
              }
              ...
              ((RichMsg.PttRec)localObject6).voiceLength.set(bgjw.a(l1));
              ...
              parambbyn = bbzh.a(-2002);
              parambbyn.msgtype = -2002;
              parambbyn.msgData = ((RichMsg.PttRec)localObject6).toByteArray();
              ((MessageForPtt)parambbyn).parse();
              paramList.add(parambbyn);
              akxm.b((String)localObject1, parambbyn);
              if (parambbyn == null)
              {
                return;
                m = 0;
        ...
        catch (UnsupportedEncodingException parambbyn)
        {
          for (;;)
          {
            Object localObject6;
            ...
            for (;;)
            {
              ...
              if (((im_msg_body.Elem)localObject5).near_by_msg.has())
              {
                ...
                {
                  parambbyn.saveExtInfoToExtStr("identify_flag", "true");
                  if (QLog.isColorLevel()) {
              ...
              for (;;)
              {
                ...
                try
                {
                  ...
                  if (paramList.uint32_holiday_flag.has())
                  {
                    ...
                    if (j == 1) {
                      parambbyn.saveExtInfoToExtStr(bbyw.c, String.valueOf(j));
                    }
                    if (QLog.isColorLevel()) {
                ...
                try
                {
                  ...
                  ((MessageForPtt)parambbyn).waveformArray = bgog.a((ptt_waveform.PttWaveform)localObject1);
                  if (QLog.isColorLevel())
                  {
                    paramList = new StringBuilder();
                    localObject1 = ((MessageForPtt)parambbyn).waveformArray;
                    ...
                    for (;;)
                    {
                      if (j < k)
                      {
                        ...
                        if (((im_msg_body.Elem)localObject5).pub_group.has())
                        {
                          ...
                          parambbyn.saveExtInfoToExtStr("hotchat_gender", String.valueOf(j));
                          paramList = (List<MessageRecord>)localObject1;
                          if (localObject1 == null) {
                            paramList = "";
                          }
                          parambbyn.saveExtInfoToExtStr("hotchat_nick", paramList);
                          if (!QLog.isColorLevel()) {
                            break;
                          }
                        ...
                        if ((((im_msg_body.Elem)localObject5).general_flags.has()) && (((im_msg_body.GeneralFlags)((im_msg_body.Elem)localObject5).general_flags.get()).uint32_olympic_torch.has()))
                        {
                          ...
                          parambbyn.saveExtInfoToExtStr("olympic_torch_flg", j + "");
                          break;
                        }
                        ...
                        new bbzc().a((List)localObject4, paramMsg, (StringBuilder)localObject3);
                        break;
                      }
                    }
              ...
              if ((((MessageForPtt)parambbyn).waveformArray == null) || (((MessageForPtt)parambbyn).waveformArray.length == 0)) {
                ((MessageForPtt)parambbyn).buileDefaultWaveform();
              }
              label2037:
              i += 1;
            }
            ...
            bool = ((bftx)paramMessageHandler.app.getManager(203)).a(((msg_comm.MsgHead)paramMsg.msg_head.get()).from_uin.get());
            if ((parambbyn.mRobotFlag == 1) || (parambbyn.mRobotFlag == 2) || (bool))
            {
                  ...
                  if (paramList.attr_6_buf.has())
                  {
                    ...
                    for (paramList = paramList.toByteArray();; paramList = null)
                    {
                      ...
                      for (;;)
                      {
                        ...
                        i = (short)(i + 1);
                        if (parambbyn.atInfoList == null) {
                          parambbyn.atInfoList = new ArrayList();
                        }
                        parambbyn.atInfoList.add(localObject4);
                      }
                      break;
                    }
                  }
            ...
            aqjq.a(paramMsg, parambbyn, paramMessageHandler.app);
            if (QLog.isColorLevel())
            {
              QLog.d("GrpDisPTTDecoder", 2, ((StringBuilder)localObject3).toString());
              return;
