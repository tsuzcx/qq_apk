  ...
  implements azhn
{
  ...
  private azlc jdField_a_of_type_Azlc;
  @NotNull
  ...
  static
  {
    jdField_a_of_type_Azlx = new azlx(null);
  }
  
  public azlu(@NotNull QQAppInterface paramQQAppInterface, @NotNull Activity paramActivity, @NotNull azhl paramazhl, @NotNull azfn paramazfn)
  {
    ...
    paramQQAppInterface.findViewById(2131376935).setOnClickListener((View.OnClickListener)new azlv(this));
    this.jdField_b_of_type_AndroidViewView = paramQQAppInterface.findViewById(2131365063);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener((View.OnClickListener)azlw.a);
    ...
    this.jdField_c_of_type_Int = agej.a(296.0F, paramQQAppInterface.getResources());
    paramQQAppInterface = this.jdField_a_of_type_ComTencentQphoneBaseUtilBaseApplication;
    Intrinsics.checkExpressionValueIsNotNull(paramQQAppInterface, "appContext");
    int i = agej.a(211.0F, paramQQAppInterface.getResources());
    float f1 = 12;
    float f2 = bhlo.a();
    paramQQAppInterface = this.jdField_a_of_type_ComTencentQphoneBaseUtilBaseApplication;
    Intrinsics.checkExpressionValueIsNotNull(paramQQAppInterface, "appContext");
    paramQQAppInterface = bhgm.a(paramQQAppInterface.getResources(), 2130841455, this.jdField_c_of_type_Int, i);
    if (paramQQAppInterface != null)
    {
      paramQQAppInterface = bhmq.d(paramQQAppInterface, f1 * f2, this.jdField_c_of_type_Int, i);
    ...
    ayus.a((Function0)new ConstellationView.3(this));
  }
  ...
  private final void a(Activity paramActivity, Function0<Unit> paramFunction01, Function0<Unit> paramFunction02)
  {
    ...
    if (!bool)
    {
      awql.a(paramActivity, bhlq.a((Context)paramActivity, 230, paramActivity.getResources().getString(2131697702), paramActivity.getResources().getString(2131697699), 2131697700, 2131697701, (DialogInterface.OnClickListener)new azmb(paramFunction01), (DialogInterface.OnClickListener)new azmc(paramFunction02)));
      return;
    }
  ...
  private final boolean a()
  {
    ...
    return localbald.a(41609, localCard, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) != 2;
  }
  ...
  private final boolean a(String paramString, ImageView paramImageView)
  {
    ...
    while (i == 0)
    {
      ...
      paramString.setTag(bhez.b(localURLDrawableOptions.mRequestWidth, localURLDrawableOptions.mRequestHeight, (int)(12 * bhlo.a())));
      paramString.setDecodeHandler(bhez.g);
      if (paramImageView != null) {
  ...
  {
    Card localCard = bhhz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    ...
    this.jdField_a_of_type_JavaLangString = bhhu.c(this.jdField_a_of_type_Int);
    this.jdField_a_of_type_Azlc = ((azlc)new azma(this));
  }
  ...
  private final void c()
  {
    ...
    localazhm.a = ((BaseActivity)localActivity);
    this.jdField_a_of_type_Azhl.a(localazhm, (azhn)this);
  }
  ...
  private final void f()
  {
    ...
    if (this.jdField_a_of_type_Int != 0)
    {
      ...
      localObject2 = ((Resources)localObject1).getString(2131697706);
      Intrinsics.checkExpressionValueIsNotNull(localObject2, "res.getString(R.string.q…nstellation_select_part1)");
      localObject1 = ((Resources)localObject1).getString(2131697707);
      ...
      if (localObject2 != null)
      {
        ...
        ((TextView)localObject2).setOnClickListener((View.OnClickListener)new azly(this, (String)localObject1));
        ((TextView)localObject2).setOnTouchListener((View.OnTouchListener)new mve());
        if (!blqj.a()) {
          break label193;
        }
    ...
    for (;;)
    {
      ...
      break;
      label160:
      localObject2 = ((Resources)localObject1).getString(2131697704);
      Intrinsics.checkExpressionValueIsNotNull(localObject2, "res.getString(R.string.q…select_no_birthday_part1)");
      localObject1 = ((Resources)localObject1).getString(2131697705);
  ...
  public final View a()
  {
    View localView = View.inflate((Context)BaseApplication.context, 2131561594, null);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131364979));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131364980));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131377288));
    this.e = ((TextView)localView.findViewById(2131377270));
    this.f = ((TextView)localView.findViewById(2131377265));
    this.g = ((TextView)localView.findViewById(2131364976));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131364977));
    ...
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131370582));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131378163));
  ...
  public final void a()
  {
    a(azla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), this.jdField_a_of_type_AndroidWidgetImageView);
    boolean bool1;
    boolean bool2;
    if (this.jdField_a_of_type_Int != 0)
    {
      ...
      bool2 = a(azla.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), this.jdField_b_of_type_AndroidWidgetImageView);
      label45:
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject2 = azla.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (QLog.isColorLevel()) {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          continue;
          ((Button)localObject1).setText(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getText(2131694386));
      ...
      if (localObject2 != null)
      {
        ((TextView)localObject2).setText((CharSequence)azla.a());
        ((TextView)localObject2).setTextColor(((Ref.IntRef)localObject1).element);
      }
      localObject1 = this.jdField_a_of_type_AndroidWidgetButton;
      if (localObject1 != null)
      {
        ((Button)localObject1).setOnClickListener((View.OnClickListener)new azlz(this, bool1));
        if (!bool1) {
          break label534;
        }
        if (!azla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
          break label509;
        }
        ((Button)localObject1).setText(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getText(2131692858));
        ((Button)localObject1).setEnabled(false);
      }
      f();
      return;
  ...
  {
    int i = azky.jdField_a_of_type_Int;
    if (paramInteger1 == null) {}
    while ((paramInteger1.intValue() != i) || (paramIntent == null)) {
      return;
    }
    paramInteger1 = azmd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramIntent, this.jdField_a_of_type_JavaLangString);
  ...
  protected void d()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.unRegistObserver((BusinessObserver)this.jdField_a_of_type_Azlc);
  }
  
  public void onBackPressed()
  {
    super.onBackPressed();
    this.jdField_a_of_type_Azfn.a(1040);
  }
  ...
  public void show()
  {
    ...
    if (ThemeUtil.isNowThemeIsNight(null, false, ""))
    {
      localView = this.jdField_b_of_type_AndroidViewView;
      if (localView != null) {
        localView.setBackgroundResource(2130846154);
      }
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.registObserver((BusinessObserver)this.jdField_a_of_type_Azlc);
      azia.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
      try
      {
        ...
        localView = this.jdField_b_of_type_AndroidViewView;
        if (localView != null) {
          localView.setBackgroundResource(2130846153);
        }
        c();
        localView = this.jdField_c_of_type_AndroidViewView;
        if (localView == null) {
