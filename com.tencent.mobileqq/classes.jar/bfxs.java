  ...
  implements IMediaPlayer
{
  ...
  private bfyc jdField_a_of_type_Bfyc = new bfxt(this);
  ...
  private void e()
  {
    wxe.b("DefaultMediaPlayer", "onVideoPlayEnded");
  ...
  private void f()
  {
    wxe.b("DefaultMediaPlayer", "onVideoPlayRepeated");
  ...
  {
    boolean bool2 = true;
    bfxu.a(hashCode(), "[Player] handle play cmd from qg");
    wxe.a("DefaultMediaPlayer", "handleStartPlay , src = %s", this.jdField_a_of_type_JavaLangString);
    ...
    this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder = new MediaDecoder(this.jdField_a_of_type_JavaLangString, this.jdField_d_of_type_Int, this.jdField_a_of_type_Bfyc, false, hashCode());
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      this.jdField_d_of_type_Boolean = false;
      this.g = 0;
      bfxu.a(hashCode(), "[Player] handle play cmd from qg finish");
      return;
      bool1 = false;
      break;
    }
  ...
  private void h()
  {
    wxe.a("DefaultMediaPlayer", "handleResumePlay , src = %s", this.jdField_a_of_type_JavaLangString);
  ...
  private void i()
  {
    ...
    if (this.g == 1)
    {
      ...
      bfxu.a(hashCode(), "[Player] render first frame to qg");
    }
  }
  
  public void a()
  {
    wxe.b("DefaultMediaPlayer", "onResume");
    if (this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder != null) {
      this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder.d();
    }
  }
  ...
  public void b()
  {
    wxe.b("DefaultMediaPlayer", "onPause");
    if (this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder != null) {
  ...
  public void c()
  {
    wxe.b("DefaultMediaPlayer", "onStop");
    if (this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder != null) {
      this.jdField_a_of_type_ComTencentQgVideoVideodecoderMediaDecoder.b();
    }
  }
  ...
  {
    wxe.b("DefaultMediaPlayer", "qg -> create");
  ...
  public void destroy()
  {
    wxe.b("DefaultMediaPlayer", "qg -> destroy");
    c();
    if (this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer != null) {
  ...
  {
    return (int)upd.a(this.jdField_a_of_type_JavaLangString);
  }
  ...
  public void pause()
  {
    wxe.b("DefaultMediaPlayer", "qg -> pause");
    b();
  }
  
  public void play(int paramInt1, int paramInt2, int paramInt3)
  {
    wxe.a("DefaultMediaPlayer", "qg -> play , texture id = %d , width = %d , height = %d", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3));
    bfxu.a(hashCode(), "[Player] receive play cmd from qg");
  ...
  public void setSrc(String paramString)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      wxe.a("DefaultMediaPlayer", "qg -> set Src , src = %s , isSrcChanged :%s", str, Boolean.valueOf(this.jdField_c_of_type_Boolean));
      return;
    }
  }
  ...
  {
    wxe.b("DefaultMediaPlayer", "qg -> setVolume , not support yet");
  }
  
  public void stop()
  {
    wxe.b("DefaultMediaPlayer", "qg -> stop");
    c();
  }
}
