  ...
  implements BusinessObserver
{
  ...
  public bfxs(TroopMoreDetailView paramTroopMoreDetailView)
  {
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      localStringBuffer = new StringBuffer(localTroopMoreDetailView.getResources().getString(2131718820));
    } while ((localView == null) || (((List)localObject2).size() < 4));
    localView.setVisibility(0);
    if (localTroopMoreDetailView.a[4] != null) {
      localTroopMoreDetailView.a[4].setBackgroundResource(2130839439);
    }
    localStringBuffer.append(",本群共").append(j).append("人");
    paramBundle = localView.findViewById(2131379293);
    ...
    if (i < ((List)localObject2).size())
    {
      ...
      case 0: 
        ...
        localRoundProgressBar = (RoundProgressBar)paramBundle.findViewById(2131376826);
        localRoundProgressBar.setTextColor(localContext.getResources().getColor(2131166989));
        if (!paramBoolean) {
          break;
        }
      }
    ...
    for (Object localObject1 = "#FF1F1F1F";; localObject1 = "#FFDDDDDD")
    {
      ...
      localRoundProgressBar.setRoundWidth(afur.a(2.0F, localTroopMoreDetailView.getResources()));
      ...
      localObject1 = (TextView)paramBundle.findViewById(2131378776);
      ...
      i += 1;
      break;
      localObject1 = localView.findViewById(2131379293);
      if (paramBoolean)
      {
        ...
        break label300;
        localObject1 = localView.findViewById(2131379294);
        if (!paramBoolean) {
          break label605;
        }
        ...
        paramBundle = (Bundle)localObject1;
        break label300;
        localObject1 = localView.findViewById(2131379295);
        if (!paramBoolean) {
          break label611;
        }
        ...
        paramBundle = (Bundle)localObject1;
        break label300;
        localObject1 = localView.findViewById(2131379296);
        if (!paramBoolean) {
          break label618;
        }
      }
