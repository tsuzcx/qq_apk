...
public class bhvk
{
  public void a(boolean paramBoolean, String paramString1, String paramString2, List<bhrj> paramList, long paramLong, bhvf parambhvf, String paramString3, Activity paramActivity, biej parambiej, Bundle paramBundle)
  {
    ...
    if ((localAppRuntime == null) || (paramBundle == null) || (parambiej == null))
    {
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        paramList = (bhrj)paramString1.next();
    ...
    if (Build.VERSION.RELEASE == null)
    {
      ...
      paramBundle.qqv.set(bhpc.a().d());
      paramBundle.app_type.set(1);
      paramBundle.pf.set(bhwf.a((Bundle)localObject, "pf", "openmobile_android"));
      paramBundle.sdkp.set(bhwf.a((Bundle)localObject, "sdkp", "android"));
      paramBundle.sdkv.set(bhwf.a((Bundle)localObject, "sdkv", "1.5.9"));
    ...
    for (paramString1 = paramString1.toString();; paramString1 = "")
    {
      ...
      break;
      paramList = bifi.a(paramActivity, paramString3);
    ...
    paramBundle.skey.set(parambiej.b);
    if (paramBoolean) {
    ...
    for (;;)
    {
      ...
      paramActivity = new NewIntent(BaseApplicationImpl.getApplication(), bhwt.class);
      paramActivity.setWithouLogin(true);
      paramActivity.putExtra("uin", parambiej.a);
      localObject = bhwf.a(localAppRuntime, parambiej, paramBundle.login_sig, "QQConnectLogin.auth", "QQConnectLogin.auth_emp");
      paramBoolean = "QQConnectLogin.auth_emp".equals(localObject);
      paramList = paramBundle.toByteArray();
      paramString1 = paramList;
      if (paramBoolean) {
        paramString1 = bifi.a(paramList, parambiej);
      }
      paramActivity.putExtra("data", paramString1);
      paramActivity.putExtra("cmd", (String)localObject);
      paramLong = System.currentTimeMillis();
      QLog.d("SDK_LOGIN.ProxyAuthManager", 1, new Object[] { "cmd=" + (String)localObject, ", uin=*" + bhwf.a(parambiej.a), ", reqState=", paramString3 });
      paramActivity.setObserver(new bhvl(this, paramLong, parambiej, (String)localObject, parambhvf, paramBoolean, paramString3, paramString2));
