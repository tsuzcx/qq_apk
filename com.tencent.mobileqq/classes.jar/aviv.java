...
{
  public aviv(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   244: aload_2
    //   245: iconst_1
    //   246: invokevirtual 129	aviv:notifyUI	(IZLjava/lang/Object;Z)V
    //   249: return
    //   250: aconst_null
    //   251: astore_2
    //   252: goto -132 -> 120
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          if (localRspBody.msg_guidelines813.has())
          {
            ...
            if (paramFromServiceMsg != null)
            {
              ...
              if (paramFromServiceMsg != null)
              {
                ...
                localavjd.jdField_a_of_type_JavaLangString = paramObject;
                if ((!paramFromServiceMsg.uint32_groups_recomm_flag.has()) || (paramFromServiceMsg.uint32_groups_recomm_flag.get() != 1)) {
                  continue;
                }
                localavjd.jdField_a_of_type_Int = 1;
              }
            }
            if (QLog.isColorLevel()) {
              QLog.d("LoginWelcomeManager", 2, String.format("813 guide :type %s, url %s", new Object[] { Integer.valueOf(localavjd.jdField_a_of_type_Int), localavjd.jdField_a_of_type_JavaLangString }));
            }
            paramToServiceMsg[1] = localavjd;
          ...
          localavjd.jdField_a_of_type_Int = 2;
          continue;
          paramFromServiceMsg = paramToServiceMsg;
        }
