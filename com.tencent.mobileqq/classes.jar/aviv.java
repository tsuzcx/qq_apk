...
public class aviv
{
  private static Map<String, aviv> jdField_a_of_type_JavaUtilMap = new HashMap();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private final Context jdField_a_of_type_AndroidContentContext;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new aviw(this);
  ...
  private final List<avix> jdField_a_of_type_JavaUtilList = new LinkedList();
  ...
  private aviv(Context paramContext, InstalledPlugin paramInstalledPlugin)
  {
  ...
  private Intent a()
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      localIntent.putExtra("qqVersion", "8.4.1");
      return localIntent;
    }
  }
  
  public static aviv a(Context paramContext, InstalledPlugin paramInstalledPlugin)
  {
    try
    {
      aviv localaviv2 = (aviv)jdField_a_of_type_JavaUtilMap.get(paramInstalledPlugin.pluginFile.getName());
      aviv localaviv1 = localaviv2;
      if (localaviv2 == null)
      {
        localaviv1 = new aviv(paramContext, paramInstalledPlugin);
        jdField_a_of_type_JavaUtilMap.put(paramInstalledPlugin.pluginFile.getName(), localaviv1);
      }
      return localaviv1;
    }
    finally {}
  ...
  private RunningPlugin a()
  {
    ...
    a("HuayangPluginLauncher", anni.a(2131704427));
    try
    {
      ...
      {
        a("HuayangPluginLauncher", anni.a(2131704437) + (System.currentTimeMillis() - l));
    ...
    catch (Exception localException2)
    {
      ...
      a(80);
      a("HuayangPluginLauncher", anni.a(2131704441) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + anni.a(2131704436) + (System.currentTimeMillis() - l));
    }
  ...
  private void a(int paramInt)
  {
    ...
    a("HuayangPluginLauncher", anni.a(2131704435) + paramInt);
  ...
  private void a(RunningPlugin paramRunningPlugin)
  {
    ...
    long l = System.currentTimeMillis();
    a("HuayangPluginLauncher", anni.a(2131704425) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile);
    ...
    for (;;)
    {
      try
      {
        ...
        a(true, null);
        if (!avip.a(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_c_of_type_JavaLangString)) {
          continue;
        }
        avjb.a("2691707");
      ...
      a("HuayangPluginLauncher", anni.a(2131704440) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + anni.a(2131704433) + (System.currentTimeMillis() - l));
      return;
      if (avip.b(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_c_of_type_JavaLangString)) {
        avjb.a("2597725");
      }
    }
  }
  ...
  {
    long l = System.currentTimeMillis();
    a("HuayangPluginLauncher", anni.a(2131704431) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile);
    Intent localIntent = a();
    try
    {
      paramRunningPlugin.startInitActivity(localIntent).get();
      a("HuayangPluginLauncher", anni.a(2131704429) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + anni.a(2131704426) + (System.currentTimeMillis() - l));
      return;
    }
    catch (Throwable paramRunningPlugin)
    {
      for (;;)
      {
        ...
        avik.a(paramRunningPlugin);
      }
    }
  }
  
  public void a(avix paramavix)
  {
    if (paramavix != null) {
      this.jdField_a_of_type_JavaUtilList.add(paramavix);
    }
  }
  ...
  public void b(avix paramavix)
  {
    if (paramavix != null) {
      this.jdField_a_of_type_JavaUtilList.remove(paramavix);
    }
  }
}
