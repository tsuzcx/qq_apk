  ...
  implements axay
{
  ...
  private boolean a(axbv paramaxbv, String paramString)
  {
    if (paramaxbv == null) {}
    while (paramaxbv.a(paramString) == -1) {
      return false;
    }
    return true;
  }
  ...
  public ReqItem a(int paramInt)
  {
    ...
    if ((j - i > paramInt) || (j < i))
    {
      ...
      ((PreloadInfoCheckUpdate.ControlReqHead)localObject3).client_ver.set("8.3.0");
      ...
      ((PreloadInfoCheckUpdate.ControlReqHead)localObject3).mem.set((int)bbdh.d() / 1048576);
      ...
      Object localObject4 = bbkc.a((SharedPreferences)localObject1, "key_web_plugin_list" + this.a.getCurrentAccountUin(), null);
      if ((localObject4 != null) && (!((Set)localObject4).isEmpty()))
      {
        localObject3 = (axbv)this.a.getManager(12);
      ...
      System.arraycopy(baxp.b(i), 0, localObject2, 0, 4);
    ...
    if (paramRespItem != null)
    {
      ...
      if (i == 2) {
        try
        {
          ...
          {
            i = (int)bbmx.a((byte[])localObject1, 0);
            paramRespItem = new byte[i - 4];
            bbmx.a(paramRespItem, 0, (byte[])localObject1, 4, i - 4);
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        do
        {
          ...
          bbkc.a(paramRespItem, "key_web_plugin_list" + this.a.getCurrentAccountUin(), (Object[])localObject2);
