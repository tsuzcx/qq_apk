  ...
  implements bkpt
{
  ...
  private bkpx a(Bitmap paramBitmap, ArrayList<bkpu> paramArrayList)
  {
    bkpx localbkpx = new bkpx(this);
    ...
    {
      paramBitmap = (bkpu)paramArrayList.get(i);
      int j = paramBitmap.jdField_b_of_type_Int;
      double d2 = paramBitmap.jdField_a_of_type_Int * j;
      double d3 = localbkpx.jdField_a_of_type_Double;
      localbkpx.jdField_a_of_type_Double = (d2 / d1 + d3);
      if (localbkpx.jdField_a_of_type_Double > jdField_a_of_type_JavaLangDouble.doubleValue()) {
        localbkpx.jdField_a_of_type_Boolean = true;
      }
      i += 1;
    }
    if ((paramArrayList.size() > 1) && (localbkpx.jdField_a_of_type_Double > b.doubleValue())) {
      localbkpx.b = true;
    }
    return localbkpx;
  }
  
  private bkpz a(String paramString)
  {
    bkpz localbkpz = new bkpz();
    if (paramString == null) {}
    do
    {
      return null;
    ...
    while (i < localJSONArray1.length())
    {
      ...
      if (j < localJSONArray2.length())
      {
        ...
        {
          localbkpz.jdField_a_of_type_Int = localJSONObject1.optInt("sceneLvOne");
          localbkpz.jdField_b_of_type_Int = localJSONObject2.optInt("sceneLvTwo");
          localbkpz.jdField_a_of_type_JavaLangString = localJSONObject2.optString("sceneName");
          localbkpz.jdField_b_of_type_JavaLangString = localJSONObject2.optString("sceneFilterID");
          localbkpz.jdField_a_of_type_Double = localJSONObject2.optDouble("sceneFilterPercent");
        }
      }
      else
      {
  ...
  private bkpz a(JSONArray paramJSONArray)
  {
    double d2 = -1.0D;
    Object localObject1 = new bkpz();
    ...
    if (paramJSONArray.length() > 0)
    {
      ...
      if (i < paramJSONArray.length())
      {
        ...
        bkpz localbkpz = a((String)localObject3);
        double d6;
        double d5;
        if (localbkpz == null)
        {
        ...
        for (;;)
        {
          ...
          d5 = d2;
          d6 = d3;
          if (localbkpz.jdField_b_of_type_Int != -1)
          {
            localObject3 = localObject1;
            double d1 = d2;
            if (localbkpz.jdField_a_of_type_Int == 3)
            {
              localObject3 = localObject1;
              d1 = d2;
              if (d4 > c.doubleValue())
  ...
  private String a(Bitmap paramBitmap, int paramInt)
  {
    ...
    if (i > paramInt)
    {
      paramBitmap = avxz.a(paramBitmap, i / paramInt);
      localByteArrayOutputStream = new ByteArrayOutputStream();
      paramBitmap.compress(Bitmap.CompressFormat.JPEG, 100, localByteArrayOutputStream);
      return bkpr.a(localByteArrayOutputStream.toByteArray());
    }
  ...
  private JSONObject a()
  {
    ...
    try
    {
      JSONObject localJSONObject2 = new JSONObject(bdcs.d("video_story_aiSceneParams.json"));
  ...
  private JSONObject a(String paramString)
  {
    ...
    try
    {
      ...
      paramString = bkps.a("https://tu.qq.com/cgi-bin/qq/get_face_detail.fcg", localJSONObject2.toString());
      return paramString;
    }
  ...
  private JSONObject b(String paramString)
  {
    ...
    try
    {
      ...
      localJSONObject2.put("token", b(paramString));
      paramString = bkps.a("https://tu.qq.com/cgi-bin/qq/do_image_classify.fcg", localJSONObject2.toString());
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  public void a(Bitmap paramBitmap, ArrayList<bkpu> paramArrayList, bkpv parambkpv)
  {
    if (paramBitmap == null)
    {
      parambkpv.a("image is null");
      return;
    }
    ...
    if (paramArrayList.jdField_a_of_type_Boolean) {
      if (paramArrayList.b) {
        paramBitmap = a(alpo.a(2131716210));
      }
    }
    while (paramBitmap == null)
    {
      parambkpv.a("unknown error");
      bkps.a(System.currentTimeMillis() - l, 1);
      return;
      paramBitmap = a(paramBitmap);
      if ((paramBitmap == null) || (paramBitmap.isNull("retcode")))
      {
        parambkpv.a("network error");
        bkps.a(System.currentTimeMillis() - l, 1);
        return;
      }
      if ((paramBitmap != null) && (paramBitmap.has("retcode")) && (paramBitmap.optInt("retcode") == 0))
      {
        ...
        if (i <= 5) {
          paramBitmap = a(alpo.a(2131716213));
        } else if (j < 50) {
          paramBitmap = a(alpo.a(2131716211));
        } else {
          paramBitmap = a(alpo.a(2131716208));
        }
      }
      else
      {
        paramBitmap = a(alpo.a(2131716212));
        continue;
        ...
        if ((paramArrayList == null) || (paramArrayList.isNull("retcode")))
        {
          ...
          bkps.a(l, 1);
          yvu.a("record_smart_filter", yvu.a(1L, l));
          return;
        }
        paramBitmap = localbkpz;
    ...
    parambkpv.a(paramBitmap);
    l = System.currentTimeMillis() - l;
    bkps.a(l, 0);
    yvu.a("record_smart_filter", yvu.a(0L, l));
  }
}
