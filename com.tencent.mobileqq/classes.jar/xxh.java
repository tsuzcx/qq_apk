  ...
  implements anoi
{
  ...
  {
    paramString = new xxj(this, paramString);
    ...
    this.jdField_a_of_type_Ymk.c(localBundle);
  }
  ...
  private void a(String paramString, String[] paramArrayOfString)
  {
            ...
            do
            {
              do
              {
                do
                {
                  do
                  {
                    do
                    {
                      do
                      {
                        ...
                        {
                          return;
                          paramString = new xxj(this, paramArrayOfString[0]);
                          QLog.d(this.TAG, 2, paramString.toString());
                          if ((this.mRuntime != null) && ((this.mRuntime.a() instanceof SubscribeHybirdFragment)))
                          {
                            ((SubscribeHybirdFragment)this.mRuntime.a()).a(xxk.a(paramString.getString("feedid"), paramString.getString("uin"), paramString.getInt("type"), paramString.getInt("width"), paramString.getInt("height"), Long.valueOf(paramString.getString("createtime")).longValue()));
                            return;
                          }
                        } while ((this.mRuntime == null) || (this.mRuntime.a() == null));
                        xxk.a(null, xxk.a(paramString.getString("feedid"), paramString.getString("uin"), paramString.getInt("type"), paramString.getInt("width"), paramString.getInt("height"), Long.valueOf(paramString.getString("createtime")).longValue()));
                        return;
                  ...
                  ((SubscribeHybirdFragment)this.mRuntime.a()).ai_();
                  return;
                  if (!"openpublishpage".equals(paramString)) {
                    break;
                  }
                } while ((!a(paramArrayOfString)) || (this.mRuntime == null) || (this.mRuntime.a() == null));
                paramString = new xxj(this, paramArrayOfString[0]).optString("puin");
                new Intent().putExtra("postUin", paramString);
                bizm.a(this.mRuntime.a().getActivity(), null, 0);
                return;
    ...
    xxk.a(null, new xxj(this, paramArrayOfString[0]).optString("uid"));
  }
  ...
  {
    paramString = new xxj(this, paramString).getJSONArray("goods");
    if (paramString != null)
    {
  ...
  private void c(String paramString)
  {
    ...
    Object localObject = new xxj(this, paramString);
    paramString = ((xxj)localObject).optString("uin");
    String str = ((xxj)localObject).optString("nick");
    localObject = ((xxj)localObject).optString("callback");
    yht.a(this.mRuntime.a().getActivity(), paramString, str, new xxi(this, (String)localObject, str));
  }
  ...
  private void d(String paramString)
  {
    ...
    if ("1".equals(paramString.getString("avatarType")))
    {
      ...
      this.jdField_a_of_type_Anoe = new anoe(this.mRuntime.a(), i);
      this.jdField_a_of_type_Anoe.a();
      this.jdField_a_of_type_Anoe.a(this);
    }
    for (;;)
    {
      ...
      break;
      label130:
      this.jdField_a_of_type_Anoe.a(i);
    }
  }
