...
class ampd
  implements bgzj
{
  ampd(ampb paramampb, List paramList, String paramString1, String paramString2, int paramInt) {}
  ...
  public boolean a(String paramString, ApolloBaseInfo paramApolloBaseInfo)
  {
    ...
    {
      int i = amhd.a(ApolloUtil.a(), this.jdField_a_of_type_JavaLangString, true);
      int j = amhd.a(ApolloUtil.a(), this.b, true);
