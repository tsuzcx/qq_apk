...
public class bade
{
  ...
  public static bade a(bade parambade)
  {
    if (parambade == null)
    {
    ...
    localbade.jdField_a_of_type_JavaLangString = parambade.jdField_a_of_type_JavaLangString;
    localbade.jdField_a_of_type_Int = parambade.jdField_a_of_type_Int;
    localbade.jdField_b_of_type_JavaLangString = parambade.jdField_b_of_type_JavaLangString;
    localbade.jdField_c_of_type_JavaLangString = parambade.jdField_c_of_type_JavaLangString;
    ArrayList localArrayList = new ArrayList();
    if (parambade.jdField_a_of_type_JavaUtilArrayList != null) {
      localArrayList.addAll(parambade.jdField_a_of_type_JavaUtilArrayList);
    }
    localbade.jdField_a_of_type_JavaUtilArrayList = localArrayList;
    localArrayList = new ArrayList();
    if (parambade.jdField_b_of_type_JavaUtilArrayList != null) {
      localArrayList.addAll(parambade.jdField_b_of_type_JavaUtilArrayList);
    }
    localbade.jdField_b_of_type_JavaUtilArrayList = localArrayList;
    localArrayList = new ArrayList();
    if (parambade.jdField_c_of_type_JavaUtilArrayList != null) {
      localArrayList.addAll(parambade.jdField_c_of_type_JavaUtilArrayList);
    }
    localbade.jdField_c_of_type_JavaUtilArrayList = localArrayList;
    localbade.jdField_a_of_type_JavaLangObject = parambade.jdField_a_of_type_JavaLangObject;
    localbade.jdField_b_of_type_Int = parambade.jdField_b_of_type_Int;
    localbade.jdField_a_of_type_Boolean = parambade.jdField_a_of_type_Boolean;
    localbade.jdField_b_of_type_Boolean = parambade.jdField_b_of_type_Boolean;
    localbade.jdField_c_of_type_Boolean = parambade.jdField_c_of_type_Boolean;
    localbade.d = parambade.d;
    return localbade;
  }
