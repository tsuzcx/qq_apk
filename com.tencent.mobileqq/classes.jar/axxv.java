  ...
  extends axxs
{
  ...
  public void a(axtc paramaxtc, axtb paramaxtb)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramaxtb = new cmd0x346.RspBody();
        paramaxtb.mergeFrom((byte[])localObject1);
        localObject3 = (cmd0x346.ApplyDownloadRsp)paramaxtb.msg_apply_download_rsp.get();
        paramaxtc = (axyy)localaxyv.jdField_a_of_type_JavaUtilList.get(0);
        if (paramaxtc != null) {
          paramaxtc.d = ((Boolean)((FromServiceMsg)localObject2).getAttribute("_attr_send_by_quickHttp", Boolean.valueOf(false))).booleanValue();
        }
        if (QLog.isColorLevel()) {
          QLog.e("http_sideway", 2, "C2CPttDownHandler.onProtoResp:isSendByQuickHttp=" + paramaxtc.d);
        }
        i = ((cmd0x346.ApplyDownloadRsp)localObject3).int32_ret_code.get();
        paramaxtb = (cmd0x346.ExtensionRsp)paramaxtb.msg_extension_rsp.get();
        if (i != 0) {
          break label637;
        }
        ...
        {
          paramaxtc.jdField_a_of_type_JavaLangString = ((cmd0x346.DownloadInfo)localObject2).str_download_url.get();
          ...
          while (((Iterator)localObject2).hasNext())
          {
            ...
            localaxuh = new axuh();
            localaxuh.jdField_a_of_type_JavaLangString = ((String)localObject3);
            paramaxtc.jdField_a_of_type_JavaUtilArrayList.add(localaxuh);
          }
        }
      }
      ...
      label477:
      if ((paramaxtb != null) && (paramaxtb.server_addr_ipv6_list.has()))
      {
        paramaxtb = (cmd0x346.AddrList)paramaxtb.server_addr_ipv6_list.get();
        if (paramaxtb != null)
        {
          localObject2 = paramaxtb.rpt_str_ip.get();
          i = paramaxtb.uint32_port.get();
          if ((localObject2 != null) && (((List)localObject2).size() > 0))
          {
            localObject2 = ((List)localObject2).iterator();
            while (((Iterator)localObject2).hasNext())
            {
              ...
              localaxuh = new axuh();
              localaxuh.jdField_a_of_type_JavaLangString = ((String)localObject3);
              localaxuh.jdField_a_of_type_Int = i;
              localaxuh.jdField_a_of_type_Boolean = true;
              paramaxtc.jdField_b_of_type_JavaUtilArrayList.add(localaxuh);
            }
          }
          paramaxtc.jdField_b_of_type_JavaLangString = paramaxtb.rpt_str_domain.get();
        }
      }
      a(0, 0, "", "", localajmn, paramaxtc);
      continue;
      label637:
      if ((paramaxtb != null) && (paramaxtb.uint32_allow_retry.get() == 1))
      {
        if (QLog.isColorLevel()) {
  ...
  public void a(axyg paramaxyg)
  {
    if ((paramaxyg != null) && (paramaxyg.jdField_a_of_type_JavaUtilList != null) && (paramaxyg.jdField_a_of_type_ComTencentMobileqqTransfileProtoReqManager != null))
    {
      ...
      localaxtb.jdField_a_of_type_JavaLangString = "PttCenterSvr.pb_pttCenter_CMD_REQ_APPLY_DOWNLOAD-1200";
      if (this.jdField_a_of_type_Int == 3) {
        localaxtb.jdField_a_of_type_JavaLangString = "OfflineFilleHandleSvr.pb_ftnPtt_CMD_REQ_APPLY_DOWNLOAD-1200";
      }
  ...
  byte[] a(List<axyr> paramList)
  {
    ...
    if (paramList.size() == 1)
    {
      paramList = (axyi)paramList.get(0);
      Object localObject;
  ...
  void b(axyg paramaxyg)
  {
    ...
    {
      axyy localaxyy = new axyy();
      localaxyv.jdField_a_of_type_JavaUtilList.add(i, localaxyy);
      i += 1;
    }
  }
}
