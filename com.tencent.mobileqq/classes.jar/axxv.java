  ...
  extends axuq
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      localLinearLayout.setId(2131369886);
      localBubbleViewLayout = new BubbleViewLayout(paramContext);
      localBubbleViewLayout.setId(2131369885);
      ...
      ((RelativeLayout)localObject3).setId(2131369879);
      ...
      localObject2 = (axup)((Iterator)localObject4).next();
      localObject5 = ((axup)localObject2).a;
      if (!"title".equals(localObject5)) {
        break label685;
      }
      localObject2 = (TextView)((axup)localObject2).a(paramContext, null, paramBundle);
    ...
    for (;;)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject5).addRule(3, 2131369879);
      ...
      break;
      label439:
      localBubbleViewLayout.setLayoutParams(new LinearLayout.LayoutParams(BaseChatItemLayout.d - actj.a(20.0F, localResources), -2));
      break label101;
      label467:
      ((RelativeLayout)localObject3).setBackgroundResource(2130843939);
      break label203;
      label477:
      if (bool)
      {
        ...
        ((RelativeLayout.LayoutParams)localObject4).addRule(0, 2131369879);
        paramView.setLayoutParams((ViewGroup.LayoutParams)localObject4);
        paramView.setId(2131372877);
        ...
        paramView.setImageDrawable(localResources.getDrawable(2130843934));
      }
      for (;;)
      {
        label536:
        ...
        ((RelativeLayout.LayoutParams)localObject4).addRule(1, 2131369879);
        break label536;
        label652:
        ((RelativeLayout)localObject3).setBackgroundResource(2130843932);
    ...
    for (;;)
    {
      try
      {
        long l = Long.parseLong(((axzj)localObject2).Y);
        localObject2 = Calendar.getInstance();
        ((Calendar)localObject2).setTimeInMillis(l * 1000L);
        localObject5 = new TextView(paramContext);
        ((TextView)localObject5).setId(2131377264);
        RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(actj.a(68.0F, localResources), actj.a(18.0F, localResources));
        localLayoutParams.addRule(14);
        if (!this.jdField_a_of_type_Boolean) {
          break label1317;
        }
        f = 51.0F;
        localLayoutParams.topMargin = actj.a(f, localResources);
      ...
      if (("head".equals(localObject5)) && ((localException instanceof axwl)))
      {
        paramBundle.putInt("bundle_args_avatar_width", actj.a(52.0F, localResources));
        paramBundle.putInt("bundle_args_avatar_height", actj.a(52.0F, localResources));
        paramBundle.putInt("bundle_args_cover_width", actj.a(52.0F, localResources));
        paramBundle.putInt("bundle_args_cover_height", actj.a(52.0F, localResources));
        if (BaseApplicationImpl.sApplication.getRuntime().getAccount().equalsIgnoreCase(((axwl)localException).S))
        {
        ...
        localRelativeLayout.setId(2131362973);
        paramBundle = new RelativeLayout.LayoutParams(-2, -2);
        paramBundle.addRule(14);
        if (this.jdField_a_of_type_Boolean) {}
        for (paramBundle.topMargin = actj.a(9.0F, localResources);; paramBundle.topMargin = actj.a(7.0F, localResources))
        {
          paramBundle.addRule(3, 2131377264);
          localRelativeLayout.setLayoutParams(paramBundle);
          ((RelativeLayout)localObject3).addView(localRelativeLayout);
          localObject3 = new RelativeLayout.LayoutParams(actj.a(52.0F, localResources), actj.a(52.0F, localResources));
          paramBundle = (Bundle)localObject1;
          if (localObject1 == null) {
            paramBundle = new LinearLayout(paramContext);
          }
          paramBundle.setId(2131375830);
          ...
          localObject1 = new RelativeLayout.LayoutParams(actj.a(52.0F, localResources), actj.a(52.0F, localResources));
          ((RelativeLayout.LayoutParams)localObject1).addRule(1, 2131375830);
          ((RelativeLayout.LayoutParams)localObject1).leftMargin = actj.a(15.0F, localResources);
