  ...
  extends bbtu
{
  ...
  public bccj(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, TroopChatPie paramTroopChatPie)
  {
    ...
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(aekt.a(9.0F, paramBaseActivity.getActivity().getResources()), aekt.a(9.0F, paramBaseActivity.getActivity().getResources()));
    localLayoutParams.addRule(7, 2131375819);
    localLayoutParams.addRule(6, 2131375819);
    localLayoutParams.rightMargin = aekt.a(4.0F, paramBaseActivity.getActivity().getResources());
    localLayoutParams.topMargin = aekt.a(11.0F, paramBaseActivity.getActivity().getResources());
  ...
  public static void a(QQAppInterface paramQQAppInterface, ConfigurationService.Config paramConfig)
  {
    ...
    if (i != j)
    {
      paramConfig = aova.a(paramConfig);
      ...
      if ((paramConfig != null) && (paramConfig.size() > 0))
      {
        ...
        for (;;)
        {
          try
          {
            ...
            if (paramConfig.has("keywordConfigs"))
            {
              ...
              ((bchc)paramQQAppInterface.getManager(262)).a((String)localObject);
            }
        ...
        localObject = (bbtv)paramQQAppInterface.getManager(289);
        if ((((bbtv)localObject).a instanceof bccj)) {
          ((bccj)((bbtv)localObject).a).a(l1);
        }
        ((bchl)paramQQAppInterface.getManager(109)).a(paramConfig);
        localEditor.apply();
  ...
  {
    bdaj.a(paramQQAppInterface, paramString, "homework", "AioAssign_Show", 0, 0, new String[] { paramString, "", "", bdaj.a(paramQQAppInterface, paramString) });
    bdaj.a(paramQQAppInterface, paramString, "Grp_notice", "CreateNotice_Show", 0, 0, new String[] { paramString, "", "", "" });
  }
  
  private boolean a()
  {
    aokc localaokc = aokd.a();
    return (localaokc != null) && (localaokc.g());
  }
  ...
  {
    if ((paramTroopChatPie.jdField_a_of_type_Agvh != null) && (paramTroopChatPie.jdField_a_of_type_Agvh.a(paramTroopChatPie.a()))) {}
    do
    {
      return;
      if (!((atlc)paramTroopChatPie.a(33)).c()) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (paramTroopChatPie.jdField_a_of_type_Agvh == null) {
        paramTroopChatPie.jdField_a_of_type_Agvh = new agvh(paramTroopChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      }
      paramTroopChatPie.jdField_a_of_type_Agvh.a(paramTroopChatPie.a(), true);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean, bcgm parambcgm, TroopChatPie paramTroopChatPie)
  {
    ...
    if ((localTroopInfo != null) && (localTroopInfo.isHomeworkTroop())) {
      if (parambcgm != null) {
        bcgk.a(paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), parambcgm, paramBoolean);
      }
    }
    while (!QLog.isColorLevel())
    {
      return;
      if (this.jdField_a_of_type_Bcgm == null) {
        this.jdField_a_of_type_Bcgm = new bccn(this, paramTroopChatPie);
      }
      bcgk.a(paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, paramTroopChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Bcgm, paramBoolean);
      return;
    }
  ...
  {
    a(paramBoolean, new bccm(this), paramTroopChatPie);
  }
  ...
  public void a(boolean paramBoolean1, TroopChatPie paramTroopChatPie, boolean paramBoolean2)
  {
    ...
    {
      if (paramTroopChatPie.jdField_a_of_type_Agvh != null) {
        paramTroopChatPie.jdField_a_of_type_Agvh.a(paramTroopChatPie.a(), false);
      }
      e(false);
      b(false);
      return;
  ...
  public void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramBoolean = bcgk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "homework_troop_aio_panel_tip_homework");
      if (QLog.isColorLevel()) {
      ...
      {
        a(1, 500L);
        bcgk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "homework_troop_aio_panel_tip_homework", true);
        return;
      }
      paramBoolean = bcgk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "homework_troop_aio_panel_tip_notification");
      if (QLog.isColorLevel()) {
    ...
    a(2, 500L);
    bcgk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "homework_troop_aio_panel_tip_notification", true);
    return;
    label238:
    a();
  }
  ...
  public void c()
  {
    if ((this.jdField_a_of_type_Bhyv != null) && (this.jdField_a_of_type_Bhyv.isShowing()) && (this.jdField_a_of_type_Int > 0)) {
  ...
  public void c(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (paramBoolean))
    {
      if (!a())
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new bcck(this));
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843349);
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      bdaj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "homework", "AioSee_Show", 0, 0, new String[] { this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "", "", bdaj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a) });
  ...
  public void d(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (paramBoolean))
    {
      if (this.jdField_a_of_type_ComTencentMobileqqTroopWidgetRedDotAnimateView.getVisibility() != 0) {
        bdaj.a("Grp_edu", "homework", "AioSee_Reddot_Show", 0, 0, new String[] { this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a });
      }
  ...
  public void e(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (paramBoolean))
    {
      int i = bcgk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
      if (QLog.isColorLevel()) {
