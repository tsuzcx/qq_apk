...
public class bbvv
{
  ...
  {
    if (jdField_a_of_type_Bbvv == null) {}
    try
    {
      if (jdField_a_of_type_Bbvv == null) {
        jdField_a_of_type_Bbvv = new bbvv();
      }
      return jdField_a_of_type_Bbvv;
    }
    finally {}
  }
  ...
  public static ArrayList<Long> a(List<? extends ayhs> paramList)
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        Object localObject = (ayhs)paramList.get(i);
        if ((localObject instanceof aygy))
        {
          localObject = (aygy)localObject;
          try
          {
            if ((((aygy)localObject).a() == 0) || (((aygy)localObject).a() == 3)) {
              break label116;
            }
            localArrayList.add(Long.valueOf(Long.parseLong(((aygy)localObject).d())));
          }
  ...
  public final aygy a(String paramString)
  {
    ...
    while (i < j)
    {
      ayhr localayhr = (ayhr)this.jdField_a_of_type_JavaUtilList.get(i);
      if (((localayhr instanceof aygy)) && (paramString.equals(localayhr.d()))) {
        return (aygy)localayhr;
      }
      i += 1;
    }
    return null;
  ...
  public String a(String paramString1, String paramString2)
  {
    ...
    if (this.b == null)
    {
      ...
      localObject = (bbvx)this.b.get(j);
      if (!((bbvx)localObject).a.equals(paramString2)) {
        break label143;
      }
    }
    label143:
    label152:
    for (Object localObject = bbvx.a(paramString1, (bbvx)localObject);; localObject = null)
    {
  ...
  public List<ayhr> a(Context paramContext, QQAppInterface paramQQAppInterface, int paramInt)
  {
    long l1 = System.currentTimeMillis();
    ArrayList localArrayList1 = new ArrayList();
    ExecutorService localExecutorService = Executors.newFixedThreadPool(1);
    ArrayList localArrayList2 = new ArrayList();
    localArrayList2.add(localExecutorService.submit(new bbvw(this, paramContext, paramQQAppInterface, ayhr.E, paramInt)));
    paramInt = 0;
    try
    {
  ...
  @SuppressLint({"UseSparseArrays"})
  public List<ayhr> a(Context paramContext, QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean)
  {
    ...
    if (localalto != null)
    {
      ...
      if (localObject != null)
      {
        ...
        while (localIterator1.hasNext())
        {
          ...
          localObject = localalto.a(String.valueOf(localGroups.group_id));
          if (localObject != null)
          {
            ...
            label176:
            for (localObject = paramContext.getResources().getString(2131721202);; localObject = localGroups.group_name)
            {
              localArrayList.add(new aygy(paramContext, paramQQAppInterface, localFriends, (String)localObject, 0L, paramLong));
              break label105;
              break;
            }
          }
    ...
    if (paramBoolean)
    {
      ...
      localArrayList.add(new aygy(paramContext, paramQQAppInterface, (Friends)localObject, paramContext.getResources().getString(2131721202), 0L, paramLong));
    }
  ...
  public List<bbvx> a(Context paramContext, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    long l1 = System.currentTimeMillis();
    ArrayList localArrayList = new ArrayList();
    alto localalto = (alto)paramQQAppInterface.getManager(51);
    if (localalto != null)
    {
      Object localObject1 = localalto.b();
      if (localObject1 != null)
      {
        localObject1 = ((List)localObject1).iterator();
        while (((Iterator)localObject1).hasNext())
        {
          Object localObject2 = localalto.a(String.valueOf(((Groups)((Iterator)localObject1).next()).group_id));
          if (localObject2 != null)
          {
            ...
            while (((Iterator)localObject2).hasNext())
            {
              ...
              localArrayList.add(new bbvx(paramContext, localFriends.uin, localFriends.name, localFriends.remark));
            }
          }
        }
      }
    ...
    if (paramBoolean) {
      localArrayList.add(new bbvx(paramContext, paramQQAppInterface.getCurrentAccountUin(), paramQQAppInterface.getCurrentNickname(), null));
    }
    long l2 = System.currentTimeMillis();
    if (QLog.isColorLevel()) {
