...
public class gn
{
  ...
  private static WifiConfiguration a(gp paramgp)
  {
    ...
    localWifiConfiguration.SSID = a(paramgp.b(), new int[0]);
    localWifiConfiguration.hiddenSSID = paramgp.a();
  ...
  private static boolean a(WifiManager paramWifiManager, gp paramgp)
  {
    WifiConfiguration localWifiConfiguration = a(paramgp);
    localWifiConfiguration.wepKeys[0] = a(paramgp.d(), new int[] { 10, 26, 58 });
  ...
  private static boolean b(WifiManager paramWifiManager, gp paramgp)
  {
    WifiConfiguration localWifiConfiguration = a(paramgp);
    localWifiConfiguration.preSharedKey = a(paramgp.d(), new int[] { 64 });
  ...
  private static boolean c(WifiManager paramWifiManager, gp paramgp)
  {
    paramgp = a(paramgp);
    paramgp.allowedKeyManagement.set(0);
    return a(paramWifiManager, paramgp);
  }
  ...
  public boolean a(gp paramgp)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        i += 1;
        continue;
        String str = paramgp.c();
        if ((TextUtils.isEmpty(str)) || (str.equals("nopass"))) {
          return c(this.jdField_a_of_type_AndroidNetWifiWifiManager, paramgp);
        }
        if (TextUtils.isEmpty(paramgp.d())) {
          break label84;
        }
        if ("WEP".equals(str)) {
          return a(this.jdField_a_of_type_AndroidNetWifiWifiManager, paramgp);
        }
        if (!"WPA".equals(str)) {
          break label84;
        }
        return b(this.jdField_a_of_type_AndroidNetWifiWifiManager, paramgp);
      }
