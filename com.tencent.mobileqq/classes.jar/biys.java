...
{
  private FilenameFilter jdField_a_of_type_JavaIoFilenameFilter = new biyt(this);
  ...
  {
    boolean bool2 = false;
    File localFile1 = new File(alof.aW, "/Tencent/ReaderZone/");
  ...
  {
    String[] arrayOfString = new File(alof.aW, "/Tencent/ReaderZone/").list(this.jdField_a_of_type_JavaIoFilenameFilter);
  ...
  {
    return new File(new File(alof.aW, "/Tencent/ReaderZone/"), paramString);
  }
  ...
  public String[] reportHistoryFileInfo()
  {
    ...
    File localFile = new File(alof.aW, "/Tencent/ReaderZone/");
