  ...
  implements SurfaceTexture.OnFrameAvailableListener, SDKInitListener, ISuperPlayer.OnAudioFrameOutputListener, ISuperPlayer.OnCaptureImageListener, ISuperPlayer.OnCompletionListener, ISuperPlayer.OnDefinitionInfoListener, ISuperPlayer.OnErrorListener, ISuperPlayer.OnInfoListener, ISuperPlayer.OnSeekCompleteListener, ISuperPlayer.OnTVideoNetInfoListener, ISuperPlayer.OnVideoPreparedListener, ISuperPlayer.OnVideoSizeChangedListener
{
  ...
  private void e()
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsSurfaceTexture.setOnFrameAvailableListener(this, this.jdField_a_of_type_Nee);
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer.setAudioPostFrameOptionInfo(localSuperPlayerAudioInfo);
      return;
      label249:
  ...
  private void f()
  {
    ...
    if (this.jdField_a_of_type_Nee != null) {
      this.jdField_a_of_type_Nee.post(new AVGameMediaPlayerWrapper.6(this));
    }
  }
  ...
  public void a(String paramString, long paramLong)
  {
    ...
    this.jdField_a_of_type_Nee.post(new AVGameMediaPlayerWrapper.3(this, paramLong));
  }
  
  public void a(ncu paramncu, nee paramnee)
  {
    QLog.d("AVGameMediaPlayerWrapper", 1, "addAVGameMediaPlayerCallBack");
    this.jdField_a_of_type_Ncu = paramncu;
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Nee != null) {
      this.jdField_a_of_type_Nee.post(new AVGameMediaPlayerWrapper.5(this));
    }
  }
  ...
  public void b(String paramString, long paramLong)
  {
    ...
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_Nee.post(new AVGameMediaPlayerWrapper.4(this, paramLong));
  }
  ...
  public void onAudioFrameOutput(TPAudioFrameBuffer paramTPAudioFrameBuffer)
  {
    if (this.jdField_a_of_type_Ncu != null) {
      this.jdField_a_of_type_Ncu.a(paramTPAudioFrameBuffer);
    }
  }
  ...
  public void onCompletion(ISuperPlayer paramISuperPlayer)
  {
    ...
    {
      if (this.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_Ncu.d(this.jdField_a_of_type_JavaLangString);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_Ncu.b(this.jdField_a_of_type_JavaLangString);
  }
  ...
  public boolean onError(ISuperPlayer paramISuperPlayer, int paramInt1, int paramInt2, int paramInt3, String paramString)
  {
    ...
    if (!this.jdField_a_of_type_Boolean) {
      bcst.b(null, "dc00898", "", "", "0X800B0E7", "0X800B0E7", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      return false;
      bcst.b(null, "dc00898", "", "", "0X800B1F4", "0X800B1F4", 0, 0, "", "", "", "");
    }
  }
  ...
  public void onFrameAvailable(SurfaceTexture paramSurfaceTexture)
  {
    ...
    paramSurfaceTexture = this.jdField_a_of_type_Nee.obtainMessage(256, this.jdField_a_of_type_AndroidGraphicsPoint.x, this.jdField_a_of_type_AndroidGraphicsPoint.y, Long.valueOf(l));
    this.jdField_a_of_type_Nee.sendMessage(paramSurfaceTexture);
  }
  ...
  public void onSeekComplete(ISuperPlayer paramISuperPlayer)
  {
    ...
    if (this.jdField_a_of_type_Nee != null) {
      this.jdField_a_of_type_Nee.post(new AVGameMediaPlayerWrapper.9(this));
    }
  }
  ...
  public void onVideoPrepared(ISuperPlayer paramISuperPlayer)
  {
    ...
    if (this.jdField_a_of_type_Nee != null) {
      this.jdField_a_of_type_Nee.post(new AVGameMediaPlayerWrapper.8(this));
    }
  }
