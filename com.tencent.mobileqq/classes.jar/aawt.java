...
class aawt
  implements Runnable
{
  aawt(aaws paramaaws, aawy paramaawy, String paramString, double paramDouble1, double paramDouble2) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Aawy.jdField_a_of_type_ComTencentMobileqqArkArkMessageServerLogic$IPassiveSearchIntentByServerHandler != null) {
        this.jdField_a_of_type_Aawy.jdField_a_of_type_ComTencentMobileqqArkArkMessageServerLogic$IPassiveSearchIntentByServerHandler.a(this.jdField_a_of_type_Aawy.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Aawy.jdField_a_of_type_JavaLangObject, null);
      }
      Object localObject2;
      String str;
      do
      ...
      } while (((ArkAppSSO)localObject2).a("ArkSearchService.PassiveSearch", str, 10000, 0, new aawu(this, (ArkLocalAppMgr)localObject1)));
