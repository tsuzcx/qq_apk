...
{
  public amzx(AppInterface paramAppInterface)
  {
  ...
  public void a(int paramInt, String paramString, ArrayList<amzf> paramArrayList)
  {
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      {
        amzf localamzf = (amzf)paramArrayList.next();
        STCommon.STLocalCVerInfo localSTLocalCVerInfo = new STCommon.STLocalCVerInfo();
        localSTLocalCVerInfo.busId.set(localamzf.jdField_a_of_type_Int);
        localSTLocalCVerInfo.itemId.set(localamzf.jdField_a_of_type_JavaLangString);
        localSTLocalCVerInfo.localVer.set(localamzf.jdField_b_of_type_Int);
    ...
    paramArrayList = new NewIntent(this.mApp.getApp(), amzy.class);
  ...
  public void a(ReportInfoManager.ReportChannlInfo paramReportChannlInfo)
  {
    ...
    try
    {
      ...
      paramReportChannlInfo = new NewIntent(this.mApp.getApp(), amzy.class);
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, long paramLong1, String paramString2, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    try
    {
      ...
      paramString2 = new NewIntent(this.mApp.getApp(), amzy.class);
  ...
  public void a(String paramString, int paramInt, long paramLong)
  {
    ...
    try
    {
      ...
      localObject = new NewIntent(this.mApp.getApp(), amzy.class);
      ...
      if (("apollo_game_av.get_usraccinfo".equals(paramString)) && (paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess()))
      {
        ...
        try
        {
          ...
          if ((paramArrayOfByte != null) && (paramArrayOfByte.size() > 0))
          {
            ...
            paramIntent = amwn.a(paramIntent.getIntExtra("gameId", -1));
            if (paramIntent != null)
            {
  ...
  public void a(String paramString1, String paramString2, long paramLong, int paramInt, boolean paramBoolean, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        paramArrayOfByte = new NewIntent(this.mApp.getApp(), amzy.class);
  ...
  public void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      {
        ((amzo)localObject1).c(paramFromServiceMsg.getResultCode(), paramIntent);
        return;
      }
    }
    ...
    {
      ((amzo)localObject1).c(paramArrayOfByte.subCode.get(), paramIntent);
      return;
    }
    Object localObject2 = new amzn();
    if (paramArrayOfByte.updateFlag.get() == 1)
    {
      bool = true;
      ((amzn)localObject2).jdField_a_of_type_Boolean = bool;
    ...
    {
      ((amzn)localObject2).jdField_b_of_type_Boolean = bool;
      ((amzn)localObject2).jdField_a_of_type_Int = paramArrayOfByte.svrVer.get();
      ((amzn)localObject2).jdField_b_of_type_Int = i;
      ((amzn)localObject2).jdField_d_of_type_JavaLangString = paramArrayOfByte.url.get();
      ((amzn)localObject2).c = paramArrayOfByte.md5.get();
      ((amzn)localObject2).jdField_a_of_type_ArrayOfByte = paramArrayOfByte.patchContent.get().toByteArray();
      ((amzn)localObject2).e = paramArrayOfByte.patchUrl.get();
      ((amzn)localObject2).jdField_b_of_type_Long = paramArrayOfByte.packageSize.get();
      ((amzn)localObject2).jdField_a_of_type_Long = paramArrayOfByte.tipsSize.get();
      ((amzn)localObject2).jdField_a_of_type_JavaLangString = paramArrayOfByte.itemId.get();
      ((amzn)localObject2).jdField_b_of_type_JavaLangString = paramIntent;
      ((amzn)localObject2).jdField_d_of_type_Int = 1;
      ((amzo)localObject1).a((amzn)localObject2);
      return;
      bool = false;
      break;
    }
  ...
  public void c(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if ((localamyx == null) || (localamyx.a() == null))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          if (i < paramFromServiceMsg.length())
          {
            ...
            localObject1 = new amtk(((JSONObject)localObject1).optString("icon"), (String)localObject2, paramArrayOfByte);
            localamyx.a().updateUserInfo((amtk)localObject1);
            if (j == amxx.jdField_a_of_type_Int) {
              localamyx.a().getOpenApiHead(l, paramArrayOfByte);
            } else if (j == amxx.jdField_b_of_type_Int) {
              localamyx.a().getOpenApiNick(l, paramArrayOfByte);
            }
          }
        }
      }
      ...
      for (;;)
      {
        try
        {
          ...
          localamyx.a().nativeOpenApiGetHeadCallBack(l, paramFromServiceMsg.getString(0), -1, 0, 0, null);
        ...
        localamyx.a().callbackFromRequest(l, 0, "cs.preload_userInfoList.local", paramFromServiceMsg.toString());
        return;
        if (j == amxx.jdField_a_of_type_Int)
        {
          paramIntent = new JSONObject(str).optJSONArray("uidList");
          localamyx.a().nativeOpenApiGetHeadCallBack(l, paramIntent.getString(0), paramFromServiceMsg.getResultCode(), 0, 0, null);
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_HEAD error openid=" + paramIntent.getString(0));
          return;
        }
        if (j == amxx.jdField_b_of_type_Int)
        {
          paramIntent = new JSONObject(str).optJSONArray("uidList");
          localamyx.a().nativeOpenApiGetNickCallBack(l, paramIntent.getString(0), paramFromServiceMsg.getResultCode(), null);
        ...
        localamyx.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), "cs.preload_userInfoList.local", paramIntent.toString());
        ...
        {
          paramFromServiceMsg = new JSONObject(str).optJSONArray("uidList");
          localamyx.a().nativeOpenApiGetNickCallBack(l, paramFromServiceMsg.getString(0), -1, null);
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_NICK error openid=" + paramFromServiceMsg.getString(0));
        }
        else if (j == amxx.c)
        {
          localamyx.a().callbackFromRequest(l, -1, "cs.preload_userInfoList.local", "{}");
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_PRELOAD error ");
        }
      }
      label859:
  ...
  public void d(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        do
        {
          for (;;)
          {
            ...
            try
            {
              ...
              if (i == 4)
              {
                localamyx.a().callbackFromRequest(l, (int)localUniSsoServerRsp.ret.get(), str3, paramArrayOfByte);
                return;
              }
            }
            catch (Throwable paramArrayOfByte)
            {
              ...
              try
              {
                ...
                if (i == 4)
                {
                  localamyx.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), paramIntent, "{}");
                  return;
                }
              }
        ...
        paramArrayOfByte = amwn.a(localJSONObject1.optInt("gameId"));
    ...
    localamyx.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), str3, "{}");
  }
