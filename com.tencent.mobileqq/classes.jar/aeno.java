  ...
  implements Handler.Callback
{
  protected boolean T;
  protected akav a;
  amnl jdField_a_of_type_Amnl;
  amnt jdField_a_of_type_Amnt = new aenp(this);
  ...
  public aeno(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    super(paramQQAppInterface, paramViewGroup, paramFragmentActivity, paramContext);
    this.jdField_b_of_type_MqqOsMqqHandler = new bfmt(ThreadManager.getSubThreadLooper(), this);
    this.jdField_a_of_type_Akav = new aent(this);
  }
  ...
  private void bp()
  {
    ...
    {
      this.jdField_a_of_type_Amnl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin(), l1, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, true);
      return;
    }
    this.jdField_a_of_type_Amnl.a(l1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, false);
  }
  ...
  private void bq()
  {
    ...
    {
      String str = amns.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e);
      if (amnk.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str)) {
  ...
  private void br()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1033)
    {
      this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setBackgroundResource(2130843030);
    ...
    for (;;)
    {
      try
      {
        ...
        {
          actn.a(this.jdField_a_of_type_ComTencentWidgetXEditTextEx, 2130843049);
          this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setTextColor(-16777216);
        }
        this.e.setTextColor(mye.c);
        ...
        if (this.jdField_a_of_type_AndroidWidgetTextView.getVisibility() == 0)
        {
          ...
          c(true);
          this.f.setText(ajyc.a(2131702377) + this.g);
          ...
          localObject1 = ajyc.a(2131702378);
          if (this.T) {
            localObject1 = ajyc.a(2131702379);
          }
          ...
          if (amnk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
          {
            localObject1 = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131560698, null);
            this.jdField_d_of_type_AndroidViewViewGroup.addView((View)localObject1, new ViewGroup.LayoutParams(-1, -1));
            localObject2 = ((View)localObject1).findViewById(2131379356);
            ...
            this.jdField_a_of_type_ComTencentMobileqqConfessConfessProgressView = ((ConfessProgressView)((View)localObject1).findViewById(2131364603));
            ...
            bs();
            if (!amnk.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "holmes_guide"))
            {
              amnk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "holmes_guide", true);
              if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int != 1033) {
                break label933;
              }
              ...
              this.jdField_d_of_type_AndroidViewViewGroup.getViewTreeObserver().addOnGlobalLayoutListener(new aenq(this, (View)localObject1, (View)localObject2));
            }
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130844753);
      ...
      continue;
      label933:
      View localView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131560696, null);
    }
  }
  ...
  private void bt()
  {
    ...
    ((bfol)localObject).a(2131690008, 5);
    ((bfol)localObject).a(2131690621, 5);
    ((bfol)localObject).c(2131690596);
    ((bfol)localObject).a(new aenu(this, (bfol)localObject));
  ...
  private void t(boolean paramBoolean)
  {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      this.jdField_p_of_type_AndroidWidgetImageView.setContentDescription(String.format(ajyc.a(2131702387), new Object[] { Integer.valueOf(localConfessConvInfo.holmesTolCount), Integer.valueOf(localConfessConvInfo.holmesCurCount) }));
      ...
      return;
      label215:
      this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130844175);
    }
  }
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    if (this.jdField_a_of_type_Bcpt == null) {
      this.jdField_a_of_type_Bcpt = new bcpt(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    }
  ...
  {
    amns.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e, true, true);
  }
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    br();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Amnt);
    this.jdField_a_of_type_Amnl = ((amnl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(125));
    bp();
    return paramBoolean;
  }
  ...
  public void aX()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int != 1033)
    {
      ...
      if (localObject != null)
      {
        localObject = (ChatFragment)localObject;
        if (((ChatFragment)localObject).a != null) {
          ((ChatFragment)localObject).a.setStatusBarDrawable(a().getResources().getDrawable(2130845303));
        }
      }
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable(SkinEngine.getInstances().getDefaultThemeDrawable(2130849040));
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setBackgroundDrawable(SkinEngine.getInstances().getDefaultThemeDrawable(2130849026));
      this.jdField_d_of_type_AndroidViewViewGroup.setBackgroundDrawable(SkinEngine.getInstances().getDefaultThemeDrawable(2130848963));
      actn.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout, SkinEngine.getInstances().getDefaultThemeDrawable(2130848770));
      actn.a(this.jdField_a_of_type_ComTencentWidgetXEditTextEx, SkinEngine.getInstances().getDefaultThemeDrawable(2130848771));
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setTextColor(-16777216);
      localObject = SkinEngine.getInstances().getDefaultThemeDrawable(2130848919);
      Drawable localDrawable1 = SkinEngine.getInstances().getDefaultThemeDrawable(2130848916);
      Drawable localDrawable2 = SkinEngine.getInstances().getDefaultThemeDrawable(2130848920);
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout.setBackgroundDrawable(SkinEngine.getInstances().getDefaultThemeDrawable(2130848820));
      return;
    }
    actn.a(this.jdField_a_of_type_ComTencentWidgetXEditTextEx, 2130843049);
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setTextColor(-16777216);
  ...
  public void aq()
  {
    ...
    localaaok.i = this.J;
    this.J = false;
    aaod.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, str, null, localaaok);
    ...
    aY();
    this.jdField_a_of_type_Aeyx.a(1002, new Object[] { str });
  }
  ...
  public void c(Intent paramIntent)
  {
    ...
    this.g = str1;
    paramIntent = (amno)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(269);
    ...
    for (;;)
    {
      ...
      if (!this.L)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1033)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqConfessConfessInfo = localamnj.a(str3, j, k, paramIntent, str1, i, str2, l);
        }
      }
      for (;;)
      {
  ...
  public int e()
  {
    int i = adwr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Normal_MaxPtt") * 1000 - 200;
  ...
  public void onClick(View paramView)
  {
    ...
    if (i == 2131367555)
    {
      ...
      if (this.o != null)
      {
        ...
        {
          this.o.setVisibility(8);
          paramView = amns.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e);
          amnk.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView, false);
          i = 1;
        }
      }
      String str;
      ...
      for (;;)
      {
        amnk.a(localQQAppInterface, localContext, paramView, str, j, bool);
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009573", "0X8009573", i, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e + "", "", paramView + "", str + "");
        return;
