  ...
  extends akon
{
  ...
  public akoq(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
    super(paramQQAppInterface, paramMessageHandler);
    this.jdField_a_of_type_JavaUtilComparator = new akos(this);
  }
  ...
  private boolean c(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord instanceof MessageForArkApp))
    {
      ...
      {
        bool1 = bool2;
        if (alqx.a(paramMessageRecord.ark_app_message.appName)) {
          bool1 = true;
        }
      }
    }
  ...
  protected TroopMemberInfo a(msg_comm.Msg paramMsg, ArrayList<MessageRecord> paramArrayList, axav paramaxav, boolean paramBoolean, azml paramazml)
  {
    long l5;
    Object localObject7;
    long l6;
    ...
    try
    {
      ...
      if ((paramaxav == null) || (paramMsg == null) || (paramArrayList == null)) {
        break label8020;
      }
      ...
      if (paramaxav.c == 1026)
      {
        l3 = bbbr.a(((msg_comm.MsgHead)localObject7).msg_seq.get());
        l2 = bbbr.a(((msg_comm.MsgHead)localObject7).msg_time.get());
      }
      ...
      localObject2 = axaq.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramMsg, String.valueOf(l6), String.valueOf(l6));
    ...
    {
      axaq.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, (List)localObject3, paramMsg, paramaxav.e, l2, false);
      localObject2 = null;
      l1 = 0L;
    }
    label284:
    ...
    for (;;)
    {
      ...
      if ((((List)localObject3).size() == 0) && (k > 1))
      {
        ...
        localObject4 = (MessageForText)axas.a(-1000);
      ...
      if (localIterator.hasNext())
      {
        ...
        localMessageRecord.istroop = paramaxav.c;
        localMessageRecord.senderuin = String.valueOf(l6);
        localMessageRecord.frienduin = String.valueOf(paramaxav.e);
        ...
        if (((msg_comm.MsgHead)localObject7).msg_flag.has())
        {
          ...
          if ((((msg_comm.MsgHead)localObject7).msg_flag.get() & 1L) == 1L)
          {
            ...
            {
              b2 = 1;
              localazml.c.a(l3, localMessageRecord.uniseq);
              b1 = b2;
              if (QLog.isColorLevel())
              {
        ...
        if ((localMessageRecord.istroop == 1) && (bbtq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(localMessageRecord.msg, localMessageRecord.frienduin))) {
          localazml.b.a(l3, localMessageRecord.uniseq);
        }
        if (((localMessageRecord instanceof MessageForTroopConfess)) && (((MessageForTroopConfess)localMessageRecord).isToSelf)) {
          localazml.d.a(l3, localMessageRecord.uniseq);
        }
        if (a(localMessageRecord)) {
          localazml.g.a(l3, localMessageRecord.uniseq);
        }
        if (b(localMessageRecord)) {
          localazml.s.a(l3, localMessageRecord.uniseq);
        }
        if (c(localMessageRecord)) {
          localazml.w.a(l3, localMessageRecord.uniseq);
        }
        Object localObject9;
        if (((paramaxav.c == 1) || (paramaxav.c == 1026)) && (localObject2 != null))
        {
          ...
          for (;;)
          {
            if (((Iterator)localObject4).hasNext())
            {
              ...
              if ((((im_msg_body.Elem)localObject6).general_flags.has()) && (((im_msg_body.Elem)localObject6).general_flags.bytes_pb_reserve.has()))
              {
                ...
                {
                  localazml.x.a(l3, localMessageRecord.uniseq);
                  if (QLog.isColorLevel())
                  {
                    ...
                    l1 = axau.a(((im_msg_body.Attr)((im_msg_body.RichText)localObject4).attr.get()).random.get());
                    localObject2 = ((im_msg_body.RichText)localObject4).elems.get();
                    if (((im_msg_body.RichText)localObject4).ptt.has())
                    {
                      axaq.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, paramMsg, (List)localObject3);
                      break;
                    }
                    localazml.jdField_a_of_type_JavaLangString = String.valueOf(paramaxav.e);
                    localazml.jdField_a_of_type_Int = paramaxav.c;
                    axaq.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler, (List)localObject3, paramMsg, false, false, localazml);
                    break;
                  }
                }
              }
        ...
        if (localMessageRecord.msgtype == -1049)
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(((MessageForReplyText)localObject4).mSourceMsgInfo.mSourceMsgSenderUin + ""))) {
            localazml.l.a(l3, localMessageRecord.uniseq);
          }
        }
        if (localMessageRecord.msgtype == -5015) {
          localazml.v.a(l3, localMessageRecord.uniseq);
        }
        if (localMessageRecord.msgtype == -2058) {
          EmojiStickerManager.a(localMessageRecord, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        }
        if (((localMessageRecord.msgtype != -2058) || (paramazml.t.a != -1L) || (paramazml.t.b != -1L)) || (localMessageRecord.msgtype == -1035))
        {
        ...
        if ((localMessageRecord.msgtype == -2035) || (localMessageRecord.msgtype == -2038))
        {
          ...
          localObject6 = bbcz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((MessageForDeliverGiftTips)localObject4).istroop, ((MessageForDeliverGiftTips)localObject4).frienduin, ((MessageForDeliverGiftTips)localObject4).senderuin);
          ...
          if (!((MessageForDeliverGiftTips)localObject4).isFromNearby)
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localObject6))
            {
              ...
              localazml.h.a(l3, localMessageRecord.uniseq);
            }
            localObject6 = (bahf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(223);
            if (localObject6 != null) {
              ((bahf)localObject6).b((MessageForDeliverGiftTips)localObject4);
            }
          }
        }
        if (aszp.a(localMessageRecord))
        {
        ...
        {
          localObject4 = axva.a(localMessageRecord.msgData);
          if ((localObject4 instanceof StructMsgForGeneralShare))
          {
            ...
            localObject9 = new akok(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            localObject6 = ((akok)localObject9).jdField_a_of_type_Aktf;
            localObject9 = ((akok)localObject9).jdField_a_of_type_JavaUtilMap;
            localObject6 = ((aktf)localObject6).a((String)localObject4, 1);
            TroopManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord.frienduin, StructMsgForGeneralShare.eventId, localMessageRecord.shmsgseq, new akor(this, false, localazml, l3, l8, (RecentUser)localObject6, (String)localObject4, localMessageRecord, (Map)localObject9));
          }
        }
        if ((localMessageRecord instanceof MessageForTroopFile)) {
          localazml.n.a(l3, localMessageRecord.uniseq);
        }
        if (bajo.a(localMessageRecord)) {
          localazml.j.a(l3, localMessageRecord.uniseq);
        }
        if ((localMessageRecord.msgtype == -5008) && ((localMessageRecord instanceof MessageForArkApp)))
        {
          ...
          if ((((MessageForArkApp)localObject4).ark_app_message != null) && (((MessageForArkApp)localObject4).ark_app_message.appName.equals("com.tencent.mannounce"))) {
            localazml.q.a(l3, localMessageRecord.uniseq);
          }
        }
        ...
        if (localMessageRecord.msgtype == -2039)
        {
          ...
          localObject10 = (airx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
          localObject4 = null;
          if (QLog.isColorLevel()) {
          ...
          {
            localObject11 = ((airx)localObject10).b(((MessageForApollo)localObject6).senderuin);
            if (QLog.isColorLevel()) {
          ...
          {
            localObject11 = ((airx)localObject10).b(((MessageForApollo)localObject6).mApolloMessage.peer_uin + "");
            if (QLog.isColorLevel()) {
          ...
          if (((ArrayList)localObject9).size() > 0) {
            ((airx)localObject10).b((List)localObject9);
          }
          if (QLog.isColorLevel()) {
          ...
          {
            i1 = ((airx)localObject10).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
            localObject4 = "";
        ...
        for (;;)
        {
          ...
          VipUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "cmshow", "Apollo", "rev_action", String.valueOf(localMessageRecord.senderuin), n, ((MessageForApollo)localObject6).msgType, new String[] { localObject4, Integer.toString(i1), Integer.toString(airx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)), String.valueOf(System.currentTimeMillis() / 1000L) });
          if (paramazml != null)
          {
            if (localazml.f.a != -1L) {
              localazml.f.b = localMessageRecord.uniseq;
            }
            if (localazml.jdField_a_of_type_Azmm.a != -1L) {
              localazml.jdField_a_of_type_Azmm.b = localMessageRecord.uniseq;
            }
            if ((l3 > this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(String.valueOf(paramaxav.e), paramaxav.c)) && (localazml.a()))
            {
              paramazml.a(localazml);
              localMessageRecord.mMessageInfo = localazml;
            }
          }
          if (((paramaxav.c != 1) && (paramaxav.c != 1026) && (paramaxav.c != 3000)) || (localObject2 == null) || (TextUtils.equals(localMessageRecord.selfuin, localMessageRecord.senderuin))) {
            break label3777;
          }
          i = 0;
          localObject4 = ((List)localObject2).iterator();
          ...
          localazml.i.a(l3, localMessageRecord.uniseq);
          break;
          ...
          localazml.i.a(l3, localMessageRecord.uniseq);
          break label1754;
          if ((localObject4 != null) && (((StructMsgForGeneralShare)localObject4).mMsgServiceID == 19) && (!((StructMsgForGeneralShare)localObject4).mMsgBrief.startsWith(ajya.a(2131701025))) && (!((StructMsgForGeneralShare)localObject4).mMsgBrief.equals(ajya.a(2131701019))))
          {
            localazml.o.a(l3, localMessageRecord.uniseq);
            break label1911;
          }
          if ((localObject4 != null) && (((StructMsgForGeneralShare)localObject4).mMsgServiceID == 106))
          {
            ...
            localazml.jdField_a_of_type_Azmm.a(l3, localMessageRecord.uniseq);
            break label1911;
          }
          if ((localObject4 == null) || (((StructMsgForGeneralShare)localObject4).mMsgServiceID != 107)) {
            break label1911;
          }
          localazml.u.a(l3, localMessageRecord.uniseq);
          break label1911;
        ...
        else
        {
          ...
          if (localObject2 != null)
          {
              ...
              if (((im_msg_body.Elem)localObject9).anon_group_msg.has())
              {
                ...
                for (;;)
                {
                  try
                  {
                    ...
                    {
                      localObject6 = "";
                      localMessageRecord.saveExtInfoToExtStr("anonymous", myb.a(i, (String)localObject4, (String)localObject6, n, i1, (String)localObject9));
            ...
            localObject9 = bajq.a(((im_msg_body.Elem)localObject9).group_business_msg);
            bajp.a(localMessageRecord, (bajq)localObject9);
            ...
            {
              axqy.b((QQAppInterface)localObject10, "P_CliOper", "Grp_AIO", "", "five_m", "revice_msg", 0, 0, (String)localObject3, localMessageRecord.msgtype + "", ((bajq)localObject9).c, "");
              localObject3 = localObject5;
              if (!QLog.isColorLevel()) {
                break;
              }
      ...
      else
      {
        ...
        i1 = -100;
        i5 = -100;
        if ((paramaxav.c == 1) || (paramaxav.c == 1026))
        {
          double d = -100.0D;
          i = -1;
                  ...
                  case 1: 
                    ...
                    do
                    {
                      ...
                      if (((im_msg_body.Elem)localObject6).general_flags.bytes_pb_reserve.has())
                      {
                        ...
                        paramazml.mergeFrom(((im_msg_body.Elem)localObject6).general_flags.bytes_pb_reserve.get().toByteArray());
                        if (paramazml.uint32_rich_card_name_ver.has()) {
                          paramazml.uint32_rich_card_name_ver.get();
                        }
                        if (!paramazml.uint32_nearby_charm_level.has()) {
                          break label8185;
                        }
                        i2 = paramazml.uint32_nearby_charm_level.get();
                        if (!paramazml.uint32_global_group_level.has()) {
                          break label8192;
                        }
                        i5 = paramazml.uint32_global_group_level.get();
                        if (!paramazml.uint32_vip_type.has()) {
                          break label8199;
                        }
                        i1 = paramazml.uint32_vip_type.get();
                        if (!paramazml.uint32_vip_level.has()) {
                          break label8205;
                        }
                        i6 = paramazml.uint32_vip_level.get();
                        i7 = VipUtils.c(i6);
                        if (paramazml.uint32_user_bigclub_flag.has()) {
                          j = paramazml.uint32_user_bigclub_flag.get();
                        }
                        if (paramazml.uint32_user_bigclub_level.has()) {
                          k = paramazml.uint32_user_bigclub_level.get();
                        }
                        if (paramazml.uint32_nameplate.has()) {
                          m = paramazml.uint32_nameplate.get();
                        }
                        if (paramazml.uint32_req_is_bigclub_hidden.has()) {
                          n = paramazml.uint32_req_is_bigclub_hidden.get();
                        }
                        i8 = n;
                        if (j != 0)
                        {
                          i8 = n;
                          if (paramazml.uint32_nameplate_vip_type.has())
                          {
                            i8 = n;
                            if (paramazml.uint32_gray_name_plate.has())
                            {
                              i6 = paramazml.uint32_nameplate_vip_type.get();
                              if ((!bblt.a(i6)) || (bblu.a(i6).b())) {
                                break label8211;
                              }
                              i6 = 1;
                              if (paramazml.uint32_gray_name_plate.get() != 0) {
                                break label8069;
                              }
                              i8 = n;
                              if (i6 != 0) {
                        ...
                        i9 = i;
                        if (paramazml.uint32_title_id.has())
                        {
                          n = paramazml.uint32_title_id.get();
                          if (n > 0) {
                            i = n;
                          }
                          i9 = i;
                        ...
                        if ((paramaxav.c == 1) && (paramazml.uint32_group_member_flag_ex2.has()))
                        {
                          i = paramazml.uint32_group_member_flag_ex2.get();
                          aknk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l1, i);
                        }
                        if ((paramaxav.c == 1) && (paramazml.uint32_group_ringtone_id.has()) && (paramazml.uint32_group_ringtone_id.get() > 0))
                        {
                          i = paramazml.uint32_group_ringtone_id.get();
                          aknk.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, l1, i);
                        }
                        ...
                        if ((paramaxav.c == 1) && (paramazml.uint32_custom_featureid.has()) && (localObject7 != null) && (paramazml.uint32_custom_featureid.get() == 19713))
                        {
                          if (QLog.isColorLevel()) {
                        ...
                        if (!paramazml.bytes_hudong_mark.has()) {
                          break label8217;
                        }
                        paramazml = paramazml.bytes_hudong_mark.get().toByteArray();
                        paramazml = badm.a(paramazml);
                        ((badj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(346)).a(String.valueOf(l1), String.valueOf(l6), paramazml);
                        i2 = i7;
                        i5 = j;
                        i6 = k;
                        i7 = m;
                      ...
                      localObject7 = ((TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52)).b(paramazml);
                      if (localObject7 == null) {
                        break label8075;
                      }
                      l8 = ((im_msg_body.Elem)localObject6).general_flags.uint64_group_rank_seq.get();
                      if (QLog.isColorLevel()) {
                        QLog.d("Q.getTroopMemberLevelInfo", 2, "onNewMsg: troopUin=" + paramazml + ", serverRankSeq=" + l8 + ", localRankSeq=" + ((TroopInfo)localObject7).dwGroupLevelSeq + ", isSyncMsgFinish=" + bool1);
                      }
                      if (l8 <= ((TroopInfo)localObject7).dwGroupLevelSeq) {
                        break label8075;
                      }
                      ((akhp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).c(paramazml, false);
                      break label8075;
                      bool5 = bool1;
                    ...
                    if (((im_msg_body.Elem)localObject6).general_flags.uint32_to_uin_flag.get() == 2)
                    {
                      ...
                      if (QLog.isColorLevel())
                      {
                        QLog.d("Q.getTroopMemberLevelInfo", 2, "onNewMsg: troopUin=" + paramazml + ", isSyncMsgFinish=" + bool1);
                        break label8075;
                        if ((((im_msg_body.Elem)localObject6).extra_info.has()) && (((im_msg_body.Elem)localObject6).extra_info.uint32_flags.has()))
                        {
                          ...
                          if (bool1)
                          {
                            ...
                            paramazml = ((HotChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(60)).a(l1 + "");
                            localObject6 = l6 + "";
                            if ((paramazml == null) || (paramazml.adminUins.contains(localObject6))) {
                              break label8229;
                            }
                            paramazml.adminUins.add(localObject6);
                            break label8229;
                          }
                        }
                        else if (((im_msg_body.Elem)localObject6).pub_group.has())
                        {
                          ...
                          if (QLog.isColorLevel())
                          {
                            ...
                            paramazml = ((im_msg_body.PubGroup)((im_msg_body.Elem)localObject6).pub_group.get()).bytes_nickname.get().toStringUtf8();
                            label6300:
                            QLog.d("Q.msg.BaseMessageProcessorForTroopAndDisc", 2, "decodeSinglePbMsg_GroupDis,receive  pub_group,bytes_nickname = " + paramazml);
                            i4 = k;
                            i5 = j;
                            i6 = i1;
                            i7 = 1;
                          ...
                          if (((im_msg_body.Elem)localObject6).elem_flags2.has())
                          {
                            ...
                            if (((im_msg_body.ElemFlags2)((im_msg_body.Elem)localObject6).elem_flags2.get()).uint32_longtitude.has())
                            {
                              ...
                              if (((im_msg_body.ElemFlags2)((im_msg_body.Elem)localObject6).elem_flags2.get()).uint32_latitude.has())
                              {
                                ...
                                label6632:
                                paramazml = String.valueOf(l1);
                                paramaxav = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
                                localObject2 = paramaxav.b(paramazml);
                                if (QLog.isColorLevel()) {
                                ...
                                if ((!bool1) && (localObject2 == null))
                                {
                                  ...
                                  ((TroopInfo)localObject2).troopuin = paramazml;
                                  paramaxav.b((TroopInfo)localObject2);
                                  ((akhp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).j(paramazml);
                                }
                                localObject2 = String.valueOf(l6);
                                i3 = ((msg_comm.GroupInfo)localObject5).group_level.get();
                                localObject6 = bbos.a(((msg_comm.GroupInfo)localObject5).group_card.get());
                                ...
                                paramaxav = paramArrayList.iterator();
                                while (paramaxav.hasNext()) {
                                  ((MessageRecord)paramaxav.next()).isOpenTroopMessage = true;
                                }
                                paramaxav = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
                                if ((paramaxav == null) || (paramaxav.f(paramazml))) {
                                  break label8315;
                                }
                                paramaxav = (akhp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20);
                                if (paramaxav == null) {
                                  break label8315;
                                }
                                paramaxav.f(paramazml, false);
                                break label8315;
                                label6975:
                                if (i2 != -100)
                                {
                                  paramaxav = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
                                  if (paramaxav != null) {
                                    paramaxav.a(paramazml, (String)localObject2, i2);
                                  }
                                }
                                if (paramBoolean) {
                                  paramaxav = (TroopManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(52);
                                ...
                                {
                                case 1: 
                                  paramaxav.a(paramazml, (String)localObject2, (String)localObject6, i, null, null, 0, 1, 100, l3, b2, 0L, d, null, -100, j, k, m, n, i1, i5);
                                case 2: 
                                  for (;;)
                                  {
                                    label7052:
                                    paramaxav.a(paramazml, (String)localObject2, (String)localObject3);
                                    paramaxav = null;
                                    label7105:
                                    ...
                                    localObject2 = (bajo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(132);
                                    if (((bajo)localObject2).a(paramazml)) {
                                      break label8356;
                                    }
                                    if (!((bajo)localObject2).b(paramazml)) {
                                      break label7551;
                                    }
                                    ...
                                    i2 = i;
                                    if (!bajo.a((MessageRecord)localObject3)) {
                                      break label8349;
                                    }
                                    ...
                                    paramaxav.a(paramazml, (String)localObject2, (String)localObject6, i, null, null, 0, 1, 100, l3, b2, 0L, d, null, -100, j, k, m, n, i1, i5);
                                    continue;
                                    paramaxav.a(paramazml, (String)localObject2, "", i, (String)localObject6, null, 0, 1, 100, l3, b2, 0L, d, null, -100, j, k, m, n, i1, i5);
                                  }
                                  paramaxav = new TroopMemberInfo();
                                  paramaxav.troopuin = paramazml;
                                  paramaxav.memberuin = ((String)localObject2);
                                  switch (i6)
                                  {
                                  case 2: 
                                    label7356:
                                    localObject3 = bbos.b((String)localObject6);
                                    paramaxav.troopColorNick = ((String)localObject6);
                                    paramaxav.troopnick = ((String)localObject3);
                                    for (;;)
                                    {
                                      paramaxav.level = i;
                                      paramaxav.realLevel = i3;
                                      paramaxav.sex = 1;
                                      paramaxav.age = 0;
                                      paramaxav.distance = 100;
                                      paramaxav.msgseq = l3;
                                      if (b2 != 1) {
                                        break label8343;
                                      }
                                      paramBoolean = true;
                                      label7418:
                                      paramaxav.isTroopFollowed = paramBoolean;
                                      paramaxav.distanceToSelf = d;
                                      paramaxav.distanceToSelfUpdateTimeStamp = System.currentTimeMillis();
                                      break;
                                      paramaxav.troopnick = "";
                                      paramaxav.friendnick = ((String)localObject6);
                                    }
                                    i2 = i;
                                    if (i == 0)
                                    {
                                      ((bajo)localObject2).a(paramazml, ((MessageRecord)localObject3).uniseq);
                                      i2 = 1;
                                    }
                                    if (QLog.isColorLevel()) {
                                      QLog.d("TroopBindPublicAccountMgr.redDot", 2, "decodePBAccountMSg:" + paramazml + "," + ((MessageRecord)localObject3).uniseq + "," + ((MessageRecord)localObject3).shmsgseq);
                                    }
                                    ((bajo)localObject2).c(paramazml);
                                    break label8349;
                                    label7551:
                                    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.b(paramazml) != 3) {
                                      break label8356;
                                    }
                                    if (QLog.isColorLevel()) {
                                      QLog.d(".troop.closeRcvMsgTmp", 2, "Shield troop recv msg:" + paramazml);
                                    }
                                    ((akhp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(paramazml, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 0, 0);
                                    break label8356;
                                  }
                                  break;
                                }
    ...
    for (;;)
    {
      ...
      while (paramMsg.hasNext())
      {
        ...
        Object localObject1;
        paramArrayList.vipBubbleID = akfv.a((int)localObject1, i);
      ...
      bfnl.a().g(System.currentTimeMillis() - l5);
      return paramaxav;
      label7894:
      label8037:
      label8040:
  ...
  protected void a(MessageRecord paramMessageRecord)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(paramMessageRecord))
    {
      ...
      if (akpx.p(paramMessageRecord.msgtype))
      {
        akau localakau = new akau();
        localakau.b = 1000;
        localakau.c = 0;
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().notifyUI(5006, true, new Object[] { Long.valueOf(paramMessageRecord.uniseq), localakau });
      }
    }
  }
}
