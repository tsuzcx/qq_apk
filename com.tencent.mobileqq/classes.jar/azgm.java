...
public class azgm
  extends azgk
{
  public azgm(String paramString1, String paramString2, azgl paramazgl, int paramInt, Bundle paramBundle)
  {
    super(paramString1, paramString2, paramazgl, paramInt, paramBundle);
  }
  ...
  protected JSONObject a(HashMap<String, Object>... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramVarArgs = new JSONObject(mpl.a(paramVarArgs, this.a, this.b, (Bundle)localObject, localBundle));
      }
