...
{
  utj(uta paramuta, String paramString) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if (i == 0)
        {
          ...
          this.jdField_a_of_type_Uta.k = ((JSONObject)localObject2).optString("puin");
          if (i == -1)
          {
            paramInt = ((JSONObject)localObject2).optInt("refuseSec");
            if (paramInt > 0)
            {
              this.jdField_a_of_type_Uta.jdField_a_of_type_Boolean = true;
              this.jdField_a_of_type_Uta.jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(1000, paramInt * 1000);
            }
          }
          ...
          {
            localObject4 = uta.a(((Integer)((Iterator)localObject3).next()).intValue());
          ...
          Object localObject4 = (ArrayList)uta.b.get(this.jdField_a_of_type_JavaLangString);
          paramInt = 0;
          if (paramInt < ((ArrayList)localObject2).size())
          {
            String str = (String)uta.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt));
            if ((str != null) && (((Integer)((ArrayList)localObject2).get(paramInt)).intValue() == 1) && (uta.a((ArrayList)localObject4, str))) {
              ((ArrayList)localObject3).add(str);
            }
          }
          else
          {
            uta.jdField_a_of_type_JavaUtilMap.put(this.jdField_a_of_type_JavaLangString, localObject3);
            uta.b.remove(this.jdField_a_of_type_JavaLangString);
            localObject2 = new ArrayList();
            if (localObject4 != null)
            {
              ...
              {
                if (uta.a((ArrayList)localObject3, (String)((ArrayList)localObject4).get(paramInt))) {
                  break label583;
                }
        ...
        else
        {
          ...
          if (this.jdField_a_of_type_Uta.m != null) {
            this.jdField_a_of_type_Uta.callJs(this.jdField_a_of_type_Uta.m, new String[] { paramBundle });
          }
          return;
        }
      }
