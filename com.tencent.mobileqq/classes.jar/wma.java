...
public class wma
  extends wmg<HotRecommendFeedItem>
{
  public wma(@NonNull HotRecommendFeedItem paramHotRecommendFeedItem)
  {
    ...
    if (!this.c.isEmpty())
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (!TextUtils.isEmpty(localStoryVideoItem.mOwnerUid)) {
          localusd.b(localStoryVideoItem.mOwnerUid);
        }
      }
    }
  }
