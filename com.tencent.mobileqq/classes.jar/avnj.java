  ...
  implements Observer, Manager
{
  ...
  azjc jdField_a_of_type_Azjc = null;
  ...
  {
    bjmv.a(paramQQAppInterface, paramMessageRecord);
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          return;
          if (((bjni)paramQQAppInterface.getBusinessHandler(146)).a(paramString, paramInt1)) {
            break;
          }
        } while (!QLog.isColorLevel());
    ...
    for (;;)
    {
      ...
      if (paramInt1 == 1)
      {
        ...
        if ((!msm.d(BaseApplicationImpl.getApplication())) && ((!jdField_b_of_type_Boolean) || (paramBoolean)))
        {
  ...
  public void a(String paramString, int paramInt)
  {
    for (;;)
    {
      ...
      synchronized (jdField_a_of_type_ArrayOfByte)
      {
        ...
        int k = this.jdField_a_of_type_Azjc.c(localRecentBaseData.getRecentUserUin(), localRecentBaseData.getRecentUserType());
      ...
      {
        i = ((aiej)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(34)).d();
      }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, boolean paramBoolean1, int paramInt2, boolean paramBoolean2)
  {
    ...
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      ...
      if ((paramInt1 != 1001) || (aquz.b((MessageRecord)localObject3))) {
        break label2549;
      }
      ...
      paramQQAppInterface = akju.a(new RecentUser(paramString, paramInt1), paramQQAppInterface, paramQQAppInterface.getApp());
    ...
    label606:
    int j;
    if ((!bkwm.a(paramQQAppInterface)) && (paramInt1 == 7220) && (AppConstants.KANDIAN_MERGE_UIN.equals(paramString)))
    {
      ...
      if ((FriendsStatusUtil.a((String)localObject1, paramQQAppInterface)) || (afqy.a((String)localObject1, i, paramQQAppInterface))) {
        return false;
      }
      ...
      localObject2 = localanuz.getRecentList(true, false).iterator();
        ...
        if (paramString != null)
        {
          ...
          for (;;)
          {
            ...
            if ((localRecentBaseData.getRecentUserType() == 3000) || (localRecentBaseData.getRecentUserType() == 0) || (localRecentBaseData.getRecentUserType() == 8))
            {
              ...
              j = this.jdField_a_of_type_Azjc.c(localRecentBaseData.getRecentUserUin(), localRecentBaseData.getRecentUserType());
              if (!QLog.isColorLevel()) {
                break label2631;
              }
            ...
            if ((paramString == null) || (paramString.getType() != 1032) || (abwz.a(i) != 1032)) {
              break;
            }
            break label536;
            label1087:
            if (((azjc)paramQQAppInterface.getManager(38)).c((String)localObject1, i) != 0) {
              break label598;
            }
            return false;
            label1111:
            if (TextUtils.equals(localRecentBaseData.getRecentUserUin(), AppConstants.RECOMMEND_CONTACT_UIN))
            {
              if (((String)localObject1).equals(AppConstants.FRIEND_SYSTEM_MSG_UIN)) {
                ...
                paramInt1 = ((aiej)paramQQAppInterface.getManager(34)).d();
              }
            }
            ...
            else
            {
              ...
              {
                localObject4 = (aquh)paramQQAppInterface.getManager(71);
                if (localObject4 == null) {
                  break label2530;
                }
                paramInt1 = ((aquh)localObject4).a().a();
                break label2648;
              }
              if (TextUtils.equals(localRecentBaseData.getRecentUserUin(), AppConstants.PULL_ACTIVE_PUSH_UIN))
              {
                localObject4 = (avng)paramQQAppInterface.getManager(145);
                if (localObject4 == null) {
                  break label2651;
                }
                paramInt1 = ((avng)localObject4).a();
                break label2651;
              }
          ...
          if (paramString.uin.equals(AppConstants.LBS_HELLO_UIN))
          {
            ...
            paramString = akju.a(paramString, paramQQAppInterface, paramQQAppInterface.getApp());
          }
          for (;;)
          {
            label1355:
            ...
            if ((aiej.a(paramQQAppInterface, paramString.getRecentUserUin())) && (AppConstants.ACTIVATE_FRIENDS_UIN.equals(paramString.getRecentUserUin()))) {
            ...
            {
              localObject2 = (RecentBaseData)((Iterator)localObject1).next();
              if ((!aiej.a(paramQQAppInterface, ((RecentBaseData)localObject2).getRecentUserUin())) || (!aiej.a(paramQQAppInterface, paramString.getRecentUserUin()))) {
                break label2075;
              }
              jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(localObject2);
            ...
            if (paramString.uin.equals(AppConstants.RECOMMEND_CONTACT_UIN))
            {
              ...
              paramInt1 = ((aiej)paramQQAppInterface.getManager(34)).d();
              bcef.b(paramQQAppInterface, "dc00898", "", "", "0X80077D5", "0X80077D5", 0, 0, "", "", "", "");
              break;
            }
            ...
            if (!bcoo.a())
            {
              ...
              if (localObject3 != null)
              {
                ...
                if (((MessageRecord)localObject3).senderuin != null)
                {
                  ...
                  if (i == 1012)
                  {
                    paramString = (aquh)paramQQAppInterface.getManager(71);
                    if (paramString == null) {
                      break label2517;
                    }
                  ...
                  if (i == 1030)
                  {
                    paramString = (String)localObject2;
                    paramInt1 = j;
                    if (paramQQAppInterface.isCreateManager(240))
                    {
                      paramString = (apjz)paramQQAppInterface.getManager(240);
                  ...
                  else
                  {
                    ...
                    paramString = (avng)paramQQAppInterface.getManager(145);
                    paramInt1 = paramString.a();
                    paramString = paramString.a;
                  }
                }
    ...
    for (;;)
    {
      paramString = (String)localObject2;
      paramInt1 = j;
      if (!paramQQAppInterface.isCreateManager(284)) {
        break label1355;
      }
      paramString = (avnh)paramQQAppInterface.getManager(284);
      paramInt1 = 1;
      paramString = paramString.a();
      break label1355;
      label2429:
      do
      {
        localObject3 = (RecentUser)localanuz.findRecentUserByUin((String)localObject1, i);
        paramString = (String)localObject2;
        paramInt1 = j;
        if (localObject3 == null) {
          break label1355;
        }
        ((RecentUser)localObject3).lastmsgtime = bbko.a();
        localObject2 = akju.a((RecentUser)localObject3, paramQQAppInterface, paramQQAppInterface.getApp());
        paramString = (String)localObject2;
        paramInt1 = j;
        if (i != 8) {
          break label1355;
  ...
  {
    if (this.jdField_a_of_type_Aiej != null) {
      this.jdField_a_of_type_Aiej = null;
    }
    if (this.jdField_a_of_type_Azjc != null) {
      this.jdField_a_of_type_Azjc = null;
    }
  }
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    if ((paramObject != null) && ((paramObject instanceof aigo)))
    {
      ...
      if (bfyg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
        break label77;
      }
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        do
        {
          return;
          i = ((aiej)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(34)).d();
        } while ((TextUtils.isEmpty(((aigo)paramObject).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) || (((aigo)paramObject).a == 0L));
        if ((i != 0) && (!f)) {
          break;
        }
      } while (!QLog.isColorLevel());
      ...
      return;
      bool1 = SettingCloneUtil.readValue(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131693533), "qqsetting_lock_screen_whenexit_key", true);
      bool2 = SettingCloneUtil.readValue(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131717796), "qqsetting_notify_showcontent_key", true);
    } while ((!Boolean.valueOf(bool1).booleanValue()) || (!Boolean.valueOf(bool2).booleanValue()));
    a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, AppConstants.RECOMMEND_CONTACT_UIN, 4000, false, avnf.a(AppConstants.RECOMMEND_CONTACT_UIN, 4000, null));
  }
}
