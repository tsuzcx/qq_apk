...
public class ote
{
  public static JSONObject a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    {
      localObject1 = (prx)paramBaseArticleInfo.mTopicRecommendFeedsInfo.a.get(0);
      localObject2 = BaseApplicationImpl.getApplication().getResources();
      str = ((prx)localObject1).d;
    }
    for (Object localObject1 = String.format(((Resources)localObject2).getString(2131652755), new Object[] { bgmq.a(((prx)localObject1).b) });; localObject1 = null)
    {
      ...
      otl.a(paramBaseArticleInfo, localJSONObject, false);
