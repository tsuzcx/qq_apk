...
public class rsv
{
  ...
  private volatile rsy jdField_a_of_type_Rsy;
  private boolean jdField_a_of_type_Boolean;
  
  static
  {
    jdField_a_of_type_JavaLangString = "Q.readinjoy.video." + rsv.class.getSimpleName();
  }
  
  public rsv(Activity paramActivity, rsx paramrsx)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_AndroidViewOrientationEventListener = new rsw(this, paramActivity, new WeakReference(paramrsx));
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_Rsy.b();
      this.jdField_a_of_type_Rsy = null;
    }
  }
