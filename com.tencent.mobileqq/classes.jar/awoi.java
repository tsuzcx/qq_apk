  ...
  extends CrashHandler
{
  ...
  static
  {
    ...
    jdField_a_of_type_AndroidOsHandler = new awoj(Looper.getMainLooper());
    jdField_a_of_type_ComTencentMobileqqUtilsHttputilsIHttpCommunicatorListener = new awok();
  ...
  public static void a(Context paramContext, boolean paramBoolean)
  {
    ...
    try
    {
      jdField_a_of_type_JavaLangString = awol.a(paramContext, "/Tencent/MobileQQ/log/") + "/";
      awol.jdField_a_of_type_JavaLangString = paramContext.getPackageManager().getPackageInfo(paramContext.getPackageName(), 0).versionName;
      awol.jdField_b_of_type_JavaLangString = Build.MODEL;
      awol.c = Build.VERSION.RELEASE;
      return;
    }
  ...
  public static void a(com.tencent.mobileqq.utils.httputils.HttpCommunicator paramHttpCommunicator, Context paramContext, ProgressDialog paramProgressDialog, String paramString1, String paramString2)
  {
    ...
    //   20: return
    //   21: aload_2
    //   22: putstatic 147	awoi:jdField_a_of_type_AndroidAppProgressDialog	Landroid/app/ProgressDialog;
    //   25: new 76	java/lang/StringBuilder
    //   28: dup
    //   29: invokespecial 77	java/lang/StringBuilder:<init>	()V
    //   32: aload_1
    //   33: ldc 32
    //   35: invokestatic 82	awol:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   49: putstatic 34	awoi:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   52: new 149	java/io/File
    //   55: dup
    //   56: new 76	java/lang/StringBuilder
    //   59: dup
    //   60: invokespecial 77	java/lang/StringBuilder:<init>	()V
    //   63: getstatic 34	awoi:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   91: ldc 160
    //   93: iconst_1
    //   94: invokestatic 163	awoi:a	(Ljava/lang/String;Ljava/lang/String;Z)V
    //   97: iconst_1
    //   98: putstatic 165	awoi:jdField_a_of_type_Boolean	Z
    //   101: aload 9
    ...
    //   204: pop
    //   205: getstatic 198	awoi:jdField_b_of_type_ArrayOfByte	[B
    //   208: ifnonnull +178 -> 386
    //   211: ldc 200
    //   213: invokevirtual 24	java/lang/String:getBytes	()[B
    //   216: putstatic 198	awoi:jdField_b_of_type_ArrayOfByte	[B
    //   219: goto +167 -> 386
    ...
    //   256: aload_2
    //   257: getstatic 198	awoi:jdField_b_of_type_ArrayOfByte	[B
    ...
    //   275: aload_1
    //   276: getstatic 26	awoi:jdField_a_of_type_ArrayOfByte	[B
    ...
    //   305: dup
    //   306: getstatic 58	awoi:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   309: aload_2
    //   310: invokevirtual 248	KQQ/HttpUploadReq:toByteArray	()[B
    //   313: getstatic 54	awoi:jdField_a_of_type_ComTencentMobileqqUtilsHttputilsIHttpCommunicatorListener	Lcom/tencent/mobileqq/utils/httputils/IHttpCommunicatorListener;
    ...
    //   320: aload_1
    //   321: ldc 253
    //   323: invokevirtual 256	com/tencent/mobileqq/utils/httputils/HttpMsg:setRequestMethod	(Ljava/lang/String;)V
    //   326: aload_0
    //   327: aload_1
    //   328: invokevirtual 262	com/tencent/mobileqq/utils/httputils/HttpCommunicator:sendMsg	(Lcom/tencent/mobileqq/utils/httputils/HttpMsg;)I
    //   331: pop
    //   332: iconst_0
    //   333: putstatic 165	awoi:jdField_a_of_type_Boolean	Z
    //   336: iconst_0
    //   337: ifeq -317 -> 20
    //   340: new 264	java/lang/NullPointerException
    //   343: dup
    //   344: invokespecial 265	java/lang/NullPointerException:<init>	()V
    //   347: athrow
    //   348: astore_0
    //   349: aload_0
  ...
  {
    awol.a(paramString1, paramString2, paramBoolean);
  }
  
  private boolean a(Throwable paramThrowable)
  {
    boolean bool = true;
    if ((paramThrowable == null) || (1 != BaseApplicationImpl.sProcessId) || (System.currentTimeMillis() - StatisticCollector.sRdmInitTime > 600000L)) {}
    Object localObject2;
    do
    {
      return false;
  ...
  public void uncaughtException(Thread paramThread, Throwable paramThrowable)
  {
    ...
    if (a(paramThrowable))
    {
      aauu.a(anvx.a(2131712874));
      StatisticCollector.sCatchedNotExit = true;
      bdjw.a(new Throwable(paramThrowable), "notExitOnSafeMode");
    ...
    try
    {
      awol.jdField_a_of_type_JavaLangString = paramThread.getPackageManager().getPackageInfo(paramThread.getPackageName(), 0).versionName;
      awol.jdField_b_of_type_JavaLangString = Build.MODEL;
      awol.c = Build.VERSION.RELEASE;
      label295:
      paramThread.crashed();
