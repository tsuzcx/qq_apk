...
public class awoi
  extends amcd
{
  public awoi(CustomCoverFragment paramCustomCoverFragment) {}
  ...
  public void e(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          QQToast.a(this.a.getActivity(), 1, 2131721096, 0).a();
          return;
        ...
        QQToast.a((Context)localObject, 0, 2131721099, 0).a();
    ...
    if ("profilelogic.readUserInfo".equals(paramObject))
    {
      ...
      this.a.stopTitleProgress();
      QQToast.a((Context)localObject, 1, 2131720801, 0).a();
      return;
    }
    QQToast.a((Context)localObject, 1, 2131721096, 0).a();
  }
}
