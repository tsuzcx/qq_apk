...
public class amom
{
  public static final String a = ajya.a(2131715285);
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          String[] arrayOfString = bbex.a(localObject2[i], "=");
          ...
          localObject2 = new String(bbco.decode(arrayOfString[1], 0));
          localObject1 = localObject2;
          if (!((String)localObject2).contains("&gc=")) {
            localObject1 = String.format("%s&gc=%s", new Object[] { localObject2, atbp.a(paramString2) });
          }
          paramString2 = bbco.encodeToString(((String)localObject1).getBytes(), 2);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, String paramString1, int paramInt2, String paramString2, String paramString3)
  {
    for (;;)
    {
      ...
      localStringBuilder.append("&").append("quin").append("=").append(atbp.a(paramString1));
      localStringBuilder.append("&").append("topicId").append("=").append(paramInt2);
      localStringBuilder.append("&").append("sUin").append("=").append(atbp.a(paramString2));
      localStringBuilder.append("&").append("rUin").append("=").append(atbp.a(paramString3));
      ...
      return;
      localObject = ((amnj)localObject).o;
      continue;
      str = "aio_card_insert";
    }
  }
          ...
          for (;;)
          {
            ...
            catch (InvalidProtocolBufferMicroException paramStringBuilder)
            {
              try
              {
                ...
                paramList = (MessageForTroopConfess)axas.a(-2067);
  ...
  public static Object[] a(String paramString)
  {
    ...
    for (Object localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();; localObject1 = null)
    {
      ...
      if (localObject2 != null)
      {
        ...
        if (localObject2 != null) {
          if (bbbr.a(str, ((TroopInfo)localObject2).troopowneruin))
          {
            i = 2;
      ...
      for (;;)
      {
        ...
        if (localObject1 != null)
        {
          paramString = ((aukp)localObject1).a(TroopMemberInfo.class, false, "troopuin=? ", new String[] { paramString }, null, null, null, null);
          ((aukp)localObject1).a();
        }
        for (;;)
        {
          ...
          if (paramString != null)
          {
            ...
            for (;;)
            {
              ...
              if (bbbr.d(((TroopMemberInfo)localObject1).memberuin)) {
  ...
  {
    boolean bool2 = false;
    paramMessageRecord = bajp.a(paramMessageRecord);
    boolean bool1 = bool2;
