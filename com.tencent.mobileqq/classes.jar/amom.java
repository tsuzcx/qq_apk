  ...
  implements View.OnClickListener
{
  ...
  protected Context a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new amon(this);
  protected anyw a;
  protected bhhm a;
  ...
  public amom(Context paramContext, ExpandableListView paramExpandableListView, QQAppInterface paramQQAppInterface, List<Entity> paramList, amop paramamop, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Amop = paramamop;
    this.jdField_a_of_type_Boolean = paramBoolean;
    this.jdField_a_of_type_Float = paramContext.getResources().getDisplayMetrics().density;
    this.jdField_a_of_type_Bhhm = new bhhm(paramContext);
    this.jdField_a_of_type_Bhhm.a((int)(this.jdField_a_of_type_Float * 100.0F), (int)(this.jdField_a_of_type_Float * 100.0F));
    a(paramList, false);
  ...
  private ArrayList<Entity> a(List<RecentUser> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localRecentUser != null) && (!bhjx.a(localRecentUser.uin)) && (localRecentUser.getType() == 0) && (!bhjx.c(localRecentUser.uin)) && (this.jdField_a_of_type_Anyw != null) && (this.jdField_a_of_type_Anyw.b(localRecentUser.uin))) {
        localArrayList.add(this.jdField_a_of_type_Anyw.e(localRecentUser.uin));
      }
    }
    ...
    if ((((PhoneContactManagerImp)localObject1).d()) || (i == 8))
    {
      ...
      if (localObject2 != null)
      {
        ...
        if (!((ArrayList)localObject1).isEmpty())
        {
          ...
          ((Groups)localObject2).group_name = this.jdField_a_of_type_AndroidContentContext.getString(2131694264);
  ...
  {
    amoo localamoo = (amoo)paramView.getTag();
    if (localamoo == null)
    {
      localamoo = new amoo();
      localamoo.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367726));
      localamoo.b = ((TextView)paramView.findViewById(2131364983));
      paramView.findViewById(2131369210).setVisibility(0);
      paramView.setTag(localamoo);
    }
    for (;;)
    {
      Groups localGroups = (Groups)getGroup(paramInt);
      localamoo.jdField_a_of_type_AndroidWidgetTextView.setText(localGroups.group_name);
      localamoo.b.setText(String.valueOf(localGroups.group_friend_count));
      ((CheckBox)paramView.findViewById(2131369210)).setChecked(this.jdField_a_of_type_ComTencentWidgetExpandableListView.c(paramInt));
      return;
    }
  }
  ...
  public void a(List<Entity> paramList, boolean paramBoolean)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      for (;;)
      {
        ...
        break label94;
        Object localObject = ((anyw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).a(String.valueOf(localGroups.group_id));
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      for (paramViewGroup.jdField_c_of_type_Int = 11;; paramViewGroup.jdField_c_of_type_Int = 1)
      {
        ...
        paramBoolean = this.jdField_a_of_type_Amop.a(paramView, paramInt1);
        boolean bool = bgpy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView);
        ...
        paramViewGroup = (amoq)localForwardRecentItemView.getTag();
        break;
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558947, paramViewGroup, false);
      paramViewGroup = new amoo();
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367726));
      paramViewGroup.b = ((TextView)paramView.findViewById(2131364983));
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (amoo)paramView.getTag();
    }
  }
  ...
  {
    amoo localamoo = (amoo)paramView.getTag();
    if (this.jdField_a_of_type_ComTencentWidgetExpandableListView.c(localamoo.jdField_a_of_type_Int)) {
      this.jdField_a_of_type_ComTencentWidgetExpandableListView.b(localamoo.jdField_a_of_type_Int);
    }
    for (;;)
    {
      EventCollector.getInstance().onViewClicked(paramView);
      return;
      this.jdField_a_of_type_ComTencentWidgetExpandableListView.a(localamoo.jdField_a_of_type_Int);
    }
  }
}
