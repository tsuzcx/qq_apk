  ...
  implements Manager
{
  ...
  public auac(QQAppInterface paramQQAppInterface)
  {
  ...
  private boolean a(awgf paramawgf, awge paramawge)
  {
    boolean bool = false;
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        try
        {
          ...
          List localList = localawgf.a(ShieldListInfo.class);
          int i;
          if (localList == null)
          {
            i = 0;
  ...
  {
    amcl localamcl = (amcl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(18);
    ...
    localamcl.a(paramInt1, arrayOfLong, paramInt2);
  }
  ...
  public boolean a(List<ShieldListInfo> paramList)
  {
    ...
    for (;;)
    {
        ...
        try
        {
          ...
          if ((localShieldListInfo2 != null) && ((localShieldListInfo2.getStatus() == 1001) || (localShieldListInfo2.getStatus() == 1002))) {
            if (localShieldListInfo1.flags != localShieldListInfo2.flags)
            {
              ...
              a(localawgf, localShieldListInfo2);
            }
          }
        }
      ...
      a(localawgf, localShieldListInfo1);
  ...
  public void b(int paramInt1, List<Long> paramList, int paramInt2)
  {
    ...
    localamcl.b(paramInt1, arrayOfLong, paramInt2);
  }
