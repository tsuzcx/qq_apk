...
{
  auac(atzu paramatzu, auah paramauah) {}
  ...
  public void a(WeiyunPB.CrossBidProxyCopyFileToOtherBidMsgRsp paramCrossBidProxyCopyFileToOtherBidMsgRsp)
  {
    ...
    if (paramCrossBidProxyCopyFileToOtherBidMsgRsp.length() < 1)
    {
      ...
      if (this.jdField_a_of_type_Auah != null) {
        this.jdField_a_of_type_Auah.a(-3, "copyFileToOtherBid_fail");
      }
    }
    do
    {
    ...
    } while (this.jdField_a_of_type_Auah == null);
    this.jdField_a_of_type_Auah.a(paramCrossBidProxyCopyFileToOtherBidMsgRsp);
  }
}
