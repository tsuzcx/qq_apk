...
public class bbxj
{
  ...
  private static final String jdField_a_of_type_JavaLangString = AppConstants.SDCARD_PATH + "early";
  ...
  {
    return bljn.jdField_a_of_type_JavaLangString;
  }
  ...
  /* Error */
  public static boolean a(blvp paramblvp)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore_2
    //   2: ldc 2
    //   4: monitorenter
    //   5: invokestatic 161	bbxj:a	()Z
    //   8: istore_3
    //   9: iload_3
    //   10: ifeq +71 -> 81
    //   13: invokestatic 166	blvn:a	()Lblvn;
    //   16: getstatic 172	dov/com/qq/im/ae/download/AEResInfo:AE_RES_ADDITIONAL_PACKAGE	Ldov/com/qq/im/ae/download/AEResInfo;
    //   19: aload_0
    //   20: iconst_0
    //   21: invokevirtual 175	blvn:a	(Ldov/com/qq/im/ae/download/AEResInfo;Lblvp;Z)V
    //   24: getstatic 172	dov/com/qq/im/ae/download/AEResInfo:AE_RES_ADDITIONAL_PACKAGE	Ldov/com/qq/im/ae/download/AEResInfo;
    //   27: invokestatic 181	dov/com/qq/im/ae/download/AEResUtil:isAEResExist	(Ldov/com/qq/im/ae/download/AEResInfo;)Z
    //   30: istore_1
    //   31: invokestatic 104	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   34: ifeq +42 -> 76
    //   37: ldc 183
    //   39: iconst_2
    ...
    //   52: iload_1
    //   53: invokevirtual 188	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   56: ldc 190
    //   58: invokevirtual 38	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   61: iload_3
    //   62: invokevirtual 188	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   65: ldc 192
    //   67: invokevirtual 38	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   70: invokevirtual 44	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   73: invokestatic 195	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   76: ldc 2
    //   78: monitorexit
    //   79: iload_1
    //   80: ireturn
    ...
    //   84: ifnull -53 -> 31
    //   87: aload_0
    //   88: getstatic 172	dov/com/qq/im/ae/download/AEResInfo:AE_RES_ADDITIONAL_PACKAGE	Ldov/com/qq/im/ae/download/AEResInfo;
    //   91: aconst_null
    //   92: iconst_0
    //   93: iconst_m1
    //   94: invokeinterface 201 5 0
    //   99: iload_2
    //   100: istore_1
    //   101: goto -70 -> 31
    //   104: astore_0
  ...
  /* Error */
  public static boolean a(QQAppInterface paramQQAppInterface, Context paramContext, blvp paramblvp)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 4
    //   3: ldc 2
    //   5: monitorenter
    //   6: invokestatic 161	bbxj:a	()Z
    //   9: istore 5
    //   11: iload 5
    //   13: ifeq +77 -> 90
    //   16: invokestatic 166	blvn:a	()Lblvn;
    //   19: getstatic 208	dov/com/qq/im/ae/download/AEResInfo:AE_RES_BASE_PACKAGE	Ldov/com/qq/im/ae/download/AEResInfo;
    //   22: aload_2
    //   23: iconst_0
    //   24: invokevirtual 175	blvn:a	(Ldov/com/qq/im/ae/download/AEResInfo;Lblvp;Z)V
    //   27: aload_0
    //   28: invokestatic 213	bbqy:a	(Lcom/tencent/mobileqq/app/QQAppInterface;)Z
    //   31: pop
    //   32: getstatic 208	dov/com/qq/im/ae/download/AEResInfo:AE_RES_BASE_PACKAGE	Ldov/com/qq/im/ae/download/AEResInfo;
    //   35: invokestatic 181	dov/com/qq/im/ae/download/AEResUtil:isAEResExist	(Ldov/com/qq/im/ae/download/AEResInfo;)Z
    //   38: istore_3
    //   39: invokestatic 104	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   42: ifeq +43 -> 85
    //   45: ldc 183
    //   47: iconst_2
    //   48: new 28	java/lang/StringBuilder
    //   51: dup
    //   52: invokespecial 29	java/lang/StringBuilder:<init>	()V
    //   55: ldc 215
    //   57: invokevirtual 38	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   60: iload_3
    //   61: invokevirtual 188	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   64: ldc 190
    //   66: invokevirtual 38	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   69: iload 5
    //   71: invokevirtual 188	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   74: ldc 192
    ...
    //   82: invokestatic 195	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   85: ldc 2
    //   87: monitorexit
    //   88: iload_3
    //   89: ireturn
    ...
    //   94: ifnull -55 -> 39
    //   97: aload_2
    //   98: getstatic 208	dov/com/qq/im/ae/download/AEResInfo:AE_RES_BASE_PACKAGE	Ldov/com/qq/im/ae/download/AEResInfo;
    //   101: aconst_null
    //   102: iconst_0
    //   103: iconst_m1
    //   104: invokeinterface 201 5 0
    //   109: iload 4
    //   111: istore_3
    //   112: goto -73 -> 39
    //   115: astore_0
  ...
  public static String b()
  {
    ...
    return bbqc.b() + str + File.separator;
  }
  
  public static boolean b()
  {
    boolean bool1 = AEResUtil.isAEBaseSoReady();
  ...
  public static String c()
  {
    ...
    return bbro.b() + str + File.separator;
  }
