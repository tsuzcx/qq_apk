...
public class beii
{
  public static final LruCache<String, beii> a;
  public static final AtomicInteger c = new AtomicInteger(1);
  public String a;
  public final CopyOnWriteArrayList<beil> a;
  ...
  /* Error */
  public static beii a(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   60: astore_0
    //   61: aload_0
    //   62: invokestatic 90	beii:b	(Ljava/lang/String;)Lbeii;
    //   65: astore_2
    //   66: goto -52 -> 14
    //   69: astore_0
    //   70: aload_0
  ...
  public static beii b(String paramString)
  {
    ...
    try
    {
      ...
      {
        beii localbeii = (beii)jdField_a_of_type_AndroidSupportV4UtilLruCache.get(paramString);
        localObject = localbeii;
        if (localbeii == null)
        {
          localObject = new beii(paramString);
  ...
  public void a(beil parambeil, String paramString)
  {
    if ((this.b.get() == 3) && (parambeil != null))
    {
      ...
      parambeil.onCheckOfflineFinish(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get());
    }
    do
    {
      return;
      if ((parambeil != null) && (!this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(parambeil))) {
        this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(parambeil);
      }
      parambeil = new SwiftBrowserOfflineHandler.1(this, paramString);
    ...
    ThreadManager.postImmediately(parambeil, new beik(this), false);
  }
  ...
  public void b()
  {
    ...
    {
      localObject1 = this.jdField_a_of_type_Myl.a("ex_offline", "");
