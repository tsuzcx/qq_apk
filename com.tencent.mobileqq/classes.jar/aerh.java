  ...
  extends aepy
{
  ...
  private aelt jdField_a_of_type_Aelt;
  ...
  public aerh(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Aelt == null);
      localDrawable = this.jdField_a_of_type_Aelt.jdField_a_of_type_AndroidViewView.getBackground();
    } while (!(localDrawable instanceof anty));
    antl localantl;
    if (this.jdField_a_of_type_Aelt.jdField_a_of_type_Ansf != null)
    {
      localantl = this.jdField_a_of_type_Aelt.jdField_a_of_type_Ansf.a;
      label62:
      if ((localantl != null) && (((this.jdField_a_of_type_Ansg != null) && (this.jdField_a_of_type_Ansg.jdField_a_of_type_Anrz.jdField_b_of_type_Boolean)) || ((this.jdField_b_of_type_Ansg != null) && (this.jdField_b_of_type_Ansg.jdField_a_of_type_Anrz.jdField_b_of_type_Boolean))))
      {
        if (!paramBoolean1) {
          break label172;
        }
        ((anty)localDrawable).c(true);
      }
    }
    for (;;)
    {
      if (paramBoolean2) {
        ((anty)localDrawable).a(paramBoolean1);
      }
  ...
  protected boolean a()
  {
    ...
    this.jdField_a_of_type_Aelt = null;
    int i = aekt.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
    Object localObject = aekt.a(aekt.a(this.jdField_a_of_type_ComTencentWidgetListView, i));
    boolean bool1;
    label371:
    boolean bool2;
    if ((localObject != null) && ((localObject instanceof aelt)))
    {
      this.jdField_a_of_type_Aelt = ((aelt)localObject);
      if ((this.jdField_b_of_type_Int != 0) && ((this.jdField_a_of_type_Aelt == null) || (this.jdField_a_of_type_Aelt.jdField_a_of_type_AndroidViewView == null) || (this.jdField_a_of_type_Aelt.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout == null))) {
        e();
      }
      if ((this.jdField_a_of_type_Aelt == null) || (this.jdField_b_of_type_AndroidViewView == null) || (this.jdField_a_of_type_Ansg == null)) {
        break label1455;
      }
      this.jdField_a_of_type_AndroidGraphicsRect.top = (this.jdField_a_of_type_Aelt.jdField_a_of_type_AndroidViewView.getTop() + this.jdField_a_of_type_Aelt.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY());
      this.jdField_a_of_type_AndroidGraphicsRect.left = (this.jdField_a_of_type_Aelt.jdField_a_of_type_AndroidViewView.getLeft() + this.jdField_a_of_type_Aelt.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getLeft());
      this.jdField_a_of_type_AndroidGraphicsRect.bottom = (this.jdField_a_of_type_Aelt.jdField_a_of_type_AndroidViewView.getBottom() + this.jdField_a_of_type_Aelt.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY());
      this.jdField_a_of_type_AndroidGraphicsRect.right = (this.jdField_a_of_type_Aelt.jdField_a_of_type_AndroidViewView.getRight() + this.jdField_a_of_type_Aelt.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getLeft());
      if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_Aelt.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend()) {
        break label538;
      }
      bool1 = true;
      if ((this.jdField_a_of_type_Ansg == null) || (this.jdField_a_of_type_Ansg.jdField_a_of_type_Anrz == null) || (this.jdField_a_of_type_Ansg.jdField_a_of_type_Anrz.c)) {
        break label544;
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimVipPngPlayAnimationDrawable.c = false;
      label409:
      if (this.jdField_b_of_type_Ansg != null)
      {
        if (!this.jdField_a_of_type_Ansg.jdField_b_of_type_JavaLangString.equals(this.jdField_b_of_type_Ansg.jdField_b_of_type_JavaLangString)) {
          break label562;
        }
    ...
    label562:
    label574:
    localObject = a(this.jdField_a_of_type_Ansg.d, this.jdField_a_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.right, this.jdField_a_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.bottom, bool1);
    i = localObject[1];
    int n = this.jdField_a_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.top + i;
    int k;
    int j;
    int m;
    if (!bool1)
    {
      i = localObject[0];
      i = this.jdField_a_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.left + i;
      k = i;
      if (this.jdField_b_of_type_Ansg == null) {
        break label1489;
      }
      localObject = a(this.jdField_b_of_type_Ansg.d, this.jdField_b_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.right, this.jdField_b_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.bottom, bool1);
      j = localObject[0] - this.jdField_b_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.left - this.jdField_b_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.right;
      m = localObject[1] + this.jdField_b_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.top;
      k = i;
      i = m;
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.d("XBubbleAnimation", 2, "bindView mView master_x=" + k + ",master_y=" + n + ",mAttrsFirst.mRect.right=" + this.jdField_a_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.right + ",mAttrsFirst.mRect.bottom=" + this.jdField_a_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.bottom + ",listview.Width=" + this.jdField_a_of_type_ComTencentWidgetListView.getWidth() + ",listview.Height=" + this.jdField_a_of_type_ComTencentWidgetListView.getHeight());
      }
      if ((k >= -this.jdField_a_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.right) && (k <= this.jdField_a_of_type_ComTencentWidgetListView.getWidth()) && (n >= -this.jdField_a_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.bottom))
      {
      ...
      {
        if ((this.jdField_b_of_type_Ansg != null) && (this.jdField_a_of_type_AndroidViewView != null) && (bool1))
        {
          if (QLog.isColorLevel()) {
            QLog.d("XBubbleAnimation", 2, "bindView mLinkView x=" + j + ",y=" + i + ",mRect.right=" + this.jdField_b_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.right + ",mRect.bottom=" + this.jdField_b_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.bottom + ",listview.Width=" + this.jdField_a_of_type_ComTencentWidgetListView.getWidth() + ",listview.Height=" + this.jdField_a_of_type_ComTencentWidgetListView.getHeight());
          }
          if ((j < -this.jdField_b_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.right) || (j > this.jdField_a_of_type_ComTencentWidgetListView.getWidth()) || (i < -this.jdField_b_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.bottom)) {
            break;
          }
          ...
          {
            return true;
            m = localObject[0] - this.jdField_a_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.left - this.jdField_a_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.right;
            k = m;
            if (this.jdField_b_of_type_Ansg == null) {
              break label1489;
            }
            localObject = a(this.jdField_b_of_type_Ansg.d, this.jdField_b_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.right, this.jdField_b_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.bottom, bool1);
            j = localObject[0] + this.jdField_b_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.left;
            i = localObject[1] + this.jdField_b_of_type_Ansg.jdField_a_of_type_AndroidGraphicsRect.top;
            k = m;
            break;
            if (!QLog.isColorLevel()) {
              break label990;
  ...
  public boolean b(Object[] paramArrayOfObject)
  {
    ...
    if ((((Long)paramArrayOfObject[1]).longValue() != this.jdField_a_of_type_Long) || (this.jdField_b_of_type_Int != i))
    {
      ...
      if ((paramArrayOfObject == null) || (paramArrayOfObject.first == null) || (((ansg)paramArrayOfObject.first).jdField_a_of_type_ArrayOfJavaLangString == null)) {
        return false;
      }
      this.jdField_a_of_type_Ansg = ((ansg)paramArrayOfObject.first);
      this.jdField_b_of_type_Ansg = ((ansg)paramArrayOfObject.second);
      try
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimVipPngPlayAnimationDrawable.a(this.jdField_a_of_type_Ansg.jdField_a_of_type_ArrayOfJavaLangString);
        if ((this.jdField_b_of_type_Ansg != null) && (this.jdField_b_of_type_Ansg.jdField_a_of_type_ArrayOfJavaLangString != null)) {
          this.jdField_b_of_type_ComTencentMobileqqActivityAioAnimVipPngPlayAnimationDrawable.a(this.jdField_b_of_type_Ansg.jdField_a_of_type_ArrayOfJavaLangString);
        }
        return true;
      }
  ...
  public boolean c(Object[] paramArrayOfObject)
  {
    ...
    do
    {
      ...
      i = aekt.a(l, this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
      localObject = aekt.a(aekt.a(this.jdField_a_of_type_ComTencentWidgetListView, i));
      if ((localObject == null) || (!(localObject instanceof aelt))) {
        break;
      }
      this.jdField_a_of_type_Aelt = ((aelt)localObject);
      ...
      paramArrayOfObject = (Pair)paramArrayOfObject[2];
    } while ((paramArrayOfObject == null) || (paramArrayOfObject.first == null) || (((ansg)paramArrayOfObject.first).jdField_a_of_type_ArrayOfJavaLangString == null));
    e();
    this.jdField_a_of_type_Long = l;
    this.jdField_b_of_type_Int = j;
    this.jdField_a_of_type_Ansg = ((ansg)paramArrayOfObject.first);
    this.jdField_b_of_type_Ansg = ((ansg)paramArrayOfObject.second);
    this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimVipPngPlayAnimationDrawable.a(this.jdField_a_of_type_Ansg.jdField_a_of_type_ArrayOfJavaLangString, this.jdField_a_of_type_Ansg.c);
    label258:
    label392:
    boolean bool;
    if (j != 0)
    {
      ...
      if (this.jdField_a_of_type_Ansg.jdField_a_of_type_Boolean)
      {
        i = 1;
    ...
    {
      this.jdField_b_of_type_AndroidViewView = new aeri(this, this.jdField_a_of_type_ComTencentWidgetListView.getContext());
      ...
      if ((this.jdField_b_of_type_Ansg != null) && (this.jdField_b_of_type_Ansg.jdField_a_of_type_ArrayOfJavaLangString != null))
      {
        this.jdField_b_of_type_ComTencentMobileqqActivityAioAnimVipPngPlayAnimationDrawable.a(this.jdField_b_of_type_Ansg.jdField_a_of_type_ArrayOfJavaLangString, this.jdField_b_of_type_Ansg.c);
        if (j != 0)
        {
          paramArrayOfObject = this.jdField_b_of_type_ComTencentMobileqqActivityAioAnimVipPngPlayAnimationDrawable;
          if (!this.jdField_b_of_type_Ansg.jdField_a_of_type_Boolean) {
            break label521;
          }
          i = 1;
          paramArrayOfObject.f = i;
        }
        this.jdField_a_of_type_AndroidViewView = new aerj(this, this.jdField_a_of_type_ComTencentWidgetListView.getContext());
    ...
    for (;;)
    {
      ...
      break;
      i = this.jdField_a_of_type_Ansg.jdField_b_of_type_Int;
      break label258;
      label521:
      i = this.jdField_b_of_type_Ansg.jdField_b_of_type_Int;
      break label392;
      label532:
      bool = false;
    }
