  ...
  implements Serializable
{
  ...
  private static NewListType[] a = new NewListType[9];
  ...
  public static NewListType convert(int paramInt)
  {
    ...
    for (;;)
    {
      NewListType[] arrayOfNewListType = a;
      if (i >= arrayOfNewListType.length) {
        break;
      }
      if (arrayOfNewListType[i].value() == paramInt) {
        return a[i];
      }
      i += 1;
    }
  ...
  public static NewListType convert(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (arrayOfNewListType[i].toString().equals(paramString)) {
        return a[i];
      }
      i += 1;
    }
