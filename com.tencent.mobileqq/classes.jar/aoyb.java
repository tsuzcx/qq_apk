  ...
  implements DialogInterface.OnDismissListener, Handler.Callback, DownloadListener
{
  ...
  final MqqHandler jdField_a_of_type_MqqOsMqqHandler = new bfmt(Looper.getMainLooper(), this, true);
  ...
  public aoyb(AppInterface paramAppInterface, Activity paramActivity, TouchWebView paramTouchWebView)
  {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidAppDialog == null)
      {
        ...
        this.jdField_a_of_type_AndroidAppDialog.setContentView(2131561447);
        this.jdField_a_of_type_AndroidAppDialog.findViewById(2131363153).setBackgroundColor(0);
        ((TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131377030)).setText(ajyc.a(2131715888));
      }
  ...
  public void onDownloadStart(String paramString1, String paramString2, String paramString3, String paramString4, long paramLong)
  {
      ...
      for (;;)
      {
        ...
        if ("application/vnd.android.package-archive".equals(paramString4))
        {
          ...
          try
          {
            ...
            paramString3 = new NewIntent(localActivity.getApplicationContext(), arpb.class);
            paramString3.putExtra("extra_cmd", "QQApkSvc.check_download_url");
            paramString3.putExtra("extra_data", paramString2.toByteArray());
            paramString3.setObserver(new aoyc(this, paramString1, paramLong, bool));
    ...
    } while ((!aoxz.a(localActivity, paramString1, (Bundle)localObject2)) || (!bool));
