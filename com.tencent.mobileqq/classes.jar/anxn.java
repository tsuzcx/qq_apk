  ...
  extends BusinessHandler
{
  ...
  public anxn(QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramRspBody.main.has())
    {
      ...
      if (paramFromServiceMsg.item.has())
      {
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          anxw localanxw = new anxw();
          if (((oidb_cmd0xc76.Item)localObject4).id.has()) {
            localanxw.a(((oidb_cmd0xc76.Item)localObject4).id.get());
          }
          if (((oidb_cmd0xc76.Item)localObject4).icon.has()) {
            localanxw.b(((oidb_cmd0xc76.Item)localObject4).icon.get());
          }
          if (((oidb_cmd0xc76.Item)localObject4).type.has()) {
            localanxw.a(((oidb_cmd0xc76.Item)localObject4).type.get());
          }
          if (((oidb_cmd0xc76.Item)localObject4).name.has()) {
            localanxw.a(((oidb_cmd0xc76.Item)localObject4).name.get());
          }
          if (((oidb_cmd0xc76.Item)localObject4).value.has()) {
            localanxw.b(((oidb_cmd0xc76.Item)localObject4).value.get());
          }
          ((List)localObject1).add(localanxw.a());
        }
      }
      ((anxx)localObject2).jdField_a_of_type_JavaUtilList = ((List)localObject1);
      if (paramFromServiceMsg.desc.has()) {
        ((anxx)localObject2).jdField_a_of_type_JavaLangString = paramFromServiceMsg.desc.get();
      }
    ...
    if (paramRspBody.apps.has())
    {
      ...
      if (paramRspBody.item.has())
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          localObject4 = new anxw();
          if (((oidb_cmd0xc76.Item)localObject3).id.has()) {
            ((anxw)localObject4).a(((oidb_cmd0xc76.Item)localObject3).id.get());
          }
          if (((oidb_cmd0xc76.Item)localObject3).icon.has()) {
            ((anxw)localObject4).b(((oidb_cmd0xc76.Item)localObject3).icon.get());
          }
          if (((oidb_cmd0xc76.Item)localObject3).type.has()) {
            ((anxw)localObject4).a(((oidb_cmd0xc76.Item)localObject3).type.get());
          }
          if (((oidb_cmd0xc76.Item)localObject3).name.has()) {
            ((anxw)localObject4).a(((oidb_cmd0xc76.Item)localObject3).name.get());
          }
          if (((oidb_cmd0xc76.Item)localObject3).value.has()) {
            ((anxw)localObject4).b(((oidb_cmd0xc76.Item)localObject3).value.get());
          }
          paramFromServiceMsg.add(((anxw)localObject4).a());
        }
      }
      ((anxx)localObject1).jdField_a_of_type_JavaUtilList = paramFromServiceMsg;
      if (paramRspBody.desc.has()) {
        ((anxx)localObject1).jdField_a_of_type_JavaLangString = paramRspBody.desc.get();
      }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   193: istore 4
    //   195: aload_0
    //   196: getfield 447	anxn:mApp	Lcom/tencent/common/app/AppInterface;
    //   199: sipush 315
    //   202: invokevirtual 453	com/tencent/common/app/AppInterface:getManager	(I)Lmqq/manager/Manager;
    //   205: checkcast 455	akhg
    //   208: aload_1
    //   209: iload 4
    //   211: invokevirtual 458	akhg:a	(Ljava/lang/String;I)V
    //   214: aload_2
    ...
    //   495: iconst_1
    //   496: aload_2
    //   497: invokevirtual 358	anxn:notifyUI	(IZLjava/lang/Object;)V
    //   500: aload_0
    //   501: iconst_1
    //   502: iconst_0
    //   503: aconst_null
    //   504: invokevirtual 358	anxn:notifyUI	(IZLjava/lang/Object;)V
    //   507: return
    //   508: aload_0
    //   509: iconst_1
    //   510: iconst_0
    //   511: aconst_null
    //   512: invokevirtual 358	anxn:notifyUI	(IZLjava/lang/Object;)V
    //   515: return
    //   516: aconst_null
    //   517: astore_1
    //   518: goto -261 -> 257
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
    anxw localanxw = new anxw();
    localanxw.a(paramString2);
    localanxw.a(paramString1);
    localanxw.b(paramInt);
    localArrayList.add(localanxw.a());
