...
public class bfzo
{
  ...
  private bfzr jdField_a_of_type_Bfzr;
  ...
  public bfzo(int paramInt, float paramFloat)
  {
    a();
  ...
  private void a(View paramView, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Bfzt.a(localViewHolder);
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_Bfzu = new bfzu(this, null);
    this.jdField_a_of_type_Bfzr = new bfzr(this, null);
    this.jdField_a_of_type_Bfzs = new bfzs(this, null);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnScrollListener(this.jdField_a_of_type_Bfzu);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.setOnFlingListener(this.jdField_a_of_type_Bfzu);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnLayoutChangeListener(this.jdField_a_of_type_Bfzr);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnLayoutChangeListener(this.jdField_a_of_type_Bfzs);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.getAdapter().registerAdapterDataObserver(new bfzp(this));
  }
  
  private void f()
  {
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.removeOnScrollListener(this.jdField_a_of_type_Bfzu);
  ...
  {
    return new bfzq(this, this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.getContext(), paramLinearLayoutManager);
  }
  ...
  {
    this.jdField_a_of_type_Bfzt = parambfzt;
  }
