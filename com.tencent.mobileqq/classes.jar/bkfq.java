...
public class bkfq
{
  ...
  public bkfq()
  {
    this.jdField_a_of_type_Bkfr = new bkfr();
  }
  
  public bkfq(JSONObject paramJSONObject)
  {
  ...
  public boolean a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Bkfr.jdField_a_of_type_Int = i;
      this.jdField_a_of_type_Bkfr.jdField_a_of_type_ArrayOfInt = new int[] { j, k, m, n };
      this.jdField_a_of_type_Bkfr.jdField_a_of_type_JavaLangString = ((String)localObject);
      this.jdField_a_of_type_Bkfr.b = i1;
      this.jdField_a_of_type_Bkfr.c = i2;
      this.jdField_a_of_type_Bkfr.d = i3;
      this.jdField_a_of_type_Bkfr.e = i4;
      this.jdField_a_of_type_Bkfr.f = i5;
      return true;
    }
  ...
  {
    return "Item{thumbUrl='" + this.jdField_a_of_type_JavaLangString + '\'' + ", name='" + this.b + '\'' + ", desc='" + this.c + '\'' + ", imageUrl='" + this.d + '\'' + ", imageDrawable=" + this.jdField_a_of_type_AndroidGraphicsDrawableDrawable + ", layoutJson='" + this.e + '\'' + ", params=" + this.jdField_a_of_type_Bkfr + '}';
  }
}
