  ...
  extends MSFServlet
{
  ...
  private void a(VideoCallMsg paramVideoCallMsg)
  {
    ...
    {
      lek.d("VideoConfigServlet", "handleVideoConfigMessage error videoMsg = null");
      return;
    }
    int[] arrayOfInt;
    int i;
    ...
    {
      arrayOfInt = lno.a(paramVideoCallMsg.vMsg);
      if (arrayOfInt != null)
      {
        i = arrayOfInt[0];
        j = arrayOfInt[1];
        ...
        bool1 = true;
        label61:
        AudioHelper.a(0, new bday(i, j, bool1));
        i = arrayOfInt[3];
        j = arrayOfInt[4];
        if (arrayOfInt[5] != 1) {
          break label289;
        ...
        bool1 = true;
        label97:
        AudioHelper.a(1, new bday(i, j, bool1));
        i = arrayOfInt[6];
        j = arrayOfInt[7];
        if (arrayOfInt[8] != 1) {
          break label295;
    ...
    {
      AudioHelper.a(2, new bday(i, j, bool1));
      i = arrayOfInt[9];
      j = arrayOfInt[10];
      bool1 = bool2;
      if (arrayOfInt[11] == 1) {
      ...
      AudioHelper.a(3, new bday(i, j, bool1));
      bool1 = lno.a(String.valueOf(AppSetting.a()), getAppRuntime().getApplication(), paramVideoCallMsg.vMsg);
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      do
      {
        ...
        try
        {
          ...
          {
            lek.c("VideoConfigServlet", "cmd0xa02 onReceive uint32_result = " + paramFromServiceMsg.uint32_result.get());
            return;
          }
        }
      ...
      lek.c("VideoConfigServlet", "cmd0xa02 onReceive list = " + paramIntent.toString());
      new ArrayList();
    ...
    return;
    lek.c("VideoConfigServlet", "cmd0xa02 onReceive not success!");
  }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    lek.c("VideoConfigServlet", "cmd0xa02 onSend");
    return;
    ...
    paramIntent.vMsg = lno.a(paramIntent.lUin, String.valueOf(AppSetting.a()), getAppRuntime().getApplication());
