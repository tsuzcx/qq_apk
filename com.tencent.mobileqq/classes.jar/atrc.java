...
public class atrc
{
  ...
  public atrc(QQAppInterface paramQQAppInterface)
  {
  ...
  public bftf a(MessageForTroopFile paramMessageForTroopFile)
  {
    return bgsk.a(this.a, paramMessageForTroopFile);
  }
  
  public bgrh a(long paramLong)
  {
    return bgrh.a(paramLong);
  }
  ...
  public im_msg_body.MsgBody a(int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    {
    default: 
      QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "attention, this is a default way to handle, peerType[" + paramMessageRecord.istroop + "] " + auoo.a(this.a, paramMessageRecord));
  ...
  public im_msg_body.MsgBody a(MessageRecord paramMessageRecord)
  {
    ...
    {
      QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleTroopFileMessage: package multi troop file message. " + auoo.a(this.a, paramMessageRecord));
    ...
    for (;;)
    {
      ...
      QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleTroopFileMessage: package normal troop file message. " + auoo.a(this.a, paramMessageRecord));
      localObject4 = (MessageForTroopFile)paramMessageRecord;
      Object localObject5 = a((MessageForTroopFile)localObject4);
      if (localObject5 == null) {
        continue;
      }
      String str2 = ((bftf)localObject5).e;
      if (!TextUtils.isEmpty(str2))
      {
        ((obj_msg.MsgContentInfo.MsgFile)localObject3).bytes_file_path.set(ByteStringMicro.copyFrom(str2.getBytes()));
        if (QLog.isDebugVersion()) {
          QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleTroopFileMessage: get troop fileId[" + str2 + "] " + auoo.a(this.a, paramMessageRecord));
        }
        label735:
        ((obj_msg.MsgContentInfo.MsgFile)localObject3).uint32_bus_id.set(((bftf)localObject5).h);
        str2 = ((bftf)localObject5).g;
        ((obj_msg.MsgContentInfo.MsgFile)localObject3).str_file_name.set(str2);
        l = ((bftf)localObject5).c;
        ((obj_msg.MsgContentInfo.MsgFile)localObject3).uint64_file_size.set(l);
        l = ((MessageForTroopFile)localObject4).lastTime;
        ((obj_msg.MsgContentInfo.MsgFile)localObject3).int64_dead_time.set(l);
        localObject5 = ((bftf)localObject5).f;
      ...
      try
      {
        ...
        continue;
        QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleTroopFileMessage: error, can not get troop fileId. " + auoo.a(this.a, paramMessageRecord));
        break label735;
        label950:
        if (!QLog.isDebugVersion()) {
          break label830;
        }
        QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleTroopFileMessage: error, can not get sha. " + auoo.a(this.a, paramMessageRecord));
      }
  ...
  public void a(ArrayList<MessageRecord> paramArrayList, ByteStringMicro paramByteStringMicro)
  {
    ...
    MessageRecord localMessageRecord = bcry.a(-2005);
    ...
    do
    {
      try
      {
        ...
        {
          QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "decodeBuddyFilePBMsg: decode multi buddy file message. " + auoo.a(this.a, localMessageRecord, false));
      ...
      QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "decodeBuddyFilePBMsg: decode normal buddy file message. " + auoo.a(this.a, localMessageRecord, false));
    ...
    if (((im_msg_body.NotOnlineFile)localObject).bytes_file_name.has())
    {
      ...
      if (((im_msg_body.NotOnlineFile)localObject).bytes_file_md5.has()) {
        localMessageRecord.saveExtInfoToExtStr("_backup_ForwardMd5", aubb.a(((im_msg_body.NotOnlineFile)localObject).bytes_file_md5.get().toByteArray()));
      }
  ...
  public boolean a(ArrayList<MessageRecord> paramArrayList, msg_comm.Msg paramMsg)
  {
    ...
    for (;;)
    {
      ...
      bhvd.a((byte[])localObject1, 0, arrayOfByte, i + 3, i1);
      ...
      for (;;)
      {
        ...
        catch (Exception localException1)
        {
          try
          {
            ...
            localObject4 = (MessageForTroopFile)bcry.a(-2017);
            ...
            localObject3 = bgsk.a((obj_msg.ObjMsg)localObject1);
        ...
        continue;
        label617:
        bgrh localbgrh = a(paramMsg.msg_head.group_info.group_code.get());
        Object localObject4 = localbgrh.a(this.a, localException3.fileUrl);
        Object localObject2 = localObject4;
        if (localObject4 == null)
        {
          localbgrh.a(this.a, localException3.fileUrl, localException3);
        ...
        localMessageForTroopFile.msg = anzj.a(2131703455);
        for (;;)
        {
          try
          {
            localMessageForTroopFile.msgData = apdm.a(localObject2);
  ...
  public im_msg_body.MsgBody b(MessageRecord paramMessageRecord)
  {
    ...
    if (a(paramMessageRecord))
    {
      QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleDiscFileMessage: package multi disc file message. " + auoo.a(this.a, paramMessageRecord));
    ...
    for (;;)
    {
      ...
      return localMsgBody;
      QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleDiscFileMessage: package normal disc file message. " + auoo.a(this.a, paramMessageRecord));
    ...
    while (paramMsg.hasNext())
    {
      ...
      else
      {
        ...
        try
        {
          ...
          {
            QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "decodeDiscFilepb: decode multi disc file message. " + auoo.a(this.a, paramMsg, false));
        ...
        QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "decodeDiscFilepb: decode normal disc file message. " + auoo.a(this.a, paramMsg, false));
        if (((im_msg_body.GroupFile)localObject2).bytes_filename.has())
        {
          ...
          paramMsg.saveExtInfoToExtStr("_backup_ForwardFileName", aunj.a((String)localObject3));
          label447:
  ...
  public im_msg_body.MsgBody c(MessageRecord paramMessageRecord)
  {
    ...
    if (a(paramMessageRecord))
    {
      QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleBuddyFileMessage: package multi buddy file message. " + auoo.a(this.a, paramMessageRecord));
      ...
      {
        QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleBuddyFileMessage: package multi buddy file message but found online file." + auoo.a(this.a, paramMessageRecord));
        return null;
      }
      ...
      if (!TextUtils.isEmpty(str)) {
        ((im_msg_body.NotOnlineFile)localObject1).bytes_file_md5.set(ByteStringMicro.copyFrom(bhml.a(str)));
      }
    ...
    for (;;)
    {
      ...
      return localMsgBody;
      QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleBuddyFileMessage: package normal buddy file message. " + auoo.a(this.a, paramMessageRecord));
      localObject2 = this.a.a().a(paramMessageRecord.uniseq, paramMessageRecord.frienduin, paramMessageRecord.istroop);
      if (localObject2 != null)
      {
        if (((FileManagerEntity)localObject2).getCloudType() == 0)
        {
          QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleBuddyFileMessage: package normal buddy file message but found online file." + auoo.a(this.a, paramMessageRecord));
          return null;
        }
        ...
        for (;;)
        {
          ...
          i = aunj.a(((FileManagerEntity)localObject2).fileName);
          if ((i == 0) || (i == 2))
          {
          ...
          break;
          QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleBuddyFileMessage: offline file name is null. " + auoo.a(this.a, paramMessageRecord));
          break label551;
          label728:
          QLog.i("FileMultiMsgPackageHandle<QFile>", 1, "handleBuddyFileMessage: offline file uuid is null. " + auoo.a(this.a, paramMessageRecord));
          break label581;
          label764:
