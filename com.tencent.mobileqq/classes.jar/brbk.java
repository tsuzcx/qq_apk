...
public class brbk
  implements Comparable<brbk>
{
  public int a;
  public long a;
  public int b;
  
  public brbk(VideoFramesRetriever paramVideoFramesRetriever, long paramLong, int paramInt1, int paramInt2)
  {
  ...
  public int a(brbk parambrbk)
  {
    return -(int)(this.jdField_a_of_type_Long - parambrbk.jdField_a_of_type_Long);
  }
}
