  ...
  extends RelativeLayout
{
  ...
  public anem(ApolloGameInfoFragment paramApolloGameInfoFragment, Context paramContext, String paramString)
  {
    super(paramContext);
    a(paramString);
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    setOnClickListener(new anep(this, paramString, paramInt));
  }
  ...
  public void a(Bitmap paramBitmap, String paramString)
  {
    ...
    for (;;)
    {
      ...
      setOnClickListener(new aneo(this));
      return;
  ...
  public void a(String paramString)
  {
    ...
    ((RelativeLayout.LayoutParams)localObject).setMargins(afur.a(12.0F, getResources()), afur.a(17.0F, getResources()), 100, afur.a(20.0F, getResources()));
    ...
    paramString = new RelativeLayout.LayoutParams(afur.a(9.0F, getResources()), afur.a(18.0F, getResources()));
    paramString.addRule(11);
    paramString.addRule(15);
    paramString.rightMargin = afur.a(27.0F, getResources());
    ...
    paramString.rightMargin = afur.a(11.0F, getResources());
    paramString.addRule(11);
    paramString.rightMargin = afur.a(27.0F, getResources());
    paramString.addRule(15);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(4);
    ...
    this.jdField_a_of_type_ComTencentImageURLImageView.setVisibility(4);
    paramString = new RelativeLayout.LayoutParams(afur.a(25.0F, getResources()), afur.a(25.0F, getResources()));
    paramString.rightMargin = afur.a(11.0F, getResources());
    paramString.addRule(0, this.c);
    paramString.addRule(15);
    setBackgroundResource(2130839354);
    addView(this.jdField_a_of_type_ComTencentImageURLImageView, paramString);
    setOnClickListener(new anen(this));
  }
