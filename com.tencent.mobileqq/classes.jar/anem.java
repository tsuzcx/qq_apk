  ...
  implements Manager
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new aneo(this, ThreadManager.getSubThreadLooper());
  private aumg jdField_a_of_type_Aumg = new anen(this);
  ...
  public anem(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramQQAppInterface.registObserver(this.jdField_a_of_type_Aumg);
      }
  ...
  private List<anet> a()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 94	anem:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   20: aload_1
    //   21: aload_0
    //   22: invokespecial 226	anem:c	()Ljava/lang/String;
    //   25: invokestatic 231	anes:a	(Ljava/lang/String;)Landroid/net/Uri;
    //   28: getstatic 234	anes:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   31: aconst_null
    //   32: aconst_null
    //   33: aconst_null
    ...
    //   68: new 255	anet
    //   71: dup
    //   72: invokespecial 256	anet:<init>	()V
    //   75: astore_3
    //   76: aload_2
    //   77: astore_1
    //   78: aload_3
    ...
    //   86: putfield 263	anet:jdField_a_of_type_Long	J
    //   89: aload_2
    //   90: astore_1
    //   91: aload_3
    //   92: aload_2
    ...
    //   99: putfield 268	anet:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   102: aload_2
    //   103: astore_1
    //   104: aload_3
    //   105: aload_2
    ...
    //   112: putfield 275	anet:jdField_a_of_type_Int	I
    //   115: aload_2
    //   116: astore_1
    //   117: aload 4
    //   119: aload_3
  ...
  {
    List localList = ((askn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(11)).d();
    if (localList != null)
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Account paramAccount)
  {
    synchronized (jdField_a_of_type_JavaUtilSet)
    {
      ...
      ??? = (anem)paramQQAppInterface.getManager(41);
      if (??? != null)
      {
        paramQQAppInterface = paramQQAppInterface.getCurrentAccountUin();
        if ((!TextUtils.isEmpty(paramQQAppInterface)) && (paramQQAppInterface.equals(e(paramAccount.name)))) {
          ((anem)???).jdField_b_of_type_Boolean = true;
        }
        ((anem)???).jdField_a_of_type_AndroidAccountsAccount = null;
        ((anem)???).d = false;
        return;
      }
    }
  ...
  {
    paramList = anel.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramList, c(), paramPhoneContact.mobileNo, paramPhoneContact.nationCode, paramPhoneContact.mobileCode, paramPhoneContact.ability, paramPhoneContact.contactID);
  ...
  private void a(List<ContentProviderOperation> paramList, PhoneContact paramPhoneContact, long paramLong)
  {
    ...
    //   4: aload_1
    //   5: lload_3
    //   6: invokestatic 528	anel:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/util/List;J)Lanel;
    //   9: astore 6
    //   11: aload_0
    //   12: getfield 94	anem:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   21: astore_1
    //   22: aload_1
    //   23: getstatic 539	aneq:jdField_a_of_type_AndroidNetUri	Landroid/net/Uri;
    //   26: getstatic 540	aneq:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   29: ldc_w 542
    //   32: iconst_1
    ...
    //   138: aload 5
    //   140: astore_1
    //   141: getstatic 539	aneq:jdField_a_of_type_AndroidNetUri	Landroid/net/Uri;
    //   144: lload_3
    ...
    //   159: aload 7
    //   161: invokevirtual 556	anel:a	(Ljava/lang/String;Landroid/net/Uri;)Lanel;
    //   164: pop
    //   165: aload 5
    //   167: ifnull +10 -> 177
    //   170: aload 5
  ...
  private boolean a(Map<String, PhoneContact> paramMap)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        localanet = (anet)((Iterator)localObject4).next();
        if (h())
        {
          if (!QLog.isColorLevel()) {
            break label1210;
        ...
        str = localanet.jdField_a_of_type_JavaLangString;
        if ((TextUtils.isEmpty(str)) || (!paramMap.containsKey(localanet.jdField_a_of_type_JavaLangString)))
        {
          a(localanet.jdField_a_of_type_Long, (List)localObject1);
          i += 1;
          continue;
        }
        ...
        if (((Set)localObject3).contains(Integer.valueOf(localanet.jdField_a_of_type_Int)))
        {
          if (QLog.isColorLevel()) {
        ...
        ((Set)localObject3).add(Integer.valueOf(localanet.jdField_a_of_type_Int));
      }
      finally {}
      if (((PhoneContact)paramMap.get(str)).contactID != localanet.jdField_a_of_type_Int)
      {
        ((Set)localObject2).add(localanet.jdField_a_of_type_JavaLangString);
        a((List)localObject1, (PhoneContact)paramMap.get(str), localanet.jdField_a_of_type_Long);
        continue;
        label396:
        ...
        else
        {
          ...
          {
            localObject4 = (anet)((Iterator)localObject3).next();
            if ((((Set)localObject2).contains(((anet)localObject4).jdField_a_of_type_JavaLangString)) && (paramMap.containsKey(((anet)localObject4).jdField_a_of_type_JavaLangString)))
            {
              a((List)localObject1, ((anet)localObject4).jdField_a_of_type_Long, ((Long)paramMap.get(((anet)localObject4).jdField_a_of_type_JavaLangString)).longValue());
              ((Set)localObject2).remove(((anet)localObject4).jdField_a_of_type_JavaLangString);
            }
            if (((ArrayList)localObject1).size() > 500)
            {
              if (QLog.isColorLevel()) {
  ...
  private Map<String, Long> b()
  {
    ...
    //   18: astore_1
    //   19: aload_2
    //   20: getstatic 700	aner:jdField_a_of_type_AndroidNetUri	Landroid/net/Uri;
    //   23: getstatic 701	aner:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   26: aconst_null
    //   27: aconst_null
    //   28: aconst_null
    ...
    //   76: invokestatic 705	akca:a	(Ljava/lang/String;)Ljava/lang/String;
    //   79: aload_2
    //   80: iconst_3
    //   81: invokeinterface 260 2 0
  ...
  private void c()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 54	anem:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   4: invokeinterface 738 1 0
    //   9: aload_0
    //   10: aconst_null
    //   11: putfield 363	anem:jdField_a_of_type_AndroidAccountsAccount	Landroid/accounts/Account;
    //   14: aload_0
    //   15: getfield 108	anem:jdField_a_of_type_AndroidAccountsAccountManager	Landroid/accounts/AccountManager;
    //   18: ldc_w 713
    ...
    //   104: invokestatic 744	anem:b	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   116: getstatic 36	anem:jdField_a_of_type_JavaUtilSet	Ljava/util/Set;
    //   119: astore_3
    //   120: aload_3
    //   121: monitorenter
    //   122: getstatic 36	anem:jdField_a_of_type_JavaUtilSet	Ljava/util/Set;
    //   125: aload 5
    ...
    //   137: monitorexit
    //   138: aload_0
    //   139: getfield 108	anem:jdField_a_of_type_AndroidAccountsAccountManager	Landroid/accounts/AccountManager;
    //   142: aload 5
    //   144: new 746	anep
    //   147: dup
    //   148: aload_0
    //   149: invokespecial 747	anep:<init>	(Lanem;)V
    //   152: aconst_null
    ...
    //   188: aload_0
    //   189: getfield 54	anem:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   192: invokeinterface 756 1 0
    //   197: return
    //   198: aload_0
    //   199: getfield 54	anem:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   202: invokeinterface 756 1 0
    //   207: return
    //   208: astore_3
    //   209: aload_0
    //   210: getfield 54	anem:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
  ...
  private boolean f()
  {
    ...
    if ((d()) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isLogin()) && (this.jdField_a_of_type_Boolean) && (!this.jdField_b_of_type_Boolean))
    {
      ...
      label310:
      for (int i = ((askn)localObject).d();; i = -1000)
      {
        QLog.d("ContactSync.Manager", 2, i);
        if ((localObject == null) || (!((askn)localObject).c())) {
          break;
        }
        if (QLog.isColorLevel()) {
          QLog.d("ContactSync.Manager", 2, "couldAddAccount | bind state = " + ((askn)localObject).d());
        }
        return true;
      }
    }
  ...
  public aneu a(Uri paramUri)
  {
    ...
    //   211: new 900	aneu
    //   214: dup
    //   215: invokespecial 901	aneu:<init>	()V
    //   218: astore 7
    //   220: aload 6
    //   222: getstatic 539	aneq:jdField_a_of_type_AndroidNetUri	Landroid/net/Uri;
    //   225: getstatic 540	aneq:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   228: ldc_w 542
    //   231: iconst_1
    ...
    //   298: putfield 902	aneu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   301: aload_1
    //   302: astore 4
    //   304: aload_1
    //   305: ifnull +393 -> 698
    ...
    //   319: getstatic 904	anes:b	[Ljava/lang/String;
    //   322: ldc_w 906
    //   325: iconst_1
    ...
    //   373: putfield 907	aneu:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   376: aload 4
    //   378: astore_1
    //   379: aload 7
    //   381: aload 4
    ...
    //   389: putfield 908	aneu:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   392: aload 4
    //   394: astore_1
    //   395: aload 7
    //   397: aload 4
    ...
    //   405: putfield 909	aneu:jdField_a_of_type_Int	I
    //   408: aload 4
    //   410: ifnull +10 -> 420
    //   413: aload 4
  ...
  public String a(GetOnlineInfoResp paramGetOnlineInfoResp)
  {
    ...
    for (;;)
    {
      i = bbcz.a(j, (int)paramGetOnlineInfoResp.iTermType);
      if ((i == 0) || (i == 6)) {
        break label97;
      }
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getContentResolver().delete(anes.a(c()), "sourceid=?", new String[] { paramString });
  }
  ...
  public String b(GetOnlineInfoResp paramGetOnlineInfoResp)
  {
    ...
    while (i != 0)
    {
      return String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getResources().getString(2131698729), new Object[] { str1, paramGetOnlineInfoResp });
      str1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getString(2131699208);
      paramGetOnlineInfoResp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getString(2131699209);
      i = 1;
      continue;
      str1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getString(2131699208);
      paramGetOnlineInfoResp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getString(2131699205);
      i = 1;
      continue;
      str1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getString(2131699208);
      paramGetOnlineInfoResp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getString(2131699204);
      i = 1;
      continue;
      str1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getString(2131699207);
      paramGetOnlineInfoResp = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getString(2131699203);
      i = 1;
    }
  }
