  ...
  extends ajps
{
  ...
  private Map<Long, ArrayList<ajpr>> jdField_a_of_type_JavaUtilMap = new HashMap();
  private Random jdField_a_of_type_JavaUtilRandom = new Random();
  private float[] jdField_a_of_type_ArrayOfFloat;
  private int jdField_b_of_type_Int = 150;
  private ajqi jdField_b_of_type_Ajqi;
  private ArrayList<Integer> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  private Map<Integer, LinkedList<ajpr>> jdField_b_of_type_JavaUtilMap = new HashMap();
  private int jdField_c_of_type_Int = 92;
  private ajqi jdField_c_of_type_Ajqi;
  private int jdField_d_of_type_Int = 136;
  private ajqi jdField_d_of_type_Ajqi;
  private int e = 5;
  private int f = 15;
  private int g = 25;
  private int h = 6;
  ...
  private void a(long paramLong1, long paramLong2, long paramLong3, String paramString, ArrayList<ajpr> paramArrayList, int paramInt1, float paramFloat1, int paramInt2, float paramFloat2)
  {
    ...
    float f2 = (int)a(true);
    paramString = new ajpr(paramLong1, a(paramLong2), a(), b(), paramFloat2, d(), paramString, paramFloat1, paramInt1, f2, f1, -1.0F, this.jdField_c_of_type_Int, this.e, this.jdField_a_of_type_AndroidGraphicsTypeface);
  ...
  private float c()
  {
    if (this.jdField_d_of_type_Ajqi == null) {
      this.jdField_d_of_type_Ajqi = new ajqi(this.h, 2);
    }
    int i = this.jdField_d_of_type_Ajqi.a();
  ...
  private int e()
  {
    if (this.jdField_a_of_type_Ajqi == null) {
      this.jdField_a_of_type_Ajqi = new ajqi(4, 2);
    }
    return this.jdField_a_of_type_Ajqi.a();
  }
  ...
  private int f()
  {
    ...
    if (this.jdField_c_of_type_Ajqi == null) {
      this.jdField_c_of_type_Ajqi = new ajqi(this.jdField_b_of_type_JavaUtilArrayList.size(), 1);
    }
    int i = this.jdField_c_of_type_Ajqi.a();
  ...
  private int g()
  {
    ...
    if (this.jdField_b_of_type_Ajqi == null) {
      this.jdField_b_of_type_Ajqi = new ajqi(this.jdField_a_of_type_JavaUtilArrayList.size(), 2);
    }
    return this.jdField_b_of_type_Ajqi.a();
  }
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        while (((Iterator)localObject).hasNext()) {
          ((ajpr)((Iterator)localObject).next()).a(paramWordingItem.jdField_a_of_type_JavaLangString);
        }
        break;
        if (QLog.isColorLevel()) {
      ...
      if (j >= 0)
      {
        this.jdField_a_of_type_Ajqi.a(j);
        i = j;
        i1 = f();
        i6 = g();
        f1 = c();
        ...
        this.jdField_a_of_type_Ajqi.a(k);
        m = k;
        j = k;
        k = m;
        i4 = f();
  ...
  public boolean a(Canvas paramCanvas, RenderBuffer paramRenderBuffer, long paramLong1, long paramLong2)
  {
    ...
    {
      if (((ajpr)((Iterator)localObject2).next()).a(2) > paramLong1) {
        break label500;
      }
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = (ajpr)((Iterator)localObject1).next();
        if (((ajpr)localObject2).a(2) == paramLong1) {
          ((ajpr)localObject2).a(6, a(true));
        }
        int j = 1;
        if ((((ajpr)localObject2).a(6) > a(true)) || (((ajpr)localObject2).a(6) + ((ajpr)localObject2).a(3) < 0.0F) || (((ajpr)localObject2).a(2) > paramLong1))
        {
          int k = 0;
          j = k;
          if (QLog.isColorLevel())
          {
            QLog.d("BaseAnimDrawer", 2, "barrage invisible: posx:" + ((ajpr)localObject2).a(6) + "  width:" + ((ajpr)localObject2).a(3) + "  index:" + ((ajpr)localObject2).a(2) + " curindex:" + paramLong1);
            j = k;
          }
        }
        if ((j == 0) && (((ajpr)localObject2).a(6) < 0.0F))
        {
          if (i > 1)
          {
            ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_JavaUtilMap.get(Long.valueOf(((ajpr)localObject2).a(1)));
            if (localArrayList != null)
            {
              localArrayList.remove(localObject2);
              if (localArrayList.size() == 0) {
                this.jdField_a_of_type_JavaUtilMap.remove(Long.valueOf(((ajpr)localObject2).a(1)));
              }
            }
        ...
        else if (((ajpr)localObject2).a(2) <= paramLong1)
        {
          if (!c()) {
            ((ajpr)localObject2).a();
          }
          if (paramCanvas != null) {
            ((ajpr)localObject2).a(paramCanvas);
          }
          if (paramRenderBuffer != null) {
            ((ajpr)localObject2).a(paramRenderBuffer);
          }
          bool2 = true;
        }
      }
