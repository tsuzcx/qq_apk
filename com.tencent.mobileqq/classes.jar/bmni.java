...
public class bmni
{
  ...
  public TianShuGetAdvCallback a;
  public String a;
  ...
  public bmni(Activity paramActivity, View paramView, int paramInt)
  {
    this.jdField_a_of_type_JavaLangString = "";
    this.jdField_b_of_type_JavaLangString = "";
    this.jdField_a_of_type_CooperationVipTianshuTianShuGetAdvCallback = new bmnj(this);
  ...
  public void a(TianShuAccess.AdItem paramAdItem, int paramInt)
  {
    ...
    localTianShuReportData.mAppId = "tianshu.99";
    localTianShuReportData.mPageId = "tianshu.99";
    localTianShuReportData.mItemId = (i + "");
    ...
    localTianShuReportData.mTriggerInfo = paramAdItem;
  ...
  public void b()
  {
    if (!TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      try
      {
        ...
        localURLDrawable.setURLDrawableListener(new bmnk(this));
