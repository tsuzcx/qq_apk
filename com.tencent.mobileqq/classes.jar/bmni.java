  ...
  implements uqz
{
  ...
  bmnt jdField_a_of_type_Bmnt = null;
  ...
  utn jdField_a_of_type_Utn = new bmnm(this);
  public String b;
  protected List<Location> b;
  
  static
  {
    jdField_a_of_type_JavaLangString = ugx.j + "emoji";
  ...
  public static String a(bmni parambmni, String paramString)
  {
    return parambmni.a("emoji_pack_url_" + paramString, "");
  }
  ...
  public static void a(bmni parambmni, String paramString1, String paramString2)
  {
    parambmni.a("emoji_pack_md5_" + paramString1, paramString2);
  }
  ...
  private static boolean a(File paramFile)
  {
    ...
    {
      return false;
      paramFile = paramFile.listFiles(new bmno());
    } while ((paramFile == null) || (paramFile.length <= 0));
    return true;
  }
  
  public static String b(bmni parambmni, String paramString)
  {
    return parambmni.a("emoji_pack_name_" + paramString, "");
  }
  ...
  private static void b(bmni parambmni, String paramString1, String paramString2)
  {
    parambmni.a("emoji_pack_url_" + paramString1, paramString2);
  }
  
  public static String c(bmni parambmni, String paramString)
  {
    return parambmni.a("emoji_pack_config_" + paramString, "");
  }
  
  private static void c(bmni parambmni, String paramString1, String paramString2)
  {
    parambmni.a("emoji_pack_name_" + paramString1, paramString2);
  }
  
  public static String d(bmni parambmni, String paramString)
  {
    return parambmni.a("emoji_pack_md5_" + paramString, "");
  }
  
  private static void d(bmni parambmni, String paramString1, String paramString2)
  {
    parambmni.a("emoji_pack_config_" + paramString1, paramString2);
  }
  ...
  public List<DoodleEmojiItem> a()
  {
    if (!a())
    {
      wsv.b("DoodleEmojiManager", "getCurrentEmojiPackList but not init yet");
  ...
  public void a(int paramInt1, int paramInt2, bmnt parambmnt)
  {
    parambmnt = new WeakReference(parambmnt);
    ung.a().a(new vbh(paramInt1, paramInt2), new bmnn(this, parambmnt));
  }
  ...
  public void a(List<DoodleEmojiItem> arg1)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      wsv.a("DoodleEmojiManager", "EmojiPack md5 has changed. old : %s, new : %s", ((DoodleEmojiItem)localObject2).md5, localDoodleEmojiItem.md5);
    }
    for (;;)
    {
      for (;;)
      {
        ...
        {
          xmx.d(???);
          localObject2 = new bmnp(localDoodleEmojiItem, 0, false, 0L, 0L);
          ((bmnp)localObject2).b = true;
          uht.a().dispatch((Dispatcher.Dispatchable)localObject2);
          ??? = null;
          localDoodleEmojiItem.setLocalEmojiFolderPath(???);
          b(localbmni, localDoodleEmojiItem.pack_id, localDoodleEmojiItem.icon);
          c(localbmni, localDoodleEmojiItem.pack_id, localDoodleEmojiItem.name);
          d(localbmni, localDoodleEmojiItem.pack_id, localDoodleEmojiItem.config);
          a(localbmni, localDoodleEmojiItem.pack_id, localDoodleEmojiItem.md5);
        ...
        synchronized (this.jdField_a_of_type_JavaUtilList)
        {
          ...
          wsv.b("DoodleEmojiManager", "start download the first emoji pack if needed : " + ((DoodleEmojiItem)localArrayList.get(0)).pack_id);
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    if ((a((File)???)) && (!paramBoolean))
    {
      ...
      uht.a().dispatch(new bmnp(localDoodleEmojiItem, 0, true, 0L, 0L));
      return true;
    }
  ...
  public void b()
  {
    ...
    if ((localutk != null) && (this.jdField_a_of_type_Utn != null)) {
      localutk.b(this.jdField_a_of_type_Utn);
    }
    this.jdField_a_of_type_Bmnt = null;
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.compareAndSet(0, 1))
    {
      ...
      {
        localObject1 = ((File)localObject1).listFiles(new bmnj(this));
        if (localObject1 != null)
        {
          ...
          if (i < j)
          {
            ...
            Object localObject2 = localFile.listFiles(new bmnk(this));
            if ((localObject2 != null) && (localObject2.length > 0))
            {
              localObject2 = a(localFile);
              Object localObject3 = b(localbmni, (String)localObject2);
              localObject3 = new DoodleEmojiItem((String)localObject2, a(localbmni, (String)localObject2), (String)localObject3, null, c(localbmni, (String)localObject2), d(localbmni, (String)localObject2));
  ...
  protected void d()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleModelDoodleEmojiItem == null)
      {
        ...
        if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleModelDoodleEmojiItem != null)
        {
          wsv.b("DoodleEmojiManager", "downloader startDownload : " + this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleModelDoodleEmojiItem);
          Bosses.get().postJob(new bmnl(this, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleModelDoodleEmojiItem));
        }
        return;
      }
      wsv.b("DoodleEmojiManager", "can not start download because find one is still downloading : " + this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleModelDoodleEmojiItem);
    }
  }
}
