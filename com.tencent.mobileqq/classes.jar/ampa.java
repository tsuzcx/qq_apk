  ...
  implements BusinessObserver
{
  ...
  private static ampa jdField_a_of_type_Ampa;
  ...
  private final SparseArray<WeakReference<ampe>> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private WeakReference<AppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  private List<ampd> jdField_a_of_type_JavaUtilList;
  ...
  public static ampa a()
  {
    try
    {
      if (jdField_a_of_type_Ampa == null) {
        jdField_a_of_type_Ampa = new ampa();
      }
      ampa localampa = jdField_a_of_type_Ampa;
      return localampa;
    }
    finally {}
  }
  ...
  private void a(int paramInt)
  {
    ...
    {
      ((ampe)localWeakReference.get()).a(false, null);
      this.jdField_a_of_type_AndroidUtilSparseArray.remove(paramInt);
    }
    QLog.i("rscContent_CmShowRscUpdateHandler", 1, "onContentCheckFailed requestId:" + paramInt);
  }
  
  private void a(int paramInt, ampd paramampd)
  {
    if (paramampd == null) {
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("rscContent_CmShowRscUpdateHandler", 2, "onContentCheckSuccess result" + paramampd);
    }
    if ((paramampd.jdField_a_of_type_Int == 100) && (paramampd.jdField_a_of_type_Long == 1L))
    {
      if (1 == BaseApplicationImpl.sProcessId) {
        break label293;
      }
      if ("all_room3D".equals(paramampd.jdField_a_of_type_JavaLangString)) {
        amov.a().a();
      }
    }
    else
    {
      label79:
      a(paramampd, paramampd.jdField_b_of_type_Int);
      if (paramampd.jdField_b_of_type_Boolean)
      {
        if (paramampd.jdField_d_of_type_Int <= 0) {
          break label417;
        }
        if (jdField_a_of_type_Int == paramampd.jdField_d_of_type_Int) {
          break label380;
        }
        jdField_a_of_type_Int = paramampd.jdField_d_of_type_Int;
        this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putInt("json_content_update_interval", paramampd.jdField_d_of_type_Int).commit();
        QLog.i("rscContent_CmShowRscUpdateHandler", 1, "onContentCheckSuccess interval != result.mCheckServerInterval:" + paramampd.jdField_d_of_type_Int);
      }
    }
    label417:
    for (;;)
    {
      for (;;)
      {
        ...
        {
          this.jdField_a_of_type_JavaUtilList.remove(paramampd);
        ...
        ((ampe)((WeakReference)localObject).get()).a(true, paramampd);
        this.jdField_a_of_type_AndroidUtilSparseArray.remove(paramInt);
        return;
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("rscContent_CmShowRscUpdateHandler", 2, "onContentCheckSuccess interval == result.mCheckServerInterval:" + paramampd.jdField_d_of_type_Int);
        continue;
        QLog.i("rscContent_CmShowRscUpdateHandler", 1, "onContentCheckSuccess result.mCheckServerInterval <= 0" + paramampd.jdField_d_of_type_Int);
      }
    }
  }
  ...
  private void a(int paramInt, List<ampd> paramList)
  {
    if (paramList != null)
    {
      if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        if (localObject != null)
        {
          ...
          if ((localObject != null) && (((bhyq)localObject).a(3) != null))
          {
            paramList = paramList.iterator();
            while (paramList.hasNext())
            {
              ampd localampd = (ampd)paramList.next();
              if (localampd != null)
              {
                localObject = new File(localampd.c());
                ((File)localObject).getParentFile().mkdirs();
                if (((File)localObject).exists()) {
                  ((File)localObject).delete();
                }
                String str1 = localampd.e();
                if ((localampd.jdField_a_of_type_Boolean) && (!new File(str1).exists()))
                {
                  localampd.jdField_a_of_type_Boolean = false;
                ...
                {
                  if (localampd.jdField_a_of_type_ArrayOfByte != null)
                  {
                    String str2 = localampd.d();
                    if (FileUtils.writeFile(localampd.jdField_a_of_type_ArrayOfByte, str2))
                    {
                      if (BspatchUtil.a(str1, str2, ((File)localObject).getAbsolutePath()))
                      {
                        ...
                        try
                        {
                          ...
                          if (QLog.isColorLevel()) {
                            QLog.d("rscContent_CmShowRscUpdateHandler", 2, " updateResource onDone dstMd5:" + str1 + " result.mMd5:" + localampd.jdField_d_of_type_JavaLangString);
                          }
                          if (!b(localampd, str1)) {
                            break label641;
                          }
  ...
  private void a(ampd paramampd)
  {
    if (QLog.isColorLevel()) {
      QLog.d("rscContent_CmShowRscUpdateHandler", 2, "downloadZipAndPatch result:" + paramampd);
    }
    if (paramampd == null) {}
    Object localObject;
    do
    {
      ...
      localObject = ((bhyq)localObject).a(3);
    } while (localObject == null);
    if (TextUtils.isEmpty(paramampd.c))
    {
      QLog.e("rscContent_CmShowRscUpdateHandler", 2, "downloadZipAndPatch result.mDownloadPatchFileUrl is empty result:" + paramampd);
      return;
    }
    File localFile = new File(paramampd.d());
    localFile.getParentFile().mkdirs();
    if (localFile.exists()) {
      localFile.delete();
    }
    bhyo localbhyo = new bhyo(paramampd.c, localFile);
    localbhyo.p = true;
    localbhyo.n = true;
    ...
    localbhyo.q = true;
    localbhyo.r = true;
    localbhyo.jdField_a_of_type_JavaLangString = (paramampd.jdField_b_of_type_JavaLangString + "_" + paramampd.jdField_a_of_type_JavaLangString);
    ((bhyt)localObject).a(localbhyo, new ampb(this, localFile, paramampd), null);
  }
  
  private void b(ampd paramampd)
  {
    if (QLog.isColorLevel()) {
      QLog.d("rscContent_CmShowRscUpdateHandler", 2, "downloadAllZip result:" + paramampd);
    }
    if ((this.jdField_a_of_type_JavaLangRefWeakReference == null) || (paramampd == null)) {}
    Object localObject;
    do
    {
      do
    ...
    if (TextUtils.isEmpty(paramampd.jdField_b_of_type_JavaLangString))
    {
      QLog.e("rscContent_CmShowRscUpdateHandler", 2, "downloadAllZip result.mDownloadFileUrl is empty result:" + paramampd);
      return;
    }
    File localFile = new File(paramampd.c());
    localFile.getParentFile().mkdirs();
    if (localFile.exists()) {
      localFile.delete();
    }
    bhyo localbhyo = new bhyo(paramampd.jdField_b_of_type_JavaLangString, localFile);
    localbhyo.p = true;
    localbhyo.n = true;
    localbhyo.f = "apollo_res";
    localbhyo.jdField_b_of_type_Int = 1;
    ...
    localbhyo.r = true;
    localbhyo.jdField_a_of_type_JavaLangString = (paramampd.jdField_b_of_type_JavaLangString + "_" + paramampd.jdField_a_of_type_JavaLangString);
    ((bhyt)localObject).a(localbhyo, new ampc(this, localFile, paramampd), null);
  }
  
  private static boolean b(ampd paramampd)
  {
    if (paramampd == null) {}
    while ((TextUtils.isEmpty(paramampd.jdField_e_of_type_JavaLangString)) || (!paramampd.jdField_e_of_type_JavaLangString.endsWith(".zip"))) {
      return false;
    }
    return true;
  }
  
  private static boolean b(ampd paramampd, String paramString)
  {
    if (paramampd == null) {}
    do
    {
      return false;
      if (TextUtils.isEmpty(paramampd.jdField_d_of_type_JavaLangString)) {
        return true;
      }
    } while ((paramString == null) || (!paramString.equalsIgnoreCase(paramampd.jdField_d_of_type_JavaLangString)));
    return true;
  }
  ...
  public void a(int paramInt, ampe paramampe)
  {
    synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
    {
      this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, new WeakReference(paramampe));
      return;
    }
  }
  
  public void a(ampd paramampd, int paramInt)
  {
    if (paramampd != null)
    {
      this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putInt(paramampd.a(), paramInt).commit();
  ...
  public void a(AppInterface paramAppInterface, int paramInt, boolean paramBoolean)
  {
    ...
    {
      return;
      if (!ampd.a(100, 1L, "all_room3D", "all_room3D.json"))
      {
      ...
      try
      {
        ...
        localObject1 = new NewIntent(BaseApplicationImpl.getContext(), awcn.class);
