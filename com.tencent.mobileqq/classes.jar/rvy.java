...
public class rvy
{
  private static Pattern a = Pattern.compile(bhfp.c.pattern() + "|" + bhfp.d.pattern(), 2);
  ...
  private static int a(Spannable paramSpannable, int paramInt1, int paramInt2)
  {
    ...
    while (localMatcher.find())
    {
      ...
      paramInt2 += 1;
      paramSpannable.setSpan(new tnu(str), i, j, 0);
    }
    return paramInt2;
  }
  ...
  public static boolean a(Spannable paramSpannable)
  {
    ...
    {
      return false;
      if (bhfp.b.matcher(paramSpannable).find())
      {
        Object localObject = (tnu[])paramSpannable.getSpans(0, m, tnu.class);
        int j;
        int n;
        int i;
        ...
        int k = 0;
        localObject = (tns[])paramSpannable.getSpans(0, m, tns.class);
        if ((localObject != null) && (localObject.length > 0))
        {
          Arrays.sort((Object[])localObject, new rvz(paramSpannable));
  ...
  public static boolean a(EditText paramEditText, String paramString, boolean paramBoolean1, boolean paramBoolean2, List<SocializeFeedsInfo.BiuCommentInfo> paramList)
  {
    ...
    paramEditText = pkf.b(a(localEditable.toString(), str));
    if (TextUtils.isEmpty(paramEditText))
    {
      paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), ""));
      return true;
    }
    tns[] arrayOftns = (tns[])localEditable.getSpans(0, localEditable.length(), tns.class);
    if ((arrayOftns == null) || (arrayOftns.length <= 0))
    {
      if (paramBoolean1) {
        break label711;
      }
    ...
    for (;;)
    {
      paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), bcsc.a(b((String)localObject + paramEditText, str))));
      return true;
      int m = arrayOftns.length;
      Arrays.sort(arrayOftns, new rvz(localEditable));
      paramEditText = bcsc.a(b(localEditable.subSequence(0, localEditable.getSpanStart(arrayOftns[0])).toString(), str));
      ...
      if (i < m)
      {
        ...
        if (i == m - 1)
        {
          ...
          paramEditText = "";
          if (j - n > 0) {
            paramEditText = bcsc.a(b(localEditable.subSequence(n, j).toString(), str));
          }
        ...
        for (;;)
        {
          try
          {
            ...
            i += 1;
            break;
            j = localEditable.getSpanStart(arrayOftns[(i + 1)]);
          }
          ...
          else if ((localObject instanceof tnt))
          {
            paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), paramEditText, 3, new SocializeFeedsInfo.JumpInfo(0L, anvx.a(2131715381), ((tnt)localObject).a())));
          }
        }
      }
      return false;
