...
class adfs
  implements adcx
{
  adfs(adfr paramadfr, adfq paramadfq, MessageForPoke paramMessageForPoke) {}
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_Adfq.b == adfe.a()) && (!this.jdField_a_of_type_ComTencentMobileqqDataMessageForPoke.isSend()) && (!(this.jdField_a_of_type_Adfr.a.a instanceof ChatHistoryActivity)) && (!adfe.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForPoke))) {
