...
public class anaf
{
  private static anah a;
  
  static
  {
    if ((anae.a("HUAWEI")) && (Build.VERSION.SDK_INT >= 23) && (amtu.a())) {
      a = null;
    }
  }
  
  /* Error */
  public static int a(anah paramanah, String paramString)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    ...
    //   4: ifnull +14 -> 18
    //   7: aload_1
    //   8: invokestatic 33	bdnn:a	(Ljava/lang/String;)Z
    //   11: istore 4
    //   13: iload 4
    //   15: ifeq +11 -> 26
    //   18: bipush 252
    ...
    //   46: aload_0
    //   47: aload 5
    //   49: invokestatic 46	amxe:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   52: aload_1
    //   53: invokestatic 49	amxe:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    //   56: istore_3
    //   57: iload_3
    //   58: istore_2
  ...
  /* Error */
  public static int a(anah paramanah, String paramString1, String paramString2)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    ...
    //   11: ifne +14 -> 25
    //   14: aload_2
    //   15: invokestatic 33	bdnn:a	(Ljava/lang/String;)Z
    //   18: istore 4
    //   20: iload 4
    //   22: ifeq +10 -> 32
    //   25: iconst_m1
    ...
    //   120: aload 5
    //   122: aload_2
    //   123: invokestatic 106	amxe:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   126: aload_1
    //   127: aload 5
    //   129: aload 6
    //   131: aload 5
    //   133: aload 6
    //   135: aload 5
    //   137: invokestatic 46	amxe:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   140: invokestatic 108	amxe:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   143: invokestatic 113	amxa:a	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   159: aload 6
    //   161: aload 5
    //   163: invokestatic 46	amxe:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   166: invokestatic 108	amxe:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   210: pop
    //   211: aload_2
    //   212: invokestatic 133	bdhb:b	(Ljava/io/File;)Ljava/lang/String;
    //   215: aload 7
    //   217: invokestatic 136	anaf:a	(Ljava/lang/String;Ljava/util/List;)Ljava/util/HashMap;
    //   220: astore_0
    //   221: aload_0
    ...
    //   296: aload 6
    //   298: aload 5
    //   300: invokestatic 46	amxe:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   303: invokestatic 108	amxe:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   344: invokestatic 106	amxe:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   387: ifeq +267 -> 654
    //   390: aload_0
    //   391: invokestatic 181	awni:a	(Ljava/lang/String;)Ljava/lang/String;
    //   394: astore 9
    //   396: aload_2
    ...
    //   491: aload 6
    //   493: aload 5
    //   495: invokestatic 46	amxe:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   498: invokestatic 108	amxe:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   501: iconst_0
    //   502: invokestatic 198	bdhb:a	(Ljava/lang/String;Z)V
  ...
  public static boolean a(anah paramanah)
  {
    if (paramanah == null) {
      return false;
    }
    Object localObject = paramanah.a();
    if ((localObject == null) || (((List)localObject).size() == 0)) {
      return false;
    }
    localObject = ((List)localObject).iterator();
    while (((Iterator)localObject).hasNext()) {
      if (!a(paramanah, (String)((Iterator)localObject).next())) {
        return false;
      }
    }
    return true;
  ...
  public static boolean a(anah paramanah, String paramString)
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    if (paramanah != null) {}
    for (;;)
    {
      try
      {
        bool1 = bdnn.a(paramString);
        if (bool1)
        {
          bool1 = bool2;
          return bool1;
        }
        String str1 = paramanah.a();
        String str2 = paramanah.b();
        paramanah = amxe.a(str1, str2, amxe.b(str1, str2, str1)) + File.separator + paramString + ".so";
        File localFile = new File(paramanah);
        if (QLog.isColorLevel()) {
          QLog.d("ArCoreNativeSoManager", 2, "isSoFileExist soFile=" + paramanah + ", exist=" + localFile.exists());
        }
        if (localFile.exists())
        {
          paramString = amxe.b(str1, str2, paramString);
          str1 = awni.a(paramanah);
          if (paramString.equalsIgnoreCase(str1))
          {
            bool1 = true;
            continue;
          }
          QLog.i("ArCoreNativeSoManager", 2, "isSoFileExist. check md5 failed. soFilename = " + paramanah + ", md5FromConfig = " + paramString + ", md5FromCalc = " + str1);
          bool1 = bool2;
          continue;
        }
        QLog.i("ArCoreNativeSoManager", 2, "isSoFileExist. so not exist. soFilename = " + paramanah);
      }
      finally {}
      bool1 = bool2;
    }
  ...
  public static boolean b(anah paramanah)
  {
    if (paramanah == null) {
      return false;
    }
    String str1 = paramanah.a();
    String str2 = paramanah.b();
    paramanah = paramanah.a();
    if ((paramanah == null) || (paramanah.size() == 0)) {
      return false;
    }
    paramanah = paramanah.iterator();
    while (paramanah.hasNext())
    {
      String str3 = (String)paramanah.next();
      if (!new File(amxe.a(str1, str2, amxe.b(str1, str2, str1)) + File.separator + str3 + ".so").exists())
      {
