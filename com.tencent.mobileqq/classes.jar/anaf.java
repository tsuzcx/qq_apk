  ...
  extends amyp<anae>
{
  ...
  @NonNull
  public anae a(amph[] paramArrayOfamph)
  {
    int j = -1;
    ...
    if (i < m)
    {
      ...
      int k = localamph.jdField_a_of_type_Int;
      if (k < j) {
        ved.e("QVipStickerProcessor", "received old task id " + k + ", latest task id: " + j);
      }
      for (;;)
      {
        i += 1;
        ...
        try
        {
          JSONObject localJSONObject = new JSONObject(new String(localamph.jdField_a_of_type_JavaLangString.getBytes("utf-8")));
        ...
        catch (UnsupportedEncodingException localUnsupportedEncodingException)
        {
          ...
          ved.e("QVipStickerProcessor", "item.content=" + localamph.jdField_a_of_type_JavaLangString + " e=" + localUnsupportedEncodingException);
        }
        catch (JSONException localJSONException)
        {
          localJSONException.printStackTrace();
          ved.e("QVipStickerProcessor", "item.content=" + localamph.jdField_a_of_type_JavaLangString + " e=" + localJSONException);
        }
      }
    }
    return new anae();
