...
public class anaf
{
  ...
  public static android.graphics.drawable.Drawable a(Context paramContext, int paramInt1, int paramInt2, String paramString)
  {
    ...
    //   22: iload_1
    //   23: iload_2
    //   24: invokespecial 38	asda:<init>	(IFII)V
    //   27: astore 5
    //   29: new 27	asda
    //   32: dup
    //   33: ldc 29
    ...
    //   42: iload_1
    //   43: iload_2
    //   44: invokespecial 38	asda:<init>	(IFII)V
    //   47: astore_0
    //   48: new 27	asda
    //   51: dup
    //   52: aload_3
    ...
    //   60: iload_1
    //   61: iload_2
    //   62: invokespecial 38	asda:<init>	(IFII)V
    //   65: astore 4
    //   67: new 27	asda
    //   70: dup
    ...
    //   108: iload_1
    //   109: iload_2
    //   110: invokespecial 38	asda:<init>	(IFII)V
    //   113: astore_3
    //   114: aload_3
    //   115: sipush 204
  ...
  public static List<MessageForApollo> a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        amst localamst = (amst)paramQQAppInterface.getManager(211);
        ...
        if (paramInt1 >= 0)
        {
          ...
          for (;;)
          {
            ...
            if ((((MessageForApollo)localObject2).gameId == paramInt2) && (((MessageForApollo)localObject2).roomId == paramLong))
            {
              ...
              if (a()) {
                localamst.a().a((MessageForApollo)localObject2);
              }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, ApolloGameData paramApolloGameData, int paramInt)
  {
    ...
    if (!bhny.a(paramContext, paramApolloGameData.gameAppPkgName))
    {
    ...
    ((amsx)paramQQAppInterface.getManager(153)).a().a(paramApolloGameData.gameId, paramApolloGameData.gameAppid, 0, paramSessionInfo.jdField_a_of_type_JavaLangString, paramInt);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localansi.e = 1;
        localansi.d = 3;
        a(paramQQAppInterface, paramString, localansi);
        return;
        localansi.jdField_b_of_type_JavaLangString = anzj.a(2131701027);
        i = 0;
      }
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, ansi paramansi)
  {
    if ((paramansi == null) || (paramQQAppInterface == null))
    {
      QLog.e("CmGameTemp_CmGameSessionUtil", 1, "[sendGameMsg], errInfo->param is null.");
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("CmGameTemp_CmGameSessionUtil", 2, new Object[] { "[sendGameMsg], gameId:", Integer.valueOf(paramansi.jdField_a_of_type_Int), ",roomId:", Long.valueOf(paramansi.jdField_a_of_type_Long), ",extendInfo:", paramansi.jdField_c_of_type_JavaLangString });
    }
    ApolloMessage localApolloMessage = new ApolloMessage();
    if (!TextUtils.isEmpty(paramansi.jdField_a_of_type_JavaLangString)) {
      localApolloMessage.name = paramansi.jdField_a_of_type_JavaLangString.getBytes();
    }
    if (0 == 0) {}
    for (;;)
    {
      try
      {
        ...
        ((JSONObject)localObject).put("gameId", paramansi.jdField_a_of_type_Int);
        ((JSONObject)localObject).put("gameMode", paramansi.jdField_c_of_type_Int);
        ((JSONObject)localObject).put("roomid", paramansi.jdField_a_of_type_Long);
        if (paramansi.jdField_a_of_type_Int == 1)
        {
          ((JSONObject)localObject).put("msgTyep", 2);
          ((JSONObject)localObject).put("gameName", paramansi.jdField_b_of_type_JavaLangString);
          if (!TextUtils.isEmpty(paramansi.jdField_c_of_type_JavaLangString)) {
            ((JSONObject)localObject).put("gameExtendJson", paramansi.jdField_c_of_type_JavaLangString);
          }
          ((JSONObject)localObject).put("gameStatus", paramansi.e);
          if (localObject != null) {
            localApolloMessage.extStr = ((JSONObject)localObject).toString();
          }
          localObject = ((amsx)paramQQAppInterface.getManager(153)).b(paramQQAppInterface.getCurrentAccountUin());
          localApolloMessage.sender_ts = bhjx.a(((ApolloBaseInfo)localObject).apolloServerTS);
          localApolloMessage.sender_status = ((ApolloBaseInfo)localObject).apolloStatus;
          localObject = ((annx)paramQQAppInterface.getManager(155)).a(paramansi.jdField_a_of_type_Int);
          if ((localObject == null) || (1 != ((ApolloGameData)localObject).hasOwnArk)) {
            break label511;
          }
          i = 297;
          localApolloMessage.flag = (i | 0x200);
          paramString = bcry.a(paramQQAppInterface, paramString, paramQQAppInterface.getCurrentAccountUin(), 1036, localApolloMessage);
          if (paramansi.jdField_a_of_type_Int == 1)
          {
            paramString.msgType = 2;
            paramString.gameId = paramansi.jdField_a_of_type_Int;
            paramString.mGameMode = paramansi.jdField_c_of_type_Int;
            paramString.roomId = paramansi.jdField_a_of_type_Long;
            paramString.mApolloMessage.id = paramansi.jdField_b_of_type_Int;
            paramString.gameName = paramansi.jdField_b_of_type_JavaLangString;
            paramString.gameExtendJson = paramansi.jdField_c_of_type_JavaLangString;
            paramString.gameStatus = paramansi.e;
            paramString.extendJson = ("{\"gameStatus\":" + paramansi.e + "}");
        ...
        {
          ((JSONObject)localObject).put("msgTyep", paramansi.d);
          continue;
        }
        paramString.msgType = paramansi.d;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    ((amsx)paramQQAppInterface.getManager(153)).a().b(paramString1, paramString2);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, long paramLong, int paramInt)
  {
    ...
    ansi localansi = new ansi();
    Object localObject2 = (annx)paramQQAppInterface.getManager(155);
    ApolloGameData localApolloGameData = ((annx)localObject2).a(paramInt);
    Object localObject1 = anzj.a(2131701026);
    if ((localApolloGameData != null) && (!TextUtils.isEmpty(localApolloGameData.name)))
    {
      localObject2 = ((annx)localObject2).a(localApolloGameData.actionId);
    ...
    for (;;)
    {
      int i = localApolloGameData.actionId;
      localansi.jdField_b_of_type_JavaLangString = localApolloGameData.name;
      localansi.jdField_a_of_type_JavaLangString = ((String)localObject1);
      localansi.jdField_b_of_type_Int = i;
      localansi.jdField_a_of_type_Int = paramInt;
      localansi.jdField_a_of_type_Long = paramLong;
      localansi.e = 0;
      ...
      if (!TextUtils.isEmpty(localansi.jdField_a_of_type_JavaLangString)) {
        ((ApolloMessage)localObject2).name = localansi.jdField_a_of_type_JavaLangString.getBytes();
      }
      localObject1 = null;
      if (0 == 0) {}
      for (;;)
      {
        try
        {
          ...
          ((JSONObject)localObject1).put("gameId", localansi.jdField_a_of_type_Int);
          ((JSONObject)localObject1).put("gameMode", localansi.jdField_c_of_type_Int);
          ((JSONObject)localObject1).put("roomid", localansi.jdField_a_of_type_Long);
          if (localansi.jdField_a_of_type_Int == 1)
          {
            ((JSONObject)localObject1).put("msgTyep", 2);
            ((JSONObject)localObject1).put("gameName", localansi.jdField_b_of_type_JavaLangString);
            if (!TextUtils.isEmpty(localansi.jdField_c_of_type_JavaLangString)) {
              ((JSONObject)localObject1).put("gameExtendJson", localansi.jdField_c_of_type_JavaLangString);
            }
            ((JSONObject)localObject1).put("gameStatus", localansi.e);
            if (localObject1 != null) {
              ((ApolloMessage)localObject2).extStr = ((JSONObject)localObject1).toString();
            }
            localObject1 = ((amsx)paramQQAppInterface.getManager(153)).b(paramQQAppInterface.getCurrentAccountUin());
            ((ApolloMessage)localObject2).sender_ts = bhjx.a(((ApolloBaseInfo)localObject1).apolloServerTS);
            ...
            localObject1 = bcry.a(paramQQAppInterface, paramString1, paramQQAppInterface.getCurrentAccountUin(), 1036, (ApolloMessage)localObject2);
            if (localansi.jdField_a_of_type_Int != 1) {
              break label698;
            }
            ((MessageForApollo)localObject1).msgType = 2;
            ((MessageForApollo)localObject1).gameId = localansi.jdField_a_of_type_Int;
            ((MessageForApollo)localObject1).mGameMode = localansi.jdField_c_of_type_Int;
            ((MessageForApollo)localObject1).roomId = localansi.jdField_a_of_type_Long;
            ((MessageForApollo)localObject1).mApolloMessage.id = localansi.jdField_b_of_type_Int;
            ((MessageForApollo)localObject1).gameName = localansi.jdField_b_of_type_JavaLangString;
            ((MessageForApollo)localObject1).gameExtendJson = localansi.jdField_c_of_type_JavaLangString;
            ((MessageForApollo)localObject1).gameStatus = localansi.e;
            ((MessageForApollo)localObject1).extendJson = ("{\"gameStatus\":" + localansi.e + ",\"robotOpenId\":" + paramString2 + "}");
            ...
            jdField_a_of_type_Long = System.currentTimeMillis();
            return;
            localansi.jdField_b_of_type_JavaLangString = anzj.a(2131701028);
            i = 0;
            break;
          }
          ((JSONObject)localObject1).put("msgTyep", localansi.d);
          continue;
          ((MessageForApollo)localObject1).msgType = localansi.d;
        }
        catch (Throwable paramQQAppInterface)
        {
          QLog.d("CmGameTemp_CmGameSessionUtil", 2, paramQQAppInterface, new Object[0]);
  ...
  public static boolean a()
  {
    if ((BaseActivity.sTopActivity instanceof FragmentActivity))
    {
      ...
      if (localObject != null)
      {
        ...
        if (!(localObject instanceof aihy)) {}
      }
    }
    for (Object localObject = (aihy)localObject;; localObject = null) {
      return (localObject != null) && (((aihy)localObject).E());
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      aean.b(paramQQAppInterface, localSessionInfo, (ArkAppMessage)localObject);
      return true;
    }
