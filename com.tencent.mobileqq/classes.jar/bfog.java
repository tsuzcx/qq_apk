  ...
  implements Handler.Callback, NotificationReportController
{
  ...
  private List<bfoh> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  private void a()
  {
    ...
    for (QQAppInterface localQQAppInterface = (QQAppInterface)localObject;; localQQAppInterface = null)
    {
      if ((localQQAppInterface != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
      {
        ...
        {
          bfoh localbfoh = (bfoh)localIterator.next();
          boolean bool = a(localQQAppInterface, localbfoh.b);
          localObject = "";
          switch (localbfoh.jdField_a_of_type_Int)
          {
          default: 
            label132:
            if ((localbfoh.c == 7200) || (localbfoh.c == 1008) || (localbfoh.c == 7220)) {
              axqy.a(localQQAppInterface, bool, "tech_push", "push", (String)localObject, "", 0, "", "", localbfoh.jdField_a_of_type_JavaLangString, localbfoh.b + "", "" + localbfoh.c, "", "", "", "");
            }
            break;
          }
          while (QLog.isDevelopLevel())
          {
            QLog.d("NotificationReportControllerImpl", 2, "report real msgType:" + localbfoh.jdField_a_of_type_Int + "    frienduin:" + localbfoh.jdField_a_of_type_JavaLangString + "   uinType:" + localbfoh.c + "    nId:" + localbfoh.b);
            break;
            ...
            break label132;
            axqy.a(localQQAppInterface, bool, "tech_push", "push", (String)localObject, "", 0, "", "", "", localbfoh.b + "", "", "", "", "", "");
          }
        }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 3: 
    case 4: 
      paramMessage = (bfoh)paramMessage.obj;
  ...
  public void report(int paramInt1, int paramInt2, String paramString, int paramInt3)
  {
    ...
    localMessage.obj = new bfoh(paramInt1, paramInt2, paramString, paramInt3);
