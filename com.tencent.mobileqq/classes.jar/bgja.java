...
public class bgja
{
  ...
  public static bgim a(bcdp parambcdp, bgii parambgii)
  {
    if (jdField_a_of_type_Bgil == null) {
      return null;
    }
    return jdField_a_of_type_Bgil.a(parambcdp, parambgii);
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    localbglq.b = "comic_plugin.apk";
    localbglq.d = "comic_plugin";
  ...
  {
    if (jdField_a_of_type_Bgiy == null) {
      jdField_a_of_type_Bgiy = new bgiy();
    }
    for (;;)
    {
      jdField_a_of_type_Bgiy.addObserver(paramObserver);
      return;
      jdField_a_of_type_Bgiy.deleteObservers();
    }
  }
  
  public static boolean a(Activity paramActivity, Intent paramIntent, String paramString, aqyd paramaqyd)
  {
    ...
    localbglq.jdField_a_of_type_JavaLangClass = VipComicProxyActivity.a(paramString);
    localbglq.jdField_a_of_type_AndroidContentIntent = paramIntent;
    localbglq.c = 10000;
    localbglq.jdField_a_of_type_Aqyd = paramaqyd;
  ...
  public static boolean a(AppRuntime paramAppRuntime)
  {
    ...
    do
    {
      do
      {
        ...
        paramAppRuntime = (bglh)paramAppRuntime.getManager(27);
  ...
  public static boolean a(AppRuntime paramAppRuntime, boolean paramBoolean, bgjd arg2)
  {
    boolean bool = false;
  ...
  public static void b(Observer paramObserver)
  {
    ...
    for (;;)
    {
      jdField_a_of_type_Bgjh.addObserver(paramObserver);
      return;
      jdField_a_of_type_Bgjh.deleteObservers();
    }
  }
}
