  ...
  extends RemoteCommand
{
  ...
  public bgmb(QQAppInterface paramQQAppInterface)
  {
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    case 1: 
      ...
      paramOnInvokeFinishLinstener.putString("result_key", bbcl.h(this.a, paramBundle));
      return paramOnInvokeFinishLinstener;
    }
    String str = paramBundle.getString("param_uin");
    boolean bool = paramBundle.getBoolean("param_fetch_if_not_exist", false);
    paramOnInvokeFinishLinstener.putString("result_key", bbcl.b(this.a, str, bool));
    return paramOnInvokeFinishLinstener;
  }
}
