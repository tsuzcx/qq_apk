  ...
  extends spi
{
  ...
  public sqf(sqe paramsqe, View paramView, BaseData paramBaseData)
  {
  ...
  {
    ViewFactory.findClickableViewListener(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerContainer.getVirtualView(), new sqg(this, paramContext));
  }
  ...
  public void b(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    sqe.a(this.jdField_a_of_type_Sqe, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerContainer);
    if ((paramBaseData2 instanceof RecommendAdData)) {
      sqe.a(this.jdField_a_of_type_Sqe, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewContainerContainer, (RecommendAdData)paramBaseData2);
    }
    try
    {
      ...
      a(sqe.a(this.jdField_a_of_type_Sqe), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataProteusItemData.c);
      return;
    }
    catch (Exception paramBaseData1)
    {
      for (;;)
      {
        tpx.a("WebFastProteusViewAdCreator", paramBaseData1.getMessage());
      }
    }
  }
}
