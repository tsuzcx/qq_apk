...
public class bfqu
{
  ...
  public static final HashMap<String, bfqw> a;
  public static Hashtable<String, TroopBarPublishActivity.Pic_list> a;
  protected static final String b;
  public static final HashMap<String, bfqw> b;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anni.a(2131713903);
    jdField_b_of_type_JavaLangString = anni.a(2131713913);
    jdField_c_of_type_JavaLangString = anni.a(2131713894);
    d = anni.a(2131713890);
  ...
  public static final Uri a(BaseActivity paramBaseActivity, String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      for (boolean bool = true; (bool) && (paramString.canWrite()); bool = paramString.mkdirs()) {
        try
        {
          ...
          Uri localUri = FileProvider7Helper.setSystemCapture(paramBaseActivity, new File(anhk.bg + System.currentTimeMillis() + ".jpg"), paramString);
    ...
    QQToast.a(paramBaseActivity, 2131695573, 1).b(paramBaseActivity.getTitleBarHeight());
    return null;
  }
  ...
  public static final String a(EditText paramEditText)
  {
    ...
    if ((paramEditText.getEditableText() instanceof bdod))
    {
      bdod localbdod = (bdod)paramEditText.getEditableText();
      if (localbdod != null)
      {
        int i = localbdod.length();
        Object localObject1 = new char[i];
        localbdod.getChars(0, i, (char[])localObject1, 0);
        paramEditText = new StringBuffer();
        paramEditText.append((char[])localObject1);
        localObject1 = (bdoa[])localbdod.getSpans(0, i, bdoa.class);
        if (((localbdod instanceof Spanned)) && (Build.VERSION.SDK_INT >= 24)) {
          Arrays.sort((Object[])localObject1, new bfqv(localbdod));
        }
        int k = 0;
        if (j < localObject1.length)
        {
          ...
          int m;
          if (((bdoa)localObject2).c == 1)
          {
            i = localbdod.getSpanStart(localObject2);
            m = localbdod.getSpanEnd(localObject2);
            localObject2 = arvq.a(((bdoa)localObject2).a & 0x7FFFFFFF);
      ...
      catch (Exception localException1)
      {
        try
        {
          ...
          if (paramString.indexOf(bdnh.a[i]) != -1) {
            str = paramString.replace(bdnh.a[i], "\024" + (char)i);
          }
          i += 1;
          paramString = str;
        }
  ...
  public static final JSONObject a(String paramString1, Context paramContext, String paramString2, String paramString3, String paramString4, Map<String, String> paramMap)
  {
    ...
    for (paramContext = new HashMap();; paramContext = paramMap)
    {
      ...
      paramString1 = nlw.a(paramString1, paramString3, paramString4, paramContext, localHashMap2, localHashMap1);
      if (QLog.isColorLevel())
      {
        QLog.d("TroopBar", 2, "singleUploadImage t = " + (System.currentTimeMillis() - l) + ", path = " + paramString2 + ", size = " + atwl.a(paramString2));
  ...
  public static final void a(Context paramContext, String paramString1, String paramString2, int paramInt, String paramString3, String paramString4, String paramString5)
  {
    ...
    bcst.b(null, "P_CliOper", "BizTechReport", "", paramString1, paramString2, 0, paramInt, "" + i, paramString3, paramString4, paramString5);
  }
  
  public static void a(Context paramContext, String paramString1, String paramString2, Bundle paramBundle1, String paramString3, int paramInt, Bundle paramBundle2, bfpo parambfpo, String paramString4)
  {
    if ((paramBundle1 != null) && (!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)))
    {
      paramBundle1.putString("version", "8.4.1");
      ...
      new bfpn(paramString3, paramString4, parambfpo, paramInt, paramBundle2).execute(new HashMap[] { paramString1 });
    }
  ...
  public static void a(BaseActivity paramBaseActivity, Bundle paramBundle1, String paramString, int paramInt, Bundle paramBundle2, bfpo parambfpo)
  {
    a(paramBaseActivity, paramBundle1, paramString, paramInt, paramBundle2, parambfpo, "GET");
  }
  
  protected static void a(BaseActivity paramBaseActivity, Bundle paramBundle1, String paramString1, int paramInt, Bundle paramBundle2, bfpo parambfpo, String paramString2)
  {
    AppRuntime localAppRuntime = paramBaseActivity.getAppRuntime();
    String str = localAppRuntime.getAccount();
    a(paramBaseActivity, str, ((TicketManager)localAppRuntime.getManager(2)).getSkey(str), paramBundle1, paramString1, paramInt, paramBundle2, parambfpo, paramString2);
  }
  ...
  {
    bcst.b(null, "P_CliOper", paramString1, "", paramString2, paramString3, 0, 0, paramString4, paramString5, paramString6, paramString7);
  }
  ...
  public static void b(BaseActivity paramBaseActivity, Bundle paramBundle1, String paramString, int paramInt, Bundle paramBundle2, bfpo parambfpo)
  {
    a(paramBaseActivity, paramBundle1, paramString, paramInt, paramBundle2, parambfpo, "POST");
  }
  ...
  {
    bcst.b(null, "dc00899", "Grp_tribe", "", paramString1, paramString2, 0, 0, paramString3, paramString4, paramString5, paramString6);
  }
}
