...
public class ahpe
  implements ahqq, Handler.Callback, View.OnClickListener
{
  private static final String jdField_a_of_type_JavaLangString = amtj.a(2131700421);
  private static final String jdField_b_of_type_JavaLangString = amtj.a(2131700422);
  ...
  public ahpe(BaseActivity paramBaseActivity, ahqs paramahqs)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_Ahqs = paramahqs;
    this.jdField_a_of_type_Bily = ((bily)paramBaseActivity.app.getManager(165));
  ...
  {
    paramVarArgs = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).inflate(2131558651, null);
  ...
  {
    if ((paramMessage.what == 1) && (this.jdField_a_of_type_Ahqs.a() == this)) {
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00899", "Qidian", this.f, "0X8009788", "ClickLawTip", 1, 0, String.valueOf(NetConnInfoCenter.getServerTime()), this.jdField_a_of_type_Bily.a(this.f), "8.4.8", "");
      continue;
      ...
      this.jdField_a_of_type_AndroidOsHandler.removeMessages(1);
      this.jdField_a_of_type_Ahqs.a();
      bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00899", "Qidian", this.f, "0X8009789", "CloseLawTip", 1, 0, String.valueOf(NetConnInfoCenter.getServerTime()), this.jdField_a_of_type_Bily.a(this.f), "8.4.8", "");
    }
  }
}
