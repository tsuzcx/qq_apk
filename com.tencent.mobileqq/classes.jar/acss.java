...
{
  private acrv jdField_a_of_type_Acrv;
  private acsg jdField_a_of_type_Acsg;
  private acsm jdField_a_of_type_Acsm;
  ...
  public acss(acsz paramacsz, View paramView, acsg paramacsg)
  {
    acvc.a("GdtMvElementsController", "GdtMvElementsController: ");
  ...
  private ImageView a(int paramInt)
  {
    ...
    if (2 == paramInt) {
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130838506));
    }
    do
    {
      ...
      if (1 == paramInt)
      {
        localImageView.setImageDrawable(this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130838500));
        return localImageView;
      }
    } while (3 != paramInt);
    localImageView.setImageDrawable(this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130838501));
    return localImageView;
  }
  ...
  private URLDrawable a(String paramString)
  {
    ...
    int i = acwn.a(140, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
    paramString.setTag(bhez.b(i, i, acwn.a(21, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext))));
  ...
  private void a(double paramDouble, LinearLayout paramLinearLayout)
  {
    ...
    for (;;)
    {
      ...
      if (paramDouble < 8.0D)
      {
        ...
        k = 4;
        i = 1;
        m = agej.a(15.0F, this.jdField_a_of_type_AndroidViewView.getResources());
      ...
      label133:
      for (localLayoutParams.leftMargin = 0;; localLayoutParams.leftMargin = agej.a(3.0F, this.jdField_a_of_type_AndroidViewView.getResources()))
      {
  ...
  {
    Object localObject1 = this.jdField_a_of_type_Acsg.a();
  ...
  private void a(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean)
        {
          j = acwn.e(this.jdField_a_of_type_AndroidContentContext);
          localLayoutParams.height = acwn.a(paramInt, i, j);
          this.jdField_b_of_type_AndroidViewView.setBackground(acwn.a(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165666), 8, 80));
          this.jdField_b_of_type_AndroidViewView.setVisibility(0);
          this.jdField_b_of_type_AndroidViewView.setLayoutParams(localLayoutParams);
          acvc.b("GdtMvElementsController", "initDesMaskPositions " + paramInt + "|" + paramBoolean);
          return;
        }
        int j = acwn.f(this.jdField_a_of_type_AndroidContentContext);
        continue;
      ...
      {
        this.jdField_b_of_type_AndroidViewView.setVisibility(8);
        acvc.d("GdtMvElementsController", "initDesMaskPositions error! ", localThrowable);
        return;
      }
      return;
      label184:
  ...
  private void a(String paramString)
  {
    ...
    if (this.jdField_c_of_type_AndroidWidgetTextView != null)
    {
      ...
      {
        acvc.a("GdtMvElementsController", "updateScoreAndStar " + paramString);
        ...
        acvc.a("GdtMvElementsController", "updateScoreAndStar " + this.jdField_b_of_type_AndroidWidgetTextView.getWidth() + " mw " + f);
  ...
  private String b()
  {
    ...
    if (localObject != null)
    {
      ...
      if (!((qq_ad_get.QQAdGetRsp.AdInfo)localObject).display_info.button_info.get().isEmpty())
      {
        ...
        acvc.b("GdtMvElementsController", "getContentStrByStyle pushName " + str2);
        ...
        {
          str1 = str2;
          if (nzq.a(this.jdField_a_of_type_AndroidContentContext, (String)localObject))
          {
            if (!localGdtMotiveVideoPageData.isStyleC()) {
              break label158;
            }
            str1 = anzj.a(2131704095);
          }
        }
      }
    }
    return str1;
    label158:
    return anzj.a(2131704096);
    label165:
    if (a())
    {
      if (nzq.a(this.jdField_a_of_type_AndroidContentContext, (String)localObject)) {
        return anzj.a(2131704097);
      }
      return anzj.a(2131704099);
    }
    return anzj.a(2131704101);
  }
  ...
  private void i()
  {
    ...
    localLayoutParams.width = acwn.a(140, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.height = localLayoutParams.width;
    localLayoutParams.topMargin = acwn.a(1054, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acwn.a(30, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetTextView.getLayoutParams();
    localLayoutParams.topMargin = acwn.a(1063, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acwn.a(196, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_b_of_type_AndroidWidgetTextView.getLayoutParams();
    localLayoutParams.topMargin = acwn.a(1111, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acwn.a(196, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_b_of_type_AndroidWidgetLinearLayout.getLayoutParams();
    localLayoutParams.topMargin = acwn.a(1160, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acwn.a(196, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
    ...
    localLayoutParams.height = acwn.a(80, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.topMargin = acwn.a(1224, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acwn.a(30, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
    ...
    localLayoutParams.height = acwn.a(129, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.topMargin = acwn.a(1199, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acwn.a(5, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.rightMargin = localLayoutParams.leftMargin;
    acvc.a("GdtMvElementsController", "inti585Vpositions() urlBtnLp2.topMargin = " + localLayoutParams.topMargin + ", urlBtnLp2.height = " + localLayoutParams.height);
    ((RelativeLayout.LayoutParams)this.jdField_c_of_type_AndroidViewView.getLayoutParams()).height = acwn.a(315, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
  }
  ...
  private void j()
  {
    ...
    localLayoutParams.width = acwn.a(140, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.height = localLayoutParams.width;
    localLayoutParams.topMargin = acwn.a(580, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acwn.a(30, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetTextView.getLayoutParams();
    localLayoutParams.topMargin = acwn.a(589, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acwn.a(196, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_b_of_type_AndroidWidgetTextView.getLayoutParams();
    localLayoutParams.topMargin = acwn.a(637, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acwn.a(196, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_b_of_type_AndroidWidgetLinearLayout.getLayoutParams();
    localLayoutParams.topMargin = acwn.a(685, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acwn.a(196, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.getLayoutParams();
    localLayoutParams.height = acwn.a(80, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.topMargin = acwn.a(611, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acwn.a(1034, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.rightMargin = acwn.a(30, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetButton.getLayoutParams();
    localLayoutParams.height = acwn.a(129, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.topMargin = acwn.a(586, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acwn.a(1009, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.rightMargin = acwn.a(5, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    ((RelativeLayout.LayoutParams)this.jdField_c_of_type_AndroidViewView.getLayoutParams()).height = acwn.a(200, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
  }
  
  private void k()
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
      ((RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams()).topMargin = acwn.a(742, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    }
    ...
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.setHeight(acwn.a(80, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext)));
    localLayoutParams.topMargin = acwn.a(1224, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acwn.a(30, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.rightMargin = localLayoutParams.leftMargin;
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetButton.getLayoutParams();
    this.jdField_a_of_type_AndroidWidgetButton.setHeight(acwn.a(129, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext)));
    localLayoutParams.topMargin = acwn.a(1199, 1334, acwn.e(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.leftMargin = acwn.a(5, 750, acwn.f(this.jdField_a_of_type_AndroidContentContext));
    localLayoutParams.rightMargin = localLayoutParams.leftMargin;
  }
  ...
  private void l()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_AndroidWidgetImageView != null) {
        this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130845496);
      }
    }
  }
  ...
  {
    GdtMotiveVideoPageData localGdtMotiveVideoPageData = this.jdField_a_of_type_Acsg.a();
    qq_ad_get.QQAdGetRsp.AdInfo localAdInfo = this.jdField_a_of_type_Acsg.a();
    Activity localActivity = this.jdField_a_of_type_Acsz.a().a();
    if (localActivity != null)
    {
      acvc.b("GdtMvElementsController", "doHandleClick");
  ...
  private void o()
  {
    int i = this.jdField_a_of_type_Acsg.a().exp_info.video_volume.get();
    acvc.a("GdtMvElementsController", "[initData] videoVolume = " + i);
    acsz localacsz = this.jdField_a_of_type_Acsz;
    if (i == 0) {}
    for (boolean bool = true;; bool = false)
    {
      localacsz.jdField_a_of_type_Boolean = bool;
      return;
    }
  }
  ...
  public void a()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362034));
    this.e = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362037));
    ...
    if (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight != null)
    {
      ...
      this.jdField_a_of_type_Acrv.a(this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight);
    }
    if (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView != null)
    {
      ...
      this.jdField_a_of_type_Acrv.a(this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView);
    }
    if (this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView != null)
    {
      ...
      this.jdField_a_of_type_Acrv.a(this.jdField_b_of_type_ComTencentGdtadApiMotivevideoGdtMvAppBtnView);
    }
    ...
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131367444);
    if (this.jdField_c_of_type_AndroidViewView != null)
    {
      this.jdField_a_of_type_Acrv.a(this.jdField_c_of_type_AndroidViewView);
      this.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
      this.jdField_c_of_type_AndroidViewView.setOnHoverListener(this);
    }
    this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131367445);
    if (this.jdField_d_of_type_AndroidViewView != null)
    {
      this.jdField_a_of_type_Acrv.a(this.jdField_d_of_type_AndroidViewView);
      this.jdField_d_of_type_AndroidViewView.setOnClickListener(this);
    }
    if ((((GdtMotiveVideoPageData)localObject).vSize != 585) && (((GdtMotiveVideoPageData)localObject).screenOrientation == 1)) {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363595));
    }
  ...
  {
    GdtMotiveVideoPageData localGdtMotiveVideoPageData = this.jdField_a_of_type_Acsg.a();
    acvc.b("GdtMvElementsController", "adjustViewsPosition " + paramInt + " style " + localGdtMotiveVideoPageData.style);
    if (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight != null) {
    ...
    if (localGdtMotiveVideoPageData.screenOrientation == 1)
    {
      if (localGdtMotiveVideoPageData.vSize == 585)
      {
        ...
        {
          this.jdField_a_of_type_Acso = new acso(this.jdField_a_of_type_AndroidContentContext);
          this.jdField_a_of_type_Acso.a(this.jdField_b_of_type_AndroidViewView, this.jdField_b_of_type_AndroidWidgetRelativeLayout, this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight, this.jdField_a_of_type_AndroidWidgetImageView, this.jdField_a_of_type_AndroidWidgetTextView, this.jdField_b_of_type_AndroidWidgetTextView, this.jdField_b_of_type_AndroidWidgetLinearLayout, this.jdField_c_of_type_AndroidViewView);
        }
        this.jdField_a_of_type_Acso.a(paramInt);
      }
      while (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null) {
        return;
      }
      if (this.jdField_a_of_type_Acsn == null)
      {
        this.jdField_a_of_type_Acsn = new acsn(this.jdField_a_of_type_AndroidContentContext);
        this.jdField_a_of_type_Acsn.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout, this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight, this.jdField_b_of_type_AndroidWidgetRelativeLayout, this.jdField_c_of_type_AndroidViewView);
      }
      this.jdField_a_of_type_Acsn.a(paramInt);
      return;
    }
    if (this.jdField_a_of_type_Acsm == null)
    {
      this.jdField_a_of_type_Acsm = new acsm(this.jdField_a_of_type_AndroidContentContext);
      this.jdField_a_of_type_Acsm.a(this.jdField_b_of_type_AndroidViewView, this.jdField_b_of_type_AndroidWidgetRelativeLayout, this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight, this.jdField_a_of_type_AndroidWidgetImageView, this.jdField_a_of_type_AndroidWidgetTextView, this.jdField_b_of_type_AndroidWidgetTextView, this.jdField_b_of_type_AndroidWidgetLinearLayout, this.jdField_c_of_type_AndroidViewView);
    }
    this.jdField_a_of_type_Acsm.a(paramInt);
  }
  ...
  public void a(int paramInt, String paramString)
  {
    GdtMotiveVideoPageData localGdtMotiveVideoPageData = this.jdField_a_of_type_Acsg.a();
    qq_ad_get.QQAdGetRsp.AdInfo localAdInfo = this.jdField_a_of_type_Acsg.a();
    long l = this.jdField_a_of_type_Acsz.a();
    String str2 = "";
    String str1;
    switch (paramInt)
    {
    ...
    for (;;)
    {
      ...
      return;
      acvc.a("GdtMvElementsController", "[click ad btn] " + localAdInfo);
      Activity localActivity = this.jdField_a_of_type_Acsz.a().a();
      str1 = str2;
      if (localAdInfo != null)
      {
        ...
        if (localActivity != null)
        {
          ...
          paramString = this.jdField_a_of_type_Acrv.a(str1, l, this.jdField_a_of_type_Acsz.a(), this.jdField_a_of_type_Acsz.b(), paramString);
          localAdInfo.report_info.click_url.set(paramString);
          m();
          GdtHandler.a(a(localAdInfo, localGdtMotiveVideoPageData, localActivity));
          continue;
          acvc.a("GdtMvElementsController", "[click ad download btn] ");
          str1 = str2;
          if (localAdInfo != null)
          {
            str1 = localAdInfo.report_info.click_url.get();
            ...
            if ((localAdInfo.exp_info.reward_video_download_type.get() == 1) && (localAdInfo.product_type.get() == 12) && (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvDownloadBtnManager != null))
            {
              ...
              if (nzq.a(this.jdField_a_of_type_AndroidContentContext, paramString)) {
                n();
              } else {
  ...
  public void b()
  {
    Drawable localDrawable = this.jdField_a_of_type_AndroidViewView.getResources().getDrawable(2130840234);
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.setBackgroundDrawable(localDrawable);
    int i = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167183);
    this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.setTextColor(i);
  }
  
  public void c()
  {
    acvc.b("GdtMvElementsController", "enableMvBtnUrlStyleDefault");
    if (this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight != null)
    {
      this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.setBackgroundDrawable(this.jdField_a_of_type_AndroidViewView.getResources().getDrawable(2130840223));
      this.jdField_a_of_type_ComTencentGdtadApiMotivevideoGdtMvButtonHighLight.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167302));
    }
  }
  ...
  public void e()
  {
    ...
    if (this.jdField_a_of_type_Acso != null)
    {
      this.jdField_a_of_type_Acso.b();
      this.jdField_a_of_type_Acso = null;
    }
    if (this.jdField_a_of_type_Acsn != null)
    {
      this.jdField_a_of_type_Acsn.b();
      this.jdField_a_of_type_Acsn = null;
    }
    if (this.jdField_a_of_type_Acsm != null)
    {
      this.jdField_a_of_type_Acsm.b();
      this.jdField_a_of_type_Acsm = null;
    }
    ...
    if (this.jdField_a_of_type_Acrv != null) {
  ...
  public void g()
  {
    acvc.a("GdtMvElementsController", "onResume: ");
    d();
    f();
  }
  ...
  public boolean onHover(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    {
      return false;
      acvc.d("GdtMvElementsController", "onHover " + paramMotionEvent.getAction());
