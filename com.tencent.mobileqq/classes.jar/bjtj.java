  ...
  implements bhtv
{
  ...
  private Object a()
  {
    ...
    try
    {
      ...
      bjtl localbjtl = new bjtl(this);
      this.jdField_b_of_type_JavaLangObject = Proxy.newProxyInstance(localClassLoader, new Class[] { localClass }, localbjtl);
      return this.jdField_b_of_type_JavaLangObject;
    }
  ...
  public void a()
  {
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_ComTencentWidgetListView != null)) {
      this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(new bidb(null));
    }
  }
  ...
  public void a(Activity paramActivity, QQAppInterface paramQQAppInterface, Card paramCard, ListView paramListView, View paramView)
  {
    ...
    bjho.a(new bjtk(this, paramActivity, paramQQAppInterface, paramListView, paramCard));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Activity paramActivity, ListView paramListView, Card paramCard)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramQQAppInterface != bjho.a()) {
          bjho.a(paramActivity, paramQQAppInterface);
        }
