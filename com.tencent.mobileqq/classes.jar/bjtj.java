  ...
  extends bjts
{
  ...
  public bjtj()
  {
    this.jdField_a_of_type_JavaLangString = bjtj.class.getSimpleName();
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          adky.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), paramString3, PublicTransFragmentActivity.class, ActivateFriendShareFragment.class);
          return false;
        }
