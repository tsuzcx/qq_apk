  ...
  extends BaseJsPlugin
{
  ...
  {
    MiniAppController.getInstance().setActivityResultListener(new bjtk(this, paramRequestEvent));
    ...
    paramRequestEvent.fail(anni.a(2131704147));
  }
  ...
  public void getMultiMemList(RequestEvent paramRequestEvent)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramRequestEvent)
      {
        ...
        return;
        paramRequestEvent.fail(anni.a(2131704148));
        return;
        if (localJSONObject != null) {
          continue;
        }
      ...
      {
        paramRequestEvent.fail(anni.a(2131704149));
        return;
