...
public class bifx
  extends bifz
  implements bibv, IEventReceiver
{
  ...
  public bifx(@NonNull bigb parambigb)
  {
    super(parambigb);
  }
  ...
  private void b(long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_AndroidOsHandler != null)
    {
      ...
      if (localObject != null)
      {
        ...
        ((bigl)localObject).b(paramLong, paramBoolean1);
      }
    }
    for (;;)
    {
      ...
      if (localObject != null) {
        ((bibw)localObject).a(paramLong);
      }
      return;
      label340:
      ((bigl)localObject).a(paramLong, paramBoolean1);
    }
  }
  ...
  public void a()
  {
    ...
    {
      long l = ((EditLocalVideoSource)this.jdField_a_of_type_Bigb.a.a).a * -1;
  ...
  public void b()
  {
    Object localObject = (bigl)a(bigl.class);
    if (localObject != null) {
      ((bigl)localObject).k();
    }
    localObject = (bibw)a(bibw.class);
    if (localObject != null) {
      ((bibw)localObject).ae_();
    }
  }
  ...
  public boolean h_()
  {
    ...
    bigl localbigl = (bigl)a(bigl.class);
    if (localbigl != null) {
      this.jdField_b_of_type_Boolean = localbigl.a(this.c);
    }
