...
public class lpc
{
  ...
  public lpc(lle paramlle)
  {
    if ((paramlle != null) && (!paramlle.a()) && (paramlle.a().contains(jdField_a_of_type_JavaLangString))) {
      this.jdField_a_of_type_Int = 2;
    }
    this.jdField_a_of_type_Lle = paramlle;
    if (this.jdField_a_of_type_Int == 2) {}
    for (paramlle = c;; paramlle = b)
    {
      this.aq = paramlle;
  ...
  public static int a(lct paramlct)
  {
    if (Build.VERSION.SDK_INT < 16) {}
    while ((paramlct == null) || (Build.VERSION.SDK_INT < paramlct.c) || (!a(paramlct.jdField_a_of_type_JavaLangString, null)) || (mqs.a(paramlct.jdField_a_of_type_JavaUtilArrayList, Integer.valueOf(Build.VERSION.SDK_INT)))) {
      return 0;
    }
    if ((paramlct.d != 0) && (Build.VERSION.SDK_INT >= 21) && (Build.VERSION.SDK_INT >= paramlct.d)) {
      return 2;
    }
    return 1;
  }
  ...
  static boolean a(String paramString, String[] paramArrayOfString)
  {
    ...
    if ((paramArrayOfString != null) && (paramArrayOfString != null))
    {
      ...
      for (;;)
      {
        ...
        if (muf.a(paramArrayOfString[i1]) == i2) {
          break;
        }
        i1 += 1;
      }
  ...
  public loy a()
  {
    ...
    for (;;)
    {
      ...
      if (Build.VERSION.SDK_INT >= 16)
      {
        loy localloy = new loy(4, true);
        try
        {
          Object localObject = a(this.jdField_a_of_type_Lle, this.W);
          if ((localObject != null) && (Build.VERSION.SDK_INT >= localObject[0]) && (a(this.jdField_a_of_type_Lle, this.X, this.ac)))
          {
            localObject = a(this.jdField_a_of_type_Lle, this.ab);
            int i1;
            if (localObject != null)
            {
              i1 = 0;
            ...
            label122:
            localObject = a(this.jdField_a_of_type_Lle, this.Y);
            if (localObject != null)
            {
              i1 = 0;
              for (;;)
            ...
            label170:
            localObject = a(this.jdField_a_of_type_Lle, this.Z);
            if (localObject != null)
            {
              i1 = 0;
              for (;;)
            ...
            label218:
            localObject = a(this.jdField_a_of_type_Lle, this.aa);
            if (localObject != null)
            {
              i1 = i2;
              for (;;)
            ...
            label266:
            localObject = a(this.jdField_a_of_type_Lle, this.ad);
            if ((localObject != null) && (localObject[0] > 0)) {
              localloy.b = localObject[0];
            }
            localObject = a(this.jdField_a_of_type_Lle, this.ae);
            if ((localObject != null) && (localObject[0] > 0)) {
              localloy.c = localObject[0];
            }
            return localloy;
          }
        }
  ...
  public boolean a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        int[] arrayOfInt = a(this.jdField_a_of_type_Lle, this.ao);
        if ((arrayOfInt != null) && (Build.VERSION.SDK_INT >= 21) && (Build.VERSION.SDK_INT >= arrayOfInt[0]))
        {
          arrayOfInt = a(this.jdField_a_of_type_Lle, this.ap);
          if (arrayOfInt != null)
          {
            boolean bool = mqs.a(arrayOfInt, paramInt);
            if (bool) {
              return true;
            }
          }
  ...
  boolean a(lle paramlle, String paramString1, String paramString2)
  {
    if (this.jdField_a_of_type_Int != 2) {}
    for (;;)
    {
      return true;
      int i2 = muf.b();
      if (muf.a(paramlle.a(paramString1, "")) > i2) {
        return false;
      }
      if (paramString2 != null)
      {
        paramlle = paramlle.a(paramString2);
        if (paramlle != null)
        {
          int i3 = paramlle.length;
          int i1 = 0;
          while (i1 < i3)
          {
            if (muf.a(paramlle[i1]) == i2) {
              return false;
            }
            i1 += 1;
          }
  ...
  int[] a(lle paramlle, String paramString)
  {
    if (Build.VERSION.SDK_INT < 16) {
      return null;
    }
    return paramlle.a(paramString);
  }
  
  String[] a(lle paramlle, String paramString)
  {
    if (Build.VERSION.SDK_INT < 16) {
      return null;
    }
  ...
  public loy b()
  {
    ...
    loy localloy = new loy(8, true);
    try
    {
      localObject = a(this.jdField_a_of_type_Lle, this.af);
      if (localObject == null)
      {
    ...
    if (!a(this.jdField_a_of_type_Lle, this.ag, this.al))
    {
      QLog.e("CodecConfigParser", 1, "getHevcEncoderAbility failed. checkQQVer failed.");
      return null;
    }
    Object localObject = a(this.jdField_a_of_type_Lle, this.ak);
    int i1;
    if (localObject != null)
    {
      i1 = 0;
    ...
    localObject = a(this.jdField_a_of_type_Lle, this.ah);
    if (localObject != null)
    {
      i1 = 0;
      label248:
    ...
    localObject = a(this.jdField_a_of_type_Lle, this.ai);
    if (localObject != null)
    {
      i1 = 0;
      label300:
    ...
    localObject = a(this.jdField_a_of_type_Lle, this.aj);
    if (localObject != null) {
      i1 = i2;
    }
    for (;;)
    {
      ...
      {
        localObject = a(this.jdField_a_of_type_Lle, this.am);
        if ((localObject != null) && (localObject[0] > 0)) {
          localException.b = localObject[0];
        }
        localObject = a(this.jdField_a_of_type_Lle, this.an);
        if ((localObject != null) && (localObject[0] > 0)) {
  ...
  public loy c()
  {
    ...
    for (;;)
    {
      ...
      if (Build.VERSION.SDK_INT >= 16)
      {
        loy localloy = new loy(1, true);
        try
        {
          Object localObject = a(this.jdField_a_of_type_Lle, this.E);
          if ((localObject != null) && (Build.VERSION.SDK_INT >= localObject[0]) && (a(this.jdField_a_of_type_Lle, this.F, this.K)))
          {
            localObject = a(this.jdField_a_of_type_Lle, this.J);
            int i1;
            if (localObject != null)
            {
              i1 = 0;
            ...
            label122:
            localObject = a(this.jdField_a_of_type_Lle, this.G);
            if (localObject != null)
            {
              i1 = 0;
              for (;;)
            ...
            label170:
            localObject = a(this.jdField_a_of_type_Lle, this.H);
            if (localObject != null)
            {
              i1 = 0;
              for (;;)
            ...
            label218:
            localObject = a(this.jdField_a_of_type_Lle, this.I);
            if (localObject != null)
            {
              i1 = i2;
              for (;;)
            ...
            label266:
            localObject = a(this.jdField_a_of_type_Lle, this.L);
            if ((localObject != null) && (localObject[0] > 0)) {
              localloy.b = localObject[0];
            }
            localObject = a(this.jdField_a_of_type_Lle, this.M);
            if ((localObject != null) && (localObject[0] > 0)) {
              localloy.c = localObject[0];
            }
            return localloy;
  ...
  public loy d()
  {
    ...
    for (;;)
    {
      ...
      if (Build.VERSION.SDK_INT >= 19)
      {
        loy localloy = new loy(2, true);
        try
        {
          Object localObject = a(this.jdField_a_of_type_Lle, this.N);
          if ((localObject != null) && (Build.VERSION.SDK_INT >= localObject[0]) && (a(this.jdField_a_of_type_Lle, this.O, this.T)))
          {
            localObject = a(this.jdField_a_of_type_Lle, this.S);
            int i1;
            if (localObject != null)
            {
              i1 = 0;
            ...
            label122:
            localObject = a(this.jdField_a_of_type_Lle, this.P);
            if (localObject != null)
            {
              i1 = 0;
              for (;;)
            ...
            label170:
            localObject = a(this.jdField_a_of_type_Lle, this.Q);
            if (localObject != null)
            {
              i1 = 0;
              for (;;)
            ...
            label218:
            localObject = a(this.jdField_a_of_type_Lle, this.R);
            if (localObject != null)
            {
              i1 = i2;
              for (;;)
            ...
            label266:
            localObject = a(this.jdField_a_of_type_Lle, this.U);
            if ((localObject != null) && (localObject[0] > 0)) {
              localloy.b = localObject[0];
            }
            localObject = a(this.jdField_a_of_type_Lle, this.V);
            if ((localObject != null) && (localObject[0] > 0)) {
              localloy.c = localObject[0];
            }
            return localloy;
