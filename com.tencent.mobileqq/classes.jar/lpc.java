...
public class lpc
{
  ...
  private static lpc jdField_b_of_type_Lpc;
  static long d;
  static long e;
  ...
  public static lpc a()
  {
    ...
    {
      if (jdField_b_of_type_Lpc != null)
      {
        lpc locallpc = jdField_b_of_type_Lpc;
        jdField_b_of_type_Lpc = locallpc.jdField_a_of_type_Lpc;
        locallpc.jdField_a_of_type_Lpc = null;
        h -= 1;
        locallpc.jdField_c_of_type_Boolean = false;
        return locallpc;
      }
      return new lpc();
    }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        this.jdField_a_of_type_Lpc = jdField_b_of_type_Lpc;
        jdField_b_of_type_Lpc = this;
        h += 1;
      }
    }
  }
