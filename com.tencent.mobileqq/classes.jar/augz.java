  ...
  extends BroadcastReceiver
{
  ...
  private void a(Intent paramIntent, FileManagerEntity paramFileManagerEntity)
  {
    ...
    for (;;)
    {
      ...
      if (l2 != 0L) {}
      for (paramFileManagerEntity.fProgress = ((float)l1 / (float)l2); this.a.jdField_a_of_type_Augp != null; paramFileManagerEntity.fProgress = 1.0F)
      {
        this.a.jdField_a_of_type_Augp.a(paramFileManagerEntity.fProgress);
        return;
      }
    }
  }
  ...
  private void b(Intent paramIntent, FileManagerEntity paramFileManagerEntity)
  {
    ...
    augr.b(this.a, NetConnInfoCenter.getServerTimeMillis());
    ...
    paramIntent.uNotifyTime = augr.a(this.a);
    paramIntent.uFileSize = l2;
    paramIntent.bFileExist = false;
    paramIntent.uStartPos = 0L;
    paramIntent.uTaskStart = augr.a(this.a);
    paramIntent.uTaskEnd = augr.b(this.a);
    paramIntent.uDuration = (augr.b(this.a) - augr.a(this.a));
    ...
    if (bool)
    {
      ...
      Object localObject = ((anvu)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8)).a().a();
      if (localObject == null) {
        break label489;
      }
      paramIntent.dwServerIP = dp.a(((bmkc)localObject).jdField_a_of_type_JavaLangString);
      paramIntent.wServerPort = ((short)((bmkc)localObject).jdField_a_of_type_Int);
      label281:
      ...
      auna.a(2131693790);
      label366:
      if (this.a.jdField_a_of_type_Augp != null) {
    ...
    for (;;)
    {
      ((anvu)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8)).a().a(paramFileManagerEntity.strDataLineMPFileID);
      if (augr.a(this.a)) {
        break label695;
      }
      paramFileManagerEntity.mContext = "needMPFileC2C";
      QLog.d("MPcFileModel<FileAssistant>", 2, "mConnPCSuc:" + augr.a(this.a) + ",create mEntity.mContext");
      return;
      if (augr.b(this.a))
      {
        i = 32;
      ...
      augr.a(this.a, j + 2100);
      break label366;
      label591:
      paramFileManagerEntity.status = 1;
      paramIntent = ((anvu)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8)).a().b();
      if (paramIntent == null) {
    ...
    label695:
    QLog.d("MPcFileModel<FileAssistant>", 2, "mConnPCSuc:" + augr.a(this.a) + "mEntity.mContext = null");
  ...
  private void c(Intent paramIntent, FileManagerEntity paramFileManagerEntity)
  {
    ...
    long l = paramIntent.getLongExtra(bmka.f, 0L);
    int i = paramFileManagerEntity.getInt(bmka.e);
    ...
    do
    {
      ...
      do
      {
        ...
        case 3: 
        case 4: 
          augr.a(this.a, i + 2000);
        }
      } while (this.a.jdField_a_of_type_Auef == null);
      this.a.jdField_a_of_type_Auef.a(false);
      return;
  ...
  {
    paramContext = this.a.jdField_a_of_type_Auei.a();
    if (paramIntent == null) {}
    String str;
    do
    {
      ...
      if (bmka.d.equalsIgnoreCase(str))
      {
        c(paramIntent, paramContext);
        return;
      }
    } while (!bmka.g.equalsIgnoreCase(str));
    augr.a(this.a, false);
