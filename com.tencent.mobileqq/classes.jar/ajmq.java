  ...
  implements TextWatcher, View.OnClickListener, View.OnTouchListener
{
  ...
  public ajmq(CountryActivity paramCountryActivity, Context paramContext)
  {
    super(paramContext);
    requestWindowFeature(1);
    getWindow().setSoftInputMode(36);
    getWindow().setBackgroundDrawable(new ColorDrawable());
    setContentView(2131558965);
    ...
    this.jdField_a_of_type_Ajmp = new ajmp(paramCountryActivity, null);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Ajmp);
  ...
  void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Ajmp.a(paramString);
    if (this.jdField_a_of_type_Ajmp.getCount() == 0) {
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    }
    for (;;)
    {
      this.jdField_a_of_type_Ajmp.notifyDataSetChanged();
      return;
  ...
  public void dismiss()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 205	achg:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 205	achg:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 205	achg:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
