  ...
  extends Dialog
{
  ...
  private bdjj jdField_a_of_type_Bdjj;
  private bdjk jdField_a_of_type_Bdjk;
  private bdjl jdField_a_of_type_Bdjl;
  private bdjm jdField_a_of_type_Bdjm;
  private bdjn jdField_a_of_type_Bdjn;
  private CharSequence jdField_a_of_type_JavaLangCharSequence;
  private ArrayList<Pair<CharSequence, Integer>> jdField_a_of_type_JavaUtilArrayList;
  private HashMap<CharSequence, bdjd> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private HashSet<Integer> jdField_a_of_type_JavaUtilHashSet;
  public boolean a;
  private int jdField_b_of_type_Int = 300;
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new bdjh(this);
  private CharSequence jdField_b_of_type_JavaLangCharSequence;
  private HashMap<Integer, Drawable> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  protected boolean b;
  private View.OnClickListener jdField_c_of_type_AndroidViewView$OnClickListener = new bdji(this);
  ...
  protected bdje(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    this(paramContext, paramBoolean1, paramBoolean2, true);
  }
  
  @TargetApi(14)
  protected bdje(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    super(paramContext, 2131690142);
    ...
    if ((paramBoolean3) && (bdyn.jdField_a_of_type_Boolean)) {
    ...
    bdyn.a(getWindow(), true);
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131493720, null));
  ...
  private int a(int paramInt)
  {
    ...
    {
    default: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131100148);
    case 0: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131100148);
    case 1: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131100148);
    ...
    case 4: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131100148);
    case 3: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131100152);
    case 5: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131100148);
    case 6: 
      return this.jdField_a_of_type_AndroidContentResResources.getColor(2131100148);
    ...
    return this.jdField_a_of_type_AndroidContentResResources.getColor(2131100155);
  }
  
  public static bdje a(Context paramContext)
  {
    paramContext = new bdje(paramContext, false, false);
    if (Build.VERSION.SDK_INT != 23) {
      paramContext.getWindow().setWindowAnimations(2131690140);
    }
    return paramContext;
  }
  ...
  private void a(TextView paramTextView, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramTextView.setContentDescription(getContext().getString(2131628569) + paramTextView.getText());
      return;
    }
    paramTextView.setContentDescription(getContext().getString(2131628570) + paramTextView.getText());
  }
  ...
  private void b()
  {
    ...
    {
      localObject1 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131493723, null);
      ((View)localObject1).setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840666));
      ((View)localObject1).setOnClickListener(new bdjf(this));
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        if (i < k)
        {
          localObject2 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131493722, null);
          TextView localTextView = (TextView)((View)localObject2).findViewById(2131296378);
          ...
          bdge.a(localTextView, Button.class.getName());
          if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.size() > 0))
          {
            localObject3 = (bdjd)this.jdField_a_of_type_JavaUtilHashMap.get(((Pair)localObject1).first);
            if ((localObject3 != null) && (((bdjd)localObject3).jdField_a_of_type_Int != 0)) {
              localTextView.setId(((bdjd)localObject3).jdField_a_of_type_Int);
            }
          }
          Object localObject3 = (ImageView)((View)localObject2).findViewById(2131296389);
          RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)((ImageView)localObject3).getLayoutParams();
          localLayoutParams.rightMargin = bdyn.a(this.jdField_a_of_type_AndroidContentContext, 15.0F);
          ...
          if (this.jdField_b_of_type_JavaUtilHashMap.containsKey(Integer.valueOf(i)))
          {
            ...
            label415:
            localObject3 = (ImageView)((View)localObject2).findViewById(2131296390);
            ...
            {
              localLayoutParams.width = bdyn.a(this.jdField_a_of_type_AndroidContentContext, 28.0F);
              localLayoutParams.height = bdyn.a(this.jdField_a_of_type_AndroidContentContext, 28.0F);
              localLayoutParams.addRule(15);
            }
            localLayoutParams.rightMargin = bdyn.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
            ((ImageView)localObject3).setLayoutParams(localLayoutParams);
            ...
            if (this.jdField_c_of_type_Boolean)
            {
              ...
              ((View)localObject2).findViewById(2131296379).setVisibility(0);
      ...
      {
        localObject1 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131493721, null);
  ...
  public Drawable a(int paramInt)
  {
    ...
    case 2: 
    default: 
      return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130840665);
    case 0: 
      return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130840662);
    case 3: 
      return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130840665);
    }
    return this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130840669);
  }
  ...
  public void a()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 461	android/app/Dialog:dismiss	()V
    //   4: return
    //   5: astore_1
    //   6: aload_1
    //   7: athrow
  ...
  public void a(bdjj parambdjj)
  {
    this.jdField_a_of_type_Bdjj = parambdjj;
  }
  
  public void a(bdjl parambdjl)
  {
    this.jdField_a_of_type_Bdjl = parambdjl;
  }
  ...
  public void dismiss()
  {
    if (this.jdField_a_of_type_Bdjm != null) {
      this.jdField_a_of_type_Bdjm.a();
    }
    if (this.g)
    {
      this.g = false;
