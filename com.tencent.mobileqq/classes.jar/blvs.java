  ...
  extends QIPCModule
{
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if (MobileQQ.sMobileQQ != null)
    {
      ...
      {
        QQToast.a(MobileQQ.sMobileQQ, MobileQQ.sMobileQQ.getResources().getString(2131716663), 1).a();
        return null;
      }
      paramInt = paramBundle.getInt("VIDEO_STORY_FROM_TYPE", blvr.a.a());
      if (paramInt == blvr.a.a()) {
      ...
      blvv.a(MobileQQ.sMobileQQ, paramBundle);
      return null;
    }
