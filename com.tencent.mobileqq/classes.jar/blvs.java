...
public class blvs
{
  private static volatile blvs jdField_a_of_type_Blvs;
  ...
  private blvs(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    a();
  }
  
  public static final blvs a(Context paramContext)
  {
    if (jdField_a_of_type_Blvs == null) {}
    try
    {
      if (jdField_a_of_type_Blvs == null) {
        jdField_a_of_type_Blvs = new blvs(paramContext);
      }
      return jdField_a_of_type_Blvs;
    }
    finally {}
  }
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if (localPluginInfo != null)
      {
        if (paramPluginBaseInfo != null)
        {
          ...
          if (!bool) {
            bdjw.a(new RuntimeException(), "plugin_tagCreateClassLoaderNotUpToDay");
          }
          return bool;
        }
  ...
  void b()
  {
    ...
    //   9: dup
    //   10: aload_0
    //   11: getfield 36	blvs:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   150: aload_0
    //   151: getfield 34	blvs:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   154: aload_3
    //   155: aload 4
