  ...
  implements Manager
{
  ...
  public int a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new nlc(this);
  ...
  public nlb(QQAppInterface paramQQAppInterface)
  {
    this(paramQQAppInterface, null);
  }
  
  public nlb(QQAppInterface paramQQAppInterface, oidb_0x791.GetRedDotRes paramGetRedDotRes)
  {
    this.jdField_b_of_type_JavaLangString = "TroopRedTouchManager2_All";
    this.jdField_c_of_type_JavaLangString = nlb.class.getSimpleName();
    ...
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localLong != null) && (paramMap.get(localLong) != null))
        {
          ...
          localJSONObject.put(String.valueOf(localLong), bhkv.encodeToString(arrayOfByte, 0));
        }
      }
  ...
  private Map<Long, oidb_0x791.RedDotInfo> a()
  {
    ...
    //   21: dup
    //   22: aload_0
    //   23: getfield 71	nlb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   44: aload_0
    //   45: getfield 71	nlb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   60: invokestatic 328	bhmi:a	(Ljava/io/File;)[B
    //   63: iconst_0
    //   64: invokestatic 332	bhkv:decode	([BI)[B
    ...
    //   119: iconst_0
    //   120: invokestatic 345	bhkv:decode	(Ljava/lang/String;I)[B
    ...
    //   160: ifeq +36 -> 196
    //   163: aload_0
    //   164: getfield 58	nlb:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   167: iconst_2
  ...
  private oidb_0x791.GetRedDotRes a()
  {
    ...
    //   5: dup
    //   6: aload_0
    //   7: getfield 71	nlb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   28: aload_0
    //   29: getfield 71	nlb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   44: invokestatic 328	bhmi:a	(Ljava/io/File;)[B
    //   47: astore_3
  ...
  private void c(oidb_0x791.RedDotInfo paramRedDotInfo)
  {
    if ((paramRedDotInfo.msg_nearby_entrance_extend_config.has()) && (paramRedDotInfo.msg_nearby_entrance_extend_config.bool_has_hintWord.has()) && (paramRedDotInfo.msg_nearby_entrance_extend_config.bool_has_hintWord.get()) && (paramRedDotInfo.msg_nearby_entrance_extend_config.str_hintWord.has())) {
      axws.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "key_nearby_red_dot_assist_text", paramRedDotInfo.msg_nearby_entrance_extend_config.str_hintWord.get().toStringUtf8());
    }
    if ((paramRedDotInfo.msg_word_corner_red_dot.has()) && (paramRedDotInfo.msg_word_corner_red_dot.bool_enable.has()) && (paramRedDotInfo.msg_word_corner_red_dot.bool_enable.get()) && (paramRedDotInfo.msg_word_corner_red_dot.bool_switch_to_word_corner.has()) && (paramRedDotInfo.msg_word_corner_red_dot.bool_switch_to_word_corner.get()) && (paramRedDotInfo.msg_word_corner_red_dot.str_hintText.has())) {
      axws.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "key_nearby_red_dot_corner_text", paramRedDotInfo.msg_word_corner_red_dot.str_hintText.get().toStringUtf8());
    }
  }
  ...
  private void d(oidb_0x791.RedDotInfo paramRedDotInfo)
  {
    ...
    try
    {
      ...
      if (paramRedDotInfo.optInt("is_c2c") == 1) {
        axws.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "key_nearby_msg_box_say_hello_msg_type", Integer.valueOf(paramRedDotInfo.optInt("say_hello_red_dot_type")));
      }
      return;
    }
    catch (Exception paramRedDotInfo)
  ...
  private void e(oidb_0x791.RedDotInfo paramRedDotInfo)
  {
    ...
    try
    {
      ...
      if (paramRedDotInfo.optInt("is_comment") == 1) {
        axws.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "key_nearby_msg_box_comment_zan_msg_type", Integer.valueOf(paramRedDotInfo.optInt("comment_red_dot_type")));
      }
      return;
    }
    catch (Exception paramRedDotInfo)
  ...
  public int a()
  {
    ...
    if (i < this.jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes.rpt_msg_reddot_info.size())
    {
      ...
      for (;;)
      {
        ...
        j = k;
        break;
        boolean bool = bhsi.f(BaseApplicationImpl.getApplication(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
        k = j;
  ...
  public int a(QQAppInterface paramQQAppInterface)
  {
    ...
    boolean bool3 = axus.a(paramQQAppInterface);
    boolean bool4 = a();
    boolean bool1;
    boolean bool2;
    label66:
  ...
  public aysu a(boolean paramBoolean)
  {
    try
    {
      aysu localaysu = a(paramBoolean, true);
      return localaysu;
    }
    finally
    {
  ...
  public aysu a(boolean paramBoolean1, boolean paramBoolean2)
  {
    for (;;)
    {
      Object localObject1;
      ...
      try
      {
        ...
        localObject1 = (nlb)localQQAppInterface.getManager(70);
        localRedTypeInfo1 = ((nlb)localObject1).a();
        localaysu = new aysu();
        if (!paramBoolean1) {
          break label935;
        }
        k = 1;
        if (!axus.a(localQQAppInterface)) {
          break label877;
        }
        localObject2 = (String)axws.a(localQQAppInterface.getCurrentAccountUin(), "key_nearby_red_dot_corner_text", "");
        localObject3 = (String)axws.a(localQQAppInterface.getCurrentAccountUin(), "key_nearby_red_dot_assist_text", "");
        if ((!TextUtils.isEmpty((CharSequence)localObject2)) || (!TextUtils.isEmpty((CharSequence)localObject3)))
        {
          localaysu.a(11);
          localaysu.jdField_b_of_type_JavaLangString = ((String)localObject2);
          localaysu.jdField_c_of_type_JavaLangString = ((String)localObject3);
          return localaysu;
        }
        localObject2 = ((nlb)localObject1).b();
        localObject3 = ((nlb)localObject1).i();
        BusinessInfoCheckUpdate.RedTypeInfo localRedTypeInfo2 = ((nlb)localObject1).k();
        localRedTypeInfo3 = ((nlb)localObject1).j();
        ArrayList localArrayList1 = ((nlb)localObject1).b();
        ArrayList localArrayList2 = ((nlb)localObject1).a();
        d();
        ((nlb)localObject1).e();
        f();
        localRedTypeInfo4 = ((nlb)localObject1).g();
        localObject1 = ((nlb)localObject1).h();
        if ((localArrayList1 == null) || (localArrayList1.size() <= 0)) {
          break label952;
        }
        localaysu.a(5);
        localaysu.b(localArrayList1.size());
        i = 56;
        j = i;
        if (localArrayList2 != null)
        {
          ...
          {
            j = i;
            if (axus.b(localQQAppInterface))
            {
              localaysu.a(5);
              localaysu.b(localArrayList2.size());
              j = 61;
            }
          }
        }
        ...
        if (paramBoolean2)
        {
          ...
          localaysu.a(5);
          localaysu.b(m);
          QLog.d("nearby.redpoint", 1, "addRedNum:" + m + ", total=" + localaysu.jdField_b_of_type_Int + ", type=" + 60);
          i = 2;
          if (j != 0) {
            break label949;
          }
          ...
          if (localObject3 != null)
          {
            k = i;
            m = j;
            if (axus.a(localQQAppInterface, 1))
            {
          ...
          {
            localaysu.a(5);
            localaysu.a(localRedTypeInfo2.red_content.get());
            bhsi.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext());
          }
          j = k;
          i = m;
          if (m != 0) {
          ...
          i = 60;
          break label979;
          localaysu.jdField_c_of_type_Int = j;
          QLog.d("nearby.redpoint", 1, "getNearbyRedPoint, needShow, isNewTab=" + paramBoolean1 + ", redType=" + i + ", redInfo=" + localaysu);
          localaysu.d = i;
        }
        else
        {
          this.jdField_a_of_type_Int = MsgBoxListActivity.a(localQQAppInterface, antf.I, true);
          continue;
        }
      ...
      label660:
      localaysu.a(5);
      localaysu.a(((BusinessInfoCheckUpdate.RedTypeInfo)localObject3).red_content.get());
      int i = 2;
      QLog.d("nearby.redpoint", 1, "addRedNum:" + ((BusinessInfoCheckUpdate.RedTypeInfo)localObject3).red_content.get() + ", total=" + localaysu.jdField_b_of_type_Int + ", type=" + 38);
      label754:
      if ((localRedTypeInfo1 != null) && (axus.a(localAppInterface, 2)))
      {
        localaysu.a(0);
        i = 25;
        j = k;
      }
      else if ((localObject2 != null) && (axus.a(localAppInterface, 3)))
      {
        i = 23;
        localaysu.a(0);
        j = k;
      ...
      else
      {
        ...
        if ((localRedTypeInfo1 == null) || (!axus.a(localAppInterface, 1001))) {
          break label993;
        }
        i = 25;
        localaysu.a(0);
  ...
  public aysv a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          localaysv.jdField_a_of_type_Int = ((oidb_0x791.RedDotInfo)localObject2).uint32_number.get();
          ...
          i = 1;
          if (i != 0) {
            localaysv.jdField_b_of_type_Int += 1;
          }
          i = ((JSONObject)localObject2).optInt("red_content_type");
          if (i != 1) {
            break label210;
          }
          localaysv.jdField_c_of_type_Int += 1;
        }
        catch (Exception localException)
        {
  ...
  public aysv a(int paramInt)
  {
    ...
    //   2: new 704	aysv
    //   5: dup
    //   6: invokespecial 705	aysv:<init>	()V
    //   9: astore_3
    //   10: aload_0
    //   11: getfield 62	nlb:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   14: ifnonnull +11 -> 25
    //   17: aload_0
    //   18: aload_0
    //   19: invokespecial 707	nlb:a	()Ljava/util/Map;
    //   22: putfield 62	nlb:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   25: aload_0
    //   26: getfield 62	nlb:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   42: areturn
    //   43: aload_0
    //   44: getfield 62	nlb:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    ...
    //   92: aload 5
    //   94: iload_1
    //   95: invokespecial 726	nlb:a	(Ltencent/im/oidb/cmd0x791/oidb_0x791$RedDotInfo;I)Z
    //   98: ifeq -37 -> 61
    //   101: aload 5
    ...
    //   115: aload_3
    //   116: iload_2
    //   117: putfield 716	aysv:jdField_a_of_type_Int	I
    //   120: goto -81 -> 39
    //   123: astore_3
    //   124: aload_0
    //   125: monitorexit
  ...
  public String a(String paramString, long paramLong, ayst paramayst)
  {
    JSONObject localJSONObject = new JSONObject();
    try
    {
      ...
      localJSONObject.put("isOfficialNotify", paramayst.jdField_b_of_type_Boolean);
      localJSONObject.put("redContentType", paramayst.jdField_b_of_type_Int);
      localJSONObject.put("redContentMsg", paramayst.jdField_a_of_type_JavaLangString);
      localJSONObject.put("topicId", paramayst.jdField_b_of_type_JavaLangString);
      localJSONObject.put("msgId", paramayst.jdField_c_of_type_JavaLangString);
      localJSONObject.put("userType", paramayst.jdField_c_of_type_Int);
  ...
  public ArrayList<oidb_0x791.RedDotInfo> a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 73	nlb:jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes	Ltencent/im/oidb/cmd0x791/oidb_0x791$GetRedDotRes;
    //   6: ifnonnull +11 -> 17
    //   9: aload_0
    //   10: aload_0
    //   11: invokespecial 521	nlb:a	()Ltencent/im/oidb/cmd0x791/oidb_0x791$GetRedDotRes;
    //   14: putfield 73	nlb:jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes	Ltencent/im/oidb/cmd0x791/oidb_0x791$GetRedDotRes;
    //   17: aload_0
    //   18: getfield 73	nlb:jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes	Ltencent/im/oidb/cmd0x791/oidb_0x791$GetRedDotRes;
    //   21: astore_3
    //   22: aload_3
    //   23: ifnonnull +9 -> 32
    //   26: aconst_null
    ...
    //   42: iload_1
    //   43: aload_0
    //   44: getfield 73	nlb:jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes	Ltencent/im/oidb/cmd0x791/oidb_0x791$GetRedDotRes;
    ...
    //   53: if_icmpge +98 -> 151
    //   56: aload_0
    //   57: getfield 73	nlb:jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes	Ltencent/im/oidb/cmd0x791/oidb_0x791$GetRedDotRes;
  ...
  public oidb_0x791.RedDotInfo a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        bool1 = ((wwh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(252)).jdField_a_of_type_Boolean;
        ...
        {
          yuk.d(this.jdField_c_of_type_JavaLangString, "%d red dot time out", new Object[] { Integer.valueOf(i) });
          continue;
        }
        if (i != 37) {}
      }
      finally {}
      if ((!bool2) && (i != 48) && ((bool1) || (i != 28)) && ((i != zpk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) || (localRedDotInfo2.uint32_number.get() > 0))) {
        if (nkt.a(localRedDotInfo2, localRedDotInfo1) > 0)
        {
  ...
  public void a()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        {
          oidb_0x791.RedDotInfo localRedDotInfo = (oidb_0x791.RedDotInfo)this.jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes.rpt_msg_reddot_info.get(i);
          if ((!localRedDotInfo.bool_display_reddot.get()) || (!nkt.a(localRedDotInfo.uint32_appid.get()))) {
            break label209;
          }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j < n)
        {
          ...
          if (nkt.c(localRedDotInfo1.uint32_appid.get())) {
            break label777;
          }
  ...
  public void b(int paramInt)
  {
    ...
    {
      nku.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRedDotInfo1);
    }
    label188:
    label331:
    label358:
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          this.jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes.rpt_msg_reddot_info.remove(i);
          nku.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRedDotInfo2);
  ...
  public BusinessInfoCheckUpdate.RedTypeInfo i()
  {
    ...
    //   68: iload_3
    //   69: aload_0
    //   70: getfield 73	nlb:jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes	Ltencent/im/oidb/cmd0x791/oidb_0x791$GetRedDotRes;
    ...
    //   82: aload_0
    //   83: getfield 73	nlb:jdField_a_of_type_TencentImOidbCmd0x791Oidb_0x791$GetRedDotRes	Ltencent/im/oidb/cmd0x791/oidb_0x791$GetRedDotRes;
    ...
    //   278: new 758	ayst
    //   281: dup
    //   282: invokespecial 991	ayst:<init>	()V
    //   285: astore 17
    //   287: aload 17
    //   289: aload 12
    //   291: invokevirtual 992	ayst:a	(Ltencent/im/oidb/cmd0x791/oidb_0x791$RedDotInfo;)V
    //   294: iload 10
    //   296: ifne +12 -> 308
    //   299: aload 16
    //   301: astore 15
    ...
    //   326: iload_2
    //   327: invokestatic 994	java/lang/String:valueOf	(I)Ljava/lang/String;
    ...
    //   345: ifeq +20 -> 365
    //   348: aload 17
    //   350: getfield 995	ayst:jdField_a_of_type_Boolean	Z
    //   353: ifne +12 -> 365
    //   356: aload 16
    ...
    //   368: lload 7
    //   370: aload 17
    //   372: invokevirtual 997	nlb:a	(Ljava/lang/String;JLayst;)Ljava/lang/String;
    //   375: astore 12
    //   377: aload 16
    ...
    //   451: iload_1
    //   452: invokestatic 994	java/lang/String:valueOf	(I)Ljava/lang/String;
