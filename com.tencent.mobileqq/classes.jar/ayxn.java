  ...
  implements aubo
{
  ...
  public ConcurrentHashMap<Integer, bjct> a;
  private boolean jdField_a_of_type_Boolean;
  private HashMap<String, Long> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  private boolean jdField_b_of_type_Boolean = true;
  private boolean c;
  
  public ayxn(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    if (this.jdField_a_of_type_AndroidDatabaseContentObserver == null) {
      this.jdField_a_of_type_AndroidDatabaseContentObserver = new ayxo(this, null);
    }
    try
    {
      if (!this.jdField_a_of_type_Boolean) {
        paramQQAppInterface.getApplication().getContentResolver().registerContentObserver(zdu.h, true, this.jdField_a_of_type_AndroidDatabaseContentObserver);
      }
  ...
  private void a(int paramInt, bjct parambjct)
  {
    if ((parambjct == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ThreadManager.post(new QZoneManagerImp.3(this, new bjct(parambjct), paramInt), 5, null, false);
  }
  ...
  private void b()
  {
    ...
    //   1: astore_2
    //   2: aload_0
    //   3: getfield 104	ayxn:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   6: ifnonnull +14 -> 20
    //   9: aload_0
    //   10: new 106	java/util/concurrent/ConcurrentHashMap
    //   13: dup
    //   14: invokespecial 192	java/util/concurrent/ConcurrentHashMap:<init>	()V
    //   17: putfield 104	ayxn:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   20: aload_0
    //   21: getfield 104	ayxn:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   24: invokevirtual 195	java/util/concurrent/ConcurrentHashMap:clear	()V
    //   27: aload_0
    //   28: getfield 54	ayxn:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   48: iconst_0
    //   49: aload_0
    //   50: getfield 54	ayxn:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   65: astore_1
    //   66: aload_2
    //   67: invokestatic 212	bjct:a	(Landroid/database/Cursor;)Ljava/util/HashMap;
    //   70: astore_3
    //   71: aload_3
    //   72: ifnull +13 -> 85
    //   75: aload_2
    //   76: astore_1
    //   77: aload_0
    //   78: getfield 104	ayxn:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   81: aload_3
    ...
    //   110: aload_0
    //   111: aload_3
    //   112: invokevirtual 101	ayxn:a	(Ljava/lang/Exception;)V
    //   115: aload_2
    //   116: ifnull -12 -> 104
    //   119: aload_2
    ...
    for (;;)
    {
      ...
      try
      {
        if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null)
        {
          ...
          bjct[] arrayOfbjct = (bjct[])this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.values().toArray(new bjct[this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size()]);
          ...
          ContentValues[] arrayOfContentValues = new ContentValues[arrayOfbjct.length];
          i = 0;
          if (i < arrayOfbjct.length)
          {
            ...
            arrayOfContentValues[i] = arrayOfbjct[i].a();
  ...
  public int a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null)
    {
      bjct localbjct = (bjct)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
      if (localbjct != null) {
        return (int)localbjct.jdField_a_of_type_Long;
      }
    }
    return 0;
  }
  
  public bjct a(int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.d("QZoneManagerImp.", 2, "QZoneManagerImp getFeedCount type :" + paramInt);
    }
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null) {
      return (bjct)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
    }
    return null;
  }
  ...
  public ArrayList<String> a()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null)
    {
      Object localObject = (bjct)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(2));
      if ((localObject != null) && (((bjct)localObject).jdField_a_of_type_JavaUtilArrayList != null) && (((bjct)localObject).jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        Iterator localIterator = ((bjct)localObject).jdField_a_of_type_JavaUtilArrayList.iterator();
  ...
  public void a()
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), ayxr.class);
    localNewIntent.putExtra("key_uin", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
    localNewIntent.putExtra("lastPushMsgTime", aywx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
  ...
  public void a(int paramInt)
  {
      ...
      for (;;)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication() != null))
        {
          ...
          if (paramInt == 2) {
            try
            {
              NewIntent localNewIntent1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), ayxp.class);
    ...
    NewIntent localNewIntent2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), ayxp.class);
  ...
  public void a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), ayxp.class);
  ...
  public void a(Exception paramException)
  {
    ...
    for (;;)
    {
      ...
      azmz.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "qzoneconfigdberror", true, 0L, 0L, localHashMap, null, true);
      bjqs.a(paramException, "QZoneConfigProvider error");
      return;
      str = "1";
      continue;
      str = "2";
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    {
      paramString1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), ayxp.class);
  ...
  public void a(HashMap<Integer, bjct> paramHashMap)
  {
    for (;;)
    {
      int j;
        ...
        else if ((paramHashMap != null) && (paramHashMap.size() != 0) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
        {
          ...
          if (j < m)
          {
            ...
            if ((localInteger != null) && ((localInteger instanceof Map.Entry)))
            {
              ...
              localObject = (bjct)((Map.Entry)localObject).getValue();
              if (!a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
              {
                if (QLog.isColorLevel()) {
                  QLog.d("FeedAlert.", 2, "QZoneManagerImp.checkShowQZonePush" + Long.toBinaryString(this.jdField_a_of_type_Long) + ",count" + ((bjct)localObject).jdField_a_of_type_Long);
                }
                if (localInteger.intValue() == 17) {
                  break label303;
                }
              }
              bool = a(localInteger.intValue(), (bjct)localObject);
  ...
  public boolean a(int paramInt, long paramLong, ArrayList<QZoneCountUserInfo> paramArrayList, String paramString1, boolean paramBoolean1, boolean paramBoolean2, String paramString2)
  {
    ...
    localbjct.jdField_a_of_type_Long = paramLong;
    localbjct.jdField_a_of_type_JavaUtilArrayList = paramArrayList;
    localbjct.jdField_a_of_type_Boolean = paramBoolean1;
    localbjct.d = paramString1;
    if (!TextUtils.isEmpty(paramString2)) {
      localbjct.c = paramString2;
    }
    paramBoolean1 = false;
    paramArrayList = (bjct)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
    if (!localbjct.a(paramArrayList)) {
      paramBoolean1 = true;
    }
    if (paramBoolean1)
    {
      if ((paramLong > 0L) && (paramArrayList != null) && (paramArrayList.jdField_a_of_type_JavaUtilArrayList != null) && (localbjct != null) && (localbjct.jdField_a_of_type_JavaUtilArrayList != null) && (localbjct.jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        paramString1 = localbjct.jdField_a_of_type_JavaUtilArrayList.iterator();
        ...
        localbjct.jdField_a_of_type_JavaUtilArrayList.addAll(paramArrayList.jdField_a_of_type_JavaUtilArrayList);
      }
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt), localbjct);
      a(paramInt, localbjct);
    }
    return paramBoolean1;
  }
  
  public boolean a(int paramInt, bjct parambjct)
  {
    boolean bool2;
    if (parambjct == null)
    {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QZoneManagerImp.", 2, "setFeedCountAll.feedtype=" + paramInt + ",count=" + parambjct.jdField_a_of_type_Long + ",uin");
    }
    if ((paramInt < 1) || (paramInt > 1010)) {
      return false;
    }
    ...
    if (!parambjct.a((bjct)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt)))) {}
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt), parambjct);
      return bool1;
    }
  }
  ...
  public void c(int paramInt)
  {
    ...
    try
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getContentResolver().delete(zdu.h, localStringBuilder.toString(), new String[] { str, String.valueOf(paramInt) });
      return;
    }
    catch (Exception localException)
    {
