...
class abwn
{
  ...
  public abwn(msg_comm.Msg paramMsg, ArrayList<MessageRecord> paramArrayList1, boolean paramBoolean, String paramString, ArrayList<DelMsgInfo> paramArrayList, ArrayList<MessageRecord> paramArrayList2)
  {
  ...
  private boolean a(MessageRecord paramMessageRecord, boolean paramBoolean, MessageForStructing paramMessageForStructing)
  {
    ...
    try
    {
      ...
      if ((i & 0x4) == 4)
      {
        ...
        i = abwi.a(this.jdField_a_of_type_Abwi, this.jdField_a_of_type_MsfMsgcommMsg_comm$Msg);
        paramBoolean = bool2;
        if (i == 1) {
          paramBoolean = true;
        }
  ...
  public abwn a()
  {
    ...
    {
      if (!bool) {
        this.jdField_a_of_type_Abwi.a.getMessageFacade().setReadFrom(localMessageRecord.frienduin, localMessageRecord.istroop, localMessageRecord.time);
      }
