  ...
  extends amus
{
  ...
  public amsk(ArConfigService paramArConfigService)
  {
  ...
  public ARCommonConfigInfo a()
  {
    ...
    for (Object localObject = (ArConfigService)this.a.get();; localObject = null)
    {
      ...
      if (((ArConfigService)localObject).jdField_a_of_type_Amnv != null) {}
      for (localObject = ((ArConfigService)localObject).jdField_a_of_type_Amnv.a();; localObject = null)
      {
  ...
  public ArConfigInfo a()
  {
    ...
    for (Object localObject = (ArConfigService)this.a.get();; localObject = null)
    {
      ...
      if (((ArConfigService)localObject).jdField_a_of_type_Amsx != null) {}
      for (localObject = ((ArConfigService)localObject).jdField_a_of_type_Amsx.a();; localObject = null)
      {
        if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    ...
    for (ArConfigService localArConfigService = (ArConfigService)this.a.get();; localArConfigService = null)
    {
      ...
      while (localArConfigService.jdField_a_of_type_Amsx == null) {
        return;
      }
      localArConfigService.jdField_a_of_type_Amsx.a(false, false);
      HashMap localHashMap = new HashMap();
      localHashMap.put("click_download", "1");
      azmz.a(BaseApplicationImpl.getContext()).a(localArConfigService.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "ar_client_download_times", true, 0L, 0L, localHashMap, null);
      return;
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    amtb.a(paramInt, (QQAppInterface)ArConfigService.b(localArConfigService));
  }
  ...
  public void a(amuu paramamuu)
  {
    ...
    while ((paramamuu == null) || (ArConfigService.b(localArConfigService) == null)) {
      return;
    }
    ArConfigService.b(localArConfigService).register(paramamuu);
  }
  
  public void a(amva paramamva)
  {
    ArConfigService localArConfigService = null;
    if (this.a != null) {
      localArConfigService = (ArConfigService)this.a.get();
    ...
    while ((paramamva == null) || (ArConfigService.c(localArConfigService) == null)) {
      return;
    }
    ArConfigService.c(localArConfigService).register(paramamva);
  }
  
  public void a(amvd paramamvd)
  {
    ArConfigService localArConfigService = null;
    if (this.a != null) {
      localArConfigService = (ArConfigService)this.a.get();
    ...
    while ((paramamvd == null) || (ArConfigService.a(localArConfigService) == null)) {
      return;
    }
    ArConfigService.a(localArConfigService).register(paramamvd);
  }
  
  public void a(amvg paramamvg)
  {
    ArConfigService localArConfigService = null;
    if (this.a != null) {
      localArConfigService = (ArConfigService)this.a.get();
    ...
    while (paramamvg == null) {
      return;
    }
    ArConfigService.d(localArConfigService).register(paramamvg);
  }
  ...
  public void a(ArConfigInfo paramArConfigInfo)
  {
    ...
    localArConfigService.jdField_a_of_type_Amsx.a(paramArConfigInfo);
  }
  ...
  public boolean a()
  {
    ...
    for (ArConfigService localArConfigService = (ArConfigService)this.a.get();; localArConfigService = null)
    {
      ...
      {
        boolean bool = amtb.a((QQAppInterface)ArConfigService.d(localArConfigService));
        if (!bool) {
          amtb.a((QQAppInterface)ArConfigService.e(localArConfigService));
        }
        return bool;
      }
      return false;
  ...
  public void b()
  {
    ...
    localArConfigService.jdField_a_of_type_Amsx.a.a();
  }
  ...
  public void b(int paramInt)
  {
    ...
    anaf.a(paramInt, (QQAppInterface)ArConfigService.g(localArConfigService));
  }
  
  public void b(amuu paramamuu)
  {
    ArConfigService localArConfigService = null;
    if (this.a != null) {
      localArConfigService = (ArConfigService)this.a.get();
    ...
    ArConfigService.b(localArConfigService).unregister(paramamuu);
  }
  
  public void b(amva paramamva)
  {
    ArConfigService localArConfigService = null;
    if (this.a != null) {
      localArConfigService = (ArConfigService)this.a.get();
    ...
    ArConfigService.c(localArConfigService).unregister(paramamva);
  }
  
  public void b(amvd paramamvd)
  {
    ...
    ArConfigService.a(localArConfigService).unregister(paramamvd);
  }
  
  public void b(amvg paramamvg)
  {
    ArConfigService localArConfigService = null;
    if (this.a != null) {
      localArConfigService = (ArConfigService)this.a.get();
    ...
    ArConfigService.d(localArConfigService).unregister(paramamvg);
  }
  ...
  public boolean b()
  {
    ...
    for (ArConfigService localArConfigService = (ArConfigService)this.a.get();; localArConfigService = null)
    {
      ...
      {
        boolean bool = anaf.a(true, (QQAppInterface)ArConfigService.i(localArConfigService));
        if (!bool) {
          anaf.a(true, (QQAppInterface)ArConfigService.j(localArConfigService));
        }
        if (!anaf.a(false, (QQAppInterface)ArConfigService.k(localArConfigService))) {
          anaf.a(false, (QQAppInterface)ArConfigService.l(localArConfigService));
        }
        return bool;
      }
      return false;
  ...
  public void c(int paramInt)
  {
    ...
    {
      return;
      localObject = (xwl)ArConfigService.m((ArConfigService)localObject).getManager(243);
    } while (localObject == null);
    ((xwl)localObject).a(paramInt);
  }
