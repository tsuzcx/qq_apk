  ...
  implements INetInfoHandler, DownloaderInterface
{
  ...
  public ajws(AppRuntime paramAppRuntime, DownloaderFactory.DownloadConfig paramDownloadConfig)
  {
  ...
  void a()
  {
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        return;
        label288:
        ThreadManager.postDownLoadTask(new ajwt(this, localDownloadTask1), 2, null, false);
