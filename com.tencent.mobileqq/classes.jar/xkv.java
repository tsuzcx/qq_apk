...
public class xkv
  implements Runnable
{
  public xkv(GoldMsgPayManager paramGoldMsgPayManager, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          xkw localxkw = new xkw(this, (String)localObject4);
          ...
          localObject3 = new xkx(this, (String)localObject3);
          int i = str3.length();
          int j = str3.length();
          ((SpannableString)localObject4).setSpan(localObject3, i, ((String)localObject1).length() + j, 33);
          localObject1 = new ButtonInfo(str4, new ColorDrawable(-15550475), -1, localxkw);
