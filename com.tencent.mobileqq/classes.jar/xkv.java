...
public class xkv
  implements bfoq
{
  public xkv(NewerGuidePlugin paramNewerGuidePlugin, Activity paramActivity, bfol parambfol) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      continue;
      paramView = bazo.a();
      paramInt = bazo.b(this.jdField_a_of_type_AndroidAppActivity);
      ...
      {
        paramView = bbuv.a(ajsf.aW + "photo/");
