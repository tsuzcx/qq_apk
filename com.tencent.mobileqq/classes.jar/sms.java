...
public class sms
{
  ...
  {
    String str = "Other";
    int i = bbev.a(BaseApplicationImpl.getApplication());
    if (i == 1) {
      str = "WiFi";
    }
    do
  ...
  public static String a(WSRedDotPushMsg paramWSRedDotPushMsg)
  {
    ...
    if (paramWSRedDotPushMsg != null)
    {
      ...
      bool = sni.a(paramWSRedDotPushMsg);
  ...
  {
    a("weishi_share_officialacc", "start_dl_ws_fin", paramInt, 0, skb.a().d(), 0L, "", "");
  }
  ...
  public static void a(WSDownloadParams paramWSDownloadParams, int paramInt)
  {
    ...
    a("weishi_share_officialacc", "start_dl_ws", paramInt, 0, skb.a().d(), 0L, "", paramWSDownloadParams.mTestId);
  }
  ...
  public static void a(WSRedDotPushMsg paramWSRedDotPushMsg)
  {
    ...
    for (;;)
    {
      ...
      long l1;
      long l2;
      if (vzz.a(BaseApplicationImpl.getApplication().getApplicationContext()))
      {
        l1 = 1L;
        l2 = j;
  ...
  {
    axqw.b(null, "dc00898", "", "", paramString1, paramString2, paramInt1, paramInt2, String.valueOf(paramLong1), String.valueOf(paramLong2), paramString3, paramString4);
  }
  ...
  public static void a(boolean paramBoolean, WSDownloadParams paramWSDownloadParams)
  {
    ...
    a(str, "dl_clk_officialdownloader", skb.a().d(), 0, 0L, 0L, "", paramWSDownloadParams.mTestId);
  }
