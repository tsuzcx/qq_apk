...
import com.tencent.mobileqq.transfile.INetEngine.NetFailedListener;
...
{
  private static bpjp jdField_a_of_type_Bpjp;
  public bpjr a;
  private HashMap<String, bpjq> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private Lock jdField_a_of_type_JavaUtilConcurrentLocksLock = new ReentrantLock();
  
  public bpjp()
  {
    this.jdField_a_of_type_Bpjr = new bpjr(this);
  }
  
  public static bpjp a()
  {
    if (jdField_a_of_type_Bpjp == null) {
      jdField_a_of_type_Bpjp = new bpjp();
    }
    return jdField_a_of_type_Bpjp;
  }
  ...
  private void a(FilterDesc paramFilterDesc, long paramLong, int paramInt)
  {
    ...
    try
    {
      Object localObject2 = ((bohj)bogd.a(5)).a;
      Object localObject1 = new ArrayList();
      if (localObject2 != null) {
        localObject1 = ((bpju)localObject2).a(0).c;
      }
      ...
      aanb.a("record_filter_download", aanb.a(paramInt, System.currentTimeMillis() - l, paramFilterDesc.resurl, paramLong, paramFilterDesc.name));
  ...
  private void a(FilterDesc paramFilterDesc, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        bpjq localbpjq = (bpjq)this.jdField_a_of_type_JavaUtilHashMap.get(paramFilterDesc.name);
        if ((localbpjq != null) && (localbpjq.jdField_a_of_type_JavaUtilArrayList != null))
        {
          i = 0;
          if (i < localbpjq.jdField_a_of_type_JavaUtilArrayList.size())
          {
            bpjs localbpjs = (bpjs)((WeakReference)localbpjq.jdField_a_of_type_JavaUtilArrayList.get(i)).get();
            if (localbpjs != null) {
              localArrayList.add(localbpjs);
            }
          }
          else
          {
            localbpjq.jdField_a_of_type_JavaUtilArrayList.clear();
        ...
        else
        {
          ...
          if ((localArrayList != null) && (localArrayList.size() > 0))
          {
            ...
            {
              paramFilterDesc = (bpjs)localArrayList.get(i);
              if (paramFilterDesc != null) {
  ...
  {
    String str = paramFilterDesc.getResFold(bpnd.b);
    bpjt.a();
  ...
  /* Error */
  private boolean a(FilterDesc paramFilterDesc, bpjs parambpjs)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 26	bpjp:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   4: invokeinterface 174 1 0
    //   9: aload_0
    //   10: getfield 21	bpjp:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   13: aload_1
    ...
    //   33: dup
    //   34: aload_0
    //   35: invokespecial 254	bpjq:<init>	(Lbpjp;)V
    //   38: astore 4
    //   40: aload 4
    //   42: aload_1
    //   43: putfield 257	bpjq:jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc	Lcom/tencent/mobileqq/richmedia/capture/data/FilterDesc;
    //   46: aload 4
    //   48: getfield 181	bpjq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   62: pop
    //   63: aload_0
    //   64: getfield 21	bpjp:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   67: aload_1
    ...
    //   78: istore_3
    //   79: aload_0
    //   80: getfield 26	bpjp:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   83: invokeinterface 206 1 0
    //   88: iload_3
    //   89: ireturn
    //   90: aload 4
    //   92: getfield 181	bpjq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   112: astore_1
    //   113: aload_0
    //   114: getfield 26	bpjp:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    ...
    //   0	124	2	parambpjs	bpjs
    //   78	31	3	bool	boolean
    //   23	68	4	localbpjq	bpjq
    // Exception table:
    //   from	to	target	type
    //   9	25	112	finally
    //   30	77	112	finally
  ...
  public void a(FilterDesc paramFilterDesc, bpjs parambpjs)
  {
    if (!a(paramFilterDesc, parambpjs)) {
      a(paramFilterDesc);
    }
  }
