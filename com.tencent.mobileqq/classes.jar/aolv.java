...
public class aolv
  extends aolh
{
  public aolv(QQAppInterface paramQQAppInterface, FriendListHandler paramFriendListHandler)
  {
        ...
        for (paramFromServiceMsg = null;; paramFromServiceMsg = null) {
          for (;;)
          {
            ...
            try
            {
              ...
              paramFromServiceMsg = new bchf().a(new Object[] { paramToServiceMsg.extraData.getString("param_keyword"), paramFromServiceMsg, Integer.valueOf(paramToServiceMsg.extraData.getInt("fromType")) });
              j = m;
            }
