...
public class aeft
{
  public static final int[] A = { 9, 2131698506, 2130844004, 2131372915, 0 };
  public static final int[] B = { 10, 2131698493, 2130837977, 2131372898, 0, 2130848824, 2130848825 };
  public static final int[] C = { 10, 2131698493, 2130844007, 2131372898, 0 };
  public static final int[] D = { 12, 2131698485, 2130838034, 2131372885, 0 };
  public static final int[] E = { 13, 2131698486, 2130838031, 2131372886, 0 };
  public static final int[] F = { 14, 2131698495, 2130837972, 2131372903, 0 };
  public static final int[] G = { 14, 2131698495, 2130844006, 2131372903, 0 };
  public static final int[] H = { 19, 2131698497, 2130838013, 2131372905, 0 };
  public static final int[] I = { 19, 2131698497, 2130844011, 2131372905, 0 };
  public static final int[] J = { 16, 2131698491, 2130837969, 2131372895, 0 };
  public static final int[] K = { 17, 2131698500, 2130838010, 2131372909, 0 };
  public static int[] L = { 23, 2131698502, 2130838022, 2131372914, 0, 2130848869, 2130848870 };
  public static final int[] M = { 26, 2131698513, 2130838022, 2131372929, 0 };
  public static final int[] N = { 24, 2131698494, 2130837978, 2131372899, 2130837854, 2130837998, 2130838000 };
  public static final int[] O = { 24, 2131698494, 2130844004, 2131372899, 0 };
  public static final int[] P = { 31, 2131698501, 2130838014, 2131372910, 0 };
  public static final int[] Q = { 32, 2131698492, 2130837976, 2131372897, 0 };
  public static final int[] R = { 24, 2131698494, 2130837980, 2131372900, 0 };
  public static final int[] S = { 24, 2131698494, 2130837979, 2131372900, 0 };
  public static final int[] T = { 29, 2131694960, 2130848789, 2131372881, 0 };
  public static final int[] U = { 29, 2131694960, 2130844003, 2131372881, 0 };
  public static final int[] V = { 21, 2131690328, 2130838217, 2131372880, 0 };
  public static final int[] W = { 21, 2131690328, 2130844001, 2131372880, 0 };
  public static final int[] X = { 21, 2131690328, 2130838264, 2131372884, 0 };
  ...
  static
  {
    ...
    jdField_a_of_type_ArrayOfInt = new int[] { 2, 2131698507, 2130838024, 2131372916, 2130837906, 2130848886, 2130848887 };
    b = new int[] { 2, 2131698507, 2130838028, 2131372917, 0 };
    c = new int[] { 2, 2131698507, 2130838026, 2131372917, 0 };
    d = new int[] { 2, 2131698507, 2130844014, 2131372916, 0 };
    e = new int[] { 3, 2131698488, 2130837960, 2131372888, 2130837820, 2130848814, 2130848815 };
    f = new int[] { 3, 2131698488, 2130837964, 2131372889, 0 };
    g = new int[] { 3, 2131698488, 2130837962, 2131372889, 0 };
    h = new int[] { 3, 2131698488, 2130844005, 2131372888, 0 };
    i = new int[] { 3, 2131698488, 2130837967, 2131372888, 2130837833, 2130848812, 2130848813 };
    j = new int[] { 3, 2131698488, 2130837965, 2131372889, 0 };
    k = new int[] { 3, 2131698488, 2130837963, 2131372889, 0 };
    l = new int[] { 4, 2131698498, 2130838002, 2131372906, 2130837903, 2130848843, 2130848844 };
    m = new int[] { 4, 2131698498, 2130838007, 2131372907, 0 };
    n = new int[] { 4, 2131698498, 2130838004, 2131372907, 0 };
    o = new int[] { 4, 2131698498, 2130844010, 2131372906, 0 };
    p = new int[] { 4, 2131698498, 2130838009, 2131372906, 2130837904, 2130848841, 2130848842 };
    q = new int[] { 4, 2131698498, 2130838008, 2131372907, 0 };
    r = new int[] { 4, 2131698498, 2130838005, 2131372907, 0 };
    s = new int[] { 5, 2131698484, 2130837954, 2131372882, 0, 2130848794, 2130848795 };
    t = new int[] { 5, 2131698484, 2130837958, 2131372883, 0 };
    u = new int[] { 5, 2131698484, 2130837956, 2131372883, 0 };
    v = new int[] { 6, 2131698508, 2130838031, 2131372919, 0, 2130848892, 2130848893 };
    w = new int[] { 8, 2131698503, 2130838017, 2131372911, 2130837905, 2130848863, 2130848864 };
    x = new int[] { 8, 2131698503, 2130838019, 2131372912, 0 };
    y = new int[] { 8, 2131698503, 2130844012, 2131372911, 0 };
    z = new int[] { 9, 2131698506, 2130838023, 2131372915, 0 };
  }
  ...
  {
    PhotoListPanel localPhotoListPanel = (PhotoListPanel)View.inflate(paramBaseChatPie.jdField_a_of_type_AndroidContentContext, 2131560629, null);
    Intent localIntent;
    if (!paramBoolean)
    {
    ...
    Object localObject = ((ajxl)paramQQAppInterface.getManager(51)).e(str);
    paramIntent = "";
    if (localObject != null) {
    ...
    localIntent.putExtra("PhotoConst.PHOTOLIST_KEY_SHOW_MEDIA", acxs.a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo));
    if (paramBoolean)
    {
      ...
      paramIntent = (akhp)paramQQAppInterface.a(20);
    ...
    localPhotoListPanel.setOnSwipeUpAndDragListener(new aekh(paramBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, paramBaseChatPie.d, paramQQAppInterface, paramBaseChatPie.a(), null, localPhotoListPanel));
  ...
  public static void a(QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity)
  {
    ...
    acxs.a(paramQQAppInterface, paramFragmentActivity);
    paramFragmentActivity.setCanLock(false);
    axqy.b(paramQQAppInterface, "CliOper", "", "", "0X800407F", "0X800407F", 0, 0, "", "", "", "");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, int paramInt1, String paramString, int paramInt2)
  {
    ...
    paramString = localavps.a(paramInt1, paramString);
    if (paramString != null)
    {
      if (paramString.iNewFlag.get() == 1) {
        localavps.a(paramString, "");
      }
    }
    else {
      return;
    ...
    for (;;)
    {
      axqy.b(paramQQAppInterface, "dc00898", "", "", "0X800A46A", "0X800A46A", paramInt2, paramString.iNewFlag.get(), String.valueOf(paramInt1), "", "", "");
      return;
      paramInt1 = 0;
      break;
      label150:
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      axqy.b(paramQQAppInterface, "CliOper", "", "", paramString, paramString, paramInt, 0, "", "", "", "");
      return;
      if (paramInt == 3000) {
        paramInt = 2;
      } else if (paramInt == 1) {
  ...
  {
    if (((bduf)paramQQAppInterface.getManager(165)).f(paramSessionInfo.jdField_a_of_type_JavaLangString)) {
      axqy.b(paramQQAppInterface, "dc00899", "Qidian", paramSessionInfo.jdField_a_of_type_JavaLangString, paramString1, paramString2, 0, 0, "", "", "", "");
    }
  }
  ...
  {
    if (((bduf)paramQQAppInterface.getManager(165)).f(paramSessionInfo.jdField_a_of_type_JavaLangString)) {
      axqy.b(paramQQAppInterface, "dc00899", "Qidian", paramSessionInfo.jdField_a_of_type_JavaLangString, paramString1, paramString2, 0, 0, paramInt1 + "", paramInt2 + "", "", "");
    }
  }
}
