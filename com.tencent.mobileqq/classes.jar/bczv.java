  ...
  extends SpannableStringBuilder
{
  ...
  static
  {
    jdField_a_of_type_AndroidTextEditable$Factory = new bczw();
  }
  
  public bczv(CharSequence paramCharSequence, int paramInt)
  {
  ...
  {
    if ((paramCharSequence instanceof bczs)) {
      return ((bczs)paramCharSequence).a();
    }
    return new bczs(paramCharSequence, paramInt).a();
  }
  ...
  public SpannableStringBuilder replace(int paramInt1, int paramInt2, CharSequence paramCharSequence, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      i = paramInt2;
      localObject = new bczs(paramCharSequence, this.jdField_a_of_type_Int).a();
