...
{
  public static final DownloadParams.DecodeHandler a = new bczw();
  public static final DownloadParams.DecodeHandler b = new bczx(bcuq.s, a);
  ...
  public static Bitmap a(@NonNull Bitmap paramBitmap1, @NonNull Bitmap paramBitmap2, int paramInt1, int paramInt2)
  {
    ...
    paramBitmap2.setDensity((int)bdkf.c());
