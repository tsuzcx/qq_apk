  ...
  extends bcvt
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (((localObject1 == null) || (!((String)localObject1).equals("1"))) || (paramBundle.getInt("accostType") == AbsStructMsg.SOURCE_ACCOUNT_TYPE_PA))
    {
      ...
      j = localResources.getDimensionPixelSize(2131298901);
      m = afur.a(2.0F, localResources);
      if (i == 0) {
        break label1962;
      }
      k = afur.a(12.0F, localResources);
      j = k;
    }
    label794:
    label1181:
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          ((LinearLayout)localObject1).setBackgroundResource(2130838301);
          n = afur.a(1.0F, localResources);
        ...
        if (((LinearLayout)localObject1).getChildCount() == this.jdField_a_of_type_JavaUtilArrayList.size())
        {
          ...
          if (n < i1)
          {
            paramView = (bcvs)this.jdField_a_of_type_JavaUtilArrayList.get(n);
        ...
        do
        {
          ...
          break label105;
          i2 = afur.a(10.0F, localResources);
          i3 = afur.a(5.0F, localResources);
          ...
          for (;;)
          {
            ...
            else
            {
              if ("summary".equals(str))
              {
                ...
                if (i != 0)
                {
                  localObject2 = ((bdaq)paramView).f();
                  if ((localObject2 == null) || (!((String)localObject2).equals("1"))) {
                    break label639;
                  }
                  if (TextUtils.isEmpty(((bdaq)paramView).c())) {
                    ((TextView)localView).setTextSize(12.0F);
                  }
                  if (TextUtils.isEmpty(((bdaq)paramView).d())) {
              ...
              if ("hr".equals(str))
              {
                if (((bcxx)paramView).a)
                {
                  ...
                  if ((i != 0) && (n != 0)) {
                    ((LinearLayout.LayoutParams)localObject2).topMargin += afur.a(6.0F, localResources);
                  }
              ...
              {
                ((LinearLayout.LayoutParams)localObject2).height = afur.a(4.0F, localResources);
          ...
          localObject2 = (bcvs)this.jdField_a_of_type_JavaUtilArrayList.get(n);
        ...
        label725:
        label997:
        int i2 = afur.a(10.0F, localResources);
        int i3 = afur.a(5.0F, localResources);
        paramView = new LinearLayout.LayoutParams(-1, -2);
        if (n > 0) {
          paramView.topMargin = i3;
        }
        String str = ((bcvs)localObject2).jdField_a_of_type_JavaLangString;
        if ("picture".equals(str))
        {
          localView.setId(-1);
          paramView.height = (BaseChatItemLayout.f - i2 - i2);
          paramView.topMargin = afur.a(9.5F, localResources);
          paramView.bottomMargin = afur.a(9.5F, localResources);
        }
        for (;;)
        {
          ...
          else if ("title".equals(str))
          {
            ...
            paramView.topMargin = afur.a(3.0F, localResources);
            paramView.bottomMargin = afur.a(3.0F, localResources);
            if ((a(1)) && (n == 0)) {
              paramView.topMargin += afur.a(14.0F, localResources);
            }
            localView.setId(-1);
          }
          else
          {
            if ("summary".equals(str))
            {
              if (i != 0)
              {
                str = ((bdaq)localObject2).f();
                if ((str == null) || (!str.equals("1"))) {
                  break label1576;
                }
                if (TextUtils.isEmpty(((bdaq)localObject2).c())) {
                  ((TextView)localView).setTextSize(12.0F);
                }
                if (TextUtils.isEmpty(((bdaq)localObject2).d())) {
                  ((TextView)localView).setTextColor(Color.parseColor("#8e8e8e"));
                }
              }
              label1452:
              localObject2 = ((bdaq)localObject2).f();
              if ((localObject2 != null) && (((String)localObject2).equals("1")))
              {
                paramView.topMargin = afur.a(3.0F, localResources);
                paramView.bottomMargin = afur.a(8.0F, localResources);
                label1501:
                if (this.o == 1)
                {
                  ((TextView)localView).setTextSize(12.0F);
              ...
              label1663:
              for (paramView.bottomMargin += afur.a(12.0F, localResources);; paramView.bottomMargin += afur.a(16.0F, localResources))
              {
                localView.setId(-1);
                break;
                if (TextUtils.isEmpty(((bdaq)localObject2).c())) {
                ...
                ((TextView)localView).setLineSpacing(4.0F, 1.0F);
                break label1452;
                paramView.topMargin = afur.a(5.0F, localResources);
                paramView.bottomMargin = afur.a(5.0F, localResources);
                break label1501;
              }
            }
            if ("hr".equals(str))
            {
              ...
              {
                if ((i != 0) && (n != 0)) {
                  paramView.topMargin += afur.a(6.0F, localResources);
                }
                if (i == 0) {
                  break label1761;
                }
            ...
            {
              paramView.height = afur.a(4.0F, localResources);
              if ((i1 == 1) && (localView.getVisibility() == 8))
              {
                ((LinearLayout)localObject1).setPadding(0, 0, 0, 0);
                if (a(1)) {
            ...
            {
              paramView = new LinearLayout.LayoutParams(-1, afur.a(36.0F, localResources));
            }
          }
        }
      }
