...
public class biwf
{
  ...
  public biwf(int paramInt1, String paramString1, String paramString2, String paramString3, ArrayList<String> paramArrayList, int paramInt2)
  {
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
