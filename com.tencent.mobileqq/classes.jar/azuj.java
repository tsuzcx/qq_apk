  ...
  implements TextWatcher
{
  ...
  public azuj(StickyNotePublishFragment paramStickyNotePublishFragment) {}
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqProfileStickynotePublishUiStickyNotePublishFragment.getActivity(), 1, 2131690259, 0).a();
      paramEditable.delete(this.jdField_a_of_type_Int, this.b);
    }
    paramEditable = aztr.a(StickyNotePublishFragment.a(this.jdField_a_of_type_ComTencentMobileqqProfileStickynotePublishUiStickyNotePublishFragment));
