...
public class aqdq
  extends aqbc
{
  private URLDrawableDownListener.Adapter jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new aqdr(this);
  ...
  public aqdq(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  private View b()
  {
    ...
    for (;;)
    {
      ...
      if (j != 0)
      {
        ...
        localFrameLayout.addView((View)localObject2, new FrameLayout.LayoutParams(-1, bbkx.a(33.0F), 16));
        ((View)localObject2).setOnClickListener(new aqds(this));
        ((View)localObject2).setContentDescription(ajyc.a(2131704763));
      }
      ...
      if ((localObject1 != null) && ((this.jdField_a_of_type_Bbgg instanceof aqdb))) {
        ((aqdb)this.jdField_a_of_type_Bbgg).a((String)localObject1);
      }
  ...
  private void b(bbgg parambbgg)
  {
    ...
    {
      localObject3 = URLDrawable.getDrawable((String)localObject3, (int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131296763), actn.a(165.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), localDrawable, localDrawable, true);
  ...
  private void e()
  {
    int j = 1;
    if (c() != 0) {}
    for (Object localObject1 = this.jdField_a_of_type_Bbgg.getInputValue();; localObject1 = "")
    {
      ...
      {
        localObject2 = actn.a(new Intent(this.jdField_a_of_type_AndroidAppActivity, SplashActivity.class), new int[] { 2 });
        ...
        {
          localObject3 = axuy.a(((Intent)localObject2).getExtras());
          Object localObject5;
          Object localObject6;
          ...
          while (((Iterator)localObject4).hasNext())
          {
            ...
            adgf.a().a((SessionInfo)localObject6, (String)localObject1, k);
            bbjj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((ResultRecord)localObject5).a, ((SessionInfo)localObject6).b, ((ResultRecord)localObject5).a(), (AbsStructMsg)localObject3, null);
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          else if (aqdl.a((Intent)localObject2))
          {
            localObject3 = ForwardUtils.a((Intent)localObject2, ((ResultRecord)localObject3).a, ((ResultRecord)localObject3).a(), ((ResultRecord)localObject3).c);
            ForwardUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, (SessionInfo)localObject3, (Intent)localObject2);
          }
      ...
      for (;;)
      {
        ...
        default: 
          ...
          if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("k_struct_forward", false))
          {
            ...
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005456", "0X8005456", 0, 0, (String)localObject4, (String)localObject2, (String)localObject3, "" + j);
          }
        ...
        for (;;)
        {
          ...
          {
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", this.jdField_a_of_type_AndroidOsBundle.getString("uin"), "Music_gene", "Music_gene_send", 0, 1, 0, "", "", "", "");
          }
        }
        v();
        return;
  ...
  public void a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    for (;;)
    {
      ...
      if ((paramAbsStructMsg != null) && (paramAbsStructMsg.size() != 0))
      {
        ...
        } while (!(localObject1 instanceof axxg));
        for (paramAbsStructMsg = (axxg)localObject1;; paramAbsStructMsg = null)
        {
          if (paramAbsStructMsg == null) {
            break label466;
          }
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            paramAbsStructMsg = (axzh)localObject2;
          }
          for (;;)
          {
            break label102;
            ...
            if (j < localStringBuilder.length())
            {
              ...
              if ('ÿ' == localStringBuilder.charAt(j))
              {
                ...
                if (j + 3 < localStringBuilder.length())
                {
                  ...
                  arrayOfInt = anqu.a((char[])localObject1);
                  localObject2 = ayki.c;
                  if (localaskd == null) {
                    break label454;
                  }
            ...
            for (localObject1 = localaskd.a(Integer.toString(arrayOfInt[0]), Integer.toString(arrayOfInt[1]));; localObject1 = null)
            {
              if (localObject1 != null) {}
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((Bundle)localObject).putString("intext_1", "" + bdej.a(this.jdField_c_of_type_Int));
        ((Bundle)localObject).putString("intext_3", "1");
        bded.a().a((Bundle)localObject, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
        return true;
  ...
  protected boolean a(bbgg parambbgg)
  {
    ...
    if (localObject != null)
    {
      ...
      parambbgg.addView(((AbsStructMsg)localObject).getPreDialogView(this.jdField_a_of_type_AndroidAppActivity, null), localLayoutParams);
      if (!bool) {
        a(((AbsStructMsg)localObject).getSourceName(), parambbgg);
      }
    }
    return true;
  }
  ...
  protected int d()
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (bgpd.a(str).b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), -1, null))) {}
    for (int j = 0;; j = -1)
    {
      if (j == 0) {
  ...
  protected void d()
  {
    ...
    if (this.jdField_a_of_type_AndroidOsBundle.getInt("uintype") == 1)
    {
      ...
      if (((bakk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a((String)localObject1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()))
      {
        bcpw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131697656, 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298865));
        return;
      }
    }
    if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("isWebCompShare", false))
    ...
    for (Object localObject1 = this.jdField_a_of_type_Bbgg.getInputValue();; localObject1 = "")
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl.startsWith("http://article.mp.qq.com")) || (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl.startsWith("http://post.mp.qq.com")))
      {
        ...
        noo.a(null, "", "0X8007236", "0X8007236", 0, 0, this.jdField_i_of_type_JavaLangString, "" + this.jdField_d_of_type_Int, (String)localObject2, "");
        noo.a("0X8007236", "", this.jdField_i_of_type_JavaLangString, "" + this.jdField_d_of_type_Int, (String)localObject2, "");
        if ((!TextUtils.isEmpty((CharSequence)localObject1)) || (!"".equals(localObject1))) {
          noo.a(null, "", "0X8007237", "0X8007237", 0, 0, this.jdField_i_of_type_JavaLangString, "" + this.jdField_d_of_type_Int, (String)localObject2, "");
        }
      }
      this.jdField_a_of_type_AndroidContentIntent.getAction();
      Object localObject2 = Boolean.valueOf(this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("key_flag_from_plugin", false));
      ...
      if (((Boolean)localObject2).booleanValue())
      {
        ...
        if (((Boolean)localObject3).booleanValue())
        {
          ...
          adgf.a().a((SessionInfo)localObject4, (String)localObject1, j);
          bbjj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidOsBundle.getString("uin"), ((SessionInfo)localObject4).b, this.jdField_a_of_type_AndroidOsBundle.getInt("uintype"), (AbsStructMsg)localObject3, null);
          if (!TextUtils.isEmpty((CharSequence)localObject1)) {
            mye.a().a = true;
          }
          localObject1 = new Intent();
  ...
  protected void r()
  {
    ...
    if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("k_struct_forward", false)) {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005457", "0X8005457", 0, 0, "", "", "android", "");
    }
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl.startsWith("http://article.mp.qq.com")) || (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl.startsWith("http://post.mp.qq.com")))
    {
      String str = this.jdField_a_of_type_AndroidOsBundle.getString("uin");
      noo.a(null, "", "0X8007235", "0X8007235", 0, 0, this.jdField_i_of_type_JavaLangString, "" + this.jdField_d_of_type_Int, str, "");
    }
  }
