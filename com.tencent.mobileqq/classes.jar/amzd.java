  ...
  extends amuv
{
  ...
  protected void a(boolean paramBoolean, byte[] paramArrayOfByte)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (paramArrayOfByte != null)
      {
        ...
        amzb.a(this.a).sendBroadcast(new Intent().setAction("com.tencent.mobileqq.onGetStreetViewUrl").putExtra("streetViewUrl", str1));
      }
    }
  ...
  protected void a(boolean paramBoolean, Object[] paramArrayOfObject)
  {
    ...
    amzb.a(this.a).sendBroadcast(localIntent);
  }
  ...
  protected void b(boolean paramBoolean, Object[] paramArrayOfObject)
  {
    ...
    amzb.a(this.a).sendBroadcast((Intent)localObject);
  }
