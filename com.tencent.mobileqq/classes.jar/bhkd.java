  ...
  extends QAlbumUtil
{
  ...
  public static int a(List<String> paramList, int paramInt, Map<String, LocalMediaInfo> paramMap1, boolean paramBoolean, Map<String, LocalMediaInfo> paramMap2)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((localObject == null) || (getMediaType((LocalMediaInfo)localObject) != 1))
      {
        ...
        bdmc.a(BaseApplicationImpl.getApplication()).a(null, "sendQualityPicLimit", true, paramInt, l, null, "");
        i += 1;
      }
    }
    label148:
  ...
  {
    bdll.b(null, "CliOper", "", "", "0X8009E99", "0X8009E99", 0, 0, paramInt1 + "", paramInt2 + "", "", "");
  }
  ...
  public static boolean a(Context paramContext, int paramInt, LocalMediaInfo paramLocalMediaInfo, boolean paramBoolean)
  {
    ...
    for (int i = b();; i = a())
    {
      ...
      if (paramInt >= i)
      {
        ...
        {
          QQToast.a(paramContext, anzj.a(2131699134) + i + anzj.a(2131699135), 0).a();
      ...
      {
        QQToast.a(paramContext, anzj.a(2131699133) + (float)l / 1024.0F / 1024.0F / 1024.0F + "G的视频", 0).a();
        paramBoolean = false;
      }
      if (paramLocalMediaInfo.mDuration <= 601000L) {
        break;
      }
      QQToast.a(paramContext, anzj.a(2131699132) + 10L + anzj.a(2131699136), 0).a();
      return false;
    }
    return paramBoolean;
  }
  ...
  public static boolean a(List<String> paramList, Activity paramActivity, int paramInt)
  {
    ...
    {
      QQToast.a(paramActivity, String.format(paramActivity.getResources().getString(2131717512), new Object[] { Integer.valueOf(paramInt) }), 0).b(paramActivity.getResources().getDimensionPixelSize(2131299011));
      return true;
    }
    return false;
  }
  ...
  {
    bdll.b(null, "CliOper", "", "", "0X8009E98", "0X8009E98", 0, 0, "", "", "", "");
  }
}
