  ...
  implements View.OnClickListener
{
  ...
  public aggq(PhotoListPanel paramPhotoListPanel) {}
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aggt == null) {}
    while (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aggt.getItemCount() <= 0) {
      return;
    }
    paramView = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aggt.a(this.jdField_a_of_type_Int);
    int j = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aggt.getItemViewType(this.jdField_a_of_type_Int);
    if ((!paramView.mChecked) && (bdar.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_JavaUtilLinkedList, this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_AndroidAppActivity, PhotoListPanel.jdField_a_of_type_Int)))
    {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 9501) && (!paramView.mChecked))
    {
      ...
      String str;
      for (i = 0; ((Iterator)localObject).hasNext(); i = (int)(i + bdcs.a(str))) {
        str = (String)((Iterator)localObject).next();
      }
      if (i + bdcs.a(paramView.path) > 52428800L)
      {
        localObject = (zpa)this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51);
        if ((localObject != null) && (((zpa)localObject).a()))
        {
          long l1 = 0L;
          try
          {
    ...
    if (!paramView.mChecked)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aggr != null) {
        this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aggr.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.a());
      }
      ...
      azmj.b(null, "CliOper", "", "", "0X8005E08", "0X8005E08", 0, 0, "", "", "", "");
