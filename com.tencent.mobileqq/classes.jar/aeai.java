...
{
  public aeai(SubLoginActivity paramSubLoginActivity) {}
  ...
  public void onGetKeyBack(String paramString1, String paramString2, String paramString3)
  {
    ...
    else
    {
      ...
      this.a.e();
      this.a.b(this.a.getString(2131720462));
    ...
    for (;;)
    {
      ...
      if (!SubLoginActivity.a(this.a))
      {
        ...
        bacu.a(this.a.app, (byte)1, paramString2);
        bacu.a(this.a.app, paramString2, 7);
        bact.b(this.a.app);
        bact.a(this.a.app);
        this.a.setTitle("");
        bact.a(this.a.app, this.a, paramString2);
        this.a.finish();
      }
  ...
  public void onLoginFailed(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      azri.a(BaseApplication.getContext()).a(this.a.app.getCurrentAccountUin(), "actSBLogin", false, 0L, 0L, paramString2, "");
      ...
      try
      {
        ...
        {
          this.a.b(this.a.getString(2131694766));
          return;
      ...
      catch (Exception paramString1)
      {
        ...
        this.a.b(this.a.getResources().getString(2131719379), paramString4, null);
      }
    }
  }
  ...
  public void onLoginTimeout(String paramString1, String paramString2, String paramString3)
  {
    ...
    paramString1.put("fail_location", "subLogin");
    azri.a(BaseApplication.getContext()).a(this.a.app.getCurrentAccountUin(), "actSBLogin", false, 0L, 0L, paramString1, "");
    if (!this.a.getActivity().isFinishing()) {}
    try
    {
      this.a.e();
