...
public class azxy
{
  ...
  @SuppressLint({"NewApi"})
  public static void a(View paramView, String paramString1, azxy paramazxy, String paramString2)
  {
    if ((paramView == null) || (paramazxy == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (a(paramazxy.jdField_o_of_type_Long))) {}
    do
    {
      do
      {
          ...
          do
          {
            do
            {
              do
              {
                do
                {
                  do
                  {
                    do
                    {
                      do
                      {
                        do
                        {
                          do
                          {
                              ...
                              do
                              {
                                do
                                {
                                  do
                                  {
                                    ...
                                    {
                                      return;
                                      paramazxy = paramazxy.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString2);
                                    } while (paramazxy == null);
                                    if ((!paramString1.equalsIgnoreCase("color")) || (!(paramView instanceof TextView))) {
                                      break;
                                    }
                                    paramView = (TextView)paramView;
                                    if ((paramazxy instanceof ColorStateList))
                                    {
                                      paramView.setTextColor((ColorStateList)paramazxy);
                                      return;
                                    }
                                  } while (!(paramazxy instanceof String));
                                  paramString1 = (String)paramazxy;
                            ...
                            if ((paramazxy instanceof Drawable))
                            {
                              paramString1 = ((Drawable)paramazxy).getConstantState().newDrawable();
                              paramazxy = new Rect();
                              paramString1.getPadding(paramazxy);
                              int i1 = paramView.getPaddingTop();
                              int i2 = paramazxy.top;
                              int i3 = paramView.getPaddingLeft();
                              int i4 = paramazxy.left;
                              int i5 = paramView.getPaddingRight();
                              int i6 = paramazxy.right;
                              int i7 = paramView.getPaddingBottom();
                              int i8 = paramazxy.bottom;
                              paramazxy = paramView.findViewById(2131374416);
                              if (Build.VERSION.SDK_INT >= 16)
                              {
                                paramView.setBackground(paramString1);
                                if (paramazxy != null) {
                                  paramazxy.setBackground(paramString1);
                                }
                              }
                              for (;;)
                              {
                                ...
                                if (paramazxy != null) {
                                  paramazxy.setBackgroundDrawable(paramString1);
                                }
                              }
                            }
                          } while (!(paramazxy instanceof String));
                      ...
                      } while (!(paramazxy instanceof Drawable));
                      paramView = (TextView)paramView;
                    } while (!(paramazxy instanceof Drawable));
                    paramView.setCompoundDrawablesWithIntrinsicBounds(((Drawable)paramazxy).getConstantState().newDrawable(), null, null, null);
                    return;
                ...
                paramView.setCompoundDrawablesWithIntrinsicBounds(null, null, ((Drawable)paramazxy).getConstantState().newDrawable(), null);
                return;
            ...
            paramView.setImageDrawable(((Drawable)paramazxy).getConstantState().newDrawable());
            return;
        ...
        paramView.setContentBackground(((Drawable)paramazxy).getConstantState().newDrawable());
        return;
        if ((!paramString1.equalsIgnoreCase("apngDrawable")) || (!(paramView instanceof ImageView))) {
          break;
        }
      } while (!(paramazxy instanceof Drawable));
      ((ImageView)paramView).setImageDrawable((Drawable)paramazxy);
      return;
    } while ((!paramString1.equalsIgnoreCase("shimmer_mask")) || (!(paramView instanceof ShimmerLinearLayout)) || (!(paramazxy instanceof BitmapDrawable)));
    paramString1 = (BitmapDrawable)paramazxy;
    paramazxy = (ShimmerLinearLayout)paramView;
  ...
  public Drawable a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Object localObject3 = bhhz.a(paramQQAppInterface, -1L);
        localObject1 = str;
  ...
  public JSONObject a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    //   47: lcmp
    //   48: ifne +23 -> 71
    //   51: getstatic 776	azxy:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   54: ifnull +17 -> 71
    //   57: getstatic 776	azxy:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   60: astore_1
    //   61: aload_1
    //   62: areturn
    //   63: ldc_w 778
    ...
    //   73: lcmp
    //   74: ifeq +13 -> 87
    //   77: getstatic 780	azxy:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   80: ifnull +7 -> 87
    //   83: getstatic 780	azxy:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   86: areturn
    ...
    //   121: aload_1
    //   122: ldc2_w 549
    //   125: invokestatic 555	bhhz:a	(Lcom/tencent/mobileqq/app/QQAppInterface;J)Ljava/lang/String;
    //   128: astore_1
    //   129: aload_1
    //   130: ifnull +142 -> 272
    //   133: aload_1
    ...
    //   336: putstatic 776	azxy:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   339: aload 5
    //   341: astore_1
    //   342: getstatic 776	azxy:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   345: astore 6
    //   347: aload 6
    //   349: astore_1
    //   350: aload 5
    ...
    //   383: putstatic 780	azxy:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   386: aload 5
    //   388: astore_1
    //   389: getstatic 780	azxy:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   392: astore 6
    //   394: aload 6
    //   396: astore_1
    //   397: aload 5
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        catch (Exception paramQQAppInterface)
        {
          ...
          if (!azzb.a(paramQQAppInterface)) {
            continue;
          }
          str1 = azze.a(paramQQAppInterface.getApp());
