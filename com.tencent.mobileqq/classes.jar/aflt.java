...
public class aflt
  extends akav
{
  public aflt(SystemRequestInfoView paramSystemRequestInfoView) {}
  
  protected void a(String paramString)
  {
    if (this.a.a())
    {
      paramString = this.a.getResources().getString(2131719993);
      bcpw.a(this.a.getContext(), 1, paramString, 0).b(this.a.a());
    }
  ...
  protected void a(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!paramBoolean) {
          ...
          {
            bcpw.a(this.a.getContext(), 1, paramString3, 0).b(this.a.a());
    ...
    for (;;)
    {
      bcpw.a(this.a.getContext(), 2, paramString1, 0).b(this.a.a());
      return;
      label234:
      ...
      if (paramInt1 == 0)
      {
        ...
        {
          paramString1 = this.a.getResources().getString(2131692781);
