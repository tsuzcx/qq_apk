...
{
  xmq(xmo paramxmo, long paramLong, String paramString) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.has())
        {
          ...
          if (!TextUtils.isEmpty(paramBundle))
          {
            if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.delayms.has())
            {
              ...
              this.jdField_a_of_type_Xmo.e.put(paramBundle, Integer.valueOf(2147483647));
              if (QLog.isColorLevel()) {
            ...
            if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.packagesize.has())
            {
              ...
              this.jdField_a_of_type_Xmo.b.put(paramBundle, Long.valueOf(l1));
              if (QLog.isColorLevel()) {
        ...
        xmo.a(this.jdField_a_of_type_Xmo, this.jdField_a_of_type_JavaLangString, l2, paramInt);
        ...
        arpb.d = System.currentTimeMillis();
        l1 = arpb.d - arpb.jdField_a_of_type_Long;
        long l3 = arpb.b - arpb.jdField_a_of_type_Long;
        long l4 = arpb.c - arpb.b;
        long l5 = arpb.d - arpb.c;
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_Xmo.callJs((String)localObject1, new String[] { ((JSONObject)localObject2).toString() });
        try
        {
          ...
          localObject3 = this.jdField_a_of_type_Xmo.mRuntime.a().getCurrentAccountUin();
          ...
          localObject1 = axrl.a(this.jdField_a_of_type_Xmo.mRuntime.a());
          if (0L != l6) {
            break;
          }
          paramBoolean = true;
          label1110:
          ((axrl)localObject1).a((String)localObject3, paramBundle, paramBoolean, l1, 0L, (HashMap)localObject2, "", false);
          return;
        }
      ...
      return;
      label1197:
      this.jdField_a_of_type_Xmo.e.put(paramBundle, Integer.valueOf((int)l1));
      continue;
      label1218:
      xmo.a(this.jdField_a_of_type_Xmo, this.jdField_a_of_type_JavaLangString, paramInt);
      continue;
      label1233:
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject3)) {
        xmo.b(this.jdField_a_of_type_Xmo, (String)localObject3, paramInt);
      }
      ...
      ((JSONObject)localObject2).put("businessRet", 0);
      ((JSONObject)localObject2).put("msg", ajyc.a(2131714335));
    }
    for (;;)
    {
      label1431:
      ...
      ((JSONObject)localObject2).put("businessRet", 0);
      ((JSONObject)localObject2).put("msg", ajyc.a(2131714341));
      break;
      label1510:
      label1511:
      do
      {
        ((JSONObject)localObject2).put("ssoRet", 255);
        ((JSONObject)localObject2).put("businessRet", 0);
        ((JSONObject)localObject2).put("msg", ajyc.a(2131714340));
        break;
        paramBoolean = false;
        break label1110;
        return;
