...
public class bgcs
{
  ...
  public final Queue<bgcx> a;
  
  public bgcs(SnapshotResultReceiver paramSnapshotResultReceiver)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put("offline_pkg", nku.b());
  }
  ...
  public static void a(Application paramApplication, String paramString, int paramInt)
  {
    ...
    localEditor.putBoolean("need_set_proxy", true);
    localEditor.commit();
    bgjw.a(paramApplication, "com.tencent.mobileqq:tool");
    if (QLog.isColorLevel())
    {
  ...
  public bgcy a(Context paramContext)
  {
    bgcy localbgcy = new bgcy(this);
    localbgcy.jdField_a_of_type_JavaLangString = (bgln.h() + " " + bgln.d());
    localbgcy.jdField_b_of_type_JavaLangString = Build.VERSION.RELEASE;
    localbgcy.c = "8.4.1.4680";
    bglo localbglo = bgln.a(paramContext);
    localbgcy.d = localbglo.jdField_a_of_type_JavaLangString;
    localbgcy.e = localbglo.c;
    localbgcy.jdField_a_of_type_Int = bgln.b();
    localbgcy.jdField_a_of_type_Long = bgln.a();
    localbgcy.jdField_b_of_type_Long = bgln.d();
    localbgcy.f = bgln.g();
    localbgcy.jdField_a_of_type_Boolean = a(paramContext);
    localbgcy.jdField_b_of_type_Int = QbSdk.getTbsVersion(paramContext);
    if (localbgcy.jdField_b_of_type_Int == 0) {}
    for (boolean bool = false;; bool = true)
    {
      localbgcy.jdField_b_of_type_Boolean = bool;
      return localbgcy;
    }
  }
  ...
  public String a()
  {
    bgcr localbgcr = bgcq.a("getprop net.dns1");
    if (localbgcr.jdField_a_of_type_Boolean)
    {
      if (!localbgcr.jdField_a_of_type_JavaUtilList.isEmpty()) {
        return (String)localbgcr.jdField_a_of_type_JavaUtilList.get(0);
      }
    }
    else if (QLog.isColorLevel()) {
      QLog.d("UnifiedDebugManager", 2, localbgcr.jdField_a_of_type_JavaLangString);
    }
    return "";
  }
  ...
  public String a(long paramLong1, long paramLong2)
  {
    ...
    //   705: aload 22
    //   707: aload 18
    //   709: invokestatic 524	bgdc:a	(Ljava/util/List;Ljava/lang/String;)V
    //   712: aload 18
    //   714: areturn
    //   715: astore 19
    //   717: ldc 140
  ...
  public String a(Context paramContext, String paramString)
  {
    ...
    {
      paramString = paramContext.list(new bgcv(this, paramString));
      ...
      finally
      {
        try
        {
          ...
          try
          {
            ...
            bgdc.a(localArrayList, paramContext);
            bgdc.a(localArrayList);
            return paramContext;
          }
  ...
  public String a(Context paramContext, List<String> paramList)
  {
    ...
    if ((((File)localObject1).exists()) && (((File)localObject1).isDirectory()))
    {
      ...
      while (paramList.hasNext())
      {
        localObject2 = ((File)localObject1).list(new bgct(this, c((String)paramList.next()).substring(0, 16)));
  ...
  public String a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    //   11: ldc_w 702
    //   14: ldc_w 383
    //   17: invokestatic 705	bhre:c	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   79: invokestatic 729	nmj:c	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   97: invokestatic 733	nmj:b	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   527: aload_1
    //   528: aload 4
    //   530: invokestatic 524	bgdc:a	(Ljava/util/List;Ljava/lang/String;)V
    //   533: aload 4
    //   535: areturn
    //   536: astore 4
    //   538: ldc 140
  ...
  public String a(File paramFile, List<String> paramList)
  {
    ...
    bgdc.a(paramFile, paramList, str);
    return str;
  }
  ...
  public void a(Context paramContext, String paramString1, int paramInt, long paramLong1, long paramLong2, String paramString2)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      ...
      {
        this.jdField_a_of_type_JavaUtilQueue.offer(new bgcx(this, paramString1, paramInt, paramLong1, paramLong2, paramString2));
        return;
      }
  ...
  public void a(Context paramContext, List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = paramContext.listFiles(new bgcu(this, c((String)paramList.next()).substring(0, 16)));
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, Handler paramHandler)
  {
    ...
    new bgdd(paramQQAppInterface, paramHandler).a(paramLong, str1, paramString);
  }
  ...
  public boolean a(Context paramContext, long paramLong)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      bgcx localbgcx = (bgcx)this.jdField_a_of_type_JavaUtilQueue.poll();
      if ((localbgcx != null) && (localbgcx.jdField_b_of_type_Long == paramLong))
      {
        localbgcx = (bgcx)this.jdField_a_of_type_JavaUtilQueue.peek();
        if (localbgcx != null)
        {
          b(paramContext, localbgcx.jdField_a_of_type_JavaLangString, localbgcx.jdField_a_of_type_Int, localbgcx.jdField_a_of_type_Long, localbgcx.jdField_b_of_type_Long, localbgcx.jdField_b_of_type_JavaLangString);
          if (QLog.isColorLevel()) {
            QLog.d("UnifiedDebugManager", 2, "finish once webview debug, start new debug(dequeue one cmd): seq=" + localbgcx.jdField_b_of_type_Long);
          }
        }
        while (!QLog.isColorLevel()) {
          return true;
  ...
  {
    paramContext = bgdc.a(a(paramContext));
  ...
  public void b(Context paramContext, String paramString, List<String> paramList)
  {
    ...
    if ((paramContext.exists()) && (paramContext.isDirectory()))
    {
      paramString = paramContext.list(new bgcw(this, paramString));
      if ((paramString != null) && (paramString.length > 0))
      {
        int j = paramString.length;
        int i = 0;
