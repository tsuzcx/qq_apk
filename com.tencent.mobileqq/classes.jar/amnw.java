...
public class amnw
{
  ...
  public amnw(ApolloRenderDriver paramApolloRenderDriver, ApolloRender paramApolloRender)
  {
  ...
  public int a(int paramInt, String paramString, int[] paramArrayOfInt, anhu paramanhu)
  {
    int j = 0;
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 2, new Object[] { "[onChangeDress] apolloId=", paramString, ", roleType=", Integer.valueOf(paramInt), ", dressId=", paramArrayOfInt, ", callback=", paramanhu });
    }
    int i;
    ...
    paramInt = this.jdField_a_of_type_ComTencentMobileqqApolloApolloRenderDriver.a(paramInt, paramString, paramArrayOfInt, paramanhu);
    this.jdField_a_of_type_ComTencentMobileqqApolloApolloRenderDriver.a();
    return paramInt;
  }
