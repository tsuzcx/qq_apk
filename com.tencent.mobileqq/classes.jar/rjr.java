...
public class rjr
  implements Runnable
{
  public rjr(AssociatedAccountActivity paramAssociatedAccountActivity, QQMessageFacade paramQQMessageFacade) {}
  ...
  public void run()
  {
    ...
    String str = this.jdField_a_of_type_ComTencentMobileqqActivityAssociatedAccountActivity.getString(2131433280);
    int i;
    Object localObject;
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityAssociatedAccountActivity.runOnUiThread(new rjs(this, (String)localObject));
        return;
      }
    }
  }
