  ...
  extends IArConfigManager.Stub
{
  ...
  public aacp(ArConfigService paramArConfigService)
  {
  ...
  public void c()
  {
    ...
    do
    {
      ...
      i = (ArConfigService.a(localArConfigService) + ArConfigService.b(localArConfigService) + ArConfigService.c(localArConfigService)) / 3;
      ArConfigService.a(localArConfigService).post(new aacq(this, localArConfigService, i));
    } while (i != 100);
    ArConfigService.a(localArConfigService).post(new aacr(this, localArConfigService));
  }
}
