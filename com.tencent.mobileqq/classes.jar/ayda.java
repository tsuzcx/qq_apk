  ...
  extends aawa
{
  ...
  public ayda(Context paramContext, PicInfo paramPicInfo)
  {
  ...
  public View a(int paramInt, Handler paramHandler, aydc paramaydc)
  {
    ...
    else
    {
      ...
      localURLImageView.setURLDrawableDownListener(new aydb(this, paramaydc, paramInt));
      if (!bool1) {
        break label619;
      }
      l = 1000L;
      paramHandler.postDelayed(new PicBrowserImage.3(this, (URLDrawable)localObject1, paramaydc, paramInt), l);
    }
    for (;;)
    {
      label441:
      ...
      for (;;)
      {
        ...
        if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.a))
        {
          ...
          try
          {
            ...
            ((URLDrawable)localObject2).setDownloadListener(new axnq(this.jdField_a_of_type_AndroidContentContext, "actNearbyPicBrowser"));
            localObject1 = localObject2;
  ...
  public void a()
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        ...
        ((URLDrawable)localObject).setDownloadListener(new axnq(this.jdField_a_of_type_AndroidContentContext));
