...
public class lsg
{
  ...
  private lsh[] jdField_a_of_type_ArrayOfLsh;
  ...
  private lsh a(int paramInt)
  {
    Object localObject2 = null;
    Object localObject1 = localObject2;
    if (this.jdField_a_of_type_ArrayOfLsh != null)
    {
      localObject1 = localObject2;
      if (paramInt < this.jdField_a_of_type_ArrayOfLsh.length) {
        localObject1 = this.jdField_a_of_type_ArrayOfLsh[paramInt];
      }
    }
    return localObject1;
  }
  ...
  private static void a(byte[] paramArrayOfByte, String paramString)
  {
    ...
    //   23: aload_2
    //   24: aload_0
    //   25: invokestatic 140	lsg:b	(Ljava/io/FileOutputStream;[B)V
    //   28: aload_2
    //   29: astore_1
    //   30: aload_2
  ...
  public void a()
  {
    ...
    for (this.jdField_a_of_type_Boolean = true;; this.jdField_a_of_type_Boolean = false)
    {
      ...
      if (this.jdField_a_of_type_ArrayOfLsh == null)
      {
        this.jdField_a_of_type_ArrayOfLsh = new lsh[6];
        i = j;
      }
      while (i < this.jdField_a_of_type_ArrayOfLsh.length)
      {
        localObject2 = (String)localObject1 + jdField_a_of_type_ArrayOfJavaLangString[i];
        if (this.jdField_a_of_type_ArrayOfLsh[i] != null) {
          this.jdField_a_of_type_ArrayOfLsh[i].a();
        }
        this.jdField_a_of_type_ArrayOfLsh[i] = new lsh((String)localObject2);
        i += 1;
      }
      break;
      if (!this.jdField_a_of_type_Boolean) {
  ...
  @TargetApi(23)
  void a(lse paramlse, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3)
  {
    lsh locallsh;
    Object localObject2;
    int i1;
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      locallsh = a(paramInt1);
      if (locallsh != null)
      {
        localObject2 = null;
        i1 = 0;
        m = paramlse.jdField_a_of_type_Int;
        n = paramlse.jdField_b_of_type_Int;
        if ((paramInt1 != 0) && (paramInt1 != 5)) {
          break label91;
        }
        i = 17;
        j = paramlse.jdField_b_of_type_Int;
        k = paramlse.jdField_a_of_type_Int;
    ...
    for (;;)
    {
      if (localObject1 != null) {
        locallsh.a((byte[])localObject1, i, j, k);
      }
      if (this.c) {
        break;
      }
      ...
      {
        m = paramlse.jdField_b_of_type_Int;
        n = paramlse.jdField_a_of_type_Int;
        if (paramlse.jdField_a_of_type_ArrayOfByte != null)
        {
          localObject1 = paramlse.jdField_a_of_type_ArrayOfByte;
          i = 42;
          k = n;
          j = m;
        }
        else
        {
          ...
          i = i1;
          localObject1 = localObject2;
          if (paramlse.jdField_b_of_type_ArrayOfByte != null)
          {
            localObject1 = paramlse.jdField_b_of_type_ArrayOfByte;
            i = 35;
            k = n;
            j = m;
          }
      ...
      else
      {
        ...
        if (paramInt1 == 1) {
          ...
          else
          {
            ...
            {
              a(m, n);
              lse.a(paramInt2, m, n, this.jdField_a_of_type_ArrayOfByte);
              localObject1 = this.jdField_a_of_type_ArrayOfByte;
              i = 42;
              k = n;
              j = m;
    ...
    int i = paramlse.jdField_b_of_type_Int * paramlse.jdField_a_of_type_Int * 4;
    if (paramArrayOfByte != null) {
      a(paramArrayOfByte, (String)localObject1 + "_yuvData_" + a(paramlse.jdField_b_of_type_Int, paramlse.jdField_a_of_type_Int, 17) + ".yuv");
    }
    if (paramInt3 != -1)
    {
      paramArrayOfByte = (String)localObject1 + "_textureId_1_" + a(paramlse.jdField_a_of_type_Int, paramlse.jdField_b_of_type_Int, 0) + ".jpg";
      lse.a(paramInt3, paramlse.jdField_a_of_type_Int, paramlse.jdField_b_of_type_Int, paramArrayOfByte);
    }
    if (paramInt2 != -1)
    {
      ...
      paramArrayOfByte = (String)localObject1 + "_fbo_1_" + a(paramlse.jdField_a_of_type_Int, paramlse.jdField_b_of_type_Int, 42) + ".yuv";
      lse.a(paramInt2, paramlse.jdField_a_of_type_Int, paramlse.jdField_b_of_type_Int, this.jdField_a_of_type_ArrayOfByte);
    ...
    if (paramInt1 == 1)
    {
      if (paramlse.c != -1)
      {
        paramArrayOfByte = (String)localObject1 + "_mYuvTextureId_for_Y_1" + a(paramlse.jdField_a_of_type_Int, paramlse.jdField_b_of_type_Int, 0) + ".jpg";
        lse.a(paramlse.c, paramlse.jdField_a_of_type_Int, paramlse.jdField_b_of_type_Int, paramArrayOfByte);
        if ((this.jdField_a_of_type_ArrayOfByte == null) || (this.jdField_a_of_type_ArrayOfByte.length != i)) {
          this.jdField_a_of_type_ArrayOfByte = new byte[i];
        }
        paramArrayOfByte = (String)localObject1 + "_mYuvTextureId_for_Y_1" + a(paramlse.jdField_a_of_type_Int, paramlse.jdField_b_of_type_Int, 42) + ".yuv";
        a(paramlse.c, 6409, paramlse.jdField_a_of_type_Int, paramlse.jdField_b_of_type_Int, this.jdField_a_of_type_ArrayOfByte);
        a(this.jdField_a_of_type_ArrayOfByte, paramArrayOfByte);
      }
      if (paramlse.d != -1)
      {
        paramArrayOfByte = (String)localObject1 + "_mYuvTextureId_for_UV_1" + a(paramlse.jdField_a_of_type_Int / 2, paramlse.jdField_b_of_type_Int / 2, 0) + ".jpg";
        lse.a(paramlse.d, paramlse.jdField_a_of_type_Int / 2, paramlse.jdField_b_of_type_Int / 2, paramArrayOfByte);
        if ((this.jdField_a_of_type_ArrayOfByte == null) || (this.jdField_a_of_type_ArrayOfByte.length != i)) {
          this.jdField_a_of_type_ArrayOfByte = new byte[i];
        }
        paramArrayOfByte = (String)localObject1 + "_mYuvTextureId_for_UV_1" + a(paramlse.jdField_a_of_type_Int, paramlse.jdField_b_of_type_Int, 42) + ".yuv";
        a(paramlse.d, 6410, paramlse.jdField_a_of_type_Int, paramlse.jdField_b_of_type_Int, this.jdField_a_of_type_ArrayOfByte);
        a(this.jdField_a_of_type_ArrayOfByte, paramArrayOfByte);
      }
    }
    for (;;)
    {
      if (paramlse.f != -1)
      {
        paramArrayOfByte = (String)localObject1 + "_yuvCenterTextureFbo_1" + a(paramlse.jdField_a_of_type_Int, paramlse.jdField_b_of_type_Int, 0) + ".jpg";
        lse.a(paramlse.f, paramlse.jdField_a_of_type_Int, paramlse.jdField_b_of_type_Int, paramArrayOfByte);
      }
      if (paramlse.e != -1)
      {
        paramArrayOfByte = (String)localObject1 + "_yuvCenterTextureId_1" + a(paramlse.jdField_a_of_type_Int, paramlse.jdField_b_of_type_Int, 0) + ".jpg";
        lse.a(paramlse.e, paramlse.jdField_a_of_type_Int, paramlse.jdField_b_of_type_Int, paramArrayOfByte);
      }
      ...
      if (paramInt1 == 4)
      {
        if (paramlse.h != -1)
        {
          ...
          paramArrayOfByte = (String)localObject1 + "_rgbRotateCenterTextureFbo_" + paramlse.h + "_" + a(paramlse.jdField_b_of_type_Int, paramlse.jdField_a_of_type_Int, 42) + ".yuv";
          lse.a(paramlse.h, paramlse.jdField_b_of_type_Int, paramlse.jdField_a_of_type_Int, this.jdField_a_of_type_ArrayOfByte);
          a(this.jdField_a_of_type_ArrayOfByte, paramArrayOfByte);
        }
        if (paramlse.g != -1)
        {
          paramArrayOfByte = (String)localObject1 + "_rgbRotateCenterTextureId_" + a(paramlse.jdField_b_of_type_Int, paramlse.jdField_a_of_type_Int, 0) + ".jpg";
          lse.a(paramlse.g, paramlse.jdField_b_of_type_Int, paramlse.jdField_a_of_type_Int, paramArrayOfByte);
        }
        if (paramlse.jdField_b_of_type_ArrayOfByte != null)
        {
          paramArrayOfByte = (String)localObject1 + "_i420Data_" + a(paramlse.jdField_b_of_type_Int, paramlse.jdField_a_of_type_Int, 17) + ".yuv";
          a(paramlse.jdField_b_of_type_ArrayOfByte, paramArrayOfByte);
        }
        else if (paramlse.jdField_a_of_type_ArrayOfByte != null)
        {
          paramArrayOfByte = (String)localObject1 + "_rgbaData_" + a(paramlse.jdField_b_of_type_Int, paramlse.jdField_a_of_type_Int, 42) + ".yuv";
          a(paramlse.jdField_a_of_type_ArrayOfByte, paramArrayOfByte);
        }
      }
    }
  }
  ...
  public void b()
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_ArrayOfLsh != null) && (this.jdField_a_of_type_ArrayOfLsh.length > 0))
      {
        int i = 0;
        while (i < this.jdField_a_of_type_ArrayOfLsh.length)
        {
          ...
          {
            this.jdField_a_of_type_ArrayOfLsh[i].a();
            this.jdField_a_of_type_ArrayOfLsh[i] = null;
          }
          i += 1;
        }
      }
