...
import com.tencent.biz.webviewplugin.Share.8;
...
public class xdt
  implements View.OnClickListener, bcag
{
  ...
  public xdt(AppInterface paramAppInterface, Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_MqqObserverBusinessObserver = new xdw(this);
    this.jdField_a_of_type_AndroidOsHandler = new xdx(this);
    ...
    if ((paramActivity instanceof bazo)) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference((bazo)paramActivity);
    }
    while (this.jdField_a_of_type_JavaLangRefWeakReference == null)
    {
      QLog.e(jdField_a_of_type_JavaLangString, 2, "Error! mWebUiUtils still null! " + paramActivity.toString());
      return;
      if ((paramActivity instanceof bazk))
      {
        paramAppInterface = ((bazk)paramActivity).b();
    ...
    paramAppInterface = (bazo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((paramAppInterface != null) && ((paramAppInterface instanceof bbev)))
    {
      this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView = ((bbev)paramAppInterface).getWebView();
      if (QLog.isColorLevel())
      {
  ...
  public static final String a(List<xdy> paramList, int paramInt)
  {
    ...
    label270:
    label276:
    for (localObject2 = (xdy)paramList.get(i1);; localObject3 = localObject1)
    {
      try
      {
        int i3 = Integer.valueOf(((xdy)localObject2).b.get()).intValue();
        if (i3 >= paramInt)
        {
          localObject2 = ((xdy)localObject2).a.get();
          localObject1 = localObject2;
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ...
            if (localObject2 == null)
            {
              ...
              localObject2 = (xdy)paramList.get(i1);
            }
          }
          i1 += 1;
        }
      ...
      catch (NumberFormatException localNumberFormatException1)
      {
        try
        {
          i2 = Integer.valueOf(((xdy)localObject2).b.get()).intValue();
          if (i2 >= paramInt) {
            break label267;
          }
          localObject2 = ((xdy)localObject2).a.get();
  ...
  public static List<xdy> a(PBRepeatMessageField<GetAppInfoProto.MsgIconsurl> paramPBRepeatMessageField)
  {
    if ((paramPBRepeatMessageField != null) && (!paramPBRepeatMessageField.isEmpty()))
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        paramPBRepeatMessageField.add(new xdy(localMsgIconsurl.url, localMsgIconsurl.size));
      }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 2, "onGetSummary. title=" + this.jdField_e_of_type_JavaLangString + ", desc=" + this.h + ", thumb=" + this.i + ", bitmap=" + paramBitmap);
    }
    Object localObject1;
    Object localObject2;
    int i2;
    ...
    else
    {
      ...
      else
      {
        ...
        ((Bundle)localObject2).putString("intext_3", "" + bcaj.b(paramInt));
        ((Bundle)localObject2).putString("intext_2", "" + i2);
        ((Bundle)localObject2).putString("stringext_1", paramString3);
        bcad.a().a((Bundle)localObject2, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
      }
      ...
      ((Bundle)localObject1).putLong("share_begin_time", bbbt.jdField_b_of_type_Long);
      if (!(this.jdField_a_of_type_AndroidAppActivity instanceof bazk)) {
        break label3432;
      }
      paramString1 = ((bazk)this.jdField_a_of_type_AndroidAppActivity).b();
    ...
    for (;;)
    {
      if ((paramInt != 0) || (!bfqn.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_b_of_type_AndroidAppActivity, (Bundle)localObject1, null))) {
        vvp.a(1, 2131623975);
      }
      return;
      ...
      for (;;)
      {
        ...
        catch (Exception paramBitmap)
        {
          ...
          localObject4 = ((Resources)localObject9).getString(2131631001);
          continue;
          paramBitmap = "plugin";
        ...
        if ((this.jdField_a_of_type_AndroidAppActivity instanceof PublicAccountBrowser))
        {
          ...
          if ((TextUtils.isEmpty(str2)) || (TextUtils.isEmpty((CharSequence)localObject4))) {
            if (jdField_f_of_type_Boolean)
            {
              ...
              if (paramInt != 0)
              {
                localObject4 = this.jdField_b_of_type_AndroidAppActivity.getString(2131631005);
              ...
              baic.a(this.jdField_a_of_type_AndroidAppActivity, 1001, 146, "web_share", str2, paramString4, paramString1, paramString2, String.format(((Resources)localObject9).getString(2131630985), new Object[] { paramString1 }), paramString3, "web", null, null, null, paramBitmap, null, (String)localObject1, (String)localObject2, (String)localObject3, (String)localObject4, "", localIntent, -1, null, -1L);
              i1 = 0;
              if (TextUtils.isEmpty(paramString4)) {
                i1 = 1;
              }
              ...
              bcad.a().a(paramString1, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
              return;
            }
          }
        }
        ...
        for (;;)
        {
          ...
          for (localObject1 = "http://qzonestyle.gtimg.cn/qzone/phone/n/QQ-Qzone-Android/logo_16.png";; localObject1 = paramBitmap)
          {
            ...
            if ((this.jdField_a_of_type_AndroidAppActivity instanceof bazk))
            {
              localObject8 = ((bazk)this.jdField_a_of_type_AndroidAppActivity).b();
              paramBitmap = (Bitmap)localObject6;
            ...
            label1586:
            if (axfs.a(paramString3))
            {
              localObject7 = "web";
              localObject4 = ajjy.a(2131648082);
              if (TextUtils.isEmpty(amlh.a().h()))
              {
                localObject1 = axfs.jdField_b_of_type_JavaLangString;
                label1624:
                localObject2 = axfs.jdField_d_of_type_JavaLangString;
                paramInt = 95;
                l1 = axfs.jdField_a_of_type_Long;
            ...
            for (;;)
            {
              if ((bool2) || (bool1))
              {
                ...
                localObject8 = this.jdField_b_of_type_AndroidAppActivity.getString(2131630985, new Object[] { paramString1 });
                if (this.jdField_a_of_type_Axdv != null) {
                  break label1917;
                }
              }
              label1747:
              ...
              for (i2 = -1;; i2 = 1001)
              {
                baic.a((Context)localObject7, i1, paramInt, "web_share", paramBitmap, paramString4, paramString1, paramString2, (String)localObject8, paramString3, "web", null, null, null, (String)localObject1, null, (String)localObject5, (String)localObject3, (String)localObject2, (String)localObject4, "", localIntent, i2, (String)localObject6, l1);
                break;
                localObject2 = this.jdField_b_of_type_AndroidAppActivity.getString(2131631001);
              ...
              if ((paramInt == 3) || (paramInt == 4)) {
                if (paramInt == 3)
                {
                  ...
                  {
                    this.jdField_a_of_type_Bbsh = new xdv(this, paramString3);
                    WXShareHelper.a().a(this.jdField_a_of_type_Bbsh);
                  }
                  this.o = String.valueOf(System.currentTimeMillis());
                  if ((TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString)) || (!axfs.jdField_b_of_type_JavaUtilMap.containsKey(this.jdField_f_of_type_JavaLangString))) {
                    break label2230;
                  }
                  paramString4 = (Integer)axfs.jdField_b_of_type_JavaUtilMap.get(this.jdField_f_of_type_JavaLangString);
              ...
              for (;;)
              {
                ...
                if ((paramString3 != null) && (paramString3.contains("docs.qq.com/")))
                {
                  if (paramInt == 3)
                  {
                    ...
                    if ((a() != null) && (a().l != null))
                    {
                      ...
                      paramString1 = axfs.a(this.jdField_g_of_type_JavaLangString);
                      if ((TextUtils.isEmpty(this.jdField_g_of_type_JavaLangString)) || (!axfs.d(this.jdField_g_of_type_JavaLangString))) {
                        break label2308;
                      }
                      if (paramString1 == null) {
                        break label2299;
                ...
                if (paramInt == 5)
                {
                  ...
                  {
                    awqx.b(null, "CliOper", "", "", "0X8006277", "0X8006277", 0, 0, "", "", "", "");
                  ...
                  if (bgmw.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_b_of_type_AndroidAppActivity, (Bundle)localObject1, null, 0)) {
                    break;
                  }
                  vvp.a(1, 2131623975);
                  return;
                ...
                {
                  bcpn.a(this.jdField_a_of_type_AndroidAppActivity, paramInt, paramString1, paramString2, paramString3, paramString4, "", 0, false);
                  return;
                }
                if (paramInt == 8)
                {
                  ...
                  catch (PackageManager.NameNotFoundException paramString2)
                  {
                    for (;;)
                    {
                      ...
                      {
                        Toast.makeText(BaseApplicationImpl.getContext(), ajjy.a(2131648083), 1).show();
                ...
                if ((this.jdField_a_of_type_AndroidAppActivity instanceof FastWebActivity))
                {
                  ...
                  onp.a().a(this.jdField_a_of_type_AndroidAppActivity, null, 1, this.w, this.jdField_e_of_type_JavaLangString, this.h, this.i, this.v, paramString3);
                  bfhz.a(paramString2, 42, 2);
                  return;
                }
                if ((this.jdField_a_of_type_AndroidAppActivity instanceof bazk))
                {
                ...
                for (;;)
                {
                  ...
                  if (!TextUtils.isEmpty(paramString1))
                  {
                    bfhl.a(0, this.jdField_e_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, null, this.h, this.i, null, null, false, -1L).c(paramString1).a("lCategory", 10L).b(this.jdField_a_of_type_AndroidAppActivity, paramString1, 2, null);
                    break;
                    paramString1 = paramString1.l;
                    continue;
                  }
                  bfhl.a(0, this.jdField_e_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, null, this.h, this.i, null, null, false, -1L).c(this.n).b(this.jdField_a_of_type_AndroidAppActivity, this.n, 2, null);
                  break;
                  paramString1 = "";
                }
                label3362:
  ...
  {
    Bundle localBundle = baev.a(paramString2, paramString3, "0.0.0.1", paramString4, this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().scaledDensity, null, null);
  ...
  public static final void a(AppInterface paramAppInterface, Context paramContext, String paramString1, long paramLong1, long paramLong2, BusinessObserver paramBusinessObserver, String paramString2)
  {
    ...
    localGetAppinfoRequest.qqv.set("8.2.6");
    ...
    paramContext = new NewIntent(paramContext, bcaz.class);
  ...
  public static List<xdy> b(PBRepeatMessageField<appType.MsgIconsurl> paramPBRepeatMessageField)
  {
    if ((paramPBRepeatMessageField != null) && (!paramPBRepeatMessageField.isEmpty()))
    {
      Object localObject = paramPBRepeatMessageField.get();
  ...
  private void b(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    if (paramInt == 1)
    {
      if (((paramString.length() > 180) || ((!(this.jdField_a_of_type_AndroidAppActivity instanceof PublicAccountBrowser)) && (paramString.length() > 60))) && (!(this.jdField_a_of_type_AndroidAppActivity instanceof TeamWorkDocEditBrowserActivity)) && (!axfs.a(paramString))) {
  ...
  public axdv a()
  {
    return this.jdField_a_of_type_Axdv;
  }
  ...
  public bbms a()
  {
    ...
    if (this.jdField_a_of_type_Bbms == null)
    {
      ...
      localbazo = (bazo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((localbazo == null) || (!(localbazo instanceof bbeu)) || (this.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
        break label134;
      }
      i1 = ((bbeu)localbazo).b();
    }
    for (;;)
    {
      this.jdField_a_of_type_Bbms = new bbms(this.jdField_a_of_type_AndroidAppActivity, i1);
      this.jdField_a_of_type_Bbms.c(2131623969);
      ...
      {
        i1 = this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131167766);
      }
      else
      {
  ...
  public String a()
  {
    ...
    for (;;)
    {
      if (TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
        {
          localObject = (bazo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if ((localObject != null) && ((localObject instanceof bbev))) {
            localObject = ((bbev)localObject).b();
          }
        }
      }
      else
      {
        return mpw.a((String)localObject, new String[0]);
      }
      localObject = "";
    }
  }
  ...
  void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131303123));
    ...
    do
    {
      do
      {
        ...
        this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131303124);
        this.jdField_a_of_type_AndroidViewView.setOnClickListener(this);
        a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_AndroidAppActivity, this.n, baak.b(this.jdField_a_of_type_Long), 0L, this.jdField_a_of_type_MqqObserverBusinessObserver);
        this.jdField_a_of_type_AndroidWidgetLinearLayout = new LinearLayout(this.jdField_a_of_type_AndroidContentContext);
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131099700));
        ...
        this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130841464);
        localObject1 = new LinearLayout.LayoutParams((int)mjg.a(this.jdField_a_of_type_AndroidContentContext, 19.0F), (int)mjg.a(this.jdField_a_of_type_AndroidContentContext, 19.0F));
        this.jdField_b_of_type_AndroidWidgetLinearLayout = new LinearLayout(this.jdField_a_of_type_AndroidContentContext);
        localObject2 = new LinearLayout.LayoutParams(-2, -2);
        this.jdField_b_of_type_AndroidWidgetLinearLayout.setPadding((int)mjg.a(this.jdField_a_of_type_AndroidContentContext, 10.0F), 0, (int)mjg.a(this.jdField_a_of_type_AndroidContentContext, 10.0F), 0);
        ...
        this.jdField_c_of_type_AndroidWidgetImageView.setImageResource(2130839750);
        localObject1 = new LinearLayout.LayoutParams((int)mjg.a(this.jdField_a_of_type_AndroidContentContext, 30.0F), (int)mjg.a(this.jdField_a_of_type_AndroidContentContext, 30.0F));
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setPadding((int)mjg.a(this.jdField_a_of_type_AndroidContentContext, 8.0F), 0, (int)mjg.a(this.jdField_a_of_type_AndroidContentContext, 8.0F), 0);
        this.jdField_a_of_type_AndroidWidgetTextView.setSingleLine(true);
        this.jdField_a_of_type_AndroidWidgetTextView.setEllipsize(TextUtils.TruncateAt.END);
        localObject1 = new LinearLayout.LayoutParams(-2, -2);
        ((LinearLayout.LayoutParams)localObject1).weight = 1.0F;
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131624589);
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131099701));
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130841274);
        this.jdField_b_of_type_AndroidWidgetTextView.setGravity(17);
        this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131099701));
        localObject1 = new LinearLayout.LayoutParams((int)mjg.a(this.jdField_a_of_type_AndroidContentContext, 56.0F), (int)mjg.a(this.jdField_a_of_type_AndroidContentContext, 30.0F));
        ((LinearLayout.LayoutParams)localObject1).rightMargin = ((int)mjg.a(this.jdField_a_of_type_AndroidContentContext, 10.0F));
        ...
        localObject1 = new FrameLayout.LayoutParams(-1, (int)mjg.a(this.jdField_a_of_type_AndroidContentContext, 44.0F));
        ((FrameLayout.LayoutParams)localObject1).gravity = 80;
        ((FrameLayout.LayoutParams)localObject1).bottomMargin = ((int)mjg.a(this.jdField_a_of_type_AndroidContentContext, 50.0F));
      } while (!(this.jdField_a_of_type_AndroidAppActivity instanceof bazk));
      localObject2 = ((bazk)this.jdField_a_of_type_AndroidAppActivity).b();
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    try
    {
      ...
      for (;;)
      {
        if ((paramInt3 == 1) && ((paramInt2 == 0) || (paramInt2 == 1)) && (this.jdField_a_of_type_Axdv != null)) {
          ThreadManager.excute(new Share.9(this), 128, null, false);
        }
        return;
        ThreadManager.getUIHandler().post(new Share.8(this, (String)localObject));
      }
    }
  ...
  public void a(Context paramContext, GetAppInfoProto.GetAppinfoResponse paramGetAppinfoResponse)
  {
    ...
    try
    {
      if ((paramGetAppinfoResponse.has()) && (paramGetAppinfoResponse.ret.get() == 0))
      {
        ...
        {
          arrayOfByte = mpl.a(paramContext, paramGetAppinfoResponse, "GET", null, null);
          if (arrayOfByte == null)
          {
            if (!QLog.isColorLevel()) {
              return;
    ...
    catch (Exception paramContext)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        catch (OutOfMemoryError localOutOfMemoryError)
        {
          ...
          paramContext = mpl.a(paramContext, String.format("http://openmobile.qq.com/api/get_app_info_by_id?appid=%d", new Object[] { Long.valueOf(baak.b(this.jdField_a_of_type_Long)) }), "GET", null, null);
        ...
        if (bady.a(paramContext, localAndroidInfo.packName.get()))
        {
          paramContext = this.jdField_a_of_type_AndroidOsHandler.obtainMessage(1001);
          try
          {
  ...
  public void a(bazo parambazo)
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference == null) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambazo);
    }
    parambazo = (bazo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if ((parambazo != null) && ((parambazo instanceof bbev)))
    {
      this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView = ((bbev)parambazo).getWebView();
      if (QLog.isColorLevel())
      {
        parambazo = jdField_a_of_type_JavaLangString;
        localObject = new StringBuilder().append(" Share secret webview is null?");
        if (this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView != null) {
          break label122;
        }
        bool = true;
        QLog.d(parambazo, 2, bool);
      }
    }
    label122:
    while (!QLog.isColorLevel()) {
  ...
  public boolean a()
  {
    ...
    for (Object localObject = null;; localObject = this.h)
    {
      ...
      localQZoneShareData.jdField_b_of_type_Long = bbbt.jdField_b_of_type_Long;
      ...
      bfqn.a(this.jdField_b_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), localQZoneShareData, null, -1);
      return true;
      this.jdField_b_of_type_AndroidAppActivity = this.jdField_a_of_type_AndroidAppActivity;
      break;
      localObject = this.jdField_e_of_type_JavaLangString;
  ...
  public boolean a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Bcal.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Bcal.jdField_b_of_type_Int = bcaj.b(paramInt);
      localBundle = new Bundle();
      localBundle.putString("report_type", "102");
      localBundle.putString("act_type", "90");
      localStringBuilder = new StringBuilder().append("");
      if (this.jdField_a_of_type_Bcal.jdField_a_of_type_Int != 0) {
        break label407;
      }
    }
    label407:
    for (int i1 = 0;; i1 = 1)
    {
      ...
      localBundle.putString("intext_3", "" + this.jdField_a_of_type_Bcal.jdField_b_of_type_Int);
      localBundle.putString("intext_2", "" + this.jdField_a_of_type_Bcal.jdField_a_of_type_Int);
      localBundle.putString("stringext_1", "" + paramString);
      bcad.a().a(localBundle, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
      this.jdField_a_of_type_Bcal.jdField_a_of_type_Boolean = false;
      ...
      paramString.putString("intext_1", "" + bcaj.a(1));
      paramString.putString("intext_3", "1");
      paramString.putString("intext_4", "0");
      bcad.a().a(paramString, "", this.jdField_a_of_type_ComTencentCommonAppAppInterface.getAccount(), false);
      return false;
    }
    ...
    if ((!this.jdField_a_of_type_Bbms.isShowing()) && (bool)) {
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, Bundle paramBundle)
  {
    ...
    //   7: aload_0
    //   8: aload_3
    //   9: invokevirtual 1648	xdt:a	(Ljava/lang/String;)Z
    //   12: ifne +5 -> 17
    //   15: iconst_0
    //   16: ireturn
    //   17: aload_0
    //   18: aload_1
    //   19: putfield 373	xdt:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   22: aload_0
    //   23: aload_2
    //   24: putfield 377	xdt:h	Ljava/lang/String;
    //   27: aload_0
    //   28: aload 4
    //   30: putfield 381	xdt:i	Ljava/lang/String;
    //   33: aload_0
    //   34: getfield 381	xdt:i	Ljava/lang/String;
    //   37: ifnull +43 -> 80
    //   40: aload_0
    //   41: getfield 381	xdt:i	Ljava/lang/String;
    //   44: ldc_w 1650
    //   47: invokevirtual 1653	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   50: ifeq +30 -> 80
    //   53: aload_0
    ...
    //   67: aload_0
    //   68: getfield 381	xdt:i	Ljava/lang/String;
    ...
    //   77: putfield 381	xdt:i	Ljava/lang/String;
    //   80: aload_0
    //   81: iconst_1
    //   82: putfield 1092	xdt:jdField_e_of_type_Boolean	Z
    //   85: aload 5
    //   87: ifnull +173 -> 260
    //   90: aload 5
    //   92: ldc_w 1657
    //   95: invokevirtual 1658	android/os/Bundle:getInt	(Ljava/lang/String;)I
    //   98: iconst_1
    ...
    //   125: aload_0
    //   126: getfield 373	xdt:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   138: aload_0
    //   139: getfield 377	xdt:h	Ljava/lang/String;
    ...
    //   151: aload_0
    //   152: getfield 381	xdt:i	Ljava/lang/String;
    ...
    //   174: aload_0
    //   175: getfield 76	xdt:jdField_a_of_type_Bcal	Lbcal;
    //   178: iconst_1
    //   179: putfield 1599	bcal:jdField_a_of_type_Boolean	Z
    //   182: aload_0
    //   183: getfield 76	xdt:jdField_a_of_type_Bcal	Lbcal;
    //   186: iconst_0
    //   187: putfield 1603	bcal:jdField_a_of_type_Int	I
    //   190: aload 4
    //   192: invokestatic 280	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   195: ifeq +430 -> 625
    //   198: aload_0
    //   199: getfield 76	xdt:jdField_a_of_type_Bcal	Lbcal;
    //   202: astore 4
    //   204: aload 4
    //   206: aload 4
    //   208: getfield 1603	bcal:jdField_a_of_type_Int	I
    //   211: iconst_1
    //   212: ior
    //   213: putfield 1603	bcal:jdField_a_of_type_Int	I
    //   216: aload_2
    //   217: invokestatic 280	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   220: ifeq +18 -> 238
    //   223: aload_0
    //   224: getfield 76	xdt:jdField_a_of_type_Bcal	Lbcal;
    //   227: astore_2
    //   228: aload_2
    //   229: aload_2
    //   230: getfield 1603	bcal:jdField_a_of_type_Int	I
    //   233: iconst_2
    //   234: ior
    //   235: putfield 1603	bcal:jdField_a_of_type_Int	I
    //   238: aload_1
    //   239: invokestatic 280	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   242: ifeq +18 -> 260
    //   245: aload_0
    //   246: getfield 76	xdt:jdField_a_of_type_Bcal	Lbcal;
    //   249: astore_1
    //   250: aload_1
    //   251: aload_1
    //   252: getfield 1603	bcal:jdField_a_of_type_Int	I
    //   255: iconst_4
    //   256: ior
    //   257: putfield 1603	bcal:jdField_a_of_type_Int	I
    //   260: aload_0
    //   261: aconst_null
    //   262: putfield 1090	xdt:jdField_a_of_type_JavaLangRefSoftReference	Ljava/lang/ref/SoftReference;
    //   265: aload 5
    //   267: ifnull +263 -> 530
    //   270: getstatic 62	xdt:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   273: iconst_1
    //   274: ldc_w 1668
    ...
    //   281: aload 5
    //   283: ldc_w 1670
    //   286: invokevirtual 1122	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   289: putfield 686	xdt:jdField_f_of_type_JavaLangString	Ljava/lang/String;
    //   292: aload_0
    //   293: aload 5
    //   295: ldc_w 1672
    //   298: invokevirtual 1122	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   301: putfield 716	xdt:jdField_g_of_type_JavaLangString	Ljava/lang/String;
    //   304: aload_0
    //   305: aload 5
    //   307: ldc_w 1657
    //   310: iconst_m1
    //   311: invokevirtual 1675	android/os/Bundle:getInt	(Ljava/lang/String;I)I
    //   314: putfield 80	xdt:jdField_d_of_type_Int	I
    //   317: aload_0
    //   318: aload 5
    //   320: ldc_w 756
    //   323: invokevirtual 1122	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   326: putfield 743	xdt:k	Ljava/lang/String;
    //   329: aload_0
    //   330: aload 5
    //   332: ldc_w 549
    //   335: invokevirtual 1122	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   338: putfield 604	xdt:l	Ljava/lang/String;
    //   341: aload_0
    //   342: aload 5
    //   344: ldc_w 1677
    //   347: invokevirtual 1122	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   350: putfield 606	xdt:m	Ljava/lang/String;
    //   353: aload_0
    //   354: aload 5
    //   356: ldc_w 758
    //   359: invokevirtual 1122	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   362: invokestatic 539	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   365: putfield 78	xdt:jdField_c_of_type_Int	I
    //   368: aload_0
    //   369: aload 5
    //   371: ldc_w 1679
    //   374: invokevirtual 1682	android/os/Bundle:getBoolean	(Ljava/lang/String;)Z
    //   377: putfield 69	xdt:jdField_a_of_type_Boolean	Z
    //   380: aload_0
    //   381: aload 5
    //   383: ldc_w 1684
    //   386: invokevirtual 1682	android/os/Bundle:getBoolean	(Ljava/lang/String;)Z
    //   389: putfield 1686	xdt:jdField_b_of_type_Boolean	Z
    //   392: aload_0
    //   393: getfield 1688	xdt:jdField_d_of_type_Boolean	Z
    //   396: ifne +15 -> 411
    //   399: aload_0
    //   400: aload 5
    //   402: ldc_w 1690
    //   405: invokevirtual 1682	android/os/Bundle:getBoolean	(Ljava/lang/String;)Z
    //   408: putfield 1688	xdt:jdField_d_of_type_Boolean	Z
    //   411: aload_0
    //   412: aload 5
    //   414: ldc_w 1692
    //   417: invokevirtual 1122	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   420: putfield 1693	xdt:j	Ljava/lang/String;
    //   423: aload_0
    //   424: aload 5
    //   426: ldc_w 1350
    //   429: invokevirtual 1122	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   432: invokestatic 539	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   435: putfield 71	xdt:jdField_a_of_type_Int	I
    //   438: aload_0
    //   439: aload 5
    //   441: ldc_w 1695
    //   444: invokevirtual 1682	android/os/Bundle:getBoolean	(Ljava/lang/String;)Z
    //   447: putfield 1697	xdt:jdField_c_of_type_Boolean	Z
    //   450: aload_0
    //   451: getfield 127	xdt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   454: ifnull +76 -> 530
    //   457: aload_0
    //   458: getfield 127	xdt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   461: instanceof 1086
    //   464: ifeq +66 -> 530
    //   467: aload_0
    //   468: getfield 127	xdt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   471: checkcast 1086	com/tencent/mobileqq/activity/TeamWorkDocEditBrowserActivity
    //   474: invokevirtual 1698	com/tencent/mobileqq/activity/TeamWorkDocEditBrowserActivity:b	()Lcom/tencent/mobileqq/webview/swift/WebViewFragment;
    //   477: checkcast 1700	com/tencent/mobileqq/activity/TeamWorkDocEditBrowserActivity$TeamWorkDocEditBrowserFragment
    //   480: astore_1
    //   481: aload_1
    //   482: ifnull +48 -> 530
    //   485: aload_1
    //   486: aload_0
    //   487: getfield 69	xdt:jdField_a_of_type_Boolean	Z
    //   490: aload_0
    //   491: getfield 71	xdt:jdField_a_of_type_Int	I
    //   494: invokevirtual 1703	com/tencent/mobileqq/activity/TeamWorkDocEditBrowserActivity$TeamWorkDocEditBrowserFragment:a	(ZI)V
    //   497: aload_1
    //   498: aload_0
    //   499: getfield 1688	xdt:jdField_d_of_type_Boolean	Z
    //   502: invokevirtual 1706	com/tencent/mobileqq/activity/TeamWorkDocEditBrowserActivity$TeamWorkDocEditBrowserFragment:g_	(Z)V
    //   505: aload_1
    //   506: invokevirtual 1708	com/tencent/mobileqq/activity/TeamWorkDocEditBrowserActivity$TeamWorkDocEditBrowserFragment:o	()V
    //   509: aload_1
    //   510: iconst_1
    //   511: aload_0
    //   512: getfield 1693	xdt:j	Ljava/lang/String;
    //   515: aconst_null
    //   516: invokevirtual 1711	com/tencent/mobileqq/activity/TeamWorkDocEditBrowserActivity$TeamWorkDocEditBrowserFragment:a	(ZLjava/lang/String;Ljava/lang/String;)V
    //   519: aload_0
    //   520: getfield 1697	xdt:jdField_c_of_type_Boolean	Z
    //   523: ifeq +7 -> 530
    //   526: aload_1
    //   527: invokevirtual 1713	com/tencent/mobileqq/activity/TeamWorkDocEditBrowserActivity$TeamWorkDocEditBrowserFragment:j	()V
    //   530: ldc_w 1715
    //   533: aload_0
    //   534: getfield 373	xdt:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   537: invokestatic 1718	cooperation/qzone/LocalMultiProcConfig:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   540: ldc_w 1720
    //   543: aload_0
    //   544: getfield 377	xdt:h	Ljava/lang/String;
    //   547: invokestatic 1718	cooperation/qzone/LocalMultiProcConfig:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   550: ldc_w 1722
    //   553: aload_0
    //   554: getfield 381	xdt:i	Ljava/lang/String;
    //   557: invokestatic 1718	cooperation/qzone/LocalMultiProcConfig:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   560: ldc_w 1724
    //   563: aload_3
    //   564: invokestatic 1718	cooperation/qzone/LocalMultiProcConfig:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   567: ldc_w 1726
    //   570: aload_0
    //   571: getfield 80	xdt:jdField_d_of_type_Int	I
    //   574: invokestatic 1727	cooperation/qzone/LocalMultiProcConfig:putInt	(Ljava/lang/String;I)V
    //   577: aload_0
    //   578: getfield 222	xdt:jdField_a_of_type_ComTencentBizPubaccountCustomWebView	Lcom/tencent/biz/pubaccount/CustomWebView;
    //   581: ifnull +16 -> 597
    //   584: ldc_w 1729
    //   587: aload_0
    //   588: getfield 222	xdt:jdField_a_of_type_ComTencentBizPubaccountCustomWebView	Lcom/tencent/biz/pubaccount/CustomWebView;
    //   591: invokevirtual 1572	com/tencent/biz/pubaccount/CustomWebView:getUrl	()Ljava/lang/String;
    //   594: invokestatic 1718	cooperation/qzone/LocalMultiProcConfig:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   597: new 505	android/content/Intent
    //   600: dup
    //   601: ldc_w 1731
    //   604: invokespecial 1732	android/content/Intent:<init>	(Ljava/lang/String;)V
    //   607: astore_1
    //   608: aload_0
    //   609: getfield 127	xdt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   612: ifnull +11 -> 623
    //   615: aload_0
    //   616: getfield 127	xdt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   619: aload_1
    //   620: invokevirtual 1735	android/app/Activity:sendBroadcast	(Landroid/content/Intent;)V
    //   623: iconst_1
    //   624: ireturn
    //   625: aload_0
    //   626: iconst_2
    //   627: putfield 1736	xdt:jdField_b_of_type_Int	I
    //   630: goto -414 -> 216
    //   633: astore_1
    //   634: getstatic 62	xdt:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   637: iconst_1
    //   638: ldc_w 1738
    //   641: invokestatic 179	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   644: aload_0
    //   645: iconst_m1
    //   646: putfield 78	xdt:jdField_c_of_type_Int	I
    //   649: goto -281 -> 368
    //   652: astore_1
    //   653: getstatic 62	xdt:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   656: iconst_1
    //   657: ldc_w 1740
    ...
    //   667: aload_0
    //   668: aconst_null
    //   669: putfield 1693	xdt:j	Ljava/lang/String;
    //   672: getstatic 62	xdt:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   675: iconst_1
    //   676: ldc_w 1742
    ...
    //   686: aload_0
    //   687: iconst_m1
    //   688: putfield 71	xdt:jdField_a_of_type_Int	I
    //   691: goto -253 -> 438
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    ...
    if (this.jdField_a_of_type_Bbms == null)
    {
      paramString7 = (bazo)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((paramString7 == null) || (!(paramString7 instanceof bbeu))) {
        break label456;
      }
    }
    label139:
    ...
    label192:
    label456:
    for (int i1 = ((bbeu)paramString7).b();; i1 = 0)
    {
      this.jdField_a_of_type_Bbms = new bbms(this.jdField_a_of_type_AndroidAppActivity, i1);
      this.jdField_a_of_type_Bbms.c(2131623969);
      boolean bool;
      if (paramString4.length() > 180)
      {
        ...
        this.jdField_a_of_type_Bbms.show();
        new Share.5(this, bool, paramString5, paramString1, paramString2, paramString3, paramString4, paramString6).start();
      }
      for (;;)
      {
        return true;
        ...
        String str = String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131630985), new Object[] { paramString2 });
        baic.a(this.jdField_a_of_type_AndroidAppActivity, 1001, 146, "struct_msg_from_h5", paramString1, paramString5, paramString2, paramString3, str, paramString4, "web", null, null, null, "plugin", null, paramString7, paramString8, "http://url.cn/JS8oE7", paramString6, null);
        int i2 = 0;
  ...
  public void onClick(View paramView)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentProtofileGetappinfoGetAppInfoProto$GetAppinfoResponse != null) && (this.jdField_a_of_type_ComTencentProtofileGetappinfoGetAppInfoProto$GetAppinfoResponse.androidInfo != null))
    {
      ...
      if (!bady.a(this.jdField_a_of_type_AndroidAppActivity, localAndroidInfo.packName.get())) {
        break label97;
      }
      bady.a(this.jdField_a_of_type_AndroidAppActivity, localAndroidInfo.packName.get(), null);
      paramView = "run";
      mpw.a(null, "", "webviewsourceclick", baak.b(this.jdField_a_of_type_Long), 0L, paramView);
    }
    label97:
    do
    {
      for (;;)
      {
        ...
        bcau.a(this.jdField_a_of_type_AndroidAppActivity, String.valueOf(baak.b(this.jdField_a_of_type_Long)), 2470, paramView);
        paramView = "setup";
        break;
        ...
        {
          bady.a(this.jdField_a_of_type_AndroidAppActivity, localAndroidInfo.packName.get(), null);
          bcfn.a().a(this.n, String.valueOf(baak.b(this.jdField_a_of_type_Long)), "ANDROIDQQ.SHAREBAR", "203", false);
        }
        while (this.jdField_a_of_type_AndroidWidgetLinearLayout != null)
        {
          ...
          paramView.putBoolean("autoDownload", true);
          paramView.putString("packageName", localAndroidInfo.packName.get());
          paramView.putString("appId", String.valueOf(baak.b(this.jdField_a_of_type_Long)));
          bcau.b(this.jdField_a_of_type_AndroidAppActivity, paramView);
          bcfn.a().a(this.n, String.valueOf(baak.b(this.jdField_a_of_type_Long)), "ANDROIDQQ.SHAREBAR", "202", false);
        }
      }
