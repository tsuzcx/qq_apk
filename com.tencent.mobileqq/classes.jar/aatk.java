  ...
  extends QQCustomDialog
{
  ...
  protected aatk(Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
  }
  
  public static aatk a(Context paramContext, String paramString1, String paramString2, int paramInt1, int paramInt2, DialogInterface.OnClickListener paramOnClickListener1, DialogInterface.OnClickListener paramOnClickListener2)
  {
    aatk localaatk = new aatk(paramContext, 2131755829);
    localaatk.setContentView(2131559043);
    localaatk.setTitle(paramString1);
    localaatk.setMessage(paramString2);
    localaatk.a(paramInt1, paramOnClickListener2);
    localaatk.b(paramInt2, paramOnClickListener1);
    localaatk.setCanceledOnTouchOutside(false);
    ...
    paramString1.setBackgroundResource(2130843793);
    ...
    localaatk.a(paramString1);
    return localaatk;
  }
  
  public aatk a(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.lBtn.setOnClickListener(new aatl(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  ...
  public aatk b(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    if (paramOnClickListener == null)
    {
    ...
    this.rBtn.setOnClickListener(new aatm(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
