...
public class awwt
{
  ...
  public static String a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    bgnr.a(paramQQAppInterface.getApp(), paramQQAppInterface, localMessage, localMessage.istroop, paramMessageRecord, null, false, false);
    try
    {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    while (((MessageForLongTextMsg.class.isInstance(paramChatMessage)) && ((paramChatMessage.getExtInfoFromExtStr("long_text_recv_state").equals("2")) || (paramChatMessage.getExtInfoFromExtStr("long_text_recv_state").equals("3")))) || (!MessageForArkApp.isAllowedArkForward(false, paramChatMessage)) || (MessageForTroopConfess.class.isInstance(paramChatMessage)) || (MessageForLightVideo.class.isInstance(paramChatMessage)) || ((paramChatMessage instanceof MessageForFuDai)) || (anlk.a(paramChatMessage)) || (((paramChatMessage instanceof MessageForPic)) && (ains.a((MessageForPic)paramChatMessage)))) {
      return false;
    }
    boolean bool;
        ...
        else
        {
          ...
          else
          {
            ...
            if (paramChatMessage.isMultiMsg) {
              bool = true;
            } else if (atvo.a(paramQQAppInterface, (MessageForFile)paramChatMessage).getCloudType() == 0) {
              bool = false;
            } else {
              bool = true;
            }
