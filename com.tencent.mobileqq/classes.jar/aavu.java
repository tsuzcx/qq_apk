  ...
  implements aavr
{
  ...
  private aavt jdField_a_of_type_Aavt;
  private int jdField_b_of_type_Int;
  private long jdField_b_of_type_Long = -2147483648L;
  
  public aavu(aavt paramaavt)
  {
    this.jdField_a_of_type_Aavt = paramaavt;
  }
  ...
  {
    String str2 = "";
    if (this.jdField_a_of_type_Aavt != null) {}
    for (Activity localActivity = this.jdField_a_of_type_Aavt.a();; localActivity = null)
    {
      String str1 = str2;
  ...
  private void a(GdtAd paramGdtAd)
  {
    ...
    localaasj.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localaasj.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(2);
    localaasj.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localaasj.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localaasj);
  }
  ...
  private void b(GdtAd paramGdtAd)
  {
    ...
    aasj localaasj = new aasj();
    localaasj.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localaasj.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(1);
    localaasj.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localaasj.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localaasj);
  }
  ...
  private void c(GdtAd paramGdtAd)
  {
    ...
    aasj localaasj = new aasj();
    localaasj.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localaasj.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(5);
    localaasj.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(b());
    localaasj.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localaasj);
  }
  ...
  private void d(GdtAd paramGdtAd)
  {
    ...
    aasj localaasj = new aasj();
    localaasj.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localaasj.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(6);
    localaasj.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(b());
    localaasj.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localaasj);
  }
  ...
  private void f(GdtAd paramGdtAd)
  {
    ...
    aasj localaasj = new aasj();
    localaasj.jdField_a_of_type_ComTencentAdTangramAd = paramGdtAd;
    localaasj.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_page_action_type.set(3);
    localaasj.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.latency_ms.set(a());
    localaasj.jdField_a_of_type_TencentGdtLanding_page_collect_data$LandingPageCollectData.landing_error_code.set(0);
    a(localaasj);
  }
