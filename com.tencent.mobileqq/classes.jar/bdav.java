...
public class bdav
  extends bdbc
{
  private static bdav jdField_a_of_type_Bdav;
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private bgfl jdField_a_of_type_Bgfl = new bdax(this);
  ...
  private boolean d;
  private boolean e = auzn.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), "is_first_show_atmosphere", true, false);
  private boolean f;
  
  public static bdav a()
  {
    if (jdField_a_of_type_Bdav == null) {}
    try
    {
      if (jdField_a_of_type_Bdav == null) {
        jdField_a_of_type_Bdav = new bdav();
      }
      return jdField_a_of_type_Bdav;
    }
    finally {}
  }
  ...
  private void a(View paramView, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        b(paramView, 2131376501, 2130850016);
        b(paramView, 2131369436, 2130850030, 2130850034);
        b(paramView, 2131369068, 2130850030, 2130850034);
        Object localObject1 = paramView.findViewById(2131376501);
        Object localObject2;
        if (localObject1 != null)
        {
          if (this.jdField_a_of_type_Int == 1)
          {
            a((View)localObject1, 2131369077, 2130849766, 2130849767);
            a((View)localObject1, 2131369082, 2130850047, 2130850048);
          }
        }
        else
        {
          ...
          a(paramView, 2131373993, 2130849869, 2130849870);
          a(paramView, 2131373983, 2130849826, 2130849827);
          a(paramView, 2131373996, 2130849875, 2130849876);
          a(paramView, 2131373975, 2130849807, 2130849808);
          a(paramView, 2131373965, 2130849797, 2130849798);
          a(paramView, 2131373988, 2130849846, 2130849847);
          a(paramView, 2131373972, 2130838156, 2130838157);
          a(paramView, 2131373976, 2130838184, 2130838186);
          a(paramView, 2131373986, 2130838197, 2130838198);
          a(paramView, 2131373959, 2130849777, 2130849778);
          localObject1 = paramView.findViewById(2131368750);
          if (localObject1 != null) {
            a((View)localObject1, a(((View)localObject1).getContext(), 2130849760));
          }
          localObject2 = (TextView)paramView.findViewById(2131367352);
          if ((localObject2 != null) && (!bbyp.b()))
          {
            ...
            a(paramView, 2131367352, 2130849908, 2130849909, 2130849905);
            ((TextView)localObject2).setPadding(j, i, k, m);
          }
          localObject2 = paramView.findViewById(2131368751);
          if (localObject1 != null) {
            a((View)localObject2, a(((View)localObject1).getContext(), 2130849759));
          }
          b(paramView, 2131372228, 2130849809);
          a(paramView, 2131368750, 2131167112);
          a(paramView, 2131378707, 2131167009);
          a(paramView, 2131369106, 2131167009);
          localObject2 = paramView.findViewById(2131363591);
          ...
          localObject2 = paramView.findViewById(2131380315);
          View localView = paramView.findViewById(2131368751);
        ...
        for (int i = 8;; i = 0)
        {
          ...
          localObject1 = b(((View)localObject1).getContext(), 2130849953);
          paramView = paramView.findViewById(2131362294);
          if (paramView == null) {
            break;
          }
          paramView.setBackgroundDrawable((Drawable)localObject1);
          return;
          a((View)localObject1, 2131369077, 2130849750, 2130849753);
          break label74;
  ...
  private static boolean b(int paramInt)
  {
    ...
    bgix localbgix = bgix.a;
    localObject = localbgix.getDir((Context)localObject, localbgix.getScid(paramInt));
  ...
  public void a(int paramInt)
  {
    ...
    ImageView localImageView = (ImageView)this.jdField_a_of_type_ComTencentMobileqqActivityChatFragment.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131371554);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      bgcn localbgcn2 = (bgcn)localImageView.getTag();
      localbgcn1 = localbgcn2;
      if (localbgcn2 == null)
      {
        localbgcn1 = new bgcn(localImageView);
        localImageView.setTag(localbgcn1);
      }
      switch (paramInt)
      {
      default: 
    ...
    if (i != 0) {
      localbgcn1.a(a("play.png"), 1);
    }
    localbgcn1.a(a("playing.png"), 0);
    return;
    if (i != 0) {
      localbgcn1.a(a("pause.png"), 1);
    }
    localbgcn1.a(a("pausing.png"), 0);
  }
  ...
  public void a(Context paramContext)
  {
    ...
    {
      this.e = false;
      localView = this.jdField_a_of_type_ComTencentMobileqqActivityChatFragment.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131371532);
      if (localView != null) {}
    }
    else
    {
    ...
    localTextView.setText(paramContext.getResources().getString(2131693363));
    this.jdField_a_of_type_ComTencentWidgetBubblePopupWindow.a(2131755846);
    ...
    this.jdField_a_of_type_ComTencentWidgetBubblePopupWindow.a().setOnClickListener(new bdaw(this));
    auzn.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), "is_first_show_atmosphere", false, false);
    bcef.b(null, "dc00898", "", "", "qq_vip", "0X800A5B9", 1, 0, "", "", "", "");
  }
  ...
  public void a(Context paramContext, View paramView)
  {
    ...
    b(paramContext, 2131370058, 2130850204, 2130850205);
    a(paramContext, 2131374623, 2130844693, 2130844694);
    a(paramContext, 2131371532, 2130844687, 2130844688);
    a(paramContext, 2131371552, 2131166994);
    a(paramContext, 2131371555, 2131166992);
    a(paramContext, 2131371550, 2131166994);
    paramView = (CircleProgress)paramContext.findViewById(2131371548);
    if (paramView != null)
    {
      ColorStateList localColorStateList = a(paramContext.getContext(), 2131166993);
      paramView.setBgAndProgressColor(100, a(paramContext.getContext(), 2131166995).getDefaultColor(), 100, localColorStateList.getDefaultColor());
    }
  ...
  public void a(ChatFragment paramChatFragment, String paramString, int paramInt)
  {
    ...
    if ((paramInt == 1) && (this.jdField_a_of_type_ComTencentMobileqqActivityChatFragment != null) && ((this.jdField_a_of_type_ComTencentMobileqqActivityChatFragment.a() instanceof afii)) && (((afii)this.jdField_a_of_type_ComTencentMobileqqActivityChatFragment.a()).c())) {
      return;
    }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      ...
      if ((paramString.jdField_b_of_type_Int != this.jdField_c_of_type_Int) || (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
      {
        ...
        bcef.b(null, "dc00898", "", "", "qq_vip", "0X800A5BB", 1, 0, "", "", "", "");
      }
      a();
      label154:
      if (paramString != null) {
    ...
    {
      bcef.b(null, "dc00898", "", "", "qq_vip", "0X800A5BE", paramInt, 0, "", "", "", "");
      if (QLog.isColorLevel()) {
      ...
      if ((paramString != null) && (paramString.jdField_b_of_type_Int == 0)) {
        bcef.b(null, "dc00898", "", "", "qq_vip", "0X800A5BB", 2, 0, "", "", "", "");
      }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    if (!paramBoolean) {
      bcef.b(null, "dc00898", "", "", "qq_vip", "0X800A5BC", 0, 0, "", "", "", "");
    }
    a();
  }
  ...
  public boolean a(ChatFragment paramChatFragment, int paramInt)
  {
    ...
    if ((paramInt == 1) && ((paramChatFragment.a() instanceof afii)))
    {
      if ((((afii)paramChatFragment.a()).c()) || (bbyp.b())) {}
  ...
  public void b(Context paramContext)
  {
    ...
    this.f = true;
    paramContext = a(paramContext, 2131167070);
  ...
  public void c()
  {
    ...
    bcef.b(null, "dc00898", "", "", "qq_vip", "0X800A5BF", 0, 0, String.valueOf((System.currentTimeMillis() - this.jdField_a_of_type_Long) / 1000L), "", "", "");
  }
}
