  ...
  implements LeakInspector.InspectorListener
{
  public List a(String paramString)
  {
    if (BaseActivity.sTopActivity != null) {
      BaseActivity.sTopActivity.runOnUiThread(new aijn(this, paramString));
    }
  ...
  {
    if (BaseActivity.sTopActivity != null) {
      BaseActivity.sTopActivity.runOnUiThread(new aijo(this, paramString1, paramBoolean, paramString2));
    }
  }
