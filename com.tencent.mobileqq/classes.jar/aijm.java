...
{
  static String jdField_a_of_type_JavaLangString = bdiv.f(BaseApplication.getContext());
      ...
      if (paramString != null)
      {
        ...
        if ((jdField_a_of_type_ArrayOfJavaLangString != null) && (jdField_a_of_type_ArrayOfJavaLangString.length > 0) && (this.jdField_f_of_type_JavaLangString != null) && (this.jdField_f_of_type_JavaLangString.length() > 0))
        {
          ...
          while (i1 == 0)
          {
            ...
            azmz.a(BaseApplication.getContext()).a(null, "actSDKDownloadHijacked", true, 0L, 0L, (HashMap)localObject2, "");
  ...
  private void g()
  {
    ...
    {
      localMessageForShortVideo = this.jdField_a_of_type_Ailz.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo;
      i2 = this.jdField_a_of_type_Ailz.jdField_a_of_type_Int;
    }
    for (;;)
    {
  ...
  public View a(Context paramContext, Handler paramHandler, ailz paramailz, agft paramagft)
  {
    ...
    this.jdField_a_of_type_Long = paramailz.jdField_d_of_type_Long;
    ...
    catch (Exception paramContext)
    {
      ...
      azmz.a(BaseApplication.getContext()).a(null, "previewVideoViewCreateSuc", false, 0L, 0L, paramHandler, null);
  ...
  public void a(String paramString, long paramLong)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOutputMute(this.jdField_a_of_type_Ailz.jdField_e_of_type_Boolean);
  ...
  public void f()
  {
    if ((!this.jdField_f_of_type_Boolean) || (this.jdField_a_of_type_Ailz == null) || (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer == null)) {}
    Object localObject;
    do
    {
      return;
      localObject = this.jdField_a_of_type_Ailz.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo;
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      str1 = null;
      if (!bdje.a(this.jdField_g_of_type_JavaLangString)) {
        str1 = bavf.a(this.jdField_g_of_type_JavaLangString);
      }
      i3 = i2;
      if (this.jdField_a_of_type_Ailz.jdField_a_of_type_ArrayOfJavaLangString == null) {
        break label1349;
      }
      i3 = i2;
      if (this.jdField_a_of_type_Ailz.jdField_a_of_type_ArrayOfJavaLangString.length <= 0) {
        break label1349;
      }
      i1 = 0;
      for (;;)
      {
        i3 = i2;
        if (i1 >= this.jdField_a_of_type_Ailz.jdField_a_of_type_ArrayOfJavaLangString.length) {
          break;
        }
        String str2 = bavf.a(this.jdField_a_of_type_Ailz.jdField_a_of_type_ArrayOfJavaLangString[i1]);
    ...
    localHashMap.put("HttpDomain", this.jdField_a_of_type_Ailz.jdField_c_of_type_JavaLangString);
    localStringBuffer1.append(" HttpDomain" + this.jdField_a_of_type_Ailz.jdField_c_of_type_JavaLangString);
    ...
    String str1 = String.valueOf(bdee.a(BaseApplicationImpl.getApplication().getApplicationContext()));
    ...
    for (str1 = "1";; str1 = "0")
    {
      ...
      azmz.a(BaseApplication.getContext()).a(null, "actStreamingVideoPlay", bool, this.jdField_g_of_type_Long, this.jdField_b_of_type_Long, localHashMap, "");
  ...
  public void onCompletion(TVK_IMediaPlayer paramTVK_IMediaPlayer)
  {
    ...
    if ((bhou.b()) && (this.jdField_b_of_type_AndroidContentContext != null))
    {
  ...
  public void onSurfaceCreated(SurfaceHolder paramSurfaceHolder)
  {
    ...
    if (this.jdField_a_of_type_Ailz != null)
    {
      ...
      if (this.jdField_a_of_type_Ailz.jdField_a_of_type_JavaLangString != null) {
        a(this.jdField_a_of_type_Ailz.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Ailz.jdField_e_of_type_Long);
      }
    }
    label63:
    while (this.jdField_a_of_type_Ailz.jdField_b_of_type_Boolean) {
      return;
    }
    ...
    label149:
    for (String str = "";; str = this.jdField_a_of_type_Ailz.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.md5)
    {
      a(this.jdField_a_of_type_Ailz.a(), paramSurfaceHolder, this.jdField_a_of_type_Ailz.jdField_a_of_type_ArrayOfJavaLangString, this.jdField_a_of_type_Ailz.jdField_e_of_type_Long, str, this.jdField_b_of_type_AndroidContentContext);
      return;
      paramSurfaceHolder = String.valueOf(this.jdField_a_of_type_Ailz.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.videoFileTime);
      break;
    }
  }
