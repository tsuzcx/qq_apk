  ...
  extends acut
{
  ...
  public afbz(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    this.jdField_a_of_type_Afcc = new afcc(this, null);
  ...
  public void a(afcb paramafcb)
  {
    this.jdField_a_of_type_Afcb = paramafcb;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((localacvd instanceof BaseBubbleBuilder)) {
      ((BaseBubbleBuilder)localacvd).c = true;
    }
    paramView = localacvd.a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage, paramView, paramViewGroup, this.jdField_a_of_type_Afcc);
    if (paramView != null) {
    ...
    for (;;)
    {
      ...
      else if ((localChatMessage.msgtype == -2039) && ((localacvd instanceof ApolloItemBuilder)))
      {
