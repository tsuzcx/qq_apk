...
public class axdn
{
  ...
  static boolean a()
  {
    return axle.b(VideoEnvironment.a());
  }
  ...
  static boolean a(AppInterface paramAppInterface, ShortVideoResourceManager.SVConfigItem paramSVConfigItem)
  {
    ...
    {
      return true;
      QmcfManager.getInstance().setQmcfMobileNotSupport(axjr.a);
      return false;
  ...
  static boolean a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    if (localFile.exists())
    {
      if ((a().equals(paramString1)) && (axde.b(paramQQAppInterface, "artfilter_config_file")))
      {
    ...
    try
    {
      ...
      bool1 = axde.b(paramQQAppInterface, "artfilter_config_file");
