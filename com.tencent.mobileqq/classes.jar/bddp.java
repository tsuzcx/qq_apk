  ...
  implements Handler.Callback
{
  ...
  public bddp()
  {
    this.jdField_a_of_type_Bddr = new bddr();
  }
  
  @TargetApi(17)
  private bdei a(bddq parambddq, int paramInt)
  {
    bdei localbdei = parambddq.jdField_a_of_type_Bdeh.a();
    if (localbdei == null)
    {
    ...
    if (localbdei.a(parambddq.jdField_a_of_type_Int, parambddq.jdField_b_of_type_Int, parambddq.e))
    {
      long l1 = SystemClock.elapsedRealtimeNanos();
      if (PtvFilterUtils.a(paramInt, parambddq.jdField_a_of_type_Int, parambddq.jdField_b_of_type_Int, parambddq.e, localbdei.jdField_a_of_type_JavaNioByteBuffer, parambddq.jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct) != 0)
      {
        localbdei.a();
        return null;
      }
      ...
      if (QLog.isColorLevel()) {
        QLog.d("PtvFilterUtils", 2, "FilterProcessRender_showPreview[getPixelDataToSharedMemory= old time " + parambddq.jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct.vFrameTime + ", new time = " + l2 + ", diff=" + (l2 - parambddq.jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct.vFrameTime));
      }
      parambddq.jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct.vFrameTime = l2;
  ...
  public static CameraFilterGLView.SharedMemWriteFile a(bdei parambdei)
  {
    if (parambdei.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewCameraFilterGLView$SharedMemWriteFile == null) {
      parambdei.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewCameraFilterGLView$SharedMemWriteFile = new CameraFilterGLView.SharedMemWriteFile();
    }
    return parambdei.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewCameraFilterGLView$SharedMemWriteFile;
  }
  
  private void a(bddq parambddq, bdei parambdei, int paramInt1, boolean paramBoolean, AVIOStruct paramAVIOStruct, int paramInt2, bdbs parambdbs)
  {
    CameraFilterGLView.SharedMemWriteFile localSharedMemWriteFile = a(parambdei);
    localSharedMemWriteFile.jdField_a_of_type_Int = parambddq.jdField_a_of_type_Int;
    localSharedMemWriteFile.jdField_b_of_type_Int = parambddq.jdField_b_of_type_Int;
    ...
    localSharedMemWriteFile.jdField_b_of_type_Boolean = parambddq.jdField_a_of_type_Boolean;
    localSharedMemWriteFile.jdField_a_of_type_Bdeh = parambddq.jdField_a_of_type_Bdeh;
    localSharedMemWriteFile.jdField_a_of_type_Alup = null;
    localSharedMemWriteFile.d = paramInt2;
    localSharedMemWriteFile.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference = parambddq.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference;
    localSharedMemWriteFile.jdField_a_of_type_Bdbs = parambdbs;
    parambddq.jdField_a_of_type_Bdeh.a(localSharedMemWriteFile);
  }
  ...
  public boolean handleMessage(Message arg1)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              ...
              {
                return true;
                synchronized (this.jdField_a_of_type_Bddr.jdField_a_of_type_JavaLangObject)
                {
                  if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilSVOpenglFlipFilter != null) && (!this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilSVOpenglFlipFilter.a(this.jdField_a_of_type_Bddr.jdField_a_of_type_Int, this.jdField_a_of_type_Bddr.jdField_b_of_type_Int, this.jdField_a_of_type_Bddr.jdField_a_of_type_AndroidOpenglEGLContext)))
                  {
                  ...
                  if (this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilSVOpenglFlipFilter == null)
                  {
                    ...
                    this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilSVOpenglFlipFilter = new SVOpenglFlipFilter(this.jdField_a_of_type_Bddr.jdField_a_of_type_Int, this.jdField_a_of_type_Bddr.jdField_b_of_type_Int, this.jdField_a_of_type_Bddr.jdField_a_of_type_AndroidOpenglEGLContext);
                  }
                }
                try
                {
            ...
            localbdei = a(???, ???.c);
          } while (localbdei == null);
          a(???, localbdei, 0, false, ???.jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct, 0, ???.jdField_a_of_type_Bdbs);
          return true;
          if ((!this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) || (!bdec.jdField_a_of_type_Boolean)) {
            break;
          }
        ...
        a(???, localbdei, 0, false, ???.jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct, ???.d, ???.jdField_a_of_type_Bdbs);
        return true;
        localbdei = a(???, ???.c);
      } while (localbdei == null);
      a(???, localbdei, 180, true, ???.jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct, ???.d, ???.jdField_a_of_type_Bdbs);
      return true;
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.getAndSet(false);
    } while (this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilSVOpenglFlipFilter == null);
    this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilSVOpenglFlipFilter.b();
