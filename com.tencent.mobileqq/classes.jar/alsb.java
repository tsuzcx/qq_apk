...
public class alsb
  extends alqn<CustomEmotionData>
{
    ...
    do
    {
      ...
      if (i < paramList2.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          localObject2 = new apov((String)localObject1);
          if ((!((apov)localObject2).a()) || (TextUtils.isEmpty(((apov)localObject2).c)) || (TextUtils.isEmpty(((apov)localObject2).d)))
          {
      ...
      if (i < paramList1.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          localapov1 = new apov((String)localObject2);
          if ((!localapov1.a()) || (TextUtils.isEmpty(localapov1.c)) || (TextUtils.isEmpty(localapov1.d)))
          {
            if (QLog.isColorLevel()) {
            ...
            ((List)localObject1).add(localapov1);
          }
        }
      }
      ...
      {
        localapov1 = (apov)localArrayList.get(i);
        int j = 0;
        while (j < ((List)localObject1).size())
        {
          apov localapov2 = (apov)((List)localObject1).get(j);
          if ((localapov1.c.equals(localapov2.c)) && (localapov2.c.equals("0")) && (localapov2.d.equals(localapov1.d)))
          {
            paramList1.remove(localapov2.a);
            ((StringBuilder)localObject2).append(localapov2.a).append(", ");
          }
          j += 1;
        }
        i += 1;
  ...
  public void a()
  {
    ...
    localPlatInfo.mqqver.set("8.3.5");
  ...
  public void a(CustomEmotionData paramCustomEmotionData, String paramString)
  {
    ...
    if ((this.app == null) || (this.app.getApp() == null))
    {
      ...
      notifyUI(3, false, this.mApp.getApplication().getString(2131692115));
      return;
    }
    if (!bdin.a())
    {
      notifyUI(3, false, this.app.getApp().getString(2131694063));
      return;
    }
    try
    {
      ...
      ((FavEmotionOcr.ReqBody)localObject1).string_version.set("8.3.5");
  ...
  public void a(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        azri.a(BaseApplication.getContext()).a(null, "favEmoModifyOcrsSuc", false, 0L, 0L, (HashMap)localObject, null);
        if ((i != 0) && (paramObject.bytes_bodybuffer.has()) && (paramObject.bytes_bodybuffer.get() != null))
        {
          ...
          if (i < paramFromServiceMsg.size())
          {
            ...
            {
              paramObject = ((apon)this.app.getManager(149)).a();
              if (paramObject != null)
              {
            ...
            {
              notifyUI(3, false, this.mApp.getApplication().getString(2131692121));
              if (QLog.isColorLevel()) {
  ...
  public void a(FromServiceMsg paramFromServiceMsg, Object paramObject, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        azri.a(BaseApplication.getContext()).a(null, "favEmoGetOcrSuc", false, 0L, 0L, (HashMap)localObject1, null);
        if ((i != 0) && (paramObject.bytes_bodybuffer.has()) && (paramObject.bytes_bodybuffer.get() != null))
        {
          paramFromServiceMsg = new FavEmotionOcr.RspBody();
          paramFromServiceMsg.mergeFrom(paramObject.bytes_bodybuffer.get().toByteArray());
          ...
          paramObject = (apon)this.app.getManager(149);
  ...
  public void a(Object paramObject, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      ((apon)this.app.getManager(149)).c(localArrayList);
  ...
  public void a(List<CustomEmotionData> paramList, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localReqBody.string_version.set("8.3.5");
  ...
  public void b(List<String> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        apov localapov = new apov((String)paramList.next());
        if (!TextUtils.isEmpty(localapov.d)) {
          localArrayList.add(localapov.d);
        }
      }
      if (localArrayList.size() > 0) {
        ((appr)this.app.getManager(141)).a(localArrayList);
      }
    }
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
    {
      ...
      if (i == 1)
      {
        paramToServiceMsg = (apoo)this.mApp.getManager(72);
