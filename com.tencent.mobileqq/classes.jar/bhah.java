...
public class bhah
  extends QIPCModule
{
  private static bhah jdField_a_of_type_Bhah;
  private final AtomicReference<bhak> jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference = new AtomicReference();
  
  public bhah(String paramString)
  {
    super(paramString);
  }
  
  public static bhah a()
  {
    if (jdField_a_of_type_Bhah == null) {}
    try
    {
      if (jdField_a_of_type_Bhah == null) {
        jdField_a_of_type_Bhah = new bhah("QzoneIPCModule");
      }
      return jdField_a_of_type_Bhah;
    }
    finally {}
  }
  
  private static List<aewv> a(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localLinkedList.add(localaewv);
      i += 1;
      paramString2 = paramString1;
    }
  }
  
  public static JSONObject a(List<aewf> paramList)
  {
    ...
    {
      Object localObject2 = (aewf)paramList.next();
      if ((localObject2 != null) && ((localObject2 instanceof aewv)))
      {
        localObject2 = (aewv)localObject2;
        try
        {
          JSONObject localJSONObject = new JSONObject();
          localJSONObject.put("url", ((aewv)localObject2).a()).put("thumbUrl", ((aewv)localObject2).e()).put("md5", ((aewv)localObject2).b());
  ...
  public void a()
  {
    QIPCServerHelper.getInstance().callClient("com.tencent.mobileqq:qzone", "QzoneIPCModule", "cooperation.qzone.ACTION_PUBLIC_ACCOUNT_GET_TASK_LIST", null, new bhaj(this));
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      ...
      localbhak = (bhak)this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference.get();
    } while ((localbhak == null) || (!paramString1.equals(bhak.b(localbhak))) || (!this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference.compareAndSet(localbhak, null)));
    bhak.a(localbhak, paramString2);
    bhak.b(localbhak, paramString3);
    bhak.a(localbhak).countDown();
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("getHostInfo".equals(paramString)) {
      try
      {
        paramString = ((ajxl)localQQAppInterface.getManager(51)).c(localQQAppInterface.getCurrentAccountUin());
    ...
    if ("isFriend".equals(paramString))
    {
      ...
      try
      {
        ...
        bool = ((ajxl)localQQAppInterface.getManager(51)).b(String.valueOf(l));
    ...
    if ("startDownloadVoicechangeSo".equals(paramString)) {
      for (;;)
      {
        ...
        try
        {
          paramString = ((anpc)localQQAppInterface.getManager(77)).a(anqb.e());
          if (paramString == null) {
            continue;
          }
          paramString.a(false);
    ...
    if ("action_qzone_pic_pre_send".equals(paramString)) {
      try
      {
        aunh.a(localQQAppInterface, paramBundle);
        paramString = new Bundle();
    ...
    for (;;)
    {
      ...
      Object localObject2 = aexb.a(localQQAppInterface);
      ((aexb)localObject2).a();
      if (!((aexb)localObject2).b())
      {
        QLog.i("QzoneIPCModule", 1, "emo rec is not open");
        return null;
      }
      localObject1 = new bhak(paramBundle, null);
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference.set(localObject1);
      if (!((aexb)localObject2).a(paramBundle, 0, paramString, true))
      {
      ...
      try
      {
        bhak.a((bhak)localObject1).await(2L, TimeUnit.SECONDS);
        if (TextUtils.isEmpty(bhak.a((bhak)localObject1)))
        {
      ...
      catch (InterruptedException paramString)
      {
        ...
        paramString = new Bundle();
        paramString.putString("analyze_text", bhak.b((bhak)localObject1));
        paramString.putString("resp_data", bhak.a((bhak)localObject1));
        paramString.putString("resp_pass", bhak.c((bhak)localObject1));
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          ((aexh)localObject3).jdField_a_of_type_JavaLangString = paramBundle;
          ((aexh)localObject3).b = ((String)localObject1);
          ((aexh)localObject3).jdField_a_of_type_JavaUtilList = a(str, (String)localObject2, paramInt);
          paramBundle = aexb.a(localQQAppInterface);
          paramBundle.a();
          ...
          if ("action_save_customenotion".equals(paramString))
          {
            ...
            paramInt = aehw.a(localQQAppInterface, paramString);
            paramString = new Bundle();
          ...
          if ("action_pre_pull_mini_app".equals(paramString))
          {
            ...
            MiniAppPrePullManager.getInstance().prePullAppinfoByLink(paramString, paramInt, new bhai(this));
            return null;
          }
          if ("cooperation.qzone.ACTION_PUBLIC_ACCOUNT_FAKE_FEED_CREATE".equalsIgnoreCase(paramString))
          {
            ...
            wpt.a().a(new SubscribeFeedsEvent(paramString, 1));
            return null;
          }
          if ("cooperation.qzone.ACTION_PUBLIC_ACCOUNT_FAKE_FEED_UPDATE".equalsIgnoreCase(paramString))
          {
            ...
            paramString = (CertifiedFakeFeed)paramString;
            wpt.a().a(new SubscribeFeedsEvent(paramString, 2));
            return null;
          }
          if ("cooperation.qzone.ACTION_PUBLIC_ACCOUNT_FAKE_FEED_DELETE".equalsIgnoreCase(paramString))
          {
            ...
            paramString = (CertifiedFakeFeed)paramString;
            wpt.a().a(new SubscribeFeedsEvent(paramString, 3));
            return null;
          }
          if ("cooperation.qzone.ACTION_PUBLIC_ACCOUNT_QUEUE_CHANGED".equalsIgnoreCase(paramString))
          {
            ...
            wpt.a().a(new PublishBoxStatusEvent(paramBundle));
            wpt.a().a(new SubscribeFeedsEvent(4));
            return null;
          }
          ...
          if ("cooperation.qzone.ACTION_PUBLIC_ACCOUNT_UNFOLLOW".equalsIgnoreCase(paramString))
          {
            ...
            sgg.a(localQQAppInterface, localQQAppInterface.getApp().getApplicationContext(), paramString, false, null, true);
            bhpo.a(localQQAppInterface.getApp().getApplicationContext(), paramString, 0);
            return null;
          }
          ...
          if ("cooperation.qzone.ACTION_PUBLIC_ACCOUNT_FEED_PUBLISH".equalsIgnoreCase(paramString))
          {
            ...
            try
            {
              ...
              wpt.a().a(new SubscribePublishFeedsEvent(paramString, 1));
              return null;
            }
            catch (Exception paramString)
            {
        ...
        {
          paramString = new Bundle();
          paramBundle = amgf.a(localQQAppInterface);
          if (paramBundle == null)
          {
          ...
          if (bool)
          {
            ...
            paramBundle = ((amtj)localObject1).a();
            localObject1 = ((amtj)localObject1).b();
        ...
        paramString = amgf.a(localQQAppInterface);
        if (paramString == null)
        {
