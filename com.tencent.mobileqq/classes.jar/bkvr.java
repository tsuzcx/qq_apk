  ...
  extends ReportDialog
{
  ...
  private bkvr(bkvu parambkvu)
  {
    super(bkvu.a(parambkvu), 2131755327);
    Object localObject3 = new LinearLayout(bkvu.a(parambkvu));
    ((LinearLayout)localObject3).setOrientation(1);
    ((LinearLayout)localObject3).setBackgroundColor(-1);
    ((LinearLayout)localObject3).setBackgroundDrawable(bkvi.a(-1, DisplayUtil.dip2px(bkvu.a(parambkvu), 4.0F)));
    int i = DisplayUtil.dip2px(bkvu.a(parambkvu), 25.0F);
    ...
    ((LinearLayout.LayoutParams)localObject4).setMargins(DisplayUtil.dip2px(bkvu.a(parambkvu), 30.0F), 0, DisplayUtil.dip2px(bkvu.a(parambkvu), 30.0F), 0);
    TextView localTextView = new TextView(bkvu.a(parambkvu));
    ...
    localObject1 = new TextView(bkvu.a(parambkvu));
    Object localObject2 = new LinearLayout.LayoutParams(-2, -2);
    ((LinearLayout.LayoutParams)localObject2).setMargins(DisplayUtil.dip2px(bkvu.a(parambkvu), 16.5F), 0, 0, DisplayUtil.dip2px(bkvu.a(parambkvu), 18.5F));
    ((TextView)localObject1).setTextColor(-16777216);
    ((LinearLayout)localObject3).addView((View)localObject1, (ViewGroup.LayoutParams)localObject2);
    Object localObject5 = new LinearLayout(bkvu.a(parambkvu));
    ...
    ((LinearLayout.LayoutParams)localObject6).setMargins(DisplayUtil.dip2px(bkvu.a(parambkvu), -5.0F), 0, DisplayUtil.dip2px(bkvu.a(parambkvu), -5.0F), 0);
    localObject2 = new Button(bkvu.a(parambkvu));
    ((Button)localObject2).setBackgroundDrawable(bkvi.a(-13544, DisplayUtil.dip2px(bkvu.a(parambkvu), 3.0F)));
    i = DisplayUtil.dip2px(bkvu.a(parambkvu), 9.0F);
    ((Button)localObject2).setPadding(0, i, 0, i);
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(0, -2, 1.0F);
    localLayoutParams.setMargins(DisplayUtil.dip2px(bkvu.a(parambkvu), 5.0F), 0, DisplayUtil.dip2px(bkvu.a(parambkvu), 5.0F), 0);
    ...
    Button localButton = new Button(bkvu.a(parambkvu));
    localButton.setBackgroundDrawable(bkvi.a(-1121584, DisplayUtil.dip2px(bkvu.a(parambkvu), 3.0F)));
    ...
    this.jdField_a_of_type_Boolean = bkvu.a(parambkvu);
    localObject3 = bkvu.a(parambkvu);
    localObject4 = bkvu.b(parambkvu);
    localObject5 = bkvu.c(parambkvu);
    localObject6 = bkvu.d(parambkvu);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = bkvu.a(parambkvu);
    this.b = bkvu.b(parambkvu);
    boolean bool1 = bkvu.b(parambkvu);
    boolean bool2 = bkvu.c(parambkvu);
    if (!TextUtils.isEmpty((CharSequence)localObject3))
    {
      ...
      ((Button)localObject2).setOnClickListener(new bkvs(this));
      label665:
      ...
      localButton.setOnClickListener(new bkvt(this));
    }
    for (;;)
    {
      setCancelable(bool1);
