  ...
  implements aaim
{
  ...
  protected BaseWidgetView a(ViewGroup paramViewGroup, zxu paramzxu)
  {
    if ((getParentFragment() instanceof SubscribeMultiPicFragment))
    {
      ...
      paramzxu = new LinearLayout.LayoutParams(-1, ImmersiveUtils.a(29.0F));
      paramzxu.leftMargin = ImmersiveUtils.a(9.0F);
      paramzxu.rightMargin = ImmersiveUtils.a(15.0F);
      paramzxu.gravity = 16;
      this.jdField_a_of_type_ComTencentBizSubscribeWidgetSubscribeFollowInfoView.setLayoutParams(paramzxu);
    ...
    if (this.jdField_a_of_type_Aaiw != null) {
      this.jdField_a_of_type_Aaiw.a(this.jdField_a_of_type_ComTencentBizSubscribeWidgetRelativevideoRelativeMultiPicHeadItemView.a());
    }
  ...
  public void d(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    do
    {
      ...
      if (aaae.b(paramStFeed.type.get()))
      {
  ...
  public void handleBlockChange(zxu paramzxu, int paramInt)
  {
    if ((paramzxu.getUniqueKey() != null) && ("RELATIVE_ADAPTER_UNIQUE_KEY".equals(paramzxu.getUniqueKey()))) {
      ((aacp)paramzxu).a(new aaco(this));
    }
  }
