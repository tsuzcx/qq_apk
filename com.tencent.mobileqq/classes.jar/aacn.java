  ...
  extends aabq
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "DoraemonOpenAPI." + aacn.class.getSimpleName();
  }
  ...
  private void a(JSONObject paramJSONObject, aabm paramaabm)
  {
    ...
    if (i <= 0)
    {
      aaet.a(paramaabm, -100, "rankingID must be bigger than 0");
      return;
    }
    Object localObject = (aacw)this.jdField_a_of_type_Aabp.a(aacw.class, false);
    if (localObject == null)
    {
      aaet.a(paramaabm, -10, "internal error, try again.");
      return;
    }
    Oidb_0xb85.ReqBody localReqBody = new Oidb_0xb85.ReqBody();
    localObject = ((aacw)localObject).a();
    localReqBody.appid.set(Integer.valueOf(this.jdField_a_of_type_Aabp.jdField_a_of_type_JavaLangString).intValue());
    localReqBody.service_id.set(this.jdField_a_of_type_Aabp.jdField_a_of_type_Int);
    localReqBody.openid.set(((aacz)localObject).jdField_a_of_type_JavaLangString);
    localReqBody.openkey.set(((aacz)localObject).b);
    ...
    mxi.a(BaseApplicationImpl.getApplication().getRuntime(), new aaco(this, (aacz)localObject, paramJSONObject, paramaabm), localReqBody.toByteArray(), "OidbSvc.0xb85", 2949, 2, null, 0L);
  }
  ...
  private void b(JSONObject paramJSONObject, aabm paramaabm)
  {
    ...
    if (i <= 0)
    {
      aaet.a(paramaabm, -100, "rankingID 没有传或者值小于等于0");
      return;
    }
    Object localObject1 = (aacw)this.jdField_a_of_type_Aabp.a(aacw.class, false);
    Oidb_0xb85.ReqBody localReqBody = new Oidb_0xb85.ReqBody();
    localObject1 = ((aacw)localObject1).a();
    localReqBody.appid.set(Integer.valueOf(this.jdField_a_of_type_Aabp.jdField_a_of_type_JavaLangString).intValue());
    localReqBody.service_id.set(this.jdField_a_of_type_Aabp.jdField_a_of_type_Int);
    localReqBody.openid.set(((aacz)localObject1).jdField_a_of_type_JavaLangString);
    localReqBody.openkey.set(((aacz)localObject1).b);
    ...
    {
      aaet.a(paramaabm, -101, "参数处理错误, 是否是类型不对? 查看一下文档吧. \nerrorMsg: " + paramJSONObject.getMessage());
      return;
    }
    mxi.a(BaseApplicationImpl.getApplication().getRuntime(), new aacp(this, (aacz)localObject1, paramJSONObject, paramaabm), localReqBody.toByteArray(), "OidbSvc.0xb85", 2949, 1, null, 0L);
  }
