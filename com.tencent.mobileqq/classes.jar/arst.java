...
public class arst
  implements SurfaceHolder.Callback, arsr
{
  ...
  public arst(SurfaceView paramSurfaceView)
  {
  ...
  private Canvas b()
  {
    ...
    for (;;)
    {
      ...
      {
        artm.a("SurfaceDanmakuView", "Exception locking surface", localException);
      }
  ...
  private boolean b()
  {
    return (arsi.a()) && (((Build.VERSION.SDK_INT == 23) && (a())) || (arqu.a().a().b()));
  }
  ...
  private void d()
  {
    Object localObject = arqu.a().a().a(SurfaceView.class, "mSurfaceLock", this.jdField_a_of_type_AndroidViewSurfaceView);
  ...
  private void e()
  {
    this.jdField_a_of_type_JavaLangObject = arqu.a().a().a(SurfaceView.class, "mDrawingStopped", this.jdField_a_of_type_AndroidViewSurfaceView);
    this.jdField_b_of_type_JavaLangObject = arqu.a().a().a(SurfaceView.class, "mWindow", this.jdField_a_of_type_AndroidViewSurfaceView);
  ...
  public void a()
  {
    ReentrantLock localReentrantLock = (ReentrantLock)arqu.a().a().a(SurfaceView.class, "mSurfaceLock", this.jdField_a_of_type_AndroidViewSurfaceView);
    ...
    try
    {
      ...
      artm.c("surface_lock", "SurfaceDanmakuView unlock lockObjectValue = " + localLong);
      if (localLong.longValue() != 0L) {
        localMethod.invoke(null, new Object[] { localLong });
      }
      localField.setLong(localSurface, 0L);
      artm.b("surface_lock", "SurfaceDanmakuView unlock: release success");
      return;
    }
    catch (Exception localException)
    {
      artm.a("surface_lock", "SurfaceDanmakuView unlock:release failed", localException);
      return;
    }
    finally
    {
      artm.c("surface_lock", "SurfaceDanmakuView unlock surfaceLock = " + localReentrantLock);
      if ((localReentrantLock != null) && (localReentrantLock.isLocked()))
      {
        artm.c("surface_lock", "SurfaceDanmakuView unlock");
  ...
  public void surfaceChanged(SurfaceHolder paramSurfaceHolder, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    artm.c("SurfaceDanmakuView", "surfaceChanged, width = " + paramInt2 + ", height = " + paramInt3);
  }
  ...
  public void surfaceCreated(SurfaceHolder paramSurfaceHolder)
  {
    ...
    artm.c("SurfaceDanmakuView", "surfaceCreated, isHardwareAccelerateEnable = " + this.jdField_b_of_type_Boolean);
  }
  ...
  public void surfaceDestroyed(SurfaceHolder paramSurfaceHolder)
  {
    ...
    artm.c("SurfaceDanmakuView", "surfaceDestroyed");
  }
}
