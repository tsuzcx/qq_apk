  ...
  extends bdtv
{
  ...
  private bdtu jdField_a_of_type_Bdtu;
  public bkxs a;
  
  public bdtt(bdtx parambdtx, bdtw parambdtw, bkxs parambkxs)
  {
  ...
  private AudioTrack a()
  {
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_Bkxs.jdField_a_of_type_Axkh.e == 1)
        {
          i = 4;
          if (this.jdField_a_of_type_Bkxs.jdField_a_of_type_Axkh.b == 16) {
            j = 2;
          }
          int k = AudioTrack.getMinBufferSize(this.jdField_a_of_type_Bkxs.jdField_a_of_type_Axkh.d, i, j);
          localAudioTrack = new AudioTrack(3, this.jdField_a_of_type_Bkxs.jdField_a_of_type_Axkh.d, i, j, k, 1);
        }
      }
    ...
    label94:
    ved.c("Q.qqstory.mediadecoderMediaCodecAudioRender", "AudioTrack init fail :%s", localThrowable1);
    return localAudioTrack;
  }
  ...
  private void a(AudioTrack paramAudioTrack, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    {
    default: 
      if (!this.jdField_a_of_type_Bdtx.a) {
    ...
    for (;;)
    {
      if ((!this.jdField_a_of_type_Bdtx.a) && (paramInt == 0) && (paramArrayOfByte != null)) {
  ...
  protected void a(MediaCodec paramMediaCodec, MediaCodec.BufferInfo paramBufferInfo)
  {
    ...
    default: 
      ...
      {
        ved.b("Q.qqstory.mediadecoderMediaCodecAudioRender", "output EOS");
    ...
    for (;;)
    {
      ...
      return;
      ved.b("Q.qqstory.mediadecoderMediaCodecAudioRender", "INFO_OUTPUT_BUFFERS_CHANGED");
      this.jdField_b_of_type_ArrayOfJavaNioByteBuffer = paramMediaCodec.getOutputBuffers();
      return;
      ved.b("Q.qqstory.mediadecoderMediaCodecAudioRender", "New format " + paramMediaCodec.getOutputFormat());
      return;
      ved.b("Q.qqstory.mediadecoderMediaCodecAudioRender", "dequeueOutputBuffer timed out!");
      return;
      try
      {
        ...
        if (localObject == null)
        {
          ved.e("Q.qqstory.mediadecoderMediaCodecAudioRender", "find no data");
          return;
        }
      }
      catch (Exception paramMediaCodec)
      {
        ved.c("Q.qqstory.mediadecoderMediaCodecAudioRender", "handle data error :%s", paramMediaCodec);
        return;
      }
      ...
      this.jdField_a_of_type_Bdtu.sendMessage((Message)localObject);
    }
  }
  ...
  protected void a(bdtw parambdtw, MediaCodec paramMediaCodec, MediaFormat paramMediaFormat)
  {
    try
    {
      this.jdField_a_of_type_Bkxs.jdField_a_of_type_Axkh.e = paramMediaFormat.getInteger("channel-count");
      this.jdField_a_of_type_Bkxs.jdField_a_of_type_Axkh.d = vxq.a(paramMediaFormat);
      ved.b("Q.qqstory.mediadecoderMediaCodecAudioRender", "config after b=" + this.jdField_a_of_type_Bkxs.jdField_a_of_type_Axkh.c + " c=" + this.jdField_a_of_type_Bkxs.jdField_a_of_type_Axkh.e + " sc=" + this.jdField_a_of_type_Bkxs.jdField_a_of_type_Axkh.d);
      ...
      this.jdField_a_of_type_Bdtu = new bdtu(this, this.jdField_a_of_type_AndroidOsHandlerThread.getLooper());
      return;
    }
    catch (Throwable parambdtw)
    {
      for (;;)
      {
        parambdtw.printStackTrace();
      }
    }
  }
