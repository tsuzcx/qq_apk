  ...
  implements Animation.AnimationListener
{
  ...
  protected static final int m = (int)BaseApplicationImpl.getApplication().getResources().getDimension(2131166272);
  protected float a;
  protected Handler a;
  ...
  public aymt()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new aymu(this);
  }
  ...
  private void a(TextView paramTextView, int paramInt)
  {
    ...
    if (paramInt == e)
    {
      paramTextView.setText(2131632128);
      paramTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130841763, 0);
