...
public class bfpj
{
  private static bfpj jdField_a_of_type_Bfpj;
  ...
  {
    if (jdField_a_of_type_Bfpj == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Bfpj == null) {
        jdField_a_of_type_Bfpj = new bfpj();
      }
      return jdField_a_of_type_Bfpj;
    }
  }
  ...
  public String a()
  {
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_JavaLangString = befc.a("52b7f2");
    }
  ...
  public String c()
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      ((StringBuilder)localObject2).append("mm=").append(babp.d() / 1048576L).append('&');
      ((StringBuilder)localObject2).append("cf=").append(babp.a()).append('&');
      ((StringBuilder)localObject2).append("cc=").append(babp.b()).append('&');
      ((StringBuilder)localObject2).append("aid=").append(babp.f()).append('&');
  ...
  public String f()
  {
    ...
    ((StringBuilder)localObject).append("mm=").append(babp.d() / 1048576L).append('&');
    ((StringBuilder)localObject).append("cf=").append(babp.a()).append('&');
    ((StringBuilder)localObject).append("cc=").append(babp.b()).append('&');
    ((StringBuilder)localObject).append("qqversion=").append("8.2.6");
