...
public class bpld
  implements Comparable<bpld>
{
  public int a;
  public long a;
  public int b;
  
  public bpld(VideoFramesRetriever paramVideoFramesRetriever, long paramLong, int paramInt1, int paramInt2)
  {
  ...
  public int a(bpld parambpld)
  {
    return -(int)(this.jdField_a_of_type_Long - parambpld.jdField_a_of_type_Long);
  }
}
