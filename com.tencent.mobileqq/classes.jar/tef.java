...
public class tef
{
  ...
  public static tef a(qqstory_service.PromoteTask paramPromoteTask)
  {
    tef localtef = new tef();
    localtef.jdField_a_of_type_Long = paramPromoteTask.uint64_taskid.get();
    localtef.jdField_a_of_type_Int = paramPromoteTask.uint32_promote_type.get();
    localtef.jdField_a_of_type_JavaLangString = paramPromoteTask.bytes_union_id.get().toStringUtf8();
    localtef.jdField_b_of_type_JavaLangString = paramPromoteTask.bytes_feed_id.get().toStringUtf8();
    localtef.jdField_b_of_type_Long = paramPromoteTask.uint64_limit_count.get();
    localtef.c = paramPromoteTask.uint64_minimal_video_count.get();
    localtef.d = paramPromoteTask.uint64_expire_time.get();
    return localtef;
  }
