...
public class pif
{
  ...
  private HashMap<String, pig> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private AppRuntime jdField_a_of_type_MqqAppAppRuntime;
  
  public pif(AppRuntime paramAppRuntime, TroopMemberApiService paramTroopMemberApiService)
  {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    String str = ((qja)this.jdField_a_of_type_MqqAppAppRuntime.getManager(261)).a();
    if (!qip.a(str)) {
      str = "";
    }
    for (;;)
  ...
  public void b(Bundle paramBundle)
  {
    ...
    Object localObject1 = (qja)this.jdField_a_of_type_MqqAppAppRuntime.getManager(261);
    ...
    label208:
    for (localObject1 = ((qja)localObject1).a(0, "", l1, (String)localObject2, str2, l2, l3, bool);; localObject1 = ((qja)localObject1).a(1, str1, l1, (String)localObject2, str2, l2, l3, bool))
    {
  ...
  public void c(Bundle paramBundle)
  {
    ...
    {
      return;
      localObject = (qja)this.jdField_a_of_type_MqqAppAppRuntime.getManager(261);
      ...
      long l2 = paramBundle.getLong("startTime");
      long l3 = paramBundle.getLong("endTime");
      pig localpig = new pig(this.jdField_a_of_type_MqqAppAppRuntime, str1, paramBundle, this.jdField_a_of_type_ComTencentBizTroopTroopMemberApiService);
      this.jdField_a_of_type_JavaUtilHashMap.put(str1, localpig);
      bool = ((qja)localObject).a(str1, str2, str3, l1, l2, l3, localpig);
      if (QLog.isColorLevel()) {
  ...
  public void d(Bundle paramBundle)
  {
    ...
    Object localObject = (qja)this.jdField_a_of_type_MqqAppAppRuntime.getManager(261);
    String str = paramBundle.getString("skinId");
    paramBundle.getString("skinUrl");
    boolean bool = ((qja)localObject).a(str);
