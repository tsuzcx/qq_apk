...
public class bqzd
  extends bqgi
{
  private final agfs jdField_a_of_type_Agfs = new bqzf(this);
  private View jdField_a_of_type_AndroidViewView;
  private bpor jdField_a_of_type_Bpor = new bqze(this);
  ...
  public bqzd(bqyq parambqyq, QzoneVerticalVideoTopicInfo paramQzoneVerticalVideoTopicInfo)
  {
    super(parambqyq);
  ...
  {
    paramMusicItemInfo = QQMusicDownloader.a(paramMusicItemInfo.mUrl, paramMusicItemInfo.getLocalPath(), this.jdField_a_of_type_Bpor);
    if (paramMusicItemInfo != null) {
      QQMusicDownloader.a(paramMusicItemInfo, this.jdField_a_of_type_Bpor);
    }
  }
  ...
  private void d()
  {
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(a()).inflate(2131562334, null);
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380126)).setText(this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo.e());
    Object localObject = (URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369308);
    ...
    for (;;)
    {
      localObject = (RelativeLayout)a(2131365887);
      RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams.addRule(12);
      localLayoutParams.bottomMargin = agej.a(110.0F, a());
      localLayoutParams.leftMargin = agej.a(10.0F, a());
  ...
  private void k()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAudioPlayer = new AudioPlayer(a(), this.jdField_a_of_type_Agfs);
  ...
  public void a(int paramInt, @NonNull bqua parambqua)
  {
    ...
    {
      parambqua.a.backgroundMusicPath = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath();
      parambqua.a.isMuteRecordVoice = true;
      parambqua.a.backgroundMusicOffset = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.musicStart;
      parambqua.a.backgroundMusicDuration = ((int)ShortVideoUtils.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath()));
      if (parambqua.a.backgroundMusicDuration <= 0) {
