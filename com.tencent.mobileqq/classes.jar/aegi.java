...
public class aegi
  extends ameq
{
  public aegi(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  {
    if (!bdeu.a(String.valueOf(paramLong1), this.a.jdField_b_of_type_JavaLangString)) {}
    do
    {
      return;
      if (QLog.isColorLevel())
  ...
  protected void a(boolean paramBoolean, List<cmd0x406.GroupFeeMember> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localaegt.a = (localGroupFeeMember.uint64_uin.get() + "");
      localaegt.jdField_b_of_type_JavaLangString = localGroupFeeMember.string_nick_name.get();
      if (this.a.jdField_a_of_type_Aloa != null) {
        this.a.jdField_a_of_type_Aloa.a(localaegt);
      }
      localArrayList.add(localaegt);
    }
  ...
  protected void b(boolean paramBoolean, long paramLong1, int paramInt1, List<oidb_0x899.memberlist> paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    if ((this.a.jdField_a_of_type_ComTencentMobileqqDataTroopInfo != null) && (this.a.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.isHomeworkTroop()))
    {
      ...
      this.a.f = bcpx.a(this.a.app, this.a.jdField_a_of_type_ComTencentMobileqqDataTroopInfo, paramList, false);
      paramList = this.a;
