...
public class acvj
  implements ahbr
{
  public acvj(CustomizeStrategyFactory.SkinRedPacketStrategy.1 param1) {}
  ...
  public void onResult(int paramInt, PreloadManager.PathResult paramPathResult)
  {
    ...
    try
    {
      ...
      BitmapFactory.Options localOptions = bbef.a(str1, paramInt);
    ...
    if (paramInt < j)
    {
      ...
      localObject2 = SafeBitmapFactory.decodeFile((String)localObject2, bbef.a((String)localObject2, i));
