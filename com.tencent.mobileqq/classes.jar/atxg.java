  ...
  extends atxd
{
  ...
  public atxg(Context paramContext, View paramView, ViewGroup paramViewGroup)
  {
    super(paramContext, paramView, paramViewGroup);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131379789));
    this.b = ((TextView)paramView.findViewById(2131379688));
    this.c = ((TextView)paramView.findViewById(2131379452));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368495));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramView.findViewById(2131369660));
  ...
  public void a(FeedsItemData paramFeedsItemData)
  {
    ...
    for (;;)
    {
      this.itemView.setOnClickListener(new atxh(this, paramFeedsItemData));
      return;
      ...
      for (;;)
      {
        ...
        ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = this.itemView.getResources().getDrawable(2130840983);
        ((URLDrawable.URLDrawableOptions)localObject).mFailedDrawable = this.itemView.getResources().getDrawable(2130840983);
