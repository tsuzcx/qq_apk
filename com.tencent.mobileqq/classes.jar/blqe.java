...
public class blqe
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajni.jdField_a_of_type_JavaLangString + "/Tencent/qim/hum_recognition";
  ...
  private String a()
  {
    ...
    int i = a();
    String str1 = blpr.a("musicopi_12345683" + "a45a1b" + l);
  ...
  public blqe a(float paramFloat)
  {
    if (QLog.isColorLevel()) {
