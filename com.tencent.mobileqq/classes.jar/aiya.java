...
public class aiya
{
  ...
  public void a()
  {
    try
    {
      if ((!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) && (!TextUtils.isEmpty(this.b)) && (bbdx.a(this.b)))
      {
        if (bbdx.b(this.b) <= 8388608L) {
          break label84;
        }
      ...
      while (QLog.isColorLevel())
      {
        ...
        return;
        label84:
        this.jdField_a_of_type_ArrayOfByte = bbdx.a(this.b);
      }
      return;
    }
    catch (Throwable localThrowable)
