...
public class woz
  implements wou
{
  protected wew<String, VideoCollectionItem> a;
  protected ygn a;
  protected wew<String, MemoryInfoEntry> b = new wew(300);
  ...
  public ShareGroupCollectionItem a(String paramString)
  {
    ...
    {
      return localObject;
      localShareGroupCollectionItem = (ShareGroupCollectionItem)this.jdField_a_of_type_Wew.a(paramString);
    ...
    paramString = ((xzh)wpm.a(7)).a(localShareGroupCollectionItem.groupId);
    if (paramString == null) {
      return null;
    }
    ...
    if (paramString != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localObject = localwpj.a(localStoryVideoListEntry.vid);
    ...
    this.jdField_a_of_type_Wew.a(localShareGroupCollectionItem.key, localShareGroupCollectionItem);
  ...
  public VideoCollectionItem a(@NonNull VideoCollectionItem paramVideoCollectionItem)
  {
    ...
    paramVideoCollectionItem = (VideoCollectionItem)this.jdField_a_of_type_Wew.a(paramVideoCollectionItem.key, paramVideoCollectionItem);
  ...
  public VideoCollectionItem a(String paramString)
  {
    ...
    {
      return localObject1;
      localObject2 = (VideoCollectionItem)this.jdField_a_of_type_Wew.a(paramString);
    ...
    if (localObject2 != null)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        StoryVideoItem localStoryVideoItem = ((wpj)localObject1).a(str);
        paramString.videoVidList.add(str);
        paramString.collectionVideoUIItemList.add(new ygo(str, localStoryVideoItem));
      }
    }
    this.jdField_a_of_type_Wew.a(paramString.key, paramString);
    return paramString;
  }
  ...
  {
    ArrayList localArrayList = new ArrayList();
    Object localObject = wpj.a(QQStoryContext.a().a().createEntityManager(), MemoriesYearNodeEntry.class, MemoriesYearNodeEntry.class.getSimpleName(), null, null);
    if (localObject == null) {
      return localArrayList;
    }
  ...
  public List<VideoCollectionItem> a(String paramString, VideoCollectionItem paramVideoCollectionItem, long paramLong)
  {
    ...
    yqp.a("MemoryManager", "query sql = %s , resultCount = %d", str1, Integer.valueOf(paramString.size()));
    paramString = paramString.iterator();
    while (paramString.hasNext())
    {
  ...
  protected void a(List<VideoCollectionItem> paramList, VideoCollectionItem paramVideoCollectionItem)
  {
    if (paramList.indexOf(paramVideoCollectionItem) > 0) {
      yqp.b("MemoryManager", "data already exist, id=%s, time=%d", paramVideoCollectionItem.collectionId, Long.valueOf(paramVideoCollectionItem.collectionTime));
    }
    int i;
    do
    {
      return;
      i = Collections.binarySearch(paramList, paramVideoCollectionItem, this.jdField_a_of_type_Ygn);
    } while (i >= 0);
  ...
  public void a(List<VideoCollectionItem> paramList, String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      localObject = a(wvs.a(paramString));
    }
    finally
    {
    ...
    for (paramString = new MemoryInfoEntry(paramString);; paramString = (String)localObject)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        localObject = (VideoCollectionItem)this.jdField_a_of_type_Wew.a(((VideoCollectionItem)localObject).key, (wev)localObject);
        ((VideoCollectionItem)localObject).videoItemList = localwpj.a(((VideoCollectionItem)localObject).videoItemList);
        ...
        localEntityManager.persistOrReplace(((VideoCollectionItem)this.jdField_a_of_type_Wew.a(((VideoCollectionItem)localObject).key, (wev)localObject)).convertTo());
      }
  ...
  public void b()
  {
    this.jdField_a_of_type_Wew.a(20);
  }
  ...
  public void b(List<ShareGroupCollectionItem> paramList, String paramString, boolean paramBoolean)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      paramString = (ShareGroupCollectionItem)this.jdField_a_of_type_Wew.a(paramString.key, paramString);
      paramString.shareGroupItem = localxzh.a(paramString.shareGroupItem);
      paramString.videoItemList = localwpj.a(paramString.videoItemList);
