...
public class auon
{
  ...
  {
    a(paramActivity, paramString, paramMap, 1000, false, false);
  }
  
  public static void a(Activity paramActivity, String paramString, Map<String, Object> paramMap, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localIntent.putExtra("need_status_bar_trans", paramBoolean1);
    localIntent.putExtra("need_status_text_dark", paramBoolean2);
    if (paramMap != null)
    {
  ...
  public static void a(Context paramContext, String paramString, Map<String, Object> paramMap, byte[] paramArrayOfByte)
  {
    ...
    localIntent.putExtra("click_millis", SystemClock.elapsedRealtime());
    localIntent.putExtra("preload_process", bool);
    localIntent.putExtra("need_status_bar_trans", true);
    localIntent.putExtra("need_status_text_dark", true);
