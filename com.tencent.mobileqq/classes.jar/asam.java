...
public class asam
{
  ...
  public static String a(long paramLong, boolean paramBoolean)
  {
    ...
    if (i == j + 1)
    {
      ...
      for (localObject = "H点m分";; localObject = "HH:mm")
      {
        ...
        return String.format(anzj.a(2131701764), new Object[] { localObject });
      }
    }
    if (i == j + 2)
    {
      ...
      {
        localObject = new SimpleDateFormat((String)localObject).format(localCalendar.getTime());
        return String.format(anzj.a(2131701765), new Object[] { localObject });
      }
    }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    do
    {
      return false;
      paramQQAppInterface = paramQQAppInterface.a();
    } while ((paramQQAppInterface == null) || (paramQQAppInterface.f(paramString, paramInt) <= 0));
    return true;
  }
  ...
  public static boolean b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (paramString != null)
    {
      paramQQAppInterface = ((bitz)paramQQAppInterface.a(107)).a("");
