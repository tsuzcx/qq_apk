  ...
  implements bjjg
{
  ...
  public adkl(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localObject2 = adkk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationInfo().sourceDir);
    ...
    for (int i = 0;; i = 1)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localObject1 = new bjja(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), (bjix)localObject1);
          if (localObject1 == null) {
            break;
          }
          localObject1 = (bjjf)((bjja)localObject1).a("sig_check");
          if (localObject1 == null) {
            break;
          }
          ((bjjf)localObject1).a(this);
          ((bjjf)localObject1).a(((JSONObject)localObject4).toString());
          return;
        }
