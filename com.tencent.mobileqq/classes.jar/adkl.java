...
{
  public adkl(AuthDevActivity paramAuthDevActivity) {}
  ...
  public void onCheckDevLockSms(WUserSigInfo paramWUserSigInfo, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    do
    {
      ...
      paramWUserSigInfo = (aodi)this.a.app.getBusinessHandler(BusinessHandlerFactory.SEC_SVC_HANDLER);
      if (paramWUserSigInfo != null) {
        paramWUserSigInfo.a();
      }
  ...
  public void onCloseDevLock(WUserSigInfo paramWUserSigInfo, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    do
    {
      ...
      AuthDevActivity.a(this.a).setVisibility(8);
      asll.a().a(this.a.app, this.a, this.a.app.getCurrentAccountUin(), false);
      QQToast.a(this.a.getApplicationContext(), 2, this.a.getString(2131691944), 0).b(this.a.getTitleBarHeight());
      paramWUserSigInfo = this.a.app.getHandler(LoginInfoActivity.class);
      if (paramWUserSigInfo != null) {
    ...
    QQToast.a(this.a.getApplicationContext(), 1, this.a.getString(2131691943), 0).b(this.a.getTitleBarHeight());
  }
}
