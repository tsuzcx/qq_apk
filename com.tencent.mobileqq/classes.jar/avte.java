...
{
  public static final String a = bigv.a(antf.ba + "hotpic/");
  ...
  {
    paramString = new bihu(paramString.replaceFirst("https", "http"), paramFile);
    paramString.e = 20000;
    paramString.n = true;
    paramString.b = 2;
    return bihw.a(paramString, null, null);
  }
  ...
  protected void a(int paramInt, HotPicData paramHotPicData)
  {
    if ((paramHotPicData instanceof EmotionSearchItem)) {
      axfj.e(String.valueOf(paramInt), 7);
    }
  }
  ...
  public File loadImageFile(DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    if (j == 0)
    {
      str = azul.a(localFile.getAbsolutePath());
