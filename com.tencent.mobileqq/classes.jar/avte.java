...
{
  public avte(QQAppInterface paramQQAppInterface)
  {
        ...
        try
        {
          ...
          if (paramOIDBSSOPkg.get_decrypt_key_rsp.has())
          {
            ...
            if (((oidb_cmd0xcde.GetDecryptKeyRsp)localObject).dncrypt_key.has())
            {
              ...
              avtq.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, localObject);
    ...
    try
    {
      ...
      if (paramOIDBSSOPkg.query_state_rsp.has())
      {
        ...
        if (paramOIDBSSOPkg.state.has())
        {
          ...
          ((avul)localObject).a(i);
          if (i == 2)
          {
            if (paramOIDBSSOPkg.token.has()) {
              ((avul)localObject).a(paramOIDBSSOPkg.token.get().toStringUtf8());
            }
            if (paramOIDBSSOPkg.encrypt_key.has()) {
              ((avul)localObject).b(paramOIDBSSOPkg.encrypt_key.get().toStringUtf8());
            }
            if (paramOIDBSSOPkg.user_data.has()) {
              ((avul)localObject).a(a((oidb_cmd0xcdd.UserData)paramOIDBSSOPkg.user_data.get()));
            }
            if (paramOIDBSSOPkg.biz_type.has()) {
              ((avul)localObject).b(paramOIDBSSOPkg.biz_type.get());
            }
          }
        }
        notifyUI(4, true, ((avul)localObject).a());
        return;
      }
    }
    catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
        ...
        try
        {
          ...
          if (paramOIDBSSOPkg.get_encrypt_key_rsp.has())
          {
            ...
            if (paramOIDBSSOPkg.encrypt_key.has())
            {
              ...
              avtq.jdField_a_of_type_JavaLangString = paramOIDBSSOPkg;
              if (QLog.isDevelopLevel()) {
  ...
  private void e(oidb_sso.OIDBSSOPkg paramOIDBSSOPkg)
  {
    ...
    if ((i == 0) && (paramOIDBSSOPkg.bytes_bodybuffer.has()) && (paramOIDBSSOPkg.bytes_bodybuffer.get() != null))
    {
      ...
      try
      {
        ...
        {
          localObject = new avub();
          paramOIDBSSOPkg = (oidb_cmd0xcdd.ConfirmQrRsp)paramOIDBSSOPkg.confirm_qr_rsp.get();
          if (paramOIDBSSOPkg.token.has()) {
            ((avub)localObject).a(paramOIDBSSOPkg.token.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.encrypt_key.has()) {
            ((avub)localObject).b(paramOIDBSSOPkg.encrypt_key.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.user_data.has()) {
            ((avub)localObject).a(a((oidb_cmd0xcdd.UserData)paramOIDBSSOPkg.user_data.get()));
          }
          if (paramOIDBSSOPkg.biz_type.has()) {
            ((avub)localObject).a(paramOIDBSSOPkg.biz_type.get());
          }
          paramOIDBSSOPkg = ((avub)localObject).a();
          if (QLog.isColorLevel()) {
  ...
  private void f(oidb_sso.OIDBSSOPkg paramOIDBSSOPkg)
  {
    ...
    if ((i == 0) && (paramOIDBSSOPkg.bytes_bodybuffer.has()) && (paramOIDBSSOPkg.bytes_bodybuffer.get() != null))
    {
      ...
      try
      {
        ...
        {
          localObject = new avuf();
          paramOIDBSSOPkg = (oidb_cmd0xcdd.GetQrRsp)paramOIDBSSOPkg.get_qr_rsp.get();
          if (paramOIDBSSOPkg.qr_sig.has()) {
            ((avuf)localObject).a(paramOIDBSSOPkg.qr_sig.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.token.has()) {
            ((avuf)localObject).b(paramOIDBSSOPkg.token.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.encrypt_key.has()) {
            ((avuf)localObject).c(paramOIDBSSOPkg.encrypt_key.get().toStringUtf8());
          }
          if (paramOIDBSSOPkg.user_data.has()) {
            ((avuf)localObject).a(a((oidb_cmd0xcdd.UserData)paramOIDBSSOPkg.user_data.get()));
          }
          if (paramOIDBSSOPkg.biz_type.has()) {
            ((avuf)localObject).a(paramOIDBSSOPkg.biz_type.get());
          }
          paramOIDBSSOPkg = ((avuf)localObject).a();
          if (QLog.isColorLevel()) {
            QLog.d("MsgBackup.MsgBackupAuthHandler", 2, "processGetQrRsp getQrResponse= " + paramOIDBSSOPkg);
          }
          avwr.a();
  ...
  public MsgBackupUserData a(oidb_cmd0xcdd.UserData paramUserData)
  {
    ...
    if (paramUserData.ip.has()) {
      localavup.a(paramUserData.ip.get().toStringUtf8());
    }
    if (paramUserData.port.has()) {
      localavup.a(paramUserData.port.get());
    }
    if (paramUserData.ssid.has()) {
      localavup.b(paramUserData.ssid.get().toStringUtf8());
    }
    if (paramUserData.bssid.has()) {
      localavup.c(paramUserData.bssid.get().toStringUtf8());
    }
    return localavup.a();
  }
