...
public class aitv
{
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, azqk paramazqk)
  {
    if ((paramQQAppInterface == null) || (paramSessionInfo == null) || (paramazqk == null)) {}
    while ((paramazqk.jdField_a_of_type_ComTencentMobileqqDataPicMessageExtraData == null) || (paramazqk.jdField_a_of_type_ComTencentMobileqqDataPicMessageExtraData.imageBizType != 9)) {
      return;
    }
    String str = "";
    if ((paramazqk.jdField_a_of_type_Azqf != null) || (paramazqk.jdField_a_of_type_Azqf.a != null) || (paramazqk.jdField_a_of_type_Azqf.a.f != null)) {
      str = paramazqk.jdField_a_of_type_Azqf.a.f;
    }
    if (QLog.isColorLevel()) {
      QLog.d("AdEmoReportUtil", 2, "reportForwardSingleAdEmo ");
    }
    a(paramQQAppInterface, paramSessionInfo.jdField_a_of_type_JavaLangString, "0X800B128", "0X800B128", 1, "", str, "");
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, MessageForPic paramMessageForPic)
  {
    ...
    while (bhjz.a().a(paramMessageForPic, "0X800B126")) {
      return;
    }
    bhjz.a().a(paramMessageForPic, "0X800B126");
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt, String paramString4, String paramString5, String paramString6)
  {
    ...
    for (String str = paramQQAppInterface.getCurrentAccountUin();; str = "")
    {
      ...
      bdll.b(paramQQAppInterface, "dc00898", "", paramString1, paramString2, paramString3, paramInt, 0, paramString4, "", paramString5, paramString6);
      return;
    }
  }
