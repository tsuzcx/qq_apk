  ...
  implements Animation.AnimationListener
{
  ...
  public mkj(VideoControlUI paramVideoControlUI, int paramInt)
  {
  ...
  public void onAnimationEnd(Animation paramAnimation)
  {
    ...
    if (!this.jdField_a_of_type_ComTencentAvUiVideoControlUI.h)
    {
      ...
      mbb.b(this.jdField_a_of_type_ComTencentAvUiVideoControlUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface, true);
