...
public class mkj
  extends mbr
{
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mkk(this);
  Intent jdField_a_of_type_AndroidContentIntent;
  public VideoController a;
  lfb jdField_a_of_type_Lfb = new mkm(this);
  lgg jdField_a_of_type_Lgg = new mkl(this);
  ...
  public mkj(VideoController paramVideoController, VideoAppInterface paramVideoAppInterface, Intent paramIntent)
  {
  ...
  private boolean a(int paramInt)
  {
    ...
    {
      axqy.b(null, "dc00899", "Grp_video", "", "invite", (String)localObject, 0, 0, String.valueOf(this.jdField_a_of_type_ComTencentAvVideoController.a().g), this.jdField_d_of_type_Int + "", "", "");
      bool1 = true;
      return bool1;
    }
  }
  ...
  public int a(long paramLong, Intent paramIntent)
  {
    ...
    if (mqo.b(this.jdField_b_of_type_Int))
    {
      ...
      paramIntent = lcx.a(this.jdField_c_of_type_Int, String.valueOf(this.jdField_a_of_type_Long), new int[0]);
      if (lcx.a().a(paramIntent))
      {
        this.jdField_a_of_type_Lga = lcx.a().b(paramIntent);
        return 2;
      }
      this.jdField_a_of_type_Lga = lcx.a().a();
      return 2;
    }
    ...
    {
      paramIntent = lcx.a(100, this.jdField_c_of_type_JavaLangString, new int[0]);
      if (QLog.isColorLevel()) {
        QLog.d("VideoInviteFloatBarUICtr", 2, "sessionId : " + paramIntent);
      }
      this.jdField_a_of_type_Lga = lcx.a().b(paramIntent);
      this.jdField_a_of_type_Lga.a(paramLong, "onStartCommand.1", 4);
      this.jdField_a_of_type_Lga.I = true;
      this.jdField_a_of_type_Lga.an = true;
      this.jdField_a_of_type_Lga.e = true;
      this.jdField_a_of_type_Lga.L = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(this.jdField_c_of_type_JavaLangString);
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(this.jdField_a_of_type_Lfb);
      return 2;
      if (QLog.isColorLevel()) {
    ...
    paramIntent = lcx.a(3, this.jdField_c_of_type_JavaLangString, new int[0]);
    this.jdField_a_of_type_Lga = lcx.a().b(paramIntent);
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Lga.a(paramLong, "onStartCommand.2", 1);
      this.jdField_a_of_type_Lga.a(paramLong, false);
    }
    for (;;)
    {
      this.jdField_a_of_type_Lga.e = true;
      ...
      return 2;
      this.jdField_a_of_type_Lga.a(paramLong, "onStartCommand.3", 2);
      paramIntent = this.jdField_a_of_type_Lga;
  ...
  public void a(long paramLong)
  {
    ...
    int i = 1;
    if (!this.jdField_a_of_type_Lga.L) {
      i = 4;
    }
    if (1008 == this.jdField_a_of_type_Lga.i) {
      i = 4;
    }
    for (;;)
    {
      if (this.jdField_c_of_type_Boolean) {
        this.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, 3, Long.valueOf(this.jdField_a_of_type_Lga.jdField_d_of_type_JavaLangString).longValue(), null, false);
      }
      for (;;)
      {
        if (this.jdField_a_of_type_Mki != null) {
          this.jdField_a_of_type_Mki.c(ajya.a(2131716294));
        }
        if (!this.jdField_a_of_type_Lga.Q) {
          break;
        }
        axqy.b(null, "CliOper", "", "", "0X8008B24", "0X8008B24", 0, 0, "", "", "", "");
        return;
        this.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, this.jdField_a_of_type_Lga.jdField_d_of_type_JavaLangString, j, i);
      }
      axqy.b(null, "CliOper", "", "", "0X8008B27", "0X8008B27", 0, 0, "", "", "", "");
      return;
    }
  }
  ...
  protected boolean a()
  {
    if (this.jdField_a_of_type_Muh == null) {
      this.jdField_a_of_type_Muh = new muh(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().getApplicationContext(), 1, "video wifi lock");
    }
    if ((msf.e(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().getApplicationContext())) && (this.jdField_a_of_type_Muh != null)) {
  ...
  public void b(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Lga.Q) {
      axqy.b(null, "CliOper", "", "", "0X8008B25", "0X8008B25", 0, 0, "", "", "", "");
    }
    while (this.jdField_c_of_type_Boolean)
    {
      ...
      a();
      return;
      axqy.b(null, "CliOper", "", "", "0X8008B28", "0X8008B28", 0, 0, "", "", "", "");
    }
  ...
  public void c(long paramLong)
  {
    ...
    axqy.b(null, "CliOper", "", "", "0X8008B2C", "0X8008B2C", 0, 0, "", "", "", "");
    if (!a(0)) {
  ...
  public void d(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Mki != null) {
      this.jdField_a_of_type_Mki.c(ajya.a(2131716295));
    }
    this.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, this.jdField_c_of_type_Int, this.jdField_a_of_type_Lga.g, this.jdField_a_of_type_ArrayOfLong, false);
    axqy.b(null, "CliOper", "", "", "0X8008B2B", "0X8008B2B", 0, 0, "", "", "", "");
    b();
  }
}
