...
public final class bmea
{
  private static Intent a(Activity paramActivity, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        if (paramIntent.getBooleanExtra("is_from_qreader_shortcut", false)) {
          ...
          {
            bmgm.e("QRJumpAction", localNumberFormatException.toString());
          }
        } else {
          i = -1;
        }
    ...
    paramActivity.putExtras(paramIntent);
    return paramActivity;
    paramIntent.putExtra("url", bmgo.b(a(paramIntent.getStringExtra("url"))));
    paramIntent.putExtra("item_type", 2);
    paramActivity = new Intent(paramActivity, ReaderContentPageActivity.class);
  ...
  public static Intent a(Activity paramActivity, Intent paramIntent, String paramString)
  {
    ...
    {
      bmgm.e("QRJumpAction", "jumpAction args error");
      return new Intent();
    }
  ...
  public static void a(Context paramContext, Intent paramIntent, String paramString, blwe paramblwe)
  {
    if ((paramContext == null) || (paramIntent == null) || (TextUtils.isEmpty(paramString)))
    {
      bmgm.a("QRJumpAction", "jumpToPlugin args error");
      return;
    }
    String str = BaseApplicationImpl.getApplication().getRuntime().getAccount();
    blwh localblwh = new blwh(1);
    localblwh.b = "qqreaderplugin.apk";
    localblwh.d = anvx.a(2131710658);
    localblwh.jdField_a_of_type_JavaLangString = str;
    localblwh.e = paramString;
    localblwh.jdField_a_of_type_JavaLangClass = QRPluginProxyActivity.a(paramString);
    paramIntent.putExtra("userQqResources", 2);
    localblwh.jdField_a_of_type_AndroidContentIntent = paramIntent;
    paramIntent = blpy.a(1);
    if (paramIntent != null)
    {
      paramIntent.a();
      localblwh.jdField_a_of_type_Avlg = paramIntent.jdField_a_of_type_Avlg;
    }
    try
    {
      blvy.a(paramContext, localblwh, paramblwe);
      return;
    }
    catch (Exception paramContext)
    {
      bmgm.a("QRJumpAction", "[jumpToPlugin] error!", paramContext);
    }
  }
}
