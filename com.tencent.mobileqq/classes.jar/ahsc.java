...
public class ahsc
  extends ahyw
  implements aglt, View.OnClickListener, View.OnLongClickListener, aroi
{
  private static final ahsh jdField_a_of_type_Ahsh = new ahsh(null);
  private final int jdField_a_of_type_Int;
  ahsk jdField_a_of_type_Ahsk = null;
  ...
  private final View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new ahse(this);
  ...
  public ahsc(Context paramContext, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView, View.OnClickListener paramOnClickListener, boolean paramBoolean)
  {
    ...
    paramExpandableListView.post(new SelectMemberBuddyListAdapter.1(this));
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      if (this.jdField_a_of_type_Ahsk == null) {
        this.jdField_a_of_type_Ahsk = new ahsk(this, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      paramViewGroup.jdField_a_of_type_JavaLangString = ((TroopMemberInfo)localObject2).memberuin;
      localObject1 = babh.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((TroopMemberInfo)localObject2).troopuin, ((TroopMemberInfo)localObject2).memberuin);
      a(paramViewGroup, this.jdField_a_of_type_Ahsk.a((TroopMemberInfo)localObject2));
      label234:
    ...
    for (;;)
    {
      if ((AppSetting.c) && (paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        ...
        paramView.setContentDescription((String)localObject1 + ajjy.a(2131647958));
      }
      return paramView;
      ...
      localObject1 = babh.a((Friends)localObject2);
    ...
    label502:
    paramView.setContentDescription((String)localObject1 + ajjy.a(2131647935));
    return paramView;
  }
  
  private void a(List<ahsf> paramList)
  {
    try
    {
      Collections.sort(paramList, jdField_a_of_type_Ahsh);
      return;
    }
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      if ((AppSetting.c) && (paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        ...
        paramView.setContentDescription(localPhoneContact.name + ajjy.a(2131647950));
      }
      return paramView;
      paramViewGroup = (ahsj)paramView.getTag();
      paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
  ...
  private View c(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (PublicAccountInfo.isLooker(localPublicAccountInfo))
      {
        ...
        return paramView;
        paramViewGroup = (ahsi)paramView.getTag();
        paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
      }
      else
      {
  ...
  private void c()
  {
    ...
    for (;;)
    {
      Object localObject2 = agln.a(this, bool, 0, 0);
      Object localObject3 = ((HashMap)localObject2).get(agln.jdField_a_of_type_JavaLangString);
      Object localObject1 = null;
      if (localObject3 != null) {
        localObject1 = (ArrayList)localObject3;
      }
      localObject2 = ((HashMap)localObject2).get(agln.b);
      ...
      if (localObject1 != null)
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if (localObject4 != null) {
            try
            {
              ...
              {
                localObject4 = ((ajjj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(((PfaFriend)localObject4).uin);
        ...
        if (!((ArrayList)localObject2).isEmpty())
        {
          ...
          ((Groups)localObject1).group_name = this.jdField_a_of_type_AndroidContentContext.getString(2131627126);
  ...
  private void f()
  {
    ...
    ((Groups)localObject).group_name = this.jdField_a_of_type_AndroidContentContext.getString(2131629351);
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_Ayky.a(this.jdField_b_of_type_JavaUtilArrayList, this.jdField_a_of_type_AndroidUtilSparseArray);
      ...
      if (((Iterator)localObject3).hasNext())
      {
        ...
        for (localObject2 = new ArrayList();; localObject2 = new ArrayList((Collection)localObject2))
        {
          ...
          while (((Iterator)localObject5).hasNext()) {
            ((ArrayList)localObject4).add(new ahsf((Friends)((Iterator)localObject5).next(), -1));
          }
          d();
          break;
        ...
        while (((Iterator)localObject4).hasNext()) {
          ((List)localObject2).add(((ahsf)((Iterator)localObject4).next()).a);
        }
  ...
  {
    ahsg localahsg = (ahsg)paramView.getTag();
    if (localahsg == null)
    {
      localahsg = new ahsg();
      paramView.findViewById(2131302936).setVisibility(0);
      localahsg.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131301599));
      paramView.setTag(localahsg);
    }
    for (;;)
    {
      Groups localGroups = (Groups)getGroup(paramInt);
      localahsg.jdField_a_of_type_AndroidWidgetTextView.setText(localGroups.group_name);
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.jdField_d_of_type_Int == 33) {
      agln.a(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.app);
    }
    if (this.jdField_a_of_type_Ahsk != null)
    {
      this.jdField_a_of_type_Ahsk.a();
      this.jdField_a_of_type_Ahsk = null;
    }
    super.b();
  }
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      else if (a(paramInt1, paramInt2) == 2)
      {
        ...
        paramView = this.jdField_a_of_type_Ayky.b(paramInt1, paramInt2, paramView, paramViewGroup, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity, this.jdField_a_of_type_AndroidViewView$OnClickListener, localRelationTroopEntity);
      }
      else
      {
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      localObject = (ahsg)paramView.getTag();
      ...
      if (AppSetting.c)
      {
        ...
        paramViewGroup.setContentDescription(((Groups)localObject).group_name + ajjy.a(2131647954));
      }
    }
    for (;;)
    {
      ...
      break;
      label153:
      paramViewGroup.setContentDescription(((Groups)localObject).group_name + ajjy.a(2131647945));
    }
  }
  ...
  {
    paramView = (ahsg)paramView.getTag();
    ...
    try
    {
      ...
      if (paramView.group_id == 1003)
      {
        ...
        {
          awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005442", "0X8005442", 1, 0, "", "", "", "");
          return;
        }
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005442", "0X8005442", 2, 0, "", "", "", "");
        return;
      }
      if (paramView.group_id == 1002)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.jdField_b_of_type_Int == 0)
        {
          awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005444", "0X8005444", 1, 0, "", "", "", "");
          return;
        }
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005444", "0X8005444", 2, 0, "", "", "", "");
        return;
      }
      if (paramView.group_id == 0)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.jdField_b_of_type_Int == 0)
        {
          awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005443", "0X8005443", 1, 0, "", "", "", "");
          return;
        }
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005443", "0X8005443", 2, 0, "", "", "", "");
        return;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.jdField_b_of_type_Int == 0)
      {
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005445", "0X8005445", 1, 0, "", "", "", "");
        return;
      }
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005445", "0X8005445", 2, 0, "", "", "", "");
      return;
    }
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    baay.a(paramView, localbakh, this.jdField_b_of_type_AndroidViewView$OnClickListener, new ahsd(this));
    return true;
  }
