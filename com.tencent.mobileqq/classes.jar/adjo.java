...
public class adjo
  extends MqqHandler
{
  public adjo(AssociatedAccountManageActivity paramAssociatedAccountManageActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (AssociatedAccountManageActivity.a(this.a) == null) {
        AssociatedAccountManageActivity.a(this.a, new bisl(this.a, this.a.getTitleBarHeight()));
      }
