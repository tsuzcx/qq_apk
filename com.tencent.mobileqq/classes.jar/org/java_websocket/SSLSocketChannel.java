  ...
  implements ByteChannel, WrappedByteChannel
{
  ...
  public int write(ByteBuffer paramByteBuffer)
  {
    ...
    //   5: istore_3
    //   6: aload_1
    //   7: invokevirtual 157	java/nio/ByteBuffer:hasRemaining	()Z
    //   10: ifeq +172 -> 182
    //   13: aload_0
    //   14: getfield 71	org/java_websocket/SSLSocketChannel:myNetData	Ljava/nio/ByteBuffer;
    //   17: invokevirtual 120	java/nio/ByteBuffer:clear	()Ljava/nio/Buffer;
    //   20: pop
    //   21: aload_0
    ...
    //   30: invokevirtual 207	javax/net/ssl/SSLEngine:wrap	(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)Ljavax/net/ssl/SSLEngineResult;
    //   33: astore 4
    //   35: getstatic 190	org/java_websocket/SSLSocketChannel$1:$SwitchMap$javax$net$ssl$SSLEngineResult$Status	[I
    //   38: aload 4
    //   40: invokevirtual 194	javax/net/ssl/SSLEngineResult:getStatus	()Ljavax/net/ssl/SSLEngineResult$Status;
    //   43: invokevirtual 197	javax/net/ssl/SSLEngineResult$Status:ordinal	()I
    //   46: iaload
    ...
    //   92: aload 4
    //   94: invokevirtual 194	javax/net/ssl/SSLEngineResult:getStatus	()Ljavax/net/ssl/SSLEngineResult$Status;
    //   97: invokevirtual 149	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   100: invokevirtual 153	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   103: invokespecial 154	java/lang/IllegalStateException:<init>	(Ljava/lang/String;)V
    //   106: athrow
    //   107: astore_1
    //   108: aload_0
    //   109: monitorexit
    ...
    //   116: invokevirtual 176	java/nio/ByteBuffer:flip	()Ljava/nio/Buffer;
    //   119: pop
    //   120: iload_2
    //   121: istore_3
    //   122: iload_3
    ...
    //   128: invokevirtual 157	java/nio/ByteBuffer:hasRemaining	()Z
    //   131: ifeq -127 -> 4
    //   134: iload_3
    //   135: aload_0
    ...
    //   143: invokevirtual 161	java/nio/channels/SocketChannel:write	(Ljava/nio/ByteBuffer;)I
    //   146: iadd
    //   147: istore_3
    //   148: goto -26 -> 122
    //   151: aload_0
    ...
    //   157: invokespecial 210	org/java_websocket/SSLSocketChannel:enlargePacketBuffer	(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    //   160: putfield 71	org/java_websocket/SSLSocketChannel:myNetData	Ljava/nio/ByteBuffer;
    //   163: goto -159 -> 4
    //   166: new 107	javax/net/ssl/SSLException
    //   169: dup
    //   170: ldc 212
    //   172: invokespecial 213	javax/net/ssl/SSLException:<init>	(Ljava/lang/String;)V
    //   175: athrow
    //   176: aload_0
    //   177: invokespecial 239	org/java_websocket/SSLSocketChannel:closeConnection	()V
    //   180: iconst_0
    //   181: istore_3
    //   182: aload_0
    //   183: monitorexit
