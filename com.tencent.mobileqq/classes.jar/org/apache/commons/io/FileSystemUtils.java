...
public class FileSystemUtils
{
  ...
  List<String> performCommand(String[] paramArrayOfString, int paramInt, long paramLong)
  {
    ...
    //   9: dup
    //   10: bipush 20
    //   12: invokespecial 292	java/util/ArrayList:<init>	(I)V
    //   15: astore 13
    //   17: lload_3
    //   18: invokestatic 298	org/apache/commons/io/ThreadMonitor:start	(J)Ljava/lang/Thread;
    //   21: astore 11
    //   23: aload_0
    //   24: aload_1
    //   25: invokevirtual 300	org/apache/commons/io/FileSystemUtils:openProcess	([Ljava/lang/String;)Ljava/lang/Process;
    //   28: astore 9
    //   30: aload 9
    //   32: invokevirtual 306	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   35: astore 8
    //   37: aload 9
    //   39: invokevirtual 310	java/lang/Process:getOutputStream	()Ljava/io/OutputStream;
    //   42: astore 7
    //   44: aload 9
    //   46: invokevirtual 313	java/lang/Process:getErrorStream	()Ljava/io/InputStream;
    //   49: astore 5
    //   51: new 315	java/io/BufferedReader
    //   54: dup
    //   55: new 317	java/io/InputStreamReader
    //   58: dup
    //   59: aload 8
    //   61: invokestatic 323	java/nio/charset/Charset:defaultCharset	()Ljava/nio/charset/Charset;
    //   64: invokespecial 326	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/nio/charset/Charset;)V
    //   67: invokespecial 329	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   70: astore 10
    //   72: aload 10
    //   74: invokevirtual 332	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   77: astore 6
    //   79: aload 6
    //   81: ifnull +43 -> 124
    //   84: aload 13
    ...
    //   105: invokevirtual 335	java/lang/String:trim	()Ljava/lang/String;
    //   108: invokeinterface 339 2 0
    //   113: pop
    //   114: aload 10
    //   116: invokevirtual 332	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   119: astore 6
    //   121: goto -42 -> 79
    //   124: aload 9
    //   126: invokevirtual 342	java/lang/Process:waitFor	()I
    //   129: pop
    //   130: aload 11
    //   132: invokestatic 346	org/apache/commons/io/ThreadMonitor:stop	(Ljava/lang/Thread;)V
    //   135: aload 9
    //   137: invokevirtual 349	java/lang/Process:exitValue	()I
    //   140: ifeq +134 -> 274
    ...
    //   160: aload 9
    //   162: invokevirtual 349	java/lang/Process:exitValue	()I
    //   165: invokevirtual 353	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   168: ldc_w 355
    //   171: invokevirtual 161	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   174: aload_1
    //   175: invokestatic 361	java/util/Arrays:asList	([Ljava/lang/Object;)Ljava/util/List;
    //   178: invokevirtual 190	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   181: invokevirtual 166	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   184: invokespecial 47	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   187: athrow
    //   188: astore 6
    //   190: new 42	java/io/IOException
    //   193: dup
    //   194: new 156	java/lang/StringBuilder
    //   197: dup
    //   198: invokespecial 157	java/lang/StringBuilder:<init>	()V
    //   201: ldc_w 363
    //   204: invokevirtual 161	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   207: aload_1
    //   208: invokestatic 361	java/util/Arrays:asList	([Ljava/lang/Object;)Ljava/util/List;
    //   211: invokevirtual 190	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   214: ldc_w 365
    //   217: invokevirtual 161	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   220: lload_3
    //   221: invokevirtual 368	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   224: invokevirtual 166	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   227: aload 6
    //   229: invokespecial 266	java/io/IOException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   232: athrow
    //   233: astore_1
    //   234: aload 5
    //   236: astore 6
    ...
    //   240: astore 5
    //   242: aload 8
    //   244: invokestatic 374	org/apache/commons/io/IOUtils:closeQuietly	(Ljava/io/InputStream;)V
    //   247: aload 7
    //   249: invokestatic 377	org/apache/commons/io/IOUtils:closeQuietly	(Ljava/io/OutputStream;)V
    //   252: aload 6
    //   254: invokestatic 374	org/apache/commons/io/IOUtils:closeQuietly	(Ljava/io/InputStream;)V
    //   257: aload 5
    //   259: invokestatic 379	org/apache/commons/io/IOUtils:closeQuietly	(Ljava/io/Reader;)V
    //   262: aload 9
    //   264: ifnull +8 -> 272
    //   267: aload 9
    //   269: invokevirtual 382	java/lang/Process:destroy	()V
    //   272: aload_1
    //   273: athrow
    //   274: aload 13
    //   276: invokeinterface 383 1 0
    //   281: ifeq +34 -> 315
    //   284: new 42	java/io/IOException
    //   287: dup
    //   288: new 156	java/lang/StringBuilder
    //   291: dup
    //   292: invokespecial 157	java/lang/StringBuilder:<init>	()V
    //   295: ldc_w 385
    //   298: invokevirtual 161	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   301: aload_1
    //   302: invokestatic 361	java/util/Arrays:asList	([Ljava/lang/Object;)Ljava/util/List;
    //   305: invokevirtual 190	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   308: invokevirtual 166	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   311: invokespecial 47	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   314: athrow
    //   315: aload 10
    //   317: invokevirtual 388	java/io/BufferedReader:close	()V
    //   320: aload 8
    //   322: invokevirtual 391	java/io/InputStream:close	()V
    //   325: aload 7
    //   327: astore 6
    //   329: aload 7
    //   331: ifnull +19 -> 350
    ...
    //   340: astore 11
    //   342: aload 7
    //   344: invokevirtual 394	java/io/OutputStream:close	()V
    //   347: aconst_null
    //   348: astore 6
    //   350: aload 5
    //   352: astore 7
    ...
    //   365: astore 11
    //   367: aload 5
    //   369: invokevirtual 391	java/io/InputStream:close	()V
    //   372: aconst_null
    //   373: astore 7
    //   375: aconst_null
    //   376: invokestatic 374	org/apache/commons/io/IOUtils:closeQuietly	(Ljava/io/InputStream;)V
    //   379: aload 6
    //   381: invokestatic 377	org/apache/commons/io/IOUtils:closeQuietly	(Ljava/io/OutputStream;)V
    //   384: aload 7
    //   386: invokestatic 374	org/apache/commons/io/IOUtils:closeQuietly	(Ljava/io/InputStream;)V
    //   389: aconst_null
    //   390: invokestatic 379	org/apache/commons/io/IOUtils:closeQuietly	(Ljava/io/Reader;)V
    //   393: aload 9
    //   395: ifnull +8 -> 403
    //   398: aload 9
    //   400: invokevirtual 382	java/lang/Process:destroy	()V
    //   403: aload 13
    //   405: areturn
    //   406: astore_1
    //   407: aconst_null
