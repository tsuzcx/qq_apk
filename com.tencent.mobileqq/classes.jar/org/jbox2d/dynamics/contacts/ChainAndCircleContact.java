  ...
  extends Contact
{
  ...
  public ChainAndCircleContact(IWorldPool paramIWorldPool)
  {
  ...
  public void evaluate(Manifold paramManifold, Transform paramTransform1, Transform paramTransform2)
  {
    ...
    this.pool.getCollision().collideEdgeAndCircle(paramManifold, this.edge, paramTransform1, (CircleShape)this.m_fixtureB.getShape(), paramTransform2);
  }
 ...
 * Qualified Name:     org.jbox2d.dynamics.contacts.ChainAndCircleContact
