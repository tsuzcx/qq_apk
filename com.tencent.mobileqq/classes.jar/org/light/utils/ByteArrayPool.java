...
public class ByteArrayPool
{
  ...
  public byte[] getBuf(int paramInt)
  {
    ...
    //   4: iload_2
    //   5: aload_0
    //   6: getfield 44	org/light/utils/ByteArrayPool:mBuffersBySize	Ljava/util/List;
    //   9: invokeinterface 72 1 0
    //   14: if_icmpge +67 -> 81
    //   17: aload_0
    //   18: getfield 44	org/light/utils/ByteArrayPool:mBuffersBySize	Ljava/util/List;
    //   21: iload_2
    ...
    //   37: aload_0
    //   38: aload_0
    //   39: getfield 46	org/light/utils/ByteArrayPool:mCurrentSize	I
    //   42: aload_3
    //   43: arraylength
    //   44: isub
    //   45: putfield 46	org/light/utils/ByteArrayPool:mCurrentSize	I
    //   48: aload_0
    //   49: getfield 44	org/light/utils/ByteArrayPool:mBuffersBySize	Ljava/util/List;
    //   52: iload_2
    //   53: invokeinterface 61 2 0
    //   58: pop
    //   59: aload_0
    //   60: getfield 39	org/light/utils/ByteArrayPool:mBuffersByLastUse	Ljava/util/List;
    //   63: aload_3
  ...
  public void returnBuf(byte[] paramArrayOfByte)
  {
    ...
    //   8: istore_2
    //   9: aload_0
    //   10: getfield 48	org/light/utils/ByteArrayPool:mSizeLimit	I
    //   13: istore_3
    //   14: iload_2
    //   15: iload_3
    //   16: if_icmple +6 -> 22
    ...
    //   21: return
    //   22: aload_0
    //   23: getfield 39	org/light/utils/ByteArrayPool:mBuffersByLastUse	Ljava/util/List;
    //   26: aload_1
    //   27: invokeinterface 80 2 0
    //   32: pop
    //   33: aload_0
    //   34: getfield 44	org/light/utils/ByteArrayPool:mBuffersBySize	Ljava/util/List;
    //   37: aload_1
    //   38: getstatic 32	org/light/utils/ByteArrayPool:BUF_COMPARATOR	Ljava/util/Comparator;
    ...
    //   55: istore_2
    //   56: aload_0
    //   57: getfield 44	org/light/utils/ByteArrayPool:mBuffersBySize	Ljava/util/List;
    //   60: iload_2
    //   61: aload_1
    //   62: invokeinterface 89 3 0
    //   67: aload_0
    //   68: aload_0
    //   69: getfield 46	org/light/utils/ByteArrayPool:mCurrentSize	I
    //   72: aload_1
    //   73: arraylength
    //   74: iadd
    //   75: putfield 46	org/light/utils/ByteArrayPool:mCurrentSize	I
    //   78: aload_0
    //   79: invokespecial 91	org/light/utils/ByteArrayPool:trim	()V
    //   82: goto -63 -> 19
    //   85: astore_1
    //   86: aload_0
    //   87: monitorexit
 ...
 * Qualified Name:     org.light.utils.ByteArrayPool
