...
public class AVReportCenter
{
  ...
  public void reportFirstFrameTime(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    LightSDKBean localLightSDKBean = new LightSDKBean(LightSDKReportEvent.PREVIEW_FIRST_FRAME.value);
    localLightSDKBean.ext_int1 = Integer.valueOf(paramInt1);
    localLightSDKBean.ext_int2 = Integer.valueOf(paramInt2);
    String str;
    if (paramBoolean) {
      str = "cold";
    } else {
    ...
    localLightSDKBean.ext_str1 = str;
    commit(localLightSDKBean, Boolean.valueOf(true));
  }
 ...
 * Qualified Name:     org.light.report.avreport.AVReportCenter
