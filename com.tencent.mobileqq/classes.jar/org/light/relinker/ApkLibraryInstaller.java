  ...
  implements ReLinker.LibraryInstaller
{
  ...
  public void installLibrary(Context paramContext, String[] paramArrayOfString, String paramString, File paramFile, ReLinkerInstance paramReLinkerInstance)
  {
    ...
    //   38: aload_3
    //   39: aastore
    //   40: invokevirtual 86	org/light/relinker/ReLinkerInstance:log	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   43: aload 4
    ...
    //   63: goto +312 -> 375
    //   66: aload 12
    //   68: getfield 144	org/light/relinker/ApkLibraryInstaller$ZipFileInZipEntry:zipFile	Ljava/util/zip/ZipFile;
    //   71: aload 12
    //   73: getfield 148	org/light/relinker/ApkLibraryInstaller$ZipFileInZipEntry:zipEntry	Ljava/util/zip/ZipEntry;
    ...
    //   91: aload_2
    //   92: aload_1
    //   93: invokespecial 159	org/light/relinker/ApkLibraryInstaller:copy	(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    //   96: lstore 8
    //   98: aload_1
    ...
    //   120: aload_0
    //   121: aload_2
    //   122: invokespecial 174	org/light/relinker/ApkLibraryInstaller:closeSilently	(Ljava/io/Closeable;)V
    //   125: aload_0
    //   126: aload_1
    //   127: invokespecial 174	org/light/relinker/ApkLibraryInstaller:closeSilently	(Ljava/io/Closeable;)V
    //   130: goto +245 -> 375
    //   133: aload_0
    //   134: aload_2
    //   135: invokespecial 174	org/light/relinker/ApkLibraryInstaller:closeSilently	(Ljava/io/Closeable;)V
    //   138: aload_0
    //   139: aload_1
    //   140: invokespecial 174	org/light/relinker/ApkLibraryInstaller:closeSilently	(Ljava/io/Closeable;)V
    //   143: aload 4
    //   145: iconst_1
    //   146: iconst_0
    ...
    //   168: ifnull +19 -> 187
    //   171: aload 12
    //   173: getfield 144	org/light/relinker/ApkLibraryInstaller$ZipFileInZipEntry:zipFile	Ljava/util/zip/ZipFile;
    //   176: ifnull +11 -> 187
    //   179: aload 12
    //   181: getfield 144	org/light/relinker/ApkLibraryInstaller$ZipFileInZipEntry:zipFile	Ljava/util/zip/ZipFile;
    ...
    //   221: aload_0
    //   222: aload_2
    //   223: invokespecial 174	org/light/relinker/ApkLibraryInstaller:closeSilently	(Ljava/io/Closeable;)V
    //   226: aload_0
    //   227: aload_3
    //   228: invokespecial 174	org/light/relinker/ApkLibraryInstaller:closeSilently	(Ljava/io/Closeable;)V
    //   231: aload_1
    //   232: athrow
    //   233: aload_0
    //   234: aload_2
    //   235: invokespecial 174	org/light/relinker/ApkLibraryInstaller:closeSilently	(Ljava/io/Closeable;)V
    //   238: goto -113 -> 125
    //   241: aload_0
    //   242: aload_2
    //   243: invokespecial 174	org/light/relinker/ApkLibraryInstaller:closeSilently	(Ljava/io/Closeable;)V
    //   246: goto -121 -> 125
    //   249: aload 5
    //   251: ldc 187
    //   253: invokevirtual 189	org/light/relinker/ReLinkerInstance:log	(Ljava/lang/String;)V
    //   256: aload 12
    //   258: ifnull +19 -> 277
    //   261: aload 12
    //   263: getfield 144	org/light/relinker/ApkLibraryInstaller$ZipFileInZipEntry:zipFile	Ljava/util/zip/ZipFile;
    //   266: ifnull +11 -> 277
    //   269: aload 12
    //   271: getfield 144	org/light/relinker/ApkLibraryInstaller$ZipFileInZipEntry:zipFile	Ljava/util/zip/ZipFile;
    //   274: invokevirtual 96	java/util/zip/ZipFile:close	()V
    //   277: return
    //   278: new 191	org/light/relinker/MissingLibraryException
    //   281: dup
    //   282: aload_3
    //   283: invokespecial 192	org/light/relinker/MissingLibraryException:<init>	(Ljava/lang/String;)V
    //   286: athrow
    //   287: astore_1
    //   288: aload 12
    //   290: astore_2
    ...
    //   298: ifnull +17 -> 315
    //   301: aload_2
    //   302: getfield 144	org/light/relinker/ApkLibraryInstaller$ZipFileInZipEntry:zipFile	Ljava/util/zip/ZipFile;
    //   305: ifnull +10 -> 315
    //   308: aload_2
    //   309: getfield 144	org/light/relinker/ApkLibraryInstaller$ZipFileInZipEntry:zipFile	Ljava/util/zip/ZipFile;
