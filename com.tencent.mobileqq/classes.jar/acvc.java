  ...
  implements FileWebView.TitilebarEventInterface
{
  ...
  public acvc(FilePreviewActivity paramFilePreviewActivity, Handler paramHandler) {}
  ...
  public void b()
  {
    ...
    if (!NetworkUtil.d(this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFilePreviewActivity.getActivity()))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFilePreviewActivity.c.setText(2131435117);
    ...
    new Handler().postDelayed(new acvd(this), 1500L);
  }
  ...
  public void d()
  {
    acve localacve = new acve(this);
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(localacve, 3000L);
    QLog.i("<FileAssistant>FilePreviewActivity", 1, "postDelayed(newRunnable, 3000)");
  }
  
  public void e()
  {
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFilePreviewActivity.runOnUiThread(new acvf(this));
  }
  
  public void f()
  {
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityFilePreviewActivity.runOnUiThread(new acvg(this));
  }
