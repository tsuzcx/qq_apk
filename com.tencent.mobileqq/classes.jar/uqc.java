  ...
  implements uqb
{
  ...
  public uqc(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, int paramInt, boolean paramBoolean)
  {
  ...
  {
    veg.a("Q.qqstory.detail.SpannableStringUtils", "on nick click. unionId = %s.", paramString);
    ...
    do
    {
      ...
      if (localObject != null) {
        sxp.a((Context)localObject, 12, paramString);
      }
    ...
    for (;;)
    {
      vel.a("home_page", (String)localObject, paramInt, 0, new String[] { paramString, vel.a(this.jdField_a_of_type_Int), "", this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId });
      return;
