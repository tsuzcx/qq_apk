...
public class maz
  extends ljf
{
  public maz(AVActivity paramAVActivity) {}
  ...
  protected void a(long paramLong, boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
      ...
      lhk.a().a(this.a.jdField_a_of_type_ComTencentAvCameraCameraUtils.a());
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    mqt.a("switch_camera", "onAfterSwitchCamera", 3, new Object[] { Long.valueOf(l) });
    QLog.w(this.a.b, 1, "onAfterSwitchCamera, success[" + paramBoolean + "], seq[" + l + "]");
    if (paramBoolean)
    {
      if (this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI != null) {
        this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI.b(2131373558, true);
      }
      if (this.a.jdField_a_of_type_ComTencentAvUiVideoLayerUI != null) {
  ...
  protected void b()
  {
    mqt.a("switch_camera", "onBeforeSwitchCamera", 3, new Object[0]);
    if (this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI != null) {
      this.a.jdField_a_of_type_ComTencentAvUiVideoControlUI.b(2131373558, false);
    }
  }
