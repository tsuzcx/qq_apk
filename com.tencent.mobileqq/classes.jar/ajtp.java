  ...
  extends ajtb
{
  ...
  public ajtp(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(Map<Integer, Integer> paramMap)
  {
    ...
    SharedPreferences.Editor localEditor = acur.a(this.a.getApplication().getApplicationContext(), this.a.getCurrentAccountUin(), 0).edit();
