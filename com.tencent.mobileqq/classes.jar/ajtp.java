...
public class ajtp
  extends Handler
{
  public ajtp(ChatHistoryTroopFileFragment paramChatHistoryTroopFileFragment) {}
    ...
    for (;;)
    {
      ...
      while (i <= ChatHistoryTroopFileFragment.a(this.a).getLastVisiblePosition())
      {
        ...
        if (paramMessage != null)
        {
          ...
          if ((paramMessage != null) && ((paramMessage instanceof bfmi))) {
            ((bfmi)paramMessage).a(this.a.a, ChatHistoryTroopFileFragment.a(this.a));
          }
        }
        i += 1;
      }
