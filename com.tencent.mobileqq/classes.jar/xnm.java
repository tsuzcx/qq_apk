  ...
  extends aykk
{
  ...
  public xnm(CharSequence paramCharSequence, int paramInt)
  {
  ...
  protected void a(View paramView, String paramString)
  {
    ...
    for (paramView = paramString.substring(i);; paramView = null)
    {
      ...
      localIntent.putExtra("big_brother_source_key", sgg.b(this.b));
      sgg.a(localIntent, paramString);
      localContext.startActivity(localIntent);
      axqy.b(null, "P_CliOper", "Pb_account_lifeservice", "", "aio_msg_url", "aio_url_clickqq", 0, 1, 0, str1, "", "", "");
      return;
    }
  }
}
