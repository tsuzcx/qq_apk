...
public class aoop
  extends acme
{
  public aoop(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private void a(MsgInfo paramMsgInfo)
  {
    ...
    for (;;)
    {
      ...
      if ((l == 20002L) || (l == 20009L) || (l == 20031L) || (l == 20019L))
      {
        ...
        if (this.a != null)
        {
          paramMsgInfo = (FriendListHandler)this.a.getBusinessHandler(BusinessHandlerFactory.FRIENDLIST_HANDLER);
          if (j != 0) {
