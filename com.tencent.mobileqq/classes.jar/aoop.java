...
public class aoop
  implements bcrc
{
  public aoop(LocalFileBrowserActivity paramLocalFileBrowserActivity) {}
  ...
  public void a(SlideDetectListView paramSlideDetectListView, View paramView, int paramInt)
  {
    ...
    {
      return;
      paramSlideDetectListView = paramView.findViewById(2131375996);
      paramView = (FileInfo)this.a.jdField_a_of_type_Aper.getItem(paramInt);
      this.a.jdField_a_of_type_Aper.a(paramView);
    } while (paramSlideDetectListView == null);
    paramView = (Button)paramSlideDetectListView.findViewById(2131364974);
  ...
  public void b(SlideDetectListView paramSlideDetectListView, View paramView, int paramInt)
  {
    ...
    if (paramSlideDetectListView != null)
    {
      ...
      paramSlideDetectListView = (Button)paramSlideDetectListView.findViewById(2131364974);
