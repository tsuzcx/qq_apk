  ...
  implements asot
{
  ...
  public asoz(Context paramContext)
  {
  ...
  {
    this.jdField_a_of_type_Asou = paramasou;
  }
  
  public void a(asov paramasov)
  {
    this.jdField_a_of_type_Asov = paramasov;
  }
  
  public void a(asow paramasow)
  {
    this.jdField_a_of_type_Asow = paramasow;
  }
  ...
  {
    this.jdField_a_of_type_Asoy = paramasoy;
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, long paramLong)
  {
    ...
    do
    {
      ...
      String str = shp.a(paramString1, 0);
      this.b = paramString2;
      this.c = paramString3;
      ...
      if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer == null)
      {
        ...
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnCompletionListener(new aspa(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnErrorListener(new aspb(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnInfoListener(new aspc(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnVideoPreparedListener(new aspd(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnDownloadCallback(new aspe(this, paramString2, paramString1, paramString3));
      }
      paramString1 = a(str, paramString2, paramLong);
      paramString1.setConfigMap("keep_last_frame", "true");
      if ((!TextUtils.isEmpty(paramString2)) && (shq.a(new File(paramString2))))
      {
    ...
    {
      Bosses.get().postJob(new aspf(this, "VideoViewTVKImpl", paramString3, paramString1));
      return;
    }
    this.c = axwx.b(this.c.replace("https://", "http://"), 1012);
