...
public class aiyh
{
  ...
  public aiyh(String paramString)
  {
    this.jdField_a_of_type_Aiyn = new ApolloGameInterfaceProxy(this, paramString);
  ...
  {
    if (aiyg.a(this.jdField_a_of_type_JavaLangString))
    {
      paramString2 = aiyg.b(paramString2);
      if (QLog.isColorLevel()) {
        QLog.d("ApolloJSContext", 1, "[notifyJSEVent] " + paramString1 + " " + paramString2);
      }
      a(String.format("if(window.__dispatchEvent){window.__dispatchEvent(%s,'%s','%s')}", new Object[] { Integer.valueOf(paramInt), paramString1, paramString2 }), new aiyi(this));
      return;
    }
  ...
  {
    if ((paramCustomWebView != null) && (this.jdField_a_of_type_Aiyn != null))
    {
      if (QLog.isColorLevel()) {
      ...
      {
        paramCustomWebView.addJavascriptInterface(this.jdField_a_of_type_Aiyn, "__browserMsg");
        return;
      }
  ...
  {
    if ((this.jdField_a_of_type_Aiyn != null) && ((this.jdField_a_of_type_Aiyn instanceof ApolloGameInterfaceProxy))) {
      ((ApolloGameInterfaceProxy)this.jdField_a_of_type_Aiyn).send(paramString2, paramString1);
    }
  }
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_Aiyn != null) && ((this.jdField_a_of_type_Aiyn instanceof ApolloGameInterfaceProxy))) {
      ((ApolloGameInterfaceProxy)this.jdField_a_of_type_Aiyn).h();
    }
  ...
  public void b(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Aiyn != null)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_Aiyn.a(this);
        return;
        label36:
        d();
      }
