  ...
  extends Drawable
{
  ...
  public wbt(int paramInt1, int paramInt2)
  {
    this(null, paramInt1, paramInt2);
  }
  
  public wbt(Bitmap paramBitmap, int paramInt1, int paramInt2)
  {
    veg.c("Q.qqstory.record.StoryFaceDrawable", "StoryFaceDrawable.");
    this.jdField_a_of_type_Int = paramInt1;
    this.b = paramInt2;
    setBounds(0, 0, paramInt1, paramInt2);
    if (paramBitmap == null) {}
    for (this.jdField_a_of_type_AndroidGraphicsBitmap = bbdr.a();; this.jdField_a_of_type_AndroidGraphicsBitmap = paramBitmap)
    {
  ...
  {
    veg.c("Q.qqstory.record.StoryFaceDrawable", "StoryFaceDrawable draw start.");
    paramCanvas.drawBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_a_of_type_AndroidGraphicsMatrix, null);
    veg.c("Q.qqstory.record.StoryFaceDrawable", "StoryFaceDrawable draw end.");
  }
