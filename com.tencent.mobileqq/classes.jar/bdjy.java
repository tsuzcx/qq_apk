...
{
  public bdjy(MiniAppVideoPlayer paramMiniAppVideoPlayer) {}
  ...
  {
    bdnw.a("MiniAppVideoPlayer", "video player onBackClick");
  ...
  {
    bdnw.a("MiniAppVideoPlayer", "video player onBackOnFullScreenClick");
    if ((Activity)this.a.a.get() == null) {}
    while (!this.a.c) {
      return;
    }
