  ...
  extends AbstractDbCacheManager
{
  ...
  protected bdka a;
  protected String b;
  protected final ArrayList<WeakReference<bdjz>> b;
  protected String c;
  
  protected bdjy(Context paramContext, Class<? extends bdju> paramClass, long paramLong, String paramString)
  {
  ...
  public bdju a(int paramInt)
  {
    try
    {
      bdju localbdju = a(this.jdField_a_of_type_AndroidDatabaseCursor, paramInt);
      return localbdju;
    }
    finally {}
  }
  
  protected List<bdjz> a()
  {
    ...
    for (;;)
    {
      ...
      localObject2 = (bdjz)localObject1.get();
    }
    for (;;)
    {
      return localObject2;
  ...
  public void a(bdju parambdju, int paramInt)
  {
    try
    {
      a(paramInt, new bdju[] { parambdju });
      return;
    }
    finally {}
  }
  
  void a(bdka parambdka)
  {
    this.jdField_a_of_type_Bdka = parambdka;
  }
  
  public void a(bdju[] paramArrayOfbdju, int paramInt)
  {
    try
    {
      a(paramInt, paramArrayOfbdju);
      return;
    }
    finally {}
  }
  ...
  public void b()
  {
    ...
    if (localObject != null)
    {
      ...
      {
        bdjz localbdjz = (bdjz)((Iterator)localObject).next();
        if (localbdjz != null) {
          localbdjz.a(this);
        }
      }
  ...
  public void b(bdju parambdju, String paramString)
  {
    try
    {
      a(parambdju, paramString);
      return;
    }
    finally {}
  }
