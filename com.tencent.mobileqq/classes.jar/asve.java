...
public class asve
{
  static ArrayList<WeakReference<asve>> a;
  public static boolean a;
  public Context a;
  public ArrayMap<HotVideoData, asuq> a;
  boolean b = false;
  ...
  /* Error */
  public static asve a(Context paramContext)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: iconst_0
    //   4: invokestatic 37	asve:a	(Z)V
    //   7: aload_0
    //   8: ifnonnull +10 -> 18
    //   11: aconst_null
    //   12: astore_0
    ...
    //   21: dup
    //   22: aload_0
    //   23: invokespecial 39	asve:<init>	(Landroid/content/Context;)V
    //   26: astore_1
    //   27: aload_1
    //   28: astore_0
    //   29: getstatic 21	asve:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   32: invokevirtual 43	java/util/ArrayList:size	()I
    //   35: iconst_3
    //   36: if_icmpge -23 -> 13
    //   39: getstatic 21	asve:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
  ...
  public static void a(asve paramasve)
  {
    for (;;)
    {
      try
      {
        ...
        if (jdField_a_of_type_JavaUtilArrayList.size() < 3)
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if (localObject != null)
            {
              localObject = (asve)((WeakReference)localObject).get();
              if ((localObject != null) && (paramasve.equals(localObject)))
              {
                i = 1;
                if (i == 0) {
                  jdField_a_of_type_JavaUtilArrayList.add(new WeakReference(paramasve));
                }
              }
            }
          }
  ...
  public static void a(boolean paramBoolean)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        localasve = (asve)localWeakReference.get();
      }
      finally {}
      asve localasve;
      if (localasve == null) {
        localObject.add(localWeakReference);
      } else if ((paramBoolean) && (!localasve.b)) {
        localasve.a();
      }
    }
  }
  ...
  /* Error */
  public static void b(asve paramasve)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    ...
    //   13: monitorexit
    //   14: return
    //   15: getstatic 21	asve:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   62: ifeq -40 -> 22
    //   65: getstatic 21	asve:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   68: aload_2
  ...
  {
    if ((paramasuq == null) || (paramHotVideoData == null)) {
      return;
    }
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_AndroidSupportV4UtilArrayMap.containsKey(paramHotVideoData))
        {
          ...
          this.jdField_a_of_type_AndroidSupportV4UtilArrayMap.setValueAt(i, paramasuq);
          if (QLog.isColorLevel()) {
      ...
      this.jdField_a_of_type_AndroidSupportV4UtilArrayMap.put(paramHotVideoData, paramasuq);
    }
  }
