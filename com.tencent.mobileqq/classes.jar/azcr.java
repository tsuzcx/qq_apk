...
public class azcr
{
  ...
  public azcr(QQAppInterface paramQQAppInterface, MessageForShortVideo paramMessageForShortVideo, long paramLong1, long paramLong2)
  {
    this.jdField_a_of_type_Int = bgnt.a(BaseApplication.getContext());
    this.jdField_a_of_type_Boolean = bcen.a(paramQQAppInterface, paramMessageForShortVideo);
  ...
  public void a()
  {
    ...
    {
      bctj.a(BaseApplication.getContext()).a(null, "actVideoMessageTime", bool, 0L, 0L, (HashMap)localObject, "");
      return;
    }
  }
