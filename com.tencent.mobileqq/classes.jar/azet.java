...
public class azet
{
  ...
  public static Pair<Integer, Bitmap> a(String paramString1, String paramString2, azcs paramazcs, int paramInt)
  {
    localObject1 = null;
    k = 0;
    ...
    for (;;)
    {
      ...
      {
        Object localObject2;
        if ((paramazcs == null) || (paramazcs.b)) {
          break label519;
        }
        paramazcs.b = true;
        if ((paramInt == 1) && (paramazcs.c)) {
          break label519;
        }
        localObject1 = a(paramString1, paramString2, paramazcs, paramInt);
        paramazcs = (Bitmap)((Pair)localObject1).second;
        if (!QLog.isColorLevel()) {
          continue;
        }
      ...
      catch (Exception paramazcs)
      {
        ...
        QLog.d("Q.olympic", 2, "decodeBitmap Exception:" + paramazcs.toString() + ",filePath:" + paramString2);
        paramazcs = null;
        localObject1 = null;
        int i = 1;
        int j = 0;
      ...
      catch (Exception paramString1)
      {
        ...
        paramazcs = (azcs)localObject1;
        localObject1 = localObject3;
        continue;
      }
      paramString1 = new Pair(Integer.valueOf(paramInt), paramazcs);
      if (QLog.isColorLevel())
      {
        if (paramazcs != null) {
          continue;
