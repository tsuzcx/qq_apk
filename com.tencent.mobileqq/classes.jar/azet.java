...
public final class azet
{
  ...
  public azet(@NotNull String paramString, @NotNull List<String> paramList)
  {
  ...
  @NotNull
  public final azet a(@Nullable String paramString)
  {
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof azet))
      {
        paramObject = (azet)paramObject;
