  ...
  extends BaseBubbleBuilder
{
  ...
  public adbx(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo, paramAIOAnimationConatiner);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new adca(this);
  }
  ...
  public View a(int paramInt1, int paramInt2, ChatMessage paramChatMessage, View paramView, ViewGroup paramViewGroup, acmv paramacmv)
  {
    ...
    paramChatMessage = (RelativeLayout)paramViewGroup.findViewById(2131310768);
    "com.tencent.mobileqq".equals(this.jdField_a_of_type_AndroidContentContext.getPackageName());
    paramacmv = ((FlashChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(217)).a;
  ...
  public View a(ChatMessage paramChatMessage, acju paramacju, View paramView, BaseChatItemLayout paramBaseChatItemLayout, acmv paramacmv)
  {
    ...
    if (paramBaseChatItemLayout.arkContainer == null)
    {
      ...
      localadcd = (adcd)paramacju;
      paramacju = paramView;
      if (paramView == null)
      {
        paramacju = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131493172, null);
        paramView = paramacju.findViewById(2131297250);
        localObject = (ArkAppLoadLayout)paramacju.findViewById(2131303802);
        ...
        localadcd.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLoadLayout = ((ArkAppLoadLayout)localObject);
        localadcd.d = localadcd.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLoadLayout.findViewById(2131300686);
        localadcd.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localadcd.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLoadLayout.findViewById(2131300687));
        localadcd.c = localadcd.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLoadLayout.findViewById(2131303812);
        localadcd.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView = ((ArkAppView)paramacju.findViewById(2131297229));
        localadcd.jdField_a_of_type_ComTencentBizQqstoryViewWidgetAutoStartProgressBar = ((AutoStartProgressBar)paramacju.findViewById(2131310112));
        localadcd.jdField_a_of_type_ComTencentBizQqstoryViewWidgetAutoStartProgressBar.setRadius(15.0F, true);
        localadcd.jdField_a_of_type_ComTencentBizQqstoryViewWidgetAutoStartProgressBar.setShowCorner(false);
        localadcd.jdField_a_of_type_ComTencentBizQqstoryViewWidgetAutoStartProgressBar.setDrawStatus(0);
        paramView = (RelativeLayout.LayoutParams)localadcd.jdField_a_of_type_ComTencentBizQqstoryViewWidgetAutoStartProgressBar.getLayoutParams();
        paramView.width = ((int)FlashChatPanel.a());
        paramView.height = ((int)FlashChatPanel.b());
        paramView.leftMargin = 0;
        localadcd.jdField_a_of_type_ComTencentBizQqstoryViewWidgetAutoStartProgressBar.setLayoutParams(paramView);
      }
      paramChatMessage.isSend();
      paramView = localadcd.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView;
      ...
      paramChatMessage = localadcd.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLoadLayout;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localadcd.jdField_a_of_type_AndroidViewView = paramacju;
        localadcd.d.setVisibility(8);
        localadcd.c.setVisibility(0);
        localadcd.jdField_a_of_type_ComTencentBizQqstoryViewWidgetAutoStartProgressBar.setVisibility(8);
        localadcd.jdField_a_of_type_ComTencentBizQqstoryViewWidgetAutoStartProgressBar.b();
        localadcd.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLoadLayout.setBkgColorNormal(ArkAppLoadLayout.b);
        ...
        bool = true;
        break label562;
        paramView.setCallback(new adbz(this, paramBaseChatItemLayout));
      }
    }
  }
  ...
  public String a(ChatMessage paramChatMessage)
  {
    ...
    {
      paramChatMessage = (MessageForArkFlashChat)paramChatMessage;
      return ajjy.a(2131634886) + paramChatMessage.ark_app_message.promptText;
    }
    return ajjy.a(2131634885) + paramChatMessage.msg;
  }
  ...
  {
    super.a(paramView);
    paramView = (MessageForArkFlashChat)aciy.a(paramView);
    if (paramView == null) {}
    String str1;
    String str2;
    do
    ...
    babr.a(this.jdField_a_of_type_AndroidContentContext, 230, str1, str2, new adcb(this, paramView), new adcc(this)).show();
  }
  
  public void a(View paramView, ChatMessage paramChatMessage)
  {
    int i = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131165220);
    if (paramChatMessage.isSend())
    {
  ...
  public boolean a(String paramString1, String paramString2, MessageForArkFlashChat paramMessageForArkFlashChat)
  {
    ...
    rtr.a(paramMessageForArkFlashChat, localIntent, paramString1);
  ...
  public boolean a(String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      if (paramString2.getPackageInfo(paramString1[0], 1) != null)
      {
        ...
        try
        {
          ((ajsi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(23)).b(paramString1[0].trim(), this.jdField_a_of_type_AndroidContentContext, paramString2);
          return true;
        }
  ...
  public bakj[] a(View paramView)
  {
    ...
    localbakh.a(2131299262, ajjy.a(2131634884), 2130838590);
    if (paramView != null)
    {
      ...
      if ((localMessageForArkFlashChat != null) && (localMessageForArkFlashChat.ark_app_message != null))
      {
        ...
        if ((localMessageForArkFlashChat.isSend()) && (localMessageForArkFlashChat.extraflag != 32768) && (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(localMessageForArkFlashChat))) {
          a(localbakh, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, localMessageForArkFlashChat);
        }
        a(localbakh, localMessageForArkFlashChat);
  ...
  protected void g(ChatMessage paramChatMessage)
  {
    ...
    bfhl.a(null, paramChatMessage.msg).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage).a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
  }
}
