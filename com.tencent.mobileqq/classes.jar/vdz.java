  ...
  implements SurfaceTexture.OnFrameAvailableListener
{
  ...
  public vdz(int paramInt1, int paramInt2)
  {
  ...
  private void e()
  {
    this.jdField_a_of_type_Vea = new vea();
    this.jdField_a_of_type_Vea.a();
    Log.d("CodecOutputSurface", "textureID=" + this.jdField_a_of_type_Vea.a());
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Vea.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Vea = null;
  ...
  {
    this.jdField_a_of_type_Vea.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Vea.a("before updateTexImage");
