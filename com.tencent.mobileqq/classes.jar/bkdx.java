  ...
  implements BluetoothProfile.ServiceListener
{
  ...
  public bkdx(TraeAudioManager paramTraeAudioManager)
  {
    super(paramTraeAudioManager);
    this.jdField_a_of_type_Bkeb = null;
  ...
  void a(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          else
          {
            ...
            this.jdField_a_of_type_Bkeb.a("DEVICE_BLUETOOTHHEADSET", true);
            localObject = this.jdField_a_of_type_Bkeb;
            if (paramIntent == null) {
              break label525;
            }
          }
          ...
          {
            ((bkeb)localObject).a(paramContext);
            return;
            paramContext = " ";
            break;
            paramContext = "null";
      ...
      if (QLog.isColorLevel()) {
        QLog.w("BluetoohHeadsetCheck", 2, "   EXTRA_SCO_AUDIO_STATE " + b(i) + "  Bluetooth visible:" + this.jdField_a_of_type_Bkeb.b("DEVICE_BLUETOOTHHEADSET"));
      }
    } while (!QLog.isColorLevel());
    label519:
    label525:
  ...
  public boolean a(Context paramContext, bkeb parambkeb)
  {
    ...
    if ((paramContext == null) || (parambkeb == null)) {
      if (QLog.isColorLevel()) {
