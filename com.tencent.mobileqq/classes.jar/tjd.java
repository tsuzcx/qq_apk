...
public class tjd
{
  ...
  public static void a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, FastWebActivity paramFastWebActivity, JSONObject paramJSONObject, List<BaseData> paramList, ArrayList<String> paramArrayList)
  {
    ...
    try
    {
      ...
      bfxp.a(paramFastWebActivity, paramArrayList.indexOf(a(paramJSONObject)), paramArrayList, null, null, false, true, "4", 1000, null, null, null, null, "", true, "1", (HashMap)new pti().e(paramArticleInfo.innerUniqueID).a(Long.valueOf(paramArticleInfo.mChannelID)).a("ref_channel", Long.valueOf(paramArticleInfo.mChannelID)).b(Integer.valueOf(paramArticleInfo.dtReportContentType)).a());
    }
    ...
    {
      tkj.a(paramArticleInfo, "0X8008996", pqf.a(paramFastWebActivity, paramArticleInfo, 0, paramFastWebArticleInfo).toString());
      return;
    }
  }
  ...
  public static boolean a(JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      try
      {
        i = tjg.a(BaseApplicationImpl.getContext());
