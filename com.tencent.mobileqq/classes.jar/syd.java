  ...
  implements sxs
{
  ...
  public syd(XListView paramXListView, List<BaseData> paramList, sxp paramsxp)
  {
  ...
  private sxp a()
  {
    if ((this.jdField_a_of_type_ComTencentWidgetXListView.getAdapter() instanceof bkky))
    {
      bkky localbkky = (bkky)this.jdField_a_of_type_ComTencentWidgetXListView.getAdapter();
      if ((localbkky.getWrappedAdapter() instanceof sxp)) {
        return (sxp)localbkky.getWrappedAdapter();
      }
    }
    return null;
  }
  ...
  private boolean a(int paramInt)
  {
    ...
    {
      afur.a("ItemHeightHelper", "", new IllegalArgumentException(" data == null index: " + paramInt + "   itemArrayList.size() :" + this.jdField_a_of_type_JavaUtilList.size()));
      return true;
    }
    return false;
  }
  ...
  private int b(int paramInt)
  {
    ...
    try
    {
      localObject = ((sxp)localObject).a(paramInt, null, this.jdField_a_of_type_ComTencentWidgetXListView, true);
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    paramView.getViewTreeObserver().addOnGlobalLayoutListener(new sye(this, paramInt, paramView));
  }
}
