...
public class affl
{
  ...
  private affn jdField_a_of_type_Affn;
  ajxl jdField_a_of_type_Ajxl = new affm(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = affl.class.getName();
  }
  
  public affl(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_c_of_type_JavaLangString = bbfj.a(paramQQAppInterface.getApplication());
  }
  ...
  {
    this.jdField_a_of_type_Affn = paramaffn;
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Affn = null;
    this.jdField_a_of_type_Int = 0;
    b();
