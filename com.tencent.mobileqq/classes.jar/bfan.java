  ...
  extends bfae
{
  ...
  private void a(int paramInt, bfbf parambfbf, MultiMsg.ReqBody paramReqBody)
  {
    ...
    localMultiMsgApplyDownReq.bytes_msg_resid.set(ByteStringMicro.copyFrom(parambfbf.jdField_a_of_type_ArrayOfByte));
    localMultiMsgApplyDownReq.uint32_msg_type.set(bfao.b(parambfbf.f));
    localMultiMsgApplyDownReq.uint64_src_uin.set(Long.valueOf(parambfbf.c).longValue());
    try
    {
      localMultiMsgApplyDownReq.bytes_msg_key.set(ByteStringMicro.copyFrom(berh.b()));
      localMultiMsgApplyDownReq.bytes_msg_sig.set(ByteStringMicro.copyFrom(berh.c()));
      List localList = berh.a(false);
      ...
      if (localList.size() > 0)
      {
        ...
        for (;;)
        {
          ...
          if (localObject2 != null)
          {
            ...
            localIpv4Info.uint32_ip_v4_addr.set(axjn.a(((ExcitingTransferHostInfo)localObject2).mstrIp));
            if (QLog.isDevelopLevel()) {
    ...
    catch (Exception localException)
    {
      ...
      label312:
      Object localObject1 = berh.a(true);
      if (QLog.isDevelopLevel()) {
  ...
  public void a(bevy parambevy, bevx parambevx)
  {
    ...
    try
    {
      localObject1 = (bfbs)localbfbj.jdField_a_of_type_JavaUtilList.get(i);
      try
      {
    ...
    for (;;)
    {
      ...
      break;
      label372:
      parambevy = ((MultiMsg.MultiMsgApplyDownRsp)localObject2).bytes_thumb_down_para.get();
      if (parambevy == null) {}
      for (parambevy = null; (parambevy == null) || (parambevy.equals("")); parambevy = parambevy.toStringUtf8()) {
      ...
      ((bfbs)localObject1).jdField_a_of_type_Int = j;
      ((bfbs)localObject1).jdField_a_of_type_JavaLangString = parambevy;
      ((bfbs)localObject1).jdField_a_of_type_ArrayOfByte = ((byte[])localObject3);
      ((bfbs)localObject1).jdField_b_of_type_ArrayOfByte = ((byte[])localObject4);
      parambevy = ((MultiMsg.MultiMsgApplyDownRsp)localObject2).rpt_uint32_down_ip.get();
      ...
      {
        j = 0;
        while (j < parambevy.size())
        {
          long l1 = ((Integer)parambevy.get(j)).intValue();
          ...
          ((bfbs)localObject1).jdField_a_of_type_JavaUtilArrayList.add(j, localObject4);
          j += 1;
        }
      }
      parambevy = ((MultiMsg.MultiMsgApplyDownRsp)localObject2).rpt_bytes_down_ip_v6.get();
      ...
      if ((parambevy != null) && (parambevy.size() > 0))
      {
        ...
        while (j < parambevy.size())
        {
          ...
          ((bewy)localObject3).jdField_a_of_type_JavaLangString = Inet6Address.getByAddress(((ByteStringMicro)parambevy.get(j)).toByteArray()).getHostAddress();
          ((bewy)localObject3).jdField_a_of_type_Int = ((int)((Integer)((List)localObject2).get(j)).intValue());
          ((bewy)localObject3).jdField_a_of_type_Boolean = true;
          ((bfbs)localObject1).jdField_b_of_type_JavaUtilArrayList.add(j, localObject3);
          j += 1;
        }
      }
      ...
      label899:
      if (j == 196) {
        bdll.b(null, "CliOper", "", "", "0X8006627", "0X8006627", 0, 1, 0, "", "", "", "");
      }
      if (bfak.a(j))
      {
        this.b += 1;
  ...
  public void a(bfau parambfau)
  {
    if ((parambfau != null) && (parambfau.jdField_a_of_type_JavaUtilList != null) && (parambfau.jdField_a_of_type_ComTencentMobileqqTransfileProtoReqManager != null))
    {
      ...
      localbevx.jdField_a_of_type_JavaLangString = "MultiMsg.ApplyDown";
  ...
  void b(bfau parambfau)
  {
    ...
    {
      bfbs localbfbs = new bfbs();
      localbfbj.jdField_a_of_type_JavaUtilList.add(i, localbfbs);
      i += 1;
    }
  }
}
