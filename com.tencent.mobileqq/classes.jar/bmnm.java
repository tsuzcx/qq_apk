  ...
  implements bmfh
{
  ...
  private void a(bmnn parambmnn)
  {
    int i = 0;
    if (TextUtils.isEmpty(parambmnn.jdField_a_of_type_JavaLangString)) {
      return;
    }
    if (TextUtils.isEmpty(parambmnn.jdField_a_of_type_JavaLangString)) {
      i = 101;
    ...
    while (i != 0)
    {
      ...
      try
      {
        ...
        localJSONObject2.put("id", parambmnn.jdField_a_of_type_Int);
        localJSONObject2.put("url", "");
        localJSONObject1.put("data", localJSONObject2);
        localJSONObject1.put("msg", "");
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.callJs(parambmnn.c, new String[] { localJSONObject1.toString() });
        return;
      }
      catch (JSONException parambmnn)
      {
        QLog.w("js-upload: QzoneUploadPlugin", 1, "JSONException error !", parambmnn);
        return;
        parambmnn.d = bmnl.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), parambmnn.jdField_a_of_type_JavaLangString);
        if ((!TextUtils.isEmpty(parambmnn.d)) && (new File(parambmnn.d).exists()))
        {
          this.jdField_a_of_type_JavaUtilMap.put(parambmnn.d, Integer.valueOf(parambmnn.jdField_a_of_type_Int));
          if (!bmnl.a(parambmnn.d, parambmnn.b)) {
            i = 102;
          }
        }
        else
      ...
      catch (Exception parambmnn)
      {
        QLog.w("js-upload: QzoneUploadPlugin", 1, "parentPlugin.callJs error !", parambmnn);
      }
    }
  }
  ...
  protected void a(String... paramVarArgs)
  {
    ...
    //   30: invokespecial 202	bmnn:<init>	(Lbmnm;I)V
    //   33: astore_1
    //   34: aload_1
    //   35: aload_2
    //   36: ldc 204
    //   38: invokevirtual 188	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   41: putfield 42	bmnn:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   44: aload_1
    //   45: aload_2
    //   46: ldc 206
    //   48: invokevirtual 188	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   51: putfield 156	bmnn:b	Ljava/lang/String;
    //   54: aload_1
    //   55: aload_2
    //   56: ldc 184
    //   58: invokevirtual 188	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   61: putfield 103	bmnn:c	Ljava/lang/String;
    //   64: aload_1
    //   65: ifnull +26 -> 91
    //   68: aload_0
    //   69: getfield 31	bmnm:jdField_b_of_type_JavaUtilMap	Ljava/util/Map;
    //   72: aload_1
    //   73: getfield 86	bmnn:jdField_a_of_type_Int	I
    ...
    //   86: aload_0
    //   87: aload_1
    //   88: invokespecial 208	bmnm:a	(Lbmnn;)V
    //   91: return
    //   92: astore_2
    //   93: aconst_null
    //   94: astore_1
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    paramBundle = (bmnn)this.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(j));
    if (paramBundle == null)
    {
