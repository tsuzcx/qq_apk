...
public class bcnc
{
  ...
  private WeakReference<agkp> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public bcnc(QQAppInterface paramQQAppInterface, MessageForPtt paramMessageForPtt, int paramInt)
  {
  ...
  private int a()
  {
    int i = BaseApplicationImpl.getContext().getResources().getColor(2131166997);
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (!this.jdField_a_of_type_JavaLangRefWeakReference.isEnqueued()))
    {
      agkp localagkp = (agkp)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if ((localagkp != null) && (localagkp.jdField_a_of_type_AndroidWidgetTextView != null)) {
        return localagkp.jdField_a_of_type_AndroidWidgetTextView.getCurrentTextColor();
      }
    }
    return i;
  }
  ...
  private void h()
  {
    ...
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((agkp)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataMessageForPtt, this.jdField_a_of_type_AndroidTextSpannableString, this.jdField_a_of_type_Int);
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((agkp)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataMessageForPtt, a(), this.jdField_a_of_type_Int);
    }
  }
  ...
  public void a(agkp paramagkp)
  {
    if (paramagkp != null) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramagkp);
    }
  }
  ...
  public void d()
  {
    ...
    {
      agkp localagkp = (agkp)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localagkp.jdField_a_of_type_AndroidWidgetProgressBar != null)
      {
        localagkp.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
        localagkp.jdField_a_of_type_AndroidWidgetProgressBar.setIndeterminate(true);
