...
public class amrz
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, RecentBaseData paramRecentBaseData)
  {
    ...
    case 7230: 
      ...
      if ((paramRecentBaseData instanceof RecentItemPublicAccountChatMsgData))
      {
        ...
        if (afwq.a(str2)) {
          akgt.a().a(paramQQAppInterface, 2);
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, AbsListView paramAbsListView, int paramInt)
  {
    ...
    do
    {
      ...
      } while (!(paramAbsListView.getAdapter() instanceof bhxm));
      localObject = (bhxm)paramAbsListView.getAdapter();
    } while (!(((bhxm)localObject).getWrappedAdapter() instanceof ajit));
    b.clear();
    ajit localajit = (ajit)((bhxm)localObject).getWrappedAdapter();
    ...
    if (i < k - 1)
    {
      paramAbsListView = localajit.getItem(i);
      String str;
      if ((paramAbsListView instanceof RecentBaseData))
      {
        ...
        if (!a.containsKey(str))
        {
          ...
          akgt.a().a(paramQQAppInterface, 1);
        }
