  ...
  implements HttpResponseListener<BaseObject>
{
  ...
  public void a(int paramInt, BaseObject paramBaseObject)
  {
    ...
    if ((paramBaseObject instanceof Geo2AddressResultObject))
    {
      ...
      if ((paramBaseObject.result != null) && (paramBaseObject.result.pois != null))
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          localObject2 = LocationRoom.Venue.a(arxd.a(this.a).app.c(), (Poi)localObject2);
          arxd.a(this.a).add(localObject2);
        }
        localObject1 = this.a;
        ...
        bool1 = true;
        arxd.b((arxd)localObject1, bool1);
      }
    }
    label235:
    label368:
      ...
      do
      {
        do
        {
          if (QLog.isDevelopLevel()) {
            QLog.i("LocationPoiDataFromMapHelper", 4, "[venue][poi-data] fetch onSuccess: mVenueList size = " + arxd.a(this.a).size() + ", mHashMore = " + arxd.a(this.a));
          }
          if (arxd.a(this.a) != null) {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          localObject2 = LocationRoom.Venue.a(arxd.a(this.a).app.c(), (SuggestionResultObject.SuggestionData)localObject2);
          arxd.a(this.a).add(localObject2);
        }
        localObject1 = this.a;
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localObject2 = LocationRoom.Venue.a(arxd.a(this.a).app.c(), (SearchResultObject.SearchResultData)localObject2);
      arxd.a(this.a).add(localObject2);
    }
    localObject1 = this.a;
    if (paramBaseObject.count >= 20) {}
  ...
  public void onFailure(int paramInt, String paramString, Throwable paramThrowable)
  {
    arxd.a(this.a, false);
    if (QLog.isDevelopLevel()) {
      QLog.i("LocationPoiDataFromMapHelper", 4, "[venue][poi-data] fetch onFailure: mVenueList size = " + arxd.a(this.a).size() + ", mHashMore = " + arxd.a(this.a));
    }
    if (arxd.a(this.a) != null) {
