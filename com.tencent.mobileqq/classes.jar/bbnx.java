...
public class bbnx
{
  ...
  public static Map<Integer, String> a(long paramLong)
  {
    ...
    Map localMap = bbnz.a(LocalMultiProcConfig.getString("EXTEND_INFO" + paramLong, ""));
    if (a(paramLong)) {
  ...
  public static void a(mobile_count_rsp_new parammobile_count_rsp_new)
  {
    if ((parammobile_count_rsp_new != null) && (parammobile_count_rsp_new.vec_soft_infos != null) && (parammobile_count_rsp_new.vec_soft_infos.size() != 0))
    {
      ...
      LocalMultiProcConfig.putString("qzone_soft_infos", bfuc.encodeToString(localJceOutputStream.toByteArray(), 0));
    }
  }
  ...
  private static void a(mobile_count_rsp_new parammobile_count_rsp_new, bboz parambboz)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while (parambboz == null);
        if (parammobile_count_rsp_new.iNextTimeout > 0)
        {
          parambboz.a = (parammobile_count_rsp_new.iNextTimeout * 1000L);
          if (QLog.isColorLevel()) {
            QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "onReceive getFeedInterval:" + parambboz.a);
          }
        }
      } while (parammobile_count_rsp_new.switchTimeout <= 0);
      parambboz.b = (parammobile_count_rsp_new.switchTimeout * 1000);
    } while (!QLog.isColorLevel());
    QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "onReceive getActiveAppInterval:" + parambboz.b);
  }
  ...
  public static void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg, QQAppInterface paramQQAppInterface, bboz parambboz)
  {
    ...
    do
    {
      ...
      {
        return;
        paramFromServiceMsg = bbnu.a(paramIntent, paramQQAppInterface, "getUndealCount");
    ...
    avta localavta = (avta)paramQQAppInterface.getManager(10);
    if (localavta != null) {
      localavta.b(0);
    }
  ...
  private static void a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      long l = System.currentTimeMillis();
      HashMap localHashMap = new HashMap();
      StatisticCollector.getInstance(paramQQAppInterface.getApp()).collectPerformance(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", true, l - bboz.c, 0L, localHashMap, "");
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, Long paramLong)
  {
    ...
    do
    {
      ...
      } while ((paramQQAppInterface == null) || (!(paramQQAppInterface instanceof bbox)));
    ...
    ((bbox)paramQQAppInterface).a(localHashMap);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Intent paramIntent, FromServiceMsg paramFromServiceMsg, bboz parambboz)
  {
    if (QLog.isColorLevel()) {
      QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "inform QZONE_GET_UNREAD isSuccess false");
    }
    if (parambboz != null) {
      parambboz.notifyObserver(null, 1000, false, new Bundle(), axkw.class);
    }
    if (paramQQAppInterface != null)
    {
      ...
      StatisticCollector.getInstance(paramQQAppInterface.getApp()).collectPerformance(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", false, bboz.d - bboz.c, 0L, paramFromServiceMsg, "");
    }
  }
  
  private static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, bboz parambboz)
  {
    if (QLog.isColorLevel()) {
      QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "inform QZONE_GET_UNREAD isSuccess false");
    }
    ...
    if (paramQQAppInterface != null)
    {
      ...
      parambboz = new HashMap();
      parambboz.put("param_FailCode", String.valueOf(9045));
      parambboz.put("param_errorDesc", paramArrayOfByte);
      StatisticCollector.getInstance(paramQQAppInterface.getApp()).collectPerformance(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", false, bboz.d - bboz.c, 0L, parambboz, "");
    }
  }
  
  public static void a(String paramString) {}
  
  private static void a(String paramString, bboz parambboz)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (parambboz == null) {
      return;
    ...
    parambboz.notifyObserver(null, 1003, true, localBundle, axkw.class);
  }
  ...
  private static void a(byte[] paramArrayOfByte, mobile_count_rsp_new parammobile_count_rsp_new, QQAppInterface paramQQAppInterface, bboz parambboz)
  {
    HashMap localHashMap = new HashMap();
    ...
    if ((paramArrayOfByte != null) && ((paramArrayOfByte instanceof bbox)))
    {
      ((bbox)paramArrayOfByte).a(localHashMap);
      if (QLog.isColorLevel()) {
    ...
    label129:
    a(paramQQAppInterface, paramArrayOfByte, parambboz);
  }
  ...
  public static boolean a(int paramInt, String paramString)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      if (localbbny.a())
      {
        ...
        if (localbbny.jdField_a_of_type_Int <= 0) {
          break label53;
        }
        bool1 = bool2;
      }
  ...
  private static boolean a(long paramLong)
  {
    ...
    try
    {
      localObject = (stNuanNuanComment)b(stNuanNuanComment.class, bfuc.decode((String)localObject, 0));
  ...
  public static byte[] a(long paramLong, String paramString1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, Map<Integer, count_info> paramMap, String paramString2, Map<Long, Long> paramMap1)
  {
    ...
    return bbnu.a(paramString1, "getUndealCount", paramLong, paramInt1, paramInt2, paramInt4);
  }
  ...
  public static void b(int paramInt, QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      if (str != null)
      {
        ...
        paramQQAppInterface = (avta)paramQQAppInterface.getManager(10);
        if ((paramInt & 0x80) == 0) {
          break label84;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((parammobile_count_rsp_new.snnComment != null) && (parammobile_count_rsp_new.snnComment.iStatus != 0) && (paramLong != -1L))
        {
          ...
          LocalMultiProcConfig.putString4Uin("qzone_dual_warm_comment_info", bfuc.encodeToString(localJceOutputStream.toByteArray(), 0), paramLong);
        ...
        if ((parammobile_count_rsp_new.sContentOpComment != null) && (parammobile_count_rsp_new.sContentOpComment.iStatus != 0) && (paramLong != -1L))
        {
          ...
          LocalMultiProcConfig.putString4Uin("qzone_dual_warm_operation_comment_info", bfuc.encodeToString(((JceOutputStream)localObject).toByteArray(), 0), paramLong);
          return;
        }
      }
