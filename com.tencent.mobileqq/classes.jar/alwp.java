  ...
  implements alwn
{
  ...
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)alwo.a(this.a).get();
    ...
    synchronized (alwo.a(this.a))
    {
      if ((Bundle)alwo.a(this.a).get(Long.valueOf(l)) != null)
      {
        alwo.a(this.a).remove(Long.valueOf(l));
        alwo.a(this.a).removeMessages(1, localObject1);
    ...
    for (??? = "1";; ??? = "2")
    {
      ...
      axrn.a(BaseApplicationImpl.getApplication()).a(null, "actAsyncShareCallback", true, 0L, 0L, (HashMap)localObject2, null);
      if (!paramBoolean) {
        break;
      }
    ...
    alwo.a(this.a, localQQAppInterface, (MessageForArkApp)localObject1);
  }
}
