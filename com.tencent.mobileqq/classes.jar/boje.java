...
{
  private int jdField_a_of_type_Int = bmvb.jdField_a_of_type_Int;
  private boix jdField_a_of_type_Boix;
  private boiy jdField_a_of_type_Boiy;
  private bpsq jdField_a_of_type_Bpsq = new bpsq();
  private MusicItemInfo jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo;
  private HashMap<Integer, boiy> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private List<boiz> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  private ConcurrentHashMap<String, bhyo> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  /* Error */
  private boiy a(MusicItemInfo paramMusicItemInfo)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   9: if_icmpne +62 -> 71
    //   12: aload_0
    //   13: getfield 44	boje:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   16: iconst_1
    ...
    //   33: new 73	boiy
    //   36: dup
    //   37: invokespecial 74	boiy:<init>	()V
    //   40: astore_2
    //   41: aload_2
    //   42: aload_0
    //   43: getfield 49	boje:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   46: invokevirtual 77	boiy:a	(Ljava/util/List;)V
    //   49: aload_0
    //   50: getfield 44	boje:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   53: iconst_1
    ...
    //   62: aload_2
    //   63: aload_1
    //   64: invokevirtual 84	boiy:a	(Lcom/tencent/mobileqq/richmedia/capture/data/MusicItemInfo;)V
    //   67: aload_0
    //   68: monitorexit
    //   69: aload_2
    //   70: areturn
    ...
    //   76: if_icmpne -9 -> 67
    //   79: aload_0
    //   80: getfield 44	boje:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   83: iconst_2
    ...
    //   108: aload_2
    //   109: aload_0
    //   110: getfield 49	boje:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   113: invokevirtual 77	boiy:a	(Ljava/util/List;)V
    //   116: aload_0
    //   117: getfield 44	boje:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   120: iconst_2
    ...
    //   129: aload_2
    //   130: aload_1
    //   131: invokevirtual 84	boiy:a	(Lcom/tencent/mobileqq/richmedia/capture/data/MusicItemInfo;)V
    //   134: goto -67 -> 67
    //   137: astore_1
    //   138: aload_0
    //   139: monitorexit
  ...
  {
    if ((this.jdField_a_of_type_Boix != null) && (!this.jdField_a_of_type_Boolean) && ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo == null) || (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.isMute() != paramMusicItemInfo.isMute()))) {
      this.jdField_a_of_type_Boix.a(paramMusicItemInfo.isMute());
    }
  }
  
  private void e()
  {
    if (this.jdField_a_of_type_Boiy != null)
    {
      d();
      this.jdField_a_of_type_Boiy.a();
    }
  }
  ...
  public int a()
  {
    int i = -1;
    if (a()) {
      i = this.jdField_a_of_type_Boiy.a();
    }
    return i;
  }
    ...
    if (this.jdField_a_of_type_Boiy != null)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo != null) && (this.jdField_a_of_type_JavaUtilList != null))
      {
        ...
        while (localIterator.hasNext()) {
          ((boiz)localIterator.next()).a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo);
        }
      }
      this.jdField_a_of_type_Boiy.b();
      d();
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Boix != null) {
      this.jdField_a_of_type_Boix.a(true);
    }
    a(-1, -1, paramInt);
  }
  
  public void a(boix paramboix)
  {
    this.jdField_a_of_type_Boix = paramboix;
    if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo != null) && (this.jdField_a_of_type_Boix != null)) {
      this.jdField_a_of_type_Boix.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.isMute());
    }
  }
  
  public void a(boiz paramboiz)
  {
    if ((paramboiz == null) || (this.jdField_a_of_type_JavaUtilList == null)) {
    ...
    {
      return;
      if (!this.jdField_a_of_type_JavaUtilList.contains(paramboiz)) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("QimMusicPlayer", 2, "addMusicPlayerSceneListener mListeners has listener");
    return;
    this.jdField_a_of_type_JavaUtilList.add(paramboiz);
  }
  ...
  public void a(MusicItemInfo paramMusicItemInfo)
  {
    ...
    {
      localObject = (bhyo)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramMusicItemInfo.getLocalPath());
      if (localObject != null) {
        QQMusicDownloader.a((bhyo)localObject);
      }
    }
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Boiy != null) && (this.jdField_a_of_type_Boiy.a());
  }
  
  public boolean a(int paramInt1, int paramInt2, int paramInt3)
  {
    MusicItemInfo localMusicItemInfo = ((QIMMusicConfigManager)bogd.a(2)).a(paramInt1, paramInt2);
  ...
  public boolean a(MusicItemInfo paramMusicItemInfo)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext()) {
        ((boiz)localIterator.next()).a(paramMusicItemInfo);
      }
    }
    c();
    ...
    this.jdField_a_of_type_Boiy = a(paramMusicItemInfo);
    return true;
  }
  ...
  public boolean a(MusicItemInfo paramMusicItemInfo, boiw paramboiw)
  {
    String str;
    ...
    if (!this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(str))
    {
      ...
      paramboiw = new bojd(this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap, this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap, paramboiw);
      bhyo localbhyo = QQMusicDownloader.a(paramMusicItemInfo.mUrl, str, paramboiw);
      if (localbhyo != null)
      {
        this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(str, localbhyo);
        QQMusicDownloader.a(localbhyo, paramboiw);
  ...
  public boolean a(MusicItemInfo paramMusicItemInfo, boolean paramBoolean, int paramInt)
  {
    ...
    if (!b(paramMusicItemInfo)) {}
    while ((bczv.a().a()) || (c(paramMusicItemInfo))) {
      return false;
    }
  ...
  public void b(int paramInt)
  {
    ...
    while (this.jdField_a_of_type_Boiy == null) {
      return;
    }
    this.jdField_a_of_type_Boiy.c();
  }
  
  public void b(boiz paramboiz)
  {
    if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.contains(paramboiz))) {
      this.jdField_a_of_type_JavaUtilList.remove(paramboiz);
    }
  }
  ...
  public boolean b()
  {
    ...
    int i = j;
    if (j == bmvb.jdField_a_of_type_Int) {
      i = bmvb.a();
    }
    QQFilterRenderManager localQQFilterRenderManager = bmvb.a(i);
  ...
  public void d()
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while (this.jdField_a_of_type_Bpsq == null);
        int j = this.jdField_a_of_type_Int;
        int i = j;
        if (j == bmvb.jdField_a_of_type_Int) {
          i = bmvb.a();
        }
        localQQFilterRenderManager = bmvb.a(i);
        if ((localMusicItemInfo.needPlay()) && (b()))
        {
          if (a()) {}
          for (i = a() - localMusicItemInfo.musicStart;; i = 0)
          {
            this.jdField_a_of_type_Bpsq.a(localMusicItemInfo, i);
            if (localQQFilterRenderManager == null) {
              break;
            }
      ...
      } while ((!localMusicItemInfo.needPlay()) && (!b()));
      this.jdField_a_of_type_Bpsq.a();
  ...
  public float getCurrentMusicGain()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          if ((this.jdField_a_of_type_Bpsq != null) && (localMusicItemInfo.needPlay()) && (a()))
          {
            float f = this.jdField_a_of_type_Bpsq.a(a() - localMusicItemInfo.musicStart);
            return f;
          }
        }
  ...
  public void onDestroy()
  {
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo = null;
    this.jdField_b_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo = null;
    this.jdField_a_of_type_Boix = null;
    this.jdField_a_of_type_JavaUtilList.clear();
    this.jdField_a_of_type_JavaUtilList = null;
    this.jdField_a_of_type_Boiy = null;
    this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilHashMap.values().iterator();
    while (localIterator.hasNext()) {
      ((boiy)localIterator.next()).f();
    }
    this.jdField_a_of_type_JavaUtilHashMap.clear();
    this.jdField_a_of_type_JavaUtilHashMap = null;
    this.jdField_a_of_type_Bpsq.a();
    this.jdField_a_of_type_Bpsq = null;
  }
