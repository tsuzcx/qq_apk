...
public class boje
{
  ...
  static double a(int paramInt)
  {
    ...
    {
      bnzb.a("AEEditorMusicWaveRandomGenerator", "obtainRandomValue() mRandoms == null.");
      d = a();
    }
    for (;;)
    {
      ...
      {
        bnzb.a("AEEditorMusicWaveRandomGenerator", "obtainRandomValue() index == mRandoms.size().");
        d = a();
      ...
      if (paramInt < 0)
      {
        bnzb.a("AEEditorMusicWaveRandomGenerator", "obtainRandomValue() index < 0.");
        return a();
      }
      if (paramInt <= jdField_a_of_type_JavaUtilArrayList.size()) {
        break;
