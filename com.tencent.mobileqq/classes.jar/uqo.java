...
public class uqo
  implements Runnable
{
  public uqo(ApolloItemBuilder paramApolloItemBuilder, MessageForApollo paramMessageForApollo, BaseChatItemLayout paramBaseChatItemLayout, ApolloItemBuilder.Holder paramHolder) {}
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataMessageForApollo.mApolloMessage != null)
    {
      ...
      localObject = new uqw(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemApolloItemBuilder, this.jdField_a_of_type_ComTencentMobileqqActivityAioItemApolloItemBuilder$Holder, this.jdField_a_of_type_ComTencentMobileqqDataMessageForApollo, 0);
      ThreadManager.getUIHandler().post((Runnable)localObject);
      localObject = new uqw(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemApolloItemBuilder, this.jdField_a_of_type_ComTencentMobileqqActivityAioItemApolloItemBuilder$Holder, this.jdField_a_of_type_ComTencentMobileqqDataMessageForApollo, 1);
    ...
    {
      ThreadManager.getUIHandler().post(new uqp(this));
      return;
    }
