  ...
  implements uqz
{
  ...
  public List<CommentEntry> a()
  {
    ...
    wsv.a("Q.qqstory:CommentManager", "query fail comment's size = %d", Integer.valueOf(((List)localObject).size()));
    return localObject;
  }
  ...
  public List<CommentEntry> a(String paramString, boolean paramBoolean)
  {
    ...
    for (int i = 4;; i = 3)
    {
      ...
      wsv.a("Q.qqstory:CommentManager", "query comment feeds id %s, %d", paramString, Integer.valueOf(((List)localObject).size()));
      return localObject;
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    {
      wsv.d("Q.qqstory:CommentManager", "push info invalidate feedId:%s, commentId:%d", new Object[] { paramString, Integer.valueOf(paramInt) });
      return;
    }
    ...
    for (;;)
    {
      ...
      localObject2 = (CommentLikeFeedItem)((wkp)localObject1).a(paramString);
      ...
      ((wkp)localObject1).a((FeedItem)localObject2);
      paramString = new uow(4, paramString, 2, (CommentLikeFeedItem)localObject2);
  ...
  public void a(@NonNull List<CommentEntry> paramList, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        wsv.a("Q.qqstory:CommentManager", "delete comment feeds id %s, %d", paramString, Integer.valueOf(((List)localObject1).size()));
        if (localObject1 == null) {
          break;
        }
        localObject1 = ((List)localObject1).iterator();
    ...
    {
      wsv.a("Q.qqstory:CommentManager", "fail comment size:%d for feedId:%s", Integer.valueOf(j), paramString);
      ...
      while (((Iterator)localObject1).hasNext()) {
        localawbw.b((CommentEntry)((Iterator)localObject1).next());
      }
      wsv.a("Q.qqstory:CommentManager", "insert comment feeds id %s, %d", paramString, Integer.valueOf(paramList.size()));
      localawbw.a().c();
      localawbw.a().b();
      return;
    }
