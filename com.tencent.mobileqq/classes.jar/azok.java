  ...
  implements Handler.Callback, HookMethodCallback
{
  ...
  private HashMap<WeakReference<PowerManager.WakeLock>, azom> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private int jdField_b_of_type_Int = 10;
  private long jdField_b_of_type_Long = 600000L;
  private HashMap<String, azol> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  private long jdField_c_of_type_Long = 7200000L;
  private HashMap<String, azol> jdField_c_of_type_JavaUtilHashMap = new HashMap();
  
  public azok(azob paramazob, String paramString)
  {
  ...
  private final void a(azom paramazom, int paramInt)
  {
    Bundle localBundle = new Bundle();
    localBundle.putInt("key_action", paramInt);
    localBundle.putString("key_stack", paramazom.b);
    localBundle.putString("key_tag", paramazom.jdField_a_of_type_JavaLangString);
    localBundle.putInt("key_flag", paramazom.jdField_a_of_type_Int);
    localBundle.putLong("key_time", paramazom.a());
    if (!azob.a())
    {
  ...
  private final void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localObject3 = (azol)((Iterator)localObject2).next();
          k = ((azol)localObject3).jdField_a_of_type_JavaUtilHashSet.size();
          if ((((azol)localObject3).jdField_a_of_type_Int & 0x1) <= 0) {
            break label506;
          }
          j = 1;
          localObject3 = ((azol)localObject3).jdField_a_of_type_JavaUtilHashSet.iterator();
        ...
        azob.b((azob)localObject3, new String[] { localObject2, "|", String.valueOf(i), "|", String.valueOf(l2), "|", String.valueOf(l1) });
        Object localObject4 = localHashMap1.keySet().iterator();
        if (!((Iterator)localObject4).hasNext()) {
          break label494;
        }
        String str1 = (String)((Iterator)localObject4).next();
        localObject3 = (azol)localHashMap1.get(str1);
        StringBuilder localStringBuilder = azny.a();
        localObject2 = ((azol)localObject3).jdField_a_of_type_JavaUtilHashSet.iterator();
        i = 0;
        if (((Iterator)localObject2).hasNext())
        {
          ...
          i += 1;
          if (i >= ((azol)localObject3).jdField_a_of_type_JavaUtilHashSet.size()) {
            break label519;
          }
          localStringBuilder.append("#");
          break label519;
        }
        Object localObject5 = this.jdField_b_of_type_Azob;
        if (paramBoolean)
        {
          localObject2 = "fg30WlUse";
          String str2 = ((azol)localObject3).jdField_a_of_type_JavaLangString.replace("|", "_");
          if ((((azol)localObject3).jdField_a_of_type_Int & 0x1) <= 0) {
            break label529;
          }
          localObject3 = "1";
          azob.b((azob)localObject5, new String[] { localObject2, "|", str2, "|", localObject3, "|", str1, "|", localStringBuilder.toString() });
          continue;
        }
    ...
    if ((this.jdField_a_of_type_Boolean) && ((i == 3) || (i == 4) || (i == 5)))
    {
      ...
      if (i == 3) {
        synchronized (this.jdField_b_of_type_JavaUtilHashMap)
        {
          ...
          {
            localazol2 = (azol)this.jdField_b_of_type_JavaUtilHashMap.get(str);
            localazol1 = localazol2;
            if (localazol2 == null)
            {
              localazol1 = new azol(this, null);
              localazol1.jdField_a_of_type_Int = paramBundle.getInt("key_flag");
              localazol1.jdField_a_of_type_JavaLangString = paramBundle.getString("key_tag");
              this.jdField_b_of_type_JavaUtilHashMap.put(str, localazol1);
            }
            localazol1.jdField_a_of_type_JavaUtilHashSet.add(new Pair(Long.valueOf(System.currentTimeMillis()), Long.valueOf(paramBundle.getLong("key_time"))));
          }
          if ((this.jdField_c_of_type_Boolean) && (this.d))
          {
            localazol2 = (azol)this.jdField_c_of_type_JavaUtilHashMap.get(str);
            localazol1 = localazol2;
            if (localazol2 == null)
            {
              localazol1 = new azol(this, null);
              localazol1.jdField_a_of_type_Int = paramBundle.getInt("key_flag");
              localazol1.jdField_a_of_type_JavaLangString = paramBundle.getString("key_tag");
              this.jdField_c_of_type_JavaUtilHashMap.put(str, localazol1);
            }
            localazol1.jdField_a_of_type_JavaUtilHashSet.add(new Pair(Long.valueOf(System.currentTimeMillis()), Long.valueOf(paramBundle.getLong("key_time"))));
          }
          return;
      ...
      if (i == 4)
      {
        azob.b(this.jdField_b_of_type_Azob, new String[] { "wlNotRelease", "|", paramBundle.getString("key_stack"), "|", paramBundle.getString("key_tag"), "|", paramBundle.getInt("key_flag") + "", "|", paramBundle.getLong("key_time") + "" });
        return;
      }
      if (i == 5) {
        azob.b(this.jdField_b_of_type_Azob, new String[] { "wlTimeout", "|", paramBundle.getString("key_stack"), "|", paramBundle.getString("key_tag"), "|", paramBundle.getInt("key_flag") + "", "|", paramBundle.getLong("key_time") + "" });
      }
    }
  }
  ...
  public void a(String paramString, Object paramObject1, Object[] paramArrayOfObject, Object paramObject2)
  {
      ...
      for (;;)
      {
        synchronized (this.jdField_a_of_type_JavaUtilHashMap)
        {
          if ("newWakeLock".equals(paramString))
          {
            ...
            paramObject2.b = azob.a().toString();
            paramObject2.c = String.valueOf(paramObject2.hashCode());
            this.jdField_a_of_type_JavaUtilHashMap.put(paramObject1, paramObject2);
            azob.a(this.jdField_b_of_type_Azob, new String[] { paramString, "|", paramObject2.c, "|", String.valueOf(paramObject2.jdField_a_of_type_Int), "|", paramObject2.jdField_a_of_type_JavaLangString, "|", paramObject2.b });
            return;
          }
        }
        ...
        while (localIterator.hasNext())
        {
          ...
          if (((WeakReference)localObject2).get() == paramObject1)
          {
            ...
            {
              break label1221;
              localObject4 = ((azom)localObject3).a(paramObject2);
              azob localazob = this.jdField_b_of_type_Azob;
              String str = ((azom)localObject3).c;
              if (!((Boolean)((Pair)localObject4).first).booleanValue()) {
                break label1229;
              }
              paramString = paramObject2;
              Object localObject1;
              azob.a(localazob, new String[] { "wl_usg", "|", str, "|0|", paramString, "|", String.valueOf(((Pair)localObject4).second), "|", String.valueOf(localObject1) });
              paramString = ((azom)localObject3).a((PowerManager.WakeLock)paramObject1, paramObject2, localObject1);
            ...
            for (;;)
            {
              ...
              azob.a(this.jdField_b_of_type_Azob, 4, 0, 0, "Acquire " + ((azom)localObject3).jdField_a_of_type_JavaLangString + " too frequently", azoq.a((List)paramString.second));
              break;
              l = ((Long)paramArrayOfObject[0]).longValue();
              break label291;
              if (l >= this.jdField_a_of_type_Long)
              {
                azob.a(this.jdField_b_of_type_Azob, new String[] { "wl_alm", "|", ((azom)localObject3).c, "|0|", String.valueOf(((Pair)localObject4).second) });
                azob.a(this.jdField_b_of_type_Azob, 4, 1, 0, "Acquire " + ((azom)localObject3).jdField_a_of_type_JavaLangString + " too long time", "CallStack: " + ((azom)localObject3).b);
              }
            }
          }
          else if (((WeakReference)localObject2).get() == null)
          {
            if (((azom)localObject3).a())
            {
              azob.a(this.jdField_b_of_type_Azob, 4, 2, 1, "WakeLock " + ((azom)localObject3).jdField_a_of_type_JavaLangString + " not release", "CreateStack: " + ((azom)localObject3).b);
              azob.a(this.jdField_b_of_type_Azob, new String[] { "wl_alm", "|", ((azom)localObject3).c, "|1" });
              a((azom)localObject3, 4);
            }
            ((azom)localObject3).a();
    ...
    {
      localObject2 = (WeakReference)localIterator.next();
      paramString = (azom)this.jdField_a_of_type_JavaUtilHashMap.get(localObject2);
      if (((WeakReference)localObject2).get() == paramObject1)
      {
        if (paramArrayOfObject == null) {
          break label1236;
        ...
        if (paramArrayOfObject.length == 0)
        {
          ...
          if (((Boolean)((Pair)localObject3).first).booleanValue())
          {
            ...
            azob.a(this.jdField_b_of_type_Azob, new String[] { "wl_tm", "|", paramString.c, "|", String.valueOf(((Pair)localObject3).second) });
            a(paramString, 3);
          }
    ...
    {
      azob.a((azob)localObject3, new String[] { "wl_usg", "|", localObject4, "|1|", paramString, "|", String.valueOf(((Pair)localObject2).second), "|", String.valueOf(i) });
      break label824;
      ...
      if (paramString.a())
      {
        azob.a(this.jdField_b_of_type_Azob, 4, 2, 1, "WakeLock " + paramString.jdField_a_of_type_JavaLangString + " not release", "CreateStack: " + paramString.b);
        azob.a(this.jdField_b_of_type_Azob, new String[] { "wl_alm", "|", paramString.c, "|1" });
        a(paramString, 4);
      }
      paramString.a();
      localIterator.remove();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    if (paramMessage.what == 1) {
      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
      {
        ...
        paramMessage = (azom)this.jdField_a_of_type_JavaUtilHashMap.get(paramMessage);
        if (paramMessage != null)
        {
          a(paramMessage, 5);
          azob.a(this.jdField_b_of_type_Azob, new String[] { "wl_alm", "|", paramMessage.c, "|0|0" });
          azob.a(this.jdField_b_of_type_Azob, 4, 1, 0, "Acquire " + paramMessage.jdField_a_of_type_JavaLangString + " too long time", "CallStack: " + paramMessage.b);
        }
        while (!QLog.isColorLevel()) {
          return false;
        }
        azob.a(this.jdField_b_of_type_Azob, "wake lock is lost ?");
      }
    }
    return false;
  }
