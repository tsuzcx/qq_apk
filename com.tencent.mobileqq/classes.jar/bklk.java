  ...
  implements Handler.Callback
{
  ...
  public bklk(Context paramContext, String paramString)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_AndroidOsHandler = new Handler(a().getLooper(), this);
    this.b = paramString;
    this.jdField_a_of_type_Bkkk = bkkk.a(this.jdField_a_of_type_AndroidContentContext);
    a();
  }
  ...
  {
    bkli.a(paramPluginInfo, a(this.jdField_a_of_type_AndroidContentContext));
  }
  
  private void a(String paramString)
  {
    bkli.a(paramString, a(this.jdField_a_of_type_AndroidContentContext));
  }
      ...
      if (paramPluginInfo.mInstalledPath != null)
      {
        ...
        if (localFile != null)
        {
          ...
          if (localFile.exists())
          {
            ...
            if (localFile.isFile())
            {
              if (!bkli.a(paramPluginInfo, localFile)) {
                break label137;
              }
              bool1 = true;
  ...
  private static boolean a(File paramFile, QZipFile paramQZipFile, ZipEntry paramZipEntry)
  {
    ...
    //   116: invokestatic 201	cooperation/qzone/util/RecycleableBufferedOutputStream:obtain	(Ljava/io/OutputStream;)Lcooperation/qzone/util/RecycleableBufferedOutputStream;
    //   119: astore_0
    //   120: aload_0
    //   121: astore 5
    //   123: aload_0
    ...
    //   143: aload 6
    //   145: aload 7
    //   147: invokevirtual 207	java/io/InputStream:read	([B)I
    //   150: istore_3
    //   151: iload_3
    //   152: ifle +66 -> 218
    //   155: aload_0
    ...
    //   166: iconst_0
    //   167: iload_3
    //   168: invokevirtual 213	java/io/OutputStream:write	([BII)V
    //   171: goto -36 -> 135
    //   174: astore_0
    //   175: aload 5
    //   177: astore_1
    ...
    //   189: invokestatic 217	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   192: aload 6
    //   194: ifnull +8 -> 202
    //   197: aload 6
    //   199: invokevirtual 220	java/io/InputStream:close	()V
    //   202: aload 5
    //   204: ifnull +8 -> 212
    //   207: aload 5
    //   209: invokevirtual 221	java/io/OutputStream:close	()V
    //   212: iconst_0
    //   213: istore 4
    //   215: iload 4
    //   217: ireturn
    ...
    //   220: ifnull +8 -> 228
    //   223: aload 6
    //   225: invokevirtual 220	java/io/InputStream:close	()V
    //   228: aload_0
    //   229: ifnull -14 -> 215
    //   232: aload_0
    //   233: invokevirtual 221	java/io/OutputStream:close	()V
    //   236: iconst_1
    //   237: ireturn
    //   238: astore_0
    //   239: iconst_1
    ...
    //   248: ifnull +7 -> 255
    //   251: aload_2
    //   252: invokevirtual 220	java/io/InputStream:close	()V
    //   255: aload_1
    //   256: ifnull +7 -> 263
    //   259: aload_1
    //   260: invokevirtual 221	java/io/OutputStream:close	()V
    //   263: aload_0
    //   264: athrow
    //   265: astore_1
    //   266: goto -38 -> 228
  ...
  private void c(PluginInfo paramPluginInfo, bkln parambkln)
  {
    int i = 1;
    String str = paramPluginInfo.mID;
    QLog.d("plugin_tag", 1, "doSetupPlugin." + str);
    if (bkli.a(paramPluginInfo, this.jdField_a_of_type_AndroidContentContext))
    {
  ...
  private boolean c(String paramString)
  {
    ...
    {
      return false;
      paramString = new File(this.b).list(new bkll(this, paramString));
  ...
  private boolean d(String paramString)
  {
    ...
    if ((localPluginInfo != null) && (bkli.a(localPluginInfo, this.jdField_a_of_type_AndroidContentContext)))
    {
      if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    ...
    boolean bool = bkli.a(localFile1);
    File[] arrayOfFile = bkli.a(localFile1);
    int i;
    File localFile2;
    Object localObject;
    if (arrayOfFile != null)
  ...
  public void a(PluginInfo paramPluginInfo, bkln parambkln)
  {
    paramPluginInfo = new Pair(paramPluginInfo, parambkln);
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(66816, paramPluginInfo).sendToTarget();
  }
  
  public void a(String paramString, File paramFile, bkln parambkln)
  {
    int i = 1;
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(paramFile);
    if ((PluginUtils.isOsNeedReleaseDex()) && (bklb.a(paramString) > 1)) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramFile))
        {
          ...
          boolean bool = Dex2Oat.a(localArrayList, localFile, true, paramFile, new bklm(this));
          ...
          bcdy.a(paramString, i, l2);
          l2 = System.currentTimeMillis();
          if (parambkln != null) {
            parambkln.a(paramString, "pluginOatCost", l2 - l1);
          }
          if (QLog.isColorLevel()) {
  ...
  public boolean a(PluginInfo paramPluginInfo, bkln parambkln)
  {
    if (paramPluginInfo == null)
    {
      if (QLog.isColorLevel()) {
    ...
    for (boolean bool = a((PluginInfo)localObject);; bool = false)
    {
      ...
      if (!bkli.a(paramPluginInfo, (File)localObject))
      {
        if (QLog.isColorLevel()) {
  ...
  public boolean a(String paramString, bkln parambkln)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      if (parambkln != null) {
        parambkln.e(paramString);
      }
      return false;
    }
    if (!this.jdField_a_of_type_Bkkk.a(paramString))
    {
      if (QLog.isColorLevel()) {
    ...
    boolean bool = false;
    Object localObject3 = this.jdField_a_of_type_Bkkk.a(paramString);
    if (localObject3 == null)
    {
      QLog.d("plugin_tag", 1, "plugin not builtin");
      if (parambkln != null) {
        parambkln.b(false, paramString);
      }
      return false;
    }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (parambkln != null) {
        parambkln.b(true, paramString);
      }
      return true;
    }
    if (parambkln != null) {
      parambkln.f(paramString);
    }
    ...
    if (localObject3 != null)
    {
      ...
      try
      {
        ...
        if ((0 == 0) && (bool))
        {
          long l2 = System.currentTimeMillis();
          if (parambkln != null) {
            parambkln.a(paramString, "pluginApkCost", l2 - l1);
          }
          i = 0;
          try
          {
            ...
            l2 = System.currentTimeMillis();
            if (parambkln != null) {
              parambkln.a(paramString, "pluginLibCost", l2 - l1);
            }
            if (localObject3 != null)
            {
      ...
      catch (Exception localException3)
      {
        for (;;)
        {
          f = FileUtils.getAvailableInnernalMemorySize();
      ...
      if (bklq.a()) {
        a(paramString, (File)localObject1, parambkln);
      }
  ...
  public void b(PluginInfo paramPluginInfo, bkln parambkln)
  {
    paramPluginInfo = new Pair(paramPluginInfo, parambkln);
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(67072, paramPluginInfo).sendToTarget();
  }
  
  public boolean b(PluginInfo paramPluginInfo, bkln parambkln)
  {
    String str = paramPluginInfo.mID;
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      {
        a(str, new File(PluginUtils.getPluginInstallDir(this.jdField_a_of_type_AndroidContentContext), str), parambkln);
        paramPluginInfo.mState = 4;
        paramPluginInfo.mFingerPrint = a();
        a(paramPluginInfo);
        if (QLog.isColorLevel()) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 66816: 
      ...
      c((PluginInfo)paramMessage.first, (bkln)paramMessage.second);
      return true;
    }
    paramMessage = (Pair)paramMessage.obj;
    b((PluginInfo)paramMessage.first, (bkln)paramMessage.second);
    return true;
  }
}
