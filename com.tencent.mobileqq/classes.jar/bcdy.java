  ...
  extends ProxyWebViewClientExtension
{
  ...
  bccx jdField_a_of_type_Bccx;
  final TouchWebView jdField_a_of_type_ComTencentBizUiTouchWebView;
  
  public bcdy(bcdu parambcdu, TouchWebView paramTouchWebView, bccx parambccx)
  {
    this.jdField_a_of_type_ComTencentBizUiTouchWebView = paramTouchWebView;
    this.jdField_a_of_type_Bccx = parambccx;
  }
  ...
  public void onFakeLoginRecognised(Bundle paramBundle)
  {
    ...
    paramBundle = "";
    String str1 = "";
    if (this.jdField_a_of_type_Bcdu.jdField_a_of_type_ComTencentBizUiTouchWebView != null)
    {
      paramBundle = this.jdField_a_of_type_Bcdu.jdField_a_of_type_ComTencentBizUiTouchWebView.getOriginalUrl();
      str1 = this.jdField_a_of_type_Bcdu.jdField_a_of_type_ComTencentBizUiTouchWebView.getUrl();
      bcfo.a(paramBundle, str1, localStringBuilder.toString(), str2, bool2, bool3, bool1);
    }
    String str3;
    if (((localObject != null) && (((ArrayList)localObject).size() > 0)) || (bool1) || (!TextUtils.isEmpty(str2)))
    {
      str3 = this.jdField_a_of_type_Bcdu.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin();
      if (this.jdField_a_of_type_Bcdu.jdField_a_of_type_ComTencentBizUiTouchWebView == null) {
        break label321;
      }
    }
    label321:
    for (Object localObject = this.jdField_a_of_type_Bcdu.jdField_a_of_type_ComTencentBizUiTouchWebView.getTitle();; localObject = "")
    {
      bcfo.a(paramBundle, str1, (String)localObject, str3);
  ...
  {
    if (this.jdField_a_of_type_Bccx != null) {
      return this.jdField_a_of_type_Bccx.a(paramString, paramBundle);
    }
    return null;
  }
  ...
  {
    if (this.jdField_a_of_type_Bccx != null) {
      this.jdField_a_of_type_Bccx.a(paramInt, paramString);
    }
  }
  ...
  public void onUrlChange(String paramString1, String paramString2)
  {
    ...
    if (this.jdField_a_of_type_Bccx != null) {
      this.jdField_a_of_type_Bccx.b(paramString1, paramString2);
    }
  }
