...
public class atyp
{
  public static void a(Context paramContext, String paramString, List<Object> paramList)
  {
    ...
    bbdj.a(paramString + "v5.8.nbr", new Object[] { paramList });
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (a(paramQQAppInterface))
    {
      ...
      if (i <= Math.abs(l3 - l1) / 1000L)
      {
        ...
        localObject = paramQQAppInterface.b(ajsf.H, 1001).iterator();
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong)
  {
    ...
    MessageForNearbyRecommenderTips localMessageForNearbyRecommenderTips = (MessageForNearbyRecommenderTips)axaq.a(-4011);
    long l = awzw.a();
    localMessageForNearbyRecommenderTips.init(paramQQAppInterface.getCurrentAccountUin(), ajsf.as, ajsf.as, "", l, -4011, 1001, l);
    localMessageForNearbyRecommenderTips.isread = true;
    akpy.a(localMessageForNearbyRecommenderTips, false);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyRecommenderUtils", 2, "-----addGrayTipsMessage  frienduin:" + paramString1 + " istroop：" + paramInt + " msg:" + bbbd.a(paramString3));
    }
    long l = awzw.a();
    MessageForGrayTips localMessageForGrayTips = (MessageForGrayTips)axaq.a(-5007);
    ...
    if ((!paramBoolean1) || (!akau.a(paramQQAppInterface, localMessageForGrayTips, false))) {
  ...
  {
    paramQQAppInterface = paramQQAppInterface.a().b(ajsf.H, 1001);
