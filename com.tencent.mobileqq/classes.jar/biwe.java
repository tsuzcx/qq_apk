  ...
  implements biwd
{
  public boolean a(int paramInt, Bundle paramBundle)
  {
    ...
    case 1: 
      ...
      araj.a().b(paramBundle, (Bundle)localObject2);
      return true;
    case 2: 
      ...
      ((QQAppInterface)localObject1).a().a(new arab(paramBundle));
    ...
    case 4: 
      ...
      paramBundle.putString("configInfo", arbp.a(((QQAppInterface)localObject1).getApp().getBaseContext(), str));
      return true;
    }
