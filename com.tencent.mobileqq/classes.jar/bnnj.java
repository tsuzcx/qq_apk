  ...
  extends bnmy
{
  ...
  private bnnk jdField_a_of_type_Bnnk;
  ...
  public bnnj(Context paramContext, String paramString)
  {
  ...
  private void d()
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Bnnk.sendEmptyMessageDelayed(0, 40L);
      localBitmap = null;
  ...
  public Bitmap a()
  {
    ...
    ArrayList localArrayList = this.jdField_a_of_type_Bnmo.a(this.jdField_a_of_type_Bnmo.a());
  ...
  public Bitmap a(long paramLong)
  {
    Bitmap localBitmap = b();
    Canvas localCanvas = new Canvas(localBitmap);
    ArrayList localArrayList = this.jdField_a_of_type_Bnmo.a(paramLong);
    if (this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataGifDecoder != null) {
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Bnnk != null) {
      this.jdField_a_of_type_Bnnk.removeCallbacksAndMessages(null);
    }
  }
  ...
  protected void b()
  {
    this.jdField_a_of_type_Bnnk = new bnnk(new WeakReference(this));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataGifDecoder = new bmtp(this.jdField_b_of_type_JavaLangString);
        ...
        this.k = this.jdField_a_of_type_Bnmo.a("offsetX", 0L, 650L, (int)(-i1 * 0.3D), 0, new bnnh());
        this.l = this.jdField_a_of_type_Bnmo.a("offsetX", 100L, 650L, (int)(-i1 * 0.3D), 0, new bnnh());
        this.m = this.jdField_a_of_type_Bnmo.a("offsetX", 200L, 650L, (int)(-i1 * 0.3D), 0, new bnnh());
        this.n = this.jdField_a_of_type_Bnmo.a("alpha", 0L, 370L, 0, 255, new ykp(0.33F, 0.0F, 0.67F, 1.0F));
        this.o = this.jdField_a_of_type_Bnmo.a("alpha", 100L, 370L, 0, 255, new ykp(0.33F, 0.0F, 0.67F, 1.0F));
        this.p = this.jdField_a_of_type_Bnmo.a("alpha", 200L, 370L, 0, 255, new ykp(0.33F, 0.0F, 0.67F, 1.0F));
        return;
      }
  ...
  protected void c()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataGifDecoder != null) && (this.jdField_b_of_type_Boolean)) {
      this.jdField_a_of_type_Bnnk.sendEmptyMessage(0);
    }
  }
