...
public class akib
  extends akhx
{
  protected akib(QQAppInterface paramQQAppInterface, Context paramContext, awbv paramawbv)
  {
  ...
  public View a(int paramInt1, int paramInt2, View paramView, ViewGroup paramViewGroup, View.OnClickListener paramOnClickListener)
  {
    ...
    if ((paramView == null) || (!(paramView.getTag() instanceof akic)))
    {
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558890, paramViewGroup, false);
      paramOnClickListener = new akic();
      paramOnClickListener.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131367808));
      paramOnClickListener.jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)paramViewGroup.findViewById(2131377553));
      paramOnClickListener.c = ((SingleLineTextView)paramViewGroup.findViewById(2131378855));
      paramOnClickListener.b = ((ImageView)paramViewGroup.findViewById(2131368918));
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton = ((Button)paramViewGroup.findViewById(2131375665));
      paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131375675));
      paramViewGroup.setTag(paramOnClickListener);
      a(paramViewGroup.findViewById(2131367808));
      localPhoneContact = (PhoneContact)this.jdField_a_of_type_Awbv;
      ...
      paramInt2 = bdbt.a(localPhoneContact.detalStatusFlag, localPhoneContact.iTermType);
    ...
    case 8: 
      for (;;)
      {
        if ((paramInt2 == 0) || (paramInt2 == 6))
        {
          ...
          paramOnClickListener.jdField_a_of_type_ComTencentWidgetSingleLineTextView.setTextColor(a(this.jdField_a_of_type_AndroidContentContext, 2131166908));
          ...
          paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setText(alpo.a(2131701588));
          paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(alpo.a(2131701591));
          label504:
          if (AppSetting.c)
          {
            ...
            paramOnClickListener.append(bdbt.b(paramInt1));
            paramViewGroup.setContentDescription(paramOnClickListener);
          }
          label533:
          return paramViewGroup;
          paramOnClickListener = (akic)paramView.getTag();
    ...
    for (;;)
    {
      ...
      paramOnClickListener.c.setVisibility(8);
      break label381;
      if (((aloz)localObject).a(localPhoneContact.unifiedCode, true))
      {
        paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
        paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setText(alpo.a(2131701590));
        paramOnClickListener.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(alpo.a(2131701592));
        break label504;
      }
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setText(alpo.a(2131689628));
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setTag(localPhoneContact);
      paramOnClickListener.jdField_a_of_type_AndroidWidgetButton.setContentDescription(alpo.a(2131689628));
