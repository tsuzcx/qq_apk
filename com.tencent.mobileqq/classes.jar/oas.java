...
public class oas
{
  ...
  public static void a(ProteusInnerData paramProteusInnerData, int paramInt)
  {
    ...
    do
    {
      ...
      localQQAppInterface = (QQAppInterface)onk.a();
    } while (localQQAppInterface == null);
    nmf.a(new nyg().a(localQQAppInterface).a(BaseApplication.getContext()).a(nmf.a).b(nmf.W).a(oav.a(paramProteusInnerData)).d(paramInt).d(nmf.a(paramProteusInnerData)).a());
  }
}
