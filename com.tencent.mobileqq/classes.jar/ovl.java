...
public class ovl
  extends ovd<DynamicChannelDataModel>
{
  ...
  protected TemplateBean a(DynamicChannelDataModel paramDynamicChannelDataModel)
  {
    ...
    if ((paramDynamicChannelDataModel.mTemplateBean != null) && (!((sfq)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext.getTemplateFactory()).a(paramDynamicChannelDataModel.mTemplateBean))) {
    ...
    {
      localJSONObject = ovf.a(paramDynamicChannelDataModel.proteusData);
      localTemplateBean = ovf.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, localJSONObject, ReadInJoyDynamicChannelBaseFragment.a(paramDynamicChannelDataModel.channelID));
