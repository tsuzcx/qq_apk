  ...
  implements ISPlayerPreDownloader.Listener
{
  ...
  private final ConcurrentHashMap<Integer, nga> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        localnga = (nga)((Map.Entry)localIterator.next()).getValue();
      } while (!localnga.jdField_a_of_type_JavaLangString.equalsIgnoreCase(paramString));
      for (paramString = localnga; paramString != null; paramString = null)
      {
  ...
  public void a(String paramString, long paramLong1, long paramLong2)
  {
    ...
    SuperPlayerVideoInfo localSuperPlayerVideoInfo = SuperPlayerFactory.createVideoInfoForUrl(paramString, 101, bjtz.d(paramString));
    ...
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(i), new nga(i, paramString));
  }
  ...
  {
    Object localObject = (nga)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
    StringBuilder localStringBuilder = new StringBuilder().append("onPrepareSuccess content:=");
    if (localObject != null) {}
    for (localObject = ((nga)localObject).toString();; localObject = null)
    {
