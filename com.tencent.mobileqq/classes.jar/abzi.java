...
public class abzi
  implements Runnable
{
  public abzi(EmoticonFromGroupManager paramEmoticonFromGroupManager, List paramList) {}
  ...
  public void run()
  {
    ...
    if (i < j)
    {
      ...
      if (1 != ((URLDrawable)localObject2).getStatus())
      {
        ...
        ((URLDrawable)localObject2).setURLDrawableListener(new abzj(this, (URLDrawable)localObject2, (CustomEmotionData)localObject1, localFavroamingManager, localFavroamingDBManager));
