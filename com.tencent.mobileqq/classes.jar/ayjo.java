...
public class ayjo
{
  ...
  public static Pair<ayjf, List<PrecoverResource>> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject4 == null) || (!((ayjf)localObject4).a()) || (localArrayList.size() <= 0)) {
        break;
      }
      ...
      while (paramString.hasNext())
      {
        ...
        if (localObject1 != null) {
          ((PrecoverResource)localObject1).businessId = ((ayjf)localObject4).a;
        }
      }
      localObject3 = paramString;
