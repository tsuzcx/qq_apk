...
{
  atli(atld paramatld, String paramString1, String paramString2, String paramString3) {}
  
  public void OnDownloadCallback(String paramString)
  {
    if (this.jdField_a_of_type_Atld.a != null) {}
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_Atld.a.a(this.b, this.c, new File(this.jdField_a_of_type_JavaLangString));
        return;
      }
      ...
      this.jdField_a_of_type_Atld.a.a(this.b, this.c, i);
      return;
      ...
      do
      {
        ...
        if (i == 2)
        {
          ...
          this.jdField_a_of_type_Atld.a.a(this.b, this.c, l1, l2);
          return;
        }
        if (i == 1)
        {
          l1 = paramString.getLong("fileSize");
          this.jdField_a_of_type_Atld.a.a(this.b, this.c, l1);
        }
        return;
        if (i == 4) {
          break;
