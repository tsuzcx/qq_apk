  ...
  implements apry
{
  ...
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)aprz.a(this.a).get();
    ...
    synchronized (aprz.a(this.a))
    {
      if ((Bundle)aprz.a(this.a).get(Long.valueOf(l)) != null)
      {
        aprz.a(this.a).remove(Long.valueOf(l));
        aprz.a(this.a).removeMessages(1, localObject1);
    ...
    for (??? = "1";; ??? = "2")
    {
      ...
      bctj.a(BaseApplicationImpl.getApplication()).a(null, "actAsyncShareCallback", true, 0L, 0L, (HashMap)localObject2, null);
      if (!paramBoolean) {
        break;
      }
    ...
    aprz.a(this.a, localQQAppInterface, (MessageForArkApp)localObject1);
  }
}
