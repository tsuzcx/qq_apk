...
public class bgij
{
  ...
  public static bghu a;
  public static bgih a;
  public static bgiq a;
  ...
  public static bghv a(bcdb parambcdb, bghr parambghr)
  {
    if (jdField_a_of_type_Bghu == null) {
      return null;
    }
    return jdField_a_of_type_Bghu.a(parambcdb, parambghr);
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    localbgkz.b = "comic_plugin.apk";
    localbgkz.d = "comic_plugin";
  ...
  {
    if (jdField_a_of_type_Bgih == null) {
      jdField_a_of_type_Bgih = new bgih();
    }
    for (;;)
    {
      jdField_a_of_type_Bgih.addObserver(paramObserver);
      return;
      jdField_a_of_type_Bgih.deleteObservers();
    }
  }
  
  public static boolean a(Activity paramActivity, Intent paramIntent, String paramString, aqyb paramaqyb)
  {
    ...
    localbgkz.jdField_a_of_type_JavaLangClass = VipComicProxyActivity.a(paramString);
    localbgkz.jdField_a_of_type_AndroidContentIntent = paramIntent;
    localbgkz.c = 10000;
    localbgkz.jdField_a_of_type_Aqyb = paramaqyb;
  ...
  public static boolean a(AppRuntime paramAppRuntime)
  {
    ...
    do
    {
      do
      {
        ...
        paramAppRuntime = (bgkq)paramAppRuntime.getManager(27);
  ...
  public static boolean a(AppRuntime paramAppRuntime, boolean paramBoolean, bgim arg2)
  {
    boolean bool = false;
  ...
  {
    if (jdField_a_of_type_Bgiq == null) {
      jdField_a_of_type_Bgiq = new bgiq();
    }
    for (;;)
    {
      jdField_a_of_type_Bgiq.addObserver(paramObserver);
      return;
      jdField_a_of_type_Bgiq.deleteObservers();
    }
  }
}
