...
public class aacq
{
  ...
  private HttpURLConnection a(Intent paramIntent)
  {
    ...
    paramIntent.setRequestProperty("User-Agent", bgyb.a(bgyb.c("httpAsync 1.0"), "", false));
  ...
  public WebResourceResponse a(String arg1, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        odq.a(null, "", "0X8007775", "0X8007775", 0, 0, this.jdField_c_of_type_Boolean + "", "" + i, localJSONObject.toString(), this.jdField_b_of_type_JavaLangString);
        continue;
  ...
  void a(long paramLong, HttpURLConnection paramHttpURLConnection, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        this.jdField_a_of_type_ComTencentSmttExportExternalInterfacesWebResourceResponse = new WebResourceResponse(a(this.jdField_a_of_type_JavaLangString), "utf-8", new aacr(this, (BufferedInputStream)localObject1, (BufferedInputStream)localObject3, (ByteArrayOutputStream)localObject2, paramHttpURLConnection));
        if (!QLog.isColorLevel()) {
          break;
        }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 51	aacq:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   18: iconst_0
    //   19: iconst_1
    ...
    //   28: putfield 295	aacq:jdField_e_of_type_Long	J
    //   31: aload_0
    //   32: aload_1
    //   33: putfield 25	aacq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   36: aload_0
    //   37: iload_2
    //   38: putfield 108	aacq:jdField_a_of_type_Boolean	Z
    //   41: aload_0
    //   42: new 474	com/tencent/biz/webviewplugin/PubAccountWebViewHttpBridge$1
    //   45: dup
    //   46: aload_0
    //   47: invokespecial 476	com/tencent/biz/webviewplugin/PubAccountWebViewHttpBridge$1:<init>	(Laacq;)V
    //   50: ldc 118
    //   52: iconst_5
    ...
    //   56: putfield 358	aacq:jdField_a_of_type_JavaLangThread	Ljava/lang/Thread;
    ...
    //   86: invokestatic 489	npn:b	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   98: aload_0
    //   99: getfield 358	aacq:jdField_a_of_type_JavaLangThread	Ljava/lang/Thread;
