  ...
  extends MSFServlet
{
  ...
  {
    int i = bbbr.a(paramLong2);
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), arkb.class);
  ...
  private void a(int paramInt, Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    //   218: aload 8
    //   220: ldc 182
    //   222: invokevirtual 186	arkb:notifyObserver	(Landroid/content/Intent;IZLandroid/os/Bundle;Ljava/lang/Class;)V
    //   225: return
    //   226: aload_3
    ...
    //   293: aload 8
    //   295: ldc 182
    //   297: invokevirtual 186	arkb:notifyObserver	(Landroid/content/Intent;IZLandroid/os/Bundle;Ljava/lang/Class;)V
    //   300: return
    //   301: astore_3
  ...
  private void a(Intent paramIntent, Packet paramPacket)
  {
    ...
    paramPacket.putSendData(bbma.a(localReqGetOpenIdByUin.toByteArray()));
  }
