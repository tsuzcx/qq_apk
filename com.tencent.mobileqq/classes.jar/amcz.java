  ...
  extends BaseAdapter
{
  ...
  public amcz(Context paramContext, JSONArray paramJSONArray, aazk paramaazk)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Aazk = paramaazk;
    if (this.jdField_a_of_type_Aazk != null) {}
    for (;;)
    {
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      if (this.jdField_a_of_type_Aazk != null)
      {
        this.jdField_a_of_type_Aazk.a("com.tencent.biz.hotchatpostlist.widget.HotChatPostItemView");
        this.jdField_a_of_type_Aazk = null;
      }
      return;
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if ((paramView == null) && (this.jdField_a_of_type_Boolean)) {
      paramView = this.jdField_a_of_type_Aazk.a("com.tencent.biz.hotchatpostlist.widget.HotChatPostItemView");
    }
    Object localObject;
    for (;;)
    {
      ...
      if (paramView != null) {
        ((View)localObject).setOnClickListener(new amdb(this, paramView.optString("bid"), paramView.optString("pid")));
      }
      try
      {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        aazk.a((View)localObject, paramView.toString());
  ...
  {
    Collections.sort(this.jdField_a_of_type_JavaUtilArrayList, new amda(this));
