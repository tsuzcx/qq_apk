...
public class aveg
  extends BaseAdapter
{
  private aveg(SignatureHistoryFragment paramSignatureHistoryFragment) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      if (i == 0)
      {
        ...
        if (paramView == null)
        {
          ...
          paramViewGroup = new avfu(this.a.getActivity(), this.a.getActivity().app, paramViewGroup, SignatureHistoryFragment.a(this.a));
          ...
          LayoutInflater.from(this.a.getActivity()).inflate(2131495520, (ViewGroup)localObject2);
          paramView.setTag(paramViewGroup);
          paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131298424));
          paramViewGroup.jdField_a_of_type_ComTencentMobileqqRichstatusCommentWidgetCommentsView = ((CommentsView)paramView.findViewById(2131298752));
          paramViewGroup.jdField_a_of_type_ComTencentMobileqqRichstatusCommentWidgetCommentsView.setOnSpanItemClick(new aveh(this));
          paramViewGroup.jdField_a_of_type_ComTencentMobileqqRichstatusCommentWidgetCommentsView.setOnItemClickListener(new avei(this, (HistorySignItem)localObject1));
          paramViewGroup.jdField_a_of_type_ComTencentMobileqqRichstatusCommentWidgetCommentsView.setOnItemLongClickListener(new avej(this, (HistorySignItem)localObject1));
          paramViewGroup.jdField_a_of_type_ComTencentMobileqqRichstatusCommentWidgetLikesView = ((LikesView)paramView.findViewById(2131303795));
          paramViewGroup.jdField_a_of_type_ComTencentMobileqqRichstatusCommentWidgetLikesView.setOnItemClickListener(new avel(this));
          paramView.setTag(paramViewGroup);
        ...
        for (;;)
        {
          ...
          paramViewGroup.j();
          return paramView;
          paramViewGroup = (avfu)paramView.getTag();
          break;
      ...
      if (paramView == null)
      {
        paramViewGroup = this.a.getActivity().getLayoutInflater().inflate(2131493742, null);
        paramViewGroup.setBackgroundColor(this.a.getResources().getColor(2131101491));
        paramView = new avem();
        ...
        paramView.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.a.getResources().getColor(2131099738));
      }
      ...
      localObject1 = (avem)paramViewGroup.getTag();
      localObject2 = new AbsListView.LayoutParams(-1, -2);
      if (SignatureHistoryFragment.a(this.a) == 3)
      {
        ((avem)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
        ((avem)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131648333));
        ((AbsListView.LayoutParams)localObject2).height = aciy.a(60.0F, this.a.getResources());
        paramViewGroup.setLayoutParams((ViewGroup.LayoutParams)localObject2);
        return paramViewGroup;
      }
      if (SignatureHistoryFragment.a(this.a) == 2)
      {
        ((avem)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
        ((avem)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(ajjy.a(2131648319));
        ((AbsListView.LayoutParams)localObject2).height = aciy.a(60.0F, this.a.getResources());
        paramViewGroup.setLayoutParams((ViewGroup.LayoutParams)localObject2);
        return paramViewGroup;
      }
    ...
    label662:
    label673:
    ((avem)localObject1).jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
    ((AbsListView.LayoutParams)localObject2).height = (awmc.b / 4);
    paramViewGroup.setLayoutParams((ViewGroup.LayoutParams)localObject2);
    return paramViewGroup;
  }
