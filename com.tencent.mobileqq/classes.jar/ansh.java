...
public class ansh
{
  ...
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new ansi(this);
  ...
  public ansh(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Ansf = ((ansf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(259));
  }
  ...
  private String b(String paramString)
  {
    if ((paramString != null) && (!"".equals(paramString)))
    {
      ...
      return ajsf.bh + akvu.a(str) + paramString + ".jpg";
    }
    return "";
  }
  ...
  public int a()
  {
    return (this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().widthPixels - axli.a(11.0F) * 2 - axli.a(2.0F) * 2) / 3;
  }
  ...
  public int a(URLDrawable paramURLDrawable)
  {
        ...
        if (ayog.b(str))
        {
          ...
          if (str != null)
          {
            ...
            if (!"".equals(str))
            {
              ...
              str = ajsf.bh + akvu.a((String)localObject) + str + ".jpg";
            }
          }
        }
      }
    ...
    try
    {
      ...
      i = aehy.a(this.jdField_a_of_type_AndroidContentContext, str);
      return i;
    }
  ...
  public Drawable a(Drawable paramDrawable, int paramInt)
  {
    ...
    for (Object localObject = Bitmap.Config.ARGB_8888;; localObject = Bitmap.Config.RGB_565)
    {
      ...
      return new BitmapDrawable(bbdr.a((Bitmap)localObject, ((Bitmap)localObject).getWidth(), ((Bitmap)localObject).getHeight()));
    }
  }
  ...
  public EmoticonFromGroupEntity a(MessageRecord paramMessageRecord)
  {
    ...
    if ((localMessageForPic.imageType == 3) || (localMessageForPic.imageType == 2000))
    {
      ...
      paramMessageRecord = aywk.a(localMessageForPic, 65537);
      ...
      paramMessageRecord = aywk.a(localMessageForPic, 1);
      if (paramMessageRecord != null) {
        break label162;
      }
    }
    ...
    if (l >= paramLong)
    {
      ...
      if (7 > i)
      {
        ...
        default: 
          return null;
        case 0: 
          return ajyc.a(2131704056);
        case 1: 
          return ajyc.a(2131704080);
        case 2: 
          return ajyc.a(2131704043);
        case 3: 
          return ajyc.a(2131704057);
        case 4: 
          return ajyc.a(2131704039);
        case 5: 
          return ajyc.a(2131704063);
        }
        return ajyc.a(2131704071);
      }
  ...
  {
    if ((paramString != null) && (!paramString.isEmpty()) && (ayog.b(paramString)))
    {
      paramString = ayog.a(paramString);
      if (paramString != null) {
  ...
  {
    return this.jdField_a_of_type_Ansf.c();
  }
  ...
  public Map<String, List<EmoticonFromGroupEntity>> a(List<EmoticonFromGroupEntity> paramList)
  {
    ...
    if (paramList != null)
    {
      ...
      {
        localObject = new TreeMap(new ansj(this));
  ...
  public void a()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("EmoticonFromGroup_Manager", 2, "init mEmoManager.mCountOfSpare:" + this.jdField_a_of_type_Ansf.b);
    }
  }
  ...
  public void a(Context paramContext, MessageForPic paramMessageForPic, View paramView)
  {
    ...
    bgkh.a(paramContext, localBundle, new AIOImageProviderService(paramMessageForPic.selfuin, null, -1, paramMessageForPic), aehy.a(paramMessageForPic), -1, -1);
  }
  
  public void a(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    this.jdField_a_of_type_Ansf.a(paramEmoticonFromGroupEntity, 2);
  }
  
  public void a(MessageRecord paramMessageRecord)
  {
    if (a(paramMessageRecord)) {
      this.jdField_a_of_type_Ansf.b(paramMessageRecord);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    for (paramString = (String)localObject;; paramString = null)
    {
      if (paramString != null)
      {
        ...
        {
          if ((ajyk.a(paramString.msg)) || (ajwd.a(paramString.msg))) {
            aptv.a(2131692668);
          }
        }
        else
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramString.msg, new ansn(localMqqHandler));
  ...
  public void a(List<MessageRecord> paramList)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Ansf.a() >= 600) || (this.jdField_a_of_type_Ansf.b() >= 300))
      {
        if (QLog.isColorLevel()) {
      ...
      else
      {
        ...
        while (paramList.hasNext())
        {
          ...
          if ((this.jdField_a_of_type_JavaUtilList.contains(localInteger)) && (!ajwd.a(localMessageRecord)) && (!asyv.a(localMessageRecord)))
          {
            if (QLog.isColorLevel()) {
              QLog.i("EmoticonFromGroup_Manager", 2, "filterMessageByType type: " + localInteger);
            }
            this.jdField_a_of_type_Ansf.a(localMessageRecord);
          }
        }
      }
    }
  ...
  public boolean a(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    ...
    if (this.jdField_a_of_type_Ansf.b < 1)
    {
      if (300 == ansp.a) {
      ...
      do
      {
        do
        {
          ...
          paramEmoticonFromGroupEntity = new ansk(this, (BaseActivity)localObject);
        } while (localObject == null);
        paramEmoticonFromGroupEntity = bbcv.a((Context)localObject, 0, ajyc.a(2131704060), ((BaseActivity)localObject).getString(2131689688), ajyc.a(2131704058), ajyc.a(2131704082), paramEmoticonFromGroupEntity, paramEmoticonFromGroupEntity);
      } while (paramEmoticonFromGroupEntity == null);
      paramEmoticonFromGroupEntity.show();
      return false;
    }
    localObject = this.jdField_a_of_type_Ansf;
    ((ansf)localObject).b -= 1;
    c(paramEmoticonFromGroupEntity);
    bcpw.a(this.jdField_a_of_type_AndroidContentContext, 2, 2131692027, 0).b(2131298865);
    return true;
  }
  ...
  {
    return this.jdField_a_of_type_Ansf.b();
  }
  
  public void b(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    this.jdField_a_of_type_Ansf.a(paramEmoticonFromGroupEntity);
  }
  ...
  {
    this.jdField_a_of_type_Ansf.a(paramList, 2);
  }
  ...
  public void c(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    ...
    {
      this.jdField_a_of_type_Ansf.jdField_a_of_type_JavaUtilList.add(localURLDrawable);
      localURLDrawable.setURLDrawableListener(new ansm(this, localURLDrawable));
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_Ansf.jdField_a_of_type_JavaUtilList.remove(localURLDrawable);
  ...
  {
    this.jdField_a_of_type_Ansf.a(paramList);
  }
