  ...
  implements Manager
{
  ...
  public aocs(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Aocu = new aocu(this, null);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(this.jdField_a_of_type_Aocu);
    this.jdField_a_of_type_Aoct = new aoct(this, null);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(this.jdField_a_of_type_Aoct);
    this.jdField_a_of_type_Aocv = new aocv(this, null);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Aocv);
  ...
  private void a(int paramInt, Object paramObject, boolean paramBoolean, Object... paramVarArgs)
  {
    ...
    Object localObject;
    boolean bool1;
    if (((paramObject instanceof aocn)) && (paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      localObject = (aocn)paramObject;
      if ((TextUtils.isEmpty(((aocn)localObject).a)) || (!((aocn)localObject).a.equals((String)paramVarArgs[0]))) {
        break label272;
      }
      bool1 = true;
    }
    for (;;)
    {
      ...
      return;
      if (((paramObject instanceof aocm)) && (paramVarArgs != null) && (paramVarArgs.length > 1))
      {
        localObject = (aocm)paramObject;
        bool1 = bool2;
        if (!TextUtils.isEmpty(((aocm)localObject).a))
        {
          bool1 = bool2;
          if (((aocm)localObject).a.equals((String)paramVarArgs[1])) {
            bool1 = true;
          }
        }
      }
      ...
      {
        if (((paramObject instanceof aoco)) && (paramVarArgs != null) && (paramVarArgs.length > 1))
        {
          localObject = (aoco)paramObject;
          if ((!TextUtils.isEmpty(((aoco)localObject).a)) && (((aoco)localObject).a.equals((String)paramVarArgs[1])))
          {
            bool1 = true;
            continue;
          }
  ...
  public String a(FaceInfo paramFaceInfo)
  {
    ...
    if (bgjq.a()) {
      localStringBuilder.append(anhk.bO);
    }
    for (;;)
    {
    ...
    if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0)) {
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        if (localIterator.hasNext()) {
          a(paramInt, (aocl)localIterator.next(), paramBoolean, paramVarArgs);
        }
      }
    }
  }
  ...
  public void a(FaceInfo paramFaceInfo)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 220	aocs:jdField_a_of_type_ComTencentMobileqqAppNearByFaceDownloader	Lcom/tencent/mobileqq/app/NearByFaceDownloader;
    //   6: astore_2
    //   7: aload_2
    //   8: ifnonnull +18 -> 26
    //   11: aload_0
    ...
    //   15: dup
    //   16: aload_0
    //   17: getfield 39	aocs:jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface	Lcom/tencent/mobileqq/nearby/NearbyAppInterface;
    ...
    //   23: putfield 220	aocs:jdField_a_of_type_ComTencentMobileqqAppNearByFaceDownloader	Lcom/tencent/mobileqq/app/NearByFaceDownloader;
    //   26: aload_0
    //   27: getfield 220	aocs:jdField_a_of_type_ComTencentMobileqqAppNearByFaceDownloader	Lcom/tencent/mobileqq/app/NearByFaceDownloader;
    //   30: ifnull +11 -> 41
    //   33: aload_0
    //   34: getfield 220	aocs:jdField_a_of_type_ComTencentMobileqqAppNearByFaceDownloader	Lcom/tencent/mobileqq/app/NearByFaceDownloader;
    //   37: aload_1
    //   38: invokevirtual 291	com/tencent/mobileqq/app/NearByFaceDownloader:b	(Lcom/tencent/mobileqq/app/face/FaceInfo;)V
    //   41: aload_0
    //   42: monitorexit
    //   43: return
    //   44: astore_2
    ...
    //   53: invokestatic 295	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   56: goto -30 -> 26
    //   59: astore_1
    //   60: aload_0
    //   61: monitorexit
  ...
  public void a(Object paramObject)
  {
    ...
    {
      return;
      if ((paramObject instanceof aocl)) {
        synchronized (this.jdField_a_of_type_JavaUtilList)
        {
          if (!this.jdField_a_of_type_JavaUtilList.contains(paramObject)) {
            this.jdField_a_of_type_JavaUtilList.add((aocl)paramObject);
          }
          return;
        }
      }
      if ((paramObject instanceof aock)) {
        synchronized (this.b)
        {
          if (!this.b.contains(paramObject)) {
            this.b.add((aock)paramObject);
          }
          return;
        }
      }
    } while (!(paramObject instanceof aocp));
    synchronized (this.c)
    {
      if (!this.c.contains(paramObject)) {
        this.c.add((aocp)paramObject);
      }
      return;
    }
  }
  ...
  public final void b(int paramInt, boolean paramBoolean, Object... paramVarArgs)
  {
    if ((this.b != null) && (this.b.size() > 0)) {
      synchronized (this.b)
      {
        ...
        if (localIterator.hasNext()) {
          a(paramInt, (aock)localIterator.next(), paramBoolean, paramVarArgs);
        }
      }
    }
  }
  ...
  public final void c(int paramInt, boolean paramBoolean, Object... paramVarArgs)
  {
    if ((this.c != null) && (this.c.size() > 0)) {
      synchronized (this.c)
      {
        ...
        if (localIterator.hasNext()) {
          a(paramInt, (aocp)localIterator.next(), paramBoolean, paramVarArgs);
        }
      }
    }
  }
  ...
  public void onDestroy()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Aocu);
      this.b.clear();
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Aoct);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Aocv);
    }
  }
}
