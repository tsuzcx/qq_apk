...
public class bhfx
{
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      if (!TextUtils.equals(ahdg.jdField_a_of_type_JavaLangString, str1))
      {
        ahdg.jdField_a_of_type_JavaLangString = str1;
        ahdg.g = false;
    ...
    if (localarjv.a > 1)
    {
      bool1 = bool2;
      label159:
      QLog.e("vip_ptt.PttUtils", 1, "ignore initAutoToTextSwitch is svip=" + bool2 + " stage=" + localarjv.a);
      if (((localardl == null) || (localardl.a())) && (!bool1)) {
        break label334;
      }
    ...
    for (;;)
    {
      ahdg.jdField_a_of_type_Long = localSharedPreferences.getLong(str2, 9223372036854775807L);
      ahdg.e = localSharedPreferences.getBoolean(str3, false);
      ahdg.g = true;
      if (!QLog.isColorLevel()) {
        break;
      }
      QLog.i("PttUtils", 2, "initAutoToTextSwitch switch:" + ahdg.d + ", time:" + ahdg.jdField_a_of_type_Long + ", hasAddTips:" + ahdg.e);
      return;
      bool1 = false;
      break label159;
      label334:
      ahdg.d = localSharedPreferences.getBoolean(str1, false);
      QLog.e("vip_ptt.PttUtils", 1, "initAutoToTextSwitch enable=" + ahdg.d);
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    for (;;)
    {
      bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8004603", "0X8004603", 0, 0, i + "", "", "", "");
      if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, int paramInt3)
  {
    if (paramInt1 == 0)
    {
      ...
      bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8006189", "0X8006189", 0, 0, "", paramInt1 + "", paramInt3 + "", "");
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      if ((paramInt2 == 1) || (paramInt2 == 2))
      {
        ...
        for (int i = 1;; i = 2)
        {
          bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8004600", "0X8004600", 0, 0, i + "", paramInt1 + "", paramInt3 + "", "");
          break;
        }
      }
      if (paramInt2 == 4) {
        bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8005C1E", "0X8005C1E", 0, 0, "", paramInt1 + "", paramInt3 + "", "");
      } else {
        bdla.b(paramQQAppInterface, "CliOper", "", "", "0X8004601", "0X8004601", 0, 0, "", paramInt1 + "", paramInt3 + "", "");
      }
    }
  }
  ...
  public static final boolean a(String paramString, int[] paramArrayOfInt)
  {
    ...
    //   49: aload 4
    //   51: aload_1
    //   52: invokestatic 343	bhfx:a	(Ljava/io/ByteArrayInputStream;[I)Z
    //   55: istore_2
    //   56: iload_2
    //   57: istore_3
    //   58: iload_3
