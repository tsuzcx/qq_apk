...
public class xso
{
  public static void a(Activity paramActivity)
  {
    ...
    while (kzy.b(BaseApplicationImpl.getContext())) {
      return;
    }
    if (!azzz.b())
    {
    ...
    Object localObject = ajed.aU + "shortvideo/" + System.currentTimeMillis() + ".mp4";
      ...
      do
      {
        ...
        if ((localMessageRecord instanceof MessageForDevShortVideo))
        {
          ...
          if (!paramSession.bSend) {
            if (paramSession.actionInfo.strServiceName.equalsIgnoreCase(xvq.e))
            {
              Object localObject3 = new xsn();
              ((xsn)localObject3).a = paramSession.strFilePathSrc;
              ((xsn)localObject3).a();
              ((MessageForDevShortVideo)localObject2).md5 = ((xsn)localObject3).jdField_c_of_type_JavaLangString;
              ((MessageForDevShortVideo)localObject2).videoFileTime = ((int)(((xsn)localObject3).jdField_b_of_type_Long / 1000L));
              ((MessageForDevShortVideo)localObject2).thumbWidth = ((xsn)localObject3).jdField_b_of_type_Int;
              ((MessageForDevShortVideo)localObject2).thumbHeight = ((xsn)localObject3).jdField_c_of_type_Int;
              ((MessageForDevShortVideo)localObject2).thumbMD5 = ((xsn)localObject3).e;
              if (!paramBoolean) {
                break label282;
              }
              ...
              bace.b(paramSession.strFilePathSrc, (String)localObject3);
            }
          }
          for (;;)
          {
