...
public class afem
  implements aiod
{
  public afem(AddContactsView paramAddContactsView) {}
  ...
  public void b()
  {
    ...
    this.a.e();
    this.a.jdField_a_of_type_ComTencentWidgetSwipListView.getViewTreeObserver().addOnGlobalLayoutListener(new afen(this));
  }
}
