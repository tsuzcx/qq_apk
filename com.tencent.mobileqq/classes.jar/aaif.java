  ...
  implements SurfaceTexture.OnFrameAvailableListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, ARBaseRender
{
  ...
  private KeyingBase.UserInterface jdField_a_of_type_ComTencentMobileqqArKeyingKeyingBase$UserInterface = new aaig(this);
  ...
  private Runnable jdField_a_of_type_JavaLangRunnable = new aaih(this);
  ...
  public aaif(ARRenderMangerInnerCallback paramARRenderMangerInnerCallback, NormalVideoARResourceInfo paramNormalVideoARResourceInfo)
  {
  ...
  public void a(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3, float[] paramArrayOfFloat4)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqArARRenderModelNormalVideoARResourceInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqArARRenderModelNormalVideoARResourceInfo.jdField_b_of_type_Int == 1)) {
      if (this.jdField_a_of_type_ComTencentMobileqqArKeyingKeyingBase != null)
      {
        ...
        paramArrayOfFloat2.a(new int[] { j }, localKeyingParams, paramArrayOfFloat1, paramArrayOfFloat3);
      }
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqArKeyingKeyingBase != null)
      {
        ...
        paramArrayOfFloat3.a(new int[] { j }, localKeyingParams, paramArrayOfFloat1, paramArrayOfFloat2);
      }
    }
  }
  ...
  public void b()
  {
    ...
    //   4: iconst_1
    //   5: ldc_w 377
    //   8: invokestatic 145	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   11: invokestatic 222	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   14: ifeq +29 -> 43
    //   17: ldc 123
    //   19: iconst_2
    ...
    //   33: aload_0
    //   34: invokevirtual 382	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   37: invokevirtual 140	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   40: invokestatic 145	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   43: aload_0
    //   44: getfield 344	aaif:jdField_b_of_type_Boolean	Z
    //   47: ifne +20 -> 67
    //   50: aload_0
    //   51: getfield 168	aaif:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   54: ifnull +13 -> 67
    //   57: aload_0
    //   58: getfield 168	aaif:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   61: invokevirtual 385	android/media/MediaPlayer:isPlaying	()Z
    //   64: ifeq +52 -> 116
    //   67: invokestatic 222	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   70: ifeq +45 -> 115
    //   73: ldc 123
    //   75: iconst_2
    //   76: new 125	java/lang/StringBuilder
    //   79: dup
    //   80: invokespecial 126	java/lang/StringBuilder:<init>	()V
    //   83: ldc_w 387
    //   86: invokevirtual 132	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   89: aload_0
    //   90: getfield 344	aaif:jdField_b_of_type_Boolean	Z
    //   93: invokevirtual 137	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   96: ldc_w 389
    //   99: invokevirtual 132	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   102: aload_0
    //   103: getfield 168	aaif:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   106: invokevirtual 382	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   109: invokevirtual 140	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   112: invokestatic 145	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   115: return
    //   116: aload_0
    //   117: iconst_0
    //   118: putfield 391	aaif:h	Z
    //   121: aload_0
    //   122: iconst_0
    //   123: putfield 319	aaif:jdField_e_of_type_Boolean	Z
    //   126: new 393	java/io/FileInputStream
    //   129: dup
    //   130: new 154	java/io/File
    //   133: dup
    //   134: aload_0
    //   135: getfield 80	aaif:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   138: invokespecial 157	java/io/File:<init>	(Ljava/lang/String;)V
    //   141: invokespecial 396	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   144: astore_3
    //   145: aload_3
    //   146: astore_2
    //   147: aload_3
    //   148: invokevirtual 400	java/io/FileInputStream:getFD	()Ljava/io/FileDescriptor;
    //   151: astore 4
    //   153: aload_3
    //   154: astore_2
    //   155: aload_0
    //   156: getfield 168	aaif:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   159: aload 4
    //   161: invokevirtual 404	android/media/MediaPlayer:setDataSource	(Ljava/io/FileDescriptor;)V
    //   164: aload_3
    //   165: astore_2
    //   166: aload_0
    //   167: iconst_1
    //   168: putfield 288	aaif:jdField_b_of_type_Int	I
    //   171: aload_3
    //   172: astore_2
    //   173: aload_0
    //   174: getfield 168	aaif:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   177: astore 4
    //   179: aload_3
    //   180: astore_2
    //   181: aload_0
    //   182: getfield 50	aaif:jdField_c_of_type_Int	I
    //   185: ifne +96 -> 281
    //   188: aload_3
    //   189: astore_2
    //   190: aload 4
    //   192: iload_1
    //   193: invokevirtual 192	android/media/MediaPlayer:setLooping	(Z)V
    //   196: aload_3
    //   197: astore_2
    //   198: aload_0
    //   199: iconst_1
    //   200: putfield 346	aaif:g	Z
    //   203: aload_3
    //   204: astore_2
    //   205: aload_0
    //   206: getfield 168	aaif:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   209: invokevirtual 407	android/media/MediaPlayer:prepare	()V
    //   212: aload_3
    //   213: astore_2
    //   214: aload_0
    //   215: iconst_0
    //   216: putfield 342	aaif:f	Z
    //   219: aload_3
    //   220: astore_2
    //   221: aload_0
    //   222: getfield 168	aaif:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   225: invokevirtual 409	android/media/MediaPlayer:start	()V
    //   228: aload_3
    //   229: astore_2
    //   230: aload_0
    //   231: iconst_1
    //   232: putfield 344	aaif:jdField_b_of_type_Boolean	Z
    //   235: aload_3
    //   236: astore_2
    //   237: aload_0
    //   238: getfield 72	aaif:jdField_a_of_type_ComTencentMobileqqArARRenderModelARRenderMangerInnerCallback	Lcom/tencent/mobileqq/ar/ARRenderModel/ARRenderMangerInnerCallback;
    //   241: ifnull +19 -> 260
    //   244: aload_3
    //   245: astore_2
    //   246: aload_0
    //   247: getfield 72	aaif:jdField_a_of_type_ComTencentMobileqqArARRenderModelARRenderMangerInnerCallback	Lcom/tencent/mobileqq/ar/ARRenderModel/ARRenderMangerInnerCallback;
    //   250: iconst_0
    //   251: aload_0
    //   252: getfield 50	aaif:jdField_c_of_type_Int	I
    //   255: invokeinterface 413 3 0
    //   260: aload_3
    //   261: ifnull -146 -> 115
    //   264: aload_3
    //   265: invokevirtual 416	java/io/FileInputStream:close	()V
    //   268: return
    //   269: astore_2
    //   270: invokestatic 222	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   273: ifeq -158 -> 115
    //   276: aload_2
    //   277: invokevirtual 225	java/lang/Throwable:printStackTrace	()V
    //   280: return
    //   281: iconst_0
    //   282: istore_1
    //   283: goto -95 -> 188
    ...
    //   292: ldc 123
    //   294: iconst_2
    //   295: new 125	java/lang/StringBuilder
    //   298: dup
    //   299: invokespecial 126	java/lang/StringBuilder:<init>	()V
    //   302: ldc_w 418
    //   305: invokevirtual 132	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   308: aload 4
    //   310: invokevirtual 419	java/io/IOException:getMessage	()Ljava/lang/String;
    //   313: invokevirtual 132	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   316: invokevirtual 140	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   319: invokestatic 145	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   322: aload_3
    //   323: astore_2
    //   324: invokestatic 222	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   327: ifeq +10 -> 337
    //   330: aload_3
    //   331: astore_2
    //   332: aload 4
    //   334: invokevirtual 420	java/io/IOException:printStackTrace	()V
    //   337: aload_3
    //   338: astore_2
    //   339: aload_0
    //   340: invokevirtual 422	aaif:d	()V
    //   343: aload_3
    //   344: ifnull -229 -> 115
    //   347: aload_3
    //   348: invokevirtual 416	java/io/FileInputStream:close	()V
    //   351: return
    //   352: astore_2
    //   353: invokestatic 222	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   356: ifeq -241 -> 115
    //   359: aload_2
    //   360: invokevirtual 225	java/lang/Throwable:printStackTrace	()V
    //   363: return
    //   364: astore 4
    //   366: aconst_null
    //   367: astore_3
    ...
    //   370: ldc 123
    //   372: iconst_2
    //   373: new 125	java/lang/StringBuilder
    //   376: dup
    //   377: invokespecial 126	java/lang/StringBuilder:<init>	()V
    //   380: ldc_w 424
    //   383: invokevirtual 132	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   386: aload 4
    //   388: invokevirtual 219	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   391: invokevirtual 132	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   394: invokevirtual 140	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   397: invokestatic 145	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   400: aload_3
    //   401: astore_2
    //   402: invokestatic 222	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   405: ifeq +10 -> 415
    //   408: aload_3
    //   409: astore_2
    //   410: aload 4
    //   412: invokevirtual 225	java/lang/Throwable:printStackTrace	()V
    //   415: aload_3
    //   416: astore_2
    //   417: aload_0
    //   418: invokevirtual 422	aaif:d	()V
    //   421: aload_3
    //   422: ifnull -307 -> 115
    //   425: aload_3
    //   426: invokevirtual 416	java/io/FileInputStream:close	()V
    //   429: return
    //   430: astore_2
    //   431: invokestatic 222	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   434: ifeq -319 -> 115
    //   437: aload_2
    //   438: invokevirtual 225	java/lang/Throwable:printStackTrace	()V
    //   441: return
    //   442: astore_3
    //   443: aconst_null
    //   444: astore_2
    ...
    //   446: ifnull +7 -> 453
    //   449: aload_2
    //   450: invokevirtual 416	java/io/FileInputStream:close	()V
    //   453: aload_3
    //   454: athrow
    //   455: astore_2
    ...
    //   459: ifeq -6 -> 453
    //   462: aload_2
    //   463: invokevirtual 225	java/lang/Throwable:printStackTrace	()V
    //   466: goto -13 -> 453
    //   469: astore_3
    //   470: goto -25 -> 445
    //   473: astore 4
  ...
  public void onCompletion(MediaPlayer paramMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqArARRenderModelARRenderMangerInnerCallback != null) {
      this.jdField_a_of_type_ComTencentMobileqqArARRenderModelARRenderMangerInnerCallback.a(2, this.jdField_c_of_type_Int - this.jdField_b_of_type_Int);
    }
  ...
  public boolean onError(MediaPlayer paramMediaPlayer, int paramInt1, int paramInt2)
  {
    ...
    StatisticCollector.a(BaseApplicationImpl.getContext()).a("", "immersed_ar_on_error", true, 0L, 0L, paramMediaPlayer, "", false);
    d();
    return false;
  }
