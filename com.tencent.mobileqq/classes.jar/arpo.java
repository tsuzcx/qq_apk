  ...
  implements afqs, afto
{
  ...
  MqqHandler jdField_a_of_type_MqqOsMqqHandler = new MqqHandler(Looper.getMainLooper(), new arpp(this));
  private boolean jdField_a_of_type_Boolean;
  
  public arpo(Activity paramActivity)
  {
    super(paramActivity);
  ...
  public static boolean a()
  {
    ...
    return (localamta != null) && (localamta.f());
  }
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewPullrefreshCommonRefreshLayout = ((CommonRefreshLayout)paramView.findViewById(2131376744));
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewPullrefreshContactRefreshHeader.setRefreshHeaderUpdateListener(new arpq(this));
