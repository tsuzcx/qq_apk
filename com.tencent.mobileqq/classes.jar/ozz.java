  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   3: aload_0
    //   4: getfield 12	ozz:a	Ljava/lang/String;
    ...
    //   18: astore 4
    //   20: aload_0
    //   21: getfield 12	ozz:a	Ljava/lang/String;
    ...
    //   47: aload_0
    //   48: getfield 12	ozz:a	Ljava/lang/String;
    ...
    //   161: aload_0
    //   162: getfield 12	ozz:a	Ljava/lang/String;
    //   165: aload 4
    //   167: invokevirtual 93	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   170: pop
    //   171: return
    //   172: new 95	java/util/zip/ZipFile
    //   175: dup
    //   176: aload_2
    //   177: invokespecial 98	java/util/zip/ZipFile:<init>	(Ljava/io/File;)V
    //   180: astore_3
    //   181: aload_3
    //   182: astore_2
    //   183: aload_3
    //   184: invokevirtual 102	java/util/zip/ZipFile:entries	()Ljava/util/Enumeration;
    //   187: astore 6
    //   189: aload_3
    //   190: astore_2
    //   191: aload_3
    //   192: invokevirtual 106	java/util/zip/ZipFile:size	()I
    //   195: ifne +153 -> 348
    //   198: bipush 16
    //   200: istore_1
    //   201: aload_3
    ...
    //   334: ifnull -299 -> 35
    //   337: aload_3
    //   338: invokevirtual 139	java/util/zip/ZipFile:close	()V
    //   341: return
    //   342: astore_2
    //   343: aload_2
    ...
    //   349: astore_2
    //   350: aload_3
    //   351: invokevirtual 106	java/util/zip/ZipFile:size	()I
    //   354: sipush 128
    //   357: imul
    //   358: istore_1
    //   359: goto -158 -> 201
    ...
    //   388: aload_0
    //   389: getfield 12	ozz:a	Ljava/lang/String;
    //   392: aload 4
    ...
    //   399: ifnull -364 -> 35
    //   402: aload_3
    //   403: invokevirtual 139	java/util/zip/ZipFile:close	()V
    //   406: return
    //   407: astore_2
    //   408: aload_2
    ...
    //   417: ifnull +7 -> 424
    //   420: aload_2
    //   421: invokevirtual 139	java/util/zip/ZipFile:close	()V
    //   424: aload_3
    //   425: athrow
    //   426: astore_2
    //   427: aload_2
    ...
    //   180	223	3	localZipFile	java.util.zip.ZipFile
