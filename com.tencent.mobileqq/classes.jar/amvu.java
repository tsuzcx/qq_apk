  ...
  implements SurfaceTexture.OnFrameAvailableListener, GLSurfaceView.Renderer
{
  ...
  amvt jdField_a_of_type_Amvt = new amvt();
  ...
  private amvv[] jdField_a_of_type_ArrayOfAmvv = new amvv[300];
  ...
  public amvu(amvj paramamvj)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Amvj = paramamvj;
    this.jdField_a_of_type_Amvo = paramamvj.a();
  }
  
  public int a()
  {
    return this.jdField_a_of_type_Amvt.a();
  }
  ...
  protected void a()
  {
    ...
    try
    {
      ...
      localObject = BitmapFactory.decodeResource(BaseApplicationImpl.getApplication().getResources(), 2130844485, (BitmapFactory.Options)localObject);
      if (localObject != null)
      {
    ...
    try
    {
      localObject = new BitmapFactory.Options();
      ((BitmapFactory.Options)localObject).inPreferredConfig = Bitmap.Config.ARGB_8888;
      localObject = BitmapFactory.decodeResource(this.jdField_a_of_type_Amvj.a().getResources(), 2130844486, (BitmapFactory.Options)localObject);
      if (localObject != null)
      {
        GLUtils.texImage2D(3553, 0, (Bitmap)localObject, 0);
        ((Bitmap)localObject).recycle();
  ...
  {
    this.u = 1;
    this.jdField_a_of_type_Amvo.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_Amvo.c = 0L;
    this.jdField_a_of_type_Amvo.jdField_b_of_type_Long = 0L;
  ...
  public void a(FloatBuffer paramFloatBuffer, Size paramSize)
  {
    ...
    if ((this.jdField_a_of_type_AndroidUtilSize == null) && (this.jdField_a_of_type_Amvt != null))
    {
      this.jdField_a_of_type_AndroidUtilSize = paramSize;
      this.jdField_a_of_type_Amvt.a(paramSize.getHeight(), paramSize.getWidth(), angf.jdField_a_of_type_Int, angf.jdField_b_of_type_Int);
    }
  }
  ...
  public void c()
  {
    ...
    if (i4 < 300)
    {
      localamvv2 = this.jdField_a_of_type_ArrayOfAmvv[i4];
      if ((localamvv2 != null) && (!localamvv2.jdField_a_of_type_Boolean))
      {
        if (this.jdField_a_of_type_JavaUtilRandom.nextFloat() > 0.7F - localamvv2.jdField_b_of_type_Float * 0.35F - Math.abs(localamvv2.jdField_a_of_type_Float * 0.3F - 0.15F)) {
          localamvv2.jdField_a_of_type_Boolean = true;
        }
      }
      else
      {
        if (localamvv2 != null)
        {
          localamvv1 = localamvv2;
          i3 = i2;
          if (!localamvv2.jdField_a_of_type_Boolean) {
            break label370;
          }
        }
        if (i2 <= i7) {
    ...
    for (;;)
    {
      ...
      float f4 = localamvv2.jdField_b_of_type_Float;
      localamvv2.jdField_b_of_type_Float = (f3 * 0.3F + 0.2F * localamvv2.jdField_b_of_type_Float + f2 + f4);
      if (localamvv2.jdField_b_of_type_Float <= 1.0D) {
        break label184;
      }
      localamvv2.jdField_a_of_type_Boolean = true;
      break label184;
      ...
      if (localamvv2 == null)
      {
        localamvv1 = new amvv(this);
        this.jdField_a_of_type_ArrayOfAmvv[i4] = localamvv1;
      }
      f3 = this.jdField_a_of_type_JavaUtilRandom.nextFloat();
      if (f3 < 0.4D) {
        localamvv1.jdField_a_of_type_Float = (f3 * 2.35F + 0.02F);
      }
      for (;;)
      {
        localamvv1.jdField_b_of_type_Float = (this.jdField_a_of_type_JavaUtilRandom.nextFloat() * 0.05F + f1);
        localamvv1.jdField_a_of_type_Boolean = false;
        i3 = i2 + 1;
        label370:
        if ((localamvv1 == null) || (localamvv1.jdField_a_of_type_Boolean) || (localamvv1.jdField_b_of_type_Float >= 1.0D)) {
          break label542;
        }
        this.jdField_c_of_type_ArrayOfFloat[(i1 * 2)] = (this.jdField_a_of_type_ArrayOfAmvv[i4].jdField_a_of_type_Float * i5);
        this.jdField_c_of_type_ArrayOfFloat[(i1 * 2 + 1)] = (this.jdField_a_of_type_ArrayOfAmvv[i4].jdField_b_of_type_Float * i6);
        i1 += 1;
        i2 = i3;
        break;
        if (f3 > 0.6F) {
          localamvv1.jdField_a_of_type_Float = ((1.0F - f3) * 2.35F + 0.02F);
        }
      }
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Amvo.jdField_a_of_type_Long == 0L) {
        break;
      }
      while (this.jdField_a_of_type_Amvo.c > this.jdField_a_of_type_Amvo.jdField_b_of_type_Long)
      {
        paramGL10 = this.jdField_a_of_type_Amvo;
      ...
      continue;
      label318:
      if ((this.jdField_a_of_type_Amvt != null) && (this.u == 2)) {
        this.jdField_a_of_type_Amvt.a(this.jdField_a_of_type_JavaNioFloatBuffer);
      }
    }
  }
  ...
  public void onSurfaceCreated(GL10 paramGL10, EGLConfig paramEGLConfig)
  {
    ...
    a();
    if (anaf.a() != null) {
      this.jdField_a_of_type_Amvt.a(BaseApplicationImpl.getContext());
    }
  }
}
