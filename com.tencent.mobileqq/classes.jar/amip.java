...
public class amip
{
  ...
  public static String aC = amtj.a(2131699468);
  public static String aD = amtj.a(2131699467);
  ...
  public static String aH = amtj.a(2131699466);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = VFSAssistantUtils.getSDKPrivatePath(AppConstants.SDCARD_PATH + "/.apollo");
    ...
    localStringBuilder.append("?client=androidQQ").append("&version=").append("8.4.8.4810").append("&system=").append(Build.VERSION.RELEASE).append("&device=").append(Build.DEVICE);
