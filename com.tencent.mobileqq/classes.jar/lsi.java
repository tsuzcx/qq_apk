...
public class lsi
  implements mse
{
  public lsi(RandomController paramRandomController) {}
  
  public void a(String paramString, msf parammsf)
  {
    if (QLog.isColorLevel()) {
      QLog.d("RandomController", 2, "onGetNearbyPeopleProfile uin :" + paramString + ", nickname:" + parammsf.b + ", gender:" + parammsf.a);
    }
    if (paramString.equals(RandomController.a(this.a).getAccount()))
    {
      if (parammsf.a != -1) {
        RandomController.a(this.a).a(parammsf.a);
      }
