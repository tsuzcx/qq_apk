  ...
  extends qhj
{
  ...
  public qfx(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qxn paramqxn, Handler paramHandler)
  {
    ...
    for (paramFromServiceMsg = localRspBody.rpt_uint32_default_interest_label_id_list.get();; paramFromServiceMsg = null)
    {
      ...
      if (localRspBody.rpt_interest_label_list.has())
      {
        ...
        if (localRspBody.rpt_interest_label_list.get() != null) {
          paramToServiceMsg = qxm.a(localRspBody.rpt_interest_label_list.get(), paramFromServiceMsg);
        }
      }
      ...
      for (;;)
      {
        ...
        return;
        paramToServiceMsg = qxm.a(null, null);
        continue;
        bool = true;
      }
    }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    a(qxp.a("OidbSvc.0x6e5", 1765, 0, localReqBody.toByteArray()));
  }
  ...
  {
    b(qxp.a(paramFromServiceMsg, paramObject, new oidb_cmd0x6e4.RspBody()));
  }
}
