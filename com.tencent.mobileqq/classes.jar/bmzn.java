...
public class bmzn
{
  private final bmzt jdField_a_of_type_Bmzt = new bmzt(null);
  private final bmzu jdField_a_of_type_Bmzu = new bmzu(null);
  ...
  public static String a(@Nullable BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    {
      paramAppInfo = bmzs.a(paramAppInfo);
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1 = "&trace_detail=base64-" + axse.a(localJSONObject.toString());
      return paramString1;
    }
  ...
  {
    if (paramAppInfo != null) {
      return String.format("&trace_detail=base64-%s", new Object[] { axse.a(bmzr.a(paramAppInfo).a()) });
    }
    return null;
  }
  ...
  public void a(@Nullable BusinessInfoCheckUpdate.AppInfo paramAppInfo, int paramInt)
  {
    ...
    bmzs localbmzs = bmzs.a(paramAppInfo);
    ItemInfo localItemInfo = new bmzq().a(localbmzs.b).c(paramAppInfo.buffer.get()).a(new bmzp(System.currentTimeMillis(), paramInt).a()).a();
    ...
    for (;;)
    {
      QLog.d("MobileReport.Manager", 2, "report " + localbmzs.toString() + " actionId = " + paramAppInfo);
      this.jdField_a_of_type_Bmzu.a(localbmzs, localItemInfo);
      return;
      label119:
      if (101 == paramInt) {
  ...
  public void a(String paramString1, int paramInt1, long paramLong, String paramString2, int paramInt2, String paramString3)
  {
    ...
    {
      localbmzs = new bmzs("", 0, "", 0, "H5CostReport", paramString1);
    ...
    try
    {
      ...
      paramString3 = new bmzq().a("").c(localJSONObject.toString()).a(new bmzp(System.currentTimeMillis(), paramInt1, paramLong).a()).a();
      if (QLog.isColorLevel()) {
        QLog.d("MobileReport.Manager", 2, "report " + localbmzs.toString() + " opType = " + paramInt1 + " url = " + paramString1 + " timecost " + paramLong + " errorcode " + paramString2);
      }
      this.jdField_a_of_type_Bmzu.a(localbmzs, paramString3);
      return;
    }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    if ((!TextUtils.isEmpty(paramString1)) && (paramString1.contains("h5costreport=1")))
    {
      localbmzs = new bmzs("", 0, "", 0, "JumpUrlReport", paramString1);
      localObject = new JSONObject();
    }
    try
    {
      ((JSONObject)localObject).put("jump_url", paramString2);
      String str = bnwt.a(paramString1).getString("adId");
      localObject = new bmzq().a(String.valueOf(str)).c(((JSONObject)localObject).toString()).a(new bmzp(System.currentTimeMillis(), 152, 1L).a()).a();
      if (QLog.isColorLevel()) {
        QLog.d("MobileReport.Manager", 2, "report " + localbmzs.toString() + " opType = " + 152 + " url = " + paramString1 + " jumpUrl = " + paramString2);
      }
      this.jdField_a_of_type_Bmzu.a(localbmzs, (ItemInfo)localObject);
      return;
    }
  ...
  {
    paramString1 = new bmzs("", 1, "", -1, paramString1, paramString2);
    if (QLog.isColorLevel()) {
      QLog.d("MobileReport.Manager", 2, "report " + paramString1.toString() + " actionId = " + paramItemInfo.toString());
    }
    this.jdField_a_of_type_Bmzt.a(paramString1, paramItemInfo);
  }
  ...
  {
    paramString2 = new bmzs("", 1, "", -1, paramString1, paramString2);
    paramString3 = new bmzq().a(paramString4).b(paramString5).d(paramString3).a(new bmzp(System.currentTimeMillis(), paramInt1, paramInt2).a()).a();
    if (QLog.isColorLevel())
    {
      if (102 != paramInt1) {
        break label137;
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bmzu.a(paramString2, paramString3);
      return;
      label137:
      if (101 == paramInt1) {
  ...
  {
    paramString4 = new bmzs("", 1, "", -1, paramString3, paramString4);
    bmzq localbmzq = new bmzq();
    paramString3 = paramString1;
    if (paramString1 == null) {
      paramString3 = "";
    }
    paramString3 = localbmzq.a(paramString3).d(paramString5).a(new bmzp(paramLong, paramInt1, paramInt2).a()).a();
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bmzu.a(paramString4, paramString3);
      return;
      label150:
      if (101 == paramInt1) {
        paramString1 = "ITEM_EXPORT";
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, int paramInt2, long paramLong, String paramString6)
  {
    ...
    paramString3 = localbmzq.a(paramString3).d(paramString5).c("{\"roomid\":\"" + paramString6 + "\"}").a(new bmzp(paramLong, paramInt1, paramInt2).a()).a();
    paramString1 = paramString2;
    if (paramString2 == null) {
      paramString1 = "";
    }
    ...
    {
      QLog.d("MobileReport.Manager", 2, "report " + paramString4.toString() + " actionId = " + paramString1);
      this.jdField_a_of_type_Bmzt.a(paramString4, paramString3);
      return;
      label180:
      if (101 == paramInt1) {
        paramString1 = "ITEM_EXPORT";
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, int paramInt1, int paramInt2)
  {
    ...
    paramString3 = localbmzq.a(paramString1).d(paramString3).a(new bmzp(System.currentTimeMillis(), paramInt1, paramInt2).a()).a();
