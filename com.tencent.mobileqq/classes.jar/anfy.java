...
public class anfy
{
  public static String a(QQAppInterface paramQQAppInterface, batm parambatm, boolean paramBoolean)
  {
    ArrayList localArrayList = null;
    if ((paramQQAppInterface == null) && (parambatm == null)) {}
    EmoticonPackage localEmoticonPackage;
    do
    {
      return null;
      localObject = parambatm.a();
      localEmoticonPackage = (EmoticonPackage)((Bundle)localObject).getSerializable("emoticonPackage");
    } while (localEmoticonPackage == null);
    int i = ((Bundle)localObject).getInt("jsonType", anfj.c);
    File localFile = (File)parambatm.jdField_a_of_type_JavaUtilMap.get(parambatm.jdField_a_of_type_JavaLangString);
    Object localObject = new angh();
    parambatm = localArrayList;
    if (localFile != null)
    {
      if (localFile.exists()) {
        parambatm = bace.a(localFile);
      }
    }
    else
    {
    ...
    label162:
    for (paramQQAppInterface = a(paramQQAppInterface, localEmoticonPackage, i, parambatm, localArrayList);; paramQQAppInterface = a(paramQQAppInterface, localEmoticonPackage, i, parambatm, localArrayList, (angh)localObject))
    {
  ...
  public static String a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, int paramInt, byte[] paramArrayOfByte, ArrayList<Emoticon> paramArrayList)
  {
    ...
    arnz localarnz = (arnz)paramQQAppInterface.getManager(14);
    Object localObject1;
    Object localObject2;
    String str1;
    try
    ...
    catch (JSONException paramQQAppInterface)
    {
      for (;;)
      {
        ...
        paramArrayOfByte = localarnz.b(paramEmoticonPackage.epId);
    ...
    localarnz.a(paramEmoticonPackage);
    if (QLog.isColorLevel()) {
    ...
    if (j < m)
    {
      ...
      paramQQAppInterface = localarnz.a(str1, (String)localObject1);
      if (paramQQAppInterface == null)
      {
        if (paramInt == anfj.d) {
          break label1013;
  ...
  public static String a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, int paramInt, byte[] paramArrayOfByte, ArrayList<Emoticon> paramArrayList, angh paramangh)
  {
    if (QLog.isColorLevel()) {
    ...
    if ((paramArrayList == null) || (paramangh == null))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramArrayOfByte.has("type")) && (1 == j))
    {
      ...
      if (paramEmoticonPackage.copywritingType != arny.a)
      {
      ...
      paramQQAppInterface = localarnz.b(str1);
      if (paramQQAppInterface != null)
      {
      ...
      if ((paramEmoticonPackage.mobileFeetype == 1) || ((str1 != null) && ("10278".equals(str1))) || (paramEmoticonPackage.jobType == 1))
      {
        ...
        localObject2 = localarnz.a(str1, str2);
