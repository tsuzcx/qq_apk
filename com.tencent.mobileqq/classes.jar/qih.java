  ...
  implements axme
{
  ...
  qih(qig paramqig, String paramString, int paramInt1, int paramInt2, long paramLong1, long paramLong2)
  {
  ...
  public axmf a(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 <= paramInt2)
    {
      ...
      paramInt1 = j;
      label87:
      localaxmf.jdField_a_of_type_Int = ((int)(i * 1.0F / 640.0F * paramInt1));
      localaxmf.jdField_a_of_type_Float = (paramInt1 / paramInt2);
    ...
    {
      localaxmf.jdField_b_of_type_Int = j;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("ReadInJoyUploadVideoCompressTask", 2, "CompressTask, step: getEncodeConfig()\n quality:" + (String)localObject + ", sourceLongEdge:" + paramInt2 + ", targetLongEdge:" + paramInt1 + ", scaleRate:" + localaxmf.jdField_a_of_type_Float + "\n defaultBitRate:" + i + ", videoBitRate:" + localaxmf.jdField_a_of_type_Int + ", videoFrameRate:" + localaxmf.jdField_b_of_type_Int + "\n setRotation:" + localaxmf.jdField_b_of_type_Boolean + ", beginTime:" + localaxmf.jdField_a_of_type_Long + ", endTime:" + localaxmf.jdField_b_of_type_Long);
      }
      return localaxmf;
      paramInt2 = paramInt1;
      break;
  ...
  {
    if ((this.jdField_a_of_type_Qig.a != null) && (!this.jdField_a_of_type_Qig.isCancelled())) {
      this.jdField_a_of_type_Qig.a.a(paramInt / 100.0F);
    }
  }
