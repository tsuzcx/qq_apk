  ...
  extends WebViewPlugin
{
  ...
  final ymm jdField_a_of_type_Ymm = new asyv(this);
  private int b;
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ((this.jdField_a_of_type_Ymk == null) || (paramString1 == null) || (!"nowlive".equals(paramString2)) || (paramString3 == null)) {}
    label318:
    do
    {
      return false;
      ...
      for (;;)
      {
        ...
        if ("openRoom".equals(paramString3))
        {
          ...
          this.jdField_a_of_type_Ymk.a(Long.valueOf(paramJsBridgeListener).longValue());
          continue;
        }
        if ("install".equals(paramString3))
        {
          ...
          for (;;)
          {
            try
            {
              ...
              paramJsBridgeListener = this.jdField_a_of_type_Ymk;
              if (i == 1) {
                bool = true;
              }
  ...
  public void onCreate()
  {
    ...
    this.jdField_a_of_type_Ymk.h(this.jdField_a_of_type_Ymm);
  }
