  ...
  extends agsl
{
  ...
  public agrg(String paramString1, String paramString2)
  {
  ...
  public boolean a(acsj paramacsj, String paramString, float paramFloat, int paramInt)
  {
    if ((paramacsj == null) || (TextUtils.isEmpty(paramString))) {}
    do
    {
      do
      {
        return false;
        paramacsj = agry.a(paramacsj, 28, 28);
        localObject1 = a(paramacsj);
        agry.a(paramacsj);
      } while (localObject1 == null);
      Object localObject1 = a((float[][][][])localObject1);
      paramacsj = new HashSet();
      ...
      if (localObject1 != null)
      {
        ...
        while (paramInt < this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          {
            ((List)localObject2).add(new agri((String)this.jdField_a_of_type_JavaUtilList.get(paramInt), localObject1[paramInt]));
            if ((localObject1[paramInt] > paramFloat) && (this.jdField_a_of_type_JavaUtilList.size() > paramInt)) {
              paramacsj.add(this.jdField_a_of_type_JavaUtilList.get(paramInt));
            }
          }
          paramInt += 1;
        }
      }
      Collections.sort((List)localObject2, new agrh(this));
      localObject1 = new StringBuilder();
      localObject2 = ((List)localObject2).iterator();
      while (((Iterator)localObject2).hasNext())
      {
        agri localagri = (agri)((Iterator)localObject2).next();
        ((StringBuilder)localObject1).append(localagri.jdField_a_of_type_JavaLangString + ":" + localagri.jdField_a_of_type_Float + "\n");
      }
      ...
      if (paramacsj.contains(paramString))
      {
        if (QLog.isColorLevel()) {
