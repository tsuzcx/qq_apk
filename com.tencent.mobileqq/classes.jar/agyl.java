...
{
  public agyl(ApolloItemBuilder paramApolloItemBuilder) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        for (;;)
        {
          ...
          amsx.jdField_a_of_type_JavaUtilArrayList.clear();
          localagyp = (agyp)agej.a(paramView);
          localObject1 = (MessageForApollo)localagyp.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          ...
          else
          {
            ...
            QQToast.a(paramView.getContext(), anzj.a(2131699321), 0).a();
          }
        }
      } while (!amsx.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()));
      int j = ((amsx)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
      ...
      if (j != 2)
      {
        localagyp.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.setFailedIconVisable(true, this);
        if (!amsx.jdField_a_of_type_JavaUtilHashSet.contains(Integer.valueOf(localagyp.e))) {
          amsx.jdField_a_of_type_JavaUtilHashSet.add(Integer.valueOf(localagyp.e));
        }
      }
    } while (!bhnv.g(this.a.jdField_a_of_type_AndroidContentContext));
    ...
    for (;;)
    {
      ...
      if ((localObject1 != null) && (this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null)) {
        VipUtils.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "cmshow", "Apollo", "new_clk_action", this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, ApolloUtil.b(((BaseChatPie)localObject1).b()), anlk.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), new String[] { String.valueOf(localagyp.e), "", "", String.valueOf(System.currentTimeMillis() / 1000L) });
      }
      this.a.a(localagyp, 2);
      break;
      label629:
      i = 0;
      break label251;
