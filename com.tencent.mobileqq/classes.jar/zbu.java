  ...
  extends WebViewPlugin
{
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Nad == null) {
      this.jdField_a_of_type_Nad = new nad(this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView, new zbv(this));
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getLayoutInflater().inflate(2131558965, null));
        this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378059));
        this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378053));
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_AndroidWidgetImageView != null) {
          this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new zbw(this));
        }
