...
public class lkw
{
  ...
  lkl jdField_a_of_type_Lkl = null;
  llk jdField_a_of_type_Llk = null;
  ...
  public lkw(String paramString, Context paramContext)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Llk = new llk();
    llk.a();
    this.jdField_a_of_type_Lkl = new lkl();
  }
  ...
  public static int a(Context paramContext)
  {
    ...
    try
    {
      paramContext = mtd.a(paramContext, "ro.qq.camera.sensor");
  ...
  public static String a(Context paramContext)
  {
    ...
    lkl locallkl = new lkl();
    if (locallkl.a(paramContext) != 0)
    {
      if (QLog.isColorLevel()) {
  ...
  {
    int i1 = 0;
    Object localObject = lfo.a(paramContext);
    if (!((lkk)localObject).a())
    {
      ljx localljx = new ljx();
      jdField_b_of_type_Boolean = localljx.b((lkk)localObject);
      if (jdField_b_of_type_Boolean)
      {
        jdField_a_of_type_Byte = localljx.jdField_a_of_type_Byte;
        jdField_b_of_type_Byte = localljx.jdField_b_of_type_Byte;
        jdField_c_of_type_Byte = localljx.jdField_c_of_type_Byte;
        jdField_d_of_type_Byte = localljx.jdField_d_of_type_Byte;
        e = localljx.e;
        f = localljx.f;
        g = localljx.g;
        h = localljx.h;
        ...
        j = localljx.j;
        k = localljx.k;
        jdField_a_of_type_Int = localljx.jdField_b_of_type_Int;
        if (QLog.isColorLevel()) {
      ...
      boolean bool = localljx.d((lkk)localObject);
      i1 = bool;
      if (bool)
      {
        l = localljx.l;
        ...
        u = localljx.u;
        v = localljx.v;
        jdField_b_of_type_Int = localljx.jdField_d_of_type_Int;
        i1 = bool;
        if (QLog.isColorLevel())
        {
    ...
    do
    {
      do
      {
        do
        {
          ...
          localObject = new lkl();
        } while (((lkl)localObject).a(paramContext) != 0);
        paramContext = ((lkl)localObject).a();
      } while (paramContext == null);
      jdField_a_of_type_Byte = paramContext.jdField_a_of_type_Lko.jdField_a_of_type_Byte;
      jdField_b_of_type_Byte = paramContext.jdField_a_of_type_Lko.jdField_a_of_type_Byte;
      jdField_c_of_type_Byte = paramContext.jdField_a_of_type_Lko.jdField_c_of_type_Byte;
      jdField_d_of_type_Byte = paramContext.jdField_a_of_type_Lko.e;
      e = paramContext.jdField_a_of_type_Lko.g;
      f = paramContext.jdField_a_of_type_Lko.i;
      g = paramContext.jdField_a_of_type_Lko.jdField_d_of_type_Byte;
      h = paramContext.jdField_a_of_type_Lko.f;
      i = paramContext.jdField_a_of_type_Lko.h;
      j = paramContext.jdField_a_of_type_Lko.j;
      w = paramContext.jdField_a_of_type_Lko.k;
      x = paramContext.jdField_a_of_type_Lko.l;
  ...
  static void a(Context paramContext, byte[] paramArrayOfByte)
  {
    ...
    while (!QLog.isColorLevel())
    {
      ...
      paramContext = paramArrayOfByte.jdField_a_of_type_Lks;
      break label92;
    }
    label277:
  ...
  public static void a(String paramString, Context paramContext, byte[] paramArrayOfByte)
  {
    ...
    if (paramArrayOfByte != null)
    {
      paramString = new lkw(paramString, paramContext);
  ...
  {
    lwd.a().a("request", -1);
    return new lkw(paramString, paramContext).a(paramLong);
  }
  ...
  public static int[] a(byte[] paramArrayOfByte)
  {
    ...
    do
    {
      ...
      do
      {
        return null;
        locallkl = new lkl();
        if (locallkl.a(paramArrayOfByte) == 0) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.d("ConfigSystemImpl", 2, "unPack PB err");
      return null;
      paramArrayOfByte = locallkl.a();
    } while ((paramArrayOfByte == null) || (!paramArrayOfByte.jdField_a_of_type_Lkq.jdField_a_of_type_Boolean));
    return new int[] { paramArrayOfByte.jdField_a_of_type_Lkq.jdField_a_of_type_Int, paramArrayOfByte.jdField_a_of_type_Lkq.jdField_b_of_type_Int, paramArrayOfByte.jdField_a_of_type_Lkq.jdField_c_of_type_Int, paramArrayOfByte.jdField_a_of_type_Lkq.jdField_d_of_type_Int, paramArrayOfByte.jdField_a_of_type_Lkq.jdField_e_of_type_Int, paramArrayOfByte.jdField_a_of_type_Lkq.f, paramArrayOfByte.jdField_a_of_type_Lkq.g, paramArrayOfByte.jdField_a_of_type_Lkq.h, paramArrayOfByte.jdField_a_of_type_Lkq.i, paramArrayOfByte.jdField_a_of_type_Lkq.j, paramArrayOfByte.jdField_a_of_type_Lkq.k, paramArrayOfByte.jdField_a_of_type_Lkq.l };
  }
  ...
  {
    Object localObject = this.jdField_a_of_type_Lkl;
    localObject.getClass();
    localObject = new lkv((lkl)localObject);
    ((lkv)localObject).jdField_a_of_type_Int = 201;
    ((lkv)localObject).jdField_b_of_type_Int = this.jdField_a_of_type_Llk.d();
    ((lkv)localObject).jdField_c_of_type_Int = llk.f();
    ((lkv)localObject).jdField_d_of_type_Int = llk.e();
    ((lkv)localObject).jdField_e_of_type_Int = ((int)(llk.d() / 1000L));
    ((lkv)localObject).f = 0;
    ((lkv)localObject).g = 0;
    ((lkv)localObject).h = 0;
    ((lkv)localObject).i = this.jdField_a_of_type_Llk.g;
    ((lkv)localObject).j = this.jdField_a_of_type_Llk.h;
    ((lkv)localObject).k = 22;
    ((lkv)localObject).l = ConfigInfo.getSharpConfigVersionFromFile(this.jdField_a_of_type_AndroidContentContext);
    ((lkv)localObject).m = 37;
    ((lkv)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    ((lkv)localObject).jdField_b_of_type_JavaLangString = ("android_" + Build.VERSION.RELEASE);
    ((lkv)localObject).jdField_c_of_type_JavaLangString = llk.c();
    ((lkv)localObject).jdField_d_of_type_JavaLangString = Build.VERSION.INCREMENTAL;
    ((lkv)localObject).jdField_e_of_type_JavaLangString = Common.a(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_Lkl.a(paramLong, (lkv)localObject);
    return this.jdField_a_of_type_Lkl.a();
  }
}
