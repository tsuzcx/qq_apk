...
public class mlr
{
  ...
  public static void a(int paramInt, long paramLong)
  {
    ...
    lcl.a(jdField_a_of_type_JavaLangString, String.format("reportVoiceChange voiceType = %s, duration = %s", new Object[] { Integer.valueOf(paramInt), Long.valueOf(paramLong) }));
  }
  
  public static void a(int paramInt, String paramString)
  {
    lcl.a(jdField_a_of_type_JavaLangString, String.format("onConnected sessionType = %s, roomid = %s", new Object[] { Integer.valueOf(paramInt), paramString }));
    d = true;
  ...
  {
    lcl.a(jdField_a_of_type_JavaLangString, String.format("reportClickEvent key = %s, type = %s, roomid = %s", new Object[] { paramString1, paramString2, jdField_b_of_type_JavaLangString }));
    axqw.b(null, "dc00898", "", "", paramString1, paramString1, 0, 0, paramString2, "", jdField_b_of_type_JavaLangString, "");
  }
  
  public static void a(lgf paramlgf)
  {
    if ((!jdField_c_of_type_Boolean) || (!d)) {
      return;
    }
    if ((paramlgf.d == 1) || (paramlgf.d == 2)) {
  ...
  public static void a(lgf paramlgf, int paramInt)
  {
    lcl.a(jdField_a_of_type_JavaLangString, String.format("updateReportData sessionType = %d, voiceType = %d", new Object[] { Integer.valueOf(paramlgf.d), Integer.valueOf(paramInt) }));
    ...
    while ((paramlgf.d != 2) && (paramlgf.d != 4)) {
      return;
    }
    if (jdField_a_of_type_Int != 0) {
      jdField_c_of_type_Int = jdField_a_of_type_Int;
