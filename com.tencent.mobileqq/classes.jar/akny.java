...
public class akny
{
  ...
  {
    paramQQAppInterface = (aknv)paramQQAppInterface.getManager(285);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, MessageForPoke paramMessageForPoke)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = ((ajxn)paramQQAppInterface.getManager(51)).b(paramString);
        if (localObject != null) {
          break;
        }
      ...
      Object localObject = String.format(Locale.getDefault(), ajyc.a(2131705688), new Object[] { ((Friends)localObject).getFriendNickWithAlias() });
      paramMessageForPoke = new aquz(paramString, paramQQAppInterface.c(), (String)localObject, paramInt, -5040, 655379, l);
      ...
      axqw.b(paramQQAppInterface, "dc00898", "", "", "0X8009891", "0X8009891", 0, 0, "", "", "", "");
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while ((paramString.length() < 5) || (axas.a(paramMessageRecord.msgtype)) || (akpy.i(paramMessageRecord.msgtype)) || (a(paramMessageRecord.msgtype)));
        paramQQAppInterface = (aknv)paramQQAppInterface.getManager(285);
        if (paramInt == 1)
        {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      localObject = (aknv)paramQQAppInterface.getManager(285);
      localFriends = localajxn.b(paramString);
    } while ((localFriends == null) || (!localFriends.isFriend()));
    if (aexd.a(paramQQAppInterface).b()) {
      if (((aknv)localObject).a(true))
      {
        if (!((aknv)localObject).c(paramString)) {
          break label227;
        }
        ((aknv)localObject).a(paramString);
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      localObject = localajxn.a(paramString, true);
      ...
      return;
      label227:
      ((aknv)localObject).a(paramString, true);
      break;
      if (QLog.isColorLevel()) {
  ...
  {
    if (((b(paramInt)) || (c(paramInt)) || (d(paramInt))) && (!bbbd.b(paramString)) && (!bahx.b(paramQQAppInterface, paramString))) {}
  ...
  private static void b(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        aknv localaknv = (aknv)paramQQAppInterface.getManager(285);
        if (!localaknv.a(false))
        {
          if (QLog.isColorLevel()) {
        ...
        else
        {
          ...
          else if (localaknv.e(paramString))
          {
            if (QLog.isColorLevel()) {
          ...
          {
            float f = localaknv.a();
            Object localObject2 = localajxn.a(paramString, true);
  ...
  {
    ((aknv)paramQQAppInterface.getManager(285)).h(paramString);
  }
  
  public static boolean d(int paramInt)
  {
    return arqn.b(paramInt);
  }
  
  private static void e(QQAppInterface paramQQAppInterface, String paramString)
  {
    ((aknv)paramQQAppInterface.getManager(285)).i(paramString);
  }
}
