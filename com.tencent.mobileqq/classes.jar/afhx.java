...
public class afhx
{
  ...
  private afhv jdField_a_of_type_Afhv;
  private afhw jdField_a_of_type_Afhw = new afia(this);
  private afie jdField_a_of_type_Afie;
  private ajxj jdField_a_of_type_Ajxj = new afib(this);
  ...
  public afhx(Face2FaceAddContactFragment paramFace2FaceAddContactFragment)
  {
    this.jdField_a_of_type_Afie = paramFace2FaceAddContactFragment;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramFace2FaceAddContactFragment.getActivity().app;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Afhw);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Ajxj);
    this.jdField_a_of_type_Afhv = ((afhv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(169));
  }
  ...
  private void a(FragmentActivity paramFragmentActivity, boolean paramBoolean, String paramString1, String paramString2)
  {
    if (Build.VERSION.SDK_INT >= 23) {
      if (paramFragmentActivity.checkSelfPermission("android.permission.ACCESS_FINE_LOCATION") != 0) {
        paramFragmentActivity.requestPermissions(new afhy(this, paramBoolean, paramString1, paramString2), 1, new String[] { "android.permission.ACCESS_FINE_LOCATION" });
      }
    }
    while (!paramBoolean)
    {
  ...
  private void a(SosoInterface.SosoLbsInfo paramSosoLbsInfo, String paramString1, String paramString2)
  {
    ...
    this.jdField_a_of_type_Afhv.a(this.jdField_a_of_type_JavaLangString, paramString1, localGPS, paramSosoLbsInfo);
  }
  ...
  public void a()
  {
    ...
    d();
    this.jdField_a_of_type_Afie = null;
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Afhw);
  ...
  public void a(List<String> paramList)
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_Afhv.a(this.jdField_a_of_type_JavaLangString, paramList);
    }
  }
  ...
  public void b()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      this.jdField_a_of_type_Afhv.a(this.jdField_a_of_type_JavaLangString);
