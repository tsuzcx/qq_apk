...
public class asrl
{
  ...
  public static void a(String paramString)
  {
    ...
    bhhr.u(BaseApplicationImpl.getApplication().getBaseContext(), str, paramString);
    if (QLog.isColorLevel())
    {
      if (paramString != null) {
  ...
  public static boolean a(aslx paramaslx)
  {
    boolean bool = false;
    if ((paramaslx != null) && (paramaslx.a != null))
    {
      String str = a();
      paramaslx = (asly)paramaslx.a.get(str);
      if (paramaslx != null)
      {
        paramaslx = paramaslx.c;
        str = b();
        if (TextUtils.isEmpty(str))
        {
          bool = true;
          if ((!TextUtils.isEmpty(paramaslx)) && (!paramaslx.equalsIgnoreCase(str))) {
            bool = true;
          }
        }
      }
  ...
  {
    return assx.a(a(paramArrayOfString));
  }
  ...
  {
    String str = BaseApplicationImpl.getApplication().getRuntime().getAccount();
    str = bhhr.s(BaseApplicationImpl.getApplication().getBaseContext(), str);
    if (QLog.isColorLevel())
    {
      if (str != null) {
  ...
  {
    return String.format("%s/matchChat", new Object[] { asma.a() });
  }
