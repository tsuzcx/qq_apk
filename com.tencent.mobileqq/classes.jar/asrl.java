...
public class asrl
  implements View.OnClickListener, assh, assi, assj
{
  ...
  public asrl(QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, Context paramContext, String paramString)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131562564, null);
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131375510));
      if (ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().getRuntime(), false, null)) {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundDrawable(paramFragmentActivity.getResources().getDrawable(2130840149));
      }
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131377444);
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362989));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378266));
      this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator = ((SimpleSlidingIndicator)this.jdField_a_of_type_AndroidViewView.findViewById(2131376281));
      a(paramQQAppInterface, paramContext, String.valueOf(this.jdField_a_of_type_Long));
      this.jdField_a_of_type_AndroidWidgetTextView.setOnTouchListener(new asrm(this));
      if (AppSetting.d) {
        this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(ajyc.a(2131706994));
      }
      if (ImmersiveUtils.isSupporImmersive() == 1)
      {
        ...
        int i = j;
        if (b()) {
          i = j - actn.a(10.0F, this.jdField_b_of_type_AndroidViewView.getResources());
        }
        paramFragmentActivity.setMargins(0, i, 0, 0);
        this.jdField_b_of_type_AndroidViewView.setLayoutParams(paramFragmentActivity);
      }
      this.jdField_a_of_type_Assg = ((assg)paramQQAppInterface.getManager(329));
      return;
    }
  ...
  private void a(int paramInt)
  {
    ...
    case 1: 
      ...
      for (;;)
      {
        astj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        return;
  ...
  {
    this.jdField_a_of_type_Boolean = astm.a(paramQQAppInterface).a(paramString);
    if (!this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setVisibility(8);
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setTabData(new String[] { paramContext.getResources().getString(2131720531), paramContext.getResources().getString(2131720532) }, new int[] { 0, 1 });
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setOnTabListener(new asrn(this));
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    {
      localView = this.jdField_a_of_type_AndroidViewView.findViewById(2131378149);
      if (localView != null) {
        if (!paramBoolean) {
          break label34;
        }
  ...
  public void a()
  {
    ...
    axqw.b(null, "dc00898", "", "", "0X800A212", "0X800A212", 0, 0, "", "", "", "");
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Assg != null) {
        this.jdField_a_of_type_Assg.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Long, this);
      }
      i = PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_AndroidContentContext).getInt(aefu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), 0);
      if (QLog.isColorLevel()) {
  ...
  public void a(ArrayList<Long> paramArrayList, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Assg == null);
      if (paramBoolean1) {
        this.jdField_a_of_type_Assg.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Long, paramArrayList, this);
      }
    } while (!paramBoolean2);
    this.jdField_a_of_type_Assg.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Long, paramArrayList, this);
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Assg != null) {
      this.jdField_a_of_type_Assg.a(this.jdField_a_of_type_Long);
    }
  }
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Assg != null)
    {
      this.jdField_a_of_type_Assg.b(this.jdField_a_of_type_Long);
      this.jdField_a_of_type_Assg = null;
    }
