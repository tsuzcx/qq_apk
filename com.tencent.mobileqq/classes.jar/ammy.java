  ...
  extends Dialog
{
  ...
  static
  {
    ...
    jdField_b_of_type_JavaLangString = alof.aX + "MsgPushNotify" + File.separator;
    ...
    jdField_g_of_type_JavaLangString = alud.a(2131707346);
    h = alud.a(2131707340);
    i = alud.a(2131707343);
  ...
  @TargetApi(14)
  public ammy(Context paramContext)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    if (paramString == null)
    {
      jdField_a_of_type_AndroidContentIntent = bdie.a(paramQQAppInterface.getApp());
      return;
    }
    Object localObject;
    label143:
    ...
    } while ((!((String)localObject).equals("device")) || (!paramString.getAttributeValue(null, "id").equals(bdgk.d())));
    jdField_a_of_type_AndroidContentIntent = null;
    for (;;)
    {
      if (paramString.next() != 3)
  ...
  public static boolean a(File paramFile)
  {
    ...
    for (;;)
    {
      ...
      if (k < jdField_a_of_type_Int)
      {
        bdhb.d(String.format(jdField_c_of_type_JavaLangString + jdField_e_of_type_JavaLangString, new Object[] { Integer.valueOf(k) }));
        k += 1;
      }
      else
      {
        if (paramFile.exists())
        {
          bdhb.a(paramFile.getPath(), jdField_b_of_type_JavaLangString, false);
          return true;
        }
        return false;
        label151:
  ...
  private static boolean b(QQAppInterface paramQQAppInterface)
  {
    ...
    if (jdField_a_of_type_Beae != null)
    {
      if ((jdField_a_of_type_Beae.a() == 2) || (jdField_a_of_type_Beae.a() == 3))
      {
        QLog.d(jdField_a_of_type_JavaLangString, 1, "res download duplicated, " + str);
        return false;
      }
      QLog.d(jdField_a_of_type_JavaLangString, 1, "res download task status error, cancel it, status: " + jdField_a_of_type_Beae.a());
      jdField_a_of_type_Beae.a(true);
    }
    jdField_a_of_type_Beae = new beae(jdField_f_of_type_JavaLangString, localFile);
    jdField_a_of_type_Beae.n = true;
    paramQQAppInterface = ((beag)paramQQAppInterface.getManager(47)).a(1);
    QLog.d(jdField_a_of_type_JavaLangString, 1, "start download ");
    paramQQAppInterface.a(jdField_a_of_type_Beae, new amnc(str), null);
    return false;
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2131558950);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131365226));
    ...
    try
    {
      ...
      localButton.setText(alud.a(2131707341));
      localButton.setOnClickListener(new ammz(this));
      localImageView.setOnClickListener(new amna(this));
      localImageView.setOnTouchListener(new amnb(this, localImageView));
      return;
    }
