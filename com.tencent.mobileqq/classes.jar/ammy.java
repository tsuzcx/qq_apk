...
public class ammy
{
  static ammy jdField_a_of_type_Ammy;
  private bahq jdField_a_of_type_Bahq = new ammz(this);
  ShareAppLogHelper jdField_a_of_type_ComTencentMobileqqTestassisterShareAppLogHelper;
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  
  ammy(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramQQAppInterface);
  }
  
  public static ammy a(QQAppInterface paramQQAppInterface)
  {
    jdField_a_of_type_Ammy = new ammy(paramQQAppInterface);
    return jdField_a_of_type_Ammy;
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTestassisterShareAppLogHelper.a(this.jdField_a_of_type_Bahq);
