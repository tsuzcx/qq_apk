...
public class olm
{
  ...
  public static void a()
  {
    ...
    {
      return;
      localObject = ((QQAppInterface)localObject).a().b(ajsd.aQ, 1008);
  ...
  private static void a(String paramString, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      for (int j = 0;; j = 1)
      {
        ...
        nol.a(null, "CliOper", "", str3, paramString, paramString, 0, 0, str4, (String)localObject3, str1, paramMessageRecord.toString(), false);
        return;
        localObject1 = null;
        break;
        i = 0;
  ...
  public static void b()
  {
    ...
    {
      a = localMap;
      QLog.d(olm.class.getSimpleName(), 2, "update kandian subscribe red pnt info success ");
    }
  }
}
