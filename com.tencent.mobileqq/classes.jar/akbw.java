...
public abstract class akbw
{
  ...
  protected abstract void addBusinessObserver(ToServiceMsg paramToServiceMsg, ajte paramajte, boolean paramBoolean);
  ...
  public ToServiceMsg makeOIDBPkg(String paramString, int paramInt1, int paramInt2, byte[] paramArrayOfByte, long paramLong, ajte paramajte, boolean paramBoolean)
  {
    ...
    addBusinessObserver(paramString, paramajte, paramBoolean);
    return paramString;
  }
}
