...
public class omx
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "8.4.10".replace(".", "");
    jdField_a_of_type_JavaUtilHashMap = new HashMap();
  }
  
  public static int a()
  {
    boolean bool1 = bmhv.l();
    boolean bool2 = bmhv.m();
    if (!bool1) {
      return 0;
    }
    if (bool2) {
      ...
      try
      {
        ...
        if (paramJSONObject != null)
        {
          ...
          if (paramJSONObject != null)
          {
            ...
            {
              paramJSONObject = prb.a(localContext);
              localJSONObject.put("wifi_ssid", prb.b(localContext));
  ...
  public static void a(int paramInt1, long paramLong, String paramString1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, rqg paramrqg, int paramInt7, String paramString2, String paramString3)
  {
    ThreadManager.post(new VideoReporter.1(paramInt1, paramLong, paramString1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramrqg, paramInt7, paramString2, paramString3), 5, null, true);
  }
  
  public static void a(long paramLong1, String paramString1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong2, rqg paramrqg, int paramInt5, String paramString2)
  {
    ...
    if (paramInt1 == 56)
    {
      ...
      localReportInfo.mVideoExtraRepoerData = paramrqg;
    ...
    label366:
    for (paramString1 = paramrqg.toString();; paramString1 = "null")
    {
  ...
  public static void a(VideoInfo paramVideoInfo, int paramInt1, int paramInt2, int paramInt3, rqg paramrqg, String paramString)
  {
    ...
    {
      a(18, l, str, paramInt1, j, k, paramInt2, paramInt3, paramrqg, i, paramVideoInfo.w, paramString);
      return;
    }
  }
  
  public static void a(BaseArticleInfo paramBaseArticleInfo, int paramInt1, int paramInt2, long paramLong, rqg paramrqg)
  {
    ...
    {
      a(l, str, paramInt1, j, k, paramInt2, paramLong, paramrqg, i, paramBaseArticleInfo.videoReportInfo);
      return;
    }
  }
  ...
  public static void a(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      olh.a(null, "CliOper", "", "", paramString1, paramString1, 0, 0, str, Integer.toString(paramInt2), paramString3, paramString2, false);
      return;
      if (paramInt1 == 1) {
        str = "3";
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramJSONObject.put("imei", pkh.b());
        paramJSONObject.put("imsi", pkh.c());
  ...
  public static void b(VideoInfo paramVideoInfo, int paramInt1, int paramInt2, int paramInt3, rqg paramrqg, String paramString)
  {
    long l = paramVideoInfo.c;
    String str = paramVideoInfo.g;
    int j = (int)paramVideoInfo.f;
    ...
    for (int i = paramVideoInfo.a.a;; i = -1)
    {
      a(5, l, str, paramInt1, j, k, paramInt2, paramInt3, paramrqg, i, paramVideoInfo.w, paramString);
      return;
    }
  }
