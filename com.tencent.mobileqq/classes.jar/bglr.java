...
public class bglr
{
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    //   41: invokestatic 49	com/tencent/qqmini/sdk/log/QMLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   44: bipush 9
    //   46: ireturn
    ...
    //   83: dup
    //   84: aload_0
    //   85: invokespecial 66	bgle:<init>	(Ljava/io/File;)V
    //   88: astore 9
    //   90: sipush 8192
    //   93: newarray byte
    //   95: astore 10
    ...
    //   107: astore 11
    //   109: aload 9
    //   111: invokevirtual 73	bgle:entries	()Ljava/util/Enumeration;
    //   114: astore 12
    //   116: iload_3
    //   117: istore_2
    //   118: aload 12
    ...
    //   226: istore_2
    //   227: aload 9
    //   229: invokevirtual 113	bgle:close	()V
    //   232: iload_2
    //   233: ireturn
    //   234: astore_0
    //   235: aload_0
    ...
    //   243: ldc 22
    //   245: ldc 116
    //   247: invokestatic 119	com/tencent/qqmini/sdk/log/QMLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   250: iconst_1
    //   251: ireturn
    //   252: astore_0
    //   253: ldc 22
    //   255: ldc 121
    //   257: invokestatic 119	com/tencent/qqmini/sdk/log/QMLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   260: iconst_2
    //   261: ireturn
    //   262: astore_0
    //   263: ldc 22
    //   265: ldc 123
    //   267: invokestatic 119	com/tencent/qqmini/sdk/log/QMLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   270: iconst_3
    //   271: ireturn
    //   272: aload 9
    //   274: aload 13
    //   276: invokevirtual 127	bgle:getInputStream	(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    //   279: astore_0
    //   280: new 129	java/util/zip/CheckedInputStream
    //   283: dup
    //   284: aload_0
    //   285: new 131	java/util/zip/CRC32
    //   288: dup
    //   289: invokespecial 132	java/util/zip/CRC32:<init>	()V
    //   292: invokespecial 135	java/util/zip/CheckedInputStream:<init>	(Ljava/io/InputStream;Ljava/util/zip/Checksum;)V
    //   295: astore 6
    ...
    //   310: ldc 137
    //   312: invokevirtual 141	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   315: ldc 143
    //   317: invokespecial 146	java/lang/String:<init>	([BLjava/lang/String;)V
    ...
    //   330: ifne +24 -> 354
    //   333: aload 8
    //   335: invokevirtual 150	java/io/File:getParentFile	()Ljava/io/File;
    //   338: astore 14
    //   340: aload 14
    ...
    //   353: pop
    //   354: new 152	java/io/BufferedOutputStream
    //   357: dup
    //   358: new 154	java/io/FileOutputStream
    //   361: dup
    //   362: aload 8
    //   364: invokespecial 155	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   367: invokespecial 158	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   370: invokestatic 163	bglf:a	(Ljava/io/OutputStream;)Lbglf;
    //   373: astore 8
    //   375: aload 13
    //   377: invokevirtual 167	java/util/zip/ZipEntry:getSize	()J
    //   380: lstore 4
    //   382: lload 4
    //   384: lconst_0
    //   385: lcmp
    ...
    //   393: iconst_0
    //   394: sipush 8192
    //   397: invokevirtual 171	java/util/zip/CheckedInputStream:read	([BII)I
    //   400: istore_2
    //   401: aload 8
    //   403: aload 10
    //   405: iconst_0
    //   406: iload_2
    //   407: invokevirtual 177	java/io/OutputStream:write	([BII)V
    //   410: lload 4
    //   412: iload_2
    //   413: i2l
    //   414: lsub
    ...
    //   417: goto -35 -> 382
    //   420: aload 13
    //   422: invokevirtual 180	java/util/zip/ZipEntry:getCrc	()J
    //   425: aload 6
    //   427: invokevirtual 184	java/util/zip/CheckedInputStream:getChecksum	()Ljava/util/zip/Checksum;
    //   430: invokeinterface 189 1 0
    //   435: lcmp
    //   436: ifeq +72 -> 508
    //   439: iconst_4
    //   440: istore_2
    ...
    //   455: aload 13
    //   457: invokevirtual 180	java/util/zip/ZipEntry:getCrc	()J
    ...
    //   466: invokestatic 119	com/tencent/qqmini/sdk/log/QMLog:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   469: aload 6
    //   471: ifnull +8 -> 479
    //   474: aload 6
    //   476: invokevirtual 195	java/util/zip/CheckedInputStream:close	()V
    //   479: aload_0
    //   480: ifnull +7 -> 487
    //   483: aload_0
    //   484: invokevirtual 198	java/io/InputStream:close	()V
    //   487: aload 8
    //   489: ifnull +199 -> 688
    //   492: aload 8
    //   494: invokevirtual 199	java/io/OutputStream:close	()V
    //   497: iconst_4
    //   498: istore_2
    //   499: goto -272 -> 227
    //   502: astore_0
    ...
    //   510: ifnull +8 -> 518
    //   513: aload 6
    //   515: invokevirtual 195	java/util/zip/CheckedInputStream:close	()V
    //   518: aload_0
    //   519: ifnull +7 -> 526
    //   522: aload_0
    //   523: invokevirtual 198	java/io/InputStream:close	()V
    //   526: aload 8
    //   528: ifnull -412 -> 116
    //   531: aload 8
    //   533: invokevirtual 199	java/io/OutputStream:close	()V
    //   536: goto -420 -> 116
    //   539: astore_0
    //   540: goto -424 -> 116
    //   543: astore_0
    ...
    //   551: ifnull +8 -> 559
    //   554: aload 7
    //   556: invokevirtual 195	java/util/zip/CheckedInputStream:close	()V
    //   559: aload 6
    //   561: ifnull +8 -> 569
    //   564: aload 6
    //   566: invokevirtual 198	java/io/InputStream:close	()V
    //   569: aload_1
    //   570: ifnull +7 -> 577
    //   573: aload_1
    //   574: invokevirtual 199	java/io/OutputStream:close	()V
    //   577: aload_0
    //   578: athrow
    //   579: astore_0
    //   580: aload_0
    ...
    //   590: astore_0
    //   591: aload_0
    //   592: invokevirtual 200	java/lang/Exception:printStackTrace	()V
    //   595: bipush 7
    //   597: istore_2
    //   598: goto -371 -> 227
    //   601: astore_1
