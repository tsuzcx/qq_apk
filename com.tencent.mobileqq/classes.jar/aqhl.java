...
{
  public static int a;
  public static SparseArray<WeakReference<aqhl>> a;
  long jdField_a_of_type_Long = -1L;
  Context jdField_a_of_type_AndroidContentContext;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler();
  private View jdField_a_of_type_AndroidViewView;
  private aqhv jdField_a_of_type_Aqhv;
  ...
  private aqhl(Context paramContext, int paramInt)
  {
  ...
  public static aqhl a(Context paramContext, int paramInt)
  {
    paramContext = new aqhl(paramContext, paramInt);
  ...
  private void b()
  {
    ((IVideoViewBase)this.jdField_a_of_type_AndroidViewView).addViewCallBack(new aqhm(this));
  }
  ...
  public aqhw a()
  {
    ...
    return new aqhw(this, this.jdField_c_of_type_Int, this.jdField_a_of_type_Long);
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Aqhv = null;
  }
  ...
  {
    this.jdField_a_of_type_Aqhv = paramaqhv;
  }
  
  public void a(aqhw paramaqhw)
  {
  ...
  public void a(String paramString1, String paramString2, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer == null) && (this.jdField_a_of_type_AndroidViewView != null))
    {
      ...
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnCompletionListener(new aqhn(this));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnErrorListener(new aqho(this));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnVideoPreparedListener(new aqhp(this));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnSeekCompleteListener(new aqhq(this));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnInfoListener(new aqhr(this));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnNetVideoInfoListener(new aqhs(this));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnVideoPreparingListener(new aqht(this));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnDownloadCallback(new aqhu(this));
    }
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOutputMute(paramBoolean);
    this.jdField_a_of_type_JavaLangString = paramString2;
    String str = aqgs.a(paramString2);
    HashMap localHashMap = new HashMap();
    localHashMap.put("shouq_bus_type", "shouq_hotpic_online_video");
    TVK_PlayerVideoInfo localTVK_PlayerVideoInfo = new TVK_PlayerVideoInfo();
    File localFile = new File(str);
    if (aqgs.a(paramString2, paramLong2))
    {
    ...
    localTVK_PlayerVideoInfo.setVid(bcdu.d(paramString1));
