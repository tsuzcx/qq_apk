...
public class aqhl
  implements aqho
{
  public aqhl(FilePreviewActivity paramFilePreviewActivity) {}
  ...
  public void a(boolean paramBoolean, String paramString1, String paramString2, long paramLong, String paramString3, String paramString4, String paramString5, String paramString6, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      if (this.a.jdField_a_of_type_Aqxr != null) {
        this.a.jdField_a_of_type_Aqxr.jdField_f_of_type_Long = System.currentTimeMillis();
      }
      this.a.c = true;
      if (!paramBoolean)
      {
        ...
        for (;;)
        {
          ...
          if (this.a.jdField_a_of_type_Aqxr != null)
          {
            this.a.jdField_a_of_type_Aqxr.jdField_a_of_type_Boolean = false;
            this.a.jdField_a_of_type_Aqxr.jdField_c_of_type_Long = (this.a.jdField_a_of_type_Aqxr.jdField_f_of_type_Long - this.a.jdField_a_of_type_Aqxr.jdField_e_of_type_Long);
            this.a.jdField_a_of_type_Aqxr.jdField_e_of_type_JavaLangString = String.valueOf(paramLong);
            this.a.jdField_a_of_type_Aqxr.i = paramString3;
            this.a.jdField_a_of_type_Aqxr.jdField_d_of_type_JavaLangString = paramString6;
            this.a.jdField_a_of_type_Aqxr.jdField_d_of_type_Long = (System.currentTimeMillis() - this.a.jdField_a_of_type_Aqxr.jdField_a_of_type_Long);
            this.a.jdField_a_of_type_Aqxr.a();
          }
          ...
          return;
          this.a.jdField_b_of_type_AndroidWidgetTextView.setText(alpo.a(2131704947));
        }
      }
      ...
      if (this.a.jdField_a_of_type_Aqxr != null)
      {
        this.a.jdField_a_of_type_Aqxr.jdField_a_of_type_Boolean = true;
        this.a.jdField_a_of_type_Aqxr.g = paramString4;
        this.a.jdField_a_of_type_Aqxr.i = "";
        this.a.jdField_a_of_type_Aqxr.jdField_f_of_type_Long = System.currentTimeMillis();
        this.a.jdField_a_of_type_Aqxr.jdField_c_of_type_Long = (this.a.jdField_a_of_type_Aqxr.jdField_f_of_type_Long - this.a.jdField_a_of_type_Aqxr.jdField_e_of_type_Long);
        this.a.jdField_a_of_type_Aqxr.jdField_c_of_type_JavaLangString = paramString1;
        this.a.jdField_a_of_type_Aqxr.jdField_f_of_type_JavaLangString = this.a.jdField_b_of_type_JavaLangString;
        this.a.jdField_a_of_type_Aqxr.jdField_d_of_type_JavaLangString = paramString6;
        this.a.jdField_a_of_type_Aqxr.jdField_d_of_type_Long = (System.currentTimeMillis() - this.a.jdField_a_of_type_Aqxr.jdField_a_of_type_Long);
        this.a.jdField_a_of_type_Aqxr.a();
      }
    ...
    } while (this.a.jdField_a_of_type_Aqxr == null);
    this.a.jdField_a_of_type_Aqxr.jdField_e_of_type_Long = System.currentTimeMillis();
    this.a.jdField_a_of_type_Aqxr.l = "2";
  }
}
