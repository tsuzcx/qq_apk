  ...
  extends apar
{
  ...
  private FileManagerEntity jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity = apck.a(paramQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataMessageForFile);
  
  public apal(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
  ...
  public apao a()
  {
    apak localapak = new apak(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
    localapak.a(new apam(this));
    return localapak;
  }
