  ...
  implements Manager
{
  ...
  bbwf jdField_a_of_type_Bbwf = new bbyy(this, "param_WIFIColorRingDownloadFlow", "param_XGColorRingDownloadFlow");
  ...
  public bbyt(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bbdj.a(lco.f(), new StringBuffer("config.json"), localInputStream);
      }
  ...
  public static VipFullScreenVideoView a(Activity paramActivity, RelativeLayout paramRelativeLayout, boolean paramBoolean)
  {
    ...
    {
      return null;
      localView = paramActivity.getLayoutInflater().inflate(2131562602, null);
      localLayoutParams = new RelativeLayout.LayoutParams(-1, -1);
      localLayoutParams.addRule(13);
    } while (paramActivity.isFinishing());
    paramRelativeLayout.addView(localView, 0, localLayoutParams);
    return (VipFullScreenVideoView)localView.findViewById(2131378898);
  }
  ...
  public static String a(AppRuntime paramAppRuntime, int paramInt1, int paramInt2, String paramString)
  {
    ...
    paramString = lco.f() + paramInt1 + File.separator;
  ...
  public static void a(AppRuntime paramAppRuntime, int paramInt, Bundle paramBundle, VipFunCallAndRing.TSourceInfo paramTSourceInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        break;
        localObject1 = new File(lco.f() + paramInt + File.separator);
  ...
  public static void a(AppRuntime paramAppRuntime, String paramString1, int paramInt1, String paramString2, int paramInt2)
  {
    ...
    } while (bbdj.a(paramString2));
    String str = b(paramAppRuntime, paramInt2, 8, null);
    paramString2 = new Bundle();
    paramString1 = new bbwg(str, paramString1);
    ((bbwi)paramAppRuntime.getManager(47)).a(1).a(paramString1, null, paramString2);
  }
  
  public static boolean a()
  {
    return new File(bbys.jdField_a_of_type_JavaLangString).exists();
  }
  
  public static boolean a(Context paramContext, VideoView paramVideoView, String paramString, int paramInt1, bbyz parambbyz, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((paramContext.exists()) && (!paramVideoView.isPlaying()))
    {
      ...
      if (paramInt1 == 6)
      {
        paramVideoView.setOnTouchListener(new bbyu());
        paramVideoView.setVideoPath(paramContext.getAbsolutePath());
        paramVideoView.requestFocus();
        paramVideoView.setVisibility(0);
        paramVideoView.setOnPreparedListener(new bbyv(parambbyz));
        paramVideoView.setOnCompletionListener(new bbyw(paramVideoView));
        paramVideoView.setOnErrorListener(new bbyx(paramInt2, parambbyz, paramVideoView, paramBoolean));
        return true;
      }
      if (paramInt1 == 7)
      {
        paramContext = bawu.a(paramString);
  ...
  public static boolean a(Context paramContext, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        bbrj.a("externalStorageType", paramString, i + "_t", l2 + "", bool + "", l2 + "", bool + "_p", "", "", "");
        return bool;
      }
      catch (Exception paramContext)
      {
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3)
  {
    ...
    for (int i = 0;; i = paramInt2)
    {
      ...
      if (bool)
      {
        ...
        localObject = new bbwg(str1, (File)localObject);
        ((bbwg)localObject).a(3);
        ((bbwg)localObject).jdField_a_of_type_Int = 0;
        ((bbwg)localObject).a(localBundle);
        this.jdField_a_of_type_Bbwf.onDone((bbwg)localObject);
        return;
        label519:
        bool = false;
        break label298;
      ...
      if (i == 0)
      {
        label530:
        localObject = new bbwg(str1, (File)localObject);
        ((bbwg)localObject).jdField_a_of_type_Byte = 1;
        ((bbwg)localObject).jdField_e_of_type_Long = 5242880L;
        ((bbwg)localObject).jdField_e_of_type_JavaLangString = jdField_a_of_type_JavaLangString;
      ...
      {
        ((bbwg)localObject).l = paramBoolean;
        if (7 != paramInt2) {
          ((bbwg)localObject).b = true;
        }
        this.jdField_a_of_type_Bbwi.a(1).a((bbwg)localObject, this.jdField_a_of_type_Bbwf, localBundle);
        if (!QLog.isColorLevel()) {
          break;
        }
  ...
  public boolean a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, bbwm parambbwm)
  {
    ...
    if (paramInt2 != 0)
    {
      bbon localbbon = (bbon)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(45);
      localbbon.jdField_a_of_type_Bbwm = parambbwm;
      localbbon.a(paramInt2, 3, paramBoolean, paramInt3, "comering");
    }
    if (i == 6) {
