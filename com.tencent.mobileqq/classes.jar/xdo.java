  ...
  extends WebViewPlugin
{
  ...
  private anad jdField_a_of_type_Anad = new xdp(this);
  ...
  private void a(String paramString, int paramInt)
  {
    ...
    if (localaigz.a(paramString)) {
      localaigz.a(paramString, null, -1001, paramInt);
    }
  ...
  private void a(String paramString, long paramLong, int paramInt)
  {
    ...
    aigz localaigz = aigz.a();
    if (localaigz.a(paramString)) {
      localaigz.a(paramString, null, -1002, paramInt);
    }
    while (!QLog.isColorLevel()) {
      return;
    }
  ...
  private void b(String paramString, int paramInt)
  {
    ...
    aigz localaigz = aigz.a();
    if (localaigz.a(paramString)) {
      localaigz.a(paramString, null, 1000, paramInt);
    }
    while (!QLog.isColorLevel()) {
      return;
    }
      ...
      try
      {
        ...
        if (localJSONObject.has("timeout"))
        {
          ...
          if (TextUtils.isEmpty(str1))
          {
            ...
            paramString1.put("msg", ajjy.a(2131648548));
          ...
          if (l2 > 0L)
          {
            ...
            if (l3 > l2)
            {
              ...
              paramString1.put("businessRet", 0);
              paramString1.put("msg", ajjy.a(2131648556));
              super.callJs(paramString2, new String[] { paramString1.toString() });
              if (!QLog.isColorLevel()) {
                break;
              }
          ...
          if (this.d.containsKey(str1))
          {
                ...
                if (i == 1)
                {
                  ...
                  if (localObject != null)
                  {
                    ...
                    if (!TextUtils.isEmpty((CharSequence)localObject))
                    {
                      ...
                      if (QLog.isColorLevel()) {
                        QLog.d("SSOWebviewPlugin", 2, "Get cookie:" + mpw.c(str2, new String[0]) + " from " + mpw.b((String)localObject, new String[0]));
                      }
                    }
                  }
                }
              }
              if ((this.mRuntime.a() == null) || (!aiwc.a().a(this.mRuntime.a().getUrl(), paramString1, this.mRuntime.a(), this))) {
                continue;
              }
              if (!QLog.isColorLevel()) {
                break;
            ...
            paramString1.put("businessRet", 0);
            paramString1.put("msg", ajjy.a(2131648545));
            super.callJs(paramString2, new String[] { paramString1.toString() });
            if (!QLog.isColorLevel()) {
              break;
            }
          ...
          localObject = new NewIntent(this.mRuntime.a().getApplicationContext(), aquf.class);
          ...
          ((NewIntent)localObject).setObserver(new xdq(this, System.currentTimeMillis(), str1));
          if (QLog.isColorLevel()) {
  ...
  protected void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      {
        paramString2 = new NewIntent(this.mRuntime.a().getApplicationContext(), mmi.class);
        ...
        paramString2.setObserver(new xdr(this, str1, str3));
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    do
    {
      ...
      aquf.jdField_a_of_type_Long = System.currentTimeMillis();
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramString1.optInt("follow") == 1)
        {
          ...
          paramJsBridgeListener = anah.a("ipc_cmd_certified_account_web_plugin_follow", null, this.jdField_a_of_type_Anad.key, paramString2);
