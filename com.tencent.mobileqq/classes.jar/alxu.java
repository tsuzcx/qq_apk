  ...
  implements DialogInterface.OnDismissListener, AdapterView.OnItemClickListener, bjoe
{
  ...
  public alxu(Context paramContext, AppInterface paramAppInterface)
  {
    try
    {
  ...
  private int a(String paramString)
  {
    ...
    try
    {
      ...
      paramString = alvx.a(this.jdField_a_of_type_Int);
      if (paramString != null)
      {
  ...
  private String a()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      ...
      localStringBuilder.append(amip.s);
  ...
  {
    return amip.s + paramInt + "/" + "shareQRCode_default_v2.png";
  }
  ...
  private boolean a(long paramLong)
  {
    try
    {
      ...
      CmGameStartChecker.StartCheckParam localStartCheckParam = localalxy.a();
  ...
  {
    return amip.s + paramInt + "/" + "shareQRCode_no_icon_default_v2.png";
  }
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    for (paramString = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; paramString = null)
    {
      ...
      this.jdField_a_of_type_Bjnw.a(new alxv(this));
  ...
  {
    if (new File(amip.s + paramInt + "/" + "shareQRCode_default_v2.png").exists()) {}
    while (new File(amip.s + paramInt + "/" + "shareQRCode_no_icon_default_v2.png").exists()) {
      return true;
    }
    return false;
  }
