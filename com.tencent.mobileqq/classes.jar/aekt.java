...
public final class aekt
{
  ...
  private static ThreadLocal<char[]> jdField_a_of_type_JavaLangThreadLocal = new aeku();
  ...
  public static int a(azsa paramazsa, String paramString)
  {
    paramazsa = paramazsa.a(paramString);
    ...
    do
    {
      ...
      try
      {
        int i1 = Integer.parseInt(paramazsa);
        return i1;
      }
  ...
  public static final void a(QQAppInterface paramQQAppInterface, BaseChatPie paramBaseChatPie, aelz paramaelz, ChatMessage paramChatMessage)
  {
    int i4 = 0;
    Object localObject;
    boolean bool;
    if (aeif.jdField_a_of_type_Int == -1)
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (aeif.jdField_a_of_type_Boolean)
        {
          aeif.jdField_a_of_type_Int = i1;
          if (aeif.jdField_a_of_type_Int == -1) {
            aeif.jdField_a_of_type_Int = 0;
          }
          if (aeif.jdField_a_of_type_Int > 0) {
            break label153;
          }
          return;
          label133:
    ...
    if (paramChatMessage == null)
    {
      ...
      if (paramaelz != null)
      {
        ...
        if (paramaelz.size() > 0)
        {
          ...
          i1 = aeif.jdField_a_of_type_Int;
          if (i2 <= i1) {
            break label296;
          }
          label210:
          if (!(paramBaseChatPie instanceof agot)) {
            break label349;
          }
        }
      }
    ...
    for (int i2 = 1;; i2 = 0)
    {
      ...
      if (i3 > -1)
      {
        paramBaseChatPie = (ChatMessage)paramaelz.get(i3);
        if (i2 == 0) {
          break label303;
        }
        if (!aeif.a(paramBaseChatPie)) {
          break label323;
        }
        i1 = 1;
      }
      for (;;)
      {
        ...
        ((WebProcessManager)paramQQAppInterface.getManager(13)).a(1, new aekv());
        return;
        i1 = 10;
        break;
        i1 = i2;
        break label210;
        if ((!paramBaseChatPie.isread) && (aeif.a(paramBaseChatPie)))
        {
          i1 = 1;
        }
        else
  ...
  private static boolean a(BaseActivity paramBaseActivity, QQAppInterface paramQQAppInterface, Intent paramIntent)
  {
    try
    {
      ...
      if (i1 == -1)
      {
        QQToast.a(paramBaseActivity, paramBaseActivity.getString(2131720081), 0).b(paramBaseActivity.getTitleBarHeight());
        return false;
      }
      if (paramIntent.hasExtra("account"))
      {
        azmj.b(paramQQAppInterface, "CliOper", "", "", "Fast_launch", "Fast_launch_msg", 0, 0, "1", "", "", "");
        if (!((aloz)paramQQAppInterface.getManager(51)).b(str))
        {
      ...
      if ((paramIntent.getBooleanExtra("shortcut", false)) && (!((aloz)paramQQAppInterface.getManager(51)).b(str)))
      {
        QQToast.a(paramBaseActivity.getApplicationContext(), paramBaseActivity.getString(2131720082), 0).b(paramBaseActivity.getTitleBarHeight());
        return false;
      }
      return true;
    }
  ...
  {
    bdjd.a(null, "AIO_doOnCreate_BeforeEnterCost");
    ...
    do
    {
      do
      {
        ...
        return true;
        if (!ylr.a().a(paramIntent, paramBaseActivity, paramQQAppInterface)) {
          break;
        }
      } while (!QLog.isColorLevel());
    ...
    label212:
    bdjd.a("AIO_doOnCreate_BeforeEnterCost", null);
    return false;
  }
