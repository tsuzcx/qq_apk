  ...
  extends ahny
{
  ...
  public void a(RecentItemRecommendTroopData paramRecentItemRecommendTroopData, ahnr paramahnr)
  {
    ...
    if (paramRecentItemRecommendTroopData.mUser.uin.equals("sp_uin_for_title"))
    {
      ...
      if (AppSetting.d)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(ajya.a(2131713218));
      }
      return;
    }
    ...
    if (paramahnr == null)
    {
      paramahnr = null;
      label225:
      this.jdField_a_of_type_ComTencentWidgetThemeImageView.setImageDrawable(paramahnr);
    ...
    label609:
    label621:
    for (paramahnr = (RecentRecommendTroopItem)paramRecentItemRecommendTroopData.mUser.extraInfo;; paramahnr = null)
    {
      if (paramahnr == null)
      {
        QLog.d("RecentRecommendTroopIte", 1, "bindData, troopItem == null");
        return;
        paramahnr = paramahnr.a(paramRecentItemRecommendTroopData);
        break label225;
      }
      if (paramahnr.activity > 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopActiveLayout.setVisibility(0);
        this.jdField_a_of_type_ComTencentMobileqqTroopWidgetTroopActiveLayout.setHotLevel(paramahnr.activity);
        ArrayList localArrayList = mya.a((RecentRecommendTroopItem)paramRecentItemRecommendTroopData.mUser.extraInfo);
        ...
        label366:
        if (!paramahnr.isJoined()) {
          break label535;
        }
        this.jdField_a_of_type_AndroidWidgetButton.setEnabled(false);
        this.jdField_a_of_type_AndroidWidgetButton.setText(2131699610);
        this.jdField_a_of_type_AndroidWidgetButton.setMinWidth(bbll.a(60.0F));
        this.jdField_a_of_type_AndroidWidgetButton.setMinWidth(bbll.a(29.0F));
        ...
        if (TextUtils.isEmpty(paramahnr.intro)) {
          break label609;
        }
        this.jdField_a_of_type_ComTencentMobileqqWidgetFolderTextView.setText(new aykk(paramahnr.intro, 11, 16));
      }
      for (;;)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetButton.setText(2131699608);
