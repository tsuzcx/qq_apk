...
public final class aubv
{
  ...
  public static Bitmap a(String paramString, int paramInt)
  {
    ...
    {
      return localObject;
      localObject = zvc.a(paramString, -1);
      if (localObject == null)
      {
      ...
      localBitmap = bggl.a(BaseApplicationImpl.sApplication.getResources(), 2130844340);
  ...
  public static String a(FileManagerEntity paramFileManagerEntity, String paramString)
  {
    ...
    {
      paramFileManagerEntity = atwl.a(str);
  ...
  public static void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    {
      QQToast.a(localBaseApplicationImpl, paramInt1, str, paramInt2).b(localBaseApplicationImpl.getResources().getDimensionPixelSize(2131298998));
      return;
    }
  }
  ...
  public static void a(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    for (int i = 1;; i = 0)
    {
      QQToast.a(localBaseApplicationImpl, paramInt, paramString, i).b(localBaseApplicationImpl.getResources().getDimensionPixelSize(2131298998));
      return;
    }
  }
    ...
    for (;;)
    {
      ...
      else if (i == 4)
      {
        ...
        if ((localAppRuntime instanceof QQAppInterface)) {
          try
          {
            paramFileManagerEntity = bfsj.a((QQAppInterface)localAppRuntime, paramFileManagerEntity);
            if (paramFileManagerEntity != null)
            {
