  ...
  implements slh
{
  ...
  public static int a(Context paramContext)
  {
    ...
    snb.b("wifiInfo", paramContext.toString());
    snb.b("SSID", "" + paramContext.getIpAddress());
  ...
  public static stReportItem a()
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject))
    {
      ...
      localstReportItem.qua = bgyi.a();
      localstReportItem.vendor = bbdh.h();
      localObject = new stDevice();
      ((stDevice)localObject).encrypted_deviceid = sjy.a().e();
      ...
      if (!vzw.a(BaseApplicationImpl.getContext())) {
        break label200;
      }
    }
    label200:
  ...
  public static stReportItem a(stSimpleMetaFeed paramstSimpleMetaFeed, int paramInt)
  {
    ...
    {
      snb.d("weishi-report", "convertFeedToReport feed == null");
      return localstReportItem;
    }
  ...
  private static String a()
  {
    ...
    if ((c.endsWith(ajya.a(2131715984))) && (c.length() > 1)) {
  ...
  private static String a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      default: 
        return str;
        str = ajya.a(2131715980);
        continue;
        str = ajya.a(2131715957);
        continue;
        str = ajya.a(2131715967);
        continue;
        str = ajya.a(2131715974);
        continue;
        str = ajya.a(2131715964);
        continue;
        str = ajya.a(2131715968);
        continue;
        str = ajya.a(2131715983);
        continue;
        str = ajya.a(2131715951);
        continue;
        str = ajya.a(2131715954);
        continue;
        str = ajya.a(2131715959);
        continue;
        str = ajya.a(2131715981);
        continue;
        str = ajya.a(2131715976);
        continue;
        str = ajya.a(2131715970);
        switch (paramInt2)
        {
        default: 
          break;
        case 12: 
          str = ajya.a(2131715946);
          continue;
          str = ajya.a(2131715978);
          continue;
          str = ajya.a(2131715985);
          continue;
          str = ajya.a(2131715958);
          continue;
          str = ajya.a(2131715979);
          continue;
          str = ajya.a(2131715953);
          continue;
          str = ajya.a(2131715949);
          continue;
          str = ajya.a(2131715969);
          continue;
          str = ajya.a(2131715947);
          continue;
          str = ajya.a(2131715973);
          switch (paramInt2)
          {
          default: 
            break;
          case 12: 
            str = ajya.a(2131715961);
            continue;
            str = ajya.a(2131715955);
            switch (paramInt2)
            {
            default: 
              break;
            case 12: 
              str = ajya.a(2131715963);
              continue;
              str = ajya.a(2131715950);
              continue;
              str = ajya.a(2131715960);
              continue;
              str = ajya.a(2131715965);
              switch (paramInt2)
              {
              default: 
                break;
              case 2: 
                str = ajya.a(2131715982);
                break;
              case 6: 
                str = ajya.a(2131715971);
                continue;
                str = ajya.a(2131715972);
                switch (paramInt2)
                {
                default: 
                  break;
                case 2: 
                  str = ajya.a(2131715975);
                  break;
                case 14: 
                  str = ajya.a(2131715952);
                  break;
                case 12: 
                  str = ajya.a(2131715948);
                  break;
                case 6: 
                  str = ajya.a(2131715956);
                  continue;
                  str = ajya.a(2131715962);
                  switch (paramInt2)
                  {
                  case 10: 
                  case 11: 
  ...
  public static String a(Context paramContext)
  {
    ...
    try
    {
      jdField_a_of_type_JavaLangString = bfnn.a("1d76c6");
    ...
    catch (Throwable paramContext)
    {
      for (;;)
      {
        snb.d("weishi-810", "telephonyManager.getDeviceId encounter error:" + paramContext);
      }
    }
  }
  ...
  public static void a(stReportItem paramstReportItem)
  {
    if (paramstReportItem == null)
    {
      snb.d("weishi-report", "report error item = null");
      return;
    }
  ...
  public static void a(ArrayList<stReportItem> paramArrayList)
  {
    ...
    {
      snb.d("weishi-report", "report error items: " + paramArrayList);
      return;
    }
    ...
    while (localIterator.hasNext())
    {
      ...
      snb.b("weishi-report", "report " + str + " stReportItem:" + localstReportItem.toString());
    }
    paramArrayList = new sls(new smw(paramArrayList), null, new smo(str), 2001);
    sll.a().a(paramArrayList);
  }
  ...
  public static String b(Context paramContext)
  {
    ...
    try
    {
      snb.b("weishi-810", "try get QIMei from UserAction.getQIMEI!");
      b = UserAction.getQIMEI();
      if (b == null)
      {
        snb.d("weishi-810", "getImei finally encounter error and return empty");
        b = "";
      }
      return b;
    }
    catch (Throwable paramContext)
    {
      for (;;)
      {
        snb.d("weishi-810", "UserAction.getQIMEI encounter error:" + paramContext);
      }
    }
  }
