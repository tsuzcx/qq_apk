  ...
  extends awoc
{
  ...
  public awpk(QQAppInterface paramQQAppInterface, PublicAccountInfo paramPublicAccountInfo, int paramInt)
  {
  ...
  protected long a(String paramString)
  {
    ...
    long l2 = awvy.b(paramString, this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name, 1073741824L);
    long l1 = l2;
  ...
  public void a(View paramView)
  {
    ...
    do
    {
      ...
      {
        awvy.a("all_result", "clk_public_uin", new String[] { "" + this.jdField_a_of_type_JavaLangString });
        awso.a(null, 0, this.c, "0X8009D51", 0, 0, this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin(), null);
      }
      str = this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin();
      bbfc.a(null, "pubAcc_aio_open", str);
      localObject1 = (akdi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56);
      if (!ajsf.aP.equals(str)) {
        break;
      }
      sjs.a((Context)localObject2, "from_search_result", 1, true);
      awvy.a(this.jdField_a_of_type_JavaLangString, 50, 0, paramView, str, this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.isOffLine, this.c);
      akgc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
      awvy.a(this.jdField_a_of_type_JavaLangString, 50, paramView, false);
    ...
    if ((localObject2 instanceof UniteSearchActivity))
    {
      ...
      axqw.b((QQAppInterface)localObject2, "CliOper", "", "", (String)localObject1, (String)localObject1, 0, 1, 0, this.jdField_a_of_type_Int + "", "", str, this.jdField_a_of_type_JavaLangString);
      label285:
      paramView = nop.a();
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      return;
      if (ajsf.aU.equals(str))
      {
        sgj.a((Context)localObject2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        break label133;
      }
      ...
      if ((TextUtils.equals("3046055438", str)) && (nrw.a()))
      {
        nrk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Context)localObject2, str, ((Context)localObject2).getResources().getString(2131691960));
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a("3046055438", 1008, false);
        break label133;
      }
      if (((localObject1 != null) && (((akdi)localObject1).a(Long.valueOf(str)))) || ((localObject1 == null) && (sgj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str))))
      {
        ...
        localIntent.putExtra("selfSet_leftViewText", ((Context)localObject2).getString(2131690572));
        ahpf.a = true;
        ahpf.a(localIntent);
        ...
        ((akdi)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo);
        break label133;
      }
      if (TextUtils.isEmpty(str))
      {
      ...
      break;
      label887:
      noo.a((QQAppInterface)localObject2, "P_CliOper", "Pb_account_lifeservice", str, paramView, paramView, 0, 0, this.jdField_a_of_type_Int + "", "", this.jdField_a_of_type_JavaLangString, "", false);
      break label285;
    }
  }
  ...
  {
    SpannableString localSpannableString = new awvn(new ArrayList(), a()).a(awvy.a(this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.summary));
