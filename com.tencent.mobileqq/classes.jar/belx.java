...
public class belx
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new bemc(this);
  ...
  public belx()
  {
    ...
    this.jdField_a_of_type_Int = agej.a(4.0F, ((Context)localObject).getResources());
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561614, null));
    ...
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367898));
    int i = 0;
  ...
  void b()
  {
    ...
    int i = agej.a(1.0F, ((Context)localObject2).getResources());
    ...
    try
    {
      ...
      ((ScaleAnimation)localObject1).setAnimationListener(new bely(this));
  ...
  void e()
  {
    int j = this.jdField_a_of_type_AndroidWidgetImageView.getWidth() - agej.a(5.0F, BaseApplicationImpl.getContext().getResources());
    ...
    localObject2 = new bema(this, localAnimatorSet);
