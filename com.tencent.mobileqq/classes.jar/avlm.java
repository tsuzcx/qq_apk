...
public class avlm
{
  ...
  {
    ((avld)paramQQAppInterface.getManager(358)).a(paramString);
  }
    ...
    if (paramMsg.msg_head.has())
    {
      ...
      if ((!parambcre.d) && (paramMsg.sig.has()))
      {
        ...
        if (QLog.isDevelopLevel()) {
          QLog.d("Q.tiny_msg.decoder.TinyMsgCodec", 4, "saveTokenSig tempHead.sig.get()----> sig:" + bhml.a(paramMsg) + ",length:" + paramMsg.length);
        }
      }
    }
  }
  
  public static void a(msg_comm.Msg paramMsg, im_msg_body.Elem paramElem, List<MessageRecord> paramList, QQAppInterface paramQQAppInterface, bcre parambcre)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (((hummer_commelem.MsgElemInfo_servtype34)localObject1).from_nickname.has())
        {
          ...
          a(paramMsg, paramQQAppInterface, parambcre, ((MessageRecord)localObject2).frienduin, str4);
          parambcre.e = Long.parseLong(((MessageRecord)localObject2).frienduin);
          if (!QLog.isColorLevel()) {
            continue;
          }
          QLog.d("Q.tiny_msg.decoder.TinyMsgCodecdecodePBMsgGameInterCommElem", 2, "toTinyId = " + l3 + ", fromTinyId = " + l2 + ", ctx.senderUin = " + parambcre.b + ", ctx.friendUin = " + parambcre.e + ", mr = " + ((MessageRecord)localObject2).getBaseInfoString());
          continue;
        }
      }
