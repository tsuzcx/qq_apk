  ...
  extends ajtd
{
  ...
  private ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new akiq(this);
  public Handler a;
  private HandlerThread jdField_a_of_type_AndroidOsHandlerThread;
  public Messenger a;
  SparseArray<akit> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private final ArrayList<akis> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public akio(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new akip(this, Looper.getMainLooper(), paramQQAppInterface);
  }
  ...
  private void a(int paramInt1, akit paramakit, int paramInt2, int paramInt3)
  {
    Message localMessage = this.jdField_a_of_type_AndroidOsHandler.obtainMessage();
    localMessage.what = 1;
    localMessage.obj = new Object[] { Integer.valueOf(paramInt1), paramakit, Integer.valueOf(paramInt2), Integer.valueOf(paramInt3) };
  ...
  private void b()
  {
    ...
    bgxy.a(this.app, this.jdField_a_of_type_AndroidContentServiceConnection);
  }
  ...
  {
    akit localakit = (akit)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt2, null);
    if (localakit == null) {
      return;
    }
    a(paramInt2, localakit, paramInt1, paramInt3);
  }
  
  public void a(int paramInt, String paramString, long paramLong)
  {
    if (this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt) == null) {
      this.jdField_a_of_type_AndroidUtilSparseArray.append(paramInt, new akit(this, paramString, paramLong));
    }
    a(paramInt);
  }
  ...
  void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    {
      Object localObject = (akis)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((akis)localObject).a();
      localObject = ((akis)localObject).a();
      if ((localView != null) && (localObject != null)) {
        ((akir)localObject).a(localView, paramLong, paramInt1, paramInt2);
      }
      for (;;)
      {
        i += 1;
  ...
  public void a(View paramView, akir paramakir)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      akis localakis = (akis)localIterator.next();
      if (localakis.a() == paramView)
      {
        localakis.b = new WeakReference(paramakir);
        return;
      }
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(new akis(this, paramView, paramakir));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, long paramLong, int paramInt2, int paramInt3)
  {
    ...
    for (Object localObject2 = (StructMsgForGeneralShare)localObject2;; localObject2 = null)
    {
      ...
      for (;;)
      {
        ...
        ((StructMsgForGeneralShare)localObject2).mMsgBrief = (ajyc.a(2131715718) + (String)localObject1);
