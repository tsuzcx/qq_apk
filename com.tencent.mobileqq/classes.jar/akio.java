...
{
  akio(akho paramakho, String paramString, Long paramLong, int paramInt) {}
  
  public void onClick(View paramView)
  {
    if (!akho.a(this.jdField_a_of_type_Akho)) {}
    for (;;)
    {
      EventCollector.getInstance().onViewClicked(paramView);
      return;
      akho.a(this.jdField_a_of_type_Akho, false);
      new Handler().postDelayed(new BannerManager.30.1(this), 1000L);
      Object localObject1 = (QQAppInterface)akho.a(this.jdField_a_of_type_Akho).getAppRuntime();
      ...
      ((StringBuilder)localObject2).append("&version=8.4.8.4810");
      ...
      VasWebviewUtil.openQQBrowserActivity(akho.a(this.jdField_a_of_type_Akho), (String)localObject2, 32768L, localIntent, false, -1);
      ...
      try
      {
        ...
        bcef.a(akho.a(this.jdField_a_of_type_Akho).app, "dc00898", "", "", "0X8009EE3", "0X8009EE3", 9, 0, "", "", "", "");
      }
