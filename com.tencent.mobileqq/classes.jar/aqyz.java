...
class aqyz
{
  ...
  private ArrayList<aqzb> jdField_a_of_type_JavaUtilArrayList;
  
  public aqyz(String paramString)
  {
  ...
  public Object a(Map<String, Object> paramMap)
  {
    ...
    for (;;)
    {
      ...
      paramMap = ((aqzb)localIterator.next()).a(paramMap);
    }
  }
  
  public ArrayList<aqzb> a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        if (i < localArrayList.size())
        {
          ...
          if (str1.charAt(0) == '.')
          {
            paramString.add(new aqzc(str1.substring(1)));
          }
          else
          {
            String str2 = aqzd.a().b(str1);
            if (!TextUtils.isEmpty(str2)) {
              paramString.add(new aqzc(str2));
            }
          }
        }
      }
      ...
      return paramString;
      String str1 = aqzd.a().a(str1);
      if (!TextUtils.isEmpty(str1)) {
        paramString.add(new aqza(Integer.parseInt(str1)));
      } else {
        return null;
      }
      i += 1;
