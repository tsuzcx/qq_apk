...
public class bkcs
{
  ...
  private bkbu jdField_a_of_type_Bkbu = new bkbu();
  ...
  private void e(float paramFloat1, float paramFloat2)
  {
    ...
    this.jdField_a_of_type_Bkbu.a(paramFloat1, paramFloat2);
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_Bkbu.a(this.jdField_b_of_type_AndroidGraphicsRectF, a());
  }
  ...
  public bkcp a(float paramFloat1, float paramFloat2)
  {
    RectF localRectF = this.jdField_a_of_type_Bkbu.a(paramFloat1, paramFloat2);
    ...
    return new bkcp(this.jdField_b_of_type_AndroidGraphicsRectF.centerX() - localRectF.centerX() + paramFloat1, this.jdField_b_of_type_AndroidGraphicsRectF.centerY() - localRectF.centerY() + paramFloat2, c(), b());
  }
  
  public bkcp a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    this.jdField_a_of_type_Bkbu.d(false);
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor != null)
    {
      this.jdField_a_of_type_Bkbu.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor, paramFloat3, paramFloat4);
      ...
      RectF localRectF2 = this.jdField_a_of_type_Bkbu.a(paramFloat1, paramFloat2);
      bkcp localbkcp = new bkcp(paramFloat1, paramFloat2, c(), a());
      localbkcp.a(bkbt.b(localRectF2, localRectF1, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
      return localbkcp;
    }
    return null;
  }
  ...
  {
    if (this.jdField_a_of_type_Bkbu.c()) {}
  ...
  {
    this.jdField_a_of_type_Bkbu.a(paramCanvas);
  }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Bkbu.a();
  }
  ...
  public boolean a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Bkbu.a(false);
      this.jdField_a_of_type_Bkbu.b(true);
      this.jdField_a_of_type_Bkbu.c(false);
      return paramBoolean;
    }
  }
  ...
  public bkcp b(float paramFloat1, float paramFloat2)
  {
    return new bkcp(paramFloat1, paramFloat2, c(), b());
  }
  ...
  public void b(float paramFloat1, float paramFloat2)
  {
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor = this.jdField_a_of_type_Bkbu.a(paramFloat1, paramFloat2);
  }
  ...
  {
    this.jdField_a_of_type_Bkbu.c(paramBoolean);
  }
  ...
  public bkcp c(float paramFloat1, float paramFloat2)
  {
    bkcp localbkcp = new bkcp(paramFloat1, paramFloat2, c(), a());
    RectF localRectF1 = new RectF(this.jdField_a_of_type_Bkbu.a());
    localRectF1.offset(paramFloat1, paramFloat2);
    if (this.jdField_a_of_type_Bkbu.d())
    {
      ...
      localbkcp.a(bkbt.a(localRectF1, localRectF2));
      return localbkcp;
    }
    RectF localRectF2 = new RectF();
    if (this.jdField_a_of_type_Bkbu.b())
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsMatrix.mapRect(localRectF2, this.jdField_a_of_type_Bkbu.a(paramFloat1, paramFloat2));
      localbkcp.a(bkbt.a(localRectF1, localRectF2, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
      return localbkcp;
    }
    this.jdField_a_of_type_AndroidGraphicsMatrix.setRotate(a(), this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY());
    this.jdField_a_of_type_AndroidGraphicsMatrix.mapRect(localRectF2, this.jdField_a_of_type_AndroidGraphicsRectF);
    localbkcp.a(bkbt.b(localRectF1, localRectF2, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
    return localbkcp;
  }
  ...
  {
    this.jdField_a_of_type_Bkbu.a(paramFloat);
  }
  ...
  public void d(float paramFloat1, float paramFloat2)
  {
    ...
    a();
    this.jdField_a_of_type_Bkbu.d(true);
  }
