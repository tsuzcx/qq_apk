  ...
  extends banb
{
  ...
  public baml(bamu parambamu, baub parambaub, String paramString)
  {
    super(parambamu, parambaub);
    this.jdField_c_of_type_Long = 0L;
    this.jdField_d_of_type_Long = 0L;
    this.jdField_a_of_type_Wyp = wyp.a();
    this.m = paramString;
  }
  ...
  public int a()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ArtFilterUploadProcessor", 2, "cancelTask taskId:" + this.jdField_c_of_type_Int + " mRichProtoReq:" + this.jdField_a_of_type_Bawo + " mTrans:" + this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction + " mNetReq:" + this.jdField_a_of_type_Baqv);
    }
  ...
  public void a()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localbawo.jdField_a_of_type_JavaLangString = "art_filter_up";
      ...
      if (QLog.isColorLevel()) {
        QLog.d("ArtFilterUploadProcessor", 2, "sendTransferRequest:" + localbawo);
      }
  ...
  public void a(int paramInt1, int paramInt2, String paramString, int paramInt3, wyr paramwyr, boolean paramBoolean)
  {
    this.x = paramInt1;
    this.jdField_b_of_type_Int = paramInt2;
    this.jdField_b_of_type_JavaLangString = paramString;
    this.jdField_c_of_type_Int = paramInt3;
    this.jdField_a_of_type_Wyr = paramwyr;
    this.jdField_b_of_type_Boolean = paramBoolean;
    if (QLog.isColorLevel()) {
      QLog.d("ArtFilterUploadProcessor", 2, "FilterUploadInfo:" + paramwyr);
    }
    if (paramwyr == null) {
      return;
    }
    this.jdField_q_of_type_Long = paramwyr.jdField_a_of_type_Long;
    this.jdField_a_of_type_ArrayOfByte = paramwyr.jdField_a_of_type_ArrayOfByte;
    this.jdField_d_of_type_JavaLangString = paramwyr.jdField_b_of_type_JavaLangString;
    this.jdField_a_of_type_JavaLangString = (EditVideoArtFilter.jdField_a_of_type_JavaLangString + paramwyr.jdField_b_of_type_Long + "_" + paramInt2 + ".png");
    this.jdField_q_of_type_Int = paramwyr.jdField_a_of_type_Int;
    this.p = paramwyr.jdField_b_of_type_Int;
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 0)
    {
      ...
      ((Bundle)localObject).putString("param_art_filter_resource_path", this.jdField_a_of_type_Wyr.jdField_a_of_type_JavaLangString);
      ...
      this.jdField_a_of_type_Wyp.callbackResult(this.x, EIPCResult.createSuccessResult((Bundle)localObject));
      this.jdField_a_of_type_Wyp.jdField_a_of_type_AndroidUtilSparseArray.remove(this.jdField_b_of_type_Int);
    ...
    label604:
    azmz.a(BaseApplication.getContext()).a(null, "afCosttimeAndFlowReport", bool, this.j - this.i, this.jdField_q_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "");
  }
  ...
  public void a(bawo parambawo, baxd parambaxd)
  {
    ...
    } while (parambaxd == null);
    int k = 0;
    label26:
    if (k < parambaxd.jdField_a_of_type_JavaUtilList.size())
    {
      parambawo = (baxf)parambaxd.jdField_a_of_type_JavaUtilList.get(k);
      if (QLog.isColorLevel()) {
        QLog.d("ArtFilterUploadProcessor", 2, "getTransferResp:" + parambawo);
      }
      if (parambawo.jdField_c_of_type_Int != 0) {
        break label142;
      }
      this.m = parambawo.jdField_c_of_type_JavaLangString;
      if (this.jdField_a_of_type_Wyp.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_Wyr.jdField_a_of_type_JavaLangString))
      {
        this.jdField_a_of_type_Wyp.jdField_a_of_type_JavaLangString = parambawo.jdField_c_of_type_JavaLangString;
        aQ_();
      }
    }
    for (;;)
    {
      ...
      break;
      label142:
      a(parambawo.jdField_c_of_type_Int, "getTransferError");
    }
  }
  ...
  public final void aQ_()
  {
    ...
    do
    {
      ...
      this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), 1, this.jdField_a_of_type_Wyr.jdField_a_of_type_JavaLangString, (int)this.r, arrayOfByte, this.jdField_a_of_type_ArrayOfByte, localbamm, (byte[])localObject);
      ...
      if (QLog.isColorLevel()) {
        QLog.d("ArtFilterUploadProcessor", 2, "<BDH_LOG> Transaction submit RetCode:" + k + " T_ID:" + this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction.getTransationId() + " MD5:" + this.jdField_a_of_type_Wyr.jdField_a_of_type_ArrayOfByte + " uuid:" + this.jdField_l_of_type_JavaLangString + " Path:" + this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction.filePath);
      }
    } while (k == 0);
  ...
  void aR_()
  {
    ...
    Object localObject1 = new bamn(this);
    ...
    localFilterStyle.style_name.set(ByteStringMicro.copyFrom(bdcv.a(this.jdField_b_of_type_JavaLangString)));
  ...
  public void b(String paramString)
  {
    ...
    localbaps.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    localbaps.e = 0;
    localbaps.jdField_a_of_type_Bapw = jdField_a_of_type_Bapw;
    if (QLog.isColorLevel()) {
      QLog.d("ArtFilterUploadProcessor", 2, "sendDownLoadRequest req:" + localbaps);
    }
  ...
  public void onResp(baqw parambaqw)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ArtFilterUploadProcessor", 2, "getDownLoadResponse: " + parambaqw);
    }
    this.jdField_a_of_type_JavaUtilHashMap.put("downloadFileSize", String.valueOf(parambaqw.jdField_a_of_type_Long));
    ...
    if (parambaqw.jdField_a_of_type_JavaLangString != null) {
      QLog.d("ArtFilterUploadProcessor", 1, "download dailed, mErrCode" + parambaqw.jdField_b_of_type_Int + "mErrDesc:" + parambaqw.jdField_a_of_type_JavaLangString);
    }
    a(parambaqw.jdField_b_of_type_Int, parambaqw.jdField_a_of_type_JavaLangString);
  }
}
