  ...
  implements URLDrawableDownListener
{
  ...
  public wxw(PhotoListActivity paramPhotoListActivity)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidContentResResources.getDrawable(2130844504);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    case 0: 
      if (paramView == null)
      {
        ...
        paramViewGroup = new wxx(this);
        paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131370989));
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131370996));
        paramViewGroup.c = ((ImageView)paramView.findViewById(2131370991));
        paramViewGroup.d = ((ImageView)paramView.findViewById(2131369414));
        paramViewGroup.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131370994);
        paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox = ((NumberCheckBox)paramView.findViewById(2131370995));
        paramViewGroup.jdField_a_of_type_Wxu = new wxu(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity);
        if (paramViewGroup.jdField_a_of_type_AndroidViewView != null) {
          paramViewGroup.jdField_a_of_type_AndroidViewView.setOnClickListener(paramViewGroup.jdField_a_of_type_Wxu);
        }
    ...
    for (;;)
    {
      paramViewGroup.jdField_a_of_type_Wxu.a(paramInt);
      paramViewGroup.jdField_a_of_type_Wxu.a(paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox);
      ...
      for (;;)
      {
        ...
        return paramView;
        paramViewGroup = (wxx)paramView.getTag();
        break;
        ...
        if (j == 3)
        {
          ...
          {
            if (paramView.getBackground() == null) {
              paramView.setBackgroundResource(2130837756);
            }
          }
          else {
            paramView.setBackgroundDrawable(null);
      ...
      if (paramView == null)
      {
        localObject1 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130970677, null);
        ...
        localObject2 = new wxx(this);
        ((wxx)localObject2).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject1).findViewById(2131370989));
        ((wxx)localObject2).jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject1).findViewById(2131371609));
        ((wxx)localObject2).c = ((ImageView)((View)localObject1).findViewById(2131370991));
        ((wxx)localObject2).d = ((ImageView)((View)localObject1).findViewById(2131369414));
        ((wxx)localObject2).jdField_a_of_type_AndroidViewView = ((View)localObject1).findViewById(2131370994);
        ((wxx)localObject2).jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox = ((NumberCheckBox)((View)localObject1).findViewById(2131370995));
        ((wxx)localObject2).jdField_a_of_type_Wxu = new wxu(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity);
        if (((wxx)localObject2).jdField_a_of_type_AndroidViewView != null) {
          ((wxx)localObject2).jdField_a_of_type_AndroidViewView.setOnClickListener(((wxx)localObject2).jdField_a_of_type_Wxu);
        }
        ...
        if (!this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.i)
        {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.I)
          {
            ((wxx)localObject2).jdField_a_of_type_AndroidViewView.setVisibility(0);
            paramView = (View)localObject1;
            paramViewGroup = (ViewGroup)localObject2;
          }
        }
      ...
      if ((PhotoListActivity.e(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity)) || (PhotoListActivity.d(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity)))
      {
        ...
        paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130971287, null);
        paramView.setLayoutParams(new AbsListView.LayoutParams(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.b, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoListActivity.jdField_c_of_type_Int));
      ...
      for (;;)
      {
        ...
        paramViewGroup.setImageResource(2130839556);
