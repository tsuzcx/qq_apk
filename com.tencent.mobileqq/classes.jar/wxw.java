  ...
  implements BusinessObserver
{
  ...
  private volatile ConcurrentHashMap<Integer, ConcurrentHashMap<Integer, wxx>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  private void a(int paramInt, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    paramBundle = (wxx)((ConcurrentHashMap)localObject2).remove(Integer.valueOf(localVSBaseRequest.getCurrentSeq()));
    if (paramBundle == null)
    {
    ...
    if (localObject1 != null)
    {
      ...
      try
      {
        ((PROTOCAL.StQWebRsp)localObject2).mergeFrom(bakc.b(((FromServiceMsg)localObject1).getWupBuffer()));
  ...
  {
    if (baip.a(paramVSBaseRequest.getRequestKey()))
    {
      urk.d("VSNetworkHelper| Protocol Cache", "requestKey is empty");
      return;
    }
  ...
  public void a(VSBaseRequest paramVSBaseRequest, wxx paramwxx)
  {
    ...
    try
    {
      ((ConcurrentHashMap)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(i))).put(Integer.valueOf(paramVSBaseRequest.getNewSeq()), paramwxx);
      return;
    }
