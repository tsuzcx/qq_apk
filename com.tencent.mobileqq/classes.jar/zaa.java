  ...
  extends yzw
{
  ...
  private final String jdField_a_of_type_JavaLangString = zaa.class.getName();
  ...
  public zaa(String paramString1, String paramString2)
  {
  ...
  private void c()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 57	zaa:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   6: ifnull +13 -> 19
    //   9: aload_0
    //   10: invokevirtual 57	zaa:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   13: invokevirtual 63	com/jakewharton/disklrucache/DiskLruCache:isClosed	()Z
    //   16: ifeq +88 -> 104
    //   19: invokestatic 67	bdms:c	()Z
    //   22: ifne +10 -> 32
    //   25: aload_0
    //   26: getfield 48	zaa:jdField_b_of_type_Long	J
    //   29: putstatic 20	zaa:jdField_a_of_type_Long	J
    //   32: aload_0
    //   33: invokevirtual 69	zaa:b	()Ljava/lang/String;
    //   36: astore_1
    ...
    //   50: ifne +57 -> 107
    //   53: aload_0
    //   54: getfield 35	zaa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   78: getstatic 20	zaa:jdField_a_of_type_Long	J
    //   81: invokestatic 93	bdnn:b	(J)Ljava/lang/String;
    ...
    //   90: invokestatic 100	wxe:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   93: aload_2
    //   94: invokevirtual 103	java/io/File:mkdirs	()Z
    //   97: pop
    //   98: aload_0
    //   99: aload_2
    //   100: invokevirtual 106	zaa:a	(Ljava/io/File;)Z
    //   103: pop
    //   104: aload_0
    //   105: monitorexit
    //   106: return
    //   107: aload_0
    //   108: getfield 35	zaa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   132: getstatic 20	zaa:jdField_a_of_type_Long	J
    //   135: invokestatic 93	bdnn:b	(J)Ljava/lang/String;
    ...
    //   144: invokestatic 110	wxe:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   147: goto -49 -> 98
    //   150: astore_1
    //   151: aload_0
    //   152: monitorexit
  ...
  public yzx a(String paramString)
  {
    c();
    yzx localyzx = new yzx(this);
    ...
    if ((a() != null) && (str != null))
    {
      ...
      catch (IOException localIOException)
      {
        for (;;)
        {
          wxe.d(this.jdField_a_of_type_JavaLangString, "Get cache error: Cache name: " + str + ", Url: " + paramString);
        }
        wxe.c(this.jdField_a_of_type_JavaLangString, "Get cache success: Cache name: " + str + ", Url: " + paramString);
        return localyzx;
      }
      if (localObject != null)
      {
        localyzx.a(localObject);
        localyzx.a(localObject.getInputStream(0));
        if (localyzx.a() == null)
        {
          wxe.d(this.jdField_a_of_type_JavaLangString, "Get cache error: InputStream is null. Cache name: " + str + ", Url: " + paramString);
          return localyzx;
        }
      }
      wxe.d(this.jdField_a_of_type_JavaLangString, "Get cache error: snapshot is null. Cache name: " + str + ", Url: " + paramString);
      return localyzx;
    }
    wxe.d(this.jdField_a_of_type_JavaLangString, "Get cache error: DiskCache or cacheName is null. Cache name: " + str + ", Url: " + paramString);
    return localyzx;
  }
  ...
  {
    wxe.b(this.jdField_a_of_type_JavaLangString, "Open cache dir.");
    try
    {
  ...
  public boolean a(String paramString)
  {
    ...
    //   9: istore_3
    //   10: aload_0
    //   11: invokespecial 54	zaa:c	()V
    //   14: aload_0
    //   15: invokevirtual 57	zaa:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   18: ifnull +183 -> 201
    //   21: aload_0
    //   22: aload_1
    //   23: invokevirtual 123	zaa:a	(Ljava/lang/String;)Ljava/lang/String;
    //   26: astore 6
    //   28: aload_0
    //   29: getfield 112	zaa:jdField_a_of_type_ComJakewhartonDisklrucacheDiskLruCache	Lcom/jakewharton/disklrucache/DiskLruCache;
    //   32: astore 7
    //   34: aload 7
    //   36: monitorenter
    //   37: iload 4
    //   39: istore_2
    //   40: aload_0
    //   41: invokevirtual 57	zaa:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   44: aload 6
    ...
    //   75: istore_2
    //   76: aload_0
    //   77: getfield 35	zaa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   109: invokestatic 100	wxe:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   112: goto -46 -> 66
    //   115: astore 6
    //   117: aload 7
    //   119: monitorexit
    ...
    //   123: astore 6
    //   125: aload_0
    //   126: getfield 35	zaa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   148: invokestatic 100	wxe:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   151: iload_2
    //   152: ireturn
    //   153: astore 6
    //   155: iload 5
    //   157: istore_2
    //   158: aload_0
    //   159: getfield 35	zaa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   181: invokestatic 100	wxe:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   184: iload_2
    //   185: ireturn
    //   186: astore 6
    //   188: goto -30 -> 158
  ...
  public boolean a(String arg1, java.io.InputStream paramInputStream)
  {
    ...
    //   7: istore 5
    //   9: aload_0
    //   10: getfield 40	zaa:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   13: astore 7
    //   15: aload 7
    //   17: monitorenter
    //   18: aload_0
    //   19: iconst_1
    //   20: putfield 185	zaa:jdField_a_of_type_Boolean	Z
    //   23: aload_0
    //   24: aload_1
    //   25: putfield 44	zaa:d	Ljava/lang/String;
    //   28: aload 7
    //   30: monitorexit
    //   31: aload_0
    //   32: invokespecial 54	zaa:c	()V
    //   35: aload_0
    //   36: aload_1
    //   37: invokevirtual 123	zaa:a	(Ljava/lang/String;)Ljava/lang/String;
    //   40: astore 11
    //   42: aload_0
    //   43: invokevirtual 57	zaa:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   46: ifnull +465 -> 511
    //   49: aload 11
    //   51: ifnull +460 -> 511
    //   54: aload_2
    //   55: ifnull +456 -> 511
    //   58: aload_0
    //   59: getfield 112	zaa:jdField_a_of_type_ComJakewhartonDisklrucacheDiskLruCache	Lcom/jakewharton/disklrucache/DiskLruCache;
    //   62: astore 10
    //   64: aload 10
    //   66: monitorenter
    //   67: aload_0
    //   68: invokevirtual 57	zaa:a	()Lcom/jakewharton/disklrucache/DiskLruCache;
    //   71: aload 11
    ...
    //   93: getstatic 22	zaa:jdField_b_of_type_Int	I
    //   96: invokespecial 200	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;I)V
    //   99: astore 8
    //   101: aload 8
    //   103: astore 7
    //   105: getstatic 22	zaa:jdField_b_of_type_Int	I
    //   108: newarray byte
    //   110: astore 12
    //   112: aload 8
    //   114: astore 7
    ...
    //   130: astore 7
    //   132: aload_0
    //   133: getfield 185	zaa:jdField_a_of_type_Boolean	Z
    //   136: ifne +186 -> 322
    //   139: aload 8
    //   141: astore 7
    //   143: aload_0
    //   144: getfield 35	zaa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   147: ldc 208
    //   149: invokestatic 211	wxe:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   152: aload 8
    //   154: astore 7
    //   156: aload 8
    ...
    //   181: istore 4
    //   183: aload_0
    //   184: getfield 35	zaa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   216: invokestatic 152	wxe:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   219: aload_0
    //   220: getfield 112	zaa:jdField_a_of_type_ComJakewhartonDisklrucacheDiskLruCache	Lcom/jakewharton/disklrucache/DiskLruCache;
    ...
    //   231: istore 5
    //   233: aload_0
    //   234: getfield 185	zaa:jdField_a_of_type_Boolean	Z
    //   237: ifne +12 -> 249
    //   240: aload_0
    //   241: aload_1
    //   242: invokevirtual 229	zaa:a	(Ljava/lang/String;)V
    //   245: iload 4
    //   247: istore 5
    //   249: aload_0
    //   250: getfield 40	zaa:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   253: astore_1
    //   254: aload_1
    //   255: monitorenter
    //   256: aload_0
    //   257: iconst_0
    //   258: putfield 185	zaa:jdField_a_of_type_Boolean	Z
    //   261: aload_0
    //   262: ldc 42
    //   264: putfield 44	zaa:d	Ljava/lang/String;
    //   267: aload_1
    //   268: monitorexit
    //   269: iload 5
    //   271: ireturn
    ...
    //   278: astore 7
    //   280: aload_0
    //   281: getfield 35	zaa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   313: invokestatic 100	wxe:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   316: aconst_null
    //   317: astore 9
    //   319: goto -241 -> 78
    //   322: aload 8
    //   324: astore 7
    //   326: aload_0
    //   327: getfield 35	zaa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   354: invokestatic 110	wxe:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   357: aload 8
    //   359: astore 7
    //   361: aload 8
    //   363: aload 12
    ...
    //   378: astore 7
    //   380: aload_0
    //   381: getfield 35	zaa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   413: invokestatic 100	wxe:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   416: iload 5
    //   418: istore 4
    //   420: aload_2
    //   421: ifnull -238 -> 183
    ...
    //   471: athrow
    //   472: aload_0
    //   473: getfield 35	zaa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   505: invokestatic 100	wxe:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   508: goto -289 -> 219
    //   511: aload_0
    //   512: getfield 35	zaa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   544: invokestatic 100	wxe:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   547: iload 6
    //   549: istore 5
    //   551: goto -302 -> 249
    //   554: astore_2
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    if ((a() != null) && (str != null))
    {
      ...
      catch (IOException localIOException)
      {
        for (;;)
        {
          wxe.d(this.jdField_a_of_type_JavaLangString, "Set cache error: Exception ");
        }
      }
      finally {}
      bool1 = bool2;
      if (localObject != null) {
        wxe.c(this.jdField_a_of_type_JavaLangString, "name: " + paramString1 + ", Cache name: " + str + ", value length: " + paramString2.length());
      }
      try
      {
        localObject.set(0, svi.a(paramString2));
        localObject.commit();
        bool1 = true;
      }
      catch (IOException paramString1)
      {
        for (;;)
        {
          wxe.d(this.jdField_a_of_type_JavaLangString, "Commit cache error: Exception ");
          bool1 = bool2;
        }
      }
  ...
  {
    if (bdms.c()) {}
    for (String str = bdms.a() + File.separator + "Android" + File.separator + "data" + File.separator + jdField_b_of_type_JavaLangString + File.separator + a();; str = c + File.separator + a())
    {
      wxe.b(this.jdField_a_of_type_JavaLangString, "Init cache dir: " + str);
      return str;
    }
  }
