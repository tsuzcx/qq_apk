  ...
  extends zeq
{
  ...
  protected void a()
  {
    ...
    if (MemoryConfigs.a().d > 0.0F)
    {
      ...
      int i = zeo.a().a(MemoryManager.a(Process.myPid()));
      int j = zeo.a().a(this.jdField_a_of_type_ComTencentMobileqqAppGuardManager.jdField_a_of_type_Array2dOfLong, this.jdField_a_of_type_ComTencentMobileqqAppGuardManager.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqAppGuardManager.b);
      l = zeo.a().b[(i + j)] / 12000;
  ...
  protected void b(String paramString)
  {
    ...
    if ("fake_p_msg".equals(paramString)) {
      this.c = (zeo.a().a(this.jdField_a_of_type_ComTencentMobileqqAppGuardManager.jdField_a_of_type_Array2dOfLong, this.jdField_a_of_type_ComTencentMobileqqAppGuardManager.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqAppGuardManager.b, MemoryManager.a(Process.myPid())) / 12000L - 2L);
    }
