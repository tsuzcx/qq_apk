...
public class bkfs
{
  ...
  {
    Object localObject = new File(nmp.a("1018") + "1018");
    if (!((File)localObject).isDirectory()) {}
    do
    {
      return null;
      localObject = ((File)localObject).listFiles(new bkft());
    } while ((localObject == null) || (localObject.length == 0));
    return localObject[0];
  }
  
  public static void a(String paramString, boolean paramBoolean, bkfr parambkfr)
  {
    if (jdField_a_of_type_Bkfq == null) {
      jdField_a_of_type_Bkfq = bkfq.a();
    }
    jdField_a_of_type_Bkfq.a(paramString, paramBoolean, parambkfr);
  }
  ...
  {
    paramString = new File(paramString).listFiles(new bkfu());
    boolean bool2;
  ...
  private static boolean c(String paramString)
  {
    ...
    //   15: aload_0
    //   16: invokestatic 93	nmp:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   46: astore 4
    //   48: invokestatic 42	bkfs:a	()Ljava/io/File;
    //   51: astore_0
    //   52: aload_0
    //   53: ifnonnull +9 -> 62
    //   56: aload 4
    //   58: invokestatic 211	bkfs:b	(Ljava/lang/String;)Z
    //   61: ireturn
    ...
    //   135: ifne +113 -> 248
    //   138: aload 4
    //   140: invokestatic 211	bkfs:b	(Ljava/lang/String;)Z
    //   143: istore_1
    //   144: iload_1
    //   145: ireturn
    //   146: astore_0
