  ...
  implements PluginManagerUpdater
{
  ...
  public avrm(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    this.e = paramString3;
    ...
    this.jdField_a_of_type_Avrl = new avrl(paramContext, paramString1, paramString3);
  ...
  private boolean a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        throw new Error(this.jdField_a_of_type_JavaLangString + anvx.a(2131700967));
      }
      finally
      {
        localObject1 = null;
      ...
      try
      {
        if (((HttpURLConnection)localObject1).getResponseCode() != 200) {
          throw new Error(anvx.a(2131700969) + 200 + anvx.a(2131700970) + ((HttpURLConnection)localObject1).getResponseCode());
        }
  ...
  public File a()
  {
    ...
    localavuj.a(BaseApplicationImpl.getContext());
    localavuj.a(this.jdField_a_of_type_JavaLangString, new avro(this, localFile, arrayOfException, l, localCountDownLatch));
    localavuj.b(avul.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaIoFile.getAbsolutePath()));
  ...
  public void a(avrp paramavrp)
  {
    this.jdField_a_of_type_Avrp = paramavrp;
  }
  ...
  public Future<File> update()
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentFuture = ThreadManagerExecutor.getExecutorService(192).submit(new avrn(this));
    return this.jdField_a_of_type_JavaUtilConcurrentFuture;
  }
