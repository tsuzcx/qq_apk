...
public class bhwl
{
  ...
  public static bhwp[] a;
  public static bhwp b;
  public static String b;
  public static bhwp c;
  public static bhwp d;
  public static bhwp e;
  public static bhwp f;
  public static bhwp g;
  public static bhwp h;
  public static bhwp i;
  
  static
  {
    jdField_a_of_type_Bhwp = new bhwp("recommendEmotion.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_emoji_aioPanal/", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_emoji_aioPanal/xydata.json", "recommendEmotionVersion", "vipData_emoji_aio_recommend.json");
    jdField_b_of_type_Bhwp = new bhwp("IndividuationUrls.json", "", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_individuation_url/android.json", "individuationUrlJsonNewVersion", "vipData_individuation_url_json");
    c = new bhwp("Individuation.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_individuation/", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_individuation/xydata.json", "IndividuationVersion", "individ_json");
    d = new bhwp("EmoticonWording.json", "", "https://i.gtimg.cn/club/item/parcel/client_wording.json", "EmoticonWordingVersion", "wording_json");
    e = new bhwp("WebviewCrashReport.json", "", "https://i.gtimg.cn/qqshow/admindata/comdata/vip_crash_report/WebviewCrashReport.json", "WebviewCrashJSONVersion", "WebviewCrashReport.json");
    f = new bhwp("Qutu_xydata.json", "", "https://i.gtimg.cn/qqshow/admindata/comdata/vipQutu_release_zip/xydata.json", "QutuXYDataJsonVersion", "xydata.json");
    g = new bhwp("iRedPacket_v2.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipRedPacketDataV2/", "https://i.gtimg.cn/qqshow/admindata/comdata/vipRedPacketDataV2/xydata.mobile.v1.json", "vipRedPacketData_json_v2", "vipRedPacketData_json_v2");
    h = new bhwp("UrlIntercept.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_url_to_api", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_url_to_api/android.json", "UrlIntercept_json", "UrlIntercept_json");
    jdField_a_of_type_JavaLangString = "clubContentPendantMarketJsonUpdate";
    i = new bhwp("font_info.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipList_font_data", "https://i.gtimg.cn/qqshow/admindata/comdata/vipList_font_data/version.json", "FontInfoList_json", "FontInfoList_json");
    jdField_a_of_type_ArrayOfBhwp = new bhwp[] { jdField_a_of_type_Bhwp, c, d };
    jdField_b_of_type_JavaLangString = "https://i.gtimg.cn/xydata";
    jdField_a_of_type_JavaUtilHashMap = new HashMap();
    jdField_a_of_type_Biht = new bhwm();
  }
  ...
  public static JSONObject a(QQAppInterface paramQQAppInterface, bhwp parambhwp, boolean paramBoolean)
  {
    Object localObject = paramQQAppInterface.getApplication().getApplicationContext();
    String str = parambhwp.jdField_a_of_type_JavaLangString;
    localObject = new File(((Context)localObject).getFilesDir(), str);
    if (((File)localObject).exists()) {
      try
      {
        paramQQAppInterface = bhmi.a((File)localObject, -1);
    ...
    for (;;)
    {
      ...
      if (paramBoolean) {
        a(paramQQAppInterface, parambhwp);
      }
    }
  }
  ...
  public static void a(AppInterface paramAppInterface, bhwp parambhwp, String paramString, File paramFile, Bundle paramBundle)
  {
    if (paramFile == null) {}
    String str1;
    do
    {
      return;
      str1 = paramString;
    } while ((paramString == null) && (parambhwp == null));
    label427:
    label435:
    label441:
    label444:
    for (;;)
    {
      try
      {
        for (;;)
        {
          str1 = parambhwp.jdField_b_of_type_JavaLangString;
          if (parambhwp == null) {
            break label427;
          }
          parambhwp = parambhwp.jdField_a_of_type_JavaLangString;
          ...
          String str3 = parambhwp + "_" + j;
          if (QLog.isColorLevel()) {
            QLog.d("ClubContentJsonTask", 2, "club_downloadFile,method:" + paramString + ",key:" + parambhwp + ", server version:" + j + ",ifromet:" + str2);
          }
          ...
          paramFile = new bihu(str1, paramFile);
          paramFile.n = true;
          paramFile.jdField_a_of_type_JavaLangString = parambhwp;
          ((bihw)paramAppInterface.getManager(47)).a(1).a(paramFile, jdField_a_of_type_Biht, paramBundle);
          if (QLog.isColorLevel()) {
          ...
          try
          {
            ...
            paramString.put("param_key", parambhwp);
            paramString.put("param_ifromet", str2);
            bdmc.a(paramAppInterface.getApplication().getApplicationContext()).a(paramAppInterface.getAccount(), "VipClubContentJsonTaskLoad", true, 1L, 0L, paramString, "", false);
          }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    int j = 0;
    while (j < jdField_a_of_type_ArrayOfBhwp.length)
    {
      a(paramQQAppInterface, jdField_a_of_type_ArrayOfBhwp[j]);
      j += 1;
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, bhwp parambhwp)
  {
    int j = 10;
    int k = 0;
    if ((paramQQAppInterface == null) || (parambhwp == null)) {}
    do
    {
      return;
      File localFile = new File(paramQQAppInterface.getApplication().getApplicationContext().getFilesDir(), parambhwp.jdField_a_of_type_JavaLangString);
      if (!localFile.exists())
      {
        if (QLog.isColorLevel()) {
          QLog.d("ClubContentJsonTask", 2, "downloadIfNotExist, not exist: " + parambhwp.jdField_a_of_type_JavaLangString);
        }
        for (;;)
        {
          try
          ...
          ((Bundle)localObject).putString("version_key", parambhwp.d);
          ((Bundle)localObject).putString("method", "downloadIfNotExist");
          ((Bundle)localObject).putString("ifromet", "null1");
          a(paramQQAppInterface, parambhwp, asfa.a("VIP_emosm", parambhwp.jdField_b_of_type_JavaLangString), localFile, (Bundle)localObject);
          return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, bhwp parambhwp, int paramInt, boolean paramBoolean)
  {
    File localFile = new File(paramQQAppInterface.getApplication().getApplicationContext().getFilesDir(), parambhwp.jdField_a_of_type_JavaLangString);
    Bundle localBundle = new Bundle();
    localBundle.putInt("version", paramInt);
    localBundle.putString("version_key", parambhwp.d);
    localBundle.putString("method", "updateJson");
    localBundle.putString("ifromet", String.valueOf(paramBoolean));
    a(paramQQAppInterface, parambhwp, null, localFile, localBundle);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    //   24: new 476	bhwn
    //   27: dup
    //   28: invokespecial 477	bhwn:<init>	()V
    //   31: putstatic 479	bhwl:jdField_a_of_type_Bhwn	Lbhwn;
    //   34: aload 6
    //   36: ldc_w 481
    ...
    //   55: invokestatic 494	biar:a	(Lmqq/app/AppRuntime;Ljava/lang/String;Ljava/lang/String;)Z
    //   58: pop
    //   59: aload 6
    //   61: ldc_w 496
    ...
    //   178: astore 5
    //   180: getstatic 479	bhwl:jdField_a_of_type_Bhwn	Lbhwn;
    //   183: aload 4
    //   185: putfield 519	bhwn:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   188: getstatic 479	bhwl:jdField_a_of_type_Bhwn	Lbhwn;
    //   191: aload 5
    //   193: putfield 520	bhwn:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   515: getstatic 598	ahtp:a	Lcom/tencent/util/LRULinkedHashMap;
    //   518: astore 4
    //   520: aload 4
    //   522: monitorenter
    //   523: getstatic 598	ahtp:a	Lcom/tencent/util/LRULinkedHashMap;
    //   526: invokevirtual 603	com/tencent/util/LRULinkedHashMap:clear	()V
    //   529: aload 4
    //   531: monitorexit
    //   532: aload_0
    //   533: invokestatic 608	bhto:a	(Lcom/tencent/common/app/AppInterface;)V
    //   536: aload 6
    //   538: ldc_w 610
    ...
    //   625: putstatic 630	avrl:jdField_a_of_type_Int	I
    //   628: aload 6
    //   630: ldc_w 632
    ...
    //   715: aload_0
    //   716: ifnull -700 -> 16
    //   719: getstatic 663	bhwz:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   722: astore 4
    //   724: aload_0
    //   725: ldc_w 534
