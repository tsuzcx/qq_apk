...
public class bhwl
  implements bhwj, NetworkState.NetworkStateListener
{
  private static bhwl jdField_a_of_type_Bhwl;
  ...
  private bhwi jdField_a_of_type_Bhwi = new bhwi();
  ...
  private bhwl()
  {
    this.jdField_a_of_type_Bhwi.a(this);
    a();
  }
  
  public static bhwl a()
  {
    try
    {
      if (jdField_a_of_type_Bhwl == null) {
        jdField_a_of_type_Bhwl = new bhwl();
      }
      bhwl localbhwl = jdField_a_of_type_Bhwl;
      return localbhwl;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bhwm(this, localHandlerThread.getLooper());
    ...
    for (int i = 1;; i = 0)
    {
      if (paramInt2 != 0)
      {
        if ((paramStatReportRequest != null) && (paramStatReportRequest.size() > 0) && (i == 0))
        {
          ...
          while (paramInt2 < i)
          {
            ...
            paramStatReportResponse = bhvy.a().a(String.valueOf(j));
            if (paramStatReportResponse != null) {
              paramStatReportRequest.addAll(paramStatReportResponse);
            }
            bhvy.a().a(String.valueOf(j), paramStatReportRequest);
            paramInt2 += 1;
          }
        }
      }
      else if ((i != 0) && (paramStatReportRequest != null) && (paramStatReportRequest.size() > 0))
      {
        ...
        while (paramStatReportRequest.hasNext())
        {
          ...
          bhvy.a().a(String.valueOf(paramStatReportResponse.type));
        }
      }
