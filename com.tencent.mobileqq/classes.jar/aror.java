...
public class aror
{
  private static aror a;
  
  public static aror a()
  {
    if (a == null) {}
    try
    {
  ...
  private MsgBackupUserData a(submsgtype0x11a.UserData paramUserData)
  {
    ...
    if (paramUserData.bytes_ip.has()) {
      localarpz.a(paramUserData.bytes_ip.get().toStringUtf8());
    }
    if (paramUserData.rpt_fixed32_port.has()) {
      localarpz.a(paramUserData.rpt_fixed32_port.get());
    }
    if (paramUserData.bytes_bssid.has()) {
      localarpz.c(paramUserData.bytes_bssid.get().toStringUtf8());
    }
    if (paramUserData.bytes_ssid.has()) {
      localarpz.b(paramUserData.bytes_ssid.get().toStringUtf8());
    }
    if (paramUserData.enum_platform.has()) {
      localarpz.a(paramUserData.enum_platform.get());
    }
    return localarpz.a();
  }
  ...
  public void a(String paramString)
  {
    ...
    localObject1 = new awbn();
    localObject2 = ((SubMsgType0x7.MsgBody)localObject2).toByteArray();
    ((awbn)localObject1).jdField_a_of_type_Int = 7;
    ((awbn)localObject1).jdField_a_of_type_ArrayOfByte = ((byte[])localObject2);
    long l1 = apck.b();
    long l2 = apck.a();
    localObject1 = awbg.a(paramString, 13, paramString.c(), (awbn)localObject1, l2, awbk.b(l1));
    ...
    if (paramMsgBody != null)
    {
      ...
      if (paramMsgBody.enum_result.has())
      {
        ...
        if (paramMsgBody.bytes_token.has()) {
          localarpl.a(paramMsgBody.bytes_token.get().toStringUtf8());
        }
        if (paramMsgBody.bytes_encrypt_key.has()) {
          localarpl.b(paramMsgBody.bytes_encrypt_key.get().toStringUtf8());
        }
        if (paramMsgBody.msg_user_data.has()) {
          localarpl.a(a((submsgtype0x11a.UserData)paramMsgBody.msg_user_data.get()));
        }
        if (paramMsgBody.enum_biz_type.has()) {
          localarpl.a(paramMsgBody.enum_biz_type.get());
        }
        paramMsgBody = localarpl.a();
        if (QLog.isColorLevel()) {
          QLog.d("MsgBackup.MsgBackupPushHandler", 2, "processOnLinePush receive processOnLinePush0x11a response = " + paramMsgBody);
        }
        arpa.a().a(paramMsgBody);
      }
    }
    label180:
    do
  ...
  public void a(submsgtype0x11b.MsgBody paramMsgBody)
  {
    if (paramMsgBody != null)
    {
      arpt localarpt = new arpt();
      if (paramMsgBody.bytes_qr_sig.has()) {
        localarpt.a(paramMsgBody.bytes_qr_sig.get().toStringUtf8());
      }
      if (paramMsgBody.enum_biz_type.has()) {
        localarpt.a(paramMsgBody.enum_biz_type.get());
      }
      paramMsgBody = localarpt.a();
      if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      if (paramGenericSubCmd.length() == 1)
      {
        ...
        if ("exit".equals(paramGenericSubCmd.optString("cmd")))
        {
          ...
          if (TextUtils.equals(paramGenericSubCmd, arop.a().a())) {
            arrt.a().b(true);
          }
        }
      }
