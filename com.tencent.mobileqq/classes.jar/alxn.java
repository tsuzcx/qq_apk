...
public class alxn
  extends Handler
{
  public alxn(QQSpecialCareSettingActivity paramQQSpecialCareSettingActivity) {}
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              QQSpecialCareSettingActivity.a(this.a, new biau(this.a, this.a.getTitleBarHeight()));
