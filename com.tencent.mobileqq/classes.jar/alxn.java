...
public class alxn
{
  ...
  public static int a(long paramLong, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    int i = -1;
    alxy localalxy = alvx.b(paramLong);
    if (localalxy != null) {
      i = localalxy.a();
    }
  ...
  private static boolean a(long paramLong, String paramString1, String paramString2, boolean paramBoolean, int paramInt)
  {
    if (paramString1.equals("cs.check_pubAccount_state.local")) {
      a(paramString1, paramString2, paramBoolean, new alxo(paramLong), paramInt);
    }
    label199:
    do
    {
      ...
      do
      {
        do
        {
          ...
          {
            a(paramString1, paramString2, paramBoolean, new alxp(paramLong), paramInt);
            return false;
          }
          if (!paramString1.equals("cs.get_dress_path.local")) {
            break label199;
          }
          localObject2 = new alxq(paramLong, paramString1);
          try
          {
            alxy localalxy = alvx.b(paramLong);
            str = paramString2;
            if (localalxy != null)
            {
              ...
              {
                localJSONObject.put("gameId", localalxy.a());
        ...
        Object localObject1 = new alxr(paramLong);
  ...
  public static boolean a(long paramLong, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localalym != null)
        {
          paramBoolean = localalym.a(paramLong, paramBoolean, paramString1, paramString2);
          return paramBoolean;
        }
      }
