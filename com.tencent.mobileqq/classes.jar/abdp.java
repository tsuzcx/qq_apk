...
{
  abdp(abdo paramabdo, ArkLocalAppMgr paramArkLocalAppMgr) {}
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    if ((paramBoolean) && (!TextUtils.isEmpty(paramObject)))
    {
      try
      {
        ...
        if (paramObject == null)
        {
          ...
          if (this.jdField_a_of_type_Abdo.a.jdField_a_of_type_ComTencentMobileqqArkArkMessageServerLogic$IPassiveSearchIntentByServerHandler == null) {
            break label680;
          }
          this.jdField_a_of_type_Abdo.a.jdField_a_of_type_ComTencentMobileqqArkArkMessageServerLogic$IPassiveSearchIntentByServerHandler.a(this.jdField_a_of_type_Abdo.a.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Abdo.a.jdField_a_of_type_JavaLangObject, null);
          return;
        }
        ...
        if (i != 0)
        {
          ...
          if ((i == 1) && (this.jdField_a_of_type_Abdo.a.jdField_a_of_type_ComTencentMobileqqArkArkMessageServerLogic$IPassiveSearchIntentByServerHandler == null)) {
            break label680;
          }
          this.jdField_a_of_type_Abdo.a.jdField_a_of_type_ComTencentMobileqqArkArkMessageServerLogic$IPassiveSearchIntentByServerHandler.a(this.jdField_a_of_type_Abdo.a.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Abdo.a.jdField_a_of_type_JavaLangObject, null);
          return;
    ...
    for (;;)
    {
      if (paramInt < i)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqArkArkLocalAppMgr.a(((ArkAiInfo)localObject).jdField_a_of_type_JavaLangString, str1, 2, new abdq(this, (ArkAiInfo)localObject, localArkPassiveSearchInfo, paramInt, i));
        break label681;
        if (this.jdField_a_of_type_Abdo.a.jdField_a_of_type_ComTencentMobileqqArkArkMessageServerLogic$IPassiveSearchIntentByServerHandler != null) {
          this.jdField_a_of_type_Abdo.a.jdField_a_of_type_ComTencentMobileqqArkArkMessageServerLogic$IPassiveSearchIntentByServerHandler.a(this.jdField_a_of_type_Abdo.a.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Abdo.a.jdField_a_of_type_JavaLangObject, null);
        }
