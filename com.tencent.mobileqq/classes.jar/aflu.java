...
public class aflu
  extends afkk
  implements afhm, View.OnClickListener
{
  int jdField_a_of_type_Int;
  afmo jdField_a_of_type_Afmo;
  ...
  public aflu(FragmentActivity paramFragmentActivity)
  {
  ...
  public int a()
  {
    return this.jdField_a_of_type_Afmo.jdField_a_of_type_ArrayOfInt[this.jdField_a_of_type_Int];
  }
  ...
  {
    super.a();
    a(2131302804).setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131302832));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
    this.jdField_a_of_type_ComTencentWidgetFadeIconImageView = ((FadeIconImageView)a(2131302803));
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator = ((SimpleSlidingIndicator)a(2131310489));
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQViewPager = ((QQViewPager)a(2131298508));
    this.jdField_a_of_type_Afmo = new afmo();
    int[] arrayOfInt1 = a();
    int[] arrayOfInt2 = b();
    if ((arrayOfInt1 != null) && (arrayOfInt2 != null))
    {
      this.jdField_a_of_type_Afmo.a(a(), arrayOfInt1, arrayOfInt2);
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setTabData(this.jdField_a_of_type_Afmo.jdField_a_of_type_ArrayOfJavaLangString, arrayOfInt1);
    }
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setOnTabListener(this);
    this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryViewPagerAdapter = new ChatHistoryViewPagerAdapter(a(), a(), this, this.jdField_a_of_type_Afmo, this.jdField_a_of_type_JavaLangString);
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQViewPager.setOnPageChangeListener(new aflv(this));
    c(0);
  }
  ...
  public void a(int paramInt)
  {
    ...
    case 1602: 
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131624448);
      this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.setVisibility(8);
      this.c = 1;
      return;
    }
  ...
  public void e()
  {
    if (this.c == 2)
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131624448);
      this.c = 1;
      if (this.jdField_a_of_type_Afmn != null) {
        this.jdField_a_of_type_Afmn.c();
      }
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      this.c = 1;
      return;
    } while (this.jdField_a_of_type_Afmn == null);
    this.jdField_a_of_type_Afmn.a();
  }
}
