  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.getResultCode() == 1000))
    {
      ...
      {
        paramFromServiceMsg = (bcvc)paramIntent.getManager(QQManagerFactory.GAMECENTER_MANAGER);
        if (paramFromServiceMsg != null)
        {
          ...
          notifyObserver(null, 10000, true, paramFromServiceMsg, ayqy.class);
    ...
    for (;;)
    {
      ...
      notifyObserver(null, 10000, false, paramIntent, ayqy.class);
      return;
      if (paramIntent != null)
      {
  ...
  public void service(Intent paramIntent)
  {
    ...
    if ((str != null) && ("gc_refresh_ui".equals(str)))
    {
      ...
      notifyObserver(null, 10000, true, paramIntent, ayqy.class);
