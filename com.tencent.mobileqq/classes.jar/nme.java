...
public abstract class nme
{
  ...
  public nme(Context paramContext, String paramString)
  {
  ...
  public boolean a(AppInterface paramAppInterface, String paramString)
  {
    try
    {
      ...
      paramAppInterface = ((bihw)((QQAppInterface)paramAppInterface).getManager(47)).a(1);
      paramString = antf.ba + a() + ".tmp";
      localObject = new bihu((String)localObject, new File(paramString));
      ((bihu)localObject).b = 3;
      Bundle localBundle = new Bundle();
      localBundle.putString("file_path", paramString);
      paramAppInterface.a((bihu)localObject, new nmf(this), localBundle);
      return true;
    }
