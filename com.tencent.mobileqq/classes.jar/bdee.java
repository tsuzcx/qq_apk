...
public class bdee
{
  ...
  {
    return bmwl.jdField_a_of_type_JavaLangString;
  }
  ...
  /* Error */
  public static boolean a(bnkw parambnkw)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore_2
    //   2: ldc 2
    //   4: monitorenter
    //   5: invokestatic 161	bdee:a	()Z
    //   8: istore_3
    //   9: iload_3
    //   10: ifeq +71 -> 81
    //   13: invokestatic 166	bnku:a	()Lbnku;
    //   16: getstatic 171	bnkt:c	Lbnkt;
    //   19: aload_0
    //   20: iconst_0
    //   21: invokevirtual 174	bnku:a	(Lbnkt;Lbnkw;Z)V
    //   24: getstatic 171	bnkt:c	Lbnkt;
    //   27: invokestatic 179	bnky:b	(Lbnkt;)Z
    //   30: istore_1
    ...
    //   52: iload_1
    //   53: invokevirtual 186	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   56: ldc 188
    //   58: invokevirtual 38	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   61: iload_3
    //   62: invokevirtual 186	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   65: ldc 190
    ...
    //   73: invokestatic 193	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   76: ldc 2
    //   78: monitorexit
    //   79: iload_1
    //   80: ireturn
    ...
    //   84: ifnull -53 -> 31
    //   87: aload_0
    //   88: getstatic 171	bnkt:c	Lbnkt;
    //   91: aconst_null
    //   92: iconst_0
    //   93: iconst_m1
    //   94: invokeinterface 199 5 0
    //   99: iload_2
    //   100: istore_1
    //   101: goto -70 -> 31
    //   104: astore_0
  ...
  /* Error */
  public static boolean a(QQAppInterface paramQQAppInterface, Context paramContext, bnkw parambnkw)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 4
    //   3: ldc 2
    //   5: monitorenter
    //   6: invokestatic 161	bdee:a	()Z
    //   9: istore 5
    //   11: iload 5
    //   13: ifeq +77 -> 90
    //   16: invokestatic 166	bnku:a	()Lbnku;
    //   19: getstatic 205	bnkt:b	Lbnkt;
    //   22: aload_2
    //   23: iconst_0
    //   24: invokevirtual 174	bnku:a	(Lbnkt;Lbnkw;Z)V
    //   27: aload_0
    //   28: invokestatic 210	bcxs:a	(Lcom/tencent/mobileqq/app/QQAppInterface;)Z
    //   31: pop
    //   32: getstatic 205	bnkt:b	Lbnkt;
    //   35: invokestatic 179	bnky:b	(Lbnkt;)Z
    //   38: istore_3
    ...
    //   60: iload_3
    //   61: invokevirtual 186	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   64: ldc 188
    //   66: invokevirtual 38	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   69: iload 5
    //   71: invokevirtual 186	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   74: ldc 190
    ...
    //   82: invokestatic 193	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   85: ldc 2
    //   87: monitorexit
    //   88: iload_3
    //   89: ireturn
    ...
    //   94: ifnull -55 -> 39
    //   97: aload_2
    //   98: getstatic 205	bnkt:b	Lbnkt;
    //   101: aconst_null
    //   102: iconst_0
    //   103: iconst_m1
    //   104: invokeinterface 199 5 0
    //   109: iload 4
    //   111: istore_3
    //   112: goto -73 -> 39
    //   115: astore_0
  ...
  public static String b()
  {
    ...
    return bcww.b() + str + File.separator;
  }
  
  public static boolean b()
  {
    boolean bool1 = bnky.a();
  ...
  public static String c()
  {
    ...
    return bcyi.b() + str + File.separator;
  }
