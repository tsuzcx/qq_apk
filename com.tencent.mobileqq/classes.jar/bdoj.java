...
public class bdoj
{
  ...
  {
    bdoe.a("WadlJsBridgeCall", 2, "dispatch wadlParams:" + paramWadlParams);
    ...
    case 2: 
    case 12: 
      biby.a().a(paramWadlParams);
      return;
    case 3: 
    case 10: 
      biby.a().a(paramWadlParams.d, paramWadlParams.jdField_a_of_type_JavaLangString);
      return;
    case 4: 
      biby.a().b(paramWadlParams.d, paramWadlParams.jdField_a_of_type_JavaLangString);
      return;
    }
  ...
  {
    bdoe.b("WadlJsBridgeCall", "doDownloadAction params:" + paramString1 + ",fromWeb:" + paramBoolean + ",from:" + paramInt + ",weburl:" + paramString2);
    ...
    try
    {
      ...
      {
        yod.c(paramString2, "DELAY_LIST");
        yod.a(paramString2, paramString1, "DELAY_APPID_DETAIL_");
        ynz.a();
        return 0;
      }
      if (!localWadlParams.jdField_b_of_type_Boolean)
      {
        yod.b(paramString2, "DELAY_LIST");
        yod.d(paramString2, "DELAY_APPID_DETAIL_");
      }
      if (localWadlParams.jdField_b_of_type_Boolean)
      {
        if (a(localWadlParams.g))
        {
          bdoe.b("WadlJsBridgeCall", "##@Operation for wadlParams.resName:" + localWadlParams.g + " is not returned! The opertion of action: " + paramInt + " is ignored!");
          return 1;
        }
        a(localWadlParams.g);
      }
      ...
      {
        yod.a(null, "558", "202982", paramString2, "55801", "4", "430");
        bdoe.b("WadlJsBridgeCall", "invalid url:" + localWadlParams);
        return -1;
        if (a(paramString2))
        {
          bdoe.b("WadlJsBridgeCall", "##@Operation for appid:" + paramString2 + " is not returned! The opertion of action: " + paramInt + " is ignored!");
          return 1;
        }
        a(paramString2);
      }
    ...
    {
      bdoe.a("WadlJsBridgeCall", "doDownloadAction:", paramString1);
      return -1;
    }
    return 0;
  }
  ...
  public void a()
  {
    ...
    {
      bdoe.a("WadlJsBridgeCall", "getQueryAllTask()>>>", localException);
    }
  }
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      biby.a().c(paramInt, paramString1);
      return;
    }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    {
      bdoe.a("WadlJsBridgeCall", "getQueryDownloadAction(String,String)>>>", paramString1);
    }
  }
  
  public void a(String paramString, boolean paramBoolean, int paramInt)
  {
    bdoe.b("WadlJsBridgeCall", "startDownload delay task" + paramString + " ," + paramBoolean + "," + paramInt + ",isWiFi=" + AppNetConnInfo.isWifiConn());
    if (1 == paramInt) {
  ...
  public void d(String paramString)
  {
    ...
    {
      bdoe.a("WadlJsBridgeCall", "query getQueryDownloadAction>>>", paramString);
    }
  }
  ...
  public void e(String paramString)
  {
    ...
    {
      bdoe.a("WadlJsBridgeCall", "query getQueryDownloadActionByVia>>>", paramString);
    }
  }
}
