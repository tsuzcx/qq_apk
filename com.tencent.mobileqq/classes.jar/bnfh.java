...
public class bnfh
{
  ...
  public bnfh(QQAppInterface paramQQAppInterface, Context paramContext, Handler paramHandler)
  {
    ...
    bnfk.a(paramContext, this.jdField_a_of_type_JavaUtilMap);
  }
  ...
  private void a(UPDATE_INFO paramUPDATE_INFO, PluginRecord paramPluginRecord)
  {
    ...
    paramPluginRecord.mInstalledPath = bnfk.a(BaseApplicationImpl.getContext(), paramPluginRecord.id).getAbsolutePath();
  }
  
  private void a(PluginRecord paramPluginRecord)
  {
    File localFile = bnfk.c(BaseApplicationImpl.getContext(), paramPluginRecord.id);
    if ((localFile != null) && (localFile.exists())) {
      localFile.delete();
    }
    bnfk.a(paramPluginRecord);
    LpReportInfo_dc01500.reportConfig(paramPluginRecord.id, paramPluginRecord.old_ver, paramPluginRecord.ver, 0);
  }
  
  private void a(String paramString)
  {
    paramString = bnfk.c(BaseApplicationImpl.getContext(), paramString);
  ...
  {
    PluginIntent localPluginIntent = new PluginIntent(BaseApplicationImpl.getContext(), bndk.class);
    localPluginIntent.a = a();
    localPluginIntent.b = bnbw.a().a();
    localPluginIntent.a(new bnfi(this));
  ...
  public void a(bnfj parambnfj)
  {
    this.jdField_a_of_type_Bnfj = parambnfj;
  }
