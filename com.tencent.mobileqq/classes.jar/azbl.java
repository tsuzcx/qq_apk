  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      localObject = ayzd.a(paramFromServiceMsg.getWupBuffer());
      if ((localObject != null) && (((List)localObject).size() > 0))
      {
        paramFromServiceMsg = (azbi)paramIntent.getManager(12);
        if (paramFromServiceMsg != null)
        {
          ...
          notifyObserver(null, 10000, true, paramFromServiceMsg, avva.class);
          QLog.e("Q.lebatab.GameCenterServlet", 2, "[red dot] 1");
          if (paramIntent != null)
          {
            paramFromServiceMsg = new HashMap();
            azri.a(paramIntent.getApp()).a(paramIntent.getCurrentAccountUin(), "actPluginUnread", true, this.b - this.a, 0L, paramFromServiceMsg, "");
          }
        }
      }
      else if (paramIntent != null)
      {
        paramFromServiceMsg = "|wufbuf: " + bdhe.a(paramFromServiceMsg.getWupBuffer());
        ...
        azri.a(paramIntent.getApp()).a(paramIntent.getCurrentAccountUin(), "actPluginUnread", false, this.b - this.a, 0L, (HashMap)localObject, "");
      }
    }
    for (;;)
    {
      ...
      notifyObserver(null, 10000, false, paramIntent, avva.class);
      return;
      if (paramIntent != null)
      {
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    if ((str != null) && (str.equals("gc_get_newandunreadmsg"))) {
      ayzd.a(paramPacket, paramIntent);
    }
  ...
  public void service(Intent paramIntent)
  {
    ...
    if ((str != null) && ("gc_refresh_ui".equals(str)))
    {
      ...
      notifyObserver(null, 10000, true, paramIntent, avva.class);
