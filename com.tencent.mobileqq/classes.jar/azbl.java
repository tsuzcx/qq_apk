  ...
  implements Handler.Callback
{
  ...
  public azbl(GestureFrameLayout paramGestureFrameLayout, List<azbk> paramList, View.OnClickListener paramOnClickListener, azbm paramazbm)
  {
    ...
    this.jdField_a_of_type_Azbm = paramazbm;
    paramGestureFrameLayout.a().a().a().invert(this.jdField_a_of_type_AndroidGraphicsMatrix);
    this.jdField_a_of_type_Azbi = new azbi();
    this.jdField_a_of_type_Azbi.a(2131365191, this.jdField_a_of_type_AndroidContentContext.getString(2131691137), 2130838930);
    this.jdField_a_of_type_Azbi.a(2131367078, this.jdField_a_of_type_AndroidContentContext.getString(2131692400), 2130838939);
    this.jdField_a_of_type_Azbi.a(2131379272, this.jdField_a_of_type_AndroidContentContext.getString(2131698244), 2130838939);
    this.jdField_a_of_type_Azbi.a(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
    if (azcb.a()) {}
    for (paramGestureFrameLayout = new azcb();; paramGestureFrameLayout = null)
    {
      this.jdField_a_of_type_Azcb = paramGestureFrameLayout;
      return;
    }
  }
  ...
  private void a(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2)
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      {
        azbk localazbk = (azbk)paramMotionEvent1.next();
        k = this.jdField_a_of_type_JavaUtilList.indexOf(localazbk);
        if (a(new Point(i, j), localazbk)) {
          a(localazbk, k);
        }
      }
    }
    ...
    if (this.jdField_a_of_type_AndroidGraphicsPoint != null)
    {
      ...
      while (paramMotionEvent1.hasNext())
      {
        paramMotionEvent2 = (azbk)paramMotionEvent1.next();
  ...
  private boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, azbk paramazbk)
  {
    Point localPoint1 = (Point)paramazbk.jdField_a_of_type_JavaUtilList.get(0);
    Point localPoint2 = (Point)paramazbk.jdField_a_of_type_JavaUtilList.get(1);
    if (a(paramInt1, paramInt2, paramInt3, paramInt4, localPoint1.x, localPoint1.y, localPoint2.x, localPoint2.y)) {
      return true;
    }
    Point localPoint3 = (Point)paramazbk.jdField_a_of_type_JavaUtilList.get(2);
    paramazbk = (Point)paramazbk.jdField_a_of_type_JavaUtilList.get(3);
    if (a(paramInt1, paramInt2, paramInt3, paramInt4, localPoint3.x, localPoint3.y, paramazbk.x, paramazbk.y)) {
      return true;
    }
    return (a(paramInt1, paramInt2, paramInt3, paramInt4, localPoint2.x, localPoint2.y, localPoint3.x, localPoint3.y)) || (a(paramInt1, paramInt2, paramInt3, paramInt4, paramazbk.x, paramazbk.y, localPoint1.x, localPoint1.y));
  }
  
  private static boolean a(Point paramPoint, azbk paramazbk)
  {
    if ((paramPoint.y > paramazbk.e) || (paramPoint.y < paramazbk.g) || (paramPoint.x > paramazbk.d) || (paramPoint.x < paramazbk.f)) {}
    int i;
    do
    {
      Point localPoint1;
      ...
      {
        return false;
        if (paramazbk.jdField_a_of_type_Int % 90 < 1) {
          return true;
        }
        Point localPoint2 = (Point)paramazbk.jdField_a_of_type_JavaUtilList.get(0);
        localPoint1 = (Point)paramazbk.jdField_a_of_type_JavaUtilList.get(1);
        paramazbk = (Point)paramazbk.jdField_a_of_type_JavaUtilList.get(2);
        localPoint3 = a(localPoint2, localPoint1);
        i = a(localPoint3, a(localPoint2, paramPoint));
      } while ((i < 0) || (i > a(localPoint3, localPoint3)));
      paramazbk = a(localPoint1, paramazbk);
      i = a(paramazbk, a(localPoint1, paramPoint));
    } while (i < 0);
    if (i <= a(paramazbk, paramazbk)) {}
  ...
  private boolean a(MotionEvent paramMotionEvent, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      azbk localazbk = (azbk)paramMotionEvent.next();
      if (!a(new Point(j, k), localazbk)) {
        break label218;
      }
      if (!paramBoolean2)
      {
        if ((paramBoolean1) || (!localazbk.jdField_b_of_type_Boolean))
        {
          bool = true;
          localazbk.jdField_b_of_type_Boolean = bool;
  ...
  public void a(MotionEvent paramMotionEvent)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      {
        i = 1;
        bdll.b(null, "dc00898", "", "", "0X800AAEE", "0X800AAEE", i, 0, String.valueOf(this.jdField_a_of_type_Int), "0", "0", "");
      }
    }
    for (;;)
    {
  ...
  public void a(azbk paramazbk)
  {
    if (!this.jdField_a_of_type_Azbi.a())
    {
      Object localObject = (Point)paramazbk.jdField_a_of_type_JavaUtilList.get(0);
      paramazbk = (Point)paramazbk.jdField_a_of_type_JavaUtilList.get(1);
      ...
      localObject[0] = paramazbk.x;
      localObject[1] = paramazbk.y;
      ...
      this.jdField_a_of_type_Azbi.a(this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureGestureFrameLayout, i, j);
    }
  }
  
  public void a(azbk paramazbk, int paramInt)
  {
    boolean bool = true;
    if (this.jdField_c_of_type_Int == -1)
    {
    ...
    for (;;)
    {
      if (bool != paramazbk.jdField_b_of_type_Boolean)
      {
        this.jdField_a_of_type_Int += 1;
        paramazbk.jdField_b_of_type_Boolean = bool;
        this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureGestureFrameLayout.a(this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureGestureFrameLayout);
  ...
  {
    this.jdField_a_of_type_Azcb.a(1);
    this.jdField_a_of_type_Azbm.b();
    return super.a(paramScaleGestureDetector);
  }
  
  public void b(MotionEvent paramMotionEvent)
  {
    this.jdField_a_of_type_Azbi.a();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    bdmc.a(BaseApplication.getContext()).a(null, "actOcrGestureType", true, 0L, 0L, paramMessage, null);
