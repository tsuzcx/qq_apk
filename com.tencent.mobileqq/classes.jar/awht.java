  ...
  extends MSFServlet
{
  ...
  private void a(Intent paramIntent, int paramInt, byte[] paramArrayOfByte1, byte[] arg4)
  {
    ...
    for (;;)
    {
      ...
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (awkj.b()) {
          awkj.a("NearbyAlumniServlet", new Object[] { "respGetNearbyAlumni", Integer.valueOf(i), paramArrayOfByte1 });
        }
        if ((paramArrayOfByte1 instanceof aaaq)) {
          paramArrayOfByte1 = (aaaq)paramArrayOfByte1;
        }
      }
      try
      {
      ...
      if ((localObject2 != null) && (((List)localObject2).size() != 0))
      {
        ...
        if ((localObject3 != null) && (((List)localObject3).size() != 0))
        {
          ...
          if (localObject3 != null) {
            ((awkn)localObject3).a(paramFromServiceMsg, (byte[])localObject1, (String[])localObject2);
          }
  ...
  public static void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString1, Object paramObject, String paramString2)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      paramObject = new NewIntent(paramAppInterface.getApplication(), awht.class);
  ...
  protected awkn a()
  {
    ...
    if ((localAppRuntime instanceof NearbyAppInterface)) {
      return (awkn)localAppRuntime.getManager(217);
    }
  ...
  protected void a(Intent paramIntent, Packet paramPacket, boolean paramBoolean)
  {
    ...
    if (awkj.b()) {
      awkj.a("NearbyAlumniServlet", new Object[] { "reqBigData", Integer.valueOf(i), Long.valueOf(l) });
    }
      ...
      do
      {
        ...
        while (localObject1 == null) {
          if (paramBoolean)
          {
            a(null, -1, null, null);
            return;
            localObject1 = ((awkn)localObject3).a();
          }
          else
          {
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            if (localObject3 == null)
            {
              ...
              a(null, -1, null, null);
              return;
              localObject2 = ((awkn)localObject3).b();
              continue;
              if (paramBoolean)
              {
                a(null, -1, null, null);
        ...
        paramPacket.mCallback = new awhu(this, paramIntent, (byte[])localObject1);
    ...
    awkj.a("NearbyAlumniServlet", new Object[] { "getBigData", localObject1, paramIntent });
  }
