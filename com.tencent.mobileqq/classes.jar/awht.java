  ...
  extends Handler
{
  ...
  public awht(QQMusicPlayService paramQQMusicPlayService, Looper paramLooper)
  {
    super(paramLooper);
                    ...
                    do
                    {
                          ...
                          do
                          {
                            do
                            {
                              ...
                              do
                              {
                                ...
                                localawhw = (awhw)paramMessage.obj;
                              } while (localawhw == null);
                              ...
                              for (paramMessage = "null";; paramMessage = QQMusicPlayService.b().a())
                              {
                                ...
                                {
                                  localawhw.a.release();
                                  if (QQMusicPlayService.a() == localawhw.a) {
                      ...
                      if ((paramMessage.equals(QQMusicPlayService.b())) && ((QQMusicPlayService.f() == 2) || (QQMusicPlayService.f() == 1)))
                      {
                        ...
                        for (i = -1;; i = Math.abs(m - paramMessage.a()))
                        {
                          ...
                          awhr.a(i, NetworkUtil.getNetworkType((Context)localObject));
                          return;
                        }
                      }
                      if (QQMusicPlayService.a().isPlaying())
                      {
                        ...
                        awhr.b(QQMusicPlayService.b(), QQMusicPlayService.e());
                      }
