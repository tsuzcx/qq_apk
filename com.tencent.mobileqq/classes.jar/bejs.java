  ...
  extends bejg
{
  ...
  private String a(oidb_0xe9b.RspBody paramRspBody)
  {
    ...
    localStringBuilder2.append(bool5).append(",");
    localStringBuilder2 = localStringBuilder1.append("hasAskAnonymously=");
    boolean bool6 = f(localJSONObject, paramRspBody);
    localStringBuilder2.append(bool6);
  ...
  {
    if (!new birs(this.a, null).a(13)) {}
    while ((!paramRspBody.rpt_msg_quests.has()) || (paramRspBody.rpt_msg_quests.size() <= 0)) {
      return false;
    }
    try
    {
