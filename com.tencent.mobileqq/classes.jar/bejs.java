  ...
  implements anvi
{
  ...
  WeakReference<bejs> jdField_a_of_type_MqqUtilWeakReference = new WeakReference(this);
  volatile boolean jdField_a_of_type_Boolean;
  
  public bejs(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Anve = ((anve)paramQQAppInterface.getManager(59));
    this.jdField_a_of_type_Anve.a(this.jdField_a_of_type_MqqUtilWeakReference);
    this.jdField_a_of_type_Anve.c(this);
  }
  ...
  private boolean a(JSONObject paramJSONObject, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    arrayOfString[0] = anve.a(paramInt1);
    arrayOfString[1] = anve.a(paramInt2);
    arrayOfString[2] = anve.a(paramInt3);
    arrayOfString[3] = anve.a(paramInt4);
    ...
    try
    {
      ...
      String str = this.jdField_a_of_type_Anve.a(arrayOfString);
      ??? = str;
      if (str.equals("不限")) {
        ??? = "";
      }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Anve.b(this.jdField_a_of_type_MqqUtilWeakReference);
  }
