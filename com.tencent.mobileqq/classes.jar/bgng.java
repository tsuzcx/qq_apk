...
public class bgng
{
  public static bgmp a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    catch (Exception paramString)
    {
      ...
      paramQQAppInterface = new bgmp(paramQQAppInterface, paramContext);
    ...
    localObject3 = paramString;
    Object localObject1 = aojx.a(paramQQAppInterface, paramContext, paramString);
      ...
      if (AudioHelper.e())
      {
        ...
        if (AudioHelper.a(8) == 1)
        {
          ...
          if (((String)localObject1).startsWith("mqqconferenceflyticket://"))
          {
            ...
            {
              localObject3 = localObject1;
              return lxv.a(paramQQAppInterface, paramContext, paramString);
            }
            localObject3 = localObject1;
            if (paramString.startsWith("mqqapi://qzone/groupalbum"))
            {
              ...
              localObject3 = localObject1;
              localObject4 = new bgmp(paramQQAppInterface, paramContext);
              localObject3 = localObject1;
              ...
              localObject3 = localObject1;
              ((bgmp)localObject4).a = paramString;
              localObject3 = localObject1;
              ((bgmp)localObject4).b = localObject2[0];
              localObject3 = localObject1;
              ((bgmp)localObject4).c = localObject2[1];
              localObject3 = localObject1;
    ...
    for (;;)
    {
      ...
      if (i < paramString.length)
      {
        ...
        try
        {
          ...
          localObject3 = localObject1;
          ((bgmp)localObject4).a(localObject2[0], localObject2[1]);
        }
  ...
  private static bgmp a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2)
  {
  ...
  private static bgmp a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String[] paramArrayOfString, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    String str = "";
    bgmp localbgmp = new bgmp(paramQQAppInterface, paramContext);
    if (paramString2.startsWith("mqqapi://now/openroom"))
    {
      localbgmp.a = paramString2;
      ...
      localbgmp.a("attr_original_url", paramString1);
    }
    label144:
    int i;
    for (;;)
    ...
    label399:
    localbgmp.a = paramContext;
    localbgmp.b = paramQQAppInterface[0];
    ...
    if (paramBoolean1)
    {
      ...
      if (i < paramQQAppInterface.length)
      {
        ...
        for (paramBoolean1 = true;; paramBoolean1 = false)
        {
          ...
          if (j > 0) {
            localbgmp.a(paramContext.substring(0, j), paramContext.substring(j + 1, paramContext.length()));
          }
          i += 1;
          break;
        }
    ...
    else
    {
      ...
      if (i < paramQQAppInterface.length)
      {
        ...
        if (paramContext.length == 2)
        {
          ...
          localbgmp.a(paramContext[0], a(paramContext[1], false));
        }
        for (;;)
        {
          i += 1;
          break;
          label587:
          localbgmp.a(paramContext[0], paramContext[1]);
        }
      }
    }
    return localbgmp;
