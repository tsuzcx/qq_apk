...
public class bllp
{
  ...
  private bllo jdField_a_of_type_Bllo = new bllo();
  ...
  private void d(float paramFloat1, float paramFloat2)
  {
    ...
    this.jdField_a_of_type_Bllo.a(paramFloat1, paramFloat2);
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_Bllo.a(this.jdField_b_of_type_AndroidGraphicsRectF, a());
  }
  ...
  {
    RectF localRectF = this.jdField_a_of_type_Bllo.a(paramFloat1, paramFloat2);
  ...
  {
    this.jdField_a_of_type_Bllo.d(false);
    if (this.jdField_a_of_type_DovComQqImAeeditorViewClipConstant$Anchor != null)
    {
      this.jdField_a_of_type_Bllo.a(this.jdField_a_of_type_DovComQqImAeeditorViewClipConstant$Anchor, paramFloat3, paramFloat4);
      ...
      RectF localRectF2 = this.jdField_a_of_type_Bllo.a(paramFloat1, paramFloat2);
  ...
  public void a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    if (paramBoolean) {
      this.jdField_a_of_type_DovComQqImAeeditorViewClipConstant$Anchor = this.jdField_a_of_type_Bllo.a(paramFloat1, paramFloat2);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Bllo.c()) {}
  ...
  {
    this.jdField_a_of_type_Bllo.a(paramCanvas);
  }
  
  public void a(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    RectF localRectF = this.jdField_a_of_type_Bllo.a(paramInt1, paramInt2);
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Bllo.a();
  }
  ...
  public boolean a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Bllo.a(false);
      this.jdField_a_of_type_Bllo.b(true);
      this.jdField_a_of_type_Bllo.c(false);
      return paramBoolean;
    }
  }
  ...
  {
    bmoq localbmoq = new bmoq(paramFloat1, paramFloat2, c(), a());
    RectF localRectF1 = new RectF(this.jdField_a_of_type_Bllo.a());
    localRectF1.offset(paramFloat1, paramFloat2);
    if (this.jdField_a_of_type_Bllo.d())
    {
    ...
    if (this.jdField_a_of_type_Bllo.b())
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsMatrix.mapRect(localRectF2, this.jdField_a_of_type_Bllo.a(paramFloat1, paramFloat2));
  ...
  public void c(float paramFloat1, float paramFloat2)
  {
    ...
    a();
    this.jdField_a_of_type_Bllo.d(true);
  }
  ...
  {
    this.jdField_a_of_type_Bllo.a(paramFloat);
  }
}
