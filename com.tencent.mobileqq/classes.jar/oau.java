...
public class oau
{
  private static oau jdField_a_of_type_Oau;
  private final int jdField_a_of_type_Int = 8;
  private final long jdField_a_of_type_Long = 86400000L;
  private final String jdField_a_of_type_JavaLangString = oau.class.getSimpleName();
  private ArrayList<oay> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private HashMap<String, oax> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private ArrayList<oax> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private ArrayList<oay> a(QQAppInterface paramQQAppInterface)
  {
    paramQQAppInterface = new ArrayList();
    Iterator localIterator = this.jdField_b_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      oax localoax = (oax)localIterator.next();
      paramQQAppInterface.add(new oay(this, localoax.jdField_a_of_type_JavaLangString, localoax.jdField_b_of_type_JavaLangString, localoax.jdField_a_of_type_Boolean));
    }
  ...
  public static oau a()
  {
    if (jdField_a_of_type_Oau == null) {}
    try
    {
      jdField_a_of_type_Oau = new oau();
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_Oau.jdField_a_of_type_JavaLangString, 2, "newInstance!");
      }
      return jdField_a_of_type_Oau;
    }
    finally {}
  }
  
  private void a(QQAppInterface paramQQAppInterface, oaw paramoaw)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      paramoaw.a(new ArrayList(), null, true);
      return;
    }
  ...
  private void b(QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      if (!TextUtils.isEmpty(paramQQAppInterface)) {
        try
        {
          paramQQAppInterface = tzo.a(paramQQAppInterface);
          if (paramQQAppInterface != null)
          {
            ...
            while (i < paramQQAppInterface.length())
            {
              ...
              localObject = new oay(this, ((JSONObject)localObject).optString("uin"), ((JSONObject)localObject).optString("name"), ((JSONObject)localObject).optBoolean("isPA", true));
  ...
  private void b(QQAppInterface paramQQAppInterface, oaw paramoaw)
  {
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_a_of_type_JavaLangString, 2, "sendGetPublicAccountSearchRecommendRequest->begin!");
    }
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication().getApplicationContext(), oaz.class);
    ...
    localGetRecommendPubAccountRequest.version.set(tzo.a());
    ...
    localNewIntent.setObserver(new oav(this, localNewIntent, paramQQAppInterface, paramoaw));
      ...
      if (!TextUtils.isEmpty(paramQQAppInterface)) {
        try
        {
          ...
          if (paramQQAppInterface != null)
          {
            ...
            {
              Object localObject = (JSONObject)paramQQAppInterface.get(i);
              localObject = new oax(this, ((JSONObject)localObject).optString("uin"), ((JSONObject)localObject).optString("name"), ((JSONObject)localObject).optLong("time"), ((JSONObject)localObject).optBoolean("isPA", true));
              this.jdField_b_of_type_JavaUtilArrayList.add(localObject);
              this.jdField_a_of_type_JavaUtilHashMap.put(((oax)localObject).jdField_a_of_type_JavaLangString, localObject);
              i += 1;
            }
          }
          return;
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    {
      paramString1 = (oax)this.jdField_a_of_type_JavaUtilHashMap.get(paramString1);
    ...
    for (;;)
    {
      ...
      {
        paramString1 = (oax)paramQQAppInterface.next();
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, paramString1.toString());
      }
      break;
      paramString2 = new oax(this, paramString1, paramString2, l, paramBoolean);
      ...
      if (i > 8)
      {
        paramString1 = (oax)this.jdField_b_of_type_JavaUtilArrayList.get(i - 1);
        this.jdField_b_of_type_JavaUtilArrayList.remove(paramString1);
  ...
  public void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, oaw paramoaw)
  {
    if (QLog.isColorLevel()) {
