...
public class pcu
{
  ...
  public pcu()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = pha.a();
  }
  ...
  {
    if ((paramBaseCommentData == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (this.jdField_a_of_type_Ozw == null)) {
      return;
    }
    label394:
    for (;;)
    {
      ...
      try
      {
        ...
        ((JSONObject)localObject).put("native_version", bgln.a(BaseApplicationImpl.getContext()));
        ...
        ((NewIntent)localObject).setObserver(new pcw(this, paramBaseCommentData, paramInt1, paramInt2));
      ...
      catch (Exception paramString)
      {
        if (this.jdField_a_of_type_Ozw != null) {
          this.jdField_a_of_type_Ozw.a(false, paramBaseCommentData.commentId, paramInt1, paramInt2);
        }
  ...
  public void a(BaseCommentData paramBaseCommentData, String paramString, int paramInt)
  {
    ...
    catch (Exception paramString)
    {
      for (;;)
      {
        Object localObject;
        if (this.jdField_a_of_type_Ozw != null) {
          this.jdField_a_of_type_Ozw.a(false, paramBaseCommentData, "");
        }
        paramString.printStackTrace();
        if (!QLog.isColorLevel()) {
          break;
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      ...
      ((NewIntent)localObject).putExtra("data", paramString.toByteArray());
      ((NewIntent)localObject).setObserver(new pcv(this, paramBaseCommentData));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet((NewIntent)localObject);
      return;
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramBaseCommentData instanceof CommentData))
        {
          ...
          localJSONObject.put("report_uin", pha.a());
          ...
          paramString2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), oaz.class);
          ...
          paramString2.setObserver(new pcx(this, paramBaseCommentData));
