  ...
  implements alwp
{
  ...
  private void a(alrr paramalrr, int paramInt, long paramLong)
  {
    ApolloCmdChannel localApolloCmdChannel = alvx.a();
    if (localApolloCmdChannel != null) {
      localApolloCmdChannel.playMusicInner(paramalrr, paramInt, paramLong);
    }
  }
  ...
  {
    if ((this.b > 0) && ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_ComTencentCommonAppAppInterface == null) || (!alvx.d()) || (paramalrr == null)))
    {
    ...
    for (Object localObject = null;; localObject = null)
    {
      try
      {
        if ((paramalrr instanceof ApolloSurfaceView)) {
          localObject = ((ApolloSurfaceView)paramalrr).getRender();
        }
        for (;;)
        {
          if (localObject == null) {
          ...
          return -1;
          if ((paramalrr instanceof ApolloTextureView)) {
            localObject = ((ApolloTextureView)paramalrr).getRender();
          }
        }
      ...
      catch (Throwable paramalrr)
      {
        QLog.e("cmgame_process.CmGameSoudPoolPlayer", 1, paramalrr, new Object[0]);
        return -1;
      }
      if (this.jdField_a_of_type_JavaUtilMap != null)
      {
        this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new alwo(this, paramFloat, paramInt2, paramString, paramalrr, paramLong));
        ...
        if (paramString != null) {
          if (-1.0F == paramFloat)
          {
            ...
            if (paramInt1 != 0) {
              a(paramalrr, paramInt1, paramLong);
            }
          }
        }
        for (;;)
      ...
      paramalrr = new StringBuilder().append("pool or cache is null ");
      if (this.jdField_a_of_type_AndroidMediaSoundPool == null) {}
  ...
  {
    if ((this.b > 0) && ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_ComTencentCommonAppAppInterface == null) || (!alvx.d())))
    {
      QLog.w("cmgame_process.CmGameSoudPoolPlayer", 1, "[playMusic], DO NOT play. switch:" + this.jdField_a_of_type_Int);
    ...
    if (paramJSONObject != null) {
      ...
      {
        QLog.e("cmgame_process.CmGameSoudPoolPlayer", 1, paramalxf, new Object[0]);
      }
    } else {
      return null;
    }
    ...
    {
      this.jdField_a_of_type_AndroidMediaSoundPool.setOnLoadCompleteListener(new alwn(this, f, i, str2, paramalxf, localJSONObject));
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        if ((i == 0) || (paramalxf == null)) {
          break;
        }
        try
        {
          localJSONObject.put("id", i);
          paramalxf.a(localJSONObject);
        }
        catch (Throwable paramalxf)
        {
          QLog.e("cmgame_process.CmGameSoudPoolPlayer", 1, paramalxf, new Object[0]);
      ...
      break;
      paramalxf = new StringBuilder().append("pool or cache is null ");
      if (this.jdField_a_of_type_AndroidMediaSoundPool == null) {}
      for (boolean bool = true;; bool = false)
      {
        QLog.e("cmgame_process.CmGameSoudPoolPlayer", 1, bool);
