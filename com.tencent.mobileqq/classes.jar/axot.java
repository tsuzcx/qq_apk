  ...
  implements Handler.Callback
{
  ...
  public axot(GestureFrameLayout paramGestureFrameLayout, List<axos> paramList, View.OnClickListener paramOnClickListener, axou paramaxou)
  {
    ...
    this.jdField_a_of_type_Axoq = new axoq();
    this.jdField_a_of_type_Axoq.a(2131365216, this.jdField_a_of_type_AndroidContentContext.getString(2131691176), 2130838962);
    this.jdField_a_of_type_Axoq.a(2131367094, this.jdField_a_of_type_AndroidContentContext.getString(2131692448), 2130838971);
    this.jdField_a_of_type_Axoq.a(2131379042, this.jdField_a_of_type_AndroidContentContext.getString(2131698409), 2130838971);
    this.jdField_a_of_type_Axoq.a(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
    if (axpj.a()) {}
    for (paramGestureFrameLayout = new axpj();; paramGestureFrameLayout = null)
    {
      this.jdField_a_of_type_Axpj = paramGestureFrameLayout;
      return;
    }
  }
  ...
  private void a(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2)
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      {
        axos localaxos = (axos)paramMotionEvent1.next();
        k = this.jdField_a_of_type_JavaUtilList.indexOf(localaxos);
        if (a(new Point(i, j), localaxos)) {
          a(localaxos, k);
        }
      }
    }
    ...
    if (this.jdField_a_of_type_AndroidGraphicsPoint != null)
    {
      ...
      while (paramMotionEvent1.hasNext())
      {
        paramMotionEvent2 = (axos)paramMotionEvent1.next();
  ...
  private boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, axos paramaxos)
  {
    Point localPoint1 = (Point)paramaxos.jdField_a_of_type_JavaUtilList.get(0);
    Point localPoint2 = (Point)paramaxos.jdField_a_of_type_JavaUtilList.get(1);
    if (a(paramInt1, paramInt2, paramInt3, paramInt4, localPoint1.x, localPoint1.y, localPoint2.x, localPoint2.y)) {
      return true;
    }
    Point localPoint3 = (Point)paramaxos.jdField_a_of_type_JavaUtilList.get(2);
    paramaxos = (Point)paramaxos.jdField_a_of_type_JavaUtilList.get(3);
    if (a(paramInt1, paramInt2, paramInt3, paramInt4, localPoint3.x, localPoint3.y, paramaxos.x, paramaxos.y)) {
      return true;
    }
    return (a(paramInt1, paramInt2, paramInt3, paramInt4, localPoint2.x, localPoint2.y, localPoint3.x, localPoint3.y)) || (a(paramInt1, paramInt2, paramInt3, paramInt4, paramaxos.x, paramaxos.y, localPoint1.x, localPoint1.y));
  }
  
  private static boolean a(Point paramPoint, axos paramaxos)
  {
    if ((paramPoint.y > paramaxos.e) || (paramPoint.y < paramaxos.g) || (paramPoint.x > paramaxos.d) || (paramPoint.x < paramaxos.f)) {}
    int i;
    do
    {
      Point localPoint1;
      ...
      {
        return false;
        if (paramaxos.jdField_a_of_type_Int % 90 < 1) {
          return true;
        }
        Point localPoint2 = (Point)paramaxos.jdField_a_of_type_JavaUtilList.get(0);
        localPoint1 = (Point)paramaxos.jdField_a_of_type_JavaUtilList.get(1);
        paramaxos = (Point)paramaxos.jdField_a_of_type_JavaUtilList.get(2);
        localPoint3 = a(localPoint2, localPoint1);
        i = a(localPoint3, a(localPoint2, paramPoint));
      } while ((i < 0) || (i > a(localPoint3, localPoint3)));
      paramaxos = a(localPoint1, paramaxos);
      i = a(paramaxos, a(localPoint1, paramPoint));
    } while (i < 0);
    if (i <= a(paramaxos, paramaxos)) {}
  ...
  private boolean a(MotionEvent paramMotionEvent, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      axos localaxos = (axos)paramMotionEvent.next();
      if (!a(new Point(j, k), localaxos)) {
        break label218;
      }
      if (!paramBoolean2)
      {
        if ((paramBoolean1) || (!localaxos.jdField_b_of_type_Boolean))
        {
          bool = true;
          localaxos.jdField_b_of_type_Boolean = bool;
  ...
  public void a(MotionEvent paramMotionEvent)
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      ...
      {
        i = 1;
        bcef.b(null, "dc00898", "", "", "0X800AAEE", "0X800AAEE", i, 0, String.valueOf(this.jdField_a_of_type_Int), "0", "0", "");
      }
    }
    for (;;)
    {
  ...
  {
    if (!this.jdField_a_of_type_Axoq.a())
    {
      Object localObject = (Point)paramaxos.jdField_a_of_type_JavaUtilList.get(0);
      paramaxos = (Point)paramaxos.jdField_a_of_type_JavaUtilList.get(1);
      ...
      localObject[0] = paramaxos.x;
      localObject[1] = paramaxos.y;
      ...
      this.jdField_a_of_type_Axoq.a(this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureGestureFrameLayout, i, j);
    }
  }
  
  public void a(axos paramaxos, int paramInt)
  {
    boolean bool = true;
    if (this.jdField_c_of_type_Int == -1)
    {
    ...
    for (;;)
    {
      if (bool != paramaxos.jdField_b_of_type_Boolean)
      {
        this.jdField_a_of_type_Int += 1;
        paramaxos.jdField_b_of_type_Boolean = bool;
        this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureGestureFrameLayout.a(this.jdField_a_of_type_ComTencentMobileqqOcrViewGestureGestureFrameLayout);
  ...
  {
    this.jdField_a_of_type_Axpj.a(1);
    this.jdField_a_of_type_Axou.b();
