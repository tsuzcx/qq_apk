  ...
  extends ClickableSpan
{
  ...
  apyo(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      for (int j = -1; i < paramArrayOfHotWordItem.length; j = k)
      {
        ...
        if (j != str.length())
        {
          ...
          localSpannableStringBuilder.setSpan(new apyo(paramQQAppInterface, paramArrayOfHotWordItem[i].hotWord), str.length(), k, 33);
          if (paramQQAppInterface != null) {
            bcst.b(paramQQAppInterface, "P_CliOper", "aio_search", "", "aio_hotword", "view_hotword", 0, 0, "", "", paramArrayOfHotWordItem[i].hotWord, "");
          }
        }
        i += 1;
      }
  ...
  private void a(Context paramContext)
  {
    ...
    localbkho.a(2131696555, 5);
    localbkho.c(2131690582);
    localbkho.a(new apyp(this, paramContext, localbkho));
  ...
  public void onClick(View paramView)
  {
    ...
    bcst.b((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), "P_CliOper", "aio_search", "", "aio_hotword", "click_hotword", 0, 0, "", "", this.jdField_a_of_type_JavaLangString, "");
  }
