...
class awhm
{
      ...
      else
      {
        if (this.jdField_a_of_type_Axro != null)
        {
          ...
          if ((localObject instanceof AppInterface))
          {
            ...
            if (localObject != null)
            {
              QLog.d("QavGesture", 2, String.format("DownloadContrl, cancelReq[%s]", new Object[] { (String)this.jdField_a_of_type_Axro.a() }));
        ...
        this.b = 0;
        if (!awhq.d(this.jdField_a_of_type_ComTencentMobileqqShortvideoGestureDownloadInfo))
        {
          this.jdField_c_of_type_Int |= 0x1;
          this.jdField_a_of_type_Int += 1;
        }
        if (!awhq.c(this.jdField_a_of_type_ComTencentMobileqqShortvideoGestureDownloadInfo))
        {
          this.jdField_c_of_type_Int |= 0x2;
          this.jdField_a_of_type_Int += 1;
        }
        if ((awhq.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoGestureDownloadInfo)) && (!awhq.b(this.jdField_a_of_type_ComTencentMobileqqShortvideoGestureDownloadInfo)))
        {
  ...
  boolean a(DownloadInfo paramDownloadInfo, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      bool2 = false;
      return bool2;
      if ((paramDownloadInfo.enable) && (!awhq.c(paramDownloadInfo)))
      {
      ...
      {
        if ((!awhq.a(paramDownloadInfo)) || (awhq.b(paramDownloadInfo))) {
          break;
        }
    ...
    localaxro.jdField_a_of_type_Axrt = new awhn(this, str1, paramDownloadInfo, i, paramInt);
