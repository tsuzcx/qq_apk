  ...
  extends azqk
{
  ...
  private RelativeLayout a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestWidth = aekt.a(70.0F, localResources);
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestHeight = aekt.a(70.0F, localResources);
      localObject1 = URLDrawable.getDrawable(paramString1, (URLDrawable.URLDrawableOptions)localObject1);
      localAnyScaleTypeImageView.setId(2131367910);
      localAnyScaleTypeImageView.setImageDrawable((Drawable)localObject1);
      paramString1 = new RelativeLayout.LayoutParams(aekt.a(70.0F, localResources), aekt.a(70.0F, localResources));
  ...
  private RelativeLayout a(Context paramContext, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      j = localResources.getDimensionPixelSize(2131296355);
      if (!paramBoolean) {
        break label135;
      }
      k = localResources.getDimensionPixelSize(2131296356);
      if (!a(1)) {
        break label147;
      }
      m = aekt.a(15.0F, localResources);
    ...
    for (;;)
    {
      ...
      break;
      label135:
      k = localResources.getDimensionPixelSize(2131298818);
      break label63;
      label147:
      m = aekt.a(6.0F, localResources);
      break label80;
      label159:
      if (a(1)) {
        i = aekt.a(15.0F, localResources);
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (((Bundle)localObject3).getBoolean("pre_dialog") == true)
    {
      ...
      {
        localObject4 = (azqj)((Iterator)localObject5).next();
        if ((localObject4 instanceof azvm))
        {
          localObject4 = (azvm)localObject4;
          if (!((azvm)localObject4).a()) {
            break label164;
          }
          localObject2 = ((azvm)localObject4).S;
          localObject4 = ((azvm)localObject4).W;
    ...
    for (;;)
    {
      ...
      if ((localObject4 instanceof StructMsgItemTitle))
      {
        ...
        if (((Bundle)localObject3).getInt("accostType") == AbsStructMsg.SOURCE_ACCOUNT_TYPE_PA)
        {
          ...
          paramView.setBackgroundColor(paramContext.getResources().getColor(2131165256));
          n = aekt.a(10.0F, (Resources)localObject5);
          int i1 = aekt.a(4.0F, (Resources)localObject5);
          int i2 = aekt.a(5.0F, (Resources)localObject5);
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            {
              localObject1 = ((azqj)localObject4).a(paramContext, null, (Bundle)localObject3);
              localObject4 = ((View)localObject1).findViewById(2131368083);
              if ((localObject4 != null) && ((localObject4 instanceof AnyScaleTypeImageView))) {
                ((AnyScaleTypeImageView)localObject4).setTag(2131372427, Integer.valueOf(1));
              }
              k = i;
            ...
            else
            {
              if ("video".equals(str))
              {
                if ((localObject4 instanceof azvm))
                {
                  localObject1 = (azvm)localObject4;
                  if (this.jdField_a_of_type_Boolean) {
                    ((azvm)localObject1).c = false;
                  }
                  if (((azvm)localObject1).a()) {
                    if (!this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.hasFlag(4))
                    {
                      ...
                      {
                        localObject1 = (azqj)this.jdField_a_of_type_JavaUtilArrayList.get(k);
                        if (!"title".equals(((azqj)localObject1).jdField_a_of_type_JavaLangString)) {
                          break label859;
                        }
                ...
                for (;;)
                {
                  ...
                  localObject4 = ((azqj)localObject4).a(paramContext, null, (Bundle)localObject3);
                  k = 1;
                ...
                if (localObject1 != null)
                {
                  ...
                  i = ((Resources)localObject5).getDimensionPixelSize(2131296355);
                ...
                for (k = (int)(i / 1.8F);; k = m)
                {
                  ...
                  for (;;)
                  {
                    ...
                    if ((j != 0) && (!TextUtils.isEmpty(paramBundle)) && ((localObject1 instanceof TitledImageView)))
                    {
                      ...
                      ((TitledImageView)localObject3).setTextSize(aekt.a(2, 18, (Resources)localObject5));
                      ((TitledImageView)localObject3).setTextBackground(paramContext.getResources().getColor(2131165256));
                      ((TitledImageView)localObject3).setTextPadding(aekt.a(10.0F, (Resources)localObject5));
                      ((TitledImageView)localObject3).settextBgRadius(aekt.a(12.0F, (Resources)localObject5));
                    }
                    if ((j != 0) && (!TextUtils.isEmpty(paramBundle)))
                    {
                      paramContext = ((View)localObject1).getTag(2131377079);
                      if ((paramContext != null) && ((paramContext instanceof azvt))) {
                        ((azvt)paramContext).a.setText(paramBundle);
                      }
                    }
                    ...
                    ((RelativeLayout)localObject2).setId(2131377076);
                    return localObject2;
                    i = ((Resources)localObject5).getDimensionPixelSize(2131298817);
                    break;
                  }
                  i = k - i * 2;
                  break label960;
