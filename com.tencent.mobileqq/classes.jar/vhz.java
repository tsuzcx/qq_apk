...
public class vhz
{
  ...
  ArrayList<viv> jdField_a_of_type_JavaUtilArrayList;
  ...
  private ETSegment[] a(ArrayList<viv> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = (viv)paramArrayList.next();
        int i4 = ((viv)localObject1).c();
        if (i4 != 0)
        {
          ...
          if (i2 < i4)
          {
            localObject2 = ((viv)localObject1).a(i2);
            localRect2 = ((viv)localObject1).a(i2);
            i3 = 1;
            i = i3;
  ...
  public String a(ArrayList<viv> paramArrayList)
  {
    ...
    while (i < k)
    {
      viv localviv = (viv)paramArrayList.get(i);
      int m = localviv.c();
      int j = 0;
      while (j < m)
      {
        localStringBuilder.append(localviv.a(j).getText());
        j += 1;
      }
      i += 1;
    }
  ...
  public boolean a(ArrayList<viv> paramArrayList, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean1, boolean paramBoolean2, ETFont paramETFont)
  {
    ...
    if (paramBoolean2)
    {
      ...
      {
        localviv1 = (viv)paramArrayList.next();
        localviv2 = new viv();
        paramInt2 = localviv1.c();
        if (paramInt2 != 0)
        {
          paramInt1 = 0;
          if (paramInt1 < paramInt2)
          {
            localTextCell = localviv1.a(paramInt1);
            localRect = localviv1.a(paramInt1);
            localviv2.a(localTextCell, localRect);
          ...
          this.jdField_a_of_type_JavaUtilArrayList.add(localviv2);
        }
      }
    }
    paramArrayList = paramArrayList.iterator();
