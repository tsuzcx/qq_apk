  ...
  implements View.OnClickListener
{
  ...
  private bgoc jdField_a_of_type_Bgoc;
  ...
  public bgnz(Activity paramActivity, bgoc parambgoc, int paramInt1, String paramString, int paramInt2)
  {
    super(paramActivity, 2131755826);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Bgoc = parambgoc;
  ...
  public bgnz(Activity paramActivity, CustomWebView paramCustomWebView, String paramString1, int paramInt1, String paramString2, int paramInt2)
  {
    super(paramActivity, 2131755826);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131363310));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131370737));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131365251));
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)findViewById(2131365110));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131364175));
    ...
    Object localObject2 = new ColorDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167326));
    Object localObject3;
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Bgoc != null) {
      this.jdField_a_of_type_Bgoc.callback(3);
    }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      Object localObject1 = bgoa.a(this.jdField_b_of_type_JavaLangString);
      Object localObject2;
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {
      ...
      for (;;)
      {
        ...
        {
          if (this.jdField_a_of_type_Bgoc != null) {
            this.jdField_a_of_type_Bgoc.callback(4);
          }
          dismiss();
          if (this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView == null) {
            break;
      ...
      if (this.jdField_a_of_type_Bgoc != null) {
        this.jdField_a_of_type_Bgoc.callback(1);
      }
      dismiss();
      if (this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView != null) {}
      try
