  ...
  implements INetInfoHandler
{
  ...
  public axup()
  {
    this.jdField_a_of_type_MqqOsMqqHandler = new axuq(this);
  }
  ...
  public long a()
  {
    if ((this.jdField_a_of_type_Axwf != null) && (this.jdField_a_of_type_Axwf.a != null)) {
      return this.jdField_a_of_type_Axwf.a.getCurPlayingPos();
    }
    return 0L;
  }
  
  public ailz a(AIOVideoData paramAIOVideoData)
  {
    ...
    for (;;)
    {
      ...
      if (bool)
      {
        localObject = axuz.a().a(paramAIOVideoData.jdField_a_of_type_Long);
        if ((localObject != null) && (((axvc)localObject).a()))
        {
          ailz localailz = new ailz();
          localailz.jdField_a_of_type_Boolean = true;
          localailz.jdField_a_of_type_ArrayOfJavaLangString = ((axvc)localObject).jdField_a_of_type_ArrayOfJavaLangString;
          localailz.jdField_a_of_type_JavaLangString = paramAIOVideoData.b;
          localailz.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo = ((axvc)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo;
          localailz.jdField_a_of_type_Int = ((axvc)localObject).jdField_a_of_type_Int;
          localailz.jdField_a_of_type_Long = paramAIOVideoData.jdField_a_of_type_Long;
          localailz.b = paramAIOVideoData.jdField_a_of_type_Int;
          return localailz;
      ...
      else
      {
        ...
        ((ailz)localObject).jdField_a_of_type_Long = paramAIOVideoData.jdField_a_of_type_Long;
        ((ailz)localObject).b = paramAIOVideoData.jdField_a_of_type_Int;
        ((ailz)localObject).jdField_a_of_type_JavaLangString = paramAIOVideoData.b;
        ((ailz)localObject).d = l;
        return localObject;
      }
      bool = false;
    }
  ...
  public void a(int paramInt, long paramLong)
  {
    ...
    if (localObject != null) {
      localMessageForShortVideo = ((ailz)localObject).jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo;
    }
    for (int j = ((ailz)localObject).jdField_a_of_type_Int;; j = -1)
    {
      ...
      do
      {
        ...
        if ((paramInt == 2003) && (!bdje.a((String)localObject))) {
          localMessageForShortVideo.lastModified = new File((String)localObject).lastModified();
        }
      } while (this.jdField_a_of_type_Axuh.a() == null);
      this.jdField_a_of_type_Axuh.a().a(localMessageForShortVideo);
      return;
  ...
  public void a(int paramInt, File paramFile)
  {
    ...
    default: 
      ...
      if (xmx.a(BaseApplication.getContext(), paramFile.getAbsolutePath(), str)) {
        QQToast.a(this.jdField_a_of_type_Axwf.mContext, 2, alpo.a(2131700510), 0).a();
      }
      break;
    }
    for (;;)
    {
      ...
      str = "0X8007A25";
      break;
      QQToast.a(this.jdField_a_of_type_Axwf.mContext, 1, alpo.a(2131700511), 0).a();
    }
  }
  ...
  public void a(long paramLong, int paramInt1, int paramInt2, int paramInt3, String paramString, boolean paramBoolean)
  {
    ...
    if ((localRichMediaBrowserInfo != null) && ((localRichMediaBrowserInfo.baseData instanceof AIOVideoData)) && (((AIOVideoData)localRichMediaBrowserInfo.baseData).jdField_a_of_type_Long == paramLong))
    {
      ...
      QQToast.a(this.jdField_a_of_type_Axwf.mContext, 2, this.jdField_a_of_type_Axwf.mContext.getString(2131719309), 0).a();
    }
    label195:
    label225:
    ...
    {
      return;
      QQToast.a(this.jdField_a_of_type_Axwf.mContext, 1, this.jdField_a_of_type_Axwf.mContext.getString(2131719324), 0).a();
      return;
    }
    if (paramInt3 == 1) {}
    for (;;)
    {
      ...
      this.jdField_a_of_type_Axwf.updateView(getSelectedIndex(), this.jdField_a_of_type_Axwf.galleryView, paramBoolean);
      return;
      paramString = "I:E";
    }
  }
  ...
  {
    this.jdField_a_of_type_Axwf.a(paramLong, paramInt1, paramInt2, paramString1, paramArrayOfString, paramString2, paramMessageForShortVideo, paramInt3);
  }
  ...
  public void b()
  {
    if ((this.jdField_a_of_type_Axuh != null) && (this.jdField_a_of_type_Axuh.a != null) && (this.jdField_a_of_type_Axuh.a() != null))
    {
      ...
      this.jdField_a_of_type_Axuh.a().a((int)aekt.a(bngs.jdField_a_of_type_Int, this.jdField_a_of_type_Axwf.mContext.getResources()) + 46);
    }
    for (;;)
    {
      this.jdField_a_of_type_Axuh.a().d();
  ...
  {
    AppNetConnInfo.registerConnectionChangeReceiver(this.jdField_a_of_type_Axwf.mContext, this);
  }
  ...
  public void setGalleryView(BaseView paramBaseView)
  {
    ...
    if ((paramBaseView instanceof axwf)) {
      this.jdField_a_of_type_Axwf = ((axwf)paramBaseView);
    }
  }
}
