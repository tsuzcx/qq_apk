  ...
  extends bfwn
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new afmq(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  protected SlideDetectListView a;
  public List<MessageRecord> a;
  private List<MessageRecord> b = new ArrayList();
  
  public afmp(Context paramContext, QQAppInterface paramQQAppInterface, afjl paramafjl, int paramInt, SlideDetectListView paramSlideDetectListView)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      ((Button)paramView.findViewById(2131377868)).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
