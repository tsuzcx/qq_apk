  ...
  implements EIPCResultCallback, BusinessObserver
{
  ...
  private WeakReference<afmv> jdField_a_of_type_MqqUtilWeakReference;
  
  public afmp(afmv paramafmv, Bundle paramBundle)
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramafmv);
    this.jdField_a_of_type_AndroidOsBundle = paramBundle;
  }
  
  public void onCallback(EIPCResult paramEIPCResult)
  {
    afmv localafmv = (afmv)this.jdField_a_of_type_MqqUtilWeakReference.get();
    if (localafmv == null)
    {
    ...
    for (paramEIPCResult = paramEIPCResult.data;; paramEIPCResult = afmu.a(-100, "client_unknown_error"))
    {
      localafmv.queryHasSetNotify(paramEIPCResult, this.jdField_a_of_type_AndroidOsBundle);
      return;
    }
  }
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      localafmv.queryHasSetNotify(afmu.a(i, paramBundle, paramInt), this.jdField_a_of_type_AndroidOsBundle);
      return;
      i = -100;
