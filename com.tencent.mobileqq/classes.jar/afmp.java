...
public class afmp
{
  private static afmp jdField_a_of_type_Afmp;
  ...
  private Map<Integer, afmq> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  private int a(int paramInt, boolean paramBoolean)
  {
    ...
    afmq localafmq = (afmq)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    if (localafmq != null)
    {
      Object localObject = localafmq.jdField_a_of_type_JavaLangRefWeakReference;
      if (localObject != null)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            if ((!((DoodleMsgLayout)localObject).b()) && (this.jdField_a_of_type_Long != localafmq.jdField_b_of_type_Long) && (((DoodleMsgLayout)localObject).a()))
            {
              if (paramBoolean)
              {
                a((DoodleMsgLayout)localObject, false);
                if (localafmq.jdField_b_of_type_Long == this.jdField_c_of_type_Long) {
            ...
            if (QLog.isColorLevel()) {
              QLog.d(jdField_a_of_type_JavaLangString, 2, "checkPlayable: can not play:" + localafmq.jdField_a_of_type_Long + "uniID:" + localafmq.jdField_b_of_type_Long + " mPlayedID:" + this.jdField_a_of_type_Long);
            }
          ...
          if (QLog.isColorLevel()) {
            QLog.d(jdField_a_of_type_JavaLangString, 2, "checkPlayable: invisible MsgID:" + localafmq.jdField_a_of_type_Long + "uniID:" + localafmq.jdField_b_of_type_Long);
          }
        }
      }
    }
  ...
  public static afmp a()
  {
    try
    {
      if (jdField_a_of_type_Afmp == null) {
        jdField_a_of_type_Afmp = new afmp();
      }
      return jdField_a_of_type_Afmp;
    }
    finally {}
  }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        afmq localafmq = (afmq)((Map.Entry)localIterator.next()).getValue();
        if ((localafmq == null) || (localafmq.jdField_a_of_type_Int < paramInt1) || (localafmq.jdField_a_of_type_Int > paramInt2)) {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        Object localObject = (afmq)localIterator.next();
        if ((localObject != null) && (((afmq)localObject).jdField_a_of_type_Int >= this.d) && (((afmq)localObject).jdField_a_of_type_Int <= this.e))
        {
          localObject = ((afmq)localObject).jdField_a_of_type_JavaLangRefWeakReference;
          if (localObject != null)
          {
            localObject = (DoodleMsgLayout)((WeakReference)localObject).get();
            if (localObject != null) {
  ...
  private void a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      do
      {
        do
        {
          ...
          afmq localafmq = (afmq)((Iterator)localObject).next();
          if (localafmq.jdField_b_of_type_Long != this.jdField_c_of_type_Long) {
            break;
          }
          localObject = localafmq.jdField_a_of_type_JavaLangRefWeakReference;
    ...
    for (;;)
    {
      ...
      break;
      label135:
      localObject = (afmq)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(i));
      if ((localObject != null) && ((((afmq)localObject).jdField_a_of_type_Long > this.jdField_b_of_type_Long) || (((afmq)localObject).jdField_b_of_type_Long == this.jdField_c_of_type_Long)))
      {
        localObject = ((afmq)localObject).jdField_a_of_type_JavaLangRefWeakReference;
        if (localObject != null)
        {
  ...
  public static void b()
  {
    try
    {
      if (jdField_a_of_type_Afmp != null)
      {
        jdField_a_of_type_Afmp.a();
        jdField_a_of_type_Afmp = null;
      }
      return;
    }
    finally {}
  ...
  public void a(long paramLong1, long paramLong2, int paramInt, DoodleMsgLayout paramDoodleMsgLayout)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(paramInt), new afmq(this, paramLong1, paramLong2, paramInt, paramDoodleMsgLayout));
    boolean bool;
    if (this.jdField_a_of_type_Int != 0)
    {
      bool = true;
  ...
  public void a(DoodleMsgLayout paramDoodleMsgLayout, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          afmq localafmq = (afmq)((Iterator)localObject).next();
          if ((localafmq.jdField_a_of_type_JavaLangRefWeakReference != null) && (localafmq.jdField_a_of_type_JavaLangRefWeakReference.get() == paramDoodleMsgLayout))
          {
            this.jdField_a_of_type_Long = localafmq.jdField_b_of_type_Long;
            if (QLog.isColorLevel()) {
