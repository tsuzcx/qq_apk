  ...
  implements Handler.Callback, TextureView.SurfaceTextureListener, View.OnTouchListener, Thread.UncaughtExceptionHandler
{
  ...
  private final List<vhb> jdField_a_of_type_JavaUtilList = new LinkedList();
  private final Queue<vgz> jdField_a_of_type_JavaUtilQueue = new LinkedBlockingDeque();
  private final vgq jdField_a_of_type_Vgq;
  private vgr jdField_a_of_type_Vgr;
  private final vgs jdField_a_of_type_Vgs;
  private final vgw jdField_a_of_type_Vgw;
  private final vgy jdField_a_of_type_Vgy;
  ...
  public vgx(Context paramContext, TextureView paramTextureView, int paramInt)
  {
    vgp localvgp = vgp.a(paramContext, 1, paramInt);
    ...
    this.jdField_a_of_type_Vhe = new vhe();
    this.jdField_a_of_type_Vjl = new vjl(paramContext);
    this.jdField_a_of_type_Vgy = new vgy();
    this.jdField_a_of_type_Vgs = new vgs(this.jdField_a_of_type_Vhe, localvgp, this.jdField_a_of_type_Vgy);
    this.jdField_a_of_type_Vgq = vgq.a(paramContext, this.jdField_a_of_type_Vjl, localvgp, this.jdField_a_of_type_Vgy, 1);
    this.jdField_a_of_type_Vgw = new vgw(paramContext, this.jdField_a_of_type_Vhe, paramInt);
  ...
  private void f()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 128	vgx:d	Z
    //   4: ifeq +15 -> 19
    //   7: aload_0
    //   8: getfield 92	vgx:jdField_a_of_type_Vgq	Lvgq;
    //   11: invokevirtual 154	vgq:e	()V
    //   14: aload_0
    //   15: iconst_0
    //   16: putfield 128	vgx:d	Z
    //   19: aload_0
    //   20: getfield 85	vgx:jdField_a_of_type_Vgs	Lvgs;
    //   23: invokevirtual 156	vgs:a	()V
    //   26: aload_0
    //   27: getfield 85	vgx:jdField_a_of_type_Vgs	Lvgs;
    //   30: invokevirtual 159	vgs:a	()Ljava/util/List;
    //   33: astore_3
    //   34: aload_0
    //   35: getfield 55	vgx:jdField_a_of_type_AndroidViewTextureView	Landroid/view/TextureView;
    //   38: invokevirtual 163	android/view/TextureView:lockCanvas	()Landroid/graphics/Canvas;
    //   41: astore_2
    //   42: aload_2
    //   43: invokestatic 168	arwd:a	(Landroid/graphics/Canvas;)V
    //   46: aload_2
    //   47: ifnull +114 -> 161
    //   50: aload_0
    //   51: getfield 92	vgx:jdField_a_of_type_Vgq	Lvgq;
    //   54: aload_2
    //   55: invokevirtual 169	vgq:a	(Landroid/graphics/Canvas;)V
    //   58: aload_3
    ...
    //   80: checkcast 187	vhb
    //   83: astore 4
    //   85: aload_3
    //   86: invokeinterface 190 1 0
    //   91: aload 4
    //   93: invokevirtual 192	vhb:c	()Z
    //   96: ifeq +66 -> 162
    //   99: aload 4
    //   101: aload_0
    //   102: invokevirtual 194	vgx:c	()J
    //   105: ldc2_w 195
    //   108: ladd
    //   109: invokevirtual 199	vhb:a	(J)V
    //   112: goto -21 -> 91
    //   115: astore_3
    //   116: ldc 201
    //   118: iconst_1
    ...
    //   144: aload_0
    //   145: getfield 222	vgx:jdField_c_of_type_Boolean	Z
    //   148: istore_1
    //   149: iload_1
    //   150: ifeq +11 -> 161
    //   153: aload_0
    //   154: getfield 55	vgx:jdField_a_of_type_AndroidViewTextureView	Landroid/view/TextureView;
    //   157: aload_2
    //   158: invokevirtual 225	android/view/TextureView:unlockCanvasAndPost	(Landroid/graphics/Canvas;)V
    //   161: return
    //   162: aload 4
    //   164: invokevirtual 228	vhb:a	()I
    //   167: tableswitch	default:+195 -> 362, 1:+17->184
    //   185: iconst_1
    //   186: invokevirtual 230	vhb:a	()Z
    //   189: ifne +15 -> 204
    //   192: aload 4
    //   194: aload_0
    //   195: getfield 92	vgx:jdField_a_of_type_Vgq	Lvgq;
    //   198: invokevirtual 233	vgq:a	()Lcom/tencent/biz/qqcircle/bizparts/danmaku/core/PhotoDanmakuDrawer;
    //   201: invokevirtual 236	vhb:b	(Lcom/tencent/biz/qqcircle/bizparts/danmaku/core/PhotoDanmakuDrawer;)V
    //   204: aload_0
    //   205: getfield 92	vgx:jdField_a_of_type_Vgq	Lvgq;
    //   208: aload 4
    //   210: invokevirtual 239	vgq:a	(Lvhb;)V
    //   213: goto -148 -> 65
    //   216: astore_3
    //   217: aload_0
    //   218: getfield 222	vgx:jdField_c_of_type_Boolean	Z
    //   221: istore_1
    //   222: iload_1
    //   223: ifeq +11 -> 234
    //   226: aload_0
    //   227: getfield 55	vgx:jdField_a_of_type_AndroidViewTextureView	Landroid/view/TextureView;
    //   230: aload_2
    ...
    //   248: return
    //   249: aload_0
    //   250: getfield 92	vgx:jdField_a_of_type_Vgq	Lvgq;
    //   253: invokevirtual 244	vgq:b	()V
    //   256: aload_0
    //   257: getfield 92	vgx:jdField_a_of_type_Vgq	Lvgq;
    //   260: invokevirtual 246	vgq:c	()V
    //   263: aload_0
    //   264: getfield 92	vgx:jdField_a_of_type_Vgq	Lvgq;
    //   267: invokevirtual 248	vgq:d	()V
    //   270: aload_0
    //   271: getfield 48	vgx:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   274: aload_0
    //   275: getfield 92	vgx:jdField_a_of_type_Vgq	Lvgq;
    //   278: invokevirtual 249	vgq:a	()Ljava/util/List;
    //   281: invokeinterface 253 2 0
    //   286: pop
    //   287: aload_0
    //   288: getfield 92	vgx:jdField_a_of_type_Vgq	Lvgq;
    //   291: invokevirtual 255	vgq:f	()V
    //   294: aload_0
    //   295: getfield 48	vgx:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   298: invokeinterface 258 1 0
    //   303: aload_0
    //   304: getfield 222	vgx:jdField_c_of_type_Boolean	Z
    //   307: istore_1
    //   308: iload_1
    //   309: ifeq -148 -> 161
    //   312: aload_0
    //   313: getfield 55	vgx:jdField_a_of_type_AndroidViewTextureView	Landroid/view/TextureView;
    //   316: aload_2
  ...
  private void j()
  {
    ...
    {
      this.jdField_a_of_type_Vhe.a(this.jdField_c_of_type_Long);
      f();
      a(4, 8L);
      return;
    }
  ...
  private void k()
  {
    ...
    this.jdField_b_of_type_Long = this.jdField_a_of_type_Vhe.a();
  }
  
  private void l()
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Vgs.b();
    this.jdField_a_of_type_Vjl.a();
  }
  
  private void m()
  {
    this.jdField_a_of_type_Vgq.a();
  }
  ...
  private void p()
  {
    if (this.jdField_a_of_type_Vgr != null) {
      ...
      {
        vgz localvgz = (vgz)this.jdField_a_of_type_JavaUtilQueue.poll();
        vhb localvhb = this.jdField_a_of_type_Vgq.a(localvgz);
        this.jdField_a_of_type_Vgr.a(localvhb, localvgz);
      }
    }
  }
  ...
  public vgs a()
  {
    return this.jdField_a_of_type_Vgs;
  }
  
  public vgw a()
  {
    return this.jdField_a_of_type_Vgw;
  }
  ...
  {
    paramPoint = new vgz(b(), paramPoint, paramInt);
  ...
  public boolean a()
  {
    return (this.jdField_c_of_type_Boolean) && (!this.jdField_a_of_type_Boolean) && (this.jdField_b_of_type_Boolean);
  }
  ...
  public long c()
  {
    return this.jdField_a_of_type_Vhe.a();
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    paramView = new vgz(b(), new Point((int)paramMotionEvent.getX(), (int)paramMotionEvent.getY()), 10);
    return this.jdField_a_of_type_Vgq.a(paramView) != null;
  }
