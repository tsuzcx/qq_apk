  ...
  extends vva
{
  ...
  public vuw(PhotoListPanel.SwipeUpAndDragListener paramSwipeUpAndDragListener, Context paramContext, ViewGroup paramViewGroup)
  {
  ...
  boolean b(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      paramMotionEvent.setAnimationListener(new vux(this, f2));
      break;
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.a(i, (ArrayList)localObject, false, true, "0X8005E0D", "0", i + "", false);
    }
  }
}
