...
{
  public kok(Context paramContext, QQAppInterface paramQQAppInterface, QQProgressDialog paramQQProgressDialog, EqqDetail paramEqqDetail, SessionInfo paramSessionInfo, String paramString) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      {
        CrmUtils.a(this.jdField_a_of_type_AndroidContentContext, 2131430035);
      ...
      {
        CrmUtils.a(this.jdField_a_of_type_AndroidContentContext, 2131430044);
      }
      else if (paramInt == 20)
      {
        CrmUtils.a(this.jdField_a_of_type_AndroidContentContext, 2131430045);
      }
      else
      {
        CrmUtils.a(this.jdField_a_of_type_AndroidContentContext, 2131430035);
