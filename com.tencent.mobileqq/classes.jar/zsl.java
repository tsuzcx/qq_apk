  ...
  implements zvf, zwf
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = zsl.class.getSimpleName();
  }
  
  public zsl(Bundle paramBundle)
  {
    super(paramBundle);
  }
  ...
  private boolean a(long paramLong, CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    } while (!zqn.a(paramStFeed.poster.attr.get()));
    return false;
  }
  ...
  private void m()
  {
    ...
    if ((a() instanceof SubscribeBaseFragment)) {
      this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentBottomBar.setShareClickListener(new zsm(this));
    }
  ...
  public zsf a(int paramInt)
  {
    ...
    localzsf.jdField_a_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
    localzsf.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StShare = this.jdField_b_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StShare;
    if (paramInt == 1) {}
    for (;;)
    {
      localzsf.jdField_a_of_type_Boolean = bool;
      localzsf.jdField_a_of_type_Int = paramInt;
      return localzsf;
      bool = false;
    }
  }
  ...
  public zyx a()
  {
    return this.jdField_a_of_type_Zyx;
  }
  ...
  public void a(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    b("share_key_subscribe_feeds_update", new zos(paramStFeed));
    if ((a() instanceof SubscribeBaseFragment)) {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      b("share_key_subscribe_feeds_update", new zos(this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed));
      if (!this.c)
      {
        this.jdField_a_of_type_ComTencentBizSubscribeWidgetStatusView = a().a();
        paramBundle = zqn.a() + File.separator + a(a()) + ".png";
      ...
      m();
      this.jdField_a_of_type_Zyx = new zyx(a());
      return;
    }
  ...
  public void c(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    if ((!zqn.a(paramStFeed.poster.attr.get())) && (a() != null))
    {
      zzs.a().a(a(), "subscribe_freshman_interaction_guide", 5000, new zss(this, paramStFeed));
      a().runOnUiThread(new DetailBaseBlock.6(this));
      zzs.a().a(a(), "subscribe_freshman_share_guide", 10000, new zst(this));
    }
  }
  ...
  protected void d()
  {
    ...
    {
      return;
      this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentBottomBar.a(a().getActivity(), this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed, new zsn(this), this.jdField_a_of_type_ComTencentBizSubscribeBaseUIExtraTypeInfo);
  ...
  public void g()
  {
    znq.a().a((String)zqg.b.get("follow_guide_pics"), 4000, new zso(this), true);
  }
  
  public void h()
  {
    znq.a().a((String)zqg.b.get("praise_guide_pics"), 4000, new zsq(this), true);
  }
