...
public class arft
{
  ...
  public static arft a(araj[] paramArrayOfaraj)
  {
    arft localarft = new arft();
    ...
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          if (localJSONObject.has("enable_third_app_share_big_image_by_server"))
          {
            ...
            {
              bool = true;
              localarft.jdField_a_of_type_Boolean = bool;
            }
          }
          else
          {
            if (localJSONObject.has("sdk_share_verify_appinfo_timeout_duration")) {
              localarft.jdField_a_of_type_Long = localJSONObject.optInt("sdk_share_verify_appinfo_timeout_duration", 0);
            }
      ...
      {
        QLog.e("OpenSdkConfProcessor", 1, "parse, failed!", paramArrayOfaraj);
        return null;
      }
      boolean bool = false;
      continue;
