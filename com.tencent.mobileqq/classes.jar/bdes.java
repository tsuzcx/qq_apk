...
{
  public BroadcastReceiver a = new bdet(this);
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("ptv".equals(paramString2))
    {
      ...
      for (;;)
      {
        ...
        localbodz.f = str21;
        localbodz.g = str22;
        localbodz.h = ((String)localObject2);
        if (!TextUtils.isEmpty(str9))
        {
          bdeq.a(this.mRuntime.a(), this.mRuntime.a(), str4, str5, str6, str7, str10, str11, str12, str13, str14, str15, str16, str17, str18, str8, str19, paramString3, str9, paramString1, paramJsBridgeListener, paramString2, (String)localObject1, localbodz);
          continue;
          continue;
          ...
          else if ("onClickShareBattle".equals(paramString3))
          {
            try
            {
              ...
              zaj.a().a(paramString1, Integer.valueOf(i).toString());
            }
            catch (JSONException paramJsBridgeListener) {}
            if (QLog.isColorLevel())
            {
          ...
          else if (("startStoryActivity".equals(paramString3)) && (paramVarArgs != null))
          {
            try
            {
              ...
              bdeq.a(this.mRuntime.a(), this.mRuntime.a(), i);
            }
