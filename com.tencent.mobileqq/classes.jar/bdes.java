...
public class bdes
  implements bdeq, NetworkState.NetworkStateListener
{
  private static bdes jdField_a_of_type_Bdes;
  ...
  private bdep jdField_a_of_type_Bdep = new bdep();
  ...
  private bdes()
  {
    this.jdField_a_of_type_Bdep.a(this);
    a();
  }
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bdet(this, localHandlerThread.getLooper());
    ...
    for (int i = 1;; i = 0)
    {
      if (paramInt2 != 0)
      {
        if ((paramStatReportRequest != null) && (paramStatReportRequest.size() > 0) && (i == 0))
        {
          ...
          while (paramInt2 < i)
          {
            ...
            paramStatReportResponse = bdef.a().a(String.valueOf(j));
            if (paramStatReportResponse != null) {
              paramStatReportRequest.addAll(paramStatReportResponse);
            }
            bdef.a().a(String.valueOf(j), paramStatReportRequest);
            paramInt2 += 1;
          }
        }
      }
      else if ((i != 0) && (paramStatReportRequest != null) && (paramStatReportRequest.size() > 0))
      {
        ...
        while (paramStatReportRequest.hasNext())
        {
          ...
          bdef.a().a(String.valueOf(paramStatReportResponse.type));
        }
      }
