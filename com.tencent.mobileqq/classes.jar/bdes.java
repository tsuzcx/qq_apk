...
public class bdes
{
  ...
  public static ArrayList<bdet> a(String paramString)
  {
  ...
  public static ArrayList<bdet> a(JSONArray paramJSONArray)
  {
    Object localObject2;
    ...
    for (;;)
    {
      ...
      try
      {
        if (i < paramJSONArray.length())
        {
          ...
          {
            localArrayList.add(new bdet(str1));
            localObject2 = str1;
          }
          localArrayList.add(new bdet(str1, str3, str2, str4));
          i += 1;
  ...
  public static LinkedHashMap<String, Integer> a(String[] paramArrayOfString, List<bdet> paramList)
  {
    int j = 0;
    ...
    {
      bdet localbdet = (bdet)paramList.next();
      if (localLinkedHashMap.containsKey(localbdet.jdField_a_of_type_JavaLangString))
      {
        i += 1;
      }
      else
      {
        localLinkedHashMap.put(localbdet.jdField_a_of_type_JavaLangString, Integer.valueOf(i));
        i += 1;
      }
    }
