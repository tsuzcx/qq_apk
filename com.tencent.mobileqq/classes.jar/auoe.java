  ...
  implements ajvb
{
  ...
  private long a(long paramLong)
  {
    ...
    if (paramLong == 0L)
    {
      ...
      {
        aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "calcFlowConsume", "picSize==0,fix by pisSizeAvg");
        l1 = paramLong;
      }
    }
    return l1;
  ...
  private void a(int paramInt, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    if (paramInt == 1)
    {
      ...
      for (paramLong1 = 0L;; paramLong1 = this.B)
      {
        ...
        paramLong2 = this.A;
        paramLong1 = this.B;
        aunq.a("4gFlowPre", this.A, false);
        aunq.a("4gFlowWaste", this.B, paramBoolean);
        if (QLog.isColorLevel()) {
          aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "updateFlow", "networkType=" + paramInt + ", preFlowPre=" + l2 + " preFlowWaste=" + l1 + "flowPre=" + paramLong2 + ", flowWaste:" + paramLong1);
        }
        return;
        paramLong1 = this.A;
        break;
    ...
    for (paramLong1 = 0L;; paramLong1 = this.D)
    {
      ...
      paramLong2 = this.C;
      paramLong1 = this.D;
      aunq.a("xgFlowPre", this.C, false);
      aunq.a("xgFlowWaste", this.D, paramBoolean);
      break;
      paramLong1 = this.C;
      break label270;
      paramLong1 = this.C;
  ...
  {
    this.jdField_a_of_type_Aunz.a(paramInt1, paramInt2, paramMessageForPic.mNotPredownloadReason);
    paramMessageForPic.preDownState = 2;
    a(paramMessageForPic);
    if (paramInt1 == 0)
    {
      this.L += 1L;
      aunq.a("wifiHitCount", this.L, true);
      if (QLog.isColorLevel()) {
        aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payHit", "networkType:" + paramInt1 + ",wifiHitCount:" + this.L + ",uniseq:" + paramMessageForPic.uniseq);
      }
    }
    do
    {
      ...
      this.H += 1L;
      this.F -= paramLong;
      aunq.a("accFlowWasteTotal", this.F, false);
      aunq.a("xgHitCount", this.H, true);
    } while (!QLog.isColorLevel());
    aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payHit", "networkType:" + paramInt1 + ",xgHitCount:" + this.H + ",uniseq:" + paramMessageForPic.uniseq);
    aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payHit", "accFlowPreTotal:" + this.E + ",accFlowWasteTotal:" + this.F);
  }
  ...
  private void b(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2)
  {
    if (this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      if (localPicPreDownloader != null)
      {
        ...
        this.jdField_a_of_type_Aunz.e(paramInt1, i1);
        this.jdField_a_of_type_Aunz.a(paramInt1, i1);
        this.jdField_a_of_type_Aunz.c(paramInt1, paramInt2);
      }
    }
    ...
    {
      this.M += 1L;
      aunq.a("wifiMissCount", this.M, true);
      aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payMiss", "networkType:" + paramInt1 + ",wifiMissCount:" + this.M + ",uniseq:" + paramMessageForPic.uniseq);
    }
    label164:
    do
    {
      return;
      this.jdField_a_of_type_Aunz.a(paramMessageForPic.preDownNetworkType, paramMessageForPic.mNotPredownloadReason);
      ...
      this.I += 1L;
      aunq.a("xgMissCount", this.I, true);
    } while (!QLog.isColorLevel());
    aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payMiss", "networkType:" + paramInt1 + ", xgMissCount:" + this.I + ", uniseq:" + paramMessageForPic.uniseq);
  }
  ...
  private void c(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == 0) {
      if (QLog.isColorLevel()) {
        aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payLeftRight", "networkType:" + paramInt1 + ",wifiHitCount:" + this.L + ",uniseq:" + paramMessageForPic.uniseq);
      }
    }
    do
    {
    ...
    aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payLeftRight", "networkType:" + paramInt1 + ",xgHitCount:" + this.H + ",uniseq:" + paramMessageForPic.uniseq);
  }
  
  private void d(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2)
  {
    this.jdField_a_of_type_Aunz.d(paramInt1, paramInt2);
    paramMessageForPic.preDownState = 6;
    a(paramMessageForPic);
    if (paramInt1 == 0) {
      if (QLog.isColorLevel()) {
        aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payNotSupport", "networkType:" + paramInt1 + ",wifiHitCount:" + this.L + ",uniseq:" + paramMessageForPic.uniseq);
      }
    }
    do
    {
    ...
    aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "payNotSupport", "networkType:" + paramInt1 + ",xgHitCount:" + this.H + ", uniseq:" + paramMessageForPic.uniseq);
  }
  
  private void e()
  {
    this.A = aunq.a("4gFlowPre", this.s);
    this.B = aunq.a("4gFlowWaste", 0L);
    this.C = aunq.a("xgFlowPre", this.y);
    this.D = aunq.a("xgFlowWaste", 0L);
    this.L = aunq.a("wifiHitCount", this.L);
    this.M = aunq.a("wifiMissCount", this.M);
    this.N = aunq.a("wifiManulClickCount", this.N);
    this.K = aunq.a("wifiPreDownCout", this.K);
    this.H = aunq.a("xgHitCount", this.H);
    this.I = aunq.a("xgMissCount", this.I);
    this.J = aunq.a("xgManulClickCount", this.J);
    this.G = aunq.a("xgPreDownCount", this.G);
    this.E = aunq.a("accFlowPreTotal", this.E);
    this.F = aunq.a("accFlowWasteTotal", this.F);
    this.O = aunq.a("requestListOverLimitCount", this.O);
    if (QLog.isColorLevel()) {
  ...
  private void f()
  {
    ...
    else
    {
      ...
      this.u = aunq.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "AMaxPDFlow3G", 614400L);
      this.v = aunq.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "AMaxWFlow3G", 716800L);
      this.w = 0L;
      this.x = 0L;
      this.o = this.u;
      this.q = 0L;
  ...
  public int a(long paramLong, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (QLog.isColorLevel()) {
          aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "isOverLimit()", "NetworkType:" + paramInt2 + " isInDPCWhiteList:" + bool);
        }
        if (paramInt2 != 0) {
          break;
        }
      ...
      aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "isOverLimit()", "Wifi, result=" + 0);
      return 0;
      if ((!bool) || (paramInt2 == 3)) {
        break;
      }
    ...
    aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "isOverLimit()", "InDPCWhiteList, result=" + 0);
    return 0;
    long l3 = a(paramLong);
    long l1;
    label219:
    ...
    {
      if (QLog.isColorLevel()) {
        aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "isOverLimit", "result:" + i1 + ",FlowWaste +picSize=" + (l2 + l3) + ",FlowWasteLimit：" + paramLong + ",FlowPre:" + l1 + ",picSize:" + l3 + ",FlowWaste:" + l2 + ",uinType:" + paramInt1 + ",networkType:" + paramInt2 + ",isDynamic:" + paramBoolean);
      }
      return i1;
      paramLong = this.v;
      break;
  ...
  public HashMap<String, String> a()
  {
    ...
    long l1 = aunq.a("4gFlowPre", this.A);
    long l2 = aunq.a("4gFlowWaste", this.B);
    long l3 = aunq.a("xgFlowPre", this.C);
    long l4 = aunq.a("xgFlowWaste", this.D);
    long l5 = aunq.a("accFlowPreTotal", this.E);
    long l6 = aunq.a("xgPreDownCount", this.G);
    long l7 = aunq.a("xgHitCount", this.H);
    long l8 = aunq.a("xgMissCount", this.I);
    long l9 = aunq.a("wifiPreDownCout", this.K);
    long l10 = aunq.a("wifiHitCount", this.L);
    long l11 = aunq.a("wifiMissCount", this.M);
    long l12 = aunq.a("xgManulClickCount", this.J);
    long l13 = aunq.a("wifiManulClickCount", this.N);
    long l14 = aunq.a("requestListOverLimitCount", this.O);
    if (QLog.isColorLevel()) {
      aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "getReportInfo", "\n|- sp4gFlowPre:" + l1 + "\n|- sp4gFlowWaste:" + l2 + "\n|- spXgFlowPre:" + l3 + "\n|-  spXgFlowWaste：" + l4 + "\n|-  spFlowPreTotal:" + l5 + "\n|-  spXgPreDownCount：" + l6 + "\n|-  spXgHitCount:" + l7 + "\n|-  spXgMissCount：" + l8 + "\n|-  spWifiPreDownCount:" + l9 + "\n|-  spWifiHitCount：" + l10 + "\n|-  spWifiMissCount:" + l11 + "\n|-  spXgManulClickCount：" + l12 + "\n|-  spWifiManulClickCount:" + l13 + "\n|-  spRequestOverLimitCount:" + l14);
    }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    {
      this.K += 1L;
      aunq.a("wifiPreDownCout", this.K, true);
    }
    do
    {
      return;
      ...
      this.F += paramLong;
      this.G += 1L;
      aunq.a("accFlowPreTotal", this.E, false);
      aunq.a("accFlowWasteTotal", this.F, false);
      aunq.a("xgPreDownCount", this.G, true);
    } while (!QLog.isColorLevel());
    aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "calcFlowConsume", "networkType:" + paramInt + ",wifiPreDownCout:" + this.K + ",xgPreDownCout:" + this.G);
    aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "calcFlowConsume", "accFlowPreTotal:" + this.E + ",accFlowWasteTotal:" + this.F);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Aunz = ((aunz)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(73));
    this.jdField_a_of_type_Akky = ((akky)this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a().a(3));
    f();
    c();
    e();
    long l1 = System.currentTimeMillis();
    if (l1 - aunq.a("lastDayTime", 0L) > 86400000L)
    {
      String str = paramQQAppInterface.getCurrentAccountUin();
      aunq.a("lastDayTime", l1, true);
      auns.a(str, a());
      d();
      ((aunz)paramQQAppInterface.getManager(73)).a();
    }
    if (QLog.isColorLevel()) {
      aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "init", "");
    }
  }
  
  public void a(MessageForPic paramMessageForPic)
  {
    aunq.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPic);
  }
  ...
  public void a(MessageForPic paramMessageForPic, long paramLong)
  {
    ...
    do
    {
      ...
      this.F -= paramLong;
      aunq.a("accFlowPreTotal", this.E, false);
      aunq.a("accFlowWasteTotal", this.F, true);
    } while (!QLog.isColorLevel());
    aune.a("PIC_TAG_PRELOAD.PreDownloadStrategyBeta", "fixPicSizeAfter", "accFlowPreTotal:" + this.E + ",accFlowWasteTotal:" + this.F);
  }
  
  public void a(String paramString)
  {
    if (this.jdField_a_of_type_Akky == null) {}
    ...
    do
    {
      ...
      return;
      localTroopStatisticsInfo = this.jdField_a_of_type_Akky.a(paramString);
    ...
    {
      this.jdField_a_of_type_Akky.a(paramString);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        aune.a("PIC_TAG_PRELOAD_TROOP", "onDpcPullFinished", "try to initDPCConfig again");
      }
      f();
    }
  }
  ...
  {
    if (aunq.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPic.istroop, paramMessageForPic.frienduin) != 0) {}
    label349:
    for (;;)
    {
      return true;
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      QLog.d("PIC_TAG_PRELOAD_TROOP", 2, "DPC has not been initialized");
      return true;
      paramString = this.jdField_a_of_type_Akky.a(paramString);
  ...
  public boolean[] a(int paramInt1, int paramInt2)
  {
    ...
    {
      i2 = aunq.a(0, paramInt1, 0);
      i1 = aunq.a(0, paramInt1, 1);
      if ((this.i >> i2 & 1L) != 1L) {
        break label180;
      }
      bool1 = true;
    ...
    {
      if (QLog.isColorLevel()) {
        aune.a("PIC_TAG_PRELOAD", "isPreDownload", "netWokrType:" + paramInt2 + ",uinType:" + paramInt1 + ",preDownThumb:" + bool1 + ",preDownBig:" + bool2 + ",xGPreDownPolicy:" + this.i);
      }
      return new boolean[] { bool1, bool2 };
      i2 = aunq.a(paramInt2, paramInt1, 0);
      i1 = aunq.a(paramInt2, paramInt1, 1);
      break;
      bool1 = false;
      break label52;
    }
  ...
  {
    if (this.jdField_a_of_type_Aunz == null) {}
    int i1;
    do
    {
      do
      ...
      i1 = aunq.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPic.istroop, paramMessageForPic.frienduin);
  ...
  public void b(String paramString)
  {
    ...
    QLog.d("PIC_TAG_PRELOAD_TROOP", 2, "DPC has not been initialized");
    return;
    TroopStatisticsInfo localTroopStatisticsInfo = this.jdField_a_of_type_Akky.a(paramString);
    long l1;
    if (localTroopStatisticsInfo != null)
    {
    ...
    for (paramString = localTroopStatisticsInfo;; paramString = localTroopStatisticsInfo)
    {
      this.jdField_a_of_type_Akky.b(paramString);
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  {
    int i1 = 0;
    this.i = aunq.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "PicDPy471", 1374942199L);
    this.j = aunq.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "AFBFlowHit3G", 150L);
    this.k = aunq.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "AFBFlowMiss3G", 40960L);
    this.l = this.k;
    this.m = aunq.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "APicAvgSize", 71680L);
    this.n = aunq.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "APicMaxSize", 204800L);
    this.jdField_a_of_type_Boolean = aunq.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, false);
    this.jdField_a_of_type_ArrayOfLong = aunq.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface);
    this.T = aunq.a(this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, "APicMaxSize", 921600L);
    int i2;
    if (QLog.isColorLevel())
    {
  ...
  public void d()
  {
    ...
    this.J = 0L;
    this.G = 0L;
    aunq.a("requestListOverLimitCount", this.O, false);
    aunq.a("wifiHitCount", this.L, false);
    aunq.a("wifiMissCount", this.M, false);
    aunq.a("wifiManulClickCount", this.N, false);
    aunq.a("wifiPreDownCout", this.K, false);
    aunq.a("4gFlowWaste", this.B, false);
    aunq.a("xgFlowWaste", this.D, false);
    aunq.a("xgHitCount", this.H, false);
    aunq.a("xgMissCount", this.I, false);
    aunq.a("xgManulClickCount", this.J, false);
    aunq.a("xgPreDownCount", this.G, true);
  }
}
