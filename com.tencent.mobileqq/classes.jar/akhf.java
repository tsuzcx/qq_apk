  ...
  implements Manager
{
  ...
  private ConcurrentHashMap<String, akhh> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          ((StringBuilder)localObject1).append(((akhh)localEntry.getValue()).jdField_a_of_type_Int);
          ((StringBuilder)localObject1).append(",type=");
          ((StringBuilder)localObject1).append(((akhh)localEntry.getValue()).b);
          ((StringBuilder)localObject1).append(",isRequest=");
          ((StringBuilder)localObject1).append(((akhh)localEntry.getValue()).jdField_a_of_type_Boolean);
          ((StringBuilder)localObject1).append(",saveTime=");
          ((StringBuilder)localObject1).append(((akhh)localEntry.getValue()).jdField_a_of_type_Long);
      ...
      {
        localObject1 = (akhh)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
        if (localObject1 != null)
        {
          int k = ((akhh)localObject1).jdField_a_of_type_Int;
          int m = ((akhh)localObject1).b;
          if (((m == 0) && (k != j)) || ((m != i) && (!((akhh)localObject1).jdField_a_of_type_Boolean)))
          {
            ((akhh)localObject1).jdField_a_of_type_Boolean = true;
            if (QLog.isColorLevel())
            {
          ...
          if ((k == j) && (m == i) && (((akhh)localObject1).jdField_a_of_type_Boolean))
          {
            if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    Object localObject = baig.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      localObject = ((String)localObject).split("\\|");
      if ((localObject != null) && (localObject.length == 2))
      {
        this.jdField_a_of_type_Long = alig.a(localObject[0]);
        this.jdField_b_of_type_Long = alig.a(localObject[1]);
        if (QLog.isColorLevel()) {
  ...
  public void a(akhg paramakhg)
  {
    ...
    if ((a()) && (paramakhg != null))
    {
      ...
      localStringBuilder.append(" uin=").append(baip.e(paramakhg.jdField_a_of_type_JavaLangString));
      localStringBuilder.append(" sysId=").append(paramakhg.jdField_b_of_type_Long);
      localStringBuilder.append(" headType=").append(paramakhg.c);
      localStringBuilder.append(" qq18Switch=").append(paramakhg.jdField_a_of_type_Long);
      if ((!TextUtils.isEmpty(paramakhg.jdField_a_of_type_JavaLangString)) && (paramakhg.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) && (paramakhg.jdField_a_of_type_Long != -1L)) {
        a(paramakhg.jdField_a_of_type_Long);
      }
      localFriendListHandler = (FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(1);
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(1, paramakhg.jdField_a_of_type_JavaLangString, 0);
      if ((localObject == null) || (!((Boolean)((Pair)localObject).first).booleanValue())) {
        break label221;
      }
      localFriendListHandler.c(paramakhg.jdField_a_of_type_JavaLangString);
      localFriendListHandler.notifyUI(3, true, paramakhg.jdField_a_of_type_JavaLangString);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      if ((localObject != null) && (((Pair)localObject).second != null))
      {
        ...
        if (((paramakhg.jdField_a_of_type_Long == 1L) && (paramakhg.c != -1L) && (paramakhg.c != l2)) || ((paramakhg.jdField_b_of_type_Long != -1L) && (paramakhg.jdField_b_of_type_Long != l1) && (l2 == 0L)))
        {
          localStringBuilder.append(" fetch userHead");
          localFriendListHandler.c(paramakhg.jdField_a_of_type_JavaLangString);
          localFriendListHandler.notifyUI(3, true, paramakhg.jdField_a_of_type_JavaLangString);
  ...
  public void a(String paramString)
  {
    ...
    {
      akhh localakhh = (akhh)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
      if ((localakhh != null) && (localakhh.jdField_a_of_type_Boolean))
      {
        QLog.d("ClassicHeadActivityManager", 2, " QQ 18 handle handleGetHeadError uin=" + paramString + ",HeadID=" + localakhh.jdField_a_of_type_Int + ",Type=" + localakhh.b + ",IsRequest=" + localakhh.jdField_a_of_type_Boolean);
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramString);
      }
    }
  }
      ...
      do
      {
        do
        {
          ...
          do
          {
            ...
            {
              return;
              localObject = new akhh(paramString, paramInt1, paramInt2);
              if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(paramString)) {
                break;
              }
            ...
            return;
            localakhh = (akhh)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
          } while (localakhh == null);
          i = localakhh.jdField_a_of_type_Int;
          j = localakhh.b;
