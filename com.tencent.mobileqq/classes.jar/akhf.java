  ...
  extends ajtd
{
  ...
  public akhf(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    paramString = bbdj.a(paramString);
  ...
  private void a(int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3, ThemeAuth.DiyThemeDetail paramDiyThemeDetail)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramString1))
      {
        ...
        if (paramInt1 == 2) {
          acuv.a(localMobileQQ, this.app.getAccount(), null, str2);
        }
      }
  ...
  private void a(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      QLog.d("Theme.ThemeHandler", 1, "Theme Auth themeId=" + str1 + ",version=" + "20000000" + ", userThemeId=" + str3 + ",currentThemeResPath=" + str2 + ", usr=" + ayla.a(this.mApp.getAccount(), 2) + ", oldTime=" + l1);
      if ("1000".equals(str1)) {
        break label964;
      }
    ...
    do
    {
      ...
      i = 1;
      aymi.a(null, "theme_detail", "205", 157, j, i, str1, "20000000", "1", "");
      return;
      ...
      ((ThemeAuth.ReqBody)localObject3).str_qq_version.set("8.2.8.4440");
      ((ThemeAuth.ReqBody)localObject3).uint32_qq_version.set(Integer.parseInt("4440"));
    ...
    for (int i = 1;; i = -1)
    {
      aymi.a(null, "theme_sp_speed", "204", 153, -1, i, String.valueOf(l2 - l1), "6653", "read", "");
      if ((paramBundle.isDirectory()) && (localObject1 != null))
      {
        ...
        aymi.a(this.app, "theme_detail", "204", 157, bbev.a(null), 101, str1, "665", String.valueOf(i), String.valueOf(((ThemeUtil.ThemeInfo)localObject1).fileNum));
        break;
        label964:
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    {
      if (!aylf.a(paramString1, paramString2)) {
        a(paramString1, paramString2);
      }
      while (ThemeUtil.isFixTheme(paramString1)) {
        return;
      }
      ayml.a(this.app, paramString1, "20000000");
      return;
    }
    a(paramString1, paramString2);
  }
  ...
  public void a()
  {
    ...
    else
    {
      ...
      QLog.d("Theme.ThemeHandler", 1, "sendThemeAuth init: , skThemeId:" + ((Bundle)localObject4).getString("themeId") + ", skVersion:" + ((Bundle)localObject4).getString("version") + ", qqVersion:" + "8.2.8");
      ...
      if (axmt.a((String)localObject2))
      {
        localObject3 = ayml.a(this.app).getString("themeID");
    ...
    for (;;)
    {
      ...
      ((Bundle)localObject4).putString("themePath", new aymh().a().d());
    }
    label559:
    Object localObject2 = new aymh().a((String)localObject3);
    ((VasQuickUpdateManager)this.app.getManager(184)).queryItemVersion(3, ((aymh)localObject2).b(), true, false, 0L, new akhh(this, (aymh)localObject2, localMobileQQ, (Bundle)localObject4));
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      return;
      label110:
      ThemeSwitcher.a(paramString1, paramString2, new akhg(this));
    }
  }
  
  /* Error */
  public void a(String paramString1, String paramString2, String paramString3, Bundle paramBundle, aymu paramaymu)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 7
    ...
    //   85: aload_0
    //   86: aload 5
    //   88: putfield 738	akhf:jdField_a_of_type_Aymu	Laymu;
    //   91: aload_0
    //   92: aload 4
    //   94: putfield 740	akhf:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    ...
    //   361: ldc_w 476
    //   364: aload_0
    //   365: getfield 126	akhf:mApp	Lcom/tencent/common/app/AppInterface;
    ...
    //   386: aload_0
    //   387: aload_2
    //   388: invokespecial 504	ajtd:sendPbReq	(Lcom/tencent/qphone/base/remote/ToServiceMsg;)V
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString1.str_qq_version.set("8.2.8.4440");
        paramString1.uint32_qq_version.set(Integer.parseInt("4440"));
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      return;
      if (QLog.isColorLevel()) {
        QLog.i("Theme.ThemeHandler", 2, "onReceive~ handleThemeAuth res.isSuccess=" + paramFromServiceMsg.isSuccess() + ",data=" + bbmj.a((byte[])paramObject));
      }
      String str1;
      String str2;
      Object localObject2;
      for (;;)
      {
        try
        {
          ...
          if (((ThemeAuth.RspBody)localObject1).uint32_sub_cmd.has())
          {
            ...
            if (k == 0)
            {
              ...
              QLog.e("Theme.ThemeHandler", 1, "onReceive Error: isSuccess=false, data=" + bbmj.a((byte[])paramObject) + ", subCmd=" + j);
              if (3 != j) {
                break;
              }
            }
            ...
            bbrc.a(this.app, "individual_v2_theme_auth_fail", String.valueOf(j), String.valueOf(j), null, 0.0F);
            paramFromServiceMsg = new HashMap();
            paramFromServiceMsg.put("authResult", String.valueOf(j));
            axrl.a(BaseApplication.getContext()).a("", "individual_v2_theme_auth_fail", false, 0L, -1L, paramFromServiceMsg, "", true);
            aymi.a(this.app, "theme_detail", "204", 157, bbev.a(null), 0 - j, str1, str2, "1", "");
          }
        }
        ...
        try
        {
          ...
          localObject2 = axrl.a(this.mApp.getApplication());
          str3 = this.mApp.getAccount();
          if (j != 0) {
            break label2737;
          }
          bool = true;
          ((axrl)localObject2).a(str3, "VipThemeAuthHandleError", bool, 1L, 0L, paramFromServiceMsg, "", false);
        }
        ...
        try
        {
          paramToServiceMsg = new aymh().a(str1).a(this.mApp.getApplication());
          bbdj.a(paramToServiceMsg, true);
      ...
      break label2743;
      if (bool) {
        axqw.b(null, "CliOper", "", "", "theme", "0X8007234", 0, 0, String.valueOf(i), "", "", "");
      }
      if (!TextUtils.isEmpty(paramToServiceMsg)) {
        break label2728;
      }
      paramToServiceMsg = ajyc.a(2131714911);
      if (bool)
      {
      ...
      {
        acuv.a(this.mApp.getApplication(), this.app.getAccount(), null, "null");
    ...
    axqw.b(this.app, "CliOper", "", "", "0X8005B9E", "0X8005B9E", 0, 0, "", "", "", "");
    paramFromServiceMsg = new Message();
    ...
    if (3 == j)
    {
      paramFromServiceMsg = ajyc.a(2131714914);
      if (k != 0)
      {
      ...
      for (;;)
      {
        ...
        if ((this.jdField_a_of_type_Aymu != null) && (this.jdField_a_of_type_AndroidOsBundle != null)) {
          break;
        }
      ...
      if ((!TextUtils.isEmpty(paramFromServiceMsg)) && (paramFromServiceMsg.equals(this.jdField_a_of_type_AndroidOsBundle.getString("themeId"))))
      {
        ...
        paramToServiceMsg = this.jdField_a_of_type_Aymu;
        if (i != 0) {
          break label2789;
        }
      }
