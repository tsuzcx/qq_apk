...
public abstract class aoaw
{
  ...
  public aoaw(Activity paramActivity, String paramString1, String paramString2, String paramString3, int paramInt)
  {
  ...
  protected void a()
  {
    ...
    for (localQZoneShareData.l = "邀请你加入派对";; localQZoneShareData.l = (c() + "邀请你加入派对"))
    {
      ...
      localQZoneShareData.a.add(d());
      localQZoneShareData.d = a();
      localQZoneShareData.jdField_b_of_type_Int = 0;
      bltb.a(a(), b(), localQZoneShareData, null, AVGameActivity.jdField_a_of_type_Int);
      return;
  ...
  protected void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Bihh = new aoax(this, paramInt);
  ...
  protected void b()
  {
    try
    {
      Object localObject = mxl.a().a();
      long l = ((myc)localObject).a();
      QLog.d("AVGameShareBase", 1, "copyRoomId: " + l);
      int i = ((myc)localObject).d();
      bcst.b(null, "dc00898", "", "", "0X800B066", "0X800B066", i, 0, "5", String.valueOf(l), "", "");
      bcst.b(null, "dc00898", "", "", "0X800B067", "0X800B067", i, 0, "", String.valueOf(l), "", "");
      String str = mxl.a().a().getCurrentAccountUin();
      localObject = ((myc)localObject).a().getNick(str);
      ((ClipboardManager)BaseApplicationImpl.getContext().getSystemService("clipboard")).setPrimaryClip(ClipData.newPlainText("avgame_share_copy_room_id_label", String.format(a().getString(2131690235), new Object[] { localObject, a(), a(l) })));
      neq.a().b().post(new AVGameShareBase.4(this));
      return;
    }
