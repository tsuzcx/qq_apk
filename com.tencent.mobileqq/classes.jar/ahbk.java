...
{
  private static final String jdField_a_of_type_JavaLangString = anzj.a(2131700063);
  ...
  public ahbk(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo);
  }
  
  private View a(View paramView, ahbl paramahbl)
  {
    View localView = paramView;
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558828, null);
      paramahbl.jdField_b_of_type_AndroidViewView = paramView;
      paramahbl.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131362342);
      paramahbl.d = paramView.findViewById(2131362341);
      paramahbl.a = ((URLImageView)paramView.findViewById(2131362344));
      paramahbl.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362345));
      paramahbl.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362343));
      localView = paramView;
      if (e)
      {
        paramahbl.jdField_b_of_type_JavaLangStringBuilder = new StringBuilder();
        localView = paramView;
      }
    }
    if (e)
    {
      ...
      paramahbl.jdField_b_of_type_JavaLangStringBuilder.replace(0, paramahbl.jdField_b_of_type_JavaLangStringBuilder.length(), "");
    }
    return localView;
  }
  ...
  {
    long l1;
    if ((paramMessageRecord != null) && (!bhjz.a().a(paramMessageRecord, "aio_msg|birthday_notice")))
    {
      bhjz.a().a(paramMessageRecord, "aio_msg|birthday_notice");
      l1 = 0L;
    }
    try
    {
  ...
  protected View a(MessageRecord paramMessageRecord, agen paramagen, View paramView, LinearLayout paramLinearLayout, agjk paramagjk)
  {
    ...
    paramagen = (ahbl)paramagen;
    paramView = a(paramView, paramagen);
    try
    {
      paramagen.a.setBackgroundURL(paramMessageRecord.icon);
      paramagen.d.setBackgroundColor(Color.parseColor(paramMessageRecord.background));
      paramagen.jdField_b_of_type_AndroidWidgetTextView.setText(paramMessageRecord.birthday);
      ...
      if (i >= 0)
      {
        ...
        paramagen.jdField_c_of_type_AndroidWidgetTextView.setText(paramLinearLayout);
        paramagen.jdField_c_of_type_AndroidViewView.setTag(paramMessageRecord);
        paramagen.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
        a(paramMessageRecord);
        if (e)
        {
          paramagen.jdField_b_of_type_JavaLangStringBuilder.append("生日");
          paramagen.jdField_b_of_type_JavaLangStringBuilder.append(paramMessageRecord.birthday);
          paramagen.jdField_b_of_type_JavaLangStringBuilder.append(paramMessageRecord.blessing);
          paramagen.jdField_b_of_type_AndroidViewView.setContentDescription(paramagen.jdField_b_of_type_JavaLangStringBuilder.toString());
        }
        return paramView;
      }
    }
    catch (Exception paramLinearLayout)
    {
      for (;;)
      {
        ...
        continue;
        paramagen.jdField_c_of_type_AndroidWidgetTextView.setText(paramMessageRecord.blessing);
      }
    }
  }
