  ...
  implements audn
{
  ...
  public void a(audl paramaudl, audm paramaudm)
  {
    if (((paramaudl instanceof SilkCodecWrapper)) || ((paramaudl instanceof AmrInputStreamWrapper))) {
      this.b += (int)QQRecorder.a(this.jdField_a_of_type_Int, 4, 2, paramaudm.jdField_a_of_type_Int);
    }
  }
  ...
  public boolean a(Context paramContext, String paramString1, int paramInt, QQRecorder.RecorderParam paramRecorderParam, String paramString2)
  {
    try
    {
      ...
      if (paramInt != 0) {
        this.jdField_a_of_type_Audp.a(new VoiceChange(paramContext, paramInt, paramString2));
      }
      if (paramRecorderParam.c == 0) {
        this.jdField_a_of_type_Audp.a(new AmrInputStreamWrapper(paramContext));
      }
      for (;;)
      {
        this.jdField_a_of_type_Audp.a(paramRecorderParam.jdField_a_of_type_Int, paramRecorderParam.b, paramRecorderParam.c);
        ...
        paramContext = bahn.a(paramRecorderParam.c, paramRecorderParam.jdField_a_of_type_Int);
        ...
        return true;
        this.jdField_a_of_type_Audp.a(new SilkCodecWrapper(paramContext));
      }
      return false;
    }
  ...
  public boolean a(byte[] paramArrayOfByte, int paramInt)
  {
    try
    {
      if (this.jdField_a_of_type_Audp != null)
      {
        paramArrayOfByte = this.jdField_a_of_type_Audp.a(paramArrayOfByte, 0, paramInt);
