...
public class yzf
{
  ...
  public static GdtCanvasData a(GdtAd paramGdtAd)
  {
    if (paramGdtAd == null)
    {
      yxp.d("GdtCanvasDataBuilderV2", "build error");
      return null;
    }
    ...
    yxp.b("GdtCanvasDataBuilderV2", "build " + str);
    try
    {
    ...
    {
      yxp.d("GdtCanvasDataBuilderV2", "build error", paramGdtAd);
    }
    return null;
  }
  ...
  private static GdtCanvasData a(GdtAd paramGdtAd, JSONObject paramJSONObject)
  {
    if ((paramGdtAd == null) || (paramJSONObject == null) || (paramJSONObject == JSONObject.NULL)) {
      yxp.d("GdtCanvasDataBuilderV2", "getCanvasData error");
    }
    ...
    do
    {
      ...
      paramJSONObject = yyo.a().a(paramGdtAd, paramJSONObject);
  ...
  private static GdtCanvasComponentData a(GdtAd paramGdtAd, JSONObject paramJSONObject, GdtCanvasData paramGdtCanvasData)
  {
    ...
    if ((paramJSONObject == null) || (paramJSONObject == JSONObject.NULL)) {
      yxp.d("GdtCanvasDataBuilderV2", "getComponent error");
    }
    String str;
    do
    {
  ...
  private static GdtCanvasComponentData a(JSONObject paramJSONObject, int paramInt)
  {
    ...
    {
      yxp.d("GdtCanvasDataBuilderV2", "getTextComponent error");
      return null;
    }
    ...
    localGdtCanvasMultiPictureComponentData.paddingTop = yzb.b(paramInt, ((JSONObject)localObject).getInt("marginTop"));
    localGdtCanvasMultiPictureComponentData.paddingBottom = yzb.b(paramInt, ((JSONObject)localObject).getInt("marginBottom"));
    ...
    while (paramInt < paramJSONObject.length())
    {
      ...
      ((GdtCanvasPictureComponentData)localObject).width = (yzb.c(BaseApplicationImpl.getContext()) - ((GdtCanvasPictureComponentData)localObject).paddingLeft - ((GdtCanvasPictureComponentData)localObject).paddingRight);
  ...
  private static GdtCanvasComponentData a(JSONObject paramJSONObject, GdtCanvasData paramGdtCanvasData)
  {
    if ((paramJSONObject == null) || (paramJSONObject == JSONObject.NULL))
    {
      yxp.d("GdtCanvasDataBuilderV2", "getMulitiPictureComponent error");
      return null;
    }
    GdtCanvasMultiPictureComponentData localGdtCanvasMultiPictureComponentData = new GdtCanvasMultiPictureComponentData();
    ...
    if (i < paramJSONObject.length())
    {
      ...
      localGdtCanvasPictureComponentData.paddingLeft = yzb.b(paramGdtCanvasData.basicWidth, localJSONObject.getInt("left"));
      localGdtCanvasPictureComponentData.paddingTop = yzb.b(paramGdtCanvasData.basicWidth, localJSONObject.getInt("top"));
      localGdtCanvasPictureComponentData.paddingRight = yzb.b(paramGdtCanvasData.basicWidth, localJSONObject.getInt("right"));
      localGdtCanvasPictureComponentData.paddingBottom = yzb.b(paramGdtCanvasData.basicWidth, localJSONObject.getInt("bottom"));
      ...
      localGdtCanvasPictureComponentData.width = (yzb.c(BaseApplicationImpl.getContext()) - localGdtCanvasPictureComponentData.paddingLeft - localGdtCanvasPictureComponentData.paddingRight);
  ...
  private static GdtCanvasAppBtnComponentData a(JSONObject paramJSONObject, int paramInt)
  {
    if (paramJSONObject == JSONObject.NULL)
    {
      yxp.d("GdtCanvasDataBuilderV2", "getAppButtonComponent error");
    ...
    localGdtCanvasAppBtnComponentData.button.text.size = yzb.b(paramInt, paramJSONObject.getInt("fontSize"));
    int i = paramJSONObject.getInt("width");
    localGdtCanvasAppBtnComponentData.height = yzb.b(paramInt, paramJSONObject.getInt("lineHeight"));
    ...
    for (;;)
    {
      localGdtCanvasAppBtnComponentData.paddingLeft = yzb.b(paramInt, paramJSONObject.getInt("marginLeft"));
      localGdtCanvasAppBtnComponentData.paddingRight = yzb.b(paramInt, paramJSONObject.getInt("marginRight"));
      localGdtCanvasAppBtnComponentData.width = (i * (yzb.c(BaseApplicationImpl.getContext()) - localGdtCanvasAppBtnComponentData.paddingLeft - localGdtCanvasAppBtnComponentData.paddingRight) / 100);
      localGdtCanvasAppBtnComponentData.paddingTop = yzb.b(paramInt, paramJSONObject.getInt("marginTop"));
      localGdtCanvasAppBtnComponentData.paddingBottom = yzb.b(paramInt, paramJSONObject.getInt("marginBottom"));
      ...
      localGdtCanvasAppBtnComponentData.toBottom = yzb.b(paramInt, paramJSONObject.getInt("toBottom"));
      localGdtCanvasAppBtnComponentData.whiteSpace = yzb.b(paramInt, paramJSONObject.getInt("whiteSpace"));
  ...
  private static GdtCanvasFixedButtonComponentData a(GdtAd paramGdtAd, JSONObject paramJSONObject, int paramInt)
  {
    if (paramJSONObject == JSONObject.NULL)
    {
      yxp.d("GdtCanvasDataBuilderV2", "getFixedButtonComponent error");
      paramGdtAd = null;
    }
    ...
    do
    {
      ...
      if (!TextUtils.isEmpty(localGdtCanvasFixedButtonComponentData.buttonStyle))
      {
        ...
        {
          localGdtCanvasFixedButtonComponentData.button.text.size = yzb.b(paramInt, 13);
          localGdtCanvasFixedButtonComponentData.button.text.text = ajya.a(2131705175);
          localGdtCanvasFixedButtonComponentData.width = yzb.a(81.0F, BaseApplicationImpl.getContext().getResources());
          localGdtCanvasFixedButtonComponentData.height = yzb.a(40.0F, BaseApplicationImpl.getContext().getResources());
        }
        for (;;)
        {
          ...
          localGdtCanvasFixedButtonComponentData.button.text.size = yzb.b(paramInt, 19);
          localGdtCanvasFixedButtonComponentData.width = yzb.c(BaseApplicationImpl.getContext());
          localGdtCanvasFixedButtonComponentData.height = yzb.a(50.0F, BaseApplicationImpl.getContext().getResources());
          localGdtCanvasFixedButtonComponentData.gravity = 17;
          paramInt = yzb.a(5.0F, BaseApplicationImpl.getContext().getResources());
          localGdtCanvasFixedButtonComponentData.paddingTop = paramInt;
          localGdtCanvasFixedButtonComponentData.paddingBottom = paramInt;
          paramInt = yzb.a(7.5F, BaseApplicationImpl.getContext().getResources());
  ...
  private static HotArea a(int paramInt, String paramString, JSONObject paramJSONObject, GdtCanvasPictureComponentData paramGdtCanvasPictureComponentData)
  {
    ...
    {
      return null;
      paramInt = yzb.c(BaseApplicationImpl.getContext());
  ...
  private static GdtCanvasPageData a(GdtAd paramGdtAd, JSONObject paramJSONObject, GdtCanvasData paramGdtCanvasData)
  {
    if (paramJSONObject == JSONObject.NULL)
    {
      yxp.d("GdtCanvasDataBuilderV2", "getPage error");
      return null;
    }
  ...
  private static List<GdtCanvasComponentData> a(GdtAd paramGdtAd, JSONArray paramJSONArray, GdtCanvasData paramGdtCanvasData)
  {
    ...
    {
      yxp.d("GdtCanvasDataBuilderV2", "getCanvasComponents error");
  ...
  private static List<GdtCanvasPageData> a(GdtAd paramGdtAd, JSONObject paramJSONObject, GdtCanvasData paramGdtCanvasData)
  {
    ...
    if ((paramJSONObject == null) || (paramJSONObject == JSONObject.NULL))
    {
      yxp.d("GdtCanvasDataBuilderV2", "getPageList error");
      return localArrayList;
    }
  ...
  private static void a(JSONObject paramJSONObject, int paramInt, GdtCanvasComponentData paramGdtCanvasComponentData)
  {
    ...
    {
      yxp.d("GdtCanvasDataBuilderV2", "initComponent error");
  ...
  private static GdtCanvasComponentData b(JSONObject paramJSONObject, GdtCanvasData paramGdtCanvasData)
  {
    if (paramJSONObject == JSONObject.NULL)
    {
      yxp.d("GdtCanvasDataBuilderV2", "getWebButtonComponent error");
      paramJSONObject = null;
      return paramJSONObject;
    }
    ...
    localGdtCanvasButtonComponentData.paddingLeft = yzb.b(paramGdtCanvasData.basicWidth, localJSONObject2.getInt("marginLeft"));
    localGdtCanvasButtonComponentData.paddingTop = yzb.b(paramGdtCanvasData.basicWidth, localJSONObject2.getInt("marginTop"));
    localGdtCanvasButtonComponentData.paddingRight = yzb.b(paramGdtCanvasData.basicWidth, localJSONObject2.getInt("marginRight"));
    localGdtCanvasButtonComponentData.paddingBottom = yzb.b(paramGdtCanvasData.basicWidth, localJSONObject2.getInt("marginBottom"));
    ...
    for (;;)
    {
      localGdtCanvasButtonComponentData.button.text.size = yzb.b(paramGdtCanvasData.basicWidth, paramJSONObject.getInt("fontSize"));
      ...
      localGdtCanvasButtonComponentData.width = (paramJSONObject.getInt("width") * (yzb.c(BaseApplicationImpl.getContext()) - localGdtCanvasButtonComponentData.paddingLeft - localGdtCanvasButtonComponentData.paddingRight) / 100);
      localGdtCanvasButtonComponentData.height = yzb.b(paramGdtCanvasData.basicWidth, paramJSONObject.getInt("lineHeight"));
      ...
      localGdtCanvasButtonComponentData.toBottom = yzb.b(paramGdtCanvasData.basicWidth, localJSONObject1.getInt("toBottom"));
      int i = yzb.b(paramGdtCanvasData.basicWidth, localJSONObject1.getInt("whiteSpace"));
      paramJSONObject = localGdtCanvasButtonComponentData;
      if (i <= 0) {
        break;
      }
  ...
  private static GdtCanvasComponentData c(JSONObject paramJSONObject, GdtCanvasData paramGdtCanvasData)
  {
    if (paramJSONObject == JSONObject.NULL)
    {
      yxp.d("GdtCanvasDataBuilderV2", "getArkFormComponent error");
      return null;
    }
