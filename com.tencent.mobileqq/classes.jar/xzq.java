...
public class xzq
  extends QQUIEventReceiver<StoryPickerFragment, wvw>
{
  public xzq(@NonNull StoryPickerFragment paramStoryPickerFragment)
  {
    super(paramStoryPickerFragment);
  }
  
  public void a(@NonNull StoryPickerFragment paramStoryPickerFragment, @NonNull wvw paramwvw)
  {
    boolean bool1 = false;
    if (!TextUtils.equals(paramStoryPickerFragment.jdField_a_of_type_JavaLangString, paramwvw.jdField_a_of_type_JavaLangString)) {
      return;
    }
    boolean bool2 = paramwvw.jdField_a_of_type_ComTencentBizQqstoryBaseErrorMessage.isSuccess();
    Object localObject = new ArrayList(paramwvw.jdField_a_of_type_JavaUtilList.size());
    List localList = paramwvw.jdField_a_of_type_JavaUtilList;
    int i = 0;
    while (i < localList.size())
    {
      ...
      if (localVideoCollectionItem.collectionType == 1)
      {
        ...
        {
          ygo localygo = (ygo)localVideoCollectionItem.collectionVideoUIItemList.get(j);
    ...
    if ((bool2) && (paramwvw.e))
    {
      ...
      paramStoryPickerFragment.jdField_a_of_type_Xzz.a((List)localObject);
    }
    for (;;)
    {
      if (paramwvw.c) {
      ...
      if (!paramwvw.jdField_a_of_type_Boolean) {
        bool1 = true;
      }
      ((zpn)localObject).a(bool2, bool1);
      ...
      break;
      label347:
      paramStoryPickerFragment.jdField_a_of_type_Xzz.b((List)localObject);
    }
  }
