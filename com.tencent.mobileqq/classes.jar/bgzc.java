...
public class bgzc
{
  ...
  public static void a(long paramLong, Activity paramActivity, String paramString, bgze parambgze)
  {
    ...
    bgzd localbgzd2 = b();
    if (QLog.isColorLevel()) {
      QLog.d("QZoneVideoCommonUtils", 2, "support record=" + localbgzd1.a() + ", support trim=" + localbgzd2.a());
    }
    if ((!localbgzd1.a()) && (!localbgzd2.a()))
    {
      if (localbgzd1.b()) {}
      for (paramString = localbgzd1.a();; paramString = null)
      {
        String str;
        if (paramString != null)
        {
        ...
        {
          str = paramActivity.getString(2131718252);
        }
        if (parambgze != null) {
          parambgze.onFail(paramActivity, str);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.w("QZoneVideoCommonUtils", 2, "qzone video is not supported, recordSupport tips=" + localbgzd1.a() + ",trimSupport tips=" + localbgzd2.a() + ",show tips=" + str);
        return;
      }
    }
    a(paramLong, paramActivity, localbgzd1.a(), localbgzd2.a(), paramString);
    PerfTracer.traceEnd("Video_component_pre_launch");
  }
  
  public static void a(long paramLong, Activity paramActivity, String paramString, bgze parambgze, Bundle paramBundle)
  {
    PerfTracer.traceStart("Video_component_pre_launch");
    if (paramActivity == null)
    {
    ...
    if ((!localbgzd1.a()) && (!localbgzd2.a()))
    {
      ...
      for (paramString = localbgzd1.a();; paramString = null)
      {
        ...
        {
          paramBundle = paramActivity.getString(2131718252);
        }
        if (parambgze != null) {
          parambgze.onFail(paramActivity, paramBundle);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.w("QZoneVideoCommonUtils", 2, "qzone video is not supported, recordSupport tips=" + localbgzd1.a() + ",trimSupport tips=" + localbgzd2.a() + ",show tips=" + paramBundle);
        return;
      }
    }
