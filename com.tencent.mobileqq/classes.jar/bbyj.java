  ...
  extends WtloginObserver
{
  ...
  final bbyk jdField_a_of_type_Bbyk;
  final String jdField_a_of_type_JavaLangString;
  
  bbyj(Intent paramIntent, String paramString, bbyk parambbyk)
  {
  ...
  public void OnRegGetSMSVerifyLoginAccountWithLhSig(int paramInt, long paramLong, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramArrayOfByte1 = BaseApplicationImpl.getContext().getString(2131717143);
        ...
        if (QLog.isDevelopLevel()) {
          bbyl.a("LHLoginMng -- OnRegGetSMSVerifyLoginAccountWithLhSig", localIntent);
        }
        if (this.jdField_a_of_type_Bbyk != null) {
          this.jdField_a_of_type_Bbyk.a(localIntent, bool, this.jdField_a_of_type_JavaLangString, paramArrayOfByte4, paramArrayOfByte1);
        }
