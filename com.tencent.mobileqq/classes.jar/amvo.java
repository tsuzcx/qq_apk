  ...
  implements Manager
{
  ...
  amsu jdField_a_of_type_Amsu = new amvr(this);
  private SharedPreferences jdField_a_of_type_AndroidContentSharedPreferences;
  private avsz jdField_a_of_type_Avsz = new amvs(this);
  private bcoq jdField_a_of_type_Bcoq = new amvt(this);
  ...
  private ArrayList<aicz> jdField_c_of_type_JavaUtilArrayList;
  ...
  public amvo(QQAppInterface paramQQAppInterface)
  {
    ...
    if (this.jdField_a_of_type_Avsz != null)
    {
      ...
      if (paramQQAppInterface != null) {
        paramQQAppInterface.a(this.jdField_a_of_type_Avsz);
      }
    }
  ...
  private int a(List<RecentBaseData> paramList, int paramInt1, int paramInt2)
  {
    if (paramInt1 < 3)
    {
      ...
      if (akkk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentBaseData)) {
        break label78;
      }
      paramInt1 += 1;
      label58:
  ...
  private aicz a(oidb_0xc26.TabInfo paramTabInfo)
  {
    aicz localaicz = new aicz();
    localaicz.jdField_a_of_type_Int = paramTabInfo.uint32_tab_id.get();
    localaicz.jdField_b_of_type_Int = paramTabInfo.uint32_recommend_count.get();
    String str;
    if (paramTabInfo.bytes_table_name.has())
    {
      ...
      label77:
      localaicz.jdField_b_of_type_JavaLangString = str;
  ...
  private RecentRecommendTroopItem a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      paramString = (RecentUser)localanuz.findRecentUser(paramString, 8113);
      if (paramString != null)
      {
  ...
  private <T extends MayKnowRecommend> ArrayList<T> b(@NonNull ArrayList<T> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if (!localamsw.b(localMayKnowRecommend.uin))
      {
        boolean bool = localamsw.a(localMayKnowRecommend.uin, false, true);
        if (bool) {}
        for (int k = 1;; k = 0)
        {
  ...
  private void c(List<oidb_0xc26.TabInfo> paramList)
  {
    ...
    for (??? = "null";; ??? = Integer.valueOf(paramList.size()))
    {
      ...
      synchronized (this.jdField_d_of_type_JavaLangObject)
      {
        ...
        if (((aicz)localObject2).jdField_a_of_type_Int == 23) {
          ((aicz)localObject2).jdField_b_of_type_Int += c().size();
        }
  ...
  private void d(List<aicz> paramList)
  {
    for (;;)
    {
      SharedPreferences localSharedPreferences;
      ...
      synchronized (this.jdField_e_of_type_JavaLangObject)
      {
        ...
        paramList = paramList.iterator();
        if (paramList.hasNext()) {
          localJSONArray.put(aicz.a((aicz)paramList.next()));
        }
      }
  ...
  private void l()
  {
    ...
    apup localapup = apuo.a();
    StringBuilder localStringBuilder;
    if (localapup != null)
    {
      this.jdField_g_of_type_Int = localapup.jdField_a_of_type_Int;
      this.jdField_a_of_type_JavaLangString = localapup.jdField_a_of_type_JavaLangString;
      if (localapup.jdField_b_of_type_Int == 1)
      {
        bool1 = true;
    ...
    else
    {
      ...
      {
        ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(1)).notifyUI(123, true, new Object[] { Integer.valueOf(k) });
  ...
  private void n()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        c();
        localObject1 = (FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(1);
  ...
  private void o()
  {
    ...
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        d();
        ??? = (FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(1);
    ...
    synchronized (this.jdField_d_of_type_JavaLangObject)
    {
      ...
      synchronized (this.jdField_e_of_type_JavaLangObject)
      {
        ...
        try
        {
          ...
          {
            localArrayList.add(aicz.a(((JSONArray)localObject4).getJSONObject(k)));
            k += 1;
          }
  ...
  private void r()
  {
    ...
    for (;;)
    {
      ...
      synchronized (jdField_b_of_type_JavaLangObject)
      {
        ...
        ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(1)).reportMayknowRecommendExplosure(this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap);
        if (!QLog.isColorLevel()) {
          continue;
        }
  ...
  public int a()
  {
    ...
    int k = 0;
    p();
    if (!((airj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(295)).c()) {}
    for (int m = 1;; m = 0) {
      label149:
      for (;;)
      {
        synchronized (this.jdField_d_of_type_JavaLangObject)
        {
          if (this.jdField_c_of_type_JavaUtilArrayList != null)
          {
            ...
            {
              aicz localaicz = (aicz)localIterator.next();
              if ((localaicz.jdField_a_of_type_Int != 23) && (m == 0)) {
                break label149;
              }
              k = localaicz.jdField_b_of_type_Int + k;
              break label149;
            }
          }
          if (QLog.isColorLevel()) {
  ...
  public ArrayList<aicz> a()
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_d_of_type_JavaLangObject)
      {
        ...
        localaicz = aicz.a((aicz)localIterator.next());
        if (localaicz.jdField_a_of_type_Int == 23)
        {
          localaicz.jdField_a_of_type_Boolean = true;
          localArrayList.add(localaicz);
        }
      }
      localaicz.jdField_a_of_type_Boolean = bool;
    }
    if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        synchronized (this.jdField_d_of_type_JavaLangObject)
        {
          if (this.jdField_c_of_type_JavaUtilArrayList != null)
          {
            ...
            {
              aicz localaicz = (aicz)((Iterator)localObject3).next();
              if ((localaicz.equals(paramList)) && ((localaicz.jdField_b_of_type_Int != paramList.jdField_b_of_type_Int) || (!localaicz.jdField_a_of_type_JavaLangString.equals(paramList.jdField_a_of_type_JavaLangString)) || (!localaicz.jdField_b_of_type_JavaLangString.equals(paramList.jdField_b_of_type_JavaLangString)) || (!localaicz.c.equals(paramList.c))))
              {
                localaicz.jdField_b_of_type_Int = paramList.jdField_b_of_type_Int;
                localaicz.jdField_a_of_type_JavaLangString = paramList.jdField_a_of_type_JavaLangString;
                localaicz.jdField_b_of_type_JavaLangString = paramList.jdField_b_of_type_JavaLangString;
                localaicz.c = paramList.c;
                d(this.jdField_c_of_type_JavaUtilArrayList);
              }
            }
          }
  ...
  public void a(View paramView, Context paramContext, String paramString)
  {
    ...
    if ((paramString.equals("sp_uin_for_title")) && (k == 2131376108))
    {
      paramView = bjnw.a(paramContext);
      paramView.b(2131691144);
      paramView.c(2131690620);
      paramView.a(new amvq(this, paramView));
      paramView.show();
      bcef.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_ellipsis", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      return;
      if ((paramView.getTag() != null) && ((paramView.getTag() instanceof akmo)))
      {
        paramView = (akmo)paramView.getTag();
        if (paramView.a == null) {
          break;
        }
        ...
        for (paramView = (RecentRecommendTroopItem)paramView.a.mUser.extraInfo; paramView != null; paramView = null)
        {
          ...
          if (k == 2131363866)
          {
            ...
            bcef.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_add", 0, 0, paramView.uin, paramView.recomAlgol, "", "");
            return;
          }
          ...
          for (;;)
          {
            try
            {
              ...
              if (TextUtils.isEmpty(paramView.recommendReason))
              {
                ...
                bcef.b(null, "dc00899", "Grp_recom", "", "msg_tab", "clk_grp", 0, 0, paramView.uin, paramView.recomAlgol, "", "");
                return;
              }
            }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        synchronized (jdField_a_of_type_JavaLangObject)
        {
          ...
          synchronized (this.jdField_c_of_type_JavaUtilArrayList)
          {
            ...
            for (;;)
            {
              ...
              localaicz = (aicz)localIterator.next();
              label218:
              label223:
              synchronized (this.jdField_f_of_type_JavaLangObject)
              {
                ...
                {
                  if (localaicz.jdField_b_of_type_Int <= 0) {
                    break;
                  }
                  k = localaicz.jdField_b_of_type_Int - 1;
                  localaicz.jdField_b_of_type_Int = k;
                }
              }
            }
          }
        ...
        break label218;
        label253:
        Object localObject3 = (ArrayList)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(localaicz.jdField_a_of_type_Int));
        if (localObject3 != null)
        {
          ...
          if (((Iterator)localObject3).hasNext())
          {
            ...
            localaicz.jdField_b_of_type_Int -= 1;
          }
        }
      }
      label337:
  ...
  public void a(@NonNull ArrayList<MayKnowRecommend> paramArrayList)
  {
    ...
    //   1: ifnull +10 -> 11
    //   4: aload_1
    //   5: invokevirtual 336	java/util/ArrayList:isEmpty	()Z
    //   8: ifeq +30 -> 38
    //   11: invokestatic 264	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   14: ifeq +23 -> 37
    //   17: ldc_w 266
    //   20: iconst_2
    //   21: invokestatic 1321	java/util/Locale:getDefault	()Ljava/util/Locale;
    //   24: ldc_w 1323
    //   27: iconst_0
    //   28: anewarray 4	java/lang/Object
    //   31: invokestatic 1327	java/lang/String:format	(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   34: invokestatic 281	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   37: return
    //   38: aload_0
    //   39: aload_1
    //   40: invokespecial 353	amvo:b	(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    //   43: astore 4
    //   45: aload 4
    //   47: astore_3
    //   48: aload 4
    ...
    //   63: iconst_0
    //   64: sipush 1000
    //   67: invokeinterface 1331 3 0
    //   72: astore_3
    //   73: getstatic 47	amvo:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   76: astore 4
    //   78: aload 4
    //   80: monitorenter
    //   81: aload_0
    //   82: getfield 141	amvo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   85: invokevirtual 1274	java/util/ArrayList:clear	()V
    //   88: aload_0
    //   89: getfield 141	amvo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   92: aload_3
    //   93: invokevirtual 357	java/util/ArrayList:addAll	(Ljava/util/Collection;)Z
    //   96: pop
    //   97: aload 4
    //   99: monitorexit
    //   100: aload_0
    //   101: getfield 130	amvo:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   104: invokevirtual 363	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   107: astore 4
    //   109: aload 4
    //   111: invokevirtual 368	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   114: aload_0
    //   115: getfield 130	amvo:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   118: ldc_w 711
    //   121: invokevirtual 376	com/tencent/mobileqq/persistence/EntityManager:execSQL	(Ljava/lang/String;)Z
    //   124: pop
    //   125: aload_3
    //   126: invokeinterface 194 1 0
    //   131: ifle +147 -> 278
    //   134: aload_3
    //   135: invokeinterface 556 1 0
    //   140: astore_3
    //   141: aload_3
    //   142: invokeinterface 385 1 0
    //   147: ifeq +131 -> 278
    //   150: aload_0
    //   151: aload_3
    //   152: invokeinterface 389 1 0
    //   157: checkcast 391	com/tencent/mobileqq/data/MayKnowRecommend
    //   160: invokevirtual 1333	amvo:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   163: pop
    //   164: goto -23 -> 141
    //   167: astore_3
    //   168: invokestatic 264	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   171: ifeq +14 -> 185
    //   174: ldc_w 266
    //   177: iconst_2
    //   178: ldc_w 1335
    //   181: aload_3
    //   182: invokestatic 400	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   185: aload 4
    //   187: invokevirtual 403	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   190: iconst_0
    //   191: istore_2
    //   192: aload_0
    //   193: getfield 97	amvo:jdField_f_of_type_JavaLangObject	Ljava/lang/Object;
    //   196: astore_3
    //   197: aload_3
    //   198: monitorenter
    //   199: aload_0
    //   200: getfield 84	amvo:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   203: ifnull +10 -> 213
    //   206: aload_0
    //   207: getfield 84	amvo:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   210: invokevirtual 1336	java/util/HashMap:clear	()V
    //   213: aload_3
    //   214: monitorexit
    //   215: invokestatic 264	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   218: ifeq -181 -> 37
    //   221: ldc_w 266
    //   224: iconst_2
    //   225: invokestatic 1321	java/util/Locale:getDefault	()Ljava/util/Locale;
    //   228: ldc_w 1338
    //   231: iconst_3
    ...
    //   236: iconst_0
    //   237: aload_1
    //   238: invokevirtual 339	java/util/ArrayList:size	()I
    //   241: invokestatic 409	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   244: aastore
    //   245: dup
    //   246: iconst_1
    //   247: aload_0
    //   248: getfield 141	amvo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   251: invokevirtual 339	java/util/ArrayList:size	()I
    //   254: invokestatic 409	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   257: aastore
    //   258: dup
    //   259: iconst_2
    //   260: iload_2
    //   261: invokestatic 1343	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   264: aastore
    //   265: invokestatic 1327	java/lang/String:format	(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   268: invokestatic 281	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   271: return
    //   272: astore_1
    //   273: aload 4
    //   275: monitorexit
    ...
    //   277: athrow
    //   278: aload 4
    //   280: invokevirtual 419	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   283: aload 4
    //   285: invokevirtual 403	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   288: iconst_1
    //   289: istore_2
    //   290: goto -98 -> 192
    //   293: astore_1
    //   294: aload 4
    //   296: invokevirtual 403	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   299: aload_1
    //   300: athrow
    //   301: astore_1
    //   302: aload_3
  ...
  public void a(List<String> paramList, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    //   21: astore 7
    //   23: getstatic 47	amvo:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   26: astore 8
    //   28: aload 8
    //   30: monitorenter
    //   31: aload_0
    //   32: getfield 141	amvo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   35: invokevirtual 380	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   38: astore 9
    //   40: aload 9
    ...
    //   57: checkcast 391	com/tencent/mobileqq/data/MayKnowRecommend
    //   60: astore 10
    //   62: aload 10
    //   64: ifnull -24 -> 40
    //   67: aload_1
    //   68: aload 10
    //   70: getfield 618	com/tencent/mobileqq/data/MayKnowRecommend:uin	Ljava/lang/String;
    //   73: invokeinterface 1345 2 0
    //   78: ifeq -38 -> 40
    //   81: iload 6
    //   83: ifeq +39 -> 122
    //   86: aload 10
    //   88: getfield 1371	com/tencent/mobileqq/data/MayKnowRecommend:cardDisplayTimestamp	J
    //   91: lload 4
    //   93: ladd
    //   94: lload_2
    //   95: lcmp
    ...
    //   99: aload 10
    //   101: lload_2
    //   102: putfield 1371	com/tencent/mobileqq/data/MayKnowRecommend:cardDisplayTimestamp	J
    //   105: aload 7
    //   107: aload 10
    //   109: invokevirtual 627	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   112: pop
    //   113: goto -73 -> 40
    //   116: astore_1
    //   117: aload 8
    ...
    //   122: aload 10
    //   124: lload_2
    //   125: putfield 1371	com/tencent/mobileqq/data/MayKnowRecommend:cardDisplayTimestamp	J
    //   128: aload 7
    //   130: aload 10
    //   132: invokevirtual 627	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   135: pop
    //   136: goto -96 -> 40
    //   139: aload 8
    //   141: monitorexit
    //   142: aload 7
    //   144: invokevirtual 336	java/util/ArrayList:isEmpty	()Z
    //   147: ifne -134 -> 13
    //   150: aload_0
    //   151: getfield 130	amvo:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   154: invokevirtual 363	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   157: astore_1
    //   158: aload_1
    //   159: invokevirtual 368	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   162: aload 7
    //   164: invokevirtual 380	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   167: astore 7
    //   169: aload 7
    //   171: invokeinterface 385 1 0
    //   176: ifeq +47 -> 223
    //   179: aload 7
    //   181: invokeinterface 389 1 0
    //   186: checkcast 391	com/tencent/mobileqq/data/MayKnowRecommend
    //   189: astore 8
    //   191: aload 8
    //   193: ifnull -24 -> 169
    //   196: aload_0
    //   197: aload 8
    //   199: invokevirtual 1333	amvo:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   202: pop
    //   203: goto -34 -> 169
    //   206: astore 7
    //   208: ldc_w 266
    //   211: iconst_1
    //   212: ldc_w 1373
    //   215: invokestatic 1065	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   218: aload_1
    //   219: invokevirtual 403	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   222: return
    //   223: aload_1
    //   224: invokevirtual 419	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   227: aload_1
    //   228: invokevirtual 403	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   231: return
    //   232: astore 7
    //   234: aload_1
    //   235: invokevirtual 403	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   238: aload 7
    //   240: athrow
    // Local variable table:
    //   start	length	slot	name	signature
      ...
      if ((??? != null) && (!???.isEmpty()))
      {
        ...
        while (localIterator2.hasNext())
        {
          ...
          if (localRgroupInfo.uint64_group_code.has())
          {
            ...
            localRecentRecommendTroopItem.labelList = amzp.b(localRgroupInfo.rpt_group_label.get());
  ...
  public boolean a(String paramString)
  {
    ...
    {
      anuz localanuz = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a();
      paramString = (RecentUser)localanuz.findRecentUser(paramString, 8112);
      if (paramString != null)
      {
        localanuz.delRecentUser(paramString);
        return true;
    ...
    try
    {
      if (this.jdField_c_of_type_JavaUtilArrayList != null)
      {
        ...
        if (!this.jdField_c_of_type_JavaUtilArrayList.isEmpty()) {
          localObject1 = (aicz)this.jdField_c_of_type_JavaUtilArrayList.get(0);
        }
      }
      if (localObject1 != null)
      {
        localObject1 = a(((aicz)localObject1).jdField_a_of_type_Int);
        if (localObject1 != null) {
  ...
  public void b()
  {
    ...
    if (this.jdField_c_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localaicz.jdField_a_of_type_Int != 23)
        {
          a(localaicz.jdField_a_of_type_Int, new ArrayList(0), true);
          a(localaicz.jdField_a_of_type_Int, null);
        }
      }
    }
  }
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_d_of_type_JavaLangObject)
      {
        ...
        if (localIterator.hasNext())
        {
          if (((aicz)localIterator.next()).jdField_a_of_type_Int != paramInt) {
            continue;
          }
          localIterator.remove();
          k = 1;
  ...
  public void c()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        {
          anuz localanuz = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a();
          localanuz.deleteRecentUserByType(8112);
          ??? = (RecentUser)localanuz.findRecentUser(AppConstants.CONVERSATION_MAY_KNOW_FRIEND_UIN, 8111);
          if (??? != null) {
            localanuz.delRecentUser((BaseRecentUser)???);
          }
          localanuz.deleteRecentUserByType(8113);
          Object localObject2 = (RecentUser)localanuz.findRecentUser("sp_uin_for_title", 8113);
          ??? = localObject2;
          if (localObject2 == null) {
          ...
          localanuz.saveRecentUser((BaseRecentUser)???);
          ...
          ??? = (RecentUser)localanuz.findRecentUser(localRecentRecommendTroopItem.uin, 8113);
          if (??? != null) {
            break label414;
          }
  ...
  {
    ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(1)).getMayKnowRecommend(null, null, paramInt, null);
  }
  ...
  public void c(String paramString)
  {
    ...
    a(paramString);
    ((amzp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(22)).a(paramString, new amvu(this, paramString));
    ...
    if (this.jdField_e_of_type_Int == 0)
    {
      ...
      bcef.b(null, "dc00899", "Grp_recom", "", "link_top", "clk_hide", 0, 0, "", "", "", "");
    }
    paramString.putInt("sp_contacts_tab_recommend_troop_count", this.jdField_e_of_type_Int);
    paramString.commit();
    ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(1)).notifyUI(92, true, null);
  }
  ...
  public void d()
  {
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      localObject1 = (RecentUser)localanuz.findRecentUser(AppConstants.CONVERSATION_MAY_KNOW_FRIEND_UIN, 8111);
      if (localObject1 != null) {
        localanuz.delRecentUser((BaseRecentUser)localObject1);
      }
      g(8112);
      localRecentUser = (RecentUser)localanuz.findRecentUser("sp_uin_for_title", 8112);
      ...
      localanuz.saveRecentUser((BaseRecentUser)localObject1);
      Iterator localIterator = ((ArrayList)localObject2).iterator();
      if (!localIterator.hasNext()) {
        break label474;
      }
      localMayKnowRecommend = (MayKnowRecommend)localIterator.next();
      localRecentUser = (RecentUser)localanuz.findRecentUser(localMayKnowRecommend.uin, 8112);
      if (localRecentUser != null) {
        break label491;
      }
    ...
    for (;;)
    {
      ...
      break;
      g(8112);
      localRecentUser = (RecentUser)localanuz.findRecentUser(AppConstants.CONVERSATION_MAY_KNOW_FRIEND_UIN, 8111);
      if (QLog.isColorLevel()) {
  ...
  public void d(int paramInt)
  {
    if (this.jdField_b_of_type_Int != paramInt) {
      ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(1)).notifyUI(123, true, new Object[] { Integer.valueOf(paramInt) });
    }
  ...
  public void d(String paramString)
  {
    ...
    ((amzp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(22)).a(paramString, new amvp(this, paramString));
    ...
    {
      bcef.b(null, "dc00899", "Grp_recom", "", "msg_tab", "slide_delete", 0, 0, paramString, (String)localObject, "", "");
      return;
  ...
  public void e()
  {
    ...
    anuz localanuz = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a();
    g(8112);
    RecentUser localRecentUser = (RecentUser)localanuz.findRecentUser(AppConstants.CONVERSATION_MAY_KNOW_FRIEND_UIN, 8111);
    if (QLog.isColorLevel()) {
  ...
  {
    a(paramString);
    ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(1)).notifyUI(122, true, new Object[] { paramString });
  }
