  ...
  extends PopupWindow
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new atfq(this);
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private atfr jdField_a_of_type_Atfr;
  private String jdField_a_of_type_JavaLangString;
  
  public atfp(Context paramContext, int paramInt1, int paramInt2)
  {
    super(paramContext);
  ...
  {
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378512));
    this.jdField_a_of_type_AndroidWidgetTextView.getTextSize();
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363517));
    ...
    for (;;)
    {
      ...
      setBackgroundDrawable(paramContext.getResources().getDrawable(2130849549));
      return;
  ...
  public void a(atfr paramatfr)
  {
    this.jdField_a_of_type_Atfr = paramatfr;
  }
