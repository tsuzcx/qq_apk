...
{
  public akth(NewFlowCameraActivity paramNewFlowCameraActivity) {}
  ...
  public void onAnimationEnd(Animator paramAnimator)
  {
    ...
    {
      if (akrw.a == 2) {
        this.a.jdField_a_of_type_Bbuk.e();
      }
      this.a.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
      if (NewFlowCameraActivity.i(this.a))
      {
        AVCodec.get().retake();
        xvv.c("PTV.NewFlowCameraActivity", "AVCodec.get().retake() by mbRetake flag");
        NewFlowCameraActivity.i(this.a, false);
      }
      this.a.jdField_a_of_type_ComTencentMobileqqActivityRichmediaStateRMVideoStateMgr.jdField_a_of_type_Akvv.u();
      ...
      for (;;)
      {
        ...
        return;
        label235:
        this.a.jdField_a_of_type_Bbuk.c(true);
      }
    }
    if (this.a.f) {
