...
public class bgiy
  extends bgix
{
  private static CopyOnWriteArrayList<bgiz> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  ...
  private bgiz a()
  {
    ...
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 38	bgiz:<init>	(Lbgiy;)V
    //   8: astore 8
    //   10: aload 8
    //   12: aload_0
    //   13: getfield 41	bgiy:jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin	Lcom/tencent/mobileqq/webview/swift/WebViewPlugin;
    //   16: getfield 47	com/tencent/mobileqq/webview/swift/WebViewPlugin:mRuntime	Lbbac;
    //   19: invokevirtual 52	bbac:a	()Lcom/tencent/common/app/AppInterface;
    //   22: invokevirtual 58	com/tencent/common/app/AppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   25: putfield 61	bgiz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   46: aload 8
    //   48: getfield 61	bgiz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   188: aload 5
    //   190: astore 4
    //   192: getstatic 28	bgiy:jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList	Ljava/util/concurrent/CopyOnWriteArrayList;
    //   195: aload 8
    ...
    //   292: astore 4
    //   294: aload 8
    //   296: getfield 153	bgiz:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   299: aload 9
    //   301: aload 6
    ...
    //   480: astore 4
    //   482: aload 8
    //   484: getfield 153	bgiz:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   487: aload 9
    //   489: aload 6
  ...
  private boolean a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject4 = bgjx.a((Context)localObject3, (String)localObject4);
    ...
    if ("signInSuccess".equals(paramString3))
    {
      try
      {
        ...
        if (paramString3.optBoolean("shareToWX"))
        {
          ...
          bgbz.a().a().a(paramString1, paramJsBridgeListener, paramString2, paramString3);
