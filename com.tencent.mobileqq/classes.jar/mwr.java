...
{
  public mwr(StageEffectView paramStageEffectView) {}
  ...
  public int a(StageMemberView paramStageMemberView1, StageMemberView paramStageMemberView2)
  {
    ...
    paramStageMemberView1 = (mwx)paramStageMemberView1.getTag();
    paramStageMemberView2 = (mwx)paramStageMemberView2.getTag();
    if (paramStageMemberView1.a == paramStageMemberView2.a) {
      return 0;
    }
    if (mwm.a(paramStageMemberView1.a - 10000, 20000) < mwm.a(paramStageMemberView2.a - 10000, 20000)) {
      return -1;
    }
    return 1;
  }
