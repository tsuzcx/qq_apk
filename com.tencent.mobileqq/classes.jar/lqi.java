  ...
  implements lpx
{
  ...
  private void a(lox paramlox, int paramInt, FloatBuffer paramFloatBuffer)
  {
    a(paramlox.jdField_a_of_type_Int, paramlox.b, ljk.c, YUVTexture.a, paramlox.jdField_a_of_type_ArrayOfByte, this.jdField_a_of_type_Int, this.b, paramInt, lqe.a(paramlox.jdField_a_of_type_Boolean), this.jdField_a_of_type_JavaNioByteBuffer, paramFloatBuffer);
    GLES20.glViewport(0, 0, paramlox.jdField_a_of_type_Int, paramlox.b);
  }
  
  public lps a(lpl paramlpl, lox paramlox, lps paramlps)
  {
    if (paramlpl.jdField_a_of_type_Mte != null) {
      paramlpl.jdField_a_of_type_Mte.a("preRender");
    }
    int i = paramlox.jdField_a_of_type_Int * paramlox.b * 3 / 2;
    ...
    a(paramlox, paramlps.jdField_a_of_type_Int, paramlpl.jdField_a_of_type_JavaNioFloatBuffer);
    if (paramlpl.jdField_a_of_type_Mte != null) {
      paramlpl.jdField_a_of_type_Mte.b("preRender");
    }
    if (paramlpl.jdField_a_of_type_Lpn != null)
    {
      paramlpl.jdField_a_of_type_Lpn.a(9, paramlps.jdField_a_of_type_Int, paramlps.b);
      paramlpl.jdField_a_of_type_Lpn.a(paramlpl, 1, paramlox, paramlps);
    }
    return paramlps;
  }
  ...
  {
    return (paramlox != null) && (paramlox.jdField_a_of_type_ArrayOfByte != null) && (paramlox.jdField_a_of_type_ArrayOfByte.length > 0);
  }
