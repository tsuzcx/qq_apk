...
public class bmbl
{
  ...
  public bmbl a()
  {
    bmbl localbmbl = new bmbl();
    localbmbl.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.putAll(this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap);
    return localbmbl;
  }
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    bmbh.d = a("land_page", paramJSONObject.optString("land_page_id", bmbh.d));
    bmbh.b = a("obj_ownerid", paramJSONObject.optString("obj_ownerid", bmbh.b));
    bmbh.g = a("algo_id", paramJSONObject.optString("algo_id", "0"));
  }
  ...
  public void b(JSONObject paramJSONObject)
  {
    ...
    bmbh.a = a("mod", paramJSONObject.optString("mod_18", bmbh.a));
    bmbh.e = a("obj_pos", paramJSONObject.optString("obj_pos_14", bmbh.e));
    bmbh.f = a("detailpage_from", paramJSONObject.optString("detailpage_from_45", bmbh.f));
  }
