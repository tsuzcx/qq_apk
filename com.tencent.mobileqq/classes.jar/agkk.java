  ...
  implements agki
{
  ...
  public android.content.Intent a(long paramLong, int paramInt)
  {
    ...
    //   29: aload_0
    //   30: getfield 15	agkk:a	Landroid/os/IBinder;
    //   33: iconst_5
    //   34: aload 5
    //   36: aload 6
    //   38: iconst_0
  ...
  public android.content.Intent a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    //   36: aload_0
    //   37: getfield 15	agkk:a	Landroid/os/IBinder;
    //   40: bipush 9
    //   42: aload 6
    //   44: aload 7
    //   46: iconst_0
  ...
  public MessageForShortVideo a(long paramLong)
  {
    ...
    //   20: invokevirtual 35	android/os/Parcel:writeLong	(J)V
    //   23: aload_0
    //   24: getfield 15	agkk:a	Landroid/os/IBinder;
    //   27: bipush 14
    //   29: aload 4
    //   31: aload 5
    //   33: iconst_0
  ...
  public void a(int paramInt, boolean paramBoolean, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    //   61: aload_0
    //   62: getfield 15	agkk:a	Landroid/os/IBinder;
    //   65: bipush 23
    //   67: aload 8
    //   69: aconst_null
    //   70: iconst_1
  ...
  public void a(long paramLong, int paramInt, android.os.Bundle paramBundle)
  {
    ...
    //   31: aload_0
    //   32: getfield 15	agkk:a	Landroid/os/IBinder;
    //   35: bipush 16
    //   37: aload 5
    //   39: aconst_null
    //   40: iconst_1
  ...
  public void a(agkl paramagkl)
  {
    ...
    try
    {
      localParcel.writeInterfaceToken("com.tencent.mobileqq.activity.aio.photo.IAIOImageProvider");
      if (paramagkl != null) {
        localIBinder = paramagkl.asBinder();
      }
      localParcel.writeStrongBinder(localIBinder);
      this.a.transact(4, localParcel, null, 1);
      return;
    }
    catch (RemoteException paramagkl)
    {
      if (QLog.isColorLevel()) {
        QLog.e("IAIOImageProvider", 2, paramagkl.getMessage(), paramagkl);
      }
      return;
    }
    finally
