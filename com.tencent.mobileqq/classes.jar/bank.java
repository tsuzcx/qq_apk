  ...
  implements bdzj, INetEventHandler
{
  ...
  alsi jdField_a_of_type_Alsi = new banl(this);
  ...
  public bank(batw parambatw, baub parambaub)
  {
  ...
  private bawy a()
  {
    ...
    localbawy.jdField_e_of_type_JavaLangString = this.jdField_a_of_type_Baub.jdField_d_of_type_JavaLangString;
    ...
    {
      localbawy.jdField_c_of_type_Int = localMessageForPtt.voiceType;
      localbawy.jdField_a_of_type_Int = localMessageForPtt.voiceLength;
      localbawy.jdField_e_of_type_Int = localMessageForPtt.autoToText;
    }
  ...
  public static byte[] a(MessageForPtt paramMessageForPtt)
  {
    ...
    localReserveStruct.uint32_redpack_type.set(ajat.a(paramMessageForPtt));
    ...
    paramMessageForPtt = ajat.a(paramMessageForPtt);
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 89	bank:jdField_a_of_type_Baub	Lbaub;
    //   6: iconst_1
    //   7: putfield 364	baub:l	Z
    //   10: aload_0
    //   11: getfield 89	bank:jdField_a_of_type_Baub	Lbaub;
    //   14: getfield 124	baub:jdField_a_of_type_ComTencentMobileqqDataMessageRecord	Lcom/tencent/mobileqq/data/MessageRecord;
    ...
    //   31: aload_0
    //   32: getfield 366	bank:jdField_a_of_type_Boolean	Z
    //   35: ifne +18 -> 53
    //   38: aload_0
    //   39: invokespecial 368	bank:d	()I
    //   42: ifne +8 -> 50
    //   45: aload_0
    //   46: iconst_0
    //   47: invokespecial 370	bank:b	(Z)V
    //   50: aload_0
    //   51: monitorexit
    //   52: return
    //   53: aload_0
    //   54: invokespecial 368	bank:d	()I
    //   57: ifne -7 -> 50
    //   60: aload_0
    //   61: iconst_1
    //   62: invokespecial 370	bank:b	(Z)V
    //   65: goto -15 -> 50
    //   68: astore_1
    //   69: aload_0
    //   70: monitorexit
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        this.jdField_a_of_type_Bamy.a(this.k);
        this.jdField_b_of_type_Bamy.a(this.k);
      }
      ...
      if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null)) {
        this.jdField_a_of_type_JavaUtilHashMap.put("param_pttOpt", String.valueOf(awtk.a((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get())));
      }
      ...
      bark.a(paramBoolean, this.jdField_a_of_type_Baub.jdField_a_of_type_Int, l2, this.q);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Baub.i))
      {
        localObject1 = (MessageForPtt)this.jdField_a_of_type_Baub.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
        localObject2 = this.jdField_a_of_type_Baub.i;
        ...
        l1 = 0L;
        label447:
        bark.a((String)localObject2, true, paramBoolean, i, l1);
      }
      if (!paramBoolean) {
        break label539;
      }
      b(true, l2);
      azmz.a(BaseApplication.getContext()).a(null, b(), true, l2, this.q, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
    for (;;)
    {
      l();
      ...
      b(false, l2);
      azmz.a(BaseApplication.getContext()).a(null, b(), false, l2, this.q, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
  }
  ...
  {
    super.aS_();
    if (!this.jdField_a_of_type_Baub.l)
    {
      if (bdze.a(this.jdField_a_of_type_Baub.i, this)) {
        try
        {
  ...
  protected im_msg_body.RichText b()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Baub.jdField_a_of_type_Int == 0)
      {
        ...
        ((im_msg_body.Ptt)localObject1).uint64_src_uin.set(Long.parseLong(this.jdField_a_of_type_Baub.jdField_b_of_type_JavaLangString));
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
        {
          localObject2 = (basp)this.jdField_a_of_type_JavaUtilArrayList.get(0);
          ((im_msg_body.Ptt)localObject1).uint32_server_ip.set(bapa.a(((basp)localObject2).jdField_a_of_type_JavaLangString));
          ((im_msg_body.Ptt)localObject1).uint32_server_port.set(((basp)localObject2).jdField_a_of_type_Int);
        }
        localObject2 = new im_msg_body.Elem();
        Object localObject3 = new im_msg_body.ElemFlags2();
        if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null))
        {
          i = ayvy.a((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get(), ((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get()).getCurrentAccountUin());
        ...
        localObject3 = b((MessageForPtt)this.jdField_a_of_type_Baub.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
      ...
      if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null))
      {
        ...
        i = ayvy.a((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get(), (String)localObject2);
        ((im_msg_body.TmpPtt)localObject1).uint32_user_type.set(i);
      }
      ((im_msg_body.TmpPtt)localObject1).uint64_ptt_times.set(QQRecorder.a(this.jdField_a_of_type_Baub.jdField_a_of_type_ComTencentMobileqqDataMessageRecord));
      if (this.jdField_a_of_type_Baub.jdField_a_of_type_Int == 1008) {
        ((im_msg_body.TmpPtt)localObject1).uint32_busi_type.set(3);
      }
      Object localObject2 = a((MessageForPtt)this.jdField_a_of_type_Baub.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
  ...
  void d()
  {
    ...
    if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null) && (this.jdField_a_of_type_Baub.jdField_n_of_type_Boolean)) {
      awud.a((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get()).a(a());
    }
  }
  ...
  public void d(boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        localMessageRecord = ((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get()).a().a(this.jdField_a_of_type_Baub.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Baub.jdField_a_of_type_Int, this.jdField_a_of_type_Baub.jdField_a_of_type_Long);
      ...
      if (!this.jdField_a_of_type_Baub.jdField_n_of_type_Boolean) {
        localMessageForPtt.url = MessageForPtt.getMsgFilePath(localMessageForPtt.voiceType, this.jdField_a_of_type_Baub.i);
      }
      ...
      if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null)) {
        ((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get()).a().a(this.jdField_a_of_type_Baub.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Baub.jdField_a_of_type_Int, localMessageRecord.uniseq, localMessageForPtt.msgData);
      }
    } while ((this.jdField_a_of_type_MqqUtilWeakReference == null) || (this.jdField_a_of_type_MqqUtilWeakReference.get() == null) || (localMessageRecord == null) || (!(localMessageRecord instanceof MessageForPtt)) || (!((azwd)((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get()).getManager(17)).b((MessageForPtt)localMessageRecord)));
    azmj.b(null, "dc00898", "", "", "0X8009DF6", "0X8009DF6", 0, 0, "", "", "", "");
    ((azwa)((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get()).getManager(17)).a((MessageForPtt)localMessageRecord, 2);
  }
  ...
  void f()
  {
    ...
    do
    {
      ...
      if (localObject1 == null)
      {
        a(9360, "constructpberror", null, this.jdField_c_of_type_Bamy);
        d();
        return;
      }
      if (this.jdField_a_of_type_Baub.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) {
    ...
    if (ajat.a(localMessageRecord))
    {
      localObject2 = ajat.a();
      alsi localalsi = this.jdField_a_of_type_Alsi;
      byte[] arrayOfByte = this.jdField_a_of_type_ArrayOfByte;
      if (this.f == null) {}
      for (localObject1 = this.jdField_l_of_type_JavaLangString;; localObject1 = this.f)
      {
        ((ajat)localObject2).a(localMessageRecord, localalsi, 0L, arrayOfByte, (String)localObject1, this);
        return;
      }
    }
    ((QQAppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get()).a().b(localMessageRecord, this.jdField_a_of_type_Alsi);
  }
  ...
  public void g()
  {
    ...
    do
    {
      ...
      try
      {
        localObject2 = localbawy.jdField_d_of_type_JavaLangString;
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          {
            continue;
            localException.str_dst_phonenum.set(localbawy.jdField_d_of_type_JavaLangString);
            i = 102;
            continue;
            i = 104;
            continue;
      ...
      ((cmd0x346.ExtensionReq)localObject1).uint32_ptt_format.set(localbawy.jdField_c_of_type_Int);
      ((cmd0x346.ExtensionReq)localObject1).uint32_ptt_time.set(localbawy.jdField_a_of_type_Int);
      j = bawa.a();
      ((cmd0x346.ExtensionReq)localObject1).uint32_net_type.set(j);
      ((cmd0x346.ExtensionReq)localObject1).uint32_voice_type.set(localbawy.jdField_d_of_type_Int);
      if (QLog.isColorLevel())
      {
