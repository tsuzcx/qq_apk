...
public class bank
  implements baxz
{
  public bank(AddedRobotView paramAddedRobotView) {}
    ...
    for (;;)
    {
      ...
      if (!AddedRobotView.a(this.a).a())
      {
        ...
        while (paramInt1 < paramInt2)
        {
          ...
          if ((localObject instanceof bann))
          {
            localObject = (bann)localObject;
            if ((!TextUtils.isEmpty(((bann)localObject).jdField_a_of_type_JavaLangString)) && (((bann)localObject).jdField_a_of_type_JavaLangString.equals(paramString))) {
              ((bann)localObject).jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(paramBitmap);
            }
          }
          else
          {
