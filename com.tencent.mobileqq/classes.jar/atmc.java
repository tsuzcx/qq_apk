...
{
  private static WeakReference<atmc> jdField_a_of_type_JavaLangRefWeakReference;
  private int jdField_a_of_type_Int;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver;
  private MediaPlayer jdField_a_of_type_AndroidMediaMediaPlayer;
  SurfaceHolder jdField_a_of_type_AndroidViewSurfaceHolder = null;
  atmm jdField_a_of_type_Atmm;
  ...
  public static atmc a()
  {
    atmc localatmc1 = null;
    if (jdField_a_of_type_JavaLangRefWeakReference != null) {
      localatmc1 = (atmc)jdField_a_of_type_JavaLangRefWeakReference.get();
    }
    atmc localatmc2 = localatmc1;
    if (localatmc1 == null)
    {
      localatmc2 = new atmc();
      jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(localatmc2);
    }
    return localatmc2;
  }
      ...
      do
      {
        do
        {
          ...
          try
          {
            ...
            throw new NullPointerException(anni.a(2131703387));
          }
  ...
  public String a()
  {
    return atvo.a(this.jdField_a_of_type_JavaLangString);
  }
  ...
  public void a(String paramString, atmf paramatmf)
  {
    ThreadManager.executeOnSubThread(new FileViewMusicService.1(this, paramString, paramatmf));
  }
  ...
  public boolean a(String paramString)
  {
    ...
    //   1: istore_2
    //   2: aload_0
    //   3: getfield 128	atmc:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   6: ifnull +22 -> 28
    //   9: aload_0
    //   10: getfield 128	atmc:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   13: invokevirtual 220	android/media/MediaPlayer:stop	()V
    //   16: aload_0
    //   17: getfield 128	atmc:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   20: invokevirtual 223	android/media/MediaPlayer:release	()V
    //   23: aload_0
    //   24: aconst_null
    //   25: putfield 128	atmc:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   28: aload_0
    //   29: new 132	android/media/MediaPlayer
    //   32: dup
    //   33: invokespecial 224	android/media/MediaPlayer:<init>	()V
    //   36: putfield 128	atmc:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   39: aload_0
    //   40: getfield 128	atmc:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   43: aload_0
    //   44: invokevirtual 228	android/media/MediaPlayer:setOnCompletionListener	(Landroid/media/MediaPlayer$OnCompletionListener;)V
    //   47: aload_0
    //   48: getfield 128	atmc:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   51: aload_0
    //   52: invokevirtual 232	android/media/MediaPlayer:setOnErrorListener	(Landroid/media/MediaPlayer$OnErrorListener;)V
    //   55: aload_0
    //   56: getfield 128	atmc:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   59: aload_0
    //   60: invokevirtual 236	android/media/MediaPlayer:setOnPreparedListener	(Landroid/media/MediaPlayer$OnPreparedListener;)V
    //   63: aload_0
    //   64: getfield 128	atmc:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   67: iconst_0
    //   68: invokevirtual 240	android/media/MediaPlayer:setLooping	(Z)V
    //   71: aload_0
    //   72: aconst_null
    //   73: putfield 58	atmc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   95: astore_3
    //   96: aload_0
    //   97: getfield 128	atmc:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   100: iconst_3
    //   101: invokevirtual 251	android/media/MediaPlayer:setAudioStreamType	(I)V
    //   104: aload 4
    //   106: astore_3
    //   107: aload_0
    //   108: getfield 128	atmc:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   111: aload 4
    ...
    //   122: aload_0
    //   123: iconst_0
    //   124: putfield 56	atmc:c	Z
    //   127: aload 4
    //   129: astore_3
    //   130: aload_0
    //   131: iconst_0
    //   132: putfield 54	atmc:jdField_b_of_type_Boolean	Z
    //   135: aload 4
    //   137: astore_3
    //   138: aload_0
    //   139: iconst_0
    //   140: putfield 188	atmc:jdField_a_of_type_Int	I
    //   143: aload 4
    //   145: astore_3
    //   146: aload_0
    //   147: iconst_0
    //   148: putfield 190	atmc:d	Z
    //   151: aload 4
    //   153: astore_3
    //   154: aload_0
    //   155: getfield 177	atmc:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   168: dup
    //   169: aload_0
    //   170: invokespecial 264	atme:<init>	(Latmc;)V
    //   173: putfield 177	atmc:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   176: aload 4
    //   178: astore_3
    ...
    //   205: aload_0
    //   206: getfield 177	atmc:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   209: aload 5
    ...
    //   217: astore_3
    //   218: aload_0
    //   219: getfield 128	atmc:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    ...
    //   235: aload_0
    //   236: aload_1
    //   237: putfield 58	atmc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   240: iconst_1
    //   241: istore_2
    //   242: iload_2
    //   243: ireturn
    ...
    //   258: astore_3
    //   259: aload_0
    //   260: getfield 196	atmc:jdField_a_of_type_Atmm	Latmm;
    //   263: ifnull +16 -> 279
    //   266: aload 4
    //   268: astore_3
    //   269: aload_0
    //   270: getfield 196	atmc:jdField_a_of_type_Atmm	Latmm;
    //   273: aconst_null
    ...
    //   345: astore_3
    //   346: aload_0
    //   347: getfield 196	atmc:jdField_a_of_type_Atmm	Latmm;
    //   350: ifnull +16 -> 366
    //   353: aload 4
    //   355: astore_3
    //   356: aload_0
    //   357: getfield 196	atmc:jdField_a_of_type_Atmm	Latmm;
    //   360: aconst_null
    ...
    //   432: astore_3
    //   433: aload_0
    //   434: getfield 196	atmc:jdField_a_of_type_Atmm	Latmm;
    //   437: ifnull +16 -> 453
    //   440: aload 4
    //   442: astore_3
    //   443: aload_0
    //   444: getfield 196	atmc:jdField_a_of_type_Atmm	Latmm;
    //   447: aconst_null
    ...
    //   526: astore_3
    //   527: aload_0
    //   528: getfield 196	atmc:jdField_a_of_type_Atmm	Latmm;
    //   531: ifnull +21 -> 552
    //   534: aload 4
    //   536: astore_3
    //   537: aload_0
    //   538: getfield 196	atmc:jdField_a_of_type_Atmm	Latmm;
    //   541: ldc_w 300
    //   544: invokestatic 78	anni:a	(I)Ljava/lang/String;
  ...
  public void onCompletion(MediaPlayer paramMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_Atmm != null) {
      this.jdField_a_of_type_Atmm.aB_();
    }
    if (this.jdField_a_of_type_AndroidContentBroadcastReceiver != null)
    {
      BaseApplicationImpl.getContext().unregisterReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver);
  ...
  public boolean onError(MediaPlayer paramMediaPlayer, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Atmm != null) {
      this.jdField_a_of_type_Atmm.a(anni.a(2131703385));
    }
    this.jdField_a_of_type_AndroidMediaMediaPlayer.release();
    this.jdField_a_of_type_AndroidMediaMediaPlayer = null;
    this.jdField_a_of_type_JavaLangString = null;
