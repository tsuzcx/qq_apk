  ...
  extends akmj
{
  ...
  akoh(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  protected void a(LocalMediaInfo paramLocalMediaInfo, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Akmi.f)
    {
      ...
      PhotoUtils.sendPhoto(this.mActivity, localIntent, this.mPhotoCommonData.selectedPhotoList, 0, this.jdField_a_of_type_Akmi.jdField_a_of_type_Boolean);
      return;
    }
    if (!this.jdField_a_of_type_Akmi.g)
    {
    ...
    for (;;)
    {
      ...
      if ((100 == paramInt) || (102 == paramInt) || (103 == paramInt)) {
        if (100 == paramInt)
        {
          ...
          localIntent.putExtra("PhotoConst.EDIT_MASK_SHAPE_TYPE", akln.c(paramInt));
      ...
      for (;;)
      {
        AlbumUtil.putRecordLastPosData(localIntent, this.mPhotoCommonData.albumId, str, this.jdField_a_of_type_Akmi.isRecodeLastAlbumPath);
  ...
  public void caseVideo(View paramView, int paramInt)
  {
    ...
    if (!this.jdField_a_of_type_Akmi.jdField_b_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        MediaScanner.getInstance(BaseApplicationImpl.getContext()).queryMediaInfoAsync(new akoi(this, paramView, (ArrayList)localObject2), (LocalMediaInfo)localObject1);
        return;
      }
