  ...
  extends akhz
{
  ...
  public ajyo(ContactsInnerFrame paramContactsInnerFrame, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      localView = ajzy.a(paramViewGroup, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater, 2131562629);
    }
    ajzy localajzy = (ajzy)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
      ...
      ajzy.a(this, localajzy, localPhoneContact);
      if (paramInt - 1 < 0)
      {
        paramView = null;
        ...
        localajzy.d.setVisibility(0);
        localajzy.d.setText(localPhoneContact.mobileNo);
        label188:
        localajzy.b.setText(localPhoneContact.name);
        if (!this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b(localajzy.jdField_a_of_type_JavaLangString)) {
          break label394;
        }
        localajzy.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(true);
        label228:
        ...
        localajzy.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(false);
        label271:
        if ((AppSetting.c) && (localajzy.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
        {
          if (!localajzy.jdField_a_of_type_AndroidWidgetCheckBox.isChecked()) {
            break label418;
          }
          localView.setContentDescription(localPhoneContact.name + alud.a(2131702949));
        }
      }
      for (;;)
      {
        localajzy.jdField_a_of_type_ComTencentMobileqqDataPhoneContact = localPhoneContact;
        ...
        break label134;
        label381:
        localajzy.d.setVisibility(8);
        break label188;
        label394:
        localajzy.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
        break label228;
        label406:
        localajzy.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(true);
        break label271;
        label418:
        localView.setContentDescription(localPhoneContact.name + alud.a(2131702921));
      }
    }
    localajzy.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
    localajzy.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    paramView = String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[i]);
    localajzy.jdField_a_of_type_AndroidWidgetTextView.setText(paramView);
    localajzy.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(String.format(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberContactsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131691954), new Object[] { paramView.toLowerCase() }));
    return localView;
  }
}
