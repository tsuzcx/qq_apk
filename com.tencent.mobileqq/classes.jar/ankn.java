  ...
  extends LinearLayout
{
  ...
  public ankn(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener)
  {
    super(paramContext);
  ...
  private void a()
  {
    ...
    if (i < this.b)
    {
      View localView = LayoutInflater.from(getContext()).inflate(2130970708, null);
      ...
      for (;;)
      {
        ...
        ((ImageView)localView.findViewById(2131371658)).setPadding(k, k, k, k);
        addView(localView);
        i += 1;
        break;
        if (this.b - 1 == i) {
  ...
  private void a(InfomationFacePackage.Item paramItem, URLImageView paramURLImageView, QIMCommonLoadingView paramQIMCommonLoadingView, ProgressBar paramProgressBar, ankr paramankr)
  {
    Object localObject1 = (QIMInformationPasterManager)QIMManager.a().c(12);
    Object localObject2 = QIMInformationPasterManager.b();
    ...
    for (;;)
    {
      localObject1 = new File((File)localObject2, (String)localObject1);
      if (QLog.isColorLevel()) {
        QLog.d("InformationFaceAdapter", 2, "apng file name:" + ((File)localObject1).getAbsolutePath());
      }
      localObject2 = ((File)localObject1).getAbsolutePath();
      if (!((File)localObject1).exists()) {
        break;
      }
      paramItem = VasApngUtil.a(BaseApplicationImpl.sApplication.getRuntime(), ((File)localObject1).getAbsolutePath(), "-Dynamic-", URLDrawableHelper.a, new int[] { 13 }, "-Dynamic-", null);
      if (paramItem != null)
      {
        if (paramItem.getStatus() != 1) {
          paramItem.restartDownload();
        }
        if (paramItem.getStatus() == 1) {
          paramankr.onLoadSuccessed(paramURLImageView, paramItem);
        }
        paramURLImageView.setImageDrawable(paramItem);
      }
      return;
      ((File)localObject2).mkdirs();
    }
    ...
    localHttpNetReq.jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$INetEngineListener = new anko(this, paramQIMCommonLoadingView, paramURLImageView, (String)localObject2, paramankr);
    localHttpNetReq.jdField_a_of_type_JavaLangString = str;
    if (QLog.isColorLevel()) {
      QLog.d("InformationFaceAdapter", 2, "apng url:" + str);
    }
    localHttpNetReq.jdField_a_of_type_Int = 0;
    localHttpNetReq.jdField_c_of_type_JavaLangString = ((File)localObject1).getAbsolutePath();
  ...
  public void a(InfomationFacePackage paramInfomationFacePackage, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localObject3 = ((View)localObject1).findViewById(2131371657);
      localURLImageView = (URLImageView)((View)localObject1).findViewById(2131371658);
      localObject2 = (ProgressBar)((View)localObject1).findViewById(2131371660);
      localQIMCommonLoadingView = (QIMCommonLoadingView)((View)localObject1).findViewById(2131371659);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        localObject1 = new ankr((String)localObject1, localURLImageView, (ProgressBar)localObject2);
        ...
        if ((this.jdField_a_of_type_AndroidContentContext instanceof EditPicActivity))
        {
          ...
          if (localObject2 != null)
          {
            ...
            if (((URLDrawable)localObject2).getStatus() == 1) {
              ((ankr)localObject1).onLoadSuccessed(localURLImageView, (URLDrawable)localObject2);
            }
        ...
        {
          a((InfomationFacePackage.Item)paramInfomationFacePackage.a.get(paramInt2), localURLImageView, localQIMCommonLoadingView, (ProgressBar)localObject2, (ankr)localObject1);
        }
      }
    }
  }
