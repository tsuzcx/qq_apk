...
public class sok
  extends nmy
{
  public sok(PublicAccountImageCollectionMainActivity paramPublicAccountImageCollectionMainActivity) {}
  ...
  public void a(sow paramsow)
  {
    ...
    PublicAccountImageCollectionMainActivity.a(this.a, paramsow);
    if (paramsow == null)
    {
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      nol.a(null, this.a.jdField_a_of_type_JavaLangString, "0X8007B97", "0X8007B97", 0, 0, this.a.b, this.a.c, "" + i, "", false);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean, ArrayList<soz> paramArrayList)
  {
    if (QLog.isColorLevel()) {
  ...
  public void a(boolean paramBoolean, sow paramsow, byte[] paramArrayOfByte, String paramString)
  {
    ...
    if (paramBoolean) {
      if ((paramString != null) && (!paramString.equals(this.a.b)))
      {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.pubaccount.video.PublicAccountArticleObserver", 2, "onGetPhotoCollectionInfoRespond isSuccess=" + paramBoolean + " ;articleID = " + paramsow.jdField_a_of_type_JavaLangString);
          }
          PublicAccountImageCollectionPreloadManager.a().a(paramsow, paramArrayOfByte);
          PublicAccountImageCollectionPreloadManager.a().b(paramsow);
        }
        if ((paramsow == null) || (paramsow.jdField_a_of_type_JavaUtilArrayList == null)) {
          break label308;
        }
      }
    }
    label308:
    for (int i = paramsow.jdField_a_of_type_JavaUtilArrayList.size();; i = 0)
    {
      nol.a(null, this.a.jdField_a_of_type_JavaLangString, "0X8007B8A", "0X8007B8A", 0, 0, this.a.b, this.a.c, "" + PublicAccountImageCollectionMainActivity.b(this.a, PublicAccountImageCollectionMainActivity.a(this.a)), "" + i, false);
      return;
      PublicAccountImageCollectionMainActivity.a(this.a, paramsow);
      if (paramsow == null)
      {
