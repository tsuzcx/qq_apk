  ...
  implements View.OnTouchListener
{
  ...
  {
    this.a.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839571);
    this.a.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(2130839571));
    if (this.a.c)
    {
      bafw.a(this.a);
