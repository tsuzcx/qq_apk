  ...
  extends BaseAdapter
{
  ...
  public bqxl(Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      localObject = new bqxm(paramView);
      paramView.setTag(localObject);
    }
    for (;;)
    {
      ((bqxm)localObject).a((zlk)this.jdField_a_of_type_JavaUtilList.get(paramInt), this.jdField_a_of_type_Zlk);
      localObject = ((bqxm)localObject).a;
      EventCollector.getInstance().onListGetView(paramInt, paramView, paramViewGroup, getItemId(paramInt));
      return localObject;
      localObject = (bqxm)paramView.getTag();
    }
  }
}
