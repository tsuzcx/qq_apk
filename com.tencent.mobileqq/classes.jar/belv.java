...
public class belv
  extends BaseAdapter
{
  public belv(GridListView paramGridListView) {}
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new belt(null));
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    if (this.a.jdField_a_of_type_Int == 0) {
      return this.a.jdField_a_of_type_Belu.getItemViewType(paramInt) + 2;
    }
    return 1;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      belt localbelt = (belt)paramView.getTag();
      ...
      paramViewGroup = localbelt.a[paramInt];
      int k = this.a.jdField_a_of_type_Belu.b(j + paramInt);
      if ((paramViewGroup != null) && (((Integer)paramViewGroup.getTag(2131361822)).intValue() != k)) {
        paramViewGroup = null;
      }
      for (;;)
      {
        View localView = this.a.jdField_a_of_type_Belu.getView(j + paramInt, paramViewGroup, paramView);
        localView.setTag(2131361822, Integer.valueOf(k));
        localbelt.a[paramInt] = localView;
        ...
        if ((this.a.jdField_a_of_type_Bhqp != null) && (this.a.jdField_a_of_type_Belu.isEnabled(j + paramInt)))
        {
        ...
        i = this.a.jdField_a_of_type_Belu.a(paramInt) + 2;
        ...
        paramView = this.a.jdField_a_of_type_Belu.getView(paramInt, (View)localObject, paramViewGroup);
        paramView.setTag(2131361822, Integer.valueOf(i));
        if ((this.a.jdField_a_of_type_Bhqp != null) && (this.a.jdField_a_of_type_Belu.isEnabled(paramInt)))
        {
