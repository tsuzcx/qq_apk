  ...
  extends bhqr
{
  ...
  private final bhqu jdField_a_of_type_Bhqu = new bhqu(this);
  @Nullable
  ...
  private final void a(bhrg parambhrg)
  {
    ThreadManagerV2.executeOnSubThread((Runnable)new DynamicDrawable.loadAndRefresh.1(this, parambhrg));
  }
  ...
  {
    paramDrawable.setCallback((Drawable.Callback)this.jdField_a_of_type_Bhqu);
  ...
  public final void a()
  {
    bhrg localbhrg = bhrj.a();
    Intrinsics.checkExpressionValueIsNotNull(localbhrg, "loader");
    if (!localbhrg.a())
    {
  ...
  {
    Drawable localDrawable = this.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
    if ((localDrawable != null) && (bhrc.a(localDrawable))) {
      bhrc.a().a(localDrawable);
    }
