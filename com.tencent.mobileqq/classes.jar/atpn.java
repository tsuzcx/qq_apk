  ...
  extends atpj
{
  ...
  String b()
  {
    ...
    {
      localObject = new atqd();
      ((atqd)localObject).jdField_b_of_type_Int = this.jdField_b_of_type_Int;
      ((atqd)localObject).d = this.d;
      ((atqd)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
      ((atqd)localObject).f = this.f;
      localObject = axwd.a((atqd)localObject, n, null);
      if (localObject == null) {
        break label129;
      }
    ...
    Object localObject = axwd.a(this, n, null);
    if (localObject != null) {
      return ((URL)localObject).toString();
    }
    label129:
