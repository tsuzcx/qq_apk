  ...
  implements afrc, Handler.Callback
{
  ...
  final ayeo jdField_a_of_type_Ayeo = new atpo(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = amtj.a(2131718242);
  }
  
  public atpn(BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new atpr(this);
  ...
  private AbsStructMsg a()
  {
    ...
    return bchh.a(localIntent.getByteArrayExtra("stuctmsg_bytes"));
  }
  ...
  public static QQCustomDialog a(Activity paramActivity, QQCustomDialog paramQQCustomDialog, BaseChatPie paramBaseChatPie, long paramLong, int paramInt, String paramString)
  {
    ...
    String str = ((QQAppInterface)localObject).getApplication().getString(2131718238);
    if (paramString != null) {}
    for (paramString = str + paramString;; paramString = str)
    {
      str = ((QQAppInterface)localObject).getApplication().getString(2131718244);
      localObject = ((QQAppInterface)localObject).getApplication().getString(2131718239);
      atpp localatpp = new atpp(paramLong, paramInt, paramActivity);
      atpq localatpq = new atpq(paramLong, paramInt, paramActivity, paramBaseChatPie);
      paramBaseChatPie = paramQQCustomDialog;
      if (paramQQCustomDialog == null) {
        paramBaseChatPie = bfur.a(paramActivity, 232, null, str, paramString, (String)localObject, localatpp, localatpq);
      }
      paramBaseChatPie.setNegativeButton(paramString, localatpq);
      paramBaseChatPie.setPositiveButton((String)localObject, localatpp);
      try
      {
  ...
  public static oidb_cmd0xb77.ReqBody a(Bundle paramBundle, String paramString1, String paramString2, oidb_cmd0xb77.ImageInfo paramImageInfo, long paramLong)
  {
    ...
    if (i == 0)
    {
      ...
      {
        paramBundle = str1;
        if (str1.contains(amtj.a(2131703935))) {
          paramBundle = str1.replace(amtj.a(2131703962), "");
        }
  ...
  public static void a(long paramLong, int paramInt, Activity paramActivity)
  {
    ...
    npn.a((QQAppInterface)localObject1, "", "choose", paramLong, paramInt, "stay");
    bhvw.a().a(((QQAppInterface)localObject1).getAccount(), "", String.valueOf(paramLong), "1000", "52", "0", false);
  ...
  public static void a(long paramLong, int paramInt, Activity paramActivity, BaseChatPie paramBaseChatPie)
  {
    ...
    npn.a(localQQAppInterface, "", "choose", paramLong, paramInt, "back");
    bhvw.a().a(localQQAppInterface.getAccount(), "", String.valueOf(paramLong), "1000", "51", "0", false);
    npn.a(paramActivity, 0, "", "");
  ...
  public static void a(Bundle paramBundle, int paramInt, long paramLong, boolean paramBoolean)
  {
    if ((paramBundle != null) && (paramBundle.getBoolean("forward_mini_program_ark_from_sdk", false))) {
      bcef.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "dc00898", "", "", "0X8009F7C", "0X8009F7C", 0, 0, "1", "", "", "");
    }
    if (paramBundle != null) {}
    for (;;)
    {
      ...
      try
      {
        ...
        {
        default: 
          bibc.a().a(0, "SHARE_TO_QQ", ((QQAppInterface)localObject).getCurrentAccountUin(), String.valueOf(paramLong), String.valueOf(i), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, null);
          if (paramInt != 1) {
            break label348;
          }
          str1 = "1";
      ...
      {
        localObject = "0";
        localbhvw.a(str4, "", str5, "10", "12", (String)localObject, str1, str3, str2, false);
        if (paramBoolean) {
  ...
  private void a(Bundle paramBundle, String paramString1, String paramString2)
  {
    ...
    nmb.a(paramString2, new atpu(this, paramBundle), paramString1.toByteArray(), "OidbSvc.0xb77_9", 2935, 9, localBundle, 0L);
  }
  
  private void a(ayeo paramayeo, AbsStructMsg paramAbsStructMsg)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    Object localObject = new WeakReference(paramayeo);
    ...
    paramayeo = this.jdField_a_of_type_AndroidOsBundle.getString("uin");
    ...
    localObject = (ayeo)((WeakReference)localObject).get();
    ...
    AbsShareMsg.sendSdkShareMessageByServer(localQQAppInterface, (AbsShareMsg)paramAbsStructMsg, paramayeo, i, str, (ayeo)localObject);
  }
  ...
  public static boolean a()
  {
    apzj localapzj = apzk.a();
    if (localapzj != null) {}
    for (boolean bool = localapzj.a();; bool = false)
    {
  ...
  private static void b(Bundle paramBundle, int paramInt, long paramLong)
  {
    ...
    int i = paramBundle.getInt("uintype");
    bcef.b(null, "dc00898", "", "", "0X800B2DB", "0X800B2DB", 0, 0, String.valueOf(paramLong), ForwardUtils.reqTypeToReportData(paramInt), ForwardUtils.toType(i), str);
  }
  ...
  private void c(String paramString)
  {
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        nmy.a().jdField_a_of_type_Boolean = true;
        acvv.b(localQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, localSessionInfo, paramString);
        return;
      }
  ...
  private void e()
  {
    ...
    if (this.jdField_a_of_type_AndroidOsBundle != null)
    {
      ...
      {
        localObject = bchh.a(this.jdField_a_of_type_AndroidOsBundle);
  ...
  private void f()
  {
    ...
    {
      this.jdField_a_of_type_AndroidContentBroadcastReceiver = new atpt(this);
  ...
  protected void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    paramString1 = new atps(this, paramInt, paramString2);
    this.jdField_b_of_type_ComTencentMobileqqUtilsQQCustomDialog.setPositiveButton(2131694201, paramString1);
    ...
    for (boolean bool = ((Bundle)localObject).getBoolean("share_send_msg_by_server", false);; bool = false)
    {
      ...
      if (bool)
      {
        ...
        if ((localObject instanceof AbsShareMsg))
        {
          ...
          bcef.b(null, "dc00898", "", "", "0X8009C93", "0X8009C93", 0, 0, String.valueOf(this.jdField_a_of_type_AndroidOsBundle.getLong("req_share_id")), str1, str2, paramIntent);
          d();
          a(this.jdField_a_of_type_Ayeo, (AbsStructMsg)localObject);
        }
      }
      do
      {
      ...
      localObject = atmp.a((String)localObject);
