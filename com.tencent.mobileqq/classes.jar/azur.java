  ...
  implements XmlSerializer
{
  ...
  public azur(AbsStructMsg paramAbsStructMsg, XmlSerializer paramXmlSerializer)
  {
  ...
  public XmlSerializer text(String paramString)
  {
    if (paramString != null) {
      try
      {
        XmlSerializer localXmlSerializer = this.jdField_a_of_type_OrgXmlpullV1XmlSerializer.text(azah.a(paramString, false));
