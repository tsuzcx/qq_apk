  ...
  implements Handler.Callback
{
  ...
  public bcfs(Activity paramActivity)
  {
  ...
  private static Pair<Integer, Integer> a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      if (paramString.isHierarchical())
      {
        ...
        if ((!TextUtils.isEmpty(paramString)) && (mvs.a().l(paramString)))
        {
          ...
          if (!paramString.contains("cmshow")) {
            i = m - (int)muc.a(BaseApplicationImpl.getApplication(), 54.0F);
          }
        }
      }
    }
  ...
  private String a()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.a != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.a.size() > 1))
    {
      ...
      {
        localObject = (bgje)((AppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null).getAppRuntime("modular_web")).getManager(213);
        ArrayList localArrayList = new ArrayList();
        localArrayList.add("1113.100803");
        this.jdField_a_of_type_JavaUtilMap = ((bgje)localObject).a(localArrayList);
      }
      if (this.jdField_a_of_type_JavaUtilMap == null) {
        break label244;
      }
  ...
  public static void a(WebView paramWebView, String paramString1, String paramString2)
  {
    ...
    for (localObject = "";; localObject = bchd.a(paramString2))
    {
  ...
  private void c()
  {
    ...
    {
      String str = a();
      if ((!TextUtils.isEmpty(str)) && (bcgq.a(str)) && (!str.contains("asyncMode=3")) && (!str.contains("sonic=1"))) {
  ...
  public Object a(String paramString, Bundle paramBundle)
  {
    ...
    paramString = bdle.a().a(paramBundle);
    if (paramString != null)
    {
      paramString = paramString.d;
      Bundle localBundle = new Bundle();
      localBundle.putString(bdlb.b, paramBundle);
      localBundle.putString(bdlb.j, paramString);
      ...
      localBundle.putString(bdlb.m, "_" + paramBundle);
      bdkx.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, localBundle, "biz_src_yyb", null, 0);
      return paramBundle;
    }
    ...
    if ("cancelDownloadTask".equals(paramString))
    {
      ...
      if (!bdkx.a(paramString)) {
        return Boolean.valueOf(false);
      }
      bdkx.a(paramString, "_" + paramString, true);
    ...
    {
      paramString = paramBundle.getString("download_id");
      paramBundle = bdle.a().a(paramString);
      if ((paramBundle == null) || (paramBundle.a() != 4)) {
        return Boolean.valueOf(false);
      }
      paramBundle = new Bundle();
      paramBundle.putString(bdlb.b, paramString);
      paramBundle.putInt(bdlb.k, 5);
      paramBundle.putBoolean(bdlb.r, false);
      paramBundle.putBoolean(bdlb.x, false);
      bdkx.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, paramBundle, "biz_src_yyb", null, 0);
      return Boolean.valueOf(true);
    }
    if ("notifyQBiconShine".equals(paramString))
    {
      paramString = (bcfx)this.jdField_a_of_type_Bceh.a().a(2);
      if (paramString != null)
      {
        paramString.jdField_a_of_type_Bcga.x = true;
    ...
    for (;;)
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_ComTencentMobileqqAppBrowserAppInterface != null) && (i != 0)) {
        if ("CN".equals(Locale.getDefault().getCountry())) {
          if (TbsDownloader.needDownload(BaseApplication.getContext(), false, false, new bcft(this)))
          {
            if (QLog.isColorLevel()) {
      ...
      label438:
      label445:
      for (localObject1 = (bcfo)this.jdField_a_of_type_Bceh.a().a(-2);; localObject1 = null)
      {
        if (((localObject1 == null) || (!((bcfo)localObject1).i)) && (!QLog.isColorLevel())) {
          break label448;
        }
        ...
        {
          if ((localObject1 == null) || (!((bcfo)localObject1).i)) {
            break;
          }
        ...
        for (;;)
        {
          axqy.b(null, "P_CliOper", "BizTechReport", "", "web", (String)localObject1, 0, 1, j, "", "", "", "");
          return;
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      paramBundle = (arpf)paramBundle.getPluginEngine().a("x5");
    } while (paramBundle == null);
    paramBundle.a();
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (Object localObject = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getWebView();; localObject = null)
    {
      if (localObject != null)
      {
        localObject = (arpf)((CustomWebView)localObject).getPluginEngine().a("x5");
        if (localObject != null) {
          ((arpf)localObject).a(paramInt, paramString);
        }
      }
      return;
    }
      ...
      for (;;)
      {
        ...
        catch (Throwable paramBundle)
        {
          try
          {
            ...
            QLog.d("SwiftBrowserTBSHandler", 1, "handle stgw time, requestTime: " + localObject4 + "s, responseTime: " + (String)localObject3 + "s, url: " + nau.b(localObject5, new String[0]));
            return;
          }
          catch (Throwable paramBundle)
          {
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = bdle.a().a("801097412");
        if ((localObject == null) || (!bbfj.h(BaseApplicationImpl.getApplication()))) {
          break;
        }
        ...
        if (paramBoolean)
        {
          ...
          bcql.a(BaseApplicationImpl.getApplication(), 2, paramString, 0).b(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.b());
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfx.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      ThreadManager.post(new SwiftBrowserTBSHandler.6(this), 8, null, true);
      paramString = new bcfu(this);
      localObject = new bcfv(this);
      if (!bbfj.h(BaseApplicationImpl.getApplication())) {
        break label351;
      }
      this.jdField_a_of_type_MqqOsMqqHandler.sendMessage(this.jdField_a_of_type_MqqOsMqqHandler.obtainMessage(102));
      if (!paramBoolean) {
    ...
    for (paramString = BaseApplicationImpl.getApplication().getResources().getString(2131689504);; paramString = BaseApplicationImpl.getApplication().getResources().getString(2131689510))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfx.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      return;
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfx.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
      break;
    }
    label351:
    if (paramBoolean)
    {
      Drawable localDrawable = BaseApplicationImpl.getApplication().getResources().getDrawable(2130843547);
      this.jdField_a_of_type_AndroidAppDialog = bbdj.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, localDrawable, BaseApplicationImpl.getApplication().getResources().getString(2131689503), " ", BaseApplicationImpl.getApplication().getResources().getString(2131690573), BaseApplicationImpl.getApplication().getResources().getString(2131689502), paramString, (View.OnClickListener)localObject);
    ...
    for (paramString = paramString.getString("icon_url", null);; paramString = null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfx.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      return;
      this.jdField_a_of_type_AndroidAppDialog = bbdj.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, BaseApplicationImpl.getApplication().getResources().getString(2131689509), 2131690573, 2131689502, paramString, (View.OnClickListener)localObject);
      this.jdField_a_of_type_AndroidAppDialog.show();
      this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfx.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      return;
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        if (paramMessage != null)
        {
          ...
          if ((localObject1 != null) && (((String)localObject1).length() != 0))
          {
            ...
            aoyd.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, (String)localObject1, paramMessage);
          }
        }
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfx.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
        return true;
      ...
      Object localObject1 = (ImageView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131378621);
      ((ImageView)localObject1).setImageDrawable(null);
      ((ImageView)localObject1).setImageDrawable(paramMessage);
      return true;
      paramMessage = (String)paramMessage.obj;
    } while ((this.jdField_a_of_type_AndroidAppDialog == null) || (!this.jdField_a_of_type_AndroidAppDialog.isShowing()) || (paramMessage == null));
    ((TextView)this.jdField_a_of_type_AndroidAppDialog.findViewById(2131378623)).setText(paramMessage);
    return true;
  }
}
