...
{
  public wnu(PublicView paramPublicView, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramView.setId(2131367506);
      paramViewGroup = new wnw();
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (wnw)paramView.getTag();
    }
    ...
    for (;;)
    {
      ...
      {
        localObject = this.a.getResources().getDrawable(2130839766);
