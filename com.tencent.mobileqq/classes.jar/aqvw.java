  ...
  extends MSFServlet
{
  ...
  private void a(aqvq paramaqvq, oidb_0xdea.GetBarrageListRspBody paramGetBarrageListRspBody)
  {
    ...
    paramaqvq.a(aqvp.a().a(localList1, paramaqvq.jdField_a_of_type_Aqvo.b)).b(localList2).a(m).b(n).c(k).a(bool).a();
  }
  
  void a(aqvq paramaqvq)
  {
    if (paramaqvq == null)
    {
      if (QLog.isColorLevel()) {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("DanmuDataHolder", 2, "request called, param:" + paramaqvq.a());
    }
    Object localObject = new oidb_0xdea.GetBarrageListReqBody();
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint64_group_code.set(paramaqvq.jdField_a_of_type_Aqvo.b);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint64_barrage_seq.set(paramaqvq.jdField_a_of_type_Aqvo.jdField_a_of_type_Long);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_last_update_time.set(paramaqvq.jdField_a_of_type_Int);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_start_index.set(paramaqvq.e);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_barrage_count.set(paramaqvq.f);
    int i;
    if ((paramaqvq.jdField_a_of_type_Aqvo.jdField_a_of_type_Int == 101) || (paramaqvq.jdField_a_of_type_Aqvo.jdField_a_of_type_Int == 103))
    {
      i = 1;
      if (i == 0) {
        break label327;
      }
      ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_video_start_time.set(paramaqvq.jdField_c_of_type_Int);
      ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_video_end_time.set(paramaqvq.jdField_d_of_type_Int);
      label182:
      ((oidb_0xdea.GetBarrageListReqBody)localObject).terminal.set(0);
      switch (paramaqvq.jdField_a_of_type_Aqvo.jdField_a_of_type_Int)
      {
      }
    }
    for (;;)
    {
      ...
      localObject = aqvp.a().a();
      NewIntent localNewIntent = new NewIntent(((QQAppInterface)localObject).getApp(), aqvw.class);
      localNewIntent.putExtra("KEY_SEND_DATA", localReqBody.toByteArray());
      localNewIntent.putExtra("KEY_GROUP_UIN", paramaqvq.jdField_a_of_type_Aqvo.b);
      localNewIntent.putExtra("KEY_TOPIC_UIN", paramaqvq.jdField_a_of_type_Aqvo.jdField_a_of_type_Long);
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if ((l1 == 0L) || (l2 == 0L))
    {
      ...
      for (;;)
      {
        aqvy.a(bool1, i, -1, false, "onReceive, topicUin:0, groupUin:0");
        return;
        bool1 = false;
      }
    }
    paramIntent = aqvp.a().a(l2, l1);
    aqvq localaqvq = aqvp.a().a(paramIntent);
    if (localaqvq == null)
    {
      if (QLog.isColorLevel()) {
      ...
      {
        aqvy.a(bool1, i, -1, false, "onReceive, holder null");
        return;
      }
    }
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      {
        bool2 = true;
        int j = localaqvq.jdField_a_of_type_Aqvo.jdField_a_of_type_Int;
        if (!bool1) {
          break label379;
        }
        paramIntent = "DanmuRsp Valid";
        label246:
        aqvy.a(bool2, i, j, bool1, paramIntent);
        if (!bool1) {
          break label395;
        }
        paramFromServiceMsg = localaqvq.jdField_a_of_type_Aqvu;
        aqvo localaqvo = localaqvq.jdField_a_of_type_Aqvo;
        bool2 = localaqvq.jdField_a_of_type_Boolean;
        i = localaqvq.b;
        if (!localaqvq.jdField_a_of_type_Aqvo.jdField_a_of_type_Boolean) {
          break label386;
        }
        paramIntent = localaqvq.jdField_c_of_type_JavaUtilList;
        label305:
        paramFromServiceMsg.a(localaqvo, true, bool2, i, (ArrayList)paramIntent, localaqvq.jdField_a_of_type_JavaUtilList);
        localaqvq.jdField_a_of_type_Aqvo.jdField_a_of_type_Boolean = true;
      }
      for (;;)
      {
        if ((!bool1) || (localaqvq.jdField_a_of_type_Boolean)) {
          break label424;
        }
        if (QLog.isColorLevel()) {
        ...
        break label246;
        label386:
        paramIntent = localaqvq.jdField_d_of_type_JavaUtilList;
        break label305;
        label395:
        localaqvq.jdField_a_of_type_Aqvu.a(localaqvq.jdField_a_of_type_Aqvo, false, localaqvq.jdField_a_of_type_Boolean, localaqvq.b, null, null);
      }
      label424:
      break;
    }
