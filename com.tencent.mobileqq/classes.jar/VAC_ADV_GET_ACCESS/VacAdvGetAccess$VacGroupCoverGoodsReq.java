  ...
  extends MessageMicro<VacGroupCoverGoodsReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 32, 40, 50, 56 }, new String[] { "ware_house_id", "media_type", "content_id", "content_type", "product_id_list", "product_list", "seller_id" }, new Object[] { Integer.valueOf(100), localInteger, "", localInteger, localLong, null, localLong }, VacGroupCoverGoodsReq.class);
  }
}
