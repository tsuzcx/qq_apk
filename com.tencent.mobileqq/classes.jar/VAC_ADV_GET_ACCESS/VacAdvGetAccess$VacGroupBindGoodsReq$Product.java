...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26 }, new String[] { "product_id", "index", "production_token" }, new Object[] { Long.valueOf(0L), Long.valueOf(0L), "" }, Product.class);
