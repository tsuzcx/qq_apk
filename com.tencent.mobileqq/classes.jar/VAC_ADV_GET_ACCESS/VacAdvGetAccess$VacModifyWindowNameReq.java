  ...
  extends MessageMicro<VacModifyWindowNameReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34, 42 }, new String[] { "ware_house_id", "media_type", "content_type", "content_id", "content_name" }, new Object[] { Integer.valueOf(100), localInteger, localInteger, "", "" }, VacModifyWindowNameReq.class);
  }
}


/* Location:           L:\local\mybackup\temp\qq_apk\com.tencent.mobileqq\classes.jar
 * Qualified Name:     VAC_ADV_GET_ACCESS.VacAdvGetAccess.VacModifyWindowNameReq
