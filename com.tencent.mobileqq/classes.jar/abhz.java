...
public class abhz
  implements aqup
{
  public abhz(GesturePWDCreateActivity paramGesturePWDCreateActivity) {}
  ...
  public void a(List<aquo> paramList)
  {
    ...
    do
    {
      ...
      if ((paramList != null) && (paramList.size() >= 3))
      {
        ...
        this.a.jdField_a_of_type_AndroidWidgetTextView.setText(2131692984);
      ...
      bcpw.a(this.a, 1, this.a.getString(2131693004), 0).b(this.a.getTitleBarHeight());
      ...
      axqw.b(this.a.app, "CliOper", "", "", "Setting_tab", "Gesture_password", 0, 1, "", "", "", "");
      bcpw.a(this.a, 2, this.a.getString(2131692986), 0).b(this.a.getTitleBarHeight());
    ...
    bcpw.a(this.a, 1, this.a.getString(2131692985), 0).b(this.a.getTitleBarHeight());
  }
