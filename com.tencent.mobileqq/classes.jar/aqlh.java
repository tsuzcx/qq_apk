  ...
  extends aqlg
{
  ...
  public aqlh(Reader paramReader, int paramInt)
  {
  ...
  public final aqle a()
  {
    ...
    for (;;)
    {
      ...
      return new aqle(new String(this.jdField_a_of_type_ArrayOfChar, 0, k), n, k + n, this.jdField_a_of_type_JavaLangString);
      label700:
      m = i1;
    }
  }
