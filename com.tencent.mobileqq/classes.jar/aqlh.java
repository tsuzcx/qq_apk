...
public class aqlh
{
  ...
  public static aqlh a()
  {
    if (jdField_a_of_type_Aqlh == null) {}
    try
    {
      if (jdField_a_of_type_Aqlh == null) {
        jdField_a_of_type_Aqlh = new aqlh();
      }
      return jdField_a_of_type_Aqlh;
    }
    finally {}
  }
  
  private aqli a(String paramString)
  {
  ...
  private void a(aqli paramaqli)
  {
    if (paramaqli.jdField_a_of_type_Int != 0) {
      return;
    }
    for (;;)
    {
      try
      {
        int i = Integer.valueOf(paramaqli.jdField_a_of_type_JavaLangString).intValue();
        Object localObject1 = "conf_" + paramaqli.jdField_a_of_type_Long + "_sharepref";
        Object localObject2 = "conf_" + paramaqli.jdField_a_of_type_Long + "_content_sharepref";
        ...
        int j = ((SharedPreferences)localObject3).getInt(paramaqli.jdField_a_of_type_JavaLangString, -1);
        ...
        {
          ((SharedPreferences.Editor)localObject1).remove(paramaqli.jdField_a_of_type_JavaLangString);
          ...
          if (bool1)
          {
            ...
            if (j != -1)
            {
              ...
              if (localObject1 != null)
              {
                ...
                ((SharedPreferences.Editor)localObject1).putLong(paramaqli.jdField_a_of_type_JavaLangString, l);
          ...
          QLog.d("QConfigJourney", 2, "deleteSpConf, entry=" + paramaqli + ", success=" + bool2);
          return;
        }
      }
      catch (NumberFormatException paramaqli)
      {
        return;
      }
      boolean bool1 = false;
  ...
  private void a(aqli paramaqli, SharedPreferences.Editor paramEditor)
  {
    Object localObject1 = null;
    if (paramaqli.jdField_a_of_type_Int != 2) {}
    boolean bool2;
    label125:
    do
    {
      ...
      if (localObject2 != null)
      {
        str = paramaqli.jdField_a_of_type_Int + "-" + paramaqli.jdField_a_of_type_JavaLangString + "-" + paramaqli.jdField_a_of_type_Long;
    ...
    QLog.d("QConfigJourney", 2, "deleteStorage, entry=" + paramaqli + ", path=" + (String)localObject1 + ", success=" + bool2);
  }
  ...
  private void b(aqli paramaqli)
  {
    if (paramaqli.jdField_a_of_type_Int != 1) {}
    for (;;)
    {
      return;
      try
      {
        ...
        String str = this.jdField_a_of_type_JavaLangString + File.separator + "qstore" + File.separator + paramaqli.jdField_a_of_type_Long + File.separator + "conf" + File.separator + i;
        ...
        if (bool1)
        {
          localObject2 = "conf_" + paramaqli.jdField_a_of_type_Long + "_sharepref";
          localObject1 = a((String)localObject2);
          localObject2 = a((String)localObject2);
          j = ((SharedPreferences)localObject1).getInt(paramaqli.jdField_a_of_type_JavaLangString, -1);
          if ((j != -1) && (localObject2 != null)) {
            ((SharedPreferences.Editor)localObject2).remove(paramaqli.jdField_a_of_type_JavaLangString + "_" + j + "_defualt");
          }
          if (localObject2 != null) {
            ((SharedPreferences.Editor)localObject2).remove(paramaqli.jdField_a_of_type_JavaLangString);
          }
          localObject1 = a("q_journey_safe_mode_deleted_confs_pref");
          if (localObject1 != null)
          {
        ...
        if (QLog.isColorLevel())
        {
          QLog.d("QConfigJourney", 2, "deleteFileConf, entry=" + paramaqli + ", path=" + str + ", success=" + bool1);
          return;
        }
      }
      catch (NumberFormatException paramaqli) {}
  ...
  void a(int paramInt, long paramLong, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      aqli localaqli = new aqli(i, String.valueOf(paramInt), paramLong, null);
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        this.jdField_a_of_type_JavaUtilSet.add(localaqli);
  ...
  void a(String arg1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      try
      {
        paramString2 = new aqli(2, ???, Long.valueOf(paramString2).longValue(), paramString3);
      }
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (paramBoolean)
        {
          ...
          localObject4 = (aqli)((Iterator)localObject3).next();
          String str = ((aqli)localObject4).jdField_a_of_type_Int + "-" + ((aqli)localObject4).jdField_a_of_type_JavaLangString + "-" + ((aqli)localObject4).jdField_a_of_type_Long;
          if (((aqli)localObject4).jdField_a_of_type_Int == 2) {
            localEditor.putString(str, ((aqli)localObject4).b);
          }
  ...
  boolean a(String paramString1, String paramString2, String paramString3)
  {
    ...
    //   1: astore 6
    //   3: aload_1
    //   4: invokestatic 93	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   7: ifne +138 -> 145
    //   10: aload_3
    //   11: invokestatic 93	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   14: ifne +131 -> 145
    //   17: aload_2
    //   18: invokestatic 116	java/lang/Long:valueOf	(Ljava/lang/String;)Ljava/lang/Long;
    //   21: invokevirtual 120	java/lang/Long:longValue	()J
    //   24: lstore 4
    //   26: aload_0
    //   27: ldc 249
    //   29: invokespecial 55	aqlh:a	(Ljava/lang/String;)Landroid/content/SharedPreferences;
    //   32: astore_2
    ...
    //   63: astore_1
    //   64: aload_0
    //   65: getfield 40	aqlh:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    ...
    //   86: astore_1
    //   87: aload_0
    //   88: getfield 40	aqlh:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    ...
    //   107: astore_1
    //   108: aload_0
    //   109: getfield 40	aqlh:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    ...
    //   128: astore_1
    //   129: aload_0
    //   130: getfield 40	aqlh:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
      ...
      for (;;)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject3))
        {
          ...
          for (;;)
          {
            ...
            {
              aqli localaqli = a((String)((Iterator)localObject4).next());
              if (localaqli != null)
              {
                ((Set)localObject3).add(localaqli);
                continue;
          ...
          {
            localObject4 = (aqli)((Iterator)localObject3).next();
            if (((aqli)localObject4).jdField_a_of_type_Int == 0) {
              a((aqli)localObject4);
            } else if (((aqli)localObject4).jdField_a_of_type_Int == 1) {
              b((aqli)localObject4);
            } else {
              a((aqli)localObject4, localEditor);
            }
          }
        }
      }
  ...
  void b(String paramString1, String paramString2, String paramString3)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokestatic 93	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   4: ifne +156 -> 160
    //   7: aload_3
    //   8: invokestatic 93	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   11: ifne +149 -> 160
    //   14: aload_2
    //   15: invokestatic 116	java/lang/Long:valueOf	(Ljava/lang/String;)Ljava/lang/Long;
    //   18: invokevirtual 120	java/lang/Long:longValue	()J
    //   21: lstore 4
    //   23: aload_0
    //   24: ldc 249
    //   26: invokespecial 55	aqlh:a	(Ljava/lang/String;)Landroid/content/SharedPreferences;
    //   29: astore_2
    ...
    //   73: ifeq +87 -> 160
    //   76: aload_2
    //   77: invokeinterface 61 1 0
    //   82: astore_2
    //   83: aload_0
    //   84: getfield 40	aqlh:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    ...
    //   111: pop
    //   112: aload_0
    //   113: getfield 40	aqlh:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    //   116: invokeinterface 422 1 0
    //   121: invokeinterface 394 1 0
    //   126: return
    //   127: astore_1
    //   128: aload_0
    //   129: getfield 40	aqlh:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
    //   132: invokeinterface 422 1 0
    //   137: invokeinterface 394 1 0
    //   142: return
    //   143: astore_1
    //   144: aload_0
    //   145: getfield 40	aqlh:jdField_a_of_type_JavaUtilConcurrentLocksReadWriteLock	Ljava/util/concurrent/locks/ReadWriteLock;
