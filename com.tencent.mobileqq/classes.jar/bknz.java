...
public class bknz
{
  ...
  public bknz(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    this.b = paramInt1;
    this.c = paramInt2;
    this.d = paramInt3;
  ...
  public void a(Canvas paramCanvas, Paint paramPaint, bknu parambknu)
  {
    ...
    paramPaint.setColor(parambknu.b);
    paramPaint.setStrokeWidth(parambknu.e);
    paramCanvas.drawLine(this.b, this.d, this.c, this.d, paramPaint);
    parambknu = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (parambknu.hasNext())
    {
      Point localPoint = (Point)parambknu.next();
