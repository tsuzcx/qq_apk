...
public class bkhw
{
  private static bkhw jdField_a_of_type_Bkhw;
  private long jdField_a_of_type_Long = -1L;
  
  public static bkhw a()
  {
    if (jdField_a_of_type_Bkhw == null) {}
    try
    {
      if (jdField_a_of_type_Bkhw == null) {
        jdField_a_of_type_Bkhw = new bkhw();
      }
      return jdField_a_of_type_Bkhw;
    }
    finally {}
  }
  ...
  public void a(MobileCommConf paramMobileCommConf)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        } while (bhtl.a(BaseApplicationImpl.getApplication(), str));
        localArrayList.add(str);
      } while (localArrayList.size() < paramMobileCommConf.maxScanNum);
    } while (localArrayList.size() <= 0);
    this.jdField_a_of_type_Long = l;
    a(this.jdField_a_of_type_Long);
    paramMobileCommConf = new NewIntent(BaseApplicationImpl.getApplication(), bkhy.class);
    try
    {
