...
public class bkhw
{
  ...
  public static void a(Context paramContext, bkhz parambkhz)
  {
    ...
    {
      if (parambkhz != null) {
        parambkhz.a(localFile1.getAbsolutePath(), localFile2.getAbsolutePath());
      }
      return;
    }
    String str2 = bkib.a(123L);
    String str1 = str2 + "weiyunLibrary.zip";
    str2 = str2 + "sizeLibrary.txt";
    bkgl.a().a(b, str1, "SoHelper", new bkhx(str2, str1, parambkhz, paramContext, localFile1, localFile2));
  }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    paramContext = bkhv.a(paramContext, "0", "key_local_so_version");
