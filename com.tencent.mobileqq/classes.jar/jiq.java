...
public class jiq
  implements Runnable
{
  public jiq(VideoNodeReporter paramVideoNodeReporter, long paramLong) {}
  ...
  public void run()
  {
    ...
    {
      jir localjir = (jir)((Iterator)localObject).next();
      if (this.jdField_a_of_type_Long == localjir.jdField_a_of_type_Long) {
