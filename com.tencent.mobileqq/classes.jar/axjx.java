...
public class axjx
{
  ...
  private List<axkc> jdField_a_of_type_JavaUtilList;
  ...
  public axjx(String paramString, int paramInt)
  {
  ...
  private axjx a(axkc paramaxkc)
  {
    if (paramaxkc != null) {
      this.jdField_a_of_type_JavaUtilList.add(paramaxkc);
    }
  ...
  private void a(StringBuilder paramStringBuilder, int paramInt)
  {
    ...
    while (paramInt < m)
    {
      if ((paramStringBuilder.charAt(paramInt) == '<') && (paramInt < k - 2))
      {
        ...
        if ((i == 36) && (paramInt < k - 3))
        {
          ...
          for (;;)
          {
            ...
            a(new axka(paramStringBuilder.substring(paramInt, paramInt + 4), i, n));
            paramInt += 4;
            break;
            if (j == 10) {
          ...
          if ((j >= 255) && (paramInt + 6 < k))
          {
            if (paramStringBuilder.charAt(paramInt + 6) == '>')
            {
              ...
              a(new axkb(paramStringBuilder.substring(paramInt, paramInt + 7), j, n));
              i = 2;
              if (i < 5)
              {
          ...
          else if (j == 250)
          {
            ...
            a(new axka(paramStringBuilder.substring(paramInt, paramInt + 4), 10, n));
            paramInt += 4;
          }
        }
        else if (((i == 37) || (i == 38)) && (paramInt < k - 6))
        {
          a(new axjz(paramStringBuilder.substring(paramInt, paramInt + 7)));
          paramInt += 7;
        }
      }
      else
      {
        ...
        {
          a(new axjw(paramStringBuilder.substring(paramInt, paramInt + 2)));
          paramInt += 2;
          continue;
        }
        a(new axjy(String.valueOf(paramStringBuilder.charAt(paramInt))));
      }
      label637:
      paramInt += 1;
    }
  ...
  public axjx a(int paramInt)
  {
    axjx localaxjx = new axjx();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
    {
      axkc localaxkc = (axkc)localIterator.next();
      if (localaxkc.a() == paramInt) {
        localaxjx.a(localaxkc);
      }
    }
    return localaxjx;
  }
  ...
  @NonNull
  public axkc a(int paramInt)
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return (axkc)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    }
  ...
  public String a()
  {
    ...
    {
      axkc localaxkc = (axkc)localIterator.next();
      if ((localaxkc.a() == 0) || (localaxkc.a() == 1)) {
        localStringBuilder.append(localaxkc.a());
      }
    }
    return localStringBuilder.toString();
  }
  
  public axjx b(int paramInt)
  {
    axjx localaxjx = new axjx();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
  ...
  public String b()
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      localStringBuilder.append(((axkc)localIterator.next()).a());
    }
    return localStringBuilder.toString();
  }
