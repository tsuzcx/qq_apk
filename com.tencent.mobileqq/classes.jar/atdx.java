...
public class atdx
{
  ...
  public atdx(QQAppInterface paramQQAppInterface)
  {
  ...
  private WeiyunPB.CrossBidProxyCopyFileToOtherBidMsgReq a(FileManagerEntity paramFileManagerEntity, long paramLong)
  {
    ...
    if (paramFileManagerEntity.strFileSHA != null) {
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_sha.set(blhj.a(paramFileManagerEntity.strFileSHA));
    }
    if (paramFileManagerEntity.strFileMd5 != null) {
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_md5.set(blhj.a(paramFileManagerEntity.strFileMd5));
    }
    ...
    if (paramFileManagerEntity.WeiYunDirKey != null) {
      localCrossBidProxyCopyFileToOtherBidMsgReq.src_pdir_key.set(blhj.a(paramFileManagerEntity.WeiYunDirKey));
    }
    ...
    if (paramFileManagerEntity.tmpSessionType > 0L)
    {
      ...
      paramFileManagerEntity.tmpSessionSig = aszt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity.peerUin, (int)paramFileManagerEntity.tmpSessionType);
  ...
  private String a(String paramString1, String paramString2, int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      localPair = blew.a(paramString2, paramInt, paramBoolean);
      localFile = new File(blew.b(), Long.toString(((Long)localPair.second).longValue()));
    ...
    paramString1 = new ateh(this, paramString1, paramInt, paramObject);
    blfu.a().a((String)((Pair)localPair.first).first, paramString2, (String)((Pair)localPair.first).second, paramString1);
    return null;
  }
  
  private void a(FileManagerEntity paramFileManagerEntity, becp parambecp, String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      return;
      long l1 = 0L;
      int i = aszt.a(parambecp.jdField_a_of_type_JavaLangString);
      Object localObject;
      long l2;
      if ((FileUtil.isFileExists(parambecp.jdField_a_of_type_JavaLangString)) && ((i == 0) || (i == 2))) {
        if (i == 0)
        {
          localObject = new BitmapFactory.Options();
          ((BitmapFactory.Options)localObject).inJustDecodeBounds = true;
          BitmapFactory.decodeFile(parambecp.jdField_a_of_type_JavaLangString, (BitmapFactory.Options)localObject);
          l2 = bfby.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, parambecp.g, parambecp.c, parambecp.jdField_a_of_type_JavaUtilUUID.toString(), paramInt2, Long.toString(parambecp.b), paramFileManagerEntity.nSessionId, ((BitmapFactory.Options)localObject).outWidth, ((BitmapFactory.Options)localObject).outHeight);
          paramFileManagerEntity = localTroopFileTransferManager.a(parambecp.jdField_a_of_type_JavaUtilUUID);
          l1 = l2;
      ...
      {
        afoa.a().a(l1, 0L, paramInt1);
        return;
        if (i == 2)
        {
          localObject = ShortVideoUtils.getVideoFileRtAndTime(parambecp.jdField_a_of_type_JavaLangString);
          l2 = bfby.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, parambecp.g, parambecp.c, parambecp.jdField_a_of_type_JavaUtilUUID.toString(), paramInt2, Long.toString(parambecp.b), paramFileManagerEntity.nSessionId, localObject[0], localObject[1], localObject[2]);
          paramFileManagerEntity = localTroopFileTransferManager.a(parambecp.jdField_a_of_type_JavaUtilUUID);
          l1 = l2;
          if (paramFileManagerEntity != null)
          {
            ...
            l1 = l2;
            continue;
            l1 = bfby.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, paramFileManagerEntity.fileName, paramFileManagerEntity.fileSize, parambecp.jdField_a_of_type_JavaUtilUUID.toString(), paramInt2, Long.toString(8888L), paramFileManagerEntity.nSessionId);
          }
        }
      }
    }
  ...
  private void a(WeiyunPB.AioPicAndVideoCopyToWeiyunMsgReq paramAioPicAndVideoCopyToWeiyunMsgReq, atek paramatek)
  {
    bleg.a();
    blfm.a(paramAioPicAndVideoCopyToWeiyunMsgReq, new ateg(this, paramatek));
  }
  ...
  private boolean a(WeiyunPB.WeiyunShareAddFromMobileQQMsgReq paramWeiyunShareAddFromMobileQQMsgReq, FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (i == 2)
    {
      ...
      if (!TextUtils.isEmpty(paramFileManagerEntity.WeiYunDirKey)) {
        paramWeiyunShareAddFromMobileQQMsgReq.file.pdir_key.set(blhj.a(paramFileManagerEntity.WeiYunDirKey));
      }
      bool = true;
    }
    label111:
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          paramFileManagerEntity = bfby.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity);
  ...
  private void b()
  {
    if (!blhf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()))
    {
      if (NetworkUtils.isWifiAvailable(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()))
      {
        this.c = true;
        blhf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), new atei(this));
      }
      return;
    }
    this.b = true;
    blei.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), true);
    WeiyunTransmissionGlobal.getInstance().getUploadManager().loadLibFromPath(blhf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()).getAbsolutePath());
  }
  
  public atep a(FileManagerEntity paramFileManagerEntity, Object paramObject, blgh paramblgh)
  {
    if (paramFileManagerEntity == null) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      localPair = asdm.a(paramFileManagerEntity.WeiYunFileId);
      if (localPair != null) {
        break;
      }
    } while (!QLog.isColorLevel());
    ...
    if (paramFileManagerEntity.nWeiYunSrcType == 2) {
      paramFileManagerEntity = blfu.a().a(paramFileManagerEntity.strLargeThumPath, paramFileManagerEntity.strThumbPath, paramFileManagerEntity.WeiYunDirKey, paramFileManagerEntity.WeiYunFileId, paramblgh);
    }
    label290:
    for (;;)
    {
      return new atep(paramFileManagerEntity, paramObject, false, null, paramblgh);
      paramFileManagerEntity = blei.a(paramFileManagerEntity.WeiYunFileId, paramFileManagerEntity.fileName, paramFileManagerEntity.strFileSHA, paramFileManagerEntity.fileSize, 0, paramFileManagerEntity.WeiYunDirKey, paramFileManagerEntity.strLargeThumPath);
      if (paramFileManagerEntity == null) {}
      for (paramFileManagerEntity = null;; paramFileManagerEntity = blfu.a().a(paramFileManagerEntity, blew.a(), true, paramblgh))
      {
  ...
  public atep a(String paramString, Object paramObject, UploadManager.IUploadStatusListener paramIUploadStatusListener)
  {
    if ((!this.b) && (!this.c)) {
      b();
    }
    ...
    paramString = blei.b(paramString, UploadFile.createUploadBatch(1, null), 1);
    if (paramString == null) {}
    ...
    label138:
    return new atep(paramString, paramObject, true, paramIUploadStatusListener, null);
  }
  ...
  public FileManagerEntity a(FileManagerEntity paramFileManagerEntity, String paramString)
  {
    ...
    localFileManagerEntity.peerNick = aszt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, null, paramFileManagerEntity.peerType);
    ...
    for (localFileManagerEntity.selfUin = paramFileManagerEntity.peerUin;; localFileManagerEntity.selfUin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount())
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("WeiYunLogicCenter<FileAssistant>", 2, "insertWeiYun2OfflineEntity FileManagerEntity:" + aszt.a(localFileManagerEntity));
      }
  ...
  public FileManagerEntity a(FileManagerEntity paramFileManagerEntity, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.e("WeiYunLogicCenter<FileAssistant>", 2, "insertWeiYun2OfflineEntity : entity is null, peerUin[" + aszt.e(paramString2) + "], peerType[" + paramInt1 + "]");
      }
      paramFileManagerEntity = null;
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().a(paramString2, paramFileManagerEntity, true, localFileManagerEntity.fileName, localFileManagerEntity.fileSize, true, paramInt1, str, localFileManagerEntity.msgSeq, localFileManagerEntity.msgSeq, null, 2, l, localFileManagerEntity.msgUid, -1L, bbko.a());
      paramFileManagerEntity = localFileManagerEntity;
      if (!QLog.isColorLevel()) {
        break;
      }
      QLog.d("WeiYunLogicCenter<FileAssistant>", 2, "insertWeiYun2OfflineEntity peerType[" + paramInt1 + "],FileManagerEntity:" + aszt.a(localFileManagerEntity));
      return localFileManagerEntity;
      if (paramInt1 == 1006)
      {
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, int paramInt3, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      blfm.a(localLibInfoListGetMsgReq, new atdy(this, paramString1));
      return;
      if (this.jdField_a_of_type_JavaUtilLinkedHashMap != null) {
        break label168;
      }
  ...
  public void a(ChatMessage paramChatMessage, atek paramatek)
  {
    ...
    for (;;)
    {
      ...
      a(localAioPicAndVideoCopyToWeiyunMsgReq, paramatek);
      return;
  ...
  public void a(FileManagerEntity paramFileManagerEntity, int paramInt, boolean paramBoolean)
  {
    if (paramFileManagerEntity == null)
    {
      ...
      aszt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0L, "actFileWy2Of", 0L, "", "", "", "", 9006L, "entity is null", 0L, 0L, 0L, "", "", 0, "", null);
      aszt.a();
      return;
    }
    ...
    if (!NetworkUtil.isNetSupport(BaseApplication.getContext()))
    {
      ...
      aszt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramFileManagerEntity.nSessionId, "actFileWy2Of", 0L, "", paramFileManagerEntity.peerUin, "", "", 9004L, "Error_No_Network", 0L, 0L, 0L, "", "", 0, "", null);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().c(paramFileManagerEntity);
      return;
    }
    QLog.d("WeiYunLogicCenter<FileAssistant>", 2, "=_= ^ [CS Send]sendWyFile2QqOffline, peerUin[" + aszt.e(paramFileManagerEntity.peerUin) + "peerType[" + paramInt + "]], WeiYunFileId[" + paramFileManagerEntity.WeiYunFileId + "], fileName[" + paramFileManagerEntity.fileName + "], fileSize[" + paramFileManagerEntity.fileSize + "], nWeiYunSrcType[" + paramFileManagerEntity.nWeiYunSrcType + "]");
    paramFileManagerEntity.fProgress = 0.0F;
    long l;
    try
    {
      l = Long.parseLong(paramFileManagerEntity.peerUin.replace("+", ""));
      avnk localavnk = (avnk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(16);
      if ((localavnk != null) && (localavnk.a(paramFileManagerEntity.peerUin)))
      {
        aszt.c(amtj.a(2131715937));
        paramFileManagerEntity.status = 0;
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerDataCenter().a();
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerNotifyCenter().a(false, 3, null);
    ...
    for (;;)
    {
      ...
      blfm.a(localCrossBidProxyCopyFileToOtherBidMsgReq, new ated(this, paramFileManagerEntity, paramInt));
      ...
      break;
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_md5.set(blhj.a(""));
    }
  }
  
  public void a(FileManagerEntity paramFileManagerEntity, long paramLong, String paramString, boolean paramBoolean1, boolean paramBoolean2, atek paramatek)
  {
    if (!NetworkUtil.isNetSupport(BaseApplication.getContext()))
    {
      if (paramatek != null) {
    ...
    } while (paramatek == null);
    paramatek.a(13, "");
    return;
    blfm.a(localWeiyunShareAddFromMobileQQMsgReq, new atea(this, paramatek));
  }
  ...
  public void a(FileManagerEntity paramFileManagerEntity, String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localbecp = localTroopFileTransferManager.a(paramFileManagerEntity.WeiYunFileId, paramFileManagerEntity.fileName, paramFileManagerEntity.getFilePath(), paramFileManagerEntity.fileSize, 25, i, 8888L);
      } while (localbecp == null);
      a(paramFileManagerEntity, localbecp, paramString, paramInt, i);
      paramFileManagerEntity.status = 2;
      if (NetworkUtil.isNetSupport(BaseApplication.getContext())) {
        break;
      }
      paramFileManagerEntity.status = 0;
      paramFileManagerEntity.isReaded = false;
      localTroopFileTransferManager.a(localbecp.jdField_a_of_type_JavaUtilUUID, -1, null, amtj.a(2131715935));
    } while (!QLog.isColorLevel());
    QLog.i("WeiYunLogicCenter<FileAssistant>", 2, "sendWeiYun2Troop : network error");
    return;
    if (QLog.isColorLevel()) {
      QLog.d("WeiYunLogicCenter<FileAssistant>", 2, "sendWeiYun2Troop, peerUin[" + aszt.e(paramFileManagerEntity.peerUin) + "], WeiYunFileId[" + paramFileManagerEntity.WeiYunFileId + "], fileName[" + paramFileManagerEntity.fileName + "], fileSize[" + paramFileManagerEntity.fileSize + "], nWeiYunSrcType[" + paramFileManagerEntity.nWeiYunSrcType + "]");
    }
    paramFileManagerEntity.fProgress = 0.0F;
    long l2 = 0L;
    try
    {
      ...
      blfm.a(a(paramFileManagerEntity, l1), new atee(this, localTroopFileTransferManager, localbecp, paramFileManagerEntity));
      return;
    }
  ...
  public void a(WeiYunFileInfo paramWeiYunFileInfo)
  {
    ...
    aslg.a(paramWeiYunFileInfo.jdField_a_of_type_JavaLangString, paramWeiYunFileInfo);
    ...
    if (paramWeiYunFileInfo.b != null) {
      ((WeiyunPB.DiskSimpleFileItem)localObject).pdir_key.set(blhj.a(paramWeiYunFileInfo.b));
    }
    ...
    blfm.a((WeiyunPB.DiskDirFileBatchDeleteExMsgReq)localObject, new atej(this, paramWeiYunFileInfo));
  }
  
  public void a(WeiYunFileInfo paramWeiYunFileInfo, atek paramatek)
  {
    ...
    paramatek.a(-2, "no_weiyunid_or_filename");
    return;
    WeiyunPB.CrossBidProxyCopyFileToOtherBidMsgReq localCrossBidProxyCopyFileToOtherBidMsgReq = new WeiyunPB.CrossBidProxyCopyFileToOtherBidMsgReq();
    ...
    if (paramWeiYunFileInfo.j != null) {
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_sha.set(blhj.a(paramWeiYunFileInfo.j));
    }
    if (paramWeiYunFileInfo.i != null) {
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_md5.set(blhj.a(paramWeiYunFileInfo.i));
    }
    for (;;)
    {
      ...
      if (paramWeiYunFileInfo.b != null) {
        localCrossBidProxyCopyFileToOtherBidMsgReq.src_pdir_key.set(blhj.a(paramWeiYunFileInfo.b));
      }
      localCrossBidProxyCopyFileToOtherBidMsgReq.src_bid.set(25);
      localCrossBidProxyCopyFileToOtherBidMsgReq.src_uin.set(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin());
      localCrossBidProxyCopyFileToOtherBidMsgReq.src_group.set(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin());
      ...
      localCrossBidProxyCopyFileToOtherBidMsgReq.user_type.set(0);
      blfm.a(localCrossBidProxyCopyFileToOtherBidMsgReq, new atef(this, paramatek));
      return;
      localCrossBidProxyCopyFileToOtherBidMsgReq.file_md5.set(blhj.a(""));
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    if (!NetworkUtil.isNetSupport(BaseApplication.getContext()))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerNotifyCenter().a(false, 45, new Object[] { Integer.valueOf(0), BaseApplication.getContext().getString(2131694062) });
      return;
    }
    ...
    localPwdVerifyMsgReq.pwd_md5.set(blhj.a(paramString));
    blfm.a(localPwdVerifyMsgReq, new atec(this, paramString));
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFileManagerNotifyCenter().a(false, 278, new Object[] { Integer.valueOf(1810001), amtj.a(2131715938), "", "", "", "", Integer.valueOf(0) });
      return;
    }
    ...
    localDiskFileDocDownloadAbsMsgReq.pdir_key.set(blhj.a(paramString2));
    blfm.a(localDiskFileDocDownloadAbsMsgReq, new atdz(this));
  }
  
  public void a(List<MessageForPic> paramList, List<MessageForShortVideo> paramList1, atek paramatek)
  {
    WeiyunPB.AioPicAndVideoCopyToWeiyunMsgReq localAioPicAndVideoCopyToWeiyunMsgReq = new WeiyunPB.AioPicAndVideoCopyToWeiyunMsgReq();
