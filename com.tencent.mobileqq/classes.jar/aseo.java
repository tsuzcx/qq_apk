...
public class aseo
  implements Manager
{
  volatile aseq jdField_a_of_type_Aseq;
  aser jdField_a_of_type_Aser;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  List<EmotionSearchItem> jdField_a_of_type_JavaUtilList = new ArrayList();
  WeakReference<asep> jdField_a_of_type_MqqUtilWeakReference;
  volatile aseq b;
  ...
  public static aseo a(QQAppInterface paramQQAppInterface)
  {
    return (aseo)paramQQAppInterface.getManager(QQManagerFactory.EMOTION_SEARCH_MANAGER);
  }
  
  private void a(asep paramasep)
  {
    if (paramasep == null) {
      return;
    }
    int i;
    if (paramasep.jdField_a_of_type_Aseq == null)
    {
      i = 0;
      label14:
      if (paramasep.jdField_a_of_type_Aseq != null) {
    ...
    label63:
    for (String str = "";; str = paramasep.jdField_a_of_type_Aseq.jdField_a_of_type_JavaLangString)
    {
      a(paramasep.jdField_a_of_type_Int, i, str);
      if (this.jdField_a_of_type_Aser == null) {
        break;
      }
      this.jdField_a_of_type_Aser.onSearchCallBack(paramasep);
      return;
      i = paramasep.jdField_a_of_type_Aseq.jdField_a_of_type_Int;
      break label14;
    }
  }
  
  private void a(aseq paramaseq, List<EmotionSearchItem> arg2, int paramInt)
  {
    if (!paramaseq.a(this.b))
    {
      if (QLog.isColorLevel()) {
        QLog.e("EmotionSearchManager", 2, "handleResponsData requestTask not current error, requestTask = " + paramaseq.jdField_a_of_type_Int + "|" + paramaseq.jdField_a_of_type_JavaLangString);
      }
      return;
    }
    asep localasep = new asep(paramInt);
    paramaseq.jdField_a_of_type_Boolean = false;
    if ((paramInt == 0) && (???.size() > 0) && (this.jdField_a_of_type_JavaUtilList.size() == ((EmotionSearchItem)???.get(0)).picIndex))
    {
      ...
      paramaseq.jdField_a_of_type_Boolean = true;
    }
    localasep.jdField_a_of_type_Aseq = paramaseq;
    localasep.jdField_a_of_type_JavaUtilList = new ArrayList();
    localasep.jdField_a_of_type_JavaUtilList.addAll(this.jdField_a_of_type_JavaUtilList);
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_Aseq = this.b;
      this.b = null;
      if ((paramaseq.jdField_a_of_type_Int == 0) && (paramInt == 0)) {
        this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(localasep);
      }
      a(localasep);
      return;
    }
  ...
  private void c()
  {
    ...
    int i = ((aseq)localObject1).b;
    int j = ((aseq)localObject1).b;
    int k = ((aseq)localObject1).c;
    ...
    if (((aseq)localObject1).jdField_a_of_type_Int == 1)
    {
      ((HotPicMsg.GetImgInfoReq)localObject3).uint32_search_req.set(1);
      ((HotPicMsg.GetImgInfoReq)localObject3).str_search_word.set(((aseq)localObject1).jdField_a_of_type_JavaLangString);
      ...
      localObject2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), avne.class);
      ...
      ((NewIntent)localObject2).putExtra("EmoSearch_reqType", ((aseq)localObject1).jdField_a_of_type_Int);
      if (((aseq)localObject1).jdField_a_of_type_JavaLangString != null) {
        break label422;
      }
    }
    label422:
    for (localObject1 = "";; localObject1 = ((aseq)localObject1).jdField_a_of_type_JavaLangString)
    {
  ...
  public aser a()
  {
    return this.jdField_a_of_type_Aser;
  }
  ...
  public void a()
  {
    ...
    if (!this.jdField_a_of_type_Aseq.jdField_a_of_type_Boolean)
    {
      a(new asep(-104));
      return;
    }
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.b = this.jdField_a_of_type_Aseq;
  ...
  public void a(aseq arg1)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      ??? = (asep)this.jdField_a_of_type_MqqUtilWeakReference.get();
      if (??? == null) {
        break label223;
      }
    }
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_JavaUtilList.addAll(((asep)???).jdField_a_of_type_JavaUtilList);
      this.jdField_a_of_type_Aseq = this.b;
      this.b = null;
      a(true);
      a((asep)???);
  ...
  {
    this.jdField_a_of_type_Aser = paramaser;
  }
  ...
  public void b()
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      this.b = null;
      this.jdField_a_of_type_JavaUtilList.clear();
      this.jdField_a_of_type_Aser = null;
      return;
    }
  }
