  ...
  extends aksu
{
  ...
  akud(AlbumListFragment paramAlbumListFragment)
  {
  ...
  public void initData(Intent paramIntent)
  {
    ...
    {
      paramIntent = bobx.a(paramIntent.getActivity().getApplicationContext(), this.mPhotoCommonData.myUin, "pref_select_album");
      if (!TextUtils.isEmpty(paramIntent)) {
        break label173;
      }
    }
    label173:
    for (paramIntent = new ArrayList();; paramIntent = bobx.a(paramIntent))
    {
      this.a = paramIntent;
  ...
  public boolean onItemClick(QQAlbumInfo paramQQAlbumInfo, int paramInt, Intent paramIntent)
  {
    ...
    for (;;)
    {
      bobx.a(paramIntent.getActivity().getApplicationContext(), this.mPhotoCommonData.myUin, "pref_select_album", bobx.a(this.a.iterator()));
      return bool;
      label199:
