...
{
  public ahcb(ClassificationSearchActivity paramClassificationSearchActivity) {}
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    if (!str.equals("")) {}
    for (paramEditable = this.a.getResources().getString(2131719591);; paramEditable = this.a.getResources().getString(2131690648))
    {
