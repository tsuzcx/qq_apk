...
public class acte
{
  static volatile acte jdField_a_of_type_Acte;
  private int jdField_a_of_type_Int;
  private final String jdField_a_of_type_JavaLangString = "DoodleResHelper";
  private Map<Integer, actf> jdField_a_of_type_JavaUtilMap;
  
  public static acte a()
  {
    if (jdField_a_of_type_Acte == null) {}
    try
    {
      if (jdField_a_of_type_Acte == null) {
        jdField_a_of_type_Acte = new acte();
      }
      return jdField_a_of_type_Acte;
    }
    finally {}
  }
  ...
  public Bitmap a(int paramInt1, int paramInt2)
  {
    ...
    //   4: iload_1
    //   5: iload_2
    //   6: invokevirtual 52	acte:a	(II)Ljava/lang/String;
    //   9: astore 8
    //   11: aload 8
    ...
    //   33: aload 8
    //   35: iconst_0
    //   36: invokespecial 66	acte:a	(Ljava/lang/String;I)Ljava/lang/String;
    ...
    //   107: aload 8
    //   109: iconst_0
    //   110: invokespecial 66	acte:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   113: aload 4
  ...
  public Drawable a(int paramInt1, int paramInt2)
  {
    ...
    //   14: iload_1
    //   15: iload_2
    //   16: invokevirtual 115	acte:b	(II)Ljava/lang/String;
    //   19: astore 6
    //   21: aload 6
    ...
    //   35: aload 6
    //   37: iconst_1
    //   38: invokespecial 66	acte:a	(Ljava/lang/String;I)Ljava/lang/String;
    ...
    //   105: aload 6
    //   107: iconst_1
    //   108: invokespecial 66	acte:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   111: aload 4
  ...
  public Drawable a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt2 > 0)
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject3).mFailedDrawable = ((Context)localObject2).getResources().getDrawable(2130837681);
      ((URLDrawable.URLDrawableOptions)localObject3).mLoadingDrawable = ((Context)localObject2).getResources().getDrawable(2130837681);
  ...
  public void a(int paramInt1, int paramInt2, View paramView, avhl paramavhl)
  {
    if (Looper.getMainLooper() != Looper.myLooper()) {
      new Handler(Looper.getMainLooper()).post(new DoodleResHelper.1(this, paramInt1, paramInt2, paramView, paramavhl));
    }
    ...
    do
    {
      ...
      if (paramInt1 == 0)
      {
        ScribbleResMgr.a().a(localQQAppInterface, 3, paramInt2, paramView, paramavhl);
        return;
      }
    } while ((paramInt1 != 1) && (paramInt1 != 2));
    ScribbleResMgr.a().a(localQQAppInterface, 4, paramInt2, paramView, paramavhl);
  }
  ...
  public void a(Bitmap paramBitmap)
  {
    ...
    {
      actf localactf = (actf)((Iterator)localObject).next();
      if ((localactf.jdField_a_of_type_JavaLangRefWeakReference != null) && (localactf.jdField_a_of_type_JavaLangRefWeakReference.get() == paramBitmap))
      {
        localactf.jdField_a_of_type_Boolean = true;
        QLog.d("DoodleResHelper", 2, "releaseBitmap succ:" + this.jdField_a_of_type_JavaUtilMap.size());
        return;
      }
    }
    localObject = new actf(this);
    ((actf)localObject).b = paramBitmap.getHeight();
    ((actf)localObject).jdField_a_of_type_Int = paramBitmap.getWidth();
    ((actf)localObject).jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramBitmap);
    ((actf)localObject).jdField_a_of_type_Boolean = true;
  ...
  public Bitmap b(int paramInt1, int paramInt2)
  {
    ...
    //   39: aload 6
    //   41: iconst_0
    //   42: invokespecial 66	acte:a	(Ljava/lang/String;I)Ljava/lang/String;
    ...
    //   89: aload 6
    //   91: iconst_0
    //   92: invokespecial 66	acte:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   95: aload 4
  ...
  public void b(int paramInt1, int paramInt2, View paramView, avhl paramavhl)
  {
    if (Looper.getMainLooper() != Looper.myLooper()) {
      new Handler(Looper.getMainLooper()).post(new DoodleResHelper.2(this, paramInt1, paramInt2, paramView, paramavhl));
    }
    QQAppInterface localQQAppInterface;
    do
    {
      ...
      if (paramInt1 == 0)
      {
        ScribbleResMgr.a().a(localQQAppInterface, 1, paramInt2, paramView, paramavhl);
        return;
      }
    } while ((paramInt1 != 1) && (paramInt1 != 2));
    ScribbleResMgr.a().a(localQQAppInterface, 2, paramInt2, paramView, paramavhl);
  }
  ...
  public Bitmap c(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject5 = (actf)((Map.Entry)((Iterator)localObject4).next()).getValue();
        if ((localObject5 == null) || (((actf)localObject5).jdField_a_of_type_JavaLangRefWeakReference == null) || (((actf)localObject5).jdField_a_of_type_JavaLangRefWeakReference.get() == null))
        {
          ((Iterator)localObject4).remove();
          QLog.d("DoodleResHelper", 2, "getBitmap remove a invalid item");
          continue;
        }
        if (!((actf)localObject5).jdField_a_of_type_Boolean) {
          continue;
        }
      }
      finally {}
      if ((((actf)localObject5).b == paramInt2) && (((actf)localObject5).jdField_a_of_type_Int == paramInt1))
      {
        if (((actf)localObject5).jdField_a_of_type_JavaLangRefWeakReference != null) {}
        label233:
        Object localObject3;
        for (Object localObject2 = (Bitmap)((actf)localObject5).jdField_a_of_type_JavaLangRefWeakReference.get(); localObject2 != null; localObject3 = null)
        {
          QLog.d("DoodleResHelper", 2, "getBitmap find idle :" + this.jdField_a_of_type_JavaUtilMap.size());
          ((actf)localObject5).jdField_a_of_type_Boolean = false;
          return localObject2;
          QLog.d("DoodleResHelper", 2, "getBitmap add new item");
          localObject2 = new actf(this);
          ((actf)localObject2).b = paramInt2;
          ((actf)localObject2).jdField_a_of_type_Int = paramInt1;
          try
          {
            localObject4 = Bitmap.createBitmap(paramInt1, paramInt2, Bitmap.Config.ARGB_8888);
            ((actf)localObject2).jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(localObject4);
            ((actf)localObject2).jdField_a_of_type_Boolean = false;
