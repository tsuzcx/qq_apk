...
public class bgem
  extends aofu
{
  public bgem(BulkSendMessageFragment paramBulkSendMessageFragment) {}
  ...
  protected void onBulkSendMessage(boolean paramBoolean, homework.RspSend1V1Msg paramRspSend1V1Msg, homework.ReqSend1V1Msg paramReqSend1V1Msg)
  {
    ...
    label97:
    for (Object localObject = "null";; localObject = zel.a(paramRspSend1V1Msg))
    {
    ...
    if (paramRspSend1V1Msg == null)
    {
      QQToast.a((Context)localObject, 1, anvx.a(2131700730), 1).a();
      return;
    }
    ...
    QQToast.a((Context)localObject, 2, anvx.a(2131700726), 1).a();
    ...
    paramRspSend1V1Msg = bhbu.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_JavaLangString);
    bhbu.a("Grp_edu", "MassMessage", "CreateMessage_Send", 0, 0, new String[] { this.a.jdField_a_of_type_JavaLangString, paramRspSend1V1Msg, paramReqSend1V1Msg.text.get().toStringUtf8(), String.valueOf(paramReqSend1V1Msg.to_uins.size()) });
  }
}
