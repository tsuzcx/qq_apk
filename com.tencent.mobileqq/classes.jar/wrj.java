...
import com.tencent.biz.videostory.capture.AEGifTipsPopupPart.1;
import com.tencent.biz.videostory.capture.AEGifTipsPopupPart.5;
  ...
  extends wug
{
  ...
  private static final String[] jdField_a_of_type_ArrayOfJavaLangString = { ajjy.a(2131624270), ajjy.a(2131624271), ajjy.a(2131624272) };
  ...
  public wrj(Activity paramActivity, View paramView, wus paramwus)
  {
  ...
  private void a(Runnable paramRunnable)
  {
    ...
    localAnimationSet.setAnimationListener(new wrl(this, paramRunnable));
  ...
  {
    if (!this.jdField_b_of_type_Boolean) {}
    while (bgxb.a().a("has_enter_aio_gif", false, 0)) {
      return false;
    }
    return true;
  }
  ...
  {
    int i = 200;
    Intent localIntent = this.jdField_a_of_type_Bhcw.a().getIntent();
    if (localIntent != null) {
  ...
  private void f()
  {
    ...
    this.jdField_b_of_type_AndroidViewAnimationAnimation.setAnimationListener(new wrk(this));
  ...
  private void g()
  {
    ...
    localAnimationSet.addAnimation(localScaleAnimation);
    localAnimationSet.addAnimation(localTranslateAnimation);
    localAnimationSet.setAnimationListener(new wrm(this));
    this.jdField_b_of_type_AndroidViewView.startAnimation(localAnimationSet);
  }
  ...
  private void j()
  {
    ...
    bgxb.a().a("has_enter_aio_gif", true, 0);
  }
  ...
  protected void a()
  {
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131300783);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131301456);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131301457));
  }
