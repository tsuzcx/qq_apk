...
public class azcv
  extends anun
{
  public azcv(CustomCoverFragment paramCustomCoverFragment) {}
  ...
  public void e(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          QQToast.a(this.a.getActivity(), 1, 2131718828, 0).a();
          return;
        ...
        QQToast.a((Context)localObject, 0, 2131718831, 0).a();
    ...
    if ("profilelogic.readUserInfo".equals(paramObject))
    {
      ...
      this.a.stopTitleProgress();
      QQToast.a((Context)localObject, 1, 2131718559, 0).a();
      return;
    }
    QQToast.a((Context)localObject, 1, 2131718828, 0).a();
  }
}
