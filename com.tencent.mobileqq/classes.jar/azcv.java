...
public class azcv
{
  ...
  private static azcv jdField_a_of_type_Azcv;
  ...
  {
    int j = 0;
    if (!azcv.class.desiredAssertionStatus()) {}
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          Object localObject = anwv.b(BaseApplicationImpl.getContext());
  ...
  public static azcv a()
  {
    if (jdField_a_of_type_Azcv == null) {}
    try
    {
      if (jdField_a_of_type_Azcv == null) {
        jdField_a_of_type_Azcv = new azcv();
      }
      return jdField_a_of_type_Azcv;
    }
    finally {}
  }
