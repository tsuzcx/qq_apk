  ...
  implements GLSurfaceView.Renderer
{
  ...
  private bjjq jdField_a_of_type_Bjjq;
  ...
  private int b;
  private int c = bhey.jdField_a_of_type_Int;
  private int d;
  private int e;
  ...
  public Bitmap a(Bitmap paramBitmap, long paramLong)
  {
    ...
    Object localObject = bjgy.a(0);
    QQFilterRenderManager localQQFilterRenderManager = bhey.a(bhey.c);
    if (localQQFilterRenderManager != null)
    {
      ...
      this.jdField_a_of_type_Bjjq = new bjjq(localQQFilterRenderManager.getBusinessOperation().getCurrentAVFilterIdList(), localMusicItemInfo, this.d, this.e, null);
      this.jdField_a_of_type_Bjjq.a(true);
      if ((this.jdField_a_of_type_Bjjq == null) || (localObject == null)) {
        break label210;
      }
    }
    for (;;)
    {
      try
      {
        paramBitmap = vms.a(paramBitmap, 1.0F, -1.0F);
        ((GPUBaseFilter)localObject).init();
        this.jdField_a_of_type_Bjjq.a(this.d, this.e);
      ...
      try
      {
        ...
        localObject = vms.a(paramBitmap, 1.0F, -1.0F);
        this.jdField_a_of_type_Bjjq = null;
        return localObject;
      }
  ...
  public Bitmap a(Bitmap paramBitmap, GPUBaseFilter paramGPUBaseFilter)
  {
    ...
    if ((this.jdField_a_of_type_Bjjq != null) && (this.jdField_a_of_type_Bjjq.jdField_a_of_type_Boolean)) {}
    for (int i = 30;; i = 2)
    {
      int j = 0;
      while (j < i)
  ...
  public Bitmap a(Bitmap paramBitmap, List<FilterDesc> paramList, bjgz parambjgz)
  {
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter = parambjgz.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter;
    this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager = parambjgz.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager;
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null) && (this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter != null) && (paramList != null))
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsBitmap = paramBitmap;
      int i = 5;
      if (parambjgz.jdField_a_of_type_Boolean)
      {
        parambjgz.jdField_a_of_type_Boolean = false;
        i = 20;
      }
      int j = 0;
      while (j < i)
      ...
      return vms.a(paramBitmap, 1.0F, -1.0F);
    }
    return null;
  }
  ...
  {
    GPUBaseFilter localGPUBaseFilter = bjgy.a(0);
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null) && (localGPUBaseFilter != null) && (paramList != null))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager.getBusinessOperation().setFilterEffectList(paramList);
      return vms.a(a(paramBitmap, localGPUBaseFilter), 1.0F, -1.0F);
    }
    return null;
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null)
    {
      ...
      this.c = bhey.jdField_a_of_type_Int;
    }
  }
  ...
  {
    if (Build.VERSION.SDK_INT >= 17) {
      this.jdField_a_of_type_Auzd = new auzd(EGL14.EGL_NO_CONTEXT, 1);
    }
    d(paramInt1, paramInt2);
  }
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_ComTencentTtpicOpenapiFilterGPUBaseFilter = bjgy.a(0);
    this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager = bhey.b();
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    for (Object localObject = this.jdField_a_of_type_AndroidGraphicsBitmap;; localObject = paramGL10)
    {
      ...
      if (this.jdField_a_of_type_Bjjq != null) {
        this.b = this.jdField_a_of_type_Bjjq.a(this.d, this.e, this.b, this.jdField_a_of_type_Long);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqShortvideoFilterQQFilterRenderManager != null)
      {
