...
public class awfm
  implements View.OnClickListener, ViewTreeObserver.OnPreDrawListener, awfq, awfv, hk
{
  ...
  bbqs jdField_a_of_type_Bbqs;
  bbry jdField_a_of_type_Bbry;
  private bbse jdField_a_of_type_Bbse = new awfn(this);
  public ETTextView a;
  ...
  public Observer a;
  WeakReference<awfr> jdField_a_of_type_MqqUtilWeakReference;
  boolean jdField_a_of_type_Boolean;
  long jdField_b_of_type_Long;
  View jdField_b_of_type_AndroidViewView;
  ImageView jdField_b_of_type_AndroidWidgetImageView;
  SingleLineTextView jdField_b_of_type_ComTencentWidgetSingleLineTextView;
  WeakReference<awfv> jdField_b_of_type_MqqUtilWeakReference;
  ...
  public awfm(Context paramContext, AppInterface paramAppInterface, View paramView, String paramString)
  {
    this.jdField_a_of_type_JavaUtilObserver = new awfo(this);
    ...
    this.h = actj.a(12.0F, paramContext.getResources());
    this.i = 2130845272;
    m();
    a();
  ...
  private void m()
  {
    if (jdField_a_of_type_ArrayOfInt == null)
    {
      ...
      jdField_a_of_type_ArrayOfInt[0] = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166320);
      jdField_a_of_type_ArrayOfInt[1] = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166321);
      jdField_a_of_type_ArrayOfInt[2] = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166322);
      jdField_a_of_type_ArrayOfInt[3] = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166324);
      jdField_a_of_type_ArrayOfInt[4] = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298260);
      jdField_a_of_type_ArrayOfInt[5] = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298258);
      jdField_a_of_type_ArrayOfInt[6] = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298259);
      jdField_a_of_type_ArrayOfInt[7] = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298261);
      jdField_a_of_type_ArrayOfInt[8] = actj.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      jdField_a_of_type_ArrayOfInt[9] = actj.a(17.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      jdField_a_of_type_ArrayOfInt[10] = actj.a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      jdField_a_of_type_ArrayOfInt[11] = actj.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      jdField_a_of_type_ArrayOfInt[12] = actj.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      jdField_a_of_type_ArrayOfInt[13] = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166323);
      jdField_a_of_type_ArrayOfInt[14] = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166320);
      jdField_a_of_type_ArrayOfInt[15] = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167146);
      jdField_a_of_type_ArrayOfInt[16] = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167134);
    }
  }
  ...
  private void n()
  {
    ...
    if (bool1)
    {
      localObject = bbkp.c(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.time * 1000L);
  ...
  private void o()
  {
    int j;
    Object localObject;
    if (this.jdField_a_of_type_Bbqs.jdField_a_of_type_Bbqu != null)
    {
      j = 1;
      if (j == 0) {
        break label229;
      }
      localObject = this.jdField_a_of_type_Bbqs.n;
      label24:
      ...
      if ((this.jdField_a_of_type_Bbqs.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) || (TextUtils.isEmpty(this.jdField_a_of_type_Bbqs.n))) {
        break label246;
      }
      localObject = this.jdField_a_of_type_Bbqs.n;
      label86:
      ...
      this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setHint(2131699398);
      this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setHintTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166321));
    }
    for (;;)
    {
      this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setTextMsg(new aykk((CharSequence)localObject, 1, 20));
  ...
  public View a(RichStatus paramRichStatus)
  {
    ...
    this.jdField_a_of_type_Bbqs = a();
    paramRichStatus.signType = this.jdField_a_of_type_Bbqs.g;
    boolean bool;
    if (this.jdField_a_of_type_Bbqs.jdField_a_of_type_Bbqu != null)
    {
      bool = true;
      this.jdField_a_of_type_Boolean = bool;
      this.jdField_b_of_type_Boolean = this.jdField_a_of_type_Bbqs.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get();
  ...
  protected bbqs a()
  {
    ...
    return awek.a().a(this.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.tplId);
  }
  ...
  protected CharSequence a(RichStatus paramRichStatus, awfv paramawfv, int paramInt)
  {
    ...
    aweq localaweq = (aweq)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(15);
    Resources localResources = this.jdField_a_of_type_AndroidContentContext.getResources();
    SpannableString localSpannableString = new SpannableString(paramRichStatus.toSpannableStringWithoutAction(paramawfv));
    if ((paramRichStatus != null) && (localResources != null) && (!TextUtils.isEmpty(paramRichStatus.actionText)))
    {
      ...
      paramawfv = (awfv)localObject;
      if (!TextUtils.isEmpty(paramRichStatus.dataText)) {
        paramawfv = (String)localObject + paramRichStatus.dataText;
      }
      Drawable localDrawable = localResources.getDrawable(2130848546);
      localObject = new SpannableStringBuilder(localSpannableString);
      ((SpannableStringBuilder)localObject).insert(0, "[S] ");
      int j;
      if (localaweq != null)
      {
        paramRichStatus = localaweq.a(paramRichStatus.actionId, 200);
        paramRichStatus = new bcry(localResources, paramRichStatus, false, false);
      ...
      label273:
      for (paramRichStatus = new awdb(paramRichStatus, 1, paramawfv, j, localDrawable, paramInt);; paramRichStatus = new awdb(paramRichStatus, 0, paramawfv, j, localDrawable, paramInt))
      {
        ((SpannableStringBuilder)localObject).setSpan(paramRichStatus, 0, "[S]".length(), 17);
        return new aykk((CharSequence)localObject, 1);
        paramRichStatus = baxi.a(localResources, 2130848539);
        break;
      }
    }
    return new aykk(localSpannableString, 1);
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561108, null, false));
    ...
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131375387);
    this.e = this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131369370);
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131369458);
    this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131369459);
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131365268);
    this.jdField_a_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131378378));
    this.jdField_b_of_type_ComTencentWidgetSingleLineTextView = ((SingleLineTextView)this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131378250));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131368537));
    vzl.a(this.jdField_b_of_type_AndroidWidgetImageView, m, m, m, m);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131368737));
    vzl.a(this.jdField_a_of_type_AndroidWidgetImageView, m, m, m, m);
    this.jdField_a_of_type_ComEtrumpMixlayoutETTextView = ((ETTextView)this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.findViewById(2131378352));
    this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setOnTextOrFontChangeListener(this);
    this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setMovementMethod(awfw.a());
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnTouchListener(muc.a);
  ...
  public void a(awfr paramawfr)
  {
    if (paramawfr != null)
    {
      this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramawfr);
      return;
    }
  ...
  {
    QLog.d("BaseSignViewHolder", 1, new Object[] { "onClick topic=", paramawfu });
    if (this.jdField_b_of_type_MqqUtilWeakReference != null) {}
    for (awfv localawfv = (awfv)this.jdField_b_of_type_MqqUtilWeakReference.get();; localawfv = null)
    {
      if (localawfv != null) {
        localawfv.a(paramawfu, paramView);
      }
      return;
    }
  }
  ...
  public void a(awfv paramawfv)
  {
    if (paramawfv != null)
    {
      this.jdField_b_of_type_MqqUtilWeakReference = new WeakReference(paramawfv);
      return;
    }
  ...
  {
    awga.a(paramETTextView, paramETTextView.getText(), 1);
  }
  
  public void a(ETTextView paramETTextView, CharSequence paramCharSequence)
  {
    awga.a(paramETTextView, paramCharSequence, 0);
  }
  ...
  protected void d()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130845272);
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(2131376206, Integer.valueOf(-1));
    e();
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848613);
    this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130845269);
    a(true);
  }
  ...
  protected void f()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqVasVasResEngineVasResDrawable == null)
    {
      ...
      localbbsp = new bbsp(this.jdField_a_of_type_ComTencentMobileqqVasVasResEngineVasResDrawable, this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.i);
      this.jdField_a_of_type_ComTencentMobileqqVasVasResEngineVasResDrawable.a(localbbsp);
      if (a() != -1) {
        break label190;
      }
    }
    ...
    {
      localbbsp.a(bool);
      this.jdField_a_of_type_ComTencentMobileqqVasVasResEngineVasResDrawable.a(this.jdField_a_of_type_Bbse);
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(2131376206, Integer.valueOf(this.jdField_a_of_type_Bbqs.f));
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(2131376209, Integer.valueOf(this.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.tplId));
  ...
  protected void g()
  {
    ...
    {
      this.jdField_a_of_type_Bbry = new bbry(this.jdField_a_of_type_ComTencentCommonAppAppInterface, j);
      localbbss = new bbss(this.jdField_a_of_type_Bbry, this.jdField_a_of_type_ComTencentCommonAppAppInterface, k);
      ...
      {
        localbbss.a(localETTextView, f1, bool);
        this.jdField_a_of_type_Bbry.a(localbbss);
        localbbss.a(a());
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(2131376207, Integer.valueOf(j));
        return;
      }
    }
    bbss localbbss = (bbss)this.jdField_a_of_type_Bbry.a();
    ...
    {
      localbbss.a(localETTextView, f1, bool);
      ((bbss)this.jdField_a_of_type_Bbry.a()).a(j, k);
      break;
      bool = false;
    }
  }
  ...
  protected void h()
  {
    ...
    int n = jdField_a_of_type_ArrayOfInt[3];
    this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.setShadowColor(n);
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Bbqs.e)) {
      j = Color.parseColor(this.jdField_a_of_type_Bbqs.e);
    }
    boolean bool = a(j);
    this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setTextColor(j);
    this.jdField_a_of_type_ComEtrumpMixlayoutETTextView.setHintTextColor(k);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848614);
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130845270);
    }
  }
  ...
  public void j()
  {
    ...
    label59:
    for (localObject = this.jdField_a_of_type_AndroidContentContext.getString(2131720850);; localObject = this.jdField_a_of_type_AndroidContentContext.getString(2131720849))
    {
  ...
  public void k()
  {
    ...
    if ((this.jdField_a_of_type_Bbry != null) && (this.jdField_a_of_type_Bbry.a() != null)) {
      this.jdField_a_of_type_Bbry.a().c();
    }
    if (this.jdField_a_of_type_ComTencentMobileqqVasVasResEngineVasResDrawable != null) {
  ...
  public void onClick(View paramView)
  {
    ...
    {
      localawfr = (awfr)this.jdField_a_of_type_MqqUtilWeakReference.get();
    ...
    for (;;)
    {
      ...
      if ((j > 0) && (localawfr != null)) {
        localawfr.a(paramView, j, this);
      }
      return;
      localawfr = null;
      break;
