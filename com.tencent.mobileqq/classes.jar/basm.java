...
public class basm
  extends banb
{
  alsi jdField_a_of_type_Alsi = new baso(this);
  ...
  public basm(bamu parambamu, baub parambaub)
  {
  ...
  private void g()
  {
    try
    {
      if (SessionInfo.getInstance(this.jdField_a_of_type_Baub.b).getHttpconn_sig_session() != null)
      {
        int i = SessionInfo.getInstance(this.jdField_a_of_type_Baub.b).getHttpconn_sig_session().length;
        this.jdField_d_of_type_ArrayOfByte = new byte[i];
        System.arraycopy(SessionInfo.getInstance(this.jdField_a_of_type_Baub.b).getHttpconn_sig_session(), 0, this.jdField_d_of_type_ArrayOfByte, 0, i);
      }
      if (this.jdField_d_of_type_ArrayOfByte == null) {
        HwServlet.getConfig(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_Baub.b);
      }
      return;
    }
    finally {}
  ...
  private void h()
  {
    ...
    MessageForScribble localMessageForScribble = (MessageForScribble)this.jdField_a_of_type_Baub.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
    if (localMessageForScribble != null)
    {
      ...
      this.c.a();
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(localMessageForScribble, this.jdField_a_of_type_Alsi);
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      azmz.a(BaseApplication.getContext()).a(null, "scribble_upload", true, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
    for (;;)
    {
      l();
      ...
      break;
      label156:
      str = bdlr.a(this.jdField_d_of_type_ArrayOfByte);
      break label105;
      label168:
      ...
      azmz.a(BaseApplication.getContext()).a(null, "scribble_upload", false, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
  }
  ...
  public void aQ_()
  {
    ...
    this.b.a();
    Object localObject = new basn(this, SystemClock.uptimeMillis());
    this.jdField_a_of_type_Baoj.jdField_c_of_type_Int = 41;
    this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), this.jdField_a_of_type_Baoj.jdField_c_of_type_Int, this.jdField_a_of_type_Baub.i, (int)this.r, this.jdField_d_of_type_ArrayOfByte, this.jdField_a_of_type_ArrayOfByte, (ITransactionCallback)localObject, this.jdField_a_of_type_Baoj.jdField_a_of_type_ArrayOfByte);
    ...
    if (QLog.isColorLevel()) {
      QLog.i("ScribblePicUploadProcessor", 2, "<BDH_LOG> Transaction submit RetCode:" + i + " T_ID:" + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.getTransationId() + " UniSeq:" + this.jdField_a_of_type_Baub.jdField_a_of_type_Long + " MD51:" + (String)localObject + " MD52:" + str + " uuid:" + this.jdField_l_of_type_JavaLangString + " Path:" + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.filePath + " Cmd:" + this.jdField_a_of_type_Baoj.jdField_c_of_type_Int);
    }
    if (i != 0)
    {
  ...
  void d()
  {
    super.d();
    d(1005);
    Object localObject = (MessageForScribble)this.jdField_a_of_type_Baub.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
    if (localObject != null) {
    ...
    if (this.jdField_a_of_type_Baub.jdField_a_of_type_Awfy != null)
    {
      ...
      ((awfz)localObject).jdField_a_of_type_Int = -1;
      ((awfz)localObject).b = this.jdField_j_of_type_Int;
      ((awfz)localObject).jdField_a_of_type_JavaLangString = this.jdField_j_of_type_JavaLangString;
  ...
  void e()
  {
    ...
    {
      localObject = new awfz();
      ((awfz)localObject).jdField_a_of_type_Int = 0;
      this.jdField_a_of_type_Baub.jdField_a_of_type_Awfy.b((awfz)localObject);
    }
  }
