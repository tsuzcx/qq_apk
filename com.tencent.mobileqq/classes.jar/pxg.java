  ...
  extends pwy
{
  ...
  private pvq jdField_a_of_type_Pvq = new pxk(this);
  private rmz jdField_a_of_type_Rmz = new pxj(this);
  private boolean jdField_a_of_type_Boolean;
  
  public pxg(@NotNull pwz parampwz, QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    super(parampwz, "RIJSkinOperationPopupStep");
  ...
  private void a(GuideData paramGuideData, String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      localFrameLayout = (FrameLayout)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131365160);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoySkinGuideView = new ReadInJoySkinGuideView(0, this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface, paramGuideData.id, paramString, paramInt, new pxh(this, localFrameLayout, paramInt, localQQAppInterface), new pxi(this, localQQAppInterface, localFrameLayout, paramGuideData));
    } while (a() != 0);
  ...
  private void a(oidb_0x5bd.RefreshInfo paramRefreshInfo, int paramInt)
  {
    ...
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    rmu localrmu = (rmu)localQQAppInterface.getManager(QQManagerFactory.READ_INJOY_REFRESH_MANAGER);
    RefreshData localRefreshData;
    if (paramRefreshInfo.has())
    {
      paramRefreshInfo = new RefreshData(paramRefreshInfo);
      localRefreshData = localrmu.a(this.jdField_a_of_type_AndroidAppActivity, paramInt);
      ...
      if (localRefreshData != null)
      {
        bhhr.f(this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface.getCurrentAccountUin(), null, paramInt);
        FileUtils.deleteFilesInDirectory(rns.a());
        localrmu.a(0, "", -1L, paramInt);
      }
    }
    for (;;)
    {
      if (paramRefreshInfo != null)
      {
        ...
        bhhr.f(this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface.getCurrentAccountUin(), paramRefreshInfo.toJson().toString(), paramInt);
      }
      return;
      ...
      if (((localRefreshData == null) || (!paramRefreshInfo.id.equals(localRefreshData.id)) || (paramRefreshInfo.seq > localRefreshData.seq)) && (i <= paramRefreshInfo.endTime))
      {
        localrmu.a(0, "", -1L, paramInt);
        FileUtils.deleteFilesInDirectory(rns.a());
        localrmu.a(paramRefreshInfo, paramInt);
        if (QLog.isColorLevel()) {
  ...
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    rmr localrmr = (rmr)localQQAppInterface.getManager(paramInt);
    if (localrmr.b(paramString, paramBaseResData))
    {
      String str = localrmr.a(paramString, paramBaseResData.id);
      if (localrmr.c(paramString, paramBaseResData))
      {
        if (QQManagerFactory.READ_INJOY_SKIN_MANAGER == paramInt)
        {
          if (bhhr.g(this.jdField_a_of_type_AndroidAppActivity, paramBaseResData.id) != paramBaseResData.seq)
          {
            FileUtils.deleteDirectory(str);
            localrmr.a(paramString, paramBaseResData);
            return false;
          }
          bhhr.t(this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface.getCurrentAccountUin(), paramBaseResData.id);
          bhhr.B(this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface.getCurrentAccountUin());
        }
  ...
  private boolean a(int paramInt, oidb_0x5bd.SkinInfo paramSkinInfo, oidb_0x5bd.GuideInfo paramGuideInfo)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    boolean bool2 = false;
    RefreshData localRefreshData = ((rmu)localQQAppInterface.getManager(QQManagerFactory.READ_INJOY_REFRESH_MANAGER)).a(this.jdField_a_of_type_AndroidAppActivity, paramInt);
    int i = (int)(System.currentTimeMillis() / 1000L);
    Object localObject;
    boolean bool1;
    if (paramSkinInfo.has())
    {
      ...
      paramGuideInfo = (rna)localQQAppInterface.getManager(QQManagerFactory.READ_INJOY_SKIN_MANAGER);
      ...
      bhhr.s(this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface.getCurrentAccountUin(), null);
      if ((localRefreshData != null) && (i <= localRefreshData.endTime))
      {
        localRefreshData.isShown = true;
        bhhr.f(this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface.getCurrentAccountUin(), localRefreshData.toJson().toString(), paramInt);
      }
    }
    label258:
    label310:
    ...
    bhhr.s(this.jdField_a_of_type_AndroidAppActivity, localQQAppInterface.getCurrentAccountUin(), paramSkinInfo.toJson().toString());
    if (paramSkinInfo.id.equals(paramGuideInfo.a()))
    {
      this.jdField_a_of_type_JavaLangString = paramSkinInfo.id;
      return bool1;
    }
    FileUtils.deleteDirectory(rmp.a(paramSkinInfo.id));
    return bool1;
  }
  ...
  private boolean a(oidb_0x5bd.GuideInfo paramGuideInfo, int paramInt)
  {
    ...
    rmt localrmt = (rmt)((QQAppInterface)localObject).getManager(QQManagerFactory.READ_IN_JOY_OPERATION_MANAGER);
    int i;
    if (paramGuideInfo.has())
    {
      ...
      paramGuideInfo = localrmt.a("operation_guide", paramGuideInfo.id);
      if (paramGuideInfo == null) {
        break label345;
      }
    ...
    for (;;)
    {
      ...
      if (j <= ((GuideData)localObject).endTime)
      {
        ...
        if (NetworkUtil.isWifiConnected(this.jdField_a_of_type_AndroidAppActivity))
        {
          localrmt.a("operation_guide", (BaseResData)localObject);
          bool2 = bool1;
        }
      }
    }
  ...
  private void j()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoySkinGuideView != null)
    {
      ...
      ((FrameLayout)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131365160)).removeView(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoySkinGuideView);
  ...
  public void a()
  {
    super.a();
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    localQQAppInterface.addObserver(this.jdField_a_of_type_Rmz);
    localQQAppInterface.addObserver(this.jdField_a_of_type_Pvq);
  }
  ...
  public void b()
  {
    super.b();
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    localQQAppInterface.removeObserver(this.jdField_a_of_type_Rmz);
    localQQAppInterface.removeObserver(this.jdField_a_of_type_Pvq);
  }
