...
public class bkps
  extends bjwu
{
  private final actw jdField_a_of_type_Actw = new bkpu(this);
  private View jdField_a_of_type_AndroidViewView;
  private bjde jdField_a_of_type_Bjde = new bkpt(this);
  ...
  public bkps(bkpf parambkpf, QzoneVerticalVideoTopicInfo paramQzoneVerticalVideoTopicInfo)
  {
    super(parambkpf);
  ...
  {
    paramMusicItemInfo = QQMusicDownloader.a(paramMusicItemInfo.mUrl, paramMusicItemInfo.getLocalPath(), this.jdField_a_of_type_Bjde);
    if (paramMusicItemInfo != null) {
      QQMusicDownloader.a(paramMusicItemInfo, this.jdField_a_of_type_Bjde);
    }
  }
  ...
  private void d()
  {
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(a()).inflate(2131561855, null);
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378370)).setText(this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo.e());
    Object localObject = (URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368638);
    ...
    for (;;)
    {
      localObject = (RelativeLayout)a(2131365523);
      RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams.addRule(12);
      localLayoutParams.bottomMargin = actn.a(110.0F, a());
      localLayoutParams.leftMargin = actn.a(10.0F, a());
  ...
  private void k()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAudioPlayer = new AudioPlayer(a(), this.jdField_a_of_type_Actw);
  ...
  public void a(int paramInt, @NonNull bkkm parambkkm)
  {
    ...
    {
      parambkkm.a.backgroundMusicPath = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath();
      parambkkm.a.isMuteRecordVoice = true;
      parambkkm.a.backgroundMusicOffset = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.musicStart;
      parambkkm.a.backgroundMusicDuration = ((int)ShortVideoUtils.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataMusicItemInfo.getLocalPath()));
      if (parambkkm.a.backgroundMusicDuration <= 0) {
