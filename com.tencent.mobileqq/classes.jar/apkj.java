  ...
  extends apnt
{
  ...
  public void a(EmoticonPackage paramEmoticonPackage, int paramInt, Bundle paramBundle)
  {
    ...
    {
      return;
      localObject1 = (apnf)apkf.l(this.a).getManager(43);
      if (paramInt != 0) {
        break;
      }
      ...
      paramInt = paramBundle.getInt("jsonType", apnf.c);
      paramBundle = new File(apro.r.replace("[epId]", paramEmoticonPackage.epId));
      localArrayList = new ArrayList();
      localObject2 = new apoh();
      if (paramBundle.exists()) {}
      for (paramBundle = bdcs.a(paramBundle);; paramBundle = null)
      {
        paramBundle = apnu.a(apkf.m(this.a), paramEmoticonPackage, paramInt, paramBundle, localArrayList, (apoh)localObject2);
        if (paramBundle == null) {
          break;
        }
        if (QLog.isColorLevel()) {
        ...
        bdqr.a("emotionType", "emotionActionFav", "2", paramEmoticonPackage.epId, "", "", paramBundle, "", "", "");
        return;
      }
      if ((!((apoh)localObject2).jdField_a_of_type_Boolean) && (paramEmoticonPackage.jobType != 4))
      {
        paramInt = 0;
        do
        {
          ((apoh)localObject2).jdField_a_of_type_JavaLangString = null;
          if (QLog.isColorLevel()) {
            QLog.d("FavroamingManager", 2, "addEmoticonsTask| fetchEncryptKeys count=" + paramInt);
          }
          ((apnf)localObject1).a(paramEmoticonPackage.epId, localArrayList, (apoh)localObject2);
          i = paramInt + 1;
          if (((apoh)localObject2).jdField_a_of_type_Boolean) {
            break;
          }
          paramInt = i;
        } while (i < 3);
        if (QLog.isColorLevel()) {
          QLog.d("FavroamingManager", 2, "addEmoticonsTask| fetchEncryptKeys count=" + i + " encryptKeysSuccess=" + ((apoh)localObject2).jdField_a_of_type_Boolean);
        }
      }
    ...
    if (paramEmoticonPackage.jobType == 0)
    {
      ...
      label459:
      aube localaube = (aube)apkf.o(this.a).getManager(14);
      if (localaube == null) {
        break label911;
      }
      paramBundle = localaube.a(((CustomEmotionData)localObject2).emoPath, ((CustomEmotionData)localObject2).eId);
    }
    label911:
    for (;;)
    {
      if (paramBundle == null)
      {
        ...
        ((apke)apkf.p(this.a).getManager(149)).b((CustomEmotionBase)localObject2);
      ...
      if (((apnf)localObject1).a(paramBundle, 14))
      {
      ...
      apne.a().a(this.a.jdField_a_of_type_Apns);
      ((apnf)localObject1).a(paramEmoticonPackage, false);
      return;
      ...
      bdqr.a("emotionType", "emotionActionFav", "1", paramEmoticonPackage.epId, "", bdee.b(apkf.q(this.a).getApplication()) + "", paramInt + "", "", "", "");
      return;
    }
  }
}
