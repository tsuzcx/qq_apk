  ...
  extends bcgx
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    float f;
    if ((paramView != null) && ((paramView instanceof RelativeLayout)) && ((paramView.getTag() instanceof bcjh)))
    {
      localObject1 = (bcjh)paramView.getTag();
      localObject2 = this.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (((Iterator)localObject2).hasNext())
      {
        localObject3 = (bcgw)((Iterator)localObject2).next();
        ((bcgw)localObject3).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
        localObject4 = ((bcgw)localObject3).jdField_a_of_type_JavaLangString;
        if ("title".equals(localObject4))
        {
          ...
          for (;;)
          {
            ((StructMsgItemTitle)localObject3).a(paramContext, ((bcjh)localObject1).b, paramBundle);
            break;
            ((StructMsgItemTitle)localObject3).c(String.valueOf(36));
          }
        }
        if ("pavideo".equals(localObject4)) {
          ((bcgw)localObject3).a(paramContext, ((bcjh)localObject1).a, paramBundle);
        }
      }
      if ((localObject1 != null) && (((bcjh)localObject1).b != null)) {
        ((TextView)((bcjh)localObject1).b).setMaxLines(2);
      }
      return paramView;
    }
    ...
    {
      localbcgw = (bcgw)((Iterator)localObject5).next();
      localbcgw.jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
      str = localbcgw.jdField_a_of_type_JavaLangString;
      if ("title".equals(str))
      {
        localObject1 = (StructMsgItemTitle)localbcgw;
    ...
    for (;;)
    {
      ...
      {
        paramView = localbcgw.a(paramContext, null, paramBundle);
        ...
        i = (int)(i * 0.32D);
        paramBundle.setBackgroundResource(2130841791);
        ...
        paramContext.setImageResource(2130841712);
        ...
        if (paramView != null) {
          ((bcjh)localObject3).a = paramView;
        }
        if (localObject1 != null)
        {
          ((bcjh)localObject3).b = ((View)localObject1);
          ((TextView)((bcjh)localObject3).b).setMaxLines(1);
        }
