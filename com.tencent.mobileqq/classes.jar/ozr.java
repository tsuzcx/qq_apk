  ...
  extends pbh
{
  ...
  pba jdField_a_of_type_Pba = new pba(this);
  ...
  public ozr(AppInterface paramAppInterface, aukn paramaukn, ExecutorService paramExecutorService, pou parampou, Handler paramHandler)
  {
  ...
  {
    int j = pow.a(paramFromServiceMsg, paramObject, paramMessageMicro);
  ...
  private ToServiceMsg a(poz parampoz)
  {
    if (parampoz == null) {
      return null;
    }
    if (parampoz.jdField_b_of_type_Int == -1) {
      return null;
    }
    parampoz.jdField_a_of_type_Int = 5;
    parampoz.jdField_a_of_type_Boolean = true;
    oidb_cmd0x68b.ReqBody localReqBody = new oidb_cmd0x68b.ReqBody();
    long l1 = onc.a();
    long l2 = Long.valueOf(onk.a()).longValue();
    ...
    localReqChannelPara.uint64_channel_id.set(parampoz.jdField_b_of_type_Int);
    localReqChannelPara.uint32_req_channel_list.set(1);
    a(localReqChannelPara);
    qah.a(localReqChannelPara, String.valueOf(parampoz.jdField_b_of_type_Int));
    localReqChannelPara.uint32_residence_time.set((int)qah.a(parampoz.jdField_b_of_type_Int));
    if (parampoz.jdField_a_of_type_Long != -1L) {
      localReqChannelPara.uint64_begin_recommend_seq.set(parampoz.jdField_a_of_type_Long);
    }
    if (parampoz.jdField_b_of_type_Long != -1L) {
      localReqChannelPara.uint64_end_recommend_seq.set(parampoz.jdField_b_of_type_Long);
    }
    if (parampoz.jdField_a_of_type_Boolean) {
      localReqChannelPara.uint32_req_article_list.set(1);
    }
    if (parampoz.jdField_b_of_type_Boolean) {
      localReqChannelPara.uint32_req_deleted_article_list.set(1);
    }
    if (parampoz.jdField_a_of_type_JavaUtilList != null) {
      localReqChannelPara.rpt_curr_article_list.set(parampoz.jdField_a_of_type_JavaUtilList);
    }
    localReqChannelPara.uint32_req_recommend_flag.set(parampoz.jdField_i_of_type_Int);
    label278:
    label294:
    Object localObject1;
    label412:
    ...
    label874:
    Object localObject4;
    if (parampoz.jdField_d_of_type_Boolean)
    {
      localReqChannelPara.uint32_req_video_list.set(1);
      if (!parampoz.jdField_e_of_type_Boolean) {
        break label1080;
      }
      localReqChannelPara.uint32_req_picture_list.set(1);
      if (!parampoz.jdField_f_of_type_Boolean) {
        break label1092;
      }
      localReqChannelPara.uint32_need_force_set_top.set(1);
      if (parampoz.jdField_a_of_type_ArrayOfByte != null) {
        localReqChannelPara.bytes_set_top_cookie.set(ByteStringMicro.copyFrom(parampoz.jdField_a_of_type_ArrayOfByte));
      }
      if (parampoz.jdField_b_of_type_ArrayOfByte != null) {
        localReqChannelPara.bytes_device_id.set(ByteStringMicro.copyFrom(parampoz.jdField_b_of_type_ArrayOfByte));
      }
      localReqChannelPara.uint32_update_times.set(parampoz.jdField_c_of_type_Int);
      localReqChannelPara.uint32_req_media_specs.set(1);
      if (!bhvh.a(parampoz.jdField_d_of_type_Int)) {
        localReqChannelPara.uint32_is_support_video_with_small_picture.set(1);
      }
      localReqChannelPara.uint32_is_support_packinfo.set(1);
      localReqChannelPara.uint32_privacy_status.set(shh.b());
      ...
      if (parampoz.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData != null)
      {
        localObject3 = new oidb_cmd0x68b.ChannelLocationInfo();
        ((oidb_cmd0x68b.ChannelLocationInfo)localObject3).city.set(ByteStringMicro.copyFromUtf8(parampoz.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData.city));
        ((oidb_cmd0x68b.ChannelLocationInfo)localObject3).province.set(ByteStringMicro.copyFromUtf8(parampoz.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData.province));
        ((oidb_cmd0x68b.ChannelLocationInfo)localObject3).nation.set(ByteStringMicro.copyFromUtf8(parampoz.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData.country));
        ((oidb_cmd0x68b.ChannelLocationInfo)localObject3).city_code.set(ByteStringMicro.copyFromUtf8(parampoz.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData.cityCode));
        localReqChannelPara.msg_channel_location_info.set((MessageMicro)localObject3);
        if (QLog.isColorLevel()) {
          QLog.i("ArticleInfoModule", 1, "0x68b request positionInfo = " + parampoz.jdField_a_of_type_ComTencentBizPubaccountReadinjoyModelSelectPositionModule$PositionData);
        }
      }
      QLog.i("ArticleInfoModule", 1, "0x68b request brand = " + (String)localObject1 + ", model = " + (String)localObject2);
      localObject1 = new ArrayList();
      if ((parampoz.jdField_i_of_type_Boolean) && (parampoz.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructLebaKDCellInfo != null))
      {
        localObject2 = new oidb_cmd0x68b.InnerMsg();
        ((oidb_cmd0x68b.InnerMsg)localObject2).uint32_jump_src_type.set(4);
        ((oidb_cmd0x68b.InnerMsg)localObject2).bytes_inner_uniq_id.set(ByteStringMicro.copyFromUtf8(String.valueOf(parampoz.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructLebaKDCellInfo.articleID)));
        ((oidb_cmd0x68b.InnerMsg)localObject2).template_id.set(parampoz.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructLebaKDCellInfo.templateID);
        ((oidb_cmd0x68b.InnerMsg)localObject2).bytes_push_context.set(ByteStringMicro.copyFromUtf8(parampoz.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructLebaKDCellInfo.extraInfo));
        ((List)localObject1).add(localObject2);
      }
      if (TextUtils.isEmpty(parampoz.jdField_a_of_type_JavaLangString)) {
        break label1172;
      }
      localObject2 = new oidb_cmd0x68b.InnerMsg();
      if (parampoz.jdField_h_of_type_Int != 5) {
        break label1120;
      }
      ((oidb_cmd0x68b.InnerMsg)localObject2).uint32_jump_src_type.set(5);
      ((oidb_cmd0x68b.InnerMsg)localObject2).bytes_inner_uniq_id.set(ByteStringMicro.copyFromUtf8(parampoz.jdField_a_of_type_JavaLangString));
      if (!TextUtils.isEmpty(parampoz.jdField_b_of_type_JavaLangString)) {
        ((oidb_cmd0x68b.InnerMsg)localObject2).bytes_title.set(ByteStringMicro.copyFromUtf8(parampoz.jdField_b_of_type_JavaLangString));
      }
      if (!TextUtils.isEmpty(parampoz.jdField_c_of_type_JavaLangString))
      {
        ((oidb_cmd0x68b.InnerMsg)localObject2).bytes_push_context.set(ByteStringMicro.copyFromUtf8(parampoz.jdField_c_of_type_JavaLangString));
        if (QLog.isColorLevel()) {
          QLog.d("ArticleInfoModule", 2, "add push contenxt:" + parampoz.jdField_c_of_type_JavaLangString);
        }
      }
      ((List)localObject1).add(localObject2);
      if ((parampoz.jdField_b_of_type_JavaUtilList == null) || (parampoz.jdField_b_of_type_JavaUtilList.size() <= 0)) {
        break label1344;
      }
      localObject2 = parampoz.jdField_b_of_type_JavaUtilList.iterator();
      label904:
      ...
      if (parampoz.jdField_h_of_type_Int <= 0) {
        break label1332;
      }
      ((oidb_cmd0x68b.InnerMsg)localObject4).uint32_jump_src_type.set(parampoz.jdField_h_of_type_Int);
    }
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(parampoz.jdField_c_of_type_JavaLangString))
      {
        ((oidb_cmd0x68b.InnerMsg)localObject4).bytes_push_context.set(ByteStringMicro.copyFromUtf8(parampoz.jdField_c_of_type_JavaLangString));
        if (QLog.isColorLevel()) {
          QLog.d("ArticleInfoModule", 2, "add push contenxt:" + parampoz.jdField_c_of_type_JavaLangString);
        }
      }
      ((oidb_cmd0x68b.InnerMsg)localObject4).uint64_algorithm_id.set(parampoz.jdField_d_of_type_Long);
      ((oidb_cmd0x68b.InnerMsg)localObject4).uint32_strategy_id.set((int)parampoz.jdField_e_of_type_Long);
      ...
      break label864;
      label1172:
      if (parampoz.jdField_c_of_type_Long == -1L) {
        break label874;
      }
      localObject2 = new ArrayList();
      localObject3 = new oidb_cmd0x68b.SubscribeMsg();
      ((oidb_cmd0x68b.SubscribeMsg)localObject3).uint64_source_article_id.set(parampoz.jdField_c_of_type_Long);
      if (!TextUtils.isEmpty(parampoz.jdField_b_of_type_JavaLangString)) {
        ((oidb_cmd0x68b.SubscribeMsg)localObject3).bytes_title.set(ByteStringMicro.copyFromUtf8(parampoz.jdField_b_of_type_JavaLangString));
      }
      ...
      ((oidb_cmd0x68b.InnerMsg)localObject2).bytes_inner_uniq_id.set(ByteStringMicro.copyFromUtf8(String.valueOf(parampoz.jdField_c_of_type_Long)));
      if (!TextUtils.isEmpty(parampoz.jdField_b_of_type_JavaLangString)) {
        ((oidb_cmd0x68b.InnerMsg)localObject2).bytes_title.set(ByteStringMicro.copyFromUtf8(parampoz.jdField_b_of_type_JavaLangString));
      }
      ((List)localObject1).add(localObject2);
    ...
    label1344:
    if (parampoz.jdField_b_of_type_Int == 40830)
    {
      localObject2 = new oidb_cmd0x68b.InnerMsg();
      if (parampoz.jdField_h_of_type_Int <= 0) {
        break label1671;
      }
      ((oidb_cmd0x68b.InnerMsg)localObject2).uint32_jump_src_type.set(parampoz.jdField_h_of_type_Int);
    }
    for (;;)
    {
      if (!TextUtils.isEmpty(parampoz.jdField_c_of_type_JavaLangString))
      {
        ((oidb_cmd0x68b.InnerMsg)localObject2).bytes_push_context.set(ByteStringMicro.copyFromUtf8(parampoz.jdField_c_of_type_JavaLangString));
        if (QLog.isColorLevel()) {
          QLog.d("ArticleInfoModule", 2, "troop subscribe add push contenxt:" + parampoz.jdField_c_of_type_JavaLangString);
        }
      }
      ((List)localObject1).add(localObject2);
      label1452:
      if ((parampoz.jdField_c_of_type_JavaUtilList == null) || (parampoz.jdField_c_of_type_JavaUtilList.isEmpty())) {
        break;
      }
      localObject2 = parampoz.jdField_c_of_type_JavaUtilList.iterator();
      while (((Iterator)localObject2).hasNext())
      {
        localObject3 = (orz)((Iterator)localObject2).next();
        QLog.d("ArticleInfoModule", 2, "InsertArticleInfo :" + localObject3);
        localObject4 = new oidb_cmd0x68b.InnerMsg();
        ((oidb_cmd0x68b.InnerMsg)localObject4).uint32_jump_src_type.set(poz.a((orz)localObject3));
        ((oidb_cmd0x68b.InnerMsg)localObject4).bytes_inner_uniq_id.set(ByteStringMicro.copyFromUtf8(String.valueOf(((orz)localObject3).jdField_a_of_type_Long)));
        if (!TextUtils.isEmpty(parampoz.jdField_c_of_type_JavaLangString)) {
          ((oidb_cmd0x68b.InnerMsg)localObject4).bytes_push_context.set(ByteStringMicro.copyFromUtf8(parampoz.jdField_c_of_type_JavaLangString));
        }
        ((oidb_cmd0x68b.InnerMsg)localObject4).uint64_algorithm_id.set(parampoz.jdField_d_of_type_Long);
        ...
        if (parampoz.jdField_b_of_type_JavaUtilList == null) {
          parampoz.jdField_b_of_type_JavaUtilList = new ArrayList();
        }
        parampoz.jdField_b_of_type_JavaUtilList.add(0, Long.valueOf(((orz)localObject3).jdField_a_of_type_Long));
      }
      label1671:
      ((oidb_cmd0x68b.InnerMsg)localObject2).uint32_jump_src_type.set(1);
    }
    oxx.a(parampoz, (List)localObject1);
    if (parampoz.jdField_b_of_type_JavaUtilList != null) {
      localReqChannelPara.rpt_subscription_article_list.set(parampoz.jdField_b_of_type_JavaUtilList);
    }
    if (parampoz.jdField_a_of_type_Pqp != null)
    {
      localObject2 = new oidb_cmd0x68b.UserReadArticle();
      ((oidb_cmd0x68b.UserReadArticle)localObject2).uint64_source.set(1L);
      localObject3 = new ArrayList();
      localObject4 = parampoz.jdField_a_of_type_Pqp.a.iterator();
      ...
      localObject3 = new ArrayList();
      localObject4 = parampoz.jdField_a_of_type_Pqp.b.iterator();
      while (((Iterator)localObject4).hasNext()) {
        ((List)localObject3).add(ByteStringMicro.copyFromUtf8((String)((Iterator)localObject4).next()));
      }
    ...
    if ((parampoz.jdField_d_of_type_JavaUtilList != null) && (parampoz.jdField_d_of_type_JavaUtilList.size() > 0))
    {
      localObject1 = new ArrayList();
      localObject2 = parampoz.jdField_d_of_type_JavaUtilList.iterator();
      while (((Iterator)localObject2).hasNext()) {
        ((List)localObject1).add(((poy)((Iterator)localObject2).next()).a());
      }
      localReqChannelPara.rpt_pkg_install_info.set((List)localObject1);
    }
    if (onk.q())
    {
      localObject1 = a(parampoz.jdField_b_of_type_Int);
    ...
    localReqBody.uint32_req_dislike_type.set(parampoz.jdField_e_of_type_Int);
    if (onc.b(l1)) {
      onc.a(parampoz);
    }
    localReqBody.uint64_client_swithes.set(parampoz.jdField_f_of_type_Int);
    localReqBody.enum_refresh_type.set(parampoz.jdField_g_of_type_Int);
    if ((parampoz.jdField_b_of_type_Int == 0) && (onk.a()))
    {
      localObject1 = new oidb_cmd0x68b.RefreshHistory();
      ((oidb_cmd0x68b.RefreshHistory)localObject1).bytes_session_id.set(ByteStringMicro.copyFromUtf8(onk.i()));
      ((oidb_cmd0x68b.RefreshHistory)localObject1).rpt_refresh_history.set(onk.a());
      if (QLog.isColorLevel()) {
        QLog.d("ArticleInfoModule", 2, "session_id = " + onk.i() + ", history = " + onk.a().toString());
      }
      localReqBody.msg_refresh_history.set((MessageMicro)localObject1);
    }
    int i;
    int j;
    if (parampoz.jdField_h_of_type_Boolean)
    {
      localObject1 = (oso)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(163);
      if (localObject1 != null)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("ArticleInfoModule", 2, "AdvertisementInfoModule reqAdvertisementList params.beginRecommendSeq = " + parampoz.jdField_a_of_type_Long);
        }
        i = 0;
        j = 30;
        osj.a().a(parampoz.jdField_b_of_type_Int, true);
        if (QLog.isColorLevel()) {
          QLog.d("ArticleInfoModule", 2, "AdvertisementInfoModule reqAdvertisementList  adStartPos = " + i + " adEndPos" + j);
        }
        if (osj.a().a(parampoz.jdField_b_of_type_Int))
        {
          if (QLog.isColorLevel()) {
            QLog.d("ArticleInfoModule", 2, "AdvertisementInfoModule reqAdvertisementList needRequestAdvertisement channelID= " + parampoz.jdField_b_of_type_Int);
          }
          int k = 1;
          if ((parampoz.jdField_g_of_type_Int == 2) || (parampoz.jdField_g_of_type_Int == 4)) {
            k = 2;
          }
          localObject2 = ((oso)localObject1).a().a(parampoz, parampoz.jdField_b_of_type_Int, k, i, j);
          ((oso)localObject1).a().a(parampoz.jdField_b_of_type_Int, i, j);
    ...
    if (parampoz.jdField_b_of_type_Int == 41403)
    {
      localObject1 = akug.a("nearby_readinjoy");
      ...
      if (parampoz.jdField_a_of_type_Long != -1L)
      {
        localObject1 = (String)bhvh.a("readinjoy_nearby_people_last_refresh_cookie_sp_key", "");
    ...
    if (parampoz.jdField_b_of_type_Int == 41403)
    {
      localObject1 = pow.a("OidbSvc.0xbf7", 3063, parampoz.j, localReqBody.toByteArray());
      QLog.d("ArticleInfoModule", 1, new Object[] { "make 0xbf7 OIDB Pkg, beginSeq = ", Long.valueOf(parampoz.jdField_a_of_type_Long), ", endSeq = ", Long.valueOf(parampoz.jdField_b_of_type_Long) });
      label2787:
      ((ToServiceMsg)localObject1).getAttributes().put(jdField_c_of_type_JavaLangString, Integer.valueOf(parampoz.jdField_a_of_type_Int));
      ((ToServiceMsg)localObject1).getAttributes().put(jdField_d_of_type_JavaLangString, Long.valueOf(parampoz.jdField_a_of_type_Long));
      ((ToServiceMsg)localObject1).getAttributes().put(jdField_e_of_type_JavaLangString, Long.valueOf(parampoz.jdField_b_of_type_Long));
      ((ToServiceMsg)localObject1).getAttributes().put(jdField_f_of_type_JavaLangString, Integer.valueOf(1));
      ((ToServiceMsg)localObject1).getAttributes().put(jdField_b_of_type_JavaLangString, Integer.valueOf(parampoz.jdField_g_of_type_Int));
      ((ToServiceMsg)localObject1).getAttributes().put("recommendFlag", Integer.valueOf(parampoz.jdField_i_of_type_Int));
      if (parampoz.jdField_b_of_type_JavaUtilList != null) {
        ((ToServiceMsg)localObject1).getAttributes().put("SubscriptionArticles", parampoz.jdField_b_of_type_JavaUtilList);
      }
      a(localReqBody, (ToServiceMsg)localObject1, l1);
      onc.a((ToServiceMsg)localObject1, l1);
      ((ToServiceMsg)localObject1).getAttributes().put("channelID", new Integer(parampoz.jdField_b_of_type_Int));
      ((ToServiceMsg)localObject1).getAttributes().put("isSingleHighLight", Boolean.valueOf(parampoz.jdField_g_of_type_Boolean));
      ((ToServiceMsg)localObject1).getAttributes().put("clientSwithes", Integer.valueOf(parampoz.jdField_f_of_type_Int));
      localObject2 = ((ToServiceMsg)localObject1).getAttributes();
      if ((parampoz.jdField_b_of_type_JavaUtilList == null) || (parampoz.jdField_b_of_type_JavaUtilList.isEmpty())) {
        break label3414;
      }
      bool = true;
      label3027:
      ...
      localObject2 = ((ToServiceMsg)localObject1).getAttributes();
      if ((parampoz.jdField_i_of_type_Int & 0x100) == 0) {
        break label3420;
      }
    }
    label3079:
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      return localObject1;
      localObject2 = osj.a().a(parampoz.jdField_b_of_type_Int);
      if (localObject2 != null)
      {
        if (QLog.isColorLevel()) {
      ...
      localObject2 = (ConcurrentHashMap)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(Integer.valueOf(parampoz.jdField_b_of_type_Int));
      if (localObject2 == null) {
        break;
      }
      if (QLog.isColorLevel()) {
      ...
      j = i + 10;
      break;
      if ((oox.c(parampoz.jdField_b_of_type_Int)) || (bhvh.a(parampoz.jdField_b_of_type_Int)))
      {
        localReqBody.bytes_style_version.set(ByteStringMicro.copyFromUtf8(rqg.a("default_feeds")));
        if (bhvh.v())
        {
          localObject1 = pbb.a(parampoz.jdField_b_of_type_Int);
          if (!TextUtils.isEmpty((CharSequence)localObject1)) {
            localReqBody.bytes_nearby_cookie.set(ByteStringMicro.copyFromUtf8((String)localObject1));
          }
          localObject1 = pow.a("OidbSvc.0xcba", 3258, 0, localReqBody.toByteArray());
          ((ToServiceMsg)localObject1).getAttributes().put("realTimeServiceKey", "default_feeds");
          QLog.d("ArticleInfoModule", 1, new Object[] { "make 0xcba OIDB Pkg, beginSeq = ", Long.valueOf(parampoz.jdField_a_of_type_Long), ", endSeq = ", Long.valueOf(parampoz.jdField_b_of_type_Long) });
          break label2787;
        }
      }
      localObject1 = pow.a("OidbSvc.0x68b", 1675, parampoz.j, localReqBody.toByteArray());
      break label2787;
      bool = false;
      break label3027;
    }
  ...
  private oidb_cmd0x46f.DislikeParam a(qaw paramqaw)
  {
    oidb_cmd0x46f.DislikeParam localDislikeParam = new oidb_cmd0x46f.DislikeParam();
    localDislikeParam.uint64_articleid.set(paramqaw.jdField_a_of_type_Long);
    localDislikeParam.uint32_reasonid.set(paramqaw.jdField_a_of_type_Int);
    localDislikeParam.uint64_feeds_id.set(paramqaw.jdField_b_of_type_Long);
    localDislikeParam.uint64_biu_uin.set(paramqaw.jdField_c_of_type_Long);
    localDislikeParam.uint64_topic_id.set(paramqaw.jdField_d_of_type_Long);
    if ((paramqaw.jdField_a_of_type_JavaLangString != null) && (paramqaw.jdField_a_of_type_JavaLangString.length() > 0)) {
      localDislikeParam.bytes_rowkey.set(ByteStringMicro.copyFromUtf8(paramqaw.jdField_a_of_type_JavaLangString));
    }
    Object localObject1;
    Object localObject2;
    if ((paramqaw.jdField_a_of_type_JavaUtilList != null) && (paramqaw.jdField_a_of_type_JavaUtilList.size() > 0))
    {
      localObject1 = paramqaw.jdField_a_of_type_JavaUtilList.iterator();
    ...
    if ((paramqaw.jdField_a_of_type_JavaUtilArrayList != null) && (paramqaw.jdField_a_of_type_JavaUtilArrayList.size() > 0))
    {
      paramqaw = paramqaw.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (paramqaw.hasNext())
      {
        localObject1 = (DislikeInfo)paramqaw.next();
  ...
  private void a(int paramInt, List<Long> paramList, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        localObject = sgj.b((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramList);
        String str = sgj.a(paramList);
        sgj.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, str, String.valueOf(l), (String)localObject, paramBoolean);
      }
      ...
      {
        localObject = (otp)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(274);
        if (localObject != null) {
          ((otp)localObject).a(sgj.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramList), l);
        }
      }
    ...
    } while ((!oox.c(paramInt)) || (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) || (paramList == null));
  ...
  private void a(long paramLong, int paramInt, oidb_cmd0x8c8.SocializeFeedsInfo paramSocializeFeedsInfo)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      {
        qdt localqdt = localArticleInfo.mTopicRecommendFeedsInfo;
        if ((paramSocializeFeedsInfo.msg_topic_recommend_feeds_info.has()) && (localqdt != null) && (localqdt.jdField_a_of_type_JavaUtilArrayList != null))
        {
          ...
          if (((oidb_cmd0x8c8.TopicRecommendFeedsInfo)localObject).msg_topic_recommend_info.has())
          {
            ...
            paramInt = 0;
            while ((paramInt < ((List)localObject).size()) && (paramInt < localqdt.jdField_a_of_type_JavaUtilArrayList.size()))
            {
              oidb_cmd0x8c8.TopicRecommendInfo localTopicRecommendInfo = (oidb_cmd0x8c8.TopicRecommendInfo)((List)localObject).get(paramInt);
              qdv localqdv = (qdv)localqdt.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
  ...
  private void a(ToServiceMsg paramToServiceMsg, Object paramObject, int paramInt, Integer paramInteger)
  {
    ...
    j = nar.a(BaseApplicationImpl.context);
    boolean bool = bbev.g(BaseApplicationImpl.context);
    ...
    {
      onk.a(paramObject, bool, System.currentTimeMillis() - paramToServiceMsg.extraData.getLong("sendtimekey"), localHashMap);
      return;
    }
  }
    ...
    for (int k = ((Bundle)localObject9).getInt("FeedsRefreshType");; k = 0)
    {
          ...
          if (((l >> 9 & 1L) == 1L) && (paramRspBody.msg_rsp_get_follow_tab_data.has()))
          {
            ...
            if ((((oidb_cmd0x68b.RspGetFollowTabData)localObject6).bytes_set_top_cookie.has()) && (((oidb_cmd0x68b.RspGetFollowTabData)localObject6).bytes_set_top_cookie.get() != null))
            {
              ...
              for (bool1 = true;; bool1 = false)
              {
                ...
                localObject5 = pot.a(((oidb_cmd0x68b.RspGetFollowTabData)localObject6).rpt_article_list.get());
                if (localObject5 != null) {
                  a((List)localObject5, ((Integer)localObject2).intValue());
                }
                if (omx.a()) {
                  omx.a().a(((Integer)localObject2).intValue(), ((oidb_cmd0x68b.RspGetFollowTabData)localObject6).rpt_article_list.get(), (List)localObject5);
                }
                ...
                for (;;)
                {
                  ...
                  if ((((ArticleInfo)localObject3).mSocialFeedInfo != null) && (((ArticleInfo)localObject3).mSocialFeedInfo.jdField_a_of_type_Qdh != null)) {
                    QLog.d("ArticleInfoModule", 2, "0x68b rpt article articleID = " + ((ArticleInfo)localObject3).mArticleID + " mRecommendSeq = " + ((ArticleInfo)localObject3).mRecommendSeq + " ChannelID = " + ((ArticleInfo)localObject3).mChannelID + " wendainfo = " + ((ArticleInfo)localObject3).mSocialFeedInfo.jdField_a_of_type_Qdh.toString() + " followStatus = " + ((ArticleInfo)localObject3).mSocialFeedInfo.jdField_h_of_type_Int);
                  }
              ...
              if (((oidb_cmd0x68b.RspGetFollowTabData)localObject6).uint32_has_followed_topic.has())
              {
                ...
                {
                  bool2 = true;
                  ((osj)localObject5).d(bool2);
                }
              }
              else
              {
                if (((oidb_cmd0x68b.RspGetFollowTabData)localObject6).uint32_topic_reddot_update_num.has()) {
                  osj.a().f(((oidb_cmd0x68b.RspGetFollowTabData)localObject6).uint32_topic_reddot_update_num.get());
                }
                if ((((oidb_cmd0x68b.RspGetFollowTabData)localObject6).uint32_refresh_topic_update_info.has()) && (((oidb_cmd0x68b.RspGetFollowTabData)localObject6).uint32_refresh_topic_update_info.get() == 1))
                {
                  ...
                  localObject5 = qdt.a((articlesummary.TopicRecommendFeedsInfo)((oidb_cmd0x68b.RspGetFollowTabData)localObject6).topic_update_info.get());
                  osj.a().a((qdt)localObject5);
                  osj.a().p();
                }
                ...
                {
                  localObject5 = bbca.encodeToString(((oidb_cmd0x68b.RspGetFollowTabData)localObject6).bytes_refresh_cookie.get().toByteArray(), 0);
                  osj.a().f((String)localObject5);
                ...
                if ((paramRspBody.bytes_new_style_params.has()) && (paramRspBody.bytes_new_style_params.get() != null))
                {
                  ...
                  if (localObject5 != null) {
                    rqg.a((String)localObject5, (String)localObject6);
                  }
                }
              ...
              for (bool1 = true;; bool1 = false)
              {
                ...
                localObject2 = pot.a(((oidb_cmd0x68b.RspChannelArticle)localObject7).rpt_article_list.get(), ((Integer)localObject5).intValue(), k, i);
                if (omx.a()) {
                  omx.a().a(((oidb_cmd0x68b.RspChannelArticle)localObject7).rpt_article_list.get(), (List)localObject2, ((Integer)localObject5).intValue());
                }
                ...
                while (((Iterator)localObject3).hasNext())
                {
                  ...
                  if ((((ArticleInfo)localObject6).mSocialFeedInfo != null) && (((ArticleInfo)localObject6).mSocialFeedInfo.jdField_a_of_type_Qdh != null)) {
                    QLog.d("ArticleInfoModule", 2, "0x68b rspChannelArticle article articleID = " + ((ArticleInfo)localObject6).mArticleID + " mRecommendSeq = " + ((ArticleInfo)localObject6).mRecommendSeq + " ChannelID = " + ((ArticleInfo)localObject6).mChannelID + " wendainfo = " + ((ArticleInfo)localObject6).mSocialFeedInfo.jdField_a_of_type_Qdh.toString() + " followStatus = " + ((ArticleInfo)localObject6).mSocialFeedInfo.jdField_h_of_type_Int);
                  }
                }
                bool2 = false;
                break;
              ...
              for (;;)
              {
                try
                {
                  ...
                  noo.a(null, "0X8009650", "0X8009650", "", 0, 0, "", "", "", ((JSONObject)localObject6).toString(), false);
                  label1561:
                  ...
                  localObject3 = pot.a(((oidb_cmd0x68b.RspChannelArticle)localObject7).rpt_deleted_article_list.get(), ((Integer)localObject5).intValue(), k, i);
                  label1605:
                  ...
                  localObject1 = (oso)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(163);
                  if (localObject1 != null) {
                    ((oso)localObject1).a().a(paramToServiceMsg, (oidb_cmd0x68b.RspChannelArticle)localObject7);
                  }
                  if ((((oidb_cmd0x68b.RspChannelArticle)localObject7).bytes_nearby_cookie.has()) && (((oidb_cmd0x68b.RspChannelArticle)localObject7).bytes_nearby_cookie.get() != null))
                  {
                    ...
                    if (!TextUtils.isEmpty((CharSequence)localObject1))
                    {
                      bhvh.a("sp_key_daily_dynamic_header_data", localObject1);
                      osj.a().j((String)localObject1);
                      bhvh.a("readinjoy_nearby_people_last_refresh_cookie_sp_key", localObject1);
                      oox.a((String)localObject1);
                    }
                  }
                  ...
                  {
                    localObject8 = new qaj();
                    ((qaj)localObject8).jdField_b_of_type_JavaUtilList = ((List)localObject2);
                    ((qaj)localObject8).jdField_a_of_type_JavaUtilList = ((oidb_cmd0x68b.RspChannelArticle)localObject7).rpt_back_off_group_info.get();
                    qad.a().a(localObject8, qad.jdField_a_of_type_Int);
                  }
              ...
              if (paramRspBody.msg_rsp_trace.has()) {
                onk.a(onk.a(), paramRspBody.msg_rsp_trace.rpt_trace_record_list.get());
              }
              bool3 = true;
              bool2 = bool1;
              bool1 = bool3;
      ...
      for (;;)
      {
        if (pcz.a(paramToServiceMsg))
        {
          ...
          localObject5 = new pcu();
          paramToServiceMsg = ((pcu)localObject5).a(paramToServiceMsg).a(((Integer)localObject2).intValue()).b(paramInt).a((List)localObject1).b(paramRspBody).a(bool1).b(bool2).a(localJSONException);
          if (!TextUtils.isEmpty((CharSequence)localObject6)) {}
          for (;;)
          {
            paramToServiceMsg.a((String)localObject6);
            pcv.a().a((pcu)localObject5);
            return;
            localObject6 = "";
          }
        }
        ...
        for (paramInt = 1;; paramInt = 0)
        {
          ...
          for (;;)
          {
            try
            {
              ...
              paramRspBody.put("zhitiao_num_daily", pce.a(BaseApplicationImpl.getApplication(), BaseApplicationImpl.getApplication().getRuntime().getAccount()));
            }
            ...
            noo.a(null, "", "0X800A6EC", "0X800A6EC", 0, 1, "", "", "", paramRspBody.toString(), false);
            return;
            i = 0;
            continue;
            i = 2;
  ...
  private void a(ArrayList<ArticleInfo> paramArrayList, qay paramqay)
  {
    paramqay = paramqay.jdField_a_of_type_JavaUtilArrayList;
    ...
    for (;;)
    {
      ...
      Iterator localIterator = paramqay.iterator();
      if (localIterator.hasNext())
      {
        qaz localqaz = (qaz)localIterator.next();
        if (localArticleInfo.mFeedId != localqaz.jdField_a_of_type_Long) {
          break;
        }
        localArticleInfo.mRecommendSeq = localqaz.jdField_c_of_type_Long;
        localArticleInfo.mFeedType = localqaz.jdField_a_of_type_Int;
        localArticleInfo.mAlgorithmID = localqaz.jdField_b_of_type_Long;
        localArticleInfo.mStrategyId = localqaz.jdField_b_of_type_Int;
      }
    }
  }
  ...
  private void a(List<ArticleInfo> paramList, int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 1664	ozr:jdField_a_of_type_Aukn	Laukn;
    //   4: invokevirtual 1669	aukn:a	()Laukp;
    //   7: invokevirtual 1673	aukp:a	()V
    //   10: aload_1
    ...
    //   35: astore_3
    //   36: aload_3
    //   37: getfield 1677	com/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo:mExtraBiuBriefInfo	Lqay;
    //   40: ifnull -23 -> 17
    //   43: aload_3
    //   44: getfield 1677	com/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo:mExtraBiuBriefInfo	Lqay;
    //   47: getfield 1647	qay:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   50: ifnull -33 -> 17
    //   53: aload_3
    //   54: getfield 1677	com/tencent/biz/pubaccount/readinjoy/struct/ArticleInfo:mExtraBiuBriefInfo	Lqay;
    //   57: getfield 1647	qay:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   79: checkcast 1649	qaz
    //   82: astore 4
    //   84: aload_0
    //   85: getfield 1664	ozr:jdField_a_of_type_Aukn	Laukn;
    //   88: ldc 160
    //   90: ldc_w 1679
    //   93: iconst_2
    ...
    //   105: iconst_1
    //   106: aload 4
    //   108: getfield 1650	qaz:jdField_a_of_type_Long	J
    //   111: invokestatic 445	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   114: aastore
    //   115: invokevirtual 1682	aukn:a	(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/String;)Laukm;
    //   118: astore 4
    //   120: aload 4
    //   122: ifnull -58 -> 64
    //   125: aload_0
    //   126: getfield 1664	ozr:jdField_a_of_type_Aukn	Laukn;
    //   129: aload 4
    //   131: invokevirtual 1684	aukn:b	(Laukm;)Z
    //   134: pop
    //   135: goto -71 -> 64
    //   138: astore_1
    //   139: aload_1
    ...
    //   172: aload_0
    //   173: getfield 1664	ozr:jdField_a_of_type_Aukn	Laukn;
    //   176: invokevirtual 1669	aukn:a	()Laukp;
    //   179: invokevirtual 1695	aukp:b	()V
    //   182: return
    //   183: aload_0
    //   184: getfield 1664	ozr:jdField_a_of_type_Aukn	Laukn;
    //   187: invokevirtual 1669	aukn:a	()Laukp;
    //   190: invokevirtual 1697	aukp:c	()V
    //   193: aload_0
    //   194: getfield 1664	ozr:jdField_a_of_type_Aukn	Laukn;
    //   197: invokevirtual 1669	aukn:a	()Laukp;
    //   200: invokevirtual 1695	aukp:b	()V
    //   203: return
    //   204: astore_1
    //   205: aload_0
    //   206: getfield 1664	ozr:jdField_a_of_type_Aukn	Laukn;
    //   209: invokevirtual 1669	aukn:a	()Laukp;
    //   212: invokevirtual 1695	aukp:b	()V
    //   215: aload_1
    //   216: athrow
  ...
  private void a(List<Long> paramList, oidb_cmd0x68b.RspBody paramRspBody, long paramLong)
  {
    ...
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        noo.a(null, "", "0X8009483", "0X8009483", 0, 0, paramRspBody.toString(), "", "", "", false);
        return;
      }
  ...
  private void a(oidb_cmd0x68b.ReqBody paramReqBody, ToServiceMsg paramToServiceMsg, long paramLong)
  {
    ...
    i = nar.a(BaseApplicationImpl.context);
    bool = bbev.g(BaseApplicationImpl.context);
    ...
    paramToServiceMsg.getAttributes().put("compressFlag", Boolean.valueOf(onc.b(paramLong)));
  }
  ...
  private void a(oidb_cmd0x68b.ReqChannelPara paramReqChannelPara)
  {
    ...
    if (i < k)
    {
      ...
      if (bbfd.a(BaseApplicationImpl.getContext(), (String)localObject1)) {}
      for (int j = 1;; j = 0)
      {
        localPBUInt32Field.set(j);
        ((oidb_cmd0x68b.PkgInstallInfo)localObject3).uint32_platform_type.set(1);
        ((oidb_cmd0x68b.PkgInstallInfo)localObject3).bytes_version.set(ByteStringMicro.copyFromUtf8(bbfd.a(BaseApplicationImpl.getContext(), (String)localObject1)));
  ...
  private void a(boolean paramBoolean1, int paramInt, boolean paramBoolean2, List<ArticleInfo> paramList, long paramLong1, long paramLong2)
  {
    ...
    if (this.jdField_a_of_type_Ozu != null) {
      localList1 = this.jdField_a_of_type_Ozu.a(paramInt, localList2, paramList);
    }
    ...
    for (;;)
    {
      ...
      if (paramInt == 0) {
        shx.a(paramList, localList1, false);
      }
      for (;;)
      {
        osm.a().b(true, paramInt, localList1, paramBoolean1);
        return;
        paramBoolean1 = false;
        break;
        paramBoolean1 = false;
        break label134;
        if (oox.c(paramInt)) {
          olm.a(paramList, localList1, false);
        }
      }
    }
  }
  ...
  private void a(boolean paramBoolean1, int paramInt, boolean paramBoolean2, List<ArticleInfo> paramList1, long paramLong1, long paramLong2, List<ArticleInfo> paramList2, ToServiceMsg paramToServiceMsg)
  {
    ...
    if (paramBoolean1)
    {
      ...
      if ((paramInt == 70) || (paramInt == 41403) || (oox.a(paramInt)) || (bhvh.a(paramInt))) {
        break label463;
      }
      if ((paramBoolean2) && (!onk.c(paramInt)))
      {
    ...
    for (boolean bool = ((Boolean)localObject).booleanValue();; bool = false)
    {
      if (paramInt == 0)
      {
        shx.a(paramList1, paramList2, bool);
        shx.a(paramList1);
        localObject = (List)paramToServiceMsg.getAttributes().get("SubscriptionArticles");
        if ((localObject != null) && (((List)localObject).size() > 0)) {
          osm.a().a(paramBoolean1, (List)localObject, paramList1);
        }
        osm.a().a(paramBoolean1, paramInt, paramList2, paramBoolean2);
        ppd.a().a(paramInt, paramList2, paramBoolean1, paramBoolean2, paramToServiceMsg);
        if (paramBoolean1) {
          if (paramList1 == null) {
            break label554;
          }
      ...
      for (int i = paramList1.size();; i = 0)
      {
        ...
        olm.a(paramList1, paramList2, bool);
        break label296;
      }
    }
  }
        ...
        for (;;)
        {
          if (localConcurrentHashMap2.get(paramArticleInfo.mVideoVid) != null)
          {
            ...
            if (localArticleInfo.mArticleID != paramArticleInfo.mArticleID)
            {
              ...
              if (QLog.isColorLevel()) {
                QLog.e("ArticleInfoModule", 2, "saveArticleInfo, find article vid duplicated! old article: channelID=" + paramInteger + ", id=" + localArticleInfo.mArticleID + "，seq: " + localArticleInfo.mRecommendSeq + ", title: " + onk.c(localArticleInfo.mTitle) + "，vid =" + localArticleInfo.mVideoVid + "\n new article  id : " + paramArticleInfo.mArticleID + " seq : " + paramArticleInfo.mRecommendSeq + " title : " + onk.c(paramArticleInfo.mTitle) + "，vid =" + paramArticleInfo.mVideoVid);
              }
            }
          }
  ...
  private boolean a(poz parampoz, long paramLong)
  {
    if ((pcz.a(parampoz)) && (!pcz.b(parampoz)))
    {
      parampoz = pcv.a().a(parampoz);
      if (parampoz != null)
      {
        long l1 = System.currentTimeMillis();
        long l2 = ((Long)bhvh.a("sp_key_readinjoy_feeds_preload_loading_time", Long.valueOf(50L))).longValue();
        ThreadManager.getUIHandler().postDelayed(new ArticleInfoModule.2(this, l2, l1, parampoz, paramLong), l2);
        return true;
      }
    }
    return false;
  ...
  private List<Long> b(int paramInt1, int paramInt2, long paramLong, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Pba.a(Integer.valueOf(paramInt1), localArrayList);
    return localArrayList;
  }
  ...
  private void b(List<ArticleInfo> paramList)
  {
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if ((((ArticleInfo)localObject).mSocialFeedInfo != null) && (((ArticleInfo)localObject).mSocialFeedInfo.jdField_a_of_type_Qcy != null) && (((ArticleInfo)localObject).mSocialFeedInfo.jdField_a_of_type_Qcy.jdField_a_of_type_JavaUtilArrayList != null) && (((ArticleInfo)localObject).mSocialFeedInfo.jdField_a_of_type_Qcy.jdField_a_of_type_JavaUtilArrayList.size() > 0))
        {
          localObject = ((ArticleInfo)localObject).mSocialFeedInfo.jdField_a_of_type_Qcy.jdField_a_of_type_JavaUtilArrayList.iterator();
          while (((Iterator)localObject).hasNext())
          {
            qda localqda = ((qcz)((Iterator)localObject).next()).jdField_a_of_type_Qda;
            if ((localqda != null) && (!TextUtils.isEmpty(localqda.jdField_e_of_type_JavaLangString)))
            {
              ood localood = onx.a(localqda.jdField_e_of_type_JavaLangString);
              if ((localood == null) || (!localood.a(System.currentTimeMillis() / 1000L, 3600L))) {
                localArrayList.add(localqda.jdField_e_of_type_JavaLangString);
              }
            }
          }
        }
    ...
    if (localArrayList.size() > 0) {
      oxq.a().a((String[])localArrayList.toArray(new String[localArrayList.size()]), null);
    }
  }
  ...
  private void c(int paramInt, List<qax> paramList)
  {
  ...
  private static void c(List<ArticleInfo> paramList)
  {
    ...
    for (;;)
    {
      if (paramList.hasNext())
      {
        ...
        else
        {
          ...
          pba.a(localArticleInfo2);
          if (olr.a(rap.c(localArticleInfo2)))
          {
    ...
    for (;;)
    {
      localArticleInfo1.articleViewModel = rvn.a(localArticleInfo1);
      break label12;
      break;
      label110:
      olr.a(localArticleInfo2);
    }
  }
  ...
  {
    int i = 4;
    int j = pow.a(paramFromServiceMsg, paramObject, new oidb_cmd0xb83.RspBody());
    ...
    for (;;)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        onk.a(paramFromServiceMsg, bool, System.currentTimeMillis() - paramToServiceMsg.extraData.getLong("sendtimekey"), j, i);
        return;
  ...
  private void d(List<ArticleInfo> paramList)
  {
    ...
    do
    {
      ...
      {
        ArticleInfo localArticleInfo = (ArticleInfo)localIterator.next();
        if ((localArticleInfo != null) && (!opv.a(localArticleInfo))) {
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int i = pow.a(paramFromServiceMsg, paramObject, (MessageMicro)localObject1);
    if (i == 0)
    {
      if (((oidb_cmd0xbbd.RspBody)localObject1).msg_rsp_feeds_data.rpt_feeds_info_list.has())
      {
        ...
        while (paramObject.hasNext())
        {
          ...
          {
            localObject2 = pot.a((articlesummary.ArticleSummary)((oidb_cmd0xbbd.RspFeedsInfo)localObject1).msg_article_summary.get(), 70, 0, null);
  ...
  private void f(int paramInt)
  {
    if (this.jdField_a_of_type_Ozv != null) {
      this.jdField_a_of_type_Ozv.a(paramInt);
    }
  }
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (boolean bool = ((Boolean)localObject).booleanValue();; bool = false)
    {
      ...
      int i = onc.a(paramToServiceMsg, paramFromServiceMsg, paramObject, localRspBody, bool);
      ...
      try
      {
        ...
        noo.a(null, "", "0X8009483", "0X8009483", 0, 0, paramFromServiceMsg.toString(), "", "", "", false);
        sak.a().b(paramToServiceMsg);
  ...
  {
    int i = pow.a(paramFromServiceMsg, paramObject, new cmd0xc5b.RspBody());
    paramToServiceMsg = BaseApplication.getContext().getString(2131695622);
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (paramToServiceMsg = pot.c(paramToServiceMsg.rpt_result_list.get());; paramToServiceMsg = null)
    {
  ...
  private void i(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      bhvh.b(this.jdField_a_of_type_ComTencentCommonAppAppInterface);
      return;
      if (QLog.isColorLevel()) {
  ...
  private void j(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramFromServiceMsg = BaseApplication.getContext().getString(2131718369);
  ...
  private void m(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramToServiceMsg = BaseApplication.getContext().getString(2131718394);
    if (localRspBody.bytes_result_desc.has())
    {
  ...
  private void n(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramToServiceMsg = BaseApplication.getContext().getString(2131718414);
    if (localRspBody.bytes_result_desc.has())
    {
      paramToServiceMsg = localRspBody.bytes_result_desc.get().toStringUtf8();
  ...
  private void o(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramFromServiceMsg = BaseApplication.getContext().getString(2131718414);
    if (localRspBody.bytes_result_desc.has())
    {
      paramFromServiceMsg = localRspBody.bytes_result_desc.get().toStringUtf8();
  ...
  {
    int i = pow.a(paramFromServiceMsg, paramObject, new oidb_cmd0xbd4.RspBody());
  ...
  private void v(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      paramObject = pot.d(paramToServiceMsg.msg_rsp_search_tag_info.rpt_msg_tag_info_list.get());
      paramToServiceMsg = pot.d(paramToServiceMsg.msg_rsp_recommend_tag_info.rpt_msg_tag_info_list.get());
  ...
  private void w(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      paramFromServiceMsg.addAll(pot.e(paramToServiceMsg.msg_rsp_search_tag_info.rpt_msg_tag_info_list.get()));
    }
    for (;;)
    {
  ...
  {
    if (onk.c(paramInteger.intValue()))
    {
      paramInteger = null;
      return paramInteger;
    }
  ...
  List<ArticleInfo> a(int paramInt1, int paramInt2, long paramLong, boolean paramBoolean)
  {
    ...
    for (Object localObject = "mChannelID = ? and mRecommendSeq < ?";; localObject = "mChannelID = ? and mRecommendSeq > ?")
    {
      ...
      ArrayList localArrayList = new ArrayList();
      localObject = this.jdField_a_of_type_Aukn.a(ArticleInfo.class, true, (String)localObject, new String[] { String.valueOf(paramInt1), String.valueOf(paramLong) }, null, null, "mRecommendSeq desc", String.valueOf(paramInt2));
      if (localObject != null)
      {
        pot.a((List)localObject);
  ...
  public List<Long> a(Integer paramInteger)
  {
    ...
    this.jdField_a_of_type_Pba.a(paramInteger, localArrayList);
    return localArrayList;
  }
    ...
    for (;;)
    {
      for (;;)
      {
        if ((((ArticleInfo)localArrayList.get(i)).mTopicRecommendFeedsInfo != null) && (((ArticleInfo)localArrayList.get(i)).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
          ((qdv)((ArticleInfo)localArrayList.get(i)).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_c_of_type_Int = paramInt2;
        }
        int k;
        Object localObject2;
        ...
        try
        {
          ...
          if (localObject1 != null)
          {
            if ((((ArticleInfo)localObject1).mTopicRecommendFeedsInfo != null) && (((ArticleInfo)localObject1).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList != null) && (((ArticleInfo)localObject1).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
              ((qdv)((ArticleInfo)localObject1).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_c_of_type_Int = paramInt2;
            }
  ...
  public void a(int paramInt1, int paramInt2, long paramLong, boolean paramBoolean)
  {
    ...
    {
      pqk.a().a(paramInt1, localList);
      if ((Looper.myLooper() == Looper.getMainLooper()) && (onk.l()))
      {
        osm.a().a(paramInt1, localList);
        return;
      }
  ...
  public void a(int paramInt1, int paramInt2, long paramLong1, boolean paramBoolean, long paramLong2)
  {
    ...
    if ((localList != null) && (localList.size() > 0))
    {
      ...
      if ((Looper.myLooper() == Looper.getMainLooper()) && (onk.l()))
      {
        ppd.a().a(paramInt1, localList, paramLong2);
        return;
      }
      if (this.jdField_a_of_type_AndroidOsHandler != null)
      {
  ...
  public void a(int paramInt1, long paramLong, int paramInt2)
  {
    ...
    if (j < paramInt2)
    {
      Collections.sort((List)localObject1, new ozs(this));
      int i = 0;
      for (;;)
      {
        if (i >= paramInt2 - j) {
  ...
  public void a(int paramInt, List<ArticleInfo> paramList)
  {
        ...
        if (localIterator2.hasNext())
        {
          ...
          if (((ArticleInfo)localEntry.getValue()).mNewPolymericInfo != null)
          {
            ...
            do
            {
              ...
              localqbr = (qbr)localIterator3.next();
            } while (localqbr.jdField_a_of_type_Long != localArticleInfo.mArticleID);
            paramList = (ArticleInfo)localEntry.getValue();
            paramList.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.remove(localqbr);
          }
          else
          {
            label306:
    ...
    for (;;)
    {
      ...
      if ((paramList.mNewPolymericInfo != null) && (((onk.m(paramList)) && (paramList.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.size() >= 3)) || ((!onk.m(paramList)) && (paramList.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.size() >= 2))))
      {
  ...
  public void a(long paramLong)
  {
    ...
    a(pow.a("OidbSvc.0xb83", 2947, 0, localReqBody.toByteArray()));
  }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    a(pow.a("OidbSvc.0x75e", 1886, 0, localReqBody.toByteArray()));
  }
  ...
  public void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    a(pow.a("OidbSvc.0xc32", 3122, 2, localReqBody.toByteArray()));
  }
  ...
  {
    oidb_cmd0x68b.ReqBody localReqBody = new oidb_cmd0x68b.ReqBody();
    long l1 = Long.valueOf(onk.a()).longValue();
    ...
    if (!TextUtils.isEmpty(paramString2)) {
      localReqBody.msg_get_follow_tab_feeds_para.bytes_refresh_cookie.set(ByteStringMicro.copyFrom(bbca.decode(paramString2, 0)));
    }
    ...
    paramHashMap = pow.a("OidbSvc.0x68b", 1675, 0, localReqBody.toByteArray());
    ...
    onc.a(paramHashMap, l2);
    a(paramHashMap);
    jdField_c_of_type_Boolean = true;
    sak.a().a(paramHashMap);
  }
  ...
  public void a(long paramLong1, long paramLong2, qcj paramqcj, long paramLong3, String paramString1, long paramLong4, long paramLong5, int paramInt1, String paramString2, int paramInt2, ArticleInfo paramArticleInfo, boolean paramBoolean)
  {
    ...
    Object localObject3;
    if ((paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdc != null))
    {
      localObject2 = new feeds_info.ShareWebPageInfo();
      localObject3 = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdc;
      if (!TextUtils.isEmpty(((qdc)localObject3).jdField_d_of_type_JavaLangString)) {
        ((feeds_info.ShareWebPageInfo)localObject2).bytes_source.set(ByteStringMicro.copyFromUtf8(((qdc)localObject3).jdField_d_of_type_JavaLangString));
      }
      if (!TextUtils.isEmpty(((qdc)localObject3).jdField_b_of_type_JavaLangString)) {
        ((feeds_info.ShareWebPageInfo)localObject2).bytes_title.set(ByteStringMicro.copyFromUtf8(((qdc)localObject3).jdField_b_of_type_JavaLangString));
      }
      if (!TextUtils.isEmpty(((qdc)localObject3).jdField_c_of_type_JavaLangString)) {
        ((feeds_info.ShareWebPageInfo)localObject2).bytes_pic_url.set(ByteStringMicro.copyFromUtf8(((qdc)localObject3).jdField_c_of_type_JavaLangString));
      }
      if (!TextUtils.isEmpty(((qdc)localObject3).jdField_a_of_type_JavaLangString)) {
        ((feeds_info.ShareWebPageInfo)localObject2).bytes_web_url.set(ByteStringMicro.copyFromUtf8(((qdc)localObject3).jdField_a_of_type_JavaLangString));
      }
      localSocializeFeedsInfo.share_web_page_info.set((MessageMicro)localObject2);
    }
    if ((paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qcs != null)) {
      localSocializeFeedsInfo.now_live_info.set(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qcs.a());
    }
    localObject2 = new feeds_info.BiuMultiLevel();
    if (paramqcj.jdField_a_of_type_JavaLangLong != null) {
      ((feeds_info.BiuMultiLevel)localObject2).uint64_origin_feeds_id.set(paramqcj.jdField_a_of_type_JavaLangLong.longValue());
    }
    if (paramqcj.jdField_b_of_type_JavaLangLong != null) {
      ((feeds_info.BiuMultiLevel)localObject2).uint64_origin_feeds_type.set(paramqcj.jdField_b_of_type_JavaLangLong.longValue());
    }
    if (QLog.isColorLevel()) {
      QLog.d("ArticleInfoModule", 1, "request0x83eDeliver feedID=" + paramLong2 + ", feeds_type=" + paramInt2 + ", articleId=" + paramLong4 + ", masterUin=" + paramLong3 + ", comment=" + paramString1 + ",mOriFeedId=" + paramqcj.jdField_a_of_type_JavaLangLong + ",mOriFeedType" + paramqcj.jdField_b_of_type_JavaLangLong + ",bussinessId = " + paramArticleInfo.businessId);
    }
    paramqcj = paramqcj.jdField_a_of_type_JavaUtilList.iterator();
    while (paramqcj.hasNext())
    {
      paramString1 = (SocializeFeedsInfo.BiuCommentInfo)paramqcj.next();
    ...
    {
      if ((paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdd != null) && (rap.a(paramArticleInfo)))
      {
        paramString1 = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdd;
        paramqcj = new feeds_info.UGCFeedsInfo();
        if (!TextUtils.isEmpty(paramString1.jdField_a_of_type_JavaLangString)) {
          paramqcj.bytes_ugc_comments.set(ByteStringMicro.copyFromUtf8(paramString1.jdField_a_of_type_JavaLangString));
        }
        paramqcj.enum_ugc_feeds_card_type.set(paramString1.jdField_a_of_type_Int);
        paramqcj.uint64_cuin.set(paramString1.jdField_a_of_type_Long);
        localObject1 = paramString1.jdField_a_of_type_JavaUtilArrayList.iterator();
        while (((Iterator)localObject1).hasNext())
        {
          localObject2 = (qde)((Iterator)localObject1).next();
          localObject3 = new feeds_info.UGCPicInfo();
          ((feeds_info.UGCPicInfo)localObject3).is_animation.set(((qde)localObject2).jdField_c_of_type_Int);
          ((feeds_info.UGCPicInfo)localObject3).uint32_pic_height.set(((qde)localObject2).jdField_b_of_type_Int);
          ((feeds_info.UGCPicInfo)localObject3).uint32_pic_width.set(((qde)localObject2).jdField_a_of_type_Int);
          if (!TextUtils.isEmpty(((qde)localObject2).jdField_a_of_type_JavaLangString)) {
            ((feeds_info.UGCPicInfo)localObject3).bytes_pic_md5.set(ByteStringMicro.copyFromUtf8(((qde)localObject2).jdField_a_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qde)localObject2).jdField_b_of_type_JavaLangString)) {
            ((feeds_info.UGCPicInfo)localObject3).bytes_pic_url.set(ByteStringMicro.copyFromUtf8(((qde)localObject2).jdField_b_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qde)localObject2).jdField_c_of_type_JavaLangString)) {
            ((feeds_info.UGCPicInfo)localObject3).bytes_thumbnail_url.set(ByteStringMicro.copyFromUtf8(((qde)localObject2).jdField_c_of_type_JavaLangString));
          }
          paramqcj.msg_ugc_pic_info_list.add((MessageMicro)localObject3);
        }
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          paramqcj.msg_ugc_voice_info_list.add((MessageMicro)localObject3);
        }
        paramString1 = paramString1.b.iterator();
        while (paramString1.hasNext())
        {
          localObject1 = (qdf)paramString1.next();
          localObject2 = new feeds_info.UGCVideoInfo();
          ((feeds_info.UGCVideoInfo)localObject2).uint32_pic_height.set(((qdf)localObject1).jdField_d_of_type_Int);
          ((feeds_info.UGCVideoInfo)localObject2).uint32_pic_width.set(((qdf)localObject1).jdField_c_of_type_Int);
          ((feeds_info.UGCVideoInfo)localObject2).uint32_video_height.set(((qdf)localObject1).jdField_b_of_type_Int);
          ((feeds_info.UGCVideoInfo)localObject2).uint32_video_width.set(((qdf)localObject1).jdField_a_of_type_Int);
          ((feeds_info.UGCVideoInfo)localObject2).uint64_duration.set(((qdf)localObject1).jdField_a_of_type_Long);
          ((feeds_info.UGCVideoInfo)localObject2).uint32_create_time.set(((qdf)localObject1).jdField_e_of_type_Int);
          ((feeds_info.UGCVideoInfo)localObject2).uint32_busi_type.set(((qdf)localObject1).jdField_f_of_type_Int);
          if (!TextUtils.isEmpty(((qdf)localObject1).jdField_c_of_type_JavaLangString)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_pic_md5.set(ByteStringMicro.copyFromUtf8(((qdf)localObject1).jdField_c_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qdf)localObject1).jdField_d_of_type_JavaLangString)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_pic_url.set(ByteStringMicro.copyFromUtf8(((qdf)localObject1).jdField_d_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qdf)localObject1).jdField_a_of_type_JavaLangString)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_video_md5.set(ByteStringMicro.copyFromUtf8(((qdf)localObject1).jdField_a_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qdf)localObject1).jdField_b_of_type_JavaLangString)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_video_url.set(ByteStringMicro.copyFromUtf8(((qdf)localObject1).jdField_b_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qdf)localObject1).jdField_e_of_type_JavaLangString)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_title.set(ByteStringMicro.copyFromUtf8(((qdf)localObject1).jdField_e_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qdf)localObject1).jdField_f_of_type_JavaLangString)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_uuid.set(ByteStringMicro.copyFromUtf8(((qdf)localObject1).jdField_f_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qdf)localObject1).i)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_vid.set(ByteStringMicro.copyFromUtf8(((qdf)localObject1).i));
          }
          if (!TextUtils.isEmpty(((qdf)localObject1).h)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_share_url.set(ByteStringMicro.copyFromUtf8(((qdf)localObject1).h));
          }
          if (!TextUtils.isEmpty(((qdf)localObject1).g)) {
            ((feeds_info.UGCVideoInfo)localObject2).bytes_uniq_id.set(ByteStringMicro.copyFromUtf8(((qdf)localObject1).g));
          }
          paramqcj.msg_ugc_video_info_list.add((MessageMicro)localObject2);
        }
        localSocializeFeedsInfo.msg_ugc_topic_feeds_info.set(paramqcj);
      }
      if ((paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qcy != null) && (rap.a(paramArticleInfo)))
      {
        paramqcj = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qcy;
        paramString1 = new feeds_info.PGCFeedsInfo();
        localObject1 = paramqcj.jdField_a_of_type_JavaUtilArrayList.iterator();
        while (((Iterator)localObject1).hasNext())
        {
          localObject2 = (qcz)((Iterator)localObject1).next();
          localObject3 = new feeds_info.PGCPicInfo();
          if (!TextUtils.isEmpty(((qcz)localObject2).jdField_a_of_type_JavaLangString)) {
            ((feeds_info.PGCPicInfo)localObject3).bytes_pic_md5.set(ByteStringMicro.copyFromUtf8(((qcz)localObject2).jdField_a_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qcz)localObject2).jdField_b_of_type_JavaLangString)) {
            ((feeds_info.PGCPicInfo)localObject3).bytes_pic_url.set(ByteStringMicro.copyFromUtf8(((qcz)localObject2).jdField_b_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qcz)localObject2).jdField_c_of_type_JavaLangString)) {
            ((feeds_info.PGCPicInfo)localObject3).bytes_thumbnail_url.set(ByteStringMicro.copyFromUtf8(((qcz)localObject2).jdField_c_of_type_JavaLangString));
          }
          ((feeds_info.PGCPicInfo)localObject3).is_animation.set(((qcz)localObject2).jdField_c_of_type_Int);
          ((feeds_info.PGCPicInfo)localObject3).uint32_pic_height.set(((qcz)localObject2).jdField_b_of_type_Int);
          ((feeds_info.PGCPicInfo)localObject3).uint32_pic_width.set(((qcz)localObject2).jdField_a_of_type_Int);
          paramString1.msg_pgc_pic_info_list.add((MessageMicro)localObject3);
        }
        localObject1 = paramqcj.b.iterator();
        while (((Iterator)localObject1).hasNext())
        {
          localObject2 = (qda)((Iterator)localObject1).next();
          localObject3 = new feeds_info.PGCVideoInfo();
          if (!TextUtils.isEmpty(((qda)localObject2).jdField_c_of_type_JavaLangString)) {
            ((feeds_info.PGCVideoInfo)localObject3).bytes_pic_md5.set(ByteStringMicro.copyFromUtf8(((qda)localObject2).jdField_c_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qda)localObject2).jdField_d_of_type_JavaLangString)) {
            ((feeds_info.PGCVideoInfo)localObject3).bytes_pic_url.set(ByteStringMicro.copyFromUtf8(((qda)localObject2).jdField_d_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qda)localObject2).jdField_a_of_type_JavaLangString)) {
            ((feeds_info.PGCVideoInfo)localObject3).bytes_video_md5.set(ByteStringMicro.copyFromUtf8(((qda)localObject2).jdField_a_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(((qda)localObject2).jdField_b_of_type_JavaLangString)) {
            ((feeds_info.PGCVideoInfo)localObject3).bytes_video_url.set(ByteStringMicro.copyFromUtf8(((qda)localObject2).jdField_b_of_type_JavaLangString));
          }
          paramString1.msg_pgc_video_info_list.add((MessageMicro)localObject3);
        }
        if (!TextUtils.isEmpty(paramqcj.jdField_a_of_type_JavaLangString)) {
          paramString1.bytes_pgc_comments.set(ByteStringMicro.copyFromUtf8(paramqcj.jdField_a_of_type_JavaLangString));
        }
        localSocializeFeedsInfo.msg_pgc_topic_feeds_info.set(paramString1);
      }
      if ((paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt != null) && (rap.b(paramArticleInfo)))
      {
        paramqcj = new feeds_info.TopicRecommendFeedsInfo();
        paramqcj.uint32_feeds_style.set(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_a_of_type_Int);
        paramqcj.uint64_feeds_id.set(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_a_of_type_Long);
        paramString1 = new ArrayList();
        if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_a_of_type_JavaUtilArrayList != null)
        {
          localObject1 = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_a_of_type_JavaUtilArrayList.iterator();
          while (((Iterator)localObject1).hasNext())
          {
            localObject2 = (qdv)((Iterator)localObject1).next();
            localObject3 = new feeds_info.TopicRecommendInfo();
            ((feeds_info.TopicRecommendInfo)localObject3).uint32_number_of_participants.set(((qdv)localObject2).jdField_b_of_type_Int);
            if (!TextUtils.isEmpty(((qdv)localObject2).jdField_a_of_type_JavaLangString)) {
              ((feeds_info.TopicRecommendInfo)localObject3).bytes_business_name.set(ByteStringMicro.copyFromUtf8(((qdv)localObject2).jdField_a_of_type_JavaLangString));
            }
            if (!TextUtils.isEmpty(((qdv)localObject2).jdField_c_of_type_JavaLangString)) {
              ((feeds_info.TopicRecommendInfo)localObject3).bytes_business_name_prefix.set(ByteStringMicro.copyFromUtf8(((qdv)localObject2).jdField_c_of_type_JavaLangString));
            }
            if (!TextUtils.isEmpty(((qdv)localObject2).jdField_b_of_type_JavaLangString)) {
              ((feeds_info.TopicRecommendInfo)localObject3).bytes_business_url.set(ByteStringMicro.copyFromUtf8(((qdv)localObject2).jdField_b_of_type_JavaLangString));
            }
            if (!TextUtils.isEmpty(((qdv)localObject2).jdField_d_of_type_JavaLangString)) {
              ((feeds_info.TopicRecommendInfo)localObject3).bytes_pic_url.set(ByteStringMicro.copyFromUtf8(((qdv)localObject2).jdField_d_of_type_JavaLangString));
            }
            ((feeds_info.TopicRecommendInfo)localObject3).uint32_business_id.set(((qdv)localObject2).jdField_a_of_type_Int);
            paramString1.add(localObject3);
          }
        }
        paramqcj.msg_topic_recommend_info.set(paramString1);
        if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_a_of_type_Qdu != null)
        {
          paramString1 = new feeds_info.TopicRecommendFeedsTitle();
          if (!TextUtils.isEmpty(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_a_of_type_Qdu.jdField_b_of_type_JavaLangString)) {
            paramString1.bytes_url.set(ByteStringMicro.copyFromUtf8(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_a_of_type_Qdu.jdField_b_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_a_of_type_Qdu.jdField_a_of_type_JavaLangString)) {
            paramString1.bytes_title_content.set(ByteStringMicro.copyFromUtf8(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_a_of_type_Qdu.jdField_a_of_type_JavaLangString));
          }
          paramqcj.msg_left_title.set(paramString1);
        }
        if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_b_of_type_Qdu != null)
        {
          paramString1 = new feeds_info.TopicRecommendFeedsTitle();
          if (!TextUtils.isEmpty(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_b_of_type_Qdu.jdField_b_of_type_JavaLangString)) {
            paramString1.bytes_url.set(ByteStringMicro.copyFromUtf8(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_b_of_type_Qdu.jdField_b_of_type_JavaLangString));
          }
          if (!TextUtils.isEmpty(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_b_of_type_Qdu.jdField_a_of_type_JavaLangString)) {
            paramString1.bytes_title_content.set(ByteStringMicro.copyFromUtf8(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_b_of_type_Qdu.jdField_a_of_type_JavaLangString));
          }
          paramqcj.msg_right_title.set(paramString1);
        }
        if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_a_of_type_JavaLangString != null) {
          paramqcj.bytes_subscribe_id.set(ByteStringMicro.copyFromUtf8(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_a_of_type_JavaLangString));
        }
        paramqcj.uint64_uin.set(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_b_of_type_Long);
        if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_b_of_type_JavaLangString != null) {
          paramqcj.bytes_comments.set(ByteStringMicro.copyFromUtf8(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qdt.jdField_b_of_type_JavaLangString));
        }
        localSocializeFeedsInfo.msg_topic_recommend_feeds_info.set(paramqcj);
      }
    }
    if ((onk.b(paramArticleInfo)) || (onk.c(paramArticleInfo)) || (onk.e(paramArticleInfo)) || (onk.f(paramArticleInfo)))
    {
      if ((paramArticleInfo.mTopicRecommendFeedsInfo != null) && (paramArticleInfo.mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
        localFeedsInfo.uint32_business_id.set(((qdv)paramArticleInfo.mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_Int);
      }
      ...
      {
        paramqcj = ByteStringMicro.copyFromUtf8(paramString2);
        localReqBody.bytes_inner_uniq_id.set(paramqcj);
        if (QLog.isColorLevel()) {
          QLog.d("ArticleInfoModule", 1, "request0x83eDeliver innerUniqueIDc=" + paramString2);
        }
      }
      localReqBody.msg_feeds_info.set(localFeedsInfo);
      paramqcj = localReqBody.uint32_is_one_touch_biu;
      if (!paramBoolean) {
        break label3090;
      }
    }
    ...
    {
      paramqcj.set(paramInt1);
      paramqcj = String.valueOf(onk.a()) + String.valueOf(System.currentTimeMillis());
      localReqBody.bytes_req_seq.set(ByteStringMicro.copyFromUtf8(paramqcj));
      paramqcj = pow.a("OidbSvc.0x83e", 2110, 0, localReqBody.toByteArray());
      paramqcj.addAttribute("biu_deliver", Integer.valueOf(1));
      paramqcj.addAttribute("BaseArticleSeq", Long.valueOf(paramLong5));
      b(paramqcj);
      return;
  ...
  public void a(long paramLong1, long paramLong2, qcj paramqcj, String paramString)
  {
    ...
    if (paramqcj.jdField_a_of_type_JavaLangLong != null) {
      localBiuMultiLevel.uint64_origin_feeds_id.set(paramqcj.jdField_a_of_type_JavaLangLong.longValue());
    }
    if (paramqcj.jdField_b_of_type_JavaLangLong != null) {
      localBiuMultiLevel.uint64_origin_feeds_type.set(paramqcj.jdField_b_of_type_JavaLangLong.longValue());
    }
    paramqcj = paramqcj.jdField_a_of_type_JavaUtilList.iterator();
    while (paramqcj.hasNext())
    {
      SocializeFeedsInfo.BiuCommentInfo localBiuCommentInfo = (SocializeFeedsInfo.BiuCommentInfo)paramqcj.next();
    ...
    paramqcj = new feeds_info.BiuOneLevelItem();
    paramqcj.bytes_biu_comments.set(ByteStringMicro.copyFromUtf8(paramString));
    paramqcj.op_type.set(0);
    paramqcj.feeds_type.set(1);
    paramqcj.uint64_feeds_id.set(paramLong2);
    paramqcj.uint64_uin.set(paramLong1);
    localBiuMultiLevel.rpt_biu_mutli_level.add(paramqcj);
    paramqcj = new feeds_info.FeedsInfo();
    paramString = new feeds_info.SocializeFeedsInfo();
    paramString.msg_biu_mutli_level.set(localBiuMultiLevel);
    paramString.msg_biu_mutli_level.set(localBiuMultiLevel);
    paramqcj.msg_social_feeds_info.set(paramString);
    localReqBody.msg_feeds_info.set(paramqcj);
    b(pow.a("OidbSvc.0xc5b_2", 3163, 2, localReqBody.toByteArray()));
  }
  ...
  public void a(long paramLong1, long paramLong2, boolean paramBoolean, ArticleInfo paramArticleInfo)
  {
    ...
    for (int i = 2;; i = 3)
    {
      ...
      localObject2 = String.valueOf(onk.a()) + String.valueOf(System.currentTimeMillis());
      ((oidb_cmd0x83e.ReqBody)localObject1).bytes_req_seq.set(ByteStringMicro.copyFromUtf8((String)localObject2));
      localObject1 = pow.a("OidbSvc.0x83e", 2110, 0, ((oidb_cmd0x83e.ReqBody)localObject1).toByteArray());
  ...
  public void a(long paramLong, String paramString1, int paramInt, String paramString2, ArrayList<SocializeFeedsInfo.BiuCommentInfo> paramArrayList, boolean paramBoolean)
  {
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      paramString1 = pow.a("OidbSvc.0x83e", 2110, 0, localReqBody.toByteArray());
  ...
  public void a(long paramLong, List<qaw> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      oidb_cmd0x46f.DislikeParam localDislikeParam = a((qaw)paramList.next());
      localReqBody.rpt_param_list.add(localDislikeParam);
    }
    a(pow.a("OidbSvc.0x46f", 1135, 0, localReqBody.toByteArray()));
  }
  ...
  public void a(long paramLong, boolean paramBoolean, FastWebArticleInfo paramFastWebArticleInfo)
  {
    ...
    for (Object localObject = paramFastWebArticleInfo.j;; localObject = "")
    {
      ...
      localObject = pow.a("OidbSvc.0x83e", 2110, 0, localReqBody.toByteArray());
  ...
  public void a(ArticleInfo paramArticleInfo, String paramString)
  {
    ...
    try
    {
      localObject3 = new String(bbca.decode(str, 0));
    ...
    str = String.valueOf(onk.a()) + String.valueOf(System.currentTimeMillis());
    ...
    localObject1 = pow.a("OidbSvc.0x83e", 2110, 0, ((oidb_cmd0x83e.ReqBody)localObject3).toByteArray());
  ...
  public void a(TopicInfo paramTopicInfo)
  {
    ...
    a(pow.a("OidbSvc.0xc16", 3094, 0, localReqBody.toByteArray()));
  }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      b(pow.a("OidbSvc.0xc6d", 3181, 1, localReqBody.toByteArray()));
  ...
  public void a(String paramString1, String paramString2, Bundle paramBundle, ArrayList<SocializeFeedsInfo.BiuCommentInfo> paramArrayList, boolean paramBoolean1, boolean paramBoolean2, TroopBarPOI paramTroopBarPOI, VisibleSetParam paramVisibleSetParam)
  {
    ...
    for (;;)
    {
      ...
      localFeedsInfo.msg_social_feeds_info.set(localSocializeFeedsInfo);
      localReqBody.msg_feeds_info.set(localFeedsInfo);
      paramString1 = String.valueOf(onk.a()) + String.valueOf(System.currentTimeMillis());
  ...
  public void a(String paramString1, String paramString2, String paramString3, List<Integer> paramList, String paramString4, String paramString5, String[] paramArrayOfString1, int[] paramArrayOfInt1, int[] paramArrayOfInt2, String[] paramArrayOfString2, ArrayList<SocializeFeedsInfo.BiuCommentInfo> paramArrayList, boolean paramBoolean, int paramInt1, int paramInt2, qcg paramqcg, TroopBarPOI paramTroopBarPOI, VisibleSetParam paramVisibleSetParam, int paramInt3)
  {
    Object localObject;
    if (QLog.isColorLevel())
    {
    ...
    if ((paramInt1 == 21) && (paramqcg != null))
    {
      paramList = new feeds_info.AccountProfile();
      paramList.bytes_desc.set(ByteStringMicro.copyFromUtf8(paramqcg.jdField_c_of_type_JavaLangString));
      paramList.bytes_nick.set(ByteStringMicro.copyFromUtf8(paramqcg.jdField_a_of_type_JavaLangString));
      paramList.bytes_profile_photo_url.set(ByteStringMicro.copyFromUtf8(paramqcg.jdField_b_of_type_JavaLangString));
      paramList.uint64_uin.set(paramqcg.jdField_a_of_type_Long);
      paramList.uint32_account_type.set(paramqcg.jdField_a_of_type_Int);
    ...
    paramString1 = pow.a("OidbSvc.0x83e", 2110, 0, paramString2.toByteArray());
    paramString1.addAttribute("ugc_deliver", Integer.valueOf(1));
    b(paramString1);
  }
  
  public void a(String paramString1, String paramString2, String paramString3, List<Integer> paramList, String paramString4, String[] paramArrayOfString1, int[] paramArrayOfInt1, int[] paramArrayOfInt2, String[] paramArrayOfString2, ArrayList<SocializeFeedsInfo.BiuCommentInfo> paramArrayList, boolean paramBoolean, int paramInt1, int paramInt2, qcg paramqcg, int paramInt3)
  {
    a(paramString1, paramString2, paramString3, paramList, paramString4, "", paramArrayOfString1, paramArrayOfInt1, paramArrayOfInt2, paramArrayOfString2, paramArrayList, paramBoolean, paramInt1, paramInt2, paramqcg, null, VisibleSetParam.a, paramInt3);
  }
  ...
  public void a(ArrayList<ResultRecord> paramArrayList, int paramInt, long paramLong, String paramString)
  {
    if ((paramInt == 1) && (paramArrayList != null) && (paramString != null))
    {
      ...
      catch (NumberFormatException paramArrayList)
      {
        ...
        a(pow.a("OidbSvc.0xbd4_1", 3028, 1, localReqBody.toByteArray()));
      }
    }
  }
  ...
  public void a(ozu paramozu)
  {
    this.jdField_a_of_type_Ozu = paramozu;
  }
  
  public void a(ozv paramozv)
  {
    this.jdField_a_of_type_Ozv = paramozv;
  }
  
  public void a(poz parampoz)
  {
    if (parampoz == null) {
    ...
    long l2 = pcz.a(parampoz);
    jdField_c_of_type_Boolean = true;
    jdField_c_of_type_Int = parampoz.jdField_g_of_type_Int;
    this.jdField_a_of_type_JavaUtilConcurrentExecutorService.execute(new ArticleInfoModule.1(this, parampoz, l1, l2));
  }
  
  public void a(qay paramqay, ArticleInfo paramArticleInfo)
  {
    ...
    ArrayList localArrayList = new ArrayList();
    Iterator localIterator = paramqay.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      qaz localqaz = (qaz)localIterator.next();
      oidb_cmd0xbbd.ReqFeedsInfo localReqFeedsInfo = new oidb_cmd0xbbd.ReqFeedsInfo();
      localReqFeedsInfo.uint64_feeds_id.set(localqaz.jdField_a_of_type_Long);
      localReqFeedsInfo.uint32_feeds_type.set(localqaz.jdField_a_of_type_Int);
    ...
    localObject = pow.a("OidbSvc.0xbbd", 3005, 0, ((oidb_cmd0xbbd.ReqBody)localObject).toByteArray());
    ...
    ((ToServiceMsg)localObject).getAttributes().put(jdField_d_of_type_JavaLangString, Long.valueOf(((qaz)paramqay.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_c_of_type_Long));
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if ((((ArticleInfo)localArrayList.get(paramInt1)).mTopicRecommendFeedsInfo != null) && (((ArticleInfo)localArrayList.get(paramInt1)).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
        ((qdv)((ArticleInfo)localArrayList.get(paramInt1)).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_c_of_type_Int = paramInt2;
      }
      ...
      if (localObject != null)
      {
        if ((((ArticleInfo)localObject).mTopicRecommendFeedsInfo != null) && (((ArticleInfo)localObject).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList != null) && (((ArticleInfo)localObject).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
          ((qdv)((ArticleInfo)localObject).mTopicRecommendFeedsInfo.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_c_of_type_Int = paramInt2;
        }
  ...
  public boolean a(Integer paramInteger, List<ArticleInfo> paramList, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Pba.a(paramInteger, paramList, paramBoolean);
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      else if (((ArticleInfo)localObject2).mNewPolymericInfo != null)
      {
        ...
        if (localObject2 != null)
        {
          ...
          while (((Iterator)localObject2).hasNext()) {
            localArrayList.add(Long.valueOf(((qbr)((Iterator)localObject2).next()).jdField_a_of_type_Long));
          }
        }
      }
      else
  ...
  public void b(int paramInt, List<ArticleInfo> paramList)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          return;
        } while ((paramList == null) || (paramList.isEmpty()) || ((paramInt != 0) && (!oox.c(paramInt))));
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int m = pow.a(paramFromServiceMsg, paramObject, localRspBody);
  ...
  public List<ArticleInfo> c(Integer paramInteger)
  {
    ...
    Collections.sort(localArrayList, new ozt(this));
    return localArrayList;
  }
  ...
  public void c(String paramString)
  {
    ...
    a(pow.a("OidbSvc.0xbde", 3038, 0, localReqBody.toByteArray()));
  }
  ...
  {
    if (!onk.q()) {}
    while ((paramInt != 0) && (!oox.c(paramInt))) {
      return;
    }
