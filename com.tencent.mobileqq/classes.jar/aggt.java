...
public class aggt
  extends RecyclerView.Adapter<aggv>
{
  public ArrayList<LocalMediaInfo> a;
  public WeakReference<PhotoListPanel> a;
  boolean a;
  
  public aggt(PhotoListPanel paramPhotoListPanel)
  {
  ...
  public int a(String paramString)
  {
    ...
    return bdar.getMediaType(paramString);
  }
  
  public aggv a(ViewGroup paramViewGroup, int paramInt)
  {
    return new aggv(this, LayoutInflater.from(paramViewGroup.getContext()).inflate(2131561135, paramViewGroup, false));
  }
  ...
  public void a(aggv paramaggv, int paramInt)
  {
    paramaggv.itemView.setOnClickListener(new aggu(this, paramInt));
    paramaggv.jdField_a_of_type_Aggq.a(paramInt);
    paramaggv.jdField_a_of_type_Aggq.a(paramaggv.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox);
    Object localObject1 = a(paramInt);
    Object localObject2 = paramaggv.jdField_a_of_type_ComTencentImageURLImageView;
    Object localObject4 = new apgg(((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).i, ((LocalMediaInfo)localObject1).thumbWidth, ((LocalMediaInfo)localObject1).thumbHeight);
    apgg localapgg = new apgg(((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).j, ((LocalMediaInfo)localObject1).thumbWidth, ((LocalMediaInfo)localObject1).thumbHeight);
    Object localObject3 = bdar.generateAlbumThumbURL((LocalMediaInfo)localObject1, "FLOW_THUMB");
    URLDrawable localURLDrawable = paramaggv.jdField_a_of_type_ComTencentImageURLDrawable;
    ...
    if ((localObject3 != null) && ((localURLDrawable == null) || (!localURLDrawable.getURL().equals(localObject3))))
    {
      ...
      localURLDrawableOptions.mFailedDrawable = localapgg;
      ...
      paramaggv.jdField_a_of_type_ComTencentImageURLDrawable = ((URLDrawable)localObject4);
      if (localURLDrawable != null) {
        localURLDrawable.cancelDownload(true);
      }
    }
    localObject2 = paramaggv.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox;
    localObject3 = paramaggv.b;
    ...
    if (((LocalMediaInfo)localObject1).mChecked)
    {
      ...
      localObject3 = paramaggv.jdField_a_of_type_AndroidWidgetImageView;
      i = getItemViewType(paramInt);
      if (i != 0) {
        break label634;
      }
      ((ImageView)localObject3).setVisibility(4);
      paramaggv.jdField_a_of_type_AndroidWidgetTextView.setVisibility(4);
      label394:
      if ((!bdal.b(((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a)) || (paramInt != 0)) {
        break label701;
      }
      localObject3 = (aljv)((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(53);
      if (((aljv)localObject3).a(1))
      {
        ((aljv)localObject3).a();
        ((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).c = paramaggv.jdField_a_of_type_AndroidViewView;
      ...
      paramaggv.jdField_a_of_type_AndroidViewView.setVisibility(0);
      aljv.a(((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_AndroidAppActivity, paramaggv.jdField_a_of_type_AndroidViewView);
    }
    for (;;)
    {
      if (AppSetting.c)
      {
        ...
        paramaggv.itemView.setContentDescription((CharSequence)localObject3);
        localObject1 = PhotoUtils.a(i, (LocalMediaInfo)localObject1, paramInt, ((NumberCheckBox)localObject2).isChecked());
        paramaggv.jdField_a_of_type_ComTencentMobileqqWidgetNumberCheckBox.setContentDescription((CharSequence)localObject1);
      }
      return;
      label580:
      localURLDrawableOptions.mLoadingDrawable = ((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_Apgg;
      localURLDrawableOptions.mFailedDrawable = ((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_b_of_type_Apgg;
      break;
      ...
      {
        ((ImageView)localObject3).setVisibility(0);
        localObject3 = paramaggv.jdField_a_of_type_AndroidWidgetTextView;
      ...
      break label394;
      label690:
      paramaggv.jdField_a_of_type_AndroidViewView.setVisibility(4);
      continue;
      label701:
      paramaggv.jdField_a_of_type_AndroidViewView.setVisibility(4);
    }
  ...
  public void a(List<LocalMediaInfo> paramList)
  {
    ...
    {
      String.format(((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131719262), new Object[] { Integer.valueOf(((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_JavaUtilLinkedList.size()) });
      return;
    }
    ((PhotoListPanel)this.jdField_a_of_type_MqqUtilWeakReference.get()).getResources().getString(2131719257);
  }
  ...
  {
    return bdar.getMediaType(a(paramInt));
  }
}
