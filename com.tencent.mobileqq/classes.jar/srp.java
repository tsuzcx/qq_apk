...
public class srp
{
  ...
  private srp(JSONObject paramJSONObject)
  {
    int j;
    try
    {
  ...
  public static srp a(@Nullable String paramString)
  {
    try
    {
  ...
  public static srp a(JSONObject paramJSONObject)
  {
    try
    {
      paramJSONObject = new srp(paramJSONObject);
