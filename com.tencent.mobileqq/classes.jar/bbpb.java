...
public class bbpb
  implements Manager
{
  bbwt jdField_a_of_type_Bbwt = new bbpc(this, "param_WIFIColorRingDownloadFlow", "param_XGColorRingDownloadFlow");
  private bbww jdField_a_of_type_Bbww;
  public bbxa a;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public bbpb(QQAppInterface paramQQAppInterface)
  {
  ...
  public static String a(long paramLong, int paramInt)
  {
    ...
    do
    {
      return "";
      if (paramInt == 2) {
        return bbpa.a + File.separator + paramLong + File.separator + "config.txt";
      }
      if (paramInt == 1) {
        return bbpa.a + File.separator + paramLong + File.separator + "cover.jpg";
      }
    } while (paramInt != 3);
    return bbpa.a + File.separator + paramLong + File.separator + "ring.mp3";
  }
  ...
  public static String a(AppRuntime paramAppRuntime, int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 3)
    {
      localObject = bbzh.a(paramAppRuntime, 0, null).getString("_3_" + paramInt1, null);
      paramAppRuntime = (AppRuntime)localObject;
      if (TextUtils.isEmpty((CharSequence)localObject)) {
        paramAppRuntime = bbqd.a("colorringAudio");
      }
    }
    for (;;)
    {
      ...
      if (paramInt2 == 2)
      {
        paramAppRuntime = bbqd.a("colorringConfig");
      }
      else
      {
        paramAppRuntime = (AppRuntime)localObject;
        if (paramInt2 == 1) {
          paramAppRuntime = bbqd.a("colorringCover");
        }
      }
    }
  }
  ...
  {
    Object localObject = new File(bbpa.a + File.separator + paramLong + File.separator + "config.txt");
    try
    {
  ...
  {
    this.jdField_a_of_type_Bbww.a(1).a(true, a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInt1, paramInt2));
  }
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, String paramString)
  {
    ...
    do
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        paramString = new bbwu(paramString, localFile);
        paramString.a(3);
        paramString.a = 0;
        paramString.a(localBundle);
        this.jdField_a_of_type_Bbwt.onDone(paramString);
        return;
      }
      paramString = new bbwu(paramString, new File(str + ".tmp"));
      paramString.e = 3145728L;
      paramString.b = true;
      this.jdField_a_of_type_Bbww.a(1).a(paramString, this.jdField_a_of_type_Bbwt, localBundle);
