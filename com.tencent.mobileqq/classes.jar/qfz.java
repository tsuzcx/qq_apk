...
public class qfz
{
  ...
  public static List<BaseArticleInfo> a(List<BaseArticleInfo> paramList)
  {
    ...
    if (i < j)
    {
      ...
      if (!pqw.h(localBaseArticleInfo1)) {
      ...
      for (;;)
      {
        ...
        while ((i + 1 < j) && (pqw.a(localBaseArticleInfo1, (BaseArticleInfo)paramList.get(i + 1))))
        {
        ...
        if ((pqw.l(localBaseArticleInfo1)) && (localArticleInfo.mGroupSubArticleList.size() >= 1))
        {
          localArrayList.add(localArticleInfo);
          if (QLog.isColorLevel()) {
            QLog.d("PolymericSmallVideo_" + qfz.class.getSimpleName(), 2, localStringBuilder.toString());
          }
        }
    ...
    if ((localArrayList.size() > 1) && (pqw.j((BaseArticleInfo)localArrayList.get(localArrayList.size() - 1)))) {
  ...
  static void a(BaseArticleInfo paramBaseArticleInfo)
  {
    if ((paramBaseArticleInfo.mNewPolymericInfo != null) && (paramBaseArticleInfo.mNewPolymericInfo.jdField_a_of_type_JavaUtilList != null) && (paramBaseArticleInfo.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.size() > 0))
    {
      ...
      try
      {
        ...
        {
          localrpt = (rpt)((Iterator)localObject).next();
          ...
          localArticleInfo.mAlgorithmID = localrpt.b;
          localArticleInfo.innerUniqueID = localrpt.g;
          localArticleInfo.mArticleContentUrl = localrpt.jdField_d_of_type_JavaLangString;
          localArticleInfo.mSubscribeID = localrpt.e;
          if (localrpt.jdField_c_of_type_Int == 1)
          {
            bool = true;
            localArticleInfo.mIsPolymericGallery = bool;
            localArticleInfo.mGalleryPicNumber = localrpt.jdField_d_of_type_Int;
            localArticleInfo.mSinglePicture = pqa.a(localrpt.jdField_c_of_type_JavaLangString);
            if (localrpt.jdField_a_of_type_Rpw != null)
            {
              localArticleInfo.mVideoCoverUrl = pqa.a(localrpt.jdField_c_of_type_JavaLangString);
              localArticleInfo.mVideoVid = localrpt.jdField_a_of_type_Rpw.a;
            }
            localArticleInfo.mNewPolymericInfo = new rps();
      ...
      catch (Exception localException1)
      {
        try
        {
          for (;;)
          {
            ...
            localArticleInfo.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.add((rpt)localrpt.clone());
            if (ppe.g(paramBaseArticleInfo))
            {
              localrpt.jdField_a_of_type_Boolean = true;
  ...
  public void a(Integer paramInteger, List<Long> paramList)
  {
    ...
    for (;;)
    {
      if (i < k)
      {
        localObject1 = this.jdField_a_of_type_Qep.a().a(paramInteger, (Long)paramList.get(i));
  ...
  public void a(Integer paramInteger, List<ArticleInfo> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (!paramBoolean)
      {
        ...
        paramInteger = this.jdField_a_of_type_Qep.a().b(paramInteger.intValue(), 10, localArticleInfo1.mRecommendSeq, true).iterator();
        while (paramInteger.hasNext())
        {
