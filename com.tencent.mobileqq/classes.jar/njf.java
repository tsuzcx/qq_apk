  ...
  implements Manager
{
  ...
  private nji jdField_a_of_type_Nji;
  ...
  public njf(QQAppInterface paramQQAppInterface)
  {
  ...
  private nry a()
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      return (nry)((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getManager(237);
    }
    return null;
  }
  ...
  private void b()
  {
    ...
    if (localTVK_IProxyFactory != null)
    {
      ...
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setPreloadCallback(new njj(this, null));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setOnPreLoadCompleteCallback(new njk(this, null));
    }
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_UserInfo = new TVK_UserInfo(b(), "");
    this.jdField_a_of_type_Nji = new nji(this, this);
    AppNetConnInfo.registerConnectionChangeReceiver(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Nji);
  ...
  public void a(nis paramnis)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if ((paramnis.jdField_a_of_type_Niu == null) || (paramnis.jdField_a_of_type_JavaUtilArrayList == null) || (paramnis.jdField_a_of_type_JavaUtilArrayList.size() <= 0))
        {
          c("handlePreloadTaskFromMessage invalid item");
          return;
        }
        niu localniu = paramnis.jdField_a_of_type_Niu;
        localnit = (nit)paramnis.jdField_a_of_type_JavaUtilArrayList.get(0);
        c("handlePreloadTaskFromMessage msgid:" + paramnis.c + ", vid:" + localnit.b);
        if (!TextUtils.isEmpty(localnit.b))
        {
          PAAdPreloadTask localPAAdPreloadTask = new PAAdPreloadTask();
          localPAAdPreloadTask.mUserUin = b();
          localPAAdPreloadTask.mVideoVid = localnit.b;
          if (this.jdField_b_of_type_JavaUtilArrayList.contains(localPAAdPreloadTask)) {
            break label309;
          }
          localPAAdPreloadTask.mMsgId = paramnis.c;
          localPAAdPreloadTask.mSource = 2;
          if (paramnis.jdField_a_of_type_Long > 0L)
          {
            l = paramnis.jdField_a_of_type_Long;
            ...
            localPAAdPreloadTask.mNetworkType = localniu.e;
            ...
            c("handlePreloadTaskFromMessage msgid:" + paramnis.c + ", vid:" + localnit.b + ", add to queue");
          }
        }
        else
        {
      ...
      continue;
      label309:
      c("handlePreloadTaskFromMessage msgid:" + paramnis.c + ", vid:" + localnit.b + ", exist in queue, ignore");
    }
  }
  
  public void a(nis paramnis, int paramInt)
  {
    Object localObject = this.jdField_a_of_type_JavaLangObject;
    if (paramnis != null) {}
    for (;;)
    {
      ...
      try
      {
        if ((paramnis.jdField_a_of_type_Niu == null) || (paramnis.jdField_a_of_type_JavaUtilArrayList == null) || (paramnis.jdField_a_of_type_JavaUtilArrayList.size() <= paramInt))
        {
          c("handlePreloadTaskFromPlay invalid item");
          return;
        }
        str = ((nit)paramnis.jdField_a_of_type_JavaUtilArrayList.get(paramInt)).b;
        c("handlePreloadTaskFromPlay msgid:" + paramnis.c + ", index:" + paramInt + ", vid:" + str);
        if (!TextUtils.isEmpty(str))
        {
          PAAdPreloadTask localPAAdPreloadTask = new PAAdPreloadTask();
          localPAAdPreloadTask.mUserUin = b();
          ...
          if (paramnis.jdField_a_of_type_Long > 0L)
          {
            ...
            localPAAdPreloadTask.mExpireTime = (localPAAdPreloadTask.mReceiveTime + jdField_a_of_type_JavaLangLong.longValue());
            localPAAdPreloadTask.mPreloadState = 1;
            localPAAdPreloadTask.mNetworkType = paramnis.jdField_a_of_type_Niu.e;
            this.c.add(localPAAdPreloadTask);
            ThreadManager.executeOnNetWorkThread(new AdvertisementVideoPreloadManager.9(this));
            c("handlePreloadTaskFromPlay msgid:" + paramnis.c + ", index:" + paramInt + ", vid:" + str + ", add to queue");
          }
        }
        else
        {
      ...
      continue;
      label317:
      c("handlePreloadTaskFromPlay msgid:" + paramnis.c + ", index:" + paramInt + ", vid:" + str + ", exist in queue, ignore");
    }
  }
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Nji != null)
    {
      this.jdField_a_of_type_Nji.a();
      AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Nji);
      this.jdField_a_of_type_Nji = null;
    }
