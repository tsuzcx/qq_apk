  ...
  public void onCardDownload(boolean paramBoolean, Object paramObject)
  {
    ...
    if ((paramObject instanceof Card))
    {
      ...
      if (AppConstants.BABY_Q_UIN.equals(paramObject.uin))
      {
        ...
        this.a.jdField_a_of_type_Azrb.jdField_a_of_type_ComTencentMobileqqDataCard = this.a.jdField_a_of_type_ComTencentMobileqqDataCard;
        this.a.jdField_a_of_type_Azrb.jdField_a_of_type_ArrayOfJavaLangString[0] = this.a.jdField_a_of_type_ComTencentMobileqqDataCard.strNick;
        this.a.jdField_a_of_type_Azrb.jdField_a_of_type_ArrayOfJavaLangString[4] = this.a.jdField_a_of_type_ComTencentMobileqqDataCard.strReMark;
      }
    }
    if (anqq.a(this.a).get("getZanVoteCount") != null)
    {
      paramObject = (Bundle)anqq.a(this.a).get("getZanVoteCount");
      ...
      anqq.a(this.a).remove("getZanVoteCount");
    }
  }
