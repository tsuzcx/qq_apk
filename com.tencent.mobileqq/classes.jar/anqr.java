...
public class anqr
{
  ...
  @Nullable
  private static UserData a(ToServiceMsg paramToServiceMsg, aber paramaber)
  {
    Object localObject = null;
    int i = a(paramToServiceMsg);
    if ((paramaber instanceof bbym))
    {
      paramToServiceMsg = ((bbym)paramaber).a[i];
      if (axei.b()) {
        if (paramToServiceMsg != null) {
          break label86;
        }
    ...
    label86:
    for (paramaber = "user data is null";; paramaber = paramToServiceMsg.strProvince)
    {
      axei.a("NearbyCmdHelper", new Object[] { "handleGetEncounter", Integer.valueOf(i), paramaber });
      return paramToServiceMsg;
      paramToServiceMsg = localObject;
      if (!(paramaber instanceof bbyk)) {
        break;
      }
      paramToServiceMsg = ((bbyk)paramaber).a[i];
      break;
    }
  }
  ...
  public static Object a(aber paramaber, FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    ...
    {
      paramaber = (RespGetPoint)paramaber.a(paramFromServiceMsg.getWupBuffer(), "RespGetPoint", new RespGetPoint());
      if (paramaber != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.nearby", 2, "LBSService --> decodeGetPointInfo(), url: " + new String(paramaber.stUDLinfo.SOSOUrl) + " , cityId = " + paramaber.stUDLinfo.cityId);
        }
        return paramaber;
      }
    }
  ...
  public static Object a(AppInterface paramAppInterface, FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg, aber paramaber)
  {
    ...
    {
      awch.a("LBS", "CMD_GET_ENCOUNTER eReplyCode:" + localRespHeader.eReplyCode);
      localUserData = null;
      bool = false;
      if (localRespHeader == null) {
        break label500;
      ...
      ((bbym)paramaber).a[i] = localUserData;
      label144:
      if (axei.b())
      {
        ...
        label158:
        axei.a("NearbyCmdHelper", new Object[] { "decodeGetEncounter", Integer.valueOf(i), paramAppInterface });
      }
      if (localUserData != null)
      {
        arkt.a(paramToServiceMsg.extraData.getString("account"), localUserData.iLon, localUserData.iLat, localUserData.lTime);
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      awch.a("LBS", "CMD_GET_ENCOUNTER eReplyCode:" + null);
      break;
      label397:
      if (!(paramaber instanceof bbyk)) {
        break label144;
      }
      ((bbyk)paramaber).a[i] = localUserData;
      break label144;
      label419:
      ...
      anqv.a(paramAppInterface, i);
      paramAppInterface = localUserData;
      continue;
      label500:
      anqv.a(paramAppInterface, -1111);
      return null;
      label509:
      bool = true;
      paramAppInterface = paramFromServiceMsg;
  ...
  public static void a(anii paramanii, byte paramByte)
  {
    try
    {
      long l = Long.parseLong(paramanii.getCurrentAccountUin());
      Object localObject = new byte[13];
      bgva.a((byte[])localObject, 0, l);
      localObject[4] = 0;
      bgva.a((byte[])localObject, 5, (short)1);
      bgva.a((byte[])localObject, 7, 40493);
      bgva.a((byte[])localObject, 9, (short)2);
      bgva.a((byte[])localObject, 11, (short)paramByte);
      localObject = paramanii.makeOIDBPkg("OidbSvc.0x4ff_9", 1279, 9, (byte[])localObject);
      ...
      paramanii.sendPbReq((ToServiceMsg)localObject);
      arkw.a("send_oidb_0x4ff_9", new Object[] { Byte.valueOf(paramByte) });
      return;
    }
    catch (Exception paramanii)
    {
      while (!QLog.isColorLevel()) {}
      QLog.w("Q.dating", 2, "send_oidb_0x4ff_9 error", paramanii);
    }
  }
  
  public static void a(anii paramanii, int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramObject != null) && (paramFromServiceMsg.isSuccess()))
    {
      ...
      if (bool1) {
        if ((paramObject != null) && (paramObject.SOSOUrl.length > 0)) {
          paramanii.notifyUI(paramInt, true, paramObject.SOSOUrl);
        }
      }
    }
    do
    {
      ...
      if (paramObject.cityId != null)
      {
        ...
        if (paramObject.cityId.length == 16)
        {
          ...
          paramToServiceMsg[0] = anjh.a(localByteBuffer.getInt());
          paramToServiceMsg[1] = anjh.a(localByteBuffer.getInt());
          paramToServiceMsg[2] = anjh.a(localByteBuffer.getInt());
      ...
      if (bool1)
      {
        paramanii.notifyUI(paramInt, false, null);
        return;
      }
    } while (!bool2);
    paramanii.notifyUI(paramInt, false, null);
  ...
  public static void a(anii paramanii, int paramInt1, List<axid> paramList, int paramInt2, int paramInt3)
  {
    if (paramList == null)
    {
      c(paramanii, paramInt1, null, null, null);
      return;
    }
    ...
    {
      axid localaxid = (axid)paramList.get(paramInt1);
      if (localaxid != null) {
        localReqBody.rpt_msg_tags.add(localaxid.a());
      }
      paramInt1 += 1;
    }
    paramList = paramanii.makeOIDBPkg("OidbSvc.0x9c7_0", 2503, 0, localReqBody.toByteArray());
    paramList.extraData.putInt("set_mode", paramInt2);
    paramList.extraData.putInt("test_mode", paramInt3);
    paramanii.sendPbReq(paramList);
  }
  
  public static void a(anii paramanii, long paramLong, int paramInt, byte[] paramArrayOfByte)
  {
    Object localObject = new cmd0x682.ReqBody();
    ((cmd0x682.ReqBody)localObject).rpt_uint64_touinlist.add(Long.valueOf(paramLong));
    localObject = paramanii.makeOIDBPkg("OidbSvc.0x682", 1666, 0, ((cmd0x682.ReqBody)localObject).toByteArray());
    ((ToServiceMsg)localObject).extraData.putByteArray("showlove_chat_sig", paramArrayOfByte);
    paramanii.sendPbReq((ToServiceMsg)localObject);
    a(paramanii.mApp, paramInt);
    arkw.c("getShowLove", new Object[] { "from type " + paramInt });
  }
  
  public static void a(anii paramanii, boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2)
  {
    if ((!paramBoolean1) && (!paramBoolean2)) {
      return;
    }
    ToServiceMsg localToServiceMsg = new ToServiceMsg("mobileqq.service", paramanii.getCurrentAccountUin(), "NeighborSvc.ReqGetPoint");
    ...
    for (;;)
    {
      paramanii.send(localToServiceMsg);
      return;
  ...
  private static void a(AppInterface paramAppInterface, int paramInt)
  {
    ...
    if ((paramInt & 0x4) == 4)
    {
      ...
      arkw.c("getShowLove", new Object[] { "report value ", str });
      str = "";
      if ((paramInt & 0x1) != 1) {
        break label184;
      }
    ...
    for (;;)
    {
      ...
      {
        paramAppInterface.reportClickEvent("CliOper", "", "", str, str, 0, 0, "", "", "", "");
        arkw.c("getShowLove", new Object[] { "report value2 ", str });
      }
      return;
      if ((paramInt & 0x8) == 8)
      {
  ...
  public static boolean a(aber paramaber, ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    boolean bool1 = false;
    int j = 0;
    ...
    {
      paramaber = new NeighborSvc.ReqHeader();
      paramaber.shVersion = 2;
      paramaber.lMID = aber.a(Long.parseLong(paramToServiceMsg.getUin()));
      paramaber.iAppID = AppSetting.a();
      paramaber.eBusiType = 0;
      paramaber.eMqqSysType = 2;
      ...
      for (i = 1;; i = 0) {
        for (;;)
        {
          ...
          paramUniPacket.put("ReqHeader", paramaber);
          ...
          aoor.a(new anqs("LBSService.Point", paramToServiceMsg));
          try
          {
            paramToServiceMsg.wait();
            Object localObject2 = axbr.a(true, aoor.a("LBSService.Point"));
    ...
    paramaber = new FromServiceMsg(paramToServiceMsg.getUin(), paramToServiceMsg.getServiceCmd());
    paramaber.setMsgFail();
    try
    {
      paramToServiceMsg.actionListener.onActionResult(paramaber);
      return false;
    }
    catch (RemoteException paramaber) {}
    return false;
  }
  
  public static boolean a(AppInterface paramAppInterface, ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket, aber paramaber)
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyCmdHelper", 2, "handleGetEncounter start...");
    }
    if (paramToServiceMsg.extraData.getBoolean("isCheckInReq", false)) {
      return b(paramAppInterface, paramToServiceMsg, paramUniPacket, paramaber);
    }
    Object localObject3 = a(paramToServiceMsg, paramaber);
    ...
    while ((paramaber != null) || (bool1))
    {
      ...
      localReqHeader.lMID = aber.a(Long.parseLong(paramToServiceMsg.getUin()));
      ...
      a(m, n, bool1, paramaber, localReqUserInfo1);
      ...
      if (axei.b()) {
        axei.a("NearbyCmdHelper", "handleGetEncounter interest", new Object[] { Byte.valueOf(b2), Long.valueOf(l2) });
      }
      ...
      if (((Boolean)axdz.a(paramAppInterface.getAccount(), "is_nearby_novice", Boolean.valueOf(false))).booleanValue())
      {
        i = 1;
        if (QLog.isColorLevel()) {
      ...
      for (paramToServiceMsg = "lbs is not null";; paramToServiceMsg = "isUseGps is true")
      {
        ...
        paramUniPacket.put("param_NetType", bgnt.a(null) + "");
        bctj.a(BaseApplicationImpl.getContext()).a(paramAppInterface.getCurrentAccountUin(), "GET_ENCOUNTER_LOCATION", true, 0L, 0L, paramUniPacket, "");
        return true;
        i = 0;
        break;
      }
    ...
    if (QLog.isColorLevel()) {
      QLog.d("NearbyCmdHelper", 2, "handleGetEncounter lbsInfo=" + paramaber + ", isUseGps=" + bool1);
    }
    if (paramaber == null) {
    ...
    paramToServiceMsg.put("param_NetType", bgnt.a(null) + "");
    bctj.a(BaseApplicationImpl.getContext()).a(paramAppInterface.getCurrentAccountUin(), "GET_ENCOUNTER_LOCATION", false, 0L, 0L, paramToServiceMsg, "");
    return false;
  }
  ...
  private static byte[] a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      return localObject;
      label100:
      localObject = a(axbr.a());
    }
  }
  
  public static void b(anii paramanii, int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    boolean bool2 = false;
    int i = -1;
    try
    {
      ...
      if (bool1)
      {
        ...
        if (localRspBody.uint32_config_seq.has())
        {
          ...
          axdz.a(paramanii.mApp.getAccount(), "toplist_hide_boygod_seq", Integer.valueOf(j));
        }
        if (localRspBody.uint32_config_time.has())
        {
          j = localRspBody.uint32_config_time.get();
          axdz.a(paramanii.mApp.getAccount(), "key_last_config_time", Integer.valueOf(j));
        }
        ...
        if ((i == 2) && (localRspBody.msg_charm_event.has()))
        {
          ...
          if (!(paramanii.mApp instanceof NearbyAppInterface)) {
            break label599;
          }
        }
        int k;
        ...
        for (;;)
        {
          ...
          paramanii.notifyUI(paramInt, true, new Object[] { Boolean.valueOf(false), Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(n), Integer.valueOf(i1), paramToServiceMsg });
          paramToServiceMsg = "0X80052B1";
          if (k - i < 0) {
            paramToServiceMsg = "0X80052B2";
          }
          paramanii.mApp.reportClickEvent("CliOper", "", "", paramToServiceMsg, paramToServiceMsg, 0, 0, "", "", "", "");
          return;
          ...
          break;
          label599:
          if ((paramanii.mApp instanceof QQAppInterface)) {
            ((QQAppInterface)paramanii.mApp).a().a(paramToServiceMsg.getUin(), paramFromServiceMsg, paramObject, (Oidb_0x686.CharmEvent)localObject1, (Oidb_0x686.NearbyCharmNotify)localObject2);
          }
        }
        label636:
        if ((localObject2 != null) && (((Oidb_0x686.NearbyCharmNotify)localObject2).uint32_pop_flag.get() == 1))
        {
          ...
          paramanii.notifyUI(paramInt, true, new Object[] { Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(n), Integer.valueOf(i1), Integer.valueOf(i2), Integer.valueOf(i3), paramToServiceMsg });
  ...
  protected static boolean b(AppInterface paramAppInterface, ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket, aber paramaber)
  {
    int i = paramToServiceMsg.extraData.getInt("localLat");
    int j = paramToServiceMsg.extraData.getInt("localLon");
    if (QLog.isColorLevel()) {
    ...
    if ((i != 0) && (j != 0))
    {
      ...
      paramAppInterface.lMID = aber.a(Long.parseLong(paramToServiceMsg.getUin()));
      ...
      paramaber = new ReqGetEncounterV2();
      paramaber.stUserData = new UserData();
      paramaber.stUserInfo = paramToServiceMsg;
      paramaber.eNewListType = 100;
      paramaber.neighbor_list_source = 4;
      paramUniPacket.setEncodeName("utf-8");
      paramUniPacket.setServantName("EncounterObj");
      paramUniPacket.setFuncName("CMD_GET_ENCOUNTERV2");
      paramUniPacket.put("ReqHeader", paramAppInterface);
      paramUniPacket.put("ReqGetEncounterV2", paramaber);
      return true;
    }
    return false;
  }
  
  public static void c(anii paramanii, int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null))
    {
      paramanii.notifyUI(paramInt, false, new Object[] { "", null, anni.a(2131705905), Integer.valueOf(-1), Integer.valueOf(-1) });
      return;
    }
    int i;
    int j;
    ...
    if (paramToServiceMsg.extraData == null)
    {
      ...
      m = anii.parseOIDBPkg(paramFromServiceMsg, paramObject, localRspBody);
      if (m != 0) {
        break label472;
      }
    ...
    for (paramFromServiceMsg = localRspBody.rpt_msg_tags.get();; paramFromServiceMsg = null)
    {
      ...
      {
        axid localaxid = axid.a((appoint_define.InterestTag)paramFromServiceMsg.get(k));
        if (localaxid != null) {
          paramObject.add(localaxid);
        }
        k += 1;
      }
    ...
    {
      paramanii.notifyUI(4, false, new Object[] { "", null, anni.a(2131705906), Integer.valueOf(i), Integer.valueOf(j) });
      axei.a("Q.nearby_people_card.", "handle_oidb_0x9c7_0", new Object[] { Integer.valueOf(m), Boolean.valueOf(true), null, paramToServiceMsg });
      return;
    }
    if ((paramanii.mApp instanceof NearbyAppInterface)) {
      ((NearbyAppInterface)paramanii.mApp).a().a(localRspBody);
    }
    for (;;)
    {
      paramanii.notifyUI(paramInt, true, new Object[] { paramToServiceMsg, paramObject, "", Integer.valueOf(i), Integer.valueOf(j) });
      axei.a("Q.nearby_people_card.", "handle_oidb_0x9c7_0", new Object[] { Integer.valueOf(m), Boolean.valueOf(true), paramObject, paramToServiceMsg });
      return;
      if (paramanii.app != null) {
        paramanii.app.a().a(localRspBody);
      }
    }
    label472:
    ...
    {
      paramanii.notifyUI(paramInt, false, new Object[] { "", null, paramToServiceMsg, Integer.valueOf(i), Integer.valueOf(j) });
      return;
    }
  }
  
  public static void d(anii paramanii, int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    boolean bool2 = true;
    boolean bool1;
        ...
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg.uint32_result.has()))
        {
          ...
          if ((i == 0) && (paramFromServiceMsg.bytes_bodybuffer.has()) && (paramFromServiceMsg.bytes_bodybuffer.get() != null))
          {
            ...
            if (4 <= paramFromServiceMsg.length)
            {
              ...
              if ((paramFromServiceMsg == null) || (!paramFromServiceMsg.equals(paramanii.getCurrentAccountUin())))
              {
                if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      if ((paramanii.mApp instanceof QQAppInterface)) {
        if (paramInt == 7)
        {
          ...
          if (bool1)
          {
            paramToServiceMsg = ((QQAppInterface)paramanii.mApp).a();
            if (paramInt != 0) {
              break label294;
            }
            paramToServiceMsg.a(bool2);
          }
          paramanii.notifyUI(7, bool1, null);
        }
      }
      for (;;)
      {
        ...
        if ((paramanii.mApp instanceof NearbyAppInterface))
        {
          paramFromServiceMsg = (NearbyAppInterface)paramanii.mApp;
          if (paramInt == 10)
          {
            ...
            paramanii.notifyUI(10, bool1, null);
          }
        }
      }
      label364:
  ...
  public static void e(anii paramanii, int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    cmd0x682.RspBody localRspBody = new cmd0x682.RspBody();
    int i = anii.parseOIDBPkg(paramFromServiceMsg, paramObject, localRspBody);
    arkw.a("getShowLove", new Object[] { "handleGetShowLoveLimit result = " + i });
    int n;
    if ((i == 0) && (localRspBody.rpt_msg_chatinfo.has()) && (localRspBody.rpt_msg_chatinfo.size() > 0))
    {
      ...
      if ((paramanii instanceof axeq)) {
        paramanii.notifyUI(9, true, new Object[] { Long.valueOf(l), Boolean.valueOf(bool1), Boolean.valueOf(bool2), paramToServiceMsg, paramFromServiceMsg, paramObject });
      }
      if (QLog.isColorLevel()) {
      ...
      if (i1 == 1) {
        paramanii.mApp.reportClickEvent("CliOper", "", "", "0X8005290", "0X8005290", 0, 0, "", "", "", "");
      }
    }
    for (;;)
    {
      ...
      if (n == 1)
      {
        paramanii.mApp.reportClickEvent("CliOper", "", "", "0X8005291", "0X8005291", 0, 0, "", "", "", "");
        continue;
        paramanii.notifyUI(paramInt, false, null);
      }
    }
