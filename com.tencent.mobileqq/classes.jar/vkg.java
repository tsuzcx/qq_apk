  ...
  implements AdapterView.OnItemClickListener
{
  ...
  private List<bbjs>[] a(Context paramContext)
  {
    ...
    localbbjs.jdField_b_of_type_Int = 2130840055;
  ...
  private boolean b()
  {
    ...
    if (!WXShareHelper.a().a()) {
      str = ajya.a(2131716390);
    }
    while (!TextUtils.isEmpty(str))
    {
      jdField_b_of_type_Int = -1;
      bcql.a(this.jdField_a_of_type_AndroidAppActivity, 1, str, 0).a();
      return false;
      if (!WXShareHelper.a().b()) {
        str = ajya.a(2131716373);
      }
    }
    return true;
  }
  ...
  protected String a(int paramInt1, String paramString1, String paramString2, int paramInt2)
  {
    if ("S".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + ajya.a(2131716385) + ajya.a(2131716393);
    }
    if ("A".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + ajya.a(2131716379) + ajya.a(2131716369);
    }
    if ("B".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + ajya.a(2131716381) + ajya.a(2131716389);
    }
    if ("C".equals(paramString1)) {
      return "[QQ高能舞室]" + paramString2 + " " + paramInt1 + ajya.a(2131716375) + ajya.a(2131716404);
    }
    return "[QQ高能舞室]" + ajya.a(2131716394);
  }
  ...
  {
    new vki(this.jdField_a_of_type_AndroidAppActivity, this.jdField_c_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, paramInt1, this.jdField_a_of_type_MqqUtilWeakReference, paramInt2).execute(new Void[0]);
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    if (paramInt2 == 2)
    {
      ...
      bcql.a(this.jdField_a_of_type_AndroidAppActivity, 1, ajya.a(2131716371), 1).a();
    }
    do
    {
      do
  ...
  public void a(Activity paramActivity, String paramString1, String paramString2, AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Avwb = new avwb(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Avwb.a(a(this.jdField_a_of_type_AndroidAppActivity));
    this.jdField_a_of_type_Avwb.a(this);
    this.jdField_a_of_type_Avwb.a(this.jdField_a_of_type_AndroidAppActivity.getString(2131719508));
  ...
  protected void a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString)) {
      bbdx.a(new File(paramString).getParent());
    }
  }
  
  protected void a(List<bbjs> paramList) {}
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Avwb != null) {
      this.jdField_a_of_type_Avwb.a();
    }
  }
  
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    if (this.jdField_a_of_type_Avwb.a().isShowing()) {
      this.jdField_a_of_type_Avwb.a().dismiss();
    }
    paramAdapterView = ((bbjv)paramView.getTag()).a;
