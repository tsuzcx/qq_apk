  ...
  implements bcrb<SpriteGLView>
{
  ...
  public bcsi()
  {
    ...
    this.jdField_a_of_type_Bcrd = new bcrd(0.0F, 0.0F);
    f();
  }
  
  public bcsi(SpriteGLView paramSpriteGLView)
  {
    this.jdField_c_of_type_ArrayOfFloat = new float[] { 1.0F, 1.0F, 0.0F, -1.0F, 1.0F, 0.0F, -1.0F, -1.0F, 0.0F, -1.0F, -1.0F, 0.0F, 1.0F, 1.0F, 0.0F, 1.0F, -1.0F, 0.0F };
    this.jdField_a_of_type_ArrayOfShort = new short[] { 0, 1, 2, 3, 4, 5 };
    this.jdField_a_of_type_ArrayOfFloat = new float[] { 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 1.0F, 0.0F, 1.0F, 1.0F };
  ...
  public bcsi(SpriteGLView paramSpriteGLView, Bitmap paramBitmap)
  {
    this.jdField_c_of_type_ArrayOfFloat = new float[] { 1.0F, 1.0F, 0.0F, -1.0F, 1.0F, 0.0F, -1.0F, -1.0F, 0.0F, -1.0F, -1.0F, 0.0F, 1.0F, 1.0F, 0.0F, 1.0F, -1.0F, 0.0F };
    this.jdField_a_of_type_ArrayOfShort = new short[] { 0, 1, 2, 3, 4, 5 };
    this.jdField_a_of_type_ArrayOfFloat = new float[] { 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 1.0F, 0.0F, 1.0F, 1.0F };
    ...
    this.jdField_a_of_type_Bcrd = new bcrd(0.0F, 0.0F);
    this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView = paramSpriteGLView;
    this.jdField_a_of_type_Bcsl = new bcsl(paramSpriteGLView, paramBitmap);
    g();
    f();
  }
  ...
  public void a(bcsl parambcsl)
  {
    this.jdField_a_of_type_Bcsl = parambcsl;
    g();
  }
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView = paramSpriteGLView;
    this.jdField_a_of_type_Bcsl = new bcsl(this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView, paramBitmap);
    g();
  }
  ...
  protected void ay_()
  {
    super.ay_();
    if (this.jdField_a_of_type_Bcsl != null) {
      this.jdField_a_of_type_Bcsl.b = false;
    }
  }
  ...
  public int c()
  {
    ...
    return this.jdField_a_of_type_Bcsl.jdField_a_of_type_Int;
  }
  ...
  public void c(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, float[] paramArrayOfFloat)
  {
    ...
    float f4 = (2.0F * this.jdField_a_of_type_Bcrd.jdField_a_of_type_Float * b() - paramInt1) / paramInt2;
    ...
    for (float f1 = (-paramInt2 + 2.0F * this.jdField_a_of_type_Bcrd.jdField_b_of_type_Float * b()) / paramInt2;; f1 = (paramInt2 - 2.0F * this.jdField_a_of_type_Bcrd.jdField_b_of_type_Float * b()) / paramInt2)
    {
  ...
  public int d()
  {
    if ((this.jdField_a_of_type_Bcsl == null) || (this.jdField_a_of_type_Bcsl.jdField_a_of_type_AndroidGraphicsBitmap == null) || (this.jdField_a_of_type_Bcsl.jdField_a_of_type_AndroidGraphicsBitmap.isRecycled())) {
      return (int)this.jdField_a_of_type_Float;
    }
    return this.jdField_a_of_type_Bcsl.jdField_a_of_type_AndroidGraphicsBitmap.getWidth();
  }
  ...
  public int e()
  {
    ...
    return this.jdField_a_of_type_Bcsl.jdField_a_of_type_AndroidGraphicsBitmap.getHeight();
  }
  ...
  protected void g()
  {
    if ((this.jdField_a_of_type_Bcsl == null) || (this.jdField_a_of_type_Bcsl.jdField_a_of_type_AndroidGraphicsBitmap == null)) {
      return;
    }
    this.jdField_a_of_type_Float = this.jdField_a_of_type_Bcsl.jdField_a_of_type_AndroidGraphicsBitmap.getWidth();
    this.jdField_b_of_type_Float = this.jdField_a_of_type_Bcsl.jdField_a_of_type_AndroidGraphicsBitmap.getHeight();
  }
}
