...
public class nzz
{
  private static final nzz jdField_a_of_type_Nzz = new nzz();
  ...
  {
    paramString = ((anrs)paramAppInterface.getManager(56)).b(paramString + "");
  ...
  private mobileqq_mp.SendMenuEventRequest a(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      localSendMenuEventRequest.versionInfo.set("8.4.1,3,4680");
  ...
  private String a(QQAppInterface paramQQAppInterface)
  {
    ...
    List localList = ((ProxyManager)localObject).a().getRecentList(true);
    if (localList == null) {
      return "";
    }
    ...
    for (;;)
    {
      ...
      for (localObject = ((RecentUser)localObject).uin;; localObject = "0")
      {
        ...
        if (((RecentUser)localObject).getType() == 7210)
        {
          ...
          if (twi.a().a(paramQQAppInterface) != 0) {
            i = 1;
          }
          break label153;
        }
        if ((((RecentUser)localObject).getType() != 7230) || (tue.a().b() == 0)) {
          break label421;
        }
        i = 1;
        break label153;
  ...
  private void a(Context paramContext, QQAppInterface paramQQAppInterface)
  {
    ...
    alzs.a().a(paramQQAppInterface, "aio_othercity_click");
  }
  ...
  private void a(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    if (AudioHelper.b(0))
    {
      bglp.a(paramContext, 230, paramContext.getString(2131697656), paramContext.getString(2131697657), new oam(this), null).show();
      return;
    }
    if (AudioHelper.a(0))
    {
      bglp.a(paramContext, 230, paramContext.getString(2131697656), paramContext.getString(2131697658), new oan(this), null).show();
      return;
    }
    agaa.a(paramQQAppInterface, (BaseActivity)paramContext, 1, 0);
    ...
    try
    {
      ...
      this.jdField_b_of_type_AndroidContentBroadcastReceiver = new oab(this);
  ...
  private static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, mobileqq_mp.ButtonInfo paramButtonInfo)
  {
    ...
    if ((paramContext instanceof FragmentActivity))
    {
      ...
      if (localObject != null)
      {
        ...
        if ((localObject instanceof aidp))
        {
          localObject = (aidp)localObject;
          ((aidp)localObject).y += 1;
        }
      }
    }
    ...
    for (;;)
    {
      ...
      ((Intent)localObject).putExtra("assignBackText", paramContext.getResources().getString(2131690563));
      ((Intent)localObject).putExtra("FORCE_BLANK_SCREEN_REPORTE", true);
      ((Intent)localObject).putExtra("big_brother_source_key", tzo.b(paramString));
  ...
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    ...
    localIntent.putExtra("assignBackText", paramContext.getResources().getString(2131690563));
    localIntent.putExtra("big_brother_source_key", tzo.b(paramString2));
    paramContext.startActivity(localIntent);
  }
  ...
  private void a(Context paramContext, MqqHandler paramMqqHandler, boolean paramBoolean)
  {
    ...
    localIntent.putExtra("from", nzz.class.getName());
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidContentBroadcastReceiver = new oal(this, paramBoolean, paramMqqHandler);
  ...
  private void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    tzo.a(localIntent, paramQQAppInterface, paramContext, paramString, -1);
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, mobileqq_mp.ButtonInfo paramButtonInfo, String paramString2)
  {
    ...
    if ((!TextUtils.isEmpty(paramString2)) && (biub.a(paramString2)))
    {
      bbyc localbbyc = new bbyc();
      int i;
      Bundle localBundle;
      int j;
      if (bbyc.a((String)localObject) == 0)
      {
        i = 0;
        localBundle = bbyc.a((String)localObject);
        j = localBundle.getInt("a_launch_mode", 268435456);
        if (i == 0) {
          break label136;
        }
        localbbyc.a(paramQQAppInterface, paramContext, String.valueOf(l), (String)localObject, paramString2, j);
      }
      for (;;)
      {
        if (!bool) {
        ...
        break;
        label136:
        bool = biub.a(paramContext, paramString2, localBundle, j);
      }
    }
    a(paramQQAppInterface, paramContext, paramString1, paramButtonInfo);
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, MqqHandler paramMqqHandler)
  {
    ...
    alzs.a().a(paramQQAppInterface, "aio_news_click");
  }
  ...
  private void a(mobileqq_mp.SendMenuEventRequest paramSendMenuEventRequest)
  {
    ...
    NewIntent localNewIntent = new NewIntent(localContext, oba.class);
    ...
    ((PROTOCAL.StQWebReq)localObject).qua.set(blru.a());
    ((PROTOCAL.StQWebReq)localObject).deviceInfo.set(blrt.a().c());
    ...
    localNewIntent.setObserver(new oaf(this, localNewIntent, localContext, str1, localBusinessObserver, localQQAppInterface));
  ...
  private void b(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    if (localUri != null)
    {
      bkho localbkho = bkho.a((BaseActivity)paramContext);
      String[] arrayOfString = paramContext.getResources().getStringArray(2130968667);
      int j = arrayOfString.length;
      int i = 0;
      while (i < j)
      {
        localbkho.c(arrayOfString[i]);
        i += 1;
      }
      localbkho.c(2131690582);
      localbkho.a(new oac(this, paramQQAppInterface, paramContext, localUri, paramSessionInfo, localbkho));
      localbkho.show();
    }
    for (;;)
    {
      ...
      try
      {
        ...
        label113:
        this.jdField_b_of_type_AndroidContentBroadcastReceiver = null;
        this.jdField_b_of_type_AndroidContentBroadcastReceiver = new oad(this);
        paramQQAppInterface = new IntentFilter("com.tencent.biz.pubaccount.picResultAction");
        paramContext.registerReceiver(this.jdField_b_of_type_AndroidContentBroadcastReceiver, paramQQAppInterface, "com.tencent.msg.permission.pushnotify", null);
        this.jdField_a_of_type_Int = 2;
        return;
        agaa.a(paramQQAppInterface, (Activity)paramContext, paramSessionInfo, null, null);
        paramQQAppInterface = (anwd)paramQQAppInterface.a(20);
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    RecentUser localRecentUser = (RecentUser)localaong.findRecentUserByUin(paramString, 1008);
  ...
  private void c(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    try
    {
      ((FragmentActivity)paramContext).getChatFragment().a().aK();
    ...
    catch (Exception paramSessionInfo)
    {
      try
      {
        ...
        this.jdField_c_of_type_AndroidContentBroadcastReceiver = new oae(this, paramQQAppInterface, bool);
  ...
  protected int a(String paramString, int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    case 1024: 
      do
      {
        ...
        return 1;
      } while (!nmp.b(paramQQAppInterface, paramString));
      return 2;
    case 0: 
      return 3;
    case 1: 
  ...
  public NewIntent a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, BusinessObserver paramBusinessObserver, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localNewIntent = new NewIntent(paramContext, oba.class);
      ...
      ((PROTOCAL.StQWebReq)localObject1).qua.set(blru.a());
      ((PROTOCAL.StQWebReq)localObject1).deviceInfo.set(blrt.a().c());
      ...
      localNewIntent.setObserver(new oag(this, localNewIntent, paramQQAppInterface, paramString, paramContext, paramBusinessObserver));
  ...
  public NewIntent a(String paramString, int paramInt, boolean paramBoolean, Context paramContext, AppInterface paramAppInterface, oap paramoap)
  {
    paramContext = new NewIntent(paramContext, oaz.class);
    ...
    paramContext.setObserver(new oaj(this, paramContext, paramoap));
    if (paramAppInterface != null) {
      paramAppInterface.startServlet(paramContext);
    }
    return paramContext;
  ...
  public void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, oao paramoao)
  {
    if ((paramString1 != null) && (!paramString1.equals(this.jdField_c_of_type_JavaLangString))) {
      a(paramString1);
    }
    this.jdField_c_of_type_JavaLangString = paramString1;
    ThreadManager.executeOnSubThread(new PublicAccountManager.1(this, paramString2, paramQQAppInterface, paramoao, paramContext));
  }
  ...
  public void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean, double paramDouble1, double paramDouble2, BusinessObserver paramBusinessObserver, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    try
    {
      ...
      NewIntent localNewIntent = new NewIntent(paramContext, oba.class);
      localNewIntent.putExtra("cmd", "CertifiedAccountSvc.certified_account_write.SendMenuEvent");
      paramString2 = new PROTOCAL.StQWebReq();
      paramString2.Seq.set(-1L);
      paramString2.qua.set(blru.a());
      paramString2.deviceInfo.set(blrt.a().c());
      ...
      localNewIntent.setObserver(new oah(this, localNewIntent, paramContext, paramString1, paramBusinessObserver, paramQQAppInterface));
      if (paramQQAppInterface != null) {
        paramQQAppInterface.startServlet(localNewIntent);
      }
      return;
  ...
  public void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, BusinessObserver paramBusinessObserver)
  {
    ...
    catch (Exception paramString2)
    {
      do
      {
        ...
        paramString3 = new NewIntent(paramBaseActivity, oba.class);
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      bcst.b(null, "dc01160", "Pb_account_lifeservice", "", "0X800661D", "0X800661D", 0, 0, "", "", (String)localObject, "");
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, mobileqq_mp.GetPublicAccountMenuResponse paramGetPublicAccountMenuResponse)
  {
    ...
    {
      bcst.a(paramQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005EC2", "0X8005EC2", 0, 0, paramString, paramGetPublicAccountMenuResponse, "", "");
      ...
      bcst.a(paramQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005EC3", "0X8005EC3", 0, 0, paramString, String.valueOf(((mobileqq_mp.ButtonInfo)((List)localObject).get(0)).sub_button.get().size()), "", "");
      return;
      i = 0;
      break label43;
      label381:
  ...
  public void a(String paramString1, Context paramContext, QQAppInterface paramQQAppInterface, String paramString2, int paramInt1, BusinessObserver paramBusinessObserver, MqqHandler paramMqqHandler, int paramInt2, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      if (localButtonInfo.type.has())
      {
        ...
        oat.a(null, "P_CliOper", "Pb_account_lifeservice", paramString2, "mp_caidan_click", "aio_caidan_click", 0, 0, String.valueOf(paramInt2), String.valueOf(paramInt1), paramString1, String.valueOf(i), false);
        pmy.a().a(paramString2, paramInt1, paramInt2, localButtonInfo);
        ...
        if (i == 2)
        {
          ...
          paramString1 = bcvs.a(localButtonInfo.url.get());
        }
        ...
        oat.a(null, "P_CliOper", "Pb_account_lifeservice", paramString2, "0X8005D4B", "0X8005D4B", 0, 0, (String)localObject + ";REFERRER=" + paramString1, "", "", "", false);
      ...
      for (boolean bool = localButtonInfo.is_new_menu.get();; bool = false)
      {
        ...
        if ((paramContext instanceof FragmentActivity))
        {
          ...
          if (paramString1 != null)
          {
            ...
            if ((paramString1 instanceof aidp))
            {
              paramString1 = (aidp)paramString1;
              paramString1.w += 1;
            }
          }
        }
      ...
      paramSessionInfo = bgng.a(paramQQAppInterface, paramContext, paramString1);
  ...
  public boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    } while ((bgln.e()) || (bgmg.a() <= 1.048576E+008F));
