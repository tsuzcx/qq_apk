  ...
  implements amql
{
  ...
  public amlh a;
  public bkjp a;
  private AVVideoCtrl.EnableCameraCompleteCallback jdField_a_of_type_ComTencentTMGSdkAVVideoCtrl$EnableCameraCompleteCallback = new amxn(this);
  ...
  public amxj(int paramInt)
  {
    this.jdField_a_of_type_Bkjp = new amxm(this);
  ...
  private void a(String[] paramArrayOfString, String paramString)
  {
    ...
    paramArrayOfString = new amxp(this);
    if (QLog.isColorLevel())
    {
      i = j;
      while (i < localArrayList1.size())
    ...
    if ((anie.a(BaseApplicationImpl.getContext()).a() != null) && (anie.a(BaseApplicationImpl.getContext()).a().getRoom() != null) && (localArrayList1.size() > 0)) {
      anie.a(BaseApplicationImpl.getContext()).a().getRoom().requestViewList((String[])localArrayList1.toArray(new String[localArrayList1.size()]), (AVView[])localArrayList2.toArray(new AVView[localArrayList2.size()]), localArrayList1.size(), paramArrayOfString);
    }
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    this.f = paramBoolean;
    if ((amwn.b(this.jdField_a_of_type_Long) != null) && (amwn.b(this.jdField_a_of_type_Long).a != null))
    {
      AppActivity localAppActivity = (AppActivity)amwn.b(this.jdField_a_of_type_Long).a.get();
      localAppActivity.requestPermissions(new amxo(this, localAppActivity), 1, new String[] { "android.permission.CAMERA" });
    }
  }
  ...
  AVVideoCtrl a()
  {
    AVContext localAVContext = anie.a(BaseApplicationImpl.getContext()).a();
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        anhw.a().b(paramBoolean);
        break label60;
      } while ((anie.a(BaseApplicationImpl.getContext()).a() == null) || (anie.a(BaseApplicationImpl.getContext()).a().getRoom() == null));
      label130:
      label140:
      anie.a(BaseApplicationImpl.getContext()).a().getRoom().cancelAllView(new amxq(this));
    }
  }
  ...
  public void d()
  {
    ...
    {
      anhw.a().a("" + this.jdField_a_of_type_Int);
      if (this.jdField_a_of_type_Amlh != null) {
        this.jdField_a_of_type_Amlh.b();
      }
      b(false);
  ...
  public void grant()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        amwn.a().callbackFromRequest(this.jdField_a_of_type_Long, 0, "cs.audioRoom_camera_enable.local", ((JSONObject)localObject).toString());
        return;
      }
      ...
      try
      {
        ...
        amwn.a().callbackFromRequest(this.jdField_a_of_type_Long, i, "cs.audioRoom_camera_enable.local", ((JSONObject)localObject).toString());
