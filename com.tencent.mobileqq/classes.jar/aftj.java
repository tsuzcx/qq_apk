  ...
  implements afrc
{
  ...
  private bhdq jdField_a_of_type_Bhdq = new aftm(this);
  private SessionInfo jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
  private BaseChatPie jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public aftj(BaseChatPie paramBaseChatPie)
  {
    ...
    this.jdField_a_of_type_Bffx = new aftk(this);
  }
  ...
  private void e()
  {
    ...
    amau localamau = ((amaz)localObject).a();
    if (localamau == null) {}
    do
    {
      do
  ...
  public RobotPanelLayoutBase a()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof afii)) {
      localTroopAIORobotLayout = ((afii)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie).a;
    }
    while (!(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof ahkw)) {
      return localTroopAIORobotLayout;
    }
    return ((ahkw)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie).a;
  }
  ...
  public String a(boolean paramBoolean)
  {
    ...
    if (localRobotPanelLayoutBase.getVisibility() != 0) {
      bezm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X8009FA1", str, "");
    }
  ...
  public void a()
  {
    ...
    {
      return;
      ViewGroup localViewGroup = (ViewGroup)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mAIORootView.findViewById(2131364407);
      if ((localViewGroup != null) && (this.jdField_a_of_type_AndroidContentContext != null))
      {
        Object localObject1 = (RobotPanelLayoutBase)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mAIORootView.findViewById(2131362480);
        c();
        if (localObject1 != null)
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof afii)) {
            ((afii)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie).a = ((TroopAIORobotLayout)localObject1);
          }
          for (;;)
          {
            ((RobotPanelLayoutBase)localObject1).setListener(this.jdField_a_of_type_Bffx);
            return;
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof ahkw)) {
              ((ahkw)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie).a = ((RobotChatPanelLayout)localObject1);
            }
          }
        }
        if (QLog.isColorLevel()) {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof afii)) {
          localObject1 = (TroopAIORobotLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558660, localViewGroup, false);
        }
        for (;;)
        {
          label194:
          ...
          localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mAIORootView.findViewById(2131362379);
          int i = 1;
          ...
          {
            ((RobotPanelLayoutBase)localObject1).setListener(this.jdField_a_of_type_Bffx);
            localObject1 = (aftj)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.getHelper(23);
            if (localObject1 == null) {
              break;
            }
            ...
            localObject1 = (RobotChatPanelLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558640, localViewGroup, false);
            break label194;
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof ahkw)) {
              ((ahkw)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie).a = ((RobotChatPanelLayout)localObject1);
            }
  ...
  public void a(int paramInt, RobotPanelLayoutBase paramRobotPanelLayoutBase, RelativeLayout paramRelativeLayout)
  {
    ...
    do
    {
      ...
      {
        return;
        paramRobotPanelLayoutBase = (TextView)paramRelativeLayout.findViewById(2131371466);
    ...
    ((RelativeLayout.LayoutParams)paramRobotPanelLayoutBase).addRule(2, 2131362480);
  }
  ...
  public void a(View paramView)
  {
    ...
    ((RelativeLayout.LayoutParams)paramView).addRule(2, 2131362480);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mAIORootView.findViewById(2131380315);
    ...
    if (paramBoolean)
    {
      ((RelativeLayout.LayoutParams)localObject).addRule(6, 2131362480);
      return;
    }
  ...
  public boolean a()
  {
    return ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof afii)) || ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof ahkw));
  }
  ...
  public boolean a(MotionEvent paramMotionEvent, boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
        paramMotionEvent = ((amaz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249)).a();
      }
    }
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ...
    else if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof ahkw))
    {
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      Object localObject;
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof afii)) {
        localObject = ((afii)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie).a;
      }
      while (localObject != null)
      {
        ...
        return;
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof ahkw)) {
          localObject = ((ahkw)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie).a;
        } else {
          localObject = null;
        }
      }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      return;
      if (((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof afii)) && (((afii)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie).f))
      {
        String str1 = ((afii)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie).b;
        String str2 = ((afii)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie).c;
        ((TroopAIORobotLayout)localRobotPanelLayoutBase).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, str1, str2, (afii)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie, new aftl(this, str1));
        return;
      }
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie instanceof ahkw))
      {
