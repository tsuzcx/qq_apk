...
public abstract class bcqq
  extends ajfb
{
  private axrr jdField_a_of_type_Axrr;
  private bcqp jdField_a_of_type_Bcqp;
  public bcqu a;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  private List<bcqt> jdField_a_of_type_JavaUtilList = new ArrayList();
  private final AtomicInteger jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger();
  
  protected bcqq(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Bcqu = new bcqr(this);
    this.jdField_a_of_type_Bcqp = ((bcqp)paramQQAppInterface.a(104));
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Bcqu);
  ...
  {
    int i = 1;
    String str = this.jdField_a_of_type_Bcqp.a();
    if (this.jdField_a_of_type_Bcqp.a() == null) {
      if (paramBoolean) {
        i = 2;
      }
    }
    do
    {
      do
      {
        ...
        {
          return i;
        } while (this.jdField_a_of_type_Bcqp.a(paramInt1, paramMessageMicro, paramInt2, paramObject));
        return 3;
        if (this.jdField_a_of_type_Bcqp.b() != null) {
          break;
        }
        if (paramBoolean) {
          return 4;
  ...
  private void a()
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          bcqt localbcqt = (bcqt)localIterator.next();
          a(localbcqt.a(), localbcqt.a(), true, localbcqt.b(), localbcqt.a());
        }
      }
  ...
  private void a(int paramInt1, MessageMicro<?> paramMessageMicro, boolean paramBoolean, int paramInt2, Object paramObject)
  {
    ...
    if (i == 1)
    {
      ...
      if (!paramBoolean) {
        synchronized (this.jdField_a_of_type_JavaLangObject)
        {
          this.jdField_a_of_type_JavaUtilList.add(new bcqt(paramInt1, paramMessageMicro, paramInt2, paramObject));
          return;
        }
      }
    }
    else
    {
      ...
      try
      {
        ...
        localObject2 = new Cryptor().encrypt(paramMessageMicro.toByteArray(), this.jdField_a_of_type_Bcqp.a());
        paramMessageMicro = new String();
        i = 0;
        while (i < "8.2.6".length())
        {
          ??? = paramMessageMicro;
          if ("8.2.6".charAt(i) != '.') {
            ??? = paramMessageMicro.concat(Character.toString("8.2.6".charAt(i)));
          }
          i += 1;
      ...
      ((im_msg_head.LoginSig)???).bytes_sig.set(ByteStringMicro.copyFrom(this.jdField_a_of_type_Bcqp.b()));
      ...
      try
      {
        ...
        ??? = this.jdField_a_of_type_Bcqp.a();
        ??? = (String)??? + "cgi-bin/httpconn";
        paramMessageMicro = paramMessageMicro.toByteArray();
        localObject2 = new axro();
        ((axro)localObject2).a(paramObject);
        ((axro)localObject2).jdField_a_of_type_ArrayOfByte = paramMessageMicro;
        ((axro)localObject2).jdField_a_of_type_Axrt = new bcqs(paramInt1, this, this.jdField_a_of_type_Bcqp.a(), paramInt2, paramObject);
        ((axro)localObject2).jdField_a_of_type_JavaLangString = ((String)???);
        ((axro)localObject2).jdField_a_of_type_Int = 1;
        ((axro)localObject2).jdField_a_of_type_JavaUtilHashMap.put("Accept-Encoding", "identity");
  ...
  private void b()
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          bcqt localbcqt = (bcqt)localIterator.next();
          a(localbcqt.a(), false, null, localbcqt.b(), localbcqt.a());
        }
      }
      this.jdField_a_of_type_JavaUtilList.clear();
    }
