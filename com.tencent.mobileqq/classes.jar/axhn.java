  ...
  implements blcc
{
  ...
  public axhn(MultiCardRootLayout paramMultiCardRootLayout) {}
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      {
        axho localaxho = (axho)MultiCardRootLayout.a(this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardRootLayout).get();
        if (localaxho != null) {
          MultiCardRootLayout.a(this.jdField_a_of_type_ComTencentMobileqqMulticardMultiCardRootLayout, localaxho.a(paramMotionEvent));
        }
      }
