...
public class mee
  extends mbn
{
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mef(this);
  Intent jdField_a_of_type_AndroidContentIntent;
  public VideoController a;
  lbu jdField_a_of_type_Lbu = lbu.a();
  ldz jdField_a_of_type_Ldz = new meg(this);
  lff jdField_a_of_type_Lff = new meh(this);
  msw jdField_a_of_type_Msw;
  ...
  public mee(VideoController paramVideoController, VideoAppInterface paramVideoAppInterface, Intent paramIntent)
  {
  ...
  void a(long paramLong, int paramInt)
  {
    ...
    do
    {
      ...
      localLong = Long.valueOf(mrb.a(this.jdField_c_of_type_JavaLangString));
    ...
    return;
    this.jdField_a_of_type_ComTencentAvVideoController.a(this.jdField_a_of_type_Lez.jdField_d_of_type_JavaLangString, 243);
  ...
  void a(long paramLong1, int paramInt1, long paramLong2, boolean paramBoolean1, int paramInt2, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      bcef.b(null, "CliOper", "", "", "0X8008B2C", "0X8008B2C", 0, 0, "", "", "", "");
      a();
      return;
  ...
  void a(long paramLong, Intent paramIntent)
  {
    ...
    if (mqu.b(this.jdField_b_of_type_Int)) {
      if (paramIntent.getIntExtra("MultiAVType", -1) == 2)
      {
        ...
        String str = lbu.a(this.jdField_c_of_type_Int, String.valueOf(this.jdField_a_of_type_Long), new int[0]);
        this.jdField_a_of_type_Lez = this.jdField_a_of_type_Lbu.c(str);
    ...
    {
      a(true);
      if ((this.jdField_a_of_type_Lez != null) || (this.jdField_b_of_type_Int == 1)) {
        break;
      }
      if (QLog.isColorLevel()) {
      ...
      this.jdField_a_of_type_Boolean = false;
      this.jdField_a_of_type_Lez = lbu.a().c(paramIntent);
      this.jdField_a_of_type_Lez.a(paramLong, "processIntent.1", 4);
      this.jdField_a_of_type_Lez.e("processIntent", true);
      this.jdField_a_of_type_Lez.ap = true;
      this.jdField_a_of_type_Lez.e = true;
      this.jdField_a_of_type_Lez.N = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(this.jdField_c_of_type_JavaLangString);
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(this.jdField_a_of_type_Ldz);
    }
    label409:
    ...
    {
      this.jdField_a_of_type_Lez.a(paramLong, "processIntent.2", 1);
      this.jdField_a_of_type_Lez.a(paramLong, false);
    }
    for (;;)
    {
      this.jdField_a_of_type_Lez.e = true;
      ...
      break;
      this.jdField_a_of_type_Lez.a(paramLong, "processIntent.3", 2);
      this.jdField_a_of_type_Lez.a(paramLong, true);
    }
  }
  
  void a(long paramLong, lez paramlez)
  {
    if (QLog.isColorLevel()) {
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoController.f)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("MultiIncomingCallUICtr", 2, "Session already destroyed, id:" + this.jdField_a_of_type_Lez.jdField_c_of_type_JavaLangString + ", status = " + this.jdField_a_of_type_Lez.jdField_g_of_type_Int);
      }
      if (this.jdField_a_of_type_Mkk != null) {
        this.jdField_a_of_type_Mkk.c(amtj.a(2131706127));
      }
    }
    label310:
    label374:
    while (!QLog.isColorLevel())
    {
      ...
      {
        return;
        if ((paramlez != null) && (locallez == paramlez))
        {
          if (lbu.a().a() >= 2)
          {
            if (paramlez.j()) {
              a(paramLong, false, paramlez);
            }
            for (;;)
            {
              a(paramlez);
              break;
              this.jdField_a_of_type_ComTencentAvVideoController.a(true, 201, new int[] { locallez.D });
        ...
        this.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, this.jdField_c_of_type_Int, this.jdField_a_of_type_Lez.jdField_g_of_type_Long, this.jdField_a_of_type_ArrayOfLong, false);
        bcef.b(null, "CliOper", "", "", "0X8008B2B", "0X8008B2B", 0, 0, "", "", "", "");
      }
      int i = 1;
      if (this.jdField_a_of_type_Boolean) {
        i = 0;
      ...
      if (this.jdField_b_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, 3, Long.valueOf(this.jdField_a_of_type_Lez.jdField_d_of_type_JavaLangString).longValue(), null, false);
        bcef.b(null, "CliOper", "", "", "0X8008B2B", "0X8008B2B", 0, 0, "", "", "", "");
      }
      for (;;)
      {
        b();
        break;
        int j = mum.d(this.jdField_c_of_type_Int);
        this.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, this.jdField_c_of_type_JavaLangString, i, j);
        if (this.jdField_a_of_type_Boolean) {
          bcef.b(null, "CliOper", "", "", "0X8008B24", "0X8008B24", 0, 0, "", "", "", "");
        } else {
          bcef.b(null, "CliOper", "", "", "0X8008B27", "0X8008B27", 0, 0, "", "", "", "");
        }
      }
    }
    label591:
  ...
  void a(long paramLong, boolean paramBoolean1, String paramString, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    {
      bcef.b(null, "CliOper", "", "", "0X8008B25", "0X8008B25", 0, 0, "", "", "", "");
      if (!paramBoolean1) {
        break label317;
      }
    ...
    for (;;)
    {
      try
      {
        ...
        if (!paramBoolean3)
        {
          ...
          return;
          bcef.b(null, "CliOper", "", "", "0X8008B28", "0X8008B28", 0, 0, "", "", "", "");
        }
      }
  ...
  void a(long paramLong, boolean paramBoolean, lez paramlez)
  {
    a(paramLong, paramBoolean, paramlez, -1);
  }
  
  void a(long paramLong, boolean paramBoolean, lez paramlez, int paramInt)
  {
    boolean bool3 = false;
    if (paramBoolean) {
    ...
    if (!paramBoolean) {
      if (paramlez != null)
      {
        String str = paramlez.jdField_d_of_type_JavaLangString;
        localObject = str;
        if (TextUtils.isEmpty(str)) {
          localObject = paramlez.s;
        }
        bool1 = paramlez.J;
        i = paramlez.F;
        l = paramlez.jdField_g_of_type_Long;
      }
    }
    for (;;)
    {
  ...
  void a(lez paramlez)
  {
    if ((this.jdField_a_of_type_ComTencentAvVideoController != null) && (paramlez != null))
    {
      ...
      localIntent.putExtra("groupId", paramlez.jdField_g_of_type_Long);
      localIntent.putExtra("peerUin", paramlez.jdField_d_of_type_JavaLangString);
  ...
  void f()
  {
    ...
    if (!mqu.b(this.jdField_b_of_type_Int))
    {
      ...
      if ((!this.jdField_a_of_type_Boolean) && (!this.jdField_b_of_type_Boolean)) {
        this.jdField_a_of_type_Msw.a(this.jdField_a_of_type_Lez.jdField_c_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, (Bitmap)localObject, null, 56, this.jdField_b_of_type_Int, 2);
      }
    }
    Bitmap localBitmap;
    String str;
    ...
    {
      return;
      this.jdField_a_of_type_Msw.a(this.jdField_a_of_type_Lez.jdField_c_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, (Bitmap)localObject, null, 55, this.jdField_b_of_type_Int, 1);
      return;
      ...
      int i = mqu.b(this.jdField_b_of_type_Int);
    ...
    } while (this.jdField_a_of_type_Lez == null);
    this.jdField_a_of_type_Msw.a(this.jdField_a_of_type_Lez.jdField_c_of_type_JavaLangString, str, localBitmap, (String)localObject, 57, this.jdField_b_of_type_Int, 3);
  }
}
