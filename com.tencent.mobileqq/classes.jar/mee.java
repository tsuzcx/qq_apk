  ...
  extends lsh
{
  ...
  public Runnable a;
  protected String a;
  private lqx jdField_a_of_type_Lqx;
  protected lrx a;
  protected lry a;
  protected lsb a;
  private maf jdField_a_of_type_Maf;
  meg jdField_a_of_type_Meg = null;
  ...
  public mee(Context paramContext, VideoAppInterface paramVideoAppInterface, String paramString)
  {
    this(paramContext, paramVideoAppInterface, paramString, 0L);
  }
  
  public mee(Context paramContext, VideoAppInterface paramVideoAppInterface, String paramString, long paramLong)
  {
    this(paramContext, paramVideoAppInterface, paramString, paramLong, true);
  }
  
  public mee(Context paramContext, VideoAppInterface paramVideoAppInterface, String paramString, long paramLong, boolean paramBoolean)
  {
    super(paramContext);
    ...
    this.jdField_a_of_type_Lqx = new lqx();
    this.jdField_r_of_type_Int = actn.a(6.0F, paramContext.getResources());
    this.s = actn.a(10.0F, paramContext.getResources());
    if (paramBoolean)
    {
      this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture = new lsf(this.jdField_a_of_type_AndroidContentContext, this, paramString, paramLong);
      this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(new mef(this, paramVideoAppInterface));
    }
  ...
  private void a(lqt paramlqt, int paramInt)
  {
    if (this.jdField_d_of_type_Boolean)
    {
      if (paramInt % 2 == 0) {
        paramlqt.b(-1.0F, 1.0F, 1.0F);
      }
    }
    else {
      return;
  ...
  private boolean a(int paramInt)
  {
    ...
    do
    {
      ...
      {
        return true;
      } while ((paramInt % 2 == 0) && (!this.jdField_o_of_type_Boolean));
      do
      {
        return false;
    ...
    for (;;)
    {
      ...
      if ((localObject != null) && (((AVActivity)localObject).a != null) && ((((AVActivity)localObject).a instanceof MultiVideoCtrlLayerUIBase)))
      {
        ...
        try
        {
          ...
          paramInt = bbev.b(BaseApplicationImpl.getApplication());
          if (paramInt == 1)
          {
            paramInt = 1;
            localStringBuilder.append(paramInt).append(';');
  ...
  Bitmap a(Bitmap paramBitmap)
  {
    ...
    //   11: aload_1
    //   12: aload_1
    //   13: invokevirtual 446	android/graphics/Bitmap:getWidth	()I
    //   16: iconst_4
    //   17: idiv
    //   18: aload_1
    //   19: invokevirtual 449	android/graphics/Bitmap:getHeight	()I
    //   22: iconst_4
    //   23: idiv
    //   24: iconst_1
    //   25: invokestatic 453	android/graphics/Bitmap:createScaledBitmap	(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;
    //   28: astore_2
    //   29: new 455	android/graphics/Canvas
    //   32: dup
    //   33: invokespecial 456	android/graphics/Canvas:<init>	()V
    //   36: astore_3
    //   37: aload_3
    //   38: aload_2
    //   39: invokevirtual 460	android/graphics/Canvas:setBitmap	(Landroid/graphics/Bitmap;)V
    //   42: aload_3
    //   43: ldc_w 462
    //   46: invokestatic 468	android/graphics/Color:parseColor	(Ljava/lang/String;)I
    //   49: getstatic 474	android/graphics/PorterDuff$Mode:LIGHTEN	Landroid/graphics/PorterDuff$Mode;
    //   52: invokevirtual 478	android/graphics/Canvas:drawColor	(ILandroid/graphics/PorterDuff$Mode;)V
    //   55: aload_2
    //   56: bipush 20
    //   58: invokestatic 483	bbju:a	(Landroid/graphics/Bitmap;I)V
    //   61: aload_2
    //   62: aload_1
    //   63: invokevirtual 446	android/graphics/Bitmap:getWidth	()I
    //   66: aload_1
    //   67: invokevirtual 449	android/graphics/Bitmap:getHeight	()I
    //   70: iconst_1
    //   71: invokestatic 453	android/graphics/Bitmap:createScaledBitmap	(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;
    //   74: astore_1
    //   75: aload_1
    //   76: astore_2
    //   77: aload_2
    ...
    //   81: astore_1
    //   82: aload_0
    //   83: getfield 141	mee:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   86: iconst_2
    //   87: new 126	java/lang/StringBuilder
    //   90: dup
    //   91: invokespecial 129	java/lang/StringBuilder:<init>	()V
    //   94: ldc_w 485
    //   97: invokevirtual 135	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   100: aload_2
    //   101: invokevirtual 398	java/lang/OutOfMemoryError:getStackTrace	()[Ljava/lang/StackTraceElement;
    //   104: invokevirtual 401	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   107: invokevirtual 139	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   110: invokestatic 270	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   113: aload_1
    //   114: areturn
    //   115: astore_2
    //   116: aload 4
    //   118: astore_1
    //   119: aload_0
    //   120: getfield 141	mee:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   123: iconst_2
    //   124: new 126	java/lang/StringBuilder
    //   127: dup
    ...
    //   137: aload_2
    //   138: invokevirtual 404	java/lang/Exception:getStackTrace	()[Ljava/lang/StackTraceElement;
    //   141: invokevirtual 401	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   144: invokevirtual 139	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   147: invokestatic 270	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   150: aload_1
    //   151: areturn
    //   152: astore_3
    //   153: aload_2
  ...
  public mei a(lqt paramlqt)
  {
    ...
    for (;;)
    {
      if (i1 != 0)
      {
        ...
        {
          paramlqt = this.jdField_a_of_type_Lrx.a(paramlqt);
          i1 = this.jdField_a_of_type_Lrx.e();
          i2 = this.jdField_a_of_type_Lrx.f();
          this.jdField_a_of_type_Mei.a(paramlqt[0], i1, i2);
          return this.jdField_a_of_type_Mei;
          i1 = 0;
          break;
          label139:
          i1 = 0;
        ...
        if (!c())
        {
          ...
          label449:
          a(paramlqt, i1);
          paramlqt.a(i7 * 90, 0.0F, 0.0F, 1.0F);
          if (i2 == 0) {
            break label553;
          }
          this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(paramlqt, 0, 0, i5, i6);
        }
        for (;;)
        {
          paramlqt.c();
          ...
          this.jdField_a_of_type_Mei.a(this.jdField_a_of_type_ComTencentTtpicOpenapiFilterRenderBuffer.getTexId(), i5, i6);
          return this.jdField_a_of_type_Mei;
          i1 = this.y;
          break;
          label548:
          ...
          break label449;
          label553:
          this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(paramlqt, 0, 0, i6, i5);
        }
      }
    }
    if ((this.e) && (this.jdField_c_of_type_Lrw != null))
    {
      paramlqt = this.jdField_c_of_type_Lrw.a(paramlqt);
      i1 = this.jdField_c_of_type_Lrw.c();
      i2 = this.jdField_c_of_type_Lrw.d();
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Mei.a(-1, 0, 0);
    return this.jdField_a_of_type_Mei;
  }
  ...
  {
    Pair localPair = a(paramInt1, paramInt2, super.b(), super.c(), this.y);
    ...
    if (QLog.isColorLevel()) {
      QLog.w(this.jdField_c_of_type_JavaLangString, 1, "setScale, scale[" + paramFloat + "->" + f1 + "], x[" + paramInt1 + "->" + localPair.first + "], y[" + paramInt2 + "->" + localPair.second + "], mRotation[" + this.y + "]");
    }
    super.b();
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    if ((paramInt2 <= 0) || (paramInt3 <= 0))
    {
      if (this.jdField_a_of_type_Maf != null)
      {
        ...
        this.jdField_a_of_type_Maf = null;
      }
      return;
    }
    if (this.jdField_a_of_type_Maf == null)
    {
      this.jdField_a_of_type_Maf = new maf();
      int i1 = b();
      int i2 = c();
      this.jdField_a_of_type_Maf.a(i1);
      this.jdField_a_of_type_Maf.b(i2);
    }
    this.jdField_a_of_type_Maf.a(paramInt1, paramInt2, paramInt3);
  }
  
  public void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    Object localObject = a(paramInt1, paramInt2, 0, 0, this.y);
    if (QLog.isColorLevel()) {
      QLog.w(this.jdField_c_of_type_JavaLangString, 1, "setTranslation, isEnd[" + paramBoolean + "], x[" + paramInt1 + "->" + ((Pair)localObject).first + "], y[" + paramInt2 + "->" + ((Pair)localObject).second + "], mRotation[" + this.y + "]");
    }
  ...
  {
    this.jdField_q_of_type_Boolean = paramBoolean.booleanValue();
  }
  ...
  protected void a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Maf != null)
      {
        this.jdField_a_of_type_Maf.a(paramInt1);
        this.jdField_a_of_type_Maf.b(paramInt2);
      }
      return;
    }
    catch (Exception localException)
  ...
  public void b(Bitmap paramBitmap)
  {
    ...
    this.jdField_a_of_type_Lrx = new lrx(paramBitmap);
  }
  ...
  protected void c(lqt paramlqt)
  {
    ...
    paramlqt.a(-i1 / 2, -i2 / 2);
    if (this.jdField_q_of_type_Boolean)
    {
      this.jdField_a_of_type_Lqx.a(-9013642);
      if (localRect.left > 0)
      {
        this.jdField_a_of_type_Lqx.a(localRect.left);
        paramlqt.a(localRect.left / 2, 0.0F, localRect.left / 2, i2, this.jdField_a_of_type_Lqx);
      }
      if (localRect.top > 0)
      {
        this.jdField_a_of_type_Lqx.a(localRect.top);
        paramlqt.a(0.0F, localRect.top / 2, i1, localRect.top / 2, this.jdField_a_of_type_Lqx);
      }
      if (localRect.right > 0)
      {
        this.jdField_a_of_type_Lqx.a(localRect.right);
        paramlqt.a(i1 - localRect.right / 2, 0.0F, i1 - localRect.right / 2, i2, this.jdField_a_of_type_Lqx);
      }
      if (localRect.bottom > 0)
      {
        this.jdField_a_of_type_Lqx.a(localRect.bottom);
        paramlqt.a(0.0F, i2 - localRect.bottom / 2, i1, i2 - localRect.bottom / 2, this.jdField_a_of_type_Lqx);
      }
    }
    paramlqt.a(i1 / 2, i2 / 2);
    if (this.jdField_q_of_type_Boolean) {
      if (((!e()) || (!this.f)) && (this.jdField_a_of_type_Lrw != null)) {
        this.jdField_a_of_type_Lrw.a(paramlqt, 0, 0, i3, i4);
      }
    }
    do
    {
      ...
      paramlqt.a(0, 0, i3, i4, this.jdField_g_of_type_Int);
      return;
      if (((!e()) || (!this.f)) && (this.jdField_a_of_type_Lrw != null))
      {
        this.jdField_a_of_type_Lrw.a(paramlqt, 0, 0, i1, i2);
        return;
      }
    } while (this.jdField_n_of_type_Boolean);
    paramlqt.a(0.0F, 0.0F, i1, i2, this.jdField_g_of_type_Int);
  }
  ...
  protected void d(lqt paramlqt)
  {
    ...
    float f3;
    float f4;
    if ((this.jdField_n_of_type_Boolean) && (!bool3))
    {
      i1 = 0;
      i6 = (i5 + i1 + 4) % 4;
    ...
    for (float f1 = f5;; f1 = f6)
    {
      ...
      String str;
      boolean bool4;
      if ((!this.jdField_n_of_type_Boolean) && (a(i6)))
      {
        bool1 = true;
        float f9 = f1;
        float f8 = f4;
        ...
        paramlqt.a(2);
        a(paramlqt, i1);
        paramlqt.a(i6 * 90, 0.0F, 0.0F, 1.0F);
        this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a((int)this.jdField_c_of_type_AndroidGraphicsRectF.width());
        this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.b((int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
        ...
        this.jdField_a_of_type_Lrx.a(paramlqt, i7, i8, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
        if ((this.jdField_b_of_type_Boolean) && (this.jdField_c_of_type_Boolean))
        {
          this.jdField_c_of_type_Boolean = false;
          QLog.d(this.jdField_c_of_type_JavaLangString, 1, "PC ScreenShare FirstFrameInfo:=<ImgWidth:=" + f10 + ",ImgHeight:=" + f11 + ",YUVImgAngle:=" + i5 + ",mAVSDKNotifyRotationType:=" + this.jdField_i_of_type_Int + ",phoneRotateAngle:=" + this.jdField_j_of_type_Int + ",renderRotation:=" + i6 + ">");
        }
        if (QLog.isColorLevel())
        {
          if (this.jdField_a_of_type_Meg == null) {
            this.jdField_a_of_type_Meg = new meg();
          }
          localObject = this.jdField_a_of_type_Meg;
      ...
      {
        ((meg)localObject).a(str, bool3, bool4, bool2, bool1, i7, i8, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_b_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_b_of_type_AndroidGraphicsRectF.width(), (int)f10, (int)f11, this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.c(), this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.d(), f12, f5, i1, i5, this.y, i6, this.jdField_a_of_type_AndroidWidgetImageView$ScaleType.ordinal());
        paramlqt.c();
        return;
        i1 = this.y;
        break;
        ...
        break label400;
        if ((this.jdField_a_of_type_Maf != null) && (this.jdField_a_of_type_Maf.f()))
        {
          paramlqt.a((4 - i5) * 90, 0.0F, 0.0F, 1.0F);
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_Maf.a(paramlqt, i7, i8, i2, i3);
            break;
            i4 = i2;
            i2 = i3;
            i3 = i4;
        ...
        this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(paramlqt, i7, i8, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
        break label601;
      }
      label1120:
      f4 = f5;
  ...
  protected void e(lqt paramlqt)
  {
    ...
    if (this.jdField_n_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Maf.a(paramlqt, (int)this.jdField_c_of_type_AndroidGraphicsRectF.left, (int)this.jdField_c_of_type_AndroidGraphicsRectF.top, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
    }
    for (;;)
    {
      paramlqt.c();
      lcl.c(this.jdField_c_of_type_JavaLangString, "renderDoubleScreenOfPC:|" + b() + "|" + h() + "|" + i2 + "|" + i3 + "|" + i4 + "|" + i5 + "|" + this.jdField_b_of_type_AndroidGraphicsRectF.toString() + "|" + this.jdField_c_of_type_AndroidGraphicsRectF.toString());
      return;
      i1 = this.y;
      break;
      label398:
      this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture.a(paramlqt, (int)this.jdField_c_of_type_AndroidGraphicsRectF.left, (int)this.jdField_c_of_type_AndroidGraphicsRectF.top, (int)this.jdField_c_of_type_AndroidGraphicsRectF.width(), (int)this.jdField_c_of_type_AndroidGraphicsRectF.height());
    }
  }
  ...
  protected void f(lqt paramlqt)
  {
    ...
    if ((this.e) && (this.jdField_c_of_type_Lrw != null))
    {
      ...
      i1 = super.b();
      i2 = super.c();
      i4 = this.jdField_c_of_type_Lrw.c();
      i3 = this.jdField_c_of_type_Lrw.d();
      if (i4 <= i1) {
        break label201;
      }
    }
    for (;;)
    {
      ...
      {
        paramlqt.a(2);
        this.jdField_c_of_type_Lrw.a(paramlqt, 0, 0, i1, i2);
        paramlqt.c();
  ...
  protected void finalize()
  {
    try
    {
      if (this.jdField_d_of_type_Lrw != null)
      {
        this.jdField_d_of_type_Lrw.a();
        this.jdField_d_of_type_Lrw = null;
      }
      ...
      if (this.jdField_c_of_type_Lrw != null)
      {
        this.jdField_c_of_type_Lrw.a();
        this.jdField_c_of_type_Lrw = null;
      }
      if (this.jdField_a_of_type_ComTencentAvOpenglTextureYUVTexture != null)
      {
  ...
  public void g(int paramInt)
  {
    if (this.jdField_p_of_type_Int != paramInt) {
      this.jdField_a_of_type_Lry = new lry(paramInt);
    }
  }
  
  protected void g(lqt paramlqt)
  {
    int i1;
    int i2;
    int i3;
    ...
    if (this.jdField_r_of_type_Boolean)
    {
      ...
      if (this.jdField_d_of_type_Lrw != null)
      {
        ...
        i4 = localRect.left;
        i4 = localRect.bottom;
        this.jdField_d_of_type_Lrw.a(paramlqt, 0, 0, i1 - i2 - i3, 36);
      }
      if (this.jdField_i_of_type_Boolean)
      {
        if (this.jdField_a_of_type_Lsb == null) {
          this.jdField_a_of_type_Lsb = new lsb();
        }
        this.jdField_a_of_type_Lsb.a();
        this.jdField_a_of_type_Lsb.a(this.jdField_a_of_type_JavaLangString);
        this.jdField_a_of_type_Lsb.a(this.jdField_h_of_type_Float);
        this.jdField_a_of_type_Lsb.c(this.jdField_n_of_type_Int);
        this.jdField_a_of_type_Lsb.d(this.jdField_o_of_type_Int);
        this.jdField_a_of_type_Lsb.e(super.b() - this.s);
        this.jdField_a_of_type_Lsb.e();
        this.jdField_i_of_type_Boolean = false;
      }
      if ((this.jdField_a_of_type_Lsb != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
      {
        i6 = super.b();
        i5 = super.c();
        i3 = this.jdField_a_of_type_Lsb.c();
        i4 = this.jdField_a_of_type_Lsb.d();
        if (!this.jdField_g_of_type_Boolean) {
          break label312;
        }
        i1 = this.s;
        i2 = i5 - this.jdField_a_of_type_Lsb.j() - this.jdField_r_of_type_Int;
      }
    }
    for (;;)
    {
      ...
      i5 = (i4 - i5) / 2;
      paramlqt.a(i6, i5);
      this.jdField_a_of_type_Lsb.a(paramlqt, i1, i2, i3, i4);
      paramlqt.c();
      return;
      label312:
      ...
      {
        i1 = actn.a(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        i2 = this.w;
      }
    }
  }
  ...
  {
    if ((paramInt == this.jdField_q_of_type_Int) && (this.jdField_b_of_type_Lrx != null)) {
      return;
    }
    if (this.jdField_b_of_type_Lrx != null)
    {
      this.jdField_b_of_type_Lrx.a();
      this.jdField_b_of_type_Lrx = null;
    }
    this.jdField_b_of_type_Lrx = new lrx(muf.a(this.jdField_a_of_type_AndroidContentContext, paramInt));
    this.jdField_b_of_type_Lrx.a(false);
  }
  
  protected void h(lqt paramlqt)
  {
    if ((this.jdField_l_of_type_Boolean) && (this.jdField_a_of_type_Lry != null)) {
      this.jdField_a_of_type_Lry.a(paramlqt, 0, 0, b(), c());
    }
  }
  ...
  protected void i(lqt paramlqt)
  {
    ...
    int i6;
    int i1;
    if ((this.jdField_r_of_type_Boolean) && (this.jdField_m_of_type_Boolean) && (this.jdField_b_of_type_Lrx != null))
    {
      i3 = super.b();
      i4 = super.c();
      i5 = this.jdField_b_of_type_Lrx.c();
      i6 = this.jdField_b_of_type_Lrx.d();
      if (!this.jdField_g_of_type_Boolean) {
        break label159;
      }
      i1 = i3 - i5 - this.jdField_r_of_type_Int;
    }
    for (int i2 = i4 - this.jdField_a_of_type_Lsb.j() - this.jdField_r_of_type_Int + this.jdField_a_of_type_Lsb.k() - i6 + (i6 - this.jdField_a_of_type_Lsb.k()) / 2;; i2 = this.w + this.jdField_a_of_type_Lsb.k() - i6 + Math.abs((i6 - this.jdField_a_of_type_Lsb.k()) / 2))
    {
      paramlqt.a(3);
      paramlqt.a((i5 - i3) / 2, (i6 - i4) / 2);
      this.jdField_b_of_type_Lrx.a(paramlqt, i1, i2, i5, i6);
      paramlqt.c();
      return;
      label159:
      i1 = actn.a(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources()) + this.jdField_a_of_type_Lsb.c() + this.s;
    }
  }
  ...
  {
    if (this.jdField_r_of_type_Boolean != paramBoolean)
    {
      if (QLog.isColorLevel()) {
        QLog.w(this.jdField_c_of_type_JavaLangString, 1, "showText, show[" + this.jdField_r_of_type_Boolean + "->" + paramBoolean + "]");
      }
  ...
  public void k(boolean paramBoolean)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d(this.jdField_c_of_type_JavaLangString, 2, "enableLoading loading: " + paramBoolean + ", mLoading: " + this.e);
      }
      this.e = paramBoolean;
      if (!paramBoolean) {
        break label108;
      ...
      if (this.jdField_c_of_type_Lrw == null) {
        this.jdField_c_of_type_Lrw = new lsa(this.jdField_a_of_type_AndroidContentContext, 2130841789);
      }
      localGLRootView = a();
      if (localGLRootView != null) {
  ...
  public void n(boolean paramBoolean)
  {
    ...
    if (paramBoolean) {
      this.x = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131297742);
    }
  }
