public final class ik
{
  ...
  private il jdField_b_of_type_Il;
  private int[] jdField_b_of_type_ArrayOfInt;
  
  static
  {
    jdField_a_of_type_Ik = new ik(285, 256);
  }
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_Il = new il(this, new int[] { 0 });
    this.jdField_b_of_type_Il = new il(this, new int[] { 1 });
  ...
  {
    b();
    return this.jdField_a_of_type_Il;
  }
