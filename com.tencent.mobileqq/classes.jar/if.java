...
public class if
{
  ...
  private static WifiConfiguration a(ih paramih)
  {
    ...
    localWifiConfiguration.SSID = a(paramih.b(), new int[0]);
    localWifiConfiguration.hiddenSSID = paramih.a();
  ...
  private static boolean a(WifiManager paramWifiManager, ih paramih)
  {
    WifiConfiguration localWifiConfiguration = a(paramih);
    localWifiConfiguration.wepKeys[0] = a(paramih.d(), new int[] { 10, 26, 58 });
  ...
  private static boolean b(WifiManager paramWifiManager, ih paramih)
  {
    WifiConfiguration localWifiConfiguration = a(paramih);
    localWifiConfiguration.preSharedKey = a(paramih.d(), new int[] { 64 });
  ...
  private static boolean c(WifiManager paramWifiManager, ih paramih)
  {
    paramih = a(paramih);
    paramih.allowedKeyManagement.set(0);
    return a(paramWifiManager, paramih);
  }
  ...
  public boolean a(ih paramih)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        i += 1;
        continue;
        String str = paramih.c();
        if ((TextUtils.isEmpty(str)) || (str.equals("nopass"))) {
          return c(this.jdField_a_of_type_AndroidNetWifiWifiManager, paramih);
        }
        if (TextUtils.isEmpty(paramih.d())) {
          break label84;
        }
        if ("WEP".equals(str)) {
          return a(this.jdField_a_of_type_AndroidNetWifiWifiManager, paramih);
        }
        if (!"WPA".equals(str)) {
          break label84;
        }
        return b(this.jdField_a_of_type_AndroidNetWifiWifiManager, paramih);
      }
