...
public final class bmgr
{
  ...
  public static void a(Activity paramActivity)
  {
    ...
    if (DeviceProfileManager.a(paramActivity, arrayOfInteger, new antj()) >= arrayOfInteger.length)
    {
  ...
  public static void a(Context paramContext)
  {
    ...
    localBusinessTask.a(new bmgs(paramContext), true);
    localBusinessTask.a();
  }
