...
public class aoob
  extends acmh
{
  public Comparator b = new aooc(this);
  
  public aoob(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private ArrayList<MessageRecord> a(ArrayList<msg_comm.Msg> paramArrayList, String paramString)
  {
    ...
    if (QLog.isColorLevel()) {
      axql.a("HCTopicMsgProc", new Object[] { "<---groupMsgRecordHandle_PB", paramString, Integer.valueOf(paramArrayList.size()) });
    }
    ArrayList localArrayList1 = new ArrayList();
    ArrayList localArrayList2 = new ArrayList();
    bcsd localbcsd = new bcsd();
    localbcsd.jdField_e_of_type_Long = Long.valueOf(paramString).longValue();
    localbcsd.jdField_e_of_type_Int = 1026;
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if (paramString != null)
      {
        ...
        localbcsd.f = ((msg_comm.GroupInfo)((msg_comm.MsgHead)localObject).group_info.get()).group_type.get();
        try
        {
          a(paramString, localArrayList1, localbcsd, false, null);
          if (localArrayList1.size() != 0)
          {
            anyv.a(localArrayList1);
            if (localArrayList1.size() > 0)
            {
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    //   60: aload 9
    //   62: aload_2
    //   63: invokevirtual 225	aoob:a	(Lmsf/msgcomm/msg_comm$Msg;Ljava/lang/String;)V
    //   66: return
    //   67: astore 10
    //   69: aconst_null
    //   70: astore 9
    ...
    //   92: iload_1
    //   93: invokevirtual 240	aoob:a	(Ljava/lang/String;I)V
    //   96: return
    //   97: aconst_null
    //   98: astore 12
    //   100: lconst_0
    ...
    //   119: aload 10
    //   121: invokespecial 242	aoob:a	(Ljava/util/List;Ljava/util/List;)V
    //   124: aload_2
    //   125: iconst_1
    //   126: aaload
    ...
    //   214: aastore
    //   215: invokestatic 51	axql:a	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   218: iload 8
    //   220: ifeq +55 -> 275
    //   223: iload_1
    //   224: sipush 1002
    ...
    //   239: aload 11
    //   241: lload 4
    //   243: invokevirtual 253	aoob:a	(ZLjava/lang/String;Ljava/util/ArrayList;Ljava/lang/String;J)V
    //   246: return
    //   247: astore 9
    //   249: aconst_null
    //   250: astore_2
    ...
    //   283: iload_1
    //   284: invokevirtual 240	aoob:a	(Ljava/lang/String;I)V
    //   287: return
    //   288: astore 9
    //   290: aconst_null
    //   291: astore_2
  ...
  protected void a(List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        avlj localavlj = this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.app.getHotChatMng(true).a(true);
        paramList = paramList.iterator();
        while (paramList.hasNext()) {
          localavlj.a((MessageRecord)paramList.next());
        }
        return;
      }
  ...
  {
    axql.a("HCTopicMsgProc", "processPush", new Object[] { paramString, paramMsg });
    if ((paramMsg == null) || (!paramMsg.msg_head.has())) {
      if (QLog.isColorLevel()) {
        axql.a("HCTopicMsgProc", new Object[] { "processPush invalidate params" });
      }
    }
    Object localObject1;
    Object localObject2;
    ...
    for (;;)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          axql.a("HCTopicMsgProc", new Object[] { "<---handleMsgPush_PB_Group: no groupInfo." });
        }
      }
      else
      {
        ...
        Object localObject3 = new bcsd();
        ((bcsd)localObject3).jdField_e_of_type_Long = l3;
        ((bcsd)localObject3).jdField_e_of_type_Int = 1026;
        ((bcsd)localObject3).f = j;
        try
        {
          a(paramMsg, (ArrayList)localObject2, (bcsd)localObject3, false, null);
          a((List)localObject2);
        ...
        catch (Exception paramMsg)
        {
          ...
          bool = anyv.a((ArrayList)localObject2);
          i = acnh.a((List)localObject2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        axnp.a((bcrm)localObject1, l1, paramString, 1);
  ...
  protected void a(boolean paramBoolean, String paramString1, ArrayList<msg_comm.Msg> paramArrayList, String paramString2, long paramLong)
  {
    if (paramArrayList != null)
    {
      ...
      axql.a("HCTopicMsgProc", "processGetMsgs", new Object[] { Boolean.valueOf(paramBoolean), paramString1, paramString2 });
      if (paramArrayList == null) {
        break label599;
      }
    }
    ...
    for (paramArrayList = a(paramArrayList, paramString1);; paramArrayList = null)
    {
      ...
      bcrm localbcrm = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a();
      int i;
      if ((paramArrayList != null) && (paramArrayList.size() > 0))
      {
        ...
        if (paramString2.size() > 0)
        {
          ...
          paramArrayList = (acmd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getBaseMessageManager(1026);
          ...
          paramBoolean = anyv.a(paramString2);
          j = acnh.a(paramString2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          ...
          if ((paramBoolean) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.isBackgroundPause))
          {
            ...
            if (l2 != -9223372036854775808L) {
              axnp.a(localbcrm, l2, paramString1, 3);
            }
      ...
      for (;;)
      {
        if ((i != 0) && (localbcrm.a(paramString1) == 1))
        {
          ...
          ((acmd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getBaseMessageManager(1026)).b(paramString1, 1026, paramLong);
        }
  ...
  protected boolean a(MessageRecord paramMessageRecord)
  {
    ...
    if (localMessageRecord != null)
    {
      ...
      axnp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMsgCache().a(), paramMessageRecord.shmsgseq, paramMessageRecord.frienduin, 2);
      bool = true;
    }
    return bool;
  }
