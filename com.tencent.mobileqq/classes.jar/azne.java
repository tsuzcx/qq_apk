...
public class azne
  implements Manager
{
  public final SparseArray<azmv> a;
  public QQAppInterface a;
  protected final List<String> a;
  protected final Map<String, azmu> a;
  protected boolean a;
  public final SparseArray<TroopAioKeywordTipInfo> b;
  public final List<String> b;
  protected boolean b;
  
  public azne(QQAppInterface paramQQAppInterface)
  {
  ...
  private List<Integer> a(MessageRecord arg1)
  {
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject1)) {
      ...
      {
        localObject1 = (azmu)this.jdField_a_of_type_JavaUtilMap.get(localObject1);
        if (localObject1 != null)
        {
          localObject1 = ((azmu)localObject1).jdField_a_of_type_JavaUtilList;
          return localObject1;
        }
      }
    }
  ...
  private void a(MessageRecord paramMessageRecord, TroopAioKeywordTipInfo paramTroopAioKeywordTipInfo, aznh paramaznh)
  {
    if (paramaznh != null) {
      ThreadManager.getUIHandler().post(new TroopAioKeywordTipManager.5(this, paramaznh, paramMessageRecord, paramTroopAioKeywordTipInfo));
    }
  }
  
  private void a(Integer paramInteger, MessageRecord paramMessageRecord, aznh paramaznh)
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(paramInteger);
    ((akhp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(localArrayList, new azng(this, paramMessageRecord, paramaznh));
  }
  ...
  private boolean a(Integer paramInteger, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    {
      localObject1 = (azmv)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInteger.intValue());
      if (localObject1 == null) {
        return false;
      }
    }
    synchronized (this.jdField_b_of_type_JavaUtilList)
    {
      ...
      {
        this.jdField_b_of_type_JavaUtilList.addAll(azmt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      ...
      if ((((azmv)localObject1).b > NetConnInfoCenter.getServerTime()) || (((azmv)localObject1).c < NetConnInfoCenter.getServerTime()))
      {
        if (QLog.isColorLevel()) {
          QLog.i("TroopAioKeywordTipManager", 2, "isSupportedRuleId, not support timelimit, currentTime=" + NetConnInfoCenter.getServerTime() + ",ruleInfo.startTime =" + ((azmv)localObject1).b + ",ruleInfo.endTime=" + ((azmv)localObject1).c);
        }
        return false;
      }
    }
    if ((((azmv)localObject1).d & paramInt) == 0)
    {
      if (QLog.isColorLevel()) {
        QLog.i("TroopAioKeywordTipManager", 2, "isSupportedRuleId, not support positionFlag, ruleInfo.positionFlag=" + ((azmv)localObject1).d + ", curInvokeType=" + paramInt);
      }
      return false;
    }
    if ((((azmv)localObject1).jdField_a_of_type_JavaUtilList != null) && (((azmv)localObject1).jdField_a_of_type_JavaUtilList.size() > 0))
    {
      if (QLog.isColorLevel()) {
      ...
      if (!((azmv)localObject1).jdField_a_of_type_JavaUtilList.contains(Integer.valueOf((int)paramInteger.dwGroupClassExt)))
      {
        if (QLog.isColorLevel())
        {
          paramMessageRecord = new StringBuilder();
          paramMessageRecord.append("[");
          localObject1 = ((azmv)localObject1).jdField_a_of_type_JavaUtilList.iterator();
  ...
  public void a()
  {
    try
    {
      ...
      {
        oidb_0x496.AioKeyword localAioKeyword = azmt.a();
        a(azmt.a(localAioKeyword), azmt.b(localAioKeyword));
      }
      return;
    }
    finally
  ...
  public void a(List<azmu> arg1, List<azmv> paramList1)
  {
    if (??? != null)
    {
      Object localObject2;
      try
      {
        synchronized (this.jdField_a_of_type_JavaUtilList)
        {
          ...
          {
            azmu localazmu = (azmu)((Iterator)localObject2).next();
            this.jdField_a_of_type_JavaUtilList.add(localazmu.jdField_a_of_type_JavaLangString.toLowerCase());
          }
        }
      }
      finally {}
      synchronized (this.jdField_a_of_type_JavaUtilMap)
      {
        ...
        if (???.hasNext())
        {
          localObject2 = (azmu)???.next();
          this.jdField_a_of_type_JavaUtilMap.put(((azmu)localObject2).jdField_a_of_type_JavaLangString.toLowerCase(), localObject2);
        }
      }
    }
    if (paramList1 != null) {
      synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
      {
        ...
        {
          ??? = (azmv)paramList1.next();
          this.jdField_a_of_type_AndroidUtilSparseArray.put(((azmv)???).jdField_a_of_type_Int, ???);
        }
      }
    }
  ...
  public void a(List<MessageRecord> paramList, List<String> paramList1, int paramInt, aznh paramaznh)
  {
    ThreadManager.post(new TroopAioKeywordTipManager.3(this, paramList, paramList1, paramInt, paramaznh), 8, null, true);
  }
