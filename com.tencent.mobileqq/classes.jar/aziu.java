...
public class aziu
{
  private volatile long jdField_a_of_type_Long = azjb.c;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManagerV2.getSubThreadLooper());
  private azie jdField_a_of_type_Azie = new aziw(this);
  private azik jdField_a_of_type_Azik = new azix(this);
  private azit jdField_a_of_type_Azit = new azit(40001);
  private aziy jdField_a_of_type_Aziy;
  private azja jdField_a_of_type_Azja = new azja(null);
  private azje jdField_a_of_type_Azje;
  private azjm jdField_a_of_type_Azjm;
  ...
  public aziu(QQAppInterface paramQQAppInterface)
  {
    ...
    e();
    this.jdField_a_of_type_Azje = new azje(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_Azjm = new azjm(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new aziv(this));
    ...
    BaseApplicationImpl.getContext().registerReceiver(this.jdField_a_of_type_Azja, paramQQAppInterface);
  }
  ...
  private void a(long paramLong, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.e("AutoStatusManager", 2, "[status][autoMgr] updateAutoStatus status changed cur: " + azjb.a(paramInt2) + " last: " + azjb.a(paramInt1));
      }
      if (this.jdField_a_of_type_Aziy != null) {
        this.jdField_a_of_type_Aziy.a(paramInt2);
      }
      if (paramInt2 == 40001) {
        if (paramLong > 40001L) {
          if (a(true)) {
            this.jdField_a_of_type_Azit.a(paramInt2);
          }
        }
      }
    }
    do
    {
      ...
      do
      {
        ...
        return;
        this.jdField_a_of_type_Azit.a(paramInt2);
        localazku = azjb.a(paramInt2);
        if (QLog.isColorLevel()) {
          QLog.e("AutoStatusManager", 2, "[status][autoMgr] updateAutoStatus getAutoStringById : " + localazku);
        }
      } while (localazku == null);
      a(localazku);
      return;
      if (paramLong != 40001L) {
        break;
    ...
    return;
    azlb.a.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, azlb.a.a(), paramInt2);
  }
  
  private void a(azku paramazku)
  {
    int i = (int)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getExtOnlineStatus();
    if (i == paramazku.jdField_a_of_type_Long)
    {
      if (QLog.isColorLevel()) {
        QLog.d("AutoStatusManager", 2, "[status][autoMgr] showTips fail status : " + paramazku + " real: " + i);
      }
      a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      c();
      return;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("AutoStatusManager", 2, "[status][autoMgr] showTips success status : " + paramazku + " real: " + i);
    }
    if (i > 40001)
    {
      boolean bool = a(i);
      if (QLog.isColorLevel()) {
        QLog.d("AutoStatusManager", 2, "[status][autoMgr] showTips real statusChanged: " + bool + " real: " + azjb.a(i));
      }
      if (bool) {
        a(false);
      }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("AutoStatusManager", 2, "[status][autoMgr] submitStatus " + paramString + " status: " + azjb.a((int)paramLong) + " auto: " + paramBoolean);
    }
    a(paramQQAppInterface);
    c();
    if (paramLong != 40001L) {
      azlb.a.a(paramQQAppInterface, azlb.a.a(), (int)paramLong);
    }
    paramQQAppInterface.a(AppRuntime.Status.online, paramLong, paramBoolean);
    if (azjb.a(paramLong)) {
      ((azic)BaseApplicationImpl.getApplication().getRuntime().getManager(369)).a().jdField_a_of_type_Azjm.a(paramLong);
    }
  }
  ...
  {
    if (paramInt == this.jdField_a_of_type_Azje.a()) {}
    for (;;)
    {
      return false;
      if (paramInt != this.jdField_a_of_type_Azjm.d())
      {
        if (azjb.b) {}
        for (int i = this.jdField_a_of_type_Azjm.b(); paramInt != i; i = this.jdField_a_of_type_Azjm.c()) {
          return true;
        }
      }
    }
  ...
  private void b(azku paramazku)
  {
    if (QLog.isColorLevel()) {
      QLog.d("AutoStatusManager", 2, "[status][autoMgr][banner] showBanner status : " + paramazku);
    }
  ...
  private void c(azku paramazku)
  {
    if (QLog.isColorLevel()) {
      QLog.d("AutoStatusManager", 2, "[status][autoMgr] showPush status : " + paramazku + " at " + new SimpleDateFormat("HH:mm:ss", Locale.getDefault()).format(new Date(System.currentTimeMillis())));
    }
    Intent localIntent = a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramazku.jdField_a_of_type_Long);
    ...
    localBuilder.setContentText(String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131690209), new Object[] { paramazku.jdField_a_of_type_JavaLangString })).setWhen(System.currentTimeMillis()).setSmallIcon(2130841403).setAutoCancel(true).setContentIntent(PendingIntent.getActivity(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 0, localIntent, 134217728));
    paramazku = localBuilder.build();
    QQNotificationManager.addChannelIfNeed(paramazku, "CHANNEL_ID_OTHER");
    QQNotificationManager.getInstance().notify("AutoStatusManager", 3000530, paramazku);
    if (ayus.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
    {
      azir.a("0X800AFA2", 1);
      return;
    }
  ...
  private void d()
  {
    ...
    int n = a();
    if (QLog.isColorLevel()) {
      QLog.w("AutoStatusManager", 2, "[status][autoMgr] updateAutoStatus last status: " + azjb.a(n) + " real status: " + azjb.a((int)l));
    }
    if (l < 40000L)
    {
      if (QLog.isColorLevel()) {
        QLog.w("AutoStatusManager", 2, "[status][autoMgr] updateAutoStatus [user submit no auto status] stopDetector. last status: " + azjb.a(n) + " real status: " + azjb.a((int)l));
      }
      b("updateStatus");
      return;
    }
    int k = this.jdField_a_of_type_Azje.a();
    if (QLog.isColorLevel()) {
      QLog.d("AutoStatusManager", 2, "[status][autoMgr] updateAutoStatus actionStatus: " + azjb.a(k) + " enable: " + azjb.a.contains(Integer.valueOf(k)));
    }
    int i;
    if ((k > 40001) && (azjb.a.contains(Integer.valueOf(k))))
    {
      i = k;
      if (QLog.isColorLevel()) {
        QLog.d("AutoStatusManager", 2, "[status][autoMgr] updateAutoStatus result: " + azjb.a(i) + " enable: " + azjb.a.contains(Integer.valueOf(i)));
      }
      if ((i <= 40001) || (azjb.a.contains(Integer.valueOf(i)))) {
        break label676;
      }
      j = m;
      if (QLog.isColorLevel()) {
        QLog.d("AutoStatusManager", 2, "[status][autoMgr] updateAutoStatus detected disabled cur status: " + azjb.a(i));
      }
    }
    label676:
    for (int j = m;; j = i)
    {
      ...
      if (azjb.b)
      {
        j = this.jdField_a_of_type_Azjm.b();
        if (QLog.isColorLevel()) {
          QLog.d("AutoStatusManager", 2, "[status][autoMgr] updateAutoStatus getNewMovementStatus: " + azjb.a(j) + " enable: " + azjb.a.contains(Integer.valueOf(j)));
        }
        if (j > 40001)
        {
          i = j;
          if (azjb.a.contains(Integer.valueOf(j))) {
            break;
          }
        }
        j = this.jdField_a_of_type_Azjm.d();
        i = j;
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.d("AutoStatusManager", 2, "[status][autoMgr] updateAutoStatus categoryStatus: " + azjb.a(j) + " enable: " + azjb.a.contains(Integer.valueOf(j)));
        i = j;
        break;
      }
      j = this.jdField_a_of_type_Azjm.c();
      if (QLog.isColorLevel()) {
        QLog.d("AutoStatusManager", 2, "[status][autoMgr] updateAutoStatus movementStatus: " + azjb.a(j) + " enable: " + azjb.a.contains(Integer.valueOf(j)));
      }
      if (j > 40001)
      {
        i = j;
  ...
  private void e()
  {
    ...
    do
    {
      ...
      localObject = ((arfp)localObject).a.a(false);
  ...
  private void f()
  {
    Object localObject = ((azih)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(370)).a();
    if (localObject != null) {
      if (QLog.isColorLevel()) {
        QLog.d("AutoStatusManager", 2, "[status][autoMgr] loadEnabledStatus smartSelectedList size: " + ((List)localObject).size());
      }
    }
    for (azjb.a = (List)localObject;; azjb.a = new ArrayList())
    {
      localObject = azjb.a.iterator();
      while (((Iterator)localObject).hasNext())
      {
        Integer localInteger = (Integer)((Iterator)localObject).next();
        if (QLog.isColorLevel()) {
          QLog.d("AutoStatusManager", 2, "[status][autoMgr] loadEnabledStatus status: " + azjb.a(localInteger.intValue()));
        }
      }
      if (QLog.isColorLevel()) {
  ...
  public String a(Integer paramInteger)
  {
    ...
    paramInteger = azjb.a(localInteger.intValue());
    if (paramInteger != null) {
      return paramInteger.jdField_a_of_type_JavaLangString;
    }
    paramInteger = azhq.a().a(AppRuntime.Status.online, 40001L);
  ...
  public void a()
  {
    try
    {
      ...
      BaseApplicationImpl.getContext().unregisterReceiver(this.jdField_a_of_type_Azja);
      return;
    }
    finally {}
  }
  
  void a(aziy paramaziy)
  {
    if (QLog.isColorLevel()) {
      QLog.d("AutoStatusManager", 2, "[status][autoMgr] startDetector listener: " + paramaziy);
    }
    this.jdField_a_of_type_Aziy = paramaziy;
  }
  ...
  public void a(@NonNull String paramString, boolean paramBoolean)
  {
    for (;;)
    {
      try
      {
        if (!azib.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getOnlineStatus(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getExtOnlineStatus()))
        {
          if (QLog.isColorLevel()) {
        ...
        if (paramBoolean) {
          this.jdField_a_of_type_Azit.a((int)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getExtOnlineStatus());
        }
    ...
    if (this.jdField_a_of_type_Azit.a != l2) {
      this.jdField_a_of_type_Azit.a("autoMgr");
    }
    this.jdField_a_of_type_Azjm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp());
    long l1 = 30000L;
    if ((l2 != 41031L) && (l2 != 41014L)) {}
    for (;;)
    {
      if (l2 == 41042L) {
        l1 = this.jdField_a_of_type_Azjm.a();
      }
      String str = bhjc.a(BaseApplication.getContext(), "KEY_LAST_AUTO_RESET_TIME_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          this.jdField_a_of_type_Azjm.a(paramBoolean);
          this.jdField_a_of_type_AndroidOsHandler.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
          bhjc.a(BaseApplication.getContext(), "KEY_LAST_AUTO_RESET_TIME_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), String.valueOf(this.jdField_b_of_type_Long));
          continue;
        }
        a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
  ...
  public void d(String paramString)
  {
    ...
    paramString = (azic)BaseApplicationImpl.getApplication().getRuntime().getManager(369);
    if (paramString != null) {
