...
public class swt
{
  private static int a(List<BaseData> paramList)
  {
    ...
    while (i > 0)
    {
      ...
      if ((svv.a(localBaseData)) && (localBaseData.r != 0))
      {
    ...
    if (paramList2 != null)
    {
      ...
      while (paramList2.hasNext())
      {
        ...
        if ((localObject instanceof ProteusItemData)) {
          swb.a(paramArticleInfo, (ProteusItemData)localObject, 5, paramSparseArray);
        }
  ...
  public static void c(List<BaseData> paramList, List<CommentInfo> paramList1)
  {
    ...
    for (;;)
    {
      j += 1;
      break;
      QLog.d(swt.class.getSimpleName(), 2, "update comment data! size : " + i);
      return;
    }
  }
