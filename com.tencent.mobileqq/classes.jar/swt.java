...
public class swt
  extends MqqHandler
{
  public swt(LoginInfoActivity paramLoginInfoActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      paramMessage = this.a.getString(2131436613);
      ...
      for (;;)
      {
        ...
        return;
        paramMessage = paramMessage + this.a.getString(2131436622);
        LoginInfoActivity.a(this.a).setText(paramMessage);
        continue;
        paramMessage = paramMessage + this.a.getString(2131436623);
        LoginInfoActivity.a(this.a).setText(paramMessage);
        continue;
        paramMessage = paramMessage + this.a.getString(2131436624);
        LoginInfoActivity.a(this.a).setText(paramMessage);
        continue;
        LoginInfoActivity.a(this.a).setText(paramMessage);
      }
