  ...
  implements Animator.AnimatorListener
{
  ...
  public adac(Context paramContext)
  {
    super(paramContext);
    this.jdField_a_of_type_Adbc = new adbc(paramContext);
    this.jdField_a_of_type_Adbc.a(new adad(this));
  }
  ...
  public void a(adar paramadar)
  {
    ...
    this.jdField_a_of_type_JavaLangString = asyh.c();
    ...
    if ((bool) && (this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable == null))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable.setImageAssetDelegate(new adae(this));
    }
    try
    {
      ...
      LottieComposition.Factory.fromInputStream(a(), localFileInputStream, new adaf(this));
      super.a(paramadar);
      paramadar.a(bool);
      return;
    }
