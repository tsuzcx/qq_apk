...
public class bebj
  extends bebo
{
  private atib jdField_a_of_type_Atib = new bebk(this);
  FileManagerEntity jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity;
  
  public bebj(TeamWorkFileImportInfo paramTeamWorkFileImportInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo != null) && (paramQQAppInterface != null))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity = auea.a(paramQQAppInterface, (MessageForFile)localMessageRecord);
      ...
      paramQQAppInterface.getFileTransferHandler().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileIdCrc, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.bSend, false, this.jdField_a_of_type_Atib);
    }
    label176:
    label197:
    for (int i = 1;; i = 0)
    {
      if (i == 0)
      {
        ...
        this.jdField_a_of_type_Bebl.i(this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo);
      }
