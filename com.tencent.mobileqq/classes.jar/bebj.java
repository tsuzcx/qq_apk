...
public class bebj
{
  ...
  public bebj(Activity paramActivity, JSONObject paramJSONObject, awqt paramawqt)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Bebm = new bebm();
    }
    catch (IllegalArgumentException paramActivity)
    {
      for (;;)
      {
        ...
        {
          xqq.a("DIYProfileTemplate.ProfileTemplateBase default line color is illegal! " + paramJSONObject.optString("c"), new Object[0]);
          this.jdField_a_of_type_Int = -1;
        }
        paramActivity = paramActivity;
        xqq.a("DIYProfileTemplate.ProfileTemplateBase default main color is illegal! " + paramJSONObject.optString("c"), new Object[0]);
  ...
  private JSONObject a(Map<String, JSONObject> paramMap, String paramString)
  {
    ...
    if (localJSONObject == null) {
      wxe.e("DIYProfileTemplate.ProfileTemplateBase", ":json illegal : it don't have " + paramString + " module");
    }
    try
    {
    ...
    {
      xqq.a("DIYProfileTemplate.ProfileTemplateBase:json error : it can not generate default " + paramString + " module", new Object[0]);
    }
    return null;
  }
  ...
  {
    paramView.measure(View.MeasureSpec.makeMeasureSpec(xsm.b(this.jdField_a_of_type_AndroidAppActivity) - xsm.a(this.jdField_a_of_type_AndroidAppActivity, 30.0F), 1073741824), View.MeasureSpec.makeMeasureSpec(0, 0));
  }
  ...
  protected int a(JSONObject paramJSONObject)
  {
    ...
    {
      xqq.a("DIYProfileTemplate.ProfileTemplateBase story line color is illegal module=" + paramJSONObject.optString("type") + " value=" + paramJSONObject.optString("line"), new Object[0]);
    }
    return i;
  }
  ...
  public View a(View paramView)
  {
    ...
    ((LinearLayout.LayoutParams)localObject).leftMargin = xsm.a(this.jdField_a_of_type_AndroidAppActivity, 15.0F);
    ((LinearLayout.LayoutParams)localObject).rightMargin = xsm.a(this.jdField_a_of_type_AndroidAppActivity, 15.0F);
    ((LinearLayout.LayoutParams)localObject).topMargin = xsm.a(this.jdField_a_of_type_AndroidAppActivity, 20.0F);
    ((LinearLayout.LayoutParams)localObject).bottomMargin = xsm.a(this.jdField_a_of_type_AndroidAppActivity, 20.0F);
  ...
  {
    QZoneLayoutTemplateBase localQZoneLayoutTemplateBase = (QZoneLayoutTemplateBase)paramView.findViewById(2131368284);
    ...
    a(paramJSONObject, paramView.findViewById(2131367819), (TextView)paramView.findViewById(2131377760), (ImageView)paramView.findViewById(2131367961));
    return paramView;
  }
  ...
  public View a(JSONObject paramJSONObject, View paramView1, View paramView2, View paramView3, View paramView4, View paramView5, View paramView6, View paramView7)
  {
    ...
    if (paramView1 == null)
    {
      ...
      this.jdField_a_of_type_AndroidViewView.findViewById(2131373573).setVisibility(8);
      label67:
      if (paramView3 != null) {
        break label537;
      }
      this.jdField_a_of_type_AndroidViewView.findViewById(2131373575).setVisibility(8);
      label87:
      if (paramView4 != null) {
        break label556;
      }
      this.jdField_a_of_type_AndroidViewView.findViewById(2131373571).setVisibility(8);
    }
    for (;;)
    {
      if (localViewGroup.getChildAt(0) != null) {
        a(paramJSONObject, "qq", localViewGroup.getChildAt(0).findViewById(2131367819));
      }
      if (localViewGroup.getChildAt(1) != null) {
        a(paramJSONObject, "p", localViewGroup.getChildAt(1).findViewById(2131367819));
      }
      if (paramView1 != null)
      {
      ...
      if (this.jdField_a_of_type_Awqt.b)
      {
        ...
        {
          ((TextView)paramView5.findViewById(2131368525)).setTextColor(this.jdField_c_of_type_Int);
          ((ImageView)paramView5.findViewById(2131367819)).clearColorFilter();
          ((ImageView)paramView5.findViewById(2131367819)).setColorFilter(this.jdField_c_of_type_Int);
          paramJSONObject.addView(paramView5, 0);
        }
        if ((paramView6 != null) && (paramView6.getParent() == null))
        {
          ((TextView)paramView6.findViewById(2131368525)).setTextColor(this.jdField_c_of_type_Int);
          ((ImageView)paramView6.findViewById(2131367819)).clearColorFilter();
          ((ImageView)paramView6.findViewById(2131367819)).setColorFilter(this.jdField_c_of_type_Int);
          paramJSONObject.addView(paramView6, 0);
        }
        if ((paramView7 != null) && (paramView7.getParent() == null))
        {
          ((TextView)paramView7.findViewById(2131368525)).setTextColor(this.jdField_c_of_type_Int);
          ((ImageView)paramView7.findViewById(2131367819)).clearColorFilter();
          ((ImageView)paramView7.findViewById(2131367819)).setColorFilter(this.jdField_c_of_type_Int);
      ...
      break;
      label519:
      a(paramJSONObject, "sign", paramView2.findViewById(2131367819));
      break label67;
      label537:
      a(paramJSONObject, "lv", paramView3.findViewById(2131367819));
      break label87;
      label556:
      a(paramJSONObject, "metal", paramView4.findViewById(2131367819));
    }
  }
  ...
  protected URLDrawable a(JSONObject paramJSONObject, int paramInt1, int paramInt2)
  {
    ...
    return a(paramJSONObject, new bebl(paramInt1, paramInt2));
  }
  ...
  public List<View> a(HashMap<String, View> paramHashMap, String[] paramArrayOfString)
  {
    ...
    {
      xqq.a("DIYProfileTemplate.ProfileTemplateBasethere is no module!", new Object[0]);
    ...
    if (i < ((JSONArray)localObject).length())
    {
      ...
      if (localJSONObject1 == null) {
        wxe.e("DIYProfileTemplate.ProfileTemplateBase", "module array[" + i + "] is null");
      }
      for (;;)
      {
        i += 1;
    ...
    for (;;)
    {
      ...
      {
        xqq.a(bool, "makeModuleList error :" + paramArrayOfString[i] + " have a parent!");
        ...
        if (paramArrayOfString[i].equals("map_key_music_box"))
        {
          ...
          if (awsv.a(this.jdField_a_of_type_Awqt))
          {
            localObject = localJSONObject1;
  ...
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561817, null);
    ...
    localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131373573);
    ((View)localObject).setBackgroundResource(2130839256);
    paramHashMap.put("map_key_sig", localObject);
    localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131373575);
    ((View)localObject).setBackgroundResource(2130839256);
    paramHashMap.put("map_key_account_level_info", localObject);
    ((View)localObject).setClickable(false);
    localObject = this.jdField_a_of_type_AndroidViewView.findViewById(2131373571);
    ((View)localObject).setBackgroundResource(2130839256);
    paramHashMap.put("map_key_medal_and_diamond", localObject);
  }
  
  public void a(HashMap<String, View> paramHashMap, QQAppInterface paramQQAppInterface, awqt paramawqt)
  {
    ProfileCardFavorShowView localProfileCardFavorShowView = a(this.jdField_a_of_type_AndroidAppActivity);
    paramQQAppInterface = new PersonalityLabelBoard(this.jdField_a_of_type_AndroidAppActivity, paramQQAppInterface, paramawqt.a.jdField_a_of_type_JavaLangString, localProfileCardFavorShowView);
    if ((this.jdField_a_of_type_AndroidAppActivity instanceof FriendProfileCardActivity)) {
      paramQQAppInterface.setScrollListener((awpd)this.jdField_a_of_type_AndroidAppActivity);
    }
    localProfileCardFavorShowView.setTitle(alud.a(2131708891));
  ...
  public void a(HashMap<String, View> paramHashMap, QQAppInterface paramQQAppInterface, awqt paramawqt, besb parambesb)
  {
    paramQQAppInterface = new TemplatePhotoWall(this.jdField_a_of_type_AndroidAppActivity, paramQQAppInterface, paramawqt.a.jdField_a_of_type_JavaLangString, parambesb);
    paramawqt = (ProfileCardDiyPhotoWallView)paramQQAppInterface.findViewById(2131371919).findViewById(2131371919);
    paramawqt.setMargin(xsm.a(this.jdField_a_of_type_AndroidAppActivity, 8.0F));
    paramawqt.setBorderWidth(this.jdField_d_of_type_Int);
    paramawqt = a(this.jdField_a_of_type_AndroidAppActivity);
    paramawqt.setTitle(alud.a(2131708892));
    paramawqt.setVisibility(8);
    paramawqt.addView(paramQQAppInterface);
    paramHashMap.put("map_key_photo_wall", paramawqt);
  }
  
  public void a(HashMap<String, View> paramHashMap, QQAppInterface paramQQAppInterface, awqt paramawqt, boolean paramBoolean)
  {
    paramQQAppInterface = a(this.jdField_a_of_type_AndroidAppActivity);
    paramQQAppInterface.setTitle(this.jdField_a_of_type_AndroidAppActivity.getString(2131691205));
  ...
  {
    awsv localawsv = new awsv(true);
    paramCard = localawsv.a(this.jdField_a_of_type_AndroidAppActivity, paramCard.uin);
    localawsv.a(this.jdField_a_of_type_Awqt);
    paramCard.setTag(2131561829, localawsv);
  ...
  protected void a(JSONObject paramJSONObject, View paramView, int paramInt1, int paramInt2)
  {
    ...
    for (paramJSONObject = "null module";; paramJSONObject = paramJSONObject.optString("type"))
    {
      ...
      wxe.d("DIYProfileTemplate.ProfileTemplateBase", "setModuleBackground " + paramJSONObject + " ,but it is null.");
      return;
    ...
    if (paramView == null)
    {
      xqq.a("setModuleBackground cant find " + paramJSONObject + " view", new Object[0]);
      return;
    }
    try
    {
      URLDrawable localURLDrawable = a(str, new bebl(paramInt1, paramInt2));
      paramView.setBackgroundDrawable(localURLDrawable);
      localURLDrawable.setURLDrawableListener(new bebk(paramView));
      return;
    }
    catch (IllegalArgumentException paramView)
    {
      xqq.a("setModuleBackground " + paramJSONObject + " url illegal:" + str + " \ne:" + paramView, new Object[0]);
    }
  }
  ...
  public void a(JSONObject paramJSONObject, ProfileCardFavorShowView paramProfileCardFavorShowView)
  {
    ...
    for (;;)
    {
      a(paramJSONObject, paramProfileCardFavorShowView.findViewById(2131367819), (TextView)paramProfileCardFavorShowView.findViewById(2131377760), (ImageView)paramProfileCardFavorShowView.findViewById(2131367961));
      return;
  ...
  protected void a(JSONObject paramJSONObject, String paramString, View paramView)
  {
    ...
    {
      wxe.d("DIYProfileTemplate.ProfileTemplateBase", "setBaseInfoIcon " + paramString + " icon,but it is null.");
      return;
    }
    if (paramView == null)
    {
      wxe.e("DIYProfileTemplate.ProfileTemplateBase", "setBaseInfoIcon cant find " + paramString + " view");
      return;
    }
    try
    {
    ...
    {
      xqq.a("setBaseInfoIcon " + paramString + " url illegal:" + paramJSONObject + " \ne:" + paramView, new Object[0]);
    }
  }
  ...
  {
    View localView = paramView.findViewById(2131368258);
    ...
    localObject1 = paramView.findViewById(2131367819);
    ...
    localObject2 = (TextView)paramView.findViewById(2131377760);
    ...
    Object localObject3 = (TextView)paramView.findViewById(2131376878);
    ...
    localObject3 = paramView.findViewById(2131377014);
    ...
    ((TextView)paramView.findViewById(2131365755)).setTextColor(this.jdField_c_of_type_Int);
    localObject3 = (TextView)paramView.findViewById(2131376877);
    ((TextView)localObject3).setTextColor(this.jdField_c_of_type_Int);
    ...
    if (paramView.getTag(2131561829) != null) {
      ((awsv)paramView.getTag(2131561829)).a(this.jdField_a_of_type_Awqt);
    }
    return paramView;
  }
  ...
  {
    paramHashMap.put("map_key_qzone", this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561818, null));
  }
  ...
  public View c(JSONObject paramJSONObject, View paramView)
  {
    ...
    do
    {
      ...
      ProfileCardDiyPhotoWallView localProfileCardDiyPhotoWallView = (ProfileCardDiyPhotoWallView)localPhotoWallView.findViewById(2131371919).findViewById(2131371919);
      ...
      a(paramJSONObject, ((ProfileCardFavorShowView)localObject).findViewById(2131367819), (TextView)((ProfileCardFavorShowView)localObject).findViewById(2131377760), (ImageView)((ProfileCardFavorShowView)localObject).findViewById(2131367961));
      localObject = localPhotoWallView.findViewById(2131371911);
  ...
  public View d(JSONObject paramJSONObject, View paramView)
  {
    ...
    try
    {
      ...
      if (localProfileCardFavorShowView.b() > 0)
      {
        ...
        localView.measure(View.MeasureSpec.makeMeasureSpec(xsm.b(this.jdField_a_of_type_AndroidAppActivity) - xsm.a(this.jdField_a_of_type_AndroidAppActivity, 78.0F), 1073741824), View.MeasureSpec.makeMeasureSpec(0, 0));
        a(paramJSONObject, localProfileCardFavorShowView.a(), localView.getMeasuredWidth(), localView.getMeasuredHeight());
        a(paramJSONObject, localProfileCardFavorShowView.findViewById(2131367819), (TextView)localProfileCardFavorShowView.findViewById(2131377760), (ImageView)localProfileCardFavorShowView.findViewById(2131367961));
        return paramView;
      }
    }
    catch (Exception localException)
    {
      for (;;)
      {
        wxe.e("DIYProfileTemplate.ProfileTemplateBase", "getTagView error personalityLabelBoard is null");
        continue;
