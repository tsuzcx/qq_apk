...
public class bmkx
{
  ...
  public bmkx(Conversation paramConversation)
  {
  ...
  private void a()
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragFrameLayout = ((DragFrameLayout)this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a().findViewById(2131365160));
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a().getLayoutInflater().inflate(2131558660, this.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragFrameLayout, false);
    this.b = this.jdField_a_of_type_AndroidViewView.findViewById(2131378891);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131378886).setBackgroundColor(this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a().getColor(2131165506));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378887));
    this.jdField_a_of_type_AndroidViewView.setOnTouchListener(new bmky(this));
    ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378888)).setOnClickListener(new bmkz(this));
  }
  
  private void b()
  {
    bmhg.a(this.jdField_a_of_type_AndroidViewView);
  }
  ...
  public void a(TianShuAccess.AdItem paramAdItem)
  {
    ...
    for (;;)
    {
      ...
      if (((TianShuAccess.MapEntry)localObject2).key.get().equals("url"))
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new bmla(this, (String)localObject1));
        PreloadManager.a().c(paramAdItem, new bmlb(this));
      }
      else
      {
