...
public class pfl
{
  private static final LRULinkedHashMap<String, pfo> jdField_a_of_type_ComTencentUtilLRULinkedHashMap;
  private static final Object jdField_a_of_type_JavaLangObject = new Object();
  private static volatile pfl jdField_a_of_type_Pfl;
  private static volatile boolean jdField_a_of_type_Boolean;
  public static int b;
  private static final LRULinkedHashMap<String, pfo> jdField_b_of_type_ComTencentUtilLRULinkedHashMap;
  public static int c;
  public static int d;
  public static int e;
  public static int f;
  ...
  public pfl()
  {
    ...
    this.jdField_a_of_type_Pfp = new pfp(new pfm(this));
  }
  
  public static pfl a()
  {
    if (jdField_a_of_type_Pfl == null) {
      jdField_a_of_type_Pfl = new pfl();
    }
    return jdField_a_of_type_Pfl;
  }
  
  public static pfo a(String paramString)
  {
    ...
    {
      localpfo = (pfo)jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramString);
      if (localpfo != null)
      {
        paramString = localpfo;
        if (localpfo.a()) {
          paramString = null;
        }
        return paramString;
    ...
    pfo localpfo = (pfo)jdField_b_of_type_ComTencentUtilLRULinkedHashMap.get(paramString);
    if (localpfo != null)
    {
      paramString = localpfo;
      if (localpfo.a()) {}
  ...
  /* Error */
  public static void a(String paramString, pfn parampfn)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 132	pfl:jdField_a_of_type_Boolean	Z
    //   6: ifeq +20 -> 26
    //   9: aload_1
    //   10: ifnull +12 -> 22
    //   13: aload_1
    //   14: getstatic 47	pfl:g	I
    ...
    //   33: aload_1
    //   34: aload_0
    //   35: invokespecial 148	com/tencent/biz/pubaccount/readinjoy/engine/ReadInJoyWebRenderEngine$3:<init>	(Lpfn;Ljava/lang/String;)V
  ...
  {
    boolean bool = true;
    File localFile = new File(pfr.a(), "libviola.so");
  ...
  public int g(Bundle paramBundle)
  {
    ...
    if (biru.a((String)localObject))
    {
      localObject = biru.a((String)localObject);
      if ((localObject != null) && (!TextUtils.isEmpty(((birv)localObject).jdField_b_of_type_JavaLangString))) {
        this.jdField_e_of_type_JavaLangString = ((birv)localObject).jdField_b_of_type_JavaLangString;
      }
    }
    while (TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString))
    {
      ...
      localObject = nmj.a(this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString);
      if (localObject != null) {
        try
        {
          int i = ((nmn)localObject).a.available();
          if (i != 0)
          {
            byte[] arrayOfByte = new byte[i];
            if (i == ((nmn)localObject).a.read(arrayOfByte)) {
  ...
  public int h(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      if (!TextUtils.isEmpty(paramBundle.getString(tde.jdField_a_of_type_JavaLangString))) {
        str1 = paramBundle.getString(tde.jdField_a_of_type_JavaLangString);
      }
      if (!TextUtils.isEmpty(paramBundle.getString(tde.jdField_e_of_type_JavaLangString))) {
        str2 = paramBundle.getString(tde.jdField_e_of_type_JavaLangString);
      }
      if (!TextUtils.isEmpty(paramBundle.getString(tde.jdField_c_of_type_JavaLangString))) {
        str3 = paramBundle.getString(tde.jdField_c_of_type_JavaLangString);
      }
      str4 = str1;
      str5 = str2;
      str6 = str3;
      if (!TextUtils.isEmpty(paramBundle.getString(tde.jdField_d_of_type_JavaLangString)))
      {
        this.jdField_f_of_type_JavaLangString = paramBundle.getString(tde.jdField_d_of_type_JavaLangString);
        str6 = str3;
        str5 = str2;
        str4 = str1;
      }
  ...
  public int i(Bundle paramBundle)
  {
    if (!TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString))
    {
      ...
      jdField_b_of_type_ComTencentUtilLRULinkedHashMap.put(this.jdField_a_of_type_JavaLangString, new pfo(this.jdField_e_of_type_JavaLangString, "utf-8", 1800000L));
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      ozs.a(ozs.a(), true, 8);
      ozs.a(ozs.a(), true, 12, System.currentTimeMillis() - this.jdField_a_of_type_Long);
      d();
      a();
      this.jdField_a_of_type_Int = 1;
      return -1;
      label131:
      jdField_a_of_type_ComTencentUtilLRULinkedHashMap.put(this.jdField_a_of_type_JavaLangString, new pfo(this.jdField_e_of_type_JavaLangString, "utf-8"));
    }
  }
