  ...
  extends aypg
{
  ...
  akat jdField_a_of_type_Akat = new aysj(this);
  private Handler jdField_a_of_type_AndroidOsHandler;
  awbg jdField_a_of_type_Awbg;
  private awbh jdField_a_of_type_Awbh;
  ...
  public aysi(ayoz paramayoz, aywc paramaywc)
  {
    super(paramayoz, paramaywc);
    this.jdField_b_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_b_of_type_JavaUtilMap = new HashMap();
    paramayoz = paramaywc.jdField_b_of_type_JavaLangObject;
    if ((paramayoz != null) && ((paramayoz instanceof awbh))) {
      this.jdField_a_of_type_Awbh = ((awbh)paramaywc.jdField_b_of_type_JavaLangObject);
    }
    if ((this.jdField_a_of_type_Ayoz != null) && (this.jdField_a_of_type_Ayoz.a != null)) {
      this.jdField_a_of_type_AndroidOsHandler = this.jdField_a_of_type_Ayoz.a;
    }
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo = ((MessageForLightVideo)paramaywc.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
  ...
  private ayzd a()
  {
    ...
    localayzd.jdField_c_of_type_Int = ((int)this.jdField_a_of_type_Aywc.jdField_a_of_type_Long);
    localayzd.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_Aywc.jdField_b_of_type_JavaLangString;
    localayzd.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_Aywc.jdField_c_of_type_JavaLangString;
    localayzd.f = this.jdField_a_of_type_Aywc.jdField_a_of_type_Int;
    localayzd.i = 0;
    if ((localayzd.f == 0) || (1008 == localayzd.f))
    {
      localayzd.jdField_b_of_type_JavaLangString = null;
      if (localayzd.f != 0) {
        break label254;
      }
      localayzd.jdField_a_of_type_Int = 0;
    }
    for (;;)
    {
      localayzd.jdField_b_of_type_Int = 2;
      Object localObject = new File(this.jdField_a_of_type_JavaLangString);
      localayzd.jdField_a_of_type_JavaLangString = ((File)localObject).getName();
      localayzd.jdField_a_of_type_Long = ((File)localObject).length();
      localayzd.jdField_a_of_type_ArrayOfByte = this.jdField_a_of_type_ArrayOfByte;
      localayzd.jdField_b_of_type_ArrayOfByte = this.d;
      localayzd.e = this.jdField_c_of_type_Int;
      localayzd.jdField_d_of_type_Int = this.jdField_b_of_type_Int;
      localayzd.h = this.x;
      localayzd.jdField_b_of_type_Long = this.jdField_b_of_type_Long;
      localObject = this.jdField_a_of_type_Ayqo;
      long l = localayzd.jdField_a_of_type_Long + this.jdField_b_of_type_Long;
      this.q = l;
      ((ayqo)localObject).jdField_a_of_type_Long = l;
      localayzd.g = 3;
      localayzd.k = 3;
      localayzd.jdField_j_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo.busiType;
      return localayzd;
      localayzd.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Aywc.jdField_c_of_type_JavaLangString;
      break;
      label254:
      if (1 == localayzd.f) {
        localayzd.jdField_a_of_type_Int = 1;
      } else if (3000 == localayzd.f) {
        localayzd.jdField_a_of_type_Int = 2;
      } else {
        localayzd.jdField_a_of_type_Int = 3;
      }
    }
  }
  ...
  private im_msg_body.RichText a()
  {
    for (;;)
    {
      try
      {
        ...
        Object localObject1 = (MessageForLightVideo)this.jdField_a_of_type_Aywc.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
        Object localObject3;
        if (localObject1 != null)
        {
          ...
          localVideoFile.bytes_file_name.set(ByteStringMicro.copyFromUtf8(this.jdField_a_of_type_Aywc.jdField_i_of_type_JavaLangString));
          localVideoFile.bytes_file_md5.set(ByteStringMicro.copyFrom(HexUtil.hexStr2Bytes(this.jdField_a_of_type_Aywc.f)));
        ...
        if (this.x == 0)
        {
          if ((this.jdField_a_of_type_Awbh != null) && (this.jdField_a_of_type_Awbh.jdField_b_of_type_Int != 0))
          {
            localVideoFile.uint32_file_time.set(this.jdField_a_of_type_Awbh.jdField_b_of_type_Int / 1000);
            ...
            localObject1 = ajya.a(2131706050);
            ((im_msg_body.Text)localObject3).str.set(ByteStringMicro.copyFromUtf8(BaseApplication.getContext().getString(2131691294)));
  ...
  private void t()
  {
    ...
    //   21: lstore_2
    //   22: aload_0
    //   23: getfield 175	aysi:d	[B
    //   26: arraylength
    //   27: aload_0
    //   28: getfield 172	aysi:jdField_a_of_type_ArrayOfByte	[B
    //   31: arraylength
    //   32: iadd
    //   33: newarray byte
    //   35: astore 5
    //   37: aload_0
    //   38: getfield 175	aysi:d	[B
    //   41: iconst_0
    //   42: aload 5
    //   44: iconst_0
    //   45: aload_0
    //   46: getfield 175	aysi:d	[B
    //   49: arraylength
    //   50: invokestatic 497	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   53: aload_0
    //   54: getfield 172	aysi:jdField_a_of_type_ArrayOfByte	[B
    //   57: iconst_0
    //   58: aload 5
    //   60: aload_0
    //   61: getfield 175	aysi:d	[B
    //   64: arraylength
    //   65: aload_0
    //   66: getfield 172	aysi:jdField_a_of_type_ArrayOfByte	[B
    //   69: arraylength
    ...
    //   176: astore 6
    //   178: aload_0
    //   179: invokespecial 529	aysi:a	()Z
    //   182: ifne +642 -> 824
    //   185: aload 5
    //   187: astore 8
    //   189: aload 7
    ...
    //   194: sipush 9303
    //   197: ldc_w 531
    //   200: invokevirtual 534	aysi:b	(ILjava/lang/String;)V
    //   203: aload 5
    //   205: astore 8
    //   207: aload 7
    //   209: astore 6
    //   211: aload_0
    //   212: invokevirtual 536	aysi:d	()V
    //   215: aload 7
    //   217: ifnull +8 -> 225
    //   220: aload 7
    ...
    //   284: aload_0
    //   285: invokespecial 543	aysi:a	()Layzd;
    //   288: astore 5
    ...
    //   310: aload 5
    //   312: getfield 139	ayzd:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   326: aload 5
    //   328: getfield 142	ayzd:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   342: aload 5
    //   344: getfield 151	ayzd:jdField_a_of_type_Int	I
    ...
    //   355: aload 5
    //   357: getfield 153	ayzd:jdField_b_of_type_Int	I
    //   360: invokevirtual 282	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   363: aload 5
    //   365: getfield 150	ayzd:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   368: ifnull +821 -> 1189
    //   371: aload 6
    ...
    //   376: aload 5
    //   378: getfield 150	ayzd:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   405: aload 5
    //   407: getfield 213	ayzd:jdField_j_of_type_Int	I
    ...
    //   445: aload 5
    //   447: getfield 165	ayzd:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   458: aload 5
    //   460: getfield 173	ayzd:jdField_a_of_type_ArrayOfByte	[B
    ...
    //   474: aload 5
    //   476: getfield 177	ayzd:jdField_b_of_type_ArrayOfByte	[B
    ...
    //   490: aload 5
    //   492: getfield 170	ayzd:jdField_a_of_type_Long	J
    ...
    //   503: aload 5
    //   505: getfield 184	ayzd:jdField_d_of_type_Int	I
    ...
    //   555: aload 5
    //   557: getfield 192	ayzd:jdField_b_of_type_Long	J
    ...
    //   587: aload 5
    //   589: aload_0
    //   590: getfield 621	aysi:jdField_b_of_type_ArrayOfByte	[B
    ...
    //   603: aload 10
    //   605: lload_2
    //   606: invokespecial 630	aysk:<init>	(Laysi;Ljava/lang/String;J)V
    //   609: astore 6
    //   611: aload_0
    //   612: new 632	com/tencent/mobileqq/highway/transaction/Transaction
    //   615: dup
    //   616: aload_0
    //   617: getfield 69	aysi:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   620: invokevirtual 635	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   623: bipush 12
    //   625: aload 10
    //   627: aload_0
    //   628: getfield 637	aysi:r	J
    //   631: l2i
    //   632: aload_0
    //   633: getfield 639	aysi:jdField_c_of_type_ArrayOfByte	[B
    //   636: aload_0
    //   637: getfield 172	aysi:jdField_a_of_type_ArrayOfByte	[B
    //   640: aload 6
    //   642: aload 5
    ...
    //   647: putfield 645	aysi:jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    //   650: aload_0
    //   651: getfield 69	aysi:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   654: invokevirtual 649	com/tencent/mobileqq/app/QQAppInterface:getHwEngine	()Lcom/tencent/mobileqq/highway/HwEngine;
    //   657: aload_0
    //   658: getfield 645	aysi:jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    ...
    //   697: aload_0
    //   698: getfield 645	aysi:jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    ...
    //   713: aload_0
    //   714: getfield 131	aysi:jdField_a_of_type_Aywc	Laywc;
    //   717: getfield 133	aywc:jdField_a_of_type_Long	J
    ...
    //   729: aload_0
    //   730: getfield 668	aysi:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   742: aload_0
    //   743: getfield 673	aysi:l	Ljava/lang/String;
    ...
    //   755: aload_0
    //   756: getfield 645	aysi:jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    ...
    //   791: ldc_w 684
    //   794: aload_0
    //   795: getfield 687	aysi:jdField_b_of_type_Aypd	Laypd;
    //   798: invokevirtual 690	aysi:a	(ILjava/lang/String;Ljava/lang/String;Laypd;)V
    //   801: aload_0
    //   802: invokevirtual 536	aysi:d	()V
    //   805: return
    //   806: astore 6
    //   808: aload 6
    ...
    //   830: astore 6
    //   832: aload_0
    //   833: getfield 468	aysi:jdField_b_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    ...
    //   850: astore 6
    //   852: aload_0
    //   853: getfield 468	aysi:jdField_b_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   856: aload 9
    ...
    //   898: astore 6
    //   900: aload_0
    //   901: getfield 470	aysi:jdField_a_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   904: aload 9
  ...
  public int a()
  {
    ...
    this.jdField_a_of_type_Awbh = null;
    return super.a();
  }
  ...
  /* Error */
  void a(aysm paramaysm)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_1
    //   3: getfield 748	aysm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   6: astore 5
    //   8: aload_1
    //   9: getfield 749	aysm:jdField_a_of_type_ArrayOfByte	[B
    //   12: astore 6
    //   14: aload_1
    //   15: getfield 750	aysm:jdField_b_of_type_ArrayOfByte	[B
    //   18: astore 7
    //   20: aload_1
    //   21: getfield 751	aysm:jdField_c_of_type_ArrayOfByte	[B
    //   24: astore 8
    //   26: aload_1
    //   27: getfield 752	aysm:jdField_a_of_type_Int	I
    //   30: istore_2
    //   31: aload_1
    //   32: getfield 753	aysm:d	[B
    //   35: astore 9
    //   37: aload_1
    //   38: getfield 755	aysm:jdField_a_of_type_Awbg	Lawbg;
    //   41: astore 9
    //   43: aload_1
    //   44: getfield 756	aysm:jdField_a_of_type_Long	J
    //   47: lstore_3
    //   48: new 758	aysn
    //   51: dup
    //   52: aload_0
    //   53: invokespecial 759	aysn:<init>	(Laysi;)V
    //   56: astore_1
    //   57: new 632	com/tencent/mobileqq/highway/transaction/Transaction
    //   60: dup
    //   61: aload_0
    //   62: getfield 69	aysi:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   83: astore 5
    //   85: aload_0
    //   86: getfield 106	aysi:y	I
    //   89: ifeq +12 -> 101
    //   92: aload 5
    //   94: aload_0
    //   95: getfield 106	aysi:y	I
    //   98: putfield 762	com/tencent/mobileqq/highway/transaction/Transaction:cacheIp	I
    //   101: aload_1
    //   102: aload 5
    //   104: putfield 764	aysn:jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction	Lcom/tencent/mobileqq/highway/transaction/Transaction;
    //   107: aload_1
    //   108: iload_2
    //   109: putfield 765	aysn:jdField_a_of_type_Int	I
    //   112: aload_1
    //   113: aload 9
    //   115: putfield 766	aysn:jdField_a_of_type_Awbg	Lawbg;
    //   118: aload_0
    //   119: getfield 69	aysi:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   135: aload_0
    //   136: iload_2
    //   137: invokevirtual 768	aysi:f	(I)V
    //   140: aload_0
    //   141: monitorexit
    //   142: return
    //   143: aload_0
    //   144: getfield 44	aysi:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   147: aload 5
  ...
  public void a(ayyp paramayyp, ayze paramayze)
  {
    ...
    if (paramayze != null)
    {
      ...
      {
        paramayyp = (ayzu)paramayze.jdField_a_of_type_JavaUtilList.get(i);
        if (QLog.isColorLevel()) {
          b("procUrl", paramayyp.toString());
        }
        if (QLog.isColorLevel()) {
          QLog.d("LightVideoUploadProcessor", 2, "onBusiProtoResp()------response.result = " + paramayyp.jdField_c_of_type_Int);
        }
        this.f = paramayyp.jdField_a_of_type_JavaLangString;
        if (paramayyp.jdField_c_of_type_Int == 0)
        {
          if (QLog.isColorLevel()) {
            QLog.d("LightVideoUploadProcessor", 2, "onBusiProtoResp()------response.isExist = " + paramayyp.jdField_a_of_type_Boolean);
          }
        ...
        for (;;)
        {
          ...
          else
          {
            d();
            continue;
            b(paramayyp.jdField_c_of_type_Int, "onBusiProtoResp error");
            d();
          }
        }
      }
  ...
  {
    long l;
    if ((this.jdField_a_of_type_Awbh != null) && (this.jdField_a_of_type_Awbh.jdField_b_of_type_Long != 0L))
    {
      l = System.currentTimeMillis() - this.jdField_a_of_type_Awbh.jdField_b_of_type_Long;
      if (QLog.isColorLevel()) {
    ...
    while ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_Int == 1))
    {
      ...
      axrn.a(BaseApplication.getContext()).a(null, "LightVideoSend", paramBoolean, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, null);
      return;
      label197:
      this.jdField_a_of_type_JavaUtilHashMap.put("param_FailCode", String.valueOf(this.jdField_j_of_type_Int));
    }
    this.jdField_a_of_type_JavaUtilHashMap.put("upload_type", String.valueOf(this.jdField_a_of_type_Int));
    axrn.a(BaseApplication.getContext()).a(null, "LightVideoSendComplete", paramBoolean, l, this.q, this.jdField_a_of_type_JavaUtilHashMap, null);
  }
  
  public void aR_()
  {
    super.aR_();
    this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Aywc.jdField_j_of_type_JavaLangString;
    this.jdField_a_of_type_Long = this.jdField_a_of_type_Aywc.jdField_a_of_type_Long;
    if (this.jdField_a_of_type_Aywc.k == null) {
      this.d = HexUtil.hexStr2Bytes(awhh.a(this.jdField_b_of_type_JavaLangString));
    }
    this.d = HexUtil.hexStr2Bytes(this.jdField_a_of_type_Aywc.k);
    Object localObject;
    ...
    o();
    if (i()) {
      if (this.jdField_a_of_type_Awbh != null) {
        if (this.jdField_a_of_type_Aywc.jdField_i_of_type_Boolean)
        {
          this.jdField_a_of_type_Int = 0;
          this.jdField_a_of_type_Awbh.a(this);
          label234:
          d(1001);
        }
      }
    ...
    for (;;)
    {
      ...
      break;
      this.jdField_a_of_type_Int = 2;
      this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Aywc.jdField_i_of_type_JavaLangString;
      if (this.jdField_a_of_type_Aywc.f == null) {
        this.jdField_a_of_type_Aywc.f = awhh.a(this.jdField_a_of_type_JavaLangString);
      }
      localObject = this.jdField_a_of_type_Ayqo;
      String str = this.jdField_a_of_type_Aywc.f;
      ((ayqo)localObject).f = str;
      this.jdField_c_of_type_JavaLangString = str;
      this.jdField_a_of_type_ArrayOfByte = HexUtil.hexStr2Bytes(this.jdField_a_of_type_Aywc.f);
      if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo.videoFileSize == 0) || (this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo.videoFileTime == 0))
      {
        ...
        axkv.a(this.jdField_a_of_type_JavaLangString, (axkw)localObject);
      ...
      f();
      break label234;
      HwServlet.getConfig(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Aywc.jdField_b_of_type_JavaLangString);
      this.jdField_a_of_type_Int = 2;
      this.jdField_a_of_type_Awbh.a(this);
    }
  }
  
  void b(awbg paramawbg)
  {
    String str = paramawbg.jdField_a_of_type_JavaLangString;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("LightVideoUploadProcessor", 2, "<BDH_LOG>sendVideoThumbByBDH  filePath:" + str + " index :" + paramawbg.jdField_d_of_type_Int + " md5:" + HexUtil.bytes2HexStr(arrayOfByte2) + " fileSize:" + i);
    }
    ...
    for (;;)
    {
      ...
      localObject = new aysm(this);
      ((aysm)localObject).jdField_a_of_type_JavaLangString = str;
      ((aysm)localObject).jdField_a_of_type_ArrayOfByte = arrayOfByte1;
      ((aysm)localObject).jdField_b_of_type_ArrayOfByte = arrayOfByte2;
      ((aysm)localObject).jdField_c_of_type_ArrayOfByte = arrayOfByte3;
      ((aysm)localObject).jdField_a_of_type_Int = 0;
      ((aysm)localObject).d = arrayOfByte2;
      ((aysm)localObject).jdField_a_of_type_Awbg = paramawbg;
      ((aysm)localObject).jdField_a_of_type_Long = i;
      a((aysm)localObject);
      return;
  ...
  public void b(boolean paramBoolean)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("LightVideoUploadProcessor", 2, "confirm send:" + this.jdField_a_of_type_Awbh.b());
      }
      if (!this.jdField_a_of_type_Awbh.b()) {
        return;
      }
    }
    if (QLog.isColorLevel()) {
    ...
    ((awap)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(326)).a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo, this.jdField_a_of_type_Akat);
  }
  
  void c(awbg paramawbg)
  {
    String str = paramawbg.jdField_a_of_type_JavaLangString;
    int i = (int)new File(str).length();
    byte[] arrayOfByte1 = this.d;
    byte[] arrayOfByte2 = HexUtil.hexStr2Bytes(paramawbg.jdField_b_of_type_JavaLangString);
    int j = paramawbg.jdField_d_of_type_Int;
    int k = paramawbg.jdField_b_of_type_Int;
    int m = paramawbg.jdField_a_of_type_Int;
    int n = paramawbg.e;
    long l = paramawbg.jdField_b_of_type_Long;
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      localObject2 = new aysm(this);
      ((aysm)localObject2).jdField_a_of_type_JavaLangString = str;
      ((aysm)localObject2).jdField_a_of_type_ArrayOfByte = this.jdField_c_of_type_ArrayOfByte;
      ((aysm)localObject2).jdField_b_of_type_ArrayOfByte = arrayOfByte1;
      ((aysm)localObject2).jdField_c_of_type_ArrayOfByte = ((byte[])localObject1);
      ((aysm)localObject2).jdField_a_of_type_Int = j;
      ((aysm)localObject2).d = arrayOfByte2;
      ((aysm)localObject2).jdField_a_of_type_Awbg = paramawbg;
      ((aysm)localObject2).jdField_a_of_type_Long = i;
      a((aysm)localObject2);
      return;
  ...
  void e()
  {
    ...
    localauor.jdField_a_of_type_Long = (this.q - this.jdField_b_of_type_Long);
    ...
    for (String str = this.l;; str = this.f)
    {
      ...
      localauor.jdField_c_of_type_Long = this.jdField_b_of_type_Long;
      if (QLog.isColorLevel()) {
        QLog.d("LightVideoUploadProcessor", 2, "onSuccess uuid = " + localauor.jdField_c_of_type_JavaLangString);
      }
      if (this.jdField_a_of_type_Aywc.jdField_a_of_type_Auoq == null) {
        break;
      }
    ...
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo.uuid = localauor.jdField_c_of_type_JavaLangString;
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForLightVideo.md5 = localauor.jdField_d_of_type_JavaLangString;
    d(1003);
  }
  
  public void e(awbg paramawbg)
  {
    if (QLog.isColorLevel()) {
      QLog.d("VideoSend", 2, "addToSendQuene, info:" + paramawbg + " mSendingInfos:" + this.jdField_b_of_type_JavaUtilMap.size() + " mReadyToSendInfos:" + this.jdField_b_of_type_JavaUtilArrayList.size() + " mUploadType" + this.jdField_a_of_type_Int);
    }
    if (paramawbg.c())
    {
    ...
    localayqo.jdField_a_of_type_Long += paramawbg.jdField_a_of_type_Long;
    this.q += paramawbg.jdField_a_of_type_Long;
    this.jdField_b_of_type_JavaUtilArrayList.add(paramawbg);
    s();
  }
  ...
  public void f()
  {
    ...
    localayyp.jdField_a_of_type_JavaLangString = "short_video_up";
    localayyp.jdField_a_of_type_JavaUtilList.add(localayzd);
  ...
  public void f(awbg paramawbg)
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new LightVideoUploadProcessor.5(this, paramawbg));
  }
  ...
  public void h()
  {
    int j = 1;
    if (QLog.isColorLevel()) {
      QLog.d("VideoSend", 2, "checkNeedSendCompleteFile check, mUploadType:" + this.jdField_a_of_type_Int + " mSendFileSliceFailed:" + this.jdField_b_of_type_Boolean + " mCombineInfo:" + this.jdField_a_of_type_Awbg);
    }
    int i;
    if (this.jdField_a_of_type_Int == 0) {
    ...
    for (;;)
    {
      if ((i != 0) && (this.jdField_a_of_type_Awbg != null))
      {
        this.jdField_a_of_type_Aywc.jdField_i_of_type_JavaLangString = this.jdField_a_of_type_Awbg.jdField_a_of_type_JavaLangString;
        this.jdField_a_of_type_Aywc.f = this.jdField_a_of_type_Awbg.jdField_b_of_type_JavaLangString;
        this.jdField_a_of_type_Aywc.jdField_i_of_type_Boolean = false;
        this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Awbg.jdField_a_of_type_JavaLangString;
        this.jdField_a_of_type_ArrayOfByte = HexUtil.hexStr2Bytes(this.jdField_a_of_type_Awbg.jdField_b_of_type_JavaLangString);
        ayqo localayqo = this.jdField_a_of_type_Ayqo;
        String str = this.jdField_a_of_type_Awbg.jdField_b_of_type_JavaLangString;
        localayqo.f = str;
        this.jdField_c_of_type_JavaLangString = str;
        this.q = this.jdField_a_of_type_Awbg.jdField_a_of_type_Long;
        this.x = (this.jdField_a_of_type_Awbg.e / 1000);
        g();
      }
      return;
      if ((this.jdField_a_of_type_Awbg != null) && (!this.jdField_a_of_type_Awbg.jdField_a_of_type_Boolean))
      {
  ...
  protected void i()
  {
    super.i();
    if (QLog.isColorLevel()) {
      QLog.d("LightVideoUploadProcessor", 2, "sendProgressMessage,progress;" + this.n + " transferedSize:" + this.jdField_a_of_type_Ayqo.e + " fileSize:" + this.jdField_a_of_type_Ayqo.jdField_a_of_type_Long);
    }
  }
  ...
  public void r()
  {
    ...
    if (jdField_a_of_type_Boolean)
    {
      ...
      l1 = Long.parseLong(this.jdField_a_of_type_Aywc.jdField_b_of_type_JavaLangString);
      l2 = Long.parseLong(this.jdField_a_of_type_Aywc.jdField_c_of_type_JavaLangString);
      localShortVideoSureReqInfo.uint64_fromuin.set(l1);
      localShortVideoSureReqInfo.uint64_touin.set(l2);
      if ((this.jdField_a_of_type_Aywc.jdField_a_of_type_Int != 0) && (1008 != this.jdField_a_of_type_Aywc.jdField_a_of_type_Int)) {
        break label405;
      }
    ...
    for (;;)
    {
      j = ((MessageForLightVideo)this.jdField_a_of_type_Aywc.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).busiType;
      ...
      if (1 == this.jdField_a_of_type_Aywc.jdField_a_of_type_Int) {
        i = 1;
      } else if (3000 == this.jdField_a_of_type_Aywc.jdField_a_of_type_Int) {
        i = 2;
      } else {
        i = 3;
      }
  ...
  public void s()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        awbg localawbg = (awbg)this.jdField_b_of_type_JavaUtilArrayList.remove(0);
        if (localawbg == null) {
          break;
        }
        if (QLog.isColorLevel()) {
          QLog.d("VideoSend", 2, "sendSlice, info:" + localawbg + " mSendingInfos:" + this.jdField_b_of_type_JavaUtilMap.size() + " mReadyToSendInfos:" + this.jdField_b_of_type_JavaUtilArrayList.size());
        }
        this.jdField_b_of_type_JavaUtilMap.put(Integer.valueOf(localawbg.jdField_d_of_type_Int), localawbg);
        a(localawbg);
      }
    }
  }
