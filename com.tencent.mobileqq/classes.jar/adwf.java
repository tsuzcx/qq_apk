...
{
  public adwf(AssociatedAccountManageActivity paramAssociatedAccountManageActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      else if (AssociatedAccountManageActivity.a(this.a) == paramView)
      {
        ...
        if (AppSetting.c) {
          paramView.setContentDescription(this.a.getString(2131719083));
        }
      }
      else
      {
        ...
        {
          paramView.setContentDescription(this.a.getString(2131690708));
          AssociatedAccountManageActivity.a(this.a).setContentDescription(this.a.getString(2131719083));
        }
        if ((localView1 instanceof ShaderAnimLayout)) {
          ((ShaderAnimLayout)localView1).b();
        }
