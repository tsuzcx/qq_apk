  ...
  implements View.OnClickListener
{
  ...
  public uuu(Context paramContext, uuy paramuuy)
  {
    super(paramContext);
    if (paramuuy != null) {
  ...
  private void a(boolean paramBoolean)
  {
    if ((paramBoolean) && (this.jdField_a_of_type_UserGrowthStNewIconStyle != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_UserGrowthStNewIconStyle.title)))
    {
      ...
      for (int i = 2130842661;; i = 2130842660)
      {
        ...
        localObject = BaseApplicationImpl.getContext().getResources().getDrawable(2130843159);
        uqt.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView, this.jdField_a_of_type_UserGrowthStNewIconStyle.iconUrl, (Drawable)localObject);
        return;
      }
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView.setImageResource(2130843159);
      return;
    }
  ...
  protected void e()
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewKandianUrlImageView = ((KandianUrlImageView)a(2131380710));
