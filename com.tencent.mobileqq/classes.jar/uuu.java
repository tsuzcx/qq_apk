...
public class uuu
  extends mxh
{
  public uuu(StoryMessageListActivity paramStoryMessageListActivity)
  {
    ...
    if ((paramInt == 0) && (paramArrayOfByte != null)) {
      try
      {
        ...
        if ((localRspStoryMessageList.errinfo.error_code.has()) && (localRspStoryMessageList.errinfo.error_code.get() == 0))
        {
          ...
          {
            uur localuur = new uur((qqstory_710_message.StoryMessage)localIterator.next());
            if (localuur.d) {
              paramArrayOfByte.add(localuur);
            }
          }
        }
