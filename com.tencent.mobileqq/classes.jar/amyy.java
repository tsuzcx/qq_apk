...
public class amyy
  extends amyp<QQFriendRelation2Config>
{
  public static QQFriendRelation2Config c()
  {
    QQFriendRelation2Config localQQFriendRelation2Config2 = (QQFriendRelation2Config)ampl.a().a(491);
  ...
  @NonNull
  public QQFriendRelation2Config a(amph[] paramArrayOfamph)
  {
    boolean bool = true;
    ...
    try
    {
      if (!TextUtils.isEmpty(paramArrayOfamph)) {
        if (new JSONObject(paramArrayOfamph).optInt("enable", 1) != 1) {
          break label49;
        }
      }
      for (;;)
    ...
    {
      ved.e("QQFriendRelation2Processor", "QQFriendRelation2Config onParsed exception :" + paramArrayOfamph.getMessage());
    }
  }
