...
public class amyy
  extends amza
{
  private LinkedList<amyz> a = new LinkedList();
  ...
  public void a(amyz paramamyz)
  {
    synchronized (this.a)
    {
      if (!this.a.contains(paramamyz)) {
        this.a.add(paramamyz);
      }
      return;
    }
  }
  ...
  public void b(amyz paramamyz)
  {
    synchronized (this.a)
    {
      this.a.remove(paramamyz);
      return;
    }
  }
