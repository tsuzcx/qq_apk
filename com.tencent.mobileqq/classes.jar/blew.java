...
public final class blew
{
    ...
    if (!jdField_a_of_type_Boolean) {
      try
      {
        if (!jdField_a_of_type_Boolean)
        {
          ...
          blei.a(localBaseApplicationImpl, false);
          blfm.a(localBaseApplicationImpl);
  ...
  private static void a(Application paramApplication)
  {
    ...
    for (paramApplication = new File(VFSAssistantUtils.getSDKPrivatePath(AppConstants.SDCARD_PATH));; paramApplication = paramApplication.getCacheDir())
    {
  ...
  public static void b()
  {
    if (jdField_a_of_type_Boolean) {
      try
      {
        if (jdField_a_of_type_Boolean)
        {
          blei.a(false, BaseApplicationImpl.getApplication().getRuntime().getLongAccountUin());
