...
public class alus
{
  ...
  public static aluu a;
  private static final RecyclablePool jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool = new RecyclablePool(aluu.class, 30);
  private static Map<String, aluu> jdField_a_of_type_JavaUtilMap;
  ...
  public static aluu a()
  {
    return (aluu)jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool.obtain(aluu.class);
  }
  ...
  public static final String a(int paramInt)
  {
    ...
    //   11: astore_3
    //   12: ldc 106
    //   14: getstatic 31	alus:jdField_a_of_type_Aluu	Laluu;
    //   17: iconst_0
    //   18: invokestatic 143	alus:a	(Ljava/lang/String;Laluu;Z)V
    //   21: ldc 145
    ...
    //   35: getstatic 31	alus:jdField_a_of_type_Aluu	Laluu;
    //   38: getfield 149	aluu:jdField_a_of_type_Long	J
    ...
    //   49: getstatic 31	alus:jdField_a_of_type_Aluu	Laluu;
    //   52: getfield 156	aluu:jdField_b_of_type_Long	J
    ...
    //   164: areturn
    //   165: ldc 106
    //   167: getstatic 31	alus:jdField_a_of_type_Aluu	Laluu;
    //   170: iconst_0
    //   171: invokestatic 143	alus:a	(Ljava/lang/String;Laluu;Z)V
    //   174: ldc 145
    ...
    //   188: getstatic 31	alus:jdField_a_of_type_Aluu	Laluu;
    //   191: getfield 149	aluu:jdField_a_of_type_Long	J
    ...
    //   202: getstatic 31	alus:jdField_a_of_type_Aluu	Laluu;
    //   205: getfield 156	aluu:jdField_b_of_type_Long	J
  ...
  public static final List<String> a(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        aluu localaluu = (aluu)jdField_a_of_type_JavaUtilMap.get(localObject4);
        if (localaluu.jdField_a_of_type_Int >= paramInt)
        {
          if (paramBoolean) {}
          ...
          for (i = 300;; i = 50)
          {
            ...
            localStringBuilder.append(localaluu.jdField_a_of_type_JavaLangString).append("_").append((String)localObject4).append(":").append(localaluu.jdField_a_of_type_Int).append("\r\n");
            if (!paramBoolean) {
              break;
            }
            localObject4 = (Thread)((Map)localObject1).get(localaluu.jdField_a_of_type_JavaLangString);
  ...
  public static void a(aluu paramaluu)
  {
    paramaluu.recycle();
  }
  
  private static void a(String paramString, aluu paramaluu, boolean paramBoolean)
  {
    try
    {
      ...
      for (long l2 = ((Long)arrayOfObject[2]).longValue();; l2 = -100L)
      {
        if (paramBoolean)
        {
          paramaluu.jdField_a_of_type_Long = l1;
          paramaluu.jdField_b_of_type_Long = l2;
          paramaluu.jdField_a_of_type_JavaLangString = paramString;
          return;
        }
        if (paramaluu.jdField_a_of_type_Long == -100L)
        {
          paramaluu.c = -100L;
          paramaluu.d = -100L;
          return;
        }
        paramaluu.c = (l1 - paramaluu.jdField_a_of_type_Long);
        paramaluu.d = (l2 - paramaluu.jdField_b_of_type_Long);
        return;
        l1 = -100L;
        paramString = null;
      }
    ...
    if (paramBoolean)
    {
      ...
      if (arrayOfString != null)
      {
        ...
        while (i < j)
        {
          ...
          aluu localaluu = a();
          a(str, localaluu, true);
          jdField_a_of_type_JavaUtilMap.put(str, localaluu);
          i += 1;
        }
      }
    }
  ...
  public static Object[] a(String paramString)
  {
    ...
    //   1: istore_1
    //   2: aload_0
    //   3: invokestatic 343	alus:a	(Ljava/lang/String;)Ljava/io/RandomAccessFile;
    //   6: astore 21
    ...
    //   47: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   50: iload_3
    //   51: iload_2
    //   52: iastore
    //   53: iload_2
    ...
    //   64: getstatic 42	alus:jdField_b_of_type_ArrayOfInt	[I
    //   67: iload_3
    //   68: iload_1
    //   69: iastore
    //   70: goto +687 -> 757
    ...
    //   91: dup
    //   92: aload 22
    //   94: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   97: iconst_1
    //   98: iaload
    //   99: iconst_1
    //   100: iadd
    //   101: getstatic 42	alus:jdField_b_of_type_ArrayOfInt	[I
    //   104: iconst_1
    //   105: iaload
    //   106: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   109: iconst_1
    //   110: iaload
    //   111: isub
    //   112: iconst_1
    ...
    //   122: dup
    //   123: aload 22
    //   125: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   128: bipush 13
    //   130: iaload
    //   131: getstatic 42	alus:jdField_b_of_type_ArrayOfInt	[I
    //   134: bipush 13
    //   136: iaload
    //   137: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   140: bipush 13
    //   142: iaload
    //   143: isub
    ...
    //   155: dup
    //   156: aload 22
    //   158: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   161: bipush 15
    //   163: iaload
    //   164: getstatic 42	alus:jdField_b_of_type_ArrayOfInt	[I
    //   167: bipush 15
    //   169: iaload
    //   170: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   173: bipush 15
    //   175: iaload
    //   176: isub
    ...
    //   188: dup
    //   189: aload 22
    //   191: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   194: bipush 14
    //   196: iaload
    //   197: getstatic 42	alus:jdField_b_of_type_ArrayOfInt	[I
    //   200: bipush 14
    //   202: iaload
    //   203: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   206: bipush 14
    //   208: iaload
    //   209: isub
    ...
    //   221: dup
    //   222: aload 22
    //   224: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   227: bipush 16
    //   229: iaload
    //   230: getstatic 42	alus:jdField_b_of_type_ArrayOfInt	[I
    //   233: bipush 16
    //   235: iaload
    //   236: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   239: bipush 16
    //   241: iaload
    //   242: isub
    ...
    //   324: dup
    //   325: aload 22
    //   327: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   330: iconst_4
    //   331: iaload
    //   332: getstatic 42	alus:jdField_b_of_type_ArrayOfInt	[I
    //   335: iconst_4
    //   336: iaload
    //   337: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   340: iconst_4
    //   341: iaload
    //   342: isub
    ...
    //   354: dup
    //   355: aload 22
    //   357: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   360: iconst_1
    //   361: iaload
    //   362: getstatic 42	alus:jdField_b_of_type_ArrayOfInt	[I
    //   365: iconst_1
    //   366: iaload
    //   367: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   370: iconst_1
    //   371: iaload
    //   372: isub
    ...
    //   384: dup
    //   385: aload 22
    //   387: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   390: iconst_2
    //   391: iaload
    //   392: getstatic 42	alus:jdField_b_of_type_ArrayOfInt	[I
    //   395: iconst_2
    //   396: iaload
    //   397: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   400: iconst_2
    //   401: iaload
    //   402: isub
    ...
    //   414: dup
    //   415: aload 22
    //   417: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   420: iconst_3
    //   421: iaload
    //   422: getstatic 42	alus:jdField_b_of_type_ArrayOfInt	[I
    //   425: iconst_3
    //   426: iaload
    //   427: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   430: iconst_3
    //   431: iaload
    //   432: isub
    ...
    //   444: dup
    //   445: aload 22
    //   447: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   450: iconst_5
    //   451: iaload
    //   452: getstatic 42	alus:jdField_b_of_type_ArrayOfInt	[I
    //   455: iconst_5
    //   456: iaload
    //   457: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   460: iconst_5
    //   461: iaload
    //   462: isub
    ...
    //   474: dup
    //   475: aload 22
    //   477: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   480: bipush 6
    //   482: iaload
    //   483: getstatic 42	alus:jdField_b_of_type_ArrayOfInt	[I
    //   486: bipush 6
    //   488: iaload
    //   489: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   492: bipush 6
    //   494: iaload
    //   495: isub
    ...
    //   507: dup
    //   508: aload 22
    //   510: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   513: bipush 7
    //   515: iaload
    //   516: getstatic 42	alus:jdField_b_of_type_ArrayOfInt	[I
    //   519: bipush 7
    //   521: iaload
    //   522: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   525: bipush 7
    //   527: iaload
    //   528: isub
    ...
    //   540: dup
    //   541: aload 22
    //   543: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   546: bipush 8
    //   548: iaload
    //   549: getstatic 42	alus:jdField_b_of_type_ArrayOfInt	[I
    //   552: bipush 8
    //   554: iaload
    //   555: getstatic 40	alus:jdField_a_of_type_ArrayOfInt	[I
    //   558: bipush 8
    //   560: iaload
    //   561: isub
  ...
  private static final int b()
  {
    try
    {
      int i = new File("/sys/devices/system/cpu/").listFiles(new alut()).length;
      return i;
    }
    catch (Exception localException) {}
    return 1;
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject1 != null)
        {
          ...
          a("-1", jdField_a_of_type_Aluu, false);
          if (paramBoolean)
          {
            ...
            if (((Iterator)localObject1).hasNext())
            {
              ...
              aluu localaluu = (aluu)jdField_a_of_type_JavaUtilMap.get(str);
              a(str, localaluu, false);
              localaluu.jdField_a_of_type_Int = ((int)(100L * (localaluu.d + localaluu.c) / l1));
              continue;
            }
          }
        }
      ...
      catch (Exception localException)
      {
        ...
        jdField_a_of_type_Aluu.jdField_a_of_type_Int = ((int)(100L * (jdField_a_of_type_Aluu.d + jdField_a_of_type_Aluu.c) / l1));
