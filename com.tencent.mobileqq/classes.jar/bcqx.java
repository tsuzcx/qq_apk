  ...
  extends bcqq
{
  ...
  public bcqx(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong1, PubAccountNavigationMenu paramPubAccountNavigationMenu, long paramLong2)
  {
    ...
    try
    {
      ...
      for (int i = 0;; i = paramPubAccountNavigationMenu.version)
      {
        ...
        ((subcmd0x519.CRMMsgHead)localObject1).uint32_ver_no.set(bcrh.a("8.2.6"));
  ...
  private void a(atmp paramatmp)
  {
    if (paramatmp != null)
    {
      paramatmp = paramatmp.a(PubAccountNavigationMenu.class);
      if (paramatmp != null)
      {
        paramatmp = paramatmp.iterator();
        while (paramatmp.hasNext())
        {
          PubAccountNavigationMenu localPubAccountNavigationMenu = (PubAccountNavigationMenu)paramatmp.next();
          if (QLog.isColorLevel()) {
  ...
  public void a(long paramLong)
  {
    if (!jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
      ...
      if (localObject != null)
      {
        localObject = (PubAccountNavigationMenu)((atmp)localObject).a(PubAccountNavigationMenu.class, new String[] { String.valueOf(paramLong) });
        if (localObject != null) {
