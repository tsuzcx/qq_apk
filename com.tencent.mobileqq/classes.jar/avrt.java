  ...
  extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
  ...
  public avrt(HiBoomPanelView paramHiBoomPanelView)
  {
  ...
  {
    avru localavru;
    if ((paramViewHolder instanceof avru))
    {
      localavru = (avru)paramViewHolder;
      localavru.jdField_a_of_type_Int = paramInt;
      if (localavru.jdField_a_of_type_Boolean) {
        break label41;
      }
    }
    for (;;)
    {
      ...
      label41:
      int i = a(paramInt);
      ViewGroup.LayoutParams localLayoutParams = localavru.itemView.getLayoutParams();
      localLayoutParams.height = HiBoomPanelView.jdField_a_of_type_Int;
      localLayoutParams.width = HiBoomPanelView.b;
      localavru.itemView.setPadding(0, 0, HiBoomPanelView.c, HiBoomPanelView.c);
      localLayoutParams = localavru.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomTextView.getLayoutParams();
      ...
      this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.a(localavru, i);
    }
  }
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    try
    {
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.getContext()).inflate(2131563099, paramViewGroup, false);
      localObject = paramViewGroup;
      if (paramViewGroup == null) {
        localObject = new View(this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.getContext());
      }
      return new avru(this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView, (View)localObject, bool);
    }
