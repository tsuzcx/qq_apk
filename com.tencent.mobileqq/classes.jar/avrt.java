...
public class avrt
{
  ...
  HashMap<Integer, avrx> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  public List<avsp> a;
  String d;
  String e;
  ...
  private avsb a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, axdh paramaxdh)
  {
    avsb localavsb = new avsb();
    localavsb.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo = paramPtvTemplateInfo;
    localavsb.jdField_a_of_type_Axdh = paramaxdh;
    paramaxdh = new avsa();
    paramaxdh.jdField_a_of_type_JavaLangString = paramPtvTemplateInfo.dgStageName;
    paramaxdh.jdField_b_of_type_JavaLangString = paramPtvTemplateInfo.dgStageResmd5;
    paramaxdh.jdField_c_of_type_JavaLangString = paramPtvTemplateInfo.dgStageResurl;
    paramaxdh.jdField_a_of_type_Boolean = paramPtvTemplateInfo.dgStageUsable;
    paramaxdh.jdField_b_of_type_Boolean = false;
    localavsb.jdField_a_of_type_JavaUtilArrayList.add(paramaxdh);
    paramaxdh = new avsa();
    paramaxdh.jdField_a_of_type_JavaLangString = paramPtvTemplateInfo.dgModelName;
    paramaxdh.jdField_b_of_type_JavaLangString = paramPtvTemplateInfo.dgModelResmd5;
    paramaxdh.jdField_c_of_type_JavaLangString = paramPtvTemplateInfo.dgModelResurl;
    paramaxdh.jdField_a_of_type_Boolean = paramPtvTemplateInfo.dgModelUsable;
    paramaxdh.jdField_b_of_type_Boolean = false;
    localavsb.jdField_a_of_type_JavaUtilArrayList.add(paramaxdh);
    paramaxdh = new avsa();
    paramaxdh.jdField_a_of_type_JavaLangString = paramPtvTemplateInfo.name;
    paramaxdh.jdField_b_of_type_JavaLangString = paramPtvTemplateInfo.md5;
    paramaxdh.jdField_c_of_type_JavaLangString = paramPtvTemplateInfo.resurl;
    paramaxdh.jdField_a_of_type_Boolean = paramPtvTemplateInfo.usable;
    paramaxdh.jdField_b_of_type_Boolean = true;
    localavsb.jdField_a_of_type_JavaUtilArrayList.add(paramaxdh);
    localavsb.jdField_a_of_type_Int = 3;
    return localavsb;
  }
  ...
  public static List<avsp> a(avrt paramavrt, String paramString, CaptureRedDotConfig paramCaptureRedDotConfig)
  {
    int i = 0;
      ...
      try
      {
        ...
        if (paramavrt != null)
        {
          if (localJSONObject.has("guide_video_url")) {
            paramavrt.d = localJSONObject.getString("guide_video_url");
          }
          if (localJSONObject.has("guide_video_md5")) {
            paramavrt.e = localJSONObject.getString("guide_video_md5");
          }
          if (localJSONObject.has("gestureGapFrame")) {
            bflp.jdField_a_of_type_JavaLangString = localJSONObject.getString("gestureGapFrame");
          }
          if (localJSONObject.has("gestureGapTime")) {
            bflp.jdField_b_of_type_JavaLangString = localJSONObject.getString("gestureGapTime");
          }
          if (localJSONObject.has("gesturethreadcoldtime")) {
            bflp.jdField_c_of_type_JavaLangString = localJSONObject.getString("gesturethreadcoldtime");
          }
          if (localJSONObject.has("gestureShouldUpload")) {
            bflp.jdField_a_of_type_Boolean = localJSONObject.getBoolean("gestureShouldUpload");
          }
        }
        Object localObject1 = "";
        Object localObject2 = "";
        ...
        if (localJSONObject.has("bigheadCommonRes"))
        {
          ...
          {
            paramavrt = ((JSONObject)localObject3).optString("bighead_model_name", "");
        ...
        a(paramCaptureRedDotConfig, paramavrt, str1, paramString);
        return paramCaptureRedDotConfig;
      }
      catch (JSONException paramavrt) {}
      if (!QLog.isColorLevel()) {
        break;
      }
      paramavrt.printStackTrace();
      return null;
      label865:
      i += 1;
    }
  ...
  static List<avsp> a(JSONArray paramJSONArray, CaptureRedDotConfig paramCaptureRedDotConfig)
  {
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((JSONObject)localObject3).has("content")) {
          localavsp.jdField_a_of_type_JavaUtilList = PtvTemplateManager.PtvTemplateInfo.convertFrom(((JSONObject)localObject3).getJSONArray("content"));
        }
        if (((JSONObject)localObject3).has("categoryName")) {
          localavsp.jdField_a_of_type_JavaLangString = ((JSONObject)localObject3).getString("categoryName");
        }
        if (((JSONObject)localObject3).has("GetRedBag"))
        {
          ...
          {
            bool = true;
            localavsp.jdField_a_of_type_Boolean = bool;
            axjq.a((JSONObject)localObject3);
          }
        }
        else
        {
          ...
          {
            localavsp.jdField_b_of_type_Int = ((JSONObject)localObject3).getInt("TipsVer");
            localavsp.jdField_b_of_type_JavaLangString = ((JSONObject)localObject3).getString("Tips");
          }
          if (!((JSONObject)localObject3).has("categoryId")) {
            break label488;
          }
          localavsp.jdField_a_of_type_Int = ((JSONObject)localObject3).getInt("categoryId");
          if (paramCaptureRedDotConfig == null) {
            break label711;
          }
          k = ((JSONObject)localObject3).optInt("redDotVersion");
          bool = ((JSONObject)localObject3).optBoolean("needRedDot");
          localObject1 = (CaptureRedDotConfig.CategoryRedConfig)paramCaptureRedDotConfig.categories.get(Integer.valueOf(localavsp.jdField_a_of_type_Int));
          ...
          if ((localavsp.jdField_a_of_type_JavaUtilList == null) || (localavsp.jdField_a_of_type_JavaUtilList.isEmpty())) {
            break label461;
          }
          localObject4 = localavsp.jdField_a_of_type_JavaUtilList.iterator();
          if (!((Iterator)localObject4).hasNext()) {
            break label461;
          }
          localObject5 = (PtvTemplateManager.PtvTemplateInfo)((Iterator)localObject4).next();
          ((PtvTemplateManager.PtvTemplateInfo)localObject5).categoryId = localavsp.jdField_a_of_type_Int;
          ((PtvTemplateManager.PtvTemplateInfo)localObject5).categoryName = localavsp.jdField_a_of_type_JavaLangString;
          continue;
      ...
      ((CaptureRedDotConfig.CategoryRedConfig)localObject1).categoryId = localavsp.jdField_a_of_type_Int;
      ((CaptureRedDotConfig.CategoryRedConfig)localObject1).version = k;
      ((CaptureRedDotConfig.CategoryRedConfig)localObject1).showRedDot = bool;
      continue;
      label461:
      ...
      if (bool) {
        try
        {
          ...
          if (localavsp.jdField_a_of_type_JavaUtilList != null)
          {
            Iterator localIterator = localavsp.jdField_a_of_type_JavaUtilList.iterator();
  ...
  private void a(avsb paramavsb)
  {
    avrx localavrx2 = (avrx)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramavsb.jdField_a_of_type_Int));
    avrx localavrx1 = localavrx2;
    if (localavrx2 == null)
    {
      localavrx1 = new avrx();
      this.jdField_a_of_type_JavaUtilHashMap.put(Integer.valueOf(paramavsb.jdField_a_of_type_Int), localavrx1);
    }
    localavrx1.b.add(paramavsb);
  }
  
  private void a(avsb paramavsb, avsa paramavsa, long paramLong1, long paramLong2)
  {
    if ((paramavsb == null) || (paramavsa == null)) {}
    do
    {
      avrx localavrx;
      do
      {
        return;
        localavrx = (avrx)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramavsb.jdField_a_of_type_Int));
        if (localavrx != null) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.e("CapturePtvTemplateManager", 2, "multiSessionDownloadProcessUpdate: BusinessParam=null  kind=" + paramavsb.jdField_a_of_type_Int + " mItem.mName=" + paramavsa.jdField_a_of_type_JavaLangString);
      return;
      paramavsa.jdField_a_of_type_Long = paramLong1;
      paramavsa.jdField_b_of_type_Long = paramLong2;
      paramavsa.jdField_c_of_type_Boolean = true;
      paramLong2 = 0L;
      paramLong1 = 1L;
      paramavsa = paramavsb.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (paramavsa.hasNext())
      {
        avsa localavsa = (avsa)paramavsa.next();
        if (!localavsa.jdField_a_of_type_Boolean)
        {
          localavsa = (avsa)localavrx.jdField_a_of_type_JavaUtilHashMap.get(localavsa.jdField_a_of_type_JavaLangString);
          if (localavsa != null) {
            if (localavsa.jdField_c_of_type_Boolean)
            {
              paramLong2 += localavsa.jdField_a_of_type_Long;
              paramLong1 += localavsa.jdField_b_of_type_Long;
            }
            else
            {
              paramLong1 += 1000L;
    ...
    } while (paramavsb.jdField_a_of_type_Axdh == null);
    paramavsb.jdField_a_of_type_Axdh.a(paramavsb.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo, (int)(paramLong2 * 100L / paramLong1));
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        ((ayrv)localObject3).jdField_a_of_type_Aysa = new avru(this, paramString, (String)localObject2, paramQQAppInterface, str);
        ((ayrv)localObject3).jdField_a_of_type_JavaLangString = ((String)???);
        ((ayrv)localObject3).jdField_a_of_type_Int = 0;
        ((ayrv)localObject3).jdField_c_of_type_JavaLangString = localFile.getPath();
        ((ayrv)localObject3).jdField_c_of_type_Int = bbev.a(aysy.a().a());
        try
        {
          ...
          ((QQAppInterface)paramQQAppInterface).getNetEngine(0).a((aysw)localObject3);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  private void a(File paramFile, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      a();
    } while (this.jdField_a_of_type_Avrz == null);
    this.jdField_a_of_type_Avrz.a();
  }
  ...
  private static void a(List<avsp> paramList, String paramString1, String paramString2, String paramString3)
  {
    ...
    {
      Object localObject = (avsp)paramList.next();
      if ((((avsp)localObject).jdField_a_of_type_JavaUtilList == null) || (((avsp)localObject).jdField_a_of_type_JavaUtilList.size() <= 0)) {
        break;
      }
      localObject = ((avsp)localObject).jdField_a_of_type_JavaUtilList.iterator();
  ...
  private boolean a(avsb paramavsb)
  {
    avrx localavrx = (avrx)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramavsb.jdField_a_of_type_Int));
    if (localavrx != null)
    {
      if (localavrx.jdField_a_of_type_JavaUtilArrayList.size() == 0) {
        return true;
      }
      paramavsb = paramavsb.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (paramavsb.hasNext())
      {
        avsa localavsa = (avsa)paramavsb.next();
        if (!localavrx.jdField_a_of_type_JavaUtilArrayList.contains(localavsa.jdField_a_of_type_JavaLangString)) {}
        for (int i = 1; i == 0; i = 0) {
          return false;
        }
      }
  ...
  private boolean a(avsb paramavsb, avsa paramavsa)
  {
    if ((paramavsb == null) || (paramavsa == null)) {
      return false;
    }
    ...
    if (localavrx != null)
    {
      localavrx.jdField_a_of_type_JavaUtilArrayList.remove(paramavsa.jdField_a_of_type_JavaLangString);
      if (a(paramavsb))
      {
        paramavsb.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.usable = a(paramavsb.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo);
        paramavsa = this.jdField_a_of_type_JavaUtilList.iterator();
        while (paramavsa.hasNext())
        {
          Object localObject = (avsp)paramavsa.next();
          if (((avsp)localObject).jdField_a_of_type_JavaUtilList != null)
          {
            localObject = ((avsp)localObject).jdField_a_of_type_JavaUtilList.iterator();
            while (((Iterator)localObject).hasNext())
            {
              PtvTemplateManager.PtvTemplateInfo localPtvTemplateInfo = (PtvTemplateManager.PtvTemplateInfo)((Iterator)localObject).next();
              if (localPtvTemplateInfo.id.equals(paramavsb.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id)) {
                localPtvTemplateInfo.usable = a(localPtvTemplateInfo);
              } else if (paramavsb.jdField_a_of_type_Int == localPtvTemplateInfo.kind) {
                localPtvTemplateInfo.usable = a(localPtvTemplateInfo);
              }
            }
          }
        }
        if (paramavsb.jdField_a_of_type_Axdh != null) {
          paramavsb.jdField_a_of_type_Axdh.a(paramavsb.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo, paramavsb.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.usable);
        }
        if (localavrx.jdField_a_of_type_JavaUtilArrayList.size() == 0) {
          localavrx.jdField_a_of_type_JavaUtilHashMap.clear();
        }
        return true;
      }
    }
  ...
  public static boolean a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        try
        {
          Object localObject = bbdj.c(localFile.getPath());
          int j = i;
          ...
          if (i != 0)
          {
            ...
            try
            {
              nay.a(localFile, a(paramString2));
              return true;
            }
  ...
  private avsb b(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, axdh paramaxdh)
  {
    avsb localavsb = new avsb();
    localavsb.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo = paramPtvTemplateInfo;
    localavsb.jdField_a_of_type_Axdh = paramaxdh;
    paramaxdh = new avsa();
    paramaxdh.jdField_a_of_type_JavaLangString = paramPtvTemplateInfo.bigHeadName;
    paramaxdh.jdField_b_of_type_JavaLangString = paramPtvTemplateInfo.bigHeadMd5;
    paramaxdh.jdField_c_of_type_JavaLangString = paramPtvTemplateInfo.bigHeadUrl;
    paramaxdh.jdField_a_of_type_Boolean = paramPtvTemplateInfo.bigHeadModelUsable;
    paramaxdh.jdField_b_of_type_Boolean = false;
    localavsb.jdField_a_of_type_JavaUtilArrayList.add(paramaxdh);
    paramaxdh = new avsa();
    paramaxdh.jdField_a_of_type_JavaLangString = paramPtvTemplateInfo.name;
    ...
    paramaxdh.jdField_b_of_type_Boolean = true;
    localavsb.jdField_a_of_type_JavaUtilArrayList.add(paramaxdh);
    localavsb.jdField_a_of_type_Int = 20;
    return localavsb;
  }
  
  private void b(avsb paramavsb)
  {
    avrx localavrx = (avrx)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramavsb.jdField_a_of_type_Int));
    if (localavrx != null) {
      localavrx.b.remove(paramavsb);
    }
  }
  
  private boolean b()
  {
    return (this.jdField_a_of_type_Avsp != null) && (this.jdField_a_of_type_Avsp.jdField_a_of_type_JavaUtilList.size() >= 30);
  }
  
  private ArrayList<avsp> c()
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.addAll(this.jdField_a_of_type_JavaUtilList);
    boolean bool1 = axgm.c();
    boolean bool2 = axkg.c();
    ...
    if ((!bool1) || (!bool2) || (!bool3))
    {
      ...
      {
        avsp localavsp = (avsp)localIterator1.next();
        List localList = localavsp.jdField_a_of_type_JavaUtilList;
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("CapturePtvTemplateManager", 2, "should hide dg tab! isQmcfEnableEntry=" + bool1 + " isFaceDanceEnableEntry=" + bool2 + " categoryID=" + localavsp.jdField_a_of_type_Int);
          }
          localIterator1.remove();
        }
      }
      avtd.a().a(bool1, bool2);
    }
    return localArrayList;
  }
  ...
  private void c()
  {
    ...
    {
      Object localObject2 = (avsp)((Iterator)localObject1).next();
      int k = i;
      int m = j;
      if (((avsp)localObject2).jdField_a_of_type_JavaUtilList != null)
      {
        Object localObject3 = new ArrayList();
        ((List)localObject3).addAll(((avsp)localObject2).jdField_a_of_type_JavaUtilList);
      ...
      for (;;)
      {
        ...
        if (((File)localObject).exists()) {
          ...
          catch (UnsatisfiedLinkError paramString1)
          {
            try
            {
              nay.a(new File(jdField_a_of_type_JavaIoFile, paramString1), jdField_a_of_type_JavaLangString);
              return true;
            }
            catch (Exception paramString1) {}
      ...
      while (i < localObject1.length)
      {
        ...
        if ((localObject2 != null) && (localObject2.length == 2))
        {
          ...
          if (localObject2 != null) {
            paramavsp.jdField_a_of_type_JavaUtilList.add(localObject2);
          }
        }
        i += 1;
      }
    ...
    do
    {
      ...
      while (!((Iterator)localObject).hasNext())
      {
        do
        {
          ...
          localObject = (avsp)localIterator.next();
        } while ((((avsp)localObject).jdField_a_of_type_Int != paramInt) || (((avsp)localObject).jdField_a_of_type_JavaUtilList == null));
        localObject = ((avsp)localObject).jdField_a_of_type_JavaUtilList.iterator();
      }
  ...
  public void a(AppInterface paramAppInterface, avsb paramavsb)
  {
    if ((paramavsb.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo == null) || (paramAppInterface == null)) {}
    label98:
    label99:
    for (;;)
    {
      return;
      if ((paramavsb.jdField_a_of_type_JavaUtilArrayList != null) && (paramavsb.jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        a(paramavsb);
        Iterator localIterator = paramavsb.jdField_a_of_type_JavaUtilArrayList.iterator();
        int i = 0;
        if (localIterator.hasNext())
        {
          avsa localavsa = (avsa)localIterator.next();
          if (localavsa.jdField_a_of_type_Boolean) {
            break label98;
          }
          a(paramAppInterface, paramavsb, localavsa);
          i = 1;
        }
        for (;;)
        {
  ...
  public void a(AppInterface paramAppInterface, avsb paramavsb, avsa paramavsa)
  {
    Object localObject = (avrx)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramavsb.jdField_a_of_type_Int));
    if (localObject == null) {
      if (QLog.isColorLevel()) {
        QLog.e("CapturePtvTemplateManager", 2, "[BG]downloadSessionTemplateItem url: businessParam = null kind=" + paramavsb.jdField_a_of_type_Int);
      }
    }
    for (;;)
    {
      return;
      if (TextUtils.isEmpty(paramavsa.jdField_a_of_type_JavaLangString)) {
        continue;
      }
      if (((avrx)localObject).jdField_a_of_type_JavaUtilHashMap.get(paramavsa.jdField_a_of_type_JavaLangString) != null)
      {
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.i("CapturePtvTemplateManager", 2, "[BG]downloadSessionTemplateItem[no need download] url: " + paramavsa.jdField_c_of_type_JavaLangString + " item.mName=" + paramavsa.jdField_a_of_type_JavaLangString);
        return;
      }
      ((avrx)localObject).jdField_a_of_type_JavaUtilHashMap.put(paramavsa.jdField_a_of_type_JavaLangString, paramavsa);
      ((avrx)localObject).jdField_a_of_type_JavaUtilArrayList.add(paramavsa.jdField_a_of_type_JavaLangString);
      localObject = new ayrv();
      ((ayrv)localObject).jdField_a_of_type_Aysa = new avsc(this, paramavsb, paramavsa);
      ((ayrv)localObject).jdField_a_of_type_JavaLangString = paramavsa.jdField_c_of_type_JavaLangString;
      ((ayrv)localObject).jdField_a_of_type_Int = 0;
      ((ayrv)localObject).jdField_c_of_type_JavaLangString = new File(jdField_a_of_type_JavaIoFile, paramavsa.jdField_a_of_type_JavaLangString).getPath();
      ((ayrv)localObject).a(paramavsa);
      ((ayrv)localObject).jdField_c_of_type_Int = bbev.a(aysy.a().a());
      try
      {
        paramAppInterface.getNetEngine(0).a((aysw)localObject);
        if (!QLog.isColorLevel()) {
          continue;
        }
        QLog.i("CapturePtvTemplateManager", 2, "downloadSessionTemplateItem url: " + paramavsa.jdField_c_of_type_JavaLangString);
        return;
      }
  ...
  public void a(AppInterface paramAppInterface, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, axdh paramaxdh)
  {
    ...
    {
      a(paramAppInterface, a(paramPtvTemplateInfo, paramaxdh));
      return;
    }
    if (paramPtvTemplateInfo.kind == 20)
    {
      a(paramAppInterface, b(paramPtvTemplateInfo, paramaxdh));
      return;
    }
    b(paramAppInterface, paramPtvTemplateInfo, paramaxdh);
  }
  ...
  public void a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_Avsp = new avsp(ajyc.a(2131701354));
      this.jdField_a_of_type_Avsp.jdField_a_of_type_JavaUtilList = new ArrayList(30);
      a(this.jdField_a_of_type_Avsp);
    }
    for (;;)
    {
      return;
      int i = 0;
      int j = -1;
      while (i < this.jdField_a_of_type_Avsp.jdField_a_of_type_JavaUtilList.size())
      {
        if (((PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_Avsp.jdField_a_of_type_JavaUtilList.get(i)).id.equals(paramPtvTemplateInfo.id)) {
          j = i;
        }
        i += 1;
      }
      if (j == -1) {
        if (!b())
        {
          this.jdField_a_of_type_Avsp.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
          a(paramInt, this.jdField_a_of_type_Avsp);
          if (QLog.isColorLevel()) {
      ...
      while (QLog.isColorLevel())
      {
        ...
        return;
        this.jdField_a_of_type_Avsp.jdField_a_of_type_JavaUtilList.remove(29);
        this.jdField_a_of_type_Avsp.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
        a(paramInt, this.jdField_a_of_type_Avsp);
        continue;
        if (j != 0)
        {
          this.jdField_a_of_type_Avsp.jdField_a_of_type_JavaUtilList.remove(j);
          this.jdField_a_of_type_Avsp.jdField_a_of_type_JavaUtilList.add(0, paramPtvTemplateInfo);
          a(paramInt, this.jdField_a_of_type_Avsp);
        }
      }
  ...
  public void a(List<avsp> paramList)
  {
    ...
    do
    {
      ...
      localList = ((avsp)paramList.next()).jdField_a_of_type_JavaUtilList;
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        localayrv.jdField_a_of_type_Aysa = new avrv(this, localPtvTemplateInfo);
        localayrv.jdField_a_of_type_JavaLangString = localPtvTemplateInfo.resurl;
        localayrv.jdField_a_of_type_Int = 0;
        localayrv.jdField_c_of_type_JavaLangString = new File(jdField_b_of_type_JavaIoFile, localPtvTemplateInfo.md5).getPath();
        ...
        try
        {
          ...
          if ((localAppRuntime != null) && ((localAppRuntime instanceof ToolRuntimePeak)))
          {
            ...
            {
              ((PeakAppInterface)localAppRuntime).getNetEngine(0).a(localayrv);
              if (QLog.isColorLevel()) {
  ...
  public void a(List<avsp> paramList, boolean paramBoolean)
  {
    if ((paramList == null) || (paramList.isEmpty())) {}
    for (;;)
    {
  ...
  public ArrayList<avsp> b()
  {
    ArrayList localArrayList = a();
    if (this.jdField_a_of_type_Avsp == null)
    {
      this.jdField_a_of_type_Avsp = new avsp(ajyc.a(2131701353));
      this.jdField_a_of_type_Avsp.jdField_a_of_type_JavaUtilList = new ArrayList(30);
      a(this.jdField_a_of_type_Avsp);
    }
    localArrayList.add(0, this.jdField_a_of_type_Avsp);
    if (QLog.isColorLevel()) {
  ...
  public void b(AppInterface paramAppInterface, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, axdh paramaxdh)
  {
    ...
    for (;;)
    {
      return;
      ayrv localayrv = new ayrv();
      localayrv.jdField_a_of_type_Aysa = new avrw(this, paramPtvTemplateInfo, paramaxdh);
      localayrv.jdField_a_of_type_JavaLangString = paramPtvTemplateInfo.resurl;
      localayrv.jdField_a_of_type_Int = 0;
      localayrv.jdField_c_of_type_JavaLangString = new File(jdField_b_of_type_JavaIoFile, paramPtvTemplateInfo.md5).getPath();
      localayrv.jdField_c_of_type_Int = bbev.a(aysy.a().a());
      try
      {
