...
public class aash
  extends aasw
  implements aimc, Handler.Callback
{
  private int jdField_a_of_type_Int;
  aima jdField_a_of_type_Aima;
  public Context a;
  ...
  private void a(LinkedHashMap<String, List<Object>> paramLinkedHashMap)
  {
    ...
    while (paramLinkedHashMap.hasNext()) {
      Collections.sort((List)paramLinkedHashMap.next(), new aasi(this));
    }
  }
    ...
    if (paramJSONObject != null)
    {
      ...
      if (ayfx.a(paramJSONObject))
      {
        ...
        while (paramJSONObject.hasNext())
        {
          ...
          String str = apvw.a(localTencentDocData.aioTime);
  ...
  private void i()
  {
    ...
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new aasj(this);
  }
  ...
  private void j()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new aask(this);
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Aoun = new aasn(this);
  ...
  public void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    this.jdField_a_of_type_Aima = new aima(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaUtilList, this.jdField_b_of_type_AndroidViewView$OnClickListener, this.jdField_a_of_type_AndroidViewView$OnClickListener, this);
    this.jdField_a_of_type_Aima.a(this);
    this.jdField_a_of_type_AndroidViewView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131560462, null);
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369318));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131370886));
    this.jdField_a_of_type_ComTencentWidgetXListView.setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Aima);
    paramIntent = this.jdField_a_of_type_AndroidViewView.findViewById(2131366241);
    paramQQAppInterface = paramIntent.findViewById(2131372798);
  ...
  public void a(TencentDocData paramTencentDocData)
  {
    ...
    for (;;)
    {
      ...
      continue;
      ayfx.a(paramTencentDocData.docUrl, this.jdField_a_of_type_AndroidContentContext);
      apue.a("0X8009A9F");
    }
  }
  ...
  public void a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (a()) {
      if (this.jdField_a_of_type_ComTencentMobileqqActivityChatHistoryFileActivity.a(paramFileManagerEntity))
      {
        ...
        {
          aptx.a(apug.d(paramFileManagerEntity.fileName) + ajya.a(2131701601));
          this.jdField_a_of_type_ComTencentMobileqqActivityChatHistoryFileActivity.b(paramFileManagerEntity);
        }
        this.jdField_a_of_type_Aima.notifyDataSetChanged();
      }
    ...
    apue.a("0X8004AE4");
    localObject = new apoi(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramFileManagerEntity, 10001);
  ...
  public void d()
  {
    ...
    this.jdField_a_of_type_Aima.a(true);
    this.jdField_a_of_type_Aima.notifyDataSetChanged();
  }
  ...
  public void e()
  {
    ...
    this.jdField_a_of_type_Aima.a(false);
    this.jdField_a_of_type_Aima.notifyDataSetChanged();
  }
