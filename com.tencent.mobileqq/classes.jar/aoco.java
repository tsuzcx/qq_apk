  ...
  extends amno
{
  ...
  public aoco(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  public ColorNote a(String paramString1, String paramString2, String paramString3, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((Modifier.isStatic(((Field)localObject).getModifiers())) || (((Field)localObject).isAnnotationPresent(awhp.class))) {
          break label381;
        }
  ...
  public ArrayList<ColorNote> a(String paramString, amnx paramamnx)
  {
    return a(paramString, paramamnx, 0);
  }
  
  public ArrayList<ColorNote> a(String arg1, amnx paramamnx, int paramInt)
  {
    paramamnx = new ArrayList();
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localColorNote.mExtra == paramInt) {
          paramamnx.add(localColorNote);
        }
      }
    }
    this.jdField_a_of_type_JavaUtilList.removeAll(paramamnx);
    a(paramamnx);
    return paramamnx;
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localColorNote.getServiceType() == 16973824) {
          if ((localArrayList.size() > 0) && (aocr.b((ColorNote)localArrayList.get(0)))) {
  ...
  public List<ColorNote> a(boolean paramBoolean, int paramInt)
  {
    try
    {
      ...
      {
        localList = this.jdField_a_of_type_Awgf.a(ColorNote.class);
  ...
  protected void a()
  {
    ...
    Object localObject = this.jdField_a_of_type_Awgf.a(ColorNote.class, true, null, null, null, null, null, null);
    if ((localObject != null) && (!((List)localObject).isEmpty()))
    {
      this.jdField_a_of_type_JavaUtilList = ((List)localObject);
      aofm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), false, false);
    }
    localObject = aobu.a();
    if ((localObject != null) && (((aobt)localObject).a() != -1))
    {
      jdField_a_of_type_Int = ((aobt)localObject).a();
      if (QLog.isColorLevel()) {
  ...
  protected void a(ColorNote paramColorNote)
  {
    if (this.jdField_a_of_type_Awgf != null) {
      this.jdField_a_of_type_Awgf.a(paramColorNote);
    }
  }
  ...
  public void a(String arg1, ColorNote paramColorNote, amnx paramamnx)
  {
  ...
  public void a(String paramString, ColorNote paramColorNote, amnx paramamnx, boolean paramBoolean)
  {
    if ((!a(paramColorNote)) && (aofm.a())) {
      if (paramColorNote.getServiceType() == 16973824) {
        azqs.b(null, "dc00898", "", "", "0X800A746", "0X800A746", 0, 0, "", "", "", "");
      }
    }
    while (!QLog.isColorLevel()) {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        if (aocr.b(paramColorNote))
        {
          ...
          if (paramColorNote.getServiceType() != 16973824) {
            b(paramString, paramColorNote, paramamnx, paramBoolean);
          }
          return;
        }
    ...
    QLog.e("ColorNoteProxy", 2, "addColorNote error! isAfterSyncMsg = " + aofm.a());
  }
  ...
  protected void b(String paramString, ColorNote paramColorNote, amnx paramamnx, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      b(paramColorNote);
