  ...
  extends ayjm
{
  ...
  static
  {
    jdField_c_of_type_JavaLangString = "Q.uniteSearch." + ayju.class.getName();
  }
  
  public ayju(String paramString, long paramLong, List<String> paramList, UnifySearchCommon.ResultItem paramResultItem, int paramInt)
  {
    ...
    this.b = paramList;
    this.g = paramString;
    this.jdField_a_of_type_Ayqs = new ayqs(paramList, a());
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      a(this.jdField_a_of_type_JavaLangString);
    }
  }
  
  public ayju(String paramString, long paramLong, List<String> paramList, DynamicSearch.ResultItem paramResultItem, int paramInt)
  {
    if (paramResultItem != null)
    {
      this.d = paramResultItem.result_id.get().toStringUtf8();
  ...
  public void a(View paramView)
  {
    ...
    try
    {
      ...
      if ((this instanceof ayki)) {
        localObject1 = "clk_more";
      }
      aynt.a(null, new ReportModelDC02528().module("all_result").action((String)localObject1).obj1(this.jdField_a_of_type_Long + "").obj2(localaydx.jdField_b_of_type_JavaLangString).ver1(this.g).ver2(aynt.a(this.jdField_c_of_type_Int)).ver7(localJSONObject.toString()).session_id(localQQAppInterface.getCurrentAccountUin() + aydw.jdField_a_of_type_Long));
      if (aydw.jdField_a_of_type_JavaUtilHashMap.containsKey(this))
      {
        localObject1 = (aydx)aydw.jdField_a_of_type_JavaUtilHashMap.get(this);
        if (((aydx)localObject1).jdField_b_of_type_Boolean)
        {
          j = 2;
          ayrd.a("all_result", "clk_object", j, 0, new String[] { this.g, "" + this.jdField_a_of_type_Long, ((aydx)localObject1).jdField_b_of_type_JavaLangString + "", ((aydx)localObject1).jdField_a_of_type_Int + "" });
        }
      }
      else
      {
        ...
        localObject1 = bdds.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramView.getContext(), (String)localObject3);
    ...
    catch (JSONException localJSONException)
    {
      ...
      do
      {
        ...
        {
          ayrd.a(paramView.getContext(), Integer.valueOf(this.d).intValue(), -1);
          return;
        }
        ...
        if (this.jdField_a_of_type_Long == 536870912L)
        {
          ...
          try
          {
            ...
            ume.a(paramView.getContext(), 24, l1);
            return;
          }
      ...
      bclo.a(paramView.getContext(), localBundle, 2);
    }
  }
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    this.jdField_a_of_type_Ayjv.jdField_a_of_type_JavaLangString = paramJSONObject.optString("imageUrl");
    this.jdField_a_of_type_Ayjv.jdField_a_of_type_Int = a(j);
    this.jdField_a_of_type_Ayjv.jdField_b_of_type_Int = paramJSONObject.optInt("cornerRadius");
    ayjv localayjv = this.jdField_a_of_type_Ayjv;
    if (paramJSONObject.optInt("needPlayIcon") == 1) {}
    for (;;)
    {
      localayjv.jdField_a_of_type_Boolean = bool;
      this.jdField_a_of_type_Ayjv.jdField_a_of_type_JavaLangCharSequence = paramJSONObject.optString("topLeftTagText");
      this.jdField_a_of_type_Ayjv.jdField_b_of_type_JavaLangString = paramJSONObject.optString("topLeftTagColor");
      this.jdField_a_of_type_Ayjv.jdField_b_of_type_JavaLangCharSequence = paramJSONObject.optString("bottomRightText");
      this.jdField_a_of_type_Ayjv.jdField_c_of_type_JavaLangString = paramJSONObject.optString("bottomRightIconUrl");
      this.jdField_a_of_type_Ayjv.jdField_c_of_type_JavaLangCharSequence = paramJSONObject.optString("bottomRightIconText");
      this.jdField_a_of_type_Ayjv.d = paramJSONObject.optInt("imageHeight");
      this.jdField_a_of_type_Ayjv.jdField_c_of_type_Int = paramJSONObject.optInt("imageWidth");
      return;
      bool = false;
    }
  }
