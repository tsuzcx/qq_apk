...
public class ayju
{
  ...
  {
    this.jdField_a_of_type_Float = paramayju.jdField_a_of_type_Float;
    this.b = paramayju.b;
    this.c = paramayju.c;
    this.d = paramayju.d;
    this.jdField_a_of_type_AndroidGraphicsMatrix.set(paramayju.jdField_a_of_type_AndroidGraphicsMatrix);
  }
