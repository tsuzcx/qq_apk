...
{
  public jyn(MultiVideoCtrlLayerUI4Discussion paramMultiVideoCtrlLayerUI4Discussion) {}
  ...
  protected void a(int paramInt, String paramString)
  {
    ...
    if (this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)
    {
      ...
      this.a.jdField_a_of_type_Jzh.a(paramInt, paramString);
      this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(this.a.jdField_a_of_type_Jzh, 500L);
    }
  }
  ...
  protected void a(long paramLong)
  {
    ...
    for (i = 4;; i = 3)
    {
      ...
      if ((this.a.jdField_f_of_type_Boolean) && (this.a.jdField_f_of_type_Boolean) && (this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)) {
        this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(new jyp(this), 500L);
      }
  ...
  protected void b(long paramLong)
  {
    ...
    for (int i = 2;; i = 1)
    {
      ...
      this.a.jdField_a_of_type_ComTencentAvUtilsSensorHelper.b(true);
      this.a.jdField_a_of_type_ComTencentAvUtilsSensorHelper.a();
      this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(new jyt(this.a), 500L);
      if ((this.a.jdField_f_of_type_Boolean) && (this.a.jdField_f_of_type_Boolean) && (this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)) {
        this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(new jyq(this), 600L);
      }
      if (this.a.jdField_a_of_type_ComTencentAvVideoController.a().jdField_f_of_type_Boolean) {
        this.a.L();
      }
  ...
  protected void c()
  {
    super.c();
    if (this.a.d != 2) {}
    while (this.a.jdField_a_of_type_ComTencentAvUiQavPanel.a(2131365396)) {
      return;
    }
    this.a.s_();
  }
  ...
  protected void d()
  {
    ...
    if (localAVActivity != null) {
      localAVActivity.runOnUiThread(new jyo(this));
    }
    while (!QLog.isColorLevel()) {
      return;
    }
