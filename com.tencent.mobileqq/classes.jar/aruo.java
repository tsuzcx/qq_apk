  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    case -2: 
      do
      {
        return;
        if (this.a.c) {
          bfdq.a().a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "", String.valueOf(this.a.jdField_a_of_type_Long), "1000", "51", "0", false);
        }
        this.a.a(true);
    ...
    birh.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 5, 0);
    this.a.jdField_a_of_type_AndroidAppActivity.setResult(1);
  }
}
