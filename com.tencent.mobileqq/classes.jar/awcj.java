...
{
  public static int a;
  public static volatile HashMap<Integer, awdo> a;
  public static volatile List<bgbn> a;
  ...
  public static int b;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new awck(this);
  private Runnable jdField_a_of_type_JavaLangRunnable = new CliNotifyPush.1(this);
  private volatile ArrayList<awdo> jdField_a_of_type_JavaUtilArrayList;
  private volatile ArrayList<awdo> b;
  private int c;
  ...
  private String a(ArrayList<awdo> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        localawdo = (awdo)paramArrayList.next();
        if ((localawdo != null) && (localawdo.jdField_a_of_type_JavaUtilMap != null)) {
      ...
      else
      {
        try
        {
          localJSONObject.put("addTime", localawdo.jdField_a_of_type_Long);
          localJSONObject.put("opUin", localawdo.jdField_b_of_type_Long);
          Iterator localIterator = localawdo.jdField_a_of_type_JavaUtilMap.keySet().iterator();
          while (localIterator.hasNext())
          {
            String str = (String)localIterator.next();
            localJSONObject.put(str, localawdo.jdField_a_of_type_JavaUtilMap.get(str));
          }
      ...
      for (;;)
      {
        ...
        if ((this.c == 0) || (this.c == 10000))
        {
          ...
          if (this.jdField_a_of_type_JavaUtilArrayList != null)
          {
            ...
            while (localIterator.hasNext())
            {
              awdo localawdo = (awdo)localIterator.next();
              a(localawdo, (QQAppInterface)getAppRuntime(), 2L);
              a(localawdo, true);
              a(localawdo);
            }
          }
  ...
  private void a(int paramInt)
  {
    ...
    b(paramInt);
    bfpr.a((QQAppInterface)getAppRuntime(), "qzonenewservice.callqzonev2", paramInt, "CliNotifyPush", 1, System.currentTimeMillis());
  }
  
  private void a(awdo paramawdo)
  {
    QLog.e("CliNotifyPush", 1, "dispathQzonePushMsg()");
    QQAppInterface localQQAppInterface = (QQAppInterface)getAppRuntime();
    if (localQQAppInterface == null) {}
    while ((paramawdo == null) || (paramawdo.jdField_a_of_type_JavaUtilMap == null)) {
      return;
    }
    Object localObject;
    if ((paramawdo.jdField_a_of_type_JavaUtilMap != null) && (paramawdo.jdField_a_of_type_JavaUtilMap.get("utime") != null) && (LocalMultiProcConfig.getInt4Uin("qzone_preget_passive_open", 0, localQQAppInterface.getLongAccountUin()) == 1))
    {
      localObject = (String)paramawdo.jdField_a_of_type_JavaUtilMap.get("utime");
      if (!LocalMultiProcConfig.getString4Uin("qzone_passive_undealtime", "", localQQAppInterface.getLongAccountUin()).equals(localObject))
      {
        paramawdo.jdField_a_of_type_Boolean = true;
        int i = bgbz.a().a().a(localQQAppInterface.getLongAccountUin());
        jdField_a_of_type_JavaUtilHashMap.put(Integer.valueOf(i), paramawdo);
      }
    }
    if (a(localQQAppInterface, paramawdo))
    {
      if (jdField_a_of_type_Boolean)
      {
        ...
        this.jdField_b_of_type_JavaUtilArrayList.add(paramawdo);
        return;
      }
      localObject = new ArrayList();
      ((ArrayList)localObject).add(paramawdo);
  ...
  public static void a(awdo paramawdo, QQAppInterface paramQQAppInterface, long paramLong)
  {
    if (paramawdo == null) {
      return;
    }
    ...
    for (long l1 = Long.parseLong(paramQQAppInterface.getAccount());; l1 = 0L)
    {
      ...
      if (paramawdo.jdField_a_of_type_Long != 0L)
      {
        l2 = paramLong;
        if (l1 != 0L)
        {
          localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), awde.class);
          localNewIntent.putExtra("timestamp", paramawdo.jdField_a_of_type_Long);
          localNewIntent.putExtra("hostuin", l1);
          if (!paramawdo.jdField_b_of_type_Boolean) {
            break label230;
          }
        }
      }
      ...
      {
        String str2 = paramawdo.jdField_a_of_type_JavaLangString;
        String str1;
        ...
        {
          str1 = str2;
          if (paramawdo.jdField_a_of_type_JavaUtilMap != null) {
            str1 = (String)paramawdo.jdField_a_of_type_JavaUtilMap.get("pushstatkey");
          }
        }
        ...
        l2 = paramLong;
        QLog.e("CliNotifyPush", 1, "sentQzoneMsfPushAck: localTimeStamp=" + paramawdo.jdField_a_of_type_Long + " uin=" + l1 + " flag=" + l2);
        return;
      }
    }
  }
  
  private void a(awdo paramawdo, boolean paramBoolean)
  {
    if ((paramawdo == null) || (paramawdo.jdField_a_of_type_JavaUtilMap == null)) {
    ...
    do
    {
      ...
      localawcz = (awcz)((QQAppInterface)localObject1).getManager(10);
    } while (localawcz == null);
    for (;;)
    {
      int m;
      try
      {
        int k = Integer.parseInt((String)paramawdo.jdField_a_of_type_JavaUtilMap.get("pushtype"));
        QLog.i("CliNotifyPush", 1, "showRedTouch type:" + k + ",uin:" + paramawdo.jdField_b_of_type_Long + ",isBackground_Pause:" + ((QQAppInterface)localObject1).isBackground_Pause);
        if ((k != 1) && (k != 300) && (k != 302)) {
          break;
        }
        localObject1 = (String)paramawdo.jdField_a_of_type_JavaUtilMap.get("conent");
        m = Integer.parseInt((String)paramawdo.jdField_a_of_type_JavaUtilMap.get("count"));
        l = paramawdo.jdField_b_of_type_Long;
        int i = 0;
        try
        {
          boolean bool = paramawdo.jdField_a_of_type_JavaUtilMap.containsKey("opuin_qzoneVipLevel");
          if (!bool) {
            break label673;
          }
          i = 1;
        ...
        catch (Exception localException1)
        {
          try
          {
            j = Integer.parseInt((String)paramawdo.jdField_a_of_type_JavaUtilMap.get("opuin_qzoneVipLevel"));
            i = 1;
            ...
            paramawdo.jdField_a_of_type_ArrayOfByte = bgfh.a(paramawdo.jdField_a_of_type_ArrayOfByte);
            if (paramawdo.jdField_a_of_type_ArrayOfByte != null)
            {
              localObject3 = (PassiveFeedsPush)bgfh.a(PassiveFeedsPush.class, paramawdo.jdField_a_of_type_ArrayOfByte);
            ...
            localObject2 = (String)paramawdo.jdField_a_of_type_JavaUtilMap.get("shcemaUrlAnd");
          }
          ...
          try
          {
            paramawdo = (String)paramawdo.jdField_a_of_type_JavaUtilMap.get("psv_tab_textlist");
            if (!TextUtils.isEmpty(paramawdo))
            {
              paramawdo = new JSONObject(paramawdo);
              paramawdo.getJSONObject("psv_tab_list");
              paramawdo = paramawdo.getJSONObject("psv_tab_list").getJSONArray("text_data");
              i = 0;
              if (i < paramawdo.length())
              {
                localObject4 = (JSONObject)paramawdo.get(i);
          ...
          catch (Exception paramawdo)
          {
            QLog.e("CliNotifyPush", 1, "psv_tab_textlist failed" + paramawdo);
            if (k != 302) {
              break label644;
            }
          }
        }
        localawcz.a(1, m, localException1, (String)localObject1, paramBoolean, true, (String)localObject2);
        return;
      }
      catch (Exception paramawdo)
      {
      ...
      label644:
      long l = m;
      localawcz.a(1, l, localException1, (String)localObject1, paramBoolean, true, "");
      return;
      label673:
      int j = 0;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((!TextUtils.isEmpty(str)) && (i > 0))
        {
          ...
          paramQQAppInterface = (akie)paramQQAppInterface.a(148);
          if (paramQQAppInterface != null)
          {
  ...
  private void a(ArrayList<awdo> paramArrayList, QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      while (localIterator.hasNext()) {
        ((awdo)localIterator.next()).a(true);
      }
      return;
    }
    catch (Exception localException)
    {
      jdField_a_of_type_Boolean = false;
      paramQQAppInterface.getHandler(awcj.class).removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
      ...
      paramQQAppInterface.getHandler(awcj.class).postDelayed(this.jdField_a_of_type_JavaLangRunnable, QzoneConfig.getInstance().getConfig("QZoneSetting", "CallQZoneWNSFromPushTimeout", 20000));
  ...
  private void a(Map<String, String> paramMap, String paramString)
  {
    ...
    try
    {
      ...
      localbgfx.jdField_a_of_type_Int = Integer.parseInt((String)paramMap.get("key_ctrl_cmd"));
      localbgfx.jdField_a_of_type_JavaUtilMap.putAll(paramMap);
  ...
  private boolean a(awdo paramawdo)
  {
    boolean bool = false;
    int i = Integer.parseInt((String)paramawdo.jdField_a_of_type_JavaUtilMap.get("pushtype"));
    QQAppInterface localQQAppInterface = (QQAppInterface)getAppRuntime();
    Object localObject;
    bgbn localbgbn2;
    if (i == 301) {
      ...
      {
        localObject = (String)paramawdo.jdField_a_of_type_JavaUtilMap.get("live_roomid");
        if (localObject != null)
        {
          localbgbn2 = (bgbn)jdField_a_of_type_JavaUtilList.get(jdField_a_of_type_JavaUtilList.size() - 1);
          if ((localbgbn2 == null) || (!((String)localObject).equals(localbgbn2.jdField_a_of_type_JavaLangString))) {
            break label257;
          }
          jdField_a_of_type_JavaUtilList.remove(localbgbn2);
    ...
    for (;;)
    {
      ...
      a(paramawdo, localQQAppInterface, 16L);
      bool = true;
      return bool;
      label187:
      bgbn localbgbn1 = (bgbn)jdField_a_of_type_JavaUtilList.get(jdField_a_of_type_JavaUtilList.size() - 1);
      if (localbgbn1 != null)
      {
        bgbl.a().a(localQQAppInterface, 0, null, localbgbn1.b, null, null, localbgbn1.jdField_a_of_type_Boolean, localbgbn1.jdField_a_of_type_Int, localbgbn1.c, localbgbn1.d, false, false);
        continue;
        label257:
        if (jdField_a_of_type_JavaUtilList.size() > 1)
        {
          ...
          {
            localbgbn2 = (bgbn)jdField_a_of_type_JavaUtilList.get(i);
            if ((localbgbn2 != null) && (localbgbn1.equals(localbgbn2.jdField_a_of_type_JavaLangString))) {
              jdField_a_of_type_JavaUtilList.remove(localbgbn2);
            }
            i += 1;
          }
  ...
  private void b(int paramInt)
  {
    ...
    awrn.a(BaseApplication.getContext()).a(localQQAppInterface.getAccount(), "callqzonefrompushv2", true, 0L, 0L, localHashMap, null, true);
  }
  
  private void b(awdo paramawdo)
  {
    QLog.e("CliNotifyPush", 1, "showPush()");
    if ((paramawdo.jdField_a_of_type_Boolean) && (paramawdo.jdField_a_of_type_Int == 0)) {
      paramawdo.jdField_a_of_type_Int += 1;
    }
    ...
    do
    {
      ...
      k = Integer.parseInt((String)paramawdo.jdField_a_of_type_JavaUtilMap.get("pushtype"));
      QLog.e("CliNotifyPush", 1, "pushType:" + k);
      if (k == 10000)
      {
        a(paramawdo.jdField_a_of_type_JavaUtilMap, localQQAppInterface.getAccount());
        a(paramawdo, localQQAppInterface, 16L);
        return;
      }
      if (k == 350)
    ...
    String str1 = (String)paramawdo.jdField_a_of_type_JavaUtilMap.get("conent");
    String str2 = (String)paramawdo.jdField_a_of_type_JavaUtilMap.get("pushstatkey");
    String str3 = (String)paramawdo.jdField_a_of_type_JavaUtilMap.get("shcemaUrlAnd");
    String str4 = (String)paramawdo.jdField_a_of_type_JavaUtilMap.get("title");
    String str5 = (String)paramawdo.jdField_a_of_type_JavaUtilMap.get("fake_push");
    String str6 = (String)paramawdo.jdField_a_of_type_JavaUtilMap.get("icon_type");
    String str7 = (String)paramawdo.jdField_a_of_type_JavaUtilMap.get("icon_url");
    if (QLog.isColorLevel()) {
      QLog.d("CliNotifyPush", 2, new Object[] { "showPush: invoked. ", " iconType: ", str6, " title: ", str4, " message: ", str1 });
    }
    long l = paramawdo.jdField_b_of_type_Long;
    if (paramawdo.jdField_a_of_type_JavaUtilMap.get("count") != null) {
      QLog.i("CliNotifyPush", 1, "showPush receive push time:" + paramawdo.jdField_a_of_type_Long + ",unreadCount=" + 1 + ",uin=" + l + ",type=" + k);
    }
    for (;;)
    {
      int j;
      ...
      try
      {
        j = Integer.parseInt((String)paramawdo.jdField_a_of_type_JavaUtilMap.get("count"));
        i = j;
        if (j < 1) {
          i = 1;
        }
      ...
      catch (Exception localException1)
      {
        try
        {
          j = Integer.parseInt((String)paramawdo.jdField_a_of_type_JavaUtilMap.get("CtrlFlag"));
          if (QLog.isColorLevel())
          {
            QLog.i("CliNotifyPush", 2, "qzone redtypeinfo:receive push time:" + paramawdo.jdField_a_of_type_Long + "=unreadCount=" + i + "=uin=" + l + "=type=" + k + "=CtrlFlag=" + j + "=message=" + str1);
            if (j != 1) {
              continue;
            }
            bool1 = true;
        ...
        catch (Exception localException2)
        {
          j = 0;
          continue;
          QLog.i("CliNotifyPush", 1, "qzone redtypeinfo:receive push time:" + paramawdo.jdField_a_of_type_Long + "=unreadCount=" + i + "=uin=" + l + "=type=" + k + "=CtrlFlag=" + j);
          continue;
          bool1 = false;
          continue;
          if (j == 1)
          {
            ...
            a(paramawdo, localQQAppInterface, 128L);
            return;
          }
      ...
      for (;;)
      {
        if (j != 0)
        {
          a(paramawdo, localQQAppInterface, 64L);
          return;
          j = 0;
        }
        else
        {
          ...
          {
            a(paramawdo, localQQAppInterface, 512L);
            return;
          }
          boolean bool3;
          if (str1 != null)
          {
            ...
            str1 = localQQAppInterface.getApp().getApplicationContext().getString(2131652306) + i + localQQAppInterface.getApp().getApplicationContext().getString(2131652307);
          }
          label1064:
          label1074:
          for (;;)
          {
            ...
            {
              bool1 = bool2;
              if (paramawdo.jdField_a_of_type_JavaUtilMap.get("daemonShow") != null) {
                bool1 = "1".equals(paramawdo.jdField_a_of_type_JavaUtilMap.get("daemonShow"));
              }
            }
            if (bool1)
            {
              bgbl.a().a(localQQAppInterface, 1, str4, str1, str6, str7, bool3, k, str3, str2, true, "1".equals(str5));
              a(paramawdo, localQQAppInterface, 4L);
            }
            QLog.e("CliNotifyPush", 1, "show push: XXX");
            return;
            a(paramawdo, localQQAppInterface, 256L);
            return;
            a(paramawdo, localQQAppInterface, 32L);
            return;
          }
          label1077:
          j = 0;
  ...
  private void c(awdo paramawdo)
  {
    ...
    if ((paramawdo.jdField_a_of_type_ArrayOfByte != null) && (paramawdo.jdField_a_of_type_ArrayOfByte.length > 0)) {
      localIntent.putExtra("update_feeds_buffer", paramawdo.jdField_a_of_type_ArrayOfByte);
    }
    for (;;)
    {
      BaseApplication.getContext().sendBroadcast(localIntent, "com.tencent.msg.permission.pushnotify");
      return;
      if ((paramawdo.jdField_a_of_type_JavaUtilMap != null) && ((paramawdo.jdField_a_of_type_JavaUtilMap instanceof HashMap))) {
        localIntent.putExtra("update_feeds", (HashMap)paramawdo.jdField_a_of_type_JavaUtilMap);
      }
    }
  }
  
  /* Error */
  private void d(awdo paramawdo)
  {
    // Byte code:
    //   0: iconst_m1
    //   1: istore_3
    ...
    //   3: ifnull +10 -> 13
    //   6: aload_1
    //   7: getfield 159	awdo:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   10: ifnonnull +4 -> 14
    //   13: return
    //   14: aload_1
    //   15: getfield 159	awdo:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   18: ldc_w 875
    //   21: invokeinterface 188 2 0
    //   26: checkcast 24	java/lang/String
    //   29: astore 6
    //   31: aload_1
    //   32: getfield 159	awdo:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   35: ldc_w 877
    ...
    //   64: ldc 199
    //   66: ldc_w 879
    //   69: invokestatic 884	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   72: iconst_1
    //   73: istore_2
    //   74: aload_0
    //   75: invokevirtual 233	awcj:getAppRuntime	()Lmqq/app/AppRuntime;
    ...
    //   97: aload 7
    //   99: aload_1
    //   100: getfield 159	awdo:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   103: invokevirtual 885	java/util/HashMap:putAll	(Ljava/util/Map;)V
    //   106: aload 7
    //   108: ldc_w 887
    //   111: iload_2
    ...
    //   122: invokestatic 739	awrn:a	(Landroid/content/Context;)Lawrn;
    //   125: aload 6
    ...
    //   138: aconst_null
    //   139: iconst_1
    //   140: invokevirtual 744	awrn:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   143: return
    ...
    //   147: aload 6
    //   149: invokestatic 891	awcj:a	(Landroid/content/Context;Ljava/lang/String;)Z
    //   152: istore 5
    //   154: iload 5
    //   156: ifeq +212 -> 368
    //   159: aload_1
    //   160: getfield 159	awdo:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   163: ldc_w 893
    ...
    //   191: istore_3
    //   192: aload_1
    //   193: getfield 159	awdo:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   196: ldc_w 895
    ...
    //   226: aload 6
    //   228: invokestatic 897	awcj:a	(Landroid/content/Context;Ljava/lang/String;)I
    //   231: istore 4
    //   233: iload 4
    //   235: iload_3
    ...
    //   245: aload_0
    //   246: aload_1
    //   247: getfield 159	awdo:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   250: aload 6
    //   252: aload 7
    //   254: invokevirtual 900	awcj:a	(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)V
    //   257: iconst_0
    //   258: istore_2
    //   259: goto +133 -> 392
    //   262: astore 8
    ...
    //   266: ldc_w 902
    //   269: aload 8
    //   271: invokestatic 905	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   274: goto -82 -> 192
    //   277: astore 6
    //   279: invokestatic 906	cooperation/qzone/util/QZLog:isColorLevel	()Z
    //   282: ifeq +24 -> 306
    //   285: ldc 199
    //   287: iconst_2
    //   288: iconst_2
    ...
    //   300: aload 6
    //   302: aastore
    //   303: invokestatic 910	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   306: iconst_4
    //   307: istore_2
    //   308: goto -234 -> 74
    //   311: ldc_w 911
    ...
    //   322: ldc_w 913
    //   325: aload 8
    //   327: invokestatic 905	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   330: ldc_w 911
    //   333: istore_2
    //   334: goto -111 -> 223
    //   337: iconst_3
    ...
    //   339: iload_3
    //   340: istore_2
    //   341: invokestatic 906	cooperation/qzone/util/QZLog:isColorLevel	()Z
    //   344: ifeq +48 -> 392
    //   347: ldc 199
    //   349: iconst_2
    //   350: iconst_1
    ...
    //   356: ldc_w 915
    //   359: aastore
    //   360: invokestatic 910	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   363: iload_3
    //   364: istore_2
    //   365: goto +27 -> 392
    //   368: invokestatic 906	cooperation/qzone/util/QZLog:isColorLevel	()Z
    //   371: ifeq +19 -> 390
    //   374: ldc 199
    //   376: iconst_2
    //   377: iconst_1
    ...
    //   383: ldc_w 917
    //   386: aastore
    //   387: invokestatic 910	cooperation/qzone/util/QZLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   390: iconst_2
    //   391: istore_2
    //   392: goto -318 -> 74
    //   395: iconst_m1
  ...
  public Map<Integer, awdo> a(FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      if ((i == 1) || (i == 2) || (i == 4) || (i == 301) || (i == 8) || (i == 300) || (i == 10000) || (i == 302) || (i == 350) || (i == 100))
      {
        ...
        if (QzoneConfig.getInstance().getConfig("QZoneSetting", "PushDeduplication", 1) == 1)
        {
          ...
          a(new awdo(localSingleMsg.addTime, localSingleMsg.data, localSingleMsg.opUin, paramFromServiceMsg.Mark), localQQAppInterface, 8L);
          a(2014);
          break;
        ...
        {
          awdo localawdo = (awdo)((Map)localObject1).get(Integer.valueOf(i));
          if ((localawdo != null) && (localawdo.jdField_a_of_type_Long < localSingleMsg.addTime))
          {
            ((Map)localObject1).put(Integer.valueOf(i), new awdo(localSingleMsg.addTime, localSingleMsg.data, localSingleMsg.opUin, paramFromServiceMsg.Mark, localSingleMsg.extBuffer));
            QLog.e("CliNotifyPush", 1, "PushDeduplication: msg localTimeStap:" + localSingleMsg.addTime + " sm newTimeStap:" + localawdo.jdField_a_of_type_Long + " msg:" + (String)localawdo.jdField_a_of_type_JavaUtilMap.get("conent"));
            a(localawdo, localQQAppInterface, 8L);
            label713:
      ...
      for (;;)
      {
        ...
        if (i == 7066) {
          ...
          a(new awdo(localSingleMsg.addTime, localSingleMsg.data, localSingleMsg.opUin, paramFromServiceMsg.Mark), localQQAppInterface, 256L);
        }
      }
      if (l3 < l1) {
  ...
  public boolean a(QQAppInterface paramQQAppInterface, awdo paramawdo)
  {
    ...
    try
    {
      if ((paramawdo.jdField_a_of_type_JavaUtilMap.containsKey("CtrlFlag")) && (Integer.parseInt((String)paramawdo.jdField_a_of_type_JavaUtilMap.get("CtrlFlag")) == 1))
      {
    ...
    catch (Exception localException)
    {
      ...
      int j = Integer.parseInt((String)paramawdo.jdField_a_of_type_JavaUtilMap.get("pushtype"));
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    paramBundle = (awdo)jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(i));
    ...
    b((awdo)jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(i)));
  }
}
