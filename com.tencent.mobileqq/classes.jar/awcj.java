...
final class awcj
  implements aycx
{
  awcj(QQAppInterface paramQQAppInterface, String paramString, int paramInt, long paramLong1, long paramLong2) {}
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          Object localObject4 = new bdyi();
          ((bdyi)localObject4).jdField_a_of_type_Int = localMessageRecord.istroop;
          ArrayList localArrayList1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getProxyManager().a().a(paramaycy.jdField_a_of_type_ArrayOfByte, (HashMap)localObject1, null, (bdyi)localObject4);
          ...
          if (((MessageRecord)localArrayList1.get(0)).msgtype == -1035)
          {
            ...
            ((avsf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(174)).a(true, this.jdField_a_of_type_Int);
            ...
            {
              ((bdyi)localObject4).jdField_a_of_type_Bdyj.a(13, this.jdField_a_of_type_Long);
              ((bdyi)localObject4).jdField_a_of_type_Bdyj.a(24, this.jdField_a_of_type_Long);
              ...
              if (QLog.isColorLevel()) {
                QLog.d("StructLongTextMsg", 2, "requestDownloadLongTextMsg update MessageInfo-- groupUin:" + str + "lastSeq:" + l + ",shMsgSeq:" + localMessageRecord.shmsgseq + ",msgInfo.hasFlag:" + ((bdyi)localObject4).a());
              }
              if ((localMessageRecord.shmsgseq > l) && (((bdyi)localObject4).a()))
              {
                localMessageRecord.mMessageInfo = ((bdyi)localObject4);
                localObject4 = (abvw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getBaseMessageManager(1);
                ArrayList localArrayList2 = new ArrayList();
                localArrayList2.add(localMessageRecord);
                ((abvw)localObject4).a(str, localArrayList2);
              }
            }
            ...
            ((awcg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(166)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Int, paramaycy.jdField_a_of_type_Int, 1);
            return;
          }
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("StructLongTextMsg", 2, "requestDownloadLongTextMsg onDownload exception! resultCode:" + paramaycy.jdField_a_of_type_Int + ",errCode: " + paramaycy.b + ",errStr:" + paramaycy.jdField_a_of_type_JavaLangString + ",cost:" + (System.currentTimeMillis() - this.b));
        continue;
        ...
        try
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("StructLongTextMsg", 2, "requestDownloadLongTextMsg onDownload failed! resultCode:" + paramaycy.jdField_a_of_type_Int + ",errCode: " + paramaycy.b + ",errStr:" + paramaycy.jdField_a_of_type_JavaLangString + ",cost:" + (System.currentTimeMillis() - this.b));
          }
        }
