...
public class auds
  implements aueb<BubbleRecommendRsp>
{
  public int a()
  {
    return 4;
  ...
  {
    return bgev.a(paramContext, "bubble", "mvip.gongneng.android.bubble.index_dynamic_tab");
  }
  
  public String a(FontBubble paramFontBubble)
  {
    return bgev.a("bubblePreview").replace("[id]", Integer.toString(paramFontBubble.bubbleId));
  }
  
  public List<FontBubble> a(QQAppInterface paramQQAppInterface, BubbleRecommendRsp paramBubbleRecommendRsp)
  {
    int j = 0;
    paramQQAppInterface = ((amsw)paramQQAppInterface.getManager(51)).a(paramQQAppInterface.getAccount());
    int i;
