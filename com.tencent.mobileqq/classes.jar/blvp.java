...
public final class blvp
{
  ...
  public static java.util.ArrayList<java.lang.Integer> a(String paramString)
  {
    ...
    //   194: ldc 147
    //   196: ldc 149
    //   198: invokestatic 152	bhfd:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   201: aload_0
    //   202: areturn
    //   203: iconst_1
    //   204: istore_2
  ...
  public static void a(Context paramContext, Bundle paramBundle, ahtp paramahtp, AIORichMediaData paramAIORichMediaData, int paramInt1, int paramInt2)
  {
    ...
    for (int i = 1;; i = 0)
    {
      if ((!localBundle.getBoolean("extra.EXTRA_NOT_CLEAR_TOP", false)) && (paramInt2 != 3) && (paramInt2 != 2) && (i == 0))
      {
        ...
        label95:
        localBundle.putParcelable("extra.IMAGE_PROVIDER", new BinderWarpper(paramahtp.asBinder()));
        ...
        paramahtp = ((BaseActivity)paramContext).getAppInterface();
        if ((paramahtp instanceof QQAppInterface))
        {
          ...
          if ((str != null) && (((QQAppInterface)paramahtp).getTroopMask(str) == 2)) {
      ...
      for (;;)
      {
        if (jdField_a_of_type_Avli != null) {
          jdField_a_of_type_Avli.b();
        }
        return;
  ...
  public static boolean a(String paramString)
  {
    ...
    //   39: ifeq -17 -> 22
    //   42: aload_0
    //   43: invokestatic 363	bheg:b	(Ljava/lang/String;)Z
    //   46: ifeq -24 -> 22
    //   49: invokestatic 104	bhfd:a	()V
    ...
    //   219: ldc 147
    //   221: ldc_w 392
    //   224: invokestatic 152	bhfd:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   227: iload 4
    //   229: ireturn
    //   230: astore_0
    //   231: aload_0
  ...
  public static void b(Context paramContext, Bundle paramBundle, ahtp paramahtp, AIORichMediaData paramAIORichMediaData, int paramInt1, int paramInt2)
  {
    Bundle localBundle = paramBundle;
    if (paramBundle == null) {
      localBundle = new Bundle();
