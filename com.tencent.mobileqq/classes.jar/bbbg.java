...
public class bbbg
{
  ...
  public static int a;
  private static bbbl jdField_a_of_type_Bbbl;
  ...
  private static final String c = ajya.a(2131714714);
  
  static
  {
    jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(false);
    jdField_a_of_type_Bbbl = new bbbl();
  ...
  public static String a(Context paramContext, Uri paramUri, String paramString1, String paramString2)
  {
    ...
    //   28: aload_2
    //   29: aload_3
    //   30: invokestatic 149	bbbg:a	(Landroid/content/Context;Ljava/io/InputStream;Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
  ...
  public static void a(Context paramContext, bbbj parambbbj, acxj paramacxj)
  {
    jdField_a_of_type_Bbbl.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    jdField_a_of_type_Bbbl.jdField_a_of_type_Acxj = paramacxj;
    parambbbj.a(paramacxj);
    parambbbj.a(new bbbi());
  }
  ...
  {
    if ((paramSessionInfo.jdField_a_of_type_Int != 1) && (paramSessionInfo.jdField_a_of_type_Int != 3000) && (paramSessionInfo.jdField_a_of_type_Int != 0) && (!akpx.d(paramSessionInfo.jdField_a_of_type_Int)))
    {
    ...
    paramViewGroup.setOnDragListener(new bbbh(localImageView, localColorDrawable1, paramViewGroup, localColorDrawable2, paramContext, paramQQAppInterface, paramSessionInfo));
  }
  ...
  private static bbbk b(Context paramContext, acuj paramacuj)
  {
    long l = 0L;
    Object localObject1;
    if ((paramacuj instanceof adxa))
    {
      localObject1 = apvm.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramacuj.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
      l = bbdx.a((String)localObject1);
      paramacuj = paramacuj.jdField_a_of_type_AndroidViewView;
    }
    for (;;)
    {
      label76:
      ...
      if (TextUtils.isEmpty((CharSequence)localObject1))
      {
        ...
        if ((paramacuj instanceof adxc))
        {
          localObject1 = apvm.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramacuj.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
          l = bbdx.a((String)localObject1);
          paramacuj = ((adxc)paramacuj).a;
          continue;
        }
        if ((paramacuj instanceof advy))
        {
          localObject2 = (MessageForPic)paramacuj.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject3 = ((MessageForPic)localObject2).getBiggestFilePath();
          String str = apug.a((String)localObject3);
          int i = bgky.a((String)localObject3);
          localObject1 = ".jpg";
          if (i == 1001) {
            localObject1 = ".png";
          }
          for (;;)
          {
            ...
            if ((!bbdx.d(((MessageForPic)localObject2).getBiggestFilePath(), (String)localObject1)) || (TextUtils.isEmpty(str))) {
              break label76;
            }
            l = ((MessageForPic)localObject2).size;
            paramacuj = ((advy)paramacuj).a;
            break;
            if (i == 1005) {
              localObject1 = ".bmp";
            } else if (i == 2000) {
        ...
        if ((paramacuj instanceof adzp))
        {
          localObject2 = (MessageForShortVideo)paramacuj.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject1 = ShortVideoUtils.a((MessageForShortVideo)localObject2, "mp4");
          l = ((MessageForShortVideo)localObject2).videoFileSize;
          paramacuj = ((adzp)paramacuj).a;
          continue;
        }
        if ((paramacuj instanceof aeaf))
        {
          localObject2 = (MessageForShortVideo)paramacuj.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject1 = ShortVideoUtils.a((MessageForShortVideo)localObject2, "mp4");
          l = ((MessageForShortVideo)localObject2).videoFileSize;
          paramacuj = ((aeaf)paramacuj).a;
        }
      }
      else
      {
        ...
        return new bbbk((File)localObject2, paramacuj, ClipData.newUri(paramContext.getContentResolver(), "uri", (Uri)localObject1));
      }
      paramacuj = null;
      localObject1 = null;
    }
  ...
  private static boolean b(DragEvent paramDragEvent, ImageView paramImageView, ColorDrawable paramColorDrawable1, ViewGroup paramViewGroup, ColorDrawable paramColorDrawable2, Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    ((TextView)paramImageView.findViewById(2131371557)).setText(ajya.a(2131714713));
