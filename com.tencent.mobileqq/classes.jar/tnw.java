  ...
  extends tnz
{
  ...
  public tnw(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      veg.a("GetPromoteTaskResponse", "GetPromoteTaskResponse(): %s", vys.a(this.jdField_a_of_type_ComTencentBizQqstoryNetworkPbQqstory_service$RspGetPromoteTaskList));
      return;
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      veg.c("GetPromoteTaskResponse", "Error GetPromoteTaskResponse()", paramArrayOfByte);
    }
  }
  
  public String toString()
  {
    return vys.a(this.jdField_a_of_type_ComTencentBizQqstoryNetworkPbQqstory_service$RspGetPromoteTaskList);
  }
}
