...
public abstract class alya
{
  ...
  protected abstract void addBusinessObserver(ToServiceMsg paramToServiceMsg, alpg paramalpg, boolean paramBoolean);
  ...
  public ToServiceMsg makeOIDBPkg(String paramString, int paramInt1, int paramInt2, byte[] paramArrayOfByte, long paramLong, alpg paramalpg, boolean paramBoolean)
  {
    ...
    addBusinessObserver(paramString, paramalpg, paramBoolean);
    return paramString;
  }
}
