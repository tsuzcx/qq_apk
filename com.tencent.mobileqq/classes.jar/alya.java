  ...
  public void onCallback(EIPCResult paramEIPCResult)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        alvx.a(new Object[] { "[checkFinish], loading from main process but waiting for tool, before cost:", Long.valueOf(l1) });
        ((ApolloGameActivity)localActivity).a(paramEIPCResult);
        ((ApolloGameActivity)localActivity).a(localCmGameInitParams);
        return;
        l1 = System.currentTimeMillis() - alxy.a(this.a).mCreateTs;
      }
