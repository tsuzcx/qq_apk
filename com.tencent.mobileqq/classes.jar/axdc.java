...
public class axdc
{
  ...
  public static void a()
  {
    ...
    bbdj.d(str1 + "libartfilter.so");
    bbdj.d(str1 + "262_8_model");
    bbdj.d(str1 + "262_8_md04_reshape");
    str1 = str1 + "bakcup/";
    if (bbdj.a(str1))
    {
      arrayOfString = b;
  ...
  public static boolean a(String paramString)
  {
    ...
    {
      return bool;
      i = bbdj.a(paramString, biie.b, false, true, QLog.isColorLevel());
  ...
  static boolean b(String paramString1, String paramString2)
  {
    ...
    if (i < paramString2.size())
    {
      ...
      do
      {
        ...
        localObject = axet.a(str);
        j = ((axeu)localObject).a('|');
        if (j != 0) {
          break label407;
        }
        str = paramString1 + ((axeu)localObject).c();
        File localFile = new File(str);
        if (!localFile.exists())
        {
        ...
        j = Integer.parseInt(((axeu)localObject).d());
        l = localFile.length();
      } while (j == l);
