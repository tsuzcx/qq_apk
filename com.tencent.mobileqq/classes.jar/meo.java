  ...
  implements MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener
{
  ...
  public static boolean a(VideoAppInterface paramVideoAppInterface)
  {
    ...
    return mjg.a(paramVideoAppInterface).getBoolean("qav_UserGuide2_for_av_redbag", true);
  }
  
  RelativeLayout a(AVActivity paramAVActivity)
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)paramAVActivity.findViewById(2131301626);
    ...
    for (;;)
    {
      ...
      localRelativeLayout = (RelativeLayout)paramAVActivity.getLayoutInflater().inflate(2131494002, (RelativeLayout)paramAVActivity.findViewById(2131306488)).findViewById(2131301626);
      a(localRelativeLayout);
      b();
      localRelativeLayout.findViewById(2131301627).setOnClickListener(new mep(this));
      Object localObject = localRelativeLayout.findViewById(2131301624);
      if (this.b == null) {
        this.b = mez.a("qav_redpacket_result_close.png", true);
      }
      if (this.b != null) {
        ((View)localObject).setBackgroundDrawable(mit.a(paramAVActivity.getResources(), this.b, 2131100329));
      }
      ((View)localObject).setOnClickListener(new meq(this));
      String str = mez.b();
      if (bace.b(str))
      {
        localObject = (VideoView)localRelativeLayout.findViewById(2131301629);
  ...
  {
    paramRelativeLayout.setOnTouchListener(new mer(this));
  }
  
  public boolean a(met parammet)
  {
    AVActivity localAVActivity = a();
    if (localAVActivity == null) {
      return false;
    }
    this.jdField_a_of_type_Met = parammet;
  ...
  boolean a(boolean paramBoolean, int paramInt)
  {
    ...
    if (localObject != null)
    {
      RelativeLayout localRelativeLayout = (RelativeLayout)((Activity)localObject).findViewById(2131301626);
      if (localRelativeLayout != null)
      {
        localRelativeLayout.setOnTouchListener(null);
        localObject = (RelativeLayout)((Activity)localObject).findViewById(2131306488);
        if (this.jdField_a_of_type_AndroidGraphicsBitmap != null)
        {
          VideoView localVideoView = (VideoView)localRelativeLayout.findViewById(2131301629);
    ...
    {
      if (this.jdField_a_of_type_Met != null)
      {
        this.jdField_a_of_type_Met.a(paramBoolean);
        this.jdField_a_of_type_Met = null;
      }
      QLog.w(this.i, 1, "closeUI, bSend[" + paramBoolean + "], closeType[" + paramInt + "]");
      mey.b(paramBoolean, paramInt);
      return bool;
    }
  }
  ...
  void b()
  {
    ...
    this.jdField_a_of_type_Lru = new mes(this);
  ...
  public boolean onInfo(MediaPlayer paramMediaPlayer, int paramInt1, int paramInt2)
  {
    if (paramInt1 == 3)
    {
      ...
      {
        paramMediaPlayer = (VideoView)paramMediaPlayer.findViewById(2131301629);
        if (paramMediaPlayer != null) {
  ...
  public void onPrepared(MediaPlayer paramMediaPlayer)
  {
    ...
    if (localObject != null)
    {
      localObject = (VideoView)((AVActivity)localObject).findViewById(2131301629);
      if (localObject != null)
      {
