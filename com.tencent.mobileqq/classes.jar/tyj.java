  ...
  extends JobSegment<List<String>, List<Bitmap>>
{
  ...
  public tyj(@Nullable Bitmap paramBitmap, String paramString, int paramInt, tyh paramtyh)
  {
  ...
  protected void a(JobContext paramJobContext, List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      txq.b(this.jdField_a_of_type_JavaLangString, "bitmapListSize = %d, stubBitmap = %s", Integer.valueOf(i), this.jdField_a_of_type_AndroidGraphicsBitmap);
      Handler localHandler = new Handler(ThreadManager.getSubThreadLooper(), new tyl(this, null));
      ...
      while (localIterator.hasNext())
      {
        ...
        if (!"stub_url".equals(str)) {
          this.jdField_a_of_type_Tyh.a(str, i, i, new tyk(this, paramJobContext, paramList, localHandler));
        }
      }
    }
  }
