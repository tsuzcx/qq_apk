  ...
  implements View.OnClickListener
{
  ...
  public wbd(View paramView, wbb paramwbb)
  {
    this.jdField_a_of_type_AndroidContentContext = paramwbb.jdField_a_of_type_AndroidContentContext;
    this.jdField_a_of_type_Int = 1;
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131377793));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131364416));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131364421));
    this.c = ((TextView)paramView.findViewById(2131364426));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131370157));
    this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardViewShareGroupInnerListView = ((ShareGroupInnerListView)paramView.findViewById(2131368329));
    this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardViewShareGroupInnerListView.setSelection(0);
    bcvq.a(this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardViewShareGroupInnerListView, false);
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardViewShareGroupInnerListView.setLoadMoreDataListener(this.jdField_a_of_type_Wbb.jdField_a_of_type_Wbl);
    paramwbb = (wix)this.jdField_a_of_type_ComTencentBizQqstoryShareGroupInfocardViewShareGroupInnerListView.a();
    paramwbb.a(this.jdField_a_of_type_Wbb.jdField_a_of_type_ComTencentBizQqstoryShareGroupModelShareGroupItem.shareGroupId);
    paramwbb.a(this.jdField_a_of_type_Wbb.jdField_a_of_type_Wbl);
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131369440);
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131369441);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131372144));
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130846096);
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130846092);
  ...
  public void a(VideoCollectionItem paramVideoCollectionItem, View paramView, int paramInt)
  {
    ...
    this.jdField_a_of_type_Wbb.jdField_a_of_type_JavaUtilHashMap.put(paramVideoCollectionItem.collectionId, new WeakReference(this));
    paramView = xmq.a(paramVideoCollectionItem.collectionTime);
    ...
    if (!TextUtils.isEmpty(paramView[0]))
    {
      ...
      ((LinearLayout.LayoutParams)localObject).setMargins(0, xod.a(this.jdField_a_of_type_AndroidContentContext, -8.0F), 0, 0);
      ...
      ((RelativeLayout.LayoutParams)localObject).leftMargin = xod.a(this.jdField_a_of_type_AndroidContentContext, 80.0F);
      this.c.setLayoutParams((ViewGroup.LayoutParams)localObject);
      if ((paramVideoCollectionItem.collectionCount > 0) || (paramInt != 2)) {
        break label655;
      }
      this.c.setText(alpo.a(2131714304));
      label382:
      localObject = this.jdField_a_of_type_Wbb.jdField_a_of_type_ComTencentBizQqstoryShareGroupModelShareGroupItem;
      ...
      paramVideoCollectionItem.height = xod.a(this.jdField_a_of_type_AndroidContentContext, 150.0F);
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setLayoutParams((ViewGroup.LayoutParams)localObject);
      localObject = (RelativeLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams();
      if ((paramInt == 3) && (TextUtils.equals(paramView[1], alpo.a(2131714297)))) {
        ((RelativeLayout.LayoutParams)localObject).setMargins(0, xod.a(this.jdField_a_of_type_AndroidContentContext, 10.0F), 0, xod.a(this.jdField_a_of_type_AndroidContentContext, 7.0F));
      }
      for (;;)
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setLayoutParams((ViewGroup.LayoutParams)localObject);
        break;
        ((RelativeLayout.LayoutParams)localObject).setMargins(0, 0, 0, xod.a(this.jdField_a_of_type_AndroidContentContext, 7.0F));
      }
      label655:
      this.c.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131699884, new Object[] { Integer.valueOf(paramVideoCollectionItem.collectionCount) }));
      break label382;
      label689:
      ...
      break label457;
      label740:
      if (TextUtils.equals(paramView[1], alpo.a(2131714301))) {
        paramVideoCollectionItem.height = xod.a(this.jdField_a_of_type_AndroidContentContext, 172.0F);
      } else {
        paramVideoCollectionItem.height = xod.a(this.jdField_a_of_type_AndroidContentContext, 176.0F);
      }
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    {
      wsv.b("Q.qqstory.shareGroup.ShareGroupsListAdapter", "no data to share");
      return;
    }
    xmq.b(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryModelVideoCollectionItem.collectionTime);
    ...
    do
    {
      ...
      paramView = (wiu)localIterator.next();
    } while ((paramView == null) || (wiz.a(paramView)) || (0 != 0));
    for (;;)
    {
      if (paramView != null)
      {
        this.jdField_a_of_type_Wbb.jdField_a_of_type_Wbl.a(this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryModelVideoCollectionItem.collectionId, this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryModelVideoCollectionItem.collectionTime, paramView.a, i, this.jdField_a_of_type_ComTencentBizQqstoryStoryHomeMemoryModelVideoCollectionItem.feedId, null);
        return;
      }
      wsv.b("Q.qqstory.shareGroup.ShareGroupsListAdapter", "cannot found first data to share to qq");
      return;
      paramView = null;
    }
  }
