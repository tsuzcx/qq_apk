...
{
  private static bdnk jdField_a_of_type_Bdnk;
  private ConcurrentLinkedQueue<bdnm> jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue;
  ...
  public static bdnk a()
  {
    if (jdField_a_of_type_Bdnk != null) {
      return jdField_a_of_type_Bdnk;
    }
    try
    {
      if (jdField_a_of_type_Bdnk == null) {
        jdField_a_of_type_Bdnk = new bdnk();
      }
      bdnk localbdnk = jdField_a_of_type_Bdnk;
      return localbdnk;
    }
    finally {}
  }
  ...
  public static void a(Context paramContext, MonitorHttpInfo paramMonitorHttpInfo, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    if (paramBoolean)
    {
      bdmc.a(paramContext).a(null, "MonitorApkDownload", true, 0L, 0L, localHashMap, "");
      label231:
      if (!QLog.isColorLevel()) {
        break label348;
      }
    ...
    for (paramContext = "MonitorApkDownload{";; paramContext = "UnMonitorApkDownload{")
    {
      ...
      bdmc.a(paramContext).a(null, "UnMonitorApkDownload", true, 0L, 0L, localHashMap, "");
      break label231;
      break;
    }
  ...
  private void b(MonitorHttpInfo paramMonitorHttpInfo, String paramString1, String paramString2)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue != null)
    {
      ...
      while (i < m)
      {
        ...
        if ((localObject instanceof bdnm))
        {
          localObject = (bdnm)localObject;
          int k = 0;
          try
          {
            j = a(str, ((bdnm)localObject).a());
            if (QLog.isColorLevel()) {
              QLog.d("NetworkMonitor", 2, new Object[] { "url=", str, " bean's url=", ((bdnm)localObject).a(), " lcs length=", Integer.valueOf(j) });
            }
            if (j < 10) {
              break label258;
            }
  ...
  public void a(String paramString)
  {
    ...
    bdnm localbdnm = new bdnm(this, paramString);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.add(localbdnm);
    if (QLog.isColorLevel()) {
    ...
    {
      paramString = (bdnm)this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.peek();
      if ((paramString == null) || (paramString.a - localbdnm.a <= 600000L)) {
        break;
      }
  ...
  public void addDownloadURL(String paramString)
  {
    ...
    if (1 != BaseApplicationImpl.sProcessId)
    {
      ...
      QIPCClientHelper.getInstance().callServer("NetworkMonitorIPCModule", "ACTION_REPORT_DOWNLOAD_URL", localBundle, new bdnl(this));
      return;
    }
    a(paramString);
  }
