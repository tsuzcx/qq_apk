  ...
  extends QIPCModule
{
  ...
  public ainb(String paramString)
  {
    super(paramString);
  }
  ...
  public static void a()
  {
    ...
    if (!a)
    {
      QIPCClientHelper.getInstance().register(localainb);
      a = true;
    }
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    try
    {
      ...
      {
        aing.a(paramBundle.getInt("gameId"));
      }
    ...
    if ("action_check_game_running".equals(paramString))
    {
      paramString = a();
      if (paramString != null)
      {
    ...
    else if ("action_set_sso_rule".equals(paramString))
    {
      ...
      aips localaips = aing.a();
      if (localaips != null) {
        localaips.a(paramString.gameId, paramBundle);
      }
    }
    else
    {
      ...
      if (bool)
      {
        try
        {
          ...
          if (l >= 0L)
          {
            ...
            awrn.a(BaseApplicationImpl.getApplication()).a(null, "cmgame_ipc_start_receive", true, l, 0L, paramBundle, "", false);
          }
          aing.a(paramString);
        }
        catch (Exception paramString)
      ...
      else if ("action_check_game_data".equals(paramString))
      {
        ...
        paramString = aing.a(paramString.gameId);
        if (paramString != null) {
