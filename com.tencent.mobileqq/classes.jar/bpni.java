  ...
  implements IEventReceiver
{
  ...
  anuw jdField_a_of_type_Anuw = new bpnk(this);
  bpnl jdField_a_of_type_Bpnl;
  braa jdField_a_of_type_Braa;
  AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface = bplg.a();
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alwf.jdField_a_of_type_JavaLangString + "/tencent/qim/share/";
  }
  ...
  private void c()
  {
    if (this.jdField_a_of_type_Bpnl == null)
    {
      this.jdField_a_of_type_Bpnl = new bpnl(this);
      if (QLog.isColorLevel()) {
        QLog.i("ComboLockManager", 2, "registerStoryReceiver");
      }
      wjj.a().registerSubscriber(this.jdField_a_of_type_Bpnl);
    }
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Bpnl != null)
    {
      ...
      wjj.a().unRegisterSubscriber(this.jdField_a_of_type_Bpnl);
      this.jdField_a_of_type_Bpnl = null;
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Braa == parambraa) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_JavaUtilHashMap = parambraa.jdField_a_of_type_JavaUtilHashMap;
      this.jdField_a_of_type_Braa = parambraa;
      parambraa = this.jdField_a_of_type_JavaUtilHashMap.keySet().iterator();
      while (parambraa.hasNext())
      {
        Object localObject = (String)parambraa.next();
  ...
  public boolean a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      else if (localLockedCategory.jdField_a_of_type_Int == 1)
      {
        ...
        {
          localLockedCategory.jdField_a_of_type_Boolean = bhsi.y(BaseApplicationImpl.getApplication(), paramString);
  ...
  public void b()
  {
    ...
    wjj.a().unRegisterSubscriber(this.jdField_a_of_type_Bpnl);
    Object localObject = (anum)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(2);
    this.jdField_a_of_type_ComTencentCommonAppAppInterface.addObserver(this.jdField_a_of_type_Anuw, true);
    if (this.jdField_a_of_type_DovComQqImCaptureDataLockedCategory != null)
    {
      localObject = BaseApplicationImpl.getContext();
      bpnj localbpnj = new bpnj(this, (Context)localObject);
      ThreadManager.getUIHandler().postDelayed(new ComboLockManager.2(this, (Context)localObject, localbpnj), 1000L);
    }
  }
  
  public void b(String paramString)
  {
    Object localObject1 = this.jdField_a_of_type_Braa.a(this.jdField_a_of_type_Int).a;
