...
public final class bebc
{
  ...
  public bebc(cmd0x383.ApplyGetFileListRspBody.FileInfo paramFileInfo)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public bebc(group_file_common.FolderInfo paramFolderInfo)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public bebc(oidb_0x6d8.GetFileListRspBody.Item paramItem)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  {
    String str = bfzl.b(paramContext, paramLong);
    paramContext = str;
    int i1;
    int i2;
    if (str != null)
    ...
    for (;;)
    {
      ...
      try
      {
        if (this.n == null)
        {
          ...
          if (i1 != 0)
          {
            this.n = ContactUtils.getDisplayName(paramQQAppInterface, b(), paramLong + "", 1, 0);
            if (this.n.length() <= 10)
            {
              i1 = i5;
              break label307;
  ...
  public String a()
  {
    return bfby.a(this.jdField_a_of_type_Long);
  }
  ...
  public void a(bebc parambebc)
  {
    if (parambebc != null)
    {
      if ((parambebc.jdField_e_of_type_Int != 8) && (parambebc.jdField_e_of_type_Int != 9)) {
        break label45;
      }
      if (parambebc.jdField_b_of_type_JavaLangString != null) {
        this.jdField_a_of_type_JavaUtilMap.put(parambebc.jdField_b_of_type_JavaLangString, parambebc);
      }
    }
    label45:
    while (((parambebc.jdField_e_of_type_Int != 11) && (parambebc.jdField_e_of_type_Int != 10) && (parambebc.jdField_e_of_type_Int != 12)) || (parambebc.jdField_b_of_type_JavaLangString == null)) {
      return;
    }
    this.jdField_a_of_type_JavaUtilMap.remove(parambebc.jdField_b_of_type_JavaLangString);
  }
  
  public void a(becp parambecp, QQAppInterface paramQQAppInterface)
  {
    this.jdField_i_of_type_JavaLangString = parambecp.jdField_b_of_type_JavaLangString;
    this.j = parambecp.jdField_c_of_type_JavaLangString;
    this.k = parambecp.jdField_d_of_type_JavaLangString;
    this.jdField_e_of_type_Int = parambecp.jdField_b_of_type_Int;
    this.jdField_h_of_type_JavaLangString = parambecp.jdField_a_of_type_JavaLangString;
    this.jdField_d_of_type_Long = parambecp.jdField_d_of_type_Long;
    this.jdField_f_of_type_Int = parambecp.jdField_c_of_type_Int;
    this.jdField_c_of_type_Boolean = parambecp.jdField_a_of_type_Boolean;
    if (this.jdField_b_of_type_Int == 0)
    {
      this.jdField_b_of_type_Int = parambecp.jdField_d_of_type_Int;
      this.l = a(BaseApplicationImpl.getApplication(), this.jdField_b_of_type_Int * 1000L);
    }
    if (this.jdField_b_of_type_JavaLangString == null) {
      this.jdField_b_of_type_JavaLangString = parambecp.jdField_e_of_type_JavaLangString;
    }
    if (this.jdField_f_of_type_JavaLangString == null) {
      this.jdField_f_of_type_JavaLangString = parambecp.jdField_i_of_type_JavaLangString;
    }
    if (this.jdField_a_of_type_Long == 0L) {
      this.jdField_a_of_type_Long = parambecp.jdField_c_of_type_Long;
    }
    if (this.jdField_c_of_type_JavaLangString == null) {
      this.jdField_c_of_type_JavaLangString = parambecp.jdField_g_of_type_JavaLangString;
    }
    if ((this.jdField_a_of_type_Int == 0) || (bebd.a(parambecp.jdField_b_of_type_Int))) {
      this.jdField_a_of_type_Int = parambecp.jdField_h_of_type_Int;
    }
    if ((this.jdField_b_of_type_Long == 0L) && (bebd.a(parambecp.jdField_b_of_type_Int))) {}
    try
    {
      this.jdField_b_of_type_Long = Long.parseLong(paramQQAppInterface.getCurrentAccountUin());
      return;
    }
    catch (NumberFormatException parambecp)
    {
  ...
  {
    return (bfby.a(paramQQAppInterface, paramLong)) && (this.jdField_d_of_type_Boolean);
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean)
  {
    ...
    boolean bool2 = bfby.a(paramQQAppInterface, paramLong);
  ...
  public void b(bebc parambebc)
  {
    ...
    this.jdField_b_of_type_Boolean = false;
    this.jdField_b_of_type_JavaLangString = parambebc.jdField_b_of_type_JavaLangString;
    this.jdField_f_of_type_JavaLangString = parambebc.jdField_f_of_type_JavaLangString;
    this.jdField_c_of_type_JavaLangString = parambebc.jdField_c_of_type_JavaLangString;
    this.jdField_a_of_type_Int = parambebc.jdField_a_of_type_Int;
    this.jdField_b_of_type_Long = parambebc.jdField_b_of_type_Long;
    this.jdField_c_of_type_Long = parambebc.jdField_c_of_type_Long;
    this.jdField_a_of_type_Long = parambebc.jdField_a_of_type_Long;
    this.jdField_b_of_type_Int = parambebc.jdField_b_of_type_Int;
    this.jdField_c_of_type_Int = parambebc.jdField_c_of_type_Int;
    this.jdField_i_of_type_Int = parambebc.jdField_i_of_type_Int;
    this.jdField_d_of_type_Int = parambebc.jdField_d_of_type_Int;
    this.jdField_e_of_type_JavaLangString = parambebc.jdField_e_of_type_JavaLangString;
    this.jdField_h_of_type_Int = parambebc.jdField_h_of_type_Int;
    this.jdField_d_of_type_JavaLangString = parambebc.jdField_d_of_type_JavaLangString;
    this.jdField_d_of_type_Boolean = parambebc.jdField_d_of_type_Boolean;
    this.l = parambebc.l;
    this.m = parambebc.m;
  }
  ...
  {
    return (bfby.a(paramQQAppInterface, paramLong)) && (!this.jdField_d_of_type_Boolean) && (!paramBoolean) && (!bebd.a(this.jdField_e_of_type_Int)) && (!bebd.b(this.jdField_e_of_type_Int));
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject == null) || (!(paramObject instanceof bebc))) {
      return false;
    }
    paramObject = (bebc)paramObject;
