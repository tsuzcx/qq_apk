...
public class bplc
  implements Comparable<bplc>
{
  public int a;
  public long a;
  public int b;
  
  public bplc(VideoFramesFetcher paramVideoFramesFetcher, long paramLong, int paramInt1, int paramInt2)
  {
  ...
  public int a(bplc parambplc)
  {
    return -(int)(this.jdField_a_of_type_Long - parambplc.jdField_a_of_type_Long);
  }
}
