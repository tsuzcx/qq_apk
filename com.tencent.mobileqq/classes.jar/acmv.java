  ...
  implements acna
{
  ...
  public void a(String paramString, int paramInt1, long paramLong, int paramInt2, QQMessageFacade.RefreshMessageContext paramRefreshMessageContext, ArrayList<MessageRecord> paramArrayList)
  {
    ...
    String str = aqvh.a(paramString, paramInt1, paramRefreshMessageContext.topicId);
    Object localObject1;
    Object localObject2;
    long l1;
    if (paramLong > 0L)
    ...
    for (;;)
    {
      ...
      if (localObject3 != null)
      {
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if (TextUtils.equals(str, aqvh.a(localMessageRecord.frienduin, localMessageRecord.istroop, localMessageRecord.getConfessTopicId()))) {
            if ((localMessageRecord.time <= l1) && ((localObject1 == null) || (!acnh.a((MessageRecord)localObject1, localMessageRecord, true)))) {
              break label657;
            }
          }
        }
      ...
      for (;;)
      {
        ...
        {
          int i = aqvh.a(paramInt1, paramRefreshMessageContext.topicId) << 3;
