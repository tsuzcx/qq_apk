...
public class arfv
  implements SurfaceHolder.Callback, arft
{
  ...
  public arfv(SurfaceView paramSurfaceView)
  {
  ...
  private Canvas b()
  {
    ...
    for (;;)
    {
      ...
      {
        argp.a("SurfaceDanmakuView", "Exception locking surface", localException);
      }
  ...
  private boolean b()
  {
    return (arfk.a()) && (((Build.VERSION.SDK_INT == 23) && (a())) || (ardw.a().a().b()));
  }
  ...
  private void d()
  {
    Object localObject = ardw.a().a().a(SurfaceView.class, "mSurfaceLock", this.jdField_a_of_type_AndroidViewSurfaceView);
  ...
  private void e()
  {
    this.jdField_a_of_type_JavaLangObject = ardw.a().a().a(SurfaceView.class, "mDrawingStopped", this.jdField_a_of_type_AndroidViewSurfaceView);
    this.jdField_b_of_type_JavaLangObject = ardw.a().a().a(SurfaceView.class, "mWindow", this.jdField_a_of_type_AndroidViewSurfaceView);
  ...
  public void a()
  {
    ReentrantLock localReentrantLock = (ReentrantLock)ardw.a().a().a(SurfaceView.class, "mSurfaceLock", this.jdField_a_of_type_AndroidViewSurfaceView);
    ...
    try
    {
      ...
      argp.c("surface_lock", "SurfaceDanmakuView unlock lockObjectValue = " + localLong);
      if (localLong.longValue() != 0L) {
        localMethod.invoke(null, new Object[] { localLong });
      }
      localField.setLong(localSurface, 0L);
      argp.b("surface_lock", "SurfaceDanmakuView unlock: release success");
      return;
    }
    catch (Exception localException)
    {
      argp.a("surface_lock", "SurfaceDanmakuView unlock:release failed", localException);
      return;
    }
    finally
    {
      argp.c("surface_lock", "SurfaceDanmakuView unlock surfaceLock = " + localReentrantLock);
      if ((localReentrantLock != null) && (localReentrantLock.isLocked()))
      {
        argp.c("surface_lock", "SurfaceDanmakuView unlock");
  ...
  public void surfaceChanged(SurfaceHolder paramSurfaceHolder, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    argp.c("SurfaceDanmakuView", "surfaceChanged, width = " + paramInt2 + ", height = " + paramInt3);
  }
  ...
  public void surfaceCreated(SurfaceHolder paramSurfaceHolder)
  {
    ...
    argp.c("SurfaceDanmakuView", "surfaceCreated, isHardwareAccelerateEnable = " + this.jdField_b_of_type_Boolean);
  }
  ...
  public void surfaceDestroyed(SurfaceHolder paramSurfaceHolder)
  {
    ...
    argp.c("SurfaceDanmakuView", "surfaceDestroyed");
  }
}
