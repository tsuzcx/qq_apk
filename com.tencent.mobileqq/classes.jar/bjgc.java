...
public class bjgc
  implements bkhw
{
  public bjgc(QidianProfileCardActivity paramQidianProfileCardActivity, String paramString) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        if (this.jdField_a_of_type_ComTencentQidianQidianProfileCardActivity.jdField_a_of_type_Bjft.d(this.jdField_a_of_type_ComTencentQidianQidianProfileCardActivity.jdField_a_of_type_Azfe.a.jdField_a_of_type_JavaLangString)) {
