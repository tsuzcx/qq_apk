...
public class amkf
{
  ...
  public static Point a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      paramQQAppInterface = bbkb.a(paramQQAppInterface.getApp(), paramQQAppInterface.c());
      ...
      {
        j = bbll.a() - bbll.a(25.0F);
        i = bbll.b() / 2 + bbll.a(25.0F);
      }
  ...
  public static void a(Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    for (;;)
    {
      try
      {
        ...
        if ((!amjt.a(paramContext)) && (paramBoolean1)) {
          c(paramContext);
        }
  ...
  public static void b(Context paramContext)
  {
    ...
    //   25: getstatic 68	amkf:jdField_a_of_type_Boolean	Z
    ...
    //   47: astore_1
    //   48: iconst_0
    //   49: putstatic 68	amkf:jdField_a_of_type_Boolean	Z
    //   52: aload_0
    //   53: aload_1
  ...
  private static void c(Context paramContext)
  {
    ...
    if (!ColorNoteSmallScreenPermissionDialogFragment.jdField_a_of_type_Boolean) {
      abtq.a(paramContext, PublicTransFragmentActivity.class, ColorNoteSmallScreenPermissionDialogFragment.class);
    }
  }
}
