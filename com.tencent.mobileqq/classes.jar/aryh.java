  ...
  implements bfdt
{
  ...
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new aryi(this);
  protected Handler a;
  public arua a;
  aryp jdField_a_of_type_Aryp = new aryp(this);
  protected aryq a;
  ...
  public aryh(Intent paramIntent)
  {
    super(paramIntent);
    this.jdField_a_of_type_MqqObserverBusinessObserver = new aryl(this);
    this.jdField_b_of_type_AndroidOsHandler = new aryo(this);
  }
  ...
  private void L()
  {
    try
    {
      bfja.a().a(0, "SHARE_TO_QQ", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), String.valueOf(this.jdField_b_of_type_Long), "4", Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, null);
      return;
    }
  ...
  private void a(String paramString, Bundle paramBundle, boolean paramBoolean)
  {
    if (this.jdField_c_of_type_Boolean) {
      arzy.a(paramString, paramBundle, paramBoolean);
    }
  }
  ...
  private boolean q()
  {
    if ((!this.jdField_c_of_type_Boolean) || (!this.n) || (this.jdField_a_of_type_Arua == null)) {
      return false;
    }
    ...
    {
      str = this.jdField_a_of_type_Arua.e();
      ...
      for (str = "1";; str = "0")
      {
        ...
        bfdq.a().a((Bundle)localObject, "" + this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), false);
        return true;
      }
    }
    return false;
  ...
  private boolean r()
  {
    ...
    if ((i1 == 5) && (!TextUtils.isEmpty(str)) && (!str.startsWith("http://")) && (!str.startsWith("https://")))
    {
      ...
      for (localObject = ((File)localObject).getAbsolutePath();; localObject = "")
      {
        ...
        localObject = new aryk(this);
        bdcd.a(this.jdField_a_of_type_AndroidAppActivity, 233, alpo.a(2131720796), alpo.a(2131720027), -1, 2131720026, (DialogInterface.OnClickListener)localObject, null).show();
        return true;
      }
    }
    return false;
  ...
  public final void H()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.ssoGetTicketNoPasswd(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 4096, this.jdField_a_of_type_Aryp);
  }
  ...
  public void K()
  {
    ...
    do
    {
      ...
      azmz.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "sha_share2qq", 1, "", "", String.valueOf(this.jdField_b_of_type_Long));
      if (this.d != 5) {
        break label645;
      }
      ...
      ((Bundle)localObject1).putString("intext_1", "" + bfdw.a(this.d));
      ((Bundle)localObject1).putString("intext_2", "" + bfdw.a(i1, (String)localObject2));
    ...
    for (int i1 = 0;; i1 = this.jdField_a_of_type_Arua.a())
    {
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Zcs == null)
    {
      ...
      this.jdField_a_of_type_Zcs.a(new aryj(this));
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_Zcs.a((String)localObject, c());
      ...
      if (paramInt1 == 0)
      {
        ...
        L();
        this.jdField_a_of_type_Zcs.b(null, null);
      }
      try
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Zcs.b(this.jdField_a_of_type_AndroidAppActivity.getString(2131719231), c());
          break;
          if (paramInt1 == 1003) {
            this.jdField_a_of_type_Zcs.a(2131692309);
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      if (!r())
      {
        ...
        if (paramInt == g.intValue()) {
          this.jdField_a_of_type_Bdfq.setEditLint("");
        }
      }
    ...
    localBundle.putString("intext_1", "" + bfdw.a(this.d));
  ...
  protected void a(String paramString, boolean paramBoolean)
  {
    ...
    localbdfq.setTitle(this.jdField_a_of_type_AndroidAppActivity.getString(2131720025));
    Object localObject;
    if (paramBoolean)
    {
      localObject = paramString;
      if (TextUtils.isEmpty(paramString)) {
        localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131720028);
      }
      localbdfq.setMessageWithUrl((String)localObject);
    }
    for (;;)
    {
      localObject = localbdfq.setPositiveButton(2131719910, new aryn(this));
      StringBuilder localStringBuilder = new StringBuilder().append(this.jdField_a_of_type_AndroidAppActivity.getString(2131690623));
      paramString = str;
      if (TextUtils.isEmpty(str)) {
        paramString = "";
      }
      ((bdfq)localObject).setNegativeButton(paramString, new arym(this));
      localbdfq.setCancelable(false);
      localbdfq.show();
      return;
      localbdfq.setMessage(2131720028);
    }
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      ...
      ((Bundle)localObject2).putString("intext_1", "" + bfdw.a(this.d));
      ((Bundle)localObject2).putString("intext_3", "0");
      bfdq.a().a((Bundle)localObject2, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
      if ((this.d == 5) && (TextUtils.isEmpty(str1)) && (TextUtils.isEmpty((CharSequence)localObject1)))
      {
        ...
        a(-1, alpo.a(2131705181), alpo.a(2131705193));
      }
      try
      {
        bfja.a().a(1, "SHARE_CHECK_AGENT", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), String.valueOf(this.jdField_b_of_type_Long), null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "分享的图片不存在");
        return false;
        localObject1 = null;
        continue;
        if (((arzd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(350)).a().a())
        {
        ...
        if ((l1 > 0L) && (!"101735437".equals(String.valueOf(l1))))
        {
          ...
          if (TextUtils.isEmpty((CharSequence)localObject2))
          {
            ...
            long l4 = arzk.a();
            e("KEY_GET_APP_INFO");
            zbj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), l1, (String)localObject1, l2, l3, this.jdField_a_of_type_MqqObserverBusinessObserver, (String)localObject2, l4, true);
            return true;
          }
  ...
  {
    if (this.jdField_c_of_type_Boolean) {
      arzy.a(paramString, paramBoolean);
    }
  }
  ...
  protected void e()
  {
    if (this.jdField_a_of_type_Arua.a())
    {
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Arua.a())) {
        this.jdField_a_of_type_AndroidOsBundle.putString("struct_share_key_source_icon", this.jdField_a_of_type_Arua.a());
      }
      String str = this.jdField_a_of_type_Arua.e();
      if (!TextUtils.isEmpty(str)) {
        this.jdField_a_of_type_AndroidOsBundle.putString("struct_share_key_source_icon_big", str);
      }
      if ((!TextUtils.isEmpty(this.jdField_a_of_type_Arua.b())) && (this.jdField_b_of_type_Long != Long.parseLong("1103584836"))) {
        this.jdField_a_of_type_AndroidOsBundle.putString("struct_share_key_source_url", this.jdField_a_of_type_Arua.b());
      }
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Arua.c())) {
        this.jdField_a_of_type_AndroidOsBundle.putString("struct_share_key_source_name", this.jdField_a_of_type_Arua.c());
      }
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Arua.d())) {
        this.jdField_a_of_type_AndroidOsBundle.putString("struct_share_key_source_a_action_data", this.jdField_a_of_type_Arua.d());
      }
      if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg != null)
      {
  ...
  protected void o()
  {
    ...
    localBundle.putString("intext_1", "" + bfdw.a(this.d));
    localBundle.putString("intext_2", "" + bfdw.a(this.jdField_a_of_type_AndroidOsBundle.getInt("uintype"), this.jdField_a_of_type_AndroidOsBundle.getString("uin")));
    localBundle.putString("intext_3", "0");
    bfdq.a().a(localBundle, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
  }
