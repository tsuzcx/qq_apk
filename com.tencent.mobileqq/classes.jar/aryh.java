  ...
  extends arvv
{
  ...
  private aryk jdField_a_of_type_Aryk;
  ...
  public aryh(aryk paramaryk, BaseFileAssistantActivity paramBaseFileAssistantActivity, Object paramObject, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, View.OnClickListener paramOnClickListener3, View.OnLongClickListener paramOnLongClickListener, View.OnClickListener paramOnClickListener4)
  {
    ...
    this.jdField_a_of_type_Aryk = paramaryk;
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (FavFileInfo localFavFileInfo = (FavFileInfo)paramViewGroup;; localFavFileInfo = null)
    {
      ...
      if (localFavFileInfo == null)
      {
        ...
        while (this.jdField_a_of_type_Aryk.b()) {
          return null;
        }
        paramView = new arvu();
        ...
        paramViewGroup.setOnClickListener(this.jdField_a_of_type_Aryk.a(paramView.jdField_a_of_type_AndroidWidgetTextView));
        paramViewGroup.setTag(paramView);
        if (this.jdField_b_of_type_JavaUtilLinkedHashMap.size() == 0) {
          paramViewGroup.setVisibility(8);
        }
        while (this.jdField_a_of_type_Aryk.a())
        {
      ...
      for (;;)
      {
        try
        {
          ...
          paramViewGroup = paramView;
          localarvu.jdField_a_of_type_Boolean = false;
          paramViewGroup = paramView;
        ...
        try
        {
          localarvu.jdField_a_of_type_JavaLangObject = localFavFileInfo;
          ...
          localarvu.jdField_a_of_type_Boolean = false;
          a(localFavFileInfo, localarvu.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView);
          paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692214) + localFavFileInfo.c;
          if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.f())
          {
            ...
            localarvu.jdField_a_of_type_AndroidWidgetImageView.setClickable(true);
            if (this.jdField_a_of_type_Aryk.a(localFavFileInfo))
            {
              paramViewGroup = paramViewGroup + this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692213);
              localarvu.jdField_b_of_type_AndroidWidgetImageView.setVisibility(4);
              localarvu.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845586);
              localarvu.jdField_a_of_type_AndroidWidgetImageView.setClickable(false);
              ...
              paramViewGroup = paramView;
              if (!localarvu.jdField_a_of_type_Boolean) {
                continue;
              }
              paramViewGroup = paramView;
              paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560769, null);
        ...
        catch (Exception localException1)
        {
          ...
          continue;
          paramViewGroup = paramViewGroup + amtj.a(2131708837);
          localException1.jdField_b_of_type_AndroidWidgetImageView.setVisibility(4);
          localException1.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845584);
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new aryj(null));
    return paramViewGroup;
  }
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    aryj localaryj = (aryj)paramView.getTag();
    int i = 0;
    for (;;)
    {
      View localView;
      if (i < 4)
      {
        localView = a(paramInt1, paramInt2 * 4 + i, paramBoolean, localaryj.a[i], paramViewGroup);
        if (localView != null) {}
      }
      else
      {
