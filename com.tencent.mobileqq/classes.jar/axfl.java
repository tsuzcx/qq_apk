...
public class axfl
  extends bhts
{
  public axfl(GameRoomInviteActivity paramGameRoomInviteActivity) {}
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt == 0)
      {
        ...
        this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.setComplete(new axfm(this));
    ...
    {
      this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.a.setText(anni.a(2131703885));
      this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.c();
    ...
    this.a.jdField_a_of_type_Bhtu.a();
    ...
    case 1: 
      do
      {
        ...
        if ((!paramMsgBody.uint64_invite_leader.has()) || (paramMsgBody.uint64_invite_leader.get() == this.a.app.getLongAccountUin()))
        {
          ...
          ((axge)localObject).jdField_a_of_type_JavaLangString = (localPlayerState.uint64_uin.get() + "");
        ...
        {
          ((axge)localObject).jdField_a_of_type_Boolean = bool;
      ...
      this.a.jdField_a_of_type_Axgf.notifyDataSetChanged();
      this.a.a();
      return;
    case 2: 
      ...
      axdz.a(this.a.app.getCurrentAccountUin(), "game_room_last_time", Long.valueOf(bbyp.a()));
      return;
    case 3: 
      label135:
      label250:
      QQToast.a(this.a, anni.a(2131703910), 0).a();
      this.a.finish();
      this.a.jdField_a_of_type_JavaUtilList = null;
      bgsg.a(this.a, this.a.app.getCurrentAccountUin(), false, System.currentTimeMillis());
      return;
    }
    this.a.a(null, anni.a(2131703887), true);
  }
}
