  ...
  public static boolean a(oidb_0x791.RedDotInfo paramRedDotInfo)
  {
    ...
    if (i == 35)
    {
      ...
      if (!TextUtils.isEmpty(paramRedDotInfo)) {
        ...
        {
          yqp.c("TroopRedTouchConfigure", "isStoryDisplayRedDot() APPID_STORY_IMG: Error parse json: ", paramRedDotInfo);
          return true;
        }
      }
      yqp.b("TroopRedTouchConfigure", "isStoryDisplayRedDot() APPID_STORY_IMG: str_custom_buffer is null");
      return true;
    }
    return b(i);
  }
