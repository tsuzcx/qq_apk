...
public class amha
  extends amgw
{
  public amha(QQAppInterface paramQQAppInterface, amgv paramamgv)
  {
    super(paramQQAppInterface, paramamgv, RoamDate.class);
  }
  ...
  {
    paramawge = (RoamDate)paramawge;
    return paramawge.uin + "&" + paramawge.date;
  }
  ...
  public Calendar a(String paramString, Calendar paramCalendar, List<Map.Entry<String, awge>> paramList)
  {
  ...
  public void a(String paramString)
  {
    ...
    paramString = ((awgf)localObject).a(RoamDate.class, false, "uin=?", new String[] { paramString }, null, null, null, null);
    ((awgf)localObject).a();
    if (paramString != null)
    {
      c();
  ...
  public boolean a(String paramString, Calendar paramCalendar, List<Map.Entry<String, awge>> paramList)
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    int j;
  ...
  public Calendar b(String paramString, Calendar paramCalendar, List<Map.Entry<String, awge>> paramList)
  {
    Object localObject3 = null;
    Object localObject2 = null;
    Object localObject1 = paramList;
