...
public class baqk
{
  ...
  public baqk(Context paramContext)
  {
    ...
    this.e = paramContext.getDimensionPixelSize(2131296728);
    this.f = this.e;
    this.g = paramContext.getDimensionPixelOffset(2131296730);
    this.h = paramContext.getDimensionPixelOffset(2131296731);
    this.jdField_a_of_type_Baqo = new baqo();
  ...
  protected View a()
  {
    ...
    this.jdField_a_of_type_Baqo.a((RelativeLayout)localView.findViewById(2131362205));
    ...
    for (int j = 0;; j = 1)
    {
      ...
      for (int k = 0;; k = 1)
      {
        ...
        if (j != 0)
        {
          localObject4 = (GridView)localView.findViewById(2131367614);
        ...
        for (;;)
        {
          ...
          ((GridView)localObject4).setAdapter(new baqm(this.jdField_a_of_type_AndroidContentContext, (List)localObject1));
          ...
          if (k != 0)
          {
            localObject1 = (GridView)localView.findViewById(2131367615);
            if (Build.VERSION.SDK_INT >= 9) {
          ...
          for (;;)
          {
            ...
            ((GridView)localObject1).setNumColumns(i);
            ((GridView)localObject1).setAdapter(new baqm(this.jdField_a_of_type_AndroidContentContext, (List)localObject2));
            ...
            ((TextView)localObject1).setOnClickListener(new baql(this));
            if (j == 0) {
