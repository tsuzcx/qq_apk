...
public class nij
  extends Handler
{
  public nij(PublicAccountAdvertisementActivity paramPublicAccountAdvertisementActivity, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        paramMessage.add(2131379398, PublicAccountAdvertisementActivity.a(this.a));
        paramMessage.commit();
