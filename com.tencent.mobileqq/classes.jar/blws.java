  ...
  implements Handler.Callback
{
  ...
  public blws(Context paramContext, String paramString)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_AndroidOsHandler = new Handler(a().getLooper(), this);
    this.b = paramString;
    this.jdField_a_of_type_Blvs = blvs.a(this.jdField_a_of_type_AndroidContentContext);
    a();
  }
  ...
  {
    blwq.a(paramPluginInfo, a(this.jdField_a_of_type_AndroidContentContext));
  }
  
  private void a(String paramString)
  {
    blwq.a(paramString, a(this.jdField_a_of_type_AndroidContentContext));
  }
      ...
      if (paramPluginInfo.mInstalledPath != null)
      {
        ...
        if (localFile != null)
        {
          ...
          if (localFile.exists())
          {
            ...
            if (localFile.isFile())
            {
              if (!blwq.a(paramPluginInfo, localFile)) {
                break label137;
              }
              bool1 = true;
  ...
  private void c(PluginInfo paramPluginInfo, blwv paramblwv)
  {
    int i = 1;
    String str = paramPluginInfo.mID;
    QLog.d("plugin_tag", 1, "doSetupPlugin." + str);
    if (blwq.a(paramPluginInfo, this.jdField_a_of_type_AndroidContentContext))
    {
  ...
  private boolean c(String paramString)
  {
    ...
    {
      return false;
      paramString = new File(this.b).list(new blwt(this, paramString));
  ...
  private boolean d(String paramString)
  {
    ...
    if ((localPluginInfo != null) && (blwq.a(localPluginInfo, this.jdField_a_of_type_AndroidContentContext)))
    {
      if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    ...
    boolean bool = blwq.a(localFile1);
    File[] arrayOfFile = blwq.a(localFile1);
    int i;
    File localFile2;
    Object localObject;
    if (arrayOfFile != null)
  ...
  public void a(PluginInfo paramPluginInfo, blwv paramblwv)
  {
    paramPluginInfo = new Pair(paramPluginInfo, paramblwv);
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(66816, paramPluginInfo).sendToTarget();
  }
  
  public void a(String paramString, File paramFile, blwv paramblwv)
  {
    int i = 1;
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(paramFile);
    if ((PluginUtils.isOsNeedReleaseDex()) && (blwj.a(paramString) > 1)) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramFile))
        {
          ...
          boolean bool = Dex2Oat.a(localArrayList, localFile, true, paramFile, new blwu(this));
          ...
          bdkt.a(paramString, i, l2);
          l2 = System.currentTimeMillis();
          if (paramblwv != null) {
            paramblwv.a(paramString, "pluginOatCost", l2 - l1);
          }
          if (QLog.isColorLevel()) {
  ...
  public boolean a(PluginInfo paramPluginInfo, blwv paramblwv)
  {
    if (paramPluginInfo == null)
    {
      if (QLog.isColorLevel()) {
    ...
    for (boolean bool = a((PluginInfo)localObject);; bool = false)
    {
      ...
      if (!blwq.a(paramPluginInfo, (File)localObject))
      {
        if (QLog.isColorLevel()) {
  ...
  public boolean a(String paramString, blwv paramblwv)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      if (paramblwv != null) {
        paramblwv.e(paramString);
      }
      return false;
    }
    if (!this.jdField_a_of_type_Blvs.a(paramString))
    {
      if (QLog.isColorLevel()) {
    ...
    boolean bool = false;
    Object localObject3 = this.jdField_a_of_type_Blvs.a(paramString);
    if (localObject3 == null)
    {
      QLog.d("plugin_tag", 1, "plugin not builtin");
      if (paramblwv != null) {
        paramblwv.b(false, paramString);
      }
      return false;
    }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (paramblwv != null) {
        paramblwv.b(true, paramString);
      }
      return true;
    }
    if (paramblwv != null) {
      paramblwv.f(paramString);
    }
    ...
    if (localObject3 != null)
    {
      ...
      try
      {
        ...
        if ((0 == 0) && (bool))
        {
          long l2 = System.currentTimeMillis();
          if (paramblwv != null) {
            paramblwv.a(paramString, "pluginApkCost", l2 - l1);
          }
          i = 0;
          try
          {
            ...
            l2 = System.currentTimeMillis();
            if (paramblwv != null) {
              paramblwv.a(paramString, "pluginLibCost", l2 - l1);
            }
            if (localObject3 != null)
            {
      ...
      if (blwy.a()) {
        a(paramString, (File)localObject1, paramblwv);
      }
  ...
  public void b(PluginInfo paramPluginInfo, blwv paramblwv)
  {
    paramPluginInfo = new Pair(paramPluginInfo, paramblwv);
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(67072, paramPluginInfo).sendToTarget();
  }
  
  public boolean b(PluginInfo paramPluginInfo, blwv paramblwv)
  {
    String str = paramPluginInfo.mID;
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      {
        a(str, new File(PluginUtils.getPluginInstallDir(this.jdField_a_of_type_AndroidContentContext), str), paramblwv);
        paramPluginInfo.mState = 4;
        paramPluginInfo.mFingerPrint = a();
        a(paramPluginInfo);
        if (QLog.isColorLevel()) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 66816: 
      ...
      c((PluginInfo)paramMessage.first, (blwv)paramMessage.second);
      return true;
    }
    paramMessage = (Pair)paramMessage.obj;
    b((PluginInfo)paramMessage.first, (blwv)paramMessage.second);
    return true;
  }
}
