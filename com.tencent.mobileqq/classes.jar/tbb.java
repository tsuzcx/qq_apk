...
public class tbb
{
  ...
  public static void a(List<BaseData> paramList)
  {
    ...
    } while ((((ProteusItemData)localObject).x != 1) || (((ProteusItemData)localObject).g));
  ...
  {
    if ((paramBaseData.t == 26) && ((paramBaseData instanceof ProteusItemData)) && (((ProteusItemData)paramBaseData).x == 1)) {}
    for (boolean bool = true;; bool = false)
    {
      if ((paramBaseData.t == 18) || (paramBaseData.t == 22) || (paramBaseData.t == 0)) {
        bool = true;
      }
      return bool;
    }
