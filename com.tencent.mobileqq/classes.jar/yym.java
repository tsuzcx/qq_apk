  ...
  extends yyn<yya, yya>
{
  ...
  public yym(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
  }
  
  /* Error */
  protected void a(com.tribe.async.async.JobContext paramJobContext, yya paramyya)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 8
    //   3: aload_2
    //   4: getfield 27	yya:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   7: astore 5
    //   9: aload 5
    ...
    //   28: invokespecial 44	yyn:notifyError	(Ljava/lang/Error;)V
    //   31: return
    //   32: aload_0
    //   33: getfield 17	yym:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   36: astore_1
    //   37: aload_1
    //   38: astore 7
    //   40: aload_1
    //   41: ifnonnull +18 -> 59
    //   44: aload_2
    //   45: getfield 47	yya:jdField_a_of_type_Int	I
    //   48: aload_2
    //   49: getfield 50	yya:b	Ljava/lang/String;
    //   52: ldc 52
    //   54: invokestatic 57	yyq:a	(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   57: astore 7
    //   59: aload_2
    //   60: getfield 60	yya:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   63: getfield 65	com/tencent/biz/qqstory/database/PublishVideoEntry:doodleRawPath	Ljava/lang/String;
    //   66: astore 10
    //   68: aload_2
    //   69: getfield 60	yya:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    ...
    //   89: ldc 72
    //   91: aload 7
    //   93: invokestatic 77	ykq:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    //   114: invokestatic 85	zeb:a	(Ljava/io/File;Ljava/io/File;)Z
    //   117: ifeq +52 -> 169
    //   120: aload_2
    //   121: getfield 60	yya:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   124: aload 7
    ...
    //   138: dup
    //   139: aload_2
    //   140: getfield 60	yya:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    ...
    //   159: invokestatic 85	zeb:a	(Ljava/io/File;Ljava/io/File;)Z
    //   162: pop
    //   163: aload_0
    //   164: aload_2
    //   165: invokespecial 95	yyn:notifyResult	(Ljava/lang/Object;)V
    //   168: return
    //   169: ldc 70
    //   171: ldc 97
    //   173: iconst_2
    ...
    //   184: aload 7
    //   186: aastore
    //   187: invokestatic 103	ykq:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   190: iconst_0
    //   191: istore_3
    //   192: goto -61 -> 131
    ...
    //   245: iconst_m1
    //   246: ldc 121
    //   248: invokestatic 126	anvx:a	(I)Ljava/lang/String;
    //   251: invokespecial 40	com/tencent/biz/qqstory/base/ErrorMessage:<init>	(ILjava/lang/String;)V
    //   254: invokespecial 44	yyn:notifyError	(Ljava/lang/Error;)V
    //   257: return
    //   258: astore_1
    //   259: ldc 70
    //   261: ldc 128
    //   263: aload_1
    //   264: invokestatic 131	ykq:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   267: aload 6
    //   269: astore_1
    //   270: goto -34 -> 236
    //   273: astore 6
    ...
    //   283: ldc 133
    //   285: aload 6
    //   287: invokestatic 131	ykq:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   290: aload 5
    //   292: ifnull +405 -> 697
    //   295: aload 5
    ...
    //   308: ldc 128
    //   310: aload_1
    //   311: invokestatic 131	ykq:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   314: aconst_null
    //   315: astore_1
    //   316: goto -80 -> 236
    //   319: astore 6
    ...
    //   329: ldc 135
    //   331: aload 6
    //   333: invokestatic 131	ykq:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   336: aload 5
    //   338: ifnull +359 -> 697
    //   341: aload 5
    ...
    //   354: ldc 128
    //   356: aload_1
    //   357: invokestatic 131	ykq:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   360: aconst_null
    //   361: astore_1
    //   362: goto -126 -> 236
    //   365: astore_2
    ...
    //   381: ldc 128
    //   383: aload_1
    //   384: invokestatic 131	ykq:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   387: goto -11 -> 376
    //   390: aload 10
    //   392: ifnull +299 -> 691
    //   395: aload 10
    //   397: aconst_null
    //   398: invokestatic 140	zdr:a	(Ljava/lang/String;Lzds;)Landroid/graphics/Bitmap;
    //   401: astore 5
    //   403: ldc 70
    //   405: ldc 142
    //   407: iconst_1
    ...
    //   413: aload 10
    //   415: aastore
    //   416: invokestatic 103	ykq:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   419: aload 5
    ...
    //   441: aload_1
    //   442: aload 6
    //   444: invokestatic 149	zdr:b	(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    //   447: astore 5
    //   449: aload 6
    ...
    //   477: ldc 156
    //   479: aload 6
    //   481: invokestatic 159	ykq:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   484: goto -65 -> 419
    //   487: astore 6
    //   489: ldc 70
    ...
    //   516: aload 6
    //   518: invokestatic 159	ykq:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   521: aload 5
    //   523: astore 6
    //   525: goto -89 -> 436
    //   528: aload_1
    ...
    //   561: invokestatic 183	ykq:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   564: goto -103 -> 461
    //   567: getstatic 187	vzh:e	Ljava/lang/String;
    //   570: invokestatic 190	zeb:a	(Ljava/lang/String;)Z
    //   573: pop
    //   574: aload_1
    //   575: aload 7
    //   577: invokestatic 193	zdr:a	(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    //   580: istore 4
    //   582: aload_1
    ...
    //   588: ifeq +42 -> 630
    //   591: aload_2
    //   592: getfield 60	yya:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   595: aload 7
    ...
    //   622: invokestatic 197	ykq:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   625: iconst_1
    //   626: istore_3
    //   627: goto -496 -> 131
    //   630: ldc 70
    //   632: ldc 199
    //   634: invokestatic 201	ykq:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   637: iconst_0
    //   638: istore_3
    //   639: goto -508 -> 131
    //   642: aload_0
    ...
    //   647: iconst_m1
    //   648: ldc 202
    //   650: invokestatic 126	anvx:a	(I)Ljava/lang/String;
    //   653: invokespecial 40	com/tencent/biz/qqstory/base/ErrorMessage:<init>	(ILjava/lang/String;)V
    //   656: invokespecial 44	yyn:notifyError	(Ljava/lang/Error;)V
    //   659: return
    //   660: astore 6
    //   662: aload 5
    //   664: astore_1
