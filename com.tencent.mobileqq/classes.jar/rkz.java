...
public class rkz
  implements ISuperPlayer.OnCaptureImageListener, ISuperPlayer.OnErrorListener, ISuperPlayer.OnInfoListener, ISuperPlayer.OnSeekCompleteListener, ISuperPlayer.OnVideoPreparedListener, rky
{
  ...
  private SparseArray<rku> jdField_b_of_type_AndroidUtilSparseArray = new SparseArray();
  ...
  public void a(rku paramrku, rkw paramrkw)
  {
    try
    {
      int i = this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer.captureImageInTime(paramrku.c, paramrku.d, paramrku.e, 0, 0, 300);
      paramrku.a = i;
      this.jdField_b_of_type_AndroidUtilSparseArray.put(i, paramrku);
      this.jdField_a_of_type_AndroidUtilSparseArray.put(i, paramrkw);
      if (QLog.isColorLevel()) {
        QLog.d("PlayerCaptureProxy", 2, "PlayerCaptureProxy try capture captureTask:" + paramrku);
      }
      return;
    }
    catch (IllegalAccessException paramrkw)
    {
      for (;;)
      {
        paramrkw.printStackTrace();
      }
    }
    finally {}
  }
  ...
  public void onCaptureImageFailed(ISuperPlayer paramISuperPlayer, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (paramInt2 < this.jdField_a_of_type_AndroidUtilSparseArray.size())
      {
        ...
        {
          paramISuperPlayer = (rkw)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt1);
  ...
  public void onCaptureImageSucceed(ISuperPlayer paramISuperPlayer, int paramInt1, int paramInt2, int paramInt3, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt2 < this.jdField_a_of_type_AndroidUtilSparseArray.size())
      {
        ...
        {
          paramISuperPlayer = (rkw)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt1);
          rku localrku = (rku)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt1);
          this.jdField_b_of_type_AndroidUtilSparseArray.remove(paramInt1);
          if (paramISuperPlayer != null) {
            paramISuperPlayer.a(paramBitmap, localrku);
          }
          this.jdField_a_of_type_AndroidUtilSparseArray.remove(paramInt1);
        }
      }
  ...
  {
    bijk.c(new PlayerCaptureProxy.2(this));
  }
}
