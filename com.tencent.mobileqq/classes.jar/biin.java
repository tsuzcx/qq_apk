...
public class biin
{
  ...
  public biin a()
  {
    biin localbiin = new biin();
    localbiin.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.putAll(this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap);
    return localbiin;
  }
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    biij.a = a("mod", paramJSONObject.optString("from", biij.a));
    biij.d = a("land_page", paramJSONObject.optString("land_page_id", biij.d));
    biij.b = a("obj_ownerid", paramJSONObject.optString("obj_ownerid", biij.b));
    biij.e = a("obj_pos", paramJSONObject.optString("pos", ""));
    biij.f = a("detailpage_from", biij.a(paramJSONObject.optString("detailpage_from"), paramJSONObject.optString("prepage")));
    biij.g = a("algo_id", paramJSONObject.optString("algo_id", "0"));
  }
