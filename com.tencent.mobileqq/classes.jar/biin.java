  ...
  extends biim
{
  ...
  public int a()
  {
    ...
    if (biij.a() < 5)
    {
      ...
      if (System.currentTimeMillis() > biij.a() + 10000L)
      {
        biij.a();
        biij.b();
        biij.a(l);
    ...
    for (;;)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("SwiftBrowserIdleTaskHelper", 2, "not need check because time limit:" + l + " - " + biij.a() + " < 10s.");
        continue;
        if (QLog.isColorLevel()) {
          QLog.d("SwiftBrowserIdleTaskHelper", 2, "not need check because count limit:" + biij.a() + ">=" + 5 + ".");
        }
      }
    }
  }
