...
public final class tzg
  extends tyg
{
  public static final tzh a = new tzh(null);
  
  public tzg(@NotNull BridgeModule paramBridgeModule)
  {
      ...
      for (;;)
      {
        ...
        if ((localActivity != null) && (localObject != null)) {
          try
          {
            ...
            paramJSONObject = bhey.a((QQAppInterface)localObject, (Context)localActivity, paramJSONObject);
            if (paramJSONObject == null) {
              break;
            }
  ...
  public void a()
  {
    a("jumpAction", (Function2)new SchemaBridgeInvokeHandler.register.1((tzg)this));
  }
}
