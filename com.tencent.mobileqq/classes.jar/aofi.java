...
{
  public aofi(ColorNoteSmallScreenService paramColorNoteSmallScreenService) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      this.a.jdField_a_of_type_Aoev.a(paramContext);
      this.a.jdField_a_of_type_ComTencentMobileqqColornoteSmallscreenColorNoteSmallScreenRelativeLayout.a(paramContext);
      break label584;
      paramContext = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a();
      if ((aocd.a()) || (((paramContext.size() != 1) || (!aocr.b((ColorNote)paramContext.get(0)))) && (paramContext.size() != 0))) {
        break label584;
      }
      this.a.f();
      break label584;
