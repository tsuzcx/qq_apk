...
public class bihe
{
  private static Intent a(BaseActivity paramBaseActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    {
      bbcv.a(paramBaseActivity, 230).setMessage("系统版本过低，不支持短视频功能").setPositiveButton(2131694793, new bihf()).show();
      return null;
    }
    if (paramQQAppInterface.c())
    {
      bcpw.a(BaseApplicationImpl.getContext(), 2131696181, 1).b(BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131298865));
      return null;
    }
  ...
  private static Intent a(BaseActivity paramBaseActivity, boolean paramBoolean1, QQAppInterface paramQQAppInterface, boolean paramBoolean2)
  {
    ...
    for (paramBaseActivity = paramBaseActivity.getIntent();; paramBaseActivity = new Intent())
    {
      ...
      paramBaseActivity.putExtra("extra_now_tab", sxp.a());
      bkpd.a("start activity");
  ...
  private static void a(BaseActivity paramBaseActivity, Intent paramIntent, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (axlc.a() == 2)
    {
      CaptureQmcfSoDownloadActivity.a(paramBaseActivity, bihm.class.getName(), paramIntent.getExtras(), 11000);
      return;
    }
    if (paramInt3 != -1)
    {
