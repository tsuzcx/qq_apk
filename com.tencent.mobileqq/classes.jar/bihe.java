...
public class bihe
{
  ...
  {
    return bihg.a().a("contentboxlaunch", "gocontentboxminiprogram", 0);
  }
  ...
  public static void a(bihf parambihf)
  {
    if (parambihf != null) {
      QzoneHandlerThreadFactory.getHandlerThread("Normal_HandlerThread").post(new QZoneConfigHelper.1(parambihf));
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    try
    {
      boolean bool = ((aubo)paramQQAppInterface.getManager(10)).b();
      return bool;
    }
