  ...
  extends bign
{
  ...
  public boolean a(Intent paramIntent)
  {
    ...
    if ((!TextUtils.isEmpty(str1)) && (uuc.c(str1)) && (!(localActivity instanceof PublicAccountBrowser)) && (!(localActivity instanceof ReadInJoyArticleDetailActivity)) && (!(localActivity instanceof PublicAccountAdvertisementActivity)))
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("SwiftBrowserNavigator", 1, "shouldNavigate to  PublicAccountBrowser, url: " + nwo.b(str1, new String[0]));
      }
    }
    do
    {
      ...
      {
        return false;
        if ((!uuc.e(str1)) || ((localActivity instanceof PublicAccountBrowser)) || ((localActivity instanceof ReadInJoyArticleDetailActivity)) || ((localActivity instanceof PublicAccountAdvertisementActivity))) {
          break;
        }
        paramIntent = new Intent(paramIntent);
        paramIntent.setComponent(new ComponentName(localActivity, PublicAccountBrowser.class));
      ...
      QLog.d("SwiftBrowserNavigator", 1, "shouldNavigate to  PublicAccountBrowser, url: " + nwo.b(str1, new String[0]));
      return false;
      if ((TextUtils.isEmpty(str1)) || (!uuc.f(str1)) || ((localActivity instanceof PublicAccountBrowser)) || ((localActivity instanceof ReadInJoyArticleDetailActivity)) || ((localActivity instanceof PublicAccountAdvertisementActivity))) {
        break;
      }
      paramIntent = new Intent(paramIntent);
      paramIntent.setComponent(new ComponentName(localActivity, PublicAccountBrowser.class));
    ...
    QLog.d("SwiftBrowserNavigator", 1, "KanDian URL shouldNavigate to  PublicAccountBrowser, url: " + nwo.b(str1, new String[0]));
    return false;
    if (amfb.a(str1)) {
      try
      {
        ...
        {
          String str2 = amfb.a(str1);
          if (!TextUtils.isEmpty(str2))
          {
            amfb.a(localActivity, str2);
            return false;
          }
        }
      }
