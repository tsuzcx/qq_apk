...
{
  public static final ClassicTypeCheckerContext.Companion Companion = new ClassicTypeCheckerContext.Companion(null);
  ...
  public ClassicTypeCheckerContext(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, @NotNull KotlinTypeRefiner paramKotlinTypeRefiner)
  {
    this.errorTypeEqualsToAnything = paramBoolean1;
    this.stubTypeEqualsToAnything = paramBoolean2;
    this.allowedTypeVariable = paramBoolean3;
    this.kotlinTypeRefiner = paramKotlinTypeRefiner;
  }
  
  public boolean areEqualTypeConstructors(@NotNull TypeConstructor paramTypeConstructor1, @NotNull TypeConstructor paramTypeConstructor2)
  {
    ...
    if ((paramTypeConstructor1 instanceof IntegerLiteralTypeConstructor)) {
      return ((IntegerLiteralTypeConstructor)paramTypeConstructor1).checkConstructor(paramTypeConstructor2);
    }
    if ((paramTypeConstructor2 instanceof IntegerLiteralTypeConstructor)) {
      return ((IntegerLiteralTypeConstructor)paramTypeConstructor2).checkConstructor(paramTypeConstructor1);
    }
    return Intrinsics.areEqual(paramTypeConstructor1, paramTypeConstructor2);
  }
  
  public boolean areEqualTypeConstructors(@NotNull TypeConstructorMarker paramTypeConstructorMarker1, @NotNull TypeConstructorMarker paramTypeConstructorMarker2)
  {
  ...
  public boolean isAllowedTypeVariable(@NotNull KotlinTypeMarker paramKotlinTypeMarker)
  {
    Intrinsics.checkParameterIsNotNull(paramKotlinTypeMarker, "$this$isAllowedTypeVariable");
    return ((paramKotlinTypeMarker instanceof UnwrappedType)) && (this.allowedTypeVariable) && ((((UnwrappedType)paramKotlinTypeMarker).getConstructor() instanceof NewTypeVariableConstructor));
  }
  ...
  @NotNull
  public AbstractTypeCheckerContext.SupertypesPolicy.DoCustomTransform substitutionSupertypePolicy(@NotNull SimpleTypeMarker paramSimpleTypeMarker)
  {
    Intrinsics.checkParameterIsNotNull(paramSimpleTypeMarker, "type");
 ...
 * Qualified Name:     kotlin.reflect.jvm.internal.impl.types.checker.ClassicTypeCheckerContext
