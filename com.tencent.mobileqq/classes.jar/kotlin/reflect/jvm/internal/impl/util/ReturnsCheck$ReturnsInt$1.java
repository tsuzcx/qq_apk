...
final class ReturnsCheck$ReturnsInt$1
  extends Lambda
  implements Function1<KotlinBuiltIns, SimpleType>
{
  ...
  public final SimpleType invoke(@NotNull KotlinBuiltIns paramKotlinBuiltIns)
  {
    ...
    paramKotlinBuiltIns = paramKotlinBuiltIns.getIntType();
    Intrinsics.checkExpressionValueIsNotNull(paramKotlinBuiltIns, "intType");
 ...
 * Qualified Name:     kotlin.reflect.jvm.internal.impl.util.ReturnsCheck.ReturnsInt.1
