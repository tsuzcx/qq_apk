  ...
  implements Function1<SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder, Unit>
{
  ...
  public final void invoke(@NotNull SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder paramFunctionEnhancementBuilder)
  {
    ...
    paramFunctionEnhancementBuilder.parameter(this.$JFBiFunction$inlined, new JavaTypeQualifiers[] { PredefinedEnhancementInfoKt.access$getNOT_PLATFORM$p(), PredefinedEnhancementInfoKt.access$getNOT_PLATFORM$p(), PredefinedEnhancementInfoKt.access$getNOT_NULLABLE$p(), PredefinedEnhancementInfoKt.access$getNULLABLE$p() });
 ...
 * Qualified Name:     kotlin.reflect.jvm.internal.impl.load.java.typeEnhancement.PredefinedEnhancementInfoKt..special..inlined.enhancement.lambda.14
