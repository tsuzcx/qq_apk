...
final class JavaVisibilities$1
  extends Visibility
{
  JavaVisibilities$1(String paramString, boolean paramBoolean)
  {
  ...
  public boolean isVisible(@Nullable ReceiverValue paramReceiverValue, @NotNull DeclarationDescriptorWithVisibility paramDeclarationDescriptorWithVisibility, @NotNull DeclarationDescriptor paramDeclarationDescriptor)
  {
    ...
    return JavaVisibilities.access$000(paramDeclarationDescriptorWithVisibility, paramDeclarationDescriptor);
  }
 ...
 * Qualified Name:     kotlin.reflect.jvm.internal.impl.load.java.JavaVisibilities.1
