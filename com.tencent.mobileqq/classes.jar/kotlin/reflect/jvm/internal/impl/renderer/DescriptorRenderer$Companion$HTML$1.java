...
final class DescriptorRenderer$Companion$HTML$1
  extends Lambda
  implements Function1<DescriptorRendererOptions, Unit>
{
  ...
  public final void invoke(@NotNull DescriptorRendererOptions paramDescriptorRendererOptions)
  {
    ...
    paramDescriptorRendererOptions.setTextFormat(RenderingFormat.HTML);
 ...
 * Qualified Name:     kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer.Companion.HTML.1
