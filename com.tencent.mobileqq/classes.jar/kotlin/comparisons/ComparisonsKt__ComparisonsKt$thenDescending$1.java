...
final class ComparisonsKt__ComparisonsKt$thenDescending$1<T>
  implements Comparator<T>
{
  ComparisonsKt__ComparisonsKt$thenDescending$1(Comparator paramComparator1, Comparator paramComparator2) {}
  
  public final int compare(T paramT1, T paramT2)
  {
    int i = this.$this_thenDescending.compare(paramT1, paramT2);
    if (i != 0) {
      return i;
    }
