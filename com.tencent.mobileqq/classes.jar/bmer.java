...
public class bmer
{
  ...
  private bmeg jdField_a_of_type_Bmeg = new bmes(this);
  private bmew jdField_a_of_type_Bmew;
  private JsCallParams jdField_a_of_type_CooperationQqreaderJsJsCallParams;
  
  public bmer(Activity paramActivity)
  {
  ...
  private Intent a(Activity paramActivity, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (paramActivity == null)
      {
        ...
        paramBundle.putExtras(bmea.a(paramBundle, 1));
      }
    ...
    String str2 = bmgr.a(paramActivity);
    if (l2 != 0L) {}
    for (paramBundle = String.valueOf(l2);; paramBundle = "")
    {
      bmgp.a(str1, str2, "2198", paramBundle, "2", "");
      paramActivity = a(paramActivity);
  ...
  private View a()
  {
    ...
    localTextView.setText(2131693680);
    ...
    bmez.a().a(this.jdField_a_of_type_AndroidAppActivity, localImageView);
  ...
  {
    boolean bool = bmfw.a();
    bmgm.e("ReaderSplashImpl", "jumpToPlugin: isUseShadow = " + bool);
    if (bool)
    {
      bmfw.a(this.jdField_a_of_type_AndroidAppActivity, paramIntent, "com.qqreader.pureader.SSReaderActivity", new bmeu(this));
      return;
    }
  ...
  private void a(View paramView)
  {
    ...
    {
      bmgm.a("ReaderSplashImpl", "showLoadingView: mContentView == null");
      return;
    }
  ...
  private void a(JsCallParams paramJsCallParams)
  {
    if (bmef.a().a())
    {
      ReaderJsPluginProxy localReaderJsPluginProxy = bmef.a().a(new bmet(this));
      ...
      for (;;)
      {
        d();
        return;
        bmgm.a("ReaderSplashImpl", "checkPluginForHandleSpecialJsCall: plugin is ready but jsPluginProxy is null");
      }
    }
  ...
  private void b(@NonNull Bundle paramBundle)
  {
    if (this.jdField_a_of_type_AndroidAppActivity == null) {
      bmgm.a("ReaderSplashImpl", "doJump: activity is null");
    }
    Intent localIntent;
    do
    {
    ...
    localIntent.putExtra("login_interval", bmgr.a(BaseApplicationImpl.getApplication()));
  ...
  private void c()
  {
    ...
    {
      bmgm.a("ReaderSplashImpl", "handlePendingJumpPluginIntent: mPendingJumpPluginIntent == null");
      return;
    }
    ...
    {
      bmgm.b("ReaderSplashImpl", "handlePendingJumpPluginIntent: activity is destroyed");
      return;
    }
    bmea.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidContentIntent, "com.qqreader.pureader.SSReaderActivity", new bmev(this));
  ...
  public void a()
  {
    bmgm.d("ReaderSplashImpl", "onCreate");
    Object localObject = new IntentFilter();
    ((IntentFilter)localObject).addAction("cooperation.qqreader.start_reader_act_completed");
    if (this.jdField_a_of_type_Bmew == null)
    {
      this.jdField_a_of_type_Bmew = new bmew(this, null);
      this.jdField_a_of_type_AndroidAppActivity.registerReceiver(this.jdField_a_of_type_Bmew, (IntentFilter)localObject);
    }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Bmew != null)
    {
      this.jdField_a_of_type_AndroidAppActivity.unregisterReceiver(this.jdField_a_of_type_Bmew);
      this.jdField_a_of_type_Bmew = null;
    }
  }
}
