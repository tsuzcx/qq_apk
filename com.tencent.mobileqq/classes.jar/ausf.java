  ...
  implements bdde
{
  ...
  public ausf(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt, long paramLong2, long paramLong3, boolean paramBoolean, long paramLong4)
  {
    ...
    do
    {
      ...
      return;
      str1 = ContactUtils.getTroopMemberName(paramQQAppInterface, String.valueOf(paramLong1), String.valueOf(paramLong4));
    } while (TextUtils.isEmpty(str1));
    String str1 = String.format(paramQQAppInterface.getApp().getString(2131698680), new Object[] { str1 });
    if (paramBoolean)
    {
      a(paramQQAppInterface, paramLong1, 1, str1, paramInt, paramLong2, paramLong3, 131092);
      return;
    }
    String str2 = paramQQAppInterface.getApp().getString(2131698679);
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, String paramString, int paramInt2, long paramLong2, long paramLong3, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    do
    {
      ...
      paramString = new aucf((String)localObject, (String)localObject, paramString, paramInt1, i, paramInt3, bbko.a());
      ...
      bool = aucg.a(paramQQAppInterface, (MessageForUniteGrayTip)localObject);
    } while (!QLog.isColorLevel());
  ...
  {
    bddf localbddf = ((bdct)this.a.getManager(339)).a(2, 1, paramString);
    if ((localbddf instanceof WatchTogetherSession))
    {
      localbddf.g = 3;
      localbddf.jdField_h_of_type_Int = 3;
      bddg.a(this.a, paramString, false);
      a(true, (WatchTogetherSession)localbddf, 1007, "");
    }
  }
    ...
    do
    {
      ...
      if (localVideoChangePushInfo != null)
      {
        ...
        for (paramObject = localVideoChangePushInfo.bytes_gray_tips.get().toStringUtf8();; paramObject = null)
        {
          ...
          long l4 = ((bdct)paramQQAppInterface.getManager(339)).a(2, 1, l2);
          if (l1 >= l4) {
            break label414;
          }
          if (!QLog.isColorLevel()) {
        ...
        WatchTogetherSession localWatchTogetherSession = (WatchTogetherSession)bddg.a(2, 1, String.valueOf(l2));
        String str;
        if (i == 1)
        {
          if (l3 == -1L)
  ...
  public void a(QQAppInterface paramQQAppInterface, WatchTogetherSession paramWatchTogetherSession, int paramInt, long paramLong1, String paramString, long paramLong2, long paramLong3, TroopTips0x857.VideoChangePushInfo paramVideoChangePushInfo)
  {
    ...
    localbdct.a(2, 1, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramLong2);
    WatchTogetherSession localWatchTogetherSession2 = (WatchTogetherSession)localbdct.a(paramWatchTogetherSession.jdField_d_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_JavaLangString);
    ...
    if (localWatchTogetherSession2 != null)
    {
      ...
      if (paramQQAppInterface.getCurrentAccountUin().equals(String.valueOf(paramLong1)))
      {
        ...
        bddg.a(paramQQAppInterface, localWatchTogetherSession1.jdField_e_of_type_JavaLangString, true);
      }
    }
    for (;;)
    {
      ...
      {
        paramQQAppInterface = localbdct.a(2, 1, localWatchTogetherSession1.jdField_e_of_type_JavaLangString, 1003);
        ...
        localbdct.a(2, 1, localWatchTogetherSession1.jdField_e_of_type_JavaLangString, 1003);
      }
      return;
      localbdct.a(paramWatchTogetherSession.jdField_d_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramWatchTogetherSession);
      localWatchTogetherSession1 = paramWatchTogetherSession;
      break;
      label277:
      if (paramInt == 2) {
        bddg.a(paramQQAppInterface, localWatchTogetherSession1.jdField_e_of_type_JavaLangString, false);
      }
    }
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, aio_media.RspLatestPlayingState paramRspLatestPlayingState)
  {
    ...
    paramToServiceMsg = (WatchTogetherSession)localbdct.a(2, 1, str);
    Object localObject = paramToServiceMsg;
    if (paramToServiceMsg == null)
    {
      localObject = (WatchTogetherSession)bddg.a(2, 1, str);
      localbdct.a(2, 1, str, (bddf)localObject);
    }
    boolean bool1;
    label470:
    boolean bool2;
    if (((WatchTogetherSession)localObject).a())
    {
      ...
      {
        ContactUtils.getTroopMemberName(this.a, ((WatchTogetherSession)localObject).jdField_e_of_type_JavaLangString, ((WatchTogetherSession)localObject).jdField_f_of_type_JavaLangString);
        bool2 = bool1;
        paramRspLatestPlayingState = paramToServiceMsg;
      }
    }
  ...
  {
    bdct localbdct = (bdct)this.a.getManager(339);
    Object localObject = localbdct.a(2, 1, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramInt);
    if ((paramBoolean) && (paramInt == 1003) && ((((bdcz)localObject).jdField_a_of_type_JavaLangObject instanceof TroopTips0x857.VideoChangePushInfo)))
    {
      int i = ((bdcz)localObject).jdField_a_of_type_AndroidOsBundle.getInt("action_type");
      String str = ((bdcz)localObject).jdField_a_of_type_AndroidOsBundle.getString("tips");
      long l1 = ((bdcz)localObject).jdField_a_of_type_AndroidOsBundle.getLong("seq");
      long l2 = ((bdcz)localObject).jdField_a_of_type_AndroidOsBundle.getLong("msgSeq");
      localbdct.a(paramWatchTogetherSession, i, str, l1, l2, (TroopTips0x857.VideoChangePushInfo)((bdcz)localObject).jdField_a_of_type_JavaLangObject);
      localbdct.b(paramWatchTogetherSession, i, str, l1, l2, (TroopTips0x857.VideoChangePushInfo)((bdcz)localObject).jdField_a_of_type_JavaLangObject);
    }
    boolean bool1;
    label201:
    boolean bool2;
    ...
    {
      bddg.a(this.a, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, false);
      if ((paramWatchTogetherSession.g == 1) && (paramWatchTogetherSession.jdField_h_of_type_Int == 2))
      {
        ...
        bool2 = true;
        label224:
        if ((!bool1) || (!bool2) || (!aurn.b(paramWatchTogetherSession.jdField_d_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramWatchTogetherSession.jdField_e_of_type_Int))) {
          break label561;
        }
        if (QLog.isColorLevel()) {
        ...
        if ((!((TroopManager)this.a.getManager(52)).c(paramWatchTogetherSession.jdField_e_of_type_JavaLangString).isAdmin()) && (!paramWatchTogetherSession.jdField_f_of_type_JavaLangString.equals(this.a.getCurrentUin()))) {
          break label552;
        }
        ((WatchTogetherFloatingData)localObject).setIsAdm(true);
        label360:
        aurn.a(BaseApplicationImpl.context, (WatchTogetherFloatingData)localObject);
      }
    }
    for (;;)
    {
      ...
      localbdct.a(paramBoolean, paramWatchTogetherSession, paramInt, paramString);
      localbdct.b(2, 1, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramInt);
      return;
      bddg.a(this.a, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, true);
      break;
      label540:
      bool1 = false;
      break label201;
      ...
      break label360;
      label561:
      if (aurn.b(paramWatchTogetherSession.jdField_d_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramWatchTogetherSession.jdField_e_of_type_Int))
      {
        if (QLog.isColorLevel()) {
          QLog.d("WatchTogetherParser", 1, "isSameFloatingInfo but param error isSupportRoomType=" + bool1 + " isUrlValid=" + bool2);
        }
        aurn.a(false, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramWatchTogetherSession.jdField_e_of_type_Int, false);
      }
    }
  }
}
