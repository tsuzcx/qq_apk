...
public class sfe
{
  ...
  private static QQHashMap<Integer, sff> jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap;
  ...
  public static Drawable a(Context paramContext, int paramInt)
  {
    ...
    case 1: 
      return paramContext.getResources().getDrawable(2130840073);
    }
    return paramContext.getResources().getDrawable(2130840078);
  }
  ...
  {
    sff localsff = a(paramQQAppInterface, paramContext, paramInt);
    if (localsff != null) {
      return localsff.a();
    }
  ...
  public static sff a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt)
  {
    int i1 = paramInt;
    if (paramInt == 3) {
      i1 = 2;
    ...
    return (sff)jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.get(Integer.valueOf(i1));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localSharedPreferences != null)
    {
      ...
      localSet = bbkc.a(localSharedPreferences, "big_data_share_channel_urls", null);
      if (localSet != null) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    if (!a(paramQQAppInterface, paramContext, bbkb.e(paramContext)))
    {
      localObject = new sff(paramQQAppInterface, paramContext, 1, 2131696730, 2130840073);
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(1), localObject);
    }
    Object localObject = bbkb.h(paramContext);
    String str = bbkb.i(paramContext);
    if ((TextUtils.isEmpty((CharSequence)localObject)) || (TextUtils.isEmpty(str)))
    {
      paramQQAppInterface = new sff(paramQQAppInterface, paramContext, 2, 2131695580, 2130840078);
    ...
    for (;;)
    {
      ...
      return;
      paramQQAppInterface = new sff(paramQQAppInterface, paramContext, 2, (String)localObject, str);
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(2), paramQQAppInterface);
    }
  }
  ...
  public static void a(ArrayList<sff> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        sff localsff = (sff)paramArrayList.next();
        jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(localsff.jdField_a_of_type_Int), localsff);
      }
    }
  }
    ...
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        while (i1 < i2)
        {
          ...
          localObject = new sff(paramQQAppInterface, paramContext, i3, ((Element)localObject).getElementsByTagName("name").item(0).getFirstChild().getNodeValue(), ((Element)localObject).getElementsByTagName("icon").item(0).getFirstChild().getNodeValue());
          if (jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap == null) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          scr.a(paramQQAppInterface, bool, (String)localObject1);
          scr.b(paramQQAppInterface, i1);
          if (i3 == 1)
          {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          scr.a(paramQQAppInterface, bool);
          scr.c(paramQQAppInterface, i1);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          bbkb.b((Context)localObject1, bool);
        }
        localObject1 = paramString.getElementsByTagName("channel_version");
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          i1 = Integer.valueOf(((Element)((NodeList)localObject1).item(0)).getFirstChild().getNodeValue()).intValue();
          i2 = bhvy.b(paramQQAppInterface);
          if (i1 <= i2) {
            break label2992;
          }
          ...
          bhvy.a(paramQQAppInterface, i3, (String)localObject2, i4);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          bbkb.c((Context)localObject1, bool);
          localObject1 = qvk.a();
          if (i1 != 0) {
            break label3033;
          }
          bool = true;
          ((qvk)localObject1).a(bool);
          if (QLog.isColorLevel()) {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          bhvy.b(paramQQAppInterface, bool);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          bbkb.a((Context)localObject1, bool, paramQQAppInterface.c());
          if (QLog.isColorLevel()) {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          bhvy.d(paramQQAppInterface, bool);
        }
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bhvy.h(paramQQAppInterface, bool);
        }
  ...
  public static String b(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt)
  {
    ...
    default: 
      return null;
    case 1: 
      return paramContext.getString(2131696730);
    }
    return paramContext.getString(2131695580);
  }
  ...
  public static boolean b()
  {
    return "1".equals((String)xfo.a().a("subscribe_entrance_enable", "0"));
  }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if ((localObject != null) && (((NodeList)localObject).getLength() > 0))
          {
            ...
            if (i1 > bbkb.y(paramQQAppInterface.getApp()))
            {
              ...
              if ((!TextUtils.isEmpty((CharSequence)localObject)) && (!TextUtils.isEmpty(paramString))) {
                bbkb.a(paramQQAppInterface.getApp(), (String)localObject, paramString);
              }
              bbkb.p(paramQQAppInterface.getApp(), i1);
              return false;
            }
          }
        }
  ...
  {
    return (String)xfo.a().a("subscribe_account_title", xfo.jdField_c_of_type_JavaLangString);
  }
  ...
  public static boolean c()
  {
    String str1 = (String)xfo.a().a("subscribe_entrance_enable", "0");
    String str2 = (String)xfo.a().a("newfollowlist", "1");
