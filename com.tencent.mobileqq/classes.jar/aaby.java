...
public class aaby
  extends zxu<CertifiedAccountMeta.StFollowRcmd>
{
  public static int a;
  ...
  public aaby(Bundle paramBundle)
  {
    super(paramBundle);
  ...
  {
    paramViewGroup = LayoutInflater.from(getContext()).inflate(2131558763, paramViewGroup, false);
    URLImageView localURLImageView = (URLImageView)paramViewGroup.findViewById(2131369261);
    ...
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      ((TextView)paramViewGroup.findViewById(2131380030)).setTextColor(-10132123);
      paramViewGroup.findViewById(2131365599).setBackgroundColor(-14540254);
  ...
  {
    aaxb.b("auth_follow", "exp_more", 0, 0, new String[0]);
    paramViewGroup = LayoutInflater.from(getContext()).inflate(2131558762, paramViewGroup, false);
    LinearLayout localLinearLayout = (LinearLayout)paramViewGroup.findViewById(2131370129);
    ...
    for (int i = -13224394;; i = -460552)
    {
      ...
      localLinearLayout.setOnClickListener(new aabz(this));
      if (this.jdField_c_of_type_Boolean) {
        ((TextView)paramViewGroup.findViewById(2131380029)).setTextColor(-5723992);
      }
      return paramViewGroup;
    }
  }
  ...
  protected void getItemOffsets(Rect paramRect, View paramView, RecyclerView paramRecyclerView, RecyclerView.State paramState)
  {
    ...
    while (paramView.getId() != 2131376804) {
      return;
    }
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      ((aaca)paramViewHolder).a(localStFollowRcmd, i);
    }
  }
  ...
  {
    if (paramInt == 100000) {
      return new aaca(this, a(paramViewGroup));
    }
    if (paramInt == 100001) {
      return new aaca(this, b(paramViewGroup));
    }
    ...
    return new aaca(this, paramViewGroup);
  }
