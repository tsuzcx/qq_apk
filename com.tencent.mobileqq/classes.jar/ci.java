  ...
  implements View.OnClickListener
{
  ...
  private ci(LiteMutiPicViewerActivity paramLiteMutiPicViewerActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      if (!LiteMutiPicViewerActivity.a(this.jdField_a_of_type_ComDatalineActivitiesLiteMutiPicViewerActivity).isTimeOut())
      {
        ...
        paramView = String.format(this.jdField_a_of_type_ComDatalineActivitiesLiteMutiPicViewerActivity.app.getApp().getString(2131427593), new Object[] { Integer.valueOf(i), Integer.valueOf(i - paramInt) });
      ...
      paramView = String.format(this.jdField_a_of_type_ComDatalineActivitiesLiteMutiPicViewerActivity.app.getApp().getString(2131427594), new Object[] { Integer.valueOf(i), Integer.valueOf(i - paramInt) });
      LiteMutiPicViewerActivity.a(this.jdField_a_of_type_ComDatalineActivitiesLiteMutiPicViewerActivity).setWaitText(paramView);
      break;
      if (paramInt <= LiteMutiPicViewerActivity.a(this.jdField_a_of_type_ComDatalineActivitiesLiteMutiPicViewerActivity).getTotalCount() - 1) {
        break label403;
    ...
    if (paramView == null)
    {
      ...
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130969989, null);
      paramViewGroup.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131364284));
      paramViewGroup.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131364110);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368676));
      paramViewGroup.jdField_a_of_type_ComDatalineUtilWidgetAsyncImageView = ((AsyncImageView)paramView.findViewById(2131361846));
