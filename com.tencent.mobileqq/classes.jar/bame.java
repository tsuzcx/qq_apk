...
public abstract class bame
  extends ProtocolDownloader.Adapter
{
  public static final String a = aljq.aX + "chatpic" + File.separator;
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    return bayb.a(localStringBuffer.toString());
  }
  
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    int i = bdcs.a(paramString2, paramString3);
  ...
  public static final String d(String paramString)
  {
    ...
    for (;;)
    {
      ...
      Object localObject1 = baul.a + File.separator + str;
      try
      {
  ...
  public File loadImageFile(DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    //   1: istore_3
    //   2: aload_0
    //   3: invokevirtual 218	bame:a	()Z
    //   6: ifeq +402 -> 408
    //   9: aload_1
    //   10: getfield 223	com/tencent/image/DownloadParams:urlStr	Ljava/lang/String;
    //   13: astore 6
    //   15: aload 6
    //   17: invokestatic 154	bame:a	(Ljava/lang/String;)Ljava/io/File;
    //   20: astore 7
    //   22: aload 7
    //   24: ifnull +53 -> 77
    //   27: ldc 116
    ...
    //   54: invokestatic 242	awen:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   57: aload_2
    //   58: ifnull +14 -> 72
    //   61: aload_2
    //   62: aload 7
    ...
    //   86: aload_1
    //   87: aload_2
    //   88: invokevirtual 257	bame:a	(Ljava/io/OutputStream;Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;)Ljava/io/File;
    //   91: pop
    //   92: aload 7
    //   94: areturn
    //   95: aload 6
    //   97: invokestatic 176	bame:c	(Ljava/lang/String;)Ljava/lang/String;
    //   100: astore 9
    //   102: getstatic 262	com/tencent/mobileqq/startup/step/InitUrlDrawable:a	Lbanz;
    //   105: aload 9
    //   107: invokevirtual 267	banz:a	(Ljava/lang/String;)Lbaoa;
    //   110: astore 10
    //   112: aload_0
    //   113: invokevirtual 269	bame:b	()Z
    //   116: istore 4
    //   118: iload 4
    //   120: ifeq +338 -> 458
    //   123: aload_1
    //   124: aload 10
    //   126: getfield 272	baoa:a	Ljava/io/File;
    //   129: invokevirtual 245	java/io/File:length	()J
    //   132: putfield 276	com/tencent/image/DownloadParams:downloaded	J
    //   135: aload_0
    //   136: aload_1
    //   137: invokevirtual 278	bame:a	(Lcom/tencent/image/DownloadParams;)Z
    //   140: istore 5
    //   142: iload 5
    //   144: ifne +5 -> 149
    //   147: iconst_1
    ...
    //   158: dup
    //   159: aload 10
    //   161: getfield 272	baoa:a	Ljava/io/File;
    //   164: iload 4
    ...
    //   178: aload_1
    //   179: aload_2
    //   180: invokevirtual 257	bame:a	(Ljava/io/OutputStream;Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;)Ljava/io/File;
    //   183: pop
    //   184: aload 8
    //   186: astore 7
    //   188: aload 6
    ...
    //   220: astore 7
    //   222: aload_1
    //   223: invokestatic 154	bame:a	(Ljava/lang/String;)Ljava/io/File;
    //   226: astore_2
    //   227: aload_2
    //   228: ifnull +67 -> 295
    //   231: aload 8
    ...
    //   262: invokestatic 242	awen:a	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   265: aload 8
    //   267: astore 7
    //   269: aload 10
    //   271: getfield 272	baoa:a	Ljava/io/File;
    ...
    //   297: astore 7
    //   299: aload 10
    //   301: invokevirtual 305	baoa:a	()Ljava/io/File;
    //   304: astore_2
    //   305: aload_2
    //   306: astore_1
    //   307: aload 8
    ...
    //   333: aload 10
    //   335: iload 4
    //   337: invokevirtual 308	baoa:a	(Z)V
    //   340: aload_2
    //   341: astore 7
    //   343: ldc_w 310
    //   346: ldc 232
    ...
    //   380: invokestatic 316	awen:b	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    //   383: aload_2
    //   384: astore 7
    //   386: aload_1
    ...
    //   410: aload_1
    //   411: aload_2
    //   412: invokevirtual 257	bame:a	(Ljava/io/OutputStream;Lcom/tencent/image/DownloadParams;Lcom/tencent/image/URLDrawableHandler;)Ljava/io/File;
    //   415: areturn
    //   416: astore_2
    //   417: goto -11 -> 406
    //   420: astore_1
