...
public class bame
{
  ...
  private static HashMap<String, bamd> d;
  ...
  public static bamd a(QQAppInterface paramQQAppInterface, String paramString)
  {
    if (QLog.isColorLevel()) {
      QLog.d("TroopNotificationHelper", 2, "HasUnReadRepeatTroopNotification");
    }
    Object localObject = (bamd)jdField_d_of_type_JavaUtilHashMap.get(paramString);
    if (localObject != null)
    {
      paramQQAppInterface = (QQAppInterface)localObject;
      if (QLog.isColorLevel())
      {
        QLog.d("TroopNotificationHelper", 2, "HasUnReadRepeatTroopNotification. type = " + ((bamd)localObject).jdField_a_of_type_Int);
        paramQQAppInterface = (QQAppInterface)localObject;
      }
    }
    label314:
    do
    {
      do
      {
        ...
        List localList = ((aukp)localObject).a(TroopNotificationCache.class, true, "troopUin=? and read=?", new String[] { paramString, "0" }, null, null, null, null);
        ((aukp)localObject).a();
        ...
        paramString = (bamd)jdField_d_of_type_JavaUtilHashMap.get(paramString);
      ...
      return null;
      paramString = new bamd(((TroopInfo)localObject).feeds_id, ((TroopInfo)localObject).troopRepeatType);
      paramQQAppInterface = paramString;
    } while (!QLog.isColorLevel());
  ...
  public static bamf a(DataInputStream paramDataInputStream, boolean paramBoolean)
  {
  ...
  public static bamf a(String paramString, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    boolean bool1 = true;
    boolean bool2 = false;
    label846:
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((i == 5) || (i == 19))
        {
          ...
          localObject5 = new bamf();
          ((bamf)localObject5).jdField_a_of_type_JavaLangString = paramArrayOfByte;
          ((bamf)localObject5).jdField_b_of_type_JavaLangString = paramString;
          ((bamf)localObject5).jdField_c_of_type_JavaLangString = ((String)localObject3);
          ((bamf)localObject5).jdField_d_of_type_JavaLangString = ((String)localObject1);
          ((bamf)localObject5).jdField_a_of_type_Int = 1;
          if (!localGroupFeedsMessage.opt_uint32_ctl_flag.has()) {
            break label894;
          }
          i = localGroupFeedsMessage.opt_uint32_ctl_flag.get();
          ((bamf)localObject5).jdField_e_of_type_Int = i;
          ...
          paramBoolean = bool1;
          ((bamf)localObject5).jdField_a_of_type_Boolean = paramBoolean;
          break label891;
        }
        if (i == 22)
        {
          ...
          localObject3 = new bamf();
          ((bamf)localObject3).jdField_b_of_type_JavaLangString = paramString;
          ((bamf)localObject3).jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
          ((bamf)localObject3).jdField_e_of_type_JavaLangString = ((String)localObject1);
          ((bamf)localObject3).jdField_a_of_type_Int = 2;
          ((bamf)localObject3).jdField_b_of_type_Long = l1;
          ((bamf)localObject3).jdField_d_of_type_Int = i;
          if (localGroupFeedsMessage.opt_uint32_ctl_flag.has())
          {
            i = localGroupFeedsMessage.opt_uint32_ctl_flag.get();
            ((bamf)localObject3).jdField_e_of_type_Int = i;
            if ((!localGroupFeedsMessage.memo_ctrl_info.has()) || (!((group_feeds.GroupFeedsMessage.MemoCtrlInfo)localGroupFeedsMessage.memo_ctrl_info.get()).uint32_need_confirmation.has())) {
              break;
            }
            paramBoolean = bool2;
            ...
            ((bamf)localObject3).jdField_a_of_type_Boolean = paramBoolean;
            break;
          }
        }
        return null;
  ...
  public static TroopNotificationCache a(bamf parambamf, String paramString, int paramInt1, int paramInt2, long paramLong)
  {
    if (parambamf != null)
    {
      if (parambamf.jdField_a_of_type_Int == 1)
      {
        String str2 = a(parambamf.jdField_c_of_type_JavaLangString);
        ...
        str2 = a(parambamf.jdField_a_of_type_JavaLangString);
        if (TextUtils.isEmpty(parambamf.jdField_a_of_type_JavaLangString))
        {
          str2 = new SimpleDateFormat("yyyy年M月d日").format(new Date(parambamf.jdField_c_of_type_Int * 1000L));
          str2 = str2 + " 群公告";
        }
        ...
        localTroopNotificationCache.title = parambamf.jdField_a_of_type_JavaLangString;
        localTroopNotificationCache.feedType = paramInt1;
        localTroopNotificationCache.appId = paramInt2;
        localTroopNotificationCache.userUin = parambamf.jdField_a_of_type_Long;
        localTroopNotificationCache.troopUin = paramLong;
        localTroopNotificationCache.time = parambamf.jdField_c_of_type_Int;
        localTroopNotificationCache.feedsId = parambamf.jdField_b_of_type_JavaLangString;
        localTroopNotificationCache.serviceID = 27;
        localTroopNotificationCache.needConfirm = parambamf.jdField_a_of_type_Boolean;
        String str3 = new SimpleDateFormat("M-d HH:mm").format(new Date(localTroopNotificationCache.time * 1000L));
        if (TextUtils.isEmpty(parambamf.jdField_d_of_type_JavaLangString)) {}
        for (localTroopNotificationCache.xmlBytes = String.format("<?xml version=\"1.0\" encoding=\"utf-8\" ?><msg action=\"web\" serviceID=\"27\" templateID=\"\" actionData=\"\" url=\"%s\" flag=\"5\" brief=\"%s\"><item layout=\"1\"><title size=\"30\" color=\"#000000\">[公告] %s</title><hr /><title size=\"22\" color=\"#000000\">%s</title><summary size=\"28\" color=\"#808080\">%s</summary></item></msg>", new Object[] { paramString, "", str2, str3, str1 }).getBytes();; localTroopNotificationCache.xmlBytes = String.format("<?xml version=\"1.0\" encoding=\"utf-8\" ?><msg action=\"web\" serviceID=\"27\" templateID=\"\" actionData=\"\" url=\"%s\" flag=\"5\" brief=\"%s\"><item layout=\"6\"><title size=\"30\" color=\"#000000\">[公告] %s</title><hr /></item><item layout=\"2\"><picture cover=\"%s\"/><title size=\"22\" color=\"#000000\">%s</title><summary size=\"28\" color=\"#808080\">%s</summary></item></msg>", new Object[] { paramString, "", str2, parambamf.jdField_d_of_type_JavaLangString, str3, str1 }).getBytes()) {
          return localTroopNotificationCache;
        }
      }
      if (parambamf.jdField_a_of_type_Int == 2)
      {
        paramString = new TroopNotificationCache();
        paramString.feedType = paramInt1;
        paramString.appId = paramInt2;
        paramString.userUin = parambamf.jdField_a_of_type_Long;
        paramString.troopUin = paramLong;
        paramString.time = parambamf.jdField_c_of_type_Int;
        paramString.feedsId = parambamf.jdField_b_of_type_JavaLangString;
        paramString.ctrlStr = parambamf.jdField_e_of_type_JavaLangString;
        paramString.xmlBytes = parambamf.jdField_a_of_type_ArrayOfByte;
        paramString.src = parambamf.jdField_d_of_type_Int;
        paramString.filterID = parambamf.jdField_b_of_type_Long;
  ...
  public static TroopNotificationCache a(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, byte[] paramArrayOfByte, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramQQAppInterface)
      {
        ...
        QLog.d(bame.class.getSimpleName(), 2, paramQQAppInterface.getMessage());
        continue;
      }
      return null;
      label310:
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = localaukp.a(true, TroopNotificationCache.class.getSimpleName(), new String[] { "troopUin", "feedType", "serviceID" }, "read=?", new String[] { String.valueOf(0) }, "troopUin", null, null, null);
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString1, int paramInt2, String paramString2, short paramShort, boolean paramBoolean)
  {
    ...
    catch (Exception localException)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d(bame.class.getSimpleName(), 2, localException.getMessage());
        }
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      {
        paramArrayOfByte = null;
        if ((((bamf)localObject).jdField_a_of_type_Int == 1) || (((bamf)localObject).jdField_a_of_type_Int == 2)) {
          paramArrayOfByte = a((bamf)localObject, paramString, 23, paramInt1, paramLong2);
        }
        QQMessageFacade localQQMessageFacade = paramQQAppInterface.a();
        ArrayList localArrayList = new ArrayList();
        localArrayList.add(paramArrayOfByte);
        paramInt1 = (int)awzy.a();
        localQQMessageFacade.a().a(paramQQAppInterface, String.valueOf(paramLong1), String.valueOf(paramLong2), localArrayList, 23, paramInt1, ((bamf)localObject).jdField_e_of_type_Int, ((bamf)localObject).jdField_b_of_type_JavaLangString);
      }
    }
    catch (Exception paramQQAppInterface)
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    if ((jdField_a_of_type_JavaUtilHashMap != null) && (jdField_a_of_type_JavaUtilHashMap.containsKey(paramString)))
    {
      ...
      ((akhp)paramQQAppInterface.a(20)).a(paramQQAppInterface, paramString, arrayOfByte, paramInt);
      return;
    }
    try
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    paramQQAppInterface = new bamd(paramString1, paramInt);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, List<TroopNotificationCache> paramList, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      if (localTroopNotificationCache.userUin == paramQQAppInterface.getLongAccountUin())
      {
        ...
        ((aukp)localObject).a(localTroopNotificationCache);
    ...
    for (;;)
    {
      ...
      if (paramInt2 == 1)
      {
        ...
        paramQQAppInterface = ahnl.a(paramString1.uin, paramString1.getType());
        ahnl.a().a(paramQQAppInterface);
        if (paramInt2 != 1) {
          break label449;
        }
        i = 29;
        paramString1.msgType = i;
        if (!(paramString1.msg instanceof ahqj)) {
          break label469;
        }
        localObject = (ahqj)paramString1.msg;
        if (!bool1) {
          break label456;
        }
        paramQQAppInterface = BaseApplication.getContext().getString(2131720285);
        label382:
        ((ahqj)localObject).jdField_a_of_type_JavaLangString = paramQQAppInterface;
      }
      for (;;)
      {
        ((ahqj)paramString1.msg).jdField_c_of_type_Int = paramInt2;
        paramString1.lastmsgtime = paramInt1;
        paramString2.a().a(paramString1);
        paramList.sendEmptyMessage(1009);
        return;
        if ((!(paramString1.msg instanceof ahqj)) || (((ahqj)paramString1.msg).jdField_c_of_type_Int != 1)) {
          break;
        }
        return;
        i = 11;
        break label342;
        paramQQAppInterface = BaseApplication.getContext().getString(2131720284);
        break label382;
        paramString1.msg = new ahqj(BaseApplication.getContext(), bool1);
      }
    }
  }
  ...
  public static void a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    QLog.d("TroopNotificationHelper", 2, bame.class.getSimpleName() + "-->clearTroopNotification");
  }
  ...
  public static byte[] a(long paramLong, short paramShort, byte[] paramArrayOfByte, String paramString)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d(bame.class.getSimpleName(), 2, paramArrayOfByte.getMessage());
      }
    }
    return null;
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(bame.class.getSimpleName(), 2, "handGetTroopAuth");
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    wzt.b("http://gdynamic.qpic.cn/gdynamic/");
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    } while (((paramString2.msg instanceof ahqj)) && (((ahqj)paramString2.msg).jdField_c_of_type_Int == 1));
    if (QLog.isColorLevel()) {
      QLog.d("TroopNotificationHelper", 2, "setUnReadRepeatTroopNotificationPre, update recent user list");
    }
    Object localObject = ahnl.a(paramString2.uin, paramString2.getType());
    ahnl.a().a((String)localObject);
    paramString2.msgType = 11;
    localObject = new ahqj(BaseApplication.getContext(), true);
    ((ahqj)localObject).jdField_c_of_type_Int = 0;
