  ...
  extends RelativeLayout
{
  ...
  public acmw(PanelAdapter paramPanelAdapter, Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(paramContext);
    int k = paramPanelAdapter.a();
    int m = paramPanelAdapter.b();
    int i = aciy.a(15.0F, getContext().getResources());
    ...
    while (i < m)
    {
      ...
      localLayoutParams.leftMargin = aciy.a(20.0F, getContext().getResources());
      localLayoutParams.rightMargin = aciy.a(20.0F, getContext().getResources());
      ...
      while (j < k)
      {
        ...
        localObject = new acmx();
        ((acmx)localObject).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131302182));
        ((acmx)localObject).jdField_a_of_type_ComTencentMobileqqRedtouchRedTouch = new RedTouch(paramContext, ((acmx)localObject).jdField_a_of_type_AndroidWidgetImageView).a(8388661).a();
        ((acmx)localObject).b = ((ImageView)localView.findViewById(2131300748));
        ((acmx)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131311234));
  ...
  public void a()
  {
    ...
    while (i < getChildCount())
    {
      ...
      if (localObject != null)
      {
        localObject = (acmx)((View)localObject).getTag();
        if ((localObject != null) && (((acmx)localObject).jdField_a_of_type_AndroidWidgetImageView != null)) {
          ((acmx)localObject).jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(null);
        }
      }
      i += 1;
    }
  ...
  protected void a(Context paramContext)
  {
    ...
    {
      int i = aciy.a(18.0F, getContext().getResources());
      int j = aciy.a(18.0F, getContext().getResources());
