class besb
{
  private static besb jdField_a_of_type_Besb;
  private static besb jdField_b_of_type_Besb;
  ...
  public static besb a(int paramInt)
  {
    if (paramInt == 0)
    {
      if (jdField_a_of_type_Besb == null) {
        jdField_a_of_type_Besb = new besb(0);
      }
      return jdField_a_of_type_Besb;
    }
    if (jdField_b_of_type_Besb == null) {
      jdField_b_of_type_Besb = new besb(1);
    }
    return jdField_b_of_type_Besb;
  }
