  ...
  implements mab
{
  ...
  public String a;
  public Timer a;
  ljr jdField_a_of_type_Ljr = new lzw(this);
  lzy jdField_a_of_type_Lzy = new lzy(this);
  public maa a;
  ...
  public lzv(SmallScreenService paramSmallScreenService)
  {
    ...
    this.jdField_a_of_type_Mcx = new lzx(this);
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          break;
          locallfe = paramVideoController.a();
          i = locallfe.jdField_d_of_type_Int;
          if (QLog.isColorLevel()) {
        ...
        } while ((locallfe.jdField_j_of_type_Int == 1011) || (paramVideoController.f));
        ...
        if (locallfe.J)
        {
          ...
          localIntent.putExtra("sessionType", locallfe.jdField_d_of_type_Int);
          localIntent.putExtra("GroupId", locallfe.jdField_d_of_type_JavaLangString);
          localIntent.putExtra("uin", locallfe.jdField_d_of_type_JavaLangString);
        ...
        l = locallfe.jdField_g_of_type_Long;
        j = locallfe.F;
        if ((l == 0L) && (locallfe.a.jdField_b_of_type_Int <= 0)) {
          break label692;
        }
        if (locallfe.a.jdField_b_of_type_Int <= 0) {
          break label545;
        }
      } while ((locallfe.jdField_d_of_type_Int == 1) || (locallfe.a.jdField_a_of_type_Int == 1) || (locallfe.jdField_d_of_type_Int == 3) || (locallfe.a.jdField_a_of_type_Int == 3) || (!QLog.isColorLevel()));
      ...
      paramVideoController.putExtra("uinType", mvk.c(j));
      paramVideoController.putExtra("isDoubleVideoMeeting", locallfe.J);
      paramVideoController.putExtra("MultiAVType", locallfe.D);
      ...
      if (QLog.isColorLevel())
      {
        ...
        continue;
        label692:
        if ((paramVideoController.d()) && (locallfe.i()))
        {
          paramVideoController = new Intent(paramContext, VideoInviteActivity.class);
          paramVideoController.addFlags(268435456);
          paramVideoController.putExtra("uinType", locallfe.jdField_j_of_type_Int);
          paramVideoController.putExtra("peerUin", locallfe.jdField_d_of_type_JavaLangString);
          paramVideoController.putExtra("extraUin", locallfe.jdField_f_of_type_JavaLangString);
          if (locallfe.jdField_f_of_type_Int == 1) {}
          for (;;)
          {
  ...
  {
    RedPacketGameSmallScreenView localRedPacketGameSmallScreenView = (RedPacketGameSmallScreenView)paramViewGroup.findViewById(2131373707);
  ...
  private void b(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((this.jdField_a_of_type_Maa != null) && (paramInt != this.jdField_a_of_type_Maa.f())) {
        break;
      }
      return;
    }
    ...
    this.jdField_a_of_type_Maa.g(paramInt);
  ...
  public void a(long paramLong)
  {
    ...
    for (Object localObject = null;; localObject = this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService.a(1))
    {
      if (localObject != null)
      {
        View localView = ((SmallScreenRelativeLayout)localObject).findViewById(2131376387);
        if (localView != null) {
          localView.findViewById(2131376391).clearAnimation();
        }
      }
      if (this.jdField_a_of_type_JavaUtilTimer != null)
      {
      ...
      if (this.jdField_a_of_type_Maa != null)
      {
        this.jdField_a_of_type_Maa.p();
        this.jdField_a_of_type_Maa = null;
      }
      ...
      {
        this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.b(this.jdField_a_of_type_Lzy);
  ...
  {
    lbd.f("SmallScreenVideoController", "notifyEvent :" + paramInteger + "|" + paramObject1 + "|" + paramObject2);
  ...
  public void a(AppRuntime paramAppRuntime)
  {
    if ((paramAppRuntime instanceof VideoAppInterface))
    {
      ...
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(this.jdField_a_of_type_Lzy);
  ...
  void a(boolean paramBoolean)
  {
    ...
    if ((localObject1 != null) && (QLog.isColorLevel())) {
      QLog.d("SmallScreenVideoController", 2, "onCreateUI SessionType = " + ((lfe)localObject1).jdField_d_of_type_Int);
    }
    this.jdField_a_of_type_AndroidGraphicsBitmap = mvk.a(this.jdField_a_of_type_AndroidContentContext, 2130841982);
    if (this.jdField_a_of_type_ComTencentAvCameraCameraUtils == null)
    {
    ...
    localObject2 = ((SmallScreenRelativeLayout)localObject2).findViewById(2131363136);
    if (this.jdField_a_of_type_Maa == null)
    {
      this.jdField_a_of_type_Maa = new maa(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, (View)localObject2, this);
      label171:
    ...
    for (;;)
    {
      if ((this.jdField_a_of_type_ComTencentAvVideoController.f) && (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null)) {
        this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new lzj(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mcx);
      }
      if (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI != null) {
        this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI.a(paramBoolean);
      }
      if ((localObject1 == null) || (((lfe)localObject1).jdField_g_of_type_Int == 4) || (this.jdField_c_of_type_Int != 1) || (this.jdField_a_of_type_Boolean)) {
        break;
      }
      int i = bibh.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getAccount(), 6, true, null);
      if (i <= 0) {
        break;
      }
      int j = bibh.a();
      localObject1 = bibh.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, i, j, null);
      if (localObject1 == null) {
        break;
      }
      localObject1 = new File((String)localObject1);
      if ((localObject1 == null) || (!((File)localObject1).exists()) || (this.jdField_a_of_type_Maa == null)) {
        break;
      }
      this.jdField_a_of_type_Maa.w();
      return;
      this.jdField_a_of_type_Maa.c();
      break label171;
      if (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null) {
        if (this.jdField_d_of_type_Boolean)
        {
          this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new SmallScreenMultiVideoControlUI(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mcx);
          if (localObject1 != null)
          {
            this.jdField_c_of_type_Int = ((lfe)localObject1).jdField_d_of_type_Int;
            this.jdField_d_of_type_Int = ((lfe)localObject1).jdField_f_of_type_Int;
          }
        }
        else
        {
          ...
          else
          {
            ...
            if (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null) {
              ...
              else
              {
                this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new SmallScreenMultiVideoControlUI(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mcx);
                continue;
                if ((localObject1 != null) && (((lfe)localObject1).a.jdField_b_of_type_Int > 0))
                {
                  if (((lfe)localObject1).a.jdField_a_of_type_Int == 3) {
                    this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new SmallScreenMultiVideoControlUI(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mcx);
                  } else {
                    this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new lzj(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mcx);
                  }
                }
                else if ((localObject1 != null) && (((lfe)localObject1).jdField_e_of_type_Boolean) && ((((lfe)localObject1).jdField_g_of_type_Int == 1) || (((lfe)localObject1).jdField_g_of_type_Int == 2))) {
                  this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI = new lzj(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService, this.jdField_a_of_type_Mcx);
                }
              }
            }
  ...
  public boolean a(int paramInt)
  {
    ...
    while ((this.jdField_a_of_type_Int == paramInt) || (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI == null) || (!(this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenVideoControlUI instanceof lzj))) {
      return false;
    }
    if (!this.jdField_a_of_type_ComTencentAvVideoController.a().k)
    {
      lbd.h("SmallScreenVideoController", "Remote not has video, nOff=" + paramInt);
      return false;
    }
    ...
    {
      return true;
      this.jdField_a_of_type_Maa.n();
      this.jdField_a_of_type_ComTencentAvVideoController.a(0);
      continue;
      this.jdField_a_of_type_Maa.m();
      this.jdField_a_of_type_ComTencentAvVideoController.a(0);
      continue;
      this.jdField_a_of_type_Maa.n();
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService == null)
    {
      ...
      label18:
      if ((!this.jdField_b_of_type_Boolean) || (locallzq == null) || (!locallzq.b()) || (localSmallScreenRelativeLayout == null) || (localSmallScreenRelativeLayout.getVisibility() == 8)) {
        break label78;
      }
    ...
    {
      return;
      locallzq = this.jdField_a_of_type_ComTencentAvSmallscreenSmallScreenService.a(1);
      break;
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoController.a().jdField_d_of_type_Int == 2) {
      if (this.jdField_a_of_type_ComTencentAvVideoController.a().l())
      {
        ...
        this.jdField_a_of_type_Maa.a((String)localObject, 1, bool1, false, this.jdField_a_of_type_ComTencentAvVideoController.b(this.jdField_a_of_type_JavaLangString));
        if ((this.jdField_a_of_type_ComTencentAvVideoController.a().jdField_j_of_type_Boolean) && (!this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.c()))
        {
          ...
          this.jdField_a_of_type_Maa.a(true, false);
          this.jdField_a_of_type_Maa.c(l2, this.jdField_a_of_type_ComTencentAvCameraCameraUtils.a());
        }
      }
    }
    ...
    {
      lob locallob = (lob)((ArrayList)localObject).get(i);
      str = String.valueOf(locallob.jdField_a_of_type_Long);
      j = locallob.jdField_a_of_type_Int;
      bool2 = locallob.jdField_a_of_type_Boolean;
      bool3 = locallob.jdField_b_of_type_Boolean;
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      if ((!str.equals(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin())) && (bool3)) {
        this.jdField_a_of_type_Maa.a(str, j, bool3, bool2, bool1);
      }
      i += 1;
      break label422;
      break;
  ...
  void j()
  {
    if (this.jdField_a_of_type_Mch == null) {
      this.jdField_a_of_type_Mch = new lzz(this, this.jdField_a_of_type_AndroidContentContext, 2);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Mch != null) {
      this.jdField_a_of_type_Mch.enable();
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Mch != null) {
      this.jdField_a_of_type_Mch.disable();
    }
  }
}
