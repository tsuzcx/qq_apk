...
public class lzv
  extends lrd
{
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new lzw(this);
  Intent jdField_a_of_type_AndroidContentIntent;
  public VideoController a;
  kur jdField_a_of_type_Kur = new lzy(this);
  kvw jdField_a_of_type_Kvw = new lzx(this);
  ...
  public lzv(VideoController paramVideoController, VideoAppInterface paramVideoAppInterface, Intent paramIntent)
  {
  ...
  private boolean a(int paramInt)
  {
    ...
    {
      awqx.b(null, "dc00899", "Grp_video", "", "invite", (String)localObject, 0, 0, String.valueOf(this.jdField_a_of_type_ComTencentAvVideoController.a().g), this.jdField_d_of_type_Int + "", "", "");
      bool1 = true;
      return bool1;
    }
  }
  ...
  public int a(long paramLong, Intent paramIntent)
  {
    ...
    if (mfs.b(this.jdField_b_of_type_Int))
    {
      ...
      paramIntent = ksn.a(this.jdField_c_of_type_Int, String.valueOf(this.jdField_a_of_type_Long), new int[0]);
      if (ksn.a().a(paramIntent))
      {
        this.jdField_a_of_type_Kvq = ksn.a().b(paramIntent);
        return 2;
      }
      this.jdField_a_of_type_Kvq = ksn.a().a();
      return 2;
    }
    ...
    while (this.jdField_c_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_Kvq = ksn.a().b(paramIntent);
      this.jdField_a_of_type_Kvq.a(paramLong, "onStartCommand.1", 4);
    ...
    {
      this.jdField_a_of_type_Kvq.a(paramLong, "onStartCommand.2", 1);
    ...
    for (;;)
    {
      ...
      return 2;
      this.jdField_a_of_type_Kvq.a(paramLong, "onStartCommand.3", 2);
      paramIntent = this.jdField_a_of_type_Kvq;
  ...
  public void a(long paramLong)
  {
    ...
    int i = 1;
    if (!this.jdField_a_of_type_Kvq.L) {
      i = 4;
    }
    if (1008 == this.jdField_a_of_type_Kvq.i) {
      i = 4;
    }
    for (;;)
    {
      ...
      for (;;)
      {
        if (this.jdField_a_of_type_Lzu != null) {
          this.jdField_a_of_type_Lzu.c(ajjy.a(2131650492));
        }
        if (!this.jdField_a_of_type_Kvq.Q) {
          break;
        }
        ...
        return;
        this.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, this.jdField_a_of_type_Kvq.jdField_d_of_type_JavaLangString, j, i);
      }
  ...
  protected boolean a()
  {
    if (this.jdField_a_of_type_Mjl == null) {
      this.jdField_a_of_type_Mjl = new mjl(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().getApplicationContext(), 1, "video wifi lock");
    }
    if ((mhj.e(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication().getApplicationContext())) && (this.jdField_a_of_type_Mjl != null)) {
  ...
  public void b(long paramLong)
  {
    ...
    while (this.jdField_c_of_type_Boolean)
    {
      ...
      long l = mfy.a(this.jdField_c_of_type_JavaLangString);
  ...
  public void d(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Lzu != null) {
      this.jdField_a_of_type_Lzu.c(ajjy.a(2131650493));
    }
    this.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, this.jdField_c_of_type_Int, this.jdField_a_of_type_Kvq.g, this.jdField_a_of_type_ArrayOfLong, false);
