  ...
  extends AutoCompleteTextView
{
  ...
  public berg(NewStyleDropdownView paramNewStyleDropdownView, Context paramContext)
  {
    super(paramContext);
    setId(526);
  ...
  public berg(NewStyleDropdownView paramNewStyleDropdownView, Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  public berg(NewStyleDropdownView paramNewStyleDropdownView, Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          try
          {
            ((ListView)localObject2).setPadding(aepi.a(13.0F, getResources()), 0, aepi.a(13.0F, getResources()), 0);
      ...
      if ((localThrowable.getChildAt(j) != null) && ((localThrowable.getChildAt(j) instanceof LoginPopupRightMaskView)))
      {
        ...
        if (i == 0)
        {
          ...
          FrameLayout.LayoutParams localLayoutParams = new FrameLayout.LayoutParams(aepi.a(20.0F, getResources()), -1);
        ...
        localObject4 = new FrameLayout.LayoutParams(-1, aepi.a(14.0F, getResources()));
