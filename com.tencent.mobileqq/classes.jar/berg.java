...
public class berg
{
  private static volatile berg jdField_a_of_type_Berg;
  ...
  public static berg a()
  {
    if (jdField_a_of_type_Berg == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Berg == null) {
        jdField_a_of_type_Berg = new berg();
      }
      return jdField_a_of_type_Berg;
    }
  }
  ...
  public java.lang.Class a(java.lang.String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 28	berg:jdField_a_of_type_JavaLangClassLoader	Ljava/lang/ClassLoader;
    //   4: ifnonnull +7 -> 11
    //   7: aload_0
    //   8: invokevirtual 30	berg:a	()V
    //   11: ldc 32
    ...
    //   32: invokestatic 51	betc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   35: aload_0
    //   36: getfield 28	berg:jdField_a_of_type_JavaLangClassLoader	Ljava/lang/ClassLoader;
    //   39: ifnull +47 -> 86
    //   42: aload_0
    //   43: getfield 28	berg:jdField_a_of_type_JavaLangClassLoader	Ljava/lang/ClassLoader;
    //   46: aload_1
    ...
    //   81: invokestatic 51	betc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   84: aload_2
    //   85: areturn
    //   86: aload_0
    ...
    //   136: invokestatic 79	betc:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   139: aload_0
    ...
    //   183: aload_3
    //   184: invokestatic 82	betc:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   187: aload_2
    //   188: areturn
    //   189: astore_3
    //   190: goto -87 -> 103
  ...
  public Object a(java.lang.String paramString)
  {
    ...
    //   42: aload_1
    //   43: aload_0
    //   44: getfield 28	berg:jdField_a_of_type_JavaLangClassLoader	Ljava/lang/ClassLoader;
    //   47: invokestatic 90	berh:a	(Ljava/lang/String;Ljava/lang/ClassLoader;)Lberh;
    //   50: invokevirtual 93	berh:a	()Lberh;
    //   53: invokevirtual 96	berh:a	()Ljava/lang/Object;
    //   56: astore_2
    //   57: ldc 32
    ...
    //   87: invokestatic 51	betc:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   90: aload_2
    //   91: areturn
    //   92: aload_1
    //   93: aload_0
    ...
    //   100: invokestatic 90	berh:a	(Ljava/lang/String;Ljava/lang/ClassLoader;)Lberh;
    //   103: invokevirtual 93	berh:a	()Lberh;
    //   106: invokevirtual 96	berh:a	()Ljava/lang/Object;
    //   109: astore_2
    //   110: aload_2
    //   111: areturn
    //   112: astore_3
    ...
    //   148: invokestatic 79	betc:c	(Ljava/lang/String;Ljava/lang/String;)V
    //   151: aload_1
    //   152: aload_0
    ...
    //   159: invokestatic 90	berh:a	(Ljava/lang/String;Ljava/lang/ClassLoader;)Lberh;
    //   162: invokevirtual 93	berh:a	()Lberh;
    //   165: invokevirtual 96	berh:a	()Ljava/lang/Object;
    //   168: astore 4
    //   170: aload 4
    //   172: areturn
    //   173: astore 4
    ...
    //   201: aload_3
    //   202: invokestatic 82	betc:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   205: aload_2
    //   206: areturn
    //   207: astore_3
    //   208: goto -93 -> 115
