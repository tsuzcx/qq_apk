...
public class ayqk
{
  ...
  private final String jdField_a_of_type_JavaLangString = ayqk.class.getSimpleName();
  private final List<ayqn> jdField_a_of_type_JavaUtilList = new CopyOnWriteArrayList();
  ...
  private ayqn a(NowQQLiveHomepageProto.RcmdAnchor paramRcmdAnchor)
  {
    boolean bool2 = true;
    ayqn localayqn = new ayqn();
    localayqn.j = paramRcmdAnchor.string_head_img_url.get();
    localayqn.jdField_b_of_type_JavaLangString = paramRcmdAnchor.string_room_img_url.get();
    localayqn.jdField_b_of_type_Int = paramRcmdAnchor.hall_room_id.get();
    localayqn.jdField_c_of_type_JavaLangString = paramRcmdAnchor.string_name.get();
    localayqn.jdField_c_of_type_Int = paramRcmdAnchor.uint32_watch_count.get();
    localayqn.jdField_d_of_type_JavaLangString = paramRcmdAnchor.string_location.get();
    localayqn.jdField_f_of_type_JavaLangString = paramRcmdAnchor.string_id.get();
    localayqn.jdField_a_of_type_Long = paramRcmdAnchor.imsdk_tiny_id.get();
    localayqn.m = paramRcmdAnchor.rtmp_url.get();
    boolean bool1;
    ...
    for (;;)
    {
      localayqn.jdField_b_of_type_Boolean = bool1;
      if (paramRcmdAnchor.video_preview.get() == 1)
      {
        bool1 = bool2;
        localayqn.jdField_c_of_type_Boolean = bool1;
        localayqn.jdField_d_of_type_Int = paramRcmdAnchor.microphone_flag.get();
        localayqn.jdField_g_of_type_JavaLangString = paramRcmdAnchor.icon_url.get();
        localayqn.jdField_a_of_type_JavaUtilList = paramRcmdAnchor.rich_title.elements.get();
        localayqn.i = paramRcmdAnchor.string_description.get();
        localayqn.h = paramRcmdAnchor.award_pendant_url.get();
        if (paramRcmdAnchor.extra_info.has())
        {
          ...
          if ((localUserExtraInfo.medal_info_list.has()) && (localUserExtraInfo.medal_info_list.get() != null) && (localUserExtraInfo.medal_info_list.size() > 0)) {
            localayqn.a(localUserExtraInfo.medal_info_list.get());
          }
        }
        localayqn.jdField_e_of_type_Int = paramRcmdAnchor.user_tag.color.get();
      }
      try
      {
        if (!TextUtils.isEmpty(paramRcmdAnchor.user_tag.change_color.get())) {
          localayqn.jdField_f_of_type_Int = Integer.parseInt(paramRcmdAnchor.user_tag.change_color.get(), 16);
        }
        localayqn.k = paramRcmdAnchor.user_tag.pic_url.get();
        localayqn.l = paramRcmdAnchor.user_tag.wording.get();
        localayqn.jdField_e_of_type_JavaLangString = paramRcmdAnchor.string_jump_url.get();
        localayqn.jdField_g_of_type_Int = paramRcmdAnchor.user_tag.type.get();
        localayqn.n = paramRcmdAnchor.advertising_sign.get();
        return localayqn;
        bool1 = false;
        continue;
        bool1 = false;
    ...
    for (;;)
    {
      ...
      case 0: 
        ...
        else
        {
          ...
          ((ayqn)localObject).jdField_a_of_type_JavaLangString = localRecommendItem.string_key.get();
          i = this.jdField_b_of_type_Int;
          this.jdField_b_of_type_Int = (i + 1);
          ((ayqn)localObject).jdField_a_of_type_Int = i;
          ((ayqn)localObject).o = localRcmdAnchor.union_channel_sign.get();
      ...
      case 5: 
        ...
        else
        {
          ...
          ((ayqn)localObject).jdField_a_of_type_Int = i;
          ((ayqn)localObject).o = localRcmdAnchor.union_channel_sign.get();
          QLog.d(this.jdField_a_of_type_JavaLangString, 2, "NewRcmdDataMgr, parseData()  Double----anchor_union_channel_sign = " + ((ayqn)localObject).o);
          this.jdField_a_of_type_JavaUtilList.add(localObject);
          continue;
  ...
  public void a(int paramInt, ayqm paramayqm, boolean paramBoolean)
  {
    ...
    localRecommendPageReq.device_id.set(bjls.c());
    localRecommendPageReq.qimei.set(UserAction.getQIMEI());
    aypv.a().a(1718, 100, localRecommendPageReq.toByteArray(), new ayql(this, paramInt, paramayqm));
  }
