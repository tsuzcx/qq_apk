...
public class ayqk
  extends ayoj
{
  public ayqk(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    if ((j != 0) && (bbfj.g(this.a.getApplicationContext())))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        new ayrp().a(paramOutputStream, paramDownloadParams, paramURLDrawableHandler);
        paramOutputStream.close();
        paramURLDrawableHandler = new File(str3);
        localFile = new File(str1);
        if (!paramURLDrawableHandler.renameTo(localFile))
        {
          bbdx.a(paramURLDrawableHandler, localFile);
          paramURLDrawableHandler.delete();
        }
        bgqi.a(this.a.waitAppRuntime(null), false, new File(str1).length());
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    for (;;)
    {
      ...
      if (5 == apug.a(paramFile.getName()))
      {
        localObject = apty.a(this.a, paramFile.getPath());
        if (localObject != null)
        {
