...
public class tay
{
  public static void a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, FastWebActivity paramFastWebActivity, JSONObject paramJSONObject, List<BaseData> paramList, ArrayList<String> paramArrayList)
  {
    ...
    try
    {
          ...
          if (bool) {
            try
            {
              ...
              if (((ProteusItemData)localObject).w == 2) {
                paramArrayList.add(pha.f(((ProteusItemData)localObject).c.getString("articleImageUrl")));
              }
            }
      ...
      bfhe.a(paramFastWebActivity, paramArrayList.indexOf(pha.f(paramJSONObject)), paramArrayList, null, null, false, true, "4", 1000, null, null, null, null, "", true);
    }
    ...
    {
      tcc.a(paramArticleInfo, "0X8008996", pha.a(paramFastWebActivity, paramArticleInfo, 0, paramFastWebArticleInfo).toString());
      return;
    }
  }
