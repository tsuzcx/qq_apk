  ...
  extends BaseAdapter
{
  ...
  public avrk(Context paramContext, boolean paramBoolean)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    ImageView localImageView2 = (ImageView)localView.findViewById(2131364780);
    URLImageView localURLImageView = (URLImageView)localView.findViewById(2131362147);
    ...
    for (;;)
    {
      ...
      {
        localImageView1.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845095));
        if (bool)
        {
          localImageView3.setVisibility(0);
          label297:
          localImageView2.setVisibility(8);
          localTextView.setText(ajyc.a(2131704599));
          localImageView1.setContentDescription(ajyc.a(2131704602));
          localTextView.setContentDescription(ajyc.a(2131704603));
        }
      }
      label590:
      do
      {
        ...
        if (bool)
        {
          ...
          paramView.mLoadingDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845091);
          paramView.mFailedDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845091);
          ...
          localImageView2.setVisibility(8);
          if (!bbjw.a(localFilterCategoryItem.j)) {
            break label590;
          }
        ...
        for (;;)
        {
          axqw.b(null, "dc00898", "", "", "0X800859E", "0X800859E", 2, 0, "", "", localFilterCategoryItem.jdField_a_of_type_JavaLangString, "");
          return localView;
          localImageView3.setVisibility(8);
        ...
        bool = avsd.a().a(3, localFilterCategoryItem.jdField_b_of_type_Int, localFilterCategoryItem.jdField_a_of_type_JavaLangString);
        if (!bool) {
          break label704;
        }
