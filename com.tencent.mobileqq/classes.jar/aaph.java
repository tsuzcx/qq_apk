...
class aaph
  implements nux
{
  aaph(aapg paramaapg, long paramLong, bikt parambikt, Context paramContext) {}
  ...
  public void loaded(int paramInt, java.lang.String paramString)
  {
    ...
    //   33: aload_0
    //   34: getfield 17	aaph:jdField_a_of_type_Long	J
    //   37: lsub
    ...
    //   78: aload_0
    //   79: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   82: aload_0
    //   83: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   86: getfield 78	aapg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   89: invokestatic 83	nuz:a	(Ljava/lang/String;)Ljava/lang/String;
    //   92: putfield 86	aapg:d	Ljava/lang/String;
    //   95: new 39	java/lang/StringBuilder
    //   98: dup
    //   99: invokespecial 40	java/lang/StringBuilder:<init>	()V
    //   102: aload_0
    //   103: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   106: getfield 78	aapg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   109: invokestatic 89	nvf:a	(Ljava/lang/String;)Ljava/lang/String;
    //   112: invokevirtual 46	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   115: aload_0
    //   116: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   119: getfield 78	aapg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   130: aload_0
    //   131: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   134: getfield 94	aapg:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   189: aload_0
    //   190: getfield 19	aaph:jdField_a_of_type_Bikt	Lbikt;
    //   193: iconst_3
    //   194: iconst_1
    //   195: iconst_1
    //   196: invokestatic 113	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   199: invokevirtual 119	bikt:notifyUI	(IZLjava/lang/Object;)V
    //   202: aload_0
    //   203: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   206: iconst_0
    //   207: putfield 122	aapg:jdField_b_of_type_Boolean	Z
    //   210: return
    //   211: new 96	java/io/File
    //   214: dup
    //   215: aload_0
    //   216: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   219: getfield 125	aapg:c	Ljava/lang/String;
    //   222: invokespecial 99	java/io/File:<init>	(Ljava/lang/String;)V
    //   225: astore_3
    //   226: aload_0
    //   227: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   230: getfield 128	aapg:jdField_a_of_type_AndroidContentSharedPreferences	Landroid/content/SharedPreferences;
    ...
    //   245: aload_0
    //   246: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   249: getfield 94	aapg:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   265: aload_0
    //   266: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   269: getfield 86	aapg:d	Ljava/lang/String;
    ...
    //   289: invokestatic 152	com/tencent/mobileqq/utils/FileUtils:deleteDirectory	(Ljava/lang/String;)V
    //   292: aload_0
    //   293: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   296: getfield 128	aapg:jdField_a_of_type_AndroidContentSharedPreferences	Landroid/content/SharedPreferences;
    //   299: invokeinterface 156 1 0
    ...
    //   316: aload_0
    //   317: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   320: getfield 94	aapg:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   329: aload_0
    //   330: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   333: getfield 78	aapg:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   336: invokestatic 83	nuz:a	(Ljava/lang/String;)Ljava/lang/String;
    //   339: invokeinterface 162 3 0
    //   344: invokeinterface 165 1 0
    //   349: pop
    //   350: aload_3
    //   351: invokevirtual 168	java/io/File:mkdirs	()Z
    //   354: pop
    //   355: aload_3
    //   356: invokevirtual 102	java/io/File:exists	()Z
    //   359: ifne +8 -> 367
    //   362: aload_3
    //   363: invokevirtual 168	java/io/File:mkdirs	()Z
    //   366: pop
    //   367: aload_0
    //   368: getfield 21	aaph:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   371: aload_0
    //   372: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   375: getfield 94	aapg:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   378: invokestatic 174	com/tencent/mobileqq/pluginsdk/PluginUtils:getPluginLibPath	(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    //   381: invokevirtual 177	java/io/File:getCanonicalPath	()Ljava/lang/String;
    //   384: astore_3
    //   385: aload_0
    //   386: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   389: getfield 180	aapg:jdField_a_of_type_JavaLangClassLoader	Ljava/lang/ClassLoader;
    //   392: ifnonnull +32 -> 424
    //   395: aload_0
    //   396: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   399: new 182	dalvik/system/DexClassLoader
    //   402: dup
    //   403: aload_2
    //   404: aload_0
    //   405: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   408: getfield 125	aapg:c	Ljava/lang/String;
    //   411: aload_3
    //   412: invokestatic 188	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   415: invokevirtual 194	com/tencent/qphone/base/util/BaseApplication:getClassLoader	()Ljava/lang/ClassLoader;
    //   418: invokespecial 197	dalvik/system/DexClassLoader:<init>	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/ClassLoader;)V
    //   421: putfield 180	aapg:jdField_a_of_type_JavaLangClassLoader	Ljava/lang/ClassLoader;
    //   424: new 39	java/lang/StringBuilder
    //   427: dup
    //   428: invokespecial 40	java/lang/StringBuilder:<init>	()V
    //   431: invokestatic 188	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   434: invokevirtual 201	com/tencent/qphone/base/util/BaseApplication:getFilesDir	()Ljava/io/File;
    ...
    //   443: getstatic 204	java/io/File:separator	Ljava/lang/String;
    //   446: invokevirtual 46	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   449: aload_0
    //   450: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   453: getfield 94	aapg:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   463: aload_2
    //   464: aload_3
    //   465: invokestatic 208	com/tencent/mobileqq/utils/FileUtils:copyFile	(Ljava/lang/String;Ljava/lang/String;)Z
    //   468: pop
    //   469: aload_0
    //   470: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   473: aload_3
    //   474: putfield 210	aapg:e	Ljava/lang/String;
    ...
    //   507: aload_0
    //   508: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   511: getfield 86	aapg:d	Ljava/lang/String;
    ...
    //   523: aload_0
    //   524: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   527: new 216	aapf
    //   530: dup
    //   531: invokestatic 188	com/tencent/common/app/BaseApplicationImpl:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   534: iconst_0
    //   535: aload_0
    //   536: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   539: getfield 210	aapg:e	Ljava/lang/String;
    //   542: aload_0
    //   543: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   546: getfield 180	aapg:jdField_a_of_type_JavaLangClassLoader	Ljava/lang/ClassLoader;
    //   549: invokespecial 219	aapf:<init>	(Landroid/content/Context;ILjava/lang/String;Ljava/lang/ClassLoader;)V
    //   552: putfield 222	aapg:jdField_a_of_type_Aapf	Laapf;
    //   555: aload_0
    //   556: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   559: iconst_1
    //   560: putfield 224	aapg:jdField_a_of_type_Boolean	Z
    //   563: aload_0
    //   564: getfield 19	aaph:jdField_a_of_type_Bikt	Lbikt;
    //   567: iconst_3
    //   568: iconst_1
    //   569: iconst_0
    //   570: invokestatic 113	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   573: invokevirtual 119	bikt:notifyUI	(IZLjava/lang/Object;)V
    //   576: aload_0
    //   577: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   580: iconst_0
    //   581: putfield 122	aapg:jdField_b_of_type_Boolean	Z
    //   584: aload_0
    //   585: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   588: iconst_0
    //   589: putfield 122	aapg:jdField_b_of_type_Boolean	Z
    //   592: return
    //   593: aload_3
    //   594: invokevirtual 168	java/io/File:mkdirs	()Z
    //   597: pop
    //   598: goto -243 -> 355
    //   601: astore_2
    ...
    //   623: aload_2
    //   624: invokevirtual 227	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   633: invokestatic 229	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   636: aload_0
    //   637: getfield 19	aaph:jdField_a_of_type_Bikt	Lbikt;
    //   640: iconst_3
    //   641: iconst_1
    //   642: iconst_3
    //   643: invokestatic 113	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   646: invokevirtual 119	bikt:notifyUI	(IZLjava/lang/Object;)V
    //   649: aload_0
    //   650: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   653: iconst_0
    //   654: putfield 122	aapg:jdField_b_of_type_Boolean	Z
    //   657: return
    //   658: astore_2
    //   659: aload_0
    //   660: getfield 15	aaph:jdField_a_of_type_Aapg	Laapg;
    //   663: iconst_0
    //   664: putfield 122	aapg:jdField_b_of_type_Boolean	Z
    //   667: aload_2
    //   668: athrow
