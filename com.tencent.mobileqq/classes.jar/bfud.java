...
public class bfud
{
  ...
  public bfud(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
  ...
  private bhyt a()
  {
    return ((bhyq)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(QQManagerFactory.DOWNLOADER_FACTORY)).a(1);
  }
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    String str = nvf.b(this.jdField_a_of_type_JavaLangString);
    boolean bool2;
    ...
    for (;;)
    {
      bfug localbfug = new bfug(this, str, bool2, bool1);
      if (!TextUtils.isEmpty(str)) {
        ThreadManager.post(new SoLibraryChecker.4(this, paramJSONObject, str, localbfug), 8, null, false);
      }
      return;
      if ((i == 3) || (i == 2))
      {
  ...
  private boolean a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty(nvf.b(str2)))
        {
          paramBoolean2 = false;
          continue;
        }
  ...
  private void b()
  {
    ...
    {
      nuz.a = bool;
      String str = nuz.a(this.jdField_a_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
        QLog.d("SoLibraryLoader", 2, "checkSoUpdate version = " + str);
      }
      if ((!new File(nvf.a(this.jdField_a_of_type_JavaLangString) + this.jdField_a_of_type_JavaLangString + "/" + this.b).exists()) && (!TextUtils.isEmpty(str)) && (!"0".equals(str))) {
        FileUtils.deleteDirectory(nvf.a(this.jdField_a_of_type_JavaLangString) + this.jdField_a_of_type_JavaLangString);
      }
    ...
    nuz.a(this.jdField_a_of_type_JavaLangString, localQQAppInterface, new bfue(this), false);
  }
  ...
  private void c()
  {
    ...
    long l = System.currentTimeMillis();
    if ((!nuz.a(BaseApplicationImpl.getContext(), str, new bfuf(this, l))) && (QLog.isColorLevel())) {
