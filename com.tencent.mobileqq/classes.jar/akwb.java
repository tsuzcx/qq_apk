...
public class akwb
{
  ...
  private void a(ApolloActionData paramApolloActionData)
  {
    ...
    ((akwq)this.a.a().getManager(249)).a().a(localSpriteTaskParam);
  }
  ...
  public void a(int paramInt)
  {
    ...
    ApolloActionData localApolloActionData = ((aleh)localQQAppInterface.getManager(155)).a(paramInt);
    String str = alpo.a(2131714688);
    ...
    {
      ((akji)localQQAppInterface.getManager(153)).a(localApolloActionData, 4);
      a(str);
      return;
    }
      ...
      try
      {
        ...
        if (localJSONArray != null)
        {
          ...
          if (localJSONArray.length() > 0)
          {
            ...
            {
              paramMessageForApollo = (ApolloSlaveInfo)bcyj.a(localJSONArray.getJSONObject(i), ApolloSlaveInfo.class);
