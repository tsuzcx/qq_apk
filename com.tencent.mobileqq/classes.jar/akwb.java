...
{
  public int a;
  public SparseArray<akwc> a;
  
  public akwb(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    paramObject = (akaw)this.app.getManager(92);
    Object localObject;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg.uint32_result.has()))
        {
          ...
          j = 0;
          if (4 <= i3) {
            l = bbmx.a(paramFromServiceMsg, 0);
          }
          if (6 > i3) {
            break label868;
          }
          m = bbmx.a(paramFromServiceMsg, 4);
          if (8 > i3) {
            break label862;
          }
          n = bbmx.a(paramFromServiceMsg, 6);
          if (10 <= i3) {
            i = bbmx.a(paramFromServiceMsg, 8);
          }
          if (12 <= i3) {
            j = bbmx.a(paramFromServiceMsg, 10);
          }
          if ((i == 0) && (j == 0) && (m == 0) && (n == 0))
          {
            if (QLog.isColorLevel()) {
      ...
      while (k < i4)
      {
        ...
        if (i1 + 4 <= i3)
        {
          localObject[k] = bbmx.a(paramFromServiceMsg, i1);
          i2 = i1 + 4;
        }
        k += 1;
        i1 = i2;
      ...
      if (i + 1 <= k) {
        paramToServiceMsg = bbmx.a(paramFromServiceMsg, 1, i);
      }
      if (QLog.isColorLevel())
      {
    ...
    if (1000 == i)
    {
      ...
      if (paramToServiceMsg != null)
      {
        ...
        if (paramToServiceMsg.uint32_result.has())
        {
          ...
          if (j == 0)
          {
            paramToServiceMsg = (akaw)this.app.getManager(92);
            i = j;
            if (paramToServiceMsg != null) {
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ((akaw)this.app.getManager(92)).a(34, null);
      return;
      bool = false;
      break;
      bool = false;
  ...
  public akat a(int paramInt)
  {
    this.jdField_a_of_type_Int = paramInt;
    if (this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt) == null)
    {
      akwc localakwc = new akwc(this, paramInt);
      this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, localakwc);
    }
    return (akat)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    try
    {
      ...
      bbmx.a(paramString, 0, l);
      bbmx.a(paramString, 4, paramInt1);
      bbmx.a(paramString, 6, paramInt2);
      bbmx.a(paramString, 8, paramInt3);
      bbmx.a(paramString, 10, paramInt4);
  ...
  public void a(String paramString, Calendar paramCalendar, boolean paramBoolean, int paramInt)
  {
    ...
    paramString = (akaw)this.app.getManager(92);
    if (paramBoolean) {}
  ...
  public void a(String paramString, Calendar paramCalendar, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    paramCalendar = localakaw.a((Calendar)paramCalendar.clone());
    long l1 = ((Long)paramCalendar.first).longValue();
    long l2 = ((Long)paramCalendar.second).longValue();
    this.app.a().a(paramString, l1, 0L, l2, (short)0, 0L, 1, localakaw.a(), localakaw.b(), paramBoolean1, paramInt, paramBoolean2);
  }
  ...
  public void a(short paramShort)
  {
    try
    {
      ...
      bbmx.a((byte[])localObject, 0, l);
      localObject[4] = 0;
      bbmx.a((byte[])localObject, 5, (short)1);
      bbmx.a((byte[])localObject, 7, 41813);
      bbmx.a((byte[])localObject, 9, (short)2);
      bbmx.a((byte[])localObject, 11, paramShort);
  ...
  {
    akaw localakaw = (akaw)this.app.getManager(92);
    Object localObject = localakaw.a(paramCalendar);
    if (localObject == null)
    {
      if (QLog.isColorLevel()) {
    ...
    {
      localakaw.a((Calendar)localObject);
    ...
    {
      localakaw.a((Calendar)localObject);
      paramCalendar = localakaw.a((Calendar)((Calendar)localObject).clone());
      int m = localakaw.a(paramString, ((Long)paramCalendar.first).longValue(), ((Long)paramCalendar.second).longValue());
      if (QLog.isColorLevel()) {
  ...
  public akat b(int paramInt)
  {
    akat localakat = (akat)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
