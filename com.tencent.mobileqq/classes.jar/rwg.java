...
public final class rwg
{
  ...
  private final void b(VideoInfo paramVideoInfo)
  {
    ...
    if (localObject != null) {
      ((AdvertisementInfo)localObject).mAdvertisementSoftInfo = ((trp)null);
    }
    ...
    paramVideoInfo.jdField_a_of_type_Oey = ((oey)null);
    paramVideoInfo.b = ((oey)null);
  }
  ...
  public final void a(@NotNull VideoInfo paramVideoInfo)
  {
    ...
    for (;;)
    {
      ...
      if ((paramVideoInfo.jdField_a_of_type_Oey != null) || (paramVideoInfo.b != null)) {
  ...
  public final void a(@NotNull rvn paramrvn)
  {
    Intrinsics.checkParameterIsNotNull(paramrvn, "holder");
    paramrvn = paramrvn.a;
    if (paramrvn != null)
    {
      paramrvn = paramrvn.a;
      if (paramrvn != null) {
        jdField_a_of_type_Rwg.a(paramrvn);
      }
    }
  }
}
