  ...
  implements View.OnClickListener
{
  ...
  public qyg(qyf paramqyf, Context paramContext, View paramView, BaseData paramBaseData)
  {
    super(paramView, paramBaseData);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131302981));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131297728));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297740));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131312415));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131297731));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131300312));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297738));
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
    a(paramContext);
    paramContext = (LinearLayout)paramView.findViewById(2131300311);
    ...
    this.jdField_a_of_type_Ohe = new qyh(this, paramqyf);
    paramView.addOnAttachStateChangeListener(new qyi(this, paramqyf));
  }
  
  private int a(int paramInt)
  {
    return (int)Math.floor(((int)babp.a(true) - this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDimensionPixelSize(2131167445) * 2 - (paramInt - 1) * this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDimensionPixelSize(2131167446)) * 1.0D / paramInt);
  }
  ...
  private void a(Context paramContext)
  {
    if (qzk.a().b())
    {
      ...
      paramContext = qzk.a().a(paramContext);
      this.jdField_b_of_type_AndroidWidgetTextView.setText(paramContext);
      this.e = vct.a(BaseApplicationImpl.getApplication().getBaseContext(), 71.0F);
    ...
    catch (Exception paramContext)
    {
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.e(qyf.a(), 1, paramContext.toString());
        }
      }
    }
  }
  ...
  private void a(FastWebArticleInfo paramFastWebArticleInfo)
  {
    ...
    this.jdField_a_of_type_AndroidViewAnimationAnimation.setAnimationListener(new qyk(this, paramFastWebArticleInfo));
  ...
  private void a(String paramString)
  {
    ...
    ocg localocg = raz.a(localArticleInfo);
    for (;;)
    {
      try
      {
        ...
        localocg.k();
        localocg.l();
        localocg.a(localArticleInfo.mAlgorithmID);
        localocg.b(localArticleInfo.mStrategyId);
        ...
        raz.a(localArticleInfo, paramString, localocg.a());
        return;
      }
      ...
      QLog.e(qyf.a(), 2, "parseR5 has error !", paramString);
      return;
      label226:
      int i = 0;
      continue;
  ...
  private void a(boolean paramBoolean)
  {
    ...
    {
      localValueAnimator.addUpdateListener(new qyj(this));
  ...
  private void b()
  {
    if ((qzk.a().b()) && (this.jdField_a_of_type_ComTencentMobileqqDiniflyLottieDrawable != null))
    {
  ...
  {
    if ((qzk.a().b()) && (!this.jdField_b_of_type_Boolean))
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
    }
    ...
    if (paramBaseData1 != null)
    {
      ...
      this.jdField_a_of_type_AndroidViewView.findViewById(2131303736).setBackgroundColor(0);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131303708).setBackgroundColor(0);
      this.jdField_a_of_type_AndroidViewView.findViewById(2131303768).setBackgroundColor(0);
    ...
    label350:
    label358:
    for (int i = 2130842222;; i = 2130841147)
    {
      paramBaseData2.setImageResource(i);
      ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131303709)).setImageResource(2130841135);
      ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131303769)).setImageResource(2130842022);
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor("#737373"));
      ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131303710)).setTextColor(Color.parseColor("#737373"));
      ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131303770)).setTextColor(Color.parseColor("#737373"));
      if (!obz.o())
      {
        paramBaseData1 = (LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131300311);
        this.jdField_a_of_type_AndroidViewView.findViewById(2131300311).setPadding(paramBaseData1.getPaddingLeft(), bajq.b(10.5F), paramBaseData1.getPaddingRight(), paramBaseData1.getPaddingBottom());
      }
      this.jdField_a_of_type_AndroidViewView.findViewById(2131303736).getLayoutParams().height = -2;
      this.jdField_a_of_type_AndroidViewView.findViewById(2131303708).getLayoutParams().height = -2;
      this.jdField_a_of_type_AndroidViewView.findViewById(2131303768).getLayoutParams().height = -2;
      return;
      i = 2130841130;
      break;
    }
    ...
    if (paramBaseData1.jdField_a_of_type_Boolean)
    {
      i = 2130842221;
      paramBaseData2.setImageResource(i);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(bgmq.a(paramBaseData1.jdField_a_of_type_Int, 99990000L, "9999万+", qyf.b()));
      if (!paramBaseData1.jdField_a_of_type_Boolean) {
        break label481;
      }
    ...
    label481:
    label489:
    for (paramBaseData1 = this.jdField_a_of_type_AndroidViewView.getResources().getDrawable(2130848172);; paramBaseData1 = this.jdField_a_of_type_AndroidViewView.getResources().getDrawable(2130848171))
    {
      this.jdField_a_of_type_AndroidViewView.findViewById(2131303736).setBackgroundDrawable(paramBaseData1);
      return;
      i = 2130841146;
      break;
      i = -16777216;
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              aciy.a(qyf.a(), "", new IllegalArgumentException());
              return;
            }
          ...
          qzk.a().a((FastWebActivity)this.jdField_a_of_type_AndroidViewView.getContext(), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData.b.fusionBiuInfo.a, 1, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData.b.innerUniqueID);
          return;
          if (!qzk.a().b()) {
            break label247;
          }
        ...
        qzk.a().a(this.jdField_a_of_type_AndroidViewView.getContext(), obz.a(), 1, 4, localArticleInfo, 1, localArticleInfo.innerUniqueID);
        return;
      } while (localArticleInfo.fusionBiuInfo == null);
      qzk.a().a(this.jdField_a_of_type_AndroidViewView.getContext(), localArticleInfo.fusionBiuInfo.a, obz.a(), localArticleInfo.mFeedType, 1, localArticleInfo.innerUniqueID);
      return;
      if (localFastWebArticleInfo.jdField_a_of_type_Boolean)
      {
        ...
        raz.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData.b, "0X8009765", "2");
      }
      for (;;)
      {
        a(localFastWebArticleInfo);
        ohb.a().c();
        ogy.a().a(obz.a(), localFastWebArticleInfo.jdField_a_of_type_Boolean, localFastWebArticleInfo);
        return;
        localFastWebArticleInfo.jdField_a_of_type_Boolean = true;
        localFastWebArticleInfo.jdField_a_of_type_Int += 1;
        raz.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewFastwebDataBaseData.b, "0X8009764", "2");
      }
