...
public class qyg
  extends BaseAdapter
{
  private qyg(ComponentPolymericView paramComponentPolymericView) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      i = 1;
      localObject2 = new pya((Context)localObject1, (ArticleInfo)localObject2, j, k, i, paramInt, false, getCount(), null, ComponentPolymericView.a(this.a).a.a());
      localObject1 = qqq.a(paramInt, localObject2, getItemViewType(paramInt), paramView, ComponentPolymericView.a(this.a), ComponentPolymericView.a(this.a).a.a(), ComponentPolymericView.a(this.a).a.a().a());
      if (localObject1 != null)
      {
        ((View)localObject1).setTag(2131380929, localObject2);
        ComponentPolymericView.a(this.a).a.a().a(localBaseArticleInfo, (pxk)localObject2, System.currentTimeMillis(), paramInt);
      }
      ...
      if (((pha.o(localBaseArticleInfo)) || (pha.p(localBaseArticleInfo))) && (!ComponentPolymericView.a(this.a)[paramInt].booleanValue())) {
    ...
    for (;;)
    {
      try
      {
        localObject3 = (rfw)localBaseArticleInfo.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.get(0);
        ((JSONObject)localObject2).put("channel_id", localBaseArticleInfo.mChannelID);
        if (((rfw)localObject3).jdField_a_of_type_Rfx == null) {
          continue;
        }
        paramView = ((rfw)localObject3).jdField_a_of_type_Rfx.a;
        ((JSONObject)localObject2).put("rowkey", paramView);
        if (((rfw)localObject3).jdField_a_of_type_Rfy == null) {
          continue;
        }
        i = ((rfw)localObject3).jdField_a_of_type_Rfy.b;
      ...
      paramView = "1";
      oat.a(null, "CliOper", "", "", "0X8009829", "0X8009829", 0, 0, (String)localObject3, paramView, localBaseArticleInfo.mStrategyId + "", ((JSONObject)localObject2).toString(), false);
      ComponentPolymericView.a(this.a)[paramInt] = Boolean.valueOf(true);
      if ((pha.i(localBaseArticleInfo)) && (localBaseArticleInfo.mPolymericInfo != null)) {
