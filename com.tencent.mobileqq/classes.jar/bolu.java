  ...
  extends DynamicTextItem
{
  ...
  private String jdField_a_of_type_JavaLangString = anvx.a(2131705363);
  ...
  public bolu(int paramInt, List<String> paramList, Bitmap paramBitmap1, Bitmap paramBitmap2)
  {
    ...
    d();
    this.m = ((int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(anvx.a(2131705364)));
    this.n = ((int)(this.jdField_b_of_type_AndroidTextTextPaint.measureText(anvx.a(2131705362)) * 10.0F));
    if (paramList == null) {}
  ...
  public int a(MotionEvent paramMotionEvent, float paramFloat1, float paramFloat2, @Nullable bowi parambowi, bpdf parambpdf)
  {
    float f1 = paramMotionEvent.getX();
    float f2 = paramMotionEvent.getY();
    if (parambowi != null) {
      return parambpdf.a(parambowi, f1, f2);
    }
  ...
  public InputFilter a()
  {
    if (this.jdField_a_of_type_AndroidTextInputFilter == null) {
      this.jdField_a_of_type_AndroidTextInputFilter = new bolx(this, 20);
    }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    String str2 = a(paramInt, new bolv(this));
    ...
    for (;;)
    {
      ...
      break label173;
      label965:
      this.jdField_a_of_type_AndroidTextStaticLayout = bomr.a(str2, 0, str2.length(), this.jdField_b_of_type_AndroidTextTextPaint, this.n, Layout.Alignment.ALIGN_NORMAL, 1.5F, 0.0F, false, null, 0, 2);
