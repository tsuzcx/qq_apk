  ...
  extends BaseAdapter
{
  ...
  public kjq(Context paramContext, @NonNull TraeHelper.SoundOutputRes paramSoundOutputRes)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramViewGroup != null) {
      if (paramView == null)
      {
        paramView = new kjr(this.jdField_a_of_type_AndroidContentContext, paramViewGroup.jdField_a_of_type_Int, paramViewGroup.b);
        paramViewGroup = (kjr)paramView;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      return paramView;
      ((kjr)paramView).a(paramViewGroup.b);
      paramView.setContentDescription(paramViewGroup.b);
      ((kjr)paramView).a(paramViewGroup.jdField_a_of_type_Int);
      break;
    }
  }
}
