...
public class bgrz
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bgsa(this);
  private View jdField_a_of_type_AndroidViewView;
  private ImageView jdField_a_of_type_AndroidWidgetImageView;
  private RelativeLayout jdField_a_of_type_AndroidWidgetRelativeLayout;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  bgsc jdField_a_of_type_Bgsc;
  ...
  public bgrz(Context paramContext, int paramInt1, int paramInt2, int paramInt3, GdtAppReceiver paramGdtAppReceiver)
  {
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    {
      bgqd.a().a(this.jdField_c_of_type_Int, 0L, paramInt1, paramString, paramInt2);
      return;
    }
    QZLog.i("VipGeneralGdtShowView", " @getGdtInfo sendBusinessReport");
  }
  
  public void a(View paramView, bgsc parambgsc)
  {
    if (paramView == null) {
      return;
    }
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131301378));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131301381));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131301382));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131301384));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131301380));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131301385));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131301386));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131301383));
  ...
  public void a(AlumBasicData paramAlumBasicData, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject1 = this.jdField_a_of_type_AndroidWidgetTextView.getResources().getDrawable(2130839687);
        ...
        if ((this.jdField_c_of_type_Int == 3) && (!awnu.b()))
        {
          ((URLDrawable)localObject1).setTag(azue.a(bajq.a(40.0F), bajq.a(40.0F)));
          ((URLDrawable)localObject1).setDecodeHandler(azue.o);
          if (localURLDrawable != null)
          {
            this.jdField_e_of_type_Int = paramAlumBasicData.jdField_a_of_type_Int;
            this.f = paramAlumBasicData.jdField_b_of_type_Int;
            int j = this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().widthPixels - bajq.b(56.0F);
            paramInt = i;
      ...
      ((URLDrawable)localObject1).setTag(azue.b(bajq.a(40.0F), bajq.a(40.0F), bajq.a(3.5F)));
  ...
  public void a(WeakReference<Activity> paramWeakReference, int paramInt, Class<? extends GdtCanvasBaseFragment> paramClass)
  {
    ...
    localyjs.jdField_a_of_type_Int = paramInt;
    if (paramWeakReference != null)
    {
      localyjs.jdField_a_of_type_JavaLangRefWeakReference = paramWeakReference;
      localyjs.jdField_a_of_type_ComTencentGdtadAditemGdtAd = new GdtAd(this.jdField_a_of_type_CooperationVipJsoninflateModelAlumBasicData.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGetRsp$AdInfo);
      ...
      localyjs.jdField_b_of_type_JavaLangClass = paramClass;
      localyjs.jdField_a_of_type_AndroidOsBundle = new Bundle();
      if (this.jdField_c_of_type_Int == 3) {
        localyjs.jdField_a_of_type_AndroidOsBundle.putString("big_brother_ref_source_key", "biz_src_jc_kuolie");
      }
      yjr.a(localyjs);
