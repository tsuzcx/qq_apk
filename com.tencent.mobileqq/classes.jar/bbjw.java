...
public class bbjw
  extends bbkf
{
  public bbjw(Context paramContext)
  {
    super(paramContext);
  }
  
  private void a(QQAppInterface paramQQAppInterface, bbkb parambbkb, boolean paramBoolean, int paramInt, String paramString)
  {
    parambbkb.jdField_a_of_type_Boolean = paramBoolean;
    if (paramBoolean)
    {
      if (paramInt == 0) {
        parambbkb.jdField_a_of_type_Int = 0;
      }
    }
    else {
      return;
    ...
    if (paramInt == 3000)
    {
      parambbkb.jdField_a_of_type_Int = 3000;
      return;
    }
    if (paramInt == 1)
    {
      ...
      {
      default: 
        parambbkb.jdField_a_of_type_Int = 1;
      }
      for (;;)
      {
        parambbkb.i = 0;
        ...
        parambbkb.i = paramQQAppInterface.wMemberNum;
        return;
        parambbkb.jdField_a_of_type_Int = 1;
        continue;
        parambbkb.jdField_a_of_type_Int = 3;
        continue;
        parambbkb.jdField_a_of_type_Int = 4;
        continue;
        parambbkb.jdField_a_of_type_Int = 2;
      }
    }
    parambbkb.jdField_a_of_type_Int = 9999;
  }
  
  private boolean a(bbkb parambbkb, String paramString)
  {
    Object localObject2 = new File(paramString);
    Object localObject1 = auog.c(paramString);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (paramString.equalsIgnoreCase(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES).getAbsolutePath() + File.separator)) {
          parambbkb.j = 1002;
        } else if ((((String)localObject1).contains("camera")) || (((String)localObject1).equals("dcim")) || (((String)localObject1).equals("100MEDIA")) || (((String)localObject1).equals("100ANDRO")) || (((String)localObject1).contains(anzj.a(2131701780))) || (((String)localObject1).contains(anzj.a(2131701779))) || (((String)localObject1).contains(anzj.a(2131701781)))) {
          parambbkb.j = 1007;
        } else if (akrx.a(paramString)) {
          parambbkb.j = 1005;
        } else {
  ...
  public void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString, bbjz parambbjz)
  {
    parambbjz.f = paramInt1;
    if (paramInt2 == 0) {
      parambbjz.b = 0;
    }
    for (;;)
    {
      paramAppInterface = (axup)paramAppInterface.getManager(106);
      if (paramAppInterface != null)
      {
        parambbjz.d = paramAppInterface.a();
        parambbjz.e = paramAppInterface.b();
      }
      parambbjz.g = Calendar.getInstance().get(11);
      parambbjz.h = bhnv.a(BaseApplication.getContext());
      return;
      if (paramInt2 == 3000)
      {
        parambbjz.b = 3000;
      ...
      else
      {
        if (paramInt2 == 1)
        {
          ...
          for (;;)
          {
            ...
            parambbjz.c = paramString.wMemberNum;
            break;
            parambbjz.b = 1;
            continue;
            parambbjz.b = 3;
