  ...
  implements bhsq
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new actq(this);
  private View.OnClickListener b;
  
  public actp(Context paramContext, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView, acts paramacts)
  {
    super(paramContext, paramQQAppInterface, paramExpandableListView);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new actr(this);
  ...
  private void a(akdg paramakdg, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      return;
      str = alpo.a(2131705226);
      i = this.jdField_b_of_type_JavaUtilList.size();
      break;
      str = alpo.a(2131705222);
      i = this.c.size();
      break;
      str = alpo.a(2131705227);
      i = this.d.size();
      break;
      str = alpo.a(2131705233);
      i = this.e.size();
      break;
      str = alpo.a(2131705229);
      i = this.f.size();
      break;
      str = alpo.a(2131705223);
      i = this.g.size();
      break;
      label356:
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      if ((localObject2 == null) || (((ajxk)localObject2).a == null)) {
        break label436;
      }
      if (!(((ajxk)localObject2).a instanceof TroopInfo)) {
        break label247;
      }
      localTroopInfo = (TroopInfo)((ajxk)localObject2).a;
      ...
      paramBoolean = this.jdField_a_of_type_Acts.a(localTroopInfo.troopuin, 1);
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        for (;;)
        {
          ...
          paramView = (akee)paramView.getTag();
          break;
          localObject2 = localTroopInfo.troopuin;
        }
        if ((((ajxk)localObject2).a instanceof DiscussionInfo))
        {
          localObject2 = (DiscussionInfo)((ajxk)localObject2).a;
          ...
          paramBoolean = this.jdField_a_of_type_Acts.a(((DiscussionInfo)localObject2).uin, 3000);
          paramInt1 = this.jdField_a_of_type_Almv.a(((DiscussionInfo)localObject2).uin);
      ...
      QLog.d("ContactsTroopAdapter", 2, "getChildView data:" + ((ajxk)localObject2).a + " groupPosition:" + paramInt1 + " childPosition:" + paramInt2);
      return paramViewGroup;
    }
    label436:
