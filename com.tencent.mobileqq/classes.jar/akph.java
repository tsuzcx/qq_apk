  ...
  extends ScanningData
{
  ...
  public akph(Context paramContext)
  {
    super(paramContext);
    l();
    a();
  ...
  private void l()
  {
    ...
    this.i = (bajq.a(1.5F) * this.jdField_c_of_type_Float);
  ...
  public void g()
  {
    ...
    {
      this.jdField_g_of_type_AndroidAnimationObjectAnimator = ObjectAnimator.ofFloat(this, "fCPositionY", new float[] { -bajq.a(25.0F), 0.0F });
