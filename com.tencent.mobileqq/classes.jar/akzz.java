...
{
  public akzz(AuthorityActivity paramAuthorityActivity) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (str = "g_a_a_l_emp";; str = "g_a_a_l")
    {
      if (paramBoolean)
      {
        ...
        for (;;)
        {
          ...
          catch (Exception paramBundle)
          {
            ...
            ((Message)localObject1).obj = this.a.getResources().getString(2131435606);
      ...
      for (;;)
      {
        ...
        paramBundle.obj = this.a.getResources().getString(2131435606);
        this.a.jdField_a_of_type_CooperationQqfavUtilHandlerPlus.sendMessage(paramBundle);
        paramBundle = this.a.getResources().getString(2131435606);
        try
        {
