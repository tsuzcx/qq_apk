  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
    ...
    if (localWebViewFragment != null)
    {
      ...
      if (localWebViewFragment.mSwiftTitleUI.b != null)
      {
        ...
        localImageView.setPadding(j, k, agej.a(i, this.jdField_a_of_type_ComTencentSmttSdkWebView.getResources()) + m, localImageView.getPaddingBottom());
      }
      label388:
      for (;;)
      {
        localImageView.setOnClickListener(new biuu(this, paramString));
        return;
