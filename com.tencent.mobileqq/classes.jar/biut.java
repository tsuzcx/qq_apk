...
public class biut
{
  protected static biut a;
  
  private long a(SQLiteDatabase paramSQLiteDatabase, String paramString, biuq parambiuq)
  {
    try
    {
      ContentValues localContentValues = new ContentValues();
      localContentValues.put("actiontype", parambiuq.c);
      localContentValues.put("appid", parambiuq.a);
      localContentValues.put("qua", parambiuq.e);
      localContentValues.put("uin", parambiuq.d);
      localContentValues.put("via", parambiuq.b);
      localContentValues.put("network", parambiuq.a());
      localContentValues.put("timestamp", parambiuq.g);
      localContentValues.put("expand1", parambiuq.h);
      localContentValues.put("expand2", parambiuq.i);
      localContentValues.put("expand3", parambiuq.j);
      localContentValues.put("expand4", parambiuq.k);
      localContentValues.put("expand5", parambiuq.l);
      long l1 = -1L;
      try
      {
      ...
      catch (SQLException paramSQLiteDatabase)
      {
        for (;;)
        {
          ...
          bisy.e("BusinessReport", paramSQLiteDatabase.getLocalizedMessage());
        }
      }
      return l1;
    }
  ...
  public int a(String paramString)
  {
    try
    {
      ...
      bisy.b("Jie", "new_table>>count=" + i);
      i += b("table_old_data", paramString);
      bisy.b("Jie", "all_table>>>count=" + i);
      return i;
    }
    finally
    {
  ...
  public int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramString1)
      {
        ...
        localObject2 = localObject1;
        bisy.e("BusinessReport", paramString1.getLocalizedMessage());
      }
      finally
      {
  ...
  /* Error */
  public int a(String paramString, ArrayList<biuq> paramArrayList)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 4
    ...
    //   10: aload_0
    //   11: invokevirtual 143	biut:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   14: astore 5
    //   16: aload 5
    //   18: ifnonnull +7 -> 25
    //   21: aload_0
    ...
    //   56: checkcast 21	biuq
    //   59: invokespecial 189	biut:a	(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Lbiuq;)J
    //   62: pop2
    //   63: iload_3
    //   64: iconst_1
    //   65: iadd
    ...
    //   97: ldc 200
    //   99: aload_1
    //   100: invokestatic 203	bisy:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   103: aload 5
    ...
    //   0	144	2	paramArrayList	ArrayList<biuq>
    //   4	91	3	i	int
    //   1	92	4	j	int
  ...
  public int a(ArrayList<biuq> paramArrayList)
  {
    try
    {
  ...
  /* Error */
  public long a(String paramString, biuq parambiuq)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   5: lstore 5
    //   7: aload_0
    //   8: invokevirtual 143	biut:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   11: astore 7
    //   13: lload 5
    //   15: lstore_3
    //   16: aload 7
    ...
    //   24: aload_1
    //   25: aload_2
    //   26: invokespecial 189	biut:a	(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Lbiuq;)J
    //   29: lstore_3
    //   30: aload 7
    ...
    //   42: ldc 212
    //   44: aload_1
    //   45: invokestatic 203	bisy:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   48: aload 7
  ...
  protected SQLiteDatabase a()
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = biuv.a(biip.a().a()).getWritableDatabase();
  ...
  public ArrayList<biuq> a(String paramString)
  {
    try
    {
  ...
  /* Error */
  public ArrayList<biuq> a(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   43: astore 7
    //   45: aload_0
    //   46: invokevirtual 143	biut:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   49: astore 5
    //   51: aload 10
    //   53: astore 4
    //   55: aload 9
    ...
    //   104: new 21	biuq
    //   107: dup
    //   108: invokespecial 247	biuq:<init>	()V
    //   111: astore 6
    //   113: aload_1
    //   114: astore 4
    //   116: aload_1
    ...
    //   134: putfield 25	biuq:c	Ljava/lang/String;
    //   137: aload_1
    //   138: astore 4
    //   140: aload_1
    //   141: astore_2
    ...
    //   158: putfield 33	biuq:a	Ljava/lang/String;
    //   161: aload_1
    //   162: astore 4
    //   164: aload_1
    //   165: astore_2
    ...
    //   182: putfield 38	biuq:e	Ljava/lang/String;
    //   185: aload_1
    //   186: astore 4
    //   188: aload_1
    //   189: astore_2
    ...
    //   206: putfield 43	biuq:d	Ljava/lang/String;
    //   209: aload_1
    //   210: astore 4
    //   212: aload_1
    //   213: astore_2
    ...
    //   230: putfield 48	biuq:b	Ljava/lang/String;
    //   233: aload_1
    //   234: astore 4
    //   236: aload_1
    //   237: astore_2
    ...
    //   254: putfield 257	biuq:f	Ljava/lang/String;
    //   257: aload_1
    //   258: astore 4
    //   260: aload_1
    //   261: astore_2
    ...
    //   278: putfield 58	biuq:g	Ljava/lang/String;
    //   281: aload_1
    //   282: astore 4
    //   284: aload_1
    //   285: astore_2
    ...
    //   302: putfield 63	biuq:h	Ljava/lang/String;
    //   305: aload_1
    //   306: astore 4
    //   308: aload_1
    //   309: astore_2
    ...
    //   326: putfield 68	biuq:i	Ljava/lang/String;
    //   329: aload_1
    //   330: astore 4
    //   332: aload_1
    //   333: astore_2
    ...
    //   350: putfield 73	biuq:j	Ljava/lang/String;
    //   353: aload_1
    //   354: astore 4
    //   356: aload_1
    //   357: astore_2
    ...
    //   374: putfield 78	biuq:k	Ljava/lang/String;
    //   377: aload_1
    //   378: astore 4
    //   380: aload_1
    //   381: astore_2
    ...
    //   398: putfield 83	biuq:l	Ljava/lang/String;
    //   401: aload_1
    //   402: astore 4
    //   404: aload_1
    //   405: astore_2
    ...
    //   443: invokestatic 105	bisy:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   446: aload 4
    //   448: ifnull +10 -> 458
    //   451: aload 4
  ...
  public int b(String paramString1, String paramString2)
  {
    ...
    //   36: astore 8
    //   38: aload_0
    //   39: invokevirtual 143	biut:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   42: astore 7
    //   44: aload 11
    //   46: astore_2
    //   47: aload 10
    ...
    //   145: invokestatic 105	bisy:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   148: aload 5
    //   150: ifnull +10 -> 160
    //   153: aload 5
  ...
  public ArrayList<biuq> b(String paramString)
  {
    try
    {
