...
{
  private anvi jdField_a_of_type_Anvi = new bhag(this);
  ...
  private volatile WeakReference<bhah> jdField_b_of_type_MqqUtilWeakReference;
  private volatile boolean jdField_b_of_type_Boolean;
  
  public bhaf(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(Setting paramSetting)
  {
    ...
    for (;;)
    {
      ...
      paramSetting = "";
      break;
      localObject = aoks.b(paramSetting.uin);
      ...
      if (HttpDownloadUtil.downloadData(a(), new asid(MsfSdkUtils.insertMtype("friendlist", paramSetting), localFile2, 0), this) == 0) {
        bool1 = true;
      }
      boolean bool2;
      if (bool1)
  ...
  public boolean a(String paramString, boolean paramBoolean, bhah parambhah)
  {
    if (QLog.isColorLevel()) {
    ...
    this.jdField_b_of_type_MqqUtilWeakReference = new WeakReference(parambhah);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (paramMessage = (Drawable)paramMessage.obj;; paramMessage = null)
    {
      ...
      {
        localbhah = (bhah)this.jdField_b_of_type_MqqUtilWeakReference.get();
        if (localbhah != null)
        {
      ...
      {
        localbhah.a(str, bool, paramMessage);
