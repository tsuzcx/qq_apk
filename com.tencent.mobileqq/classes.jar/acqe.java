  ...
  implements apwk
{
  private static int a(int paramInt)
  {
    ...
    acvc.d("GdtInterstitialNotifyReg", String.format("getError arkScriptError:%d not working", new Object[] { Integer.valueOf(paramInt) }));
    return 1;
  }
  ...
  private static int a(String paramString)
  {
    ...
    {
      acvc.d("GdtInterstitialNotifyReg", String.format("getReasonForClose params:%s", new Object[] { paramString }), localThrowable);
    }
    return -2147483648;
  }
  ...
  private static long a(String paramString)
  {
    ...
    {
      acvc.d("GdtInterstitialNotifyReg", String.format("getVideoPositionMillis params:%s", new Object[] { paramString }), localThrowable);
    }
    return -2147483648L;
  }
  ...
  private static GdtAd a(String paramString)
  {
    ...
    {
      acvc.b("GdtInterstitialNotifyReg", String.format("getAd params:%s", new Object[] { paramString }), localThrowable);
    }
    return null;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    for (;;)
    {
      acvc.b("GdtInterstitialNotifyReg", String.format("receiveHTTPGet %b %s", new Object[] { Boolean.valueOf(bool), paramString }));
      return bool;
  ...
  private static int b(String paramString)
  {
    ...
    {
      acvc.d("GdtInterstitialNotifyReg", String.format("getError params:%s", new Object[] { paramString }), localThrowable);
    }
    return -2147483648;
  }
  ...
  private static String b(String paramString)
  {
    ...
    {
      acvc.d("GdtInterstitialNotifyReg", String.format("getUrl params:%s", new Object[] { paramString }), localThrowable);
    }
    return null;
  }
  ...
  private boolean b(String paramString)
  {
    ...
    for (;;)
    {
      acvc.b("GdtInterstitialNotifyReg", String.format("receiveClick %b", new Object[] { Boolean.valueOf(bool) }));
      return bool;
  ...
  private static String c(String paramString)
  {
    ...
    {
      acvc.d("GdtInterstitialNotifyReg", String.format("getKey params:%s", new Object[] { paramString }), localThrowable);
    }
    return null;
  }
  ...
  private boolean c(String paramString)
  {
    ...
    for (;;)
    {
      acvc.b("GdtInterstitialNotifyReg", String.format("receiveClose %b", new Object[] { Boolean.valueOf(bool) }));
      return bool;
  ...
  private boolean d(String paramString)
  {
    ...
    for (;;)
    {
      acvc.b("GdtInterstitialNotifyReg", String.format("receiveLoaded %b", new Object[] { Boolean.valueOf(bool) }));
      return bool;
  ...
  private boolean e(String paramString)
  {
    int i = b(paramString);
    int j = a(i);
    acvc.d("GdtInterstitialNotifyReg", String.format("receiveError error:%d arkScriptError:%d params:%s", new Object[] { Integer.valueOf(j), Integer.valueOf(i), paramString }));
    if ((j != 4) && (j != 207)) {}
    do
    {
      return true;
  ...
  {
    int i = 0;
    acvc.b("GdtInterstitialNotifyReg", String.format("notify appName:%s eventName:%s params:%s", new Object[] { paramString1, paramString2, paramString3 }));
    boolean bool;
    if (acqd.a().a().a.equals(paramString1)) {
    ...
    for (;;)
    {
      ...
      {
        acvp.a(BaseApplicationImpl.getApplication(), paramString3, (GdtInterstitialStatus)localObject, paramString2, paramString1);
        return bool;
