...
public class ajrq
  implements Comparable<ajrq>
{
  public int a;
  public long a;
  public int b;
  
  public ajrq(VideoFramesFetcher paramVideoFramesFetcher, long paramLong, int paramInt1, int paramInt2)
  {
  ...
  public int a(ajrq paramajrq)
  {
    return -(int)(this.jdField_a_of_type_Long - paramajrq.jdField_a_of_type_Long);
  }
}
