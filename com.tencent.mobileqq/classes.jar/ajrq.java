  ...
  extends ajfb
{
  ...
  public ajrq(QQAppInterface paramQQAppInterface)
  {
      ...
      catch (InvalidProtocolBufferMicroException paramArrayOfByte)
      {
        do
        {
          do
          {
            do
            {
              do
              {
                ...
                case 2: 
                  ...
                  paramArrayOfByte = new bbta(this.app.getApp().getApplicationContext(), paramArrayOfByte);
                }
              } while (paramArrayOfByte == null);
              paramArrayOfByte = (bbtd)paramArrayOfByte.a("intchk");
            } while (paramArrayOfByte == null);
            ...
            paramArrayOfByte.b("8.2.6." + AppSetting.g());
            return;
            paramArrayOfByte = (MSFNetTransportProvider)this.app.a(63);
            paramArrayOfByte = new bbta(this.app.getApp().getApplicationContext(), paramArrayOfByte);
          } while (paramArrayOfByte == null);
          paramArrayOfByte = (bbtc)paramArrayOfByte.a("app_scan");
        } while (paramArrayOfByte == null);
