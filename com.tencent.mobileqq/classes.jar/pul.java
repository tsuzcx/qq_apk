  ...
  extends pwd
{
  ...
  public pul(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qli paramqli, Handler paramHandler)
  {
  ...
  private void c()
  {
    ...
    localReqBody.uint32_network_type.set(ptv.b());
    try
    {
    ...
    a(qlk.a("OidbSvc.0xcba", 3258, 0, localReqBody.toByteArray()));
  }
  
  private void d()
  {
    String str = (String)bkwm.a("sp_key_daily_dynamic_header_data", "");
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int i = paq.a(paramToServiceMsg, paramFromServiceMsg, paramObject, localRspBody, false);
    ...
    if (i == 0)
    {
      if ((localRspBody.rspChannelArticle.has()) && (localRspBody.rspChannelArticle.get() != null))
      {
        ...
        if ((paramToServiceMsg.bytes_nearby_cookie.has()) && (paramToServiceMsg.bytes_nearby_cookie.get() != null))
        {
          ...
          bkwm.a("sp_key_daily_dynamic_header_data", paramToServiceMsg);
          a(paramToServiceMsg);
        }
      }
      return;
    }
    bkwm.a("sp_key_daily_dynamic_header_data", "");
