  ...
  implements awbo
{
  ...
  public atww(QQAppInterface paramQQAppInterface)
  {
  ...
  private SummaryCardUpdate.SUpdateReq a(int paramInt, String paramString)
  {
    ...
    localSUpdateReq.client_version.set("8.2.6");
  ...
  private void a(File paramFile)
  {
    ...
    //   151: dup
    //   152: aload_0
    //   153: getfield 18	atww:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   156: invokevirtual 239	com/tencent/mobileqq/app/QQAppInterface:getApplication	()Lmqq/app/MobileQQ;
    //   159: invokestatic 244	azyk:a	(Landroid/content/Context;)Ljava/lang/String;
    ...
    //   204: aload_0
    //   205: aload_1
    //   206: invokespecial 260	atww:a	(Ljava/lang/String;)V
    //   209: aload 4
    //   211: ifnull -76 -> 135
    //   214: aload 4
  ...
  private void a(String paramString)
  {
    ...
    if (paramString != null)
    {
      ...
      bace.a(new File(BaseApplicationImpl.getApplication().getFilesDir(), "labelList").getAbsolutePath(), localByteArrayOutputStream.toByteArray(), false);
    }
  }
  ...
  private boolean e()
  {
    ...
    try
    {
      ...
      {
        QLog.d("ProfileCard.ProfileCardCheckUpdate", 2, bool1);
        localObject = new File(azyk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()));
        if (l2 <= l1)
        {
  ...
  public ReqItem a(int paramInt)
  {
    ...
    do
    {
      ...
      System.arraycopy(azvx.b(i), 0, localObject2, 0, 4);
    ...
    QLog.d("ProfileCard.ProfileCardCheckUpdate", 2, "getCheckUpdateItemData uin=" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin() + ",cardVersion=" + str1 + "labelVersion=" + str2 + ",client_version=" + "8.2.6" + ",dataLen=" + i);
    return localReqItem;
  }
      ...
      if (i == 2) {
        for (;;)
        {
          try
          {
            ...
            i = (int)bakz.a((byte[])localObject, 0);
            paramRespItem = new byte[i - 4];
            bakz.a(paramRespItem, 0, (byte[])localObject, 4, i - 4);
  ...
  public void a(SummaryCardUpdate.SUpdateRsp paramSUpdateRsp)
  {
    ...
    bcad.a().a("SummaryCardUpdate.EM_RT_FUN_CALL", 100, i, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1000277, ajjy.a(2131642665), true);
  }
  ...
  public void b(SummaryCardUpdate.SUpdateRsp paramSUpdateRsp)
  {
    ...
    bcad.a().a("SummaryCardUpdate.EM_RT_SPECIAL_REMIND", 100, i, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1000277, ajjy.a(2131642700), true);
  }
  ...
  public void d(SummaryCardUpdate.SUpdateRsp paramSUpdateRsp)
  {
    ...
    bcad.a().a("SummaryCardUpdate.EM_RT_SUMMARY_LABEL", 100, i, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1000277, ajjy.a(2131642670), true);
  }
  ...
  public void e(SummaryCardUpdate.SUpdateRsp paramSUpdateRsp)
  {
    ...
    bcad.a().a("SummaryCardUpdate.EM_RT_SUMMARY_UPDATE", 100, i, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 1000277, ajjy.a(2131642690), true);
  }
}
