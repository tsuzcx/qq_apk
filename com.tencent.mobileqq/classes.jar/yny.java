...
public class yny
  implements Runnable
{
  public yny(NewFriendMoreSysMsgAdapter paramNewFriendMoreSysMsgAdapter, boolean paramBoolean) {}
  ...
  public void run()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAdapterNewFriendMoreSysMsgAdapter.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.runOnUiThread(new ynz(this, localArrayList));
  }
}
