  ...
  extends unk<vcv>
{
  ...
  public vax(String paramString, int paramInt)
  {
    this(paramString, paramInt, 0, 0);
  }
  
  public vax(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    if (paramString == null) {
  ...
  public String a()
  {
    return ume.a("StorySvc.video_emoticon_get");
  }
  ...
  public unf a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new vcv(localRspGetEmoticonPackList, paramArrayOfByte, System.currentTimeMillis());
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      wsv.e("GetEmojiPackInfoListRequest", "GetEmojiPackInfoListRequest error : " + paramArrayOfByte);
    }
    return null;
  }
