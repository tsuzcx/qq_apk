...
public class aimu
{
  ...
  private static HashMap<String, List<aiko>> c = new HashMap();
  ...
  public static List<aiko> a(String paramString)
  {
  ...
  public static List<aija> a(ArrayList<aiko> paramArrayList, QQAppInterface paramQQAppInterface)
  {
    ...
    {
      String str = String.valueOf(((aiko)paramArrayList.get(i)).jdField_a_of_type_Long);
      ...
      if ((localTroopInfo != null) && (localTroopInfo.troopname != null) && (!localTroopInfo.troopname.isEmpty()))
      {
        ...
        localaija.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo = localTroopInfo;
        localaija.jdField_a_of_type_JavaLangString = str;
        localaija.jdField_a_of_type_Int = ((aiko)paramArrayList.get(i)).jdField_a_of_type_Int;
        localArrayList.add(localaija);
      }
      i += 1;
    }
    return localArrayList;
  ...
  public static void a(String paramString1, String paramString2, String paramString3, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      paramString2 = (anca)paramQQAppInterface.getBusinessHandler(20);
  ...
  public static void a(String paramString, List<aiko> paramList)
  {
  ...
  public static boolean a(long paramLong, int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = (atub)paramQQAppInterface.getBusinessHandler(153);
    if (!a(str))
    {
