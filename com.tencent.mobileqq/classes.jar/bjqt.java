  ...
  implements bjoh
{
  ...
  public bjqt(WadlJsBridge paramWadlJsBridge, String paramString)
  {
  ...
  public void onException(String paramString)
  {
    ...
    bjqp.a("WadlJsBridge", "##@!JsCheckUpdateCallback onException >>> " + paramString);
  ...
  {
    bjqp.c("WadlJsBridge", "##@checkUpdate(End) onResult()");
    if (!this.jdField_a_of_type_ComTencentOpenWadlWadlJsBridge.hasRight()) {
      return;
    }
