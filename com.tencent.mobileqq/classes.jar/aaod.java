  ...
  implements aaob
{
  ...
  aapa jdField_a_of_type_Aapa = null;
  protected String a;
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            this.jdField_a_of_type_Aanz.b(paramString, (String)localObject);
            return;
          }
        }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("anonymousNickChanged".equals(paramString3)) {
      try
      {
        ...
        this.jdField_a_of_type_Aanz.a(paramString1, l, i, paramString2, j, paramString3, this);
        return true;
      }
    ...
    for (;;)
    {
      ...
      if ("cleanDynamicRedPoint".equals(paramString3)) {
        try
        {
          ...
          this.jdField_a_of_type_Aanz.c(paramJsBridgeListener, this);
          return true;
        }
        catch (JSONException paramJsBridgeListener)
        {
      ...
      else if ("getTroopBarPublishInfo".equals(paramString3))
      {
        try
        {
          ...
          this.jdField_a_of_type_Aanz.a(new aaoe(this, paramJsBridgeListener));
        }
        catch (JSONException paramJsBridgeListener)
        {
          paramJsBridgeListener.printStackTrace();
      ...
      else
      {
        if (("createVideoAndSend".equals(paramString3)) || ("prepareVideoResources".equals(paramString3))) {
          try
          {
            ...
            if (this.jdField_a_of_type_Aapa == null) {
              this.jdField_a_of_type_Aapa = new aapa((BaseActivity)this.mRuntime.a());
            }
            localObject2 = this.jdField_a_of_type_Aapa;
            localObject2.getClass();
            localObject2 = new aapk((aapa)localObject2);
            ((aapk)localObject2).jdField_a_of_type_JavaLangString = paramString1;
            ((aapk)localObject2).b = ((String)localObject1);
            ((aapk)localObject2).c = paramString2;
            ((aapk)localObject2).jdField_a_of_type_Int = i;
            i = 0;
            while (i < paramVarArgs.length())
            {
              paramString1 = paramVarArgs.getString(i);
              ((aapk)localObject2).jdField_a_of_type_JavaUtilArrayList.add(paramString1);
              i += 1;
            }
            if ("createVideoAndSend".equals(paramString3)) {
              this.jdField_a_of_type_Aapa.a((aapk)localObject2, new aaof(this, paramJsBridgeListener));
            } else {
              this.jdField_a_of_type_Aapa.a((aapk)localObject2, new aaog(this, paramJsBridgeListener));
            }
          }
        ...
        else if (("enableShortVideoPublish".equals(paramString3)) && (paramVarArgs.length == 1))
        {
          try
          {
            ...
            paramJsBridgeListener.put("enableShortVideoPublish", bann.a());
            if (QLog.isColorLevel()) {
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_Aapa = null;
  }
}
