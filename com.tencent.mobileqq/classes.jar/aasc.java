  ...
  implements ServiceConnection
{
  ...
  public void onServiceConnected(ComponentName paramComponentName, android.os.IBinder arg2)
  {
    ...
    //   29: aload_2
    //   30: aload_0
    //   31: getfield 12	aasc:a	Laasb;
    //   34: getfield 50	aasb:jdField_a_of_type_AndroidOsMessenger	Landroid/os/Messenger;
    ...
    //   48: aload_3
    //   49: ldc 58
    //   51: invokestatic 61	aasb:a	()Ljava/lang/String;
    ...
    //   67: aload_0
    //   68: getfield 12	aasc:a	Laasb;
    //   71: astore_2
    //   72: aload_2
    //   73: monitorenter
    //   74: aload_0
    //   75: getfield 12	aasc:a	Laasb;
    //   78: aload_1
    //   79: putfield 76	aasb:jdField_b_of_type_AndroidOsMessenger	Landroid/os/Messenger;
    //   82: new 78	java/util/ArrayList
    //   85: dup
    //   86: aload_0
    //   87: getfield 12	aasc:a	Laasb;
    //   90: getfield 81	aasb:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   93: invokespecial 84	java/util/ArrayList:<init>	(Ljava/util/Collection;)V
    //   96: astore_3
    //   97: aload_0
    //   98: getfield 12	aasc:a	Laasb;
    //   101: getfield 81	aasb:jdField_b_of_type_JavaUtilList	Ljava/util/List;
