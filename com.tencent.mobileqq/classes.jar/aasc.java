...
public class aasc
{
  ...
  public aasc(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new mqq.util.WeakReference(paramQQAppInterface);
  }
  
  private static aasp a(JSONObject paramJSONObject)
  {
    if (paramJSONObject == null) {
      return null;
    }
    aasp localaasp = new aasp(null);
    localaasp.jdField_a_of_type_Int = paramJSONObject.optInt("type", -1);
    localaasp.d = paramJSONObject.optString("md5", null);
    localaasp.b = paramJSONObject.optString("url", null);
    localaasp.jdField_a_of_type_JavaLangString = paramJSONObject.optString("name", null);
    localaasp.c = paramJSONObject.optString("identifier", null);
    if (!localaasp.a())
    {
    ...
    if (paramJSONObject != null)
    {
      localaasp.e = paramJSONObject.optString("url");
      localaasp.f = paramJSONObject.optString("diff-md5");
      localaasp.g = paramJSONObject.optString("source-md5");
      if (!localaasp.b()) {
        localaasp.a();
      }
    }
  ...
  private void a(String paramString, aasp paramaasp1, aasp paramaasp2, aasr paramaasr)
  {
    boolean bool = false;
    aasp localaasp = paramaasp1;
    if (!a(paramaasp1)) {
      localaasp = null;
    }
    if (localaasp == null)
    {
      ArkAppCenter.b("ArkApp.Dict.Update", String.format("updateDict, local not exists, full update, name=%s", new Object[] { paramaasp2.jdField_a_of_type_JavaLangString }));
      ArkAppDataReport.a(paramaasp2.jdField_a_of_type_JavaLangString, 1);
      a(paramString, paramaasp2, new aasg(this, paramaasp2, paramaasr));
      return;
    }
    if (localaasp.d.equals(paramaasp2.d))
    {
      ArkAppCenter.b("ArkApp.Dict.Update", String.format("updateDict, file not change, copy from origin, name=%s", new Object[] { paramaasp2.jdField_a_of_type_JavaLangString }));
      paramaasp1 = c(localaasp.jdField_a_of_type_JavaLangString);
      paramString = String.format("%s/%s", new Object[] { paramString, paramaasp2.jdField_a_of_type_JavaLangString });
      if (FileUtils.d(paramaasp1, paramString)) {
        break label284;
      }
      ArkAppCenter.b("ArkApp.Dict.Update", String.format("updateDict, copy file fail, %s->%s", new Object[] { paramaasp1, paramString }));
    }
    for (;;)
    {
      paramaasr.a(bool);
      return;
      if ((paramaasp2.b()) && (localaasp.d.equals(paramaasp2.g)))
      {
        ArkAppCenter.b("ArkApp.Dict.Update", String.format("updateDict, incremental update, name=%s", new Object[] { paramaasp2.jdField_a_of_type_JavaLangString }));
        ArkAppDataReport.a(paramaasp2.jdField_a_of_type_JavaLangString, 3);
        b(paramString, localaasp, paramaasp2, new aash(this, paramaasp2, paramaasr, paramString));
        return;
      }
      ArkAppCenter.b("ArkApp.Dict.Update", String.format("updateDict, full update, name=%s", new Object[] { paramaasp2.jdField_a_of_type_JavaLangString }));
      a(paramString, paramaasp2, new aasj(this, paramaasr));
      return;
      label284:
      bool = true;
    }
  ...
  private void a(String paramString, aasp paramaasp, aasr paramaasr)
  {
    a(paramaasp.jdField_a_of_type_JavaLangString, paramaasp.b, new aask(this, paramaasp, paramString, paramaasr));
  }
  
  private void a(String paramString1, String paramString2, aasq paramaasq)
  {
    aass localaass = new aass(null);
    ...
    localaass.jdField_a_of_type_JavaLangRefWeakReference = new java.lang.ref.WeakReference(localPreDownloadController);
    paramaasq = new aasm(this, paramString2, localaass, paramaasq);
    if (localQQAppInterface == null)
    {
      ArkAppCenter.b("ArkApp.Dict.Update", "downloadDictFile, qq app interface is null, return");
      return;
    }
    localaass.jdField_a_of_type_Boolean = localPreDownloadController.a();
    if (localaass.jdField_a_of_type_Boolean)
    {
      localPreDownloadController.a(10022, "prd", paramString1, 0, paramString2, "", 1, 0, false, new RunnableTask(localQQAppInterface, paramString1, paramaasq, 10000L));
      return;
    }
    paramaasq.run();
  ...
  private void a(JSONObject paramJSONObject1, JSONObject paramJSONObject2)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = new aast(null);
      ((aast)localObject1).jdField_a_of_type_Int = ((Map)localObject2).size();
      ((aast)localObject1).jdField_a_of_type_Boolean = true;
      localObject2 = ((Map)localObject2).values().iterator();
      while (((Iterator)localObject2).hasNext())
      {
        aasp localaasp = (aasp)((Iterator)localObject2).next();
        a(str, (aasp)paramJSONObject1.get(localaasp.jdField_a_of_type_JavaLangString), localaasp, new aase(this, (aast)localObject1, localaasp, str, paramJSONObject2));
      }
    }
  }
  
  private static boolean a(aasp paramaasp)
  {
    if (paramaasp == null) {}
    while (!a(c(paramaasp.jdField_a_of_type_JavaLangString), paramaasp.d)) {
      return false;
    }
    return true;
  }
  ...
  private static boolean a(String paramString1, String paramString2)
  {
    ...
    //   80: invokestatic 409	aasc:a	([B)Ljava/lang/String;
    //   83: aload_1
  ...
  private void b(String paramString, aasp paramaasp1, aasp paramaasp2, aasr paramaasr)
  {
    a(paramaasp2.jdField_a_of_type_JavaLangString, paramaasp2.e, new aasl(this, paramaasp2, paramaasp1, paramString, paramaasr));
  }
  ...
  private void c(JSONObject paramJSONObject)
  {
    ...
    } while (a((aasp)localIterator.next()));
    for (int i = 1;; i = 0)
    {
      if (i == 0)
      {
  ...
  public void a()
  {
    ...
    ArkRecommendLogic.a().post(new aasd(this));
  }
