...
public final class biup
{
  private static Intent a(Activity paramActivity, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        if (paramIntent.getBooleanExtra("is_from_qreader_shortcut", false)) {
          ...
          {
            bixe.e("QRJumpAction", localNumberFormatException.toString());
          }
        } else {
          i = -1;
        }
    ...
    paramActivity.putExtras(paramIntent);
    return paramActivity;
    paramIntent.putExtra("url", bixg.b(a(paramIntent.getStringExtra("url"))));
    paramIntent.putExtra("item_type", 2);
    paramActivity = new Intent(paramActivity, ReaderContentPageActivity.class);
  ...
  public static Intent a(Activity paramActivity, Intent paramIntent, String paramString)
  {
    ...
    {
      bixe.e("QRJumpAction", "jumpAction args error");
      return new Intent();
    }
  ...
  public static void a(Context paramContext, Intent paramIntent, String paramString, bimm parambimm)
  {
    if ((paramContext == null) || (paramIntent == null) || (TextUtils.isEmpty(paramString)))
    {
      bixe.a("QRJumpAction", "jumpToPlugin args error");
      return;
    }
    String str = BaseApplicationImpl.getApplication().getRuntime().getAccount();
    bimp localbimp = new bimp(1);
    localbimp.b = "qqreaderplugin.apk";
    localbimp.d = alpo.a(2131711580);
    localbimp.jdField_a_of_type_JavaLangString = str;
    localbimp.e = paramString;
    localbimp.jdField_a_of_type_JavaLangClass = QRPluginProxyActivity.a(paramString);
    paramIntent.putExtra("userQqResources", 2);
    localbimp.jdField_a_of_type_AndroidContentIntent = paramIntent;
    paramIntent = bihv.a(1);
    if (paramIntent != null)
    {
      paramIntent.a();
      localbimp.jdField_a_of_type_Asor = paramIntent.jdField_a_of_type_Asor;
    }
    try
    {
      bimg.a(paramContext, localbimp, parambimm);
      return;
    }
    catch (Exception paramContext)
    {
      bixe.a("QRJumpAction", "[jumpToPlugin] error!", paramContext);
    }
  }
}
