...
public class biup
  implements Observer
{
  private ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new biuv(this);
  ...
  public biup(QQAppInterface paramQQAppInterface)
  {
  ...
  private Bundle a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Biuw == null)
      {
      ...
      try
      {
        ...
        paramBundle = this.jdField_a_of_type_Biuw.a("com.qqdataline.action.notify", paramBundle);
        if (paramBundle != null) {
          paramBundle.setClassLoader(getClass().getClassLoader());
        }
        return paramBundle;
  ...
  private void a(Bundle paramBundle, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Biuw.a("com.qqdataline.action.notify", paramBundle);
        return;
      }
      catch (Exception paramBundle)
      {
  ...
  private Bundle b(Bundle paramBundle)
  {
    ...
    if (((String)localObject2).equals("DatalineHandler_sendC2CMessage_ToService"))
    {
      ...
      paramBundle.putParcelable("ToServiceMsg", ((alqo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8)).a(l1, (String)localObject1, i, j, k, (byte[])localObject2, l2));
    }
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            {
              ((alqo)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(8)).sendPbReq((ToServiceMsg)paramBundle.getParcelable("ToServiceMsg"));
              return null;
            }
          ...
          localObject2 = ((amnv)localObject2).a();
          paramBundle = (Bundle)localObject1;
      ...
      if (((String)localObject2).equals("DatalineHandler_saveFileManagerEntity"))
      {
        ...
        paramBundle = arrr.a((String)localObject1);
        ...
        localFileManagerEntity.fileSize = arrr.a((String)localObject1);
        localFileManagerEntity.isReaded = true;
        localFileManagerEntity.peerUin = ((String)localObject2);
        if (l1 == 0L) {}
        for (localFileManagerEntity.peerNick = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131694654);; localFileManagerEntity.peerNick = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131694666))
        {
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Biuw == null) && (!this.jdField_a_of_type_Boolean))
    {
  ...
  private void d()
  {
    ...
    {
      CheckPermission.requestSDCardPermission(BaseActivity.sTopActivity, new biur(this));
      return;
    }
    f();
  }
  ...
  private void f()
  {
    a(0);
    this.b = false;
    this.jdField_a_of_type_Bdjz = bdgm.a(BaseActivity.sTopActivity, 230, alud.a(2131703151), alud.a(2131703155), 2131694806, 2131721503, new bius(this), new biut(this));
    this.jdField_a_of_type_Bdjz.setOnDismissListener(new biuu(this));
    TextView localTextView = (TextView)this.jdField_a_of_type_Bdjz.findViewById(2131365233);
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-2, -2);
    localLayoutParams.gravity = 17;
    localTextView.setLayoutParams(localLayoutParams);
    localTextView.setMinHeight(bdaq.a(BaseActivity.sTopActivity, 35.0F));
    ...
    for (;;)
    {
      ...
      while (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
      {
        ...
        try
        {
          ...
          localObject1 = localObject2;
          this.jdField_a_of_type_Biuw.a("com.qqdataline.action.notify", localBundle);
          localObject1 = localObject2;
          if (!QLog.isColorLevel()) {
            continue;
          }
  ...
  private void i()
  {
    ...
    localPluginCommunicationHandler.register(new biuq(this, "dataline.remotecall"));
  }
  ...
  private void k()
  {
    ...
    biun.a(BaseActivity.sTopActivity, (Bundle)localObject, "com.qqdataline.activity.LiteWifiphotoActivity");
  ...
  public biuo a()
  {
    ...
    biuo localbiuo = new biuo();
    localbiuo.jdField_a_of_type_JavaLangString = localBundle.getString("ServerInfo.serverIp");
    localbiuo.jdField_a_of_type_Int = localBundle.getInt("ServerInfo.serverPort");
    return localbiuo;
  }
  ...
  {
    if ((paramawge instanceof DataLineMsgRecord)) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(0).a(paramawge, paramamnx);
    }
    while (!(paramawge instanceof MpfileTaskRecord)) {
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a((MpfileTaskRecord)paramawge);
  }
  
  public void a(MpfileTaskInfo paramMpfileTaskInfo, long paramLong)
  {
    FileManagerEntity localFileManagerEntity = arrr.a(paramMpfileTaskInfo, paramLong);
  ...
  public void a(String paramString1, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString, amnx paramamnx)
  {
    if (paramString1.equals(DataLineMsgRecord.tableName())) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(0).a(paramString1, paramContentValues, paramString2, paramArrayOfString, paramamnx);
    }
    while (!paramString1.equals(MpfileTaskRecord.tableName())) {
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramString1, paramContentValues, paramString2, paramArrayOfString, paramamnx);
  }
  
  public void a(String paramString1, String paramString2, String[] paramArrayOfString, amnx paramamnx)
  {
    if (paramString1.equals(DataLineMsgRecord.tableName())) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(0).a(paramString1, paramString2, paramArrayOfString, paramamnx);
    }
    while (!paramString1.equals(MpfileTaskRecord.tableName())) {
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramString1, paramString2, paramArrayOfString, paramamnx);
  }
