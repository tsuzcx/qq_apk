...
public abstract class anzf
  extends anzo
{
  private static anzh a;
  public int a;
  protected Context a;
  protected SparseArray<View> a;
  
  public anzf(Context paramContext, int paramInt1, int paramInt2)
  {
    super(paramInt1);
  ...
  {
    if (jdField_a_of_type_Anzh != null)
    {
      jdField_a_of_type_Anzh.a();
      jdField_a_of_type_Anzh = null;
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      if (jdField_a_of_type_Anzh == null) {
        jdField_a_of_type_Anzh = new anzh();
      }
    } while (jdField_a_of_type_Anzh.a(paramInt, localView));
  }
  ...
  public View b(int paramInt)
  {
    ...
    if (jdField_a_of_type_Anzh != null) {
      localView1 = jdField_a_of_type_Anzh.a(i);
    }
