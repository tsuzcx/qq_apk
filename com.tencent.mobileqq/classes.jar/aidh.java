  ...
  extends aimb
{
  ...
  public aidh(FriendListInnerFrame paramFriendListInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562408, paramViewGroup, false);
      paramView = new aidi(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame, null);
    ...
    paramView = (aidi)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberFriendListInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.b(paramViewGroup.uin))
      {
        ...
        if ((AppSetting.d) && (paramView.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
        {
          ...
          localView.setContentDescription(paramViewGroup.getFriendNick() + ajyc.a(2131704870));
        }
      }
      for (;;)
      {
        ...
        break label299;
        label390:
        localView.setContentDescription(paramViewGroup.getFriendNick() + ajyc.a(2131704873));
      }
    }
