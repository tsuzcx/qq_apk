  ...
  extends akhz
{
  public int a;
  public String a;
  public LinkedHashMap<String, List<aidf>> a;
  public List<aidf> a;
  public int[] a;
  public String[] a;
  public int b;
  ...
  public aidh(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 1) || (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 11)) {
      paramChatHistoryTroopMemberFragment = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131691906);
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 5) {
        paramChatHistoryTroopMemberFragment = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131696781);
      } else {
        paramChatHistoryTroopMemberFragment = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131721112);
      }
    }
  }
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        ((TextView)paramView).setText(this.jdField_a_of_type_ArrayOfJavaLangString[paramInt] + this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131721501, new Object[] { Integer.valueOf(localList.size()) }));
  ...
  public Object[] a()
  {
    ...
    Object localObject6 = (bcpg)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203);
    Object localObject9;
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)
      {
        ...
        localaidf = (aidf)localIterator.next();
        if (((bcpg)localObject6).b(localaidf.jdField_a_of_type_JavaLangString))
        {
          ...
          ((List)localObject8).add(localaidf);
        }
      }
      ...
      {
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_n_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_n_of_type_JavaLangString.contains(localaidf.jdField_a_of_type_JavaLangString))) {
          localArrayList2.add(localaidf);
        }
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_JavaLangString.contains(localaidf.jdField_a_of_type_JavaLangString)) && (!this.jdField_a_of_type_JavaUtilList.contains(localaidf))) {
          this.jdField_a_of_type_JavaUtilList.add(localaidf);
        }
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_JavaUtilArrayList.contains(localaidf.jdField_a_of_type_JavaLangString)) && (!this.jdField_a_of_type_JavaUtilList.contains(localaidf)))
        {
          this.jdField_a_of_type_JavaUtilList.add(localaidf);
          this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_JavaUtilArrayList.remove(localaidf.jdField_a_of_type_JavaLangString);
        }
      }
      ...
      {
        if ((!this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && ((localaidf.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_JavaUtilList.contains(localaidf.jdField_a_of_type_JavaLangString)))) {
          ((List)localObject9).add(localaidf);
        }
        if ((!this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && (localaidf.jdField_b_of_type_Boolean)) {
          localArrayList1.add(localaidf);
        }
        if ((!localaidf.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) && (localaidf.jdField_d_of_type_Long == 1L)) {
          ((List)localObject10).add(localaidf);
        }
      }
      if (((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f.equals(localaidf.jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString.contains(localaidf.jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && ((localaidf.jdField_a_of_type_Int == 332) || (localaidf.jdField_a_of_type_Int == 333))))
      {
        ((List)localObject7).add(localaidf);
        if (QLog.isColorLevel()) {
          QLog.d("zivonchen", 2, "constructHashStruct uin = " + localaidf.jdField_a_of_type_JavaLangString + ", name = " + localaidf.jdField_g_of_type_JavaLangString + ", level = " + localaidf.jdField_a_of_type_Int);
        }
      }
      else if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 5) && (!TextUtils.isEmpty(localaidf.u)))
      {
        ((List)localObject7).add(localaidf);
      }
      else
      {
        if (localaidf.jdField_c_of_type_JavaLangString == null) {
          break label4292;
        }
        if (localaidf.jdField_c_of_type_JavaLangString.length() == 0) {
          break label4292;
        }
        for (;;)
        {
          ...
          ((List)localObject1.get(localObject4)).add(localaidf);
          break;
          localObject3 = localaidf.jdField_c_of_type_JavaLangString.substring(0, 1);
        }
      }
    }
    localObject6 = new aidi(0, true);
    ...
    else
    {
      for (;;)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.h) {
          localObject1.remove(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720274));
        }
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 21)
        {
          this.jdField_a_of_type_Int = 0;
          Collections.sort((List)localObject7, (Comparator)localObject6);
          ((LinkedHashMap)localObject4).put(alud.a(2131701978), this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList);
          break label4323;
        }
        if ((((List)localObject9).size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 12))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131720274), localObject9);
        }
        if ((localArrayList1.size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 3))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131721098), localArrayList1);
        }
        if ((((List)localObject10).size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 3))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131691373), localObject10);
        }
        if (((List)localObject7).size() > 0)
        {
          Collections.sort((List)localObject7, (Comparator)localObject6);
        ...
        for (localObject3 = ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment);; localObject3 = this.jdField_a_of_type_JavaLangString)
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131721114), localObject8);
          break label4330;
          if (c1 > 'Z') {
            break;
          }
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 2)
        {
          ...
          {
            localObject7 = (aidf)((Iterator)localObject6).next();
            if (TextUtils.isEmpty(((aidf)localObject7).r)) {
              ((aidf)localObject7).r = a((String[])localObject4, ((aidf)localObject7).jdField_b_of_type_Long, (Calendar)localObject3);
            }
            if (localObject1.get(((aidf)localObject7).r) == null) {
              localObject1.put(((aidf)localObject7).r, new ArrayList());
            }
            ((List)localObject1.get(((aidf)localObject7).r)).add(localObject7);
          }
          ...
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject1.get(localObject4[i]), new aidi(2, false));
        ...
        else if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 6)
        {
          ...
          {
            localObject6 = (aidf)((Iterator)localObject4).next();
            if (TextUtils.isEmpty(((aidf)localObject6).r))
            {
              if (((aidf)localObject6).jdField_b_of_type_Long == 0L) {
                ((aidf)localObject6).jdField_b_of_type_Long = ((aidf)localObject6).jdField_a_of_type_Long;
              }
              ((aidf)localObject6).r = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.a(((aidf)localObject6).jdField_b_of_type_Long, (Calendar)localObject3, ChatHistoryTroopMemberFragment.d(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment), ChatHistoryTroopMemberFragment.e(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment));
            }
            if (localObject2.get(((aidf)localObject6).r) == null) {
              localObject2.put(((aidf)localObject6).r, new ArrayList());
            }
            if (!TextUtils.isEmpty(((aidf)localObject6).r)) {
              ((List)localObject2.get(((aidf)localObject6).r)).add(localObject6);
            }
          }
          localObject3 = new LinkedHashMap();
          ...
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject2.get(ChatHistoryTroopMemberFragment.e(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment).get(i)), new aidi(2, false));
        ...
        else
        {
          ...
          {
            localObject7 = (aidf)((Iterator)localObject6).next();
            if (TextUtils.isEmpty(((aidf)localObject7).q)) {
              ((aidf)localObject7).q = b((String[])localObject4, ((aidf)localObject7).jdField_a_of_type_Long, (Calendar)localObject3);
            }
            if (localObject2.get(((aidf)localObject7).q) == null) {
              localObject2.put(((aidf)localObject7).q, new ArrayList());
            }
            ((List)localObject2.get(((aidf)localObject7).q)).add(localObject7);
          }
          localObject3 = new LinkedHashMap();
          i = localObject4.length - 1;
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject2.get(localObject4[i]), new aidi(3, false));
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 1)
      {
        ...
        {
          localObject10 = (aidf)((Iterator)localObject9).next();
          if (((bcpg)localObject6).b(((aidf)localObject10).jdField_a_of_type_JavaLangString))
          {
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 5) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 2) && (!ChatHistoryTroopMemberFragment.f(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment))) {
              if ((this.jdField_c_of_type_JavaUtilList != null) && (this.jdField_c_of_type_JavaUtilList.contains(((aidf)localObject10).jdField_a_of_type_JavaLangString)))
              {
                ((List)localObject3).add(localObject10);
                ((aidf)localObject10).jdField_d_of_type_Boolean = true;
              }
              else
              {
                ((List)localObject8).add(localObject10);
                ((aidf)localObject10).jdField_d_of_type_Boolean = false;
              }
            }
          }
          else if ((this.jdField_c_of_type_JavaUtilList != null) && (this.jdField_c_of_type_JavaUtilList.contains(((aidf)localObject10).jdField_a_of_type_JavaLangString)))
          {
            ((aidf)localObject10).jdField_d_of_type_Boolean = true;
            if (((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f.equals(((aidf)localObject10).jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString.contains(((aidf)localObject10).jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && ((((aidf)localObject10).jdField_a_of_type_Int == 332) || (((aidf)localObject10).jdField_a_of_type_Int == 333)))) {
        ...
        localObject2.clear();
        Collections.sort((List)localObject3, new aidi(1, false));
        if (((List)localObject3).size() > 0) {
          localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131721114), localObject3);
        }
        if (((List)localObject4).size() > 0)
        {
          Collections.sort((List)localObject4, new aidi(1, false));
        ...
        for (localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131695019);; localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131695018))
        {
          localObject2.put(localObject3, localObject4);
          Collections.sort((List)localObject7, new aidi(1, false));
          if (((List)localObject7).size() > 0) {
            localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131721110), localObject7);
          }
          Collections.sort((List)localObject8, new aidi(1, false));
          if (((List)localObject8).size() <= 0) {
            break;
          }
          localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131721109), localObject8);
          break;
        }
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 7)
      {
        ...
        while (i < j)
        {
          localObject9 = (aidf)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList.get(i);
          ((aidf)localObject9).k = 0;
          ((HashMap)localObject8).put(((aidf)localObject9).jdField_a_of_type_JavaLangString, localObject9);
          i += 1;
        }
        if (ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment) != null)
        {
          ...
          {
            localObject9 = (aidf)((HashMap)localObject8).remove(String.valueOf(ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)[i]));
        ...
        if (ChatHistoryTroopMemberFragment.b(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment) != null)
        {
          ...
          {
            localObject9 = (aidf)((HashMap)localObject8).remove(String.valueOf(ChatHistoryTroopMemberFragment.b(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)[i]));
            if (localObject9 == null) {
              break label4375;
            }
        ...
        if (ChatHistoryTroopMemberFragment.c(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment) != null)
        {
          ...
          {
            localObject9 = (aidf)((HashMap)localObject8).remove(String.valueOf(ChatHistoryTroopMemberFragment.c(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)[i]));
            if (localObject9 == null) {
              break label4382;
            }
        ...
        Collections.sort((List)localObject3, new aidi(2, true));
        if (!((List)localObject3).isEmpty()) {
          localObject2.put(alud.a(2131701991), localObject3);
        }
        if (!((List)localObject4).isEmpty()) {
          localObject2.put(alud.a(2131702051), localObject4);
        }
        if (!((List)localObject6).isEmpty()) {
          localObject2.put(alud.a(2131702017), localObject6);
        }
        Collections.sort((List)localObject7, new aidi(2, true));
        if (((List)localObject7).isEmpty()) {
          break label4389;
        }
        localObject2.put(alud.a(2131701976), localObject7);
        break label4389;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 8)
      {
        ...
        {
          localObject8 = (aidf)((Iterator)localObject7).next();
          localObject9 = (oidb_0xa2a.UserInfo)((HashMap)localObject6).get(((aidf)localObject8).jdField_a_of_type_JavaLangString);
          if (localObject9 != null)
          {
            ((List)localObject3).add(localObject8);
            ((aidf)localObject8).l = ((oidb_0xa2a.UserInfo)localObject9).score.get();
          }
          else
          {
        ...
        if (((List)localObject3).size() > 0)
        {
          Collections.sort((List)localObject3, new aidi(8, false));
          localObject2.put(alud.a(2131702013), localObject3);
        }
        if (((List)localObject4).size() <= 0) {
          break label4392;
        }
        Collections.sort((List)localObject4, new aidi(8, false));
        localObject2.put(alud.a(2131702006), localObject4);
        break label4392;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 4)
      {
        ...
        localObject6 = alud.a(2131701982);
        localObject7 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject7).hasNext())
        {
          localObject8 = (aidf)((Iterator)localObject7).next();
          j = ((aidf)localObject8).jdField_a_of_type_Int;
          i = j;
          if (j >= 10000) {
            i = ((aidf)localObject8).jdField_a_of_type_Int - 10000;
          }
          if ((i >= 321) && (i <= 327))
          {
    ...
    for (;;)
    {
      if (i >= 0)
      {
        ...
        {
          Collections.sort((List)((LinkedHashMap)localObject3).get(localObject4[i]), new aidi(0, false));
      ...
      else
      {
        if (((LinkedHashMap)localObject3).get(localObject6) != null)
        {
          Collections.sort((List)((LinkedHashMap)localObject3).get(localObject6), new aidi(0, false));
  ...
  public Object getItem(int paramInt)
  {
    ...
    int i = -(i + 1) - 1;
    return (aidf)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
  }
  ...
  public int getItemViewType(int paramInt)
  {
    if (ChatHistoryTroopMemberFragment.e(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment))
    {
      ...
      {
        i = -(i + 1) - 1;
        aidf localaidf = (aidf)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
        if ((TextUtils.isEmpty(localaidf.jdField_m_of_type_JavaLangString)) && (!TextUtils.isEmpty(localaidf.p)) && (!TextUtils.isEmpty(localaidf.jdField_g_of_type_JavaLangString)) && (!localaidf.jdField_g_of_type_JavaLangString.equals(localaidf.p))) {
          return 1;
        }
      }
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      if (i == 0)
      {
        ...
        localObject1 = (aidf)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList.get(paramInt);
        paramViewGroup.g.setTag(((aidf)localObject1).jdField_a_of_type_JavaLangString);
        paramViewGroup.jdField_b_of_type_AndroidViewView.setTag(((aidf)localObject1).jdField_a_of_type_JavaLangString);
        paramViewGroup.jdField_a_of_type_AndroidViewView.setTag(((aidf)localObject1).jdField_a_of_type_JavaLangString);
        paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setTag(Integer.valueOf(paramInt));
        this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.a(paramViewGroup, (aidf)localObject1, a(((aidf)localObject1).jdField_a_of_type_JavaLangString, 2), false, false);
      }
    }
    label253:
    int j;
    for (;;)
    {
      ...
      j = -(j + 1) - 1;
      localObject1 = (aidf)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[j])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[j] - 1);
      paramViewGroup.g.setTag(((aidf)localObject1).jdField_a_of_type_JavaLangString);
      paramViewGroup.jdField_b_of_type_AndroidViewView.setTag(((aidf)localObject1).jdField_a_of_type_JavaLangString);
      paramViewGroup.jdField_a_of_type_AndroidViewView.setTag(((aidf)localObject1).jdField_a_of_type_JavaLangString);
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setTag(Integer.valueOf(paramInt));
      Object localObject2;
      if (((aidf)localObject1).jdField_c_of_type_Boolean)
      {
        localObject2 = new bamb(((aidf)localObject1).jdField_b_of_type_JavaLangString, 16).a();
        paramViewGroup.jdField_e_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
        bdrv.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, paramViewGroup.jdField_e_of_type_AndroidWidgetTextView, (Spannable)localObject2);
      ...
      for (;;)
      {
        ...
        Bitmap localBitmap = a(((aidf)localObject1).jdField_a_of_type_JavaLangString, 2);
        if (i == 1) {}
        for (;;)
        {
          ((ChatHistoryTroopMemberFragment)localObject2).a(paramViewGroup, (aidf)localObject1, localBitmap, false, bool);
          break;
          bool = false;
        }
        label564:
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_Aidv.a(paramViewGroup, (aidf)localObject1);
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 9) || (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 19))
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 12)
      {
        ...
        {
          localObject1 = (aidf)((List)localObject1).get(paramInt);
          if (!this.jdField_a_of_type_JavaUtilList.contains(localObject1)) {
            break label1012;
          }
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131721114).equals(String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[j])))
      {
      ...
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setText(String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[j]) + this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131721501, new Object[] { Integer.valueOf(((List)localObject1).size()) }));
      break label766;
      label1012:
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
    }
