  ...
  implements amup, amut
{
  ...
  public void a()
  {
    ...
    if ((this.jdField_b_of_type_Int > 0) && (this.jdField_a_of_type_Amvm != null)) {
      VipUtils.a(null, "cmshow", "Apollo", "play_times", ApolloUtil.b(this.jdField_a_of_type_Amvm.jdField_a_of_type_Int), 0, new String[] { Integer.toString(this.jdField_b_of_type_Int), this.jdField_a_of_type_Amvm.jdField_a_of_type_JavaLangString });
    }
  ...
  {
    if ((paramSpriteTaskParam == null) || (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList == null) || (this.jdField_a_of_type_Amvm == null))
    {
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localamuu != null) {
        localamuu.a(localSpriteTaskParam, localSpriteTaskParam.jdField_a_of_type_Long);
      }
    }
    if ((this.jdField_a_of_type_Amve != null) && (!TextUtils.isEmpty(paramString)) && (paramString.equals(localSpriteTaskParam.jdField_a_of_type_JavaLangString))) {
      this.jdField_a_of_type_Amve.a(localSpriteTaskParam.jdField_a_of_type_JavaLangString, localSpriteTaskParam.f, localSpriteTaskParam.jdField_a_of_type_Int);
    }
    ...
    do
    {
      do
      {
        ...
        while (localIterator.hasNext())
        {
          amuu localamuu = (amuu)localIterator.next();
          if (localamuu != null) {
            localamuu.a(localSpriteTaskParam, localSpriteTaskParam.jdField_a_of_type_Long, paramInt2);
          }
        }
      } while ((this.jdField_a_of_type_Amve == null) || (TextUtils.isEmpty(paramString)) || (!paramString.equals(localSpriteTaskParam.jdField_a_of_type_JavaLangString)));
      this.jdField_a_of_type_Amve.a(localSpriteTaskParam.jdField_a_of_type_JavaLangString, localSpriteTaskParam.f, localSpriteTaskParam.jdField_a_of_type_Int, localSpriteTaskParam.m, localSpriteTaskParam.jdField_a_of_type_AndroidOsBundle);
  ...
  {
    boolean bool = true;
    if ((this.jdField_a_of_type_Amvm == null) || (!this.jdField_a_of_type_Amvm.a()))
    {
    ...
    } while (localSpriteTaskParam.jdField_a_of_type_Amuq == null);
