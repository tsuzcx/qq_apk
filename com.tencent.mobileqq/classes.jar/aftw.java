...
public class aftw
  implements Runnable
{
  public aftw(ScanTorchActivity paramScanTorchActivity, String paramString) {}
  
  public void run()
  {
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      ScanTorchActivity.q(this.jdField_a_of_type_ComTencentMobileqqOlympicActivityScanTorchActivity);
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqOlympicActivityScanTorchActivity.runOnUiThread(new aftx(this));
      return;
