  ...
  extends LinearLayout
{
  ...
  public taa(TabLayoutCompat paramTabLayoutCompat, Context paramContext)
  {
    super(paramContext);
  ...
  private void a(@Nullable TextView paramTextView, @Nullable ImageView paramImageView)
  {
    ...
    {
      localDrawable = this.jdField_a_of_type_Szz.a();
      if (this.jdField_a_of_type_Szz == null) {
        break label176;
      }
      localCharSequence1 = this.jdField_a_of_type_Szz.a();
      if (this.jdField_a_of_type_Szz == null) {
        break label182;
      }
      localCharSequence2 = this.jdField_a_of_type_Szz.b();
      label48:
  ...
  public void a(@Nullable szz paramszz)
  {
    if (paramszz != this.jdField_a_of_type_Szz)
    {
  ...
  public boolean performClick()
  {
    ...
    if (this.jdField_a_of_type_Szz != null)
    {
      ...
      szz localszz = TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat);
      if (TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat) == this.jdField_a_of_type_Szz) {
        i = 1;
      }
      this.jdField_a_of_type_Szz.a();
      if ((TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat) != null) && (i == 0)) {
        TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat).a(this.jdField_a_of_type_Szz, localszz, 1);
      }
      return true;
    }
    return bool;
