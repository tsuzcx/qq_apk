...
public class tjz
{
  ...
  public static void a()
  {
    ...
    Object localObject = rlz.a;
    localObject = new VInstanceManager.Builder().application(BaseApplicationImpl.getApplication()).param(new JSONObject()).preconditionAdapter(new tjy((String)localObject)).serviceJsUrl((String)localObject).isBlockingMode(false);
