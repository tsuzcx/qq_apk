...
{
  atdy(atdu paramatdu, Intent paramIntent) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    this.jdField_a_of_type_Atdu.a.dismiss();
    if (paramBoolean) {}
    for (;;)
    {
      try
      ...
      catch (Exception paramBundle)
      {
        ...
        this.jdField_a_of_type_Atdu.startActivityForResult(this.jdField_a_of_type_AndroidContentIntent, (byte)1);
      }
