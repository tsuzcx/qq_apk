...
class atdy
  implements blfl<WeiyunPB.LibInfoListGetMsgRsp>
{
  atdy(atdx paramatdx, String paramString) {}
  ...
  public void a(int paramInt, String paramString, WeiyunPB.LibInfoListGetMsgRsp paramLibInfoListGetMsgRsp)
  {
    ...
    atdx.a(this.jdField_a_of_type_Atdx).getFileManagerNotifyCenter().a(false, 31, new Object[] { Integer.valueOf(paramInt), paramString, this.jdField_a_of_type_JavaLangString });
  }
  ...
  public void a(WeiyunPB.LibInfoListGetMsgRsp paramLibInfoListGetMsgRsp)
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localWeiYunFileInfo.jdField_b_of_type_JavaLangString = blhj.a(((WeiyunPB.FileItem)localObject2).pdir_key.get());
      ...
      localWeiYunFileInfo.i = blhj.a(((WeiyunPB.FileItem)localObject2).file_md5.get());
      localWeiYunFileInfo.j = blhj.a(((WeiyunPB.FileItem)localObject2).file_sha.get());
      if (!atdx.a(this.jdField_a_of_type_Atdx).containsKey(localWeiYunFileInfo.jdField_a_of_type_JavaLangString))
      {
        atdx.a(this.jdField_a_of_type_Atdx).put(localWeiYunFileInfo.jdField_a_of_type_JavaLangString, localWeiYunFileInfo);
        localArrayList.add(localWeiYunFileInfo);
      }
    }
    localObject1 = atdx.a(this.jdField_a_of_type_Atdx).getFileManagerNotifyCenter();
    Object localObject2 = this.jdField_a_of_type_JavaLangString;
    if (paramLibInfoListGetMsgRsp.finish_flag.get() == 1) {}
    for (boolean bool = true;; bool = false)
    {
      ((ashb)localObject1).a(true, 31, new Object[] { localObject2, Boolean.valueOf(bool), Integer.valueOf(paramLibInfoListGetMsgRsp.FileItem_items.size()), paramLibInfoListGetMsgRsp.server_version.get(), localArrayList, Integer.valueOf(atdx.a(this.jdField_a_of_type_Atdx)) });
      return;
    }
  }
}
