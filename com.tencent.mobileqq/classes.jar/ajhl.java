...
public class ajhl
{
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        baig.a(BaseApplicationImpl.getContext(), paramInt, k, m, n, (String)localObject1, (String)localObject3, paramString);
        if (QLog.isColorLevel()) {
        ...
        if (!bgfb.b((File)localObject2, paramString))
        {
  ...
  private static boolean a(String paramString1, String paramString2)
  {
    ...
    //   855: aload 11
    //   857: astore_0
    //   858: invokestatic 14	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   861: ifeq +35 -> 896
    //   864: aload 11
    //   866: astore_0
    //   867: ldc 16
    //   869: iconst_2
    //   870: new 24	java/lang/StringBuilder
    //   873: dup
    //   874: invokespecial 28	java/lang/StringBuilder:<init>	()V
    //   877: ldc_w 365
    //   880: invokevirtual 50	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   883: aload_1
    //   884: invokevirtual 274	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   887: invokevirtual 50	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   890: invokevirtual 55	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   893: invokestatic 277	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   896: iload 7
    //   898: istore 8
    //   900: aload 11
    //   902: ifnull -874 -> 28
    //   905: aload 11
    //   907: invokevirtual 343	java/io/BufferedReader:close	()V
    //   910: iload 7
    //   912: ireturn
    //   913: astore_0
    //   914: iload 7
    ...
    //   921: ifnull +7 -> 928
    //   924: aload_0
    //   925: invokevirtual 343	java/io/BufferedReader:close	()V
    //   928: aload_1
    //   929: athrow
    //   930: astore_0
    //   931: goto -3 -> 928
