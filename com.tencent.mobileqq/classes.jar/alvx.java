...
public class alvx
{
  ...
  public static alxy a(int paramInt)
  {
    alyh localalyh = a();
    if (localalyh == null) {
      return null;
  ...
  public static alxy a(int paramInt1, int paramInt2)
  {
    alyh localalyh = a();
    if (localalyh == null) {
      return null;
    }
    return localalyh.a(paramInt1, paramInt2);
  }
  
  public static alxy a(long paramLong)
  {
  ...
  public static alyh a()
  {
    ...
    if ((localAppInterface instanceof CmGameAppInterface)) {
      return (alyh)((CmGameAppInterface)localAppInterface).getManager(255);
    }
    return null;
  }
  
  public static alym a(int paramInt)
  {
    alxy localalxy = a(paramInt);
    if (localalxy != null) {
      return localalxy.a();
    }
  ...
  public static alym a(long paramLong)
  {
    alxy localalxy = b(paramLong);
    if (localalxy != null) {
      return localalxy.a();
  ...
  public static ApolloSurfaceView a()
  {
    ...
    {
      return null;
      localObject = ((alyh)localObject).a();
    } while (localObject == null);
    return ((alxy)localObject).a();
  }
  ...
  public static void a(Activity paramActivity, Conversation paramConversation)
  {
    ...
    {
      return;
      localalnr = (alnr)a().getManager(153);
      if (a(null)) {
        localalnr.k = true;
      }
    } while ((localalnr == null) || (!localalnr.j) || (paramActivity == null) || (!(paramActivity instanceof SplashActivity)) || (paramActivity.isFinishing()) || (!((SplashActivity)paramActivity).isResume()) || (paramConversation == null));
    if (FrameHelperActivity.b())
    {
      FrameHelperActivity.c(true);
      FrameHelperActivity.t();
    }
    a(paramConversation.b, localalnr.a());
    localalnr.j = false;
  ...
  public static void a(View paramView, String paramString)
  {
    ...
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        localTextView.setBackgroundResource(2130838632);
  ...
  public static void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, int paramInt3, long paramLong, JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("sqVersion", "8.4.8.4810");
      ...
      paramJSONObject = new NewIntent(paramAppInterface.getApp(), alsb.class);
      ...
      paramJSONObject.setObserver(new alvy());
  ...
  public static void a(CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    else
    {
      ...
      if ((paramStartCheckParam.mStartType == 2) || (paramStartCheckParam.mStartType == 1) || (paramStartCheckParam.mStartType == 3))
      {
        ...
        if (localList != null)
        {
          ...
          if (i < localList.size())
          {
            localObject3 = (alyk)localList.get(i);
            if ((localObject3 == null) || (((alyk)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam == null)) {
              break label713;
            }
            localObject1 = localalyh.a(((alyk)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
            if (localObject1 == null) {
              break label713;
            }
            localObject4 = ((alxy)localObject1).a();
            if ((((alxy)localObject1).a() != paramStartCheckParam.gameId) || ((paramStartCheckParam.roomId != 0L) && (paramStartCheckParam.roomId != ((ammz)localObject4).jdField_a_of_type_Long))) {
              break label713;
            }
            if (((alxy)localObject1).a() == null) {
              break label1490;
            }
          }
        }
    ...
    label849:
    label1490:
    for (localObject1 = ((alxy)localObject1).a().getClass();; localObject1 = null)
    {
      QLog.i("cmgame_process.CmGameUtil", 1, " launchGame found old task.mStartCheckParam:" + ((alyk)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
      if (localObject1 == null)
      {
        if ((localList != null) && (localList.size() >= alyh.jdField_a_of_type_ArrayOfJavaLangClass.length))
        {
          localObject2 = (alyk)localList.get(0);
          if ((localObject2 != null) && (((alyk)localObject2).jdField_a_of_type_JavaLangRefWeakReference != null))
          {
            localObject3 = (Activity)((alyk)localObject2).jdField_a_of_type_JavaLangRefWeakReference.get();
            if (localObject3 != null)
            {
              ((Activity)localObject3).finish();
              if (((alyk)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
              {
                alxn.a("cs.close_room.local", "{}", false, null, ((alyk)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                QLog.i("cmgame_process.CmGameUtil", 1, " launchGame close old  task.mStartCheckParam.gameId:" + ((alyk)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
              }
            }
          }
          localalyh.jdField_a_of_type_JavaUtilList.remove(0);
        }
        localObject2 = new HashMap();
        i = 0;
        for (;;)
        {
          if (i < localalyh.jdField_a_of_type_JavaUtilList.size())
          {
            localObject3 = (alyk)localalyh.jdField_a_of_type_JavaUtilList.get(i);
            if ((localObject3 != null) && (((alyk)localObject3).jdField_a_of_type_JavaLangString != null)) {
              ((HashMap)localObject2).put(((alyk)localObject3).jdField_a_of_type_JavaLangString, ((alyk)localObject3).jdField_a_of_type_JavaLangString);
            }
            i += 1;
            continue;
            i += 1;
        ...
        i = 0;
        if (i >= alyh.jdField_a_of_type_ArrayOfJavaLangClass.length) {
          break label1483;
        }
        if (TextUtils.isEmpty((String)((HashMap)localObject2).get(alyh.jdField_a_of_type_ArrayOfJavaLangClass[i].getSimpleName())))
        {
          localObject2 = alyh.jdField_a_of_type_ArrayOfJavaLangClass[i];
      ...
      for (;;)
      {
        ...
        {
          localObject1 = alyh.jdField_a_of_type_ArrayOfJavaLangClass[0];
          QLog.e("cmgame_process.CmGameUtil", 1, "can not find activityClass, use first class");
        }
        localObject2 = new alyk();
        ((alyk)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam = paramStartCheckParam;
        ((alyk)localObject2).jdField_a_of_type_JavaLangString = ((Class)localObject1).getSimpleName();
        localalyh.jdField_a_of_type_JavaUtilList.add(localObject2);
        for (;;)
        {
          if (QLog.isColorLevel())
          {
            localObject2 = localalyh.jdField_a_of_type_JavaUtilList.iterator();
            for (;;)
            {
              if (((Iterator)localObject2).hasNext())
              {
                localObject3 = (alyk)((Iterator)localObject2).next();
                QLog.d("cmgame_process.CmGameUtil", 2, "launchGame task:" + ((alyk)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                continue;
                i += 1;
                break;
                ...
                {
                  alyk localalyk = (alyk)localList.get(i);
                  boolean bool2 = false;
                  localObject3 = localObject1;
                  if (localalyk != null)
                  {
                    localObject3 = localObject1;
                    if (localalyk.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
                    {
                      localObject3 = localalyh.a(localalyk.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                      boolean bool1 = bool2;
                      localObject2 = localObject1;
                      if (localObject3 != null)
                      {
                        ammz localammz = ((alxy)localObject3).a();
                        bool1 = bool2;
                        localObject2 = localObject1;
                        if (((alxy)localObject3).a() == paramStartCheckParam.gameId) {
                          if (paramStartCheckParam.roomId != 0L)
                          {
                            bool1 = bool2;
                            localObject2 = localObject1;
                            if (paramStartCheckParam.roomId != localammz.jdField_a_of_type_Long) {}
                          }
                          else
                          {
                            bool2 = true;
                            bool1 = bool2;
                            localObject2 = localObject1;
                            if (((alxy)localObject3).a() != null)
                            {
                              localObject2 = ((alxy)localObject3).a().getClass();
                              bool1 = bool2;
                            }
                          }
                        }
                      ...
                      if (!bool1)
                      {
                        if (localalyk.jdField_a_of_type_JavaLangRefWeakReference != null)
                        {
                          localObject1 = (Activity)localalyk.jdField_a_of_type_JavaLangRefWeakReference.get();
                          if (localObject1 != null)
                          {
                            ((Activity)localObject1).finish();
                            if (localalyk.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) {
                              alxn.a("cs.close_room.local", "{}", false, null, localalyk.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                            }
                            QLog.i("cmgame_process.CmGameUtil", 1, " launchGame close old  task.mStartCheckParam.gameId:" + localalyk.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                          }
                        }
                        ((List)localObject4).add(localalyk);
                        localObject3 = localObject2;
                      }
                    }
                  }
        ...
        for (;;)
        {
          ...
          localObject2 = alyh.jdField_a_of_type_ArrayOfJavaLangClass[0];
          break;
  ...
  public static void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      localalzh = a();
    } while (localalzh == null);
    localalzh.a(paramString1, paramString2, -1L, 4, false, null);
  }
  ...
  public static void a(Object... paramVarArgs)
  {
    alsn localalsn = a();
    if (localalsn != null) {
      localalsn.a("cmg_launch", 4, paramVarArgs);
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    ApolloGameData localApolloGameData = ((amir)localObject).a(paramStartCheckParam.gameId);
    alnr localalnr = (alnr)paramQQAppInterface.getManager(153);
    if (localalnr != null)
    {
      paramStartCheckParam.game = localApolloGameData;
      if ((localApolloGameData != null) && ((((amir)localObject).a(paramStartCheckParam.gameId)) || (paramStartCheckParam.isRequestConf))) {
        break label244;
      }
    }
    label244:
    for (boolean bool = true;; bool = false)
    {
      ...
      paramStartCheckParam.isWhiteUsr = localalnr.c((String)localObject);
      paramStartCheckParam.apolloStatus = localalnr.b((String)localObject);
      paramStartCheckParam.pushItem = localalnr.a().a();
      ...
      paramStartCheckParam.gender = ((awhw)paramQQAppInterface.getManager(106)).b();
      paramStartCheckParam.isEnableMSAA = c(paramStartCheckParam.gameId);
      paramStartCheckParam.mIsTransGame = amio.c.contains(Integer.valueOf(paramStartCheckParam.gameId));
      return true;
    }
  }
  ...
  public static int b()
  {
    ...
    alnr localalnr = (alnr)a().getManager(153);
    if ((localalnr != null) && (localalnr.j())) {
      return 1;
    }
    return 0;
  }
  ...
  public static int b(int paramInt)
  {
    try
    {
      ...
      ((StringBuilder)localObject).append(amip.s).append(paramInt).append(File.separator).append("gameConfig.json");
  ...
  public static alxy b(int paramInt1, int paramInt2)
  {
    alyh localalyh = a();
    if (localalyh == null) {
      return null;
    }
    return localalyh.b(paramInt1, paramInt2);
  }
  
  public static alxy b(long paramLong)
  {
    alyh localalyh = a();
    if (localalyh == null) {
      return null;
    }
    return localalyh.a(paramLong);
  }
  ...
  public static String b(CmGameInitParams paramCmGameInitParams)
  {
    ...
    for (;;)
    {
      try
      {
        localJSONObject1 = amja.a(0, amdp.a);
        ...
        if (("1".equals(paramCmGameInitParams.mGameName)) || ("2".equals(paramCmGameInitParams.mGameName)))
        {
          ...
          if ((!ApolloGameStateMachine.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.getAndSet(false)) || (ApolloGameStateMachine.jdField_a_of_type_Altx == null)) {
            break label999;
          }
          localJSONObject1.put("freeMemory", ApolloGameStateMachine.jdField_a_of_type_Altx.jdField_b_of_type_Long);
          localJSONObject1.put("totalMemory", ApolloGameStateMachine.jdField_a_of_type_Altx.jdField_c_of_type_Long);
          localJSONObject1.put("osVersion", altx.jdField_a_of_type_JavaLangString);
          localJSONObject1.put("model", altx.jdField_b_of_type_JavaLangString);
          localJSONObject1.put("cpuType", altx.jdField_c_of_type_JavaLangString);
          localJSONObject1.put("cpuNumber", altx.jdField_a_of_type_Int);
          localJSONObject1.put("cpuFrequency", altx.jdField_a_of_type_Long);
          localJSONObject1.put("gameVersion", paramCmGameInitParams.mVersion);
          localJSONObject1.put("QQVer", "8.4.8.4810");
  ...
  public static void b()
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localObject = (alnr)a().getManager(153);
        if ((localObject != null) && (((alnr)localObject).k())) {
          ((alnr)localObject).a().b();
        }
        i = a();
      } while (-1 == i);
      localObject = alvp.a().a(i);
    } while (localObject == null);
    ((alyd)localObject).c();
  }
