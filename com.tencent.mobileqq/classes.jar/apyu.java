...
public class apyu
{
  ...
  private ArkAppPreloader.PreloadAppCallback jdField_a_of_type_ComTencentArkArkAppPreloader$PreloadAppCallback = new apyw(this);
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  private ConcurrentHashMap<String, apyy> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(8);
  private boolean jdField_a_of_type_Boolean;
  private boolean b;
  
  public apyu(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(apyy paramapyy)
  {
    ...
    ThreadManagerV2.executeOnSubThread(new ArkAppPreDownloadMgr.3(this, paramapyy));
  }
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() > 0) && (!this.jdField_a_of_type_Boolean))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (!TextUtils.isEmpty(localapyy.a)) {
          if (TextUtils.isEmpty(ArkAppMgr.getInstance().getAppPathByNameFromLocal(localapyy.a, "", null, false))) {
            a(localapyy);
          } else {
            QLog.d("ArkApp.ArkAppPreDownloadMgr", 1, new Object[] { "profiling ark app predowloaded,app=", localapyy.a });
          }
        }
      }
    }
  ...
  public void a(aqys paramaqys)
  {
    if ((paramaqys != null) && (paramaqys.a() != null)) {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = paramaqys.a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
    }
