  ...
  implements Manager
{
  ...
  public bglo(QQAppInterface paramQQAppInterface)
  {
  ...
  private MessageForTroopReward a(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, int paramInt3)
  {
    ...
    localMessageForTroopReward.msgUid = bcsc.a(paramInt1);
    localMessageForTroopReward.msg = bhfj.a(null);
    ...
    localMessageForTroopReward.time = bcrg.a();
  ...
  {
    acne localacne = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageProxy(0).a();
    Lock localLock = localacne.a(paramString, paramInt);
    localLock.lock();
    try
    {
      paramString = (List)localacne.b().get(a(paramString, paramInt));
      if (paramString != null)
      {
