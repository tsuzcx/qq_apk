  ...
  implements View.OnClickListener
{
  ...
  public boolean a;
  protected ArrayList<ainj> b;
  protected boolean b;
  private boolean c;
  private boolean d;
  
  public aiow(Context paramContext, QQAppInterface paramQQAppInterface, ListView paramListView, int paramInt, boolean paramBoolean)
  {
  ...
  private void a(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (bkxa.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
        break label134;
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bool)
        {
          abdm.a(null, "Usr_NewDevice_Click", i, 0, 0);
      ...
      catch (Exception localException2)
      {
        for (;;)
        {
          try
          {
            ...
            bkxa.a().a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), localIntent2, str1, 0, null, SmartDevicePluginProxyActivity.class);
            abdm.a(null, "Usr_NewDevice_Click", i, 0, 0);
          }
  ...
  private void a(View paramView, Friends paramFriends)
  {
    ...
    paramFriends = localaara.a(paramFriends.signature, paramFriends.iTermType);
    localaara.a((Activity)this.jdField_a_of_type_AndroidContentContext, paramFriends, false);
    ...
    if (paramFriends != null)
    {
      ...
      i = 1;
      abdm.a(null, l, "Usr_LiteApp_Open", i, 0, paramFriends.productId);
      l = paramFriends.din;
    ...
    for (int i = 1;; i = 2)
    {
      abdm.a(null, l, "Usr_LiteApp_Open_Online", i, 0, paramFriends.productId);
      return;
      i = 2;
      break;
    }
  ...
  {
    amzy localamzy = (amzy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(10);
    int i;
  ...
  private void f()
  {
    ...
    localFriends.remark = amtj.a(2131694020);
    localFriends.name = amtj.a(2131694020);
    if (a(AppConstants.DATALINE_PC_UIN))
    {
      i = 10;
      localFriends.status = ((byte)i);
      localFriends.groupid = 1001;
      localArrayList.add(aini.a(5, localFriends, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
      ...
      if ((a(AppConstants.DATALINE_IPAD_UIN)) || (this.c))
      {
        ...
        localFriends.remark = this.jdField_a_of_type_AndroidContentContext.getString(2131693487);
        localFriends.name = this.jdField_a_of_type_AndroidContentContext.getString(2131693487);
        ...
        if (!this.d)
        {
          bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005D18", "0X8005D18", 0, 0, "", "", "", "");
          this.d = true;
      ...
      if (((amxn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(74)).a())
      {
        localFriends = new Friends();
        localFriends.uin = AppConstants.DATALINE_PRINTER_UIN;
        localFriends.remark = this.jdField_a_of_type_AndroidContentContext.getString(2131691255);
        localFriends.name = this.jdField_a_of_type_AndroidContentContext.getString(2131691255);
        if (!a(AppConstants.DATALINE_IPAD_UIN)) {
          break label528;
        }
      }
    ...
    for (int i = 10;; i = 0)
    {
      ...
      if (this.jdField_b_of_type_Boolean)
      {
        ...
        localFriends.remark = this.jdField_a_of_type_AndroidContentContext.getString(2131691253);
        localFriends.name = this.jdField_a_of_type_AndroidContentContext.getString(2131691253);
  ...
  public int a()
  {
    ...
    while (i < getCount())
    {
      ...
      if ((localObject1 != null) && ((localObject1 instanceof aiou)))
      {
        localObject1 = (Friends)((aiou)localObject1).a;
        Object localObject2 = (aara)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(51);
        if (localObject2 != null)
        {
          localObject2 = ((aara)localObject2).b();
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    {
      Friends localFriends = (Friends)((ainj)((Iterator)localObject).next()).a;
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localFriends.remark = abdn.a(localDeviceInfo);
        ...
        localArrayList1.add(aini.a(5, localFriends, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
        this.jdField_a_of_type_Int += 1;
        break;
        i = 0;
        break label170;
        ...
        {
          localObject = localaara.a(localDeviceInfo.productId);
      ...
      label479:
      localArrayList2.add(aini.a(5, localFriends, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
      break;
  ...
  public void d()
  {
    ...
    if (i < localArrayList.size()) {
      if (!((Friends)((ainj)localArrayList.get(i)).a).uin.equals(AppConstants.DATALINE_PRINTER_UIN)) {}
    }
    for (;;)
    {
      if (((amxn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(74)).a()) {
  ...
  public void e()
  {
    ...
    for (;;)
    {
      ...
      int i = 0;
      if (i < localArrayList.size()) {
        if (!((Friends)((ainj)localArrayList.get(i)).a).uin.equals(AppConstants.DATALINE_IPAD_UIN)) {}
      }
      for (;;)
      {
        if (i != -1) {
        ...
        for (i = 1;; i = 0)
        {
          ...
          ((amzy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(10)).d(1);
          return;
          i += 1;
          break;
          i = 0;
  ...
  public Object getItem(int paramInt)
  {
    ...
    return (ainj)this.jdField_b_of_type_JavaUtilArrayList.get(paramInt);
  }
  ...
  {
    View localView = ((ainj)this.jdField_b_of_type_JavaUtilArrayList.get(paramInt)).a(0, paramInt, paramView, paramViewGroup, null);
    if (localView != null)
    {
      a((ainm)localView.getTag(), null);
  ...
  public void onClick(View paramView)
  {
    ...
    if (localainm != null)
    {
      ...
      if ((localainm.a instanceof Friends)) {
        localObject = (Friends)localainm.a;
      }
    }
    if (localObject == null) {}
    for (;;)
    {
      ...
      try
      {
        ((azvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).b("100701.100702");
        label118:
        if ((this.jdField_a_of_type_AndroidContentContext instanceof BaseActivity))
        {
          ...
          localBaseActivity.requestPermissions(new aiox(this, paramView, localBaseActivity), 3, new String[] { "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
        }
        for (;;)
        {
          ...
          bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800603C", "0X800603C", 0, 0, "", "", "", "");
          break;
          label262:
          a(paramView);
          continue;
        ...
        if (AppConstants.DATALINE_IPAD_UIN.equals(((Friends)localObject).uin))
        {
          ...
          this.jdField_a_of_type_AndroidContentContext.startActivity((Intent)localObject);
          bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006041", "0X8006041", 0, 0, "", "", "", "");
          continue;
        }
        ...
        if ((this.jdField_a_of_type_AndroidContentContext instanceof BaseActivity))
        {
          ...
          if (!PermissionUtils.isStorePermissionEnable(localBaseActivity))
          {
            localBaseActivity.requestPermissions(new aioy(this, paramView, (Friends)localObject, localBaseActivity), 3, new String[] { "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
            continue;
          }
