  ...
  extends ltv
{
  ...
  public ltz(lud paramlud)
  {
    ...
    this.jdField_a_of_type_Luv = new luv(localBitmap);
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 > 2)
    {
      ...
      if (this.jdField_a_of_type_ArrayOfLuv != null)
      {
        ...
        if (this.jdField_a_of_type_ArrayOfLuv[(paramInt1 / 10)] != null) {
          this.jdField_a_of_type_ArrayOfLuv[(paramInt1 / 10)].a(this.jdField_a_of_type_AndroidGraphicsCanvas, this.jdField_b_of_type_AndroidGraphicsRect, this.jdField_a_of_type_AndroidGraphicsPaint);
        }
    ...
    for (;;)
    {
      if (this.jdField_b_of_type_Luv != null) {
        this.jdField_b_of_type_Luv.a(this.jdField_a_of_type_AndroidGraphicsCanvas, this.jdField_b_of_type_AndroidGraphicsRect, this.jdField_a_of_type_AndroidGraphicsPaint);
      }
      this.jdField_b_of_type_AndroidGraphicsRect.set(0, 59, 252, 148);
      paramInt1 = (paramInt2 - 80) / 10;
      if ((paramInt1 >= 0) && (paramInt1 < this.jdField_b_of_type_ArrayOfLuv.length) && (this.jdField_b_of_type_ArrayOfLuv[paramInt1] != null)) {
        this.jdField_b_of_type_ArrayOfLuv[paramInt1].a(this.jdField_a_of_type_AndroidGraphicsCanvas, this.jdField_b_of_type_AndroidGraphicsRect, this.jdField_a_of_type_AndroidGraphicsPaint);
      }
      return;
      label239:
      if (this.jdField_a_of_type_ArrayOfLuv[paramInt1] != null) {
        this.jdField_a_of_type_ArrayOfLuv[paramInt1].a(this.jdField_a_of_type_AndroidGraphicsCanvas, this.jdField_b_of_type_AndroidGraphicsRect, this.jdField_a_of_type_AndroidGraphicsPaint);
      }
  ...
  {
    this.jdField_b_of_type_ArrayOfLuv[0] = new luv(paramAVRedPacketManager.a("qav_redpacket_score_80.png"));
    this.jdField_b_of_type_ArrayOfLuv[1] = new luv(paramAVRedPacketManager.a("qav_redpacket_score_90.png"));
    this.jdField_b_of_type_ArrayOfLuv[2] = new luv(paramAVRedPacketManager.a("qav_redpacket_score_100.png"));
    this.jdField_b_of_type_ArrayOfLuv[3] = new luv(paramAVRedPacketManager.a("qav_redpacket_score_110.png"));
    this.jdField_b_of_type_Luv = new luv(paramAVRedPacketManager.a("qav_redpacket_score_combo.png"));
  ...
  {
    super.b();
    luv[] arrayOfluv = this.jdField_b_of_type_ArrayOfLuv;
