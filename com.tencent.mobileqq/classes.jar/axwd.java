...
public class axwd
{
  ...
  static
  {
    ...
    jdField_b_of_type_Int = (int)bacc.a(localBaseApplication, 45.0F);
    c = (int)bacc.a(localBaseApplication, 135.0F);
  ...
  public static Bitmap a()
  {
    ...
    {
      localBitmap1 = azvq.a(BaseApplicationImpl.getContext().getResources(), 2130839112);
  ...
  public static Drawable a()
  {
    ...
    if (localBitmap1 == null)
    {
      localBitmap1 = azvq.a(BaseApplicationImpl.getContext().getResources(), 2130837903);
      localBitmap2 = localBitmap1;
      if (localBitmap1 != null)
      {
        localBitmap2 = localBitmap1;
  ...
  public static Drawable a(int paramInt)
  {
    ...
    if (localBitmap1 == null)
    {
      localBitmap1 = azvq.a(BaseApplicationImpl.getContext().getResources(), paramInt);
      localBitmap2 = localBitmap1;
      if (localBitmap1 != null)
      {
        localBitmap2 = localBitmap1;
  ...
  public static URLDrawable a(atqc paramatqc, int paramInt)
  {
    return a(paramatqc, paramInt, null, null);
  }
  
  public static URLDrawable a(atqc paramatqc, int paramInt, String paramString, URLDrawable.URLDrawableOptions paramURLDrawableOptions)
  {
    boolean bool2 = true;
    if (paramatqc == null) {
      return null;
    }
    paramString = URLDrawable.getDrawable(a(paramatqc, paramInt, paramString), paramURLDrawableOptions);
    paramString.setTag(paramatqc);
    if (paramatqc.isSendFromLocal()) {}
    for (;;)
    {
      return paramString;
      if (!atpm.jdField_b_of_type_Boolean) {
        break;
      }
      paramString.setAutoDownload(true);
    }
    boolean bool3 = SettingCloneUtil.readValue(BaseApplication.getContext(), null, BaseApplication.getContext().getString(2131629640), "qqsetting_auto_receive_pic_key", true);
    boolean bool1 = bool2;
  ...
  private static String a(atpj paramatpj)
  {
    if (paramatpj == null) {
      return null;
    }
    switch (paramatpj.jdField_b_of_type_Int)
    {
    default: 
      return null;
    case 0: 
  ...
  private static String a(atpj paramatpj, int paramInt)
  {
    int n;
    String str;
    if (paramInt == 65537)
  ...
  public static URL a(atpn paramatpn, int paramInt, String paramString)
  {
    if (paramatpn == null) {
      return null;
    }
    String str1 = paramatpn.f;
    label48:
    String str2;
    if ((str1 != null) && (!"null".equals(str1)) && (!"".equals(str1)))
    {
      if (paramatpn.jdField_b_of_type_Boolean) {
        paramInt = 1;
      }
      if (paramString == null) {
        break label184;
    ...
    for (;;)
    {
      try
      {
        ...
        if (QLog.isColorLevel())
        {
          QLog.e("URLDrawableHelper", 2, "getURL file == null" + paramatpn.toString());
          str2 = str1;
        }
        if (paramString == null) {
          break label200;
        }
        paramatpn = new URL(paramString, null, str2);
        return paramatpn;
      }
      catch (MalformedURLException paramatpn)
      {
        label184:
        paramatpn.printStackTrace();
        return null;
      }
      if ((paramatpn.jdField_b_of_type_Int == 8000) && (paramInt == 65537))
      {
        if (awqg.a())
        {
          str1 = paramatpn.k;
      ...
      str1 = paramatpn.g;
      break;
      paramString = a(paramatpn, paramInt);
      break label48;
      label200:
      paramatpn = null;
    }
  ...
  public static URL a(atqc paramatqc, int paramInt)
  {
    return a(paramatqc, paramInt, null);
  }
  
  public static URL a(atqc paramatqc, int paramInt, String paramString)
  {
    if (paramatqc == null) {
      return null;
    }
    if (paramatqc.isSendFromLocal()) {
      return a(paramatqc.getPicUploadInfo(), paramInt, paramString);
    }
    return a(paramatqc.getPicDownloadInfo(), paramInt, paramString);
  }
  
  public static URL a(atqd paramatqd, int paramInt, String paramString)
  {
    if (paramatqd == null) {
      return null;
    }
    if (paramatqd.d < 4) {}
    for (String str2 = a(paramatqd);; str2 = null)
    {
      String str3 = a(paramatqd, paramInt);
      if ((paramatqd.jdField_b_of_type_Int == 8000) && (paramInt == 65537)) {}
      for (String str1 = paramatqd.h;; str1 = "") {
        for (;;)
        {
          if (str1 != null) {}
          try
          {
            if (("".equals(str1)) && (QLog.isColorLevel())) {
              QLog.e("URLDrawableHelper", 2, "getURL file == null" + paramatqd.toString());
            }
            if (paramString != null)
            {
              paramatqd = new URL(paramString, str2, str1);
              return paramatqd;
              if ((paramatqd.f != null) && (!"".equals(paramatqd.f)))
              {
                str1 = paramatqd.f;
                continue;
              }
              if ((paramatqd.a != null) && (!"".equals(paramatqd.a)))
              {
                str1 = paramatqd.a;
                continue;
              }
              if ((paramatqd.g != null) && (!"".equals(paramatqd.g))) {
                str1 = paramatqd.g;
              }
            }
            else
            {
              ...
              paramatqd = new URL(str3, str2, str1);
              return paramatqd;
            }
          }
          catch (MalformedURLException paramatqd)
          {
            paramatqd.printStackTrace();
            return null;
          }
        }
      }
  ...
  public static void a(URLDrawable paramURLDrawable, String paramString, boolean paramBoolean)
  {
    ...
    if ((paramURLDrawable.getStatus() != 1) && (axoa.b(str))) {}
    try
    {
  ...
  public static boolean a(Context paramContext, atqc paramatqc, int paramInt)
  {
    return axoa.a(a(paramatqc, paramInt).toString()) != null;
  }
  ...
  public static Drawable b()
  {
    ...
    if (localBitmap1 == null)
    {
      localBitmap1 = azvq.a(BaseApplicationImpl.getContext().getResources(), 2130837820);
      localBitmap2 = localBitmap1;
      if (localBitmap1 != null)
      {
        localBitmap2 = localBitmap1;
  ...
  public static URLDrawable b(atqc paramatqc, int paramInt)
  {
    URLDrawable localURLDrawable = URLDrawable.getDrawable(a(paramatqc, 65537));
    ...
    {
      localURLDrawable.setTargetDensity(d);
      localURLDrawable.setTag(paramatqc);
  ...
  public static void b()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 500	axwd:jdField_b_of_type_Boolean	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifeq +7 -> 15
    //   11: ldc 2
    ...
    //   53: putstatic 61	axwd:m	I
    //   56: iconst_1
    //   57: putstatic 500	axwd:jdField_b_of_type_Boolean	Z
  ...
  {
    return SettingCloneUtil.readValue(BaseApplication.getContext(), null, BaseApplication.getContext().getString(2131629640), "qqsetting_auto_receive_pic_key", true);
  }
  ...
  public static Drawable c()
  {
    ...
    if (localBitmap1 == null)
    {
      localBitmap1 = azvq.a(BaseApplicationImpl.getContext().getResources(), 2130843637);
      localBitmap2 = localBitmap1;
      if (localBitmap1 != null)
      {
        localBitmap2 = localBitmap1;
