  ...
  implements View.OnTouchListener
{
  ...
  private bblv(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.jdField_b_of_type_JavaLangString = paramString2;
    Friends localFriends = ((ajxl)paramQQAppInterface.getManager(51)).e(paramString1);
    int i;
    if (localFriends != null)
    {
      if (!bblt.a(localFriends.nameplateVipType)) {
        break label166;
      }
      paramQQAppInterface = bblu.a(localFriends.nameplateVipType);
      if (!bblt.b(localFriends.grayNameplateFlag)) {
        break label116;
      }
      i = 1;
      this.c = i;
      this.jdField_a_of_type_Int = paramQQAppInterface.jdField_a_of_type_Int;
      if ((paramQQAppInterface != bblu.e) && (paramQQAppInterface != bblu.f)) {
        break label122;
      }
    ...
    do
    {
      do
      {
        ...
        i = 0;
        break;
        if ((paramQQAppInterface == bblu.c) || (paramQQAppInterface == bblu.d))
        {
          this.jdField_b_of_type_Int = localFriends.superVipTemplateId;
          return;
        }
      } while ((paramQQAppInterface != bblu.jdField_a_of_type_Bblu) && (paramQQAppInterface != bblu.b));
  ...
  public static bblv a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    return new bblv(paramQQAppInterface, paramString1, paramString2);
  }
  ...
  {
    if (!bbtn.a.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "namePlate_UrlConfig")) {
    ...
    {
      paramMotionEvent = bbtn.a.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.c);
      ...
      bool = true;
      bblt.b((String)localObject1, i, bool);
