  ...
  implements Handler.Callback
{
  ...
  private static zrr jdField_a_of_type_Zrr;
  ...
  public static zrr a()
  {
    if (jdField_a_of_type_Zrr == null) {}
    try
    {
      if (jdField_a_of_type_Zrr == null)
      {
        jdField_a_of_type_Zrr = new zrr();
        new HardCoderManager.1().start();
      }
      return jdField_a_of_type_Zrr;
    }
    finally {}
  }
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = zrn.a().a();
  ...
  public int a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, long paramLong, int paramInt7, String paramString, boolean paramBoolean)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1) {
      return zrn.a().a(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramLong, paramInt7, paramString);
    }
    Message localMessage = this.jdField_a_of_type_AndroidOsHandler.obtainMessage(0);
    zro localzro = (zro)zrn.a.obtain(zro.class);
    localzro.jdField_a_of_type_Int = paramInt1;
    localzro.c = paramInt2;
    localzro.d = paramInt3;
    localzro.e = paramInt4;
    localzro.b = paramInt5;
    localzro.f = paramInt6;
    localzro.jdField_a_of_type_Long = paramLong;
    localzro.jdField_a_of_type_JavaLangString = paramString;
    localMessage.obj = localzro;
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((Math.abs(System.currentTimeMillis() - l) <= 86400000L) || (!badq.h(BaseApplicationImpl.getContext()))) {
          continue;
        }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      Object localObject = (zro)paramMessage.obj;
      jdField_a_of_type_AndroidOsBundle.putInt("key_delay", ((zro)localObject).jdField_a_of_type_Int);
      jdField_a_of_type_AndroidOsBundle.putInt("key_cpu", ((zro)localObject).c);
      jdField_a_of_type_AndroidOsBundle.putInt("key_io", ((zro)localObject).d);
      jdField_a_of_type_AndroidOsBundle.putInt("key_bind", ((zro)localObject).e);
      jdField_a_of_type_AndroidOsBundle.putInt("key_timeout", ((zro)localObject).b);
      jdField_a_of_type_AndroidOsBundle.putInt("key_scene", ((zro)localObject).f);
      jdField_a_of_type_AndroidOsBundle.putLong("key_action", ((zro)localObject).jdField_a_of_type_Long);
      jdField_a_of_type_AndroidOsBundle.putString("key_tag", ((zro)localObject).jdField_a_of_type_JavaLangString);
