...
public class wnc
{
  ...
  public static int a(View paramView)
  {
    ...
    do
    {
      ...
      j = xod.d(paramView.getContext()) / 2;
    } while (i <= 0);
    int i = Math.min(Math.abs(j - arrayOfInt[1]), Math.abs(j - (arrayOfInt[1] + i)));
    wsv.b("Q.qqstory.home.StoryListUtils", "getDistanceToCenterY=" + i);
    return i;
  }
  
  public static Bitmap a(Drawable paramDrawable, int paramInt1, int paramInt2, Map<String, Bitmap> paramMap, wmo paramwmo)
  {
    ...
    for (Bitmap localBitmap = (Bitmap)paramMap.get("w=" + paramInt1 + "h=" + paramInt2);; localBitmap = null)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            wnb.b("Q.qqstory.home.StoryListUtils", new Object[] { "drawable2Bitmap need create width=", Integer.valueOf(paramInt1), ",height=", Integer.valueOf(paramInt2) });
          ...
          wsv.a("Q.qqstory.home.StoryListUtils", "drawable2Bitmap:width=%d,height=%d,cost time=%d", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Long.valueOf(System.currentTimeMillis() - l));
          paramDrawable = (Drawable)localObject;
          if (paramwmo == null) {
            break;
          }
          return paramwmo.a((Bitmap)localObject);
        }
        catch (OutOfMemoryError paramDrawable)
        {
          label347:
          wsv.e("Q.qqstory.home.StoryListUtils", "drawable2Bitmap out off memory width=" + paramInt1 + ",height=" + paramInt2);
          return null;
        }
      }
  ...
  public static String a(int paramInt, boolean paramBoolean)
  {
    ...
    default: 
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = alpo.a(2131714833);
      }
      break;
    }
    do
    {
      return localObject2;
      localObject1 = alpo.a(2131714834);
      break;
      localObject1 = alpo.a(2131714832);
      break;
      localObject1 = alpo.a(2131714861);
      break;
      localObject1 = alpo.a(2131714825);
      break;
      localObject1 = alpo.a(2131714822);
      break;
      localObject1 = alpo.a(2131714858);
      break;
      localObject1 = alpo.a(2131714836);
      break;
      localObject1 = alpo.a(2131714826);
      break;
      localObject1 = alpo.a(2131714847);
      break;
      localObject1 = alpo.a(2131714848);
      break;
      localObject1 = alpo.a(2131714863);
      break;
      localObject1 = alpo.a(2131714843);
      break;
      localObject1 = alpo.a(2131714862);
      break;
      localObject1 = alpo.a(2131714856);
      break;
      localObject1 = alpo.a(2131714841);
      break;
      localObject1 = alpo.a(2131714840);
      break;
      localObject1 = alpo.a(2131714830);
      break;
      localObject1 = alpo.a(2131714857);
      break;
      localObject1 = alpo.a(2131714821);
      break;
      localObject1 = alpo.a(2131714827);
      break;
      localObject1 = alpo.a(2131714835);
      break;
      localObject1 = alpo.a(2131714844);
      break;
      localObject1 = alpo.a(2131714855);
      break;
      localObject1 = alpo.a(2131714839);
      break;
      localObject1 = alpo.a(2131714852);
      break;
      localObject1 = alpo.a(2131714823);
      break;
      localObject2 = localObject1;
    } while (!paramBoolean);
    return alpo.a(2131714845) + (String)localObject1;
  }
  ...
  {
    Object localObject = ((uhl)paramQQAppInterface.getManager(181)).a(false);
  ...
  public static void a(ArrayList<String> paramArrayList)
  {
    ...
    wsv.b("Q.qqstory.home.StoryListUtils", "reportShieldFriendStory:" + paramArrayList.size());
    wnm localwnm = new wnm();
    localwnm.a = paramArrayList;
    uht.a().dispatch(localwnm);
  }
  ...
  public static int b(View paramView)
  {
    ...
    wsv.b("Q.qqstory.home.StoryListUtils", "getDistanceToTop=" + i);
    return i;
  }
  ...
  public static String b(long paramLong)
  {
    ...
    if (m == i3) {
      return String.format(Locale.getDefault(), alpo.a(2131714842), new Object[] { Integer.valueOf(n), Integer.valueOf(i1) });
    }
    localCalendar.setTimeInMillis(paramLong);
    localCalendar.add(6, 1);
    if (localCalendar.get(6) == i3) {
      return String.format(Locale.getDefault(), alpo.a(2131714831), new Object[] { Integer.valueOf(n), Integer.valueOf(i1) });
    }
    if (i != i2) {
  ...
  public static int c(View paramView)
  {
    ...
    do
    {
      ...
      paramView.getLocationOnScreen(arrayOfInt);
      i = paramView.getHeight();
      j = xod.d(paramView.getContext());
    } while (i <= 0);
    int i = Math.min(Math.abs(j - arrayOfInt[1]), Math.abs(j - (arrayOfInt[1] + i)));
    wsv.b("Q.qqstory.home.StoryListUtils", "getDistanceToBottom=" + i);
    return i;
  }
}
