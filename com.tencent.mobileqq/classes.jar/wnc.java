  ...
  extends wfm
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = weg.a("StoryTabSvc.startpage_feeds_list_725");
  }
  ...
  public wfh a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new wnd(localRspMsgTabNodeList);
    }
  ...
  protected byte[] a()
  {
    ...
    localReqMsgTabNodeList.client_version.set(ByteStringMicro.copyFromUtf8("8.4.10"));
