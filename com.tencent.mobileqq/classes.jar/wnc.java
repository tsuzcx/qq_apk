  ...
  extends wnf
{
  ...
  private ErrorMessage a()
  {
    ...
    localObject = nnr.a(QQStoryContext.a().a(), (String)localObject, null, "GET", null, null, 5000, 5000);
    if ((localObject != null) && (((HttpResponse)localObject).getStatusLine().getStatusCode() == 200))
    {
      localObject = nnr.a((HttpResponse)localObject);
      yuk.a("Q.qqstory.publish.upload.LinkRichObject", "http resp %s", localObject);
    ...
    {
      yuk.d("Q.qqstory.publish.upload.LinkRichObject", "");
      if (localObject != null) {}
    ...
    yuk.d("Q.qqstory.publish.upload.LinkRichObject", "request take time %dms", new Object[] { Long.valueOf(System.currentTimeMillis() - l) });
  ...
  protected void a()
  {
    ...
    {
      yuk.c("Q.qqstory.publish.upload.LinkRichObject", "parse url ", localJSONException);
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        yuk.c("Q.qqstory.publish.upload.LinkRichObject", "parse url ", localIOException);
