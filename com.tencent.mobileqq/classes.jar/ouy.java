  ...
  implements owa
{
  ...
  public JSONObject a(int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    localJSONObject.put("live_status_bg_url", ((ppm)localObject).jdField_a_of_type_JavaLangString);
    if (!TextUtils.isEmpty(((ppm)localObject).b)) {
      localJSONObject.put("live_status_icon_url", ((ppm)localObject).b);
    }
    localJSONObject.put("live_status_text", ((ppm)localObject).c);
    if (!TextUtils.isEmpty(((ppm)localObject).d)) {
      localJSONObject.put("live_hot_icon_url", ((ppm)localObject).d);
    }
    localJSONObject.put("live_hot_text", ((ppm)localObject).e);
    ...
    for (;;)
    {
      ...
      localJSONObject.put("url", ((ppm)localObject).f);
      localJSONObject.put("jump_report_info", ((ppm)localObject).g);
