  ...
  extends acup
{
  ...
  public afbx(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    this.jdField_a_of_type_Afca = new afca(this, null);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((localacuz instanceof BaseBubbleBuilder)) {
      ((BaseBubbleBuilder)localacuz).c = true;
    }
    paramView = localacuz.a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage, paramView, paramViewGroup, this.jdField_a_of_type_Afca);
    if (paramView != null) {
    ...
    for (;;)
    {
      ...
      else if ((localChatMessage.msgtype == -2039) && ((localacuz instanceof ApolloItemBuilder)))
      {
