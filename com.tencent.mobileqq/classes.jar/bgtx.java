  ...
  implements View.OnTouchListener
{
  ...
  private bgtx(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.jdField_b_of_type_JavaLangString = paramString2;
    Friends localFriends = ((anmw)paramQQAppInterface.getManager(51)).e(paramString1);
    int i;
    if (localFriends != null)
    {
      if (!bgtv.a(localFriends.nameplateVipType)) {
        break label166;
      }
      paramQQAppInterface = bgtw.a(localFriends.nameplateVipType);
      if (!bgtv.b(localFriends.grayNameplateFlag)) {
        break label116;
      }
      i = 1;
      this.c = i;
      this.jdField_a_of_type_Int = paramQQAppInterface.jdField_a_of_type_Int;
      if ((paramQQAppInterface != bgtw.f) && (paramQQAppInterface != bgtw.g)) {
        break label122;
      }
    ...
    do
    {
      do
      {
        ...
        i = 0;
        break;
        if ((paramQQAppInterface == bgtw.d) || (paramQQAppInterface == bgtw.e))
        {
          this.jdField_b_of_type_Int = localFriends.superVipTemplateId;
          return;
        }
      } while ((paramQQAppInterface != bgtw.b) && (paramQQAppInterface != bgtw.c));
  ...
  public static bgtx a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    return new bgtx(paramQQAppInterface, paramString1, paramString2);
  }
  ...
  {
    if (!bhch.a.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "namePlate_UrlConfig")) {
    ...
    {
      paramMotionEvent = bhch.a.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.c);
      ...
      bool = true;
      bgtv.b((String)localObject1, i, bool);
