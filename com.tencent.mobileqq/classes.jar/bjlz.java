...
public class bjlz
{
  private static bjlz a;
  
  private Intent a(QQAppInterface paramQQAppInterface)
  {
    Intent localIntent = bizm.a(paramQQAppInterface.getApp());
  ...
  public void a(android.content.Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    //   194: astore 7
    //   196: getstatic 344	bdlz:e	Z
    //   199: ifne +175 -> 374
    //   202: invokestatic 349	bjma:a	()Lbjma;
    //   205: aload 9
    //   207: aload_1
    //   208: aload 7
    //   210: aload_2
    //   211: aload_3
    //   212: ldc_w 350
    //   215: invokevirtual 353	bjma:a	(Landroid/app/PendingIntent;Landroid/content/Context;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;I)Landroid/app/Notification;
    //   218: astore_2
    //   219: aload_1
    //   220: iconst_0
    //   221: aload_2
    //   222: invokestatic 358	bhnv:a	(Landroid/content/Context;ILandroid/app/Notification;)V
    ...
    //   371: goto -175 -> 196
    //   374: ldc_w 380
    //   377: invokestatic 385	bdcb:k	()Ljava/lang/String;
    //   380: invokevirtual 389	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   383: ifeq +23 -> 406
    //   386: invokestatic 349	bjma:a	()Lbjma;
    //   389: aload 9
    //   391: aload_1
    //   392: aload 7
    //   394: aload_2
    //   395: aload_3
    //   396: ldc_w 350
    //   399: invokevirtual 391	bjma:b	(Landroid/app/PendingIntent;Landroid/content/Context;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;I)Landroid/app/Notification;
    //   402: astore_2
    //   403: goto -184 -> 219
    //   406: invokestatic 349	bjma:a	()Lbjma;
    //   409: aload 9
    //   411: aload_1
    //   412: aload 7
    //   414: aload_2
    //   415: aload_3
    //   416: ldc_w 350
    //   419: invokevirtual 394	bjma:c	(Landroid/app/PendingIntent;Landroid/content/Context;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;I)Landroid/app/Notification;
    //   422: astore_2
    //   423: goto -204 -> 219
    //   426: astore_1
    //   427: ldc 195
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean1, int paramInt2, String paramString5, String paramString6, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    a(paramInt1, paramQQAppInterface);
    Object localObject2 = (ayxn)paramQQAppInterface.getManager(10);
    Object localObject1;
    int i;
    switch (paramInt2)
    {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          localObject1 = BitmapFactory.decodeResource(paramQQAppInterface.getApp().getResources(), 2130847940);
        ...
        catch (OutOfMemoryError localOutOfMemoryError1)
        {
          try
          {
            for (;;)
            {
              ...
              j = 2130841131;
              localObject1 = null;
              localObject2 = atzm.a(paramQQAppInterface);
              if (((atzm)localObject2).a(paramString3, paramString4)) {
                localObject1 = ((atzm)localObject2).a(paramString3, paramString4, null);
              }
              if (bdlz.e) {
                break label1383;
              }
              paramString1 = bjma.a().a((PendingIntent)localObject3, paramQQAppInterface.getApp(), (Bitmap)localObject1, paramString1, paramString2, j);
              ...
              bhnv.a(paramQQAppInterface.getApp(), 0, paramString1);
              if (localStatus != AppRuntime.Status.dnd) {
                break label1441;
              }
              if (!QLog.isColorLevel()) {
              ...
              paramInt1 = ((ayxn)localObject2).a(1);
              ((ayxn)localObject2).a(1, paramInt1);
              if (paramInt1 > 0) {
                break label1555;
              }
              paramInt1 = 1;
                  ...
                  for (;;)
                  {
                    ...
                    try
                    {
                      for (;;)
                      {
                        ...
                        {
                          localObject1 = localObject2;
                          localObject3 = new bizg();
                          localObject1 = localObject2;
                          ((bizg)localObject3).c = String.valueOf(322);
                          localObject1 = localObject2;
                          ((bizg)localObject3).d = String.valueOf(2);
                          localObject1 = localObject2;
                          ((bizg)localObject3).e = String.valueOf(6);
                          localObject1 = localObject2;
                          QZoneClickReport.report(paramQQAppInterface.getAccount(), (bizg)localObject3, true);
                        }
                        localObject1 = localObject2;
                        localObject3 = Uri.parse(paramString5);
                        localObject1 = localObject2;
                        bjmb localbjmb = new bjmb(((Uri)localObject3).getQueryParameter("room"), paramString2, paramBoolean1, paramInt2, paramString5, paramString6);
                        localObject1 = localObject2;
                        if (aywx.a == null)
                        {
                          localObject1 = localObject2;
                          aywx.a = Collections.synchronizedList(new ArrayList());
                        }
                        if (paramBoolean2)
                        {
                          localObject1 = localObject2;
                          aywx.a.add(localbjmb);
                        }
                        try
                        {
              ...
              paramString1 = BaseApplication.getContext().getString(2131720566);
              continue;
              if ((TextUtils.isEmpty(paramString1)) || (paramInt2 != 8)) {
                if (paramBoolean1)
                {
                  if ((paramInt2 == 2) || (paramInt2 == 8) || (paramInt2 == 4)) {
                    paramString1 = BaseApplication.getContext().getString(2131719352);
                  } else {
                    paramString1 = BaseApplication.getContext().getString(2131719352) + "(" + BaseApplication.getContext().getString(2131693507) + paramInt1 + BaseApplication.getContext().getString(2131720336) + BaseApplication.getContext().getString(2131721208) + ")";
                  }
                }
                else {
                  paramString1 = BaseApplication.getContext().getString(2131719352);
          ...
          catch (Throwable localThrowable)
          {
            for (;;)
            {
              try
              {
                localBitmap2 = BitmapFactory.decodeResource(paramQQAppInterface.getApp().getResources(), 2130847837);
              ...
              {
                k = 2130847670;
                localBitmap3 = bcwc.a(paramQQAppInterface.getApp().getResources(), 2130840157);
                localatzm = atzm.a(paramQQAppInterface);
                localBitmap1 = localBitmap3;
                j = k;
                if (localatzm.a(paramString3, paramString4))
                {
                  localBitmap1 = localatzm.a(paramString3, paramString4, localBitmap3);
                  j = k;
                  continue;
                  if ("oppo".equalsIgnoreCase(bdcb.k())) {
                    paramString1 = bjma.a().b(localException5, paramQQAppInterface.getApp(), localBitmap1, paramString1, paramString2, j);
                  } else {
                    paramString1 = bjma.a().c(localException5, paramQQAppInterface.getApp(), localBitmap1, paramString1, paramString2, j);
                  }
                }
              }
            }
            ...
            for (;;)
            {
              if (paramQQAppInterface != null)
              {
                bizm.a(paramQQAppInterface, getClass().getSimpleName());
