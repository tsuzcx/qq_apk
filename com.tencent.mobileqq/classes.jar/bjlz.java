...
public class bjlz
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bjlz.class.getName();
  }
  
  public bjlz()
  {
    this.jdField_a_of_type_Bjma = new bjma(this, bizw.a().a(), "agent_cgi_report.db", null, 4);
  }
  
  /* Error */
  private ArrayList<bjmc> a(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: ldc 44
    //   4: ldc 46
    //   6: invokestatic 52	bjko:b	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   18: aload_0
    //   19: aload_0
    //   20: getfield 39	bjlz:jdField_a_of_type_Bjma	Lbjma;
    //   23: invokevirtual 59	bjma:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   26: putfield 61	bjlz:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   29: aconst_null
    //   30: astore 4
    //   32: aload_0
    //   33: getfield 61	bjlz:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    ...
    //   278: aload 12
    //   280: aload_2
    //   281: invokespecial 129	bjmc:<init>	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   302: aload 4
    //   304: astore_3
    //   305: getstatic 18	bjlz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   332: aload_3
    //   333: invokestatic 143	bjko:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   336: aload_2
    //   337: ifnull +9 -> 346
    //   340: aload_2
    //   341: invokeinterface 146 1 0
    //   346: aload_0
    //   347: getfield 61	bjlz:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    ...
    //   387: invokestatic 52	bjko:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   390: aload_0
    //   391: monitorexit
    //   392: aload 5
    //   394: areturn
    //   395: astore_1
    //   396: getstatic 18	bjlz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   399: ldc 158
    //   401: aload_1
    //   402: invokestatic 143	bjko:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   405: goto -15 -> 390
    //   408: aload_3
    //   409: ifnull -63 -> 346
    //   412: aload_3
  ...
  public int a(String paramString)
  {
    try
    {
      ...
      bjko.b(jdField_a_of_type_JavaLangString, "new_table>>count=" + i);
      i += a("olddata_report", paramString);
      bjko.b(jdField_a_of_type_JavaLangString, "all_table>>>count=" + i);
      return i;
    }
    finally
    {
  ...
  public int a(String paramString1, String paramString2)
  {
    ...
    //   29: aload_0
    //   30: aload_0
    //   31: getfield 39	bjlz:jdField_a_of_type_Bjma	Lbjma;
    //   34: invokevirtual 59	bjma:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   37: putfield 61	bjlz:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   40: aload_0
    //   41: getfield 61	bjlz:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   44: aload_1
    //   45: aconst_null
    //   46: aload 5
    //   48: aload_2
    ...
    //   101: athrow
    //   102: astore_1
    //   103: getstatic 18	bjlz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   106: ldc 158
    //   108: aload_1
    //   109: invokestatic 143	bjko:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   112: iconst_0
    //   113: istore_3
    //   114: goto -45 -> 69
    //   117: astore_1
    //   118: getstatic 18	bjlz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   121: aload_1
    //   122: invokevirtual 189	java/lang/Exception:getLocalizedMessage	()Ljava/lang/String;
    //   125: aload_1
    //   126: invokestatic 192	bjko:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   129: iconst_0
    //   130: istore_3
    //   131: goto -62 -> 69
    // Local variable table:
  ...
  public int a(ArrayList<bjmc> paramArrayList)
  {
    int i;
    try
    {
      bjko.b("cgi_report_debug", "ReportDataModal backupOldItems count = " + paramArrayList.size());
      ...
      for (;;)
      {
        ...
        {
          bjmc localbjmc = (bjmc)paramArrayList.next();
          ContentValues localContentValues = new ContentValues();
          localContentValues.put("apn", localbjmc.jdField_a_of_type_JavaLangString);
          localContentValues.put("frequency", localbjmc.b);
          localContentValues.put("commandid", localbjmc.c);
          localContentValues.put("resultcode", localbjmc.d);
          localContentValues.put("tmcost", localbjmc.e);
          localContentValues.put("reqsize", localbjmc.f);
          localContentValues.put("rspsize", localbjmc.g);
          localContentValues.put("touin", localbjmc.h);
          localContentValues.put("deviceinfo", localbjmc.i);
          localContentValues.put("detail", localbjmc.j);
          localContentValues.put("appid", localbjmc.k);
          try
          {
            this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase = this.jdField_a_of_type_Bjma.getWritableDatabase();
          ...
          catch (Exception localException)
          {
            for (;;)
            {
              bjko.c(jdField_a_of_type_JavaLangString, "update>>>", localException);
            }
          }
        }
      }
      bjko.b("cgi_report_debug", "ReportDataModal backupOldItems succ_count = " + i);
    }
    finally {}
    return i;
  }
  
  public ArrayList<bjmc> a(String paramString)
  {
    try
    {
  ...
  public boolean a(String paramString)
  {
    ...
    try
    {
      bjko.b("cgi_report_debug", "ReportDataModal deleteOldItems start");
      try
      {
        this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase = this.jdField_a_of_type_Bjma.getWritableDatabase();
      ...
      catch (Exception paramString)
      {
        ...
        {
          label75:
          bjko.a(jdField_a_of_type_JavaLangString, "deleteOldItems>>>", paramString);
        }
      }
    }
    finally {}
    try
    {
      ...
      this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase.close();
      bjko.b("cgi_report_debug", "ReportDataModal deleteOldItems success");
      bool = true;
    }
    catch (Exception paramString)
    {
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10)
  {
    ...
    //   113: invokestatic 52	bjko:b	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   432: invokestatic 29	bizw:a	()Lbizw;
    //   435: invokevirtual 32	bizw:a	()Landroid/content/Context;
    //   438: invokestatic 329	bjkj:e	(Landroid/content/Context;)Ljava/lang/String;
    ...
    //   468: invokestatic 29	bizw:a	()Lbizw;
    //   471: invokevirtual 334	bizw:a	()J
    ...
    //   533: aload_0
    //   534: aload_0
    //   535: getfield 39	bjlz:jdField_a_of_type_Bjma	Lbjma;
    //   538: invokevirtual 249	bjma:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   541: putfield 61	bjlz:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   544: aload_0
    //   545: getfield 61	bjlz:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   548: ldc 162
    //   550: aconst_null
    //   551: aload_3
    ...
    //   555: pop2
    //   556: aload_0
    //   557: getfield 61	bjlz:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   560: invokevirtual 147	android/database/sqlite/SQLiteDatabase:close	()V
    //   563: ldc 44
    //   565: ldc_w 341
    //   568: invokestatic 52	bjko:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   571: iconst_1
    //   572: istore 12
    //   574: aload_0
    //   575: monitorexit
    ...
    //   586: ldc 44
    //   588: ldc_w 343
    //   591: invokestatic 345	bjko:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   594: iconst_0
    //   595: istore 12
    //   597: goto -23 -> 574
    //   600: astore_1
  ...
  public ArrayList<bjmc> b(String paramString)
  {
    try
    {
  ...
  public boolean b(String paramString)
  {
    ...
    try
    {
      bjko.b("cgi_report_debug", "ReportDataModal deleteNewItems start");
      try
      {
        this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase = this.jdField_a_of_type_Bjma.getWritableDatabase();
      ...
      catch (Exception paramString)
      {
        ...
        {
          label75:
          bjko.a(jdField_a_of_type_JavaLangString, "deleteNewItems>>>", paramString);
        }
      }
    }
    finally {}
    try
    {
      this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase.execSQL(paramString);
      this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase.close();
      bjko.b("cgi_report_debug", "ReportDataModal deleteNewItems success");
      bool = true;
    }
    catch (Exception paramString)
    {
