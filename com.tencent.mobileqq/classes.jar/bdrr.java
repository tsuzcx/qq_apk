...
public class bdrr
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new bdrw(this);
  ...
  public bdrr()
  {
    ...
    this.jdField_a_of_type_Int = afur.a(4.0F, ((Context)localObject).getResources());
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)View.inflate((Context)localObject, 2131561573, null));
    ...
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131367829));
    int i = 0;
  ...
  void b()
  {
    ...
    int i = afur.a(1.0F, ((Context)localObject2).getResources());
    this.d.setPadding(i, i, i, i);
    this.d.setBackgroundResource(2130845126);
    ...
    try
    {
      ...
      ((ScaleAnimation)localObject1).setAnimationListener(new bdrs(this));
  ...
  void e()
  {
    int j = this.jdField_a_of_type_AndroidWidgetImageView.getWidth() - afur.a(5.0F, BaseApplicationImpl.getContext().getResources());
    ...
    localObject2 = new bdru(this, localAnimatorSet);
