  ...
  extends bdnv
{
  ...
  private LinearLayout a(Context paramContext)
  {
    ...
    paramContext.setPadding(localResources.getDimensionPixelSize(2131298982), 0, localResources.getDimensionPixelSize(2131298983), 0);
  ...
  private void a(Context paramContext, Resources paramResources, LinearLayout paramLinearLayout, int paramInt, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    if (((localObject1 == null) || (!((String)localObject1).equals("1"))) || (paramLinearLayout.getChildCount() == this.jdField_a_of_type_JavaUtilArrayList.size()))
    {
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        if ((localObject2 instanceof StructMsgItemTitle))
        {
          ...
          ((bdnu)localObject2).a(paramContext, (View)localObject3, paramBundle);
          i = ((View)localObject3).getPaddingTop();
          j = ((View)localObject3).getPaddingBottom();
          if (paramBoolean)
          {
            if ((!(localObject2 instanceof bdpx)) && (!(localObject2 instanceof bdpz))) {
              break label431;
            }
        ...
        for (;;)
        {
          ...
          localObject3 = (bdsv)localObject2;
          ((bdsv)localObject3).a();
          if ((localObject3 != null) && ((((bdsv)localObject3).c() == null) || (((bdsv)localObject3).c().equals("")))) {
            ((bdsv)localObject3).c(String.valueOf(28));
          }
          localObject4 = ((bdsv)localObject3).f();
          if ((localObject4 != null) && (((String)localObject4).equals("1")))
          {
            ((bdsv)localObject3).c(String.valueOf(24));
            if ((!paramBoolean) || (!TextUtils.isEmpty(((bdsv)localObject3).d()))) {
              break label157;
            }
            ((bdsv)localObject3).b("#8e8e8e");
            break label157;
          }
          if (!paramBoolean) {
            break label157;
          }
          if (TextUtils.isEmpty(((bdsv)localObject3).c())) {
            ((bdsv)localObject3).c(String.valueOf(32));
          }
          if (!TextUtils.isEmpty(((bdsv)localObject3).d())) {
            break label157;
          }
          ((bdsv)localObject3).b("#000000");
          break label157;
          label431:
          if ((localObject2 instanceof bdox))
          {
          ...
          break label222;
          label467:
          if (((localObject2 instanceof bdsv)) && (paramBoolean)) {
    ...
    else
    {
      ...
      if (((Iterator)localObject2).hasNext())
      {
        ...
        localObject3 = ((bdnu)localObject1).jdField_a_of_type_JavaLangString;
        if ("title".equals(localObject3))
        {
          ...
          localObject3 = ((bdnu)localObject1).a(paramContext, null, paramBundle);
        ...
        for (;;)
        {
          ...
          else
          {
            if ("summary".equals(localObject3))
            {
              ...
              {
                localObject3 = (bdsv)localObject1;
                ((bdsv)localObject3).a();
                if ((localObject3 != null) && ((((bdsv)localObject3).c() == null) || (((bdsv)localObject3).c().equals("")))) {
                  ((bdsv)localObject3).c(String.valueOf(28));
                }
                localObject4 = ((bdsv)localObject1).f();
                if ((localObject4 == null) || (!((String)localObject4).equals("1"))) {
                  break label1100;
                }
                ((bdsv)localObject3).c(String.valueOf(24));
            ...
            else
            {
              ...
              {
                localObject4 = ((bdnu)localObject1).a(paramContext, null, paramBundle);
                localObject1 = ((View)localObject4).findViewById(2131368676);
              ...
              {
                localObject1 = ((bdnu)localObject1).a(paramContext, null, paramBundle);
                ((AnyScaleTypeImageView)localObject1).setImageResource(2130841722);
  ...
  private void a(Context paramContext, Resources paramResources, LinearLayout paramLinearLayout, int paramInt, View paramView, boolean paramBoolean)
  {
    ...
    if (((Iterator)localObject3).hasNext())
    {
      ...
      int j = i;
      if ((localObject4 instanceof bdnw))
      {
        localObject4 = (bdnw)localObject4;
        if (paramBoolean)
        {
          if (!(localObject4 instanceof bdsv)) {
            break label216;
          }
          if (TextUtils.isEmpty(((bdnw)localObject4).c())) {
            ((bdnw)localObject4).c(String.valueOf(32));
          }
          if (TextUtils.isEmpty(((bdnw)localObject4).d())) {
            ((bdnw)localObject4).b("#000000");
          }
        }
      }
      for (;;)
      {
        localObject4 = ((bdnw)localObject4).a(paramResources);
        j = i;
        if (localObject4 != null)
        {
          ((bdnx)localObject4).e = (i + 1);
          ((bdnx)localObject4).f = (((bdnx)localObject4).e + ((bdnx)localObject4).jdField_a_of_type_JavaLangString.length());
          j = i + ((bdnx)localObject4).jdField_a_of_type_JavaLangString.length();
          ((StringBuffer)localObject1).append(((bdnx)localObject4).jdField_a_of_type_JavaLangString);
          ((ArrayList)localObject2).add(localObject4);
        }
        i = j;
        break;
        label216:
        if (((localObject4 instanceof StructMsgItemTitle)) && (TextUtils.isEmpty(((bdnw)localObject4).c()))) {
          ((bdnw)localObject4).c(String.valueOf(36));
        }
      }
    }
    ...
    {
      localObject3 = (bdnx)((Iterator)localObject2).next();
      ((SpannableStringBuilder)localObject1).setSpan(new TextAppearanceSpan(null, ((bdnx)localObject3).b, (int)TypedValue.applyDimension(2, ((bdnx)localObject3).c, paramResources.getDisplayMetrics()), ColorStateList.valueOf(((bdnx)localObject3).jdField_a_of_type_Int), null), ((bdnx)localObject3).e, ((bdnx)localObject3).f, 33);
    }
  ...
  {
    if (onq.b(this.Y)) {
      paramLinearLayout.setOnClickListener(new bdrs(this));
    }
  }
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (paramBundle.getInt("accostType") == AbsStructMsg.SOURCE_ACCOUNT_TYPE_PA)
    {
      ...
      i = localResources.getDimensionPixelSize(2131298983);
      a(paramView);
      d(paramView);
      if (bool)
      {
