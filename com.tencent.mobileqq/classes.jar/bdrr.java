  ...
  extends bdom
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      localLinearLayout.setId(2131370714);
      localBubbleViewLayout = new BubbleViewLayout(paramContext);
      localBubbleViewLayout.setId(2131370713);
      ...
      ((RelativeLayout)localObject3).setId(2131370707);
      ...
      ((RelativeLayout)localObject3).setBackgroundResource(2130844761);
      ...
      localObject2 = (bdol)((Iterator)localObject4).next();
      localObject5 = ((bdol)localObject2).a;
      if (!"title".equals(localObject5)) {
        break label685;
      }
      localObject2 = (TextView)((bdol)localObject2).a(paramContext, null, paramBundle);
      ((TextView)localObject2).setSingleLine();
      localObject5 = new RelativeLayout.LayoutParams(-1, -2);
      i = localResources.getDimensionPixelSize(2131296838);
      j = localResources.getDimensionPixelSize(2131296401);
      if (!bool) {
        break label673;
      }
    ...
    for (;;)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject5).addRule(3, 2131370707);
      ...
      ((TextView)localObject2).setBackgroundColor(localResources.getColor(2131167302));
      ...
      break;
      label439:
      localBubbleViewLayout.setLayoutParams(new LinearLayout.LayoutParams(BaseChatItemLayout.e - agej.a(20.0F, localResources), -2));
      break label101;
      label467:
      ((RelativeLayout)localObject3).setBackgroundResource(2130844762);
      break label203;
      label477:
      if (bool)
      {
        ...
        ((RelativeLayout.LayoutParams)localObject4).addRule(0, 2131370707);
        paramView.setLayoutParams((ViewGroup.LayoutParams)localObject4);
        paramView.setId(2131374209);
        ...
        ((RelativeLayout)localObject3).setBackgroundResource(2130844754);
        paramView.setImageDrawable(localResources.getDrawable(2130844757));
      }
      for (;;)
      {
        label536:
        ...
        ((RelativeLayout.LayoutParams)localObject4).addRule(1, 2131370707);
        break label536;
        label652:
        ((RelativeLayout)localObject3).setBackgroundResource(2130844755);
        paramView.setImageDrawable(localResources.getDrawable(2130844756));
      }
      label673:
      ((RelativeLayout.LayoutParams)localObject5).setMargins(0, 0, 0, 0);
    }
    ...
    for (;;)
    {
      try
      {
        long l = Long.parseLong(((bdtj)localObject2).ai);
        localObject2 = Calendar.getInstance();
        ((Calendar)localObject2).setTimeInMillis(l * 1000L);
        localObject5 = new TextView(paramContext);
        ((TextView)localObject5).setId(2131378847);
        RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(agej.a(68.0F, localResources), agej.a(18.0F, localResources));
        localLayoutParams.addRule(14);
        if (!this.jdField_a_of_type_Boolean) {
          break label1317;
        }
        f = 51.0F;
        localLayoutParams.topMargin = agej.a(f, localResources);
      ...
      if (("head".equals(localObject5)) && ((localException instanceof bdqh)))
      {
        paramBundle.putInt("bundle_args_avatar_width", agej.a(52.0F, localResources));
        paramBundle.putInt("bundle_args_avatar_height", agej.a(52.0F, localResources));
        paramBundle.putInt("bundle_args_cover_width", agej.a(52.0F, localResources));
        paramBundle.putInt("bundle_args_cover_height", agej.a(52.0F, localResources));
        if (BaseApplicationImpl.sApplication.getRuntime().getAccount().equalsIgnoreCase(((bdqh)localException).ac))
        {
        ...
        localRelativeLayout.setId(2131363145);
        paramBundle = new RelativeLayout.LayoutParams(-2, -2);
        paramBundle.addRule(14);
        if (this.jdField_a_of_type_Boolean) {}
        for (paramBundle.topMargin = agej.a(9.0F, localResources);; paramBundle.topMargin = agej.a(7.0F, localResources))
        {
          paramBundle.addRule(3, 2131378847);
          localRelativeLayout.setLayoutParams(paramBundle);
          ((RelativeLayout)localObject3).addView(localRelativeLayout);
          localObject3 = new RelativeLayout.LayoutParams(agej.a(52.0F, localResources), agej.a(52.0F, localResources));
          paramBundle = (Bundle)localObject1;
          if (localObject1 == null) {
            paramBundle = new LinearLayout(paramContext);
          }
          paramBundle.setId(2131377312);
          ...
          localObject1 = new RelativeLayout.LayoutParams(agej.a(52.0F, localResources), agej.a(52.0F, localResources));
          ((RelativeLayout.LayoutParams)localObject1).addRule(1, 2131377312);
          ((RelativeLayout.LayoutParams)localObject1).leftMargin = agej.a(15.0F, localResources);
          paramBundle = paramView;
          if (paramView == null) {
            paramBundle = new LinearLayout(paramContext);
          }
          paramBundle.setId(2131367233);
