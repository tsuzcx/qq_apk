  ...
  implements loq
{
  ...
  public bdrr(Context paramContext, long paramLong, bdrm parambdrm)
  {
  ...
  private void a()
  {
    bdru.c("MultiOperatorBase", "initGAudioCtrl");
    try
    {
      if (this.jdField_a_of_type_ComTencentAvGaudioQQGAudioCtrl == null)
      {
        ...
        if (this.jdField_a_of_type_ComTencentAvGaudioQQGAudioCtrl != null)
        {
          ...
          this.jdField_a_of_type_ComTencentAvGaudioQQGAudioCtrl.init(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Long, 1, "8.2.8");
          ClientLogReport.instance().init(this.jdField_a_of_type_AndroidContentContext, AppSetting.a());
          GAClientLogReport.instance();
          return;
        }
        bdru.a("MultiOperatorBase", "initGAudioCtrl create instance fail.");
        return;
      }
    }
    catch (Exception localException)
    {
      bdru.a("MultiOperatorBase", "initGAudioCtrl  fail.", localException);
  ...
  private boolean a()
  {
    bdru.c("MultiOperatorBase", "loadLibrary");
    try
    {
    ...
    {
      bdru.a("MultiOperatorBase", "loadLibrary fail.", localThrowable);
    }
    return false;
  }
  ...
  private void b()
  {
    bdru.c("MultiOperatorBase", "unInitGAudioCtrl");
    try
    {
      if (this.jdField_a_of_type_ComTencentAvGaudioQQGAudioCtrl != null)
      {
    ...
    {
      bdru.a("MultiOperatorBase", "unInitGAudioCtrl  fail.", localException);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Bdrm != null) {
      this.jdField_a_of_type_Bdrm.a(paramLong1, paramLong2, paramArrayOfByte);
    }
  }
