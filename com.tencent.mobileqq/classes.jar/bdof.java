...
public class bdof
{
  public static bdpl a(bdpl parambdpl)
  {
    for (parambdpl = parambdpl.a(); (parambdpl != null) && (parambdpl.jdField_a_of_type_Int != 1); parambdpl = parambdpl.a()) {}
    return parambdpl;
  }
  ...
  public static AbsStructMsg a()
  {
    ...
    localStructMsgForGeneralShare.mMsgBrief = anvx.a(2131713979);
    ...
    bdoe.a(0).a(new StructMsgItemTitle(""));
  ...
  public static AbsStructMsg a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong, byte[] paramArrayOfByte, int paramInt2)
  {
    ...
    if ((paramArrayOfByte != null) && ((paramArrayOfByte instanceof AbsShareMsg)))
    {
      ...
      if ((l1 == 23L) && ((paramInt1 == 82) || (paramInt1 == 43))) {
        bdla.b(paramQQAppInterface, "P_CliOper", "Grp_AIO", paramQQAppInterface.getCurrentAccountUin(), "AIOchat", "appear_obj", 0, 0, String.valueOf(paramLong), String.valueOf(l1), String.valueOf(l2), "");
      }
      if (l1 == 52L)
      {
        paramQQAppInterface = new StringBuilder("rec flower msg,");
        paramQQAppInterface.append(bdqg.a(paramArrayOfByte));
  ...
  public static AbsStructMsg a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    //   56: aload_0
    //   57: iload_1
    //   58: invokestatic 234	bdpo:a	([BI)[B
    //   61: astore_3
    ...
    //   93: astore_3
    //   94: aload_3
    //   95: invokestatic 251	bdof:a	(Ljava/lang/String;)Z
    //   98: istore_2
    //   99: aload_3
    //   100: aload_0
    //   101: iload_2
    ...
    //   105: invokestatic 260	bdof:a	(Ljava/lang/String;)Ljava/lang/String;
    //   108: astore_3
    ...
    //   153: new 272	bdpm
    //   156: dup
    //   157: invokespecial 273	bdpm:<init>	()V
    //   160: astore 4
    //   162: aload 4
    //   164: aload_0
    //   165: invokevirtual 275	bdpm:a	(Ljava/lang/String;)V
    //   168: aload 4
    //   170: iload_2
    //   171: invokevirtual 278	bdpm:a	(Z)V
    ...
    //   192: aload 4
    //   194: invokevirtual 299	bdpm:a	()Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    //   197: astore_3
    //   198: aload_3
    //   199: astore_0
    //   200: aload_3
  ...
  public static String a(bdpl parambdpl)
  {
    if (parambdpl.jdField_a_of_type_Int == 3) {}
    Object localObject;
    for (parambdpl = parambdpl.jdField_a_of_type_JavaLangString;; parambdpl = ((StringBuilder)localObject).toString())
    {
      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          if (localbdpl.jdField_a_of_type_Int == 3) {
            ((StringBuilder)localObject).append(localbdpl.jdField_a_of_type_JavaLangString);
          }
        }
      }
    }
