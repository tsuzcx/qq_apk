...
{
  private ajmm jdField_a_of_type_Ajmm = new aymf(this);
  private ayml jdField_a_of_type_Ayml;
  private aymw jdField_a_of_type_Aymw;
  ...
  private void a(MessageRecord paramMessageRecord, TroopAioKeywordTipInfo paramTroopAioKeywordTipInfo)
  {
    ...
    this.jdField_d_of_type_Int = this.jdField_a_of_type_Acka.a(paramMessageRecord.uniseq);
    if (this.jdField_a_of_type_Ayml == null)
    {
      this.jdField_a_of_type_Ayml = new ayml(this);
      this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131494718, null));
      this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup.setOnClickListener(this);
      this.jdField_a_of_type_Ayml.jdField_a_of_type_ComTencentWidgetURLThemeImageView = ((URLThemeImageView)this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131311895));
      this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131311898));
      this.jdField_a_of_type_Ayml.b = ((TextView)this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131311897));
      this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131311894));
      this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849322);
    }
    this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130843178);
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_Ayml.jdField_a_of_type_ComTencentWidgetURLThemeImageView.setImageDrawable((Drawable)localObject1);
        if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.title))
        {
          this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
          if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.summary)) {
            break label688;
          }
          this.jdField_a_of_type_Ayml.b.setVisibility(8);
          if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup) < 0)
          {
            localObject1 = new RelativeLayout.LayoutParams(-2, -2);
            ((RelativeLayout.LayoutParams)localObject1).topMargin = azvv.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
            ((RelativeLayout.LayoutParams)localObject1).addRule(11);
            this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup, (ViewGroup.LayoutParams)localObject1);
          }
          localObject1 = (RelativeLayout.LayoutParams)this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup.getLayoutParams();
          ...
          this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup.setVisibility(0);
          localObject1 = new TranslateAnimation(2, 1.0F, 2, 0.0F, 2, 0.0F, 2, 0.0F);
          ((Animation)localObject1).setDuration(500L);
          this.jdField_b_of_type_Boolean = true;
          ((Animation)localObject1).setAnimationListener(new aymg(this));
          if (this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup.getAnimation() == null) {
            this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup.startAnimation((Animation)localObject1);
          }
          localObject2 = new awrb(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("notice_center_new");
          if (!paramMessageRecord.isSend()) {
            break label719;
          }
          localObject1 = "exp_keyword_input";
          ((awrb)localObject2).d((String)localObject1).a(new String[] { paramMessageRecord.frienduin, String.valueOf(paramTroopAioKeywordTipInfo.ruleId), paramMessageRecord.getExtInfoFromExtStr("key_aio_keyword") }).a();
          return;
        }
      }
      ...
      this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.title);
      continue;
      label688:
      this.jdField_a_of_type_Ayml.b.setVisibility(0);
      this.jdField_a_of_type_Ayml.b.setText(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.summary);
      continue;
      label719:
  ...
  private boolean a(MessageRecord paramMessageRecord)
  {
    ...
    return a(this.jdField_a_of_type_Acka.b(paramMessageRecord.uniseq));
  }
  
  private void b(boolean paramBoolean)
  {
    if ((!this.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_Ayml == null) || (!this.jdField_b_of_type_Boolean) || (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup) < 0)) {}
    ...
    do
    {
      ...
      localTranslateAnimation.setAnimationListener(new aymh(this, paramBoolean));
    } while (this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup.getAnimation() != null);
    this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup.startAnimation(localTranslateAnimation);
  }
  ...
  private boolean b()
  {
    ...
    do
    {
      ...
      return false;
      if ((this.jdField_a_of_type_Aymw == null) || (!this.jdField_a_of_type_Aymw.g())) {
        break label129;
      }
    } while (!QLog.isColorLevel());
  ...
  {
    if (this.jdField_a_of_type_Ayml != null) {
      return this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup;
    }
    return null;
  }
  ...
  protected void d()
  {
    ...
    if ((this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_a_of_type_Ayml != null) && (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup) >= 0))
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.removeView(this.jdField_a_of_type_Ayml.jdField_a_of_type_AndroidViewViewGroup);
      this.jdField_a_of_type_Ayml = null;
    }
  ...
  public void e()
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Acka.a().size();
      if (i != this.e) {
        break;
      }
    } while (!QLog.isColorLevel());
  ...
  public void f()
  {
    ...
    this.jdField_d_of_type_Int = this.jdField_a_of_type_Acka.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.uniseq);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramView = paramView.replace("$TEXT$", baaw.encodeToString(((MessageForText)this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).sb.toString().getBytes(), 0));
        localObject = paramView;
        if (this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.url.contains("$KEYWORD$")) {
          localObject = paramView.replace("$KEYWORD$", baaw.encodeToString(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.getExtInfoFromExtStr("key_aio_keyword").getBytes(), 0));
        }
      ...
      localObject = new awrb(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("notice_center_new");
      if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.isSend())
      {
        paramView = "clk_keyword_input";
        ((awrb)localObject).d(paramView).a(new String[] { this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin, String.valueOf(this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopAioKeywordTipInfo.ruleId), this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.getExtInfoFromExtStr("key_aio_keyword") }).a();
        b(true);
        return;
        if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForStructing))
        {
          ...
          {
            paramView = paramView.replace("$TEXT$", baaw.encodeToString(((AbsShareMsg)((MessageForStructing)localObject).structingMsg).mContentTitle.getBytes(), 0));
            continue;
            if (((String)localObject).startsWith("mqqapi"))
            {
              paramView = bade.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, (String)localObject);
              if (paramView != null)
              {
                paramView.c();
                continue;
