...
{
  public rtc(BaseChatPie paramBaseChatPie) {}
      ...
      for (int j = Integer.parseInt(paramObject);; j = 0)
      {
        ...
        for (float f = Float.parseFloat(paramObject);; f = 0.0F)
        {
          ...
          for (int k = Integer.parseInt(paramObject);; k = 0)
          {
            ...
            {
            default: 
              paramObject = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438221);
              localObject1 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438221);
              if (QLog.isColorLevel()) {
                QLog.d("Q.aio.BaseChatPie", 2, "unknown action auth errcode");
              }
              paramObject = DialogUtil.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 0, paramObject, (String)localObject1, this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131436731), (String)localObject2, (DialogInterface.OnClickListener)localObject3, new rtg(this));
            ...
            case 31004: 
              label575:
              paramObject = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438207);
              localObject4 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438208);
            ...
            for (;;)
            {
              localObject2 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438210);
              localObject3 = new rtd(this, m);
              ...
              break label575;
              localObject2 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438213);
              paramObject = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438208);
              localObject1 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438210);
              if (bool)
              {
                localObject2 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438214);
                paramObject = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438209);
                localObject1 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438211);
              }
              if (localApolloActionData != null) {
              ...
              for (;;)
              {
                localObject3 = new rte(this, m, bool);
                ...
                if (TextUtils.isEmpty(paramObject)) {
                  paramObject = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438217);
                }
                for (;;)
                {
                  localObject1 = (String)((Map)localObject1).get("url");
                  localObject1 = (String)localObject1 + "&actionid=" + m;
                  localObject4 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438218);
                  localObject2 = this.a.jdField_a_of_type_AndroidWidgetRelativeLayout.getResources().getString(2131438218);
                  localObject3 = new rtf(this, (String)localObject1, m);
                  ...
                  paramObject = localObject4;
                  break label575;
                  QQToast.a(this.a.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131438198), 0).b(this.a.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131558448));
                  if (!QLog.isColorLevel()) {
                    break;
                  }
