...
public class bjjs
{
  private static final atxa<bjjs, Void> jdField_a_of_type_Atxa = new bjjt();
  private static bjhz jdField_a_of_type_Bjhz;
  private FileFilter jdField_a_of_type_JavaIoFileFilter = new bjjv(this);
  private String jdField_a_of_type_JavaLangString;
  private ConcurrentHashMap<Integer, bjjn> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  private FileFilter jdField_b_of_type_JavaIoFileFilter = new bjjw(this);
  private String jdField_b_of_type_JavaLangString;
  private ConcurrentHashMap<Integer, ArrayList<bjka>> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap;
  private String c;
  ...
  public static bjjs a()
  {
    return (bjjs)jdField_a_of_type_Atxa.b(null);
  }
  ...
  private String a()
  {
    ...
    this.jdField_a_of_type_JavaLangString = bjhx.a();
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap)
      {
        ...
        do
        {
          ...
          localObject2 = (bjka)((Iterator)???).next();
          localbjjp = (bjjp)((bjka)localObject2).jdField_a_of_type_JavaLangRefWeakReference.get();
        } while (localbjjp == null);
        localbjjp.a(paramInt, b(paramInt, ((bjka)localObject2).b), ((bjka)localObject2).jdField_a_of_type_JavaLangString);
      }
    }
  }
  
  private void a(int paramInt1, String paramString1, int paramInt2, String paramString2, bjjp parambjjp)
  {
    if (parambjjp == null) {
      return;
    }
    ThreadManager.post(new FontManager.3(this, paramInt1, paramInt2, parambjjp, paramString2, paramString1), 8, null, false);
  }
  
  private void a(int paramInt1, String paramString1, int paramInt2, String paramString2, boolean paramBoolean, bjjp parambjjp)
  {
    if (parambjjp == null) {
      return;
    }
    ...
    {
      parambjjp.a(paramInt1, null, paramString2);
      return;
    }
    if (!paramBoolean)
    {
    ...
    a(paramInt1, paramString1, paramInt2, paramString2, parambjjp);
  }
  ...
  private boolean a(int paramInt)
  {
    ...
    //   0: aload_0
    //   1: iload_1
    //   2: invokespecial 133	bjjs:a	(I)Ljava/lang/String;
    //   5: astore 5
    //   7: aload_0
    //   8: iload_1
    //   9: invokespecial 269	bjjs:b	(I)Ljava/lang/String;
    //   12: astore 6
    ...
    //   32: invokestatic 274	bjtz:b	(Ljava/io/File;Ljava/io/File;)Z
    //   35: istore 4
    //   37: iload 4
    //   39: ifeq +440 -> 479
    ...
    //   96: iload_1
    //   97: iconst_1
    //   98: invokespecial 136	bjjs:a	(II)Ljava/lang/String;
    ...
    //   126: iload 4
    //   128: ifeq +18 -> 146
    //   131: invokestatic 78	bjjs:b	()Lbjhz;
    //   134: aload 8
    //   136: invokevirtual 286	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   139: iconst_1
    //   140: invokevirtual 298	bjhz:a	(Ljava/lang/String;Z)V
    //   143: iload 4
    //   145: istore_3
    //   146: iload_3
    //   147: ifeq +209 -> 356
    //   150: new 300	bjjn
    //   153: dup
    //   154: invokespecial 301	bjjn:<init>	()V
    //   157: astore 7
    //   159: aload 7
    //   161: iload_1
    //   162: putfield 303	bjjn:jdField_a_of_type_Int	I
    //   165: aload_0
    //   166: getfield 31	bjjs:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   169: aload 7
    //   171: getfield 303	bjjn:jdField_a_of_type_Int	I
    ...
    //   192: invokestatic 309	bjtz:a	(Ljava/io/File;)Z
    //   195: pop
    //   196: new 55	java/io/File
    //   199: dup
    //   200: aload 6
    //   202: invokespecial 112	java/io/File:<init>	(Ljava/lang/String;)V
    //   205: invokestatic 309	bjtz:a	(Ljava/io/File;)Z
    //   208: pop
    //   209: iload_3
    //   210: ireturn
    //   211: astore 7
    ...
    //   252: invokestatic 309	bjtz:a	(Ljava/io/File;)Z
    //   255: pop
    //   256: new 55	java/io/File
    //   259: dup
    //   260: aload 6
    //   262: invokespecial 112	java/io/File:<init>	(Ljava/lang/String;)V
    //   265: invokestatic 309	bjtz:a	(Ljava/io/File;)Z
    //   268: pop
    //   269: iconst_0
    //   270: ireturn
    //   271: astore 5
    ...
    //   290: iload_1
    //   291: iconst_0
    //   292: invokespecial 136	bjjs:a	(II)Ljava/lang/String;
    ...
    //   320: iload 4
    //   322: ifeq -176 -> 146
    //   325: invokestatic 78	bjjs:b	()Lbjhz;
    //   328: aload 8
    //   330: invokevirtual 286	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   333: iconst_1
    //   334: invokevirtual 298	bjhz:a	(Ljava/lang/String;Z)V
    //   337: aload_0
    //   338: aload 8
    ...
    //   344: iload_1
    //   345: iconst_1
    //   346: invokespecial 136	bjjs:a	(II)Ljava/lang/String;
    //   349: invokespecial 321	bjjs:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   352: istore_3
    //   353: goto -207 -> 146
    //   356: ldc 141
    //   358: iconst_1
    ...
    //   411: invokestatic 309	bjtz:a	(Ljava/io/File;)Z
    //   414: pop
    //   415: new 55	java/io/File
    //   418: dup
    //   419: aload 6
    //   421: invokespecial 112	java/io/File:<init>	(Ljava/lang/String;)V
    //   424: invokestatic 309	bjtz:a	(Ljava/io/File;)Z
    //   427: pop
    //   428: iconst_0
    //   429: istore_3
    //   430: goto -221 -> 209
    ...
    //   459: invokestatic 309	bjtz:a	(Ljava/io/File;)Z
    //   462: pop
    //   463: new 55	java/io/File
    //   466: dup
    //   467: aload 6
    //   469: invokespecial 112	java/io/File:<init>	(Ljava/lang/String;)V
    //   472: invokestatic 309	bjtz:a	(Ljava/io/File;)Z
    //   475: pop
    //   476: aload 7
    //   478: athrow
    //   479: ldc 141
  ...
  private boolean a(int paramInt1, String paramString1, int paramInt2, String arg4, bjjp parambjjp)
  {
    ...
    bjka localbjka = new bjka(this, null);
    localbjka.jdField_a_of_type_Int = paramInt1;
    localbjka.b = paramInt2;
    localbjka.jdField_a_of_type_JavaLangString = ???;
    localbjka.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambjjp);
    synchronized (this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap)
    {
      parambjjp = (ArrayList)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt1));
      if (parambjjp == null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("FontManager", 4, "add new download task. fontId =" + paramInt1);
        }
        parambjjp = new ArrayList();
        parambjjp.add(localbjka);
        this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt1), parambjjp);
  ...
  private static bjhz b()
  {
    if (jdField_a_of_type_Bjhz == null) {
      jdField_a_of_type_Bjhz = bjhx.d();
    }
    return jdField_a_of_type_Bjhz;
  }
  ...
  {
    bjjn localbjjn = new bjjn(paramInt);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt), localbjjn);
  }
  ...
  public bjjx a(long paramLong)
  {
    ...
    localObject1 = new bjjx();
    try
    {
      ((bjjx)localObject1).jdField_a_of_type_Int = Integer.valueOf(arrayOfString[0]).intValue();
      ((bjjx)localObject1).jdField_a_of_type_JavaLangString = arrayOfString[1];
      return localObject1;
    }
  ...
  public bjjz a(long paramLong)
  {
    ...
    localObject1 = new bjjz();
    try
    {
      ((bjjz)localObject1).jdField_a_of_type_Int = Integer.valueOf(arrayOfString[0]).intValue();
      ((bjjz)localObject1).jdField_a_of_type_JavaLangString = arrayOfString[1];
      return localObject1;
    }
    catch (Throwable localThrowable)
    {
  ...
  public String a(int paramInt, String paramString1, String paramString2, bjjq parambjjq)
  {
    ...
    {
      a(paramInt, paramString1, 0, paramString2, false, parambjjq);
      return null;
    }
    b().a(str, true);
    return str;
  ...
  public String a(int paramInt, String paramString1, String paramString2, boolean paramBoolean, bjjr parambjjr)
  {
    if (QLog.isColorLevel()) {
    ...
    if (!new File(str).exists())
    {
      a(paramInt, paramString1, 1, paramString2, paramBoolean, parambjjr);
      return null;
    }
    b().a(str, true);
    return str;
  ...
  public void a(long paramLong, bjjx parambjjx)
  {
    String str = "";
    ...
    {
      localObject = str;
      if (parambjjx.jdField_a_of_type_Int > 0)
      {
        localObject = str;
        if (!TextUtils.isEmpty(parambjjx.jdField_a_of_type_JavaLangString))
        {
          localObject = new StringBuilder();
          ((StringBuilder)localObject).append(parambjjx.jdField_a_of_type_Int).append(";");
          ((StringBuilder)localObject).append(parambjjx.jdField_a_of_type_JavaLangString).append(";");
  ...
  public void a(long paramLong, bjjy parambjjy)
  {
    String str2 = "";
    String str1 = str2;
    if (parambjjy != null)
    {
      str1 = str2;
      if (parambjjy.jdField_a_of_type_Int > 0)
      {
        str1 = str2;
        if (!TextUtils.isEmpty(parambjjy.jdField_a_of_type_JavaLangString))
        {
          str1 = parambjjy.toString();
          a(paramLong, null);
        }
      }
    }
  ...
  public void a(long paramLong, bjjz parambjjz)
  {
    String str = "";
    Object localObject = str;
    if (parambjjz != null)
    {
      localObject = str;
      if (parambjjz.jdField_a_of_type_Int > 0)
      {
        localObject = str;
        if (!TextUtils.isEmpty(parambjjz.jdField_a_of_type_JavaLangString))
        {
          localObject = new StringBuilder();
          ((StringBuilder)localObject).append(parambjjz.jdField_a_of_type_Int).append(";");
          ((StringBuilder)localObject).append(parambjjz.jdField_a_of_type_JavaLangString).append(";");
          localObject = ((StringBuilder)localObject).toString();
          a(paramLong, null);
        }
      }
  ...
  {
    paramapkv = new bjju(this);
    QIPCClientHelper.getInstance().callServer("VasFontIPCModule", gh.jdField_a_of_type_JavaLangString, null, paramapkv);
  }
