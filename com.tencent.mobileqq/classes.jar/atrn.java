...
public class atrn
  extends bdin
{
  private atrn(atri paramatri) {}
  
  private void a(TeamWorkFileImportInfo paramTeamWorkFileImportInfo, String paramString, boolean paramBoolean)
  {
    if (((paramTeamWorkFileImportInfo.jdField_a_of_type_Int == 1) || (paramTeamWorkFileImportInfo.jdField_a_of_type_Int == 0) || (paramTeamWorkFileImportInfo.jdField_a_of_type_Int == 3000)) && (paramTeamWorkFileImportInfo.jdField_a_of_type_JavaLangString != this.a.jdField_a_of_type_Atoo.m())) {}
    for (int i = 1;; i = 0)
    {
      if (i != 0)
      {
  ...
  private void a(JSONObject paramJSONObject, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, String paramString)
  {
    try
    {
      if (paramJSONObject.getInt("retcode") != 0)
      {
        ...
        if (paramTeamWorkFileImportInfo.b()) {
          bdiq.a(paramTeamWorkFileImportInfo.m, this.a.jdField_a_of_type_Atoo.m());
        }
        bcst.b(null, "dc00898", "", "", "0X800A627", "0X800A627", 2, 0, "", "", "", "");
        return;
      }
    ...
    {
      bcst.b(null, "dc00898", "", "", "0X800A627", "0X800A627", 3, 0, "", "", "", "");
  ...
  private void b(JSONObject paramJSONObject, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, String paramString)
  {
    ...
    if (paramTeamWorkFileImportInfo.a())
    {
      ...
      bgsc.a(this.a.jdField_a_of_type_AndroidAppActivity, 1001, 95, "web_share", "", localTencentDocData.docIcon, localTencentDocData.title, localTencentDocData.summary, this.a.jdField_a_of_type_AndroidAppActivity.getString(2131695697, new Object[] { localTencentDocData.title }), paramString, "web", null, null, null, "web", null, null, null, bdjg.d, this.a.jdField_a_of_type_AndroidAppActivity.getString(2131718512), "", paramJSONObject, -1, "https://docs.qq.com/desktop/m/index.html?_wv=2097154", -1L);
      bdkv.a(null, "0X800A21F");
    }
    ...
    if (!atri.c(this.a))
    {
      long l = bdkv.a(paramTeamWorkFileImportInfo.k + "-" + paramTeamWorkFileImportInfo.d);
      if (l > 0L) {
        bcst.b(null, "dc00898", "", "", "0X800A62E", "0X800A62E", 0, 0, "", "", String.valueOf(l), "");
      }
      boolean bool = arbb.a().a(paramTeamWorkFileImportInfo.b);
      ...
      bdjg.a(paramJSONObject, this.a.jdField_a_of_type_AndroidAppActivity, localTencentDocData, paramTeamWorkFileImportInfo);
      return;
    }
    bdiq.a(paramTeamWorkFileImportInfo.m, this.a.jdField_a_of_type_Atoo.m());
  }
  ...
  private void c(String paramString, TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    if ((paramTeamWorkFileImportInfo != null) && (paramTeamWorkFileImportInfo.c()))
    {
      ...
      bdkv.a(null, "0X800ABA7");
    }
    for (;;)
    {
      if (i == 0) {
        this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.a(1, paramString, Boolean.valueOf(false));
      }
      if ((atri.d(this.a)) && (i != 0)) {
        atri.e(this.a, true);
      }
      if (i == 0) {
  ...
  public void a(TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    if ((paramTeamWorkFileImportInfo != null) && ((paramTeamWorkFileImportInfo.a()) || ((paramTeamWorkFileImportInfo.b()) && (paramTeamWorkFileImportInfo.g == 0))))
    {
      ...
      if (paramTeamWorkFileImportInfo.b()) {
        bcst.b(null, "dc00898", "", "", "0X800A627", "0X800A627", 1, 0, "", "", "", "");
      }
    ...
    for (;;)
    {
      ...
      return;
      label174:
      QQToast.a(localQQAppInterface.getApp(), 1, 2131718559, 0).a();
    }
  }
  ...
  public void a(String paramString1, String paramString2, TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    {
      localQQAppInterface = (QQAppInterface)BaseApplicationImpl.sApplication.getRuntime();
      arax localarax = arbb.a();
      ThreadManager.getFileThreadHandler().post(new SimpleFilePresenter.InnerTeamWorkFileImportObserver.3(this, localarax, paramTeamWorkFileImportInfo, paramString2, localQQAppInterface, paramString1));
    }
    ...
    {
      paramTeamWorkFileImportInfo.l = 0;
      ThreadManager.getFileThreadHandler().post(new SimpleFilePresenter.InnerTeamWorkFileImportObserver.4(this, bool, paramString2, localQQAppInterface, paramString1));
      return;
    }
  }
  ...
  public void b(TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    {
      String str = this.a.jdField_a_of_type_AndroidAppActivity.getString(2131697670);
      if (paramTeamWorkFileImportInfo.b()) {
        str = anni.a(2131697401);
      }
      this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerFileviewerViewerSimpleFileViewer.i(str);
      bdkv.a(null, "0X800A21E");
    }
    if ((paramTeamWorkFileImportInfo != null) && ((paramTeamWorkFileImportInfo.c()) || (paramTeamWorkFileImportInfo.b())) && (paramTeamWorkFileImportInfo.g == 1))
    {
  ...
  public void c(TeamWorkFileImportInfo paramTeamWorkFileImportInfo)
  {
    ...
    if ((paramTeamWorkFileImportInfo != null) && (paramTeamWorkFileImportInfo.b()))
    {
      ...
      atri.a(this.a, true, paramTeamWorkFileImportInfo.jdField_a_of_type_Int);
    }
