...
public class arps
{
  private static arps jdField_a_of_type_Arps;
  public static String a;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private HandlerThread jdField_a_of_type_AndroidOsHandlerThread;
  private ITMAssistantDownloadClientListener jdField_a_of_type_ComTencentTmdownloaderITMAssistantDownloadClientListener = new arpt(this);
  private TMAssistantDownloadClient jdField_a_of_type_ComTencentTmdownloaderTMAssistantDownloadClient;
  private Map<String, arpu> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  private int a(String paramString, arpu paramarpu)
  {
    if ((paramarpu == null) || (paramString == null)) {
      return -1;
    }
    ...
    this.jdField_a_of_type_JavaUtilMap.put(paramString, paramarpu);
    QLog.i(jdField_a_of_type_JavaLangString, 1, "[UniformDL][" + paramarpu.jdField_a_of_type_Long + "] addDownloadCtx...total:[" + this.jdField_a_of_type_JavaUtilMap.size() + "] add it. url:[ " + paramString + "]");
    return 0;
  }
  ...
  public static arps a()
  {
    try
    {
      if (jdField_a_of_type_Arps == null) {
        jdField_a_of_type_Arps = new arps();
      }
      arps localarps = jdField_a_of_type_Arps;
      return localarps;
    }
    finally {}
  }
  
  private arpu a(String paramString)
  {
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      paramString = (arpu)this.jdField_a_of_type_JavaUtilMap.get(paramString);
      return paramString;
    }
  }
  ...
  private void a(arpu paramarpu, int paramInt, String paramString)
  {
    ...
    {
      paramInt = 2;
      paramString = arpl.a(paramInt);
      if (paramarpu != null)
      {
        a(paramarpu.b(), paramarpu.jdField_b_of_type_Int);
        paramarpu.b(0L);
        if (paramarpu.jdField_a_of_type_Arpr != null)
        {
          Bundle localBundle = new arpv(paramarpu.a(), paramarpu.a()).a();
          paramarpu.jdField_a_of_type_Arpr.a(paramInt, paramString, localBundle);
        }
      }
      return;
    }
    ...
    for (long l = bdag.a() * 1024L;; l = bdag.b() * 1024L)
    {
      ...
      paramInt = i;
      if (l >= paramarpu.jdField_b_of_type_Long - paramarpu.a()) {
        break;
      }
      QLog.e(jdField_a_of_type_JavaLangString, 1, "[UniformDL][" + paramarpu.jdField_a_of_type_Long + "] write file failed.  space is no enough:[" + paramarpu.jdField_b_of_type_Long + " " + paramarpu.a() + " " + l + "]");
      paramInt = 9;
      break;
      if (702 == paramInt)
      {
  ...
  private void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentTmdownloaderTMAssistantDownloadClient == null)
      {
        ...
        if (((arpu)localObject2).jdField_a_of_type_Arpr != null)
        {
          paramString = new arpv(0L, ((arpu)localObject2).a()).a();
          ((arpu)localObject2).jdField_a_of_type_Arpr.a(41, arpl.a(41), paramString);
        }
      }
      else
      {
        ...
        if (localObject1 != null) {
          ((arpu)localObject2).jdField_b_of_type_Int = ((NetworkInfo)localObject1).getType();
        }
        int i;
        int j;
        try
        ...
        if (localObject2 != null)
        {
          a(((arpu)localObject2).b(), ((arpu)localObject2).jdField_b_of_type_Int);
          ((arpu)localObject2).b(0L);
          if (((arpu)localObject2).jdField_a_of_type_Arpr != null)
          {
            paramString = new arpv(0L, ((arpu)localObject2).a()).a();
            ((arpu)localObject2).jdField_a_of_type_Arpr.a(20, arpl.a(20), paramString);
            return;
            label420:
            Bundle localBundle;
            if (4 == j)
            {
              ...
              for (;;)
              {
                ...
                try
                {
                  ...
                  ((arpu)localObject2).a(((arpu)localObject2).jdField_b_of_type_Long);
                  if (((arpu)localObject2).jdField_a_of_type_Arpr == null) {
                    break;
                  }
                  localBundle = new arpv(0L, ((arpu)localObject2).a()).a();
                  localObject2 = ((arpu)localObject2).jdField_a_of_type_Arpr;
                  if (localTMAssistantDownloadTaskInfo2 != null) {
                    break label614;
                  }
                  paramString = null;
                  ((arpr)localObject2).a(paramString, localBundle);
                  return;
                }
                catch (Exception paramString)
                {
            ...
            while ((localObject2 != null) && (((arpu)localObject2).jdField_a_of_type_Arpr != null))
            {
              localBundle = new arpv(0L, ((arpu)localObject2).a()).a();
              ((arpu)localObject2).jdField_a_of_type_Arpr.a(i, paramString, localBundle);
              return;
              if (1 == j)
              {
                i = 17;
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          } while ((localarpu == null) || (localarpu.jdField_a_of_type_Arpr == null));
          localarpu.jdField_a_of_type_Arpr.c(null);
          return;
        ...
        localarpu.jdField_a_of_type_Arpr.a(null);
        return;
        ...
        localarpu.a(2);
        a(localarpu.b(), localarpu.jdField_b_of_type_Int);
        localarpu.b(0L);
        a(localarpu, paramInt2, paramString2);
        return;
      ...
      paramString1 = new arpv(localarpu.a(), localarpu.a()).a();
      localarpu.jdField_a_of_type_Arpr.a(paramString3, paramString1);
      return;
    ...
    localarpu.jdField_a_of_type_Arpr.b(null);
  }
  ...
  private void a(String paramString1, int paramInt, String paramString2)
  {
    ...
    do
    {
      ...
      a(localarpu.b(), localarpu.jdField_b_of_type_Int);
      localarpu.b(0L);
    } while (localarpu.jdField_a_of_type_Arpr == null);
    paramString1 = new arpv(localarpu.a(), localarpu.a()).a();
    localarpu.jdField_a_of_type_Arpr.a(paramInt, paramString2, paramString1);
  }
  
  private void a(String paramString, long paramLong1, long paramLong2)
  {
    int i = (int)((float)paramLong1 / (float)paramLong2 * 100.0F);
    arpu localarpu = a(paramString);
    if (localarpu != null)
    {
      localarpu.b(paramLong1 - localarpu.a() + localarpu.b());
      localarpu.a(paramLong1);
      if (localarpu.jdField_a_of_type_Arpr != null) {
        localarpu.jdField_a_of_type_Arpr.a(i, null);
      }
      return;
    }
  ...
  private void b(String paramString)
  {
    ...
    if (this.jdField_a_of_type_ComTencentTmdownloaderTMAssistantDownloadClient == null)
    {
      ...
      if ((localarpu != null) && (localarpu.jdField_a_of_type_Arpr != null))
      {
        paramString = new arpv(0L, localarpu.a()).a();
        localarpu.jdField_a_of_type_Arpr.a(41, arpl.a(41), paramString);
      }
    }
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if (localTMAssistantDownloadTaskInfo != null)
          {
            ...
            paramString = new arpv(localarpu.a(), localarpu.a()).a();
            localarpu.jdField_a_of_type_Arpr.a(21, arpl.a(21), paramString);
          }
        }
        catch (Exception localException)
        {
          for (;;)
          {
            ...
            if (localarpu != null)
            {
              ...
              if (localarpu.jdField_a_of_type_Arpr != null)
              {
                localBundle = new arpv(localarpu.a(), localarpu.a()).a();
                localarpu.jdField_a_of_type_Arpr.a(20, arpl.a(20), localBundle);
              }
            }
  ...
  private int d(String paramString)
  {
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      arpu localarpu = (arpu)this.jdField_a_of_type_JavaUtilMap.remove(paramString);
      int i = this.jdField_a_of_type_JavaUtilMap.size();
      QLog.i(jdField_a_of_type_JavaLangString, 1, "[UniformDL][" + localarpu.jdField_a_of_type_Long + "] delDownloadCtx...total:[" + i + "] add it. url:[ " + paramString + "]");
      return i;
    }
  }
  ...
  private void f()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      ...
      if (((Iterator)localObject3).hasNext()) {
        localArrayList.add((arpu)((Iterator)localObject3).next());
      }
    }
    ...
    {
      arpu localarpu = (arpu)((Iterator)???).next();
      if (localarpu != null)
      {
        a(localarpu.b(), localarpu.jdField_b_of_type_Int);
        localarpu.b(0L);
        if (localarpu.jdField_a_of_type_Arpr != null)
        {
          localObject3 = new arpv(localarpu.a(), localarpu.a()).a();
          localarpu.jdField_a_of_type_Arpr.a(10, arpl.a(10), (Bundle)localObject3);
        }
      }
    }
  }
  
  public int a(long paramLong1, String paramString, long paramLong2, arpr paramarpr)
  {
    if (paramString == null)
    {
    ...
    arpu localarpu = new arpu(this, paramLong1, paramString, paramLong2);
    localarpu.jdField_a_of_type_Arpr = paramarpr;
    int i = a(paramString, localarpu);
    if (i != 0)
    {
