  ...
  extends aaub
{
  ...
  public aato(aauc paramaauc, String paramString1, List<String> paramList, String paramString2, String paramString3)
  {
    super(paramaauc, paramString1, paramList);
    this.jdField_a_of_type_JavaLangString = paramString3;
    Object localObject;
    this.b = localObject;
    this.jdField_a_of_type_JavaUtilList = paramString2;
    this.jdField_a_of_type_Aaub = new aatz(paramaauc, paramString1, paramList);
  }
  
  public File a(File paramFile, String paramString, aatl paramaatl)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Aatd.jdField_a_of_type_Zqi.a((String)localObject, paramFile.getAbsolutePath(), str3, i, j, new aatv(this, paramaatl, str3));
    }
  ...
  public void a()
  {
    ...
    a(this.jdField_a_of_type_JavaUtilList, str, new aatp(this, localaatn));
  }
  
  public void a(List<String> paramList, String paramString, aatl paramaatl)
  {
    if ((paramList == null) || (this.jdField_a_of_type_JavaUtilList.size() == 0))
    {
      paramaatl.a(null, false, "videoFiles empty!");
      return;
    }
    if (paramList.size() == 1)
    {
      paramaatl.a((String)this.jdField_a_of_type_JavaUtilList.get(0), true, "combineVideos Success size = 1");
      return;
    }
    try
    {
      ...
      a(this.jdField_a_of_type_JavaUtilList, paramList.getAbsolutePath(), new aatt(this, l, paramaatl, paramList));
      return;
    }
  ...
  public void a(List<String> paramList, String paramString, aaty paramaaty)
  {
    ...
    this.jdField_a_of_type_Aatd.jdField_a_of_type_Long = System.currentTimeMillis();
    ...
    if (i < paramList.size())
    {
      ...
      for (;;)
      {
        ...
        ((zqo)localObject4).jdField_a_of_type_Int = 5;
        ((zqo)localObject4).jdField_a_of_type_JavaUtilArrayList = new VideoCombineHelper.CombineTask.3(this, (String)localObject2, (String)localObject3);
        ((zqo)localObject4).jdField_a_of_type_Zqq = new aatu(this, paramaaty);
    ...
    paramString.jdField_a_of_type_Zqq = paramaaty;
    ((ArrayList)localObject1).add(paramString);
    if (this.jdField_a_of_type_Aatd.jdField_a_of_type_Zqi.a()) {
      try
      {
        this.jdField_a_of_type_Aatd.jdField_a_of_type_Zqi.b((ArrayList)localObject1);
        return;
      }
    ...
    try
    {
      this.jdField_a_of_type_Aatd.jdField_a_of_type_Zqi.a((ArrayList)localObject1);
      return;
    }
    catch (FFmpegCommandAlreadyRunningException paramList)
    {
  ...
  public boolean a(int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      zoc.a(localBitmap, Bitmap.CompressFormat.PNG, 100, paramString2);
      zoc.a(localBitmap);
      bool = true;
    }
