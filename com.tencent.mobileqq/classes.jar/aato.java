  ...
  implements bkzq
{
  ...
  public aato(Context paramContext)
  {
    ...
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.tencent.map", anvx.a(2131709905));
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.google.android.apps.maps", "Google地图");
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.autonavi.minimap", anvx.a(2131709903));
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.baidu.BaiduMap", anvx.a(2131709904));
  ...
  public static String a(double paramDouble)
  {
    if (paramDouble < 1000.0D) {
      return String.format(anvx.a(2131709911), new Object[] { Double.valueOf(paramDouble) });
    }
    return String.format(anvx.a(2131709910), new Object[] { Double.valueOf(paramDouble / 1000.0D) });
  }
  ...
  {
    bdla.b(null, "dc00899", "Pb_account_lifeservice", "", "rec_locate_android", paramString1, 0, 0, paramString2, paramString3, "", "");
    if (QLog.isColorLevel()) {
  ...
  {
    bdla.b(null, "P_CliOper", "Pb_account_lifeservice", "", "rec_locate", paramString1, 0, 0, paramString2, "", "", "");
    if (QLog.isColorLevel()) {
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Aatq != null) {
        if (!this.jdField_a_of_type_Aatq.b())
        {
  ...
  protected void a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (bkyz.a(this.jdField_a_of_type_AndroidContentContext, str)) {
  ...
  public void a(aatq paramaatq)
  {
    this.jdField_a_of_type_Aatq = paramaatq;
  }
  ...
  public void a(GeoPoint paramGeoPoint1, GeoPoint paramGeoPoint2)
  {
    if (!NetworkUtil.isNetworkAvailable(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, paramGeoPoint1.getString(2131694255), 1).b(paramGeoPoint1.getDimensionPixelSize(2131299080));
      return;
    }
    ...
    for (;;)
    {
      ...
      new bghh(str, "GET", new aatp(this), 1000, localBundle2, true).execute(new HashMap[] { paramGeoPoint1 });
      return;
  ...
  public void a(GeoPoint paramGeoPoint1, GeoPoint paramGeoPoint2, String paramString1, String paramString2)
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 0, anvx.a(2131709908), 1).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299080));
      return;
    }
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_JavaLangString = anvx.a(2131709906);
    }
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      this.jdField_b_of_type_JavaLangString = anvx.a(2131709902);
    }
    ...
    if (d > 1000.0D)
    {
      ...
      if ((this.jdField_a_of_type_Aatq == null) || (this.jdField_a_of_type_Aatq.b())) {
        break label469;
      }
      this.jdField_a_of_type_Bkzi.c(anvx.a(2131709909));
      label295:
      this.jdField_a_of_type_ArrayOfInt[0] = 0;
      this.jdField_a_of_type_Bkzi.c(anvx.a(2131709907));
      this.jdField_a_of_type_ArrayOfInt[1] = 1;
      this.jdField_a_of_type_Bkzi.c((CharSequence)this.jdField_a_of_type_JavaUtilLinkedHashMap.get("com.tencent.map"));
      ...
      this.jdField_a_of_type_Bkzi.c(paramString1);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = 0;
      break;
      this.jdField_a_of_type_Bkzi.c(anvx.a(2131709901));
      break label295;
  ...
  public void a(JSONObject paramJSONObject, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Aatq != null) {
        this.jdField_a_of_type_Aatq.a(paramJSONObject, paramInt);
      }
      return;
      if (paramInt == 1)
      {
