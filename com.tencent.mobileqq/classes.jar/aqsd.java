...
public class aqsd
{
  ...
  public static ColorNote a(ColorNote paramColorNote)
  {
    ...
    return new aqrv().a(i | 0x80000000).a(paramColorNote.getSubType()).b(0).b(paramColorNote.getMainTitle()).c(str).d(paramColorNote.getPicUrl()).a(paramColorNote.getReserve()).a();
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    localbhpc.dismissMessage();
    ((RelativeLayout.LayoutParams)localbhpc.getTitleTextView().getLayoutParams()).bottomMargin = bhtq.a(26.0F);
    localbhpc.setCanceledOnTouchOutside(false);
    localbhpc.setTitle(paramContext.getString(2131690759));
    localbhpc.setNegativeButton(paramContext.getString(2131690758), new aqse(localbhpc, paramContext));
    if (localbhpc.isShowing()) {
      localbhpc.dismiss();
    }
    localbhpc.show();
    paramContext = localbhpc.getTitleTextView();
  ...
  public static boolean a(ColorNote paramColorNote)
  {
    ...
    boolean bool1 = bool2;
    if (paramColorNote != null) {
      if (bhsr.a(paramColorNote.mMainTitle))
      {
        bool1 = bool2;
        if (bhsr.a(paramColorNote.mSubTitle)) {}
      }
      else
      {
        bool1 = true;
  ...
  {
    if ((a == null) || (a.size() == 0) || (bhsr.a(paramString))) {}
    for (;;)
    {
      return false;
      int i = 0;
  ...
  public static ColorNote b(ColorNote paramColorNote)
  {
    ...
    return new aqrv().a(i).a(paramColorNote.getSubType()).b(paramColorNote.getMainTitle()).c(paramColorNote.getSubTitle()).a(paramColorNote.getReserve()).a();
  }
  ...
  {
    if ((b.size() == 0) || (bhsr.a(paramString))) {}
    for (;;)
    {
      return false;
      int i = 0;
  ...
  public static ColorNote c(ColorNote paramColorNote)
  {
    ...
    return new aqrv().a(paramColorNote.getServiceType()).a(paramColorNote.getSubType()).b(paramColorNote.getMainTitle()).c(paramColorNote.getSubTitle()).d(paramColorNote.getPicUrl()).a(paramColorNote.getReserve()).b(paramColorNote.mExtra).a();
  }
  ...
  {
    if ((c.size() == 0) || (bhsr.a(paramString))) {}
    for (;;)
    {
      return false;
      int i = 0;
