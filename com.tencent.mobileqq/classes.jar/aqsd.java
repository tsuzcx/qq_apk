...
public class aqsd
{
  ...
  aqsb jdField_a_of_type_Aqsb;
  aqsh jdField_a_of_type_Aqsh;
  ...
  public aqsd(aqsc paramaqsc) {}
  
  public aqsd a()
  {
    aqsc.a().a(aqsc.a().a(this.jdField_a_of_type_Aqsb.b, this.jdField_a_of_type_Aqsb.jdField_a_of_type_Long), this);
    return this;
  }
  
  public aqsd a(int paramInt)
  {
    this.jdField_a_of_type_Int = paramInt;
    return this;
  }
  
  public aqsd a(aqsb paramaqsb)
  {
    this.jdField_a_of_type_Aqsb = paramaqsb;
    return this;
  }
  
  public aqsd a(aqsh paramaqsh)
  {
    this.jdField_a_of_type_Aqsh = paramaqsh;
    return this;
  }
  
  public aqsd a(List<DanmuItemBean> paramList)
  {
    this.jdField_c_of_type_JavaUtilList = paramList;
    return this;
  }
  
  public aqsd a(boolean paramBoolean)
  {
  ...
  public String a()
  {
    return String.format("CacheHolder - topicUin:%s, groupUin:%s, msgType:%s, peakCached:%s, videoStartTime:%s, videoEndTime:%s, nextStartIdx:%s, count:%s", new Object[] { Long.valueOf(this.jdField_a_of_type_Aqsb.jdField_a_of_type_Long), Long.valueOf(this.jdField_a_of_type_Aqsb.b), Integer.valueOf(this.jdField_a_of_type_Aqsb.jdField_a_of_type_Int), Boolean.valueOf(this.jdField_a_of_type_Aqsb.jdField_a_of_type_Boolean), Integer.valueOf(this.jdField_c_of_type_Int), Integer.valueOf(this.jdField_d_of_type_Int), Integer.valueOf(this.e), Integer.valueOf(this.f) });
  }
  ...
  public aqsd b(List<Long> paramList)
  {
    this.jdField_a_of_type_JavaUtilList = paramList;
    return this;
  }
  
  public aqsd c(int paramInt)
  {
    this.e = paramInt;
    return this;
  }
  
  public aqsd d(int paramInt)
  {
    this.jdField_c_of_type_Int = paramInt;
    return this;
  }
  
  public aqsd e(int paramInt)
  {
