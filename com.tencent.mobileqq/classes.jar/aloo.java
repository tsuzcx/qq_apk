...
public class aloo
{
  ...
  private aloq jdField_a_of_type_Aloq;
  ...
  public aloo(String paramString)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_AndroidHardwareSensorEventListener = new alor(this);
    this.jdField_a_of_type_Akuo = new alop(this, 3, true, true, 0L, true, true, "ArkAppEventObserverManager");
  }
  ...
  public void a(alov paramalov, long paramLong)
  {
    if ((paramalov instanceof alou))
    {
      if (QLog.isColorLevel()) {
        QLog.d("ArkAppEventObserverManager", 2, "attachEvent MotionCallback");
      }
      if ((this.jdField_a_of_type_Long != 0L) && (this.jdField_a_of_type_Alou != null)) {
        this.jdField_a_of_type_Alou.a(this.jdField_a_of_type_Long);
      }
      this.jdField_a_of_type_Alou = ((alou)paramalov);
      this.jdField_a_of_type_Long = paramLong;
      if (this.jdField_a_of_type_AndroidHardwareSensor == null)
      {
        paramalov = (SensorManager)BaseApplicationImpl.getApplication().getSystemService("sensor");
        this.jdField_a_of_type_AndroidHardwareSensor = paramalov.getDefaultSensor(1);
        if (this.jdField_a_of_type_AndroidHardwareSensor == null) {
          break label113;
        }
        paramalov.registerListener(this.jdField_a_of_type_AndroidHardwareSensorEventListener, this.jdField_a_of_type_AndroidHardwareSensor, 1);
      }
    }
    label113:
    do
    {
      do
      {
        do
        {
          ...
          this.jdField_a_of_type_Alou.a(false, 0.0F, 0.0F, 0.0F);
          return;
          if (!(paramalov instanceof alow)) {
            break;
          }
          if (QLog.isColorLevel()) {
            QLog.d("ArkAppEventObserverManager", 2, "attachEvent OrientationCallback");
          }
          if ((this.jdField_b_of_type_Long != 0L) && (this.jdField_a_of_type_Alow != null)) {
            this.jdField_a_of_type_Alow.a(this.jdField_b_of_type_Long);
          }
          this.jdField_a_of_type_Alow = ((alow)paramalov);
          this.jdField_b_of_type_Long = paramLong;
        } while (this.jdField_b_of_type_AndroidHardwareSensor != null);
        paramalov = (SensorManager)BaseApplicationImpl.getApplication().getSystemService("sensor");
        this.jdField_b_of_type_AndroidHardwareSensor = paramalov.getDefaultSensor(3);
        paramalov.registerListener(this.jdField_a_of_type_AndroidHardwareSensorEventListener, this.jdField_b_of_type_AndroidHardwareSensor, 1);
        return;
        if ((paramalov instanceof alox))
        {
          if (QLog.isColorLevel()) {
            QLog.d("ArkAppEventObserverManager", 2, "attachEvent PositionCallback callback=" + paramalov + ", cbId=" + paramLong + ", mPositionCallback=" + this.jdField_a_of_type_Alox + ", mPositionCallbackId=" + this.jdField_c_of_type_Long);
          }
          if ((this.jdField_c_of_type_Long != 0L) && (this.jdField_a_of_type_Alox != null)) {
            this.jdField_a_of_type_Alox.a(this.jdField_c_of_type_Long);
          }
          this.jdField_a_of_type_Alox = ((alox)paramalov);
          this.jdField_c_of_type_Long = paramLong;
          SosoInterface.a(this.jdField_a_of_type_Akuo);
          return;
        }
        if (!(paramalov instanceof alos)) {
          break;
        }
        if (QLog.isColorLevel()) {
          QLog.d("ArkAppEventObserverManager", 2, "attachEvent ConnectionCallback");
        }
        if ((this.jdField_d_of_type_Long != 0L) && (this.jdField_a_of_type_Alos != null)) {
          this.jdField_a_of_type_Alos.a(this.jdField_d_of_type_Long);
        }
        this.jdField_a_of_type_Alos = ((alos)paramalov);
        this.jdField_d_of_type_Long = paramLong;
      } while (this.jdField_a_of_type_Aloq != null);
      this.jdField_a_of_type_Aloq = new aloq(this);
      AppNetConnInfo.registerConnectionChangeReceiver(BaseApplicationImpl.getApplication(), this.jdField_a_of_type_Aloq);
      return;
    } while (!(paramalov instanceof alot));
    if (QLog.isColorLevel()) {
      QLog.d("ArkAppEventObserverManager", 2, "attachEvent GetCurrentPositionCallback");
    }
    if ((this.jdField_e_of_type_Long != 0L) && (this.jdField_a_of_type_Alot != null)) {
      this.jdField_a_of_type_Alot.a(this.jdField_e_of_type_Long);
    }
    this.jdField_a_of_type_Alot = ((alot)paramalov);
  ...
  public void a(String paramString)
  {
    ...
    if ("Motion".equals(paramString))
    {
      ...
      this.jdField_a_of_type_Alou = null;
    ...
    do
    {
      ...
      if ("Orientation".equals(paramString))
      {
        ...
        this.jdField_a_of_type_Alow = null;
      ...
      if ("Position".equals(paramString))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("ArkAppEventObserverManager", 2, "detachEvent PositionCallback mPositionCallback=" + this.jdField_a_of_type_Alox + ", mPositionCallbackId=" + this.jdField_c_of_type_Long);
        }
        if ((this.jdField_c_of_type_Long != 0L) && (this.jdField_a_of_type_Alox != null)) {
          this.jdField_a_of_type_Alox.a(this.jdField_c_of_type_Long);
        }
    ...
    if (this.jdField_a_of_type_Aloq != null)
    {
      AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Aloq);
      this.jdField_a_of_type_Aloq = null;
    }
    if ((this.jdField_d_of_type_Long != 0L) && (this.jdField_a_of_type_Alos != null)) {
      this.jdField_a_of_type_Alos.a(this.jdField_d_of_type_Long);
    }
