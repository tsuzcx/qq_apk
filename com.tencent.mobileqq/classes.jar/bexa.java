...
public class bexa
  extends andd
{
  public bexa(BulkSendMessageFragment paramBulkSendMessageFragment) {}
  ...
  protected void onBulkSendMessage(boolean paramBoolean, homework.RspSend1V1Msg paramRspSend1V1Msg, homework.ReqSend1V1Msg paramReqSend1V1Msg)
  {
    ...
    label97:
    for (Object localObject = "null";; localObject = yps.a(paramRspSend1V1Msg))
    {
      ...
      {
        this.a.jdField_a_of_type_ComTencentBizQqstoryUtilsUIUtils$StoryProgressUI.dismiss();
    ...
    if (paramRspSend1V1Msg == null)
    {
      QQToast.a((Context)localObject, 1, amtj.a(2131700379), 1).a();
      return;
    }
    ...
    QQToast.a((Context)localObject, 2, amtj.a(2131700375), 1).a();
    ...
    paramRspSend1V1Msg = bftc.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_JavaLangString);
    bftc.a("Grp_edu", "MassMessage", "CreateMessage_Send", 0, 0, new String[] { this.a.jdField_a_of_type_JavaLangString, paramRspSend1V1Msg, paramReqSend1V1Msg.text.get().toStringUtf8(), String.valueOf(paramReqSend1V1Msg.to_uins.size()) });
  }
}
