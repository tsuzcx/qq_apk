...
public class bipa
{
  protected static bipa a;
  protected static byte[] a;
  public int a;
  protected List<bipb> a;
  public int b;
  ...
  {
    if (jdField_a_of_type_Bipa == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Bipa == null) {
        jdField_a_of_type_Bipa = new bipa();
      }
      return jdField_a_of_type_Bipa;
    }
  }
  ...
  {
    List localList = ((bipb)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_JavaUtilList;
    if (localList != null) {
  ...
  public Friend a(String paramString)
  {
    ...
    do
    {
      ...
      while (!localIterator2.hasNext())
      {
        ...
        localIterator2 = ((bipb)localIterator1.next()).jdField_a_of_type_JavaUtilList.iterator();
      }
  ...
  {
    return ((bipb)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_JavaLangString;
  }
  ...
  public List<Friend> a()
  {
    ...
    {
      Iterator localIterator2 = ((bipb)localIterator1.next()).jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator2.hasNext()) {
  ...
  {
    return ((bipb)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_JavaUtilList;
  }
  ...
  public void a(List<bipb> paramList, int paramInt1, int paramInt2)
  {
    label9:
    String str2;
    ...
    else
    {
      ...
      this.c.clear();
      str2 = biip.a().a().getResources().getString(2131690798);
    ...
    for (;;)
    {
      if (localIterator1.hasNext())
      {
        paramList = (bipb)localIterator1.next();
