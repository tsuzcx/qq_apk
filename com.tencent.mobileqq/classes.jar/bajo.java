  ...
  implements Manager
{
    ...
    for (;;)
    {
      ...
      else
      {
        for (;;)
        {
          ...
          for (;;)
          {
            axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_public", "", "oper", "bottom_one", 0, 0, paramString, "", "", "");
            break;
            if (((ChatMessage)???.get(i)).shmsgseq > l) {
              ???.add(i, ???);
  ...
  public boolean a(String paramString)
  {
    ...
    //   9: aload_1
    //   10: aload_0
    //   11: getfield 33	bajo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
