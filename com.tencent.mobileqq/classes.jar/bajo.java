  ...
  extends xbg
{
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d9.TransFileRspBody paramTransFileRspBody, Bundle paramBundle)
  {
    ...
    ((bajk)localObject).jdField_a_of_type_Int -= 1;
    if ((!paramBoolean) || (paramTransFileRspBody == null)) {
      azsr.a("TroopFileManager", azsr.jdField_a_of_type_Int, "onTransFileResult:  isSuccess:false");
    }
    do
    {
      return;
      localObject = paramBundle.getString("fileId");
      paramBundle = (azpg)this.a.c.get(localObject);
    } while (paramBundle == null);
    int i = paramTransFileRspBody.int32_ret_code.get();
    azsr.c("TroopFileManager", azsr.jdField_a_of_type_Int, "onTransFileResult: fileId:" + (String)localObject + " isSuccess:" + paramBoolean + " errCode:" + paramInt + " retCode:" + i);
    if (i < 0)
    {
      paramInt = 501;
      switch (i)
    ...
    paramTransFileRspBody = (bajq)this.a.d.get(paramBundle.f);
