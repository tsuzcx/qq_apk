...
{
  public aggd(OcrControl paramOcrControl) {}
  ...
  public void a(int paramInt, String paramString, ARCloudRecogResult paramARCloudRecogResult)
  {
    ...
    if (paramString != null)
    {
      ...
      if (paramString.a != null)
      {
        ...
        if ((localOcrRecogResult != null) && ((this.a.a == 1) || (this.a.a == 2))) {
          ThreadManager.postImmediately(new agge(this, localOcrRecogResult, paramString), null, false);
        }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ThreadManager.postImmediately(new aggf(this, paramString), null, false);
          ThreadManager.post(new aggg(this, j, i, m, k, paramInt), 5, null, false);
          return;
          label345:
          i = i1;
          j = n;
