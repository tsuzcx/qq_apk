...
public class aaqx
{
  public aaqx(NewerGuidePlugin paramNewerGuidePlugin, JSONObject paramJSONObject, Activity paramActivity) {}
  ...
  public void deniedReadContacts()
  {
    ...
    try
    {
      ...
      QQCustomDialog.showPermissionSettingDialog(this.jdField_a_of_type_AndroidAppActivity, anvx.a(2131706901));
      return;
    }
