...
public class ngv
  extends ndi
{
  public ngv(AppInterface paramAppInterface)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (528 == i)
      {
        paramToServiceMsg = acnk.a(((MsgInfo)localObject).vMsg);
    ...
    label230:
    label241:
    for (paramToServiceMsg = nff.a(((AvGameNotify.NotifyMsg)localObject).type.get());; paramToServiceMsg = "null")
    {
      QLog.d("avgame_logic.GameRoomPushHandler", 1, new Object[] { "handleOnlinePush type=", paramToServiceMsg });
      if (localObject == null) {
        break label75;
      }
      nfj.a((AVGameAppInterface)this.mApp, (AvGameNotify.NotifyMsg)localObject);
      break label75;
      break;
