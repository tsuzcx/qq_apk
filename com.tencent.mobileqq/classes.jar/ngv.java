...
public class ngv
{
  ...
  private final akfx jdField_a_of_type_Akfx = new nhc(this, "readinjoy_weather");
  private final View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ngw(this);
  ...
  private final ohe jdField_a_of_type_Ohe = new nhd(this);
  private int jdField_b_of_type_Int = -1;
  private final View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new ngy(this);
  private final View.OnClickListener c = new ngz(this);
  private final View.OnClickListener d = new nha(this);
  private View.OnClickListener e;
  
  public ngv(@NonNull VafContext paramVafContext)
  {
  ...
  private static Container a(VafContext paramVafContext, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = rdg.a("daily_dynamic_header", true);
        if (localObject != null)
        {
          paramJSONObject = ((rdg)localObject).getTemplateBean(paramJSONObject);
          if (paramJSONObject != null)
          {
            paramVafContext = paramVafContext.getViewFactory().inflate(paramVafContext, paramJSONObject);
            oag.a(paramVafContext, null, paramJSONObject);
  ...
  private Container a(JSONObject paramJSONObject, View.OnClickListener paramOnClickListener)
  {
    if ((this.jdField_b_of_type_Int == -1) || (this.jdField_b_of_type_Int == 0))
    {
      ...
      {
        Drawable localDrawable = this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2130842519);
    ...
    for (;;)
    {
      ...
      if (paramJSONObject != null)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842519);
  ...
  private static URLDrawable.URLDrawableOptions a(Context paramContext)
  {
    ...
    paramContext = paramContext.getResources().getDrawable(2130842519);
  ...
  private void a(int paramInt)
  {
    ...
    bgmq.a("sp_key_daily_dynamic_header_state", Integer.valueOf(this.jdField_a_of_type_Int));
  ...
  private void a(@NonNull View paramView, @NonNull Container paramContainer, @NonNull Drawable paramDrawable, JSONObject paramJSONObject)
  {
    ...
    ((DailyTitleBar)paramView.findViewById(2131305234)).setVisibility(8);
    DailyTitleBarSwitcher localDailyTitleBarSwitcher = (DailyTitleBarSwitcher)paramView.findViewById(2131299324);
    ...
    ReadInJoyDailyPullToZoomHeaderXListView localReadInJoyDailyPullToZoomHeaderXListView = (ReadInJoyDailyPullToZoomHeaderXListView)paramView.findViewById(2131310904);
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)LayoutInflater.from(paramView.getContext()).inflate(2131494325, localReadInJoyDailyPullToZoomHeaderXListView, false));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131297462));
    ngt.a(paramDrawable);
    ngt.a(this.jdField_a_of_type_AndroidWidgetImageView);
  ...
  private static void a(Container paramContainer, String paramString, JSONObject paramJSONObject)
  {
    ...
    ViewFactory.findClickableViewListener(paramContainer.getVirtualView(), new nhf(paramString, paramJSONObject));
  }
  ...
  private void a(@NonNull BaseActivity paramBaseActivity, @NonNull Runnable paramRunnable)
  {
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      {
        paramBaseActivity.requestPermissions(new nhe(this, paramRunnable), 1, new String[] { "android.permission.ACCESS_FINE_LOCATION" });
        return;
      }
      paramRunnable.run();
      return;
  ...
  private void a(String paramString)
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2131101136);
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewDailyTitleBarSwitcher == null) {
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewDailyTitleBarSwitcher = ((DailyTitleBarSwitcher)this.jdField_a_of_type_AndroidViewView.findViewById(2131299324));
      }
    ...
    if (!TextUtils.isEmpty(str))
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewDailyTitleBarSwitcher.setOnTitleClickWeatherListener(new ngx(this, paramJSONObject));
      return;
    }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    long l1 = ((Long)bgmq.a("sp_key_daily_dynamic_header_last_refresh_time", Long.valueOf(0L))).longValue();
  ...
  private static boolean a(Container paramContainer, JSONObject paramJSONObject)
  {
    ...
    if ((localObject instanceof TemplateBean))
    {
      ...
      try
      {
        rdg localrdg = rdg.a("daily_dynamic_header", true);
        if (localrdg != null) {}
        for (paramJSONObject = localrdg.getTemplateBean(paramJSONObject); (paramJSONObject != null) && (TextUtils.equals(paramJSONObject.getStyleName(), ((TemplateBean)localObject).getStyleName())) && (((TemplateBean)localObject).getId() == paramJSONObject.getId()); paramJSONObject = null)
        {
          QLog.i("DailyHeaderViewController", 1, "[bindDataForProteusHeader] template match, bind data");
          oag.a(paramContainer, (TemplateBean)localObject, paramJSONObject);
          return true;
        }
        return false;
      }
  ...
  private void b()
  {
    ...
    DailyTitleBar localDailyTitleBar = (DailyTitleBar)this.jdField_a_of_type_AndroidViewView.findViewById(2131305234);
    ...
    this.jdField_a_of_type_AndroidViewView.findViewById(2131299324).setVisibility(8);
    if (this.jdField_a_of_type_AndroidViewViewGroup != null)
    {
      ((ReadInJoyDailyPullToZoomHeaderXListView)this.jdField_a_of_type_AndroidViewView.findViewById(2131310904)).removeHeaderView(this.jdField_a_of_type_AndroidViewViewGroup);
  ...
  private void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localJSONObject.putOpt("error_reason", ajjy.a(2131636916)).putOpt("operation_text", ajjy.a(2131636921));
      View.OnClickListener localOnClickListener = this.c;
      for (;;)
      {
        a(localJSONObject, localOnClickListener);
        return;
        localJSONObject.putOpt("error_reason", ajjy.a(2131636922)).putOpt("operation_text", ajjy.a(2131636919));
        localOnClickListener = this.d;
        continue;
        localJSONObject.putOpt("error_reason", ajjy.a(2131636923)).putOpt("operation_text", ajjy.a(2131636920));
  ...
  private void b(View paramView)
  {
    ...
    a(((Integer)bgmq.a("sp_key_daily_dynamic_header_state", Integer.valueOf(0))).intValue());
  }
  ...
  private static void b(String paramString, JSONObject paramJSONObject)
  {
    ...
    localocg.b("model_type", a(paramString));
    localocg.b("topic_id", paramJSONObject.optString("topic_id", ""));
    ndn.a(null, "CliOper", "", "", "0X8009D12", "0X8009D12", 0, 0, "", "", "", localocg.a(), false);
  }
  ...
  private void c()
  {
    JSONObject localJSONObject = ogy.a().a();
    Object localObject;
    ...
    if (localContainer != null)
    {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          Drawable localDrawable = this.jdField_a_of_type_AndroidViewView.getContext().getResources().getDrawable(2131101136);
        }
      }
    }
    a(0);
  ...
  private static void c(String paramString, JSONObject paramJSONObject)
  {
    ...
    localocg.b("model_type", a(paramString));
    localocg.b("topic_id", paramJSONObject.optString("topic_id", ""));
    ndn.a(null, "CliOper", "", "", "0X8009D13", "0X8009D13", 0, 0, "", "", "", localocg.a(), false);
  }
  ...
  private void d()
  {
    ...
    for (;;)
    {
      ...
      ((JSONObject)localObject).putOpt("error_reason", ajjy.a(2131636914));
      for (;;)
      {
        ((JSONObject)localObject).putOpt("operation_text", ajjy.a(2131636915));
        break;
        ((JSONObject)localObject).putOpt("error_reason", ajjy.a(2131636918));
        continue;
        ((JSONObject)localObject).putOpt("error_reason", ajjy.a(2131636917));
      }
    }
  }
