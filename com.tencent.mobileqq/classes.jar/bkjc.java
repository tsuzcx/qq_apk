...
public class bkjc
{
  ...
  public static void a(Context paramContext)
  {
    ...
    bkjf.a().enter(paramContext, 1002L, BaseApplicationImpl.getApplication().getRuntime().getAccount(), "", new Bundle(), null);
  }
  ...
  public static void a(Context paramContext, Intent paramIntent, String paramString, EnterCallback paramEnterCallback)
  {
    ...
    for (paramIntent = paramIntent.getExtras();; paramIntent = null)
    {
      ...
      bkjf.a().enter(paramContext, 1003L, BaseApplicationImpl.getApplication().getRuntime().getAccount(), "", (Bundle)localObject, paramEnterCallback);
      return;
    }
  }
}
