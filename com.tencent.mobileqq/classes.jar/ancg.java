...
public class ancg
  extends Handler
{
  public ancg(EditVideoArtFilter paramEditVideoArtFilter) {}
  ...
  public void dispatchMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        QQToast.a(this.a.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131438706), 0).a();
        return;
        if (QLog.isColorLevel()) {
