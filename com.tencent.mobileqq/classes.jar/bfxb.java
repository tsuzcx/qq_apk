...
public class bfxb
{
  ...
  public static ArrayList<bfxc> a(String paramString)
  {
  ...
  public static ArrayList<bfxc> a(JSONArray paramJSONArray)
  {
    Object localObject2;
    ...
    for (;;)
    {
      ...
      try
      {
        if (i < paramJSONArray.length())
        {
          ...
          {
            localArrayList.add(new bfxc(str1));
            localObject2 = str1;
          }
          localArrayList.add(new bfxc(str1, str3, str2, str4));
          i += 1;
  ...
  public static LinkedHashMap<String, Integer> a(String[] paramArrayOfString, List<bfxc> paramList)
  {
    int j = 0;
    ...
    {
      bfxc localbfxc = (bfxc)paramList.next();
      if (localLinkedHashMap.containsKey(localbfxc.jdField_a_of_type_JavaLangString))
      {
        i += 1;
      }
      else
      {
        localLinkedHashMap.put(localbfxc.jdField_a_of_type_JavaLangString, Integer.valueOf(i));
        i += 1;
      }
    }
