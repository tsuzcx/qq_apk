  ...
  extends WebViewPlugin
{
  private boolean a(JSONObject paramJSONObject)
  {
    ...
    if ((localafwp != null) && (localafwp.a(paramJSONObject))) {}
    for (int i = 1;; i = 0)
    {
  ...
  private boolean b(JSONObject paramJSONObject)
  {
    ...
    Intent localIntent = AIOUtils.setOpenAIOIntent(new Intent(localActivity, SplashActivity.class), new int[] { 2 });
    localIntent.addFlags(4194304);
    localIntent.putExtra("uin", str);
    localIntent.putExtra("uintype", 1);
    localIntent.putExtra("chat_inputBarContent", paramJSONObject);
    localActivity.startActivity(localIntent);
    localActivity.overridePendingTransition(2130771990, 2130772301);
    return true;
  }
