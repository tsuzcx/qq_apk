...
public class agsb
{
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramActivity = azqu.a(paramActivity);
    } while (paramActivity == null);
    bdir.a(paramQQAppInterface, paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_a_of_type_Int, paramActivity, null);
    azmj.b(paramQQAppInterface, "CliOper", "", paramSessionInfo.jdField_a_of_type_JavaLangString, "0X8004B51", "0X8004B51", 0, 0, "", "", "", "");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, SessionInfo paramSessionInfo, AbsShareMsg paramAbsShareMsg, String paramString)
  {
    ...
    zcp localzcp = new zcp(paramFragmentActivity);
    String str = paramFragmentActivity.getString(2131719909);
    if (paramString != null) {}
    for (paramString = str + paramString;; paramString = str)
    {
      paramAbsShareMsg = new agsc(paramAbsShareMsg, paramFragmentActivity, paramFragmentActivity, paramQQAppInterface, paramSessionInfo);
      localzcp.a(paramString, paramAbsShareMsg);
      localzcp.a(paramFragmentActivity.getResources().getString(2131719916));
      localzcp.a(paramAbsShareMsg);
      localzcp.a(false);
      localzcp.show();
      azmj.b(paramQQAppInterface, "CliOper", "", paramSessionInfo.jdField_a_of_type_JavaLangString, "0X8004B54", "0X8004B54", 0, 0, "", "", "", "");
      return;
    }
  }
  ...
  {
    boolean bool = false;
    azmj.b(paramQQAppInterface, "CliOper", "", paramSessionInfo.jdField_a_of_type_JavaLangString, "0X8004B53", "0X8004B53", 0, 0, "", "", "", "");
    ...
    localObject = azqu.a((byte[])localObject);
    ...
    if (paramIntent.getBooleanExtra("from3rdApp", false))
    {
      ...
      if (paramIntent.getBooleanExtra("showFirstStructMsg", false))
      {
        ...
        if (paramIntent != null)
        {
          ...
          long l = aytq.jdField_a_of_type_Int;
          paramSessionInfo = ayvw.a(paramQQAppInterface, paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.jdField_a_of_type_Int, l, paramIntent);
