...
{
  private static bcfv jdField_a_of_type_Bcfv;
  private ConcurrentLinkedQueue<bcfx> jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue;
  ...
  public static bcfv a()
  {
    if (jdField_a_of_type_Bcfv != null) {
      return jdField_a_of_type_Bcfv;
    }
    try
    {
      if (jdField_a_of_type_Bcfv == null) {
        jdField_a_of_type_Bcfv = new bcfv();
      }
      bcfv localbcfv = jdField_a_of_type_Bcfv;
      return localbcfv;
    }
    finally {}
  }
  ...
  private void b(MonitorHttpInfo paramMonitorHttpInfo, String paramString1, String paramString2)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue != null)
    {
      ...
      while (i < m)
      {
        ...
        if ((localObject instanceof bcfx))
        {
          localObject = (bcfx)localObject;
          int k = 0;
          try
          {
            j = a(str, ((bcfx)localObject).a());
            if (QLog.isColorLevel()) {
              QLog.d("NetworkMonitor", 2, new Object[] { "url=", str, " bean's url=", ((bcfx)localObject).a(), " lcs length=", Integer.valueOf(j) });
            }
            if (j < 10) {
              break label258;
            }
  ...
  public void a(String paramString)
  {
    ...
    bcfx localbcfx = new bcfx(this, paramString);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.add(localbcfx);
    if (QLog.isColorLevel()) {
    ...
    {
      paramString = (bcfx)this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.peek();
      if ((paramString == null) || (paramString.a - localbcfx.a <= 600000L)) {
        break;
      }
  ...
  public void addDownloadURL(String paramString)
  {
    ...
    if (1 != BaseApplicationImpl.sProcessId)
    {
      ...
      QIPCClientHelper.getInstance().callServer("NetworkMonitorIPCModule", "ACTION_REPORT_DOWNLOAD_URL", localBundle, new bcfw(this));
      return;
    }
    a(paramString);
  }
