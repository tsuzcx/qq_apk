...
public class ayox
{
  ...
  public static int a()
  {
    ...
    for (int i = j;; i = 0)
    {
      j = i;
      if (i <= 0) {
        j = bgsg.H(BaseApplicationImpl.sApplication.getApplicationContext());
      }
      return j;
    }
  }
  ...
  private int a(int paramInt)
  {
    ...
    for (paramInt = 12;; paramInt = 24) {
      return afur.a(paramInt, BaseApplicationImpl.getContext().getResources());
    }
  }
  ...
  private Drawable a(aypi paramaypi, @Nullable Friends paramFriends, int paramInt1, int paramInt2)
  {
    ...
    if (paramaypi != null)
    {
      ...
      paramaypi = paramaypi.jdField_a_of_type_MqqAppAppRuntime$Status;
      if (paramInt2 != 1) {
        break label49;
      }
      paramInt1 = 0;
      localObject1 = aypc.a(paramaypi, paramInt1);
    }
    label49:
    label55:
    do
    ...
    label104:
    paramaypi = URLDrawable.getDrawable(paramaypi.b, URLDrawable.URLDrawableOptions.obtain());
    paramaypi.setBounds(0, 0, i, i);
    return paramaypi;
    label127:
    if (paramaypi.jdField_a_of_type_Long == 1030L)
    {
      localObject1 = (aqqh)aqlk.a().a(652);
      if ((localObject1 == null) || (paramFriends == null)) {
        break label326;
      }
      localObject1 = ((aqqh)localObject1).a(paramFriends.weatherTypeId);
      if (QLog.isColorLevel()) {
    ...
    label326:
    for (paramFriends = ((ayse)localObject1).d;; paramFriends = "")
    {
      if (QLog.isColorLevel()) {
      ...
      {
        paramaypi = URLDrawable.getDrawable(paramFriends, (URLDrawable.URLDrawableOptions)localObject1);
        paramaypi.setBounds(0, 0, i, i);
        return paramaypi;
      }
      paramaypi = URLDrawable.getDrawable(paramaypi.b, (URLDrawable.URLDrawableOptions)localObject1);
      paramaypi.setBounds(0, 0, i, i);
      return paramaypi;
      paramaypi = URLDrawable.getDrawable(paramaypi.b, URLDrawable.URLDrawableOptions.obtain());
      paramaypi.setBounds(0, 0, i, i);
  ...
  public static int b()
  {
    int i = bgsg.I(BaseApplicationImpl.sApplication.getApplicationContext());
    int j = i;
  ...
  public static int c()
  {
    ...
    //   25: if_icmplt +96 -> 121
    //   28: aload_3
    //   29: invokevirtual 233	android/os/BatteryManager:isCharging	()Z
    //   32: istore_2
    //   33: aload_3
    //   34: bipush 6
    ...
    //   75: iconst_1
    //   76: iload_2
    //   77: invokestatic 240	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   80: aastore
    //   81: dup
    //   82: iconst_2
    //   83: ldc 242
    ...
    //   109: ldc 249
    //   111: aload_3
    //   112: invokestatic 253	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   115: iload_0
    //   116: ireturn
    //   117: astore_3
    //   118: goto -12 -> 106
  ...
  public Drawable a(long paramLong, AppRuntime.Status paramStatus, int paramInt, Friends paramFriends)
  {
    ...
    {
      aypi localaypi = a(AppRuntime.Status.online, paramLong);
      if (localaypi != null) {
        return a(localaypi, paramFriends, paramInt, 3);
      }
    }
    return aypc.a(paramStatus, a(paramInt));
  }
  
  public Drawable a(aypi paramaypi, Friends paramFriends)
  {
    return a(paramaypi, paramFriends, 0, 1);
  }
  
  public Bundle a(aysp paramaysp)
  {
    Bundle localBundle = new Bundle();
    BusinessInfo.LocationPoiInfo localLocationPoiInfo = new BusinessInfo.LocationPoiInfo();
    localLocationPoiInfo.latitude.set(paramaysp.jdField_a_of_type_Double);
    localLocationPoiInfo.longitude.set(paramaysp.b);
    localLocationPoiInfo.poi_name.set(ByteStringMicro.copyFromUtf8(paramaysp.jdField_a_of_type_JavaLangString));
    long l = NetConnInfoCenter.getServerTime();
    localLocationPoiInfo.update_time.set(l);
    localLocationPoiInfo.flag.set(paramaysp.jdField_a_of_type_Int);
    localBundle.putByteArray("LocationInfo", localLocationPoiInfo.toByteArray());
    if (QLog.isColorLevel()) {
      QLog.d("OnLineStatusHelper", 2, new Object[] { "OnlineStatusHelper buildSyncLocationData info:", paramaysp.toString() });
    }
    return localBundle;
  }
  
  public Bundle a(aysp paramaysp, boolean paramBoolean)
  {
    Bundle localBundle = new Bundle();
    BusinessInfo.LocationPoiInfo localLocationPoiInfo = new BusinessInfo.LocationPoiInfo();
    if (paramaysp != null)
    ...
    label144:
    for (paramaysp = "";; paramaysp = paramaysp.toString())
    {
      QLog.d("OnLineStatusHelper", 2, new Object[] { "OnlineStatusHelper buildSyncLocationData info:", paramaysp });
      return localBundle;
    }
  }
  ...
  public aypi a(AppRuntime.Status paramStatus, long paramLong, boolean paramBoolean)
  {
    if (paramStatus == null)
    {
    ...
    label119:
    for (paramStatus = ((aqqh)localObject).b(paramStatus, paramLong);; paramStatus = ((aqqh)localObject).a(paramStatus, paramLong))
    {
      localObject = paramStatus;
      if (paramStatus == null) {
        localObject = new aypi(AppRuntime.Status.online);
      }
      return localObject;
      localObject = paramStatus;
      break;
    ...
    label130:
    Object localObject = (aqqj)aqlk.a().a(578);
    if ((localObject != null) && (paramStatus == AppRuntime.Status.online)) {
      return ((aqqj)localObject).a(paramStatus, paramLong);
    }
    if (localObject != null) {
      return ((aqqj)localObject).a(paramStatus, 0L);
    }
    return new aypi(AppRuntime.Status.online);
  }
  ...
  public String a(long paramLong, AppRuntime.Status paramStatus)
  {
    if (paramStatus == AppRuntime.Status.online)
    {
      ...
      aypi localaypi = a(AppRuntime.Status.online, paramLong);
      if ((localaypi != null) && (!TextUtils.isEmpty(localaypi.jdField_a_of_type_JavaLangString))) {
        return localaypi.jdField_a_of_type_JavaLangString;
      }
    }
    return aypc.a(paramStatus);
  }
  
  public String a(QQAppInterface paramQQAppInterface, aypi paramaypi, AppRuntime.Status paramStatus, Friends paramFriends, TextView paramTextView, int paramInt)
  {
    if (paramStatus == AppRuntime.Status.online)
    {
      if (paramaypi.jdField_a_of_type_Long > 0L) {}
      for (boolean bool = true;; bool = false) {
        return a(paramQQAppInterface, paramFriends, paramTextView, 4, paramaypi, Boolean.valueOf(bool));
      }
    }
    return b(paramQQAppInterface, paramaypi, paramStatus, paramFriends, paramTextView, paramInt);
  }
  
  public String a(QQAppInterface paramQQAppInterface, Friends paramFriends, TextView paramTextView, int paramInt, aypi paramaypi, Boolean paramBoolean)
  {
    AppRuntime.Status localStatus = a().a(paramaypi);
    if (!Boolean.valueOf(a(paramaypi, paramFriends, paramBoolean.booleanValue())).booleanValue())
    {
      if (paramInt == 1) {}
      for (paramQQAppInterface = bglf.b(paramFriends);; paramQQAppInterface = aypu.b(paramFriends))
      {
        paramFriends = paramQQAppInterface;
        if (TextUtils.isEmpty(paramQQAppInterface)) {
          paramFriends = BaseApplicationImpl.getContext().getResources().getString(2131718211);
        }
        return paramFriends;
      }
    }
    return a().b(paramQQAppInterface, paramaypi, localStatus, paramFriends, paramTextView, paramInt);
  }
  
  public ArrayList<aypi> a()
  {
    aqqj localaqqj = (aqqj)aqlk.a().a(578);
    if (localaqqj != null) {
      return localaqqj.a();
    }
    return null;
  ...
  public AppRuntime.Status a(aypi paramaypi)
  {
    if (paramaypi != null) {
      return paramaypi.jdField_a_of_type_MqqAppAppRuntime$Status;
    }
    return null;
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Friends paramFriends, TextView paramTextView, boolean paramBoolean)
  {
    ...
    int i = bglf.a(paramFriends.detalStatusFlag, paramFriends.iTermType);
    boolean bool1;
    ...
    for (;;)
    {
      if (paramBoolean)
      {
        paramTextView.setCompoundDrawablePadding(afur.a(4.0F, BaseApplicationImpl.getContext().getResources()));
        ...
        {
          paramBoolean = aypu.b(paramQQAppInterface);
          break label139;
        }
        if (paramFriends.uExtOnlineStatus == 1040L)
        {
          paramBoolean = aypu.b(paramFriends);
          break label139;
        }
  ...
  public void a(Friends paramFriends, TextView paramTextView, boolean paramBoolean, aypi paramaypi)
  {
    Drawable[] arrayOfDrawable = paramTextView.getCompoundDrawables();
    if (paramBoolean)
    {
    ...
    if ((bglf.a(paramFriends.detalStatusFlag, paramFriends.iTermType) == 4) && (paramFriends.uExtOnlineStatus > 0L) && (paramaypi != null)) {}
    for (int i = 1;; i = 0)
    {
      if (i == 0) {
        break label124;
      }
      paramFriends = a().a(paramaypi, paramFriends);
      if (paramFriends == null) {
        break;
      }
      paramTextView.setCompoundDrawablePadding(afur.a(4.0F, BaseApplicationImpl.getContext().getResources()));
  ...
  public boolean a(aypi paramaypi)
  {
    return (paramaypi != null) && (paramaypi.jdField_a_of_type_Long == 1000L);
  }
  
  boolean a(aypi paramaypi, Friends paramFriends)
  {
    return (paramaypi.jdField_a_of_type_Long == 1030L) && (!aypu.a(paramFriends));
  }
  
  public boolean a(aypi paramaypi, Friends paramFriends, boolean paramBoolean)
  {
    boolean bool = paramBoolean;
    if (paramBoolean)
    {
      bool = paramBoolean;
      if (aypi.a(paramaypi.jdField_a_of_type_Long)) {
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      {
        paramBoolean = bool;
        if (!aypu.a(paramFriends)) {
          paramBoolean = false;
        }
      }
      bool = paramBoolean;
      if (paramaypi.jdField_a_of_type_Long == 1040L)
      {
        bool = paramBoolean;
        if (!aypu.b(paramFriends)) {
          bool = false;
        }
      }
      paramBoolean = bool;
      if (paramaypi.jdField_a_of_type_Long == 40001L)
      {
        paramBoolean = bool;
        if (!aypu.b(paramaypi)) {
          paramBoolean = false;
  ...
  {
    if (a(paramQQAppInterface, paramSessionInfo.jdField_a_of_type_JavaLangString))
    {
      paramView = ((anmw)paramQQAppInterface.getManager(51)).e(paramSessionInfo.jdField_a_of_type_JavaLangString);
      boolean bool;
      if (!paramQQAppInterface.c().equals(paramSessionInfo.jdField_a_of_type_JavaLangString))
      {
        bool = true;
      ...
      do
      {
        do
        {
          ...
          paramQQAppInterface = (aqqh)aqlk.a().a(652);
        } while ((paramQQAppInterface == null) || (paramQQAppInterface.a == null) || (TextUtils.isEmpty(paramQQAppInterface.a.jdField_a_of_type_JavaLangString)));
        paramQQAppInterface = paramQQAppInterface.a.jdField_a_of_type_JavaLangString + paramView.adCode;
        aysf.a.a(paramActivity, paramQQAppInterface, 4014);
        aypy.a("0X800AF4C", 2);
        return true;
      } while (paramQQAppInterface.jdField_a_of_type_Long != 1040L);
      label207:
      aysf.a.a(paramActivity, paramView.constellationJumpUrl, 4014);
      aypy.a("0X800AF4C", 1);
      return true;
    }
    return false;
  ...
  {
    Friends localFriends = ((anmw)paramQQAppInterface.getManager(51)).e(paramString);
    boolean bool;
    if (!paramQQAppInterface.c().equals(paramString)) {
      bool = true;
    }
    while (localFriends != null)
    {
      ...
      {
        if (paramQQAppInterface.jdField_a_of_type_Long == 1030L) {
          return aypu.a(localFriends);
        }
        if (paramQQAppInterface.jdField_a_of_type_Long == 1040L) {
          return aypu.b(localFriends);
        }
      }
    }
    return false;
  ...
  protected boolean a(String paramString)
  {
    ...
    return ((QQAppInterface)localAppRuntime).c().equals(paramString);
  }
  ...
  public String b(QQAppInterface paramQQAppInterface, aypi paramaypi, AppRuntime.Status paramStatus, Friends paramFriends, TextView paramTextView, int paramInt)
  {
    if ((paramStatus == AppRuntime.Status.online) && (paramaypi != null))
    {
      if ((paramaypi.jdField_a_of_type_Long == 1000L) && (paramFriends != null)) {
      ...
      do
      {
        ...
        return bglf.b(paramFriends);
        if ((paramaypi.jdField_a_of_type_Long == 1028L) && (paramFriends != null)) {
          return aysz.a(paramQQAppInterface, paramFriends, paramTextView);
        }
        if ((paramaypi.jdField_a_of_type_Long == 1030L) && (paramFriends != null)) {
          return aypu.a(paramQQAppInterface, paramTextView, paramFriends, paramInt);
        }
        if ((paramaypi.jdField_a_of_type_Long != 1040L) || (paramFriends == null)) {
          break;
        }
        paramQQAppInterface = aysh.b(paramFriends);
        if (QLog.isColorLevel()) {
          QLog.d("OnLineStatusHelper", 2, new Object[] { "getAIOStatusName: invoked. ", " suitableTrend: ", paramQQAppInterface });
        }
      } while (aypu.b(paramFriends));
      return "";
      if (paramaypi.jdField_a_of_type_Long > 40001L)
      {
        if (!TextUtils.isEmpty(paramaypi.jdField_a_of_type_JavaLangString))
        {
          long l = paramFriends.autoStatusUpdateSecond;
          paramStatus = aypu.a(NetConnInfoCenter.getServerTime(), l);
          QLog.d("OnLineStatusHelper", 1, new Object[] { "getAIOStatusName: invoked. [status-time] ", " passTimeStr: ", paramStatus, " autoStatusUpdateSecond: ", Long.valueOf(l), " extOnlineStatus.title: ", paramaypi.jdField_a_of_type_JavaLangString, " friend.uin: ", paramFriends.uin, " during second: ", Long.valueOf(NetConnInfoCenter.getServerTime() - l) });
          if ((TextUtils.isEmpty(paramStatus)) || (paramQQAppInterface.getCurrentAccountUin().equals(paramFriends.uin))) {
            return paramaypi.jdField_a_of_type_JavaLangString;
          }
          return paramaypi.jdField_a_of_type_JavaLangString + String.format("(%s)", new Object[] { paramStatus });
        }
        return "";
      }
      if (paramaypi.jdField_a_of_type_Long == 40001L)
