...
public class lbf
{
  ...
  public lbf(Context paramContext, int paramInt, long paramLong)
  {
  ...
  private File a(Context paramContext)
  {
    ...
    Object localObject = lbk.a(paramContext);
    if ((("mounted".equals(Environment.getExternalStorageState())) || (!lbk.a())) && (localObject != null)) {
  ...
  private String b(String paramString)
  {
    ...
    //   1: astore 4
    //   3: aload_1
    //   4: invokestatic 115	lbk:a	(Ljava/lang/String;)Ljava/lang/String;
    //   7: astore_1
    //   8: aload_0
    //   9: getfield 32	lbf:a	Lcom/jakewharton/disklrucache/DiskLruCache;
    //   12: aload_1
  ...
  public lbi a(String paramString1, long paramLong, String paramString2)
  {
    String str = a(lbk.a(paramString2, paramString1));
    if (str == null) {
      return null;
    }
    paramString2 = a(lbk.a(paramString2, paramString1, paramLong));
    paramString1 = Boolean.valueOf(false);
    if (paramString2 != null) {
      paramString1 = Boolean.valueOf(paramString2);
    }
    return new lbi(str, paramString1.booleanValue());
  }
  ...
  {
    a(lbk.a(paramString1, paramString2, paramLong), paramBoolean.toString());
  }
  
  public void a(String paramString1, String paramString2, long paramLong, Boolean paramBoolean, String paramString3)
  {
    a(lbk.a(paramString3, paramString1, paramLong), paramBoolean.toString());
    a(lbk.a(paramString3, paramString1), paramString2);
  }
}
