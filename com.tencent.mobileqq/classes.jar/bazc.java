  ...
  extends bayu
{
  ...
  static
  {
    jdField_c_of_type_JavaLangString = "Q.uniteSearch." + bazc.class.getName();
  }
  
  public bazc(String paramString, long paramLong, List<String> paramList, UnifySearchCommon.ResultItem paramResultItem, int paramInt)
  {
    ...
    this.b = paramList;
    this.g = paramString;
    this.jdField_a_of_type_Bbfz = new bbfz(paramList, a());
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      a(this.jdField_a_of_type_JavaLangString);
    }
  }
  
  public bazc(String paramString, long paramLong, List<String> paramList, DynamicSearch.ResultItem paramResultItem, int paramInt)
  {
    if (paramResultItem != null)
    {
      this.d = paramResultItem.result_id.get().toStringUtf8();
  ...
  public void a(View paramView)
  {
    ...
    try
    {
      ...
      if ((this instanceof bazq)) {
        localObject1 = "clk_more";
      }
      bbda.a(null, new ReportModelDC02528().module("all_result").action((String)localObject1).obj1(this.jdField_a_of_type_Long + "").obj2(localbatc.jdField_b_of_type_JavaLangString).ver1(this.g).ver2(bbda.a(this.jdField_c_of_type_Int)).ver7(localJSONObject.toString()).session_id(localQQAppInterface.getCurrentAccountUin() + batb.jdField_a_of_type_Long));
      if (batb.jdField_a_of_type_JavaUtilHashMap.containsKey(this))
      {
        localObject1 = (batc)batb.jdField_a_of_type_JavaUtilHashMap.get(this);
        if (((batc)localObject1).jdField_b_of_type_Boolean)
        {
          j = 2;
          bbgk.a("all_result", "clk_object", j, 0, new String[] { this.g, "" + this.jdField_a_of_type_Long, ((batc)localObject1).jdField_b_of_type_JavaLangString + "", ((batc)localObject1).jdField_a_of_type_Int + "" });
        }
      }
      else
      {
        ...
        localObject1 = bfwg.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramView.getContext(), (String)localObject3);
    ...
    catch (JSONException localJSONException)
    {
      ...
      do
      {
        ...
        {
          bbgk.a(paramView.getContext(), Integer.valueOf(this.d).intValue(), -1);
          return;
        }
        ...
        if (this.jdField_a_of_type_Long == 536870912L)
        {
          ...
          try
          {
            ...
            vpl.a(paramView.getContext(), 24, l1);
            return;
          }
  ...
  {
    boolean bool = true;
    this.jdField_a_of_type_Bazd = new bazd(this);
    int j = paramJSONObject.optInt("imageType");
    this.jdField_a_of_type_Bazd.jdField_a_of_type_JavaLangString = paramJSONObject.optString("imageUrl");
    this.jdField_a_of_type_Bazd.jdField_a_of_type_Int = a(j);
    this.jdField_a_of_type_Bazd.jdField_b_of_type_Int = paramJSONObject.optInt("cornerRadius");
    bazd localbazd = this.jdField_a_of_type_Bazd;
    if (paramJSONObject.optInt("needPlayIcon") == 1) {}
    for (;;)
    {
      localbazd.jdField_a_of_type_Boolean = bool;
      this.jdField_a_of_type_Bazd.jdField_a_of_type_JavaLangCharSequence = paramJSONObject.optString("topLeftTagText");
      this.jdField_a_of_type_Bazd.jdField_b_of_type_JavaLangString = paramJSONObject.optString("topLeftTagColor");
      this.jdField_a_of_type_Bazd.jdField_b_of_type_JavaLangCharSequence = paramJSONObject.optString("bottomRightText");
      this.jdField_a_of_type_Bazd.jdField_c_of_type_JavaLangString = paramJSONObject.optString("bottomRightIconUrl");
      this.jdField_a_of_type_Bazd.jdField_c_of_type_JavaLangCharSequence = paramJSONObject.optString("bottomRightIconText");
      this.jdField_a_of_type_Bazd.d = paramJSONObject.optInt("imageHeight");
      this.jdField_a_of_type_Bazd.jdField_c_of_type_Int = paramJSONObject.optInt("imageWidth");
      return;
      bool = false;
    }
  }
