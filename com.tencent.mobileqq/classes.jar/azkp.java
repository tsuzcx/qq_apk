...
public class azkp
{
  public static aynd a(Bundle paramBundle, String paramString1, String paramString2)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("TroopBar", 2, "applyUpload title = " + str2 + ", filePath = " + str1 + ", size = " + bace.a(str1));
    }
    if ((TextUtils.isEmpty(str1)) || (!bace.a(str1)))
    {
    ...
    paramString1.add(new BasicNameValuePair("size", String.valueOf(bace.a(str1))));
    paramString1.add(new BasicNameValuePair("sha", bach.a(apck.a(str1)).toLowerCase()));
    paramString1.add(new BasicNameValuePair("md5", bach.a(apck.d(str1)).toLowerCase()));
    paramString1.add(new BasicNameValuePair("bkn", "" + azlj.b(paramString2)));
    if (QLog.isColorLevel()) {
