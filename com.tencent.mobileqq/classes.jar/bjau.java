public class bjau
{
  ...
  public static boolean a(@org.jetbrains.annotations.NotNull android.content.Context paramContext, @org.jetbrains.annotations.NotNull java.io.File paramFile)
  {
    ...
    //   60: invokestatic 61	bjbl:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   63: aload 5
    //   65: astore 6
    //   67: aload 5
    //   69: ifnonnull +88 -> 157
    ...
    //   74: astore 4
    //   76: aload_1
    //   77: invokestatic 68	bhpp:a	(Ljava/io/File;)Ljava/lang/String;
    //   80: astore 6
    //   82: aload 6
    //   84: astore 4
    ...
    //   140: invokestatic 77	bjbl:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   143: aload_0
    //   144: sipush -1002
    //   147: ldc 79
    //   149: aload_1
    //   150: invokestatic 84	bjbo:a	(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;)V
    //   153: aload 5
    //   155: astore 6
    //   157: aload 6
    //   159: ifnull +229 -> 388
    ...
    //   172: ldc 86
    //   174: aload 5
    //   176: invokestatic 89	bjbl:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   179: aload 4
    //   181: astore 6
    //   183: aload_0
    //   184: sipush -1001
    ...
    //   194: invokestatic 84	bjbo:a	(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;)V
    //   197: aload 4
    //   199: astore 6
    //   201: aload 4
    ...
    //   208: astore 5
    //   210: aload_1
    //   211: invokestatic 68	bhpp:a	(Ljava/io/File;)Ljava/lang/String;
    //   214: astore 6
    //   216: aload 6
    //   218: astore 5
    ...
    //   274: invokestatic 77	bjbl:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   277: aload_0
    //   278: sipush -1002
    //   281: ldc 79
    //   283: aload_1
    //   284: invokestatic 84	bjbo:a	(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;)V
    //   287: aload 4
    //   289: astore 6
    //   291: goto -134 -> 157
    //   294: astore 4
    ...
    //   306: astore 5
    //   308: aload_1
    //   309: invokestatic 68	bhpp:a	(Ljava/io/File;)Ljava/lang/String;
    //   312: astore 6
    //   314: aload 6
    //   316: astore 5
    ...
    //   372: invokestatic 77	bjbl:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   375: aload_0
    //   376: sipush -1002
    //   379: ldc 79
    //   381: aload_1
    //   382: invokestatic 84	bjbo:a	(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;)V
    //   385: aload 4
    //   387: athrow
    //   388: iconst_0
    //   389: ireturn
