...
public class bjau
  extends TextView
{
  public bjau(ProfileCardFavorItemDetailView paramProfileCardFavorItemDetailView, Context paramContext, Drawable paramDrawable, String paramString, int paramInt)
  {
    super(paramContext);
    setTextSize(1, 11.0F);
    setTextColor(-1);
    if (paramDrawable != null)
    {
      ...
      int i = (int)(agej.a(11.0F, getResources()) * 0.8D + 0.5D);
    ...
    for (;;)
    {
      ...
      setPadding(agej.a(4.0F, getResources()), 0, agej.a(4.0F, getResources()), 0);
      setLayoutParams(new ViewGroup.LayoutParams(-2, agej.a(15.0F, getResources())));
      return;
