  ...
  extends anii
{
  ...
  private nwo jdField_a_of_type_Nwo;
  
  public nwm(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {}
    while (this.jdField_a_of_type_Nwo != null) {
      return;
    }
    this.jdField_a_of_type_Nwo = new nwn(this);
    this.mApp.addObserver(this.jdField_a_of_type_Nwo);
  ...
  {
    super.onDestroy();
    this.mApp.removeObserver(this.jdField_a_of_type_Nwo);
  }
