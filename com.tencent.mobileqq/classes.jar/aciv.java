...
public class aciv
{
  ...
  public static int a(String paramString, int paramInt)
  {
    ...
    {
      acho.d("GdtUIUtils", "getColor error", paramString);
    }
    return paramInt;
  }
  ...
  public static Drawable a(@ColorInt int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      localPaintDrawable.setShaderFactory(new aciw(f1, f3, f2, f4, arrayOfInt));
  ...
  public static void a(Activity paramActivity)
  {
    ...
    {
      a(paramActivity);
      acho.a("GdtMvViewController", "enableNotch && updateLiuhaiTopHeight 0");
    }
  }
  ...
  public static boolean a(Activity paramActivity)
  {
    ...
    acho.a("GdtMvViewController", "hasTopLiuHai  " + LiuHaiUtils.a);
  ...
  public static int b(Context paramContext)
  {
    ...
    {
      acho.d("GdtUIUtils", "getScreenWidth error");
      return -2147483648;
    }
  ...
  public static int d(Context paramContext)
  {
    ...
    while ((paramContext.getResources() == null) || (paramContext.getResources().getDisplayMetrics() == null))
    {
      acho.d("GdtUIUtils", "getScreenHeight error");
      return -2147483648;
    }
