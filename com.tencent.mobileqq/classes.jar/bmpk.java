...
public class bmpk
{
  ...
  private bmqa jdField_a_of_type_Bmqa = new bmpm(this);
  private INetInfoHandler jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new bmpl(this);
  private String jdField_a_of_type_JavaLangString = "#FDFDFD";
  private ArrayList<bmpz> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  private ArrayList<bmpz> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public bmpk(Activity paramActivity)
  {
  ...
  private String a(String paramString)
  {
    ...
    for (paramString = "&";; paramString = "?")
    {
      ...
      if (!((String)localObject).contains("&ChannelID=")) {
        paramString = (String)localObject + "&ChannelID=" + bmrb.a();
      }
      localObject = paramString;
      if (QRDebugEnvUrlUtils.isDebugEnv()) {
        localObject = QRDebugEnvUrlUtils.getTestUrl(paramString);
      }
      bmqw.e("ReaderTabConfigDataHelper", " url=" + (String)localObject);
      return localObject;
    }
  }
  ...
  private void a(ArrayList<bmpz> paramArrayList)
  {
    ...
    while (i < j)
    {
      ...
      this.jdField_c_of_type_ArrayOfJavaLangString[i] = localbmpz.jdField_c_of_type_JavaLangString;
      int k = localbmpz.jdField_a_of_type_Int;
  ...
  private boolean a(ArrayList<bmpz> paramArrayList1, ArrayList<bmpz> paramArrayList2)
  {
    ...
    if (paramArrayList1.size() == paramArrayList2.size())
    {
      ...
      while (i < j)
      {
        if (!((bmpz)paramArrayList1.get(i)).equals(paramArrayList2.get(i))) {
          return false;
        }
        i += 1;
      }
  ...
  private boolean a(JSONObject paramJSONObject, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      localObject1 = new bmpz(((JSONObject)localObject1).optInt("tabID", -1), ((JSONObject)localObject1).optString("tabName"), ((JSONObject)localObject1).optString("n_tabIcon"), ((JSONObject)localObject1).optString("h_tabIcon"), localArrayList, k);
      if (k != 0) {
        break label397;
      }
    ...
    {
      bmqu.d(paramJSONObject, paramBoolean);
  ...
  private void e()
  {
    ...
    for (;;)
    {
      ...
      return;
      bmqw.d("ReaderTabConfigDataHelper", "tab url from local");
      a(4);
      this.jdField_a_of_type_JavaUtilArrayList.clear();
      bmpz localbmpz = new bmpz();
      localbmpz.jdField_a_of_type_Int = 100;
      localbmpz.jdField_a_of_type_JavaLangString = "书城";
      localbmpz.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_ELPT79nUxC.png";
      localbmpz.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_AXwBTwpLm8.png";
      ...
      localbmpz.jdField_a_of_type_JavaUtilArrayList = localArrayList;
      this.jdField_a_of_type_JavaUtilArrayList.add(localbmpz);
      localbmpz = new bmpz();
      localbmpz.jdField_a_of_type_Int = 101;
      localbmpz.jdField_a_of_type_JavaLangString = "分类";
      localbmpz.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_u3wddLskp6.png";
      localbmpz.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_xYKQeprMCg.png";
      localArrayList = new ArrayList(1);
      localArrayList.add(a("https://cdn.vip.qq.com/club/client/read/6/rel/category_index.html?configfrom=local&_bid=2036"));
      localbmpz.jdField_a_of_type_JavaUtilArrayList = localArrayList;
      this.jdField_a_of_type_JavaUtilArrayList.add(localbmpz);
      localbmpz = new bmpz();
      localbmpz.jdField_a_of_type_Int = 102;
      localbmpz.jdField_a_of_type_JavaLangString = "书架";
      localbmpz.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_G6VUELHdgC.png";
      localbmpz.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_f9xtLKYkBV.png";
      localArrayList = new ArrayList(2);
      ...
      this.jdField_a_of_type_JavaUtilArrayList.add(localbmpz);
      localbmpz = new bmpz();
      localbmpz.jdField_a_of_type_Int = 104;
      localbmpz.jdField_a_of_type_JavaLangString = "我的";
      localbmpz.jdField_b_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190604150617_XAeQPgB9Z8.png";
      localbmpz.jdField_c_of_type_JavaLangString = "https://qzonestyle.gtimg.cn/aoi/sola/20190603213616_wdBlMCyKuS.png";
      localArrayList = new ArrayList(1);
  ...
  private void f()
  {
    ...
    {
      bmqw.a("ReaderTabConfigDataHelper", "getTabConfigDataFromDB," + localJSONException.getMessage());
    }
  }
  ...
  public String d()
  {
    ...
    return "&height=" + (bhgr.b(this.jdField_a_of_type_AndroidContentContext, i) + 50);
  }
}
