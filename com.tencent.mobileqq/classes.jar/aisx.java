  ...
  implements bbwl, INetInfoHandler
{
  ...
  public aisx(AppRuntime paramAppRuntime, bbwk parambbwk)
  {
    ...
    try
    {
      if (!this.jdField_a_of_type_JavaUtilLinkedList.isEmpty())
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("ApolloQueue_Downloader", 2, "getTask | " + paramString + " task find =" + localbbwg);
            }
            return localbbwg;
          }
        }
  ...
  public void a()
  {
    for (;;)
    {
      try
      {
        synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
        {
          ...
          if ((!localbbwg2.a()) && (l > localbbwg2.c + localbbwg2.d))
          {
            ...
            QLog.d("ApolloQueue_Downloader", 2, "remove task[" + localbbwg2.jdField_a_of_type_JavaLangString + "], isCancal=" + localbbwg2.b() + ", timeOut=" + bool);
          }
        }
        bool = false;
      }
      ...
      for (;;)
      {
        ...
        return;
        label288:
        ThreadManager.postDownLoadTask(new ApolloQueueDownloader.1(this, localbbwg1), 2, null, false);
  ...
  public void a(bbwg parambbwg)
  {
    ...
    try
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("ApolloQueue_Downloader", 2, "removeTask | task=" + parambbwg);
        }
        parambbwg.i();
  ...
  public void a(bbwg parambbwg, bbwf arg2, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
      {
        ...
        if (paramBundle == null)
        {
          ...
          if (parambbwg.b)
          {
            ...
            if ((parambbwg.jdField_a_of_type_JavaUtilList != null) && (parambbwg.jdField_a_of_type_JavaUtilList.size() != 0)) {
              break label328;
            }
            ??? = null;
            if (QLog.isColorLevel()) {
              QLog.d("ApolloQueue_Downloader", 2, new Object[] { "startDownload | task=" + parambbwg.jdField_a_of_type_JavaLangString, ", url:", ??? });
            }
            a();
            return;
          }
      ...
      if ((parambbwg.b) && (!paramBundle.a()) && (this.jdField_a_of_type_JavaUtilLinkedList.remove(paramBundle)))
      {
        ...
        continue;
        label328:
        ??? = (String)parambbwg.jdField_a_of_type_JavaUtilList.get(0);
      }
    }
  }
