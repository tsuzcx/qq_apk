  ...
  implements View.OnClickListener
{
  ...
  public aipi(SigCommentListActivity paramSigCommentListActivity, QQAppInterface paramQQAppInterface, XListView paramXListView, View paramView)
  {
  ...
  {
    if (this.b != null) {
      ((aipj)this.b.getTag()).jdField_a_of_type_AndroidWidgetTextView.setText(paramInt);
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      if (1 == i)
      {
        ...
        if (paramView == null)
        {
          paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562443, this.jdField_a_of_type_ComTencentWidgetXListView, false);
          paramViewGroup = new aipk();
          paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131376191));
          paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131376192));
          paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131376189));
          paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131376190));
          paramViewGroup.c = ((TextView)paramView.findViewById(2131376193));
          paramView.setTag(paramViewGroup);
          localSigCommentInfo = a(paramInt);
          localObject = String.valueOf(localSigCommentInfo.uin);
          bayh localbayh = bayh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, (String)localObject);
          if (localbayh != null) {
            paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(localbayh);
          }
          localObject = bbcz.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject);
          paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject);
          paramViewGroup.jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130848968);
        ...
        for (Object localObject = ajya.a(2131714114) + (String)localObject;; localObject = ajya.a(2131714111) + (String)localObject)
        {
          ...
          return paramView;
          paramViewGroup = (aipk)paramView.getTag();
          break;
        }
      }
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561646, this.jdField_a_of_type_ComTencentWidgetXListView, false);
      paramView.setOnClickListener(this);
      paramViewGroup = new aipj();
      paramView.setTag(paramViewGroup);
      paramView.findViewById(2131369480).setVisibility(8);
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370442));
      this.b = paramView;
    }
    for (;;)
    {
      return this.b;
      paramView = (aipj)paramView.getTag();
    }
  }
