  ...
  extends bebk
{
  ...
  public bixp(beey parambeey)
  {
    super(parambeey);
    this.jdField_a_of_type_AndroidAppActivity = parambeey.jdField_a_of_type_AndroidAppActivity;
    ...
    if (this.jdField_a_of_type_Befb.jdField_a_of_type_Int != i) {
      g(i);
    }
    this.jdField_g_of_type_JavaLangString = bdcb.a(this.jdField_a_of_type_AndroidAppActivity).jdField_a_of_type_JavaLangString;
    this.h = bixj.a(this.jdField_a_of_type_AndroidAppActivity);
  }
  ...
  private ImageView a(int paramInt, String paramString, View.OnClickListener paramOnClickListener)
  {
    if ((this.jdField_a_of_type_AndroidWidgetImageView != null) && (this.jdField_a_of_type_AndroidWidgetImageView.getVisibility() == 0))
    {
      ...
      ((RelativeLayout.LayoutParams)localObject).leftMargin = (((RelativeLayout.LayoutParams)localObject).width + bcwh.a(this.jdField_a_of_type_AndroidAppActivity, 13.0F));
  ...
  {
    paramRadioButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130846456));
  ...
  private boolean d()
  {
    ...
    {
      bixe.e("ReaderTitleBarView", bool);
      if (100 != this.jdField_f_of_type_Int) {
        break;
      }
      return true;
  ...
  private void i(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidWidgetTextView == null) {
      bixe.a("ReaderTitleBarView", "leftView is null");
    }
    ...
    do
    {
      ...
      localDrawable = bdda.a(localDrawable, paramInt);
    } while (localDrawable == null);
  ...
  private void j()
  {
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      localRadioButton.setId(2131373872);
      localLayoutParams = new ViewGroup.LayoutParams(bcwh.a(this.jdField_a_of_type_AndroidAppActivity, 68.0F), bcwh.a(this.jdField_a_of_type_AndroidAppActivity, 34.0F));
      a(localRadioButton, true);
      localRadioButton.setText(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131717552));
      ...
      localRadioButton.setId(2131373873);
      a(localRadioButton, false);
      localRadioButton.setText(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131717554));
      this.jdField_a_of_type_AndroidWidgetRadioGroup.addView(localRadioButton, localLayoutParams);
    }
    this.jdField_a_of_type_AndroidWidgetRadioGroup.setOnCheckedChangeListener(new bixr(this));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.removeAllViews();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(this.jdField_a_of_type_AndroidWidgetLinearLayout, new ViewGroup.LayoutParams(bcwh.a(this.jdField_a_of_type_AndroidAppActivity, 186.0F), bcwh.a(this.jdField_a_of_type_AndroidAppActivity, 44.0F)));
  }
  ...
  private void j(int paramInt)
  {
    ...
    if ((!TextUtils.isEmpty(this.e)) && (!TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString))) {
      ...
      default: 
        ...
        if (this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) {
          this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_ComTencentBizUiTouchWebView.loadUrl(str);
        }
        break;
      }
    }
    for (int i = paramInt;; i = 0)
    {
      k(i);
      return;
      bixh.a(this.jdField_g_of_type_JavaLangString, this.h, "5", "502", "", "3", "", "", "");
      str = this.e;
      paramInt = 0;
      break;
      bixh.a(this.jdField_g_of_type_JavaLangString, this.h, "5", "2206", "", "3", "", "", "");
      paramInt = 1;
  ...
  public void a(Intent paramIntent, String paramString)
  {
    ...
    this.jdField_a_of_type_Befb.jdField_a_of_type_JavaLangString = null;
    super.a(paramIntent, paramString);
    if (d())
    {
      a(this.jdField_a_of_type_Befb.jdField_a_of_type_OrgJsonJSONObject, false);
      if ((this.jdField_a_of_type_Beey.a() != null) && (!this.jdField_a_of_type_Befb.jdField_a_of_type_Boolean))
      {
        this.jdField_a_of_type_Befb.s = true;
        a(this.jdField_a_of_type_Beey.a());
      }
    }
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130849989));
    int i;
    int j;
    int k;
    int m;
    ...
    if (d())
    {
      ...
      bixj.a(this.jdField_a_of_type_AndroidViewViewGroup, ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidAppActivity));
      if (this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null)
      {
        j = this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getResources().getDimensionPixelSize(2131298914);
        if (!d()) {
          break label665;
        }
        bixj.a(this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebBrowserViewContainer, -i);
        this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.p = true;
        this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.q = true;
        if (this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d != null)
        {
          if (!ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().getRuntime(), false, null)) {
            break label705;
          }
          this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d.setBackgroundColor(-6710887);
          localObject = this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.a().getWindow();
          if (d()) {
            break label783;
          }
          bool = true;
      ...
      localDrawable = this.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130846434);
      if (!d()) {
        break label789;
      }
      localObject = bdda.a(localDrawable, -1);
      label522:
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131694343));
      label551:
    ...
    for (;;)
    {
      if (this.jdField_c_of_type_AndroidViewView == null) {
        this.jdField_c_of_type_AndroidViewView = a(2130846435, this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131717553), new bixq(this));
      }
      return;
      f(-16777216);
      d(-16777216);
      ...
      break label311;
      label665:
      if (!(this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment instanceof ReaderHomeTabFragment)) {
        break label361;
      }
      bixj.a(this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_ComTencentBizUiTouchWebView, -j - ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidAppActivity));
      break label361;
      label705:
      this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d.setBackgroundColor(-1);
      ...
      localObject = bdda.a(localDrawable, this.jdField_a_of_type_Befb.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle.e);
      break label522;
      label823:
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      break label551;
      label835:
      bixe.a("ReaderTitleBarView", "mTitleBarLeftTabUrl=" + this.e + ",mTitleBarRightTabUrl=" + this.jdField_f_of_type_JavaLangString);
    }
  }
  ...
  public void h(int paramInt)
  {
    if (paramInt > 0)
    {
      ...
      Window localWindow = this.jdField_a_of_type_Beey.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.a().getWindow();
      a(d(), localWindow);
    }
  }
}
