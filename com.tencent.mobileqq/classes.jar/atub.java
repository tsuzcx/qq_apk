...
public class atub
{
  ...
  public static Pair<atts, List<PrecoverResource>> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((localObject4 == null) || (!((atts)localObject4).a()) || (localArrayList.size() <= 0)) {
        break;
      }
      ...
      while (paramString.hasNext())
      {
        ...
        if (localObject1 != null) {
          ((PrecoverResource)localObject1).businessId = ((atts)localObject4).a;
        }
      }
      localObject3 = paramString;
  ...
  {
    if (azzu.a()) {
      return ajed.aU + "pddata/prd/" + "res_precover";
    }
