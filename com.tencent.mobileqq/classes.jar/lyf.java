...
public class lyf
  implements Runnable
{
  public lyf(ReadInJoyDeliverUGCActivity paramReadInJoyDeliverUGCActivity, String paramString) {}
  ...
  public void run()
  {
    ...
    if (!((File)localObject1).exists())
    {
      ...
      ReadInJoyDeliverUGCActivity.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcReadInJoyDeliverUGCActivity, 1, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcReadInJoyDeliverUGCActivity.getString(2131438884));
