  ...
  implements GestureDetector.OnGestureListener
{
  ...
  private mlf(VideoLayerUI paramVideoLayerUI) {}
  ...
  public boolean onScroll(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2, float paramFloat1, float paramFloat2)
  {
    ...
    {
      axqw.b(null, "CliOper", "", "", "0X8009F62", "0X8009F62", 0, 0, "", "", "", "");
  ...
  public boolean onSingleTapUp(MotionEvent paramMotionEvent)
  {
    ...
    if (VideoLayerUI.e(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI))
    {
      ...
      paramMotionEvent = this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMee[0];
      ...
      if (((ArrayList)localObject1).size() > VideoLayerUI.f(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI))
      {
        ...
        axqw.b(null, "CliOper", "", "", "0X800A069", "0X800A069", 0, 0, "", "", "", "");
      ...
      localObject2 = (mlj)((ArrayList)localObject1).get(j + 1);
      label578:
      label597:
      if (localObject2 != null)
      {
        bool = ((mlj)localObject2).c();
        if (localObject2 == null) {
          break label668;
        }
        if ((!str.equalsIgnoreCase(String.valueOf(((mlj)localObject2).jdField_a_of_type_Long))) || (((mlj)localObject2).b() != k)) {
          break label663;
        }
        i = 1;
        label362:
        ...
        {
          if ((this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_Miw.a()) && (bool))
          {
            axqw.b(null, "CliOper", "", "", "0X8009F63", "0X8009F63", 0, 0, "", "", "", "");
            str = paramMotionEvent.b();
            i = Integer.valueOf(paramMotionEvent.h()).intValue();
            long l = ((mlj)localObject2).jdField_a_of_type_Long;
            k = Integer.valueOf(((mlj)localObject2).b()).intValue();
          ...
          if (!bool)
          {
            if (!((mlj)localObject2).a()) {
              break label696;
            }
            if (((mlj)localObject2).a() != this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getLongAccountUin()) {
              break label673;
            }
            bool = true;
            if (!bool) {
            ...
            mat.a(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1051);
      ...
      for (;;)
      {
        axqw.b(null, "CliOper", "", "", "0X800A068", "0X800A068", 0, 0, "", "", "", "");
        return true;
        bool = false;
        break;
        label663:
        ...
        break label578;
        label679:
        mat.a(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1052);
        break label597;
        label696:
        mat.a(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1053);
    ...
    {
      i = j + 1;
      if ((this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMee == null) || (i <= 0) || (i >= this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMee.length)) {
        return true;
      }
      localObject2 = this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMee[0];
      paramMotionEvent = this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_ArrayOfMee[i];
      if ((localObject2 == null) || (paramMotionEvent == null)) {
        return true;
      }
      if (this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_Miw.a())
      {
        axqw.b(null, "CliOper", "", "", "0X8009F63", "0X8009F63", 0, 0, "", "", "", "");
        localObject1 = ((mee)localObject2).b();
        j = Integer.valueOf(((mee)localObject2).h()).intValue();
      ...
      QLog.d(this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_JavaLangString, 1, "condition print onSingleTapUp mTargetIndex:=" + this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.q + ",canSwitchView=" + this.jdField_a_of_type_ComTencentAvUiVideoLayerUI.jdField_a_of_type_Miw.a());
    }
    for (;;)
    {
      return true;
