  ...
  extends lef
{
  ...
  protected void a(long paramLong1, long paramLong2)
  {
    ...
    this.a.jdField_a_of_type_Lff.al = true;
  ...
  protected void a(long paramLong, ArrayList<lcv> paramArrayList, int paramInt1, int paramInt2)
  {
    ...
    while (paramArrayList.hasNext()) {
      if (String.valueOf(((lcv)paramArrayList.next()).jdField_a_of_type_Long).equalsIgnoreCase(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getAccount())) {
        this.a.a();
      }
    }
  }
  ...
  protected void b(long paramLong1, long paramLong2)
  {
    ...
    lzf.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface).a(paramLong1, false);
