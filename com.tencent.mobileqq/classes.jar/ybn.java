...
public class ybn
  extends QIPCModule
{
  private static ybn a;
  public long a;
  public SparseArray<ArtFilterUploadProcessor> a;
  public String a;
  public ybp a;
  public String b;
  ...
  public static String a()
  {
    ...
    if (!((ArtFilterManager)localObject1).a)
    {
    ...
    if (localObject2 != null)
    {
      ...
      {
        JSONObject localJSONObject = ((ybi)((Iterator)localObject2).next()).a();
  ...
  public static ybn a()
  {
    if (jdField_a_of_type_Ybn == null) {}
    try
    {
      if (jdField_a_of_type_Ybn == null) {
        jdField_a_of_type_Ybn = new ybn();
      }
      return jdField_a_of_type_Ybn;
    }
    finally {}
  }
  ...
  public ArtFilterUploadProcessor a()
  {
    ...
    localTransferRequest.mUinType = 0;
    localTransferRequest.mPeerUin = "";
    localTransferRequest.mIsUp = true;
    localTransferRequest.needSendMsg = false;
    return new ArtFilterUploadProcessor(((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getTransFileController(), localTransferRequest, this.jdField_a_of_type_JavaLangString);
  }
  ...
  public void a()
  {
    ...
    {
      ((ArtFilterUploadProcessor)this.jdField_a_of_type_AndroidUtilSparseArray.valueAt(i)).cancel();
      i += 1;
    }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("action_img_preupload".equals(paramString))
    {
      ...
      a();
      this.jdField_a_of_type_Ybp = ybp.a(paramString, l1);
      if (QLog.isColorLevel()) {
        QLog.d("ArtFilterModule", 2, "ACTION_IMG_PREUPLOAD:  currentFilterImgPath:" + this.b + " currentFilterUploadProcessors:" + this.jdField_a_of_type_AndroidUtilSparseArray + "\n currentFilterUploadInfo:" + this.jdField_a_of_type_Ybp);
      }
      a().begin(paramInt, -1, "", 0, this.jdField_a_of_type_Ybp, true);
    }
    for (;;)
    {
      return null;
      if ("action_get_art_filter_path".equals(paramString))
      {
        ...
        if ((this.b != null) && (this.b.equals(str)))
        {
          if (this.jdField_a_of_type_AndroidUtilSparseArray.get(i) == null)
          {
            ...
            {
              if (this.jdField_a_of_type_Ybp == null) {
                this.jdField_a_of_type_Ybp = ybp.a(str, l1);
              }
              paramBundle = a();
              paramBundle.reportKey("current_TaskCount", String.valueOf(this.jdField_a_of_type_AndroidUtilSparseArray.size()));
              paramBundle.begin(paramInt, i, paramString, j, this.jdField_a_of_type_Ybp, bool1);
        ...
        else
        {
          ...
          paramBundle = a();
          this.jdField_a_of_type_AndroidUtilSparseArray.put(i, paramBundle);
          paramBundle.begin(paramInt, i, paramString, j, this.jdField_a_of_type_Ybp, true);
        }
      }
      else if ("action_cancel_art_filter_task".equals(paramString))
      {
        ...
        {
          ((ArtFilterUploadProcessor)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt)).cancel();
      ...
      else if ("action_exit_art_filter".equals(paramString))
      {
        a(true);
        a();
        this.jdField_a_of_type_Ybp = null;
      }
    }
  }
}
