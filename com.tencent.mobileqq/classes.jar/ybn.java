  ...
  extends BaseShortVideoOprerator
{
  ...
  public ybn(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  private void b(axey paramaxey)
  {
    ThreadManager.getSubThreadHandler().post(new DevShortVideoOperator.1(this, paramaxey));
  }
  ...
  public int a()
  {
    ...
    //   12: aconst_null
    //   13: aload_0
    //   14: getfield 47	ybn:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   147: putfield 80	ybn:jdField_b_of_type_Int	I
    //   150: aload_0
    //   151: aload 10
    //   153: invokevirtual 83	android/graphics/Bitmap:getHeight	()I
    //   156: putfield 85	ybn:jdField_c_of_type_Int	I
    //   159: new 87	java/io/File
    //   162: dup
    //   163: aload_0
    //   164: getfield 47	ybn:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   167: invokespecial 90	java/io/File:<init>	(Ljava/lang/String;)V
    //   170: astore_2
    //   171: aload_0
    //   172: aload_2
    //   173: invokevirtual 94	java/io/File:length	()J
    //   176: putfield 96	ybn:jdField_a_of_type_Long	J
    ...
    //   189: aload_3
    //   190: aload_0
    //   191: getfield 96	ybn:jdField_a_of_type_Long	J
    ...
    //   200: putfield 115	ybn:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   203: aload_0
    //   204: getfield 115	ybn:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   234: aload_0
    //   235: getfield 115	ybn:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   281: ireturn
    //   282: aload_0
    //   283: getfield 115	ybn:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   286: ldc 139
    ...
    //   314: invokestatic 150	bbdx:c	(Ljava/lang/String;)V
    ...
    //   433: putfield 186	ybn:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   436: aload_0
    //   437: getfield 186	ybn:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   467: aload_0
    //   468: getfield 186	ybn:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   511: aload_0
    //   512: aload_0
    //   513: getfield 186	ybn:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    //   516: ldc 139
    ...
    //   521: putfield 191	ybn:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   524: aload 9
    //   526: aload_0
    //   527: getfield 191	ybn:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   530: invokestatic 194	bbdx:c	(Ljava/lang/String;Ljava/lang/String;)Z
    //   533: istore_1
    //   534: iload_1
    //   535: ifne +34 -> 569
    //   538: aload_3
    ...
    //   568: ireturn
    //   569: aload_0
    //   570: getfield 196	ybn:jdField_b_of_type_Long	J
    //   573: lconst_0
    //   574: lcmp
    //   575: ifne +14 -> 589
    //   578: aload_0
    //   579: aload_0
    //   580: getfield 47	ybn:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   583: invokestatic 199	com/tencent/mobileqq/shortvideo/ShortVideoUtils:a	(Ljava/lang/String;)J
    //   586: putfield 196	ybn:jdField_b_of_type_Long	J
    //   589: aload_3
    //   590: ifnull +7 -> 597
    //   593: aload_3
    ...
    //   326	776	8	localObject22	Object
  ...
  public axey a(Object paramObject, axei paramaxei)
  {
    ...
    {
      a();
      localObject = new axey();
      ((axey)localObject).jdField_c_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
      ((axey)localObject).h = this.jdField_a_of_type_JavaLangString;
      ((axey)localObject).j = this.jdField_d_of_type_JavaLangString;
      ((axey)localObject).jdField_b_of_type_Int = this.jdField_a_of_type_Int;
      ((axey)localObject).jdField_d_of_type_JavaLangString = "";
      ((axey)localObject).jdField_e_of_type_Int = ((int)this.jdField_a_of_type_Long);
      ((axey)localObject).f = ((int)this.jdField_b_of_type_Long / 1000);
      ((axey)localObject).jdField_e_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
      ((axey)localObject).jdField_c_of_type_Int = this.jdField_b_of_type_Int;
      ((axey)localObject).jdField_d_of_type_Int = this.jdField_c_of_type_Int;
      ((axey)localObject).jdField_g_of_type_Int = paramaxei.jdField_a_of_type_Int;
      ((axey)localObject).jdField_a_of_type_JavaLangObject = paramObject;
      ((axey)localObject).jdField_g_of_type_JavaLangString = this.jdField_e_of_type_JavaLangString;
      ((axey)localObject).l = "";
  ...
  public MessageRecord a(axey paramaxey)
  {
    ...
    MessageForDevShortVideo localMessageForDevShortVideo = (MessageForDevShortVideo)axas.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramaxey.jdField_c_of_type_JavaLangString, paramaxey.jdField_d_of_type_JavaLangString, paramaxey.jdField_b_of_type_Int);
    localMessageForDevShortVideo.videoFileName = paramaxey.h;
    if (paramaxey.jdField_a_of_type_JavaLangString == null) {
      paramaxey.jdField_a_of_type_JavaLangString = "";
    }
    localMessageForDevShortVideo.uuid = paramaxey.jdField_a_of_type_JavaLangString;
    if (paramaxey.jdField_e_of_type_JavaLangString == null) {
      paramaxey.jdField_e_of_type_JavaLangString = "";
    }
    localMessageForDevShortVideo.md5 = paramaxey.jdField_e_of_type_JavaLangString;
    localMessageForDevShortVideo.videoFileFormat = 2;
    localMessageForDevShortVideo.videoFileSize = paramaxey.jdField_e_of_type_Int;
    localMessageForDevShortVideo.videoFileTime = paramaxey.f;
    localMessageForDevShortVideo.thumbWidth = paramaxey.jdField_c_of_type_Int;
    localMessageForDevShortVideo.thumbHeight = paramaxey.jdField_d_of_type_Int;
    ...
    localMessageForDevShortVideo.thumbMD5 = paramaxey.jdField_g_of_type_JavaLangString;
    localMessageForDevShortVideo.extraflag = 32772;
    if (paramaxey.l == null) {
      paramaxey.l = "";
    }
    localMessageForDevShortVideo.fileSource = paramaxey.l;
    ...
    if (i != 0)
    {
      localMessageForDevShortVideo.msgseq = paramaxey.jdField_a_of_type_Axez.jdField_a_of_type_Long;
      localMessageForDevShortVideo.shmsgseq = paramaxey.jdField_a_of_type_Axez.jdField_b_of_type_Long;
      localMessageForDevShortVideo.msgUid = paramaxey.jdField_a_of_type_Axez.c;
    }
    localMessageForDevShortVideo.msg = localMessageForDevShortVideo.getSummary();
    localMessageForDevShortVideo.serial();
    paramaxey.jdField_a_of_type_Long = localMessageForDevShortVideo.uniseq;
    aung.a(this.jdField_g_of_type_JavaLangString, this.f, "packmsg", "cost:" + (System.currentTimeMillis() - l));
    aung.a(this.jdField_g_of_type_JavaLangString, this.f, "packMsg", "mr: " + localMessageForDevShortVideo.toLogString() + "-" + localMessageForDevShortVideo.toString());
    return localMessageForDevShortVideo;
  }
  
  public MessageRecord a(im_msg_body.RichText paramRichText)
  {
    aung.a(this.jdField_g_of_type_JavaLangString, this.f, "attachRichText2Msg", "");
  ...
  {
    aung.a(this.jdField_g_of_type_JavaLangString, this.f, "updateMsg", "resut:" + paramauor);
    if (paramauor != null)
    {
