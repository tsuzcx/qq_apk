...
public class ltg
  implements Handler.Callback, ltm
{
  public int a;
  public Handler a;
  ...
  public ltg(VideoAppInterface paramVideoAppInterface, AVActivity paramAVActivity)
  {
  ...
  {
    ViewGroup localViewGroup = (ViewGroup)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131365722);
    Object localObject1 = null;
    Object localObject2;
    View localView;
    if (localViewGroup != null)
    {
      localObject2 = (RedPacketGameView)localViewGroup.findViewById(2131373487);
      ...
      if (localObject2 == null)
      {
        ...
        localView = localViewGroup.findViewById(2131373455);
        if (localView == null) {
          break label128;
        }
      }
  ...
  {
    ViewGroup localViewGroup = (ViewGroup)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131365722);
    RedPacketGameView localRedPacketGameView = (RedPacketGameView)localViewGroup.findViewById(2131373487);
  ...
  public void a(int paramInt)
  {
    ...
    c();
    RedPacketGameView localRedPacketGameView = (RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131373487);
  ...
  public void a(int paramInt, ltn paramltn)
  {
    if (QLog.isColorLevel()) {
    ...
    catch (Exception paramltn)
    {
      if (QLog.isColorLevel()) {
        QLog.d("AVRedPacketManager", 2, "AVRedPacketGameControl.preLoadRes  exception", paramltn);
      }
    }
  }
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    {
      return;
      localRedPacketGameView = (RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131373487);
  ...
  public boolean a()
  {
    Object localObject = (RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131373487);
  ...
  public void b()
  {
    ...
    ((RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131373487)).d();
  }
  ...
  public void b(AVRedPacketManager.LocalFrameSyncInfo paramLocalFrameSyncInfo)
  {
    ...
    ((RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131373487)).b(paramLocalFrameSyncInfo);
  }
