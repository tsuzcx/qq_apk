...
public class bgdi
  implements bivj
{
  private bgdj jdField_a_of_type_Bgdj;
  private String jdField_a_of_type_JavaLangString;
  
  public bgdi(String paramString, bgdj parambgdj)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_Bgdj = parambgdj;
  }
  ...
  public int a(String paramString1, int paramInt, String paramString2, Bundle paramBundle)
  {
    ...
    if (paramString1.equals(BaseApplicationImpl.sApplication.getPackageName()))
    {
      ...
      for (;;)
      {
        if (this.jdField_a_of_type_Bgdj != null) {
          this.jdField_a_of_type_Bgdj.a(paramInt);
        }
        ...
        else
        {
          try
          {
            ...
            bkdn.a(paramBundle, this.jdField_a_of_type_JavaLangString);
  ...
  public void a(String paramString, int paramInt, Bundle paramBundle)
  {
    if (BaseApplicationImpl.sApplication.getPackageName().equals(paramString))
    {
      ...
      if ((this.jdField_a_of_type_Bgdj != null) && (!this.jdField_a_of_type_Bgdj.a(paramInt))) {
