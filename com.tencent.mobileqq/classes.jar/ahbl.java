  ...
  implements View.OnClickListener
{
  ...
  public ahbl(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
    super(paramQQAppInterface, paramBaseAdapter, paramContext, paramSessionInfo);
    this.jdField_e_of_type_Int = -2143248129;
    this.jdField_a_of_type_Int = ((int)paramContext.getResources().getDimension(2131298118));
    this.c = ((int)paramContext.getResources().getDimension(2131298277));
  ...
  private View a(View paramView, ahbn paramahbn)
  {
    View localView = paramView;
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558869, null);
      paramahbn.c = ((TextView)paramView.findViewById(2131371803));
      paramahbn.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131368381));
      paramahbn.d = ((TextView)paramView.findViewById(2131365513));
      paramahbn.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131379001));
      paramahbn.e = ((TextView)paramView.findViewById(2131378963));
      paramahbn.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131365253));
      paramahbn.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView = ((CornerImageView)paramView.findViewById(2131365254));
    }
    try
    {
      paramahbn.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView.setImageResource(2130845373);
      paramahbn.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView.setRadius(AIOUtils.dp2px(3.0F, paramahbn.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView.getResources()));
      paramahbn.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView.setPressMask(true);
      Object localObject = paramahbn.jdField_b_of_type_AndroidWidgetTextView.getCompoundDrawables();
      ...
      {
        paramahbn.jdField_b_of_type_JavaLangStringBuilder = new StringBuilder();
        localView = paramView;
      }
      if (jdField_e_of_type_Boolean)
      {
        localView.setContentDescription(null);
        paramahbn.jdField_b_of_type_JavaLangStringBuilder.replace(0, paramahbn.jdField_b_of_type_JavaLangStringBuilder.length(), "");
        paramahbn.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelCornerImageView.setContentDescription(null);
      }
      return localView;
    }
  ...
  private void a(ahbn paramahbn)
  {
    if (paramahbn.jdField_a_of_type_ComTencentMobileqqDataMessageForMedalNews.myLevel == 0) {}
    for (int i = 0;; i = 8)
    {
      if (paramahbn.e.getVisibility() != i) {
        paramahbn.e.setVisibility(i);
      }
      Object localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131698629);
      if (!((String)localObject).equalsIgnoreCase(paramahbn.e.getText().toString()))
      {
        localObject = new SpannableString((CharSequence)localObject);
        ((SpannableString)localObject).setSpan(new aryx(new ahbm(this), this.jdField_a_of_type_AndroidContentResColorStateList), 11, 14, 33);
        paramahbn.e.setText((CharSequence)localObject);
        paramahbn.e.setMovementMethod(LinkMovementMethod.getInstance());
      }
      return;
    }
  }
  
  private void a(ahbn paramahbn, int paramInt)
  {
    int j;
    int i;
    switch (paramInt)
    ...
    default: 
      j = 2130845385;
      i = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166428);
      this.jdField_a_of_type_AndroidGraphicsColorFilter = new PorterDuffColorFilter(i, PorterDuff.Mode.SRC_IN);
      Object localObject2 = paramahbn.jdField_b_of_type_AndroidWidgetTextView.getCompoundDrawables();
      ...
      paramahbn.jdField_a_of_type_AndroidWidgetImageView.setColorFilter(this.jdField_a_of_type_AndroidGraphicsColorFilter);
      paramahbn.jdField_b_of_type_AndroidWidgetTextView.setTextColor(i);
      paramahbn.c.setTextColor(i);
      paramahbn.d.setTextColor(i);
      if (paramInt <= 3)
      {
        paramahbn.jdField_a_of_type_AndroidWidgetImageView.setImageResource(j);
        paramahbn.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      break;
    }
    for (;;)
    {
      paramahbn.jdField_a_of_type_AndroidWidgetImageView.setTag(Integer.valueOf(paramInt));
      return;
      j = 2130845383;
      i = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166426);
      break;
      j = 2130845384;
      i = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166430);
      break;
      paramahbn.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
    }
  }
  ...
  private void a(String paramString1, String paramString2, int paramInt1, int paramInt2, long paramLong1, long paramLong2)
  {
    if ((paramLong1 == 0L) || (paramLong2 == 0L)) {
      a(bhbx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString1), paramString1);
    }
    String str;
    do
    {
      ...
      paramString2 = awvb.a(new String[] { paramInt2 + "", paramInt1 + "", paramString1, str });
    ...
    for (;;)
    {
      try
      {
        paramString1 = awvb.a(Long.valueOf(1000L * paramLong1)).substring(0, 4);
  ...
  {
    paramaftk = (MessageForMedalNews)paramMessageRecord;
    paramLinearLayout = (ahbn)paramafos;
    paramView = a(paramView, paramLinearLayout);
    paramLinearLayout.jdField_a_of_type_Long = paramaftk.uniseq;
    paramLinearLayout.jdField_a_of_type_JavaLangString = paramaftk.frienduin;
    paramLinearLayout.jdField_a_of_type_ComTencentMobileqqDataMessageForMedalNews = paramaftk;
    int n = paramaftk.level;
    paramMessageRecord = paramaftk.name;
    paramafos = paramaftk.desc;
    paramaftk = paramaftk.icon;
    int i = 1;
    int k = 1;
    int m = 1;
    ...
    if (localObject != null)
    {
      ...
      {
        k = m;
        if (paramaftk.equalsIgnoreCase((String)localObject)) {
          k = 0;
        }
      }
    }
    if (j != 0)
    {
      ...
      localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131698628, new Object[] { localObject });
    ...
    for (;;)
    {
      if (!paramLinearLayout.d.getText().equals(paramafos)) {
        paramLinearLayout.d.setText(paramafos);
      }
      if (k != 0)
      {
        paramafos = a(paramaftk);
        ...
        paramLinearLayout.jdField_a_of_type_ComTencentImageURLImageView.setTag(paramaftk);
      }
      if (i != 0) {
  ...
  {
    ahbn localahbn = (ahbn)paramView.getTag();
    if (localahbn == null) {}
    for (;;)
    {
      EventCollector.getInstance().onViewClicked(paramView);
      return;
      ThreadManager.postImmediately(new MedalNewsItemBuilder.2(this, localahbn.jdField_a_of_type_ComTencentMobileqqDataMessageForMedalNews), null, true);
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0x8009434", "0x8009434", 0, 0, "", "4", "", "");
    }
  }
}
