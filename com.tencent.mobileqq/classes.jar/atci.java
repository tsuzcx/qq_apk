...
public class atci
{
  ...
  private static asxh jdField_a_of_type_Asxh;
  private static atci jdField_a_of_type_Atci;
  ...
  public static atci a()
  {
    if (jdField_a_of_type_Atci == null) {
      jdField_a_of_type_Atci = new atci();
    }
    return jdField_a_of_type_Atci;
  }
  ...
  public static String a(asxh paramasxh)
  {
    asxi localasxi = null;
    Object localObject1 = "";
    if (paramasxh != null) {
      if ((paramasxh.mSchoolInfos == null) || (paramasxh.mSchoolInfos.isEmpty())) {
        break label224;
      }
    }
    label224:
    for (localObject1 = (asxj)paramasxh.mSchoolInfos.get(0);; localObject1 = null)
    {
      long l;
      if (localObject1 != null)
      {
        l = ((asxj)localObject1).a;
        localObject1 = ((asxj)localObject1).jdField_b_of_type_JavaLangString;
      }
      for (String str = String.valueOf(l);; str = null)
      {
        Object localObject2 = localasxi;
        if (paramasxh.mLabelInfos != null)
        {
          localObject2 = localasxi;
          if (!paramasxh.mLabelInfos.isEmpty())
          {
            localObject2 = new StringBuilder();
            paramasxh = paramasxh.mLabelInfos.iterator();
            int i = 1;
            if (paramasxh.hasNext())
            {
              localasxi = (asxi)paramasxh.next();
              if (i != 0)
              {
                ((StringBuilder)localObject2).append(localasxi.jdField_a_of_type_JavaLangString);
                i = 0;
              }
              for (;;)
              {
  ...
  public static void a(int paramInt1, int paramInt2, String paramString1, String paramString2, asxh paramasxh)
  {
    jdField_a_of_type_Int = paramInt1;
    jdField_b_of_type_Int = paramInt2;
    jdField_a_of_type_JavaLangString = paramString1;
    jdField_b_of_type_JavaLangString = paramString2;
    jdField_a_of_type_Asxh = paramasxh;
  }
  ...
  {
    bdll.a(null, "dc00898", "", paramString1, "0X800AD9A", "0X800AD9A", paramInt, 0, paramString2, paramString3, paramString4, paramString5);
  }
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      bdll.b(null, "dc00898", "", "", "0X800A68C", "0X800A68C", paramInt, 0, "", "", str, (String)localObject);
      return;
      str = "";
    }
  }
