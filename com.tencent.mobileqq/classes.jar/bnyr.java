...
{
  public bnyr(AEEditorVideoEditFragment paramAEEditorVideoEditFragment) {}
  ...
  public void onDeleteButtonClick(String paramString)
  {
    ...
    this.a.p();
    bnrh.a(AEEditorVideoEditFragment.f(), "[onDeleteButtonClick]textEditorData = null");
  }
  ...
  public void onStickerOutsideClick()
  {
    this.a.j();
    this.a.jdField_a_of_type_ComTencentTavcutBeanTextEditorData = null;
    bnrh.a(AEEditorVideoEditFragment.f(), "[onStickerOutsideClick]textEditorData = null");
  }
  ...
  public void onTextEditButtonClick(TextEditorData paramTextEditorData)
  {
    ...
    this.a.jdField_a_of_type_Bocp.a(this.a.getActivity(), paramTextEditorData, this.a.jdField_a_of_type_ComTencentTavcutSessionTAVCutVideoSession);
  ...
  public void onUpdateTextStickerDone(String paramString)
  {
    if (this.a.jdField_a_of_type_ComTencentTavcutBeanTextEditorData != null)
    {
      this.a.jdField_a_of_type_ComTencentTavcutBeanTextEditorData.setUniqueID(paramString);
      this.a.a(this.a.jdField_a_of_type_ComTencentTavcutBeanTextEditorData);
      bnrh.d(AEEditorVideoEditFragment.f(), "[onUpdateTextStickerDone] uniqueId:" + paramString);
      return;
    }
    bnrh.d(AEEditorVideoEditFragment.f(), "[onUpdateTextStickerDone] mCurrentTextEditorData null");
  }
}
