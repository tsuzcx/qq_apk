...
public class bayu
{
  ...
  static
  {
    ...
    jdField_b_of_type_Int = (int)bdgz.a(localBaseApplication, 45.0F);
    c = (int)bdgz.a(localBaseApplication, 135.0F);
  ...
  public static Bitmap a()
  {
    ...
    {
      localBitmap1 = bdal.a(BaseApplicationImpl.getContext().getResources(), 2130839224);
  ...
  public static Drawable a()
  {
    ...
    if (localBitmap1 == null)
    {
      localBitmap1 = bdal.a(BaseApplicationImpl.getContext().getResources(), 2130837969);
      localBitmap2 = localBitmap1;
      if (localBitmap1 != null)
      {
        localBitmap2 = localBitmap1;
  ...
  public static Drawable a(int paramInt)
  {
    ...
    if (localBitmap1 == null)
    {
      localBitmap1 = bdal.a(BaseApplicationImpl.getContext().getResources(), paramInt);
      localBitmap2 = localBitmap1;
      if (localBitmap1 != null)
      {
        localBitmap2 = localBitmap1;
  ...
  public static URLDrawable a(awjs paramawjs, int paramInt)
  {
    return a(paramawjs, paramInt, null, null);
  }
  
  public static URLDrawable a(awjs paramawjs, int paramInt, String paramString, URLDrawable.URLDrawableOptions paramURLDrawableOptions)
  {
    boolean bool2 = true;
    if (paramawjs == null) {
      return null;
    }
    paramString = URLDrawable.getDrawable(a(paramawjs, paramInt, paramString), paramURLDrawableOptions);
    paramString.setTag(paramawjs);
    if (paramawjs.isSendFromLocal()) {}
    for (;;)
    {
      return paramString;
      if (!awjc.jdField_b_of_type_Boolean) {
        break;
      }
      paramString.setAutoDownload(true);
    }
    boolean bool3 = SettingCloneUtil.readValue(BaseApplication.getContext(), null, BaseApplication.getContext().getString(2131695482), "qqsetting_auto_receive_pic_key", true);
    boolean bool1 = bool2;
  ...
  private static String a(awiz paramawiz)
  {
    if (paramawiz == null) {
      return null;
    }
    switch (paramawiz.jdField_b_of_type_Int)
    {
    default: 
      return null;
    case 0: 
  ...
  private static String a(awiz paramawiz, int paramInt)
  {
    int n;
    String str;
    if (paramInt == 65537)
  ...
  public static URL a(awjd paramawjd, int paramInt, String paramString)
  {
    if (paramawjd == null) {
      return null;
    }
    String str1 = paramawjd.f;
    label48:
    String str2;
    if ((str1 != null) && (!"null".equals(str1)) && (!"".equals(str1)))
    {
      if (paramawjd.jdField_b_of_type_Boolean) {
        paramInt = 1;
      }
      if (paramString == null) {
        break label184;
    ...
    for (;;)
    {
      try
      {
        ...
        if (QLog.isColorLevel())
        {
          QLog.e("URLDrawableHelper", 2, "getURL file == null" + paramawjd.toString());
          str2 = str1;
        }
        if (paramString == null) {
          break label200;
        }
        paramawjd = new URL(paramString, null, str2);
        return paramawjd;
      }
      catch (MalformedURLException paramawjd)
      {
        label184:
        paramawjd.printStackTrace();
        return null;
      }
      if ((paramawjd.jdField_b_of_type_Int == 8000) && (paramInt == 65537))
      {
        if (azqb.a())
        {
          str1 = paramawjd.k;
      ...
      str1 = paramawjd.g;
      break;
      paramString = a(paramawjd, paramInt);
      break label48;
      label200:
      paramawjd = null;
    }
  ...
  public static URL a(awjs paramawjs, int paramInt)
  {
    return a(paramawjs, paramInt, null);
  }
  
  public static URL a(awjs paramawjs, int paramInt, String paramString)
  {
    if (paramawjs == null) {
      return null;
    }
    if (paramawjs.isSendFromLocal()) {
      return a(paramawjs.getPicUploadInfo(), paramInt, paramString);
    }
    return a(paramawjs.getPicDownloadInfo(), paramInt, paramString);
  }
  
  public static URL a(awju paramawju, int paramInt, String paramString)
  {
    if (paramawju == null) {
      return null;
    }
    if (paramawju.d < 4) {}
    for (String str2 = a(paramawju);; str2 = null)
    {
      String str3 = a(paramawju, paramInt);
      if ((paramawju.jdField_b_of_type_Int == 8000) && (paramInt == 65537)) {}
      for (String str1 = paramawju.h;; str1 = "") {
        for (;;)
        {
          if (str1 != null) {}
          try
          {
            if (("".equals(str1)) && (QLog.isColorLevel())) {
              QLog.e("URLDrawableHelper", 2, "getURL file == null" + paramawju.toString());
            }
            if (paramString != null)
            {
              paramawju = new URL(paramString, str2, str1);
              return paramawju;
              if ((paramawju.f != null) && (!"".equals(paramawju.f)))
              {
                str1 = paramawju.f;
                continue;
              }
              if ((paramawju.a != null) && (!"".equals(paramawju.a)))
              {
                str1 = paramawju.a;
                continue;
              }
              if ((paramawju.g != null) && (!"".equals(paramawju.g))) {
                str1 = paramawju.g;
              }
            }
            else
            {
              ...
              paramawju = new URL(str3, str2, str1);
              return paramawju;
            }
          }
          catch (MalformedURLException paramawju)
          {
            paramawju.printStackTrace();
            return null;
          }
        }
      }
  ...
  public static void a(URLDrawable paramURLDrawable, String paramString, boolean paramBoolean)
  {
    ...
    if ((paramURLDrawable.getStatus() != 1) && (baqn.b(str))) {}
    try
    {
  ...
  public static boolean a(Context paramContext, awjs paramawjs, int paramInt)
  {
    return baqn.a(a(paramawjs, paramInt).toString()) != null;
  }
  ...
  public static Drawable b()
  {
    ...
    if (localBitmap1 == null)
    {
      localBitmap1 = bdal.a(BaseApplicationImpl.getContext().getResources(), 2130837966);
      localBitmap2 = localBitmap1;
      if (localBitmap1 != null)
      {
        localBitmap2 = localBitmap1;
  ...
  public static URLDrawable b(awjs paramawjs, int paramInt)
  {
    URLDrawable localURLDrawable = URLDrawable.getDrawable(a(paramawjs, 65537));
    ...
    {
      localURLDrawable.setTargetDensity(d);
      localURLDrawable.setTag(paramawjs);
  ...
  public static void b()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 500	bayu:jdField_b_of_type_Boolean	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifeq +7 -> 15
    //   11: ldc 2
    ...
    //   53: putstatic 61	bayu:m	I
    //   56: iconst_1
    //   57: putstatic 500	bayu:jdField_b_of_type_Boolean	Z
  ...
  {
    return SettingCloneUtil.readValue(BaseApplication.getContext(), null, BaseApplication.getContext().getString(2131695482), "qqsetting_auto_receive_pic_key", true);
  }
  ...
  public static Drawable c()
  {
    ...
    if (localBitmap1 == null)
    {
      localBitmap1 = bdal.a(BaseApplicationImpl.getContext().getResources(), 2130844148);
      localBitmap2 = localBitmap1;
      if (localBitmap1 != null)
      {
        localBitmap2 = localBitmap1;
