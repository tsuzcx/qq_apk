...
public class mfa
  extends mci
{
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mfb(this);
  Intent jdField_a_of_type_AndroidContentIntent;
  public VideoController a;
  lbz jdField_a_of_type_Lbz = lbz.a();
  lee jdField_a_of_type_Lee = new mfc(this);
  lfk jdField_a_of_type_Lfk = new mfd(this);
  mtt jdField_a_of_type_Mtt;
  ...
  public mfa(VideoController paramVideoController, VideoAppInterface paramVideoAppInterface, Intent paramIntent)
  {
  ...
  void a(long paramLong, int paramInt)
  {
    ...
    do
    {
      ...
      localLong = Long.valueOf(mry.a(this.jdField_c_of_type_JavaLangString));
    ...
    return;
    this.jdField_a_of_type_ComTencentAvVideoController.a(this.jdField_a_of_type_Lfe.jdField_d_of_type_JavaLangString, 243);
  ...
  void a(long paramLong1, int paramInt1, long paramLong2, boolean paramBoolean1, int paramInt2, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      bdla.b(null, "CliOper", "", "", "0X8008B2C", "0X8008B2C", 0, 0, "", "", "", "");
      a();
      return;
  ...
  void a(long paramLong, Intent paramIntent)
  {
    ...
    if (mrr.b(this.jdField_b_of_type_Int)) {
      if (paramIntent.getIntExtra("MultiAVType", -1) == 2)
      {
        ...
        String str = lbz.a(this.jdField_c_of_type_Int, String.valueOf(this.jdField_a_of_type_Long), new int[0]);
        this.jdField_a_of_type_Lfe = this.jdField_a_of_type_Lbz.c(str);
    ...
    {
      a(true);
      if ((this.jdField_a_of_type_Lfe != null) || (this.jdField_b_of_type_Int == 1)) {
        break;
      }
      if (QLog.isColorLevel()) {
      ...
      paramIntent = lbz.a(100, this.jdField_c_of_type_JavaLangString, new int[0]);
      if (QLog.isColorLevel()) {
        QLog.d("MultiIncomingCallUICtr", 2, "sessionId : " + paramIntent);
      }
      this.jdField_a_of_type_Boolean = false;
      this.jdField_a_of_type_Lfe = lbz.a().c(paramIntent);
      this.jdField_a_of_type_Lfe.a(paramLong, "processIntent.1", 4);
      this.jdField_a_of_type_Lfe.e("processIntent", true);
      this.jdField_a_of_type_Lfe.ap = true;
      this.jdField_a_of_type_Lfe.e = true;
      this.jdField_a_of_type_Lfe.N = this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(this.jdField_c_of_type_JavaLangString);
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(this.jdField_a_of_type_Lee);
    }
    label409:
    paramIntent = lbz.a(3, this.jdField_c_of_type_JavaLangString, new int[0]);
    this.jdField_a_of_type_Lfe = lbz.a().c(paramIntent);
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Lfe.a(paramLong, "processIntent.2", 1);
      this.jdField_a_of_type_Lfe.a(paramLong, false);
    }
    for (;;)
    {
      this.jdField_a_of_type_Lfe.e = true;
      ...
      break;
      this.jdField_a_of_type_Lfe.a(paramLong, "processIntent.3", 2);
      this.jdField_a_of_type_Lfe.a(paramLong, true);
    }
  }
  
  void a(long paramLong, lfe paramlfe)
  {
    if (QLog.isColorLevel()) {
    ...
    if (this.jdField_a_of_type_ComTencentAvVideoController.f)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("MultiIncomingCallUICtr", 2, "Session already destroyed, id:" + this.jdField_a_of_type_Lfe.jdField_c_of_type_JavaLangString + ", status = " + this.jdField_a_of_type_Lfe.jdField_g_of_type_Int);
      }
      if (this.jdField_a_of_type_Mlh != null) {
        this.jdField_a_of_type_Mlh.c(anvx.a(2131706479));
      }
    }
    label310:
    label374:
    while (!QLog.isColorLevel())
    {
      ...
      {
        return;
        if ((paramlfe != null) && (locallfe == paramlfe))
        {
          if (lbz.a().a() >= 2)
          {
            if (paramlfe.j()) {
              a(paramLong, false, paramlfe);
            }
            for (;;)
            {
              a(paramlfe);
              break;
              this.jdField_a_of_type_ComTencentAvVideoController.a(true, 201, new int[] { locallfe.D });
        ...
        this.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, this.jdField_c_of_type_Int, this.jdField_a_of_type_Lfe.jdField_g_of_type_Long, this.jdField_a_of_type_ArrayOfLong, false);
        bdla.b(null, "CliOper", "", "", "0X8008B2B", "0X8008B2B", 0, 0, "", "", "", "");
      }
      int i = 1;
      if (this.jdField_a_of_type_Boolean) {
        i = 0;
      ...
      if (this.jdField_b_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, 3, Long.valueOf(this.jdField_a_of_type_Lfe.jdField_d_of_type_JavaLangString).longValue(), null, false);
        bdla.b(null, "CliOper", "", "", "0X8008B2B", "0X8008B2B", 0, 0, "", "", "", "");
      }
      for (;;)
      {
        b();
        break;
        int j = mvk.d(this.jdField_c_of_type_Int);
        this.jdField_a_of_type_ComTencentAvVideoController.a(paramLong, this.jdField_c_of_type_JavaLangString, i, j);
        if (this.jdField_a_of_type_Boolean) {
          bdla.b(null, "CliOper", "", "", "0X8008B24", "0X8008B24", 0, 0, "", "", "", "");
        } else {
          bdla.b(null, "CliOper", "", "", "0X8008B27", "0X8008B27", 0, 0, "", "", "", "");
        }
      }
    }
    label591:
  ...
  void a(long paramLong, boolean paramBoolean1, String paramString, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    {
      bdla.b(null, "CliOper", "", "", "0X8008B25", "0X8008B25", 0, 0, "", "", "", "");
      if (!paramBoolean1) {
        break label317;
      }
    ...
    for (;;)
    {
      try
      {
        ...
        if (!paramBoolean3)
        {
          ...
          return;
          bdla.b(null, "CliOper", "", "", "0X8008B28", "0X8008B28", 0, 0, "", "", "", "");
        }
      }
  ...
  void a(long paramLong, boolean paramBoolean, lfe paramlfe)
  {
    a(paramLong, paramBoolean, paramlfe, -1);
  }
  
  void a(long paramLong, boolean paramBoolean, lfe paramlfe, int paramInt)
  {
    boolean bool3 = false;
    if (paramBoolean) {
    ...
    if (!paramBoolean) {
      if (paramlfe != null)
      {
        String str = paramlfe.jdField_d_of_type_JavaLangString;
        localObject = str;
        if (TextUtils.isEmpty(str)) {
          localObject = paramlfe.s;
        }
        bool1 = paramlfe.J;
        i = paramlfe.F;
        l = paramlfe.jdField_g_of_type_Long;
      }
    }
    for (;;)
    {
  ...
  void a(lfe paramlfe)
  {
    if ((this.jdField_a_of_type_ComTencentAvVideoController != null) && (paramlfe != null))
    {
      ...
      localIntent.putExtra("groupId", paramlfe.jdField_g_of_type_Long);
      localIntent.putExtra("peerUin", paramlfe.jdField_d_of_type_JavaLangString);
  ...
  void f()
  {
    ...
    if (!mrr.b(this.jdField_b_of_type_Int))
    {
      ...
      if ((!this.jdField_a_of_type_Boolean) && (!this.jdField_b_of_type_Boolean)) {
        this.jdField_a_of_type_Mtt.a(this.jdField_a_of_type_Lfe.jdField_c_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, (Bitmap)localObject, null, 56, this.jdField_b_of_type_Int, 2);
      }
    }
    Bitmap localBitmap;
    String str;
    ...
    {
      return;
      this.jdField_a_of_type_Mtt.a(this.jdField_a_of_type_Lfe.jdField_c_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, (Bitmap)localObject, null, 55, this.jdField_b_of_type_Int, 1);
      return;
      ...
      int i = mrr.b(this.jdField_b_of_type_Int);
    ...
    } while (this.jdField_a_of_type_Lfe == null);
    this.jdField_a_of_type_Mtt.a(this.jdField_a_of_type_Lfe.jdField_c_of_type_JavaLangString, str, localBitmap, (String)localObject, 57, this.jdField_b_of_type_Int, 3);
  }
}
