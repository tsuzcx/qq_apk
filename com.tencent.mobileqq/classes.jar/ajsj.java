...
{
  public ajsj(ChatHistoryC2CLinkFragment paramChatHistoryC2CLinkFragment) {}
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject1 = (ChatMessage)((ajsh)paramView.getTag()).a;
    if (this.a.c)
    {
      this.a.jdField_a_of_type_Ajwf.a(localObject1);
      this.a.jdField_a_of_type_Ajsd.notifyDataSetChanged();
    }
    ...
    if ((localObject1 instanceof StructMsgForGeneralShare))
    {
      ...
      bdor localbdor = new bdor(this.a.b, paramView, (StructMsgForGeneralShare)localObject2);
      StructMsgForGeneralShare.onClickEvent(this.a.b, this.a.jdField_a_of_type_AndroidContentContext, (StructMsgForGeneralShare)localObject2, paramView, localbdor);
    }
    for (;;)
    {
