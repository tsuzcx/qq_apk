  ...
  extends ajqv
{
  ...
  ajsj(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  {
    PhotoUtils.getTypeforReportSpcialDiscuss(this.jdField_a_of_type_Ajqu.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    ...
    while (i1 < paramArrayList.size())
    {
      ...
      {
        m = ((NewPhotoListActivity)this.mActivity).a((String)localObject);
  ...
  public void caseVideo(View paramView, int paramInt)
  {
    ...
    {
      paramView = bfur.a(this.mActivity, "请选择不超过" + (float)this.mPhotoCommonData.videoSizeLimit / 1024.0F / 1024.0F / 1024.0F + "G的视频");
    ...
    {
      paramView = bfur.a(this.mActivity, "请选择不超过" + this.mPhotoCommonData.videoDurationLimit / 60L / 1000L + "分钟的视频");
      paramView.setPositiveButton(2131694201, new bfvf());
      paramView.show();
      return;
    }
    ...
    if (!this.jdField_a_of_type_Ajqu.isSingleMode)
    {
      ...
      ((Intent)localObject1).putExtra("PhotoConst.SHOW_MAGIC_USE_PASTER", this.jdField_a_of_type_Ajqu.e);
      ((Intent)localObject1).putExtra("PasterConstants.paster_id", this.jdField_a_of_type_Ajqu.jdField_a_of_type_JavaLangString);
      ((Intent)localObject1).putExtra("PasterConstants.paster_cate_id", this.jdField_a_of_type_Ajqu.jdField_b_of_type_JavaLangString);
      ...
      ((Intent)localObject1).putExtra("PasterConstants.pasters_data", this.jdField_a_of_type_Ajqu.jdField_b_of_type_JavaUtilHashMap);
    ...
    ((Intent)localObject2).putExtra("uin", this.jdField_a_of_type_Ajqu.d);
    ((Intent)localObject2).putExtra("uintype", this.jdField_a_of_type_Ajqu.jdField_a_of_type_Int);
  ...
  public String getExceedMaxSelectNumStr(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (this.mPhotoCommonData.showMediaType == 6) {
      return ((NewPhotoListActivity)this.mActivity).getResources().getString(2131694430, new Object[] { Integer.valueOf(i) });
    }
    if (this.mPhotoCommonData.showMediaType == 2) {
      return ((NewPhotoListActivity)this.mActivity).getResources().getString(2131694434, new Object[] { Integer.valueOf(i) });
    }
