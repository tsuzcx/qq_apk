  ...
  implements bbls
{
        ...
        if ((((im_msg_body.Elem)localObject2).general_flags.has()) && (((im_msg_body.Elem)localObject2).general_flags.bytes_pb_reserve.has())) {
          try
          {
            ...
            if (((generalflags.ResvAttr)localObject1).bytes_pb_ptt_waveform.has())
            {
              ...
              paramMessageForPtt.waveformArray = bfxf.a((ptt_waveform.PttWaveform)localObject2);
              if (QLog.isColorLevel())
              {
    ...
    if (paramRichText.elems.has())
    {
      ...
      while (paramRichText.hasNext())
      {
        ...
        if ((localElem.common_elem.has()) && (21 == localElem.common_elem.uint32_service_type.get()))
        {
          ...
          apse.a(paramMsg, localElem, localArrayList, paramMessageHandler.app);
        }
      }
    }
  }
  ...
  public void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList, bbkm parambbkm)
  {
    ...
    Object localObject3;
    long l2;
    if (bcmt.a(paramMessageHandler.app))
    {
      i4 = 1;
      l1 = -1L;
      localObject1 = "";
      ...
      localObject1 = parambbkm;
      parambbkm = (bbkm)localObject3;
    }
    label307:
    label335:
    Object localObject4;
    ...
    {
      i1 = i6 + i5;
      localObject3 = parambbkm;
      parambbkm = (bbkm)localObject1;
      ...
      if (i2 == 9)
      {
        localObject3 = new byte[i5];
        PkgTools.copyData((byte[])localObject3, 0, (byte[])localObject5, i6, i5);
        n = bfyl.b(bftf.a(PkgTools.getLongData((byte[])localObject3, 0)));
        localObject3 = parambbkm;
        parambbkm = (bbkm)localObject1;
        localObject1 = localObject3;
      }
      ...
      else
      {
        ...
        try
        {
          ...
          parambbkm = (bbkm)localObject4;
        }
        catch (Exception localException)
        {
          localObject2 = parambbkm;
          parambbkm = (bbkm)localObject3;
          k = i3;
          j = i2;
          i = i1;
    ...
    for (;;)
    {
      ...
      for (localObject3 = ((ByteStringMicro)localObject3).toStringUtf8();; localObject3 = "")
      {
        ...
        for (i1 = 1;; i1 = 2)
        {
          bcef.b(paramMessageHandler.app, "CliOper", "", "", "0X80060E4", "0X80060E4", i1, 0, "", "", "", "8.4.8");
          ...
          akgt.b(parambbkm, (MessageRecord)localObject2);
          return;
        }
      }
      label1250:
      localObject3 = parambbkm;
      parambbkm = (bbkm)localObject2;
