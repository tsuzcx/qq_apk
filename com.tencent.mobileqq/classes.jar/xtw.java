...
public class xtw
{
  public ArrayList<Long> a(List<String> paramList)
  {
    ...
    {
      l = axwp.a((String)paramList.next()) + l;
  ...
  public ArrayList<Long> a(List<String> paramList, String paramString)
  {
    ...
    long l2 = axwp.a(paramString);
    paramString = new ArrayList();
    Iterator localIterator = paramList.iterator();
    long l1 = 0L;
    while (localIterator.hasNext())
    {
      l1 = axwp.a((String)localIterator.next()) + l1;
  ...
  public boolean a(List<String> paramList, String paramString, int paramInt1, int paramInt2, MediaFormat paramMediaFormat)
  {
    ...
    {
      localObject4 = new bnsg();
      try
      {
        i = bnsf.a((String)paramList.get(0), (bnsg)localObject4);
      ...
      paramInt1 = j;
      if (AudioHelper.f()) {
        return bnsa.a(paramList, paramString, i);
      }
      ...
      localObject5 = new axvi(paramString, paramInt1, paramInt2, azib.r, 1, false, i);
      ((axvi)localObject5).b = true;
    }
    for (;;)
    {
      Object localObject3;
      try
      {
        ...
        localObject3 = new File(((axvi)localObject5).a);
        if (!((File)localObject3).exists()) {
          bdhb.c(((File)localObject3).getAbsolutePath());
        }
        localObject3 = new MediaMuxer(((axvi)localObject5).a, 0);
        ((MediaMuxer)localObject3).setOrientationHint(((axvi)localObject5).g);
  ...
  public ArrayList<Long> b(List<String> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      {
        localLinkedHashMap.put(localObject, Long.valueOf(axwp.a((String)localObject)));
      }
    }
  ...
  public ArrayList<Long> b(List<String> paramList, String paramString)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      {
        paramString.put(localObject, Long.valueOf(axwp.a((String)localObject)));
      }
    }
    paramList = new ArrayList();
