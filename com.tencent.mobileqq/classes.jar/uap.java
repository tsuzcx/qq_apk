...
{
  public uap(ServiceAccountFolderActivityNew paramServiceAccountFolderActivityNew) {}
  ...
  private void a(int paramInt)
  {
    if (paramInt == FolderBaseTabFragment.a)
    {
      ...
      for (str = "1";; str = "2")
      {
        zxp.b("auth_discover", "tofollow", 0, 0, new String[] { str });
    ...
    {
      zxp.b("auth_follow", "todiscover", 0, 0, new String[] { str });
