  ...
  implements LiteTransferListenerCallback, LiteTransferOperatorCallback
{
  ...
  private anyz jdField_a_of_type_Anyz = new answ(this);
  public anzy a;
  ...
  private dc jdField_a_of_type_Dc;
  private dg jdField_a_of_type_Dg = new dg(this);
  public dk a;
  public String a;
  private ArrayList<bcqd> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  protected HashMap<Long, bcqc> a;
  ...
  public ansr(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Anzy = new anzy(paramQQAppInterface);
    this.jdField_a_of_type_Dk = new dk(paramQQAppInterface);
    this.jdField_a_of_type_Dc = new dc(paramQQAppInterface);
    this.jdField_c_of_type_Int = BaseApplication.getContext().getResources().getDimensionPixelSize(2131296826);
    this.jdField_d_of_type_Int = BaseApplication.getContext().getResources().getDimensionPixelSize(2131296825);
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new anss(this);
    this.jdField_b_of_type_AndroidContentBroadcastReceiver = new ansu(this, paramQQAppInterface);
    this.jdField_a_of_type_ComTencentMobileqqMsfSdkHandlerINetInfoHandler = new ansv(this);
    ...
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Anyz);
    this.jdField_a_of_type_Blzs = new blzs(paramQQAppInterface);
    f();
    g();
  ...
  private ToServiceMsg a(boolean paramBoolean, long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2, int paramInt4)
  {
    ...
    localbcsf.jdField_a_of_type_Int = paramInt2;
    localbcsf.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    paramString = a(13, paramString, localbcsf, l, bcsc.b(paramLong1), paramLong2);
  ...
  private msg_svc.PbSendMsgReq a(int paramInt1, String paramString, bcsf parambcsf, long paramLong1, int paramInt2, long paramLong2)
  {
    return bcrx.a(this.app, paramInt1, paramString, parambcsf, paramLong1, paramInt2);
  }
  
  private void a(int paramInt, long paramLong, String paramString)
  {
    int i = DataLineMsgRecord.getDevTypeBySeId(paramLong);
    DataLineMsgRecord localDataLineMsgRecord = this.app.getMessageFacade().getDatalineMessageManager(i).a(paramLong);
    ...
    do
    {
      ...
      if (paramInt == 1)
      {
        ...
        this.app.getMessageFacade().getDatalineMessageManager(i).a(localDataLineMsgRecord.msgId, localDataLineMsgRecord.serverPath, localDataLineMsgRecord.md5);
        return;
      }
    } while (paramInt != 2);
    ...
    if (paramDataLineMsgRecord.isSend()) {
      if (paramInt2 == 2)
      {
        ...
        if (!TextUtils.isEmpty(paramDataLineMsgRecord.thumbPath)) {
          this.app.getMessageFacade().getDatalineMessageManager(paramInt1).a(paramDataLineMsgRecord.msgId, paramDataLineMsgRecord.thumbPath);
        }
        this.app.getMessageFacade().getDatalineMessageManager(paramInt1).c(paramDataLineMsgRecord.msgId);
        this.app.getMessageFacade().getDatalineMessageManager(paramInt1).c();
        this.app.getMessageFacade().getDatalineMessageManager(paramInt1).a(paramDataLineMsgRecord.msgId);
        if ((paramDataLineMsgRecord.nSessionState == 2) && (FileUtil.isFileExists(paramDataLineMsgRecord.path))) {
          this.app.getMessageFacade().getDatalineMessageManager(paramInt1).b(paramDataLineMsgRecord.msgId, paramDataLineMsgRecord.path);
        }
        bdla.b(this.app, "CliOper", "", "", "0X8006223", "0X8006223", 0, 0, "", "", "", "");
      }
    }
    for (;;)
    {
      ...
      if ((paramInt2 == 32) || (paramInt2 == 11) || (paramInt2 == 8))
      {
        ...
        this.app.getMessageFacade().getDatalineMessageManager(paramInt1).c(paramDataLineMsgRecord.msgId);
        this.app.getMessageFacade().getDatalineMessageManager(paramInt1).b(paramDataLineMsgRecord.msgId);
        bdla.b(this.app, "CliOper", "", "", "0X8006224", "0X8006224", 0, 0, "", "", "", "");
      }
      else
      {
        paramDataLineMsgRecord.fileMsgStatus = 0L;
        ...
        if (paramInt2 == 2)
        {
          ...
          String str = aueq.a(paramDataLineMsgRecord.path);
          if (str != null)
          {
            FileUtils.deleteFile(paramDataLineMsgRecord.path);
            paramDataLineMsgRecord.path = str;
            this.app.getMessageFacade().getDatalineMessageManager(paramInt1).b(paramDataLineMsgRecord.msgId, str);
          }
          this.app.getMessageFacade().getDatalineMessageManager(paramInt1).c(paramDataLineMsgRecord.msgId);
          this.app.getMessageFacade().getDatalineMessageManager(paramInt1).a(paramDataLineMsgRecord.msgId);
          this.app.getMessageFacade().getDatalineMessageManager(paramInt1).c();
          bdla.b(this.app, "CliOper", "", "", "0X8006226", "0X8006226", 0, 0, "", "", "", "");
        }
        else if ((paramInt2 == 32) || (paramInt2 == 11) || (paramInt2 == 8))
        {
          ...
          this.app.getMessageFacade().getDatalineMessageManager(paramInt1).c(paramDataLineMsgRecord.msgId);
          this.app.getMessageFacade().getDatalineMessageManager(paramInt1).b(paramDataLineMsgRecord.msgId);
          bdla.b(this.app, "CliOper", "", "", "0X8006227", "0X8006227", 0, 0, "", "", "", "");
        }
        else
        {
  ...
  private void a(long paramLong, int paramInt)
  {
    ...
    do
    {
      ...
      {
        ((beed)this.app.getManager(QQManagerFactory.TEAMWORK_SPREAD_MANAGER_DATALINE)).a(localDataLineMsgRecord, i);
        return;
      }
  ...
  private void a(long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    for (float f = 0.0F;; f = (float)paramLong2 / (float)paramLong3)
    {
      ...
      DataLineMsgRecord localDataLineMsgRecord = this.app.getMessageFacade().getDatalineMessageManager(i).a(paramLong1);
      if (localDataLineMsgRecord != null) {
  ...
  private void a(Session paramSession, NFCInfo paramNFCInfo, FTNInfo paramFTNInfo, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localDataLineMsgRecord = this.app.getMessageFacade().getDatalineMessageManager(j).a(paramSession.uSessionID);
      if (localDataLineMsgRecord != null) {
        break label608;
      }
    ...
    if ((paramSession.strFileNameSrc != null) && (paramSession.strFileNameSrc.length() > 0))
    {
      ...
      label365:
      paramNFCInfo = this.app.getMessageFacade().getDatalineMessageManager(j);
      if (paramSession.bSend) {
        break label602;
      }
    }
    ...
    for (boolean bool = true;; bool = false)
    {
      for (;;)
      {
        ...
        if ((paramBoolean) && (paramNFCInfo.nSessionState != 1) && ((!paramNFCInfo.isSend()) || (!auea.b(paramNFCInfo.path)))) {
          a(paramNFCInfo.path);
        }
        if (!paramSession.bSend) {
          break label676;
    ...
    {
      this.app.getMessageFacade().getDatalineMessageManager(j).c(localDataLineMsgRecord.msgId);
      this.app.getMessageFacade().getDatalineMessageManager(j).b(localDataLineMsgRecord.msgId);
      paramNFCInfo = localDataLineMsgRecord;
      break;
    }
    label676:
    if (!paramBoolean)
    {
      paramFTNInfo = this.app.getDataLineMsgProxy(j).b(paramSession.uSessionID);
    ...
    for (;;)
    {
      ...
      return;
      label787:
      paramFTNInfo = this.app.getDataLineMsgProxy(j).a(paramSession.dwGroupID);
  ...
  private void a(DataLineMsgRecord paramDataLineMsgRecord, WeiYunFileInfo paramWeiYunFileInfo)
  {
    ...
    this.app.getFileManagerEngine().a().a(paramWeiYunFileInfo, new anst(this, l));
  }
  
  private void a(ToServiceMsg paramToServiceMsg)
  {
    NewIntent localNewIntent = new NewIntent(this.app.getApplication(), ansz.class);
  ...
  private boolean a(bcqd parambcqd)
  {
    int j = 0;
    int i = 0;
    StringBuffer localStringBuffer = new StringBuffer();
    int m = parambcqd.a(localStringBuffer);
    if (m == -1) {
      return false;
    }
    int k;
    ...
    parambcqd.a(a(parambcqd.a().longValue(), 1001, parambcqd.a(), m, localStringBuffer.toString().getBytes()));
    return true;
  }
  ...
  private void b(List<SubMsgType0x7.MsgBody.MoloNotify> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      {
        localDataLineMsgRecord = this.jdField_a_of_type_Dg.a(((SubMsgType0x7.MsgBody.MoloNotify)localObject).bytes_buf.get().toByteArray());
        if (localDataLineMsgRecord == null)
        {
          if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      a().getMessageFacade().getDatalineMessageManager(j).a(localDataLineMsgRecord, true);
      if ((DataLineMsgSet.isSingle(localDataLineMsgRecord)) || (!b(localDataLineMsgRecord.groupId))) {
        break label479;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      {
        b(111);
        this.jdField_a_of_type_Dg.a(localDataLineMsgRecord.strMoloKey);
        dq.c(this.app);
        label729:
        this.app.getMessageFacade().getDatalineMessageManager(j).c(localDataLineMsgRecord.msgId);
        continue;
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    paramToServiceMsg = this.app.getMessageFacade().getDatalineMessageManager(j).a(l);
  ...
  private void d(DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    this.app.getMessageFacade().getDatalineMessageManager(i).c(paramDataLineMsgRecord.msgId);
    this.app.getMessageFacade().getDatalineMessageManager(i).b(paramDataLineMsgRecord.msgId);
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size()) {
      if (!((bcqd)this.jdField_a_of_type_JavaUtilArrayList.get(i)).a().equals(paramToServiceMsg)) {}
    }
    for (paramToServiceMsg = (bcqd)this.jdField_a_of_type_JavaUtilArrayList.get(i);; paramToServiceMsg = null)
    {
      if (paramToServiceMsg == null) {}
      do
      {
        ...
        if (paramToServiceMsg.a())
        {
          ...
          this.app.getMessageFacade().getDatalineMessageManager(i).a(paramToServiceMsg.a().msgId);
  ...
  private void e(DataLineMsgRecord paramDataLineMsgRecord)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (FileUtils.fileExistsAndNotEmpty(paramDataLineMsgRecord.thumbPath));
      str = auea.a(str, 384, 384);
  ...
  public void GetThumbFilePath(int paramInt, Session paramSession)
  {
    ...
    Object localObject = (aocn)this.app.getBusinessHandler(BusinessHandlerFactory.REGPRXYSVCPACK_HANDLER);
    if ((localObject != null) && (((aocn)localObject).a() == 0))
    {
    ...
    localObject = fd.a(BaseApplication.getContext(), paramSession.strFilePathSrc);
    if (localObject == null)
    {
  ...
  {
    ez.a(this.app, paramReportItem, ez.jdField_b_of_type_Int);
  }
  ...
  public void OnGroupComplete(int paramInt1, int paramInt2)
  {
    ...
    {
      return;
      DataLineMsgSet localDataLineMsgSet2 = this.app.getDataLineMsgProxy(0).a(paramInt1);
      localDataLineMsgSet1 = localDataLineMsgSet2;
      if (localDataLineMsgSet2 == null) {
        localDataLineMsgSet1 = this.app.getDataLineMsgProxy(1).a(paramInt1);
      }
  ...
  public void OnSessionNew(Session paramSession, NFCInfo paramNFCInfo, FTNInfo paramFTNInfo)
  {
    if (paramSession.bSend)
    {
      bdla.b(this.app, "CliOper", "", "", "0X8006222", "0X8006222", 0, 0, "", "", "", "");
      if ((paramSession.actionInfo != null) && (paramSession.actionInfo.strServiceName != null) && (paramSession.actionInfo.strServiceName.length() != 0)) {
        break label210;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      a(paramSession);
      return;
      bdla.b(this.app, "CliOper", "", "", "0X8006225", "0X8006225", 0, 0, "", "", "", "");
      break;
      label199:
  ...
  public int a(String paramString)
  {
    ...
    return this.jdField_a_of_type_Dg.a(paramString);
  }
  ...
  public blzs a()
  {
    return this.jdField_a_of_type_Blzs;
  }
  ...
  public Session a(long paramLong)
  {
    boolean bool = true;
    int i = DataLineMsgRecord.getDevTypeBySeId(paramLong);
    DataLineMsgRecord localDataLineMsgRecord = a().getMessageFacade().getDatalineMessageManager(i).a(paramLong);
    if (localDataLineMsgRecord == null) {
      return null;
    }
    ...
    for (;;)
    {
      ...
      localSession.strFilePathSrc = aueq.c(localDataLineMsgRecord.path);
  ...
  public dc a()
  {
    return this.jdField_a_of_type_Dc;
  }
  ...
  public Long a(String paramString, int paramInt)
  {
    ...
    localDataLineMsgRecord.issuc = false;
    ((aocy)this.app.getBusinessHandler(BusinessHandlerFactory.SVIP_HANDLER)).a(localDataLineMsgRecord);
    localDataLineMsgRecord.time = bcrg.a();
    localDataLineMsgRecord.sessionid = localLong.longValue();
    localDataLineMsgRecord.progress = 0.0F;
    this.app.getMessageFacade().getDatalineMessageManager(paramInt).a(localDataLineMsgRecord, false);
    if (!NetworkUtil.isNetSupport(BaseApplication.getContext())) {
      return Long.valueOf(0L);
    }
    localDataLineMsgRecord.issuc = true;
    paramString = new bcqd(paramString, localLong, localDataLineMsgRecord);
    if (!a(paramString)) {
      return Long.valueOf(0L);
    }
  ...
  {
    this.jdField_a_of_type_Dg.b(paramInt);
  }
  ...
  public void a(int paramInt, long paramLong, boolean paramBoolean)
  {
    ...
    b(localDataLineMsgRecord.path);
    this.app.getMessageFacade().getDatalineMessageManager(i).c(localDataLineMsgRecord.msgId);
    if (localDataLineMsgRecord.strMoloKey != null)
    {
      this.jdField_a_of_type_Dg.c(localDataLineMsgRecord.strMoloKey);
      return;
    }
  ...
  protected void a(long paramLong1, long paramLong2, SubMsgType0x7.MsgBody.GenericSubCmd paramGenericSubCmd, SubMsgType0x7.MsgBody.MsgHeader paramMsgHeader)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        case 1: 
          ...
          default: 
            ...
            {
              localbcqc = new bcqc(Long.valueOf(paramGenericSubCmd.uint32_size.get()), Long.valueOf(l));
              this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(l), localbcqc);
            ...
            {
              localbcqc = (bcqc)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(l));
              continue;
            }
            if (!paramGenericSubCmd.uint32_index.has()) {
              break label697;
            }
            localbcqc.a(paramGenericSubCmd.uint32_index.get(), paramMsgHeader);
            if (!localbcqc.a()) {
              break label697;
            }
            ...
            if (i == 1)
            {
              paramGenericSubCmd = localbcqc.a();
              i = 0;
              ...
              this.app.getMessageFacade().getDatalineMessageManager(i).a((DataLineMsgRecord)localObject1, true);
              h();
              a(8, true, new Object[] { Integer.valueOf((int)paramLong1), localbcqc.a(), Long.valueOf(((DataLineMsgRecord)localObject1).sessionid) });
              return;
            }
            break;
          }
      ...
      ((DataLineMsgRecord)localObject1).msg = localbcqc.a();
      continue;
      awzj.a().a(paramGenericSubCmd);
      return;
      label691:
      break label705;
      label694:
  ...
  public void a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    {
      localDataLineMsgRecord.thumbPath = FileUtil.combinPath(FileUtil.getThumbnailPath(this.app.getApplication()), auea.a(paramFileManagerEntity.strThumbPath));
    ...
    Object localObject = (ansr)this.app.getBusinessHandler(BusinessHandlerFactory.DATALINE_HANDLER);
    localDataLineMsgRecord.sessionid = ((ansr)localObject).a(0, 0).longValue();
    localDataLineMsgRecord.msg = "";
    localDataLineMsgRecord.issend = 1;
    localDataLineMsgRecord.isread = true;
    localDataLineMsgRecord.issuc = false;
    ...
    this.app.getMessageFacade().getDatalineMessageManager(DataLineMsgRecord.getDevTypeBySeId(localDataLineMsgRecord.sessionid)).a(localDataLineMsgRecord, true);
    ((ansr)localObject).a(7, true, new Object[] { Long.valueOf(0L), Long.valueOf(localDataLineMsgRecord.sessionid), localDataLineMsgRecord.path, Byte.valueOf((byte)b(localDataLineMsgRecord.msgtype)), Boolean.valueOf(false), Boolean.valueOf(false), Long.valueOf(localDataLineMsgRecord.filesize) });
  ...
  public void a(WeiYunFileInfo paramWeiYunFileInfo)
  {
    ...
    this.app.getMessageFacade().getDatalineMessageManager(DataLineMsgRecord.getDevTypeBySeId(localDataLineMsgRecord.sessionid)).a(localDataLineMsgRecord, true);
    localansr.a(7, true, new Object[] { Long.valueOf(0L), Long.valueOf(localDataLineMsgRecord.sessionid), localDataLineMsgRecord.path, Byte.valueOf((byte)b(localDataLineMsgRecord.msgtype)), Boolean.valueOf(false), Boolean.valueOf(false), Long.valueOf(localDataLineMsgRecord.filesize) });
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.getServiceCmd().equals("MessageSvc.PbSendMsg"))
    {
      ...
      awzj.a().a(paramToServiceMsg, paramFromServiceMsg, paramObject);
    }
    label72:
  ...
  {
    this.jdField_a_of_type_Blzs.a(paramMsg);
  }
  
  public void a(msg_comm.Msg paramMsg, SubMsgType0x7.MsgBody paramMsgBody)
  {
    this.jdField_a_of_type_Blzs.a(paramMsg, paramMsgBody);
    DataLineMsgRecord localDataLineMsgRecord;
    try
    {
      localDataLineMsgRecord = new DataLineMsgRecord();
    ...
    this.app.getMessageFacade().getDatalineMessageManager(paramMsgBody.msg_header.uint32_src_ter_type.get()).d(localDataLineMsgRecord.time);
    ...
    localObject = (aocn)this.app.getBusinessHandler(BusinessHandlerFactory.REGPRXYSVCPACK_HANDLER);
    if ((localObject != null) && (((aocn)localObject).d() != 1)) {
      ((aocn)localObject).e(1);
    }
  ...
  public void a(msg_comm.Msg paramMsg, C2CType0x211_SubC2CType0x9.MsgBody paramMsgBody)
  {
    ...
    this.jdField_a_of_type_Anzy.a(this, paramMsg, paramMsgBody);
  }
  ...
  {
    int i = DataLineMsgRecord.getDevTypeBySeId(paramLong);
    DataLineMsgRecord localDataLineMsgRecord = this.app.getDataLineMsgProxy(i).b(paramLong);
    DataLineMsgSet localDataLineMsgSet = this.app.getDataLineMsgProxy(i).a(paramInt);
  ...
  public boolean a(DataLineMsgRecord paramDataLineMsgRecord, int paramInt)
  {
    ...
    if (paramInt == 3)
    {
      ...
      {
        localObject = this.app.getDataLineMsgProxy(1).a();
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      {
        localObject = this.app.getDataLineMsgProxy(0).a();
        if ((localObject != null) && (((DataLineMsgSetList)localObject).size() > 0))
        {
          localObject = ((DataLineMsgSetList)localObject).iterator();
          while (((Iterator)localObject).hasNext())
  ...
  public boolean a(DataLineMsgSet paramDataLineMsgSet)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localDataLineMsgRecord.strMoloKey != null)
      {
        ...
        {
          this.jdField_a_of_type_Dg.d(localDataLineMsgRecord.strMoloKey);
          if (QLog.isDevelopLevel()) {
    ...
    return this.app.getMessageFacade().getDatalineMessageManager(i).a(paramDataLineMsgSet) >= 0;
  }
  ...
  public boolean a(String paramString)
  {
    ...
    return this.jdField_a_of_type_Dg.e(paramString);
  }
  ...
  public boolean a(List<Long> paramList)
  {
    ...
    if (((Iterator)localObject1).hasNext())
    {
      ...
      localObject3 = a().getMessageFacade().getDatalineMessageManager(i).a(((Long)localObject2).longValue());
      if (localObject3 != null)
      {
        ((DataLineMsgRecord)localObject3).fileMsgStatus = 0L;
        this.app.getMessageFacade().getDatalineMessageManager(i).c(((DataLineMsgRecord)localObject3).msgId);
      }
      if ((localObject3 != null) && (((DataLineMsgRecord)localObject3).strMoloKey != null))
      {
        this.jdField_a_of_type_Dg.a(((DataLineMsgRecord)localObject3).strMoloKey);
        bool1 = true;
      }
      for (;;)
      {
    ...
    if (localArrayList1.size() > 0)
    {
      ...
      i = DataLineMsgRecord.getDevTypeBySeId(((Long)localObject2).longValue());
      localDataLineMsgRecord = this.app.getMessageFacade().getDatalineMessageManager(i).a(((Long)localObject2).longValue());
      if (localDataLineMsgRecord == null)
      {
    ...
    for (;;)
    {
      ...
      for (bool1 = false;; bool1 = true)
      {
        ...
        while (paramList.hasNext())
        {
          ...
          a(((DataLineMsgRecord)localObject1).path);
        }
      }
      return true;
    }
  ...
  public int b()
  {
    return ((aocy)this.app.getBusinessHandler(BusinessHandlerFactory.SVIP_HANDLER)).b();
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, int paramInt)
  {
    ...
    } while (this.app.getMessageFacade().getDatalineMessageManager(paramInt).a(l) == null);
  ...
  public boolean b(String paramString)
  {
    ...
    return this.jdField_a_of_type_Dg.b(paramString);
  }
  ...
  public void d()
  {
    long l = this.app.getMessageFacade().getLastMessage(String.valueOf(AppConstants.DATALINE_PC_UIN), 6000).time;
    ...
    if ((l != 0L) && (l != this.jdField_c_of_type_Long))
    {
      ...
      ((acmp)this.app.getMsgHandler().a("c2c_processor")).a(localArrayList);
      this.jdField_c_of_type_Long = l;
    }
    l = this.app.getMessageFacade().getLastMessage(String.valueOf(AppConstants.DATALINE_IPAD_UIN), 6003).time;
  ...
  public void e()
  {
    Object localObject = this.app.getDataLineMsgProxy(0).a();
    ...
    localObject = this.app.getDataLineMsgProxy(0).a(false);
    if (localObject != null)
    {
      localObject = ((DataLineMsgSetList)localObject).iterator();
      while (((Iterator)localObject).hasNext())
  ...
  public void onDestroy()
  {
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        if ((this.app != null) && (this.app.getApp() != null) && (this.jdField_a_of_type_Anyz != null))
        {
        ...
        {
          bool1 = bool2;
          if (this.app.getDataLineMsgProxy(0) != null)
          {
            localObject = this.app.getDataLineMsgProxy(0).a();
            bool1 = bool2;
            if (localObject != null)
        ...
        {
          bool2 = bool1;
          if (this.app.getDataLineMsgProxy(1) != null)
          {
            localObject = this.app.getDataLineMsgProxy(1).a();
            bool2 = bool1;
            if (localObject != null)
        ...
        this.jdField_a_of_type_Blzs.a();
        this.jdField_a_of_type_Dg.a();
        this.jdField_a_of_type_Anzy.a();
        this.jdField_a_of_type_Dc.a();
        if (this.jdField_a_of_type_JavaUtilTimer != null)
        {
          this.jdField_a_of_type_JavaUtilTimer.cancel();
          this.jdField_a_of_type_JavaUtilTimer = null;
  ...
  {
    this.jdField_a_of_type_Blzs.a(paramToServiceMsg, paramFromServiceMsg, (byte[])paramObject);
