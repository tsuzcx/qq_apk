  ...
  extends BaseAdapter
{
  ...
  public Drawable a(ApolloActionPackage paramApolloActionPackage)
  {
    ...
    {
      localURLDrawable2 = anit.a("" + paramApolloActionPackage.mIconSelectedUrl.hashCode(), null, paramApolloActionPackage.mIconSelectedUrl, true);
    ...
    for (URLDrawable localURLDrawable1 = localURLDrawable2;; localURLDrawable1 = null)
    {
      ...
      {
        paramApolloActionPackage = anit.a("" + paramApolloActionPackage.mIconUnselectedUrl.hashCode(), null, paramApolloActionPackage.mIconUnselectedUrl, true);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131558687, paramViewGroup, false);
      paramView = new anss(this);
      paramView.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131378339));
      ...
      paramView.jdField_a_of_type_AndroidViewView = localView.findViewById(2131378336);
      paramView.jdField_a_of_type_AndroidViewView.setBackgroundColor(this.jdField_a_of_type_Int);
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131378337));
      paramView.b = localView.findViewById(2131381061);
    ...
    for (;;)
    {
      ...
      return localView;
      localObject = (anss)paramView.getTag();
      localView = paramView;
