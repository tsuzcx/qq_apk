  ...
  extends Drawable
{
  ...
  public aqjb(Resources paramResources, NinePatch paramNinePatch1, NinePatch paramNinePatch2, int paramInt)
  {
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      localObject = (HashMap)aqhg.a().a.get(Integer.valueOf(this.jdField_d_of_type_Int));
      if ((localObject == null) || (((HashMap)localObject).size() <= 0)) {
        return;
      }
      localObject = ((HashMap)localObject).values().iterator();
      while (((Iterator)localObject).hasNext()) {
        ((aqin)((Iterator)localObject).next()).a(this, paramCanvas);
      }
