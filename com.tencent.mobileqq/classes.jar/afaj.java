...
public class afaj
  extends Handler
{
  public afaj(TextPreviewActivity paramTextPreviewActivity, Looper paramLooper)
  {
    super(paramLooper);
  }
    ...
    case 19: 
      do
      {
        do
        {
          ...
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetContainerView.a.setMovementMethod(binf.a());
          return;
