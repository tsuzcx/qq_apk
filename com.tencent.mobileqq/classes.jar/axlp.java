...
public class axlp
{
  ...
  private Map<Integer, ajof> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  private Map<Integer, ajof> e = new HashMap();
  private Map<Integer, Integer> f = new HashMap();
  
  private axlp()
  {
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(1), new ajof(960, 720));
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(2), new ajof(960, 720));
  ...
  private void a()
  {
    ...
    for (;;)
    {
      ...
      for (j = arrayOfString2.length - 1;; j = 0)
      {
        ...
        {
          this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(2), new ajof(arrayOfInt3[i], arrayOfInt2[i]));
          this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(1), new ajof(arrayOfInt3[i], arrayOfInt2[i]));
          this.e.put(Integer.valueOf(2), new ajof(arrayOfInt3[j], arrayOfInt2[j]));
          this.e.put(Integer.valueOf(1), new ajof(arrayOfInt3[j], arrayOfInt2[j]));
        }
        if (localObject != null)
        {
  ...
  public ajof a(int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramInt))) {
      return (ajof)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    }
    return new ajof(960, 720);
  }
  
  public ajof b(int paramInt)
  {
    if (this.e.containsKey(Integer.valueOf(paramInt))) {
      return (ajof)this.e.get(Integer.valueOf(paramInt));
    }
    return new ajof(640, 480);
  }
}
