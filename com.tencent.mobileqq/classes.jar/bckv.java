...
public class bckv
{
  ...
  public bckv(bcgx parambcgx, Context paramContext, int paramInt)
  {
  ...
  private TextView a(bclv parambclv, View paramView)
  {
    ...
    if (paramView == null)
    {
      ...
      if (!TextUtils.isEmpty(parambclv.b()))
      {
        localTextView.setText(parambclv.b().trim());
        paramView = localTextView;
      }
    }
    do
    {
      ...
      paramView = localTextView;
    } while (TextUtils.isEmpty(parambclv.b()));
    localTextView.setText(parambclv.b().trim());
  ...
  public static boolean a(bcgx parambcgx, int paramInt)
  {
    ...
    if ((localObject == null) || (TextUtils.isEmpty(parambcgx.ab)) || ((!ugf.a((QQAppInterface)localObject, parambcgx.ab)) && (!"2909288299".equals(parambcgx.ab)) && (!"3338705755".equals(parambcgx.ab)))) {}
    int j;
    label83:
    do
    {
      ...
      j = 0;
      paramInt = 0;
      if (i < parambcgx.a.size())
      {
        localObject = ((bcgw)parambcgx.a.get(i)).a;
        int m;
        int k;
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (paramView != null)
    {
      ...
      if ((paramView instanceof LinearLayout))
      {
        ...
        localFrameLayout = (FrameLayout)((LinearLayout)localObject1).findViewById(2131377960);
        if (localFrameLayout != null)
        {
          ...
          if (k < this.jdField_a_of_type_Bcgx.a.size())
          {
            localObject2 = (bcgw)this.jdField_a_of_type_Bcgx.a.get(k);
            str = ((bcgw)localObject2).a;
            if ("title".equals(str))
            {
    ...
    for (;;)
    {
      ...
      {
        localObject2 = a((bcgw)localObject2, localFrameLayout, paramBundle);
        m = 1;
        paramContext = paramView;
        paramView = (View)localObject2;
        j = i;
      ...
      else
      {
        if ("summary".equals(str))
        {
          ...
          if ((j != 0) && (!TextUtils.isEmpty(((bclv)localObject2).b())))
          {
            if (((bclv)localObject2).b().trim().length() <= 0)
            {
              localObject2 = paramContext;
              m = i;
              i = j;
            ...
            ((ArrayList)localObject3).add(a((bclv)localObject2, ((LinearLayout)localObject1).findViewById(i + 2131377977)));
            localObject2 = paramContext;
            paramContext = paramView;
            m = i + 1;
            i = j;
            ...
            {
              paramBundle = (TextView)paramContext.findViewById(2131377975);
            ...
            for (;;)
            {
              ...
              paramContext = null;
              paramView = null;
              if (j < this.jdField_a_of_type_Bcgx.a.size())
              {
                localObject2 = (bcgw)this.jdField_a_of_type_Bcgx.a.get(j);
                localObject3 = ((bcgw)localObject2).a;
                ...
                for (;;)
                {
                  ...
                  {
                    localObject2 = a((bcgw)localObject2, null, paramBundle);
                  ...
                  else
                  {
                    ...
                    {
                      localObject2 = (bclv)localObject2;
                      if ((i != 0) && (!TextUtils.isEmpty(((bclv)localObject2).b())))
                      {
                        if (((bclv)localObject2).b().trim().length() <= 0)
                        {
                          localObject2 = paramContext;
                        ...
                        localObject2 = a((bclv)localObject2, null);
                        ((TextView)localObject2).setId(2131377977 + j);
                        ((LinearLayout)localObject1).addView((View)localObject2);
                      }
                    }
                    localObject2 = paramContext;
  ...
  public View a(bcgw parambcgw, View paramView, Bundle paramBundle)
  {
    ...
    if ((parambcgw != null) && ((parambcgw instanceof PAImageView))) {
      ((PAImageView)parambcgw).setUseRadiusRound(true, localResources.getDimensionPixelSize(2131296448));
    }
