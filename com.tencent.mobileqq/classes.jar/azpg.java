...
public final class azpg
{
  ...
  public azpg(cmd0x383.ApplyGetFileListRspBody.FileInfo paramFileInfo)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public azpg(group_file_common.FolderInfo paramFolderInfo)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public azpg(oidb_0x6d8.GetFileListRspBody.Item paramItem)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  {
    String str = bbkb.b(paramContext, paramLong);
    paramContext = str;
    int i1;
    int i2;
    if (str != null)
    ...
    for (;;)
    {
      ...
      try
      {
        if (this.n == null)
        {
          ...
          if (i1 != 0)
          {
            this.n = bbcl.a(paramQQAppInterface, b(), paramLong + "", 1, 0);
            if (this.n.length() <= 10)
            {
              i1 = i5;
              break label307;
  ...
  public String a()
  {
    return bakj.a(this.jdField_a_of_type_Long);
  }
  
  public String a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    return bbcl.a(paramQQAppInterface, b(), paramLong + "", 1, 0);
  }
  ...
  public void a(azpg paramazpg)
  {
    if (paramazpg != null)
    {
      if ((paramazpg.jdField_e_of_type_Int != 8) && (paramazpg.jdField_e_of_type_Int != 9)) {
        break label45;
      }
      if (paramazpg.jdField_b_of_type_JavaLangString != null) {
        this.jdField_a_of_type_JavaUtilMap.put(paramazpg.jdField_b_of_type_JavaLangString, paramazpg);
      }
    }
    label45:
    while (((paramazpg.jdField_e_of_type_Int != 11) && (paramazpg.jdField_e_of_type_Int != 10) && (paramazpg.jdField_e_of_type_Int != 12)) || (paramazpg.jdField_b_of_type_JavaLangString == null)) {
      return;
    }
    this.jdField_a_of_type_JavaUtilMap.remove(paramazpg.jdField_b_of_type_JavaLangString);
  }
  
  public void a(azqt paramazqt, QQAppInterface paramQQAppInterface)
  {
    this.jdField_i_of_type_JavaLangString = paramazqt.jdField_b_of_type_JavaLangString;
    this.j = paramazqt.jdField_c_of_type_JavaLangString;
    this.k = paramazqt.jdField_d_of_type_JavaLangString;
    this.jdField_e_of_type_Int = paramazqt.jdField_b_of_type_Int;
    this.jdField_h_of_type_JavaLangString = paramazqt.jdField_a_of_type_JavaLangString;
    this.jdField_d_of_type_Long = paramazqt.jdField_d_of_type_Long;
    this.jdField_f_of_type_Int = paramazqt.jdField_c_of_type_Int;
    this.jdField_c_of_type_Boolean = paramazqt.jdField_a_of_type_Boolean;
    if (this.jdField_b_of_type_Int == 0)
    {
      this.jdField_b_of_type_Int = paramazqt.jdField_d_of_type_Int;
      this.l = a(BaseApplicationImpl.getApplication(), this.jdField_b_of_type_Int * 1000L);
    }
    if (this.jdField_b_of_type_JavaLangString == null) {
      this.jdField_b_of_type_JavaLangString = paramazqt.jdField_e_of_type_JavaLangString;
    }
    if (this.jdField_f_of_type_JavaLangString == null) {
      this.jdField_f_of_type_JavaLangString = paramazqt.jdField_i_of_type_JavaLangString;
    }
    if (this.jdField_a_of_type_Long == 0L) {
      this.jdField_a_of_type_Long = paramazqt.jdField_c_of_type_Long;
    }
    if (this.jdField_c_of_type_JavaLangString == null) {
      this.jdField_c_of_type_JavaLangString = paramazqt.jdField_g_of_type_JavaLangString;
    }
    if ((this.jdField_a_of_type_Int == 0) || (azph.a(paramazqt.jdField_b_of_type_Int))) {
      this.jdField_a_of_type_Int = paramazqt.jdField_h_of_type_Int;
    }
    if ((this.jdField_b_of_type_Long == 0L) && (azph.a(paramazqt.jdField_b_of_type_Int))) {}
    try
    {
      this.jdField_b_of_type_Long = Long.parseLong(paramQQAppInterface.getCurrentAccountUin());
      return;
    }
    catch (NumberFormatException paramazqt)
    {
  ...
  {
    return (bakj.a(paramQQAppInterface, paramLong)) && (this.jdField_d_of_type_Boolean);
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean)
  {
    ...
    boolean bool2 = bakj.a(paramQQAppInterface, paramLong);
  ...
  public void b(azpg paramazpg)
  {
    ...
    this.jdField_b_of_type_Boolean = false;
    this.jdField_b_of_type_JavaLangString = paramazpg.jdField_b_of_type_JavaLangString;
    this.jdField_f_of_type_JavaLangString = paramazpg.jdField_f_of_type_JavaLangString;
    this.jdField_c_of_type_JavaLangString = paramazpg.jdField_c_of_type_JavaLangString;
    this.jdField_a_of_type_Int = paramazpg.jdField_a_of_type_Int;
    this.jdField_b_of_type_Long = paramazpg.jdField_b_of_type_Long;
    this.jdField_c_of_type_Long = paramazpg.jdField_c_of_type_Long;
    this.jdField_a_of_type_Long = paramazpg.jdField_a_of_type_Long;
    this.jdField_b_of_type_Int = paramazpg.jdField_b_of_type_Int;
    this.jdField_c_of_type_Int = paramazpg.jdField_c_of_type_Int;
    this.jdField_i_of_type_Int = paramazpg.jdField_i_of_type_Int;
    this.jdField_d_of_type_Int = paramazpg.jdField_d_of_type_Int;
    this.jdField_e_of_type_JavaLangString = paramazpg.jdField_e_of_type_JavaLangString;
    this.jdField_h_of_type_Int = paramazpg.jdField_h_of_type_Int;
    this.jdField_d_of_type_JavaLangString = paramazpg.jdField_d_of_type_JavaLangString;
    this.jdField_d_of_type_Boolean = paramazpg.jdField_d_of_type_Boolean;
    this.l = paramazpg.l;
    this.m = paramazpg.m;
  }
  ...
  {
    return (bakj.a(paramQQAppInterface, paramLong)) && (!this.jdField_d_of_type_Boolean) && (!paramBoolean) && (!azph.a(this.jdField_e_of_type_Int)) && (!azph.b(this.jdField_e_of_type_Int));
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject == null) || (!(paramObject instanceof azpg))) {
      return false;
    }
    paramObject = (azpg)paramObject;
