...
class tkd
{
  ...
  tkc jdField_a_of_type_Tkc;
  
  public tkd(XmlPullParser paramXmlPullParser, tkc paramtkc)
  {
    this.jdField_a_of_type_OrgXmlpullV1XmlPullParser = paramXmlPullParser;
    this.jdField_a_of_type_Tkc = paramtkc;
  }
    ...
    case 2: 
      ...
      do
      {
        for (;;)
        {
          ...
          this.jdField_a_of_type_Tkc.jdField_a_of_type_JavaUtilStack.push(str);
          ...
          while (i < this.jdField_a_of_type_OrgXmlpullV1XmlPullParser.getAttributeCount())
          {
            ...
            {
              this.jdField_a_of_type_Tkc.b.put(m, tjy.a(this.jdField_a_of_type_OrgXmlpullV1XmlPullParser.getAttributeValue(i).trim()));
              return;
            }
            i += 1;
          }
        ...
        if (tjy.d().equals(str))
        {
          this.jdField_a_of_type_Tkc.b.put(m, tkb.a(4, new Object[] { Integer.valueOf(1) }));
          return;
        }
        if (tjy.e().equals(str))
        {
          this.jdField_a_of_type_Tkc.b.put(m, tkb.a(3, new Object[0]));
          return;
        }
        if (tjy.f().equals(str))
        {
          this.jdField_a_of_type_Tkc.b.put(m, tkb.a(4, new Object[] { Integer.valueOf(2) }));
          return;
        }
      } while ((!tjy.g().equals(str)) && (!tjy.h().equals(str)));
      int j = 0;
      int k = 0;
      if (j < this.jdField_a_of_type_OrgXmlpullV1XmlPullParser.getAttributeCount())
      {
        ...
        for (;;)
        {
          ...
          k = i;
          break;
          str = (String)tjy.a(this.jdField_a_of_type_OrgXmlpullV1XmlPullParser.getAttributeValue(j)).get("text-align");
          i = k;
      ...
      this.jdField_a_of_type_Tkc.jdField_a_of_type_AndroidUtilSparseArray.put(m, Integer.valueOf(k));
      return;
    }
    QLog.d("fast_web", 2, new Object[] { "【remove】 depth : ", Integer.valueOf(m), ", name : ", this.jdField_a_of_type_OrgXmlpullV1XmlPullParser.getName(), " size : ", Integer.valueOf(this.jdField_a_of_type_Tkc.b.size()) });
    if (!this.jdField_a_of_type_Tkc.jdField_a_of_type_JavaUtilStack.isEmpty())
    {
      this.jdField_a_of_type_Tkc.jdField_a_of_type_JavaUtilStack.pop();
      this.jdField_a_of_type_Tkc.b.remove(m);
      this.jdField_a_of_type_Tkc.jdField_a_of_type_AndroidUtilSparseArray.remove(m);
      return;
    }
