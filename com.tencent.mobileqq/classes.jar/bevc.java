...
public class bevc
  extends aomz
{
  public bevc(QQAppInterface paramQQAppInterface, ProxyManager paramProxyManager)
  {
  ...
  public void a(long paramLong, UUID paramUUID)
  {
    ...
    bevx.c("TroopFileDataBaseProxy", bevx.a, "[" + paramUUID.toString() + "] deleteItem");
    ...
    paramUUID = new bevf(this, paramUUID);
  ...
  public void a(TroopFileTansferItemEntity paramTroopFileTansferItemEntity)
  {
    ...
    bevx.c("TroopFileDataBaseProxy", bevx.a, "[" + paramTroopFileTansferItemEntity.Id.toString() + "] updateItem transStatus[" + paramTroopFileTansferItemEntity.Status + "] FilePath[" + paramTroopFileTansferItemEntity.FilePath + "]");
    ...
    for (;;)
    {
      ...
      localContentValues.put("_sStatus", besm.a(i));
      String str1 = paramTroopFileTansferItemEntity.getTableName();
      String str2 = paramTroopFileTansferItemEntity.Id.toString();
      paramTroopFileTansferItemEntity = new beve(this, paramTroopFileTansferItemEntity);
  ...
  {
    bevx.c("TroopFileDataBaseProxy", bevx.a, "[" + paramTroopFileTansferItemEntity.Id.toString() + "] addItem status[" + paramTroopFileTansferItemEntity.getStatus() + "]");
    paramProxyListener = new bevd(this, paramTroopFileTansferItemEntity);
    ...
    bevx.a("TroopFileDataBaseProxy", bevx.a, "Item status[" + String.valueOf(paramTroopFileTansferItemEntity.getStatus()) + "] is wrong");
  }
