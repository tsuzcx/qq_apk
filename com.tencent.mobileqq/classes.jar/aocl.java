...
public class aocl
  implements aodu
{
  public aocl(ArConfigService paramArConfigService) {}
  ...
  public void a(int paramInt)
  {
    ...
    try
    {
      ...
      while (i < j)
      {
        ((aofm)ArConfigService.a(this.a).getBroadcastItem(i)).a(paramInt);
        i += 1;
      }
    ...
    catch (RemoteException localRemoteException)
    {
      ...
      aocu.a(localRemoteException.getCurrentAccountUin(), false, paramInt);
    }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    try
    {
      ...
      while (i < j)
      {
        ((aofm)ArConfigService.a(this.a).getBroadcastItem(i)).a(paramLong1, paramLong2);
        i += 1;
      }
      ArConfigService.a(this.a).finishBroadcast();
      return;
  ...
  public void a(ARCommonConfigInfo paramARCommonConfigInfo)
  {
    ...
    try
    {
      ...
      while (i < j)
      {
        ((aofm)ArConfigService.a(this.a).getBroadcastItem(i)).a(null, null, paramARCommonConfigInfo);
        i += 1;
      }
      ArConfigService.a(this.a).finishBroadcast();
      return;
  ...
  public void a(ArConfigInfo paramArConfigInfo)
  {
    ...
    try
    {
      ...
      while (i < j)
      {
        ((aofm)ArConfigService.a(this.a).getBroadcastItem(i)).a(paramArConfigInfo, null, null);
        i += 1;
      }
      ArConfigService.a(this.a).finishBroadcast();
      return;
  ...
  public void a(ArEffectConfig paramArEffectConfig)
  {
    ...
    try
    {
      ...
      while (i < j)
      {
        ((aofm)ArConfigService.a(this.a).getBroadcastItem(i)).a(null, paramArEffectConfig, null);
        i += 1;
      }
      ArConfigService.a(this.a).finishBroadcast();
      return;
  ...
  public void b()
  {
      ...
      try
      {
        ...
        for (;;)
        {
          if (i < j) {
            try
            {
              ((aofm)ArConfigService.a(this.a).getBroadcastItem(i)).a();
              i += 1;
            }
            catch (RemoteException localRemoteException)
            {
    ...
    aocu.a(((QQAppInterface)???).getCurrentAccountUin(), true, 0);
  }
}
