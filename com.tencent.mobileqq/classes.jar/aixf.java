...
public class aixf
  extends amgy
{
  public aixf(PublicView paramPublicView, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      return localObject1;
      localObject2 = (aixh)paramView.getTag();
    ...
    for (;;)
    {
      ...
      {
        localObject2 = this.a.getResources().getDrawable(2130841803);
        int i = (int)bhdz.a(this.a.a, 15.0F);
