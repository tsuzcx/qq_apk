  ...
  extends BaseAdapter
{
  ...
  zcr jdField_a_of_type_Zcr;
  boolean jdField_a_of_type_Boolean = false;
  boolean b = true;
  
  public akjh(Context paramContext, JSONArray paramJSONArray, zcr paramzcr)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Zcr = paramzcr;
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      if (this.jdField_a_of_type_Zcr != null)
      {
        this.jdField_a_of_type_Zcr.a("com.tencent.biz.hotchatpostlist.widget.HotChatPostItemView");
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if ((paramView == null) && (this.jdField_a_of_type_Boolean)) {
      paramView = this.jdField_a_of_type_Zcr.a("com.tencent.biz.hotchatpostlist.widget.HotChatPostItemView");
    }
    for (;;)
    {
      ...
      if (paramView != null) {
        paramViewGroup.setOnClickListener(new akjj(this, paramView.optString("bid"), paramView.optString("pid")));
      }
      try
      {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        zcr.a(paramViewGroup, paramView.toString());
        return paramViewGroup;
      }
    }
  }
  ...
  {
    Collections.sort(this.jdField_a_of_type_JavaUtilArrayList, new akji(this));
