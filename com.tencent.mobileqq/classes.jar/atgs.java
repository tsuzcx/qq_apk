...
public class atgs
{
  ...
  private atdw jdField_a_of_type_Atdw = new atgt(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private LinkedHashMap<String, atgu> jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
  private List<atgu> jdField_a_of_type_JavaUtilList = new ArrayList();
  private List<String> b = new ArrayList();
  
  public atgs(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(atgu paramatgu)
  {
    if (paramatgu == null) {}
    do
    {
      return;
      this.jdField_a_of_type_JavaUtilLinkedHashMap.put(paramatgu.jdField_a_of_type_JavaLangString, paramatgu);
  ...
  {
    paramString2 = atvo.g(paramString2);
    if (!a(paramString1, paramString2)) {
      return false;
    }
    atgu localatgu = new atgu();
    localatgu.b = paramString1;
    localatgu.jdField_a_of_type_JavaLangString = paramString2;
    localatgu.jdField_a_of_type_Long = paramLong;
    this.b.add(paramString2);
    this.jdField_a_of_type_JavaUtilList.add(localatgu);
    return true;
  }
  ...
  private boolean a(String paramString1, String paramString2)
  {
    ...
    while (atwl.b(paramString1)) {
      return false;
    }
    return true;
  }
  
  private void b(atgu paramatgu)
  {
    if (paramatgu == null) {
      return;
    }
    new atdv(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(paramatgu.jdField_a_of_type_Long, paramatgu.b, paramatgu.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Atdw);
  }
