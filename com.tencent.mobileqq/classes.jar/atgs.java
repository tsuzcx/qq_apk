...
public class atgs
{
  ...
  private atgu jdField_a_of_type_Atgu;
  private atgv jdField_a_of_type_Atgv = new atgt(this);
  private Object jdField_a_of_type_JavaLangObject = new Object();
  private List<atgv> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public atgs(long paramLong, String paramString, Bundle paramBundle)
  {
  ...
  public static String a(int paramInt)
  {
    ...
    case 1: 
      return str + "[" + String.valueOf(paramInt) + "]";
    case 2: 
      return amtj.a(2131714906);
    case 3: 
      return amtj.a(2131714894);
    case 4: 
      return amtj.a(2131714899);
    case 5: 
      return amtj.a(2131714896);
    case 6: 
      return amtj.a(2131714907);
    case 7: 
      return amtj.a(2131714904);
    case 8: 
      return amtj.a(2131714905);
    case 9: 
      return amtj.a(2131714903);
    case 10: 
      return "SDK下载服务错误";
    case 11: 
      return amtj.a(2131714898);
    case 12: 
      return "下载器DC失败";
    case 13: 
      return amtj.a(2131714897);
    }
    return amtj.a(2131714902);
  }
  ...
  private List<atgv> a()
  {
    ...
    synchronized (this.jdField_b_of_type_JavaLangObject)
    {
      ...
      while (i < j)
      {
        localArrayList.add((atgv)this.jdField_a_of_type_JavaUtilList.get(i));
        i += 1;
      }
  ...
  private boolean a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 150	atgs:jdField_a_of_type_Atgu	Latgu;
    //   8: ifnull +24 -> 32
    //   11: aload_0
    //   12: getfield 150	atgs:jdField_a_of_type_Atgu	Latgu;
    //   15: aconst_null
    //   16: invokeinterface 155 2 0
    //   21: pop
    //   22: aload_0
    //   23: getfield 150	atgs:jdField_a_of_type_Atgu	Latgu;
    ...
    //   36: aload_0
    //   37: iconst_1
    //   38: putfield 29	atgs:jdField_a_of_type_Int	I
    //   41: aload_0
    //   42: new 159	atgw
    //   45: dup
    //   46: aload_0
    //   47: getfield 51	atgs:jdField_a_of_type_Long	J
    //   50: invokespecial 162	atgw:<init>	(J)V
    //   53: putfield 150	atgs:jdField_a_of_type_Atgu	Latgu;
    //   56: aload_0
    //   57: getfield 150	atgs:jdField_a_of_type_Atgu	Latgu;
    //   60: aload_0
    //   61: getfield 45	atgs:jdField_a_of_type_Atgv	Latgv;
    //   64: invokeinterface 155 2 0
    //   69: pop
    //   70: iload_3
    //   71: istore_1
    //   72: aload_0
    //   73: getfield 150	atgs:jdField_a_of_type_Atgu	Latgu;
    //   76: aload_0
    //   77: getfield 47	atgs:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   80: aload_2
    //   81: invokeinterface 165 3 0
    //   86: ifeq +39 -> 125
    //   89: getstatic 22	atgs:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   92: iconst_1
    ...
    //   105: aload_0
    //   106: getfield 51	atgs:jdField_a_of_type_Long	J
    ...
    //   129: aload_0
    //   130: iconst_2
    //   131: putfield 29	atgs:jdField_a_of_type_Int	I
    //   134: aload_0
    //   135: new 180	athe
    //   138: dup
    //   139: aload_0
    //   140: getfield 51	atgs:jdField_a_of_type_Long	J
    //   143: invokespecial 181	athe:<init>	(J)V
    //   146: putfield 150	atgs:jdField_a_of_type_Atgu	Latgu;
    //   149: goto -93 -> 56
    //   152: astore_2
    //   153: aload_0
    //   154: monitorexit
  ...
  public void a(atgv paramatgv)
  {
    synchronized (this.jdField_b_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_JavaUtilList.contains(paramatgv)) {
        this.jdField_a_of_type_JavaUtilList.remove(paramatgv);
      }
      return;
    }
  }
  
  public void a(atgv paramatgv, boolean paramBoolean)
  {
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        ...
        if ((atgv)this.jdField_a_of_type_JavaUtilList.get(i) == paramatgv)
        {
          if (paramBoolean == true)
          {
            ...
            paramatgv = (atgv)this.jdField_a_of_type_JavaUtilList.remove(i);
            this.jdField_a_of_type_JavaUtilList.add(paramatgv);
      ...
      if (paramatgv != null)
      {
        ...
        atgv localatgv = (atgv)this.jdField_a_of_type_JavaUtilList.remove(i - 1);
        this.jdField_a_of_type_JavaUtilList.add(paramatgv);
        this.jdField_a_of_type_JavaUtilList.add(localatgv);
      }
      for (;;)
      {
  ...
  public boolean a(Bundle paramBundle)
  {
    ...
    String str1 = aszt.b(asyy.a().c() + (String)localObject1);
    String str2 = asyy.a().b() + (String)localObject1;
    ...
    return a(atgn.a((String)localObject1), (Bundle)localObject2);
  }
  ...
  public int b()
  {
    if (this.jdField_a_of_type_Atgu != null)
    {
      ...
      return this.jdField_a_of_type_Atgu.c();
    }
  ...
  public int c()
  {
    if (this.jdField_a_of_type_Atgu != null)
    {
      ...
      return this.jdField_a_of_type_Atgu.d();
    }
  ...
  public int d()
  {
    if (this.jdField_a_of_type_Atgu != null)
    {
      ...
      return this.jdField_a_of_type_Atgu.b();
    }
  ...
  public int e()
  {
    if (this.jdField_a_of_type_Atgu != null)
    {
      ...
      return this.jdField_a_of_type_Atgu.f();
    }
  ...
  {
    if (this.jdField_a_of_type_Atgu != null) {
      return this.jdField_a_of_type_Atgu.e();
    }
