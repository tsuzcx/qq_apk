  ...
  implements Manager
{
  ...
  private WeakReference<amia> jdField_a_of_type_MqqUtilWeakReference;
  private WeakReference<amib> b;
  
  public amhy(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Amia = new amhz(this);
  ...
  private boolean a()
  {
    ...
    if ((amhd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) && (localamhd != null) && (1 == localamhd.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()))) {
      return true;
    }
  ...
  public void a(int paramInt, apollo_push_msgInfo.STPushMsgElem paramSTPushMsgElem)
  {
    ...
    for (;;)
    {
      ...
      ((ancd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).a(paramSTPushMsgElem);
      ...
      if ((!TextUtils.isEmpty(str)) && (!str.equals(localObject))) {
        amhd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, "apllo_redPack_action");
      }
      if ((TextUtils.isEmpty(str)) || (str.equals(paramSTPushMsgElem))) {
        break;
      }
      amhd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramSTPushMsgElem, "apllo_redPack_action");
      return;
  ...
  public void a(amia paramamia)
  {
    ...
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramamia);
  }
  
  public void a(amib paramamib)
  {
    if (paramamib == null)
    {
      this.b = null;
    ...
    this.b = new WeakReference(paramamib);
  }
  ...
  public void a(ApolloActionPush paramApolloActionPush)
  {
    ...
    if (paramApolloActionPush.mWordShowType == 1)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        ...
        localObject2 = ((ancd)localObject1).a(localSpriteTaskParam.f);
        if (localObject2 == null) {
          break label253;
        }
        if (TextUtils.isEmpty(localSpriteTaskParam.jdField_c_of_type_JavaLangString)) {
          localSpriteTaskParam.jdField_c_of_type_JavaLangString = amzq.a(((ApolloActionData)localObject2).bubbleText);
        }
      }
    }
    for (;;)
    {
      localObject1 = amuo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (localObject1 != null) {
        ((amul)localObject1).a().a(localSpriteTaskParam);
      }
      ...
      ((ancd)localObject1).a((List)localObject2);
    }
  }
  ...
  public void a(apollo_push_msgInfo.STPushMsgElem paramSTPushMsgElem)
  {
    ...
    do
    {
      do
      {
        for (;;)
        {
          ...
          if ((a()) && ("tab_list_android_json_v665".equals(localObject1)))
          {
            ...
            if (m > i)
            {
              ((amhd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(true, "onLinePush", 1);
              if (!QLog.isColorLevel()) {
                continue;
              }
            ...
            if ((a()) && (aoph.a().equals(localObject1)))
            {
              i = 0;
              localObject1 = new File(ancb.av);
              if (!((File)localObject1).exists())
              {
                ...
                i = 1;
                localObject1 = ancb.av + "base.zip";
                if (i != 0)
                {
                  localObject2 = new Bundle();
                  ((Bundle)localObject2).putLong("version", m);
                  amxb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject1, ancb.at, (Bundle)localObject2, new aopj());
                }
                if (!QLog.isColorLevel()) {
                  continue;
                }
              ...
              if ("apollo_thunder_json_v670".equals(localObject1)) {
                amyz.a(null, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, m, false);
              }
            }
          }
        }
      ...
      for (;;)
      {
        try
        {
          ...
          l = ((amhd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(1, i) / 1000L;
          if (l != m) {
            amxb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), null, i, null, -1, -1, true);
          }
          if (!QLog.isColorLevel()) {
            break;
          }
    ...
    for (;;)
    {
      try
      {
        localObject2 = (amhd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
        if ((!amhd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) || (localObject2 == null) || (1 != ((amhd)localObject2).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()))) {
          break;
        }
        i = Integer.parseInt(localException1);
        l = ((amhd)localObject2).a(2, i) / 1000L;
        if (l != m) {
          amxb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), null, -1, new int[] { i }, -1, -1, true);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
  ...
  public void b(apollo_push_msgInfo.STPushMsgElem paramSTPushMsgElem)
  {
    ...
    if ((localObject2 != null) && (((List)localObject2).size() > 0))
    {
        ...
        for (;;)
        {
          ...
          if (this.b != null)
          {
            ...
            if (this.b.get() != null)
            {
              ...
              {
                j = 2;
                ((amib)this.b.get()).a(1, localObject3);
              }
            }
          }
          i = j;
      ...
      localObject1 = (ancd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
      if (localObject1 != null) {
        ((ancd)localObject1).a(paramSTPushMsgElem, i);
      }
      for (;;)
      {
        ((annl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(255)).a(NetConnInfoCenter.getServerTimeMillis());
        return;
