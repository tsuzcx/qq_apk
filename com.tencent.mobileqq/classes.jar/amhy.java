  ...
  implements amhu, amhv, Manager
{
  ...
  private List<amhq> jdField_a_of_type_JavaUtilList;
  ...
  private long a(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return l3;
          ConcurrentHashMap localConcurrentHashMap = this.jdField_a_of_type_Amhr.a();
          ...
          if (localObject != null)
          {
            ...
            if (((List)localObject).size() > 0)
            {
              ...
              for (;;)
              {
                ...
                amht localamht = (amht)localConcurrentHashMap.get(str);
                l2 = l1;
                if (localamht != null)
                {
                  l2 = l1 + localamht.jdField_a_of_type_Long;
                  localamht.b += 1;
                  this.jdField_a_of_type_Amhr.a(str, localamht);
                }
                l1 = l2;
              }
            }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        else if (amib.c(i))
        {
          paramList = awbo.a(paramList);
          if (paramList != null) {
            paramList = aroo.a(this.jdField_a_of_type_ComTencentMobileqqAppPeakAppInterface, paramList);
          }
        }
        else if (amib.d(i))
        {
        ...
        {
          paramList = awbo.a(paramList);
          if ((paramList != null) && ((paramList instanceof MessageForStructing)) && (aule.a((MessageForStructing)paramList))) {
            b(paramString, this.jdField_a_of_type_Amhz.c(MessageRecord.class, "select * from mr_multimessage where msgseq=?", "mr_multimessage", "msgseq=?", new String[] { String.valueOf(paramList.uniseq) }));
          }
        }
        paramList = "";
        continue;
  ...
  private String a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      continue;
      str1 = this.jdField_a_of_type_Amhz.a(paramMessageRecord.frienduin);
      continue;
      if (this.jdField_a_of_type_Agft != null)
      {
        str1 = this.jdField_a_of_type_Agft.a(paramMessageRecord.senderuin, paramMessageRecord.frienduin);
        continue;
        str1 = this.jdField_a_of_type_Amhz.a(paramMessageRecord.senderuin, paramMessageRecord.frienduin);
      }
    }
  }
  ...
  private boolean a(amhq paramamhq)
  {
    if ((paramamhq == null) || (this.jdField_a_of_type_Agft == null)) {}
    String str;
    do
    {
      return true;
      str = MessageRecord.getTableName(paramamhq.jdField_a_of_type_JavaLangString, paramamhq.jdField_a_of_type_Int);
    } while (TextUtils.isEmpty(str));
    b(str);
    if (this.jdField_a_of_type_Agft != null) {
      this.jdField_a_of_type_Agft.b(paramamhq.jdField_a_of_type_JavaLangString, paramamhq.jdField_a_of_type_Int);
    }
    a(str);
    return true;
  }
    ...
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null))
    {
      ...
      if ((localObject != null) && (((List)localObject).size() > 0))
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          amht localamht = (amht)localConcurrentHashMap.get(str1);
          if (localamht != null)
          {
            localamht.b -= 1;
            if (localamht.b == 0)
            {
              String str2 = this.jdField_a_of_type_Amhr.a(localamht);
              if (!TextUtils.isEmpty(str2))
              {
                this.jdField_a_of_type_Long += localamht.jdField_a_of_type_Long;
                paramString.add(str2);
              }
              this.jdField_a_of_type_Amhr.a(str1);
            }
            else
            {
              this.jdField_a_of_type_Amhr.a(str1, localamht);
            }
          }
        }
        this.jdField_a_of_type_Amhr.a(paramString);
      }
    }
  }
  ...
  private boolean b()
  {
    return (this.jdField_a_of_type_Amhr != null) && (this.jdField_a_of_type_Amhr.a());
  }
  
  private void c()
  {
    this.jdField_a_of_type_Amhz = new amhz();
    AppInterface localAppInterface = this.jdField_a_of_type_Amhz.a();
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_Amhz.a(this);
    this.jdField_a_of_type_Amhr = new amhr(this);
  }
  ...
  private void f()
  {
    ...
    Object localObject = this.jdField_a_of_type_Amhz.a();
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      b(str1, this.jdField_a_of_type_Amhz.a(MessageRecord.class, str2, str1, null, null));
    }
    this.jdField_b_of_type_Boolean = true;
    if (QLog.isColorLevel()) {
  ...
  private void g()
  {
    ...
    Object localObject = this.jdField_a_of_type_Amhz.b();
    if ((localObject == null) || (((ArrayList)localObject).size() == 0))
    {
      if (QLog.isColorLevel()) {
    ...
    while (((Iterator)localObject).hasNext())
    {
      String str1 = (String)((Iterator)localObject).next();
      String str2 = String.format("select * from %s", new Object[] { str1 });
      b(str1, this.jdField_a_of_type_Amhz.b(MessageRecord.class, str2, str1, null, null));
    }
    this.c = true;
    if (QLog.isColorLevel()) {
  ...
  private void h()
  {
    if ((a()) && (b()))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localamhq.jdField_a_of_type_JavaLangString = ((MessageRecord)localObject).frienduin;
          localamhq.jdField_b_of_type_JavaLangString = a((MessageRecord)localObject);
          localamhq.jdField_a_of_type_Int = ((MessageRecord)localObject).istroop;
          localamhq.jdField_b_of_type_Long = ((MessageRecord)localObject).time;
          localamhq.jdField_a_of_type_Long = a(MessageRecord.getTableName(localamhq.jdField_a_of_type_JavaLangString, ((MessageRecord)localObject).istroop));
          if ((localamhq.jdField_a_of_type_Long > 0L) && (this.jdField_a_of_type_JavaUtilList != null))
          {
            localamhq.c = amhs.a(localamhq.jdField_a_of_type_Long);
            this.jdField_a_of_type_JavaUtilList.add(localamhq);
          }
        }
      }
      ...
      if (this.jdField_a_of_type_Amhw != null)
      {
        ...
        this.jdField_a_of_type_Amhw.a(this.jdField_a_of_type_JavaUtilList);
      }
    }
    for (;;)
    {
  ...
  public List<amhq> a(int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilList != null) {
      Collections.sort(this.jdField_a_of_type_JavaUtilList, new amhp(paramInt));
    }
    return this.jdField_a_of_type_JavaUtilList;
  }
  
  public List<amhq> a(List<amhq> paramList)
  {
    if ((paramList == null) || (paramList.isEmpty()) || (this.jdField_a_of_type_Agft == null)) {
      return this.jdField_a_of_type_JavaUtilList;
    }
    if (QLog.isColorLevel()) {
    ...
    while (paramList.hasNext())
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList != null) {
        this.jdField_a_of_type_JavaUtilList.remove(localamhq);
      }
    }
    return this.jdField_a_of_type_JavaUtilList;
  }
  ...
  public void a(String paramString, awbv paramawbv)
  {
    if ((TextUtils.isEmpty(paramString)) || (paramawbv == null)) {
      if (QLog.isColorLevel()) {
        QLog.e("MessageCleanManager", 2, "onNotifyLastMsg tableName or entity is null");
      }
    }
    while ((!(paramawbv instanceof MessageRecord)) || (this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap == null)) {
      return;
    }
    this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, (MessageRecord)paramawbv);
  }
  
  public void a(String paramString, List<? extends awbv> paramList)
  {
    if ((paramList == null) || (paramList.isEmpty())) {
      if (QLog.isColorLevel()) {
  ...
  public void b()
  {
    ...
    } while (this.jdField_a_of_type_Amhw == null);
    if (QLog.isColorLevel()) {
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_Agft = null;
  }
}
