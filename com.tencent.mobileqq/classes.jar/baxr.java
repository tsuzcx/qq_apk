  ...
  extends bayu
{
  ...
  public baxr()
  {
    this.jdField_c_of_type_Int = 2131167093;
  ...
  public baxr(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong, List<String> paramList, int paramInt)
  {
    this.jdField_c_of_type_Int = 2131167093;
    this.jdField_g_of_type_Int = -1;
    this.jdField_h_of_type_Int = -1;
  ...
  public baxr(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong, List<String> paramList, int paramInt1, String paramString7, String paramString8, int paramInt2, String paramString9, String paramString10, String paramString11)
  {
    this.jdField_c_of_type_Int = 2131167093;
    this.jdField_g_of_type_Int = -1;
    this.jdField_h_of_type_Int = -1;
    ...
    this.jdField_l_of_type_JavaLangString = paramString9;
  ...
  private void a()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          bily.a((QQAppInterface)localObject3, this.jdField_l_of_type_Int, this.jdField_b_of_type_JavaLangString);
          bily.a((QQAppInterface)localObject3, this.jdField_b_of_type_JavaLangString, str1);
          if ((!bily.b(this.jdField_l_of_type_Int)) && (!bily.c(this.jdField_l_of_type_Int))) {
            break;
          }
      ...
      if (TextUtils.isEmpty((CharSequence)localObject2)) {
        localObject1 = this.jdField_a_of_type_AndroidContentContext.getString(2131695629);
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = bbfy.a(Long.parseLong(((JSONObject)localObject3).optString("create_time")));
  ...
  public CharSequence a()
  {
    ...
    do
    {
      try
      {
        CharSequence localCharSequence = bbgk.a(this.jdField_c_of_type_JavaLangString, a(), true);
      ...
      localObject = new bbfz(this.jdField_a_of_type_JavaUtilList, a());
      if (d() != 1002) {
        break;
      }
      this.jdField_c_of_type_JavaLangString = bbgk.a(this.jdField_c_of_type_JavaLangString);
      localSpannableString = ((bbfz)localObject).a(this.jdField_c_of_type_JavaLangString, true);
      localObject = localSpannableString;
    } while (localSpannableString != null);
    return "";
    this.jdField_c_of_type_JavaLangString = bbgk.a(this.jdField_c_of_type_JavaLangString);
    SpannableString localSpannableString = ((bbfz)localObject).a(this.jdField_c_of_type_JavaLangString, true);
    if (((bbfz)localObject).jdField_a_of_type_Int > 0) {}
    for (;;)
    {
  ...
  public Object a(String paramString)
  {
    ...
    {
      paramString = BaseApplicationImpl.getApplication().getResources().getString(2131698714);
      ...
      for (;;)
      {
        ...
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131698716);
        continue;
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131698714);
        bool = true;
        continue;
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131698715);
      }
    }
  ...
  public void a(View paramView)
  {
    ...
    default: 
      ...
      if ((localObject2 instanceof basu))
      {
        localObject3 = (basu)localObject2;
        if (((basu)localObject3).b()) {}
        localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
        localObject1 = ((basu)localObject3).a();
        if (!(localObject1 instanceof bast)) {
          break label2613;
        }
      }
      break;
    ...
    label2565:
    label2613:
    for (Object localObject1 = (bast)localObject1;; localObject1 = null)
    {
      switch (((basu)localObject3).a())
      {
      default: 
        label204:
        if (d() == 268435456)
        {
          bbgk.a("all_result", "clk_function", new String[] { "" + this.jdField_a_of_type_JavaLangString, "" + this.jdField_b_of_type_JavaLangString, "" + (this.jdField_j_of_type_Int + 1) });
          if ("63".equals(b()))
          {
            localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
            if (!alhb.a(paramView.getContext(), (QQAppInterface)localObject1)) {
              break;
            }
          }
        }
      ...
      do
      {
        ...
        {
          return;
          bbgk.a(this.jdField_a_of_type_JavaLangString, 70, 0, this.jdField_j_of_type_Int, paramView);
          if (this.jdField_o_of_type_Int == 1)
          {
            bcef.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 0, 0, "", "", "", "");
            bcef.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 2, 0, "", "", "", "");
            break;
          }
          bcef.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 0, 0, "", "", "", "");
          bcef.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 1, 0, "", "", "", "");
          break;
          bbgk.a(this.jdField_a_of_type_JavaLangString, 80, 0, this.jdField_j_of_type_Int, paramView);
          break;
          bbgk.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.jdField_a_of_type_JavaLangString, this.jdField_s_of_type_JavaLangString, e(), e());
          bbgk.a(this.jdField_a_of_type_JavaLangString, 120, 0, this.jdField_j_of_type_Int, paramView);
          if ((this.jdField_s_of_type_JavaLangString != null) && (!TextUtils.isEmpty(this.jdField_s_of_type_JavaLangString)))
          {
            bbda.a(null, 0, this.jdField_a_of_type_Int, "0X8009D31", 4, 0, this.jdField_b_of_type_JavaLangString, null);
            break;
          }
          ...
          {
            bbda.a(null, 0, this.jdField_a_of_type_Int, "0X8009D35", 0, 0, this.jdField_b_of_type_JavaLangString, null);
            break;
          }
          bbda.a(null, 0, this.jdField_a_of_type_Int, "0X8009D49", 0, 0, this.jdField_b_of_type_JavaLangString, null);
          break;
          QQAppInterface localQQAppInterface;
          JSONObject localJSONObject;
          if ((batb.jdField_b_of_type_JavaUtilHashMap.containsKey(this)) && (d() != 268435456))
          {
            localObject4 = (batc)batb.jdField_b_of_type_JavaUtilHashMap.get(this);
          ...
          try
          {
            ...
            localJSONObject.put("obj_lct", ((batc)localObject4).jdField_a_of_type_Int);
            localJSONObject.put("get_src", "web");
            bbda.a(null, new ReportModelDC02528().module("all_result").action("clk_item").obj1(this.jdField_a_of_type_Long + "").obj2(((batc)localObject4).jdField_b_of_type_JavaLangString).ver1(this.jdField_a_of_type_JavaLangString).ver2(bbda.a(this.jdField_a_of_type_Int)).ver7(localJSONObject.toString()).session_id(localQQAppInterface.getCurrentAccountUin() + batb.jdField_a_of_type_Long));
            if (bbgk.a(this.jdField_a_of_type_Long)) {
              if (batb.jdField_a_of_type_JavaUtilHashMap.containsKey(this))
              {
                localObject4 = (batc)batb.jdField_a_of_type_JavaUtilHashMap.get(this);
                if (((batc)localObject4).jdField_b_of_type_Boolean)
                {
                  i1 = 2;
                  bbgk.a("all_result", "clk_object", i1, 0, new String[] { this.jdField_a_of_type_JavaLangString, "" + this.jdField_a_of_type_Long, ((batc)localObject4).jdField_b_of_type_JavaLangString + "", ((batc)localObject4).jdField_a_of_type_Int + "" });
                }
              }
              else
              {
                if ((localObject1 == null) || (!((bast)localObject1).b())) {
                  break label204;
                }
                ((bast)localObject1).a(true);
                bbgk.a("all_result", "clk_first_result", new String[] { ((basu)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(3), bbgk.a("dynamic_tab_search.1", ((basu)localObject3).a()) });
              }
            }
          }
          catch (JSONException localJSONException2)
          {
            ...
            if (batb.jdField_b_of_type_Boolean) {}
            for (i1 = 2;; i1 = 1)
            {
              bbgk.a("all_result", "clk_content", i1, 0, new String[] { ((basu)localObject3).a(), "" + this.jdField_a_of_type_Long, "", bbgk.a("dynamic_tab_search.1", ((basu)localObject3).a()) });
              if ((localObject1 == null) || (!((bast)localObject1).b())) {
                break;
              }
              ((bast)localObject1).a(true);
              bbgk.a("all_result", "clk_first_result", new String[] { ((basu)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), bbgk.a("dynamic_tab_search.1", ((basu)localObject3).a()) });
              break;
            }
          }
        }
        ...
        {
          ((bast)localObject1).a(true);
          bbgk.a("all_result", "clk_tab_first_result", new String[] { ((basu)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), bbgk.a("dynamic_tab_search.1", ((basu)localObject3).a()) });
        }
        bbgk.a("all_result", "clk_tab_result", new String[] { ((basu)localObject3).a(), "" + this.jdField_a_of_type_Long, "", bbgk.a("dynamic_tab_search.1", ((basu)localObject3).a()) });
        break label204;
        if ((localObject1 != null) && (((bast)localObject1).b()))
        {
          ((bast)localObject1).a(true);
          bbgk.a("sub_result", "clk_sub_first_result", new String[] { ((basu)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), bbgk.a("dynamic_tab_search.1", ((basu)localObject3).a()) });
        }
        bbgk.a("sub_result", "clk_result", new String[] { ((basu)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), bbgk.a("dynamic_tab_search.1", ((basu)localObject3).a()) });
        break label204;
        if (((paramView.getContext() instanceof UniteSearchActivity)) && (batb.jdField_b_of_type_JavaUtilHashMap.containsKey(this)))
        {
          localObject1 = (batc)batb.jdField_b_of_type_JavaUtilHashMap.get(this);
          localObject3 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
          localObject4 = new JSONObject();
        }
        try
        {
          ((JSONObject)localObject4).put("project", bbda.a());
          ((JSONObject)localObject4).put("event_src", "client");
          ((JSONObject)localObject4).put("obj_lct", ((batc)localObject1).jdField_a_of_type_Int);
          ((JSONObject)localObject4).put("get_src", "native");
          bbda.a(null, new ReportModelDC02528().module("all_result").action("clk_item").obj1(((batc)localObject1).jdField_a_of_type_Long + "").obj2(((batc)localObject1).jdField_b_of_type_JavaLangString).ver1(((batc)localObject1).jdField_a_of_type_JavaLangString).ver2(bbda.a(UniteSearchActivity.jdField_d_of_type_Int)).ver7(((JSONObject)localObject4).toString()).session_id(((QQAppInterface)localObject3).getCurrentAccountUin() + batb.jdField_a_of_type_Long));
        ...
        catch (JSONException localJSONException1)
        {
          ...
          {
            paramView = bfwg.a(((BaseActivity)paramView.getContext()).app, (Context)localObject2, this.jdField_e_of_type_JavaLangString);
            if (paramView != null)
            {
              paramView.a();
              return;
        ...
        {
          bbgk.a(paramView.getContext(), Integer.valueOf(this.jdField_b_of_type_JavaLangString).intValue(), this.jdField_a_of_type_Int);
          return;
        }
        if (this.jdField_a_of_type_Long == 1001L)
        {
          ...
          if (bezm.b((QQAppInterface)localObject1, this.jdField_b_of_type_JavaLangString))
          {
            bezm.a(paramView.getContext(), null, this.jdField_b_of_type_JavaLangString);
            return;
          }
        }
      ...
      for (;;)
      {
        ...
        TroopUtils.openTroopInfoActivity(paramView.getContext(), (Bundle)localObject1, 2);
        return;
        i1 = 104;
        break;
  ...
  {
    this.jdField_s_of_type_JavaLangString = paramString;
  }
  ...
  {
    bbfz localbbfz = new bbfz(this.jdField_a_of_type_JavaUtilList, a());
    this.jdField_g_of_type_JavaLangString = bbgk.a(this.jdField_g_of_type_JavaLangString);
    SpannableString localSpannableString = null;
    Object localObject = localSpannableString;
    if (this.jdField_f_of_type_Int == 1)
    {
      LhLogoResources localLhLogoResources = bgff.a(this.jdField_g_of_type_Int);
      localObject = localSpannableString;
      if (localLhLogoResources != null) {
        localObject = localLhLogoResources.lightColor;
      }
    }
    localSpannableString = localbbfz.a(bgff.a(this.jdField_f_of_type_Int, this.jdField_g_of_type_Int, false, this.jdField_g_of_type_JavaLangString), (String)localObject, false, false, true);
    localObject = localSpannableString;
    if (localSpannableString == null) {
      localObject = "";
    }
  ...
  public CharSequence c()
  {
    boolean bool = false;
    bbfz localbbfz = new bbfz(this.jdField_a_of_type_JavaUtilList, a());
    this.jdField_a_of_type_JavaLangCharSequence = bbgk.a(this.jdField_a_of_type_JavaLangCharSequence);
    SpannableString localSpannableString = localbbfz.a(this.jdField_a_of_type_JavaLangCharSequence, false, false, false);
    if (localbbfz.jdField_a_of_type_Int > 0) {
      bool = true;
    }
  ...
  public CharSequence d()
  {
    ...
    {
      return localObject;
      localSpannableString = new bbfz(this.jdField_a_of_type_JavaUtilList, a()).a(this.jdField_b_of_type_JavaLangCharSequence, false, this.jdField_a_of_type_Boolean);
      localObject = localSpannableString;
    } while (localSpannableString != null);
    return "";
  }
