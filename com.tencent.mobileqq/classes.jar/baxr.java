  ...
  implements ITransactionCallback
{
  ...
  public baxr(ShortVideoUploadProcessor paramShortVideoUploadProcessor) {}
  ...
  public void onFailed(int paramInt, byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    bdif.a(String.valueOf(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Bayk.jdField_a_of_type_Long), "segment", "index: " + this.jdField_a_of_type_Int + "<BDH_LOG> step: resp onFailed errorCoed:" + paramInt + " BdhTransId : " + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.getTransationId());
    synchronized (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor)
    {
      ...
      paramHashMap = (barh)this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_b_of_type_JavaUtilHashMap.get(Integer.valueOf(this.jdField_a_of_type_Int));
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor)
      {
        ...
        localObject1 = (barh)this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_b_of_type_JavaUtilHashMap.get(Integer.valueOf(this.jdField_a_of_type_Int));
      ...
      if ((ShortVideoUploadProcessor.jdField_a_of_type_Boolean) && (paramArrayOfByte != null) && (paramArrayOfByte.length > 0))
      {
        ...
        try
        {
          ...
          else
          {
            ...
            bdif.a(String.valueOf(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Bayk.jdField_a_of_type_Long), "svrcomp_r", "TransactionListener.onSuccess -> get MD5 from Server success!  MD5:" + HexUtil.bytes2HexStr((byte[])localObject2));
            this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Bayk.f = HexUtil.bytes2HexStr((byte[])localObject2);
            this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Bayk.f;
            if (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_JavaUtilHashMap != null)
            {
              this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_JavaUtilHashMap.put("param_fileMD5", this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Bayk.f);
            ...
            this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Bayk.i = ShortVideoUtils.a((MessageForShortVideo)this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Bayk.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, "mp4");
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Bass;
    Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Bass;
    ...
    ((bass)localObject2).e = l;
    ((bass)localObject1).jdField_a_of_type_Long = l;
  ...
  public void onUpdateProgress(int paramInt)
  {
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Bass.e = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.s;
        if (this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.cacheIp == 0) {
          break label317;
        }
