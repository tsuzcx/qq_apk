  ...
  implements axuv
{
  ...
  static
  {
    jdField_a_of_type_Axzf = new axzf(null);
  }
  
  public axzc(@NotNull QQAppInterface paramQQAppInterface, @NotNull Activity paramActivity, @NotNull axut paramaxut, @NotNull axsv paramaxsv)
  {
    ...
    paramQQAppInterface.findViewById(2131376689).setOnClickListener((View.OnClickListener)new axzd(this));
    this.jdField_b_of_type_AndroidViewView = paramQQAppInterface.findViewById(2131365090);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener((View.OnClickListener)axze.a);
    ...
    paramQQAppInterface = this.jdField_a_of_type_ComTencentQphoneBaseUtilBaseApplication;
    Intrinsics.checkExpressionValueIsNotNull(paramQQAppInterface, "appContext");
    paramQQAppInterface = bfpx.a(paramQQAppInterface.getResources(), 2130841491, this.jdField_c_of_type_Int, i);
    if (paramQQAppInterface != null)
    {
      paramQQAppInterface = bfvo.d(paramQQAppInterface, f1 * f2, this.jdField_c_of_type_Int, i);
    ...
    axia.a((Function0)new ConstellationView.3(this));
  }
  ...
  private final void a(Activity paramActivity, Function0<Unit> paramFunction01, Function0<Unit> paramFunction02)
  {
    ...
    if (!bool)
    {
      avdr.a(paramActivity, bfur.a((Context)paramActivity, 230, paramActivity.getResources().getString(2131697848), paramActivity.getResources().getString(2131697845), 2131697846, 2131697847, (DialogInterface.OnClickListener)new axzj(paramFunction01), (DialogInterface.OnClickListener)new axzk(paramFunction02)));
      return;
    }
  ...
  private final boolean a()
  {
    ...
    return localazbd.a(41609, localCard, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) != 2;
  }
  ...
  private final boolean a(String paramString, ImageView paramImageView)
  {
    ...
    while (i == 0)
    {
      ...
      paramString.setTag(bfol.b(localURLDrawableOptions.mRequestWidth, localURLDrawableOptions.mRequestHeight, (int)(12 * DeviceInfoUtil.getDesity())));
      paramString.setDecodeHandler(bfol.g);
      if (paramImageView != null) {
  ...
  {
    Card localCard = bfrj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    ...
    this.jdField_a_of_type_JavaLangString = bfre.c(this.jdField_a_of_type_Int);
    this.jdField_a_of_type_Axyk = ((axyk)new axzi(this));
  }
  ...
  private final void c()
  {
    ...
    localaxuu.a = ((BaseActivity)localActivity);
    this.jdField_a_of_type_Axut.a(localaxuu, (axuv)this);
  }
  ...
  private final void f()
  {
    ...
    if (this.jdField_a_of_type_Int != 0)
    {
      ...
      localObject2 = ((Resources)localObject1).getString(2131697852);
      Intrinsics.checkExpressionValueIsNotNull(localObject2, "res.getString(R.string.q…nstellation_select_part1)");
      localObject1 = ((Resources)localObject1).getString(2131697853);
      ...
      if (localObject2 != null)
      {
        ...
        ((TextView)localObject2).setOnClickListener((View.OnClickListener)new axzg(this, (String)localObject1));
        ((TextView)localObject2).setOnTouchListener((View.OnTouchListener)new mun());
        if (!bjuk.a()) {
          break label193;
        }
    ...
    for (;;)
    {
      ...
      break;
      label160:
      localObject2 = ((Resources)localObject1).getString(2131697850);
      Intrinsics.checkExpressionValueIsNotNull(localObject2, "res.getString(R.string.q…select_no_birthday_part1)");
      localObject1 = ((Resources)localObject1).getString(2131697851);
  ...
  public final View a()
  {
    View localView = View.inflate((Context)BaseApplication.context, 2131561472, null);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131365006));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131365007));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131377038));
    this.e = ((TextView)localView.findViewById(2131377020));
    this.f = ((TextView)localView.findViewById(2131377015));
    this.g = ((TextView)localView.findViewById(2131365003));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131365004));
    ...
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131370550));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131377933));
  ...
  public final void a()
  {
    a(axyi.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), this.jdField_a_of_type_AndroidWidgetImageView);
    boolean bool1;
    boolean bool2;
    if (this.jdField_a_of_type_Int != 0)
    {
      ...
      bool2 = a(axyi.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), this.jdField_b_of_type_AndroidWidgetImageView);
      label45:
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject2 = axyi.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (QLog.isColorLevel()) {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          continue;
          ((Button)localObject1).setText(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getText(2131694500));
      ...
      if (localObject2 != null)
      {
        ((TextView)localObject2).setText((CharSequence)axyi.a());
        ((TextView)localObject2).setTextColor(((Ref.IntRef)localObject1).element);
      }
      localObject1 = this.jdField_a_of_type_AndroidWidgetButton;
      if (localObject1 != null)
      {
        ((Button)localObject1).setOnClickListener((View.OnClickListener)new axzh(this, bool1));
        if (!bool1) {
          break label534;
        }
        if (!axyi.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
          break label509;
        }
        ((Button)localObject1).setText(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getText(2131692909));
        ((Button)localObject1).setEnabled(false);
      }
      f();
      return;
  ...
  {
    int i = axyg.jdField_a_of_type_Int;
    if (paramInteger1 == null) {}
    while ((paramInteger1.intValue() != i) || (paramIntent == null)) {
      return;
    }
    paramInteger1 = axzl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramIntent, this.jdField_a_of_type_JavaLangString);
    if (this.jdField_b_of_type_Int != ((Number)paramInteger1.getFirst()).intValue()) {
      QQToast.a((Context)BaseApplication.context, 0, 2131690971, 0).a();
    }
  ...
  protected void d()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.unRegistObserver((BusinessObserver)this.jdField_a_of_type_Axyk);
  }
  
  public void onBackPressed()
  {
    super.onBackPressed();
    this.jdField_a_of_type_Axsv.a(1040);
  }
  ...
  public void show()
  {
    ...
    if (ThemeUtil.isNowThemeIsNight(null, false, ""))
    {
      localView = this.jdField_b_of_type_AndroidViewView;
      if (localView != null) {
        localView.setBackgroundResource(2130846045);
      }
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.registObserver((BusinessObserver)this.jdField_a_of_type_Axyk);
      axvi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
      try
      {
        ...
        localView = this.jdField_b_of_type_AndroidViewView;
        if (localView != null) {
          localView.setBackgroundResource(2130846044);
        }
        c();
        localView = this.jdField_c_of_type_AndroidViewView;
        if (localView == null) {
