  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    localBundle.putString("file_send_path", axzb.a(this.a));
    ...
    do
    {
      ...
      paramView = "";
      if ((axzb.b(this.a) == null) || (axzb.b(this.a).equals(""))) {
        break label500;
      }
      localBundle.putString("struct_msg_video_info", axzb.b(this.a));
      ...
      try
      {
        localObject2 = new JSONObject(axzb.b(this.a));
      ...
      axqw.b((QQAppInterface)localObject2, "P_CliOper", "Pb_account_lifeservice", "", "0X8005C9A", "0X8005C9A", 0, 1, 0, ((StructMsgForGeneralShare)localObject1).uin, ((StructMsgForGeneralShare)localObject1).currentAccountUin, axzb.a(this.a), paramView);
    ...
    try
    {
      ...
      paramView.put("net", String.valueOf(nam.a()));
      paramView.put("mobile_imei", bbct.a());
      paramView.put("obj", "");
      ...
      ses.a((AppInterface)localObject2, ((StructMsgForGeneralShare)localObject1).message.selfuin, paramView.toString(), "" + ((StructMsgForGeneralShare)localObject1).msgId);
      return;
    }
