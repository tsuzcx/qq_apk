  ...
  extends akor
{
  ...
  private MessageRecord a(MsgInfo paramMsgInfo, long paramLong)
  {
    ...
    long l1 = bbmj.a((byte[])localObject6, 0);
    byte b = localObject6[4];
    Object localObject5 = new ArrayList();
    Object localObject4 = (ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
    Object localObject1 = (ajxn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
    Object localObject7 = (ajvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53);
    ...
    case 9: 
      do
      {
        ...
        {
          return null;
          paramLong = bbmj.a((byte[])localObject6, 5);
          l2 = bbmj.a((byte[])localObject6, 9);
          ...
          ((ajvi)localObject4).a(l1);
          i = ((ajvk)localObject7).a(l1 + "");
        } while (((ajvk)localObject7).a(String.valueOf(l1), String.valueOf(l2)));
        if (QLog.isColorLevel()) {
        ...
        if ((TextUtils.isEmpty((CharSequence)localObject1)) || (bbcl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1))))
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.DiscMsgPc.discuss", 2, "coptype 2 server memberName empty");
          }
          localObject1 = bbcl.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), (String)localObject6);
        }
        ...
        ((ajvi)localObject4).a(l1, (String)localObject6, (List)localObject5, 10009);
        if (((String)localObject6).equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
        {
          ((ajvk)localObject7).a(String.valueOf(l1), String.valueOf(l3));
          a(b, l1, l3);
          ((ajvi)localObject4).a(String.valueOf(l1));
          return null;
        }
        ((ajvi)localObject4).a(l1);
        ((ajvk)localObject7).a(String.valueOf(l1), String.valueOf(l3));
        ...
        l2 = bbmj.a((byte[])localObject6, 5);
        k = bbmj.a((byte[])localObject6, 13);
        localObject3 = new ArrayList();
        j = 15;
        for (i = 1; i < k + 1; i = (short)(i + 1))
        {
          localObject7 = (String)((ArrayList)localObject1).get(i);
          l3 = bbmj.a((byte[])localObject6, j);
          j += 4;
          ((List)localObject5).add(String.valueOf(l3));
          ((ArrayList)localObject3).add(new Pair(String.valueOf(l3), localObject7));
        }
        localObject6 = new ajvj();
        ((ajvj)localObject6).jdField_b_of_type_Int = ((ArrayList)localObject1).size();
        ((ajvj)localObject6).jdField_a_of_type_JavaLangString = String.valueOf(l1);
        ((ajvi)localObject4).a((ajvj)localObject6);
        ((ajvi)localObject4).a(l1, String.valueOf(l2), (List)localObject5, 10004);
        ...
        if (((aktg)localObject6).b(Long.toString(l1), 3000) != null)
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.DiscMsgPc.discuss", 2, "handleDiscussionMemchangeMsg ru alreadyintab");
          }
          if (bbcl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1)))
          {
        ...
        localObject5 = ((aktg)localObject6).a(Long.toString(l1), 3000);
        ahpf.a((RecentUser)localObject5, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a());
        ...
        ((aktg)localObject6).a((RecentUser)localObject5);
        if (QLog.isColorLevel()) {
        ...
        for (;;)
        {
          ...
          if (TextUtils.equals((CharSequence)localObject6, String.valueOf(l2)))
          {
            ...
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Multi_call", "Show_discuss_tips", 0, 0, "", "", "", "");
          }
          else
          {
            b((Pair)localObject4, paramMsgInfo, (ArrayList)localObject3, paramLong, String.valueOf(l1), b, true);
        ...
        l2 = bbmj.a((byte[])localObject6, 5);
        l3 = bbmj.a((byte[])localObject6, 9);
        bbmj.a((byte[])localObject6, 13);
        i = bbmj.a((byte[])localObject6, 17);
        localObject1 = new byte[i];
        bbmj.b((byte[])localObject6, 19, (byte[])localObject1, i);
        ...
        if (l2 == paramLong)
        {
          ...
          ((ajvi)localObject4).a(String.valueOf(l1), (String)localObject5);
          a(paramMsgInfo, paramLong, l1, l2, (String)localObject1);
          return null;
        }
        localObject3 = "";
        localObject1 = ((ajvk)localObject7).a(String.valueOf(l1));
        if ((localObject1 != null) && (((DiscussionInfo)localObject1).isDiscussHrMeeting())) {
          localObject1 = bbfu.a((ajvk)localObject7, ((DiscussionInfo)localObject1).uin, String.valueOf(l2));
        }
        for (;;)
        {
          ...
          if (TextUtils.isEmpty((CharSequence)localObject1))
          {
            ...
            localObject3 = bbcl.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), String.valueOf(l2));
          }
      ...
      } while (bbmj.a((byte[])localObject6, 5) == 0);
      k = bbmj.a((byte[])localObject6, 7);
      localObject4 = new ArrayList();
      i = 9;
      j = 0;
      while (j < k)
      {
        l3 = bbmj.a((byte[])localObject6, i);
        localObject3 = "";
        localObject1 = localObject3;
        if (paramMsgInfo.vNickName != null)
        {
      ...
      j = bbmj.a((byte[])localObject6, i);
      localObject1 = new byte[j];
      bbmj.b((byte[])localObject6, i + 2, (byte[])localObject1, j);
    ...
    case 22: 
      l3 = bbmj.a((byte[])localObject6, 5);
      bbmj.a((byte[])localObject6, 9);
      l4 = bbmj.a((byte[])localObject6, 13);
      l5 = bbmj.a((byte[])localObject6, 17);
      if (l5 == 0L) {
        break;
      }
    }
    for (int i = 1;; i = 0)
    {
      ...
      default: 
        ...
        if (((aktg)localObject1).b(Long.toString(l1), 3000) != null) {
          return null;
        }
        break;
      case 0: 
      ...
      case 2: 
        ...
        localObject1 = new ajvj();
        ((ajvj)localObject1).jdField_b_of_type_Int = k;
        ((ajvj)localObject1).jdField_a_of_type_JavaLangString = String.valueOf(l1);
        ((ajvi)localObject4).a((ajvj)localObject1);
        ...
        for (i = 1;; i = 0)
        {
          ...
          while (i < k)
          {
            String str = String.valueOf(bbmj.a((byte[])localObject6, j));
            localObject3 = "";
            localObject1 = localObject3;
            if (paramMsgInfo.vNickName != null)
            {
        ...
        for (;;)
        {
          ((ajvi)localObject4).a(l1, String.valueOf(l3), (List)localObject5, i);
          if (this.jdField_a_of_type_AndroidOsHandler == null) {
            this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper());
          }
      ...
      localObject3 = ((aktg)localObject1).a(Long.toString(l1), 3000);
      ...
      ((aktg)localObject1).a((RecentUser)localObject3);
      return null;
      i = localObject6.length - 5;
      localObject1 = new byte[i];
      bbmj.b((byte[])localObject6, 5, (byte[])localObject1, i);
      localObject3 = new oidb_0x858.NotifyMsgBody();
      paramMsgInfo = (MessageForQQWalletTips)axaq.a(-2029);
      try
      {
        ...
        paramMsgInfo.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), l2 + "", "", "[QQWallet Tips]", awzw.a(), -2029, 3000, awzw.a());
      ...
      return null;
      bbmj.a((byte[])localObject6, 5);
      bbmj.a((byte[])localObject6, 9);
      i = localObject6[13];
      return null;
      l3 = bbmj.a((byte[])localObject6, 5);
      l4 = bbmj.a((byte[])localObject6, 9);
      i = bbmj.a(localObject6[13]);
      bbmj.a((byte[])localObject6, 14, i);
      i += 14;
      k = bbmj.a((byte[])localObject6, i);
      j = i + 2;
      Object localObject2 = new HashSet();
      i = 0;
      while (i < k)
      {
        l5 = bbmj.a((byte[])localObject6, j);
        j += 4;
      ...
      localObject3 = (ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
      ...
      if (((HashSet)localObject2).contains(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
      {
        ...
        for (;;)
        {
          ((ajvi)localObject3).a(l1, String.valueOf(l3), (List)localObject5, 10005);
          return null;
          ((ajvi)localObject3).a((String)localObject4);
          a(paramMsgInfo, paramLong, l2, l2, ajyc.a(2131703329));
        }
      }
      ((ajvi)localObject3).a((String)localObject4, (HashSet)localObject2);
      if (Long.getLong((String)localObject4) != null) {}
      for (paramLong = Long.getLong((String)localObject4).longValue();; paramLong = 0L)
      {
        ((ajvi)localObject3).a(paramLong);
        break;
      }
      l4 = bbmj.a((byte[])localObject6, 5);
      l3 = bbmj.a((byte[])localObject6, 9);
      if (QLog.isColorLevel()) {
      ...
      if (TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        localObject2 = bbcl.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), (String)localObject7);
      }
      for (;;)
      {
        k = bbmj.a((byte[])localObject6, 13);
        ...
        if (((HashSet)localObject8).size() > 0)
        {
          ...
          while (((Iterator)localObject6).hasNext())
          {
            ...
            ((StringBuffer)localObject3).append(bbcl.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l1), (String)localObject9)).append("、");
          }
        }
        ...
        {
          localObject6 = (ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
          ((ajvi)localObject6).a(l1, (String)localObject7, (List)localObject5, 10005);
          ...
          if (((HashSet)localObject8).contains(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
          {
            ...
            ((ajvi)localObject6).a(String.valueOf(l1));
            a(paramMsgInfo, paramLong, l2, l2, ajyc.a(2131703328));
            return null;
          }
          localObject2 = (String)localObject2 + ajyc.a(2131703327) + (String)localObject3;
          ((ajvi)localObject6).a(String.valueOf(l1), (HashSet)localObject8);
          ((ajvi)localObject4).a(l1);
          a(paramMsgInfo, paramLong, l2, l2, (String)localObject2);
          return null;
          i = (int)bbmj.a((byte[])localObject6, 5);
          localObject2 = new byte[i];
          bbmj.b((byte[])localObject6, 9, (byte[])localObject2, i);
          ...
          try
          {
            ...
            case 2: 
              ...
              if (((ajvk)localObject7).jdField_a_of_type_JavaUtilMap != null)
              {
                ((ajvk)localObject7).jdField_a_of_type_JavaUtilMap.put(localObject3, new String[] { localObject2, paramMsgInfo });
                ((ajvk)localObject7).jdField_a_of_type_JavaUtilSet.add(localObject2);
              }
              if (QLog.isColorLevel()) {
              ...
              ((ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).a(String.valueOf(l1));
              if ((BaseActivity.sTopActivity instanceof SplashActivity)) {}
              ((ajsz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22)).notifyUI(41, true, new Object[] { Integer.valueOf(2131696439), localObject3, localObject2, Boolean.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c().equals(paramMsgInfo)) });
            }
          }
  ...
  private MessageRecord a(MsgInfo paramMsgInfo, SvcReqPushMsg paramSvcReqPushMsg)
  {
    ...
    if ((paramMsgInfo != null) && (!akau.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMsgInfo, true))) {
      return paramMsgInfo;
    }
    return null;
  }
  ...
  {
    MessageRecord localMessageRecord = axaq.a(-1050);
    String str = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131720675);
    switch (paramInt)
    {
    default: 
      if (QLog.isColorLevel()) {
  ...
  {
    MessageRecord localMessageRecord = axaq.a(-1004);
    ...
    localMessageRecord.isread = true;
    if (QLog.isColorLevel()) {
      QLog.d("Q.msg.DiscMsgPc", 2, "----------handleC2COnlinePushMsgResp after analysis friendUin: " + paramLong2 + " msgType: " + -1004 + " friendType: " + 3000 + " shMsgSeq: " + paramMsgInfo.shMsgSeq + " msgContent: " + bbbd.a(paramString));
    }
  ...
  private void a(Pair<Long, String> paramPair1, MsgInfo paramMsgInfo, long paramLong1, long paramLong2, long paramLong3, byte paramByte, long paramLong4, Pair<Long, String> paramPair2)
  {
    ...
    if (TextUtils.isEmpty(paramPair1))
    {
      ...
      paramPair1 = bbcl.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(paramLong2), String.valueOf(l1));
    }
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(str))
      {
        ...
        paramPair2 = bbcl.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(paramLong2), String.valueOf(l2));
      }
      if (bbcl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(paramLong2))) {
        paramPair1 = bbcl.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(paramLong2), String.valueOf(l1));
      }
      if (paramLong4 == 0L) {
  ...
  private void a(Pair<Long, String> paramPair, MsgInfo paramMsgInfo, ArrayList<Pair<String, String>> paramArrayList, long paramLong1, String paramString, byte paramByte, long paramLong2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((!TextUtils.isEmpty(paramPair)) && (!bbcl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString))) {
        break label133;
      }
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.DiscMsgPc.discuss", 2, "showWelcomeTips server name empty cOpType:" + paramByte);
      }
      paramPair = bbcl.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, (String)localObject);
      break label133;
      label242:
      localStringBuffer.append("、" + paramPair);
    }
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(str))
      {
        ...
        paramPair = bbcl.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, String.valueOf(l));
      }
      if (bbcl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString)) {
        paramPair = bbcl.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, String.valueOf(l));
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    bbmj.b(paramArrayOfByte, paramInt, paramMessageRecord, i);
  ...
  private void a(ToServiceMsg paramToServiceMsg, ArrayList<msg_comm.Msg> paramArrayList, msg_svc.PbGetDiscussMsgResp paramPbGetDiscussMsgResp)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      {
        paramToServiceMsg = (ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
        ...
        while (j < k)
        {
          ...
          if ((paramArrayList instanceof MessageForMarketFace)) {
            askc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForMarketFace)paramArrayList);
          }
          j += 1;
        }
        j = 0;
        ...
        if (paramToServiceMsg.size() > 0)
        {
          ...
          paramArrayList = (akon)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(3000);
          ...
          j = akpy.a(paramToServiceMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      ...
      for (boolean bool1 = bool2;; bool1 = false)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(bool1)) && (!akpy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, 3000)))
        {
          bool1 = true;
        ...
        for (;;)
        {
          if ((i != 0) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(str) == 1))
          {
            ...
            if (paramToServiceMsg != null)
            {
              ...
              ((akon)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(3000)).b(str, 3000, l1);
            }
          }
          return;
          bool1 = false;
  ...
  private void a(ToServiceMsg paramToServiceMsg, ArrayList<msg_comm.Msg> paramArrayList, msg_svc.PbGetDiscussMsgResp paramPbGetDiscussMsgResp, String paramString)
  {
    ...
    for (paramArrayList = ((msg_comm.DiscussInfo)localObject3).discuss_remark.get().toByteArray();; paramArrayList = null)
    {
      for (;;)
      {
        ...
        localaxat.e = l5;
        localaxat.jdField_c_of_type_Int = 3000;
        localaxat.d = m;
        ...
        try
        {
          a((msg_comm.Msg)localObject2, localArrayList3, localaxat, true, localazmj);
          ...
          akau.a((List)localObject3);
          localArrayList1.addAll((Collection)localObject3);
          akau.a("Q.msg.DiscMsgPc", paramString, l3, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), String.valueOf(l5));
          if ((paramArrayList == null) || (paramArrayList.length <= 0)) {
            break;
          }
          localObject3 = String.valueOf(l1);
          localObject2 = bbdm.a(paramArrayList) + ":" + (String)localObject3;
          if (((HashSet)localObject1).contains(localObject2)) {
            break;
          }
          paramArrayList = ((ajvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramArrayList, String.valueOf(l5), (String)localObject3, false);
          if (paramArrayList == null) {
            break;
          }
      ...
      if (localArrayList2.size() > 0) {
        ((ajvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).b(localArrayList2);
      }
      paramArrayList = (ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6);
      ...
      ((askq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(paramArrayList + "&" + 3000, localazmj);
      paramArrayList = new ArrayList();
      if (paramToServiceMsg != null)
      {
      ...
      ((bbqs)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(localArrayList1);
      return;
    }
  }
  ...
  {
    MessageRecord localMessageRecord = axaq.a(-1016);
    long l = awzw.a();
    if ((paramArrayList != null) && (paramArrayList.size() > 1))
    {
      ...
      localMessageRecord.init(paramString2, paramString1, paramString3, paramArrayList + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131694444), l, -1016, 3000, l);
  ...
  private void a(ArrayList<msg_comm.Msg> paramArrayList, ArrayList<MessageRecord> paramArrayList1)
  {
    ...
    for (paramArrayList = ((msg_comm.DiscussInfo)localObject2).discuss_remark.get().toByteArray();; paramArrayList = null)
    {
      ...
      for (;;)
      {
        try
        {
          a(localMsg, localArrayList2, localaxat, true, (azmj)localObject1);
          if (!QLog.isColorLevel()) {
            break label1003;
          }
        ...
        catch (Exception localException)
        {
          ...
          if ((paramArrayList != null) && (paramArrayList.length > 0))
          {
            ...
            String str = bbdm.a(paramArrayList) + ":" + (String)localObject1;
            if (!localHashSet.contains(str))
            {
              paramArrayList = ((ajvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramArrayList, String.valueOf(l1), (String)localObject1, false);
              if (paramArrayList != null)
              {
        ...
        if (localArrayList1.size() > 0) {
          ((ajvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).b(localArrayList1);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
    ...
    for (localObject1 = ((msg_comm.DiscussInfo)localObject2).discuss_remark.get().toByteArray();; localObject1 = null)
    {
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          paramFromServiceMsg.append(" fromUin:").append(l1).append(" toUin").append(l4).append(" msgTime:").append(m).append(" msgSeq:").append(l5).append(" msgUid:").append(l6).append(" userActive:").append(n).append(" fromInstid:").append(i1).append(" disUin:").append(l2).append(" disType:").append(i2).append(" disSeq:").append(l7).append(" remarkSender:").append(bbdm.a((byte[])localObject1)).append(" divSeq:").append(k).append(" pkgIndex:").append(j).append(" pkgNum:").append(i).append(" hasShare:").append(paramMsg.appshare_info.has());
          QLog.d("Q.msg.DiscMsgPc", 2, paramFromServiceMsg.toString());
        }
        ((ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6)).a(l2, l1);
        ((ajxn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).a(l1);
        paramFromServiceMsg = (ajvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53);
        localObject2 = new axat();
        ((axat)localObject2).e = l2;
        ((axat)localObject2).jdField_c_of_type_Int = 3000;
        ((axat)localObject2).d = i2;
          ...
          if (i < j)
          {
            ...
            if ((((MessageRecord)localObject5).senderuin != null) && (((MessageRecord)localObject5).senderuin.equalsIgnoreCase(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())))
            {
              ...
              if (localObject6 != null)
              {
                ...
                adgf.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((MessageRecord)localObject6).uniseq);
              }
            }
            for (;;)
            {
              ...
              if ((i == 0) && (localObject1 != null) && (localObject1.length > 0))
              {
                ...
                localObject6 = bbdm.a((byte[])localObject1) + ":" + str;
        ...
        if (paramFromServiceMsg.size() > 0)
        {
          ...
          boolean bool2 = akau.a(paramFromServiceMsg);
          i = akpy.a(paramFromServiceMsg, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          ...
          if ((!this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(bool2)) || (akpy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, Long.toString(l2), 3000))) {
            break label1824;
          }
        }
        for (boolean bool1 = true;; bool1 = false)
        {
          ...
          ((bbqs)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(paramMsg);
          return;
        }
        i = 0;
        j = 0;
  ...
  private boolean a(long paramLong1, long paramLong2, short paramShort)
  {
    ...
    //   37: astore 7
    //   39: aload_0
    //   40: getfield 44	akpj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   43: invokevirtual 1024	com/tencent/mobileqq/app/QQAppInterface:a	()Lawzw;
    //   46: invokevirtual 1584	awzw:a	()Ljava/util/ArrayList;
    //   49: aload 7
    ...
    //   98: ireturn
    //   99: aload_0
    //   100: getfield 44	akpj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   103: invokevirtual 1024	com/tencent/mobileqq/app/QQAppInterface:a	()Lawzw;
    //   106: aload 7
    //   108: invokevirtual 1590	awzw:a	(Ljava/lang/String;)V
    //   111: iconst_0
    //   112: istore 6
    //   114: goto -20 -> 94
    //   117: astore 7
  ...
  public static void b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, int paramInt, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (paramInt == 11)
      {
        ...
        ((airv)paramQQAppInterface.getManager(211)).a(0, 3000, Long.toString(l), paramArrayOfByte);
        return;
      }
      if (paramInt == 12)
      {
        ...
        ((aist)paramQQAppInterface.getManager(227)).a(3000, paramArrayOfByte);
        return;
      }
    }
    catch (Exception paramQQAppInterface)
    ...
    if (paramInt == 13)
    {
      ...
      if (paramArrayOfByte.opt_msg_goldtips.has())
      {
        ...
        if ((paramQQAppInterface.type.has()) && (paramQQAppInterface.type.get() == 3)) {
          ahbe.a(3000, null, (oidb_0x858.GoldMsgTipsElem)paramArrayOfByte.opt_msg_goldtips.get());
        }
      }
    }
  }
      ...
      if ((paramInt == 9) && (paramArrayOfByte.opt_msg_obj_update.has()))
      {
        ...
        if (paramMessageRecord.bytes_ext_msg.has())
        {
          ...
          try
          {
            ...
            ((aqug)paramQQAppInterface.getManager(156)).a(paramArrayOfByte, false);
            return;
          }
  ...
  public akqj a(int paramInt, MsgInfo paramMsgInfo, SvcReqPushMsg paramSvcReqPushMsg)
  {
    ...
    for (;;)
    {
      ...
      if ((paramMsgInfo != null) && (paramSvcReqPushMsg != null)) {
        return new akqj(a(paramMsgInfo, paramSvcReqPushMsg), false);
      }
  ...
  public List<MessageRecord> a(msg_comm.Msg paramMsg, axat paramaxat)
  {
    ...
    try
    {
      a(paramMsg, localArrayList1, paramaxat, true, localazmj);
      long l = paramMsg.msg_head.discuss_info.discuss_uin.get();
      ((askq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(String.valueOf(l) + "&" + 3000, localazmj);
