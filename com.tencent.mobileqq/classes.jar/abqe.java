...
public class abqe
{
  ...
  public abqe(SharedPreferences paramSharedPreferences, String paramString)
  {
  ...
  public static abqe a(JSONObject paramJSONObject)
  {
    abqe localabqe = new abqe();
    try
    {
      localabqe.a = paramJSONObject.getString("name").trim();
      localabqe.b = paramJSONObject.getString("ver").trim();
      localabqe.c = paramJSONObject.getString("system").trim();
      localabqe.d = paramJSONObject.getString("driver").trim();
      localabqe.e = paramJSONObject.getString("url").trim();
      localabqe.f = paramJSONObject.getString("type").trim();
      localabqe.h = paramJSONObject.getString("enabled").trim();
      localabqe.k = paramJSONObject.optString("previousPatch", "").trim();
      return localabqe;
    }
    catch (Exception paramJSONObject)
    {
      abpt.a("PatchInfo", "Parse PatchInfo from JSON exception " + paramJSONObject);
    }
    return null;
  }
  ...
  public JSONObject a()
  {
    ...
    {
      abpt.a("PatchInfo", "Get JSON String failed " + localJSONException);
    }
