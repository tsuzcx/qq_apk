  ...
  extends xgy
{
  ...
  public asrx(Context paramContext, PicInfo paramPicInfo)
  {
  ...
  public View a(int paramInt, Handler paramHandler, asrz paramasrz)
  {
    ...
    else
    {
      ...
      localURLImageView.setURLDrawableDownListener(new asry(this, paramasrz, paramInt));
      if (!bool1) {
        break label619;
      }
      l = 1000L;
      paramHandler.postDelayed(new PicBrowserImage.3(this, (URLDrawable)localObject1, paramasrz, paramInt), l);
    }
    for (;;)
    {
      label441:
      ...
      for (;;)
      {
        ...
        if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.a))
        {
          ...
          try
          {
            localObject2 = axsk.a(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.a);
            localObject1 = localFile;
            ...
            ((URLDrawable)localObject2).setDownloadListener(new ascs(this.jdField_a_of_type_AndroidContentContext, "actNearbyPicBrowser"));
            localObject1 = localObject2;
            localURLImageView.setImageDrawable((Drawable)localObject2);
            localObject1 = localObject2;
            bool1 = axoa.b(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.a);
            localObject1 = localObject2;
          }
  ...
  public void a()
  {
    ...
    try
    {
      localObject = axsk.a((String)localObject);
      if (localObject != null)
      {
        ...
        ((URLDrawable)localObject).setDownloadListener(new ascs(this.jdField_a_of_type_AndroidContentContext));
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.b)) {
        try
        {
          ...
          if (axoa.b(((URL)localObject4).toString()))
          {
