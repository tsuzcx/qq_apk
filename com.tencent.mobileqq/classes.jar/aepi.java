...
public final class aepi
{
  ...
  private static ThreadLocal<char[]> jdField_a_of_type_JavaLangThreadLocal = new aepj();
  ...
  public static int a(azwj paramazwj, String paramString)
  {
    paramazwj = paramazwj.a(paramString);
    ...
    do
    {
      ...
      try
      {
        int i1 = Integer.parseInt(paramazwj);
        return i1;
      }
  ...
  public static final void a(QQAppInterface paramQQAppInterface, BaseChatPie paramBaseChatPie, aeqo paramaeqo, ChatMessage paramChatMessage)
  {
    int i4 = 0;
    Object localObject;
    boolean bool;
    if (aemu.jdField_a_of_type_Int == -1)
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (aemu.jdField_a_of_type_Boolean)
        {
          aemu.jdField_a_of_type_Int = i1;
          if (aemu.jdField_a_of_type_Int == -1) {
            aemu.jdField_a_of_type_Int = 0;
          }
          if (aemu.jdField_a_of_type_Int > 0) {
            break label153;
          }
          return;
          label133:
    ...
    if (paramChatMessage == null)
    {
      ...
      if (paramaeqo != null)
      {
        ...
        if (paramaeqo.size() > 0)
        {
          ...
          i1 = aemu.jdField_a_of_type_Int;
          if (i2 <= i1) {
            break label296;
          }
          label210:
          if (!(paramBaseChatPie instanceof agti)) {
            break label349;
          }
        }
      }
    ...
    for (int i2 = 1;; i2 = 0)
    {
      ...
      if (i3 > -1)
      {
        paramBaseChatPie = (ChatMessage)paramaeqo.get(i3);
        if (i2 == 0) {
          break label303;
        }
        if (!aemu.a(paramBaseChatPie)) {
          break label323;
        }
        i1 = 1;
      }
      for (;;)
      {
        ...
        ((WebProcessManager)paramQQAppInterface.getManager(13)).a(1, new aepk());
        return;
        i1 = 10;
        break;
        i1 = i2;
        break label210;
        if ((!paramBaseChatPie.isread) && (aemu.a(paramBaseChatPie)))
        {
          i1 = 1;
        }
        else
  ...
  private static boolean a(BaseActivity paramBaseActivity, QQAppInterface paramQQAppInterface, Intent paramIntent)
  {
    try
    {
      ...
      if (i1 == -1)
      {
        QQToast.a(paramBaseActivity, paramBaseActivity.getString(2131720093), 0).b(paramBaseActivity.getTitleBarHeight());
        return false;
      }
      if (paramIntent.hasExtra("account"))
      {
        azqs.b(paramQQAppInterface, "CliOper", "", "", "Fast_launch", "Fast_launch_msg", 0, 0, "1", "", "", "");
        if (!((alto)paramQQAppInterface.getManager(51)).b(str))
        {
      ...
      if ((paramIntent.getBooleanExtra("shortcut", false)) && (!((alto)paramQQAppInterface.getManager(51)).b(str)))
      {
        QQToast.a(paramBaseActivity.getApplicationContext(), paramBaseActivity.getString(2131720094), 0).b(paramBaseActivity.getTitleBarHeight());
        return false;
      }
      return true;
    }
  ...
  {
    bdnm.a(null, "AIO_doOnCreate_BeforeEnterCost");
    ...
    do
    {
      do
      {
        ...
        return true;
        if (!yqg.a().a(paramIntent, paramBaseActivity, paramQQAppInterface)) {
          break;
        }
      } while (!QLog.isColorLevel());
    ...
    label212:
    bdnm.a("AIO_doOnCreate_BeforeEnterCost", null);
    return false;
  }
