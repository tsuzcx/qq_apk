  ...
  implements amql
{
  ...
  public static int b;
  public static int c;
  private ankt jdField_a_of_type_Ankt;
  private ankx jdField_a_of_type_Ankx;
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<Activity> jdField_a_of_type_JavaLangRefWeakReference;
  private HashMap<String, amtk> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public amxx(int paramInt, Activity paramActivity)
  {
    this.jdField_b_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_Ankt = new ankt(amwn.a(), paramActivity);
    this.jdField_a_of_type_Ankx = new ankx(paramActivity, amwn.a());
  ...
  private void a(long paramLong, int paramInt, amys paramamys)
  {
    ApolloCmdChannel localApolloCmdChannel = amwn.a();
    if (localApolloCmdChannel != null)
    {
      localApolloCmdChannel.callbackFromRequest(paramLong, paramInt, "cs.get_redPacket_result.local", paramamys.a());
      paramamys.jdField_b_of_type_Int = 0;
      paramamys.jdField_a_of_type_Boolean = false;
      return;
    }
    QLog.e("cmgame_process.CmGameSubProcessHandler", 1, "[notifyRedPacketResult] cmdChannel is null");
  }
  
  private void a(long paramLong, String paramString, adad paramadad)
  {
    if (paramadad == null) {
      return;
    }
    ...
    paramadad.a(str, null, new amyc(this, paramString, paramLong));
  }
  
  private void a(long paramLong, String paramString1, String paramString2)
  {
    Object localObject = amwn.a(this.jdField_d_of_type_Int);
    if (localObject == null) {
    ...
    ((amwq)localObject).a(paramLong, paramString1, paramString2);
  }
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_JavaUtilRegexPattern == null)
        {
          ...
          if (localObject != null)
          {
            localObject = ((amyx)localObject).a(this.jdField_d_of_type_Int);
            if (QLog.isColorLevel()) {
  ...
  {
    if ((!paramString1.startsWith("cs.")) && (!paramString1.endsWith(".local")) && (!amqp.a(paramString1)) && (a(paramString1))) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          paramString2 = amwn.a(this.jdField_d_of_type_Int);
        ...
        if ("apollo_router_game.game_ad_linkcmd_get_ad".equals(paramString1))
        {
          ...
          ((amzx)localObject2).a(paramString1, (String)localObject1, paramLong, 4, bool, paramString2);
          break;
  ...
  private byte[] a(String paramString)
  {
    ...
    try
    {
      ...
      localObject1 = acil.a((Context)localObject1);
  ...
  private void c()
  {
    ...
    do
    {
      ...
      {
        return;
        Activity localActivity = ((amyo)localObject).a();
  ...
  private void d()
  {
    ...
    if (localActivity != null) {
      amwn.a(this.jdField_d_of_type_Int, localActivity);
    }
  }
  ...
  private void e(long paramLong, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        amwn.a(amwn.a(), i, j, this.jdField_d_of_type_Int, k, paramString);
        i = 0;
      }
      catch (Exception paramString)
      {
  ...
  private void f(long paramLong, String paramString)
  {
    ...
    ((amzo)localObject).b(paramLong, paramString);
  }
  ...
  private void h(long paramLong, String paramString)
  {
    ...
    ((amzo)localObject).a(paramLong, paramString);
  }
  ...
  private void h(String paramString)
  {
    ...
    paramString = a();
    if (paramString != null) {
      aupt.a(paramString, localIntent, 20180427);
    }
  }
  ...
  private void i(long paramLong, String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
        localCmGameInitParams = ((amyo)localObject).a();
      } while (localCmGameInitParams == null);
      localObject = ((amyo)localObject).a(localCmGameInitParams.appId, ((amyo)localObject).a());
    } while (localObject == null);
    if (localCmGameInitParams.accessTokenRet != 1)
    {
      ...
      ((adad)localObject).a("login", null, new amyb(this, paramString, paramLong, (adad)localObject, localCmGameInitParams));
      return;
    }
    a(paramLong, paramString, (adad)localObject);
  }
  ...
  private void i(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        amyo localamyo = amwn.a(this.jdField_d_of_type_Int);
        if (localamyo != null)
        {
          localamyo.jdField_c_of_type_Int = 0;
          amri localamri2 = localamyo.a();
          amri localamri1;
          if ((localamri2 != null) && (localamri2.jdField_a_of_type_Long != 0L))
          {
            localamri1 = localamri2;
            if (localamri2.jdField_a_of_type_Int != 0) {}
          }
          else
          {
            localamri1 = this.jdField_a_of_type_Ankt.a(paramString);
          }
          if (localamri1 != null)
          {
            this.jdField_a_of_type_Ankt.a(localamri1);
            this.jdField_a_of_type_Ankt.a(str);
            ThreadManager.getUIHandler().post(new CmGameSubProcessHandler.9(this));
            paramString = localamyo.a();
            if (paramString != null)
            {
  ...
  private void j(long paramLong, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((amys)localObject).jdField_d_of_type_Int = i;
        if ((((amys)localObject).jdField_a_of_type_Int <= 0) || (((amys)localObject).jdField_d_of_type_Int < ((amys)localObject).jdField_a_of_type_Int)) {
          break label345;
        }
        if (QLog.isColorLevel()) {
          QLog.d("cmgame_process.CmGameSubProcessHandler", 2, "[hanldeGetRedPacketResult] score:" + ((amys)localObject).jdField_d_of_type_Int + "info.grabState:" + ((amys)localObject).jdField_b_of_type_Int);
        }
        if (((amys)localObject).jdField_b_of_type_Int == 3)
        {
          a(paramLong, 0, (amys)localObject);
          if (!"0".equals(((amys)localObject).f)) {
            break label429;
          }
          albw.a(((amys)localObject).jdField_b_of_type_JavaLangString, ((amys)localObject).jdField_a_of_type_Long, ((amys)localObject).jdField_d_of_type_Int + "", Integer.parseInt(((amys)localObject).jdField_d_of_type_JavaLangString), bool1, false, this.jdField_d_of_type_Int);
          return;
        }
      }
      catch (Exception paramString)
      ...
      if (((amys)localObject).jdField_b_of_type_Int == 0)
      {
        if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
          albw.a(amwn.a(), ((amys)localObject).g + "", this.jdField_d_of_type_Int + "", i + "", new CmGameSubProcessHandler.4(this, null, paramLong));
        }
        ((amys)localObject).jdField_b_of_type_Int = 1;
        return;
      }
      ((amys)localObject).jdField_a_of_type_Boolean = true;
      return;
      label345:
      a(paramLong, 0, (amys)localObject);
      if ("0".equals(((amys)localObject).f)) {}
  ...
  private void j(String paramString)
  {
    ...
    try
    {
      localamyo = amwn.a(this.jdField_d_of_type_Int);
      if (localamyo == null) {
        return;
      }
      localamri = localamyo.a();
      paramString = new JSONObject(paramString);
    ...
    localamri.jdField_c_of_type_JavaLangString = paramString.optString("extendInfo");
    paramString = localamyo.a();
    if (paramString != null)
    {
      paramString.mRoomId = l;
      localamri.jdField_b_of_type_JavaLangString = paramString.mChineseName;
      localamri.jdField_b_of_type_Int = paramString.mActionId;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString != null)
        {
          ...
          {
            albw.a(amwn.a(), paramString.g + "", this.jdField_d_of_type_Int + "", i + "", new CmGameSubProcessHandler.5(this, null, paramLong));
  ...
  private void k(String paramString)
  {
    ...
    if (localAppInterface != null) {
      ankm.a(localAppInterface, paramString);
    }
  }
  ...
  private void l(long paramLong, String paramString)
  {
    ...
    if (localObject == null) {
      paramString = amwn.a((int)paramLong);
    }
    if (paramString != null)
    {
      ...
      if (localObject != null)
      {
        ...
        paramString.a("login", null, new amya(this, (CmGameInitParams)localObject, paramLong));
      }
    }
    try
    {
  ...
  private void m(long paramLong, String paramString)
  {
    ...
    {
      amwn.a().callbackFromRequest(paramLong, 6, "cs.xy_device_vibrate.local", "{}");
      QLog.e("cmgame_process.CmGameSubProcessHandler", 1, paramString, new Object[0]);
    }
  }
  ...
  private void n(long paramLong, String paramString)
  {
    ...
    {
      amwn.a().callbackFromRequest(paramLong, 4, "cs.xy_device_gyro_sensor_start.local", "{}");
      QLog.e("cmgame_process.CmGameSubProcessHandler", 1, paramString, new Object[0]);
    }
  }
  ...
  public amqr a(long paramLong, String paramString1, String paramString2)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return null;
        } while ((localamyo == null) || (localamyo.a() == null));
        if (localamyo.a().getLuaState() == paramLong) {
          break;
        }
      ...
      {
        ankm.a(this.jdField_d_of_type_Int, paramString2, a());
        return null;
      }
  ...
  {
    paramString = anan.a(paramString);
    amyo localamyo = amwn.a(this.jdField_d_of_type_Int);
    if ((paramString == null) || (localamyo == null))
    {
      QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[playADsVideo], adInfo or launcher is null.");
      return;
    }
    paramString.b = paramLong;
    localamyo.a(paramString);
  }
  
  public void a(long paramLong, String paramString, amqm paramamqm)
  {
    if ((this.jdField_b_of_type_JavaUtilHashMap != null) && (this.jdField_b_of_type_JavaUtilHashMap.containsKey(paramString))) {
      paramamqm.a((Bitmap)this.jdField_b_of_type_JavaUtilHashMap.get(paramString), 200);
    }
    for (;;)
    {
      return;
      ...
      {
        ThreadManagerV2.excute(new CmGameSubProcessHandler.10(this, ((amtk)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).jdField_a_of_type_JavaLangString, paramamqm, paramString), 128, null, true);
        return;
      }
      paramamqm = amwn.a();
      if (paramamqm != null)
      {
        Object localObject1 = amwn.a(this.jdField_d_of_type_Int);
        if (localObject1 == null)
        {
          QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[getUserInfo], launcher is null, mGameId:" + this.jdField_d_of_type_Int);
          return;
        }
        Object localObject2 = ((amyo)localObject1).a();
        try
        {
          ...
          paramamqm.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject1).toString(), paramLong, jdField_a_of_type_Int);
          if (QLog.isColorLevel())
          {
  ...
  public void a(long paramLong, String paramString, amqn paramamqn)
  {
    if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))) {
      paramamqn.a(((amtk)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).jdField_b_of_type_JavaLangString);
    }
    for (;;)
    {
      return;
      ...
      if (paramamqn != null)
      {
        ...
        try
        {
          ...
          ((JSONArray)localObject2).put(paramString);
          ((JSONObject)localObject1).put("uidList", localObject2);
          paramamqn.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject1).toString(), paramLong, jdField_b_of_type_Int);
          if (QLog.isColorLevel())
          {
  ...
  public void a(amtk paramamtk)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap != null) {
      this.jdField_a_of_type_JavaUtilHashMap.put(paramamtk.jdField_c_of_type_JavaLangString, paramamtk);
    }
  }
  ...
  {
    int i = this.e;
    if (ankm.a(a(), paramString, this.jdField_d_of_type_Int, i)) {}
    try
    {
  ...
  public void b(String paramString)
  {
    try
    {
      ...
      paramString = amwn.a(this.jdField_d_of_type_Int);
      if (paramString != null) {
        paramString.a(i);
      }
      return;
  ...
  public void c(long paramLong, String paramString)
  {
    ...
    if (localamzx != null)
    {
      localObject1 = amwn.a(this.jdField_d_of_type_Int);
      if (localObject1 == null) {
        QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[getUserInfo], launcher is null, mGameId:" + this.jdField_d_of_type_Int);
      }
    }
    ...
    Object localObject1 = ((amyo)localObject1).a();
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          localamzx.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject2).toString(), paramLong, jdField_c_of_type_Int, false, null);
          return;
        }
      }
      catch (Exception paramString)
  ...
  {
    Object localObject2 = amwn.b(paramLong);
    Object localObject1 = localObject2;
    if (localObject2 == null) {
      localObject1 = amwn.a((int)paramLong);
    }
    if (localObject1 != null)
    {
      localObject2 = ((amyo)localObject1).a();
      if (localObject2 != null) {
        try
        {
          CmGameInitParams localCmGameInitParams = ((amyo)localObject1).a();
