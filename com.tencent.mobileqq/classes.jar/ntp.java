  ...
  implements rgg
{
  ...
  public ntp(int paramInt1, int paramInt2, Activity paramActivity, oul paramoul)
  {
    super(paramActivity);
    this.jdField_c_of_type_Int = 1;
    this.jdField_a_of_type_Osm = new ntq(this);
    this.jdField_d_of_type_Int = paramInt2;
    this.jdField_b_of_type_Int = paramInt1;
    this.jdField_a_of_type_Ovc = ((ovc)paramoul);
    this.jdField_a_of_type_Omt = new omt();
    this.jdField_a_of_type_Omt.jdField_a_of_type_Long = bhvy.a(paramInt1, (QQAppInterface)onh.a());
  }
  ...
  private void a(List<BaseArticleInfo> paramList, int paramInt)
  {
    ...
    localArrayList.addAll(this.jdField_a_of_type_Ovc.a());
    paramList = ozg.a().a(this.jdField_b_of_type_Int, paramList, localArrayList, paramInt);
    this.jdField_a_of_type_Ovc.a(paramList);
    this.jdField_a_of_type_Ovc.a();
  }
  ...
  private void a(boolean paramBoolean1, int paramInt1, boolean paramBoolean2, int paramInt2)
  {
    ...
    long l = a();
    ArticleInfo localArticleInfo = (ArticleInfo)this.jdField_a_of_type_Ovc.a(0);
    ...
    this.jdField_a_of_type_Ovc.a(paramBoolean1);
    localArrayList = new ArrayList();
    osg.a().a(this.jdField_b_of_type_Int, (List)localObject, i, true, false, this.jdField_c_of_type_Int, null, -1L, null, a(), 0L, 0L, null, paramInt1, false, null, 0, localArrayList);
    this.jdField_c_of_type_Int += 1;
    if ((a() instanceof ReadInJoyNewFeedsActivity)) {
      a(-2);
    }
    shu.a(paramInt1, this.jdField_b_of_type_Int, a(), paramBoolean2, paramInt2);
  }
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    boolean bool2 = this.jdField_a_of_type_Ovc.a();
    boolean bool3 = nth.a(this.jdField_b_of_type_Int);
    Object localObject = (KandianMergeManager)((BaseActivity)a()).app.getManager(162);
    boolean bool1;
    if (System.currentTimeMillis() - this.jdField_a_of_type_Omt.d > 300000L)
    {
      bool1 = true;
      boolean bool4 = c();
      ...
      bool1 = nth.c(this.jdField_b_of_type_Int);
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_Int != 70)
      {
        ...
        if (this.jdField_b_of_type_Int != 56)
        {
          ...
          {
            bool1 = paramBoolean;
            if (!oou.c(this.jdField_b_of_type_Int)) {
              bool1 = true;
            }
          }
        }
    ...
    label377:
    localObject = this.jdField_a_of_type_Omt;
    if (this.jdField_a_of_type_Omt.jdField_a_of_type_Long == 0L) {}
    for (;;)
    {
      ((omt)localObject).jdField_a_of_type_Long = l;
      if (this.jdField_b_of_type_Int == 0) {}
      return false;
      l = this.jdField_a_of_type_Omt.jdField_a_of_type_Long;
    }
  }
  ...
  {
    this.jdField_a_of_type_Ovc.a();
    this.jdField_a_of_type_Ovc.a(paramBaseArticleInfo, paramInt);
    bcql.a(this.jdField_a_of_type_AndroidAppActivity, -1, this.jdField_a_of_type_AndroidAppActivity.getString(2131699674), 0).b(((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).getTitleBarHeight());
    if (ozg.a(paramBaseArticleInfo.mRecommendSeq)) {
      ozg.a().a(this.jdField_b_of_type_Int, paramBaseArticleInfo.mRecommendSeq);
    }
    do
    {
      do
      {
        ...
        localDislikeInfo.a = ajya.a(2131712726);
        localDislikeInfo.jdField_c_of_type_Int = 9;
        localDislikeInfo.b = "";
        ArrayList localArrayList = new ArrayList();
        localArrayList.add(localDislikeInfo);
        osg.a().a(Long.valueOf(str).longValue(), ((ArticleInfo)paramBaseArticleInfo).makeDislikeParam(localArrayList));
        osg.a().a(this.jdField_b_of_type_Int, paramBaseArticleInfo);
      } while (paramInt != 0);
      paramBaseArticleInfo = (KandianMergeManager)((QQAppInterface)onh.a()).getManager(162);
    } while (this.jdField_a_of_type_Ovc.a().size() > 0);
  ...
  public void a(ReadInjoyXRecyclerView paramReadInjoyXRecyclerView, int paramInt)
  {
    ...
    for (;;)
    {
      osg.a().a(this.jdField_b_of_type_Int, a(), paramInt, 0, i);
  ...
  public void a(ReadInjoyXRecyclerView paramReadInjoyXRecyclerView, boolean paramBoolean)
  {
    ...
    if ((!onh.a()) || (d()) || (paramBoolean))
    {
      ...
      osj.a().a(2, null);
      ReadinjoyTabFrame localReadinjoyTabFrame = onh.a(a());
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Ovc.c();
    } while (!paramBoolean);
    this.jdField_a_of_type_Ovc.b();
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Ovc != null) {
      this.jdField_a_of_type_Ovc.a(a(Integer.valueOf(this.jdField_b_of_type_Int)), b(Integer.valueOf(this.jdField_b_of_type_Int)));
    }
    this.jdField_a_of_type_Omt.b = System.currentTimeMillis();
  ...
  public void c()
  {
    ...
    do
    {
      ...
      super.c();
    } while (this.jdField_a_of_type_Ovc == null);
    this.jdField_a_of_type_Ovc.a(b(Integer.valueOf(this.jdField_b_of_type_Int)), a(Integer.valueOf(this.jdField_b_of_type_Int)));
  }
  ...
  public void i()
  {
    this.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)osg.a().a(this.jdField_b_of_type_Int));
    if ((this.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_JavaUtilArrayList.size() == 0)) {
      osg.a().c(this.jdField_b_of_type_Int);
    }
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
      this.jdField_a_of_type_Ovc.c(this.jdField_a_of_type_JavaUtilArrayList);
    }
    osg.a().a(this.jdField_b_of_type_Int);
  }
  ...
  public void k()
  {
    if (this.jdField_a_of_type_Ovc != null)
    {
      ...
      Map localMap2 = shu.a(this.jdField_b_of_type_Int);
      ThreadManager.executeOnSubThread(new ReadInJoyChannelWaterFallViewController.2(this, localMap1, a(Integer.valueOf(this.jdField_b_of_type_Int)), localMap2, onh.e(this.jdField_b_of_type_Int)));
