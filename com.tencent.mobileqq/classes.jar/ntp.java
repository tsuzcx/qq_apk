  ...
  extends osp
{
  ...
  public void a(float paramFloat, int paramInt)
  {
    ...
    paramFloat /= paramInt;
    ntk.a(this.a).setY((1.0F - paramFloat) * ntk.a(this.a).getHeight() * 0.03F);
  }
  ...
  public void a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    if (paramTabChannelCoverInfo != null)
    {
      ...
      if (bhvh.z())
      {
        ntk.b(this.a, paramTabChannelCoverInfo);
        ntk.b(this.a, ntk.a(this.a, ntk.a(this.a)));
      }
      ntk.a(paramTabChannelCoverInfo.mChannelCoverId, 1);
      this.a.c(paramTabChannelCoverInfo.mChannelCoverId);
    }
    try
    {
      paramTabChannelCoverInfo = new onr().a("source", "303").a(paramTabChannelCoverInfo.mChannelCoverId);
      if (nss.a()) {}
      for (;;)
      {
        ntk.a("0X8009B94", "", paramTabChannelCoverInfo.b("style", i).a());
        return;
        i = 0;
      }
      return;
  ...
  {
    int i = 8;
    ntk.a(this.a, paramBoolean);
    if (!oot.a())
    {
      ImageView localImageView = ntk.a(this.a);
      if (paramBoolean) {
        i = 0;
      }
