  ...
  implements DialogInterface.OnClickListener
{
  ...
  public void onClick(DialogInterface paramDialogInterface, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      break;
      aqbe.a(this.a, "user_click", "more_about", "share", "success");
      continue;
      aqbe.a(this.a, "user_click", "custom_button", "share_QQ", "success");
      continue;
      aqbe.a(this.a, "user_click", "more_button", "share_QQ", "success");
    }
    label171:
    if (this.a.f())
    {
      if ((aqbe.a(this.a) != null) && (!aqbe.a(this.a).isEmpty()))
      {
        paramDialogInterface = aqbe.a(this.a).iterator();
        while (paramDialogInterface.hasNext())
        {
          localObject1 = (ResultRecord)paramDialogInterface.next();
          if (((ResultRecord)localObject1).b == 6000) {
            this.a.b(aqau.f.intValue());
          } else if (((ResultRecord)localObject1).b == 6003) {
            this.a.b(aqau.k.intValue());
          }
        }
        if ((aqbe.b(this.a) == null) || (aqbe.b(this.a).isEmpty()))
        {
        ...
        this.a.jdField_a_of_type_AndroidOsBundle.putParcelableArrayList("forward_multi_target", aqbe.b(this.a));
        this.a.jdField_a_of_type_AndroidContentIntent.putParcelableArrayListExtra("forward_multi_target", aqbe.b(this.a));
      }
      this.a.d();
      if (this.a.c) {}
      for (;;)
      {
        if ((this.a.jdField_a_of_type_AndroidOsBundle != null) && (this.a.jdField_a_of_type_AndroidOsBundle.getBoolean("k_forward_show_direct_share_tips", false))) {
          axqy.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A4A2", "0X800A4A2", 0, 0, "0", "", "", "");
        }
        aqbe.b(this.a);
    ...
    if (((baky)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a((String)localObject2, true).a)
    {
      bcql.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131697657, 0).b(this.a.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298865));
      return;
    }
    bool1 = false;
    ...
    if (bool1)
    {
      ...
      nol.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", paramDialogInterface, "0X8005A2C", "0X8005A2C", 0, 0, "", "", "", "", false);
    }
    if (this.a.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("forward_source_from_shoot_quick", false))
    {
      ...
      if (i == 21)
      {
        ...
        label851:
        axqy.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", paramDialogInterface, paramDialogInterface, 0, 0, "", "", "", "");
      }
    }
    else
    {
    ...
    for (;;)
    {
      try
      {
        if ((i != aqau.f.intValue()) && (i != aqau.k.intValue())) {
          continue;
        }
        this.a.b(i);
      }
      catch (Throwable paramDialogInterface)
      {
        ...
        continue;
        if (i != aqau.j.intValue()) {
          continue;
        }
        this.a.y();
        continue;
        if (i != aqau.m.intValue()) {
          continue;
        }
        this.a.z();
        continue;
        if (i != aqau.e.intValue()) {
          continue;
        }
        paramDialogInterface = null;
        if (!(this.a.jdField_a_of_type_Bbgu instanceof bbhp)) {
          continue;
        }
        paramDialogInterface = ((bbhp)this.a.jdField_a_of_type_Bbgu).a();
        ...
        paramInt = 1001;
        continue;
        nol.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X80059DC", "0X80059DC", paramInt, 0, (String)localObject1, (String)localObject2, paramDialogInterface, (String)localObject3, false);
        continue;
        continue;
      }
      ...
      if ((this.a.jdField_a_of_type_AndroidOsBundle != null) && (this.a.jdField_a_of_type_AndroidOsBundle.getBoolean("forward_report_confirm")))
      {
        ...
        axqy.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", paramDialogInterface, paramDialogInterface, 0, 0, (String)localObject1, "", "", "");
      }
      bool1 = false;
      if (this.a.jdField_a_of_type_AndroidOsBundle != null)
      {
        ...
        nol.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", (String)localObject1, "0X8005B07", "0X8005B07", paramInt, 0, str, (String)localObject2, paramDialogInterface, (String)localObject3, false);
      }
      if ((this.a.jdField_a_of_type_AndroidOsBundle != null) && (!bool1))
      {
        ...
        if (localObject2 != null)
        {
          ...
          {
            localObject3 = axva.a(paramDialogInterface);
            if (localObject3 != null)
            {
              localObject1 = this.a.jdField_a_of_type_AndroidOsBundle.getString("uin");
              paramDialogInterface = (DialogInterface)localObject1;
              ...
              nol.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", paramDialogInterface, "0X8005B06", "0X8005B06", 0, 0, (String)localObject2, "" + ((AbsStructMsg)localObject3).msgId, "", "", false);
              nol.a("0X8005B06", paramDialogInterface, (String)localObject2, "" + ((AbsStructMsg)localObject3).msgId, "", "");
            }
          }
        }
      }
      if (this.a.c) {
        bdes.a().a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "", String.valueOf(this.a.jdField_a_of_type_Long), "1000", "50", "0", false);
      }
      ...
      if ((this.a.jdField_a_of_type_AndroidOsBundle != null) && (this.a.jdField_a_of_type_AndroidOsBundle.getBoolean("KEY_FROM_OCR", false))) {
        axqy.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009C8E", "0X8009C8E", 0, 0, "", "", "", "");
      }
      ...
      axqy.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009C85", "0X8009C85", 0, 0, "", "", "", "");
      break;
      if (i != 1) {
        break label851;
      }
