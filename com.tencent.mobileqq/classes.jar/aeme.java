  ...
  extends aelk
{
  ...
  public aeme(QQAppInterface paramQQAppInterface, CustomEmotionData paramCustomEmotionData)
  {
    this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData = paramCustomEmotionData;
    this.jdField_a_of_type_JavaLangString = ((ancg)paramQQAppInterface.getManager(149)).a(paramCustomEmotionData);
    if (paramCustomEmotionData.isMarkFace) {
      this.jdField_a_of_type_ComTencentMobileqqDataEmoticon = ((arnz)paramQQAppInterface.getManager(14)).a(paramCustomEmotionData.emoPath, paramCustomEmotionData.eId);
    }
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, String paramString)
  {
    ...
    paramSessionInfo = adww.a(paramString);
    if ((paramSessionInfo != null) && (paramSessionInfo.length >= 8)) {
      bezp.a(paramQQAppInterface, "100007", "2", "40051", paramSessionInfo[0], new String[] { paramSessionInfo[2], paramSessionInfo[4], adww.a(paramString) });
    }
  }
  ...
  public URL a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        URL localURL1 = new URL("protocol_vas_extension_image", "FAVORITE_PANEL_THUMB", this.jdField_a_of_type_JavaLangString);
        if (localURL1 != null) {
          break;
        }
  ...
  {
    ((anch)paramQQAppInterface.getManager(103)).b(this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData.isMarkFace) && (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon != null))
    {
      aael.a(paramQQAppInterface, paramContext, paramSessionInfo, this.jdField_a_of_type_ComTencentMobileqqDataEmoticon);
      if (this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.isNewSoundEmoticon()) {
        arnz.a(paramQQAppInterface, "0X800A932", paramSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId);
      }
      ((anch)paramQQAppInterface.getManager(103)).a(this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData);
      return;
    }
    if (((paramContext instanceof BaseActivity)) && (ascr.a(paramSessionInfo.jdField_a_of_type_Int, paramSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      ...
      bbmy.a(paramQQAppInterface.getApp(), "热聊暂不支持发送自定义表情", 0).b(paramContext.getTitleBarHeight());
      return;
    }
    if (!this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData.isMarkFace) {}
    for (String str = ankl.a(((andn)paramQQAppInterface.getManager(141)).a(), this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData.md5);; str = null)
    {
      if (adww.a(str))
      {
      ...
      aael.a(paramQQAppInterface, paramContext, paramSessionInfo, str, true, bool, this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData.eId, null);
      break;
    }
  }
