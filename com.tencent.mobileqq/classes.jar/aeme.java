...
{
  public aeme(NearbyJsInterface paramNearbyJsInterface, String paramString, boolean paramBoolean) {}
    ...
    for (;;)
    {
      try
      {
        ...
        if ((paramBundle.uint32_result.has()) && (paramBundle.uint32_result.get() == 0) && (paramBundle.bytes_bodybuffer.has()) && (paramBundle.bytes_bodybuffer.get() != null))
        {
          ...
          paramBundle = new aemg(String.valueOf(paramBundle.uint64_uin.get()), paramBundle.int32_direction_flag.get());
