...
public class azlp
  extends azlq
{
  private ArrayList<azib> jdField_a_of_type_JavaUtilArrayList;
  private boolean jdField_a_of_type_Boolean = true;
  private OnlineStatusPermissionChecker.OnlineStatusPermissionItem b;
  
  public azlp(@NonNull BaseActivity paramBaseActivity, azhl paramazhl)
  {
    super(paramBaseActivity, paramazhl);
  }
  
  private void a(ArrayList<azib> paramArrayList)
  {
  ...
  private boolean d()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilArrayList.size() != this.jdField_a_of_type_Azip.a().size()) {
      return true;
    }
    Iterator localIterator1 = this.jdField_a_of_type_Azip.a().iterator();
    for (;;)
    {
      if (localIterator1.hasNext())
      {
        azib localazib1 = (azib)localIterator1.next();
        ...
        do
        {
          ...
          localazib2 = (azib)localIterator2.next();
        } while (localazib1.a != localazib2.a);
      }
      for (int i = 1; i == 0; i = 0)
      {
        return true;
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setText(2131694098);
    if (paramBoolean2)
    {
  ...
  protected boolean a(boolean paramBoolean)
  {
    ...
    if ((this.b == null) && (localazih.a(this.jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusPermissionChecker$OnlineStatusPermissionItem, this))) {
      return true;
    }
    if ((this.b != null) && (c())) {
      return true;
  ...
  protected void b()
  {
    ...
    this.jdField_a_of_type_Azip.a(this.jdField_a_of_type_JavaUtilArrayList);
  }
  ...
  public ArrayList<Integer> c()
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      localArrayList.add(Integer.valueOf((int)((azib)((Iterator)localObject).next()).a));
    }
    return localArrayList;
  }
  ...
  public void c()
  {
    ...
    a(this.jdField_a_of_type_Azip.a());
  }
