...
{
  public sbb(ReadInJoySelectMemberFragment paramReadInJoySelectMemberFragment) {}
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    if (paramEditable.length() > 0)
    {
      if (!ReadInJoySelectMemberFragment.a(this.a).isVisible()) {
        this.a.getChildFragmentManager().beginTransaction().add(2131367252, ReadInJoySelectMemberFragment.a(this.a)).addToBackStack(null).commit();
      }
