...
public class bihj
  extends bign
  implements Handler.Callback, AdapterView.OnItemClickListener, uwb
{
  ...
  uvz jdField_a_of_type_Uvz = null;
  public boolean a;
  int b;
  public String b;
  public boolean b;
  ...
  private void b()
  {
    this.jdField_a_of_type_Tkm = new tkm(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Tkm.a(this);
    ...
    {
      this.jdField_a_of_type_Tkm.a((String)localObject);
      return;
    }
  }
  ...
  View a()
  {
    ...
    for (int i = 2131363780;; i = 2131379112)
    {
  ...
  public String a()
  {
    return this.jdField_a_of_type_Tkm.a();
  }
  ...
  public void a(Uri paramUri, String paramString, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Tkm != null) {
      paramUri = this.jdField_a_of_type_Tkm.c();
    }
    int i;
    for (;;)
    {
      ...
      try
      {
        ...
        bdla.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A69", "0X8006A69", 0, 0, "", paramString, "", "");
        olh.a("0X8006A69", "", "", paramString, "", "");
        if (QLog.isDevelopLevel()) {
    ...
    this.jdField_a_of_type_AndroidGraphicsBitmap = tkl.a(this.jdField_a_of_type_AndroidAppActivity.getWindow(), paramString);
    if (this.jdField_a_of_type_AndroidGraphicsBitmap != null)
    {
      if (this.jdField_a_of_type_Tkm != null) {
        this.jdField_a_of_type_Tkm.a(paramInt);
      }
      if (paramInt != 1) {
        break label477;
      }
  ...
  {
    if (this.jdField_a_of_type_Tkm != null) {
      this.jdField_a_of_type_Tkm.a(paramString);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Tkm != null) {
      this.jdField_a_of_type_Tkm.a(paramString1, paramString2, paramInt);
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Tkm.a().show();
  ...
  {
    if (this.jdField_a_of_type_Tkm != null) {
      this.jdField_a_of_type_Tkm.a(paramJSONArray);
    }
  }
  ...
  void a(boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
        ...
        do
        {
          ...
          if ((this.jdField_a_of_type_AndroidWidgetLinearLayout != null) && ((this.jdField_a_of_type_AndroidWidgetLinearLayout.getTag() instanceof Integer)))
          {
            ...
            if (i != paramInt)
            {
              ...
              localObject = (RelativeLayout)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131363780);
              if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.mRootView != null)) {
                this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.mRootView.findViewById(2131363780);
              }
          ...
          if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
          {
            ...
            this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)LayoutInflater.from(BaseApplicationImpl.getContext()).inflate(2131559672, null));
            localObject = (RelativeLayout)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131363780);
            if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.mRootView != null)) {
              this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mUIStyleHandler.mRootView.findViewById(2131363780);
            }
            ...
            if (paramInt == 2)
            {
              localObject = (LinearLayout.LayoutParams)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131377122).getLayoutParams();
              ((LinearLayout.LayoutParams)localObject).width = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131297583);
              ((LinearLayout.LayoutParams)localObject).height = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131297584);
            }
            this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131377122).setOnClickListener(new bihl(this));
          }
          ...
          ((ImageView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131377122)).setImageBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap);
      ...
      ((AlphaAnimation)localObject).setAnimationListener(new bihm(this));
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Uvz != null;
  }
  
  public void b(String paramString)
  {
    if ((this.jdField_a_of_type_Uvz == null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      ...
      this.jdField_a_of_type_Uvz = new uvz(this.jdField_a_of_type_AndroidAppActivity, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
      this.jdField_a_of_type_Uvz.a(this);
      localObject = a();
      if (localObject != null)
      {
        ((View)localObject).setDrawingCacheEnabled(true);
        ((View)localObject).getViewTreeObserver().addOnGlobalLayoutListener(new bihk(this, (View)localObject));
      }
      if (QLog.isColorLevel()) {
    ...
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_Tkm != null)) {
      this.jdField_a_of_type_Tkm.c(paramString.replace("|", "｜"));
    }
    while ((this.jdField_a_of_type_Tkm == null) || (!TextUtils.isEmpty(this.jdField_a_of_type_Tkm.b())) || (this.jdField_a_of_type_AndroidAppActivity == null)) {
      return;
    }
    this.jdField_a_of_type_Tkm.c(BaseApplicationImpl.getContext().getResources().getString(2131695004));
  }
  ...
  {
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_Tkm != null)) {
      this.jdField_a_of_type_Tkm.b(paramString);
    }
  }
  ...
  {
    if ((!TextUtils.isEmpty(paramString)) && (this.jdField_a_of_type_Tkm != null)) {
      this.jdField_a_of_type_Tkm.e(paramString);
    }
  }
  ...
  public void f(String paramString)
  {
    ...
    paramString.putExtra("EditPicType", this.jdField_a_of_type_Tkm.b());
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          continue;
          bdla.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1001", localException, "", "");
          olh.a("0X8006A1F", "", "1001", localException, "", "");
          if (QLog.isColorLevel())
          {
            QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action friend!");
            continue;
            bdla.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1002", localException, "", "");
            olh.a("0X8006A1F", "", "1002", localException, "", "");
            if (QLog.isColorLevel())
            {
              QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action qzone!");
              continue;
              bdla.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1003", localException, "", "");
              olh.a("0X8006A1F", "", "1003", localException, "", "");
              if (QLog.isColorLevel())
              {
                QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action wechat!");
                continue;
                bdla.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1004", localException, "", "");
                olh.a("0X8006A1F", "", "1004", localException, "", "");
                if (QLog.isColorLevel())
                {
                  QLog.d("SwiftBrowserScreenShotHandler", 2, "onScreenShotItemClick->do action wechat circle!");
                  continue;
                  olh.a(null, "", "0X800787A", "0X800787A", 0, 0, localException, str, "", "");
                  bdla.b(null, "dc00899", "Pb_account_lifeservice", "", "0X8006A1F", "0X8006A1F", 0, 0, "1005", localException, "", "");
                  olh.a("0X8006A1F", "", "1005", localException, "", "");
                  if (QLog.isColorLevel()) {
  ...
  public void onLifeCycleStateChanged(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      do
      {
        ...
        } while (this.jdField_a_of_type_Tkm == null);
      ...
      return;
      if ((this.jdField_a_of_type_Tkm != null) && (this.jdField_a_of_type_Tkm.a() != null)) {
        this.jdField_a_of_type_Tkm.a().onConfigurationChanged();
      }
