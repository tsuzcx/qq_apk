...
public class awwa
{
  ...
  private static long a(String paramString, bbcu parambbcu, boolean paramBoolean)
  {
    paramString = a(parambbcu, paramString);
    return a(paramString[0], paramString[1], parambbcu.jdField_a_of_type_JavaUtilList.size(), false, paramBoolean);
  }
    ...
    do
    {
      for (;;)
      {
        ...
        if (l != -9223372036854775808L) {
          return awii.r + l + paramLong;
        }
        if (paramBoolean1)
        {
          bbcu localbbcu = ChnToSpell.a(paramString2, 1);
          if (!paramString2.equals(localbbcu.jdField_a_of_type_JavaLangString)) {}
          while (i != 0)
          {
            l = a(paramString1, localbbcu, paramBoolean3);
            if (l == -9223372036854775808L) {
              break label123;
            }
            return awii.s + l + paramLong;
            i = 0;
          }
        }
      }
  ...
  public static long a(String paramString1, String paramString2, bbcu parambbcu1, bbcu parambbcu2, long paramLong)
  {
    if ((TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString1))) {}
    long l;
    label116:
    do
    {
      for (;;)
      {
        ...
        if ((parambbcu1 != null) && (parambbcu2 != null))
        {
          if (!paramString2.equals(parambbcu1.jdField_a_of_type_JavaLangString)) {}
          for (int i = 1; i != 0; i = 0)
          {
            l = a(paramString1, parambbcu1, false);
            if (l == -9223372036854775808L) {
              break label116;
            }
            return awii.s + l + paramLong;
      ...
      l = a(paramString1, parambbcu2, false);
    } while (l == -9223372036854775808L);
    return awii.s + l + paramLong;
  }
  ...
  {
    Drawable localDrawable = BaseApplicationImpl.sApplication.getResources().getDrawable(2130840062);
  ...
  public static Drawable a(baxy parambaxy, awof paramawof)
  {
    return a(parambaxy, paramawof.b(), paramawof.c());
  }
  ...
  public static Drawable a(baxy parambaxy, String paramString, int paramInt)
  {
    ...
    {
      Bitmap localBitmap = parambaxy.a(i, paramString);
      if (localBitmap != null)
      {
        if (paramInt == 103) {
      ...
      if (!parambaxy.a()) {
        parambaxy.a(paramString, i, true, (byte)1);
      }
      if (paramInt == 1) {
        return bbef.b();
      }
      ...
      if (paramInt == 11) {
        return new BitmapDrawable(bbef.b());
      }
      if (paramInt == 102) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130843409);
      }
      if (paramInt == 106) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130846132);
      }
      if (paramInt == 105)
      {
        parambaxy = sfe.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), com.tencent.mobileqq.mqsafeedit.BaseApplication.getContext(), 1);
        if ((parambaxy != null) && (parambaxy.a() != null)) {
          return parambaxy.a();
        }
        return sfe.a(BaseApplicationImpl.sApplication, 1);
      }
      ...
      if (String.valueOf(9994L).equals(paramString)) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130840077);
      }
      if (String.valueOf(9992L).equals(paramString)) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130840075);
      }
      if (ajsd.aB.equals(paramString)) {
        return saz.a();
      }
      if (String.valueOf(9980L).equals(paramString)) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130840076);
      }
      if (String.valueOf(9973L).equals(paramString)) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130843923);
      }
      if (paramInt == 9889987) {
        return BaseApplicationImpl.sApplication.getResources().getDrawable(2130842028);
      }
      if (paramInt == 108)
      {
        parambaxy = BaseApplicationImpl.sApplication.getRuntime();
        if (parambaxy != null) {
          return ((afax)parambaxy.getManager(138)).a();
        }
      }
      else
      {
        if (String.valueOf(ajsd.D).equals(paramString)) {
          return BaseApplicationImpl.sApplication.getResources().getDrawable(2130840067);
        }
        if (paramInt == 110)
        {
          parambaxy = sfe.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), BaseApplicationImpl.sApplication, 2);
          if ((parambaxy != null) && (parambaxy.a() != null)) {
            return parambaxy.a().getConstantState().newDrawable();
          }
          return sfe.a(BaseApplicationImpl.sApplication, 2).getConstantState().newDrawable();
        }
        if (paramInt == 111)
        {
          parambaxy = sfe.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), BaseApplicationImpl.sApplication, 3);
          if ((parambaxy != null) && (parambaxy.a() != null)) {
            return parambaxy.a().getConstantState().newDrawable();
          }
          return sfe.a(BaseApplicationImpl.sApplication, 3).getConstantState().newDrawable();
        }
      }
      return bbef.b();
    }
  ...
  public static awvy a(String paramString1, bbcv parambbcv1, String paramString2, bbcv parambbcv2, long paramLong)
  {
    if ((TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString1)) || (paramString2.contains(paramString1))) {
      return null;
    }
    if ((parambbcv1 == null) || (parambbcv2 == null)) {
      return null;
    }
    if (awwg.a(paramString1) == 0) {
      return null;
    }
    ...
    awvy localawvy = new awvy();
    String str2 = parambbcv1.jdField_b_of_type_JavaLangString;
    String str4 = parambbcv1.jdField_c_of_type_JavaLangString;
    parambbcv1 = parambbcv1.jdField_d_of_type_JavaLangString;
    String str3 = parambbcv2.jdField_b_of_type_JavaLangString;
    String str5 = parambbcv2.jdField_c_of_type_JavaLangString;
    paramString1 = parambbcv2.jdField_d_of_type_JavaLangString;
    int i5 = awwg.a(paramString2);
    int i1 = 0;
    ...
    case 0: 
      for (;;)
      {
        localawvy.jdField_d_of_type_Int = m;
        localawvy.jdField_a_of_type_Boolean = true;
        localawvy.jdField_a_of_type_JavaLangString = str1;
        localawvy.jdField_b_of_type_JavaLangString = str2;
        localawvy.jdField_c_of_type_JavaLangString = paramString2;
        localawvy.jdField_d_of_type_JavaLangString = str3;
        k = j;
        if (paramString2.length() < j) {
          k = 0;
        }
        localawvy.jdField_a_of_type_Int = k;
        j = i;
        if (paramString2.length() - localawvy.jdField_a_of_type_Int < i) {
          j = paramString2.length() - localawvy.jdField_a_of_type_Int;
        }
        localawvy.jdField_b_of_type_Int = j;
        localawvy.jdField_c_of_type_Int = ((100 - m << 8) + (n << 4) + i4);
        return localawvy;
    ...
    case 1: 
      if (str3.contains(str2))
      {
        ...
        if (awwg.a(paramString2.charAt(i)))
        {
          if (str1.length() + i > paramString2.length()) {
            break label1021;
          }
          m = ((Integer)parambbcv2.jdField_b_of_type_JavaUtilList.get(i)).intValue();
          if (str1.length() + i + 1 < parambbcv2.jdField_b_of_type_JavaUtilList.size())
          {
            j = ((Integer)parambbcv2.jdField_b_of_type_JavaUtilList.get(str1.length() + i + 1)).intValue();
            label518:
    ...
    for (;;)
    {
      ...
      {
        m = str1.length();
        n = ((Integer)parambbcv2.jdField_b_of_type_JavaUtilList.get(j)).intValue();
        if (j + m + 1 < parambbcv2.jdField_b_of_type_JavaUtilList.size())
        {
          i = ((Integer)parambbcv2.jdField_b_of_type_JavaUtilList.get(str1.length() + j + 1)).intValue();
          label700:
          parambbcv2 = str3.substring(n, i);
      ...
      for (;;)
      {
        ...
        if (str5.contains(str4))
        {
          ...
          {
            m = str1.length();
            n = ((Integer)parambbcv2.jdField_b_of_type_JavaUtilList.get(i)).intValue();
            if (i + m + 1 < parambbcv2.jdField_b_of_type_JavaUtilList.size())
            {
              j = ((Integer)parambbcv2.jdField_b_of_type_JavaUtilList.get(str1.length() + i + 1)).intValue();
              label891:
              parambbcv2 = str3.substring(n, j);
  ...
  public static awwc a(CharSequence paramCharSequence, String paramString, boolean paramBoolean)
  {
    ...
    if ((TextUtils.isEmpty(paramCharSequence)) || (TextUtils.isEmpty(paramString))) {
      return new awwc(paramCharSequence);
    }
    ...
    label293:
    return new awwc(paramCharSequence);
    return new awwc(paramCharSequence, i, j);
  }
  ...
  public static CharSequence a(TextView paramTextView, float paramFloat, int paramInt, CharSequence paramCharSequence, List<String> paramList, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    float f1 = a(paramTextView, ajya.a(2131713680));
    ...
    do
    {
      do
      {
        ...
        for (;;)
        {
          ...
          awwc localawwc = a(paramCharSequence, (String)localObject, paramBoolean1);
          localObject = localawwc.jdField_a_of_type_JavaLangCharSequence;
          m = j;
          n = i;
          ...
          if (i == -1)
          {
            ...
            if (j == 0)
            {
              ...
              n = i;
              paramCharSequence = (CharSequence)localObject;
              if (localawwc.jdField_a_of_type_Int != -1)
              {
                m = j;
                n = i;
                paramCharSequence = (CharSequence)localObject;
                if (localawwc.jdField_b_of_type_Int > 0)
                {
                  n = localawwc.jdField_a_of_type_Int;
                  m = localawwc.jdField_b_of_type_Int;
                  paramCharSequence = (CharSequence)localObject;
                }
              }
            }
  ...
  public static CharSequence a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    {
      jdField_a_of_type_AndroidGraphicsPaint = ((TextView)LayoutInflater.from(paramQQAppInterface.getApp()).inflate(2131562379, null).findViewById(2131377350)).getPaint();
  ...
  public static CharSequence a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, awvy paramawvy)
  {
    if (paramawvy == null) {
      return new SpannableStringBuilder(paramString1);
    }
    ...
    int k = paramawvy.jdField_a_of_type_Int;
    int m = paramawvy.jdField_b_of_type_Int;
    if ((k < 0) || (k > paramString1.length()) || (!paramString1.equalsIgnoreCase(paramawvy.jdField_c_of_type_JavaLangString)) || (paramawvy.jdField_d_of_type_Int > 1)) {
      return new SpannableStringBuilder(paramString1);
    }
    float f1 = jdField_a_of_type_AndroidGraphicsPaint.measureText(paramString1);
    ...
    if ((f1 >= jdField_c_of_type_Int) && (k >= 0))
    {
      ...
      paramawvy = new float[paramString2.length()];
      jdField_a_of_type_AndroidGraphicsPaint.getTextWidths(paramString2, paramawvy);
      i = paramawvy.length - 1;
      f1 = 0.0F;
      j = 0;
      if (i >= 0)
      {
  ...
  public static void a()
  {
    ...
    {
      if (i != 0) {
        axqy.b(null, "CliOper", "", "", "0X8005ECF", "0X8005ECF", i, 0, "", "", "", "");
      }
      return;
      j = 0;
      break;
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, String paramString1, String paramString2, int paramInt4)
  {
    ...
    default: 
      ...
      if (paramBoolean)
      {
        ...
        if (paramInt4 == 12)
        {
          ...
          label190:
          axrn.a(com.tencent.mobileqq.mqsafeedit.BaseApplication.getContext()).a(null, "NetGroupSearchItemClick", true, 0L, 0L, localHashMap, null);
          paramString1 = "";
          switch (paramInt1)
          {
          }
    ...
    for (;;)
    {
      axqy.b(null, "CliOper", "", "", paramString1, paramString1, 0, 0, String.valueOf(paramInt3), "", "", "");
      return;
      i = 70;
      break;
      i = 80;
      ...
      for (;;)
      {
        axrn.a(com.tencent.mobileqq.mqsafeedit.BaseApplication.getContext()).a(null, "NetModelSearchItemClick", true, 0L, 0L, localHashMap, null);
        break;
        localHashMap.put("isFolder", "0");
      }
      if (paramInt3 == 0)
    ...
    case 44: 
      do
      {
        do
        {
          ...
          return;
          ayap.a(localQQAppInterface, paramContext, String.valueOf(9992L));
      ...
      axqy.b(localQQAppInterface, "CliOper", "", "", "0X8006477", "0X8006477", paramInt2, 0, "", "", "", "");
      return;
    }
    ConfessMsgListFragment.a(paramContext, 2);
  }
  
  public static void a(Intent paramIntent, aqbe paramaqbe)
  {
    int j = 1006;
    boolean bool2 = false;
    String str1;
    ...
    int m;
    boolean bool1;
    if ((paramIntent != null) && (paramaqbe != null))
    {
      ...
      bool1 = true;
      if ((!(paramaqbe instanceof aqgd)) || (!paramIntent.hasExtra("contactSearchResultPhoneContactMobileCode")) || (k == 1006)) {
        break label395;
      }
  ...
  public static void a(View paramView, awoe paramawoe)
  {
    Activity localActivity = (Activity)paramView.getContext();
    Intent localIntent = new Intent();
    localIntent.putExtra("contactSearchResultUin", paramawoe.b());
    localIntent.putExtra("contactSearchResultUinType", paramawoe.d());
    localIntent.putExtra("contactSearchResultName", paramawoe.c());
    localIntent.putExtra("contactSearchResultNick", paramawoe.d());
    if (((paramawoe instanceof awmq)) || ((paramawoe instanceof awnd)) || ((paramawoe instanceof awmy))) {
      paramView = paramawoe.b();
    }
    for (;;)
    {
      String str;
      ...
      {
        localIntent.putExtra("contactSearchResultPhoneContactOriginBinder", ((awna)paramawoe).a.originBinder);
        awna localawna = (awna)paramawoe;
        str = localawna.a.mobileCode;
        if (!TextUtils.isEmpty(str)) {
          break label282;
        }
        str = localawna.a.mobileNo;
      }
      label282:
      for (;;)
      {
        localIntent.putExtra("contactSearchResultPhoneContactMobileCode", str);
        localIntent.putExtra("contactSearchResultPhoneContactNationCode", ((awna)paramawoe).a.nationCode);
        localIntent.putExtra("contactSearchResultPhoneContactAbility", ((awna)paramawoe).a.ability);
        ...
        {
          paramView = ((awms)paramawoe).e();
          break;
        }
        if ((paramawoe instanceof awmz))
        {
          paramView = ((awmz)paramawoe).jdField_a_of_type_JavaLangString;
          break;
        }
        if (!(paramawoe instanceof awnb)) {
          break label285;
        }
        paramView = ((awnb)paramawoe).e();
        break;
      }
      label285:
      paramView = "";
  ...
  public static void a(awoe paramawoe, View paramView)
  {
    ThreadManager.postImmediately(new SearchUtils.2(paramView, paramawoe), null, true);
  }
  
  public static void a(AppInterface paramAppInterface, String paramString1, String paramString2, List<String> paramList, String paramString3, Rect paramRect, awwb paramawwb)
  {
    ThreadManager.post(new SearchUtils.3(paramString1, paramString2, paramList, paramString3, paramRect, paramAppInterface, paramawwb), 8, null, true);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        paramQQAppInterface = bbex.a(paramQQAppInterface, paramActivity, paramString);
        if (paramQQAppInterface != null)
        {
  ...
  public static void a(String paramString)
  {
    ...
    for (int i = arrayOfString.length;; i = 0)
    {
      if (i > 1)
      {
        ...
        axqy.b(null, "CliOper", "", "", "0X8005E0F", "0X8005E0F", 0, 0, "" + i, "", "", "");
      }
      return;
    }
  }
  ...
  public static void a(String paramString, int paramInt1, int paramInt2, int paramInt3, View paramView)
  {
    ...
    if (bool)
    {
      int i = awvz.a(paramInt1);
      if (QLog.isColorLevel()) {
        QLog.d("searchUtils", 2, "moduleIndex:" + i + " searchKey:" + paramString);
      }
      axqy.b(null, "CliOper", "", "", "0X8005E10", "0X8005E10", paramInt1, 0, String.valueOf(i), String.valueOf(paramInt3), String.valueOf(paramInt2), "");
      ...
      axrn.a(com.tencent.mobileqq.mqsafeedit.BaseApplication.getContext()).a(null, "GroupSearchItemClick", true, 0L, 0L, a(paramView), null);
      return;
    }
    axqy.b(null, "CliOper", "", "", "0X8005E11", "0X8005E11", paramInt1, 0, "", String.valueOf(paramInt3), String.valueOf(paramInt2), "");
    paramView = new HashMap();
    paramView.put("moduleType", Integer.toString(paramInt1));
    paramView.put("moduleChildType", Integer.toString(paramInt2));
    paramView.put("itemLinePosition", Integer.toString(paramInt3));
    paramView.put("keyword", paramString);
    axrn.a(com.tencent.mobileqq.mqsafeedit.BaseApplication.getContext()).a(null, "ModelSearchItemClick", true, 0L, 0L, paramView, null);
  }
  
  public static void a(String paramString, int paramInt1, int paramInt2, View paramView)
  {
    boolean bool = a(paramView.getContext());
    int i = ((Integer)paramView.getTag(2131379214)).intValue() + 1;
    if (QLog.isColorLevel()) {
      QLog.d("searchUtils", 2, "moduleType:" + paramInt1 + " itemLinePosition:" + i);
    }
    if (bool)
    {
      int j = awvz.a(paramInt1);
      if (QLog.isColorLevel()) {
        QLog.d("searchUtils", 2, "moduleIndex:" + j + " searchKey:" + paramString);
      }
      axqy.b(null, "CliOper", "", "", "0X8005E10", "0X8005E10", paramInt1, 0, String.valueOf(j), String.valueOf(i), String.valueOf(paramInt2), "");
      paramView = new HashMap();
      paramView.put("moduleType", Integer.toString(paramInt1));
    ...
    axqy.b(null, "CliOper", "", "", "0X8005E11", "0X8005E11", paramInt1, 0, "", String.valueOf(i), String.valueOf(paramInt2), "");
    paramView = new HashMap();
    paramView.put("moduleType", Integer.toString(paramInt1));
    paramView.put("moduleChildType", Integer.toString(paramInt2));
    paramView.put("itemLinePosition", Integer.toString(i));
  ...
  public static void a(String paramString, int paramInt, View paramView, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      axqy.b(null, "CliOper", "", "", "0X8005E12", "0X8005E12", 40, 0, "3", "", "", "");
    }
    do
    {
      return;
      ...
      axqy.b(null, "CliOper", "", "", "0X8005E12", "0X8005E12", paramInt, 0, "1", "", "", "");
    } while (!UniteSearchActivity.jdField_b_of_type_Boolean);
    if (UniteSearchActivity.e == -1)
    {
      axqy.b(null, "CliOper", "", "", "0X8007E2E", "0X8007E2E", 2, 0, "", "" + UniteSearchActivity.jdField_b_of_type_Int, UniteSearchActivity.jdField_a_of_type_JavaLangString, "");
      return;
    }
    axqy.b(null, "CliOper", "", "", "0X8007E2E", "0X8007E2E", 1, 0, "", "" + UniteSearchActivity.jdField_b_of_type_Int, UniteSearchActivity.jdField_a_of_type_JavaLangString, "");
    return;
    if (QLog.isColorLevel()) {
      QLog.d("searchUtils", 2, "moduleType:" + paramInt + " -2 searchKey:" + "");
    }
    axqy.b(null, "CliOper", "", "", "0X8005E12", "0X8005E12", paramInt, 0, "2", "", "", "");
  }
  
  public static void a(String paramString1, String paramString2, int paramInt1, int paramInt2, String... paramVarArgs)
  {
    new axrc(null).a("dc00899").b("Grp_all_search").c(paramString1).d(paramString2).a(paramInt1).b(paramInt2).a(paramVarArgs).a();
  }
  ...
  {
    new axrc(null).a("dc00899").b(paramString1).c(paramString2).d(paramString3).a(paramInt1).b(paramInt2).a(paramVarArgs).a();
  }
  ...
  public static boolean a(awoi paramawoi)
  {
    return ((paramawoi instanceof awmq)) || ((paramawoi instanceof awmu)) || ((paramawoi instanceof awmy)) || ((paramawoi instanceof awnd));
  }
  ...
  public static int[] a(bbcu parambbcu, String paramString)
  {
    ...
    tmp11_7[1] = 0;
    tmp11_7;
    int j = parambbcu.jdField_a_of_type_JavaLangString.indexOf(paramString);
    if (j < 0) {
      return arrayOfInt;
    }
    int i = 0;
    int k;
    if (i < parambbcu.jdField_a_of_type_JavaUtilList.size())
    {
      if (j == ((Integer)parambbcu.jdField_a_of_type_JavaUtilList.get(i)).intValue())
      {
        arrayOfInt[0] = i;
        k = i + 1;
        for (;;)
        {
          if ((k >= parambbcu.jdField_a_of_type_JavaUtilList.size()) || (j + paramString.length() <= ((Integer)parambbcu.jdField_a_of_type_JavaUtilList.get(k)).intValue()))
          {
            arrayOfInt[1] = (k - i);
            return arrayOfInt;
          }
      ...
      k = parambbcu.jdField_a_of_type_JavaLangString.indexOf(paramString, ((Integer)parambbcu.jdField_a_of_type_JavaUtilList.get(i)).intValue());
      if (k < 0) {
        return arrayOfInt;
      }
      j = i - 1;
    ...
    do
    {
      for (;;)
      {
        ...
        if (paramBoolean)
        {
          ...
          if (!paramString2.equals(((bbcu)localObject).jdField_a_of_type_JavaLangString)) {}
          for (int i = 1; i != 0; i = 0)
          {
            localObject = a((bbcu)localObject, paramString1);
      ...
      while (i < paramString1.length)
      {
        ...
        if (!paramString1[i].equalsIgnoreCase(paramString2[i]))
        {
          ...
          if (arrayOfString1 != null)
          {
            ...
            {
              f1 = f2;
              if (awwg.a(arrayOfString1[0], arrayOfString2[0]))
              {
                f1 = f2;
                if (arrayOfString1.length > 1)
                {
                  f2 += f3;
                  f1 = f2;
                  if (awwg.b(arrayOfString1[1], arrayOfString2[1])) {
                    f1 = f2 + f3;
                  }
                }
              }
  ...
  {
    ((awpz)paramQQAppInterface.getManager(318)).a(paramString1, paramString2, paramString3, paramInt);
  }
