...
public class bdux
{
  private bduv jdField_a_of_type_Bduv = new bduv();
  ...
  private List<String> a(QQAppInterface paramQQAppInterface)
  {
    ...
    localArrayList.add(aljq.aX + paramQQAppInterface + File.separator);
  ...
  private void a(String paramString)
  {
    ...
    {
      paramString = new File(bduw.a(paramString));
  ...
  private void c(Context paramContext)
  {
    ...
    Iterator localIterator = bdva.a.iterator();
  ...
  private void d()
  {
    for (;;)
    {
      try
      {
        File[] arrayOfFile = new File(aljq.aX).listFiles();
        if (arrayOfFile == null) {
          return;
        }
  ...
  public final void a()
  {
    Iterator localIterator = bdva.b.iterator();
    while (localIterator.hasNext()) {
  ...
  public void a(Context paramContext)
  {
    ...
    catch (Throwable paramContext)
    {
      for (;;)
      {
        this.jdField_a_of_type_Bduv.reportError(new Throwable("FileSystemManager proxy", paramContext));
  ...
  public void b(Context paramContext)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1) {
      FileSystemManager.setStatisticsCallback(this.jdField_a_of_type_Bduv);
    }
    if (BaseApplicationImpl.sProcessId == 1) {}
    for (;;)
    {
