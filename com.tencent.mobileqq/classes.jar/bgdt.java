...
public final class bgdt
  implements Handler.Callback, bgdj, bivy, biwy, DownloadListener
{
  private static bgdt jdField_a_of_type_Bgdt;
  private int jdField_a_of_type_Int;
  private bgdi jdField_a_of_type_Bgdi;
  private bgdu jdField_a_of_type_Bgdu;
  ...
  private WeakReference<bgdv> jdField_a_of_type_JavaLangRefWeakReference;
  private final ArrayList<bgdw> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  public boolean a;
  ...
  private int a(int paramInt1, int paramInt2)
  {
    ...
    String str;
    Bundle localBundle;
    if ((this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper != null) && (this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bgdy != null) && (this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bgdy.jdField_a_of_type_JavaLangString != null))
    {
      str = this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bgdy.jdField_a_of_type_JavaLangString;
      localBundle = new Bundle();
      localBundle.putString(bivp.b, "100686848");
      localBundle.putString(bivp.j, this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.strNewSoftwareURL);
      localBundle.putString(bivp.f, this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName());
      localBundle.putInt(bivp.k, paramInt1);
      if (paramInt1 == 12) {
        localBundle.putBoolean(bivp.o, true);
      }
      localBundle.putString(bivp.i, "ANDROIDQQ.QQUPDATE");
      localBundle.putString(bivp.l, str);
      if (paramInt2 == 0) {
        break label319;
      }
      localBundle.putString(bivp.m, "_100686848");
    ...
    {
      localBundle.putString(bivp.jdField_c_of_type_JavaLangString, "6633");
      localBundle.putInt(bivp.e, this.jdField_a_of_type_Int);
      localBundle.putBoolean(bivp.g, true);
      localBundle.putBoolean(bivp.h, true);
      localBundle.putInt(bivp.n, 1);
      localBundle.putInt(bivp.A, this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.bGray);
      bivl.a(BaseActivity.sTopActivity, localBundle, "biz_src_jc_update", this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_ComTencentApkupdateLogicDataApkUpdateDetail, i);
      return 0;
      str = "新版手Q";
      break;
      label319:
  ...
  public static bgdt a()
  {
    if (jdField_a_of_type_Bgdt == null) {
      jdField_a_of_type_Bgdt = new bgdt();
    }
    return jdField_a_of_type_Bgdt;
  }
  ...
  public static String a()
  {
    ...
    if (localObject != null)
    {
      localObject = ((bgdt)localObject).jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper;
      str1 = str2;
      if (localObject != null)
      {
        str1 = str2;
  ...
  {
    return bkgj.a(paramString, "nt", bgds.a());
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo != null)) {
        if ((((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.iUpgradeType > 0) && (((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.bNewSwitch == 1))
        {
          ...
          if (anjo.a(paramQQAppInterface, ((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.iNewTimeStamp)) {
            break label96;
          }
          bool1 = bool2;
        }
    ...
    for (;;)
    {
      bool2 = bool1;
      if (!bool1) {
        bool2 = ((awhu)paramQQAppInterface.getManager(244)).a();
      }
      return bool2;
      bool1 = false;
      break;
  ...
  private void b(int paramInt)
  {
    try
    {
      anjo localanjo = (anjo)((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getRuntime()).a(4);
      ...
      localanjo.a(str, paramInt, this.jdField_a_of_type_JavaLangString);
      return;
    }
    finally
    {
  ...
  {
    paramQQAppInterface = bgdz.a(paramQQAppInterface);
    boolean bool2;
    boolean bool1;
  ...
  private void c(int paramInt)
  {
    ...
    do
    {
      ...
      localbgdv = (bgdv)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localbgdv == null);
    if (this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo != null) {
      localbgdv.a(paramInt, this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper, this);
    }
  ...
  private void d(int paramInt)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      if (localIterator.hasNext()) {
        ((bgdw)localIterator.next()).a(paramInt, this);
      }
    }
  }
  ...
  private void g()
  {
    try
    {
      if (!a())
      {
        this.jdField_a_of_type_Bgdu = new bgdu(this);
        this.jdField_a_of_type_Bgdu.a();
      }
      return;
    }
    finally
  ...
  private void h()
  {
    try
    {
      if (a())
      {
        this.jdField_a_of_type_Bgdu.b();
        this.jdField_a_of_type_Bgdu = null;
      }
      return;
    }
    finally
  ...
  private void i()
  {
    ...
    bcst.b((QQAppInterface)localObject, "CliOper", "", "", "0X800716C", "0X800716C", 0, 0, "", "", "", "");
    int i = 0;
    this.jdField_a_of_type_Boolean = false;
    if (bgnt.h(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl)) {
      i = 1;
    }
    ...
    bctj.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", true, 0L, 0L, (HashMap)localObject, "", true);
  }
  ...
  private void k()
  {
    try
    {
      ...
      if (this.d)
      {
        biwx.a().b(this);
        biwx.a().a();
        if (this.jdField_a_of_type_Bgdi != null)
        {
          bivl.b(this.jdField_a_of_type_Bgdi);
          this.jdField_a_of_type_Bgdi = null;
        }
  ...
  public void a()
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadInfo != null) && (this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadInfo.jdField_c_of_type_Int == 1))
      {
        ...
        anjo.b(localQQAppInterface, false);
        d(false);
        return;
      }
    } while (this.b);
    b(anjo.a(localQQAppInterface, false));
  }
  ...
  public void a(int paramInt)
  {
    ...
    {
      bctj.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeWritten", bool, 0L, 0L, localHashMap, "", true);
      return;
    }
  }
  ...
  public void a(bgdw parambgdw)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(parambgdw)) {
        this.jdField_a_of_type_JavaUtilArrayList.add(parambgdw);
      }
      return;
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    String str = anjo.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl);
  ...
  public void a(String paramString)
  {
    ...
    b(this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bgdy.jdField_a_of_type_Int);
  }
  ...
  public void a(ArrayList<ApkUpdateDetail> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      {
        if (this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bgdy.jdField_a_of_type_Int == paramArrayList.versioncode) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Bgdi == null)
        {
          ...
          this.jdField_a_of_type_Bgdi = new bgdi(paramString2, this);
          bivl.a(this.jdField_a_of_type_Bgdi);
      ...
      if (i != 0)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bgdy = null;
        c(-1);
      }
    }
  }
  ...
  boolean a()
  {
    return this.jdField_a_of_type_Bgdu != null;
  }
  ...
  {
    // Byte code:
    //   0: new 663	java/io/File
    //   3: dup
    //   4: aload_1
    //   5: invokespecial 665	java/io/File:<init>	(Ljava/lang/String;)V
    //   8: astore_1
    //   9: aload_1
    //   10: invokevirtual 668	java/io/File:exists	()Z
    //   13: ifeq +73 -> 86
    //   16: new 670	java/io/FileInputStream
    //   19: dup
    //   20: aload_1
    //   21: invokespecial 673	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   24: astore_3
    //   25: aload_3
    //   26: astore_1
    //   27: iconst_2
    ...
    //   34: aload_3
    //   35: aload 4
    //   37: invokevirtual 677	java/io/FileInputStream:read	([B)I
    //   40: pop
    //   41: aload 4
    //   43: iconst_0
    //   44: baload
    ...
    //   62: ifnull +7 -> 69
    //   65: aload_3
    //   66: invokevirtual 680	java/io/FileInputStream:close	()V
    //   69: iconst_0
    //   70: ireturn
    //   71: astore_1
    //   72: aload_1
    //   73: invokevirtual 683	java/io/IOException:printStackTrace	()V
    //   76: iconst_0
    //   77: ireturn
    //   78: aload_3
    //   79: ifnull +7 -> 86
    //   82: aload_3
    //   83: invokevirtual 680	java/io/FileInputStream:close	()V
    //   86: iconst_1
    //   87: ireturn
    //   88: astore_1
    //   89: aload_1
    //   90: invokevirtual 683	java/io/IOException:printStackTrace	()V
    //   93: goto -7 -> 86
    //   96: astore 4
    //   98: aconst_null
    //   99: astore_3
    ...
    //   106: ldc 210
    //   108: aload 4
    //   110: invokestatic 685	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   113: aload_3
    //   114: ifnull -28 -> 86
    //   117: aload_3
    //   118: invokevirtual 680	java/io/FileInputStream:close	()V
    //   121: goto -35 -> 86
    //   124: astore_1
    //   125: aload_1
    //   126: invokevirtual 683	java/io/IOException:printStackTrace	()V
    //   129: goto -43 -> 86
    //   132: astore_3
    //   133: aconst_null
    //   134: astore_1
    ...
    //   136: ifnull +7 -> 143
    //   139: aload_1
    //   140: invokevirtual 680	java/io/FileInputStream:close	()V
    //   143: aload_3
    //   144: athrow
    //   145: astore_1
    //   146: aload_1
    //   147: invokevirtual 683	java/io/IOException:printStackTrace	()V
    //   150: goto -7 -> 143
    //   153: astore_3
    //   154: goto -19 -> 135
    //   157: astore 4
  ...
  public boolean a(UpgradeInfo paramUpgradeInfo, bgdv parambgdv)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bgdy = anjo.a(paramUpgradeInfo);
    if ((parambgdv == null) || (paramUpgradeInfo == null)) {
      return false;
    }
    ...
    j();
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambgdv);
    if (QLog.isColorLevel()) {
      QLog.d("UpgradeController", 2, "handleUpgradeInfo packageName = " + this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName() + ", bGray = " + paramUpgradeInfo.bGray + ", versioncode = " + this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bgdy.jdField_a_of_type_Int);
    }
    paramUpgradeInfo = new ApkUpdateParam(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName(), paramUpgradeInfo.bGray, this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bgdy.jdField_a_of_type_Int);
    parambgdv = new ArrayList();
    parambgdv.add(paramUpgradeInfo);
    biwx.a().b(parambgdv);
    return true;
  }
  ...
  public void b(bgdw parambgdw)
  {
    ...
    {
      if (this.jdField_a_of_type_JavaUtilArrayList.contains(parambgdw)) {
        this.jdField_a_of_type_JavaUtilArrayList.remove(parambgdw);
      }
      return;
    }
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    anjo.b(localQQAppInterface, paramBoolean);
    if (paramBoolean)
    {
      g();
      return;
  ...
  public void c()
  {
    ...
    //   11: iconst_2
    //   12: ldc_w 792
    //   15: invokestatic 339	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   18: aload_0
    //   19: getfield 243	bgdt:b	Z
    //   22: ifeq +21 -> 43
    //   25: aload_0
    //   26: iconst_0
    //   27: putfield 243	bgdt:b	Z
    //   30: aload_0
    //   31: invokevirtual 794	bgdt:e	()V
    //   34: aload_0
    //   35: invokespecial 796	bgdt:h	()V
    //   38: ldc 138
    //   40: invokestatic 798	bivl:a	(Ljava/lang/String;)V
    //   43: aload_0
    //   44: monitorexit
    //   45: return
    //   46: astore_1
  ...
  public void onDownloadError(DownloadInfo paramDownloadInfo, int paramInt1, String paramString, int paramInt2)
  {
    ...
    bctj.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", false, 0L, 0L, paramDownloadInfo, "", true);
  }
  ...
  public void onDownloadFinish(DownloadInfo paramDownloadInfo)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject2))
    {
      ...
      {
        paramDownloadInfo = bivr.a().a(paramDownloadInfo);
        localObject1 = localObject2;
    ...
    for (;;)
    {
      int k = ardl.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl);
      ...
      for (i = 101;; i = 9527)
      {
        ...
        bctj.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", false, 0L, 0L, (HashMap)localObject1, "", true);
        if (bool) {
          break;
        }
        this.jdField_a_of_type_Bkgm.sendEmptyMessage(0);
        return;
