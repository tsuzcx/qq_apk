...
public class wrq
{
  ...
  private static final Property<ImageView, Matrix> jdField_a_of_type_AndroidUtilProperty = new wru(Matrix.class, "animatedTransform");
  ...
  private wrx jdField_a_of_type_Wrx;
  ...
  public wrq(Bundle paramBundle, wry paramwry)
  {
    if ((paramBundle == null) || (paramwry == null)) {
      return;
    }
      ...
      for (;;)
      {
        try
        {
          ...
          if (Build.VERSION.SDK_INT >= 16)
          {
            ...
            localBundle.putString("bundle_key_source_image_param", new wrx((String)localObject, paramInt1, paramInt2).a());
  ...
  private void a()
  {
    if ((this.jdField_a_of_type_Wrp != null) && (this.jdField_a_of_type_Wrp.a())) {
      return;
    }
  ...
  {
    if (this.jdField_a_of_type_Wrp != null) {
      this.jdField_a_of_type_Wrp.a(2);
    }
    ...
    ((ObjectAnimator)localObject1).addListener(new wrs(this, paramInt4, paramInt3, paramInt1, paramInt2));
    ...
    localObject2 = ObjectAnimator.ofObject(this.jdField_a_of_type_AndroidWidgetImageView, jdField_a_of_type_AndroidUtilProperty, new wrv(), new Matrix[] { localObject2, localObject3 });
    ...
    this.jdField_a_of_type_AndroidAnimationAnimatorSet.addListener(new wrt(this));
  ...
  {
    this.jdField_a_of_type_Wrp = new wrp();
    ...
    this.jdField_a_of_type_Wrx = new wrx();
    this.jdField_a_of_type_Wrx.a(str);
    this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Wrx.jdField_a_of_type_JavaLangString;
    this.jdField_a_of_type_JavaIoFile = new File(this.jdField_a_of_type_JavaLangString);
    this.jdField_a_of_type_Int = this.jdField_a_of_type_Wrx.jdField_a_of_type_Int;
    this.jdField_b_of_type_Int = this.jdField_a_of_type_Wrx.jdField_b_of_type_Int;
  ...
  private void c()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetFrameLayout != null)
    {
      ...
      localLayoutParams.topMargin = this.jdField_a_of_type_Wry.a();
    ...
    this.jdField_a_of_type_Wrp.a(1);
  }
  
  private void d()
  {
    int[] arrayOfInt = this.jdField_a_of_type_Wry.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
  ...
  private void e()
  {
    if ((this.jdField_a_of_type_Wrp == null) || (!this.jdField_a_of_type_Wrp.b())) {
      QLog.d("TransitionAnimHelper", 1, "initImageEnterAnimation error!");
    }
    while (this.jdField_b_of_type_AndroidWidgetImageView == null) {
      return;
    }
    this.jdField_b_of_type_AndroidWidgetImageView.getViewTreeObserver().addOnPreDrawListener(new wrr(this));
  }
  ...
  {
    if (this.jdField_a_of_type_Wrp != null) {
      this.jdField_a_of_type_Wrp.a(paramwrz);
    }
  }
}
