  ...
  extends absm
{
  ...
  public amlc(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, ayzv paramayzv)
  {
    ...
    do
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("wk", 2, "onReceive, MessageConstants.CMD_TRANSSERVICE_REQOFFFILEPACK: " + paramayzv.jdField_b_of_type_Byte);
      }
      if (paramayzv.jdField_b_of_type_Byte == 6)
      {
        e(paramToServiceMsg, paramFromServiceMsg, paramayzv);
        return;
      }
      if (paramayzv.jdField_b_of_type_Byte == 3)
      {
        d(paramToServiceMsg, paramFromServiceMsg, paramayzv);
        return;
      }
      if (paramayzv.jdField_b_of_type_Byte == 2)
      {
        c(paramToServiceMsg, paramFromServiceMsg, paramayzv);
        return;
      }
    } while (paramayzv.jdField_b_of_type_Byte != 1);
    b(paramToServiceMsg, paramFromServiceMsg, paramayzv);
  }
  ...
  private void a(msg_svc.PbSendMsgReq paramPbSendMsgReq, FMTransC2CMsgInfo paramFMTransC2CMsgInfo)
  {
    ...
    {
      return;
      paramFMTransC2CMsgInfo = asqr.a(paramFMTransC2CMsgInfo.entity.getFilePath(), paramFMTransC2CMsgInfo.entity.imgWidth, paramFMTransC2CMsgInfo.entity.imgHeight, paramFMTransC2CMsgInfo.entity.strQRUrl);
  ...
  private void a(msg_svc.PbSendMsgReq paramPbSendMsgReq, FMTransC2CMsgInfo paramFMTransC2CMsgInfo, azak paramazak)
  {
    long l1 = 0L;
    ...
    for (;;)
    {
      if ((paramazak != null) && (paramazak.jdField_a_of_type_ArrayOfByte != null)) {
        break label786;
      }
      if (!QLog.isColorLevel()) {
        break;
    ...
    paramPbSendMsgReq.msg_body.rich_text.trans_211_tmp_msg.bytes_msg_body.set(ByteStringMicro.copyFrom(paramazak.jdField_a_of_type_ArrayOfByte));
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, ayzv paramayzv)
  {
    ...
    localalwy.b = paramFromServiceMsg.getResultCode();
    localalwy.c = i;
    this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(paramToServiceMsg, 5004, true, new Object[] { paramayzv, localalwy });
  }
            ...
            if (QLog.isColorLevel())
            {
              ...
              if (QLog.isColorLevel())
              {
                ...
                if (QLog.isColorLevel())
                {
                  ...
                  {
                    amkl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, paramObject.errmsg.get(), 1001, false, false);
                  ...
                  {
                    azqs.b((QQAppInterface)localObject1, "dc00899", "grp_lbs", "", "c2c_tmp", "no_send", 0, 0, paramObject, "" + i, "", "");
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, ayzv paramayzv)
  {
    ...
    localalwy.b = paramFromServiceMsg.getResultCode();
    localalwy.c = i;
    this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(paramToServiceMsg, 5005, true, new Object[] { paramayzv, localalwy });
  }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, ayzv paramayzv)
  {
    ...
    {
      return;
      long l1 = paramayzv.jdField_c_of_type_Long;
      long l2 = paramayzv.d;
      long l3 = paramayzv.e;
      long l4 = paramayzv.jdField_b_of_type_Long;
      paramFromServiceMsg = paramayzv.jdField_b_of_type_JavaLangString;
      String str1 = paramayzv.jdField_c_of_type_JavaLangString;
      String str2 = paramToServiceMsg.extraData.getString("friendUin");
      boolean bool = paramToServiceMsg.extraData.getBoolean("isRead");
      Object localObject = "http://" + bdqa.b(l1) + "/?ver=" + "2" + "&rkey=" + paramFromServiceMsg;
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.BaseMessageProcessor", 2, "<<---handleGetOffLineFileResp serverPath: " + (String)localObject + " strFileName: " + str1 + " time: " + paramayzv.d + " seq: " + paramayzv.jdField_a_of_type_Short);
      }
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.BaseMessageProcessor", 2, "friendUin:" + str2 + "  struct.senderUin: " + paramayzv.jdField_b_of_type_Long + " struct.time: " + paramayzv.d + " struct.seq: " + paramayzv.jdField_a_of_type_Short);
      }
      int i;
      if (azah.a(str1, paramayzv.jdField_a_of_type_Byte))
      {
        paramFromServiceMsg = bays.a((String)localObject, l3, 1, false, (String)localObject);
        i = -2000;
      }
      while (paramFromServiceMsg != null)
      {
        localObject = azaf.a(i);
        ...
        ((MessageRecord)localObject).msgseq = paramayzv.jdField_a_of_type_Short;
        ((MessageRecord)localObject).shmsgseq = paramayzv.jdField_a_of_type_Short;
        ...
        return;
        if (azah.b(str1, paramayzv.jdField_a_of_type_Byte))
        {
          if (!str1.contains("_")) {}
          for (paramFromServiceMsg = str1.substring(0, str1.length() - 4);; paramFromServiceMsg = str1.substring(str1.lastIndexOf("_") + 1, str1.length() - 4))
          {
            ...
            if (!azuj.e(paramFromServiceMsg)) {
              break;
            }
            if (QLog.isColorLevel()) {
              QLog.d("Q.msg.BaseMessageProcessor", 2, "is Duplicate key：" + paramFromServiceMsg);
            }
            azuj.d(paramFromServiceMsg);
            return;
          }
          azuj.c(paramFromServiceMsg);
          paramFromServiceMsg = bays.a((String)localObject, l3, 2, false);
          i = -2002;
        }
        else
        {
          ...
          paramFromServiceMsg = bays.a(barl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), str1, 0, null), l3, 0, false, (String)localObject);
          i = -2005;
        }
      }
    }
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, ayzv paramayzv)
  {
    if (paramayzv == null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(paramToServiceMsg, paramFromServiceMsg);
    ...
    localalwy.b = paramFromServiceMsg.getResultCode();
    localalwy.c = i;
    this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(paramToServiceMsg, 5003, true, new Object[] { paramayzv.jdField_a_of_type_ArrayOfByte, localalwy });
  }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    case 7001: 
      ...
      {
        a((ToServiceMsg)paramVarArgs[0], (FromServiceMsg)paramVarArgs[1], (ayzv)paramVarArgs[2]);
        return;
      }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(paramToServiceMsg, 5003, false, new Object[] { paramFromServiceMsg, localalwy });
        return;
      }
      if (paramToServiceMsg.extraData.getInt("offfile_type") == 2)
      {
        this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(paramToServiceMsg, 5005, false, new Object[] { paramFromServiceMsg, localalwy });
        return;
      }
    } while (paramToServiceMsg.extraData.getInt("offfile_type") != 3);
    this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a(paramToServiceMsg, 5004, false, new Object[] { paramFromServiceMsg, localalwy });
  }
  ...
  public boolean a(String paramString, int paramInt, byte[] paramArrayOfByte, FMTransC2CMsgInfo paramFMTransC2CMsgInfo)
  {
    ...
    a(true, true, true, l, new amld(this, paramString, paramFMTransC2CMsgInfo, paramInt, paramArrayOfByte));
    return true;
  }
  ...
  public boolean a(String paramString, long paramLong, int paramInt, byte[] paramArrayOfByte)
  {
    ...
    ayxz.a = i + 1;
    long l = i;
    a(true, true, true, l, new amle(this, paramString, paramLong, Math.abs(new Random().nextInt()), l, paramInt, paramArrayOfByte));
    return true;
  }
