  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject1 = (ChatMessage)((ambw)paramView.getTag()).a;
    if (this.a.b()) {
    ...
    while ((!(localObject1 instanceof MessageForStructing)) || (((MessageForStructing)localObject1).structingMsg == null) || (!(((MessageForStructing)localObject1).structingMsg instanceof AbsShareMsg))) {
      for (;;)
      {
        this.a.jdField_a_of_type_Ambv.notifyDataSetChanged();
        break;
    ...
    if ((localObject1 instanceof StructMsgForGeneralShare))
    {
      ...
      bcwp localbcwp = new bcwp(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView, (StructMsgForGeneralShare)localObject2);
      StructMsgForGeneralShare.onClickEvent(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_AndroidContentContext, (StructMsgForGeneralShare)localObject2, paramView, localbcwp);
    }
    for (;;)
    {
