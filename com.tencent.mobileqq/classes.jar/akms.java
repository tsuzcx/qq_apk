  ...
  extends PhotoPreviewLogicBase
{
  ...
  public akms(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
  ...
  private void a()
  {
    if (this.mPhotoCommonData.selectedPhotoList.size() == 0)
    {
      ...
      {
        QQToast.a(this.mActivity, anvx.a(2131689757), 0).b(this.mActivity.getResources().getDimensionPixelSize(2131299080));
        return;
      }
      this.mPhotoCommonData.selectedPhotoList.add(this.jdField_a_of_type_JavaLangString);
    }
    bode.a(this.c, this.mActivity, this.mPhotoCommonData, false);
  ...
  public void initUI()
  {
    ...
    this.mActivity.sendBtn.setOnClickListener(new akmt(this));
  }
  ...
  public void onSelectClick(View paramView)
  {
    ...
    if (!this.mPhotoCommonData.selectedIndex.contains(Integer.valueOf(i)))
    {
      ...
      {
        paramView = BaseApplicationImpl.sApplication.getResources().getString(2131689758, new Object[] { Integer.valueOf(9 - this.b) });
        QQToast.a(this.mActivity, paramView, 0).b(this.mActivity.getResources().getDimensionPixelSize(2131299080));
        return;
      }
      ...
      {
        QQToast.a(this.mActivity, anvx.a(2131689759), 0).b(this.mActivity.getResources().getDimensionPixelSize(2131299080));
        return;
      }
      if (j != 1) {}
    }
  ...
  public void updateButton()
  {
    ...
    this.mActivity.sendBtn.setBackgroundResource(2130837999);
    super.updateButton();
  }
}
