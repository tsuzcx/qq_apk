  ...
  implements bihh
{
  ...
  protected bgcd a;
  protected biau a;
  bjha jdField_a_of_type_Bjha = new bgca(this);
  protected bkho a;
  protected bkic a;
  ...
  public bgbw(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData)
  {
    this(paramBaseActivity, paramTroopInfoData, null);
  }
  
  public bgbw(BaseActivity paramBaseActivity, TroopInfoData paramTroopInfoData, bgcd parambgcd)
  {
    this.jdField_a_of_type_Int = -1;
    this.jdField_b_of_type_Int = -1;
    this.jdField_a_of_type_Anxg = new bgbz(this);
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData = paramTroopInfoData;
    if (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.addObserver(this.jdField_a_of_type_Bjha);
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.addObserver(this.jdField_a_of_type_Anxg);
    }
    this.jdField_a_of_type_Bgcd = parambgcd;
  }
  ...
  public static Bitmap a(String paramString, Resources paramResources, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    catch (OutOfMemoryError paramString)
    {
      ...
      if (paramBoolean)
      {
        ...
        paramResources = bggl.a(paramResources, 2130839652);
  ...
  public static String a(String paramString, Context paramContext)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      str = paramContext.getString(2131718039);
    }
    return str;
  }
  ...
  public static void a(Activity paramActivity, Bundle paramBundle, int paramInt)
  {
    try
    {
      localAbsShareMsg = new bcvp(StructMsgForGeneralShare.class).c(132).a(paramBundle.getString("summary")).e(paramBundle.getString("targetUrl")).a(1105290942L).a();
      ...
      for (localAbsShareMsg.mSourceName = "NOW";; localAbsShareMsg.mSourceName = "")
      {
        ...
        ((bcvt)localObject).a(paramBundle.getString("imageUrl"), paramBundle.getString("title"), str);
        ...
        aufz.a(paramActivity, paramBundle, paramInt);
        return;
  ...
  public static void a(Activity paramActivity, MessageForQQStory paramMessageForQQStory, int paramInt)
  {
    try
    {
      AbsShareMsg localAbsShareMsg = new bcvp(StructMsgForGeneralShare.class).c(80).a(paramMessageForQQStory.brief).e("").a();
      ...
      try
      {
        ...
        aufz.a(paramActivity, (Intent)localObject, paramInt);
        if (QLog.isColorLevel())
        {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, int paramInt, Intent paramIntent)
  {
    ...
    localIntent = afur.a(new Intent(paramActivity, SplashActivity.class), null);
  ...
  public static List<ShareActionSheetBuilder.ActionSheetItem>[] a(Context paramContext, boolean paramBoolean)
  {
    ...
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).label = paramContext.getString(2131695695);
    ...
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).label = paramContext.getString(2131695708);
    ...
    localArrayList.add(localObject);
    localObject = new ShareActionSheetBuilder.ActionSheetItem();
    ((ShareActionSheetBuilder.ActionSheetItem)localObject).label = paramContext.getString(2131695698);
    ...
    localActionSheetItem.label = paramContext.getString(2131695687);
    ...
    if (paramBoolean)
    {
      ...
      localActionSheetItem.label = paramContext.getString(2131715811);
      localActionSheetItem.icon = 2130842415;
      localActionSheetItem.iconNeedBg = true;
  ...
  public static void b(Activity paramActivity, Bundle paramBundle, int paramInt)
  {
    try
    {
      Object localObject = new bcvp(StructMsgForGeneralShare.class);
      if ("action_mqq".equals(paramBundle.getString("jump_action")))
      {
        localObject = ((bcvp)localObject).c(129).a(paramBundle.getString("summary")).a(1104763709L).a();
      ...
      for (;;)
      {
        ...
        String str = paramBundle.getString("summary");
        localbcvt.a(paramBundle.getString("imageUrl"), paramBundle.getString("title"), str);
        ...
        aufz.a(paramActivity, paramBundle, paramInt);
        return;
        localObject = ((bcvp)localObject).c(129).a(paramBundle.getString("summary")).e(paramBundle.getString("targetUrl")).a(1104763709L).a();
        ((AbsShareMsg)localObject).mMsgBrief = paramBundle.getString("summary");
        ((AbsShareMsg)localObject).mContentSummary = paramBundle.getString("summary");
        ((AbsShareMsg)localObject).mContentTitle = paramBundle.getString("title");
        ((AbsShareMsg)localObject).mSourceAction = "";
  ...
  private void h()
  {
    ...
    do
    {
      ...
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 0, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131718791), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      ...
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 0, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131697034), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      localObject = "";
      if (this.jdField_b_of_type_Int == 1)
      ...
      for (;;)
      {
        ...
        bcst.b(localQQAppInterface, "CliOper", "", "", "Grp", (String)localObject, 0, 0, str, "", "", "");
        ...
        if (this.jdField_a_of_type_Bgcd != null) {
          this.jdField_a_of_type_Bgcd.a(this.jdField_a_of_type_Int, false);
        }
        this.jdField_a_of_type_Int = -1;
        this.jdField_b_of_type_Int = -1;
    ...
    {
      ((bjhb)localQQAppInterface.a(85)).b(this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
      return;
    }
    Object localObject = (anwd)localQQAppInterface.a(20);
    ...
    default: 
      return;
    case 0: 
      this.jdField_c_of_type_JavaLangString = bfpi.a("", this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, 0);
      l();
      return;
    case 3: 
      i();
  ...
  private void i()
  {
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty((CharSequence)localObject3)) {
        localObject1 = anni.a(2131714462) + bglf.e(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
      }
  ...
  private void j()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopName == null)
    {
      ...
      str1 = anni.a(2131714458) + bglf.e(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
    }
    label337:
    for (;;)
    {
  ...
  private void k()
  {
    ...
    if (bool)
    {
      ...
      localObject1 = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131718035), new Object[] { localObject2 }) + "(" + this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin + ")" + a();
      ...
      ((Bundle)localObject3).putString("desc", anni.a(2131714461) + bglf.e(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin));
    }
    for (;;)
    {
      ...
      bltb.a(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (Bundle)localObject3, null, 145);
      if (QLog.isColorLevel()) {
      ...
      this.jdField_b_of_type_Int = -1;
      return;
      localObject1 = bfpi.a("", this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, 0) + "100";
      break;
      label539:
  ...
  private void l()
  {
    ...
    for (localObject3 = (String)localObject1 + "(" + ((TroopInfo)localObject3).wMemberNum + ")";; localObject3 = localObject1)
    {
      ...
      AbsShareMsg localAbsShareMsg = new bcvp(StructMsgForGeneralShare.class).c(15).a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131717276) + (String)localObject3).a("web", a(), (String)localObject1, (String)localObject1, (String)localObject1).a();
      ...
      for (;;)
      {
        ...
        localbczv.b(1);
        localbczv.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131695486));
        bcvt localbcvt = bcwc.a(2);
        String str = this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.mRichFingerMemo;
        if (TextUtils.isEmpty(str))
        {
          localObject2 = anni.a(2131714460) + bglf.e(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopowneruin);
          label423:
          localbcvt.a((String)localObject1, (String)localObject3, (String)localObject2, 1);
          localAbsShareMsg.addItem(localbczv);
        ...
        for (int i = 21;; i = 3)
        {
          aufz.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, (Intent)localObject2, i);
          if ((this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity instanceof TroopCreateLogicActivity)) {
  ...
  private void m()
  {
    ...
    str1 = String.format(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131693152), new Object[] { str1, a() });
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bgcd != null) {
        this.jdField_a_of_type_Bgcd.a(this.jdField_a_of_type_Int, true);
      }
      this.jdField_a_of_type_Int = -1;
      this.jdField_b_of_type_Int = -1;
      return;
  ...
  public void a()
  {
    try
    {
      if ((this.jdField_a_of_type_Biau == null) && (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null))
      {
  ...
  public void a(bgce parambgce)
  {
    ThreadManager.post(new TroopShareUtility.10(this, parambgce), 8, null, false);
  }
  ...
  public void a(TroopInfoData paramTroopInfoData)
  {
    ...
    bcst.b((QQAppInterface)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppRuntime(), "CliOper", "", "", "Grp", "Clk_share_grplink", 0, 0, "", "", "", "");
    this.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData = paramTroopInfoData;
    d();
  }
  ...
  protected void b(boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        str1 = "0";
        localbcsy = new bcsy(null).a("P_CliOper").b("Grp_set").c("Grp_data").d((String)localObject);
    ...
    {
      localbcsy.a(new String[] { str2, localObject, str1 }).a();
      return;
  ...
  protected void d()
  {
    ...
    for (int i = 5;; i = 4)
    {
      ...
      while (j <= i)
      {
        ((List)localObject).add(bkic.a(j));
        j += 1;
      }
    }
    if ((this.jdField_a_of_type_Bkic == null) && (this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity != null)) {
      this.jdField_a_of_type_Bkic = new bkic(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
    }
    if (this.jdField_a_of_type_Bkic != null) {
      this.jdField_a_of_type_Bkic.a((List)localObject);
    }
    if (this.jdField_a_of_type_Bkho == null)
    {
      localObject = new bgbx(this);
      if (this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder == null)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setOnDismissListener(new bgby(this));
  ...
  public void e()
  {
    this.jdField_a_of_type_Bgcd = null;
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.removeObserver(this.jdField_a_of_type_Bjha);
  ...
  public void f()
  {
    ...
    localIntent.putExtra("title", anni.a(2131714457));
    int i;
  ...
  public void onWXShareResp(BaseResp paramBaseResp)
  {
    ...
    if (this.jdField_a_of_type_Bgcd != null)
    {
      bgcd localbgcd = this.jdField_a_of_type_Bgcd;
    ...
    else
    {
      ...
      case -1: 
      default: 
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 1, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131718007), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
      }
    }
    for (;;)
    {
      ...
      bool = false;
      break;
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131718025), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
    }
  }
}
