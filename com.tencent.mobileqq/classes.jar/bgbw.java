...
public class bgbw
{
  ...
  public bgbw(Context paramContext, ViewGroup paramViewGroup)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(paramContext).inflate(2131560641, paramViewGroup, false);
    e();
  ...
  private CharSequence a(String paramString1, String paramString2, int paramInt)
  {
    ...
    paramString2.setSpan(new bgvl(this.jdField_a_of_type_AndroidContentContext, 0, 20, 1, 7, 14, paramInt, paramString1), 0, paramString1.length(), 33);
    return paramString2;
  }
  ...
  private void a(String paramString)
  {
    ...
    paramString.setDownloadListener(new bgbz(this));
  ...
  private void e()
  {
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131380603);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379744));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369200));
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131380591);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380197));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379815));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380048));
    this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131380592);
    this.e = this.jdField_a_of_type_AndroidViewView.findViewById(2131380594);
    this.f = this.jdField_a_of_type_AndroidViewView.findViewById(2131380605);
    this.g = this.jdField_a_of_type_AndroidViewView.findViewById(2131376770);
    this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteVideoView = ((SpriteVideoView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378270));
  }
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt1, long paramLong, int paramInt2, int paramInt3)
  {
    ...
    int j = 2130843769;
    int i = paramString.getColor(2131165343);
    paramInt1 -= 1;
    int k;
    ...
    default: 
      ...
      if (this.jdField_a_of_type_AndroidWidgetImageView.getMeasuredHeight() > 0)
      {
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setText(a(anzj.a(2131712106), paramString.toString(), paramInt1));
        this.jdField_c_of_type_AndroidWidgetTextView.setTextColor(i);
        this.jdField_c_of_type_AndroidWidgetTextView.setText(a(anzj.a(2131712104), String.valueOf(paramInt2), paramInt1));
        this.jdField_d_of_type_AndroidWidgetTextView.setTextColor(i);
        this.jdField_d_of_type_AndroidWidgetTextView.setText(a(anzj.a(2131712105), String.valueOf(paramInt3), paramInt1));
        if (this.g.getMeasuredHeight() != 0) {
          break label440;
        }
        this.g.getViewTreeObserver().addOnGlobalLayoutListener(new bgby(this, paramBoolean));
      }
      break;
    }
    for (;;)
    {
      ...
      break;
      paramInt1 = paramString.getColor(2131167302);
      m = 2130843750;
      j = 2130843768;
      i = paramInt1;
      break;
      ...
      i = paramInt1;
      break;
      this.jdField_a_of_type_AndroidWidgetImageView.getViewTreeObserver().addOnGlobalLayoutListener(new bgbx(this, str2));
      break label168;
      label440:
  ...
  public void c()
  {
    ...
    if ((localObject1 instanceof QQAppInterface)) {
      bgux.a((QQAppInterface)localObject1, "qb_troop_hw_recite_result.mp4", "https://pub.idqqimg.com/pc/misc/files/20180312/59583551a1c748dfaae1e64f6e04ca20.mp4");
    }
