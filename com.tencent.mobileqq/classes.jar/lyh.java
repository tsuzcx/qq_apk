  ...
  extends lyf
{
  ...
  private volatile HashMap<Long, mas> jdField_a_of_type_JavaUtilHashMap;
  ...
  static
  {
    ...
    jdField_a_of_type_Array2dOfInt = new int[][] { arrayOfInt1, { 1, 1 }, { 1, 2 }, arrayOfInt2, arrayOfInt3, { 2, 2, 2 }, { 2, 2, 3 }, { 2, 3, 3 }, { 3, 3, 3 }, { 3, 3, 2, 2 }, { 3, 3, 3, 2 }, { 3, 3, 3, 3 }, { 3, 3, 3, 4 }, { 3, 3, 4, 4 }, { 3, 4, 4, 4 }, { 4, 4, 4, 4 } };
  ...
  protected lyh(Context paramContext, VideoAppInterface paramVideoAppInterface)
  {
  ...
  public void a(kvq paramkvq, ltl[] paramArrayOfltl, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, int paramInt4)
  {
    ...
    {
      return;
      paramInt3 = Math.min(paramkvq.c.size(), paramArrayOfltl.length);
      float f1;
      boolean bool;
      if (paramInt3 > jdField_a_of_type_Int)
      {
        paramInt3 = jdField_a_of_type_Int;
        if ((paramInt3 >= 2) && (mjg.a(1))) {
          ThreadManager.getUIHandler().post(new ScreenLayoutMultipleGrid.1(this));
        }
        paramkvq = a(paramInt3, paramInt1, paramInt2);
        f1 = mjg.a(this.jdField_a_of_type_AndroidContentContext, 12.0F);
        float f2 = mjg.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
        paramInt1 = 0;
        if (paramInt1 < paramInt3)
        {
          Object localObject = (Rect)paramkvq.get(paramInt1);
          if (localObject == null) {
            continue;
          }
          paramArrayOfltl[paramInt1].b(((Rect)localObject).left, ((Rect)localObject).top, ((Rect)localObject).right, ((Rect)localObject).bottom);
          paramArrayOfltl[paramInt1].a(0, 0, 0, 0);
          long l1 = AudioHelper.a(paramArrayOfltl[paramInt1].b());
          long l2 = paramArrayOfltl[paramInt1].h();
          if ((TextUtils.isEmpty(paramArrayOfltl[paramInt1].a())) && (l1 != 0L)) {
            paramArrayOfltl[paramInt1].b(String.valueOf(l1));
          }
          if ((l1 == 0L) || (l2 == 2L)) {
            break label302;
          }
          ...
          if (paramBoolean)
          {
            localObject = (mas)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(l1));
            if (localObject == null) {
              break label308;
            }
            bool = ((mas)localObject).d();
          }
          paramArrayOfltl[paramInt1].c(bool);
          if (paramInt3 != 1) {
            break label314;
          }
          paramArrayOfltl[paramInt1].h(false);
          paramArrayOfltl[paramInt1].a(f2);
        }
      }
      for (;;)
      {
        ...
        if (paramInt3 >= 2)
        {
          paramArrayOfltl[paramInt1].h(true);
          paramArrayOfltl[paramInt1].a(f1);
        }
      }
