...
public class birb
{
  public static boolean a()
  {
    ...
    {
      QQToast.a(BaseApplicationImpl.getApplication(), alpo.a(2131709980), 1).a();
  ...
  private static void b(String paramString)
  {
    ...
    if (localTextView != null)
    {
      ...
      localTextView.setOnClickListener(new bird(localDialog));
    }
    localTextView = (TextView)localDialog.findViewById(2131365226);
    if (localTextView != null)
    {
      localTextView.setText(2131691602);
      localTextView.setOnClickListener(new bire(localDialog, paramString));
    }
    localDialog.show();
  }
}
