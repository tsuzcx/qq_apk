...
public class afih
  implements Runnable
{
  public afih(NearbyProfileEditTribePanel paramNearbyProfileEditTribePanel) {}
  ...
  public void run()
  {
    ...
    this.a.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.runOnUiThread(new afii(this));
  }
}
