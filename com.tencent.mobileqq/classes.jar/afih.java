  ...
  extends BaseAdapter
{
  ...
  public afih(Context paramContext, View paramView, String paramString)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_JavaUtilList = afik.a().a(paramString);
  ...
  public void a()
  {
    ArrayList localArrayList = afik.a().a(this.jdField_a_of_type_JavaLangString);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845334);
      paramViewGroup.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130839124);
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetPresseffectPressEffectImageView.setImageResource(2130845333);
    }
    for (;;)
    {
