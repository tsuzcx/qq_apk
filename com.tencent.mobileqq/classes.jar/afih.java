...
public class afih
  extends afii
{
  private static final Set<WeakReference<afih>> jdField_a_of_type_JavaUtilSet = Collections.synchronizedSet(new HashSet());
  private SessionInfo jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo;
  public WeakReference<MessageForArkApp> a;
  public boolean a;
  protected WeakReference<afih> b = new WeakReference(this);
      ...
      do
      {
        ...
        do
        {
          do
          {
            ...
            {
              return null;
              localObject = (afih)((WeakReference)localObject).get();
            } while (localObject == null);
            localObject = ((afih)localObject).jdField_a_of_type_JavaLangRefWeakReference;
          } while (localObject == null);
  ...
  public static void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      Object localObject2 = (afih)((WeakReference)localObject2).get();
      ((afih)localObject2).doOnEvent(paramInt);
      if (paramInt == 2) {
        b((afih)localObject2);
      }
    }
  ...
  public static void a(afih paramafih)
  {
    if (paramafih == null) {
      return;
    }
    synchronized (jdField_a_of_type_JavaUtilSet)
    {
      jdField_a_of_type_JavaUtilSet.remove(paramafih.b);
      return;
    }
  }
  
  public static void b(afih paramafih)
  {
    WeakReference localWeakReference = paramafih.jdField_a_of_type_JavaLangRefWeakReference;
    if ((localWeakReference != null) && (localWeakReference.get() != null)) {
      ((MessageForArkApp)localWeakReference.get()).arkContainer = null;
    }
    localWeakReference = paramafih.f;
    if ((localWeakReference != null) && (localWeakReference.get() != null)) {
      ((RecommendCommonMessage)localWeakReference.get()).mOldAppInfo.mArkContainer = null;
    }
    localWeakReference = paramafih.g;
    if ((localWeakReference != null) && (localWeakReference.get() != null)) {
      ((RecommendCommonMessage.ArkMsgAppInfo)localWeakReference.get()).mArkContainer = null;
    }
    paramafih = paramafih.jdField_e_of_type_JavaLangRefWeakReference;
    if ((paramafih != null) && (paramafih.get() != null)) {
      ((ArkBabyqCardInfo)paramafih.get()).mArkBabyqContainer = null;
    }
  }
