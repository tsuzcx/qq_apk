  ...
  implements bjvb
{
  ...
  public afih(BaseChatPie paramBaseChatPie)
  {
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Arfd != null) {
      this.jdField_a_of_type_Arfd.a();
    }
  }
  ...
  public boolean a(String paramString, Bundle paramBundle)
  {
    ...
    Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app;
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mContext;
    XEditTextEx localXEditTextEx = this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.input;
    int i;
    if ((!TextUtils.isEmpty(paramString)) && (paramBundle != null) && (bjmm.a((Context)localObject1)))
    {
      ...
      if (!TextUtils.isEmpty(paramString)) {
        acvv.a((QQAppInterface)localObject2, (Context)localObject1, this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.sessionInfo, paramString, i);
      }
    }
    label180:
    label194:
    do
    {
      do
      {
        ...
        if ("com.sogou.inputmethod.appid".equals(paramString))
        {
          ...
          paramString = bhwf.a(((QQAppInterface)localObject2).getApp(), str, (String)localObject3);
          if (QLog.isColorLevel()) {
          ...
          if (this.jdField_a_of_type_Arfd == null) {
            this.jdField_a_of_type_Arfd = new arfd(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie);
          }
          this.jdField_a_of_type_Arfd.a(paramString);
          return true;
        }
        if (("com.sogou.inputmethod.qqexp".equals(paramString)) || ("com.tencent.qqpinyin.qqexp".equals(paramString)))
        {
          ...
          this.jdField_a_of_type_Arfd.a(i, paramString);
          return true;
        }
      ...
      Object localObject3 = (QQRecorder.RecorderParam)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.input.a;
      ...
      if ((i == ((QQRecorder.RecorderParam)localObject3).a) && (!StringUtil.isEmpty(paramString))) {
        break label644;
      }
