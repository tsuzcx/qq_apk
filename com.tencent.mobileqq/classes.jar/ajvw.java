  ...
  extends ajtb
{
  ...
  public ajvw(NearbyAppInterface paramNearbyAppInterface)
  {
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    catch (Exception localException)
    {
      ...
      localbayr = (bayr)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(216);
    ...
    for (;;)
    {
      ...
      if ((i == 32) && (((MultiHeadUrl.RspHeadInfo)localObject2).faceType.get() != 0))
      {
        ...
        if (paramToServiceMsg != null)
        {
          label1095:
          i = 0;
          paramFromServiceMsg = localbayr.a("stranger_" + String.valueOf(localFaceInfo.b) + "_" + localFaceInfo.jdField_a_of_type_JavaLangString);
          if (localbayr.a(localFaceInfo)) {
            break label1353;
          }
          i = 1;
          if (i == 0) {
        ...
        {
          localbayr.a((FaceInfo)localArrayList.get(i));
          i += 1;
        }
        ...
        try
        {
          ...
          localbayr.a(paramToServiceMsg, System.currentTimeMillis());
          return;
        }
    ...
    for (;;)
    {
      ...
      if (!bool3)
      {
        ...
        if (!this.jdField_a_of_type_Boolean)
        {
          ...
          bbcy.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getApp().getApplicationContext(), true);
          return bool1;
          label212:
          bool1 = false;
        }
