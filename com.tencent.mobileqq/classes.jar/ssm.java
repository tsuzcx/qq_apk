  ...
  extends BaseAdapter
{
  ...
  private ssp jdField_a_of_type_Ssp;
  ...
  public void a(BaseAdapter paramBaseAdapter)
  {
    ...
    paramBaseAdapter.registerDataSetObserver(new ssn(this));
  }
  
  public void a(sso paramsso)
  {
    this.jdField_a_of_type_Sso = paramsso;
  }
  
  public void a(ssp paramssp)
  {
    this.jdField_a_of_type_Ssp = paramssp;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      if (i < j)
      {
        ...
        if (this.jdField_a_of_type_Ssp != null) {
          this.jdField_a_of_type_Ssp.a(paramInt, (View)localObject);
        }
      }
    }
    for (;;)
  ...
  public void notifyDataSetChanged()
  {
    ...
    if (this.jdField_a_of_type_Sso != null) {
      this.jdField_a_of_type_Sso.a();
    }
  }
}
