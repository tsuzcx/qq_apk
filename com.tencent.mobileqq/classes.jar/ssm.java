  ...
  implements sfp
{
  ...
  public ssm(int paramInt, String paramString)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_d_of_type_Boolean = true;
  ...
  public long a(String paramString)
  {
    try
    {
      ...
      if (arrayOfObject != null)
      {
        ...
        if (m < n)
        {
          ste localste = (ste)arrayOfObject[m];
          if (TextUtils.equals(paramString, localste.jdField_a_of_type_JavaLangString)) {
            return localste.jdField_b_of_type_Long;
          }
        }
      }
    }
    catch (Exception localException)
    {
      ...
      {
        int m;
        urk.c("Q.qqstory.msgTab.nodeList.MsgTabNodeInfo", "getRecommendIdByVid:%s", localException);
  ...
  public MsgTabNodeEntity a()
  {
    ...
    while (localIterator.hasNext()) {
      localJSONArray.put(((ste)localIterator.next()).a());
    }
    ...
    if (this.jdField_b_of_type_JavaUtilList != null)
    {
      ...
      while (localIterator.hasNext()) {
        localJSONArray.put(((tfv)localIterator.next()).a());
      }
  ...
  public void a(MsgTabNodeEntity paramMsgTabNodeEntity)
  {
    ...
    try
    {
      ...
      while (m < i1)
      {
        ...
        localObject = new ste();
        ((ste)localObject).a(localJSONObject);
        this.jdField_a_of_type_JavaUtilList.add(localObject);
        if (!((ste)localObject).jdField_a_of_type_Boolean) {
    ...
    {
      urk.c("Q.qqstory.msgTab.nodeList.MsgTabNodeInfo", "convertFrom(entity) errors", localJSONException1);
      ...
      if ((!TextUtils.isEmpty(paramMsgTabNodeEntity.localSuccessVideoList)) && (!paramMsgTabNodeEntity.localSuccessVideoList.equals("null"))) {
        try
        {
          ...
          while (m < i1)
          {
            ...
            localObject = new tfv();
            ((tfv)localObject).a(localJSONObject);
  ...
  public void a(qqstory_service.MsgTabNodeInfo paramMsgTabNodeInfo)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      ste localste = new ste();
      localste.a(localMsgTabNodeVideoInfo, localArrayDeque);
      this.jdField_a_of_type_JavaUtilList.add(localste);
    ...
    for (int m = 0;; m = 1)
    {
      ...
      if (paramMsgTabNodeInfo.redpoint.has())
      {
        ...
        urk.a("Q.qqstory.msgTab.nodeList.MsgTabNodeInfo", "MsgTabNodeInfo convertFrom, unionId:%s, uid:%s, redPoint:%s", this.jdField_a_of_type_JavaLangString, Long.valueOf(this.jdField_b_of_type_Long), Boolean.valueOf(this.jdField_c_of_type_Boolean));
      }
  ...
  {
    this.jdField_d_of_type_Int = paramssm.jdField_d_of_type_Int;
    this.jdField_b_of_type_Boolean = paramssm.jdField_b_of_type_Boolean;
    this.h = paramssm.h;
  }
  ...
  public boolean a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((TextUtils.isEmpty(localste.jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(localste.jdField_b_of_type_JavaLangString))) {
        return false;
      }
    }
  ...
  {
    if ((paramObject instanceof ssm))
    {
      paramObject = (ssm)paramObject;
