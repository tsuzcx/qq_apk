  ...
  extends ajfb
{
  ...
  public ajrm(QQAppInterface paramQQAppInterface)
  {
  ...
  private LoginInfo a()
  {
    try
    {
      ...
      localLoginInfo.sClientVer = babp.c();
  ...
  {
    paramToServiceMsg = (fv)this.app.getManager(42);
    ...
    for (;;)
    {
      try
      {
        ...
        {
          gh.jdField_a_of_type_Int = paramFromServiceMsg.i32_font_type.get();
          if (QLog.isColorLevel()) {
            QLog.d("VasShieldFont", 2, "handleGetFontShieldType type= " + gh.jdField_a_of_type_Int);
          }
          gh.b = this.app.c();
          gh.a(this.app);
        }
        ...
        try
        {
          ...
          while (localIterator.hasNext())
          {
            ...
            if ((!paramObject.diyFontConfigMap.containsKey(Integer.valueOf(i))) || (!paramToServiceMsg.equals(paramObject.diyFontConfigMap.get(Integer.valueOf(i)))))
            {
              ...
              ((fv)this.app.getManager(42)).b(str, i);
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    if ((paramFromServiceMsg.isSuccess()) && (paramObject != null))
    {
      ...
      {
        paramToServiceMsg.mergeFrom(paramFromServiceMsg.getWupBuffer());
        paramFromServiceMsg = (aqdf)this.app.getManager(219);
  ...
  public int a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 25	ajrm:d	I
    //   6: iconst_m1
    //   7: if_icmpne +53 -> 60
    //   10: aload_0
    //   11: getfield 51	ajrm:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   14: bipush 51
    //   16: invokevirtual 35	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   19: checkcast 264	ajjj
    //   22: aload_0
    //   23: getfield 51	ajrm:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   26: invokevirtual 517	com/tencent/mobileqq/app/QQAppInterface:getAccount	()Ljava/lang/String;
    //   29: invokevirtual 326	ajjj:a	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/ExtensionInfo;
    //   32: astore_2
    //   33: aload_2
    //   34: ifnonnull +9 -> 43
    //   37: iconst_0
    ...
    //   43: aload_0
    //   44: aload_2
    //   45: getfield 520	com/tencent/mobileqq/data/ExtensionInfo:uVipFont	J
    //   48: l2i
    //   49: putfield 25	ajrm:d	I
    //   52: aload_0
    //   53: aload_2
    //   54: getfield 523	com/tencent/mobileqq/data/ExtensionInfo:vipFontType	I
    //   57: putfield 27	ajrm:e	I
    //   60: aload_0
    //   61: getfield 25	ajrm:d	I
    //   64: istore_1
    //   65: goto -26 -> 39
    //   68: astore_2
    //   69: aload_0
  ...
  public void a()
  {
    ...
    localTFontSsoReq.str_mqqver.set("8.2.6.4370");
    Object localObject3 = new VipFontUpdate.TFontFreshReq();
    ((VipFontUpdate.TFontFreshReq)localObject3).i32_local_font_id.set(a());
    ((VipFontUpdate.TFontFreshReq)localObject3).i32_cpu_freq.set((int)babp.b());
    ((VipFontUpdate.TFontFreshReq)localObject3).i32_cpu_num.set(babp.b());
    ((VipFontUpdate.TFontFreshReq)localObject3).i32_total_mem.set((int)(babp.d() / 1048576L));
    ...
    ((VipFontUpdate.TFontFreshReq)localObject3).i32_os_type.set(bajo.a());
    ...
    gh.c = a();
    if (QLog.isColorLevel()) {
      QLog.d("VasShieldFont", 2, "pbGetUserFont: " + gh.c);
    }
    ...
    localObject3 = ((fv)this.app.getManager(42)).a(a(), this.e);
    Object localObject4;
    if (localObject3 != null)
    {
      localObject4 = new File(((fu)localObject3).a);
  ...
  public void a(int paramInt1, int paramInt2)
  {
    try
    {
      ...
      if ((paramInt1 != this.d) || (paramInt2 != this.e))
      {
        ...
        ExtensionInfo localExtensionInfo = localajjj.a(this.app.getAccount());
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    //   2: iload_1
    //   3: aload_0
    //   4: getfield 21	ajrm:b	I
    //   7: if_icmpeq +139 -> 146
    //   10: aload_0
    //   11: getfield 51	ajrm:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   14: ifnull +132 -> 146
    //   17: invokestatic 109	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   20: ifeq +29 -> 49
    //   23: ldc 95
    //   25: iconst_2
    ...
    //   39: iload_1
    //   40: invokevirtual 201	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    ...
    //   49: aload_0
    //   50: iload_1
    //   51: putfield 21	ajrm:b	I
    //   54: aload_0
    //   55: getfield 51	ajrm:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   58: invokevirtual 569	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   61: aload_0
    //   62: getfield 51	ajrm:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   65: invokevirtual 55	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   68: iconst_0
    //   69: invokevirtual 575	com/tencent/qphone/base/util/BaseApplication:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   72: invokeinterface 800 1 0
    //   77: ldc_w 911
    //   80: iload_1
    //   81: invokeinterface 807 3 0
    //   86: invokeinterface 810 1 0
    //   91: pop
    //   92: iload_1
    //   93: ifle +53 -> 146
    ...
    //   103: aload_0
    //   104: getfield 51	ajrm:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   107: invokevirtual 517	com/tencent/mobileqq/app/QQAppInterface:getAccount	()Ljava/lang/String;
    ...
    //   119: iload_1
    //   120: invokevirtual 201	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   123: invokevirtual 138	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   126: astore_3
    //   127: iload_2
    //   128: ifeq +26 -> 154
    //   131: new 915	com/tencent/mobileqq/app/SVIPHandler$1
    //   134: dup
    //   135: aload_0
    //   136: aload_3
    //   137: invokespecial 918	com/tencent/mobileqq/app/SVIPHandler$1:<init>	(Lajrm;Ljava/lang/String;)V
    //   140: iconst_5
    //   141: aconst_null
    //   142: iconst_0
    //   143: invokestatic 924	com/tencent/mobileqq/app/ThreadManager:post	(Ljava/lang/Runnable;ILcom/tencent/mobileqq/app/ThreadExcutor$IThreadListener;Z)V
    //   146: aload_0
    //   147: iconst_0
    //   148: putfield 812	ajrm:jdField_a_of_type_Boolean	Z
    //   151: aload_0
    //   152: monitorexit
    //   153: return
    //   154: invokestatic 929	almr:a	()Lalmr;
    //   157: aload_0
    //   158: getfield 51	ajrm:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   161: aload_3
    //   162: aconst_null
    //   163: invokevirtual 932	almr:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Lajfe;)V
    //   166: goto -20 -> 146
    //   169: astore_3
    //   170: aload_0
    //   171: monitorexit
  ...
  public void a(ajfe paramajfe, boolean paramBoolean)
  {
    paramajfe = createToServiceMsg("QCUniBusinessLogin.check", paramajfe, paramBoolean);
    UniLoginCheckReq localUniLoginCheckReq = new UniLoginCheckReq(a(), new ArrayList(), 2L, new GetUsrKeyWordInfoReq());
    paramajfe.extraData.putSerializable("req", localUniLoginCheckReq);
    this.app.sendToService(paramajfe);
  }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    label11:
    while (((mnf.a(paramMessageRecord)) && (mnf.b(paramMessageRecord))) || (paramMessageRecord.istroop == 1001) || (paramMessageRecord.istroop == 10002)) {
      return;
    }
    if (e() > 0)
    {
  ...
  public void a(ArrayList<Hamlet> paramArrayList, ajfe paramajfe, boolean paramBoolean)
  {
    paramajfe = createToServiceMsg("QCUniBusinessLogin.check", paramajfe, paramBoolean);
    paramArrayList = new UniLoginCheckReq(a(), paramArrayList, 3L, new GetUsrKeyWordInfoReq());
    paramajfe.extraData.putSerializable("req", paramArrayList);
    this.app.sendToService(paramajfe);
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    {
      almq localalmq = (almq)this.jdField_a_of_type_ComTencentMobileqqBubbleBubbleManager.a.get(Integer.valueOf(paramInt1));
      return (localalmq != null) && (localalmq.a()) && (localalmq.a(paramInt2));
    }
    return false;
  }
  ...
  public void b(int paramInt, boolean paramBoolean)
  {
    ...
    //   49: aload_0
    //   50: iload_1
    //   51: putfield 29	ajrm:f	I
    //   54: iload_1
    //   55: ifle +53 -> 108
    //   58: new 111	java/lang/StringBuilder
    //   61: dup
    //   62: invokespecial 112	java/lang/StringBuilder:<init>	()V
    //   65: aload_0
    //   66: getfield 51	ajrm:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   69: invokevirtual 517	com/tencent/mobileqq/app/QQAppInterface:getAccount	()Ljava/lang/String;
    ...
    //   81: iload_1
    //   82: invokevirtual 201	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   85: invokevirtual 138	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   88: astore_3
    //   89: iload_2
    //   90: ifeq +26 -> 116
    //   93: new 1145	com/tencent/mobileqq/app/SVIPHandler$2
    //   96: dup
    //   97: aload_0
    //   98: aload_3
    //   99: invokespecial 1146	com/tencent/mobileqq/app/SVIPHandler$2:<init>	(Lajrm;Ljava/lang/String;)V
    //   102: iconst_5
    //   103: aconst_null
    //   104: iconst_0
    //   105: invokestatic 924	com/tencent/mobileqq/app/ThreadManager:post	(Ljava/lang/Runnable;ILcom/tencent/mobileqq/app/ThreadExcutor$IThreadListener;Z)V
    //   108: aload_0
    //   109: iconst_0
    //   110: putfield 812	ajrm:jdField_a_of_type_Boolean	Z
    //   113: aload_0
    //   114: monitorexit
    //   115: return
    //   116: invokestatic 1151	aieg:a	()Laieg;
    //   119: aload_0
    //   120: getfield 51	ajrm:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   123: aload_3
    //   124: aconst_null
    //   125: invokevirtual 1154	aieg:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Lajfe;)Lcom/tencent/mobileqq/addon/DiyPendantEntity;
    //   128: pop
    //   129: goto -21 -> 108
    //   132: astore_3
    //   133: aload_0
  ...
  public int c()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqBubbleBubbleManager != null) && (this.jdField_a_of_type_ComTencentMobileqqBubbleBubbleManager.a != null))
    {
      almq localalmq = (almq)this.jdField_a_of_type_ComTencentMobileqqBubbleBubbleManager.a.get(Integer.valueOf(b()));
      if ((localalmq != null) && (localalmq.a()))
      {
        int i = localalmq.a();
        if (QLog.isColorLevel()) {
  ...
  public void c(int paramInt)
  {
    try
    {
      ...
      ajjj localajjj = (ajjj)this.app.getManager(51);
      ExtensionInfo localExtensionInfo2 = localajjj.a(this.app.getAccount());
  ...
  public ToServiceMsg createToServiceMsg(String paramString, ajfe paramajfe, boolean paramBoolean)
  {
    return super.createToServiceMsg(paramString, paramajfe, paramBoolean);
  }
  ...
  public int d()
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: invokestatic 1187	com/tencent/mobileqq/app/DeviceProfileManager:a	()Lcom/tencent/mobileqq/app/DeviceProfileManager;
    //   5: getstatic 1193	com/tencent/mobileqq/app/DeviceProfileManager$DpcNames:MsgLengthByBubble	Lcom/tencent/mobileqq/app/DeviceProfileManager$DpcNames;
    //   8: invokevirtual 1196	com/tencent/mobileqq/app/DeviceProfileManager$DpcNames:name	()Ljava/lang/String;
    //   11: ldc_w 1198
    //   14: invokevirtual 1200	com/tencent/mobileqq/app/DeviceProfileManager:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   17: astore_3
    //   18: iconst_0
    //   19: istore_2
    //   20: aload_3
    //   21: invokestatic 565	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   24: istore_1
    //   25: aload_0
    //   26: monitorexit
    //   27: iload_1
    ...
    //   30: iload_2
    //   31: istore_1
    //   32: invokestatic 109	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   35: ifeq -10 -> 25
    //   38: ldc 95
    //   40: iconst_2
    //   41: aload_3
    //   42: invokevirtual 1201	java/lang/NumberFormatException:getMessage	()Ljava/lang/String;
    //   45: invokestatic 247	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   48: iload_2
    //   49: istore_1
    //   50: goto -25 -> 25
    //   53: astore_3
  ...
  public void e(int paramInt)
  {
    ...
    readItemInfoReq localreadItemInfoReq = new readItemInfoReq(109L, babp.c(), paramInt);
  ...
  public void f(int paramInt)
  {
    ...
    readUserInfoReq localreadUserInfoReq = new readUserInfoReq(babp.c(), 109, paramInt);
  ...
  public void g(int paramInt)
  {
    ...
    setUserProfileReq localsetUserProfileReq = new setUserProfileReq(paramInt, babp.c(), 109);
  ...
  public void h(int paramInt)
  {
    ...
    setUserFlagReq localsetUserFlagReq = new setUserFlagReq(paramInt, babp.c(), 109);
