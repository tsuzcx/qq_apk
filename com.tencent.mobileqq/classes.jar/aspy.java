...
public class aspy
{
  ...
  private aspx jdField_a_of_type_Aspx;
  private asqb jdField_a_of_type_Asqb;
  private asqc jdField_a_of_type_Asqc;
  private ArrayList<View> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private List<aggw> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public aspy(aspx paramaspx)
  {
    this.jdField_a_of_type_Aspx = paramaspx;
  }
  
  public static aspy a(AppInterface paramAppInterface)
  {
    if (QLog.isColorLevel()) {
      QLog.d("MultiAioContext", 2, "create() called with: app = [" + paramAppInterface + "]");
    }
    paramAppInterface = (aspx)paramAppInterface.getManager(325);
    aspy localaspy = new aspy(paramAppInterface);
    localaspy.c(paramAppInterface.a(localaspy));
    return localaspy;
  }
  ...
  public aggw a(MultiAIOItemFragment paramMultiAIOItemFragment)
  {
    ...
    if (i >= 0)
    {
      ...
      if (i < this.jdField_a_of_type_JavaUtilList.size()) {
        localObject1 = (aggw)this.jdField_a_of_type_JavaUtilList.get(i);
      }
    }
    localObject2 = localObject1;
    if (localObject1 == null)
    {
      localObject2 = aghd.a(paramMultiAIOItemFragment.getActivity(), paramMultiAIOItemFragment.a(), paramMultiAIOItemFragment.getActivity().app);
      a(i, (aggw)localObject2);
    }
    return localObject2;
  }
  ...
  public asqc a()
  {
    return this.jdField_a_of_type_Asqc;
  }
  ...
  public List<RecentBaseData> a(QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    if (localList2 == null)
    {
      localList1 = aspm.a(paramFragmentActivity, paramQQAppInterface, paramString1, paramInt, paramString2, paramString3);
      a(localList1);
    }
    return localList1;
  }
  ...
  public void a(int paramInt, aggw paramaggw)
  {
    while (this.jdField_a_of_type_JavaUtilList.size() <= paramInt) {
      this.jdField_a_of_type_JavaUtilList.add(null);
    }
    if (QLog.isColorLevel()) {
      QLog.d("MultiAioContext", 2, "setMiniPie() called with: position = [" + paramInt + "], miniPie = [" + paramaggw + "]");
    }
    this.jdField_a_of_type_JavaUtilList.set(paramInt, paramaggw);
  }
  
  public void a(Intent paramIntent)
  {
    if (this.jdField_a_of_type_Asqb != null) {
      this.jdField_a_of_type_Asqb.a(paramIntent);
    }
  }
  ...
  {
    this.jdField_a_of_type_Asqb = paramasqb;
  }
  
  public void a(asqc paramasqc)
  {
    this.jdField_a_of_type_Asqc = paramasqc;
  }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Asqc != null) {
      this.jdField_a_of_type_Asqc.a();
    }
  }
