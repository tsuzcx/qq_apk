  ...
  implements ujj
{
  ...
  public static int a(Context paramContext)
  {
    ...
    upe.b("wifiInfo", paramContext.toString());
    upe.b("SSID", "" + paramContext.getIpAddress());
  ...
  public static stReportItem a()
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject))
    {
      ...
      localstReportItem.qua = blru.a();
      localstReportItem.vendor = bgln.h();
      localObject = new stDevice();
      ((stDevice)localObject).encrypted_deviceid = ugb.a().e();
  ...
  public static stReportItem a(stSimpleMetaFeed paramstSimpleMetaFeed, int paramInt)
  {
    ...
    {
      upe.d("weishi-report", "convertFeedToReport feed == null");
      return localstReportItem;
    }
  ...
  private static String a()
  {
    ...
    if ((c.endsWith(anni.a(2131714645))) && (c.length() > 1)) {
  ...
  private static String a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      default: 
        return str;
        str = anni.a(2131714641);
        continue;
        str = anni.a(2131714618);
        continue;
        str = anni.a(2131714628);
        continue;
        str = anni.a(2131714635);
        continue;
        str = anni.a(2131714625);
        continue;
        str = anni.a(2131714629);
        continue;
        str = anni.a(2131714644);
        continue;
        str = anni.a(2131714612);
        continue;
        str = anni.a(2131714615);
        continue;
        str = anni.a(2131714620);
        continue;
        str = anni.a(2131714642);
        continue;
        str = anni.a(2131714637);
        continue;
        str = anni.a(2131714631);
        switch (paramInt2)
        {
        default: 
          break;
        case 12: 
          str = anni.a(2131714607);
          continue;
          str = anni.a(2131714639);
          continue;
          str = anni.a(2131714646);
          continue;
          str = anni.a(2131714619);
          continue;
          str = anni.a(2131714640);
          continue;
          str = anni.a(2131714614);
          continue;
          str = anni.a(2131714610);
          continue;
          str = anni.a(2131714630);
          continue;
          str = anni.a(2131714608);
          continue;
          str = anni.a(2131714634);
          switch (paramInt2)
          {
          default: 
            break;
          case 12: 
            str = anni.a(2131714622);
            continue;
            str = anni.a(2131714616);
            switch (paramInt2)
            {
            default: 
              break;
            case 12: 
              str = anni.a(2131714624);
              continue;
              str = anni.a(2131714611);
              continue;
              str = anni.a(2131714621);
              continue;
              str = anni.a(2131714626);
              switch (paramInt2)
              {
              default: 
                break;
              case 2: 
                str = anni.a(2131714643);
                break;
              case 6: 
                str = anni.a(2131714632);
                continue;
                str = anni.a(2131714633);
                switch (paramInt2)
                {
                default: 
                  break;
                case 2: 
                  str = anni.a(2131714636);
                  break;
                case 14: 
                  str = anni.a(2131714613);
                  break;
                case 12: 
                  str = anni.a(2131714609);
                  break;
                case 6: 
                  str = anni.a(2131714617);
                  continue;
                  str = anni.a(2131714623);
                  switch (paramInt2)
                  {
                  case 10: 
                  case 11: 
  ...
  public static String a(Context paramContext)
  {
    ...
    try
    {
      jdField_a_of_type_JavaLangString = bkfy.a("1d76c6");
    ...
    catch (Throwable paramContext)
    {
      for (;;)
      {
        upe.d("weishi-810", "telephonyManager.getDeviceId encounter error:" + paramContext);
      }
    }
  }
  ...
  public static void a(stReportItem paramstReportItem)
  {
    if (paramstReportItem == null)
    {
      upe.d("weishi-report", "report error item = null");
      return;
    }
  ...
  public static void a(ArrayList<stReportItem> paramArrayList)
  {
    ...
    {
      upe.d("weishi-report", "report error items: " + paramArrayList);
      return;
    }
    ...
    while (localIterator.hasNext())
    {
      ...
      upe.b("weishi-report", "report " + str + " stReportItem:" + localstReportItem.toString());
    }
    paramArrayList = new uju(new unz(paramArrayList), null, new umr(str), 2001);
    ujn.a().a(paramArrayList);
  }
  ...
  public static String b(Context paramContext)
  {
    ...
    try
    {
      upe.b("weishi-810", "try get QIMei from UserAction.getQIMEI!");
      b = UserAction.getQIMEI();
      if (b == null)
      {
        upe.d("weishi-810", "getImei finally encounter error and return empty");
        b = "";
      }
      return b;
    }
    catch (Throwable paramContext)
    {
      for (;;)
      {
        upe.d("weishi-810", "UserAction.getQIMEI encounter error:" + paramContext);
      }
    }
  }
