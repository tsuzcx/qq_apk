  ...
  extends bcdd
{
  ...
  private static ConcurrentHashMap<String, SoftReference<ArrayList<bcdg>>> c = new ConcurrentHashMap();
  private anzf jdField_a_of_type_Anzf = new bcdo(this);
  private apaw jdField_a_of_type_Apaw;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  private String jdField_a_of_type_JavaLangString;
  private Comparator<FTSEntity> jdField_a_of_type_JavaUtilComparator = new bcdm(this);
  ...
  public bcdk(QQAppInterface paramQQAppInterface)
  {
  ...
  private int a(String paramString, int paramInt)
  {
    if (this.jdField_a_of_type_Apaw == null) {
      this.jdField_a_of_type_Apaw = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
    }
    int i = 0;
    if (!this.jdField_a_of_type_Apaw.isRecentUserInCache(paramString, paramInt)) {
      i = 10;
    }
    if (paramInt == 3000) {
      return i + 2;
  ...
  private ArrayList<bcdp> a(ArrayList<FTSEntity> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if ((localFTSMessage != null) && (localFTSMessage.msgExts != null))
      {
        ...
        String str = adak.a((String)localObject2, i);
        if (!((HashMap)localObject1).containsKey(str))
        {
          bcdp localbcdp = new bcdp();
          localbcdp.jdField_a_of_type_JavaUtilList = new ArrayList();
          localbcdp.jdField_a_of_type_JavaUtilList.add(localFTSMessage);
          localbcdp.jdField_a_of_type_Int = localFTSMessage.mSearchScene;
          localbcdp.b = localFTSMessage.mProximity;
          localbcdp.c = a((String)localObject2, i);
          localbcdp.jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)localFTSMessage.msgExts).time;
          localbcdp.jdField_a_of_type_JavaUtilHashSet = new HashSet();
          localbcdp.jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(localFTSMessage.mOId));
          localbcdp.d = localFTSMessage.searchStrategy;
          localbcdp.e = localFTSMessage.senderNum;
          localbcdp.f = localFTSMessage.friendNum;
          localbcdp.g = localFTSMessage.friendIndex;
          ((HashMap)localObject1).put(str, localbcdp);
        }
        else
        {
          localObject2 = (bcdp)((HashMap)localObject1).get(str);
          if (((bcdp)localObject2).jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(localFTSMessage.mOId)))
          {
            if (localFTSMessage.mSearchScene == ((bcdp)localObject2).jdField_a_of_type_Int)
            {
              if (localFTSMessage.mProximity < ((bcdp)localObject2).b) {
                ((bcdp)localObject2).b = localFTSMessage.mProximity;
              }
              if (((FTSMessageCodec.TextMsgExts)localFTSMessage.msgExts).time > ((bcdp)localObject2).jdField_a_of_type_Long) {
                ((bcdp)localObject2).jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)localFTSMessage.msgExts).time;
              }
              if (localFTSMessage.senderNum > ((bcdp)localObject2).e) {
                ((bcdp)localObject2).e = localFTSMessage.senderNum;
              }
              if (localFTSMessage.friendNum > ((bcdp)localObject2).f) {
                ((bcdp)localObject2).f = localFTSMessage.friendNum;
              }
              if (localFTSMessage.friendIndex > ((bcdp)localObject2).g) {
                ((bcdp)localObject2).g = localFTSMessage.friendIndex;
              }
            }
            for (;;)
            {
              if (localFTSMessage.mSearchScene < ((bcdp)localObject2).jdField_a_of_type_Int) {
                ((bcdp)localObject2).jdField_a_of_type_Int = localFTSMessage.mSearchScene;
              }
              if (localFTSMessage.searchStrategy < ((bcdp)localObject2).d) {
                ((bcdp)localObject2).d = localFTSMessage.searchStrategy;
              }
              ((bcdp)localObject2).jdField_a_of_type_JavaUtilList.add(localFTSMessage);
              break;
              if (localFTSMessage.mSearchScene < ((bcdp)localObject2).jdField_a_of_type_Int)
              {
                ((bcdp)localObject2).b = localFTSMessage.mProximity;
    ...
    Collections.sort(paramArrayList, new bcdn(this));
    return paramArrayList;
  }
  
  private List<bcdg> a(String paramString1, String paramString2, String paramString3, boolean paramBoolean1, ArrayList<FTSEntity> paramArrayList, boolean paramBoolean2)
  {
    Object localObject1 = new HashMap();
    paramArrayList = paramArrayList.iterator();
    int i = 0;
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if ((localObject2 != null) && (((FTSMessage)localObject2).msgExts != null))
      {
        ...
        localObject4 = adak.a((String)localObject3, j);
        if (!((HashMap)localObject1).containsKey(localObject4))
        {
          localObject5 = new bcdp();
          ((bcdp)localObject5).jdField_a_of_type_JavaUtilList = new ArrayList();
          ((bcdp)localObject5).jdField_a_of_type_JavaUtilList.add(localObject2);
          ((bcdp)localObject5).b = ((FTSMessage)localObject2).mProximity;
          ((bcdp)localObject5).c = a((String)localObject3, j);
          ((bcdp)localObject5).jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject2).msgExts).time;
          ((bcdp)localObject5).jdField_a_of_type_JavaUtilHashSet = new HashSet();
          ((bcdp)localObject5).jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(((FTSMessage)localObject2).mOId));
          ((bcdp)localObject5).d = ((FTSMessage)localObject2).searchStrategy;
          ((HashMap)localObject1).put(localObject4, localObject5);
        }
        else
        {
          localObject3 = (bcdp)((HashMap)localObject1).get(localObject4);
          if (!((bcdp)localObject3).jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(((FTSMessage)localObject2).mOId)))
          {
            i = 1;
          }
          else
          {
            if (((FTSMessage)localObject2).mProximity < ((bcdp)localObject3).b) {
              ((bcdp)localObject3).b = ((FTSMessage)localObject2).mProximity;
            }
            if (((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject2).msgExts).time > ((bcdp)localObject3).jdField_a_of_type_Long) {
              ((bcdp)localObject3).jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject2).msgExts).time;
            }
            if (((FTSMessage)localObject2).searchStrategy < ((bcdp)localObject3).d) {
              ((bcdp)localObject3).d = ((FTSMessage)localObject2).searchStrategy;
            }
            ((bcdp)localObject3).jdField_a_of_type_JavaUtilList.add(localObject2);
          }
        }
      }
    }
    ...
    Collections.sort(paramArrayList, new bcdl(this));
    localObject1 = bhut.a(paramString2);
    ...
    if (paramArrayList != null)
    {
      ...
      {
        localObject4 = (bcdp)((Iterator)localObject3).next();
        if (a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(((FTSMessage)((bcdp)localObject4).jdField_a_of_type_JavaUtilList.get(0)).uin), ((FTSMessage)((bcdp)localObject4).jdField_a_of_type_JavaUtilList.get(0)).istroop))
        {
          ...
          {
            paramArrayList = new bcdr((QQAppInterface)localObject5, paramArrayList, paramString2, (ArrayList)localObject1, ((bcdp)localObject4).jdField_a_of_type_JavaUtilList, paramString3, null);
            paramArrayList.jdField_a_of_type_Int = ((bcdp)localObject4).d;
            paramArrayList.b = ((bcdp)localObject4).e;
            paramArrayList.c = ((bcdp)localObject4).f;
            paramArrayList.d = ((bcdp)localObject4).g;
            ((List)localObject2).add(paramArrayList);
            i = bbzo.a("fts_native_chathistory_maxnum", 3);
  ...
  private List<bcdf> a(String paramString, ArrayList<FTSEntity> paramArrayList)
  {
    ArrayList localArrayList = bhut.a(paramString);
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      paramArrayList.add(new bcdq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, localArrayList, (FTSEntity)localObject2));
    }
    return paramArrayList;
  }
  ...
  private static boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    {
      paramQQAppInterface = ((anws)paramQQAppInterface.getManager(53)).a(paramString);
  ...
  public List<bcdg> a(bcmq parambcmq)
  {
    if (parambcmq == null) {
      return null;
    }
    ...
    for (boolean bool = parambcmq.jdField_a_of_type_AndroidOsBundle.getBoolean("fts_search_is_limited", true);; bool = true)
    {
      if (bhut.g(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == 1) {
        return b(parambcmq, bool);
      }
      return a(parambcmq, bool);
    }
  }
  
  public List<bcdg> a(bcmq arg1, boolean paramBoolean)
  {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          if (localObject1 != null)
          {
            ...
            bdmc.a(BaseApplication.getContext()).a(null, "SearchMessageStatistic_FTS", true, (l7 - l5) / 1000000L, 0L, (HashMap)localObject5, null);
            l8 = System.nanoTime();
            if (QLog.isColorLevel()) {
              if (??? == null) {
                break label1500;
          ...
          for (int i1 = ???.size();; i1 = 0)
          {
            ...
            if (n == 0)
            {
              ...
              bdmc.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l1, 0L, ???, null);
            }
            ??? = (bcmq)localObject1;
            if (n == 0) {
              if (localObject1 != null)
            ...
            bdmc.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l2, 0L, (HashMap)localObject5, null);
            return localObject4;
  ...
  public List<bcdg> a(String paramString, boolean paramBoolean)
  {
    if (!bhnv.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
      return null;
    }
    ??? = (anze)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(81);
    Object localObject2 = new ArrayList();
    ((ArrayList)localObject2).add(paramString);
    ((anze)???).a((ArrayList)localObject2);
    ...
    bdmc.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l2, 0L, (HashMap)localObject2, null);
    return paramString;
    label654:
    ...
    if (localArrayList == null)
    {
      ...
      bdmc.a(BaseApplication.getContext()).a(null, "SearchMessageStatistic_FTS", true, (l3 - l6) / 1000000L, 0L, paramString, null);
      l4 = System.nanoTime();
      if (QLog.isColorLevel()) {
        if (localArrayList == null) {
          break label1267;
    ...
    for (int n = localArrayList.size();; n = 0)
    {
      ...
      ((HashMap)localObject2).put("groupSortCost", String.valueOf(l1));
      bdmc.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l2, 0L, paramString, null);
      return ???;
  ...
  public void a(bcmq parambcmq, bcmd<bcdg> parambcmd)
  {
    bhuu.e = System.nanoTime();
    bhuu.f = 0L;
    ThreadManager.post(new FTSMessageSearchEngine.1(this, parambcmq, parambcmd), 8, null, true);
  }
  ...
  public List<bcdf> b(bcmq parambcmq)
  {
    if (QLog.isColorLevel()) {
      QLog.d("FTSMessageSearchEngine", 2, "========== search message use FTSMessageSearchEngine");
    }
    ...
    Object localObject = parambcmq.jdField_a_of_type_JavaLangString;
    if (parambcmq.jdField_a_of_type_AndroidOsBundle == null) {
      return new ArrayList();
    }
    long l3 = parambcmq.jdField_a_of_type_AndroidOsBundle.getLong("uin");
    int i = parambcmq.jdField_a_of_type_AndroidOsBundle.getInt("uinType");
    parambcmq = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a((String)localObject, FTSMessage.class, false, false, l3, i);
    l3 = System.nanoTime();
    localObject = a((String)localObject, parambcmq);
    long l4 = System.nanoTime();
    if (parambcmq != null) {}
    for (i = parambcmq.size();; i = 0)
    {
  ...
  public List<bcdg> b(bcmq arg1, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
      QLog.d("FTSMessageSearchEngine", 2, "========== search message use FTSMessageSearchEngine");
    }
    ...
    Object localObject4 = bhut.a(str);
    ...
    for (int i2 = 0;; i2 = 1)
    {
      ...
      bdmc.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, 0L, 0L, localHashMap, null);
      return localObject3;
      i1 = ???.size();
      break label362;
    }
    ...
    long l1 = System.nanoTime();
    localObject4 = bhut.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject4);
    ...
    if ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
    {
      ...
      while (((Iterator)localObject5).hasNext())
      {
        localObject6 = (bhuv)((Iterator)localObject5).next();
        if ((((bhuv)localObject6).jdField_a_of_type_Int != 0) && (((bhuv)localObject6).jdField_a_of_type_Int != 1004)) {
          break label2300;
        }
        j += 1;
      }
    ...
    for (;;)
    {
      ...
      if ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
      {
        ...
        {
          localObject5 = ((bhuv)((ArrayList)localObject4).get(i5)).jdField_a_of_type_JavaLangString;
          int i9 = ((bhuv)((ArrayList)localObject4).get(i5)).jdField_a_of_type_Int;
          localObject6 = ((bhuv)((ArrayList)localObject4).get(i5)).jdField_a_of_type_AndroidUtilPair;
          int i6 = m;
          ...
          {
            i = k;
            if (bhut.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == 1)
            {
      ...
      for (m = i;; m = i)
      {
        ...
        for (;;)
        {
          ...
          l3 += l4;
          localObject3 = bhut.a(localHashMap);
          localObject5 = ((ArrayList)localObject5).iterator();
          while (((Iterator)localObject5).hasNext())
          {
            localObject6 = (bcdp)((Iterator)localObject5).next();
            localObject7 = (FTSMessage)((bcdp)localObject6).jdField_a_of_type_JavaUtilList.get(0);
            ...
            {
              localObject7 = new bcdr(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localHashMap, localHashMap, (ArrayList)localObject3, ((bcdp)localObject6).jdField_a_of_type_JavaUtilList, null, null);
              ((bcdr)localObject7).jdField_a_of_type_Int = ((bcdp)localObject6).d;
              ((bcdr)localObject7).b = ((bcdp)localObject6).e;
              ((bcdr)localObject7).c = ((bcdp)localObject6).f;
              ((bcdr)localObject7).d = ((bcdp)localObject6).g;
          ...
          bdmc.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l3, 0L, ???, null);
  ...
  public void b(bcmq parambcmq, bcmd<bcdf> parambcmd)
  {
    ThreadManager.post(new FTSMessageSearchEngine.2(this, parambcmq, parambcmd), 8, null, true);
  }
  
  public void f()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Anzf);
  }
  
  public void g()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Anzf);
  }
}
