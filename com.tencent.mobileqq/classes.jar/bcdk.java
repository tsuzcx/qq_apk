  ...
  extends ProxyWebViewClientExtension
{
  ...
  public bcdk(bcdg parambcdg, TouchWebView paramTouchWebView, bccj parambccj)
  {
  ...
  public void onFakeLoginRecognised(Bundle paramBundle)
  {
    ...
    paramBundle = "";
    String str1 = "";
    if (this.jdField_a_of_type_Bcdg.jdField_a_of_type_ComTencentBizUiTouchWebView != null)
    {
      paramBundle = this.jdField_a_of_type_Bcdg.jdField_a_of_type_ComTencentBizUiTouchWebView.getOriginalUrl();
      str1 = this.jdField_a_of_type_Bcdg.jdField_a_of_type_ComTencentBizUiTouchWebView.getUrl();
      bcfa.a(paramBundle, str1, localStringBuilder.toString(), str2, bool2, bool3, bool1);
    }
    String str3;
    if (((localObject != null) && (((ArrayList)localObject).size() > 0)) || (bool1) || (!TextUtils.isEmpty(str2)))
    {
      str3 = this.jdField_a_of_type_Bcdg.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin();
      if (this.jdField_a_of_type_Bcdg.jdField_a_of_type_ComTencentBizUiTouchWebView == null) {
        break label321;
      }
    }
    label321:
    for (Object localObject = this.jdField_a_of_type_Bcdg.jdField_a_of_type_ComTencentBizUiTouchWebView.getTitle();; localObject = "")
    {
      bcfa.a(paramBundle, str1, (String)localObject, str3);
