...
public class bbey
  implements bdvw
{
  public bbey(ScribbleResMgr.4 param4) {}
  
  public void onResp(bdwt parambdwt)
  {
    int j = 2;
    if (QLog.isColorLevel()) {
      QLog.i("ScribbleResMgr", 2, "onResp  mResult: " + parambdwt.jdField_a_of_type_Int + " url:" + this.a.a.sourceUrl);
    }
    int i = j;
    Object localObject;
    String str1;
    ...
    for (i = 0;; i = 1)
    {
      ...
      {
        j = i;
        localObject = (beaw)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(193);
        i = j;
        if (((beaw)localObject).a())
        {
          ((beaw)localObject).a(this.a.a.sourceUrl, parambdwt.jdField_a_of_type_Long);
          i = j;
        }
