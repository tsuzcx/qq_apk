...
public class bfis
{
  ...
  {
    bfhg.c("AppUpdate", "httpRequest >>> " + paramString1.toString());
    try
    {
    ...
    catch (JSONException paramContext)
    {
      ...
      for (;;)
      {
        bfhg.c("AppUpdate", "httpRequest JSONException", paramContext);
        return;
        i = 0;
        continue;
        paramString1 = "0";
      ...
      bfhg.c("AppUpdate", "use supportEtag");
      if (paramBoolean) {
        break label548;
      }
      ...
      bfhg.c("AppUpdate", "execute asyncTask url >>> " + str2 + " methodName " + str3);
      a(new bfib(str2, str3, new bfit(paramContext, paramWebView, str1, str4, str5, paramBoolean)), localBundle);
      return;
    }
    catch (Exception paramContext)
    {
      bfhg.c("AppUpdate", "httpRequest Exception", paramContext);
    }
    localBundle = new Bundle();
    localBundle.putString("platform", bexd.a().g());
    localBundle.putString("keystr", bexd.a().a());
    localBundle.putString("uin", paramString2);
    localBundle.putString("resolution", bfin.e());
    localBundle.putString("keytype", "256");
    if (bfij.a(paramContext))
    {
      paramString1 = "1";
      ...
      while (paramString2.hasNext())
      {
        ...
        bfhg.c("AppUpdate", "key = " + (String)localObject1 + " value = " + localObject2.toString());
  ...
  @TargetApi(11)
  protected static void a(bfib parambfib, Bundle paramBundle)
  {
