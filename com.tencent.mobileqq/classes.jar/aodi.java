...
public class aodi
{
  ...
  public static FullMessageSearchResult.SearchResultItem a(QQAppInterface paramQQAppInterface, EntityManager paramEntityManager, Cursor paramCursor, String paramString1, int paramInt, String paramString2, aodg paramaodg)
  {
    ...
    do
    {
      ...
      {
        if ((paramaodg.c == 3) || (paramaodg.c == 2)) {
          return null;
        }
        paramInt = 0;
  ...
  private static String a(byte[] paramArrayOfByte)
  {
    ...
    if (paramArrayOfByte != null)
    {
      ...
      {
        AbsStructMsg localAbsStructMsg = bcwd.a(paramArrayOfByte);
        localObject = str;
