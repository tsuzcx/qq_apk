...
public class bdow
{
  public static bdqc a(bdqc parambdqc)
  {
    for (parambdqc = parambdqc.a(); (parambdqc != null) && (parambdqc.jdField_a_of_type_Int != 1); parambdqc = parambdqc.a()) {}
    return parambdqc;
  }
  ...
  public static AbsStructMsg a()
  {
    ...
    localStructMsgForGeneralShare.mMsgBrief = anzj.a(2131713400);
    ...
    bdov.a(0).a(new StructMsgItemTitle(""));
  ...
  public static AbsStructMsg a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong, byte[] paramArrayOfByte, int paramInt2)
  {
    ...
    if ((paramArrayOfByte != null) && ((paramArrayOfByte instanceof AbsShareMsg)))
    {
      ...
      if ((l1 == 23L) && ((paramInt1 == 82) || (paramInt1 == 43))) {
        bdll.b(paramQQAppInterface, "P_CliOper", "Grp_AIO", paramQQAppInterface.getCurrentAccountUin(), "AIOchat", "appear_obj", 0, 0, String.valueOf(paramLong), String.valueOf(l1), String.valueOf(l2), "");
      }
      if (l1 == 52L)
      {
        paramQQAppInterface = new StringBuilder("rec flower msg,");
        paramQQAppInterface.append(bdqx.a(paramArrayOfByte));
  ...
  public static AbsStructMsg a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    //   93: astore_3
    //   94: aload_3
    //   95: invokestatic 250	bdow:a	(Ljava/lang/String;)Z
    //   98: istore_2
    //   99: aload_3
    //   100: aload_0
    //   101: iload_2
    //   102: invokestatic 255	begd:a	(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    //   105: invokestatic 258	bdow:a	(Ljava/lang/String;)Ljava/lang/String;
    //   108: astore_3
    ...
    //   153: new 270	bdqd
    //   156: dup
    //   157: invokespecial 271	bdqd:<init>	()V
    //   160: astore 4
    //   162: aload 4
    //   164: aload_0
    //   165: invokevirtual 273	bdqd:a	(Ljava/lang/String;)V
    //   168: aload 4
    //   170: iload_2
    //   171: invokevirtual 276	bdqd:a	(Z)V
    ...
    //   192: aload 4
    //   194: invokevirtual 297	bdqd:a	()Lcom/tencent/mobileqq/structmsg/AbsStructMsg;
    //   197: astore_3
    //   198: aload_3
    //   199: astore_0
    //   200: aload_3
  ...
  public static String a(bdqc parambdqc)
  {
    if (parambdqc.jdField_a_of_type_Int == 3) {}
    Object localObject;
    for (parambdqc = parambdqc.jdField_a_of_type_JavaLangString;; parambdqc = ((StringBuilder)localObject).toString())
    {
      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          if (localbdqc.jdField_a_of_type_Int == 3) {
            ((StringBuilder)localObject).append(localbdqc.jdField_a_of_type_JavaLangString);
          }
        }
      }
    }
  ...
  public static final String a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject = agej.a().append(paramString);
        i = 0;
        k = 0;
