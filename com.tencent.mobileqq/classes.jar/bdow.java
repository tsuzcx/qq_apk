  ...
  implements View.OnClickListener
{
  ...
  {
    Object localObject3 = paramView.findViewById(2131378157);
    ...
    for (;;)
    {
      ...
      return;
      Object localObject1 = ((View)localObject3).getTag(2131378157);
      if ((localObject1 instanceof StructMsgForImageShare))
      {
        ...
        try
        {
          ...
          {
            bdla.b((QQAppInterface)localObject1, "P_CliOper", "Pb_account_lifeservice", localStructMsgForImageShare.uin, "mp_msg_msgpic_click", "aio_morpic_click", 0, 0, "", "", Long.toString(localStructMsgForImageShare.msgId), "");
          ...
          {
            bdla.b(null, "dc00898", "", "", "0X800A428", "0X800A428", 0, 0, "", ForwardUtils.toTypeSimple(localStructMsgForImageShare.uinType), Long.toString(localStructMsgForImageShare.mSourceAppid), localStructMsgForImageShare.getTitleFromBrief());
            if (QLog.isColorLevel()) {
              QLog.d("StructMsg", 2, new Object[] { "大图点击=0X800A428, appid=" + localStructMsgForImageShare.mSourceAppid + ", fileType=4, briefTitle=", localStructMsgForImageShare.getTitleFromBrief() });
            }
          }
          bdla.b(null, "CliOper", "", "", "0X800567A", "0X800567A", 0, 0, localStructMsgForImageShare.mMsgServiceID + "", "", "", "");
          ...
          if ((!bhfj.b(localStructMsgForImageShare.mIsSend)) && (((bdqa)localObject4).a != null))
          {
            localObject1 = ahcj.a(localContext, ((bdqa)localObject4).a);
        ...
        catch (AccountNotMatchException localAccountNotMatchException)
        {
          ...
          else
          {
            ...
            localIntent.putExtra("image_share_by_server", ((bdqa)localObject4).a());
            localIntent.putExtra("urlAtServer", ((bdqa)localObject4).ad);
            localIntent.putExtra("KEY_FILE_ID", ((bdqa)localObject4).c);
            localIntent.putExtra("picMD5", ((bdqa)localObject4).ae);
            localIntent.putExtra("url", ((bdqa)localObject4).ac);
            ...
            localIntent.putExtra("IS_FROMOTHER_TERMINAL_KEY", bhfj.c(localStructMsgForImageShare.mIsSend));
    ...
    localIntent.putExtra("fileSize", ((bdqa)localObject4).d);
    localIntent.putExtra("KEY_TIME", ((bdqa)localObject4).e);
    ...
    localIntent.putExtra("KEY_THUMBNAL_BOUND", aavz.a((View)localObject3));
    localIntent.putExtra("title", localStructMsgForImageShare.getTitleFromBrief());
    Object localObject4 = ((bdqa)localObject4).a;
    if (localObject4 != null)
    {
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        if ((!bhfj.b(((MessageForPic)localObject4).issend)) || (TextUtils.isEmpty(((MessageForPic)localObject4).path)) || (!new File(((MessageForPic)localObject4).path).exists())) {
          continue;
        }
        ...
        if ((!bhfj.b(((MessageForPic)localObject4).issend)) || (TextUtils.isEmpty(((MessageForPic)localObject4).path)) || (!TextUtils.isEmpty(((MessageForPic)localObject4).md5)) || (!new File(((MessageForPic)localObject4).path).exists())) {
          continue;
        }
        localAIOImageData.jdField_b_of_type_JavaLangString = ((MessageForPic)localObject4).path;
        localAIOImageData.jdField_b_of_type_Int = 4;
        continue;
        if (!avek.a(localStructMsgForImageShare)) {
          continue;
        }
        localAIOImageData.jdField_b_of_type_Int = 5;
        avek.a(localAIOImageData, localStructMsgForImageShare);
        continue;
      ...
      localAIOImageData = ahsl.a((MessageForPic)localObject4);
      ...
      if ((localStructMsgForImageShare.mMsgActionData != null) && (localStructMsgForImageShare.mMsgActionData.startsWith("comic_plugin.apk")))
      {
        ...
        localAIOImageData.a = localStructMsgForImageShare.getBytes();
        localObject4 = ahsj.a(localStructMsgForImageShare);
        localAIOImageData.d = ahsj.a((String[])localObject4);
        if ((localObject4 != null) && (localObject4.length >= 8))
        {
          if (localObject4[7].equals("link"))
          {
            localObject3 = localObject4[4];
            blrb.a(null, (String)localObject2, localContext, "3009", "2", "40054", localObject4[0], new String[] { localObject4[2], localObject4[4], localObject3 });
          }
        }
        else
        {
          ...
          if (((localContext instanceof SplashActivity)) || ((localContext instanceof ChatActivity)) || ((localContext instanceof ChatHistoryActivity)) || ((localContext instanceof PublicFragmentActivity)) || ((localContext instanceof ChatHistory)))
          {
            ...
            if ((localObject3 instanceof QQAppInterface))
            {
              ...
              ((Bundle)localObject2).putString("uin", ((MultiForwardActivity)localContext).getChatFragment().a().getSessionInfo().curFriendUin);
              localObject4 = ((Bundle)localObject2).getString("extra.GROUP_UIN");
              if ((localObject4 != null) && (((QQAppInterface)localObject3).getTroopMask((String)localObject4) == 2)) {
          ...
          bdla.b(null, "P_CliOper", "Pb_account_lifeservice", localStructMsgForImageShare.uin, "0X80055C7", "0X80055C7", 0, j, "" + localStructMsgForImageShare.msgId, "" + localStructMsgForImageShare.templateIDForPortal, "", localStructMsgForImageShare.mMsgUrl);
          localObject2 = new StringBuilder().append("MSGID=").append(Long.toString(localStructMsgForImageShare.msgId)).append(";TEPLATEID=").append(localStructMsgForImageShare.templateIDForPortal).append(";ARTICALID=").append("").append(";REFERRER=").append(bdnu.a(localStructMsgForImageShare.mMsgUrl));
          bdla.b(null, "P_CliOper", "Pb_account_lifeservice", localStructMsgForImageShare.uin, "0X8005D49", "0X8005D49", 0, j, ((StringBuilder)localObject2).toString(), "", "", "");
          break;
