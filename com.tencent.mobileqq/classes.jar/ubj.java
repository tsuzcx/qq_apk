...
{
  public ubj(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          do
          {
            do
            {
              ...
              do
              {
                do
                {
                  ...
                  for (i = 1;; i = 0)
                  {
                    ...
                    paramView = paramView.findViewById(2131364300);
                    bool1 = bool2;
              ...
              paramView = paramView.findViewById(2131375085);
              boolean bool1 = bool3;
              if (paramView.getTag() != null)
              {
                bool1 = bool3;
        ...
        QQToast.a(this.a, this.a.getString(2131434811), 0).b(this.a.getTitleBarHeight());
        return;
