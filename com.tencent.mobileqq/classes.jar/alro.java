...
public class alro
{
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bdne.a(BaseApplicationImpl.getContext(), paramInt, k, m, n, (String)localObject1, (String)localObject3, paramString);
        if (QLog.isColorLevel()) {
        ...
        if (!bjtz.b((File)localObject2, paramString))
        {
  ...
  private static boolean a(String paramString1, String paramString2)
  {
    ...
    //   106	665	13	localObject3	Object
    // Exception table:
    //   from	to	target	type
