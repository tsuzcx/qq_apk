  ...
  extends awfk
{
  ...
  public awfj(Context paramContext, AppInterface paramAppInterface, View paramView, String paramString)
  {
  ...
  protected void a()
  {
    this.h = actn.a(16.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    super.a();
    ...
    int i = actn.a(36.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ...
    this.jdField_a_of_type_ComTencentMobileqqRichstatusSignBoxShadowLayout.setYOffset(i + actn.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
    i = (int)(axli.jdField_a_of_type_Int * 0.11F);
    ...
    ((ViewGroup.MarginLayoutParams)localObject).bottomMargin = actn.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ((ViewGroup.MarginLayoutParams)localObject).topMargin = actn.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  }
