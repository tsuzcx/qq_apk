...
public final class sae
{
  ...
  public sae(int paramInt, @Nullable String paramString)
  {
    this(paramInt, paramString, null);
  }
  
  public sae(int paramInt, @Nullable String paramString, @Nullable String[] paramArrayOfString)
  {
    this(paramInt, paramString, paramArrayOfString, null, false, 0L, null, false, false, false, null, 0, 4080, null);
  }
  
  public sae(int paramInt1, @Nullable String paramString1, @Nullable String[] paramArrayOfString, @Nullable String paramString2, boolean paramBoolean1, long paramLong, @Nullable String paramString3, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, @Nullable String paramString4, int paramInt2)
  {
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof sae))
      {
        paramObject = (sae)paramObject;
