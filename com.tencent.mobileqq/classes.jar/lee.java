  ...
  extends MSFServlet
{
  ...
  private void a(MultiVideoMsg paramMultiVideoMsg)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.a.getApplication(), lee.class);
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfByte = ldz.a(paramArrayOfByte);
    ...
    liz.a(34);
    msw.a("VideoServlet", ldc.a(3, String.valueOf(paramArrayOfByte.c), new int[0]), this.a, paramArrayOfByte);
  }
  ...
  void a(int paramInt, Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    Object localObject = locallkt;
    if (paramFromServiceMsg.isSuccess())
    {
      localObject = locallkt;
      if (i > 0)
      {
    ...
    locallkt = this.a.a();
    if (locallkt != null) {
      locallkt.a(paramInt, paramFromServiceMsg.isSuccess(), paramFromServiceMsg.getResultCode(), paramIntent, (byte[])localObject);
    }
  }
  ...
  void a(SharpVideoMsg paramSharpVideoMsg)
  {
    ...
    if (localFriends != null)
    {
      ...
      localBundle.putString("fromUin", mqx.a(l1));
  ...
  void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    //   30: iconst_4
    //   31: iload_3
    //   32: invokestatic 420	bbmj:a	([BI[BII)V
    ...
    //   63: astore_2
    //   64: aload_2
    //   65: invokestatic 532	lhd:a	(Lcom/tencent/av/common$ErrorInfo;)I
    //   68: istore 4
    //   70: aload_2
    ...
    //   187: i2l
    //   188: invokespecial 577	lom:<init>	(JJ)V
    ...
    //   210: istore 9
    //   212: aload_0
    //   213: getfield 99	lee:a	Lcom/tencent/av/app/VideoAppInterface;
    //   216: instanceof 101
    //   219: ifeq +170 -> 389
    //   222: aload_0
    //   223: getfield 99	lee:a	Lcom/tencent/av/app/VideoAppInterface;
    //   226: astore_1
    //   227: iload 9
    //   229: ifne +104 -> 333
    //   232: aload_1
    ...
    //   332: return
    //   333: aload_0
    //   334: getfield 99	lee:a	Lcom/tencent/av/app/VideoAppInterface;
    //   337: iconst_4
    ...
    //   388: return
    //   389: aload_0
    //   390: getfield 99	lee:a	Lcom/tencent/av/app/VideoAppInterface;
    //   393: iconst_4
  ...
  void a(String paramString, Packet paramPacket, Bundle paramBundle)
  {
    ...
    if (paramString != null) {
      paramPacket.putSendData(bblm.a(paramString));
    }
  }
  ...
  void b(Packet paramPacket, Bundle paramBundle)
  {
    ...
    paramPacket.putSendData(bblm.a(paramBundle.toByteArray()));
  }
          ...
          for (;;)
          {
            ...
            for (boolean bool = true;; bool = false)
            {
              ...
              if ("SharpSvr.c2s".equalsIgnoreCase(str)) {
                axqw.b(null, "CliOper", "", "", "0X80088B1", "0X80088B1", 0, 0, "", "", "", "");
              }
              if (paramIntent == null) {
                break;
              }
            ...
            if ("SharpSvr.s2c".equalsIgnoreCase(str))
            {
              ...
              if (i != 1013)
              {
                ...
                for (;;)
                {
                  ...
                  this.a.a(paramIntent.from_uin, (String)localObject, awzw.a());
                  if (this.a.c)
                  {
                    this.a.c = false;
                    this.a.d = true;
                  ...
                  try
                  {
                    localObject = ldz.a(paramIntent.video_buff);
                    QLog.w("tagSharpSvr", 1, "<-- onReceive() cmd = " + str + " , msg_type = " + paramIntent.msg_type + ", bodyType = " + ((lea)localObject).a);
                    c(paramIntent);
            ...
            else
            {
              if ("SharpSvr.c2sack".equalsIgnoreCase(localException))
              {
                ...
                for (;;)
                {
                  ...
                  try
                  {
                    paramFromServiceMsg = ldz.a(paramIntent.video_buff);
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    do
    {
      do
      {
        ...
        return;
        axqw.b(null, "CliOper", "", "", "0X80088B0", "0X80088B0", 0, 0, "", "", "", "");
        if (QLog.isColorLevel()) {
        ...
        try
        {
          paramPacket = ldz.a(paramIntent.video_buff);
        ...
        try
        {
          localObject1 = ldz.a(((SharpVideoMsg)localObject3).video_buff);
          QLog.w("tagSharpSvr", 1, "--> onSend() cmd = SharpSvr.s2cack , msg_type = " + ((SharpVideoMsg)localObject3).msg_type + ", bodyType = " + ((lea)localObject1).a);
        ...
        bbmj.a((byte[])localObject2, 0, paramIntent.length + 4);
        bbmj.a((byte[])localObject2, 4, paramIntent, paramIntent.length);
    ...
    paramPacket.putSendData(bblm.a(((Bundle)localObject2).getByteArray("vMsg")));
    return;
