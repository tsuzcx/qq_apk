  ...
  extends BroadcastReceiver
{
  ...
  lee(VideoAppInterface paramVideoAppInterface)
  {
    ...
    do
    {
      do
      {
        do
        {
            ...
            do
            {
              do
              {
                do
                {
                        ...
                        do
                        {
                          do
                          {
                            ...
                            do
                            {
                                  ...
                                  do
                                  {
                                    do
                                    {
                                      ...
                                      do
                                      {
                                        do
                                        {
                                          do
                                          {
                                            do
                                            {
                                              ...
                                              QLog.d(led.a, 2, " onReceive: " + paramIntent.getAction());
                                              return;
                                              if (QLog.isColorLevel()) {
                                                QLog.w(led.a, 1, "GAudioMsgReceiver_onReceive[" + paramIntent.getAction() + "]");
                                              }
                                              ...
                                              if (QLog.isColorLevel()) {
                                                QLog.d(led.a, 2, "GAudioMsgReceiver type: " + i);
                                              }
                                              if (i != 26) {
                                                break;
                                              }
                                          ...
                                          QLog.d(led.a, 2, "GAudioMsgReceiver TYPE_GAUDIO_AUDIO_C2S_ACK UnsatisfiedLinkError!");
                                          return;
                                          if (i == 24)
                                          {
                                        ...
                                        QLog.e(led.a, 2, "GAudioMsgReceiver-->uinlist is null");
                                        return;
                                        str1 = paramIntent[0];
                                        str2 = this.a.getCurrentAccountUin();
                                        if (QLog.isColorLevel()) {
                                          QLog.d(led.a, 2, "TYPE_GAUDIO_MEMBER_KICKOUT-->discuss id = " + l1 + ", cmdUin = " + (String)localObject + ", outUin = " + str1 + ", selfUin = " + str2 + ", uinList.size = " + paramIntent.length);
                                        }
                              ...
                              l2 = muk.a(paramIntent);
                              l3 = AudioHelper.b();
                              QLog.w(led.a, 1, "switchToMultiAudio, seq[" + l2 + "], newseq[" + l3 + "], [discussion]");
                              paramContext.a(l3, i, l1, (ArrayList)localObject);
                              return;
                              if (paramIntent.getAction().equals("tencent.video.q2v.GroupInfoChanged"))
                              {
                                paramContext = bhon.a(paramIntent.getExtras());
                              ...
                              if (QLog.isColorLevel()) {
                                QLog.w(led.a, 1, "GAudioMsgReceiver_onReceive[tencent.video.q2v.GroupSystemMsg], type[" + i + "], relationType[" + j + "], relationId[" + l1 + "], userUin[" + l2 + "], needSendCmd[" + bool + "]");
                              }
                              if ((i != 7) && (i != 8)) {
                                break label1597;
                              }
                            ...
                            if (QLog.isColorLevel()) {
                              QLog.d(led.a, 2, "ACTION_SELECT_MEMBER");
                            }
                            i = paramIntent.getIntExtra("InviteCount", 0);
                            paramIntent = paramIntent.getStringExtra("FirstName");
                            if (QLog.isColorLevel()) {
                              QLog.d(led.a, 2, "ACTION_SELECT_MEMBER --> InviteCount = " + i + " , FirstName = " + paramIntent);
                            }
                  ...
                  QLog.d(led.a, 2, "[random room owner] ACTION_RANDOM_MULTI_OWNER_ONLINE_PUSH");
                  return;
                } while (paramContext.a() != null);
                lbj.e(led.a, "ACTION_RANDOM_MULTI_OWNER_ONLINE_PUSH videoController.getSessionInfo() == null");
                return;
              ...
              lbj.e(led.a, "ACTION_RANDOM_1V1_ONLINE_PUSH videoController.getSessionInfo() == null");
              return;
              ...
              if ((paramContext != null) && (paramContext.a() != null))
              {
                ...
                QLog.d(led.a, 2, "ACTION_AUDIO_TRANS_PUSH rsptype=" + i + "|" + paramContext.length);
                ((lgb)this.a.a(0)).a(i, paramContext);
                return;
              }
            } while (paramContext.a() != null);
            lbj.e(led.a, " ACTION_AUDIO_TRANS_PUSH videoController.getSessionInfo() == null");
            return;
          ...
          lwb.a(this.a, i, paramIntent.getStringExtra("rspbody"));
          return;
        } while (paramContext.a() != null);
        lbj.e(led.a, "ACTION_AV_REPORT_PUSH videoController.getSessionInfo() == null");
        return;
      ...
      QLog.d(led.a, 1, "ACTION_OPPOSITE_AUDIO_ENGINE_READY:" + l1 + "|" + l2);
    } while ((l1 == 0L) || (l2 == 0L));
    label1597:
    label1611:
    label2137:
