  ...
  implements View.OnTouchListener
{
  ...
  public biqk(PAHighLightImageView paramPAHighLightImageView, Context paramContext)
  {
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    paramView = this.jdField_a_of_type_ComTencentMobileqqWidgetPAHighLightImageView.getTag(2131373330);
    if (paramView == null) {}
    label100:
    do
    {
