...
public class avhj
  implements axrt
{
  public avhj(ScribbleResMgr.5 param5) {}
  
  public void onResp(axsq paramaxsq)
  {
    int j = 2;
    QLog.i("ScribbleResMgr", 2, "DownloadResIcon onResp resp.mResult:  " + paramaxsq.a);
    int i = j;
    Object localObject;
    String str1;
    String str2;
    ...
    for (i = 0;; i = 1)
    {
      ...
      for (;;)
      {
        ...
        paramaxsq = new ScribbleResMgr.ResInfo();
        paramaxsq.resType = this.a.a;
        paramaxsq.sourceId = 0;
        ScribbleResMgr.a(this.a.this$0, paramaxsq, i);
        return;
        if (str2 == null) {}
