...
public class aonj
{
  ...
  public aonj(QQAppInterface paramQQAppInterface, apcy paramapcy, long paramLong)
  {
    ...
    Object localObject1 = (HashMap)paramapcy.a().get("OnlinePreView");
    ...
    paramapcy = (HashMap)paramapcy.a().get("OfflineConfig");
    localObject1 = paramapcy.keySet().iterator();
    while (((Iterator)localObject1).hasNext())
    {
      localObject2 = (String)((Iterator)localObject1).next();
      localObject3 = paramapcy.get(localObject2);
  ...
  {
    long l1 = Long.parseLong(apck.c("OfflineConfigFlowSize"));
    try
    {
  ...
  public static String a(Context paramContext, String paramString)
  {
    ...
    return apck.c(paramString);
  }
  
  public static String a(Context paramContext, String paramString1, String paramString2)
  {
    return a(paramContext, "OnlinePreView", apdh.a(paramString1).replace(".", ""), paramString2);
  }
  ...
  {
    long l1 = Long.parseLong(apck.c("OfflineConfigFlowTime"));
    try
    {
  ...
  {
    long l1 = Long.parseLong(apck.c("OfflineConfigFtnThumbMaxSize"));
    try
    {
