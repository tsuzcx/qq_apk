  ...
  extends aoni
{
  ...
  public aonj(QQAppInterface paramQQAppInterface, aonm paramaonm)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if (localanmw.b((String)localObject3))
          {
        ...
        else if (bgnn.a(MessageRecord.getTableName((String)localObject3, i), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a()))
        {
          localArrayList.add(localFTSEntity);
  ...
  private void a(FTSMessage paramFTSMessage, int paramInt)
  {
    try
    {
      ...
      if ((paramFTSMessage.istroop == 0) && (!((anmw)localObject1).b(paramFTSMessage.senderuin)) && (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(paramFTSMessage.senderuin)) && (!bgnn.a((String)localObject2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a())))
      {
        ...
        bctj.a(BaseApplicationImpl.getContext()).a(null, "actStrangerFtsMsg", true, 0L, 0L, (HashMap)localObject1, "");
      }
      return;
    }
      ...
      synchronized (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList)
      {
        ...
        if (!localThrowable.isEmpty())
        {
          ...
          if ((QLog.isColorLevel()) || (paramLong > 60000L))
          {
            ...
            bctj.a(BaseApplication.getContext()).a(null, "actFTSMsgCost", true, paramLong, 0L, (HashMap)localObject3, null, false);
  ...
  public ArrayList<FTSEntity> a(long paramLong, Pair<CharSequence, CharSequence> paramPair)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a()))
    {
      localObject = aonh.a(FTSMessage.class, String.valueOf(paramLong));
      localObject = this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a((aywc)localObject);
  ...
  public ArrayList<FTSEntity> a(String paramString, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      do
      {
        ...
        localObject1 = bguq.a(str);
        paramString = aonh.a(paramString, (String[])((ArrayList)localObject1).toArray(new String[((ArrayList)localObject1).size()]), paramClass, paramBoolean1, paramBoolean2);
  ...
  public ArrayList<FTSEntity> a(String paramString, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a()))
    {
      ...
      do
      {
        ...
        paramString = bguq.a((String)localObject);
        if (QLog.isColorLevel()) {
          QLog.i("Q.fts.FTSMsgOperator", 2, "query segments = " + Arrays.toString(paramString));
        }
        ...
        localObject = bguq.a((String)localObject);
        paramString = aonh.a(paramString, (String[])((ArrayList)localObject).toArray(new String[((ArrayList)localObject).size()]), paramClass, paramBoolean1, paramBoolean2, paramInt);
  ...
  public ArrayList<FTSEntity> a(String paramString1, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString2)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a()))
    {
      ...
      do
      {
        ...
        paramString1 = bguq.a((String)localObject);
        if (QLog.isColorLevel()) {
        ...
        localObject = bguq.a((String)localObject);
        paramString1 = aonh.a(paramString1, (String[])((ArrayList)localObject).toArray(new String[((ArrayList)localObject).size()]), paramClass, paramBoolean1, paramBoolean2, paramInt, paramString2);
  ...
  public void a(MsgQueueItem paramMsgQueueItem, EntityManager paramEntityManager)
  {
    ...
    if ((paramMsgQueueItem.whereClause != null) && (!TextUtils.isEmpty(paramMsgQueueItem.whereClause)))
    {
      ...
      if ((localObject1 != null) && (bguq.a(paramMsgQueueItem.value))) {
    ...
    while (paramMsgQueueItem.hasNext())
    {
      ...
      if ((((MessageRecord)localObject1).isSupportFTS()) && (((MessageRecord)localObject1).isValid) && (((MessageRecord)localObject1).msgtype != -2006) && (!((MessageRecord)localObject1).isMultiMsg))
      {
        ...
        continue;
        if ((localObject1 != null) && (bguq.b(paramMsgQueueItem.value)))
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            if ((((MessageRecord)localObject3).isSupportFTS()) && (((MessageRecord)localObject3).isValid) && (((MessageRecord)localObject3).msgtype != -2006) && (!((MessageRecord)localObject3).isMultiMsg))
            {
              ...
              localObject3 = bguq.a(paramMsgQueueItem.value, (MessageRecord)localObject3);
  ...
  public boolean a(FTSDatatbase paramFTSDatatbase, FTSDatabase paramFTSDatabase)
  {
    ...
    this.jdField_a_of_type_Aonp = new aonk(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this);
  ...
  public long b(String paramString)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))
    {
      ...
      if (((FTSMsgCounter)localObject).mMsgCnt > 1000L)
      {
        ...
        this.jdField_a_of_type_Ayvj.update((Entity)localObject);
      }
      for (;;)
      {
  ...
  public void b(MsgQueueItem paramMsgQueueItem, EntityManager paramEntityManager)
  {
    ...
    try
    {
      ((FTSMessage)localObject).uin = mqu.a(paramMsgQueueItem.frindUin);
  ...
  {
    super.c();
    if (1 == bguq.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
      this.jdField_a_of_type_Aonm.obtainMessage(1, this).sendToTarget();
    }
  }
  ...
  public void e()
  {
    if ((!aone.jdField_a_of_type_Boolean) && (bguq.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) {
      if (QLog.isColorLevel()) {
        QLog.e("Q.fts.FTSMsgOperator", 2, "transToDatabase ENABLE = " + aone.jdField_a_of_type_Boolean + ", FTSUpgradeFlag = " + bguq.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      }
    }
  ...
  {
    // Byte code:
    //   0: getstatic 845	aone:jdField_a_of_type_Boolean	Z
    //   3: ifne +64 -> 67
    //   6: aload_0
    //   7: getfield 72	aonj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   10: invokestatic 857	bguq:d	(Lcom/tencent/mobileqq/app/QQAppInterface;)Z
    //   13: ifeq +54 -> 67
    ...
    //   38: getstatic 845	aone:jdField_a_of_type_Boolean	Z
    ...
    //   50: aload_0
    //   51: getfield 72	aonj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   54: invokestatic 857	bguq:d	(Lcom/tencent/mobileqq/app/QQAppInterface;)Z
    ...
    //   66: return
    //   67: aload_0
    //   68: getfield 72	aonj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   74: astore 9
    //   76: aload_0
    //   77: getfield 72	aonj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   105: iconst_0
    //   106: aload_0
    //   107: getfield 390	aonj:jdField_a_of_type_Int	I
    ...
    //   135: iconst_0
    //   136: aload_0
    //   137: getfield 390	aonj:jdField_a_of_type_Int	I
    ...
    //   168: iconst_0
    //   169: aload_0
    //   170: getfield 320	aonj:jdField_b_of_type_Int	I
    ...
    //   198: iconst_0
    //   199: aload_0
    //   200: getfield 320	aonj:jdField_b_of_type_Int	I
    ...
    //   238: aload_0
    //   239: getfield 294	aonj:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   242: ifnull +271 -> 513
    //   245: aload_0
    //   246: getfield 294	aonj:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    ...
    //   286: istore_1
    //   287: aload_0
    //   288: getfield 294	aonj:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   291: aload 11
    //   293: iconst_1
    //   294: iload_1
    ...
    //   299: aload_0
    //   300: aload_0
    //   301: getfield 390	aonj:jdField_a_of_type_Int	I
    //   304: iload_1
    //   305: iadd
    //   306: putfield 390	aonj:jdField_a_of_type_Int	I
    ...
    //   363: istore_1
    //   364: aload_0
    //   365: getfield 294	aonj:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   368: aload 11
    //   370: iconst_2
    //   371: iload_1
    ...
    //   376: aload_0
    //   377: aload_0
    //   378: getfield 320	aonj:jdField_b_of_type_Int	I
    //   381: iload_1
    //   382: iadd
    //   383: putfield 320	aonj:jdField_b_of_type_Int	I
    ...
    //   428: aload_0
    //   429: getfield 333	aonj:d	I
    //   432: i2l
    //   433: lstore 5
    //   435: aload_0
    //   436: aload_0
    //   437: getfield 294	aonj:jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase	Lcom/tencent/mobileqq/persistence/fts/FTSDatatbase;
    //   440: ldc_w 400
    //   443: invokevirtual 403	com/tencent/mobileqq/persistence/fts/FTSDatatbase:b	(Ljava/lang/String;)I
    //   446: putfield 333	aonj:d	I
    ...
    //   545: iconst_1
    //   546: aload 8
    //   548: invokevirtual 882	java/lang/Exception:toString	()Ljava/lang/String;
    //   551: aastore
    //   552: invokestatic 884	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   555: aload 7
