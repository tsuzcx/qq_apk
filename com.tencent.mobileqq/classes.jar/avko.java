...
public class avko
{
  ...
  ActionCallback jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceActionCallback = new avkq(this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public avko(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Avjl = avkt.a().a();
  ...
  private void c(Bundle paramBundle)
  {
    ...
    {
      localObject2 = bdsh.a(str2);
      localObject1 = localObject2;
      if (localObject2 == null) {
        localObject1 = bdsh.a(str2 + "?busiType=3");
      }
      localObject2 = str1;
    ...
    paramBundle.putString("hostVersion", String.valueOf(ardl.a(BaseApplicationImpl.getContext())));
  ...
  public void a(Bundle paramBundle, avkm paramavkm)
  {
    ...
    paramavkm = paramBundle.getString("mqqUrl", "");
    long l = System.currentTimeMillis();
    if ((l - this.jdField_a_of_type_Long < 1000L) && (!avjo.c(paramBundle).equals("1")))
    {
      QLog.i("DynamicNow | NowEntry", 1, "开始处理mqq　scheme,time = " + System.currentTimeMillis() + " 点太快了");
      QQToast.a(BaseApplicationImpl.getContext(), anni.a(2131706436), 0).a();
      return;
    }
    this.jdField_a_of_type_Long = l;
    QLog.i("DynamicNow | NowEntry", 1, "开始进入now结合版,time = " + System.currentTimeMillis() + " mqqScheme = " + paramavkm);
  ...
  {
    Object localObject1 = avjo.a(paramBundle);
    Object localObject2 = avjo.b(paramBundle);
    long l = avjo.a(paramBundle);
    this.jdField_a_of_type_Avjl.a(false, (String)localObject2, String.valueOf(l), (String)localObject1, false, false, true);
    ...
    if ((a((String)localObject1)) || (bdsh.a((String)localObject1) != null) || (bdsh.a((String)localObject2) != null))
    {
      c(paramBundle);
      return;
    }
    ...
    ((URLDrawable)localObject1).setURLDrawableListener(new avkp(this, l, (AtomicBoolean)localObject2, paramBundle));
