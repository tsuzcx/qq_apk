  ...
  extends Handler
{
  ...
  public bfrb(PublishHomeWorkFragment paramPublishHomeWorkFragment, Looper paramLooper)
  {
    super(paramLooper);
  ...
  void a()
  {
    ...
    localObject = localPublishHomeWorkFragment.getString(2131697184, new Object[] { Integer.valueOf(i), Integer.valueOf(j), localPublishHomeWorkFragment.jdField_a_of_type_JavaLangString }).trim();
    String str1 = localPublishHomeWorkFragment.getString(2131697184, new Object[] { Integer.valueOf(i), Integer.valueOf(j), "" }).trim();
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      case 3: 
        ...
        localPublishHomeWorkFragment.jdField_a_of_type_Bkzi.d(false);
        return;
      case 515: 
      ...
      case 102: 
        ...
        if (i < 1000)
        {
          QQToast.a(localPublishHomeWorkFragment.getActivity(), anvx.a(2131708292), 0).a();
          localPublishHomeWorkFragment.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelCommonRecordSoundPanel.a();
          return;
        }
        if (!NetworkUtil.isNetSupport(localPublishHomeWorkFragment.getActivity()))
        {
          if (QLog.isColorLevel()) {
            QLog.d("PublishHomeWorkFragment", 2, "no network toast");
          }
          QQToast.a(localPublishHomeWorkFragment.getActivity(), 2131696954, 0).a();
          localPublishHomeWorkFragment.f = false;
          localPublishHomeWorkFragment.m();
          return;
        }
        ...
        {
          paramMessage = new bfuq(paramMessage, null, i / 1000, (int)l, localPublishHomeWorkFragment.b);
