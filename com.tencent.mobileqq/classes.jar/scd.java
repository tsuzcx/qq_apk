...
public final class scd
{
  ...
  {
    boolean bool = true;
    jdField_a_of_type_Scf = new scf(null);
  ...
  public scd(@NotNull VideoFeedsStressFollowLayout paramVideoFeedsStressFollowLayout, @NotNull View paramView)
  {
    ...
    paramVideoFeedsStressFollowLayout = this.jdField_b_of_type_AndroidViewView.findViewById(2131367982);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsStressFollowLayout.a((scn)new sce(this));
  }
  ...
  private final void a()
  {
    ...
    localValueAnimator.addUpdateListener((ValueAnimator.AnimatorUpdateListener)new scg(this));
    localValueAnimator.addListener((Animator.AnimatorListener)new sch(this));
  ...
  private final void a(Animator.AnimatorListener paramAnimatorListener)
  {
    ...
    localAnimatorSet2.addListener((Animator.AnimatorListener)new sci(this));
    ValueAnimator localValueAnimator = ValueAnimator.ofFloat(new float[] { 0.0F, 1.0F });
    Intrinsics.checkExpressionValueIsNotNull(localValueAnimator, "translationAnimator");
    localValueAnimator.setDuration(400L);
    localValueAnimator.addUpdateListener((ValueAnimator.AnimatorUpdateListener)new scj(this));
    AnimatorSet localAnimatorSet3 = new AnimatorSet();
    localAnimatorSet3.addListener((Animator.AnimatorListener)new sck(this, paramAnimatorListener));
