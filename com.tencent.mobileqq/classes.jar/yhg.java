...
public class yhg
  extends nit
{
  public yhg(StoryMessageListActivity paramStoryMessageListActivity)
  {
    ...
    if ((paramInt == 0) && (paramArrayOfByte != null)) {
      try
      {
        ...
        if ((localRspStoryMessageList.errinfo.error_code.has()) && (localRspStoryMessageList.errinfo.error_code.get() == 0))
        {
          ...
          {
            yhd localyhd = new yhd((qqstory_710_message.StoryMessage)localIterator.next());
            if (localyhd.d) {
              paramArrayOfByte.add(localyhd);
            }
          }
        }
