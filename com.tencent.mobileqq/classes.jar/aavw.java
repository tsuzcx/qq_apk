  ...
  implements Handler.Callback, bauf, baug, Manager
{
  ...
  public aavw(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(aawe paramaawe)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokevirtual 54	aawe:b	()Z
    //   4: ifne +4 -> 8
    //   7: return
    //   8: aload_1
    //   9: invokevirtual 57	aawe:b	()Ljava/lang/String;
    ...
    //   112: invokestatic 106	aavv:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   115: aload_2
    //   116: astore_1
    //   117: aload_2
    //   118: aload 5
    ...
    //   133: invokestatic 106	aavv:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   136: aload_2
    //   137: astore_1
    //   138: aload_2
    //   139: aload 6
    ...
    //   154: invokestatic 106	aavv:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   157: aload_2
    //   158: astore_1
    //   159: aload_2
    //   160: ldc 108
    ...
    //   214: aload 5
    //   216: invokestatic 106	aavv:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   219: aload_2
    //   220: ifnull -213 -> 7
    //   223: aload_2
    ...
    //   252: invokestatic 106	aavv:a	(Ljava/io/InputStream;Ljava/io/File;)V
    //   255: goto -36 -> 219
    //   258: astore_3
    //   259: aload_2
    //   260: astore_1
  ...
  {
    aavx localaavx = (aavx)parambavf.jdField_a_of_type_Bave.a();
    if ((localaavx == null) || (localaavx.jdField_a_of_type_Aawe == null))
    {
    ...
    long l2 = localaavx.jdField_a_of_type_Long;
    String str3 = localaavx.jdField_a_of_type_Aawe.b();
    String str1 = localaavx.jdField_a_of_type_Aawe.c();
    int i = localaavx.jdField_a_of_type_Aawe.c();
    QLog.d("PatchLogTag", 1, "PatchDownloadManager doOnResp reslut=" + parambavf.jdField_a_of_type_Int + ", mTotalFileLen=" + parambavf.jdField_a_of_type_Long + ", downloadPatchSize=" + i + ", cost time=" + (l1 - l2));
    ...
    for (;;)
    {
      try
      {
        if ((parambavf.jdField_a_of_type_Int != 0) || (parambavf.jdField_a_of_type_Long != i)) {
          break label398;
        }
        boolean bool2 = true;
        boolean bool1 = bool2;
        if (!localaavx.jdField_a_of_type_Aawe.b())
        {
          bool1 = bool2;
          if (PatchCommonUtil.isArtGeN()) {
            bool1 = aavy.a(localaavx.jdField_a_of_type_Aawe);
          }
        }
        bool2 = bool1;
        if (bool1) {
          bool2 = PatchChecker.checkPatchValid(localaavx.jdField_a_of_type_JavaLangString, str3);
        }
        if (bool2)
        {
          a(localaavx.jdField_a_of_type_Aawe);
          zhx.c();
          zhx.a(alud.a(2131708294));
      ...
      {
        QLog.d("PatchLogTag", 1, "PatchDownloadManager doOnResp throwable=" + parambavf);
      ...
      if (parambavf.exists())
      {
        ...
        {
          str3 = "PatchDownloadManager doOnResp NOT ResultOk mErrCode=" + parambavf.b + ", mErrDesc=" + parambavf.jdField_a_of_type_JavaLangString;
          ...
          if (l2 - l1 > 21600000L)
          {
            azpo.a(new RuntimeException(), str3);
            ((SharedPreferences)localObject).edit().putLong("patch_download_fail_report_time", l2).commit();
          }
          if ((parambavf.b == 9039) || (parambavf.b == 9301))
          {
            parambavf = new File(parambavf.jdField_a_of_type_Bave.d);
            QLog.d("PatchLogTag", 1, "write temp patch fail path=" + parambavf.getAbsolutePath() + ", isExist=" + parambavf.exists() + ", canWrite=" + parambavf.canWrite());
          }
        }
        if (localaavx.jdField_a_of_type_Int < 3)
        {
          a(localaavx.jdField_a_of_type_Int, localaavx.jdField_a_of_type_JavaLangString, localaavx.jdField_a_of_type_Aawe);
          return;
        }
        zhx.c();
        parambavf = new File(str2);
        if (parambavf.exists()) {
          parambavf.delete();
        }
  ...
  public void a(int paramInt, String paramString, aawe paramaawe)
  {
    String str1 = paramaawe.d();
    String str2 = paramaawe.c();
    ...
    localbaub.c = PatchCommonUtil.getPatchPath(str2);
    localbaub.a(new aavx(this, paramInt + 1, SystemClock.elapsedRealtime(), paramString, paramaawe));
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(str2, localbaub);
  ...
  public void a(bave parambave, bavf parambavf)
  {
    ...
    parambavf.c = 0L;
    parambave.jdField_a_of_type_JavaUtilHashMap.put("Range", "bytes=" + parambave.jdField_a_of_type_Long + "-");
  }
  ...
  {
    if (this.jdField_a_of_type_AndroidOsHandler != null) {
      this.jdField_a_of_type_AndroidOsHandler.obtainMessage(1, parambavf).sendToTarget();
    }
  }
  
  public void onUpdateProgeress(bave parambave, long paramLong1, long paramLong2)
  {
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(2, (int)paramLong1, (int)paramLong2, parambave).sendToTarget();
  }
}
