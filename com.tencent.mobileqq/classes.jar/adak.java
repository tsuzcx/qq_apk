...
public class adak
{
  public static Comparator<MessageRecord> a;
  ...
  static
  {
    ...
    d = new int[] { -4004, -4003, -4009, -4020, -3010, -3011, -1044, -5005, -4021, -4022, -5011, -3014, -2064, -7005, -5022, -7013 };
    e = new int[] { -1034, -1042, -2015, -2061, -2003, -2004, -2009, -1001, -2076, -2012, -1013, -2030, -1019, -1018, -1014, -1043, -1045, -5000, -5001, -1024, -1028, 2024, -2042, -5005, -1046, -2027, -2037, -5006, -4011, -4012, -2029, -2034, -2033, -2041, -2060, -2062, -2065, -2063, -2066, -3016, -7007, -7010, -7009, -7011, -7012 };
    ...
    h = new int[] { -2006, -1034, -1042, -2015, -2061, -4002, -4003, -4004, -1001, -1047, -1013, -2030, -1019, -1018, -2012, -1014, -1004, -1016, -1017, -1050, -2021, -3011, -4020, -3009, -3010, -1041, -1043, -1044, -1045, -5000, -5001, -1024, -1028, 1018, 2024, -2042, -1012, -1046, -2027, -2029, -2043, -4021, -4022, -2049, -5021, -5023, -2065, -2060, -2062, -4023, -4024, -7007, -2077, -7010, -7009, -7011, -7012, -7013 };
    i = new int[0];
    j = new int[0];
    k = new int[] { 1008 };
    l = new int[] { -1000, -2000, -2002, -2005, -1035, -1036, -1037, -20000, -2007, -2011, -2010, -1051 };
    m = new int[] { -2000, -2002, -2007, -2058, -2011, -2020, -2022, -1051, -1035, -2057, -7001, -2071 };
    n = new int[] { -1001, -2009, -2016, -4008 };
    o = new int[] { -2030, -1047, -5040 };
    p = new int[] { -5040, -5020, -5021, -5022, -5023 };
    jdField_a_of_type_ArrayOfJavaLangString = new String[] { antf.H, antf.w, antf.ab, antf.aj, antf.ak, antf.D, antf.G, antf.aM };
    jdField_b_of_type_ArrayOfJavaLangString = new String[] { antf.aA };
    q = new int[] { 0, 1000, 1004, 1020, 1006, 1001, 10002, 10004, 1009, 1003, 1005, 1008, 1023, 1021, 1022, 1024, 1025, 1010, 7400, 1037, 1044, 1045, 1032, 1033, 1034, 1036, 1038, 10007, 10008, 10009, 10010 };
    r = new int[] { 1033, 1034 };
    s = new int[] { 1000, 1004, 1020 };
    t = new int[] { 1, 3000, 1006, 7000, 9501, 10005, 1033, 1034, 1036 };
    jdField_c_of_type_ArrayOfJavaLangString = new String[] { antf.H, antf.ab };
    u = new int[] { 1001, 10002, 1010 };
    v = new int[] { 0, 1, 3000, 1025, 1024 };
    w = new int[] { 0, 1, 3000 };
    jdField_a_of_type_JavaUtilComparator = new adal();
  }
  ...
  {
    return aqyt.a(paramInt1, paramInt2);
  }
  ...
  public static MessageRecord a(List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.equals(localMessageRecord.frienduin, antf.aA))
      {
  ...
  public static String a(MessageRecord paramMessageRecord)
  {
    ...
    if (paramMessageRecord.istroop == 1032)
    {
      ...
      for (;;)
      {
        return aqyt.a(paramMessageRecord.senderuin, i1, paramMessageRecord.getConfessTopicId());
        i1 = 1034;
      }
    }
    if ((paramMessageRecord.istroop == 1033) || (paramMessageRecord.istroop == 1034)) {
      return aqyt.a(paramMessageRecord.frienduin, paramMessageRecord.istroop, paramMessageRecord.getConfessTopicId());
    }
  ...
  public static List<MessageRecord> a(List<MessageRecord> paramList)
  {
    ...
    {
      MessageRecord localMessageRecord = (MessageRecord)paramList.next();
      if ((!o(localMessageRecord.msgtype)) && (((localMessageRecord.istroop != 3000) && (localMessageRecord.istroop != 1)) || (localMessageRecord.shmsgseq > 0L))) {
  ...
  public static List<MessageRecord> a(List<MessageRecord> paramList, boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean) {
      Collections.sort(paramList, new adam());
    }
    ...
    while (i2 >= 0)
    {
      ...
      if ((u(localMessageRecord.msgtype)) && (localMessageRecord.shmsgseq == 0L))
      {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        localList = paramQQAppInterface.a(1).c(paramString, 1, 1L + paramLong, 2147483647L);
      ...
      for (;;)
      {
        ...
        bdll.b(paramQQAppInterface, "dc00899", "BizTechReport", "", "Grp_msg", "del_abnormal_local_msg", 0, 0, paramString, i2 + "", i3 + "", "");
        return;
        label426:
        i5 = i1;
        i1 = i3;
  ...
  public static void a(String paramString, int paramInt, List<MessageRecord> paramList, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      {
        if (((bcrg)localObject1).a(paramString, paramInt) != null)
        {
          paramQQAppInterface = new ArrayList();
          ...
          for (;;)
          {
            ...
            if (!((ArrayList)localObject4).isEmpty()) {
              if ((((MessageRecord)((ArrayList)localObject4).get(0)).longMsgCount <= ((ArrayList)localObject4).size()) || (((MessageRecord)((ArrayList)localObject4).get(0)).isSendFromLocal()))
              {
                ...
                ((bcrg)localObject1).a(paramString, paramInt, (String)localObject3);
              }
              else if (((bcrg)localObject1).a(paramString, paramInt, (String)localObject3))
              {
                if (QLog.isColorLevel()) {
  ...
  {
    if (paramInt == 1) {
      return !((HotChatManager)paramQQAppInterface.getManager(60)).b(paramString);
    }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    {
      if (((HotChatManager)paramQQAppInterface.getManager(60)).b(paramMessageRecord.frienduin)) {
        return true;
      }
    }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    if (paramInt == 3000)
    {
      ...
      DiscussionInfo localDiscussionInfo = localanws.a(paramString, true);
      if ((localDiscussionInfo == null) || (localDiscussionInfo.isHidden())) {
        return true;
      }
      paramQQAppInterface = localanws.a(paramString, paramQQAppInterface.getCurrentAccountUin());
      if (paramQQAppInterface != null) {
    ...
    do
    {
      do
      {
        do
        {
          ...
          break;
          bool1 = bool2;
        } while (!j(paramMessageRecord.msgtype));
        bool1 = bool2;
    ...
    for (;;)
    {
      ...
      if (c(paramMessageRecord1, paramMessageRecord2))
      {
        ...
        if (c(paramMessageRecord1, paramMessageRecord2))
        {
          ...
          else if (avpe.a(paramMessageRecord1))
          {
            paramBoolean = bool1;
            if (paramMessageRecord1.msgUid == paramMessageRecord2.msgUid)
            {
              ...
              do
              {
                do
                {
                  do
                  {
                    ...
                    paramBoolean1 = bool;
                  } while (avpe.a(paramMessageRecord1));
  ...
  {
    MessageForTroopFile localMessageForTroopFile = (MessageForTroopFile)bcry.a(-2017);
    MessageRecord.copyMessageRecordBaseField(localMessageForTroopFile, paramMessageRecord1);
    localMessageForTroopFile.doParse();
    paramMessageRecord1 = (MessageForTroopFile)bcry.a(-2017);
  ...
  public static <T extends MessageRecord> void b(List<T> paramList, T paramT, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (((localMessageRecord instanceof MessageForUniteGrayTip)) && ((paramT instanceof MessageForUniteGrayTip)))
        {
          if (((MessageForUniteGrayTip)localMessageRecord).tipParam.d <= ((MessageForUniteGrayTip)paramT).tipParam.d) {
            break;
          }
          i1 = 1;
        }
      ...
      do
      {
        do
        {
          do
          {
            ...
            if ((paramMessageRecord2.msgtype != -2065) && (paramMessageRecord2.msgtype != -2062) && (paramMessageRecord2.msgtype != -4023) && (paramMessageRecord2.msgtype != -2066) && (paramMessageRecord2.msgtype != -7009) && (paramMessageRecord2.msgtype != -7010) && (paramMessageRecord2.msgtype != -7011) && (paramMessageRecord2.msgtype != -7012) && (paramMessageRecord2.msgtype != -7013)) {
              break;
            }
  ...
  public static boolean b(String paramString)
  {
    ...
    while ((!antf.aj.equals(paramString)) && (!antf.ak.equals(paramString))) {
      return false;
    }
    return true;
  }
  ...
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (((a(paramInt) == 1001) || (a(paramInt) == 10002)) && ((!antf.H.equals(paramString)) && (((a(paramInt) == 1001) || (a(paramInt) == 10002)) && ((!antf.I.equals(paramString)) && ((a(paramInt) != 1009) || (!antf.w.equals(paramString))) && ((a(paramInt) != 1010) || (!antf.ab.equals(paramString))) && ((a(paramInt) != 1001) || (!antf.aj.equals(paramString))) && ((a(paramInt) != 1010) || (!antf.ak.equals(paramString))) && ((a(paramInt) != 1010) || (!antf.H.equals(paramString))) && ((a(paramInt) != 1010) || (!antf.aj.equals(paramString))) && ((a(paramInt) != 1032) || (!antf.aM.equals(paramString))) && ((a(paramInt) != 1044) || (!antf.aT.equals(paramString))) && ((a(paramInt) != 10008) || (!antf.aU.equals(paramString))))))) {
      return false;
    }
    return true;
  }
  ...
  public static String c(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord.istroop == 1) && (nlj.b(paramMessageRecord))) {
      return "80000000";
    }
    return paramMessageRecord.senderuin;
  }
  ...
  {
    return (d(paramMessageRecord)) && (!b(paramMessageRecord.frienduin, paramMessageRecord.istroop)) && (paramQQAppInterface.a().a(paramMessageRecord.frienduin));
  }
  ...
  {
    return (antf.al.equals(paramString)) || (antf.am.equals(paramString));
  }
  ...
  {
    return antf.an.equals(paramString);
  }
  ...
  {
    return antf.al.equals(paramString);
  }
  ...
  {
    return antf.am.equals(paramString);
  }
  ...
  {
    boolean bool2 = j(paramInt);
    boolean bool1 = bool2;
    if (!bool2) {
      bool1 = bcsa.a(paramInt);
    }
    return bool1;
  }
