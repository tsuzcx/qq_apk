  ...
  implements Handler.Callback
{
  ...
  public arpb(arou paramarou, ViewGroup paramViewGroup)
  {
    this.jdField_a_of_type_Arou = paramarou;
    this.jdField_a_of_type_AndroidViewView = paramarou.a().getLayoutInflater().inflate(2131560676, paramViewGroup, false);
    int i = View.MeasureSpec.makeMeasureSpec(0, 0);
    this.jdField_a_of_type_AndroidViewView.measure(i, i);
    TextView localTextView1 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373917);
    TextView localTextView2 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373915);
    paramViewGroup = (AsyncImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373916);
    String str = paramarou.a();
    i = paramarou.a();
    localTextView1.setText(arrr.a(str, true, localTextView1.getMeasuredWidth(), localTextView1.getPaint(), 1));
    localTextView2.setText(arso.a(paramarou.a()));
    paramViewGroup.setImageResource(arrr.b(str));
    if ((i == 5) || (i == 0))
    {
      paramarou = paramarou.b();
      if (arso.b(paramarou))
      {
        if (i != 5) {
          break label255;
        }
        paramViewGroup.setApkIconAsyncImage(paramarou);
      }
    }
    for (;;)
    {
      paramViewGroup.setSupportMaskView(false);
      ((AsyncImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373906)).setSupportMaskView(false);
      ...
      this.b = new bhsl(ThreadManagerV2.getFileThreadLooper(), this, false);
      return;
      label255:
      paramViewGroup.setAsyncImage(paramarou);
    }
  }
  ...
  private Bitmap a(Bitmap paramBitmap, int paramInt, String paramString)
  {
    ...
    localAsyncImageView = (AsyncImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373906);
    localAsyncImageView.setImageBitmap(paramBitmap);
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373919);
    BaseApplicationImpl localBaseApplicationImpl = BaseApplicationImpl.sApplication;
    if (TextUtils.isEmpty(paramString))
    {
      paramBitmap = new StringBuilder().append(BaseApplicationImpl.sApplication.getString(2131698538)).append(":");
      paramString = BaseApplicationImpl.sApplication;
      if (paramInt == 1) {
        paramInt = 2131698536;
      }
    }
    for (paramBitmap = paramString.getString(paramInt);; paramBitmap = BaseApplicationImpl.sApplication.getString(2131698539) + ":" + paramString)
    {
      localTextView.setText(localBaseApplicationImpl.getString(2131698529, new Object[] { paramBitmap }));
      try
      {
  ...
  private static String a(Bitmap paramBitmap)
  {
    ...
    try
    {
      paramBitmap = ybk.a(BaseApplicationImpl.sApplication, str, paramBitmap);
      return paramBitmap;
    }
  ...
  private void a(ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem, Bitmap paramBitmap, String paramString)
  {
    ...
    do
    {
      ...
      localObject = this.jdField_a_of_type_Arou.a();
    ...
    {
      arow.a(1, 2131696947, true);
      return;
    }
    if (paramString == null)
    {
      if (i == 39) {}
      for (i = 2131717630;; i = 2131696946)
      {
        arow.a(1, i, true);
        return;
      }
    ...
    case 2: 
      ...
      aryv.a((Activity)localObject, paramActionSheetItem, 1, -1);
      return;
    case 3: 
      ...
      bjdt.a((Activity)localObject, paramActionSheetItem, paramString, ((BaseActivity)localObject).getString(2131692303), ((BaseActivity)localObject).getString(2131698529, new Object[] { "" }), 2);
      return;
    case 9: 
    case 10: 
    ...
    case 39: 
      ...
      arow.a(2, ((BaseActivity)localObject).getString(2131717631, new Object[] { paramString }), true);
      return;
    }
    ...
    aryv.a((Activity)localObject, paramActionSheetItem, ForwardRecentTranslucentActivity.class, 1, -1, "");
  }
  ...
  private static String b(Bitmap paramBitmap)
  {
    ...
    //   22: dup
    //   23: getstatic 462	alof:bd	Ljava/lang/String;
    ...
    //   60: getstatic 462	alof:bd	Ljava/lang/String;
    ...
    //   118: getstatic 462	alof:bd	Ljava/lang/String;
  ...
  public void a(ShareActionSheetBuilder.ActionSheetItem paramActionSheetItem)
  {
    ...
    do
    {
      do
      {
        return;
        i = paramActionSheetItem.action;
        if ((i == 39) || (bdin.d(this.jdField_a_of_type_Arou.a()))) {
          break;
        }
    ...
    if (this.jdField_a_of_type_Bety == null)
    {
      this.jdField_a_of_type_Bety = new bety(this.jdField_a_of_type_Arou.a());
  ...
  public boolean a(Bitmap paramBitmap, int paramInt, String paramString)
  {
    ...
    if (paramBitmap == null)
    {
      arow.a(1, BaseApplicationImpl.sApplication.getResources().getString(2131698523, new Object[] { Integer.valueOf(-2) }), true);
      return false;
    }
    this.jdField_a_of_type_Arou.a(paramBitmap);
