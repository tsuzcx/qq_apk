...
public class bnlc
{
  ...
  static
  {
    jdField_a_of_type_JavaIoFile = a(new File(ajni.d), "qqstroy_follow_capture");
    d();
  }
  ...
  public static void a(String paramString, bnle parambnle)
  {
    ...
    for (;;)
    {
      ...
      if (!b(str2, str1))
      {
        ...
        localbaps.jdField_a_of_type_Bapx = new bnld(str2, str1, parambnle);
        localbaps.jdField_a_of_type_JavaLangString = paramString;
        localbaps.jdField_a_of_type_Int = 0;
        localbaps.jdField_c_of_type_JavaLangString = str2;
        localbaps.jdField_c_of_type_Int = bdee.a(baqx.a().a());
        try
        {
          parambnle = BaseApplicationImpl.getApplication().getRuntime();
          if (QQAppInterface.class.isInstance(parambnle))
          {
            ((QQAppInterface)parambnle).getNetEngine(0).a(localbaps);
  ...
  public boolean a()
  {
    return !TextUtils.isEmpty(urk.d());
  }
