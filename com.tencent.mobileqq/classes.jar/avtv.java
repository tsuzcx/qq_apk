...
public class avtv
  extends avrb
{
  public avtv(OCRTextSearchActivity paramOCRTextSearchActivity) {}
  ...
  public void a(int paramInt, String paramString, avsl paramavsl)
  {
    ...
    this.a.jdField_a_of_type_ComTencentMobileqqOcrUiSearchResultFragment.a(this.a.jdField_a_of_type_AndroidWidgetEditText.getText().toString(), paramInt, paramavsl);
    this.a.a(1);
    if ((paramInt == 0) && (paramavsl.a != null) && (paramavsl.a.size() > 0))
    {
      azmj.b(null, "dc00898", "", "", "0X80082E8", "0X80082E8", 0, 0, "", "", "", "");
      return;
    }
    azmj.b(null, "dc00898", "", "", "0X80082E7", "0X80082E7", 0, 0, "", "", "", "");
  }
}
