  ...
  extends RemoteCommand
{
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    case 5: 
          ...
          do
          {
            ...
            do
            {
              do
              {
                ...
                localSharedPreferences = bgmq.a(this.a, 1);
            ...
            babh.h(this.a, paramBundle);
            paramOnInvokeFinishLinstener.putString("result_key", babh.j(this.a, paramBundle));
            return paramOnInvokeFinishLinstener;
            paramBundle = paramBundle.getString("param_uin");
            paramOnInvokeFinishLinstener.putParcelable("result_key", this.a.a(paramBundle, true));
            return paramOnInvokeFinishLinstener;
            paramBundle = paramBundle.getString("param_uin");
            localObject = (ajjj)this.a.getManager(51);
          } while ((localObject == null) || (TextUtils.isEmpty(paramBundle)));
          paramBundle = ((ajjj)localObject).b(paramBundle);
      ...
      paramOnInvokeFinishLinstener.putString("result_key", Boolean.toString(ogy.a().a(paramBundle)));
      return paramOnInvokeFinishLinstener;
    case 6: 
      paramBundle = bgmq.a(this.a);
    ...
    case 7: 
      paramOnInvokeFinishLinstener.putString("result_key", obz.b());
      return paramOnInvokeFinishLinstener;
    }
    paramBundle = paramBundle.getString("param_uin");
    new ndv(this.a, paramBundle, this.a.getApp().getApplicationContext()).a();
