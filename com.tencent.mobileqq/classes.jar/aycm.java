  ...
  extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
  ...
  public aycm(RecyclerView.Adapter paramAdapter)
  {
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    if (this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt) != null) {
      return new aycn((View)this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt));
    }
    if (this.b.get(paramInt) != null) {
      return new aycn((View)this.b.get(paramInt));
    }
