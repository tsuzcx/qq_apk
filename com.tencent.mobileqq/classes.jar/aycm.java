  ...
  implements ayci
{
  ...
  public aycm(VideoData paramVideoData, QQAppInterface paramQQAppInterface)
  {
  ...
  public int a()
  {
    try
    {
      int i = Integer.parseInt("8.4.5".replace(".", ""));
      return i;
    }
  ...
  public void a(int paramInt, ayck paramayck)
  {
    ...
    nkm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new aycn(this, paramayck), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
  }
  
  public void a(Comments.Comment paramComment, aycj paramaycj)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ...
    if (a(localReqBody))
    {
      ...
      nkm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new aycp(this, paramaycj, paramComment), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
    }
    paramaycj.a(paramComment, -1);
  }
  
  public void a(Comments.Comment paramComment, aycl paramaycl)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      nkm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new ayco(this, paramaycl, paramComment), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
