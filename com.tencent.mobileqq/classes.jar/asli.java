...
public class asli
{
  private static asli jdField_a_of_type_Asli;
  private static byte[] jdField_a_of_type_ArrayOfByte = new byte[0];
  private Messenger jdField_a_of_type_AndroidOsMessenger;
  private anvi jdField_a_of_type_Anvi = new aslj(this);
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new aslk(this);
  
  public static asli a()
  {
    if (jdField_a_of_type_Asli == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Asli == null) {
        jdField_a_of_type_Asli = new asli();
      }
      return jdField_a_of_type_Asli;
    }
  }
  ...
  public static void a()
  {
    if (jdField_a_of_type_Asli != null) {
      synchronized (jdField_a_of_type_ArrayOfByte)
      {
        if ((jdField_a_of_type_Asli != null) && (jdField_a_of_type_Asli.jdField_a_of_type_JavaLangRefWeakReference != null))
        {
          QQAppInterface localQQAppInterface = (QQAppInterface)jdField_a_of_type_Asli.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (localQQAppInterface != null) {
            localQQAppInterface.removeObserver(jdField_a_of_type_Asli.jdField_a_of_type_Anvi);
          }
          jdField_a_of_type_Asli = null;
        }
        return;
      }
    }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    label30:
    for (int i = -1;; i = asll.a().a(localQQAppInterface, localQQAppInterface.getCurrentAccountUin(), null, paramArrayOfByte, this.jdField_a_of_type_MqqObserverWtloginObserver))
    {
      a(i);
      return;
    }
