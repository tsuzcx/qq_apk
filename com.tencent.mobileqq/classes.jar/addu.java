...
public class addu
{
  private static addu jdField_a_of_type_Addu;
  ...
  static
  {
    jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool = new RecyclablePool(addv.class, 4);
    jdField_b_of_type_ComTencentCommonsdkPoolRecyclablePool = new RecyclablePool(addw.class, 4);
  ...
  {
    if (jdField_a_of_type_Addu == null) {}
    try
    {
      if (jdField_a_of_type_Addu == null) {
        jdField_a_of_type_Addu = new addu();
      }
      return jdField_a_of_type_Addu;
    }
    finally {}
  }
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_Boolean)
      {
        ...
        try
        {
          ...
          if (localObject1 == null)
          {
            ...
            for (;;)
            {
              ...
              {
                localObject8 = (addv)localArrayList.get(i);
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            ...
            localObject2 = null;
            continue;
            if ((localObject2 instanceof addv))
            {
              localArrayList.add((addv)localObject2);
              localHashSet2.add(Integer.valueOf(((addv)localObject2).hashCode()));
            }
            for (;;)
            {
              i += 1;
              break;
              if ((localObject2 instanceof addw))
              {
                j = ((addw)localObject2).jdField_a_of_type_Int;
                if (localHashSet2.contains(Integer.valueOf(j))) {
                  localHashMap.put(Integer.valueOf(j), (addw)localObject2);
                } else {
                  ((addw)localObject2).recycle();
                }
              }
              else
              {
                ...
                bkfk.a("queueTask poll invalid object");
              }
            }
            a();
            continue;
            ...
            {
              ((addv)localObject8).jdField_d_of_type_Long = l3;
              ((addv)localObject8).jdField_g_of_type_Long = ((addw)localHashMap.get(Integer.valueOf(localObject8.hashCode()))).jdField_a_of_type_Long;
              localHashMap.remove(Integer.valueOf(localObject8.hashCode()));
            }
            l2 = ((addv)localObject8).jdField_d_of_type_Long - l3;
            if (l2 <= 0L)
            {
              if (HardCoderJNI.hcDebug) {
                Log.d("HardCoder.HCPerfManager", "InLoop STOP:" + i + "/" + localArrayList.size() + " task:" + ((addv)localObject8).a(l3));
              }
              localArrayList.remove(localObject8);
              localHashSet2.remove(Integer.valueOf(localObject8.hashCode()));
              ((addv)localObject8).recycle();
              j = i - 1;
            ...
            {
              l2 = Math.min(l1, l2);
              l1 = ((addv)localObject8).jdField_b_of_type_Long - l3;
              if (l1 > 0L)
              {
                if (HardCoderJNI.hcDebug) {
                  Log.d("HardCoder.HCPerfManager", "InLoop WAIT:" + i + "/" + localArrayList.size() + " task:" + ((addv)localObject8).a(l3));
                }
                l1 = Math.min(l2, l1);
                j = i;
                localObject9 = localObject2;
              ...
              {
                if (HardCoderJNI.hcDebug) {
                  Log.d("HardCoder.HCPerfManager", "InLoop  RUN:" + i + "/" + localArrayList.size() + " task:" + ((addv)localObject8).a(l3));
                }
                localObject7 = localObject2;
                if (((addv)localObject8).jdField_c_of_type_Int > 0) {
                  if ((localObject2 != null) && (localObject2.jdField_c_of_type_Int <= ((addv)localObject8).jdField_c_of_type_Int))
                  {
                    localObject7 = localObject2;
                    if (localObject2.jdField_c_of_type_Int == ((addv)localObject8).jdField_c_of_type_Int)
                    {
                      localObject7 = localObject2;
                      if (localObject2.jdField_d_of_type_Long >= ((addv)localObject8).jdField_d_of_type_Long) {}
                    }
                  }
                  else
                  {
                ...
                if (((addv)localObject8).jdField_d_of_type_Int > 0) {
                  if ((localObject3 != null) && (localObject3.jdField_d_of_type_Int <= ((addv)localObject8).jdField_d_of_type_Int))
                  {
                    localObject2 = localObject3;
                    if (localObject3.jdField_d_of_type_Int == ((addv)localObject8).jdField_d_of_type_Int)
                    {
                      localObject2 = localObject3;
                      if (localObject3.jdField_d_of_type_Long >= ((addv)localObject8).jdField_d_of_type_Long) {}
                    }
                  }
                  else
                  {
                ...
                if (((addv)localObject8).jdField_e_of_type_Int > 0)
                {
          ...
          for (localObject7 = "null";; localObject7 = localObject3.a(l3))
          {
            ...
            break;
            localObject7 = ((addv)localObject4).a(l3);
            break label1091;
            localObject7 = localObject2.a(l3);
            break label1116;
            localObject7 = ((addv)localObject5).a(l3);
            break label1157;
          }
          l2 = 0L;
          j = 0;
          ...
          if (i > 0)
          {
            ...
            {
              localObject9 = (addv)((Iterator)localObject7).next();
              Log.i("HardCoder.HCPerfManager", "!cancelBindCore task:" + ((addv)localObject9).a(l3));
              if ((((addv)localObject9).jdField_d_of_type_Long <= l3) || (HardCoderJNI.checkEnv))
              {
                if (((addv)localObject9).jdField_e_of_type_Int == 0)
                {
                  if (!HardCoderJNI.checkEnv) {
                    break label1799;
                  }
                  bkfk.a("bindTid:" + ((addv)localObject9).jdField_e_of_type_Int);
                }
                localObject6[i] = ((addv)localObject9).jdField_e_of_type_Int;
                i += 1;
              }
              else
              {
          ...
          for (;;)
          {
            ...
            for (;;)
            {
              ...
              localObject7 = (addv)((Iterator)localObject6).next();
              Log.i("HardCoder.HCPerfManager", "requestBindCore task:" + ((addv)localObject7).a(l3));
              if (((addv)localObject7).jdField_d_of_type_Long <= l3)
              {
                if (!HardCoderJNI.checkEnv) {
                  break;
                }
                bkfk.a("stopTime:" + (((addv)localObject7).jdField_d_of_type_Long - l3));
              }
              if (((addv)localObject7).jdField_e_of_type_Int == 0)
              {
                if (!HardCoderJNI.checkEnv) {
                  break label2380;
                }
                bkfk.a("bindTid:" + ((addv)localObject7).jdField_e_of_type_Int);
              }
              localObject9[m] = ((addv)localObject7).jdField_e_of_type_Int;
              m += 1;
              k = ((addv)localObject7).jdField_f_of_type_Int;
              l2 = ((addv)localObject7).jdField_a_of_type_Long;
              j = ((addv)localObject7).jdField_g_of_type_Int;
              i = Math.min((int)(((addv)localObject7).jdField_d_of_type_Long - l3), i);
            }
            a();
          }
          a();
        ...
        if (localObject3 == null)
        {
          if (localObject5 != null)
          {
            Log.i("HardCoder.HCPerfManager", "!cancelHighIOFreq task:" + ((addv)localObject5).a(l3));
            if ((!jdField_a_of_type_Boolean) && (HardCoderJNI.checkEnv)) {
              HardCoderJNI.cancelHighIOFreq(((addv)localObject5).jdField_g_of_type_Int, SystemClock.elapsedRealtimeNanos());
            }
          }
          if (localObject3 == null) {
            break label3670;
      ...
      for (;;)
      {
        ...
        if (localObject2 == null)
        {
          if (localObject4 != null)
          {
            Log.i("HardCoder.HCPerfManager", "!cancelCpuHighFreq task:" + ((addv)localObject4).a(l3));
            if ((!jdField_a_of_type_Boolean) && (HardCoderJNI.checkEnv)) {
              HardCoderJNI.cancelCpuHighFreq(((addv)localObject4).jdField_g_of_type_Int, SystemClock.elapsedRealtimeNanos());
            }
          }
          if (localObject2 == null) {
            break label3652;
        ...
        for (;;)
        {
          ...
          for (boolean bool = true;; bool = false)
          {
            ...
            if (localObject5 == null) {}
            for (localObject5 = "null";; localObject5 = ((addv)localObject5).a(l3))
            {
            ...
            if (localObject4 == null) {}
            for (localObject4 = "null";; localObject4 = ((addv)localObject4).a(l3))
            {
          ...
          if (localObject2 == localObject2)
          {
            ...
            localObject4 = (addv)localArrayList.get(k);
            if (HardCoderJNI.hcDebug) {
              Log.d("HardCoder.HCPerfManager", "CheckTask:" + k + "/" + localArrayList.size() + " task:" + ((addv)localObject4).a(l3));
            }
            if ((((addv)localObject4).jdField_c_of_type_Int <= 0) && (((addv)localObject4).jdField_d_of_type_Int <= 0) && (((addv)localObject4).jdField_e_of_type_Int <= 0)) {
              break label3225;
            }
            bool = true;
            bkfk.a(bool);
            if ((((addv)localObject4).jdField_a_of_type_Long <= 0L) && (((addv)localObject4).jdField_f_of_type_Int <= 0)) {
              break label3231;
            }
            bool = true;
            bkfk.a(bool);
            localObject5 = "taskInintTime:" + (((addv)localObject4).jdField_c_of_type_Long - l3);
            if (((addv)localObject4).jdField_c_of_type_Long > l3) {
              break label3237;
            }
            bool = true;
            bkfk.a((String)localObject5, bool);
            localObject5 = "taskStopTime:" + (((addv)localObject4).jdField_d_of_type_Long - l3);
            if (((addv)localObject4).jdField_d_of_type_Long < l3) {
              break label3243;
            }
            bool = true;
            bkfk.a((String)localObject5, bool);
            ...
            label3052:
            bkfk.a((String)localObject5, bool);
            if (((addv)localObject4).jdField_b_of_type_Long <= l3) {
              break label3279;
            }
            ...
            bool = true;
            bkfk.a(bool);
            localObject5 = "next:" + l1 + " start:" + (((addv)localObject4).jdField_b_of_type_Long - l3);
            if (l1 > ((addv)localObject4).jdField_b_of_type_Long - l3) {
              break label3273;
            }
            bool = true;
            label3175:
          ...
          do
          {
            ...
            bool = false;
            break label3175;
            localObject5 = "nextWake:" + l1 + " stop:" + (((addv)localObject4).jdField_d_of_type_Long - l3);
            if (l1 > ((addv)localObject4).jdField_d_of_type_Long - l3) {
              break label3600;
            }
            bool = true;
            bkfk.a((String)localObject5, bool);
            ...
            bool = true;
            bkfk.a((String)localObject5, bool);
            localObject5 = "reqTimeStamp:" + j + " stop:" + (((addv)localObject4).jdField_d_of_type_Long - l3);
            if (j > ((addv)localObject4).jdField_d_of_type_Long - l3) {
              break label3612;
            }
            bool = true;
            bkfk.a((String)localObject5, bool);
            localObject5 = "reqCpu:" + i + " task:" + ((addv)localObject4).jdField_c_of_type_Int;
            if (i > ((addv)localObject4).jdField_c_of_type_Int) {
              break label3618;
            }
            bool = true;
            bkfk.a((String)localObject5, bool);
            localObject5 = "reqIO:" + m + " task:" + ((addv)localObject4).jdField_d_of_type_Int;
            if (m > ((addv)localObject4).jdField_d_of_type_Int) {
              break label3624;
            }
            bool = true;
            bkfk.a((String)localObject5, bool);
          } while (((addv)localObject4).jdField_e_of_type_Int <= 0);
          label3444:
          bkfk.a(localHashSet1.contains(localObject4));
          label3554:
  ...
  {
    addv localaddv = (addv)jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool.obtain(addv.class);
    localaddv.jdField_a_of_type_Int = paramInt1;
    localaddv.jdField_c_of_type_Int = paramInt2;
    localaddv.jdField_d_of_type_Int = paramInt3;
    localaddv.jdField_e_of_type_Int = paramInt4;
    localaddv.jdField_b_of_type_Int = paramInt5;
    localaddv.jdField_f_of_type_Int = paramInt6;
    localaddv.jdField_a_of_type_Long = paramLong;
    localaddv.jdField_g_of_type_Int = paramInt7;
    localaddv.jdField_c_of_type_Long = System.currentTimeMillis();
    localaddv.jdField_b_of_type_Long = (localaddv.jdField_c_of_type_Long + paramInt1);
    localaddv.jdField_d_of_type_Long = (localaddv.jdField_c_of_type_Long + paramInt1 + paramInt5);
    localaddv.jdField_a_of_type_JavaLangString = paramString;
    localaddv.jdField_e_of_type_Long = localaddv.jdField_b_of_type_Long;
    localaddv.jdField_f_of_type_Long = localaddv.jdField_c_of_type_Long;
    if ((paramInt1 < 0) || (paramInt2 < 0) || (paramInt3 < 0) || (paramInt4 < 0) || (paramInt5 <= 0) || ((paramInt2 == 0) && (paramInt3 == 0) && (paramInt4 == 0)))
    {
      Log.e("HardCoder.HCPerfManager", "ErrorParam task:" + localaddv.a(localaddv.jdField_c_of_type_Long));
      return 0;
    }
    boolean bool = this.jdField_a_of_type_JavaUtilConcurrentLinkedBlockingQueue.offer(localaddv);
    if (HardCoderJNI.hcDebug) {
      Log.d("HardCoder.HCPerfManager", "OutCallAddTask ret:" + bool + " task:" + localaddv.a(localaddv.jdField_c_of_type_Long));
    }
    if (bool) {
      return localaddv.hashCode();
    }
    return 0;
  }
  ...
  {
    addw localaddw = (addw)jdField_b_of_type_ComTencentCommonsdkPoolRecyclablePool.obtain(addw.class);
    localaddw.jdField_a_of_type_Long = System.currentTimeMillis();
    localaddw.jdField_a_of_type_Int = paramInt;
    if (paramInt != 0) {}
    for (boolean bool = this.jdField_a_of_type_JavaUtilConcurrentLinkedBlockingQueue.offer(localaddw);; bool = false)
    {
      if (HardCoderJNI.hcDebug) {
