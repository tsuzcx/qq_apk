  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public ahvq(QQAppInterface paramQQAppInterface, Context paramContext, ArrayList<String> paramArrayList, int paramInt)
  {
  ...
  protected Integer a(Void... paramVarArgs)
  {
    ...
    //   184: putfield 22	ahvq:jdField_a_of_type_Long	J
    ...
    //   190: astore 8
    //   192: aload_0
    //   193: getfield 33	ahvq:jdField_b_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   208: checkcast 144	ahux
    //   211: invokevirtual 147	ahux:a	()Lcom/tencent/mobileqq/data/MessageForShortVideo;
    //   214: astore 7
    //   216: aload 7
    //   218: ifnonnull +8 -> 226
    //   221: iconst_5
    ...
    //   239: aload_0
    //   240: getfield 35	ahvq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   267: aload_0
    //   268: getfield 35	ahvq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   283: aload_0
    //   284: getfield 33	ahvq:jdField_b_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   313: invokestatic 177	com/tencent/mobileqq/utils/FileUtils:fileExistsAndNotEmpty	(Ljava/lang/String;)Z
    //   316: ifeq +274 -> 590
    ...
    //   333: aload 7
    //   335: getfield 182	com/tencent/mobileqq/data/MessageForShortVideo:md5	Ljava/lang/String;
    //   338: invokestatic 188	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   341: ifeq +82 -> 423
    //   344: aload 7
    //   346: aload_0
    //   347: getfield 189	ahvq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   350: putfield 182	com/tencent/mobileqq/data/MessageForShortVideo:md5	Ljava/lang/String;
    //   353: aload 7
    //   355: ldc 191
    //   357: invokestatic 197	com/tencent/mobileqq/shortvideo/ShortVideoUtils:getShortVideoSavePath	(Lcom/tencent/mobileqq/data/MessageForShortVideo;Ljava/lang/String;)Ljava/lang/String;
    //   360: astore_1
    //   361: aload 8
    //   363: aload_1
    //   364: invokevirtual 203	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   367: ifne +41 -> 408
    //   370: aload 8
    //   372: aload_1
    //   373: invokestatic 207	com/tencent/mobileqq/utils/FileUtils:rename	(Ljava/lang/String;Ljava/lang/String;)Z
    //   376: pop
    ...
    //   405: invokestatic 212	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   408: aload_1
    //   409: putstatic 214	com/tencent/mobileqq/activity/bless/BlessSelectMemberActivity:b	Ljava/lang/String;
    //   412: aload 7
    //   414: aload_1
    //   415: putfield 171	com/tencent/mobileqq/data/MessageForShortVideo:videoFileName	Ljava/lang/String;
    //   418: aload 7
    //   420: invokevirtual 217	com/tencent/mobileqq/data/MessageForShortVideo:serial	()V
    //   423: aload 6
    //   425: ifnull +519 -> 944
    //   428: invokestatic 219	com/tencent/mobileqq/activity/bless/BlessSelectMemberActivity:b	()Z
    //   431: ifne +513 -> 944
    //   434: iconst_0
    //   435: iconst_3
    //   436: invokestatic 224	bbqf:a	(II)Lbbqx;
    //   439: astore_1
    //   440: aload 7
    //   442: aload_1
    //   443: invokestatic 227	bbqf:a	(Ljava/lang/Object;Lbbqx;)Lbbrp;
    //   446: astore 5
    //   448: aload 5
    //   450: iconst_0
    //   451: putfield 232	bbrp:a	Z
    //   454: aload 5
    //   456: iconst_1
    //   457: putfield 234	bbrp:d	Z
    //   460: aload 5
    //   462: getfield 237	bbrp:r	Ljava/lang/String;
    //   465: ifnull +32 -> 497
    //   468: aload 5
    //   470: getfield 237	bbrp:r	Ljava/lang/String;
    //   473: invokevirtual 240	java/lang/String:length	()I
    //   476: bipush 39
    //   478: if_icmpne +19 -> 497
    //   481: aload 5
    //   483: aload 5
    //   485: getfield 237	bbrp:r	Ljava/lang/String;
    //   488: iconst_0
    //   489: bipush 28
    //   491: invokevirtual 244	java/lang/String:substring	(II)Ljava/lang/String;
    //   494: putfield 237	bbrp:r	Ljava/lang/String;
    //   497: aload_1
    //   498: aload 5
    //   500: invokevirtual 249	bbqx:a	(Lbbrp;)V
    //   503: aload_1
    //   504: aload 6
    //   506: invokestatic 252	bbqf:a	(Lbbqx;Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   509: aload_0
    //   510: invokestatic 131	java/lang/System:currentTimeMillis	()J
    //   513: putfield 24	ahvq:jdField_b_of_type_Long	J
    ...
    //   537: aload 7
    //   539: getfield 257	com/tencent/mobileqq/data/MessageForShortVideo:uniseq	J
    ...
    //   551: aload 7
    //   553: invokevirtual 262	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   556: ldc_w 264
    //   559: invokevirtual 95	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   562: aload_0
    //   563: getfield 24	ahvq:jdField_b_of_type_Long	J
    //   566: aload_0
    //   567: getfield 22	ahvq:jdField_a_of_type_Long	J
    //   570: lsub
    //   571: l2d
    //   572: ldc2_w 265
    //   575: ddiv
    //   576: invokevirtual 269	java/lang/StringBuilder:append	(D)Ljava/lang/StringBuilder;
    //   579: invokevirtual 112	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   582: invokestatic 212	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   585: iconst_1
    //   586: invokestatic 121	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   589: areturn
    //   590: aload 8
    //   592: invokestatic 177	com/tencent/mobileqq/utils/FileUtils:fileExistsAndNotEmpty	(Ljava/lang/String;)Z
    //   595: ifne +24 -> 619
    ...
    //   618: areturn
    //   619: new 273	java/io/File
    //   622: dup
    //   623: aload 8
    //   625: invokespecial 276	java/io/File:<init>	(Ljava/lang/String;)V
    //   628: astore 5
    //   630: aload 5
    //   632: invokevirtual 278	java/io/File:length	()J
    //   635: lstore_2
    //   636: lload_2
    //   637: lconst_0
    //   638: lcmp
    ...
    //   661: areturn
    //   662: new 282	java/io/FileInputStream
    //   665: dup
    //   666: aload 5
    //   668: invokespecial 285	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   671: astore 5
    //   673: aload 5
    //   675: ifnull +196 -> 871
    //   678: aload 5
    //   680: lload_2
    //   681: invokestatic 291	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   684: invokestatic 297	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   687: astore 5
    //   689: aload 5
    //   691: astore_1
    //   692: aload 5
    //   694: invokestatic 188	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   697: ifeq +174 -> 871
    ...
    //   738: astore 5
    //   740: aload 5
    //   742: invokevirtual 302	java/io/FileNotFoundException:printStackTrace	()V
    //   745: iconst_0
    //   746: ifeq +125 -> 871
    //   749: aconst_null
    //   750: lload_2
    //   751: invokestatic 291	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   754: invokestatic 297	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   757: astore 5
    //   759: aload 5
    //   761: astore_1
    //   762: aload 5
    //   764: invokestatic 188	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   767: ifeq +104 -> 871
    ...
    //   813: aconst_null
    //   814: lload_2
    //   815: invokestatic 291	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   818: invokestatic 297	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   821: astore 5
    //   823: aload 5
    //   825: invokestatic 188	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   828: ifeq +41 -> 869
    ...
    //   871: aload_0
    //   872: aload_1
    //   873: putfield 189	ahvq:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   876: aload 7
    //   878: lload_2
    //   879: l2i
    //   880: putfield 305	com/tencent/mobileqq/data/MessageForShortVideo:videoFileSize	I
    //   883: aload 7
    //   885: getfield 308	com/tencent/mobileqq/data/MessageForShortVideo:mThumbFilePath	Ljava/lang/String;
    //   888: invokestatic 177	com/tencent/mobileqq/utils/FileUtils:fileExistsAndNotEmpty	(Ljava/lang/String;)Z
    //   891: ifeq -558 -> 333
    //   894: aload 7
    //   896: getfield 311	com/tencent/mobileqq/data/MessageForShortVideo:thumbMD5	Ljava/lang/String;
    //   899: ldc_w 313
    //   902: invokestatic 317	com/tencent/mobileqq/shortvideo/ShortVideoUtils:getShortVideoThumbPicPath	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   905: astore_1
    //   906: aload_1
    //   907: aload 7
    //   909: getfield 308	com/tencent/mobileqq/data/MessageForShortVideo:mThumbFilePath	Ljava/lang/String;
    //   912: invokevirtual 203	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   915: ifne -582 -> 333
    //   918: aload_1
    //   919: aload 7
    //   921: getfield 308	com/tencent/mobileqq/data/MessageForShortVideo:mThumbFilePath	Ljava/lang/String;
    //   924: invokestatic 207	com/tencent/mobileqq/utils/FileUtils:rename	(Ljava/lang/String;Ljava/lang/String;)Z
    //   927: ifne +8 -> 935
    //   930: iconst_3
    ...
    //   935: aload 7
    //   937: aload_1
    //   938: putfield 308	com/tencent/mobileqq/data/MessageForShortVideo:mThumbFilePath	Ljava/lang/String;
    //   941: goto -608 -> 333
    ...
    //   975: aload_1
    //   976: iload 4
    //   978: invokevirtual 322	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   981: ldc_w 324
    //   984: invokevirtual 95	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   987: invokestatic 219	com/tencent/mobileqq/activity/bless/BlessSelectMemberActivity:b	()Z
    //   990: invokevirtual 322	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   993: invokevirtual 112	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   996: invokestatic 212	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   999: goto -414 -> 585
    //   1002: iconst_0
    //   1003: istore 4
    //   1005: goto -33 -> 972
  ...
  protected void a(Integer paramInteger)
  {
    ...
    ahuz.a("bless_event_ptv_result", localProperties);
    ...
    for (;;)
    {
      ...
      return;
      BlessSelectMemberActivity.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718488, true);
      continue;
      BlessSelectMemberActivity.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718483, true);
      continue;
      BlessSelectMemberActivity.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718454, true);
      continue;
      BlessSelectMemberActivity.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718480, true);
      continue;
      BlessSelectMemberActivity.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718484);
      continue;
      BlessSelectMemberActivity.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131718481, true);
    }
  }
