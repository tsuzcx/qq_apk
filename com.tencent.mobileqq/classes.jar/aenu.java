  ...
  implements aeng, aenz
{
  ...
  public aenu(QQAppInterface paramQQAppInterface, aeob paramaeob, Context paramContext, XPanelContainer paramXPanelContainer, List<QQOperationViopTipTask> paramList, SessionInfo paramSessionInfo, acka paramacka)
  {
  ...
  private void b(QQOperationViopTipTask paramQQOperationViopTipTask)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Aeob.a(this, new Object[] { paramQQOperationViopTipTask });
      return;
      i = 0;
    }
  }
  ...
  public View a(Object... paramVarArgs)
  {
    if ((paramVarArgs[0] instanceof QQOperationViopTipTask))
    {
      ...
      View localView = LayoutInflater.from((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).inflate(2131495058, null);
      TextView localTextView = (TextView)localView.findViewById(2131307246);
      Button localButton = (Button)localView.findViewById(2131307243);
      localTextView.setText(paramVarArgs.adwords);
      localButton.setText(paramVarArgs.clickableWord);
      localButton.setOnClickListener(new aenv(this, paramVarArgs));
      return localView;
    }
    return null;
  }
  ...
  public MessageRecord a(Object... paramVarArgs)
  {
    ...
    {
      paramVarArgs = (QQOperationViopTipTask)paramVarArgs[0];
      MessageRecord localMessageRecord = awbi.a(-1041);
      long l = awao.a();
  ...
  {
    amnb localamnb = amnb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    ...
    for (;;)
    {
      ...
      if (paramList.hasNext())
      {
        ...
        localQQOperationViopTipTask = localamnb.a(i);
      ...
      for (;;)
      {
        ...
        if ((!localQQOperationViopTipTask.isGryTipsTask()) || (localamnb.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 2))) {
          break;
        }
