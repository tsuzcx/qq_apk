...
public class mrf
{
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, String paramString1, int paramInt1, long paramLong2, long paramLong3, long paramLong4, String paramString2, long paramLong5, List<String> paramList, String paramString3, long paramLong6, int paramInt2, String paramString4, mrj parammrj)
  {
    ...
    paramString1 = new NewIntent(paramQQAppInterface.getApplication(), mmi.class);
    paramString1.putExtra("cmd", "OidbSvc.0x79b_1");
    paramString1.putExtra("data", paramString2.toByteArray());
    paramString1.setObserver(new mrh(paramQQAppInterface, parammrj));
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, mmn parammmn)
  {
    ...
    mmj.b(paramQQAppInterface, parammmn, localReqBody.toByteArray(), "OidbSvc.0x6f6_0", 1782, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, mri parammri)
  {
    ...
    localObject = new NewIntent(paramQQAppInterface.getApplication(), mmi.class);
    ((NewIntent)localObject).putExtra("cmd", "OidbSvc.0x79a_1");
    ((NewIntent)localObject).putExtra("data", localOIDBSSOPkg.toByteArray());
    ((NewIntent)localObject).setObserver(new mrg(paramQQAppInterface, parammri));
    paramQQAppInterface.startServlet((NewIntent)localObject);
  }
  
  private static void b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, mri parammri)
  {
    try
    {
  ...
  private static void b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, mrj parammrj)
  {
    try
    {
      paramQQAppInterface = new oidb_sso.OIDBSSOPkg();
      ...
      if ((paramQQAppInterface == null) || (!paramQQAppInterface.uint32_result.has()) || (paramQQAppInterface.uint32_result.get() != 0) || (!paramQQAppInterface.bytes_bodybuffer.has()) || (paramQQAppInterface.bytes_bodybuffer.get() == null))
      {
        parammrj.a(paramQQAppInterface.str_error_msg.get());
        return;
      }
      parammrj.a();
      return;
