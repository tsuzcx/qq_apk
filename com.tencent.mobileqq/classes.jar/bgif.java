...
public class bgif
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localaoep.e(Long.valueOf(paramString).longValue());
      bglm.a(paramQQAppInterface, paramString, 1102858908);
      ChatActivityUtils.a(paramQQAppInterface, paramString, Integer.valueOf(0));
      return;
    }
    ThreadManager.post(new TroopAioNotifyManager.1(paramQQAppInterface, paramString, localaoep), 8, null, true);
  }
