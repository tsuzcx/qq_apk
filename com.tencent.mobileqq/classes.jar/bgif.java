...
public class bgif
{
  public static bgdf a;
  static CustomWebView jdField_a_of_type_ComTencentBizPubaccountCustomWebView;
  static String jdField_a_of_type_JavaLangString;
  
  static
  {
    jdField_a_of_type_Bgdf = new bgig();
  }
  
  private static int a(Context paramContext, String paramString, int paramInt, bbac parambbac)
  {
    int i = 2;
  ...
  public static void a(Context paramContext, bbac parambbac)
  {
    parambbac = babr.a(paramContext, 0);
    parambbac.setMessage(paramContext.getString(2131654369));
    parambbac.setPositiveButton(paramContext.getString(2131626337), new bgih(paramContext));
    parambbac.setNegativeButton(paramContext.getString(2131627735), new bgii(parambbac));
    try
    {
      if (!parambbac.isShowing()) {
        parambbac.show();
      }
      return;
    }
  ...
  /* Error */
  private static void a(bbac parambbac, String paramString)
  {
    // Byte code:
    //   0: iconst_m1
    //   1: istore_3
    ...
    //   110: pop
    //   111: aload_0
    //   112: invokevirtual 300	bbac:a	()Landroid/app/Activity;
    //   115: astore_0
    //   116: aload_0
    //   117: ifnull -111 -> 6
    //   120: aload_0
  ...
  static void a(bbac parambbac, String... paramVarArgs)
  {
    if ((parambbac != null) && (parambbac.a() != null) && (paramVarArgs != null) && (paramVarArgs.length > 0)) {
      try
      {
        Object localObject1 = parambbac.a(parambbac.a());
        ...
        jdField_a_of_type_ComTencentBizPubaccountCustomWebView = parambbac.a();
        ...
        paramVarArgs = new QZoneWebViewJsHandleLogic.2(parambbac, localHashMap, str2, str3, paramVarArgs, str1, (String)localObject1);
        if (TextUtils.isEmpty((CharSequence)localObject2))
        {
          paramVarArgs.run();
          return;
        }
        ThreadManager.post(new QZoneWebViewJsHandleLogic.3((String)localObject2, localHashMap, parambbac, paramVarArgs), 8, null, false);
        return;
      }
      catch (Exception parambbac)
      {
        QZLog.e("QZoneWebViewJsHandleLogic", "shareMiniProgramFromQzone error", parambbac);
      }
    }
  }
  
  private static void a(WebViewPlugin paramWebViewPlugin, bbac parambbac, String... paramVarArgs)
  {
    if ((paramVarArgs == null) || (parambbac == null) || (paramVarArgs.length <= 0)) {}
    Object localObject5;
    Object localObject2;
    Object localObject3;
    Object localObject4;
    ...
    do
    {
      do
      {
        do
        {
          for (;;)
          {
            ...
            try
            {
              ...
              paramVarArgs = parambbac.a().getUrl();
              if (!bgga.a().a(paramVarArgs, (String)localObject1))
              {
            ...
            if (bool)
            {
              ...
              try
              {
                if (((String)localObject2).indexOf("uin=") != -1)
                {
                  ...
                  bfpr.a((Activity)localObject4, bfpy.a(), paramWebViewPlugin, 0, 0, 0);
                  return;
                }
              }
        ...
        parambbac = parambbac.a((Activity)localObject4);
        if (!(parambbac instanceof bbad)) {
          break label1043;
        }
        i = ((bbad)parambbac).switchRequestCode(paramWebViewPlugin, (byte)3);
        if (TextUtils.isEmpty(paramVarArgs))
        {
          bfpr.a((Activity)localObject4, bfpy.a(), (String)localObject1, i);
          return;
        }
        bfpr.a((Activity)localObject4, bfpy.a(), (String)localObject1, i, paramVarArgs);
        return;
      ...
      localObject6 = parambbac.a((Activity)localObject4);
      if (!(localObject6 instanceof bbad)) {
        break label1048;
      }
      i = ((bbad)localObject6).switchRequestCode(paramWebViewPlugin, (byte)3);
      paramWebViewPlugin = bfpy.a();
      paramWebViewPlugin.jdField_a_of_type_JavaLangString = parambbac.a().getAccount();
      parambbac = new Bundle();
      parambbac.putString("source", paramVarArgs.getQueryParameter("source"));
      parambbac.putString("bypassparam", paramVarArgs.getQueryParameter("bypassparam"));
      parambbac.putAll(localBundle);
      bfpr.a((Activity)localObject4, paramWebViewPlugin, (String)localObject1, (String)localObject2, (String)localObject3, (String)localObject5, i, parambbac);
      return;
      if (!"mqzone://arouse/dynamicnickname".equalsIgnoreCase((String)localObject2)) {
        break;
      }
    } while ((parambbac == null) || (parambbac.a() == null) || (parambbac.a() == null));
    label645:
    bfpr.a(parambbac.a(), parambbac.a().getAccount());
    return;
    if (((String)localObject2).startsWith("mqzone://arouse/uploadphoto"))
    {
      bfpr.a(paramWebViewPlugin, parambbac, parambbac.a(), parambbac.a().getAccount(), (String)localObject2);
      return;
    }
    if ((((String)localObject2).startsWith("mqzone://arouse/facade")) || (((String)localObject2).startsWith("mqzonev2://arouse/facade")))
    {
      a(parambbac.a(), (String)localObject2, 81, parambbac);
      return;
    }
    if (((String)localObject2).startsWith("mqzone://arouse/moodVoiceRecord"))
    {
      bfpr.b(paramWebViewPlugin, parambbac, parambbac.a(), parambbac.a().getAccount(), (String)localObject2);
      return;
    }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        i = bgij.a(paramWebViewPlugin, parambbac, 4);
        bfpr.a((Activity)localObject4, bfpy.a(), paramVarArgs, i, bool);
        return;
      }
      bfpr.a((Activity)localObject4, bfpy.a(), paramVarArgs, -1, bool);
      return;
      label1012:
  ...
  public static boolean a(WebViewPlugin paramWebViewPlugin, bbac parambbac, String paramString, String... paramVarArgs)
  {
    if ("updateFeedContainer".equalsIgnoreCase(paramString)) {
      f(parambbac, paramVarArgs);
    }
    do
    {
      return true;
  ...
  private static void b(bbac parambbac, String... paramVarArgs)
  {
    if ((parambbac != null) && (parambbac.a() != null) && (paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      parambbac = new Intent("qzone.pickgamemates");
      parambbac.putExtra("gamemates", paramVarArgs[0]);
      BaseApplicationImpl.getApplication().sendBroadcast(parambbac);
      if (QLog.isColorLevel()) {
  ...
  private static void c(bbac parambbac, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      parambbac = new Intent("updateIsSpecialFollow");
      parambbac.putExtra("isSpecialFollow", i);
      BaseApplicationImpl.getApplication().sendBroadcast(parambbac);
      if (QLog.isColorLevel()) {
    ...
    {
      QLog.e("QZoneWebViewJsHandleLogic", 1, "handleUpdateIsSpecialFollow catch an exception. ", parambbac);
    }
  }
  ...
  private static void d(bbac parambbac, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      parambbac = new Intent("showFollowActionSheet");
      parambbac.putExtra("followStatus", i);
      BaseApplicationImpl.getApplication().sendBroadcast(parambbac);
      if (QLog.isColorLevel()) {
        QLog.d("QZoneWebViewJsHandleLogic", 1, "followStatus = " + i);
      }
    ...
    {
      QLog.e("QZoneWebViewJsHandleLogic", 1, "handleShowFollowActionSheet catch an exception. ", parambbac);
    }
  }
  
  private static void e(bbac parambbac, String... paramVarArgs)
  {
    Activity localActivity;
    if ((parambbac != null) && (parambbac.a() != null) && (paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      localActivity = parambbac.a();
      if (bady.a(localActivity, "com.tencent.weishi"))
      {
        parambbac = "";
        try
        {
          paramVarArgs = new JSONObject(paramVarArgs[0]).optString("schema");
          parambbac = paramVarArgs;
          if (!TextUtils.isEmpty(paramVarArgs))
          {
            parambbac = paramVarArgs;
            Intent localIntent = new Intent();
        ...
        {
          QLog.e("QZoneWebViewJsHandleLogic", 1, "handleClickWeiShiWidget catch an exception. weishi schema is " + parambbac, paramVarArgs);
          return;
        }
      }
    }
  ...
  private static void f(bbac parambbac, String... paramVarArgs)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            if (!(parambbac.a().getParent() instanceof RelativeLayout)) {
              continue;
            }
            ((RelativeLayout)parambbac.a().getParent()).setVisibility(8);
          }
        }
        catch (JSONException parambbac)
        {
          QLog.e("QZoneWebViewJsHandleLogic", 1, parambbac, new Object[0]);
          return;
        }
      }
    } while (!(parambbac.a().getParent() instanceof RelativeLayout));
    ((RelativeLayout)parambbac.a().getParent()).setVisibility(0);
  }
  
  private static void g(bbac parambbac, String... paramVarArgs)
  {
    if ((paramVarArgs == null) || (paramVarArgs.length <= 0)) {}
    for (;;)
    {
      ...
      try
      {
        ...
        if (((JSONObject)localObject).getInt("success") == 1)
        {
          ...
          if ((paramVarArgs != null) && (paramVarArgs.length() > 0) && (localJSONArray != null) && (localJSONArray.length() == paramVarArgs.length()))
          {
            ...
            parambbac.a().setResult(-1, localIntent);
            parambbac.a().finish();
            if (QLog.isColorLevel())
            {
  ...
  private static void h(bbac parambbac, String... paramVarArgs)
  {
    if ((paramVarArgs == null) || (paramVarArgs.length <= 0)) {
      return;
    }
  ...
  private static void i(bbac parambbac, String... paramVarArgs)
  {
    if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
      try
      {
        ...
        try
        {
          ...
          if (!TextUtils.isEmpty(str1)) {
            ((StringBuilder)localObject2).append(bcgl.b).append("=").append(str1);
          }
          if (!TextUtils.isEmpty(paramVarArgs)) {
            ((StringBuilder)localObject2).append("&").append(bcgl.f).append("=").append(paramVarArgs);
          }
          if (!TextUtils.isEmpty((CharSequence)localObject1)) {
            ((StringBuilder)localObject2).append("&").append(bcgl.c).append("=").append((String)localObject1);
          }
          if (!TextUtils.isEmpty(str2)) {
            ((StringBuilder)localObject2).append("&").append(bcgl.d).append("=").append(str2);
          }
          if (!TextUtils.isEmpty(str3)) {
            ((StringBuilder)localObject2).append("&").append(bcgl.i).append("=").append(str3);
          }
          if (!TextUtils.isEmpty(str4)) {
            ((StringBuilder)localObject2).append("&").append(bcgl.e).append("=").append(str4);
          }
          if (!TextUtils.isEmpty(str5)) {
            ((StringBuilder)localObject2).append("&").append(bcgl.B).append("=").append(str5);
          }
          ...
          bfpr.a((Bundle)localObject1);
          bcau.a(parambbac.a(), (Bundle)localObject1);
          return;
        }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e("QZoneWebViewJsHandleLogic", 2, "json 解析异常", parambbac);
        }
      }
    }
  }
