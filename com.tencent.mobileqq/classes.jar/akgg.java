  ...
  extends ajtb
{
  ...
  public akgg(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_JavaLangString = paramQQAppInterface.getApplication().getString(2131719540);
    this.jdField_b_of_type_JavaLangString = paramQQAppInterface.getApplication().getString(2131719541);
    this.c = paramQQAppInterface.getApplication().getString(2131719538);
    this.d = paramQQAppInterface.getApplication().getString(2131719542);
    this.f = paramQQAppInterface.getApplication().getString(2131719536);
    this.g = paramQQAppInterface.getApplication().getString(2131719534);
    this.h = paramQQAppInterface.getApplication().getString(2131719537);
    this.e = paramQQAppInterface.getApplication().getString(2131719539);
    this.i = paramQQAppInterface.getApplication().getString(2131719535);
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, sso2sns_0x3_blocklist.RspBody paramRspBody)
  {
    ...
    ((aset)this.app.getManager(16)).a(paramFromServiceMsg);
  ...
  private void a(boolean paramBoolean, int paramInt, long[] paramArrayOfLong)
  {
    ...
    if (j < m)
    {
      ...
      if (k != 1006) {
        if (paramBoolean)
        {
          ...
          if (k == 1024)
          {
            localbduf = (bduf)this.app.getManager(165);
            if (localbduf != null)
            {
              localObject1 = localObject2;
              if (!localbduf.a((String)localObject3))
              {
                localObject1 = localObject2;
                if (localbduf.f((String)localObject3)) {}
              }
            }
            else
            {
          ...
          if ((localObject1 == null) || (((List)localObject1).size() <= 0) || (!akpx.a((MessageRecord)((List)localObject1).get(((List)localObject1).size() - 1), (MessageRecord)localObject3, false))) {
            break label594;
          }
          if (QLog.isColorLevel()) {
    ...
    for (int k = 1;; k = 0)
    {
      ...
      do
      {
        ...
        localObject2 = bbcz.f(this.app, String.valueOf(l1));
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    long l1 = bbmx.a(arrayOfByte1, 0);
    long l2 = bbmx.a(arrayOfByte1, 4);
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, sso2sns_0x3_blocklist.RspBody paramRspBody)
  {
    ...
    paramToServiceMsg = (aset)this.app.getManager(16);
    int j = 0;
  ...
  private byte[] a(sso2sns_comm_info.Sso2SnsCommInfo paramSso2SnsCommInfo, sso2sns_0x3_blocklist.ReqBody paramReqBody)
  {
    ...
    bbmx.a(arrayOfByte1, 0, l1);
    bbmx.a(arrayOfByte2, 0, l2);
  ...
  private void d()
  {
    ...
    ((aset)this.app.getManager(16)).a(localArrayList);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (paramInt == 1006)
    {
      paramString = bbcz.e(this.app, paramString);
