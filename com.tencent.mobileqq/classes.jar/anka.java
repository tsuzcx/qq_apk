...
public class anka
{
  ...
  private ArkAppPreloader.PreloadAppCallback jdField_a_of_type_ComTencentArkArkAppPreloader$PreloadAppCallback = new ankc(this);
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  private ConcurrentHashMap<String, anke> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(8);
  private boolean jdField_a_of_type_Boolean;
  private boolean b;
  
  public anka(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(anke paramanke)
  {
    ...
    ThreadManagerV2.executeOnSubThread(new ArkAppPreDownloadMgr.3(this, paramanke));
  }
  ...
  private void c()
  {
    ...
    ArkAppPreloader.preloadCommon(anjs.a(), str2, str1);
  }
  ...
  public void a()
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() > 0) && (!this.jdField_a_of_type_Boolean))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (!TextUtils.isEmpty(localanke.a)) {
          if (TextUtils.isEmpty(ArkAppMgr.getInstance().getAppPathByNameFromLocal(localanke.a, "", null, false))) {
            a(localanke);
          } else {
            QLog.d("ArkApp.ArkAppPreDownloadMgr", 1, new Object[] { "profiling ark app predowloaded,app=", localanke.a });
          }
        }
      }
    }
  ...
  public void a(aohn paramaohn)
  {
    if ((paramaohn != null) && (paramaohn.a() != null)) {
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = paramaohn.a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          azmz.a(BaseApplicationImpl.getApplication()).a(str, "ark_app_predownload_first_hit", true, 0L, 0L, localHashMap, "", false);
        ...
        continue;
        azmz.a(BaseApplicationImpl.getApplication()).a(str, "ark_app_predownload_first_hit", false, 0L, 0L, localHashMap, "", false);
      }
      finally {}
      label193:
      continue;
