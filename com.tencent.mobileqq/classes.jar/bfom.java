  ...
  extends BaseAdapter
{
  ...
  private LinkedHashMap<Integer, ArrayList<bfnx>> jdField_a_of_type_JavaUtilLinkedHashMap = new TroopAppShortcutContainer.AppsListViewAdapter.1(this);
  
  public bfom(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
  }
  
  public bfnx a(int paramInt)
  {
      ...
      if (paramInt < j)
      {
        ...
        if (k >= 0)
        {
          ...
          if (k < ((ArrayList)localEntry.getValue()).size()) {
            return (bfnx)((ArrayList)localEntry.getValue()).get(k);
          }
        }
      }
    }
  ...
  public void a(int paramInt, bfnx parambfnx)
  {
    if (this.jdField_a_of_type_JavaUtilLinkedHashMap.containsKey(Integer.valueOf(paramInt)))
    {
      ...
      ((ArrayList)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(Integer.valueOf(paramInt))).add(parambfnx);
      notifyDataSetChanged();
    }
  }
  
  public void a(int paramInt, List<bfnx> paramList)
  {
    if (this.jdField_a_of_type_JavaUtilLinkedHashMap.containsKey(Integer.valueOf(paramInt)))
    {
      ((ArrayList)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(Integer.valueOf(paramInt))).clear();
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (localObject != null) {}
    for (localObject = ((bfnx)localObject).a(paramInt, paramView, paramViewGroup);; localObject = null)
    {
