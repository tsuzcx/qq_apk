...
public class bdfk
{
  ...
  {
    new bhyv("QC.HomepageLogicServer.HomepageLogicObj", "QcHomePageLogic.GetConciseThemeReq", "stReq", "stRsp").a("GetConciseTheme", new GetConciseThemeReq(bhyv.a()), new GetConciseThemeRsp(), new bdfl(paramString, paramAppInterface, paramBoolean), false);
  }
      ...
      if (true == jdField_a_of_type_Boolean)
      {
        ...
        for (;;)
        {
          ...
          if ((ImmersiveUtils.isSupporImmersive() != 0) && (paramImmersiveTitleBar2 != null)) {
            paramImmersiveTitleBar2.setBackgroundColor(BaseApplicationImpl.getApplication().getResources().getColor(2131167084));
          }
        }
      }
      ...
      if (true == jdField_a_of_type_Boolean)
      {
        ...
        for (;;)
        {
          ...
          if ((ImmersiveUtils.isSupporImmersive() != 0) && (paramSystemBarCompact != null)) {
            paramSystemBarCompact.setStatusBarColor(2131167084);
          }
        }
      }
  ...
  private static final void a(String paramString)
  {
    ...
    {
      localObject = (bdfe)((QQAppInterface)localObject).getBusinessHandler(BusinessHandlerFactory.SIMPLE_UI_HANDLER);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      ((bdfe)localObject).a(bool, i);
      ((bdfe)localObject).notifyUI(4, true, new Object[] { Boolean.valueOf(bool), Integer.valueOf(i), paramString });
