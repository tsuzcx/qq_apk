...
public class asgs
{
  ...
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new asgt(this);
  ...
  public asgs(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Asgq = ((asgq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(259));
  }
  ...
  private String b(String paramString)
  {
    if ((paramString != null) && (!"".equals(paramString)))
    {
      ...
      return antf.bl + apdf.a(str) + paramString + ".jpg";
    }
    return "";
  }
  ...
  public int a()
  {
    return (this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().widthPixels - bdep.a(11.0F) * 2 - bdep.a(2.0F) * 2) / 3;
  }
  ...
  public int a(URLDrawable paramURLDrawable)
  {
        ...
        if (beqz.b(str))
        {
          ...
          if (str != null)
          {
            ...
            if (!"".equals(str))
            {
              ...
              str = antf.bl + apdf.a((String)localObject) + str + ".jpg";
            }
          }
        }
      }
    ...
    try
    {
      ...
      i = aicv.a(this.jdField_a_of_type_AndroidContentContext, str);
      return i;
    }
  ...
  public Drawable a(Drawable paramDrawable, int paramInt)
  {
    ...
    for (Object localObject = Bitmap.Config.ARGB_8888;; localObject = Bitmap.Config.RGB_565)
    {
      ...
      return new BitmapDrawable(bhmq.a((Bitmap)localObject, ((Bitmap)localObject).getWidth(), ((Bitmap)localObject).getHeight()));
    }
  }
  ...
  public EmoticonFromGroupEntity a(MessageRecord paramMessageRecord)
  {
    ...
    if ((localMessageForPic.imageType == 3) || (localMessageForPic.imageType == 2000))
    {
      ...
      paramMessageRecord = beyq.a(localMessageForPic, 65537);
      ...
      paramMessageRecord = beyq.a(localMessageForPic, 1);
      if (paramMessageRecord != null) {
        break label162;
      }
    }
    ...
    if (l >= paramLong)
    {
      ...
      if (7 > i)
      {
        ...
        default: 
          return null;
        case 0: 
          return anzj.a(2131702955);
        case 1: 
          return anzj.a(2131702979);
        case 2: 
          return anzj.a(2131702942);
        case 3: 
          return anzj.a(2131702956);
        case 4: 
          return anzj.a(2131702938);
        case 5: 
          return anzj.a(2131702962);
        }
        return anzj.a(2131702970);
      }
  ...
  {
    if ((paramString != null) && (!paramString.isEmpty()) && (beqz.b(paramString)))
    {
      paramString = beqz.a(paramString);
      if (paramString != null) {
  ...
  {
    return this.jdField_a_of_type_Asgq.c();
  }
  ...
  public Map<String, List<EmoticonFromGroupEntity>> a(List<EmoticonFromGroupEntity> paramList)
  {
    ...
    if (paramList != null)
    {
      ...
      {
        localObject = new TreeMap(new asgu(this));
  ...
  public void a()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("EmoticonFromGroup_Manager", 2, "init mEmoManager.mCountOfSpare:" + this.jdField_a_of_type_Asgq.b);
    }
  }
  ...
  public void a(Context paramContext, MessageForPic paramMessageForPic, View paramView)
  {
    ...
    bmgb.a(paramContext, localBundle, new AIOImageProviderService(paramMessageForPic.selfuin, null, -1, paramMessageForPic), aicv.a(paramMessageForPic), -1, -1);
  }
  
  public void a(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    this.jdField_a_of_type_Asgq.a(paramEmoticonFromGroupEntity, 2);
  }
  
  public void a(MessageRecord paramMessageRecord)
  {
    if (a(paramMessageRecord)) {
      this.jdField_a_of_type_Asgq.b(paramMessageRecord);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    for (paramString = (String)localObject;; paramString = null)
    {
      if (paramString != null)
      {
        ...
        {
          if ((anzr.a(paramString.msg)) || (anxg.a(paramString.msg))) {
            auna.a(2131692322);
          }
        }
        else
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramString.msg, new asgy(localMqqHandler));
  ...
  public void a(List<MessageRecord> paramList)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Asgq.a() >= 600) || (this.jdField_a_of_type_Asgq.b() >= 300))
      {
        if (QLog.isColorLevel()) {
      ...
      else
      {
        ...
        while (paramList.hasNext())
        {
          ...
          if ((this.jdField_a_of_type_JavaUtilList.contains(localInteger)) && (!anxg.a(localMessageRecord)) && (!axug.a(localMessageRecord)))
          {
            if (QLog.isColorLevel()) {
              QLog.i("EmoticonFromGroup_Manager", 2, "filterMessageByType type: " + localInteger);
            }
            this.jdField_a_of_type_Asgq.a(localMessageRecord);
          }
        }
      }
    }
  ...
  public boolean a(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    ...
    if (this.jdField_a_of_type_Asgq.b < 1)
    {
      if (300 == asha.a) {
      ...
      do
      {
        do
        {
          ...
          paramEmoticonFromGroupEntity = new asgv(this, (BaseActivity)localObject);
        } while (localObject == null);
        paramEmoticonFromGroupEntity = bhlq.a((Context)localObject, 0, anzj.a(2131702959), ((BaseActivity)localObject).getString(2131689609), anzj.a(2131702957), anzj.a(2131702981), paramEmoticonFromGroupEntity, paramEmoticonFromGroupEntity);
      } while (paramEmoticonFromGroupEntity == null);
      paramEmoticonFromGroupEntity.show();
      return false;
    }
    localObject = this.jdField_a_of_type_Asgq;
    ((asgq)localObject).b -= 1;
    c(paramEmoticonFromGroupEntity);
    QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2, 2131691733, 0).b(2131299011);
    return true;
  }
  ...
  {
    return this.jdField_a_of_type_Asgq.b();
  }
  
  public void b(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    this.jdField_a_of_type_Asgq.a(paramEmoticonFromGroupEntity);
  }
  ...
  {
    this.jdField_a_of_type_Asgq.a(paramList, 2);
  }
  ...
  public void c(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    ...
    {
      this.jdField_a_of_type_Asgq.jdField_a_of_type_JavaUtilList.add(localURLDrawable);
      localURLDrawable.setURLDrawableListener(new asgx(this, localURLDrawable));
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_Asgq.jdField_a_of_type_JavaUtilList.remove(localURLDrawable);
  ...
  {
    this.jdField_a_of_type_Asgq.a(paramList);
  }
