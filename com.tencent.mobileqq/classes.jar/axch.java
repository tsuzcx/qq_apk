  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      paramIntent = bgyn.a(paramFromServiceMsg.getWupBuffer());
      if (paramIntent != null)
      {
        paramFromServiceMsg = new Bundle();
        paramFromServiceMsg.putSerializable("data", paramIntent);
        notifyObserver(null, 1002, true, paramFromServiceMsg, atzq.class);
        return;
      }
      if (QLog.isColorLevel()) {
        QLog.d("QZoneAlbumListNumServlet", 2, "inform QZoneAlbumListNumServlet isSuccess false");
      }
      notifyObserver(null, 1002, false, new Bundle(), atzq.class);
      return;
    }
    if (QLog.isColorLevel()) {
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    byte[] arrayOfByte = new bgyn(paramIntent.getLongExtra("selfuin", 0L), paramIntent.getStringExtra("refer")).encode();
