...
public class npk
{
  ...
  public npk(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if (this.jdField_a_of_type_Npn != null) {
      this.jdField_a_of_type_Npn.a(paramArrayList);
    }
  }
  ...
  private void a(List<Long> paramList)
  {
    ...
    ((NewIntent)localObject).setObserver(new npm(this));
  ...
  {
    if (this.jdField_a_of_type_Npn != null) {
      this.jdField_a_of_type_Npn.a();
    }
  }
  
  public void a()
  {
    this.jdField_a_of_type_Npn = null;
    this.jdField_a_of_type_Boolean = true;
  }
  
  public boolean a(String paramString, npn paramnpn)
  {
    return a(paramString, paramnpn, false);
  }
  
  public boolean a(String paramString, npn paramnpn, boolean paramBoolean)
  {
    this.jdField_a_of_type_Npn = paramnpn;
    paramnpn = new oidb_0x8cf.ReqBody();
    try
    {
      paramnpn.opt_uint64_groupcode.set(Long.parseLong(paramString));
      paramnpn.opt_uint32_need_mobile_sysapps.set(1);
      paramString = new oidb_sso.OIDBSSOPkg();
      paramString.uint32_command.set(2255);
      paramString.uint32_service_type.set(6);
      paramString.bytes_bodybuffer.set(ByteStringMicro.copyFrom(paramnpn.toByteArray()));
      paramnpn = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), nkl.class);
      paramnpn.putExtra("cmd", "OidbSvc.0x8cf_6");
      paramnpn.putExtra("data", paramString.toByteArray());
      paramnpn.setObserver(new npl(this, paramBoolean));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet(paramnpn);
      return true;
    }
    catch (NumberFormatException paramnpn)
    {
