...
class anrj
  extends mmm
{
  anrj(anri paramanri, boolean paramBoolean) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    paramArrayOfByte = (anpv)ExtendFriendProfileEditFragment.a(this.a.a).getTag();
    if (!this.b) {}
    for (;;)
    {
      paramArrayOfByte.mVipHide = bool;
      bajr.a(paramArrayOfByte, ExtendFriendProfileEditFragment.a(this.a.a));
