  ...
  extends WebViewClient
{
  ...
  private abdv(AbsBaseWebViewActivity paramAbsBaseWebViewActivity) {}
  ...
  protected WebResourceResponse a(WebView paramWebView, String paramString)
  {
    ...
    if (paramString.startsWith("mqqpa://resourceid/")) {
      localObject1 = tyo.a(paramString);
    }
  ...
  public void onDetectedBlankScreen(String paramString, int paramInt)
  {
    ...
    this.b.jdField_a_of_type_Biqx.a(paramString, paramInt);
  }
  ...
  public void onPageFinished(WebView paramWebView, String paramString)
  {
    if ((!this.b.c) && (!this.b.isFinishing()))
    {
      ...
      if ((Build.VERSION.SDK_INT >= 19) && (!this.b.c) && (this.b.jdField_a_of_type_Nxo != null))
      {
        paramString = paramWebView.getTitle();
        this.b.jdField_a_of_type_Nxo.onReceivedTitle(paramWebView, paramString);
      }
      agdz.b(this.b.getIntent());
      return;
    }
  ...
  public void onReceivedSslError(WebView paramWebView, SslErrorHandler paramSslErrorHandler, SslError paramSslError)
  {
    if ((!this.b.c) && (!this.b.isFinishing()))
    {
      ...
      {
        QLog.e("WebLog_WebViewBase", 1, paramWebView + ", pageUrl=" + noe.b(str, new String[0]));
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("WebLog_WebViewBase", 2, "shouldOverrideUrlLoading:" + noe.b(paramString, new String[0]));
    }
    ...
    if ((("http".equals(paramString)) || ("data".equals(paramString))) && (!str.contains("/cgi-bin/httpconn?htcmd=0x6ff0080"))) {
      CustomWebView.addContextLog(noe.b(str, new String[0]));
    }
    try
    {
      if (("http".equals(paramString)) || ("https".equals(paramString)))
      {
        ...
        if ((localObject != null) && (((WebView.HitTestResult)localObject).getType() == 0))
        {
          ...
          this.b.jdField_a_of_type_Biqx.e(str);
        }
      }
      ...
      else
      {
        ...
        if ((this.b.isResume()) && ((System.currentTimeMillis() - this.b.e < 1000L) || (this.b.jdField_a_of_type_Niz.a(paramWebView.getUrl(), str).booleanValue())))
        {
