...
{
  private vdh(GivingHeartItemBuilder paramGivingHeartItemBuilder) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        ...
        {
          if (paramView.findViewById(2131362364).getVisibility() == 0) {}
          for (i = 1; i != 0; i = 0)
          {
      ...
      for (;;)
      {
        try
        {
          ...
          ((CustomFrameAnimationDrawable)localObject1).a(new vdi(this, localHolder, localMessageForPoke));
          ...
          paramView = ((FitSystemWindowsRelativeLayout)((ViewGroup)((Activity)this.a.jdField_a_of_type_AndroidContentContext).getWindow().getDecorView()).getChildAt(0).findViewById(2131363510)).a();
          localHolder.jdField_b_of_type_AndroidViewView.setVisibility(0);
          paramView.a(localHolder, PokeItemHelper.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      localHolder.c.setVisibility(8);
      localHolder.jdField_a_of_type_AndroidWidgetRelativeLayout.clearAnimation();
      localHolder.jdField_a_of_type_ComTencentMobileqqActivityAioItemUnlimitedBladeWorks.setEndListener(new vdj(this, localHolder, localMessageForPoke));
