  ...
  extends ClickableSpan
{
  ...
  afks(afjb paramafjb, QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  public void onClick(View paramView)
  {
    ...
    if (!bdee.d(localContext))
    {
      QQToast.a(localContext, 2131692397, 0).b(localContext.getResources().getDimensionPixelSize(2131298914));
      return;
    }
    Intent localIntent = new Intent(localContext, QQSpecialCareSettingActivity.class);
    localIntent.putExtra("key_friend_uin", this.jdField_a_of_type_Afjb.a.a);
