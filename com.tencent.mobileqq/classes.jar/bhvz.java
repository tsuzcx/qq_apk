...
{
  public bhvz(HealthBusinessPlugin paramHealthBusinessPlugin) {}
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    if ((Math.abs(this.a.a.y - this.a.b.y) < 8) && (Math.abs(this.a.a.x - this.a.b.x) < 8))
    {
      ...
      while (paramMotionEvent.hasNext())
      {
        ...
        SeekBar localSeekBar = ((bhwi)this.a.jdField_f_of_type_JavaUtilHashMap.get(localObject)).jdField_a_of_type_AndroidWidgetSeekBar;
        TextView localTextView1 = ((bhwi)this.a.jdField_f_of_type_JavaUtilHashMap.get(localObject)).jdField_c_of_type_AndroidWidgetTextView;
        TextView localTextView2 = ((bhwi)this.a.jdField_f_of_type_JavaUtilHashMap.get(localObject)).jdField_b_of_type_AndroidWidgetTextView;
        ImageView localImageView1 = ((bhwi)this.a.jdField_f_of_type_JavaUtilHashMap.get(localObject)).jdField_a_of_type_AndroidWidgetImageView;
        ImageView localImageView2 = ((bhwi)this.a.jdField_f_of_type_JavaUtilHashMap.get(localObject)).jdField_b_of_type_AndroidWidgetImageView;
        TextView localTextView3 = ((bhwi)this.a.jdField_f_of_type_JavaUtilHashMap.get(localObject)).jdField_a_of_type_AndroidWidgetTextView;
        ImageView localImageView3 = ((bhwi)this.a.jdField_f_of_type_JavaUtilHashMap.get(localObject)).jdField_c_of_type_AndroidWidgetImageView;
        ...
        if ((paramView.contains(this.a.a.x, this.a.a.y)) && (paramView.contains(this.a.b.x, this.a.b.y)))
        {
          ...
          if (localSeekBar.getVisibility() == 4)
          {
            ...
            for (int i = 2130848634;; i = 2130849183)
            {
