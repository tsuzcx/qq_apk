  ...
  extends akav
{
  ...
  protected void a(String paramString1, int paramInt1, int paramInt2, SendMessageHandler paramSendMessageHandler, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    for (;;)
    {
      this.a.e(196608);
      return;
      bcpw.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131718808), 0).b(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
    }
  }
  ...
  protected void a(boolean paramBoolean, String paramString, long paramLong)
  {
    ...
    if (this.a.U)
    {
      ...
      aerl.a(this.a).removeMessages(39);
      aerl.b(this.a).sendMessage(paramString);
    }
    ThreadManagerV2.excute(new NearbyChatPie.11.1(this, paramBoolean, this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getIntent().getStringExtra("NEARBY_MSG_REPORT_SOURCE"), (aszd)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(106)), 16, null, false);
  }
