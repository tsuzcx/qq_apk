  ...
  implements View.OnClickListener
{
  ...
  protected String a;
  private List<bltw> jdField_a_of_type_JavaUtilList = new ArrayList();
  protected View b;
  protected boolean b;
  ...
  public blts(Activity paramActivity)
  {
  ...
  private void a()
  {
    ...
    if (Math.min(bgln.g(), bgln.h()) >= 720L)
    {
  ...
  private void b()
  {
    ...
    label130:
    for (View localView = View.inflate(BaseApplicationImpl.getContext(), 2131561977, null);; localView = View.inflate(BaseApplicationImpl.getContext(), 2131561979, null))
    {
      this.jdField_a_of_type_AndroidViewView = View.inflate(BaseApplicationImpl.getContext(), 2131561981, null);
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131370447);
      this.jdField_a_of_type_Awgo = ((awgo)localView.findViewById(2131370440));
      this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView = ((MagicfaceContainerView)localView.findViewById(2131370442));
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131370441));
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370445));
  ...
  private void c()
  {
    if ((this.jdField_a_of_type_Bltp != null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      ...
      ((View)this.jdField_a_of_type_Awgo).setVisibility(8);
      this.jdField_a_of_type_Awgo.setSurfaceCreatelistener(null);
    }
    try
    {
      ...
      label109:
      if (this.jdField_a_of_type_Bltp.a())
      {
        bltp localbltp = this.jdField_a_of_type_Bltp;
        localbltp.a(new bltt(this, localbltp));
        return;
      }
  ...
  public View a(String paramString1, String paramString2, bltv parambltv)
  {
    return a(paramString1, paramString2, false, parambltv);
  }
  
  public View a(String paramString1, String paramString2, boolean paramBoolean, bltv parambltv)
  {
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_Awgo != null) && (((View)this.jdField_a_of_type_Awgo).getVisibility() == 0))
      {
        localObject1 = new bltw(this);
        ((bltw)localObject1).jdField_a_of_type_JavaLangString = paramString1;
        ((bltw)localObject1).jdField_a_of_type_Boolean = paramBoolean;
        ((bltw)localObject1).b = paramString2;
        ((bltw)localObject1).jdField_a_of_type_Bltv = parambltv;
        this.jdField_a_of_type_JavaUtilList.add(localObject1);
        return null;
      }
      if ((this.jdField_a_of_type_Bltp != null) && (this.jdField_a_of_type_Bltp.a())) {
        return null;
      }
      if (this.jdField_a_of_type_AndroidAppActivity == null) {
        return null;
      }
      this.jdField_a_of_type_Awfj = bltp.a(paramString1, paramString2);
      if (this.jdField_a_of_type_Awfj == null) {
        return null;
      }
      this.jdField_a_of_type_JavaLangString = paramString1;
      b();
      this.jdField_a_of_type_Bltp = new bltp(this);
      ...
      this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.updateViewLayout((View)this.jdField_a_of_type_Awgo, (ViewGroup.LayoutParams)localObject2);
      if (!paramBoolean) {
        a(0);
      }
      ...
      if (paramBoolean)
      {
        ...
        ((FrameLayout.LayoutParams)localObject1).topMargin = bgtn.a(75.0F);
        ((FrameLayout.LayoutParams)localObject1).bottomMargin = bgtn.a(75.0F);
        ((FrameLayout.LayoutParams)localObject1).leftMargin = bgtn.a(15.0F);
        ((FrameLayout.LayoutParams)localObject1).rightMargin = bgtn.a(15.0F);
        this.jdField_a_of_type_Awgo.setIsFullScreen(false);
        this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.setTouchEffect(true);
        ((View)this.jdField_a_of_type_Awgo).setClickable(false);
        ((View)this.jdField_a_of_type_Awgo).setFocusable(false);
      ...
      this.jdField_a_of_type_Awgo.setIsFullScreen(this.jdField_a_of_type_Awfj.jdField_b_of_type_Boolean);
      this.jdField_a_of_type_AndroidViewView.setVisibility(0);
      localObject1 = this.jdField_a_of_type_Awgo;
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      ((View)localObject1).setVisibility(0);
      ((SurfaceView)localObject1).setZOrderOnTop(true);
      ((SurfaceView)localObject1).getHolder().setFormat(-2);
      localObject2 = new awgj();
      ((awgj)localObject2).a((awfv)localObject1);
      this.jdField_a_of_type_Bltp.a((awgj)localObject2);
      this.jdField_a_of_type_Bltp.a(new bltu(this, l, parambltv));
      this.jdField_a_of_type_Bltp.a(paramString1, paramString2);
    }
  ...
  public boolean b()
  {
    if ((this.jdField_a_of_type_Bltp != null) && (this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.getVisibility() != 8))
    {
      c();
      return true;
    }
