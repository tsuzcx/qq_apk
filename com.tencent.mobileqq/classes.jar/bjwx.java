  ...
  extends BaseAdapter
{
  ...
  List<bjyl> jdField_a_of_type_JavaUtilList;
  
  public bjwx(PhotoWallViewForQiDianProfile paramPhotoWallViewForQiDianProfile, Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext);
  }
  
  public void a(List<bjyl> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    for (;;)
    {
      try
      {
        localObject1 = ((bjyl)this.jdField_a_of_type_JavaUtilList.get(paramInt)).c;
        Object localObject2;
        int i;
        int j;
      ...
      catch (Exception localException1)
      {
        try
        {
          localObject4 = ((bjyl)this.jdField_a_of_type_JavaUtilList.get(paramInt)).a;
          localObject2 = localObject1;
          localObject1 = localObject4;
          if (paramView != null) {
            break label366;
          }
          paramView = new bjwy(this);
          localObject4 = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559609, null);
          ...
          paramView.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)((View)localObject4).findViewById(2131372766));
          paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject4).findViewById(2131370795));
          ...
          paramView.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130841675);
          ...
          paramView.jdField_a_of_type_ComTencentImageURLImageView.setTag(new azpb(25, Integer.valueOf(paramInt)));
          if (!TextUtils.isEmpty(localObject2)) {
            break label384;
          }
          paramView.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130850491);
      ...
      continue;
      label366:
      localObject5 = (bjwy)paramView.getTag();
