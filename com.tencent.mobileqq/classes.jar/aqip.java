  ...
  extends bcal
{
  ...
  public aqip(NearbyHybridFragment paramNearbyHybridFragment, Context paramContext, Activity paramActivity, AppInterface paramAppInterface)
  {
  ...
  public void a()
  {
    ...
    for (long l = System.currentTimeMillis();; l = 0L)
    {
      ...
      atbp.a("WebSpeedTrace", "mInitWebViewTime", new Object[] { Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqFragmentNearbyHybridFragment.jdField_a_of_type_ComTencentMobileqqActivityNearbyActivity.k) });
      return;
    }
  }
  ...
  public void bindJavaScript(ArrayList<WebViewPlugin> paramArrayList)
  {
    if (paramArrayList != null)
    {
      ...
      paramArrayList.add(new xmi());
      paramArrayList.add(new bhrc());
    }
  }
  ...
  public void onPageFinished(WebView paramWebView, String paramString)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqFragmentNearbyHybridFragment.jdField_a_of_type_Aqju != null)
      {
        this.jdField_a_of_type_ComTencentMobileqqFragmentNearbyHybridFragment.jdField_a_of_type_Aqju.a(true);
        this.jdField_a_of_type_ComTencentMobileqqFragmentNearbyHybridFragment.jdField_a_of_type_Aqju.a();
      }
      this.d = true;
