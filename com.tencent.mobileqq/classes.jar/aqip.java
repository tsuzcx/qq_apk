  ...
  extends aqin
{
  ...
  {
    aqip localaqip = new aqip();
    Context localContext = BaseApplicationImpl.getApplication().getApplicationContext();
    localaqip.jdField_a_of_type_JavaLangString = paramJSONObject.optString("align");
    localaqip.d = (DisplayUtil.sp2px(localContext, paramJSONObject.optInt("text_size") / 2) + 1);
    localaqip.jdField_c_of_type_JavaLangString = paramJSONObject.optString("text_align");
    ...
    try
    {
      localaqip.jdField_c_of_type_Int = Color.parseColor("#" + (String)localObject);
      if (paramJSONObject.has("rect"))
      {
        localObject = paramJSONObject.optJSONArray("rect");
        localaqip.jdField_a_of_type_ArrayOfInt = new int[4];
        int i = 0;
        while (i < ((JSONArray)localObject).length())
        {
          localaqip.jdField_a_of_type_ArrayOfInt[i] = DisplayUtil.dip2px(localContext, ((JSONArray)localObject).optInt(i) / 2);
          i += 1;
        }
      }
    }
    catch (Exception localException)
    {
      ...
      localaqip.e = paramJSONObject.optInt("text_max_count");
      if (QLog.isColorLevel()) {
  ...
  @TargetApi(11)
  public Rect a(aqjb paramaqjb, Canvas paramCanvas, Paint paramPaint)
  {
    float f1 = 0.0F;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_JavaLangString.endsWith("L"))
        {
          ...
          localObject = aqhg.a().a(paramaqjb, paramaqjb.jdField_a_of_type_JavaLangString);
          Paint.FontMetrics localFontMetrics = paramPaint.getFontMetrics();
          f4 = aqin.a(paramPaint, (String)localObject);
  ...
  public void a(aqjb paramaqjb, Canvas paramCanvas)
  {
    ...
    {
      return;
      str = aqhg.a().a(paramaqjb, paramaqjb.jdField_a_of_type_JavaLangString);
    ...
    paramaqjb = a(paramaqjb, paramCanvas, localPaint);
    paramCanvas.drawText(str, paramaqjb.left, paramaqjb.top, localPaint);
  }
}
