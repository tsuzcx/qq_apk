  ...
  implements lta
{
  ...
  {
    if (this.a.jdField_a_of_type_Lfe == null) {}
    label517:
    label1010:
    do
    {
            ...
            if ((paramltg.a == -100) || (paramltg.a == 3))
            {
              if (RandomController.a(this.a) == 1)
              {
                if ((paramInt == 0) && ((paramltg instanceof lti)))
                {
                  ...
                  this.a.jdField_a_of_type_Lfe.a.a = paramltg.a;
                  if (this.a.jdField_a_of_type_Lfe.l())
                  {
              ...
              else if (RandomController.a(this.a) == 2)
              {
                ...
                if ((paramInt == 0) && ((paramltg instanceof ltk)))
                {
                  ...
                  for (localObject1 = ((ltk)localObject2).e;; localObject1 = String.valueOf(((ltk)localObject2).jdField_a_of_type_Long))
                  {
                    ...
                    {
                      lcu locallcu = RandomController.a(this.a).a((String)localObject1);
                      if (locallcu != null)
                      {
                        locallcu.c = ((ltk)localObject2).c;
                        RandomController.a(this.a).a((String)localObject1, ((ltk)localObject2).b, ((ltk)localObject2).c);
                        if (QLog.isColorLevel()) {
                          QLog.d("RandomController", 2, "RSP_MULTI_PULL uin:" + locallcu.jdField_a_of_type_Long + ", headUrl:" + locallcu.c);
                        }
                      }
                    }
                ...
                if (paramInt == 100)
                {
                  ...
                  while (((Iterator)localObject2).hasNext()) {
                    ((StringBuilder)localObject1).append(((lcu)((Iterator)localObject2).next()).jdField_a_of_type_Long).append("|");
                  }
                ...
                if ((paramltg instanceof ltk))
                {
                  ...
                  if ((!TextUtils.isEmpty(paramltg.d)) && (TextUtils.isEmpty(this.a.jdField_a_of_type_Lfe.a.e)))
                  {
                    this.a.jdField_a_of_type_Lfe.a.e = (RandomController.a(this.a).getApp().getString(2131695490) + " “" + paramltg.d + "” ");
                    RandomController.a(this.a, paramltg.d);
                    if (QLog.isColorLevel()) {
                      QLog.d("RandomController", 2, "RSP_MULTI_PULL talkTips : " + this.a.jdField_a_of_type_Lfe.a.e);
                    }
                  }
                }
              }
      ...
      this.a.jdField_a_of_type_JavaLangString = HexUtil.hexString2String(paramltg.jdField_a_of_type_OrgJsonJSONObject.optString("wording").trim());
      if (TextUtils.isEmpty(this.a.jdField_a_of_type_JavaLangString)) {
        this.a.jdField_a_of_type_JavaLangString = RandomController.a(this.a).getApp().getApplicationContext().getString(2131695483);
      }
      if (QLog.isColorLevel()) {
