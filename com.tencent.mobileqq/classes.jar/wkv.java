  ...
  extends wps
{
  ...
  public void a(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    {
      xhe.a(((CertifiedAccountMeta.StUser)localObject1).id.get(), "auth_" + wva.a(a()), "exp_shop", 0, 0, new String[0]);
      localObject2 = a();
      if (!wiw.a(((CertifiedAccountMeta.StUser)localObject1).attr.get())) {
        break label241;
      }
    }
    label241:
    for (paramStFeed = ajyc.a(2131702210);; paramStFeed = ((CertifiedAccountMeta.StUser)localObject1).nick.get())
    {
      paramStFeed = woz.a((Context)localObject2, 13.5F, "#878B99", String.format("%s的小店", new Object[] { paramStFeed }));
      ...
      paramStFeed.setOnClickListener(new wkw(this, (CertifiedAccountMeta.StUser)localObject1));
  ...
  {
    paramBundle = woz.a(a(), 16.0F, "#222222", ajyc.a(2131701475));
  ...
  {
    if (((a().b(0) instanceof wkx)) && (((wkx)a().b(0)).a() != null)) {
      ((wkx)a().b(0)).a().a(paramComponentRvInnerView);
    }
  }
  ...
  public void a(String paramString, wpi paramwpi)
  {
    ...
    if ((paramString.equals("share_key_subscribe_feeds_update")) && (paramwpi.a != null))
    {
      this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed = ((CertifiedAccountMeta.StFeed)paramwpi.a);
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    case 100000: 
      return new wpb(this, this.jdField_a_of_type_AndroidWidgetFrameLayout);
    }
    return new wpb(this, a());
  }
}
