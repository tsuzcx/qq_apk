  ...
  extends vlg
{
  ...
  public vkv(DoodleView paramDoodleView)
  {
  ...
  private void b()
  {
    ...
    if (bkvi.b()) {
      this.jdField_c_of_type_Int = bkvi.jdField_a_of_type_Int;
    }
    this.d = localDisplayMetrics.heightPixels;
    if (bkvi.b()) {
      this.d = (localDisplayMetrics.heightPixels - bkvi.e);
    }
    ...
    this.jdField_a_of_type_Vpo.b(0.5F);
  }
