  ...
  extends bhrq
{
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bhsb(this);
  ...
  private void a(int paramInt1, int paramInt2, String paramString, boolean paramBoolean)
  {
    ...
    if (paramInt2 > 0)
    {
      ...
      if (paramInt1 > 0)
      {
        str = String.format(localActivity.getString(2131718142), new Object[] { Integer.valueOf(paramInt1) }) + "，";
        str = str + paramString + ajyc.a(2131712282);
      }
      paramString = str + String.format(localActivity.getString(2131718135), new Object[] { Integer.valueOf(paramInt2) });
      bbcv.a(localActivity, 232).setMessage(paramString).setNegativeButton(2131718140, new bhsh(this)).show();
      return;
    }
    bdid.a().a(localActivity.getString(2131718143) + paramString + ajyc.a(2131712281));
  }
  
  private void a(String paramString)
  {
    bhkl.a().a().d(paramString);
  }
  ...
  private void b(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localIntent.putExtra("source_name", this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getString(2131717943));
  ...
  private void c(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        i = bbcp.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getAccount(), "troop_photo_message", String.valueOf(i));
        if (QLog.isDevelopLevel()) {
  ...
  private void f(String... paramVarArgs)
  {
    ...
    try
    {
      ...
      bgxy.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), str, i, 1, l, "", paramVarArgs, (String)localObject, 7001, 43);
      return;
    }
    catch (Exception paramVarArgs)
    {
  ...
  private void h(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        bgxy.c(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), (bgyf)localObject2, (Bundle)localObject4, 6);
  ...
  private void i(String... paramVarArgs)
  {
    ...
    bhkl.a().a(new bhsc(this, paramVarArgs));
    if (!a())
    {
      bdid.a().a(ajyc.a(2131712280));
      return;
    }
    if (!NetworkState.isNetSupport())
    {
      bdid.a().a(ajyc.a(2131712277));
      return;
    }
    if (!NetworkState.isWifiConn())
    {
      Activity localActivity = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a();
      bbcv.a(localActivity, 230).setTitle(localActivity.getString(2131718139)).setMessage(localActivity.getString(2131718141)).setPositiveButton(localActivity.getString(2131718138), new bhsg(this, paramVarArgs)).setNegativeButton(localActivity.getString(2131718137), new bhsf(this)).show();
      return;
    }
    a(paramVarArgs[0]);
  }
  ...
  private void j(String... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bgxy.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), str, i, 4, j, "", paramVarArgs, (String)localObject, 7001, 43);
        return;
      }
      catch (Exception paramVarArgs) {}
  ...
  private void l(String... paramVarArgs)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localbgyf.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getCurrentAccountUin();
        paramVarArgs.putBoolean("key_need_change_to_jpg", true);
        bgxy.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), localbgyf, paramVarArgs, bgxy.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin, this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime, 6));
        return;
      }
      catch (Exception paramVarArgs) {}
    } while (!QLog.isColorLevel());
