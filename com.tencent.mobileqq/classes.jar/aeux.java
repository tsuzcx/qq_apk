...
public class aeux
  extends aiab
{
  public aeux(PublicView paramPublicView, Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramView.setId(2131307161);
      paramViewGroup = new aeuz();
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (aeuz)paramView.getTag();
    }
    ...
    for (;;)
    {
      ...
      {
        localObject = this.a.getResources().getDrawable(2130841234);
        paramInt = (int)bacc.a(this.a.a, 15.0F);
