  ...
  extends LinearLayout
{
  ...
  public tea(TabLayoutCompat paramTabLayoutCompat, Context paramContext)
  {
    super(paramContext);
  ...
  private void a(@Nullable TextView paramTextView, @Nullable ImageView paramImageView)
  {
    ...
    {
      localDrawable = this.jdField_a_of_type_Tdz.a();
      if (this.jdField_a_of_type_Tdz == null) {
        break label176;
      }
      localCharSequence1 = this.jdField_a_of_type_Tdz.a();
      if (this.jdField_a_of_type_Tdz == null) {
        break label182;
      }
      localCharSequence2 = this.jdField_a_of_type_Tdz.b();
      label48:
  ...
  public void a(@Nullable tdz paramtdz)
  {
    if (paramtdz != this.jdField_a_of_type_Tdz)
    {
  ...
  public boolean performClick()
  {
    ...
    if (this.jdField_a_of_type_Tdz != null)
    {
      ...
      tdz localtdz = TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat);
      if (TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat) == this.jdField_a_of_type_Tdz) {
        i = 1;
      }
      this.jdField_a_of_type_Tdz.a();
      if ((TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat) != null) && (i == 0)) {
        TabLayoutCompat.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetTabLayoutCompat).a(this.jdField_a_of_type_Tdz, localtdz, 1);
      }
      return true;
    }
    return bool;
