  ...
  extends BaseAdapter
{
  ...
  public aeaf(GameQuickWordsPanel paramGameQuickWordsPanel)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramViewGroup = new aeag(this);
      paramViewGroup.a = ((TextView)paramView.findViewById(2131362970));
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (aeag)paramView.getTag();
    }
  }
