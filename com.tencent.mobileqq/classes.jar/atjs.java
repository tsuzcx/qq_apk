  ...
  extends atic
{
  ...
  protected void a(int paramInt, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (paramBoolean1 = true;; paramBoolean1 = false)
    {
      if (QLog.isColorLevel()) {
        QLog.i("LyricsController", 2, "onLyricModuleSwitchChange, newUserClosed:" + paramBoolean1 + " type:" + paramInt + " uin:" + paramString + " mFloatParams:" + this.a.jdField_a_of_type_Atjl);
      }
      if ((this.a.jdField_a_of_type_Atjl.a(paramInt, paramString)) && (this.a.jdField_a_of_type_Atjl.jdField_b_of_type_Boolean != paramBoolean1))
      {
        this.a.jdField_a_of_type_Atjl.jdField_b_of_type_Boolean = paramBoolean1;
        atjn.a(this.a);
        if ((!TextUtils.isEmpty(this.a.jdField_b_of_type_JavaLangString)) && (!paramBoolean1) && (paramBoolean2))
        {
          atjn.a(this.a, this.a.jdField_b_of_type_JavaLangString);
          if (this.a.jdField_a_of_type_JavaLangBoolean != null) {
            atjn.a(this.a, this.a.jdField_b_of_type_JavaLangString, this.a.c, this.a.jdField_a_of_type_JavaLangBoolean.booleanValue());
          }
          atjn.a(this.a, this.a.jdField_b_of_type_JavaLangString, this.a.i);
        }
      }
      if (paramBoolean2) {
  ...
  protected void a(ListenTogetherSession paramListenTogetherSession)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.a.jdField_a_of_type_Atjl.a = ((String)localObject1);
      atjn.a(this.a);
      return;
    }
  }
  ...
  protected void a(ISong paramISong)
  {
    ...
    atjn.a(this.a, paramISong.a());
    this.a.jdField_a_of_type_Atjl.a = paramISong.d();
    atjn.a(this.a);
  }
  ...
  protected void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      atjn.b(this.a, paramString, paramInt);
      bajt.a().a();
      return;
      if (paramInt == 3)
      {
  ...
  {
    atjn.a(this.a, paramString, paramInt1, paramInt2);
  }
  ...
  protected void a(boolean paramBoolean, ListenTogetherSession paramListenTogetherSession)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.a.jdField_a_of_type_Atjl.a = paramListenTogetherSession;
      this.a.a(i, str);
      return;
    }
    this.a.b(i, str);
