...
public final class bksr
{
  private static Intent a(Activity paramActivity, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        if (paramIntent.getBooleanExtra("is_from_qreader_shortcut", false)) {
          ...
          {
            bkvd.e("QRJumpAction", localNumberFormatException.toString());
          }
        } else {
          i = -1;
        }
    ...
    paramActivity.putExtras(paramIntent);
    return paramActivity;
    paramIntent.putExtra("url", bkvf.b(a(paramIntent.getStringExtra("url"))));
    paramIntent.putExtra("item_type", 2);
    paramActivity = new Intent(paramActivity, ReaderContentPageActivity.class);
  ...
  public static void a(Context paramContext, Intent paramIntent, String paramString, bkkw parambkkw)
  {
    ...
    localbkkz.d = amtj.a(2131710311);
    localbkkz.jdField_a_of_type_JavaLangString = str;
    localbkkz.e = paramString;
    localbkkz.jdField_a_of_type_JavaLangClass = QRPluginProxyActivity.a(paramString);
    paramIntent.putExtra("userQqResources", 2);
    localbkkz.jdField_a_of_type_AndroidContentIntent = paramIntent;
    paramIntent = bken.a(1);
    if (paramIntent != null)
    {
      paramIntent.a();
      localbkkz.jdField_a_of_type_Aufm = paramIntent.jdField_a_of_type_Aufm;
    }
    try
    {
      bkkq.a(paramContext, localbkkz, parambkkw);
      return;
    }
    catch (Exception paramContext)
    {
      bkvd.a("QRJumpAction", "[jumpToPlugin] error!", paramContext);
    }
  }
}
