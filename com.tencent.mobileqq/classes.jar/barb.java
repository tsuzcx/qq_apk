...
public class barb
{
  private static baqr jdField_a_of_type_Baqr;
      ...
      try
      {
        ...
        else
        {
          if ((localArrayList.size() == 0) || (i == -1))
          {
            ...
            paramList = akju.a(new RecentUser(AppConstants.DATALINE_PC_UIN, 6000), paramQQAppInterface, paramActivity);
            if (paramList != null)
            {
              paramList.mTitleName = paramActivity.getResources().getString(2131693486);
              localArrayList.add(paramList);
            }
          }
          Collections.sort(localArrayList, new akjw(paramQQAppInterface));
  ...
  {
    baqr localbaqr2 = (baqr)apub.a().a(485);
    baqr localbaqr1 = localbaqr2;
    if (localbaqr2 == null)
    {
      localbaqr2 = new baqr();
      localbaqr1 = localbaqr2;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ScreenShotHelper", 2, "ScreenShotConfigData switch isOpened = " + localbaqr1);
    }
    jdField_a_of_type_Baqr = localbaqr1;
  }
  ...
  public static void a(Activity paramActivity)
  {
    ...
    paramActivity = ((ViewGroup)paramActivity.getWindow().getDecorView().getRootView()).findViewById(2131376848);
  ...
  public static void a(Activity paramActivity, Handler paramHandler)
  {
    ...
    View localView = ((ViewGroup)paramActivity.getWindow().getDecorView().getRootView()).findViewById(2131376848);
    if (localView != null)
    {
  ...
  public static void a(Activity paramActivity, String paramString, Handler paramHandler)
  {
    ...
    Object localObject1 = localViewGroup.findViewById(2131376848);
    ...
    for (;;)
    {
      ...
      {
        localObject3 = View.inflate(paramActivity, 2131562730, null);
        localImageView = (ImageView)((View)localObject3).findViewById(2131376851);
      ...
      for (;;)
      {
        try
        {
          paramActivity.getResources().getDrawable(2130840385);
          ...
          ((View)localObject3).setId(2131376848);
          localObject1 = localObject3;
          if (localObject1 != null)
          {
            a((View)localObject1);
            ((View)localObject1).setTag(paramString);
            ((View)localObject1).setOnClickListener(new barc());
  ...
  public static void a(Context paramContext, android.net.Uri paramUri, View paramView1, View paramView2, boolean paramBoolean)
  {
    ...
    //   23: iconst_3
    //   24: aload 9
    //   26: invokestatic 525	yxi:a	(Landroid/net/Uri;Landroid/content/Context;ILandroid/util/SparseArray;)I
    //   29: istore 6
    //   31: iload 6
    //   33: invokestatic 528	yxi:b	(I)Z
    //   36: ifeq +262 -> 298
    ...
    //   109: istore 5
    //   111: iload 6
    //   113: invokestatic 546	yxi:a	(I)Z
    //   116: ifeq -106 -> 10
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    {
      localObject = ((ViewGroup)((Activity)paramContext).getWindow().getDecorView().getRootView()).findViewById(2131376848);
      if (localObject != null) {
          ...
          if (localQQAppInterface.getMessageFacade().isChatting())
          {
            ...
            if (localQQAppInterface.getMessageFacade().getCurChatMsgList() != null)
            {
              ...
              if (localQQAppInterface.getMessageFacade().getCurChatMsgList().size() > 0)
              {
                ...
                adxr.a(paramString, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class, 9011);
                i = 1;
              }
            }
          }
    ...
    if (((paramContext instanceof QQBrowserActivity)) && (a((QQBrowserActivity)paramContext)))
    {
      ...
      adxr.a((QQBrowserActivity)paramContext, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class, 11);
    }
    while (i != 0) {
      return;
    }
    adxr.a(paramContext, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class);
  }
  ...
  public static void a(baqr parambaqr)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ScreenShotHelper", 2, "onConfUpdate : " + parambaqr);
    }
    if (parambaqr != null) {
      jdField_a_of_type_Boolean = parambaqr.a();
    }
  }
  ...
  public static boolean a()
  {
    ...
    b = true;
    a();
    jdField_a_of_type_Boolean = jdField_a_of_type_Baqr.a();
    if (QLog.isColorLevel()) {
  ...
  private static boolean a(QQBrowserActivity paramQQBrowserActivity)
  {
    ...
    return paramQQBrowserActivity.getSupportFragmentManager().findFragmentById(2131365087) instanceof WebViewFragment;
  }
