  ...
  extends ajtd
{
  ...
  public ajvr(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong1, long paramLong2, long paramLong3, long paramLong4)
  {
    ...
    localGetUserEqqListRequest.begin.set(bbbd.a(paramLong1));
    localGetUserEqqListRequest.limit.set(bbbd.a(paramLong2));
    localGetUserEqqListRequest.seqno.set(bbbd.a(paramLong3));
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      notifyUI(100, bool, localakdq);
      ((PublicAccountHandler)this.app.a(11)).notifyUI(100, true, localakdq);
      return;
      i = 0;
      continue;
      if (paramToServiceMsg.seqno.has())
      {
        ...
        bool = true;
        localakdq.jdField_a_of_type_Boolean = bool;
        paramObject = ((akdi)this.app.getManager(56)).a(paramFromServiceMsg, l2);
        i = 0;
          ...
          if (paramToServiceMsg.ret_info.has())
          {
            ...
            if (i != 0)
            {
              ...
              if (paramFromServiceMsg.err_info.has())
              {
                ...
                i = paramToServiceMsg.seqno.get();
                aoee.a(this.app).a(this.app, paramFromServiceMsg, i, paramToServiceMsg);
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3, BusinessObserver paramBusinessObserver)
  {
    ...
    {
      long l = Long.valueOf(paramString).longValue();
      paramString = new NewIntent(this.app.getApplication().getApplicationContext(), nou.class);
