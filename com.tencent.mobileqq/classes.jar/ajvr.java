  ...
  implements Runnable
{
  ...
  public ajvr(PathTraceManager paramPathTraceManager, long paramLong, String paramString)
  {
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqVashealthPathTraceManager.jdField_a_of_type_ComTencentMobileqqAppBrowserAppInterface != null)
    {
      HashMap localHashMap = new HashMap();
      localHashMap.put("type", paramInt + "");
      String str = this.jdField_a_of_type_ComTencentMobileqqVashealthPathTraceManager.jdField_a_of_type_ComTencentMobileqqAppBrowserAppInterface.getCurrentAccountUin();
      StatisticCollector.a(this.jdField_a_of_type_ComTencentMobileqqVashealthPathTraceManager.jdField_a_of_type_ComTencentMobileqqAppBrowserAppInterface.getApp()).a(str, "QQSportUpload", paramBoolean, System.currentTimeMillis(), 0L, localHashMap, "", false);
    }
  }
  ...
  public void run()
  {
    ...
    try
    {
      ...
      {
        localTracePathData = PathTraceManager.a(this.jdField_a_of_type_ComTencentMobileqqVashealthPathTraceManager);
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqVashealthPathTraceManager.b != 0L) && (localTracePathData != null)) {
          localTracePathData.totalTime = this.jdField_a_of_type_ComTencentMobileqqVashealthPathTraceManager.b;
        }
        localList = this.jdField_a_of_type_ComTencentMobileqqVashealthPathTraceManager.a(this.jdField_a_of_type_Long);
        ...
        if ((Build.VERSION.SDK_INT < 19) || (this.jdField_a_of_type_ComTencentMobileqqVashealthPathTraceManager.jdField_a_of_type_AndroidHardwareSensor == null)) {
          break label447;
        }
      ...
      for (;;)
      {
        ...
        break label989;
        localTracePathData = this.jdField_a_of_type_ComTencentMobileqqVashealthPathTraceManager.a(this.jdField_a_of_type_Long);
        break;
        label447:
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        ((NewIntent)localObject2).setObserver(new ajvs(this, localJSONObject, localList, localThrowable, localSharedPreferences, localOrbitReq));
