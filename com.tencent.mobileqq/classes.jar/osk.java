...
public class osk
  implements bjvm
{
  public osk(ReadInJoyCommentComponentFragment paramReadInJoyCommentComponentFragment) {}
  ...
  public View onCreatePanel(int paramInt)
  {
    ...
    if (paramInt == 3)
    {
      ...
      {
        this.a.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel = ((EmoticonMainPanel)View.inflate(ReadInJoyCommentComponentFragment.a(this.a), 2131559130, null));
    ...
    {
      this.a.jdField_a_of_type_ComTencentMobileqqHotpicPublicAccountHotPicPanel = ((PublicAccountHotPicPanel)View.inflate(ReadInJoyCommentComponentFragment.a(this.a), 2131559617, null));
