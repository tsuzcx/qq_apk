  ...
  implements abqx
{
  ...
  public static GdtMotiveVideoPageData a(qq_ad_get.QQAdGetRsp.AdInfo paramAdInfo, int paramInt)
  {
    ...
    if ((localGdtAd != null) && (localGdtAd.info != null))
    {
      ...
      abrl.d("GdtOpenMvPageHandler", "VideoUrl " + localGdtMotiveVideoPageData.url);
      Object localObject1;
      if (localGdtAd.getImageData() == null)
      {
        ...
        if (paramAdInfo != null) {
          localObject1 = abrk.a(paramAdInfo);
        }
  ...
  public void a(GdtMotiveVideoPageData paramGdtMotiveVideoPageData, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (paramGdtMotiveVideoPageData != null)
    {
      ...
      if (str != null)
      {
        ...
        {
          paramGdtMotiveVideoPageData = (abqc)this.jdField_a_of_type_JavaLangRefWeakReference.get();
          if (paramGdtMotiveVideoPageData != null)
          {
  ...
  public boolean a(abqc paramabqc, String paramString, String... paramVarArgs)
  {
    ...
    {
      abrl.d("GdtOpenMvPageHandler", "GdtOpenMvPageHandler error");
      return true;
    }
    String str2 = "";
    for (;;)
    {
      try
      {
        abrl.a("GdtOpenMvPageHandler", "args = " + paramVarArgs[0]);
      ...
      catch (Throwable localThrowable1)
      {
        try
        {
          ...
          k = i;
          paramVarArgs = (qq_ad_get.QQAdGetRsp.AdInfo)qq_ad_get.QQAdGetRsp.AdInfo.class.cast(abrk.a(new qq_ad_get.QQAdGetRsp.AdInfo(), new JSONObject(paramVarArgs)));
        }
        ...
        try
        {
          ...
          if (localGdtMotiveVideoPageData != null)
          {
            ...
            GdtMotiveVideoFragment.b(paramabqc.a(), GdtMotiveVideoFragment.class, localGdtMotiveVideoPageData);
          }
          if (paramabqc == null) {
            break label377;
          }
