  ...
  implements afal
{
  ...
  public afbc(BaseChatPie paramBaseChatPie)
  {
  ...
  {
    String str1;
    if ((paramSessionInfo != null) && (paramSessionInfo.jdField_a_of_type_Aemb != null))
    {
      ...
      if (paramSessionInfo.jdField_a_of_type_Aemb.a == null) {
        break label335;
      }
      if ((paramSessionInfo.jdField_a_of_type_Aemb.a instanceof apgf)) {
    ...
    for (;;)
    {
      ...
      {
        ((bdqa)paramQQAppInterface.getManager(235)).a.a(i, new afbd(this, i));
        paramSessionInfo = paramSessionInfo + "-effect";
        label181:
        QAPM.setABFactor("AIO背景", paramSessionInfo, abqt.class);
      }
      do
      {
        return;
        if (!(paramSessionInfo.jdField_a_of_type_Aemb.a instanceof URLDrawable)) {
          break label335;
        }
        ...
        {
          paramContext = aemb.a(paramContext, str2, str1);
