...
class aghb
  extends aghd
{
  public aghb(aggy paramaggy, Context paramContext, ViewGroup paramViewGroup)
  {
  ...
  {
    Object localObject1 = new RelativeLayout.LayoutParams(this.jdField_a_of_type_Aggv.itemView.getWidth() - (int)(2.0F * this.jdField_a_of_type_Aggy.e + 0.5F), this.jdField_a_of_type_Aggv.itemView.getHeight() - (int)(2.0F * this.jdField_a_of_type_Aggy.e + 0.5F) * 2);
    ((RelativeLayout.LayoutParams)localObject1).leftMargin = (this.jdField_c_of_type_ArrayOfInt[0] + (int)(2.0F * this.jdField_a_of_type_Aggy.e + 0.5F));
    this.jdField_a_of_type_AndroidViewViewGroup.getLocationInWindow(this.jdField_b_of_type_ArrayOfInt);
    ((RelativeLayout.LayoutParams)localObject1).topMargin = (this.jdField_c_of_type_ArrayOfInt[1] - this.jdField_b_of_type_ArrayOfInt[1] - this.jdField_a_of_type_Aggy.jdField_a_of_type_Int + (int)(2.0F * this.jdField_a_of_type_Aggy.e + 0.5F));
    ...
    {
    default: 
      f1 = this.jdField_a_of_type_Aggy.a(paramInt, this.jdField_a_of_type_Aggv.itemView.getWidth() - (int)(4.0F * this.jdField_a_of_type_Aggy.e), this.jdField_a_of_type_Aggv.itemView.getHeight() - (int)(4.0F * this.jdField_a_of_type_Aggy.e));
      awen.a("PhotoListPanel", "startFlingAnim", "f scale = " + f1);
      j = this.jdField_a_of_type_Aggy.jdField_a_of_type_ArrayOfInt[0] - (int)(65.0F * this.jdField_a_of_type_Aggy.e + 0.5F + this.jdField_a_of_type_Aggv.itemView.getWidth() * f1 + 0.5F) - this.jdField_c_of_type_ArrayOfInt[0];
      paramInt = this.jdField_a_of_type_AndroidViewViewGroup.getHeight();
      i = this.jdField_a_of_type_Aggy.jdField_a_of_type_ArrayOfInt[1];
      k = this.jdField_a_of_type_Aggy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.getHeight();
      int n = (int)(13.0F * this.jdField_a_of_type_Aggy.e + 0.5F + this.jdField_a_of_type_Aggv.itemView.getHeight() * f1 + 0.5F);
      int i1 = this.jdField_c_of_type_ArrayOfInt[1];
      m = ((RelativeLayout.LayoutParams)localObject1).topMargin - (int)(30.0F * this.jdField_a_of_type_Aggy.e);
      ...
      {
        paramInt = k - (int)(70.0F * this.jdField_a_of_type_Aggy.e + 0.5F);
        i = j;
      }
      break;
    }
    for (;;)
    {
      ...
      ((AnimationSet)localObject1).setAnimationListener(new aghc(this));
      return true;
      f1 = this.jdField_a_of_type_Aggy.a(paramInt, this.jdField_a_of_type_Aggv.itemView.getHeight() - (int)(4.0F * this.jdField_a_of_type_Aggy.e));
      break;
      paramInt = k;
      i = j;
      if (PhotoListPanel.g() == 1) {
        ...
        {
          paramInt = k - (int)((this.jdField_a_of_type_Aggv.itemView.getHeight() - (int)(4.0F * this.jdField_a_of_type_Aggy.e)) * 0.5F * (f2 - 1.0F) * f1);
          i = j;
        }
        else
        {
          i = j - (int)((this.jdField_a_of_type_Aggv.itemView.getHeight() - (int)(4.0F * this.jdField_a_of_type_Aggy.e)) * 0.5F * (1.0F / f2 - 1.0F) * f1);
          paramInt = k;
        }
      }
    }
  ...
  {
    this.jdField_a_of_type_Aggy.jdField_a_of_type_AndroidViewVelocityTracker.addMovement(paramMotionEvent);
    return true;
  }
  ...
  boolean b(MotionEvent paramMotionEvent)
  {
    ...
    float f3 = f2 - this.jdField_a_of_type_Aggy.jdField_b_of_type_Float;
    float f4 = this.jdField_a_of_type_Aggy.jdField_a_of_type_Float;
    int i = paramMotionEvent.getPointerId(0);
    this.jdField_a_of_type_Aggy.jdField_a_of_type_AndroidViewVelocityTracker.computeCurrentVelocity(1000);
    float f5 = this.jdField_a_of_type_Aggy.jdField_a_of_type_AndroidViewVelocityTracker.getYVelocity(i);
    awen.a("PhotoListPanel", "FlingHandler", "@@handleUp,x = " + f1 + ",y = " + f2 + ",delY = " + f3 + ",velocityY = " + f5 + ",SWIPE_THRESHOLD = " + aggy.b());
    if ((-f3 > aggy.b()) && (Math.abs(f5) > 100.0F) && (SystemClock.elapsedRealtime() - this.jdField_a_of_type_Aggy.jdField_a_of_type_Long < 500L) && ((this.jdField_a_of_type_Aggy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.l == 1) || (this.jdField_a_of_type_Aggy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.l == 0)) && (Math.abs(f3) > Math.abs(f1 - f4)))
    {
      if (this.jdField_a_of_type_Aggy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aggt.a.size() == 0)
      {
        awen.a("PhotoListPanel", "handleUp", "handler = " + this + "mInfos is null!!!!!! targetPosition=" + this.jdField_b_of_type_Int);
        return false;
      }
      ...
      {
        awen.a("PhotoListPanel", "handleUp", "handler  animLayout already hasparent= ");
        return false;
      }
      i = this.jdField_a_of_type_Aggy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aggt.getItemViewType(this.jdField_b_of_type_Int);
      paramMotionEvent = new ArrayList();
      paramMotionEvent.add(this.jdField_a_of_type_Aggy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_Aggt.a(this.jdField_b_of_type_Int).path);
      ...
      {
        paramMotionEvent = this.jdField_a_of_type_Aggy.jdField_a_of_type_Aggx;
      ...
      for (;;)
      {
        ...
        bool = false;
        break;
        this.jdField_a_of_type_Aggy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.a(this.jdField_b_of_type_Int, paramMotionEvent, false, true, "0X8005E0D", "1", i + "", false);
      }
    }
    awen.a("PhotoListPanel", "FlingHandler", "@handleUp,return false. velocityY = " + f5 + ",dely = " + (f2 - this.jdField_a_of_type_Aggy.jdField_b_of_type_Float));
