  ...
  implements xny
{
  ...
  public void a(String paramString)
  {
    ...
    for (int i = 1;; i = 0)
    {
      QWalletCommonServlet.a(new VoiceRedPackMatchReq(l1, str1, str2, l2, paramString, l3, j, localGroupVoiceInfo, 0, localC2CVoiceInfo, "7.6.8", new VoiceMatchStatus(i, this.jdField_a_of_type_ComTencentMobileqqActivityQwalletVoiceVoiceRedPacketHelper.b, this.jdField_a_of_type_ComTencentMobileqqActivityQwalletVoiceVoiceRedPacketHelper.jdField_c_of_type_Int, VoiceRecognizer.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))), new xnv(this, System.currentTimeMillis()));
