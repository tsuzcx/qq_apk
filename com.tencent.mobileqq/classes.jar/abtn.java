...
public class abtn
  extends aimb
{
  public LinkedHashMap<String, List<abtm>> a;
  public int[] a;
  public String[] a;
  
  public abtn(PublicAccountListActivity paramPublicAccountListActivity)
  {
  ...
  private void b()
  {
    ...
    for (;;)
    {
      ...
      {
        abtm localabtm = (abtm)((Iterator)localObject2).next();
        if (!PublicAccountListActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityPublicAccountListActivity, localabtm))
        {
          if ((localabtm.jdField_a_of_type_JavaLangString == null) || (localabtm.jdField_a_of_type_JavaLangString.length() == 0))
          {
            localObject1 = "#";
          ...
          for (localObject1 = ((String)localObject1).toUpperCase();; localObject1 = "#")
          {
            ...
            ((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(localObject1)).add(localabtm);
            break;
            localObject1 = localabtm.jdField_a_of_type_JavaLangString.substring(0, 1);
            break label89;
          }
        }
      }
  ...
  public Object getItem(int paramInt)
  {
    ...
    i = -(i + 1) - 1;
    return (abtm)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      i = -(i + 1) - 1;
      localObject = (abtm)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
      paramViewGroup.jdField_a_of_type_Abtm = ((abtm)localObject);
      paramViewGroup.jdField_a_of_type_JavaLangString = String.valueOf(((abtm)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.uin);
      paramViewGroup.jdField_a_of_type_AndroidViewView.setVisibility(0);
      paramViewGroup.f.setVisibility(8);
      paramViewGroup.d.setVisibility(0);
      paramViewGroup.d.setText(((abtm)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name);
      if (((abtm)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.certifiedGrade <= 0L) {
        break label650;
      }
      ...
      label379:
      paramViewGroup.e.setText(((abtm)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.summary);
      ...
      if (((abtm)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.extendType != 2) {
        break label796;
      }
    }
    label650:
    label796:
    for (boolean bool = nbc.a(this.jdField_a_of_type_ComTencentMobileqqActivityPublicAccountListActivity.app, ((abtm)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin(), 1024);; bool = false)
    {
      if (bool)
      {
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setTag(-1, ((abtm)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.getUin());
        paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setTag(-2, ((abtm)localObject).jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo.name);
      ...
      do
      {
        ...
        break label504;
        paramViewGroup.jdField_a_of_type_Abtm = null;
