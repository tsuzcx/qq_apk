...
public class asmi
{
  ...
  public static Pair<StringBuilder, StringBuilder> a(Context paramContext, File paramFile)
  {
    ...
    a = true;
    paramContext = xwb.a(Uri.parse("file://" + paramFile.getAbsolutePath()), paramContext);
    a = false;
    return paramContext;
  }
  ...
  public static String a(String paramString)
  {
    ...
    //   85: invokestatic 157	bdcv:a	([B)Ljava/lang/String;
    //   88: astore_2
  ...
  public static msg_ctrl.MsgCtrl a(String paramString)
  {
    ...
    Object localObject2;
    long l2;
    if ((asmt.a().f()) && (!TextUtils.isEmpty(paramString)))
    {
    ...
    for (;;)
    {
      ...
      azmz.a(BaseApplicationImpl.getContext()).a(null, "act_getMsgCtrlForPicMsg", true, 0L, 0L, localHashMap, "");
      return localMsgCtrl;
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  {
    Object localObject = asmt.a();
    if (!((asmt)localObject).e()) {}
    String str;
    do
    {
      return false;
      str = ((asmt)localObject).a();
      localObject = ((asmt)localObject).b();
