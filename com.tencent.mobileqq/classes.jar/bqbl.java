  ...
  extends bqeb
{
  ...
  private static final String jdField_b_of_type_JavaLangString = anzj.a(2131702376);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bqbl.class.getSimpleName();
  }
  
  public bqbl(bqgk parambqgk, long paramLong)
  {
  ...
  private void a(String paramString)
  {
    ...
    for (int i = 1;; i = 2)
    {
      bdll.b(null, "dc00899", "Grp_tribe", "", "video_edit", paramString, i, 0, "", "", "", "");
      return;
    }
  }
  ...
  private void b(String paramString)
  {
    ...
    for (;;)
    {
      paramString.setSpan(new zuc(a(), 2130842559), 0, 1, 33);
  ...
  private void j()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(new bqbm(this));
      return;
      b(jdField_b_of_type_JavaLangString);
    }
  }
  ...
  {
    super.a();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)a(2131364062));
    this.jdField_a_of_type_AndroidViewView = ((ImageView)a(2131379182));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)a(2131365109));
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetTextView.setText(anzj.a(2131702375));
    this.jdField_b_of_type_AndroidWidgetTextView = new TextView(a());
    this.jdField_b_of_type_AndroidWidgetTextView.setGravity(17);
    this.jdField_b_of_type_AndroidWidgetTextView.setMaxWidth(bhgr.a(a(), 192.0F));
    ...
    int i = bhgr.a(a(), 10.0F);
    this.jdField_b_of_type_AndroidWidgetTextView.setPadding(i, 0, i, 0);
    this.jdField_b_of_type_AndroidWidgetTextView.setBackgroundResource(2130842560);
    Object localObject = new RelativeLayout.LayoutParams(-2, bhgr.a(a(), 28.0F));
    ((RelativeLayout.LayoutParams)localObject).addRule(11);
    ((RelativeLayout.LayoutParams)localObject).addRule(15);
    ((RelativeLayout.LayoutParams)localObject).rightMargin = bhgr.a(a(), 10.0F);
    ...
    localObject = bfek.a(((EditVideoParams)((Activity)a()).getIntent().getParcelableExtra(EditVideoParams.class.getName())).a);
    if (localObject != null)
    {
