...
{
  public ahdv(UniteSearchActivity paramUniteSearchActivity) {}
  
  public void a(SearchEntryDataModel paramSearchEntryDataModel)
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.uniteSearch.UniteSearchActivity", 2, "handleContentRecommendResult() result = " + paramSearchEntryDataModel);
    }
    if (this.a.jdField_a_of_type_ComTencentMobileqqSearchFragmentSearchEntryFragment != null) {
      this.a.jdField_a_of_type_ComTencentMobileqqSearchFragmentSearchEntryFragment.a(paramSearchEntryDataModel);
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.w("Q.uniteSearch.UniteSearchActivity", 2, "handleContentRecommendError error, resultCode = " + paramInt + ",  errorMsg = " + paramString);
    }
  }
