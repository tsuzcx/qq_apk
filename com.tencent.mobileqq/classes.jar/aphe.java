  ...
  implements Handler.Callback
{
  ...
  private void b()
  {
    ...
    try
    {
      ...
      {
        this.jdField_a_of_type_Aphf.c();
        this.jdField_a_of_type_Aphf = null;
      }
      return;
    }
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Aphf != null) {
          this.jdField_a_of_type_Aphf.a(2);
        }
      }
    }
  }
  ...
  private void b(long paramLong)
  {
    ...
    catch (Exception localException)
    {
      ...
      } while (this.jdField_a_of_type_Aphf == null);
      this.jdField_a_of_type_Aphf.a(4);
    }
  }
  ...
  private void b(byte[] paramArrayOfByte, long paramLong)
  {
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      this.jdField_a_of_type_Aphf.a(3);
    }
  }
  ...
  public void a(bbmc parambbmc, aphf paramaphf)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqArARRecordVideoEncoderCore.a(parambbmc, paramaphf);
      if (this.jdField_a_of_type_Aphf != null) {
        this.jdField_a_of_type_Aphf.a();
      }
      return;
    }
    catch (Exception parambbmc)
    {
      for (;;)
      {
        QLog.e("VideoEncoder", 1, "startRecording start encoder fail.", parambbmc);
        if (this.jdField_a_of_type_Aphf != null) {
          this.jdField_a_of_type_Aphf.a(1);
        }
      }
    }
  }
