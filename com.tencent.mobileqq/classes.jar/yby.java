  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public yby(Activity paramActivity, String paramString1, String paramString2, int paramInt1, WeakReference<AppInterface> paramWeakReference, int paramInt2)
  {
  ...
  {
    if (!bbxo.d((AppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get())) {
      return -1002;
    }
    bbxo.d(null);
    ...
    ((bbwq)localObject).jdField_b_of_type_JavaLangString = paramString1;
    ((bbwq)localObject).jdField_a_of_type_JavaLangString = paramString2;
    ...
    for (;;)
    {
      ...
      i = AudioEncoder.a((bbwq)localObject);
  ...
  protected void a(Integer paramInteger)
  {
    ...
    a(amtj.a(2131715374) + paramInteger, null);
  }
  
  protected void onPreExecute()
  {
    a(this.jdField_a_of_type_AndroidAppActivity, 2131694451);
  }
}
