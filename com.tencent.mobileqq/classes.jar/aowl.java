  ...
  implements View.OnClickListener
{
  ...
  private TextWatcher jdField_a_of_type_AndroidTextTextWatcher = new aowm(this);
  ...
  public aowl(Context paramContext, ViewGroup paramViewGroup, QQAppInterface paramQQAppInterface, XEditTextEx paramXEditTextEx)
  {
  ...
  {
    View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559457, this.jdField_a_of_type_AndroidViewViewGroup, false);
    ...
    paramString.leftMargin = aekt.a(14.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131364137)).addView(localView, paramString);
    return localView;
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if ((paramView instanceof aowk))
    {
      paramView = ((aowk)paramView).a();
      if (!TextUtils.isEmpty(paramView))
      {
        ...
        arrayOfnad[0] = new nad(this.jdField_a_of_type_AndroidViewViewGroup, new aown(this, arrayOfnad));
        this.jdField_a_of_type_AndroidViewView.setOnClickListener(new aowo(this, paramView));
      }
    }
  }
}
