  ...
  implements QQTextEjectaFilter.EjectaTextureCallBack
{
  ...
  public int[] onDrawFrame()
  {
    ...
    arrayOfInt1[0] = bjrh.a(this.a).getCanvasTexture("offscreen_richard");
    if (((bjrh.a(this.a) != null) || (bjrh.a(this.a).f)) && (!bjrh.a(this.a)))
    {
      if (bjrh.a(this.a) == 0) {
        bjrh.a(this.a, GlUtil.createTexture(3553, bjrh.a(this.a)));
      }
      arrayOfInt1[1] = bjrh.a(this.a);
      arrayOfInt2[1] = 1;
    }
    bjrh.a(this.a).setIsNeedReverseTexture(arrayOfInt2);
    return arrayOfInt1;
  }
}
