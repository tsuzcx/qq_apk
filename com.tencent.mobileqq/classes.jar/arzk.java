  ...
  implements afal, Handler.Callback
{
  ...
  final awfy jdField_a_of_type_Awfy = new arzl(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alpo.a(2131719913);
  }
  
  public arzk(BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = new arzo(this);
  ...
  public static bdfq a(Activity paramActivity, bdfq parambdfq, BaseChatPie paramBaseChatPie, long paramLong, int paramInt, String paramString)
  {
    ...
    String str = ((QQAppInterface)localObject).getApplication().getString(2131719909);
    if (paramString != null) {}
    for (paramString = str + paramString;; paramString = str)
    {
      str = ((QQAppInterface)localObject).getApplication().getString(2131719915);
      localObject = ((QQAppInterface)localObject).getApplication().getString(2131719910);
      arzm localarzm = new arzm(paramLong, paramInt, paramActivity);
      arzn localarzn = new arzn(paramLong, paramInt, paramActivity, paramBaseChatPie);
      paramBaseChatPie = parambdfq;
      if (parambdfq == null) {
        paramBaseChatPie = bdcd.a(paramActivity, 232, null, str, paramString, (String)localObject, localarzm, localarzn);
      }
      paramBaseChatPie.setNegativeButton(paramString, localarzn);
      paramBaseChatPie.setPositiveButton((String)localObject, localarzm);
      try
      {
        paramBaseChatPie.show();
        return paramBaseChatPie;
      }
      catch (Throwable parambdfq)
      {
      ...
      QLog.e("ForwardShareByServerHelper", 2, "qbShowShareResultDialog: failed. ", parambdfq);
      return paramBaseChatPie;
    }
  }
  ...
  private AbsStructMsg a()
  {
    ...
    return azqu.a(localIntent.getByteArrayExtra("stuctmsg_bytes"));
  }
  ...
  public static String a(Context paramContext, String paramString)
  {
    try
    {
      ...
      paramContext = bdcv.a(paramString.digest());
  ...
  public static oidb_cmd0xb77.ReqBody a(Bundle paramBundle, String paramString1, String paramString2, oidb_cmd0xb77.ImageInfo paramImageInfo)
  {
    ...
    if (i == 0)
    {
      ...
      {
        paramBundle = str1;
        if (str1.contains(alpo.a(2131705190))) {
          paramBundle = str1.replace(alpo.a(2131705217), "");
        }
  ...
  public static void a(long paramLong, int paramInt, Activity paramActivity)
  {
    ...
    bfdq.a().a(((QQAppInterface)localObject1).getAccount(), "", String.valueOf(paramLong), "1000", "52", "0", false);
  ...
  public static void a(long paramLong, int paramInt, Activity paramActivity, BaseChatPie paramBaseChatPie)
  {
    ...
    bfdq.a().a(localQQAppInterface.getAccount(), "", String.valueOf(paramLong), "1000", "51", "0", false);
  ...
  private void a(Bundle paramBundle)
  {
    ...
    paramBundle = azqu.a(paramBundle);
    if ((paramBundle != null) && ((paramBundle instanceof AbsShareMsg))) {}
    for (paramBundle = (AbsShareMsg)paramBundle;; paramBundle = null)
    {
      this.jdField_a_of_type_Bdfq = a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bdfq, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, paramBundle.mSourceAppid, paramBundle.mMsgServiceID, str);
      return;
    }
  }
  ...
  public static void a(Bundle paramBundle, int paramInt, long paramLong)
  {
    if ((paramBundle != null) && (paramBundle.getBoolean("forward_mini_program_ark_from_sdk", false))) {
      azmj.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "dc00898", "", "", "0X8009F7C", "0X8009F7C", 0, 0, "1", "", "", "");
    }
    ...
    for (;;)
    {
      try
      {
        ...
        {
        default: 
          bfja.a().a(0, "SHARE_TO_QQ", localQQAppInterface.getCurrentAccountUin(), String.valueOf(paramLong), String.valueOf(i), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, null);
          if (paramInt != 1) {
            break label327;
          }
          paramBundle = "1";
      ...
      bfdq.a().a(localQQAppInterface.getAccount(), "", paramLong + "", "10", "12", "0", paramBundle, str2, str1, false);
      if (QLog.isColorLevel())
      {
  ...
  private void a(Bundle paramBundle, String paramString1, String paramString2)
  {
    ...
    mzy.a(paramString2, new arzr(this, paramBundle), paramString1.toByteArray(), "OidbSvc.0xb77_9", 2935, 9, localBundle, 0L);
  }
  
  private void a(awfy paramawfy, AbsStructMsg paramAbsStructMsg)
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    Object localObject = new WeakReference(paramawfy);
    ...
    paramawfy = this.jdField_a_of_type_AndroidOsBundle.getString("uin");
    ...
    localObject = (awfy)((WeakReference)localObject).get();
    ...
    AbsShareMsg.sendSdkShareMessageByServer(localQQAppInterface, (AbsShareMsg)paramAbsStructMsg, paramawfy, i, str, (awfy)localObject);
  }
  ...
  public static boolean a()
  {
    aokp localaokp = aokq.a();
    if (localaokp != null) {}
    for (boolean bool = localaokp.a();; bool = false)
    {
  ...
  public static boolean b()
  {
    aokp localaokp = aokq.a();
    if (localaokp != null) {}
    for (boolean bool = localaokp.b();; bool = false)
    {
  ...
  private void e()
  {
    ...
    if (this.jdField_a_of_type_AndroidOsBundle != null)
    {
      ...
      {
        localObject = azqu.a(this.jdField_a_of_type_AndroidOsBundle);
    ...
    {
      this.jdField_a_of_type_Bdfq = a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bdfq, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, ((AbsShareMsg)localObject).mSourceAppid, ((AbsShareMsg)localObject).mMsgServiceID, str);
  ...
  private void f()
  {
    ...
    {
      this.jdField_a_of_type_AndroidContentBroadcastReceiver = new arzq(this);
  ...
  protected void a(int paramInt, String paramString1, String paramString2)
  {
    ...
    paramString1 = new arzp(this, paramInt, paramString2);
    this.jdField_b_of_type_Bdfq.setPositiveButton(2131694951, paramString1);
    ...
    for (boolean bool = ((Bundle)localObject).getBoolean("share_send_msg_by_server", false);; bool = false)
    {
      ...
      if (bool)
      {
        ...
        if ((localObject instanceof AbsShareMsg))
        {
          ...
          azmj.b(null, "dc00898", "", "", "0X8009C93", "0X8009C93", 0, 0, "", str1, str2, paramIntent);
          d();
          a(this.jdField_a_of_type_Awfy, (AbsStructMsg)localObject);
        }
      }
      do
      {
      ...
      localObject = arwa.a((String)localObject);
