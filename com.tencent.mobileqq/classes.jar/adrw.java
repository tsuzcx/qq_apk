...
{
  public adrw(NewAuthDevUgFragment paramNewAuthDevUgFragment) {}
  ...
  public void onReceive(VerifyDevLockManager.NotifyType paramNotifyType, int paramInt, Object paramObject)
  {
    ...
    {
      avit.a(NewAuthDevUgFragment.a(this.a), paramNotifyType, 3, NewAuthDevUgFragment.b(this.a));
      return;
      bool = false;
      break;
      label202:
    ...
    if (paramNotifyType == VerifyDevLockManager.NotifyType.NOTIFY_CHECK_SELF_PHONE)
    {
      ...
      if (paramInt == 241)
      {
        ...
        for (paramNotifyType = (QQAppInterface)NewAuthDevUgFragment.a(this.a);; paramNotifyType = null)
        {
          avit.a(NewAuthDevUgFragment.a(this.a), paramNotifyType, 5, NewAuthDevUgFragment.b(this.a));
          return;
        }
      }
      if (paramInt == 242)
  ...
  public void onVerifyClose(int paramInt1, String paramString, int paramInt2, ErrMsg paramErrMsg)
  {
    ...
    if (paramInt2 == 0)
    {
      ...
      NewAuthDevUgFragment.a(this.a).setText(2131691901);
      ...
      if ((NewAuthDevUgFragment.a(this.a) instanceof QQAppInterface))
      {
        ...
        avit.a(NewAuthDevUgFragment.a(this.a), paramString, 4, NewAuthDevUgFragment.b(this.a));
        if (!(NewAuthDevUgFragment.a(this.a) instanceof QQAppInterface)) {
          break label297;
        }
      }
      ...
      {
        bcef.a(paramString, "dc00898", "", NewAuthDevUgFragment.b(this.a), "0X800AEFB", "0X800AEFB", 0, 0, "", "", "", "");
        return;
        paramString = null;
        break;
      }
    ...
    for (paramString = (QQAppInterface)NewAuthDevUgFragment.a(this.a);; paramString = null)
    {
      avit.a(NewAuthDevUgFragment.a(this.a), paramString, 3, NewAuthDevUgFragment.b(this.a));
      return;
    }
  }
}
