  ...
  extends atdk
{
  protected void e(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    {
      int i = awqu.a().decrementAndGet();
      awqu.a(0);
      AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
      localAppRuntime.getPreferences().edit().putInt(localAppRuntime.getAccount() + "_" + "qzone_xp_req_left", i).apply();
      awqu.b(((mobile_get_qzone_public_msg_rsp)paramBundle).next_req_tmstamp);
      if (QLog.isColorLevel()) {
        QLog.i("QZoneReport", 2, "next req time: " + awqu.b() + ", left: " + i);
      }
      awqx.b(null, "CliOper", "", "", "0X800915D", "0X800915D", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      awqu.a().set(false);
      BaseApplicationImpl.getApplication().getRuntime().unRegistObserver(awqu.a());
      return;
      awqu.c();
      if (QLog.isColorLevel()) {
