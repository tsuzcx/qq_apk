  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  private awmx jdField_a_of_type_Awmx;
  ...
  public awfz(QQAppInterface paramQQAppInterface, Context paramContext, MessageForShortVideo paramMessageForShortVideo, awgc paramawgc)
  {
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    Object localObject1 = awfu.a((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get());
    awfx localawfx = awfu.a(paramString1);
    awfy.a(localawfx);
    boolean bool = awfu.a(localawfx, (awfw)localObject1);
    this.jdField_b_of_type_Boolean = bool;
    if (QLog.isColorLevel()) {
      QLog.d("VideoCompressProcessor", 1, "CompressTask, isNeedCompress = " + bool);
    }
    if (this.jdField_a_of_type_Awgc != null) {
      befn.a(new VideoCompressProcessor.CompressTask.1(this, bool));
    }
    if (!bool) {
      return -1;
    }
    localObject1 = awfu.a(localawfx, (awfw)localObject1, this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.sendRawVideo);
    int i = awif.a((Context)this.jdField_b_of_type_JavaLangRefWeakReference.get());
    Object localObject2;
    label290:
    label380:
    long l1;
    ...
    if ((Build.VERSION.SDK_INT >= 18) && ((i & 0x1) > 0) && ((i & 0x2) > 0))
    {
      ...
      localObject2 = new awgd(this.jdField_a_of_type_JavaLangRefWeakReference, paramString1, paramString2, (awfv)localObject1, new awga(this));
      this.jdField_a_of_type_Awmx = new awmx();
      if ((!this.jdField_a_of_type_Awmx.a(new File(paramString1), (awmy)localObject2, true)) || (((awgd)localObject2).a != null)) {
        break label567;
      }
      if (QLog.isColorLevel()) {
      ...
      localObject2 = new awgb(this);
      i = ShortVideoTrimmer.a((Context)this.jdField_b_of_type_JavaLangRefWeakReference.get(), paramString1, paramString2, (QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (awmj)localObject2, (awfv)localObject1, localawfx);
      if (i != 0) {
        break label626;
      }
    ...
    {
      awfy.a(bool, l3, localawfx, (awfv)localObject1, l2);
      if (QLog.isColorLevel()) {
      ...
      label586:
      if (this.jdField_a_of_type_Awgc != null) {
        this.jdField_a_of_type_Awgc.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, 1.0F);
      }
      if (QLog.isColorLevel()) {
      ...
      awrn.a(BaseApplication.getContext()).a(null, "initVideoTrimError", true, 0L, 0L, null, "", false);
      break label380;
  ...
  protected Integer a(Void... paramVarArgs)
  {
    ...
    if ((TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.videoFileName)) || (!bace.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.videoFileName)))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((TextUtils.isEmpty(this.c)) || (!bace.b(this.c)))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        this.jdField_b_of_type_JavaLangString = bach.a(MD5.toMD5Byte(new FileInputStream(paramVarArgs), this.jdField_a_of_type_Long));
      ...
      catch (Exception paramVarArgs)
      {
        ...
        if (this.jdField_a_of_type_Long < 104345600L)
        {
          ...
          bace.a(new File(this.c), new File(ShortVideoUtils.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, "mp4")));
        }
      }
    }
  ...
  public void a(awgc paramawgc)
  {
    ...
    do
    {
      do
      {
        ...
        } while (this.jdField_a_of_type_Awgc == null);
        this.jdField_a_of_type_Awgc.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, 1);
        return;
        if (!isCancelled()) {
          break;
        }
      } while (this.jdField_a_of_type_Awgc == null);
      this.jdField_a_of_type_Awgc.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, 3);
      return;
    } while (this.jdField_a_of_type_Awgc == null);
    this.jdField_a_of_type_Awgc.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, this.jdField_b_of_type_Boolean);
  }
  ...
  protected void a(Integer paramInteger)
  {
    ...
    if (this.jdField_a_of_type_Awgc != null)
    {
      awgc localawgc = this.jdField_a_of_type_Awgc;
      MessageForShortVideo localMessageForShortVideo = this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo;
      if (paramInteger.intValue() == 1) {
        i = 1;
      }
      localawgc.a(localMessageForShortVideo, i);
    }
    while (paramInteger.intValue() == 1)
    {
      adoi.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, (QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (Context)this.jdField_b_of_type_JavaLangRefWeakReference.get());
      return;
      if (QLog.isColorLevel()) {
        QLog.d("VideoCompressProcessor", 2, "onPostExecute, mListener is null ," + b());
      }
    }
    adoi.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo, (QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (Context)this.jdField_b_of_type_JavaLangRefWeakReference.get());
  }
  
  public boolean a()
  {
    if (this.jdField_a_of_type_Awmx != null) {}
    for (boolean bool = this.jdField_a_of_type_Awmx.a();; bool = false) {
      try
      {
        if (this.jdField_a_of_type_JavaLangProcess != null) {
          this.jdField_a_of_type_JavaLangProcess.destroy();
  ...
  protected void onCancelled()
  {
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)
    {
      ...
      if (!TextUtils.isEmpty(localMessageForShortVideo.md5)) {
        bace.d(ShortVideoUtils.a(localMessageForShortVideo, "mp4"));
      }
      ...
      avau.a((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), localMessageForShortVideo.frienduin, localMessageForShortVideo.uniseq);
    ...
    for (Object localObject = ShortVideoUtils.d(this.jdField_a_of_type_JavaLangString, "mp4");; localObject = ShortVideoUtils.c(this.jdField_a_of_type_JavaLangString, "mp4"))
    {
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        bace.d((String)localObject);
      }
      awfy.a().a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo.uniseq);
      if (QLog.isColorLevel()) {
