...
public class alep
{
  ...
  public static String a(String[] paramArrayOfString)
  {
    ...
    for (;;)
    {
      ...
      str2 = paramArrayOfString[attl.a(paramArrayOfString.length)];
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          ((JSONObject)localObject).put("atlas", albu.a(paramInt + "/role", 1));
          ((JSONObject)localObject).put("json", albu.a(paramInt + "/role", 1));
          continue;
      ...
      localJSONObject2.put("atlas", albu.a(localInteger + "/dress", 2));
      localJSONObject2.put("json", albu.a(localInteger + "/dress", 2));
    }
    localJSONObject1.put("dressPath", localException1);
    return localJSONObject1;
  }
  
  public static void a(int paramInt1, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt2, String paramString3, alev paramalev)
  {
    akji localakji = (akji)paramQQAppInterface.getManager(153);
    Object localObject = localakji.b(paramString1);
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (localObject.length > 0))
      {
        ...
        if (paramInt2 < j)
        {
          aknx localaknx = localObject[paramInt2];
          i = localaknx.jdField_b_of_type_Int;
          int[] arrayOfInt = localaknx.a();
          if ((albu.a(paramString1, localaknx.jdField_a_of_type_Int, arrayOfInt, paramQQAppInterface, new alet(paramalev, paramInt1, paramQQAppInterface, paramString2, paramString3, localaknx, arrayOfInt))) && (localaknx.jdField_a_of_type_Int != 0))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ApolloGameBasicEventUtil", 2, "valid role and dress RSC.");
            }
            if (paramalev != null) {
              paramalev.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, localaknx.jdField_a_of_type_Int, arrayOfInt, 3);
            }
          }
        }
      }
      ...
      for (;;)
      {
        ...
        if (paramalev != null)
        {
          ...
          {
            paramInt2 = 2;
            paramalev.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, paramInt2, akzg.a(paramInt2), 1);
          }
        }
        else
        {
          akji.a(paramQQAppInterface, paramString1, "apllo_game");
          paramQQAppInterface = (aloz)paramQQAppInterface.getManager(51);
          if ((paramQQAppInterface == null) || (paramQQAppInterface.b(paramString1))) {
            continue;
          }
          paramQQAppInterface = localakji.b(paramString1);
        ...
        for (long l = paramQQAppInterface.apolloUpdateTime;; l = 0L)
        {
          ...
          paramalev.a(paramInt1, paramQQAppInterface, paramString1, paramString2, paramString3, 1, akzg.a(1), 1);
          break label282;
        }
      }
    }
  ...
  public static void a(int paramInt, String paramString, Activity paramActivity)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localaliq = new aliq();
        localObject1 = akro.a(paramInt);
        if (localObject1 != null)
        {
          localObject1 = ((aktr)localObject1).a();
          if ((localObject1 != null) && (((CmGameStartChecker.StartCheckParam)localObject1).game != null))
          {
            localaliq.jdField_b_of_type_Int = ((CmGameStartChecker.StartCheckParam)localObject1).game.actionId;
            localaliq.jdField_b_of_type_JavaLangString = ((CmGameStartChecker.StartCheckParam)localObject1).game.name;
          }
        }
        if (localaliq.jdField_b_of_type_Int <= 0) {
          localaliq.jdField_b_of_type_Int = 439;
        }
        localaliq.jdField_a_of_type_Int = paramInt;
        localaliq.jdField_a_of_type_JavaLangString = alpo.a(2131700739);
        localaliq.jdField_c_of_type_Int = i;
        ...
        ((JSONObject)localObject1).put("xyRootSrc", akpq.a(paramInt));
        i = paramString.optInt("activityId");
        int j = paramString.optInt("reqCode");
        localObject2 = akro.a(paramInt);
        if (localObject2 != null)
        {
          ((aktr)localObject2).jdField_b_of_type_Int = i;
          ((aktr)localObject2).jdField_c_of_type_Int = j;
        }
        localaliq.jdField_c_of_type_JavaLangString = ((JSONObject)localObject1).toString();
        if (localaliq.jdField_c_of_type_JavaLangString.length() >= 500)
        {
          QLog.w("cmgame.sendmsg", 1, "extendInfo is too long, len:" + localaliq.jdField_c_of_type_JavaLangString.length() + ",content:" + localaliq.jdField_c_of_type_JavaLangString);
          return;
        }
      }
      ...
      Object localObject1 = akty.a();
      if ((localObject1 != null) && (((akty)localObject1).a != null) && (0L != l)) {
        ((akty)localObject1).a.roomId = l;
      }
      if (i == 0)
      {
        paramString.put("msgType", 4);
        aktg.a("cs.send_game_msg.local", paramString.toString(), true, null, paramInt);
        return;
      }
    } while (1 != i);
    a(localaliq, paramActivity, 3);
  }
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Object localObject1 = (akji)paramQQAppInterface.getManager(153);
    Object localObject2 = akji.jdField_c_of_type_JavaLangString;
    localObject1 = akji.jdField_b_of_type_JavaLangString;
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        a(paramLong, paramQQAppInterface, paramString2, "", 1, paramString1, new aleq());
        return;
  ...
  public static void a(long paramLong, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt, String paramString3, aleu paramaleu)
  {
    akji localakji = (akji)paramQQAppInterface.getManager(153);
    Object localObject = localakji.b(paramString1);
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (localObject.length > 0))
      {
        ...
        if (paramInt < j)
        {
          aknx localaknx = localObject[paramInt];
          i = localaknx.jdField_b_of_type_Int;
          int[] arrayOfInt = localaknx.a();
          if ((albu.a(paramString1, localaknx.jdField_a_of_type_Int, arrayOfInt, paramQQAppInterface, new ales(paramaleu, paramLong, paramQQAppInterface, paramString2, paramString3, localaknx, arrayOfInt))) && (localaknx.jdField_a_of_type_Int != 0))
          {
            if (QLog.isColorLevel()) {
              QLog.d("ApolloGameBasicEventUtil", 2, "valid role and dress RSC.");
            }
            if (paramaleu != null) {
              paramaleu.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, localaknx.jdField_a_of_type_Int, arrayOfInt, 3);
            }
          }
        }
      }
      ...
      for (;;)
      {
        ...
        if (paramaleu != null)
        {
          ...
          {
            paramInt = 2;
            paramaleu.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, paramInt, akzg.a(paramInt), 1);
          }
        }
        else
        {
        ...
        for (paramLong = paramQQAppInterface.apolloUpdateTime;; paramLong = 0L)
        {
          ...
          paramaleu.a(paramLong, paramQQAppInterface, paramString1, paramString2, paramString3, 1, akzg.a(1), 1);
          break label285;
        }
      }
    }
  ...
  public static void a(aliq paramaliq, Activity paramActivity, int paramInt)
  {
    if (paramaliq == null)
    {
    ...
    localBundle.putInt("forward.apollo.gameid", paramaliq.jdField_a_of_type_Int);
    localBundle.putInt("forward.apollo.gameMode", paramaliq.jdField_c_of_type_Int);
    localBundle.putInt("forward_type", 34);
    if (QLog.isColorLevel()) {
      QLog.d("ApolloGameBasicEventUtil", 2, "[forwardGameMsg] gameId:" + paramaliq.jdField_a_of_type_Int + ";fromtype:" + paramInt);
    }
    if (paramInt == 2)
    {
      localIntent.putExtras(localBundle);
      arum.a(paramActivity, localIntent, 99999);
      return;
    }
    localBundle.putInt("forward.apollo.actionid", paramaliq.jdField_b_of_type_Int);
    localBundle.putLong("forward.apollo.roomid", paramaliq.jdField_a_of_type_Long);
    localBundle.putString("forward.apollo.gamename", paramaliq.jdField_b_of_type_JavaLangString);
    localBundle.putString("forward.apollo.actionname", paramaliq.jdField_a_of_type_JavaLangString);
    localBundle.putInt("forward.apollo.msgtype", paramaliq.d);
    localBundle.putString("forward.apollo.sharejson", paramaliq.jdField_c_of_type_JavaLangString);
    localIntent.putExtras(localBundle);
    arum.a(paramActivity, localIntent, 20180426);
  }
    ...
    if (localJSONObject1.has("param"))
    {
      ...
      if (localJSONObject2 != null)
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          paramString = bhos.a(paramString, str, localJSONObject2.getString(str));
        }
      }
    }
    for (;;)
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, Activity paramActivity)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        Object localObject = (aleh)paramQQAppInterface.getManager(155);
        localJSONObject = new JSONObject(paramString);
        int j = localJSONObject.optInt("gameMode");
        int k = localJSONObject.optInt("gameId");
        long l = localJSONObject.optLong("roomId");
        localaliq = new aliq();
        ApolloGameData localApolloGameData = ((aleh)localObject).a(k);
        paramString = alpo.a(2131700721);
        if ((localApolloGameData != null) && (!TextUtils.isEmpty(localApolloGameData.name)))
        {
          ...
          localaliq.jdField_a_of_type_JavaLangString = paramString;
          localaliq.jdField_b_of_type_Int = i;
          localaliq.jdField_c_of_type_Int = j;
          localaliq.jdField_a_of_type_Long = l;
          localaliq.jdField_a_of_type_Int = k;
      ...
      localaliq.jdField_b_of_type_JavaLangString = alpo.a(2131700740);
      int i = 0;
      continue;
      localaliq.d = 3;
      continue;
      ...
      ApolloGameUtil.a(paramQQAppInterface, localaliq, paramString.a());
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          QLog.i("ApolloGameBasicEventUtil", 1, "pass uin.");
          a(paramInt, paramQQAppInterface, paramString2, str, 1, paramString1, new aler(i));
          return;
        }
      }
      catch (Exception paramQQAppInterface)
  ...
  public static boolean a(Context paramContext, String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt1 == 2)
      {
        ...
        String str = String.format("https://cmshow.qq.com/apollo/html/game-platform/buy-props.html?_wv=3&adtag=inside_game&gameId=%s&gameOrientation=%s&itemList=%s", new Object[] { Integer.valueOf(localaktr.a()), Integer.valueOf(i), URLEncoder.encode(paramString.optString("itemList"), "UTF-8") });
        ...
        VipUtils.a(null, "cmshow", "Apollo", "open_webpage", 0, 0, new String[] { localaktr.a().mGameName });
        if (QLog.isColorLevel())
        {
          ...
          VipUtils.a(null, "cmshow", "Apollo", "open_webpage", 1, 0, new String[] { localaktr.a().mGameName });
        }
      }
      else
      {
  ...
  private static String b()
  {
    ...
    {
      if ((alpo.a(2131700748).equals(str)) || (str.contains(alpo.a(2131700733)))) {
        return a(b);
      }
      if ((alpo.a(2131700746).equals(str)) || (str.contains(alpo.a(2131700707)))) {
        return a(c);
      }
      if ((alpo.a(2131700719).equals(str)) || (str.contains(alpo.a(2131700713)))) {
  ...
  public static void b(long paramLong, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    paramString = b(akji.jdField_c_of_type_JavaLangString.getBytes(), paramString.getBytes());
    try
    {
    ...
    if (localJSONObject.has("param"))
    {
      ...
      if (localJSONObject != null)
      {
        ...
        for (;;)
        {
          ...
          paramString = bhos.a(paramString, str, localJSONObject.getString(str));
        }
      }
    }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      ((nup)paramQQAppInterface.a(88)).a(i, paramString, str1, str2, str3, l1, l2, l3, l4, bool);
      return;
    }
    catch (Exception paramQQAppInterface)
    {
  ...
  public static void c(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    int j = bdee.b(paramQQAppInterface.getApp());
    long l1 = 0L;
    label199:
    label204:
    label210:
