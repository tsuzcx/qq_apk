  ...
  extends MSFServlet
{
  ...
  {
    new bgql().a(paramFileStoragePushFSSvcList);
  }
  
  public static void a(FileStoragePushFSSvcList paramFileStoragePushFSSvcList, QQAppInterface paramQQAppInterface)
  {
    paramFileStoragePushFSSvcList.pttlist = ayqh.a().a(paramFileStoragePushFSSvcList.pttlist);
    ayqh.a().a(paramFileStoragePushFSSvcList);
    b(paramFileStoragePushFSSvcList, paramQQAppInterface);
    a(paramFileStoragePushFSSvcList);
    a(paramQQAppInterface);
    ampg.a(paramFileStoragePushFSSvcList, paramQQAppInterface);
    ...
    avcj.a(paramQQAppInterface).a(true, false);
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localHwConfig != null) {
      ConfigManager.getInstance(localBaseApplication, paramQQAppInterface.getHwEngine()).onSrvAddrPush(localBaseApplication, paramQQAppInterface, str, localHwConfig);
    }
  }
  ...
  private static void b(FileStoragePushFSSvcList paramFileStoragePushFSSvcList, QQAppInterface paramQQAppInterface)
  {
    if ((paramFileStoragePushFSSvcList != null) && (paramFileStoragePushFSSvcList.vUrlEncodeServiceList != null))
    {
      ...
      ayvn.a().a(paramFileStoragePushFSSvcList.vUrlEncodeServiceList);
    }
  }
          ...
          if ("qqwifi.notifyAvail".equals(str))
          {
            ...
            if (paramIntent != null)
            {
              ...
              for (int i = 1032;; i = 1033)
              {
                ...
                axqy.b(localQQAppInterface, "CliOper", "", "", "QQWIFI", "show_buleNotify", 0, 0, "", "", "", "");
                return;
              }
            }
          }
