...
class axcg
  extends nis
{
  axcg(axce paramaxce, axbm paramaxbm, long paramLong) {}
      ...
      if (paramArrayOfByte != null) {
        for (;;)
        {
          try
          {
            ...
            if (paramArrayOfByte.hasNext())
            {
              ...
              if (paramBundle.uint32_result.get() == 0) {
                this.jdField_a_of_type_Axbm.a(paramBundle.uint64_uin.get(), paramBundle.uint64_tinyid.get());
              }
            }
            else
            {
          ...
          catch (InvalidProtocolBufferMicroException paramArrayOfByte)
          {
            ...
            this.jdField_a_of_type_Axbm.a(this.jdField_a_of_type_Long, -1L);
          }
          this.jdField_a_of_type_Axbm.a(this.jdField_a_of_type_Long, -1L);
