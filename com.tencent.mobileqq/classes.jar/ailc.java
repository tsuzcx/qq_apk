...
public class ailc
  extends baua
{
  public ailc(SendWebPicActivity paramSendWebPicActivity) {}
  
  public void handleMessage(Message paramMessage)
  {
    baoj localbaoj = (baoj)paramMessage.obj;
    if ((localbaoj == null) || (localbaoj.b != 24) || (localbaoj.c != 51)) {}
    do
    {
      do
      {
        return;
      } while (localbaoj.f.equals(SendWebPicActivity.a(this.a)));
    ...
    try
    {
      paramMessage.mergeFrom(localbaoj.a, 0, localbaoj.a.length);
      SendWebPicActivity.a(this.a, true);
      SendWebPicActivity.a(this.a, localbaoj.f);
    ...
    if (QLog.isColorLevel()) {
      QLog.d("SendWebPicActivity", 2, "mPicTransProcessorHandler send error:" + localbaoj.g);
    }
