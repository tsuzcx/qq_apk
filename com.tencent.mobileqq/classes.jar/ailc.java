  ...
  extends BaseAdapter
{
  ...
  private CompoundButton.OnCheckedChangeListener jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener = new aild(this);
  private aqhf jdField_a_of_type_Aqhf;
  protected QQAppInterface a;
  protected List<Object> a;
  
  public ailc(QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, aqhf paramaqhf)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramFragmentActivity.getResources().getDrawable(2130844490);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      paramView = new aile();
      localObject = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131561066, paramViewGroup, false);
      paramView.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)((View)localObject).findViewById(2131362694));
      paramView.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)((View)localObject).findViewById(2131362693));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject).findViewById(2131362695));
      paramView.jdField_a_of_type_ComTencentWidgetSwitch = ((Switch)((View)localObject).findViewById(2131362696));
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject).mRequestWidth = actn.a(paramViewGroup.jdField_a_of_type_ComTencentImageURLImageView.getMeasuredWidth(), this.jdField_a_of_type_AndroidAppActivity.getResources());
