  ...
  implements Manager
{
  ...
  public agfi(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b(MessageRecord paramMessageRecord, AppGuideTipsConfig paramAppGuideTipsConfig)
  {
    ...
    paramMessageRecord = new avpd(str, (String)localObject, paramAppGuideTipsConfig.tipsMsg, paramMessageRecord.istroop, -5022, 2621441, l);
  ...
  public void a(BaseChatPie paramBaseChatPie, MessageRecord paramMessageRecord)
  {
    ...
    label22:
    while (aqyt.a(paramMessageRecord)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      bdll.b(null, "dc00898", "", "", "0X8008947", "0X8008947", 0, 0, "", "", "", "");
      return;
      localAppGuideTipsConfig.allow = false;
      break label92;
      label277:
  ...
  public void a(java.util.List<AppGuideTipsConfig> paramList)
  {
    ...
    //   15: astore_3
    //   16: aload_0
    //   17: getfield 49	agfi:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   20: invokevirtual 402	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   23: astore 4
    //   25: aload 4
    //   27: astore_3
    //   28: aload_3
    //   29: invokevirtual 407	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   32: aload_0
    //   33: getfield 32	agfi:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   36: invokeinterface 410 1 0
    //   41: aload_0
    //   42: iconst_0
    //   43: putfield 92	agfi:jdField_a_of_type_Boolean	Z
    //   46: iconst_0
    //   47: istore_2
    //   48: iload_2
    //   49: aload_1
    ...
    //   58: aload_1
    //   59: iload_2
    //   60: invokeinterface 413 2 0
    //   65: checkcast 94	com/tencent/mobileqq/data/AppGuideTipsConfig
    //   68: astore 4
    //   70: aload 4
    //   72: ifnull +234 -> 306
    //   75: aload_0
    //   76: getfield 49	agfi:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   79: ldc 94
    //   81: aload 4
    //   83: getfield 386	com/tencent/mobileqq/data/AppGuideTipsConfig:tipsType	Ljava/lang/String;
    //   86: invokevirtual 417	com/tencent/mobileqq/persistence/EntityManager:find	(Ljava/lang/Class;Ljava/lang/String;)Lcom/tencent/mobileqq/persistence/Entity;
    ...
    //   125: dup
    //   126: invokespecial 418	com/tencent/mobileqq/data/AppGuideTipsConfig:<init>	()V
    //   129: astore 4
    //   131: aload 4
    //   133: sipush 1001
    //   136: invokevirtual 421	com/tencent/mobileqq/data/AppGuideTipsConfig:setStatus	(I)V
    //   139: aload_0
    //   140: getfield 49	agfi:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   143: aload 4
    //   145: ldc_w 423
    //   148: iconst_1
    ...
    //   154: ldc 237
    //   156: aastore
    //   157: invokevirtual 427	com/tencent/mobileqq/persistence/EntityManager:remove	(Lcom/tencent/mobileqq/persistence/Entity;Ljava/lang/String;[Ljava/lang/String;)Z
    //   160: pop
    //   161: iconst_0
    //   162: istore_2
    //   163: iload_2
    ...
    //   190: aload_0
    //   191: aload 4
    //   193: invokevirtual 381	agfi:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   196: pop
    //   197: goto +116 -> 313
    //   200: aload_3
    //   201: invokevirtual 430	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   204: aload_3
    //   205: ifnull -192 -> 13
    //   208: aload_3
    //   209: invokevirtual 433	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   212: return
    //   213: astore 4
    //   215: aload_3
    //   216: astore_1
    ...
    //   227: ifeq +33 -> 260
    //   230: getstatic 22	agfi:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   233: iconst_2
    ...
    //   247: aload_3
    //   248: invokevirtual 438	java/lang/Exception:getMessage	()Ljava/lang/String;
    ...
    //   257: invokestatic 441	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   260: aload_1
    //   261: ifnull -248 -> 13
    //   264: aload_1
    //   265: invokevirtual 433	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   268: return
    //   269: astore_1
    //   270: aconst_null
    //   271: astore_3
    ...
    //   273: ifnull +7 -> 280
    //   276: aload_3
    //   277: invokevirtual 433	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   280: aload_1
    //   281: athrow
    //   282: astore_1
    //   283: goto -11 -> 272
