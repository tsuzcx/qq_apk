  ...
  implements bays
{
  ...
  public baxw(ahzl paramahzl, List<bayt> paramList, String paramString)
  {
  ...
  public String a()
  {
    if (UniteSearchActivity.d == 12) {
      return amtj.a(2131704477) + uex.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), BaseApplicationImpl.getContext());
    }
    return amtj.a(2131704476);
  }
  ...
  {
    bbgk.a(this.jdField_a_of_type_JavaLangString, 90, 0, paramView);
    ...
    if ((paramView != null) && ((paramView instanceof BaseActivity))) {
      odq.a(((BaseActivity)paramView).app, "P_CliOper", "Pb_account_lifeservice", "0", "0X8005D22", "0X8005D22", 0, 0, "0", "1", this.jdField_a_of_type_JavaLangString, "", false);
    }
  }
