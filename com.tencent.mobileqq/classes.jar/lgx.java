...
public class lgx
  ...
  implements lgu, lhg
{
  public static final String d = lbm.a() + 176 + File.separator;
  ...
  lgz jdField_a_of_type_Lgz = new lgz();
  private lhk jdField_a_of_type_Lhk = new lhk();
  private lih jdField_a_of_type_Lih;
  private WeakReference<lhh> jdField_a_of_type_MqqUtilWeakReference = new WeakReference(null);
  private boolean jdField_a_of_type_Boolean;
  private ArrayList<lgy> b = new ArrayList();
  private String e;
  private String f;
  
  public lgx(VideoAppInterface paramVideoAppInterface)
  {
  ...
  private MagicFaceDataEntity a(FaceItem paramFaceItem, String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    {
      lbj.c(this.jdField_a_of_type_JavaLangString, String.format("createMagicEntity: id=%s, senderType%s.", new Object[] { paramFaceItem.getId(), Integer.valueOf(paramInt) }));
      str1 = paramFaceItem.getId();
      str2 = paramFaceItem.getType();
      if (!"multi_result".equalsIgnoreCase(paramFaceItem.getAttr())) {
        break label100;
      }
      paramString = new lhe(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, str1, str2, paramString, paramBoolean, paramInt);
    }
    for (;;)
    {
      ...
      if ("huanlian".equalsIgnoreCase(paramFaceItem.getAttr())) {
        paramString = new mal(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, str1, str2, paramString, paramBoolean, paramInt);
      } else {
  ...
  private MagicFaceDataEntity a(String paramString, boolean paramBoolean)
  {
    ...
    if (paramString != null)
    {
      ...
      this.jdField_a_of_type_Lgn.a(paramString, a(paramString), b(paramString), localArrayList, false);
      lbj.e(this.jdField_a_of_type_JavaLangString, "prepareEntity FILE not exist: " + ((File)localObject).getPath());
    }
    return null;
  }
  
  private void a(long paramLong, MagicFaceDataEntity paramMagicFaceDataEntity, lhh paramlhh)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity != null)
    {
      ...
      if (localFaceItem != null)
      {
        ...
        if (!TextUtils.isEmpty(str))
        {
          ...
          this.jdField_a_of_type_Lhk.a(paramLong, str, paramMagicFaceDataEntity, paramlhh, this);
        }
      }
    }
  }
  ...
  private boolean a(long paramLong)
  {
    if (this.jdField_a_of_type_JavaUtilQueue.size() > 0)
    {
      ...
      a(paramLong, localMagicFaceDataEntity, (lhh)this.jdField_a_of_type_MqqUtilWeakReference.get());
  ...
  private int b()
  {
    ...
    int i = localVideoController.b(locallff.d);
    if ((i == 2) || (i == 3) || (i == 4))
    {
      i = 1;
      if (i != 0) {
    ...
    do
    {
      ...
      i = 0;
      break;
      k = localVideoController.c(locallff.d);
  ...
  public int a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 3)
    {
      ...
      if ((bool1) || (bool2)) {
        if ((!"0".equalsIgnoreCase(str2)) && (!"0_iOS".equalsIgnoreCase(str2)))
        {
          ...
          new mcy(l, str2, false, 4).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
    ...
    for (;;)
    {
      ...
      if ("STOP".equals(str1))
      {
        continue;
        if (paramInt == 1) {
          new mcy(l, paramString, false, 4).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
        }
      }
    }
  }
  ...
  public FaceItem a()
  {
    if ((this.jdField_a_of_type_Lgr != null) && (((FaceItem)this.jdField_a_of_type_Lgr).isSameType("creativecop"))) {
      return (FaceItem)this.jdField_a_of_type_Lgr;
    }
    return null;
  }
      ...
      else if (paramInt == 370)
      {
        if (((JSONObject)localObject1).has("blessingTips"))
        {
          ...
          while (i < localJSONArray.length())
          {
            ...
            lgy locallgy = new lgy();
            locallgy.jdField_a_of_type_JavaLangString = localJSONObject.optString("id");
            if (localJSONObject.has("start_date")) {
              locallgy.jdField_a_of_type_Long = ((SimpleDateFormat)localObject2).parse(localJSONObject.optString("start_date")).getTime();
            }
            if (localJSONObject.has("end_date")) {
              locallgy.jdField_b_of_type_Long = ((SimpleDateFormat)localObject2).parse(localJSONObject.optString("end_date")).getTime();
            }
            if (localJSONObject.has("text")) {
              locallgy.jdField_b_of_type_JavaLangString = localJSONObject.getString("text");
            }
            if (localJSONObject.has("image_url")) {
              locallgy.c = localJSONObject.getString("image_url");
            }
            if (localJSONObject.has("call_time_len")) {
              locallgy.jdField_a_of_type_Int = localJSONObject.getInt("call_time_len");
            }
            if (localJSONObject.has("show_time_len")) {
              locallgy.jdField_b_of_type_Int = localJSONObject.getInt("show_time_len");
            }
            this.b.add(locallgy);
            QLog.w(this.jdField_a_of_type_JavaLangString, 1, "parseConfig, blessingTips[" + locallgy + "]");
            i += 1;
          }
        }
        ...
        {
          this.jdField_a_of_type_Lgz.jdField_a_of_type_Int = ((JSONObject)localObject1).optInt("exposure_show_time_len", 5);
          this.jdField_a_of_type_Lgz.jdField_b_of_type_Int = ((JSONObject)localObject1).optInt("exposure_call_time", 2);
          this.jdField_a_of_type_Lgz.c = ((JSONObject)localObject1).optInt("click_call_time", 2);
          this.jdField_a_of_type_Lgz.d = ((JSONObject)localObject1).optInt("click_show_time_len", 5);
          this.jdField_a_of_type_Lgz.jdField_a_of_type_JavaLangString = ((JSONObject)localObject1).optString("exposure_show_text", this.jdField_a_of_type_Lgz.jdField_a_of_type_JavaLangString);
        }
      }
    }
  ...
  public lgz a()
  {
    return this.jdField_a_of_type_Lgz;
  }
  ...
  public void a()
  {
    ...
    if (locallgt != null) {
      locallgt.a(3003, this);
    }
    this.jdField_a_of_type_Lih = ((lih)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(5));
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (bool)
      {
        ...
        this.f = null;
        a(l, null);
        if (this.jdField_a_of_type_Lhk.a()) {
          this.jdField_a_of_type_Lhk.b();
        }
      }
      return;
      if (paramInt == 3002) {
  ...
  protected void a(long paramLong, int paramInt, String paramString1, String paramString2)
  {
    ...
    case 2: 
      ...
      new mcz(paramLong, "onSessionStatusChanged", 5, null).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      lha.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, paramString1);
      lha.a(2, paramString1);
      lha.a(2);
      return;
    }
    a(paramLong, 6101, null, Boolean.valueOf(false));
  ...
  public void a(long paramLong, String paramString, int paramInt)
  {
    ...
    {
      bool2 = this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity.a((lhi)localObject);
      bool1 = bool2;
      if (bool2)
      {
        bool1 = bool2;
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (!bool1)
      {
        ...
        {
          ((lhx)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2)).a(paramLong, this.e);
          a(paramLong, 6102, null, null);
          this.e = null;
        }
      }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      lha.a(4, paramString2);
      lha.a(4);
    } while (!this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(13));
    ((lhm)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(13)).a(l, "stopInteractiveVideo");
  }
  ...
  public boolean a(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity != null)
    {
      ...
      {
        this.jdField_a_of_type_JavaUtilQueue.clear();
        lbj.e(this.jdField_a_of_type_JavaLangString, "stop dequeue" + paramString);
        this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity = null;
        if (paramBoolean) {
          e(paramString);
        }
        ...
        {
          this.jdField_a_of_type_Lhk.b();
          lbj.e(this.jdField_a_of_type_JavaLangString, "stop " + paramString + ", mStopType =" + paramInt);
        }
      }
    }
  ...
  public boolean a(long paramLong, FaceItem paramFaceItem)
  {
    ...
    if ((paramFaceItem != null) && (paramFaceItem.isSameType("creativecop")))
    {
      ...
      ((FaceItem)this.jdField_a_of_type_Lgr).setDesc((String)localObject);
      bdll.b(null, "CliOper", "", "", "0X800A74C", "0X800A74C", 0, 0, "", "", paramFaceItem.getId(), "");
      j = b();
      if (this.jdField_a_of_type_Lih.a(3, "creative") != 1) {
        break label282;
      }
      bool1 = true;
      i = 0;
    ...
    for (;;)
    {
      ...
      if (i != 0) {
        mbb.a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, 1010, i);
      }
      if (bool2)
      {
        this.jdField_a_of_type_AndroidOsHandler.obtainMessage(101, this.jdField_a_of_type_Lgr).sendToTarget();
        if (paramFaceItem != null)
        {
          ...
          if ((!paramFaceItem.equalsIgnoreCase("face")) && (!paramFaceItem.equalsIgnoreCase("voicesticker")))
          {
            ...
            if (localObject != null) {
              ((lgt)localObject).a(3003, paramFaceItem);
            }
          }
        }
      }
  ...
  public boolean a(long paramLong, FaceItem paramFaceItem, String paramString, boolean paramBoolean, lhh paramlhh)
  {
    boolean bool2 = true;
    if (AudioHelper.f()) {
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, "start, id[" + paramString + "], curData[" + this.jdField_a_of_type_ComTencentAvBusinessManagerMagicfaceMagicFaceDataEntity + "], isSender[" + paramBoolean + "], queue[" + this.jdField_a_of_type_JavaUtilQueue.size() + "], isPlaying[" + this.jdField_a_of_type_Lhk.a() + "], mLastPendantId[" + this.e + "], seq[" + paramLong + "]");
    }
    boolean bool1;
    ...
    if (bool3)
    {
      ...
      this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramlhh);
      if ((this.jdField_a_of_type_Lhk == null) || (!this.jdField_a_of_type_Lhk.a())) {
        break label468;
      }
      if (bool3) {
        break label554;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((paramFaceItem != null) || (bool3))
        {
          ...
          paramFaceItem = (lhx)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(2);
        ...
        for (;;)
        {
          QLog.w(this.jdField_a_of_type_JavaLangString, 1, "start, step[" + i + "], mLastPendantId[" + paramlhh + "->" + this.e + "]");
          ...
          a(paramLong, (MagicFaceDataEntity)localObject, paramlhh);
          paramFaceItem = (FaceItem)localObject;
          break label276;
          label506:
          i = 2;
