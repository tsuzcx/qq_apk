  ...
  extends ajtd
{
  ...
  public lgx(AppInterface paramAppInterface)
  {
  ...
  public String a()
  {
    return String.valueOf(this.jdField_a_of_type_Lgz.jdField_a_of_type_Long);
  }
  ...
  public void a(String paramString1, String paramString2, long paramLong, String paramString3)
  {
    ...
    for (Object localObject1 = "0";; localObject1 = paramString3)
    {
      ...
      localObject2 = this.jdField_a_of_type_Lgv;
      localToServiceMsg.putWupBuffer(lgv.a(localInfoHead.toByteArray(), ((AudioTransClientTransInfo.InfoReqBody)localObject1).toByteArray()));
      boolean bool = bbev.g(this.mApp.getApplication().getApplicationContext());
      if (bool) {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, com.tencent.qphone.base.remote.FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   4: ifeq +641 -> 645
    //   7: aload_0
    //   8: getfield 28	lgx:jdField_a_of_type_Lgv	Llgv;
    //   11: astore_1
    //   12: aload_2
    //   13: invokevirtual 266	com/tencent/qphone/base/remote/FromServiceMsg:getWupBuffer	()[B
    //   16: invokestatic 269	lgv:a	([B)Llgw;
    //   19: astore_2
    //   20: aload_2
    //   21: getfield 274	lgw:a	[B
    //   24: astore_1
    //   25: aload_2
    //   26: getfield 276	lgw:b	[B
    //   29: astore_2
    ...
    //   101: astore_2
    //   102: aload_0
    //   103: getfield 35	lgx:jdField_a_of_type_Lgz	Llgz;
    //   106: aload_2
    ...
    //   113: putfield 308	lgz:jdField_a_of_type_Int	I
    //   116: aload_0
    //   117: getfield 35	lgx:jdField_a_of_type_Lgz	Llgz;
    //   120: aload_2
    ...
    //   127: putfield 313	lgz:b	I
    //   130: aload_0
    //   131: getfield 35	lgx:jdField_a_of_type_Lgz	Llgz;
    //   134: aload_1
    ...
    //   147: putfield 40	lgz:jdField_a_of_type_Long	J
    //   150: aload_2
    ...
    //   157: astore_1
    //   158: aload_0
    //   159: getfield 35	lgx:jdField_a_of_type_Lgz	Llgz;
    //   162: new 332	java/util/ArrayList
    //   165: dup
    //   166: invokespecial 333	java/util/ArrayList:<init>	()V
    //   169: putfield 336	lgz:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   172: aload_0
    //   173: invokevirtual 338	lgx:b	()Z
    //   176: istore 5
    //   178: ldc 212
    //   180: iconst_1
    ...
    //   205: aload_0
    //   206: getfield 35	lgx:jdField_a_of_type_Lgz	Llgz;
    ...
    //   229: aload_0
    //   230: getfield 48	lgx:jdField_a_of_type_Boolean	Z
    ...
    //   325: aload_0
    //   326: getfield 35	lgx:jdField_a_of_type_Lgz	Llgz;
    //   329: getfield 336	lgz:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   332: aload_3
    ...
    //   352: astore_3
    //   353: aload_0
    //   354: getfield 28	lgx:jdField_a_of_type_Lgv	Llgv;
    //   357: astore 6
    //   359: aload_3
    //   360: aload_2
    ...
    //   367: invokestatic 405	lgv:a	(I)Ljava/lang/String;
    ...
    //   411: astore_3
    //   412: aload_0
    //   413: getfield 28	lgx:jdField_a_of_type_Lgv	Llgv;
    //   416: astore 6
    //   418: ldc 212
    //   420: iconst_2
    //   421: aload_3
    ...
    //   429: invokestatic 405	lgv:a	(I)Ljava/lang/String;
    ...
    //   490: goto -340 -> 150
    //   493: aload_0
    //   494: getfield 82	lgx:mApp	Lcom/tencent/common/app/AppInterface;
    //   497: iconst_0
    //   498: invokevirtual 430	com/tencent/common/app/AppInterface:getBusinessHandler	(I)Ljava/lang/Object;
    //   501: checkcast 432	lha
    //   504: iload 4
    //   506: i2l
    //   507: iconst_1
    //   508: aload_0
    //   509: getfield 35	lgx:jdField_a_of_type_Lgz	Llgz;
    //   512: getfield 336	lgz:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   515: aload_0
    //   516: getfield 35	lgx:jdField_a_of_type_Lgz	Llgz;
    //   519: getfield 40	lgz:jdField_a_of_type_Long	J
    //   522: invokevirtual 435	lha:a	(JZLjava/util/List;J)V
    //   525: aload_0
    //   526: iconst_1
    //   527: putfield 48	lgx:jdField_a_of_type_Boolean	Z
    //   530: iload 5
    //   532: ifeq -54 -> 478
    //   535: aload_0
    //   536: iload 4
    //   538: i2l
    //   539: aload_0
    //   540: getfield 35	lgx:jdField_a_of_type_Lgz	Llgz;
    //   543: getfield 40	lgz:jdField_a_of_type_Long	J
    //   546: invokevirtual 437	lgx:a	(JJ)V
    //   549: return
    //   550: aload_2
