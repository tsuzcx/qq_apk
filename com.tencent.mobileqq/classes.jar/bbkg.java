...
public class bbkg
  extends bbkp
{
  public bbkg(Context paramContext)
  {
    super(paramContext);
  }
  
  private void a(QQAppInterface paramQQAppInterface, bbkl parambbkl, boolean paramBoolean, int paramInt, String paramString)
  {
    parambbkl.jdField_a_of_type_Boolean = paramBoolean;
    if (paramBoolean)
    {
      if (paramInt == 0) {
        parambbkl.jdField_a_of_type_Int = 0;
      }
    }
    else {
      return;
    ...
    if (paramInt == 3000)
    {
      parambbkl.jdField_a_of_type_Int = 3000;
      return;
    }
    if (paramInt == 1)
    {
      ...
      {
      default: 
        parambbkl.jdField_a_of_type_Int = 1;
      }
      for (;;)
      {
        parambbkl.i = 0;
        ...
        parambbkl.i = paramQQAppInterface.wMemberNum;
        return;
        parambbkl.jdField_a_of_type_Int = 1;
        continue;
        parambbkl.jdField_a_of_type_Int = 3;
        continue;
        parambbkl.jdField_a_of_type_Int = 4;
        continue;
        parambbkl.jdField_a_of_type_Int = 2;
      }
    }
    parambbkl.jdField_a_of_type_Int = 9999;
  }
  
  private boolean a(bbkl parambbkl, String paramString)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (paramString.equalsIgnoreCase(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES).getAbsolutePath() + File.separator)) {
          parambbkl.j = 1002;
        } else if ((((String)localObject1).contains("camera")) || (((String)localObject1).equals("dcim")) || (((String)localObject1).equals("100MEDIA")) || (((String)localObject1).equals("100ANDRO")) || (((String)localObject1).contains(anvx.a(2131702366))) || (((String)localObject1).contains(anvx.a(2131702365))) || (((String)localObject1).contains(anvx.a(2131702367)))) {
          parambbkl.j = 1007;
        } else if (aklj.a(paramString)) {
          parambbkl.j = 1005;
        } else {
  ...
  public void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString, bbkj parambbkj)
  {
    parambbkj.f = paramInt1;
    if (paramInt2 == 0) {
      parambbkj.b = 0;
    }
    for (;;)
    {
      paramAppInterface = (axny)paramAppInterface.getManager(QQManagerFactory.NEARBY_CARD_MANAGER);
      if (paramAppInterface != null)
      {
        parambbkj.d = paramAppInterface.a();
        parambbkj.e = paramAppInterface.b();
      }
      parambbkj.g = Calendar.getInstance().get(11);
      parambbkj.h = NetworkUtil.getSystemNetwork(BaseApplication.getContext());
      return;
      if (paramInt2 == 3000)
      {
        parambbkj.b = 3000;
      ...
      else
      {
        if (paramInt2 == 1)
        {
          ...
          for (;;)
          {
            ...
            parambbkj.c = paramString.wMemberNum;
            break;
            parambbkj.b = 1;
            continue;
            parambbkj.b = 3;
