...
public class akbb
  extends akab
{
  public akbb(QQAppInterface paramQQAppInterface, QQMessageFacade paramQQMessageFacade)
  {
  ...
  protected String a(String paramString1, String paramString2)
  {
    ...
    String str;
    for (paramString2 = ajjy.a(2131639650);; paramString2 = babh.h(this.a, paramString2, paramString1))
    {
  ...
  public void a(MessageRecord paramMessageRecord, atmp paramatmp, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, ajzz paramajzz)
  {
    ...
    Map localMap2 = paramajzz.jdField_a_of_type_JavaUtilMap;
    Map localMap1 = paramajzz.d;
    ...
    localObject = ((akeu)localObject).a(str1, 1);
    if (localMap2.containsKey(akbm.a(((RecentUser)localObject).uin, ((RecentUser)localObject).getType()))) {
      localObject = (RecentUser)localMap2.get(akbm.a(((RecentUser)localObject).uin, ((RecentUser)localObject).getType()));
    }
    for (;;)
    {
      int i;
  ...
  protected void b(QQMessageFacade.Message paramMessage)
  {
    ...
    if (QLog.isDevelopLevel()) {
      asfl.a("PttShow", "processNickName", new Object[] { paramMessage.senderuin, paramMessage.nickName });
    }
  }
}
