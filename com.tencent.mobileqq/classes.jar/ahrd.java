  ...
  implements ufj, ufk, ufl, ufm
{
  ...
  private ahre jdField_a_of_type_Ahre;
  ...
  private void a()
  {
    ...
    if (this.jdField_a_of_type_Ahre != null) {
      this.jdField_a_of_type_Ahre.a();
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("LoginActivity.GuideVideoHandler", 2, "MediaPlayer onCompletion has been called.   at " + paramufh.b() + " mIsPause" + this.jdField_a_of_type_Boolean);
    }
    this.jdField_a_of_type_Int = paramufh.b();
  ...
  {
    paramufh = new StringBuilder(64);
    paramufh.append("bgVideo error-- what=");
    paramufh.append(paramInt1);
    paramufh.append(" extra=");
    paramufh.append(paramInt2);
    if (QLog.isColorLevel()) {
      QLog.d("LoginActivity.GuideVideoHandler", 2, paramufh.toString());
    }
    a();
    paramufh = Build.MODEL;
    if (paramufh != null)
    {
      HashMap localHashMap = new HashMap();
      localHashMap.put("crashModel", paramufh);
      axrn.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getApplicationContext()).a(null, "newHandGuide_error", true, 0L, 0L, localHashMap, "", false);
    }
    return true;
  }
