  ...
  implements aoga<String>
{
  ...
  public static ntq a()
  {
    ntq localntq = new ntq();
    localntq.jdField_a_of_type_JavaLangString = swy.jdField_d_of_type_JavaLangString;
    localntq.jdField_b_of_type_JavaLangString = swy.jdField_e_of_type_JavaLangString;
    localntq.jdField_b_of_type_Boolean = swy.jdField_a_of_type_Boolean;
    localntq.jdField_c_of_type_Boolean = swy.p;
    localntq.jdField_a_of_type_Boolean = swy.jdField_b_of_type_Boolean;
    localntq.jdField_d_of_type_Boolean = swy.jdField_e_of_type_Boolean;
    localntq.jdField_e_of_type_Boolean = swy.jdField_f_of_type_Boolean;
    localntq.jdField_f_of_type_Boolean = swy.jdField_g_of_type_Boolean;
    localntq.jdField_g_of_type_Boolean = swy.jdField_h_of_type_Boolean;
    localntq.jdField_h_of_type_Boolean = swy.jdField_i_of_type_Boolean;
    localntq.jdField_i_of_type_Boolean = swy.l;
    localntq.j = swy.j;
    localntq.jdField_c_of_type_JavaLangString = swy.jdField_f_of_type_JavaLangString;
    localntq.jdField_a_of_type_Long = swy.jdField_a_of_type_Long;
    localntq.k = swy.m;
    localntq.jdField_a_of_type_Int = swy.jdField_b_of_type_Int;
    localntq.jdField_d_of_type_JavaLangString = swy.jdField_i_of_type_JavaLangString;
    localntq.l = swy.n;
    localntq.m = swy.jdField_c_of_type_Boolean;
    localntq.n = swy.o;
    localntq.jdField_a_of_type_JavaUtilArrayList = swy.jdField_a_of_type_JavaUtilArrayList;
    localntq.jdField_b_of_type_Int = swy.jdField_c_of_type_Int;
    localntq.jdField_c_of_type_Int = swy.jdField_d_of_type_Int;
    localntq.jdField_d_of_type_Int = swy.jdField_e_of_type_Int;
    localntq.o = swy.k;
    Object localObject = swy.jdField_g_of_type_JavaLangString;
    localntq.jdField_e_of_type_JavaLangString = ((String)localObject);
    localntq.jdField_f_of_type_JavaLangString = swy.jdField_h_of_type_JavaLangString;
    try
    {
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        if (((JSONObject)localObject).has("useNewLogic")) {
          b(localntq, (JSONObject)localObject);
        }
        if (((JSONObject)localObject).has("releaseServiceMinMem")) {
          a(localntq, (JSONObject)localObject);
        }
      }
      return localntq;
    }
  ...
  private ntq a(ntq paramntq, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString.has("service_folder_name")) {
          this.jdField_a_of_type_JavaLangString = paramntq.jdField_a_of_type_JavaLangString;
        }
        if (paramString.has("service_folder_icon")) {
          this.jdField_b_of_type_JavaLangString = paramntq.jdField_b_of_type_JavaLangString;
        }
        if (paramString.has("service_folder_redspots")) {
          this.jdField_a_of_type_Boolean = paramntq.jdField_a_of_type_Boolean;
        }
        if (paramString.has("service_folder_delete")) {
          this.jdField_b_of_type_Boolean = paramntq.jdField_b_of_type_Boolean;
        }
        if (paramString.has("ServiceFolder_RedClean_After_Enter")) {
          this.jdField_c_of_type_Boolean = paramntq.jdField_c_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload")) {
          this.jdField_d_of_type_Boolean = paramntq.jdField_d_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_wifi")) {
          this.jdField_e_of_type_Boolean = paramntq.jdField_e_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_4G")) {
          this.jdField_f_of_type_Boolean = paramntq.jdField_f_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_3G")) {
          this.jdField_g_of_type_Boolean = paramntq.jdField_g_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_2G")) {
          this.jdField_h_of_type_Boolean = paramntq.jdField_h_of_type_Boolean;
        }
        if (paramString.has("pub_account_bottom_bar")) {
          this.jdField_i_of_type_Boolean = paramntq.jdField_i_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_image_preload")) {
          this.j = paramntq.j;
        }
        if (paramString.has("kandian_feeds_fling_LToR_host")) {
          this.jdField_c_of_type_JavaLangString = paramntq.jdField_c_of_type_JavaLangString;
        }
        if (paramString.has("kandian_ad_background_showtime")) {
          this.jdField_a_of_type_Long = paramntq.jdField_a_of_type_Long;
        }
        ...
        {
          this.jdField_a_of_type_Int = paramntq.jdField_a_of_type_Int;
          this.jdField_d_of_type_JavaLangString = paramntq.jdField_d_of_type_JavaLangString;
        }
        ...
        if ((i1 != 0) && (paramString.has("host_white_list"))) {
          this.jdField_a_of_type_JavaUtilArrayList = paramntq.jdField_a_of_type_JavaUtilArrayList;
        }
        if (paramString.has("album_predown_enable")) {
          this.jdField_b_of_type_Int = paramntq.jdField_b_of_type_Int;
        }
        if (paramString.has("album_predown_photo_rule")) {
          this.jdField_c_of_type_Int = paramntq.jdField_c_of_type_Int;
        }
        if (paramString.has("album_predown_slide_photocounts")) {
          this.jdField_d_of_type_Int = paramntq.jdField_d_of_type_Int;
        }
        ...
        {
          this.jdField_e_of_type_JavaLangString = paramntq.jdField_e_of_type_JavaLangString;
          this.p = paramntq.p;
          this.jdField_e_of_type_Int = paramntq.jdField_e_of_type_Int;
          this.jdField_f_of_type_Int = paramntq.jdField_f_of_type_Int;
          this.jdField_g_of_type_Int = paramntq.jdField_g_of_type_Int;
          this.jdField_h_of_type_Int = paramntq.jdField_h_of_type_Int;
        }
        if (paramString.has("releaseServiceMinMem"))
        {
          this.jdField_f_of_type_JavaLangString = paramntq.jdField_f_of_type_JavaLangString;
          this.jdField_i_of_type_Int = paramntq.jdField_i_of_type_Int;
          return this;
        }
      }
      catch (JSONException paramntq)
      {
        paramntq.printStackTrace();
      }
    }
    return this;
  }
  ...
  private static void a(ntq paramntq, JSONObject paramJSONObject)
  {
    paramntq.jdField_i_of_type_Int = paramJSONObject.optInt("releaseServiceMinMem", 80);
  }
  ...
  private static void b(ntq paramntq, JSONObject paramJSONObject)
  {
    paramntq.p = paramJSONObject.optBoolean("useNewLogic", false);
    paramntq.jdField_e_of_type_Int = paramJSONObject.optInt("minTotalMem", 1024);
    paramntq.jdField_f_of_type_Int = paramJSONObject.optInt("minAvailableMem", 100);
    paramntq.jdField_g_of_type_Int = paramJSONObject.optInt("minCpuNum", 2);
    paramntq.jdField_h_of_type_Int = paramJSONObject.optInt("minCpuFreq", 1000);
  }
  ...
  public void b()
  {
    swy.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    swy.jdField_e_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
    swy.jdField_a_of_type_Boolean = this.jdField_b_of_type_Boolean;
    swy.p = this.jdField_c_of_type_Boolean;
    swy.jdField_b_of_type_Boolean = this.jdField_a_of_type_Boolean;
    swy.jdField_e_of_type_Boolean = this.jdField_d_of_type_Boolean;
    swy.jdField_f_of_type_Boolean = this.jdField_e_of_type_Boolean;
    swy.jdField_g_of_type_Boolean = this.jdField_f_of_type_Boolean;
    swy.jdField_h_of_type_Boolean = this.jdField_g_of_type_Boolean;
    swy.jdField_i_of_type_Boolean = this.jdField_h_of_type_Boolean;
    swy.l = this.jdField_i_of_type_Boolean;
    swy.j = this.j;
    swy.jdField_f_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
    swy.jdField_a_of_type_Long = this.jdField_a_of_type_Long;
    swy.m = this.k;
    swy.jdField_b_of_type_Int = this.jdField_a_of_type_Int;
    swy.jdField_i_of_type_JavaLangString = this.jdField_d_of_type_JavaLangString;
    swy.n = this.l;
    swy.jdField_c_of_type_Boolean = this.m;
    swy.o = this.n;
    swy.jdField_a_of_type_JavaUtilArrayList = this.jdField_a_of_type_JavaUtilArrayList;
    swy.jdField_c_of_type_Int = this.jdField_b_of_type_Int;
    swy.jdField_d_of_type_Int = this.jdField_c_of_type_Int;
    swy.jdField_e_of_type_Int = this.jdField_d_of_type_Int;
    swy.k = this.o;
    swy.jdField_g_of_type_JavaLangString = this.jdField_e_of_type_JavaLangString;
    swy.jdField_h_of_type_JavaLangString = this.jdField_f_of_type_JavaLangString;
  }
  ...
  public void c()
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface)) {
      swy.b((QQAppInterface)localAppRuntime);
    }
  }
}
