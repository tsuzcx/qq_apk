...
{
  private alll jdField_a_of_type_Alll;
  private SurfaceTexture jdField_a_of_type_AndroidGraphicsSurfaceTexture;
  
  public allk(SurfaceTexture paramSurfaceTexture)
  {
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = paramSurfaceTexture;
  }
  
  public void a(alll paramalll)
  {
    this.jdField_a_of_type_Alll = paramalll;
  }
  ...
  public void drawFrame(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat, boolean paramBoolean, int paramInt5, int paramInt6)
  {
    if (this.jdField_a_of_type_Alll != null) {
      this.jdField_a_of_type_Alll.a(paramArrayOfByte1, paramArrayOfByte2, paramArrayOfByte3, paramInt1, paramInt2, paramInt3, paramInt4, paramFloat, paramBoolean);
    }
  }
