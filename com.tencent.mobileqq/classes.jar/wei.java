...
public class wei
{
  ...
  private static wei jdField_a_of_type_Wei;
  private Handler jdField_a_of_type_AndroidOsHandler;
  private String b = ajed.aU + "subscribe_draft/";
  private String c = ajed.aU + "subscribe_draft_simple/";
  ...
  public static wei a()
  {
    try
    {
      if (jdField_a_of_type_Wei == null) {
        jdField_a_of_type_Wei = new wei();
      }
      wei localwei = jdField_a_of_type_Wei;
      return localwei;
    }
    finally {}
  }
  
  public void a(Context paramContext, String paramString1, String paramString2, int paramInt, wes paramwes)
  {
    ...
    do
    {
      ...
      paramContext.a(new wej(this, paramwes, paramString1, paramContext));
      paramContext.a(new wek(this, paramString1, paramString2, paramwes, paramContext));
    } while (paramContext.isShowing());
    paramContext.show();
  }
  
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, wem paramwem)
  {
    ...
    {
      this.jdField_a_of_type_AndroidOsHandler.post(new SubscribeDraftManager.1(this, paramString1, paramString2, paramString3, paramString4, paramwem));
      return;
    }
    if (paramwem != null) {
      paramwem.a(3, false, paramString2, new Object[0]);
    }
    QLog.d(jdField_a_of_type_JavaLangString, 4, "modifyDraft failed because something is empty");
  }
  
  public void a(String paramString1, String paramString2, wem paramwem)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new SubscribeDraftManager.4(this, paramString1, paramString2, paramwem));
  }
  
  public void a(String paramString, wem paramwem)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new SubscribeDraftManager.2(this, paramString, paramwem));
  }
  ...
  public boolean a(String paramString)
  {
    ...
    if (paramString != null)
    {
      ...
      if ((paramString.exists()) && (paramString.isDirectory())) {
        return paramString.listFiles().length > 0;
      }
    }
    return false;
  }
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    //   2: aconst_null
    //   3: astore 4
    //   5: new 244	java/io/File
    //   8: dup
    //   9: aload_1
    //   10: invokespecial 245	java/io/File:<init>	(Ljava/lang/String;)V
    //   13: astore_1
    //   14: aload_1
    //   15: invokevirtual 248	java/io/File:exists	()Z
    //   18: ifne +35 -> 53
    //   21: aload_1
    //   22: invokevirtual 261	java/io/File:createNewFile	()Z
    //   25: pop
    //   26: new 263	java/io/FileWriter
    //   29: dup
    //   30: aload_1
    //   31: iconst_0
    //   32: invokespecial 266	java/io/FileWriter:<init>	(Ljava/io/File;Z)V
    //   35: astore_1
    //   36: aload_1
    //   37: aload_2
    //   38: invokevirtual 269	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   41: aload_1
    //   42: invokevirtual 272	java/io/FileWriter:flush	()V
    //   45: aload_1
    //   46: invokevirtual 273	java/io/FileWriter:close	()V
    //   49: iconst_1
    //   50: istore_3
    //   51: iload_3
    //   52: ireturn
    //   53: aload_1
    //   54: invokevirtual 276	java/io/File:delete	()Z
    //   57: pop
    //   58: aload_1
    //   59: invokevirtual 261	java/io/File:createNewFile	()Z
    //   62: pop
    //   63: goto -37 -> 26
    //   66: astore_1
    //   67: aload 4
    ...
    //   71: ifnull -20 -> 51
    //   74: aload_1
    //   75: invokevirtual 273	java/io/FileWriter:close	()V
    //   78: iconst_0
    //   79: ireturn
    //   80: astore_1
    //   81: iconst_0
  ...
  public void b(String paramString1, String paramString2, wem paramwem)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)))
    {
      QLog.d(jdField_a_of_type_JavaLangString, 4, "deletDraft failed because uin or draftID is empty");
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new SubscribeDraftManager.5(this, paramString1, paramString2, paramwem));
  }
}
