      ...
      for (;;)
      {
        ...
        if ("getCache".equals(paramString))
        {
          try
          {
            ...
            qzi.a().a(paramJSONObject.getString("url"), paramJSONObject.toString(), new sne(paramOnInovkeCallback));
            return;
          }
          catch (JSONException paramString)
          {
        ...
        else if ("writeCache".equals(paramString))
        {
          try
          {
            ...
            {
              paramJSONObject.put("callid", 0);
              qzi.a().a(paramJSONObject.getString("url"), paramJSONObject.toString(), null, paramJSONObject);
              return;
            }
          }
          catch (JSONException paramString)
