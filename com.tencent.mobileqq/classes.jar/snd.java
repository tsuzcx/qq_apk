...
public class snd
{
  ...
  {
    paramString2 = snf.b(paramString2);
    snb.d("WeishiScehmeUtil", "openWeishi: scheme = " + paramString2);
    jdField_a_of_type_Boolean = true;
    vzw.a(paramContext, paramString1, paramString2);
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      snb.d("WeishiScehmeUtil", "openWeishi context = " + paramContext + "scheme = " + paramString2);
      return;
    }
    ...
    snb.c("WeishiScehmeUtil", "openWeishi final scheme = " + paramString2);
