...
{
  public azjd(SplashADView paramSplashADView) {}
  ...
  public void onClick(View paramView)
  {
    if (this.a.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer != null)
    {
      if (this.a.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.getOutputMute())
      {
        ...
        this.a.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849761);
      }
    }
    else {
      return;
    ...
    this.a.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849762);
  }
}
