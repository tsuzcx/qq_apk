  ...
  extends BaseAdapter
{
  ...
  public ArrayList<bilc> a;
  public boolean a;
  public int b;
  
  public agoe(Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      while (i < this.jdField_a_of_type_Int)
      {
        ...
        ((LinearLayout)localObject2).addView(LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131561041, null), (ViewGroup.LayoutParams)localObject3);
        i += 1;
    ...
    for (;;)
    {
      ...
      for (localObject1 = (bilc)this.jdField_a_of_type_JavaUtilArrayList.get(k);; localObject1 = null)
      {
        ((ChangeVoiceView)localObject3).a((bilc)localObject1);
