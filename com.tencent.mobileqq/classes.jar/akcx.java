...
class akcx
  implements akae
{
  akcx(akcw paramakcw, MessageRecord paramMessageRecord, boolean paramBoolean, msg_svc.PbSendMsgReq paramPbSendMsgReq) {}
  
  public ToServiceMsg a()
  {
    long l = System.currentTimeMillis();
    ToServiceMsg localToServiceMsg = this.jdField_a_of_type_Akcw.a.createToServiceMsg("MessageSvc.PbMultiMsgSend");
    ...
    localToServiceMsg.extraData.putBoolean(awav.h, this.jdField_a_of_type_Boolean);
    ...
    {
      int i = awbk.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.msgUid);
