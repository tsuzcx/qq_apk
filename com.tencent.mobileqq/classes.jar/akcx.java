...
public class akcx
  extends aywi
{
  private akcx(ContactListView paramContactListView) {}
  
  protected void a(boolean paramBoolean, int paramInt)
  {
    if ((!paramBoolean) || (!bgnt.d(this.a.getContext())))
    {
      this.a.i();
      this.a.g();
    }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (!paramBoolean1)
    {
      this.a.i();
      this.a.g();
      if (((i == 0) || (i == 7)) && ((this.a.jdField_a_of_type_Int != 2) || (!(this.a.jdField_a_of_type_Aufz instanceof ForwardShareCardOption))) && (this.a.b == 0)) {
        this.a.a(2131717326, 3000L);
      }
    }
    do
    {
