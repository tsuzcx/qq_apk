...
public class akus
{
  private static akus jdField_a_of_type_Akus;
  public static final String a;
  public static final String b;
  private static boolean jdField_b_of_type_Boolean;
  public static final String c;
  private static final String d = aktw.jdField_a_of_type_JavaLangString + "/qav" + File.separator + "beauty" + File.separator;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = aktw.jdField_a_of_type_JavaLangString + "/qsvf" + File.separator;
  ...
  public static int a(Context paramContext)
  {
    ...
    if ((j > 0) && (!new File(jdField_a_of_type_JavaLangString + "filter_config.xml").exists())) {
      lba.f("VideoFilterTools", "getQQShortVideoFilterConfigVersion config file don't exist!");
    }
    for (;;)
    {
      lba.f("VideoFilterTools", "getQQShortVideoFilterConfigVersion:" + i);
      return i;
      i = j;
    }
  }
  ...
  {
    if (jdField_a_of_type_Akus == null) {
      jdField_a_of_type_Akus = new akus();
    }
    return jdField_a_of_type_Akus;
  }
  
  private static akux a(String paramString)
  {
    if (TextUtils.isEmpty(paramString))
    {
      lba.f("VideoFilterTools", "parseConfig|content is empty.");
      return null;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        localakux = new akux(i, str1, str2);
        try
        {
          lba.f("VideoFilterTools", "parseConfig:" + i + "|" + str1 + "|" + str2);
          return localakux;
        }
      ...
      try
      {
        ...
        lba.f("VideoFilterTools", "parseConfig failed. info = " + localJSONObject);
        return localakux;
      }
      catch (JSONException localJSONException2)
      {
        localJSONException2.printStackTrace();
        lba.f("VideoFilterTools", "parseConfig|parse failed.context = " + paramString);
        return localakux;
      }
    }
  }
  ...
  public static String a(Context paramContext)
  {
    try
    {
      ...
      lba.f("VideoFilterTools", "getQQShortVideoFilterConfig:" + jdField_a_of_type_JavaLangString + "filter_config.xml" + "|" + localFile.exists());
      if (localFile.exists()) {
  ...
  {
    lba.f("VideoFilterTools", "setQQShortVideoFilterConfigVersion:" + paramInt);
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
  ...
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    if (paramString == null)
    {
      lba.f("VideoFilterTools", "updateQQShortVideoFilterConfig error ");
      return;
    }
  ...
  static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        lba.f("VideoFilterTools", "compareContent :" + (l2 - l1));
        return;
        ...
        if (paramString1 != null)
        {
          ...
          while (paramString1.hasNext())
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              {
                lba.f("VideoFilterTools", "compareContent res:" + localFilterDesc.name + "|" + localFilterDesc.resMD5 + "|" + paramString2.resMD5);
                ...
                lba.f("VideoFilterTools", "compareContent iconMD5:" + localFilterDesc.name + "|" + localFilterDesc.iconMD5 + "|" + paramString2.iconMD5);
  ...
  {
    if (paramString == null) {
      lba.f("VideoFilterTools", "handleQQSvCommonConfig empty content!");
    }
    do
    {
      for (;;)
      ...
      try
      {
        ...
        while (i < localJSONArray.length())
        {
          ...
          try
          {
            ...
            lba.f("VideoFilterTools", "parseConfig:" + k + "|" + m + "|" + n + "|" + str5 + "|" + str1 + "|" + str4 + "|" + str2 + "|" + str3);
            i += 1;
          }
  ...
  public static boolean a(int paramInt1, long paramLong1, long paramLong2, int paramInt2)
  {
    ...
    if (i < paramInt2)
    {
      lba.f("VideoFilterTools", "isSupportOfDevice error OSversion: " + i);
      return false;
    }
    paramInt2 = lld.e();
    if (paramInt2 < paramInt1)
    {
      lba.f("VideoFilterTools", "isSupportOfDevice error cpucount: " + paramInt2);
      return false;
    }
    long l = lld.d();
    if (l < paramLong1)
    {
      lba.f("VideoFilterTools", "isSupportOfDevice error cpuFrequency: " + l);
      return false;
    }
    paramLong1 = DeviceInfoUtil.getSystemTotalMemory();
    if (paramLong1 < paramLong2)
    {
      lba.f("VideoFilterTools", "isSupportOfDevice error memory: " + paramLong1);
      return false;
    }
    return true;
  }
  ...
  public static String b(Context paramContext)
  {
    try
    {
      ...
      lba.f("VideoFilterTools", "getVideoEffectBeautyConfig:" + d + "beauty_config.json" + "|" + localFile.exists());
      if (localFile.exists()) {
        return FileUtils.readFileToString(localFile);
      }
      b(paramContext, 0);
  ...
  public static void b(Context paramContext)
  {
    try
    {
      ...
      if ((paramContext != null) && (!TextUtils.isEmpty(paramContext.jdField_a_of_type_JavaLangString)))
      {
        ...
        lba.f("VideoFilterTools", "preDownloadResource :" + ((File)localObject).exists());
        if (!((File)localObject).exists())
        {
          localObject = new HttpNetReq();
          ((HttpNetReq)localObject).mCallback = new akuu();
  ...
  {
    lba.f("VideoFilterTools", "setVideoEffectBeautyConfigVersion:" + paramInt);
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
  ...
  public static boolean b(Context paramContext)
  {
    ...
    lba.f("VideoFilterTools", "getIsFirstLauncher:" + i);
    if (i == 0) {
      bool = true;
    }
    return bool;
  ...
  public FilterRender a(int paramInt1, int paramInt2)
  {
    ...
    {
      lba.f("VideoFilterTools", "getFilter|init texture.");
    ...
    {
      lba.f("VideoFilterTools", "getFilterRender|destroy current filterRender.");
  ...
  public List<FilterDesc> a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        lba.f("VideoFilterTools", "getFilterDescs " + str1 + " exist: " + bool);
        if (bool)
        {
          ...
          lba.f("VideoFilterTools", "getFilterDescs " + str2 + " exist: " + bool);
    ...
    while (((Iterator)???).hasNext())
    {
      ...
      lba.f("VideoFilterTools", "getFilterDescs " + (String)localObject3 + " exist: " + bool);
      if (bool)
      {
  ...
  public void a(Context paramContext, akuw arg2)
  {
    if (QLog.isColorLevel()) {
      com.tencent.av.video.effect.QavVideoEffect.DEBUG_MODE = true;
    }
    lba.f("VideoFilterTools", "init");
    if (this.jdField_a_of_type_JavaUtilArrayList == null) {
      this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    }
    this.jdField_a_of_type_Akuw = ???;
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      a(a(paramContext), this.jdField_a_of_type_JavaUtilArrayList);
      a(this.jdField_a_of_type_JavaUtilArrayList);
      lba.f("VideoFilterTools", "filter list size:" + this.jdField_a_of_type_JavaUtilArrayList.size());
  ...
  void a(List<FilterDesc> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      lba.f("VideoFilterTools", "preDownloadResource list is empty!");
    }
    do
    {
      return;
      lba.f("VideoFilterTools", "preDownloadResource list size: " + paramList.size());
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(0);
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        FilterDesc localFilterDesc = (FilterDesc)paramList.next();
        lba.f("VideoFilterTools", "preDownloadResource predownload: " + localFilterDesc.predownload + ", iconurl: " + localFilterDesc.iconurl + ", resurl:" + localFilterDesc.resurl);
        if (localFilterDesc.predownload == 1)
        {
          ...
          if (!TextUtils.isEmpty(localFilterDesc.iconurl))
          {
            ...
            lba.f("VideoFilterTools", "preDownloadResource " + (String)localObject1 + " exist: " + ((File)localObject2).exists());
            if (!((File)localObject2).exists())
            {
              localObject2 = new HttpNetReq();
              ((HttpNetReq)localObject2).mCallback = new akuv(this);
              ...
              lbc.a().sendReq((NetReq)localObject2);
          ...
          if ((!TextUtils.isEmpty(localFilterDesc.resurl)) && (!TextUtils.isEmpty((CharSequence)localObject1)))
          {
            ...
            lba.f("VideoFilterTools", "preDownloadResource " + (String)localObject1 + "params.json" + " exist: " + ((File)localObject2).exists());
            if (!((File)localObject2).exists())
            {
              localObject1 = new HttpNetReq();
              ((HttpNetReq)localObject1).mCallback = new akut(this);
              ...
              lbc.a().sendReq((NetReq)localObject1);
              this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
            }
          }
        }
      }
    } while ((this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) || (this.jdField_a_of_type_Akuw == null));
    this.jdField_a_of_type_Akuw.a(false);
  }
  ...
  public void b()
  {
    lba.f("VideoFilterTools", "destroy");
  ...
  public void c(Context paramContext)
  {
    if (new File(d + "beauty_config.json").exists())
    {
      ...
      {
        lba.f("VideoFilterTools", "!JasonFile.exists()");
        b(paramContext);
      }
      return;
    }
    lba.f("VideoFilterTools", "BEAUTY_CONFIG  is not exsit");
  }
