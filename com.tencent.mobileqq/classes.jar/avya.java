  ...
  implements bekg
{
  ...
  private void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt, long paramLong2, long paramLong3, boolean paramBoolean, long paramLong4)
  {
    ...
    String str1 = String.format(paramQQAppInterface.getApp().getString(2131698991), new Object[] { str1 });
    if (paramBoolean)
    {
      a(paramQQAppInterface, paramLong1, 1, str1, paramInt, paramLong2, paramLong3, 131092);
      return;
    }
    String str2 = paramQQAppInterface.getApp().getString(2131698990);
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, String paramString, int paramInt2, long paramLong2, long paramLong3, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    do
    {
      ...
      paramString = new avhz((String)localObject, (String)localObject, paramString, paramInt1, i, paramInt3, bcrg.a());
      ...
      bool = avia.a(paramQQAppInterface, (MessageForUniteGrayTip)localObject);
    } while (!QLog.isColorLevel());
  ...
  {
    bekh localbekh = ((bejv)this.a.getManager(QQManagerFactory.TOGETHER_CONTROLLER_MANAGER)).a(2, 1, paramString);
    if ((localbekh instanceof WatchTogetherSession))
    {
      localbekh.jdField_h_of_type_Int = 3;
      localbekh.i = 3;
      beki.a(this.a, paramString, false);
      a(true, (WatchTogetherSession)localbekh, 1007, "");
    }
  }
    ...
    do
    {
      ...
      if (localVideoChangePushInfo != null)
      {
        ...
        for (paramObject = localVideoChangePushInfo.bytes_gray_tips.get().toStringUtf8();; paramObject = null)
        {
          ...
          long l4 = ((bejv)paramQQAppInterface.getManager(QQManagerFactory.TOGETHER_CONTROLLER_MANAGER)).a(2, 1, l2);
          if (l1 >= l4) {
            break label414;
          }
          if (!QLog.isColorLevel()) {
        ...
        WatchTogetherSession localWatchTogetherSession = (WatchTogetherSession)beki.a(2, 1, String.valueOf(l2));
        String str;
        if (i == 1)
        {
          if (l3 == -1L)
  ...
  public void a(QQAppInterface paramQQAppInterface, WatchTogetherSession paramWatchTogetherSession, int paramInt, long paramLong1, String paramString, long paramLong2, long paramLong3, TroopTips0x857.VideoChangePushInfo paramVideoChangePushInfo)
  {
    ...
    localbejv.a(2, 1, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramLong2);
    WatchTogetherSession localWatchTogetherSession2 = (WatchTogetherSession)localbejv.a(paramWatchTogetherSession.jdField_e_of_type_Int, paramWatchTogetherSession.jdField_f_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_JavaLangString);
    ...
    if (localWatchTogetherSession2 != null)
    {
      ...
      if (paramQQAppInterface.getCurrentAccountUin().equals(String.valueOf(paramLong1)))
      {
        ...
        beki.a(paramQQAppInterface, localWatchTogetherSession1.jdField_e_of_type_JavaLangString, true);
      }
    }
    for (;;)
    {
      ...
      {
        paramQQAppInterface = localbejv.a(2, 1, localWatchTogetherSession1.jdField_e_of_type_JavaLangString, 1003);
        ...
        localbejv.a(2, 1, localWatchTogetherSession1.jdField_e_of_type_JavaLangString, 1003);
      }
      return;
      localbejv.a(paramWatchTogetherSession.jdField_e_of_type_Int, paramWatchTogetherSession.jdField_f_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramWatchTogetherSession);
      localWatchTogetherSession1 = paramWatchTogetherSession;
      break;
      label277:
      if (paramInt == 2) {
        beki.a(paramQQAppInterface, localWatchTogetherSession1.jdField_e_of_type_JavaLangString, false);
      }
    }
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, aio_media.RspLatestPlayingState paramRspLatestPlayingState)
  {
    ...
    paramToServiceMsg = (WatchTogetherSession)localbejv.a(2, 1, str);
    Object localObject = paramToServiceMsg;
    if (paramToServiceMsg == null)
    {
      localObject = (WatchTogetherSession)beki.a(2, 1, str);
      localbejv.a(2, 1, str, (bekh)localObject);
    }
    boolean bool1;
    label470:
    boolean bool2;
  ...
  {
    bejv localbejv = (bejv)this.a.getManager(QQManagerFactory.TOGETHER_CONTROLLER_MANAGER);
    Object localObject = localbejv.a(2, 1, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramInt);
    if ((paramBoolean) && (paramInt == 1003) && ((((bekb)localObject).jdField_a_of_type_JavaLangObject instanceof TroopTips0x857.VideoChangePushInfo)))
    {
      int i = ((bekb)localObject).jdField_a_of_type_AndroidOsBundle.getInt("action_type");
      String str = ((bekb)localObject).jdField_a_of_type_AndroidOsBundle.getString("tips");
      long l1 = ((bekb)localObject).jdField_a_of_type_AndroidOsBundle.getLong("seq");
      long l2 = ((bekb)localObject).jdField_a_of_type_AndroidOsBundle.getLong("msgSeq");
      localbejv.a(paramWatchTogetherSession, i, str, l1, l2, (TroopTips0x857.VideoChangePushInfo)((bekb)localObject).jdField_a_of_type_JavaLangObject);
      localbejv.b(paramWatchTogetherSession, i, str, l1, l2, (TroopTips0x857.VideoChangePushInfo)((bekb)localObject).jdField_a_of_type_JavaLangObject);
    }
    boolean bool1;
    label201:
    boolean bool2;
    ...
    {
      beki.a(this.a, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, false);
      if ((paramWatchTogetherSession.jdField_h_of_type_Int == 1) && (paramWatchTogetherSession.i == 2))
      {
        ...
        bool2 = true;
        label224:
        if ((!bool1) || (!bool2) || (!avxi.b(paramWatchTogetherSession.jdField_e_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramWatchTogetherSession.jdField_f_of_type_Int))) {
          break label562;
        }
        if (QLog.isColorLevel()) {
        ...
        label361:
        avxi.a(BaseApplicationImpl.context, (WatchTogetherFloatingData)localObject);
      }
    }
    for (;;)
    {
      ...
      localbejv.a(paramBoolean, paramWatchTogetherSession, paramInt, paramString);
      localbejv.b(2, 1, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramInt);
      return;
      beki.a(this.a, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, true);
      break;
      label541:
      bool1 = false;
      break label201;
      ...
      break label361;
      label562:
      if (avxi.b(paramWatchTogetherSession.jdField_e_of_type_Int, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramWatchTogetherSession.jdField_f_of_type_Int))
      {
        if (QLog.isColorLevel()) {
          QLog.d("WatchTogetherParser", 1, "isSameFloatingInfo but param error isSupportRoomType=" + bool1 + " isUrlValid=" + bool2);
        }
        avxi.a(false, paramWatchTogetherSession.jdField_e_of_type_JavaLangString, paramWatchTogetherSession.jdField_f_of_type_Int, false);
      }
    }
  }
}
