  ...
  implements oqp
{
  public void a(int paramInt, @NotNull Container paramContainer, @NotNull ouc paramouc, @NotNull ouo paramouo, @NotNull ViewBase paramViewBase)
  {
    ...
    paramViewBase.setOnClickListener((ViewBase.OnClickListener)new oqz(paramContainer.getVirtualView().findViewBaseByName("id_first_comment_view"), paramouc, paramouo));
  }
}
