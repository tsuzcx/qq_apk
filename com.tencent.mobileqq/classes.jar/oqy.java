  ...
  implements pvg
{
  ...
  private ViewPager.OnPageChangeListener jdField_a_of_type_AndroidSupportV4ViewViewPager$OnPageChangeListener = new ore(this);
  ...
  private Map<Integer, rot> jdField_a_of_type_JavaUtilMap = new HashMap();
  private orf jdField_a_of_type_Orf;
  private org jdField_a_of_type_Org;
  private pvj jdField_a_of_type_Pvj;
  private pvq jdField_a_of_type_Pvq = new ord(this);
  private pwk jdField_a_of_type_Pwk = new orc(this);
  ...
  static
  {
    ...
    jdField_a_of_type_Long = bmhv.f(pkh.a());
  }
  
  public oqy(Context paramContext, View paramView, ReadInJoyChannelViewPager paramReadInJoyChannelViewPager)
  {
    ...
    this.jdField_a_of_type_ComTencentBizWidgetsTabLayout = ((TabLayout)this.jdField_b_of_type_AndroidViewView.findViewById(2131378429));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131369463));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131369524));
  ...
  private void a(int paramInt1, float paramFloat, int paramInt2)
  {
    ...
    {
      localView2 = localViewGroup.findViewById(2131369118);
      paramInt2 = 0;
      if (paramInt1 != i - 1) {
        break label274;
      }
  ...
  public static void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    try
    {
      paramString = new pqg().b().f().a(paramInt1).b(paramInt2 + 1).d(paramString);
      if (paramInt1 == 41695)
      {
        localObject = pvj.a().a();
        if (localObject != null)
  ...
  private void a(View paramView1, View paramView2)
  {
    ...
    paramView1 = (TextView)paramView1.findViewById(2131380210);
    paramView2 = (TextView)paramView2.findViewById(2131380210);
    a(paramView1);
    b(paramView2);
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    olh.a(null, "", paramString1, paramString1, 0, 0, paramString2, "", "", paramString3, false);
  }
  ...
  private void a(List<TabChannelCoverInfo> paramList)
  {
    ...
    if (this.jdField_a_of_type_Org != null)
    {
      ...
      this.jdField_a_of_type_Org.a(paramList);
    }
  ...
  private void a(Map<Integer, rot> paramMap)
  {
    if (paramMap != null)
    {
      ...
      if (paramMap.hasNext())
      {
        ...
        {
          oxo.a("0X8009495", localTabChannelCoverInfo, j, i, localrot.l);
          break;
        }
      }
    }
  ...
  private void b(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    KandianSubscribeManager localKandianSubscribeManager = (KandianSubscribeManager)pkh.a().getManager(QQManagerFactory.KANDIAN_SUBSCRIBE_MANAGER);
    rrx localrrx = new rrx();
    localrrx.jdField_a_of_type_Long = 0L;
    localrrx.b = 9223372036854775807L;
    localrrx.jdField_a_of_type_Boolean = localKandianSubscribeManager.a();
    paramTabChannelCoverInfo.redPoint = localrrx;
    a(paramTabChannelCoverInfo);
  }
  
  private void b(List<TabChannelCoverInfo> paramList)
  {
    List localList = this.jdField_a_of_type_Pvj.a();
    if ((localList != null) && (localList.size() > 0))
    {
      ((rov)localList.get(0)).jdField_a_of_type_JavaUtilList = paramList;
      this.jdField_a_of_type_Pvj.a(localList, 1, true);
    }
  ...
  private int e()
  {
    List localList = this.jdField_a_of_type_Pvj.b();
    int k;
    if ((localList == null) || (localList.size() == 0))
    {
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_Tbq = new tbq(this.jdField_b_of_type_AndroidViewView.getContext(), this.jdField_a_of_type_JavaUtilList, this.jdField_a_of_type_ComTencentBizWidgetsTabLayout, this);
    this.jdField_a_of_type_JavaUtilMap.clear();
    this.jdField_a_of_type_Tbq.a(this.jdField_a_of_type_JavaUtilMap);
    this.jdField_a_of_type_ComTencentBizWidgetsTabLayout.setAdapter(this.jdField_a_of_type_Tbq);
    ...
    k();
    jdField_a_of_type_Int = e();
    pwf.a(this.jdField_a_of_type_Pwk);
    h();
  }
  ...
  private void h()
  {
    ...
    VideoReport.setElementParams(this.jdField_a_of_type_AndroidWidgetImageView, new pti().a("14").c("click_more_channel").b("channel_bar").a().a());
  ...
  private void i()
  {
    Object localObject = (pvp)pkh.a().getManager(QQManagerFactory.READINJOY_LOGIC_MANAGER);
    List localList;
    if (localObject != null)
    {
  ...
  private void j()
  {
    if (pli.a())
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849421);
      return;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130842983);
  }
  
  private void k()
  {
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new oqz(this));
  }
  ...
  private void n()
  {
    ...
    if (this.jdField_a_of_type_ComTencentWidgetHorizontalListView$OnScrollStateChangedListener == null) {
      this.jdField_a_of_type_ComTencentWidgetHorizontalListView$OnScrollStateChangedListener = new orb(this);
    }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        a("0X8009B94", "", new pqg().a("source", "302").a(((TabChannelCoverInfo)localObject).mChannelCoverId).b("style", 0).a());
        if (c() == paramInt)
        {
      ...
      catch (JSONException localJSONException1)
      {
        try
        {
          a("0X8009665", "", pqf.a().a(((TabChannelCoverInfo)localObject).mChannelCoverId).m(ReadInJoyChannelPanelFragment.a((ChannelCoverInfo)localObject)).n(ReadInJoyChannelPanelFragment.a((TabChannelCoverInfo)localObject)).a());
          boolean bool = bmhv.D();
          if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
  ...
  public void a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    do
    {
      do
      {
        ...
        localObject = (pvp)pkh.a().getManager(QQManagerFactory.READINJOY_LOGIC_MANAGER);
      } while (localObject == null);
      localObject = ((pvp)localObject).a();
    } while (localObject == null);
    if (pno.a())
    {
      ((pvj)localObject).a(paramTabChannelCoverInfo);
      return;
    }
    pno.b().post(new ReadInJoyChannelViewPagerController.3(this, (pvj)localObject, paramTabChannelCoverInfo));
  }
  
  public void a(orf paramorf)
  {
    this.jdField_a_of_type_Orf = paramorf;
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      while (i > 0)
      {
        ...
        this.jdField_a_of_type_Pvj.a(localTabChannelCoverInfo.mChannelCoverId, 5, false, false);
        i -= 1;
      }
      this.jdField_a_of_type_Tbq.notifyDataSetChanged();
    }
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Pwk != null) {
  ...
  public void y_()
  {
    ...
    rrx localrrx = new rrx();
    localrrx.jdField_a_of_type_Boolean = true;
    localrrx.jdField_a_of_type_Long = 0L;
    localrrx.b = 9223372036854775807L;
    localTabChannelCoverInfo.redPoint = localrrx;
    a(localTabChannelCoverInfo);
    this.jdField_a_of_type_ComTencentBizWidgetsTabLayout.a();
  }
}
