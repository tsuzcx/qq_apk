  ...
  extends oql<BaseArticleInfo>
{
  ...
  public int a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    {
      actj.a("DynamicItemViewHelperCompat", "", new IllegalArgumentException(ajya.a(2131703581)));
      return b;
    }
  ...
  protected TemplateBean a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    try
    {
      ...
      JSONObject localJSONObject = this.jdField_a_of_type_Pft.a(i, paramBaseArticleInfo);
      localTemplateBean1 = localTemplateBean2;
      localTemplateBean2 = this.jdField_a_of_type_Pft.a(i, localJSONObject);
      localTemplateBean1 = localTemplateBean2;
  ...
  public void a(ProteusItemView paramProteusItemView, int paramInt1, BaseArticleInfo paramBaseArticleInfo, VafContext paramVafContext, int paramInt2)
  {
    ...
    if (localTemplateBean1 != null)
    {
      ...
      if (localTemplateBean2 != null)
      {
        ...
        if (!localTemplateBean2.equals(localTemplateBean1))
        {
          ...
          if (localObject != null)
          {
            ((Container)localObject).setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841262));
    ...
    if (localTemplateBean2 != null) {
      olo.a(paramBaseArticleInfo, (TemplateBean)localObject, localTemplateBean2);
    }
    olo.a(paramBaseArticleInfo, paramVafContext, localTemplateBean2);
    bfwu.a();
  }
