  ...
  extends bgpa
{
  ...
  private agpt jdField_a_of_type_Agpt = new bgow(this);
  private ArkViewImplement.LoadCallback jdField_a_of_type_ComTencentArkArkViewImplement$LoadCallback = new bgox(this);
  ...
  public bgov(Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
  }
  
  private agpq a(bgoy parambgoy)
  {
    this.jdField_a_of_type_Agpq = new agpp();
    ...
    if (QLog.isDebugVersion()) {
      QLog.d("QQCustomArkDialog", 4, "w=" + i + ",h=" + j + ", appName:" + parambgoy.jdField_a_of_type_JavaLangString);
    }
    this.jdField_a_of_type_Agpq.a(parambgoy.jdField_a_of_type_JavaLangString, parambgoy.b, parambgoy.c, parambgoy.d, parambgoy.jdField_a_of_type_Float, parambgoy.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    if ((this.e != 0) && (this.f != 0)) {
      this.jdField_a_of_type_Agpq.setFixSize(this.e, this.f);
    }
    for (;;)
    {
      apih.a = false;
      return this.jdField_a_of_type_Agpq;
      this.jdField_a_of_type_Agpq.setFixSize(this.d, this.g);
      this.jdField_a_of_type_Agpq.setMaxSize(this.d, this.jdField_a_of_type_Int);
      this.jdField_a_of_type_Agpq.setMinSize(this.b, this.c);
    }
  }
  ...
  {
    paramBundle = a(new bgoy(paramBundle));
    paramBundle.a(this.jdField_a_of_type_Agpt);
  ...
  public void a(Context paramContext, Bundle paramBundle)
  {
    try
    {
      ...
      View localView = LayoutInflater.from(paramContext).inflate(2131558828, null);
      localView.setPadding(0, 0, 0, 0);
      this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView = ((ArkAppView)localView.findViewById(2131362910));
      this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppLoadLayout = ((ArkAppLoadLayout)localView.findViewById(2131370188));
      localView.findViewById(2131362934).setPadding(0, 0, 0, 0);
      ((LinearLayout)localView.findViewById(2131362917)).setVisibility(8);
      ...
      if (bool2)
      {
        localObject2 = MessageForArkApp.limitToSizeRange(apoh.a(), ((ArkAppMessage.Config)localObject1).width.intValue(), ((ArkAppMessage.Config)localObject1).height.intValue());
      ...
      if (!bool1)
      {
        localObject2 = findViewById(2131363680);
        if (localObject2 != null) {
        ...
        localObject2 = findViewById(2131365438);
        if (localObject2 != null) {
          ((View)localObject2).setVisibility(8);
        }
        localObject2 = findViewById(2131365456);
        if (localObject2 != null) {
          ((View)localObject2).setVisibility(8);
        }
        ...
        if (paramContext != null) {
          appq.a(paramContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView);
        }
      }
    }
