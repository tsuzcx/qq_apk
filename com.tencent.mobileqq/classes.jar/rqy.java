...
public class rqy
{
    ...
    do
    {
      do
      {
        do
        {
          ...
          jdField_a_of_type_Int = agej.a(28.0F, paramActivity.getResources());
          this.jdField_a_of_type_AndroidViewViewGroup.getLocationInWindow(this.jdField_a_of_type_ArrayOfInt);
          this.jdField_a_of_type_JavaUtilRandom = new Random();
          paramActivity = a();
          if (paramActivity != null)
          {
            this.jdField_a_of_type_Rqx = ((rqx)paramActivity.a(138));
            this.jdField_a_of_type_Rqz = new rqz(this);
            paramActivity.addObserver(this.jdField_a_of_type_Rqz);
          }
          this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo = bnrf.a();
          if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo == null) {
            break label236;
          }
          if ((this.jdField_a_of_type_Rqx == null) || (!bnrf.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoLikeAnimationInfo.jdField_a_of_type_Int))) {
            break;
          }
          this.jdField_a_of_type_Rqx.a(paramInt);
          bnrf.a(System.currentTimeMillis());
      ...
      return;
    } while (this.jdField_a_of_type_Rqx == null);
    this.jdField_a_of_type_Rqx.a(paramInt);
    bnrf.a(System.currentTimeMillis());
  }
  ...
  public void a()
  {
    ...
    if (localQQAppInterface != null) {
      localQQAppInterface.removeObserver(this.jdField_a_of_type_Rqz);
    }
  }
