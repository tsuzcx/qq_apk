  ...
  extends BusinessHandler
{
  ...
  public bhab(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_AndroidSupportV4UtilLruCache = new LruCache(100);
    this.jdField_a_of_type_Bhaj = new bhaj();
    this.jdField_a_of_type_Bhar = null;
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bhah(this);
  ...
  public bhar a(String paramString)
  {
    if (this.jdField_a_of_type_Bhar == null) {
      this.jdField_a_of_type_Bhar = new bhar(paramString);
    }
    if (!TextUtils.isEmpty(paramString)) {
      this.jdField_a_of_type_Bhar.jdField_a_of_type_JavaLangString = paramString;
    }
    return this.jdField_a_of_type_Bhar;
  }
  
  protected nmf a(bhai<oidb_0x8e4.RspBody> parambhai)
  {
    return new bhaf(this, parambhai);
  }
  ...
  public void a(int paramInt1, int paramInt2, bhai<oidb_0x8e4.RspBody> parambhai)
  {
    ...
    nmb.a(this.app, a(parambhai), localReqBody.toByteArray(), "OidbSvc.0x8e4_1", 2276, 1, new Bundle(), 5000L);
  }
  ...
  public void a(TextView paramTextView, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      if (((amsw)localObject).b(paramString1))
      {
      ...
      localObject = ((amsw)localObject).a(paramString1);
  ...
  public void a(bhai<oidb_0x8e4.RspBody> parambhai)
  {
    if (QLog.isColorLevel()) {
      QLog.e("WerewolvesHandler", 2, "reqInviteId");
    }
    oidb_0x8e4.ReqBody localReqBody = new oidb_0x8e4.ReqBody();
    nmb.a(this.app, a(parambhai), localReqBody.toByteArray(), "OidbSvc.0x8e4_6", 2276, 6, new Bundle(), 5000L);
  }
  ...
  public void a(HotChatInfo paramHotChatInfo)
  {
    try
    {
      ...
      awkz.a().a(l);
      awka.a(this.app.getCurrentAccountUin(), "game_room_last_time", Long.valueOf(bbko.a()));
  ...
  public void a(HotChatInfo paramHotChatInfo, int paramInt1, int paramInt2, bhai<oidb_0x8e4.RspBody> parambhai)
  {
    if (QLog.isColorLevel()) {
      QLog.e("WerewolvesHandler", 2, "exitRoom");
    }
    oidb_0x8ed.ReqBody localReqBody = new oidb_0x8ed.ReqBody();
    bhad localbhad = new bhad(this, parambhai);
    try
    {
      long l = Long.parseLong(paramHotChatInfo.troopUin);
      localReqBody.uint64_room_id.set(l, true);
      localReqBody.rpt_uint64_uins.add(Long.valueOf(this.app.getLongAccountUin()));
      nmb.a(this.app, b(new bhae(this, localbhad, paramHotChatInfo, l, paramInt2, paramInt1, parambhai)), localReqBody.toByteArray(), "OidbSvc.0x8ed_2", 2285, 2, new Bundle(), 5000L);
      return;
    }
    catch (Exception paramHotChatInfo)
    {
  ...
  public void a(HotChatInfo paramHotChatInfo, bhai<oidb_0x8ed.RspBody> parambhai)
  {
    if (QLog.isColorLevel()) {
      QLog.e("WerewolvesHandler", 2, "exitRoom");
    }
    ...
    try
    {
      ...
      localReqBody.uint64_room_id.set(l, true);
      localReqBody.rpt_uint64_uins.add(Long.valueOf(this.app.getLongAccountUin()));
      nmb.a(this.app, b(new bhac(this, parambhai, paramHotChatInfo)), localReqBody.toByteArray(), "OidbSvc.0x8ed_2", 2285, 2, new Bundle(), 5000L);
      awkz.a().a(l);
      awka.a(this.app.getCurrentAccountUin(), "game_room_last_time", Long.valueOf(bbko.a()));
      try
      {
  ...
  public void a(String paramString, long paramLong, bhai<oidb_0x8e4.RspBody> parambhai)
  {
    if (QLog.isColorLevel()) {
    ...
    nmb.a(this.app, a(parambhai), localReqBody.toByteArray(), "OidbSvc.0x8e4_5", 2276, 5, new Bundle(), 5000L);
  }
  
  public void a(String paramString, bhai<oidb_0x8e4.RspBody> parambhai)
  {
    oidb_0x8e4.ReqBody localReqBody = new oidb_0x8e4.ReqBody();
    localReqBody.string_invite_id.set(ByteStringMicro.copyFromUtf8(paramString), true);
    nmb.a(this.app, a(parambhai), localReqBody.toByteArray(), "OidbSvc.0x8e4_3", 2276, 3, new Bundle(), 5000L);
  }
  
  public void a(String paramString, boolean paramBoolean, bhai<oidb_0x8e4.RspBody> parambhai)
  {
    if (TextUtils.isEmpty(paramString))
    {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      nmb.a(this.app, a(parambhai), localReqBody.toByteArray(), "OidbSvc.0x8e4_2", 2276, 2, new Bundle(), 5000L);
      return;
    }
  }
  ...
  public void a(TroopTips0x857.WereWolfPush paramWereWolfPush, byte[] paramArrayOfByte)
  {
    ...
    {
      ((amtp)this.app.getBusinessHandler(35)).a(2);
      return;
    }
    ...
    for (paramWereWolfPush = "";; paramWereWolfPush = str1.substring(0, 1) + "***" + str1.substring(str1.length() - 1) + "|msg len:" + str1.length())
    {
      ...
      this.jdField_a_of_type_Bhar.a("WereWolfPush", paramArrayOfByte);
      return;
    }
  }
  ...
  protected nmf b(bhai<oidb_0x8ed.RspBody> parambhai)
  {
    return new bhag(this, parambhai);
  }
  
  public void b(int paramInt1, int paramInt2, bhai<oidb_0x8e4.RspBody> parambhai)
  {
    if (QLog.isColorLevel()) {
    ...
    localReqBody.uint32_zone_id.set(paramInt2);
    nmb.a(this.app, a(parambhai), localReqBody.toByteArray(), "OidbSvc.0x8e4_4", 2276, 4, new Bundle(), 5000L);
  }
  
  public void b(String paramString, bhai<oidb_0x8e4.RspBody> parambhai)
  {
    if (QLog.isColorLevel()) {
  ...
  public void b(String paramString, boolean paramBoolean, bhai<oidb_0x8e4.RspBody> parambhai)
  {
    oidb_0x8e4.ReqBody localReqBody = new oidb_0x8e4.ReqBody();
    ...
    {
      paramString.set(i);
      nmb.a(this.app, a(parambhai), localReqBody.toByteArray(), "OidbSvc.0x8e4_7", 2276, 7, new Bundle(), 5000L);
      return;
    }
  }
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_Bhaj.removeCallbacksAndMessages(null);
    super.onDestroy();
  }
    ...
    if ("ProfileService.GetSimpleInfo".equals(localObject))
    {
      ...
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        if ((localObject != null) && (paramToServiceMsg != null) && (((ArrayList)localObject).size() > 0) && (paramToServiceMsg.size() > 0))
        {
          ...
          this.jdField_a_of_type_Bhaj.sendMessage(paramFromServiceMsg);
        }
      }
    }
  }
