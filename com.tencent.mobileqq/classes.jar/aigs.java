...
public class aigs
{
  ...
  public static ArrayList<aigr> a;
  ...
  public static aigr a(int paramInt)
  {
    if (jdField_a_of_type_JavaUtilArrayList.size() > paramInt) {
      return (aigr)jdField_a_of_type_JavaUtilArrayList.get(paramInt);
    }
    return null;
  }
  ...
  public static Drawable a(int paramInt)
  {
    ...
    ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = BaseApplicationImpl.getContext().getResources().getDrawable(2130841518);
    ((URLDrawable.URLDrawableOptions)localObject).mFailedDrawable = BaseApplicationImpl.getContext().getResources().getDrawable(2130841518);
  ...
  public static String a(int paramInt)
  {
    ...
    if (TextUtils.isEmpty(str2)) {
      str1 = anvx.a(2131707369);
    }
    return str1;
  }
  
  public static List<aigr> a(String paramString)
  {
        ...
        for (;;)
        {
          if (i < j) {
            try
            {
              ...
              aigr localaigr = new aigr();
              localaigr.jdField_a_of_type_Int = k;
              localaigr.jdField_a_of_type_JavaLangString = b(k);
              jdField_a_of_type_JavaUtilArrayList.add(localaigr);
              i += 1;
            }
  ...
  public static aigr b(int paramInt)
  {
    Object localObject;
    aigr localaigr;
    if (jdField_a_of_type_JavaUtilArrayList.size() != 0)
    {
      ...
      do
      {
        ...
        localaigr = (aigr)((Iterator)localObject).next();
      } while (localaigr.jdField_a_of_type_Int != paramInt);
    }
    for (;;)
    {
      localObject = localaigr;
      if (localaigr == null)
      {
        localObject = new aigr();
        ((aigr)localObject).jdField_a_of_type_Int = paramInt;
        ((aigr)localObject).jdField_a_of_type_JavaLangString = b(paramInt);
      }
      return localObject;
      localaigr = null;
    }
