...
public class bjgx
{
  ...
  protected bjgx()
  {
    this.jdField_a_of_type_AndroidOsHandler = new bjgy(this, Looper.getMainLooper());
  ...
  public static bjgx a()
  {
    try
    {
      if (jdField_a_of_type_Bjgx == null) {
        jdField_a_of_type_Bjgx = new bjgx();
      }
      bjgx localbjgx = jdField_a_of_type_Bjgx;
      return localbjgx;
    }
    finally {}
  }
  ...
  public int a(int paramInt)
  {
    ...
    {
      return paramInt;
      i = bjlt.a(bizw.a().a(), null).a("Common_CGIReportFrequencyFailed");
      paramInt = i;
    } while (i != 0);
    return 100;
  }
  ...
  public Bundle a()
  {
    localObject1 = bjgz.a().a("report_cgi");
    ...
    try
    {
      ((Bundle)localObject1).putString("releaseversion", bizw.a().f());
      ((Bundle)localObject1).putString("device", Build.DEVICE);
      ((Bundle)localObject1).putString("qua", bjly.b);
      ...
      while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        localObject2 = bjls.a(bool) + "&" + (String)((BaseData)localObject2).attrs.get("deviceInfo");
  ...
  public void a(Bundle paramBundle, String paramString1, String paramString2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        bizw.a().a(Long.valueOf(paramString2).longValue());
        if (QLog.isColorLevel()) {
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, boolean paramBoolean1, boolean paramBoolean2)
  {
    try
    {
      a(bjhh.a(paramString1, paramString2, paramString4, paramString5, paramString3, paramString6, paramString7, "", "", paramString8, paramString9), paramString3, paramString1, paramBoolean1, paramBoolean2);
      return;
    }
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, boolean paramBoolean1, boolean paramBoolean2)
  {
    try
    {
      a(bjhh.a(paramString1, paramString2, paramString4, paramString5, paramString3, paramString6, paramString5, "", "", "", ""), paramString3, paramString1, paramBoolean1, paramBoolean2);
      return;
    }
    catch (Exception paramString1)
    {
  ...
  public boolean a(String paramString, int paramInt)
  {
    ...
    {
      j = bjlt.a(bizw.a().a(), null).a("Common_CGIReportMaxcount");
      if (j != 0) {}
    }
    for (;;)
    {
      ...
      {
        j = bjlt.a(bizw.a().a(), null).a("Agent_ReportBatchCount");
        if (j != 0) {
          i = j;
        }
      }
  ...
  public Bundle b()
  {
    for (;;)
    {
      try
      {
        Object localObject1 = bjgz.a().a("report_via");
        if (localObject1 != null) {
