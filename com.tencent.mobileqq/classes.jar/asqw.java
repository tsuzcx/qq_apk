...
public class asqw
{
  ...
  public static asqw a()
  {
    if ((jdField_a_of_type_Asqw == null) || (jdField_a_of_type_Asqw.jdField_a_of_type_Boolean)) {
      jdField_a_of_type_Asqw = b();
    }
    return jdField_a_of_type_Asqw;
  }
  
  public static boolean a()
  {
    asqw localasqw = a();
    return (localasqw != null) && (localasqw.b == 1);
  }
  
  public static asqw b()
  {
    int i1 = 256;
    boolean bool = false;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          localObject = new asqw();
          ((asqw)localObject).jdField_a_of_type_Int = k;
          ((asqw)localObject).b = i;
          ((asqw)localObject).c = n;
          if ((str == null) || (str.isEmpty())) {
            bool = true;
          }
          ((asqw)localObject).jdField_a_of_type_Boolean = bool;
          return localObject;
        }
