...
{
  public adig(LoginVerifyCodeActivity paramLoginVerifyCodeActivity) {}
  ...
  public void OnGetSubaccountStViaSMSVerifyLogin(String paramString1, String paramString2, long paramLong1, int paramInt1, long paramLong2, int paramInt2, ErrMsg paramErrMsg)
  {
    ...
    if (paramInt2 == 0) {
      if ((paramString1 != null) && (paramString2 != null) && (paramString1.equals(paramString2)))
      {
        ...
        LoginVerifyCodeActivity.a(this.a, 2131720425, 0);
        this.a.finish();
      }
    }
    for (;;)
    {
      ...
      if (this.a.app != null)
      {
        ...
        azri.a(BaseApplication.getContext()).a(this.a.app.getCurrentAccountUin(), "actSBLogin", true, 0L, 0L, paramString1, "");
        bdne.a(this.a.app.getApplication().getApplicationContext(), paramString2, true);
        this.a.getAppRuntime().getSubAccountKey(this.a.app.getAccount(), paramString2, this.a.a);
        paramString1 = (badd)this.a.app.getManager(61);
