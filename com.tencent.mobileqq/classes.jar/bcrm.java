...
public class bcrm
{
  ...
  public bcrm(QQAppInterface paramQQAppInterface, int paramInt, String paramString, SharedPreferences paramSharedPreferences, bcrh parambcrh)
  {
  ...
  public void a(int paramInt1, String paramString, long paramLong, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bcrh.putLong(a(paramInt1, paramString), l1);
      return;
      l1 = paramLong;
      if (paramInt2 == 2)
      {
