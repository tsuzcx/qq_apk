  ...
  implements Animation.AnimationListener
{
  ...
  public kat(VideoControlUI paramVideoControlUI, int paramInt)
  {
  ...
  {
    this.jdField_a_of_type_ComTencentAvUiVideoControlUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().removeCallbacks(this.jdField_a_of_type_ComTencentAvUiVideoControlUI.jdField_a_of_type_Kau);
    ...
    if (!this.jdField_a_of_type_ComTencentAvUiVideoControlUI.i)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentAvUiVideoControlUI.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().post(this.jdField_a_of_type_ComTencentAvUiVideoControlUI.jdField_a_of_type_Kau);
        return;
