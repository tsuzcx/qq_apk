  ...
  extends xsw
{
  ...
  private ArrayList<xvl> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private ConcurrentHashMap<Long, xvm> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(20);
  private ConcurrentHashMap<Long, Long> b = new ConcurrentHashMap(10);
  
  public xvk(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong1, String paramString, int paramInt, long paramLong2)
  {
    ...
    {
      paramString = new xvm(this, paramString, paramInt, paramLong2);
  ...
  private void a(MessageForDeviceSingleStruct paramMessageForDeviceSingleStruct)
  {
    ...
    {
      Object localObject = (xvl)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((xvl)localObject).a();
      localObject = ((xvl)localObject).a();
      if ((localView != null) && (localObject != null)) {
        ((amsn)localObject).a(localView, paramMessageForDeviceSingleStruct);
      }
      for (;;)
      {
        i += 1;
  ...
  public long a(MessageForDeviceSingleStruct paramMessageForDeviceSingleStruct, View paramView, amsn paramamsn)
  {
    long l1;
    ...
    if (paramView != null)
    {
      ...
      {
        xvl localxvl = (xvl)localIterator.next();
        if (localxvl.a() == paramView) {
          localxvl.b = new WeakReference(paramamsn);
        }
      }
    }
    for (int i = 1;; i = 0)
    {
      if (i == 0) {
        this.jdField_a_of_type_JavaUtilArrayList.add(new xvl(this, paramView, paramamsn));
      }
  ...
  {
    paramLong = (xvm)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramLong);
    if (paramLong == null) {
      return null;
    }
  ...
  {
    int i = 3;
    MessageForDeviceSingleStruct localMessageForDeviceSingleStruct = (MessageForDeviceSingleStruct)awbi.a(-4502);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject = ((xrh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(paramDataPoint.mDin);
        if (localObject == null) {
          break label636;
        }
        j = ((DeviceInfo)localObject).productId;
        yds.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDataPoint.mDin, "Usr_AIO_ReceiveMsg", i, 0, j);
        if ((localObject != null) && (((DeviceInfo)localObject).isAdmin == 1) && (!TextUtils.isEmpty(localMessageForDeviceSingleStruct.faceRect))) {
          yds.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDataPoint.mDin, "FR_StrangerComming", 0, 0, 0);
        }
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        return;
        this.b.put(Long.valueOf(localMessageForDeviceSingleStruct.uniseq), Long.valueOf(awao.a()));
        continue;
