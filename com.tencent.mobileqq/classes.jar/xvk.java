...
{
  public xvk(AudioTranslator paramAudioTranslator) {}
  ...
  protected void a(long paramLong, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2)
  {
    ...
    xwq localxwq = (xwq)AudioTranslator.a(this.a).jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(paramInt1));
    long l1;
    label460:
    long l2;
    if (localxwq == null)
    {
      ...
      break label751;
      localxwq = new xwq(paramLong, paramInt1, paramInt2);
      AudioTranslator.a(this.a).jdField_a_of_type_JavaUtilHashMap.put(Integer.valueOf(paramInt1), localxwq);
      l1 = paramLong;
    ...
    for (;;)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        AudioTranslator.a(this.a, false);
        return;
        l1 = localxwq.jdField_a_of_type_Long;
        break label460;
      }
      for (;;)
      {
  ...
  protected void a(long paramLong, int paramInt1, int paramInt2, HostInfo paramHostInfo)
  {
    ...
    if (AudioTranslator.a(this.a).jdField_a_of_type_Xvu != null) {
      AudioTranslator.a(this.a).jdField_a_of_type_Xvu.a(paramLong, paramInt1);
    }
    for (;;)
    {
  ...
  protected void b(long paramLong, int paramInt)
  {
    ...
    synchronized (this.a)
    {
      ...
      if ((AudioTranslator.a(this.a).jdField_a_of_type_Long == paramLong) && (AudioTranslator.a(this.a).jdField_a_of_type_Int != paramInt))
      {
        ...
        if (AudioTranslator.a(this.a).jdField_a_of_type_Xvu != null) {
          AudioTranslator.a(this.a).jdField_a_of_type_Xvu.a(paramLong, paramInt);
        }
      }
      return;
    }
