...
public class alut
  extends alsc
{
  public alut(CmGameLoadingFragment paramCmGameLoadingFragment, AppInterface paramAppInterface)
  {
  ...
  public void onDownloadConfirm(CmGameStartChecker.StartCheckParam paramStartCheckParam, alsd paramalsd, long paramLong)
  {
    ...
    do
    {
      ...
      } while (paramalsd == null);
      paramalsd.a(paramStartCheckParam);
      return;
    ...
    CmGameLoadingFragment.a(this.a).a(paramStartCheckParam, paramalsd, paramLong);
  }
  ...
  {
    alvp.a().a(paramStartCheckParam, paramLong, null);
    if (CmGameLoadingFragment.a(this.a) != null) {
    ...
    do
    {
      do
      {
        do
        {
          ...
          alvp.a().a(paramStartCheckParam, paramLong, paramCmGameInitParams);
