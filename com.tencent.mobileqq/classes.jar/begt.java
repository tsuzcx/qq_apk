  ...
  extends SpannableStringBuilder
{
  ...
  static
  {
    jdField_a_of_type_AndroidTextEditable$Factory = new begu();
  }
  
  public begt(CharSequence paramCharSequence, int paramInt)
  {
  ...
  {
    if ((paramCharSequence instanceof begq)) {
      return ((begq)paramCharSequence).a();
    }
    return new begq(paramCharSequence, paramInt).a();
  }
  ...
  public SpannableStringBuilder replace(int paramInt1, int paramInt2, CharSequence paramCharSequence, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      i = paramInt2;
      localObject = new begq(paramCharSequence, this.jdField_a_of_type_Int).a();
