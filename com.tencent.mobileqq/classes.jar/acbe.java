  ...
  private static void a(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler, MsgInfo paramMsgInfo, MsgType0x210 paramMsgType0x210)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        paramMsgType0x210 = (aquh)paramQQAppInterface.getManager(71);
    ...
    Object localObject2 = (amuo)paramQQAppInterface.getManager(131);
    ((amuo)localObject2).a(m, n, true);
    ((amuo)localObject2).a(i1, (String)localObject1);
    label641:
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      ((aneg)paramQQAppInterface.getBusinessHandler(27)).a((String)localObject1, paramMsgType0x210);
      label797:
      label1571:
      do
      {
        ...
        if ((j == 2003) && (paramMsgType0x210.msg_push_lost_dev_found.has()))
        {
          ...
          ((aara)paramQQAppInterface.getBusinessHandler(51)).a(111, (Bundle)localObject1);
          break;
        }
        if ((j == 2007) && (paramMsgType0x210.msg_babyq_reward_info.has()))
        {
          ...
          ((amoa)paramQQAppInterface.getBusinessHandler(53)).a(paramMsgType0x210);
          break;
        }
        ...
        if (j == 1)
        {
          ...
          ((QIMFollwerAdd)localObject1).upTime = bbko.a();
          ((QIMFollwerAdd)localObject1).source = paramMsgType0x210.bytes_src_wording.get().toStringUtf8();
          ((aiej)paramQQAppInterface.getManager(34)).b((QIMFollwerAdd)localObject1);
          break;
        }
        ...
        ((QIMNotifyAddFriend)localObject1).pushTime = bbko.a();
        if (QLog.isColorLevel()) {
          QLog.d("QIMNewNotifyPush", 2, "receive data= " + ((QIMNotifyAddFriend)localObject1).toString());
        }
        ((amyk)paramQQAppInterface.getManager(257)).a((QIMNotifyAddFriend)localObject1);
        break;
        k = 0;
        break label497;
        j = 0;
