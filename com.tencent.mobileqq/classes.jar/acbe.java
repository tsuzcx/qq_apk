...
{
  public acbe(TroopRequestActivity paramTroopRequestActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    int m = 1;
    int i = 1;
    if ((!badq.d(this.a)) && ((paramView != this.a.jdField_b_of_type_AndroidWidgetButton) || ((this.a.jdField_b_of_type_Int != 1) && (this.a.jdField_b_of_type_Int != 22)))) {
      bbmy.a(this.a, this.a.getString(2131628946), 0).b(this.a.getTitleBarHeight());
    }
    String str2;
    label435:
    label637:
    do
    {
      do
      {
          ...
          do
          {
            do
            {
              do
              {
                do
                {
                  do
                  {
                    ...
                    while (this.a.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.group_msg_type.get() == 80)
                    {
                      ...
                      return;
                      arjb.a().b(this.a.jdField_a_of_type_JavaLangString, this.a.app);
                    }
                    if (this.a.jdField_d_of_type_Boolean) {
                      afcz.a(this.a.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg, "unnormal_edit_join");
                    }
                    if (n == 2)
                    {
                      ...
                      this.a.h();
                      TroopRequestActivity.a(this.a, this.a.app, str2, this.a.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg, this.a.jdField_a_of_type_Afcf);
                      ...
                      {
                        awqx.b(this.a.app, "P_CliOper", "Grp_contacts", "", "notice", "agree_invite", 0, 0, str2, str1, paramView, "1");
                        return;
                        i = 0;
                        break;
                      }
                    ...
                    if (n == 82)
                    {
                      ...
                      awqx.b(this.a.app, "P_CliOper", "Grp_public", "", "oper", "focus_invite", 0, 0, "", "", "", this.a.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.req_uin.get() + "");
                      return;
                    }
                ...
                {
                  awqx.b(this.a.app, "P_CliOper", "Grp_contacts", "", "notice", "agree_ask", 0, 0, str2, str1, paramView, "1");
                  return;
                  i = 0;
                  break;
                }
                ...
                if ((this.a.jdField_b_of_type_Int == 1) || (this.a.jdField_b_of_type_Int == 22))
                {
                  ...
                  if (this.a.jdField_d_of_type_Boolean) {
                    afcz.a(this.a.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg, "unnormal_edit_reject");
                  }
                  awqx.b(this.a.app, "P_CliOper", "Grp_contacts", "", "notice", "refuse_ask_has_reason", 0, 0, str2, str1, "", "1");
                  return;
                }
              ...
              if (n == 1)
              {
                ...
                for (paramView = "1";; paramView = "0")
                {
                  awqx.b(this.a.app, "P_CliOper", "Grp_contacts", "", "notice", "refuse_ask", 0, 0, str2, str1, paramView, "1");
                  return;
                  i = 0;
                  break;
                }
            ...
            for (paramView = "0";; paramView = "1")
            {
              awqx.b(this.a.app, "P_CliOper", "Grp_contacts", "", "notice", "refuse_invite", 0, 0, str2, str1, paramView, "1");
              return;
              i = 0;
              break;
            }
            ...
            if (this.a.jdField_b_of_type_Int == 82)
            {
              ...
              azzx.a("Grp_contacts_news", "notice", "ignore_invite", 0, 0, new String[] { str2, str1 });
            }
          } while (!TroopRequestActivity.a(this.a, 2));
          this.a.h();
          if (n == 1)
          {
            azzx.a("Grp_contacts_news", "notice", "ignore_ask", 0, 0, new String[] { str2, str1 });
            return;
          }
        } while (n != 2);
        i = this.a.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.group_inviter_role.get();
        ...
        for (paramView = "0";; paramView = "1")
        {
          azzx.a("Grp_contacts_news", "notice", "ignore_invite", 0, 0, new String[] { str2, str1, paramView });
          return;
          i = 0;
          break;
        }
      ...
      while (((this.a.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.group_msg_type.get() == 11) && (this.a.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.sub_type.get() == 3)) || (this.a.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg.msg.group_msg_type.get() == 7))
      {
        this.a.h();
        TroopRequestActivity.a(this.a, this.a.app, str2, this.a.jdField_a_of_type_TencentMobileimStructmsgStructmsg$StructMsg, this.a.jdField_a_of_type_Afcf);
        azzx.a("Grp_contacts_news", "notice", "again_join", 0, 0, new String[] { str2 });
        return;
        arjb.a().b(this.a.jdField_a_of_type_JavaLangString, this.a.app);
      }
    ...
    if ((paramView.size() > 0) && (this.a.jdField_a_of_type_JavaLangString.length() > 0)) {
      ((ajtg)this.a.app.a(20)).a(this.a.jdField_a_of_type_JavaLangString, paramView, "");
    }
    azzx.a("Grp_contacts_news", "notice", "again_invite", 0, 0, new String[] { str2 });
  }
}
