  ...
  extends arxg
{
  ...
  public asbg(int paramInt1, int paramInt2, String paramString, EmotionSearchItem paramEmotionSearchItem)
  {
  ...
  public Drawable a(Context paramContext, float paramFloat)
  {
    ...
    URL localURL = avbc.a(this.jdField_a_of_type_ComTencentMobileqqEmosmEmosearchEmotionSearchItem.url);
    if (localURL == null) {
      return null;
    }
  ...
  protected void a(QQAppInterface paramQQAppInterface)
  {
    if (this.jdField_a_of_type_Int == 1)
    {
      if (!bgsp.a(this.jdField_a_of_type_JavaLangString)) {
        bcst.b(paramQQAppInterface, "dc00898", "", "", "0X800AE2E", "0X800AE2E", 0, 0, this.b + "", "", this.jdField_a_of_type_ComTencentMobileqqEmosmEmosearchEmotionSearchItem.getEmoMd5(), "");
      }
      if (bgsp.a(this.jdField_a_of_type_JavaLangString))
      {
        i = 1;
        bcst.b(paramQQAppInterface, "dc00898", "", "", "0X800AE20", "0X800AE20", i, 0, this.b + "", "", this.jdField_a_of_type_ComTencentMobileqqEmosmEmosearchEmotionSearchItem.getEmoMd5(), "");
      }
    }
    ...
    bcst.b(paramQQAppInterface, "dc00898", "", "", "0X800AE36", "0X800AE36", 0, 0, this.b + "", "", this.jdField_a_of_type_ComTencentMobileqqEmosmEmosearchEmotionSearchItem.getEmoMd5(), "");
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, EditText paramEditText, SessionInfo paramSessionInfo)
  {
    ...
    int j = 0;
    paramEditText = null;
    Object localObject = avbc.a(this.jdField_a_of_type_ComTencentMobileqqEmosmEmosearchEmotionSearchItem.originalUrl);
    int i;
    ...
    while ((paramEditText == null) && (paramSessionInfo.jdField_a_of_type_Int != 1008))
    {
      ...
      {
        localObject = avbc.a(this.jdField_a_of_type_ComTencentMobileqqEmosmEmosearchEmotionSearchItem.url).getAbsolutePath();
        paramEditText = (EditText)localObject;
        i = j;
        if (QLog.isColorLevel())
        {
