...
public class asbg
  extends asbb
{
  public asbg(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    super(paramQQAppInterface, paramContext);
  }
  
  protected becp a(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage instanceof MessageForTroopFile))
    {
      paramChatMessage = (MessageForTroopFile)paramChatMessage;
      return bfby.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
    }
    ...
    do
    {
      do
      {
        do
        {
          ...
          localTroopFileTransferManager.d(paramaezf.jdField_a_of_type_JavaUtilUUID);
          return;
        } while (paramInt != 1);
        bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A887", "0X800A887", 0, 0, "", "", "", "");
        paramChatMessage = new bebp(Long.parseLong(paramChatMessage.frienduin), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Activity)this.jdField_a_of_type_AndroidContentContext);
        if ((paramaezf.b != 10) && (paramaezf.b != 9)) {
          break;
        }
      } while (paramaezf.jdField_a_of_type_JavaUtilUUID == null);
      paramChatMessage.b(paramaezf.jdField_a_of_type_JavaUtilUUID);
      return;
      if (paramaezf.b == 7)
      {
        paramChatMessage.a(paramView.url, paramaezf.g, paramaezf.c, paramaezf.h);
        return;
      }
    } while ((paramaezf.b != 6) || (FileUtils.fileExistsAndNotEmpty(paramaezf.jdField_a_of_type_JavaLangString)));
    paramChatMessage.a(paramView.url, paramaezf.g, paramaezf.c, paramaezf.h);
  }
  ...
  protected boolean a(ChatMessage paramChatMessage)
  {
    ...
    int i = aszt.a(paramChatMessage.g);
    if ((i == 0) || (i == 2)) {
      return false;
    }
