...
public class asbg
{
  ...
  public final ArrayList<asbb> a;
  public final int b;
  public asbf b;
  public final int c;
  private final int d;
  
  public asbg(String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, ArrayList<asbb> paramArrayList)
  {
  ...
  public asbg(String paramString, int paramInt1, int paramInt2, ArrayList<asbb> paramArrayList)
  {
    this.jdField_a_of_type_Asbf = new asbf();
    this.jdField_b_of_type_Asbf = new asbf();
    this.jdField_a_of_type_Int = paramInt1;
  ...
  public long a()
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
      return ((asbb)this.jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_Long;
    }
    return 0L;
  }
  ...
  public void a(Canvas paramCanvas, int paramInt1, int paramInt2, Paint paramPaint1, Paint paramPaint2, Bitmap paramBitmap1, Bitmap paramBitmap2, int paramInt3)
  {
    ...
    if ((this.jdField_a_of_type_Asbf != null) && (this.jdField_a_of_type_Asbf.a != null) && (!this.jdField_a_of_type_Asbf.a.isRecycled()))
    {
      paramBitmap1 = new Rect(paramInt1 - this.jdField_a_of_type_Asbf.c - this.jdField_a_of_type_Asbf.a.getWidth(), (int)(paramInt2 - paramPaint1.getTextSize()), paramInt1 - this.jdField_a_of_type_Asbf.c, (int)(this.jdField_a_of_type_Asbf.a.getHeight() + paramInt2 - paramPaint1.getTextSize()));
      paramCanvas.drawBitmap(this.jdField_a_of_type_Asbf.a, null, paramBitmap1, null);
    }
  ...
  public void a(Canvas paramCanvas, int paramInt1, int paramInt2, Paint paramPaint1, Paint paramPaint2, Paint paramPaint3, int paramInt3, float paramFloat1, float paramFloat2, int[] paramArrayOfInt, float[] paramArrayOfFloat)
  {
    ...
    if (paramInt3 > 0)
    {
      paramArrayOfInt = (asbb)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt3 - 1);
    ...
    paramPaint2 = (asbb)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt3);
    ...
    for (paramPaint2 = this.jdField_a_of_type_JavaLangString.substring(paramPaint2.jdField_a_of_type_Int, this.jdField_a_of_type_JavaLangString.length());; paramPaint2 = this.jdField_a_of_type_JavaLangString.substring(paramPaint2.jdField_a_of_type_Int, paramPaint2.jdField_b_of_type_Int))
    {
      ...
      if (paramInt3 < this.jdField_a_of_type_JavaUtilArrayList.size() - 1)
      {
        paramPaint2 = (asbb)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt3 + 1);
  ...
  public long b()
  {
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
    {
      asbb localasbb = (asbb)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_JavaUtilArrayList.size() - 1);
      long l = localasbb.jdField_a_of_type_Long;
      return localasbb.jdField_b_of_type_Long + l;
    }
    return 0L;
  }
}
