...
public class mkc
  extends lgg
{
  public mkc(VideoInviteActivity paramVideoInviteActivity) {}
  ...
  protected void a(String paramString, boolean paramBoolean)
  {
    if ((this.a.c != null) && (this.a.c.equals(paramString)))
    {
      ...
      if (paramBoolean)
      {
        ...
        this.a.jdField_a_of_type_Mhj.a(new mke(this));
      }
    }
    return;
    label187:
  ...
  protected void c(int paramInt)
  {
    ...
    do
    {
      ...
      int j = this.a.jdField_a_of_type_Lga.d;
      if ((localFile != null) && (localFile.exists()) && (this.a.jdField_a_of_type_Lga.g != 4) && ((j == 1) || (j == 0)) && (this.a.jdField_a_of_type_AndroidWidgetRelativeLayout != null))
      {
        if (this.a.jdField_a_of_type_ComTencentMobileqqVipavVipFullScreenVideoView == null) {
          this.a.jdField_a_of_type_ComTencentMobileqqVipavVipFullScreenVideoView = bbzh.a((Activity)this.a.jdField_a_of_type_JavaLangRefWeakReference.get(), this.a.jdField_a_of_type_AndroidWidgetRelativeLayout, false);
        }
        if (bbzh.a(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApp().getApplicationContext(), this.a.jdField_a_of_type_ComTencentMobileqqVipavVipFullScreenVideoView, str, i, null, paramInt, false))
        {
          this.a.a(true);
