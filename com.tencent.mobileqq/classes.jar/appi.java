  ...
  implements aptd
{
  ...
  public Drawable a(Context paramContext, float paramFloat)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	appi:e	Ljava/lang/String;
    //   4: astore_1
    //   5: aload_0
    //   6: getfield 40	appi:h	Ljava/lang/String;
    //   9: ldc 42
    ...
    //   18: astore 4
    //   20: aload_0
    //   21: getfield 40	appi:h	Ljava/lang/String;
    //   24: ldc 50
    ...
    //   53: ifne +9 -> 62
    //   56: aload_0
    //   57: getfield 67	appi:b	Ljava/lang/String;
    //   60: astore 4
    ...
    //   248: aload_0
    //   249: invokevirtual 159	appi:toString	()Ljava/lang/String;
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, EditText paramEditText, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      if (((paramContext instanceof BaseActivity)) && (aupu.a(paramSessionInfo.jdField_a_of_type_Int, paramSessionInfo.jdField_a_of_type_JavaLangString)))
      {
        ...
        QQToast.a(paramQQAppInterface.getApp(), alpo.a(2131701681), 0).b(paramContext.getTitleBarHeight());
        return;
      }
      paramEditText = null;
      ...
      acex.a(paramQQAppInterface, paramContext, paramSessionInfo, this.e, true, this.jdField_a_of_type_JavaLangString, paramEditText);
    } while (TextUtils.isEmpty(this.d));
    azmj.b(paramQQAppInterface, "dc00898", "", "", "0X800A371", "0X800A371", 0, 0, "", "", this.d, "");
  }
