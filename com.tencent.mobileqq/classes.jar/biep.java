...
{
  private final bieq jdField_a_of_type_Bieq;
  private final ReleaseLooperHandler jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler;
  
  public biep(bieq parambieq, ReleaseLooperHandler paramReleaseLooperHandler)
  {
    this.jdField_a_of_type_Bieq = parambieq;
  ...
  private void b(bidv parambidv)
  {
    ...
    do
    {
        ...
        do
        {
          do
          {
            ...
            do
            {
              ...
              {
                this.jdField_a_of_type_Bieq.a(parambidv.a(), true, false, false, str2);
                return;
              }
            } while (parambidv.d());
            if (!IOUtils.ensureStorageSpace(str4, l1 - l2))
            {
              this.jdField_a_of_type_Bieq.a(parambidv.a(), false, false, true, "");
              return;
            }
          } while (parambidv.d());
          if (!IOUtils.ensureWritable(str4))
          {
            this.jdField_a_of_type_Bieq.a(parambidv.a(), false, true, false, "");
            return;
          }
        } while (parambidv.d());
        localObject = IOUtils.ensureFilePath(str4, parambidv.a().b);
      } while (parambidv.d());
      String str1 = a(str3);
      if ((!TextUtils.isEmpty(str1)) && (!TextUtils.equals(str2, str1)) && (TextUtils.equals(str3, IOUtils.getFileSha1(str1))))
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Bieq.a(parambidv.a(), bool, false, false, (String)localObject);
          return;
          bool = IOUtils.copyFileAndNotifyOS(WeiyunTransmissionGlobal.getInstance().getContext(), str1, (String)localObject);
        }
      }
    } while (parambidv.d());
    this.jdField_a_of_type_Bieq.a(parambidv.a(), false, false, false, (String)localObject);
  }
  
  public void a(bidv parambidv)
  {
    if (parambidv == null) {
      return;
    }
    this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler.sendMessage(Message.obtain(null, 11, parambidv));
  }
