  ...
  implements Runnable
{
  ...
  public void run()
  {
    if (CommonDataAdapter.a().a() != null)
    {
      ...
      ((TextView)localObject2).setBackgroundColor(CommonDataAdapter.a().a().getResources().getColor(2131492923));
      ((TextView)localObject2).setText(2131428534);
      ((TextView)localObject2).setTextColor(CommonDataAdapter.a().a().getResources().getColor(2131492970));
