...
{
  public akte(NewFlowCameraActivity paramNewFlowCameraActivity) {}
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    catch (Exception paramView)
    {
      for (;;)
      {
        ...
        amoa.a(this.a.jdField_f_of_type_AndroidViewView);
        ...
        if (NewFlowCameraActivity.h(this.a)) {
          if (this.a.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
          {
            ...
            if (this.a.r == 10004) {
              xwa.a("plus_shoot", "clk_shoot", 0, 0, new String[] { "2", "", "", "" });
            }
          }
          else
          {
            this.a.c();
            if (this.a.r == 10002) {
              xwa.a("video_shoot", "clk_shoot", 0, 0, new String[] { "2" });
            } else if (this.a.r == 10004) {
              xwa.a("plus_shoot", "clk_shoot", 0, 0, new String[] { "1", "", "", "" });
            }
          }
        }
      }
