  ...
  implements axay
{
  ...
  public akfr(AppInterface paramAppInterface)
  {
  ...
  public ReqItem a(int paramInt)
  {
    ...
    for (long l = ((MessageHandler)localObject2).a().e("last_friend_seq_47");; l = 0L)
    {
      ...
      ((structmsg.ReqSystemMsgNew)localObject1).latest_group_seq.set(((MessageHandler)localObject2).a().e("last_group_seq"));
      ...
      bbmx.a((byte[])localObject2, 0, localObject1.length + 4);
      bbmx.a((byte[])localObject2, 4, (byte[])localObject1, localObject1.length);
