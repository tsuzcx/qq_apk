  ...
  implements axaw
{
  ...
  public akfr(QQAppInterface paramQQAppInterface)
  {
  ...
  public ReqItem a(int paramInt)
  {
    ...
    {
      localObject1 = (bbix)this.app.getManager(31);
      if (localObject1 != null) {
        ((bbix)localObject1).a(true, this);
      }
    }
    if (this.a != null)
    {
      Object localObject2 = this.app.jdField_a_of_type_Awyl.a(this.a.getServiceCmd());
      if (localObject2 != null)
      {
        localObject1 = new UniPacket(true);
        ((UniPacket)localObject1).setEncodeName("utf-8");
        if (((xop)localObject2).a(this.a, (UniPacket)localObject1))
        {
