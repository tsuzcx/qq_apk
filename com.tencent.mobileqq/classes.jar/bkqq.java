...
public class bkqq
{
  ...
  {
    return bggq.a(bkqp.a(this.jdField_a_of_type_Bkqp), paramFloat);
  }
  ...
  {
    Object localObject = new bkqs(a(paramInt3));
    ((bkqs)localObject).resize(paramInt1, paramInt2);
  ...
  public bkqp a()
  {
    ...
    this.jdField_a_of_type_Bkqp.c(localDrawable1);
    localDrawable1 = a(a(this.c), a(this.d), 49, this.b);
    Drawable localDrawable2 = a(a(this.d), a(this.c), 51, this.b);
    this.jdField_a_of_type_Bkqp.b(localDrawable2);
    this.jdField_a_of_type_Bkqp.a(localDrawable1);
    return this.jdField_a_of_type_Bkqp;
  }
