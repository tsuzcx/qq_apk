...
{
  public adam(FriendProfileCardActivity paramFriendProfileCardActivity) {}
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                do
                {
                        ...
                        do
                        {
                          do
                          {
                            do
                            {
                              do
                              {
                                do
                                {
                                  do
                                  {
                                    ...
                                    localObject1 = (Card)paramMessage.obj;
                                    this.a.jdField_a_of_type_Awqt.jdField_a_of_type_ComTencentMobileqqDataCard = ((Card)localObject1);
                                    if (QLog.isColorLevel()) {
                                      QLog.d("Q.profilecard.FrdProfileCard", 2, "UI_MSG_UPDATE_CARD: isNegRet = " + bool1 + " msgSource = " + i);
                                    }
                                    this.a.a((Card)localObject1, bool1);
                                    if (i == 1) {
                                      this.a.jdField_a_of_type_Bdnt.a("updateCardByDbEnd", false);
                                    }
                                    for (;;)
                                    {
                                      ...
                                      if ((i == 7) || (i == 8) || (paramMessage.arg2 == 12) || (paramMessage.arg2 == 11)) {
                                        this.a.jdField_a_of_type_Bdnt.a("updateCardBySSOEnd", false);
                                      }
                                    }
                                  ...
                                  this.a.a(this.a.jdField_a_of_type_Awqt);
                                  return true;
                                ...
                                this.a.jdField_a_of_type_Awqt.jdField_a_of_type_ComTencentMobileqqDataContactCard = paramMessage;
                              ...
                              this.a.jdField_a_of_type_Awqt.jdField_a_of_type_ComTencentMobileqqQcallQCallCardInfo = paramMessage;
                              this.a.a(paramMessage, bool1);
                              return true;
                              if (paramMessage.what != 10) {
                                break label724;
                              }
                              if (this.a.jdField_a_of_type_Awqt.jdField_a_of_type_ComTencentMobileqqDataCard != null)
                              {
                                if (QLog.isColorLevel()) {
                                  QLog.i("Q.profilecard.FrdProfileCard", 2, "initHeaderView timeout");
                                }
                                this.a.jdField_a_of_type_Awqt.jdField_a_of_type_Boolean = true;
                                ...
                                this.a.a(this.a.jdField_a_of_type_Awqt.jdField_a_of_type_ComTencentMobileqqDataCard, false);
                                return true;
                              }
                            } while (this.a.jdField_a_of_type_Awqt.jdField_a_of_type_ComTencentMobileqqQcallQCallCardInfo == null);
                            if (QLog.isColorLevel()) {
                              QLog.i("Q.profilecard.FrdProfileCard", 2, "initHeaderView timeout");
                            }
                            this.a.jdField_a_of_type_Awqt.jdField_a_of_type_Boolean = true;
                            this.a.jdField_a_of_type_Awqt.jdField_a_of_type_Awra = null;
                            this.a.a(this.a.jdField_a_of_type_Awqt.jdField_a_of_type_ComTencentMobileqqQcallQCallCardInfo, false);
                            return true;
                          ...
                          } while ((this.a.jdField_a_of_type_Awqt == null) || (this.a.jdField_a_of_type_Awqt.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a.equals(this.a.app.getCurrentAccountUin())));
                          ProfileActivity.a(this.a, paramMessage);
                          return true;
                          Toast.makeText(this.a.getApplicationContext(), 2131695640, 0).show();
                          return true;
                          if (paramMessage.what != 12) {
                            break label1088;
                          }
                        } while ((this.a.jdField_a_of_type_Awqt.jdField_a_of_type_ComTencentMobileqqDataCard == null) || ((awra.f != this.a.jdField_a_of_type_Awqt.jdField_a_of_type_ComTencentMobileqqDataCard.lCurrentStyleId) && (awra.h != this.a.jdField_a_of_type_Awqt.jdField_a_of_type_ComTencentMobileqqDataCard.lCurrentStyleId)) || (!(paramMessage.obj instanceof Bitmap)));
                  ...
                  } while (this.a.jdField_a_of_type_Awqt.jdField_a_of_type_ComTencentMobileqqDataCard.lCurrentStyleId != awra.h);
                  if (QLog.isColorLevel()) {
            ...
            FriendProfileCardActivity.a(this.a).a(this.a.jdField_a_of_type_Awqt);
            return true;
        ...
        localObject1 = this.a.jdField_b_of_type_Bhtd.obtainMessage();
        ((Message)localObject1).what = paramMessage.what;
        ((Message)localObject1).arg1 = (paramMessage.arg1 - 1);
        this.a.jdField_b_of_type_Bhtd.sendMessageDelayed((Message)localObject1, 1000L);
        return true;
        ...
        {
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetProfileCardMoreInfoView.a(this.a.jdField_a_of_type_Awqt, true, new String[] { "map_key_medal" });
          return true;
        }
