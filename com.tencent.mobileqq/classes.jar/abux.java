  ...
  extends anii
{
  ...
  public abrv a;
  private absc jdField_a_of_type_Absc = new abuy(this);
  public abur a;
  private abuv jdField_a_of_type_Abuv;
  public abuw a;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new abuz(this);
  anut jdField_a_of_type_Anut = new abva(this);
  public HashMap<String, List<absc>> a;
  ...
  public abux(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Absc);
    this.jdField_a_of_type_Abuv = new abuv(paramQQAppInterface);
    this.jdField_a_of_type_Abur = new abur(paramQQAppInterface);
    this.jdField_a_of_type_Abrv = new abrv();
    this.jdField_a_of_type_Abuw = new abuw(paramQQAppInterface);
    a(f, this.jdField_a_of_type_Abrv);
    a(e, this.jdField_a_of_type_Abrv);
    a(g, this.jdField_a_of_type_Abrv);
    a(g, this.jdField_a_of_type_Abur);
    a(g, this.jdField_a_of_type_Abuw);
    a(jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Abuv);
    a(c, this.jdField_a_of_type_Abuv);
    a(d, this.jdField_a_of_type_Abuv);
    a(h, this.jdField_a_of_type_Abuv);
    a("8000-NASDevMusicFile", this.jdField_a_of_type_Abuv);
    a("8001-NASDevVideoFile", this.jdField_a_of_type_Abuv);
    a("8002-NASDevDocumentFile", this.jdField_a_of_type_Abuv);
    a("8003-NASDevCommonFile", this.jdField_a_of_type_Abuv);
    a("", this.jdField_a_of_type_Abuv);
    a("", this.jdField_a_of_type_Abrv);
    ...
    paramQQAppInterface = (anus)paramQQAppInterface.a(34);
  ...
  private void a()
  {
    DeviceInfo[] arrayOfDeviceInfo = ((abqn)this.app.a(51)).a();
  ...
  {
    MessageForDeviceText localMessageForDeviceText = (MessageForDeviceText)bbzh.a(-4508);
  ...
  private void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong)
  {
    ...
    String str = adrl.f + "http://maps.google.com/maps?q=" + paramString2 + "," + paramString3 + "&iwloc=A&hl=zh-CN (" + paramString5 + ")";
    if (!paramContext.getResources().getString(2131695395).equals(paramString4)) {}
    for (paramContext = paramContext.getResources().getString(2131691132) + " " + paramString4;; paramContext = paramContext.getResources().getString(2131691132))
    {
      ...
      paramContext = new bcvp(StructMsgForGeneralShare.class).c(32).a(paramContext).d(str).a("plugin", paramString2, paramString2, paramString2, paramString2).a();
      ...
      paramContext = bbzh.a(this.app, this.app.getCurrentAccountUin(), paramString1, this.app.getCurrentAccountUin(), 9501, 100L, paramContext);
  ...
  public abrv a()
  {
    return this.jdField_a_of_type_Abrv;
  }
  
  public abur a()
  {
    return this.jdField_a_of_type_Abur;
  }
  
  public abuv a()
  {
    return this.jdField_a_of_type_Abuv;
  }
  
  public abuw a()
  {
    return this.jdField_a_of_type_Abuw;
  }
  ...
  public void a(DataPoint paramDataPoint)
  {
    try
    {
      ...
      long l = ((JSONObject)localObject).optLong("msg_time", bbyp.a());
  ...
  {
    ArrayList localArrayList = bgjw.a(paramString, 560, 20, null, new ArrayList());
    int i = 0;
    if (i < localArrayList.size())
    {
      ...
      paramString = "";
      if (str1 != null) {
        paramString = bbzj.a(str1, true, null);
      }
      int j = (int)bbyp.a();
      ...
      localMessageForDeviceText.shmsgseq = bbzj.a(i, paramSessionInfo.jdField_a_of_type_Int);
      ...
      for (;;)
      {
        if (localMessageForDeviceText.extraflag != 32768)
        {
          ...
          ((abqn)paramQQAppInterface.a(51)).a(localMessageForDeviceText.msg, Long.parseLong(localMessageForDeviceText.frienduin), l, localMessageForDeviceText.msgseq);
        }
        i += 1;
        break;
  ...
  public void a(String paramString1, String paramString2, long paramLong, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    default: 
      paramInt = i;
      localMessageForGrayTips = (MessageForGrayTips)bbzh.a(paramInt);
  ...
  public void a(String paramString1, String paramString2, long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    {
      i = -5001;
      localMessageForNewGrayTips = (MessageForNewGrayTips)bbzh.a(i);
  ...
  public boolean a(String paramString, absc paramabsc)
  {
    ...
    if (!((List)localObject).contains(paramabsc)) {
      ((List)localObject).add(paramabsc);
    }
    return true;
  }
  
  public boolean b(String paramString, absc paramabsc)
  {
    paramString = (List)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (paramString != null) {
      paramString.remove(paramabsc);
    }
    return true;
  }
  ...
  {
    super.onDestroy();
    b(f, this.jdField_a_of_type_Abrv);
    b(e, this.jdField_a_of_type_Abrv);
    b(g, this.jdField_a_of_type_Abrv);
    b(g, this.jdField_a_of_type_Abur);
    b(jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Abuv);
    b(c, this.jdField_a_of_type_Abuv);
    b(d, this.jdField_a_of_type_Abuv);
    b(h, this.jdField_a_of_type_Abuv);
    b("8000-NASDevMusicFile", this.jdField_a_of_type_Abuv);
    b("8001-NASDevVideoFile", this.jdField_a_of_type_Abuv);
    b("8002-NASDevDocumentFile", this.jdField_a_of_type_Abuv);
    b("8003-NASDevCommonFile", this.jdField_a_of_type_Abuv);
    b("", this.jdField_a_of_type_Abuv);
    b("", this.jdField_a_of_type_Abrv);
    this.app.removeObserver(this.jdField_a_of_type_Absc);
    this.app.getApp().unregisterReceiver(this.jdField_a_of_type_AndroidContentBroadcastReceiver);
    this.app.removeObserver(this.jdField_a_of_type_Anut);
    this.jdField_a_of_type_Abuv = null;
    this.jdField_a_of_type_Abur = null;
    this.jdField_a_of_type_Abrv = null;
    this.jdField_a_of_type_Abuw = null;
  }
