  ...
  implements bjsc
{
  ...
  public static bjsd a()
  {
    if (jdField_a_of_type_Bjsd == null) {
      jdField_a_of_type_Bjsd = new bjsd();
    }
    return jdField_a_of_type_Bjsd;
  }
  ...
  protected String a(int paramInt)
  {
    ...
    catch (JSONException localJSONException)
    {
      for (;;)
      {
        bjtx.c("DownloadCallbackWebImpl", "getCallBackJsonObject >>> ", localJSONException);
      }
    }
  }
  ...
  protected String a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, String paramString3, int paramInt4, int paramInt5)
  {
    ...
    catch (JSONException paramString1)
    {
      for (;;)
      {
        bjtx.c("DownloadCallbackWebImpl", "getCallBackJsonObject >>> ", paramString1);
      }
    }
  }
  ...
  public JSONObject a(DownloadInfo paramDownloadInfo, int paramInt)
  {
    ...
    {
      bjtx.c("DownloadCallbackWebImpl", "onNetworkConnect " + paramDownloadInfo.getMessage(), paramDownloadInfo);
    }
    return localJSONObject;
  }
  ...
  {
    bjsh localbjsh = bjsh.a();
    for (;;)
    {
      int i;
      try
      {
        int j = localbjsh.a().size();
        i = 0;
        if (i < j)
        {
          Object localObject = (bjvc)localbjsh.a().get(i);
          ...
          if (localWebView != null) {
            if (TextUtils.isEmpty(((bjvc)localObject).getJsCallbackMethod()))
            {
              ...
              bjtx.a("DownloadCallbackWebImpl", " commonJsCallBack >>> " + (String)localObject);
      ...
      {
        bjtx.c("DownloadCallbackWebImpl", "doJsCallback >>> ", paramString);
      }
      i += 1;
    }
  }
