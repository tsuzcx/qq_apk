...
public class bpkl
{
  ...
  private bpjn jdField_a_of_type_Bpjn = new bpjn();
  ...
  private void e(float paramFloat1, float paramFloat2)
  {
    ...
    this.jdField_a_of_type_Bpjn.a(paramFloat1, paramFloat2);
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_Bpjn.a(this.jdField_b_of_type_AndroidGraphicsRectF, a());
  }
  ...
  public bpki a(float paramFloat1, float paramFloat2)
  {
    RectF localRectF = this.jdField_a_of_type_Bpjn.a(paramFloat1, paramFloat2);
    ...
    return new bpki(this.jdField_b_of_type_AndroidGraphicsRectF.centerX() - localRectF.centerX() + paramFloat1, this.jdField_b_of_type_AndroidGraphicsRectF.centerY() - localRectF.centerY() + paramFloat2, c(), b());
  }
  
  public bpki a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    this.jdField_a_of_type_Bpjn.d(false);
    if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor != null)
    {
      this.jdField_a_of_type_Bpjn.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor, paramFloat3, paramFloat4);
      ...
      RectF localRectF2 = this.jdField_a_of_type_Bpjn.a(paramFloat1, paramFloat2);
      bpki localbpki = new bpki(paramFloat1, paramFloat2, c(), a());
      localbpki.a(bpjm.b(localRectF2, localRectF1, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
      return localbpki;
    }
    return null;
  }
  ...
  {
    if (this.jdField_a_of_type_Bpjn.c()) {}
  ...
  {
    this.jdField_a_of_type_Bpjn.a(paramCanvas);
  }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Bpjn.a();
  }
  ...
  public boolean a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Bpjn.a(false);
      this.jdField_a_of_type_Bpjn.b(true);
      this.jdField_a_of_type_Bpjn.c(false);
      return paramBoolean;
    }
  }
  ...
  public bpki b(float paramFloat1, float paramFloat2)
  {
    return new bpki(paramFloat1, paramFloat2, c(), b());
  }
  ...
  public void b(float paramFloat1, float paramFloat2)
  {
    ...
    this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiClipClipConstant$Anchor = this.jdField_a_of_type_Bpjn.a(paramFloat1, paramFloat2);
  }
  ...
  {
    this.jdField_a_of_type_Bpjn.c(paramBoolean);
  }
  ...
  public bpki c(float paramFloat1, float paramFloat2)
  {
    bpki localbpki = new bpki(paramFloat1, paramFloat2, c(), a());
    RectF localRectF1 = new RectF(this.jdField_a_of_type_Bpjn.a());
    localRectF1.offset(paramFloat1, paramFloat2);
    if (this.jdField_a_of_type_Bpjn.d())
    {
      ...
      localbpki.a(bpjm.a(localRectF1, localRectF2));
      return localbpki;
    }
    RectF localRectF2 = new RectF();
    if (this.jdField_a_of_type_Bpjn.b())
    {
      ...
      this.jdField_a_of_type_AndroidGraphicsMatrix.mapRect(localRectF2, this.jdField_a_of_type_Bpjn.a(paramFloat1, paramFloat2));
      localbpki.a(bpjm.a(localRectF1, localRectF2, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
      return localbpki;
    }
    this.jdField_a_of_type_AndroidGraphicsMatrix.setRotate(a(), this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY());
    this.jdField_a_of_type_AndroidGraphicsMatrix.mapRect(localRectF2, this.jdField_a_of_type_AndroidGraphicsRectF);
    localbpki.a(bpjm.b(localRectF1, localRectF2, this.jdField_b_of_type_AndroidGraphicsRectF.centerX(), this.jdField_b_of_type_AndroidGraphicsRectF.centerY()));
    return localbpki;
  }
  ...
  {
    this.jdField_a_of_type_Bpjn.a(paramFloat);
  }
  ...
  public void d(float paramFloat1, float paramFloat2)
  {
    ...
    a();
    this.jdField_a_of_type_Bpjn.d(true);
  }
