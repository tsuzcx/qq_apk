  ...
  extends Handler
{
  ...
  public abpe(CameraManagerImpl paramCameraManagerImpl, Looper paramLooper)
  {
    super(paramLooper);
  }
      ...
      catch (RuntimeException localRuntimeException)
      {
        ...
        if ((paramMessage.what != 2) && (CameraManagerImpl.a(this.jdField_a_of_type_ComTencentMobileqqCameraCameraManagerImpl) != null))
        {
          ...
          catch (Exception localException2)
          {
            ...
            continue;
            if (!(paramMessage.obj instanceof abpc)) {
              continue;
            }
            ((abpc)paramMessage.obj).onAutoFocus(false, CameraManagerImpl.a(this.jdField_a_of_type_ComTencentMobileqqCameraCameraManagerImpl));
            return;
          }
