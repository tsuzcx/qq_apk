...
public class akil
  implements ajte, BusinessObserver
{
  protected void a() {}
  ...
  public void onUpdate(int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        return;
        a(paramBoolean, (bauh)paramObject);
        return;
        long l;
        if ((paramObject instanceof Object[]))
        {
        ...
        for (;;)
        {
          ...
          if ((paramObject instanceof Object[]))
          {
            ...
            localObject1 = localObject2;
            if (paramObject.length > 0) {
              localObject1 = (azvn)paramObject[0];
            }
          }
          a(paramBoolean, (azvn)localObject1);
          return;
          i = 0;
          paramInt = i;
          if (paramObject != null)
          ...
          for (paramObject = (List)localObject1[2];; paramObject = null)
          {
            ...
            a(paramBoolean, ((Integer)paramObject[0]).intValue(), ((Long)paramObject[1]).longValue(), (bami)paramObject[2]);
            return;
            if (!(paramObject instanceof Object[])) {
              break;
            }
