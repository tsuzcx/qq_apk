  ...
  implements akij
{
  ...
  public akil(JSONObject paramJSONObject, Bundle paramBundle, WeakReference<MessengerService> paramWeakReference)
  {
  ...
  public void invalidateSelf()
  {
    ...
    float f = bdbg.a(localTextPaint, localRect, (String)localObject4);
    try
    {
      i = Color.parseColor((String)localObject1);
      if (n == 1)
      {
        localObject3 = akii.a().a(this, (String)localObject4, m, n, f, i, j, k, localTextPaint);
      ...
      try
      {
        do
        {
          ...
          for (;;)
          {
            ...
            localObject3 = bdbi.encodeToString(((ByteArrayOutputStream)localObject4).toByteArray(), 2);
          ...
          localObject2 = akii.a().a(this, m, n);
