  ...
  implements BusinessObserver
{
  ...
  private final SparseArray<WeakReference<alqd>> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  private WeakReference<AppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  private List<alqc> jdField_a_of_type_JavaUtilList;
  ...
  public static alpz a()
  {
    try
    {
      if (jdField_a_of_type_Alpz == null) {
        jdField_a_of_type_Alpz = new alpz();
      }
      alpz localalpz = jdField_a_of_type_Alpz;
      return localalpz;
    }
    finally {}
  }
  ...
  private void a(int paramInt)
  {
    ...
    {
      ((alqd)localWeakReference.get()).a(false, null);
      this.jdField_a_of_type_AndroidUtilSparseArray.remove(paramInt);
    }
    QLog.i("rscContent_CmShowRscUpdateHandler", 1, "onContentCheckFailed requestId:" + paramInt);
  }
  
  private void a(int paramInt, alqc paramalqc)
  {
    if (paramalqc == null) {
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("rscContent_CmShowRscUpdateHandler", 2, "onContentCheckSuccess result" + paramalqc);
    }
    if ((paramalqc.jdField_a_of_type_Int == 100) && (paramalqc.jdField_a_of_type_Long == 1L))
    {
      if (1 == BaseApplicationImpl.sProcessId) {
        break label293;
      }
      if ("all_room3D".equals(paramalqc.jdField_a_of_type_JavaLangString)) {
        alpu.a().a();
      }
    }
    else
    {
      label79:
      a(paramalqc, paramalqc.jdField_b_of_type_Int);
      if (paramalqc.jdField_b_of_type_Boolean)
      {
        if (paramalqc.jdField_d_of_type_Int <= 0) {
          break label417;
        }
        if (jdField_a_of_type_Int == paramalqc.jdField_d_of_type_Int) {
          break label380;
        }
        jdField_a_of_type_Int = paramalqc.jdField_d_of_type_Int;
        this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putInt("json_content_update_interval", paramalqc.jdField_d_of_type_Int).commit();
        QLog.i("rscContent_CmShowRscUpdateHandler", 1, "onContentCheckSuccess interval != result.mCheckServerInterval:" + paramalqc.jdField_d_of_type_Int);
      }
    }
    label417:
    for (;;)
    {
      for (;;)
      {
        ...
        {
          this.jdField_a_of_type_JavaUtilList.remove(paramalqc);
        ...
        ((alqd)((WeakReference)localObject).get()).a(true, paramalqc);
        this.jdField_a_of_type_AndroidUtilSparseArray.remove(paramInt);
        return;
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("rscContent_CmShowRscUpdateHandler", 2, "onContentCheckSuccess interval == result.mCheckServerInterval:" + paramalqc.jdField_d_of_type_Int);
        continue;
        QLog.i("rscContent_CmShowRscUpdateHandler", 1, "onContentCheckSuccess result.mCheckServerInterval <= 0" + paramalqc.jdField_d_of_type_Int);
      }
    }
  }
  ...
  private void a(int paramInt, List<alqc> paramList)
  {
    if (paramList != null)
    {
      if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        if (localObject != null)
        {
          ...
          if ((localObject != null) && (((bgog)localObject).a(3) != null))
          {
            paramList = paramList.iterator();
            while (paramList.hasNext())
            {
              alqc localalqc = (alqc)paramList.next();
              if (localalqc != null)
              {
                localObject = new File(localalqc.c());
                ((File)localObject).getParentFile().mkdirs();
                if (((File)localObject).exists()) {
                  ((File)localObject).delete();
                }
                String str1 = localalqc.e();
                if ((localalqc.jdField_a_of_type_Boolean) && (!new File(str1).exists()))
                {
                  localalqc.jdField_a_of_type_Boolean = false;
                  QLog.e("rscContent_CmShowRscUpdateHandler", 1, "updateResource old version File no exist :" + str1);
                }
                if (localalqc.jdField_a_of_type_Boolean)
                {
                  if (localalqc.jdField_a_of_type_ArrayOfByte != null)
                  {
                    String str2 = localalqc.d();
                    if (FileUtils.writeFile(localalqc.jdField_a_of_type_ArrayOfByte, str2))
                    {
                      if (BspatchUtil.a(str1, str2, ((File)localObject).getAbsolutePath()))
                      {
                        ...
                        try
                        {
                          ...
                          if (QLog.isColorLevel()) {
                            QLog.d("rscContent_CmShowRscUpdateHandler", 2, " updateResource onDone dstMd5:" + str1 + " result.mMd5:" + localalqc.jdField_d_of_type_JavaLangString);
                          }
                          if (!b(localalqc, str1)) {
                            break label640;
                          }
                        ...
                        catch (Exception localException)
                        {
                          for (;;)
                          {
                            ...
                            a(paramInt);
                            break;
                            boolean bool = FileUtils.copyFile(((File)localObject).getAbsolutePath(), localException.b() + localException.jdField_e_of_type_JavaLangString);
  ...
  private void a(alqc paramalqc)
  {
    if (QLog.isColorLevel()) {
      QLog.d("rscContent_CmShowRscUpdateHandler", 2, "downloadZipAndPatch result:" + paramalqc);
    }
    if (paramalqc == null) {}
    Object localObject;
    do
    {
      ...
      localObject = ((bgog)localObject).a(3);
    } while (localObject == null);
    if (TextUtils.isEmpty(paramalqc.c))
    {
      QLog.e("rscContent_CmShowRscUpdateHandler", 2, "downloadZipAndPatch result.mDownloadPatchFileUrl is empty result:" + paramalqc);
      return;
    }
    File localFile = new File(paramalqc.d());
    localFile.getParentFile().mkdirs();
    if (localFile.exists()) {
      localFile.delete();
    }
    bgoe localbgoe = new bgoe(paramalqc.c, localFile);
    localbgoe.p = true;
    localbgoe.n = true;
    localbgoe.f = "apollo_res";
    localbgoe.jdField_b_of_type_Int = 1;
    localbgoe.q = true;
    localbgoe.r = true;
    localbgoe.jdField_a_of_type_JavaLangString = (paramalqc.jdField_b_of_type_JavaLangString + "_" + paramalqc.jdField_a_of_type_JavaLangString);
    ((bgoj)localObject).a(localbgoe, new alqa(this, localFile, paramalqc), null);
  }
  
  private void b(alqc paramalqc)
  {
    if (QLog.isColorLevel()) {
      QLog.d("rscContent_CmShowRscUpdateHandler", 2, "downloadAllZip result:" + paramalqc);
    }
    if ((this.jdField_a_of_type_JavaLangRefWeakReference == null) || (paramalqc == null)) {}
    Object localObject;
    do
    {
      do
    ...
    if (TextUtils.isEmpty(paramalqc.jdField_b_of_type_JavaLangString))
    {
      QLog.e("rscContent_CmShowRscUpdateHandler", 2, "downloadAllZip result.mDownloadFileUrl is empty result:" + paramalqc);
      return;
    }
    File localFile = new File(paramalqc.c());
    localFile.getParentFile().mkdirs();
    if (localFile.exists()) {
      localFile.delete();
    }
    bgoe localbgoe = new bgoe(paramalqc.jdField_b_of_type_JavaLangString, localFile);
    localbgoe.p = true;
    localbgoe.n = true;
    localbgoe.f = "apollo_res";
    localbgoe.jdField_b_of_type_Int = 1;
    ...
    localbgoe.r = true;
    localbgoe.jdField_a_of_type_JavaLangString = (paramalqc.jdField_b_of_type_JavaLangString + "_" + paramalqc.jdField_a_of_type_JavaLangString);
    ((bgoj)localObject).a(localbgoe, new alqb(this, localFile, paramalqc), null);
  }
  
  private static boolean b(alqc paramalqc)
  {
    if (paramalqc == null) {}
    while ((TextUtils.isEmpty(paramalqc.jdField_e_of_type_JavaLangString)) || (!paramalqc.jdField_e_of_type_JavaLangString.endsWith(".zip"))) {
      return false;
    }
    return true;
  }
  
  private static boolean b(alqc paramalqc, String paramString)
  {
    if (paramalqc == null) {}
    do
    {
      return false;
      if (TextUtils.isEmpty(paramalqc.jdField_d_of_type_JavaLangString)) {
        return true;
      }
    } while ((paramString == null) || (!paramString.equalsIgnoreCase(paramalqc.jdField_d_of_type_JavaLangString)));
    return true;
  }
  ...
  public void a(int paramInt, alqd paramalqd)
  {
    synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
    {
      this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, new WeakReference(paramalqd));
      return;
    }
  }
  
  public void a(alqc paramalqc, int paramInt)
  {
    if (paramalqc != null)
    {
      this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putInt(paramalqc.a(), paramInt).commit();
  ...
  public void a(AppInterface paramAppInterface, int paramInt, boolean paramBoolean)
  {
    ...
    {
      return;
      if (!alqc.a(100, 1L, "all_room3D", "all_room3D.json"))
      {
      ...
      try
      {
        ...
        ((WebSSOAgent.UniSsoServerReqComm)localObject3).mqqver.set("8.4.8");
        ...
        localObject1 = new NewIntent(BaseApplicationImpl.getContext(), auwo.class);
