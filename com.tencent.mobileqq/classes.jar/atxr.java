...
public class atxr
{
  ...
  public CharSequence a(amko paramamko)
  {
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder();
    Object localObject = paramamko.a().jdField_a_of_type_JavaUtilArrayList;
    localSpannableStringBuilder.append(paramamko.a().jdField_a_of_type_JavaLangString);
    int i = 0;
    while (i < ((ArrayList)localObject).size()) {
      if (TextUtils.isEmpty(((amkq)((ArrayList)localObject).get(i)).jdField_a_of_type_JavaLangString))
      {
        i += 1;
      }
      else
      {
        ...
        paramamko = ((amkq)((ArrayList)localObject).get(i)).jdField_a_of_type_JavaLangString;
        localObject = new ForegroundColorSpan(Color.parseColor("#4D94FF"));
        localSpannableStringBuilder.append(paramamko);
        localSpannableStringBuilder.setSpan(localObject, j, paramamko.length() + j, 33);
      }
    }
  ...
  {
    long l = alzw.a().a(529, paramQQAppInterface.getCurrentAccountUin());
  ...
  {
    boolean bool = false;
    if (alzw.a().a(529, paramQQAppInterface.getCurrentAccountUin()) > paramQQAppInterface.getApp().getSharedPreferences(paramQQAppInterface.getCurrentAccountUin(), 0).getLong("recommend_topic_version", -1L)) {
      bool = true;
    }
    return bool;
  }
