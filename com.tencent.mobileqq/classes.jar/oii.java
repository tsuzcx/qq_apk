...
public class oii
{
  ...
  public static final int e = bhtq.a(5.0F);
  public int a;
  ...
  public oii(ViewGroup paramViewGroup, ReadInJoyNavigationGridview paramReadInJoyNavigationGridview, ImageView paramImageView)
  {
    this.jdField_a_of_type_Pfh = new oim(this);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyNavigationGridview.setChannelButtonListener(new oin(this));
  ...
  {
    JSONObject localJSONObject = ozs.b();
    switch (paramInt)
    {
    }
    for (;;)
  ...
  public static void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ocd.a(null, "CliOper", "", "", str, str, 0, 0, "", "", "", paramString, false);
      return;
      str = "0X8008B81";
      continue;
      str = "0X8008B83";
  ...
  {
    ozs.b().postDelayed(new ReadInJoyNaviController.4(this), paramLong);
  }
  ...
  public void a(int paramInt)
  {
    ...
    ozs.b().postDelayed(new ReadInJoyNaviController.1(this), 0L);
  }
  ...
  public void a(ChannelCoverInfo paramChannelCoverInfo)
  {
    ...
    for (;;)
    {
      ...
      {
        ozs.b().postDelayed(new ReadInJoyNaviController.2(this, paramChannelCoverInfo), 0L);
        return;
      }
      i += 1;
    }
