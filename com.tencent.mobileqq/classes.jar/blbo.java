  ...
  implements View.OnClickListener
{
  ...
  public blbo(QQComicTabBarView paramQQComicTabBarView, int paramInt, boolean paramBoolean, List<WebViewTabBarData> paramList)
  {
  ...
  void a(QQComicTabBarView paramQQComicTabBarView)
  {
    ...
    try
    {
      ...
      ((blbd)localObject).dispatchJsEvent("qbrowserTabClick", null, localJSONObject);
