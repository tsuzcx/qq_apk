...
{
  public static int a;
  private static aoeh jdField_a_of_type_Aoeh;
  public static int b;
  ...
  public static aoeh a()
  {
    if (jdField_a_of_type_Aoeh == null) {
      jdField_a_of_type_Aoeh = new aoeh();
    }
    return jdField_a_of_type_Aoeh;
  }
  ...
  public void a(Context paramContext, String paramString)
  {
    ...
    {
      paramContext = bbcv.a(paramContext, 230, str2, String.format(paramContext.getString(2131692149), new Object[] { paramString, localObject }), null, localaoei);
      if (paramContext != null)
      {
        paramContext.setNegativeButton(str1, localaoei);
        paramContext.show();
      }
      return;
    }
