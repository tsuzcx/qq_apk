  ...
  extends MSFServlet
{
  ...
  {
    bfqx.a().a(paramString, paramInt);
  }
  
  private void a(byte[] paramArrayOfByte)
  {
    bfqx.a().b(paramArrayOfByte);
  }
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    do
    {
      ...
      bfrg.c("VideoChannelServlet", String.format("onReceive cmd=%s", new Object[] { paramIntent }));
    ...
    bfrg.c("VideoChannelServlet", String.format(">>> ip=%s", new Object[] { paramIntent }));
    a(paramIntent, 0);
    return;
    if ("VideoCCSvc.Adaptation".equalsIgnoreCase(paramIntent))
    {
      ...
      bfrg.a("VideoChannelServlet", String.format("onReceive get config fail, resultCode=%s", new Object[] { Integer.valueOf(paramFromServiceMsg.getResultCode()) }));
      return;
    }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    bfrg.c("VideoChannelServlet", String.format("onSend reqType=%s", new Object[] { Integer.valueOf(i) }));
    switch (i)
    {
    default: 
