  ...
  implements View.OnClickListener
{
  ...
  public bfqz()
  {
    ...
    this.jdField_a_of_type_Anyu = new bfrc(this, null);
  }
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    nkm.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new bfra(this, paramLong), localReqBody.toByteArray(), "OidbSvc.0x487_0", 1159, paramInt);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, Observer paramObserver, SessionInfo paramSessionInfo, RelativeLayout paramRelativeLayout, aggs paramaggs, ChatXListView paramChatXListView)
  {
    ...
    this.d = paramContext.getResources().getColor(2131166230);
    this.e = paramContext.getResources().getColor(2131166231);
  ...
  public void b()
  {
    ...
    if (this.jdField_c_of_type_AndroidViewView == null) {
      this.jdField_c_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560566, null);
    }
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout.indexOfChild(this.jdField_c_of_type_AndroidViewView) == -1)
    {
      localObject = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject).topMargin = bhgr.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
      ((RelativeLayout.LayoutParams)localObject).addRule(3, 2131374287);
      ((RelativeLayout.LayoutParams)localObject).addRule(11);
      ((RelativeLayout.LayoutParams)localObject).height = bhgr.a(this.jdField_a_of_type_AndroidContentContext, 41.0F);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379329));
    ...
    ((LinearLayout.LayoutParams)localObject).leftMargin = bhgr.a(this.jdField_a_of_type_AndroidContentContext, 4.0F);
    ((LinearLayout.LayoutParams)localObject).rightMargin = bhgr.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
    int i = bhgr.a(this.jdField_a_of_type_AndroidContentContext, 18.0F);
    ...
    for (;;)
    {
      this.jdField_c_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843643);
  ...
  public void c()
  {
    ...
    ImageView localImageView = (ImageView)this.jdField_b_of_type_AndroidViewView.findViewById(2131379328);
    localImageView.setVisibility(0);
    LinearLayout.LayoutParams localLayoutParams = (LinearLayout.LayoutParams)localImageView.getLayoutParams();
    localLayoutParams.height = -2;
    localLayoutParams.width = -2;
    localLayoutParams.leftMargin = bhgr.a(this.jdField_a_of_type_AndroidContentContext, 3.0F);
    localLayoutParams.rightMargin = bhgr.a(this.jdField_a_of_type_AndroidContentContext, 8.0F);
    Drawable localDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843644);
    localLayoutParams.leftMargin = bhgr.a(this.jdField_a_of_type_AndroidContentContext, 11.0F);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131697003);
  }
  ...
  public void e()
  {
    ...
    {
      bdll.b(localQQAppInterface, "P_CliOper", "Grp_public", "", "oper", str1, 0, 0, "", "", "", str2);
      return;
