...
public class bfqz
{
  private static bfqz jdField_a_of_type_Bfqz;
  ...
  private bfqz()
  {
    ...
    for (int i = 4;; i = 0)
    {
      ...
      if (this.jdField_a_of_type_AndroidContentSharedPreferences != null) {
        this.jdField_a_of_type_AndroidContentSharedPreferences.registerOnSharedPreferenceChangeListener(new bfra(this));
      }
      return;
    }
  }
  ...
  public static bfqz a()
  {
    if (jdField_a_of_type_Bfqz == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Bfqz == null) {
        jdField_a_of_type_Bfqz = new bfqz();
      }
      return jdField_a_of_type_Bfqz;
    }
  }
