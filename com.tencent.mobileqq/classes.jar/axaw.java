...
public class axaw
{
  public static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    return 0;
    Object localObject = paramQQAppInterface.a(1044).a(antf.aT, 1044);
    if (localObject == null)
    {
  ...
  public static Intent a(Context paramContext)
  {
    ...
    paramContext.putExtra("uin", antf.aT);
  ...
  public static void a(QQAppInterface paramQQAppInterface, RecentMatchChatListItem paramRecentMatchChatListItem, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (paramBoolean) {
        paramQQAppInterface.a().a(antf.aT, 1044, paramRecentMatchChatListItem.getRecentUserUin(), paramQQAppInterface.getCurrentAccountUin());
      }
    } while (i <= 0);
