  ...
  implements awts
{
  ...
  public awtt(awti paramawti, StoryPlayController paramStoryPlayController, ShortVideoCommentsView paramShortVideoCommentsView, boolean paramBoolean)
  {
  ...
  public void a(int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqNearbyNowStoryPlayController.jdField_a_of_type_ComTencentMobileqqNearbyNowViewStuffContainerView.a.a(this.jdField_a_of_type_Awti.jdField_a_of_type_Int, i);
      return;
    }
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (this.jdField_a_of_type_Boolean)) {
      awrv.a(this.jdField_a_of_type_Awti, paramInt1, paramInt2);
    }
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Awti != null)
    {
      ...
      this.jdField_a_of_type_Awti.jdField_a_of_type_ComTencentMobileqqNearbyNowViewOperationView.a(true);
      if ((this.jdField_a_of_type_Awti.jdField_a_of_type_Int >= 0) && (this.jdField_a_of_type_Awti.jdField_a_of_type_Int < this.jdField_a_of_type_ComTencentMobileqqNearbyNowStoryPlayController.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.a.size()))
      {
        localVideoData = (VideoData)this.jdField_a_of_type_ComTencentMobileqqNearbyNowStoryPlayController.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.a.get(this.jdField_a_of_type_Awti.jdField_a_of_type_Int);
    ...
    label195:
    while (this.jdField_a_of_type_ComTencentMobileqqNearbyNowStoryPlayController.jdField_a_of_type_Int != this.jdField_a_of_type_Awti.jdField_a_of_type_Int)
    {
      return;
  ...
  public void e()
  {
    ...
    if (this.jdField_a_of_type_Awti.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetImageDisplayView.getVisibility() == 0) {
      if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowStoryPlayController.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.a.size() > this.jdField_a_of_type_ComTencentMobileqqNearbyNowStoryPlayController.jdField_a_of_type_Int) && (((VideoData)this.jdField_a_of_type_ComTencentMobileqqNearbyNowStoryPlayController.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.a.get(this.jdField_a_of_type_ComTencentMobileqqNearbyNowStoryPlayController.jdField_a_of_type_Int)).jdField_a_of_type_JavaUtilArrayList.size() > 0)) {
        awrv.a(this.jdField_a_of_type_Awti, ((awqc)((VideoData)this.jdField_a_of_type_ComTencentMobileqqNearbyNowStoryPlayController.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.a.get(this.jdField_a_of_type_ComTencentMobileqqNearbyNowStoryPlayController.jdField_a_of_type_Int)).jdField_a_of_type_JavaUtilArrayList.get(0)).b, ((awqc)((VideoData)this.jdField_a_of_type_ComTencentMobileqqNearbyNowStoryPlayController.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.a.get(this.jdField_a_of_type_ComTencentMobileqqNearbyNowStoryPlayController.jdField_a_of_type_Int)).jdField_a_of_type_JavaUtilArrayList.get(0)).jdField_a_of_type_Int, (VideoData)this.jdField_a_of_type_ComTencentMobileqqNearbyNowStoryPlayController.jdField_a_of_type_ComTencentMobileqqNearbyNowViewVideoPlayerPagerAdapter.a.get(this.jdField_a_of_type_ComTencentMobileqqNearbyNowStoryPlayController.jdField_a_of_type_Int), this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewShortVideoCommentsView);
      }
    }
    while ((this.b <= 0) || (this.c <= 0)) {
      return;
    }
    awrv.a(this.jdField_a_of_type_Awti, this.b, this.c);
  }
  ...
  public void f()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqNearbyNowViewWidgetHorizontalBallLoadingView = ((HorizontalBallLoadingView)this.jdField_a_of_type_Awti.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131370267));
