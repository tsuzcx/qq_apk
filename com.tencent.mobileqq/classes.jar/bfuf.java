...
public class bfuf
  extends bfuh
{
  public bfuf(QZoneMsgFragment paramQZoneMsgFragment) {}
  ...
  protected void a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ...
      QLog.i("QZoneMsgManager.QZoneMsgFragment", 2, "onLoadMoreMsg ，hasMore=" + QZoneMsgFragment.b(this.a));
    }
    for (;;)
    {
      QZoneMsgFragment.a(this.a, paramBoolean);
  ...
  protected void b(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      if (paramBundle != null)
      {
        ...
        QLog.i("QZoneMsgManager.QZoneMsgFragment", 2, "onPreloadMsg ，hasMore=" + QZoneMsgFragment.b(this.a));
        return;
      }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("QZoneMsgManager.QZoneMsgFragment", 2, "onReFreshMsg start");
    }
    ...
    if (paramBundle != null)
    {
      ...
      if (QLog.isColorLevel())
      {
        StringBuilder localStringBuilder = new StringBuilder().append("onReFreshMsg ，hasMore=").append(QZoneMsgFragment.b(this.a)).append(" ,ArkNes_vec size:");
