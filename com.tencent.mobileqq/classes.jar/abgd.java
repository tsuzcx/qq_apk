  ...
  extends abfk
{
  ...
  public void a(Activity paramActivity, abfl paramabfl, int paramInt)
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)paramabfl.a();
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setId(2131367295);
    localRelativeLayout.addView(this.jdField_a_of_type_AndroidWidgetTextView, localLayoutParams);
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(4);
    this.jdField_a_of_type_AndroidViewAnimationAlphaAnimation.setDuration(300L);
    this.b.setDuration(300L);
    this.jdField_a_of_type_Abfl = paramabfl;
    this.jdField_a_of_type_AndroidViewAnimationAlphaAnimation.setAnimationListener(new abge(this));
    this.b.setAnimationListener(new abgf(this));
  }
