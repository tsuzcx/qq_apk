  ...
  implements bepy
{
  ...
  public bepz(Context paramContext, GestureDetector.OnGestureListener paramOnGestureListener, Handler paramHandler)
  {
    if (paramHandler != null) {}
    for (this.jdField_a_of_type_AndroidOsHandler = new beqa(this, paramHandler);; this.jdField_a_of_type_AndroidOsHandler = new beqa(this))
    {
