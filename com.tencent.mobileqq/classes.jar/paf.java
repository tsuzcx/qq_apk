  ...
  extends pbe
{
  ...
  private HashMap<String, paj<Parcelable>> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private ConcurrentHashMap<String, paj<FastWebArticleInfo>> b = new ConcurrentHashMap();
  
  static
  {
    jdField_a_of_type_JavaLangString = paf.class.getSimpleName();
  }
  
  public paf(AppInterface paramAppInterface, aukp paramaukp, ExecutorService paramExecutorService, por parampor, Handler paramHandler)
  {
  ...
  {
    int i = bcxw.a(null);
    Object localObject = bhvy.f(onh.a());
  ...
  private void b()
  {
    this.jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache = new pag(this, 2012, 30, 1);
  }
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = pot.a(paramFromServiceMsg, paramObject, localRspBody);
    boolean bool1 = false;
    boolean bool2 = false;
    ...
    for (;;)
    {
      paramFromServiceMsg = (pai)a(Integer.valueOf(i));
      ...
      if (str != null)
      {
        ...
        this.b.put(str, new paj(this, paramToServiceMsg));
      }
      for (;;)
      {
        ...
        paramToServiceMsg.put("param_uin", onh.a());
        paramToServiceMsg.put("param_retCode", k + "");
        paramToServiceMsg.put("param_succ", String.valueOf(bool1));
        paramToServiceMsg.put("param_netType", bcxw.a(null) + "");
        axrn.a(BaseApplicationImpl.getApplication()).a(null, "actKandianFastWebCost", bool1, l, 0L, paramToServiceMsg, null);
        return;
        label518:
        if ((paramToServiceMsg != null) && (this.b.containsKey(str)))
        {
          paramFromServiceMsg = (paj)this.b.get(str);
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = pot.a(paramFromServiceMsg, paramObject, paramToServiceMsg);
    paramFromServiceMsg = new rmx();
    boolean bool;
    ...
    for (;;)
    {
      paramToServiceMsg = (pah)a(Integer.valueOf(i));
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = pot.a(paramFromServiceMsg, paramObject, localRspBody);
    paramFromServiceMsg = (rsp)a(Integer.valueOf(i));
    paramToServiceMsg = "";
  ...
  public int a(String paramString1, String paramString2, String paramString3, int paramInt, pai parampai)
  {
    for (;;)
    {
      Object localObject1;
      try
      {
        QLog.d("Q.readinjoy.fast_web", 2, "getArticleContent, rowkey : " + paramString2 + ", url : " + paramString1 + " callback: " + parampai + ", reqType : " + paramInt);
        if ((paramInt != 2) && (paramString2 != null))
        {
          localObject1 = (paj)this.b.get(paramString2);
          if (localObject1 != null)
          {
            if (!((paj)localObject1).a()) {
              continue;
            }
        ...
        ((oidb_cmd0xad6.Client)localObject2).bytes_version.set(ByteStringMicro.copyFromUtf8("8.3.0"));
        ...
        if (paramInt == 1)
        {
          ...
          paramString3 = pot.a("OidbSvc.0xad6", 2774, 0, ((oidb_cmd0xad6.ReqBody)localObject1).toByteArray());
          ...
          if (parampai != null)
          {
            parampai.a(true, ((paj)localObject1).jdField_a_of_type_Boolean, (FastWebArticleInfo)((paj)localObject1).a());
            nol.a(null, "CliOper", "", "", "0X8009C51", "0X8009C51", 0, 0, "", "", "", "", false);
          }
          QLog.d("Q.readinjoy.fast_web", 2, "hit cache, rowkey : " + paramString2 + ", url : " + paramString1 + " isUserWeb " + ((paj)localObject1).jdField_a_of_type_Boolean);
          return -1;
        }
        if (paramInt == 3)
        {
  ...
  {
    paramString = (paj)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
  ...
  {
    paramString = (paj)this.b.get(paramString);
    if (paramString != null) {
  ...
  {
    return rnj.a((List)this.jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache.get(paramString));
  }
  ...
  public void a(@NonNull ArticleInfo paramArticleInfo, int paramInt, rsp paramrsp)
  {
    ...
    for (;;)
    {
      ...
      localFeedParam.multi_level_info.set(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qcg.a());
      ...
      try
      {
        ...
        localObject = pot.a("OidbSvc.0xbd3", 3027, 0, localReqBody.toByteArray());
        int i = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
  ...
  public void a(ArticleInfo paramArticleInfo, pah parampah, boolean paramBoolean)
  {
    Object localObject1 = new oidb_cmd0xb54.ReqBody();
    Object localObject2 = new oidb_cmd0xb54.Client();
    ((oidb_cmd0xb54.Client)localObject2).bytes_version.set(ByteStringMicro.copyFromUtf8("8.3.0"));
    ...
    if (bhvy.n(this.jdField_a_of_type_ComTencentCommonAppAppInterface) != 1) {
    ...
    Object localObject3 = (paj)this.b.get(paramArticleInfo.innerUniqueID);
    if (localObject3 != null)
    {
      localObject3 = (FastWebArticleInfo)((paj)localObject3).a();
    ...
    localObject1 = pot.a("OidbSvc.0xb54", 2900, 0, ((oidb_cmd0xb54.ReqBody)localObject1).toByteArray());
    int i = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
  ...
  {
    paj localpaj = (paj)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (localpaj == null)
    {
      paramParcelable = new paj(this, paramParcelable);
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, paramParcelable);
      return;
    }
    localpaj.a(paramParcelable);
  }
  
  public void a(String paramString1, String paramString2, String paramString3, int paramInt, pah parampah)
  {
    oidb_cmd0xad7.ReqBody localReqBody = new oidb_cmd0xad7.ReqBody();
    Object localObject = new oidb_cmd0xad7.Client();
    ((oidb_cmd0xad7.Client)localObject).bytes_version.set(ByteStringMicro.copyFromUtf8("8.3.0"));
    ...
    try
    {
      ...
      if (paramInt == 2)
      {
        ...
        paramString3 = pot.a("OidbSvc.0xad7", 2775, 0, localReqBody.toByteArray());
        int i = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int j = pot.a(paramFromServiceMsg, paramObject, (MessageMicro)localObject2);
    paramFromServiceMsg = (pah)b(Integer.valueOf(i));
    paramObject = (paj)this.b.get(localObject3);
    if (paramObject == null) {
      return;
    }
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        if (((oidb_cmd0xb54.RspBody)localObject2).bytes_proteus_json_data.has())
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject3))
          {
            ...
            rmn.a((String)localObject3, paramObject.jdField_a_of_type_AndroidUtilSparseArray);
          }
        }
        ...
        while (((Iterator)localObject4).hasNext())
        {
          ...
          if ((((oidb_cmd0xb54.RelatedSearchWord)localObject6).bytes_word.has()) && (((oidb_cmd0xb54.RelatedSearchWord)localObject6).str_jmp_url.has()))
          {
            ...
            {
              localObject6 = new rka();
              ((rka)localObject6).jdField_a_of_type_JavaLangString = ((String)localObject5);
              ((rka)localObject6).b = str2;
              ((rka)localObject6).jdField_a_of_type_Float = f;
              ((rka)localObject6).c = str3;
              ((rka)localObject6).jdField_a_of_type_Int = i;
