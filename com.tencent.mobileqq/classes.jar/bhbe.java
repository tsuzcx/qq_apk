...
public class bhbe
{
  private static volatile bhbe jdField_a_of_type_Bhbe;
  ...
  private Vector<bhbg> jdField_a_of_type_JavaUtilVector = new Vector();
  ...
  private void a()
  {
    ...
    if (Build.VERSION.SDK_INT > 16)
    {
      if (this.jdField_a_of_type_AndroidViewChoreographer$FrameCallback == null) {
        this.jdField_a_of_type_AndroidViewChoreographer$FrameCallback = new bhbf(this);
      }
  ...
  private void a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          ((bhbg)this.jdField_a_of_type_JavaUtilVector.get(i)).a(this.jdField_a_of_type_Long, d);
          i += 1;
        }
      }
      finally {}
  ...
  public void a(bhbg parambhbg)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (!this.jdField_a_of_type_JavaUtilVector.contains(parambhbg)) {
        this.jdField_a_of_type_JavaUtilVector.add(parambhbg);
      }
  ...
  public void b(bhbg parambhbg)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_JavaUtilVector.contains(parambhbg)) {
        this.jdField_a_of_type_JavaUtilVector.remove(parambhbg);
      }
      if (this.jdField_a_of_type_JavaUtilVector.size() <= 0) {
        b();
      }
