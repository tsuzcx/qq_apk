...
public class blpr
{
  ...
  {
    xot localxot = xot.a(BaseApplicationImpl.getApplication().getApplicationContext());
    ArrayList localArrayList = new ArrayList();
    localArrayList.add("-formats");
    localxot.a((String[])localArrayList.toArray(new String[0]), new blpt());
  }
  
  public static void a(String paramString1, String paramString2, blqf paramblqf)
  {
    a();
    xot localxot = xot.a(BaseApplicationImpl.getApplication().getApplicationContext());
    ArrayList localArrayList = new ArrayList();
    ...
    localxot.a((String[])localArrayList.toArray(new String[0]), new blps(paramString2, paramblqf));
  }
  
  public static boolean a()
  {
    File localFile = new File(blqe.a);
    if (!localFile.exists()) {
      localFile.mkdir();
    }
    try
    {
      new blpp(BaseApplicationImpl.getContext()).a("svm_snr15_random_noise", localFile);
      return true;
    }
