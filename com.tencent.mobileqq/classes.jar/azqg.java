...
{
  public azqg(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(Activity paramActivity, String paramString, QQAppInterface paramQQAppInterface, PersonalityLabel paramPersonalityLabel, azrb paramazrb)
  {
    byte[] arrayOfByte = PersonalityLabel.convertToBytes(paramPersonalityLabel);
    paramActivity.runOnUiThread(new PersonalityLabelHandler.1(paramString, paramQQAppInterface, paramazrb, arrayOfByte));
    paramActivity = (anvk)paramQQAppInterface.getManager(QQManagerFactory.FRIENDS_MANAGER);
  ...
  {
    afqy localafqy = (afqy)this.mApp.getManager(QQManagerFactory.BEANCURD_MANAGER);
    Object localObject = localafqy.a(paramString2, 0, 3);
    if (localObject != null) {
    ...
    for (int i = 0;; i = 1) {
      for (;;)
      {
        ...
        try
        {
          ...
          ((BeancurdMsg)localObject).startTime = bcrg.a();
          ((BeancurdMsg)localObject).validTime = 2592000L;
          ((BeancurdMsg)localObject).buffer = paramString1;
          localafqy.a((BeancurdMsg)localObject);
          return;
          localObject = this.app.getMessageFacade().getAllMessages(paramString2, 0, new int[] { -2060 });
        ...
        do
        {
          for (;;)
          {
            ...
            else
            {
              ...
              paramFromServiceMsg = localanvk.a(paramObject);
            ...
            try
            {
              ...
              for (paramToServiceMsg = ((PersonalityLabelPhoto)paramToServiceMsg.personalityLabelPhotos.get(0)).get128SizeUrl() + azpf.d;; paramToServiceMsg = "")
              {
