...
public class anbl
  implements ancm
{
  public static List<anbl> a;
  private int jdField_a_of_type_Int;
  private anbs jdField_a_of_type_Anbs;
  private AudioManager.OnAudioFocusChangeListener jdField_a_of_type_AndroidMediaAudioManager$OnAudioFocusChangeListener = new anbr(this);
  ...
  public anbl(int paramInt1, int paramInt2, String arg3)
  {
    this.jdField_a_of_type_Int = paramInt1;
    this.jdField_b_of_type_Int = paramInt2;
    ande localande = anbd.a(paramInt2);
    if (localande != null) {
      localande.b(0);
    }
    if ("effect".equals(???)) {
      if (localande != null) {
        this.jdField_a_of_type_Anbs = new anbs(paramInt2);
      }
    }
    for (;;)
    {
      ...
      synchronized (jdField_a_of_type_JavaUtilList)
      {
        ...
        a(1);
        this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnErrorListener(new anbm(this));
      }
    }
  }
  
  private void a(ancl paramancl, JSONObject paramJSONObject)
  {
    if (paramancl != null) {
  ...
  public JSONObject a(int paramInt, JSONObject paramJSONObject, ancl paramancl)
  {
    int i;
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null)
    {
      ...
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnSeekCompleteListener(new anbn(this, paramJSONObject, paramancl));
  ...
  public JSONObject a(ancl paramancl, JSONObject paramJSONObject)
  {
    if (paramJSONObject != null) {
      try
      {
        if (paramJSONObject.optInt("N_R_OBJ") == this.jdField_a_of_type_Int)
        {
          ...
          if ("cs.audio_play.local".equals(str)) {
            return b(paramJSONObject, paramancl);
          }
          ...
          if ("cs.audio_load.local".equals(str)) {
            return c(paramJSONObject, paramancl);
          }
          ...
          if ("cs.audio_seek.local".equals(str)) {
            return a(paramJSONObject.optInt("seek"), paramJSONObject, paramancl);
          }
          if ("cs.audio_src.local".equals(str)) {
            return a(paramJSONObject.optString("src"), paramJSONObject, paramancl);
          }
          ...
          if ("cs.audio_destroy.local".equals(str)) {
            return b(paramancl, paramJSONObject);
          }
          if ("cs.audio_onend.local".equals(str)) {
            return e(paramJSONObject, paramancl);
          }
          ...
          {
            paramancl = a(paramJSONObject, paramancl);
            return paramancl;
          }
        }
      }
      ...
      {
        QLog.e("CmGameAudioPlayer", 1, "audio failed", paramancl);
      }
    }
    return null;
  }
  
  public JSONObject a(String paramString, JSONObject paramJSONObject, ancl paramancl)
  {
      ...
      try
      {
        ...
        if (localande != null)
        {
          ...
          for (;;)
          {
            ...
            a(2);
            return paramJSONObject;
            paramString = amzf.a(paramString, localande.a(), str1, false);
          }
        }
  ...
  public JSONObject a(JSONObject paramJSONObject, ancl paramancl)
  {
    try
    {
      if (paramJSONObject.has("src")) {
        a(paramJSONObject.optString("src"), paramJSONObject, paramancl);
      }
      ...
      if (paramJSONObject.has("currentTime")) {
        d(paramJSONObject, paramancl);
      }
      return paramJSONObject;
    }
    catch (Throwable paramancl)
    {
      QLog.e("CmGameAudioPlayer", 1, paramancl, new Object[0]);
    }
    return paramJSONObject;
  }
  ...
  public JSONObject a(boolean paramBoolean, float paramFloat1, float paramFloat2, JSONObject paramJSONObject)
  {
    ...
    } while (this.jdField_a_of_type_Anbs == null);
    Object localObject = this.jdField_a_of_type_Anbs;
    if ((paramBoolean) || ((Float.compare(paramFloat1, 0.0F) == 0) && (Float.compare(paramFloat2, 0.0F) == 0))) {}
    for (int i = 0;; i = 1)
    {
      ((anbs)localObject).a(i, BaseActivity.sTopActivity.getAppInterface());
      return paramJSONObject;
    }
  }
  ...
  public JSONObject b(ancl arg1, JSONObject paramJSONObject)
  {
    try
    {
      if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null) {
  ...
  public JSONObject b(JSONObject paramJSONObject)
  {
    for (;;)
    {
      ...
      if (paramJSONObject.optBoolean("auto", true)) {
        ...
        this.jdField_a_of_type_Anbs.a(i, null);
      }
    }
  }
  
  public JSONObject b(JSONObject paramJSONObject, ancl paramancl)
  {
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null)
    {
      i = a();
    ...
    while (this.jdField_a_of_type_Anbs == null) {
      for (;;)
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new anbo(this));
        }
    ...
    a(true);
    return this.jdField_a_of_type_Anbs.a(paramancl, paramJSONObject);
  }
  ...
  public JSONObject c(JSONObject paramJSONObject, ancl paramancl)
  {
    if ((this.jdField_a_of_type_AndroidMediaMediaPlayer != null) && ((a() == 2) || (a() == 6)))
    {
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new anbp(this, paramJSONObject, paramancl));
  ...
  public JSONObject d(JSONObject paramJSONObject, ancl paramancl)
  {
    int i;
  ...
  public JSONObject e(JSONObject paramJSONObject)
  {
    if (this.jdField_a_of_type_Anbs != null)
    {
      this.jdField_a_of_type_Anbs.c(paramJSONObject.optInt("id"), null);
      this.jdField_a_of_type_Anbs.a(paramJSONObject);
    }
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null)
    {
  ...
  public JSONObject e(JSONObject paramJSONObject, ancl paramancl)
  {
    if (this.jdField_a_of_type_AndroidMediaMediaPlayer != null) {
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new anbq(this, paramancl, paramJSONObject));
    }
    return null;
  }
  ...
  public JSONObject f(JSONObject paramJSONObject)
  {
    ...
    this.jdField_a_of_type_Anbs.b(paramJSONObject.optInt("id"), null);
    return paramJSONObject;
  }
}
