...
public class amih
{
  ...
  public amih(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    return abot.a(paramMessageRecord1.frienduin, paramMessageRecord1.istroop).equals(abot.a(paramMessageRecord2.frienduin, paramMessageRecord2.istroop));
  }
  ...
  public int a(boolean paramBoolean)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      for (int i = 0; localIterator.hasNext(); i = localMessage.counter + i)
      {
        ...
        if ((localMessage.istroop == 1037) || (localMessage.istroop == 1044) || (localMessage.istroop == 1045) || ((paramBoolean) && (bhpd.a(localMessage)))) {
          break label20;
        }
      }
      return i;
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      if (i >= 0)
      {
        localamii = (amii)localMessage.msgInfoList.get(i);
        if ((localamii.jdField_a_of_type_Int == 3000) || (localamii.jdField_a_of_type_Int == 1))
        {
          if (localamii.c != paramMessageRecord.shmsgseq) {
            break label486;
          }
          j = i;
        }
      ...
      for (;;)
      {
        if (j == -1)
        {
          ...
          return;
          if (localamii.b != paramMessageRecord.msgUid) {
            break;
          }
          j = i;
          if (localamii.c != paramMessageRecord.shmsgseq) {
        ...
        else
        {
          if ((j == k - 1) && (k > 1))
          {
            paramMessageRecord = (amii)localMessage.msgInfoList.get(k - 2);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        ...
        if (((paramInt == ((QQMessageFacade.Message)localObject2).istroop) || ((abot.d(paramInt)) && (abot.d(((QQMessageFacade.Message)localObject2).istroop)))) && (((QQMessageFacade.Message)localObject2).frienduin.equals(paramString)))
        {
          ...
          if (bool1)
          {
            ...
            if ((!bhpd.a(paramInt)) || (!bhpd.a(paramString))) {
              break label309;
            }
            bhpd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(paramString);
          }
          return;
        }
      }
  ...
  public int b(boolean paramBoolean)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      {
        QQMessageFacade.Message localMessage = (QQMessageFacade.Message)localIterator.next();
        if ((localMessage.istroop != 1008) && (localMessage.istroop != 1037) && (localMessage.istroop != 1044) && (localMessage.istroop != 1045) && ((!paramBoolean) || (!bhpd.a(localMessage))))
        {
          if (7000 != localMessage.istroop) {
            break label166;
          }
          azyu localazyu = (azyu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(61);
          if (localazyu == null) {
            break label157;
          }
          j = localazyu.b(localMessage.frienduin);
          break label159;
        }
      }
      return i;
  ...
  public void b(QQMessageFacade.Message paramMessage)
  {
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      if (localObject != null)
      {
        ...
        localObject = new amii(paramMessage.frienduin, paramMessage.istroop, paramMessage.uniseq, paramMessage.msgUid, paramMessage.shmsgseq);
