...
public class aqvv
{
  ...
  public static String a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      if (paramInt3 == 3) {
        return ajjy.a(2131628180);
      }
      if (paramInt3 == 2) {
        return ajjy.a(2131628191);
      }
      if (paramInt3 == 1) {
        return ajjy.a(2131628210);
      }
      return ajjy.a(2131628202);
    }
    if (paramInt2 > 1) {
      return paramInt2 + ajjy.a(2131628200);
    }
    if (paramInt2 == 1) {
      return paramInt2 + ajjy.a(2131628224);
    }
    return ajjy.a(2131628202);
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2)
  {
    ...
    if (paramInt == 2) {
      str = babh.a(paramQQAppInterface, paramString2);
    }
    for (;;)
    {
      ...
      break;
      if (paramInt == 1) {
        str = babh.h(paramQQAppInterface, paramString1, paramString2);
      }
    }
  }
  ...
  public static void a(Activity paramActivity, int paramInt, String paramString)
  {
    ...
    localIntent.putExtra("url", befm.a(befm.a(befm.a(befm.a(QzoneConfig.getInstance().getConfig("H5Url", "YQHMusicPersonalPlayerUrl", "https://zb.vip.qq.com/v2/musicTheme"), "uin", paramString), "uinType", String.valueOf(paramInt)), "type", "2"), "_wv", "5123"));
    paramActivity.startActivity(localIntent);
    awqx.b(null, "dc00898", "", "", "qq_vip", "0X800A5C2", 1, 0, "", "", bajr.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()), "");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, int paramInt, String paramString)
  {
    ...
    paramQQAppInterface.putExtra("url", befm.a(befm.a(befm.a(befm.a("https://web.qun.qq.com/qunmusic/listener", "uin", paramString), "uinType", String.valueOf(paramInt)), "_wwv", "128"), "_wv", "2"));
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, String paramString, int paramInt2)
  {
    ...
    for (boolean bool = ((TroopInfo)localObject).isAdmin();; bool = false)
    {
      if (!bool)
      {
        ...
        {
          bbmy.a(BaseApplication.getContext(), 2131628196, 0).a();
          return;
        }
  ...
  {
    if (axmt.a(paramQQAppInterface).a(paramContext, 1, paramString, paramInt2)) {
      return;
    }
    Intent localIntent = new Intent(paramContext, QQBrowserActivity.class);
    String str2 = befm.a("https://web.qun.qq.com/qunmusic/index", "uin", paramString);
    ...
    if (!TextUtils.isEmpty(str3)) {
      str1 = befm.a(str2, "themeId", str3);
    }
    str2 = befm.a(str1, "uinType", String.valueOf(paramInt1));
    if (bool)
    {
      str1 = "1";
      str2 = befm.a(befm.a(befm.a(str2, "showlrc", str1), "_wv", "2"), "_wwv", "128");
      if (!localListenTogetherManager.b(paramInt1, paramString)) {
        break label260;
      }
      str1 = "1";
      label160:
      str2 = befm.a(befm.a(str2, "isJoin", str1), "from", String.valueOf(paramInt2));
    ...
    for (str1 = "1";; str1 = "0")
    {
      localIntent.putExtra("url", befm.a(str2, "isNew", str1));
