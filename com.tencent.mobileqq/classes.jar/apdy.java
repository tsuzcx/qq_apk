  ...
  extends ContentObserver
{
  ...
  apdw jdField_a_of_type_Apdw;
  
  public apdy(Handler paramHandler)
  {
    super(paramHandler);
  }
  
  public apdy(Handler paramHandler, long paramLong)
  {
    super(paramHandler);
    jdField_a_of_type_Long = paramLong;
  }
  
  private void b(Context paramContext, apdw paramapdw)
  {
  ...
  public void a(Context paramContext, apdw paramapdw)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((!(paramContext instanceof BaseActivity)) || (!a((BaseActivity)paramContext, paramapdw)));
      b(paramContext, paramapdw);
    } while (!QLog.isColorLevel());
    QLog.d("sms.content", 2, "register...");
  }
  
  @TargetApi(23)
  public boolean a(BaseActivity paramBaseActivity, apdw paramapdw)
  {
    if ((Build.VERSION.SDK_INT >= 23) && (paramBaseActivity.checkSelfPermission("android.permission.READ_SMS") != 0))
    {
      paramBaseActivity.requestPermissions(new apdz(this, paramBaseActivity, paramapdw), 1, new String[] { "android.permission.READ_SMS" });
      return false;
    }
    return true;
  }
  ...
  public void onChange(boolean paramBoolean)
  {
    ...
    //   5: aload_0
    //   6: getfield 40	apdy:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   9: ifnonnull +18 -> 27
    ...
    //   26: return
    //   27: aload_0
    //   28: getfield 40	apdy:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   39: getstatic 23	apdy:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   42: aconst_null
    //   43: aconst_null
    //   44: ldc 125
    ...
    //   207: getstatic 31	apdy:jdField_a_of_type_Long	J
    ...
    //   221: astore 4
    //   223: lload_2
    //   224: getstatic 31	apdy:jdField_a_of_type_Long	J
    //   227: lcmp
    //   228: iflt +41 -> 269
    //   231: aload 5
    //   233: astore 4
    //   235: aload_0
    //   236: getfield 42	apdy:jdField_a_of_type_Apdw	Lapdw;
    //   239: ifnull +30 -> 269
    //   242: aload 5
    //   244: astore 4
    //   246: aload_0
    //   247: getfield 42	apdy:jdField_a_of_type_Apdw	Lapdw;
    //   250: aload 6
    //   252: aload 7
    ...
    //   264: lload_2
    //   265: ladd
    //   266: putstatic 31	apdy:jdField_a_of_type_Long	J
    //   269: aload 5
    //   271: ifnull -245 -> 26
    //   274: aload 5
