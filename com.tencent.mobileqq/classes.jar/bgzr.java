  ...
  implements AsyncResult
{
  ...
  public void onReceiveResult(boolean paramBoolean, JSONObject paramJSONObject)
  {
    if ((paramBoolean) && (paramJSONObject != null))
    {
      ...
      {
        ((MiniAppInfo)localObject).launchParam.clone(bgzp.a(this.a).launchParam);
        ((MiniAppInfo)localObject).apkgInfo = bgzp.a(this.a).apkgInfo;
        ...
        for (;;)
        {
          ...
          bgzp.a(this.a, (MiniAppInfo)localObject);
          this.a.c();
          return;
