...
public class bgzr
{
  ...
  public static <T> T b(JSONObject paramJSONObject, Class<T> paramClass)
  {
    ...
    try
    {
      ...
      if ((localField.isAnnotationPresent(bgzu.class)) || (Modifier.isStatic(localField.getModifiers()))) {
        break label346;
      }
      if (localField.isAnnotationPresent(bgzs.class)) {
        paramClass = ((bgzs)localField.getAnnotation(bgzs.class)).a();
      }
    ...
    if (List.class.isAssignableFrom(localClass2))
    {
      ...
      if (!localField.isAnnotationPresent(bgzt.class)) {
        return null;
      }
      localClass1 = ((bgzt)localField.getAnnotation(bgzt.class)).a();
