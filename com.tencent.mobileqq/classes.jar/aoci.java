...
public class aoci
{
  ...
  {
    return avlm.a(a(paramQQAppInterface, paramLong1, paramLong2, paramLong3), paramUinPairMsg, paramQQAppInterface);
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    if ((str != null) && (str.equals(paramString1))) {
      return anzj.a(2131705514);
    }
    paramString2 = bhlg.a(paramQQAppInterface, paramString1, paramString2, 1, 0);
    if (paramString2 == paramString1)
    {
      paramQQAppInterface = ((anyw)paramQQAppInterface.getManager(51)).e(paramString1);
      if (paramQQAppInterface != null) {
        return bhlg.a(paramQQAppInterface);
      }
    }
    return paramString2;
  }
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    {
      localObject1 = bcrw.a((MessageForText)paramMessageRecord);
    ...
    while (localObject1 == null)
    {
      ...
      {
        localObject1 = bcrw.a((MessageForReplyText)paramMessageRecord);
      ...
      {
        localObject1 = bcrw.a((MessageForPic)paramMessageRecord);
        i = ((MessageForPic)paramMessageRecord).msgVia;
      }
      else if (paramMessageRecord.msgtype == -2002)
      {
        localObject1 = bcrw.a((MessageForPtt)paramMessageRecord);
        i = ((MessageForPtt)paramMessageRecord).msgVia;
      }
      else if (paramMessageRecord.msgtype == -2007)
      {
        localObject1 = bcrw.a((MessageForMarketFace)paramMessageRecord);
      ...
      {
        localObject1 = bcrw.a((MessageForApollo)paramMessageRecord);
        i = 0;
      }
      else if ((paramMessageRecord.msgtype == -2011) || (paramMessageRecord.msgtype == -2051) || (paramMessageRecord.msgtype == -7002))
      {
        localObject1 = bcrw.a((MessageForStructing)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2010)
      {
        localObject1 = bcrw.a((MessageForFunnyFace)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2020)
      {
        localObject1 = bcrw.a((MessageForShakeWindow)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2022)
      {
        localObject1 = bcrw.a((MessageForShortVideo)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2071)
      {
        localObject1 = bcrw.a((MessageForLightVideo)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5008)
      {
        localObject1 = bcrw.a((ChatMessage)paramMessageRecord, false);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5013)
      {
        localObject1 = bcrw.c((ChatMessage)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5014)
      {
        localObject1 = bcrw.d((ChatMessage)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5012)
      {
        localObject1 = bcrw.e((MessageForPoke)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5018)
      {
        localObject1 = bcrw.f((MessageForPokeEmo)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -1051)
      {
        localObject1 = bcrw.a((MessageForLongTextMsg)paramMessageRecord, true);
        i = 0;
      }
      ...
      {
        localObject1 = bcrw.a((MessageForMixedMsg)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2057)
      {
        localObject1 = bcrw.a((MessageForTroopStory)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -7001)
      {
        localObject1 = bcrw.g((MessageForScribble)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5016)
      {
        localObject1 = bcrw.c((MessageForArkBabyqReply)paramMessageRecord, false);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5017)
      {
        localObject1 = bcrw.b((MessageForArkApp)paramMessageRecord, false);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -7005)
      {
        localObject1 = bcrw.b((MessageForLimitChatConfirm)paramMessageRecord);
        i = 0;
      }
      else
      {
    ...
    if (nlj.a(paramMessageRecord))
    {
      ...
      localObject4 = nlj.a(paramMessageRecord);
      ((im_msg_body.AnonymousGroupMsg)localObject3).uint32_flags.set(((nlk)localObject4).jdField_a_of_type_Int);
      if (!TextUtils.isEmpty(((nlk)localObject4).jdField_a_of_type_JavaLangString)) {
        ((im_msg_body.AnonymousGroupMsg)localObject3).str_anon_id.set(ByteStringMicro.copyFrom(((nlk)localObject4).jdField_a_of_type_JavaLangString.getBytes()));
      }
      if (!TextUtils.isEmpty(((nlk)localObject4).jdField_b_of_type_JavaLangString)) {
        ((im_msg_body.AnonymousGroupMsg)localObject3).str_anon_nick.set(ByteStringMicro.copyFrom(((nlk)localObject4).jdField_b_of_type_JavaLangString.getBytes()));
      }
      ((im_msg_body.AnonymousGroupMsg)localObject3).uint32_head_portrait.set(((nlk)localObject4).jdField_b_of_type_Int);
      ((im_msg_body.AnonymousGroupMsg)localObject3).uint32_expire_time.set(((nlk)localObject4).jdField_c_of_type_Int);
      if (!TextUtils.isEmpty(((nlk)localObject4).jdField_c_of_type_JavaLangString)) {
        ((im_msg_body.AnonymousGroupMsg)localObject3).str_rank_color.set(ByteStringMicro.copyFrom(((nlk)localObject4).jdField_c_of_type_JavaLangString.getBytes()));
      }
    ...
    do
    {
      localObject2 = asam.a(paramMessageRecord);
      ...
      localObject2 = (apdc)paramQQAppInterface.getManager(199);
      if ((localObject2 != null) && (((apdc)localObject2).a()) && (((apdc)localObject2).a() == 1L) && ((paramMessageRecord.istroop == 1) || (paramMessageRecord.istroop == 3000)))
      {
        localObject2 = ((apdc)localObject2).a();
        if (localObject2 != null)
        {
      ...
      if (((anyw)paramQQAppInterface.getManager(51)).a)
      {
        if (QLog.isColorLevel()) {
      ...
      localObject1 = bcrw.a(paramQQAppInterface, paramMessageRecord, (im_msg_body.RichText)localObject1, i);
      if ((localObject1 != null) && ((paramMessageRecord instanceof MessageForStructing)))
      {
        ...
        if ((((MessageForStructing)localObject2).structingMsg != null) && (ubr.a(((MessageForStructing)localObject2).structingMsg)))
        {
      ...
      localObject4 = (anyw)paramQQAppInterface.getManager(51);
      ...
      {
        localObject3 = aqyt.b(paramMessageRecord);
    ...
    for (;;)
    {
      try
      {
        localObject2 = (String)axws.a(paramQQAppInterface.getCurrentAccountUin(), "self_nick", String.valueOf(""));
        k = ((Integer)axws.a(paramQQAppInterface.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1))).intValue();
        j = ((Integer)axws.a(paramQQAppInterface.getCurrentAccountUin(), "self_age", Integer.valueOf(-1))).intValue();
        if ((j >= 0) && (k >= 0)) {
          continue;
        }
        localFriends = ((anyw)localObject4).e(paramQQAppInterface.getCurrentAccountUin());
      ...
      if (paramMessageRecord.msgtype == -2011)
      {
        ...
        k = 0;
        continue;
        localObject4 = ((anyw)localObject4).b(paramQQAppInterface.getCurrentAccountUin());
      ...
      if ((paramMessageRecord.istroop == 1033) || (paramMessageRecord.istroop == 1034))
      {
        ...
        aqyt.a(localElem, paramMessageRecord);
      ...
      {
        localElem = aqyt.a(paramMessageRecord);
        if (localElem != null) {
          ((im_msg_body.RichText)localObject1).elems.add(localElem);
        }
        if (!QLog.isColorLevel()) {
      ...
      avlm.a(localElem, paramMessageRecord);
      ((im_msg_body.RichText)localObject1).elems.add(localElem);
      if (!QLog.isColorLevel()) {
        break label1073;
      }
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, ArrayList<String> paramArrayList, aear paramaear)
  {
    int i = 0;
    Object localObject1;
    boolean bool1;
    ...
    do
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandlerUtils", 2, String.format("getPbSendReqFromBlessMsg, hongbao param, temp_id: %d, video_len: %d, redbag_id: %s, redbag_amount: %d, has_readbag: %d, has_video: %d", new Object[] { Long.valueOf(paramaear.jdField_a_of_type_Long), Long.valueOf(paramaear.jdField_b_of_type_Long), paramaear.jdField_a_of_type_ArrayOfByte, Long.valueOf(paramaear.c), Integer.valueOf(paramaear.jdField_a_of_type_Int), Integer.valueOf(paramaear.jdField_b_of_type_Int) }));
        }
        ((msg_svc.MultiMsgAssist)localObject1).uint64_temp_id.set(paramaear.jdField_a_of_type_Long);
        ((msg_svc.MultiMsgAssist)localObject1).uint64_vedio_len.set(paramaear.jdField_b_of_type_Long);
        ((msg_svc.MultiMsgAssist)localObject1).uint32_has_readbag.set(paramaear.jdField_a_of_type_Int);
        if (paramaear.jdField_a_of_type_Int == 1)
        {
          if (paramaear.jdField_a_of_type_ArrayOfByte != null) {
            ((msg_svc.MultiMsgAssist)localObject1).bytes_redbag_id.set(ByteStringMicro.copyFrom(paramaear.jdField_a_of_type_ArrayOfByte));
          }
          ((msg_svc.MultiMsgAssist)localObject1).uint64_redbag_amount.set(paramaear.c);
        }
        ((msg_svc.MultiMsgAssist)localObject1).uint32_has_vedio.set(paramaear.jdField_b_of_type_Int);
      }
      int j = bcsa.a(paramMessageRecord.msgUid);
      int k = (short)(int)paramMessageRecord.msgseq;
      paramArrayList = paramQQAppInterface.a().a();
      paramaear = new msg_svc.PbSendMsgReq();
      paramaear.msg_body.set((MessageMicro)localObject2);
      paramaear.msg_seq.set(k & 0xFFFF);
      paramaear.msg_rand.set(j);
      paramaear.msg_via.set(i);
      paramaear.multi_msg_assist.set((MessageMicro)localObject1);
      if (paramArrayList != null) {
        paramaear.sync_cookie.set(ByteStringMicro.copyFrom(paramArrayList));
      }
      paramArrayList = paramaear;
    } while (paramaear == null);
    label257:
    label263:
    a(paramQQAppInterface, paramMessageRecord, paramaear);
    return paramaear;
  }
  ...
  private static im_msg_body.GeneralFlags a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq)
  {
    ...
    Object localObject1 = paramMessageRecord.getExtInfoFromExtStr(bcrn.jdField_c_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      catch (Exception localException2)
      {
        ...
        localGeneralFlags.babyq_guide_msg_cookie.set(ByteStringMicro.copyFrom(paramQQAppInterface.toByteArray()));
        return localGeneralFlags;
        paramQQAppInterface = bhjx.a(paramMessageRecord.msg);
        if (paramQQAppInterface == null) {
          continue;
        }
      ...
      if (paramPbSendMsgReq != null)
      {
        ...
        localObject2 = (aogu)paramQQAppInterface.a(13);
        k = ((aogu)localObject2).d();
        m = ((aogu)localObject2).b();
        if (m <= 0) {
          break label3296;
        }
        localObject1 = ((BubbleManager)localObject1).a(m, false);
        if ((localObject1 != null) && ((localObject1 == null) || (((aqkq)localObject1).a == null) || (((aqkq)localObject1).a.size() <= 0))) {
          break label2164;
        }
      }
      label1866:
        ...
        for (j = k;; j = 0) {
          for (;;)
          {
            ...
            if ((paramMessageRecord instanceof MessageForFoldMsg))
            {
              i1 = i;
              n = j;
              if (akwu.a(paramQQAppInterface))
              {
                bool = akwu.b(paramQQAppInterface);
                localObject2 = (akwu)paramQQAppInterface.getManager(125);
                ...
                if (((MessageForFoldMsg)localObject1).redBagId != null)
                {
                  k = i;
                  m = j;
                  if (akwu.b(paramQQAppInterface))
                  {
                    n = 1;
                    i1 = 1;
                    if ((!bool) || (((akwu)localObject2).e)) {
                      break label2170;
                    }
                    i = 1;
                    label1018:
            ...
            if ((paramMessageRecord instanceof MessageForLongTextMsg))
            {
              ...
              localObject1 = ((anyw)paramQQAppInterface.getManager(51)).a(paramQQAppInterface.c());
              k = j;
              j = i;
              if (localObject1 != null)
              {
                ...
                m = 1;
                localResvAttr.uint32_mobile_custom_font.set(gc.a((ExtensionInfo)localObject1));
              ...
              for (;;)
              {
                ...
                try
                {
                  ...
                  if ((k & 0x1) == 1)
                  {
                    ...
                    if (!((bgty)paramQQAppInterface.getManager(203)).a(paramMessageRecord)) {
                      break label2338;
                    }
                    ...
                    bcrw.a(paramPbSendMsgReq, ((MessageForPtt)localObject1).mInputContent, ((MessageForPtt)localObject1).atInfoList);
                    i = k;
                ...
                catch (NumberFormatException localNumberFormatException)
                {
                  ...
                  {
                    k = i;
                    if (aiyz.b((MessageForPic)paramMessageRecord))
                    {
                      i = 1;
                  ...
                  catch (Exception paramQQAppInterface)
                  {
                    try
                    {
                      ...
                      localResvAttr.bytes_pb_ptt_waveform.set(ByteStringMicro.copyFrom(bhoi.a(paramQQAppInterface.waveformArray).toByteArray()));
  ...
  private static im_msg_body.RichText a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    Iterator localIterator = paramQQAppInterface.a().a().d().iterator();
    while (localIterator.hasNext())
    {
      im_msg_body.RichText localRichText = ((adbo)localIterator.next()).a(paramMessageRecord, paramQQAppInterface);
  ...
  protected static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq)
  {
    ...
    Object localObject = (aogu)paramQQAppInterface.a(13);
    int j = ((aogu)localObject).d();
    paramQQAppInterface = (BubbleManager)paramQQAppInterface.getManager(44);
    int n = ((aogu)localObject).b();
    boolean bool;
    if (n > 0)
    {
      paramQQAppInterface = paramQQAppInterface.a(n, false);
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.MessageHandlerUtils", 2, "bubbleId->" + n + " needSend->" + bool);
      }
      if ((paramPbSendMsgReq.msg_body.has()) && (((im_msg_body.MsgBody)paramPbSendMsgReq.msg_body.get()).rich_text.has()))
      {
        ...
        if ((paramQQAppInterface.elems != null) && (paramQQAppInterface.elems.has()))
        {
          ...
          if ((!bool) || ((j > 0) && ((i + 7 >= j) || (j <= 0))) || (paramMessageRecord.vipBubbleDiyTextId <= 0)) {
            break label465;
          }
          paramPbSendMsgReq.uint32_bubble_diy_text_id.set(paramMessageRecord.vipBubbleDiyTextId);
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.MessageHandlerUtils", 2, "add BubbleDiyTextId!");
          }
        }
      ...
      for (i = 1;; i = 0)
      {
        ...
        if ((paramMessageRecord instanceof MessageForShortVideo))
        {
          ...
          {
            ((generalflags.ResvAttr)localObject).uint32_red_envelope_type.set(paramMessageRecord.redBagType);
            ((generalflags.ResvAttr)localObject).bytes_shortVideoId.set(ByteStringMicro.copyFromUtf8(paramMessageRecord.shortVideoId));
  ...
  private static void a(MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq, QQAppInterface paramQQAppInterface)
  {
    Iterator localIterator = paramQQAppInterface.a().a().d().iterator();
    while (localIterator.hasNext()) {
      ((adbo)localIterator.next()).a(paramMessageRecord, paramPbSendMsgReq, paramQQAppInterface);
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((localMessageRecord != null) && (localMessageRecord.msgtype == paramMessageRecord.msgtype) && (bhjx.a(localMessageRecord.msg, paramMessageRecord.msg)))
        {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((paramMessageRecord.istroop == 1) || (paramMessageRecord.istroop == 1026) || (paramMessageRecord.istroop == 3000))
      {
        if ((localObject != null) && (((List)localObject).size() > 0))
        {
          ...
          while (((Iterator)localObject).hasNext()) {
            if (adak.a((MessageRecord)((Iterator)localObject).next(), paramMessageRecord, false, paramBoolean))
            {
              if ((QLog.isColorLevel()) && (localStringBuilder != null))
              {
      ...
      else if (adak.d(paramMessageRecord.istroop))
      {
        if ((localObject != null) && (((List)localObject).size() > 0))
        {
          localObject = ((List)localObject).iterator();
          while (((Iterator)localObject).hasNext()) {
            if (adak.a((MessageRecord)((Iterator)localObject).next(), paramMessageRecord, paramBoolean))
            {
              if ((QLog.isColorLevel()) && (localStringBuilder != null))
              {
      ...
      else if (paramMessageRecord.istroop == 7220)
      {
        if ((localObject != null) && (((List)localObject).size() > 0))
        {
          ...
          } while (!adak.a((MessageRecord)paramQQAppInterface.next(), paramMessageRecord, true));
          if ((QLog.isColorLevel()) && (localStringBuilder != null))
          {
            localStringBuilder.append(" filterType: other");
            QLog.w("Q.msg.MessageHandlerUtils", 2, localStringBuilder.toString());
