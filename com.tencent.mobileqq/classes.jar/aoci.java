  ...
  extends GestureDetector
{
  ...
  Animator.AnimatorListener jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new aocj(this);
  Context jdField_a_of_type_AndroidContentContext;
  Rect jdField_a_of_type_AndroidGraphicsRect;
  View jdField_a_of_type_AndroidViewView;
  ImageView jdField_a_of_type_AndroidWidgetImageView;
  aocm jdField_a_of_type_Aocm = new aocm(this, null);
  ...
  public aoci(Context paramContext, GestureDetector.SimpleOnGestureListener paramSimpleOnGestureListener, BaseChatPie paramBaseChatPie)
  {
    ...
    for (int i1 = 0;; i1 = ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      if (!(paramBaseChatPie instanceof aeoe)) {
        break;
      }
  ...
  private String a(aocb paramaocb)
  {
    if (paramaocb.jdField_a_of_type_ComTencentMobileqqDataEmoticon == null)
    {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) {
      try
      {
        int i1 = Integer.parseInt(paramaocb.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
        int i2 = Integer.parseInt(paramaocb.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId);
        paramaocb = anqu.a(i2, i1);
        EmoticonPackage localEmoticonPackage = ((askd)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(String.valueOf(i2));
        char[] arrayOfChar = new char[5];
        arrayOfChar[0] = '\024';
        arrayOfChar[1] = paramaocb[3];
        arrayOfChar[2] = paramaocb[2];
        arrayOfChar[3] = paramaocb[1];
        arrayOfChar[4] = paramaocb[0];
        if ((localEmoticonPackage != null) && (localEmoticonPackage.isAPNG == 2)) {
          arrayOfChar[1] = 'ǿ';
        }
        paramaocb = new StringBuilder(String.valueOf(arrayOfChar));
        EmojiStickerManager.a(paramaocb);
        return paramaocb.toString();
      }
  ...
  private void e()
  {
    ...
    bbcv.a(this.jdField_a_of_type_AndroidContentContext, 230).setTitle(ajyc.a(2131714385)).setMessage(ajyc.a(2131714378)).setPositiveButton(ajyc.a(2131714384), new aocl(this)).setNegativeButton("取消", new aock(this)).show();
    int i1;
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
    {
  ...
  void a(float paramFloat1, float paramFloat2)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView != null))
    {
      ...
      localViewPropertyAnimator.setListener(this.jdField_a_of_type_Aocm);
  ...
  void a(View paramView, boolean paramBoolean)
  {
    ...
    if (paramView != null)
    {
      localambh = (ambh)paramView.getTag(2131363708);
      localObject = (ChatMessage)paramView.getTag(2131364153);
      bool = false;
      if (localObject != null) {
      ...
      if (localambh != null)
      {
        ...
        ((amcz)localObject).b(paramBoolean);
      }
    }
    label77:
    ...
    {
      if (bool) {}
      for (i1 = 2130848928;; i1 = 2130848752)
      {
        ...
        localambh.a(paramView, (Drawable)localObject);
        return;
      }
    }
    if (bool) {}
    for (int i1 = 2130848929;; i1 = 2130848753)
    {
      localObject = ((Resources)localObject).getDrawable(i1);
      break label112;
      break;
  ...
  void a(String paramString)
  {
    ...
    bcpw.a(this.jdField_a_of_type_AndroidContentContext, paramString, 0).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298865));
  }
  ...
  boolean a()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout != null)
    {
      ...
      while (i1 >= 0)
      {
        ...
        if (((View)localObject).getId() == 2131372889)
        {
          ...
          double d1;
          if (((localObject instanceof aobk)) || ((localObject instanceof Emoticon)) || ((localObject instanceof aoau)))
          {
            this.s = 1;
          ...
          {
            return true;
            if ((!(localObject instanceof aocp)) && (!(localObject instanceof aocb))) {
              break;
            }
            this.s = 0;
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
    {
      ...
      {
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131372924);
          ...
          for (;;)
          {
            ...
            if ((localObject1 instanceof BaseChatItemLayout))
            {
              ...
              if (i1 >= 0)
              {
                ...
                if ((localObject3 != null) && (((View)localObject3).getId() == 2131364110))
                {
            ...
            for (;;)
            {
              ...
              if ((this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getTag(2131372925) instanceof Integer)) {
                i1 = ((Integer)this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getTag(2131372925)).intValue();
              }
              ...
              {
                localObject1 = (aocp)localObject1;
                if (((aocp)localObject1).jdField_a_of_type_Int == 1)
                {
                  this.t = 2;
                  break label1902;
                }
                if (((aocp)localObject1).jdField_a_of_type_Int != 2) {
                  break label1902;
                }
                this.t = 3;
                break label1902;
              }
              if ((localObject1 instanceof aocb))
              {
                this.t = 4;
                break label1902;
              }
              if (!(localObject1 instanceof aoau)) {
                break label1902;
              }
              this.t = 5;
              break label1902;
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                Object localObject4;
                aoau localaoau;
                if ((paramMotionEvent instanceof aobk))
                {
                  localObject1 = (aobk)paramMotionEvent;
                  localObject2 = null;
                  localObject4 = null;
                  localObject3 = null;
                  localaoau = null;
                ...
                for (;;)
                {
                  label2921:
                  View localView;
                  if ((!EmojiStickerManager.f) && (bbdj.a() > 1.048576E+008F))
                  {
                    i1 = 1;
                    paramMotionEvent = null;
                    if ((localObject1 == null) || (((aobk)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon == null)) {
                      break label3566;
                    }
                    if (i1 == 0) {
                      break label3549;
                    }
                    paramMotionEvent = ((aobk)localObject1).a("fromAIO", true, false, null, (int)(this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getWidth() * this.jdField_b_of_type_Double), (int)(this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getHeight() * this.jdField_b_of_type_Double));
                    ...
                    if ((localView == null) || (localView.getId() != 2131364110)) {
                      break label7828;
                    }
                    ...
                    localObject6 = (ChatMessage)localView.getTag(2131364153);
                  ...
                  for (;;)
                  {
                    ...
                    if (i2 != 0)
                    {
                      ...
                      if ((paramMotionEvent instanceof aocp))
                      {
                        localObject4 = (aocp)paramMotionEvent;
                        localObject2 = null;
                        localObject3 = null;
                        localaoau = null;
                        localObject1 = null;
                      ...
                      if ((paramMotionEvent instanceof aocb))
                      {
                        localObject2 = (aocb)paramMotionEvent;
                        localObject4 = null;
                        localObject3 = null;
                        localaoau = null;
                        localObject1 = null;
                      ...
                      if (!(paramMotionEvent instanceof aoau)) {
                        break label8000;
                      }
                      localaoau = (aoau)paramMotionEvent;
                      localObject2 = null;
                      localObject4 = null;
                      localObject3 = null;
                      localObject1 = null;
                      ...
                      break label2921;
                      label3549:
                      paramMotionEvent = ((aobk)localObject1).a(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float);
                      break label2981;
                      label3566:
                      if (localObject4 != null)
                      {
                        paramMotionEvent = ((aocp)localObject4).b(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float);
                        break label2981;
                      }
                      ...
                      if (localObject2 != null)
                      {
                        paramMotionEvent = ((aocb)localObject2).b(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float);
                        break label2981;
                      }
                      if (localaoau == null) {
                        break label2981;
                      }
                      paramMotionEvent = localaoau.b(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float, 0, 0);
                      break label2981;
                    ...
                    for (;;)
                    {
                      if ((localObject6 != null) && (((ChatMessage)localObject6).extraflag != 32772) && (((ChatMessage)localObject6).extraflag != 32768) && (bool3) && (bool4) && (((ChatMessage)localObject6).msgtype != -2009) && (((ChatMessage)localObject6).msgtype != -2016) && (!(localObject6 instanceof MessageForLongMsg)) && (!(localObject6 instanceof MessageForLongTextMsg)) && (bool2) && (i5 != 0) && (i4 == 0) && (i3 == 0) && (i1 == 0))
                      {
                        ...
                        if ((localObject1 != null) && (((aobk)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon != null))
                        {
                          localObject5 = ((aobk)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId;
                          if (f2 - i16 + this.r <= i8) {
                            break label4786;
                          }
                        ...
                        for (;;)
                        {
                          ...
                          if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (localObject5 != null))
                          {
                            ...
                            if (bool1)
                            {
                              ...
                              if (localObject1 != null)
                              {
                                ((aobk)localObject1).jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerInfo = ((EmojiStickerManager.StickerInfo)localObject6);
                                ((ChatMessage)localObject5).stickerHidden = false;
                                this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a((anyc)localObject1);
                              }
                              do
                              {
                                for (;;)
                                {
                                  ...
                                  if (localObject3 != null)
                                  {
                                    aaod.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (Emoticon)localObject3, (EmojiStickerManager.StickerInfo)localObject6);
                                  }
                                  else
                                  {
                                    if (localObject4 != null)
                                    {
                                      if (((aocp)localObject4).jdField_a_of_type_Int == 1) {}
                                      for (paramMotionEvent = ayla.c(((aocp)localObject4).jdField_b_of_type_Int);; paramMotionEvent = ayla.a(((aocp)localObject4).jdField_b_of_type_Int))
                                      {
                                    ...
                                    paramMotionEvent = a((aocb)localObject2);
                                    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(paramMotionEvent, (EmojiStickerManager.StickerInfo)localObject6);
                                  }
                                }
                              } while (localaoau == null);
                              ...
                              localObject5 = localaoau.d;
                              if (!TextUtils.isEmpty(localaoau.c)) {}
                              for (bool1 = true;; bool1 = false)
                              {
                                aaod.a(paramMotionEvent, (Context)localObject2, (SessionInfo)localObject4, (String)localObject5, true, bool1, localaoau.c, (EmojiStickerManager.StickerInfo)localObject6);
                                break;
                              }
                              label6137:
                              ...
                              a(String.format(ajyc.a(2131714387), new Object[] { Integer.valueOf(EmojiStickerManager.jdField_e_of_type_Int) }));
