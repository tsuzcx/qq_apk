...
public class biah
{
  ...
  public static Drawable a(int paramInt1, int paramInt2, bial parambial)
  {
    if (a.containsKey(Integer.valueOf(paramInt1))) {
      return biai.a().a("http://qzonestyle.gtimg.cn/qzone/phone/n/QQ-Qzone-Android/qzone_yellow_icon_v6.zip", paramInt2, (String)a.get(Integer.valueOf(paramInt1)), parambial);
    }
    switch (paramInt1)
    {
    default: 
    ...
    return BaseApplicationImpl.getContext().getResources().getDrawable(2130848335);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, bial parambial)
  {
    return a(paramString, paramInt1, paramInt2, paramInt3, parambial, 0);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, bial parambial, int paramInt4)
  {
    switch (paramInt4)
    {
    }
    ...
    {
      return null;
      biai.a().a(paramString, paramInt1, "border", parambial);
      continue;
      switch (paramInt3)
      {
      }
    }
    return biai.a().a(paramString, paramInt1, "head", parambial);
    return biai.a().a(paramString, paramInt1, "bottom_lv" + paramInt2, parambial);
    return biai.a().a(paramString, paramInt1, "right", parambial);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4, bial parambial)
  {
    String str = a(paramInt1, paramInt3, paramBoolean, paramInt4);
    if (!TextUtils.isEmpty(str)) {
      return biai.a().a(paramString, paramInt2, str, true, parambial);
    }
    return null;
  }
