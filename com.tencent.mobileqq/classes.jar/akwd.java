  ...
  implements Manager
{
  ...
  public final long a;
  private akwc jdField_a_of_type_Akwc = new akwc(BaseApplicationImpl.getApplication());
  ...
  private BusinessObserver jdField_a_of_type_MqqObserverBusinessObserver = new akwf(this);
  public long b;
  ...
  private void a(int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_Akwc.c(this.jdField_a_of_type_JavaUtilArrayList);
      this.jdField_a_of_type_JavaUtilArrayList.clear();
    }
    if (this.jdField_b_of_type_JavaUtilArrayList.size() > 0)
    {
      this.jdField_a_of_type_Akwc.b(this.jdField_b_of_type_JavaUtilArrayList);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        else
        {
          ...
          NewIntent localNewIntent = new NewIntent(paramList.getApplication(), akwg.class);
  ...
  private void a(boolean paramBoolean)
  {
    ...
    //   4: putfield 246	akwd:jdField_b_of_type_Long	J
    //   7: aload_0
    //   8: getfield 248	akwd:jdField_b_of_type_Boolean	Z
    //   11: ifeq +4 -> 15
    //   14: return
    //   15: getstatic 28	akwd:jdField_b_of_type_ArrayOfByte	[B
    //   18: astore_2
    //   19: aload_2
    //   20: monitorenter
    ...
    //   52: aload_0
    //   53: iconst_1
    //   54: putfield 248	akwd:jdField_b_of_type_Boolean	Z
    //   57: iconst_1
    //   58: putstatic 86	akwd:jdField_a_of_type_Boolean	Z
    //   61: new 255	com/tencent/mobileqq/activity/qwallet/report/VACDReportMgr$1
    //   64: dup
    //   65: aload_0
    //   66: invokespecial 256	com/tencent/mobileqq/activity/qwallet/report/VACDReportMgr$1:<init>	(Lakwd;)V
    //   69: bipush 10
    //   71: aconst_null
    //   72: iconst_0
    ...
    //   77: ifne +11 -> 88
    //   80: aload_0
    //   81: invokespecial 264	akwd:d	()V
    //   84: aload_0
    //   85: invokespecial 266	akwd:c	()V
    //   88: aload_0
    //   89: iload_1
    //   90: invokespecial 268	akwd:b	(Z)V
    //   93: aload_2
    //   94: monitorexit
    //   95: return
    //   96: astore_3
    ...
    //   112: aload_0
    //   113: invokevirtual 277	akwd:onDestroy	()V
    //   116: goto -23 -> 93
  ...
  private void c()
  {
    if (this.jdField_c_of_type_AndroidOsHandlerThread == null)
    {
      ...
      this.jdField_c_of_type_AndroidOsHandler = new akwe(this, this.jdField_c_of_type_AndroidOsHandlerThread.getLooper());
    }
  }
