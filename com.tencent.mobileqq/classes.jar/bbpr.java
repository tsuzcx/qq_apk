  ...
  extends bbpp
{
  ...
  private void a(long paramLong, int paramInt1, int paramInt2, int paramInt3, String paramString, RichMediaBrowserInfo paramRichMediaBrowserInfo)
  {
    ...
    else
    {
      ...
      str = new bbpj().a((AIOFilePictureData)paramRichMediaBrowserInfo.baseData, 20);
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        catch (Throwable localThrowable)
        {
          ...
          continue;
          GalleryUrlImageView localGalleryUrlImageView = (GalleryUrlImageView)this.jdField_a_of_type_Bbqq.mBrowserItemView.findViewById(2131368320);
          if (localGalleryUrlImageView == null) {
            break label399;
          }
          localGalleryUrlImageView.setGalleryImageListener(new bbps(this, paramString, paramRichMediaBrowserInfo));
          localGalleryUrlImageView.setImageDrawable(paramString);
          this.jdField_a_of_type_Bbqq.a = agej.a(this.jdField_a_of_type_Bbqq.b, paramString);
        }
        if (paramString != null) {
          continue;
        }
        QQToast.a(this.jdField_a_of_type_Bbqq.mContext, this.jdField_a_of_type_Bbqq.mContext.getString(2131694455), 0).a();
        return;
    ...
    {
      if (!this.jdField_a_of_type_Bbqq.mContext.getString(2131692472).equals(paramString)) {
        break label480;
      }
      QQToast.a(this.jdField_a_of_type_Bbqq.mContext, paramString, 0).a();
    }
    for (;;)
    {
  ...
  public Intent a(AIOFilePictureData paramAIOFilePictureData, Activity paramActivity)
  {
    ...
    if ((paramAIOFilePictureData != null) && (RichMediaBrowserManager.getInstance().getProvider() != null) && (RichMediaBrowserManager.getInstance().getProvider().isPingBinder()))
    {
      ...
      if (localIntent != null)
      {
        ...
        for (;;)
        {
          bbqh.a(paramActivity, localIntent, bool);
  ...
  public void a(int paramInt, URLDrawable paramURLDrawable)
  {
    if (paramURLDrawable != null)
    {
      ...
      if ((this.jdField_a_of_type_Bbqq != null) && (paramInt == getCurrentPosition())) {
        this.jdField_a_of_type_Bbqq.bindView(paramInt);
      }
    }
  }
    ...
    if ((localObject2 != null) && (((RichMediaBrowserInfo)localObject2).baseData != null) && (((AIOBrowserBaseData)((RichMediaBrowserInfo)localObject2).baseData).jdField_a_of_type_Long == paramLong))
    {
      ...
      if ((this.mainBrowserPresenter != null) && (this.mainBrowserPresenter.browserModel != null))
      {
        ...
        if ((paramInt3 == 2) && (!TextUtils.isEmpty(paramString))) {
          new bbpj().b((AIOFilePictureData)((RichMediaBrowserInfo)localObject2).baseData, paramInt2, paramString);
        }
        this.jdField_a_of_type_Bbqq.updateView(paramInt1, this.jdField_a_of_type_Bbqq.mBrowserItemView, paramBoolean);
  ...
  public void b()
  {
    if ((this.jdField_a_of_type_Bbpq != null) && (this.jdField_a_of_type_Bbpq.a != null) && (this.jdField_a_of_type_Bbpq.a() != null))
    {
      ...
      this.jdField_a_of_type_Bbpq.a().a((int)agej.a(LiuHaiUtils.jdField_a_of_type_Int, this.jdField_a_of_type_Bbqq.mContext.getResources()) + 40);
    }
    for (;;)
    {
      this.jdField_a_of_type_Bbpq.a().c();
      this.jdField_a_of_type_Bbpq.a().e();
      this.jdField_a_of_type_Bbpq.a.a();
      return;
      label101:
      this.jdField_a_of_type_Bbpq.a().a(40);
    }
  }
  ...
  {
    super.onDestroy();
    if (this.jdField_a_of_type_Bbqq.a != null) {
      this.jdField_a_of_type_Bbqq.b.removeCallbacks(this.jdField_a_of_type_Bbqq.a);
    }
  }
  ...
  public void setGalleryView(BrowserBaseView paramBrowserBaseView)
  {
    ...
    if ((paramBrowserBaseView instanceof bbqq)) {
      this.jdField_a_of_type_Bbqq = ((bbqq)paramBrowserBaseView);
    }
  }
}
