...
public class bplm
  implements bpip<bphy>
{
  int jdField_a_of_type_Int;
  long jdField_a_of_type_Long;
  int b;
  
  private bplm(DoodleLayout paramDoodleLayout) {}
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    ((AlphaAnimation)localObject).setAnimationListener(new bpln(this));
    ...
    localAlphaAnimation.setAnimationListener(new bplo(this));
    if (paramBoolean2) {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_Bplg != null) {
        this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_Bplg.b((Animation)localObject);
      }
      return;
    }
  }
  
  public boolean a(bphy parambphy, MotionEvent paramMotionEvent)
  {
    bpwg localbpwg = this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout.jdField_a_of_type_DovComTencentBizQqstoryTakevideoViewWidgetColorbarHorizontalSelectColorLayout.a();
    if (localbpwg != null) {}
    int i;
    int j;
    switch (localbpwg.jdField_a_of_type_Int)
    {
    default: 
    ...
    do
    {
      do
      {
        do
        {
          return false;
          i = localbpwg.b;
          if (i != bpmz.jdField_a_of_type_Int) {
          ...
          for (;;)
          {
            localObject = (bpmz)parambphy.a(101);
            if (localObject != null) {
              ((bpmz)localObject).a(i);
            }
            if (parambphy.b()) {
              break;
            }
          ...
          parambphy.a((AppInterface)localObject, 2, localbpwg.b);
          break;
