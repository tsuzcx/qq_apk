  ...
  extends bdsu
{
  ...
  protected int a;
  protected long a;
  anqd jdField_a_of_type_Anqd = new bdyu(this);
  protected anuz a;
  ...
  public boolean b;
  protected int c;
  bdsz jdField_e_of_type_Bdsz = new bdsz();
  ...
  public bdyr(bdzi parambdzi, bdzn parambdzn)
  {
    ...
    for (this.x = ((MessageForShortVideo)this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).busiType;; this.x = 0)
    {
      if (!this.jdField_a_of_type_Bdzn.jdField_i_of_type_Boolean)
      {
        parambdzi = this.jdField_a_of_type_Bdzn.jdField_i_of_type_JavaLangString;
        parambdzn = parambdzi.split("QQ_&_MoblieQQ_&_QQ");
        if (4 == parambdzn.length) {
          break;
        }
        if (QLog.isColorLevel()) {
          QLog.d("ShortVideoUploadProcessor", 2, "path was not set correctlly------path = " + parambdzi);
        }
    ...
    this.jdField_a_of_type_Bdzn.jdField_i_of_type_JavaLangString = parambdzn[0];
    this.jdField_a_of_type_JavaLangString = parambdzn[1];
    this.jdField_c_of_type_Int = Integer.parseInt(parambdzn[2]);
    if (QLog.isColorLevel()) {
      QLog.d("ShortVideoUploadProcessor", 2, "Init params videoTime : " + this.jdField_c_of_type_Int);
    }
    this.jdField_a_of_type_ArrayOfByte = HexUtil.hexStr2Bytes(parambdzn[3]);
  }
  ...
  private becj a()
  {
    ...
    String str;
    int j;
    if ((this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) && ((this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForBlessPTV)))
    {
      Object localObject = (MessageForBlessPTV)this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;
      if (((MessageForBlessPTV)localObject).uinList != null)
      {
        str = (String)((MessageForBlessPTV)localObject).uinList.get(0);
        localbecj.jdField_d_of_type_JavaLangString = str;
        localbecj.k = 1;
        if (((MessageForBlessPTV)localObject).uinList == null) {
          break label450;
        }
        ...
        localObject = new File(this.jdField_a_of_type_Bdzn.jdField_i_of_type_JavaLangString);
        str = ((File)localObject).getName();
        localbecj.jdField_a_of_type_JavaLangString = str;
        ...
        localbecj.jdField_b_of_type_ArrayOfByte = this.jdField_a_of_type_ArrayOfByte;
        localbecj.jdField_e_of_type_Int = this.jdField_a_of_type_Int;
        localbecj.jdField_d_of_type_Int = this.jdField_b_of_type_Int;
        localbecj.h = this.jdField_c_of_type_Int;
        localbecj.jdField_b_of_type_Long = this.jdField_a_of_type_Long;
        localObject = this.jdField_a_of_type_Bduk;
        long l = localbecj.jdField_a_of_type_Long + this.jdField_a_of_type_Long;
    ...
    label450:
    label597:
    for (localbecj.jdField_j_of_type_Int = ((MessageForShortVideo)this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).busiType;; localbecj.jdField_j_of_type_Int = 0)
    {
      this.x = localbecj.jdField_j_of_type_Int;
      return localbecj;
      str = "0";
      break;
      j = 1;
      break label121;
      if ((this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) && (((MessageForShortVideo)this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).CheckIsHotVideo()))
      {
    ...
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          ((im_msg_body.Text)localObject3).str.set(ByteStringMicro.copyFromUtf8(anni.a(2131712854)));
        ...
        localVideoFile.bytes_file_md5.set(ByteStringMicro.copyFrom(HexUtil.hexStr2Bytes(this.jdField_a_of_type_Bdzn.jdField_f_of_type_JavaLangString)));
        continue;
        localObject3 = "";
      }
  ...
  private void a(bcfn parambcfn, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    bard localbard;
    int j;
    if (parambcfn != null)
    {
      localbard = new bard(BaseApplication.getContext());
      j = 2002;
    ...
    for (;;)
    {
      if ((parambcfn.jdField_i_of_type_JavaLangString == null) || (parambcfn.jdField_i_of_type_JavaLangString.length() <= 0)) {
        parambcfn.jdField_i_of_type_JavaLangString = parambcfn.h;
      }
      localbard.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, parambcfn.jdField_i_of_type_JavaLangString, j, paramMessageRecord.istroop, paramMessageRecord.frienduin, false, paramBoolean, -1, null, parambcfn.f, parambcfn.jdField_e_of_type_JavaLangString);
      return;
      j = 2002;
      continue;
      j = 2001;
  ...
  private void a(im_msg_body.RichText paramRichText, bcfn parambcfn, boolean paramBoolean)
  {
    MessageRecord localMessageRecord;
    if (this.jdField_a_of_type_Bdzn.jdField_a_of_type_Ayyt != null)
    {
      localMessageRecord = this.jdField_a_of_type_Bdzn.jdField_a_of_type_Ayyt.a(paramRichText);
      if ((localMessageRecord != null) && ((localMessageRecord instanceof MessageForShortVideo))) {
        break label174;
      }
      parambcfn = new StringBuilder().append("Mr_");
    ...
    {
      a(9368, "msgtypeError", paramRichText, this.jdField_c_of_type_Bdsz);
      d();
      return;
    ...
    if ((localMessageRecord instanceof MessageForBlessPTV))
    {
      ...
      ayxi.a("ShortVideoUploadProcessor", "updataMessageDataBaseContent", "notifyUI bless ptv data send finished");
      return;
    }
    if ((localMessageRecord instanceof MessageForDanceMachine))
    {
      ...
      ayxi.a("ShortVideoUploadProcessor", "updataMessageDataBaseContent", "notifyUI dance machine data send finished");
      return;
    }
    if (!e())
    {
    ...
    bgnl.a(String.valueOf(this.jdField_a_of_type_Bdzn.jdField_a_of_type_Long), "message", "sendMsg() []. mr = " + localMessageRecord.toString());
    ((bauy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(326)).a(localMessageRecord, this.jdField_a_of_type_Anqd);
    a(parambcfn, localMessageRecord, paramBoolean);
  }
  ...
  {
    if (this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) {}
    for (MessageRecord localMessageRecord = this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;; localMessageRecord = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_Bdzn.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Bdzn.jdField_a_of_type_Int, this.jdField_a_of_type_Bdzn.jdField_a_of_type_Long))
    {
      if ((localMessageRecord != null) && ((localMessageRecord instanceof MessageForShortVideo)) && (((MessageForShortVideo)localMessageRecord).redBagType == LocalMediaInfo.REDBAG_TYPE_GET)) {
        bckg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      return;
    }
  }
  ...
  public void a(int paramInt, HashMap<String, String> paramHashMap, long paramLong)
  {
    ...
    if ((this.y == 3) && (this.jdField_e_of_type_Bdsz != null))
    {
      this.jdField_e_of_type_Bdsz.b();
      this.jdField_e_of_type_Bdsz.jdField_a_of_type_Int = 0;
    }
    if (!QLog.isColorLevel()) {}
    for (;;)
    {
      d();
      return;
      bcsz.a("Upload_Video_Error", String.valueOf(paramInt));
    }
  }
  ...
  public void a(bebv parambebv, beck parambeck)
  {
    ...
    {
      int j = 0;
      if (j < parambeck.jdField_a_of_type_JavaUtilList.size())
      {
        parambebv = (beda)parambeck.jdField_a_of_type_JavaUtilList.get(j);
        if (QLog.isColorLevel()) {
          b("procUrl", parambebv.toString());
        }
        a(this.jdField_a_of_type_Bdsz, parambebv);
        if (QLog.isColorLevel()) {
          QLog.d("ShortVideoUploadProcessor", 2, "onBusiProtoResp()------response.result = " + parambebv.jdField_c_of_type_Int);
        }
        this.jdField_f_of_type_JavaLangString = parambebv.jdField_a_of_type_JavaLangString;
        if (parambebv.jdField_c_of_type_Int == 0)
        {
          if (QLog.isColorLevel()) {
            QLog.d("ShortVideoUploadProcessor", 2, "onBusiProtoResp()------response.isExist = " + parambebv.jdField_a_of_type_Boolean);
          }
          this.z = parambebv.jdField_a_of_type_Int;
          this.A = parambebv.jdField_b_of_type_Int;
          if (QLog.isColorLevel()) {
            QLog.d("ShortVideoUploadProcessor", 2, "onBusiProtoResp()------response.videoAttr = " + parambebv.jdField_a_of_type_Int + ", response.videoKandianType = " + parambebv.jdField_b_of_type_Int);
          }
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      if ((this.jdField_a_of_type_Bdzn.jdField_a_of_type_Int == 1) || (this.jdField_a_of_type_Bdzn.jdField_a_of_type_Int == 3000)) {
      ...
      if (this.jdField_a_of_type_Bdzn.jdField_e_of_type_Int == 0) {
      ...
      this.jdField_a_of_type_JavaUtilHashMap.put("param_fileMd5", this.jdField_a_of_type_Bdzn.jdField_f_of_type_JavaLangString);
  ...
  protected void a(boolean paramBoolean, long paramLong)
  {
    if ((this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction != null) && (this.w == 1) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getHwEngine() != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getHwEngine().getCurrentConfig().segNum > 32L))
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "tempVideoUploadBDH", paramBoolean, paramLong, this.jdField_q_of_type_Long, localHashMap, "");
    }
  }
  ...
  public void a(byte[] paramArrayOfByte, HashMap<String, String> paramHashMap, String paramString, long paramLong)
  {
    ...
    try
    {
      ...
      long l5 = Long.valueOf((String)paramHashMap.get("dwFlow_Xg")).longValue();
      if (QLog.isColorLevel()) {
        QLog.d("ShortVideoUploadProcessor", 2, "<BDH_LOG> Transaction End : Success. New : SendTotalCost:" + (l1 - paramLong) + "ms ,fileSize:" + this.jdField_a_of_type_Bduk.jdField_a_of_type_Long + " transInfo:" + (String)paramHashMap.get("rep_bdhTrans"));
      }
      b(paramHashMap);
      if (((String)paramHashMap.get("param_BDH_Cache_Diff")).equals(String.valueOf(true))) {
        this.h = true;
  ...
  public boolean a()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 149	bdyr:jdField_a_of_type_ArrayOfByte	[B
    //   4: ifnonnull +98 -> 102
    //   7: new 1057	java/io/FileInputStream
    //   10: dup
    //   11: aload_0
    //   12: getfield 128	bdyr:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   27: putfield 149	bdyr:jdField_a_of_type_ArrayOfByte	[B
    //   30: aload_2
    //   31: astore_1
    //   32: aload_0
    //   33: getfield 149	bdyr:jdField_a_of_type_ArrayOfByte	[B
    //   36: ifnonnull +58 -> 94
    //   39: aload_2
    //   40: astore_1
    //   41: aload_0
    ...
    //   58: aload_0
    //   59: getfield 128	bdyr:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   68: invokevirtual 121	bdyr:b	(ILjava/lang/String;)V
    //   71: aload_2
    //   72: astore_1
    //   73: aload_0
    //   74: invokevirtual 123	bdyr:d	()V
    //   77: aload_2
    //   78: ifnull +7 -> 85
    //   81: aload_2
    ...
    //   102: aload_0
    //   103: getfield 1073	bdyr:jdField_a_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   106: ifnonnull +126 -> 232
    //   109: aload_0
    //   110: new 1075	java/io/RandomAccessFile
    //   113: dup
    //   114: aload_0
    //   115: getfield 128	bdyr:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   118: ldc_w 1076
    //   121: invokespecial 1078	java/io/RandomAccessFile:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   124: putfield 1073	bdyr:jdField_a_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   127: aload_0
    //   128: getfield 1073	bdyr:jdField_a_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   131: ifnonnull +101 -> 232
    //   134: aload_0
    //   135: sipush 9303
    //   138: ldc_w 1080
    //   141: invokevirtual 121	bdyr:b	(ILjava/lang/String;)V
    //   144: aload_0
    //   145: invokevirtual 123	bdyr:d	()V
    //   148: iconst_0
    //   149: ireturn
    //   150: astore_1
    //   151: aload_1
    ...
    //   163: aload_0
    //   164: aconst_null
    //   165: putfield 149	bdyr:jdField_a_of_type_ArrayOfByte	[B
    //   168: aload_2
    //   169: astore_1
    //   170: aload_0
    //   171: aload_3
    //   172: invokevirtual 1083	bdyr:a	(Ljava/io/IOException;)V
    //   175: aload_2
    //   176: astore_1
    //   177: aload_0
    //   178: invokevirtual 123	bdyr:d	()V
    //   181: aload_2
    //   182: ifnull -97 -> 85
    //   185: aload_2
    ...
    //   224: aload_0
    //   225: aconst_null
    //   226: putfield 1073	bdyr:jdField_a_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   229: goto -102 -> 127
    //   232: aload_0
    //   233: new 223	java/io/File
    //   236: dup
    //   237: aload_0
    //   238: getfield 128	bdyr:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   241: invokespecial 226	java/io/File:<init>	(Ljava/lang/String;)V
    //   244: invokevirtual 234	java/io/File:length	()J
    //   247: putfield 248	bdyr:jdField_a_of_type_Long	J
    //   250: aload_0
    //   251: aload_0
    //   252: getfield 128	bdyr:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   255: invokevirtual 1086	bdyr:b	(Ljava/lang/String;)V
    //   258: iconst_1
    //   259: ireturn
    //   260: astore_2
    //   261: goto -60 -> 201
  ...
  public byte[] a(becj parambecj)
  {
    ...
    localPttShortVideoUploadReq.uint64_fromuin.set(Long.parseLong(parambecj.jdField_c_of_type_JavaLangString));
    localPttShortVideoUploadReq.uint64_touin.set(Long.parseLong(parambecj.jdField_d_of_type_JavaLangString));
    localPttShortVideoUploadReq.uint32_chat_type.set(parambecj.jdField_a_of_type_Int);
    localPttShortVideoUploadReq.uint32_client_type.set(parambecj.jdField_b_of_type_Int);
    if (parambecj.jdField_b_of_type_JavaLangString != null) {
      localPttShortVideoUploadReq.uint64_group_code.set(Long.parseLong(parambecj.jdField_b_of_type_JavaLangString));
    }
    for (;;)
    {
      localPttShortVideoUploadReq.uint32_agent_type.set(parambecj.i);
      localPttShortVideoUploadReq.uint32_business_type.set(parambecj.jdField_j_of_type_Int);
      ...
      localPttShortVideoFileInfo.str_file_name.set(parambecj.jdField_a_of_type_JavaLangString);
      localPttShortVideoFileInfo.bytes_file_md5.set(ByteStringMicro.copyFrom(parambecj.jdField_a_of_type_ArrayOfByte));
      localPttShortVideoFileInfo.bytes_thumb_file_md5.set(ByteStringMicro.copyFrom(parambecj.jdField_b_of_type_ArrayOfByte));
      localPttShortVideoFileInfo.uint64_file_size.set(parambecj.jdField_a_of_type_Long);
      localPttShortVideoFileInfo.uint32_file_res_length.set(parambecj.jdField_d_of_type_Int);
      localPttShortVideoFileInfo.uint32_file_res_width.set(parambecj.jdField_e_of_type_Int);
      localPttShortVideoFileInfo.uint32_file_format.set(parambecj.g);
      localPttShortVideoFileInfo.uint32_file_time.set(parambecj.h);
      localPttShortVideoFileInfo.uint64_thumb_file_size.set(parambecj.jdField_b_of_type_Long);
  ...
  public void aN_()
  {
    ...
    if ((((MessageForShortVideo)this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).busiType == 0) && (((MessageForShortVideo)this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).isPause))
    {
      if (QLog.isColorLevel()) {
    ...
    super.aN_();
    if (((MessageForShortVideo)this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).CheckIsHotVideo())
    {
      f();
      return;
    }
    if ((this.jdField_a_of_type_Bdzn.jdField_a_of_type_JavaLangObject != null) && ((this.jdField_a_of_type_Bdzn.jdField_a_of_type_JavaLangObject instanceof bcfn))) {
      this.jdField_g_of_type_Boolean = ((bcfn)this.jdField_a_of_type_Bdzn.jdField_a_of_type_JavaLangObject).jdField_i_of_type_Boolean;
    }
    d(1001);
    this.jdField_a_of_type_Bduk.a();
    g();
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("ShortVideoUploadProcessor", 2, "resume()  + mIsPause : " + this.jdField_m_of_type_Boolean);
    }
    if (this.jdField_m_of_type_Boolean)
    {
      ...
      v();
      d(1001);
      this.jdField_a_of_type_Bdsv.a.post(new ShortVideoUploadProcessor.1(this));
    }
    return 0;
  }
  ...
  void b(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Bdzn.jdField_a_of_type_JavaLangObject != null) && ((this.jdField_a_of_type_Bdzn.jdField_a_of_type_JavaLangObject instanceof bcfn)))
    {
      localObject2 = (bcfn)this.jdField_a_of_type_Bdzn.jdField_a_of_type_JavaLangObject;
      this.jdField_i_of_type_Boolean = ((bcfn)localObject2).jdField_g_of_type_Boolean;
    ...
    for (Object localObject1 = localObject2;; localObject1 = null)
    {
      ...
      bgnl.a(String.valueOf(this.jdField_a_of_type_Bdzn.jdField_a_of_type_Long), "message", "sendMsg() start.");
  ...
  public boolean b()
  {
    ...
    {
      this.jdField_b_of_type_ArrayOfByte = HexUtil.hexStr2Bytes(this.jdField_a_of_type_Bdzn.jdField_f_of_type_JavaLangString);
      bduk localbduk = this.jdField_a_of_type_Bduk;
      String str = this.jdField_a_of_type_Bdzn.jdField_f_of_type_JavaLangString;
      localbduk.jdField_f_of_type_JavaLangString = str;
    ...
    if (!bgmg.b(this.jdField_a_of_type_Bdzn.jdField_i_of_type_JavaLangString))
    {
  ...
  public void c()
  {
    if (!this.jdField_m_of_type_Boolean)
    {
      ...
      if ((this.jdField_a_of_type_Bdzn.jdField_e_of_type_Int == 1010) && (this.jdField_a_of_type_Bdzn.jdField_a_of_type_Ayyt != null))
      {
        ...
        localayyu.jdField_b_of_type_Int = 9037;
        localayyu.jdField_a_of_type_JavaLangString = "cancel";
  ...
  void d()
  {
    ...
    label320:
    for (Object localObject = this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord;; localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_Bdzn.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Bdzn.jdField_a_of_type_Int, this.jdField_a_of_type_Bdzn.jdField_a_of_type_Long))
    {
      ...
      if (this.jdField_a_of_type_Bdzn.jdField_a_of_type_Ayyt != null)
      {
        ...
        ((ayyu)localObject).jdField_b_of_type_Int = this.jdField_j_of_type_Int;
      ...
      if ((this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) && ((this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForBlessPTV)))
      {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().notifyUI(999, false, this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin);
        ayxi.a("ShortVideoUploadProcessor", "onError", "notifyUI bless ptv send error");
      }
      if ((this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) && ((this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord instanceof MessageForDanceMachine)))
      {
        ((MessageForDanceMachine)this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).errorCode = 1;
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().notifyUI(8034, false, this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
        ayxi.a("ShortVideoUploadProcessor", "onError", "notifyUI dance machine send error");
      }
      return;
    }
  }
  ...
  void e()
  {
    ...
    if (this.jdField_a_of_type_Bdzn.jdField_a_of_type_Ayyt != null)
    {
      ...
      localayyu.jdField_a_of_type_Long = (this.jdField_q_of_type_Long - this.jdField_a_of_type_Long);
      ...
      if (this.jdField_f_of_type_JavaLangString == null)
      {
        ...
        this.jdField_a_of_type_Bdzn.jdField_a_of_type_Ayyt.b(localayyu);
        if (QLog.isColorLevel()) {
          QLog.d("ShortVideoUploadProcessor", 2, "onSuccess uuid = " + localayyu.jdField_c_of_type_JavaLangString);
        }
      }
    }
    for (;;)
    {
      d(1003);
      if (this.jdField_a_of_type_Bdzn.jdField_e_of_type_Int == 2) {
        w();
      }
      if (QLog.isColorLevel()) {
  ...
  public void g()
  {
    if (this.jdField_a_of_type_Bdzn.jdField_i_of_type_Boolean)
    {
      ...
      this.y = 3;
      this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Bdzn.jdField_j_of_type_JavaLangString;
      this.jdField_a_of_type_ArrayOfByte = HexUtil.hexStr2Bytes(this.jdField_a_of_type_Bdzn.k);
      if (a()) {
        break label159;
      }
    }
    ...
    while (!i())
    {
      ...
      if (((MessageForShortVideo)this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).busiType == 1) {
        if (VideoUpConfigInfo.sSwitch != 2) {}
      }
      for (this.y = 2;; this.y = 2) {
        do
        {
          if (bdyo.jdField_a_of_type_Long <= 0L) {
            break label157;
          }
          this.jdField_a_of_type_JavaUtilHashMap.put("param_cost_c_comp", String.valueOf(bdyo.jdField_a_of_type_Long));
          break;
        } while ((((MessageForShortVideo)this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).busiType != 2) || (PTVUpConfigInfo.sSwitch != 2));
      }
      break;
    }
  ...
  public void h()
  {
    ...
    {
      int j;
      if (SessionInfo.getInstance(this.jdField_a_of_type_Bdzn.jdField_b_of_type_JavaLangString).getHttpconn_sig_session() != null)
      {
        j = SessionInfo.getInstance(this.jdField_a_of_type_Bdzn.jdField_b_of_type_JavaLangString).getHttpconn_sig_session().length;
        this.jdField_f_of_type_ArrayOfByte = new byte[j];
        System.arraycopy(SessionInfo.getInstance(this.jdField_a_of_type_Bdzn.jdField_b_of_type_JavaLangString).getHttpconn_sig_session(), 0, this.jdField_f_of_type_ArrayOfByte, 0, j);
      }
      if (SessionInfo.getInstance(this.jdField_a_of_type_Bdzn.jdField_b_of_type_JavaLangString).getSessionKey() != null)
      {
        j = SessionInfo.getInstance(this.jdField_a_of_type_Bdzn.jdField_b_of_type_JavaLangString).getSessionKey().length;
        this.jdField_e_of_type_ArrayOfByte = new byte[j];
        System.arraycopy(SessionInfo.getInstance(this.jdField_a_of_type_Bdzn.jdField_b_of_type_JavaLangString).getSessionKey(), 0, this.jdField_e_of_type_ArrayOfByte, 0, j);
      }
      return;
    }
    finally {}
  ...
  void r()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ShortVideoUploadProcessor", 2, "sendGetUrlReq()----busiReq.seq : " + this.jdField_a_of_type_Bdzn.jdField_a_of_type_Long);
    }
    becj localbecj = a();
    ...
    {
      return;
      if (localbecj.jdField_a_of_type_Long == 0L)
      {
      ...
      if ((localbecj.jdField_j_of_type_Int == 0) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getHwEngine().mConnManager.getCurrentConnNum() > 0)) {
  ...
  public void t()
  {
    ...
    do
    {
      ...
      becj localbecj = a();
      byte[] arrayOfByte = a(localbecj);
      bdys localbdys = new bdys(this, (String)localObject, l);
      int j = 12;
      if (localbecj.jdField_j_of_type_Int == 0) {
        j = 25;
      }
      this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), j, (String)localObject, (int)this.jdField_r_of_type_Long, this.jdField_b_of_type_ArrayOfByte, localbdys, arrayOfByte, true);
      localObject = new bdyt(this);
    ...
    a(k, "sendFileByBDH SubmitError.", "", this.jdField_b_of_type_Bdsz);
    d();
  }
  
  protected void u()
  {
    if (((MessageForShortVideo)this.jdField_a_of_type_Bdzn.jdField_a_of_type_ComTencentMobileqqDataMessageRecord).busiType == 0) {
      ThreadManager.post(new ShortVideoUploadProcessor.7(this, this.jdField_a_of_type_Bdzn.jdField_i_of_type_JavaLangString), 5, null, true);
    }
  }
}
