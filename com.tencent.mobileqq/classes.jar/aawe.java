  ...
  extends ajxj
{
  ...
  protected void onCancelMayKnowRecommend(boolean paramBoolean, String paramString)
  {
    ...
    if (paramBoolean)
    {
      akaa localakaa = (akaa)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
      ArrayList localArrayList = localakaa.c();
      if (localakaa.a(paramString)) {
  ...
  protected void onGetGenralSettings(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      localObject1 = null;
      asfd.a().i(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (localObject1 != null) {
        break label176;
      }
    }
    for (;;)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        {
          if (localObject1 != null) {
            ((aktf)localObject1).b(localRecentUser);
          }
          ahpd.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, 1);
    ...
    label186:
    this.a.a(9, ajsd.C, 5000);
    this.a.a(9, ajsd.aK, 5001);
    if (QLog.isColorLevel()) {
  ...
  protected void onGetMayKnowRecommend(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ...
      if (!bool)
      {
        paramBundle = (akaa)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
        if (!paramBundle.b()) {
          break label103;
        }
        paramBundle.c();
  ...
  protected void onHideConversationMayKnowRecommend(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      paramObject = (akaa)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
      paramObject.e();
      this.a.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(1009);
    ...
    bcql.a(BaseApplication.getContext(), ajya.a(2131702602), 0).a();
    paramBoolean = ((akaa)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159)).b("sp_mayknow_ml_s_a_vl");
    paramObject = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    if (paramBoolean) {}
    for (;;)
    {
  ...
  protected void onMayknowStateChanged(boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (((akaa)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159)).b("sp_mayknow_ml_s_a_vl")))
    {
      this.a.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(1009);
      this.a.jdField_a_of_type_MqqOsMqqHandler.removeCallbacks(this.a.jdField_a_of_type_JavaLangRunnable);
      this.a.jdField_a_of_type_MqqOsMqqHandler.postDelayed(this.a.jdField_a_of_type_JavaLangRunnable, 1600L);
  ...
  protected void onSetGenralSettingsTroopFilter(boolean paramBoolean, Map<String, Integer> paramMap)
  {
    ...
    if (localObject == null)
    {
      ...
      asfd.a().a(str, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    for (;;)
    {
      ...
      try
      {
        RecentUser localRecentUser = ((aktf)localObject).b(str, 1);
      ...
      break;
      label315:
      asfd.a().c(str, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    label333:
    this.a.a(9, ajsd.C, 5000);
    this.a.a(9, ajsd.aK, 5001);
  ...
  protected void onUpdateCustomHead(boolean paramBoolean, String paramString)
  {
    ...
    if (!bbbr.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
    {
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    if (!paramBoolean) {}
    while (bbbr.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount())) {
      return;
    }
    this.a.a(0L);
  }
