...
public class bfdi
{
  protected static bfdi a;
  protected static byte[] a;
  public int a;
  protected List<bfdj> a;
  public int b;
  ...
  public static bfdi a()
  {
    if (jdField_a_of_type_Bfdi == null) {}
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (jdField_a_of_type_Bfdi == null) {
        jdField_a_of_type_Bfdi = new bfdi();
      }
      return jdField_a_of_type_Bfdi;
    }
  }
  ...
  {
    List localList = ((bfdj)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_JavaUtilList;
    if (localList != null) {
  ...
  public Friend a(String paramString)
  {
    ...
    do
    {
      ...
      while (!localIterator2.hasNext())
      {
        ...
        localIterator2 = ((bfdj)localIterator1.next()).jdField_a_of_type_JavaUtilList.iterator();
      }
  ...
  {
    return ((bfdj)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_JavaLangString;
  }
  ...
  public List<Friend> a()
  {
    ...
    {
      Iterator localIterator2 = ((bfdj)localIterator1.next()).jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator2.hasNext()) {
  ...
  {
    return ((bfdj)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_JavaUtilList;
  }
  ...
  public void a(List<bfdj> paramList, int paramInt1, int paramInt2)
  {
    label9:
    String str2;
    ...
    else
    {
      ...
      this.c.clear();
      str2 = bexd.a().a().getResources().getString(2131690955);
    ...
    for (;;)
    {
      if (localIterator1.hasNext())
      {
        paramList = (bfdj)localIterator1.next();
