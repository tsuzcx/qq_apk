...
public class biso
{
  ...
  private bisz jdField_a_of_type_Bisz;
  ...
  static
  {
    jdField_a_of_type_JavaUtilList = Arrays.asList(new String[] { ajyc.a(2131699969), ajyc.a(2131699980), ajyc.a(2131699978), ajyc.a(2131699985), ajyc.a(2131699989), ajyc.a(2131699986), "dbq", "886", ajyc.a(2131699983), ajyc.a(2131699982), ajyc.a(2131699973), "ok", "666", ajyc.a(2131699975), ajyc.a(2131699992), ajyc.a(2131699984) });
  }
  
  public biso(BaseVMPeakActivity paramBaseVMPeakActivity, RelativeLayout paramRelativeLayout, AEGIFOutlineTextView paramAEGIFOutlineTextView)
  {
    this.jdField_a_of_type_DovComQqImBaseVMPeakActivity = paramBaseVMPeakActivity;
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = paramRelativeLayout;
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null)
    {
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372848));
      this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376298));
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView = ((RecyclerView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372849));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372845));
    }
    this.jdField_a_of_type_DovComQqImAeGifGiftextAEGIFOutlineTextView = paramAEGIFOutlineTextView;
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_JavaUtilHashMap.put("happy", ajyc.a(2131699994));
    this.jdField_a_of_type_JavaUtilHashMap.put("neutral", ajyc.a(2131699970));
    this.jdField_a_of_type_JavaUtilHashMap.put("sad", ajyc.a(2131699976));
    this.jdField_a_of_type_JavaUtilHashMap.put("anger", ajyc.a(2131699987));
    this.jdField_a_of_type_JavaUtilHashMap.put("disgust", ajyc.a(2131699979));
    this.jdField_a_of_type_JavaUtilHashMap.put("fear", ajyc.a(2131699974));
  }
  ...
  private void b(String paramString1, String paramString2, String paramString3)
  {
    ...
    {
      i = bawz.a(this.jdField_a_of_type_DovComQqImBaseVMPeakActivity, 73.199997F);
      ...
      this.jdField_a_of_type_DovComQqImAeGifGiftextAEGIFOutlineTextView.setOutlineWidth(bawz.a(this.jdField_a_of_type_DovComQqImBaseVMPeakActivity, 4.0F));
      if (paramString1.indexOf('\n') <= 0) {
        break label137;
      }
    }
    label137:
    for (float f = bawz.a(this.jdField_a_of_type_DovComQqImBaseVMPeakActivity, 26.0F);; f = bawz.a(this.jdField_a_of_type_DovComQqImBaseVMPeakActivity, 30.0F))
    {
      ...
      return;
      i = bawz.a(this.jdField_a_of_type_DovComQqImBaseVMPeakActivity, 41.0F);
      break;
    }
  }
  ...
  public ArrayList<bisk> a()
  {
    ArrayList localArrayList = new ArrayList();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext()) {
      localArrayList.add(new bisk((String)localIterator.next()));
    }
  ...
  public void a(String paramString)
  {
    ...
    if ((!this.jdField_a_of_type_JavaUtilArrayList.contains(paramString)) && (this.jdField_a_of_type_Bisz != null)) {
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Bisz = new bisz(this.jdField_a_of_type_DovComQqImBaseVMPeakActivity, this);
    this.jdField_a_of_type_Bisz.setHasStableIds(true);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Bisz);
    ...
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.addOnScrollListener(new bisp(this));
    this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new bisq(this));
  }
  ...
  public void b(String paramString)
  {
    ...
    {
      f = bawz.a(this.jdField_a_of_type_DovComQqImBaseVMPeakActivity, 26.0F);
    ...
    label114:
    for (int i = bawz.a(this.jdField_a_of_type_DovComQqImBaseVMPeakActivity, 73.199997F);; i = bawz.a(this.jdField_a_of_type_DovComQqImBaseVMPeakActivity, 41.0F))
    {
      localLayoutParams.height = i;
      this.jdField_a_of_type_DovComQqImAeGifGiftextAEGIFOutlineTextView.setLayoutParams(localLayoutParams);
      return;
      f = bawz.a(this.jdField_a_of_type_DovComQqImBaseVMPeakActivity, 30.0F);
      break;
    }
  }
  ...
  public void c()
  {
    ...
    d();
    this.jdField_a_of_type_Biur.a().a(this.jdField_a_of_type_DovComQqImBaseVMPeakActivity, new bisr(this));
  }
  ...
  public void d()
  {
    ...
    b(ajyc.a(2131699990), "#ccffffff", "#000000");
  }
}
