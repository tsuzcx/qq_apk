...
public class bapo
{
  ...
  public static bapo a(boolean paramBoolean, TianShuAccess.GetAdsRsp paramGetAdsRsp)
  {
    ...
    localObject1 = new bapo();
    ((bapo)localObject1).jdField_a_of_type_JavaLangString = ((String)localHashMap.get("type"));
    ((bapo)localObject1).c = ((String)localHashMap.get("pic"));
    ((bapo)localObject1).b = ((String)localHashMap.get("url"));
    ((bapo)localObject1).jdField_a_of_type_CooperationVipPbTianShuAccess$AdItem = ((TianShuAccess.AdItem)paramGetAdsRsp.value.lst.get(0));
    if (TextUtils.isEmpty(((bapo)localObject1).c)) {
      return null;
    }
    return localObject1;
  }
