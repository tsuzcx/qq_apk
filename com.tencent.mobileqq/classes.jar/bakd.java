...
public class bakd
{
  ...
  public static void a(Context paramContext, String paramString, int paramInt, RichMediaBrowserInfo paramRichMediaBrowserInfo)
  {
    ...
    localIntent.putExtra("extra.EXTRA_CURRENT_IMAGE", bakb.a((AIOBrowserBaseData)paramRichMediaBrowserInfo.baseData));
    localIntent.putExtra("leftViewText", paramContext.getString(2131690768));
