...
public class arge
{
  private static Map<String, arge> jdField_a_of_type_JavaUtilMap = new HashMap();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private final Context jdField_a_of_type_AndroidContentContext;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new argf(this);
  ...
  private final List<argg> jdField_a_of_type_JavaUtilList = new LinkedList();
  ...
  private arge(Context paramContext, InstalledPlugin paramInstalledPlugin)
  {
  ...
  private Intent a()
  {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      localIntent.putExtra("qqVersion", "8.3.0");
      return localIntent;
    }
  }
  
  public static arge a(Context paramContext, InstalledPlugin paramInstalledPlugin)
  {
    try
    {
      arge localarge2 = (arge)jdField_a_of_type_JavaUtilMap.get(paramInstalledPlugin.pluginFile.getName());
      arge localarge1 = localarge2;
      if (localarge2 == null)
      {
        localarge1 = new arge(paramContext, paramInstalledPlugin);
        jdField_a_of_type_JavaUtilMap.put(paramInstalledPlugin.pluginFile.getName(), localarge1);
      }
      return localarge1;
    }
    finally {}
  ...
  private RunningPlugin a()
  {
    ...
    a("HuayangPluginLauncher", ajya.a(2131705642));
    try
    {
      ...
      {
        a("HuayangPluginLauncher", ajya.a(2131705652) + (System.currentTimeMillis() - l));
    ...
    catch (Exception localException2)
    {
      ...
      a(80);
      a("HuayangPluginLauncher", ajya.a(2131705656) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + ajya.a(2131705651) + (System.currentTimeMillis() - l));
    }
  ...
  private void a(int paramInt)
  {
    ...
    a("HuayangPluginLauncher", ajya.a(2131705650) + paramInt);
  ...
  private void a(RunningPlugin paramRunningPlugin)
  {
    ...
    long l = System.currentTimeMillis();
    a("HuayangPluginLauncher", ajya.a(2131705640) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile);
    ...
    for (;;)
    {
      try
      {
        ...
        a(true, null);
        if (!arfy.a(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_c_of_type_JavaLangString)) {
          continue;
        }
        argk.a("2691707");
      ...
      a("HuayangPluginLauncher", ajya.a(2131705655) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + ajya.a(2131705648) + (System.currentTimeMillis() - l));
      return;
      if (arfy.b(this.jdField_a_of_type_ComTencentMobileqqIntervideoIVPluginInfo.jdField_c_of_type_JavaLangString)) {
        argk.a("2597725");
      }
    }
  }
  ...
  {
    long l = System.currentTimeMillis();
    a("HuayangPluginLauncher", ajya.a(2131705646) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile);
    Intent localIntent = a();
    try
    {
      paramRunningPlugin.startInitActivity(localIntent).get();
      a("HuayangPluginLauncher", ajya.a(2131705644) + this.jdField_a_of_type_ComTencentHydevteamPluginframeworkInstalledpluginInstalledPlugin.pluginFile + ajya.a(2131705641) + (System.currentTimeMillis() - l));
      return;
    }
    catch (Throwable paramRunningPlugin)
    {
  ...
  {
    if (paramargg != null) {
      this.jdField_a_of_type_JavaUtilList.add(paramargg);
    }
  }
  ...
  public void b(argg paramargg)
  {
    if (paramargg != null) {
      this.jdField_a_of_type_JavaUtilList.remove(paramargg);
    }
  }
}
