  ...
  implements bhqp
{
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    if (QLog.isColorLevel()) {
      QLog.i(aicw.jdField_a_of_type_JavaLangString, 2, "onItemClick, position = " + paramInt);
    }
    ...
    {
      paramAdapterView = (aicu)this.a.jdField_a_of_type_Aicv.getItem(paramInt);
      ...
      if (QLog.isColorLevel()) {
        QLog.i(aicw.jdField_a_of_type_JavaLangString, 2, "onItemClick, mRecordCount = " + this.a.jdField_a_of_type_Int);
      }
      this.a.a(true);
      this.a.dismiss();
    }
    ...
    {
      return;
      if (paramAdapterView == this.a.jdField_a_of_type_Aidg)
      {
        paramAdapterView = (aick)this.a.jdField_a_of_type_Aidg.getItem(paramInt);
        this.a.b = false;
    ...
    QLog.i(aicw.jdField_a_of_type_JavaLangString, 2, "onItemClick, unknown data type");
  }
}
