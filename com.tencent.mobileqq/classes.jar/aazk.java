...
public class aazk
{
  ...
  public aazk(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3)
  {
    this.b = paramString1;
  ...
  public View a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (ClassNotFoundException localClassNotFoundException)
      {
        ...
        try
        {
          paramString = (View)localObject.getConstructor(new Class[] { Context.class }).newInstance(new Object[] { this.jdField_a_of_type_Aazf });
          return paramString;
        }
  ...
  public void a(nkm paramnkm, boolean paramBoolean)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((!nko.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getApplicationContext(), str, new aazl(this, l, localContext, paramBoolean, paramnkm))) && (QLog.isColorLevel())) {
