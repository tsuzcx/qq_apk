  ...
  implements MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnSeekCompleteListener
{
  ...
  private wys jdField_a_of_type_Wys;
  ...
  public void a(VsMusicItemInfo paramVsMusicItemInfo)
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewVsMusicItemInfo != null)
    {
      ...
      wye.a("edit_smart_music_play", wye.a((HashMap)localObject));
    }
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Wys == null);
      this.jdField_a_of_type_Wys.a(this.jdField_a_of_type_AndroidMediaMediaPlayer, -2, -1);
      return;
    ...
    this.jdField_a_of_type_Wys.a(this.jdField_a_of_type_AndroidMediaMediaPlayer, -1, -1);
    return;
  ...
  public void a(wys paramwys)
  {
    this.jdField_a_of_type_Wys = paramwys;
  }
  ...
  {
    if ((this.jdField_a_of_type_Wys != null) && (paramInt1 != -38)) {
      this.jdField_a_of_type_Wys.a(paramMediaPlayer, paramInt1, paramInt2);
    }
    return false;
  }
  ...
  {
    if ((paramMediaPlayer != null) && (this.jdField_a_of_type_Wys != null) && (!paramMediaPlayer.isPlaying()))
    {
      this.c = (System.currentTimeMillis() - this.jdField_a_of_type_Long);
      this.jdField_b_of_type_Long = System.currentTimeMillis();
      this.jdField_a_of_type_Wys.a(paramMediaPlayer, this.jdField_a_of_type_ComTencentBizVideostoryWidgetViewSmartmusicviewVsMusicItemInfo);
    }
  }
}
