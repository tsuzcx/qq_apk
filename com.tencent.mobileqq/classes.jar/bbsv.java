...
public class bbsv
{
  private static bbsv jdField_a_of_type_Bbsv;
  private String jdField_a_of_type_JavaLangString;
  private ConcurrentLinkedQueue<bbsw> jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue = new ConcurrentLinkedQueue();
  ...
  public static bbsv a()
  {
    try
    {
      if (jdField_a_of_type_Bbsv == null) {
        jdField_a_of_type_Bbsv = new bbsv();
      }
      bbsv localbbsv = jdField_a_of_type_Bbsv;
      return localbbsv;
    }
    finally {}
  }
  ...
  private String a(String paramString)
  {
    try
    {
      ...
      if (localFile.exists())
      {
        ...
        paramString = beek.a(paramString);
        return paramString;
      }
    }
  ...
  private String b(PackageInfo paramPackageInfo)
  {
    ...
    return bech.a(paramPackageInfo);
  }
  ...
  private void c()
  {
    ...
    try
    {
      ...
      localSharedInfoPacket.qq_version.set(a("8.2.6"));
      if (QLog.isColorLevel()) {
        QLog.d("SecShare.AV", 2, String.format("Version = %s intVersion= 0x%x", new Object[] { "8.2.6", Integer.valueOf(a("8.2.6")) }));
      }
      if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.isEmpty()) {
        break label561;
      }
      localSendInfo = new SecSharedInfo.SendInfo();
      localObject1 = (bbsw)this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.poll();
      i = ((bbsw)localObject1).a();
      localObject3 = ((bbsw)localObject1).a();
      str3 = ((bbsw)localObject1).b();
      j = ((bbsw)localObject1).b();
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        {
          localObject2 = becz.a((String)localObject3);
  ...
  {
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.offer(new bbsw(paramInt1, paramString1, paramInt2, paramString2));
  }
