...
public class bakk
  extends xba
{
  public bakk(TroopFileTransferManager paramTroopFileTransferManager) {}
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d6.DownloadFileRspBody paramDownloadFileRspBody, Bundle paramBundle)
  {
    ...
    int i = apug.a(apvd.a(((TroopFileTransferManager.Item)localObject1).FileName));
    paramInt = paramBundle.getInt("thumbNail");
    boolean bool2 = paramBundle.getBoolean("isPreview", false);
    paramBundle = new bakt();
    ...
    catch (NullPointerException localNullPointerException)
    {
      ...
      if (bool2)
      {
        bajt.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.e, 700);
        paramBundle.jdField_a_of_type_Boolean = false;
        ((ajsx)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22)).c(paramBundle);
        return;
      }
    ...
    if (bool2)
    {
      ...
      paramBundle.d = bbea.a(paramDownloadFileRspBody.bytes_download_url.get().toByteArray());
    }
    ...
    if (i < 0)
    {
      ...
      if (bool2)
      {
        ...
        if (TextUtils.isEmpty(paramBundle.c)) {
          paramBundle.c = ajya.a(2131715368);
        }
        paramBundle.jdField_a_of_type_Boolean = false;
        ((ajsx)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(22)).c(paramBundle);
        return;
    ...
    ((TroopFileTransferManager.Item)localObject1).cookieValue = bbea.a(paramDownloadFileRspBody.bytes_cookie_val.get().toByteArray());
    ...
    ((TroopFileTransferManager.Item)localObject1).DownloadUrl = bbea.a(paramDownloadFileRspBody.bytes_download_url.get().toByteArray());
    ...
    while ((paramInt == 128) || (paramInt == 383) || (paramInt == 640))
    {
      ...
      this.a.jdField_a_of_type_ArrayOfBaku[4].a(paramDownloadFileRspBody);
      return;
      if (i == -134)
      {
    ...
    if (!this.a.c((TroopFileTransferManager.Item)localObject1)) {
      this.a.jdField_a_of_type_ArrayOfBaku[3].a(new TroopFileTransferManager.TaskHttpDownload(this.a, (TroopFileTransferManager.Item)localObject1));
    }
  }
}
