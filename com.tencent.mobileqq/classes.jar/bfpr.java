...
public class bfpr
{
  ...
  static
  {
    ...
    jdField_b_of_type_JavaLangString = ajjy.a(2131646121);
  }
  ...
  {
    Intent localIntent = new Intent();
    localIntent.putExtra("key_left_tab_title", paramContext.getString(2131651852));
    localIntent.putExtra("key_rihgt_tab_title", paramContext.getString(2131651933));
  ...
  @NonNull
  private static Intent a(bfpy parambfpy, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambfpy);
  ...
  private static Intent a(bfpy parambfpy, String paramString)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambfpy);
  ...
  public static Intent a(String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      localIntent.putExtra("hc_code", abai.jdField_a_of_type_Int);
      abai.jdField_a_of_type_Int = 0;
      b(localIntent);
      return localIntent;
    }
  ...
  public static SurfaceView a(Context paramContext, String paramString)
  {
    try
    {
      if (f())
      {
        bcec.a().a(jdField_b_of_type_JavaLangString, 1);
        return null;
      }
      try
      {
  ...
  {
    babr.a(paramActivity, 230).setMessage(2131652409).setPositiveButton(2131651963, new bfps()).setNegativeButton(2131653652, paramOnClickListener).show();
  }
  ...
  public static void a(Activity paramActivity, Bundle paramBundle, bfpy parambfpy, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    Intent localIntent = new Intent();
    ...
    QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void a(Activity paramActivity, bfpy parambfpy, int paramInt)
  {
    c(paramActivity, parambfpy, null, paramInt);
  }
  
  public static void a(Activity paramActivity, bfpy parambfpy, int paramInt, Bundle paramBundle)
  {
    Intent localIntent = new Intent();
    localIntent.putExtras(paramBundle);
    a(localIntent, parambfpy);
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, int paramInt, String paramString, long paramLong1, long paramLong2)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambfpy);
    ...
    QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, localIntent, 0);
  }
  
  public static void a(Activity paramActivity, bfpy parambfpy, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString5, int paramInt8, Bundle paramBundle, boolean paramBoolean1, boolean paramBoolean2, int paramInt9, int paramInt10, boolean paramBoolean3)
  {
    a(paramActivity, parambfpy, paramInt1, paramString1, paramString2, paramString3, paramString4, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramString5, paramInt8, paramBundle, paramBoolean1, paramBoolean2, paramInt9, paramInt10, paramBoolean3, null);
  }
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString5, int paramInt8, Bundle paramBundle1, boolean paramBoolean1, boolean paramBoolean2, int paramInt9, int paramInt10, boolean paramBoolean3, Bundle paramBundle2)
  {
    ...
    for (;;)
    {
      ...
      for (paramInt2 = 1;; paramInt2 = 0)
      {
        ...
        QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, paramString1, paramInt1, null, true);
        return;
      }
    }
  }
  ...
  {
    a(paramActivity, parambfpy, paramInt1, paramString1, paramString2, paramString3, paramString4, paramInt2, paramBoolean1, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramString5, paramInt8, paramInt9, paramBoolean2, paramString6, paramBoolean3, null);
  }
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt2, boolean paramBoolean1, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString5, int paramInt8, int paramInt9, boolean paramBoolean2, String paramString6, boolean paramBoolean3, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      for (paramInt7 = 1;; paramInt7 = 0)
      {
        ...
        QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, paramString1, paramInt1, null, paramBoolean2);
        return;
      }
    }
  }
  
  public static void a(Activity paramActivity, bfpy parambfpy, long paramLong, int paramInt)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambfpy);
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, Intent paramIntent)
  {
    a(paramActivity, parambfpy, paramIntent, -1);
  }
  
  public static void a(Activity paramActivity, bfpy parambfpy, Intent paramIntent, int paramInt)
  {
    a(paramIntent, parambfpy);
    if (paramInt >= 0) {
    ...
    for (;;)
    {
      ...
      QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, paramIntent, paramInt);
      return;
      paramIntent.putExtra("bNeedCallBack", false);
    }
  }
  
  public static void a(Activity paramActivity, bfpy parambfpy, Intent paramIntent, int paramInt, DialogInterface.OnDismissListener paramOnDismissListener)
  {
    QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, paramIntent, paramInt, paramOnDismissListener, true);
  }
  
  public static void a(Activity paramActivity, bfpy parambfpy, Intent paramIntent, int paramInt, boolean paramBoolean)
  {
    a(paramIntent, parambfpy);
    if (paramInt >= 0) {
      paramIntent.putExtra("bNeedCallBack", true);
    ...
    {
      QzonePluginProxyActivity.a(paramIntent, "com.qzone.misc.web.QZoneTranslucentActivity");
      QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, paramIntent, paramInt, null, paramBoolean);
      return;
      paramIntent.putExtra("bNeedCallBack", false);
    }
  }
  ...
  @Deprecated
  public static void a(Activity paramActivity, bfpy parambfpy, Intent paramIntent, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, ArrayList<String> paramArrayList, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, paramString1, paramInt2);
      return;
      i = 0;
      continue;
      i = 3;
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = a(parambfpy, "com.qzone.album.ui.activity.QZonePersonalAlbumSelectActivity");
    localIntent.putExtras(paramBundle);
    QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void a(Activity paramActivity, bfpy parambfpy, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt)
  {
    paramBaseBusinessAlbumInfo = a(parambfpy, paramBaseBusinessAlbumInfo);
    QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, paramBaseBusinessAlbumInfo, paramInt);
  }
  
  public static void a(Activity paramActivity, bfpy parambfpy, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt, String paramString)
  {
    paramBaseBusinessAlbumInfo = a(parambfpy, paramBaseBusinessAlbumInfo);
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, CoverCacheData paramCoverCacheData, String paramString, int paramInt)
  {
    parambfpy = bfpv.a(parambfpy.jdField_a_of_type_JavaLangString, paramString, "usersummary", true);
    paramCoverCacheData = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramCoverCacheData);
    paramCoverCacheData.putExtra("url", parambfpy);
    if (bbaf.a.containsKey("Qzone")) {
      paramCoverCacheData.putExtra("insertPluginsArray", new String[] { "Qzone" });
    }
    paramCoverCacheData.setData(Uri.parse(parambfpy));
    c(paramCoverCacheData);
    paramActivity.startActivityForResult(paramCoverCacheData, paramInt);
  }
  
  public static void a(Activity paramActivity, bfpy parambfpy, Long paramLong, int paramInt1, int paramInt2, int paramInt3, aqdz paramaqdz)
  {
    paramLong = a(paramActivity, paramLong, paramInt1);
    a(paramLong, parambfpy);
    a(paramLong, paramInt2);
    QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, paramLong, paramInt3, paramaqdz);
  }
  
  public static void a(Activity paramActivity, bfpy parambfpy, Long paramLong, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    a(paramActivity, parambfpy, paramLong, paramInt1, paramBoolean, paramInt2, 5);
  }
  
  public static void a(Activity paramActivity, bfpy parambfpy, Long paramLong, int paramInt1, boolean paramBoolean, int paramInt2, int paramInt3)
  {
    ...
    QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, paramLong, paramInt2);
  }
  
  @Deprecated
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString, int paramInt)
  {
    if (TextUtils.isEmpty(paramString)) {
      return;
    }
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    a(paramActivity, parambfpy, paramString, paramInt1, paramInt2, paramInt3, null, null);
  }
  
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString, int paramInt1, int paramInt2, int paramInt3, aqdz paramaqdz, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, localIntent, paramInt2, paramaqdz);
      return;
      i = 0;
      break;
      label93:
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString1, int paramInt, Bundle paramBundle, String paramString2)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambfpy);
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString1, int paramInt, String paramString2)
  {
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString1, long paramLong, int paramInt1, int paramInt2, String paramString2, String paramString3)
  {
    Intent localIntent = new Intent();
    ...
    QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, localIntent, paramInt1);
  }
  
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString1, long paramLong, String paramString2, int paramInt)
  {
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString1, long paramLong, String paramString2, int paramInt, String paramString3, boolean paramBoolean)
  {
    Intent localIntent = new Intent("com.tencent.intent.QZONE_OPEN_VIP");
    a(localIntent, parambfpy);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.module.vipcomponent.ui.DiamondYellowOpenActivity");
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString1, long paramLong, String paramString2, String paramString3, int paramInt)
  {
    Object localObject;
    if (paramActivity == null) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((Intent)localObject).putExtra("userId", parambfpy.jdField_a_of_type_JavaLangString);
        ((Intent)localObject).putExtra("userName", parambfpy.jdField_b_of_type_JavaLangString);
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString1, String paramString2, int paramInt)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambfpy);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.detail.ui.activity.QzoneDetailActivity");
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambfpy);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.detail.ui.activity.QzoneDetailActivity");
    ...
    QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, localIntent, paramInt2);
  }
  
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3)
  {
    ...
    parambfpy = paramString1;
    if (!TextUtils.isEmpty(paramString3)) {
      parambfpy = paramString1 + "&source=" + paramString3;
    }
    paramString1 = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramString1);
    if (QLog.isColorLevel()) {
      QLog.d("QZoneHelper", 2, "forwardToQunAlbumList:" + parambfpy);
    }
    paramString1.putExtra("url", parambfpy);
    if (bbaf.a.containsKey("Qzone")) {
      paramString1.putExtra("insertPluginsArray", new String[] { "Qzone" });
    }
    paramString1.setData(Uri.parse(parambfpy));
    c(paramString1);
    paramActivity.startActivityForResult(paramString1, paramInt2);
  }
  
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString1, String paramString2, String paramString3, int paramInt)
  {
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    parambfpy = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunAlbumPhotoList", "https://h5.qzone.qq.com/groupphoto/inqq/photo/{QUN_ID}/{ALBUM_ID}?_wv=3&_proxy=1").replace("{QUN_ID}", paramString1).replace("{ALBUM_ID}", paramString2);
    paramString1 = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramString1);
    paramString1.putExtra("url", parambfpy);
    if (bbaf.a.containsKey("Qzone")) {
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, Bundle paramBundle)
  {
    a(paramActivity, parambfpy, paramString1, paramString2, paramString3, paramString4, paramInt, paramBundle, true);
  }
  
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, Bundle paramBundle, boolean paramBoolean)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambfpy);
    localIntent.putExtra("startup_sceneid", 4);
    ...
    try
    {
      ...
      for (paramString1 = paramBundle;; paramString1 = new Bundle())
      {
        ...
        QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, localIntent, paramInt, null, paramBoolean);
        return;
      }
      return;
    }
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString1, String paramString2, String paramString3, String paramString4, long paramLong, int paramInt)
  {
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString1, String paramString2, ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, ArrayList<Long> paramArrayList, int paramInt, String paramString3, String paramString4)
  {
    Intent localIntent = new Intent("com.tencent.intent.QZONE_RESHIP_FROM_QUN_AIO_TO_QUN");
    a(localIntent, parambfpy);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, String paramString1, String paramString2, boolean paramBoolean, int paramInt)
  {
    parambfpy = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunFeed", "https://h5.qzone.qq.com/groupphoto/inqq/recent/{QUN_ID}/groupphoto?_wv=3&_proxy=1").replace("{QUN_ID}", paramString1);
    ...
    paramString1.putExtra("source_name", BaseApplicationImpl.getContext().getString(2131652127));
    paramString1.setData(Uri.parse(parambfpy));
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, boolean paramBoolean, String paramString1, String paramString2, int paramInt1, String paramString3, String paramString4, long paramLong1, long paramLong2, int paramInt2)
  {
  ...
  public static void a(Activity paramActivity, bfpy parambfpy, boolean paramBoolean, String paramString1, String paramString2, int paramInt1, ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, ArrayList<Long> paramArrayList3, ArrayList<Long> paramArrayList4, int paramInt2)
  {
    Intent localIntent = new Intent("com.tencent.intent.QZONE_QUOTE_FROM_AIO");
    a(localIntent, parambfpy);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
  ...
  public static void a(Activity paramActivity, String paramString1, int paramInt1, int paramInt2, long paramLong, String paramString2, String paramString3, String paramString4, int paramInt3, int paramInt4)
  {
    ...
    a(paramString1, localbfpy);
    QzonePluginProxyActivity.a(paramString1, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
    QzonePluginProxyActivity.a(paramActivity, localbfpy.jdField_a_of_type_JavaLangString, paramString1, paramInt3);
  }
  ...
  {
    bfpy localbfpy = bfpy.a();
    localbfpy.jdField_a_of_type_JavaLangString = paramString2;
    ...
    b(paramActivity, localbfpy, paramString2, -1);
  }
  ...
  public static void a(Context paramContext, bfpy parambfpy)
  {
    parambfpy = QzoneConfig.getInstance().getConfig("H5Url", "QzonePictureSettingPage", "https://h5.qzone.qq.com/image/setting/imageSetting?_wv=3&_proxy=1&uin={uin}").replace("{uin}", String.valueOf(parambfpy.jdField_a_of_type_JavaLangString)).replace("{host_uin}", parambfpy.jdField_a_of_type_JavaLangString).replace("{UIN}", String.valueOf(parambfpy.jdField_a_of_type_JavaLangString)).replace("{HOST_UIN}", parambfpy.jdField_a_of_type_JavaLangString);
    if (!befm.b(parambfpy).containsKey("_wv")) {
      befm.a(parambfpy, "_wv", "5");
    }
    if (QLog.isColorLevel()) {
      QLog.d("QZoneHelper", 2, "jump qzone setting URL:" + parambfpy);
    }
    Intent localIntent = new Intent(BaseApplication.getContext(), QQBrowserActivity.class);
    a(localIntent);
    localIntent.putExtra("url", parambfpy);
    ...
    localIntent.setData(Uri.parse(parambfpy));
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    do
    {
      ...
      azzz.a(BaseApplicationImpl.getContext(), "com.tencent.mobileqq:picture");
      ...
      azzz.a(BaseApplicationImpl.getContext(), "com.tencent.mobileqq:qzonevideo");
  ...
  public static void a(Intent paramIntent, bfpy parambfpy)
  {
    paramIntent.putExtra("qzone_uin", parambfpy.jdField_a_of_type_JavaLangString);
    paramIntent.putExtra("nickname", parambfpy.jdField_b_of_type_JavaLangString);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, bfpy parambfpy, int paramInt1, boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2, boolean paramBoolean3, boolean paramBoolean4, String paramString3, boolean paramBoolean5, String paramString4, String paramString5, boolean paramBoolean6, boolean paramBoolean7, boolean paramBoolean8, boolean paramBoolean9, String paramString6, boolean paramBoolean10, boolean paramBoolean11, boolean paramBoolean12, int paramInt2, boolean paramBoolean13, Bundle paramBundle)
  {
    ...
    if (paramBoolean12)
    {
      ...
      if (paramBoolean2)
      {
        parambfpy = acnc.a(ajed.bh);
        paramQQAppInterface.putBoolean("support_photo_merge", true);
        paramQQAppInterface.putString("qcamera_photo_filepath", parambfpy);
        ...
        paramQQAppInterface.putString("pic_confirm_text", ajjy.a(2131646125));
      }
    ...
    for (;;)
    {
      paramActivity.overridePendingTransition(2130772284, 2130772280);
      return;
      ...
      break;
      label387:
      babr.a(paramActivity, 230).setMessage(ajjy.a(2131646123)).setPositiveButton(2131629116, new bfpu()).show();
    }
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, PublishMoodInfo paramPublishMoodInfo, Intent paramIntent, int paramInt, boolean paramBoolean)
  {
    ...
    bfqn.a(paramQQAppInterface, paramActivity, localBundle, null, paramInt);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, ServiceConnection paramServiceConnection)
  {
    ...
    localbfdi.jdField_e_of_type_JavaLangString = "com.qzone.publish.business.publishqueue.PublishQueueService";
  ...
  public static void a(QQAppInterface paramQQAppInterface, aqdz paramaqdz)
  {
    ThreadManager.post(new QZoneHelper.8(paramQQAppInterface, paramaqdz), 8, null, false);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, aqdz paramaqdz)
  {
    ...
    {
      awqx.b(paramQQAppInterface, "CliOper", "", "", "0X8005E9C", "0X8005E9C", 1, 0, "", "", "", "");
      awrv.a().a("actQZLoadHitRateRed", true);
    }
    for (;;)
    {
      ...
      try
      {
        ...
        ((Intent)localObject).putExtra("cpuNum", babp.b());
      ...
      catch (Exception paramString)
      {
        ...
        paramString.jdField_a_of_type_Aqdz = paramaqdz;
        ...
        bfcz.c(paramQQAppInterface.getApp(), paramString);
      }
      ...
      awoa.e = System.currentTimeMillis();
      return;
      if ("Leba".equals(paramString))
      {
        awqx.b(paramQQAppInterface, "CliOper", "", "", "0X8005E9C", "0X8005E9C", 1, 0, "", "", "", "");
        awrv.a().a("actQZLoadHitRateLeba", true);
      }
      else if ("FriendProfileCardActivity".equals(paramString))
      {
        awrv.a().a("actQZLoadHitRateProfile", true);
      }
    }
    QLog.d("QZoneHelper", 1, "preloadQzone is not allowed as crash frequently.");
    awrn.a(BaseApplicationImpl.getContext()).a(paramQQAppInterface.getCurrentAccountUin(), "actNoPreloadQzone", true, 0L, 0L, null, "");
    return;
    label443:
    label463:
    return;
  ...
  public static void a(WebViewPlugin paramWebViewPlugin, bbac parambbac, Activity paramActivity, String paramString1, String paramString2)
  {
    Intent localIntent = new Intent();
    QzonePluginProxyActivity.a(localIntent, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
    localIntent.putExtra("startup_sceneid", 6);
    ...
    QzonePluginProxyActivity.a(paramActivity, paramString1, localIntent, a(paramWebViewPlugin, parambbac, 1));
  }
  ...
  public static void a(String paramString, Context paramContext)
  {
    ...
    ((Intent)localObject).putExtra("source_name", BaseApplicationImpl.getContext().getString(2131652127));
  ...
  public static void a(String paramString1, ArrayList<String> paramArrayList1, int paramInt1, LbsDataV2.PoiInfo paramPoiInfo, String paramString2, String paramString3, ArrayList<String> paramArrayList2, HashMap<String, String> paramHashMap1, HashMap<String, String> paramHashMap2, String paramString4, int paramInt2)
  {
    ...
    bgbz.a().a("cmd.publishMixMood", paramString2, false);
  }
  ...
  public static void a(String paramString1, ArrayList<String> paramArrayList1, int paramInt1, ArrayList<String> paramArrayList2, int paramInt2, int paramInt3, String paramString2, boolean paramBoolean1, boolean paramBoolean2, int paramInt4, String paramString3)
  {
    ...
    bgbz.a().a("cmd.publishMoodForAll", localBundle, false);
  }
  ...
  {
    bgdo.a(paramString1, paramInt1, paramString2, paramInt2);
  }
  ...
  public static void a(AppRuntime paramAppRuntime, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        apdh.c((String)localObject + File.separator + "qz_predownload_config.xml");
        apdh.c((String)localObject + File.separator + "QZ_Per_Config.xml");
        apdh.c((String)localObject + File.separator + "QZONE_UNREAD.xml");
      }
  ...
  public static void a(boolean paramBoolean, bfpx parambfpx)
  {
    if (!paramBoolean)
    {
      parambfpx.a(false, true);
      return;
    }
    ThreadManager.postImmediately(new QZoneHelper.6(parambfpx), null, true);
  }
  ...
  public static boolean a(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    if (QzoneConfig.getInstance().getConfig("QZoneSetting", "aio2qzonedetail", 1) == 1)
    {
      ...
      QzonePluginProxyActivity.a(paramActivity, bfpy.a().jdField_a_of_type_JavaLangString, paramString2, 0);
      if (QLog.isColorLevel()) {
  ...
  public static boolean a(Context paramContext, Intent paramIntent, boolean paramBoolean)
  {
    ...
    try
    {
      if ((awnu.a()) && (bfsz.b()))
      {
        if (((paramContext instanceof FragmentActivity)) && (!bfsz.a((FragmentActivity)paramContext, ((FragmentActivity)paramContext).app))) {
          return false;
        }
  ...
  {
    babr.a(paramActivity, 230).setMessage(2131652410).setPositiveButton(2131653652, paramOnClickListener).setNegativeButton(2131651963, new bfpt()).show();
  }
  
  public static void b(Activity paramActivity, bfpy parambfpy, int paramInt)
  {
    parambfpy = QzoneConfig.getInstance().getConfig("H5Url", "QzoneSettingMainPage", "https://h5.qzone.qq.com/qzone/setting?_wv=3&_proxy=1&uin={uin}").replace("{uin}", String.valueOf(parambfpy.jdField_a_of_type_JavaLangString)).replace("{host_uin}", parambfpy.jdField_a_of_type_JavaLangString).replace("{UIN}", String.valueOf(parambfpy.jdField_a_of_type_JavaLangString)).replace("{HOST_UIN}", parambfpy.jdField_a_of_type_JavaLangString);
    if (!befm.b(parambfpy).containsKey("_wv")) {
      befm.a(parambfpy, "_wv", "5");
    }
    if (QLog.isColorLevel()) {
  ...
  public static void b(Activity paramActivity, bfpy parambfpy, Intent paramIntent, int paramInt)
  {
  ...
  public static void b(Activity paramActivity, bfpy parambfpy, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = a(parambfpy, "com.qzone.album.business.photolist.activity.QZonePersonalPhotoListActivity");
    localIntent.putExtras(paramBundle);
    QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void b(Activity paramActivity, bfpy parambfpy, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt)
  {
    paramBaseBusinessAlbumInfo = a(parambfpy, paramBaseBusinessAlbumInfo);
  ...
  public static void b(Activity paramActivity, bfpy parambfpy, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt, String paramString)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambfpy);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.album.business.photolist.activity.QZonePersonalPhotoListActivity");
  ...
  public static void b(Activity paramActivity, bfpy parambfpy, Long paramLong, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    a(paramActivity, parambfpy, paramLong, paramInt1, paramBoolean, paramInt2, 12);
  }
  
  public static void b(Activity paramActivity, bfpy parambfpy, String paramString, int paramInt)
  {
    try
    {
      Intent localIntent = new Intent();
  ...
  public static void b(Activity paramActivity, bfpy parambfpy, String paramString1, long paramLong, String paramString2, int paramInt)
  {
  ...
  public static void b(Activity paramActivity, bfpy parambfpy, String paramString1, String paramString2, int paramInt)
  {
    parambfpy = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunAlbumDetail", "https://h5.qzone.qq.com/groupphoto/inqq/detail/{QQ_URL}?_wv=3&_proxy=1").replace("{QQ_URL}", URLEncoder.encode(paramString1));
    paramString1 = new Intent(BaseApplication.getContext(), QQBrowserDelegationActivity.class);
    paramString1.putExtra("url", parambfpy);
    paramString1.putExtra("fromQZone", true);
    paramString1.putExtra("injectrecommend", true);
  ...
  public static void b(Context paramContext, String paramString)
  {
    ...
    a((Activity)paramContext, bfpy.a(), localIntent);
  }
  ...
  {
    if (!bahj.a(paramQQAppInterface.getApp(), new String[] { paramString1 })) {
      return;
    }
    a(paramIntent, paramQQAppInterface, paramString2, paramBitmap);
    Thread.sleep(1000L);
    bahj.a(paramQQAppInterface, paramIntent, paramString2, paramBitmap);
    Thread.sleep(1000L);
  }
  ...
  public static void b(WebViewPlugin paramWebViewPlugin, bbac parambbac, Activity paramActivity, String paramString1, String paramString2)
  {
    paramString2 = new Intent();
    ...
    QzonePluginProxyActivity.a(paramActivity, paramString1, paramString2, a(paramWebViewPlugin, parambbac, 6));
  }
  ...
  public static void c(Activity paramActivity, bfpy parambfpy, int paramInt)
  {
    parambfpy = new SimpleDateFormat("yyyyMM", Locale.getDefault()).format(new Date());
    parambfpy = QzoneConfig.getInstance().getConfig("H5Url", "QzoneShuoshuoDailyCalendar", "https://h5.qzone.qq.com/v2/shuoshuo-daily/calendar/{date}?_wv=16777216").replace("{date}", parambfpy).replace("{DATE}", parambfpy);
    if (!befm.b(parambfpy).containsKey("_wv")) {
      befm.a(parambfpy, "_wv", "1027");
    }
    if (QLog.isColorLevel()) {
      QLog.d("QZoneHelper", 2, "jump qzone ShuoshuoDailyCalendar URL:" + parambfpy);
    }
    Intent localIntent = new Intent(BaseApplication.getContext(), QQBrowserActivity.class);
    a(localIntent);
    localIntent.putExtra("url", parambfpy);
  ...
  public static void c(Activity paramActivity, bfpy parambfpy, Intent paramIntent, int paramInt)
  {
    Intent localIntent = paramIntent;
    if (paramIntent == null) {
      localIntent = new Intent();
  ...
  public static void c(Activity paramActivity, bfpy parambfpy, Bundle paramBundle, int paramInt)
  {
    bgbz.a().a("cmd.cancelKillPictureProcess", null, false);
    Intent localIntent = a(parambfpy, "com.qzone.preview.QzonePictureViewer");
    localIntent.putExtras(paramBundle);
    localIntent.putExtra("fromQZone", false);
    QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, localIntent, paramInt, null, false);
  }
  
  public static void c(Activity paramActivity, bfpy parambfpy, String paramString, int paramInt)
  {
    ...
    localIntent.putExtra("key_title", ajjy.a(2131646120));
    localIntent.putExtra("key_desc", "");
    localIntent.putExtra("key_need_save_draft", false);
    QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void c(Activity paramActivity, bfpy parambfpy, String paramString1, String paramString2, int paramInt)
  {
    if (TextUtils.isEmpty(paramString1)) {
      return;
    }
    parambfpy = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunAlbumSelect", "https://h5.qzone.qq.com/groupphoto/inqq/album/{QUN_ID}/select?_wv=3&_proxy=1").replace("{QUN_ID}", paramString1);
    paramString1 = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramString1);
    paramString1.putExtra("url", parambfpy);
    if (bbaf.a.containsKey("Qzone")) {
  ...
  private static void c(Bitmap paramBitmap, @NonNull QQAppInterface paramQQAppInterface, String paramString1, long paramLong, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      if (Build.VERSION.SDK_INT < 26)
      {
        ...
        bahj.a(paramQQAppInterface, b(paramQQAppInterface, paramString1, paramLong), paramString2, paramBitmap);
        Thread.sleep(1000L);
        if (baii.a(paramQQAppInterface.getApplication(), new String[] { paramString1 }))
        {
          bcec.a().a(2131625739);
          return;
        }
  ...
  public static void d(Activity paramActivity, bfpy parambfpy, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = a(parambfpy, "com.qzone.album.business.dlna.activity.DLNAActivity");
    localIntent.putExtras(paramBundle);
    QzonePluginProxyActivity.a(paramActivity, parambfpy.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void d(Activity paramActivity, bfpy parambfpy, String paramString, int paramInt)
  {
    parambfpy = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunPassiveFeed", "https://h5.qzone.qq.com/groupphoto/inqq/relatedme/{QUN_ID}/{UIN}?_wv=3&_proxy=1").replace("{QUN_ID}", paramString).replace("{UIN}", parambfpy.jdField_a_of_type_JavaLangString);
    paramString = new Intent(BaseApplication.getContext(), QQBrowserDelegationActivity.class);
    paramString.putExtra("url", parambfpy);
    ...
    paramString.putExtra("source_name", BaseApplicationImpl.getContext().getString(2131652127));
    paramString.setData(Uri.parse(parambfpy));
  ...
  public static void e(Activity paramActivity, bfpy parambfpy, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = new Intent();
