...
public class ttd
{
  ...
  public static void a()
  {
    ...
    Object localObject = rvd.a;
    localObject = new VInstanceManager.Builder().application(BaseApplicationImpl.getApplication()).param(new JSONObject()).preconditionAdapter(new ttc((String)localObject)).serviceJsUrl((String)localObject).isBlockingMode(false);
