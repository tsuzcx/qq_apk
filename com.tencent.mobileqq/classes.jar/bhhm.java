  ...
  implements View.OnTouchListener
{
  ...
  private ScaleGestureDetector.OnScaleGestureListener jdField_a_of_type_AndroidViewScaleGestureDetector$OnScaleGestureListener = new bhhn(this);
  ...
  public bhhm(View paramView, Context paramContext, bhhi parambhhi, bhhw parambhhw)
  {
    this.jdField_a_of_type_Bhhi = parambhhi;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Int = parambhhw.a();
    this.jdField_b_of_type_Int = parambhhw.b();
    this.jdField_c_of_type_Int = parambhhw.d();
  ...
  private void a(float paramFloat1, float paramFloat2)
  {
    if (this.jdField_a_of_type_Bhhi != null) {
      this.jdField_a_of_type_Bhhi.a(paramFloat1, paramFloat2);
    }
    this.g += paramFloat1;
    this.h += paramFloat2;
    if (this.g > 90.0F) {
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    while (paramMotionEvent.getAction() != 2)
    {
      ...
      if (paramMotionEvent.getAction() == 1)
      {
        ...
        if ((Math.abs(f1 - this.i) <= m) && (Math.abs(f2 - this.j) <= m) && (this.jdField_a_of_type_Bhhi != null)) {
