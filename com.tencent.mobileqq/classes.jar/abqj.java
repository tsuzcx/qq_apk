  ...
  implements bewx
{
  ...
  public abqj(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          localObject2 = abqi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationInfo().sourceDir);
    ...
    for (int i = 0;; i = 1)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localObject1 = new bewr(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext(), (bewo)localObject1);
          if (localObject1 == null) {
            break;
          }
          localObject1 = (beww)((bewr)localObject1).a("sig_check");
          if (localObject1 == null) {
            break;
          }
          ((beww)localObject1).a(this);
          ((beww)localObject1).a(((JSONObject)localObject4).toString());
          return;
        }
