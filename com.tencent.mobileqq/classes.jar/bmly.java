  ...
  extends bmtx
{
  ...
  public bmly(bmlu parambmlu, @NonNull Drawable paramDrawable, @NonNull bmmc parambmmc, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    super(parambmmc.jdField_a_of_type_AndroidGraphicsPointF, parambmmc.jdField_a_of_type_Float, parambmmc.jdField_b_of_type_Float, parambmmc.c, parambmmc.d, parambmmc.jdField_a_of_type_Int, parambmmc.jdField_b_of_type_Int, true);
  ...
  public bmly(bmlu parambmlu, @NonNull Drawable paramDrawable, @NonNull bmmc parambmmc, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
  ...
  private void b(Canvas paramCanvas)
  {
    ...
    if (this.jdField_k_of_type_Int == 0)
    {
      ...
      if (!bmlu.d(this.jdField_b_of_type_Bmlu).a.e()) {
        break label133;
      }
      j = -1;
      i = -1;
    ...
    for (;;)
    {
      bmtu.a(paramCanvas, this.jdField_b_of_type_Bmlu.jdField_a_of_type_Bmtw, this, i, k, j);
      paramCanvas.restore();
      return;
      i = 2130844160;
      break;
  ...
  {
    if ((!this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.isInSegment(bmlu.c(this.jdField_b_of_type_Bmlu).a())) && (!this.jdField_k_of_type_Boolean)) {}
    do
    {
      return;
      float f2 = this.u;
      ...
      if ((this.jdField_d_of_type_Boolean) && (this.jdField_k_of_type_Boolean))
      {
        if ((this.jdField_g_of_type_Boolean) && (this.jdField_h_of_type_Boolean))
        {
          ...
          paramCanvas.drawLine(f2 + f1, f4 + f3, f6 + f5, this.t + f7, this.jdField_b_of_type_Bmlu.e);
          paramCanvas.save();
          paramCanvas.concat(this.jdField_b_of_type_Bmlu.jdField_a_of_type_Bmtw.b(this));
          int i = (int)(this.u * this.q * this.w) + this.jdField_j_of_type_Int * 2;
          int j = (int)(this.v * this.q * this.w) + this.jdField_j_of_type_Int * 2;
          paramCanvas.drawRect(new RectF(-i / 2, -j / 2, i / 2, j / 2), this.jdField_b_of_type_Bmlu.f);
          paramCanvas.restore();
        }
      ...
      paramCanvas.save();
      paramCanvas.concat(this.jdField_b_of_type_Bmlu.jdField_a_of_type_Bmtw.a(this));
      paramCanvas.translate(-this.u / 2.0F, -this.v / 2.0F);
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable.draw(paramCanvas);
      paramCanvas.restore();
      this.jdField_b_of_type_Bmlu.jdField_a_of_type_Bmtw.b(this);
  ...
  {
    if ((!this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.isInSegment(bmlu.e(this.jdField_b_of_type_Bmlu).a())) && (!this.jdField_k_of_type_Boolean)) {
      return;
    }
    float f2 = this.u;
    float f1 = this.v;
    ...
    if ((this.jdField_f_of_type_Boolean) && (this.jdField_h_of_type_Int == 0))
    {
      ...
      paramCanvas.drawBitmap(this.jdField_a_of_type_AndroidGraphicsBitmap.extractAlpha(this.jdField_b_of_type_Bmlu.g, null), null, new Rect((int)-this.p, (int)-this.p, this.jdField_a_of_type_AndroidGraphicsBitmap.getWidth() + (int)this.p, this.jdField_a_of_type_AndroidGraphicsBitmap.getHeight() + (int)this.p), this.jdField_b_of_type_Bmlu.g);
    }
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable.draw(paramCanvas);
    paramCanvas.restore();
  }
  ...
  public void a(String paramString)
  {
    ...
    {
      if (!(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable instanceof bmth)) {
        break label68;
      }
      this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = bmro.a((bmth)this.jdField_a_of_type_AndroidGraphicsDrawableDrawable, this.jdField_b_of_type_Bmlu.jdField_a_of_type_AndroidContentContext, paramString);
      if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null) {
        this.jdField_g_of_type_JavaLangString = ((bmth)this.jdField_a_of_type_AndroidGraphicsDrawableDrawable).c();
      }
    }
    while (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable == null)
    {
      ...
      if ((this.jdField_a_of_type_AndroidGraphicsDrawableDrawable instanceof BitmapDrawable)) {
        this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = bmro.a(this.jdField_g_of_type_JavaLangString, this.jdField_b_of_type_Bmlu.jdField_a_of_type_AndroidContentContext, paramString);
      }
    }
    ...
    if (f1 < bnoa.a(23.0F)) {
      this.jdField_b_of_type_AndroidGraphicsPointF.x = (this.jdField_b_of_type_AndroidGraphicsPointF.x - f1 + bnoa.a(23.0F));
    }
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable.setCallback(bmlu.f(this.jdField_b_of_type_Bmlu));
  ...
  public void b()
  {
    if (this.jdField_c_of_type_AndroidAnimationValueAnimator == null)
    {
      ...
      this.jdField_c_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bmlz(this));
      this.jdField_c_of_type_AndroidAnimationValueAnimator.addListener(new bmma(this));
    }
