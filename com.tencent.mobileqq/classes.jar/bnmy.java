  ...
  extends Drawable
{
  ...
  public bnmy(Context paramContext, String paramString)
  {
    this.jdField_a_of_type_Bnmo = new bnmo();
  ...
  public Bitmap a()
  {
    return a(this.jdField_a_of_type_Bnmo.a());
  }
  ...
  protected void c()
  {
    this.jdField_a_of_type_AndroidAnimationValueAnimator = ValueAnimator.ofObject(this.jdField_a_of_type_Bnmo, new Object[] { this.jdField_a_of_type_Bnmo.b(), this.jdField_a_of_type_Bnmo.a() });
    this.jdField_a_of_type_AndroidAnimationValueAnimator.setInterpolator(new DecelerateInterpolator());
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bnmz(this));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bnna(this));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.setDuration(this.jdField_a_of_type_Bnmo.a());
