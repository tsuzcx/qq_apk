...
public class bkon
{
  ...
  static
  {
    ...
    jdField_b_of_type_ArrayOfInt = new int[] { 2130845869, 2130845872, 2130845870, 2130845875, 2130845874 };
  }
  
  public bkon(Drawable paramDrawable, int paramInt1, int paramInt2)
  {
  ...
  public bkon(Drawable paramDrawable, int paramInt, String paramString)
  {
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramDrawable;
