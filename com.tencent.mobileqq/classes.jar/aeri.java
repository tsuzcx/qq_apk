...
public class aeri
  implements ajal
{
  public aeri(CustomizeStrategyFactory.SkinRedPacketStrategy.1 param1) {}
  ...
  public void onResult(int paramInt, PreloadManager.PathResult paramPathResult)
  {
    ...
    try
    {
      ...
      BitmapFactory.Options localOptions = bdhj.a(str1, paramInt);
    ...
    if (paramInt < j)
    {
      ...
      localObject2 = SafeBitmapFactory.decodeFile((String)localObject2, bdhj.a((String)localObject2, i));
