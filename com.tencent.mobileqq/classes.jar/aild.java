  ...
  implements aimh
{
  ...
  public aild(QQAppInterface paramQQAppInterface, aimj paramaimj, Activity paramActivity, SessionInfo paramSessionInfo, afwy paramafwy)
  {
  ...
  public View a(Object... paramVarArgs)
  {
    ...
    ((TextView)paramVarArgs.findViewById(2131374152)).setText(2131691598);
    ((ImageView)paramVarArgs.findViewById(2131374150)).setImageResource(2130849842);
    paramVarArgs.findViewById(2131374149).setOnClickListener(new aile(this));
    return paramVarArgs;
  }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (arcd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 1)) {
          return;
        }
        paramVarArgs = this.jdField_a_of_type_Afwy.a();
        ...
        if (j >= 0)
        {
          ...
          {
            i = paramInt;
            if (acwh.p(((ChatMessage)localObject2).msgtype))
            {
              i = paramInt;
