...
public class aild
  implements aikq, Handler.Callback
{
  ...
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler = new bhde(ThreadManager.getSubThreadLooper(), this);
  private int b;
  
  public aild(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, ailr paramailr)
  {
  ...
  {
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800524B", "0X800524B", 0, 0, String.valueOf(paramInt), "", "", "");
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    if (this.b == 0) {}
    for (String str = "0";; str = "1")
    {
      bdla.b(localQQAppInterface, "dc00899", "grp_lbs", "", "tmp_grey", "exp_oper", 0, 0, str, "", "", "");
      return this.jdField_a_of_type_Ailr.a(this, paramVarArgs);
    }
  }
  ...
  public MessageRecord a(Object... paramVarArgs)
  {
    ...
    for (paramVarArgs = paramVarArgs[0].toString();; paramVarArgs = null)
    {
      ...
      {
        MessageRecord localMessageRecord = bcsa.a(-2027);
        long l = bcrg.a();
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        } while (bcsc.a(paramMessage.msgtype));
      ...
      while (!TextUtils.isEmpty(paramMessage))
      {
        ...
        if (localGrayTipsConfig.sceneId == 4)
        {
          ...
          else
          {
            ...
            paramMessage.text = anvx.a(2131706680);
            paramMessage.highlightText = anvx.a(2131706679);
          }
      ...
      if (!bhfj.b(((ChatMessage)localObject).issend)) {
        break label1201;
      }
    ...
    } while (bhfj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (QQMessageFacade.Message)localObject));
    ...
    if (paramMessage != null)
    {
      ...
      if (bcsc.a(((ChatMessage)paramMessage.next()).msgtype)) {
        break label1348;
      }
      i += 1;
    }
    ...
    for (;;)
    {
      ...
      for (paramMessage = this.jdField_a_of_type_ComTencentMobileqqAppNearbyGrayTipsManager.c(this.b, this.jdField_a_of_type_Int, l1);; paramMessage = null)
      {
        ...
        if (bcsc.a(((ChatMessage)localObject).msgtype)) {
          break;
        }
