...
public class achy
  implements Runnable
{
  public achy(QfileLocalFileMediaTabView paramQfileLocalFileMediaTabView) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      break;
      QfileLocalFileMediaTabView.a(this.a, new achz(this, localArrayList, localHashMap2, localHashMap1, localLinkedHashMap));
      return;
    }
  }
}
