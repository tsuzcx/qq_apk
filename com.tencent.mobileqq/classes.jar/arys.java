  ...
  extends aryh
{
  ...
  private arvg jdField_a_of_type_Arvg = new aryt(this);
  private arwg jdField_a_of_type_Arwg = new arwg(this.jdField_a_of_type_AndroidOsBundle);
  protected ndm a;
  ...
  static
  {
    jdField_l_of_type_JavaLangString = alpo.a(2131705175);
  }
  
  public arys(Intent paramIntent)
  {
    super(paramIntent);
    this.jdField_d_of_type_Long = -1L;
    this.jdField_b_of_type_AndroidOsHandler = new aryz(this);
    this.jdField_a_of_type_Ndm = new arzb(this);
  }
  ...
  private void N()
  {
    ...
    if (!this.jdField_i_of_type_Boolean) {
      if ((!TextUtils.isEmpty(this.jdField_i_of_type_JavaLangString)) && (!this.jdField_i_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount())))
      {
        ...
        azmz.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "sha_pageview", 1, "", "", str2);
    ...
    for (;;)
    {
      bfdq.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), this.jdField_h_of_type_JavaLangString, str2, "10", "11", "0", (String)localObject, "0", "0", false);
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005A0F", "0X8005A0F", 0, 0, "1", "", "", "");
      return;
      if (!TextUtils.isEmpty(this.jdField_h_of_type_JavaLangString))
      {
        ...
        for (;;)
        {
          try
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(l1, this.jdField_h_of_type_JavaLangString, this.jdField_b_of_type_Long, new arza(this));
            i = 0;
          }
  ...
  private void a(long paramLong, String paramString1, String paramString2, int paramInt, String paramString3, boolean paramBoolean)
  {
    ...
    if (i == 11)
    {
      ...
      {
        paramString1 = azqn.a((String)localObject);
        if (!TextUtils.isEmpty(paramString1)) {
          azmj.b(null, "CliOper", "", "", "0X8005F53", "0X8005F53", 0, 0, azqn.a(paramInt) + "", "", paramString1, "");
        }
      }
    }
    ...
    if ((localObject != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
    {
      ...
      azmj.b(null, "dc00898", "", "", "0X8009C93", "0X8009C93", 0, 0, "", "4", paramString3, str);
      ...
      paramString1 = aekt.a(localIntent, new int[] { 2 });
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_AndroidOsBundle.getBoolean("share_msg_by_server_enable_entry", false)) && (i == 11))
      {
        ...
        new arye().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (AbsStructMsg)localObject, this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, paramString1);
        break;
      }
      a((AbsStructMsg)localObject, paramString2, paramInt, paramString3);
      break;
      label531:
      paramString1 = aekt.a(localIntent, null);
      paramString1.putExtra("share_from_aio", true);
    }
  }
  
  private void a(Bundle paramBundle, awfz paramawfz, String paramString1, String paramString2, String paramString3)
  {
    Object localObject;
    if ((paramawfz.jdField_a_of_type_JavaLangObject instanceof int[]))
    {
      int[] arrayOfInt = (int[])paramawfz.jdField_a_of_type_JavaLangObject;
      if (arrayOfInt.length == 5)
      {
        localObject = new oidb_cmd0xb77.ImageInfo();
        ((oidb_cmd0xb77.ImageInfo)localObject).md5.set(paramawfz.d);
        ((oidb_cmd0xb77.ImageInfo)localObject).uuid.set(paramawfz.c);
        ...
        ((oidb_cmd0xb77.ImageInfo)localObject).file_id.set((int)paramawfz.jdField_b_of_type_Long);
      }
    }
    for (paramawfz = (awfz)localObject;; paramawfz = null)
    {
      paramBundle = arzk.a(paramBundle, null, null, paramawfz);
      paramawfz = BaseApplicationImpl.getApplication().getRuntime();
      if (paramawfz == null)
      {
      ...
      arzy.a("KEY_STAGE_2_IMAGE_B77");
      mzy.a(paramawfz, new aryy(this, paramString2, paramString1, paramString3), paramBundle.toByteArray(), "OidbSvc.0xb77_9", 2935, 9, (Bundle)localObject, 0L);
      return;
    }
  }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    arwa.a().a(paramString2, paramString1);
  }
  ...
  private boolean a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    for (;;)
    {
      ...
      {
        azqj localazqj = (azqj)paramAbsStructMsg.get(i);
        if (!(localazqj instanceof aztc)) {
          break label95;
        }
        paramAbsStructMsg = (aztc)localazqj;
        bool1 = bool2;
  ...
  private boolean q()
  {
    ...
    arve localarve = ((arzd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(350)).a();
    if (localarve.b())
    {
    ...
    if (localarve.c())
    {
      ...
      this.jdField_a_of_type_Arua = localarve.a(this.jdField_b_of_type_Long);
      return false;
    }
    if (localarve.a())
    {
      QLog.d("ForwardOption.ForwardSdkShareOption", 1, "--> hasValidAppInfo");
      this.jdField_a_of_type_Arua = localarve.a();
      e();
      return false;
    }
    QLog.d("ForwardOption.ForwardSdkShareOption", 1, "--> waiting d55 back");
    localarve.a(this.jdField_a_of_type_Arvg);
    a(2131719368);
    return true;
  }
  ...
  private boolean r()
  {
    ...
    if ((TextUtils.isEmpty(this.jdField_a_of_type_AndroidOsBundle.getString("image_url_remote"))) || (!arzk.a())) {
      bool = true;
    }
    return bool;
  }
  ...
  protected void L()
  {
    ...
    azmz.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "", "multi_account", "push_login_window", 0, 1, 0);
    ...
    this.jdField_b_of_type_Bdfq.setMessage(2131695720);
    this.jdField_b_of_type_Bdfq.setTitle(2131692310);
    arzc localarzc = new arzc(this);
    this.jdField_b_of_type_Bdfq.setNegativeButton(2131690648, localarzc);
    this.jdField_b_of_type_Bdfq.setPositiveButton(2131719919, localarzc);
    this.jdField_b_of_type_Bdfq.show();
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_Arwg.a(paramQQAppInterface, paramActivity);
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      ...
      if (r())
      {
        H();
        if (bool2) {
          bfja.a().a(0, "SHARE_CHECK_AGENT", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), String.valueOf(this.jdField_b_of_type_Long), null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, null);
        }
      }
      try
      {
  ...
  protected boolean a(bdfq parambdfq)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg == null)
    {
      ...
      if (!AbsShareMsg.class.isInstance(localObject))
      {
        ...
        a(-1, alpo.a(2131705172), alpo.a(2131705199));
      }
    }
    try
    {
      bfja.a().a(1, "SHARE_CHECK_AGENT", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), String.valueOf(this.jdField_b_of_type_Long), null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "类型错误");
      label145:
      return false;
      ...
      if (!this.jdField_a_of_type_AndroidOsBundle.getBoolean("key_sdk_share_pure_text"))
      {
        ...
        ((LinearLayout.LayoutParams)localObject).setMargins(aekt.a(-15.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, aekt.a(-15.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), aekt.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
        if (QLog.isColorLevel()) {
        ...
        parambdfq.addView(this.jdField_a_of_type_Aryq.a(), (LinearLayout.LayoutParams)localObject);
      ...
      for (;;)
      {
        ...
        parambdfq.adjustMessageTopBottomMargin(0.0F, 0.0F);
        break;
        label400:
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForAudioShare))
        {
          ((LinearLayout.LayoutParams)localObject).setMargins(0, aekt.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, aekt.a(10.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
          break;
        }
        if (!(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare)) {
          break;
        }
        ((LinearLayout.LayoutParams)localObject).setMargins(aekt.a(-10.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, aekt.a(-7.5F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0);
        break;
        label490:
  ...
  protected boolean a(AbsStructMsg paramAbsStructMsg, String paramString1, int paramInt, String paramString2)
  {
    ...
    paramString1 = (ArkAppMessage)anjp.a(2, paramString1, this.jdField_a_of_type_AndroidOsBundle, localObject1);
    ...
    for (;;)
    {
      ...
      for (paramString2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();; paramString2 = localSessionInfo.b)
      {
        ...
        paramString1.containStructMsg = ayvw.a((QQAppInterface)localObject2, str1, str2, paramString2, paramInt, i, paramAbsStructMsg);
        if ((!TextUtils.isEmpty(((ArkAppMessage)localObject1).appName)) && (!TextUtils.isEmpty(((ArkAppMessage)localObject1).appView)) && (!TextUtils.isEmpty(((ArkAppMessage)localObject1).metaList))) {
          anjv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((ArkAppMessage)localObject1).appName, "AIOArkSdkSendMessage", 1, 0, 0L, 0L, 0L, ((ArkAppMessage)localObject1).appView, "");
        }
        acex.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localSessionInfo, paramString1);
        return true;
      }
    }
  }
  ...
  public DeviceInfo[] a(DeviceInfo[] paramArrayOfDeviceInfo)
  {
    ...
    while (i < j)
    {
      ...
      {
        LightAppSettingInfo localLightAppSettingInfo = ((aabb)localObject).a(localDeviceInfo);
  ...
  public void b(int paramInt)
  {
    ...
    if (paramInt == k.intValue())
    {
      ...
      default: 
        ...
        localIntent.putExtra("dataline_forward_text", alpo.a(2131705177));
      }
    }
    Bundle localBundle;
    for (;;)
    {
      ...
      localBundle.putLong("res_share_id", bdaw.a(this.jdField_b_of_type_Long));
      ...
      else
      {
        ...
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004931", "0X8004931", 0, 0, "", "", "", "");
        if (QLog.isColorLevel())
        {
    ...
    for (;;)
    {
      ...
      continue;
      label1243:
      localObject = this.jdField_a_of_type_Arua.b();
      break label373;
      label1255:
      localObject = this.jdField_a_of_type_Arua.a();
      break label397;
      label1267:
      localObject = this.jdField_a_of_type_Arua.c();
      break label421;
      label1279:
      localObject = this.jdField_a_of_type_Arua.d();
      break label445;
      label1291:
      localIntent.putExtras(localBundle);
  ...
  {
    if ((this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("qqfav_extra_from_sdk_share", false)) || (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("qqfav_extra_from_system_share", false))) {
      return this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131698388);
    }
  ...
  protected boolean c()
  {
    ...
    try
    {
      bfja.a().a(0, "SHARE_TO_QQ", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), String.valueOf(this.jdField_b_of_type_Long), String.valueOf(i), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, null);
      label99:
      String str1;
      label110:
      String str2;
      ...
      if (this.jdField_d_of_type_Int == 1)
      {
        ...
        str2 = "1";
        bfdq.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "", this.jdField_b_of_type_Long + "", "10", "12", "0", str1, str3, str2, false);
        if ((QSecFramework.a().a(1003).booleanValue()) && (this.jdField_c_of_type_Boolean))
        {
          ...
          if ((!TextUtils.isEmpty(str2)) && (!bewm.a().a())) {
            bewm.a().a(null, str2);
          }
          if (this.jdField_d_of_type_Int != 1) {
            break label383;
          }
          bewm.a().a(2, str3, i, str1);
        }
      }
      for (;;)
      {
  ...
  protected int d()
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
        {
          ...
          localObject3 = birl.a((StructMsgForImageShare)this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg);
          m = k;
          ArrayList localArrayList;
          if (localObject3 != null)
          {
            localArrayList = new ArrayList();
            localArrayList.add(((azsp)localObject3).S);
            m = a(localArrayList);
            if (m == 0) {
              break label387;
            }
        ...
        for (;;)
        {
          ...
          {
            break;
            if (!biqt.a((ArrayList)localObject3, bool, this.jdField_a_of_type_AndroidContentIntent.getStringExtra("qqfav_extra_richmedia_title"), this.jdField_a_of_type_AndroidContentIntent.getStringExtra("qqfav_extra_mixed_msg"), true, this.jdField_b_of_type_Long, (String)localObject2).a(l2, str).b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), -1, null)) {
              break label793;
            }
            k = 0;
            break label538;
            if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg != null)
            {
              ...
              i = 2;
              localObject2 = birl.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.getXmlBytes());
              m = 0;
              if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForAudioShare))
              {
                m = 2;
    ...
    if (this.jdField_a_of_type_AndroidOsBundle.getBoolean("key_sdk_share_pure_text"))
    {
      ...
      if (TextUtils.isEmpty(this.jdField_a_of_type_AndroidOsBundle.getString("qqfav_extra_richmedia_title")))
      {
        ...
        localObject1 = biqt.a(null, false, this.jdField_a_of_type_AndroidOsBundle.getString("qqfav_extra_richmedia_title"), this.jdField_a_of_type_AndroidOsBundle.getString("qqfav_extra_mixed_msg"), true, this.jdField_b_of_type_Long, (String)localObject2).a(l2, (String)localObject1);
        ...
        bool = true;
        if (!((biqt)localObject1).a((Activity)localObject2, (String)localObject3, -1, null, bool)) {
          break label795;
        }
        i = 0;
        j = 0;
        ...
        i = m;
        if (k == 0) {
          birh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "User_AddFav", i, 0, 69, j, "", "");
        }
        return k;
      }
    }
  ...
  protected void d()
  {
    ...
    Object localObject2 = this.jdField_a_of_type_Bdfq.getInputValue();
    ...
    boolean bool = azqu.a(this.jdField_a_of_type_AndroidOsBundle) instanceof StructMsgForImageShare;
    if (bool)
    {
      this.jdField_a_of_type_AndroidOsBundle.putString("share_comment_message", this.jdField_a_of_type_Bdfq.getInputValue());
    ...
    if (f()) {
      if (TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        this.jdField_a_of_type_Arwg.a(b());
      }
    }
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("forward_mini_program_ark_from_sdk", false)) {
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009F7B", "0X8009F7B", 0, 0, "1", "", "", "");
      }
      return;
      localObject1 = "1";
      break;
      ...
      break label260;
      label341:
      this.jdField_j_of_type_JavaLangString = this.jdField_a_of_type_Bdfq.getInputValue();
      super.d();
      continue;
      label359:
      ...
      else
      {
        ...
        {
          azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007C3A", "0X8007C3A", 0, 0, "2", "", "", "");
          ...
          ((Bundle)localObject1).putString("intext_1", "" + bfdw.a(this.jdField_d_of_type_Int));
          ((Bundle)localObject1).putString("intext_2", "" + bfdw.a(this.jdField_a_of_type_AndroidOsBundle.getInt("uintype"), this.jdField_a_of_type_AndroidOsBundle.getString("uin")));
          ((Bundle)localObject1).putString("intext_3", "0");
          bfdq.a().a((Bundle)localObject1, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
        }
      }
    }
  }
  ...
  protected void d(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 0)
      {
        ...
        if (!bool) {
          birl.a(this.jdField_a_of_type_AndroidAppActivity, 2131698476, 2);
        }
      }
      while (!bool)
      {
        ...
        localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131698475);
        ...
        localObject = str;
        if (TextUtils.isEmpty(str)) {
          localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131698467);
        }
        localObject = (String)localObject;
        localObject = bdcd.a(this.jdField_a_of_type_AndroidAppActivity, 230, this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131720042), this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131698469), (String)localObject, this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131695052), new aryu(this), new aryv(this));
        ((bdfq)localObject).setOnDismissListener(new aryw(this));
        if (!this.jdField_a_of_type_AndroidAppActivity.isFinishing())
        {
          ...
          continue;
          if (2 == paramInt) {
            birl.a(this.jdField_a_of_type_AndroidAppActivity, 2131695350, 1);
          } else if (3 == paramInt) {
            birl.a(this.jdField_a_of_type_AndroidAppActivity, 2131698474, 1);
          } else {
            birl.a(this.jdField_a_of_type_AndroidAppActivity, 2131698468, 1);
          }
        }
      }
    }
  ...
  protected boolean d()
  {
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        if (this.jdField_l_of_type_Boolean)
        {
          ...
          try
          {
            ...
            if ((this.jdField_a_of_type_Arua == null) && (QLog.isColorLevel())) {
      ...
      if (this.jdField_a_of_type_Arua == null)
      {
        ...
        arzy.a("KEY_GET_APP_INFO");
        zbj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_b_of_type_Long, str2, l1, this.jdField_a_of_type_MqqObserverBusinessObserver, str1);
        try
        {
          jdField_a_of_type_JavaLangObject.wait(20000L);
        }
  ...
  protected void r()
  {
    ...
    try
    {
      ...
      if ((!TextUtils.isEmpty(str1)) && (!TextUtils.isEmpty(str2)) && (!TextUtils.isEmpty((CharSequence)localObject))) {
        anjv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str1, "AIOArkSdkSendClosed", 1, 0, 0L, 0L, 0L, str2, "");
      }
      label95:
      if (f()) {
      ...
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007C3A", "0X8007C3A", 0, 0, "2", "", "", "");
      if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("forward_mini_program_ark_from_sdk", false)) {
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009F7B", "0X8009F7B", 0, 0, "2", "", "", "");
      }
      if ((this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("qqfav_extra_from_sdk_share", false)) || (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("qqfav_extra_from_system_share", false))) {
  ...
  public void w()
  {
    ...
    if ((this.jdField_b_of_type_Zcs != null) && (this.jdField_b_of_type_Zcs.isShowing())) {
      this.jdField_b_of_type_Zcs.dismiss();
    }
  ...
  protected void y()
  {
    AbsStructMsg localAbsStructMsg = azqu.a(this.jdField_a_of_type_AndroidOsBundle);
    if (localAbsStructMsg != null) {
      ((ztk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(49)).a().a(this.jdField_a_of_type_AndroidOsBundle.getString("uin"), localAbsStructMsg);
    }
  ...
  public void z()
  {
    ...
    localBundle.putString("text_filter_default_screen_touch_tips", alpo.a(2131705188));
    localxlb.a(this.jdField_a_of_type_AndroidAppActivity, localBundle, 20004);
    this.jdField_a_of_type_AndroidAppActivity.overridePendingTransition(2130772232, 2130772038);
    wta.a("share", "clk_videoclips", 0, 0, new String[0]);
  }
}
