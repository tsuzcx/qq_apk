  ...
  implements INetEngine.INetEngineListener
{
  ...
  ArrayList<apgg> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  static
  {
    jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$IBreakDownFix = new apgf();
  }
  
  public apge(AppInterface paramAppInterface, apgi paramapgi)
  {
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    this.jdField_a_of_type_Apgi = paramapgi;
  }
  
  private void a(apgg paramapgg)
  {
    if ((TextUtils.isEmpty(paramapgg.jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(paramapgg.jdField_b_of_type_JavaLangString))) {
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.i("ArConfig_ArResourceDownload", 2, "downLoad:url=" + paramapgg.jdField_a_of_type_JavaLangString + ",md5= " + paramapgg.jdField_b_of_type_JavaLangString);
    }
    paramapgg.jdField_b_of_type_Int += 1;
    ...
    localHttpNetReq.mReqUrl = paramapgg.jdField_a_of_type_JavaLangString;
    localHttpNetReq.mHttpMethod = 0;
    localHttpNetReq.mOutPath = paramapgg.c;
    localHttpNetReq.mPrioty = 1;
    localHttpNetReq.setUserData(paramapgg);
    ...
    paramapgg.jdField_a_of_type_ComTencentMobileqqTransfileHttpNetReq = localHttpNetReq;
  }
  ...
  private void a(ArCloudConfigInfo paramArCloudConfigInfo)
  {
    ...
    if (paramArCloudConfigInfo.jdField_d_of_type_Int == 100)
    {
      ...
      localObject1 = apfw.a() + "ar_model/" + paramArCloudConfigInfo.jdField_d_of_type_Int + File.separator + paramArCloudConfigInfo.jdField_a_of_type_ComTencentMobileqqArModelArModelResource.jdField_a_of_type_JavaLangString + "_model.zip";
    }
    for (;;)
    {
      if (localFile == null)
      ...
      try
      {
        String str = aznv.a(localFile.getAbsolutePath());
        localObject2 = str;
        if (QLog.isColorLevel())
        {
          localObject2 = str;
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      synchronized (this.jdField_a_of_type_ArrayOfByte)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (localapgg.jdField_b_of_type_Long < localapgg.jdField_a_of_type_Long) {
            this.jdField_a_of_type_ComTencentMobileqqTransfileINetEngine.cancelReq(localapgg.jdField_a_of_type_ComTencentMobileqqTransfileHttpNetReq);
          }
        }
      }
  ...
  public void a(ArConfigInfo paramArConfigInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          paramArConfigInfo = (apgg)this.jdField_a_of_type_JavaUtilArrayList.get(k);
          if (!paramBoolean1) {
            break label1279;
          }
          paramArConfigInfo.jdField_b_of_type_Boolean = true;
          if (this.jdField_a_of_type_Apgi.a(paramArConfigInfo.jdField_b_of_type_JavaLangString)) {
            break label1279;
          }
      ...
      {
        localObject1 = new apgg();
        ((apgg)localObject1).jdField_a_of_type_Int = 2;
        ((apgg)localObject1).jdField_a_of_type_JavaLangString = ((ArCloudConfigInfo)localObject4).jdField_a_of_type_ComTencentMobileqqArModelArFeatureInfo.jdField_b_of_type_JavaLangString;
        ((apgg)localObject1).jdField_b_of_type_JavaLangString = ((ArCloudConfigInfo)localObject4).jdField_a_of_type_ComTencentMobileqqArModelArFeatureInfo.jdField_a_of_type_JavaLangString;
        ((apgg)localObject1).c = ((ArCloudConfigInfo)localObject4).jdField_a_of_type_ComTencentMobileqqArModelArFeatureInfo.c;
        ((apgg)localObject1).jdField_a_of_type_Long = ((ArCloudConfigInfo)localObject4).jdField_a_of_type_ComTencentMobileqqArModelArFeatureInfo.jdField_a_of_type_Long;
        ((apgg)localObject1).jdField_a_of_type_Boolean = true;
        if (!this.jdField_a_of_type_JavaUtilSet.contains(((apgg)localObject1).jdField_b_of_type_JavaLangString))
        {
          this.jdField_a_of_type_JavaUtilSet.add(((apgg)localObject1).jdField_b_of_type_JavaLangString);
        ...
        if ((localObject1 != null) && (((File)localObject1).exists()) && (!TextUtils.isEmpty((CharSequence)localObject3)))
        {
          ...
          if (paramBoolean2)
          {
            ...
            try
            {
              localObject1 = new File(((ArCloudConfigInfo)localObject4).jdField_a_of_type_ComTencentMobileqqArModelArModelResource.f);
              j = i;
              apmw.a(((ArCloudConfigInfo)localObject4).jdField_a_of_type_ComTencentMobileqqArModelArModelResource.f, ((File)localObject1).getParentFile().getAbsolutePath() + File.separator + ((ArCloudConfigInfo)localObject4).jdField_a_of_type_ComTencentMobileqqArModelArModelResource.jdField_a_of_type_JavaLangString + File.separator);
              j = 1;
            ...
            catch (Exception localException)
            {
              ...
              localObject2 = new apgg();
              ((apgg)localObject2).jdField_a_of_type_Int = 3;
              ((apgg)localObject2).jdField_a_of_type_JavaLangString = ((ArCloudConfigInfo)localObject4).jdField_a_of_type_ComTencentMobileqqArModelArModelResource.jdField_b_of_type_JavaLangString;
              ((apgg)localObject2).jdField_b_of_type_JavaLangString = ((ArCloudConfigInfo)localObject4).jdField_a_of_type_ComTencentMobileqqArModelArModelResource.jdField_a_of_type_JavaLangString;
              ((apgg)localObject2).c = ((ArCloudConfigInfo)localObject4).jdField_a_of_type_ComTencentMobileqqArModelArModelResource.f;
              ((apgg)localObject2).jdField_a_of_type_Long = ((ArCloudConfigInfo)localObject4).jdField_a_of_type_ComTencentMobileqqArModelArModelResource.jdField_a_of_type_Long;
              ((apgg)localObject2).jdField_a_of_type_Boolean = true;
              if (this.jdField_a_of_type_JavaUtilSet.contains(((apgg)localObject2).jdField_b_of_type_JavaLangString)) {
                break label1566;
              }
            }
            this.jdField_a_of_type_JavaUtilSet.add(((apgg)localObject2).jdField_b_of_type_JavaLangString);
      ...
      else if ((((ArCloudConfigInfo)localObject4).jdField_a_of_type_JavaUtilArrayList != null) && (((ArCloudConfigInfo)localObject4).jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        ...
        for (;;)
        {
          ...
          try
          {
            localObject2 = aznv.a(((File)localObject4).getAbsolutePath());
            if (((!((File)localObject4).exists()) || (TextUtils.isEmpty((CharSequence)localObject2)) || (!((String)localObject2).equals(localArVideoResourceInfo.c))) && (!this.jdField_a_of_type_JavaUtilSet.contains(localArVideoResourceInfo.jdField_d_of_type_JavaLangString)))
            {
              localObject2 = new apgg();
              ((apgg)localObject2).jdField_a_of_type_Int = 3;
              ((apgg)localObject2).jdField_a_of_type_JavaLangString = localArVideoResourceInfo.jdField_d_of_type_JavaLangString;
              ((apgg)localObject2).jdField_b_of_type_JavaLangString = localArVideoResourceInfo.c;
              ((apgg)localObject2).jdField_a_of_type_Long = localArVideoResourceInfo.jdField_a_of_type_Long;
              ((apgg)localObject2).c = localArVideoResourceInfo.e;
              ((apgg)localObject2).jdField_a_of_type_Boolean = true;
              this.jdField_a_of_type_JavaUtilArrayList.add(localObject2);
        ...
        if (i != 0)
        {
          this.jdField_a_of_type_Apgi.a(paramArConfigInfo);
          continue;
          this.jdField_a_of_type_Long += paramArConfigInfo.jdField_a_of_type_Long;
          j = ((apgi)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(QQManagerFactory.AR_RESOURCE_MANAGER)).d();
          if (!QLog.isColorLevel()) {
            break label1582;
          }
  ...
  public void onResp(NetResp paramNetResp)
  {
    ...
    if (paramNetResp.mResult == 0)
    {
      ...
      if (??? != null)
      {
        ...
        if ((??? instanceof apgg))
        {
          localObject3 = this.jdField_a_of_type_Apgi.a();
          localapgg = (apgg)???;
          if (!TextUtils.isEmpty(localHttpNetReq.mOutPath)) {
            break label1267;
          }
          QLog.d("ArConfig_ArResourceDownload", 1, "req.mOutPath is null, md5=" + localapgg.jdField_b_of_type_JavaLangString);
          if (!bool1) {
            break label766;
          }
          i = 98765;
    ...
    for (;;)
    {
      ...
      if (bool1)
      {
        ...
        ??? = aznv.a(((File)???).getAbsolutePath());
        if ((!TextUtils.isEmpty((CharSequence)???)) && (!((String)???).equalsIgnoreCase(localapgg.jdField_b_of_type_JavaLangString)))
        {
          if (QLog.isColorLevel()) {
            QLog.d("ArConfig_ArResourceDownload", 2, "Md5 error|fileMD5=" + (String)??? + ", type=" + localapgg.jdField_a_of_type_Int);
          }
          j = i;
          bool2 = bool1;
          if (localapgg.jdField_a_of_type_Int != 1)
          {
            ((File)???).delete();
            bool2 = false;
            j = -100001;
          }
          if (localapgg.jdField_b_of_type_Boolean) {
            this.jdField_a_of_type_Apgi.a(localapgg.jdField_b_of_type_JavaLangString, true);
          }
          bool1 = bool2;
          i = j;
          if (this.jdField_a_of_type_JavaUtilSet.contains(localapgg.jdField_b_of_type_JavaLangString)) {
            this.jdField_a_of_type_JavaUtilSet.remove(localapgg.jdField_b_of_type_JavaLangString);
          }
          if (this.jdField_a_of_type_JavaUtilSet.isEmpty()) {
            this.jdField_a_of_type_Boolean = false;
          }
          if ((localapgg.jdField_a_of_type_Int != 1) && (localapgg.jdField_a_of_type_Int != 2) && (localapgg.jdField_a_of_type_Int != 3) && (localapgg.jdField_a_of_type_Int != 4)) {
            break label1104;
          }
          j = 1;
          ??? = "0";
          ...
          ??? = new HashMap();
          ((HashMap)???).put("url", ayym.a(localHttpNetReq.mReqUrl));
          ((HashMap)???).put("resultCode", String.valueOf(paramNetResp.mResult));
          ((HashMap)???).put("fileSize", String.valueOf(localapgg.jdField_a_of_type_Long));
      ...
      for (;;)
      {
        synchronized (this.jdField_a_of_type_ArrayOfByte)
        {
          for (;;)
          {
            ...
            j = i;
            bool2 = bool1;
            if (localapgg.jdField_a_of_type_Int != 3) {
              break label264;
            }
            try
            {
              synchronized (this.jdField_a_of_type_ArrayOfByte)
              {
                Object localObject4 = ((ArConfigInfo)localObject3).getModelResByMd5(localapgg.jdField_b_of_type_JavaLangString);
                if ((!TextUtils.isEmpty(localapgg.c)) && (localObject4 != null) && ((((ArCloudConfigInfo)localObject4).jdField_d_of_type_Int == 0) || (((ArCloudConfigInfo)localObject4).jdField_d_of_type_Int == 100)))
                {
                  localObject4 = new File(localapgg.c);
                  apmw.a(localapgg.c, ((File)localObject4).getParentFile().getAbsolutePath() + File.separator + localapgg.jdField_b_of_type_JavaLangString + File.separator);
                  this.jdField_a_of_type_Apgi.a((ArConfigInfo)localObject3);
                }
                j = i;
                bool2 = bool1;
              }
            ...
            {
              ((File)???).delete();
              if (localapgg.jdField_a_of_type_Boolean)
              {
                bool1 = false;
                i = -100002;
              }
          ...
          bool2 = bool1;
          break label264;
          if ((localapgg.jdField_b_of_type_Int <= 3) && (!localapgg.jdField_b_of_type_Boolean))
          {
            a(localapgg);
            if (!QLog.isColorLevel()) {
              break;
            }
            QLog.i("ArConfig_ArResourceDownload", 2, "retry downLoad:retryUrl=" + localapgg.jdField_a_of_type_JavaLangString + ",retryMd5= " + localapgg.jdField_b_of_type_JavaLangString);
            return;
          }
          if (localapgg.jdField_b_of_type_Boolean) {
            this.jdField_a_of_type_Apgi.a(localapgg.jdField_b_of_type_JavaLangString, false);
          }
          break label291;
          j = 0;
        }
        ...
        synchronized (this.jdField_a_of_type_ArrayOfByte)
        {
          ...
          {
            localapgg = (apgg)((Iterator)localObject3).next();
            if (localapgg.jdField_b_of_type_Long < localapgg.jdField_a_of_type_Long) {
              this.jdField_a_of_type_ComTencentMobileqqTransfileINetEngine.cancelReq(localapgg.jdField_a_of_type_ComTencentMobileqqTransfileHttpNetReq);
            }
          }
        ...
        {
          this.jdField_a_of_type_Apgi.a(i, paramNetResp.mResult);
          this.jdField_b_of_type_Boolean = true;
        }
        continue;
        long l = 0L;
  ...
  public void onUpdateProgeress(NetReq arg1, long paramLong1, long paramLong2)
  {
    ...
    synchronized (this.jdField_a_of_type_ArrayOfByte)
    {
      ...
      {
        apgg localapgg = (apgg)localIterator.next();
        if (str.equals(localapgg.jdField_b_of_type_JavaLangString))
        {
          paramLong2 = localapgg.jdField_b_of_type_Long;
          localapgg.jdField_b_of_type_Long = paramLong1;
          this.jdField_b_of_type_Long += paramLong1 - paramLong2;
        }
      }
      if (!this.jdField_b_of_type_Boolean) {
        this.jdField_a_of_type_Apgi.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_Long);
      }
      return;
    }
  }
