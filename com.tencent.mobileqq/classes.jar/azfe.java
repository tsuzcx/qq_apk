...
public class azfe
  implements Handler.Callback, axkk
{
  private static azfe jdField_a_of_type_Azfe;
  private static Object jdField_a_of_type_JavaLangObject = new Object();
  public int a;
  private Handler jdField_a_of_type_AndroidOsHandler;
  public ConcurrentHashMap<String, awpy> a;
  ...
  {
    if (jdField_a_of_type_Azfe == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Azfe == null) {
        jdField_a_of_type_Azfe = new azfe();
      }
      return jdField_a_of_type_Azfe;
    }
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, Friends paramFriends, TextView paramTextView)
  {
    ...
    if ((!TextUtils.isEmpty(paramFriends.songName)) && (System.currentTimeMillis() < paramFriends.songEndTime))
    {
      ...
      {
        paramQQAppInterface = String.format(paramQQAppInterface.getString(2131698156), new Object[] { paramFriends.songName, paramFriends.singerName });
        if (!(paramTextView instanceof OnlineStatusLyricView)) {
          break label152;
        }
        ((azff)bofz.a().getBusinessHandler(BusinessHandlerFactory.ONLINE_STATUS_HANDLER)).a(paramFriends);
        ((OnlineStatusLyricView)paramTextView).setFriendSession(paramFriends, paramQQAppInterface);
      }
      for (;;)
      {
        bdla.b(null, "dc00898", "", "", "0X800AC92", "0X800AC92", paramFriends.songSourceType, 0, "", "0", "0", "");
        return paramQQAppInterface;
        paramQQAppInterface = String.format(paramQQAppInterface.getString(2131698157), new Object[] { paramFriends.songName });
        break;
        label152:
        paramQQAppInterface = aqsl.a(paramTextView.getPaint(), paramQQAppInterface, ViewUtils.dip2px(200.0F));
      }
    }
    return paramQQAppInterface.getString(2131698158);
  }
  ...
  public void a(Activity paramActivity, String paramString)
  {
    ...
    bdla.b(null, "dc00898", "", "", "0X800ABB2", "0X800ABB2", 0, 0, "", "0", "0", "");
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    default: 
      return false;
    case 1: 
      ((azff)a().getBusinessHandler(BusinessHandlerFactory.ONLINE_STATUS_HANDLER)).a(null);
      return false;
    case 2: 
      localazff = (azff)a().getBusinessHandler(BusinessHandlerFactory.ONLINE_STATUS_HANDLER);
      ...
      {
        localazff.a((MusicInfo)localObject, j, bool, QQMusicPlayService.a());
    ...
    azff localazff = (azff)a().getBusinessHandler(BusinessHandlerFactory.ONLINE_STATUS_HANDLER);
    Object localObject = QQPlayerService.b();
    if (paramMessage.arg1 == 1) {}
    for (boolean bool = true;; bool = false)
    {
      localazff.a((SongInfo)localObject, i, bool, QQPlayerService.d());
