  ...
  extends axgj
{
  ...
  static axhr jdField_a_of_type_Axhr;
  ...
  public int a;
  amez jdField_a_of_type_Amez = amez.a();
  public Camera a;
  axht jdField_a_of_type_Axht = new axht(this);
  axhu jdField_a_of_type_Axhu;
  ...
  static
  {
    if (!axhr.class.desiredAssertionStatus()) {}
  ...
  {
    if (jdField_a_of_type_Axhr == null) {}
    try
    {
      if (jdField_a_of_type_Axhr == null) {
        jdField_a_of_type_Axhr = new axhr();
      }
      return jdField_a_of_type_Axhr;
    }
    finally {}
  }
  
  private axhu a(List<Camera.Size> paramList, int paramInt1, int paramInt2)
  {
    int j = -1;
    ...
    for (;;)
    {
      ...
      if (i > 0)
      {
        localaxhu.jdField_b_of_type_Int = paramInt2;
        localaxhu.jdField_a_of_type_Int = i;
        if (localaxhu.jdField_a_of_type_Int / 4 == localaxhu.jdField_b_of_type_Int / 3)
        {
          if (QLog.isColorLevel()) {
  ...
  private axhu a(List<Camera.Size> paramList, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        if ((localSize != null) && (localSize.width >= paramInt1) && (localSize.height >= paramInt2) && (localSize.width / localSize.height >= d1))
        {
          ...
          if (l2 < l1)
          {
            localaxhu.jdField_a_of_type_Int = localSize.width;
            localaxhu.jdField_b_of_type_Int = localSize.height;
            l1 = l2;
          }
        }
        for (;;)
        {
          break;
          if ((l2 == l1) && (localSize.width < localaxhu.jdField_a_of_type_Int))
          {
            localaxhu.jdField_a_of_type_Int = localSize.width;
            localaxhu.jdField_b_of_type_Int = localSize.height;
          }
    ...
    if (((localaxhu.jdField_a_of_type_Int <= 0) || (localaxhu.jdField_b_of_type_Int <= 0)) && (paramList != null) && (!paramList.isEmpty()))
    {
      localIterator = paramList.iterator();
      l1 = 0L;
      if (localIterator.hasNext())
    ...
    if (QLog.isColorLevel()) {
      QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSize[self-adaption] cSize.width=" + localaxhu.jdField_a_of_type_Int + "  cSize.height=" + localaxhu.jdField_b_of_type_Int);
    }
    if ((localaxhu.jdField_a_of_type_Int > 0) && (localaxhu.jdField_b_of_type_Int > 0)) {
      return localaxhu;
    }
    if ((paramList != null) && (!paramList.isEmpty()) && (paramList.get(0) != null))
    {
      localaxhu.jdField_a_of_type_Int = ((Camera.Size)paramList.get(0)).width;
      localaxhu.jdField_b_of_type_Int = ((Camera.Size)paramList.get(0)).height;
      return localaxhu;
    }
    return null;
  }
  
  private axhu a(List<Camera.Size> paramList, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (((List)localObject1).size() == 0)
      {
        ...
        if (paramList.hasNext())
        {
          localObject3 = (axhu)paramList.next();
          if (localObject3 == null) {
            break label885;
          }
          paramInt1 = Math.max(((axhu)localObject3).jdField_a_of_type_Int, ((axhu)localObject3).jdField_b_of_type_Int);
          paramInt2 = Math.min(((axhu)localObject3).jdField_a_of_type_Int, ((axhu)localObject3).jdField_b_of_type_Int);
      ...
      for (;;)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          if (localObject1 != null)
          {
            ...
            for (;;)
            {
              ...
              QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getHighVersionPreviewSizeV2 secend: width=" + ((axhu)((List)localObject1).get(paramInt1)).jdField_a_of_type_Int + " height=" + ((axhu)((List)localObject1).get(paramInt1)).jdField_b_of_type_Int + " w/h=" + ((axhu)((List)localObject1).get(paramInt1)).jdField_a_of_type_Int / ((axhu)((List)localObject1).get(paramInt1)).jdField_b_of_type_Int);
              paramInt1 += 1;
            }
            f2 = 10000.0F;
          }
        ...
        if (((List)localObject1).size() == 0)
        {
          ...
          while (paramList.hasNext())
          {
            ...
            {
              paramInt1 = Math.max(((axhu)localObject2).jdField_a_of_type_Int, ((axhu)localObject2).jdField_b_of_type_Int);
              paramInt2 = Math.min(((axhu)localObject2).jdField_a_of_type_Int, ((axhu)localObject2).jdField_b_of_type_Int);
          ...
          if ((QLog.isColorLevel()) && (localObject1 != null))
          {
            ...
            {
              QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getHighVersionPreviewSizeV2 third: width=" + ((axhu)((List)localObject1).get(paramInt1)).jdField_a_of_type_Int + " height=" + ((axhu)((List)localObject1).get(paramInt1)).jdField_b_of_type_Int + " w/h=" + ((axhu)((List)localObject1).get(paramInt1)).jdField_a_of_type_Int / ((axhu)((List)localObject1).get(paramInt1)).jdField_b_of_type_Int);
              paramInt1 += 1;
            }
          }
        }
        if (((List)localObject1).size() > 0)
        {
          ...
          if ((localObject1 == null) || (((axhu)localObject1).jdField_a_of_type_Int * ((axhu)localObject1).jdField_b_of_type_Int <= paramList.jdField_a_of_type_Int * paramList.jdField_b_of_type_Int)) {
            break label882;
          }
  ...
  private int c()
  {
    ...
    float f = i * 1.0F / 8.0F;
    int j = (int)(this.jdField_a_of_type_Axhu.jdField_b_of_type_Int * this.jdField_a_of_type_Axhu.jdField_a_of_type_Int * f);
    if (QLog.isColorLevel()) {
      ...
      try
      {
        for (;;)
        {
          ...
          if (bfnz.c())
          {
            ...
            bjah.b(jdField_b_of_type_JavaLangString, "【Real Old openCamera】:" + this.jdField_a_of_type_Int);
            bjah.b(jdField_b_of_type_JavaLangString, "【Real Old openCamera】:currentCount= " + j);
          }
          for (this.jdField_a_of_type_AndroidHardwareCamera = Camera.open(this.jdField_a_of_type_Int);; this.jdField_a_of_type_AndroidHardwareCamera = Camera.open())
          {
            ...
            if (axhp.a().a(this.jdField_a_of_type_AndroidHardwareCamera)) {
              break label321;
            }
            if (QLog.isColorLevel()) {
          ...
          try
          {
            ...
            i = 3;
            break label83;
            this.jdField_a_of_type_Axht = new axht(this);
  ...
  public axhu a()
  {
    return this.jdField_a_of_type_Axhu;
  }
  
  public axhu a(int paramInt)
  {
    Object localObject2 = axhp.a().a();
    int i;
    ...
    if (((List)localObject1).size() > 0)
    {
      ...
      for (paramInt = 2147483647; ((Iterator)localObject1).hasNext(); paramInt = i)
      {
        ...
        if (((Camera.Size)localObject2).width < paramInt)
        {
          ...
          localaxhu.jdField_b_of_type_Int = ((Camera.Size)localObject2).height;
          localaxhu.jdField_a_of_type_Int = ((Camera.Size)localObject2).width;
        }
      }
    }
    if (localaxhu.jdField_a_of_type_Int > 0) {
      return localaxhu;
    }
    return null;
  }
  
  public axhu a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    Object localObject2 = axhp.a().a();
    ...
    label400:
    int i = axgi.jdField_c_of_type_Int;
    int j = axgi.d;
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (paramInt2 > 0)
      {
        localaxhu.jdField_b_of_type_Int = j;
        localaxhu.jdField_a_of_type_Int = paramInt2;
        if ((axhq.a()) && (a((ArrayList)localObject3, i, j))) {
          localaxhu.jdField_a_of_type_Int = i;
        }
        return localaxhu;
      }
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        if ((localObject5 != null) && (a(paramInt1, paramInt3, paramInt4, ((Camera.Size)localObject5).width, ((Camera.Size)localObject5).height)))
        {
          ...
          if (l2 < l1)
          {
            localaxhu.jdField_a_of_type_Int = ((Camera.Size)localObject5).width;
            localaxhu.jdField_b_of_type_Int = ((Camera.Size)localObject5).height;
            l1 = l2;
          }
        }
        for (;;)
        {
          break;
          if ((l2 == l1) && (((Camera.Size)localObject5).width < localaxhu.jdField_a_of_type_Int))
          {
            localaxhu.jdField_a_of_type_Int = ((Camera.Size)localObject5).width;
            localaxhu.jdField_b_of_type_Int = ((Camera.Size)localObject5).height;
          }
      ...
      for (;;)
      {
        ...
        if (paramInt1 > 0)
        {
          localaxhu.jdField_b_of_type_Int = i;
          localaxhu.jdField_a_of_type_Int = paramInt1;
          return localaxhu;
        }
        if ((localaxhu.jdField_a_of_type_Int <= 0) || (localaxhu.jdField_b_of_type_Int <= 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if (localObject4 != null)
            {
              ...
              if (l2 < l1)
              {
                localaxhu.jdField_a_of_type_Int = ((Camera.Size)localObject4).width;
                localaxhu.jdField_b_of_type_Int = ((Camera.Size)localObject4).height;
                l1 = l2;
              }
            }
            for (;;)
            {
              break;
              if ((l2 == l1) && (((Camera.Size)localObject4).width < localaxhu.jdField_a_of_type_Int))
              {
                localaxhu.jdField_a_of_type_Int = ((Camera.Size)localObject4).width;
                localaxhu.jdField_b_of_type_Int = ((Camera.Size)localObject4).height;
              }
        ...
        if ((localaxhu.jdField_a_of_type_Int <= 0) || (localaxhu.jdField_b_of_type_Int <= 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if ((localObject3 != null) && (a(320, paramInt3, paramInt4, ((Camera.Size)localObject3).width, ((Camera.Size)localObject3).height)))
            {
              ...
              if (l2 < l1)
              {
                localaxhu.jdField_a_of_type_Int = ((Camera.Size)localObject3).width;
                localaxhu.jdField_b_of_type_Int = ((Camera.Size)localObject3).height;
                l1 = l2;
              }
            }
            for (;;)
            {
              break;
              if ((l2 == l1) && (((Camera.Size)localObject3).width < localaxhu.jdField_a_of_type_Int))
              {
                localaxhu.jdField_a_of_type_Int = ((Camera.Size)localObject3).width;
                localaxhu.jdField_b_of_type_Int = ((Camera.Size)localObject3).height;
              }
        ...
        if ((localaxhu.jdField_a_of_type_Int <= 0) || (localaxhu.jdField_b_of_type_Int <= 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            {
              break;
              if ((l2 == l1) && (((Camera.Size)localObject2).width < localaxhu.jdField_a_of_type_Int))
              {
                localaxhu.jdField_a_of_type_Int = ((Camera.Size)localObject2).width;
                localaxhu.jdField_b_of_type_Int = ((Camera.Size)localObject2).height;
              }
        ...
        if (QLog.isColorLevel()) {
          QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getFullVideoPreviewSize[self-adaption] cSize.width=" + localaxhu.jdField_a_of_type_Int + "  cSize.height=" + localaxhu.jdField_b_of_type_Int);
        }
        if ((localaxhu.jdField_a_of_type_Int > 0) && (localaxhu.jdField_b_of_type_Int > 0)) {
          return localaxhu;
        }
  ...
  public axhu a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    if ((!jdField_c_of_type_Boolean) && (this.jdField_a_of_type_AndroidHardwareCamera == null)) {
      throw new AssertionError();
    }
    if ((!jdField_c_of_type_Boolean) && (this.jdField_a_of_type_Axhu == null)) {
      throw new AssertionError();
    }
    if (a() == null) {
      return null;
    ...
    axhu localaxhu = new axhu();
    Object localObject1 = axhp.a().b();
    if ((localObject1 == null) || (((List)localObject1).isEmpty())) {
      return null;
    }
    Object localObject2 = new axhu();
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localSize != null)
      {
        ...
        if (localSize.width >= paramInt1)
        {
          ...
          {
            f2 = Math.abs(f4 - f3);
            ((axhu)localObject2).jdField_a_of_type_Int = localSize.width;
            ((axhu)localObject2).jdField_b_of_type_Int = localSize.height;
          }
        }
        f1 = f2;
      }
    }
    if ((localArrayList.isEmpty()) && (((axhu)localObject2).jdField_a_of_type_Int >= paramInt1))
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "getPictureSize: width=" + ((axhu)localObject2).jdField_a_of_type_Int + " height=" + ((axhu)localObject2).jdField_b_of_type_Int + " w/h=" + ((axhu)localObject2).jdField_a_of_type_Int / ((axhu)localObject2).jdField_b_of_type_Int);
      }
      return localObject2;
    }
    if ((localArrayList.isEmpty()) && (((List)localObject1).size() > 0))
    {
      localaxhu.jdField_a_of_type_Int = ((Camera.Size)((List)localObject1).get(0)).width;
      localaxhu.jdField_b_of_type_Int = ((Camera.Size)((List)localObject1).get(0)).height;
      return localaxhu;
    }
    ...
    if (paramInt5 == -1)
    {
      ...
      {
        localObject2 = (Camera.Size)((Iterator)localObject1).next();
        if (localaxhu.jdField_a_of_type_Int < ((Camera.Size)localObject2).width)
        {
          localaxhu.jdField_a_of_type_Int = ((Camera.Size)localObject2).width;
          localaxhu.jdField_b_of_type_Int = ((Camera.Size)localObject2).height;
        }
    ...
    while (localaxhu.jdField_a_of_type_Int == 0)
    {
      return null;
      localaxhu = a(paramInt3, paramInt4, paramInt5, localArrayList);
    }
    return localaxhu;
  }
  
  public axhu a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    int j = 0;
    if (QLog.isColorLevel()) {
      QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSizeV2: dstwidth=" + paramInt1 + "  dstheight=" + paramInt2);
    }
    Object localObject = axhp.a().a();
    ...
    axhu localaxhu = a((List)localObject, paramInt1, paramInt2);
    if (localaxhu != null)
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSizeGuaranteeOK: DEFAULT resolution os OK.");
      }
      localObject = localaxhu;
      if (paramBoolean)
      {
        ahvx.a(2, paramInt1, paramInt2, localaxhu.jdField_a_of_type_Int, localaxhu.jdField_b_of_type_Int);
        localObject = localaxhu;
      }
    }
    do
    {
      ...
      {
        return localObject;
        localaxhu = a((List)localObject, 960, 720);
        if (localaxhu == null) {
          break;
        }
        if (QLog.isColorLevel()) {
      ...
      ahvx.a(3, paramInt1, paramInt2, localaxhu.jdField_a_of_type_Int, localaxhu.jdField_b_of_type_Int);
      return localaxhu;
      localaxhu = a((List)localObject, paramInt1, paramInt2, paramInt3, paramInt4);
      localObject = localaxhu;
    } while (!paramBoolean);
    if (localaxhu == null)
    {
    ...
    label379:
    for (paramInt4 = j;; paramInt4 = localaxhu.jdField_b_of_type_Int)
    {
      ahvx.a(4, paramInt1, paramInt2, paramInt3, paramInt4);
      return localaxhu;
      paramInt3 = localaxhu.jdField_a_of_type_Int;
      break;
    }
  }
  
  public axhu a(int paramInt1, int paramInt2, int paramInt3, List<Camera.Size> paramList)
  {
  ...
  @TargetApi(17)
  public void a(File paramFile, Rect paramRect, aiai paramaiai, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    if (this.jdField_a_of_type_AndroidHardwareCamera == null) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          this.jdField_a_of_type_AndroidHardwareCamera.takePicture(null, null, null, new axhs(this, paramInt1, l, paramFile, paramRect, paramaiai, paramBoolean, paramInt2));
          return;
        }
  ...
  public boolean a(axhu paramaxhu)
  {
    ...
    try
    {
      localParameters.setPreviewSize(paramaxhu.jdField_a_of_type_Int, paramaxhu.jdField_b_of_type_Int);
      this.jdField_a_of_type_Axhu = paramaxhu;
      boolean bool = a(localParameters);
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] setParamsPreviewSize, result = " + bool + ",size.width = " + paramaxhu.jdField_a_of_type_Int + ",size.height = " + paramaxhu.jdField_b_of_type_Int);
      }
      return bool;
    }
    catch (Exception paramaxhu)
    {
      paramaxhu.printStackTrace();
    }
    return false;
  }
  
  public boolean a(axii paramaxii)
  {
    Camera.Parameters localParameters = a();
    if (localParameters == null)
    {
    ...
    localParameters.setPreviewFormat(paramaxii.jdField_a_of_type_Int);
    localParameters.setPreviewSize(paramaxii.jdField_a_of_type_Axhu.jdField_a_of_type_Int, paramaxii.jdField_a_of_type_Axhu.jdField_b_of_type_Int);
    localParameters.setPreviewFpsRange(paramaxii.jdField_b_of_type_Int, paramaxii.jdField_c_of_type_Int);
    if (paramaxii.jdField_a_of_type_Boolean) {
      localParameters.setPictureSize(paramaxii.jdField_b_of_type_Axhu.jdField_a_of_type_Int, paramaxii.jdField_b_of_type_Axhu.jdField_b_of_type_Int);
    }
    boolean bool = a(localParameters);
    if (bool)
    {
      this.jdField_b_of_type_Int = paramaxii.jdField_a_of_type_Int;
      this.jdField_a_of_type_Axhu = paramaxii.jdField_a_of_type_Axhu;
      this.jdField_a_of_type_ArrayOfInt = new int[] { paramaxii.jdField_b_of_type_Int, paramaxii.jdField_c_of_type_Int };
      this.jdField_b_of_type_Axhu = paramaxii.jdField_b_of_type_Axhu;
    }
    return bool;
  }
  ...
  public axhu[] a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    axhu localaxhu1 = a(paramInt1, paramInt2, paramInt3, paramInt4, true);
    if (localaxhu1 != null)
    {
      arrayOfaxhu[0] = localaxhu1;
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewAndPictureSizeGuarantee way2 preview=" + localaxhu1.jdField_a_of_type_Int + " " + localaxhu1.jdField_b_of_type_Int);
      }
      axhu localaxhu2 = a(localaxhu1.jdField_a_of_type_Int, localaxhu1.jdField_b_of_type_Int, paramInt3, paramInt4, 1);
      arrayOfaxhu[1] = localaxhu2;
      if (localaxhu2 != null)
      {
        if (QLog.isColorLevel()) {
          QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewAndPictureSizeGuarantee way2 picture=" + localaxhu2.jdField_a_of_type_Int + " " + localaxhu2.jdField_b_of_type_Int);
        }
        ahvx.a(true, localaxhu1.jdField_a_of_type_Int, localaxhu1.jdField_b_of_type_Int, localaxhu2.jdField_a_of_type_Int, localaxhu2.jdField_b_of_type_Int);
      }
    }
    else
    {
    ...
    ahvx.a(true, localaxhu1.jdField_a_of_type_Int, localaxhu1.jdField_b_of_type_Int, -1, -1);
    return arrayOfaxhu;
  }
  ...
  public axhu b()
  {
    return this.jdField_b_of_type_Axhu;
  }
  
  public axhu b(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
    ...
    axhu localaxhu = a((List)localObject, paramInt1, paramInt2, 2600, 1500, (int)f1, 1000);
    if (localaxhu != null)
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSizeGuaranteeOK: DEFAULT resolution os OK.");
    ...
    do
    {
      ...
      localaxhu = a((List)localObject, paramInt1, paramInt2, 2600, 1500, (int)f1, 700);
      if (localaxhu == null) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    label444:
    label453:
    for (paramInt4 = 0;; paramInt4 = ((axhu)localObject).jdField_b_of_type_Int)
    {
      ahvx.a(4, paramInt1, paramInt2, paramInt3, paramInt4);
      return localObject;
      paramInt3 = ((axhu)localObject).jdField_a_of_type_Int;
      break;
    }
  }
  ...
  public void b()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Axhu = null;
  ...
  public boolean b()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 347	axhr:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   4: ifnonnull +5 -> 9
    //   7: iconst_0
    //   8: ireturn
    //   9: aload_0
    //   10: getfield 529	axhr:jdField_a_of_type_Boolean	Z
    //   13: ifne +5 -> 18
    //   16: iconst_1
    //   17: ireturn
    //   18: aload_0
    //   19: iconst_0
    //   20: putfield 529	axhr:jdField_a_of_type_Boolean	Z
    //   23: aload_0
    //   24: invokespecial 595	axhr:h	()Z
    //   27: istore_1
    //   28: iload_1
    //   29: ifeq +10 -> 39
    //   32: aload_0
    //   33: getfield 347	axhr:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   36: invokevirtual 598	android/hardware/Camera:cancelAutoFocus	()V
    //   39: aload_0
    //   40: getfield 347	axhr:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   43: invokevirtual 750	android/hardware/Camera:stopPreview	()V
    //   46: aload_0
    //   47: getfield 347	axhr:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   50: aconst_null
    //   51: invokevirtual 621	android/hardware/Camera:setPreviewCallback	(Landroid/hardware/Camera$PreviewCallback;)V
    //   54: aload_0
    //   55: getfield 347	axhr:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   58: aconst_null
  ...
  public boolean b(axhu paramaxhu)
  {
    Camera.Parameters localParameters = a();
    if (localParameters == null) {}
    do
    {
      ...
      try
      {
        localParameters.setPictureSize(paramaxhu.jdField_a_of_type_Int, paramaxhu.jdField_b_of_type_Int);
        this.jdField_b_of_type_Axhu = paramaxhu;
        boolean bool = a(localParameters);
        if (QLog.isColorLevel()) {
          QLog.i(jdField_b_of_type_JavaLangString, 2, "setRawPictureSize w " + paramaxhu.jdField_a_of_type_Int + ", h " + paramaxhu.jdField_b_of_type_Int + ", success=" + bool);
        }
        return bool;
      }
      catch (Exception paramaxhu)
    ...
    QLog.i(jdField_b_of_type_JavaLangString, 2, "setParamsPictureSize", paramaxhu);
    return false;
  }
  ...
  public axhu[] b(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (QLog.isColorLevel()) {
    ...
    axhu[] arrayOfaxhu = new axhu[2];
    axhu localaxhu1 = b(paramInt1, paramInt2, paramInt3, paramInt4, true);
    if (localaxhu1 != null)
    {
      arrayOfaxhu[0] = localaxhu1;
      if (QLog.isColorLevel()) {
  ...
  public axhu c(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean)
  {
    int j = 0;
    if (QLog.isColorLevel()) {
    ...
    axhu localaxhu = a((List)localObject, axgi.jdField_c_of_type_Int, axgi.d);
    if (localaxhu != null)
    {
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewSizeGuaranteeOK: DEFAULT resolution os OK.");
      ...
      if (paramBoolean)
      {
        ahvx.a(2, axgi.jdField_c_of_type_Int, axgi.d, localaxhu.jdField_a_of_type_Int, localaxhu.jdField_b_of_type_Int);
        localObject = localaxhu;
      }
    }
    do
    {
      do
      {
        ...
        localaxhu = a((List)localObject, axgi.jdField_a_of_type_ArrayOfInt[1], axgi.b[1]);
        if (localaxhu == null) {
          break;
        }
        if (QLog.isColorLevel()) {
      ...
      ahvx.a(3, axgi.jdField_c_of_type_Int, axgi.d, localaxhu.jdField_a_of_type_Int, localaxhu.jdField_b_of_type_Int);
      return localaxhu;
      localaxhu = a((List)localObject, paramInt1, paramInt2, paramInt3, paramInt4);
      localObject = localaxhu;
    } while (!paramBoolean);
    ...
    label413:
    for (paramInt2 = j;; paramInt2 = localaxhu.jdField_b_of_type_Int)
    {
      ahvx.a(4, axgi.jdField_c_of_type_Int, axgi.d, paramInt1, paramInt2);
      return localaxhu;
      paramInt1 = localaxhu.jdField_a_of_type_Int;
      break;
    }
  }
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_Int == 1)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.i(jdField_b_of_type_JavaLangString, 2, "setDisplayOrientation degrees=" + i + " blackPhone=" + bool1 + " camera=" + ahty.jdField_a_of_type_Int + " rom_black=" + bool2);
          }
          return true;
          i = 0;
          break;
  ...
  public axhu[] c(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (QLog.isColorLevel()) {
      QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewAndPictureSizeGuarantee wanted size=" + axgi.jdField_c_of_type_Int + " " + axgi.d + " cliped=" + paramInt1 + " " + paramInt2);
    }
    if (0 != 0)
    {
      paramInt1 = axgi.jdField_c_of_type_Int;
      paramInt1 = axgi.d;
      throw new NullPointerException();
    }
    axhu[] arrayOfaxhu = new axhu[2];
    axhu localaxhu2 = c(paramInt1, paramInt2, paramInt3, paramInt4, true);
    if (localaxhu2 != null)
    {
      arrayOfaxhu[0] = localaxhu2;
      if (QLog.isColorLevel()) {
        QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewAndPictureSizeGuarantee way2 preview=" + localaxhu2.jdField_a_of_type_Int + " " + localaxhu2.jdField_b_of_type_Int);
      }
      axhu localaxhu1 = a(localaxhu2.jdField_a_of_type_Int, localaxhu2.jdField_b_of_type_Int, paramInt3, paramInt4, 1);
      arrayOfaxhu[1] = localaxhu1;
      if (localaxhu1 != null)
      {
        if (QLog.isColorLevel()) {
          QLog.i(jdField_b_of_type_JavaLangString, 2, "[@] getPreviewAndPictureSizeGuarantee way2 picture=" + localaxhu1.jdField_a_of_type_Int + " " + localaxhu1.jdField_b_of_type_Int);
        }
        ahvx.a(true, localaxhu2.jdField_a_of_type_Int, localaxhu2.jdField_b_of_type_Int, localaxhu1.jdField_a_of_type_Int, localaxhu1.jdField_b_of_type_Int);
        return arrayOfaxhu;
      }
      ahvx.a(true, localaxhu2.jdField_a_of_type_Int, localaxhu2.jdField_b_of_type_Int, -1, -1);
    }
    return arrayOfaxhu;
  }
