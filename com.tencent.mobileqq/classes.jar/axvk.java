...
public class axvk
{
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if ((paramBoolean) && (this.jdField_a_of_type_Axvo != null)) {
          this.jdField_a_of_type_Axvo.k();
        }
        return;
        if (QLog.isColorLevel()) {
  ...
  public void a(MediaFormat paramMediaFormat)
  {
    ...
    if (this.jdField_a_of_type_Axvo != null) {
      this.jdField_a_of_type_Axvo.a(this.jdField_a_of_type_AndroidMediaMediaFormat);
    }
    return;
    label114:
    this.jdField_a_of_type_Axwb.a(0, paramMediaFormat);
  }
  ...
  public void a(axvi paramaxvi)
  {
    ...
    if (paramaxvi.j != -1) {
      ((MediaFormat)localObject).setInteger("bitrate-mode", paramaxvi.j);
    }
    if (paramaxvi.k != -1)
    {
    ...
    if (paramaxvi.jdField_b_of_type_Boolean)
    {
      ((MediaFormat)localObject).setInteger("profile", 1);
      ((MediaFormat)localObject).setInteger("level", 512);
    }
    if (QLog.isColorLevel()) {
      QLog.d("HWVideoEncoder", 2, "start : encodeConfig = + " + paramaxvi.toString() + " ; format: " + localObject);
    }
    ...
    if (paramaxvi.jdField_a_of_type_Axwb == null)
    {
    ...
    for (;;)
    {
      if (paramaxvi.jdField_a_of_type_Axvo != null) {
        this.jdField_a_of_type_Axvo = paramaxvi.jdField_a_of_type_Axvo;
      }
      this.jdField_a_of_type_Int = -1;
      this.jdField_a_of_type_Boolean = false;
      return;
      this.jdField_a_of_type_Axwb = paramaxvi.jdField_a_of_type_Axwb;
      this.jdField_a_of_type_Axwb.jdField_a_of_type_AndroidMediaMediaMuxer.setOrientationHint(paramaxvi.g);
    }
  }
  ...
  public void a(ByteBuffer paramByteBuffer, MediaCodec.BufferInfo paramBufferInfo)
  {
    if (this.jdField_a_of_type_Axwb == null)
    {
      ...
      if (this.jdField_a_of_type_Axvo != null)
      {
        ...
        this.jdField_a_of_type_Axvo.a(paramBufferInfo);
    ...
    this.jdField_a_of_type_Axwb.a(0, paramByteBuffer, paramBufferInfo);
  }
    ...
    catch (Exception localException1)
    {
      try
      {
        for (;;)
        {
          ...
          if ((this.jdField_a_of_type_Axwb != null) || (this.jdField_a_of_type_AndroidMediaMediaMuxer == null)) {
            break label237;
          }
          try
          {
      ...
      catch (Exception localException2)
      {
        ...
        } while (this.jdField_a_of_type_Axwb == null);
