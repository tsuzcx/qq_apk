...
public class akdm
  implements axay
{
  public akdm(PublicAccountHandler paramPublicAccountHandler) {}
  ...
  public ReqItem a(int paramInt)
  {
    ...
    if (bool)
    {
      ...
      ((CertifiedAccountRead.StGetFollowListReq)localObject1).seq.set(bbbr.a(l1));
      ((CertifiedAccountRead.StGetFollowListReq)localObject1).count.set(bbbr.a(1L));
      ...
      ((PROTOCAL.StQWebReq)localObject2).qua.set(bgyi.a());
      ((PROTOCAL.StQWebReq)localObject2).deviceInfo.set(bgyh.a().c());
      ...
      localReqItem.vecParam = bbma.a((byte[])localObject1);
      return localReqItem;
    }
    ...
    localReqItem.vecParam = bbma.a(((mobileqq_mp.GetUserFollowListRequest)localObject1).toByteArray());
    return localReqItem;
  }
