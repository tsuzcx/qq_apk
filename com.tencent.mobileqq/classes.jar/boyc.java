...
public class boyc
{
  ...
  private static boolean a(Context paramContext, QQAppInterface paramQQAppInterface)
  {
    ...
    boolean bool4 = bann.a();
    boolean bool2 = a();
    if ((!bool3) || (!bool4) || (!bool2))
    {
      yqp.b("CaptureUtils", "checkApiVersionDialog false");
      bglp.a(paramContext, 230).setMessage(anni.a(2131707498)).setPositiveButton(2131694081, new boyd()).show();
      bool1 = true;
    }
    return bool1;
  }
  ...
  {
    return (ShortVideoUtils.a(paramAppInterface)) && (bnpy.a(bnpt.b) == 1);
  }
}
