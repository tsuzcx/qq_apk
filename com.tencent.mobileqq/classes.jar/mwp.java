  ...
  extends mwm
{
  ...
  protected mwp(AppInterface paramAppInterface)
  {
  ...
  private ndd a()
  {
    ...
    if ((this.mApp instanceof AVGameAppInterface)) {
      localndd = ((AVGameAppInterface)this.mApp).a();
    }
    return localndd;
  }
  ...
  private void a(int paramInt, List<String> arg2, HashMap<String, String> paramHashMap)
  {
    ...
    if (localObject != null)
    {
      ...
      ((ndd)localObject).a(paramInt, ???, paramHashMap);
  ...
  public static UserInfo b(String paramString)
  {
    ...
    if (localObject != null)
    {
      localObject = (mwp)((AVGameAppInterface)localObject).a(2);
      if (localObject != null) {
        return ((mwp)localObject).a(paramString);
      }
    }
    return null;
  }
  ...
  public Bitmap b(int paramInt1, String paramString, byte paramByte, int paramInt2)
  {
    Object localObject = a();
    if (localObject == null) {}
    for (localObject = null;; localObject = ((ndd)localObject).a(paramInt1, paramString, paramByte, paramInt2))
    {
      if (localObject != null) {}
      try
      {
  ...
  public UserInfo b(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      return localObject1;
      localObject1 = ((ndd)localObject2).a(paramInt, paramString);
    }
  }
