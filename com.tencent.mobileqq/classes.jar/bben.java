...
public class bben
{
  private static bbed jdField_a_of_type_Bbed;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j < k)
        {
          ...
          else if ((localRecentBaseData.getRecentUserType() == 6000) && (TextUtils.equals(localRecentBaseData.getRecentUserUin(), anhk.z)))
          {
            localArrayList.add(localRecentBaseData);
            i = j;
          }
        ...
        else
        {
          if ((localArrayList.size() == 0) || (i == -1))
          {
            ...
            paramList = alan.a(new RecentUser(anhk.z, 6000), paramQQAppInterface, paramActivity);
            if (paramList != null)
            {
              paramList.mTitleName = paramActivity.getResources().getString(2131693379);
              localArrayList.add(paramList);
            }
          }
          Collections.sort(localArrayList, new alao(paramQQAppInterface));
  ...
  {
    bbed localbbed2 = (bbed)aqlk.a().a(485);
    bbed localbbed1 = localbbed2;
    if (localbbed2 == null)
    {
      localbbed2 = new bbed();
      localbbed1 = localbbed2;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ScreenShotHelper", 2, "ScreenShotConfigData switch isOpened = " + localbbed1);
    }
    jdField_a_of_type_Bbed = localbbed1;
  }
  ...
  public static void a(Activity paramActivity)
  {
    ...
    paramActivity = ((ViewGroup)paramActivity.getWindow().getDecorView().getRootView()).findViewById(2131376957);
  ...
  public static void a(Activity paramActivity, Handler paramHandler)
  {
    ...
    View localView = ((ViewGroup)paramActivity.getWindow().getDecorView().getRootView()).findViewById(2131376957);
    if (localView != null)
    {
  ...
  public static void a(Activity paramActivity, String paramString, Handler paramHandler)
  {
    ...
    Object localObject1 = localViewGroup.findViewById(2131376957);
    int k = bgtn.b(79.0F);
    ...
    for (;;)
    {
      ...
      {
        localObject3 = View.inflate(paramActivity, 2131562817, null);
        localImageView = (ImageView)((View)localObject3).findViewById(2131376960);
      ...
      for (;;)
      {
        try
        {
          paramActivity.getResources().getDrawable(2130840337);
          ...
          ((URLDrawable.URLDrawableOptions)localObject1).mLoadingDrawable = bdzx.b();
  ...
  public static void a(Context paramContext, android.net.Uri paramUri, View paramView1, View paramView2, boolean paramBoolean)
  {
    ...
    //   7: ifnonnull +4 -> 11
    //   10: return
    //   11: new 515	android/util/SparseArray
    //   14: dup
    //   15: iconst_2
    //   16: invokespecial 517	android/util/SparseArray:<init>	(I)V
    //   19: astore 9
    //   21: aload_1
    //   22: aload_0
    //   23: iconst_3
    //   24: aload 9
    //   26: invokestatic 522	zuc:a	(Landroid/net/Uri;Landroid/content/Context;ILandroid/util/SparseArray;)I
    //   29: istore 6
    //   31: iload 6
    //   33: invokestatic 525	zuc:b	(I)Z
    //   36: ifeq +262 -> 298
    ...
    //   54: aload 9
    //   56: iconst_2
    //   57: invokevirtual 528	android/util/SparseArray:get	(I)Ljava/lang/Object;
    //   60: astore_0
    //   61: aload_0
    //   62: instanceof 530
    //   65: ifeq +228 -> 293
    //   68: aload_0
    //   69: checkcast 530	java/lang/String
    //   72: astore_1
    //   73: new 532	org/json/JSONObject
    //   76: dup
    //   77: invokespecial 533	org/json/JSONObject:<init>	()V
    //   80: astore_0
    //   81: aload_0
    //   82: ldc_w 535
    //   85: aload_1
    //   86: invokevirtual 539	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   89: pop
    //   90: aload_0
    ...
    //   103: aload_3
    //   104: aload_0
    //   105: invokevirtual 445	android/view/View:setTag	(Ljava/lang/Object;)V
    //   108: iconst_1
    //   109: istore 5
    //   111: iload 6
    //   113: invokestatic 543	zuc:a	(I)Z
    //   116: ifeq -106 -> 10
    ...
    //   134: aload 9
    //   136: iconst_1
    //   137: invokevirtual 528	android/util/SparseArray:get	(I)Ljava/lang/Object;
    //   140: astore_1
    //   141: aload 8
    //   143: astore_0
    //   144: aload_1
    ...
    //   148: ifeq +56 -> 204
    //   151: aload_1
    //   152: checkcast 547	android/util/Pair
    //   155: astore_0
    //   156: aload_0
    //   157: getfield 551	android/util/Pair:second	Ljava/lang/Object;
    //   160: invokestatic 554	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   163: invokevirtual 557	java/lang/String:trim	()Ljava/lang/String;
    //   166: astore_1
    //   167: aload_0
    //   168: getfield 560	android/util/Pair:first	Ljava/lang/Object;
    //   171: invokestatic 554	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   174: invokevirtual 557	java/lang/String:trim	()Ljava/lang/String;
    //   177: astore_3
    //   178: new 532	org/json/JSONObject
    //   181: dup
    //   182: invokespecial 533	org/json/JSONObject:<init>	()V
    //   185: astore_0
    //   186: aload_0
    //   187: ldc_w 562
    //   190: aload_1
    //   191: invokevirtual 539	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   194: pop
    //   195: aload_0
    //   196: ldc_w 564
    //   199: aload_3
    //   200: invokevirtual 539	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   203: pop
    //   204: aload_0
    ...
    //   242: aload_2
    //   243: aload_0
    //   244: invokevirtual 445	android/view/View:setTag	(Ljava/lang/Object;)V
    //   247: return
    //   248: astore_1
    //   249: aconst_null
    //   250: astore_0
    //   251: aload_1
    //   252: invokevirtual 567	org/json/JSONException:printStackTrace	()V
    //   255: goto -165 -> 90
    //   258: aload_0
    //   259: invokevirtual 568	org/json/JSONObject:toString	()Ljava/lang/String;
    //   262: astore_0
    //   263: goto -165 -> 98
    //   266: astore_1
    //   267: aload 7
    //   269: astore_0
    //   270: aload_1
    //   271: invokevirtual 567	org/json/JSONException:printStackTrace	()V
    //   274: goto -70 -> 204
    //   277: aload_0
    //   278: invokevirtual 568	org/json/JSONObject:toString	()Ljava/lang/String;
    //   281: astore_0
    //   282: goto -70 -> 212
    //   285: astore_1
    //   286: goto -16 -> 270
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    {
      localObject = ((ViewGroup)((Activity)paramContext).getWindow().getDecorView().getRootView()).findViewById(2131376957);
      if (localObject != null) {
          ...
          if (localQQAppInterface.a().a())
          {
            ...
            if (localQQAppInterface.a().a() != null)
            {
              ...
              if (localQQAppInterface.a().a().size() > 0)
              {
                ...
                aevv.a(paramString, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class, 9011);
                i = 1;
              }
            }
          }
    ...
    if (((paramContext instanceof QQBrowserActivity)) && (a((QQBrowserActivity)paramContext)))
    {
      ...
      aevv.a((QQBrowserActivity)paramContext, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class, 11);
    }
    while (i != 0) {
      return;
    }
    aevv.a(paramContext, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class);
  }
  ...
  public static void a(bbed parambbed)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ScreenShotHelper", 2, "onConfUpdate : " + parambbed);
    }
    if (parambbed != null) {
      jdField_a_of_type_Boolean = parambbed.a();
    }
  }
  ...
  public static boolean a()
  {
    ...
    b = true;
    a();
    jdField_a_of_type_Boolean = jdField_a_of_type_Bbed.a();
    if (QLog.isColorLevel()) {
  ...
  private static boolean a(QQBrowserActivity paramQQBrowserActivity)
  {
    ...
    return paramQQBrowserActivity.getSupportFragmentManager().findFragmentById(2131365013) instanceof WebViewFragment;
  }
  ...
  public List<RecentBaseData> a(Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      if (paramQQAppInterface.a().a().getRecentList(false).size() > 0) {
        localArrayList.addAll(albs.a().jdField_a_of_type_JavaUtilList);
      }
