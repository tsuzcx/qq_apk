...
{
  public bpau(AEPituCameraCaptureButtonLayout paramAEPituCameraCaptureButtonLayout) {}
  ...
  {
    bpam.b("CameraCaptureLayout", "scaleAnimator end, shortVideoShot:" + this.a.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get() + ", mActionUpAnimator:" + this.a.b.get());
    if (!this.a.b.get())
    {
