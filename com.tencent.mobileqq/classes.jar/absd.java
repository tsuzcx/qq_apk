...
{
  private static absd jdField_a_of_type_Absd;
  ...
  {
    if (jdField_a_of_type_Absd == null) {}
    try
    {
      if (jdField_a_of_type_Absd == null)
      {
        jdField_a_of_type_Absd = new absd();
        new HardCoderManager.1().start();
      }
      return jdField_a_of_type_Absd;
    }
    finally {}
  }
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = abrz.a().a();
  ...
  public int a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, long paramLong, int paramInt7, String paramString, boolean paramBoolean)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1) {
      return abrz.a().a(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramLong, paramInt7, paramString);
    }
    Message localMessage = this.jdField_a_of_type_AndroidOsHandler.obtainMessage(0);
    absa localabsa = (absa)abrz.a.obtain(absa.class);
    localabsa.jdField_a_of_type_Int = paramInt1;
    localabsa.c = paramInt2;
    localabsa.d = paramInt3;
    localabsa.e = paramInt4;
    localabsa.b = paramInt5;
    localabsa.f = paramInt6;
    localabsa.jdField_a_of_type_Long = paramLong;
    localabsa.jdField_a_of_type_JavaLangString = paramString;
    localMessage.obj = localabsa;
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((Math.abs(System.currentTimeMillis() - l) <= 86400000L) || (!bdee.h(BaseApplicationImpl.getContext()))) {
          continue;
        }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      Object localObject = (absa)paramMessage.obj;
      jdField_a_of_type_AndroidOsBundle.putInt("key_delay", ((absa)localObject).jdField_a_of_type_Int);
      jdField_a_of_type_AndroidOsBundle.putInt("key_cpu", ((absa)localObject).c);
      jdField_a_of_type_AndroidOsBundle.putInt("key_io", ((absa)localObject).d);
      jdField_a_of_type_AndroidOsBundle.putInt("key_bind", ((absa)localObject).e);
      jdField_a_of_type_AndroidOsBundle.putInt("key_timeout", ((absa)localObject).b);
      jdField_a_of_type_AndroidOsBundle.putInt("key_scene", ((absa)localObject).f);
      jdField_a_of_type_AndroidOsBundle.putLong("key_action", ((absa)localObject).jdField_a_of_type_Long);
      jdField_a_of_type_AndroidOsBundle.putString("key_tag", ((absa)localObject).jdField_a_of_type_JavaLangString);
