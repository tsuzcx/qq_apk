  ...
  extends zeo
{
  ...
  public agfq(AIORichMediaData paramAIORichMediaData)
  {
    this.jdField_b_of_type_Int = -2;
    this.jdField_a_of_type_Agfr = new agfr();
  ...
  @Deprecated
  public static URLDrawable a(awfj paramawfj)
  {
    return baul.b(paramawfj, 1);
  }
  ...
  public Drawable c()
  {
    for (;;)
    {
      ...
      catch (Throwable localThrowable)
      {
        ...
        if (baul.a(((File)localObject2).getAbsolutePath()) != 0) {
          break label631;
        }
        ...
        if (baul.a(((File)localObject3).getAbsolutePath()) != 0) {
          break label631;
        }
