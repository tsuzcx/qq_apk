...
public class beqb
{
  ...
  /* Error */
  public static beqb a(String paramString)
  {
    // Byte code:
    //   0: aload_0
    ...
    //   169: aload 10
    //   171: iload 5
    //   173: invokespecial 87	beqa:<init>	(ILjava/lang/String;Ljava/lang/String;I)V
    ...
    //   211: new 2	beqb
    //   214: dup
    //   215: invokespecial 98	beqb:<init>	()V
    //   218: astore 7
    //   220: aload 7
    //   222: aload 8
    //   224: putfield 18	beqb:jdField_a_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   227: iload 4
    //   229: iconst_1
    ...
    //   236: aload 7
    //   238: iload 6
    //   240: putfield 100	beqb:jdField_a_of_type_Boolean	Z
    //   243: aload 7
    //   245: iload 5
    //   247: putfield 20	beqb:jdField_a_of_type_Int	I
  ...
  private void a()
  {
    beqa localbeqa1 = new beqa(1, "龙王", "https://qzonestyle.gtimg.cn/aoi/sola/20200213150116_n4PxCiurbm.png", 1);
    beqa localbeqa2 = new beqa(2, "群聊之火", "https://qzonestyle.gtimg.cn/aoi/sola/20200213150231_zLczuKN4tp.png", 2);
    beqa localbeqa3 = new beqa(3, "群聊炽焰", "https://qzonestyle.gtimg.cn/aoi/sola/20200213150305_AJiyOgHCDg.png", 3);
    beqa localbeqa4 = new beqa(4, "冒尖小春笋", "https://qzonestyle.gtimg.cn/aoi/sola/20200213150335_tUJCAtoKVP.png", 4);
    beqa localbeqa5 = new beqa(5, "茁壮小春笋", "https://qzonestyle.gtimg.cn/aoi/sola/20200213150408_nw0sOEFzqw.png", 5);
    beqa localbeqa6 = new beqa(6, "快乐源泉", "https://qzonestyle.gtimg.cn/aoi/sola/20200213150434_3tDmsJExCP.png", 6);
    a(localbeqa1);
    a(localbeqa2);
    a(localbeqa3);
    a(localbeqa4);
  ...
  public beqa a(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidUtilSparseArray != null) {
      return (beqa)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt);
    }
    return null;
  }
  
  public void a(beqa parambeqa)
  {
    if (this.jdField_a_of_type_AndroidUtilSparseArray != null) {
      this.jdField_a_of_type_AndroidUtilSparseArray.put(parambeqa.jdField_a_of_type_Int, parambeqa);
    }
  }
