...
public class auvd
{
  ...
  @SuppressLint({"NewApi"})
  public static void a(View paramView, String paramString1, auvd paramauvd, String paramString2)
  {
    if ((paramView == null) || (paramauvd == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (a(paramauvd.jdField_o_of_type_Long))) {}
    do
    {
      do
      {
          ...
          do
          {
            do
            {
              do
              {
                do
                {
                  do
                  {
                    do
                    {
                      do
                      {
                        do
                        {
                          do
                          {
                              ...
                              do
                              {
                                do
                                {
                                  do
                                  {
                                    ...
                                    {
                                      return;
                                      paramauvd = paramauvd.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString2);
                                    } while (paramauvd == null);
                                    if ((!paramString1.equalsIgnoreCase("color")) || (!(paramView instanceof TextView))) {
                                      break;
                                    }
                                    paramView = (TextView)paramView;
                                    if ((paramauvd instanceof ColorStateList))
                                    {
                                      paramView.setTextColor((ColorStateList)paramauvd);
                                      return;
                                    }
                                  } while (!(paramauvd instanceof String));
                                  paramString1 = (String)paramauvd;
                            ...
                            if ((paramauvd instanceof Drawable))
                            {
                              paramString1 = ((Drawable)paramauvd).getConstantState().newDrawable();
                              paramauvd = new Rect();
                              paramString1.getPadding(paramauvd);
                              int i1 = paramView.getPaddingTop();
                              int i2 = paramauvd.top;
                              int i3 = paramView.getPaddingLeft();
                              int i4 = paramauvd.left;
                              int i5 = paramView.getPaddingRight();
                              int i6 = paramauvd.right;
                              int i7 = paramView.getPaddingBottom();
                              int i8 = paramauvd.bottom;
                              paramauvd = paramView.findViewById(2131373084);
                              if (Build.VERSION.SDK_INT >= 16)
                              {
                                paramView.setBackground(paramString1);
                                if (paramauvd != null) {
                                  paramauvd.setBackground(paramString1);
                                }
                              }
                              for (;;)
                              {
                                ...
                                if (paramauvd != null) {
                                  paramauvd.setBackgroundDrawable(paramString1);
                                }
                              }
                            }
                          } while (!(paramauvd instanceof String));
                      ...
                      } while (!(paramauvd instanceof Drawable));
                      paramView = (TextView)paramView;
                    } while (!(paramauvd instanceof Drawable));
                    paramView.setCompoundDrawablesWithIntrinsicBounds(((Drawable)paramauvd).getConstantState().newDrawable(), null, null, null);
                    return;
                ...
                paramView.setCompoundDrawablesWithIntrinsicBounds(null, null, ((Drawable)paramauvd).getConstantState().newDrawable(), null);
                return;
            ...
            paramView.setImageDrawable(((Drawable)paramauvd).getConstantState().newDrawable());
            return;
        ...
        paramView.setContentBackground(((Drawable)paramauvd).getConstantState().newDrawable());
        return;
        if ((!paramString1.equalsIgnoreCase("apngDrawable")) || (!(paramView instanceof ImageView))) {
          break;
        }
      } while (!(paramauvd instanceof URLDrawable));
      ((ImageView)paramView).setImageDrawable((URLDrawable)paramauvd);
      return;
    } while ((!paramString1.equalsIgnoreCase("shimmer_mask")) || (!(paramView instanceof ShimmerLinearLayout)) || (!(paramauvd instanceof BitmapDrawable)));
    paramString1 = (BitmapDrawable)paramauvd;
    paramauvd = (ShimmerLinearLayout)paramView;
  ...
  public Drawable a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Object localObject3 = bazo.a(paramQQAppInterface, -1L);
        localObject1 = str;
  ...
  public JSONObject a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    //   47: lcmp
    //   48: ifne +23 -> 71
    //   51: getstatic 785	auvd:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   54: ifnull +17 -> 71
    //   57: getstatic 785	auvd:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   60: astore_1
    //   61: aload_1
    //   62: areturn
    //   63: ldc_w 787
    ...
    //   73: lcmp
    //   74: ifeq +13 -> 87
    //   77: getstatic 789	auvd:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   80: ifnull +7 -> 87
    //   83: getstatic 789	auvd:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   86: areturn
    ...
    //   121: aload_1
    //   122: ldc2_w 559
    //   125: invokestatic 565	bazo:a	(Lcom/tencent/mobileqq/app/QQAppInterface;J)Ljava/lang/String;
    //   128: astore_1
    //   129: aload_1
    //   130: ifnull +142 -> 272
    //   133: aload_1
    ...
    //   336: putstatic 785	auvd:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   339: aload 5
    //   341: astore_1
    //   342: getstatic 785	auvd:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   345: astore 6
    //   347: aload 6
    //   349: astore_1
    //   350: aload 5
    ...
    //   383: putstatic 789	auvd:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   386: aload 5
    //   388: astore_1
    //   389: getstatic 789	auvd:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   392: astore 6
    //   394: aload 6
    //   396: astore_1
    //   397: aload 5
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        catch (Exception paramQQAppInterface)
        {
          ...
          if (!auwk.a(paramQQAppInterface)) {
            continue;
          }
          str1 = auwn.a(paramQQAppInterface.getApp());
          localObject2 = bbql.a(paramQQAppInterface, str1 + "logo.png", "-wzry-card-logo-", a(paramQQAppInterface, str1 + "logo.png", true, true), new int[] { 7 }, "-wzry-card-logo-", null);
