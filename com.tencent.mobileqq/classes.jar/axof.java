...
class axof
  extends ntc
{
  axof(axoe paramaxoe, axnm paramaxnm) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        paramArrayOfByte = new axnn(bool1, bool2, l, paramArrayOfByte.bytes_list_jump_url.get().toStringUtf8(), paramArrayOfByte.bytes_card_url_h.get().toStringUtf8(), paramArrayOfByte.bytes_card_url_g.get().toStringUtf8());
        this.jdField_a_of_type_Axnm.a(paramArrayOfByte);
        return;
        bool1 = false;
        break;
        label208:
