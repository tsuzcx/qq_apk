  ...
  implements View.OnClickListener
{
  ...
  private List<aiqo> jdField_a_of_type_JavaUtilList;
  private boolean jdField_a_of_type_Boolean;
  
  public afpv(Context paramContext, QQAppInterface paramQQAppInterface, ListView paramListView, int paramInt, boolean paramBoolean, PhoneContactFragment paramPhoneContactFragment)
  {
    ...
    do
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (!localPhoneContact.isHiden) {
          ((List)localObject1).add(aiqj.a(1, localPhoneContact, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext));
        }
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (a())
    {
      ...
      {
        this.jdField_a_of_type_AndroidViewView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131558842, null);
        this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130839132);
        this.jdField_a_of_type_AndroidViewView.findViewById(2131368568).setVisibility(8);
        this.jdField_a_of_type_AndroidViewView.findViewById(2131368649).setVisibility(8);
        paramView = (SingleLineTextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367211);
        paramView.setText(ajyc.a(2131707993));
        paramViewGroup = (ViewGroup.MarginLayoutParams)paramView.getLayoutParams();
        paramViewGroup.leftMargin /= 2;
        paramView.setLayoutParams(paramViewGroup);
        ((SimpleTextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364631)).setText("0");
      }
      return this.jdField_a_of_type_AndroidViewView;
    }
    paramView = ((aiqo)this.jdField_a_of_type_JavaUtilList.get(paramInt)).a(0, paramInt, paramView, paramViewGroup, this);
    if (paramView != null)
    {
      paramViewGroup = (aiqr)paramView.getTag();
      ...
      if ((paramViewGroup instanceof aiqt)) {
        ((aiqt)paramViewGroup).a.setOnClickListener(this);
      }
    }
    return paramView;
  }
  ...
  {
    int i = 17;
    if ((paramView != null) && (paramView.getId() == 2131375181) && ((paramView.getTag() instanceof PhoneContact)))
    {
    ...
    for (;;)
    {
      ...
      paramView = AddFriendLogicActivity.a(this.jdField_a_of_type_AndroidContentContext, 2, paramView.unifiedCode, null, 3006, i, paramView.name, null, null, ajyc.a(2131707988), null);
      this.jdField_a_of_type_AndroidContentContext.startActivity(paramView);
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "contact", "", "addbook", "add_friend", 0, 0, "", "", "", "");
      do
      {
        do
        {
          return;
        } while ((paramView == null) || (!(paramView.getTag() instanceof aiqr)));
      ...
      for (;;)
      {
        ...
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80053DF", "0X80053DF", 0, 0, "1", "", "", "");
        return;
