...
{
  public int a;
  private LinkedHashMap<String, List<afou>> jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
  ...
  public azdv(List<afou> paramList)
  {
    this.jdField_a_of_type_JavaUtilList = paramList;
    this.jdField_c_of_type_JavaUtilList = new ArrayList();
  }
  
  private azdw a(QQAppInterface paramQQAppInterface, TroopInfo paramTroopInfo, String paramString, azdw paramazdw, boolean paramBoolean)
  {
    if (((azdj.a(paramQQAppInterface, paramTroopInfo)) || (azdj.b(paramQQAppInterface, paramTroopInfo))) && (!paramBoolean))
    {
      paramQQAppInterface = azdu.a();
      if ((TextUtils.isEmpty(paramString)) || (azdu.a(paramString, paramQQAppInterface))) {
        paramazdw.jdField_a_of_type_JavaUtilList.add(0, paramQQAppInterface);
      }
    }
    return paramazdw;
  }
  
  private azdw a(String paramString, boolean paramBoolean, TroopInfo paramTroopInfo)
  {
  ...
  private List<afou> a(LinkedHashMap<String, List<afou>> paramLinkedHashMap)
  {
  ...
  private Object[] a(String paramString, TroopInfo paramTroopInfo)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((localafou.jdField_a_of_type_Boolean) || ((!TextUtils.isEmpty(paramString)) && (azdj.a(localafou.jdField_a_of_type_JavaLangString, paramTroopInfo)))) {
          break label664;
        }
        if ((TextUtils.isEmpty(paramString)) || (!azdj.b(localafou.jdField_a_of_type_JavaLangString, paramTroopInfo))) {
          break label228;
        }
      }
      finally {}
      ...
      ((List)localLinkedHashMap.get(localObject2)).add(localafou);
      continue;
      label228:
      localObject1 = localafou.x;
      if ((localObject1 == null) || (((String)localObject1).length() == 0)) {
        break label688;
      }
      localObject1 = ((String)localObject1).substring(0, 1);
    }
    paramTroopInfo = new azdn(paramTroopInfo);
  ...
  public azdw a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean1, SessionInfo paramSessionInfo, boolean paramBoolean2)
  {
    ...
    for (this.jdField_b_of_type_JavaUtilList = azdu.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilList, paramBoolean1);; this.jdField_b_of_type_JavaUtilList = new ArrayList(azdu.a(paramString, azdu.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilList, paramBoolean1), paramQQAppInterface, localTroopInfo))) {
