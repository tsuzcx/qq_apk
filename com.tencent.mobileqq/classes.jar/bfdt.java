  ...
  implements Handler.Callback
{
  ...
  public bfdt(Context paramContext, String paramString)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_AndroidOsHandler = new Handler(a().getLooper(), this);
    this.b = paramString;
    this.jdField_a_of_type_Bfct = bfct.a(this.jdField_a_of_type_AndroidContentContext);
    a();
  }
  ...
  {
    bfdr.a(paramPluginInfo, a(this.jdField_a_of_type_AndroidContentContext));
  }
  
  private void a(String paramString)
  {
    bfdr.a(paramString, a(this.jdField_a_of_type_AndroidContentContext));
  }
      ...
      if (paramPluginInfo.mInstalledPath != null)
      {
        ...
        if (localFile != null)
        {
          ...
          if (localFile.exists())
          {
            ...
            if (localFile.isFile())
            {
              if (!bfdr.a(paramPluginInfo, localFile)) {
                break label137;
              }
              bool1 = true;
  ...
  private static boolean a(File paramFile, QZipFile paramQZipFile, ZipEntry paramZipEntry)
  {
    ...
    //   116: invokestatic 200	bggg:a	(Ljava/io/OutputStream;)Lbggg;
    //   119: astore_0
    //   120: aload_0
    //   121: astore 5
    //   123: aload_0
  ...
  private void c(PluginInfo paramPluginInfo, bfdw parambfdw)
  {
    int i = 1;
    String str = paramPluginInfo.mID;
    QLog.d("plugin_tag", 1, "doSetupPlugin." + str);
    if (bfdr.a(paramPluginInfo, this.jdField_a_of_type_AndroidContentContext))
    {
  ...
  private boolean c(String paramString)
  {
    ...
    {
      return false;
      paramString = new File(this.b).list(new bfdu(this, paramString));
  ...
  private boolean d(String paramString)
  {
    ...
    if ((localPluginInfo != null) && (bfdr.a(localPluginInfo, this.jdField_a_of_type_AndroidContentContext)))
    {
      if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    ...
    boolean bool = bfdr.a(localFile1);
    File[] arrayOfFile = bfdr.a(localFile1);
    int i;
    File localFile2;
    Object localObject;
    if (arrayOfFile != null)
  ...
  public void a(PluginInfo paramPluginInfo, bfdw parambfdw)
  {
    paramPluginInfo = new Pair(paramPluginInfo, parambfdw);
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(66816, paramPluginInfo).sendToTarget();
  }
  
  public void a(String paramString, File paramFile, bfdw parambfdw)
  {
    int i = 1;
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(paramFile);
    if ((PluginUtils.isOsNeedReleaseDex()) && (bfdk.a(paramString) > 1)) {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!TextUtils.isEmpty(paramFile))
        {
          ...
          boolean bool = Dex2Oat.a(localArrayList, localFile, true, paramFile, new bfdv(this));
          ...
          awqq.a(paramString, i, l2);
          l2 = System.currentTimeMillis();
          if (parambfdw != null) {
            parambfdw.a(paramString, "pluginOatCost", l2 - l1);
          }
          if (QLog.isColorLevel()) {
  ...
  public boolean a(PluginInfo paramPluginInfo, bfdw parambfdw)
  {
    if (paramPluginInfo == null)
    {
      if (QLog.isColorLevel()) {
    ...
    for (boolean bool = a((PluginInfo)localObject);; bool = false)
    {
      ...
      if (!bfdr.a(paramPluginInfo, (File)localObject))
      {
        if (QLog.isColorLevel()) {
      ...
      bace.a((File)localObject, localFile);
      if (!bfdr.a(paramPluginInfo, localFile))
      {
        if (QLog.isColorLevel()) {
  ...
  public boolean a(String paramString, bfdw parambfdw)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      if (parambfdw != null) {
        parambfdw.e(paramString);
      }
      return false;
    }
    if (!this.jdField_a_of_type_Bfct.a(paramString))
    {
      if (QLog.isColorLevel()) {
    ...
    bool = false;
    localObject4 = this.jdField_a_of_type_Bfct.a(paramString);
    if (localObject4 == null)
    {
      QLog.d("plugin_tag", 1, "plugin not builtin");
      if (parambfdw != null) {
        parambfdw.b(false, paramString);
      }
      return false;
    }
    ...
    for (i = 1;; i = 0)
    {
      ...
      if (parambfdw != null) {
        parambfdw.b(true, paramString);
      }
      return true;
    }
    if (parambfdw != null) {
      parambfdw.f(paramString);
    }
      ...
      for (;;)
      {
        try
        {
          ...
          if ((0 == 0) && (bool))
          {
            l2 = System.currentTimeMillis();
            if (parambfdw != null) {
              parambfdw.a(paramString, "pluginApkCost", l2 - l1);
            }
            i = 0;
            try
            {
              ...
              l2 = System.currentTimeMillis();
              if (parambfdw != null) {
                parambfdw.a(paramString, "pluginLibCost", l2 - l1);
              }
              if (localObject1 != null)
              {
          ...
          if (bfdz.a()) {
            a(paramString, (File)localObject5, parambfdw);
          }
  ...
  public void b(PluginInfo paramPluginInfo, bfdw parambfdw)
  {
    paramPluginInfo = new Pair(paramPluginInfo, parambfdw);
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(67072, paramPluginInfo).sendToTarget();
  }
  
  public boolean b(PluginInfo paramPluginInfo, bfdw parambfdw)
  {
    String str = paramPluginInfo.mID;
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      {
        a(str, new File(PluginUtils.getPluginInstallDir(this.jdField_a_of_type_AndroidContentContext), str), parambfdw);
        paramPluginInfo.mState = 4;
        paramPluginInfo.mFingerPrint = a();
        a(paramPluginInfo);
        if (QLog.isColorLevel()) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 66816: 
      ...
      c((PluginInfo)paramMessage.first, (bfdw)paramMessage.second);
      return true;
    }
    paramMessage = (Pair)paramMessage.obj;
    b((PluginInfo)paramMessage.first, (bfdw)paramMessage.second);
    return true;
  }
}
