...
public class atbi
{
  ...
  public atbi(AbsListView paramAbsListView)
  {
    ...
    this.jdField_a_of_type_Behk = null;
  }
  ...
  {
    return a(this.jdField_a_of_type_Atbj, paramListAdapter);
  }
  
  ListAdapter a(atbj paramatbj, ListAdapter paramListAdapter)
  {
    ...
    if (paramatbj != null)
    {
      ...
      if (paramListAdapter != null) {
        localObject = new atbf(paramatbj, (BaseAdapter)paramListAdapter);
      }
    }
    return localObject;
  }
  ...
  begh a()
  {
    return this.jdField_a_of_type_Begh;
  }
  
  behk a()
  {
    return this.jdField_a_of_type_Behk;
  }
  ...
  public void a(atbj paramatbj)
  {
    if (this.jdField_a_of_type_Atbj != null)
    {
      this.jdField_a_of_type_Atbj.a(null);
      this.jdField_a_of_type_Atbj = null;
    }
    ...
    {
      paramatbj.a(this);
      a(a(paramatbj, this.jdField_a_of_type_AndroidWidgetListAdapter));
    }
    for (;;)
    {
      ...
      b();
      return;
      this.jdField_a_of_type_ComTencentWidgetAbsListView.setOnScrollListener(this.jdField_a_of_type_Begh);
      ...
      this.jdField_a_of_type_ComTencentWidgetAbsListView.setOnItemSelectedListener(this.jdField_a_of_type_Behk);
  ...
  public void a(behk parambehk)
  {
    ...
    this.jdField_a_of_type_Behk = parambehk;
  }
  
  public boolean a()
  {
    return this.jdField_a_of_type_Atbj != null;
  }
