  ...
  implements View.OnTouchListener
{
  ...
  public mii(Context paramContext, ImageView paramImageView1, ImageView paramImageView2, ShimmerTextView paramShimmerTextView, ImageView paramImageView3)
  {
    ...
    this.jdField_c_of_type_Int = paramContext.getResources().getDimensionPixelSize(2131297792);
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      do
      {
        ...
        } while (this.jdField_a_of_type_Mig == null);
