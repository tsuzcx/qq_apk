  ...
  public void onReceive(Context arg1, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      if ((i == 100) || (i < 0))
      {
        ...
        this.a.jdField_a_of_type_Int = bbtk.a(this.a.jdField_a_of_type_ComTencentMobileqqShortvideoGestureDownloadInfo);
        boolean bool;
        ...
        synchronized (this.a.jdField_a_of_type_JavaUtilArrayList)
        {
          ...
          while (???.hasNext()) {
            ((bbte)???.next()).a(bool, this.a.b(), this.a.jdField_a_of_type_Int);
          }
          bool = false;
        }
      }
