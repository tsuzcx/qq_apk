  ...
  extends bbtc
{
  ...
  {
    a.download(paramQQAppInterface, "specialRing." + paramInt, parambbqp, paramBoolean);
  }
  ...
  {
    paramContext = a.getDir(paramContext, "specialRing." + paramInt);
    paramContext = bbdx.a(new File(paramContext + File.separator + paramInt + ".json"));
