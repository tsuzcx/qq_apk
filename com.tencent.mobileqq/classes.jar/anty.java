  ...
  extends Drawable
{
  ...
  public anty(Resources paramResources, NinePatch paramNinePatch1, NinePatch paramNinePatch2, int paramInt)
  {
    ...
    if (paramResources != null)
    {
      ...
      this.jdField_b_of_type_Int = aekt.a(65.0F, paramResources);
      this.jdField_c_of_type_Int = aekt.a(57.0F, paramResources);
    }
  }
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      localObject = (HashMap)ansd.a().a.get(Integer.valueOf(this.jdField_d_of_type_Int));
      if ((localObject == null) || (((HashMap)localObject).size() <= 0)) {
        return;
      }
      localObject = ((HashMap)localObject).values().iterator();
      while (((Iterator)localObject).hasNext()) {
        ((antk)((Iterator)localObject).next()).a(this, paramCanvas);
      }
