  ...
  extends aode
{
  ...
  private Map<Long, anui> bgObserverMap = new HashMap();
  private long seq;
  private Map<Long, anui> uiObserverMap = new HashMap();
  
  private void dispatchMessage(int paramInt, boolean paramBoolean1, Object paramObject, boolean paramBoolean2, anui paramanui, MqqHandler paramMqqHandler)
  {
    paramObject = new BaseBusinessHandler.1(this, paramanui, paramInt, paramMqqHandler, paramBoolean1, paramObject);
    if (paramBoolean2)
    {
  ...
  protected void addBusinessObserver(ToServiceMsg paramToServiceMsg, anui paramanui, boolean paramBoolean)
  {
    if ((paramanui == null) || (paramBoolean)) {}
    synchronized (this.bgObserverMap)
    {
      ???.put(Long.valueOf(this.seq), paramanui);
      paramToServiceMsg = paramToServiceMsg.extraData;
      paramanui = SEQ_KEY;
      long l = this.seq;
      this.seq = (1L + l);
      paramToServiceMsg.putLong(paramanui, l);
      return;
      ??? = this.uiObserverMap;
    }
  }
  ...
  public ToServiceMsg createToServiceMsg(String paramString, anui paramanui)
  {
    return createToServiceMsg(paramString, paramanui, false);
  }
  
  ToServiceMsg createToServiceMsg(String arg1, anui paramanui, boolean paramBoolean)
  {
    ...
    {
      ???.put(Long.valueOf(this.seq), paramanui);
      paramanui = localToServiceMsg.extraData;
      String str = SEQ_KEY;
      long l = this.seq;
      this.seq = (1L + l);
      paramanui.putLong(str, l);
  ...
  public abstract List<anui> getObservers(int paramInt);
  ...
  public void notifyUI(int paramInt, boolean paramBoolean1, Object paramObject, boolean paramBoolean2)
  {
    ...
    if ((localList != null) && (localList.size() > 0)) {
      try
      {
        ...
        {
          localObject = (anui)localIterator.next();
          if ((observerClass() != null) && (observerClass().isAssignableFrom(localObject.getClass())))
          {
            long l = System.currentTimeMillis();
            ((anui)localObject).onUpdate(paramInt, paramBoolean1, paramObject);
    ...
    if ((localList != null) && (localList.size() > 0)) {
      try
      {
        ...
        while (localIterator.hasNext())
        {
          localObject = (anui)localIterator.next();
          if ((observerClass() != null) && (observerClass().isAssignableFrom(localObject.getClass()))) {
            dispatchMessage(paramInt, paramBoolean1, paramObject, paramBoolean2, (anui)localObject, uiHandler);
          }
        }
      }
      finally {}
    ...
    if ((localList != null) && (localList.size() > 0)) {
      try
      {
        ...
        while (localIterator.hasNext())
        {
          localObject = (anui)localIterator.next();
          if ((observerClass() != null) && (observerClass().isAssignableFrom(localObject.getClass()))) {
            dispatchMessage(paramInt, paramBoolean1, paramObject, paramBoolean2, (anui)localObject, bgHandler);
          }
        }
      }
      finally {}
  ...
  public void notifyUI(ToServiceMsg paramToServiceMsg, int paramInt, boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramToServiceMsg.extraData.containsKey(SEQ_KEY))
    {
      ...
      {
        paramToServiceMsg = (anui)this.uiObserverMap.remove(Long.valueOf(l));
    ...
    for (;;)
    {
      synchronized (this.bgObserverMap)
      {
        paramToServiceMsg = (anui)this.bgObserverMap.remove(Long.valueOf(l));
  ...
  protected aocj removeMessageObserver(ToServiceMsg paramToServiceMsg)
  {
    ...
    synchronized (this.uiObserverMap)
    {
      ...
      if (aocj.class.isInstance((anui)this.uiObserverMap.get(Long.valueOf(l))))
      {
        paramToServiceMsg = (aocj)this.uiObserverMap.remove(Long.valueOf(l));
