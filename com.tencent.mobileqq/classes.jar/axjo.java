...
public class axjo
  implements AdapterView.OnItemClickListener, axqa
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = antf.ba + "TempMail" + File.separator;
    j = anzj.a(2131699040);
  }
  
  public axjo(QQAppInterface paramQQAppInterface, Context paramContext, Activity paramActivity, BaseChatPie paramBaseChatPie, MqqHandler paramMqqHandler)
  {
  ...
  {
    URL localURL = beyq.a(paramMessageForPic, 131075);
    if (beqz.a(localURL.toString()) != null) {
      return beqz.d(localURL.toString());
    }
    localURL = beyq.a(paramMessageForPic, 1);
    if (beqz.a(localURL.toString()) != null) {
      return beqz.d(localURL.toString());
    }
    paramMessageForPic = beyq.a(paramMessageForPic, 65537);
    if (beqz.a(paramMessageForPic.toString()) != null) {
      return beqz.d(paramMessageForPic.toString());
    }
    return null;
  }
  ...
  public static String a(MessageForPic paramMessageForPic, List<String> paramList1, List<String> paramList2)
  {
    ...
    paramMessageForPic = "";
    if (str2.indexOf(".") == -1) {
      paramMessageForPic = bhmi.b(str1);
    }
    paramMessageForPic = anzj.a(2131699044) + paramList1.size() + "." + paramMessageForPic;
    paramList1 = paramMessageForPic + anzj.a(2131699039);
      ...
      if (paramMessageForStructing == null)
      {
        ...
        if (((StructMsgForGeneralShare)localObject2).mStructMsgItemLists != null)
        {
          ...
          for (;;)
          {
            ...
            {
              localObject3 = (bdre)localObject3;
              localObject1 = paramMessageForStructing;
              if (((bdre)localObject3).a != null)
              {
                localObject3 = ((bdre)localObject3).a.iterator();
                for (;;)
                {
                  localObject1 = paramMessageForStructing;
                  ...
                  if ((localObject1 instanceof bdtj)) {
                    paramMessageForStructing = ((bdtj)localObject1).ai;
                  }
                }
              }
            }
  ...
  public void a(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          paramArrayList = Intent.createChooser((Intent)paramMap.remove(0), anzj.a(2131699038));
    ...
    this.jdField_a_of_type_AndroidContentContext.startActivity(Intent.createChooser(localIntent, anzj.a(2131699036)));
  }
  ...
  public void a(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList, Intent paramIntent)
  {
    ...
    //   19: ifne +725 -> 744
    //   22: aload_0
    //   23: getfield 103	axjo:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   26: ldc_w 415
    ...
    //   37: iconst_0
    //   38: aload_0
    //   39: getfield 101	axjo:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   42: aload 6
    //   44: getfield 421	com/tencent/mobileqq/data/ChatMessage:selfuin	Ljava/lang/String;
    //   47: invokestatic 426	bhlg:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   50: aastore
    //   51: dup
    //   52: iconst_1
    //   53: aload_0
    //   54: getfield 101	axjo:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   57: aload 6
    //   59: getfield 429	com/tencent/mobileqq/data/ChatMessage:frienduin	Ljava/lang/String;
    //   62: invokestatic 426	bhlg:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   65: aastore
    ...
    //   80: pop
    //   81: getstatic 56	axjo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   84: iconst_1
    //   85: invokestatic 438	bhmi:a	(Ljava/lang/String;Z)V
    //   88: new 47	java/io/File
    //   91: dup
    //   92: getstatic 56	axjo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   165: getstatic 56	axjo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   168: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   171: getstatic 64	axjo:j	Ljava/lang/String;
    ...
    //   180: invokestatic 448	bhmi:a	(Ljava/lang/String;)Ljava/io/File;
    //   183: pop
    ...
    //   199: getstatic 56	axjo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   202: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   205: getstatic 64	axjo:j	Ljava/lang/String;
    ...
    //   442: astore 7
    //   444: aload 5
    //   446: invokestatic 521	behh:a	(Ljava/lang/String;)Z
    //   449: ifeq +1189 -> 1638
    //   452: aload 5
    //   454: invokestatic 522	behh:d	(Ljava/lang/String;)Ljava/lang/String;
    //   457: astore 7
    //   459: goto +1179 -> 1638
    //   462: aload 6
    //   464: astore 7
    ...
    //   753: aload_0
    //   754: getfield 103	axjo:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   757: ldc_w 547
    ...
    //   768: iconst_0
    //   769: aload_0
    //   770: getfield 101	axjo:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   773: aload 6
    //   775: getfield 429	com/tencent/mobileqq/data/ChatMessage:frienduin	Ljava/lang/String;
    //   778: invokestatic 549	bhlg:g	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   781: aastore
    ...
    //   801: aload_0
    //   802: getfield 103	axjo:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   805: ldc_w 547
    ...
    //   816: iconst_0
    //   817: aload_0
    //   818: getfield 101	axjo:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   821: aload_0
    //   822: getfield 101	axjo:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   833: invokestatic 558	bhlg:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    //   836: aastore
    ...
    //   868: aload 12
    //   870: aload 13
    //   872: invokestatic 563	axjo:a	(Lcom/tencent/mobileqq/data/MessageForPic;Ljava/util/List;Ljava/util/List;)Ljava/lang/String;
    //   875: astore 5
    //   877: goto -415 -> 462
    //   880: aload 16
    //   882: instanceof 565
    ...
    //   951: ldc_w 574
    //   954: invokestatic 62	anzj:a	(I)Ljava/lang/String;
    ...
    //   993: ldc_w 577
    //   996: invokestatic 62	anzj:a	(I)Ljava/lang/String;
    ...
    //   1111: ldc_w 595
    //   1114: invokestatic 62	anzj:a	(I)Ljava/lang/String;
    //   1117: astore 5
    //   1119: goto -657 -> 462
    //   1122: ldc_w 597
    //   1125: aload 7
    ...
    //   1136: ifeq +14 -> 1150
    //   1139: ldc_w 603
    //   1142: invokestatic 62	anzj:a	(I)Ljava/lang/String;
    //   1145: astore 5
    //   1147: goto -41 -> 1106
    //   1150: aload 7
    ...
    //   1163: aload_0
    //   1164: aload 7
    //   1166: invokevirtual 608	axjo:a	(Lcom/tencent/mobileqq/data/MessageForStructing;)Ljava/lang/String;
    //   1169: astore 5
    //   1171: goto -65 -> 1106
    //   1174: aload 7
    ...
    //   1277: aload_1
    //   1278: aload_0
    //   1279: getstatic 64	axjo:j	Ljava/lang/String;
    //   1282: invokevirtual 630	axjo:a	(Ljava/lang/String;)Landroid/net/Uri;
    ...
    //   1336: getstatic 56	axjo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   1367: invokestatic 637	bhmi:d	(Ljava/lang/String;Ljava/lang/String;)Z
    //   1370: ifeq -63 -> 1307
    //   1373: aload_1
    //   1374: aload_0
    //   1375: aload 13
    ...
    //   1394: invokevirtual 630	axjo:a	(Ljava/lang/String;)Landroid/net/Uri;
    ...
    //   1512: getstatic 56	axjo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   1543: invokestatic 637	bhmi:d	(Ljava/lang/String;Ljava/lang/String;)Z
    //   1546: ifeq -63 -> 1483
    //   1549: aload_1
    //   1550: aload_0
    //   1551: aload 11
    ...
    //   1570: invokevirtual 630	axjo:a	(Ljava/lang/String;)Landroid/net/Uri;
  ...
  public boolean a()
  {
    Iterator localIterator = axpf.a().a.entrySet().iterator();
    boolean bool2 = false;
    if (localIterator.hasNext())
    {
      ...
      if (((Boolean)((Map.Entry)localObject).getValue()).booleanValue())
      {
        ...
        bool2 |= anxg.a((MessageRecord)localObject);
        if (aost.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject)) {}
      }
    }
    while (bool2)
    {
      ...
      do
      {
        do
        {
          ...
          localObject = bgsk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForTroopFile)localObject);
        } while (localObject == null);
        bool1 = bool2;
        if (((bftf)localObject).b == 8) {
          break;
        }
        bool1 = bool2;
        if (((bftf)localObject).b == 9) {
          break;
        }
        bool1 = bool2;
        if (((bftf)localObject).b == 6) {
          break;
        }
        bool1 = bool2;
        if (((bftf)localObject).b == 7) {
          break;
        }
        if (((bftf)localObject).b == 11)
        {
          bool1 = bool2;
  ...
  {
    if (((paramChatMessage instanceof MessageForPic)) && (anxg.a(paramChatMessage))) {
      return false;
    }
    ...
    else if (((paramChatMessage instanceof MessageForPic)) && (aiyz.a((MessageForPic)paramChatMessage)))
    {
      return false;
    }
    return aost.a(paramChatMessage);
  }
  ...
  public List<ShareActionSheetBuilder.ActionSheetItem>[] a(Context paramContext)
  {
    ...
    for (int m = 1;; m = 0)
    {
      ...
      ((ShareActionSheetBuilder.ActionSheetItem)localObject).label = paramContext.getString(2131695744);
      ((ShareActionSheetBuilder.ActionSheetItem)localObject).icon = 2130839311;
      ...
      {
        localObject = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject).label = paramContext.getString(2131692528);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject).icon = 2130840154;
      ...
      if (k != 0)
      {
        ...
        localActionSheetItem.label = paramContext.getString(2131695746);
        localActionSheetItem.icon = 2130839344;
        localActionSheetItem.iconNeedBg = true;
        localActionSheetItem.action = 26;
        localActionSheetItem.argus = "";
        ((ArrayList)localObject).add(localActionSheetItem);
      }
      if (aixg.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int))
      {
        localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
        localActionSheetItem.label = paramContext.getString(2131689959);
        localActionSheetItem.icon = 2130837959;
        localActionSheetItem.iconNeedBg = true;
      ...
      {
        localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
        localActionSheetItem.label = paramContext.getString(2131695761);
        localActionSheetItem.icon = 2130839487;
        localActionSheetItem.iconNeedBg = true;
      ...
      localActionSheetItem.label = paramContext.getString(2131695742);
      ...
      ((ArrayList)localObject).add(localActionSheetItem);
      localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
      localActionSheetItem.label = paramContext.getString(2131695737);
      localActionSheetItem.icon = 2130840122;
      localActionSheetItem.iconNeedBg = true;
  ...
  public void b()
  {
    Iterator localIterator = axpf.a().a().iterator();
    ...
    do
    {
      ...
      k = ahgk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage);
    } while ((!(localChatMessage instanceof MessageForPic)) || (k != 1) || (bhnt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForPic)localChatMessage, false)));
  ...
  public void b(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList)
  {
    ...
    if (k < paramArrayList.size())
    {
      ...
      for (;;)
      {
        ...
        {
          localObject1 = anzj.a(2131699037);
        }
        else if ((localChatMessage instanceof MessageForShortVideo))
        {
          localObject1 = anzj.a(2131699041);
        }
        else
        {
    ...
    for (;;)
    {
      ...
      localObject1 = anzj.a(2131699043);
      break;
      ...
      else
      {
        ...
        if (((MessageForStructing)localObject1).structingMsg.mMsgUrl != null)
        {
          ...
          if (((localChatMessage instanceof MessageForArkFlashChat)) && (localChatMessage.msg != null))
          {
            ...
            QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131693895, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
            return;
          }
          localObject1 = null;
          break;
  ...
  public boolean b()
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      if (((Boolean)((Map.Entry)localObject).getValue()).booleanValue())
      {
        localObject = (ChatMessage)((Map.Entry)localObject).getKey();
        bool2 |= anxg.a((MessageRecord)localObject);
        if (aost.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject)) {}
      }
    }
    while (bool2)
    {
      ...
      do
      {
        ...
        localObject = (MessageForTroopFile)localObject;
      } while (bgsk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForTroopFile)localObject) == null);
      boolean bool1 = bool2;
      bool2 = bool1;
      break;
    }
  ...
  public boolean b(ChatMessage paramChatMessage)
  {
    ...
    if (((paramChatMessage instanceof MessageForPic)) && (aiyz.a((MessageForPic)paramChatMessage))) {
      return false;
    }
    return aost.a(paramChatMessage);
  }
  ...
  public boolean c()
  {
    ...
    Object localObject1 = axpf.a().a();
    if (((List)localObject1).size() == 0)
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131697752, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      return false;
    }
    ...
    if (localArrayList1.size() > 0)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        bgsk.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject2);
      }
    }
    ...
    if (localArrayList2.size() > 0)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        localFileManagerEntity = aunj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForFile);
      ...
      localObject2 = aunj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForFile)localObject1);
      if (localObject2 == null)
      {
        auna.a(2131692320);
        return false;
      ...
      aunj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject1, BaseActivity.sTopActivity);
    }
    while ((localArrayList1.size() == 0) && (localArrayList2.size() == 0))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        aunj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject2, BaseActivity.sTopActivity);
      }
    }
    return true;
  }
  ...
  public void d()
  {
    ...
    ((aiwv)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(59)).b(localList, System.currentTimeMillis() + 60000L, 2);
  }
  ...
  public boolean e()
  {
    ...
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131693889, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      return false;
    }
    ((agvl)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(1)).a(localList, 3);
    return true;
  }
  ...
  public boolean g()
  {
    ...
    if (localList.isEmpty())
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131693894, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      return false;
    }
    ((agvl)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(1)).a(localList, 4);
    return true;
  }
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      default: 
        break;
      case 9: 
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", e, e, 0, 0, "", "", "", "");
        k = -1;
        ...
        if (this.jdField_a_of_type_Bjig != null) {
          this.jdField_a_of_type_Bjig = new axjp(this);
        }
        WXShareHelper.a().a(this.jdField_a_of_type_Bjig);
        ((agvl)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(1)).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Aggs, true);
        break;
      case 25: 
        label216:
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", f, f, 0, 0, "", "", "", "");
        if (!d()) {
          bhlq.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131693888)).setPositiveButton(17039370, new axjt(this)).setNegativeButton(17039360, new axjs(this)).show();
        } else if ((!axpf.a().a().isEmpty()) && (e())) {
          this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
        }
        break;
      }
    }
    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", i, i, 0, 0, "", "", "", "");
    Object localObject2 = axpf.a().a();
    localObject1 = new ArrayList();
    ...
    if (((Iterator)localObject2).hasNext())
    {
      ...
      m = ahgk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject3);
      if (((localObject3 instanceof MessageForPic)) && (m == 1))
      {
        if (bhnt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForPic)localObject3, false)) {
          break label1336;
        }
    ...
    for (;;)
    {
      ...
      {
        QQToast.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getString(2131717544), 0).a();
        break;
      }
      ...
      bbqb.a(this.jdField_a_of_type_AndroidAppActivity, (String)localObject2, (String)localObject3, (String)localObject4, m, (List)localObject1, 102);
      break;
      if (!b())
      {
        bhlq.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131693898)).setPositiveButton(17039370, new axjv(this)).setNegativeButton(17039360, new axju(this)).show();
        break;
      }
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80067F7", "0X80067F7", 0, 0, "", "", "", "");
      if (!c()) {
        break;
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
      break;
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", g, g, 0, 0, "", "", "", "");
      if (!a())
      {
        bhlq.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131693896)).setPositiveButton(17039370, new axjx(this)).setNegativeButton(17039360, new axjw(this)).show();
        break;
      }
      if (!bnzk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), this.jdField_a_of_type_MqqOsMqqHandler)) {
        break;
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
      break;
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", h, h, 0, 0, "", "", "", "");
      if (!f())
      {
        bhlq.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131693893)).setPositiveButton(17039370, new axjz(this)).setNegativeButton(17039360, new axjy(this)).show();
        break;
      }
      if ((axpf.a().a().isEmpty()) || (!g())) {
        break;
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
      break;
      localObject1 = new axps(this.jdField_a_of_type_AndroidAppActivity);
      localObject2 = (axqb)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(324);
      if ((localObject2 == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Aggs == null)) {
        break;
      }
      localObject3 = new ArrayList();
      localObject4 = axpf.a().a.entrySet().iterator();
      ...
      localObject3 = axpw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (List)localObject3, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Aggs.a, this);
      if ((localObject3 == null) || (((List)localObject3).isEmpty()))
      {
        QQToast.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getString(2131717543), 0).a();
        break;
      }
      ...
      ((axqb)localObject2).a(new axjq(this, (axps)localObject1, (axqb)localObject2, (List)localObject3));
      ((axqb)localObject2).a((List)localObject3, true);
      ...
      ((axqb)localObject2).a((List)localObject3, 1, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
      break;
      d();
      break;
    }
