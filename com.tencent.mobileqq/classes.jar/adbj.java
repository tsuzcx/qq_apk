...
public class adbj
  extends andd
{
  public adbj(ChatSettingForTroop paramChatSettingForTroop) {}
  ...
  protected void onGetAddedRobots(boolean paramBoolean, int paramInt, long paramLong, ArrayList<bfdl> paramArrayList)
  {
  ...
  protected void onTroopManagerFailed(int paramInt1, int paramInt2)
  {
    ...
    this.a.jdField_a_of_type_Bhhw.b(2, 2131691945, 1500);
    this.a.finish();
  }
    ...
    do
    {
      for (;;)
      {
        ...
        if ((1 == paramInt1) && ((this.a.isResume()) || (this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.cGroupOption == 1)))
        {
          ...
          case -1: 
          default: 
            this.a.jdField_a_of_type_Bhhw.b(2, 2131693219, 1500);
          }
          for (;;)
          {
            this.a.b = null;
            return;
            ((anca)this.a.app.getBusinessHandler(20)).b(Long.parseLong(paramString), Long.parseLong(this.a.app.getAccount()));
            continue;
            this.a.jdField_a_of_type_Bhhw.b(2, 2131693220, 1500);
            this.a.finish();
            ...
            if (localObject != null)
            {
              ...
              continue;
              this.a.jdField_a_of_type_Bhhw.b(2, 2131719201, 1500);
            }
          }
        }
        if (this.a.isResume())
        {
          ...
          if (paramInt2 == 0)
          {
            ...
            for (paramString = null;; paramString = paramString.b(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin))
            {
              ...
              this.a.c.setText(amtj.a(2131700900) + this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.wMemberNum + amtj.a(2131700902));
              return;
            }
          }
        }
  ...
  protected void onTroopMemberActiveRankingDesc(boolean paramBoolean1, String paramString1, boolean paramBoolean2, String paramString2)
  {
    ...
    do
    {
      ...
      paramString1 = (TextView)localView.findViewById(2131376413);
