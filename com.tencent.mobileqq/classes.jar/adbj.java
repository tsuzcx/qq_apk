...
{
  adbj(adbi paramadbi, int paramInt, adaa paramadaa) {}
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    this.jdField_a_of_type_Adbi.a.dismiss();
    label104:
    int j;
    int i;
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          addh.a(this.jdField_a_of_type_Adaa, (JSONObject)localObject1);
          l = paramLong;
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            ...
            addh.a(localadaa, -1, (String)localObject2);
          }
        }
      }
      label358:
