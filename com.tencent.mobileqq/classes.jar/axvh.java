  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      View localView = paramView.findViewById(2131376585);
      if (localView != null)
      {
        Object localObject1 = localView.getTag(2131376585);
        if ((localObject1 != null) && (StructMsgForGeneralShare.class.isInstance(localObject1)))
        {
          ...
          if (localObject1 != null) {
            if ((localObject1 instanceof aebu))
            {
              localObject2 = (aebu)localObject1;
          ...
          for (;;)
          {
            ...
            if (paramView.getTag(2131376582) == null) {
              break;
            }
            do
            {
              localObject2 = null;
              break;
            } while (paramView.getTag(2131376582) != null);
            return;
            label235:
            ...
            if ((localObject1 != null) && ((localObject1 instanceof QQAppInterface)))
            {
              ...
              akwu.a((QQAppInterface)localObject1, 0, 4, localStructMsgForGeneralShare.message);
              ...
              try
              {
                ...
                sep.a((AppInterface)localObject1, localStructMsgForGeneralShare.message.selfuin, ((JSONObject)localObject3).toString(), "" + localStructMsgForGeneralShare.msgId);
                Object localObject4 = (nqn)((QQAppInterface)localObject1).getManager(88);
                localObject3 = (nrf)((QQAppInterface)localObject1).a(88);
                if ((localStructMsgForGeneralShare.message != null) && (localObject4 != null) && (localObject3 != null) && (((nqn)localObject4).a(localStructMsgForGeneralShare.message.senderuin)))
                {
                  localObject4 = localStructMsgForGeneralShare.message;
                  if (TextUtils.isEmpty(localStructMsgForGeneralShare.index))
                  {
                    i = 0;
                    ((nrf)localObject3).a(false, (MessageRecord)localObject4, i, localStructMsgForGeneralShare.mMsgUrl);
                  }
                }
                else
                {
                  ...
                  {
                    axqy.b((QQAppInterface)localObject1, "P_CliOper", "Pb_account_lifeservice", localStructMsgForGeneralShare.uin, "mp_msg_msgpic_click", "aio_morpic_click", 0, 0, "", "", Long.toString(localStructMsgForGeneralShare.msgId), "");
                  ...
                  if ((localObject2 != null) && (((aebu)localObject2).a != null)) {
                    nau.a((QQAppInterface)localObject1, "", "click", localStructMsgForGeneralShare.mSourceAppid, localStructMsgForGeneralShare.mMsgServiceID, nau.a(((aebu)localObject2).a.jdField_a_of_type_Int));
                  }
                  ...
                  axqy.b((QQAppInterface)localObject1, "CliOper", "", "", "0X800567A", "0X800567A", 0, 0, localStructMsgForGeneralShare.mMsgServiceID + "", "", "", "");
                  if (localStructMsgForGeneralShare.uinType != 1008) {
                    break label1573;
                  }
                  j = 2;
                  axqy.b((QQAppInterface)localObject1, "CliOper", "", "", "0X8004B5C", "0X8004B5C", j, 0, "", String.valueOf(i), (String)localObject3, localStructMsgForGeneralShare.source_puin);
                  axqy.b(null, "dc00898", "", "", "0X800A630", "0X800A630", 0, 0, "1", ForwardUtils.b(localStructMsgForGeneralShare.uinType), localStructMsgForGeneralShare.mContentTitle, "");
                  ...
                  if ((localView instanceof ViewGroup))
                  {
                    ...
                    if ((localObject3 != null) && ((localObject3 instanceof TextViewWrapLayout)))
                    {
                      ...
                      if ((localObject3 != null) && ((localObject3 instanceof axxi))) {
                        axqy.b((QQAppInterface)localObject1, "dc00898", "", "", "0X8007C38", "0X8007C38", 0, 0, ((axxi)localObject3).k + "", "", "", "");
                      }
                    }
                  }
                  if ((localObject2 != null) && (localStructMsgForGeneralShare.hasFlag(16)))
                  {
                    ...
                    ThreadManager.post(new StructMsgForGeneralShare.5.2(this, (aebu)localObject2, (QQAppInterface)localObject1), 2, null, false);
                  }
                  if ((localStructMsgForGeneralShare != null) && (localObject2 != null) && (((aebu)localObject2).a != null) && ((((aebu)localObject2).a.jdField_a_of_type_Int == 1025) || (((aebu)localObject2).a.jdField_a_of_type_Int == 0)) && (!TextUtils.isEmpty(localStructMsgForGeneralShare.mMsgAction)) && (myv.b(((aebu)localObject2).a.jdField_a_of_type_JavaLangString)) && ((localStructMsgForGeneralShare.mMsgServiceID != 92) || (localStructMsgForGeneralShare.message == null))) {}
                }
                try
                {
                  if (QLog.isColorLevel()) {
                  ...
                  if (!localStructMsgForGeneralShare.mQidianBulkTaskId.equals("0"))
                  {
                    ...
                    ((bdvn)((QQAppInterface)localObject1).a(85)).a(((JSONObject)localObject2).toString(), localStructMsgForGeneralShare.message.frienduin, "", 10009, 0);
                  }
                }
                ...
                ((bduf)((QQAppInterface)localObject1).getManager(165)).a(localStructMsgForGeneralShare.mMsgAction, localStructMsgForGeneralShare.mMsg_A_ActionData, localStructMsgForGeneralShare.mMsgActionData, localStructMsgForGeneralShare.mMsgUrl, 0, "");
                if (localChatFragment != null)
                {
                  localObject2 = localChatFragment.a();
                  if ((localObject2 instanceof aert)) {
                    ((aert)localObject2).a.b();
                  }
                }
                StructMsgForGeneralShare.onClickEvent((QQAppInterface)localObject1, localContext, localStructMsgForGeneralShare, paramView, new axvm((QQAppInterface)localObject1, paramView, localStructMsgForGeneralShare));
                return;
              }
              catch (JSONException localJSONException)
              {
                for (;;)
                {
                  ...
                  else
                  {
                    ...
                    j = 1;
                    continue;
                    if ((localStructMsgForGeneralShare != null) && (localObject2 != null) && (((aebu)localObject2).a != null) && (!TextUtils.isEmpty(localStructMsgForGeneralShare.mMsgAction)) && (((aebu)localObject2).a.jdField_a_of_type_Int == 1024)) {
                      ((bduf)((QQAppInterface)localObject1).getManager(165)).a(localStructMsgForGeneralShare.mMsgAction, localStructMsgForGeneralShare.mMsg_A_ActionData, localStructMsgForGeneralShare.mMsgActionData, localStructMsgForGeneralShare.mMsgUrl, 1, "");
                    }
                  }
                }
              }
