...
public class avzd
{
  ...
  avzg jdField_a_of_type_Avzg = new avzg(this);
  List<avzh> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  private void a(String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    {
      avzh localavzh = (avzh)localIterator.next();
      if (localavzh != null) {
        localavzh.a(paramString, paramBoolean, paramInt);
      }
    }
  ...
  public avzg a()
  {
    return this.jdField_a_of_type_Avzg;
  }
  
  public void a()
  {
    this.jdField_a_of_type_Avzg = new avzg(this);
  }
  
  public void a(AppInterface paramAppInterface, String paramString1, Context paramContext, String paramString2, avzh paramavzh)
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Avzg.b))
    {
      if (paramavzh != null) {
        paramavzh.a(paramString1, true, 0);
      }
      return;
    }
    avzf localavzf = new avzf(this, paramavzh, paramString1);
    ...
    paramString2 = bjva.a(paramContext);
    ...
    for (;;)
    {
      ...
      paramContext = new NewIntent(paramContext, nkl.class);
      ...
      try
      {
        ...
        paramContext.setObserver(localavzf);
      ...
      catch (Exception paramString2)
      {
        for (;;)
        {
          paramavzh.a(paramString1, false, -10001);
        }
      }
    }
  }
  
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, avzh paramavzh, boolean paramBoolean, String paramString5)
  {
    QLog.i("XProxy", 2, "开始拉取A1，uin = " + paramString1 + " appid = " + paramString4);
    if ((this.jdField_a_of_type_Avzg.a != null) && (!paramBoolean) && (System.currentTimeMillis() - this.jdField_a_of_type_Long < 43200000L))
    {
      if (paramavzh != null) {
        paramavzh.a(paramString2, true, 0);
      }
      return true;
    }
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_JavaUtilList.add(paramavzh);
      return true;
    }
    ...
    for (;;)
    {
      this.jdField_a_of_type_OicqWlogin_sdkRequestWtloginHelper.SetListener(new avze(this, paramString2));
      this.jdField_a_of_type_JavaUtilList.add(paramavzh);
      ...
      {
        paramString5 = bhml.a(paramString5);
      }
    }
  }
}
