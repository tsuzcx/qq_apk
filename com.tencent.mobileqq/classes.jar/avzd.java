  ...
  extends xfp
{
  ...
  private long a(String paramString)
  {
    ...
    {
      long l = baub.a((QQAppInterface)localAppRuntime, "name_plate_config_version", 0L);
  ...
  private boolean b(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    String str3 = paramToServiceMsg.extraData.getString(ajve.a);
    Object localObject = paramToServiceMsg.extraData.getString(ajve.c);
    long l1 = paramToServiceMsg.extraData.getLong(ajve.l);
    boolean bool3 = baov.a();
    boolean bool1 = false;
    boolean bool2 = false;
    ...
    String str4 = bati.a(0, BaseApplicationImpl.getContext());
    localObject = bati.a(1, BaseApplicationImpl.getContext());
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        localPrivExtV2Req.pullPayRuleCfgTime = baub.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "last_pull_pay_rule", 0L);
        ...
        paramToServiceMsg.extraData.putBoolean(ajve.h, bool1);
        paramToServiceMsg.extraData.putBoolean(ajve.i, bool2);
        ...
        try
        {
          localPrivExtV2Req.sImsi1 = befc.b("a4bd32");
        }
    ...
    {
      if (bool1) {
        paramToServiceMsg.extraData.putString(ajve.j, localPrivExtV2Req.sImsi1);
      }
      if (bool2) {
        paramToServiceMsg.extraData.putString(ajve.k, localPrivExtV2Req.sImsi2);
      }
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    do
    {
      ...
      if ("ClubInfoSvc.guanjiaReport".equals(paramToServiceMsg.getServiceCmd()))
      {
        ...
        localObject = paramToServiceMsg.extraData.getString(ajve.a);
        ...
        localGuanjiaReportReq.sPhoneNum = paramToServiceMsg.extraData.getString(ajve.d);
        localGuanjiaReportReq.bKingCard = paramToServiceMsg.extraData.getBoolean(ajve.e);
        localGuanjiaReportReq.iCardType = paramToServiceMsg.extraData.getInt(ajve.f);
        localGuanjiaReportReq.iCardStatus = paramToServiceMsg.extraData.getInt(ajve.g);
      ...
      ((GetCustomOnlineStatusReq)localObject).lUin = paramToServiceMsg.extraData.getLong(ajve.m);
      ((GetCustomOnlineStatusReq)localObject).sIMei = paramToServiceMsg.extraData.getString(ajve.n);
