...
public class auyp
  implements auyy<BubbleRecommendRsp>
{
  public int a()
  {
    return 4;
  ...
  {
    return bgyg.a(paramContext, "bubble", "mvip.gongneng.android.bubble.index_dynamic_tab");
  }
  
  public String a(FontBubble paramFontBubble)
  {
    return bgyg.a("bubblePreview").replace("[id]", Integer.toString(paramFontBubble.bubbleId));
  }
  
  public List<FontBubble> a(QQAppInterface paramQQAppInterface, BubbleRecommendRsp paramBubbleRecommendRsp)
  {
    int j = 0;
    paramQQAppInterface = ((anmw)paramQQAppInterface.getManager(51)).a(paramQQAppInterface.getAccount());
    int i;
