  ...
  implements aywy
{
  ...
  public aglq(Context paramContext, LocalMediaInfo paramLocalMediaInfo)
  {
    Resources localResources = paramContext.getResources();
    this.f = localResources.getDisplayMetrics().density;
    jdField_a_of_type_Float = localResources.getDimension(2131296962);
    b = localResources.getDimension(2131296960);
    c = localResources.getDimension(2131296961);
  ...
  {
    int i = bbbx.a(paramLocalMediaInfo);
    ...
    if (i == 0) {
      try
      {
        ...
        if ((!paramContext.isInJustDecodeBounds) && (paramContext.needRegionDecode))
        {
          ...
          localaxrn.a(null, "safeDecode", bool, l, paramContext.rawWidth * i, paramOptions, "");
        }
  ...
  public Bitmap a(URL paramURL)
  {
    ...
    int i = aywm.a(localLocalMediaInfo.path);
