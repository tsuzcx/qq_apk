  ...
  extends anvi
{
  ...
  protected void onGetHeadInfo(boolean paramBoolean, Setting paramSetting)
  {
    ...
    for (String str = paramSetting.uin;; str = "")
    {
      ...
      if ((paramSetting != null) && (paramSetting.uin != null) && (paramSetting.uin.equals(bhaf.a(this.a)))) {
  ...
  public void onGetHeadInfoEmpty(boolean paramBoolean, int paramInt, List<String> paramList)
  {
    ...
    for (String str = paramList.toString();; str = "")
    {
      ...
      if (paramList != null)
      {
        ...
        while (paramList.hasNext())
        {
          ...
          if ((str != null) && (str.equals(bhaf.a(this.a))))
          {
            if (!paramBoolean) {
              break label145;
            }
    ...
    label145:
    bhaf.a(this.a).obtainMessage(1).sendToTarget();
  }
}
