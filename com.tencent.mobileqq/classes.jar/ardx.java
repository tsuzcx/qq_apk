  ...
  implements PluginManagerUpdater
{
  ...
  public ardx(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    this.e = paramString3;
    ...
    this.jdField_a_of_type_Ardw = new ardw(paramContext, paramString1, paramString3);
  ...
  private boolean a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        throw new Error(this.jdField_a_of_type_JavaLangString + ajyc.a(2131701458));
      }
      finally
      {
        localObject1 = null;
      ...
      try
      {
        if (((HttpURLConnection)localObject1).getResponseCode() != 200) {
          throw new Error(ajyc.a(2131701460) + 200 + ajyc.a(2131701461) + ((HttpURLConnection)localObject1).getResponseCode());
        }
  ...
  public File a()
  {
    ...
    arhu localarhu = new arhu();
    localarhu.a(BaseApplicationImpl.getContext());
    localarhu.a(this.jdField_a_of_type_JavaLangString, new ardz(this, localFile, arrayOfException, l, localCountDownLatch));
    localarhu.b(arhw.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaIoFile.getAbsolutePath()));
  ...
  {
    throw new UnsupportedOperationException(ajyc.a(2131701459));
  }
  ...
  public Future<File> update()
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentFuture = akhl.a(192).submit(new ardy(this));
    return this.jdField_a_of_type_JavaUtilConcurrentFuture;
  }
