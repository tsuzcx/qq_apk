...
public class ardx
  implements Manager
{
  private static final String jdField_a_of_type_JavaLangString = ardx.class.getSimpleName();
  ...
  public ardx(QQAppInterface paramQQAppInterface)
  {
  ...
  private ardt a()
  {
    if (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null) {
      return (ardt)((BaseChatPie)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a(16);
    }
    return null;
  }
  ...
  private boolean a()
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && ((this.jdField_a_of_type_JavaLangRefWeakReference.get() instanceof aeqs))) {
      return c();
    }
    return b();
  }
