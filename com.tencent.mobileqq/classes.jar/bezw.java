...
public class bezw
  extends QIPCModule
{
  private static bezw jdField_a_of_type_Bezw;
  bezx jdField_a_of_type_Bezx;
  ...
  public static bezw a()
  {
    if (jdField_a_of_type_Bezw == null) {}
    try
    {
      if (jdField_a_of_type_Bezw == null) {
        jdField_a_of_type_Bezw = new bezw("QQComicIPCModule");
      }
      return jdField_a_of_type_Bezw;
    }
    finally {}
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("isLebaItemOpen".equals(paramString))
    {
      ...
      paramString = ((auqh)((QQAppInterface)localObject).getManager(36)).a().iterator();
      do
      {
      ...
      for (;;)
      {
        ...
        else
        {
          if ("getComicConfig".equals(paramString))
          {
            ...
            {
              if (this.jdField_a_of_type_Bezx == null) {
                this.jdField_a_of_type_Bezx = new bezx(this, paramInt);
              }
              paramString.addCallBacker(this.jdField_a_of_type_Bezx);
            }
          ...
          if ("getPlayerSo".equals(paramString)) {
            bezr.a((QQAppInterface)localObject);
          }
        }
      }
    }
