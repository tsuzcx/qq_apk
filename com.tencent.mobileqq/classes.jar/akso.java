  ...
  implements INetInfoHandler, DownloaderInterface
{
  ...
  public akso(AppRuntime paramAppRuntime, DownloaderFactory.DownloadConfig paramDownloadConfig)
  {
  ...
  void a()
  {
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        return;
        label288:
        ThreadManager.postDownLoadTask(new aksp(this, localDownloadTask1), 2, null, false);
