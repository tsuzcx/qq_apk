...
public class qsq
  extends qqt
{
  public qsq(Context paramContext, aobu paramaobu, snh paramsnh)
  {
  ...
  public qqt d()
  {
    ...
    if ((this.jdField_a_of_type_Qqs != null) && ((this.jdField_a_of_type_Qqs instanceof ComponentContentBig)) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle != null))
    {
      ...
      ((LinearLayout.LayoutParams)localObject).setMargins(0, afur.a(13.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, afur.a(13.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      ((RelativeLayout.LayoutParams)localObject).setMargins(afur.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, afur.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle.setLayoutParams((ViewGroup.LayoutParams)localObject);
      ...
      localLinearLayout2.setOnClickListener(new qsr(this));
