...
public class aqug
  implements alsy, Manager
{
  static int jdField_a_of_type_Int = 3600;
  public long a;
  private SharedPreferences jdField_a_of_type_AndroidContentSharedPreferences;
  protected Handler a;
  private aqum jdField_a_of_type_Aqum;
  public String a;
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  public Vector<aqul> a;
  ...
  public aqug(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilVector = new Vector();
    this.jdField_a_of_type_AndroidOsHandler = new aquh(this, Looper.getMainLooper());
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        a("https://openmobile.qq.com/gameteam/get_team_context?uin=" + paramQQAppInterface.getCurrentAccountUin(), new aqui(this));
        this.jdField_a_of_type_Aqum = ((aqum)a());
        alsx.a("com.tencent.qqopen.teamup", this);
        return;
        i = 0;
      }
  ...
  private void a(SubMsgType0xaa.GameTeam_TurnOverMessage paramGameTeam_TurnOverMessage, boolean paramBoolean)
  {
    ...
    do
    {
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  this.jdField_c_of_type_Int = j;
                  this.e = k;
                  this.jdField_a_of_type_Aqum.setChanged();
                  this.jdField_a_of_type_Aqum.notifyObservers(Integer.valueOf(2));
                  return;
                  if (!bool2) {
                    break;
                  }
      ...
      if (localObject == null)
      {
        this.jdField_a_of_type_JavaUtilVector.add(new aqul(this, this.f, this.jdField_c_of_type_JavaLangString));
        this.jdField_a_of_type_JavaLangString = str1;
        this.jdField_b_of_type_Int = i;
        this.jdField_c_of_type_Int = j;
        this.jdField_a_of_type_Long = l;
      ...
      while (paramGameTeam_TurnOverMessage.hasNext())
      {
        ...
        if ((((SubMsgType0xaa.InviteSource)localObject).type.has()) && (((SubMsgType0xaa.InviteSource)localObject).src.has()))
        {
          ...
          {
            localObject = new aqul(this, b(m), (String)localObject);
    ...
    this.jdField_a_of_type_JavaUtilVector.clear();
    if (localObject == null) {
      this.jdField_a_of_type_JavaUtilVector.add(new aqul(this, b(m), str3));
    }
    for (;;)
    {
      this.jdField_a_of_type_Aqum.setChanged();
      ...
      while (paramGameTeam_TurnOverMessage.hasNext())
      {
        ...
        if ((((SubMsgType0xaa.InviteSource)localObject).type.has()) && (((SubMsgType0xaa.InviteSource)localObject).src.has()))
        {
          ...
          {
            localObject = new aqul(this, b(i), (String)localObject);
            this.jdField_a_of_type_JavaUtilVector.add(localObject);
          }
        }
      }
  ...
  private void b(SubMsgType0xaa.GameTeam_TurnOverMessage paramGameTeam_TurnOverMessage)
  {
    ...
    if (bool)
    {
      paramGameTeam_TurnOverMessage = localQQAppInterface.getApp().getString(2131692930);
      switch (j)
      {
      case 5: 
      default: 
        return;
      case 1: 
        localObject1 = localQQAppInterface.getApp().getString(2131692949);
      }
    }
    for (;;)
    {
      String str3 = localQQAppInterface.getApp().getString(2131692951);
      paramGameTeam_TurnOverMessage = paramGameTeam_TurnOverMessage + (String)localObject1 + str3;
      localObject1 = (MessageForGrayTips)axaq.a(-2049);
      ...
      bded.a().a(localQQAppInterface.getCurrentAccountUin(), "", "", "2000", "2011", "0", false);
      return;
      switch (k)
      {
      default: 
        ...
        break;
      case 0: 
        paramGameTeam_TurnOverMessage = bbcl.a(localQQAppInterface, str1, (String)localObject2, 0, 0);
        break;
      case 1: 
        paramGameTeam_TurnOverMessage = bbcl.a(localQQAppInterface, str1, (String)localObject2, 1, 0);
        break;
      case 3000: 
        paramGameTeam_TurnOverMessage = bbcl.a(localQQAppInterface, str1, (String)localObject2, 2, 0);
        break;
        localObject1 = localQQAppInterface.getApp().getString(2131692952);
        continue;
        localObject1 = localQQAppInterface.getApp().getString(2131692936);
        continue;
  ...
  public Observable a()
  {
    if (this.jdField_a_of_type_Aqum == null) {
      this.jdField_a_of_type_Aqum = new aqum();
    }
    return this.jdField_a_of_type_Aqum;
  }
  ...
  public void a()
  {
    ...
    if (l1 > 0L)
    {
      ...
      {
        this.jdField_a_of_type_Aqum.setChanged();
        this.jdField_a_of_type_Aqum.notifyObservers(Integer.valueOf(1));
      }
      this.jdField_a_of_type_AndroidOsHandler.sendMessageDelayed(localMessage, l1 * 1000L + 30000L);
    }
  }
  
  public void a(String paramString, aquk paramaquk)
  {
    ThreadManager.post(new GamePartyManager.4(this, paramString, paramaquk), 5, null, false);
  }
  ...
  protected void a(SubMsgType0xaa.GameTeam_StartGameMessage paramGameTeam_StartGameMessage, boolean paramBoolean)
  {
    ...
    for (l1 -= l2;; l1 = l2 - l1)
    {
      ...
      a("https://openmobile.qq.com/gameteam/get_team_info?uin=" + localQQAppInterface.getCurrentAccountUin() + "&team_list=" + (String)localObject, new aquj(this, l1, paramGameTeam_StartGameMessage, l2, paramBoolean));
      return;
      if (!QLog.isColorLevel()) {
        break;
      }
    ...
    if ((this.jdField_a_of_type_Boolean) && (paramInt >= 0) && (!TextUtils.isEmpty(paramString)))
    {
      if (((QQAppInterface)localObject).getCurrentAccountUin().equals(this.jdField_b_of_type_JavaLangString))
      {
        ...
        do
        {
          ...
          localaqul = (aqul)((Iterator)localObject).next();
        } while ((paramInt != localaqul.jdField_a_of_type_Int) || (!paramString.equals(localaqul.jdField_a_of_type_JavaLangString)));
        return true;
      }
  ...
  public void b()
  {
    ...
    {
      this.jdField_a_of_type_Aqum.setChanged();
      this.jdField_a_of_type_Aqum.notifyObservers(Integer.valueOf(3));
    }
    c();
    this.jdField_a_of_type_AndroidOsHandler.removeMessages(1);
  }
  ...
  public void onDestroy()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localEditor.commit();
        alsx.a("com.tencent.qqopen.teamup");
        return;
      }
      catch (JSONException localJSONException)
      {
