  ...
  implements View.OnClickListener
{
  ...
  {
    if ((!agnf.a(this.a)) || (this.a.a()) || (System.currentTimeMillis() - agnf.a(this.a) < 600L)) {}
    ...
    do
    {
      do
      {
        do
        {
          for (;;)
          {
            ...
            return;
            agnf.a(this.a, System.currentTimeMillis());
            localMessageForApollo = (MessageForApollo)((agol)AIOUtils.getHolder(paramView)).a;
            ...
            else
            {
              ...
              {
                QQToast.a(paramView.getContext(), anvx.a(2131699842), 0).a();
              }
              else
              {
                if (ApolloEngine.a()) {
      ...
      localamme = (amme)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.APOLLO_MANAGER);
    } while (localamme == null);
    int i;
    ...
    {
      label310:
      int k = localamme.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin());
      ...
      for (int j = 0;; j = localMessageForApollo.playerList.size())
      {
        ...
        agnf.a(this.a, localMessageForApollo);
        break;
