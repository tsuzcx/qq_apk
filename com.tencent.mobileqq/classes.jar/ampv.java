public abstract class ampv<DATA, CONFIG extends amqi>
  extends ampo<DATA, CONFIG>
{
  private float[] a;
  private float d;
  ...
  public void a(float paramFloat1, float paramFloat2, long paramLong1, long paramLong2)
  {
    if (!a(paramLong1))
    {
      amrq.c("BaseDanmaku", "onLayout, Y = " + paramFloat2 + ", danmaku = " + toString());
      this.d = a(paramLong2);
      if (!c())
      {
        this.e = paramFloat2;
  ...
  public float[] a(long paramLong)
  {
    ...
    this.jdField_a_of_type_ArrayOfFloat[0] = (f1 - ampx.a().b());
  ...
  {
    super.g();
    this.f = ((int)(f() + this.jdField_a_of_type_Float) / (float)this.jdField_a_of_type_Amrg.a());
  }
