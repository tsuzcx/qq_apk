...
public class ayob
{
  public static ayoe a(int paramInt)
  {
    switch (paramInt)
    {
    default: 
  ...
  public static Object[] a(org.json.JSONObject paramJSONObject, String paramString1, String paramString2)
  {
    ...
    //   116: istore 4
    //   118: iload 4
    //   120: invokestatic 110	ayob:a	(I)Layoe;
    //   123: astore 8
    //   125: aload 8
    //   127: ifnull +54 -> 181
    //   130: aload 8
    //   132: aload 7
    //   134: invokevirtual 115	ayoe:a	(Lorg/json/JSONObject;)Lcom/tencent/mobileqq/data/TroopFeedItem;
    //   137: astore 7
    //   139: aload 7
    //   141: ifnull +40 -> 181
    //   144: aload 7
