  ...
  extends airj
{
  ...
  protected aitr(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
  ...
  protected void c()
  {
    if ("FromFastImage".equals(this.jdField_a_of_type_Airg.from))
    {
      azqs.b(null, "CliOper", "", "", "0X8004D93", "0X8004D93", 0, 0, "", "", "", "");
      aips.d();
    }
    if ("FromCamera".equals(this.jdField_a_of_type_Airg.from)) {
      aips.b();
    }
    super.c();
    azqs.b(null, "CliOper", "", "", "0X8005147", "0X8005147", 0, 0, "", "", "", "");
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      i = 1;
      localObject3 = (URLDrawable)this.jdField_a_of_type_Airg.activeDrawable.get(paramInt);
      if (i == 0) {
        break label215;
      }
      paramViewGroup = ((NewPhotoPreviewActivity)this.mActivity).getLayoutInflater().inflate(2131561155, null);
      paramViewGroup.setTag(2131296400, Boolean.valueOf(true));
      paramViewGroup.setLayoutParams(new Gallery.LayoutParams(-1, -1));
      localObject1 = (ImageView)paramViewGroup.findViewById(2131372258);
    ...
    do
    {
      ...
      ((ImageView)localObject1).setContentDescription(alud.a(2131708532) + paramInt);
    ...
    for (;;)
    {
      ...
      {
        paramView = bayu.a;
        if (this.jdField_a_of_type_Airg.cameraType != 103) {
          break label495;
        }
      ...
      ((ImageView)localObject1).setImageDrawable((Drawable)localObject3);
      this.jdField_a_of_type_Airg.activeDrawable.put(paramInt, localObject3);
      break;
      label464:
      ((ImageView)localObject1).setContentDescription(alud.a(2131708530) + paramInt);
      return localObject1;
      label495:
      localObject2 = null;
      continue;
  ...
  public void initData(Intent paramIntent)
  {
    ...
    label243:
    for (this.jdField_a_of_type_Airg.f = 1037;; this.jdField_a_of_type_Airg.f = 1008)
    {
      ...
      {
        ((PresendPicMgr)localObject).a(str, this.jdField_a_of_type_Airg.f);
        if (QLog.isColorLevel()) {
          QLog.d("PhotoPreviewActivity", 2, "  initData , presendMgr = " + localObject + ",picpath = " + str + ",from = " + this.jdField_a_of_type_Airg.from + ",mBusiType = " + this.jdField_a_of_type_Airg.f);
        }
      }
  ...
  {
    super.initUI();
    ((NewPhotoPreviewActivity)this.mActivity).backToPhotoListBtn.setText(2131695282);
  ...
  public void onMagicStickClick(View paramView, int paramInt1, Bundle paramBundle, int paramInt2, Intent paramIntent)
  {
    if (this.jdField_a_of_type_Airg.a != null)
    {
      ...
      if (this.jdField_a_of_type_Boolean) {
        azqs.b(null, "CliOper", "", "", "0X8004D95", "0X8004D95", 0, 0, "", "", "", "");
      }
    }
