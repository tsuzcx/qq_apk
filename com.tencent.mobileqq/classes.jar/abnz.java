...
public class abnz
  implements abuj, View.OnClickListener
{
  private int jdField_a_of_type_Int;
  private final aboe jdField_a_of_type_Aboe = new aboe();
  private abop jdField_a_of_type_Abop;
  private final abpc jdField_a_of_type_Abpc = new abpc();
  ...
  public abnz(abpi paramabpi, View paramView, abop paramabop)
  {
  ...
  private boolean a(WebView paramWebView, String paramString)
  {
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_Abop == null) || (this.jdField_a_of_type_Abop.a() == null) || (this.jdField_a_of_type_Abop.a() == null) || (TextUtils.isEmpty(this.jdField_a_of_type_Abop.a().getUrlForClick())))
      {
        QLog.i("GdtMVCellingStyleController", 1, "handleSchema urlForClick is Empty");
        return false;
      }
      String str = this.jdField_a_of_type_Abop.a().getUrlForClick();
      abrs.a(1, 0, this.jdField_a_of_type_Abop.a());
      GdtReporter.doCgiReport(str);
      QLog.i("GdtMVCellingStyleController", 1, "handleSchema url= " + paramString);
      this.jdField_a_of_type_Abpc.a(paramWebView, paramString);
      return true;
    }
  ...
  private void c(Activity paramActivity)
  {
    ...
    this.jdField_c_of_type_Int = this.jdField_a_of_type_Abpc.a(this.jdField_a_of_type_Abop.a(), paramActivity);
    ...
    if ((this.jdField_c_of_type_Int == 4) || (this.jdField_c_of_type_Int == 5))
    {
      ...
      String str2;
      if (this.jdField_a_of_type_Abop.a() == null)
      {
        paramActivity = "";
        String str1 = amtj.a(2131704352) + paramActivity;
        str2 = amtj.a(2131692649);
      ...
      for (;;)
      {
        this.jdField_a_of_type_Aboe.a(this.jdField_c_of_type_AndroidWidgetTextView);
        return;
        paramActivity = this.jdField_a_of_type_Abop.a().getAppName();
        break;
        label190:
  ...
  private void e(int paramInt)
  {
    ...
    localValueAnimator.addUpdateListener(new aboa(this, localLayoutParams, localLayoutParams.topMargin, paramInt));
  ...
  private void i()
  {
    ...
    String str = this.jdField_a_of_type_Abop.a().getUrlForClick();
    GdtReporter.doCgiReport(this.jdField_a_of_type_Aboe.a(str, this.jdField_a_of_type_Abpi.a(), this.jdField_a_of_type_Abpi.a(), this.jdField_a_of_type_Abpi.b(), null));
    j();
  }
  ...
  protected void a()
  {
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131370156));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131366098));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131366099));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131366097));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131381041));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131380625));
    ...
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131380626);
    this.jdField_a_of_type_ComTencentGdtadViewsVideoceilingGdtVideoCeilingLandView = ((GdtVideoCeilingLandView)this.jdField_a_of_type_AndroidViewView.findViewById(2131381036));
    this.jdField_a_of_type_AndroidViewView.findViewById(2131381026).setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131381037));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131372043));
    this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.d = this.jdField_a_of_type_AndroidViewView.findViewById(2131378924);
  }
  ...
  {
    if (this.jdField_a_of_type_Abpf != null) {
      this.jdField_a_of_type_Abpf.a(paramFloat);
    }
  ...
  protected void a(Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Abpc.a(this.jdField_a_of_type_Abop.a()));
    this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.jdField_a_of_type_Abpc.a(paramActivity, this.jdField_a_of_type_Abop.a()));
    this.jdField_a_of_type_AndroidWidgetButton.setText(this.jdField_a_of_type_Abpc.a(paramActivity, this.jdField_a_of_type_Abop));
  }
  
  public void a(Activity paramActivity, abpf paramabpf)
  {
    this.jdField_a_of_type_Abpf = paramabpf;
  ...
  protected void b(Activity paramActivity)
  {
    try
    {
      ...
      this.jdField_a_of_type_Abup = new abob(this, paramActivity, paramActivity, null, (AppInterface)localObject);
      this.jdField_a_of_type_Abup.a(this.jdField_a_of_type_ComTencentBizUiTouchWebView);
      this.jdField_a_of_type_Abup.a(null);
      new bgtj(this.jdField_a_of_type_Abup).a(null, (AppInterface)localObject, null);
      localObject = "";
      ...
      if (this.jdField_a_of_type_Abop != null)
      {
        paramActivity = (Activity)localObject;
        if (this.jdField_a_of_type_Abop.a() != null) {
          paramActivity = bjnd.a(this.jdField_a_of_type_Abop.a().getUrlForLandingPage(), "xj_scene", "3");
        }
      }
  ...
  public void d()
  {
    ...
    {
      this.jdField_a_of_type_Abpc.a(localActivity, this.jdField_a_of_type_Abop.a());
      return;
    }
    if (this.jdField_c_of_type_Int == 4)
    {
      this.jdField_a_of_type_Abpc.b(localActivity, this.jdField_a_of_type_Abop.a());
      return;
    }
    QLog.i("GdtMVCellingStyleController", 1, "onClickOpenApp mModel == null");
  }
  ...
  public void e()
  {
    ...
    abps localabps;
    if (!this.jdField_a_of_type_Abpi.c())
    {
      localabps = this.jdField_a_of_type_Abpi.a();
      if (localabps == null) {
  ...
  public void f()
  {
    if ((this.jdField_a_of_type_Abop == null) || (this.jdField_a_of_type_Abop.a() == null)) {
      return;
    }
    int j = this.jdField_a_of_type_Abop.a().vSize;
    int i;
    double d1;
    if (j == 585)
    {
