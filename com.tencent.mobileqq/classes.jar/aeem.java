...
public class aeem
  extends antq
{
  private aeem(JoinDiscussionActivity paramJoinDiscussionActivity) {}
  ...
  protected void onDecodeFlyTicket(boolean paramBoolean, String paramString)
  {
    if (paramBoolean)
    {
      ...
      this.a.jdField_a_of_type_Antl.c(this.a.jdField_a_of_type_JavaLangString);
      return;
    }
    this.a.a(0, -161);
  }
  ...
  protected void onGetDiscussionInfoByFlyTicket(boolean paramBoolean, int paramInt, RespGetDiscussInfo paramRespGetDiscussInfo)
  {
    if (paramBoolean)
    {
      ...
      if (this.a.jdField_a_of_type_JavaUtilList != null)
      {
        ...
        if (((Iterator)localObject3).hasNext())
        {
          ...
          for (;;)
          {
            ...
            {
              localObject2 = ((anvk)this.a.app.getManager(QQManagerFactory.FRIENDS_MANAGER)).b(((DiscussionMemberInfo)localObject1).memberUin);
      ...
      this.a.c = ContactUtils.setDiscussionNameAndCompareName(this.a.app, this.a.d, String.valueOf(this.a.jdField_a_of_type_Long), l | 0x20000000, paramRespGetDiscussInfo.Name, localHashMap);
      ...
      if (TextUtils.isEmpty(this.a.e)) {
        ((FriendListHandler)this.a.app.getBusinessHandler(BusinessHandlerFactory.FRIENDLIST_HANDLER)).getFriendInfo(this.a.jdField_a_of_type_Long + "", false);
      }
      return;
    }
    this.a.a(0, paramInt);
  ...
  protected void onJoinDiscussionByFlyTicket(boolean paramBoolean, long paramLong, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      bdla.b(this.a.app, "CliOper", "", this.a.app.getCurrentAccountUin(), "discuss", "discuss_QR_join", 0, 0, "", "", "", "");
      this.a.stopTitleProgress();
    ...
    {
      if (paramInt != 0) {
        QQToast.a(this.a, anvx.a(2131705356), 0).b(this.a.getTitleBarHeight());
      }
      Intent localIntent = AIOUtils.setOpenAIOIntent(new Intent(this.a, SplashActivity.class), null);
