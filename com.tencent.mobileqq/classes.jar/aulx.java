...
public class aulx
  implements avew
{
  public aulx(DeleteFaceFragment paramDeleteFaceFragment, String paramString1, String paramString2) {}
  ...
  public void a(FaceDetectForThirdPartyManager.AppConf paramAppConf)
  {
    ...
    for (;;)
    {
      if (i == 0)
      {
        DeleteFaceFragment.a(this.jdField_a_of_type_ComTencentMobileqqFragmentDeleteFaceFragment).requestPermissions(new auly(this, paramAppConf), 1, new String[] { "android.permission.CAMERA" });
        return;
        i = 0;
      }
      else
