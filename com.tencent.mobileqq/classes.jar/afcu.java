  ...
  extends BaseAdapter
{
  ...
  private List<afct> jdField_a_of_type_JavaUtilList = new LinkedList();
  
  public afcu(TroopMemberHistoryFragment paramTroopMemberHistoryFragment, Context paramContext)
  {
  ...
  boolean a(List<afct> paramList)
  {
    ...
    {
      afct localafct = (afct)paramList.get(i);
      l2 = localafct.jdField_a_of_type_Long;
      if ((l1 == 0L) || (!a(l1, l2))) {
        localafct.jdField_a_of_type_Boolean = true;
      }
      this.jdField_a_of_type_JavaUtilList.add(localafct);
      i += 1;
    }
    return true;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131377841));
      paramView.setTag(paramViewGroup);
      localafct = (afct)getItem(paramInt);
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(localafct.jdField_a_of_type_JavaLangCharSequence);
      paramViewGroup.b.setText(localafct.a());
      localObject = new ayjw(bbcz.h(this.jdField_a_of_type_ComTencentMobileqqActivityChathistoryTroopMemberHistoryFragment.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityChathistoryTroopMemberHistoryFragment.b, localafct.jdField_a_of_type_JavaLangString), 16).a();
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetColorNickTextView.setText((CharSequence)localObject);
      bbos.a(this.jdField_a_of_type_ComTencentMobileqqActivityChathistoryTroopMemberHistoryFragment.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetColorNickTextView, (Spannable)localObject);
      localObject = bayh.a(this.jdField_a_of_type_ComTencentMobileqqActivityChathistoryTroopMemberHistoryFragment.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, localafct.jdField_a_of_type_JavaLangString);
      ...
      if (!localafct.jdField_a_of_type_Boolean) {
        break label420;
      }
    ...
    for (localLayoutParams.topMargin = i;; localLayoutParams.topMargin = 0)
    {
      ...
      paramView.setContentDescription(localafct.jdField_a_of_type_JavaLangCharSequence + " " + localafct.a());
      return paramView;
      paramViewGroup = (afcs)paramView.getTag();
      break;
      i = bbll.a(9.0F);
      break label284;
      i = bbll.a(9.0F);
