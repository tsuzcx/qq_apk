...
public class wrt
{
  ...
  private static final Property<ImageView, Matrix> jdField_a_of_type_AndroidUtilProperty = new wrx(Matrix.class, "animatedTransform");
  ...
  private wrs jdField_a_of_type_Wrs;
  private wsa jdField_a_of_type_Wsa;
  private wsb jdField_a_of_type_Wsb;
  private int jdField_b_of_type_Int;
  private ImageView jdField_b_of_type_AndroidWidgetImageView;
  private int c;
  private int d;
  
  public wrt(Bundle paramBundle, wsb paramwsb)
  {
    if ((paramBundle == null) || (paramwsb == null)) {
      return;
    }
    this.jdField_a_of_type_Wsb = paramwsb;
    a(paramBundle);
    a();
    b();
    c();
      ...
      for (;;)
      {
        try
        {
          ...
          if (Build.VERSION.SDK_INT >= 16)
          {
            ...
            localBundle.putString("bundle_key_source_image_param", new wsa((String)localObject, paramInt1, paramInt2).a());
  ...
  private void a()
  {
    if ((this.jdField_a_of_type_Wrs != null) && (this.jdField_a_of_type_Wrs.a())) {
      return;
    }
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (this.jdField_a_of_type_Wrs != null) {
      this.jdField_a_of_type_Wrs.a(2);
    }
    ...
    ((ObjectAnimator)localObject1).addListener(new wrv(this, paramInt4, paramInt3, paramInt1, paramInt2));
    ...
    localObject2 = ObjectAnimator.ofObject(this.jdField_a_of_type_AndroidWidgetImageView, jdField_a_of_type_AndroidUtilProperty, new wry(), new Matrix[] { localObject2, localObject3 });
    ...
    this.jdField_a_of_type_AndroidAnimationAnimatorSet.addListener(new wrw(this));
  ...
  {
    this.jdField_a_of_type_Wrs = new wrs();
    ...
    this.jdField_a_of_type_Wsa = new wsa();
    this.jdField_a_of_type_Wsa.a(str);
    this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Wsa.jdField_a_of_type_JavaLangString;
    this.jdField_a_of_type_JavaIoFile = new File(this.jdField_a_of_type_JavaLangString);
    this.jdField_a_of_type_Int = this.jdField_a_of_type_Wsa.jdField_a_of_type_Int;
    this.jdField_b_of_type_Int = this.jdField_a_of_type_Wsa.jdField_b_of_type_Int;
  ...
  private void c()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetFrameLayout != null)
    {
      ...
      localLayoutParams.topMargin = this.jdField_a_of_type_Wsb.a();
    ...
    this.jdField_a_of_type_Wrs.a(1);
  }
  
  private void d()
  {
    int[] arrayOfInt = this.jdField_a_of_type_Wsb.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
  ...
  private void e()
  {
    if ((this.jdField_a_of_type_Wrs == null) || (!this.jdField_a_of_type_Wrs.b())) {
      QLog.d("TransitionAnimHelper", 1, "initImageEnterAnimation error!");
    }
    while (this.jdField_b_of_type_AndroidWidgetImageView == null) {
      return;
    }
    this.jdField_b_of_type_AndroidWidgetImageView.getViewTreeObserver().addOnPreDrawListener(new wru(this));
  }
  ...
  {
    if (this.jdField_a_of_type_Wrs != null) {
      this.jdField_a_of_type_Wrs.a(paramwsc);
    }
  }
}
