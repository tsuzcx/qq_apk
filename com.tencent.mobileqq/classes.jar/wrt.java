  ...
  implements TextWatcher, View.OnClickListener, View.OnTouchListener
{
  ...
  public wrt(NewStyleCountryActivity paramNewStyleCountryActivity, Context paramContext)
  {
    super(paramContext);
    ...
    paramContext = (Button)findViewById(2131368254);
    paramContext.setVisibility(0);
    paramContext.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewView = findViewById(2131363900);
    ...
    findViewById(2131363903).setVisibility(8);
    this.jdField_a_of_type_ComTencentWidgetListView = ((ListView)findViewById(2131363901));
    this.jdField_a_of_type_Wrs = new wrs(paramNewStyleCountryActivity, null);
    this.jdField_a_of_type_ComTencentWidgetListView.setAdapter(this.jdField_a_of_type_Wrs);
  ...
  void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Wrs.a(paramString);
    if (this.jdField_a_of_type_Wrs.getCount() == 0) {
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    }
    for (;;)
    {
      this.jdField_a_of_type_Wrs.notifyDataSetChanged();
      return;
