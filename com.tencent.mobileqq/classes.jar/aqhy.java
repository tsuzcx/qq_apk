  ...
  implements INetInfoHandler
{
  ...
  {
    Iterator localIterator = aqhx.a(this.a).iterator();
    while (localIterator.hasNext()) {
      ((aqia)localIterator.next()).a(5);
    }
  ...
  {
    paramString = aqhx.a(this.a).iterator();
    while (paramString.hasNext()) {
      ((aqia)paramString.next()).a(4);
    }
    if (QLog.isColorLevel()) {
