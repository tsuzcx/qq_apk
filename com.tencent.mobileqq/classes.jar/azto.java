...
public class azto
{
  ...
  public final Queue<aztt> a;
  
  public azto(SnapshotResultReceiver paramSnapshotResultReceiver)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put("offline_pkg", mol.b());
  }
  ...
  public static void a(Application paramApplication, String paramString, int paramInt)
  {
    ...
    localEditor.putBoolean("need_set_proxy", true);
    localEditor.commit();
    azzz.a(paramApplication, "com.tencent.mobileqq:tool");
    if (QLog.isColorLevel())
    {
  ...
  public aztu a(Context paramContext)
  {
    aztu localaztu = new aztu(this);
    localaztu.jdField_a_of_type_JavaLangString = (babp.h() + " " + babp.d());
    localaztu.jdField_b_of_type_JavaLangString = Build.VERSION.RELEASE;
    localaztu.c = "8.2.6.4370";
    babq localbabq = babp.a(paramContext);
    localaztu.d = localbabq.jdField_a_of_type_JavaLangString;
    localaztu.e = localbabq.c;
    localaztu.jdField_a_of_type_Int = babp.b();
    localaztu.jdField_a_of_type_Long = babp.a();
    localaztu.jdField_b_of_type_Long = babp.d();
    localaztu.f = babp.g();
    localaztu.jdField_a_of_type_Boolean = a(paramContext);
    localaztu.jdField_b_of_type_Int = QbSdk.getTbsVersion(paramContext);
    if (localaztu.jdField_b_of_type_Int == 0) {}
    for (boolean bool = false;; bool = true)
    {
      localaztu.jdField_b_of_type_Boolean = bool;
      return localaztu;
    }
  }
  ...
  public String a()
  {
    aztn localaztn = aztm.a("getprop net.dns1");
    if (localaztn.jdField_a_of_type_Boolean)
    {
      if (!localaztn.jdField_a_of_type_JavaUtilList.isEmpty()) {
        return (String)localaztn.jdField_a_of_type_JavaUtilList.get(0);
      }
    }
    else if (QLog.isColorLevel()) {
      QLog.d("UnifiedDebugManager", 2, localaztn.jdField_a_of_type_JavaLangString);
    }
    return "";
  }
  ...
  public String a(long paramLong1, long paramLong2)
  {
    ...
    //   705: aload 22
    //   707: aload 18
    //   709: invokestatic 524	azty:a	(Ljava/util/List;Ljava/lang/String;)V
    //   712: aload 18
    //   714: areturn
    //   715: astore 19
    //   717: ldc 140
  ...
  public String a(Context paramContext, String paramString)
  {
    ...
    {
      paramString = paramContext.list(new aztr(this, paramString));
      ...
      finally
      {
        try
        {
          ...
          try
          {
            ...
            azty.a(localArrayList, paramContext);
            azty.a(localArrayList);
            return paramContext;
          }
  ...
  public String a(Context paramContext, List<String> paramList)
  {
    ...
    if ((((File)localObject1).exists()) && (((File)localObject1).isDirectory()))
    {
      ...
      while (paramList.hasNext())
      {
        localObject2 = ((File)localObject1).list(new aztp(this, c((String)paramList.next()).substring(0, 16)));
  ...
  public String a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    //   11: ldc_w 702
    //   14: ldc_w 383
    //   17: invokestatic 706	bbdc:b	(Ljava/lang/String;)Ljava/lang/String;
    //   20: invokevirtual 709	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   23: invokestatic 714	com/tencent/smtt/sdk/CookieManager:getInstance	()Lcom/tencent/smtt/sdk/CookieManager;
    //   26: astore_1
    //   27: aload_1
    //   28: iconst_1
    //   29: invokevirtual 718	com/tencent/smtt/sdk/CookieManager:setAcceptCookie	(Z)V
    //   32: aload_1
    //   33: aload 4
    //   35: invokevirtual 721	com/tencent/smtt/sdk/CookieManager:getCookie	(Ljava/lang/String;)Ljava/lang/String;
    //   38: astore_1
    //   39: aload_1
    //   40: ifnull +69 -> 109
    //   43: aload 12
    //   45: ldc_w 723
    //   48: aload_1
    //   49: invokevirtual 709	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   79: invokestatic 730	mpw:c	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   97: invokestatic 734	mpw:b	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    //   116: invokestatic 739	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   119: invokevirtual 742	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   122: ldc_w 744
    ...
    //   154: pop
    //   155: lload_2
    //   156: invokestatic 747	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   159: astore 10
    ...
    //   234: invokevirtual 753	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   237: checkcast 755	java/net/HttpURLConnection
    //   240: astore_1
    //   241: aload_1
    //   242: ldc_w 757
    //   245: invokevirtual 760	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    //   248: aload_1
    //   249: sipush 6000
    //   252: invokevirtual 764	java/net/HttpURLConnection:setConnectTimeout	(I)V
    //   255: aload_1
    //   256: sipush 6000
    //   259: invokevirtual 767	java/net/HttpURLConnection:setReadTimeout	(I)V
    //   262: aload 12
    //   264: invokevirtual 771	android/os/Bundle:keySet	()Ljava/util/Set;
    //   267: invokeinterface 774 1 0
    //   272: astore 4
    //   274: aload 4
    ...
    //   296: aload 12
    //   298: aload 7
    //   300: invokevirtual 776	android/os/Bundle:get	(Ljava/lang/String;)Ljava/lang/Object;
    //   303: astore 8
    //   305: aload 8
    //   307: instanceof 259
    //   310: ifeq -36 -> 274
    ...
    //   321: invokevirtual 779	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   324: goto -50 -> 274
    //   327: astore 7
    //   329: aload 6
    //   331: astore 4
    ...
    //   371: ifnull +8 -> 379
    //   374: aload 6
    //   376: invokevirtual 784	java/io/OutputStream:close	()V
    //   379: aload 4
    //   381: ifnull +8 -> 389
    //   384: aload 4
    //   386: invokevirtual 787	java/net/HttpURLConnection:disconnect	()V
    //   389: aload_1
    //   390: athrow
    //   391: aload_1
    //   392: invokevirtual 790	java/net/HttpURLConnection:connect	()V
    //   395: sipush 200
    //   398: aload_1
    //   399: invokevirtual 793	java/net/HttpURLConnection:getResponseCode	()I
    //   402: if_icmpne +56 -> 458
    //   405: sipush 1024
    //   408: newarray byte
    //   410: astore 4
    //   412: new 795	java/io/BufferedInputStream
    //   415: dup
    //   416: aload_1
    //   417: invokevirtual 799	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   420: invokespecial 802	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   423: astore 7
    //   425: aload 7
    //   427: aload 4
    //   429: invokevirtual 808	java/io/InputStream:read	([B)I
    //   432: istore 5
    //   434: iconst_m1
    //   435: iload 5
    ...
    //   444: iconst_0
    //   445: iload 5
    //   447: invokevirtual 811	java/io/OutputStream:write	([BII)V
    //   450: goto -25 -> 425
    //   453: aload 6
    //   455: invokevirtual 812	java/io/OutputStream:flush	()V
    //   458: aload 6
    //   460: ifnull +8 -> 468
    //   463: aload 6
    //   465: invokevirtual 784	java/io/OutputStream:close	()V
    //   468: aload_1
    //   469: ifnull +7 -> 476
    //   472: aload_1
    //   473: invokevirtual 787	java/net/HttpURLConnection:disconnect	()V
    ...
    //   527: aload_1
    //   528: aload 4
    //   530: invokestatic 524	azty:a	(Ljava/util/List;Ljava/lang/String;)V
    //   533: aload 4
    //   535: areturn
    //   536: astore 4
    //   538: ldc 140
  ...
  public String a(File paramFile, List<String> paramList)
  {
    ...
    azty.a(paramFile, paramList, str);
    return str;
  }
  ...
  public void a(Context paramContext, String paramString1, int paramInt, long paramLong1, long paramLong2, String paramString2)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      ...
      {
        this.jdField_a_of_type_JavaUtilQueue.offer(new aztt(this, paramString1, paramInt, paramLong1, paramLong2, paramString2));
        return;
      }
  ...
  public void a(Context paramContext, List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      localObject1 = paramContext.listFiles(new aztq(this, c((String)paramList.next()).substring(0, 16)));
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, Handler paramHandler)
  {
    ...
    new aztz(paramQQAppInterface, paramHandler).a(paramLong, str1, paramString);
  }
  ...
  public boolean a(Context paramContext, long paramLong)
  {
    synchronized (this.jdField_a_of_type_JavaUtilQueue)
    {
      aztt localaztt = (aztt)this.jdField_a_of_type_JavaUtilQueue.poll();
      if ((localaztt != null) && (localaztt.jdField_b_of_type_Long == paramLong))
      {
        localaztt = (aztt)this.jdField_a_of_type_JavaUtilQueue.peek();
        if (localaztt != null)
        {
          b(paramContext, localaztt.jdField_a_of_type_JavaLangString, localaztt.jdField_a_of_type_Int, localaztt.jdField_a_of_type_Long, localaztt.jdField_b_of_type_Long, localaztt.jdField_b_of_type_JavaLangString);
          if (QLog.isColorLevel()) {
            QLog.d("UnifiedDebugManager", 2, "finish once webview debug, start new debug(dequeue one cmd): seq=" + localaztt.jdField_b_of_type_Long);
          }
        }
        while (!QLog.isColorLevel()) {
          return true;
  ...
  {
    paramContext = azty.a(a(paramContext));
  ...
  public void b(Context paramContext, String paramString, List<String> paramList)
  {
    ...
    if ((paramContext.exists()) && (paramContext.isDirectory()))
    {
      paramString = paramContext.list(new azts(this, paramString));
      if ((paramString != null) && (paramString.length > 0))
      {
        int j = paramString.length;
        int i = 0;
