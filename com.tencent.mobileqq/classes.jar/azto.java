  ...
  extends azqk
{
  ...
  private RelativeLayout a(Context paramContext)
  {
    ...
    localBubbleViewLayout.setId(2131363764);
    localBubbleViewLayout.setRadius(10.0F);
    LinearLayout localLinearLayout = new LinearLayout(paramContext);
    localLinearLayout.setLayoutParams(new LinearLayout.LayoutParams(-1, -2));
    localLinearLayout.setPadding(0, 0, 0, aekt.a(10.0F, paramContext.getResources()));
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      if ((("picture".equals(localObject3)) || ("vote".equals(localObject3)) || ("video".equals(localObject3))) && (localObject1 == null))
      {
        ...
        i = aekt.a(200.0F, localResources);
        if (!(localObject2 instanceof azsm)) {
          break label756;
        }
        localObject2 = (azsm)localObject2;
        if (((azsm)localObject2).l > 0)
        {
          i = ((azsm)localObject2).l;
          label175:
          if ((j & 0x2) == 0) {
            break label753;
          }
          ...
          ((ImageView)localObject1).setImageResource(2130841361);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          localLinearLayout1 = (LinearLayout)((azqj)localObject2).a(paramContext, null, paramBundle);
          localObject2 = new LinearLayout.LayoutParams(-1, -2);
          ((LinearLayout.LayoutParams)localObject2).setMargins(0, aekt.a(10.0F, localResources), 0, aekt.a(6.0F, localResources));
          ...
          ((BubbleViewLayout)localRelativeLayout.findViewById(2131363764)).a = bool;
          if (bool)
          {
            if (localLinearLayout1 != null) {
              localLinearLayout1.setPadding(aekt.a(12.0F, localResources), 0, aekt.a(22.0F, localResources), 0);
            }
            if (paramView != null) {
              paramView.setPadding(aekt.a(12.0F, localResources), 0, aekt.a(22.0F, localResources), 0);
            }
            ...
            {
              if (!aupt.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg.message, "isFaceScoreSecondMember")) {
                break label730;
              }
              paramContext = "2";
              if ((j & 0x2) == 0) {
          ...
          {
            aupt.a("exp_obj", paramBundle, new String[] { paramContext, "", "", paramView });
            return localRelativeLayout;
            if (localLinearLayout1 != null) {
              localLinearLayout1.setPadding(aekt.a(22.0F, localResources), 0, aekt.a(12.0F, localResources), 0);
            }
            if (paramView == null) {
              break;
            }
            paramView.setPadding(aekt.a(22.0F, localResources), 0, aekt.a(12.0F, localResources), 0);
            break;
            paramContext = "1";
            break label616;
            i = 0;
