...
public class atqz
{
  public static void a(String paramString, atrb paramatrb)
  {
    ...
    if (bdee.b(BaseApplicationImpl.getContext()))
    {
      ...
      ThreadManagerV2.excute(new GateWayVerifyMobileHelper.1(paramString, paramatrb), 128, null, true);
      return;
    }
    ...
    {
      paramatrb.a(new Exception("mobile network is not enable"));
      return;
    }
    QLog.d("GateWayVerifyMobileHelper", 1, new Object[] { "current version is ", Integer.valueOf(Build.VERSION.SDK_INT) });
    if (Build.VERSION.SDK_INT <= 20)
    {
      d(paramString, paramatrb);
      return;
    }
    e(paramString, paramatrb);
  }
  
  /* Error */
  private static void a(java.net.HttpURLConnection paramHttpURLConnection, java.net.URL paramURL, atrb paramatrb)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
  ...
  /* Error */
  @RequiresApi(api=21)
  private static void b(String paramString, android.net.Network paramNetwork, atrb paramatrb)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 5
    ...
    //   33: aload 6
    //   35: aload_2
    //   36: invokestatic 309	atqz:a	(Ljava/net/HttpURLConnection;Ljava/net/URL;Latrb;)V
    //   39: aload_0
    //   40: ifnull +7 -> 47
    //   43: aload_0
  ...
  /* Error */
  private static void c(String paramString, atrb paramatrb)
  {
    // Byte code:
    //   0: ldc 25
    //   2: iconst_1
    ...
    //   40: aload 5
    //   42: aload_1
    //   43: invokestatic 309	atqz:a	(Ljava/net/HttpURLConnection;Ljava/net/URL;Latrb;)V
    //   46: aload_0
    //   47: ifnull +7 -> 54
    //   50: aload_0
  ...
  private static void d(String paramString, atrb paramatrb)
  {
    QLog.d("GateWayVerifyMobileHelper", 1, "start changeNetTypeToMobileV19");
    ThreadManagerV2.excute(new GateWayVerifyMobileHelper.2(paramString, paramatrb), 128, null, true);
  }
  
  @RequiresApi(api=21)
  private static void e(String paramString, atrb paramatrb)
  {
    ...
    paramString = new atra(localMqqHandler, localConnectivityManager, paramatrb, paramString);
    localConnectivityManager.requestNetwork((NetworkRequest)localObject, paramString);
    localMqqHandler.postDelayed(new GateWayVerifyMobileHelper.4(paramatrb, localConnectivityManager, paramString), 4000L);
  }
}
