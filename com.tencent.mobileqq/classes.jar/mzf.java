  ...
  implements myo
{
  ...
  public mzf()
  {
    this.jdField_a_of_type_Mzi = new mzi();
  ...
  private int a(boolean paramBoolean)
  {
    ...
    //   3: ifeq +7 -> 10
    //   6: aload_0
    //   7: invokespecial 50	mzf:d	()V
    //   10: aload_0
    //   11: getfield 52	mzf:jdField_c_of_type_Long	J
    //   14: lstore 4
    //   16: lload 4
    //   18: lconst_0
    //   19: lcmp
    ...
    //   32: aload_0
    //   33: getfield 52	mzf:jdField_c_of_type_Long	J
    //   36: lsub
    //   37: l2i
    //   38: istore_2
    //   39: aload_0
    //   40: getfield 60	mzf:jdField_d_of_type_Int	I
    //   43: istore_3
    //   44: iload_2
    //   45: iload_3
    //   46: iadd
  ...
  @NotNull
  public static mzf a(long paramLong, String paramString, mzi parammzi, Player paramPlayer, myp parammyp)
  {
    mzf localmzf = new mzf();
    localmzf.jdField_a_of_type_JavaLangString = paramString;
    localmzf.jdField_b_of_type_Long = paramLong;
    localmzf.jdField_a_of_type_Myp = parammyp;
    localmzf.jdField_a_of_type_ComTencentAvgameGamelogicDataPlayer = paramPlayer;
    localmzf.jdField_a_of_type_Mzi.a(parammzi);
    return localmzf;
  }
  ...
  private void d()
  {
    ...
    {
      i = a(false);
      i = this.jdField_a_of_type_Mzi.jdField_d_of_type_Int * 1000 - i;
      if (i <= 0) {
        a(i);
      }
    }
    ...
    this.jdField_a_of_type_AndroidOsCountDownTimer = new mzg(this, i, i + 1, l, i);
    this.jdField_a_of_type_AndroidOsCountDownTimer.start();
  }
  
  public int a()
  {
    return this.jdField_a_of_type_Mzi.jdField_b_of_type_Int;
  }
  ...
  public void a(mzf parammzf)
  {
    Object localObject2 = null;
    if (parammzf == null) {
      return;
    }
    this.jdField_a_of_type_JavaLangString = parammzf.jdField_a_of_type_JavaLangString;
    this.jdField_b_of_type_Long = parammzf.jdField_b_of_type_Long;
    this.jdField_c_of_type_Int = parammzf.jdField_c_of_type_Int;
    if (parammzf.jdField_a_of_type_ComTencentAvgameGamelogicDataPlayer == null)
    {
      localObject1 = null;
      this.jdField_a_of_type_ComTencentAvgameGamelogicDataPlayer = ((Player)localObject1);
      if (parammzf.jdField_b_of_type_ComTencentAvgameGamelogicDataPlayer != null) {
        break label202;
      }
      localObject1 = null;
      label54:
      this.jdField_b_of_type_ComTencentAvgameGamelogicDataPlayer = ((Player)localObject1);
      if (parammzf.jdField_c_of_type_ComTencentAvgameGamelogicDataPlayer != null) {
        break label213;
      }
      localObject1 = null;
      label68:
      this.jdField_c_of_type_ComTencentAvgameGamelogicDataPlayer = ((Player)localObject1);
      if (parammzf.jdField_d_of_type_ComTencentAvgameGamelogicDataPlayer != null) {
        break label224;
      }
      localObject1 = null;
      label82:
      this.jdField_d_of_type_ComTencentAvgameGamelogicDataPlayer = ((Player)localObject1);
      if (parammzf.jdField_a_of_type_Myp != null) {
        break label235;
      }
    }
    label202:
    ...
    label224:
    label235:
    for (Object localObject1 = localObject2;; localObject1 = parammzf.jdField_a_of_type_Myp.a())
    {
      this.jdField_a_of_type_Myp = ((myp)localObject1);
      this.jdField_d_of_type_Int = parammzf.jdField_d_of_type_Int;
      this.e = parammzf.e;
      this.jdField_c_of_type_Long = parammzf.jdField_c_of_type_Long;
      this.jdField_d_of_type_Long = parammzf.jdField_d_of_type_Long;
      this.jdField_a_of_type_Mzi.a(parammzf.jdField_a_of_type_Mzi);
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.clear();
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.addAll(parammzf.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
      this.jdField_a_of_type_Int = parammzf.jdField_a_of_type_Int;
      this.jdField_b_of_type_Int = parammzf.jdField_b_of_type_Int;
      this.jdField_a_of_type_ComTencentAvgameGamelogicDataGameRecordInfo.copyFrom(parammzf.jdField_a_of_type_ComTencentAvgameGamelogicDataGameRecordInfo);
      return;
      localObject1 = parammzf.jdField_a_of_type_ComTencentAvgameGamelogicDataPlayer.clone();
      break;
      localObject1 = parammzf.jdField_b_of_type_ComTencentAvgameGamelogicDataPlayer.clone();
      break label54;
      localObject1 = parammzf.jdField_c_of_type_ComTencentAvgameGamelogicDataPlayer.clone();
      break label68;
      localObject1 = parammzf.jdField_d_of_type_ComTencentAvgameGamelogicDataPlayer.clone();
      break label82;
    }
  }
  ...
  public void a(AvGameCommon.GameStatusInfo paramGameStatusInfo)
  {
    ...
    if ((paramGameStatusInfo.question_info.has()) && (paramGameStatusInfo.question_info.get() != null)) {
      this.jdField_a_of_type_Myp = myn.b((AvGameCommon.GameQuestionInfo)paramGameStatusInfo.question_info.get(), false);
    }
    if ((paramGameStatusInfo.game_info.has()) && (paramGameStatusInfo.game_info.get() != null))
    {
      this.jdField_a_of_type_Mzi.a();
      this.jdField_a_of_type_Mzi.a((AvGameCommon.GameInfo)paramGameStatusInfo.game_info.get());
    }
  ...
  {
    boolean bool = true;
    if ((paramPlayer == null) || (parammyp == null)) {
      bool = false;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Myp = parammyp;
        this.jdField_d_of_type_ComTencentAvgameGamelogicDataPlayer = null;
        if (this.jdField_a_of_type_ComTencentAvgameGamelogicDataPlayer != null) {
  ...
  public boolean a(myp parammyp, int paramInt1, Player paramPlayer, long paramLong, int paramInt2)
  {
    ...
    //   4: monitorenter
    //   5: aload_0
    //   6: getfield 68	mzf:jdField_a_of_type_Myp	Lmyp;
    //   9: ifnull +112 -> 121
    //   12: aload_0
    //   13: getfield 68	mzf:jdField_a_of_type_Myp	Lmyp;
    //   16: aload_1
    ...
    //   29: aload_0
    //   30: iconst_3
    //   31: putfield 29	mzf:jdField_c_of_type_Int	I
    //   34: aload_0
    //   35: aload_1
    //   36: putfield 68	mzf:jdField_a_of_type_Myp	Lmyp;
    //   39: aload_0
    //   40: aload_3
    //   41: putfield 174	mzf:jdField_d_of_type_ComTencentAvgameGamelogicDataPlayer	Lcom/tencent/avgame/gamelogic/data/Player;
    //   44: aload_0
    //   45: iload_2
    //   46: putfield 184	mzf:jdField_a_of_type_Int	I
    //   49: aload_0
    //   50: lload 4
    //   52: putfield 330	mzf:jdField_a_of_type_Long	J
    //   55: aload_0
    //   56: aload_3
    //   57: getfield 332	com/tencent/avgame/gamelogic/data/Player:uin	Ljava/lang/String;
    //   60: iload_2
    //   61: invokevirtual 334	mzf:a	(Ljava/lang/String;I)V
    //   64: aload_1
    //   65: invokeinterface 336 1 0
    //   70: iconst_1
    //   71: if_icmpne +29 -> 100
    //   74: aload_0
    //   75: getfield 70	mzf:jdField_a_of_type_ComTencentAvgameGamelogicDataPlayer	Lcom/tencent/avgame/gamelogic/data/Player;
    //   78: ifnull +22 -> 100
    //   81: aload_0
    //   82: iload 6
    //   84: putfield 185	mzf:jdField_b_of_type_Int	I
    //   87: aload_0
    //   88: aload_0
    //   89: getfield 70	mzf:jdField_a_of_type_ComTencentAvgameGamelogicDataPlayer	Lcom/tencent/avgame/gamelogic/data/Player;
    //   92: getfield 332	com/tencent/avgame/gamelogic/data/Player:uin	Ljava/lang/String;
    //   95: iload 6
    //   97: invokevirtual 334	mzf:a	(Ljava/lang/String;I)V
    //   100: aload_0
    //   101: iconst_0
    //   102: putfield 60	mzf:jdField_d_of_type_Int	I
    //   105: aload_0
    //   106: invokestatic 58	android/os/SystemClock:elapsedRealtime	()J
    //   109: putfield 52	mzf:jdField_c_of_type_Long	J
    //   112: aload_0
    //   113: invokespecial 50	mzf:d	()V
    //   116: aload_0
    //   117: monitorexit
    //   118: iload 7
    //   120: ireturn
  ...
  public int b()
  {
    return this.jdField_a_of_type_Mzi.jdField_a_of_type_Int;
  }
  ...
  public boolean b(myp parammyp)
  {
    ...
    try
    {
      ...
      {
        bool1 = bool2;
        if (this.jdField_a_of_type_Myp.a(parammyp))
        {
  ...
  public boolean c(myp parammyp)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 68	mzf:jdField_a_of_type_Myp	Lmyp;
    //   6: ifnull +32 -> 38
    //   9: aload_0
    //   10: getfield 68	mzf:jdField_a_of_type_Myp	Lmyp;
    //   13: aload_1
    //   14: invokeinterface 328 2 0
    //   19: ifeq +19 -> 38
    //   22: aload_0
    //   23: aload_1
    //   24: putfield 68	mzf:jdField_a_of_type_Myp	Lmyp;
    //   27: aload_0
    //   28: aconst_null
    //   29: putfield 174	mzf:jdField_d_of_type_ComTencentAvgameGamelogicDataPlayer	Lcom/tencent/avgame/gamelogic/data/Player;
    //   32: iconst_1
    //   33: istore_2
    //   34: aload_0
    //   35: monitorexit
  ...
  public int e()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: invokespecial 50	mzf:d	()V
    //   8: iload_2
    //   9: istore_1
    //   10: aload_0
    //   11: getfield 29	mzf:jdField_c_of_type_Int	I
    //   14: ifeq +15 -> 29
    //   17: aload_0
    //   18: getfield 29	mzf:jdField_c_of_type_Int	I
    //   21: istore_1
    //   22: iload_1
    //   23: iconst_1
    //   24: if_icmpne +9 -> 33
    ...
    //   34: istore_1
    //   35: aload_0
    //   36: getfield 178	mzf:jdField_d_of_type_Long	J
    //   39: lconst_0
    //   40: lcmp
    //   41: ifle -12 -> 29
    //   44: invokestatic 58	android/os/SystemClock:elapsedRealtime	()J
    //   47: aload_0
    //   48: getfield 178	mzf:jdField_d_of_type_Long	J
    //   51: lsub
    //   52: l2i
    //   53: istore_1
    //   54: aload_0
    //   55: getfield 176	mzf:e	I
    //   58: istore_2
    //   59: aload_0
    //   60: getfield 34	mzf:jdField_a_of_type_Mzi	Lmzi;
    //   63: getfield 103	mzi:jdField_d_of_type_Int	I
    //   66: istore_3
    //   67: iload_1
    //   68: iload_2
    //   69: iadd
  ...
  public int f()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 219	mzf:a	()I
    //   6: invokestatic 342	myn:c	(I)Z
    //   9: ifeq +29 -> 38
    //   12: aload_0
    //   13: invokevirtual 343	mzf:a	()Lmyp;
    //   16: astore_2
    //   17: aload_2
    //   18: ifnull +20 -> 38
    //   21: aload_2
    ...
    //   37: ireturn
    //   38: aload_0
    //   39: getfield 34	mzf:jdField_a_of_type_Mzi	Lmzi;
    //   42: getfield 346	mzi:e	I
    //   45: istore_1
    //   46: iload_1
    //   47: sipush 1000
    //   50: imul
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("\n").append("gameInfo=").append("[").append(this.jdField_a_of_type_Mzi).append("]");
    localStringBuilder.append("\n").append("topic=").append("[").append(this.jdField_a_of_type_Myp).append("]");
