  ...
  extends VafContext
{
  ...
  {
    ProteusConfig localProteusConfig = new ProteusConfig.ProteusConfigBuilder().withDrawableHelper(new qgj()).withCustomMethodInterface(new qgn()).withLogger(new qgf()).withDtReporter(new pin()).build();
