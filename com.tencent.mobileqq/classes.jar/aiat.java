  ...
  implements View.OnClickListener
{
  ...
  public aiat(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean, Context paramContext)
  {
  ...
  private void a()
  {
    try
    {
      String str = ((avds)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.GAME_CENTER_MSG_MANAGER)).d();
  ...
  private void a(String paramString)
  {
    ...
    {
      return;
      GameUserInfo localGameUserInfo = ((avds)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.GAME_CENTER_MSG_MANAGER)).a(paramString);
      if (localGameUserInfo == null)
      {
        QLog.w(aiah.b, 1, "GameUsrAvatarClickLis, usrInfo is null, roleId:" + paramString);
        return;
      }
      if (TextUtils.isEmpty(localGameUserInfo.mFaceUrl))
      {
        QLog.w(aiah.b, 1, "GameUsrAvatarClickLis, faceurl is null, roleId:" + paramString);
        return;
      }
      paramString = URLDrawable.URLDrawableOptions.obtain();
      Drawable localDrawable = BaseApplicationImpl.getContext().getResources().getDrawable(2130840348);
    ...
    QLog.d(aiah.b, 2, "GameUsrAvatarClickLis del ret:" + bool);
  }
  
  public void onClick(View paramView)
  {
    if (System.currentTimeMillis() - this.jdField_a_of_type_Long < 500L) {
      QLog.w(aiah.b, 1, "GameUsrAvatarClickLis, click too fast!!!");
    }
    for (;;)
    {
