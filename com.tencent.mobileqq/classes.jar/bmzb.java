  ...
  implements Animatable
{
  ...
  Property<bmzb, Float> jdField_a_of_type_AndroidUtilProperty = new bmzc(this, Float.class, "backScale");
  private String jdField_a_of_type_JavaLangString;
  private boolean jdField_a_of_type_Boolean;
  private float jdField_b_of_type_Float;
  private int jdField_b_of_type_Int = 0;
  Property<bmzb, Integer> jdField_b_of_type_AndroidUtilProperty = new bmzd(this, Integer.class, "backAlpha");
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ("1/2".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841176);
        }
        ...
        {
          paramString = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841181);
          return paramString;
        }
      }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidAnimationValueAnimator != null)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bmze(this));
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bmzf(this));
