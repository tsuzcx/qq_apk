  ...
  implements Manager
{
  ...
  public vky(QQAppInterface paramQQAppInterface)
  {
  ...
  @NonNull
  public static vky a(QQAppInterface paramQQAppInterface)
  {
    return (vky)paramQQAppInterface.getManager(253);
  }
  ...
  public void a(ConfigurationService.Config paramConfig)
  {
    ...
    int j = bfyz.aE(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    String str;
    if (i != j)
    {
    ...
    {
      return;
      bfyz.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramConfig.version.get(), str);
      try
      {
        b(str);
        return;
  ...
  public void a(@NonNull MessageForQQStoryFeed paramMessageForQQStoryFeed)
  {
    ...
    xwa.a("aio_msg", "aio_push", 0, 0, new String[] { paramMessageForQQStoryFeed.frienduin });
    aezm localaezm = (aezm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(282);
    Object localObject = localaezm.a(paramMessageForQQStoryFeed.frienduin, 0, 5);
    int i;
    if (localObject != null)
    {
    ...
    for (;;)
    {
      ...
      bfyz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), paramMessageForQQStoryFeed.frienduin, i);
      return;
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getAllMessages(paramMessageForQQStoryFeed.frienduin, 0, new int[] { -2061 });
