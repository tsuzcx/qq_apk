...
public class njb
{
  private static njb jdField_a_of_type_Njb;
  private final Object jdField_a_of_type_JavaLangObject = new Object();
  private ArrayList<nis> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private por jdField_a_of_type_Por = por.a();
  
  public static njb a()
  {
    if (jdField_a_of_type_Njb == null) {
      jdField_a_of_type_Njb = new njb();
    }
    return jdField_a_of_type_Njb;
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg)
  {
    if (paramToServiceMsg != null)
    {
      ...
      this.jdField_a_of_type_Por.a(paramToServiceMsg);
    }
  }
  ...
  public String a(String paramString)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localnis.jdField_a_of_type_JavaLangString.equals(paramString))
        {
          paramString = localnis.jdField_a_of_type_Niu.jdField_a_of_type_JavaLangString;
          return paramString;
        }
      }
      return null;
  ...
  public nis a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          nis localnis = (nis)localIterator.next();
          if (paramString.equals(localnis.jdField_a_of_type_JavaLangString)) {
            return localnis;
          }
        }
      }
  ...
  public void a(AppInterface paramAppInterface, int paramInt, nis paramnis)
  {
    if ((paramnis == null) || (paramAppInterface == null)) {}
    for (;;)
    {
      return;
      oidb_cmd0x886.PhoneInfo localPhoneInfo = njl.a();
      try
      {
        l1 = Long.parseLong(paramAppInterface.getCurrentAccountUin());
        paramAppInterface = paramnis.a(paramInt);
        long l2 = NetConnInfoCenter.getServerTimeMillis();
        String str = bdik.d(l1 + paramnis.c + paramInt + l2);
        ...
        a(pot.a("OidbSvc.0x886", 2182, 0, localReqBody.toByteArray()));
        if (!QLog.isColorLevel()) {
          continue;
        }
        paramAppInterface = new StringBuilder("AdReport(");
        paramAppInterface.append(paramInt).append(") msgID=").append(paramnis.c);
  ...
  public void a(QQAppInterface paramQQAppInterface, RecentUser paramRecentUser)
  {
    if ((paramRecentUser != null) && (paramRecentUser.uin != null)) {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        nis localnis = a(paramRecentUser.uin);
        if ((localnis != null) && (NetConnInfoCenter.getServerTimeMillis() - localnis.jdField_a_of_type_Long > 86400000L))
        {
          ...
          if (localObject1 == null)
          {
            ...
            if (localObject1 != null)
            {
              ...
              ((aktf)localObject1).b(paramRecentUser);
              ahpd.b(paramQQAppInterface, localnis.jdField_a_of_type_JavaLangString, 1008);
              paramQQAppInterface.a().c(localnis.jdField_a_of_type_JavaLangString, 1008);
            }
            ThreadManager.executeOnFileThread(new AdvertisementRecentUserManager.1(this, localnis));
          }
        }
        else
        {
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("AdvertisementRecentUserManager", 2, "putAdvertisementItem uin:" + paramnis.jdField_a_of_type_JavaLangString);
    }
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_JavaUtilArrayList.add(paramnis);
      return;
    }
  }
}
