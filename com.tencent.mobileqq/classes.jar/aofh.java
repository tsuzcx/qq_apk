...
public class aofh
  extends acvk
{
  public aofh(QQAppInterface paramQQAppInterface, QQMessageFacade paramQQMessageFacade, acwe paramacwe)
  {
  ...
  protected String a(String paramString1, String paramString2)
  {
    ...
    String str;
    for (paramString2 = anni.a(2131704231);; paramString2 = bglf.h(this.a, paramString2, paramString1))
    {
  ...
  public void a(MessageRecord paramMessageRecord, EntityManager paramEntityManager, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, acvi paramacvi)
  {
    ...
    Map localMap2 = paramacvi.jdField_a_of_type_JavaUtilMap;
    Map localMap1 = paramacvi.d;
    ...
    localObject = (RecentUser)((aong)localObject).findRecentUserByUin(str1, 1);
    if (localMap2.containsKey(acwh.a(((RecentUser)localObject).uin, ((RecentUser)localObject).getType()))) {
      localObject = (RecentUser)localMap2.get(acwh.a(((RecentUser)localObject).uin, ((RecentUser)localObject).getType()));
    }
    for (;;)
    {
      int i;
  ...
  protected void b(QQMessageFacade.Message paramMessage)
  {
    ...
    if (QLog.isDevelopLevel()) {
      axei.a("PttShow", "processNickName", new Object[] { paramMessage.senderuin, paramMessage.nickName });
    }
  }
}
