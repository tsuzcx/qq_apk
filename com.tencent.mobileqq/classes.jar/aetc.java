...
{
  public aetc(PermisionPrivacyActivity paramPermisionPrivacyActivity) {}
  
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    boolean bool;
    if (((paramCompoundButton == this.a.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.a()) || (paramCompoundButton == PermisionPrivacyActivity.b(this.a)) || (paramCompoundButton == PermisionPrivacyActivity.a(this.a)) || (paramCompoundButton == this.a.b.a()) || (paramCompoundButton == this.a.c.a()) || (paramCompoundButton == this.a.e.a())) && (!bgnt.d(this.a.getActivity())))
    {
      this.a.a(2131693988, 1);
      localObject1 = this.a;
      if (!paramBoolean)
      {
        bool = true;
    ...
    for (;;)
    {
      ...
      {
        if (AppSetting.c) {
          this.a.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setContentDescription(this.a.getResources().getString(2131693945));
        }
        if (paramBoolean) {}
        for (i = 1;; i = 0)
        {
          bcst.b(this.a.app, "CliOper", "", "", "Setting_tab", "Nearby_likeme", 0, i, String.valueOf(i), "", "", "");
      ...
      {
        ((anip)this.a.app.a(2)).o(paramBoolean);
        if (paramBoolean) {
          bcst.b(this.a.app, "dc00898", "", "", "0X8009E81", "0X8009E81", 0, 0, "", "", "", "");
        } else {
          bcst.b(this.a.app, "dc00898", "", "", "0X8009E80", "0X8009E80", 0, 0, "", "", "", "");
        }
      }
      else
      {
        if (paramCompoundButton == this.a.i.a())
        {
          ...
          {
            QQToast.a(this.a.getApplicationContext(), 2131717834, 1).a();
            localObject1 = this.a;
            if (!paramBoolean)
            {
              bool = true;
        ...
        if (paramCompoundButton == this.a.jdField_a_of_type_AndroidWidgetCompoundButton)
        {
          if (!bgnt.d(this.a.app.getApplication().getApplicationContext()))
          {
            QQToast.a(this.a.getApplicationContext(), 2131693948, 1).a();
          ...
          {
            i = 1;
            bcst.b(this.a.app, "CliOper", "", "", "Setting_tab", "Latest_chatlog_syn", 0, i, String.valueOf(i), "", "", "");
            this.a.a(this.a.getApplication().getResources().getString(2131717789));
            if (!paramBoolean) {
              break label657;
            }
          }
        ...
        if (paramCompoundButton == PermisionPrivacyActivity.b(this.a))
        {
          ...
          for (i = 1;; i = 0)
          {
            bcst.b(this.a.app, "CliOper", "", "", "Setting_tab", "Visible_same", 0, i, String.valueOf(i), "", "", "");
        ...
        if (paramCompoundButton == PermisionPrivacyActivity.a(this.a))
        {
          ...
          for (i = 1;; i = 0)
          {
            bcst.b(this.a.app, "CliOper", "", "", "Setting_tab", "Same_likeme", 0, i, String.valueOf(i), "", "", "");
        ...
        if (paramCompoundButton == this.a.h.a())
        {
          ...
          for (i = 1;; i = 0)
          {
            bcst.b(this.a.app, "CliOper", "", "", "Setting_tab", "Clk_signature_qzone", 0, i, String.valueOf(i), "", "", "");
            if ((!bgnt.d(this.a.getActivity())) || (PermisionPrivacyActivity.a(this.a) == null)) {
              break label924;
            }
            if (AppSetting.c) {
              this.a.h.setContentDescription(anni.a(2131706689));
            }
        ...
        if (paramCompoundButton == this.a.g.a())
        {
          ...
          if (paramBoolean)
          {
            if ((ajca.a()) && (VersionUtils.isM()))
            {
              PhoneContactManagerImp localPhoneContactManagerImp = (PhoneContactManagerImp)this.a.app.getManager(11);
              ajcc localajcc = new ajcc();
              localajcc.jdField_a_of_type_JavaLangRunnable = ((Runnable)localObject1);
              localajcc.b = ((Runnable)localObject2);
              localajcc.jdField_a_of_type_Int = 7;
              localPhoneContactManagerImp.a().a(this.a, localajcc, this.a, new String[] { "android.permission.READ_CONTACTS", "android.permission.WRITE_CONTACTS", "android.permission.GET_ACCOUNTS" });
            }
            else
            {
        ...
        {
          if (AppSetting.c) {
            this.a.b.setContentDescription(anni.a(2131706691));
          }
          PermisionPrivacyActivity.a(this.a, this.a.b.a(), paramBoolean);
          this.a.app.c(paramBoolean, true);
          if (paramBoolean) {
            bcst.b(this.a.app, "CliOper", "", "", "0X8009C08", "0X8009C08", 0, 0, "", "", "", "");
          } else {
            bcst.b(this.a.app, "CliOper", "", "", "0X8009C09", "0X8009C09", 0, 0, "", "", "", "");
          }
        }
        else if (paramCompoundButton == this.a.c.a())
        {
          if (AppSetting.c) {
            this.a.c.setContentDescription(anni.a(2131706682));
          }
        ...
        else
        {
          if (paramCompoundButton == this.a.d.a())
          {
            ...
            for (i = 1;; i = 0)
            {
              bcst.b((QQAppInterface)localObject1, "CliOper", "", "", "0X800487E", "0X800487E", 0, 0, String.valueOf(i), "", "", "");
              if (!bgnt.d(this.a.getActivity())) {
                break label1520;
              }
              if (AppSetting.c) {
                this.a.d.setContentDescription(anni.a(2131706692));
              }
              ((anip)this.a.app.a(2)).i(paramBoolean);
              break;
            }
            label1520:
            localObject1 = this.a;
    ...
    label1638:
    this.a.jdField_a_of_type_Anwd.a(paramBoolean);
    ...
    {
      bcst.b((QQAppInterface)localObject2, "dc00899", "Grp_invite_friend", "", "auto_pass", (String)localObject1, 0, 0, "", "", "", "");
      break;
      i = 2131692796;
      break label1666;
    }
