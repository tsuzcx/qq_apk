...
public class arln
{
  ...
  arls jdField_a_of_type_Arls = new arls();
  private String jdField_a_of_type_JavaLangString = "";
  boolean jdField_a_of_type_Boolean = true;
  arls jdField_b_of_type_Arls = new arls();
  private String jdField_b_of_type_JavaLangString = "";
  arls jdField_c_of_type_Arls = new arls();
  ...
  @NonNull
  public static arln a(@Nullable String paramString)
  {
    ...
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        localarln.jdField_a_of_type_Int = paramString.optInt("enable", localarln.jdField_a_of_type_Int);
        localarln.jdField_a_of_type_JavaLangString = paramString.optString("cacheFlag", localarln.jdField_a_of_type_JavaLangString);
        localarln.jdField_b_of_type_JavaLangString = paramString.optString("intructionPageUrl", localarln.jdField_b_of_type_JavaLangString);
        localarln.jdField_a_of_type_Arls = arls.a(paramString.getJSONObject("fullSpaceMessage"));
        localarln.jdField_b_of_type_Arls = arls.a(paramString.getJSONObject("redSubString"));
        localarln.jdField_c_of_type_Arls = arls.a(paramString.getJSONObject("blueSubString"));
        localarln.d = arls.a(paramString.getJSONObject("blueActionUrl"));
        localarln.e = arls.a(paramString.getJSONObject("fullAlertMessage"));
        localarln.f = arls.a(paramString.getJSONObject("bigFileAlertMessage"));
        localarln.g = arls.a(paramString.getJSONObject("alertButtonTitle"));
        localarln.h = arls.a(paramString.getJSONObject("buttonActionUrl"));
        localarln.i = arls.a(paramString.getJSONObject("AIObuttonActionUrl"));
      }
      if (QLog.isColorLevel()) {
        QLog.e("QVIP.TROOP_FILE.ConfigProcessor", 1, " : " + localarln.toString());
      }
      return localarln;
    }
  ...
  private static void b(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      bdla.b(null, "dc00898", "", "", "qq_vip", paramString1, j, 1, 0, "", "", paramString3, "");
      return;
  ...
  {
    String str1 = this.jdField_a_of_type_Arls.a(paramString);
    String str2 = this.jdField_b_of_type_Arls.a(paramString);
    String str3 = this.jdField_c_of_type_Arls.a(paramString);
    ...
    j = str1.indexOf(str3);
    if (j > -1) {
      localSpannableString.setSpan(new arlo(this, str4, paramString), j, str3.length() + j, 33);
    }
  ...
  {
    paramContext = bhdj.a(paramContext, 230, "", paramString1, this.jdField_c_of_type_JavaLangString, this.g.a(paramString2), new arlq(this, paramContext, paramBoolean1, paramString2, paramBoolean2), new arlr(this, paramRunnable, paramBoolean1, paramString2, paramBoolean2));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        for (int j = 1;; j = 0)
        {
          ...
          localObject = new arlp(this, paramString2);
