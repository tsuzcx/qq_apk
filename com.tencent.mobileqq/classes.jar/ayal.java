  ...
  extends MSFServlet
{
  ...
  {
    Object localObject = new NewIntent(paramQQAppInterface.getApp(), ayal.class);
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          paramLong = axrl.a(BaseApplication.getContext());
          ...
          if (paramMessageForPtt.istroop == 0)
          {
            ...
            ((HashMap)localObject).put("appversion", "8.2.8");
        ...
        catch (Exception paramQQAppInterface)
        {
          try
          {
            ...
            for (;;)
            {
              paramQQAppInterface = axrl.a(BaseApplication.getContext());
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (bool2 = true;; bool2 = false)
    {
      ...
      notifyObserver(paramIntent, k, bool2, paramFromServiceMsg, ayah.class);
      return;
      break;
    }
  }
