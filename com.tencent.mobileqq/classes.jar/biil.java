  ...
  implements bihz, INetInfoHandler
{
  ...
  public biil(AppRuntime paramAppRuntime, bihy parambihy)
  {
    ...
    try
    {
      if (!this.jdField_a_of_type_JavaUtilLinkedList.isEmpty())
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("QueueDownloader", 2, "getTask | " + paramString + " task find =" + localbihu);
            }
            return localbihu;
          }
        }
  ...
  public void a()
  {
    for (;;)
    {
      try
      {
        synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
        {
          ...
          if ((!localbihu2.a()) && (l > localbihu2.c + localbihu2.d))
          {
            ...
            QLog.d("QueueDownloader", 2, "remove task[" + localbihu2.jdField_a_of_type_JavaLangString + "], isCancal=" + localbihu2.b() + ", timeOut=" + bool);
          }
        }
        bool = false;
      }
      ...
      for (;;)
      {
        ...
        return;
        label288:
        ThreadManager.postDownLoadTask(new QueueDownloader.1(this, localbihu1), 2, null, false);
  ...
  public void a(bihu parambihu)
  {
    ...
    try
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("QueueDownloader", 2, "removeTask | task=" + parambihu);
        }
        parambihu.i();
      ...
      synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
      {
        ...
        if (paramBundle == null)
        {
          ...
          if (parambihu.b)
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.d("QueueDownloader", 2, "startDownload | task=" + parambihu.jdField_a_of_type_JavaLangString);
            }
            a();
            return;
          }
