  ...
  extends RelativeLayout
{
  ...
  public aapy(ArkPanelPagerAdapter paramArkPanelPagerAdapter, Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    while (i < m)
    {
      ...
      for (paramAttributeSet.topMargin = (XPanelContainer.d / (m + 1));; paramAttributeSet.topMargin = (j * i + XPanelContainer.d * (i + 2) / (m + 1) / 2))
      {
        ...
        while (j < k)
        {
          ...
          ((ArkPanelPagerAdapter.ViewHolder)localObject).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131363678));
          ((ArkPanelPagerAdapter.ViewHolder)localObject).b = ((ImageView)localView.findViewById(2131363679));
          ((ArkPanelPagerAdapter.ViewHolder)localObject).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131362943));
