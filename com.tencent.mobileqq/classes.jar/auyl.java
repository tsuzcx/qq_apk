  ...
  implements Manager
{
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, apvs paramapvs)
  {
    QLog.i("TeleScreen|CheckForwardManager", 1, "dl src: " + paramString1 + ", refId: " + paramString4);
    BaseApplicationImpl localBaseApplicationImpl = BaseApplicationImpl.getApplication();
    NewIntent localNewIntent = new NewIntent(localBaseApplicationImpl.getApplicationContext(), auyn.class);
    ...
    if (paramapvs != null)
    {
      int i = paramString1.a(paramContext, paramapvs);
      localNewIntent.putExtra("req_id", i);
      if (QLog.isColorLevel()) {
        QLog.d("TeleScreen|CheckForwardManager", 2, "add req with id: " + i);
      }
    }
    localNewIntent.setObserver(apwl.a());
    localBaseApplicationImpl.getRuntime().startServlet(localNewIntent);
  }
  
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, List<ResolveInfo> paramList, String paramString6, apvx paramapvx)
  {
    ...
    for (;;)
    {
      ...
      int i = apwl.a().a(paramContext, paramapvx);
      localNewIntent.putExtra("req_id", i);
      if (QLog.isColorLevel()) {
        QLog.d("TeleScreen|CheckForwardManager", 2, "add req with id: " + i);
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, oidb_cmd0xc78.CheckShareExtensionReq paramCheckShareExtensionReq, String paramString, auyo paramauyo)
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApp(), auyn.class);
