...
public class auyl
{
  private static auyl jdField_a_of_type_Auyl;
  ...
  {
    if (jdField_a_of_type_Auyl == null) {
      jdField_a_of_type_Auyl = new auyl();
    }
    return jdField_a_of_type_Auyl;
  }
  
  public static URLDrawable a(String paramString, int paramInt1, int paramInt2)
  {
    URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
    localURLDrawableOptions.mLoadingDrawable = new aqww(-10065297, 100, 100);
    localURLDrawableOptions.mFailedDrawable = new aqww(-10065297, 100, 100);
  ...
  public static URLDrawable a(String paramString1, String paramString2, long paramLong, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt3, QQLiveDrawable.OnStateListener paramOnStateListener, URLDrawable paramURLDrawable)
  {
    ...
    localQQLiveDrawableParams.mCoverLoadingDrawable = new aqww(-10065297, 100, 100);
    ...
    for (paramString1.mLoadingDrawable = paramURLDrawable;; paramString1.mLoadingDrawable = new aqww(-10065297, 100, 100))
    {
      paramString1.mRequestWidth = paramInt1;
      paramString1.mRequestHeight = paramInt2;
      return URLDrawable.getDrawable(agnj.a(paramLong), paramString1);
    }
  }
  ...
  public void a(auym paramauym)
  {
    this.jdField_a_of_type_Auym = paramauym;
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Auym != null) {
      this.jdField_a_of_type_Auym.a(paramBoolean);
    }
  }
