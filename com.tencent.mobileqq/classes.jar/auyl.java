...
public abstract class auyl
{
  ...
  public auyl(long paramLong, String paramString, byte[] paramArrayOfByte)
  {
    ...
    this.jdField_b_of_type_ComTencentUploadUinterfaceIUploadTaskCallback = new auym(this);
    this.jdField_a_of_type_Long = paramLong;
    this.g = paramString;
    this.h = auyj.a(paramString);
