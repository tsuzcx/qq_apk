...
public class bdjd
{
  ...
  public static Bundle a(Context paramContext, Map<String, String> paramMap, String paramString1, String paramString2)
  {
    ...
    paramContext.putString("platform", bcxm.a().g());
    paramContext.putString("version", bcxm.a().d());
    paramContext.putString("uin", paramString2);
    paramContext.putString("imei", bdja.c());
    paramContext.putString("imsi", bdja.d());
    paramContext.putString("android_id", Settings.Secure.getString(bcxm.a().a().getContentResolver(), "android_id"));
    paramContext.putString("mac_addr", bdja.a());
    paramContext.putString("model_info", Build.MODEL);
    paramContext.putString("resolution", bdja.e());
    paramContext.putString("keystr", bcxm.a().a());
    paramContext.putString("sid", bcxm.a().a());
  ...
  public static String a(String paramString1, int paramInt1, String paramString2, int paramInt2, String paramString3)
  {
    ...
    localStringBuilder.append("\"");
    localStringBuilder.append("]");
    bdht.b("AppReport", "message to cgi: " + localStringBuilder.toString());
  ...
  public static Map<String, String> a(Context paramContext)
  {
    ...
    //   41: aconst_null
    //   42: areturn
    //   43: getstatic 16	bdjd:a	Ljava/util/concurrent/locks/Lock;
    ...
    //   169: aload 4
    //   171: astore 7
    //   173: getstatic 16	bdjd:a	Ljava/util/concurrent/locks/Lock;
    ...
    //   365: ldc 247
    //   367: iload_3
    //   368: invokestatic 249	bdjd:a	(Ljava/lang/String;ILjava/lang/String;I)Ljava/lang/String;
    ...
    //   434: iconst_0
    //   435: aaload
    //   436: invokestatic 277	bdiw:a	(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    //   439: invokestatic 113	bdjd:a	(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/String;
    ...
    //   500: invokestatic 284	bdht:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   503: goto +339 -> 842
    //   506: astore 6
    //   508: aload 5
    //   510: astore_0
    ...
    //   603: invokestatic 284	bdht:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   606: goto +236 -> 842
    //   609: astore_0
    //   610: aload 7
    //   612: astore 4
    ...
    //   689: invokestatic 284	bdht:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   692: goto +150 -> 842
    //   695: aload 4
    //   697: ifnull +8 -> 705
    //   700: aload 4
  ...
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    ...
    bdht.b("AppReport", "save package <" + paramString + " : " + paramInt + "> to local");
  ...
  public static boolean a()
  {
    boolean bool = bdjb.a(bcxm.a().a(), null).b("C_Full_Report");
    bdht.c("AppReport", "<AppReport>, app full report switch : " + bool);
    return bool;
  }
