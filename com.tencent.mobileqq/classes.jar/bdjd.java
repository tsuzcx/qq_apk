...
public class bdjd
  extends bdiw<Bundle, Void, HashMap<String, Object>>
{
  protected Handler a;
  public bdje a;
  
  public bdjd(String paramString1, String paramString2, bdje parambdje)
  {
    super(paramString1, paramString2);
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_a_of_type_Bdje = parambdje;
  }
  ...
  public bdiz a(String paramString1, String paramString2, Bundle paramBundle)
  {
  ...
  public void a()
  {
    this.jdField_a_of_type_Bdje = null;
  }
  ...
  public HashMap<String, Object> b(Bundle... paramVarArgs)
  {
    ...
    try
    {
      ...
      j = bdjq.a(bcyb.a().a(), (String)localObject).a("Common_HttpRetryCount");
      bdii.c("OpenConfig_agent", "config 1:Common_HttpRetryCount            config_value:" + j + "   appid:" + (String)localObject + "     url:" + str2);
      if (j == 0)
      {
        j = 3;
        bdii.c("OpenConfig_agent", "config 1:Common_HttpRetryCount            result_value:" + j + "   appid:" + (String)localObject + "     url:" + str2);
    ...
    catch (Exception localException)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          try
          {
            localbdiz = a(this.jdField_a_of_type_JavaLangString, this.b, paramVarArgs[0]);
            l2 = l1;
            l4 = l1;
            str1 = localbdiz.jdField_a_of_type_JavaLangString;
            l2 = l1;
            l4 = l1;
            ...
            l2 = l1;
            l4 = l1;
            ((JSONObject)localObject).put("content", localbdiz.jdField_a_of_type_JavaIoInputStream);
          }
          catch (ConnectTimeoutException localConnectTimeoutException)
          {
            ...
            l2 = l1;
            l4 = l1;
            localJSONObject1.put("httpdatamodified", localbdiz.jdField_a_of_type_Int);
            continue;
          }
          ...
          catch (HttpBaseUtil.HttpStatusException paramVarArgs)
          {
            ...
            try
            {
              ...
              bdka.a().a(str2, l3, l2, 0L, i, bcyb.a().a(), "1000002", null);
              return localHashMap;
            }
          ...
          catch (Exception paramVarArgs)
          {
            ...
            {
              i = Integer.parseInt(paramVarArgs.getMessage().replace("http status code error:", ""));
              bdka.a().a(str2, l3, l4, 0L, i, bcyb.a().a(), "1000002", null);
              return localHashMap;
            }
            catch (Exception paramVarArgs)
            {
          ...
          l2 = l1;
          l4 = l1;
          bdii.a("HttpCgiAsyncTask", "response.isModified= " + localbdiz.jdField_a_of_type_Int);
          l2 = l1;
          l4 = l1;
          if (localbdiz.jdField_a_of_type_Int == 0)
          {
            if (!bool) {
              continue;
            }
            ...
            l2 = l1;
            l4 = l1;
            localJSONObject2.put("httpdatamodified", localbdiz.jdField_a_of_type_Int);
            l2 = l1;
            l4 = l1;
          ...
          l2 = l1;
          l4 = l1;
          l1 = localbdiz.jdField_a_of_type_Long;
          l2 = l1;
          l4 = l1;
          l5 = localbdiz.b;
          l2 = l5;
          l4 = l3;
          bdii.c("ReportManager", str2 + " | " + l4 + " | " + l1 + " | " + l2 + " | " + i);
          l3 = 0L;
          try
          {
          ...
          bdka.a().a(str2, l4, l1, l2, i, l3, "1000002", null);
          return localHashMap;
          if (!bool) {
            continue;
          }
