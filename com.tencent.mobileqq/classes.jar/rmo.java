...
public class rmo
{
  public static void a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, FastWebActivity paramFastWebActivity, JSONObject paramJSONObject, List<BaseData> paramList, ArrayList<String> paramArrayList)
  {
    ...
    try
    {
        ...
        while (paramList.hasNext())
        {
          ...
          if (bool) {
            try
            {
              ...
              if (((ProteusItemData)localObject).s == 2) {
                paramArrayList.add(onk.f(((ProteusItemData)localObject).b.getString("articleImageUrl")));
              }
            }
      ...
      badh.a(paramFastWebActivity, paramArrayList.indexOf(onk.f(paramJSONObject)), paramArrayList, null, null, false, true, "4", 1000, null, null, null, null, "", true);
    }
    ...
    {
      rnr.a(paramArticleInfo, "0X8008996", onk.a(paramFastWebActivity, paramArticleInfo, 0, paramFastWebArticleInfo).toString());
      return;
    }
  }
