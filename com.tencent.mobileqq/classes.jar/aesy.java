  ...
  implements View.OnClickListener
{
  ...
  public aesy(MusicPlayerActivity paramMusicPlayerActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ((!(localObject1 instanceof aeti)) || (paramView == null)) {
        continue;
      }
      localObject1 = (aeti)localObject1;
      ...
      this.jdField_a_of_type_ComTencentWidgetActionSheet = ActionSheetAdapter.a(paramView, (ActionSheetAdapter)localObject3, new aesz(this, (aeti)localObject1), null, null, true);
      ...
      try
      {
        ...
        if (paramView.isSelected())
        {
          ...
          MusicPlayerActivity.a(this.jdField_a_of_type_ComTencentMobileqqMusicgeneMusicPlayerActivity).setImageResource(2130839472);
          if (!(localObject3 instanceof Integer)) {
            continue;
          }
          i = ((Integer)localObject3).intValue();
          MusicPlayerActivity.a(this.jdField_a_of_type_ComTencentMobileqqMusicgeneMusicPlayerActivity, 2130839472, i);
          return;
        }
      }
      ...
      MusicPlayerActivity.a(this.jdField_a_of_type_ComTencentMobileqqMusicgeneMusicPlayerActivity).setImageResource(2130839471);
      if (!(localObject3 instanceof Integer)) {
        continue;
      }
      i = ((Integer)localObject3).intValue();
      MusicPlayerActivity.a(this.jdField_a_of_type_ComTencentMobileqqMusicgeneMusicPlayerActivity, 2130839471, i);
      return;
      if (localObject2 == null) {
        continue;
      }
        ...
        default: 
          for (;;)
          {
            for (;;)
            {
              ...
              localObject1 = (aetj)MusicPlayerActivity.b().get(localObject1);
              paramView = MusicPlayerActivity.a(this.jdField_a_of_type_ComTencentMobileqqMusicgeneMusicPlayerActivity, (IQQPlayerService)localObject2, paramView, ((aetj)localObject1).a);
              MusicPlayerActivity.a(this.jdField_a_of_type_ComTencentMobileqqMusicgeneMusicPlayerActivity, (aetj)localObject1, paramView);
              return;
            ...
            ((ActionSheet)localObject1).a(2131438498);
            ((ActionSheet)localObject1).a(2131438497, 2);
            ((ActionSheet)localObject1).c(2131438496);
            ((ActionSheet)localObject1).a(new aetb(this, paramView, (ActionSheet)localObject1));
