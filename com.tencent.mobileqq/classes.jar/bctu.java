...
public class bctu
  extends bctr
  implements SeekBar.OnSeekBarChangeListener, bctf, IVideoOuterStatusListener
{
  ...
  public bctu(Context paramContext)
  {
    super(paramContext);
  }
    ...
    do
    {
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          this.jdField_e_of_type_AndroidWidgetImageView.setImageResource(2130845344);
          break label64;
          m = 40;
          k = 16;
          if (localResources == null) {
          ...
          m = actn.a(20.0F, localResources);
          k = actn.a(8.0F, localResources);
          break label118;
      ...
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130845345);
        return;
      }
  ...
  private void b()
  {
    ...
    do
    {
      ...
      {
        if ((this.jdField_a_of_type_Bctp == null) || (!this.jdField_a_of_type_Bctp.a(this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.a(), this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.b())))
        {
  ...
  private void c(int paramInt)
  {
    ...
    if (this.jdField_f_of_type_AndroidWidgetImageView != null)
    {
      ...
      this.jdField_f_of_type_AndroidWidgetImageView.setImageResource(2130845343);
    ...
    for (;;)
    {
      if (this.jdField_c_of_type_AndroidWidgetTextView != null)
      {
        ...
        this.jdField_c_of_type_AndroidWidgetTextView.setText(2131699615);
      }
      return;
      label138:
    ...
    if (paramInt == 401)
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(2131699616);
      return;
    }
    if (paramInt == 402)
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(2131699618);
      return;
    }
    if (paramInt == 403)
    {
      this.jdField_c_of_type_AndroidWidgetTextView.setText(2131699617);
      return;
    }
    this.jdField_c_of_type_AndroidWidgetTextView.setText(2131699616);
  }
  ...
  private void c(boolean paramBoolean)
  {
    if (Build.VERSION.SDK_INT >= 21) {
      if (this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer != null)
      {
        ...
        if ((this.jdField_a_of_type_AndroidContentContext != null) && (this.jdField_a_of_type_AndroidContentContext.getResources() != null))
        {
          ...
          aokg.a(this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845339));
        }
      }
    }
    for (;;)
    {
      ...
      return;
      label97:
      aokg.a(this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130845338));
    }
  }
  ...
  private void d(int paramInt)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationObjectAnimator.addUpdateListener(new bctw(this, f2, f1));
        this.jdField_a_of_type_AndroidAnimationObjectAnimator.addListener(new bctx(this, paramInt));
  ...
  private void f()
  {
    ...
    if (this.jdField_a_of_type_Bcto != null) {
      this.jdField_a_of_type_Bcto.a();
    }
  ...
  private void h()
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenContainer.b())
      {
        ...
        {
          this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(ajyc.a(2131704627));
          return;
        }
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(ajyc.a(2131704628));
        return;
      }
      if (this.jdField_f_of_type_Int == 0)
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(ajyc.a(2131704631));
        return;
      }
    } while (this.jdField_f_of_type_Int != 1);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setContentDescription(ajyc.a(2131704625));
  }
  ...
  public void a(Context paramContext)
  {
    ...
    this.jdField_b_of_type_AndroidWidgetFrameLayout.setId(2131373162);
    this.jdField_b_of_type_AndroidWidgetImageView = new ImageView(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_b_of_type_AndroidWidgetImageView.setId(2131373148);
    this.jdField_b_of_type_AndroidWidgetImageView.setScaleType(ImageView.ScaleType.FIT_XY);
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373152));
    this.jdField_c_of_type_AndroidWidgetImageView.setContentDescription(ajyc.a(2131704633));
    this.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373151));
    this.jdField_d_of_type_AndroidWidgetImageView.setContentDescription(ajyc.a(2131704629));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373158));
    this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(ajyc.a(2131704630));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373157));
    this.jdField_b_of_type_AndroidWidgetTextView.setContentDescription(ajyc.a(2131704626));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373155));
    this.jdField_e_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373153));
    this.jdField_e_of_type_AndroidWidgetImageView.setContentDescription(ajyc.a(2131704632));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373159));
    this.jdField_f_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373154));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373161));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373160));
    ...
    this.jdField_a_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131373164));
    this.jdField_a_of_type_AndroidWidgetSeekBar.setOnSeekBarChangeListener(this);
    this.jdField_a_of_type_AndroidWidgetSeekBar.setThumb(paramContext.getResources().getDrawable(2130848690));
    this.jdField_a_of_type_AndroidWidgetSeekBar.setProgressDrawable(paramContext.getResources().getDrawable(2130845185));
  ...
  {
    this.jdField_a_of_type_Bcto = parambcto;
  }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenFloatingScreenStatusReceiver.a(0, new bctv(this));
    }
  }
