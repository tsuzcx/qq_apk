  ...
  public String a(int paramInt, long paramLong)
  {
    if ((paramInt >= 0) && (paramInt < 41))
    {
      ...
      for (;;)
      {
        ...
        {
          this.jdField_a_of_type_JavaLangString = kyl.a();
    ...
    krx.d("VideoNodeReporter", "buildBody report error:" + paramInt);
    return null;
  }
  
  public void a(kvq paramkvq, String paramString)
  {
    if (paramkvq != null)
    {
      if (paramkvq.j != -1) {
        this.jdField_a_of_type_Int = paramkvq.j;
      }
      if (paramkvq.jdField_d_of_type_Int != 0) {
        this.jdField_b_of_type_Int = paramkvq.jdField_d_of_type_Int;
      }
      if (!TextUtils.isEmpty(paramkvq.jdField_d_of_type_JavaLangString)) {
        this.jdField_b_of_type_JavaLangString = paramkvq.jdField_d_of_type_JavaLangString;
      }
    }
