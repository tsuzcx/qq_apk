...
public final class tzk
  extends tyg
{
  public static final tzl a = new tzl(null);
  
  public tzk(@NotNull BridgeModule paramBridgeModule)
  {
  ...
  private final void b(JSONObject paramJSONObject, String paramString)
  {
    ...
    {
      uta.a(paramJSONObject, str, (twh)new tzm(this, paramString));
      break;
    }
  }
  ...
  {
    UiApiPlugin.a(true, paramString, (twh)new tzn(this));
  }
  ...
  public void a()
  {
    a("openPluginView", (Function2)new UIBridgeInvokeHandler.register.1((tzk)this));
    a("arouseReadInJoyNativeCommentView", (Function2)new UIBridgeInvokeHandler.register.2((tzk)this));
    a("biuCommentAladdinConfig", (Function2)new UIBridgeInvokeHandler.register.3((tzk)this));
    a("showCommentEditor", (Function2)new UIBridgeInvokeHandler.register.4((tzk)this));
