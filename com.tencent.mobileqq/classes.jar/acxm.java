...
public class acxm
{
  ...
  private WeakReference<acxo> jdField_a_of_type_JavaLangRefWeakReference;
  private URL jdField_a_of_type_JavaNetURL;
  private boolean jdField_a_of_type_Boolean;
  
  public acxm(String paramString, WeakReference<acxo> paramWeakReference)
  {
    try
    {
    ...
    {
      acvc.d("GdtDrawableLoader", "GdtDrawableLoader error " + paramString, paramWeakReference);
    }
  }
  
  private URLDrawable.URLDrawableListener a()
  {
    return new acxn(this);
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    acvc.b("GdtDrawableLoader", "notify " + paramBoolean + " " + a());
    this.jdField_a_of_type_Boolean = true;
    if (paramBoolean)
    {
      ((acxo)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a(this.jdField_a_of_type_ComTencentImageURLDrawable);
      return;
    }
    ((acxo)this.jdField_a_of_type_JavaLangRefWeakReference.get()).b(this.jdField_a_of_type_ComTencentImageURLDrawable);
  }
  ...
  private boolean a()
  {
    ...
    acvc.b("GdtDrawableLoader", "retry " + a());
  ...
  private void b()
  {
    ...
    if ((!b()) || (this.jdField_a_of_type_ComTencentImageURLDrawable == null)) {
      acvc.b("GdtDrawableLoader", "update error " + a());
    }
    for (;;)
    {
      return;
      ...
      {
        acvc.b("GdtDrawableLoader", "drawable status is loading " + a());
        i = j;
      ...
      while ((i != 0) && (!this.jdField_a_of_type_Boolean))
      {
        ...
        {
          acvc.b("GdtDrawableLoader", "drawable status is file downloaded " + a());
          i = j;
        }
        else if (this.jdField_a_of_type_ComTencentImageURLDrawable.getStatus() == 1)
        {
          acvc.b("GdtDrawableLoader", "drawable status is successed " + a());
          a(true);
          i = 0;
        }
        else if (this.jdField_a_of_type_ComTencentImageURLDrawable.getStatus() == 2)
        {
          acvc.d("GdtDrawableLoader", "drawable status is failed " + a());
          i = j;
          if (!a())
          {
            a(false);
        ...
        {
          acvc.d("GdtDrawableLoader", "drawable status is cancled " + a());
          a(false);
          i = 0;
        }
        else
        {
          acvc.d("GdtDrawableLoader", "drawable status is " + this.jdField_a_of_type_ComTencentImageURLDrawable.getStatus() + " " + a());
          i = 0;
        }
      }
    }
  ...
  public void a()
  {
    if (!b())
    {
      acvc.d("GdtDrawableLoader", "load error");
      return;
    }
    acvc.b("GdtDrawableLoader", "load " + a());
    ...
    {
      acvc.d("GdtDrawableLoader", "load error " + a());
      return;
    }
