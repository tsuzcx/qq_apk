...
public class abqa
  extends QIPCModule
{
  private static volatile abqa a;
  
  private abqa(String paramString)
  {
    super(paramString);
  }
  ...
  {
    abrl.b("gdt_ipc", "Action  " + paramString);
    if ("do_app_jump".equals(paramString))
    {
      if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface))
      {
        paramString = (abrm)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(110);
