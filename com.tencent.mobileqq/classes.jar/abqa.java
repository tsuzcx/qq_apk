  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if ("com.tencent.device.ble.ACTION_GATT_CONNECTED".equals(paramContext)) {
      accz.a().a(null, "Net_Bind_BLE_Connect", 0);
    }
    do
    {
      int i;
        ...
        do
        {
          do
          {
            ...
            if (paramContext != null)
            {
              ...
              abpx.b(this.a).remove(paramContext);
              if (this.a.jdField_a_of_type_Abwl == paramContext) {
                this.a.jdField_a_of_type_Abwl = null;
              }
              abpx.a(this.a).remove(paramContext);
              abpx.a(this.a, i);
