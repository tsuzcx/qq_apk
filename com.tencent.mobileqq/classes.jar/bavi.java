...
public abstract class bavi
  implements DownloadParams.DecodeHandler
{
  public static final DownloadParams.DecodeHandler a;
  private static String a;
  public static final DownloadParams.DecodeHandler b = new bavu();
  public static final DownloadParams.DecodeHandler c = new bavz();
  public static final DownloadParams.DecodeHandler d = new bawa();
  public static final DownloadParams.DecodeHandler e = new bawb();
  public static final DownloadParams.DecodeHandler f = new bawc();
  public static final DownloadParams.DecodeHandler g = new bawd();
  public static final DownloadParams.DecodeHandler h = new bawe();
  public static final DownloadParams.DecodeHandler i = new bawf();
  public static final DownloadParams.DecodeHandler j = new bavk();
  public static final DownloadParams.DecodeHandler k = new bavl();
  public static final DownloadParams.DecodeHandler l = new bavm();
  public static final DownloadParams.DecodeHandler m = new bavn();
  public static final DownloadParams.DecodeHandler n = new bavo();
  public static final DownloadParams.DecodeHandler o = new bavp();
  public static final DownloadParams.DecodeHandler p = new bavq();
  public static final DownloadParams.DecodeHandler q = new bavr();
  public static final DownloadParams.DecodeHandler r = new bavs();
  public static final DownloadParams.DecodeHandler s = new bawg(10);
  public static final DownloadParams.DecodeHandler t = new bawg(20);
  public static final DownloadParams.DecodeHandler u = new bavt();
  public static final DownloadParams.DecodeHandler v = new bavv();
  public static final DownloadParams.DecodeHandler w = new bawh();
  public static final DownloadParams.DecodeHandler x = new bavw();
  public static final DownloadParams.DecodeHandler y = new bavx();
  public static final DownloadParams.DecodeHandler z = new bavy();
  
  static
  {
    jdField_a_of_type_JavaLangString = "URLDrawableDecodeHandler";
    jdField_a_of_type_ComTencentImageDownloadParams$DecodeHandler = new bavj();
  }
