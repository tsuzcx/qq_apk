...
public class akmz
  extends alpd
{
  public akmz(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  public void a(List<Long> paramList, alpg paramalpg)
  {
    ...
    localAddonReqComm.mqqver.set("8.3.5");
    ...
    paramalpg = super.createToServiceMsg("ReadDiyAddonInfo.1", paramalpg);
      ...
      do
      {
        ...
        catch (Exception paramFromServiceMsg)
        {
          ...
          if ((paramFromServiceMsg.rspcmd0x01.has()) && (paramFromServiceMsg.rspcmd0x01.userdiyinfo.has()))
          {
            ...
            akmx.a().a(this.app, true, paramFromServiceMsg);
