  ...
  implements View.OnClickListener
{
  ...
  public amqw(SigCommentListActivity paramSigCommentListActivity, QQAppInterface paramQQAppInterface, XListView paramXListView, View paramView)
  {
  ...
  {
    if (this.b != null) {
      ((amqx)this.b.getTag()).jdField_a_of_type_AndroidWidgetTextView.setText(paramInt);
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (1 == i)
      {
        ...
        if (paramView == null)
        {
          paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562938, this.jdField_a_of_type_ComTencentWidgetXListView, false);
          localObject1 = new amqy();
          ((amqy)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131377707));
          ((amqy)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131377708));
          ((amqy)localObject1).jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131377705));
          ((amqy)localObject1).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131377706));
          ((amqy)localObject1).c = ((TextView)paramView.findViewById(2131377709));
          paramView.setTag(localObject1);
          localSigCommentInfo = a(paramInt);
          localObject2 = String.valueOf(localSigCommentInfo.uin);
          aoot localaoot = aoot.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, (String)localObject2);
          if (localaoot != null) {
            ((amqy)localObject1).jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(localaoot);
          }
          localObject2 = bhlg.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject2);
          ((amqy)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
          ((amqy)localObject1).jdField_b_of_type_AndroidWidgetImageView.setBackgroundResource(2130850035);
        ...
        label375:
        for (Object localObject2 = anzj.a(2131712977) + (String)localObject2;; localObject2 = anzj.a(2131712974) + (String)localObject2)
        {
          ((amqy)localObject1).jdField_b_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
          a(localSigCommentInfo.feedsid, ((amqy)localObject1).c);
          break;
          localObject1 = (amqy)paramView.getTag();
          break label171;
        }
      }
      if (2 == i)
      {
        if (paramView == null)
        {
          paramView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562132, this.jdField_a_of_type_ComTencentWidgetXListView, false);
          paramView.setOnClickListener(this);
          localObject1 = new amqx();
          paramView.setTag(localObject1);
          paramView.findViewById(2131370293).setVisibility(8);
          ((amqx)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371433));
          this.b = paramView;
        }
        for (;;)
        {
          paramView = this.b;
          break;
          paramView = (amqx)paramView.getTag();
        }
      }
    }
  }
