...
public class bkjh
{
  public static void a(Context paramContext, TextView paramTextView, int paramInt, boolean paramBoolean)
  {
    ...
    {
      return;
      int i = paramContext.getResources().getDimensionPixelSize(2131297048);
      int j = paramContext.getResources().getDimensionPixelSize(2131297046);
      switch (paramInt)
      {
      case 4: 
      case 6: 
      ...
      case 5: 
        for (;;)
        {
          ...
          return;
          i = paramContext.getResources().getDimensionPixelSize(2131297048);
          paramInt = paramContext.getResources().getDimensionPixelSize(2131297046);
          ...
          paramInt -= j;
          continue;
          i = paramContext.getResources().getDimensionPixelSize(2131297051);
          paramInt = paramContext.getResources().getDimensionPixelSize(2131297049);
          continue;
          i = paramContext.getResources().getDimensionPixelSize(2131297052);
          paramInt = paramContext.getResources().getDimensionPixelSize(2131297050);
          continue;
          k = paramContext.getResources().getDimensionPixelSize(2131297048);
          i = paramContext.getResources().getDimensionPixelSize(2131297047);
          paramInt = i;
          if (paramBoolean) {
            paramInt = i + bgtn.a(8.0F);
          }
          paramTextView.measure(0, 0);
    ...
    paramTextView.setMargins(0, 0, paramContext.getResources().getDimensionPixelSize(2131297053), 0);
  }
  ...
  public static void a(TextView paramTextView, int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString)
  {
    ...
    for (;;)
    {
      if ((TextUtils.isEmpty(paramString)) && (paramInt1 == 0) && (paramInt2 == 0))
      {
        ...
        paramString = "";
        paramInt1 = 2130850388;
        paramInt2 = 0;
        break;
        if (paramInt3 > 0) {}
        for (paramInt2 = paramInt3;; paramInt2 = 2130850392)
        {
          paramString = "NEW";
          paramInt1 = 0;
          break;
      ...
      Object localObject = paramTextView.getTag(2131380256);
      ...
      for (;;)
      {
        ...
        if (!bgjw.a(paramTextView.getText().toString(), paramString))
        {
        ...
        paramTextView.setTag(2131380256, Integer.valueOf(paramInt1));
        paramTextView.setText(paramString);
