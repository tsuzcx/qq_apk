...
public class noo
{
  public static int a(QQAppInterface paramQQAppInterface, String paramString, AccountDetail paramAccountDetail)
  {
    ...
    {
      return i;
      i = sgj.a(((AccountDetail)localObject).accountFlag);
      break;
      i = 3;
      continue;
      i = 4;
      if (sgj.a(((AccountDetail)localObject).accountFlag2) == -8L)
      {
        i = 8;
        continue;
        i = 5;
  ...
  public static void a(ArticleInfo paramArticleInfo)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject2).put("folder_status", onk.d);
      ((JSONObject)localObject2).put("feeds_source", onk.c(paramArticleInfo));
      ((JSONObject)localObject2).put("rowkey", paramArticleInfo.innerUniqueID);
      ((JSONObject)localObject2).put("feeds_type", "" + onk.a(paramArticleInfo));
      ((JSONObject)localObject2).put("kandian_mode", "" + onk.e());
      ((JSONObject)localObject2).put("tab_source", "" + onk.d());
      ...
      ((JSONObject)localObject2).put("mark_type", "" + onk.a(paramArticleInfo));
    ...
    if ((rap.a(paramArticleInfo)) || (rap.i(paramArticleInfo)) || (rap.j(paramArticleInfo)) || (rap.k(paramArticleInfo)))
    {
      ...
      a(null, onk.c(paramArticleInfo), str2, str2, 0, 0, String.valueOf(paramArticleInfo.mFeedId), (String)localObject2, "" + paramArticleInfo.mStrategyId, (String)localObject1, false);
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    if ((i != 2) && (sgj.a(paramQQAppInterface, paramString) != -7)) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    ...
    axqw.b(paramQQAppInterface, "dc01160", "Pb_account_lifeservice", paramString1, paramString2.toUpperCase(), paramString3.toUpperCase(), paramInt1, paramInt2, paramString4, paramString5, paramString6, paramString7);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt1, int paramInt2, String paramString6, String paramString7, String paramString8, String paramString9)
  {
    ...
    axqw.b(paramQQAppInterface, paramString1, paramString2, paramString3, paramString4, paramString5, paramInt1, paramInt2, paramString6, paramString7, paramString8, paramString9);
    axqw.b(paramQQAppInterface, "dc01160", "Pb_account_lifeservice", paramString3, paramString4.toUpperCase(), paramString5.toUpperCase(), paramInt1, paramInt2, paramString6, paramString7, paramString8, paramString9);
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    axrl.a(BaseApplication.getContext()).a(str, paramString1, true, 0L, 0L, localHashMap, "");
    if (QLog.isColorLevel()) {
  ...
  private static String b(String paramString)
  {
    try
    {
      ...
      ((JSONObject)localObject).put("version_standard", "8.2.8");
