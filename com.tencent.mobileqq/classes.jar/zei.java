  ...
  implements zjl
{
  ...
  private bjwa jdField_a_of_type_Bjwa;
  ...
  {
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView = ((VideoPlayerView)paramView.findViewById(2131380969));
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131370169);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131369772);
    ...
    this.jdField_a_of_type_Bjwa = new bjwa(a(), new zep(this, null));
  ...
  private void q()
  {
    this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(new zej(this));
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setPreviewVideoClickListener(new zek(this));
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setNextVideoClickListener(new zel(this));
    if (a() != null) {
      a().a(new zem(this));
    }
    a().addOnItemTouchListener(new zen(this));
    this.jdField_a_of_type_ComTencentBizSubscribeWidgetSubscribeFollowInfoView.setOnTouchListener(new zeo(this));
  }
  ...
  public zds a()
  {
    return (zds)a().a("RELATIVE_ADAPTER_UNIQUE_KEY");
  }
  ...
  protected void a(CertifiedAccountRead.StGetFeedDetailRsp paramStGetFeedDetailRsp, boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView != null) && (paramStGetFeedDetailRsp != null) && (zbh.a(paramStGetFeedDetailRsp.type.get())))
    {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    if ((!bbyp.b()) && (this.jdField_a_of_type_ComTencentWidgetImmersiveSystemBarCompact != null)) {
    ...
    this.jdField_a_of_type_ComTencentBizSubscribeWidgetSubscribeFollowInfoView = ((SubscribeFollowInfoView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131370122));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369163));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369363));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369407));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369226));
    if (a() != null)
    {
      LiuHaiUtils.a(a());
  ...
  {
    if (("share_key_continue_feeds".equals(paramString)) && (paramyzn != null) && (this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView != null)) {
      this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setContinueFeeds((List)paramyzn.a);
    }
  }
  ...
  public void d(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    do
    {
      do
      {
        ...
        zxp.a(paramStFeed.poster.id.get(), "auth_" + zlv.a(a()), "clk_recom", 0, 0, new String[] { "", "", paramStFeed.id.get(), paramStFeed.title.get() });
      ...
      b("share_key_subscribe_feeds_update", new yzn(paramStFeed, true));
    } while (a() == null);
