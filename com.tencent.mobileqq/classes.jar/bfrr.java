...
public class bfrr
{
  ...
  public static SpannableString a(Resources paramResources, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (!bgiz.a(((AppInterface)localObject).getApp(), paramInt1)) {
      bgiz.a((QQAppInterface)localObject, paramInt1, null, false);
    }
    boolean bool = ThemeUtil.isNowThemeIsNight(null, false, null);
    if (paramInt2 == 0)
    {
      localObject = new SpannableString("*");
      paramInt2 = (int)paramResources.getDimension(2131298432);
      paramResources = paramResources.getDrawable(2130845753);
      paramResources = VasApngUtil.getOptimizedApngDrawable(bfrj.a(paramInt1, bfrj.a), paramResources, VasApngUtil.VIP_APNG_TAGS, "halfStar");
    ...
    for (;;)
    {
      ...
      paramInt3 = (int)paramResources.getDimension(2131298432);
      paramInt2 = 0;
      if (paramInt2 < str1.length())
      {
        ...
        {
          localObject = paramResources.getDrawable(2130845751);
          localObject = VasApngUtil.getOptimizedApngDrawable(bfrj.a(paramInt1, bfrj.e), (Drawable)localObject, VasApngUtil.VIP_APNG_TAGS, "crown");
          label452:
          if (localObject != null)
          {
            if (!"&".equalsIgnoreCase(str2)) {
        ...
        for (;;)
        {
          ...
          if ("@".equalsIgnoreCase(str2))
          {
            localObject = paramResources.getDrawable(2130845755);
            localObject = VasApngUtil.getOptimizedApngDrawable(bfrj.a(paramInt1, bfrj.d), (Drawable)localObject, VasApngUtil.VIP_APNG_TAGS, "sun");
            break label452;
          }
          if ("#".equalsIgnoreCase(str2))
          {
            localObject = paramResources.getDrawable(2130845752);
            localObject = VasApngUtil.getOptimizedApngDrawable(bfrj.a(paramInt1, bfrj.c), (Drawable)localObject, VasApngUtil.VIP_APNG_TAGS, "moon");
            break label452;
          }
          if ("%".equalsIgnoreCase(str2))
          {
            localObject = paramResources.getDrawable(2130845754);
            localObject = VasApngUtil.getOptimizedApngDrawable(bfrj.a(paramInt1, bfrj.b), (Drawable)localObject, VasApngUtil.VIP_APNG_TAGS, "star");
            break label452;
          }
          if ("$".equalsIgnoreCase(str2))
          {
            localObject = paramResources.getDrawable(2130850685);
            break label452;
          }
          localObject = null;
          break label452;
  ...
  public static SpannableString a(View paramView, Resources paramResources, long paramLong, int paramInt, boolean paramBoolean)
  {
    ...
    for (localObject = bghc.a().a(((QQAppInterface)localObject).getCurrentUin(), paramLong, paramInt, paramBoolean);; localObject = "")
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        if (((URLDrawable)localObject).getStatus() == 1) {
          ((URLDrawable)localObject).setBounds(0, 0, UIUtils.dip2px(BaseApplicationImpl.getContext(), 47.0F), UIUtils.dip2px(BaseApplicationImpl.getContext(), 14.0F));
        }
      }
      for (;;)
      {
        if (localObject != null)
        {
          ((URLDrawable)localObject).setURLDrawableListener(new bfrs(paramView));
          localSpannableString.setSpan(new ImageSpan((Drawable)localObject), 0, 1, 33);
          paramView = paramResources.getDrawable(2130845776);
          paramView.setBounds(0, 0, (int)paramResources.getDimension(2131297224), UIUtils.dip2px(BaseApplicationImpl.getContext(), 5.0F));
  ...
  public static SpannableString a(View paramView, Resources paramResources, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    paramView = null;
    int i = (int)paramResources.getDimension(2131297253);
    ...
    if ((paramBoolean1) && (paramInt > 0))
    {
      ...
      localDrawable = paramResources.getDrawable(2130846977);
    ...
    for (;;)
    {
      ...
      {
        paramView.mutate();
        ((URLDrawable)paramView).setURLDrawableListener(new bfrt(localWeakReference));
        localSpannableString.setSpan(new ImageSpan(paramView), 0, 1, 33);
        paramView = paramResources.getDrawable(2130845776);
        paramView.setBounds(0, 0, (int)paramResources.getDimension(2131297224), i);
        localSpannableString.setSpan(new ImageSpan(paramView), 1, 2, 33);
      }
      if (QLog.isDevelopLevel()) {
      ...
      if ((paramBoolean2) && (paramInt > 0))
      {
        ...
        localDrawable = paramResources.getDrawable(2130846978);
        paramView = URLDrawable.getDrawable(paramView, localDrawable, localDrawable);
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    boolean bool = SettingCloneUtil.readValue((Context)localObject2, null, ((Context)localObject2).getString(2131694557), "qqsetting_auto_receive_pic_key", true);
    int i;
    Object localObject3;
    if (bool)
    {
      ...
      localObject3 = (baoy)paramQQAppInterface.getManager(15);
      if (localObject3 != null)
      {
        bool = ((baoy)localObject3).b();
        if (!bool) {
          break label1197;
        }
        i = 1;
        ...
        if (!ampt.a(paramQQAppInterface, false)) {
          break label1202;
        }
        i = 1;
        label108:
        ((Map)localObject1).put("Download_new", Integer.valueOf(i));
        if (!SettingCloneUtil.readValue((Context)localObject2, null, ((Context)localObject2).getString(2131718212), "qqsetting_notify_icon_key", false)) {
          break label1207;
        }
        i = 1;
        label146:
        ((Map)localObject1).put("System_icon", Integer.valueOf(i));
        if (!SettingCloneUtil.readValue((Context)localObject2, null, paramQQAppInterface.getApp().getString(2131694542), "qqsetting_enter_sendmsg_key", false)) {
          break label1212;
        }
        i = 1;
        label186:
        ...
        if (!awka.b(paramQQAppInterface.getAccount())) {
          break label1237;
        }
        i = 1;
        label322:
    ...
    for (;;)
    {
      try
      {
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          bcef.b(paramQQAppInterface, "CliStatus", "", "", "Setting_tab", (String)localObject3, 0, 0, String.valueOf(((Map)localObject1).get(localObject3)), "", "", "");
          continue;
        }
        if (!SettingCloneUtil.readValue(paramQQAppInterface.getApp(), null, paramQQAppInterface.getApp().getString(2131694546), "qqsetting_screenshot_key", false)) {
          break label1292;
        }
        i = 1;
        bcef.b(paramQQAppInterface, "CliStatus", "", "", "Setting_tab", "Shake_screenshot_switch", 0, 0, String.valueOf(i), "", "", "");
        if (!paramQQAppInterface.getVisibilityForNetWorkStatus(false)) {
          break label1297;
        }
        i = 1;
        bcef.b(paramQQAppInterface, "CliStatus", "", "", "0X80044D1", "0X80044D1", 0, 0, String.valueOf(i), "", "", "");
        localObject1 = ((amsw)paramQQAppInterface.getManager(51)).b(paramQQAppInterface.getCurrentAccountUin());
        if (localObject1 != null)
        {
          ...
          i = 1;
          bcef.b(paramQQAppInterface, "CliStatus", "", "", "0X8004884", "0X8004884", 0, 0, String.valueOf(i), "", "", "");
        }
        if (!HotChatManager.b(paramQQAppInterface)) {
          break label1307;
        }
        i = 1;
        bcef.b(paramQQAppInterface, "CliStatus", "", "", "0X8004B1E", "0X8004B1E", 0, 0, String.valueOf(i), "", "", "");
        if (!paramQQAppInterface.getNotAllowedSeeMyDongtai(false)) {
          break label1312;
        }
        i = 1;
        bcef.b(paramQQAppInterface, "CliStatus", "", "", "0X8004C5C", "0X8004C5C", 0, 0, String.valueOf(i), "", "", "");
        if (!paramQQAppInterface.getShieldHisDongtai(false)) {
          break label1317;
        }
        i = 1;
        bcef.b(paramQQAppInterface, "CliStatus", "", "", "0X8004C5D", "0X8004C5D", 0, 0, String.valueOf(i), "", "", "");
        localObject3 = (amsw)paramQQAppInterface.getManager(51);
        i = ((amsw)localObject3).c();
        if (i <= 0) {
          break label1322;
        }
        localObject1 = "1";
        if (i > 0)
        {
          ...
          bcef.b(paramQQAppInterface, "CliStatus", "", "", "0X8004C69", "0X8004C69", 0, 0, (String)localObject1, (String)localObject2, String.valueOf(((amsw)localObject3).b()), "");
          if (((aneo)paramQQAppInterface.getManager(85)).a(false))
          {
            i = 1;
            bcef.b(paramQQAppInterface, "CliStatus", "", "", "0X8004E0C", "0X8004E0C", 0, i, String.valueOf(i), "", "", "");
            if (!paramQQAppInterface.isCallTabShow) {
              continue;
            }
            i = 1;
            bcef.b(paramQQAppInterface, "CliStatus", "", "", "0X8004EDE", "0X8004EDE", 0, 0, String.valueOf(i), "", "", "");
            localObject1 = ((airj)paramQQAppInterface.getManager(295)).a();
            ...
            localObject2 = (aire)((Iterator)localObject1).next();
            int j = ((aire)localObject2).a;
            if (!((aire)localObject2).e) {
              continue;
            }
            i = 2;
            bcef.b(paramQQAppInterface, "CliStatus", "", "", "0X80097A1", "0X80097A1", j, 0, String.valueOf(i), "", "", "");
            continue;
          }
        }
        else
