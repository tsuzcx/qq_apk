...
public final class qzm
{
  private final void a(Readinjoy.ArticleSummary paramArticleSummary, WeiShiVideoArticleInfo paramWeiShiVideoArticleInfo)
  {
    if (paramArticleSummary.msg_video_data.has())
    {
      ...
      paramArticleSummary.jdField_a_of_type_JavaLangString = pnq.a(paramWeiShiVideoArticleInfo);
      ...
      paramArticleSummary.jdField_b_of_type_JavaLangString = pnq.a(paramWeiShiVideoArticleInfo);
    }
  }
  ...
  private final void a(oidb_cmd0xbed.ArticleSummary paramArticleSummary, WeiShiVideoArticleInfo paramWeiShiVideoArticleInfo)
  {
    if (paramArticleSummary.rpt_article_list.has())
    {
      ...
      if (i < m)
      {
        ...
        SimpleChannelInfo localSimpleChannelInfo = rwq.a(paramArticleSummary.msg_channel_info);
        int j;
        ...
        {
          localObject = (BaseVideoArticleInfo)rwq.a((oidb_cmd0xbed.ArticleSummary)localObject, j, k);
          if (localObject != null) {
  ...
  private final void b(oidb_cmd0xbed.ArticleSummary paramArticleSummary, WeiShiVideoArticleInfo paramWeiShiVideoArticleInfo)
  {
    if (paramArticleSummary.rpt_label_list.has())
    {
      ...
      {
        SimpleChannelInfo localSimpleChannelInfo = rwq.a((oidb_cmd0xbed.ChannelInfo)paramArticleSummary.next());
        if (localSimpleChannelInfo != null) {
  ...
  private final void c(Readinjoy.ArticleSummary paramArticleSummary, WeiShiVideoArticleInfo paramWeiShiVideoArticleInfo)
  {
    if (paramArticleSummary.rpt_label_list.has())
    {
      ...
      while (paramArticleSummary.hasNext())
      {
        ...
        paramWeiShiVideoArticleInfo.labelList.add(rwq.a(localChannelInfo));
      }
    }
  }
  ...
  public final WeiShiVideoArticleInfo a(@Nullable Readinjoy.ArticleSummary paramArticleSummary)
  {
    ...
    try
    {
      ...
      localWeiShiVideoArticleInfo.rowkey = pnq.a(localPBBytesField);
      ...
      for (;;)
      {
        ...
        localWeiShiVideoArticleInfo.title = pnq.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.summary = pnq.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.pagePicUrl = pnq.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.articleContentUrl = pnq.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.subscribeName = pnq.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.subscribeIcon = pnq.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.subscribeID = pnq.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.recommendReason = pnq.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.pushContext = pnq.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.adsJumpUrl = pnq.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.videoReportInfo = pnq.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.businessInfo = pnq.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.videoSubscriptTxt = pnq.a(localPBBytesField);
        ...
        localWeiShiVideoArticleInfo.videoSubscriptColor = pnq.a(localPBBytesField);
        ((qzm)this).c(paramArticleSummary, localWeiShiVideoArticleInfo);
        ((qzm)this).b(paramArticleSummary, localWeiShiVideoArticleInfo);
        ((qzm)this).a(paramArticleSummary, localWeiShiVideoArticleInfo);
    ...
    if (paramArticleSummary != null)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          Intrinsics.checkExpressionValueIsNotNull(localPBBytesField, "summary.bytes_video_subscript_color");
          localWeiShiVideoArticleInfo.videoSubscriptColor = pnq.a(localPBBytesField);
          ((qzm)this).d(paramArticleSummary, localWeiShiVideoArticleInfo);
          ((qzm)this).c(paramArticleSummary, localWeiShiVideoArticleInfo);
          ((qzm)this).b(paramArticleSummary, localWeiShiVideoArticleInfo);
          ((qzm)this).a(paramArticleSummary, localWeiShiVideoArticleInfo);
        }
        catch (Throwable paramArticleSummary)
        {
          ...
          QLog.e("VideoProtoHelper", 0, "cmd0xbedToWeiShiVideoArticleInfo error:" + ozs.a(paramArticleSummary));
          continue;
        }
        return localWeiShiVideoArticleInfo;
        bool = false;
