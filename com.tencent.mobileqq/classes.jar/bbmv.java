...
public class bbmv
{
  ...
  private final bbmo jdField_a_of_type_Bbmo;
  private final brfy jdField_a_of_type_Brfy;
  private final String jdField_a_of_type_JavaLangString;
  private ByteBuffer jdField_a_of_type_JavaNioByteBuffer;
  private final List<bbmx> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public bbmv(brfy parambrfy, String paramString, bbmo parambbmo)
  {
    this.jdField_a_of_type_Brfy = parambrfy;
  ...
  private void b()
  {
    ...
    bbmx localbbmx;
    for (int i = 0; localIterator.hasNext(); i = bbmx.b(localbbmx) + i)
    {
      localbbmx = (bbmx)localIterator.next();
      bbmx.a(localbbmx, localBufferInfo, i);
      this.jdField_a_of_type_AndroidMediaMediaMuxer.writeSampleData(a(bbmx.a(localbbmx)), this.jdField_a_of_type_JavaNioByteBuffer, localBufferInfo);
    }
  ...
  public void a()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Brfy.a())
      {
  ...
  public void a(int paramInt, ByteBuffer paramByteBuffer, MediaCodec.BufferInfo paramBufferInfo)
  {
    try
    {
      ...
      this.jdField_a_of_type_JavaUtilList.add(new bbmx(paramInt, paramBufferInfo.size, paramBufferInfo, null));
      return;
    }
