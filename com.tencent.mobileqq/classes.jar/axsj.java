...
public class axsj
{
  ...
  public axsj(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Axsn = new axsn();
  ...
  protected View a()
  {
    ...
    this.jdField_a_of_type_Axsn.a((RelativeLayout)localView.findViewById(2131362143));
    ...
    for (int j = 0;; j = 1)
    {
      ...
      for (int k = 0;; k = 1)
      {
        ...
        for (;;)
        {
          ...
          ((GridView)localObject4).setAdapter(new axsl(this.jdField_a_of_type_AndroidContentContext, (List)localObject1));
          ...
          for (;;)
          {
            ...
            ((GridView)localObject1).setNumColumns(i);
            ((GridView)localObject1).setAdapter(new axsl(this.jdField_a_of_type_AndroidContentContext, (List)localObject2));
            ...
            ((TextView)localObject1).setOnClickListener(new axsk(this));
            if (j == 0) {
