  ...
  implements axrt
{
  ...
  apba jdField_a_of_type_Apba = null;
  axro jdField_a_of_type_Axro = null;
  axrr jdField_a_of_type_Axrr = null;
  bess jdField_a_of_type_Bess = null;
  ...
  public apbb(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, long paramLong, apba paramapba)
  {
    this.jdField_a_of_type_Axrr = paramQQAppInterface.getNetEngine(0);
    this.jdField_a_of_type_Apba = paramapba;
    paramapba = new ArrayList(1);
    paramapba.add(paramString1);
    this.jdField_a_of_type_Aojs = new aojs(paramQQAppInterface, paramapba, "/ftn_handler");
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Axrr.b(this.jdField_a_of_type_Axro);
  ...
  public void a(long paramLong)
  {
    ...
    localaxro.jdField_a_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
    localaxro.jdField_a_of_type_Int = 1;
    localaxro.jdField_a_of_type_JavaUtilHashMap.put("Accept-Encoding", "identity");
    localaxro.e = this.jdField_d_of_type_JavaLangString;
    try
    {
      byte[] arrayOfByte = a(paramLong);
      arrayOfByte = this.jdField_a_of_type_Apba.a(arrayOfByte, paramLong);
      if (arrayOfByte == null) {
        return;
      }
      localaxro.jdField_a_of_type_ArrayOfByte = arrayOfByte;
      this.jdField_a_of_type_Axro = localaxro;
      localaxro.jdField_a_of_type_Axtz = apck.a();
  ...
  byte[] a(long paramLong)
  {
    ...
    //   6: aload_0
    //   7: lconst_0
    //   8: putfield 50	apbb:jdField_b_of_type_Long	J
    //   11: aload_0
    //   12: getfield 48	apbb:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   15: ifnonnull +23 -> 38
    //   18: aload_0
    //   19: new 213	java/io/FileInputStream
    //   22: dup
    //   23: aload_0
    //   24: getfield 40	apbb:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   27: invokespecial 214	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   30: putfield 48	apbb:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   33: aload_0
    //   34: lconst_0
    //   35: putfield 70	apbb:jdField_c_of_type_Long	J
    //   38: lload_1
    //   39: lconst_0
    //   40: lcmp
    //   41: ifne +113 -> 154
    //   44: aload_0
    //   45: getfield 70	apbb:jdField_c_of_type_Long	J
    //   48: lconst_0
    //   49: lcmp
    //   50: ifeq +23 -> 73
    //   53: aload_0
    ...
    //   57: dup
    //   58: aload_0
    //   59: getfield 40	apbb:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   62: invokespecial 214	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   65: putfield 48	apbb:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   68: aload_0
    //   69: lconst_0
    //   70: putfield 70	apbb:jdField_c_of_type_Long	J
    //   73: aload_0
    //   74: lload_1
    //   75: putfield 70	apbb:jdField_c_of_type_Long	J
    //   78: aload_0
    //   79: getfield 42	apbb:jdField_a_of_type_Bess	Lbess;
    //   82: aload_0
    //   83: getfield 46	apbb:jdField_a_of_type_Long	J
    //   86: aload_0
    //   87: getfield 50	apbb:jdField_b_of_type_Long	J
    //   90: lload_1
    //   91: invokestatic 219	apbc:a	(Lbess;JJJ)I
    //   94: istore_3
    //   95: iload_3
    //   96: newarray byte
    //   98: astore 4
    //   100: aload_0
    //   101: getfield 48	apbb:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   104: aload 4
    //   106: iconst_0
    //   107: iload_3
    ...
    //   112: aload_0
    //   113: aload_0
    //   114: getfield 70	apbb:jdField_c_of_type_Long	J
    //   117: iload_3
    //   118: i2l
    //   119: ladd
    //   120: putfield 70	apbb:jdField_c_of_type_Long	J
    //   123: aload 4
    //   125: areturn
    //   126: astore 4
    //   128: aload_0
    //   129: aconst_null
    //   130: putfield 48	apbb:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   133: aload 4
    ...
    //   142: aload_0
    //   143: aconst_null
    //   144: putfield 48	apbb:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   147: aload 4
    ...
    //   154: lload_1
    //   155: aload_0
    //   156: getfield 70	apbb:jdField_c_of_type_Long	J
    //   159: lcmp
    //   160: ifle +29 -> 189
    //   163: aload_0
    //   164: getfield 48	apbb:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   167: lload_1
    //   168: aload_0
    //   169: getfield 70	apbb:jdField_c_of_type_Long	J
    //   172: lsub
    ...
    //   189: lload_1
    //   190: aload_0
    //   191: getfield 70	apbb:jdField_c_of_type_Long	J
    //   194: lcmp
    //   195: ifge -122 -> 73
    //   198: aload_0
    ...
    //   202: dup
    //   203: aload_0
    //   204: getfield 40	apbb:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   207: invokespecial 214	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   210: putfield 48	apbb:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   213: aload_0
    //   214: lconst_0
    //   215: putfield 70	apbb:jdField_c_of_type_Long	J
    //   218: aload_0
    //   219: getfield 48	apbb:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   222: lload_1
    ...
    //   232: aload_0
    //   233: aconst_null
    //   234: putfield 48	apbb:jdField_a_of_type_JavaIoInputStream	Ljava/io/InputStream;
    //   237: aload 4
  ...
  public void onResp(axsq paramaxsq)
  {
    ...
    do
    {
      return;
      if (QLog.isColorLevel()) {
        QLog.d("OfflineFileHttpUploder<FileAssistant>", 4, "logID[" + this.jdField_d_of_type_JavaLangString + "]onResp result:" + paramaxsq.jdField_a_of_type_Int + " errCode:" + paramaxsq.jdField_b_of_type_Int + " errDesc:" + paramaxsq.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_Axro = null;
      i = paramaxsq.jdField_c_of_type_Int;
      if ((paramaxsq.jdField_b_of_type_Int == 9364) && (this.jdField_b_of_type_Int < 3))
      {
        ...
        this.jdField_a_of_type_Bess.a();
        if (this.jdField_a_of_type_Apba != null) {
          this.jdField_a_of_type_Apba.a(true);
        }
        a(this.jdField_b_of_type_Long);
        return;
      }
      if ((aopg.a(paramaxsq.jdField_b_of_type_Int)) && (this.jdField_a_of_type_Aojs != null))
      {
      ...
      if ((i == 200) && (paramaxsq.jdField_a_of_type_Int == 0)) {
        break;
      }
      if ((paramaxsq.jdField_a_of_type_Int == 9056) && (this.f < 5))
      {
        this.f += 1;
        a(this.jdField_b_of_type_Long);
        return;
    ...
    QLog.e("OfflineFileHttpUploder<FileAssistant>", 1, "logID[" + this.jdField_d_of_type_JavaLangString + "]httpRetCode:" + i + "]onResp result:" + paramaxsq.jdField_a_of_type_Int + " errCode:" + paramaxsq.jdField_b_of_type_Int + " errDesc:" + paramaxsq.jdField_a_of_type_JavaLangString);
    return;
    this.f = 0;
    this.jdField_a_of_type_Bess.b();
    String str = (String)paramaxsq.jdField_a_of_type_JavaUtilHashMap.get("User-ReturnCode");
    if (str != null) {}
    for (long l = Long.parseLong(str);; l = 0L)
    {
      ...
      l = this.jdField_a_of_type_Apba.a(paramaxsq);
      if (l == -1L)
      {
      ...
      {
        paramaxsq = "RangSizeError_rangError tSize[" + String.valueOf(l) + "]<=mSize[" + String.valueOf(this.jdField_b_of_type_Long) + "],reTryafter[" + String.valueOf(this.jdField_d_of_type_Int) + "]";
        QLog.w("OfflineFileHttpUploder<FileAssistant>", 1, "nSessionId[" + this.jdField_d_of_type_JavaLangString + "]" + paramaxsq);
      ...
      this.jdField_a_of_type_Apba.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_Long);
      a(l);
      return;
    }
  }
