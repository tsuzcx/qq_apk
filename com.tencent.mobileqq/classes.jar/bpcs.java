  ...
  implements bpcu
{
  ...
  public bpcs(@NonNull bpep parambpep, int paramInt)
  {
    super(parambpep);
    ...
    {
      wnh.a().a("EditVideoDTextFace.mSrcFrom", this.jdField_a_of_type_JavaLangString);
      return;
    }
  }
  ...
  private void j()
  {
    ...
    QQToast.a(a(), a().getString(2131697515), 0).a();
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_JavaUtilList = boqj.a(0);
    if (TextUtils.isEmpty(this.b)) {
      this.b = anni.a(2131702614);
    }
    boqj.a(0, Collections.singletonList(this.b));
    this.jdField_a_of_type_Bpep.a().a().postDelayed(new EditVideoDTextFace.1(this, localDynamicTextConfigManager), 1000L);
  }
      ...
      do
      {
        do
        {
          do
          {
            ...
            paramObject = (bozw)a(bozw.class);
          } while (paramObject == null);
          paramObject = paramObject.a();
        } while (paramObject == null);
        localbpic = paramObject.a();
      } while (localbpic == null);
      paramInt1 = 0;
      if (localbpic.a != null) {
  ...
  public void a(int paramInt, @NonNull bpsf parambpsf)
  {
    ...
    parambpsf = ((bozw)a(bozw.class)).a().a();
    int i = parambpsf.a.size();
    StringBuilder localStringBuilder = new StringBuilder();
    paramInt = 0;
    while (paramInt < i)
    {
      localStringBuilder.append(((bpif)parambpsf.a.get(paramInt)).a.c() + 1);
      if (paramInt < i - 1) {
        localStringBuilder.append(",");
      }
      paramInt += 1;
    }
    yqu.a("video_edit_text", "pub_withText", 0, 0, new String[] { this.jdField_a_of_type_JavaLangString, localStringBuilder.toString(), String.valueOf(i), "" });
  }
  ...
  public void g()
  {
    ...
    {
      InputMethodManager localInputMethodManager = (InputMethodManager)this.jdField_a_of_type_Bpfx.getActivity().getSystemService("input_method");
      if ((localInputMethodManager != null) && (localInputMethodManager.isActive())) {
        localInputMethodManager.hideSoftInputFromWindow(this.jdField_a_of_type_Bpfx.a().getWindowToken(), 0);
      }
    }
    super.g();
    boqj.a(0, this.jdField_a_of_type_JavaUtilList);
  }
  ...
  public void i()
  {
    if ((this.jdField_a_of_type_AndroidViewView != null) && (this.jdField_a_of_type_AndroidViewView.getVisibility() == 8))
    {
      ...
      yqu.a("video_edit_text", "exp_textWording", 0, 0, new String[] { this.jdField_a_of_type_JavaLangString, "", "", "" });
