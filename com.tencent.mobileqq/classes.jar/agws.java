...
public class agws
  implements Runnable
{
  public agws(ReportBadCase paramReportBadCase, BadcaseReportUtils.BadDataFrame paramBadDataFrame) {}
  ...
  public void run()
  {
    ...
    synchronized (ReportBadCase.a())
    {
      ...
      if (i == 3) {
        ThreadManager.postDownLoadTask(new agwt(this), 5, null, true);
      }
      return;
      str2 = finally;
      throw str2;
