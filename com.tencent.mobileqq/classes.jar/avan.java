  ...
  extends aval
{
  ...
  public avan(bhpc parambhpc, QQAppInterface paramQQAppInterface)
  {
    super(parambhpc);
  ...
  private void a(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage instanceof MessageForMixedMsg))
    {
      ...
      if (paramChatMessage.msgElemList != null)
      {
        ...
        while (paramChatMessage.hasNext())
        {
          ...
          if ((localObject2 instanceof MessageForText))
          {
            ...
            ((AnimationTextView)localObject1).setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165653));
            ((AnimationTextView)localObject1).setSpannableFactory(begp.a);
            if (!TextUtils.isEmpty(((MessageForText)localObject2).sb2)) {
              ((AnimationTextView)localObject1).setText(new begp(((MessageForText)localObject2).sb2.toString(), 5, 20));
            }
            for (;;)
            {
              ...
              if (!TextUtils.isEmpty(((MessageForText)localObject2).sb)) {
                ((AnimationTextView)localObject1).setText(new begp(((MessageForText)localObject2).sb.toString(), 5, 20));
              } else if (!TextUtils.isEmpty(((MessageForText)localObject2).msg)) {
                ((AnimationTextView)localObject1).setText(new begp(((MessageForText)localObject2).msg, 5, 20));
              }
            }
          }
          if ((localObject2 instanceof MessageForPic))
          {
            ...
            localObject2 = ahng.a(this.jdField_a_of_type_AndroidContentContext, (MessageForPic)localObject3);
            ((ImageView)localObject1).setMaxWidth(besm.a(ahng.a((MessageForPic)localObject3)));
            ((ImageView)localObject1).setMaxHeight(besm.a(ahng.a((MessageForPic)localObject3)));
            if (localObject2 != null)
            {
              if (((((URLDrawable)localObject2).getCurrDrawable() instanceof RoundRectDrawable)) && (a()))
              {
                ...
                ((ImageView)localObject1).setImageDrawable(new ascz(0, ((RoundRectDrawable)localObject3).getIntrinsicWidth(), ((RoundRectDrawable)localObject3).getIntrinsicHeight()));
          ...
          else if ((localObject2 instanceof MessageForReplyText))
          {
            ...
            {
              ((AnimationTextView)localObject1).setText(new begp(((MessageForReplyText)localObject2).sb.toString(), 5, 20));
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout.getViewTreeObserver().addOnGlobalLayoutListener(new avao(this));
    }
  }
  ...
  private void f()
  {
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout.getHeight() >= bhtq.a(this.jdField_a_of_type_Int + 1))
    {
      this.jdField_a_of_type_ComTencentWidgetMaxHeightRelativelayout.setMaxHeight(bhtq.a(450.0F));
  ...
  protected int a()
  {
    if (this.jdField_a_of_type_Int == 0) {
      this.jdField_a_of_type_Int = ((int)((this.jdField_a_of_type_Bhpc.getRootViewHeight() - this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131297056)) / bhtq.a));
    }
