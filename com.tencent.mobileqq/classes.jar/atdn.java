  ...
  extends ajfb
{
  ...
  public atdn(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(int paramInt, Intent paramIntent, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      for (paramIntent = Integer.toString(j);; paramIntent = i + "_" + j)
      {
        ...
        awrn.a(this.mApp.getApplication()).a(this.app.getCurrentAccountUin(), "ocrTextSearch", bool, l, 0L, paramArrayOfByte, "");
        if (QLog.isColorLevel()) {
  ...
  private void a(Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      Object localObject4 = axpy.a().b(l1);
      Object localObject5 = axpy.a().a(l1);
      ...
      try
      {
        ...
        ((axro)localObject1).jdField_a_of_type_ArrayOfByte = ((byte[])localObject5);
        ((axro)localObject1).jdField_a_of_type_Axrt = new atdo(this, paramIntent, (byte[])localObject2, (String)localObject3);
        ((axro)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject4);
        ((axro)localObject1).jdField_a_of_type_Int = 1;
        ((axro)localObject1).f = 57;
        ((axro)localObject1).jdField_a_of_type_JavaUtilHashMap.put("Accept-Encoding", "identity");
        ((axro)localObject1).jdField_c_of_type_Int = 2;
        ((axro)localObject1).jdField_c_of_type_Long = 15000L;
        paramIntent = BaseApplicationImpl.sApplication.getRuntime();
        if ((paramIntent instanceof AppInterface))
        {
          ((AppInterface)paramIntent).getNetEngine(0).a((axsp)localObject1);
          if (QLog.isColorLevel()) {
