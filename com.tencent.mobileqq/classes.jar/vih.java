  ...
  extends vhl
{
  ...
  public vih(Activity paramActivity)
  {
    super(paramActivity);
    g();
  }
  ...
  private void j()
  {
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.setOnEditorActionListener(new vij(this));
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.addTextChangedListener(new vik(this));
  }
  ...
  private void k()
  {
    ...
    Matcher localMatcher = aagc.g.matcher(str);
    int i = 0;
    ...
    if (i >= j - 10)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(getContext().getResources().getColor(2131166246));
    }
    for (;;)
    {
      ...
      return;
      label162:
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(getContext().getResources().getColor(2131166247));
    }
  }
  ...
  private void l()
  {
    ...
    this.jdField_a_of_type_Aage.a(new vil(this));
  ...
  protected void c()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131363774));
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131363817));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380015));
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131381271));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380016));
    super.c();
    h();
  }
  ...
  protected void g()
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setCallBack(localvii);
    ...
    this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemAndEmojiEmoticonPanel = new SystemAndEmojiEmoticonPanel(this.jdField_a_of_type_AndroidAppActivity, localvii);
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      continue;
      if ((!a()) && (this.jdField_a_of_type_Vhp != null))
      {
