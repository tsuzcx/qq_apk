...
public class bgxp
{
  ...
  {
    this.jdField_a_of_type_Int = bgxr.b(paramCustomOnlineStatusMsg);
    this.jdField_a_of_type_JavaLangString = bgxr.a(paramCustomOnlineStatusMsg);
    this.b = bgxr.a(paramCustomOnlineStatusMsg);
    b();
  }
  ...
  {
    int j = this.c;
    aqws localaqws = (aqws)aqlk.a().a(479);
    if ((localaqws == null) || (localaqws.a)) {}
    for (int i = 1;; i = 0)
    {
      this.c = i;
      if (j != this.c) {
