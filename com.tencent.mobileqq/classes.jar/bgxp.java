...
public class bgxp
{
  ...
  private final bhhj jdField_a_of_type_Bhhj = new bhhj();
  private final bhhk jdField_a_of_type_Bhhk = new bhhk();
  private final bhhl jdField_a_of_type_Bhhl = new bhhl(200);
  private MiniAppInfo jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo;
  private final Runnable jdField_a_of_type_JavaLangRunnable = new MiniGamePerformanceStatics.1(this);
  private long jdField_b_of_type_Long;
  private final bhhj jdField_b_of_type_Bhhj = new bhhj();
  ...
  private void d()
  {
    ...
    this.jdField_b_of_type_Bhhj.a();
    this.jdField_a_of_type_Bhhl.a();
    this.jdField_a_of_type_Long = bgxa.a("-1");
  ...
  private void e()
  {
    ...
    if (this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo != null)
    {
      ...
      f5 = (float)(bgxa.a("-1") - this.jdField_a_of_type_Long) / ((float)l / 1000.0F);
      f6 = this.jdField_a_of_type_Bhhj.a();
      f7 = this.jdField_a_of_type_Bhhk.a() - this.jdField_a_of_type_Float;
      if (!this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo.isReportTypeMiniGame()) {
        break label365;
      }
      f3 = this.jdField_b_of_type_Bhhj.a();
      float f4 = this.jdField_a_of_type_Bhhl.a();
      bgyd.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 629, a(f5), "1");
      bgyd.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 631, a(f6), "1");
      bgyd.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 643, a(f7), "1");
      bgyd.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 630, a(f3), "1");
      bgyd.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 642, a(f4), "1");
      bgxv.a(f3, f4);
      f1 = f3;
      f2 = f4;
    ...
    {
      bgxw.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, f5, f6, f7, f1, f2);
      d();
      return;
      label365:
      bgyd.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 629, a(f5), bgyd.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo));
      bgyd.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 631, a(f6), bgyd.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo));
      bgyd.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo, 643, a(f7), bgyd.a(this.jdField_a_of_type_ComTencentQqminiSdkLauncherModelMiniAppInfo));
      if (localMiniAppProxy.isDebugVersion()) {
  ...
  {
    this.jdField_a_of_type_Bhhl.a(paramFloat);
    this.jdField_b_of_type_Bhhj.a(paramFloat);
  }
