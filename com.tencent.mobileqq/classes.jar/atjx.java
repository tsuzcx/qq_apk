...
class atjx
  implements atjp
{
  atjx(atjw paramatjw, String paramString1, String paramString2) {}
  ...
  public void onResult(boolean paramBoolean1, String paramString, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    QIPCServerHelper.getInstance().callClient(this.jdField_a_of_type_JavaLangString, "FlutterSubQIPCModule", this.b, localBundle, new atjy(this));
  }
}
