...
public class bacn
{
  public static Future<?> a(Context paramContext, Bundle paramBundle, boolean paramBoolean, baco parambaco)
  {
    ...
    return amdp.a(192).submit(new PluginUtils.1(paramContext, paramBundle, parambaco));
  }
}
