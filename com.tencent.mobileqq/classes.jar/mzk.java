...
public class mzk
  implements axay
{
  public mzk(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if (mzi.jdField_a_of_type_Boolean) {
      return null;
    }
    mzi.jdField_a_of_type_Boolean = true;
    if (QLog.isColorLevel()) {
      QLog.d(mzi.jdField_a_of_type_JavaLangString, 2, "getCheckUpdateItemData");
    }
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      localReqBody.uint32_platform.set(mzi.jdField_a_of_type_Int);
      if (QLog.isColorLevel()) {
        QLog.d(mzi.jdField_a_of_type_JavaLangString, 1, String.format("OfflineExpireCheckUpdate, check update QQ Version: %s", new Object[] { "8.3.0.4480" }));
      }
      ...
      paramInt = nao.a(((QQAppInterface)localObject).getApp());
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        catch (NumberFormatException localNumberFormatException1)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.i(mzi.jdField_a_of_type_JavaLangString, 2, "NumberFormatException:" + str);
          }
          paramInt = 0;
          continue;
        }
      ...
      return null;
      if (QLog.isColorLevel()) {
        QLog.i(mzi.jdField_a_of_type_JavaLangString, 2, "Exception:" + str);
      }
      paramInt = 0;
      continue;
    ...
    label426:
    localReqItem.vecParam = bbma.a(localReqBody.toByteArray());
    return localReqItem;
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(mzi.jdField_a_of_type_JavaLangString, 2, "handleCheckUpdateItemData");
    }
    Object localObject = BaseApplicationImpl.getApplication().getRuntime();
    if ((localObject instanceof QQAppInterface))
    {
      ...
      {
        paramRespItem = bbma.b(paramRespItem.vecUpdate);
    ...
    while (!QLog.isColorLevel()) {
      try
      {
        ...
        mzi.a(new String(localRspBody.str_expire_pkg.get().toByteArray(), "UTF-8"));
        mzi.a(new String(localRspBody.str_predown_pkg_ex.get().toByteArray(), "UTF-8"), (QQAppInterface)localObject, ((QQAppInterface)localObject).getApp().getApplicationContext(), 1);
      ...
      catch (InvalidProtocolBufferMicroException paramRespItem)
      {
        for (;;)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.i(mzi.jdField_a_of_type_JavaLangString, 2, "handleCheckUpdateItemData: " + QLog.getStackTraceString(paramRespItem));
          }
        }
      }
    ...
    QLog.d(mzi.jdField_a_of_type_JavaLangString, 2, "***handleCheckUpdateItemData fail respitem.cResult:" + paramRespItem.cResult);
  }
}
