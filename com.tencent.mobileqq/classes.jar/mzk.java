...
public class mzk
{
  ...
  public static String a()
  {
    ...
    {
      veg.d("OfflineEnvHelper", "getInnerOfflineDir, initEnv");
      a();
    }
    return c;
  }
  ...
  public static String a(String paramString)
  {
    ...
    if (a(paramString))
    {
      veg.d("OfflineEnvHelper", "getOfflineDir, isStoreInSD true");
      return b();
    }
    return a();
  }
  ...
  private static void a()
  {
    ...
    //   5: ldc 56
    //   7: iconst_1
    //   8: invokestatic 61	ayxq:a	(ILjava/lang/String;Z)Ljava/lang/String;
    //   11: astore 7
    //   13: aload 7
    ...
    //   81: ifne +128 -> 209
    //   84: getstatic 19	mzk:jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock	Ljava/util/concurrent/locks/ReentrantLock;
    ...
    //   203: getstatic 19	mzk:jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock	Ljava/util/concurrent/locks/ReentrantLock;
    ...
    //   258: ior
    //   259: ifeq +460 -> 719
    //   262: getstatic 116	mze:a	Lmzr;
    //   265: invokeinterface 138 1 0
    //   270: ifeq +16 -> 286
    //   273: getstatic 116	mze:a	Lmzr;
    //   276: ldc 118
    //   278: iconst_2
    //   279: ldc 140
    ...
    //   289: ldc 56
    //   291: iconst_0
    //   292: invokestatic 61	ayxq:a	(ILjava/lang/String;Z)Ljava/lang/String;
    //   295: astore 7
    //   297: aload 7
    ...
    //   365: ifne +131 -> 496
    //   368: getstatic 21	mzk:jdField_b_of_type_JavaUtilConcurrentLocksReentrantLock	Ljava/util/concurrent/locks/ReentrantLock;
    ...
    //   490: getstatic 21	mzk:jdField_b_of_type_JavaUtilConcurrentLocksReentrantLock	Ljava/util/concurrent/locks/ReentrantLock;
    ...
    //   545: ior
    //   546: ifeq +337 -> 883
    //   549: getstatic 116	mze:a	Lmzr;
    //   552: invokeinterface 138 1 0
    //   557: ifeq +16 -> 573
    //   560: getstatic 116	mze:a	Lmzr;
    //   563: ldc 118
    //   565: iconst_2
    //   566: ldc 157
    //   568: invokeinterface 133 4 0
    //   573: return
    //   574: getstatic 116	mze:a	Lmzr;
    //   577: invokeinterface 138 1 0
    //   582: ifeq +45 -> 627
    //   585: getstatic 116	mze:a	Lmzr;
    //   588: ldc 118
    //   590: iconst_2
    //   591: ldc 159
    ...
    //   599: istore_3
    //   600: goto -441 -> 159
    //   603: getstatic 116	mze:a	Lmzr;
    //   606: invokeinterface 138 1 0
    //   611: ifeq +16 -> 627
    //   614: getstatic 116	mze:a	Lmzr;
    //   617: ldc 118
    //   619: iconst_2
    //   620: ldc 161
    ...
    //   629: goto -470 -> 159
    //   632: astore 9
    //   634: getstatic 19	mzk:jdField_a_of_type_JavaUtilConcurrentLocksReentrantLock	Ljava/util/concurrent/locks/ReentrantLock;
    //   637: invokevirtual 136	java/util/concurrent/locks/ReentrantLock:unlock	()V
    //   640: aload 9
    //   642: athrow
    //   643: astore 9
    //   645: getstatic 116	mze:a	Lmzr;
    //   648: invokeinterface 138 1 0
    //   653: ifeq -444 -> 209
    //   656: getstatic 116	mze:a	Lmzr;
    //   659: ldc 118
    //   661: iconst_2
    ...
    //   716: goto -460 -> 256
    //   719: aload 6
    //   721: invokestatic 170	bbuv:a	(Ljava/lang/String;)Ljava/lang/String;
    //   724: putstatic 172	mzk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   727: aload 7
    //   729: invokestatic 170	bbuv:a	(Ljava/lang/String;)Ljava/lang/String;
    //   732: putstatic 174	mzk:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   735: goto -449 -> 286
    //   738: getstatic 116	mze:a	Lmzr;
    //   741: invokeinterface 138 1 0
    //   746: ifeq +45 -> 791
    //   749: getstatic 116	mze:a	Lmzr;
    //   752: ldc 118
    //   754: iconst_2
    //   755: ldc 176
    ...
    //   763: istore_3
    //   764: goto -318 -> 446
    //   767: getstatic 116	mze:a	Lmzr;
    //   770: invokeinterface 138 1 0
    //   775: ifeq +16 -> 791
    //   778: getstatic 116	mze:a	Lmzr;
    //   781: ldc 118
    //   783: iconst_2
    //   784: ldc 178
    ...
    //   793: goto -347 -> 446
    //   796: astore 9
    //   798: getstatic 21	mzk:jdField_b_of_type_JavaUtilConcurrentLocksReentrantLock	Ljava/util/concurrent/locks/ReentrantLock;
    //   801: invokevirtual 136	java/util/concurrent/locks/ReentrantLock:unlock	()V
    //   804: aload 9
    //   806: athrow
    //   807: astore 9
    //   809: getstatic 116	mze:a	Lmzr;
    //   812: invokeinterface 138 1 0
    //   817: ifeq -321 -> 496
    //   820: getstatic 116	mze:a	Lmzr;
    //   823: ldc 118
    //   825: iconst_2
    ...
    //   880: goto -337 -> 543
    //   883: aload 6
    //   885: putstatic 25	mzk:c	Ljava/lang/String;
    //   888: aload 7
    //   890: putstatic 184	mzk:d	Ljava/lang/String;
    //   893: return
  ...
  public static boolean a(String paramString)
  {
    ...
    mze.a.a("HtmlCheckUpdate", 2, "initEnv NumberFormatException");
    return true;
  }
  ...
  public static String b()
  {
    ...
    {
      veg.d("OfflineEnvHelper", "getSDOfflineDir, initEnv");
      a();
    }
