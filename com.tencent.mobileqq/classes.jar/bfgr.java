...
{
  public bfgr(QuickLoginAuthorityActivity paramQuickLoginAuthorityActivity) {}
  
  public void onFailed(String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    QLog.e("Q.quicklogin.QuickLoginAuthorityActivity", 1, "-->onFailed--action = " + paramInt1 + ", ret = " + paramInt2 + ", ssoAccount = *" + bfii.a(paramString));
    this.a.f();
    if (paramInt2 == -1000)
    {
    ...
    if (paramBundle == null) {}
    for (paramBundle = this.a.getString(2131695061);; paramBundle = paramBundle.getMessage())
    {
  ...
  {
    QLog.i("Q.quicklogin.QuickLoginAuthorityActivity", 1, "-->onGetA1WithA1--ret = " + paramInt1 + ", ssoAccount = *" + bfii.a(paramString));
  ...
  {
    QLog.i("Q.quicklogin.QuickLoginAuthorityActivity", 1, "-->onGetTicketNoPasswd--ssoAccount = *" + bfii.a(paramString));
    this.a.b = null;
    ...
    aoqw localaoqw = (aoqw)aoks.a().a(546);
    paramBundle = "";
    if (paramInt == 32) {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if (localaoqw.jdField_a_of_type_Int == 1)
          {
            paramBundle = (String)localaoqw.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
            if ((this.a.a(paramString, paramBundle)) && (paramArrayOfByte != null))
            {
              ...
              if ((localaoqw.b != 1) || (paramInt != 0)) {
                break label754;
              }
              this.a.f();
              QQToast.a(BaseApplicationImpl.getContext(), alud.a(2131711628), 1).a();
              ...
              azri.a(BaseApplicationImpl.getContext()).a("", "kQuickLoginForBrowser", true, 0L, 0L, paramArrayOfByte, "");
              return;
  ...
  {
    QLog.i("Q.quicklogin.QuickLoginAuthorityActivity", 1, "-->onUserCancel--action = " + paramInt + ", ssoAccount = *" + bfii.a(paramString));
    this.a.f();
  }
}
