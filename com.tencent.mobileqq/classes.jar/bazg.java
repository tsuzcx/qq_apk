  ...
  extends bazc
{
  ...
  public bazg(String paramString, long paramLong, List<String> paramList, UnifySearchCommon.ResultItem paramResultItem, int paramInt)
  {
    super(paramString, paramLong, paramList, paramResultItem, paramInt);
  }
  
  public bazg(String paramString, long paramLong, List<String> paramList, DynamicSearch.ResultItem paramResultItem, int paramInt)
  {
    super(paramString, paramLong, paramList, paramResultItem, paramInt);
  }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_JavaLangCharSequence = bbgk.a(paramString.optString("headText"));
        this.jdField_a_of_type_JavaLangString = paramString.optString("headLineIconURL");
        this.jdField_b_of_type_JavaLangCharSequence = bbgk.a(paramString.optString("descLineText"));
        this.jdField_c_of_type_JavaLangCharSequence = bbgk.a(paramString.optString("firstLineText"));
        ...
        if (localJSONArray != null)
        {
          ...
          if (i < localJSONArray.length())
          {
            ...
            localObject = new bayv(((JSONObject)localObject).optString("url"), ((JSONObject)localObject).optInt("type"));
