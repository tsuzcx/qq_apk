  ...
  extends MessageMicro<StMusic>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 26, 34, 40, 48, 56, 64, 74, 80, 88, 98, 106, 112, 120, 130, 136, 146, 154, 162, 168, 178, 186, 194, 200 }, new String[] { "uiSongId", "strSongMid", "strSongName", "strLanguage", "iTrySize", "iTryBegin", "iTryEnd", "iPlayTime", "strPlayUrl", "iSize", "copyright", "strFormat", "strLyric", "iType", "iStartPos", "strLabel", "uiAlbumId", "strAlbumMid", "strAlbumName", "strAlbumPic", "uiSingerId", "strSingerMid", "strSingerName", "strSingerPic", "iFrom" }, new Object[] { localLong, "", "", "", localInteger, localInteger, localInteger, localInteger, "", localInteger, localInteger, "", "", localInteger, localLong, "", localLong, "", "", "", localLong, "", "", "", localInteger }, StMusic.class);
  }
}
