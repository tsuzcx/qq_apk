...
public class bppc
{
  ...
  {
    zqi localzqi = zqi.a(BaseApplicationImpl.getApplication().getApplicationContext());
    ArrayList localArrayList = new ArrayList();
    localArrayList.add("-formats");
    localzqi.a((String[])localArrayList.toArray(new String[0]), new bppe());
  }
  
  public static void a(String paramString1, String paramString2, bppq parambppq)
  {
    a();
    zqi localzqi = zqi.a(BaseApplicationImpl.getApplication().getApplicationContext());
    ArrayList localArrayList = new ArrayList();
    ...
    localzqi.a((String[])localArrayList.toArray(new String[0]), new bppd(paramString2, parambppq));
  }
  
  public static boolean a()
  {
    File localFile = new File(bppp.a);
    if (!localFile.exists()) {
      localFile.mkdir();
    }
    try
    {
      new bppa(BaseApplicationImpl.getContext()).a("svm_snr15_random_noise", localFile);
      return true;
    }
