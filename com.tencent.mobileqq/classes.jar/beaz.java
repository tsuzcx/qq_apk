  ...
  implements beay
{
  ...
  public beaz(Context paramContext, Activity paramActivity, Intent paramIntent, AppInterface paramAppInterface)
  {
  ...
  protected void adjustLayout(boolean paramBoolean, bebb parambebb)
  {
    if (QLog.isColorLevel()) {
    ...
    if (paramBoolean)
    {
      localLayoutParams = (RelativeLayout.LayoutParams)parambebb.b.getLayoutParams();
      localLayoutParams.topMargin = i;
      parambebb.b.setLayoutParams(localLayoutParams);
      localLayoutParams = (RelativeLayout.LayoutParams)parambebb.a.getLayoutParams();
      localLayoutParams.topMargin = 0;
      localLayoutParams.addRule(3, 0);
      parambebb.a.setLayoutParams(localLayoutParams);
      return;
    }
    RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)parambebb.b.getLayoutParams();
    localLayoutParams.topMargin = i;
    parambebb.b.setLayoutParams(localLayoutParams);
    localLayoutParams = (RelativeLayout.LayoutParams)parambebb.a.getLayoutParams();
    localLayoutParams.topMargin = (i + bcwh.a(this.mContext, 50.0F));
    parambebb.a.setLayoutParams(localLayoutParams);
  }
  ...
  public void buildTitleBar()
  {
    ...
    this.mTitleBar = new befv(this.mInActivity, this.mWebview, this.titleContainer);
    this.titleContainer.setBackgroundResource(2130849463);
    ...
    this.mTitleBar.a(new beba(this));
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if ((this.bNeedStatusTrans) && (ImmersiveUtils.isSupporImmersive() == 1))
    {
      ...
      int i = this.mInActivity.getResources().getColor(2131166957);
  ...
  protected void onImmersive(boolean paramBoolean, bebb parambebb)
  {
    if (QLog.isColorLevel()) {
  ...
  protected final void setTittlebarImmersive(boolean paramBoolean, bebb parambebb)
  {
    if (QLog.isColorLevel()) {
      QLog.d("WebViewBaseBuilder", 2, "setTittlebarImmersive");
    }
    adjustLayout(paramBoolean, parambebb);
    onImmersive(paramBoolean, parambebb);
  }
}
