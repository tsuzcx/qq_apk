...
public class awef
  extends blhu
{
  ajzx jdField_a_of_type_Ajzx;
  awdu jdField_a_of_type_Awdu;
  OverScrollRecyclerView jdField_a_of_type_ComTencentBizQqstoryWidgetOverScrollRecyclerView;
  
  public awef(OverScrollRecyclerView paramOverScrollRecyclerView, ajzx paramajzx, awdu paramawdu)
  {
  ...
  {
    if ((paramViewHolder != null) && (paramViewHolder.itemView != null) && ((paramViewHolder instanceof awdy)) && (Build.VERSION.SDK_INT >= 21)) {}
    try
    {
  ...
  public boolean onMove(RecyclerView paramRecyclerView, RecyclerView.ViewHolder paramViewHolder1, RecyclerView.ViewHolder paramViewHolder2)
  {
    ...
    if (this.jdField_a_of_type_Ajzx != null) {
      return this.jdField_a_of_type_Ajzx.a(paramRecyclerView, i, j);
    }
    return false;
  }
  ...
  public void onSelectedChanged(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.jdField_a_of_type_Ajzx != null) {
        this.jdField_a_of_type_Ajzx.a(this.jdField_a_of_type_Awdu);
      }
    }
    do
    {
