...
public class amwz
{
  ...
  @Nullable
  private static UserData a(ToServiceMsg paramToServiceMsg, aafe paramaafe)
  {
    Object localObject = null;
    int i = a(paramToServiceMsg);
    if ((paramaafe instanceof bbkl))
    {
      paramToServiceMsg = ((bbkl)paramaafe).a[i];
      if (awkj.b()) {
        if (paramToServiceMsg != null) {
          break label86;
        }
    ...
    label86:
    for (paramaafe = "user data is null";; paramaafe = paramToServiceMsg.strProvince)
    {
      awkj.a("NearbyCmdHelper", new Object[] { "handleGetEncounter", Integer.valueOf(i), paramaafe });
      return paramToServiceMsg;
      paramToServiceMsg = localObject;
      if (!(paramaafe instanceof bbkj)) {
        break;
      }
      paramToServiceMsg = ((bbkj)paramaafe).a[i];
      break;
    }
  }
  ...
  public static Object a(aafe paramaafe, FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    ...
    {
      paramaafe = (RespGetPoint)paramaafe.a(paramFromServiceMsg.getWupBuffer(), "RespGetPoint", new RespGetPoint());
      if (paramaafe != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.nearby", 2, "LBSService --> decodeGetPointInfo(), url: " + new String(paramaafe.stUDLinfo.SOSOUrl) + " , cityId = " + paramaafe.stUDLinfo.cityId);
        }
        return paramaafe;
      }
    }
  ...
  public static Object a(AppInterface paramAppInterface, FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg, aafe paramaafe)
  {
    ...
    {
      avif.a("LBS", "CMD_GET_ENCOUNTER eReplyCode:" + localRespHeader.eReplyCode);
      localUserData = null;
      bool = false;
      if (localRespHeader == null) {
        break label500;
      ...
      ((bbkl)paramaafe).a[i] = localUserData;
      label144:
      if (awkj.b())
      {
        ...
        label158:
        awkj.a("NearbyCmdHelper", new Object[] { "decodeGetEncounter", Integer.valueOf(i), paramAppInterface });
      }
      if (localUserData != null)
      {
        aqug.a(paramToServiceMsg.extraData.getString("account"), localUserData.iLon, localUserData.iLat, localUserData.lTime);
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      avif.a("LBS", "CMD_GET_ENCOUNTER eReplyCode:" + null);
      break;
      label397:
      if (!(paramaafe instanceof bbkj)) {
        break label144;
      }
      ((bbkj)paramaafe).a[i] = localUserData;
      break label144;
      label419:
      ...
      amxd.a(paramAppInterface, i);
      paramAppInterface = localUserData;
      continue;
      label500:
      amxd.a(paramAppInterface, -1111);
      return null;
      label509:
      bool = true;
      paramAppInterface = paramFromServiceMsg;
    ...
    for (;;)
    {
      ...
      if (paramSosoLbsInfo.mWifis != null)
      {
        ...
        while (paramSosoLbsInfo.hasNext())
        {
          ...
          paramReqUserInfo.vSOSOMac.add(new SOSO_Wifi(((SosoInterface.SosoWifi)localObject).mMac, (short)((SosoInterface.SosoWifi)localObject).mRssi));
        }
      }
    }
  }
  ...
  private static void a(AppInterface paramAppInterface, int paramInt)
  {
    ...
    if ((paramInt & 0x4) == 4)
    {
      ...
      aquj.c("getShowLove", new Object[] { "report value ", str });
      str = "";
      if ((paramInt & 0x1) != 1) {
        break label184;
      }
    ...
    for (;;)
    {
      ...
      {
        paramAppInterface.reportClickEvent("CliOper", "", "", str, str, 0, 0, "", "", "", "");
        aquj.c("getShowLove", new Object[] { "report value2 ", str });
      }
      return;
      if ((paramInt & 0x8) == 8)
      {
  ...
  public static void a(BusinessHandler paramBusinessHandler, byte paramByte)
  {
    try
    {
      ...
      aquj.a("send_oidb_0x4ff_9", new Object[] { Byte.valueOf(paramByte) });
      return;
    }
    ...
    do
    {
      ...
      if (paramObject.cityId != null)
      {
        ...
        if (paramObject.cityId.length == 16)
        {
          ...
          paramToServiceMsg[0] = ampm.a(localByteBuffer.getInt());
          paramToServiceMsg[1] = ampm.a(localByteBuffer.getInt());
          paramToServiceMsg[2] = ampm.a(localByteBuffer.getInt());
  ...
  public static void a(BusinessHandler paramBusinessHandler, int paramInt1, List<awoe> paramList, int paramInt2, int paramInt3)
  {
    if (paramList == null)
    {
    ...
    {
      awoe localawoe = (awoe)paramList.get(paramInt1);
      if (localawoe != null) {
        localReqBody.rpt_msg_tags.add(localawoe.a());
      }
      paramInt1 += 1;
    }
  ...
  public static void a(BusinessHandler paramBusinessHandler, long paramLong, int paramInt, byte[] paramArrayOfByte)
  {
    ...
    paramBusinessHandler.sendPbReq((ToServiceMsg)localObject);
    a(paramBusinessHandler.mApp, paramInt);
    aquj.c("getShowLove", new Object[] { "from type " + paramInt });
  }
  ...
  public static boolean a(aafe paramaafe, ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    boolean bool1 = false;
    int j = 0;
    ...
    {
      paramaafe = new NeighborSvc.ReqHeader();
      paramaafe.shVersion = 2;
      paramaafe.lMID = aafe.a(Long.parseLong(paramToServiceMsg.getUin()));
      paramaafe.iAppID = AppSetting.a();
      paramaafe.eBusiType = 0;
      paramaafe.eMqqSysType = 2;
      ...
      for (i = 1;; i = 0) {
        for (;;)
        {
          ...
          paramUniPacket.put("ReqHeader", paramaafe);
          ...
          LbsManagerService.startLocation(new amxa("LBSService.Point", paramToServiceMsg));
          try
          {
            paramToServiceMsg.wait();
            Object localObject2 = awhp.a(true, LbsManagerService.getCachedLbsInfo("LBSService.Point"));
    ...
    paramaafe = new FromServiceMsg(paramToServiceMsg.getUin(), paramToServiceMsg.getServiceCmd());
    paramaafe.setMsgFail();
    try
    {
      paramToServiceMsg.actionListener.onActionResult(paramaafe);
      return false;
    }
    catch (RemoteException paramaafe) {}
    return false;
  }
  
  public static boolean a(AppInterface paramAppInterface, ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket, aafe paramaafe)
  {
    if (QLog.isColorLevel()) {
      QLog.d("NearbyCmdHelper", 2, "handleGetEncounter start...");
    }
    if (paramToServiceMsg.extraData.getBoolean("isCheckInReq", false)) {
      return b(paramAppInterface, paramToServiceMsg, paramUniPacket, paramaafe);
    }
    Object localObject3 = a(paramToServiceMsg, paramaafe);
    ...
    while ((paramaafe != null) || (bool1))
    {
      ...
      localReqHeader.lMID = aafe.a(Long.parseLong(paramToServiceMsg.getUin()));
      ...
      a(m, n, bool1, paramaafe, localReqUserInfo1);
      ...
      if (localObject4 != null)
      {
        ...
        if (localObject4.length > 0)
        {
          ...
          paramaafe = SosoInterface.getRawSosoInfo();
      ...
      if (awkj.b()) {
        awkj.a("NearbyCmdHelper", "handleGetEncounter interest", new Object[] { Byte.valueOf(b2), Long.valueOf(l2) });
      }
      ...
      if (((Boolean)awka.a(paramAppInterface.getAccount(), "is_nearby_novice", Boolean.valueOf(false))).booleanValue())
      {
        i = 1;
        if (QLog.isColorLevel()) {
      ...
      for (paramToServiceMsg = "lbs is not null";; paramToServiceMsg = "isUseGps is true")
      {
        ...
        paramUniPacket.put("param_NetType", NetworkUtil.getSystemNetwork(null) + "");
    ...
    if (QLog.isColorLevel()) {
      QLog.d("NearbyCmdHelper", 2, "handleGetEncounter lbsInfo=" + paramaafe + ", isUseGps=" + bool1);
    }
    if (paramaafe == null) {
    ...
    paramToServiceMsg.put("param_NetType", NetworkUtil.getSystemNetwork(null) + "");
    ...
    try
    {
      ...
      if (bool1)
      {
        ...
        if (localRspBody.uint32_config_seq.has())
        {
          ...
          awka.a(paramBusinessHandler.mApp.getAccount(), "toplist_hide_boygod_seq", Integer.valueOf(j));
        }
        if (localRspBody.uint32_config_time.has())
        {
          j = localRspBody.uint32_config_time.get();
          awka.a(paramBusinessHandler.mApp.getAccount(), "key_last_config_time", Integer.valueOf(j));
        }
        ...
        if ((i == 2) && (localRspBody.msg_charm_event.has()))
        {
          ...
          if (!(paramBusinessHandler.mApp instanceof NearbyAppInterface)) {
            break label599;
          }
        }
        int k;
        ...
        for (;;)
        {
          ...
          paramBusinessHandler.mApp.reportClickEvent("CliOper", "", "", paramToServiceMsg, paramToServiceMsg, 0, 0, "", "", "", "");
          return;
          ...
          break;
          label599:
          if ((paramBusinessHandler.mApp instanceof QQAppInterface)) {
            ((QQAppInterface)paramBusinessHandler.mApp).getNearbyProxy().a(paramToServiceMsg.getUin(), paramFromServiceMsg, paramObject, (Oidb_0x686.CharmEvent)localObject1, (Oidb_0x686.NearbyCharmNotify)localObject2);
          }
        }
        label636:
  ...
  protected static boolean b(AppInterface paramAppInterface, ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket, aafe paramaafe)
  {
    int i = paramToServiceMsg.extraData.getInt("localLat");
    int j = paramToServiceMsg.extraData.getInt("localLon");
    if (QLog.isColorLevel()) {
    ...
    if ((i != 0) && (j != 0))
    {
      ...
      paramAppInterface.lMID = aafe.a(Long.parseLong(paramToServiceMsg.getUin()));
      ...
      paramaafe = new ReqGetEncounterV2();
      paramaafe.stUserData = new UserData();
      paramaafe.stUserInfo = paramToServiceMsg;
      paramaafe.eNewListType = 100;
      paramaafe.neighbor_list_source = 4;
      paramUniPacket.setEncodeName("utf-8");
      paramUniPacket.setServantName("EncounterObj");
      paramUniPacket.setFuncName("CMD_GET_ENCOUNTERV2");
      paramUniPacket.put("ReqHeader", paramAppInterface);
      paramUniPacket.put("ReqGetEncounterV2", paramaafe);
      return true;
    }
    return false;
  }
  ...
  public static void c(BusinessHandler paramBusinessHandler, int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      paramBusinessHandler.notifyUI(paramInt, false, new Object[] { "", null, amtj.a(2131706242), Integer.valueOf(-1), Integer.valueOf(-1) });
      return;
    }
    int i;
    int j;
    ...
    for (paramFromServiceMsg = localRspBody.rpt_msg_tags.get();; paramFromServiceMsg = null)
    {
      ...
      {
        awoe localawoe = awoe.a((appoint_define.InterestTag)paramFromServiceMsg.get(k));
        if (localawoe != null) {
          paramObject.add(localawoe);
        }
        k += 1;
      }
    ...
    {
      paramBusinessHandler.notifyUI(4, false, new Object[] { "", null, amtj.a(2131706243), Integer.valueOf(i), Integer.valueOf(j) });
      awkj.a("Q.nearby_people_card.", "handle_oidb_0x9c7_0", new Object[] { Integer.valueOf(m), Boolean.valueOf(true), null, paramToServiceMsg });
      return;
    }
    if ((paramBusinessHandler.mApp instanceof NearbyAppInterface)) {
      ((NearbyAppInterface)paramBusinessHandler.mApp).a().a(localRspBody);
    }
    for (;;)
    {
      paramBusinessHandler.notifyUI(paramInt, true, new Object[] { paramToServiceMsg, paramObject, "", Integer.valueOf(i), Integer.valueOf(j) });
      awkj.a("Q.nearby_people_card.", "handle_oidb_0x9c7_0", new Object[] { Integer.valueOf(m), Boolean.valueOf(true), paramObject, paramToServiceMsg });
      return;
      if (paramBusinessHandler.app != null) {
        paramBusinessHandler.app.getNearbyProxy().a(localRspBody);
      }
    }
    label472:
    ...
    for (;;)
    {
      if ((paramBusinessHandler.mApp instanceof QQAppInterface)) {
        if (paramInt == 7)
        {
          ...
          if (bool1)
          {
            paramToServiceMsg = ((QQAppInterface)paramBusinessHandler.mApp).getNearbyProxy();
            if (paramInt != 0) {
              break label294;
            }
      ...
      for (;;)
      {
        ...
        if ((paramBusinessHandler.mApp instanceof NearbyAppInterface))
        {
          paramFromServiceMsg = (NearbyAppInterface)paramBusinessHandler.mApp;
          if (paramInt == 10)
          {
  ...
  public static void e(BusinessHandler paramBusinessHandler, int paramInt, ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    aquj.a("getShowLove", new Object[] { "handleGetShowLoveLimit result = " + i });
    int n;
    if ((i == 0) && (localRspBody.rpt_msg_chatinfo.has()) && (localRspBody.rpt_msg_chatinfo.size() > 0))
    {
      ...
      if ((paramBusinessHandler instanceof awkr)) {
      ...
      if (i1 == 1) {
        paramBusinessHandler.mApp.reportClickEvent("CliOper", "", "", "0X8005290", "0X8005290", 0, 0, "", "", "", "");
      }
    }
    for (;;)
    {
      ...
      if (n == 1)
      {
        paramBusinessHandler.mApp.reportClickEvent("CliOper", "", "", "0X8005291", "0X8005291", 0, 0, "", "", "", "");
        continue;
        paramBusinessHandler.notifyUI(paramInt, false, null);
      }
    }
