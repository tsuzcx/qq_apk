...
public class bqib
{
  ...
  private bqia jdField_a_of_type_Bqia = new bqic(this);
  ...
  public float a(int paramInt)
  {
    ...
    if ((this.b) && (this.jdField_a_of_type_Bqhz != null) && (this.jdField_a_of_type_Bqhz.jdField_a_of_type_Boolean) && (paramInt >= this.jdField_a_of_type_Int)) {
      return this.jdField_a_of_type_Bqhz.a(paramInt - this.jdField_a_of_type_Int);
    }
    return -1.0F;
  }
