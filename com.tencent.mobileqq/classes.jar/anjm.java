...
{
  public anjm(MessageForQQWalletTips paramMessageForQQWalletTips, SoftReference paramSoftReference1, SoftReference paramSoftReference2, QQAppInterface paramQQAppInterface, Context paramContext, adiw paramadiw, agvx paramagvx, int paramInt) {}
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips.bytes_jumpurl))
      {
        ...
        paramView = bgxb.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips.bytes_jumpurl, MessageForQQWalletTips.access$100(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), true);
        ahiv.a(this.jdField_a_of_type_AndroidContentContext, paramView);
        return;
      }
      if ((MessageForQQWalletTips.access$200(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips) != 524288) || (this.jdField_a_of_type_Adiw == null) || (this.jdField_a_of_type_Agvx == null)) {
        break;
      }
      localObject2 = this.jdField_a_of_type_Agvx.a(MessageForQQWalletTips.access$300(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips));
      if ((localObject2 == null) || (((agvw)localObject2).a) || (((agvw)localObject2).b) || (((agvw)localObject2).a())) {
        break;
      }
      paramView = this.jdField_a_of_type_Agvx.a(((agvw)localObject2).e);
    } while (bbkk.a(paramView));
    this.jdField_a_of_type_Adiw.b(MessageForQQWalletTips.access$300(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletTips), paramView, ajya.a(2131706599));
    return;
