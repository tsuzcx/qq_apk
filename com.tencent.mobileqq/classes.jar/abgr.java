...
{
  abgr(abgp paramabgp, long paramLong, String paramString) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.has())
        {
          ...
          if (!TextUtils.isEmpty(paramBundle))
          {
            if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.delayms.has())
            {
              ...
              this.jdField_a_of_type_Abgp.e.put(paramBundle, Integer.valueOf(2147483647));
              if (QLog.isColorLevel()) {
            ...
            if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.packagesize.has())
            {
              ...
              this.jdField_a_of_type_Abgp.b.put(paramBundle, Long.valueOf(l1));
              if (QLog.isColorLevel()) {
        ...
        abgp.a(this.jdField_a_of_type_Abgp, this.jdField_a_of_type_JavaLangString, l2, paramInt);
        ...
        awjk.d = System.currentTimeMillis();
        l1 = awjk.d - awjk.jdField_a_of_type_Long;
        long l3 = awjk.b - awjk.jdField_a_of_type_Long;
        long l4 = awjk.c - awjk.b;
        long l5 = awjk.d - awjk.c;
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_Abgp.callJs((String)localObject1, new String[] { ((JSONObject)localObject2).toString() });
        try
        {
          ...
          localObject3 = this.jdField_a_of_type_Abgp.mRuntime.a().getCurrentAccountUin();
          ...
          localObject1 = bdmc.a(this.jdField_a_of_type_Abgp.mRuntime.a());
          if (0L != l6) {
            break;
          }
          paramBoolean = true;
          label1110:
          ((bdmc)localObject1).a((String)localObject3, paramBundle, paramBoolean, l1, 0L, (HashMap)localObject2, "", false);
          return;
        }
      ...
      return;
      label1197:
      this.jdField_a_of_type_Abgp.e.put(paramBundle, Integer.valueOf((int)l1));
      continue;
      label1218:
      abgp.a(this.jdField_a_of_type_Abgp, this.jdField_a_of_type_JavaLangString, paramInt);
      continue;
      label1233:
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject3)) {
        abgp.b(this.jdField_a_of_type_Abgp, (String)localObject3, paramInt);
      }
      ...
      ((JSONObject)localObject2).put("businessRet", 0);
      ((JSONObject)localObject2).put("msg", anzj.a(2131713140));
    }
    for (;;)
    {
      label1431:
      ...
      ((JSONObject)localObject2).put("businessRet", 0);
      ((JSONObject)localObject2).put("msg", anzj.a(2131713146));
      break;
      label1510:
      label1511:
      do
      {
        ((JSONObject)localObject2).put("ssoRet", 255);
        ((JSONObject)localObject2).put("businessRet", 0);
        ((JSONObject)localObject2).put("msg", anzj.a(2131713145));
        break;
        paramBoolean = false;
        break label1110;
        return;
