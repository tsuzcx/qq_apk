  ...
  extends GPUBaseFilter
{
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Avad != null) || (this.b != null);
  }
  
  public void destroy()
  {
    if (this.jdField_a_of_type_Avad != null) {
      this.jdField_a_of_type_Avad.destroy();
    }
    if (this.b != null) {
      this.b.destroy();
    }
  ...
  public void drawTexture(int paramInt, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
    ...
    if (this.jdField_a_of_type_Avad != null) {
      this.jdField_a_of_type_Avad.drawTexture(paramInt, paramArrayOfFloat1, paramArrayOfFloat2);
    }
  ...
  public void init()
  {
    if ((this.jdField_a_of_type_Avad != null) && (!this.jdField_a_of_type_Avad.isInitialized())) {
      this.jdField_a_of_type_Avad.init();
    }
  ...
  {
    if (this.jdField_a_of_type_Avad != null) {
      this.jdField_a_of_type_Avad.onOutputSizeChanged(paramInt1, paramInt2);
    }
    if (this.b != null) {
