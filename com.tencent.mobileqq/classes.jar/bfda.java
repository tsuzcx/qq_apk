  ...
  implements aaea
{
  ...
  private void g(String paramString)
  {
    ...
    a();
    localObject = new bisl((Context)localObject, ((BaseActivity)localObject).getTitleBarHeight());
    ((bisl)localObject).a(paramString);
    ((bisl)localObject).setCancelable(false);
    ((bisl)localObject).setOnDismissListener(new bfdc(this));
    this.jdField_a_of_type_Bisl = ((bisl)localObject);
  ...
  private void h(String paramString)
  {
    ...
    {
      QQToast.a((Context)localObject, 2131694253, 0).b(((BaseActivity)localObject).getTitleBarHeight());
      return;
    }
    g(((BaseActivity)localObject).getString(2131719741));
  ...
  private void j(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localIntent.putExtra("param_title", this.mRuntime.a().getString(2131693381));
        localIntent.putExtra("param_done_button_wording", this.mRuntime.a().getString(2131694399));
        localIntent.putExtra("param_done_button_highlight_wording", this.mRuntime.a().getString(2131694400));
        localIntent.putExtra("param_only_friends", true);
      ...
      catch (JSONException localJSONException1)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramString))
          {
            ...
            paramString.putString("troop_info_title", localActivity.getString(2131695850));
  ...
  private void m(String paramString)
  {
    ...
    g(((Activity)localObject).getString(2131719746));
    localObject = new Intent((Context)localObject, TroopCreateLogicActivity.class);
  ...
  {
    c();
    bkzi localbkzi = (bkzi)bkzz.a(this.mRuntime.a(), null);
    localbkzi.a(2131719739);
    localbkzi.a(2131719740, 3);
    localbkzi.c(2131690697);
    localbkzi.setOnDismissListener(new bfdd(this));
    localbkzi.a(new bfde(this));
  ...
  public void b(String paramString)
  {
    ...
    if (!NetworkUtil.isNetSupport(localBaseActivity)) {
      QQToast.a(localBaseActivity, 2131694253, 0).b(localBaseActivity.getTitleBarHeight());
    }
  ...
  public void d(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 65	bfda:mRuntime	Lbifw;
    //   4: invokevirtual 70	bifw:a	()Landroid/app/Activity;
    //   7: astore_3
    //   8: new 168	org/json/JSONObject
    //   11: dup
    //   12: aload_1
    //   13: invokespecial 170	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   16: astore_1
    //   17: aload_1
    //   18: ldc_w 481
    //   21: invokevirtual 175	org/json/JSONObject:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   24: astore 4
    //   26: aload_1
    //   27: ldc_w 483
    //   30: invokevirtual 484	org/json/JSONObject:getBoolean	(Ljava/lang/String;)Z
    //   33: istore_2
    //   34: aload 4
    //   36: bipush 13
    //   38: invokestatic 237	com/tencent/mobileqq/activity/TroopInfoActivity:a	(Ljava/lang/String;I)Landroid/os/Bundle;
    //   41: astore_1
    //   42: aload_1
    //   43: ldc_w 483
    //   46: iload_2
    //   47: invokevirtual 488	android/os/Bundle:putBoolean	(Ljava/lang/String;Z)V
    //   50: aload_3
    //   51: aload_1
    //   52: invokestatic 491	com/tencent/mobileqq/activity/TroopInfoActivity:a	(Landroid/content/Context;Landroid/os/Bundle;)V
    //   55: iload_2
    //   56: ifeq +7 -> 63
    //   59: aload_3
    ...
    catch (JSONException paramString)
    {
      try
      {
        ...
        if (paramString != null)
        {
          ...
          bfcz.a(localActivity, localActivity.getIntent().getExtras(), paramString);
        }
        return;
      }
      catch (JSONException paramString) {}
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      paramString3 = this.jdField_a_of_type_Aady;
      if (j == -1) {}
      ...
      if (paramString3.equals("insertCreateGroupSuccessMsg")) {
        try
        {
          ...
          this.jdField_a_of_type_Aady.a(paramJsBridgeListener, paramString1, i, paramString2, this);
        }
      ...
      {
        paramJsBridgeListener.a("8.4.10.4875");
        break label2336;
      }
      if (paramString3.equals("isNetworkConnected"))
      {
        paramJsBridgeListener.a(Boolean.valueOf(bjkj.d(bizw.a().a())));
        break label2336;
      }
    ...
    else if ("updateTroopBindedPubAccount".equals(paramString3))
    {
      try
      {
        ...
        if (j > 0)
        {
          ...
          this.jdField_a_of_type_Aady.a(l, paramString1);
        }
        if (!QLog.isColorLevel()) {
          break label2336;
        }
    ...
    else if ("getLastSpeakMessage".equals(paramString3))
    {
      try
      {
        ...
        paramString2 = paramString2.optString("callback");
        this.jdField_a_of_type_Aady.a(paramJsBridgeListener, paramString1, new bfdb(this, paramString2));
        if (!QLog.isColorLevel()) {
          break label2336;
        }
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_Aady.a(paramString1, i, j, k, paramString2);
      ...
      if ("returnToTroopAIO".equals(paramString3))
      {
        ...
        SensorAPIJavaScript.returnToAio(this.jdField_a_of_type_Aady, this.mRuntime.a(), paramJsBridgeListener, true);
        break label2336;
      }
      else
      {
        if ("notifyCreateTroops".equals(paramString3))
        {
          try
          {
            ...
            paramString2 = paramString2.optString("callback");
            this.jdField_a_of_type_Aady.a(paramJsBridgeListener, paramString1, paramString2, this);
          }
          catch (JSONException paramJsBridgeListener)
          {
            if (!QLog.isColorLevel()) {
          ...
          for (;;)
          {
            try
            {
              ...
              if ((paramString2 != null) && (paramString2.length() > 0))
              {
                ...
                this.jdField_a_of_type_Aady.a(paramString3);
  ...
  public void onActivityResult(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    {
      if (bool) {
        QQToast.a((Context)localObject2, 2131719738, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      }
      for (;;)
      {
        ...
        return;
        QQToast.a((Context)localObject2, 2131719743, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      }
    }
    if (paramByte == 1002) {
      paramIntent = ((BaseActivity)localObject2).getString(2131719750);
    }
    for (;;)
    {
      ...
      return;
      if (bool) {
        paramIntent = ((BaseActivity)localObject2).getString(2131719737);
      } else {
        paramIntent = ((BaseActivity)localObject2).getString(2131719742);
      }
    }
  }
