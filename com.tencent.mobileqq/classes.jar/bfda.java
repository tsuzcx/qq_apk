...
{
  bfda(bfcw parambfcw, bfdd parambfdd) {}
  
  public void onServiceEvent(String paramString1, String paramString2, int[] paramArrayOfInt)
  {
    this.jdField_a_of_type_Bfdd.a(paramString1, paramString2, paramArrayOfInt);
  }
  
  public String onServiceNativeRequest(String paramString1, String paramString2, int paramInt)
  {
    return this.jdField_a_of_type_Bfdd.a(paramString1, paramString2, paramInt);
  }
}
