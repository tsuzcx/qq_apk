  ...
  extends wzu
{
  ...
  public wzh(wzv paramwzv, String paramString1, List<String> paramList, String paramString2, String paramString3)
  {
    super(paramwzv, paramString1, paramList);
    this.jdField_a_of_type_JavaLangString = paramString3;
    Object localObject;
    this.b = localObject;
    this.jdField_a_of_type_JavaUtilList = paramString2;
    this.jdField_a_of_type_Wzu = new wzs(paramwzv, paramString1, paramList);
  }
  
  public File a(File paramFile, String paramString, wze paramwze)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Wyw.jdField_a_of_type_Wae.a((String)localObject, paramFile.getAbsolutePath(), str3, i, j, new wzo(this, paramwze, str3));
    }
  ...
  public void a()
  {
    ...
    a(this.jdField_a_of_type_JavaUtilList, str, new wzi(this, localwzg));
  }
  
  public void a(List<String> paramList, String paramString, wze paramwze)
  {
    if ((paramList == null) || (this.jdField_a_of_type_JavaUtilList.size() == 0))
    {
      paramwze.a(null, false, "videoFiles empty!");
      return;
    }
    if (paramList.size() == 1)
    {
      paramwze.a((String)this.jdField_a_of_type_JavaUtilList.get(0), true, "combineVideos Success size = 1");
      return;
    }
    try
    {
      ...
      a(this.jdField_a_of_type_JavaUtilList, paramList.getAbsolutePath(), new wzm(this, l, paramwze, paramList));
      return;
    }
  ...
  public void a(List<String> paramList, String paramString, wzr paramwzr)
  {
    ...
    this.jdField_a_of_type_Wyw.jdField_a_of_type_Long = System.currentTimeMillis();
    ...
    if (i < paramList.size())
    {
      ...
      for (;;)
      {
        ...
        ((wak)localObject4).jdField_a_of_type_Int = 5;
        ((wak)localObject4).jdField_a_of_type_JavaUtilArrayList = new VideoCombineHelper.CombineTask.3(this, (String)localObject2, (String)localObject3);
        ((wak)localObject4).jdField_a_of_type_Wam = new wzn(this, paramwzr);
    ...
    paramString.jdField_a_of_type_Wam = paramwzr;
    ((ArrayList)localObject1).add(paramString);
    if (this.jdField_a_of_type_Wyw.jdField_a_of_type_Wae.a()) {
      try
      {
        this.jdField_a_of_type_Wyw.jdField_a_of_type_Wae.b((ArrayList)localObject1);
        return;
      }
    ...
    try
    {
      this.jdField_a_of_type_Wyw.jdField_a_of_type_Wae.a((ArrayList)localObject1);
      return;
    }
    catch (FFmpegCommandAlreadyRunningException paramList)
    {
  ...
  public boolean a(int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      vxy.a(localBitmap, Bitmap.CompressFormat.PNG, 100, paramString2);
      vxy.a(localBitmap);
      bool = true;
    }
