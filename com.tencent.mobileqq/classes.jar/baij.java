  ...
  implements IBrowserAnimationListener
{
  ...
  public baij(RichMediaBaseData paramRichMediaBaseData)
  {
  ...
  public Drawable getAnimationDrawable()
  {
    for (;;)
    {
      try
      {
        ...
        {
          localDrawable = new baji().a((AIOPictureData)this.jdField_a_of_type_ComTencentRichmediabrowserModelRichMediaBaseData);
        ...
        else
        {
          ...
          {
            localDrawable = new bajj().a((AIOVideoData)this.jdField_a_of_type_ComTencentRichmediabrowserModelRichMediaBaseData);
            continue;
          }
          if ((this.jdField_a_of_type_ComTencentRichmediabrowserModelRichMediaBaseData instanceof AIOFilePictureData))
          {
            localDrawable = new baje().a((AIOFilePictureData)this.jdField_a_of_type_ComTencentRichmediabrowserModelRichMediaBaseData);
            continue;
          }
          if (!(this.jdField_a_of_type_ComTencentRichmediabrowserModelRichMediaBaseData instanceof AIOFileVideoData)) {
            break label219;
          }
          localDrawable = new bajf().a((AIOFileVideoData)this.jdField_a_of_type_ComTencentRichmediabrowserModelRichMediaBaseData);
          continue;
        }
        return null;
      }
  ...
  {
    paramRichMediaBaseData = new baij(paramRichMediaBaseData);
