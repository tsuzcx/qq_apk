  ...
  extends bame
{
  ...
  public axhs(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    if ((paramDownloadParams != null) && (paramDownloadParams.tag != null) && ((paramDownloadParams.tag instanceof String)))
    {
      ...
      paramDownloadParams = new File(aljq.bd);
    ...
    if ((paramDownloadParams != null) && (paramFile != null))
    {
      ...
      if (paramDownloadParams != null)
      {
        ...
        if (!TextUtils.isEmpty(paramDownloadParams))
        {
          ...
          int i = 90;
          if (this.a != null) {
            i = bcwh.a(this.a, 30.0F);
          }
          paramDownloadParams = bdda.a(paramFile.getAbsolutePath(), i, i);
          paramFile = paramDownloadParams;
          if (j == 1)
          {
            if (paramDownloadParams != null) {
              paramFile = bdda.a(paramDownloadParams, paramDownloadParams.getWidth(), paramDownloadParams.getWidth(), paramDownloadParams.getHeight());
            }
          }
          else {
            return paramFile;
