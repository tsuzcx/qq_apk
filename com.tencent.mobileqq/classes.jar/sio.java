  ...
  extends sii
{
  ...
  public sio(@NonNull String[] paramArrayOfString)
  {
  ...
  protected void a(String[] paramArrayOfString, sij paramsij)
  {
    ...
    for (;;)
    {
      ...
      while (j < k)
      {
        localArrayList.add(new sip(this, arrayOfFile[j]));
        j += 1;
      }
      ...
      while (j < n)
      {
        ...
        catch (InterruptedException localInterruptedException)
        {
          ...
          a(((sip)localArrayList.get(j)).a);
          k += 1;
          j += 1;
        }
      }
      paramsij.jdField_a_of_type_Double = (d - a(localFile) + paramsij.jdField_a_of_type_Double);
      paramsij.jdField_a_of_type_Int += k;
    }
  }
