...
public final class bhla
{
  ...
  public bhla(@ColorInt int paramInt1, int paramInt2)
  {
  ...
  private void a()
  {
    ...
    {
      i = bhku.a(-1, this.d, 4.5F);
      j = bhku.a(-1, this.d, 3.0F);
      if ((i != -1) && (j != -1))
      {
        this.g = bhku.b(-1, i);
        this.f = bhku.b(-1, j);
    ...
    int m = bhku.a(-16777216, this.d, 4.5F);
    int k = bhku.a(-16777216, this.d, 3.0F);
    if ((m != -1) && (k != -1))
    {
      this.g = bhku.b(-16777216, m);
      this.f = bhku.b(-16777216, k);
      this.jdField_a_of_type_Boolean = true;
      return;
    }
    if (i != -1)
    ...
    label175:
    for (int i = bhku.b(-1, j);; i = bhku.b(-16777216, k))
    {
      this.f = i;
      this.jdField_a_of_type_Boolean = true;
      return;
  ...
  public float[] a()
  {
    ...
    bhku.a(this.jdField_a_of_type_Int, this.b, this.c, this.jdField_a_of_type_ArrayOfFloat);
