...
public class bmiz
{
  ...
  private static bmiz jdField_a_of_type_Bmiz;
  ...
  public static bmiz a()
  {
    if (jdField_a_of_type_Bmiz == null) {}
    try
    {
      if (jdField_a_of_type_Bmiz == null) {
        jdField_a_of_type_Bmiz = new bmiz();
      }
      return jdField_a_of_type_Bmiz;
    }
    finally {}
  }
  ...
  public static ArrayList<String> a(Context paramContext, int paramInt1, long paramLong1, long paramLong2, int paramInt2, int paramInt3)
  {
    ...
    //   2: lload_2
    //   3: lload 4
    //   5: invokestatic 267	bmiz:a	(Landroid/content/Context;IJJ)Landroid/database/Cursor;
    //   8: astore_0
    //   9: aload_0
    ...
    //   158: ifne +14 -> 172
    //   161: aload 10
    //   163: invokestatic 300	bmiz:a	(Ljava/lang/String;)Landroid/media/ExifInterface;
    //   166: invokestatic 303	bmiz:a	(Landroid/media/ExifInterface;)Z
    //   169: ifeq -80 -> 89
    //   172: aload 9
    //   174: aload 10
    ...
    //   229: areturn
    //   230: ldc_w 322
    //   233: invokestatic 327	bmjs:a	(Ljava/lang/String;)Ljava/util/List;
    //   236: astore 8
    //   238: goto -162 -> 76
    //   241: ldc_w 329
    //   244: invokestatic 327	bmjs:a	(Ljava/lang/String;)Ljava/util/List;
    //   247: astore 8
    //   249: goto -173 -> 76
    //   252: ldc_w 331
    //   255: invokestatic 327	bmjs:a	(Ljava/lang/String;)Ljava/util/List;
    //   258: astore 8
    //   260: goto -184 -> 76
    //   263: astore_0
    //   264: aload_0
