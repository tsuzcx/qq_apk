  ...
  implements Handler.Callback, Manager, BusinessObserver
{
  ...
  private ConcurrentHashMap<Long, azwg> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  private int b = -1;
  ...
  public azwd(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(MessageForPtt paramMessageForPtt, int paramInt)
  {
    if (paramMessageForPtt != null)
    {
      ...
      paramMessageForPtt.sttText = alpo.a(2131715001);
      ...
      azmz.a(BaseApplication.getContext()).a(null, "ptttotextSuc", false, 0L, 0L, localHashMap, null);
    }
    try
    {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    return ((azwd)paramQQAppInterface.getManager(17)).a();
  }
  ...
  public void a(int paramInt)
  {
    ...
    try
    {
      ...
      localHashMap.put("appversion", "8.3.3");
      localazmz.a("", "PttSttEntryChange", false, 0L, 0L, localHashMap, "");
      return;
    }
  ...
  public void a(azwf paramazwf)
  {
    this.jdField_a_of_type_Azwf = paramazwf;
  }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      while (paramArrayOfByte != null)
      {
        ...
        localObject = (azwg)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(localLong);
        paramArrayOfByte = (byte[])localObject;
        if (localObject == null)
        {
          paramArrayOfByte = new azwg(null);
  ...
  public Long b(MessageForPtt paramMessageForPtt, int paramInt)
  {
    ...
    {
      if (!bdje.a(paramMessageForPtt.urlAtServer)) {
        break label160;
      }
      QLog.e("", 1, new Object[] { "stt err, c2c no fileID ", paramMessageForPtt });
      a(paramMessageForPtt, 2003);
      if (this.jdField_a_of_type_Azwf != null) {
        this.jdField_a_of_type_Azwf.a(false, paramMessageForPtt);
      }
    }
    for (;;)
    {
      return localLong;
      if (bdje.a(paramMessageForPtt.md5))
      {
      ...
      {
        label160:
        Object localObject = aoqj.c();
        boolean bool = bdwk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "have_add_ptt_svip_gray_msg", false);
        if ((((aoqi)localObject).jdField_a_of_type_Int == 2) && (!bool) && (VipUtils.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && (aftg.d))
        {
          localObject = new aslp(paramMessageForPtt.frienduin, paramMessageForPtt.selfuin, alpo.a(2131715002), paramMessageForPtt.istroop, -5020, 655392, paramMessageForPtt.time);
          ...
          bdwk.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "have_add_ptt_svip_gray_msg", true);
        ...
        while (!this.jdField_a_of_type_JavaUtilHashMap.containsKey(localLong))
        {
          ...
          azwh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPtt, localLong, paramInt);
          return localLong;
          if (QLog.isColorLevel()) {
            QLog.d("Q.stt", 1, "stage2 first translate It is need add gray msg and insert falied:conf.stage == " + ((aoqi)localObject).jdField_a_of_type_Int + " && " + bool);
          }
        }
      }
    }
  ...
  public boolean b(MessageForPtt paramMessageForPtt)
  {
    ...
    {
      return true;
      bdew.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (QLog.isColorLevel()) {
        QLog.d("Q.stt", 2, "needAuotoChange AutoChangeFlag=" + aftg.d + " AutoChangeSetTime=" + aftg.jdField_a_of_type_Long + " isTranslating=" + a(paramMessageForPtt) + "mPtt.msgTime=" + paramMessageForPtt.msgTime + " mPtt.time=" + paramMessageForPtt.time + " mPtt.sttAbility=" + paramMessageForPtt.sttAbility + " isRedPackPTT=" + ajat.a(paramMessageForPtt));
      }
    } while ((!a(paramMessageForPtt)) && (!ajat.a(paramMessageForPtt)) && (aftg.d) && ((aftg.jdField_a_of_type_Long < paramMessageForPtt.msgTime) || (aftg.jdField_a_of_type_Long < paramMessageForPtt.time)) && (paramMessageForPtt.voiceChangeFlag != 1) && ((paramMessageForPtt.sttAbility == 1) || (paramMessageForPtt.sttAbility == 3)));
    return false;
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (MessageForPtt localMessageForPtt = (MessageForPtt)this.jdField_a_of_type_JavaUtilHashMap.remove(paramMessage.obj);; localMessageForPtt = null)
    {
      ...
      if ((localMessageForPtt != null) && (this.jdField_a_of_type_Azwf != null))
      {
        a(localMessageForPtt, 2002);
        this.jdField_a_of_type_Azwf.a(false, localMessageForPtt);
      }
      return true;
      ...
      for (localMessageForPtt = (MessageForPtt)this.jdField_a_of_type_JavaUtilHashMap.remove(Long.valueOf(l));; localMessageForPtt = null)
      {
        ...
        azmz.a(BaseApplication.getContext()).a(null, "ptttotextSuc", true, 0L, 0L, localHashMap, null);
        ...
        if (QLog.isColorLevel()) {
          QLog.d("PttItemBuilder", 2, "ptt convert to text success,seq is:" + localMessageForPtt.uniseq + ",sttAbility is:" + localMessageForPtt.sttAbility + ",sttText is:" + bdal.a(localMessageForPtt.sttText));
        }
        if (this.jdField_a_of_type_Azwf == null) {
          break;
        }
        this.jdField_a_of_type_Azwf.a(true, localMessageForPtt);
        return true;
      }
    }
  }
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_Azwf = null;
  }
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Azwf == null);
      this.jdField_a_of_type_Azwf.a(false, paramBundle);
      return;
    } while (!QLog.isColorLevel());
