...
public class azwd
{
  private static final String jdField_a_of_type_JavaLangString = azwd.class.getSimpleName();
  ...
  private void b()
  {
    ...
    Collections.sort((List)localObject1, new azwe(this));
    label176:
  ...
  public int a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    catch (Throwable localThrowable)
    {
      ...
      if (((amsw)paramQQAppInterface.getManager(51)).b(paramString))
      {
        b(paramString);
        return 1;
      }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 245	azwd:jdField_a_of_type_Boolean	Z
    //   6: istore 6
    //   8: iload 6
    //   10: ifne +198 -> 208
    //   13: aload_1
    //   14: ifnull +15 -> 29
    //   17: aload_0
    //   18: new 238	java/lang/ref/WeakReference
    //   21: dup
    //   22: aload_1
    //   23: invokespecial 248	java/lang/ref/WeakReference:<init>	(Ljava/lang/Object;)V
    //   26: putfield 223	azwd:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    //   29: aload_0
    //   30: invokevirtual 71	azwd:a	()Landroid/content/SharedPreferences;
    //   33: astore_1
    //   34: aload_1
    //   35: ifnonnull +64 -> 99
    //   38: aconst_null
    ...
    //   124: ifle +148 -> 272
    //   127: aload 11
    //   129: invokevirtual 178	java/lang/String:length	()I
    //   132: istore 5
    //   134: iload 4
    //   136: iload 5
    //   138: iconst_1
    ...
    //   169: ifnull +103 -> 272
    //   172: aload 9
    //   174: invokevirtual 178	java/lang/String:length	()I
    //   177: ifle +95 -> 272
    //   180: aload_0
    //   181: getfield 41	azwd:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   184: aload 9
    //   186: lload 7
    //   188: invokestatic 191	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   191: invokevirtual 277	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   194: pop
    //   195: goto +77 -> 272
    //   198: astore_1
    //   199: aload_1
    //   200: invokevirtual 117	java/lang/Throwable:printStackTrace	()V
    //   203: aload_0
    //   204: iconst_1
    //   205: putfield 245	azwd:jdField_a_of_type_Boolean	Z
    //   208: aload_0
    //   209: monitorexit
    //   210: return
    //   211: astore 9
    //   213: aload 9
    //   215: invokevirtual 117	java/lang/Throwable:printStackTrace	()V
    //   218: lconst_0
    //   219: lstore 7
    //   221: aconst_null
    //   222: astore 9
    ...
    //   230: ifeq -27 -> 203
    //   233: getstatic 24	azwd:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   236: iconst_2
    //   237: ldc_w 279
    //   240: iconst_2
    ...
    //   249: iconst_1
    //   250: aload_0
    //   251: getfield 41	azwd:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   254: invokevirtual 280	java/util/concurrent/ConcurrentHashMap:toString	()Ljava/lang/String;
    //   257: aastore
    //   258: invokestatic 176	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   261: invokestatic 68	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   264: goto -61 -> 203
    //   267: astore_1
    //   268: aload_0
    //   269: monitorexit
