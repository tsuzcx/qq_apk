...
public class ablf
  extends ajto
{
  public ablf(LikeRankingListActivity paramLikeRankingListActivity) {}
  ...
  protected void onReqLikeRankingListResult(boolean paramBoolean1, String paramString, List<LikeRankingInfo> paramList, int paramInt, boolean paramBoolean2)
  {
    ...
    else
    {
      ...
      this.a.jdField_a_of_type_Ajzq.a(paramList, paramInt, paramBoolean2);
      if ((!paramBoolean2) || (paramList.size() != 0)) {
        break label258;
      }
      this.a.e.setVisibility(0);
      label165:
      this.a.jdField_a_of_type_Ablg.a(paramList, true);
    ...
    for (;;)
    {
      ...
      label284:
      this.a.a(null);
      this.a.jdField_a_of_type_Ablg.a = false;
      this.a.jdField_a_of_type_Ablg.notifyDataSetChanged();
      if (this.a.jdField_a_of_type_Ablg.getCount() <= 1) {
        this.a.e.setVisibility(0);
      }
    }
    label341:
    this.a.jdField_a_of_type_Ablg.a = false;
    this.a.jdField_a_of_type_Ablg.notifyDataSetChanged();
    bcql.a(BaseApplication.getContext(), 1, ajya.a(2131706110), 0).a();
  }
}
