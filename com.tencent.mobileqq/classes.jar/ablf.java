  ...
  implements ablq
{
  ...
  public ablf(@NonNull Context paramContext)
  {
  ...
  private void c()
  {
    this.jdField_a_of_type_Ablo = new ablo();
    this.jdField_a_of_type_Ablp = new ablp(this, this.jdField_a_of_type_Ablo);
    this.jdField_a_of_type_Ablp.a();
  }
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = getLayoutInflater().inflate(2131559225, (ViewGroup)localObject, false);
    setContentView(this.jdField_a_of_type_AndroidViewView);
    setOnDismissListener(new ablg(this));
    this.jdField_a_of_type_AndroidWidgetGridLayout = ((GridLayout)((FrameLayout)localObject).findViewById(2131367623));
    a();
    localObject = findViewById(2131380321);
    ((View)localObject).setOnClickListener(new ablh(this));
    ((View)localObject).setContentDescription(amtj.a(2131690768));
    setCanceledOnTouchOutside(false);
  }
  
  public abof a(View paramView)
  {
    try
    {
      int[] arrayOfInt = new int[2];
      paramView.getLocationOnScreen(arrayOfInt);
      paramView = new abof(paramView.getWidth(), paramView.getHeight(), arrayOfInt[0], arrayOfInt[1]);
      return paramView;
    }
  ...
  {
    Object localObject1 = this.jdField_a_of_type_Abld.a().getAds();
    ...
    ImageView localImageView = (ImageView)paramLinearLayout.findViewById(2131368236);
    Object localObject2 = ((GdtAd)localObject1).info.display_info.basic_info.img.get();
    abrl.a("GdtAdBoxDialog", "bindView() i = [" + paramInt7 + "], j = [" + paramInt8 + "], url = [" + (String)localObject2 + "]");
    try
    {
      localImageView.setImageDrawable(MiniAppUtils.getIcon(localImageView.getContext(), (String)localObject2, true, 2130841172, 65));
      localObject2 = (TextView)paramLinearLayout.findViewById(2131371615);
      ...
      this.jdField_a_of_type_Aboe.a(localImageView);
      ...
      localImageView.setOnClickListener(new abli(this));
      localImageView.setTag(2131367452, localObject1);
      localImageView.setTag(2131380829, localObject1);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        abrl.d("GdtAdBoxDialog", "bad url params", localException);
      }
      localImageView.setTag(2131380828, new ablj(this));
      localImageView.getViewTreeObserver().addOnGlobalLayoutListener(new ablk(this, localImageView));
    }
  }
  
  public void a(abld paramabld)
  {
    this.jdField_a_of_type_Abld = paramabld;
  }
  
  protected void a(ablo paramablo)
  {
    abrl.a("GdtAdBoxDialog", "bindData() called with: model = [" + paramablo + "]");
    int i = this.jdField_a_of_type_Abld.a().getAds().size();
    if (i == 0)
    {
    ...
    for (;;)
    {
      ...
      int n = absw.a(23.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      int i1 = absw.a(21.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      int i2 = absw.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      int i3 = absw.a(0.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      int i4 = absw.a(65.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      int i5 = i4 + absw.a(24.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      int i6 = absw.a(22.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      ...
      if (j < m)
      {
        ...
        for (;;)
        {
          ...
          LinearLayout localLinearLayout = (LinearLayout)paramablo.inflate(2131559218, null);
  ...
  {
    Object localObject = paramView.getTag(2131380829);
    if ((localObject != null) && ((localObject instanceof GdtAd)))
    {
      localObject = (GdtAd)localObject;
      GdtReporter.doCgiReport(this.jdField_a_of_type_Aboe.b(((GdtAd)localObject).getUrlForImpression(), a(paramView)));
    }
  }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_ComTencentAdTangramUtilAdExposureChecker$ExposureCallback == null) {
      this.jdField_a_of_type_ComTencentAdTangramUtilAdExposureChecker$ExposureCallback = new abll(this);
    }
  }
  
  public void b(ablo paramablo)
  {
    a(paramablo);
  }
  ...
  {
    if (this.jdField_a_of_type_Ablp.a()) {
      return;
    }
    super.onBackPressed();
  }
  ...
  public void onWindowFocusChanged(boolean paramBoolean)
  {
    ...
    abrl.a("GdtAdBoxDialog", "onWindowFocusChanged() called with: hasFocus = [" + paramBoolean + "]");
  }
}
