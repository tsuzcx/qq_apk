...
{
  public afvo(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (j == 2131365350)
        {
          ...
          if (this.a.jdField_d_of_type_Int == 20)
          {
            ...
            localObject1 = ((afwl)localObject2).a.getTag();
            ...
            localObject1 = (afwe)this.a.jdField_a_of_type_Afwg.getItem(i);
            this.a.a((afwe)localObject1);
            break;
            i = 0;
            break label100;
            label314:
          ...
          {
            if (this.a.jdField_a_of_type_Afwg.jdField_b_of_type_JavaUtilList.contains(localObject1)) {
              this.a.jdField_a_of_type_Afwg.jdField_b_of_type_JavaUtilList.remove(localObject1);
            }
            for (;;)
            {
              TroopMemberListActivity.a(this.a);
              this.a.jdField_a_of_type_Afwg.notifyDataSetChanged();
              break;
              if (i != 0) {
                this.a.jdField_a_of_type_Afwg.jdField_b_of_type_JavaUtilList.add(localObject1);
              }
            }
          }
          if (bool1)
          {
            ...
            if (localObject2 != null) {
              ((afwl)localObject2).a.a(true);
            }
            if (!TextUtils.isEmpty(this.a.u))
            {
              localObject2 = this.a.a(this.a.u, bool1);
              if (localObject2 != null) {
                ((afwl)localObject2).a.b(true);
              }
            }
      ...
      else if ((j == 2131363842) && (this.a.c))
      {
        ...
        {
          if (this.a.isResume()) {
            QQToast.a(this.a, this.a.getString(2131693965), 0).b(this.a.getTitleBarHeight());
          }
        }
