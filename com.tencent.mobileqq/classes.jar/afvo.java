  ...
  extends afup
{
  ...
  private Queue<afvs> jdField_a_of_type_JavaUtilQueue = new LinkedList();
  
  public afvo(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  private boolean a()
  {
    ...
    {
      localObject2 = (afvs)this.jdField_a_of_type_JavaUtilQueue.peek();
      if (localObject2 != null)
      {
        localObject1 = ((afvs)localObject2).jdField_a_of_type_JavaLangString;
        i = ((afvs)localObject2).jdField_a_of_type_Int;
        label107:
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.setImageAssetDelegate(new afvq(this, (String)localObject2));
        LottieComposition.Factory.fromInputStream(this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.getContext(), localIOException2, new afvr(this, localIOException2));
        ...
        switch (this.jdField_a_of_type_Afvt.jdField_a_of_type_Int)
        {
        }
        for (;;)
        {
          return true;
          if (this.jdField_a_of_type_Afvt.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo == null) {
            break;
          }
          str = this.jdField_a_of_type_Afvt.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.troopuin;
          long l = this.jdField_a_of_type_Afvt.jdField_a_of_type_ComTencentMobileqqDataTroopTroopInfo.dwGroupClassExt;
          bdla.b(null, "dc00898", "", this.jdField_a_of_type_Afvt.jdField_a_of_type_JavaLangString, "0X800AE17", "0X800AE17", i, 0, str, String.valueOf(l), "", "");
        }
        str = null;
      }
      String str = "";
  ...
  protected boolean a(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    Object localObject = (InputLinearLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131368910);
    if (localObject != null) {}
    for (paramInt4 = ((InputLinearLayout)localObject).getHeight();; paramInt4 = 0)
    {
      localObject = (PanelIconLinearLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372419);
      if (localObject != null) {
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    if (paramVarArgs.length > 2)
    {
      ...
      if ((!TextUtils.isEmpty(str)) && (i != 0)) {
        this.jdField_a_of_type_JavaUtilQueue.add(new afvs(this, str, i, null));
      }
      paramVarArgs = paramVarArgs[2];
      if ((paramVarArgs != null) && ((paramVarArgs instanceof afvt))) {
        this.jdField_a_of_type_Afvt = ((afvt)paramVarArgs);
      }
    ...
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)View.inflate(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext(), 2131558596, null));
      if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
      {
        if (QLog.isColorLevel()) {
      ...
      this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView = ((DiniFlyAnimationView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131362333));
      ...
      this.jdField_a_of_type_ComTencentMobileqqDiniflyDiniFlyAnimationView.addAnimatorListener(new afvp(this));
