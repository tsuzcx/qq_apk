...
public class yep
{
  ...
  static
  {
    jdField_a_of_type_ArrayOfJavaLangString = weg.a(2130968663);
  }
  ...
  public String a(int paramInt, TextPaint paramTextPaint)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localStringBuilder.append(weg.a(2131699213, new Object[] { Integer.valueOf(this.g) }));
        return localStringBuilder.toString();
        if (this.jdField_a_of_type_Boolean)
        {
          localStringBuilder.append(UIUtils.formatCount(j)).append("个小视频");
        ...
        if (this.jdField_a_of_type_JavaUtilArrayList.size() > 0)
        {
          ...
          i = n;
          j = m;
          if (this.jdField_a_of_type_Wkv != null)
          {
            i = this.jdField_a_of_type_Wkv.b;
            k = this.jdField_a_of_type_Wkv.jdField_a_of_type_Int;
            l1 = this.jdField_a_of_type_Wkv.c;
            j = m;
          }
        }
        localStringBuilder.append(UIUtils.formatCount(j)).append("个小视频");
  ...
  public void a()
  {
    ...
    do
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        int i = yex.a(localStoryVideoItem.mUploadStatus);
        if ((i == 1) || (i == 0))
        {
  ...
  public void c(StoryVideoItem paramStoryVideoItem)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          if ((this.jdField_a_of_type_JavaUtilArrayList.size() != 0) || (this.jdField_a_of_type_Wkv == null)) {
            break;
          }
          this.jdField_a_of_type_Wkv.b = 0;
          this.jdField_a_of_type_Wkv.jdField_a_of_type_Int = 0;
          this.jdField_a_of_type_Wkv.c = 0;
          paramStoryVideoItem = (wjl)wjs.a(10);
