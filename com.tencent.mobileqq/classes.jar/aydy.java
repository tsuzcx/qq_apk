  ...
  implements Manager
{
  ...
  public void b(MessageForPic paramMessageForPic)
  {
    ...
    int n;
    String str1;
    if (aydq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPic.istroop, paramMessageForPic.frienduin) == 3)
    {
      m = 1;
      n = baec.a(l1, l2);
      if (n != 0) {
    ...
    {
      str2 = str1;
      if (bkkh.a(paramMessageForPic.imageType)) {
        str2 = str1 + "Dynamic";
      }
