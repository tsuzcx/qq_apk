  ...
  extends ajrn
{
      ...
      try
      {
        ...
        if (this.c == 0)
        {
          ...
          if (j < this.jdField_b_of_type_Int)
          {
            ...
            localajpz = (ajpz)((View)localObject).getTag();
            i1 = m * n * paramInt + i;
        ...
        {
          localObject = ((ajpx)this.jdField_a_of_type_JavaUtilList.get(i1)).a;
          ...
          if ((localObject != null) && (((ApolloActionData)localObject).actionName != null)) {
            localajpz.jdField_a_of_type_AndroidWidgetTextView.setText(((ApolloActionData)localObject).actionName);
          }
          localajpz.jdField_a_of_type_Ajpx = ((ajpx)this.jdField_a_of_type_JavaUtilList.get(i1));
          localajpz.jdField_a_of_type_Ajpx.c = 1;
        }
        else
        {
  ...
  public boolean a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject1 = (ajol)paramQQAppInterface.getManager(154);
        ...
        else
        {
          ...
          for (paramSessionInfo = ((ajol)localObject1).jdField_a_of_type_JavaUtilList;; paramSessionInfo = ((ajol)localObject1).b)
          {
    ...
    label140:
    Object localObject2 = (ajmu)paramQQAppInterface.getManager(155);
    if (localObject2 != null)
    {
      localObject2 = ((ajmu)localObject2).a(((ApolloActionRecentData)paramSessionInfo.get(i)).actionId);
      localObject1 = localObject2;
      if (localObject2 == null) {}
    }
    for (;;)
    {
      localObject2 = new ajqd(paramQQAppInterface.c());
      ((ajqd)localObject2).a = ((ApolloActionData)localObject1);
      ((ajqd)localObject2).c = 1;
