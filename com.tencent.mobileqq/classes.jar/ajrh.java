  ...
  implements awbo
{
  ...
  public ajrh(QQAppInterface paramQQAppInterface)
  {
  ...
  public ReqItem a(int paramInt)
  {
    ...
    {
      localObject1 = (bahr)this.app.getManager(31);
      if (localObject1 != null) {
        ((bahr)localObject1).a(true, this);
      }
    }
    if (this.a != null)
    {
      Object localObject2 = this.app.jdField_a_of_type_Avys.a(this.a.getServiceCmd());
