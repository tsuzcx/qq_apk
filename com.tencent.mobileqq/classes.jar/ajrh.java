...
public class ajrh
  extends beci
{
  public ajrh(ChatHistoryC2CAllFragment paramChatHistoryC2CAllFragment) {}
  ...
  public void a(boolean paramBoolean, Object[] paramArrayOfObject)
  {
    try
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131719270).equals(str))
      {
        paramArrayOfObject = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getMsgItemByUniseq(((DocsGrayTipsInfo)localObject).a, 0, l);
      ...
      QLog.i(beay.i, 2, " onGetUserAuth  isSuccess = " + paramBoolean + " tips =" + str);
      return;
    }
    catch (Exception paramArrayOfObject)
    {
      QLog.e(beay.i, 2, " onGetUserAuth  exception = " + paramArrayOfObject.toString());
    }
  }
  ...
  public void b(boolean paramBoolean, Object[] paramArrayOfObject)
  {
    try
    {
      QLog.i(beay.i, 2, " onSetUserAuth  isSuccess = " + paramBoolean);
      Object localObject = (DocsGrayTipsInfo)paramArrayOfObject[0];
      String str = (String)paramArrayOfObject[1];
      long l = ((Long)paramArrayOfObject[2]).longValue();
      if (paramBoolean)
    ...
    {
      QLog.e(beay.i, 1, " onSetUserAuth  exception  = " + paramArrayOfObject.toString());
    }
  }
}
