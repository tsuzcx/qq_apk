  ...
  extends qzn
{
  ...
  public qzs(ViewGroup paramViewGroup, long paramLong, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, @Nullable String paramString3)
  {
    ...
    TextView localTextView2 = (TextView)a(2131381082);
    TextView localTextView1 = (TextView)a(2131381087);
    ((TextView)a(2131381084)).setText(paramString2);
    ...
    for (paramViewGroup = String.valueOf(paramLong / 100L);; paramViewGroup = String.valueOf((float)paramLong / 100.0F))
    {
      ...
      localTextView1.setOnClickListener(new qzt(this, paramInt1, paramInt2, paramInt3));
  ...
  {
    return LayoutInflater.from(paramViewGroup.getContext()).inflate(2131562758, paramViewGroup, false);
  }
