...
class albf
  extends Handler
{
  albf(albe paramalbe, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message arg1)
  {
    ...
    case 1: 
      synchronized (albe.a())
      {
        ...
        if ((ReportInfo)albe.a(this.a).get(Long.valueOf(localReportHeader.seqno)) != null)
        {
          if (QLog.isColorLevel()) {
      ...
      if (localObject5 != null)
      {
        ...
        albe.a(this.a).add(localObject5);
      }
      albe.a(this.a).put(Long.valueOf(localObject1.seqno), localReportInfo);
      albe.b(this.a).add(localObject1);
      albe.a().notify();
      return;
    case 2: 
      for (;;)
      {
        synchronized (albe.a())
        {
          ...
          localObject5 = (ReportInfo)albe.a(this.a).get(Long.valueOf(l));
          if (localObject5 != null) {
            break;
          }
          if (QLog.isColorLevel())
    ...
    case 3: 
      for (;;)
      {
        synchronized (albe.a())
        {
          ...
          localObject4 = (ReportInfo)albe.a(this.a).get(Long.valueOf(l));
      ...
      else
      {
        ...
        albe.a(this.a).add(???);
        albe.b(this.a, 5);
        localObject4 = albe.b(this.a).obtainMessage();
        if (localObject4 != null)
        {
          ((Message)localObject4).arg1 = 5;
          ((Message)localObject4).obj = new Object[] { Long.valueOf(l), ??? };
          albe.b(this.a).sendMessageDelayed((Message)localObject4, 10000L);
        }
        return;
      }
      break;
    ...
    for (??? = ???.step;; ??? = ".")
    {
      ...
      synchronized (albe.a())
      {
        ...
        if ((ReportInfo)albe.a(this.a).get(Long.valueOf(((ReportHeader)???).seqno)) != null)
        {
          if (QLog.isColorLevel()) {
      ...
      localReportInfo.body.reportItems.add(localObject5);
      albe.a(this.a).put(Long.valueOf(localObject3.seqno), localReportInfo);
      albe.b(this.a).add(localObject3);
      albe.a(this.a).add(localObject5);
      albe.a(this.a, 1);
      return;
      ??? = ".";
