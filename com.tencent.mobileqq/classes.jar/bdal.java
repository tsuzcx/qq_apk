  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    localBundle.putString("file_send_path", bdak.a(this.a));
    ...
    for (;;)
    {
      ...
      localObject1 = "";
      if ((bdak.b(this.a) == null) || (bdak.b(this.a).equals(""))) {
        break label520;
      }
      localBundle.putString("struct_msg_video_info", bdak.b(this.a));
      ...
      try
      {
        localObject3 = new JSONObject(bdak.b(this.a));
      ...
      bcst.b((QQAppInterface)localObject3, "P_CliOper", "Pb_account_lifeservice", "", "0X8005C9A", "0X8005C9A", 0, 1, 0, ((StructMsgForGeneralShare)localObject2).uin, ((StructMsgForGeneralShare)localObject2).currentAccountUin, bdak.a(this.a), (String)localObject1);
      if ((((StructMsgForGeneralShare)localObject2).message != null) && ("1".equals(((StructMsgForGeneralShare)localObject2).message.getExtInfoFromExtStr("is_AdArrive_Msg")))) {
        try
        {
          ...
          ((JSONObject)localObject1).put("net", String.valueOf(nlw.a()));
          ((JSONObject)localObject1).put("mobile_imei", bgln.a());
          ...
          txr.a((AppInterface)localObject3, ((StructMsgForGeneralShare)localObject2).message.selfuin, ((JSONObject)localObject1).toString(), "" + ((StructMsgForGeneralShare)localObject2).msgId);
        }
