...
public class bdal
{
  ...
  private static Map<String, bdan<Bitmap>> jdField_a_of_type_JavaUtilMap = Collections.synchronizedMap(new HashMap());
  ...
  public static Bitmap a(Resources paramResources, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localbdam.jdField_a_of_type_AndroidGraphicsBitmap = BitmapFactory.decodeResource(paramResources, paramInt, (BitmapFactory.Options)localObject);
      }
      catch (OutOfMemoryError paramResources)
      {
        Object localObject;
        localbdam.jdField_a_of_type_Int = 1;
        continue;
      }
      catch (Throwable paramResources)
      {
        localbdam.jdField_a_of_type_Int = 3;
        continue;
      }
      if (localbdam.jdField_a_of_type_AndroidGraphicsBitmap != null)
      {
        localbdam.jdField_a_of_type_Int = 0;
        paramResources = String.valueOf(localbdam.jdField_a_of_type_AndroidGraphicsBitmap.hashCode());
        localObject = new bdan(paramResources, localbdam.jdField_a_of_type_AndroidGraphicsBitmap, jdField_a_of_type_JavaLangRefReferenceQueue);
        jdField_a_of_type_JavaUtilMap.put(paramResources, localObject);
      }
      return localbdam.jdField_a_of_type_AndroidGraphicsBitmap;
  ...
  public static Bitmap a(Resources paramResources, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramResources != null)
    {
      ...
      bdan localbdan = new bdan((String)localObject, paramResources, jdField_a_of_type_JavaLangRefReferenceQueue);
      jdField_a_of_type_JavaUtilMap.put(localObject, localbdan);
    }
  ...
  public static Bitmap a(InputStream paramInputStream, Rect paramRect, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      if (paramInputStream != null)
      {
        ...
        localObject = new bdan(paramRect, paramInputStream, jdField_a_of_type_JavaLangRefReferenceQueue);
  ...
  public static Bitmap a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (paramString != null)
    {
      ...
      bdan localbdan = new bdan((String)localObject, paramString, jdField_a_of_type_JavaLangRefReferenceQueue);
      jdField_a_of_type_JavaUtilMap.put(localObject, localbdan);
    }
    return paramString;
  }
  ...
  public static Bitmap a(String paramString, BitmapFactory.Options paramOptions)
  {
    ...
    a(paramString, paramOptions, localbdam);
    return localbdam.jdField_a_of_type_AndroidGraphicsBitmap;
  }
  ...
  public static Bitmap a(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localbdam.jdField_a_of_type_AndroidGraphicsBitmap = SafeBitmapFactory.decodeByteArray(paramArrayOfByte, paramInt1, paramInt2, localOptions);
      }
      ...
      {
        localbdam.jdField_a_of_type_Int = 0;
        paramArrayOfByte = String.valueOf(localbdam.jdField_a_of_type_AndroidGraphicsBitmap.hashCode());
        localObject = new bdan(paramArrayOfByte, localbdam.jdField_a_of_type_AndroidGraphicsBitmap, jdField_a_of_type_JavaLangRefReferenceQueue);
  ...
  public static bdam a(String paramString, BitmapFactory.Options paramOptions)
  {
    bdam localbdam = new bdam();
    a(paramString, paramOptions, localbdam);
    return localbdam;
  ...
  private static void a()
  {
    for (;;)
    {
      bdan localbdan = (bdan)jdField_a_of_type_JavaLangRefReferenceQueue.poll();
      if (localbdan == null) {
        break;
      }
      jdField_a_of_type_JavaUtilMap.remove(bdan.a(localbdan));
    }
  }
  
  /* Error */
  public static void a(String paramString, BitmapFactory.Options paramOptions, bdam parambdam)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 8
    ...
    //   44: aload_2
    //   45: iconst_2
    //   46: putfield 107	bdam:jdField_a_of_type_Int	I
    //   49: iconst_0
    //   50: ifeq +11 -> 61
    ...
    //   182: aload_2
    //   183: iconst_3
    //   184: putfield 107	bdam:jdField_a_of_type_Int	I
    //   187: aload 4
    //   189: ifnull +8 -> 197
    //   192: aload 4
    ...
    //   242: putfield 105	bdam:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   245: aload 4
    //   247: ifnull +8 -> 255
    //   250: aload 4
    ...
    //   268: aload_2
    //   269: getfield 105	bdam:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   272: ifnull -200 -> 72
    //   275: aload_2
    //   276: iconst_0
    //   277: putfield 107	bdam:jdField_a_of_type_Int	I
    //   280: new 117	bdan
    //   283: dup
    //   284: aload_0
    //   285: aload_2
    //   286: getfield 105	bdam:jdField_a_of_type_AndroidGraphicsBitmap	Landroid/graphics/Bitmap;
    //   289: getstatic 29	bdal:jdField_a_of_type_JavaLangRefReferenceQueue	Ljava/lang/ref/ReferenceQueue;
    //   292: invokespecial 120	bdan:<init>	(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/ref/ReferenceQueue;)V
    //   295: astore_1
    //   296: getstatic 24	bdal:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   299: aload_0
    //   300: aload_1
    ...
    //   320: aload_2
    //   321: iconst_2
    //   322: putfield 107	bdam:jdField_a_of_type_Int	I
    //   325: aload 4
    //   327: ifnull +8 -> 335
    //   330: aload 4
    ...
    //   363: aload_2
    //   364: iconst_1
    //   365: putfield 107	bdam:jdField_a_of_type_Int	I
    //   368: aload 4
    //   370: ifnull +8 -> 378
    //   373: aload 4
    ...
    //   406: aload_2
    //   407: iconst_3
    //   408: putfield 107	bdam:jdField_a_of_type_Int	I
    //   411: aload 4
    //   413: ifnull +8 -> 421
    //   416: aload 4
  ...
  public static Bitmap b(Resources paramResources, int paramInt)
  {
    ...
    try
    {
      localbdam.jdField_a_of_type_AndroidGraphicsBitmap = BitmapFactory.decodeResource(paramResources, paramInt, new BitmapFactory.Options());
      if (localbdam.jdField_a_of_type_AndroidGraphicsBitmap != null)
      {
        localbdam.jdField_a_of_type_Int = 0;
        paramResources = String.valueOf(localbdam.jdField_a_of_type_AndroidGraphicsBitmap.hashCode());
        bdan localbdan = new bdan(paramResources, localbdam.jdField_a_of_type_AndroidGraphicsBitmap, jdField_a_of_type_JavaLangRefReferenceQueue);
        jdField_a_of_type_JavaUtilMap.put(paramResources, localbdan);
      }
      return localbdam.jdField_a_of_type_AndroidGraphicsBitmap;
    }
    catch (OutOfMemoryError paramResources)
