  ...
  extends bnhq
{
  ...
  public void a()
  {
    ...
    if (localRMVideoStateMgr != null)
    {
      ...
      if (localRMVideoStateMgr.jdField_a_of_type_Bnhw != null) {
        localRMVideoStateMgr.jdField_a_of_type_Bnhw.a();
      }
  ...
  public void a(AVCodec.AVCodecCallback paramAVCodecCallback, MessageStruct paramMessageStruct)
  {
    ...
    paramAVCodecCallback.jdField_a_of_type_Bnhk = null;
    if (QLog.isColorLevel()) {
  ...
  public void a(Object paramObject, int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      if (paramVarArgs != null) {
        ...
        else if ((paramVarArgs[0] instanceof String))
        {
          ...
          {
            this.d = true;
            RMVideoStateMgr.a().a(2002, alud.a(2131713846), false);
          }
          if (QLog.isColorLevel()) {
            QLog.d("RMVideoInitState", 2, "[@] EVENT_CREATE_CAMERA, error = " + paramVarArgs[0]);
          }
          if (1 == bnfi.a) {
            bjwi.a(bnqj.a + "", "qzone_video_record", "2", null);
          }
          localObject = BaseApplicationImpl.sApplication.getQQProcessName();
          if ((localObject != null) && (((String)localObject).endsWith(":story")))
          {
            ...
            if ((paramVarArgs != null) && ((paramVarArgs[0] instanceof String)))
            {
              ...
              {
                this.d = true;
                RMVideoStateMgr.a().a(2003, alud.a(2131713857), false);
              }
              if (QLog.isColorLevel())
              {
                ...
                {
                  this.d = true;
                  RMVideoStateMgr.a().a(2002, alud.a(2131713858), false);
                }
                if (QLog.isColorLevel()) {
                ...
                if (1 == bnfi.a)
                {
                  bjwi.a(bnqj.a + "", "qzone_video_record", "4", null);
                  continue;
                  if ((paramObject instanceof AudioCapture))
                  {
                    ...
                    case 3: 
                      ...
                      else
                      {
                        ...
                        while (1 == bnfi.a)
                        {
                          bjwi.a(bnqj.a + "", "qzone_video_record", "5", null);
                          break;
                          if (QLog.isColorLevel()) {
                    ...
                    case 5: 
                      ...
                      for (;;)
                      {
                        ...
                        {
                          RMVideoStateMgr.a().b(0, alud.a(2131713849), false);
                          ((RMVideoStateMgr)localObject).f = true;
                        }
                        if (1 != bnfi.a) {
                          break;
                        }
                        bjwi.a(bnqj.a + "", "qzone_video_record", "6", null);
                        break;
                        ((RMVideoStateMgr)localObject).b(false);
                      }
                    case 6: 
    ...
    for (;;)
    {
      if (!((RMVideoStateMgr)localObject).f)
      {
        RMVideoStateMgr.a().b(0, alud.a(2131713848), false);
        ((RMVideoStateMgr)localObject).f = true;
      }
      if (1 != bnfi.a) {
        break;
      }
      bjwi.a(bnqj.a + "", "qzone_video_record", "7", null);
      break;
      ((RMVideoStateMgr)localObject).b(false);
    }
  }
