  ...
  extends azql
{
  ...
  public azsg()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new azsj(this);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (i > 1) {
      if (j == 0)
      {
        paramContext.setBackgroundResource(2130838180);
        i = 0;
      }
    }
    for (;;)
    {
      paramContext.setTag(2131377057, Integer.valueOf(i));
      ...
      if ((!b()) || ((b()) && (a())))
      {
        ...
        paramContext.setOnLongClickListener(new azsh(this));
        paramContext.setOnTouchListener(new azsi(this));
        return paramContext;
        if (j == i - 1)
        {
          paramContext.setBackgroundResource(2130838184);
          i = 2;
        }
        else
        {
          paramContext.setBackgroundResource(2130838182);
          i = 1;
        }
      }
      else
  ...
  public void a(String paramString, MessageRecord paramMessageRecord, StructMsgForGeneralShare paramStructMsgForGeneralShare)
  {
    ...
    try
    {
      ...
      if ((i != 23001027) && (i != 0) && (i != -4) && (i != -6))
      {
        ...
        if (!((aitd)paramString.getManager(245)).a(paramMessageRecord.frienduin))
        {
          j = 1;
          i = -4;
          if (j != 0) {
