...
public class bcxt
{
  ...
  public bcxt(int paramInt, String paramString1, String paramString2, Object paramObject, Bundle paramBundle)
  {
  ...
  {
    if ((paramObject instanceof bcxt))
    {
      paramObject = (bcxt)paramObject;
      if ((paramObject.jdField_a_of_type_Int == this.jdField_a_of_type_Int) && (bdal.a(this.jdField_a_of_type_JavaLangString, paramObject.jdField_a_of_type_JavaLangString)) && ((3 != this.jdField_a_of_type_Int) || ((bdal.a(this.b, paramObject.b)) && (bdal.a(this.jdField_a_of_type_JavaLangObject, paramObject.jdField_a_of_type_JavaLangObject)) && (bdal.a(this.jdField_a_of_type_AndroidOsBundle, paramObject.jdField_a_of_type_AndroidOsBundle))))) {
        return true;
      }
    }
    return false;
