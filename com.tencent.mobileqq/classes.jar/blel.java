...
class blel
  implements blfl<WeiyunPB.DiskFileBatchDownloadMsgRsp>
{
  blel(blek paramblek, blfn paramblfn, blgf paramblgf, DownloadType paramDownloadType) {}
  
  public void a(int paramInt, String paramString, WeiyunPB.DiskFileBatchDownloadMsgRsp paramDiskFileBatchDownloadMsgRsp)
  {
    this.jdField_a_of_type_Blgf.a(this.jdField_a_of_type_Blfn, false, paramInt, paramString);
  }
  ...
  public void a(WeiyunPB.DiskFileBatchDownloadMsgRsp paramDiskFileBatchDownloadMsgRsp)
  {
    ...
    if ((paramDiskFileBatchDownloadMsgRsp != null) && (paramDiskFileBatchDownloadMsgRsp.file_list != null))
    {
      ...
      } while ((paramDiskFileBatchDownloadMsgRsp == null) || (!TextUtils.equals(paramDiskFileBatchDownloadMsgRsp.file_id.get(), this.jdField_a_of_type_Blfn.jdField_a_of_type_JavaLangString)));
    }
    for (;;)
    {
      if (paramDiskFileBatchDownloadMsgRsp == null)
      {
        this.jdField_a_of_type_Blgf.a(this.jdField_a_of_type_Blfn, false, 1828004, amtj.a(2131714088));
        return;
      }
      ...
      {
        this.jdField_a_of_type_Blfn.a(paramDiskFileBatchDownloadMsgRsp.server_name.get(), paramDiskFileBatchDownloadMsgRsp.server_port.get(), (String)localObject, paramDiskFileBatchDownloadMsgRsp.download_url.get(), paramDiskFileBatchDownloadMsgRsp.video_url.get(), "0");
        if (this.jdField_a_of_type_CooperationWeiyunSdkDownloadDownloadType == DownloadType.FILE_ORDINARY) {
          this.jdField_a_of_type_Blfn.jdField_a_of_type_Blfp.c = blfq.a(this.jdField_a_of_type_Blfn.jdField_a_of_type_Blfp.c);
        }
        this.jdField_a_of_type_Blgf.a(this.jdField_a_of_type_Blfn, true, 0, null);
        return;
      }
