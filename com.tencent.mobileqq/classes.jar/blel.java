  ...
  extends QIPCModule
{
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    {
      paramBundle = (aloz)((QQAppInterface)localObject1).getManager(51);
      if (paramBundle != null)
      {
        ...
        ((Bundle)localObject2).putByteArray("PROFILE_PHOTO", a(a(bcxb.a((AppInterface)localObject1, paramString, (byte)3))));
    ...
    else if ("WATER_MARK_GET_QQCARD_FRIENDINFO".equals(paramString))
    {
      ...
      if (localObject2 != null)
      {
        ...
        paramBundle = ((aloz)localObject2).c(paramString);
        localObject2 = new Bundle();
        ((Bundle)localObject2).putString("QQ_NUMBER", paramString);
        ((Bundle)localObject2).putInt("QQ_LEVEL", paramBundle.iQQLevel);
        ((Bundle)localObject2).putInt("QQ_VIP_LEVEL", paramBundle.iSuperVipLevel);
    ...
    for (paramString = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();; paramString = null)
    {
      ...
      localObject2 = new appi();
      ((appi)localObject2).e = paramBundle.getString("ARG_GIF_PATH");
      ((appi)localObject2).f = ((appi)localObject2).e;
      ((appi)localObject2).a = paramBundle.getString("forward_summary_extra", "");
      ((appi)localObject2).c = paramBundle.getString("widgetinfo", "");
      ((appi)localObject2).a(paramString, BaseApplicationImpl.getContext(), null, ((SessionWrap)localObject1).a());
      return null;
      return null;
    }
  }
