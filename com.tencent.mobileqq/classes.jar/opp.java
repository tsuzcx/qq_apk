  ...
  extends oqg
{
  ...
  private List<ppg> jdField_a_of_type_JavaUtilList = new ArrayList();
  private boolean jdField_a_of_type_Boolean = true;
  private long jdField_b_of_type_Long;
  private List<ppf> jdField_b_of_type_JavaUtilList = new ArrayList();
  private boolean jdField_b_of_type_Boolean = true;
  private long jdField_c_of_type_Long;
  private List<ppg> jdField_c_of_type_JavaUtilList = new ArrayList();
  private boolean jdField_c_of_type_Boolean = true;
  private String j = "";
  private String k = "";
  
  public opp(AppInterface paramAppInterface, atmp paramatmp, ExecutorService paramExecutorService, pdc parampdc, Handler paramHandler)
  {
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      paramToServiceMsg = psg.a((Iterable)localObject, new opq(this));
    ...
    {
      paramToServiceMsg = psg.a((Iterable)localObject, new opr(this));
    ...
    paramToServiceMsg = psg.a((Iterable)localObject, new ops(this));
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    localReqBody.uint64_uin.set(obz.a());
    ...
    for (paramInt1 = 0;; paramInt1 = 1)
    {
      ...
      localObject = pde.a("OidbSvc.0x977", 2423, 5, localReqBody.toByteArray());
