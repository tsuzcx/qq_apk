...
public class bhci
{
  ...
  public bhci(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  private void a()
  {
    ...
    do
    {
      ...
      } while (!bhck.a(((File)localObject).getAbsolutePath()));
      localObject = this.jdField_a_of_type_Bhcj;
    } while (localObject == null);
    if (!bhcg.a(str)) {}
    for (boolean bool = true;; bool = false)
    {
      ((bhcj)localObject).a(this, bool);
      return;
    }
  }
  ...
  public String a()
  {
    return bhcg.a(this.jdField_a_of_type_JavaLangString, this.c);
  }
