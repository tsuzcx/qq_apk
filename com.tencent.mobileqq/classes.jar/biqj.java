  ...
  extends biql
{
  ...
  public biqj(Context paramContext, String paramString)
  {
  ...
  protected void a(Canvas paramCanvas, ArrayList<Integer> paramArrayList)
  {
    ...
    this.jdField_a_of_type_AndroidTextTextPaint.setShadowLayer(f2 * 20.0F, 0.0F, 0.0F, this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131099985));
  ...
  protected void b()
  {
    ...
    this.jdField_a_of_type_AndroidTextTextPaint.setColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131099984));
    ...
    this.e = this.jdField_a_of_type_Bipz.a("anim", 0L, 1000L, 0, 999, new LinearInterpolator());
  }
