  ...
  implements zyq
{
  ...
  private blhl jdField_a_of_type_Blhl;
  ...
  {
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView = ((VideoPlayerView)paramView.findViewById(2131381321));
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131370342);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131369941);
    ...
    this.jdField_a_of_type_Blhl = new blhl(a(), new ztu(this, null));
  ...
  private void q()
  {
    this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(new zto(this));
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setPreviewVideoClickListener(new ztp(this));
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setNextVideoClickListener(new ztq(this));
    if (a() != null) {
      a().a(new ztr(this));
    }
    a().addOnItemTouchListener(new zts(this));
    this.jdField_a_of_type_ComTencentBizSubscribeWidgetSubscribeFollowInfoView.setOnTouchListener(new ztt(this));
  }
  ...
  private void r()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView != null)
    {
      ...
      if (!this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.i())
      {
  ...
  public zsx a()
  {
    return (zsx)a().a("RELATIVE_ADAPTER_UNIQUE_KEY");
  }
  ...
  protected void a(CertifiedAccountRead.StGetFeedDetailRsp paramStGetFeedDetailRsp, boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView != null) && (paramStGetFeedDetailRsp != null) && (zqm.a(paramStGetFeedDetailRsp.type.get())))
    {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    if ((!bdfk.b()) && (this.jdField_a_of_type_ComTencentWidgetImmersiveSystemBarCompact != null)) {
    ...
    this.jdField_a_of_type_ComTencentBizSubscribeWidgetSubscribeFollowInfoView = ((SubscribeFollowInfoView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131370296));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369325));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369530));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369574));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369389));
    if (a() != null)
    {
      LiuHaiUtils.a(a());
  ...
  {
    if (("share_key_continue_feeds".equals(paramString)) && (paramzos != null) && (this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView != null)) {
      this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setContinueFeeds((List)paramzos.a);
    }
  }
  ...
  {
    super.b(paramStFeed);
    if ((this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentBottomBar != null) && (this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView != null) && (this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.i())) {
  ...
  public boolean c()
  {
    if ((this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView != null) && (this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.h())) {
      return true;
    }
    return super.c();
  }
  ...
  public void d(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    do
    {
      do
      {
        ...
        aanb.a(paramStFeed.poster.id.get(), "auth_" + aaba.a(a()), "clk_recom", 0, 0, new String[] { "", "", paramStFeed.id.get(), paramStFeed.title.get() });
        if (zqm.a(paramStFeed.type.get())) {
          break;
        }
        zqm.a(a(), paramStFeed);
      } while (a() == null);
      ...
      b("share_key_subscribe_feeds_update", new zos(paramStFeed, true));
    } while (a() == null);
  ...
  public boolean f()
  {
    return (this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView == null) || (!this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.e());
  }
