  ...
  extends baum
{
  ...
  bdmu jdField_a_of_type_Bdmu = new bdmu(this);
  URLDrawableDownListener.Adapter jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new bdmr(this);
  private ArrayDeque<bdms> jdField_a_of_type_JavaUtilArrayDeque = new ArrayDeque();
  private boolean jdField_a_of_type_Boolean = true;
  
  public bdmq(ImageView paramImageView)
  {
  ...
  private void b()
  {
    Object localObject = (bdms)this.jdField_a_of_type_JavaUtilArrayDeque.poll();
    if (localObject == null) {
    ...
    do
    {
      ...
      localObject = ((bdms)localObject).a(a());
  ...
  public void a(bdms parambdms)
  {
    this.jdField_a_of_type_JavaUtilArrayDeque.add(parambdms);
  ...
  {
    a(new bdmt(paramString, paramInt));
  }
  ...
  public void onLoadSuccessed(URLDrawable paramURLDrawable)
  {
    ...
    {
      this.jdField_a_of_type_Bdmu.a(paramURLDrawable);
      return;
    }
    b();
  }
