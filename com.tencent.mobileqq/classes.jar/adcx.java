...
public class adcx
  extends bcal
  implements bcdc, bcdv, bchr, bchv
{
  private adcu a;
  protected xmt a;
  
  public adcx(Context paramContext, Activity paramActivity, AppInterface paramAppInterface)
  {
    super(paramContext, paramActivity, paramAppInterface);
    super.preInitPluginEngine();
    this.mWebview = new TouchWebView(paramContext);
    buildBaseWebView(this.mInterface);
    this.jdField_a_of_type_Adcu = new adcu(paramActivity, this.mWebview);
  }
  ...
  protected xmt b()
  {
    ...
    {
      this.jdField_a_of_type_Xmt = new xmt(this.mInterface, this.mInActivity);
      this.jdField_a_of_type_Xmt.a(this);
    }
  ...
  public void bindJavaScript(ArrayList<WebViewPlugin> paramArrayList)
  {
    if (paramArrayList != null)
    {
      ...
      paramArrayList.add(new xmz());
      paramArrayList.add(new noy());
    }
  }
  
  public void c()
  {
    this.jdField_a_of_type_Adcu.a(b());
  }
