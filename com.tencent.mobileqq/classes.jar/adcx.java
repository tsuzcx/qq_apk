  ...
  implements View.OnClickListener, QzoneConfig.QzoneConfigChangeListener
{
  ...
  public adcx(Conversation paramConversation)
  {
  ...
  private void h()
  {
    if (this.jdField_d_of_type_Int == 2)
    {
      ...
      if ((QzoneConfig.isQQCircleShowMessageEntranceTips()) && (vha.a() == 1)) {
  ...
  private void j()
  {
    if ((this.jdField_d_of_type_Int != 0) && (this.jdField_d_of_type_Int != 2))
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetImageView != null)
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130850598);
        this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getString(2131691105));
      }
    }
  }
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a(2131365145);
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a(2131373814);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131374255);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a(2131365146));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a(2131365144));
  ...
  public void a(View paramView)
  {
    ...
    for (boolean bool = PermissionUtils.isStorePermissionEnable(this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a());; bool = true)
    {
      if (!bool)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a().requestPermissions(new adcy(this, paramView), 3, new String[] { "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
        return;
      }
      b(paramView);
      return;
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((QzoneConfig.isQQCircleShowMessageEntrance()) && (QzoneConfig.isQQCircleShowLebaBySwitchButton()))
    {
      ...
      h();
      b(paramBoolean);
      ThreadManager.getSubThreadHandler().post(new ConversationTitleBtnCtrl.2(this));
      return;
    }
    this.jdField_d_of_type_Int = 0;
    h();
  ...
  public void b()
  {
    boolean bool = arnn.d(this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a);
    if (QLog.isDevelopLevel()) {
      QLog.d("ConversationTitleBtnCtrl", 4, "switchType isMatchChatMode =" + bool);
    }
    if (bool)
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130850600);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getString(2131691104));
  ...
  public void b(View paramView)
  {
    ...
    {
      localObject2 = (azvi)this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a.getManager(36);
      BusinessInfoCheckUpdate.AppInfo localAppInfo = ((azvi)localObject2).a(6, "120000");
      localObject1 = bnfm.a(localAppInfo.buffer.get(), "mqqapi://videostory/takevideo?src_type=internal&version=1&from=mainCamera&uin=&appid=406&widgetid=&shareto=1");
      QLog.i("ConversationTitleBtnCtrl", 1, "handleCameraBtnClick---has red point, jumpSchme=" + (String)localObject1);
      ((azvi)localObject2).a(localAppInfo, null);
    }
    ...
    {
      bcef.b(null, "dc00898", "", "", "0X800A2D5", "0X800A2D5", 0, 0, paramView, "", "", "");
      return;
      label270:
      localObject2 = "?";
      break;
  ...
  {
    j();
    if ((this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouch != null) && (apyv.a().jdField_a_of_type_Int == 1) && (Build.VERSION.SDK_INT >= 21) && (this.jdField_d_of_type_Int == 0))
    {
  ...
  public void c(boolean paramBoolean)
  {
    ...
    if ((apyv.a().jdField_a_of_type_Int == 1) && (Build.VERSION.SDK_INT >= 21))
    {
      this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouch.setVisibility(0);
      Object localObject = (azvi)this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a.getManager(36);
      BusinessInfoCheckUpdate.AppInfo localAppInfo = ((azvi)localObject).a(6, "120000");
      ...
      if (bool1)
      {
        ...
        ((azvi)localObject).b(localAppInfo, null);
        if (!paramBoolean) {
          bcef.b(null, "dc00898", "", "", "0X800A2D4", "0X800A2D4", 0, 0, "3", "", "", "");
        }
        label175:
        if (!paramBoolean) {
          break label245;
      ...
      {
        bcef.b(null, "dc00898", "", "", "0X800A2D4", "0X800A2D4", 0, 0, (String)localObject, "", "", "");
        return;
        if ((bool1) || (!bool2)) {
          break label175;
        }
          ...
          else if (this.jdField_d_of_type_Int == 2)
          {
            ...
            else
            {
              ...
              if (this.jdField_d_of_type_Boolean)
              {
                ...
                localHashMap.put("key_unread_red_num", this.jdField_b_of_type_Int + "");
                if (this.jdField_a_of_type_Int > 0) {
                  localHashMap.put("key_assign_show_tab_type", this.jdField_a_of_type_Int + "");
                }
