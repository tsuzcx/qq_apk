  ...
  extends bnff
{
  ...
  public bnfn()
  {
    this.jdField_a_of_type_AndroidOsHandler = new bnfp(this);
  }
  ...
  {
    PhotoCommonBaseData localPhotoCommonBaseData = this.jdField_a_of_type_Bnfu.a;
  ...
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)paramView.findViewById(2131376788);
    super.a(paramView);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.addOnScrollListener(new bnfo(this));
  }
  ...
  public void h()
  {
    if (((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListBaseData.isShowCamera) && ("$RecentAlbumId".equals(this.jdField_a_of_type_Bnfu.a.albumId))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityPhotoAlbumPhotoListBaseData.showCameraInVideo) && ("$VideoAlbumId".equals(this.jdField_a_of_type_Bnfu.a.albumId)))) {
      e();
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_Bnfu.a(paramView, new Bundle(), 2, null);
    }
  }
