...
public class vwf
{
  ...
  public vwf(qqstory_struct.QimVideoInfo paramQimVideoInfo)
  {
  ...
  public static vwf a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new vwf(localQimVideoInfo);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      xvv.c("QimVideoInfoItem", "Error: parse db bytes error.", paramArrayOfByte);
    }
    return null;
  }
