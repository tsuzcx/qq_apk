  ...
  implements bjqx
{
  ...
  {
    parambegz.a().getHandler(bjxt.class).post(new QzoneDeviceTagJsPlugin.1(paramArrayOfString));
  }
  
  private static void b(WebViewPlugin paramWebViewPlugin, begz parambegz, String[] paramArrayOfString)
  {
    parambegz.a().getHandler(bjxt.class).post(new QzoneDeviceTagJsPlugin.2());
  }
