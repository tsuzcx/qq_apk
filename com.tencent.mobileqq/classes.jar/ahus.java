  ...
  implements ahur
{
  ...
  public static ahur a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof ahur))) {
      return (ahur)localIInterface;
    }
    return new ahut(paramIBinder);
  }
