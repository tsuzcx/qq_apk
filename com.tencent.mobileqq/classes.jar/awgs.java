...
public class awgs
{
  private static awgj jdField_a_of_type_Awgj;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j < k)
        {
          ...
          else if ((localRecentBaseData.a() == 6000) && (TextUtils.equals(localRecentBaseData.a(), ajsd.z)))
          {
            localArrayList.add(localRecentBaseData);
            i = j;
          }
        ...
        else
        {
          if ((localArrayList.size() == 0) || (i == -1))
          {
            ...
            paramList = ahmg.a(new RecentUser(ajsd.z, 6000), paramQQAppInterface, paramActivity);
            if (paramList != null)
            {
              paramList.mTitleName = paramActivity.getResources().getString(2131693965);
              localArrayList.add(paramList);
            }
          }
          Collections.sort(localArrayList, new ahmh(paramQQAppInterface));
  ...
  {
    awgj localawgj2 = (awgj)ampl.a().a(485);
    awgj localawgj1 = localawgj2;
    if (localawgj2 == null)
    {
      localawgj2 = new awgj();
      localawgj1 = localawgj2;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ScreenShotHelper", 2, "ScreenShotConfigData switch isOpened = " + localawgj1);
    }
    jdField_a_of_type_Awgj = localawgj1;
  }
  ...
  public static void a(Activity paramActivity)
  {
    ...
    paramActivity = ((ViewGroup)paramActivity.getWindow().getDecorView().getRootView()).findViewById(2131375640);
  ...
  public static void a(Activity paramActivity, Handler paramHandler)
  {
    ...
    View localView = ((ViewGroup)paramActivity.getWindow().getDecorView().getRootView()).findViewById(2131375640);
    if (localView != null)
    {
  ...
  public static void a(Activity paramActivity, String paramString, Handler paramHandler)
  {
    ...
    Object localObject1 = localViewGroup.findViewById(2131375640);
    int k = bbll.b(79.0F);
    ...
    for (;;)
    {
      ...
      {
        localObject3 = View.inflate(paramActivity, 2131562357, null);
        localImageView = (ImageView)((View)localObject3).findViewById(2131375643);
      ...
      for (;;)
      {
        try
        {
          paramActivity.getResources().getDrawable(2130840055);
          ...
          ((URLDrawable.URLDrawableOptions)localObject1).mLoadingDrawable = aywm.b();
  ...
  public static void a(Context paramContext, String paramString)
  {
    ...
    {
      localObject = ((ViewGroup)((Activity)paramContext).getWindow().getDecorView().getRootView()).findViewById(2131375640);
      if (localObject != null) {
          ...
          if (localQQAppInterface.a().a())
          {
            ...
            if (localQQAppInterface.a().a() != null)
            {
              ...
              if (localQQAppInterface.a().a().size() > 0)
              {
                ...
                abtq.a(paramString, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class, 9011);
                i = 1;
              }
            }
          }
    ...
    if (((paramContext instanceof QQBrowserActivity)) && (a((QQBrowserActivity)paramContext)))
    {
      ...
      abtq.a((QQBrowserActivity)paramContext, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class, 11);
    }
    while (i != 0) {
      return;
    }
    abtq.a(paramContext, (Intent)localObject, PublicTransFragmentActivity.class, ScreenShotFragment.class);
  }
  ...
  public static void a(awgj paramawgj)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ScreenShotHelper", 2, "onConfUpdate : " + paramawgj);
    }
    if (paramawgj != null) {
      jdField_a_of_type_Boolean = paramawgj.a();
    }
  }
  ...
  public static boolean a()
  {
    ...
    b = true;
    a();
    jdField_a_of_type_Boolean = jdField_a_of_type_Awgj.a();
    if (QLog.isColorLevel()) {
  ...
  private static boolean a(QQBrowserActivity paramQQBrowserActivity)
  {
    ...
    return paramQQBrowserActivity.getSupportFragmentManager().findFragmentById(2131364705) instanceof WebViewFragment;
  }
  ...
  public List<RecentBaseData> a(Activity paramActivity, QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      ahmh localahmh = new ahmh(paramQQAppInterface);
      localahmh.a(localList);
      if (localList != null) {
        i = localList.size();
      }
      ahmg.a(localList, paramQQAppInterface, paramActivity, localArrayList, i);
      Collections.sort(localArrayList, localahmh);
    }
