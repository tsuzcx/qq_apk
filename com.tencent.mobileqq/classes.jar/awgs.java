  ...
  implements View.OnClickListener
{
  ...
  public awgs(BaseChatPie paramBaseChatPie)
  {
  ...
  {
    bfos localbfos = (bfos)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a.getManager(223);
    if ((localbfos != null) && (localbfos.a != 1)) {
      localbfos.e();
    }
  ...
  public void a(Emoticon paramEmoticon, int paramInt1, String paramString, int paramInt2)
  {
    ...
    if ((this.jdField_a_of_type_Awgo != null) && (((View)this.jdField_a_of_type_Awgo).getVisibility() == 0))
    {
      ...
      {
        this.jdField_a_of_type_Awgx.a();
        this.jdField_a_of_type_Awgx = null;
      }
    }
    do
    {
      do
      {
        ...
        {
          return;
          if ((this.jdField_b_of_type_Awgo == null) || (((View)this.jdField_b_of_type_Awgo).getVisibility() != 0)) {
            break;
          }
          if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_Awgx = null;
        return;
        if ((this.jdField_a_of_type_Awgb == null) || (!this.jdField_a_of_type_Awgb.a())) {
          break;
        }
        if (QLog.isColorLevel()) {
      ...
      this.jdField_a_of_type_Awfj = awgb.a(paramEmoticon, paramInt1, paramInt2);
    ...
    b();
    this.jdField_a_of_type_Awgb = new awgb(this);
    Object localObject2;
    Object localObject1;
    Object localObject3;
    if (paramInt1 == 0)
    {
      ...
      ((View)this.jdField_b_of_type_Awgo).setVisibility(8);
      this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.setVisibility(0);
      localObject2 = this.jdField_a_of_type_Awgo;
      localObject1 = this.jdField_a_of_type_AndroidWidgetTextView;
      this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.setMagicfaceGestureListener(this.jdField_a_of_type_Awgb);
    ...
    for (;;)
    {
      ...
      localObject3 = new awgj();
      ((awgj)localObject3).a((awfv)localObject2);
      this.jdField_a_of_type_Awgb.a((awgj)localObject3);
      this.jdField_a_of_type_Awgb.a(new awgu(this, paramInt1, (TextView)localObject1));
      this.jdField_a_of_type_Awgb.a(new awgv(this, l, paramInt1));
      if (!((awgo)localObject2).a()) {
        break;
      }
      if (QLog.isColorLevel()) {
        QLog.d("MagicfaceViewController", 2, "func playMaigcface ends, step 7.");
      }
      this.jdField_a_of_type_Awgb.a(paramEmoticon, paramInt1, paramString, paramInt2);
      return;
      if (QLog.isColorLevel()) {
      ...
      this.jdField_b_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.updateViewLayout((View)this.jdField_b_of_type_Awgo, (ViewGroup.LayoutParams)localObject2);
      ...
      this.jdField_b_of_type_Awgo.setIsFullScreen(this.jdField_a_of_type_Awfj.jdField_b_of_type_Boolean);
      this.jdField_a_of_type_AndroidViewView.setVisibility(0);
      localObject2 = this.jdField_b_of_type_Awgo;
      localObject1 = this.jdField_c_of_type_AndroidWidgetTextView;
      this.jdField_b_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.setMagicfaceGestureListener(this.jdField_a_of_type_Awgb);
    ...
    ((awgo)localObject2).setSurfaceCreatelistener(new awgw(this, paramEmoticon, paramInt1, paramString, paramInt2));
  }
  
  public void a(Emoticon paramEmoticon, awgx paramawgx)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      return;
      paramawgx = new Emoticon();
      paramawgx.eId = paramEmoticon.eId;
      paramawgx.epId = paramEmoticon.epId;
      paramawgx.magicValue = paramEmoticon.magicValue;
      paramawgx.jobType = paramEmoticon.jobType;
      this.jdField_a_of_type_ComTencentMobileqqDataEmoticon = paramawgx;
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView == null)
    {
      ...
      {
        localView = View.inflate(BaseApplicationImpl.getContext(), 2131561978, null);
        this.jdField_a_of_type_Awgo = ((awgo)localView.findViewById(2131370437));
        this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView = ((MagicfaceContainerView)localView.findViewById(2131370438));
        this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131370451));
        this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131370439));
        this.jdField_b_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131370448));
        this.jdField_a_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131370436));
        this.jdField_d_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131370449));
        this.e = ((Button)localView.findViewById(2131370450));
    ...
    for (View localView = View.inflate(BaseApplicationImpl.getContext(), 2131561977, null);; localView = View.inflate(BaseApplicationImpl.getContext(), 2131561979, null))
    {
      ...
      this.jdField_b_of_type_Awgo = ((awgo)localView.findViewById(2131370440));
      this.jdField_b_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView = ((MagicfaceContainerView)localView.findViewById(2131370442));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370446));
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131370444));
      this.jdField_c_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131370441));
      this.f = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131370443));
      ...
      return;
      localView = View.inflate(BaseApplicationImpl.getContext(), 2131561980, null);
      break;
    }
  }
  ...
  public boolean b()
  {
    if ((this.jdField_a_of_type_Awgb != null) && ((this.jdField_a_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.getVisibility() != 8) || (this.jdField_b_of_type_ComTencentMobileqqMagicfaceViewMagicfaceContainerView.getVisibility() != 8)))
    {
      g();
      return true;
    }
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Awgb.b())
    {
      this.e.setBackgroundResource(2130847168);
      return;
    }
    this.e.setBackgroundResource(2130847167);
  }
  
  public void d()
  {
    if (this.jdField_a_of_type_Awgb.c())
    {
      this.f.setBackgroundResource(2130847117);
      return;
    }
    this.f.setBackgroundResource(2130847165);
  }
  ...
  public void f()
  {
    ...
    if ((this.jdField_a_of_type_Awgb != null) && (this.jdField_a_of_type_Awgb.a() >= 0)) {
      if (this.jdField_a_of_type_Awgb.a() != 0) {
        break label83;
      }
    }
    label83:
    for (localEmoticon.magicValue = "value=1";; localEmoticon.magicValue = ("value=" + this.jdField_a_of_type_Awgb.a()))
    {
  ...
  public void g()
  {
    if (this.jdField_a_of_type_Awgb != null)
    {
      ...
      ((View)this.jdField_b_of_type_Awgo).setVisibility(8);
      this.jdField_b_of_type_Awgo.setSurfaceCreatelistener(null);
    }
    try
    {
      if (QLog.isColorLevel()) {
    ...
    if (this.jdField_a_of_type_Awgb.a())
    {
      localObject = this.jdField_a_of_type_Awgb;
      ((awgb)localObject).a(new awgt(this, (awgb)localObject));
    }
    for (;;)
    {
      if (this.jdField_a_of_type_Awgx != null)
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131370449: 
      for (;;)
      {
        ...
        return;
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), "CliOper", "", "", "MbFasong", "MbGuanbi", 0, 0, this.jdField_a_of_type_JavaLangString, "", "", "");
        g();
        continue;
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), "CliOper", "", "", "MbJieshou", "MbZhudongGuanbi", 0, 0, this.jdField_a_of_type_JavaLangString, "", "", "");
        g();
        continue;
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), "CliOper", "", "", "MbFasong", "MbChongzuo", 0, 0, this.jdField_a_of_type_JavaLangString, "", "", "");
        if (this.jdField_a_of_type_Awgb != null)
        {
          this.jdField_a_of_type_Awgb.f();
    ...
    case 2131370450: 
      bool3 = this.jdField_a_of_type_Awgb.b();
      localawgb = this.jdField_a_of_type_Awgb;
      if (!bool3)
      {
        bool1 = true;
        label275:
      ...
      for (bool1 = bool2;; bool1 = false)
      {
        ...
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), "CliOper", "", "", "MbFasong", "MbKaiqiShengxiao", 0, 0, "", "", "", "");
        break;
        bool1 = false;
        break label275;
      }
    }
    bool2 = this.jdField_a_of_type_Awgb.c();
    awgb localawgb = this.jdField_a_of_type_Awgb;
    if (!bool2)
    {
      bool1 = true;
      label381:
    ...
    for (boolean bool1 = bool3;; bool1 = false)
    {
      ...
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), "CliOper", "", "", "MbJieshou", "MbKaiqiShengxiao2", 0, 0, "", "", "", "");
      break;
      bool1 = false;
      break label381;
    }
