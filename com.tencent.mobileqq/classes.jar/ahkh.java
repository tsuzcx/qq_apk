  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if ((this.a.jdField_a_of_type_AndroidContentContext instanceof FragmentActivity))
      {
        ...
        {
          localObject2 = (agmv)((BaseChatPie)localObject2).a(27);
          if (localObject2 != null) {
            ((agmv)localObject2).a((String)localObject1, localadrt, 0);
          }
        }
      }
      Object localObject2 = MessageForText.getTroopMemberInfoFromExtrJson(localMessageForText.getExtInfoFromExtStr(bbyw.i));
      adrm.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (String)localObject1, (ArrayList)localObject2, localadrt);
    ...
    {
      bcst.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_msg", "", "grp_msg", "clk_like", 0, 0, localMessageForText.frienduin, "", (String)localObject1, "");
      break;
