...
public class aahy
{
  ...
  public static aahz a(JSONObject paramJSONObject)
  {
    int i = 0;
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < paramJSONObject.length())
        {
          ...
          aaia localaaia = new aaia();
          localaaia.jdField_a_of_type_JavaLangString = localJSONObject.optString("img");
          localaaia.jdField_b_of_type_JavaLangString = localJSONObject.optString("jumpUrl");
          if ((TextUtils.isEmpty(localaaia.jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(localaaia.jdField_b_of_type_JavaLangString))) {
            break label215;
          }
          localArrayList.add(localaaia);
        }
      }
      ...
      for (;;)
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject)) {
          paramJSONObject = anvx.a(2131704739);
        }
        ...
        {
          localObject = new aahz();
          ((aahz)localObject).jdField_a_of_type_JavaLangString = paramJSONObject;
          ((aahz)localObject).jdField_a_of_type_JavaUtilList = localArrayList;
          return localObject;
        }
      }
      label215:
  ...
  public static aaia a(JSONObject paramJSONObject)
  {
    try
    {
  ...
  public static aaib a(JSONObject paramJSONObject)
  {
    try
    {
      ...
      {
        aaib localaaib = new aaib();
        localaaib.jdField_a_of_type_JavaLangString = str;
        localaaib.jdField_b_of_type_JavaLangString = paramJSONObject;
        return localaaib;
      }
    }
    catch (Exception paramJSONObject)
  ...
  public static void a(com.tencent.mobileqq.app.QQAppInterface paramQQAppInterface, com.tencent.mobileqq.config.struct.splashproto.ConfigurationService.Config paramConfig)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 170	com/tencent/mobileqq/app/QQAppInterface:getCurrentUin	()Ljava/lang/String;
    //   4: astore 5
    //   6: aload 5
    //   8: invokestatic 172	aahy:a	(Ljava/lang/String;)I
    //   11: istore 4
    //   13: aload_1
    ...
    //   24: dup
    //   25: invokespecial 90	java/lang/StringBuilder:<init>	()V
    //   28: ldc 185
    ...
    //   70: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   156: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   217: invokestatic 241	ayym:a	([B)[B
    //   220: astore_0
    //   221: aload_0
    //   222: ifnull +291 -> 513
    //   225: new 113	java/lang/String
    //   228: dup
    //   229: aload_0
    //   230: ldc 243
    ...
    //   236: aload_0
    //   237: ifnull +266 -> 503
    //   240: invokestatic 85	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   243: ifeq +28 -> 271
    //   246: ldc 87
    //   248: iconst_2
    //   249: new 89	java/lang/StringBuilder
    //   252: dup
    //   253: invokespecial 90	java/lang/StringBuilder:<init>	()V
    //   256: ldc 248
    ...
    //   271: new 31	org/json/JSONObject
    //   274: dup
    //   275: aload_0
    ...
    //   298: ldc_w 264
    //   301: aload_0
    //   302: invokestatic 267	aahy:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   305: aload_1
    //   306: ldc_w 269
    ...
    //   335: ldc_w 273
    //   338: aload_0
    //   339: invokestatic 267	aahy:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   342: aload_1
    //   343: ldc_w 275
    ...
    //   363: invokestatic 267	aahy:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   366: aload 5
    //   368: iload_3
    //   369: invokestatic 279	aahy:a	(Ljava/lang/String;I)V
    //   372: return
    //   373: astore_0
    //   374: ldc 87
    //   376: iconst_1
    //   377: new 89	java/lang/StringBuilder
    //   380: dup
    //   381: invokespecial 90	java/lang/StringBuilder:<init>	()V
    //   384: ldc_w 281
    ...
    //   397: invokestatic 105	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   400: aconst_null
    //   401: astore_0
    //   402: goto -166 -> 236
    //   405: aload_0
    ...
    //   437: ldc_w 273
    //   440: ldc_w 262
    //   443: invokestatic 267	aahy:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   446: goto -104 -> 342
    //   449: astore_0
    //   450: ldc 87
    //   452: iconst_1
    //   453: new 89	java/lang/StringBuilder
    //   456: dup
    //   457: invokespecial 90	java/lang/StringBuilder:<init>	()V
    //   460: ldc_w 289
    //   463: invokevirtual 96	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   466: aload_0
    //   467: invokevirtual 284	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   470: invokevirtual 101	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   473: invokestatic 105	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   476: return
    //   477: astore_0
    //   478: ldc 87
    //   480: iconst_1
    ...
    //   491: ldc_w 275
    //   494: ldc_w 262
    //   497: invokestatic 267	aahy:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   500: goto -134 -> 366
    //   503: ldc 87
    //   505: iconst_1
    //   506: ldc_w 296
    //   509: invokestatic 105	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   512: return
    //   513: aconst_null
    //   514: astore_0
    //   515: goto -279 -> 236
