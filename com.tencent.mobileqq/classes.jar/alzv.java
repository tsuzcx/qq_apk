...
public class alzv
{
  public static ameh a(BaseApplicationImpl paramBaseApplicationImpl)
  {
    alzt.a().a(419, 0L, false);
    amei localamei = new amei();
    paramBaseApplicationImpl = a(419, paramBaseApplicationImpl);
    if (paramBaseApplicationImpl != null) {
      try
      {
        paramBaseApplicationImpl = localamei.a(paramBaseApplicationImpl);
        if (paramBaseApplicationImpl != null) {
  ...
  private static alzs[] a(int paramInt, BaseApplicationImpl paramBaseApplicationImpl)
  {
    ...
    localObject1 = new alzs[((Set)localObject2).size()];
    localObject2 = ((Set)localObject2).iterator();
    int i = 0;
    while (((Iterator)localObject2).hasNext())
    {
      String str = (String)((Iterator)localObject2).next();
      localObject1[i] = new alzs(Integer.valueOf(str).intValue(), paramBaseApplicationImpl.getString(paramInt + "_" + str, null));
      i += 1;
    }
    return localObject1;
  }
