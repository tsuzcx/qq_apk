  ...
  extends DialogFromBottom
{
  ...
  static
  {
    jdField_a_of_type_Asnd = new asnd(null);
  }
  
  public asnc(@NotNull Context paramContext)
  {
    super(paramContext);
    a(paramContext);
  }
  ...
  {
    Object localObject1 = LayoutInflater.from(paramContext).inflate(2131561144, null);
    if (localObject1 == null) {
      throw new TypeCastException("null cannot be cast to non-null type android.widget.LinearLayout");
    }
    localObject1 = (LinearLayout)localObject1;
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView = ((RecyclerView)((LinearLayout)localObject1).findViewById(2131376269));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((LinearLayout)localObject1).findViewById(2131378864));
    ...
    if (localObject2 != null) {
      ((RecyclerView)localObject2).addItemDecoration((RecyclerView.ItemDecoration)new asne(i, j));
    }
    this.jdField_a_of_type_Asnf = new asnf(paramContext);
    paramContext = this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView;
    if (paramContext != null) {
      paramContext.setAdapter((RecyclerView.Adapter)this.jdField_a_of_type_Asnf);
    }
    ((ImageView)((LinearLayout)localObject1).findViewById(2131362936)).setOnClickListener((View.OnClickListener)new asni(this));
    setOnCancelListener((DialogInterface.OnCancelListener)asnj.a);
    ((LinearLayout)localObject1).getViewTreeObserver().addOnGlobalLayoutListener((ViewTreeObserver.OnGlobalLayoutListener)new asnk((LinearLayout)localObject1));
    setContentView((View)localObject1);
  }
  
  private final void a(List<? extends askj> paramList)
  {
    asnf localasnf = this.jdField_a_of_type_Asnf;
    if (localasnf == null) {
      Intrinsics.throwNpe();
    }
    localasnf.a(paramList);
    paramList = this.jdField_a_of_type_Asnf;
    if (paramList == null) {
      Intrinsics.throwNpe();
    }
  ...
  public final void a(int paramInt1, int paramInt2, @Nullable List<? extends askj> paramList)
  {
  ...
  public final void b(int paramInt1, int paramInt2, @Nullable List<? extends askj> paramList)
  {
    if (QLog.isColorLevel()) {
    ...
    if (localTextView != null)
    {
      ...
      localObject = getContext().getString(2131697905);
