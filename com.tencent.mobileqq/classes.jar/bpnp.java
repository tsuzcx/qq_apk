...
public abstract class bpnp<PACKAGE extends bpnb>
  extends BaseAdapter
{
  public int a;
  protected Context a;
  ...
  public bpnp(Context paramContext, FaceListPage paramFaceListPage)
  {
  ...
  {
    this.jdField_a_of_type_Bpnb = paramPACKAGE;
  }
  ...
  public int getCount()
  {
    ...
    int i = this.jdField_a_of_type_Bpnb.b();
    int j = this.jdField_a_of_type_Bpnb.a();
    if (j < 1) {
