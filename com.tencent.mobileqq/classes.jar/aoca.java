...
class aoca
  extends ankx
{
  private aoca(aoby paramaoby) {}
  
  protected void a(boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
    if (aoby.a(this.a) == null) {
      return;
    }
    String str;
    int i;
    if (this.a.jdField_a_of_type_Aobx != null)
    {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        return;
        label185:
        this.a.jdField_a_of_type_Aobx.onDecodeTaskCompleted(this.a.b + this.a.jdField_a_of_type_JavaUtilLinkedList.size(), i, str, paramString);
      }
      label223:
      i = 101;
      str = paramString;
