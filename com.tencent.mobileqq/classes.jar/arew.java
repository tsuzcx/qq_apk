...
public class arew
{
  ...
  public static arew a(TimerTaskManager.TimerTaskRunnable paramTimerTaskRunnable)
  {
    arew localarew = new arew();
    TimerTaskManager.TimerTaskRunnable.a(paramTimerTaskRunnable, true);
    localarew.jdField_a_of_type_ComTencentMobileqqLyricCommonTimerTaskManager$TimerTaskRunnable = paramTimerTaskRunnable;
    return localarew;
  }
