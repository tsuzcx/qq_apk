...
public class lsz
  implements mnz
{
  private static volatile lsz jdField_a_of_type_Lsz;
  public int a;
  ...
  private ltb jdField_a_of_type_Ltb = new ltb(this);
  ...
  public static lsz a()
  {
    if (jdField_a_of_type_Lsz == null) {}
    try
    {
      if (jdField_a_of_type_Lsz == null) {
        jdField_a_of_type_Lsz = new lsz();
      }
      return jdField_a_of_type_Lsz;
    }
    finally {}
  }
  ...
  private boolean c()
  {
    VoiceRecognizer.shareInstance().setListener(this.jdField_a_of_type_Ltb);
    ...
    Object localObject1 = lzq.a().a("AVVoiceRecogSo");
    Object localObject2 = lzq.a().a("AVVoiceRecogModel");
    if ((localObject1 == null) || (localObject2 == null))
    {
      QLog.i("AVVoiceRecog", 1, "initRecognizer. init failed. soResInfo == null || modelResInfo == null.");
      return false;
    }
    if (!lzq.a().b("AVVoiceRecogSo"))
    {
      lzq.a().a("AVVoiceRecogSo");
      QLog.i("AVVoiceRecog", 1, "initRecognizer. init failed. so file no exist.");
      return false;
    }
    if (!lzq.a().b("AVVoiceRecogModel"))
    {
      lzq.a().a("AVVoiceRecogModel");
    ...
    try
    {
      localObject1 = lzq.a().a("AVVoiceRecogSo");
      localObject2 = lzq.a().a("AVVoiceRecogModel");
  ...
  public void a(VideoAppInterface paramVideoAppInterface, lta paramlta)
  {
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface = paramVideoAppInterface;
    this.jdField_a_of_type_Lta = paramlta;
  }
  ...
  public boolean b()
  {
    ...
    ResInfo localResInfo1 = lzq.a().a("AVVoiceRecogSo");
    ResInfo localResInfo2 = lzq.a().a("AVVoiceRecogModel");
