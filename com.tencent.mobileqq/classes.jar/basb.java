...
{
  public basb(PathTraceManager.DataUploadTask paramDataUploadTask, JSONObject paramJSONObject, List paramList, TracePathData paramTracePathData, SharedPreferences paramSharedPreferences, QQSportsOrbit.OrbitReq paramOrbitReq) {}
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        for (;;)
        {
          ...
          paramBundle = new NewIntent(BaseApplicationImpl.sApplication.getApplicationContext(), aquf.class);
