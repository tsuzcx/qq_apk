  ...
  extends ajfb
{
  ...
  public ales(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(String paramString, boolean paramBoolean, byte[] paramArrayOfByte, int paramInt1, int paramInt2, ajfe paramajfe)
  {
    paramajfe = super.createToServiceMsg(paramString, paramajfe);
    paramajfe.addAttribute("SendTime", Long.valueOf(System.currentTimeMillis()));
    paramajfe.addAttribute("IsGenericCmd", Boolean.valueOf(paramBoolean));
    paramajfe.addAttribute("IsPanelRequest", Boolean.valueOf(false));
    paramajfe.addAttribute("NotifyType", Integer.valueOf(paramInt2));
    paramajfe.putWupBuffer(paramArrayOfByte);
    if (paramInt1 > 0) {
      paramajfe.setTimeout(paramInt1);
    }
    if (!ajfu.a().containsKey(paramString)) {
      ajfu.a(paramString, a);
    }
  ...
  {
    if ((TextUtils.isEmpty(paramString)) || (paramajfe == null)) {
      return false;
    }
    paramajfe = super.createToServiceMsg(paramString, paramajfe);
    paramajfe.addAttribute("SendTime", Long.valueOf(System.currentTimeMillis()));
    paramajfe.addAttribute("IsGenericCmd", Boolean.valueOf(true));
    paramajfe.addAttribute("IsPanelRequest", Boolean.valueOf(true));
    paramajfe.addAttribute("NotifyType", Integer.valueOf(paramInt2));
    if (paramInt1 > 0) {
      paramajfe.setTimeout(paramInt1);
    }
  ...
  {
    if ((TextUtils.isEmpty(paramString1)) || (paramajfe == null)) {
      return false;
    }
    ...
    try
    {
      ...
      a(paramString1, true, paramString2, paramInt1, paramInt2, paramajfe);
      return true;
    }
