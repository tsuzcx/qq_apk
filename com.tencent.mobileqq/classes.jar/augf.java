  ...
  extends ProtocolDownloader.Adapter
{
  ...
  {
    paramString = new bgoe(paramString.replaceFirst("https", "http"), paramFile);
    paramString.e = 20000;
    paramString.n = true;
    paramString.b = 2;
    return bgog.a(paramString, null, null);
  }
  ...
  protected void a(int paramInt, HotPicData paramHotPicData)
  {
    if ((paramHotPicData instanceof EmotionSearchItem)) {
      avsq.e(String.valueOf(paramInt), 7);
    }
  }
  ...
  public File loadImageFile(DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    if (j == 0)
    {
      str = ayja.a(localFile.getAbsolutePath());
