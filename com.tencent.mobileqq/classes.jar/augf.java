...
public class augf
{
  private static augf a;
  
  public static augf a()
  {
    if (a == null) {}
    try
    {
  ...
  private MsgBackupUserData a(submsgtype0x11a.UserData paramUserData)
  {
    ...
    if (paramUserData.bytes_ip.has()) {
      localauhn.a(paramUserData.bytes_ip.get().toStringUtf8());
    }
    if (paramUserData.rpt_fixed32_port.has()) {
      localauhn.a(paramUserData.rpt_fixed32_port.get());
    }
    if (paramUserData.bytes_bssid.has()) {
      localauhn.c(paramUserData.bytes_bssid.get().toStringUtf8());
    }
    if (paramUserData.bytes_ssid.has()) {
      localauhn.b(paramUserData.bytes_ssid.get().toStringUtf8());
    }
    if (paramUserData.enum_platform.has()) {
      localauhn.a(paramUserData.enum_platform.get());
    }
    return localauhn.a();
  }
  ...
  public void a(String paramString)
  {
    ...
    localObject1 = new azak();
    localObject2 = ((SubMsgType0x7.MsgBody)localObject2).toByteArray();
    ((azak)localObject1).jdField_a_of_type_Int = 7;
    ((azak)localObject1).jdField_a_of_type_ArrayOfByte = ((byte[])localObject2);
    long l1 = arrr.b();
    long l2 = arrr.a();
    localObject1 = azad.a(paramString, 13, paramString.c(), (azak)localObject1, l2, azah.b(l1));
    ...
    if (paramMsgBody != null)
    {
      ...
      if (paramMsgBody.enum_result.has())
      {
        ...
        if (paramMsgBody.bytes_token.has()) {
          localaugz.a(paramMsgBody.bytes_token.get().toStringUtf8());
        }
        if (paramMsgBody.bytes_encrypt_key.has()) {
          localaugz.b(paramMsgBody.bytes_encrypt_key.get().toStringUtf8());
        }
        if (paramMsgBody.msg_user_data.has()) {
          localaugz.a(a((submsgtype0x11a.UserData)paramMsgBody.msg_user_data.get()));
        }
        if (paramMsgBody.enum_biz_type.has()) {
          localaugz.a(paramMsgBody.enum_biz_type.get());
        }
        paramMsgBody = localaugz.a();
        if (QLog.isColorLevel()) {
          QLog.d("MsgBackup.MsgBackupPushHandler", 2, "processOnLinePush receive processOnLinePush0x11a response = " + paramMsgBody);
        }
        augo.a().a(paramMsgBody);
      }
    }
    label180:
    do
  ...
  public void a(submsgtype0x11b.MsgBody paramMsgBody)
  {
    if (paramMsgBody != null)
    {
      auhh localauhh = new auhh();
      if (paramMsgBody.bytes_qr_sig.has()) {
        localauhh.a(paramMsgBody.bytes_qr_sig.get().toStringUtf8());
      }
      if (paramMsgBody.enum_biz_type.has()) {
        localauhh.a(paramMsgBody.enum_biz_type.get());
      }
      paramMsgBody = localauhh.a();
      if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      if (paramGenericSubCmd.length() == 1)
      {
        ...
        if ("exit".equals(paramGenericSubCmd.optString("cmd")))
        {
          ...
          if (TextUtils.equals(paramGenericSubCmd, augd.a().a())) {
            aujh.a().b(true);
          }
        }
      }
