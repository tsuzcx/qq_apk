...
{
  xwd(AppActivity paramAppActivity, String paramString, QQAppInterface paramQQAppInterface, ScannerParams paramScannerParams, View paramView, xwj paramxwj) {}
    ...
    else
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          paramInt = j;
          paramBundle = new xty(((JSONObject)localObject3).getString("d"));
          paramInt = j;
        ...
        paramInt = j;
        i = xuc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_MqqAppAppActivity, paramBundle, this.jdField_a_of_type_JavaLangString, localBundle);
        paramInt = i;
        ...
        paramInt = i;
        xwb.a(i, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_MqqAppAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        paramInt = i;
        ...
        label451:
        paramBundle = bdcd.a(this.jdField_a_of_type_MqqAppAppActivity, 230);
        paramBundle.setTitle(2131717616);
        paramBundle.setMessage((CharSequence)localObject1);
        localObject2 = new xwe(this);
        paramBundle.setPositiveButton(2131694951, new xwf(this, (String)localObject1));
        paramBundle.setNegativeButton(2131690648, (DialogInterface.OnClickListener)localObject2);
        paramBundle.setOnCancelListener((DialogInterface.OnCancelListener)localObject2);
        paramBundle.show();
        xwb.a(paramInt, (String)localObject1, this.jdField_a_of_type_MqqAppAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        return;
      ...
      if (((JSONObject)localObject3).has("a_a"))
      {
        ...
        paramInt = j;
        paramBundle = bdds.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_MqqAppAppActivity, paramBundle);
        if (paramBundle == null) {
          break label837;
        }
        paramInt = j;
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          for (;;)
          {
            xwb.a(0, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_MqqAppAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            if (!this.jdField_a_of_type_ComTencentBizQrcodeIpcScannerParams.b) {
              break;
            }
            this.jdField_a_of_type_MqqAppAppActivity.finish();
