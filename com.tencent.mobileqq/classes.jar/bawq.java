    ...
    if ("gift".equals(paramString2))
    {
      ...
      do
      {
        ...
        if (("close".equals(paramString3)) && (paramVarArgs.length == 1)) {
          try
          {
            ...
            sendRemoteReq(anah.a("close_version", paramJsBridgeListener, this.mOnRemoteResp.key, paramString1), false, false);
            return true;
          }
        ...
        if ("isFlowerVisible".equals(paramString3)) {
          try
          {
            ...
            paramString1 = new Bundle();
            sendRemoteReq(anah.a("getFlowerVisibility", paramJsBridgeListener, this.mOnRemoteResp.key, paramString1), false, false);
            return true;
          }
      ...
      for (;;)
      {
        try
        {
          ...
          paramJsBridgeListener = paramString1;
          sendRemoteReq(anah.a("setFlowerVisibility", paramString1, this.mOnRemoteResp.key, paramString2), false, false);
          return true;
        }
