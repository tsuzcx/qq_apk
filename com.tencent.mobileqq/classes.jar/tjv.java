...
{
  tjv(tjt paramtjt, Intent paramIntent, Activity paramActivity) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    tjt.a(this.jdField_a_of_type_Tjt).dismiss();
    if (paramBoolean) {}
    for (;;)
    {
      try
      ...
      catch (Exception paramBundle)
      {
        ...
        QLog.e(tjt.a(), 2, paramBundle.getMessage());
        continue;
      ...
      QLog.e(tjt.a(), 2, "build struct msg fail");
      return;
