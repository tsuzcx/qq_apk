...
public class vob
  implements vlk<vlj>
{
  private final int jdField_a_of_type_Int = vpp.b(DoodleLayout.a(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout), 40.0F);
  private Rect jdField_a_of_type_AndroidGraphicsRect;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
  
  private vob(DoodleLayout paramDoodleLayout) {}
  
  public boolean a(vlj paramvlj, MotionEvent paramMotionEvent)
  {
    if ((paramvlj instanceof vkp)) {
      localRect = new Rect();
    }
    for (Rect localRect = ((vkp)paramvlj).a(localRect);; localRect = null)
    {
      ...
      case 6: 
        do
        {
          ...
          paramvlj = this.jdField_a_of_type_AndroidGraphicsRect;
          paramvlj.top -= this.jdField_a_of_type_Int;
          paramvlj = this.jdField_a_of_type_AndroidGraphicsRect;
          paramvlj.bottom += this.jdField_a_of_type_Int;
      ...
      while ((paramMotionEvent.getPointerCount() != 1) || (this.jdField_a_of_type_AndroidGraphicsRect == null) || (!this.jdField_a_of_type_AndroidGraphicsRect.contains((int)f1, (int)f2))) {
        for (;;)
        {
          ...
          return false;
          if ((paramvlj instanceof vld))
          {
            veg.b("DoodleLayout", "editpic remove text.");
            paramvlj.a();
            paramvlj.b(false);
          }
          else if ((paramvlj instanceof vlb))
          {
            paramMotionEvent = ((vlb)paramvlj).a();
            if ((paramMotionEvent != null) && ((paramMotionEvent instanceof vlf)))
            {
