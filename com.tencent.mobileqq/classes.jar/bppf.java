...
public class bppf
{
  ...
  public bppf(int paramInt1, int paramInt2, Typeface paramTypeface, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
  ...
  public static bppf a(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, Typeface paramTypeface, bpon parambpon)
  {
  ...
  public void a(CharSequence paramCharSequence, bpon parambpon)
  {
    a(paramCharSequence, parambpon, 0);
  }
  
  public void a(CharSequence paramCharSequence, bpon parambpon, int paramInt)
  {
    ...
    for (int j = (paramInt - this.e) / (paramCharSequence.length() - 1);; j = 0)
    {
      ...
      while (k < paramCharSequence.length())
      {
        ...
        else
        {
          ...
          if (this.f == 0)
          {
            localbpoy.b = parambpon.a("", this.c + a(), this.d, 0, 255, new LinearInterpolator());
            label282:
            localbpoy.jdField_a_of_type_AndroidGraphicsBitmap = ((Bitmap)localObject);
            if (k != 0) {
              break label374;
            }
            localbpoy.jdField_a_of_type_Int = paramInt;
          }
          for (paramInt = localbpoy.jdField_a_of_type_AndroidGraphicsBitmap.getWidth() + paramInt;; paramInt = localbpoy.jdField_a_of_type_AndroidGraphicsBitmap.getWidth() + j + paramInt)
          {
            this.jdField_a_of_type_JavaUtilArrayList.add(localbpoy);
            break;
            localbpoy.b = parambpon.a("", this.c + this.d * k / paramCharSequence.length(), this.d, 0, 255, new LinearInterpolator());
            break label282;
            label374:
            localbpoy.jdField_a_of_type_Int = (paramInt + j);
          }
        }
      }
      return;
