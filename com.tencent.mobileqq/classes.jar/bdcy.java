...
{
  public static int a;
  private static bdcy jdField_a_of_type_Bdcy;
  ...
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bdcz(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = antf.ba + "VideoRedbagRes" + File.separator;
  ...
  public bdcy(AppInterface paramAppInterface)
  {
  ...
  private RelativeLayout.LayoutParams a(CustomFrameAnimationDrawable paramCustomFrameAnimationDrawable)
  {
    if ((paramCustomFrameAnimationDrawable != null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      ...
      paramCustomFrameAnimationDrawable = new RelativeLayout.LayoutParams(agej.a(j / 2, this.jdField_a_of_type_AndroidAppActivity.getResources()), agej.a(k / 2, this.jdField_a_of_type_AndroidAppActivity.getResources()));
  ...
  public static bdcy a(AppInterface paramAppInterface)
  {
    if (jdField_a_of_type_Bdcy == null) {}
    try
    {
      if (jdField_a_of_type_Bdcy == null) {
        jdField_a_of_type_Bdcy = new bdcy(paramAppInterface);
      }
      return jdField_a_of_type_Bdcy;
    }
    finally {}
  }
  ...
  private CustomFrameAnimationDrawable a(String paramString)
  {
    ...
    //   11: getstatic 57	bdcy:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   154: aload_1
    //   155: invokestatic 229	bhmq:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   158: astore_1
    ...
    //   169: aload_1
    //   170: aload_0
    //   171: getfield 235	bdcy:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
  ...
  public static void a(Intent paramIntent, Activity paramActivity)
  {
    ...
    alpb.a(paramActivity, paramIntent);
  }
  
  public static void a(View paramView, ahrx paramahrx, ChatMessage paramChatMessage, Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (j != 0)
        {
          if (paramView.findViewById(2131374309) != null)
          {
            paramView.findViewById(2131374308).setVisibility(0);
            paramahrx = (ImageView)paramView.findViewById(2131374309);
            if (j == 1) {
              paramahrx.setImageResource(2130849745);
            }
            for (;;)
            {
              paramahrx.setVisibility(0);
              paramView = (RelativeLayout.LayoutParams)((ImageView)paramView.findViewById(2131374308)).getLayoutParams();
              if (!paramChatMessage.isSend()) {
                break label213;
              }
              paramView.rightMargin = agej.a(6.0F, paramContext.getResources());
              ...
              break;
              if (j == 2) {
                paramahrx.setImageResource(2130849746);
              } else if (j == 3) {
                paramahrx.setImageResource(2130849744);
              }
            }
            paramView.rightMargin = 0;
            paramView.leftMargin = agej.a(6.0F, paramContext.getResources());
            return;
          }
          paramahrx = new ImageView(paramContext);
          paramahrx.setBackgroundDrawable(paramContext.getResources().getDrawable(2130849743));
          paramahrx.setId(2131374308);
          paramahrx.setVisibility(0);
          RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, agej.a(70.0F, paramContext.getResources()));
          localLayoutParams.addRule(7, 2131372628);
          localLayoutParams.addRule(8, 2131372628);
          if (paramChatMessage.isSend())
          {
            localLayoutParams.rightMargin = agej.a(6.0F, paramContext.getResources());
            localLayoutParams.leftMargin = 0;
            ((RelativeLayout)paramView).addView(paramahrx, localLayoutParams);
            paramahrx = new ImageView(paramContext);
            if (j != 1) {
              break label441;
            }
          ...
          for (;;)
          {
            paramahrx.setId(2131374309);
            paramahrx.setVisibility(0);
            paramChatMessage = new RelativeLayout.LayoutParams(-2, -2);
            paramChatMessage.addRule(8, 2131372628);
            paramChatMessage.addRule(14);
            ((RelativeLayout)paramView).addView(paramahrx, paramChatMessage);
            return;
            localLayoutParams.rightMargin = 0;
            localLayoutParams.leftMargin = agej.a(6.0F, paramContext.getResources());
            break;
            if (j == 2) {
              paramahrx.setImageResource(2130849746);
            } else if (j == 3) {
        ...
        paramView.findViewById(2131374309).setVisibility(4);
        paramView.findViewById(2131374308).setVisibility(4);
        return;
        j = 0;
      }
    }
  ...
  {
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApp(), bddi.class);
  ...
  private void b(AIOShortVideoData paramAIOShortVideoData)
  {
    ...
    if (paramAIOShortVideoData.h == 0)
    {
      ...
      new bddg(this).execute(new String[] { paramAIOShortVideoData.jdField_c_of_type_JavaLangString });
    }
    for (;;)
    {
  ...
  private static boolean b(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (bhsi.c(paramQQAppInterface.getApp()))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramQQAppInterface.exists()) && (!paramQQAppInterface.isDirectory()))
    {
      try
      {
        paramQQAppInterface = bhmi.b(paramQQAppInterface);
  ...
  public static void c()
  {
    try
    {
      if (!jdField_a_of_type_Boolean) {
        bhsi.e(BaseApplication.getContext(), true);
      }
      return;
    }
    finally {}
  ...
  private void c(AIOShortVideoData paramAIOShortVideoData)
  {
    ...
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setBackgroundResource(2130849747);
    ...
    if (paramAIOShortVideoData.h == 0)
    {
      ...
      {
        this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849756);
        this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      }
    ...
    for (;;)
    {
      ...
      break;
      label207:
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849757);
      c();
    }
  }
  ...
  private void d()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (!anzj.a(2131712169).trim().equals(localObject)) {
          break;
        }
    ...
    } while (!anzj.a(2131712167).trim().equals(localObject));
    alug.b("", "0X80088E6");
    j();
    a();
  }
  ...
  private void g()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131712166));
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(0);
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131166951));
      this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(14.0F);
      this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130849748, 0);
  ...
  private void h()
  {
    if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_AndroidAppActivity != null))
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131712170));
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(0);
  ...
  private void i()
  {
    ...
    if (localCustomFrameAnimationDrawable != null)
    {
      ...
      localCustomFrameAnimationDrawable.c();
      localCustomFrameAnimationDrawable.a(new bddf(this));
      if (this.jdField_a_of_type_AndroidOsHandler == null) {
        this.jdField_a_of_type_AndroidOsHandler = new Handler();
      }
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849751);
      k();
      c();
    }
  }
  ...
  private void k()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131712168));
    this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
    this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131166952));
    this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(16.0F);
    this.jdField_a_of_type_AndroidWidgetTextView.setPadding(agej.a(12.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), agej.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), agej.a(12.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), agej.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
    this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130849752);
    this.jdField_a_of_type_AndroidWidgetTextView.bringToFront();
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    ObjectAnimator.ofFloat(this.jdField_a_of_type_AndroidWidgetTextView, "alpha", new float[] { 0.0F, 1.0F }).setDuration(180L).start();
  }
  ...
  private void l()
  {
    ...
    if (localCustomFrameAnimationDrawable != null)
    {
      ...
      localCustomFrameAnimationDrawable.a(new bdda(this, localCustomFrameAnimationDrawable));
      return;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849751);
    c();
  ...
  private void n()
  {
    ...
    for (;;)
    {
      ...
      h();
      return;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130849755);
      c();
    }
  }
  ...
  public ImageView a(Activity paramActivity, ViewGroup paramViewGroup, String paramString)
  {
    ...
    paramString.setId(2131374361);
    Object localObject = new RelativeLayout.LayoutParams(-1, agej.a(180.0F, paramActivity.getResources()));
    ...
    ((TextView)localObject).setId(2131374362);
    localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.addRule(12);
    localLayoutParams.addRule(14);
    localLayoutParams.bottomMargin = agej.a(10.0F, paramActivity.getResources());
    paramViewGroup.addView((View)localObject, localLayoutParams);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject);
    ((TextView)localObject).bringToFront();
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new bdde(this));
    e();
    return paramString;
  }
  ...
  public void a(int paramInt)
  {
    if (paramInt == -1)
    {
      ...
      localCustomFrameAnimationDrawable.c();
      localCustomFrameAnimationDrawable.a(new bddb(this));
    }
    for (;;)
    {
  ...
  public void a(Activity paramActivity)
  {
    if (a())
    {
      ...
      Bundle localBundle = bocm.a(null, paramActivity.getClass().getName(), 10004, 8);
      zmq.a().a(paramActivity, localBundle, 9010);
    }
  }
