...
public final class aciy
{
  ...
  private static ThreadLocal<char[]> jdField_a_of_type_JavaLangThreadLocal = new aciz();
  ...
  public static int a(awwc paramawwc, String paramString)
  {
    paramawwc = paramawwc.a(paramString);
    ...
    do
    {
      ...
      try
      {
        int i1 = Integer.parseInt(paramawwc);
        return i1;
      }
  ...
  public static final void a(QQAppInterface paramQQAppInterface, BaseChatPie paramBaseChatPie, acka paramacka, ChatMessage paramChatMessage)
  {
    int i4 = 0;
    Object localObject;
    boolean bool;
    if (acgk.jdField_a_of_type_Int == -1)
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (acgk.jdField_a_of_type_Boolean)
        {
          acgk.jdField_a_of_type_Int = i1;
          if (acgk.jdField_a_of_type_Int == -1) {
            acgk.jdField_a_of_type_Int = 0;
          }
          if (acgk.jdField_a_of_type_Int > 0) {
            break label153;
          }
          return;
          label133:
    ...
    if (paramChatMessage == null)
    {
      ...
      if (paramacka != null)
      {
        ...
        if (paramacka.size() > 0)
        {
          ...
          i1 = acgk.jdField_a_of_type_Int;
          if (i2 <= i1) {
            break label296;
          }
          label210:
          if (!(paramBaseChatPie instanceof aegy)) {
            break label349;
          }
        }
      }
    ...
    for (int i2 = 1;; i2 = 0)
    {
      ...
      if (i3 > -1)
      {
        paramBaseChatPie = (ChatMessage)paramacka.get(i3);
        if (i2 == 0) {
          break label303;
        }
        if (!acgk.a(paramBaseChatPie)) {
          break label323;
        }
        i1 = 1;
      }
      for (;;)
      {
        ...
        ((WebProcessManager)paramQQAppInterface.getManager(13)).a(1, new acja());
        return;
        i1 = 10;
        break;
        i1 = i2;
        break label210;
        if ((!paramBaseChatPie.isread) && (acgk.a(paramBaseChatPie)))
        {
          i1 = 1;
        }
        else
  ...
  private static boolean a(BaseActivity paramBaseActivity, QQAppInterface paramQQAppInterface, Intent paramIntent)
  {
    try
    {
      ...
      if (i1 == -1)
      {
        bbmy.a(paramBaseActivity, paramBaseActivity.getString(2131653654), 0).b(paramBaseActivity.getTitleBarHeight());
        return false;
      }
      if (paramIntent.hasExtra("account"))
      {
        awqx.b(paramQQAppInterface, "CliOper", "", "", "Fast_launch", "Fast_launch_msg", 0, 0, "1", "", "", "");
        if (!((ajjj)paramQQAppInterface.getManager(51)).b(str))
        {
      ...
      if ((paramIntent.getBooleanExtra("shortcut", false)) && (!((ajjj)paramQQAppInterface.getManager(51)).b(str)))
      {
        bbmy.a(paramBaseActivity.getApplicationContext(), paramBaseActivity.getString(2131653655), 0).b(paramBaseActivity.getTitleBarHeight());
        return false;
      }
      return true;
    }
  ...
  {
    baio.a(null, "AIO_doOnCreate_BeforeEnterCost");
    ...
    do
    {
      do
      {
        ...
        return true;
        if (!whz.a().a(paramIntent, paramBaseActivity, paramQQAppInterface)) {
          break;
        }
      } while (!QLog.isColorLevel());
    ...
    label212:
    baio.a("AIO_doOnCreate_BeforeEnterCost", null);
    return false;
  }
