  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public zap(Activity paramActivity, String paramString1, String paramString2, int paramInt1, WeakReference<AppInterface> paramWeakReference, int paramInt2)
  {
  ...
  {
    if (!bdeq.d((AppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get())) {
      return -1002;
    }
    bdeq.d(null);
    ...
    ((bddn)localObject).jdField_b_of_type_JavaLangString = paramString1;
    ((bddn)localObject).jdField_a_of_type_JavaLangString = paramString2;
    ...
    for (;;)
    {
      ...
      i = AudioEncoder.a((bddn)localObject);
      ...
      {
        i = bddu.a(paramString3, paramString1, paramString4, 0);
        paramString2.delete();
        if (i != 0)
        {
  ...
  protected void a(Integer paramInteger)
  {
    ...
    a(anzj.a(2131715140) + paramInteger, null);
  }
  
  protected void onPreExecute()
  {
    a(this.jdField_a_of_type_AndroidAppActivity, 2131694337);
  }
}
