...
public class anqq
  implements Runnable
{
  public anqq(QIMCameraCaptureUnit paramQIMCameraCaptureUnit, List paramList) {}
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_DovComQqImQIMCameraCaptureUnit.a() != null)
    {
      ...
      QIMCameraCaptureUnit.a(this.jdField_a_of_type_DovComQqImQIMCameraCaptureUnit).mTransferPosList = localQimSegmentMergeUtil.a(localArrayList1, (String)localObject2);
      if (QLog.isColorLevel()) {
        QLog.d("VERSION_CODES", 2, "[segmentCapture] onSegmentVideoCaptured segment video merge result: " + bool);
      }
      MediaScanner.a(BaseApplicationImpl.getContext()).a(new anqr(this), QIMCameraCaptureUnit.a(this.jdField_a_of_type_DovComQqImQIMCameraCaptureUnit));
    }
    label509:
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        ...
        break;
        QIMCameraCaptureUnit.a(this.jdField_a_of_type_DovComQqImQIMCameraCaptureUnit).mTransferPosList = localQimSegmentMergeUtil.a(localArrayList1);
      }
    }
    label542:
    label562:
