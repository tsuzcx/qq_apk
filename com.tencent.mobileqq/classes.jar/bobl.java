...
{
  public bobl(VSDispatchObserver.onVSRspCallBack paramonVSRspCallBack, long paramLong) {}
  ...
  {
    bnrh.b("AEEditorMusicHelper", "[requestDetailedMusicInfo], onReceive(), isSuccess=" + paramBoolean + ", retCode=" + paramLong + ", errMsg=" + paramString);
    ...
    bnqm.a().a(i, l1 - l2 + "", "AEEditorMusicInfo", 0);
  }
}
