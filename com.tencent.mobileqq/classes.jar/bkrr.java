  ...
  extends ThirdAppProxy
{
  ...
  private bmqi jdField_a_of_type_Bmqi = new bkrs(this);
  private bmql jdField_a_of_type_Bmql;
  ...
  public void init()
  {
    ...
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_Bmql = new bmql();
    this.jdField_a_of_type_Bmql.a(this.jdField_a_of_type_Bmqi);
  }
  
  public boolean installApp(String paramString, AsyncResult paramAsyncResult)
  {
    if ((this.jdField_a_of_type_Bmql == null) || (TextUtils.isEmpty(paramString)) || (paramAsyncResult == null)) {
      return false;
    }
    ...
    this.jdField_a_of_type_Bmql.b(localWadlParams1);
  ...
  public void queryApkDownloadInfo(String paramString, AsyncResult paramAsyncResult)
  {
    ...
    paramString = new bkrt(this, paramString, paramAsyncResult);
    bmqt.a().a(paramString);
    bmqt.a().a("10036618", localArrayList);
  }
  ...
  public void queryDownloadTask(String paramString, AsyncResult paramAsyncResult)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Bmql == null) || (TextUtils.isEmpty(paramString))) {
        paramAsyncResult.onReceiveResult(false, null);
      }
      this.b.put(paramString, paramAsyncResult);
      paramAsyncResult = new ArrayList();
      paramAsyncResult.add(paramString);
    } while (this.jdField_a_of_type_Bmql == null);
    this.jdField_a_of_type_Bmql.a(paramAsyncResult);
  }
  ...
  public void startDownload(String paramString, JSONObject paramJSONObject, boolean paramBoolean, ThirdAppProxy.AppDownloadListener paramAppDownloadListener)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString.b(7);
        paramString.b = 2;
        this.jdField_a_of_type_Bmql.a(paramString);
        return;
      }
  ...
  public boolean stopDownloadTask(String paramString)
  {
    ...
    localWadlParams.b(2);
    localWadlParams.b = 3;
    this.jdField_a_of_type_Bmql.a(6, paramString);
    return true;
  }
  ...
  public void unInit()
  {
    ...
    if (this.jdField_a_of_type_Bmql != null)
    {
      this.jdField_a_of_type_Bmql.b(this.jdField_a_of_type_Bmqi);
      this.jdField_a_of_type_Bmql.d();
      this.jdField_a_of_type_Bmql = null;
    }
  }
}
