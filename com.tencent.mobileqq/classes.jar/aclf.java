...
public class aclf
{
  ...
  protected acjr a;
  final acju jdField_a_of_type_Acju;
  final aclb jdField_a_of_type_Aclb;
  protected List<bhrj> a;
  
  static
  {
    jdField_a_of_type_JavaLangString = "DoraemonOpenAPI." + aclf.class.getSimpleName();
  }
  
  public aclf(acju paramacju, aclb paramaclb)
  {
    this.jdField_a_of_type_Acju = paramacju;
  ...
  private String a(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3)
  {
    ...
    localLinkedHashMap.put("app_id", this.jdField_a_of_type_Acju.jdField_a_of_type_JavaLangString);
    ...
    avro localavro = this.jdField_a_of_type_Acju.a();
    if (localavro == null)
    {
      paramAppRuntime = "";
    ...
    label265:
    for (paramAppRuntime = "";; paramAppRuntime = localavro.i)
    {
      ...
      paramAppRuntime = localavro.jdField_b_of_type_JavaLangString;
      break;
    }
  ...
  private void a()
  {
    ...
    long l = Long.parseLong(this.jdField_a_of_type_Acju.jdField_a_of_type_JavaLangString);
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      if (((bhrj)localObject2).jdField_a_of_type_Int > 0) {
        localAuthorizeRequest.openapi.add(Integer.valueOf(((bhrj)localObject2).jdField_b_of_type_Int));
      }
    }
    ...
    localAuthorizeRequest.sdkp.set(acmy.a(this.jdField_a_of_type_Acju.jdField_a_of_type_Int));
    localAuthorizeRequest.sdkv.set("1.5.9");
    localAuthorizeRequest.response_type.set("token");
    if ((this.jdField_a_of_type_Acju instanceof ackb))
    {
      localObject1 = ((ackb)this.jdField_a_of_type_Acju).a();
    ...
    if ((this.jdField_a_of_type_Acju instanceof aclu))
    {
      aclu localaclu = (aclu)this.jdField_a_of_type_Acju;
      if (localaclu.b)
      {
        localObject3 = a((AppRuntime)localObject1, (String)localObject3, localaclu.e, localaclu.d);
    ...
    ((NewIntent)localObject3).setObserver(new aclk(this, (String)localObject2));
  ...
  private void a(String paramString)
  {
    ...
    if (localavro == null)
    {
      ...
      localObject = BaseApplicationImpl.getApplication().getString(2131694276);
    }
    label144:
    for (;;)
    {
      if (TextUtils.isEmpty(paramString))
      {
        a();
        return;
        localObject = localavro.jdField_b_of_type_JavaLangString;
        break;
      }
      acju localacju = this.jdField_a_of_type_Acju;
      if (localavro == null) {}
      for (;;)
      {
        localacju.a((String)localObject, str, BaseApplicationImpl.getApplication().getString(2131694275, new Object[] { localObject }), paramString, BaseApplicationImpl.getApplication().getString(2131719641), new aclh(this), BaseApplicationImpl.getApplication().getString(2131719651), new acli(this), new aclj(this));
        return;
        str = localavro.c;
      }
    }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    try
    {
      long l2 = Long.parseLong(this.jdField_a_of_type_Acju.jdField_a_of_type_JavaLangString);
      l1 = l2;
    }
    ...
    if (((this.jdField_a_of_type_Acju instanceof aclu)) && (((aclu)this.jdField_a_of_type_Acju).b))
    {
      localObject1 = "all" + ",server_side";
      localGetAuthApiListRequest.scope.set((String)localObject1);
      localGetAuthApiListRequest.sdkp.set(acmy.a(this.jdField_a_of_type_Acju.jdField_a_of_type_Int));
      ...
      localObject1 = new NewIntent(BaseApplicationImpl.getApplication(), bhwt.class);
      ...
      ((NewIntent)localObject1).setObserver(new aclg(this, str3, paramBoolean));
  ...
  private boolean a(SdkAuthorize.GetAuthApiListResponse paramGetAuthApiListResponse)
  {
    ...
    while (paramGetAuthApiListResponse.hasNext())
    {
      ...
      {
        bhrj localbhrj = new bhrj();
        localbhrj.jdField_b_of_type_JavaLangString = localAuthItem.api_list.get();
        localbhrj.jdField_a_of_type_Int = localAuthItem.default_flag.get();
        localbhrj.jdField_b_of_type_Int = localAuthItem.id.get();
        if (localAuthItem.is_new.get() != 0) {}
        for (boolean bool = true;; bool = false)
        {
          localbhrj.jdField_a_of_type_Boolean = bool;
          localbhrj.jdField_a_of_type_JavaLangString = localAuthItem.title.get();
          this.jdField_a_of_type_JavaUtilList.add(localbhrj);
          break;
        }
      }
    }
  ...
  private void b(String paramString)
  {
    ...
    Object localObject = this.jdField_a_of_type_Acju.a();
    if ((localObject != null) && ((this.jdField_a_of_type_Acju instanceof aclu)) && ((localObject instanceof bguf)))
    {
  ...
  public void a(JSONObject paramJSONObject, acjr paramacjr, boolean paramBoolean)
  {
