...
public class aclf
  extends amab
{
  public aclf(ChatSettingForTroop paramChatSettingForTroop) {}
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    ...
    this.a.jdField_a_of_type_Beps.b(2, 2131692288, 1500);
    this.a.finish();
  }
    ...
    do
    {
      for (;;)
      {
        ...
        if ((1 == paramInt1) && ((this.a.isResume()) || (this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.cGroupOption == 1)))
        {
          ...
          case -1: 
          default: 
            this.a.jdField_a_of_type_Beps.b(2, 2131693803, 1500);
          }
          for (;;)
          {
            this.a.b = null;
            return;
            ((alzf)this.a.app.a(20)).b(Long.parseLong(paramString), Long.parseLong(this.a.app.getAccount()));
            continue;
            this.a.jdField_a_of_type_Beps.b(2, 2131693804, 1500);
            this.a.finish();
            ...
            if (localObject != null)
            {
              ...
              continue;
              this.a.jdField_a_of_type_Beps.b(2, 2131721045, 1500);
            }
          }
        }
        if (this.a.isResume())
        {
          ...
          if (paramInt2 == 0)
          {
            ...
            for (paramString = null;; paramString = paramString.b(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin))
            {
              ...
              this.a.c.setText(alpo.a(2131702126) + this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.wMemberNum + alpo.a(2131702128));
              return;
            }
          }
        }
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong, ArrayList<bckw> paramArrayList)
  {
