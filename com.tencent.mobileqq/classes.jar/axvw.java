  ...
  implements axvs
{
  ...
  public axvw(VideoData paramVideoData, QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(int paramInt, axvu paramaxvu)
  {
    ...
    ntb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new axvx(this, paramaxvu), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
  }
  
  public void a(Comments.Comment paramComment, axvt paramaxvt)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ...
    if (a(localReqBody))
    {
      ...
      ntb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new axvz(this, paramaxvt, paramComment), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
    }
    paramaxvt.a(paramComment, -1);
  }
  
  public void a(Comments.Comment paramComment, axvv paramaxvv)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqNearbyNowModelVideoData == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      ntb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new axvy(this, paramaxvv, paramComment), localReqBody.toByteArray(), "OidbSvc.0xada_0", 2778, 0, null, 0L);
      return;
