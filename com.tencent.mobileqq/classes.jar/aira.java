  ...
  implements Handler.Callback, View.OnClickListener
{
  ...
  public WeakReference<aiqp> a;
  private boolean jdField_a_of_type_Boolean;
  private int jdField_b_of_type_Int = -1;
  WeakReference<Context> jdField_b_of_type_JavaLangRefWeakReference;
  
  public aira(Activity paramActivity, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    this.jdField_a_of_type_Aiqz = new aiqz((Context)this.jdField_b_of_type_JavaLangRefWeakReference.get(), this);
    ...
    if (aiyr.jdField_a_of_type_Int > 0)
    {
      jdField_a_of_type_Int = aiyr.jdField_a_of_type_Int * 1000;
  ...
  private BaseChatPie a()
  {
    ...
    if (localObject2 != null)
    {
      ...
      {
        localObject2 = (aifg)((AppInterface)localObject2).getManager(153);
        localObject1 = localChatFragment;
        if (localObject2 != null)
        {
          localObject2 = ((aifg)localObject2).a();
          localObject1 = localChatFragment;
          if (localObject2 != null) {
  ...
  private void g()
  {
    ...
    if ((localBaseChatPie != null) && (this.jdField_a_of_type_Aiqz != null) && (localBaseChatPie.a().a() == this.jdField_a_of_type_Aiqz) && (this.jdField_a_of_type_Aiqz.jdField_a_of_type_AndroidWidgetRelativeLayout.isShown()))
    {
      this.jdField_a_of_type_Aiqz.a();
      this.jdField_a_of_type_Befq.removeMessages(20);
      this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(20, 1000L);
    }
  }
  ...
  public void a(aiqp paramaiqp)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramaiqp);
  }
  
  public void a(Activity paramActivity)
  {
    this.jdField_a_of_type_Aiqz = new aiqz(paramActivity, this);
  }
  ...
  public void b()
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (((aeob)localObject).a() == this.jdField_a_of_type_Aiqz))
      {
        ((aeob)localObject).a();
        if (QLog.isColorLevel()) {
  ...
  public void c()
  {
    ...
    for (localObject1 = null;; localObject1 = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
    {
      ...
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = ajjy.a(2131636344);
      }
      localMessage.obj = (ajjy.a(2131636340) + (String)localObject2);
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Aiqz != null)
    {
      ...
      this.jdField_a_of_type_Aiqz.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_JavaLangString);
      this.jdField_a_of_type_Aiqz.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      this.jdField_a_of_type_Aiqz.c.setVisibility(8);
    }
    label251:
    while (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam == null)
    {
      ...
      if (this.jdField_a_of_type_Aiqz != null)
      {
        if ((this.jdField_a_of_type_Aiqz.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent() instanceof ViewGroup)) {
          ((ViewGroup)this.jdField_a_of_type_Aiqz.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent()).removeView(this.jdField_a_of_type_Aiqz.jdField_a_of_type_AndroidWidgetRelativeLayout);
        }
        ((aeob)localObject1).a(this.jdField_a_of_type_Aiqz, new Object[0]);
      }
      if (!QLog.isColorLevel()) {
        break;
      }
    ...
    for (Object localObject1 = null;; localObject1 = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
    {
      Object localObject2 = localObject1;
      if (TextUtils.isEmpty((CharSequence)localObject1)) {
        localObject2 = ajjy.a(2131636343);
      }
      localObject1 = ajjy.a(2131636345) + (String)localObject2;
      this.jdField_a_of_type_Aiqz.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject1);
      this.jdField_a_of_type_Aiqz.jdField_b_of_type_AndroidWidgetTextView.setText((CharSequence)localObject1);
      break;
    }
  }
  ...
  public void e()
  {
    this.jdField_a_of_type_Befq.removeMessages(25);
  ...
  {
    this.jdField_a_of_type_Befq.removeMessages(25);
    this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(25, jdField_a_of_type_Int);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            do
            {
                ...
                do
                {
                  do
                  {
                    do
                    {
                      ...
                      paramMessage.ap();
                      return false;
                      if ((this.jdField_a_of_type_Aiqz != null) && ((paramMessage.obj instanceof String)))
                      {
                    ...
                    if (paramMessage != null)
                    {
                      ...
                      if ((localObject3 != null) && (this.jdField_a_of_type_Aiqz != null))
                      {
                        if ((this.jdField_a_of_type_Aiqz.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent() instanceof ViewGroup)) {
                          ((ViewGroup)this.jdField_a_of_type_Aiqz.jdField_a_of_type_AndroidWidgetRelativeLayout.getParent()).removeView(this.jdField_a_of_type_Aiqz.jdField_a_of_type_AndroidWidgetRelativeLayout);
                        }
                        if (this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
                        {
                          ...
                          if (TextUtils.isEmpty(paramMessage)) {
                            localObject1 = ajjy.a(2131636346);
                          }
                          paramMessage = ajjy.a(2131636341) + (String)localObject1;
                          this.jdField_a_of_type_Aiqz.jdField_a_of_type_AndroidWidgetTextView.setText(paramMessage);
                          this.jdField_a_of_type_Aiqz.jdField_b_of_type_AndroidWidgetTextView.setText(paramMessage);
                        }
                        this.jdField_a_of_type_Aiqz.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                        this.jdField_a_of_type_Aiqz.c.setVisibility(8);
                        ((aeob)localObject3).a(this.jdField_a_of_type_Aiqz, new Object[0]);
                        if (QLog.isColorLevel()) {
                          QLog.d("cmgame_process.CmGameUIManager", 2, "showGameTips");
                        }
                      }
                    }
                    Object localObject3 = aing.a();
                    MqqHandler localMqqHandler;
                    Message localMessage;
                    ...
                    for (paramMessage = (Message)localObject2;; paramMessage = this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.game.name)
                    {
                      localObject1 = paramMessage;
                      if (TextUtils.isEmpty(paramMessage)) {
                        localObject1 = ajjy.a(2131636337);
                      }
                      localMessage.obj = (ajjy.a(2131636339) + (String)localObject1);
                      localMqqHandler.sendMessage(localMessage);
                      if (this.jdField_b_of_type_Int > 0) {
                        bajr.a((AppInterface)localObject3, "cmshow", "Apollo", "miniature_game", a(), 0, new String[] { Integer.toString(this.jdField_b_of_type_Int) });
                      }
                      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
                      {
                        paramMessage = (aiqp)this.jdField_a_of_type_JavaLangRefWeakReference.get();
                        if (paramMessage != null) {
                          paramMessage.a();
                        }
                      }
                    ...
                    {
                      bajr.a(null, "cmshow", "Apollo", "game_shutdown", 0, 0, new String[] { paramMessage });
                      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
                      {
                        paramMessage = (aiqp)this.jdField_a_of_type_JavaLangRefWeakReference.get();
                        if (paramMessage != null) {
                      ...
                      ainb.a(this.jdField_b_of_type_Int);
                    ...
                    if (localObject2 != null)
                    {
                      ...
                      if (localObject2 != null)
                      {
                        if ((this.jdField_a_of_type_Aiqz == null) || (this.jdField_a_of_type_Aiqz != ((aeob)localObject2).a())) {
                          break label964;
                        }
                        ((aeob)localObject2).a();
                        if (QLog.isColorLevel()) {
                    ...
                    for (;;)
                    {
                      ...
                      {
                        localObject2 = (aiqp)this.jdField_a_of_type_JavaLangRefWeakReference.get();
                        if ((paramMessage.obj instanceof String)) {
                          localObject1 = (String)paramMessage.obj;
                        }
                        if (localObject2 != null) {
                          ((aiqp)localObject2).d((String)localObject1);
                        }
                      }
                      paramMessage = aing.a();
                      ...
                      bajr.a(paramMessage, "cmshow", "Apollo", "shutdown_game", 0, 0, new String[] { Integer.toString(this.jdField_b_of_type_Int), Integer.toString(aing.b()), Integer.toString(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.commFlag & 0x1) });
                      return false;
                      if (QLog.isColorLevel()) {
                    ...
                    if ((paramMessage.obj instanceof String))
                    {
                      ...
                      if (this.jdField_a_of_type_Aiqz != null)
                      {
                        this.jdField_a_of_type_Aiqz.c.setVisibility(8);
                        this.jdField_a_of_type_Aiqz.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                        this.jdField_a_of_type_Aiqz.jdField_a_of_type_AndroidWidgetTextView.setText((String)paramMessage.obj);
                      }
                    }
                    paramMessage = aing.a();
              ...
              this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(24, 500L);
              return false;
              paramMessage = a();
            } while (paramMessage == null);
            paramMessage.ap();
        ...
        if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Aiqz != null))
        {
          localObject1 = (String)paramMessage.obj;
          localObject2 = new SpannableString((String)localObject1 + ajjy.a(2131636342));
          ((SpannableString)localObject2).setSpan(new ForegroundColorSpan(-16776961), 0, ((String)localObject1).length(), 17);
          this.jdField_a_of_type_Aiqz.jdField_b_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
          g();
        }
      } while (!QLog.isColorLevel());
      ...
      paramMessage = a();
    } while ((paramMessage == null) || (this.jdField_a_of_type_Aiqz == null) || (paramMessage.a().a() != this.jdField_a_of_type_Aiqz) || (!this.jdField_a_of_type_Aiqz.jdField_a_of_type_AndroidWidgetRelativeLayout.isShown()));
    label733:
  ...
  public void onClick(View paramView)
  {
    ...
    {
      bajr.a(null, "cmshow", "Apollo", "clk_game_banner", i, 0, new String[] { paramView });
      paramView = a();
      if (paramView != null) {
        paramView.ap();
      }
      this.jdField_a_of_type_Befq.sendEmptyMessageDelayed(18, 300L);
      return;
