  ...
  implements aiqy
{
  ...
  public aira(JSONObject paramJSONObject, Bundle paramBundle, WeakReference<MessengerService> paramWeakReference)
  {
  ...
  public void invalidateSelf()
  {
    ...
    float f = bbcm.a(localTextPaint, localRect, (String)localObject4);
    try
    {
      i = Color.parseColor((String)localObject1);
      if (n == 1)
      {
        localObject3 = aiqx.a().a(this, (String)localObject4, m, n, f, i, j, k, localTextPaint);
      ...
      try
      {
        do
        {
          ...
          for (;;)
          {
            ...
            localObject3 = bbco.encodeToString(((ByteArrayOutputStream)localObject4).toByteArray(), 2);
          ...
          localObject2 = aiqx.a().a(this, m, n);
