...
public class aira
  ...
  implements PhotoListLogic.IadapterCallback, PhotoListLogic.IcheckBoxCallback, PhotoListLogic.IitemClickCallback, xng
{
  public aiqz a;
  
  public aira(NewPhotoListActivity paramNewPhotoListActivity)
  {
    super(paramNewPhotoListActivity);
    this.mPhotoListData = new aiqz();
    this.a = ((aiqz)this.mPhotoListData);
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 >= 0) && (paramInt1 < localArrayList.size()) && (paramInt2 >= 0) && (paramInt2 < localArrayList.size()))
    {
      ...
      xna.a().b(localArrayList, this.mPhotoCommonData.allMediaInfoHashMap);
    }
  ...
  protected void a(Intent paramIntent, boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    for (i = 1;; i = 0)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        localObject1 = ((NewPhotoListActivity)this.mActivity).getResources().getString(2131719750);
        ...
        if (bezm.a(this.mActivity, 4, new airb(this, paramIntent))) {
          bdgm.a(this.mActivity, 232, null, (String)localObject1, new airc(this, paramIntent), new aird(this)).show();
        }
        if (QLog.isColorLevel()) {
  ...
  public void a(SlideItemInfo paramSlideItemInfo)
  {
    ...
    for (;;)
    {
      if ((i >= 0) && (i < ((List)localObject2).size()))
      {
        ...
        localObject2 = (HashMap)bdfa.sSelectItemPosMap.get(this.mPhotoCommonData.albumId);
        if (localObject2 != null) {
      ...
      aips.a(((NewPhotoListActivity)this.mActivity).getIntent(), "param_cancelSelNum");
      localObject1 = (HashMap)bdfa.sSelectItemPosMap.get(this.mPhotoCommonData.albumId);
  ...
  protected void a(LocalMediaInfo paramLocalMediaInfo, int paramInt)
  {
    ...
    if (this.a.f)
    {
      paramLocalMediaInfo = bdfa.sSelectItemAlbum;
    ...
    if ((100 == paramInt) || (102 == paramInt) || (103 == paramInt)) {
      if (100 == paramInt)
      {
        ...
        localIntent.putExtra("PhotoConst.EDIT_MASK_SHAPE_TYPE", aiqe.c(paramInt));
      }
    }
    for (;;)
    {
      bdfa.a(localIntent, this.mPhotoCommonData.albumId, str, this.a.isRecodeLastAlbumPath);
  ...
  public boolean addAndRemovePhotoByGesture(LocalMediaInfo paramLocalMediaInfo, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      paramLocalMediaInfo = (LinkedHashMap)bdfa.sSelectItemPosMap.get(this.mPhotoCommonData.albumId);
      if (paramLocalMediaInfo != null) {
        break label843;
      }
      paramLocalMediaInfo = new LinkedHashMap();
      bdfa.sSelectItemPosMap.put(this.mPhotoCommonData.albumId, paramLocalMediaInfo);
    }
    label843:
    for (;;)
    {
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        for (;;)
        {
          ...
          aips.a(((NewPhotoListActivity)this.mActivity).getIntent(), "param_cancelSelNum");
          paramLocalMediaInfo = (HashMap)bdfa.sSelectItemPosMap.get(this.mPhotoCommonData.albumId);
          if (paramLocalMediaInfo != null) {
  ...
  protected void b()
  {
    ...
    {
      aips.a(((NewPhotoListActivity)this.mActivity).getIntent(), this.mPhotoCommonData.selectedPhotoList.size());
      aips.a(((NewPhotoListActivity)this.mActivity).getIntent(), this.mPhotoCommonData.selectedPhotoList.size(), this.mPhotoCommonData.currentQualityType);
    }
    Intent localIntent = ((NewPhotoListActivity)this.mActivity).getIntent();
  ...
  public Intent caseNoSingModeImage(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    paramAdapterView.putExtra("PhotoConst.editPathMap", aioz.a(this.a.jdField_c_of_type_JavaUtilHashMap));
  ...
  public void d()
  {
    ...
    bdfa.a(((NewPhotoListActivity)this.mActivity).b, localaiqy.selectedPhotoList, localaiqy.allMediaInfoHashMap, this.a.k, this.mActivity, this.a.jdField_a_of_type_JavaUtilHashMap, localaiqy.selectedMediaInfoHashMap);
  ...
  public void doOnDestroy()
  {
    if (this.mPhotoCommonData.isShowQzoneAlbum) {
      BaseApplicationImpl.getApplication().getRuntime().unRegistObserver(NewPhotoListActivity.jdField_a_of_type_Aiqv);
    }
    if (this.mPhotoCommonData.a()) {
      xna.a().f();
    }
  ...
  public void doOnResume()
  {
    ...
    xna.a().c();
    xna.a().a(this.a.jdField_a_of_type_Xne);
  }
  ...
  public void enterPhotoPreviewActivity(boolean paramBoolean, Intent paramIntent)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if ((localArrayList != null) && (localArrayList.size() > 0)) {
        azqs.b(null, "CliOper", "", this.mPhotoCommonData.myUin, "0X8004072", "0X8004072", 0, localArrayList.size(), 0, "", "", "", "");
      }
  ...
  void f()
  {
    ...
    if (this.mPhotoCommonData.selectedPhotoList.size() > 0) {
      xna.a().a(this.mPhotoCommonData.selectedPhotoList, this.mPhotoCommonData.allMediaInfoHashMap, false);
    }
  }
  ...
  public String getExceedMaxSelectNumStr(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (paramLocalMediaInfo != null)
    {
      ...
      str1 = ((NewPhotoListActivity)this.mActivity).getResources().getString(2131695261, new Object[] { Integer.valueOf(i) });
    }
    label80:
    do
    {
    ...
    if (this.mPhotoCommonData.a()) {
      return ((NewPhotoListActivity)this.mActivity).getResources().getString(2131695262, new Object[] { Integer.valueOf(i) });
    }
  ...
  public List<LocalMediaInfo> getLocalMediaInfos()
  {
    ...
    do
    {
      do
      {
        ...
        {
          return localObject2;
          localObject1 = bdfa.getAlbumMedias(this.mActivity, this.mPhotoCommonData.albumId, this.mPhotoCommonData.albumName, i, this.a.filter, 0, 0, true, null, false, this.a.filterVideoDurationLimit, 1);
          break;
          localObject1 = bdfa.getAlbumMedias(this.mActivity, this.mPhotoCommonData.albumId, this.mPhotoCommonData.albumName, i, this.a.filter, this.a.filterVideoDurationLimit);
          break;
  ...
  public void handleVideoCapture(Intent paramIntent)
  {
    ...
    localupd.a(true);
    localObject = upd.a((String)localObject);
    String str = akcq.a(((PublishVideoEntry)localObject).mLocalRawVideoDir);
    if (TextUtils.isEmpty(str))
    {
      QZLog.i("PhotoListActivity", 1, "get target path fail");
      return;
    }
    localupd.a((PublishVideoEntry)localObject, str, false, true, new airf(this, l, str, (PublishVideoEntry)localObject, paramIntent));
  }
  ...
  public void handleVideoEncodeSucceed(Message paramMessage)
  {
    ...
    if ((paramMessage.obj instanceof String))
    {
      ...
      QQToast.a(this.mActivity, String.format(((NewPhotoListActivity)this.mActivity).getResources().getString(2131695260), new Object[] { Integer.valueOf(aiqy.getInstance().maxSelectNum) }), 0).a();
    }
    for (;;)
    {
  ...
  public void initData(Intent paramIntent)
  {
    ...
    aioz.a(this.mActivity, paramIntent, false, this.a.jdField_c_of_type_JavaUtilHashMap);
    ...
    try
    {
      ...
      if (this.mPhotoCommonData.isShowQzoneAlbum)
      {
        ...
        BaseApplicationImpl.getApplication().getRuntime().registObserver(NewPhotoListActivity.jdField_a_of_type_Aiqv);
  ...
  public void onCheckBoxClick(View paramView, int paramInt, CheckBox paramCheckBox)
  {
    ...
    do
    {
      ...
      if ((((NewPhotoListActivity)this.mActivity).getIntent().getBooleanExtra("PhotoConst.IS_SEND_GIF_SIZE_LIMIT", false)) && (((NewPhotoListActivity)this.mActivity).isGif(localLocalMediaInfo)) && (bdhb.a(localLocalMediaInfo.path) > 3145728L))
      {
        QQToast.a(this.mActivity, "图片文件过大", 0).b(((NewPhotoListActivity)this.mActivity).mTitleBarHeight);
        paramCheckBox.setChecked(false);
        return;
      }
    } while ((this.mPhotoCommonData.a()) && (!bnfr.a(this.mActivity, localLocalMediaInfo)));
    label409:
    boolean bool1;
    label428:
    Object localObject2;
      ...
      for (bool1 = bool2;; bool1 = false)
      {
        ...
        if (xna.a().a().isEmpty())
        {
          ...
          if ((paramView != null) && (((NewPhotoListActivity)this.mActivity).mGridView.getHeight() - paramView.getY() < ((NewPhotoListActivity)this.mActivity).mImageHeight)) {
            ((NewPhotoListActivity)this.mActivity).mGridView.smoothScrollBy(xna.jdField_a_of_type_Int, 500);
          }
        }
  ...
  {
    if (paramBoolean) {
      if (bdfa.a(this.mPhotoCommonData.selectedPhotoList, this.mPhotoCommonData.jdField_a_of_type_Int, this.mPhotoCommonData.allMediaInfoHashMap, this.a.k, this.mPhotoCommonData.selectedMediaInfoHashMap) > 0)
      {
        QQToast.a(this.mActivity, ((NewPhotoListActivity)this.mActivity).getResources().getString(2131695273), 0).b(((NewPhotoListActivity)this.mActivity).getResources().getDimensionPixelSize(2131298914));
    ...
    for (;;)
    {
      ...
      return;
      if (bdfa.a(this.mPhotoCommonData.selectedPhotoList, this.mPhotoCommonData.videoSizeLimit, this.mPhotoCommonData.allMediaInfoHashMap, this.a.k, this.mPhotoCommonData.selectedMediaInfoHashMap) > 0)
      {
        QQToast.a(this.mActivity, ((NewPhotoListActivity)this.mActivity).getResources().getString(2131720133), 0).b(((NewPhotoListActivity)this.mActivity).getResources().getDimensionPixelSize(2131298914));
        bdfa.c();
      }
      ((NewPhotoListActivity)this.mActivity).jdField_a_of_type_AndroidWidgetCheckBox.setChecked(true);
      this.mPhotoCommonData.currentQualityType = 2;
      bdfa.a(((NewPhotoListActivity)this.mActivity).b, this.mPhotoCommonData.selectedPhotoList, this.mPhotoCommonData.allMediaInfoHashMap, this.a.k, this.mActivity, this.a.jdField_a_of_type_JavaUtilHashMap, this.mPhotoCommonData.selectedMediaInfoHashMap);
      continue;
      this.mPhotoCommonData.currentQualityType = 0;
      ((NewPhotoListActivity)this.mActivity).jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
      ((NewPhotoListActivity)this.mActivity).b.setVisibility(4);
  ...
  public boolean onQueryPhoto(List<LocalMediaInfo> paramList)
  {
    ...
    if (this.a.firstResume)
    {
      ...
      Object localObject = (LinkedHashMap)bdfa.sSelectItemPosMap.get(this.mPhotoCommonData.albumId);
      k = i;
      if (localObject != null)
      {
  ...
  public void onSendBtnClick(View paramView)
  {
    ...
    if (((NewPhotoListActivity)this.mActivity).getIntent().getBooleanExtra("PhotoConst.IS_SEND_FILESIZE_LIMIT", false))
    {
      ...
      if (arrr.a())
      {
        arre.a(this.mActivity, 2131692754, 2131692759, new aire(this));
        return;
      }
    }
    b();
  ...
  public void postInitUI()
  {
    ...
    for (;;)
    {
      ...
      if (this.mPhotoCommonData.a())
      {
        this.a.jdField_a_of_type_Xne = new xne(this.mActivity, this);
        xna.a().a(this.a.jdField_a_of_type_Xne);
  ...
  {
    aioz.a(paramList, null, this.a.jdField_c_of_type_JavaUtilHashMap);
  }
  ...
  {
    if (aioz.a(paramLocalMediaInfo.path, this.a.jdField_c_of_type_JavaUtilHashMap))
    {
      if (Build.VERSION.SDK_INT >= 21) {
        paramHolder.mPhotoFlagView.setImageDrawable(((NewPhotoListActivity)this.mActivity).getDrawable(2130839178));
      }
      for (;;)
      {
        paramHolder.mPhotoFlagView.setVisibility(0);
        return;
        paramHolder.mPhotoFlagView.setImageResource(2130839178);
      }
    }
