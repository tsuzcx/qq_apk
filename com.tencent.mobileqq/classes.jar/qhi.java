...
class qhi
  implements Runnable
{
  qhi(qhh paramqhh, BluetoothDevice paramBluetoothDevice, byte[] paramArrayOfByte) {}
  ...
  public void run()
  {
    ...
    if ((localBlePeerInfo.jdField_a_of_type_JavaUtilList != null) && (localBlePeerInfo.jdField_a_of_type_JavaUtilList.contains("0000feba-0000-1000-8000-00805f9b34fb")))
    {
      ...
      if ((localBlePeerInfo.jdField_a_of_type_Int == 0) || (localBlePeerInfo.jdField_a_of_type_ArrayOfByte == null) || (!this.jdField_a_of_type_Qhh.a.b.contains(new Long(localBlePeerInfo.jdField_a_of_type_Int)))) {}
    }
    for (;;)
    {
      try
      {
        QFindBLEScanMgr.b(this.jdField_a_of_type_Qhh.a);
        boolean bool1 = QFindBLEScanMgr.a(this.jdField_a_of_type_Qhh.a, localBlePeerInfo);
        bool2 = QFindBLEScanMgr.a(this.jdField_a_of_type_Qhh.a, localBlePeerInfo, bool1);
        if (QLog.isColorLevel()) {
        ...
        QFindBLEScanMgr.a(this.jdField_a_of_type_Qhh.a, localBlePeerInfo.jdField_a_of_type_Int, localBlePeerInfo.a());
      }
      ...
      this.jdField_a_of_type_Qhh.a.a.postDelayed(new qhj(this), this.jdField_a_of_type_Qhh.a.i);
      return;
      if (bool2) {
        QFindBLEScanMgr.a(this.jdField_a_of_type_Qhh.a, localBlePeerInfo, null, false);
      }
    }
  }
}
