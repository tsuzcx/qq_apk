  ...
  implements Handler.Callback
{
  ...
  public azss(azsk paramazsk, String paramString)
  {
  ...
  {
    super.b();
    if ((azsk.a()) && (this.jdField_b_of_type_Int != 0) && (this.jdField_a_of_type_Int > 0))
    {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == 0)
    {
      ...
      azsk.a(this.jdField_b_of_type_Azsk, paramMessage.toString());
      azsk.a(this.jdField_b_of_type_Azsk, new String[] { "nt|fg|", String.valueOf(n), "|", String.valueOf(l1), "|", String.valueOf(l2), "|", String.valueOf(l3), "|", String.valueOf(l4) });
      if (n == 1800) {
        azsk.b(this.jdField_b_of_type_Azsk, new String[] { "fg30Trf", "|", String.valueOf(l1), "|", String.valueOf(l2), "|", String.valueOf(l3), "|", String.valueOf(l4) });
      }
    }
    for (;;)
    {
      ...
      if (paramMessage.what == 3)
      {
        ...
        if (System.currentTimeMillis() - this.m < this.d + 2000L)
        {
          ...
          paramMessage.append(l2 / 1000L).append("/").append(l4 / 1000L);
          azsk.a(this.jdField_b_of_type_Azsk, paramMessage.toString());
          azsk.a(this.jdField_b_of_type_Azsk, new String[] { "nt|bg|", String.valueOf(n), "|", String.valueOf(l1), "|", String.valueOf(l2), "|", String.valueOf(l3), "|", String.valueOf(l4) });
          if (n == 300) {
            azsk.b(this.jdField_b_of_type_Azsk, new String[] { "bg5Trf", "|", String.valueOf(l1), "|", String.valueOf(l2), "|", String.valueOf(l3), "|", String.valueOf(l4) });
          }
        }
      }
    }
