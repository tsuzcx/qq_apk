...
public final class qyr
{
  ...
  static
  {
    jdField_a_of_type_Qyt = new qyt(null);
  }
  ...
  private final Pair<Integer, Long> a(int paramInt)
  {
    ...
    int j = 0;
    int i = 0;
    Object localObject = this.jdField_a_of_type_Szd;
    if (localObject != null)
    {
      localObject = ((szd)localObject).a();
      if (!(localObject instanceof ReadInJoyNewFeedsActivity)) {
        break label274;
      }
      localObject = this.jdField_a_of_type_Szd;
      if (localObject == null) {
        break label72;
      }
    }
    label72:
    for (localObject = ((szd)localObject).a();; localObject = null)
    {
      if (localObject != null) {
        break label78;
      }
    ...
    if (((ReadInJoyNewFeedsActivity)localObject).a() > 0L)
    {
      localObject = this.jdField_a_of_type_Szd;
      if (localObject != null) {}
      for (localObject = ((szd)localObject).a(); localObject == null; localObject = null) {
        throw new TypeCastException("null cannot be cast to non-null type com.tencent.biz.pubaccount.readinjoy.activity.ReadInJoyNewFeedsActivity");
      }
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        ...
        localObject = ((szd)localObject).a();
        label318:
        localObject = pqx.a((Context)localObject);
        if (localObject == null) {
          break label398;
        }
  ...
  public final void a(@Nullable String paramString, @NotNull HashMap<String, String> paramHashMap, @Nullable View paramView)
  {
    ...
    bjum.a((Runnable)new PTSLiteSwiperEventDispatcher.handleSwiperDrag.1(paramString, paramHashMap));
  }
  ...
  {
    Intrinsics.checkParameterIsNotNull(paramHashMap, "dataSet");
    bjum.a((Runnable)new PTSLiteSwiperEventDispatcher.handleSwiperItemExposure.1(this, paramString1, paramString2, paramHashMap));
  }
}
