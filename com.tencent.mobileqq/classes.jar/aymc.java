  ...
  extends aynq
{
  ...
  private long jdField_b_of_type_Long = ayhr.L;
  ...
  public aymc(QQAppInterface paramQQAppInterface, int paramInt1, DiscussionInfo paramDiscussionInfo, List<DiscussionMemberInfo> paramList, int paramInt2)
  {
  ...
  private long a(amnz paramamnz, String paramString1, long paramLong, String paramString2)
  {
    ...
    {
    default: 
      return ayvm.a(paramString2, paramString1, paramLong);
    case 0: 
      return ayvm.a(paramString2, paramString1, paramLong);
    }
    if (paramamnz.a(this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin)) {
      return ayvm.a(paramString2, paramString1, paramLong, true, false, false);
    }
    return ayvm.a(paramString2, paramString1, paramLong);
  }
  
  private long a(List<List<aymd>> paramList)
  {
    ...
    while (i < paramList.size())
    {
      ...
      {
        localObject = ((aymd)((List)paramList.get(i)).get(j)).jdField_a_of_type_ComTencentMobileqqDataDiscussionMemberInfo;
        ...
        l2 = l1;
        if (((aymd)((List)paramList.get(i)).get(j)).jdField_a_of_type_Long > l1) {
          l2 = ((aymd)((List)paramList.get(i)).get(j)).jdField_a_of_type_Long;
        }
        j += 1;
        l1 = l2;
      }
    ...
    for (;;)
    {
      ...
      long l3 = ((aymd)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_Long;
      l2 = l1;
      if (l3 > l1) {
        l2 = l3;
      }
      this.jdField_a_of_type_JavaUtilSet.add(((aymd)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_ComTencentMobileqqDataDiscussionMemberInfo);
      this.jdField_b_of_type_JavaUtilList.add(((aymd)((List)paramList.get(i)).get(arrayOfInt[i])).jdField_a_of_type_JavaLangString);
      i += 1;
      l1 = l2;
    }
  }
  ...
  private void a()
  {
    int i = 0;
    int n = 0;
    if ((ayvm.a(this.jdField_b_of_type_Int)) || (this.jdField_b_of_type_Int == 5))
    {
      ...
      if (this.jdField_a_of_type_JavaUtilList != null)
      {
        ...
        for (int m = 1;; m = 0)
        {
          ...
          localSpannableStringBuilder.append(ayvm.a((String)this.jdField_b_of_type_JavaUtilList.get(j), (String)this.jdField_c_of_type_JavaUtilList.get(j), 6));
          i += 1;
      ...
      this.jdField_c_of_type_JavaLangCharSequence = (i + alud.a(2131702912));
      return;
    }
    this.jdField_a_of_type_JavaLangCharSequence = alud.a(2131702969);
    ...
    for (;;)
    {
      ...
      if (!this.jdField_b_of_type_JavaUtilList.isEmpty())
      {
        ...
        while (i >= 0)
        {
          ((SpannableStringBuilder)localObject).append(ayvm.a((String)this.jdField_b_of_type_JavaUtilList.get(i), (String)this.jdField_c_of_type_JavaUtilList.get(i), 6));
          if (i > 0) {
            ((SpannableStringBuilder)localObject).append("、");
          }
          i -= 1;
  ...
  static boolean a(int paramInt, List<List<aymd>> paramList, long[] paramArrayOfLong, Map<DiscussionMemberInfo, Long> paramMap1, int[] paramArrayOfInt, Map<DiscussionMemberInfo, Integer> paramMap, boolean[] paramArrayOfBoolean, Set<DiscussionMemberInfo> paramSet, Map<DiscussionMemberInfo, Long> paramMap2)
  {
    paramArrayOfBoolean[paramInt] = true;
    int i = 0;
    if (i < ((List)paramList.get(paramInt)).size())
    {
      DiscussionMemberInfo localDiscussionMemberInfo = ((aymd)((List)paramList.get(paramInt)).get(i)).jdField_a_of_type_ComTencentMobileqqDataDiscussionMemberInfo;
      if (paramSet.contains(localDiscussionMemberInfo)) {}
      for (;;)
      {
        i += 1;
        break;
        long l = paramArrayOfLong[paramInt] + ((Long)paramMap1.get(localDiscussionMemberInfo)).longValue() - ((aymd)((List)paramList.get(paramInt)).get(i)).jdField_a_of_type_Long;
        if (l == 0L)
        {
  ...
  private Object[] a(DiscussionMemberInfo paramDiscussionMemberInfo, String paramString)
  {
    ...
    long l1 = a(localamnz, paramDiscussionMemberInfo.inteRemark, ayhr.k, paramString);
    String str;
    ...
    for (;;)
    {
      long l3 = a(localamnz, paramDiscussionMemberInfo.memberName, ayhr.l, paramString);
      l1 = l2;
      if (l3 > l2)
      {
      ...
      Friends localFriends = this.jdField_a_of_type_Alto.b(paramDiscussionMemberInfo.memberUin);
      ...
      if (localFriends != null)
      {
        ...
        {
          l3 = a(localamnz, localFriends.remark, ayhr.j, paramString);
          paramDiscussionMemberInfo = str;
          l2 = l1;
          if (l3 > l1)
          {
          ...
          l1 = a(localamnz, localFriends.name, ayhr.l, paramString);
          l3 = l2;
          if (l1 > l2)
          {
        ...
        if (j < this.jdField_a_of_type_JavaUtilList.size())
        {
          ...
          for (;;)
          {
            ...
            if (l != -9223372036854775808L)
            {
              ...
              localaymd.jdField_a_of_type_Long = l;
              localaymd.jdField_a_of_type_JavaLangString = ((String)arrayOfObject[1]);
              localaymd.jdField_a_of_type_ComTencentMobileqqDataDiscussionMemberInfo = ((DiscussionMemberInfo)this.jdField_a_of_type_JavaUtilList.get(j));
              localArrayList2.add(localaymd);
            }
          }
        }
  ...
  protected long a(String paramString)
  {
    ...
    {
      l1 = ayvm.b(paramString, this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.discussionName, ayhr.e);
        ...
        for (i = 1;; i = 0)
        {
          if (i == 0)
          {
            ...
            if (paramString.a(this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin))
            {
              ...
              this.jdField_b_of_type_Long = ayhr.J;
              break label389;
            }
            this.jdField_b_of_type_Long = ayhr.L;
            break label389;
          }
          label564:
          i = 0;
  ...
  public void a(View paramView)
  {
    ...
    if (ayvm.a(this.jdField_b_of_type_Int))
    {
      ...
      ajlb.a(paramView.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin, 3000, this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.discussionName, false);
      amcg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString);
      ayvm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, a().toString(), this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin, "", 3000);
      ayvm.a(this.jdField_a_of_type_JavaLangString, 20, 3, paramView);
      ayvm.a(this.jdField_a_of_type_JavaLangString, 30, paramView, false);
      ayvm.a(this.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      new azqx(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_listNew").c("search_result").d("clk_grp").a(new String[] { this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo.uin }).a();
      return;
      label299:
  ...
  public String c()
  {
    return bdgc.a(BaseApplicationImpl.sApplication, this.jdField_a_of_type_ComTencentMobileqqDataDiscussionInfo);
  }
