  ...
  implements ayml
{
  ...
  WeakReference<aymd> jdField_a_of_type_MqqUtilWeakReference;
  
  public aymc(QQAppInterface paramQQAppInterface, aymd paramaymd)
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(paramaymd);
  ...
  public aymd a()
  {
    ...
    return (aymd)this.jdField_a_of_type_MqqUtilWeakReference.get();
  }
  ...
  public void a(RedTouchItem paramRedTouchItem, int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt == 100601)
      {
        if (!aymo.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {}
  ...
  {
    aymd localaymd = a();
    if ((paramList == null) || (localaymd == null)) {
      return;
    }
    ...
    while (((Iterator)localObject3).hasNext())
    {
      ...
      {
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", (String)localObject1, (String)localObject1, 0, 0, "", "", "", "");
        localObject2 = localObject1;
      }
    }
    localObject3 = localaymd.a(10015);
    ...
    if (localObject3 != null)
    {
      ...
      if (paramList.contains(localObject3))
      {
        ...
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007391", "0X8007391", 0, 0, "", "", "", "");
        ((MedalWallMng)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MEDAL_WALL_MNG)).b();
      }
    }
    localObject2 = localaymd.a(10016);
    ...
    for (;;)
    {
      ...
      if (localObject2 != null) {
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", (String)localObject2, (String)localObject2, 0, 0, "", "", "", "");
      }
      localObject1 = localaymd.a(10018);
      ...
      paramList = (aqvd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.CONFESS_MANAGER);
      localObject2 = paramList.a();
      if ((localObject2 != null) && (((aquz)localObject2).c())) {
        continue;
      }
