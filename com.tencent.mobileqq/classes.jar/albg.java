  ...
  implements albj, albn
{
  ...
  private albp jdField_a_of_type_Albp;
  ...
  public void a(albo paramalbo)
  {
    if ((paramalbo != null) && (this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArrayList != null))
    {
      if (this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(paramalbo)) {
    ...
    this.jdField_b_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramalbo);
  }
  ...
  public void a(SpriteTaskParam paramSpriteTaskParam)
  {
    ...
    {
      return;
      if ((1 == this.jdField_a_of_type_Alba.d) && (paramSpriteTaskParam.g != 1))
      {
        this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(0, paramSpriteTaskParam);
        if ((this.jdField_a_of_type_Albp instanceof SpriteUIHandler)) {
          ((SpriteUIHandler)this.jdField_a_of_type_Albp).a(false, true, null);
        }
        localObject1 = this.jdField_a_of_type_Alba.a();
        localObject2 = Integer.toString(ApolloUtil.b(this.jdField_a_of_type_Alba.jdField_a_of_type_Int));
    ...
    int i = ApolloUtil.b(this.jdField_a_of_type_Alba.jdField_a_of_type_Int);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Albp != null) {
      this.jdField_a_of_type_Albp.a(paramString, paramString.jdField_a_of_type_Long);
    }
  ...
  public void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Albp != null) {
      this.jdField_a_of_type_Albp.a(paramString, paramString.jdField_a_of_type_Long, paramInt2);
    }
