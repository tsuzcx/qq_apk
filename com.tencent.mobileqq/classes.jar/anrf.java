...
public class anrf
  extends ansq<CameraEmotionData>
{
  private ConcurrentHashMap<Integer, CameraEmotionData> a = new ConcurrentHashMap();
  
  protected anrf(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          ((aseg)this.app.getManager(QQManagerFactory.CAMERA_EMOTION_MANAGER)).a(localCameraEmotionData);
  ...
  private void a(List<CameraEmotionRoaming_sso.ImgInfo> paramList, List<anrg> paramList1, List<String> paramList2)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (!StringUtil.isEmpty(str4))
      {
        ...
        paramList = "";
        label146:
        localanrg.b = paramList;
        if (str2 != null) {
          break label262;
        }
        paramList = "";
        label160:
        localanrg.c = paramList;
        if (str3 != null) {
          break label268;
        }
      }
  ...
  public void a()
  {
    ...
    String str = ((aseg)this.app.getManager(QQManagerFactory.CAMERA_EMOTION_MANAGER)).a();
    ...
    localReqBody.bytes_version.set(ByteStringMicro.copyFrom("8.4.10".getBytes()));
  ...
  public void a(CameraEmotionData paramCameraEmotionData, int paramInt1, int paramInt2, long paramLong)
  {
    ...
    ((CameraEmotionRoaming_sso.ReqBody)localObject2).bytes_version.set(ByteStringMicro.copyFrom("8.4.10".getBytes()));
  ...
  public void a(CameraEmotionData paramCameraEmotionData, boolean paramBoolean)
  {
    ...
    for (Object localObject1 = "";; localObject1 = paramCameraEmotionData.templateId)
    {
      ...
      ((CameraEmotionRoaming_sso.ReqBody)localObject1).bytes_version.set(ByteStringMicro.copyFrom("8.4.10".getBytes()));
  ...
  public void a(List<String> paramList, boolean paramBoolean)
  {
    ...
    paramList.bytes_version.set(ByteStringMicro.copyFrom("8.4.10".getBytes()));
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    case 3: 
      if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
      {
        ...
        for (paramToServiceMsg = "null";; paramToServiceMsg = Integer.valueOf(paramFromServiceMsg.getResultCode()))
        {
          ...
          awyr.e(String.valueOf(paramFromServiceMsg.getResultCode()), 2);
          return;
        }
        awyr.d("3002", 2);
        return;
    ...
    if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
    {
      ...
      for (paramToServiceMsg = "null";; paramToServiceMsg = Integer.valueOf(paramFromServiceMsg.getResultCode()))
      {
        ...
        awyr.d(String.valueOf(paramFromServiceMsg.getResultCode()), 2);
        return;
      }
      awyr.d("3003", 2);
      return;
