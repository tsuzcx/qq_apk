...
public class acvb
{
  ...
  private static MessageMicro a(MessageMicro paramMessageMicro, JSONObject paramJSONObject)
  {
    ...
    //   8: invokestatic 22	acvb:c	(Ljava/lang/Class;)Z
    //   11: ifeq +17 -> 28
    //   14: aload_1
    //   15: ifnull +13 -> 28
    ...
    //   28: ldc 34
    //   30: ldc 36
    //   32: invokestatic 42	acvc:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   35: aconst_null
    //   36: areturn
    //   37: aload_0
    ...
    //   83: ldc 34
    //   85: ldc 75
    //   87: invokestatic 42	acvc:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   90: goto -40 -> 50
    //   93: astore_0
    //   94: ldc 34
    //   96: ldc 77
    //   98: aload_0
    //   99: invokestatic 80	acvc:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   102: aconst_null
    //   103: areturn
    //   104: astore_0
    //   105: ldc 34
    //   107: ldc 77
    //   109: aload_0
    //   110: invokestatic 80	acvc:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   113: aconst_null
    //   114: areturn
    //   115: aload_1
    //   116: aload 5
    ...
    //   184: ldc 34
    //   186: ldc 75
    //   188: invokestatic 42	acvc:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   191: goto -141 -> 50
    //   194: astore 4
    //   196: ldc 34
    //   198: ldc 77
    //   200: aload 4
    //   202: invokestatic 80	acvc:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   205: goto -155 -> 50
    //   208: astore 4
    //   210: ldc 34
    //   212: ldc 77
    //   214: aload 4
    //   216: invokestatic 80	acvc:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   219: goto -169 -> 50
    //   222: astore 4
    //   224: ldc 34
    //   226: ldc 77
    //   228: aload 4
    //   230: invokestatic 80	acvc:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   233: goto -183 -> 50
    //   236: ldc 101
    //   238: aload 5
    ...
    //   246: aload 4
    //   248: invokestatic 104	acvb:a	(Lcom/tencent/mobileqq/pb/PBField;Ljava/lang/Object;)Lcom/tencent/mobileqq/pb/PBField;
    //   251: astore 4
    //   253: aload 4
    //   255: ifnonnull +13 -> 268
    //   258: ldc 34
    //   260: ldc 75
    //   262: invokestatic 42	acvc:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   265: goto -215 -> 50
    //   268: aload 5
    //   270: aload 4
    //   272: invokestatic 106	acvb:a	(Ljava/lang/Object;)Ljava/lang/Object;
    //   275: aload 5
    //   277: invokevirtual 18	java/lang/Object:getClass	()Ljava/lang/Class;
    //   280: invokestatic 109	acvb:a	(Ljava/lang/Class;)Ljava/lang/Class;
    //   283: invokestatic 112	acvb:a	(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Class;)V
    //   286: goto -236 -> 50
    //   289: aload_0
    //   290: instanceof 114
    //   293: ifeq +13 -> 306
    ...
    //   306: ldc 34
    //   308: ldc 75
    //   310: invokestatic 42	acvc:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   313: aconst_null
    //   314: areturn
  ...
  public static PBField a(PBField paramPBField, Object paramObject)
  {
    ...
    {
      acvc.d("GdtJsonPbUtil", "pbFromJson error");
      return null;
    }
  ...
  private static PBField a(PBField paramPBField, JSONArray paramJSONArray)
  {
    ...
    {
      acvc.d("GdtJsonPbUtil", "pbRepeatFromJsonArray error");
      return null;
    }
    try
    {
    ...
    catch (NoSuchFieldException localNoSuchFieldException1)
    {
      for (;;)
      {
        ...
        boolean bool;
        paramPBField = null;
        acvc.d("GdtJsonPbUtil", "getClassOfPBArray", localNoSuchFieldException1);
      }
    }
    catch (IllegalAccessException localIllegalAccessException1)
    {
      for (;;)
      {
        label80:
        paramPBField = null;
        acvc.d("GdtJsonPbUtil", "getClassOfPBArray", localIllegalAccessException1);
        continue;
        ...
        catch (InstantiationException paramPBField)
        {
          for (;;)
          {
            acvc.d("GdtJsonPbUtil", "getClassOfPBArray", paramPBField);
            paramPBField = null;
          }
        }
      ...
      for (;;)
      {
        ...
        {
          acvc.d("GdtJsonPbUtil", "pbRepeatFromJsonArray", localNoSuchFieldException2);
          Object localObject2 = null;
          continue;
        }
        catch (IllegalAccessException localIllegalAccessException2)
        {
          acvc.d("GdtJsonPbUtil", "pbRepeatFromJsonArray", localIllegalAccessException2);
      ...
      for (;;)
      {
        ...
        catch (JSONException localJSONException)
        {
          for (;;)
          {
            acvc.d("GdtJsonPbUtil", "pbRepeatFromJsonArray", localJSONException);
            continue;
  ...
  private static PBPrimitiveField a(PBPrimitiveField paramPBPrimitiveField, Object paramObject)
  {
    ...
    {
      acvc.d("GdtJsonPbUtil", "pbFromJsonPrimitive error");
      return null;
    }
    try
    {
    ...
    catch (Throwable paramObject)
    {
      for (;;)
      {
        acvc.d("GdtJsonPbUtil", "pbFromJsonPrimitive", paramObject);
        paramObject = null;
      }
    }
    return paramObject;
  ...
  private static Class a(Class paramClass)
  {
    if (paramClass == null)
    {
      acvc.d("GdtJsonPbUtil", "getValueClassOfPBField error");
      return null;
    }
    try
    {
    ...
    {
      acvc.d("GdtJsonPbUtil", "getValueClassOfPBField", paramClass);
    }
    return null;
  }
  ...
  public static Object a(PBField paramPBField)
  {
    if (paramPBField == null)
    {
      acvc.d("GdtJsonPbUtil", "pbToJson error");
      return null;
    }
    if (a(paramPBField.getClass())) {
    ...
    acvc.d("GdtJsonPbUtil", "pbToJson error, " + paramPBField.getClass().getName() + " is not supported");
    return null;
  }
  ...
  private static Object a(PBPrimitiveField<?> paramPBPrimitiveField)
  {
    ...
    {
      acvc.d("GdtJsonPbUtil", "pbPrimitiveFieldToJson", paramPBPrimitiveField);
    }
    return "";
  }
  ...
  private static Object a(Object paramObject)
  {
    if (paramObject == null)
    {
      acvc.d("GdtJsonPbUtil", "getOfPB error");
      return null;
    }
    try
    {
    ...
    {
      acvc.d("GdtJsonPbUtil", "getOfPB", paramObject);
    }
    return null;
  }
  ...
  private static JSONArray a(PBField paramPBField)
  {
    ...
    {
      acvc.d("GdtJsonPbUtil", "pbRepeatToJson error");
      return null;
    }
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          acvc.d("GdtJsonPbUtil", "pbMessagebToJson error");
        }
        catch (IllegalAccessException localIllegalAccessException)
        {
          acvc.d("GdtJsonPbUtil", "pbMessagebToJson", localIllegalAccessException);
        }
        continue;
        label179:
        ...
        if ((localObject1 != null) && (!JSONObject.NULL.equals(localObject1))) {
          ...
          {
            acvc.d("GdtJsonPbUtil", "pbMessagebToJson", localJSONException);
          }
        }
      }
    }
  ...
  private static void a(Object paramObject1, Object paramObject2)
  {
    ...
    {
      acvc.d("GdtJsonPbUtil", "addOfPB error");
      return;
    }
    ...
    for (;;)
    {
      ...
      {
        acvc.d("GdtJsonPbUtil", "addOfPB", paramObject1);
        return;
      }
  ...
  private static void a(Object paramObject1, Object paramObject2, Class paramClass)
  {
    ...
    {
      acvc.d("GdtJsonPbUtil", "setOfPB error");
      return;
    }
    try
    {
    ...
    {
      acvc.d("GdtJsonPbUtil", "setOfPB", paramObject1);
    }
  }
