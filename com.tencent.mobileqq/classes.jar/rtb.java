...
public class rtb
{
  ...
  private static rtb jdField_a_of_type_Rtb;
  public static int b;
  ...
  private static final String k = "QQ/8.4.8 Android/0.17 Android/" + Build.VERSION.RELEASE;
  ...
  {
    if ((paramBoolean) && (paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep != null)) {
      return paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep.jdField_a_of_type_JavaLangLong;
    }
  ...
  {
    return bjmz.a(paramString1, paramString2);
  }
  ...
  private JSONArray a(List<rff> paramList)
  {
    JSONArray localJSONArray = new JSONArray();
    Iterator localIterator = paramList.iterator();
    while (localIterator.hasNext())
    {
      rff localrff = (rff)localIterator.next();
      if ((localrff.jdField_b_of_type_JavaLangString != null) || (localrff.c != null))
      {
        JSONObject localJSONObject = new JSONObject();
        if (localrff.jdField_b_of_type_JavaLangString != null)
        {
          paramList = localrff.jdField_b_of_type_JavaLangString;
          label74:
        ...
        label154:
        for (paramList = localrff.c;; paramList = localrff.jdField_b_of_type_JavaLangString)
        {
          localJSONObject.put("thumbnail_url", paramList);
          localJSONObject.put("pic_width", localrff.jdField_a_of_type_Int);
          localJSONObject.put("pic_height", localrff.jdField_b_of_type_Int);
          localJSONArray.put(localJSONObject);
          break;
          paramList = localrff.c;
          break label74;
        }
      }
    }
  ...
  public static rtb a()
  {
    if (jdField_a_of_type_Rtb == null) {
      jdField_a_of_type_Rtb = new rtb();
    }
    return jdField_a_of_type_Rtb;
  }
  ...
  private void a(ArticleInfo paramArticleInfo, JSONObject paramJSONObject)
  {
    if (pay.a(paramArticleInfo))
    {
      ...
      paramJSONObject.put("videoTimeTips", qxf.a(paramArticleInfo.mVideoDuration));
    }
  }
  ...
  private void a(ArticleInfo paramArticleInfo, JSONObject paramJSONObject, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rer != null)
    {
      ...
      if (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rer.jdField_a_of_type_Int != 1) {
        break label372;
      }
      i1 = 1;
    ...
    for (;;)
    {
      if ((paramBoolean2) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep != null))
      {
        paramJSONObject.put("originFeedsId", String.valueOf(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep.jdField_a_of_type_JavaLangLong));
        paramJSONObject.put("originFeedsType", paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep.jdField_b_of_type_JavaLangLong);
        localObject = new JSONArray();
        paramArticleInfo = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep.jdField_a_of_type_JavaUtilList.iterator();
        while (paramArticleInfo.hasNext())
        {
          ...
          localJSONObject.put("biuLevel_uin", new String(bfuc.encode(Long.toString(localBiuCommentInfo.jdField_a_of_type_JavaLangLong.longValue()).getBytes(), 0)));
          localJSONObject.put("biuLevel_nick", "");
          localJSONObject.put("biuLevel_remark", "");
          if (pay.a() != null)
          {
            String str = ContactUtils.getBuddyName((QQAppInterface)pay.a(), Long.toString(localBiuCommentInfo.jdField_a_of_type_JavaLangLong.longValue()), true);
        ...
        if (paramBoolean2)
        {
          localObject = Long.valueOf(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rer.jdField_a_of_type_Long);
          paramJSONObject.put("uin", new String(bfuc.encode(Long.toString(((Long)localObject).longValue()).getBytes(), 0)));
          paramJSONObject.put("nick", "");
          paramJSONObject.put("remark", "");
          if (pay.a() != null)
          {
            localObject = ContactUtils.getBuddyName((QQAppInterface)pay.a(), Long.toString(((Long)localObject).longValue()), true);
  ...
  private void a(String paramString1, JSONObject paramJSONObject, String paramString2, rtg paramrtg)
  {
    ThreadManager.post(new ReadInJoyWebDataManager.5(this, paramString1, paramString2, paramrtg, paramJSONObject), 5, null, true);
  }
  
  /* Error */
  private void a(String paramString1, rtf paramrtf, JSONObject paramJSONObject, String paramString2)
  {
    // Byte code:
    //   0: invokestatic 191	pay:a	()Lmqq/app/AppRuntime;
    ...
    //   17: dup
    //   18: aload_1
    //   19: invokespecial 446	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   22: astore 7
    //   24: aload 7
    //   26: ldc_w 448
    //   29: invokevirtual 451	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   32: astore 5
    //   34: aload 5
    //   36: astore_1
    //   37: aload 5
    //   39: invokestatic 457	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   42: ifne +24 -> 66
    //   45: aload 5
    //   47: ldc_w 459
    //   50: ldc_w 461
    //   53: invokevirtual 465	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   56: ldc_w 467
    //   59: ldc_w 469
    //   62: invokevirtual 465	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   65: astore_1
    //   66: aload_3
    //   67: ldc_w 448
    //   70: aload_1
    ...
    //   75: aload 7
    //   77: ldc_w 471
    //   80: invokevirtual 451	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   83: astore 5
    //   85: aload 5
    //   87: invokestatic 457	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   90: ifeq +20 -> 110
    //   93: aload_2
    //   94: aload_3
    //   95: invokeinterface 476 2 0
    //   100: return
    //   101: astore_1
    //   102: aload_2
    //   103: aload_3
    //   104: invokeinterface 476 2 0
    //   109: return
    //   110: new 321	java/net/URL
    //   113: dup
    //   114: aload 4
    //   116: invokespecial 477	java/net/URL:<init>	(Ljava/lang/String;)V
    //   119: invokevirtual 480	java/net/URL:getHost	()Ljava/lang/String;
    //   122: astore_1
    //   123: aload 7
    //   125: ldc_w 482
    //   128: invokevirtual 451	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   131: astore 4
    //   133: aload 4
    //   135: invokestatic 457	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   138: ifne +462 -> 600
    //   141: aload_0
    //   142: aload 4
    //   144: aload_1
    //   145: invokespecial 485	rtb:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   148: ifeq +45 -> 193
    //   151: aload 4
    //   153: astore_1
    //   154: aload_1
    //   155: astore 4
    //   157: aload_1
    //   158: invokestatic 457	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   161: ifeq +8 -> 169
    //   164: ldc_w 487
    //   167: astore 4
    //   169: aload 7
    //   171: ldc_w 489
    //   174: invokevirtual 451	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   177: astore_1
    //   178: aload_1
    //   179: invokestatic 457	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   182: ifeq +19 -> 201
    //   185: aload_2
    //   186: aload_3
    //   187: invokeinterface 476 2 0
    //   192: return
    //   193: aload_2
    //   194: aload_3
    //   195: invokeinterface 476 2 0
    //   200: return
    //   201: aload_0
    //   202: aload 4
    //   204: aload 5
    //   206: aload_1
    //   207: invokespecial 491	rtb:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   210: astore 7
    //   212: aload 7
    //   214: invokestatic 457	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   217: ifeq +11 -> 228
    //   220: aload_2
    //   221: aload_3
    //   222: invokeinterface 476 2 0
    //   227: return
    //   228: new 493	java/io/File
    //   231: dup
    //   232: new 33	java/lang/StringBuilder
    //   235: dup
    //   236: invokespecial 36	java/lang/StringBuilder:<init>	()V
    //   239: getstatic 496	com/tencent/biz/pubaccount/PublicAccountJavascriptInterface:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   256: invokestatic 503	com/tencent/mobileqq/utils/HexUtil:String2HexString	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   279: aload 5
    //   281: invokestatic 503	com/tencent/mobileqq/utils/HexUtil:String2HexString	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   293: aload_1
    //   294: invokestatic 503	com/tencent/mobileqq/utils/HexUtil:String2HexString	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   303: invokespecial 504	java/io/File:<init>	(Ljava/lang/String;)V
    //   306: astore 5
    //   308: aload 5
    //   310: invokevirtual 507	java/io/File:exists	()Z
    //   313: ifne +22 -> 335
    //   316: aload_3
    //   317: ldc_w 509
    //   320: ldc_w 511
    ...
    //   327: aload_2
    //   328: aload_3
    //   329: invokeinterface 476 2 0
    //   334: return
    //   335: aload_0
    //   336: monitorenter
    //   337: new 513	java/io/FileInputStream
    //   340: dup
    //   341: aload 5
    //   343: invokespecial 516	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   346: astore_1
    //   347: aload_1
    //   348: astore 4
    //   350: aload 5
    //   352: invokevirtual 518	java/io/File:length	()J
    //   355: l2i
    //   356: newarray byte
    //   358: astore 5
    //   360: aload_1
    ...
    //   363: aload_1
    //   364: aload 5
    //   366: invokevirtual 524	java/io/InputStream:read	([B)I
    //   369: pop
    //   370: aload_1
    //   371: astore 4
    //   373: aload_0
    ...
    //   383: aload 7
    //   385: invokespecial 526	rtb:b	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   388: astore 5
    //   390: aload 5
    ...
    //   425: ifnull +178 -> 603
    //   428: aload_1
    //   429: invokevirtual 529	java/io/InputStream:close	()V
    //   432: return
    //   433: astore_1
    //   434: aload_1
    //   435: invokevirtual 532	java/io/IOException:printStackTrace	()V
    //   438: return
    //   439: aload_1
    //   440: astore 4
    //   442: aload_3
    ...
    //   448: ldc_w 459
    //   451: ldc_w 461
    //   454: invokevirtual 465	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   457: ldc_w 467
    //   460: ldc_w 469
    //   463: invokevirtual 465	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    //   486: ifnull +117 -> 603
    //   489: aload_1
    //   490: invokevirtual 529	java/io/InputStream:close	()V
    //   493: return
    //   494: astore_1
    //   495: aload_1
    //   496: invokevirtual 532	java/io/IOException:printStackTrace	()V
    //   499: return
    //   500: astore 5
    //   502: aconst_null
    //   503: astore_1
    ...
    //   534: aload_2
    //   535: aload_3
    //   536: invokeinterface 476 2 0
    //   541: aload_1
    //   542: ifnull +61 -> 603
    //   545: aload_1
    //   546: invokevirtual 529	java/io/InputStream:close	()V
    //   549: return
    //   550: astore_1
    //   551: aload_1
    //   552: invokevirtual 532	java/io/IOException:printStackTrace	()V
    //   555: return
    //   556: astore_1
    //   557: aconst_null
    //   558: astore 4
    ...
    //   562: ifnull +8 -> 570
    //   565: aload 4
    //   567: invokevirtual 529	java/io/InputStream:close	()V
    //   570: aload_1
    //   571: athrow
    //   572: astore 4
    //   574: aload 4
    //   576: invokevirtual 532	java/io/IOException:printStackTrace	()V
    //   579: goto -9 -> 570
    //   582: astore_1
    //   583: goto -23 -> 560
    //   586: astore_1
  ...
  private void a(URL paramURL, String paramString1, String paramString2, JSONObject paramJSONObject)
  {
    ...
    //   36: astore 7
    //   38: aload 8
    //   40: invokestatic 457	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   43: ifne +25 -> 68
    //   46: aload 8
    //   48: ldc_w 459
    //   51: ldc_w 461
    //   54: invokevirtual 465	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   57: ldc_w 467
    //   60: ldc_w 469
    //   63: invokevirtual 465	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   66: astore 7
    //   68: aload 4
    //   70: ldc_w 448
    //   73: aload 7
    ...
    //   78: pop
    //   79: getstatic 119	rtb:jdField_a_of_type_Long	J
    //   82: ldc2_w 538
    //   85: lcmp
    //   86: ifle +20 -> 106
    //   89: new 541	com/tencent/biz/pubaccount/readinjoy/video/ReadInJoyWebDataManager$3
    //   92: dup
    //   93: aload_0
    //   94: aload_1
    //   95: aload_2
    //   96: aload_3
    //   97: aload 4
    //   99: invokespecial 544	com/tencent/biz/pubaccount/readinjoy/video/ReadInJoyWebDataManager$3:<init>	(Lrtb;Ljava/net/URL;Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONObject;)V
    //   102: invokestatic 548	com/tencent/mobileqq/app/ThreadManager:executeOnNetWorkThread	(Ljava/lang/Runnable;)V
    //   105: return
    //   106: aload 10
    //   108: ldc_w 471
    //   111: invokevirtual 451	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   114: astore_3
    //   115: aload_3
    //   116: invokestatic 457	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   119: ifne +423 -> 542
    //   122: aload 10
    //   124: ldc_w 489
    //   127: invokevirtual 451	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   130: astore 4
    //   132: aload 4
    //   134: invokestatic 457	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   137: ifne +405 -> 542
    //   140: aload 10
    //   142: ldc_w 534
    //   145: invokevirtual 451	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   148: astore 7
    //   150: aload 7
    //   152: invokestatic 457	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   155: ifne +387 -> 542
    //   158: aload_1
    //   159: invokevirtual 480	java/net/URL:getHost	()Ljava/lang/String;
    //   162: astore_1
    //   163: aload 10
    //   165: ldc_w 482
    //   168: invokevirtual 451	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   171: astore_2
    //   172: aload_2
    //   173: invokestatic 457	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   176: ifne +363 -> 539
    //   179: aload_0
    //   180: aload_2
    //   181: aload_1
    //   182: invokespecial 485	rtb:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   185: ifeq +357 -> 542
    //   188: aload_2
    //   189: astore_1
    //   190: aload_1
    //   191: astore_2
    //   192: aload_1
    //   193: invokestatic 457	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   196: ifeq +7 -> 203
    //   199: ldc_w 487
    //   202: astore_2
    //   203: aload_0
    //   204: aload 7
    //   206: invokespecial 550	rtb:b	(Ljava/lang/String;)Ljava/lang/String;
    //   209: astore_1
    //   210: aload_0
    //   211: aload_2
    //   212: aload_3
    //   213: aload 4
    //   215: aload_1
    //   216: invokespecial 552	rtb:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   219: aload_0
    //   220: aload 7
    //   222: aload_1
    //   223: invokespecial 553	rtb:a	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   226: astore 7
    //   228: new 493	java/io/File
    //   231: dup
    //   232: new 33	java/lang/StringBuilder
    ...
    //   265: invokespecial 504	java/io/File:<init>	(Ljava/lang/String;)V
    //   268: astore_1
    //   269: aload_1
    //   270: invokevirtual 507	java/io/File:exists	()Z
    //   273: ifne +153 -> 426
    //   276: aload_1
    //   277: invokevirtual 556	java/io/File:mkdirs	()Z
    //   280: pop
    //   281: new 493	java/io/File
    //   284: dup
    //   285: aload_1
    //   286: aload_2
    //   287: invokespecial 559	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   290: astore_1
    //   291: aload_1
    //   292: invokevirtual 507	java/io/File:exists	()Z
    //   295: ifne +151 -> 446
    //   298: aload_1
    //   299: invokevirtual 556	java/io/File:mkdirs	()Z
    //   302: pop
    //   303: new 493	java/io/File
    //   306: dup
    //   307: aload_1
    //   308: aload_3
    //   309: invokestatic 503	com/tencent/mobileqq/utils/HexUtil:String2HexString	(Ljava/lang/String;)Ljava/lang/String;
    //   312: invokespecial 559	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   315: astore 8
    //   317: aload 8
    //   319: invokevirtual 507	java/io/File:exists	()Z
    //   322: ifne +144 -> 466
    //   325: aload 8
    //   327: invokevirtual 556	java/io/File:mkdirs	()Z
    //   330: pop
    //   331: aconst_null
    //   332: astore_2
    //   333: aconst_null
    ...
    //   339: aload_3
    //   340: astore_2
    //   341: new 493	java/io/File
    //   344: dup
    //   345: aload 8
    //   347: aload 4
    //   349: invokestatic 503	com/tencent/mobileqq/utils/HexUtil:String2HexString	(Ljava/lang/String;)Ljava/lang/String;
    //   352: invokespecial 559	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   355: astore 4
    //   357: aload_3
    //   358: astore_2
    //   359: aload 4
    //   361: invokevirtual 507	java/io/File:exists	()Z
    //   364: ifeq +11 -> 375
    //   367: aload_3
    //   368: astore_2
    //   369: aload 4
    //   371: invokevirtual 562	java/io/File:delete	()Z
    //   374: pop
    //   375: aload_3
    //   376: astore_2
    //   377: new 564	java/io/FileWriter
    //   380: dup
    //   381: aload 4
    //   383: invokespecial 565	java/io/FileWriter:<init>	(Ljava/io/File;)V
    //   386: astore_1
    //   387: aload_1
    //   388: aload 7
    //   390: invokevirtual 568	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   393: getstatic 119	rtb:jdField_a_of_type_Long	J
    //   396: lstore 5
    //   398: aload 4
    //   400: invokevirtual 518	java/io/File:length	()J
    //   403: lload 5
    //   405: ladd
    //   406: putstatic 119	rtb:jdField_a_of_type_Long	J
    //   409: aload_0
    //   410: monitorexit
    //   411: aload_1
    //   412: ifnull +130 -> 542
    //   415: aload_1
    //   416: invokevirtual 569	java/io/FileWriter:close	()V
    //   419: return
    //   420: astore_1
    //   421: aload_1
    //   422: invokevirtual 532	java/io/IOException:printStackTrace	()V
    //   425: return
    //   426: aload_1
    //   427: invokevirtual 572	java/io/File:isFile	()Z
    //   430: ifeq -149 -> 281
    //   433: aload_1
    //   434: invokevirtual 562	java/io/File:delete	()Z
    //   437: pop
    //   438: aload_1
    //   439: invokevirtual 556	java/io/File:mkdirs	()Z
    //   442: pop
    //   443: goto -162 -> 281
    //   446: aload_1
    //   447: invokevirtual 572	java/io/File:isFile	()Z
    //   450: ifeq -147 -> 303
    //   453: aload_1
    //   454: invokevirtual 562	java/io/File:delete	()Z
    //   457: pop
    //   458: aload_1
    //   459: invokevirtual 556	java/io/File:mkdirs	()Z
    //   462: pop
    //   463: goto -160 -> 303
    //   466: aload 8
    //   468: invokevirtual 572	java/io/File:isFile	()Z
    //   471: ifeq -140 -> 331
    //   474: aload 8
    //   476: invokevirtual 562	java/io/File:delete	()Z
    //   479: pop
    //   480: aload 8
    //   482: invokevirtual 556	java/io/File:mkdirs	()Z
    //   485: pop
    //   486: goto -155 -> 331
    //   489: astore_3
    //   490: aload_2
    ...
    //   502: ifnull +40 -> 542
    //   505: aload_2
    //   506: invokevirtual 569	java/io/FileWriter:close	()V
    //   509: return
    //   510: astore_1
    //   511: aload_1
    //   512: invokevirtual 532	java/io/IOException:printStackTrace	()V
    //   515: return
    //   516: astore_2
    //   517: aload_1
    //   518: ifnull +7 -> 525
    //   521: aload_1
    //   522: invokevirtual 569	java/io/FileWriter:close	()V
    //   525: aload_2
    //   526: athrow
    //   527: astore_1
    //   528: aload_1
    //   529: invokevirtual 532	java/io/IOException:printStackTrace	()V
    //   532: goto -7 -> 525
    //   535: astore_3
    //   536: goto -44 -> 492
    //   539: goto -349 -> 190
  ...
  public static boolean a(ArticleInfo paramArticleInfo)
  {
    ...
    {
      return false;
      if ((pgb.f(paramArticleInfo)) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep != null))
      {
        switch ((int)paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep.jdField_b_of_type_JavaLangLong.longValue())
        {
        case 11: 
        default: 
          return false;
    ...
    } while ((!pgb.a(paramArticleInfo)) && (!pgb.h(paramArticleInfo)));
    return true;
  }
  ...
  {
    if ((paramBoolean) && (paramArticleInfo.mSocialFeedInfo != null) && (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep != null)) {
      return paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep.jdField_b_of_type_JavaLangLong;
    }
  ...
  {
    return bjmz.b(paramString1, paramString2);
  }
  ...
  private void b(ArticleInfo paramArticleInfo, JSONObject paramJSONObject)
  {
    ...
    {
      paramJSONObject.put("timeTips", pax.a(paramArticleInfo.mSocialFeedInfo.e, true));
    ...
    } while ((paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfe == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfe.a == null) || (paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfe.a.size() <= 0));
    paramJSONObject.put("multiPicUrls", a(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rfe.a));
  }
  ...
  public void a(ArticleInfo paramArticleInfo, boolean paramBoolean, String paramString)
  {
    ...
    Boolean localBoolean1 = Boolean.valueOf(pgb.f(paramArticleInfo));
    if ((pgb.a(paramArticleInfo)) || (pgb.h(paramArticleInfo))) {}
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("timeTips", pax.a(paramArticleInfo.mTime));
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt == 1)
        {
          localrte = new rte(this);
          paramString = str + "&ispreload=1";
        }
        str = c;
        if (paramInt == 1)
        {
          a("get", paramString, localJSONObject, str, localrte, Boolean.valueOf(bool));
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  {
    odq.a(null, "", "0X8008221", "0X8008221", 0, 0, paramString1, paramString2, "", "", false);
  }
  
  public void a(String paramString1, String paramString2, String paramString3)
  {
    odq.a(null, "", "0X8008220", "0X8008220", 0, 0, paramString1, paramString2, paramString3, "", false);
  }
  ...
  public void a(String paramString1, String paramString2, JSONObject paramJSONObject, String paramString3, rtg paramrtg, Boolean paramBoolean)
  {
    ...
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        ...
        {
          a(paramString2, paramJSONObject, paramString3, paramrtg);
          return;
        }
      }
    }
  ...
  public void a(String paramString1, String paramString2, rtf paramrtf)
  {
    JSONObject localJSONObject = new JSONObject();
    if (TextUtils.isEmpty(paramString2)) {
      return;
    }
    new Thread(new ReadInJoyWebDataManager.4(this, paramString2, paramrtf, localJSONObject, paramString1)).start();
  }
  
  public void a(String paramString, JSONObject paramJSONObject)
  {
    if ((BaseApplication.getContext() == null) || (!pdn.a())) {}
    do
    {
      return;
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaViewViolaBaseView == null)
      {
        ...
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaViewViolaBaseView.a(jdField_a_of_type_JavaLangString, null, new tpa(jdField_a_of_type_JavaLangString, new JSONObject(), null, null));
      }
      try
      {
        JSONObject localJSONObject = new JSONObject();
  ...
  public boolean a()
  {
    ...
    if ((b()) && (bkwm.A(localQQAppInterface))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
