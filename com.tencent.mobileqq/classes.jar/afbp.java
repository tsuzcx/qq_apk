  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public afbp(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity)
  {
  ...
  protected Integer a(Void... arg1)
  {
    ...
    {
      localObject1 = axdq.a(0, this.jdField_b_of_type_Int);
      axey localaxey = axdq.a(this.jdField_a_of_type_AndroidContentIntent, (axei)localObject1);
      if (localaxey == null) {
        return Integer.valueOf(5);
      }
      localaxey.d = true;
      localaxey.a = false;
      if ((localaxey.r != null) && (localaxey.r.length() == 39)) {
        localaxey.r = localaxey.r.substring(0, 28);
      }
      ((axei)localObject1).a(localaxey);
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo = ((MessageForShortVideo)new axda(???.app).a(localaxey));
      ...
      ((afax)((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getManager(138)).a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForShortVideo);
