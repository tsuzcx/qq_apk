...
final class abjx
  extends QIPCModule
{
  private static volatile abjx a;
  
  private abjx(String paramString)
  {
    super(paramString);
  }
  
  public static abjx a()
  {
    if (a == null) {}
    try
    {
      if (a == null) {
        a = new abjx("gdt_ipc_module_server_to_client");
      }
      return a;
    }
    finally {}
  ...
  public void callbackResult(int paramInt, EIPCResult paramEIPCResult)
  {
    ...
    {
      abrl.b("GdtIPCAdapter", String.format("ServerToClientIPCModule.callbackResult success:%b", new Object[] { Boolean.valueOf(bool) }));
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if (localParams != null)
    {
      ...
      label33:
      abrl.b("GdtIPCAdapter", String.format("ServerToClientIPCModule.onCall action:%s to:%s", new Object[] { paramBundle, str }));
