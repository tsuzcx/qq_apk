...
{
  public aeaq(GameRoomInviteActivity paramGameRoomInviteActivity) {}
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt == 0)
      {
        ...
        this.a.jdField_a_of_type_ComTencentMobileqqWerewolvesWereWolvesLoadingView.setComplete(new aear(this));
    ...
    case 1: 
      do
      {
        ...
        if ((!paramMsgBody.uint64_invite_leader.has()) || (paramMsgBody.uint64_invite_leader.get() == this.a.app.getLongAccountUin()))
        {
          ...
          ((aebl)localObject).jdField_a_of_type_JavaLangString = (localPlayerState.uint64_uin.get() + "");
        ...
        {
          ((aebl)localObject).jdField_a_of_type_Boolean = bool;
      ...
      this.a.jdField_a_of_type_Aebm.notifyDataSetChanged();
      this.a.a();
      return;
    case 2: 
