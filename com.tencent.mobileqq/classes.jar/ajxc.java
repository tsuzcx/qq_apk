...
public class ajxc
{
  ...
  protected static amzh a;
  public static Handler a;
  public static String a;
  public static WeakReference<ajxi> a;
  public static int b;
  ...
  static
  {
    ...
    jdField_a_of_type_AndroidOsHandler = new ajxd(Looper.myLooper());
    jdField_a_of_type_Amzh = new amzh(jdField_a_of_type_AndroidOsHandler);
  }
  ...
  public static ArrayList<PfaFriend> a()
  {
    ...
    do
    {
      ...
      localObject2 = ((anuz)localObject1).getRecentList(true);
  ...
  public static HashMap<String, Object> a(ajxi paramajxi, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramajxi);
    ...
    paramajxi = new HashMap();
    if (jdField_a_of_type_WalletPfaFriendRsp == null)
    {
      paramajxi.put(jdField_a_of_type_JavaLangString, a());
    ...
    for (;;)
    {
      paramajxi.put(jdField_b_of_type_JavaLangString, jdField_a_of_type_WalletPfaFriendRsp.vecPfaMsg);
      if (!paramBoolean) {
        break;
      }
      ...
      return paramajxi;
      label142:
      paramajxi.put(jdField_a_of_type_JavaLangString, jdField_a_of_type_WalletPfaFriendRsp.vecRec);
    }
  }
  ...
  public static void a(int paramInt1, int paramInt2)
  {
    ...
    localQQAppInterface.addObserver(jdField_a_of_type_Amzh);
    ...
    for (;;)
    {
      ((amzg)localQQAppInterface.getBusinessHandler(42)).a(localPfaFriendRqt);
      return;
  ...
  public static void a(SelectMemberActivity paramSelectMemberActivity, ArrayList<ResultRecord> paramArrayList)
  {
    ...
    Object localObject2 = amtj.a(2131714054);
    ...
    for (localObject2 = (String)localObject1 + "、";; localObject2 = localObject1)
    {
      ...
      {
        QQToast.a(paramSelectMemberActivity, paramSelectMemberActivity.getString(2131719024), 0).a();
        return;
      }
      paramArrayList = new ajxe(new WeakReference(paramSelectMemberActivity), localArrayList);
      localObject2 = paramSelectMemberActivity.getIntent().getExtras();
      paramSelectMemberActivity = bfur.a(paramSelectMemberActivity, (String)localObject1, ((Bundle)localObject2).getString("choose_friend_content"), ((Bundle)localObject2).getString("choose_friend_subcontent"), paramSelectMemberActivity.mTopayTips, null, paramArrayList, paramArrayList, 36, false);
      bcef.b(akgd.a(), "P_CliOper", "Vip_pay_mywallet", "", "wallet", "friendpay.selectpage.windowshow", 0, 0, "", "", "", "");
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramQQAppInterface != null) {
      paramQQAppInterface.removeObserver(jdField_a_of_type_Amzh);
    }
  }
  ...
  protected static void a(boolean paramBoolean)
  {
    if (jdField_a_of_type_JavaLangRefWeakReference != null)
    {
      ajxi localajxi = (ajxi)jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localajxi != null) {
        localajxi.b(paramBoolean);
      }
    }
  }
  ...
  {
    ajxg localajxg = new ajxg(paramActivity);
    paramList1 = new ajxh(paramActivity, paramList1, paramList2);
    paramActivity = bfur.a(paramActivity, 230, null, amtj.a(2131714055), amtj.a(2131714053), "留在QQ", paramList1, localajxg);
