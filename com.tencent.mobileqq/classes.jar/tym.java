...
public class tym
{
  private static volatile tym jdField_a_of_type_Tym;
  ...
  public static tym a()
  {
    if (jdField_a_of_type_Tym == null) {}
    try
    {
      if (jdField_a_of_type_Tym == null) {
        jdField_a_of_type_Tym = new tym();
      }
      return jdField_a_of_type_Tym;
    }
    finally {}
  }
  ...
  private void a(FeedCloudCommon.StCommonExt paramStCommonExt, int paramInt)
  {
    ...
    VSNetworkHelper.a().a(paramStCommonExt, new tyn(this, paramInt));
  }
  ...
  private void a(FeedCloudRead.StGetSessionInfoRsp paramStGetSessionInfoRsp, int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        typ.a().a(this.jdField_b_of_type_ArrayOfByte);
        return;
      } while (1 != paramStGetSessionInfoRsp.sessionType.get());
      this.jdField_b_of_type_ArrayOfByte = paramStGetSessionInfoRsp.sessonID.get().toByteArray();
      this.jdField_a_of_type_Int = paramStGetSessionInfoRsp.expireTime.get();
  ...
  private void b(int paramInt)
  {
    if (this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap != null)
    {
      ...
      if (l > 0L) {
        tyi.a(this.jdField_b_of_type_Long, System.currentTimeMillis() - l, paramInt, paramInt);
      }
    }
  }
  ...
  private void c(int paramInt)
  {
    if (this.jdField_a_of_type_Long != 0L)
    {
      ...
      for (Object localObject = this.jdField_a_of_type_ArrayOfByte;; localObject = this.jdField_b_of_type_ArrayOfByte)
      {
        ...
        VSNetworkHelper.a().a((VSBaseRequest)localObject, new tyo(this, (QCircleHeartbeatSignalReportRequest)localObject));
        h();
        return;
      }
    }
  ...
  private void h()
  {
    ...
    tye.a(this.c, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, this.jdField_b_of_type_Long, this.jdField_b_of_type_Int);
  ...
  {
    i();
    return new ArrayList(Arrays.asList(new FeedCloudCommon.Entry[] { a("uin", String.valueOf(bexd.a().a())), a("network_type", b()), a("app_version", "8.3.3.4515"), a("qua", bizf.a()), a("platform", "android"), a("report_from", "1"), a("os_version", Build.VERSION.RELEASE), a("mobile_type", Build.MODEL), a("respond_type", bfin.e()), a("device_info", Build.DEVICE), a("imei", bfin.c()), a("idfa", ""), a("idfv", "") }));
  }
