  ...
  extends MessageMicro<PbPushMsg>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 26, 32, 72 }, new String[] { "msg", "svrip", "bytes_push_token", "ping_flag", "uint32_general_flag" }, new Object[] { null, Integer.valueOf(0), localByteStringMicro, Integer.valueOf(0), Integer.valueOf(0) }, PbPushMsg.class);
  }
}
