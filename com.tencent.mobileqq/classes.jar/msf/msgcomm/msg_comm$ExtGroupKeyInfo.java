  ...
  extends MessageMicro<ExtGroupKeyInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 34 }, new String[] { "cur_max_seq", "cur_time", "operate_by_parents", "bytes_ext_group_info" }, new Object[] { localInteger, Long.valueOf(0L), localInteger, localByteStringMicro }, ExtGroupKeyInfo.class);
  }
}
