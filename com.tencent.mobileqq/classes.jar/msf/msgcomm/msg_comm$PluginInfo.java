  ...
  extends MessageMicro<PluginInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40, 48, 58, 66, 74, 82, 90 }, new String[] { "res_id", "pkg_name", "new_ver", "res_type", "lan_type", "priority", "res_name", "res_desc", "res_url_big", "res_url_small", "res_conf" }, new Object[] { localInteger, "", localInteger, localInteger, localInteger, localInteger, "", "", "", "", "" }, PluginInfo.class);
  }
}
