  ...
  extends MessageMicro<PbC2CUnReadMsgNumResp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24 }, new String[] { "result", "errmsg", "msg_num" }, new Object[] { localInteger, "", localInteger }, PbC2CUnReadMsgNumResp.class);
  }
}
