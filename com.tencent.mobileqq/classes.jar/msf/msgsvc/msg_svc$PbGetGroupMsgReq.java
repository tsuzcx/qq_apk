  ...
  extends MessageMicro<PbGetGroupMsgReq>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 48, 56, 64 }, new String[] { "group_code", "begin_seq", "end_seq", "filter", "member_seq", "public_group", "shield_flag", "save_traffic_flag" }, new Object[] { localLong, localLong, localLong, localInteger, localLong, Boolean.valueOf(false), localInteger, localInteger }, PbGetGroupMsgReq.class);
  }
}
