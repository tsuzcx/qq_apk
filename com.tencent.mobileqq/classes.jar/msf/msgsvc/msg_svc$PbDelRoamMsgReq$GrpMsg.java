  ...
  extends MessageMicro<GrpMsg>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "group_code", "msg_seq", "uint32_resv_flag" }, new Object[] { localLong, localLong, Integer.valueOf(0) }, GrpMsg.class);
  }
}
