  ...
  extends MessageMicro<MessageResult>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 42, 48 }, new String[] { "uint32_result", "uint32_msg_seq", "uint32_msg_time", "uint32_msg_random", "bytes_err_msg", "uint32_msg_type" }, new Object[] { localInteger, localInteger, localInteger, localInteger, localByteStringMicro, localInteger }, MessageResult.class);
  }
}
