  ...
  extends MessageMicro<PbGetGroupMsgResp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40, 50 }, new String[] { "result", "errmsg", "group_code", "return_begin_seq", "return_end_seq", "msg" }, new Object[] { Integer.valueOf(0), "", localLong, localLong, localLong, null }, PbGetGroupMsgResp.class);
  }
}
