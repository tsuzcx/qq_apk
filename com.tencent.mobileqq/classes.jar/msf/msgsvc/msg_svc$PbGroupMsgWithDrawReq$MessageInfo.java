  ...
  extends MessageMicro<MessageInfo>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32 }, new String[] { "uint32_msg_seq", "uint32_msg_random", "uint32_msg_type", "uint32_resv_flag" }, new Object[] { localInteger, localInteger, localInteger, localInteger }, MessageInfo.class);
  }
}
