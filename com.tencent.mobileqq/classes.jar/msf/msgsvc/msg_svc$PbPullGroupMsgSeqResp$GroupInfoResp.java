  ...
  extends MessageMicro<GroupInfoResp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24 }, new String[] { "group_code", "member_seq", "group_seq" }, new Object[] { localLong, localLong, localLong }, GroupInfoResp.class);
  }
}
