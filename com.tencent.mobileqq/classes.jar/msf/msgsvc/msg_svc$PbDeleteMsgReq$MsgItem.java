  ...
  extends MessageMicro<MsgItem>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 58 }, new String[] { "from_uin", "to_uin", "msg_type", "msg_seq", "msg_uid", "sig" }, new Object[] { localLong, localLong, localInteger, localInteger, localLong, localByteStringMicro }, MsgItem.class);
  }
}
