  ...
  extends MessageMicro<PbSendMsgResp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 42, 48, 58, 66, 72, 80 }, new String[] { "result", "errmsg", "send_time", "uint32_svrbusy_wait_time", "msg_send_info", "errtype", "trans_svr_info", "receipt_resp", "text_analysis_result", "uint32_msg_info_flag" }, new Object[] { localInteger, "", localInteger, localInteger, null, localInteger, null, null, localInteger, localInteger }, PbSendMsgResp.class);
  }
}
