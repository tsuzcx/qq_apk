  ...
  extends MessageMicro<PbGroupReadedReportResp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 40 }, new String[] { "result", "errmsg", "group_code", "member_seq", "group_msg_seq" }, new Object[] { Integer.valueOf(0), "", localLong, localLong, localLong }, PbGroupReadedReportResp.class);
  }
}
