...
public class bhcm
{
  ...
  private long jdField_l_of_type_Long = 1L;
  private String jdField_l_of_type_JavaLangString = "none";
  private long jdField_m_of_type_Long = 55L;
  private String jdField_m_of_type_JavaLangString = "#ffffff";
  private long jdField_n_of_type_Long = 40L;
  ...
  private HashMap<String, String> a(String paramString1, int paramInt, String paramString2)
  {
    ...
    if ((this.jdField_b_of_type_Int == 4) || (this.jdField_b_of_type_Int == 5) || (this.jdField_b_of_type_Int == 6) || (this.jdField_b_of_type_Int == 7) || (this.jdField_b_of_type_Int == 2))
    {
      ...
      localHashMap.put("beauty_value", "" + AEBeautyProviderView.a() / 100.0D);
      localHashMap.put("facial_value", "" + AEBeautyProviderView.b() / 100.0D);
      ...
      localHashMap.put("cameraId", bhcl.a(ahhj.jdField_a_of_type_Int));
      if (jdField_a_of_type_JavaLangLong.longValue() != 1L) {
        break label431;
      }
      localHashMap.put("resolution", bgxl.a.d());
    }
    for (;;)
    {
      ...
      localHashMap.put("face_type", this.jdField_b_of_type_Int + "");
      if ((this.jdField_b_of_type_Int != 4) && (this.jdField_b_of_type_Int != 5) && (this.jdField_b_of_type_Int != 6) && (this.jdField_b_of_type_Int != 7)) {
        break label474;
      }
      ...
      if (jdField_a_of_type_JavaLangLong.longValue() == 2L) {
        localHashMap.put("resolution", bgxl.a.g());
      } else {
  ...
  public HashMap<String, String> a(int paramInt, String paramString1, String paramString2)
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("ret_code", "" + paramInt);
  ...
  public HashMap<String, String> a(long paramLong)
  {
    ...
    for (;;)
    {
      localHashMap.put("duration", bhcl.a(Long.valueOf(System.currentTimeMillis() - paramLong)));
      localHashMap.put("cameraId", bhcl.a(ahhj.jdField_a_of_type_Int));
      if (jdField_a_of_type_JavaLangLong.longValue() != 1L) {
        break label244;
      }
  ...
  public HashMap<String, String> a(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      if ((this.jdField_h_of_type_JavaLangString == null) || (!this.jdField_h_of_type_JavaLangString.equals(paramString)))
      {
        ...
        this.jdField_i_of_type_JavaLangString = bcdu.d(QQStoryContext.a().getAccount() + bhcl.a());
      }
  ...
  public void a()
  {
    ...
    bhcs.a("AEBaseReportParam", 1, "【operation_time】:" + str);
  }
  ...
  public HashMap<String, String> b(long paramLong)
  {
    ...
    if ((this.jdField_b_of_type_Int == 4) || (this.jdField_b_of_type_Int == 5) || (this.jdField_b_of_type_Int == 6) || (this.jdField_b_of_type_Int == 7) || (this.jdField_b_of_type_Int == 2))
    {
      ...
      localHashMap.put("face_uin", this.jdField_d_of_type_JavaLangString + UserAction.getQIMEI());
      label331:
      localHashMap.put("preview_view_size", bgxl.a.a());
      localHashMap.put("configed_preview_resolution", bgxl.a.b());
      localHashMap.put("configed_capture_resolution", bgxl.a.c());
      localHashMap.put("render_resolution", bgxl.a.e());
      if (jdField_a_of_type_JavaLangLong.longValue() != 1L) {
        break label524;
      }
      localHashMap.put("resolution", bgxl.a.d());
      ...
      if (!bgxl.a.jdField_b_of_type_Boolean) {
        break label567;
      }
    }
    label524:
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("packageId", "package_base");
    if (paramBoolean) {}
    for (String str = "1";; str = "0")
    {
  ...
  public HashMap<String, String> c(boolean paramBoolean)
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("packageId", "package_add_1");
    if (paramBoolean) {}
    for (String str = "1";; str = "0")
    {
      localHashMap.put("ret_code", str);
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("duration", bhcl.a(Long.valueOf(a())));
    return localHashMap;
  }
  
  public HashMap<String, String> e(String paramString)
  {
    return bhcl.a(f(), i(paramString));
  }
  ...
  {
    this.jdField_m_of_type_Long = paramLong;
  }
  ...
  public HashMap<String, String> f()
  {
    ...
    for (String str = bcdu.d(QQStoryContext.a().getAccount() + bhcl.a());; str = this.jdField_i_of_type_JavaLangString) {
      return a(str, 1, "-1");
    }
  }
  ...
  {
    this.jdField_n_of_type_Long = paramLong;
  }
  ...
  {
    this.jdField_l_of_type_Long = paramLong;
  }
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("duration_first_frame", bhcl.a(Long.valueOf(this.jdField_d_of_type_Long - this.jdField_c_of_type_Long)));
    localHashMap.put("duration_bottom_bar", bhcl.a(Long.valueOf(this.jdField_e_of_type_Long - this.jdField_c_of_type_Long)));
    localHashMap.put("duration_photo_btn", bhcl.a(Long.valueOf(this.jdField_f_of_type_Long - this.jdField_c_of_type_Long)));
    String str;
    if (bhcl.b()) {
      str = "first_launch";
    }
  ...
  public HashMap<String, String> j()
  {
    ...
    HashMap localHashMap = new HashMap();
    localHashMap.put("duration", bhcl.a(Long.valueOf(l1 - l2)));
    return localHashMap;
  }
  ...
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("duration", bhcl.a(Long.valueOf(this.jdField_i_of_type_Long)));
    ...
    Object localObject = new DecimalFormat("0.00").format((float)this.jdField_m_of_type_Long / 100.0F);
    String str = new DecimalFormat("0.00").format((float)this.jdField_n_of_type_Long / 100.0F);
    localHashMap.put("beauty_value", localObject);
    localHashMap.put("facial_value", str);
    localObject = bjac.a().c(0);
    if (localObject != null) {}
    for (this.jdField_k_of_type_JavaLangString = ((QIMFilterCategoryItem)localObject).jdField_a_of_type_JavaLangString;; this.jdField_k_of_type_JavaLangString = "none")
    {
      ...
      localHashMap.put("cameraId", Long.toString(this.jdField_l_of_type_Long));
  ...
  public void k()
  {
    ...
    this.jdField_n_of_type_JavaLangString = bcdt.a(localStringBuilder.toString());
  }
  ...
  public HashMap<String, String> m()
  {
    ...
    localHashMap.put("cameraId", Long.toString(this.jdField_l_of_type_Long));
    localHashMap.put("emoticon_id", this.jdField_j_of_type_JavaLangString);
    localHashMap.put("text_content", this.jdField_l_of_type_JavaLangString);
    if (this.jdField_l_of_type_JavaLangString.equals("none"))
    {
    ...
    {
      localHashMap.put("filter_id", this.jdField_k_of_type_JavaLangString);
      if (this.jdField_n_of_type_JavaLangString.equals("")) {
        k();
      }
      localHashMap.put("MD5", this.jdField_n_of_type_JavaLangString);
      return localHashMap;
      localHashMap.put("text_color", this.jdField_m_of_type_JavaLangString);
      break;
    }
  }
