...
{
  public bhcm(QZoneMsgFragment paramQZoneMsgFragment) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (paramIntent.getAction() == "com.qzone.sync_comment_like")
    {
      ...
      if ((this.a.jdField_a_of_type_Bhck != null) && (!TextUtils.isEmpty(paramContext))) {
        i = 0;
      }
    }
    for (;;)
    {
      if (i < this.a.jdField_a_of_type_Bhck.getCount())
      {
        paramIntent = (MQMsg)this.a.jdField_a_of_type_Bhck.getItem(i);
        if ((paramIntent.msgInteractData != null) && (paramIntent.msgInteractData.likeCell != null) && (paramIntent.msgInteractData.likeCell.likeKey.equals(paramContext)))
        {
          ...
          ((bhcq)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(293)).a(paramIntent);
        }
      }
      else
      {
        this.a.jdField_a_of_type_Bhck.notifyDataSetChanged();
        return;
      }
      i += 1;
    }
