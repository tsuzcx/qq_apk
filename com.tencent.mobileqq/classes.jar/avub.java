...
public class avub
  extends avue
  implements avuy, URLDrawable.DownloadListener
{
  public int a;
  ...
  public avub(HotPicPageView paramHotPicPageView, View paramView, avvi paramavvi)
  {
    super(paramHotPicPageView, paramView, paramavvi);
    this.jdField_a_of_type_Int = -10;
    if (this.itemView != null) {
      this.itemView.setOnTouchListener(null);
    }
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131368170));
    this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131368177));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131368176));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380981));
    ...
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131372939));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380916));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131380982));
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131364535);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131380785));
  }
  ...
  public void a()
  {
    ...
    if (localHotVideoMongoliaRelativeLayout != null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avub == this) {
        this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avub = null;
      }
  ...
  public void b()
  {
    ...
    localValueAnimator.addUpdateListener(new avud(this));
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.itemView.setContentDescription(anzj.a(2131704505));
      continue;
      this.jdField_d_of_type_AndroidWidgetImageView.setVisibility(0);
      a();
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
      ...
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.itemView.setContentDescription(anzj.a(2131704502));
      this.jdField_a_of_type_Boolean = false;
      continue;
      this.jdField_a_of_type_Boolean = false;
      if (paramInt == 1) {
      ...
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.itemView.setContentDescription(anzj.a(2131704508));
      continue;
      if ((this.jdField_d_of_type_AndroidWidgetImageView.getVisibility() == 0) && ((this.jdField_a_of_type_Int == 1) || (this.jdField_a_of_type_Int == 2)))
      {
        ...
        ((AlphaAnimation)localObject).setAnimationListener(new avuc(this));
      ...
      for (;;)
      {
        ...
        this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
        this.jdField_a_of_type_AndroidViewView.setVisibility(8);
        this.itemView.setContentDescription(anzj.a(2131704504));
        break;
        this.jdField_d_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      this.jdField_d_of_type_AndroidWidgetImageView.setVisibility(8);
      ...
      this.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.itemView.setContentDescription(anzj.a(2131704506));
      b();
      continue;
      this.jdField_d_of_type_AndroidWidgetImageView.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
      ...
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_a_of_type_AndroidViewView.setVisibility(8);
      this.itemView.setContentDescription(anzj.a(2131704507));
    }
  }
  ...
  {
    if ((this.jdField_a_of_type_Avvi != null) && ((this.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_Int == -11))) {
      this.jdField_a_of_type_Avvi.c(this, getPosition());
    }
    for (;;)
    {
  ...
  public void onFileDownloadFailed(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avvh.a();
  }
  ...
  public void onFileDownloadSucceed(long paramLong)
  {
    ...
    if ((localHotVideoData != null) && (localHotVideoData.picIndex == paramLong))
    {
      ...
      if (localHotVideoData.CheckIsNeedBlurBackground())
      {
        ...
        if ((Build.VERSION.SDK_INT >= 17) && (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.a()) && (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avup != null)) {
          this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avup.a(this, localHotVideoData);
        }
      }
    }
    this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avvh.a();
