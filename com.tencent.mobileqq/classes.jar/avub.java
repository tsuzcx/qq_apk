...
public class avub
{
  private static HashMap<String, avub> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private final Context jdField_a_of_type_AndroidContentContext;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new avuc(this);
  private final Handler jdField_a_of_type_AndroidOsHandler;
  private avud jdField_a_of_type_Avud;
  ...
  private avub(Context paramContext, File paramFile, String paramString)
  {
    ...
    this.jdField_a_of_type_Boolean = avte.a();
  ...
  public static avub a(Context paramContext, String paramString1, String paramString2)
  {
    try
    {
      String str = paramString2 + paramString1;
      avub localavub = (avub)jdField_a_of_type_JavaUtilHashMap.get(str);
      paramString1 = localavub;
      if (localavub == null)
      {
        paramString1 = new avub(paramContext.getApplicationContext(), a(paramContext), paramString2);
  ...
  private InstalledPlugin a(ProgressFuture<InstalledPlugin> paramProgressFuture)
  {
    ...
    if ((!this.jdField_b_of_type_Boolean) && (avue.jdField_a_of_type_Boolean))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (str.equals("SOURCE_CGI"))
        {
          ...
          avue.a("2653754");
          localObject1 = localObject2;
          a("HuayangPluginNewDownloader", anvx.a(2131705116) + localTargetDownloadInfo.url);
          localObject1 = localObject2;
      ...
      catch (VersionCheckException localVersionCheckException)
      {
        ...
        try
        {
          ...
          a("updatePlugin", j, m, "", "");
          localObject3 = localInstalledPlugin;
          a("HuayangPluginNewDownloader", anvx.a(2131705130) + m);
          localObject3 = localInstalledPlugin;
          if (!str.equals("SOURCE_CGI")) {
            continue;
          }
  ...
  private void a(InstalledPlugin paramInstalledPlugin)
  {
    ...
    try
    {
      ...
      a("HuayangPluginNewDownloader", anvx.a(2131705112));
      str1 = str2;
      if (!this.jdField_b_of_type_Boolean)
      {
  ...
  {
    Object localObject = new StringBuilder().append(anvx.a(2131705118));
    boolean bool;
    if (paramInstalledPlugin == null)
    {
      bool = true;
  ...
  {
    Intent localIntent = new Intent(avts.c(this.jdField_b_of_type_JavaLangString));
    int i;
    if (paramBoolean)
    {
      i = 1;
      ...
      if (!paramBoolean)
      {
        if (!avts.a(this.jdField_b_of_type_JavaLangString)) {
          break label64;
        }
        avue.a("2714209");
      }
    ...
    label64:
    while (!avts.b(this.jdField_b_of_type_JavaLangString))
    {
      return;
      i = 0;
      break;
  ...
  private void b(InstalledPlugin paramInstalledPlugin)
  {
    ...
    if (this.jdField_a_of_type_Avud != null) {
      this.jdField_a_of_type_Avud.a(10, new Object[0]);
    }
    ...
    a("HuayangPluginNewDownloader", anvx.a(2131705132));
  }
  
  private void b(InstalledPlugin paramInstalledPlugin, boolean paramBoolean)
  {
    a("HuayangPluginNewDownloader", anvx.a(2131705120) + paramInstalledPlugin);
  ...
  private void c()
  {
    ...
    if ((localObject1 != null) && (((List)localObject1).size() > 0))
    {
      ...
      {
        a("HuayangPluginNewDownloader", anvx.a(2131705127) + (String)localObject3 + " mPluginVersion:" + this.e);
    ...
    for (;;)
    {
      ...
      if (avuf.jdField_a_of_type_JavaUtilMap.get(this.d) != null) {
        avue.b(String.valueOf(((avuf)avuf.jdField_a_of_type_JavaUtilMap.get(this.d)).g));
      }
      localObject3 = null;
      break;
      label553:
    ...
    if (!this.jdField_b_of_type_Boolean) {
      if (localException1 == null)
      {
        ...
        a("HuayangPluginNewDownloader", anvx.a(2131705126));
