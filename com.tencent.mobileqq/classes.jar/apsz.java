...
public class apsz
{
  public static final String a = amtj.a(2131714291);
  ...
  public static String a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          String[] arrayOfString = bfwg.a(localObject2[i], "=");
          ...
          localObject2 = new String(bfuc.decode(arrayOfString[1], 0));
          localObject1 = localObject2;
          if (!((String)localObject2).contains("&gc=")) {
            localObject1 = String.format("%s&gc=%s", new Object[] { localObject2, awkh.a(paramString2) });
          }
          paramString2 = bfuc.encodeToString(((String)localObject1).getBytes(), 2);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, String paramString1, int paramInt2, String paramString2, String paramString3)
  {
    for (;;)
    {
      ...
      localStringBuilder.append("&").append("quin").append("=").append(awkh.a(paramString1));
      localStringBuilder.append("&").append("topicId").append("=").append(paramInt2);
      localStringBuilder.append("&").append("sUin").append("=").append(awkh.a(paramString2));
      localStringBuilder.append("&").append("rUin").append("=").append(awkh.a(paramString3));
      ...
      return;
      localObject = ((aprw)localObject).o;
      continue;
      str = "aio_card_insert";
    }
  }
          ...
          for (;;)
          {
            ...
            catch (InvalidProtocolBufferMicroException paramStringBuilder)
            {
              try
              {
                ...
                paramList = (MessageForTroopConfess)bbli.a(-2067);
  ...
  public static Object[] a(String paramString)
  {
    ...
    for (Object localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();; localObject1 = null)
    {
      ...
      if (localObject2 != null)
      {
        ...
        if (localObject2 != null) {
          if (bftf.a(str, ((TroopInfo)localObject2).troopowneruin))
          {
            i = 2;
        ...
        for (;;)
        {
          ...
          if (paramString != null)
          {
            ...
            for (;;)
            {
              ...
              if (bftf.d(((TroopMemberInfo)localObject1).memberuin)) {
  ...
  {
    boolean bool2 = false;
    paramMessageRecord = bfat.a(paramMessageRecord);
    boolean bool1 = bool2;
