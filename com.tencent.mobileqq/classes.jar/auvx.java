...
public class auvx
  extends QIPCModule
{
  private static volatile auvx a;
  
  public auvx(String paramString)
  {
    super(paramString);
  }
  
  public static auvx a()
  {
    if (a == null) {}
    try
    {
      if (a == null) {
        a = new auvx("QQGameIPCModule");
      }
      return a;
    }
    finally {}
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          paramString = (autd)((AppRuntime)localObject2).getManager(358);
        ...
        {
          ((autd)((AppRuntime)localObject2).getManager(358)).a(0);
      ...
      autv.a("game_source_pic_txt", paramString, paramBundle);
      autv.a("game_source_pic_url", (String)localObject1, paramBundle);
      autv.a("game_source_type_pic", paramInt + "", paramBundle);
      autv.a("game_source_subtype_pic", i + "", paramBundle);
      ...
      {
        autf.a(((autd)((AppRuntime)localObject2).getManager(358)).b(), ((AppRuntime)localObject2).getApplication(), null);
        return null;
      }
    } while (!"action_set_clean_req_time".equals(paramString));
    autf.a(((AppRuntime)localObject2).getAccount());
    return null;
  }
}
