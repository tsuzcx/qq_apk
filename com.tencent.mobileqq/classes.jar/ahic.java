...
public class ahic
{
  ...
  public static void a(int paramInt)
  {
    try
    {
      ...
      if (!str1.equals(str2))
      {
        ahih.a(ahib.d, 1, paramInt, null, false);
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, String... paramVarArgs)
  {
    try
    {
      ...
      ahih.a(ahib.b, paramInt1, paramInt2, localHashMap, paramBoolean);
      return;
    }
  ...
  private static void a(int paramInt, AppInterface paramAppInterface)
  {
    ...
    for (;;)
    {
      ...
      if (localObject != null) {
        ThreadManagerV2.executeOnFileThread(new SpringHbMonitorReporter.1((ahid)localObject));
      }
    }
  }
  ...
  public static void a(PreloadModule paramPreloadModule, int paramInt1, String paramString, int paramInt2)
  {
    ...
    do
    {
      ...
      paramPreloadModule = ahiy.c(paramString);
      if (!TextUtils.isEmpty(paramPreloadModule))
      {
        ...
        ahih.a(ahib.jdField_a_of_type_JavaLangString, 2, paramInt1, localHashMap);
      }
      if (paramInt1 == 0)
      {
        a();
  ...
  public static void a(SpringHbReportManager.ReportInfo paramReportInfo)
  {
    ...
    paramReportInfo = (ahfz)((QQAppInterface)localObject).getManager(342);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          {
            i = 0;
            ahih.a((String)localObject3, 2, i, (Map)localObject2, false);
          }
        }
        else
        {
      ...
      {
        ahih.a(paramString, 1, paramInt1, (Map)localObject3, true);
  ...
  public static void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    ahih.a(ahib.jdField_a_of_type_JavaLangString, 4, paramInt, localHashMap);
  }
  ...
  public static void a(boolean paramBoolean1, int paramInt, AppInterface paramAppInterface, boolean paramBoolean2)
  {
    ...
    for (int i = 0;; i = 1)
    {
      ahih.a((String)localObject2, 1, i, (Map)localObject1, false);
    ...
    String str = ahib.jdField_a_of_type_JavaLangString;
    if (paramBoolean1) {}
    for (paramInt = j;; paramInt = 1)
    {
      ahih.a(str, 1, paramInt, (Map)localObject2, true);
  ...
  @NonNull
  private static ahid b(AppRuntime paramAppRuntime)
  {
    ahid localahid = new ahid(null);
    Object localObject = "";
    int k = 0;
    int m = -1;
    int j;
    ...
    {
      localObject = (ahfs)((QQAppInterface)paramAppRuntime).getManager(343);
      if (localObject == null) {
        break label232;
      }
      if (((ahfs)localObject).a() != null)
      {
        paramAppRuntime = ((ahfs)localObject).a().bids;
        j = ((ahfs)localObject).a();
        i = ((ahfs)localObject).b();
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        localahid.jdField_a_of_type_JavaLangString = ((String)localObject);
        localahid.b = i;
        localahid.jdField_a_of_type_Int = j;
        return localahid;
        paramAppRuntime = "";
        break;
  ...
  private static int c(int paramInt)
  {
    ...
    return ampm.a().a(paramInt, localQQAppInterface.getCurrentAccountUin());
  }
