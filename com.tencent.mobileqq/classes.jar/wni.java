...
public class wni
  extends wki<CertifiedAccountMeta.StComment>
  implements View.OnClickListener, Animation.AnimationListener, CompoundButton.OnCheckedChangeListener, IEventReceiver
{
  private static final String jdField_a_of_type_JavaLangString = wni.class.getSimpleName();
  ...
  private View.OnLayoutChangeListener jdField_a_of_type_AndroidViewView$OnLayoutChangeListener = new wnl(this);
  private ViewStub jdField_a_of_type_AndroidViewViewStub;
  private Animation jdField_a_of_type_AndroidViewAnimationAnimation;
  private AbsListView.OnScrollListener jdField_a_of_type_AndroidWidgetAbsListView$OnScrollListener = new wnk(this);
  public ListView a;
  ...
  protected wmn a;
  private wnb jdField_a_of_type_Wnb;
  private final wnp jdField_a_of_type_Wnp;
  private wnq jdField_a_of_type_Wnq;
  private wnr jdField_a_of_type_Wnr;
  private wns jdField_a_of_type_Wns;
  private woo jdField_a_of_type_Woo;
  private woq jdField_a_of_type_Woq;
  ...
  public wni(Activity paramActivity, boolean paramBoolean, CertifiedAccountMeta.StFeed paramStFeed, wnr paramwnr, ExtraTypeInfo paramExtraTypeInfo)
  {
    super(paramActivity, paramBoolean);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Wnp = new wnp(this);
    stb.a().registerSubscriber(this.jdField_a_of_type_Wnp);
  ...
  private wmn a()
  {
    if (this.jdField_a_of_type_Wmn == null)
    {
      this.jdField_a_of_type_Wmn = new wmn();
      this.jdField_e_of_type_Int = this.jdField_a_of_type_Wmn.hashCode();
    }
    return this.jdField_a_of_type_Wmn;
  }
  ...
  private void a(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_Wnb == null) {
      this.jdField_a_of_type_Wnb = new wnb((Activity)this.jdField_a_of_type_AndroidContentContext);
    }
    String str2;
    String str1;
    if (paramStReply != null) {
      if (paramStReply.postUser != null)
      {
        ...
        this.jdField_a_of_type_Wnb.b(str1);
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_Wnb.a(new wnm(this, paramStComment, paramStReply));
      c(paramStComment, paramStReply);
      this.jdField_a_of_type_Wnb.a(paramBoolean2);
      return;
      ...
      {
        this.jdField_a_of_type_Wnb.b(this.jdField_a_of_type_AndroidContentContext.getString(2131692374));
      }
    }
  }
  ...
  private void a(CertifiedAccountMeta.StFeed paramStFeed, CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    for (paramStComment = paramStReply;; paramStComment = str)
    {
      ...
      wsd.a(this.jdField_a_of_type_AndroidContentContext, paramStReply);
      return;
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_Wnb != null) && (this.jdField_a_of_type_AndroidWidgetTextView != null)) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Wnb.a());
      }
      return;
      k = 0;
    }
  ...
  private void a(Object[] paramArrayOfObject)
  {
    ...
    do
    {
        ...
        do
        {
          do
          {
            ...
            do
            {
              do
              {
                  ...
                  for (;;)
                  {
                    ...
                    if (paramArrayOfObject[3] != null)
                    {
                      ...
                      if (this.jdField_a_of_type_Wnr != null) {
                        this.jdField_a_of_type_Wnr.a((CertifiedAccountRead.StGetFeedDetailRsp)localObject2, VSNetworkHelper.a((String)localObject1), localLong.longValue(), (String)localObject1);
                      }
                      if ((paramArrayOfObject.length >= 6) && (paramArrayOfObject[5] != null))
                      {
                        ...
                        if (((COMM.StCommonExt)localObject1).mapInfo.size() > 0)
                        {
                          ...
                          h();
                          wpt.a().a(new CommentReplyEvent((CertifiedAccountMeta.StComment)paramArrayOfObject.get(0), (CertifiedAccountMeta.StReply)localObject1));
                          this.i = true;
                          this.j = true;
                        }
                      }
                    ...
                    for (;;)
                    {
                      ...
                      break;
                      h();
                      wpt.a().a(new CommentReplyEvent((CertifiedAccountMeta.StComment)paramArrayOfObject.get(0), null));
                      break;
                      a(new CommentPresenter.12(this));
                      break;
                      QLog.w(jdField_a_of_type_JavaLangString, 1, "get feed detail response failed");
                      if (this.jdField_a_of_type_Wnr != null) {
                        this.jdField_a_of_type_Wnr.a(null, VSNetworkHelper.a((String)localObject1), localLong.longValue(), (String)localObject1);
                      }
                      if (!this.h) {
                        bcql.a(a(), (CharSequence)localObject1, 0).a();
                      }
                    }
                  }
                  if (this.jdField_a_of_type_Wnb != null) {
                    this.jdField_a_of_type_Wnb.b(this.jdField_a_of_type_AndroidWidgetTextView);
                  }
                ...
                if ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoCommentRsp))
                {
                  ...
                  if ((localLong.longValue() != 0L) && (this.jdField_a_of_type_Woo != null) && (this.jdField_a_of_type_Woo.a(String.valueOf(paramArrayOfObject[4])))) {
                    m();
                  }
                  if (localLong.longValue() == 0L)
                  {
                    if ((this.jdField_a_of_type_Woo != null) && (this.jdField_a_of_type_Woo.a(String.valueOf(paramArrayOfObject[4]), (CertifiedAccountMeta.StComment)localObject2))) {
                      m();
                    }
                    b(1);
                  }
                }
                a(localLong.longValue(), ajya.a(2131702196), (String)localObject1);
              ...
              if ((localLong.longValue() == 0L) && ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoCommentRsp)))
              {
                ...
                if ((this.jdField_a_of_type_Woo != null) && (this.jdField_a_of_type_Woo.a(paramArrayOfObject))) {
                  m();
                }
                b(-1);
              }
              a(localLong.longValue(), ajya.a(2131702190), ajya.a(2131702199));
              return;
            ...
            if ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoReplyRsp))
            {
              ...
              if ((localLong.longValue() != 0L) && (this.jdField_a_of_type_Woo != null) && (this.jdField_a_of_type_Woo.a(((CertifiedAccountMeta.StComment)localObject2).id.get(), paramArrayOfObject))) {
                m();
              }
              if ((localLong.longValue() == 0L) && (this.jdField_a_of_type_Woo != null) && (this.jdField_a_of_type_Woo.a(((CertifiedAccountMeta.StComment)localObject2).id.get(), paramArrayOfObject, (CertifiedAccountMeta.StReply)localObject1))) {
                m();
              }
            }
            a(localLong.longValue(), ajya.a(2131702189), ajya.a(2131702200));
            return;
          } while (a(5, paramArrayOfObject));
          a(localLong.longValue(), ajya.a(2131702195), ajya.a(2131702202));
      ...
      } while ((localLong.longValue() != 0L) || (this.jdField_a_of_type_Woo == null) || (TextUtils.isEmpty(paramArrayOfObject)) || (TextUtils.isEmpty((CharSequence)localObject1)));
      this.jdField_a_of_type_Woo.a(paramArrayOfObject, (String)localObject1);
      m();
      return;
    ...
    label1207:
    for (paramArrayOfObject = this.jdField_a_of_type_Wmn.a((List)localObject1, (String)paramArrayOfObject[5]);; paramArrayOfObject = (Object[])localObject1)
    {
      this.jdField_a_of_type_Woo.a(paramArrayOfObject);
      m();
      return;
    }
  }
  ...
  {
    if ((paramStUser != null) && (win.a() != null) && (paramStUser.id.get().equals(win.a().id.get()))) {}
  ...
  private void b(int paramInt)
  {
    ...
    stb.a().dispatch(new wna(5, new Object[] { b(), Integer.valueOf(this.jdField_d_of_type_Int) }));
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    {
      localTextView = (TextView)this.jdField_c_of_type_AndroidViewView.findViewById(2131370452);
      if (localTextView != null)
      {
        if (!paramBoolean) {
          break label37;
        }
        localTextView.setText(2131693816);
      }
    }
    return;
    label37:
  ...
  private void c(int paramInt)
  {
    ...
    if (paramInt == 0) {
      this.jdField_a_of_type_Woo.a(a().poster.id.get());
    }
  ...
  private void c(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    this.jdField_a_of_type_Wnb.setOnShowListener(new wnn(this, paramStComment, paramStReply));
    this.jdField_a_of_type_Wnb.a(new wno(this, paramStComment, paramStReply));
  }
  ...
  private void n()
  {
    ...
    this.jdField_b_of_type_AndroidViewView = a(2131364467);
    this.jdField_e_of_type_AndroidViewView = a(2131365997);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131364498));
    this.jdField_c_of_type_AndroidViewView = a(2131364478);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131377110));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_d_of_type_AndroidViewView = a(2131363531);
    ...
    this.jdField_a_of_type_Woo = new woo(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Wns);
    this.jdField_a_of_type_Woo.a(this.jdField_d_of_type_JavaLangString);
    this.jdField_a_of_type_AndroidWidgetListView.setAdapter(this.jdField_a_of_type_Woo);
    this.jdField_a_of_type_AndroidWidgetListView.setEmptyView(this.jdField_c_of_type_AndroidViewView);
    if (this.jdField_b_of_type_AndroidViewView != null) {
      this.jdField_b_of_type_AndroidViewView.setOnClickListener(new wnj(this));
    }
  }
  ...
  private void p()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 313	wni:jdField_a_of_type_Wmn	Lwmn;
    //   6: ifnonnull +16 -> 22
    //   9: getstatic 65	wni:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   12: iconst_1
    //   13: ldc_w 902
    ...
    //   22: aload_0
    //   23: aload_0
    //   24: invokespecial 326	wni:a	()Lwmn;
    //   27: aload_0
    //   28: invokespecial 299	wni:b	()Ljava/lang/String;
    //   31: invokevirtual 617	wmn:a	(Ljava/lang/String;)Ljava/util/ArrayList;
    //   34: putfield 305	wni:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   37: aload_0
    //   38: aload_0
    //   39: invokespecial 326	wni:a	()Lwmn;
    //   42: aload_0
    //   43: invokespecial 299	wni:b	()Ljava/lang/String;
    //   46: invokevirtual 905	wmn:a	(Ljava/lang/String;)LNS_COMM/COMM$StCommonExt;
    //   49: putfield 286	wni:jdField_a_of_type_NS_COMMCOMM$StCommonExt	LNS_COMM/COMM$StCommonExt;
    //   52: aload_0
    //   53: getfield 305	wni:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   56: ifnull -37 -> 19
    //   59: aload_0
    //   60: getfield 333	wni:jdField_a_of_type_Woo	Lwoo;
    //   63: ifnull +44 -> 107
    //   66: aload_0
    //   67: getfield 333	wni:jdField_a_of_type_Woo	Lwoo;
    //   70: invokevirtual 907	woo:a	()V
    //   73: aload_0
    //   74: getfield 333	wni:jdField_a_of_type_Woo	Lwoo;
    //   77: aload_0
    //   78: getfield 305	wni:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   81: invokevirtual 765	woo:a	(Ljava/util/Collection;)Z
    //   84: pop
    //   85: aload_0
    //   86: getfield 662	wni:i	Z
    //   89: ifeq +11 -> 100
    //   92: aload_0
    //   93: getfield 333	wni:jdField_a_of_type_Woo	Lwoo;
    //   96: iconst_0
    //   97: invokevirtual 909	woo:a	(I)V
    //   100: aload_0
    //   101: getfield 333	wni:jdField_a_of_type_Woo	Lwoo;
    //   104: invokevirtual 912	woo:notifyDataSetChanged	()V
    //   107: aload_0
    //   108: getfield 339	wni:jdField_a_of_type_AndroidWidgetListView	Landroid/widget/ListView;
    //   111: ifnull +47 -> 158
    //   114: aload_0
    //   115: getfield 97	wni:jdField_g_of_type_Int	I
    //   118: aload_0
    //   119: invokevirtual 149	wni:a	()I
    //   122: if_icmpeq +36 -> 158
    //   125: aload_0
    //   126: getfield 662	wni:i	Z
    //   129: ifeq +29 -> 158
    //   132: aload_0
    //   133: aload_0
    //   134: invokevirtual 149	wni:a	()I
    //   137: putfield 97	wni:jdField_g_of_type_Int	I
    //   140: getstatic 65	wni:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   143: iconst_1
    //   144: ldc_w 914
    //   147: invokestatic 373	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   150: aload_0
    //   151: getfield 339	wni:jdField_a_of_type_AndroidWidgetListView	Landroid/widget/ListView;
    //   154: iconst_0
    //   155: invokevirtual 917	android/widget/ListView:setSelection	(I)V
    //   158: aload_0
    //   159: getfield 305	wni:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   162: ifnull -143 -> 19
    //   165: aload_0
    //   166: getfield 305	wni:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   169: invokevirtual 632	java/util/ArrayList:size	()I
    //   172: ifle -153 -> 19
    //   175: aload_0
    //   176: aload_0
    //   177: invokespecial 326	wni:a	()Lwmn;
    //   180: aload_0
    //   181: invokespecial 299	wni:b	()Ljava/lang/String;
    //   184: invokevirtual 781	wmn:a	(Ljava/lang/String;)I
    //   187: putfield 131	wni:jdField_d_of_type_Int	I
    //   190: goto -171 -> 19
    //   193: astore_1
    //   194: aload_0
    //   195: monitorexit
    ...
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
        {
          ...
          {
            this.jdField_b_of_type_AndroidWidgetTextView.setText(wol.a(this.jdField_d_of_type_Int));
          ...
          if (this.jdField_a_of_type_Woo.getCount() == 0)
          {
            bool = true;
            b(bool);
          }
  ...
  public void a(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    String str = b();
    if ((!bbkk.a(str)) && (a() != null) && (a().vecComment.size() == 0) && (a().commentCount.get() != 0))
    {
  ...
  public void a(wnq paramwnq)
  {
    this.jdField_a_of_type_Wnq = paramwnq;
  }
  
  public void a(woq paramwoq)
  {
    this.jdField_a_of_type_Woq = paramwoq;
  }
  ...
  public boolean d()
  {
    return (this.jdField_a_of_type_Wnb != null) && (this.jdField_a_of_type_Wnb.isShowing());
  }
  
  protected void e()
  {
    stb.a().unRegisterSubscriber(this.jdField_a_of_type_Wnp);
    a().a();
    this.jdField_a_of_type_Wmn = null;
  ...
  public void onAnimationEnd(Animation paramAnimation)
  {
    if (paramAnimation == this.jdField_a_of_type_AndroidViewAnimationAnimation)
    {
      ...
      if (this.jdField_a_of_type_Wnq != null) {
        this.jdField_a_of_type_Wnq.i();
      }
    }
