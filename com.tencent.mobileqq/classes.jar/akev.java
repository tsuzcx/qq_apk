...
public class akev
  extends Handler
{
  public akev(QQSpecialFriendSettingActivity paramQQSpecialFriendSettingActivity) {}
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              QQSpecialFriendSettingActivity.a(this.a, new bety(this.a, this.a.getTitleBarHeight()));
