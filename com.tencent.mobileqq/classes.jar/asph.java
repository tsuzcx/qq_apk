...
public class asph
{
  ...
  public static asph a(String paramString)
  {
    if (paramString == null) {}
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            localObject = new asph();
            ((asph)localObject).a = Integer.parseInt(paramString.getElementsByTagName("entry").item(0).getFirstChild().getNodeValue());
            return localObject;
          }
        }
