  ...
  extends bllx
{
  ...
  private static String a(Context paramContext)
  {
    try
    {
      ...
      bdiv.ag(paramContext, BaseApplicationImpl.getApplication().getRuntime().getAccount(), 0);
      return null;
    }
    catch (IOException paramContext)
    {
      wsv.e("CaptureTemplateManager", paramContext.toString());
    }
    return null;
  }
  ...
  public static void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      bdcs.a(jdField_a_of_type_JavaLangString, "template_config.xml", paramString);
      return;
      bool = false;
    }
  }
  ...
  private boolean a(String paramString1, String paramString2)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          paramString1 = bdcs.c(paramString1.getPath());
  ...
  public final blol a()
  {
    return this.jdField_a_of_type_Blol;
  }
  ...
  public void a(blol paramblol, Activity paramActivity, int paramInt)
  {
    if (paramInt == 0)
    {
      if (this.jdField_a_of_type_ArrayOfDovComQqImCapturePartQIMTemplateItem[2] != null) {}
      this.jdField_a_of_type_ArrayOfBlol[2] = paramblol;
      if (this.jdField_a_of_type_ArrayOfBlol[1] != null) {}
      this.jdField_a_of_type_ArrayOfBlol[1] = paramblol;
    }
    while (paramInt == -1)
    {
      return;
    ...
    this.jdField_a_of_type_ArrayOfBlol[paramInt] = paramblol;
  }
  ...
  public void a(QIMTemplateItem paramQIMTemplateItem, Activity paramActivity, int paramInt)
  {
    ...
    {
      localblnl.a(localQIMTemplateItem);
  ...
  public boolean a(Context paramContext)
  {
    ...
    catch (Exception paramContext)
    {
      for (;;)
      {
        wsv.c("CaptureTemplateManager", "initFromCache", paramContext);
        bool1 = bool2;
      }
    }
    wsv.b("CaptureTemplateManager", "initFromCache " + bool1);
    return bool1;
  }
  
  public boolean a(blol paramblol, int paramInt)
  {
    boolean bool2 = false;
    boolean bool3 = false;
    if (paramblol != null)
    {
      blol localblol = this.jdField_a_of_type_ArrayOfBlol[paramInt];
      boolean bool1 = bool3;
      if (localblol != null)
      {
        bool1 = bool3;
        if (paramblol.b().equals(localblol.b())) {
          bool1 = true;
        }
      }
      bool2 = bool1;
      if (QLog.isColorLevel())
      {
        QLog.d("QCombo", 2, "isApplying :" + paramblol);
        bool2 = bool1;
      }
    }
    return bool2;
  ...
  {
    wsv.b("CaptureTemplateManager", "preInitCombo: " + paramList.size());
    blnl localblnl = (blnl)blmf.a(5);
    ...
    if (paramList.hasNext())
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        {
          localblol = localblnl.a(localQIMTemplateItem);
          localblol.a = localblol.a();
          if (localblol.a == 1)
          {
            localblol.b = ((int)(10000.0F * localblol.a()));
            wsv.b("CaptureTemplateManager", "preInitCombo progress: " + localQIMTemplateItem.b + ", progress: " + localblol.b);
            bool = true;
          }
        }
        for (;;)
  ...
  public void d()
  {
    ...
    f();
    if (this.jdField_a_of_type_Blnw != null) {
      this.jdField_a_of_type_Blnw.a(this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
    }
  }
}
