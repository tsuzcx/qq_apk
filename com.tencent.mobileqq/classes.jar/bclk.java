  ...
  implements Manager
{
  ...
  public ArrayList<bcll> a;
  protected Queue<String> a;
  
  static
  {
    jdField_a_of_type_JavaLangString = "<{text:'A',action:'',url:'',url_p:'schemel://xxx',actionData:'action:xxxx',actionData_i:'',actionData_a:''}>" + alpo.a(2131716174) + "<{text:'B',action:'',url:'',url_p:'schemel://xxx',actionData:'action:xxxx',actionData_i:'',actionData_a:''}>" + alpo.a(2131716175) + "<{icon:'/rose',url:'url.qq.com?rose.png',alt:'玫瑰'}>";
    jdField_a_of_type_JavaUtilHashMap = new HashMap();
  }
  
  public bclk(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(GroupOpenSysMsg.SysMsgBody paramSysMsgBody, TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    {
      MessageForArkApp localMessageForArkApp = (MessageForArkApp)ayvw.a(-5008);
      ...
      if (paramSysMsgBody.sender.has())
      {
        ...
        localMessageForArkApp.saveExtInfoToExtStr("troop_msg_nick_color", String.valueOf(BaseApplication.getContext().getResources().getColor(2131166925)));
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    boolean bool = localawbw.a(TroopTipsEntity.class.getSimpleName(), localContentValues, "troopUin=? and msgSeq=?", new String[] { paramString1, paramString2 });
    localawbw.a();
    if (bool)
    {
  ...
  public MessageForGrayTips a(TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    do
    {
      ...
      } while (alsh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForGrayTips, false));
  ...
  public MessageRecord a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, int paramInt, long paramLong, boolean paramBoolean1, boolean paramBoolean2, abok paramabok)
  {
    ...
    do
    {
        ...
        try
        {
          ...
          case 1: 
            if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_redtips.has())
            {
              ...
              {
                a(new bcll(this, ((TroopTipsEntity)localObject2).troopUin, paramArrayOfByte));
                return null;
              }
              ((TroopTipsEntity)localObject2).currentUin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
              paramQQAppInterface = (MessageForQQWalletTips)ayvw.a(-2029);
              ...
              paramQQAppInterface.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), ((TroopTipsEntity)localObject2).troopUin, "", "[QQWallet Tips]", ayvc.a(), -2029, 1, ayvc.a());
            ...
            if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_graytips.uint32_robot_group_opt.has())
            {
              ...
              paramArrayOfByte = (bckx)paramQQAppInterface.getManager(203);
            }
            ...
            if (j == 3)
            {
              bcgk.a(paramQQAppInterface, (TroopTipsEntity)localObject2);
              return null;
            }
            if ((j == 6) && (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_graytips.uint64_receiver_uin.has()))
            {
              ...
              {
                bbpo.a().a(String.valueOf(l1), paramQQAppInterface.getCurrentAccountUin(), true);
                ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(l1, paramLong);
              }
            }
            for (;;)
            {
              ...
              if ((paramBoolean1) || (!alsh.a(paramQQAppInterface, paramArrayOfByte, false))) {
                break label1231;
              }
              return null;
              if (j != 11) {
      ...
      bclo.a(l1, paramQQAppInterface, paramLong);
      return null;
    ...
    if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_group_notify.has())
    {
      ...
      paramArrayOfByte = ((aubr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37)).a(Long.valueOf(l1), true);
      if ((paramArrayOfByte != null) && (1 == paramQQAppInterface.opt_uint32_auto_pull_flag.get()))
      {
        ...
        ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).notifyUI(67, true, new Object[] { String.valueOf(l1), paramQQAppInterface.opt_bytes_feeds_id.get().toStringUtf8(), Integer.valueOf(paramQQAppInterface.opt_uint32_auto_pull_flag.get()) });
        break label3393;
        if (!paramBoolean2)
        {
          if (paramabok != null) {
          ...
          {
            paramabok = (TroopTips0x857.MessageRecallReminder)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_recall.get();
            paramLong = paramabok.uint64_uin.get();
            paramInt = paramabok.uint32_op_type.get();
            paramQQAppInterface = new HashMap();
            try
            {
              paramArrayOfByte = new msgrevoke_userdef.MsgInfoUserDef();
              paramArrayOfByte.mergeFrom(paramabok.bytes_userdef.get().toByteArray());
            ...
            paramabok = ((ArrayList)paramabok.uint32_recalled_msg_list.get()).iterator();
            while (paramabok.hasNext())
            {
              localObject2 = (TroopTips0x857.MessageRecallReminder.MessageMeta)paramabok.next();
            ...
            {
              paramabok = (TroopTips0x857.NotifyObjmsgUpdate)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_objmsg_update.get();
              if (paramabok.bytes_ext_msg.has())
              {
                paramArrayOfByte = new SubMsgType0xaa.MsgBody();
                try
                {
                  paramArrayOfByte.mergeFrom(paramabok.bytes_ext_msg.get().toByteArray());
                  ((askw)paramQQAppInterface.getManager(156)).a(paramArrayOfByte, false);
                }
                catch (Exception paramabok)
                {
                  for (;;)
                  {
                    if (QLog.isColorLevel()) {
                ...
                if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_werewolf_push.has())
                {
                  ...
                  ((behr)paramQQAppInterface.a(107)).a((TroopTips0x857.WereWolfPush)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_werewolf_push.get(), paramArrayOfByte);
                  break label3393;
                  if (QLog.isColorLevel()) {
                  ...
                  if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_stcm_game_state.has())
                  {
                    ...
                    {
                      ((akje)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211)).a(0, 1, Long.toString(l1), paramQQAppInterface);
                      break label3393;
                      if (QLog.isColorLevel()) {
                      ...
                      if (((TroopTips0x857.NotifyMsgBody)localObject1).apllo_msg_push.has())
                      {
                        ...
                        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
                        {
                          ((akkd)paramQQAppInterface.getManager(227)).a(1, paramArrayOfByte);
                          break label3393;
                          if (QLog.isColorLevel()) {
                          ...
                          if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_goldtips.has())
                          {
                            ...
                            {
                              aivh.a(1, (TroopTips0x857.GoldMsgTipsElem)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_goldtips.get(), null);
                              break label3393;
                              if (QLog.isColorLevel()) {
                              ...
                              if (paramBoolean1)
                              {
                                ...
                                {
                                  ((alzf)paramQQAppInterface.a(20)).a(String.valueOf(l1), false, "", false, true, false, true);
                                  break label3393;
                                  if (QLog.isColorLevel()) {
                                  ...
                                  {
                                    badt.a(paramQQAppInterface, (TroopTips0x857.TroopFormGrayTipsInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_troopformtips_push.get(), ((TroopTipsEntity)localObject2).troopUin);
                                    break label3393;
                                    if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_media_push.has())
                                    {
                                      atig.a(paramQQAppInterface, paramInt, paramLong, (TroopTips0x857.MediaChangePushInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_msg_media_push.get());
                                    }
                                    else
                                    {
                                      ...
                                      if (paramBoolean1)
                                      {
                                        try
                                        {
                                          paramabok = (TroopTips0x857.GeneralGrayTipInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_general_gray_tip.get();
                                          if (paramabok.uint64_busi_type.has())
                                          {
                                            l1 = paramabok.uint64_busi_type.get();
                                            if (!paramabok.uint64_busi_id.has()) {
                                              break label2838;
                                            }
                                            l2 = paramabok.uint64_busi_id.get();
                                            if (!paramabok.uint32_ctrl_flag.has()) {
                                              break label2844;
                                            }
                                            paramInt = paramabok.uint32_ctrl_flag.get();
                                            if (paramabok.uint32_c2c_type.has()) {
                                              paramabok.uint32_c2c_type.get();
                                            }
                                            if (paramabok.uint32_service_type.has()) {
                                              paramabok.uint32_service_type.get();
                                            }
                                            if (!paramabok.bytes_pb_reserv.has()) {
                                              break label2849;
                                            }
                                            paramArrayOfByte = paramabok.bytes_pb_reserv.get().toByteArray();
                                            if (!paramabok.bytes_content.has()) {
                                              break label2854;
                                            }
                                            paramabok = paramabok.bytes_content.get().toByteArray();
                                            localObject1 = "";
                                            if ((paramabok == null) || (paramabok.length <= 0)) {
                                              break label2860;
                                            }
                                            paramabok = new String(paramabok, "utf-8");
                                            paramInt = aslq.a(paramInt);
                                            paramArrayOfByte = aslq.a(paramQQAppInterface, ((TroopTipsEntity)localObject2).troopUin, 1, paramInt, paramLong, paramabok, l1, l2, paramArrayOfByte);
                                            if (paramArrayOfByte == null) {
                                              break label3393;
                                            }
                                            ...
                                            paramArrayOfByte.saveExtInfoToExtStr("bytes_content", paramabok);
                                            azmj.b(paramQQAppInterface, "CliOper", "", "", "0X800A560", "0X800A560", 3, 0, "" + l2, "" + l1, "", "");
                                            aslq.a(paramQQAppInterface, paramArrayOfByte);
                                          }
                                        }
                                      ...
                                      else
                                      {
                                        ...
                                        {
                                          paramArrayOfByte = ((baky)paramQQAppInterface.getManager(339)).a(2);
                                          if (paramArrayOfByte != null) {
                                        ...
                                        else
                                        {
                                          ...
                                          {
                                            paramArrayOfByte = ((baky)paramQQAppInterface.getManager(339)).a(4);
                                            if (paramArrayOfByte != null) {
                                          ...
                                          else
                                          {
                                            ...
                                            if ((paramQQAppInterface != null) && (paramQQAppInterface.uint32_group_honor_switch.has()))
                                            {
                                              ...
                                              paramQQAppInterface = (bcbt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(346);
                                              if (paramInt != 0) {
                                                break label3397;
                                              }
                                              paramBoolean1 = true;
                                              ...
                                              break label3393;
                                              atmb.a(paramQQAppInterface, paramInt, paramLong, (TroopTips0x857.NotifyMsgBody)localObject1);
                                              break label3393;
                                              if (((TroopTips0x857.NotifyMsgBody)localObject1).opt_group_announce_tbc_info.has())
                                              {
                                                paramabok = (TroopTips0x857.GroupAnnounceTBCInfo)((TroopTips0x857.NotifyMsgBody)localObject1).opt_group_announce_tbc_info.get();
                                                if (paramabok != null) {
                                                  if (!paramabok.feeds_id.has()) {
                                                    break label3406;
                                                  }
                                                }
                                              }
    ...
    label3397:
    label3406:
    for (paramArrayOfByte = paramabok.feeds_id.get().toStringUtf8();; paramArrayOfByte = null)
    {
      paramLong = paramabok.group_id.get();
      paramInt = paramabok.action.get();
      switch (paramInt)
      {
      case 0: 
        bckr.b(paramQQAppInterface, paramArrayOfByte, String.valueOf(paramLong), 1);
        break;
      case 1: 
      case 2: 
  ...
  public List<TroopTipsEntity> a(String paramString)
  {
    ...
    do
    {
      ...
      paramString = ((awbw)localObject).a(TroopTipsEntity.class, true, "troopUin=? and read=? and currentUin=?", new String[] { paramString, "0", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() }, null, null, "time ASC", null);
      ((awbw)localObject).a();
  ...
  public void a(bcll parambcll)
  {
    if (QLog.isColorLevel()) {
      QLog.d("TroopTipsMsgMgr", 2, "addWalletTipsCache");
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(parambcll);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      bcll localbcll = (bcll)localIterator.next();
      TroopTips0x857.RedGrayTipsInfo localRedGrayTipsInfo = localbcll.jdField_a_of_type_TencentImOidbCmd0x857TroopTips0x857$RedGrayTipsInfo;
      String str = paramQQAppInterface.getCurrentAccountUin();
      MessageForQQWalletTips localMessageForQQWalletTips = (MessageForQQWalletTips)ayvw.a(-2029);
      ...
      localMessageForQQWalletTips.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), localbcll.jdField_a_of_type_JavaLangString, "", "[QQWallet Tips]", ayvc.a(), -2029, 1, ayvc.a());
  ...
  public void a(QQAppInterface paramQQAppInterface, TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    localawbw.a(paramTroopTipsEntity);
    localawbw.a();
  }
  ...
  public void b(QQAppInterface paramQQAppInterface)
  {
    ...
    awbw localawbw = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    Cursor localCursor = localawbw.a(true, TroopTipsEntity.class.getSimpleName(), new String[] { "troopUin" }, "read=?", new String[] { String.valueOf(0) }, "troopUin", null, null, null);
    if (localCursor != null) {}
    for (;;)
    {
      try
