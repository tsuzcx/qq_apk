...
public class arre
{
  ...
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new arrf(this);
  ...
  private arrc jdField_a_of_type_Arrc;
  ...
  public arre(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Arrc = ((arrc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(259));
  }
  ...
  private String b(String paramString)
  {
    if ((paramString != null) && (!"".equals(paramString)))
    {
      ...
      return anhk.bl + aopp.a(str) + paramString + ".jpg";
    }
    return "";
  }
  ...
  public int a()
  {
    return (this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().widthPixels - bclx.a(11.0F) * 2 - bclx.a(2.0F) * 2) / 3;
  }
  ...
  public int a(URLDrawable paramURLDrawable)
  {
        ...
        if (bdsh.b(str))
        {
          ...
          if (str != null)
          {
            ...
            if (!"".equals(str))
            {
              ...
              str = anhk.bl + aopp.a((String)localObject) + str + ".jpg";
            }
          }
        }
      }
    ...
    try
    {
      ...
      i = ahth.a(this.jdField_a_of_type_AndroidContentContext, str);
      return i;
    }
  ...
  public Drawable a(Drawable paramDrawable, int paramInt)
  {
    ...
    for (Object localObject = Bitmap.Config.ARGB_8888;; localObject = Bitmap.Config.RGB_565)
    {
      ...
      return new BitmapDrawable(bgmo.a((Bitmap)localObject, ((Bitmap)localObject).getWidth(), ((Bitmap)localObject).getHeight()));
    }
  }
  ...
  public EmoticonFromGroupEntity a(MessageRecord paramMessageRecord)
  {
    ...
    if ((localMessageForPic.imageType == 3) || (localMessageForPic.imageType == 2000))
    {
      ...
      paramMessageRecord = bdzx.a(localMessageForPic, 65537);
      ...
      paramMessageRecord = bdzx.a(localMessageForPic, 1);
      if (paramMessageRecord != null) {
        break label162;
      }
    }
    ...
    if (l >= paramLong)
    {
      ...
      if (7 > i)
      {
        ...
        default: 
          return null;
        case 0: 
          return anni.a(2131702848);
        case 1: 
          return anni.a(2131702872);
        case 2: 
          return anni.a(2131702835);
        case 3: 
          return anni.a(2131702849);
        case 4: 
          return anni.a(2131702831);
        case 5: 
          return anni.a(2131702855);
        }
        return anni.a(2131702863);
      }
  ...
  {
    if ((paramString != null) && (!paramString.isEmpty()) && (bdsh.b(paramString)))
    {
      paramString = bdsh.a(paramString);
      if (paramString != null) {
  ...
  {
    return this.jdField_a_of_type_Arrc.c();
  }
  ...
  public Map<String, List<EmoticonFromGroupEntity>> a(List<EmoticonFromGroupEntity> paramList)
  {
    ...
    if (paramList != null)
    {
      ...
      {
        localObject = new TreeMap(new arrg(this));
  ...
  public void a()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("EmoticonFromGroup_Manager", 2, "init mEmoManager.mCountOfSpare:" + this.jdField_a_of_type_Arrc.b);
    }
  }
  ...
  public void a(Context paramContext, MessageForPic paramMessageForPic, View paramView)
  {
    ...
    bley.a(paramContext, localBundle, new AIOImageProviderService(paramMessageForPic.selfuin, null, -1, paramMessageForPic), ahth.a(paramMessageForPic), -1, -1);
  }
  
  public void a(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    this.jdField_a_of_type_Arrc.a(paramEmoticonFromGroupEntity, 2);
  }
  
  public void a(MessageRecord paramMessageRecord)
  {
    if (a(paramMessageRecord)) {
      this.jdField_a_of_type_Arrc.b(paramMessageRecord);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    for (paramString = (String)localObject;; paramString = null)
    {
      if (paramString != null)
      {
        ...
        {
          if ((annq.a(paramString.msg)) || (anlk.a(paramString.msg))) {
            atvf.a(2131692317);
          }
        }
        else
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramString.msg, new arrk(localMqqHandler));
  ...
  public void a(List<MessageRecord> paramList)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Arrc.a() >= 600) || (this.jdField_a_of_type_Arrc.b() >= 300))
      {
        if (QLog.isColorLevel()) {
      ...
      else
      {
        ...
        while (paramList.hasNext())
        {
          ...
          if ((this.jdField_a_of_type_JavaUtilList.contains(localInteger)) && (!anlk.a(localMessageRecord)) && (!axbp.a(localMessageRecord)))
          {
            if (QLog.isColorLevel()) {
              QLog.i("EmoticonFromGroup_Manager", 2, "filterMessageByType type: " + localInteger);
            }
            this.jdField_a_of_type_Arrc.a(localMessageRecord);
          }
        }
      }
    }
  ...
  public boolean a(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    ...
    if (this.jdField_a_of_type_Arrc.b < 1)
    {
      if (300 == arrm.a) {
        QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2131689608, 0).b(2131298998);
      }
      do
      {
        do
        {
          ...
          paramEmoticonFromGroupEntity = new arrh(this, (BaseActivity)localObject);
        } while (localObject == null);
        paramEmoticonFromGroupEntity = bglp.a((Context)localObject, 0, anni.a(2131702852), ((BaseActivity)localObject).getString(2131689607), anni.a(2131702850), anni.a(2131702874), paramEmoticonFromGroupEntity, paramEmoticonFromGroupEntity);
      } while (paramEmoticonFromGroupEntity == null);
      paramEmoticonFromGroupEntity.show();
      return false;
    }
    localObject = this.jdField_a_of_type_Arrc;
    ((arrc)localObject).b -= 1;
    c(paramEmoticonFromGroupEntity);
    QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2, 2131691730, 0).b(2131298998);
    return true;
  }
  ...
  {
    return this.jdField_a_of_type_Arrc.b();
  }
  
  public void b(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    this.jdField_a_of_type_Arrc.a(paramEmoticonFromGroupEntity);
  }
  ...
  {
    this.jdField_a_of_type_Arrc.a(paramList, 2);
  }
  ...
  public void c(EmoticonFromGroupEntity paramEmoticonFromGroupEntity)
  {
    ...
    {
      this.jdField_a_of_type_Arrc.jdField_a_of_type_JavaUtilList.add(localURLDrawable);
      localURLDrawable.setURLDrawableListener(new arrj(this, localURLDrawable));
    ...
    for (;;)
    {
      ...
      return;
      this.jdField_a_of_type_Arrc.jdField_a_of_type_JavaUtilList.remove(localURLDrawable);
  ...
  {
    this.jdField_a_of_type_Arrc.a(paramList);
  }
