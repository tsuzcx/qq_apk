  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Xkb.a(this.jdField_a_of_type_Int);
      paramIntent = aurl.b(arrayOfByte);
      ...
      try
      {
        ...
        this.jdField_a_of_type_Xkb.a(this.jdField_a_of_type_JavaLangString, new String[] { paramContext });
        return;
        label286:
        paramContext = paramContext.toString();
      }
