  ...
  extends bbbg
{
  ...
  private WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new bbbi(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bbbh.class.getSimpleName();
  }
  
  public bbbh(RegisterNewBaseActivity paramRegisterNewBaseActivity)
  {
  ...
  public void a(String paramString)
  {
    try
    {
      ...
      if (azoz.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.app, this.c.getBytes(), paramString.getBytes(), this.d, this.jdField_a_of_type_MqqObserverWtloginObserver) != 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.c();
        this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131715879, 1);
      }
      return;
    }
