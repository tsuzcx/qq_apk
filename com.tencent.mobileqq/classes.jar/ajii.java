...
public class ajii
  implements aive, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, Handler.Callback, View.OnClickListener, TouchWebView.OnScrollChangedListener
{
  public float a;
  int jdField_a_of_type_Int = 1;
  private aivc jdField_a_of_type_Aivc;
  ...
  public ajii(RelativeLayout paramRelativeLayout, ajir paramajir)
  {
    ...
    paramajir = new RelativeLayout.LayoutParams(100, 100);
    this.jdField_a_of_type_Aivc = new ajij(this);
    this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRender().setRenderCallback(this.jdField_a_of_type_Aivc);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout.addView(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView, paramajir);
    this.jdField_e_of_type_Float = (ajwe.a() / 16.0F);
    if (this.jdField_e_of_type_Float != 0.0F) {
      this.jdField_d_of_type_Float = (bbct.a() / this.jdField_e_of_type_Float);
    }
    if (this.jdField_d_of_type_Float == 0.0F) {
      this.jdField_d_of_type_Float = bbct.a();
    }
    ...
    this.jdField_a_of_type_Ajin = new ajin();
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = new RelativeLayout(paramRelativeLayout);
    paramajir = new ImageView(paramRelativeLayout);
    paramajir.setImageResource(2130839140);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.addRule(13, -1);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.addView(paramajir, localLayoutParams);
  ...
  private String b(int paramInt, boolean paramBoolean, ApolloWebAvatarParam paramApolloWebAvatarParam)
  {
    ...
    if (!ajkk.a(paramApolloWebAvatarParam.uin, paramApolloWebAvatarParam.roleId, paramApolloWebAvatarParam.dressIds, null))
    {
      bcpw.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), ajyc.a(2131700566), 0).a();
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
      {
        ...
        if ((paramApolloWebAvatarParam.tapRectWidth > 0) && (paramApolloWebAvatarParam.tapRectHeight > 0))
        {
          ...
          this.jdField_a_of_type_Bfnk.sendEmptyMessageDelayed(23, 500L);
          ...
          ((RelativeLayout.LayoutParams)???).topMargin = ((int)(paramApolloWebAvatarParam.y * this.jdField_d_of_type_Float - (float)bbct.j() * this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.rate));
          ((RelativeLayout.LayoutParams)???).rightMargin = ((int)((float)bbct.i() - this.jdField_d_of_type_Float * paramApolloWebAvatarParam.x - ((RelativeLayout.LayoutParams)???).width - ApolloUtil.a(68.0F, this.jdField_d_of_type_Float) * this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.rate / 0.289F));
          ...
          this.jdField_a_of_type_Bfnk.sendMessage(paramApolloWebAvatarParam);
  ...
  private void e()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) {
          if (this.jdField_i_of_type_Int == 0) {
            ...
            for (;;)
            {
              if (!new File(ajhw.b(this.jdField_i_of_type_Int)).exists()) {
                break label395;
              }
              this.jdField_a_of_type_Bfnk.sendEmptyMessageDelayed(24, (int)(this.jdField_f_of_type_Float * 1000.0F));
              return;
              k = 0;
              break;
              m = 0;
      ...
      if ((!TextUtils.isEmpty(ajkl.a().jdField_a_of_type_JavaLangString)) && ("interactive".equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.tab)))
      {
        this.jdField_a_of_type_Bfnk.sendEmptyMessageDelayed(24, 0L);
        return;
      }
    ...
    for (int m = 1;; m = 0)
    {
      ...
      if ((!ajhw.a(this.jdField_c_of_type_Int)) || (m != 0) || (k != 0) || (n == 0)) {
        break;
      }
      try
      {
        bbbr.a(BaseApplicationImpl.getContext(), true);
        this.jdField_a_of_type_AndroidMediaMediaPlayer.reset();
        this.jdField_a_of_type_AndroidMediaMediaPlayer.setDataSource(ajmu.jdField_d_of_type_JavaLangString + this.jdField_c_of_type_Int + "/" + "music.amr");
  ...
  private void f()
  {
    try
    {
      ...
      {
        bbbr.a(BaseApplicationImpl.getContext(), false);
        this.jdField_a_of_type_AndroidMediaMediaPlayer.stop();
      }
      if (this.jdField_a_of_type_Bfnk != null) {
        this.jdField_a_of_type_Bfnk.removeMessages(24);
      }
      return;
    }
  ...
  public String a()
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null))
    {
      ...
      String[] arrayOfString = ajkk.a(10, -1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
      if ((arrayOfString.length > 0) && (!TextUtils.isEmpty(arrayOfString[0])) && (arrayOfString[0].length() - "action".length() > 0)) {}
      ajkl.a().jdField_a_of_type_JavaLangString = arrayOfString[0].substring(0, arrayOfString[0].length() - "action".length());
    ...
    this.jdField_a_of_type_Bfnk.sendEmptyMessageDelayed(22, 100L);
    return a(ajyc.a(2131700554));
  }
  ...
  public String a(int paramInt, boolean paramBoolean, ApolloWebAvatarParam paramApolloWebAvatarParam)
  {
    ...
    if (!ajkk.a(paramApolloWebAvatarParam.uin, paramApolloWebAvatarParam.roleId, paramApolloWebAvatarParam.dressIds, null))
    {
      bcpw.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), ajyc.a(2131700553), 0).a();
      return a("dresses is not download!");
    }
    if ((!TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString)) && (!this.jdField_e_of_type_JavaLangString.equals(paramApolloWebAvatarParam.tab)))
    {
      ...
      this.jdField_a_of_type_Bfnk.postDelayed(new ApolloViewController.2(this, paramInt, paramBoolean, paramApolloWebAvatarParam), 100L);
    }
    for (;;)
    {
      return b("initAvatar成功");
  ...
  public String a(ajim paramajim)
  {
    if (this.j)
    {
      ...
      return a(ajyc.a(2131700559));
    }
    if (paramajim == null) {
      return a("actionData is null");
    }
    if (paramajim.jdField_a_of_type_Int > 1) {}
    for (this.jdField_a_of_type_Ajim = paramajim; (paramajim.jdField_c_of_type_Int == 1) && (!TextUtils.isEmpty(paramajim.jdField_b_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (!paramajim.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId)); this.jdField_a_of_type_Ajim = null) {
      return a(ajyc.a(2131700564));
    }
    if ((TextUtils.isEmpty(paramajim.jdField_b_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)) {
      paramajim.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId;
    }
    if (TextUtils.isEmpty(paramajim.jdField_b_of_type_JavaLangString)) {
      return a("未传apolloId");
    }
    if (!this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramajim.jdField_b_of_type_JavaLangString)) {
      return a(ajyc.a(2131700562));
    }
    Object localObject1 = (ApolloWebAvatarParam)this.jdField_a_of_type_JavaUtilHashMap.get(paramajim.jdField_b_of_type_JavaLangString);
    if (localObject1 == null) {
      return a(ajyc.a(2131700548));
    }
    int m = 0;
    int k = m;
    if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)
    {
      k = m;
      if (paramajim.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId)) {
        k = 1;
      }
    }
    if ((k != 0) && (!ajkk.a(((ApolloWebAvatarParam)localObject1).uin, ((ApolloWebAvatarParam)localObject1).roleId, ((ApolloWebAvatarParam)localObject1).dressIds, null)))
    {
      bcpw.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), ajyc.a(2131700549), 0).a();
      return a(ajyc.a(2131700560));
    }
    if (!ApolloUtil.a(paramajim.jdField_b_of_type_Int, paramajim.jdField_c_of_type_Int))
    {
      if (k != 0) {
        bcpw.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), ajyc.a(2131700567), 0).a();
      }
      return a(ajyc.a(2131700550));
    }
    ...
    {
      if (k != 0) {
        bcpw.a(BaseApplicationImpl.getContext(), ajyc.a(2131700565), 0).a();
      }
      return a(ajyc.a(2131700555));
    }
    if (k != 0) {
      f();
    }
    this.jdField_i_of_type_Int = paramajim.m;
    this.jdField_f_of_type_Float = paramajim.jdField_a_of_type_Float;
    boolean bool;
    label556:
    label616:
    float f1;
    ...
    if (paramajim.l == 0)
    {
      ...
      this.jdField_h_of_type_Boolean = paramajim.jdField_a_of_type_Boolean;
      if ((this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (paramajim.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId))) {
        this.jdField_c_of_type_Int = paramajim.jdField_b_of_type_Int;
      }
      this.jdField_b_of_type_Boolean = true;
      this.jdField_a_of_type_AndroidWidgetFrameLayout.setVisibility(8);
      this.jdField_a_of_type_Bfnk.removeMessages(16);
      this.jdField_f_of_type_Int = paramajim.jdField_i_of_type_Int;
      this.jdField_d_of_type_JavaLangString = paramajim.jdField_a_of_type_JavaLangString;
      this.jdField_g_of_type_Int = paramajim.k;
      if (paramajim.j != 1) {
        break label1141;
      }
      bool = true;
      this.jdField_f_of_type_Boolean = bool;
      if ((!paramajim.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Ajin != null)) {
        this.jdField_a_of_type_Ajin.a();
      }
      if ((!TextUtils.isEmpty(paramajim.jdField_a_of_type_JavaLangString)) && (!paramajim.jdField_a_of_type_Boolean)) {
        break label1147;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView != null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView.setVisibility(8);
      }
      if (paramajim.jdField_d_of_type_Int != 0) {
        break label1518;
      }
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.setVisibility(0);
      ...
      if (this.jdField_a_of_type_Int != paramajim.jdField_c_of_type_Int)
      {
        ...
        if (paramajim.jdField_c_of_type_Int != 1) {
          break label1218;
        }
        if (ApolloUtil.d(this.jdField_f_of_type_Int))
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(2, null, ajhw.a(this.jdField_f_of_type_Int), null);
      ...
      if (!paramajim.jdField_a_of_type_Boolean) {
        break label1277;
      }
      this.jdField_a_of_type_Ajin.a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView, paramajim.jdField_b_of_type_Int, ((ApolloWebAvatarParam)localObject1).roleId, paramajim.jdField_c_of_type_Int);
      this.jdField_a_of_type_Ajin.a(paramajim.jdField_b_of_type_Float);
      this.jdField_a_of_type_Int = paramajim.jdField_c_of_type_Int;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
      if (TextUtils.isEmpty(paramajim.jdField_a_of_type_JavaLangString)) {
        break label1496;
      }
      if (paramajim.k != 1) {
        break label1453;
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView != null)
      {
        ...
        n = (int)((float)bbct.j() * ((ApolloWebAvatarParam)localObject1).rate * 1.14F);
        ...
        label1086:
        if (!paramajim.jdField_a_of_type_Boolean) {
          aiwc.a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getWidth(), n, this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView, BaseApplicationImpl.getContext(), "", paramajim.jdField_a_of_type_JavaLangString, true);
        }
      }
    }
    for (;;)
    {
      ...
      localObject2 = ajkk.a(13, paramajim.jdField_b_of_type_Int, ((ApolloWebAvatarParam)localObject1).roleId, true);
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(1, ((ApolloWebAvatarParam)localObject1).apolloId, paramajim.jdField_b_of_type_Int, 0, localObject2[0], localObject2[1]);
      if (paramajim.jdField_c_of_type_Int != 1) {
        break label890;
      }
      localObject2 = ajkk.a(13, paramajim.jdField_b_of_type_Int, ((ApolloWebAvatarParam)localObject1).roleId, false);
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(2, null, paramajim.jdField_b_of_type_Int, 0, localObject2[0], localObject2[1]);
      break label890;
      label1384:
      ...
      break label1086;
      label1453:
      ajkl.a().jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(8);
    ...
    if ((!this.jdField_c_of_type_Boolean) || (this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView == null))
    {
      ...
      this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.init(new ajik(this, (DisplayMetrics)localObject1, paramajim));
      if (this.jdField_b_of_type_Aivc == null) {
        this.jdField_b_of_type_Aivc = new ajil(this);
      }
      this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getRender().setRenderCallback(this.jdField_b_of_type_Aivc);
      label1745:
      this.jdField_a_of_type_Int = 1;
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.onExecDispose();
      ...
      localObject1 = ajyc.a(2131700568);
      label1800:
      ...
      label1836:
      if ((paramajim.jdField_h_of_type_Int != 1) && (paramajim.jdField_e_of_type_Int > 0)) {
        break label2016;
      }
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetButton.setTag(Integer.valueOf(paramajim.jdField_b_of_type_Int));
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(Integer.valueOf(paramajim.jdField_b_of_type_Int));
      break;
      this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.onExecDispose();
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.onExecDispose();
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      localObject1 = this.jdField_a_of_type_Bfnk.obtainMessage(19, paramajim.jdField_c_of_type_Int, paramajim.jdField_b_of_type_Int);
      if (paramajim.jdField_a_of_type_Boolean) {
        ((Message)localObject1).obj = Float.valueOf(paramajim.jdField_b_of_type_Float);
      }
      this.jdField_a_of_type_Bfnk.sendMessageDelayed((Message)localObject1, 100L);
      break label1745;
      label1995:
      ...
      ApolloUtil.a(this.jdField_b_of_type_AndroidWidgetImageView, paramajim.jdField_e_of_type_Int);
      if (!bool) {
  ...
  public String a(ArrayList<ApolloWebAvatarParam> paramArrayList)
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if (!ajkk.a(localApolloWebAvatarParam.uin, localApolloWebAvatarParam.roleId, localApolloWebAvatarParam.dressIds, null))
      {
        bcpw.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), ajyc.a(2131700551), 0).a();
        return a("dresses is not download!");
      }
    }
  ...
  public String a(int[] paramArrayOfInt)
  {
    if (this.j)
    {
      ...
      return a(ajyc.a(2131700561));
    }
    if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam == null) {
      return a(ajyc.a(2131700552));
    }
    if (!ajkk.a(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.uin, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, paramArrayOfInt, null))
    {
      bcpw.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), ajyc.a(2131700569), 0).a();
      return a(ajyc.a(2131700558));
    }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      Object localObject1 = new RelativeLayout.LayoutParams(-2, (int)((float)bbct.j() * 0.6F));
      ((RelativeLayout.LayoutParams)localObject1).addRule(13, -1);
      ((RelativeLayout.LayoutParams)localObject1).leftMargin = ApolloUtil.a(25.0F, this.jdField_d_of_type_Float);
      ((RelativeLayout.LayoutParams)localObject1).rightMargin = ApolloUtil.a(25.0F, this.jdField_d_of_type_Float);
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)((View)localObject2).findViewById(2131363792));
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)((View)localObject2).findViewById(2131362646));
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((View)localObject2).findViewById(2131362576));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)((View)localObject2).findViewById(2131362575));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject2).findViewById(2131362573));
      ...
      ((ImageView)localObject1).setId(2131362604);
  ...
  {
    this.jdField_a_of_type_Bfnk.removeMessages(23);
    this.jdField_b_of_type_Int = paramInt;
    if (this.jdField_g_of_type_Boolean)
    {
      this.jdField_a_of_type_Bfnk.removeMessages(16);
      this.jdField_a_of_type_Bfnk.sendEmptyMessageDelayed(16, 3000L);
    }
    label218:
    label250:
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)
      {
        if ("mall".equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.tab)) {
          ...
          {
            this.jdField_a_of_type_JavaLangString = ajyc.a(2131700571);
            if (this.jdField_h_of_type_Int == 1) {
              this.jdField_a_of_type_JavaLangString = ajhw.a(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId);
            }
        ...
        for (;;)
        {
          ...
          {
            this.jdField_a_of_type_JavaLangString = ajyc.a(2131700556);
            break;
          }
  ...
  public void a(aive paramaive)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramaive);
  }
  
  public void a(Activity paramActivity, AppInterface paramAppInterface, String paramString1, String paramString2)
  {
    c(false);
    this.jdField_a_of_type_Bfnk.postDelayed(new ApolloViewController.3(this, paramActivity, paramAppInterface, paramString1, paramString2), 500L);
  }
  ...
  public void c(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = 1;
      this.jdField_a_of_type_Bfnk.obtainMessage(18).sendToTarget();
      return;
      label79:
  ...
  public boolean handleMessage(Message arg1)
  {
    ...
    case 27: 
      do
      {
        do
        {
          do
          {
            for (;;)
            {
              ...
              if ((this.jdField_a_of_type_AndroidMediaAudioManager != null) && (this.jdField_a_of_type_AndroidMediaAudioManager.getRingerMode() == 1))
              {
                ...
                n = 1;
                if ((!new File(ajhw.b(this.jdField_i_of_type_Int)).exists()) || (m != 0) || (k != 0) || (n == 0)) {}
              }
              try
              {
                bbbr.a(BaseApplicationImpl.getContext(), true);
                this.jdField_a_of_type_AndroidMediaMediaPlayer.reset();
                this.jdField_a_of_type_AndroidMediaMediaPlayer.setDataSource(ajhw.b(this.jdField_i_of_type_Int));
                this.jdField_a_of_type_AndroidMediaMediaPlayer.prepare();
                this.jdField_a_of_type_AndroidMediaMediaPlayer.start();
                if (!TextUtils.isEmpty(ajkl.a().jdField_a_of_type_JavaLangString))
                {
                  ??? = ajkl.a().jdField_a_of_type_JavaLangString;
                  if (???.startsWith("def"))
                  {
                    ??? = ajmu.jdField_c_of_type_JavaLangString + "/" + ???;
                    ajkl.a().jdField_a_of_type_JavaLangString = "";
                    ??? = ApolloUtil.a(???, "amr");
                    if (??? == null) {}
                  }
              ...
              catch (Throwable ???)
              {
                try
                {
                  ...
                  ??? = ajmu.jdField_a_of_type_JavaLangString + "/" + ???;
                }
                catch (IOException ???)
                {
                  for (;;)
          ...
          ??? = ajkk.a(4, -1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
        ...
        if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_Int != 0))
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId)))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId, ajhw.a, null);
          }
        }
        for (;;)
        {
          synchronized (this.jdField_a_of_type_JavaUtilHashMap)
          {
            ...
            if ((???.arg1 > 0) && (!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString)) && (this.jdField_f_of_type_Boolean) && (this.jdField_g_of_type_Int == 0))
            {
              ...
              if (this.jdField_a_of_type_Ajir != null) {
                this.jdField_a_of_type_Ajir.a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView);
              }
              a(false);
              ...
              this.jdField_a_of_type_Bfnk.sendEmptyMessageDelayed(21, 100L);
              return false;
              if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)
              {
              ...
              for (;;)
              {
                synchronized (this.jdField_a_of_type_JavaUtilHashMap)
                {
                  for (;;)
                  {
                    ...
                    {
                      ???.a(1, localApolloWebAvatarParam.apolloId, ajhw.a, null);
                      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
                      {
      ...
      if (!TextUtils.isEmpty((CharSequence)???))
      {
        if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)) {
          synchronized (this.jdField_a_of_type_JavaUtilHashMap)
          {
            if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(???))
            {
              ...
              if (localApolloWebAvatarParam != null)
              {
                ...
                if (??? != null)
                {
                  ...
                  ((aitm)???).a(1, localApolloWebAvatarParam.apolloId, localApolloWebAvatarParam.roleId, ApolloUtil.a(localApolloWebAvatarParam.rate), localApolloWebAvatarParam.x, this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getHeight() / this.jdField_d_of_type_Float - localApolloWebAvatarParam.y);
                  if (localApolloWebAvatarParam.roleId != 0) {
                    break label1995;
                  }
                  ((aitm)???).a(1, localApolloWebAvatarParam.apolloId, ajhw.a, null);
                }
              }
            }
            ...
            ((aitm)???).a(1, localApolloWebAvatarParam.apolloId, localApolloWebAvatarParam.dressIds, null);
          }
        }
    ...
    case 19: 
      ...
      {
        f2 = 77.0F;
        f4 = (float)(Math.max(bbct.h(), bbct.g()) / 7L) / 368.0F;
        ??? = ???.obj;
    ...
    for (int k = 1;; k = 0)
    {
      ...
      {
        f1 = 330.0F * f4 / bbct.jdField_a_of_type_Float / 2.0F;
        ...
        this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(2, null, ajhw.a(this.jdField_f_of_type_Int), null);
        ??? = ajkk.a(13, n, this.jdField_f_of_type_Int, false);
        if (k != 0)
        {
          this.jdField_a_of_type_Ajin.a(this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView, n, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, m);
          this.jdField_a_of_type_Ajin.a(f3);
        }
      }
      for (;;)
      {
        ...
        ??? = ajkk.a(13, n, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
          ...
          if (!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString))
          {
            if (this.jdField_g_of_type_Int == 1)
            {
              ...
              if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != ???)
              {
                ...
                ???.bottomMargin = (actn.a(f2, this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext().getResources()) + (this.jdField_a_of_type_AndroidWidgetRelativeLayout.getHeight() - this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getHeight()) / 2);
              ...
              aiwc.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getWidth(), k, this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView, BaseApplicationImpl.getContext(), "", this.jdField_d_of_type_JavaLangString, true);
              return true;
              f2 = 42.0F;
              break;
            ...
            ajkl.a().jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(0);
        ...
        this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId, "Bubble");
        return true;
        if ((this.jdField_a_of_type_Ajim == null) || (this.jdField_a_of_type_Ajim.jdField_a_of_type_Int <= 0)) {
          break;
        }
        ??? = this.jdField_a_of_type_Ajim;
        ???.jdField_a_of_type_Int -= 1;
        a(this.jdField_a_of_type_Ajim);
        return false;
        label2851:
        return true;
        f1 = 0.0F;
  ...
  {
    if (paramView.getId() == 2131362604)
    {
      this.jdField_a_of_type_Bfnk.sendEmptyMessage(15);
      f();
    }
    ...
    f();
    if ((this.jdField_a_of_type_Ajir != null) && ((paramView.getTag() instanceof Integer))) {
      this.jdField_a_of_type_Ajir.a(((Integer)paramView.getTag()).intValue());
    }
    this.jdField_a_of_type_Bfnk.sendEmptyMessage(15);
  }
  ...
  public void onNotifyLongTouch(String paramString)
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((aive)this.jdField_a_of_type_JavaLangRefWeakReference.get()).onNotifyLongTouch(paramString);
    }
  }
  ...
  public void onNotifyStatusChanged(int paramInt, String paramString)
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((aive)this.jdField_a_of_type_JavaLangRefWeakReference.get()).onNotifyStatusChanged(paramInt, paramString);
    }
  }
  ...
  public void onSurfaceReady(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Bfnk.sendEmptyMessage(18);
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((aive)this.jdField_a_of_type_JavaLangRefWeakReference.get()).onSurfaceReady(paramInt1, paramInt2);
    }
  }
}
