  ...
  extends WebViewPlugin
{
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Mxn == null) {
      this.jdField_a_of_type_Mxn = new mxn(this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView, new xnf(this));
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getLayoutInflater().inflate(2131558928, null));
        this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131377522));
        this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131377516));
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_AndroidWidgetImageView != null) {
          this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new xng(this));
        }
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Mxn != null)
        {
          ...
          this.jdField_a_of_type_Mxn = null;
        }
