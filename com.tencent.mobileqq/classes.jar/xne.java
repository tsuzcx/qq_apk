...
public class xne
{
  ...
  public xne(@NonNull String paramString1, @NonNull String paramString2)
  {
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.b = paramString2;
  }
  
  public static xne a(String paramString1, String paramString2, @NonNull ErrorMessage paramErrorMessage)
  {
    ...
    for (;;)
    {
      paramString1 = new xne(paramString1, paramString2);
  ...
  public static xne a(String paramString1, String paramString2, String paramString3)
  {
    if (paramString1 != null) {
      if (paramString2 == null) {
        break label31;
  ...
  {
    return ((wpj)wpm.a(5)).b(this.jdField_a_of_type_JavaLangString);
  }
  ...
  public VideoListFeedItem a()
  {
    ...
    FeedItem localFeedItem = ((yij)wpm.a(11)).a(this.b, true);
  ...
  public String toString()
  {
    ...
    for (;;)
    {
      ...
      i = this.jdField_a_of_type_Wrs.a;
      break;
      label89:
      if (b()) {
