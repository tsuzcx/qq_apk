  ...
  extends slz
{
  ...
  public tab()
  {
    this.jdField_c_of_type_JavaLangString = skt.a("StoryGroupSvc.datacard_get_feeds_new");
  ...
  public slu a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new tbr(this.a, localRspGroupDateVideoList);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      urk.b("Q.qqstory.shareGroup:GetShareGroupDateListRequest", a(), paramArrayOfByte);
    }
    return null;
  }
