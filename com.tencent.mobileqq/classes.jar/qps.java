...
public final class qps
{
  ...
  static
  {
    jdField_a_of_type_Qpt = new qpt(null);
  }
  ...
  private final qpy a(int paramInt, Activity paramActivity, String paramString1, String paramString2, boolean paramBoolean1, boolean paramBoolean2, Function3<? super Boolean, ? super Boolean, ? super Integer, Unit> paramFunction3)
  {
    boolean bool2 = false;
    int j = 1;
    int i;
    ...
    {
      i = bggq.a((Context)paramActivity, 72.0F);
      bool1 = bool2;
    ...
    {
      return new qpy(paramInt, paramBoolean1, paramString1, paramString2, i, bool1, paramFunction3);
      i = bggq.a((Context)paramActivity, 16.0F);
      break;
    }
  }
  ...
  private final void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    {
      oat.a(localQQAppInterface, "", "0X800AFFC", "0X800AFFC", 0, 0, str, paramString, String.valueOf(paramInt2), "", false);
      return;
    }
  }
  ...
  private final void a(int paramInt1, String paramString, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    if (paramInt2 == 1)
    {
      paramInt3 = 1;
      localphi = new phi();
      localphi.a("click_type", Integer.valueOf(paramInt3));
      if (!paramBoolean) {
        break label113;
      }
      paramInt3 = 1;
      localphi.a("is_ticked", Integer.valueOf(paramInt3));
    ...
    for (String str = "2";; str = "1")
    {
      oat.a(localQQAppInterface, "", "0X800AFFE", "0X800AFFE", 0, 0, str, paramString, String.valueOf(paramInt2), localphi.a(), false);
      return;
      if (paramInt3 == 1)
      {
        paramInt3 = 0;
  ...
  private final void a(boolean paramBoolean1, boolean paramBoolean2, Activity paramActivity)
  {
    ...
    if (paramBoolean1) {
      localStringBuilder.append(pha.g(2131717098));
    }
    for (;;)
    {
      if (paramBoolean2) {
        localStringBuilder.append(pha.g(2131716961));
      }
      QQToast.a((Context)paramActivity, 2, (CharSequence)localStringBuilder, 0).a();
      return;
      localStringBuilder.append(pha.g(2131716897));
    }
  }
  ...
  private final void b(int paramInt1, String paramString, int paramInt2)
  {
    ...
    for (String str = "2";; str = "1")
    {
      oat.a(localQQAppInterface, "", "0X800AFFD", "0X800AFFD", 0, 0, str, paramString, String.valueOf(paramInt2), "", false);
      return;
    }
  }
  ...
  public final void a(int paramInt1, @NotNull String paramString1, @NotNull String paramString2, int paramInt2)
  {
    ...
    {
      paramString1 = a(paramInt1, (Activity)localBaseActivity, paramString1, paramString2, bool1, bool2, (Function3)new RIJPushNotifyManager.showPushNotifyDialog.param.1(this, localBaseActivity, paramString2, paramInt2, paramInt1));
      pmk.a().b(false, "MATCH_ALL_UIN");
      new qqa((ViewGroup)localObject, paramString1).a(true);
  ...
  public final void a(int paramInt1, boolean paramBoolean1, boolean paramBoolean2, @NotNull String paramString1, int paramInt2, @NotNull String paramString2, @NotNull qpu paramqpu)
  {
    Intrinsics.checkParameterIsNotNull(paramString1, "avatarUrl");
    Intrinsics.checkParameterIsNotNull(paramString2, "uniqueId");
    Intrinsics.checkParameterIsNotNull(paramqpu, "callback");
    ...
    for (Object localObject = ((Window)localObject).getDecorView();; localObject = null)
    {
      if ((localObject instanceof ViewGroup))
      {
        paramString1 = a(paramInt1, (Activity)localBaseActivity, paramString1, paramString2, paramBoolean1, paramBoolean2, (Function3)new RIJPushNotifyManager.showPushNotifyDialogForWeb.param.1(this, localBaseActivity, paramString2, paramInt2, paramqpu, paramInt1));
        pmk.a().b(false, "MATCH_ALL_UIN");
        new qqa((ViewGroup)localObject, paramString1).a(true);
        a(paramInt2, paramString2, paramInt1);
      }
  ...
  public final void a(boolean paramBoolean, @NotNull String paramString)
  {
    ...
    pmk.a().b(paramBoolean, paramString);
  }
