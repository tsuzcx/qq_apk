...
public class ahgn
{
  ...
  private final acjg jdField_a_of_type_Acjg = new ahgo(this);
  private final ahkt jdField_a_of_type_Ahkt = new ahgp(this);
  ...
  private ahgn(Activity paramActivity, FixedSizeVideoView paramFixedSizeVideoView, ImageButton paramImageButton, QzoneVerticalVideoTopicInfo paramQzoneVerticalVideoTopicInfo)
  {
  ...
  public static ahgn a(Activity paramActivity, FixedSizeVideoView paramFixedSizeVideoView, QzoneVerticalVideoTopicInfo paramQzoneVerticalVideoTopicInfo, ImageButton paramImageButton)
  {
    return new ahgn(paramActivity, paramFixedSizeVideoView, paramImageButton, paramQzoneVerticalVideoTopicInfo);
  }
  ...
  private ver a()
  {
    ...
    {
      ver localver = new ver();
      localver.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo.c();
      localver.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo.d();
      localver.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_CooperationQzoneVideoQzoneVerticalVideoTopicInfo.b();
      localver.jdField_b_of_type_Int = 3;
      return localver;
    }
    return null;
  }
  ...
  private boolean c()
  {
    return (this.jdField_a_of_type_Ver != null) && (a() - this.jdField_a_of_type_Ver.f > 0L);
  }
  ...
  private void f()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioAudioPlayer == null)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioAudioPlayer = new AudioPlayer(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Acjg);
    ...
    if (this.jdField_a_of_type_Ver != null)
    {
      ...
      str = this.jdField_a_of_type_Ver.g;
      if (this.jdField_a_of_type_Int == 0) {
        break label108;
      }
    }
    label108:
    for (int i = this.jdField_a_of_type_Int;; i = this.jdField_a_of_type_Ver.jdField_d_of_type_Int)
    {
    ...
    label119:
    QZLog.e("EditLocalVideoMusicMixe", 2, new Object[] { "startAudioPlayback: music not downloaded " + this.jdField_a_of_type_Ver.jdField_d_of_type_JavaLangString });
  }
  
  public void a()
  {
    P2VEditMusicDialog localP2VEditMusicDialog = new P2VEditMusicDialog(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Ahkt, (int)a(), true);
  ...
  {
    if (this.jdField_a_of_type_Ver != null) {
      new P2VEditMusicDialog(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Ahkt, (int)paramLong, true);
    }
  }
  ...
  public void a(ahgr paramahgr)
  {
    QzoneHandlerThreadFactory.getHandlerThread("Normal_HandlerThread").post(new EditLocalVideoMusicMixRunnable(this.jdField_a_of_type_Long, this.b, this.c, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Ver, new ahgq(this, paramahgr)));
  }
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Ver != null) && ((this.jdField_a_of_type_Ver.jdField_b_of_type_Int == 0) || (this.jdField_a_of_type_Ver.jdField_b_of_type_Int == 3) || (this.jdField_a_of_type_Ver.jdField_b_of_type_Int == 2)) && (!this.jdField_a_of_type_Boolean);
  }
