  ...
  implements Manager
{
  ...
  public aygx(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(ChatMessage paramChatMessage, String paramString1, String paramString2, String paramString3, anda paramanda)
  {
    if ((!this.jdField_a_of_type_Ayhf.a()) && (QLog.isColorLevel()))
    {
    ...
    this.jdField_a_of_type_Ayhf.a(paramChatMessage);
    new Handler(ThreadManager.getSubThreadLooper()).postDelayed(new AIOMessageSpreadManager.2(this, paramChatMessage, paramString1, paramanda, paramString2, paramString3), 1000L);
  }
  ...
  {
    this.jdField_a_of_type_Ayhf.a(paramancy);
  }
    ...
    do
    {
      ...
      catch (Exception localException1)
      {
        ...
        if (((String)localObject3).equalsIgnoreCase("keyword")) {
          axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009078", "0X8009078", 0, 0, "", "", "", "");
        }
        while ((localException1 instanceof MessageForFile))
        {
          ...
          if (paramChatMessage == null)
          {
            ...
            if (((String)localObject3).equalsIgnoreCase("precent")) {
              axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800907B", "0X800907B", 0, 0, "", "", "", "");
            } else if (((String)localObject3).equalsIgnoreCase("text_keyword")) {
              axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009072", "0X800907B", 0, 0, "", "", "", "");
            }
          }
          else
          {
            ayee.a(paramChatMessage, paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 2);
            return;
          }
        }
      }
      if ((localException1 instanceof MessageForTroopFile))
      {
        ...
        localObject2 = bakx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
        localObject3 = new TeamWorkFileImportInfo();
        ((TeamWorkFileImportInfo)localObject3).c = ((azqv)localObject2).jdField_a_of_type_JavaLangString;
        ((TeamWorkFileImportInfo)localObject3).jdField_b_of_type_JavaLangString = ((azqv)localObject2).g;
        ((TeamWorkFileImportInfo)localObject3).j = apug.a(((azqv)localObject2).g);
        ...
        ((TeamWorkFileImportInfo)localObject3).jdField_d_of_type_JavaLangString = ((azqv)localObject2).jdField_e_of_type_JavaLangString;
        ((TeamWorkFileImportInfo)localObject3).jdField_b_of_type_Int = ((azqv)localObject2).h;
        ...
        ayee.a((TeamWorkFileImportInfo)localObject3, paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((TeamWorkFileImportInfo)localObject3).jdField_d_of_type_Int);
        return;
      }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      QLog.e("AIOMessageSpreadManager", 1, apug.a());
      return;
    }
    if (QLog.isColorLevel()) {
