  ...
  extends BaseAdapter
{
  ...
  {
    if (paramView == null) {
      paramView = LayoutInflater.from(paramViewGroup.getContext()).inflate(2131561968, paramViewGroup, false);
    }
    for (;;)
    {
      ColorSelectView localColorSelectView = (ColorSelectView)paramView.findViewById(2131364711);
      ImageView localImageView = (ImageView)paramView.findViewById(2131364709);
      if (paramInt == 0)
      {
        localColorSelectView.setVisibility(8);
        localImageView.setVisibility(0);
        if (this.jdField_a_of_type_Int == paramInt) {}
        for (int i = 2130847076;; i = 2130847075)
        {
