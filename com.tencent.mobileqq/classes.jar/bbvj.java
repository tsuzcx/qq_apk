...
public class bbvj
{
  ...
  public static bbvk a(String paramString)
  {
    int i = 1;
      ...
      try
      {
        ...
        if (j == -1)
        {
          ...
          if (-1 == m)
          {
            ...
            localbbvk.jdField_a_of_type_JavaLangString = paramString;
            localbbvk.jdField_a_of_type_Int = Integer.valueOf(str1).intValue();
            if (i == 0) {
              break;
            }
            localbbvk.b = 1;
          ...
          str1 = str1 + ":" + str2;
          continue;
          localbbvk.jdField_a_of_type_JavaLangString = str2;
          localbbvk.jdField_a_of_type_Int = 0;
          continue;
        }
        j += 3;
      }
  ...
  public static bcmu a(long paramLong)
  {
    QQAppInterface localQQAppInterface = a();
    if (localQQAppInterface == null) {
      return null;
    }
    return bcmu.a(localQQAppInterface, paramLong);
  }
