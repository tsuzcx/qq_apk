...
public class bnsr
{
  ...
  private ITMAssistantDownloadClientListener jdField_a_of_type_ComTencentTmdownloaderITMAssistantDownloadClientListener = new bnss(this);
  ...
  private HashMap<String, bnst> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  
  static
  {
    jdField_a_of_type_JavaLangString = bnsr.class.getName();
  }
  
  public bnsr(Context paramContext)
  {
  ...
  public void a(String paramString1, String paramString2, bnst parambnst)
  {
    ...
    if (localFile.exists())
    {
      if (parambnst != null)
      {
        parambnst.a(paramString1, localFile.length(), localFile.length());
        parambnst.a(paramString1, 3, 0, null, paramString2);
      }
      return;
    }
    if (!this.jdField_b_of_type_JavaUtilHashMap.containsKey(paramString1))
    {
      this.jdField_b_of_type_JavaUtilHashMap.put(paramString1, parambnst);
