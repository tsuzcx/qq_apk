...
public class bnsr
{
        ...
        if (paramLocalMediaInfo.mMimeType.contains("video"))
        {
          if ((TextUtils.isEmpty(paramLocalMediaInfo.path)) || (paramLocalMediaInfo.path.equalsIgnoreCase("null")))
          {
            ...
            if (paramInt7 == 11)
            {
              ...
              JSONObject localJSONObject = bdmy.a(paramLocalMediaInfo);
            ...
            break label837;
            label227:
            if (blvr.a(paramActivity.getIntent(), paramInt7)) {
              break label883;
            }
            if (!blvr.c(paramActivity.getIntent())) {
              break label887;
            }
            break label883;
            label252:
            paramString1 = new EditVideoParams(paramInt7, paramInt2, paramString1, localBundle);
            paramString1.f = paramActivity.getIntent().getIntExtra("VIDEO_STORY_FROM_TYPE", blvr.a.a());
            if (l != 0L) {
            ...
            yqk.a(paramLocalMediaInfo, paramActivity.getIntent().getExtras(), paramActivity);
            ...
            paramLocalMediaInfo.putExtra("VIDEO_STORY_FROM_TYPE", blvr.a(paramActivity.getIntent()));
            if (paramInt7 == 14)
            {
              paramLocalMediaInfo.putExtra("VIDEO_STORY_JUMP_TO_TYPE", blvr.b(paramActivity.getIntent()));
              paramLocalMediaInfo.putExtra("VIDEO_STORY_MEDIA_TYPE", blvr.c(paramActivity.getIntent()));
            }
            if (paramBundle == null) {
              break label916;
            }
  ...
  public static boolean a()
  {
    ...
    if (localvuq == null)
    {
      xvv.e("Q.qqstory.publish.QQStoryFlowCallback", "StoryConfigManager(CONFIG_MANAGER) is null!");
      return false;
    }
    int i = localvuq.b();
    if (i == h) {
    ...
    jdField_a_of_type_Int = ((Integer)localvuq.b("localUploadVideoSizeLimit", Integer.valueOf(jdField_a_of_type_Int))).intValue();
    jdField_b_of_type_Int = ((Integer)localvuq.b("localUploadVideoMinResolutionLimit", Integer.valueOf(jdField_b_of_type_Int))).intValue();
    c = ((Integer)localvuq.b("localUploadVideoDurationLimit", Integer.valueOf(c))).intValue();
    e = ((Integer)localvuq.b("localUploadVideoRatioLimit", Integer.valueOf(e))).intValue();
    f = ((Integer)localvuq.b("localUploadImageSizeLimit", Integer.valueOf(f))).intValue();
    g = ((Integer)localvuq.b("localUploadImageMinResolutionLimit", Integer.valueOf(g))).intValue();
    jdField_a_of_type_Float = e / 10000 / 1000.0F;
    jdField_b_of_type_Float = e % 10000 / 1000.0F;
    xvv.d("Q.qqstory.publish.QQStoryFlowCallback", "Update Limit Config %d|%d|%d|%d|%d|%d", new Object[] { Integer.valueOf(jdField_a_of_type_Int), Integer.valueOf(jdField_b_of_type_Int), Integer.valueOf(c), Integer.valueOf(e), Integer.valueOf(f), Integer.valueOf(g) });
    xvv.d("Q.qqstory.publish.QQStoryFlowCallback", "Update Limit Config from %d to %d", new Object[] { Integer.valueOf(h), Integer.valueOf(i) });
    h = localvuq.b();
    return true;
  }
  ...
  public static boolean a(Activity paramActivity, Intent paramIntent, int paramInt)
  {
    ...
    if (localLocalMediaInfo == null) {
      throw new IllegalArgumentException(amtj.a(2131709992));
    }
    ...
    if (j == 10012)
    {
      if (l < blih.jdField_a_of_type_Int)
      {
  ...
  public static boolean a(@NonNull Activity paramActivity, @NonNull LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (paramLocalMediaInfo.mMimeType.contains("video")) {
      if (paramLocalMediaInfo.mDuration > c)
      {
        ...
        xvv.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
        j = 4;
        k = 5;
        i = 1;
      }
    ...
    for (;;)
    {
      xwa.b("upload_local_video", "choose_media_info", 0, j, new String[] { a(paramLocalMediaInfo) });
      if (i != 0)
      {
        String str1 = String.valueOf(1);
        label200:
        xwa.a("video_shoot", "chose_video", 0, 0, new String[] { str1, String.valueOf(k), String.valueOf(f1) });
        if ((i != 0) && (paramLocalMediaInfo.mDuration >= 20500L)) {
          xwa.a("video_shoot", "local_over", 0, 0, new String[0]);
        }
        if (paramLocalMediaInfo.addedDate == 0L)
        {
          ...
          i = 0;
          label307:
          xwa.b("upload_local_video", "media_info_missing", 0, i, new String[] { a(paramLocalMediaInfo) });
        }
        if (localObject != null) {
      ...
      for (;;)
      {
        ...
        {
          localObject = QQToast.a(paramActivity, 1, amtj.a(2131709982), 0);
          xvv.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          k = 1;
          j = 1;
          i = 1;
        ...
        {
          localObject = QQToast.a(paramActivity, 1, amtj.a(2131709970), 0);
          xvv.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          k = 3;
          j = 2;
          i = 1;
        ...
        if ((f1 < 0.4F) || (f1 > 2.2F))
        {
          localObject = QQToast.a(paramActivity, 1, amtj.a(2131709975), 0);
          xvv.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          j = 3;
          i = 1;
          break;
        ...
        localObject = QQToast.a(paramActivity, 1, amtj.a(2131709961), 0);
        xvv.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
        j = 6;
        k = 8;
        i = 1;
        ...
        {
          localObject = QQToast.a(paramActivity, 1, amtj.a(2131709977), 0);
          xvv.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          k = 1;
          j = 1;
          i = 0;
        ...
        {
          localObject = QQToast.a(paramActivity, 1, amtj.a(2131709976), 0);
          xvv.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
          k = 3;
          j = 2;
          i = 0;
        ...
        localObject = QQToast.a(paramActivity, 1, amtj.a(2131709974), 0);
        xvv.c("Q.qqstory.publish.QQStoryFlowCallback", "checkQQStoryMediaValid media not valid! " + paramLocalMediaInfo.toString());
        j = 3;
        i = 0;
        break;
