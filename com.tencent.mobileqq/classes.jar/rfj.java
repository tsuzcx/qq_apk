...
public class rfj
  extends rfl
{
  public rfj(Context paramContext, FaceDecoder paramFaceDecoder, szd paramszd)
  {
  ...
  public rbp o()
  {
    ...
    if (this.jdField_a_of_type_Rbo != null)
    {
      ...
      this.jdField_a_of_type_Rbo.a(ComponentContentGridImage.a(((qfw)this.jdField_a_of_type_JavaLangObject).a()));
    }
