...
public final class bguo
{
  ...
  {
    return bgwg.a(paramContext, String.valueOf(BaseApplicationImpl.getApplication().getRuntime().getLongAccountUin()), "key_signature");
  }
  ...
  {
    bgwg.a(paramContext, String.valueOf(paramLong), "key_pwd_queried");
    bgwg.a(paramContext, String.valueOf(paramLong), "key_pwd_has");
    bgwg.a(paramContext, String.valueOf(paramLong), "key_pwd_verified");
    a[0].set(false);
    a[1].set(false);
    a[2].set(false);
    a[3].set(false);
  ...
  {
    bgwg.a(paramContext, String.valueOf(BaseApplicationImpl.getApplication().getRuntime().getLongAccountUin()), "key_signature", paramString);
  }
  ...
  public static void a(Context paramContext, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (localAtomicBoolean.compareAndSet(bool, paramBoolean)) {
        bgwg.a(paramContext, String.valueOf(BaseApplicationImpl.getApplication().getRuntime().getLongAccountUin()), "key_pwd_queried", Boolean.toString(paramBoolean));
      }
      return;
      bool = false;
    }
  ...
  public static void a(bgun<WeiyunPB.PwdQueryMsgRsp> parambgun)
  {
    if (parambgun == null) {
      return;
    }
    if (a[0].get())
    {
      ...
      if ((a[1].get()) && (!a[2].get()))
      {
        ...
        parambgun.a(localPwdQueryMsgRsp);
        return;
      }
    ...
    bgui.a().a(Integer.toString(11001), a(11001, new WeiyunPB.PwdQueryMsgReq()), new bgum(11001, parambgun));
  }
  
  public static void a(WeiyunPB.AioPicAndVideoCopyToWeiyunMsgReq paramAioPicAndVideoCopyToWeiyunMsgReq, bgun<WeiyunPB.AioPicAndVideoCopyToWeiyunMsgRsp> parambgun)
  {
    bgui.a().a(Integer.toString(246001), a(246001, paramAioPicAndVideoCopyToWeiyunMsgReq), new bgum(246001, parambgun));
  }
  
  public static void a(WeiyunPB.CrossBidProxyCopyFileToOtherBidMsgReq paramCrossBidProxyCopyFileToOtherBidMsgReq, bgun<WeiyunPB.CrossBidProxyCopyFileToOtherBidMsgRsp> parambgun)
  {
    bgui.a().a(Integer.toString(245700), a(245700, paramCrossBidProxyCopyFileToOtherBidMsgReq), new bgum(245700, parambgun));
  }
  
  public static void a(WeiyunPB.CrossBidProxyOfflineFileGetListMsgReq paramCrossBidProxyOfflineFileGetListMsgReq, bgun<WeiyunPB.CrossBidProxyOfflineFileGetListMsgRsp> parambgun)
  {
    bgui.a().a(Integer.toString(245706), a(245706, paramCrossBidProxyOfflineFileGetListMsgReq), new bgum(245706, parambgun));
  }
  
  public static void a(WeiyunPB.DiskDirFileBatchDeleteExMsgReq paramDiskDirFileBatchDeleteExMsgReq, bgun<WeiyunPB.DiskDirFileBatchDeleteExMsgRsp> parambgun)
  {
    bgui.a().a(Integer.toString(2509), a(2509, paramDiskDirFileBatchDeleteExMsgReq), new bgum(2509, parambgun));
  }
  
  public static void a(WeiyunPB.DiskFileBatchDownloadMsgReq paramDiskFileBatchDownloadMsgReq, bgun<WeiyunPB.DiskFileBatchDownloadMsgRsp> parambgun)
  {
    bgui.a().a(Integer.toString(2402), a(2402, paramDiskFileBatchDownloadMsgReq), new bgum(2402, parambgun));
  }
  
  public static void a(WeiyunPB.DiskFileDocDownloadAbsMsgReq paramDiskFileDocDownloadAbsMsgReq, bgun<WeiyunPB.DiskFileDocDownloadAbsMsgRsp> parambgun)
  {
    bgui.a().a(Integer.toString(2414), a(2414, paramDiskFileDocDownloadAbsMsgReq), new bgum(2414, parambgun));
  }
  
  public static void a(WeiyunPB.DiskPicBackupReq paramDiskPicBackupReq, bgun<WeiyunPB.DiskPicBackupRsp> parambgun)
  {
    bgui.a().a(Integer.toString(2803), a(2803, paramDiskPicBackupReq), new bgum(2803, parambgun));
  }
  
  public static void a(WeiyunPB.LibInfoListGetMsgReq paramLibInfoListGetMsgReq, bgun<WeiyunPB.LibInfoListGetMsgRsp> parambgun)
  {
    bgui.a().a(Integer.toString(26113), a(26113, paramLibInfoListGetMsgReq), new bgum(26113, parambgun));
  }
  
  public static void a(WeiyunPB.PwdVerifyMsgReq paramPwdVerifyMsgReq, bgun<WeiyunPB.PwdVerifyMsgRsp> parambgun)
  {
    bgui.a().a(Integer.toString(11005), a(11005, paramPwdVerifyMsgReq), new bgum(11005, parambgun));
  }
  
  public static void a(WeiyunPB.QqSdkFileUploadMsgReq paramQqSdkFileUploadMsgReq, bgun<WeiyunPB.QqSdkFileUploadMsgRsp> parambgun)
  {
    bgui.a().a(Integer.toString(246000), a(246000, paramQqSdkFileUploadMsgReq), new bgum(246000, parambgun));
  }
  
  public static void a(WeiyunPB.WeiyunShareAddFromMobileQQMsgReq paramWeiyunShareAddFromMobileQQMsgReq, bgun<WeiyunPB.WeiyunShareAddFromMobileQQMsgRsp> parambgun)
  {
    bgui.a().a(Integer.toString(12102), a(12102, paramWeiyunShareAddFromMobileQQMsgReq), new bgum(12102, parambgun));
  }
  
  public static void a(WeiyunPB.WeiyunTrialCouponUseMsgReq paramWeiyunTrialCouponUseMsgReq, bgun<WeiyunPB.WeiyunTrialCouponUseMsgRsp> parambgun)
  {
    bgui.a().a(Integer.toString(245520), a(245520, paramWeiyunTrialCouponUseMsgReq), new bgum(245520, parambgun));
  }
  
  public static void a(String paramString, bgun<WeiyunPB.PwdVerifyMsgRsp> parambgun)
  {
    ...
    localPwdVerifyMsgReq.pwd_md5.set(bgwl.a(paramString));
    a(localPwdVerifyMsgReq, parambgun);
  }
  ...
  public static void b(Context paramContext, boolean paramBoolean)
  {
    ...
    {
      if (localAtomicBoolean.compareAndSet(bool, paramBoolean)) {
        bgwg.a(paramContext, String.valueOf(BaseApplicationImpl.getApplication().getRuntime().getLongAccountUin()), "key_pwd_has", Boolean.toString(paramBoolean));
      }
      return;
      bool = false;
    }
  ...
  public static void b(String paramString, bgun<WeiyunPB.PwdVerifyMsgRsp> parambgun)
  {
    WeiyunPB.PwdVerifyMsgReq localPwdVerifyMsgReq = new WeiyunPB.PwdVerifyMsgReq();
    localPwdVerifyMsgReq.cs_sig.set(bgwl.a(paramString));
    a(localPwdVerifyMsgReq, parambgun);
  }
  ...
  public static void c(Context paramContext, boolean paramBoolean)
  {
    ...
    {
      if (localAtomicBoolean.compareAndSet(bool, paramBoolean)) {
        bgwg.a(paramContext, String.valueOf(BaseApplicationImpl.getApplication().getRuntime().getLongAccountUin()), "key_pwd_verified", Boolean.toString(paramBoolean));
      }
      return;
      bool = false;
    }
