  ...
  implements DialogInterface.OnClickListener, QQPermissionCallback
{
  ...
  private static final String[] jdField_b_of_type_ArrayOfJavaLangString = { alpo.a(2131702148), "QQ使用电话权限确定本机号码和设备ID，以保证帐号登录的安全性。QQ不会拨打其他号码或终止通话。\n请在设置中开启电话权限或存储空间，以正常使用QQ功能。" };
  private addq jdField_a_of_type_Addq;
  ...
  private void a(AppActivity paramAppActivity, int paramInt)
  {
    ...
    azmj.a(null, "dc00898", "", "", str1, str1, paramInt, 0, "", "", str2, "");
  }
  ...
  public void a()
  {
    ...
    bdfq localbdfq = bdcd.a(this.jdField_a_of_type_MqqAppAppActivity, 230);
    String str1 = alpo.a(2131710586);
    if (i > 1) {}
    for (i = 2131694153;; i = 2131694152)
    {
      String str2 = alpo.a(i);
      localbdfq.setTitle(str1);
      localbdfq.setMessage(str2);
      localbdfq.setNegativeButton(alpo.a(2131694151), localaddp);
      localbdfq.setPositiveButton(alpo.a(2131694150), localaddp);
      localbdfq.show();
      return;
    }
  }
  
  public void a(addq paramaddq)
  {
    this.jdField_a_of_type_Addq = paramaddq;
  }
  ...
  public boolean a(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (alun.a(0)))
    {
      paramAppActivity = new addo(this);
      alun.a(this.jdField_a_of_type_MqqAppAppActivity, "", paramAppActivity, paramAppActivity).show();
      return false;
    }
  ...
  {
    if (this.jdField_a_of_type_Addq != null) {
      this.jdField_a_of_type_Addq.b();
    }
