...
public class aznv
{
  ...
  public static String a(Bitmap paramBitmap)
  {
    ...
    return bhcu.encodeToString(localByteArrayOutputStream.toByteArray(), 2);
  }
  ...
  public static String a(String paramString)
  {
    ...
    try
    {
      ...
      if (arrayOfByte != null) {
        localObject1 = bkvq.b(arrayOfByte);
      }
    }
  ...
  public static String a(String paramString, long paramLong)
  {
    for (i = 1;; i = j)
    {
      ...
      str = bhcu.encodeToString(str.getBytes(), 2);
  ...
  public static String a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return bkvq.b(jdField_a_of_type_JavaSecurityMessageDigest.digest());
    }
  ...
  public static String b(String paramString)
  {
    ...
    //   23: iconst_2
    //   24: invokestatic 242	bhcu:decode	([BI)[B
    //   27: astore_0
