...
public class bgww
  extends bgvv
  implements DialogInterface.OnDismissListener, bjtg, ShareActionSheet.OnItemClickListener
{
  ...
  public Activity a;
  protected Bundle a;
  private bgxc jdField_a_of_type_Bgxc;
  public ShareActionSheetBuilder a;
  public WebViewFragment a;
  public String a;
  public final ArrayList<String> a;
  private slb jdField_a_of_type_Slb;
  ...
  {
    if (paramInt == 1) {
      return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131718869, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131691178) });
    }
    if (paramInt == 3) {
      return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131718869, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131718407) });
    }
    if (paramInt == 10) {
      return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131718869, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131718403) });
    }
    if (paramInt == 12) {
      return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131718869, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131695895) });
    }
    return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131718869, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131719377) });
  }
  ...
  {
    bfur.a(this.jdField_a_of_type_AndroidAppActivity, a(paramInt), 2131691686, 2131719641, new bgwz(this, paramInt, paramString), new bgxa(this, paramInt, paramString)).show();
  }
  
  private void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Aadf.p)) {
      this.jdField_a_of_type_Aadf.a(paramString1, 3, true);
    }
    for (;;)
    {
      bcef.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_40", "weixin_share", 0, 1, 0, "", "", "", "");
      if ((paramString2 != null) && (!"".equals(paramString2))) {
        odq.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1003, 0, paramString2, paramString4, paramString3, AccountDetailActivity.a(paramString3), false);
      }
      ...
      if (this.jdField_a_of_type_Aadf.a != null) {
      ...
      try
      {
        ...
        label171:
        acmy.b(this.jdField_a_of_type_Aadf.a, localJSONObject);
        this.jdField_a_of_type_Aadf.a(paramString1, 3, true);
      }
  ...
  private void b(String paramString)
  {
    ...
    yyi.a(2, 2131691181);
    if ((this.i) && (!TextUtils.isEmpty(this.jdField_a_of_type_Aadf.p))) {
  ...
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Aadf.p)) {
      this.jdField_a_of_type_Aadf.a(paramString, 8, false);
    }
    for (;;)
    {
      ...
      odq.a(null, "", "0X800787A", "0X800787A", 0, 0, (String)localObject, str, "", "");
      ugf.a(1005, str, this.jdField_f_of_type_Int);
      return;
      this.jdField_a_of_type_Aadf.a(paramString, 8, false);
    }
  }
  ...
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Aadf.p)) {
      this.jdField_a_of_type_Aadf.a(paramString, 4, true);
    }
    for (;;)
    {
  ...
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Aadf.p)) {
      this.jdField_a_of_type_Aadf.a(paramString, 2, false);
    }
    for (;;)
    {
      ...
      try
      {
        ...
        label125:
        acmy.b(this.jdField_a_of_type_Aadf.a, paramString);
    ...
    for (localObject1 = ((WebView)localObject3).getOriginalUrl();; localObject1 = null)
    {
      ...
      for (;;)
      {
        ...
        catch (Exception localException)
        {
          ...
          b(paramString);
          continue;
          bglg.a.a(this.jdField_a_of_type_AndroidAppActivity, paramString);
          continue;
          if (paramInt != 11) {
            continue;
          }
          ...
          try
          {
            ...
            if (n != 0)
            {
              ...
              odq.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1008, 0, str4, str2, str3, AccountDetailActivity.a(str3), false);
            }
          }
          ...
          if (this.jdField_a_of_type_Bgxc == null) {
            continue;
          }
          this.jdField_a_of_type_Bgxc.a(paramString);
          continue;
          if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) {
            continue;
          }
          throw new InvalidParameterException("ACTION_REFRESH_FREIEND_VIEW should be handled by QQBrowserActivity!");
          paramBundle = (bgxd)this.mComponentContext.a().a(-2);
          ...
          boolean bool = true;
          this.jdField_a_of_type_Aadf.g = bool;
          if (!QLog.isColorLevel()) {
            continue;
          }
          QLog.d("SwiftBrowserShareMenuHandler", 2, new Object[] { "ShareArkFromH5 mShare.isShareArk=", Boolean.valueOf(this.jdField_a_of_type_Aadf.g), ",\n shareUrl=", npn.b(paramString, new String[0]) });
          if ((paramInt != 72) || (TextUtils.isEmpty(this.jdField_a_of_type_Aadf.r))) {
            continue;
          }
          this.jdField_a_of_type_Aadf.a(n, str8, str7);
          a(paramString, (String)localObject2, (String)localObject1);
          continue;
          if (paramInt != 4) {
            continue;
          }
          apdo.a(this.jdField_a_of_type_AndroidAppActivity, paramString, str6);
          continue;
          if (paramInt != 5) {
            continue;
          }
          ...
          paramString = (bgxh)this.mComponentContext.a().a(16);
          if (paramString == null) {
            continue;
          }
          paramString.a("https://appchannel.html5.qq.com/directdown?app=qqbrowser&channel=10367", true);
          bcef.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_46", "qqbrowser_share", 0, 1, 0, "", "", "", "");
          bcef.b(null, "P_CliOper", "VIPCOMIC", "", "0X80061A0", "0X80061A0", 1000, 0, npn.b(str3, new String[0]), null, null, null);
          if ((str4 == null) || ("".equals(str4))) {
            continue;
          }
          odq.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1005, 0, str4, str2, str3, AccountDetailActivity.a(str3), false);
          continue;
          ...
          ugf.a(1002, (String)localObject1, this.jdField_f_of_type_Int);
          if ((this.jdField_a_of_type_Aadf.a() == null) || (this.jdField_a_of_type_Aadf.a().jdField_a_of_type_Int != 0)) {
            continue;
          }
          ...
          if (!this.jdField_a_of_type_Aadf.a(paramString)) {
            continue;
          }
          this.jdField_a_of_type_Aadf.a(paramString, 9, false);
          if ((str4 == null) || ("".equals(str4))) {
            continue;
          }
          odq.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1007, 0, str4, str2, str3, AccountDetailActivity.a(str3), false);
          continue;
          if (paramInt != 129) {
            continue;
          }
          bkox.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mApp.getCurrentAccountUin(), this.jdField_c_of_type_Long, this.jdField_d_of_type_Long);
          continue;
          ...
          ugf.a(1003, (String)localObject1, this.jdField_f_of_type_Int);
          ...
          yyi.a(0, n);
          continue;
          ugf.a(1004, (String)localObject1, this.jdField_f_of_type_Int);
          continue;
          ...
          this.jdField_a_of_type_Aadf.a(paramString, 5, true);
          continue;
          if (paramInt != 15) {
            continue;
          }
          ...
          return;
          a().a(i2, new bgwx(this));
          bcef.b(null, "P_CliOper", "Grp_open", "", "third_app", "add_menu", 0, 1, 0, "" + i1, "" + i2, "", "");
          continue;
          if (paramInt != 16) {
            continue;
          }
          ...
          bcef.b(null, "P_CliOper", "Grp_open", "", "third_app", "detail_menu", 0, 1, 0, "" + i1, "" + i2, "", "");
          continue;
          if (paramInt != 17) {
            continue;
          }
          ...
          paramBundle.putExtra("hide_more_button", true);
          this.jdField_a_of_type_AndroidAppActivity.startActivity(paramBundle);
          bcef.b(null, "P_CliOper", "Grp_open", "", "third_app", "share_menu", 0, 1, 0, "" + i1, "" + i2, "", "");
          continue;
          if (paramInt != 18) {
            continue;
          }
          ...
          bcef.b(null, "P_CliOper", "Grp_open", "", "third_app", "refresh_menu", 0, 1, 0, "" + i1, "" + i2, "", "");
          continue;
          ...
          this.jdField_a_of_type_Aadf.a(paramString, n, false);
          continue;
          n = 7;
          continue;
          this.jdField_a_of_type_Aadf.a(paramString, n, true);
          continue;
          if (paramInt != 21) {
            continue;
          }
          paramString = (bgwr)this.mComponentContext.a().a(64);
          if (paramString == null) {
            continue;
          }
          ...
          paramBundle = "";
          odq.a(null, "", "0X8007071", "0X8007071", 0, 0, paramBundle, "", "", "");
          odq.a("0X8007071", "", paramBundle, "", "", "");
          continue;
          if (paramInt != 12) {
            continue;
          }
          ...
          paramString = (oct)((Iterator)localObject1).next();
          ...
          paramBundle = "";
          bcua.a(paramString, paramBundle);
          continue;
          n = 1;
          continue;
          paramBundle = this.jdField_a_of_type_Aadf.b();
          continue;
          if (paramInt != 70) {
            continue;
          }
          ...
          bcef.b(null, "dc00898", "", "", "0X800A9A4", "0X800A9A4", 0, 0, "1", "", "", "");
          bfrx.a(this.mComponentContext.a(), new bgwy(this));
          continue;
          l1 = 0L;
          continue;
          l1 = 0L;
  ...
  {
    ((bgxd)this.mComponentContext.a().a(-2)).jdField_a_of_type_Long = paramLong;
  }
  
  public void a(aadf paramaadf, long paramLong)
  {
    if (paramaadf == null) {}
    label297:
    do
    {
      for (;;)
      {
        ...
        if ((this.jdField_a_of_type_AndroidAppActivity != null) && (!this.jdField_a_of_type_AndroidAppActivity.isFinishing()))
        {
          ...
          paramaadf = null;
          localObject1 = (bgwr)this.mComponentContext.a().a(64);
          if (localObject1 != null) {
            paramaadf = ((bgwr)localObject1).a();
          }
          localObject1 = (bgxd)this.mComponentContext.a().a(-2);
          if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (localObject1 != null))
          {
            if (((bgxd)localObject1).m)
            {
              paramaadf = "<font color='#777777'>应用由 </font><font color='#00a5e0'>" + this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.troopAppCompanyName + "</font><font color='#777777'> 提供</font>";
              this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetTitle(Html.fromHtml(paramaadf));
              bcef.b(null, "P_CliOper", "Grp_open", "", "third_app", "exp_menu", 0, 1, 0, "" + this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.troopId, "" + this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.appId, "", "");
            }
          }
          else
          {
          ...
          try
          {
            ...
            else
            {
              ...
              localObject2 = paramaadf;
              if (paramaadf == null) {
                localObject2 = "";
              }
              odq.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005F78", "0X8005F78", 0, 0, this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.publicUin, (String)localObject1, this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.msgid, (String)localObject2, false);
              if (this.jdField_f_of_type_Boolean)
              {
                odq.a(null, "", "0X8008CAA", "0X8008CAA", 0, 0, "", "", "", "", false);
                return;
                if (!TextUtils.isEmpty(paramaadf))
                {
                  this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetTitle(paramaadf);
                  break label297;
                }
                this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetTitle(BaseApplicationImpl.getApplication().getString(2131718364));
              }
            }
          }
    ...
    odq.a(null, "", "0X8008CAB", "0X8008CAB", 0, 0, "", "", "", "", false);
  }
  
  public void a(bgxc parambgxc)
  {
    this.jdField_a_of_type_Bgxc = parambgxc;
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ugf.a(1001, paramString3, this.jdField_f_of_type_Int);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Aadf.p)) {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          try
          {
            ...
            label143:
            acmy.b(this.jdField_a_of_type_Aadf.a, paramString2);
            this.jdField_a_of_type_Aadf.a(paramString1, 1, false);
          }
  ...
  public List<ShareActionSheetBuilder.ActionSheetItem>[] a()
  {
    ...
    Object localObject1 = (bgxd)this.mComponentContext.a().a(-2);
    if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (localObject1 != null) && (((bgxd)localObject1).m))
    {
    ...
    {
      if ((localObject1 != null) && (!TextUtils.isEmpty(((AppRuntime)localObject1).getAccount())) && (this.h) && (!ufd.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:diandian")) && (!TextUtils.isEmpty(this.jdField_a_of_type_Aadf.p))) {
      ...
      {
        n = 1;
        if (((n != 0) || (this.g)) && (!ufd.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:sinaWeibo"))) {
        ...
        if ((!ufd.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:qiDian")) && ((this.jdField_a_of_type_Long & 0x10) == 0L)) {
          bily.a(this.jdField_a_of_type_AndroidAppActivity, localArrayList1);
        }
        ...
        if ((!ufd.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:copyWatchWord")) && ((this.jdField_a_of_type_Long & 0x2) == 0L) && (aqik.a(a())) && (a().contains("?")))
        {
          n = bglg.a.a(a()).intValue();
          if (n != -1)
          {
            bcef.b(null, "dc00898", "", "", "qq_vip", "0X800AF77", n, 0, "", "", "", "");
        ...
        if (this.k)
        {
          ...
          if ((localObject3 != null) && (((apkn)localObject3).a()) && (((apkn)localObject3).e()) && (!aplm.c((String)localObject2)))
          {
            boolean bool = ((apkn)localObject3).c();
      ...
      for (;;)
      {
        ...
        localObject3 = (oct)((Iterator)localObject2).next();
      ...
      localObject2 = (bgwr)this.mComponentContext.a().a(64);
      if ((localObject2 != null) && (((bgwr)localObject2).a()) && (!ufd.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:screenShotShare"))) {
      ...
      if ((localObject1 != null) && (!TextUtils.isEmpty(((AppRuntime)localObject1).getAccount())) && (!ufd.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:exportTencentDocs")) && ((((SwiftBrowserUIStyleHandler)this.mComponentContext.a().a(2)).mUIStyle.mWWVRulesFromUrl & 0x4000) == 0L))
      {
        localObject2 = a();
        localObject1 = localObject2;
  ...
  public void b(int paramInt)
  {
    ...
    } while (this.jdField_a_of_type_Aadf == null);
    this.jdField_a_of_type_Aadf.a(paramInt, n);
  }
  ...
  public void c()
  {
    this.jdField_a_of_type_Slb = new sld(this.jdField_a_of_type_AndroidAppActivity.getLayoutInflater()).a(this).a(this.jdField_b_of_type_Int).a().a(this.mComponentContext.a());
  }
  ...
  public void d()
  {
    if (a())
    {
      this.jdField_c_of_type_Int = a().b(new bgxb(this));
      return;
    }
    b(1);
  }
  ...
  public void onDismiss(DialogInterface paramDialogInterface)
  {
    ...
    try
    {
      if ((this.jdField_a_of_type_Aadf != null) && (this.jdField_a_of_type_Aadf.a() != null)) {
        this.jdField_a_of_type_Aadf.a().dismiss();
      }
  ...
  public void onLifeCycleStateChanged(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Slb != null) {
          this.jdField_a_of_type_Slb.a();
        }
        if (this.jdField_a_of_type_Zon != null)
        {
          this.jdField_a_of_type_Zon.a(this.jdField_c_of_type_Int);
    ...
    } while ((this.jdField_a_of_type_Slb == null) || (!this.jdField_a_of_type_Slb.a()));
    this.jdField_a_of_type_Slb.b();
    c();
  }
}
