...
public class bjil
{
  ...
  public static Map<String, String> a()
  {
    try
    {
      Map localMap = a(new FileInputStream("/proc/cpuinfo"), new bjim());
      return localMap;
    }
  ...
  /* Error */
  private static Map<String, String> a(InputStream paramInputStream, bjio parambjio)
  {
    // Byte code:
  ...
  private static void a(Set<String> paramSet, Map<String, String> paramMap)
  {
    ...
    //   57: dup
    //   58: invokestatic 94	bjil:d	()Ljava/lang/String;
  ...
  private static String b(Map<String, String> paramMap, String paramString)
  {
    ...
    for (;;)
    {
      ...
      else if (paramString.equals("mg"))
      {
        ...
        paramMap = "A" + bjkf.b(paramString.toString()).substring(0, 15);
      }
  ...
  private static Map<String, String> b()
  {
    ...
    {
      return localHashMap;
      a(a(localInputStream, new bjin()), localHashMap);
  ...
  private static void b()
  {
    ...
    bjhk.b(localStringBuilder.toString().substring(1), 110);
  }
