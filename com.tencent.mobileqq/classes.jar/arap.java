  ...
  extends BaseAdapter
{
  ...
  private aras jdField_a_of_type_Aras;
  private arbm jdField_a_of_type_Arbm;
  private List<LocationRoom.Venue> jdField_a_of_type_JavaUtilList;
  private boolean jdField_a_of_type_Boolean = true;
  private int b = -1;
  
  arap(Context paramContext)
  {
  ...
  void a()
  {
    if ((this.jdField_a_of_type_Arbm.a()) && (this.jdField_a_of_type_Aras != null)) {
      this.jdField_a_of_type_Aras.a(1);
    }
  }
  ...
  void a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Aras != null) {
      this.jdField_a_of_type_Aras.a(4);
    }
  }
  
  void a(aras paramaras)
  {
    this.jdField_a_of_type_Aras = paramaras;
  }
  
  public void a(BaseActivity paramBaseActivity, int paramInt1, int paramInt2, String paramString)
  {
    this.jdField_a_of_type_Arbm = new arbm(paramBaseActivity, paramInt1, paramInt2, paramString);
    this.jdField_a_of_type_Arbm.a(new araq(this, paramString));
    if ((this.jdField_a_of_type_Arbm.a()) && (this.jdField_a_of_type_Aras != null)) {
      this.jdField_a_of_type_Aras.a(0);
    }
    this.b = -1;
  ...
  public int getCount()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      if (this.jdField_a_of_type_Arbm.b()) {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramViewGroup = new arar();
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131493591, null);
      ...
      paramViewGroup.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131310033);
      paramViewGroup.jdField_b_of_type_AndroidViewView.setVisibility(4);
      paramViewGroup.c = paramView.findViewById(2131304762);
      paramView.setTag(paramViewGroup);
      if ((!this.jdField_a_of_type_Arbm.b()) || (paramInt != this.jdField_a_of_type_JavaUtilList.size())) {
        break label148;
      }
    ...
    {
      return paramView;
      paramViewGroup = (arar)paramView.getTag();
      break;
    ...
    {
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(String.format(this.jdField_a_of_type_AndroidContentContext.getString(2131628357), new Object[] { localVenue.b }));
    ...
    for (paramViewGroup = paramViewGroup + this.jdField_a_of_type_AndroidContentContext.getString(2131629548);; paramViewGroup = str + this.jdField_a_of_type_AndroidContentContext.getString(2131629549))
    {
