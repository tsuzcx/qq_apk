...
public class vqx
{
  ...
  private sua jdField_a_of_type_Sua = new sua();
  ArrayList<bbzn> b;
  private ArrayList<vrn> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  
  static
  {
    jdField_a_of_type_JavaLangString = BaseApplicationImpl.sApplication.getFilesDir() + File.separator + "blessVoiceChange.json";
    jdField_b_of_type_JavaLangString = ajsf.aW + "voiceChange/bless/";
    jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
    a();
  }
  
  public vqx(EditVideoMusic paramEditVideoMusic, EditVideoParams paramEditVideoParams, Handler paramHandler)
  {
  ...
  private boolean a()
  {
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList == null)
    {
      ...
      if (i < ListenChangeVoicePanel.jdField_a_of_type_ArrayOfInt.length)
      {
        ...
        for (j = 0;; j = 2)
        {
          ((ArrayList)localObject1).add(new bbzn(k, (String)localObject4, (String)localObject5, 0, j, 1, new bbzo(ListenChangeVoicePanel.jdField_b_of_type_ArrayOfInt[i], null, null, null)));
          i += 1;
          break;
        }
      }
    ...
    if (localObject1 == null)
    {
      ...
      {
        localObject1 = (bbzn)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject1 != null) {
          ((bbzn)localObject1).jdField_b_of_type_Int = 0;
        }
        i += 1;
      }
      return false;
    ...
    for (;;)
    {
      ...
      catch (Exception localException2)
      {
        ...
        localObject4 = (bbzn)localIterator.next();
        if (localArrayList.contains(Integer.valueOf(((bbzn)localObject4).jdField_a_of_type_Int))) {
          continue;
        }
        ((bbzn)localObject4).jdField_b_of_type_Int = 0;
        continue;
      ...
      {
        localObject5 = (bbzn)((Iterator)localObject4).next();
        if (!localArrayList.contains(Integer.valueOf(((bbzn)localObject5).jdField_a_of_type_Int))) {
          ((bbzn)localObject5).jdField_b_of_type_Int = 0;
        }
      }
      label929:
      j += 1;
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList != null)
    {
      localObject3 = (bbzn)this.jdField_b_of_type_JavaUtilArrayList.get(j);
      label956:
      ...
      else
      {
        ...
        if (k != 0)
        {
          ...
          {
            j = k;
            if (bbpm.a(((JSONObject)localObject4).getString("QQVersion"), "8.2.8"))
            {
              k = 0;
              j = k;
              if (QLog.isColorLevel())
        ...
        if (j == 0)
        {
          ((bbzn)localObject3).jdField_b_of_type_Int = j;
        }
        else
        {
          ...
          for (;;)
          {
            ...
            ((bbzn)localObject3).d = 1;
            ((bbzn)localObject3).c = 0;
            if (!TextUtils.isEmpty(((JSONObject)localObject6).getString("name"))) {
              break label1364;
            }
            localObject4 = ((bbzn)localObject3).jdField_a_of_type_JavaLangString;
            label1225:
            ((bbzn)localObject3).jdField_a_of_type_JavaLangString = ((String)localObject4);
            if (!TextUtils.isEmpty(((JSONObject)localObject6).getString("description"))) {
              break label1377;
            }
            localObject4 = ((bbzn)localObject3).jdField_b_of_type_JavaLangString;
            label1253:
            ((bbzn)localObject3).jdField_b_of_type_JavaLangString = ((String)localObject4);
            ((bbzn)localObject3).jdField_a_of_type_Bbzo.jdField_a_of_type_JavaLangString = ((String)localObject5);
            break label1632;
            localObject5 = bbnq.jdField_a_of_type_JavaLangString + (String)localObject5;
    ...
    for (int j = ((JSONObject)localObject4).getInt("tag");; j = 0)
    {
      ...
      if (localArrayList.size() > 0)
      {
        ...
        {
          localObject4 = (bbzn)((Iterator)localObject3).next();
          if (!localArrayList.contains(Integer.valueOf(((bbzn)localObject4).jdField_a_of_type_Int))) {
            ((bbzn)localObject4).jdField_b_of_type_Int = 0;
          }
        }
      ...
      while (i < this.jdField_b_of_type_JavaUtilArrayList.size())
      {
        localObject3 = (bbzn)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject3 != null) {
          ((bbzn)localObject3).jdField_b_of_type_Int = 0;
        }
        i += 1;
      }
      return true;
      ...
      while (i < this.jdField_b_of_type_JavaUtilArrayList.size())
      {
        localObject4 = (bbzn)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject4 != null) {
          ((bbzn)localObject4).jdField_b_of_type_Int = 0;
        }
        i += 1;
  ...
  private void d()
  {
    ...
    new vqy(this, this.jdField_a_of_type_Sua, l).executeOnExecutor(Bosses.get().getExecutor(16), new tfe[] { new tfe(str1, str2, null) });
  }
  ...
  public void a(vrn paramvrn)
  {
    ...
    if (a((Object[])localObject2))
    {
      ...
      if (!localFile.exists()) {
        bbdj.a(new File((String)localObject1), localFile);
      }
      localObject2 = new bbzm((String)localObject2, i, 64000, 2, paramvrn.c);
      bbzp.a(BaseApplicationImpl.getContext(), (bbzm)localObject2, jdField_c_of_type_JavaLangString, new vqz(paramvrn, (String)localObject1), new bbzr(false, false, false, true, true, null));
      localObject1 = new Properties();
      ((Properties)localObject1).setProperty("bless_param_voice_id", "" + paramvrn.c);
      afbb.a("bless_event_voice_click", (Properties)localObject1);
    }
  }
  ...
  protected void b()
  {
    ...
    if (a((Object[])localObject))
    {
      ...
      if (localFile.exists()) {
        bbdj.a(localFile, new File((String)localObject));
      }
    }
  }
  ...
  public void c()
  {
    ...
    synchronized (this.jdField_c_of_type_JavaUtilArrayList)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (localbbzn.jdField_b_of_type_Int == 2)
        {
          vrn localvrn = new vrn(4, localbbzn.jdField_a_of_type_JavaLangString, localbbzn.jdField_a_of_type_Bbzo.jdField_a_of_type_Int, localbbzn.jdField_a_of_type_Int);
          if ((localbbzn.jdField_a_of_type_Bbzo.jdField_a_of_type_Int == 0) && (!TextUtils.isEmpty(localbbzn.jdField_a_of_type_Bbzo.jdField_a_of_type_JavaLangString))) {
            localvrn.g = (jdField_b_of_type_JavaLangString + localbbzn.jdField_a_of_type_Bbzo.jdField_a_of_type_JavaLangString.substring(localbbzn.jdField_a_of_type_Bbzo.jdField_a_of_type_JavaLangString.lastIndexOf("/") + 1));
          }
          this.jdField_c_of_type_JavaUtilArrayList.add(localvrn);
        }
      }
    }
