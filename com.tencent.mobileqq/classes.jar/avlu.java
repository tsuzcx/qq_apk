...
public class avlu
  extends ajus
{
  public avlu(PublicAcntSearchFragment paramPublicAcntSearchFragment) {}
  ...
  public void a(String paramString1, boolean paramBoolean1, String paramString2, byte[] paramArrayOfByte, boolean paramBoolean2, List<avom> paramList, long[] paramArrayOfLong, String paramString3, List<DynamicTabSearch.SubHotWord> paramList1, boolean paramBoolean3, String paramString4)
  {
    ...
    {
      paramString2 = (avom)paramString1.next();
      if (paramString2.a() == null) {
        break label1056;
      }
      long l3 = l1;
      if ((paramString2 instanceof avnk))
      {
        paramString3 = (avnk)paramString2;
        l3 = l1;
        if (l1 == -1L) {
          l3 = paramString3.a;
        }
    ...
    for (;;)
    {
      break label307;
      if (!paramBoolean1) {
        avwf.a("sub_result", "load_result", new String[] { this.a.jdField_c_of_type_JavaLangString, avwf.a(paramArrayOfLong), "", avwf.a("dynamic_tab_search.1", paramArrayOfLong) });
      }
      if (i == 0)
      {
        avwf.a("sub_result", "no_result", new String[] { this.a.jdField_c_of_type_JavaLangString, avwf.a(paramArrayOfLong), "", avwf.a("dynamic_tab_search.1", paramArrayOfLong) });
        ...
        paramString1 = avjb.a(paramList, paramBoolean1);
        if ((paramBoolean1) || (l1 != PublicAcntSearchFragment.a(this.a)) || (paramString1 == null) || (paramString1.size() <= 0) || (paramBoolean3)) {
          break label865;
        }
        paramString2 = (avol)this.a.jdField_c_of_type_JavaUtilList.get(this.a.jdField_c_of_type_JavaUtilList.size() - 1);
        if ((!(this.a.jdField_c_of_type_JavaUtilList.get(this.a.jdField_c_of_type_JavaUtilList.size() - 1) instanceof avpr)) || (!(paramString1.get(0) instanceof avnu))) {
        ...
        if (!((avol)paramString1.get(i) instanceof avnu)) {
          break label852;
        }
      }
      for (;;)
      {
        if ((paramString2 instanceof avon))
        {
          paramString2 = (avon)paramString2;
          j = paramString2.a();
          avwi.a(paramString2, j + i, j - 1);
        }
        for (;;)
        {
          int k = 0;
          for (;;)
          {
            if (k < i)
            {
              paramString2 = (avol)paramString1.get(k);
              if ((paramString2 instanceof avon)) {
                avwi.a((avon)paramString2, j + i, j + k);
              }
              k += 1;
              continue;
              if (!paramBoolean1) {
              ...
              avwf.a("sub_result", "exp_result", new String[] { this.a.jdField_c_of_type_JavaLangString, avwf.a(paramArrayOfLong), "", avwf.a("dynamic_tab_search.1", paramArrayOfLong) });
              break;
              label852:
              j = i;
              i += 1;
          ...
          for (;;)
          {
            ...
            {
              if ((this.a.jdField_c_of_type_JavaUtilList.get(i) instanceof avow)) {
                ((avow)this.a.jdField_c_of_type_JavaUtilList.get(i)).r = 0;
              }
              i += 1;
            }
            label949:
