  ...
  implements Manager
{
  ...
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new apoc(this);
  public awgf a;
  ...
  public apob(QQAppInterface paramQQAppInterface)
  {
  ...
  public List<EmoticonFromGroupEntity> a()
  {
    ...
    return this.jdField_a_of_type_Awgf.a(EmoticonFromGroupEntity.class);
  }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord instanceof MessageForPic)) {
      d(((bduj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a(paramMessageRecord));
    }
    for (;;)
    {
      ...
      if ((paramMessageRecord instanceof MessageForMixedMsg))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if ((localObject instanceof MessageForPic))
          {
            ...
            d(((bduj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a((MessageRecord)localObject));
          }
        }
      }
    }
    ...
    do
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localObject instanceof MessageForPic))
        {
          localObject = (MessageForPic)localObject;
          MessageForMixedMsg.copyBaseInfoFromMixedToPic((MessageForPic)localObject, paramMessageRecord);
          localObject = ((bduj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(235)).a.a((MessageRecord)localObject);
