  ...
  extends pxz
{
  ...
  public pxt(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qnd paramqnd, Handler paramHandler)
  {
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      i = qnf.a(paramFromServiceMsg, paramObject, paramToServiceMsg);
    ...
    bjda.a().post(new ReadInJoyDianDianEntranceModule.1(this, paramObject));
  }
  ...
  public void a()
  {
    ...
    localReqBody.uint32_req_recommend_flag.set(ocf.a());
    localReqBody.uint64_uin.set(pha.a());
    String str = (String)bmqa.a(tkg.f, "");
    if (!TextUtils.isEmpty(str)) {
      localReqBody.bytes_entrance_cookie.set(ByteStringMicro.copyFromUtf8(str));
    }
    a(qnf.a("OidbSvc.0x6cf", 1743, 1, localReqBody.toByteArray()));
  ...
  public void b(int paramInt)
  {
    ...
    localObject = qnf.a("OidbSvc.0xdcb", 3531, 0, ((oidb_cmd0xdcb.ReqBody)localObject).toByteArray());
