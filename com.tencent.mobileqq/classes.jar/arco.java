...
public class arco
  extends QIPCModule
{
  private static volatile arco jdField_a_of_type_Arco;
  ...
  private arco(String paramString)
  {
    super(paramString);
  }
  ...
  {
    if (jdField_a_of_type_Arco == null) {}
    try
    {
      if (jdField_a_of_type_Arco == null) {
        jdField_a_of_type_Arco = new arco("IdentificationIpcServer_Model");
      }
      return jdField_a_of_type_Arco;
    }
    finally {}
  }
  ...
  {
    return new arcq(this, paramFile, paramEIPCResult, paramQQAppInterface, paramInt2, paramInt3, paramInt1);
  }
  ...
  private void a(Bundle paramBundle)
  {
    ...
    axqw.b((QQAppInterface)localObject2, "dc00898", "", "", "0X80097EB", "0X80097EB", 0, 0, i + "", "" + k, j + "", "");
  ...
  private void a(Bundle paramBundle, int paramInt)
  {
    ...
    armm.a(paramBundle, str3, str4, i, AppSetting.a(), str2, str1, l, new arcp(this, localFaceDetectForThirdPartyManager, paramInt, paramBundle));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    bbdj.b(paramString3);
    arcr localarcr = new arcr(this, paramString3, paramString2, paramString1, paramInt);
    paramString3 = (aysv)paramQQAppInterface.getManager(21);
    paramString2 = paramString3;
    if (paramString3 == null) {
      paramString2 = new aysv();
    }
    paramQQAppInterface = paramString2.a(paramQQAppInterface, 0);
    paramString2 = new ayrv();
    paramString2.jdField_a_of_type_Aysa = localarcr;
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if (localSVConfigItem.name.startsWith("new_qq_android_native_short_new_other_"))
            {
              ...
              if (AppSetting.b)
              {
                ...
                QLog.d("qqidentification_server", 1, new Object[] { "no res,start download, localpath is", str, " version is : ", Integer.valueOf(i), " app so bits is : ", Integer.valueOf(arcm.b()) });
