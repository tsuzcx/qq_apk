    ...
    for (;;)
    {
      ...
      if (this.a.jdField_a_of_type_Ajyc != null)
      {
        ...
        if (this.a.jdField_a_of_type_Ajyc != null)
        {
          ...
          this.a.c = false;
          ajyx.a(this.a).setVisibility(8);
          ajyx.a(this.a, 0, null);
          this.a.jdField_a_of_type_Ajuv.a(ajyx.a(this.a), this.a.jdField_a_of_type_JavaLangString, this.a.jdField_a_of_type_Long);
          this.a.jdField_a_of_type_Ajuv.notifyDataSetChanged();
          this.a.b = 1;
        }
      }
    }
