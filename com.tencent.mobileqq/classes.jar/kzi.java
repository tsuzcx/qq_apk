...
public final class kzi
  implements Runnable
{
  public kzi(String paramString, int paramInt1, int paramInt2, Context paramContext, AdvertisementInfo paramAdvertisementInfo, VideoAdInfo paramVideoAdInfo, long paramLong, JSONObject paramJSONObject, AppInterface paramAppInterface) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      ((NewIntent)localObject2).setObserver(new kzj(this));
