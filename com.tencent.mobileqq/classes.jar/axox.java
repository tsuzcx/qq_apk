...
public class axox
  extends axou
{
  bess jdField_a_of_type_Bess = new bess();
  public RandomAccessFile a;
  ArrayList<axuh> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  public byte[] a;
  ...
  public axox(axos paramaxos, axvt paramaxvt)
  {
    ...
    c(paramaxvt.jdField_c_of_type_JavaLangString + paramaxvt.jdField_a_of_type_Long);
    this.jdField_c_of_type_Boolean = paramaxvt.jdField_e_of_type_Boolean;
  }
  ...
  protected axro a(byte[] paramArrayOfByte)
  {
    ...
    localaxro.jdField_a_of_type_JavaLangString = a(paramArrayOfByte);
    ...
    localaxro.jdField_k_of_type_Boolean = true;
    localaxro.jdField_a_of_type_JavaUtilHashMap.put("Range", "bytes=" + this.jdField_s_of_type_Long + "-");
  ...
  {
    if (paramLong1 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 1, paramInt, this.jdField_a_of_type_Axvt.jdField_a_of_type_Int, paramLong1);
    }
    if (paramLong2 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 1, paramInt, this.jdField_a_of_type_Axvt.jdField_a_of_type_Int, paramLong2);
    }
    if (paramLong3 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 0, paramInt, this.jdField_a_of_type_Axvt.jdField_a_of_type_Int, paramLong3);
    }
    if (paramLong4 != 0L) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.countFlow(true, 0, paramInt, this.jdField_a_of_type_Axvt.jdField_a_of_type_Int, paramLong4);
    }
  }
  ...
  public boolean j()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 131	axox:jdField_a_of_type_Axvt	Laxvt;
    //   4: getfield 304	axvt:i	Ljava/lang/String;
    //   7: astore 4
    //   9: new 306	java/io/FileInputStream
    //   12: dup
    //   13: aload 4
    //   15: invokespecial 308	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   18: astore_3
    //   19: aload_3
    //   20: astore_2
    //   21: aload_0
    //   22: aload_3
    //   23: aload_0
    //   24: getfield 311	axox:jdField_a_of_type_Axqf	Laxqf;
    //   27: getfield 314	axqf:jdField_a_of_type_Long	J
    //   30: invokestatic 320	com/tencent/qphone/base/util/MD5:toMD5Byte	(Ljava/io/InputStream;J)[B
    //   33: putfield 321	axox:jdField_a_of_type_ArrayOfByte	[B
    //   36: aload_3
    //   37: astore_2
    //   38: aload_0
    //   39: aload_0
    //   40: getfield 321	axox:jdField_a_of_type_ArrayOfByte	[B
    //   43: invokestatic 326	com/qq/taf/jce/HexUtil:bytes2HexStr	([B)Ljava/lang/String;
    //   46: putfield 328	axox:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   49: aload_3
    //   50: astore_2
    //   51: aload_0
    //   52: aload_0
    //   53: getfield 328	axox:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   56: putfield 329	axox:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   59: aload_3
    //   60: astore_2
    //   61: aload_0
    //   62: getfield 311	axox:jdField_a_of_type_Axqf	Laxqf;
    //   65: aload_0
    //   66: getfield 328	axox:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   69: putfield 331	axqf:f	Ljava/lang/String;
    //   72: aload_3
    //   73: astore_2
    //   74: aload_0
    ...
    //   82: aload_0
    //   83: getfield 328	axox:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   95: aload_0
    //   96: getfield 334	axox:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   105: putfield 328	axox:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    //   108: aload_3
    //   109: ifnull +7 -> 116
    //   112: aload_3
    //   113: invokevirtual 335	java/io/FileInputStream:close	()V
    //   116: iconst_1
    //   117: istore_1
    //   118: iload_1
    //   119: ireturn
    ...
    //   121: aload_3
    //   122: astore_2
    //   123: new 337	java/io/File
    //   126: dup
    //   127: aload 4
    //   129: invokespecial 338	java/io/File:<init>	(Ljava/lang/String;)V
    //   132: astore 4
    //   134: aload_3
    //   135: astore_2
    //   136: aload 4
    //   138: invokevirtual 341	java/io/File:exists	()Z
    //   141: istore_1
    //   142: iload_1
    //   143: ifeq -107 -> 36
    //   146: aload_3
    //   147: astore_2
    //   148: aload 4
    //   150: invokestatic 346	bech:a	(Ljava/io/File;)Ljava/lang/String;
    //   153: astore 4
    //   155: aload 4
    //   157: ifnull +17 -> 174
    //   160: aload_3
    ...
    //   162: aload_0
    //   163: aload 4
    //   165: invokestatic 350	com/qq/taf/jce/HexUtil:hexStr2Bytes	(Ljava/lang/String;)[B
    //   168: putfield 321	axox:jdField_a_of_type_ArrayOfByte	[B
    //   171: goto -135 -> 36
    //   174: ldc_w 269
    //   177: astore 4
    //   179: goto -19 -> 160
    //   182: astore_2
    //   183: aload_2
    //   184: invokevirtual 211	java/io/IOException:printStackTrace	()V
    //   187: goto -71 -> 116
    //   190: astore 4
    //   192: aconst_null
    //   193: astore_3
    ...
    //   196: aload_0
    //   197: aconst_null
    //   198: putfield 321	axox:jdField_a_of_type_ArrayOfByte	[B
    //   201: aload_3
    //   202: astore_2
    //   203: aload_0
    //   204: aload 4
    //   206: invokevirtual 208	axox:a	(Ljava/io/IOException;)V
    //   209: iconst_0
    //   210: istore_1
    //   211: aload_3
    //   212: ifnull -94 -> 118
    //   215: aload_3
    //   216: invokevirtual 335	java/io/FileInputStream:close	()V
    //   219: iconst_0
    //   220: ireturn
    //   221: astore_2
    //   222: aload_2
    //   223: invokevirtual 211	java/io/IOException:printStackTrace	()V
    //   226: iconst_0
    //   227: ireturn
    //   228: astore_3
    //   229: aconst_null
    ...
    //   232: ifnull +7 -> 239
    //   235: aload_2
    //   236: invokevirtual 335	java/io/FileInputStream:close	()V
    //   239: aload_3
    //   240: athrow
    //   241: astore_2
    //   242: aload_2
    //   243: invokevirtual 211	java/io/IOException:printStackTrace	()V
    //   246: goto -7 -> 239
    //   249: astore_3
    //   250: goto -19 -> 231
    //   253: astore 4
  ...
  protected void o()
  {
    try
    {
      ...
      {
        i = SessionInfo.getInstance(this.jdField_a_of_type_Axvt.jdField_b_of_type_JavaLangString).getHttpconn_sig_session().length;
        this.jdField_c_of_type_ArrayOfByte = new byte[i];
        System.arraycopy(SessionInfo.getInstance(this.jdField_a_of_type_Axvt.jdField_b_of_type_JavaLangString).getHttpconn_sig_session(), 0, this.jdField_c_of_type_ArrayOfByte, 0, i);
      }
      if (SessionInfo.getInstance(this.jdField_a_of_type_Axvt.jdField_b_of_type_JavaLangString).getSessionKey() != null)
      {
        i = SessionInfo.getInstance(this.jdField_a_of_type_Axvt.jdField_b_of_type_JavaLangString).getSessionKey().length;
        this.jdField_b_of_type_ArrayOfByte = new byte[i];
        System.arraycopy(SessionInfo.getInstance(this.jdField_a_of_type_Axvt.jdField_b_of_type_JavaLangString).getSessionKey(), 0, this.jdField_b_of_type_ArrayOfByte, 0, i);
      }
      return;
    }
    finally {}
