  ...
  implements asjg
{
  ...
  public asgq(Context paramContext, FullPopData paramFullPopData, String paramString1, String paramString2, boolean paramBoolean)
  {
    super(paramContext, paramFullPopData, paramString1, paramString2, paramBoolean);
    this.jdField_a_of_type_AndroidOsHandler = new asgr(this);
  }
  ...
  private void e()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqGamecenterDataFullPopData != null)
    {
      ...
      ((ObjectAnimator)localObject2).addListener(new asgs(this));
  ...
  private void f()
  {
    ...
    localObjectAnimator.addListener(new asgt(this));
  }
  ...
  private void g()
  {
    ...
    localScaleAnimation.setAnimationListener(new asgu(this));
  ...
  private void h()
  {
    ...
    this.d.bringToFront();
    this.d.setOnClickListener(new asgv(this));
  }
  ...
  private void i()
  {
    ...
    localScaleAnimation.setAnimationListener(new asgw(this));
