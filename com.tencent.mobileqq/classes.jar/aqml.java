...
public class aqml
{
  ...
  private aqml(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList)
  {
  ...
  private aqml(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, long paramLong)
  {
  ...
  private aqml(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2)
  {
    this(paramQQAppInterface, paramList);
  ...
  public static aqml a(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, long paramLong)
  {
    return new aqml(paramQQAppInterface, paramList, paramLong);
  }
  
  public static aqml a(QQAppInterface paramQQAppInterface, List<ContentProviderOperation> paramList, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2)
  {
    return new aqml(paramQQAppInterface, paramList, paramString1, paramString2, paramString3, paramString4, paramInt1, paramInt2);
  }
  ...
  public aqml a(String paramString)
  {
  ...
  public aqml a(String paramString, Uri paramUri)
  {
    this.jdField_a_of_type_AndroidContentContentValues.clear();
    this.jdField_a_of_type_AndroidContentContentValues.put("data1", paramString);
    a(paramUri);
  ...
  public aqml b(String paramString)
  {
    this.jdField_a_of_type_AndroidContentContentValues.clear();
    ...
    this.jdField_a_of_type_AndroidContentContentValues.put("data3", amtj.a(2131701655));
    a();
    return this;
  }
}
