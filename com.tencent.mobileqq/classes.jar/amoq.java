  ...
  extends ServerConfigObserver
{
  ...
  public void onGetPluginConfig(boolean paramBoolean, int paramInt, GetResourceRespV2 paramGetResourceRespV2)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        localObject1 = amop.a(this.a).getEntityManagerFactory().createEntityManager();
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          if (localGetResourceRespInfoV2.iPluginType == 32)
          {
            ...
            if (amox.a((aukn)localObject1, amop.a(this.a), localGetResourceRespInfoV2).cDefaultState != 0) {
              break label515;
            }
            paramInt = 1;
            i = 1;
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          {
            ResourcePluginInfo.remove((aukn)localObject1, localGetResourceRespInfoV2.strPkgName);
            i = 1;
          }
        }
        ...
        while (paramGetResourceRespV2.hasNext())
        {
          ...
          {
            amox.a((aukn)localObject1, amop.a(this.a), (GetResourceRespInfoV2)localObject2);
            i = 1;
          }
        }
        ((aukn)localObject1).a();
        ...
        if (i != 0)
        {
          paramGetResourceRespV2 = new ArrayList(amop.a(this.a)).iterator();
          while (paramGetResourceRespV2.hasNext())
          {
        ...
        label415:
        if (k >= amop.a(this.a).size()) {
          break;
        }
        try
        {
          ResourcePluginListener.a((ResourcePluginListener)amop.a(this.a).get(k), (byte)1, 2);
          label454:
          k += 1;
          break label415;
          while (paramInt < amop.a(this.a).size()) {
            try
            {
              ResourcePluginListener.a((ResourcePluginListener)amop.a(this.a).get(paramInt), (byte)-1, 2);
              label500:
              paramInt += 1;
            }
