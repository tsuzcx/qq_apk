  ...
  extends apld
{
  ...
  private apij jdField_a_of_type_Apij = new aplo(this);
  private apjj jdField_a_of_type_Apjj = new apjj(this.jdField_a_of_type_AndroidOsBundle);
  protected mps a;
  ...
  static
  {
    jdField_l_of_type_JavaLangString = ajjy.a(2131639007);
  }
  
  public apln(Intent paramIntent)
  {
    super(paramIntent);
    this.jdField_d_of_type_Long = -1L;
    this.jdField_b_of_type_AndroidOsHandler = new aplu(this);
    this.jdField_a_of_type_Mps = new aplw(this);
  }
  
  private void M()
  {
    QLog.d("ForwardOption.ForwardSdkShareOption", 1, "--> getAppInfoInBackground");
    String str = this.jdField_a_of_type_AndroidOsBundle.getString("pkg_name");
    apih.a(this.jdField_a_of_type_AndroidOsBundle.getString("open_id", ""), this.jdField_b_of_type_Long, str);
  }
  ...
  private void a(long paramLong, String paramString1, String paramString2, int paramInt, String paramString3, boolean paramBoolean)
  {
    ...
    if (i == 11)
    {
      ...
      {
        paramString1 = awup.a(str1);
        if (!TextUtils.isEmpty(paramString1)) {
          awqx.b(null, "CliOper", "", "", "0X8005F53", "0X8005F53", 0, 0, awup.a(paramInt) + "", "", paramString1, "");
        }
      }
    }
    paramString1 = awuw.a(this.jdField_a_of_type_AndroidOsBundle);
    if ((paramString1 != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
    {
      ...
      awqx.b(null, "dc00898", "", "", "0X8009C93", "0X8009C93", 0, 0, "", "4", str1, str2);
      ...
      paramString1 = aciy.a(localIntent, new int[] { 2 });
    ...
    for (;;)
    {
      ...
      break;
      label484:
      paramString1 = aciy.a(localIntent, null);
      paramString1.putExtra("share_from_aio", true);
    }
  }
  
  private void a(Bundle paramBundle, atqr paramatqr, String paramString1, String paramString2, String paramString3)
  {
    Object localObject;
    if ((paramatqr.jdField_a_of_type_JavaLangObject instanceof int[]))
    {
      int[] arrayOfInt = (int[])paramatqr.jdField_a_of_type_JavaLangObject;
      if (arrayOfInt.length == 5)
      {
        localObject = new oidb_cmd0xb77.ImageInfo();
        ((oidb_cmd0xb77.ImageInfo)localObject).md5.set(paramatqr.d);
        ((oidb_cmd0xb77.ImageInfo)localObject).uuid.set(paramatqr.c);
        ...
        ((oidb_cmd0xb77.ImageInfo)localObject).file_id.set((int)paramatqr.jdField_b_of_type_Long);
      }
    }
    for (paramatqr = (atqr)localObject;; paramatqr = null)
    {
      paramBundle = apmf.a(paramBundle, null, null, paramatqr);
      paramatqr = BaseApplicationImpl.getApplication().getRuntime();
      if (paramatqr == null)
      {
      ...
      apmt.a("KEY_STAGE_2_IMAGE_B77");
      mmj.a(paramatqr, new aplt(this, paramString2, paramString1, paramString3), paramBundle.toByteArray(), "OidbSvc.0xb77_9", 2935, 9, (Bundle)localObject, 0L);
      return;
    }
  }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    apjd.a().a(paramString2, paramString1);
  }
  ...
  private boolean a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    for (;;)
    {
      ...
      {
        awul localawul = (awul)paramAbsStructMsg.get(i);
        if (!(localawul instanceof awxe)) {
          break label95;
        }
        paramAbsStructMsg = (awxe)localawul;
        bool1 = bool2;
        if (paramAbsStructMsg.i != 1)
        {
          bool1 = bool2;
          if (paramAbsStructMsg.i != 3) {
            bool1 = true;
          }
        }
      }
  ...
  private boolean p()
  {
    ...
    apih localapih = ((aply)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(350)).a();
    if (this.jdField_a_of_type_AndroidOsBundle.getBoolean("use_d55_cache", false))
    {
      QLog.d("ForwardOption.ForwardSdkShareOption", 1, "--> use AppInfo cache");
      this.jdField_a_of_type_Aphd = localapih.a(this.jdField_b_of_type_Long);
      e();
      M();
      return false;
    }
    if (localapih.b(this.jdField_b_of_type_Long))
    {
      QLog.d("ForwardOption.ForwardSdkShareOption", 1, "--> isForbid");
      a(localapih.a(this.jdField_b_of_type_Long), true);
      return true;
    }
    if (localapih.c(this.jdField_b_of_type_Long))
    {
      QLog.d("ForwardOption.ForwardSdkShareOption", 1, "--> timeout");
      return false;
    }
    if (localapih.a(this.jdField_b_of_type_Long))
    {
    ...
    localapih.a(this.jdField_a_of_type_Apij);
    a(2131653054);
    return true;
  }
  ...
  protected void L()
  {
    ...
    awrn.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "", "multi_account", "push_login_window", 0, 1, 0);
    ...
    aplx localaplx = new aplx(this);
    this.jdField_b_of_type_Bafb.setNegativeButton(2131625035, localaplx);
    this.jdField_b_of_type_Bafb.setPositiveButton(2131653589, localaplx);
    this.jdField_b_of_type_Bafb.show();
  }
  ...
  public String a()
  {
    ...
    {
      str1 = str2;
      if (mpv.a(str2, "UTF-8") > 105) {
        str1 = mpv.a(str2, 105, "UTF-8", "...");
      }
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_Apjj.a(paramQQAppInterface, paramActivity);
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      ...
      H();
      if (bool2) {
        bcfn.a().a(0, "SHARE_CHECK_AGENT", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), String.valueOf(this.jdField_b_of_type_Long), null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, null);
      }
      try
      {
  ...
  protected boolean a(bafb parambafb)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg == null)
    {
      ...
      if (!AbsShareMsg.class.isInstance(localObject))
      {
        ...
        a(-1, ajjy.a(2131639004), ajjy.a(2131639031));
      }
    }
    try
    {
      bcfn.a().a(1, "SHARE_CHECK_AGENT", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), String.valueOf(this.jdField_b_of_type_Long), null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "类型错误");
      label145:
      return false;
      ...
      if (!this.jdField_a_of_type_AndroidOsBundle.getBoolean("key_sdk_share_pure_text"))
      {
        ...
        ((LinearLayout.LayoutParams)localObject).setMargins(aciy.a(-15.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, aciy.a(-15.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), aciy.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
        if (QLog.isColorLevel()) {
        ...
        parambafb.addView(this.jdField_a_of_type_Apll.a(), (LinearLayout.LayoutParams)localObject);
      ...
      for (;;)
      {
        ...
        parambafb.adjustMessageTopBottomMargin(0.0F, 0.0F);
        break;
        label400:
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForAudioShare))
        {
          ((LinearLayout.LayoutParams)localObject).setMargins(0, aciy.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, aciy.a(10.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
          break;
        }
        if (!(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare)) {
          break;
        }
        ((LinearLayout.LayoutParams)localObject).setMargins(aciy.a(-10.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, aciy.a(-7.5F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0);
        break;
        label490:
  ...
  protected boolean a(AbsStructMsg paramAbsStructMsg, String paramString1, int paramInt, String paramString2)
  {
    ...
    paramString1 = (ArkAppMessage)alej.a(2, paramString1, this.jdField_a_of_type_AndroidOsBundle, localObject1);
    ...
    for (;;)
    {
      ...
      for (paramString2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();; paramString2 = localSessionInfo.b)
      {
        ...
        paramString1.containStructMsg = awbi.a((QQAppInterface)localObject2, str1, str2, paramString2, paramInt, i, paramAbsStructMsg);
        if ((!TextUtils.isEmpty(((ArkAppMessage)localObject1).appName)) && (!TextUtils.isEmpty(((ArkAppMessage)localObject1).appView)) && (!TextUtils.isEmpty(((ArkAppMessage)localObject1).metaList))) {
          alep.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((ArkAppMessage)localObject1).appName, "AIOArkSdkSendMessage", 1, 0, 0L, 0L, 0L, ((ArkAppMessage)localObject1).appView, "");
        }
  ...
  public DeviceInfo[] a(DeviceInfo[] paramArrayOfDeviceInfo)
  {
    ...
    while (i < j)
    {
      ...
      {
        LightAppSettingInfo localLightAppSettingInfo = ((ydh)localObject).a(localDeviceInfo);
  ...
  public void b(int paramInt)
  {
    ...
    if (paramInt == k.intValue())
    {
      ...
      default: 
        ...
        localIntent.putExtra("dataline_forward_text", ajjy.a(2131639009));
      }
    }
    Bundle localBundle;
    for (;;)
    {
      ...
      localBundle.putLong("res_share_id", baak.a(this.jdField_b_of_type_Long));
      ...
      else
      {
        ...
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004931", "0X8004931", 0, 0, "", "", "", "");
        if (QLog.isColorLevel())
        {
    ...
    for (;;)
    {
      ...
      continue;
      label1246:
      localObject = this.jdField_a_of_type_Aphd.b();
      break label373;
      label1258:
      localObject = this.jdField_a_of_type_Aphd.a();
      break label397;
      label1270:
      localObject = this.jdField_a_of_type_Aphd.c();
      break label421;
      label1282:
      localObject = this.jdField_a_of_type_Aphd.d();
      break label445;
      label1294:
      localIntent.putExtras(localBundle);
  ...
  {
    if ((this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("qqfav_extra_from_sdk_share", false)) || (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("qqfav_extra_from_system_share", false))) {
      return this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131632361);
    }
  ...
  public void c()
  {
    ...
    if (!this.jdField_i_of_type_Boolean) {
      if ((!TextUtils.isEmpty(this.jdField_i_of_type_JavaLangString)) && (!this.jdField_i_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount())))
      {
        ...
        mpw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, null, "connect_sharepic", "pageview", this.jdField_b_of_type_Long, i, "");
        awrn.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "sha_pageview", 1, "", "", str2);
    ...
    for (;;)
    {
      bcad.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), this.jdField_h_of_type_JavaLangString, str2, "10", "11", "0", (String)localObject, "0", "0", false);
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005A0F", "0X8005A0F", 0, 0, "1", "", "", "");
      return;
      if (!TextUtils.isEmpty(this.jdField_h_of_type_JavaLangString))
      {
        ...
        for (;;)
        {
          try
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(l1, this.jdField_h_of_type_JavaLangString, this.jdField_b_of_type_Long, new aplv(this));
            i = 0;
          }
      ...
      break;
      label430:
      mpw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, null, "pageview", this.jdField_b_of_type_Long, i, "");
      break label155;
      label452:
      String str1;
  ...
  protected boolean c()
  {
    ...
    try
    {
      bcfn.a().a(0, "SHARE_TO_QQ", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), String.valueOf(this.jdField_b_of_type_Long), String.valueOf(i), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, null);
      label99:
      String str1;
      label111:
      String str2;
      ...
      if (this.jdField_c_of_type_Int == 1)
      {
        ...
        str2 = "1";
        bcad.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "", this.jdField_b_of_type_Long + "", "10", "12", "0", str1, str3, str2, false);
        if ((QSecFramework.a().a(1003).booleanValue()) && (this.jdField_c_of_type_Boolean))
        {
          ...
          if ((!TextUtils.isEmpty(str2)) && (!bbsv.a().a())) {
            bbsv.a().a(null, str2);
          }
          if (this.jdField_c_of_type_Int != 1) {
            break label386;
          }
          bbsv.a().a(2, str3, i, str1);
        }
      }
      for (;;)
      {
  ...
  protected int d()
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
        {
          ...
          localObject2 = bfid.a((StructMsgForImageShare)this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg);
          m = k;
          ArrayList localArrayList;
          if (localObject2 != null)
          {
            localArrayList = new ArrayList();
            localArrayList.add(((awwr)localObject2).S);
            m = a(localArrayList);
            if (m == 0) {
              break label357;
            }
        ...
        for (;;)
        {
          ...
          {
            break;
            if (!bfhl.a((ArrayList)localObject2, bool, this.jdField_a_of_type_AndroidContentIntent.getStringExtra("qqfav_extra_richmedia_title"), this.jdField_a_of_type_AndroidContentIntent.getStringExtra("qqfav_extra_mixed_msg"), true, this.jdField_b_of_type_Long, (String)localObject1).a(l2, str2).b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), -1, null)) {
              break label763;
            }
            k = 0;
            break label508;
            if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg != null)
            {
              ...
              i = 2;
              localObject1 = bfid.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.getXmlBytes());
              m = 0;
              if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForAudioShare))
              {
                m = 2;
    ...
    if (this.jdField_a_of_type_AndroidOsBundle.getBoolean("key_sdk_share_pure_text"))
    {
      ...
      if (TextUtils.isEmpty(this.jdField_a_of_type_AndroidOsBundle.getString("qqfav_extra_richmedia_title")))
      {
        ...
        if (!bfhl.a(null, false, this.jdField_a_of_type_AndroidOsBundle.getString("qqfav_extra_richmedia_title"), this.jdField_a_of_type_AndroidOsBundle.getString("qqfav_extra_mixed_msg"), true, this.jdField_b_of_type_Long, (String)localObject1).a(l2, str1).b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), -1, null)) {
          break label765;
        }
        i = 0;
        j = 0;
        ...
        i = m;
        if (k == 0) {
          bfhz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "User_AddFav", i, 0, 69, j, "", "");
        }
        return k;
      }
    }
  ...
  protected void d()
  {
    ...
    Object localObject2 = this.jdField_a_of_type_Bafb.getInputValue();
    ...
    boolean bool = awuw.a(this.jdField_a_of_type_AndroidOsBundle) instanceof StructMsgForImageShare;
    if (bool)
    {
      this.jdField_a_of_type_AndroidOsBundle.putString("share_comment_message", this.jdField_a_of_type_Bafb.getInputValue());
    ...
    if (f()) {
      if (TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        this.jdField_a_of_type_Apjj.a(b());
      }
    }
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("forward_mini_program_ark_from_sdk", false)) {
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009F7B", "0X8009F7B", 0, 0, "1", "", "", "");
      }
      return;
      localObject1 = "1";
      break;
      ...
      break label256;
      label339:
      this.jdField_j_of_type_JavaLangString = this.jdField_a_of_type_Bafb.getInputValue();
      super.d();
      continue;
      label357:
      ...
      else
      {
        ...
        {
          awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007C3A", "0X8007C3A", 0, 0, "2", "", "", "");
          ...
          ((Bundle)localObject1).putString("intext_1", "" + bcaj.a(this.jdField_c_of_type_Int));
          ((Bundle)localObject1).putString("intext_2", "" + bcaj.a(this.jdField_a_of_type_AndroidOsBundle.getInt("uintype"), this.jdField_a_of_type_AndroidOsBundle.getString("uin")));
          ((Bundle)localObject1).putString("intext_3", "0");
          bcad.a().a((Bundle)localObject1, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
        }
      }
    }
  }
  ...
  protected void d(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 0)
      {
        ...
        if (!bool) {
          bfid.a(this.jdField_a_of_type_AndroidAppActivity, 2131632448, 2);
        }
      }
      while (!bool)
      {
        ...
        localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131632447);
        ...
        localObject = str;
        if (TextUtils.isEmpty(str)) {
          localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131632439);
        }
        localObject = (String)localObject;
        localObject = babr.a(this.jdField_a_of_type_AndroidAppActivity, 230, this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131653616), this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131632441), (String)localObject, this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131629217), new aplp(this), new aplq(this));
        ((bafb)localObject).setOnDismissListener(new aplr(this));
        if (!this.jdField_a_of_type_AndroidAppActivity.isFinishing())
        {
          ...
          continue;
          if (2 == paramInt) {
            bfid.a(this.jdField_a_of_type_AndroidAppActivity, 2131629510, 1);
          } else if (3 == paramInt) {
            bfid.a(this.jdField_a_of_type_AndroidAppActivity, 2131632446, 1);
          } else {
            bfid.a(this.jdField_a_of_type_AndroidAppActivity, 2131632440, 1);
          }
        }
      }
    }
  ...
  protected boolean d()
  {
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        if (this.jdField_l_of_type_Boolean)
        {
          ...
          try
          {
            ...
            if ((this.jdField_a_of_type_Aphd == null) && (QLog.isColorLevel())) {
      ...
      if (this.jdField_a_of_type_Aphd == null)
      {
        ...
        apmt.a("KEY_GET_APP_INFO");
        xdt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.jdField_b_of_type_Long, str2, l1, this.jdField_a_of_type_MqqObserverBusinessObserver, str1);
        try
        {
          jdField_a_of_type_JavaLangObject.wait(20000L);
        }
  ...
  protected void r()
  {
    ...
    try
    {
      ...
      if ((!TextUtils.isEmpty(str1)) && (!TextUtils.isEmpty(str2)) && (!TextUtils.isEmpty((CharSequence)localObject))) {
        alep.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str1, "AIOArkSdkSendClosed", 1, 0, 0L, 0L, 0L, str2, "");
      }
      label95:
      if (f()) {
      ...
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007C3A", "0X8007C3A", 0, 0, "2", "", "", "");
      if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("forward_mini_program_ark_from_sdk", false)) {
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009F7B", "0X8009F7B", 0, 0, "2", "", "", "");
      }
      if ((this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("qqfav_extra_from_sdk_share", false)) || (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("qqfav_extra_from_system_share", false))) {
  ...
  {
    super.w();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Mps);
    if ((this.jdField_a_of_type_Xfc != null) && (this.jdField_a_of_type_Xfc.isShowing())) {
      this.jdField_a_of_type_Xfc.dismiss();
    }
    if ((this.jdField_b_of_type_Xfc != null) && (this.jdField_b_of_type_Xfc.isShowing())) {
      this.jdField_b_of_type_Xfc.dismiss();
    }
  ...
  protected void y()
  {
    AbsStructMsg localAbsStructMsg = awuw.a(this.jdField_a_of_type_AndroidOsBundle);
    if (localAbsStructMsg != null) {
      ((xvq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(49)).a().a(this.jdField_a_of_type_AndroidOsBundle.getString("uin"), localAbsStructMsg);
    }
  ...
  public void z()
  {
    ...
    localBundle.putString("text_filter_default_screen_touch_tips", ajjy.a(2131639020));
    localvjq.a(this.jdField_a_of_type_AndroidAppActivity, localBundle, 20004);
    this.jdField_a_of_type_AndroidAppActivity.overridePendingTransition(2130772217, 2130772038);
    urp.a("share", "clk_videoclips", 0, 0, new String[0]);
  }
}
