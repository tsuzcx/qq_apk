...
public class aogq
{
  ...
  public aogq(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = paramMessageRecord;
    this.jdField_a_of_type_Boolean = paramQQAppInterface.isRingerSilent();
    this.b = bgzw.a(paramQQAppInterface.getApp().getApplicationContext(), paramQQAppInterface);
    this.c = b(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
    this.d = bgzw.b(paramQQAppInterface.getApp().getApplicationContext(), paramQQAppInterface);
  ...
  private void a(int paramInt)
  {
    ...
    while (j < k)
    {
      ((aogp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.vibrateListenerList.get(j)).b(paramInt);
      j += 1;
    }
  }
  ...
  private void a(MessageRecord paramMessageRecord)
  {
    ...
    for (int j = 0;; j = localAudioManager.getStreamVolume(2))
    {
      ...
      if (localaqne != null)
      {
        if (!aqne.a(paramMessageRecord)) {
          break;
        }
        localaqne.b(paramMessageRecord);
      }
      return;
    }
    localaqne.b();
  ...
  public static boolean a(int paramInt, QQMessageFacade.Message paramMessage, boolean paramBoolean)
  {
    boolean bool3 = true;
  ...
  private void c(MessageRecord paramMessageRecord, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    boolean bool1;
    boolean bool2;
    if ((paramMessageRecord != null) && (localaqne != null))
    {
      boolean bool3 = localaqne.b(paramMessageRecord.frienduin, paramMessageRecord.istroop);
      boolean bool4 = localaqne.a(paramMessageRecord.senderuin);
      bool1 = bool4;
      bool2 = bool3;
      if (QLog.isColorLevel())
      {
    ...
    for (;;)
    {
      ...
      if (((paramBoolean1) && (bool2) && (bool1)) || ((bhsv.a(paramMessageRecord)) && (localaqne != null))) {
        localaqne.b(paramMessageRecord);
      }
      return;
      bool1 = false;
  ...
  void a(MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    if (localaqne != null)
    {
      ...
      if (paramMessageRecord != null) {
        bool1 = localaqne.b(this.h, paramMessageRecord.frienduin, paramMessageRecord.istroop);
      }
    }
    if (QLog.isColorLevel()) {
  ...
  void a(MessageRecord paramMessageRecord, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localObject = aqne.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    ...
    if (localObject != null)
    {
      bool1 = bool2;
      if (paramMessageRecord != null) {
        bool1 = ((aqne)localObject).a(this.i, paramMessageRecord.frienduin, paramMessageRecord.istroop);
      }
    }
    ...
    if (paramMessageRecord != null)
    {
      ...
      if (paramMessageRecord.istroop == 1001)
      {
        ...
        if (!aryo.b(paramMessageRecord))
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.e("SpecialCare", 2, "message.istroop = " + paramMessageRecord.istroop + " MsgBoxUtil.shouldInMsgBox(message) = " + aryo.b(paramMessageRecord));
            }
  ...
  public void b(MessageRecord paramMessageRecord, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    boolean bool2 = a(bhhi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
  ...
  {
    awxj localawxj = (awxj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.NEW_MSG_NOTIFICATION_MANAGER);
    if (localawxj != null) {
      return localawxj.a(paramMessageRecord);
    }
    return true;
  }
