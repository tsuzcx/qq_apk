...
public class aqjp
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bigv.a(antf.ba + ".Rock/");
  }
  ...
  public static EntityManager a()
  {
    if (jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager == null) {
      jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = new aqjw().createEntityManager();
    }
  ...
  public static void a(RockDownloaderTask paramRockDownloaderTask)
  {
    ...
    NewIntent localNewIntent = new NewIntent(paramRockDownloaderTask.getRuntime().getApplication(), aqjv.class);
    ...
    localNewIntent.setObserver(new aqjq(paramRockDownloaderTask));
  ...
  private static void b(RockDownloaderTask paramRockDownloaderTask, DownloadInfo paramDownloadInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((bool1) && (bool2))
      {
        ...
        localObject = (DownloadInfo)bjsz.a().a().remove(paramDownloadInfo.jdField_b_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
  ...
  private static void b(@NonNull RockDownloaderTask paramRockDownloaderTask, String paramString)
  {
    ...
    if (localObject != null)
    {
      localStringBuilder.append(((RockDownloadInfo)localObject).getBusinessName()).append("&").append(((RockDownloadInfo)localObject).getBusinessScene()).append("&").append(((RockDownloadInfo)localObject).getPackageName()).append("&").append(blhc.a("0"));
      ...
      localHashMap.put("IMEI", blhc.a("0"));
    ...
    try
    {
      ...
      {
        bdll.b((QQAppInterface)paramRockDownloaderTask.getRuntime(), "dc00898", "", ((QQAppInterface)paramRockDownloaderTask.getRuntime()).c(), paramString, paramString, 1, 1, "", "", localStringBuilder.toString(), "");
        bdmc.a(((QQAppInterface)paramRockDownloaderTask.getRuntime()).getApp()).a(((QQAppInterface)paramRockDownloaderTask.getRuntime()).c(), "RockDownloader", true, 0L, 0L, localHashMap, "");
      }
      for (;;)
      {
        if (!QLog.isColorLevel()) {
        ...
        bdll.b(null, "dc00898", "", paramRockDownloaderTask.getRuntime().getAccount(), paramString, paramString, 1, 1, "", "", localStringBuilder.toString(), "");
        bdmc.a(paramRockDownloaderTask.getRuntime().getApplication()).a(paramRockDownloaderTask.getRuntime().getAccount(), "RockDownloader", true, 0L, 0L, localHashMap, "");
      }
    }
    catch (Throwable paramRockDownloaderTask)
    {
      for (;;)
      {
        if (QLog.isColorLevel())
        {
          ...
          continue;
          bdll.b(null, "dc00898", "", "", paramString, paramString, 1, 1, "", "", localStringBuilder.toString(), "");
          bdmc.a(BaseApplicationImpl.context).a("", "RockDownloader", true, 0L, 0L, localHashMap, "");
        }
      }
  ...
  private static void b(DownloadInfo paramDownloadInfo, int paramInt1, String paramString, int paramInt2, boolean paramBoolean, RockDownloaderTask paramRockDownloaderTask)
  {
    ...
    if (paramBoolean)
    {
      ...
      paramRockDownloaderTask.getRockDownloadListener().onDownloadFail(paramRockDownloaderTask.getDownloadInfo(), anzj.a(2131712374), 10010);
    }
    for (;;)
    {
      paramRockDownloaderTask.getRockDownloadListener().onDownloadFinish(paramRockDownloaderTask.getDownloadInfo());
      paramString = (DownloadInfo)bjsz.a().a().remove(paramDownloadInfo.jdField_b_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
  ...
  private static void d(RockDownloaderTask paramRockDownloaderTask)
  {
    ...
    {
      localaqjr = new aqjr(paramRockDownloaderTask, bool);
      Iterator localIterator = bjsz.a().a().values().iterator();
      ...
      bjsz.a().b(localDownloadInfo1);
      if (bool)
      {
        paramRockDownloaderTask.getRockDownloadListener().onDownloadFail(paramRockDownloaderTask.getDownloadInfo(), anzj.a(2131712371), 10011);
        paramRockDownloaderTask.getRockDownloadListener().onDownloadFinish(paramRockDownloaderTask.getDownloadInfo());
      }
      return;
    }
  ...
  {
    Object localObject = new NewIntent(paramRockDownloaderTask.getRuntime().getApplication(), aqjv.class);
