...
public class vty
  extends Handler
{
  public vty(QRLoginAuthActivity paramQRLoginAuthActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (this.a.jdField_b_of_type_Int == 77313)
      {
        label263:
        this.a.c = "Windows";
        this.a.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.a.getResources().getDrawable(2130845898));
        this.a.jdField_a_of_type_AndroidWidgetTextView.setText(this.a.getString(2131651419, new Object[] { this.a.c }));
        if (TextUtils.isEmpty(this.a.d)) {
          this.a.d = this.a.getString(2131654751);
        }
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(this.a.getString(2131651425, new Object[] { this.a.d }));
        if (!this.a.jdField_a_of_type_Boolean) {
          break label958;
        }
        this.a.jdField_b_of_type_AndroidWidgetButton.setVisibility(0);
        label410:
        awqx.b(null, "dc00898", "", "", "0X800A46D", "0X800A46D", vvn.a(this.a.jdField_b_of_type_Int), 0, "", "", "", "");
        return;
        if (k == 32) {
          i = j;
        }
      ...
      for (;;)
      {
        ...
        {
          this.a.c = "Mac";
          this.a.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.a.getResources().getDrawable(2130845896));
          break;
        }
        if (this.a.jdField_b_of_type_Int == 3)
        {
          this.a.c = "iPad";
          this.a.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.a.getResources().getDrawable(2130845895));
          break;
        }
        if (vvn.b(this.a.jdField_b_of_type_Int))
        {
          this.a.c = ajjy.a(2131645412);
          this.a.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(this.a.getResources().getDrawable(2130845897));
          break;
        }
        this.a.c = ajjy.a(2131645413);
        ...
        for (;;)
        {
          try
          {
            ...
            if (this.a.jdField_a_of_type_Bbms.isShowing()) {
