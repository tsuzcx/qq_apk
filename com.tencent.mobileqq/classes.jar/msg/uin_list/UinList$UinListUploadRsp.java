  ...
  extends MessageMicro<UinListUploadRsp>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24 }, new String[] { "int32_result", "bytes_store_key", "silence_period" }, new Object[] { localInteger, localByteStringMicro, localInteger }, UinListUploadRsp.class);
  }
}
