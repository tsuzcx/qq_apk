  ...
  extends MessageMicro<msg>
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 24, 32, 40, 50, 56, 64 }, new String[] { "version", "result", "uin", "time", "number", "text", "touin_count", "touin_list" }, new Object[] { localInteger, localInteger, localLong, localLong, localInteger, localByteStringMicro, localInteger, localLong }, msg.class);
  }
}
