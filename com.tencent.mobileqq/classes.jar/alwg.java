  ...
  implements ambn
{
  ...
  private alwm jdField_a_of_type_Alwm = new alwi(this);
  private alwn jdField_a_of_type_Alwn;
  private alwo jdField_a_of_type_Alwo;
  Context jdField_a_of_type_AndroidContentContext;
  Handler jdField_a_of_type_AndroidOsHandler = new Handler(new alwh(this));
  private bcwn jdField_a_of_type_Bcwn = new alwj(this);
  blmh jdField_a_of_type_Blmh = new alwk(this);
  ...
  public alwg(AppInterface paramAppInterface, Context paramContext, ArrayList<PtvTemplateManager.PtvTemplateInfo> paramArrayList, int paramInt, HorizontalListView paramHorizontalListView, FSurfaceViewLayout paramFSurfaceViewLayout)
  {
    ...
    ambk.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface).a(this);
  }
  ...
  {
    PtvTemplateManager.PtvTemplateInfo localPtvTemplateInfo;
    if ((!bhsr.a(this.jdField_a_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewFSurfaceViewLayout != null))
    {
  ...
  {
    this.jdField_a_of_type_Alwn = paramalwn;
  }
  
  public void a(alwo paramalwo)
  {
    this.jdField_a_of_type_Alwo = paramalwo;
  }
  ...
  public void a(PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Alwo != null) {
        this.jdField_a_of_type_Alwo.c(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.type);
      }
    ...
    ambk.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface).a(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo);
    ...
    {
      alug.a("", "0X80075BA", paramPtvTemplateInfo, this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id, "", "");
      if (!this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.hasGesture()) {
        break;
      }
      alug.a("", "0X80083AE", paramPtvTemplateInfo, this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id, "", "");
      return;
      ...
      this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo, this.jdField_a_of_type_Bcwn);
      this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.downloading = true;
      alxb.a("shortvideo_download_effects", null);
      break label271;
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    ambk.a("lbsUpdateFilter", String.format("currentPath=%s,name=%s", new Object[] { "" + this.jdField_a_of_type_JavaLangString, "" + paramString }), null);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ((PtvTemplateItemView)localObject).a(paramInt, (PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt), this.jdField_a_of_type_Alwm);
      break;
