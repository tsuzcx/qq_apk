...
public class azmg
  extends alpd
{
  baot jdField_a_of_type_Baot = new azmh(this);
  ...
  baot jdField_b_of_type_Baot = new azmi(this);
  ...
  public azmg(QQAppInterface paramQQAppInterface)
  {
  ...
  private boolean a(boolean paramBoolean1, String paramString1, boolean paramBoolean2, boolean paramBoolean3, String paramString2)
  {
    ...
    String str = ThemeUtil.getUserCurrentThemeId(this.app);
    Object localObject1 = baos.a(this.app).getString("themeID");
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (paramBoolean1) {}
        for (paramString2 = this.jdField_b_of_type_Baot;; paramString2 = this.jdField_a_of_type_Baot) {
    ...
    for (StringBuilder localStringBuilder = new StringBuilder(1024);; localStringBuilder = null)
    {
      ...
      if (i != 0)
      {
        ...
        if ((paramToServiceMsg != null) && (paramToServiceMsg.uint32_result.has()) && (paramToServiceMsg.uint32_result.get() == 0)) {
          if ((paramToServiceMsg.bytes_bodybuffer.has()) && (paramToServiceMsg.bytes_bodybuffer.get() != null))
          {
            l2 = bdeu.a(ByteBuffer.wrap(paramToServiceMsg.bytes_bodybuffer.get().toByteArray()).getInt());
            ...
            if (bool2)
            {
              babd.a(bool5, this.app);
              azmk.a(this.app.getCurrentAccountUin(), bool3, 3);
              azmk.a(this.app.getCurrentAccountUin(), j, 3);
              bool1 = bool2;
            }
            if ((QLog.isColorLevel()) && (localStringBuilder != null)) {
            ...
            if (l1 == this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicLong.get())
            {
              ...
              bool2 = a(false, "211", azmk.b(), true, azmf.jdField_b_of_type_ArrayOfJavaLangString[azmk.c()]);
              if (!bool2) {
  ...
  {
    paramInt = azmf.jdField_b_of_type_ArrayOfInt[paramInt];
    ...
    for (;;)
    {
      ...
      localByteBuffer.putInt(bdeu.a(l2)).put((byte)0).putShort((short)3).putShort((short)-23251).putShort((short)2).putShort(s1).putShort((short)-23238).putShort((short)2).putShort((short)paramInt).putShort((short)-23174).putShort((short)2).putShort(s2);
  ...
  public boolean a(boolean paramBoolean, int paramInt)
  {
    ...
    boolean bool2 = a(paramBoolean, azmf.jdField_b_of_type_ArrayOfJavaLangString[paramInt]);
    if (bool2) {}
    for (boolean bool1 = a(false, "212", paramBoolean, true, azmf.jdField_b_of_type_ArrayOfJavaLangString[paramInt]);; bool1 = false)
    {
      if (QLog.isColorLevel()) {
  ...
  public boolean a(boolean paramBoolean1, int paramInt, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    Object localObject = azmf.jdField_b_of_type_ArrayOfJavaLangString[paramInt];
    ...
    {
      return bool;
      long l = ((azmg)this.app.a(154)).a(paramBoolean1, paramInt, paramBoolean2, paramBoolean3);
