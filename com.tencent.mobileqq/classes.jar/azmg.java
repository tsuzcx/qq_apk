...
public final class azmg
  implements avtl
{
  public azmg(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt, String paramString, HashMap paramHashMap) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      if ((paramArrayOfByte.app_type.get() <= 0) || (paramArrayOfByte.is_group_member.get() != 0))
      {
        ...
        paramInt = 1;
        paramBundle = new ayqs().a("QQ_chatroom_surface").b("click_entrance").a(paramInt).d(String.valueOf(bool));
