...
public class azmg
{
  ...
  private static azmi jdField_a_of_type_Azmi = new azmi();
  ...
  public static int a()
  {
    ...
    if (!((aluw)((AppRuntime)localObject).getManager(56)).a(Long.valueOf(Long.parseLong("2290230341"))))
    {
      if (QLog.isColorLevel()) {
  ...
  {
    bjmn.a().a(new azmh(paramQQAppInterface));
  ...
  public static void a(QQAppInterface paramQQAppInterface, ConfigurationService.Config paramConfig, int paramInt, String paramString)
  {
    ...
    int j = bdiv.a(paramQQAppInterface.getApp(), "qzone_xp_config_version", paramString);
    if (QLog.isColorLevel()) {
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        try
        {
          ...
          bdiv.a(paramQQAppInterface.getApp(), "qzone_xp_config_version", paramString, i);
          return;
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    NewIntent localNewIntent = new NewIntent(BaseApplicationImpl.getApplication(), ayxw.class);
    ...
    for (String str = "1";; str = "0")
    {
      ...
      BaseApplicationImpl.getApplication().getRuntime().registObserver(jdField_a_of_type_Azmi);
      BaseApplicationImpl.getApplication().getRuntime().startServlet(localNewIntent);
      azmj.b(paramQQAppInterface, "CliOper", "", "", "0X800915C", "0X800915C", 0, 0, "", "", "", "");
      return;
    }
  }
}
