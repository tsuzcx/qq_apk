...
public class bmpa
{
  ...
  public static Drawable a(int paramInt1, int paramInt2, bmpe parambmpe)
  {
    if (a.containsKey(Integer.valueOf(paramInt1))) {
      return bmpb.a().a("https://qzonestyle.gtimg.cn/qzone/qzact/act/external/qzone_vip_icon/qzone_yellow_icon_v8.zip", paramInt2, (String)a.get(Integer.valueOf(paramInt1)), parambmpe);
    }
    switch (paramInt1)
    {
    default: 
    ...
    return BaseApplicationImpl.getContext().getResources().getDrawable(2130849321);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, bmpe parambmpe)
  {
    return a(paramString, paramInt1, paramInt2, paramInt3, parambmpe, 0);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, bmpe parambmpe, int paramInt4)
  {
    switch (paramInt4)
    {
    }
    ...
    {
      return null;
      bmpb.a().a(paramString, paramInt1, "border", parambmpe);
      continue;
      switch (paramInt3)
      {
      }
    }
    return bmpb.a().a(paramString, paramInt1, "head", parambmpe);
    return bmpb.a().a(paramString, paramInt1, "bottom_lv" + paramInt2, parambmpe);
    return bmpb.a().a(paramString, paramInt1, "right", parambmpe);
  }
  
  public static Drawable a(String paramString, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4, bmpe parambmpe)
  {
    String str = a(paramInt1, paramInt3, paramBoolean, paramInt4);
    if (!TextUtils.isEmpty(str)) {
      return bmpb.a().a(paramString, paramInt2, str, true, parambmpe);
    }
    return null;
  }
