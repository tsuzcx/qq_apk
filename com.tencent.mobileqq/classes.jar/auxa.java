...
public class auxa
  implements aakw
{
  public auxa(NearbyHybridFragment paramNearbyHybridFragment) {}
  ...
  public void a()
  {
    ...
    {
      if (localSosoLbsInfo != null) {
        ((anzr)this.a.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.a(axoc.c)).a((float)localSosoLbsInfo.mLocation.mLon02, (float)localSosoLbsInfo.mLocation.mLat02, 5);
      }
