  ...
  extends BusinessHandler
{
  ...
  public auxa(QQAppInterface paramQQAppInterface)
  {
              ...
              if (paramFromServiceMsg.has())
              {
                ...
                if (paramFromServiceMsg.res_id.has())
                {
                  ...
                  for (;;)
                  {
                    ...
                    amuz localamuz = new amuz();
                    localamuz.jdField_a_of_type_Long = ((Integer)paramFromServiceMsg.get(i2)).intValue();
                    localamuz.jdField_a_of_type_Int = i1;
                    m += 1;
                    localamuz.b = m;
                    ((List)localObject).add(localamuz);
                    i2 += 1;
                  }
                  localObject = null;
                  break;
  ...
  public void a(ArrayList<BusinessInfoCheckUpdate.AppSetting> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      localBatchSetSettingReqBody.sClientVer.set("8.4.8.4810");
  ...
  public void a(List<Integer> paramList, long paramLong, int paramInt, StringBuilder paramStringBuilder)
  {
    ...
    do
    {
      ...
      if (paramLong >= l)
      {
        ...
        amvb.a(localSharedPreferences, (List)localObject, Long.valueOf(paramLong), paramInt);
        paramStringBuilder.append(" saveUserSortInfo");
        return;
      }
      paramList = amvb.a(this.app, paramInt);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (short s = 1;; s = 0)
    {
      for (;;)
      {
        ((ByteBuffer)localObject2).putInt(bftf.a(l1)).put((byte)0).putShort((short)1).putShort((short)-23054).putShort((short)2).putShort(s);
      ...
      try
      {
        ...
        if (paramFromServiceMsg.uint32_result.get() == 0)
        {
          ...
          if (i == 1)
          {
            ...
            {
              i = 2;
              amvb.b(paramFromServiceMsg, i);
              boolean bool3 = amvb.a(amvb.d(this.app));
