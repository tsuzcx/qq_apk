...
public class baoa
{
  ...
  public baoa()
  {
    if ((this.jdField_a_of_type_Bhik == null) || (this.jdField_a_of_type_Bhik.a))
    {
  ...
  private byte[] a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 34	baoa:jdField_b_of_type_JavaUtilQueue	Ljava/util/Queue;
    ...
    //   19: astore_1
    //   20: aload_0
    //   21: getfield 29	baoa:jdField_a_of_type_JavaUtilSet	Ljava/util/Set;
    //   24: aload_1
    ...
    //   34: areturn
    //   35: aload_0
    //   36: getfield 34	baoa:jdField_b_of_type_JavaUtilQueue	Ljava/util/Queue;
  ...
  {
    WXVadData localWXVadData = this.jdField_a_of_type_Bhik.a(paramArrayOfByte);
    ArrayList localArrayList = new ArrayList();
    if (localWXVadData == null)
    {
      bakl.a("HelloQQWake", "vadOnlineProcess isError ");
    ...
    for (;;)
    {
      bakl.a("HelloQQWake", "status：" + this.c + ",preStatus:" + i + ",nextCount:" + this.d + ",onlinePreData.size:" + this.jdField_a_of_type_JavaUtilQueue.size() + ",outData.size:" + localArrayList.size());
      return localArrayList;
      this.d = 0;
      break;
