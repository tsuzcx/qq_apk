...
{
  private static HashMap<String, aunt> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private long jdField_a_of_type_Long;
  private Context jdField_a_of_type_AndroidContentContext;
  private aumd jdField_a_of_type_Aumd = new aumd();
  private auog jdField_a_of_type_Auog;
  private auoi jdField_a_of_type_Auoi = new aunu(this);
  private IVPluginDataReporter jdField_a_of_type_ComTencentMobileqqIntervideoGroupvideoIVPluginDataReporter;
  private String jdField_a_of_type_JavaLangString;
  private List<aunw> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  private aunt(Context paramContext, String paramString1, String paramString2)
  {
    ...
    this.jdField_a_of_type_Auog = auog.a(paramContext, paramString1, paramString2);
  }
  
  public static aunt a(Context paramContext, String paramString1, String paramString2)
  {
    try
    {
      String str = paramString2 + paramString1;
      aunt localaunt2 = (aunt)jdField_a_of_type_JavaUtilHashMap.get(str);
      aunt localaunt1 = localaunt2;
      if (localaunt2 == null)
      {
        localaunt1 = new aunt(paramContext, paramString1, paramString2);
        jdField_a_of_type_JavaUtilHashMap.put(str, localaunt1);
      }
      return localaunt1;
    }
    finally {}
  ...
  private void a(InstalledPlugin paramInstalledPlugin, boolean paramBoolean, long paramLong)
  {
    ...
    paramInstalledPlugin = new aunw(this, this.d, localIVPluginInfo, paramInstalledPlugin, paramBoolean, paramLong);
    this.jdField_a_of_type_JavaUtilList.add(paramInstalledPlugin);
    if (localIVPluginInfo.jdField_a_of_type_Int == 1)
    {
      this.jdField_a_of_type_Long = System.currentTimeMillis();
      this.jdField_a_of_type_Aumd.a(this.jdField_a_of_type_JavaLangString, localIVPluginInfo.jdField_a_of_type_JavaLangString, localIVPluginInfo.c, localIVPluginInfo.jdField_b_of_type_JavaLangString, paramInstalledPlugin, true, localIVPluginInfo.k);
    }
    ...
    this.jdField_a_of_type_Aumd.a(localAppInterface, localIVPluginInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_AndroidContentContext, localIVPluginInfo.jdField_b_of_type_JavaLangString, paramInstalledPlugin);
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, Map<String, IVPluginInfo> paramMap)
  {
    ...
    this.jdField_a_of_type_Auog.jdField_a_of_type_JavaLangString = paramString2;
    if (!paramString2.equals(this.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_Aumd.a();
    }
    auoj.jdField_a_of_type_Boolean = TextUtils.equals(paramString1, "hy_sixgod");
    ...
    this.jdField_a_of_type_JavaUtilList.clear();
    this.jdField_a_of_type_Auog.a(this.jdField_a_of_type_Auoi);
    this.jdField_a_of_type_Auog.a(paramString1, paramString4, this.d, paramMap);
  }
  ...
  public void onKillPluginProcess()
  {
    ...
    if (Looper.myLooper() == Looper.getMainLooper()) {
      throw new RuntimeException(amtj.a(2131704759));
    }
    ...
    this.jdField_a_of_type_AndroidContentContext.bindService(localIntent, new aunv(this, localCountDownLatch), 1);
    for (;;)
    {
      try
      {
