  ...
  extends ayod
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ayop.class.getSimpleName();
  }
  
  public ayop(String paramString, long paramLong, List<String> paramList, UnifySearchCommon.ResultItem paramResultItem, int paramInt)
  {
    super(paramString, paramLong, paramList, paramResultItem, paramInt);
  }
  
  public ayop(String paramString, long paramLong, List<String> paramList, DynamicSearch.ResultItem paramResultItem, int paramInt)
  {
    super(paramString, paramLong, paramList, paramResultItem, paramInt);
  }
        ...
        while (i < paramString.length())
        {
          ...
          if (localObject2 != null)
          {
            ...
            while (m < ((JSONArray)localObject2).length())
            {
              ...
              localArrayList.add(new aynw(localJSONObject.optString("url"), localJSONObject.optInt("type")));
              m += 1;
            }
          }
          localObject1 = new aylv((String)localObject1, str1, str2, str3, n, localArrayList);
