...
public class basj
{
  ...
  private static HashMap<String, bask> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public static basp a(String paramString)
  {
    ...
    localbasp.jdField_a_of_type_JavaLangString = paramString[0];
    if (paramString.length == 2)
    {
      localbasp.jdField_a_of_type_Int = Integer.valueOf(paramString[1]).intValue();
      return localbasp;
    }
    localbasp.jdField_a_of_type_Int = 80;
    return localbasp;
  }
  ...
  public static String a()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 107	basj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   6: ifnull +12 -> 18
    //   9: getstatic 107	basj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   12: astore_0
    //   13: ldc 2
    //   15: monitorexit
    //   16: aload_0
    //   17: areturn
    //   18: ldc 109
    //   20: putstatic 107	basj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   69: putstatic 107	basj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   72: getstatic 107	basj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   75: astore_0
    //   76: goto -63 -> 13
    //   79: astore_0
    //   80: ldc 109
    //   82: putstatic 107	basj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   85: aload_0
    ...
    synchronized (jdField_a_of_type_JavaUtilHashMap)
    {
      ...
      if ((paramInt2 < 2) || (jdField_a_of_type_JavaUtilRandom.nextInt(paramInt2) == 1) || (b())) {
        synchronized (jdField_a_of_type_JavaUtilHashMap)
        {
          ...
          jdField_a_of_type_JavaUtilHashMap.put(paramString, new bask(paramInt1, paramArrayOfString));
  ...
  public static void a(String paramString1, boolean paramBoolean, String paramString2)
  {
    synchronized (jdField_a_of_type_JavaUtilHashMap)
    {
      if (jdField_a_of_type_JavaUtilHashMap.containsKey(paramString1))
      {
        ...
        bask localbask = (bask)jdField_a_of_type_JavaUtilHashMap.remove(paramString1);
        if (localbask != null)
        {
          ...
          if (paramString1 != null)
          {
            ...
            QLog.endColorLog(localbask.jdField_a_of_type_ArrayOfJavaLangString, localbask.jdField_a_of_type_Int, paramBoolean, paramString2, str, paramString1);
          }
        }
  ...
  private static boolean b()
  {
    ...
    {
      String str = bdhy.a(ServerConfigManager.ConfigType.app, "active_log_upload");
