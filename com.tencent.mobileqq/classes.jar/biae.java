  ...
  extends ahmp
{
  ...
  public biae(tAdvDesc paramtAdvDesc)
  {
    super(paramtAdvDesc);
  }
  ...
  protected void a()
  {
    ...
    catch (Exception localException)
    {
      ...
      bhku.a().a(2741, this.a.task_id, 102, "CountDownBanner json parseError exception = " + localException.getMessage() + " json string = " + str);
    }
  }
}
