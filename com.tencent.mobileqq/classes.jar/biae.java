...
public class biae
  extends bhzx<Bundle, Void, HashMap<String, Object>>
{
  protected Handler a;
  public biaf a;
  
  public biae(String paramString1, String paramString2, biaf parambiaf)
  {
  ...
  public biaa a(String paramString1, String paramString2, Bundle paramBundle)
  {
  ...
  public void a()
  {
    this.jdField_a_of_type_Biaf = null;
  }
  ...
  public HashMap<String, Object> b(Bundle... paramVarArgs)
  {
    ...
    try
    {
      ...
      j = biar.a(bhpc.a().a(), (String)localObject).a("Common_HttpRetryCount");
      bhzm.c("OpenConfig_agent", "config 1:Common_HttpRetryCount            config_value:" + j + "   appid:" + (String)localObject + "     url:" + str2);
      if (j == 0)
      {
        j = 3;
        bhzm.c("OpenConfig_agent", "config 1:Common_HttpRetryCount            result_value:" + j + "   appid:" + (String)localObject + "     url:" + str2);
    ...
    catch (Exception localException)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          try
          {
            localbiaa = a(this.jdField_a_of_type_JavaLangString, this.b, paramVarArgs[0]);
            l2 = l1;
            l4 = l1;
            str1 = localbiaa.jdField_a_of_type_JavaLangString;
            l2 = l1;
            l4 = l1;
            ...
            l2 = l1;
            l4 = l1;
            ((JSONObject)localObject).put("content", localbiaa.jdField_a_of_type_JavaIoInputStream);
          }
          catch (ConnectTimeoutException localConnectTimeoutException)
          {
            ...
            l2 = l1;
            l4 = l1;
            localJSONObject1.put("httpdatamodified", localbiaa.jdField_a_of_type_Int);
            continue;
          }
          ...
          catch (HttpBaseUtil.HttpStatusException paramVarArgs)
          {
            ...
            try
            {
              ...
              biaz.a().a(str2, l3, l2, 0L, i, bhpc.a().a(), "1000002", null);
              return localHashMap;
            }
          ...
          catch (Exception paramVarArgs)
          {
            ...
            {
              i = Integer.parseInt(paramVarArgs.getMessage().replace("http status code error:", ""));
              biaz.a().a(str2, l3, l4, 0L, i, bhpc.a().a(), "1000002", null);
              return localHashMap;
            }
            catch (Exception paramVarArgs)
            {
          ...
          l2 = l1;
          l4 = l1;
          bhzm.a("HttpCgiAsyncTask", "response.isModified= " + localbiaa.jdField_a_of_type_Int);
          l2 = l1;
          l4 = l1;
          if (localbiaa.jdField_a_of_type_Int == 0)
          {
            ...
            l2 = l1;
            l4 = l1;
            localJSONObject2.put("httpdatamodified", localbiaa.jdField_a_of_type_Int);
            l2 = l1;
            l4 = l1;
          ...
          l2 = l1;
          l4 = l1;
          l1 = localbiaa.jdField_a_of_type_Long;
          l2 = l1;
          l4 = l1;
          l5 = localbiaa.b;
          l2 = l5;
          l4 = l3;
          bhzm.c("ReportManager", str2 + " | " + l4 + " | " + l1 + " | " + l2 + " | " + i);
          l3 = 0L;
          try
          {
          ...
          biaz.a().a(str2, l4, l1, l2, i, l3, "1000002", null);
          return localHashMap;
          if (!bool) {
            continue;
          }
