...
public class acxv
{
  ...
  private static akim jdField_a_of_type_Akim;
  ...
  {
    if (bbbj.a(paramSessionInfo.jdField_a_of_type_Int)) {}
    for (int i = 5;; i = 6)
    {
      if (mye.a().a(paramSessionInfo.jdField_a_of_type_JavaLangString)) {
        i = 1;
      }
      return i;
    }
  ...
  public static int a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, ArrayList<String> paramArrayList, Intent paramIntent1, Intent paramIntent2)
  {
    ...
    if ((paramIntent1 == null) || (!paramIntent1.hasExtra("showFlashPic")))
    {
      ...
      paramIntent2.putExtra("showFlashPic", ajwd.a(paramSessionInfo.jdField_a_of_type_Int, (HotChatManager)localObject, paramSessionInfo.b));
    }
    ...
    for (;;)
    {
      ...
      paramIntent2.putExtra("ALBUM_ID", bbbj.a(paramActivity));
      paramIntent2.putExtra("ALBUM_NAME", bbbj.b(paramActivity));
      ...
      paramIntent2.putExtra("is_anonymous", mye.a().a(paramSessionInfo.jdField_a_of_type_JavaLangString));
      ...
      if ((paramIntent1 != null) && (paramIntent1.getBooleanExtra("ReceiptMsgManager.EXTRA_KEY_IS_RECEIPT", false)))
      {
        ...
        paramIntent2.putExtra("PhotoConst.MAXUM_SELECTED_NUM", Math.min(avph.b(paramQQAppInterface), j));
      }
      paramIntent2.putExtra("session_info", paramSessionInfo);
      ...
      if ((paramActivity instanceof SplashActivity))
      {
        ...
        paramIntent2 = actn.a(paramIntent2, null);
        ...
        paramIntent2 = actn.a(paramIntent2, null);
        paramIntent2.putExtra(bbbi.h, 80);
        ...
        localyak = (yak)paramQQAppInterface.a(51);
  ...
  public static void a(Intent paramIntent, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
    if (a(paramSessionInfo, paramQQAppInterface.a(paramSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      ...
      paramIntent.putExtra("binder_presendService", new BinderWarpper(new auoh(paramSessionInfo.jdField_a_of_type_Int, paramSessionInfo.jdField_a_of_type_JavaLangString, paramSessionInfo.b, paramQQAppInterface.getAccount(), paramSessionInfo.jdField_e_of_type_Int).asBinder()));
    }
  }
  ...
  public static void a(AppInterface paramAppInterface, Activity paramActivity, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (!bbbd.a())
      {
        bcpw.a(paramActivity, paramActivity.getResources().getString(2131719044), 0).a();
        return;
      }
      paramAppInterface = ajsf.bj;
      boolean bool;
      label56:
      Object localObject;
      if (paramInt2 == 1)
      ...
      catch (Exception paramAppInterface)
      {
        for (;;)
        {
          ...
          bcpw.a(paramActivity, 2131690593, 0).a();
        }
      }
    }
  }
  ...
  {
    bgwk.a(paramQQAppInterface, "tenpay.com", new acxy(paramInt1, paramSessionInfo, paramQQAppInterface, paramInt2, paramString, paramActivity));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, ahdb paramahdb, List<ahdb> paramList, int paramInt)
  {
    if (paramahdb == null) {
      return;
    }
    ...
    int i = 0;
    Object localObject2 = "";
    paramList = (agvz)paramQQAppInterface.getManager(125);
    if (paramList != null) {}
    label1422:
    label1561:
    label1569:
    for (String str = paramList.a();; str = null)
    {
      ...
      {
        int k;
        if (RedPacketManager.TYPEHBINFOMAP.get(Integer.valueOf(paramahdb.jdField_a_of_type_Int)) == null) {
          k = 1;
        }
        Object localObject3;
        switch (paramahdb.jdField_a_of_type_Int)
        {
        case 8: 
        case 9: 
        case 10: 
        ...
        case 7: 
          for (;;)
          {
            ...
            try
            {
              ...
              ((JSONObject)localObject3).put("bus_type", paramahdb);
              if (j > 0) {
            ...
            catch (JSONException paramahdb)
            {
              for (;;)
              {
                long l;
                paramahdb.printStackTrace();
                continue;
                if (paramInt == 1)
                {
                  aefv.a(paramQQAppInterface, "0X8005FC9", paramSessionInfo.jdField_a_of_type_Int);
                  continue;
            ...
            aefv.a(paramQQAppInterface, "0X8005CAF", paramSessionInfo.jdField_a_of_type_Int);
            if (jdField_a_of_type_Int != 0) {
              break label1523;
            }
            paramActivity = paramList + ".plus";
            axqw.b(paramQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", paramActivity, 0, 0, (String)localObject1, "", "", "");
            return;
            if (paramSessionInfo.jdField_a_of_type_Int == 3000)
            {
              i = 2;
              paramList = "entrance.click.group";
              j = ((ajvk)paramQQAppInterface.getManager(53)).a(paramSessionInfo.jdField_a_of_type_JavaLangString);
              break;
            }
            if (paramSessionInfo.jdField_a_of_type_Int == 1)
            {
              ...
              try
              {
                ...
                paramList = (akhq)paramQQAppInterface.a(20);
                if (jdField_a_of_type_Akim == null) {
                  jdField_a_of_type_Akim = new acxx(paramSessionInfo);
                }
                paramQQAppInterface.addObserver(jdField_a_of_type_Akim);
                paramList.b(l, 32, 0);
              }
              ...
              {
                axqw.b(paramQQAppInterface, "CliOper", "", "", "0X8005B9C", "0X8005B9C", 0, 0, "", "", "", "");
                j = 6;
            ...
            for (paramList = paramQQAppInterface.a().l(paramSessionInfo.jdField_a_of_type_JavaLangString);; paramList = paramQQAppInterface.a().m(paramSessionInfo.jdField_a_of_type_JavaLangString))
            {
              ...
              paramList = bbca.encodeToString(paramList, 2);
              axqw.b(paramQQAppInterface, "CliOper", "", "", "0X8005B9D", "0X8005B9D", 0, 0, "", "", "", "");
              localObject3 = "entrance.click.c2c";
              localObject2 = paramList;
              i = 7;
              j = 1;
              paramList = (List<ahdb>)localObject3;
              break;
            }
            k = ((Integer)RedPacketManager.TYPEHBINFOMAP.get(Integer.valueOf(paramahdb.jdField_a_of_type_Int))).intValue();
            break label165;
            localObject1 = "13140";
            paramahdb = String.valueOf(1);
            continue;
            localObject1 = "13141";
            paramahdb = String.valueOf(2);
            continue;
            localObject3 = "13142";
            paramahdb = (ahdb)localObject1;
            localObject1 = localObject3;
        ...
        case 5: 
          ...
          axqw.b(paramQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "plus.hongbao.click", 0, 0, "", "", "", "");
          return;
        case 3: 
          if (paramahdb.jdField_a_of_type_OrgJsonJSONObject != null) {}
          for (paramahdb = paramahdb.jdField_a_of_type_OrgJsonJSONObject.optString("theme_id", "");; paramahdb = "")
          {
            localIntent.putExtra("theme_type", paramahdb);
        ...
        case 4: 
          ...
          paramList = paramahdb.jdField_a_of_type_OrgJsonJSONObject.optString("url", "");
          paramQQAppInterface = paramList;
          if (paramahdb.jdField_a_of_type_OrgJsonJSONObject.optInt("subtype", 0) == 1) {
        ...
        case 12: 
          paramahdb = paramahdb.jdField_a_of_type_OrgJsonJSONObject.optString("schema");
          if (TextUtils.isEmpty(paramahdb)) {
            break;
          }
          a(paramQQAppInterface, paramActivity, paramSessionInfo, i, j, paramahdb);
          return;
        }
      }
    }
  ...
  {
    axqw.b(paramQQAppInterface, "CliOper", "", paramSessionInfo.jdField_a_of_type_JavaLangString, "Music_gene", "Music_gene_AIO", 0, 0, String.valueOf(a(paramSessionInfo.jdField_a_of_type_Int)), "", "", "");
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo, ArrayList<String> paramArrayList, Intent paramIntent, HashMap<LocalMediaInfo, LocalMediaInfo> paramHashMap)
  {
    ...
    for (;;)
    {
      ...
      return;
      localIntent.putExtra("PhotoConst.editPathMap", agpm.a(paramHashMap));
      paramActivity.startActivityForResult(localIntent, i);
    }
  }
  ...
  {
    new acya(paramSessionInfo, paramQQAppInterface, paramContext, bbdr.b(paramContext, paramUri)).execute(new Void[0]);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, boolean paramBoolean, String paramString, BaseChatPie paramBaseChatPie)
  {
    ...
    if (((paramSessionInfo.jdField_a_of_type_Int == 1025) || (paramSessionInfo.jdField_a_of_type_Int == 0) || (paramSessionInfo.jdField_a_of_type_Int == 1000) || (paramSessionInfo.jdField_a_of_type_Int == 1004)) && (((bdto)paramQQAppInterface.getManager(165)).d(paramSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      arrayOfInt[0] = 5;
      localmui.b(2131698242);
    }
    for (int i = 1;; i = 0)
    {
      arrayOfInt[i] = 1;
      ...
      localmui.a(new acxw(paramQQAppInterface));
      localmui.a(new acxz(localmui, arrayOfInt, paramSessionInfo, paramQQAppInterface, paramBaseChatPie, paramContext, paramString));
      localmui.show();
      axqw.b(paramQQAppInterface, "CliOper", "", "", "0X8004D68", "0X8004D68", 0, 0, "", "", "", "");
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, boolean paramBoolean, String paramString, Map<String, String> paramMap)
  {
    ...
    for (;;)
    {
      axqw.b(paramQQAppInterface, "CliOper", "", "", str2, str2, 0, 0, str1, "", "", "");
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, int paramInt1, int paramInt2)
  {
    ...
    if (AudioHelper.b(0))
    {
      bbcv.a(paramContext, 230, paramContext.getString(2131698453), paramContext.getString(2131698454), new acyb(), null).show();
      return;
    }
    if (AudioHelper.a(0))
    {
      bbcv.a(paramContext, 230, paramContext.getString(2131698453), paramContext.getString(2131698455), new acyc(), null).show();
      return;
    }
    if (paramQQAppInterface.getApp().checkPermission("android.permission.CAMERA", Process.myPid(), Process.myUid()) != 0)
    {
      bbcv.a(paramContext, 230, paramContext.getString(2131698453), ajyc.a(2131708305), new acyd(), null).show();
      return;
    }
    ...
    for (int i = 1;; i = 17000)
    {
      ...
      ymw.a(paramQQAppInterface, Long.parseLong(paramSessionInfo.jdField_a_of_type_JavaLangString), "Usr_AIO_SendMsg", 2, 0, paramInt1);
      return;
    }
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo)
  {
    ...
    bgpf.a(paramActivity, paramQQAppInterface.getAccount(), localIntent, -1, false);
    bgpr.b(paramQQAppInterface, 3, paramSessionInfo.jdField_a_of_type_Int);
  }
  ...
  {
    Object localObject = (askl)paramQQAppInterface.getManager(11);
    String str;
    if (paramSessionInfo.jdField_a_of_type_Int == 1006) {
      str = ((askl)localObject).a(paramSessionInfo.jdField_a_of_type_JavaLangString);
    }
    for (localObject = paramSessionInfo.jdField_a_of_type_JavaLangString; paramString == null; localObject = ((askl)localObject).b(str))
    {
  ...
  public static void c(QQAppInterface paramQQAppInterface, Activity paramActivity, SessionInfo paramSessionInfo)
  {
    ...
    paramQQAppInterface.putExtra(bbbi.h, 84);
