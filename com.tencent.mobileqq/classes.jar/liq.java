  ...
  extends lio
{
  ...
  public boolean a(int paramInt, String paramString)
  {
    if (!this.jdField_a_of_type_Boolean) {
      bjum.a().postDelayed(new SupportFace.1(this), 1100L);
    }
    lbd.f("SupportFace", "onReceiveSupportMessage type:" + paramInt + "|" + paramString);
    if (paramString != null)
    {
    ...
    do
    {
      ...
      {
        this.f = 1;
        lbd.f("SupportFace", "onReceiveSupportMessage  support reason 1:");
        return false;
      }
      return true;
      if (paramString.equals("SUPPORT_FALSE"))
      {
        ...
        for (;;)
        {
          ...
          {
            this.f = 0;
            lbd.f("SupportFace", "onReceiveSupportMessage not support reason 1:");
          }
        }
      }
      ...
      if (paramString.equals("SUPPORT_CREATIVECOP_TRUE"))
      {
        ...
        {
          this.f = 1;
          lbd.f("SupportFace", "onReceiveSupportMessage  support reason 2:");
        }
        return true;
      }
    ...
    {
      this.f = 0;
      lbd.f("SupportFace", "onReceiveSupportMessage  not support reason 2:");
    }
    return true;
  }
  ...
  public void c()
  {
    ...
    this.e = -1;
    this.f = -1;
    lbd.f("SupportFace", "SupportFace restore:");
  }
}
