  ...
  extends aqqt
{
  ...
  aqqb(aqpv paramaqpv, MessageRecord paramMessageRecord)
  {
    super(paramaqpv);
  ...
  void a(String paramString, int paramInt, aqqr paramaqqr)
  {
    ...
    aqpv.a(this.jdField_a_of_type_Aqpv).a().a().a(paramString, paramInt, this.b, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, 102, new aqqc(this, paramString, paramaqqr));
  }
}
