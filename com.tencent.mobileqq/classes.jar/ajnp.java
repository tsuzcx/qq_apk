...
public class ajnp
  implements DialogInterface.OnDismissListener, Handler.Callback, AdapterView.OnItemClickListener, bfoq
{
  ...
  public ajnp(Context paramContext, AppInterface paramAppInterface)
  {
    try
    {
  ...
  private int a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.f = (ajyc.a(2131700345) + this.jdField_a_of_type_JavaLangString);
  ...
  private void b()
  {
    ...
    for (localObject = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; localObject = null)
    {
      ...
      {
        if ((localObject != null) && (localAppInterface != null) && (bgyu.a(localAppInterface, (Context)localObject, localBundle, null)))
        {
          localObject = a();
          if (localObject != null) {
            break label172;
  ...
  private void c()
  {
    Object localObject1 = new axuk(StructMsgForGeneralShare.class).c(96).a(this.f).e(this.c).a(ajyc.a(2131700373), null).b("web", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326").a();
    Object localObject2 = axux.a(2);
    ((axuo)localObject2).a(this.d, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString);
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
    {
      ...
      if (localObject1 != null) {
        aqbc.a((Activity)localObject1, (Intent)localObject2, 14002);
      }
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    localArrayList.add(bfov.a(3));
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {}
    for (paramString = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; paramString = null)
    {
      if (paramString != null)
      {
        localbfov = new bfov(paramString);
        localbfov.a(localArrayList);
      }
      if ((this.jdField_a_of_type_Bfol == null) && (paramString != null)) {
        this.jdField_a_of_type_Bfol = bfov.a(paramString, localbfov, this, this, this, false);
      }
      if ((this.jdField_a_of_type_Bfol != null) && (!this.jdField_a_of_type_Bfol.isShowing()))
      {
        this.jdField_a_of_type_Bfol.setOnDismissListener(this);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (Activity localActivity = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; localActivity = null)
    {
      ...
      {
        localbfov = new bfov(localActivity);
        localbfov.a(localArrayList);
      }
      if ((this.jdField_a_of_type_Bfol == null) && (localActivity != null))
      {
        ...
        this.jdField_a_of_type_Bfol = bfov.a(localActivity, localbfov, new ajnq(this, paramString), this, this, false);
      }
      if ((this.jdField_a_of_type_Bfol == null) || (this.jdField_a_of_type_Bfol.isShowing())) {
        break;
      }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localBundle.putString("summary", ajyc.a(2131700330));
        ...
        bgyu.a((AppInterface)localObject, paramMessage, localBundle, this, 15);
        return false;
      }
