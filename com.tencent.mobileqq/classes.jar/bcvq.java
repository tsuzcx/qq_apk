...
public class bcvq
{
  ...
  public static void a(View paramView, bcvv parambcvv)
  {
    paramView.setAccessibilityDelegate(new bcvt(parambcvv));
  }
  ...
  public static void a(View paramView, CharSequence paramCharSequence, String paramString)
  {
    if (Build.VERSION.SDK_INT >= 14) {
      paramView.setAccessibilityDelegate(new bcvu(paramCharSequence, paramString));
    }
  }
  ...
  public static void a(EditText paramEditText, String paramString)
  {
    if ((AppSetting.c) && (Build.VERSION.SDK_INT >= 14))
    {
      ...
      paramEditText.setAccessibilityDelegate(new bcvr());
    }
  }
  ...
  public static void b(View paramView)
  {
    ...
    if ((localAccessibilityManager != null) && (Build.VERSION.SDK_INT >= 14) && (localAccessibilityManager.isEnabled()))
    {
      ...
      paramView.setAccessibilityDelegate(new bcvs());
    }
  }
