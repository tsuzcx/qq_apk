...
public class bcvq
  extends bcvz
{
  public bcvq(AbsShareMsg paramAbsShareMsg, QQAppInterface paramQQAppInterface, View paramView)
  {
  ...
  public boolean a(Activity paramActivity, long paramLong, String paramString1, String paramString2, String paramString3)
  {
    ...
    biqa.b(paramActivity, paramString2);
    return true;
  }
  ...
  public boolean a(String paramString)
  {
    ...
    tzo.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.message, localIntent, paramString);
    this.jdField_a_of_type_AndroidContentContext.startActivity(localIntent);
    bcst.b(null, "P_CliOper", "Pb_account_lifeservice", "", "aio_msg_url", "aio_url_clickqq", 0, 1, 0, paramString, "", "", "");
    return true;
  }
  ...
  public boolean a(String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      if (paramString2.getPackageInfo(paramString1[0], 1) != null)
      {
        ...
        try
        {
          paramString3 = (anvf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(23);
