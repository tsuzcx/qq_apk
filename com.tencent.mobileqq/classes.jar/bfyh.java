  ...
  implements Manager
{
  ...
  public bfyh(AppInterface paramAppInterface)
  {
  ...
  {
    String str = bdgc.m(paramQQAppInterface, paramString);
    if ((TextUtils.isEmpty(str)) || (str.equals(paramString)))
    {
      paramQQAppInterface = ((bfyh)paramQQAppInterface.getManager(165)).a(String.valueOf(paramString));
  ...
  {
    paramawgf = paramawgf.a(QidianExternalInfo.class);
    if (paramawgf != null)
    {
      paramawgf = paramawgf.iterator();
      while (paramawgf.hasNext())
      {
        QidianExternalInfo localQidianExternalInfo = (QidianExternalInfo)paramawgf.next();
        if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    for (;;)
    {
      try
      {
        ...
        bfyh localbfyh = (bfyh)paramQQAppInterface.getManager(165);
        ...
        if (bool1)
        {
          ...
          localbfyh.a(localBmqqAccountType);
          if (!bool1) {
            continue;
          }
          QidianExternalInfo localQidianExternalInfo = localbfyh.a(paramString);
          paramString = localbfyh.a(paramString);
          if ((localQidianExternalInfo != null) && (paramString != null)) {
            continue;
          }
          if (bhta.a()) {
            ThreadManager.post(new QidianManager.10(localbfyh, paramQQAppInterface, localBmqqAccountType), 5, null, true);
          }
        }
        else
        {
        ...
        localbfyh.b(paramQQAppInterface.getApp().getBaseContext(), localBmqqAccountType);
        return;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    try
    {
      ...
      if (!nbp.a(paramString1)) {
        return;
      }
      ((bfyh)paramQQAppInterface.getManager(165)).h.put(paramString1, paramString2);
      return;
    }
    catch (Exception paramQQAppInterface) {}
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Friends[] paramArrayOfFriends)
  {
    ...
    {
      localbfyh = (bfyh)paramQQAppInterface.getManager(165);
      if (bhta.a()) {
        ThreadManager.postImmediately(new QidianManager.9(localbfyh, paramQQAppInterface, paramArrayOfFriends), null, false);
      }
    }
    else
    {
    ...
    localbfyh.b(paramQQAppInterface, paramArrayOfFriends);
  }
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    if ((!TextUtils.isEmpty(paramString1)) && (paramString1.contains("isNeedReply=")) && (paramString1.contains("QidianKfUin=")))
    {
      ...
      if (bool2)
      {
        ...
        SosoInterface.a(new bfyi(this, 1, true, true, 0L, true, false, "QidianManager", paramString1, paramInt1, str3, paramInt2, str2, str1, paramString2));
      }
    }
    label364:
    while (!QLog.isColorLevel())
  ...
  {
    boolean bool2 = true;
    paramQQAppInterface = (bfyh)paramQQAppInterface.getManager(165);
    boolean bool1 = bool2;
    if (paramFriends != null)
    {
      bool1 = bool2;
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    return ((((bfyh)paramQQAppInterface.getManager(165)).a(paramMessageRecord.frienduin)) || (paramMessageRecord.istroop == 1024)) && (!TextUtils.isEmpty(paramMessageRecord.getExtInfoFromExtStr("is_eman_sc_message")));
  }
  
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    return ((bfyh)paramQQAppInterface.getManager(165)).e(paramString);
  }
  
  private boolean a(String paramString, int paramInt)
  {
    Object localObject = (alto)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(51);
    if (localObject != null)
    {
      localObject = ((alto)localObject).b(paramString);
  ...
  {
    paramawgf = paramawgf.a(QidianInternalInfo.class);
    if (paramawgf != null)
    {
      paramawgf = paramawgf.iterator();
      while (paramawgf.hasNext())
      {
        QidianInternalInfo localQidianInternalInfo = (QidianInternalInfo)paramawgf.next();
        if (QLog.isColorLevel()) {
  ...
  private void b(QQAppInterface paramQQAppInterface, Friends[] paramArrayOfFriends)
  {
    ...
    //   15: astore 9
    //   17: aload 9
    //   19: getfield 425	com/tencent/mobileqq/data/Friends:uin	Ljava/lang/String;
    //   22: astore 10
    //   24: aload 9
    //   26: getfield 424	com/tencent/mobileqq/data/Friends:cSpecialFlag	B
    //   29: istore 5
    //   31: aload 10
    //   33: invokestatic 363	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   36: pop2
    //   37: aload 10
    //   39: invokestatic 368	nbp:a	(Ljava/lang/String;)Z
    //   42: ifne +4 -> 46
    //   45: return
    //   46: iload 5
    //   48: invokestatic 371	bfyh:b	(I)Z
    //   51: istore 6
    //   53: iload 5
    //   55: invokestatic 373	bfyh:a	(I)Z
    //   58: istore 7
    //   60: iload 5
    //   62: invokestatic 375	bfyh:c	(I)Z
    //   65: istore 8
    //   67: iload 6
    //   69: ifne +60 -> 129
    //   72: iload 7
    ...
    //   132: iload 6
    //   134: ifeq +109 -> 243
    //   137: new 385	com/tencent/qidian/data/BmqqAccountType
    //   140: dup
    //   141: aload 10
    //   143: bipush 6
    //   145: invokespecial 388	com/tencent/qidian/data/BmqqAccountType:<init>	(Ljava/lang/String;I)V
    //   148: astore 9
    //   150: aload 9
    //   152: ifnull +133 -> 285
    //   155: aload_0
    //   156: aload 10
    //   158: invokevirtual 592	bfyh:a	(Ljava/lang/String;)I
    //   161: aload 9
    //   163: invokevirtual 596	com/tencent/qidian/data/BmqqAccountType:getAccountType	()I
    //   166: if_icmpeq +119 -> 285
    //   169: aload_0
    //   170: getfield 50	bfyh:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   173: aload 10
    //   175: aload 9
    //   177: invokevirtual 596	com/tencent/qidian/data/BmqqAccountType:getAccountType	()I
    //   180: invokestatic 601	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   183: invokeinterface 336 3 0
    //   188: pop
    //   189: iload 6
    //   191: ifeq +94 -> 285
    //   194: aload_0
    //   195: aload 10
    //   197: invokevirtual 126	bfyh:a	(Ljava/lang/String;)Lcom/tencent/qidian/data/QidianExternalInfo;
    //   200: astore 11
    //   202: aload_0
    //   203: aload 10
    //   205: invokevirtual 394	bfyh:a	(Ljava/lang/String;)Lcom/tencent/qidian/data/QidianProfileUiInfo;
    //   208: astore 10
    //   210: aload 11
    //   212: ifnull +8 -> 220
    //   215: aload 10
    ...
    //   220: aload_0
    //   221: aload_1
    //   222: invokevirtual 406	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   225: invokevirtual 412	com/tencent/qphone/base/util/BaseApplication:getBaseContext	()Landroid/content/Context;
    //   228: aload 9
    //   230: invokevirtual 415	bfyh:b	(Landroid/content/Context;Lcom/tencent/qidian/data/BmqqAccountType;)Z
    //   233: pop
    //   234: goto +51 -> 285
    //   237: astore_1
    //   238: aload_1
    //   239: invokevirtual 446	java/lang/Exception:printStackTrace	()V
    //   242: return
    //   243: iload 7
    //   245: ifeq +18 -> 263
    //   248: new 385	com/tencent/qidian/data/BmqqAccountType
    //   251: dup
    //   252: aload 10
    //   254: iconst_1
    //   255: invokespecial 388	com/tencent/qidian/data/BmqqAccountType:<init>	(Ljava/lang/String;I)V
    //   258: astore 9
    //   260: goto -110 -> 150
    //   263: iload 8
    //   265: ifeq -115 -> 150
    //   268: new 385	com/tencent/qidian/data/BmqqAccountType
    //   271: dup
    //   272: aload 10
    //   274: iconst_3
    //   275: invokespecial 388	com/tencent/qidian/data/BmqqAccountType:<init>	(Ljava/lang/String;I)V
    //   278: astore 9
    //   280: goto -130 -> 150
    //   283: astore_1
    //   284: return
  ...
  private void b(BmqqUserSimpleInfo paramBmqqUserSimpleInfo)
  {
    ...
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        try
        {
          localawgf.b(paramBmqqUserSimpleInfo);
          if (QLog.isColorLevel()) {
  ...
  private void b(QidianExternalInfo paramQidianExternalInfo, QidianInternalInfo paramQidianInternalInfo, QidianCorpInfo paramQidianCorpInfo, QidianProfileUiInfo paramQidianProfileUiInfo)
  {
    ...
    while (!QLog.isColorLevel())
    {
      try
      {
        localawgf.b(paramQidianExternalInfo);
        if (paramQidianInternalInfo == null) {
          break label124;
        }
        localawgf.b(paramQidianInternalInfo);
      }
      ...
      {
        localawgf.b(paramQidianCorpInfo);
        if (paramQidianProfileUiInfo == null) {
          break label168;
        }
        localawgf.b(paramQidianProfileUiInfo);
      }
      for (;;)
      {
        if (QLog.isColorLevel()) {
  ...
  {
    return ((bfyh)paramQQAppInterface.getManager(165)).f(paramString);
  }
  ...
  private void c(awgf paramawgf)
  {
    paramawgf = paramawgf.a(BmqqUserSimpleInfo.class);
    if (paramawgf != null)
    {
      paramawgf = paramawgf.iterator();
      while (paramawgf.hasNext())
      {
        BmqqUserSimpleInfo localBmqqUserSimpleInfo = (BmqqUserSimpleInfo)paramawgf.next();
        if (QLog.isColorLevel()) {
  ...
  private void d(awgf paramawgf)
  {
    paramawgf = paramawgf.a(QidianCorpInfo.class);
    if (paramawgf != null)
    {
      paramawgf = paramawgf.iterator();
      while (paramawgf.hasNext())
      {
        QidianCorpInfo localQidianCorpInfo = (QidianCorpInfo)paramawgf.next();
        if (QLog.isColorLevel()) {
  ...
  private void e(awgf paramawgf)
  {
    paramawgf = paramawgf.a(QidianProfileUiInfo.class);
    if (paramawgf != null)
    {
      paramawgf = paramawgf.iterator();
      while (paramawgf.hasNext())
      {
        QidianProfileUiInfo localQidianProfileUiInfo = (QidianProfileUiInfo)paramawgf.next();
        if (QLog.isColorLevel()) {
  ...
  private void f(awgf paramawgf)
  {
    paramawgf = paramawgf.a(QidianPAForWpa.class);
    if (paramawgf != null)
    {
      paramawgf = paramawgf.iterator();
      while (paramawgf.hasNext())
      {
        QidianPAForWpa localQidianPAForWpa = (QidianPAForWpa)paramawgf.next();
  ...
  public int a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      if (ndv.b(paramQQAppInterface, paramString, 0)) {
        return 3;
      }
    } while (a(paramString));
  ...
  public String a(Context paramContext, String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      return String.format(paramContext.getString(2131698890), new Object[] { paramString });
    }
    return paramContext.getString(2131698889);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        localObject2 = azvd.a(paramString.getBytes(), 0);
    ...
    paramString = (MessageForStructing)azaf.a(-2011);
    ...
    for (;;)
    {
      ...
      if (alww.a(paramQQAppInterface, paramString, false)) {
        break;
      }
  ...
  {
    ((bfzp)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).a(paramString1, paramInt1, paramBoolean, 0.0D, 0.0D, paramString2, paramInt2, paramString3, paramString4, paramString5);
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ((bfzp)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).a(paramString1, paramString2, paramString3);
      return;
  ...
  {
    if ((!nbp.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) || (nbp.a(null, paramString))) {
      ((alpk)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(2)).a(paramString, paramBoolean);
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    while (localIterator.hasNext()) {
      ((bfyj)localIterator.next()).a(paramBoolean);
    }
  }
      ...
      try
      {
        ...
        if (nbp.a(paramContext))
        {
          ...
          default: 
            return false;
          case 1: 
            ((bfzp)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).b(l);
            return true;
          }
          ((bfzp)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).d(l);
          return true;
        }
      }
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      Long.parseLong(paramString);
      if (!nbp.a(paramString)) {}
      while ((nbp.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) && (!nbp.a(null, paramString))) {
        return false;
      }
  ...
  {
    ((alpk)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(2)).f(paramString);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (nbp.a(paramContext))
        {
          ...
          case 0: 
          case 2: 
            ((nbm)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(37)).a(paramContext);
            return true;
          case 1: 
            ((bfzp)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).a(l);
            return true;
          }
          ((bfzp)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(85)).c(l);
          return true;
        }
      }
      catch (Exception paramContext) {}
