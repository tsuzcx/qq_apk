  ...
  implements DatePicker.OnDateChangedListener
{
  ...
  public bipy(Activity paramActivity, List<WMElement> paramList)
  {
  ...
  private void a(EditText paramEditText, WMEditItem paramWMEditItem)
  {
    ...
    if (this.jdField_a_of_type_Biqh != null) {
      this.jdField_a_of_type_Biqh.a();
    }
  }
  
  private void a(WMElement paramWMElement, biqg parambiqg)
  {
    bbgu localbbgu = new bbgu(this.jdField_a_of_type_AndroidWidgetEditText.getContext(), 2131755791);
    localbbgu.setContentView(2131558906);
    localbbgu.setTitle(ajya.a(2131716884));
    localbbgu.setMessage(ajya.a(2131716889));
    localbbgu.setNegativeButton(ajya.a(2131716885), new biqd(this));
    localbbgu.setPositiveButton(ajya.a(2131716886), new biqe(this, parambiqg, paramWMElement));
  ...
  {
    if (paramEditText != null) {
      paramEditText.setCustomSelectionActionModeCallback(new biqf(this));
    }
  }
  ...
  public void a()
  {
    if ((!this.jdField_a_of_type_JavaUtilList.isEmpty()) && (this.jdField_a_of_type_AndroidWidgetEditText != null) && (this.jdField_a_of_type_ComTencentTtpicOpenapiModelWMEditItem != null))
    {
      ...
      if (this.jdField_a_of_type_Biqh != null) {
        this.jdField_a_of_type_Biqh.a(this.jdField_a_of_type_ComTencentTtpicOpenapiModelWMEditItem.itemType, this.jdField_a_of_type_ComTencentTtpicOpenapiModelWMEditItem.value, this.jdField_a_of_type_AndroidWidgetEditText);
      }
    }
    label83:
    do
    ...
    } while (this.jdField_a_of_type_Biqh == null);
    this.jdField_a_of_type_Biqh.a();
  }
  
  public void a(biqh parambiqh)
  {
    this.jdField_a_of_type_Biqh = parambiqh;
  }
  ...
  {
    biqg localbiqg = (biqg)paramViewHolder;
    if (paramInt == 0)
    {
      this.jdField_a_of_type_AndroidWidgetEditText = localbiqg.jdField_a_of_type_AndroidWidgetEditText;
    ...
    if (paramInt == getItemCount() - 1) {
      localbiqg.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
    }
    WMEditItem localWMEditItem = (WMEditItem)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    localbiqg.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new bipz(this, paramInt, localbiqg));
    if (localWMEditItem.itemType != WMEditItem.ITEM_TYPE_TEXT)
    {
      localbiqg.jdField_a_of_type_AndroidWidgetButton.setVisibility(4);
      ...
      localbiqg.jdField_a_of_type_AndroidWidgetEditText.setText(paramViewHolder);
      localbiqg.jdField_a_of_type_AndroidWidgetEditText.setFocusable(false);
      localbiqg.jdField_a_of_type_AndroidWidgetEditText.setCursorVisible(false);
      localbiqg.jdField_a_of_type_AndroidWidgetEditText.setOnClickListener(new biqa(this, localbiqg, localWMEditItem));
      b(localbiqg.jdField_a_of_type_AndroidWidgetEditText);
      return;
    }
    if ((localWMEditItem.value == null) || (localWMEditItem.value.equals("")))
    {
      localbiqg.jdField_a_of_type_AndroidWidgetEditText.setText(((WMElement)LogicDataManager.getInstance().getEditableWMElement().get(paramInt)).getDefault());
      ...
      localbiqg.jdField_a_of_type_AndroidWidgetEditText.setFocusable(false);
      localbiqg.jdField_a_of_type_AndroidWidgetEditText.setFocusableInTouchMode(false);
      localbiqg.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130837636);
      localbiqg.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
    }
    for (;;)
    {
      localbiqg.jdField_a_of_type_AndroidWidgetEditText.setOnFocusChangeListener(new biqb(this, localbiqg, localWMEditItem));
      localbiqg.jdField_a_of_type_AndroidWidgetEditText.setOnClickListener(new biqc(this, localbiqg, localWMEditItem));
      return;
      localbiqg.jdField_a_of_type_AndroidWidgetEditText.setText(localWMEditItem.value);
      break;
      label419:
      localbiqg.jdField_a_of_type_AndroidWidgetEditText.setFocusable(true);
      localbiqg.jdField_a_of_type_AndroidWidgetEditText.setFocusableInTouchMode(true);
      localbiqg.jdField_a_of_type_AndroidWidgetEditText.requestFocus();
      localbiqg.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130837634);
      localbiqg.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
    }
  }
  ...
  {
    return new biqg(this, LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131558486, paramViewGroup, false));
  }
  ...
  public void onDateChanged(DatePicker paramDatePicker, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      localObject = new StringBuilder().append(paramInt1).append(ajya.a(2131716888));
      if (paramInt2 + 1 >= 10) {
        break label202;
      }
      paramDatePicker = "0";
      localObject = ((StringBuilder)localObject).append(paramDatePicker).append(paramInt2 + 1).append(ajya.a(2131716883));
      if (paramInt3 >= 10) {
        break label208;
      }
      paramDatePicker = "0";
      localObject = paramDatePicker + paramInt3 + ajya.a(2131716887);
