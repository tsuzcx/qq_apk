  ...
  extends bdnt
{
  ...
  public abdn(CharSequence paramCharSequence, int paramInt)
  {
  ...
  protected void a(View paramView, String paramString)
  {
    ...
    for (paramView = paramString.substring(i);; paramView = null)
    {
      ...
      localIntent.putExtra("assignBackText", localContext.getResources().getString(2131690563));
      ...
      localIntent.putExtra("big_brother_source_key", tzo.b(this.b));
      tzo.a(localIntent, paramString);
      localContext.startActivity(localIntent);
      bcst.b(null, "P_CliOper", "Pb_account_lifeservice", "", "aio_msg_url", "aio_url_clickqq", 0, 1, 0, str1, "", "", "");
      return;
    }
  }
}
