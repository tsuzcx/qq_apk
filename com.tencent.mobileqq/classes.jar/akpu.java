...
{
  public akpu(VasQuickUpdateManager paramVasQuickUpdateManager) {}
    ...
    do
    {
      do
      {
        do
        {
                ...
                do
                {
                  do
                  {
                    ...
                    if (paramLong == 1004L)
                    {
                      ...
                      if (paramString.endsWith("libtmsdualcore")) {
                        return VasQuickUpdateEngine.safeDeleteFile(new File(TMSManager.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())));
                      }
                      ...
                      if (paramString.equals("libVipFont_765")) {
                        return VasQuickUpdateEngine.safeDeleteFile(new File(VasUtils.a() + "libvipfont765.so"));
                      }
                      ...
                      if (paramString.equals("libqgplayer_765")) {
                        return VasQuickUpdateEngine.safeDeleteFile(new File(VipComicSoHelper.a() + "libqgplayer_765.so"));
                      }
                      if (!paramString.equals("libAPNG_765")) {
                        break label1411;
                      }
                      return VasQuickUpdateEngine.safeDeleteFile(new File(VasUtils.a() + "libAPNG765.so"));
                    }
                    if (paramLong != 5L) {
                      break label1089;
                    }
                  ...
                  return bool2;
                  if (!paramString.startsWith("font.hifontQQ.android.")) {
                    break;
                  }
                  paramString = paramString.substring("font.hifontQQ.android.".length(), paramString.length());
          ...
          bool2 = VasQuickUpdateEngine.safeDeleteFile(new File(AppConstants.bz + paramString));
          bool1 = bool2;
        } while (!QLog.isColorLevel());
      ...
      {
        localObject = ((VasExtensionManager)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234)).jdField_a_of_type_ComTencentMobileqqProfileProfileCardManager;
        i = Integer.parseInt(paramString.substring("card.".length(), paramString.length()));
        return ((ProfileCardManager)localObject).b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), i);
        if (paramLong != 22L) {
          break label1448;
        }
      ...
      do
      {
        ...
        if (paramLong == 1005L)
        {
          paramString = AppConstants.aK + "/.apollo/game/2000/";
          bool2 = VasQuickUpdateEngine.safeDeleteFile(new File(paramString));
          bool1 = bool2;
          if (!QLog.isColorLevel()) {
            break;
      ...
      for (;;)
      {
        ...
        if (paramString.startsWith("signature.item."))
        {
          ...
          if (paramString.endsWith(".json"))
          {
            ...
            localObject2 = AppConstants.by + File.separator + paramString + File.separator;
          }
        }
      }
    }
    ...
    if (paramLong == 5L)
    {
      ...
      for (;;)
      {
        ...
        if (paramString.startsWith("font.hifontQQ.android."))
        {
          localTagItemInfo.bPreConfig = false;
          localTagItemInfo.bSaveInDir = true;
          localTagItemInfo.strSavePath = (HiBoomFont.jdField_a_of_type_JavaLangString + paramString.substring("font.hifontQQ.android.".length(), paramString.length()));
        }
    ...
    else
    {
      ...
      else if (paramLong == 4L)
      {
        ...
        if (paramString.startsWith("faceAddon.sticker."))
        {
          localTagItemInfo.bPreConfig = false;
          localTagItemInfo.bSaveInDir = false;
          localTagItemInfo.strSavePath = (AppConstants.bw + "sticker_info/" + paramString.replace("faceAddon.sticker.", ""));
          return localTagItemInfo;
        }
        if ((paramString.startsWith("pendant.")) && (paramString.length() > "pendant.".length()))
        {
          ...
          if (i > 0)
          {
            ...
            ((StringBuilder)localObject2).append(AppConstants.bw).append((String)localObject1).append(File.separator);
            localTagItemInfo.bPreConfig = false;
            localTagItemInfo.bSaveInDir = true;
      ...
      else
      {
        ...
        if (paramLong == 1004L)
        {
          ...
          for (;;)
          {
            ...
            } else if (paramString.equals("libtmsdualcore")) {
              localTagItemInfo.strSavePath = TMSManager.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp());
            ...
            } else if (paramString.equals("libVipFont_765")) {
            ...
            } else if (paramString.equals("libAPNG_765")) {
              localTagItemInfo.strSavePath = (FontManager.jdField_a_of_type_JavaLangString + File.separator + "apng.zip");
            }
          }
        }
        if (paramLong == 15L)
        {
          ...
          if (paramString.startsWith("card."))
          {
            ...
            localTagItemInfo.bSaveInDir = false;
            i = Integer.parseInt(paramString.substring("card.".length(), paramString.length()));
            paramString = ((VasExtensionManager)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234)).jdField_a_of_type_ComTencentMobileqqProfileProfileCardManager;
            localTagItemInfo.strSavePath = ProfileCardManager.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), i);
            return localTagItemInfo;
          }
        }
        else
        {
          ...
          if (paramLong == 9L)
          {
            if (paramString.startsWith("signature.sticker."))
            {
              localTagItemInfo.bPreConfig = false;
              localTagItemInfo.bSaveInDir = false;
              localTagItemInfo.strSavePath = (AppConstants.bz + paramString.substring("signature.sticker.".length(), paramString.length()));
              return localTagItemInfo;
            }
          }
          else
  ...
  public boolean isFileExists(long paramLong, String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        ((StringBuilder)localObject1).append(AppConstants.bw).append((String)localObject2).append(File.separator);
        if (!paramString.endsWith(".xydata.js")) {
          break;
        }
    ...
    for (;;)
    {
      for (;;)
      {
        for (;;)
        {
          ...
          if (paramLong == 15L)
          {
            ...
            i = Integer.parseInt(paramString.substring("card.".length(), paramString.length()));
            paramString = ((VasExtensionManager)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234)).jdField_a_of_type_ComTencentMobileqqProfileProfileCardManager;
            return ProfileCardManager.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), i);
          }
          if (paramLong != 21L) {
            break label2025;
          }
      ...
      if (paramLong == 1004L)
      {
        ...
        if (paramString.startsWith("libtmsdualcore")) {
          return new File(TMSManager.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())).exists();
        }
        if (paramString.equals("emojiStickerGuideZip_v2")) {
          return new File(EmojiStickerManager.a() + "emojiStickerGuideZip_v2.zip").exists();
        }
        if (paramString.startsWith("libVipFont_765")) {
          return new File(VasUtils.a() + "libvipfont765.so").exists();
        }
        if (paramString.startsWith("bqmall.android.h5magic.")) {
          return new File(VasEmojiManager.b(paramString)).exists();
        }
        if (paramString.equals("libqgplayer_765")) {
          return new File(VipComicSoHelper.a() + "libqgplayer_765.so").exists();
        }
        bool1 = bool2;
        if (!paramString.equals("libAPNG_765")) {
          break;
        }
        return VasApngUtil.b();
      }
      if (paramLong == 9L)
      {
        bool1 = bool2;
        ...
        paramString = paramString.substring("signature.sticker.".length(), paramString.length());
        return new File(AppConstants.bz + paramString).exists();
      }
      if (paramLong == 1999L) {
