  ...
  implements View.OnClickListener, bfvi
{
  ...
  private ajtq jdField_a_of_type_Ajtq = new afmd(this);
  private ajxl jdField_a_of_type_Ajxl = new afmc(this);
  private akac jdField_a_of_type_Akac;
  private Context jdField_a_of_type_AndroidContentContext;
  private View jdField_a_of_type_AndroidViewView;
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  private awcd jdField_a_of_type_Awcd = new afmb(this);
  private aweo jdField_a_of_type_Aweo;
  private bfob jdField_a_of_type_Bfob = new afmg(this);
  private bfvm jdField_a_of_type_Bfvm;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private XListView jdField_a_of_type_ComTencentWidgetXListView;
  protected Runnable a;
  private Comparator<MayKnowRecommend> jdField_a_of_type_JavaUtilComparator = new afmf(this);
  ...
  public afma(Context paramContext, QQAppInterface paramQQAppInterface, XListView paramXListView, View paramView1, View paramView2, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131365641));
    ...
    paramXListView.setMaskShape(bfwa.jdField_b_of_type_Int);
    ...
    this.jdField_a_of_type_Afsa = ((afsa)paramQQAppInterface.getManager(295));
  ...
  private void a(afmh paramafmh)
  {
    if (!ThemeUtil.isNowThemeIsNight(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, null))
    {
      paramafmh.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130839047);
      paramafmh.jdField_a_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor("#12B7F5"));
      paramafmh.b.setTextColor(Color.parseColor("#7F12B7F5"));
      paramafmh.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(a("https://qzonestyle.gtimg.cn/aoi/sola/20190920103348_DVTS7XhGQJ.png"));
      return;
    }
    paramafmh.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130839048);
    paramafmh.jdField_a_of_type_AndroidWidgetTextView.setTextColor(Color.argb(102, 255, 255, 255));
    paramafmh.b.setTextColor(Color.argb(102, 255, 255, 255));
    paramafmh.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(a("https://qzonestyle.gtimg.cn/aoi/sola/20190920103348_9H32GY0LpT.png"));
  }
  ...
  protected View a(Context paramContext, int paramInt, afmh paramafmh)
  {
    View localView = LayoutInflater.from(paramContext).inflate(paramInt, null);
    return this.jdField_a_of_type_Bfvm.a(paramContext, localView, paramafmh, -1);
  }
  
  protected View a(Context paramContext, int paramInt, afmi paramafmi)
  {
    View localView = LayoutInflater.from(paramContext).inflate(paramInt, null);
    return this.jdField_a_of_type_Bfvm.a(paramContext, localView, paramafmi, -1);
  }
  ...
  protected bfvm a(Context paramContext)
  {
    ...
    return new afme(this, 1, 2, new int[] { i, j }, -1, paramContext, arrayOfInt1, arrayOfInt2);
  }
  ...
  public void a(TextView paramTextView, MayKnowRecommend paramMayKnowRecommend)
  {
    ...
    String str = paramMayKnowRecommend.getDisplayName(this.jdField_a_of_type_Akac.a());
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((this.jdField_b_of_type_Int != 23) && (this.jdField_a_of_type_Afsa.c()))
    {
      this.jdField_b_of_type_AndroidViewView.setVisibility(8);
      this.jdField_a_of_type_AndroidViewView.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(2131699206);
      this.jdField_c_of_type_AndroidViewView.setVisibility(0);
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A5D3", "0X800A5D3", 0, 0, "2", "", "", "");
      return;
    }
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    Object localObject = ((ajxn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    ArrayList localArrayList = ((amdk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(112)).a();
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      paramViewGroup = new afmh();
      paramView = a(this.jdField_a_of_type_AndroidContentContext, 2131561126, paramViewGroup);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368511));
      paramViewGroup.b = ((TextView)paramView.findViewById(2131378175));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378378));
      paramViewGroup.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131363476));
      ...
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "frd_list", "info_add_exp", 2, 0, "", "", "", "");
      paramViewGroup = null;
    ...
    for (;;)
    {
      ...
      if ((paramView == null) || (!(paramView.getTag() instanceof afmi)))
      {
        ...
        paramViewGroup.e = ((TextView)paramView.findViewById(2131376657));
        paramView.setTag(paramViewGroup);
      ...
      paramViewGroup = (afmi)paramView.getTag();
      break;
      label778:
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131375333: 
      ...
      do
      {
        ...
        if ((!((ajxn)localObject).b(paramView.uin)) && (!((ajxn)localObject).d(paramView.uin)))
        {
          ...
          localObject = paramView.getDisplayName(this.jdField_a_of_type_Akac.a());
          ...
          ((Intent)localObject).putExtra("key_param_age_area", bazo.a(this.jdField_a_of_type_AndroidContentContext, paramView.gender, paramView.age, paramView.country, paramView.province, paramView.city));
        ...
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "frd_list", "info_add_clk", 2, 0, "", "", "", "");
      ...
      for (int i = 1;; i = 110)
      {
        ...
        String str = ((MayKnowRecommend)localObject).getRecommendName(this.jdField_a_of_type_Akac.a());
    ...
    {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A5D4", "0X800A5D4", 0, 0, "2", "", "", "");
      this.jdField_a_of_type_Afsa.b(true);
      return;
    }
    bcpw.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getResources().getString(2131692321), 0).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298865));
  }
