...
public class ucq
  extends Handler
{
  public ucq(TroopInfoActivity paramTroopInfoActivity) {}
    ...
    do
    {
      ...
      do
      {
        ...
        if (paramMessage.what == 4)
        {
          ...
          for (paramMessage = this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.mRichFingerMemo;; paramMessage = this.a.getResources().getString(2131433099))
          {
        ...
        if (!paramMessage.isEmpty())
        {
          ...
          ((TextView)((View)localObject1).findViewById(2131366466)).setVisibility(0);
        }
