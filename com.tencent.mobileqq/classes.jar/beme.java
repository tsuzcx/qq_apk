  ...
  implements DialogInterface.OnCancelListener
{
  ...
  private void a()
  {
    ...
    if (k < m)
    {
      ...
      for (;;)
      {
        ...
        continue;
        bffu.a(getContext(), 8.0F);
        j = this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131165735);
        localObject2 = new SpannableString(((Button)localObject1).getText());
        Object localObject3 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130840862);
    ...
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      ((Button)localObject2).setText(2131694208);
  ...
  public TextView a(String paramString)
  {
    try
    {
      ...
      localButton.setBackgroundResource(2130840714);
      localButton.setClickable(false);
      return localButton;
    }
    catch (Exception paramString)
    {
      besl.d("ActionSheetDialog", "e:" + paramString.toString());
    }
    return null;
  }
