  ...
  implements BusinessObserver
{
  ...
  private WeakReference<ryk> jdField_a_of_type_JavaLangRefWeakReference;
  @NotNull
  private final String b;
  
  public ryj(@NotNull ryk paramryk, @NotNull String paramString1, @NotNull String paramString2)
  {
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.b = paramString2;
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramryk);
  }
  ...
  private final void a(String paramString)
  {
    ...
    if (localObject != null)
    {
      localObject = (ryk)((WeakReference)localObject).get();
      if (localObject != null) {
        ((ryk)localObject).a(paramString);
      }
    }
  }
  ...
  private final void a(JSONObject paramJSONObject)
  {
    ...
    if (localObject != null)
    {
      localObject = (ryk)((WeakReference)localObject).get();
      if (localObject != null) {
        ((ryk)localObject).a(this.jdField_a_of_type_JavaLangString, paramJSONObject);
      }
    }
  }
