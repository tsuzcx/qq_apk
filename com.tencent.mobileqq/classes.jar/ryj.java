...
public class ryj
{
  private static final String jdField_a_of_type_JavaLangString = ryj.class.getSimpleName();
  ...
  public ryj(ColorBandVideoEntranceButton paramColorBandVideoEntranceButton, Context paramContext)
  {
    ...
    paramColorBandVideoEntranceButton = pha.a();
    ...
    for (;;)
    {
      this.jdField_a_of_type_Ocf = ((ocf)paramColorBandVideoEntranceButton.a(90));
      this.jdField_a_of_type_Ocg = new ryk(this, null);
      paramColorBandVideoEntranceButton.addObserver(this.jdField_a_of_type_Ocg);
      this.jdField_a_of_type_Rym = new rym(this, null);
      pmk.a().a(this.jdField_a_of_type_Rym);
      return;
      label121:
  ...
  {
    SharedPreferences localSharedPreferences = bmqa.a(this.jdField_c_of_type_JavaLangString);
  ...
  private VideoInfo a()
  {
    Object localObject = bmqa.a(this.jdField_c_of_type_JavaLangString);
  ...
  public static void a(tkf paramtkf)
  {
    ruo.a().a(paramtkf);
    if (paramtkf == null) {}
    label201:
    ...
    do
    {
      ...
      do
      {
        ...
        for (;;)
        {
          try
          {
            if (!(paramtkf instanceof VideoInfo)) {
              break label244;
            }
            localObject = (VideoInfo)paramtkf;
            ...
            if (localObject != null)
            {
              ...
              paramtkf = ((VideoInfo)localObject).jdField_g_of_type_JavaLangString;
              localJSONObject.put("rowkey", paramtkf);
              oat.a(null, "CliOper", "", "", "0X80081C6", "0X80081C6", 0, 0, "", "", "", localJSONObject.toString(), false);
              if (QLog.isColorLevel()) {
              ...
              oat.a(null, "", "0X8009A22", "0X8009A22", 0, 0, "", "", "", pha.a((VideoInfo)localObject, i), false);
              return;
            }
          }
          catch (Exception paramtkf)
          {
            paramtkf.printStackTrace();
            return;
          }
          i = 1;
          continue;
      ...
      oat.a(null, "", "0X80094FE", "0X80094FE", 0, 0, "", "", "", pha.a((VideoInfo)localObject, i), false);
      return;
    } while (!(paramtkf instanceof VideoInfo.EntranceDownloadInfo));
    paramtkf = (VideoInfo.EntranceDownloadInfo)paramtkf;
    Object localObject = new skc("", "", "", "");
    ((skc)localObject).V(1).a(paramtkf.jdField_c_of_type_JavaLangString).a(0);
    oat.a(null, "", "0X80094FE", "0X80094FE", 0, 0, "", "", "", ((skc)localObject).a().a(), false);
  }
  ...
  public static void b(tkf paramtkf)
  {
    ThreadManager.excute(new VideoFeedsFirstVideoRecommendationManager.1(paramtkf), 16, null, true);
  }
  ...
  private void e()
  {
    ...
    {
      localObject = bmqa.a(this.jdField_c_of_type_JavaLangString);
      if (localObject != null) {
  ...
  {
    boolean bool;
    if ((this.jdField_a_of_type_Ocf != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetReddotColorBandVideoEntranceButton != null) && (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetReddotColorBandVideoEntranceButton.getVisibility() == 0) && (!this.jdField_a_of_type_Boolean))
    {
      ocf localocf = this.jdField_a_of_type_Ocf;
      ocg localocg = this.jdField_a_of_type_Ocg;
      String str = this.jdField_b_of_type_JavaLangString;
      if (this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null)
      {
        bool = true;
        localocf.a(localocg, str, paramInt, bool);
        if (QLog.isColorLevel()) {
  ...
  public void b()
  {
    ...
    if ((localQQAppInterface != null) && (this.jdField_a_of_type_Ocg != null)) {
      localQQAppInterface.removeObserver(this.jdField_a_of_type_Ocg);
    }
  }
  ...
  public void c()
  {
    ...
    pmk.a().b(this.jdField_a_of_type_Rym);
  }
  ...
  public void d()
  {
    ...
    {
      this.jdField_a_of_type_Ocf = ((ocf)localQQAppInterface.a(90));
      localQQAppInterface.addObserver(this.jdField_a_of_type_Ocg);
