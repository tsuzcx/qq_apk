...
class axsl
  extends Handler
{
  public axsl(Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    {
      if (axsk.a() == null) {
        axsk.a(bbuv.a(Environment.getExternalStorageDirectory().getPath() + "/tencent/msflogs/" + "com.tencent.mobileqq".replace(".", File.separator) + "/battery/"));
      }
      axsk.b(axsk.a() + axsk.b() + "_" + axsk.a() + ".log");
      axsk.c(axsk.a() + axsk.b() + "_" + axsk.a() + ".rpt");
      paramMessage = new File(axsk.a());
      Object localObject1 = new File(axsk.c());
      localObject3 = new File(axsk.d());
      try
      {
        ...
        axsk.a(new BufferedWriter(new FileWriter((File)localObject1), 8192));
        ((File)localObject3).createNewFile();
        axsk.b(new BufferedWriter(new FileWriter((File)localObject3), 8192));
        localObject1 = null;
        ...
        axsk.b(new Object[] { "header", localObject3, AppSetting.g(), "pub", localObject1, Build.MANUFACTURER, Build.MODEL, Integer.valueOf(Build.VERSION.SDK_INT), Long.valueOf(axsk.a()), "1.3" });
        return;
      }
    ...
    else
    {
      ...
      {
        if (axsk.a() == null) {
          axsk.a(bbuv.a(Environment.getExternalStorageDirectory().getPath() + "/tencent/msflogs/com/tencent/mobileqq/battery/"));
        }
        label830:
        for (;;)
        {
          try
          {
            localObject2 = new File(axsk.a()).listFiles();
            ...
            try
            {
              long l = axsk.a((File)localObject3);
