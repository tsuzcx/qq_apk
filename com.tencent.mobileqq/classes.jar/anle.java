...
{
  anle(Context paramContext, QQAppInterface paramQQAppInterface, Emoticon paramEmoticon, anfj paramanfj, SessionInfo paramSessionInfo, EmojiStickerManager.StickerInfo paramStickerInfo) {}
  ...
  public void a(EmoticonPackage paramEmoticonPackage)
  {
    ...
    if ((paramEmoticonPackage != null) && ((2 != paramEmoticonPackage.status) || (!paramEmoticonPackage.valid))) {
      if (paramEmoticonPackage.jobType == 4)
      {
        ...
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X8005C13", 0, 0, "", "", "", "");
      }
    }
    do
    {
      ...
      bool = false;
      break;
      if (!this.jdField_a_of_type_Anfj.c()) {
        break label483;
      }
      if (this.jdField_a_of_type_Anfj.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, Boolean.valueOf(false))) {
        break label170;
      }
      ChatActivityUtils.a(this.jdField_a_of_type_AndroidContentContext, 2131624423, 0);
    ...
    return;
    label170:
    Object localObject = arhf.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, 0);
    if ((localObject != null) && (((argn)localObject).a))
    {
      if (arhw.a())
      {
    ...
    do
    {
      ...
      return;
      int j = argh.a(arhf.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, 0));
      int i = 0;
      ...
      if ((localObject != null) && (!((argn)localObject).c))
      {
        aael.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqDataEmoticon);
        awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X800579D", 0, 0, this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId, "", "", "");
        return;
      }
      localObject = ((FragmentActivity)this.jdField_a_of_type_AndroidContentContext).getChatFragment();
    } while (localObject == null);
    ((ChatFragment)localObject).a().a().a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon, new anlf(this, paramEmoticonPackage));
    return;
    label483:
    ChatActivityUtils.a(this.jdField_a_of_type_AndroidContentContext, 2131624440);
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X8005C16", 0, 0, "", "", "", "");
  }
}
