  ...
  implements CompoundButton.OnCheckedChangeListener
{
  ...
  public aqjo(Context paramContext, baxy parambaxy, QQAppInterface paramQQAppInterface)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (aqjn)paramView.getTag();
    }
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      localObject = (aqjn)paramCompoundButton.getTag();
      if (i == 0)
      {
        ...
        for (paramBoolean = true;; paramBoolean = false)
        {
          ...
          paramCompoundButton.setOnCheckedChangeListener(((aqjn)localObject).jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener);
          return;
          i = 2;
          break;
        }
      }
      ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(1)).a(Long.valueOf(((aqjn)localObject).jdField_a_of_type_JavaLangString).longValue(), paramBoolean);
      return;
    }
  }
}
