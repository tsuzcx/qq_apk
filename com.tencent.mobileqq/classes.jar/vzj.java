...
public class vzj
{
  ...
  public vzj(BaseActivity paramBaseActivity, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = vpm.b(paramBaseActivity, paramInt);
      return;
      bool = false;
    }
  }
  ...
  private void a(float paramFloat)
  {
    ...
    if (paramFloat > 0.5D)
    {
      ...
      this.b.setBackgroundResource(2130849547);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130839753);
    this.b.setBackgroundResource(2130849547);
    this.b.setTextColor(this.b.getContext().getResources().getColorStateList(2131166851));
    this.c.setTextColor(this.c.getContext().getResources().getColorStateList(2131166851));
  }
  
  public void a(View paramView)
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131377400));
    ...
    this.c = ((TextView)paramView.findViewById(2131368457));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368441));
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean2)
    {
      ...
      localValueAnimator.addUpdateListener(new vzk(this));
