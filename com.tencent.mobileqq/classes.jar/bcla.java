  ...
  extends bcgx
{
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (((localObject1 == null) || (!((String)localObject1).equals("1"))) || (paramBundle.getInt("accostType") == AbsStructMsg.SOURCE_ACCOUNT_TYPE_PA))
    {
      ...
      j = localResources.getDimensionPixelSize(2131298979);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          ((LinearLayout)localObject1).setBackgroundResource(2130838336);
        ...
        if (((LinearLayout)localObject1).getChildCount() == this.jdField_a_of_type_JavaUtilArrayList.size())
        {
          ...
          if (n < i1)
          {
            paramView = (bcgw)this.jdField_a_of_type_JavaUtilArrayList.get(n);
        ...
        do
        {
          ...
          for (;;)
          {
            ...
            else
            {
              if ("summary".equals(str))
              {
                ...
                if (i != 0)
                {
                  localObject2 = ((bclv)paramView).f();
                  if ((localObject2 == null) || (!((String)localObject2).equals("1"))) {
                    break label639;
                  }
                  if (TextUtils.isEmpty(((bclv)paramView).c())) {
                    ((TextView)localView).setTextSize(12.0F);
                  }
                  if (TextUtils.isEmpty(((bclv)paramView).d())) {
          ...
          localObject2 = (bcgw)this.jdField_a_of_type_JavaUtilArrayList.get(n);
        ...
        String str = ((bcgw)localObject2).jdField_a_of_type_JavaLangString;
        if ("picture".equals(str))
        {
          localView.setId(-1);
        ...
        for (;;)
        {
          ...
          else
          {
            if ("summary".equals(str))
            {
              if (i != 0)
              {
                str = ((bclv)localObject2).f();
                if ((str == null) || (!str.equals("1"))) {
                  break label1576;
                }
                if (TextUtils.isEmpty(((bclv)localObject2).c())) {
                  ((TextView)localView).setTextSize(12.0F);
                }
                if (TextUtils.isEmpty(((bclv)localObject2).d())) {
                  ((TextView)localView).setTextColor(Color.parseColor("#8e8e8e"));
                }
              }
              label1452:
              localObject2 = ((bclv)localObject2).f();
              if ((localObject2 != null) && (((String)localObject2).equals("1")))
              {
                paramView.topMargin = AIOUtils.dp2px(3.0F, localResources);
