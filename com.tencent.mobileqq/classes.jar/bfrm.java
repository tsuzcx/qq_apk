  ...
  extends Observable
{
  ...
  public bfrm(QQAppInterface paramQQAppInterface, Long paramLong)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bfrn(this, Looper.getMainLooper());
    this.jdField_a_of_type_Bgpp = new bfro(this);
    this.jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_JavaLangLong = paramLong;
  }
  
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, int paramInt, bgpp parambgpp)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject2).put("muid", MD5.toMD5(bhlo.a()));
      ((JSONObject)localObject2).put("carrier", bhlo.e());
      ((JSONObject)localObject2).put("conn", nnr.a());
      ...
      if (paramQQAppInterface != null)
      {
        ...
        new bgpo(paramQQAppInterface, "GET", parambgpp, paramInt, null, true).execute(new HashMap[] { localObject2 });
    ...
    for (;;)
    {
      ...
      else
      {
        try
        {
          ...
          {
            localTroopFeedItem.tag = anzj.a(2131714096);
            ...
            localObject = new ByteArrayInputStream(bdqf.a(localTroopNotificationCache.xmlBytes, i));
            localbfrp = new bfrp(this);
            SAXParserFactory.newInstance().newSAXParser().parse((InputStream)localObject, localbfrp);
            ((InputStream)localObject).close();
            if (localTroopNotificationCache.serviceID == 20)
            {
              localTroopFeedItem.title = localbfrp.jdField_a_of_type_JavaLangString;
              localTroopFeedItem.content = "";
              localTroopFeedItem.picPath = localbfrp.jdField_b_of_type_JavaLangString;
              localTroopFeedItem.linkUrl = localbfrp.jdField_d_of_type_JavaLangString;
          ...
          for (;;)
          {
            localTroopFeedItem.tag = anzj.a(2131714097);
            localTroopFeedItem.type = 133;
            break;
            localTroopFeedItem.title = localTroopNotificationCache.title;
            localTroopFeedItem.content = localbfrp.jdField_c_of_type_JavaLangString;
            break label282;
            i = 0;
            break;
            i = 0;
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      new bgpo("https://web.qun.qq.com/cgi-bin/announce/get_feed", "GET", this.jdField_a_of_type_Bgpp, paramInt, null, true).execute(new HashMap[] { localObject1 });
  ...
  public void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication();
    ((HashMap)localObject1).put("CONTEXT", MobileQQ.getContext());
    new bgpo("https://web.qun.qq.com/cgi-bin/announce/get_t_list", "GET", this.jdField_a_of_type_Bgpp, paramInt, null, true).execute(new HashMap[] { localObject1 });
    if (QLog.isColorLevel()) {
