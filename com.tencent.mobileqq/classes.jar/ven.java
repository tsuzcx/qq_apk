...
{
  public ven(StructingMsgItemBuilder paramStructingMsgItemBuilder) {}
    ...
    case 2131368523: 
      do
      {
        ...
        do
        {
          ...
          paramView = paramView.getContext().getResources().getDrawable(2130841453);
        ...
        localTroopTopicMgr.a((ChatMessage)localObject2, 1, new veo(this));
        return;
