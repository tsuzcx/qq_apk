...
public class aglr
{
  private aglv jdField_a_of_type_Aglv = new agls(this);
  ...
  public aglr(Context paramContext, String paramString)
  {
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Aglv = null;
    this.jdField_a_of_type_AndroidContentContext = null;
  }
  
  public void a(aglw paramaglw)
  {
    this.jdField_a_of_type_Aglw = paramaglw;
  }
  ...
  public void a(Context paramContext, ArrayList<IntimateInfo.MemoryDayInfo> paramArrayList)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout != null)
    {
      ...
      while (i < localArrayList.size())
      {
        ...
        localObject = new aglt(this, paramContext);
        if (localObject != null)
        {
          ((aglt)localObject).a(paramArrayList);
          ((aglt)localObject).a(this.jdField_a_of_type_Aglv);
          if (((aglt)localObject).a() != null) {
            this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(((aglt)localObject).a());
          }
        }
        i += 1;
        continue;
