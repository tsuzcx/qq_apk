...
public class aqqa
  ...
  implements Handler.Callback, bicg
{
  ...
  public aqqa(Context paramContext, QQAppInterface paramQQAppInterface, QQGamePubAccountFragment paramQQGamePubAccountFragment)
  {
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Aqqr = new aqqr(localRelativeLayout, this.jdField_a_of_type_AndroidContentContext);
  ...
  public void a(String paramString1, String paramString2, String paramString3, JSONObject paramJSONObject, String paramString4)
  {
    ...
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(actn.a(280.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), -1);
    ...
    TextView localTextView1 = (TextView)((View)localObject).findViewById(2131378389);
    if ((!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(paramString3)))
    {
      localTextView1.setText(paramString2);
      localTextView1.setTextColor(aqst.a(-16733441, 1593879295));
      ((ImageView)((View)localObject).findViewById(2131361894)).setImageDrawable(URLDrawable.getDrawable("https://cmshow.gtimg.cn/client/gameCenter/gameCenter_arrow@2x.png"));
      paramString2 = (CheckBox)((View)localObject).findViewById(2131364186);
      TextView localTextView2 = (TextView)((View)localObject).findViewById(2131378093);
      TextView localTextView3 = (TextView)((View)localObject).findViewById(2131378225);
      localTextView3.setTextColor(aqst.a(-16733441, 1593879295));
      ...
      paramString2.setOnCheckedChangeListener(new aqqd(this, paramString1));
      localTextView2.setOnClickListener(new aqqe(this, paramString4));
      localTextView1.setOnClickListener(new aqqf(this, paramString4, paramString3));
      localTextView3.setOnClickListener(new aqqg(this, paramString4, paramJSONObject, (String)localObject));
      this.jdField_a_of_type_AndroidAppDialog.show();
      paramString1 = new HashMap();
      yod.a(paramString1, paramString4);
    ...
    for (;;)
    {
      ...
      yod.a(ajae.a(), "769", "205710", a().gameAppId, "76905", "1", "160", paramString1);
      return;
      localTextView1.setText(ajyc.a(2131710318));
      break;
      label410:
  ...
  {
    b();
    this.jdField_a_of_type_AndroidWidgetFrameLayout$LayoutParams.topMargin = actn.a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ...
    if (paramBoolean1)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131710302));
      return;
    }
    if (paramBoolean2)
    {
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131710304));
  }
  ...
  public void b()
  {
    if (this.jdField_b_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      ((FrameLayout.LayoutParams)localObject2).leftMargin = actn.a(7.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131710305));
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mFailedDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846254);
      ((URLDrawable.URLDrawableOptions)localObject1).mLoadingDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846254);
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      localObject3 = new LinearLayout.LayoutParams(actn.a(15.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(15.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      localFrameLayout.setLayoutParams(new RecyclerView.LayoutParams(-1, actn.a(120.0F, this.jdField_a_of_type_AndroidContentContext.getResources())));
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131710295));
      ...
      ((LinearLayout.LayoutParams)localObject3).leftMargin = actn.a(7.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      this.jdField_c_of_type_AndroidWidgetTextView.setText(ajyc.a(2131710320));
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.clearAnimation();
    this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajyc.a(2131710312));
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Bibq != null) {
      biby.b(this.jdField_a_of_type_Bibq);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.arg1 == 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131710313));
      return false;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
  ...
  {
    if (a(paramInt)) {
      if ((paramViewHolder instanceof aqqr)) {
        ((aqqr)paramViewHolder).a(this.jdField_a_of_type_ComTencentMobileqqGamecenterDataFeedsItemData$TopCardInfo, this);
      }
    }
    label27:
      ...
      do
      {
        do
        {
          do
          {
            ...
            if ((!(paramViewHolder instanceof aqqj)) && (!(paramViewHolder instanceof aqqh))) {
              break;
            }
          ...
          if ((localFeedsItemData.type == 1) || (localFeedsItemData.type == 2) || (localFeedsItemData.type == 3))
          {
            ...
            yod.a(ajae.a(), "769", "205021", a().gameAppId, "76902", "1", "160", paramViewHolder);
            return;
          }
        } while (localFeedsItemData.type != 4);
        ((aqqh)paramViewHolder).a(this, localFeedsItemData, paramInt);
        paramViewHolder = new HashMap();
        yod.a(paramViewHolder, localFeedsItemData.msgId);
        paramViewHolder.put(Integer.valueOf(2), localFeedsItemData.msgId);
        paramViewHolder.put(Integer.valueOf(6), localFeedsItemData.feedId);
        ...
        yod.a(ajae.a(), "769", "205021", a().gameAppId, "76902", "1", "160", paramViewHolder);
        return;
      } while (!(paramViewHolder instanceof aqrr));
      localFeedsItemData = a(paramInt);
    } while (localFeedsItemData == null);
    ((aqrr)paramViewHolder).a(localFeedsItemData);
    paramViewHolder = new HashMap();
    yod.a(paramViewHolder, localFeedsItemData.msgId);
    paramViewHolder.put(Integer.valueOf(2), localFeedsItemData.msgId);
    paramViewHolder.put(Integer.valueOf(6), localFeedsItemData.feedId);
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    if (this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt) != null)
    {
      if (paramInt == this.jdField_a_of_type_Int) {
        return this.jdField_a_of_type_Aqqr;
      }
      return new aqqb(this, (View)this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt));
    }
    if (this.jdField_b_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt) != null) {
      return new aqqc(this, (View)this.jdField_b_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt));
    }
    if (paramInt == 4)
    {
      ...
      ((LinearLayout)localObject1).setPadding(actn.a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, actn.a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ...
      Object localObject4 = new RelativeLayout.LayoutParams(-1, actn.a(45.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((RelativeLayout.LayoutParams)localObject4).setMargins(actn.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ...
      ((TextView)localObject4).setId(2131362885);
      ((TextView)localObject4).setEllipsize(TextUtils.TruncateAt.END);
      ((TextView)localObject4).setMaxWidth(actn.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      RelativeLayout.LayoutParams localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.setMargins(actn.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, actn.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      localLayoutParams2.leftMargin = actn.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      localLayoutParams2.addRule(6, 2131362885);
      localLayoutParams2.addRule(1, 2131362885);
      ((RelativeLayout)localObject2).addView((View)localObject4, localLayoutParams2);
      localObject4 = new TextView(this.jdField_a_of_type_AndroidContentContext);
      ((TextView)localObject4).setTextColor(-6052957);
      ...
      ((TextView)localObject4).setPadding(actn.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((TextView)localObject3).setEllipsize(TextUtils.TruncateAt.END);
      localObject3 = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject3).setMargins(0, actn.a(-1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actn.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ((RelativeLayout.LayoutParams)localObject3).addRule(6, 2131362885);
      ...
      localLayoutParams = new LinearLayout.LayoutParams(0, actn.a(71.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      localLayoutParams.weight = 3.0F;
      localLayoutParams.gravity = 16;
      ((LinearLayout)localObject1).addView((View)localObject2, localLayoutParams);
      paramViewGroup.addView((View)localObject1, localLayoutParams1);
      localObject1 = new ImageView(this.jdField_a_of_type_AndroidContentContext);
      localLayoutParams1 = new RelativeLayout.LayoutParams(-1, actn.a(1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((ImageView)localObject1).setImageDrawable(new ColorDrawable(-263173));
      ((ImageView)localObject1).setId(2131365269);
      ((ImageView)localObject1).setPadding(actn.a(25.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, 0, 0);
      localLayoutParams1.rightMargin = actn.a(4.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      paramViewGroup.addView((View)localObject1, localLayoutParams1);
      return new aqqh(paramViewGroup);
    }
    if ((paramInt == 5) || (paramInt == 7) || (paramInt == 6)) {
      return aqrw.a(this.jdField_a_of_type_AndroidContentContext, paramInt, paramViewGroup);
    }
    return new aqqj(LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559086, paramViewGroup, false));
  }
  
  public void onViewDetachedFromWindow(RecyclerView.ViewHolder paramViewHolder)
  {
    super.onViewDetachedFromWindow(paramViewHolder);
    if ((paramViewHolder instanceof aqqj))
    {
      paramViewHolder = (aqqj)paramViewHolder;
      if ((paramViewHolder.a != null) && (aqsn.a().a() == paramViewHolder.a))
      {
        paramViewHolder.a.i();
        paramViewHolder.a.l();
      }
