  ...
  extends slz<sxj>
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = skt.a("StoryGroupSvc.convert_group_id");
  }
  ...
  public slu a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new sxj(localRspConvertGroupId);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      urk.b("Q.qqstory.net:BatchNetHandler", a(), paramArrayOfByte);
    }
    return null;
  }
