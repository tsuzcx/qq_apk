  ...
  implements ManagedClientConnection
{
  ...
  private volatile plc jdField_a_of_type_Plc;
  private volatile boolean jdField_a_of_type_Boolean;
  
  public pld(ClientConnectionManager paramClientConnectionManager, ClientConnectionOperator paramClientConnectionOperator, plc paramplc)
  {
  ...
  {
    plc localplc = this.jdField_a_of_type_Plc;
    if (localplc == null) {
      return null;
    }
    return (OperatedClientConnection)localplc.b();
  }
  ...
  {
    plc localplc = this.jdField_a_of_type_Plc;
    this.jdField_a_of_type_Plc = null;
    return localplc;
  }
  ...
  public void abortConnection()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 34	pld:jdField_a_of_type_Plc	Lplc;
    //   6: ifnonnull +6 -> 12
    //   9: aload_0
    //   10: monitorexit
    //   11: return
    //   12: aload_0
    //   13: iconst_0
    //   14: putfield 36	pld:jdField_a_of_type_Boolean	Z
    //   17: aload_0
    //   18: getfield 34	pld:jdField_a_of_type_Plc	Lplc;
    //   21: invokevirtual 48	plc:b	()Ljava/lang/Object;
    //   24: checkcast 50	org/apache/http/conn/OperatedClientConnection
    //   27: astore_1
    //   28: aload_1
    //   29: invokeinterface 61 1 0
    //   34: aload_0
    //   35: getfield 30	pld:jdField_a_of_type_OrgApacheHttpConnClientConnectionManager	Lorg/apache/http/conn/ClientConnectionManager;
    //   38: aload_0
    //   39: aload_0
    //   40: getfield 40	pld:jdField_a_of_type_Long	J
    //   43: getstatic 67	java/util/concurrent/TimeUnit:MILLISECONDS	Ljava/util/concurrent/TimeUnit;
    //   46: invokeinterface 73 5 0
    //   51: aload_0
    //   52: aconst_null
    //   53: putfield 34	pld:jdField_a_of_type_Plc	Lplc;
    //   56: aload_0
    //   57: monitorexit
    //   58: return
    //   59: astore_1
  ...
  public void close()
  {
    ...
    if (localplc != null)
    {
      OperatedClientConnection localOperatedClientConnection = (OperatedClientConnection)localplc.b();
      localplc.a();
  ...
  public void layerProtocol(HttpContext paramHttpContext, HttpParams paramHttpParams)
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Plc == null) {
        throw new ConnectionShutdownException();
      }
    }
    finally {}
    Object localObject = this.jdField_a_of_type_Plc.a();
    ...
    OperatedClientConnection localOperatedClientConnection = (OperatedClientConnection)this.jdField_a_of_type_Plc.b();
    ...
    this.jdField_a_of_type_Plc.a().layerProtocol(localOperatedClientConnection.isSecure());
  }
  ...
  public void open(HttpRoute paramHttpRoute, HttpContext paramHttpContext, HttpParams paramHttpParams)
  {
    ...
    if (this.jdField_a_of_type_Plc.a().isConnected()) {
    ...
    for (;;)
    {
      ...
      catch (Exception paramHttpRoute)
      {
        ...
        continue;
        paramHttpRoute = this.jdField_a_of_type_Plc.a();
        if (localHttpHost2 != null) {
          break;
        }
      }
  ...
  public void tunnelProxy(HttpHost paramHttpHost, boolean paramBoolean, HttpParams paramHttpParams)
  {
    ...
    this.jdField_a_of_type_Plc.a().tunnelProxy(paramHttpHost, paramBoolean);
  }
  ...
  public void tunnelTarget(boolean paramBoolean, HttpParams paramHttpParams)
  {
    ...
    this.jdField_a_of_type_Plc.a().tunnelTarget(paramBoolean);
  }
