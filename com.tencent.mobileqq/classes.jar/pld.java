...
public class pld
{
  ...
  {
    SharedPreferences localSharedPreferences = bkwm.a(pay.a(), true, true);
  ...
  public static boolean a(pkz parampkz)
  {
    if (a()) {
      return true;
    }
    ThreadManager.post(new ReadInjoyWebRenderSoLoader.1(parampkz), 8, null, true);
    return false;
  }
  
  private static void c()
  {
    Object localObject = bkwm.a(pay.a(), true, true);
    if (localObject == null)
    {
  ...
  private static boolean c(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        String str = a();
        FileUtils.deleteFile(str + paramString);
      }
