...
public class aetr
  implements Runnable
{
  public aetr(NearbyProfileEditPanel paramNearbyProfileEditPanel) {}
  ...
  public void run()
  {
    ...
    this.a.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.runOnUiThread(new aets(this));
  }
}
