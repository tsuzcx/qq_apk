  ...
  implements View.OnClickListener
{
  ...
  public baks(BaseBubbleBuilder paramBaseBubbleBuilder)
  {
  ...
  {
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A36C", "0X800A36C", paramInt, 0, "", "", "", "");
  }
  
  private boolean a(View paramView, MessageForReplyText paramMessageForReplyText)
  {
    Object localObject1 = ahgl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForReplyText.frienduin, paramMessageForReplyText.istroop, paramMessageForReplyText, paramMessageForReplyText.mSourceMsgInfo);
    ...
    else if (paramMessageForReplyText.isBarrageMsg)
    {
      ...
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A885", "0X800A885", 0, 0, "", "", "", "");
    }
    boolean bool1;
    label351:
    int i;
    for (;;)
    {
      ...
      if ((paramView.getId() == 2131364407) || (paramView.getId() == 2131378666)) {
        break label635;
      }
      return false;
      ...
      if ((localObject2 instanceof MessageForShortVideo))
      {
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A886", "0X800A886", 0, 0, "", "", "", "");
      }
      else if (atvo.a((MessageRecord)localObject2))
      {
        localObject1 = ahgl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject2);
        if ((localObject1 instanceof MessageForFile))
        {
          ...
          if (localObject1 != null)
          {
            i = atvo.a(((FileManagerEntity)localObject1).fileName);
            if (i == 0) {
              bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A885", "0X800A885", 0, 0, "", "", "", "");
            } else if (i == 2) {
              bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A886", "0X800A886", 0, 0, "", "", "", "");
        ...
        else if ((localObject1 instanceof MessageForTroopFile))
        {
          ...
          localObject1 = bfsj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForTroopFile)localObject1);
          if (localObject1 != null)
          {
            i = atvo.a(((bety)localObject1).g);
            if (i == 0) {
              bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A885", "0X800A885", 0, 0, "", "", "", "");
            } else if (i == 2) {
              bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A886", "0X800A886", 0, 0, "", "", "", "");
    ...
    {
      localObject1 = (ImageView)paramView.findViewById(2131378666);
      if (((MessageForShortVideo)localObject2).busiType != 0)
      {
        ...
        ShortVideoRealItemBuilder.a((QQAppInterface)localObject3, localContext, localMessageForShortVideo, (View)localObject2, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, false, true, ahgl.a(paramMessageForReplyText.mSourceMsgInfo, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), bool1, paramMessageForReplyText);
      }
      for (;;)
      {
        a(5);
        return true;
        ahhm.a((MessageForShortVideo)localObject2, 0L, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, ahgl.a(paramMessageForReplyText.mSourceMsgInfo, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), bool1, paramMessageForReplyText);
      }
      if ((localObject2 instanceof MessageForText))
      {
        if ((paramView.getId() != 2131364407) && (paramView.getId() != 2131371338)) {
          return false;
        }
        if (paramView.getId() != 2131364407) {
          break label2603;
        }
        paramMessageForReplyText = (ETTextView)paramView.findViewById(2131371338);
      ...
      {
        if ((paramView.getId() != 2131364407) && (paramView.getId() != 2131371338) && (paramView.getId() != 2131378666)) {
          return false;
        }
        if (((localObject2 instanceof MessageForMixedMsg)) && ((paramView.getId() == 2131364407) || (paramView.getId() == 2131371338)))
        {
          if (paramView.getId() != 2131364407) {
            break label2592;
          }
        ...
        for (;;)
        {
          ...
          if (((localObject2 instanceof MessageForPic)) && (!(paramView instanceof URLImageView)))
          {
            ...
            if (ahdu.a((MessageForPic)localObject1)) {
              AIOEmotionFragment.a(this.jdField_a_of_type_AndroidContentContext, (MessageRecord)localObject1, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, abga.a(paramView), ahgl.a(paramMessageForReplyText.mSourceMsgInfo, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), false);
            }
            for (;;)
            {
              return true;
              ahdu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, null, (MessageForPic)localObject2, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, true, ahgl.a(paramMessageForReplyText.mSourceMsgInfo, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), bool1, paramMessageForReplyText);
            }
          }
          paramView = (URLImageView)paramView;
          localObject1 = (MessageForPic)paramView.getTag(2131364393);
            ...
            if (bgmg.a(this.jdField_a_of_type_AndroidContentContext))
            {
              ...
              if (!((URLDrawable)localObject3).isDownloadStarted())
              {
                ...
                if (ahdu.a((MessageForPic)localObject1)) {
                  ...
                  ahdu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramView, (ChatMessage)localObject1, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, true, ahgl.a(paramMessageForReplyText.mSourceMsgInfo, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), bool1, paramMessageForReplyText);
                }
              }
            }
          }
      ...
      {
        paramView = ahgl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject2);
        ...
        if ((paramView instanceof MessageForFile))
        {
          ...
          if (localObject1 != null)
          {
            ...
            if (i == 0)
            {
              atwt.a(this.jdField_a_of_type_AndroidContentContext, null, (MessageForFile)paramView, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, false, true, true, paramMessageForReplyText);
              a(6);
              return true;
            }
            if (i == 2)
            {
              ...
              if (!atwt.a((FileManagerEntity)localObject1)) {
                return true;
              }
              i = 0;
              ...
              for (;;)
              {
                atwt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (MessageForFile)paramView, null, i, 10004, (FileManagerEntity)localObject1, false, true);
                break;
            ...
            for (;;)
            {
              paramView = new atpw(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, (FileManagerEntity)localObject1, 10004);
              ...
              paramView = new atpy(this.jdField_a_of_type_AndroidContentContext, paramView);
              paramView.a(i);
              paramView.a();
              break;
              if (((FileManagerEntity)localObject1).peerType == 3000) {
        ...
        else if ((paramView instanceof MessageForTroopFile))
        {
          ...
          localObject1 = bfsj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView);
          if (localObject1 != null)
          {
            if (((bety)localObject1).b == 12)
            {
            ...
            if (i == 2)
            {
              ...
              atwt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramView, l, (bety)localObject1, paramView.senderuin, paramView.lastTime, 3, 3, null, false, true, true);
            }
            for (;;)
            {
              a(6);
              return true;
              if (i == 0) {
                switch (((bety)localObject1).b)
                {
                case 4: 
                case 5: 
                default: 
                  ahdu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, null, paramView, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, true, ahgl.a(paramMessageForReplyText.mSourceMsgInfo, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface), bool1, paramMessageForReplyText);
                  break;
                case 0: 
                case 1: 
                case 2: 
                ...
                atwt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramMessageForReplyText, l, (bety)localObject1, paramView.senderuin, paramView.lastTime, 3, 3, null, false, true);
              }
            }
          }
        }
      ...
      {
        if (!ambv.a((MessageRecord)localObject2)) {
          return false;
        }
        if (ahgl.c((MessageRecord)localObject2)) {
          return false;
        }
        if ((((MessageForStructing)localObject2).structingMsg != null) && ((((MessageForStructing)localObject2).structingMsg instanceof AbsShareMsg)))
        {
          ...
          if ((paramMessageForReplyText instanceof StructMsgForGeneralShare))
          {
            ...
            localObject2 = new bcwp(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView, (StructMsgForGeneralShare)localObject1);
            StructMsgForGeneralShare.onClickEvent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, (StructMsgForGeneralShare)localObject1, paramView, (bcwp)localObject2);
    ...
    for (;;)
    {
      try
      {
        ...
        label1041:
        label1426:
        if ((paramMessageForReplyText != null) && (aqnw.a().a(paramMessageForReplyText.appName, paramMessageForReplyText.appView)))
        {
          a(aqnw.a(paramMessageForReplyText.appName, paramMessageForReplyText.appView));
          localObject2 = aqnw.a().a(new JSONObject(paramMessageForReplyText.toAppXml()));
      ...
      continue;
      label2567:
      apkd.a((String)localObject2, 0, paramMessageForReplyText.appName);
      return true;
      label2580:
      localObject1 = null;
      continue;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      {
        afur.n = true;
        localObject1 = bgva.a(localMessageForReplyText.action);
        localObject1 = bgng.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView.getContext(), (String)localObject1);
        if (localObject1 != null) {
          ((bgmp)localObject1).a();
        }
      }
      ...
      case 2131369181: 
        ...
        {
          localObject2 = ahgl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForReplyText.frienduin, localMessageForReplyText.istroop, localMessageForReplyText, localMessageForReplyText.mSourceMsgInfo);
          ...
          if (((localObject1 instanceof MessageForUniteGrayTip)) && (((MessageForUniteGrayTip)localObject1).tipParam != null) && ((((MessageForUniteGrayTip)localObject1).tipParam.b == 1) || (((MessageForUniteGrayTip)localObject1).tipParam.b == 131073)))
          {
            ...
            label631:
            label636:
            for (int j = 2131696971;; j = 2131697066)
            {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0) && ((localObject2 instanceof ahzy))) {
            ((ahzy)localObject2).a(22, localSourceMsgInfo.origUid, localSourceMsgInfo.mSourceMsgTime, null, 1, 1);
          }
          for (;;)
          {
            ahgl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject1, "0X800A36A");
            break;
            ...
            else if ((localObject2 instanceof aicv))
            {
              ((BaseChatPie)localObject2).a(22, localSourceMsgInfo.mSourceMsgSeq, (int)(localMessageForReplyText.shmsgseq - localSourceMsgInfo.mSourceMsgSeq), localMessageForReplyText, 1, 1);
              if (QLog.isColorLevel()) {
        ...
        QQToast.a(this.jdField_a_of_type_AndroidContentContext, 2131696970, 0).b(((FragmentActivity)this.jdField_a_of_type_AndroidContentContext).getTitleBarHeight());
        break;
        if (QLog.isColorLevel()) {
