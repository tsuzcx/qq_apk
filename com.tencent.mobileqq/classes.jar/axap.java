...
public class axap
  ...
  implements Manager
{
  private alrl jdField_a_of_type_Alrl = new axar(this);
  private altm jdField_a_of_type_Altm = new axaq(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public axap(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Altm);
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Alrl);
  }
  ...
  public static axas a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, QQMessageFacade.Message paramMessage)
  {
    return new axas(paramQQAppInterface, paramString, paramInt1, paramInt2, paramMessage, null);
  }
  ...
  private QCallRecent a(MessageForVideo paramMessageForVideo)
  {
    ...
    localQCallRecent.lastCallMsg = bdil.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), paramMessageForVideo.text);
    ...
    catch (Exception paramMessageForVideo)
    {
      for (;;)
      {
        ...
        else
        {
          ...
          if (QLog.isColorLevel())
          {
            QLog.d("QCallFacade", 2, "getMessageToCallRecord java.lang.NumberFormatException: Invalid int: " + arrayOfString[1] + " msg byte " + bdeu.a(str));
            paramMessageForVideo = (MessageForVideo)localObject;
          }
        }
      }
  ...
  private void a(QCallRecent paramQCallRecent, String paramString)
  {
    ...
    if ((abti.d(paramQCallRecent.type)) && (paramQCallRecent.state == 5))
    {
      a(1);
      return;
    }
  ...
  public int a()
  {
    ...
    do
    {
      ...
      localObject = ((amnz)localObject).a(false);
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      {
        DiscussionMemberInfo localDiscussionMemberInfo = ((alrk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(localRecentUser.uin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      ...
      if ((localRecentUser.getType() != 0) || ((!FriendsStatusUtil.a(localRecentUser.uin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && (!afex.a(localRecentUser.uin, localRecentUser.getType(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)))) {
  ...
  public int a(MessageRecord paramMessageRecord, int paramInt)
  {
    ...
    while ((paramMessageRecord.msgtype != -2026) && (!abti.d(paramInt))) {
      return i;
    }
    return 1;
  }
  ...
  public String a(String paramString, boolean paramBoolean)
  {
    ...
    for (j = k;; j = k)
    {
      ...
      if ((j == 1) || (i == 1)) {
        if (paramBoolean) {
          if (paramString != null) {
            ((StringBuilder)localObject1).append(paramString).append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131696053));
          }
        }
      }
      for (;;)
      {
        ...
        {
          ((StringBuilder)localObject1).append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131696416));
        }
        else
        {
          ((StringBuilder)localObject1).append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131695845));
          continue;
          ((StringBuilder)localObject1).append(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131696010, new Object[] { "" + i, "" + j }));
        }
      }
      break label238;
      break label192;
    ...
    if (localIterator.hasNext())
    {
      ...
      for (;;)
      {
        ...
        if (localQCallRecord.time > l1)
        {
          ...
          localObject = azaf.a(-2016);
          ((MessageRecord)localObject).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131696102);
      ...
      for (((MessageRecord)localObject).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131696103);; ((MessageRecord)localObject).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131696101))
      {
  ...
  public void a(int paramInt, long paramLong, String paramString)
  {
    ...
    ((QCallRecord)localObject).time = ayzl.a();
    ...
    if (paramInt == 1)
    {
      ...
      ((QCallRecent)localObject).lastCallTime = ayzl.a();
  ...
  public void a(int paramInt, long paramLong, String paramString1, String paramString2)
  {
    ...
    localQCallRecent.lastCallTime = ayzl.a();
  ...
  public void a(long paramLong1, long paramLong2, boolean paramBoolean1, long paramLong3, boolean paramBoolean2)
  {
    ...
    while ((((alrk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(String.valueOf(paramLong1)) == null) || (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(String.valueOf(paramLong2)))) {
      return;
    }
  ...
  public void a(MessageForVideo paramMessageForVideo)
  {
    ...
    {
      azqs.b(localQQAppInterface, "CliOper", "", "", "0X8004067", "0X8004067", 0, 0, paramMessageForVideo, "", "", "");
    ...
    for (paramMessageForVideo = "1";; paramMessageForVideo = "0")
    {
      azqs.b(localQQAppInterface, "CliOper", "", "", "Msg_tab", "Call_history_count", 0, 0, paramMessageForVideo, "", "", "");
      break;
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    localQCallRecent.readTime = ayzl.a();
    if (QLog.isDevelopLevel()) {
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4)
  {
    ...
    do
    {
      ...
      } while ((localalto != null) && (!localalto.b(paramString1)));
    } while ((paramString1 == null) || ((paramInt1 == 3000) && (((alrk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramString1) == null)));
    paramString1 = a().a(paramString1, paramInt1);
    if ((paramInt4 == 6) || (paramInt4 == 5) || (paramString1.isMissedCall())) {
      paramString1.lastCallTime = ayzl.a();
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, long paramLong, String paramString2)
  {
    ...
    localaxat.a((QCallRecord)localObject);
    localObject = localaxat.a(paramString1, paramInt1);
    ...
    localaxat.d((QCallRecent)localObject);
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    paramString2.lastCallTime = ayzl.a();
  ...
  {
    int k = 0;
    Object localObject2 = (aufv)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(11);
    ...
    for (;;)
    {
      ...
      return;
      localObject2 = ((aufv)localObject2).c(paramString);
      break;
      label152:
      i = 0;
      break label57;
      ...
      break label77;
      label162:
      localObject1 = ((alto)localObject1).e(((PhoneContact)localObject2).uin);
      break label89;
      label177:
      j = 0;
      break label104;
