...
public class aegb
  extends Handler
{
  public aegb(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        if ((TroopMemberListActivity.b(this.a)) && (TroopMemberListActivity.d(this.a)))
        {
          ...
          paramMessage.obj = this.a.jdField_a_of_type_Aegv.a();
          TroopMemberListActivity.a(this.a, paramMessage);
        }
        return;
        this.a.k();
        ...
        {
          if (this.a.jdField_a_of_type_Aegv.b != null) {
            this.a.jdField_a_of_type_Aegv.b.clear();
          }
        ...
        QQToast.a(this.a, this.a.getString(2131691554), 0).b(this.a.jdField_a_of_type_AndroidViewView.getHeight());
      ...
      return;
    } while (this.a.jdField_a_of_type_Aegv == null);
    this.a.jdField_a_of_type_Aegv.a();
    return;
    ...
    for (this.a.n = "0"; this.a.jdField_a_of_type_Aegv != null; this.a.n = "1")
    {
      label1133:
      this.a.jdField_a_of_type_Aegv.a();
      return;
