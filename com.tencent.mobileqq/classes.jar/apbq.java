...
public abstract class apbq<DATA, CONFIG extends apck>
{
  ...
  protected final PriorityQueue<apbu> a;
  protected boolean a;
  protected float b;
  protected int b;
  protected long b;
  ...
  private void j()
  {
    try
    {
      this.jdField_a_of_type_Apck = this.jdField_a_of_type_Apbz.a(a());
      return;
    }
  ...
  private void k()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilHashMap != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localObject instanceof apbs)) {
          ((apbs)localObject).a();
        }
      }
  ...
  public long a()
  {
    return this.jdField_a_of_type_Apdi.a();
  }
  ...
  public final void a(long paramLong1, long paramLong2)
  {
    ...
    if (!this.jdField_a_of_type_JavaUtilPriorityQueue.isEmpty())
    {
      ...
      while (localIterator.hasNext())
      {
        apbu localapbu = (apbu)localIterator.next();
        localapbu.jdField_a_of_type_Long -= paramLong1;
        if (localapbu.jdField_a_of_type_Long <= 0L)
        {
          localIterator.remove();
          localapbu.jdField_a_of_type_Apbt.a(this);
        }
      }
    }
  }
  ...
  public void a(apdi paramapdi)
  {
    this.jdField_a_of_type_Apdi = paramapdi;
  }
  
  public void a(DATA paramDATA)
  {
    if ((apaz.a().a().a()) && (paramDATA == null)) {
  ...
  public boolean a(long paramLong)
  {
    ...
    while (paramLong - this.jdField_b_of_type_Long < this.jdField_a_of_type_Apdi.a()) {
      return false;
    }
    return true;
  }
  ...
  {
    return (this.jdField_a_of_type_Long > 0L) && (paramLong - this.jdField_a_of_type_Long >= this.jdField_a_of_type_Apdi.a());
  }
  ...
  {
    this.jdField_a_of_type_Apdi.a(paramFloat);
  }
  ...
  public boolean e()
  {
    return (this.jdField_a_of_type_Boolean) && (apcp.a());
  }
  ...
  public void f()
  {
    ...
    {
      apds.c("BaseDanmaku", "onFirstExposure, danmaku = " + toString());
      i();
      this.jdField_d_of_type_Boolean = true;
    }
    if ((this.jdField_a_of_type_Apbr != null) && (f1 <= 0.0F))
    {
      this.jdField_a_of_type_Apbr.a(this);
      this.jdField_a_of_type_Apbr = null;
    }
  }
  ...
  protected void i()
  {
    if (this.jdField_a_of_type_Apbz != null) {
      this.jdField_a_of_type_Apbz.a(this);
    }
  }
  
  public String toString()
  {
    return "BaseDanmaku" + this.jdField_a_of_type_Int + "[left:" + b() + ",top:" + c() + ",right:" + d() + ",bottom:" + e() + ", time:" + this.jdField_b_of_type_Long + ", mData=" + String.valueOf(this.jdField_a_of_type_JavaLangObject) + ", mType=" + a() + ", playerTime=" + this.jdField_a_of_type_Apbz.a() + "]";
  }
}
