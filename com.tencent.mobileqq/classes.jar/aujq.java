...
public class aujq
{
  ...
  public aujq(aujp paramaujp)
  {
    this.jdField_a_of_type_JavaLangString = paramaujp.jdField_a_of_type_JavaLangString;
    this.jdField_b_of_type_JavaLangString = paramaujp.jdField_b_of_type_JavaLangString;
    this.jdField_a_of_type_Int = paramaujp.jdField_a_of_type_Int;
    this.d = paramaujp.jdField_b_of_type_Int;
    this.e = paramaujp.jdField_c_of_type_Int;
    if (paramaujp.jdField_b_of_type_Boolean)
    {
      this.jdField_a_of_type_Long = paramaujp.d;
      this.jdField_a_of_type_ArrayOfByte = a(paramaujp.jdField_c_of_type_Long);
      this.jdField_b_of_type_Long = paramaujp.jdField_b_of_type_Long;
      this.jdField_b_of_type_ArrayOfByte = a(paramaujp.jdField_a_of_type_Long);
      return;
    }
    this.jdField_a_of_type_Long = paramaujp.jdField_b_of_type_Long;
    this.jdField_a_of_type_ArrayOfByte = a(paramaujp.jdField_a_of_type_Long);
  }
  ...
  public String a(String paramString)
  {
    ...
    try
    {
      paramString = bbdm.a(this.jdField_a_of_type_ComTencentQphoneBaseUtilCryptor.encrypt(paramString.getBytes(), this.jdField_a_of_type_ArrayOfByte));
      return paramString;
    }
  ...
  public String b(String paramString)
  {
    try
    {
      paramString = bbdm.a(paramString);
