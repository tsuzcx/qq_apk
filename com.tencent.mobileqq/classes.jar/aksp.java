...
public class aksp
{
  private static volatile aksp jdField_a_of_type_Aksp;
  ...
  private void b()
  {
    ...
    QIPCClientHelper.getInstance().getClient().addListener(new aksq(this));
    long l = System.currentTimeMillis();
    QIPCClientHelper.getInstance().getClient().connect(new aksr(this, l));
  }
