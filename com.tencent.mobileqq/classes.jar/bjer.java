  ...
  implements Manager, BusinessObserver
{
  ...
  public bjer(QQAppInterface paramQQAppInterface)
  {
  ...
  public ArrayList<QZoneMsgEntityNew> a()
  {
    ...
    //   13: aload_0
    //   14: getfield 101	bjer:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   17: ifnull +8 -> 25
    //   20: aload_0
    //   21: getfield 101	bjer:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   24: areturn
    //   25: aload_0
    //   26: invokevirtual 103	bjer:a	()Lcom/tencent/mobileqq/app/QQAppInterface;
    //   29: astore_2
    //   30: aload_2
    //   31: ifnonnull +12 -> 43
    //   34: ldc 71
    ...
    //   42: areturn
    //   43: aload_2
    //   44: invokevirtual 111	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawbx;
    //   47: invokevirtual 117	awbx:createEntityManager	()Lawbw;
    //   50: astore_2
    //   51: aload_2
    //   52: ldc 119
    //   54: iconst_0
    ...
    //   59: ldc 121
    //   61: ldc 123
    //   63: invokevirtual 128	awbw:a	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   66: astore_3
    //   67: aload_0
    //   68: new 130	java/util/ArrayList
    //   71: dup
    //   72: invokespecial 131	java/util/ArrayList:<init>	()V
    //   75: putfield 101	bjer:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   78: aload_3
    //   79: ifnull +68 -> 147
    //   82: aload_3
    ...
    //   130: aload_0
    //   131: getfield 101	bjer:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   134: aload 4
    ...
    //   148: ifnull +7 -> 155
    //   151: aload_2
    //   152: invokevirtual 152	awbw:a	()V
    //   155: aload_0
    //   156: getfield 101	bjer:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   159: areturn
    //   160: astore_3
    //   161: aconst_null
    //   162: astore_2
    ...
    //   175: ifnull -20 -> 155
    //   178: aload_2
    //   179: invokevirtual 152	awbw:a	()V
    //   182: goto -27 -> 155
    //   185: astore_3
    //   186: aconst_null
    //   187: astore_2
    ...
    //   189: ifnull +7 -> 196
    //   192: aload_2
    //   193: invokevirtual 152	awbw:a	()V
    //   196: aload_3
    //   197: athrow
    //   198: astore_3
    //   199: goto -11 -> 188
  ...
  public void a()
  {
    ...
    return;
    bjez localbjez = new bjez(localQQAppInterface.getLongAccountUin(), "", a(0), 1);
    localbjez.a(0);
    QzoneCommonIntent localQzoneCommonIntent = new QzoneCommonIntent(localQQAppInterface.getApplication(), apbf.class);
  ...
  public void a(MQLikeCell paramMQLikeCell, long paramLong)
  {
    ...
    {
      i = 0;
      localObject1 = new bjey(Long.valueOf(l), (String)localObject1, (String)localObject2, i, paramMQLikeCell.appid);
      ((bjey)localObject1).a(100);
      localObject2 = new QzoneCommonIntent(localQQAppInterface.getApplication(), apbf.class);
    ...
    for (;;)
    {
      ...
      ((QzoneCommonIntent)localObject2).setRequest((bizh)localObject1);
    ...
    do
    {
      ...
      if ((localObject1 instanceof QzoneMessageBoxRsp))
      {
        ...
        if (localObject1 != null)
        {
          ...
          localQQAppInterface.notifyObservers(bjes.class, paramInt, true, paramBundle);
          a((QZoneMsgEntityNew)localObject1, paramInt);
          return;
        }
        localQQAppInterface.notifyObservers(bjes.class, paramInt, false, paramBundle);
