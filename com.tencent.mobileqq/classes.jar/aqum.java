  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    try
    {
      ...
      localObject1 = baaw.encodeToString(((cmd0xccb.RspBody)localObject2).res_id.get().toByteArray(), 0);
    ...
    catch (Exception paramFromServiceMsg)
    {
      ...
      notifyObserver(paramIntent, 0, false, paramIntent.getExtras(), aquj.class);
      return;
    }
    int n;
    ...
    int k = j;
    int j = n;
    QLog.d("jubaoApiPlugin", 1, "servlet upload onReceive isSucess = " + bool + ",ssoResultCode = " + i1 + "oidbResultCode = " + i + "uuid:" + paramFromServiceMsg + " c2c_type:" + k + " service_type:" + j);
    if (bool)
    {
    ...
    notifyObserver(paramIntent, 0, bool, paramIntent.getExtras(), aquj.class);
    return;
    label770:
    for (;;)
    {
