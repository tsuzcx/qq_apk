  ...
  extends aqqt
{
  ...
  private yps jdField_a_of_type_Yps = new aqqv(this);
  ...
  private aqqu(aqpv paramaqpv, MessageRecord paramMessageRecord, int paramInt)
  {
    super(paramaqpv);
  ...
  void a(String paramString, int paramInt, aqqr paramaqqr)
  {
    ...
    //   19: aload_0
    //   20: getfield 56	aqqu:c	Ljava/lang/String;
    ...
    //   48: aload_0
    //   49: getfield 56	aqqu:c	Ljava/lang/String;
    ...
    //   61: ldc 158
    //   63: aload_0
    //   64: getfield 96	aqqu:k	Ljava/lang/String;
    ...
    //   94: aload_0
    //   95: getfield 56	aqqu:c	Ljava/lang/String;
    ...
    //   112: aload_3
    //   113: aload_0
    //   114: getfield 68	aqqu:jdField_a_of_type_Long	J
    //   117: iconst_0
    //   118: invokestatic 179	aqpv:a	(JZ)Ljava/lang/String;
    //   121: iconst_0
    //   122: invokeinterface 184 3 0
    //   127: return
    //   128: aload_0
    //   129: aload_3
    //   130: putfield 135	aqqu:jdField_a_of_type_Aqqr	Laqqr;
    //   133: aload_0
    //   134: aload_1
    //   135: invokestatic 66	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   138: putfield 144	aqqu:jdField_b_of_type_Long	J
    //   141: aload_0
    //   142: new 186	android/os/Bundle
    //   145: dup
    //   146: invokespecial 187	android/os/Bundle:<init>	()V
    //   149: putfield 132	aqqu:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   152: aload_0
    //   153: getfield 132	aqqu:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   156: ldc 40
    //   158: aload_0
    //   159: getfield 144	aqqu:jdField_b_of_type_Long	J
    ...
    //   168: aload_0
    //   169: getfield 52	aqqu:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   172: ifnull +26 -> 198
    //   175: aload_0
    //   176: getfield 52	aqqu:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   179: invokevirtual 198	java/lang/String:isEmpty	()Z
    //   182: ifne +16 -> 198
    //   185: aload_0
    //   186: getfield 132	aqqu:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   189: ldc 50
    //   191: aload_0
    //   192: getfield 52	aqqu:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   195: invokevirtual 195	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   198: aload_0
    //   199: getfield 132	aqqu:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   202: ldc 54
    //   204: aload_0
    //   205: getfield 56	aqqu:c	Ljava/lang/String;
    //   208: invokevirtual 195	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   211: aload_0
    //   212: getfield 132	aqqu:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   215: ldc 58
    //   217: aload_0
    //   218: getfield 60	aqqu:d	Ljava/lang/String;
    //   221: invokevirtual 195	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   224: aload_0
    //   225: getfield 72	aqqu:e	Ljava/lang/String;
    //   228: invokestatic 203	arni:b	(Ljava/lang/String;)Z
    //   231: ifeq +16 -> 247
    //   234: aload_0
    //   235: getfield 132	aqqu:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   238: ldc 70
    //   240: aload_0
    //   241: getfield 72	aqqu:e	Ljava/lang/String;
    //   244: invokevirtual 195	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   247: aload_0
    //   248: getfield 76	aqqu:f	Ljava/lang/String;
    //   251: invokevirtual 198	java/lang/String:isEmpty	()Z
    //   254: ifne +16 -> 270
    //   257: aload_0
    //   258: getfield 132	aqqu:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   261: ldc 74
    //   263: aload_0
    //   264: getfield 84	aqqu:h	Ljava/lang/String;
    //   267: invokevirtual 195	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   270: aload_0
    //   271: getfield 80	aqqu:g	Ljava/lang/String;
    //   274: invokevirtual 198	java/lang/String:isEmpty	()Z
    //   277: ifne +16 -> 293
    //   280: aload_0
    //   281: getfield 132	aqqu:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   284: ldc 78
    //   286: aload_0
    //   287: getfield 84	aqqu:h	Ljava/lang/String;
    //   290: invokevirtual 195	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   293: aload_0
    //   294: getfield 84	aqqu:h	Ljava/lang/String;
    //   297: invokevirtual 198	java/lang/String:isEmpty	()Z
    //   300: ifne +16 -> 316
    //   303: aload_0
    //   304: getfield 132	aqqu:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   307: ldc 82
    //   309: aload_0
    //   310: getfield 84	aqqu:h	Ljava/lang/String;
    //   313: invokevirtual 195	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   316: iload_2
    //   317: ifne +165 -> 482
    //   320: aload_0
    //   321: getfield 132	aqqu:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   324: ldc 205
    //   326: iconst_1
    ...
    //   333: aload_0
    //   334: getfield 48	aqqu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   337: invokestatic 66	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   340: lstore 4
    //   342: aload_0
    //   343: getfield 92	aqqu:j	Ljava/lang/String;
    ...
    //   367: aload_0
    //   368: getfield 56	aqqu:c	Ljava/lang/String;
    ...
    //   380: aload_0
    //   381: getfield 135	aqqu:jdField_a_of_type_Aqqr	Laqqr;
    //   384: aload_0
    //   385: getfield 68	aqqu:jdField_a_of_type_Long	J
    //   388: iconst_1
    //   389: invokestatic 179	aqpv:a	(JZ)Ljava/lang/String;
    //   392: iconst_0
    //   393: invokeinterface 184 3 0
    //   398: aload_0
    //   399: getfield 88	aqqu:i	Ljava/lang/String;
    ...
    //   421: aload_0
    //   422: getfield 56	aqqu:c	Ljava/lang/String;
    ...
    //   433: aload_0
    //   434: getfield 92	aqqu:j	Ljava/lang/String;
    ...
    //   451: aload_0
    //   452: getfield 28	aqqu:jdField_a_of_type_Aqpv	Laqpv;
    //   455: invokestatic 225	aqpv:a	(Laqpv;)Lcom/tencent/mobileqq/app/QQAppInterface;
    //   458: lload 4
    //   460: iload_2
    //   461: aload_0
    //   462: getfield 92	aqqu:j	Ljava/lang/String;
    //   465: aload_0
    //   466: getfield 144	aqqu:jdField_b_of_type_Long	J
    //   469: aload_0
    //   470: getfield 120	aqqu:jdField_a_of_type_Int	I
    //   473: aconst_null
    //   474: aload_0
    //   475: getfield 38	aqqu:jdField_a_of_type_Yps	Lyps;
    //   478: invokestatic 230	ypf:a	(Lcom/tencent/mobileqq/app/QQAppInterface;JILjava/lang/String;JILandroid/os/Bundle;Lyps;)V
    //   481: return
    //   482: iload_2
    //   483: sipush 3000
    //   486: if_icmpne +19 -> 505
    //   489: aload_0
    //   490: getfield 132	aqqu:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   493: ldc 205
    //   495: iconst_2
    ...
    //   510: aload_0
    //   511: getfield 132	aqqu:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   514: ldc 205
    //   516: iconst_3
    ...
    //   542: aload_0
    //   543: getfield 48	aqqu:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   554: aload_0
    //   555: getfield 56	aqqu:c	Ljava/lang/String;
    ...
    //   567: aload_0
    //   568: getfield 135	aqqu:jdField_a_of_type_Aqqr	Laqqr;
    //   571: aload_0
    //   572: getfield 68	aqqu:jdField_a_of_type_Long	J
    //   575: iconst_0
    //   576: invokestatic 179	aqpv:a	(JZ)Ljava/lang/String;
    //   579: iconst_0
    ...
    //   611: aload_0
    //   612: getfield 56	aqqu:c	Ljava/lang/String;
    ...
    //   624: aload_0
    //   625: getfield 135	aqqu:jdField_a_of_type_Aqqr	Laqqr;
    //   628: aload_0
    //   629: getfield 68	aqqu:jdField_a_of_type_Long	J
    //   632: iconst_0
    //   633: invokestatic 179	aqpv:a	(JZ)Ljava/lang/String;
    //   636: iconst_0
