...
public class bgjw
  extends aahm
{
  public bgjw(TroopFileTransferManager paramTroopFileTransferManager) {}
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d6.DownloadFileRspBody paramDownloadFileRspBody, Bundle paramBundle)
  {
    ...
    int i = auea.a(FileUtil.getExtension(((TroopFileTransferManager.Item)localObject1).FileName));
    paramInt = paramBundle.getInt("thumbNail");
    boolean bool2 = paramBundle.getBoolean("isPreview", false);
    paramBundle = new bgka();
    ...
    catch (NullPointerException localNullPointerException)
    {
      ...
      if (bool2)
      {
        bgjc.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.e, 700);
        paramBundle.jdField_a_of_type_Boolean = false;
        ((anrb)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.BIZ_TROOP_HANDLER)).c(paramBundle);
        return;
      }
    ...
    if (i < 0)
    {
      ...
      if (bool2)
      {
        ...
        if (TextUtils.isEmpty(paramBundle.c)) {
          paramBundle.c = anvx.a(2131714721);
        }
        paramBundle.jdField_a_of_type_Boolean = false;
        ((anrb)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.BIZ_TROOP_HANDLER)).c(paramBundle);
        return;
    ...
    while ((paramInt == 128) || (paramInt == 383) || (paramInt == 640))
    {
      ...
      this.a.jdField_a_of_type_ArrayOfBgkb[4].a(paramDownloadFileRspBody);
      return;
      if (i == -134)
      {
    ...
    if (!this.a.c((TroopFileTransferManager.Item)localObject1)) {
      this.a.jdField_a_of_type_ArrayOfBgkb[3].a(new TroopFileTransferManager.TaskHttpDownload(this.a, (TroopFileTransferManager.Item)localObject1));
    }
  }
}
