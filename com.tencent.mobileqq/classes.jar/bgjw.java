  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if ("com.qzone.topic.video.FakeFeed".equals(paramContext)) {
      if (!TextUtils.isEmpty(bgjv.a(this.a))) {}
    }
    int i;
    do
    {
      ...
      do
      {
        ...
        localObject2 = bgis.a(paramContext, i, j, true);
        ...
        try
        {
          ...
          this.a.a.callJs(bgjv.a(this.a), new String[] { ((JSONObject)localObject1).toString() });
          return;
        }
      ...
      } while (TextUtils.isEmpty(bgjv.a(this.a)));
      ...
      try
      {
        ...
        this.a.a.callJs(bgjv.a(this.a), new String[] { ((JSONObject)localObject2).toString() });
        return;
      }
      catch (JSONException paramContext)
      {
    ...
    } while ((!"com.qzone.h5.video.recordCallback".equals(paramContext)) || (TextUtils.isEmpty(bgjv.b(this.a))));
    ...
    Object localObject2 = bgis.a(paramContext, paramIntent.getIntExtra("param.thumbnailWidth", 0), paramIntent.getIntExtra("param.thumbnailHeight", 0), true);
    if (TextUtils.isEmpty((CharSequence)localObject2))
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if (bool)
        {
          ...
          ((JSONObject)localObject1).put("video_info", bgjv.a(this.a, paramIntent));
          this.a.a.callJs(bgjv.b(this.a), new String[] { ((JSONObject)localObject1).toString() });
          return;
        }
      }
      catch (JSONException paramContext)
