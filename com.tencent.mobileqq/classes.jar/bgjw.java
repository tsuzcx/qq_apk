  ...
  extends ApkgBaseInfo
{
  ...
  public bgjw(String paramString, MiniAppBaseInfo paramMiniAppBaseInfo)
  {
    super(paramString, paramMiniAppBaseInfo);
    this.jdField_a_of_type_JavaUtilMap = new HashMap();
  }
  
  public static bgjw a(String paramString1, String paramString2, MiniAppBaseInfo paramMiniAppBaseInfo)
  {
    if ((TextUtils.isEmpty(paramString1)) || (!new File(paramString1).exists())) {
      return null;
    }
    paramString1 = new bgjw(paramString1, paramMiniAppBaseInfo);
  ...
  public bgjx a()
  {
    ...
    try
    {
      localObject = bgkv.a((File)localObject);
      ...
      localbgjx.a = ((String)localObject);
      localbgjx.b = str;
      return localbgjx;
    }
  ...
  public String b(String paramString)
  {
    ...
    try
    {
      String str3 = bgkv.b(new File(getApkgFolderPath(), str2));
      paramString = str1;
  ...
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (!new File(getChildFileAbsolutePath(bgkl.a(paramString))).exists()) {
      return false;
    }
    return true;
  }
  ...
  {
    return bgkv.a(new File(c(paramString)));
  }
  ...
  public void init(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        this.mConfigStr = bgkv.b(new File(getApkgFolderPath() + "/" + paramString, "app-config.json"));
  ...
  public boolean isUrlResReady(String paramString, MiniAppBaseInfo paramMiniAppBaseInfo)
  {
    ...
    {
      return true;
      paramString = new File(bgjh.a(paramMiniAppBaseInfo, false), paramString).getAbsolutePath();
