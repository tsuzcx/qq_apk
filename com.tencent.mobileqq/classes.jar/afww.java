...
public class afww
  implements afwv, ark.RuntimeClassCallbackWrapper
{
  private afwu jdField_a_of_type_Afwu;
  private ark.VariantWrapper jdField_a_of_type_ComTencentArkArk$VariantWrapper;
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<QQAppInterface> jdField_a_of_type_JavaLangRefWeakReference;
  
  public afww(QQAppInterface paramQQAppInterface, String paramString)
  {
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Afwu != null)
    {
      this.jdField_a_of_type_Afwu.a(null);
      this.jdField_a_of_type_Afwu.a();
      this.jdField_a_of_type_Afwu = null;
    }
  }
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramArrayOfVariantWrapper))
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject)) && (((String)localObject).equalsIgnoreCase("sso")))
        {
          ...
          if (localObject != null) {}
          for (this.jdField_a_of_type_Afwu = new afxh((QQAppInterface)localObject, this.jdField_a_of_type_JavaLangString); this.jdField_a_of_type_Afwu.a(paramArrayOfVariantWrapper); this.jdField_a_of_type_Afwu = new afxf(this.jdField_a_of_type_JavaLangString))
          {
  ...
  {
    if ((this.jdField_a_of_type_Afwu == null) || (paramArrayOfVariantWrapper == null) || (paramArrayOfVariantWrapper.length < 2)) {}
    do
    {
      paramVariantWrapper.SetBool(false);
      return true;
    ...
    for (;;)
    {
      this.jdField_a_of_type_Afwu.a(this);
      if (!this.jdField_a_of_type_Afwu.b(paramArrayOfVariantWrapper)) {
        break;
      }
      paramVariantWrapper.SetBool(true);
      return true;
  ...
  protected boolean f(ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_Afwu.a(i);
        paramVariantWrapper.SetBool(true);
        return true;
  ...
  {
    boolean bool = false;
    if ((this.jdField_a_of_type_Afwu == null) || (paramArrayOfVariantWrapper == null) || (paramArrayOfVariantWrapper.length < 1))
    {
      paramVariantWrapper.SetBool(false);
      return true;
    }
    if (this.jdField_a_of_type_Afwu.a() == 0) {
      bool = true;
    }
        ...
        do
        {
          do
          {
            do
            {
              ...
              return true;
            } while (this.jdField_a_of_type_Afwu.a() != 0);
            str = this.jdField_a_of_type_Afwu.a();
          } while (str == null);
          paramArrayOfVariantWrapper = paramArrayOfVariantWrapper[1].GetString();
