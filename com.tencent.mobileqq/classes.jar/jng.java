...
{
  public jng(QQServiceForAV paramQQServiceForAV) {}
  ...
  protected void a(boolean paramBoolean, long paramLong1, int paramInt1, List paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    if ((paramBoolean) && (paramInt1 == 2))
    {
      ...
      paramList.removeObserver(this.a.jdField_a_of_type_ComTencentMobileqqAppTroopObserver);
    }
  }
  ...
  protected void a(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4, int paramInt4, int paramInt5, long paramLong)
  {
    ...
    paramString3.removeObserver(this.a.jdField_a_of_type_ComTencentMobileqqAppTroopObserver);
  }
