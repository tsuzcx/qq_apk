  ...
  implements alys
{
  ...
  WeakReference<atod> jdField_b_of_type_JavaLangRefWeakReference;
  int d = 0;
  
  public atnr(Context paramContext, PicInfo paramPicInfo)
  {
    ...
    if ((paramContext instanceof QQAppInterface)) {
      this.jdField_a_of_type_Alyz = ((alyz)paramContext.getManager(180));
    }
    for (;;)
    {
  ...
  public View a(int paramInt, Handler paramHandler, atod paramatod)
  {
    ...
    this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(paramatod);
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (!bool1)
      {
        ...
        {
          bool1 = alyq.b(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d);
          bool2 = bool1;
          if (bool1)
          {
            localURLImageView.setImageDrawable(URLDrawable.getDrawable(alyq.a(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d), a(paramHandler)));
            bool2 = bool1;
          }
        }
      }
      if (!bool2) {
        if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d))
        {
          ...
          if (this.jdField_a_of_type_Alyq.a(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d)) {
            this.jdField_b_of_type_Int = 0;
          }
          paramatod.a(paramInt, this.jdField_b_of_type_Int);
          label396:
          if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d))
    {
      ...
      if (!alyq.b(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d)) {
        this.jdField_a_of_type_Alyq.a(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d);
      }
    }
  }
  ...
  public void a(View paramView, int paramInt, atod paramatod)
  {
    ...
    if ((this.d != 1) && (this.d != 2) && (this.d != 3) && (this.d != 4))
    {
      ...
      if (this.jdField_b_of_type_Int > 0) {
        paramatod.b(paramInt, this.jdField_b_of_type_Int / 100);
      }
  ...
  public void a(String paramString, int paramInt)
  {
    if (paramString.equals(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d))
    {
      ...
      if ((this.jdField_b_of_type_JavaLangRefWeakReference != null) && (this.jdField_b_of_type_JavaLangRefWeakReference.get() != null)) {
        ((atod)this.jdField_b_of_type_JavaLangRefWeakReference.get()).b(this.jdField_a_of_type_Int, paramInt);
      }
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    Object localObject = (atod)this.jdField_b_of_type_JavaLangRefWeakReference.get();
    paramString = (URLImageView)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (localObject != null)
    {
      ((atod)localObject).a(this.jdField_a_of_type_Int, paramBoolean1);
      ((atod)localObject).a(this.jdField_a_of_type_Int);
    }
    ...
    for (paramBoolean2 = true;; paramBoolean2 = false)
    {
      ...
      if (paramBoolean1)
      {
        ...
        if (alyq.b(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d))
        {
          localObject = URLDrawable.getDrawable(alyq.a(this.jdField_a_of_type_ComTencentMobileqqNearbyPicbrowserPicInfo.d), a(paramString.getDrawable()));
