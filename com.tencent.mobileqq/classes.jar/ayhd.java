...
{
  static final int[] jdField_a_of_type_ArrayOfInt = { 2131377043, 2131377039, 2131377038, 2131377044, 2131377041, 2131377042, 2131377040 };
  int jdField_a_of_type_Int;
  private View.OnLongClickListener jdField_a_of_type_AndroidViewView$OnLongClickListener = new ayhv(this);
  ...
  private aqul jdField_a_of_type_Aqul = new ayhl(this);
  aydi jdField_a_of_type_Aydi;
  private ayif jdField_a_of_type_Ayif;
  ...
  private TransProcessorHandler jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new ayhu(this);
  ...
  private aqul jdField_b_of_type_Aqul = new ayhm(this);
  ...
  private aqul jdField_c_of_type_Aqul = new ayhw(this);
  ...
  public ayhd(NearbyPeopleProfileActivity paramNearbyPeopleProfileActivity)
  {
    ...
    if (Build.VERSION.SDK_INT >= 11) {
      this.jdField_a_of_type_Ayif = new ayif(this, this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.f);
    }
    ...
    int k = aydi.jdField_a_of_type_ArrayOfInt.length - 1;
    this.jdField_a_of_type_ArrayOfAxug = new axug[k];
    int j = 0;
    while (j < k)
    {
      this.jdField_a_of_type_ArrayOfAxug[j] = new axug(aydi.jdField_a_of_type_ArrayOfInt[j]);
      j += 1;
    }
  ...
  private RelativeLayout a(PicInfo paramPicInfo, Drawable paramDrawable)
  {
    ...
    if (Build.VERSION.SDK_INT >= 11)
    {
      ...
      localRelativeLayout.setOnDragListener(this.jdField_a_of_type_Ayif);
    }
  ...
  private void a(TextView paramTextView, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      if ((localRichStatus != null) && (!TextUtils.isEmpty(localRichStatus.actionText)))
      {
        ...
        {
          paramArrayOfByte = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_a_of_type_Bbvn.a(localRichStatus.actionId, 200);
  ...
  private void a(PicInfo paramPicInfo, View paramView)
  {
    ...
    paramPicInfo = bhdj.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, anvx.a(2131706804), 0, 0, null, null);
    paramPicInfo.setPositiveButton(2131694399, new ayie(this, paramPicInfo));
    paramPicInfo.show();
  }
  ...
  private void a(CustomImgView paramCustomImgView, PicInfo paramPicInfo, Drawable paramDrawable)
  {
    ...
    if (paramDrawable == null) {
      localObject = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getResources().getDrawable(2130845675);
    }
    try
    {
  ...
  private View b()
  {
    ...
    ((TextView)localObject).setText(anvx.a(2131706823));
  ...
  private boolean e()
  {
    ...
    if (!StringUtil.isEmpty(str))
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.b(anvx.a(2131706742));
        return false;
      }
    }
    else
    {
      this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.b(anvx.a(2131706755));
      return false;
    }
    return true;
  }
  ...
  private void j()
  {
    bkzi localbkzi = bkzi.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
    Object localObject = (DispatchActionMoveScrollView)localbkzi.findViewById(2131361981);
    ((DispatchActionMoveScrollView)localObject).dispatchActionMove = true;
    ((DispatchActionMoveScrollView)localObject).setBackgroundResource(17170445);
    localObject = (IphonePickerView)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity).inflate(2131561188, null);
    ((IphonePickerView)localObject).a(this.jdField_b_of_type_Aqul);
    if (this.jdField_h_of_type_AndroidWidgetEditText.getTag() != null)
    {
      ...
      ((IphonePickerView)localObject).setPickListener(new ayhz(this, j, localbkzi));
      localbkzi.a(new ayia(this));
    ...
    localbkzi.show();
    a(this.jdField_e_of_type_AndroidWidgetLinearLayout, localbkzi.a());
        ...
        if (((RelativeLayout)localObject).getChildCount() == 2) {
          if (j == 0)
          {
            ...
            if (this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(j) != null) {
              this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildAt(j).setContentDescription(anvx.a(2131706733) + (j + 1));
            }
          }
        }
      }
  ...
  private void m()
  {
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "dc00899", "grp_lbs", "", "data_card", "del_pho", 0, 0, "", "", "", "");
  }
  
  private void n()
  {
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "dc00899", "grp_lbs", "", "data_card", "up_gif", 0, 0, "", "", "", "");
  }
  ...
  private void o()
  {
    ...
    {
      Object localObject = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694247, new Object[] { this.jdField_a_of_type_JavaLangString });
      localObject = bhdj.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, (String)localObject, 0, 0, null, null);
      ((QQCustomDialog)localObject).setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694513), new ayid(this, (QQCustomDialog)localObject));
  ...
  private void p()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131706762));
    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131706723));
    ...
    localTextView.setOnClickListener(new ayhn(this));
    ...
    localTextView.setOnClickListener(new ayhp(this));
  ...
  private void q()
  {
    if (this.jdField_a_of_type_JavaUtilLinkedList.size() > 0)
    {
      Object localObject = new StringBuilder(anvx.a(2131706751));
  ...
  Intent a(String paramString)
  {
    ...
    localIntent.putExtra("PhotoConst.QZONE_COVER_CROP_LEFT_TITLE", anvx.a(2131706756));
                      ...
                      if ((paramInt2 == -1) && (paramIntent != null))
                      {
                        ...
                        for (;;)
                        {
                          try
                          {
                            ...
                            paramInt1 = j;
                            if (paramInt1 < this.jdField_a_of_type_ArrayOfAxug.length)
                            {
                              if (this.jdField_a_of_type_ArrayOfAxug[paramInt1].jdField_a_of_type_Int != paramInt2) {
                                break label406;
                              }
                              paramIntent = this.jdField_a_of_type_ArrayOfAxug[paramInt1];
                            ...
                            this.jdField_a_of_type_Aydi.a(this.jdField_a_of_type_ArrayOfAxug);
  ...
  protected void a(View paramView)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131366001));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getResources().getColor(2131167086));
    this.jdField_a_of_type_AndroidWidgetHorizontalScrollView = ((HorizontalScrollView)paramView.findViewById(2131366002));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131365982));
    ...
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131372671));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378219));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131365999));
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131366000));
    this.jdField_e_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131378020));
    ...
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131364357));
    this.jdField_d_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131369615));
    this.jdField_c_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131369616));
    this.jdField_e_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131365024));
    this.jdField_d_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131364799));
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131364798));
    this.jdField_g_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131364379));
    this.jdField_f_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131368260));
    this.jdField_g_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131381632));
    this.jdField_h_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131378015));
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)paramView.findViewById(2131367067));
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setVisibility(8);
    this.jdField_h_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131377037));
    ...
    paramView = (LinearLayout)this.jdField_b_of_type_AndroidViewView.findViewById(2131369761);
    this.jdField_a_of_type_Aydi = new aydi();
    this.jdField_a_of_type_Aydi.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, paramView);
    p();
  }
  ...
  public void a(NearbyPeopleCard paramNearbyPeopleCard)
  {
    ...
    else
    {
      ...
      this.jdField_a_of_type_JavaLangString = anvx.a(2131706752);
      if (!this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.godFlag) {
        break label1221;
      }
      this.jdField_d_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694238));
      this.jdField_a_of_type_AndroidWidgetButton.setContentDescription(anvx.a(2131706716));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new ayhf(this));
      e();
      ...
      this.jdField_e_of_type_AndroidWidgetTextView.setText(bgzv.d(j));
      if (!StringUtil.isEmpty(bgzv.d(j))) {
        break label1265;
      }
      this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_d_of_type_AndroidWidgetEditText.setText(bgzv.e(j));
      ...
      paramNearbyPeopleCard = (String)axqc.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_name", "");
      if (!this.jdField_b_of_type_Boolean)
      {
        ...
        this.i = ((Integer)axqc.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_valid_state", Integer.valueOf(0))).intValue();
        if (this.i != 2) {
          break label1287;
        }
      ...
      this.jdField_h_of_type_AndroidWidgetEditText.setText(bgzv.a(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.maritalStatus - 1));
      ...
      if (bgzv.a(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.vGiftInfo) == 0) {
        break label1428;
      }
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.godFlag)
      {
        paramNearbyPeopleCard = this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694248, new Object[] { this.jdField_a_of_type_JavaLangString });
        paramNearbyPeopleCard = bhdj.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity, paramNearbyPeopleCard, 0, 0, null, null);
        paramNearbyPeopleCard.setPositiveButton(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694513), new ayhg(this, paramNearbyPeopleCard));
      ...
      this.jdField_b_of_type_AndroidViewView.findViewById(2131378020).setOnClickListener(this);
      ...
      this.jdField_b_of_type_AndroidViewView.findViewById(2131369616).setOnClickListener(this);
      this.jdField_d_of_type_AndroidWidgetEditText.setOnClickListener(this);
      this.jdField_b_of_type_AndroidViewView.findViewById(2131368261).setOnClickListener(this);
      this.jdField_f_of_type_AndroidWidgetEditText.setOnClickListener(this);
      this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new ayhh(this));
      this.jdField_g_of_type_AndroidWidgetEditText.addTextChangedListener(new ayhi(this));
      this.jdField_e_of_type_AndroidWidgetEditText.addTextChangedListener(new ayhj(this));
      this.jdField_a_of_type_AndroidWidgetEditText.getViewTreeObserver().addOnGlobalLayoutListener(new ayhk(this));
      return;
      ...
      this.jdField_a_of_type_JavaLangString = anvx.a(2131706807);
      break label268;
      label1221:
      if (this.jdField_a_of_type_JavaUtilArrayList.size() <= NearbyPeopleProfileActivity.jdField_b_of_type_Int) {
        break label295;
      }
      this.jdField_d_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.getString(2131694239, new Object[] { this.jdField_a_of_type_JavaLangString }));
      break label295;
      label1265:
      this.jdField_e_of_type_AndroidWidgetTextView.setBackgroundResource(bgzv.b(j));
      this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(0);
      break label587;
      label1287:
      ...
      for (;;)
      {
        axqc.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_name", this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.college);
        axqc.a(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.getCurrentAccountUin(), "school_valid_state", Integer.valueOf(this.i));
        break;
        this.jdField_g_of_type_AndroidWidgetTextView.setVisibility(0);
        this.i = 2;
        continue;
  ...
  public boolean a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null)
    {
      ...
      Object localObject2 = this.jdField_a_of_type_ArrayOfAxug;
    ...
    for (int k = j;; k = j)
    {
      if (k != 0)
      {
        ...
        j = 0;
        break label440;
        localObject1 = ((axug)localObject1).toString();
        break label507;
      }
      return false;
      break;
  ...
  void e()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.oldPhotoCount > 0) && (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.age >= 14) && (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.age <= 24) && (this.jdField_a_of_type_JavaUtilArrayList.size() <= 1)) {
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X800481B", "0X800481B", 0, 0, "", "", "", "");
    }
    if (Build.VERSION.SDK_INT >= 11)
    {
  ...
  void g()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.a(anvx.a(2131706799));
    ...
    for (int j = 1;; j = 3)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null) && (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.gender == 0))
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard != null)
        {
          ...
          if ((this.jdField_h_of_type_AndroidWidgetEditText.getTag() != null) && (((Byte)this.jdField_h_of_type_AndroidWidgetEditText.getTag()).byteValue() != this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.maritalStatus))
          {
            ...
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 3, 0, "", "", "", "");
          }
          ...
          if (j != this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.job)
          {
            ...
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 6, 0, "", "", "", "");
          }
          ...
          if (!((String)localObject).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.company))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_d_of_type_Boolean = true;
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 7, 0, "", "", "", "");
          }
          ...
          if (!((String)localObject).equals(this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.college))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.jdField_d_of_type_Boolean = true;
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 8, 0, "", "", "", "");
          }
          ...
          if (!Arrays.equals((Object[])localObject, new String[] { this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.hometownCountry, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.hometownProvice, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.hometownCity, this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.hometownDistrict }))
          {
            ...
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X8004820", "0X8004820", 9, 0, "", "", "", "");
          }
          boolean bool2 = this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.a();
          if (this.jdField_a_of_type_ComTencentMobileqqDataNearbyPeopleCard.switchGiftVisible != 0L) {
            break label1242;
          ...
          if (bool2 != bool1)
          {
            ...
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X80060BB", "0X80060BB", 0, 0, "", "", "", "");
          }
          if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app.execute(new NearbyProfileEditPanel.23(this, (axqt)localObject, localBundle, localArrayList));
      }
      label1242:
      label1247:
      label1252:
      while (!QLog.isDevelopLevel())
      {
        ...
        j = 1;
        break label1110;
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app, "CliOper", "", "", "0X80060BC", "0X80060BC", 0, 0, "", "", "", "");
        break label1158;
      }
  ...
  public void onClick(View paramView)
  {
    ...
    if ((paramView.getId() == 2131367629) || (paramView == this.jdField_b_of_type_AndroidWidgetEditText))
    {
      ...
      ((IphonePickerView)localObject2).a(this.jdField_c_of_type_Aqul);
      if (this.jdField_b_of_type_AndroidWidgetEditText.getTag() != null)
      {
        ...
        ((IphonePickerView)localObject2).setPickListener(new ayhe(this, (IphonePickerView)localObject2, (bkzi)localObject1));
        ((bkzi)localObject1).a(new ayho(this));
    ...
    do
    {
      do
      {
        for (;;)
        {
          ...
          else if ((paramView.getId() == 2131368261) || (paramView == this.jdField_f_of_type_AndroidWidgetEditText))
          {
            c();
          }
          else if ((paramView.getId() == 2131381633) || (paramView == this.jdField_g_of_type_AndroidWidgetEditText))
          {
            i();
          }
          else
          {
            if ((paramView.getId() != 2131378020) && (paramView != this.jdField_h_of_type_AndroidWidgetEditText)) {
              break;
            }
            j();
          }
        }
      } while ((paramView.getId() != 2131362307) && (paramView != this.jdField_c_of_type_AndroidWidgetEditText));
      localObject1 = bkzi.c(this.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity);
    ...
    for (j = 0;; j = (j & 0xFF) - 1)
    {
      ...
      ((IphonePickerView)localObject3).setPickListener(new ayhx(this, (IphonePickerView)localObject3, (bkzi)localObject1));
      ...
      ((bkzi)localObject1).a(new ayhy(this));
