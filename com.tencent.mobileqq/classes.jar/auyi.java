...
public class auyi
{
  ...
  auyk jdField_a_of_type_Auyk = auyk.jdField_a_of_type_Auyk;
  String jdField_a_of_type_JavaLangString = "";
  boolean jdField_a_of_type_Boolean = false;
  auyk jdField_b_of_type_Auyk = auyk.jdField_a_of_type_Auyk;
  String jdField_b_of_type_JavaLangString = "";
  boolean jdField_b_of_type_Boolean = false;
  auyk jdField_c_of_type_Auyk = auyk.jdField_a_of_type_Auyk;
  boolean jdField_c_of_type_Boolean = false;
  auyk d = auyk.jdField_a_of_type_Auyk;
  auyk e = auyk.jdField_a_of_type_Auyk;
  auyk f = auyk.jdField_a_of_type_Auyk;
  auyk g = auyk.jdField_a_of_type_Auyk;
  auyk h = auyk.jdField_a_of_type_Auyk;
  auyk i = auyk.jdField_a_of_type_Auyk;
  auyk j = auyk.jdField_a_of_type_Auyk;
  ...
  private auyk a(JSONObject paramJSONObject)
  {
    boolean bool = true;
    if (paramJSONObject == null) {
      return auyk.jdField_a_of_type_Auyk;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        paramJSONObject = new auyk(bool, localSimpleDateFormat.parse(str), localSimpleDateFormat.parse(paramJSONObject));
  ...
  private void b()
  {
    this.jdField_a_of_type_Auyk = auyk.jdField_a_of_type_Auyk;
    this.jdField_b_of_type_Auyk = auyk.jdField_a_of_type_Auyk;
    this.jdField_c_of_type_Auyk = auyk.jdField_a_of_type_Auyk;
    this.d = auyk.jdField_a_of_type_Auyk;
    this.e = auyk.jdField_a_of_type_Auyk;
    this.f = auyk.jdField_a_of_type_Auyk;
    this.g = auyk.jdField_a_of_type_Auyk;
    this.h = auyk.jdField_a_of_type_Auyk;
    this.i = auyk.jdField_a_of_type_Auyk;
    this.j = auyk.jdField_a_of_type_Auyk;
  ...
  public void a(ConfigurationService.Config paramConfig)
  {
    ...
    if (m != k)
    {
      paramConfig = arcj.b(paramConfig, m, paramConfig.type.get());
      a(paramConfig);
      b(paramConfig);
    }
  ...
  void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Auyk = a(paramString.optJSONObject("webview_menu"));
        this.jdField_b_of_type_Auyk = a(paramString.optJSONObject("webview_launch_app"));
        this.jdField_c_of_type_Auyk = a(paramString.optJSONObject("scan_qrcode"));
        ...
        if (paramString.optInt("need_report_system_share_info_new") == 1)
        {
          ...
          JefsClass.getInstance().a(this.jdField_b_of_type_Auyk.a(), paramString);
        }
      }
