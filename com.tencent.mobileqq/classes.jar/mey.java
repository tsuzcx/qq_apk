...
public class mey
  implements Runnable
{
  public mey(VideoPlayManager paramVideoPlayManager, VideoPlayManager.VideoPlayParam paramVideoPlayParam, JSONObject paramJSONObject, VideoRecommendManager paramVideoRecommendManager) {}
  ...
  public void run()
  {
    ...
    for (localObject = "1";; localObject = "0")
    {
      ...
      PublicAccountReportUtils.a("0X8007408", this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoPlayManager$VideoPlayParam.j, "", "", "", str3);
      ...
      NativeAdUtils.a(null, VideoPlayManager.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoPlayManager), NativeAdUtils.f, NativeAdUtils.l, (AdvertisementInfo)localObject, null, 0L, NativeAdUtils.a(ReadInJoyBaseAdapter.h, (int)(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoPlayManager$VideoPlayParam.b / 1000L), ReadInJoyBaseAdapter.i, 0, ReadInJoyBaseAdapter.f, ReadInJoyBaseAdapter.g, ((BaseArticleInfo)localObject).mVideoDuration, NativeAdUtils.s));
      return;
    }
  }
}
