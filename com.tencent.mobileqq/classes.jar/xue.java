...
public class xue
  implements bhqd
{
  public xue(QRCardActivity paramQRCardActivity, boolean[] paramArrayOfBoolean, String paramString1, Context paramContext, String paramString2) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ArrayOfBoolean[0] == 1)
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Bhpy.dismiss();
          return;
          paramView = this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.app.getAccount();
          localObject = (String)this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Xxa.f.get(this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.k);
          if (!TextUtils.isEmpty(paramView))
          {
            ...
            paramView = (String)this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Xxa.f.get(this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.k);
      ...
      if (this.jdField_a_of_type_ArrayOfBoolean[2] == 1)
      {
        ...
        if (!this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Xxa.c.isEmpty()) {
          paramView.putAll(this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Xxa.c);
        }
        if (!this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Xxa.f.isEmpty()) {
          paramView.putAll(this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Xxa.f);
        }
        if (this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Xxa.e != null) {
          paramView.putAll(this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Xxa.e);
        }
        if (!this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Xxa.d.isEmpty()) {
          paramView.putAll(this.jdField_a_of_type_ComTencentBizQrcodeActivityQRCardActivity.jdField_a_of_type_Xxa.d);
        }
        switch (paramInt)
        {
        }
