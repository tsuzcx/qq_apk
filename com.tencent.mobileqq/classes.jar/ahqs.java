...
public class ahqs
  implements ahqr, Handler.Callback
{
  int jdField_a_of_type_Int = DisplayUtil.dip2px(BaseApplicationImpl.getContext(), 50.0F);
  private aewx jdField_a_of_type_Aewx;
  private ahqq jdField_a_of_type_Ahqq;
  Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new ahqt(this);
  ...
  private ArrayList<ahqu> jdField_a_of_type_JavaUtilArrayList;
  ...
  public ahqs(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, aewx paramaewx, XPanelContainer paramXPanelContainer, List<QQOperationViopTipTask> paramList)
  {
    this.jdField_a_of_type_MqqOsMqqHandler = new bjmp(Looper.getMainLooper(), this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo = paramSessionInfo;
    this.jdField_a_of_type_Aewx = paramaewx;
  ...
  private RelativeLayout a()
  {
    ...
    //   23: putfield 112	ahqs:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   26: aload_1
    //   27: astore_2
    //   28: new 114	java/io/File
    //   31: dup
    //   32: getstatic 120	ofx:h	Ljava/lang/String;
    ...
    //   74: getstatic 120	ofx:h	Ljava/lang/String;
    ...
    //   92: astore_2
    //   93: aload_0
    //   94: getfield 112	ahqs:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   97: aload_2
  ...
  private boolean a(ahqu paramahqu)
  {
    boolean bool3 = false;
    Object localObject1 = a(paramahqu.b());
    int i = -1;
    int[] arrayOfInt = paramahqu.a();
    boolean bool1;
    if (arrayOfInt != null)
    {
      if (this.jdField_a_of_type_Ahqq != null) {
        i = this.jdField_a_of_type_Ahqq.b();
      }
      boolean bool2 = true;
      int j = 0;
    ...
    for (;;)
    {
      if ((bool1) && ((paramahqu instanceof ahqq)) && (this.jdField_a_of_type_Ahqq != null) && (this.jdField_a_of_type_Ahqq.a() > ((ahqq)paramahqu).a()))
      {
  ...
  {
    if (this.jdField_a_of_type_Ahqq != null) {
      return this.jdField_a_of_type_Ahqq.b();
    }
    return -1;
  }
  ...
  public ahqq a()
  {
    return this.jdField_a_of_type_Ahqq;
  }
  ...
  public void a()
  {
    if (Thread.currentThread() == Looper.getMainLooper().getThread())
    {
      if (this.jdField_a_of_type_Aewx != null) {
        this.jdField_a_of_type_Aewx.a(this.jdField_a_of_type_Ahqq);
      }
      this.jdField_a_of_type_Ahqq = null;
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
      ...
      while (localIterator.hasNext()) {
        ((ahqu)localIterator.next()).a(paramInt, paramVarArgs);
      }
    }
  }
  
  public void a(ahqu paramahqu)
  {
    if (paramahqu == null) {}
    do
    {
    ...
    } while (this.jdField_a_of_type_JavaUtilArrayList.contains(paramahqu));
    this.jdField_a_of_type_JavaUtilArrayList.add(paramahqu);
  }
  ...
  public void a(View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setId(2131368139);
    }
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(paramOnClickListener);
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout == null) {
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentWidgetXPanelContainer.findViewById(2131364407));
    }
    if (this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368139) == null) {
  ...
  public boolean a(ahpr paramahpr, Object... paramVarArgs)
  {
    if (paramahpr != null)
    {
      if (a(paramahpr)) {
    ...
    {
      return false;
      paramVarArgs = paramahpr.a(paramVarArgs);
      if (paramVarArgs != null)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("TipsManager", 2, "showGrayTips() success: from " + a(paramahpr.b()));
        }
        return true;
      }
    } while (!QLog.isColorLevel());
    QLog.d("TipsManager", 2, "showGrayTips() failure: MessageRecord null, from " + a(paramahpr.b()));
    return false;
  }
  
  public boolean a(ahqq paramahqq, Object... paramVarArgs)
  {
    ...
    do
    {
      ...
      if (Thread.currentThread() == Looper.getMainLooper().getThread())
      {
        paramVarArgs = paramahqq.a(paramVarArgs);
        this.jdField_a_of_type_Aewx.a(paramVarArgs, paramahqq);
        this.jdField_a_of_type_Ahqq = paramahqq;
      }
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.d("TipsManager", 2, "showTipsBar() success: from " + a(paramahqq.b()));
        }
        return true;
        paramVarArgs = new TipsManager.1(this, paramahqq, paramVarArgs);
  ...
  public void c()
  {
    ...
    View localView1 = this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131379102);
    View localView2 = this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131379096);
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        int k = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131299076);
        if (i == -1) {
  ...
  public void d()
  {
    ...
    try
    {
      if ((this.jdField_b_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) && (this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131368139) != null))
      {
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(null);
        this.jdField_a_of_type_AndroidWidgetRelativeLayout.clearAnimation();
        this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131366947));
        this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131366948));
