...
public class avea
{
  ...
  public static Drawable a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      localObject1 = localObject3;
      if (a(paramQQAppInterface, paramString)) {
        localObject1 = bayh.b(paramQQAppInterface, paramString, (byte)3);
      }
      localObject2 = localObject1;
    } while (localObject1 != null);
    return bbef.b();
  ...
  public static PhoneContact a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localaskn != null)
    {
      PhoneContact localPhoneContact = localaskn.c(paramString);
      aumd localaumd = aume.a(paramString);
      paramQQAppInterface = localPhoneContact;
      if (localPhoneContact == null) {
        paramQQAppInterface = localaskn.b(localaumd.c);
      }
      paramString = paramQQAppInterface;
      if (paramQQAppInterface == null) {
        paramString = localaskn.b("+" + localaumd.a + localaumd.c);
      }
      paramQQAppInterface = paramString;
      if (paramString == null) {
        paramQQAppInterface = localaskn.b(localaumd.a + localaumd.c);
      }
      paramString = paramQQAppInterface;
      if (paramQQAppInterface == null) {
        paramString = localaskn.b("00" + localaumd.a + localaumd.c);
      }
      if (paramString == null) {
        return localaskn.b(localaumd.a + "-" + localaumd.c);
      }
      return paramString;
    }
    return null;
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (String str = ((PhoneContact)localObject2).uin;; str = null)
    {
      ...
      if (!TextUtils.isEmpty(str))
      {
        ...
        if (!str.equals("0"))
        {
          localObject2 = ((ajxl)paramQQAppInterface.getManager(51)).e(str);
  ...
  {
    aumd localaumd = aume.a(paramString);
    if (localaumd.a.equals("86")) {
      paramString = localaumd.c;
    }
    return paramString;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    localbfpc.a(2131689581);
    arrayOfInt[0] = 1;
    localbfpc.b(2131690587);
    localbfpc.c(2131690596);
    localbfpc.a(new aveb());
    localbfpc.a(new avec(localbfpc, arrayOfInt, paramString, paramContext, paramQQAppInterface));
    localbfpc.show();
  }
