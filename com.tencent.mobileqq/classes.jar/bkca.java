  ...
  extends ajdy
{
  ...
  public bkca(tAdvDesc paramtAdvDesc)
  {
    super(paramtAdvDesc);
  }
  ...
  protected void a()
  {
    ...
    catch (Exception localException)
    {
      ...
      bjmf.a().a(2741, this.a.task_id, 102, "CountDownBanner json parseError exception = " + localException.getMessage() + " json string = " + str);
    }
  }
}
