  ...
  extends bhmv
{
  ...
  public blqf(bhql parambhql)
  {
    super(parambhql);
    this.jdField_a_of_type_AndroidAppActivity = parambhql.jdField_a_of_type_AndroidAppActivity;
    ...
    if (this.jdField_a_of_type_Bhqo.jdField_a_of_type_Int != i) {
      g(i);
    }
    this.jdField_g_of_type_JavaLangString = bgln.a(this.jdField_a_of_type_AndroidAppActivity).jdField_a_of_type_JavaLangString;
    this.h = blpz.a(this.jdField_a_of_type_AndroidAppActivity);
  }
  ...
  private ImageView a(int paramInt, String paramString, View.OnClickListener paramOnClickListener)
  {
    if ((this.jdField_a_of_type_AndroidWidgetImageView != null) && (this.jdField_a_of_type_AndroidWidgetImageView.getVisibility() == 0))
    {
      ...
      ((RelativeLayout.LayoutParams)localObject).leftMargin = (((RelativeLayout.LayoutParams)localObject).width + bggq.a(this.jdField_a_of_type_AndroidAppActivity, 13.0F));
  ...
  {
    paramRadioButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130846970));
  ...
  private boolean d()
  {
    ...
    {
      blpu.e("ReaderTitleBarView", bool);
      if (100 != this.jdField_f_of_type_Int) {
        break;
      }
      return true;
  ...
  private void i(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidWidgetTextView == null) {
      blpu.a("ReaderTitleBarView", "leftView is null");
    }
    ...
    do
    {
      ...
      localDrawable = bgmo.a(localDrawable, paramInt);
    } while (localDrawable == null);
  ...
  private void j()
  {
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      localRadioButton.setId(2131374639);
      localLayoutParams = new ViewGroup.LayoutParams(bggq.a(this.jdField_a_of_type_AndroidAppActivity, 68.0F), bggq.a(this.jdField_a_of_type_AndroidAppActivity, 34.0F));
      a(localRadioButton, true);
      localRadioButton.setText(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131715796));
      ...
      localRadioButton.setId(2131374640);
      a(localRadioButton, false);
      localRadioButton.setText(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131715798));
      this.jdField_a_of_type_AndroidWidgetRadioGroup.addView(localRadioButton, localLayoutParams);
    }
    this.jdField_a_of_type_AndroidWidgetRadioGroup.setOnCheckedChangeListener(new blqh(this));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.removeAllViews();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(this.jdField_a_of_type_AndroidWidgetLinearLayout, new ViewGroup.LayoutParams(bggq.a(this.jdField_a_of_type_AndroidAppActivity, 186.0F), bggq.a(this.jdField_a_of_type_AndroidAppActivity, 44.0F)));
  }
  ...
  private void j(int paramInt)
  {
    ...
    if ((!TextUtils.isEmpty(this.e)) && (!TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString))) {
      ...
      default: 
        ...
        if (this.jdField_a_of_type_Bhql.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) {
          this.jdField_a_of_type_Bhql.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.webView.loadUrl(str);
        }
        break;
      }
    }
    for (int i = paramInt;; i = 0)
    {
      k(i);
      return;
      blpx.a(this.jdField_g_of_type_JavaLangString, this.h, "5", "502", "", "3", "", "", "");
      str = this.e;
      paramInt = 0;
      break;
      blpx.a(this.jdField_g_of_type_JavaLangString, this.h, "5", "2206", "", "3", "", "", "");
      paramInt = 1;
  ...
  public void a(Intent paramIntent, String paramString)
  {
    ...
    this.jdField_a_of_type_Bhqo.jdField_a_of_type_JavaLangString = null;
    super.a(paramIntent, paramString);
    if (d())
    {
      a(this.jdField_a_of_type_Bhqo.jdField_a_of_type_OrgJsonJSONObject, false);
      if ((this.jdField_a_of_type_Bhql.a() != null) && (!this.jdField_a_of_type_Bhqo.jdField_a_of_type_Boolean))
      {
        this.jdField_a_of_type_Bhqo.s = true;
        a(this.jdField_a_of_type_Bhql.a());
      }
    }
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130850654));
    int i;
    int j;
    int k;
    int m;
    ...
    if (d())
    {
      ...
      blpz.a(this.jdField_a_of_type_AndroidViewViewGroup, ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidAppActivity));
      if (this.jdField_a_of_type_Bhql.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null)
      {
        j = this.jdField_a_of_type_Bhql.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getResources().getDimensionPixelSize(2131298998);
        if (!d()) {
          break label665;
        }
        blpz.a(this.jdField_a_of_type_Bhql.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.contentView, -i);
        ...
        if (this.jdField_a_of_type_Bhql.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mSystemBarComp != null)
        {
          ...
          this.jdField_a_of_type_Bhql.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mSystemBarComp.setBackgroundColor(-6710887);
          localObject = this.jdField_a_of_type_Bhql.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getHostActivity().getWindow();
          if (d()) {
            break label783;
          }
          bool = true;
      ...
      localDrawable = this.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130846948);
      if (!d()) {
        break label789;
      }
      localObject = bgmo.a(localDrawable, -1);
      label522:
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131693601));
      label551:
    ...
    for (;;)
    {
      if (this.jdField_c_of_type_AndroidViewView == null) {
        this.jdField_c_of_type_AndroidViewView = a(2130846949, this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131715797), new blqg(this));
      }
      return;
      f(-16777216);
      d(-16777216);
      ...
      break label311;
      label665:
      if (!(this.jdField_a_of_type_Bhql.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment instanceof ReaderHomeTabFragment)) {
        break label361;
      }
      blpz.a(this.jdField_a_of_type_Bhql.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.webView, -j - ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidAppActivity));
      break label361;
      label705:
      this.jdField_a_of_type_Bhql.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mSystemBarComp.setBackgroundColor(-1);
      ...
      localObject = bgmo.a(localDrawable, this.jdField_a_of_type_Bhqo.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle.e);
      break label522;
      label823:
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      break label551;
      label835:
      blpu.a("ReaderTitleBarView", "mTitleBarLeftTabUrl=" + this.e + ",mTitleBarRightTabUrl=" + this.jdField_f_of_type_JavaLangString);
    }
  }
  ...
  public void h(int paramInt)
  {
    if (paramInt > 0)
    {
      ...
      Window localWindow = this.jdField_a_of_type_Bhql.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getHostActivity().getWindow();
      a(d(), localWindow);
    }
  }
}
