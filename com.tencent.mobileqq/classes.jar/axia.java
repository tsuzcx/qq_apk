  ...
  extends axhz
{
  ...
  private WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new axib(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = axia.class.getSimpleName();
  }
  
  public axia(RegisterNewBaseActivity paramRegisterNewBaseActivity)
  {
  ...
  public void a(String paramString)
  {
    try
    {
      ...
      if (awdr.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.app, this.c.getBytes(), paramString.getBytes(), this.d, this.jdField_a_of_type_MqqObserverWtloginObserver) != 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.c();
        this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131717515, 1);
      }
      return;
    }
