    ...
    for (;;)
    {
      try
      {
        ...
        if (asld.a)
        {
          ...
          if (asld.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
          {
            paramString4 = paramString5;
            if (paramBundle != null)
            {
          ...
          if (this.a.jdField_a_of_type_Aruk != null) {
            this.a.jdField_a_of_type_Aruk.a(paramBoolean, paramString6, str1, paramInt1, paramString1, paramString3, paramString2, this.a.jdField_a_of_type_JavaLangString, paramString5);
          }
        }
        else
        {
