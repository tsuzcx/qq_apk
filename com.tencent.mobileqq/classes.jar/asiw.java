...
public class asiw
{
  public static String a(QQAppInterface paramQQAppInterface, bhyo parambhyo, boolean paramBoolean)
  {
    ArrayList localArrayList = null;
    if ((paramQQAppInterface == null) && (parambhyo == null)) {}
    ...
    int i = ((Bundle)localObject).getInt("jsonType", asih.c);
    File localFile = (File)parambhyo.jdField_a_of_type_JavaUtilMap.get(parambhyo.jdField_a_of_type_JavaLangString);
    Object localObject = new asjh();
    parambhyo = localArrayList;
    if (localFile != null)
    {
      if (localFile.exists()) {
        parambhyo = FileUtils.fileToBytes(localFile);
      }
    }
    else
    {
    ...
    label162:
    for (paramQQAppInterface = a(paramQQAppInterface, localEmoticonPackage, i, parambhyo, localArrayList);; paramQQAppInterface = a(paramQQAppInterface, localEmoticonPackage, i, parambhyo, localArrayList, (asjh)localObject))
    {
  ...
  public static String a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, int paramInt, byte[] paramArrayOfByte, ArrayList<Emoticon> paramArrayList, asjh paramasjh)
  {
    if (QLog.isColorLevel()) {
      QLog.d("EmotionJsonUtils", 2, "parseJson : parseJson start");
    }
    Object localObject = a(paramQQAppInterface, paramEmoticonPackage, paramArrayOfByte, paramArrayList, paramasjh);
    if (localObject != null) {
    ...
    {
      return paramQQAppInterface;
      localObject = (awyr)paramQQAppInterface.getManager(QQManagerFactory.EMOTICON_MANAGER);
      try
      {
        ...
        paramArrayOfByte = a(paramEmoticonPackage, paramInt, (awyr)localObject, localJSONObject, str, paramQQAppInterface, "");
        ...
        for (paramEmoticonPackage.supportSize = paramQQAppInterface;; paramEmoticonPackage.supportSize = localJSONObject.getJSONArray("supportSize").toString()) {
          do
          {
            ...
            ((awyr)localObject).a(paramEmoticonPackage);
            int i = ((awyr)localObject).a(str);
            boolean bool = false;
            if (EmoticonUtils.emoticonPkgNeedUpdate(paramEmoticonPackage)) {
              bool = true;
            }
            if (QLog.isColorLevel()) {
              QLog.d("EmotionJsonUtils", 2, "parseJson: ep = " + paramEmoticonPackage + " ,update :" + bool);
            }
            paramArrayOfByte = a(paramEmoticonPackage, paramInt, paramArrayList, paramasjh, (awyr)localObject, localJSONObject, str, i, bool);
            paramQQAppInterface = paramArrayOfByte;
            if (paramArrayOfByte != null) {
              break;
            }
  ...
  protected static String a(QQAppInterface paramQQAppInterface, EmoticonPackage paramEmoticonPackage, byte[] paramArrayOfByte, ArrayList<Emoticon> paramArrayList, asjh paramasjh)
  {
    if (paramQQAppInterface == null)
    {
      if (QLog.isColorLevel()) {
    ...
    if ((paramArrayList == null) || (paramasjh == null))
    {
      if (QLog.isColorLevel()) {
  ...
  protected static String a(EmoticonPackage paramEmoticonPackage, int paramInt, awyr paramawyr, JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3)
  {
    int i2 = 0;
            ...
            for (int n = paramJSONObject.getInt("updateTime");; n = 0)
            {
              ...
              for (;;)
              {
                ...
                for (int i1 = 3;; i1 = 0)
                {
                  ...
                  a(paramEmoticonPackage, paramInt, paramawyr, paramJSONObject, paramString1, m, j, n);
  ...
  protected static String a(EmoticonPackage paramEmoticonPackage, int paramInt1, ArrayList<Emoticon> paramArrayList, asjh paramasjh, awyr paramawyr, JSONObject paramJSONObject, String paramString, int paramInt2, boolean paramBoolean)
  {
    ...
    if (j < n)
    {
      ...
      localObject = paramawyr.a(paramString, str1);
      if (localObject == null) {
        if (paramInt1 != asih.d)
        {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        k = i;
        break;
        paramawyr.b(localArrayList);
        if (paramEmoticonPackage.newSoundEp) {
          paramawyr.a(paramEmoticonPackage);
        }
        if (i == 0) {}
        for (paramBoolean = true;; paramBoolean = false)
        {
          paramasjh.a = paramBoolean;
          return null;
        }
      }
    }
  ...
  protected static void a(EmoticonPackage paramEmoticonPackage, int paramInt1, awyr paramawyr, JSONObject paramJSONObject, String paramString, int paramInt2, int paramInt3, int paramInt4)
  {
    if (paramEmoticonPackage.copywritingType != awyq.a)
    {
    ...
    paramawyr = paramawyr.b(paramString);
    if (paramawyr != null)
    {
      paramEmoticonPackage.status = paramawyr.status;
      paramEmoticonPackage.valid = paramawyr.valid;
    }
    ...
    if (paramawyr != null)
    {
      paramEmoticonPackage.wordingId = paramawyr.wordingId;
      return;
    }
    paramEmoticonPackage.wordingId = -1L;
  }
  
  protected static void a(EmoticonPackage paramEmoticonPackage, int paramInt1, ArrayList<Emoticon> paramArrayList, awyr paramawyr, JSONArray paramJSONArray, int paramInt2, boolean paramBoolean)
  {
    int i = 0;
    Object localObject;
    String str1;
    ...
    if (i < paramInt2)
    {
      ...
      localObject = paramawyr.a(str3, str1);
      if (localObject == null)
      {
        if (paramInt1 == asih.d) {
          break label362;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((paramBoolean) && (j == 0)) {
          paramawyr.a((Emoticon)localObject);
        }
        if (QLog.isColorLevel()) {
  ...
  protected static void a(EmoticonPackage paramEmoticonPackage, int paramInt, ArrayList<Emoticon> paramArrayList, awyr paramawyr, JSONObject paramJSONObject1, long paramLong, JSONObject paramJSONObject2, JSONArray paramJSONArray1, JSONArray paramJSONArray2)
  {
    ...
    for (int i = paramJSONArray1.getInt("isOriginal");; i = 0)
    {
      ...
      for (j = paramJSONArray2.getInt("feeType");; j = 0)
      {
        ...
        for (;;)
        {
          ...
          a(paramEmoticonPackage, paramInt, paramArrayList, paramawyr, paramJSONObject1, paramJSONObject1.length(), true);
          return;
          if (j <= 0) {
            break;
          }
          paramEmoticonPackage.extraFlags &= i;
          break;
          paramJSONObject1 = paramawyr.b(paramEmoticonPackage.epId);
