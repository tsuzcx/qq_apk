...
public class naq
{
  ...
  private void a(String paramString, byte[] paramArrayOfByte, BusinessObserver paramBusinessObserver)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.a.getApplication(), mzx.class);
  ...
  private void a(userinfo.UserInfo paramUserInfo, nar paramnar)
  {
    ...
    a("SearchAsmTab.GetPopClassific", localReqBody.toByteArray(), new nas(paramnar, this.a, 1));
  }
  
  public void a(nar paramnar)
  {
    try
    {
      a(a(null), paramnar);
