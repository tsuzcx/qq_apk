...
public class abik
  implements begw
{
  public abik(ProfileCardMoreActivity paramProfileCardMoreActivity, String paramString, begr parambegr) {}
    ...
    for (;;)
    {
      ...
      if (badq.d(BaseApplication.getContext()))
      {
        ...
        if (azzz.b(this.jdField_a_of_type_JavaLangString)) {
          awqx.b(this.jdField_a_of_type_ComTencentMobileqqActivityProfileCardMoreActivity.app, "dc00898", "", "", "0X8007FDF", "0X8007FDF", 0, 0, "", "", "", "");
        }
        this.jdField_a_of_type_ComTencentMobileqqActivityProfileCardMoreActivity.finish();
      }
      else
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityProfileCardMoreActivity.a(2131625912, 1);
        continue;
        if (azzz.b(this.jdField_a_of_type_JavaLangString)) {
          awqx.b(this.jdField_a_of_type_ComTencentMobileqqActivityProfileCardMoreActivity.app, "dc00898", "", "", "0X8007FE0", "0X8007FE0", 0, 0, "", "", "", "");
        }
      }
    }
  }
