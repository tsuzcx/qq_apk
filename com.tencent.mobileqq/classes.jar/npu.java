...
public class npu
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "8.3.0".replace(".", "");
    jdField_a_of_type_JavaUtilHashMap = new HashMap();
  }
  
  public static int a()
  {
    boolean bool1 = bhvy.i();
    boolean bool2 = bhvy.j();
    if (!bool1) {
      return 0;
    }
    if (bool2) {
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    for (paramInt = paramQQAppInterface.wMemberNum;; paramInt = 2)
    {
      ...
      do
      {
        ...
        paramQQAppInterface = (ajvi)paramQQAppInterface.getManager(53);
        i = j;
      ...
      try
      {
        ...
        if (paramJSONObject != null)
        {
          ...
          if (paramJSONObject != null)
          {
            ...
            {
              paramJSONObject = onh.a(localContext);
              localJSONObject.put("wifi_ssid", onh.b(localContext));
              localJSONObject.put("wifi_mac", paramJSONObject);
            }
            localJSONObject.put("imei", onh.f());
            localJSONObject.put("imsi", onh.g());
            localJSONObject.put("androidid", bbdh.f());
  ...
  public static void a(int paramInt1, long paramLong, String paramString1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, qca paramqca, int paramInt7, String paramString2, String paramString3)
  {
    ThreadManager.post(new VideoReporter.1(paramInt1, paramLong, paramString1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramqca, paramInt7, paramString2, paramString3), 5, null, true);
  }
  
  public static void a(long paramLong1, String paramString1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong2, qca paramqca, int paramInt5, String paramString2)
  {
    ...
    if (paramInt1 == 56)
    {
      ...
      localReportInfo.mVideoExtraRepoerData = paramqca;
    ...
    label366:
    for (paramString1 = paramqca.toString();; paramString1 = "null")
    {
      QLog.d("VideoReporter", 2, paramString1);
      localArrayList.add(localReportInfo);
      new pbu(null, null, por.a(), null).a(localArrayList);
      return;
  ...
  public static void a(VideoInfo paramVideoInfo, int paramInt1, int paramInt2, int paramInt3, qca paramqca, String paramString)
  {
    long l = paramVideoInfo.c;
    String str = paramVideoInfo.g;
    int j = (int)paramVideoInfo.f;
    int k = paramVideoInfo.r;
    if (paramVideoInfo.a != null) {}
    for (int i = paramVideoInfo.a.a;; i = -1)
    {
      a(18, l, str, paramInt1, j, k, paramInt2, paramInt3, paramqca, i, paramVideoInfo.N, paramString);
      return;
    }
  }
  
  public static void a(BaseArticleInfo paramBaseArticleInfo, int paramInt1, int paramInt2, long paramLong, qca paramqca)
  {
    ...
    {
      a(l, str, paramInt1, j, k, paramInt2, paramLong, paramqca, i, paramBaseArticleInfo.videoReportInfo);
      return;
    }
  }
  ...
  public static void a(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      nol.a(null, "CliOper", "", "", paramString1, paramString1, 0, 0, str, Integer.toString(paramInt2), paramString3, paramString2, false);
      return;
      if (paramInt1 == 1) {
        str = "3";
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramJSONObject.put("imei", onh.f());
        paramJSONObject.put("imsi", onh.g());
  ...
  {
    if ((onh.a() instanceof QQAppInterface))
    {
      QQAppInterface localQQAppInterface = (QQAppInterface)onh.a();
      return bdik.d(localQQAppInterface.c() + "_" + System.currentTimeMillis());
    }
    return bdik.d("_" + System.currentTimeMillis());
  }
  
  public static void b(VideoInfo paramVideoInfo, int paramInt1, int paramInt2, int paramInt3, qca paramqca, String paramString)
  {
    long l = paramVideoInfo.c;
    String str = paramVideoInfo.g;
    int j = (int)paramVideoInfo.f;
    ...
    for (int i = paramVideoInfo.a.a;; i = -1)
    {
      a(5, l, str, paramInt1, j, k, paramInt2, paramInt3, paramqca, i, paramVideoInfo.N, paramString);
      return;
    }
  }
