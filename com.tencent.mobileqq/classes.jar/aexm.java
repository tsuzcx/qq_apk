...
public class aexm
  implements aeyt, Handler.Callback, View.OnClickListener
{
  private static final String jdField_a_of_type_JavaLangString = ajya.a(2131701274);
  private static final String jdField_b_of_type_JavaLangString = ajya.a(2131701275);
  ...
  public aexm(BaseActivity paramBaseActivity, aeyv paramaeyv)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    this.jdField_a_of_type_Aeyv = paramaeyv;
    this.jdField_a_of_type_Bduf = ((bduf)paramBaseActivity.app.getManager(165));
  ...
  public View a(Object... paramVarArgs)
  {
    ...
    TextView localTextView = (TextView)paramVarArgs.findViewById(2131362382);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramVarArgs.findViewById(2131362381).setOnClickListener(this);
        return paramVarArgs;
      }
  ...
  {
    if ((paramMessage.what == 1) && (this.jdField_a_of_type_Aeyv.a() == this)) {
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131362380: 
      ...
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00899", "Qidian", this.f, "0X8009788", "ClickLawTip", 1, 0, String.valueOf(NetConnInfoCenter.getServerTime()), this.jdField_a_of_type_Bduf.a(this.f), "8.3.0", "");
      return;
    }
    ...
    this.jdField_a_of_type_AndroidOsHandler.removeMessages(1);
    this.jdField_a_of_type_Aeyv.a();
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, "dc00899", "Qidian", this.f, "0X8009789", "CloseLawTip", 1, 0, String.valueOf(NetConnInfoCenter.getServerTime()), this.jdField_a_of_type_Bduf.a(this.f), "8.3.0", "");
  }
}
