  ...
  implements Manager
{
  ...
  public int a(String paramString)
  {
    ...
    while (!bddy.a(paramString, localSQLiteDatabase)) {
      return 0;
    }
  ...
  public long a(String paramString)
  {
    ...
    do
    {
      return l3;
      l2 = l1;
      if (bddy.a(paramString, localSQLiteDatabase)) {
        l3 = l1;
      }
      try
      {
  ...
  public Cursor a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      paramString2 = bddy.b(null, paramString1, localSQLiteDatabase, (String)localObject1);
    ...
    for (;;)
    {
      ...
      if (paramString1.indexOf("mr_discusssion_") != -1)
      {
        ...
        paramString2 = bddy.b(null, paramString1, localSQLiteDatabase, (String)localObject2);
      ...
      Object localObject2 = bddy.a(null, paramString1, localSQLiteDatabase, paramString2, null);
  ...
  public awbx a()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_ComTencentMobileqqDataQQEntityManagerFactory == null)
      {
        this.jdField_a_of_type_ComTencentMobileqqDataQQEntityManagerFactory = new awdh(str);
  ...
  public awce a()
  {
    ...
    {
      if ((this.jdField_a_of_type_Awce == null) || (!this.jdField_a_of_type_Awce.a())) {
        this.jdField_a_of_type_Awce = ((awce)a().createMessageRecordEntityManager());
      }
  ...
  public List<MessageRecord> a(String paramString1, String paramString2)
  {
    ...
    {
      return null;
      paramString1 = bddy.a(null, paramString1, localSQLiteDatabase, paramString2, null);
