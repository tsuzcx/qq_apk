...
{
  public jxi(MultiVideoCtrlLayerUI4NewGroupChat paramMultiVideoCtrlLayerUI4NewGroupChat) {}
  ...
  protected void a(long paramLong, boolean paramBoolean, int paramInt)
  {
    ...
    if (this.a.jdField_a_of_type_ComTencentAvUiQavPanel.a(2131365369)) {
      return;
    }
    this.a.t_();
  }
  ...
  protected void b(long paramLong)
  {
    ...
    for (int i = j;; i = 3)
    {
      ...
      this.a.jdField_a_of_type_ComTencentAvUtilsSensorHelper.b(true);
      this.a.jdField_a_of_type_ComTencentAvUtilsSensorHelper.a();
      this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(new jxj(this.a), 500L);
      if (this.a.jdField_a_of_type_ComTencentAvVideoController.a().f) {
