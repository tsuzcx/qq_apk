...
public class ateb
{
  ...
  ActionCallback jdField_a_of_type_ComTencentIntervideoNowproxyCustomized_interfaceActionCallback = new ated(this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public ateb(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Atcy = ateg.a().a();
  ...
  private void c(Bundle paramBundle)
  {
    ...
    {
      localObject2 = baqn.a(str2);
      localObject1 = localObject2;
      if (localObject2 == null) {
        localObject1 = baqn.a(str2 + "?busiType=3");
      }
      localObject2 = str1;
    ...
    paramBundle.putString("hostVersion", String.valueOf(apao.a(BaseApplicationImpl.getContext())));
  ...
  public void a(Bundle paramBundle, atdz paramatdz)
  {
    ...
    paramatdz = paramBundle.getString("mqqUrl", "");
    long l = System.currentTimeMillis();
    if ((l - this.jdField_a_of_type_Long < 1000L) && (!atdb.c(paramBundle).equals("1")))
    {
      QLog.i("DynamicNow | NowEntry", 1, "开始处理mqq　scheme,time = " + System.currentTimeMillis() + " 点太快了");
      QQToast.a(BaseApplicationImpl.getContext(), alud.a(2131708059), 0).a();
      return;
    }
    this.jdField_a_of_type_Long = l;
    QLog.i("DynamicNow | NowEntry", 1, "开始进入now结合版,time = " + System.currentTimeMillis() + " mqqScheme = " + paramatdz);
  ...
  {
    Object localObject1 = atdb.a(paramBundle);
    Object localObject2 = atdb.b(paramBundle);
    long l = atdb.a(paramBundle);
    this.jdField_a_of_type_Atcy.a(false, (String)localObject2, String.valueOf(l), (String)localObject1, false, false, true);
    ...
    if ((a((String)localObject1)) || (baqn.a((String)localObject1) != null) || (baqn.a((String)localObject2) != null))
    {
      c(paramBundle);
      return;
    }
    ...
    ((URLDrawable)localObject1).setURLDrawableListener(new atec(this, l, (AtomicBoolean)localObject2, paramBundle));
