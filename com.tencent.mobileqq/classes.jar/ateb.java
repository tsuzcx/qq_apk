...
class ateb
  implements blfl<WeiyunPB.PwdQueryMsgRsp>
{
  ateb(atdx paramatdx) {}
  ...
  public void a(int paramInt, String paramString, WeiyunPB.PwdQueryMsgRsp paramPwdQueryMsgRsp)
  {
    ...
    atdx.a(this.a).getFileManagerNotifyCenter().a(false, 44, new Object[] { Integer.valueOf(paramInt), paramString, null });
  }
  ...
  public void a(WeiyunPB.PwdQueryMsgRsp paramPwdQueryMsgRsp)
  {
    ...
    blfm.a(atdx.a(this.a).getApplication().getApplicationContext(), true);
    if (paramPwdQueryMsgRsp.pwd_open.get()) {
      blfm.b(atdx.a(this.a).getApplication().getApplicationContext(), true);
    }
    atdx.a(this.a).getFileManagerNotifyCenter().a(true, 44, new Object[] { Integer.valueOf(0), null, Boolean.valueOf(paramPwdQueryMsgRsp.pwd_open.get()) });
  }
}
