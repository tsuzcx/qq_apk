...
public class ampl
{
  ...
  private final Map<Integer, ampa> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  private final Object jdField_b_of_type_JavaLangObject = new Object();
  private final Map<Integer, ampm> jdField_b_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  private int a(ampa paramampa, int paramInt, long paramLong)
  {
    int i = a(paramLong).getInt(String.valueOf(paramInt), -1);
    paramInt = i;
    if (i == -1) {
      paramInt = paramampa.b();
    }
    return paramInt;
  }
  ...
  private <T> T a(ampa<T> paramampa, int paramInt)
  {
    Object localObject2 = paramampa.a(paramInt);
    Object localObject1 = localObject2;
    if (localObject2 == null) {
      localObject1 = a(paramampa.a());
    }
    return localObject1;
  }
  
  private Object a(ampa paramampa, long paramLong, int paramInt)
  {
    Object localObject2 = a(paramampa.a());
    if (localObject2 != null)
    {
      int i = paramampa.a();
      int j = a(paramampa, i, paramLong);
    ...
    for (Object localObject1 = localObject2;; localObject1 = paramampa.a(0))
    {
      if (QLog.isColorLevel()) {
        QLog.d("QConfigManager", 2, "loadNewConfigFailBackport, version=" + paramInt + ", type" + paramampa.a() + ", conf=" + localObject1);
      }
      return localObject1;
    }
  }
  
  private Object a(ampa paramampa, amph[] paramArrayOfamph, int paramInt)
  {
    try
    {
      Object localObject = paramampa.b(paramArrayOfamph);
      return localObject;
    }
    catch (Exception localException)
    {
      ampo.a().a(paramampa, paramArrayOfamph, paramInt, localException);
    }
    return null;
  }
  ...
  private void a(ampa paramampa, ConfigurationService.Config paramConfig, long paramLong, String paramString, int paramInt1, int paramInt2)
  {
    int i = paramConfig.msg_content_list.size();
    if (i == 0) {
      paramConfig = paramampa.a(1);
    }
    label312:
    for (;;)
    {
      ...
      {
        a(paramampa, paramConfig, paramInt2, paramLong, bool);
        return;
        ...
        if (paramInt1 < i)
        {
          ...
          if ((localContent != null) && (localContent.content.has()))
          {
            ...
            localObject1 = augv.a(localContent.content.get().toByteArray());
            if (localObject1 == null) {
              break label193;
            }
          }
          for (;;)
          {
            try
            {
              ...
              if (!TextUtils.isEmpty((CharSequence)localObject1)) {
                localArrayList.add(new amph(localContent.task_id.get(), (String)localObject1));
              }
              paramInt1 += 1;
            }
        ...
        Object localObject2 = new amph[localArrayList.size()];
        localArrayList.toArray((Object[])localObject2);
        paramConfig = a(paramampa, (amph[])localObject2, paramInt2);
        if (paramConfig != null)
        {
          a(paramampa, (amph[])localObject2, paramLong, paramString);
          if (!QLog.isColorLevel()) {
            break label312;
          }
        ...
        paramConfig = a(paramampa, paramLong, paramInt2);
        break;
      }
    }
  }
  
  private void a(ampa paramampa, Object paramObject, int paramInt, long paramLong, boolean paramBoolean)
  {
    if (paramObject != null)
    {
      a(paramLong).edit().putInt(String.valueOf(paramampa.a()), paramInt).putBoolean(paramampa.a() + "_" + paramInt + "_defualt", paramBoolean).apply();
      this.jdField_b_of_type_JavaUtilMap.put(Integer.valueOf(paramampa.a()), new ampm(paramLong, paramInt, paramObject));
      paramampa.a(paramObject);
    }
  }
  
  private void a(ampa paramampa, amph[] paramArrayOfamph, long paramLong, String paramString)
  {
    int j = 0;
    int i = 0;
    if (paramampa.b())
    {
      ...
      {
        paramampa = a(paramString, String.valueOf(paramArrayOfamph[i].jdField_a_of_type_Int));
        if (paramampa != null) {
          a(paramArrayOfamph[i].jdField_a_of_type_JavaLangString, paramampa);
        }
        i += 1;
      }
    }
    ...
    while (i < paramArrayOfamph.length)
    {
      localHashSet.add(String.valueOf(paramArrayOfamph[i].jdField_a_of_type_Int));
      paramString.putString(paramampa.a() + "_" + paramArrayOfamph[i].jdField_a_of_type_Int, paramArrayOfamph[i].jdField_a_of_type_JavaLangString);
      i += 1;
    }
    a(paramLong).edit().putStringSet(paramampa.a() + "_ids", localHashSet).apply();
    paramString.apply();
  }
  ...
  private amph[] a(int paramInt, long paramLong)
  {
    ...
    Object localObject = new amph[arrayOfFile.length];
    paramInt = 0;
    while (paramInt < arrayOfFile.length)
    {
      File localFile = arrayOfFile[paramInt];
      localObject[paramInt] = new amph(a(localFile), a(localFile));
      paramInt += 1;
    }
    return localObject;
  }
  
  private ampa b(int paramInt)
  {
    switch (paramInt)
    {
    default: 
  ...
  private void b(ampa paramampa, ConfigurationService.Config paramConfig, long paramLong, String paramString, int paramInt1, int paramInt2)
  {
    if (paramConfig.content_list.isEmpty()) {
      paramString = paramampa.a(1);
    }
    for (;;)
    {
      a(paramampa, paramString, paramInt2, paramLong, paramConfig.content_list.isEmpty());
      return;
      int i = paramConfig.content_list.size();
      amph[] arrayOfamph = new amph[i];
      paramInt1 = 0;
      while (paramInt1 < i)
      {
        arrayOfamph[paramInt1] = new amph(paramInt1, (String)paramConfig.content_list.get(paramInt1));
        paramInt1 += 1;
      }
      Object localObject = a(paramampa, arrayOfamph, paramInt2);
      if (localObject != null)
      {
        a(paramampa, arrayOfamph, paramLong, paramString);
        if (QLog.isColorLevel())
        {
      ...
      {
        paramString = a(paramampa, paramLong, paramInt2);
        continue;
      }
      paramString = localObject;
    }
  ...
  private amph[] b(int paramInt, long paramLong)
  {
    if (a(paramInt) == null)
    {
      if (QLog.isColorLevel()) {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      localObject1[i] = new amph(Integer.valueOf(str).intValue(), localSharedPreferences.getString(paramInt + "_" + str, null));
      i += 1;
    }
    return localObject1;
  }
  
  private ampa c(int paramInt)
  {
    ampa localampa = a(paramInt);
    if (localampa == null) {}
    return localampa;
  }
  ...
  public int a(int paramInt, long paramLong)
  {
    ...
    return a(localampa, paramInt, paramLong);
  }
  ...
  public int a(int paramInt, String paramString)
  {
    ...
    return a(localampa, paramInt, a(paramString, localampa.a()));
  }
  
  public ampa a(int paramInt)
  {
    Object localObject1 = (ampa)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    if (localObject1 == null) {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ampa localampa2 = (ampa)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
        localObject1 = localampa2;
        if (localampa2 == null)
        {
          localampa2 = b(paramInt);
          localObject1 = localampa2;
          if (localampa2 != null)
          {
            this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(paramInt), localampa2);
            localObject1 = localampa2;
          }
        }
        return localObject1;
  ...
  public <T> T a(int paramInt)
  {
    ...
    int i;
    for (long l = a(((SimpleAccount)localObject1).getUin(), localampa.a());; l = 0L)
    {
      localObject1 = a(l);
      ...
      return a(localampa, 0);
      if (QLog.isColorLevel()) {
        QLog.d("QConfigManager", 2, "Can not get an runtime.May be in a process of none appRuntime.");
      }
      return a(localampa, 1);
    }
    ??? = (ampm)this.jdField_b_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    if ((??? != null) && (((ampm)???).jdField_a_of_type_Int == i) && (((ampm)???).jdField_a_of_type_Long == l) && (((ampm)???).jdField_a_of_type_JavaLangObject != null)) {
      return ((ampm)???).jdField_a_of_type_JavaLangObject;
    }
    if (((SharedPreferences)localObject1).getBoolean(localampa.a() + "_" + i + "_defualt", false)) {
      return a(localampa, 0);
    }
    Object localObject3;
    for (;;)
    {
      ...
      {
        ampi.a().a(paramInt, l, localampa.b());
        if (localampa.b())
        {
    ...
    try
    {
      Object localObject5 = localampa.b((amph[])localObject3);
      this.jdField_b_of_type_JavaUtilMap.put(Integer.valueOf(paramInt), new ampm(l, i, localObject5));
      return localObject5;
    }
    catch (Exception localException)
    {
      ampo.a().a(localampa, (amph[])localObject3, i, localException);
      localObject3 = a(localampa.a());
    }
    return localObject3;
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    {
      l1 = l2;
      if (((ampa)localObject).a())
      {
        AppRuntime localAppRuntime = MobileQQ.sMobileQQ.waitAppRuntime(null);
        l1 = l2;
        if (localAppRuntime != null) {
          l1 = a(localAppRuntime.getAccount(), ((ampa)localObject).a());
        }
      }
    }
    localObject = a(l1);
  ...
  public void a(int paramInt1, int paramInt2, ConfigurationService.Config paramConfig, String arg4)
  {
    ...
    if (localampa.c()) {
      a(localampa, paramConfig, l, str, i, paramInt2);
    }
    for (;;)
    {
      ampi.a().a(paramInt1, l, localampa.b());
      return;
      b(localampa, paramConfig, l, str, i, paramInt2);
    }
  }
  ...
  public void a(int[] paramArrayOfInt)
  {
    ...
    andt.jdField_a_of_type_JavaLangString = str;
    NewIntent localNewIntent = new NewIntent(BaseApplicationImpl.getApplication(), andt.class);
  ...
  public int b(int paramInt, long paramLong)
  {
    ...
    ampa localampa = a(paramInt);
    if ((localampa != null) && (localampa.d()) && (i == 0)) {
