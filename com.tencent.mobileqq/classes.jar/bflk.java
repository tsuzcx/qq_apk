...
public class bflk
{
  ...
  private void a(oidb_0xea3.RspBody paramRspBody)
  {
    ...
    bfkp localbfkp = (bfkp)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(171);
    if (localbfkp == null) {
      return;
    }
    ...
    localbfkp.notifyUI(4, true, new Object[] { Long.valueOf(this.jdField_a_of_type_Long), this.jdField_a_of_type_JavaUtilList, this.jdField_b_of_type_JavaUtilList });
    b();
  }
  ...
  public void a()
  {
    ...
    localObject = localbfkp.makeOIDBPkg("OidbSvcTcp.0xea3", 3747, 1, ((oidb_0xea3.ReqBody)localObject).toByteArray(), 30000L);
    ((ToServiceMsg)localObject).extraData.putLong("sendSeq", this.jdField_b_of_type_Long);
    localbfkp.sendPbReq((ToServiceMsg)localObject);
  }
  
  public boolean a(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    if ((bfkp)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getBusinessHandler(171) == null) {
      return true;
    }
    oidb_0xea3.RspBody localRspBody = new oidb_0xea3.RspBody();
    int i = bfkp.parseOIDBPkg(paramFromServiceMsg, paramObject, localRspBody);
    boolean bool;
    if (i == 0)
    {
