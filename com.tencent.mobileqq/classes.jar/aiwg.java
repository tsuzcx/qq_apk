...
public class aiwg
{
  ...
  private Comparator<CmGamePushItem> jdField_a_of_type_JavaUtilComparator = new aiwh(this);
  ...
  private void a(CmGamePushItem paramCmGamePushItem1, CmGamePushItem paramCmGamePushItem2)
  {
    ...
    do
    {
      ...
      localaukn = ((QQAppInterface)localObject).getEntityManagerFactory().createEntityManager();
    } while (localaukn == null);
    localObject = localaukn.a();
    ((aukp)localObject).a();
    ...
    for (;;)
    {
      try
      {
        localaukn.b(paramCmGamePushItem2);
        localaukn.a(paramCmGamePushItem1);
        ((aukp)localObject).c();
        return;
      }
  ...
  private void a(List<CmGamePushItem> paramList)
  {
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 18	aiwg:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   18: astore_2
    //   19: aload_2
    //   20: monitorenter
    //   21: aload_0
    //   22: getfield 23	aiwg:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   25: aload_1
    ...
    //   33: monitorexit
    //   34: aload_0
    //   35: getfield 43	aiwg:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   46: ifnull -33 -> 13
    //   49: aload_2
    //   50: invokevirtual 55	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lauko;
    //   53: invokevirtual 61	auko:createEntityManager	()Laukn;
    //   56: astore_3
    //   57: aload_3
    //   58: ifnull -45 -> 13
    //   61: aload_3
    //   62: invokevirtual 66	aukn:a	()Laukp;
    //   65: astore_2
    //   66: aload_2
    //   67: invokevirtual 70	aukp:a	()V
    //   70: aload_1
    ...
    //   96: invokevirtual 74	aukn:b	(Laukm;)Z
    //   99: pop
    //   100: goto -23 -> 77
    //   103: astore_1
    ...
    //   128: athrow
    //   129: aload_2
    //   130: invokevirtual 80	aukp:c	()V
    //   133: aload_2
    //   134: invokevirtual 82	aukp:b	()V
    //   137: return
    //   138: astore_1
    //   139: aload_2
    //   140: invokevirtual 82	aukp:b	()V
    //   143: aload_1
    //   144: athrow
  ...
  public void a(CmGamePushItem paramCmGamePushItem)
  {
    ...
    if ((localObject1 != null) && (paramCmGamePushItem.msg_type == 1)) {
      ((avpq)((QQAppInterface)localObject1).getManager(36)).c(String.valueOf("103100.103200.103240.103248"));
    }
