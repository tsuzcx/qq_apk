  ...
  extends kzt
{
  ...
  public static void a(Context paramContext, Header[] paramArrayOfHeader, List<String> paramList, String paramString, kzi paramkzi)
  {
    paramList = new StringEntity(a(paramList, paramString), "UTF-8");
    a().a(paramContext, "https://api.microsofttranslator.com/V2/Http.svc/TranslateArray", paramArrayOfHeader, paramList, "application/xml", paramkzi);
  }
  
  public static void a(Context paramContext, Header[] paramArrayOfHeader, Map<String, String> paramMap, kzk paramkzk)
  {
    ...
    a().a(paramContext, "https://datamarket.accesscontrol.windows.net/v2/OAuth2-13", paramArrayOfHeader, paramMap, "application/x-www-form-urlencoded", paramkzk);
  }
}
