...
{
  public ashy(QQGamePubAccountFragment paramQQGamePubAccountFragment) {}
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    {
      asjl localasjl = asjw.a(localMessageRecord, this.a.getActivity());
      if (localasjl == null)
      {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("QQGamePubAccountFragment", 2, "headerView = " + localasjl.getClass().getSimpleName());
      }
      ...
      localLayoutParams3.addRule(13, ((View)localasjl).getId());
      ...
      if (localMessageRecord != null)
      {
        ...
        localTextView.setText(bdjj.a(this.a.getActivity(), 3, localMessageRecord.time * 1000L));
        ...
        if (localLayoutParams2 == null) {
          localLayoutParams1 = new RelativeLayout.LayoutParams(-2, aekt.a(15.0F, this.a.getResources()));
        }
      ...
      for (;;)
      {
        localRelativeLayout.addView((View)localasjl, localLayoutParams3);
        ...
        localasjl.a(localMessageRecord, this.a.getActivity());
        if (localMessageRecord == null) {
          return localRelativeLayout;
        }
        if ((localMessageRecord != null) && ((localMessageRecord instanceof MessageForArkApp)))
        {
          paramViewGroup = (ArkTextureView)localasjl;
          ((View)localasjl).setOnTouchListener(new ashz(this, paramViewGroup));
        }
        return localRelativeLayout;
        localTextView = null;
