...
public class behv
{
    ...
    for (;;)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if (localSecondApiRightInfo != null) {
          ...
          {
            if (betc.a()) {
              betc.a("AuthFilterList", "config apiName : " + localSecondApiRightInfo.apiName + ", secondName: " + localSecondApiRightInfo.secondName);
            }
          ...
          {
            if (betc.a()) {
              betc.a("AuthFilterList", "init config apiName : " + localSecondApiRightInfo.apiName + ", secondName: " + localSecondApiRightInfo.secondName);
            }
  ...
  public static void a(List<String> paramList1, List<String> paramList2)
  {
    ...
    if (paramList1 != null)
    {
      try
      {
        ...
        while (paramList1.hasNext())
        {
          ...
          {
            betc.a("AuthFilterList", "whiteList eventName : " + str);
    ...
    else
    {
      ...
      while (paramList1.hasNext())
      {
        ...
        {
          betc.a("AuthFilterList", "whiteList eventName : " + paramList2);
  ...
  {
    return (paramMiniAppInfo != null) && ((paramMiniAppInfo.isAppStoreMiniApp()) || ((paramMiniAppInfo.appMode != null) && (paramMiniAppInfo.appMode.b)));
  }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    if (jdField_a_of_type_JavaUtilMap.containsKey(paramString1))
    {
      ...
      {
        betc.a("AuthFilterList_isEventNameRight", "false, 一级黑名单 : " + paramString1);
        return false;
      }
      if (((Integer)jdField_a_of_type_JavaUtilMap.get(paramString1)).intValue() == 1)
      {
        betc.a("AuthFilterList_isEventNameRight", "true, 一级白名单 : " + paramString1);
        return true;
      }
    }
    if (jdField_b_of_type_JavaUtilMap.containsKey(paramString1))
    {
      ...
      {
        betc.a("AuthFilterList_isEventNameRight", "true, 二级白名单 : " + paramString1 + " " + paramString2);
        return true;
      }
      betc.a("AuthFilterList_isEventNameRight", "false, 二级黑名单或未配置 : " + paramString1 + " " + paramString2);
      return false;
    }
    if (jdField_b_of_type_JavaUtilList.contains(paramString1))
    {
      betc.a("AuthFilterList_isEventNameRight", "false, 本地黑名单 : " + paramString1);
      return false;
    }
    betc.a("AuthFilterList_isEventNameRight", "true, 无限制api : " + paramString1);
    return true;
  }
  ...
  private static void b()
  {
    ...
    {
      String str1 = bema.a("MiniApp", "MiniAppAuthWhiteList", "1108292102");
      if ((str1 != null) && (!str1.equals(jdField_a_of_type_JavaLangString)))
      {
        ...
        {
          betc.d("AuthFilterList", "initAuthWhiteList error,", localThrowable);
