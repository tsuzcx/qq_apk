...
public class bhco
  implements bhcw
{
  public bhco(QZoneMsgFragment paramQZoneMsgFragment) {}
    ...
    case 5: 
      ...
      do
      {
        ...
        if ((paramMQMsg != null) && (paramMQMsg.msgInteractData != null)) {
          ((bhcq)this.a.a.getManager(293)).a(paramMQMsg.msgInteractData.likeCell, paramMQMsg.pushTime);
        }
        ...
        if ((paramMQMsg != null) && (paramMQMsg.msgInteractData != null))
        {
          ...
          bgxy.b(this.a.getActivity(), bgyf.a(), paramView);
        }
        for (;;)
        {
        ...
        for (;;)
        {
          ...
          if (paramMQMsg.msgInteractData.shareToQzone != null)
          {
            ...
            bgyu.a(this.a.getActivity(), BaseApplicationImpl.getApplication().getRuntime().getAccount(), paramView, null, 0);
          }
        }
        paramMQMsg = bbej.a(this.a.a, this.a.getActivity(), "mqqzone://arouse/activefeed");
