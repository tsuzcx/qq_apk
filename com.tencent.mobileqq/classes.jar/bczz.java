...
public class bczz
{
  ...
  private List<bdae> jdField_a_of_type_JavaUtilList;
  ...
  public bczz(String paramString, int paramInt)
  {
  ...
  private bczz a(bdae parambdae)
  {
    if (parambdae != null) {
      this.jdField_a_of_type_JavaUtilList.add(parambdae);
    }
  ...
  private void a(StringBuilder paramStringBuilder, int paramInt)
  {
    ...
    while (paramInt < m)
    {
      if ((paramStringBuilder.charAt(paramInt) == '<') && (paramInt < k - 2))
      {
        ...
        if ((i == 36) && (paramInt < k - 3))
        {
          ...
          for (;;)
          {
            ...
            a(new bdac(paramStringBuilder.substring(paramInt, paramInt + 4), i, n));
            paramInt += 4;
            break;
            if (j == 10) {
          ...
          if ((j >= 255) && (paramInt + 6 < k))
          {
            if (paramStringBuilder.charAt(paramInt + 6) == '>')
            {
              ...
              a(new bdad(paramStringBuilder.substring(paramInt, paramInt + 7), j, n));
              i = 2;
              if (i < 5)
              {
          ...
          else if (j == 250)
          {
            ...
            a(new bdac(paramStringBuilder.substring(paramInt, paramInt + 4), 10, n));
            paramInt += 4;
          }
        }
        else if (((i == 37) || (i == 38)) && (paramInt < k - 6))
        {
          a(new bdab(paramStringBuilder.substring(paramInt, paramInt + 7)));
          paramInt += 7;
        }
      }
      else
      {
        ...
        {
          a(new bczy(paramStringBuilder.substring(paramInt, paramInt + 2)));
          paramInt += 2;
          continue;
        }
        a(new bdaa(String.valueOf(paramStringBuilder.charAt(paramInt))));
      }
      label635:
      paramInt += 1;
    }
  ...
  public bczz a(int paramInt)
  {
    bczz localbczz = new bczz();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
    {
      bdae localbdae = (bdae)localIterator.next();
      if (localbdae.a() == paramInt) {
        localbczz.a(localbdae);
      }
    }
    return localbczz;
  }
  ...
  @NonNull
  public bdae a(int paramInt)
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return (bdae)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    }
  ...
  public String a()
  {
    ...
    {
      bdae localbdae = (bdae)localIterator.next();
      if ((localbdae.a() == 0) || (localbdae.a() == 1)) {
        localStringBuilder.append(localbdae.a());
      }
    }
    return localStringBuilder.toString();
  }
  
  public bczz b(int paramInt)
  {
    bczz localbczz = new bczz();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
  ...
  public String b()
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      localStringBuilder.append(((bdae)localIterator.next()).a());
    }
    return localStringBuilder.toString();
  }
