...
public class uns
  extends ujr<stGetPersonalFeedListRsp>
{
  public uns(String paramString1, String paramString2, boolean paramBoolean, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    upe.d("PersonalFeedListRequest", "stSimpleGetFeedListReq  = " + localstGetPersonalFeedListReq.toString());
  }
}
