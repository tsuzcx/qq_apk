...
public class uns
{
  ...
  public uns(Activity paramActivity, unt paramunt)
  {
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Unt = paramunt;
  }
  ...
  public static void a(Activity paramActivity, Intent paramIntent)
  {
    ...
    sxm.a(paramActivity, i, paramIntent);
  }
  ...
  public static void c(Activity paramActivity, Intent paramIntent)
  {
    ...
    {
      ved.e("Q.qqstory.home.QQStoryHomeJumpHelper", "handleOpenTagAction parm error");
      return;
    }
    tti.a(paramActivity, str, paramIntent);
  }
  
  public static void d(Activity paramActivity, Intent paramIntent)
  {
    paramIntent = (String)((tcs)tcz.a(10)).b("mainHallConfig", "");
    if (!TextUtils.isEmpty(paramIntent)) {}
    for (;;)
    {
      try
      {
        ...
        ved.d("Q.qqstory.home.QQStoryHomeJumpHelper", "square config not ready , use default config instead");
        return;
      }
      catch (Exception paramIntent)
      {
        ved.d("Q.qqstory.home.QQStoryHomeJumpHelper", "analyze config error , error :%s", new Object[] { paramIntent.getMessage() });
      }
      paramIntent = "";
    }
  ...
  private void e(Intent paramIntent)
  {
    ...
    bbeg.a(QQStoryContext.a(), this.jdField_a_of_type_AndroidAppActivity, paramIntent, str);
  }
  ...
  private void h(Intent paramIntent)
  {
    ...
    sxm.a(this.jdField_a_of_type_AndroidAppActivity, 23, str);
  }
  ...
  {
    ved.b("Q.qqstory.home.QQStoryHomeJumpHelper", "handleAction=" + paramInt);
    switch (paramInt)
    {
    case 3: 
    default: 
    ...
    case 1: 
      ...
      this.jdField_a_of_type_Unt.a(false, true, 16, null);
      return true;
    case 2: 
      a(paramIntent);
      return true;
  ...
  protected void c(Intent paramIntent)
  {
    ...
    if (paramIntent == null)
    {
      ved.e("Q.qqstory.home.QQStoryHomeJumpHelper", "handle open play list error , no play info !");
      return;
    }
    tvc.a(this.jdField_a_of_type_AndroidAppActivity, paramIntent, 31, null);
  }
