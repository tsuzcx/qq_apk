  ...
  implements Handler.Callback, bdvv, bdvw, Manager
{
  ...
  private bkde jdField_a_of_type_Bkde;
  ...
  public bkda(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bkcz = new bkcz(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  private String a(bkde parambkde)
  {
    parambkde = a() + parambkde.jdField_a_of_type_Long + File.separator;
    File localFile = new File(parambkde);
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
    return parambkde;
  ...
  private void a(bdwt parambdwt)
  {
    ...
    do
    {
      ...
      QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] http download error=%d", new Object[] { Integer.valueOf(parambdwt.jdField_a_of_type_Int) }));
      return;
      localbkdb = (bkdb)parambdwt.jdField_a_of_type_Bdws.a();
    } while (localbkdb == null);
    if (parambdwt.jdField_a_of_type_Int == 0) {}
    while (!bool)
    {
      try
      {
        if (localbkdb.jdField_d_of_type_Int >= 3) {
          break label146;
        }
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] retried to download, retry=%d, result=%b, url=%s", new Object[] { Integer.valueOf(localbkdb.jdField_d_of_type_Int), Boolean.valueOf(bool), localbkdb.jdField_c_of_type_JavaLangString }));
        }
        a(localbkdb);
        return;
      }
      ...
      continue;
      label146:
      File localFile = new File(parambdwt.jdField_a_of_type_Bdws.jdField_c_of_type_JavaLangString);
      if (localFile.exists()) {
        localFile.delete();
      }
    }
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(localbkdb.jdField_d_of_type_JavaLangString.toLowerCase());
    a(bool, parambdwt.jdField_a_of_type_Bdws);
  }
  
  private void a(bkde parambkde)
  {
    if (parambkde != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] update complete: sid=%d", new Object[] { Long.valueOf(parambkde.jdField_a_of_type_Long) }));
      }
      parambkde.a();
      if (b())
      {
        this.jdField_a_of_type_JavaLangString += String.format("#%d#", new Object[] { Long.valueOf(parambkde.jdField_b_of_type_Long) });
        this.jdField_b_of_type_JavaLangString += String.format("#%d#", new Object[] { Long.valueOf(parambkde.jdField_a_of_type_Long) });
      }
      a("0X80078B4", 0, "", "");
    }
  }
  ...
  private void a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    {
      paramInt = (int)this.jdField_a_of_type_Bkde.jdField_b_of_type_Long;
      if (this.jdField_a_of_type_Bkde == null) {
        break label188;
      }
    }
    label188:
    for (paramString2 = String.format("%d", new Object[] { Long.valueOf(this.jdField_a_of_type_Bkde.jdField_a_of_type_Long) });; paramString2 = "")
    {
      if (QLog.isColorLevel()) {
      ...
      localbkaf.a(paramString1).a(paramString1).a(paramString3).a(paramString2).a(this.jdField_a_of_type_Int);
      bkac.a(localbkaf.toString(), 105, paramInt);
      return;
      paramInt = 0;
      break;
    }
  ...
  private void a(boolean paramBoolean, bdws parambdws)
  {
    if ((!paramBoolean) || (parambdws == null))
    {
      a(3);
      return;
    }
    File localFile = new File(parambdws.jdField_c_of_type_JavaLangString);
    bkdb localbkdb = (bkdb)parambdws.a();
    if ((!localFile.exists()) || (localbkdb == null))
    {
      a(3);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] http download complete: %s, %s", new Object[] { parambdws.jdField_c_of_type_JavaLangString, localbkdb.jdField_c_of_type_JavaLangString }));
    }
    switch (localbkdb.jdField_a_of_type_Int)
    {
    default: 
      return;
    case 1: 
      localFile = new File(b());
      new File(parambdws.jdField_c_of_type_JavaLangString).renameTo(localFile);
      a("0X80078AC", localbkdb.jdField_c_of_type_Int, "", "");
      if (this.jdField_a_of_type_Bkcz.a(localFile.toString()))
      {
        this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putInt("last_update_config_version", localbkdb.jdField_c_of_type_Int).commit();
        if (this.jdField_a_of_type_Bkcz.a().isEmpty())
        {
          if (QLog.isColorLevel()) {
      ...
      a("0X80078AC", localbkdb.jdField_c_of_type_Int, localbkdb.jdField_b_of_type_JavaLangString, localbkdb.jdField_c_of_type_JavaLangString);
      if (QLog.isColorLevel()) {
    ...
    a("0X80078AE", localbkdb.jdField_c_of_type_Int, "", "");
    d(7);
  }
  
  private boolean a()
  {
    Object localObject = this.jdField_a_of_type_Bkcz.a();
    int i = 0;
    if (i < ((List)localObject).size()) {
      if (((bkde)((List)localObject).get(i)).a()) {}
    }
  ...
  private boolean a(bkdb parambkdb)
  {
    if (parambkdb == null) {}
    do
    {
      return false;
      if ((parambkdb.jdField_a_of_type_Int == 2) && (parambkdb.e != 1) && (!NetworkUtils.isWifiConnected(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication())))
      {
        if (QLog.isColorLevel()) {
    ...
    } while ((parambkdb.jdField_d_of_type_Int < 3) && (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.contains(parambkdb.jdField_d_of_type_JavaLangString.toLowerCase())));
    ...
    localbdvs.jdField_a_of_type_JavaLangString = parambkdb.jdField_c_of_type_JavaLangString;
    localbdvs.jdField_a_of_type_Int = 0;
    localbdvs.jdField_c_of_type_JavaLangString = (parambkdb.jdField_a_of_type_JavaLangString + parambkdb.jdField_b_of_type_JavaLangString);
    parambkdb.jdField_d_of_type_Int += 1;
    parambkdb.jdField_a_of_type_Long = new Date().getTime();
    localbdvs.a(parambkdb);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(parambkdb.jdField_d_of_type_JavaLangString.toLowerCase(), localbdvs);
    localbdvu.a(localbdvs);
    if (QLog.isColorLevel()) {
      QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] begin http download %s", new Object[] { parambkdb.jdField_c_of_type_JavaLangString }));
    }
    return true;
  }
  
  private boolean a(bkde parambkde)
  {
    boolean bool;
    if (parambkde != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] rollback: sid=%d", new Object[] { Long.valueOf(parambkde.jdField_a_of_type_Long) }));
      }
      if (parambkde.jdField_b_of_type_JavaUtilList.isEmpty())
      {
        if (!QLog.isColorLevel()) {
          break label355;
        }
    ...
    for (;;)
    {
      ...
      return bool;
      String str = b(parambkde);
      long l2 = 0L;
      int i = 0;
      while (i < parambkde.jdField_b_of_type_JavaUtilList.size())
      {
        Object localObject = (bkdd)parambkde.jdField_b_of_type_JavaUtilList.get(i);
        File localFile1 = new File(((bkdd)localObject).f);
        File localFile2 = new File(((bkdd)localObject).g);
        long l1 = l2;
        ...
        l2 = l1;
        if (((bkdd)localObject).jdField_a_of_type_Int == 2)
        {
          l2 = l1;
        ...
        localObject = new File(str, ((bkdd)localObject).jdField_c_of_type_JavaLangString);
        l1 = l2;
      ...
      if (l2 == parambkde.jdField_b_of_type_JavaUtilList.size())
      {
        bool = true;
      }
      else
  ...
  private String b(bkde parambkde)
  {
    parambkde = a(parambkde) + "bak" + File.separator;
    File localFile = new File(parambkde);
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
  ...
  private void b(bkde parambkde)
  {
    if (parambkde != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] cleanup: sid=%d", new Object[] { Long.valueOf(parambkde.jdField_a_of_type_Long) }));
      }
      bgmg.a(a(parambkde), false);
    }
  }
  ...
  private boolean b(bkde parambkde)
  {
    return true;
  }
  
  private String c(bkde parambkde)
  {
    return a(parambkde) + parambkde.jdField_a_of_type_JavaLangString;
  }
  ...
  private void c()
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_Boolean = false;
      a("0X80078B5", 0, "", "");
      this.jdField_a_of_type_Bkde = null;
      if (QLog.isColorLevel()) {
  ...
  {
    this.jdField_a_of_type_Bkde = null;
    List localList = this.jdField_a_of_type_Bkcz.a();
    int i = 0;
    label150:
    boolean bool;
    if (i < localList.size())
    {
      bkde localbkde = (bkde)localList.get(i);
      if (localbkde.a()) {}
      for (;;)
      {
        i += 1;
        break;
        if ((localbkde.jdField_b_of_type_Boolean) && (localbkde.jdField_a_of_type_Boolean) && (localbkde.jdField_c_of_type_Boolean)) {
          break label150;
        }
        if (QLog.isColorLevel()) {
          QLog.w("QQProtect.QPUpdate", 2, String.format("[SFU] not matched section: sid=%d, os: %b, qq:%b, cpu:%b", new Object[] { Long.valueOf(localbkde.jdField_a_of_type_Long), Boolean.valueOf(localbkde.jdField_b_of_type_Boolean), Boolean.valueOf(localbkde.jdField_a_of_type_Boolean), Boolean.valueOf(localbkde.jdField_c_of_type_Boolean) }));
        }
        localbkde.a();
      }
      this.jdField_a_of_type_Bkde = localbkde;
      c(0);
      if (QLog.isColorLevel())
      {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] next update: sid=%d", new Object[] { Long.valueOf(this.jdField_a_of_type_Bkde.jdField_a_of_type_Long) }));
        bool = true;
      }
    }
    for (;;)
  ...
  private boolean c(bkde parambkde)
  {
    String str;
    if (parambkde != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] verify package: sid=%d", new Object[] { Long.valueOf(parambkde.jdField_a_of_type_Long) }));
      }
      str = bkcx.a(c(parambkde));
      if (str == null) {
        return false;
      }
    }
    for (boolean bool = str.equalsIgnoreCase(parambkde.jdField_b_of_type_JavaLangString);; bool = false)
    {
      if (QLog.isColorLevel()) {
  ...
  private void d(int paramInt)
  {
    ...
    case 6: 
      do
      {
        ...
        d();
        return;
        if ((c()) && (this.jdField_a_of_type_Bkde != null))
        {
          if (!i(this.jdField_a_of_type_Bkde))
          {
            d(15);
            return;
          }
        ...
        d(16);
        return;
      } while ((this.jdField_a_of_type_Bkde != null) && (h(this.jdField_a_of_type_Bkde)));
      a(3);
      return;
    case 7: 
      if ((this.jdField_a_of_type_Bkde != null) && (c(this.jdField_a_of_type_Bkde)))
      {
        d(8);
        return;
      }
      ...
      return;
    case 8: 
      if ((this.jdField_a_of_type_Bkde != null) && (g(this.jdField_a_of_type_Bkde)))
      {
        d(9);
        return;
      }
      ...
      return;
    case 9: 
      if ((this.jdField_a_of_type_Bkde != null) && (e(this.jdField_a_of_type_Bkde)))
      {
        d(10);
        return;
      }
      ...
      return;
    case 10: 
      if ((this.jdField_a_of_type_Bkde != null) && (f(this.jdField_a_of_type_Bkde)))
      {
        d(11);
        return;
      }
      ...
      return;
    case 11: 
      if ((this.jdField_a_of_type_Bkde != null) && (d(this.jdField_a_of_type_Bkde)))
      {
        d(12);
        return;
      }
      ...
      return;
    case 12: 
      if ((this.jdField_a_of_type_Bkde != null) && (b(this.jdField_a_of_type_Bkde)))
      {
        a(0);
        return;
      }
      ...
      return;
    case 13: 
      if ((this.jdField_a_of_type_Bkde != null) && (a(this.jdField_a_of_type_Bkde)))
      {
        a(0);
        return;
      }
    ...
    case 14: 
      if (this.jdField_a_of_type_Bkde != null) {
        b(this.jdField_a_of_type_Bkde);
      }
      d(15);
      return;
    case 15: 
      a(this.jdField_a_of_type_Bkde);
      this.jdField_a_of_type_Bkde = null;
      if (a())
      {
        d(16);
  ...
  private boolean d(bkde parambkde)
  {
    boolean bool;
    if (parambkde != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] verify: sid=%d", new Object[] { Long.valueOf(parambkde.jdField_a_of_type_Long) }));
      }
      if (parambkde.jdField_c_of_type_JavaUtilList.isEmpty())
      {
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] no diff: sid=%d", new Object[] { Long.valueOf(parambkde.jdField_a_of_type_Long) }));
        }
        bool = true;
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        if (i < parambkde.jdField_c_of_type_JavaUtilList.size())
        {
          bkdd localbkdd = (bkdd)parambkde.jdField_c_of_type_JavaUtilList.get(i);
          if (TextUtils.isEmpty(localbkdd.g)) {}
          for (String str = localbkdd.f;; str = localbkdd.g)
          {
            str = bkcx.a(str);
            if ((str != null) && (str.equalsIgnoreCase(localbkdd.jdField_b_of_type_JavaLangString))) {
              break label246;
            }
            if (!QLog.isColorLevel()) {
              break label253;
            }
            QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] not matched: %s!=%s, sid=%d", new Object[] { str, localbkdd.jdField_b_of_type_JavaLangString, Long.valueOf(parambkde.jdField_a_of_type_Long) }));
            bool = false;
            break;
          }
          label246:
  ...
  private boolean e(bkde parambkde)
  {
    boolean bool;
    if (parambkde != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] backup: sid=%d", new Object[] { Long.valueOf(parambkde.jdField_a_of_type_Long) }));
      }
      if (parambkde.f == 0L)
      {
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (parambkde.f > 0L)
      {
        String str1 = b(parambkde);
        long l1 = 0L;
        int i = 0;
        while (i < parambkde.jdField_c_of_type_JavaUtilList.size())
        {
          bkdd localbkdd = (bkdd)parambkde.jdField_c_of_type_JavaUtilList.get(i);
          long l2 = l1;
          if (1 == localbkdd.jdField_a_of_type_Int)
          {
            String str2 = str1 + localbkdd.jdField_c_of_type_JavaLangString;
            a(new File(localbkdd.f), new File(str2));
            l2 = l1 + 1L;
          }
          i += 1;
          l1 = l2;
        ...
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] backup %d files of %d", new Object[] { Long.valueOf(l1), Integer.valueOf(parambkde.jdField_c_of_type_JavaUtilList.size()) }));
        }
        if (parambkde.f == l1) {
          bool = true;
        } else {
  ...
  private boolean f(bkde parambkde)
  {
    boolean bool1;
    if ((parambkde != null) && (!parambkde.jdField_c_of_type_JavaUtilList.isEmpty()))
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] do update files: sid=%d", new Object[] { Long.valueOf(parambkde.jdField_a_of_type_Long) }));
      }
      String str = a(parambkde);
      int i = 0;
      if (i < parambkde.jdField_c_of_type_JavaUtilList.size())
      {
        bkdd localbkdd = (bkdd)parambkde.jdField_c_of_type_JavaUtilList.get(i);
        File localFile1 = new File(str, localbkdd.jdField_b_of_type_JavaLangString);
        Object localObject = new File(localbkdd.f);
        ...
        for (;;)
        {
          ...
          if (!bool2)
          {
            localObject = localbkdd.f + ".1";
            File localFile2 = new File((String)localObject);
            localbkdd.jdField_a_of_type_Int = 3;
            localbkdd.g = ((String)localObject);
            bool2 = a(localFile1, localFile2);
            if (QLog.isColorLevel()) {
              QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] copied failed, renamed to: %s", new Object[] { localbkdd.g }));
            }
            bool1 = bool2;
            if (bool2)
            {
              this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putString(localbkdd.f, localbkdd.g).commit();
              bool1 = bool2;
            }
          }
          if (!bool1) {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] success copied: %s", new Object[] { localbkdd.f }));
          }
          parambkde.jdField_b_of_type_JavaUtilList.add(localbkdd);
          parambkde.g += 1L;
        }
        label376:
        a("0X80078B2", (int)localbkdd.jdField_b_of_type_Long, localbkdd.jdField_a_of_type_JavaLangString, localbkdd.jdField_b_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
          QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] failed copied: %s", new Object[] { localbkdd.f }));
        }
      }
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] update %d files of %d", new Object[] { Long.valueOf(parambkde.g), Integer.valueOf(parambkde.jdField_c_of_type_JavaUtilList.size()) }));
      }
      if (parambkde.g == parambkde.jdField_c_of_type_JavaUtilList.size()) {
        bool1 = true;
      }
    }
    for (;;)
  ...
  private boolean g(bkde parambkde)
  {
    boolean bool;
    if (parambkde != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] unzip package: sid=%d", new Object[] { Long.valueOf(parambkde.jdField_a_of_type_Long) }));
      }
      String str = a(parambkde);
      File localFile = new File(str);
      if (!localFile.exists()) {
  ...
  private boolean h(bkde parambkde)
  {
    boolean bool = false;
    if (parambkde != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] download package: sid=%d", new Object[] { Long.valueOf(parambkde.jdField_a_of_type_Long) }));
      }
      bool = a(new bkdb(2, 0, a(parambkde), parambkde.jdField_a_of_type_JavaLangString, parambkde.jdField_c_of_type_JavaLangString, parambkde.jdField_b_of_type_JavaLangString, 0, true, 0, new Date().getTime(), parambkde.jdField_b_of_type_Int));
    }
    return bool;
  }
  
  private boolean i(bkde parambkde)
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    if (parambkde != null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] get different: sid=%d", new Object[] { Long.valueOf(parambkde.jdField_a_of_type_Long) }));
      }
      List localList = parambkde.jdField_a_of_type_JavaUtilList;
      int i = 0;
      if (i < localList.size())
      {
        bkdd localbkdd = (bkdd)localList.get(i);
        if (!new File(localbkdd.f).exists())
        {
          localbkdd.jdField_a_of_type_Int = 2;
          parambkde.jdField_c_of_type_JavaUtilList.add(localbkdd);
        }
        String str;
        do
        {
          i += 1;
          break;
          str = bkcx.a(localbkdd.f);
        } while ((str != null) && (str.equalsIgnoreCase(localbkdd.jdField_b_of_type_JavaLangString)));
        localbkdd.jdField_a_of_type_Int = 1;
        if (str != null) {}
        for (;;)
        {
          localbkdd.jdField_c_of_type_JavaLangString = str;
          parambkde.jdField_c_of_type_JavaUtilList.add(localbkdd);
          parambkde.f += 1L;
          break;
          str = "";
      ...
      if (QLog.isColorLevel()) {
        QLog.d("QQProtect.QPUpdate", 2, String.format("[SFU] need to update %d files of %d", new Object[] { Integer.valueOf(parambkde.jdField_c_of_type_JavaUtilList.size()), Integer.valueOf(parambkde.jdField_a_of_type_JavaUtilList.size()) }));
      }
      bool1 = bool2;
      if (!parambkde.jdField_c_of_type_JavaUtilList.isEmpty()) {
        bool1 = true;
      ...
      try
      {
        ...
        if (localUpdateQueryResponse != null)
        {
          ...
          if ((i1 == 0) && (k == 1))
          {
            ...
            bool1 = a(new bkdb(1, k, a(), "qp_sfu_config.dat", paramFromServiceMsg, paramToServiceMsg, m, bool1, 0, new Date().getTime(), 1));
          }
        }
        else
        {
        ...
        if (i1 == 1)
        {
          ...
          bool1 = bool2;
          if (!this.jdField_a_of_type_Bkcz.a(paramToServiceMsg.toString())) {
            continue;
          }
          if (this.jdField_a_of_type_Bkcz.a().isEmpty()) {
            d(16);
  ...
  {
    if (this.jdField_a_of_type_AndroidOsHandler != null) {
      this.jdField_a_of_type_AndroidOsHandler.obtainMessage(1052688, parambdwt).sendToTarget();
    }
  }
  
  public void onUpdateProgeress(bdws parambdws, long paramLong1, long paramLong2)
  {
    this.jdField_a_of_type_AndroidOsHandler.obtainMessage(1052689, (int)paramLong1, (int)paramLong2, parambdws).sendToTarget();
  }
}
