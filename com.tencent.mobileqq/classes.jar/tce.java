...
public class tce
{
  ...
  public static Pair<String, Bitmap> a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        int n = afur.a(0.5F, localResources);
        int i = afur.a(90.0F, localResources);
        ...
        if (k >= paramInt)
        {
          ...
          localCanvas.drawBitmap(BitmapFactory.decodeResource(localResources, 2130841643), afur.a(13.0F, localResources), afur.a(25.0F, localResources) + paramInt, localPaint);
          localPaint.setColor(-16777216);
          localPaint.setTextSize(afur.a(2, 18, localResources));
          localCanvas.drawText("QQ看点", afur.a(60.0F, localResources), afur.a(42.0F, localResources) + paramInt, localPaint);
          localPaint.setColor(Color.parseColor("#777777"));
          localPaint.setTextSize(afur.a(2, 14, localResources));
          localCanvas.drawText(localResources.getString(2131694642), afur.a(60.0F, localResources), afur.a(61.0F, localResources) + paramInt, localPaint);
          ...
          str = (String)nlw.a((HashMap)localObject).get("url");
          ...
          bctj.a(BaseApplication.getContext()).a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "actReadInJoyShortenUrl", true, 0L, 0L, (HashMap)localObject, "");
      ...
      catch (Exception paramString1)
      {
        try
        {
          ...
          paramString1 = bgbw.a(paramString2, localResources, afur.a(80.0F, localResources), 0, false);
          paramString2 = paramString1;
          if (paramString1 == null)
          {
            if (QLog.isColorLevel()) {
            ...
            paramString2 = BitmapFactory.decodeResource(localResources, 2130841649);
          }
          localCanvas.drawBitmap(paramString2, j - afur.a(5.0F, localResources) - paramString2.getWidth(), afur.a(5.0F, localResources) + paramInt, localPaint);
      ...
      if (TextUtils.isEmpty(str))
      {
        ...
        bctj.a(BaseApplication.getContext()).a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), "actReadInJoyShortenUrl", false, 0L, 0L, (HashMap)localObject, "");
        paramString1 = null;
      }
  ...
  public static String a(Bitmap paramBitmap, String paramString)
  {
    ...
    //   3: dup
    //   4: getstatic 346	anhk:cC	Ljava/lang/String;
    //   7: invokestatic 350	bhgg:a	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   57: getstatic 346	anhk:cC	Ljava/lang/String;
    ...
    //   80: invokestatic 350	bhgg:a	(Ljava/lang/String;)Ljava/lang/String;
    //   83: astore 4
