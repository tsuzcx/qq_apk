...
public class ajgc
  extends ajgd
{
  public ajgc(int paramInt, ajgf paramajgf, ajgb paramajgb)
  {
    super(paramInt, paramajgf, paramajgb);
  }
  
  public ajgc(int paramInt, String paramString, ajgf paramajgf, ajgb paramajgb)
  {
    super(paramInt, paramString, paramajgf, paramajgb);
  }
  ...
  private aivv b()
  {
    ...
    try
    {
      ...
      {
        localJSONObject.put("is3DBetaTester", ajfh.a(localQQAppInterface));
  ...
  private aivv d(String paramString)
  {
    try
    {
      QLog.d("CmShow_SpriteActionScript", 1, new Object[] { "handleJsError mSpriteFrom:", Integer.valueOf(this.jdField_a_of_type_Ajgf.e) });
      paramString = new JSONObject(paramString).optString("data");
      ajlo.a(ajfh.b(this.jdField_a_of_type_Ajgf.e), 1000, 50, new Object[] { paramString });
      return null;
    }
    catch (Exception paramString)
    {
  ...
  private aivv f(String paramString)
  {
    try
    {
      ...
      if ((i == ajfh.b(1)) || (i == ajfh.b(2))) {
        ajlo.a(i, null, new int[] { ajln.a(i, false, this.jdField_a_of_type_Ajgf.jdField_b_of_type_Int, -1, true) });
      }
      ajlo.b(i);
      if ((i == ajfh.b(1)) || (i == ajfh.b(2)))
      {
        ajlo.a(ajfh.b(this.jdField_a_of_type_Ajgf.e), false);
        return null;
      }
    }
    catch (Throwable paramString)
  ...
  private aivv j(String paramString)
  {
    try
    {
      if (this.jdField_a_of_type_Ajgf.e != 0) {
        return null;
      }
  ...
  private aivv m(String paramString)
  {
    try
    {
      ...
      paramString = this.jdField_a_of_type_Ajgb;
      if (paramString != null) {
        return null;
      }
    }
      ...
      try
      {
        ...
        if ("pet".equals(paramString.getString("config_name")))
        {
          ...
          if (localObject != null)
          {
            ...
            if (((airx)localObject).j == null) {
              break label124;
            }
            paramString = new JSONArray(((airx)localObject).j);
  ...
  private aivv p(String paramString)
  {
    ...
    paramString = this.jdField_a_of_type_Ajgf.a();
    if (paramString != null)
    {
      paramString.a();
      return null;
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject = ajfh.a(ApolloUtil.a());
          if (localObject != null)
          {
  ...
  private aivv q(String paramString)
  {
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_Ajgf == null) || (this.jdField_a_of_type_Ajgf.a() == null))
      {
      ...
      if (this.jdField_a_of_type_Ajgf.a().a() == null)
      {
    ...
    ApolloUtil.a(this.jdField_a_of_type_Ajgf.a().a(), (String)localObject);
    return null;
    label122:
    ...
    if (i > 0)
    {
      ApolloGameUtil.a(this.jdField_a_of_type_Ajgf.a(), i, 333002, "message", 1);
      return null;
    }
  ...
  public aivv a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localaivv.jdField_b_of_type_Boolean = true;
        JSONObject localJSONObject = new JSONObject();
        if ((1 == localQQAppInterface.c()) && (((this.jdField_a_of_type_Ajgf.jdField_a_of_type_Int != 1) && (this.jdField_a_of_type_Ajgf.jdField_a_of_type_Int != 3000)) || (((1 == localQQAppInterface.a()) || (this.jdField_a_of_type_Ajgf.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_Ajgf.jdField_a_of_type_Int == -2)) && (!localQQAppInterface.k()) && (!localQQAppInterface.l()) && (localQQAppInterface.m()) && (!MediaPlayerManager.a(localQQAppInterface).a()) && ((localQQAppInterface.a() == null) || (!localQQAppInterface.a().k())) && (!localQQAppInterface.c()))))
        {
  ...
  {
    aiuz localaiuz = a();
    if ((localaiuz == null) || (localaiuz.getLuaState() != paramLong)) {}
    do
    {
      do
      {
      ...
      if ("cs.script_update_boundinglist.local".equals(paramString1)) {
        return a(paramString2, localaiuz.getRenderImpl().a());
      }
  ...
  public aivv a(String paramString)
  {
    ...
    try
    {
      ...
      ajgl localajgl = this.jdField_a_of_type_Ajgb.a();
      if (localajgl != null)
      {
        int i = 0;
        if (i < localJSONArray1.length())
        {
          ...
          if (j == 1) {
            localJSONObject2.put("petPath", localajgl.a(new JSONArray(paramString.optString("actionList"))));
          }
          for (;;)
          {
            ...
            i += 1;
            break;
            localObject = localajgl.a((String)localObject);
  ...
  public void a(int paramInt)
  {
    try
    {
      ...
      ApolloUtil.a().callbackFromRequest(this.jdField_a_of_type_Ajgf.a().getLuaState(), 0, "sc.script_notify_user_operation.local", localJSONObject.toString());
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString, int paramInt5)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!this.jdField_a_of_type_Ajgf.jdField_b_of_type_Boolean) {
          break label874;
        }
        ...
        if (localObject != null)
        {
          ...
          localJSONObject.put("freeMemory", ((ajor)localObject).d);
          localJSONObject.put("totalMemory", ((ajor)localObject).jdField_c_of_type_Long);
          localJSONObject.put("maxMemory", ((ajor)localObject).jdField_b_of_type_Long);
        }
        localJSONObject.put("aioType", ApolloGameUtil.a(ApolloUtil.a(), paramInt4, this.jdField_a_of_type_Ajgf.jdField_a_of_type_JavaLangString));
        ...
        localJSONObject.put("uin", this.jdField_a_of_type_Ajgf.jdField_b_of_type_JavaLangString);
        ...
        {
          paramString.put(ajki.a(1, Integer.valueOf(localObject[paramInt2]).intValue()));
          paramInt2 += 1;
          continue;
        }
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    try
    {
      ...
      {
        ApolloCmdChannel.getChannel(paramString1).callbackFromRequest(this.jdField_a_of_type_Ajgf.a().getLuaState(), 0, "sc.script_on_sprite_single_clicked.local", localJSONObject.toString());
        return;
      }
      paramString1 = ApolloUtil.a();
      if (paramString1 != null)
      {
        ApolloCmdChannel.getChannelFromOtherProcess(paramString1).callbackFromRequest(this.jdField_a_of_type_Ajgf.a().getLuaState(), 0, "sc.script_on_sprite_single_clicked.local", localJSONObject.toString());
        return;
      }
    }
  ...
  {
    if ((this.jdField_a_of_type_Ajgf != null) && (this.jdField_a_of_type_Ajgf.a() != null)) {
      a(this.jdField_a_of_type_Ajgf.a().getWidth(), this.jdField_a_of_type_Ajgf.a().getInitHeight(), this.jdField_a_of_type_Ajgf.a().getHeight(), this.jdField_a_of_type_Ajgf.jdField_a_of_type_Int, this.jdField_a_of_type_Ajgf.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Ajgf.e);
    }
  }
  ...
  public aivv c(String paramString)
  {
    try
    {
      int i = this.jdField_a_of_type_Ajgf.e;
      if (i != 0) {}
      return null;
    }
    catch (Throwable paramString)
