...
public class suf
{
  ...
  public suf(View paramView, View.OnClickListener paramOnClickListener)
  {
  ...
  {
    a(paramInt, paramString1, paramString2, 2130843229);
  }
  ...
  public void a(int paramInt1, String paramString1, String paramString2, int paramInt2)
  {
    if (this.jdField_b_of_type_AndroidViewView == null)
    {
      this.jdField_b_of_type_AndroidViewView = ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131366244)).inflate();
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131366245));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131366239));
      this.c = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131380983));
      this.jdField_b_of_type_AndroidViewView.setOnClickListener(null);
    }
    c();
    six.a(this.jdField_b_of_type_AndroidViewView);
    ...
    if (paramInt1 == 1)
    {
      ...
      paramString1 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841837);
  ...
  {
    if (this.jdField_b_of_type_AndroidViewView != null) {
      six.a(this.jdField_b_of_type_AndroidViewView, 8, 300, true);
    }
  }
}
