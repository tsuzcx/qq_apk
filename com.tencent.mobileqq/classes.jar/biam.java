...
public class biam
{
  ...
  {
    PackageManager localPackageManager = bhpc.a().a().getPackageManager();
    try
    {
    ...
    {
      bhzm.b("AppUtil", "getApkVersonCode>>>", paramString);
    }
    return 0;
  }
  ...
  public static Bitmap a(String paramString)
  {
    try
    {
      ...
      if ((paramString != null) && (paramString.applicationInfo != null))
      {
        ...
        if (paramString != null)
        {
          paramString = bhzk.b(paramString);
          return paramString;
        }
      }
    }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramString = bhpc.a().a().getPackageManager().getPackageArchiveInfo(paramString, 1);
        if (paramString != null)
        {
      ...
      {
        bhzm.c("AppUtil", "getApkName>>>", paramString);
      }
    }
    return null;
  }
    ...
    catch (Exception localException)
    {
      ...
      if (paramString1 != null)
      {
        ...
        catch (Exception paramString1)
        {
          ...
          Toast.makeText(paramContext, amtj.a(2131699781), 0).show();
          return;
        }
      }
      Toast.makeText(paramContext, amtj.a(2131699782), 0).show();
    }
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (!TextUtils.isEmpty(paramString3))
    {
      ...
      bhzm.c("add", ">>has add appCustom=" + paramString3);
    }
    paramString1.putExtra("platformId", "qzone_m");
    bhzm.c("add", ">>has add platformid=qzone_m");
    try
    ...
    {
      Toast.makeText(paramContext, amtj.a(2131699783), 0).show();
    }
  }
  ...
  public static boolean a(Context paramContext)
  {
    if (paramContext == null)
    {
      bhzm.e("AppUtil", "isPackageScanAllowed context is null");
      return true;
    }
    try
    {
      boolean bool = bhpc.a().a().getSharedPreferences("package_scan", 0).getBoolean("qqsetting_package_scan_flag", true);
      return bool;
    }
    catch (Exception paramContext)
    {
    ...
    if (localIntent == null)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          try
          {
            ((anbg)((BaseActivity)paramContext).app.getBusinessHandler(23)).b(paramString.trim(), paramContext, localIntent);
            return true;
          }
          catch (Exception paramBundle)
          {
            for (;;)
            {
              try
              {
                new anbg((QQAppInterface)null).a(paramString.trim(), paramContext, localIntent);
              }
              catch (Exception paramString)
              {
      ...
      {
        Toast.makeText(paramContext, amtj.a(2131699784), 0).show();
        return false;
      }
    }
  }
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    try
    {
      ...
      if (new File(paramString1).exists())
      {
        ...
        {
          bhzm.b("AppUtil", "installApp>>> put source " + paramString2);
          paramString1.putExtra("big_brother_source_key", paramString2);
        }
        if (!TextUtils.isEmpty(paramString3))
        {
          bhzm.b("AppUtil", "installApp>>> put ref id " + paramString3);
    ...
    {
      bhzm.c("AppUtil", "installApp>>>", paramContext);
    }
    return false;
  }
  ...
  {
    return bfwv.a(bhpc.a().a(), paramString);
  }
  ...
  public static int b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        bhzm.c("AppUtil", "getApkVersonCodeFromApkFile>>>", paramString);
      }
    }
    return 0;
  }
  ...
  public static String b(Context paramContext)
  {
    ...
    {
      bhzm.b("AppUtil", "getCurProcessName err", paramContext);
    }
    return null;
  }
  ...
  {
    bhzm.b("AppUtil", "getAppVersionCode: " + paramString);
    localObject1 = null;
    try
    {
      a(paramString);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        bhzm.e("AppUtil", "openManifest failed: " + localException.getMessage());
      }
    }
    ...
    for (;;)
    {
      ...
      {
        String str;
        bhzm.e("AppUtil", "error: " + paramString.getMessage());
        localObject1.close();
        return 0;
      }
      ...
      if ((!TextUtils.isEmpty(str)) && (str.equals("manifest")))
      {
        ...
        if (i < localObject1.getAttributeCount())
        {
          if (localObject1.getAttributeName(i).equals("versionCode"))
          {
            ...
            localObject1.close();
            bhzm.b("AppUtil", "apkPath:" + paramString + ",versionCode:" + str);
