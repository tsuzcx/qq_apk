  ...
  implements Handler.Callback
{
  ...
  public alnw(alny paramalny, alnz paramalnz)
  {
    this.jdField_a_of_type_Int = 0;
    this.jdField_a_of_type_Alny = paramalny;
    this.jdField_a_of_type_Alnz = paramalnz;
  }
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if ((!this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_ArrayOfJavaLangString != null) && (this.jdField_a_of_type_ArrayOfJavaLangString.length > 0))
        {
          ...
          new alnx(this, 0).execute(new Integer[] { Integer.valueOf(this.jdField_c_of_type_Int) });
        }
      }
      return;
    }
  ...
  public void a(int paramInt, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Alny.a(this, paramString1, this.jdField_b_of_type_JavaLangString, paramString2);
      return;
    }
    this.jdField_a_of_type_Int = 2;
  }
  ...
  public void a(Bitmap paramBitmap, int paramInt)
  {
    ...
    if ((this.jdField_b_of_type_Boolean) && (paramBitmap != null) && (!paramBitmap.isRecycled()))
    {
      ...
      this.jdField_a_of_type_Bhtd.obtainMessage(255, this.jdField_c_of_type_Int, 0).sendToTarget();
    }
    for (;;)
    {
      ...
      return;
      label77:
      paramBitmap = this.jdField_a_of_type_Bhtd.obtainMessage(255, this.jdField_c_of_type_Int, 0);
      this.jdField_a_of_type_Bhtd.sendMessageDelayed(paramBitmap, this.jdField_b_of_type_Int - l2);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    this.jdField_a_of_type_Alnz.a(paramMessage.arg1, this.jdField_a_of_type_AndroidGraphicsBitmap);
    ...
    if ((this.jdField_a_of_type_ArrayOfJavaLangString != null) && (this.jdField_a_of_type_ArrayOfJavaLangString.length > this.jdField_c_of_type_Int)) {
      new alnx(this, this.jdField_c_of_type_Int).execute(new Integer[] { Integer.valueOf(this.jdField_c_of_type_Int) });
    }
    for (;;)
    {
