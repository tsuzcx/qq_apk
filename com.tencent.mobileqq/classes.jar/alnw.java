  ...
  extends bgod
{
  ...
  {
    if ((parambgoe == null) || (this.a.a == null)) {}
    String str1;
    do
    {
      return;
      if (parambgoe.a != 0)
      {
        QLog.e("ApolloManager", 1, new Object[] { "preDownloadListener task error:", Integer.valueOf(parambgoe.a()) });
        return;
      }
      str1 = parambgoe.c;
      parambgoe = parambgoe.a();
    } while (parambgoe == null);
    ApolloPreDownloadData localApolloPreDownloadData = (ApolloPreDownloadData)parambgoe.getSerializable(str1);
    ...
    for (parambgoe = ApolloUtil.e(localApolloPreDownloadData.dirType) + localApolloPreDownloadData.zipDir;; parambgoe = amip.t + localApolloPreDownloadData.resId + ".zip")
    {
      ...
      ThreadManager.getSubThreadHandler().post(new ApolloManager.20.1(this, localApolloPreDownloadData, parambgoe, str2));
      return;
    }
  }
}
