...
public class bkai
{
  ...
  public bkai(Activity paramActivity, WebView paramWebView)
  {
  ...
  {
    bkad.a("WadlJsBridgeCall", 2, "dispatchAction wadlParams:" + paramWadlParams);
    ...
    {
      Pair localPair = acik.a((Intent)localObject);
      ...
      for (;;)
      {
        acik.a(null, "558", "205906", paramWadlParams.jdField_a_of_type_JavaLangString, "55801", "4", "430", new String[] { String.valueOf(localPair.first), (String)localPair.second, paramWadlParams.c, paramWadlParams.e, localObject });
        return;
        bnyp.a().a(paramWadlParams.d, paramWadlParams.jdField_a_of_type_JavaLangString);
        return;
        bnyp.a().b(paramWadlParams.d, paramWadlParams.jdField_a_of_type_JavaLangString);
        return;
  ...
  {
    bkad.c("WadlJsBridgeCall", "doDownloadAction params:" + paramString1 + ",fromWeb:" + paramBoolean + ",from:" + paramInt + ",weburl:" + paramString2);
    ...
    try
    {
      ...
      {
        acik.c(paramString2, "DELAY_LIST");
        acik.a(paramString2, paramString1, "DELAY_APPID_DETAIL_");
        acig.a();
        return 0;
      }
      if (!localWadlParams.jdField_a_of_type_Boolean)
      {
        acik.b(paramString2, "DELAY_LIST");
        acik.d(paramString2, "DELAY_APPID_DETAIL_");
      }
      if (localWadlParams.jdField_a_of_type_Boolean)
      {
        if (a(localWadlParams.h))
        {
          bkad.c("WadlJsBridgeCall", "##@Operation for wadlParams.resName:" + localWadlParams.h + " is not returned! The opertion of action: " + paramInt + " is ignored!");
          return 1;
        }
        a(localWadlParams.h);
      }
      ...
      {
        acik.a(null, "558", "202982", paramString2, "55801", "4", "430");
        bkad.c("WadlJsBridgeCall", "invalid url:" + localWadlParams);
        return -1;
        if (a(paramString2))
        {
          bkad.c("WadlJsBridgeCall", "##@Operation for appid:" + paramString2 + " is not returned! The opertion of action: " + paramInt + " is ignored!");
          return 1;
        }
        a(paramString2);
      }
    ...
    {
      bkad.a("WadlJsBridgeCall", "doDownloadAction:", paramString1);
      return -1;
    }
    return 0;
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    {
      bkad.a("WadlJsBridgeCall", "getQueryDownloadAction(String,String)>>>", paramString1);
    }
  }
  
  public void a(String paramString, boolean paramBoolean, int paramInt)
  {
    bkad.c("WadlJsBridgeCall", "startDownload delay task" + paramString + " ," + paramBoolean + "," + paramInt + ",isWiFi=" + AppNetConnInfo.isWifiConn());
    if (1 == paramInt) {
