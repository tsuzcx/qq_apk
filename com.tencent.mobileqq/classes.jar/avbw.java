...
public class avbw
  extends RecyclerView.Adapter<avcc>
{
  public avdg a;
  public List<HotPicData> a;
  
  public avbw(HotPicPageView paramHotPicPageView, int paramInt)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
  }
  
  public avcc a(ViewGroup paramViewGroup, int paramInt)
  {
    if (avbk.a(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqHotpicHotPicMainPanel.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Int)) {
      return new avbz(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView, LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_AndroidContentContext).inflate(2131558609, paramViewGroup, false), this.jdField_a_of_type_Avdg);
    }
    return new avcc(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView, LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_AndroidContentContext).inflate(2131558608, paramViewGroup, false), this.jdField_a_of_type_Avdg);
  }
  ...
  public void a(avcc paramavcc, int paramInt)
  {
    Object localObject1;
    Object localObject2;
    if ((paramavcc instanceof avbz))
    {
      localObject1 = (avbz)paramavcc;
      ((avbz)localObject1).d();
      localObject2 = ((avbz)localObject1).a();
      if (localObject2 != null)
      {
        ((HotVideoData)localObject2).SetPreviewDownloadListener(null);
        if (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avcn != null) {
          this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avcn.a((HotVideoData)localObject2);
        }
      }
      ((avbz)localObject1).a(null);
    }
    for (;;)
    {
      HotPicData localHotPicData = (HotPicData)this.jdField_a_of_type_JavaUtilList.get(paramInt);
      ViewGroup.MarginLayoutParams localMarginLayoutParams1 = (ViewGroup.MarginLayoutParams)paramavcc.d.getLayoutParams();
      ...
      if ((paramInt != 0) && (paramInt != 1) && (paramInt != 2))
      {
        ...
        ViewGroup.MarginLayoutParams localMarginLayoutParams2 = (ViewGroup.MarginLayoutParams)((avbz)localObject1).c.getLayoutParams();
        ...
        ((avbz)localObject1).a(localHotVideoData);
        ...
        if (localObject3 == null) {
          localObject2 = new allk(localHotVideoData.width, localHotVideoData.height);
        }
        f = i / ((allk)localObject2).a();
        i = ((allk)localObject2).b();
        ((avbz)localObject1).jdField_b_of_type_AndroidWidgetTextView.setText(localHotVideoData.getVideoLengthString());
        ((avbz)localObject1).a.setText(localHotVideoData.name);
        localMarginLayoutParams2.width = j;
        localMarginLayoutParams2.height = i;
        localObject2 = (ViewGroup.MarginLayoutParams)((avbz)localObject1).jdField_b_of_type_AndroidWidgetImageView.getLayoutParams();
        ...
        if (avda.a((HotVideoData)localObject3)) {
          break label827;
        }
        ((avbz)localObject1).a(-11);
        i = 1;
      }
      for (;;)
      {
        ...
        if (localObject2 != null)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Int != -20)
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avdf.a((URLDrawable)localObject2, paramInt);
            j = 16;
          ...
          if (i != 0)
          {
            ...
            ((avbz)localObject1).a((Drawable)localObject2);
          }
          label717:
        ...
        {
          label648:
          EventCollector.getInstance().onRecyclerBindViewHolder(paramavcc, paramInt, getItemId(paramInt));
          return;
          localMarginLayoutParams1.topMargin = 0;
          break;
          label805:
          ...
          break label355;
          label827:
          ((avbz)localObject1).a(0);
          if (!((HotVideoData)localObject3).CheckIsNeedBlurBackground()) {
            break label1239;
          }
          ((avbz)localObject1).b(new ColorDrawable(Color.parseColor("#7f000000")));
          if ((!this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.a()) || (Build.VERSION.SDK_INT < 17) || (this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avcn == null)) {
            break label1239;
          }
          this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_Avcn.a((avbz)localObject1, (HotVideoData)localObject3);
          i = 1;
          break label564;
          label907:
          ...
          {
            i = 0;
            ((avbz)localObject1).a(-10);
            ((HotVideoData)localObject3).GetPreviewURLAsync(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, "0", new avbx(this, (HotVideoData)localObject3, (avbz)localObject1, (URLDrawable)localObject2));
            break label564;
          }
          j = 1;
          i = j;
          ...
          break label696;
          label1040:
          paramavcc.d.setImageDrawable((Drawable)localObject2);
          break label717;
          label1052:
