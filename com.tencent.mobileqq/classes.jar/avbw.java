  ...
  implements INetInfoHandler
{
  ...
  public void a(ayuq paramayuq, int paramInt)
  {
    Object localObject = null;
    if (paramayuq != null)
    {
      localObject = new StringBuffer(200);
      ((StringBuffer)localObject).append("http://").append(paramayuq.jdField_a_of_type_JavaLangString);
      if (paramayuq.jdField_a_of_type_Int != 80) {
        ((StringBuffer)localObject).append(":").append(paramayuq.jdField_a_of_type_Int);
      }
