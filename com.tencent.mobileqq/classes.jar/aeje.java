...
import com.tencent.mobileqq.activity.aio.rebuild.TroopChatPie.13.1;
import com.tencent.mobileqq.activity.aio.rebuild.TroopChatPie.13.2;
import com.tencent.mobileqq.activity.aio.rebuild.TroopChatPie.13.3;
import com.tencent.mobileqq.activity.aio.rebuild.TroopChatPie.13.4;
  ...
  extends ajuc
{
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    if ((paramInt1 == 9) && (this.a.af)) {
      bbmy.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 1, ajjy.a(2131649475), 0).a();
    }
  }
  ...
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    if ((paramInt1 == 2) || (paramInt1 == 9))
    {
      if (paramInt2 == 0)
      {
        ...
        String str = ajjy.a(2131649480);
        if (this.a.af) {
          str = ajjy.a(2131649478);
        }
        bbmy.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 2, str, 0).a();
        str = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c();
        aejb.a(this.a, paramString, str);
        ((ajtg)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a().a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      }
    }
    else {
      return;
    }
    bbmy.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 1, ajjy.a(2131649473), 0).a();
  }
  
  protected void a(ayre paramayre)
  {
    if (QLog.isColorLevel()) {
      QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, "onPushTroopEnterEffect: troopUin = " + paramayre.b + ", data.id = " + paramayre.jdField_a_of_type_Int);
    }
    ...
    paramayre = this.a.a();
    paramayre.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    paramayre.a();
  }
  
  protected void a(Boolean paramBoolean)
  {
    if ((aejb.e(this.a) != null) && (paramBoolean.booleanValue())) {}
  }
  
  protected void a(Boolean paramBoolean, ArrayList<Integer> paramArrayList, List<cmd0xca05.Result> paramList)
  {
    if ((aejb.f(this.a) != null) && (paramBoolean.booleanValue())) {
      aejb.g(this.a).a();
    }
  }
  ...
  {
    if (!azzz.a(String.valueOf(paramLong1), this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {}
    do
    {
      return;
      if (QLog.isColorLevel())
    ...
    ThreadManager.post(new TroopChatPie.13.1(this, paramList), 8, null, true);
  }
  
  protected void a(boolean paramBoolean, TroopInfo paramTroopInfo, String paramString)
  {
    if ((aejb.a(this.a) != null) && (paramTroopInfo != null) && (paramTroopInfo.troopuin.equals(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))) {
      aejb.b(this.a).a(true);
    }
  }
  
  protected void a(boolean paramBoolean, Object paramObject)
  {
    aejb.g(this.a).removeMessages(24);
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        i = 1;
        break;
        if ((this.a.c != null) && (arxu.a().jdField_a_of_type_Int != 2)) {
          this.a.c.dismiss();
        }
        arxu.a().b.clear();
      ...
      {
        ((acxm)aejb.a(this.a).a(11)).a((Map)paramObject, arxu.a().jdField_a_of_type_JavaUtilArrayList, arxu.a().jdField_a_of_type_Int);
        return;
      }
      ((acxp)aejb.b(this.a).a(1)).a((Map)paramObject, arxu.a().jdField_a_of_type_JavaUtilArrayList, arxu.a().jdField_a_of_type_Int);
      return;
      label405:
      i = 0;
    }
  ...
  protected void a(boolean paramBoolean, String paramString, int paramInt, List<String> paramList)
  {
    ...
    if ((paramBoolean) && (azpj.a(paramInt)) && (paramString.equalsIgnoreCase((String)localObject)))
    {
      if ((paramInt != 2) && (paramInt != 3) && (paramInt != 1) && (paramInt != 5)) {
        break label129;
      }
      paramList = (acym)this.a.a(28);
      if (paramList != null) {
    ...
    for (;;)
    {
      ...
      if ((paramInt == 4) && (paramList != null) && (paramList.size() > 0))
      {
        if (!this.a.am)
        {
          ...
          localObject = (acym)this.a.a(28);
          if (localObject != null) {
            ((acym)localObject).a(paramBoolean, paramString);
          }
        }
  ...
  protected void a(boolean paramBoolean, String paramString, long paramLong1, long paramLong2)
  {
    ...
    if (i != 0) {
      new ayzm(this.a.jdField_a_of_type_AndroidContentContext, "3171", "libWXVoice.so", "WXVoice").a();
    }
    if ((TextUtils.equals(paramString, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) && (paramBoolean) && (paramLong1 != paramLong2) && (aejb.a(this.a) != null)) {
      aejb.a(this.a).a(paramLong2, true, this.a, paramString);
    }
  }
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString.equals(paramString1)) && (this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(paramString2)) && (paramInt1 == 1) && (paramInt2 == 0))
    {
      ...
      awqx.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "AIOchat", "Get_history", 0, 0, paramString1, "", "", "");
      if (QLog.isColorLevel()) {
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString3, String paramString4)
  {
    if (paramBoolean)
    {
      if (paramInt4 == 0)
      {
        mnf.a().a(paramString1, paramInt2, paramInt1, paramString2, paramInt3, null, paramString4);
        aejb.f(this.a).postDelayed(new TroopChatPie.13.2(this), 500L);
        return;
      }
      this.a.a(3, paramString3);
      return;
    }
    this.a.a(1, this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131624500));
  }
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt, String paramString3, String paramString4)
  {
    ...
    {
      if ((!azgh.a(paramInt)) && (aejb.a(this.a) != null) && ((aejb.a(this.a).a instanceof azco))) {
        ((azco)aejb.a(this.a).a).b(this.a);
      }
      if (aejb.a(this.a) != null) {
        aejb.a(this.a).a(paramInt);
      }
    }
  }
  ...
  protected void a(boolean paramBoolean1, String paramString, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      azhh.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      return;
    }
  }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, List<azrn> paramList, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        localazrn = (azrn)paramList.next();
        if (!TextUtils.equals(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, localazrn.jdField_a_of_type_JavaLangString)) {
          continue;
        }
        if (localazrn.jdField_a_of_type_Long == 1104445552L)
        {
          if (QLog.isColorLevel()) {
            QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, new Object[] { "onUpdateTroopUnreadMsg homework. num=", Integer.valueOf(localazrn.b) });
          }
          ...
          if ((aejb.a(this.a) != null) && ((aejb.a(this.a).a instanceof azco))) {
            ((azco)aejb.a(this.a).a).a(false, this.a);
          }
        }
      }
      for (;;)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, "receive troop album  red dot, push=" + paramBoolean2 + ", num=" + localazrn.b);
        }
        Message localMessage = aejb.c(this.a).obtainMessage(85);
        localMessage.arg1 = localazrn.b;
        localMessage.sendToTarget();
        break label72;
        break;
        label328:
        if (localazrn.jdField_a_of_type_Long == 1106611799L)
        {
          if (QLog.isColorLevel()) {
            QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, "receive game feed red dot, push=" + paramBoolean2 + ", num=" + localazrn.b);
          }
          localMessage = aejb.b(this.a).obtainMessage(85);
          localMessage.arg1 = localazrn.b;
          localMessage.sendToTarget();
        }
      }
  ...
  {
    this.a.bC();
    if ((aejb.a(this.a) != null) && (aejb.b(this.a).a() != null)) {
      aejb.c(this.a).a().b();
    }
  }
  ...
  {
    if ((aejb.h(this.a) != null) && (paramBoolean.booleanValue())) {
      aejb.i(this.a).a();
    }
  }
  ...
  {
    if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString.equals(paramString)) && (!aejb.a(this.a))) {
      this.a.b(1);
    }
  }
  ...
  protected void c(String paramString1, String paramString2)
  {
    if (this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString.equals(paramString1))
    {
      List localList = this.a.jdField_a_of_type_Acka.a();
      ...
      paramString1 = ((azko)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(152)).a(paramString1, paramString2);
      if (paramString1 != null)
      {
  ...
  protected void c(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    {
      paramString2 = (azrx)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234);
      aejb.a(this.a, paramString1, true);
      if ((paramBoolean) && (this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity != null) && (this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.isResume()))
      {
        ...
        ThreadManager.getSubThreadHandler().removeCallbacks(aejb.a(this.a));
        ThreadManager.getUIHandler().post(new TroopChatPie.13.4(this, l));
      }
    }
  }
  ...
  protected void d(String paramString)
  {
    if ((paramString != null) && (paramString.equals(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)))
    {
      ...
      if (paramString != null)
      {
        ...
        this.a.bC();
        if (aejb.a(this.a) != null) {
          aejb.a(this.a).a(paramString.dwGroupClassExt, true, this.a, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
        }
        aejb.b(this.a);
        aejb.c(this.a);
      }
  ...
  {
    if ((aejb.d(this.a)) || (this.a.jdField_a_of_type_Azro == null)) {}
    boolean bool1;
    boolean bool2;
    do
    {
      ...
      bool1 = ((aqyr)this.a.a(33)).c();
      bool2 = ((acyj)this.a.a(43)).c();
    } while ((this.a.V) || (bool1) || (bool2));
    if (!paramBoolean)
    {
      this.a.jdField_a_of_type_Azro.a(2);
      return;
    }
    paramString2 = ((azrx)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234)).a(paramString1);
    if (!TextUtils.isEmpty(paramString2))
    {
      this.a.c(true);
      this.a.f.setText(paramString2);
    }
    if (this.a.jdField_a_of_type_Azro != null)
    {
      this.a.jdField_a_of_type_Azro.a(paramString1);
      if (this.a.jdField_a_of_type_Azro.a())
      {
        this.a.jdField_a_of_type_Azro.d();
        aejb.a(this.a, true);
        return;
      }
      this.a.jdField_a_of_type_Azro.a(0);
      aejb.a(this.a, false);
      return;
    }
    aejb.a(this.a, false);
  ...
  protected void d(boolean paramBoolean, String paramString, List<TroopAIONotifyItem> paramList)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.a.jdField_a_of_type_Aymw == null);
      bool1 = this.a.jdField_a_of_type_Aymw.a();
      bool2 = this.a.jdField_a_of_type_Aymw.d();
      int j = 0;
      int i = j;
      if (paramList != null)
      {
        ...
        if (paramList.size() > 0)
        {
          this.a.jdField_a_of_type_Aymw.a(paramList);
          i = j;
          if (!bool2)
          {
            i = j;
            if (!bool1)
            {
              this.a.jdField_a_of_type_Aymw.f();
              i = 1;
            }
          }
        }
      ...
      if ((!bool1) && (!bool2) && (i == 0) && (!bool3)) {
        ThreadManager.getUIHandler().postDelayed(new TroopChatPie.13.3(this), 500L);
      }
    } while (!QLog.isColorLevel());
