  ...
  extends bmlu
{
  ...
  public bmls(DoodleView paramDoodleView)
  {
  ...
  public static Drawable a(String paramString)
  {
    ...
    //   5: areturn
    //   6: aload_0
    //   7: invokestatic 20	xmn:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   10: astore_1
    //   11: aload_1
    //   12: ifnull +74 -> 86
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b())
      {
        ...
        for (;;)
        {
          if (localIterator.hasNext())
          {
            ...
            localDynamicStickerData.centerP = localbmly.jdField_b_of_type_AndroidGraphicsPointF;
            localDynamicStickerData.scale = localbmly.q;
            localDynamicStickerData.rotate = localbmly.r;
            localDynamicStickerData.translateX = (localbmly.s + paramInt1);
            localDynamicStickerData.translateY = (localbmly.t + paramInt2);
            localDynamicStickerData.height = localbmly.v;
            localDynamicStickerData.width = localbmly.u;
            localDynamicStickerData.path = localbmly.jdField_f_of_type_JavaLangString;
            localDynamicStickerData.type = localbmly.h;
            localDynamicStickerData.data = localbmly.jdField_g_of_type_JavaLangString;
            localDynamicStickerData.layerWidth = j;
            localDynamicStickerData.layerHeight = i;
            localDynamicStickerData.mapMotionTrack = localbmly.jdField_a_of_type_JavaUtilMap;
            localDynamicStickerData.setSegmentList(localbmly.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.getSegmentList());
        ...
        if (((ArrayList)localObject).size() > 0)
        {
          ...
          return bmtv.a((ArrayList)localObject);
        }
      }
      return null;
      j = m;
  ...
  public void a(ArrayList<PasterParcelData> paramArrayList, boolean paramBoolean, JSONArray paramJSONArray)
  {
    ...
    if (i < paramArrayList.size())
    {
      ...
      if ((localPasterParcelData.jdField_d_of_type_Int == 3) && (!TextUtils.isEmpty(localPasterParcelData.jdField_e_of_type_JavaLangString)))
      {
        ...
        j = 1;
        localbmth = bmro.a(BaseApplicationImpl.getContext(), localPasterParcelData.jdField_e_of_type_JavaLangString);
        if (j == 0) {
          break label443;
        }
        paramJSONArray = localbmth;
      }
    }
    for (;;)
    {
      ...
      if (paramJSONArray != null)
      {
        ...
        wsv.b("DynamicFaceLayer", "Create Normal FaceItem.");
        localbmly = new bmly(this, paramJSONArray, new bmmc(localPasterParcelData.jdField_a_of_type_AndroidGraphicsPointF.x, localPasterParcelData.jdField_a_of_type_AndroidGraphicsPointF.y, localPasterParcelData.jdField_a_of_type_Float, localPasterParcelData.jdField_b_of_type_Float, localPasterParcelData.jdField_c_of_type_Float, localPasterParcelData.jdField_d_of_type_Float, (int)localPasterParcelData.jdField_e_of_type_Float, (int)localPasterParcelData.f), localPasterParcelData.jdField_a_of_type_JavaLangString, localPasterParcelData.jdField_b_of_type_JavaLangString, localPasterParcelData.jdField_c_of_type_JavaLangString, localPasterParcelData.jdField_d_of_type_Int);
        localbmly.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.set(localPasterParcelData.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper);
        localbmly.jdField_g_of_type_JavaLangString = localPasterParcelData.jdField_e_of_type_JavaLangString;
        localbmly.jdField_g_of_type_Int = localPasterParcelData.jdField_e_of_type_Int;
        localbmly.jdField_e_of_type_Int = 0;
        localbmly.jdField_f_of_type_Int = 1;
        localbmly.jdField_b_of_type_Boolean = bmro.a(localbmth.a());
        localbmly.c = bmro.b(localbmth.a());
        if (localbmly.jdField_b_of_type_Boolean)
        {
          this.jdField_b_of_type_JavaUtilList.add(localbmly);
          if (!TextUtils.isEmpty(localPasterParcelData.jdField_d_of_type_JavaLangString))
          {
            localbmly.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI = new TroopBarPOI("-1", "", localPasterParcelData.jdField_d_of_type_JavaLangString, 0, "", 0, "");
            localbmly.jdField_a_of_type_Long = System.currentTimeMillis();
          }
        }
        if ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams == null) || (!this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b())) {
          break label471;
        ...
        this.jdField_a_of_type_JavaUtilList.add(localbmly);
      }
      for (;;)
      {
        i += 1;
        ...
        paramJSONArray = new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), localbmth.a());
        break label90;
        label471:
        localbmly.h = 0;
        paramJSONArray = (bmlu)this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a(bmlu.jdField_a_of_type_JavaLangString);
        if (paramJSONArray != null) {
          paramJSONArray.jdField_a_of_type_JavaUtilList.add(localbmly);
        }
      }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_JavaUtilList != null) && (!this.jdField_a_of_type_JavaUtilList.isEmpty()))
      {
        ...
        {
          Object localObject = (bmly)localIterator.next();
          if ((((bmly)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable != null) && ((((bmly)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable instanceof URLDrawable)))
          {
            localObject = (URLDrawable)((bmly)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable;
            if (localObject != null)
            {
  ...
  public void b()
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        Drawable localDrawable = ((bmly)localIterator.next()).jdField_a_of_type_AndroidGraphicsDrawableDrawable;
        if ((localDrawable instanceof bmts)) {
          ((bmts)localDrawable).a();
        }
      }
    }
    super.b();
  ...
  public void c(Canvas paramCanvas)
  {
    ...
    {
      bmly localbmly = (bmly)localIterator.next();
      Object localObject2 = a(a(localbmly.jdField_f_of_type_JavaLangString));
      if (localObject2 != null) {
        ((Drawable)localObject2).setBounds(0, 0, (int)localbmly.u, (int)localbmly.v);
      }
      Object localObject1 = localObject2;
      if (localbmly.h == 3)
      {
        localObject1 = localObject2;
        if (localbmly.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
        {
          localObject1 = localObject2;
          if (!(localbmly.jdField_a_of_type_AndroidGraphicsDrawableDrawable instanceof bmth)) {}
        }
      }
      for (;;)
      {
        try
        {
          localObject1 = (bmth)localbmly.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
          localObject1 = new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), ((bmth)localObject1).a());
        }
        catch (Exception localException2)
        {
          try
          {
            ...
            paramCanvas.save();
            paramCanvas.translate(-localbmly.u / 2.0F, -localbmly.v / 2.0F);
