...
public class bmls
{
  public static bmgl a;
  static CustomWebView jdField_a_of_type_ComTencentBizPubaccountCustomWebView;
  static String jdField_a_of_type_JavaLangString;
  
  static
  {
    jdField_a_of_type_Bmgl = new bmlt();
  }
  
  private static int a(Context paramContext, String paramString, int paramInt, bhod parambhod)
  {
    int i = 2;
  ...
  public static void a(Context paramContext, bhod parambhod)
  {
    parambhod = bglp.a(paramContext, 0);
    parambhod.setMessage(paramContext.getString(2131718567));
    parambhod.setPositiveButton(paramContext.getString(2131691648), new bmlu(paramContext));
    parambhod.setNegativeButton(paramContext.getString(2131692947), new bmlv(parambhod));
    try
    {
      if (!parambhod.isShowing()) {
        parambhod.show();
      }
      return;
    }
  ...
  /* Error */
  private static void a(bhod parambhod, String paramString)
  {
    // Byte code:
    //   0: iconst_m1
    //   1: istore_3
    ...
    //   110: pop
    //   111: aload_0
    //   112: invokevirtual 300	bhod:a	()Landroid/app/Activity;
    //   115: astore_0
    //   116: aload_0
    //   117: ifnull -111 -> 6
    //   120: aload_0
  ...
  static void a(bhod parambhod, String... paramVarArgs)
  {
    if ((parambhod != null) && (parambhod.a() != null) && (paramVarArgs != null) && (paramVarArgs.length > 0)) {
      try
      {
        Object localObject1 = parambhod.a(parambhod.a());
        ...
        jdField_a_of_type_ComTencentBizPubaccountCustomWebView = parambhod.a();
        ...
        paramVarArgs = new QZoneWebViewJsHandleLogic.2(parambhod, localHashMap, str2, str3, paramVarArgs, str1, (String)localObject1);
        if (TextUtils.isEmpty((CharSequence)localObject2))
        {
          paramVarArgs.run();
          return;
        }
        ThreadManager.post(new QZoneWebViewJsHandleLogic.3((String)localObject2, localHashMap, parambhod, paramVarArgs), 8, null, false);
        return;
      }
      catch (Exception parambhod)
      {
        QZLog.e("QZoneWebViewJsHandleLogic", "shareMiniProgramFromQzone error", parambhod);
      }
    }
  }
  
  private static void a(WebViewPlugin paramWebViewPlugin, bhod parambhod, String... paramVarArgs)
  {
    if ((paramVarArgs == null) || (parambhod == null) || (paramVarArgs.length <= 0)) {}
    Object localObject5;
    Object localObject2;
    Object localObject3;
    Object localObject4;
    ...
    do
    {
      do
      {
        do
        {
          for (;;)
          {
            ...
            try
            {
              ...
              paramVarArgs = parambhod.a().getUrl();
              if (!bmjn.a().a(paramVarArgs, (String)localObject1))
              {
            ...
            if (bool)
            {
              ...
              try
              {
                if (((String)localObject2).indexOf("uin=") != -1)
                {
                  ...
                  blsb.a((Context)localObject4, blsi.a(), paramWebViewPlugin, 0, 0, 0);
                  return;
                }
              }
        ...
        parambhod = parambhod.a((Activity)localObject4);
        if (!(parambhod instanceof bhoe)) {
          break label1115;
        }
        i = ((bhoe)parambhod).switchRequestCode(paramWebViewPlugin, (byte)3);
        if (TextUtils.isEmpty(paramVarArgs))
        {
          blsb.a((Activity)localObject4, blsi.a(), (String)localObject1, i);
          return;
        }
        blsb.a((Activity)localObject4, blsi.a(), (String)localObject1, i, paramVarArgs);
        return;
      ...
      localObject6 = parambhod.a((Activity)localObject4);
      if (!(localObject6 instanceof bhoe)) {
        break label1120;
      }
      i = ((bhoe)localObject6).switchRequestCode(paramWebViewPlugin, (byte)3);
      paramWebViewPlugin = blsi.a();
      paramWebViewPlugin.jdField_a_of_type_JavaLangString = parambhod.a().getAccount();
      parambhod = new Bundle();
      parambhod.putString("source", paramVarArgs.getQueryParameter("source"));
      parambhod.putString("bypassparam", paramVarArgs.getQueryParameter("bypassparam"));
      parambhod.putAll(localBundle);
      blsb.a((Activity)localObject4, paramWebViewPlugin, (String)localObject1, (String)localObject2, (String)localObject3, (String)localObject5, i, parambhod);
      return;
      if (!"mqzone://arouse/dynamicnickname".equalsIgnoreCase((String)localObject2)) {
        break;
      }
    } while ((parambhod == null) || (parambhod.a() == null) || (parambhod.a() == null));
    blsb.a(parambhod.a(), parambhod.a().getAccount());
    return;
    if (((String)localObject2).startsWith("mqzone://arouse/uploadphoto"))
    {
      blsb.a(paramWebViewPlugin, parambhod, parambhod.a(), parambhod.a().getAccount(), (String)localObject2);
      return;
    }
    if ((((String)localObject2).startsWith("mqzone://arouse/facade")) || (((String)localObject2).startsWith("mqzonev2://arouse/facade")))
    {
      a(parambhod.a(), (String)localObject2, 81, parambhod);
      return;
    }
    if (((String)localObject2).startsWith("mqzone://arouse/moodVoiceRecord"))
    {
      blsb.b(paramWebViewPlugin, parambhod, parambhod.a(), parambhod.a().getAccount(), (String)localObject2);
      return;
    }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        i = bmlw.a(paramWebViewPlugin, parambhod, 4);
        blsb.a((Activity)localObject4, blsi.a(), paramVarArgs, i, bool);
        return;
      }
      blsb.a((Activity)localObject4, blsi.a(), paramVarArgs, -1, bool);
      return;
      label1084:
  ...
  public static boolean a(WebViewPlugin paramWebViewPlugin, bhod parambhod, String paramString, String... paramVarArgs)
  {
    if ("updateFeedContainer".equalsIgnoreCase(paramString)) {
      f(parambhod, paramVarArgs);
    }
    do
    {
      return true;
  ...
  private static void b(bhod parambhod, String... paramVarArgs)
  {
    if ((parambhod != null) && (parambhod.a() != null) && (paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      parambhod = new Intent("qzone.pickgamemates");
      parambhod.putExtra("gamemates", paramVarArgs[0]);
      BaseApplicationImpl.getApplication().sendBroadcast(parambhod);
      if (QLog.isColorLevel()) {
  ...
  private static void c(bhod parambhod, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      parambhod = new Intent("updateIsSpecialFollow");
      parambhod.putExtra("isSpecialFollow", i);
      BaseApplicationImpl.getApplication().sendBroadcast(parambhod);
      if (QLog.isColorLevel()) {
    ...
    {
      QLog.e("QZoneWebViewJsHandleLogic", 1, "handleUpdateIsSpecialFollow catch an exception. ", parambhod);
    }
  }
  ...
  private static void d(bhod parambhod, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      parambhod = new Intent("showFollowActionSheet");
      parambhod.putExtra("followStatus", i);
      BaseApplicationImpl.getApplication().sendBroadcast(parambhod);
      if (QLog.isColorLevel()) {
        QLog.d("QZoneWebViewJsHandleLogic", 1, "followStatus = " + i);
      }
    ...
    {
      QLog.e("QZoneWebViewJsHandleLogic", 1, "handleShowFollowActionSheet catch an exception. ", parambhod);
    }
  }
  
  private static void e(bhod parambhod, String... paramVarArgs)
  {
    Activity localActivity;
    if ((parambhod != null) && (parambhod.a() != null) && (paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      localActivity = parambhod.a();
      if (bgnw.a(localActivity, "com.tencent.weishi"))
      {
        parambhod = "";
        try
        {
          paramVarArgs = new JSONObject(paramVarArgs[0]).optString("schema");
          parambhod = paramVarArgs;
          if (!TextUtils.isEmpty(paramVarArgs))
          {
            parambhod = paramVarArgs;
            Intent localIntent = new Intent();
        ...
        {
          QLog.e("QZoneWebViewJsHandleLogic", 1, "handleClickWeiShiWidget catch an exception. weishi schema is " + parambhod, paramVarArgs);
          return;
        }
      }
    }
  ...
  private static void f(bhod parambhod, String... paramVarArgs)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          {
            if (!(parambhod.a().getParent() instanceof RelativeLayout)) {
              continue;
            }
            ((RelativeLayout)parambhod.a().getParent()).setVisibility(8);
          }
        }
        catch (JSONException parambhod)
        {
          QLog.e("QZoneWebViewJsHandleLogic", 1, parambhod, new Object[0]);
          return;
        }
      }
    } while (!(parambhod.a().getParent() instanceof RelativeLayout));
    ((RelativeLayout)parambhod.a().getParent()).setVisibility(0);
  }
  
  private static void g(bhod parambhod, String... paramVarArgs)
  {
    if ((paramVarArgs == null) || (paramVarArgs.length <= 0)) {}
    for (;;)
    {
      ...
      try
      {
        ...
        if (((JSONObject)localObject).getInt("success") == 1)
        {
          ...
          if ((paramVarArgs != null) && (paramVarArgs.length() > 0) && (localJSONArray != null) && (localJSONArray.length() == paramVarArgs.length()))
          {
            ...
            parambhod.a().setResult(-1, localIntent);
            parambhod.a().finish();
            if (QLog.isColorLevel())
            {
  ...
  private static void h(bhod parambhod, String... paramVarArgs)
  {
    if ((paramVarArgs == null) || (paramVarArgs.length <= 0)) {
      return;
    }
  ...
  private static void i(bhod parambhod, String... paramVarArgs)
  {
    if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
      try
      {
        ...
        try
        {
          ...
          if (!TextUtils.isEmpty(str1)) {
            ((StringBuilder)localObject2).append(bivp.b).append("=").append(str1);
          }
          if (!TextUtils.isEmpty(paramVarArgs)) {
            ((StringBuilder)localObject2).append("&").append(bivp.f).append("=").append(paramVarArgs);
          }
          if (!TextUtils.isEmpty((CharSequence)localObject1)) {
            ((StringBuilder)localObject2).append("&").append(bivp.c).append("=").append((String)localObject1);
          }
          if (!TextUtils.isEmpty(str2)) {
            ((StringBuilder)localObject2).append("&").append(bivp.d).append("=").append(str2);
          }
          if (!TextUtils.isEmpty(str3)) {
            ((StringBuilder)localObject2).append("&").append(bivp.i).append("=").append(str3);
          }
          if (!TextUtils.isEmpty(str4)) {
            ((StringBuilder)localObject2).append("&").append(bivp.e).append("=").append(str4);
          }
          if (!TextUtils.isEmpty(str5)) {
            ((StringBuilder)localObject2).append("&").append(bivp.B).append("=").append(str5);
          }
          ...
          blsb.a((Bundle)localObject1);
          biqa.a(parambhod.a(), (Bundle)localObject1);
          return;
        }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e("QZoneWebViewJsHandleLogic", 2, "json 解析异常", parambhod);
        }
      }
    }
  }
