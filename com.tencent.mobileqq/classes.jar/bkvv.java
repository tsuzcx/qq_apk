...
public class bkvv
{
  private static bkvv jdField_a_of_type_Bkvv = new bkvv();
  private static final String jdField_a_of_type_JavaLangString = bkvv.class.getSimpleName();
  private Map<String, WeakReference<bkvx>> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  private Map<String, MetaMaterial> b = new HashMap();
  
  public static bkvv a()
  {
    return jdField_a_of_type_Bkvv;
  }
  ...
  private void a(MetaMaterial paramMetaMaterial)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(paramMetaMaterial.id))
    {
      ...
      if (localObject != null)
      {
        localObject = (bkvx)((WeakReference)localObject).get();
        if (localObject != null) {
          ((bkvx)localObject).a(paramMetaMaterial);
        }
      }
    }
  }
  ...
  private void a(MetaMaterial paramMetaMaterial, int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(paramMetaMaterial.id))
    {
      ...
      if (localObject != null)
      {
        localObject = (bkvx)((WeakReference)localObject).get();
        if (localObject != null) {
          ((bkvx)localObject).a(paramMetaMaterial, paramInt);
        }
      }
    }
  }
  ...
  {
    return new File(bkks.e, paramMetaMaterial.id).getAbsolutePath();
  }
  
  public void a(AppInterface paramAppInterface, MetaMaterial paramMetaMaterial, bkvx parambkvx)
  {
    if ((paramMetaMaterial == null) || (TextUtils.isEmpty(paramMetaMaterial.id)))
    {
      if (parambkvx != null) {
        parambkvx.b(paramMetaMaterial);
      }
      return;
    }
    this.jdField_a_of_type_JavaUtilMap.put(paramMetaMaterial.id, new WeakReference(parambkvx));
  ...
  public boolean a(MetaMaterial paramMetaMaterial)
  {
    ...
    //   14: iconst_0
    //   15: ireturn
    //   16: getstatic 127	bkks:d	Ljava/lang/String;
    //   19: astore_2
    ...
    //   44: invokestatic 140	bdcs:c	(Ljava/lang/String;)Ljava/lang/String;
    //   47: astore_3
    //   48: aload_3
    ...
    //   73: getstatic 80	bkks:e	Ljava/lang/String;
    ...
    //   162: getstatic 80	bkks:e	Ljava/lang/String;
    ...
    //   177: invokestatic 171	ndr:a	(Ljava/io/File;Ljava/lang/String;)V
    //   180: iconst_1
    //   181: ireturn
    //   182: astore_1
