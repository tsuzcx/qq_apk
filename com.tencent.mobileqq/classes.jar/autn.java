  ...
  extends WebViewPlugin
{
  ...
  public static CopyOnWriteArrayList<WeakReference<autn>> a;
  public static AtomicBoolean a;
  String jdField_a_of_type_JavaLangString = "";
  WeakReference<autn> jdField_a_of_type_JavaLangRefWeakReference = null;
  ...
  {
    jdField_a_of_type_AndroidContentBroadcastReceiver = new auto();
    if (QLog.isColorLevel()) {
  ...
  public void a(android.content.Context paramContext, Intent paramIntent)
  {
    ...
    //   6: ifnull +20 -> 26
    //   9: aload_0
    //   10: getfield 31	autn:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    //   13: ifnull +13 -> 26
    //   16: aload_0
    //   17: getfield 31	autn:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   50: aload_1
    //   51: aload_0
    //   52: invokevirtual 288	autn:a	()Ljava/lang/String;
    ...
    //   85: ifeq +14 -> 99
    //   88: aload_0
    //   89: getfield 229	autn:mRuntime	Lbgve;
    //   92: invokevirtual 234	bgve:a	()Landroid/app/Activity;
    ...
    //   157: astore_2
    //   158: aload_0
    //   159: getfield 229	autn:mRuntime	Lbgve;
    //   162: invokevirtual 307	bgve:a	()Lcom/tencent/biz/pubaccount/CustomWebView;
    //   165: astore 5
    //   167: aload 5
    //   169: ifnull -143 -> 26
    //   172: aload 5
    ...
    //   197: ifeq +68 -> 265
    //   200: aload_0
    //   201: getfield 31	autn:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    ...
    //   284: ifeq +48 -> 332
    //   287: invokestatic 343	nko:a	()Lnko;
    //   290: aload 8
    //   292: ldc_w 345
    //   295: invokevirtual 348	nko:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   298: ifne +17 -> 315
    //   301: invokestatic 343	nko:a	()Lnko;
    //   304: aload 8
    //   306: ldc_w 350
    //   309: invokevirtual 348	nko:a	(Ljava/lang/String;Ljava/lang/String;)Z
    //   312: ifeq +20 -> 332
    //   315: aload_0
    //   316: aload 6
    //   318: aload_1
    //   319: aload_2
    //   320: invokevirtual 354	autn:dispatchJsEvent	(Ljava/lang/String;Lorg/json/JSONObject;Lorg/json/JSONObject;)V
    //   323: return
    //   324: ldc_w 356
    //   327: astore 5
    //   329: goto -110 -> 219
    ...
    //   354: aload 9
    //   356: invokestatic 366	nko:b	(Ljava/lang/String;Ljava/lang/String;)Z
    //   359: ifeq +12 -> 371
    //   362: aload_0
    //   363: aload 6
    //   365: aload_1
    //   366: aload_2
    //   367: invokevirtual 354	autn:dispatchJsEvent	(Ljava/lang/String;Lorg/json/JSONObject;Lorg/json/JSONObject;)V
    //   370: return
    //   371: iload_3
    //   372: iconst_1
    //   373: iadd
