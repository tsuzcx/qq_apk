  ...
  implements Manager
{
  ...
  public ConcurrentHashMap<Long, arzz> a;
  public MqqHandler a;
  ...
  private ConcurrentHashMap<String, ConcurrentHashMap<String, asaf>> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  public boolean b;
  ...
  private ConcurrentHashMap<String, ConcurrentHashMap<String, asae>> jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  public asaa(QQAppInterface paramQQAppInterface)
  {
  ...
  private int a(List<ChatMessage> paramList, SessionInfo paramSessionInfo, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (j != 0)
      {
        ...
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007FA7", "0X8007FA7", 0, 0, "", "", "", "");
  ...
  public static void a(RelativeLayout paramRelativeLayout, QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = (asaa)paramQQAppInterface.getManager(QQManagerFactory.DOUTU_MAGAGER);
  ...
  private void a(ChatMessage paramChatMessage)
  {
    ...
    if (paramChatMessage.isSend())
    {
      ...
      if (((MessageForMarketFace)localObject2).mMarkFaceMessage != null)
      {
        ...
        paramChatMessage = asdi.a(paramChatMessage.sbufID, paramChatMessage.mediaType);
      }
      i = 1;
    }
    for (;;)
    {
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800AF0B", "0X800AF0B", 0, 0, String.valueOf(i), "", paramChatMessage, "");
      return;
      label84:
        ...
        for (paramList.isDui = false;; paramList.isDui = false)
        {
          do
          {
            if (paramList.isDui)
            {
              ...
              {
                bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008012", "0X8008012", 0, 0, "", "", "", "");
  ...
  private boolean a(String paramString)
  {
    ...
    if (bhhr.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))
    {
      if (QLog.isColorLevel()) {
      ...
      for (paramInt = 0;; paramInt = i)
      {
        ...
        for (;;)
        {
          if (paramInt > 0)
          {
            ...
            {
              bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008095", "0X8008095", 0, 0, "", "", "", "");
              this.jdField_e_of_type_Int = (localArrayList.size() - 1);
              if (paramInt == 3) {
                bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008094", "0X8008094", 0, 0, "", "", "", "");
              }
            }
          }
          ...
          for (;;)
          {
            ...
            paramList = new asak(paramList.senderuin, paramInt - 2, bool);
  ...
  private void f()
  {
    this.jdField_f_of_type_Boolean = bhhr.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    this.jdField_c_of_type_Boolean = bhhr.i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    this.jdField_d_of_type_Boolean = bhhr.k(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    this.jdField_b_of_type_Boolean = bhhr.l(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    long l1 = bhhr.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    int i = bhhr.aq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin());
    long l2 = bhhr.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    long l3 = bhhr.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    int j = bhhr.an(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (l1 > 0L) {
  ...
  public int a(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((asae)((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_a_of_type_Int;
    }
    return 0;
  }
  ...
  public long a(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((asaf)((ConcurrentHashMap)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_a_of_type_Long;
    }
    return 0L;
  }
  ...
  public void a(long paramLong)
  {
    ...
    {
      localObject = (arzz)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong));
      ((arzz)localObject).jdField_a_of_type_Int += 1;
    }
    if (QLog.isColorLevel())
    {
    ...
    label203:
    for (int i = ((arzz)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Int;; i = 0)
    {
      QLog.i("DoutuManager", 2, i);
      if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong)) != null) && (((arzz)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Int >= 1))
      {
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(Long.valueOf(paramLong));
        if ((this.jdField_a_of_type_Arzv != null) && (this.jdField_a_of_type_Arzv.jdField_a_of_type_Long == paramLong)) {
  ...
  public void a(Context paramContext, ViewGroup paramViewGroup, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, MqqHandler paramMqqHandler, arzz paramarzz)
  {
    ...
    Object localObject = (LinearLayout)paramViewGroup.findViewById(2131365818);
    if (localObject != null)
    {
      if (QLog.isColorLevel()) {
      ...
      paramViewGroup = (DoutuEmotionHorizonListView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131365821);
      this.jdField_a_of_type_Arzv = ((arzv)paramViewGroup.getAdapter());
      if (this.jdField_a_of_type_Arzv == null)
      {
        this.jdField_a_of_type_Arzv = new arzv(paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseActivity, paramSessionInfo, paramMqqHandler, this.jdField_b_of_type_Boolean, paramarzz, this.jdField_a_of_type_Int);
        paramViewGroup.setAdapter(this.jdField_a_of_type_Arzv);
      }
      c();
    }
    for (;;)
    {
      if ((this.jdField_g_of_type_Long <= 0L) || (System.currentTimeMillis() - this.jdField_g_of_type_Long <= 0L) || (System.currentTimeMillis() - this.jdField_g_of_type_Long >= 1000L))
      {
          ...
          if (paramContext.hasNext())
          {
            ...
            if (this.jdField_c_of_type_JavaUtilList.size() < 20)
            {
              ...
              if (!TextUtils.isEmpty(paramBaseActivity.pic_md5))
              {
                ...
                this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)View.inflate(paramContext, 2131558610, null));
                localObject = (DoutuEmotionHorizonListView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131365821);
                this.jdField_a_of_type_Arzv = new arzv(paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseActivity, paramSessionInfo, paramMqqHandler, this.jdField_b_of_type_Boolean, paramarzz, this.jdField_a_of_type_Int);
                ((DoutuEmotionHorizonListView)localObject).setAdapter(this.jdField_a_of_type_Arzv);
                ((DoutuEmotionHorizonListView)localObject).setOnScrollStateChangedListener(new asab(this));
                ((DoutuEmotionHorizonListView)localObject).setTouchListener(new asad(this, paramMqqHandler));
        ...
        if (this.jdField_a_of_type_Arzv != null)
        {
          this.jdField_a_of_type_Arzv.jdField_b_of_type_JavaUtilList = new ArrayList();
          this.jdField_a_of_type_Arzv.jdField_b_of_type_JavaUtilList.addAll(this.jdField_c_of_type_JavaUtilList);
        }
        this.jdField_b_of_type_JavaUtilList.clear();
        h();
        label568:
    ...
    label821:
    label859:
    for (paramContext = paramarzz.toString();; paramContext = "")
    {
      QLog.d("DoutuManager", 2, paramContext);
      if ((paramarzz != null) && (paramarzz.a()) && (this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Arzv != null))
      {
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Long.valueOf(this.jdField_a_of_type_Arzv.jdField_a_of_type_Long), new arzz(this.jdField_a_of_type_Arzv.jdField_a_of_type_Long, 0));
        a(paramarzz, paramSessionInfo, this.jdField_a_of_type_Arzv.jdField_a_of_type_Long);
      }
      ...
      arzt.c();
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007FA9", "0X8007FA9", 0, 0, "", "", "", "");
  ...
  public void a(arzz paramarzz, SessionInfo paramSessionInfo, long paramLong)
  {
    ThreadManager.post(new DoutuManager.4(this, paramarzz, paramLong, paramSessionInfo), 5, null, true);
  }
  ...
  public void a(SessionInfo paramSessionInfo, ChatMessage paramChatMessage)
  {
    ...
    {
      ((ConcurrentHashMap)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramChatMessage)).put(paramSessionInfo, new asaf(this, l1, l2));
      return;
    }
    ConcurrentHashMap localConcurrentHashMap = new ConcurrentHashMap();
    localConcurrentHashMap.put(paramSessionInfo, new asaf(this, l1, l2));
  ...
  public void a(SessionInfo paramSessionInfo, ChatMessage paramChatMessage, int paramInt1, int paramInt2)
  {
    ...
    {
      ((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).put(paramSessionInfo, new asae(this, l1, l2, paramChatMessage.senderuin, paramInt1, paramInt2));
      return;
    }
    ConcurrentHashMap localConcurrentHashMap = new ConcurrentHashMap();
    localConcurrentHashMap.put(paramSessionInfo, new asae(this, l1, l2, paramChatMessage.senderuin, paramInt1, paramInt2));
  ...
  public void a(List<ChatMessage> paramList, SessionInfo paramSessionInfo, BaseChatPie paramBaseChatPie, int paramInt)
  {
    ...
    label17:
    while (bhbx.b(paramSessionInfo.curFriendUin)) {
      return;
    }
    if (c()) {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    bhhr.h(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), paramBoolean);
    if (paramBoolean) {
  ...
  public void a(boolean paramBoolean, List<DoutuData> paramList)
  {
    ...
    if ((this.jdField_a_of_type_Arzv != null) && (this.jdField_c_of_type_JavaUtilList.size() == 0))
    {
      if (QLog.isColorLevel()) {
      ...
      h();
      this.jdField_a_of_type_Arzv.a();
      if (this.jdField_a_of_type_Arzv.jdField_a_of_type_MqqOsMqqHandler != null) {
        this.jdField_a_of_type_Arzv.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(81);
      }
    }
    int i;
    if (this.jdField_b_of_type_JavaUtilList.size() > 0) {
  ...
  public void a(boolean paramBoolean, List<DoutuData> paramList, long paramLong)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      i = ((arzz)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Int;
  ...
  public long b(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((asae)((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_a_of_type_Long;
    }
    return 0L;
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout != null)
    {
      ...
      this.jdField_a_of_type_Arzv = null;
      this.jdField_c_of_type_JavaUtilList.clear();
      this.jdField_a_of_type_JavaUtilList.clear();
      g();
    }
  ...
  public long c(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((asae)((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_b_of_type_Long;
    }
    return 0L;
  }
  ...
  {
    if (this.jdField_a_of_type_Arzv == null) {}
    while ((this.jdField_a_of_type_Arzv.jdField_a_of_type_JavaUtilHashMap == null) && (this.jdField_a_of_type_Arzv.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData == null)) {
      return;
    }
    Object localObject1 = new asag();
    ((asag)localObject1).jdField_a_of_type_JavaLangString = "dc03631";
    localObject1.getClass();
    Object localObject2 = new asah((asag)localObject1);
    ((asah)localObject2).jdField_a_of_type_JavaLangString = String.valueOf(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
    if (this.jdField_a_of_type_Arzv.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData != null)
    {
      ((asah)localObject2).d = this.jdField_a_of_type_Arzv.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData.pic_md5;
      ((asah)localObject2).e = this.jdField_a_of_type_Arzv.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData.pic_down_url;
    }
    if (this.jdField_a_of_type_Arzv.jdField_a_of_type_Arzz != null)
    {
      ((asah)localObject2).c = this.jdField_a_of_type_Arzv.jdField_a_of_type_Arzz.c;
      ((asah)localObject2).jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Arzv.jdField_a_of_type_Arzz.jdField_b_of_type_JavaLangString;
    }
    if ((this.jdField_a_of_type_Arzv.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_Arzv.jdField_a_of_type_JavaUtilHashMap.size() > 0))
    {
      ArrayList localArrayList1 = new ArrayList();
      ArrayList localArrayList2 = new ArrayList();
      Iterator localIterator = this.jdField_a_of_type_Arzv.jdField_a_of_type_JavaUtilHashMap.keySet().iterator();
      while (localIterator.hasNext())
      {
        String str = (String)localIterator.next();
        localArrayList1.add(str);
        localArrayList2.add(this.jdField_a_of_type_Arzv.jdField_a_of_type_JavaUtilHashMap.get(str));
      }
      ((asah)localObject2).jdField_a_of_type_JavaUtilArrayList = localArrayList1;
      ((asah)localObject2).jdField_b_of_type_JavaUtilArrayList = localArrayList2;
    }
    int i;
    if (this.jdField_a_of_type_Arzv.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null)
    {
      i = this.jdField_a_of_type_Arzv.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType;
      if (i != 0) {
        break label401;
      }
      ((asah)localObject2).f = "c2c";
    }
    for (;;)
    {
      ((asah)localObject2).h = this.jdField_a_of_type_Arzv.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin;
      ((asah)localObject2).g = "android";
      ((asag)localObject1).jdField_a_of_type_Asah = ((asah)localObject2);
      localObject1 = ((asag)localObject1).a();
      localObject2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), asai.class);
      ...
      this.jdField_a_of_type_Arzv.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData = null;
      this.jdField_a_of_type_Arzv.jdField_a_of_type_JavaUtilHashMap = null;
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet((NewIntent)localObject2);
      return;
      label401:
      if (i == 1) {
        ((asah)localObject2).f = "group";
      } else if (i == 3000) {
        ((asah)localObject2).f = "discuss";
      } else {
        ((asah)localObject2).f = "other";
      }
    }
  }
  ...
  public boolean d()
  {
    return a(bhhr.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()));
  }
  ...
  public void e()
  {
    ...
    String str1 = bhhr.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    String str2 = bhhr.l(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    ...
    if (!a(str1))
    {
      ...
      bhyo localbhyo = new bhyo(str2, new File(str3));
      localbhyo.n = true;
      ...
      localbhyt.a(localbhyo, new asac(this, str2, str3, str1), null);
      return;
    }
    DuiButtonImageView.a();
    jdField_a_of_type_Boolean = false;
