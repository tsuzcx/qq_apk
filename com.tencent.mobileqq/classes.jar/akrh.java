  ...
  implements ayth
{
  ...
  public void a(aytj paramaytj, ayti paramayti)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject1 = (ajxn)this.a.a.getManager(51);
        paramayti = this.a.a.getAccount();
        localRspNextSystemMsg = new structmsg.RspNextSystemMsg();
        localRspNextSystemMsg.mergeFrom((byte[])paramaytj.a.getWupBuffer());
        new StringBuilder();
      ...
      if (i < j)
      {
        localObject3 = axaq.a(-2018);
        ((MessageRecord)localObject3).msgtype = -2018;
        ((MessageRecord)localObject3).selfuin = paramayti;
        ((MessageRecord)localObject3).frienduin = ajsf.M;
      ...
      else if (paramaytj.size() > 0)
      {
        i = paramaytj.size();
        long l1 = ((MessageRecord)paramaytj.get(0)).time;
        long l2 = ((MessageRecord)paramaytj.get(i - 1)).time;
        l3 = ayda.a().a(this.a.a);
        localObject2 = this.a.a.a().a(ajsf.M, 0, l3).iterator();
        while (((Iterator)localObject2).hasNext())
        {
          ...
          {
            this.a.a.a().b(ajsf.M, 0, ((ChatMessage)localObject3).uniseq, false);
          ...
          else if ((localObject3 instanceof MessageForSystemMsg))
          {
            ...
            if ((localMessageForSystemMsg.structMsg.msg.sub_type.get() == 13) && (((ajxn)localObject1).b(str)))
            {
              this.a.a.a().b(ajsf.M, 0, ((ChatMessage)localObject3).uniseq, false);
              ((Iterator)localObject2).remove();
            }
        ...
        ayda.a().a(this.a.a, l2);
        if (paramaytj.size() < 20) {
          ayda.a().a(true, this.a.a);
        }
