  ...
  extends akon
{
  ...
  public akrh(QQAppInterface paramQQAppInterface, MessageHandler paramMessageHandler)
  {
  ...
  private void a(MessageRecord paramMessageRecord, long paramLong1, long paramLong2, int paramInt)
  {
    ...
    int i1 = axau.b(paramMessageRecord.msgUid);
    ...
    if ((i2 == 0) || (i2 == 1000) || (i2 == 1004))
    {
      ...
      if (paramMessageRecord.msgtype == -2005)
      {
        ...
        if ((paramMessageRecord != null) && (paramMessageRecord.nOLfileSessionId != 0L))
        {
          ...
          ((msg_svc.PbDelRoamMsgReq.C2CMsg)localObject).msg_random.set(axau.b(paramMessageRecord.msgUid));
        }
      }
    }
    for (;;)
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    boolean bool = paramToServiceMsg.extraData.getBoolean(axaf.h);
    if (QLog.isColorLevel()) {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    boolean bool3 = paramToServiceMsg.extraData.getBoolean(axaf.h);
  ...
  public static void b(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    axrn.a(BaseApplication.getContext()).a(localAppInterface.getCurrentAccountUin(), "revokeMsgErrorTag", false, 0L, 0L, localHashMap, "");
    if (QLog.isColorLevel()) {
  ...
  public ToServiceMsg a(List<MessageRecord> paramList, int paramInt)
  {
    ...
    if ((paramInt == 1) && (!((MessageRecord)localObject1).isSend()) && (!banb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())))
    {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        case 1004: 
          for (;;)
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              int i4 = axau.b(localMessageRecord.msgUid);
              ...
              for (localObject2 = localMessageRecord.senderuin;; localObject2 = localMessageRecord.selfuin) {
                try
                {
                  ...
                  if (axaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord, (msg_svc.RoutingHead)localObject2)) {
        ...
        if (localIterator.hasNext())
        {
          ...
          i3 = axau.b(localMessageRecord.msgUid);
          ...
          {
            if (!banb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) {
              break label1350;
            }
          ...
          for (;;)
          {
            ...
            break label1160;
            label1350:
            if (banb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageRecord.frienduin, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) {
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      break;
      if ((!akpx.a(paramMessageRecord)) && (akpx.f(paramMessageRecord.msgtype)))
      {
        ...
        for (;;)
        {
          ...
          int i2 = awyn.jdField_a_of_type_Int;
          awyn.jdField_a_of_type_Int = i2 + 1;
          long l1 = i2;
  ...
  public void a(MessageRecord paramMessageRecord, ArrayList<String> paramArrayList, aaod paramaaod)
  {
    paramArrayList = akas.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord, paramArrayList, paramaaod);
    ...
    {
      a(false, true, true, 0L, new akri(this, paramMessageRecord, bool, paramArrayList));
      return;
    }
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().e())
    {
      if (this.jdField_a_of_type_Anwi != null) {
        this.jdField_a_of_type_Anwi.a(false);
      }
  ...
  {
    if (this.jdField_a_of_type_Anwi != null) {
      this.jdField_a_of_type_Anwi.a(true);
    }
