...
public class boen
  implements boce
{
  public boen(AEEditorImageEditFragment paramAEEditorImageEditFragment) {}
  ...
  public void a(int paramInt, bode parambode)
  {
    if (this.a.jdField_a_of_type_DovComQqImAeeditorModuleAifilterAEEditorAILoadingView != null) {
      ThreadManager.getUIHandler().post(new AEEditorImageEditFragment.16.1(this, parambode));
    }
    if (paramInt == 0)
    {
    ...
    if (parambode != null)
    {
      ...
      if (paramInt < AEEditorImageEditFragment.b(this.a))
      {
        ...
        for (;;)
        {
          paramInt += 1;
          break;
          if ((AEEditorImageEditFragment.a(this.a).a((String)AEEditorImageEditFragment.b(this.a).get(paramInt)) != null) && (((bodj)parambode.a.get(paramInt)).a))
          {
          ...
          {
            AEEditorImageEditFragment.a(this.a).a((String)AEEditorImageEditFragment.b(this.a).get(paramInt), (bode)parambode.a.get(paramInt));
            AEEditorImageEditFragment.a(this.a).put(String.valueOf(paramInt), this.a.a((bode)parambode.a.get(paramInt)));
            AEEditorImageEditFragment.a(this.a).a(paramInt, (bode)parambode.a.get(paramInt));
            localStringBuilder.append(((bodj)parambode.a.get(paramInt)).a() + "|");
          }
        }
      }
