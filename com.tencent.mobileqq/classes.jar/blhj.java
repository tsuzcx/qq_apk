...
public class blhj
{
  ...
  public blhj(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private void a(Activity paramActivity, int paramInt, String paramString, zuk paramzuk)
  {
    if (paramActivity == null) {
      return;
    }
    String str = anni.a(2131709470);
    if (1 == paramInt) {
      paramString = str + anni.a(2131709473) + paramString + anni.a(2131709468);
    }
    for (;;)
    {
      bglp.a(paramActivity, 230, paramActivity.getString(2131697544), paramString, 2131697538, 2131697538, new blhs(this, paramzuk), null).show();
      return;
      if (2 == paramInt) {
        paramString = str + anni.a(2131709472) + paramString + anni.a(2131709467);
      } else {
        paramString = anni.a(2131709469);
      }
    }
  }
  ...
  public static void a(Context paramContext, int paramInt, Bundle paramBundle)
  {
    if (paramContext == null)
    {
      ...
      Toast.makeText(BaseApplication.getContext(), anni.a(2131709471), 0).show();
      return;
    }
    ...
    if ((paramContext instanceof aazf)) {
  ...
  private void h()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 161	blhj:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnull +6 -> 14
    //   11: aload_0
    ...
    //   30: putfield 161	blhj:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   33: aload_0
    //   34: getfield 161	blhj:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   37: new 170	cooperation/qlink/QQProxyForQlink$9
    //   40: dup
    //   41: aload_0
    //   42: invokespecial 172	cooperation/qlink/QQProxyForQlink$9:<init>	(Lblhj;)V
    //   45: lconst_0
    //   46: ldc2_w 173
  ...
  private void j()
  {
    ...
    {
      this.jdField_b_of_type_AndroidContentBroadcastReceiver = new blhk(this);
  ...
  private void l()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 223	blhj:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   8: ifnonnull +58 -> 66
    //   11: aload_0
    //   12: new 225	blhl
    //   15: dup
    //   16: aload_0
    //   17: invokespecial 226	blhl:<init>	(Lblhj;)V
    //   20: putfield 223	blhj:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   37: aload_0
    //   38: getfield 28	blhj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   41: ifnull +11 -> 52
    //   44: aload_0
    //   45: getfield 28	blhj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   56: aload_1
    //   57: aload_0
    //   58: getfield 223	blhj:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   61: aload_2
    ...
    //   77: aload_0
    //   78: aconst_null
    //   79: putfield 223	blhj:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   82: goto -16 -> 66
    //   85: astore_1
    //   86: aload_0
    //   87: monitorexit
  ...
  private void m()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 223	blhj:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   6: ifnull +28 -> 34
    //   9: aload_0
    //   10: getfield 28	blhj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13: ifnull +13 -> 26
    //   16: aload_0
    //   17: getfield 28	blhj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   44: aload_0
    //   45: getfield 223	blhj:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   51: aload_0
    //   52: aconst_null
    //   53: putfield 223	blhj:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   56: goto -22 -> 34
    //   59: astore_1
    //   60: aload_0
    //   61: monitorexit
  ...
  public void a(Activity paramActivity, DialogInterface.OnClickListener paramOnClickListener1, DialogInterface.OnClickListener paramOnClickListener2, DialogInterface.OnClickListener paramOnClickListener3, String paramString)
  {
    ...
    {
      return;
      String str2 = bglf.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerUin);
      String str1;
      if (str2 != null)
      {
        str1 = str2;
      ...
      {
        a("0X8004854", 1);
        paramOnClickListener3 = paramActivity.getResources().getString(2131697584) + str1 + paramActivity.getResources().getString(2131697585);
        ...
        {
          this.jdField_a_of_type_Bgpa = bglp.a(paramActivity, 230, paramActivity.getResources().getString(2131697545), paramOnClickListener3, paramActivity.getResources().getString(2131697586), paramActivity.getResources().getString(2131697586), paramOnClickListener2, null);
          label194:
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Bgpa.setOnDismissListener(new blhp(this));
        return;
        label224:
        str1 = this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerUin;
        break;
        this.jdField_a_of_type_Bgpa = bglp.a(paramActivity, 230, paramActivity.getResources().getString(2131697545), paramOnClickListener3, paramActivity.getResources().getString(2131697586), paramActivity.getResources().getString(2131697587), paramOnClickListener1, paramOnClickListener2);
        break label194;
        if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mMode == 2)
        {
          a("0X8004856", 1);
          paramOnClickListener1 = str1 + paramActivity.getResources().getString(2131697583);
          this.jdField_a_of_type_Bgpa = bglp.a(paramActivity, 230, paramActivity.getResources().getString(2131697545), paramOnClickListener1, paramActivity.getResources().getString(2131697582), paramActivity.getResources().getString(2131697582), paramOnClickListener3, null);
          this.jdField_a_of_type_Bgpa.show();
        }
  ...
  public void a(Activity paramActivity, ArrayList<String> paramArrayList, int paramInt1, int paramInt2, boolean paramBoolean, String paramString)
  {
    ...
    paramActivity.finish();
    return;
    a(paramActivity, new blhm(this, paramArrayList, paramActivity, paramInt1, paramBoolean), new blhn(this), new blho(this), paramString);
  }
  ...
  public void a(QlAndQQInterface.InsertFMFileInfo paramInsertFMFileInfo)
  {
    ...
    String str = atvo.a(paramInsertFMFileInfo.filePath);
    long l1 = atvo.a(paramInsertFMFileInfo.filePath);
    long l2 = bbzh.a(-1000).uniseq;
    ...
    localFileManagerEntity.nFileType = atvo.a(paramInsertFMFileInfo.filePath);
    ...
    if (localanmw.e(String.valueOf(localFileManagerEntity.peerUin)) != null)
    {
      localFileManagerEntity.peerType = 0;
      localFileManagerEntity.peerNick = atvo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInsertFMFileInfo.uin, null, 0);
      localFileManagerEntity.status = 1;
      if ((!localanmw.b(paramInsertFMFileInfo.uin)) && (!paramInsertFMFileInfo.bSend)) {
        break label356;
      }
      localFileManagerEntity.nOpType = 0;
      localFileManagerEntity.bSend = true;
      bdzv.a(paramInsertFMFileInfo.filePath, 0L, 0, true);
    ...
    for (;;)
    {
      ...
      bdzv.a(paramInsertFMFileInfo.filePath, l1, 0, false, null);
      bdtd.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), str, 0, null);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localFileManagerEntity);
    }
  }
  ...
  {
    String str = bglf.i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
    anmw localanmw = (anmw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", paramString, paramString, 0, paramInt, 0, "", "", "", "");
  }
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean, long paramLong1, long paramLong2, HashMap<String, String> paramHashMap)
  {
    ...
    blhx.a(paramString1, paramString2, paramBoolean, paramLong1, paramLong2, paramHashMap);
  }
  
  public void a(AppActivity paramAppActivity, String paramString, zuk paramzuk)
  {
    if ((paramAppActivity == null) || (paramString == null)) {
      return;
    }
    blhw localblhw = blhv.a(paramString);
    if (localblhw == null)
    {
      bglp.a(paramAppActivity, 230, paramAppActivity.getString(2131697544), paramAppActivity.getString(2131697564), 2131697538, 2131697538, new blhq(this, paramzuk), null).show();
      return;
    }
    if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mWorking)
    {
      a(paramAppActivity, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mMode, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerNick, paramzuk);
      return;
    }
    ...
    paramzuk = new Bundle();
    paramzuk.putString("url", paramString);
    paramzuk.putString("key", localblhw.a);
    paramzuk.putString("peerUin", localblhw.b);
    paramzuk.putString("peerNick", localblhw.c);
    paramzuk.putString("peerOS", localblhw.d);
    paramzuk.putString("apSSID", localblhw.e);
    paramzuk.putString("preSharedKey", localblhw.f);
    paramzuk.putBoolean("fromqlink", bool);
    paramString = paramAppActivity.getIntent().getStringExtra("subfrom");
    if (paramString != null) {
      paramzuk.putString("subfrom", paramString);
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
    a(paramAppActivity, 11, paramzuk);
    paramAppActivity.finish();
  }
  
  public void a(AppActivity paramAppActivity, zuk paramzuk)
  {
    if (paramAppActivity == null) {
      return;
    }
    bglp.a(paramAppActivity, 230, paramAppActivity.getString(2131697562), paramAppActivity.getString(2131697563), 2131697538, 2131697538, new blhr(this, paramzuk), null).show();
  }
  ...
  public boolean a(String paramString, List<String> paramList)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      localSendFileInfo.sessionid = atvo.a().longValue();
      localSendFileInfo.filePath = paramList;
      localSendFileInfo.fileSize = atvo.a(paramList);
  ...
  {
    if (1 == paramInt) {
      atvo.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext());
    }
  }
