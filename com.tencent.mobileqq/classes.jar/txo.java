...
public class txo
{
  ...
  static txo jdField_a_of_type_Txo;
  ...
  public static txo a()
  {
    if (jdField_a_of_type_Txo == null) {
      jdField_a_of_type_Txo = new txo();
    }
    return jdField_a_of_type_Txo;
  }
  ...
  {
    bdmc.a(BaseApplicationImpl.getApplication()).a(null, paramString, true, 0L, 0L, paramHashMap, null);
  }
