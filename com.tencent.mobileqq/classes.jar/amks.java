...
public class amks
{
  ...
  public final CopyOnWriteArrayList<amkt> a;
  ...
  public static amks a()
  {
    if (jdField_a_of_type_Amks == null) {}
    try
    {
      if (jdField_a_of_type_Amks == null) {
        jdField_a_of_type_Amks = new amks();
      }
      return jdField_a_of_type_Amks;
    }
    finally {}
  }
  ...
  private void c(String paramString)
  {
    ...
    if (localObject2.length == 3)
    {
      ...
      {
        localObject1 = new File(bhcs.c((String)localObject1));
        if (((File)localObject1).exists())
        {
          ...
          localObject1 = bgyo.a(((File)localObject1).getAbsolutePath());
  ...
  public Bitmap a(amkp paramamkp, int paramInt)
  {
    if ((paramamkp == null) || (TextUtils.isEmpty(paramamkp.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.containsKey(paramamkp.jdField_a_of_type_JavaLangString))
    {
      Object localObject = (DiyPendantEntity)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramamkp.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramamkp);
      paramamkp = BaseApplicationImpl.getApplication().getRuntime();
      if ((paramamkp instanceof QQAppInterface)) {
        a((QQAppInterface)paramamkp, 500);
      }
      return null;
      if (QLog.isColorLevel()) {
        QLog.i("DiyPendantFetcher", 2, "can not found cache in DiyPendantCache! " + paramamkp.jdField_a_of_type_JavaLangString);
      }
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArraySet.add(paramamkp.jdField_a_of_type_JavaLangString);
    }
  }
  
  public Bitmap a(amkt paramamkt, String paramString, int paramInt1, int paramInt2, float paramFloat, int paramInt3, int paramInt4, int paramInt5, Paint paramPaint)
  {
    ...
    Object localObject = bhcs.a(String.valueOf(paramInt1));
    if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_isFontLoaded(paramInt1))
    {
      this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramamkt);
      if (bhcs.a(String.valueOf(paramInt1)))
      {
        if (QLog.isColorLevel()) {
    ...
    paramamkt = new ETFont(paramInt1, (String)localObject, paramFloat);
    paramamkt.setColor(paramInt3);
    try
    {
      localObject = Bitmap.createBitmap(paramInt4, paramInt5, Bitmap.Config.ARGB_8888);
      if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_isPaintableChar(paramString.charAt(0), paramamkt)) {
        break label590;
      }
      for (paramInt1 = this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_spaceMeasureText(paramString, 0, paramString.length(), paramamkt, paramPaint); paramInt1 > paramInt4; paramInt1 = this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_spaceMeasureText(paramString, 0, paramString.length(), paramamkt, paramPaint)) {
        paramamkt.mFontSize -= 1;
      }
      paramInt2 = (paramInt4 - paramInt1) / 2;
    }
    catch (OutOfMemoryError paramamkt)
    {
      QLog.d("DiyPendantFetcher", 1, "fetchTextWithFont Bitmap.createBitmap OutOfMemoryError: " + paramamkt.getMessage());
      return null;
    }
    paramInt1 = 0;
    paramPaint = new Paint.FontMetrics();
    if (this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_getFontMetrics(paramPaint, paramamkt))
    {
      paramFloat = paramPaint.bottom;
      float f = paramPaint.top;
      paramInt1 = (int)((paramInt5 - (paramFloat - f)) / 2.0F);
    }
    if (!this.jdField_a_of_type_ComEtrumpMixlayoutETEngine.native_drawText(paramString, (Bitmap)localObject, paramInt2, paramInt1, paramamkt))
    {
  ...
  public Typeface a(amkt paramamkt, int paramInt1, int paramInt2)
  {
    if ((paramamkt == null) || (paramInt1 <= 0)) {
      return null;
    }
  ...
  public DiyPendantEntity a(QQAppInterface paramQQAppInterface, String paramString, BusinessObserver paramBusinessObserver)
  {
    ...
    ((amku)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.DIY_PENDANT_HANDLER)).a((List)localObject, paramBusinessObserver);
    return null;
  }
  ...
  public List<DiyPendantSticker> a(amkp paramamkp)
  {
    if ((paramamkp == null) || (TextUtils.isEmpty(paramamkp.jdField_a_of_type_JavaLangString))) {
      return null;
    }
    if (this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.containsKey(paramamkp.jdField_a_of_type_JavaLangString)) {
      return ((DiyPendantEntity)this.jdField_a_of_type_ComTencentUtilLRULinkedHashMap.get(paramamkp.jdField_a_of_type_JavaLangString)).getStickerInfoList();
    }
    if (QLog.isColorLevel()) {
      QLog.i("DiyPendantFetcher", 2, "can not found cache in DiyPendantCache! " + paramamkp.jdField_a_of_type_JavaLangString);
    }
  ...
  {
    String str = bhcs.a(String.valueOf(paramInt1));
  ...
  public void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, List<DiyPendantEntity> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if (paramBoolean)
      {
        ...
        ExtensionInfo localExtensionInfo = localanvk.a(localDiyPendantEntity.uinAndDiyId.split("_")[0]);
