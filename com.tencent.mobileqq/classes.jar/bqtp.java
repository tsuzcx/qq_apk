  ...
  extends bqts
{
  ...
  public bqtp(Context paramContext, int paramInt)
  {
  ...
  public View a(int paramInt, ViewGroup paramViewGroup)
  {
    ...
    Object localObject = new RelativeLayout.LayoutParams(-1, zps.a(this.a, 1.0F));
    ((RelativeLayout.LayoutParams)localObject).addRule(10);
    localView.setLayoutParams((ViewGroup.LayoutParams)localObject);
    localView.setBackgroundColor(Color.parseColor("#DEDFE0"));
    localObject = new View(this.a);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, zps.a(this.a, 1.0F));
    localLayoutParams.addRule(12);
    ((View)localObject).setLayoutParams(localLayoutParams);
    ((View)localObject).setBackgroundColor(Color.parseColor("#DEDFE0"));
    if (QQStoryContext.a())
    {
      paramViewGroup.setBackgroundColor(this.a.getResources().getColor(2131166476));
      ((View)localObject).setBackgroundColor(this.a.getResources().getColor(2131166476));
      localView.setBackgroundColor(this.a.getResources().getColor(2131166476));
    }
