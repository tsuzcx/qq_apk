...
public class mfy
  extends QIPCModule
{
  public mfy(VideoFeedsIPCServer paramVideoFeedsIPCServer, String paramString)
  {
    super(paramString);
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if ("CMD_SHORTVIDEO_REQUEST_MANUAL_DOWNLOAD".equals(paramString))
    {
      ...
      if (paramBundle != null)
      {
        ...
        VideoFeedsIPCServer.a(this.a, new mfz(this, paramString));
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    if ("CMD_CAMERA_CAPTURE_SO_DOWNLOAD".equals(paramString))
                    {
                      ...
                      VideoFeedsIPCServer.a(this.a).a(new mga(this));
                    ...
                    else
                    {
                      ...
                      {
                        VideoFeedsIPCServer.a(this.a, new mgb(this, (QQAppInterface)localObject));
