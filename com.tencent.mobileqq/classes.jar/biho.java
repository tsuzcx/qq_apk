...
public class biho
{
  private static biho jdField_a_of_type_Biho;
  ...
  static String g = anzj.a(2131699061);
  static String h = anzj.a(2131699059);
  static String i = anzj.a(2131699060);
  static String j = anzj.a(2131699058);
  public int a;
  public long a;
  ...
  public static biho a()
  {
    if (jdField_a_of_type_Biho == null) {}
    try
    {
      if (jdField_a_of_type_Biho == null) {
        jdField_a_of_type_Biho = new biho();
      }
      return jdField_a_of_type_Biho;
    }
    finally {}
  }
  ...
  public void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    bhmi.a(paramContext.getFilesDir() + File.separator + "vipKerwordJson", paramString1);
  }
  ...
  void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    if (TextUtils.isEmpty(paramString2))
    {
      ...
      localMessageRecord.msgUid = aunj.b();
      if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord == null) {
        break label249;
      }
    }
  ...
  public void a(AppRuntime paramAppRuntime)
  {
    ...
    if (localObject1 != null) {
      asoo.a(((JSONObject)localObject1).optLong("interval", 86400L));
    }
    ...
    {
      auvx.jdField_a_of_type_Boolean = bool1;
      QLog.i("AioVipKeywordHelper", 1, "lottieConfig.switch is " + bool1);
      localObject1 = paramAppRuntime.optJSONObject("ipProductGrayTips");
      if (localObject1 != null)
      {
        axfi.jdField_a_of_type_JavaLangString = ((JSONObject)localObject1).optString("leftText", axfi.jdField_a_of_type_JavaLangString);
        axfi.jdField_b_of_type_JavaLangString = ((JSONObject)localObject1).optString("linkText", axfi.jdField_b_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
      ...
      if (localObject1 != null)
      {
        bhkt.jdField_a_of_type_Int = ((JSONObject)localObject1).optInt("interval", 5000);
        QLog.d("AioVipKeywordHelper", 1, "getStrangerInterval is " + bhkt.jdField_a_of_type_Int);
      }
      localObject1 = paramAppRuntime.optJSONObject("downloadTimeoutConfig");
      if (localObject1 != null)
      {
        askd.jdField_b_of_type_Int = ((JSONObject)localObject1).optInt("emotion", askd.jdField_b_of_type_Int);
        bool1 = bool2;
        if (((JSONObject)localObject1).optInt("emoTryReadNoLen", 0) == 1) {
          bool1 = true;
        }
        askd.jdField_b_of_type_Boolean = bool1;
      ...
      if (localObject1 != null) {
        biav.a().a((JSONArray)localObject1);
      }
      aslq.a(paramAppRuntime.optJSONArray("h5MagicTips"));
      return;
    }
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      {
        return false;
      } while ((bdgb.b()) || (this.jdField_d_of_type_Int == 0));
      l1 = 86400L;
      int i1;
      switch (paramSessionInfo.jdField_a_of_type_Int)
      {
