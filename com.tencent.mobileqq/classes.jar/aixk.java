...
{
  public static int a;
  private anvi jdField_a_of_type_Anvi = new aixm(this);
  private CardObserver jdField_a_of_type_ComTencentMobileqqAppCardObserver = new aixl(this);
  ...
  public static aixk a(QQAppInterface paramQQAppInterface)
  {
    return (aixk)paramQQAppInterface.getManager(QQManagerFactory.NEW_FRIEND_VERIFICATION_MANAGER);
  }
  ...
  public aixj a()
  {
    return (aixj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(BusinessHandlerFactory.NEW_FRIEND_VERIFICATION_HANDLER);
  }
  ...
  public void a()
  {
    ...
    if (jdField_a_of_type_Int > 0) {
      bdla.b(null, "dc00898", "", "", "0X800A3A3", "0X800A3A3", 0, jdField_a_of_type_Int, 0, "", "", "", "");
    }
