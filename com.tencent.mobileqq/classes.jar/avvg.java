  ...
  extends alpd
{
  ...
  public avvg(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(int paramInt, Intent paramIntent, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      for (paramIntent = Integer.toString(j);; paramIntent = i + "_" + j)
      {
        ...
        azri.a(this.mApp.getApplication()).a(this.app.getCurrentAccountUin(), "ocrTextSearch", bool, l, 0L, paramArrayOfByte, "");
        if (QLog.isColorLevel()) {
  ...
  private void a(Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      Object localObject4 = basl.a().b(l1);
      Object localObject5 = basl.a().a(l1);
      ...
      for (;;)
      {
        ...
        {
          int i;
          if (SessionInfo.getInstance(this.app.c()).getHttpconn_sig_session() != null)
          {
            i = SessionInfo.getInstance(this.app.c()).getHttpconn_sig_session().length;
            localObject1 = new byte[i];
            System.arraycopy(SessionInfo.getInstance(this.app.c()).getHttpconn_sig_session(), 0, localObject1, 0, i);
          }
          localObject2 = localObject4;
          if (SessionInfo.getInstance(this.app.c()).getSessionKey() != null)
          {
            i = SessionInfo.getInstance(this.app.c()).getSessionKey().length;
            localObject2 = new byte[i];
            System.arraycopy(SessionInfo.getInstance(this.app.c()).getSessionKey(), 0, localObject2, 0, i);
          }
      ...
      try
      {
        ...
        ((baub)localObject1).jdField_a_of_type_ArrayOfByte = ((byte[])localObject5);
        ((baub)localObject1).jdField_a_of_type_Baug = new avvh(this, paramIntent, (byte[])localObject2, (String)localObject3);
        ((baub)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject4);
        ((baub)localObject1).jdField_a_of_type_Int = 1;
        ((baub)localObject1).f = 57;
        ((baub)localObject1).jdField_a_of_type_JavaUtilHashMap.put("Accept-Encoding", "identity");
        ((baub)localObject1).jdField_c_of_type_Int = 2;
        ((baub)localObject1).jdField_c_of_type_Long = 15000L;
        paramIntent = BaseApplicationImpl.sApplication.getRuntime();
        if ((paramIntent instanceof AppInterface))
        {
          ((AppInterface)paramIntent).getNetEngine(0).a((bave)localObject1);
          if (QLog.isColorLevel()) {
