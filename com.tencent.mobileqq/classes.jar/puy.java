...
public class puy
  extends QIPCModule
{
  private static volatile puy a;
  
  private puy(String paramString)
  {
    super(paramString);
  }
  ...
  private void a(Bundle paramBundle)
  {
    ...
    if (ptw.a(paramBundle, (String)localObject))
    {
      QLog.i("ReadInJoyIPCModule", 1, "[jumpToNativeChannel], jump to recommend channel, using floating window.");
      return;
    }
    if (bool) {}
    for (localObject = "1"; ptt.a((String)localObject, i); localObject = "0")
    {
      ohp.a(paramBundle, i, str, k, 4);
      return;
    }
    localObject = ohp.b(paramBundle, 0, i);
  ...
  {
    ReadInJoyUserInfoModule.a(paramBundle.getLong("uin"), new pva(this, paramInt));
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        if (ptt.a(Uri.parse(str).getQueryParameter("ispush"), paramInt)) {
          try
          {
            if (str.contains("v_url_base64")) {}
            for (paramString = bgmp.c(Uri.parse(str).getQueryParameter("v_url_base64")); BaseActivity.sTopActivity == null; paramString = URLDecoder.decode(Uri.parse(str).getQueryParameter("v_url"), "utf-8"))
            {
              paramBundle = BaseApplicationImpl.getContext();
              tlg.a(paramBundle, null, paramString, null);
              return null;
            }
          }
      ...
      paramBundle = new ovb();
      UiApiPlugin.a(paramString, paramBundle, paramString.getStringExtra("arg_callback"), new puz(this, paramInt, paramBundle));
      return null;
    ...
    paramString = new Bundle();
    paramString.putInt("action_get_app_type", ube.c());
    callbackResult(paramInt, EIPCResult.createResult(0, paramString));
    return null;
  }
}
