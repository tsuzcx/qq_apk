...
public class apse
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = amtj.a(2131701551);
  }
  ...
  public static MessageRecord a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    {
      QQMessageFacade.Message localMessage = paramQQAppInterface.getMessageFacade().getLastMessage(paramMessageRecord.senderuin, i, paramMessageRecord.getConfessTopicId());
      MessageRecord localMessageRecord = paramMessageRecord;
      if (localMessage != null) {
        localMessageRecord = paramQQAppInterface.getMessageFacade().getMsgItemByUniseq(paramMessageRecord.senderuin, i, localMessage.uniseq);
      }
  ...
  public static String a(QQAppInterface paramQQAppInterface, ConfessInfo paramConfessInfo, String paramString)
  {
    ...
    if ((paramConfessInfo.isSysMsg == 1) && (!TextUtils.equals(paramConfessInfo.confessorUinStr, str))) {
      return amtj.a(2131701548);
    }
    if (!TextUtils.equals(paramConfessInfo.confessorUinStr, str)) {
      return paramConfessInfo.confessorNick;
    }
    return ContactUtils.getBuddyName(paramQQAppInterface, paramString, true);
  }
  ...
  public static im_msg_body.Elem a(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      localC2CConfessContext.uint64_confessor_uin.set(Long.parseLong(((apsb)localObject2).jdField_c_of_type_JavaLangString));
      localC2CConfessContext.uint64_confess_to_uin.set(Long.parseLong(((apsb)localObject2).jdField_b_of_type_JavaLangString));
      localC2CConfessContext.uint64_send_uin.set(Long.parseLong(paramMessageRecord.senderuin));
      localC2CConfessContext.bytes_confess.set(ByteStringMicro.copyFromUtf8(((apsb)localObject2).jdField_d_of_type_JavaLangString));
      localC2CConfessContext.bytes_confessor_nick.set(ByteStringMicro.copyFromUtf8(((apsb)localObject2).jdField_e_of_type_JavaLangString));
      localC2CConfessContext.uint64_confess_time.set(((apsb)localObject2).jdField_a_of_type_Long);
      localC2CConfessContext.uint32_bg_type.set(((apsb)localObject2).jdField_b_of_type_Int);
      localC2CConfessContext.uint32_topic_id.set(((apsb)localObject2).jdField_a_of_type_Int);
      localC2CConfessContext.uint32_confessor_sex.set(((apsb)localObject2).jdField_c_of_type_Int);
      localC2CConfessContext.uint32_confess_num.set(((apsb)localObject2).jdField_d_of_type_Int);
      localC2CConfessContext.uint32_biz_type.set(((apsb)localObject2).f);
      localC2CConfessContext.uint32_confess_to_sex.set(((apsb)localObject2).jdField_e_of_type_Int);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if ((paramQQAppInterface != null) && (aprw.a(paramQQAppInterface, "redpoint_leba_show"))) {
      aprw.a(paramQQAppInterface, "redpoint_leba_show", 0L);
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, String paramString1, int paramInt2, String paramString2)
  {
    ...
    paramQQAppInterface = (apsa)paramQQAppInterface.getManager(269);
    ...
    {
      paramString1 = String.format("&topicId=%d&fromEncodeUin=%s&fromGender=%d&toUin=%s", new Object[] { Integer.valueOf(paramInt1), awkh.a(paramString1), Integer.valueOf(paramInt2), awkh.a(paramString2) });
  ...
  public static void a(QQAppInterface paramQQAppInterface, RecentItemConfessMsg paramRecentItemConfessMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      while (QLog.isDevelopLevel())
      {
        ...
        if (paramBoolean) {
          paramQQAppInterface.getMessageFacade().removeMsgFromMsgBox(AppConstants.CONFESS_UIN, 1032, paramRecentItemConfessMsg.getRecentUserUin(), paramQQAppInterface.getCurrentAccountUin(), paramRecentItemConfessMsg.mType, paramRecentItemConfessMsg.mConfessInfo.topicId);
        }
        if (i > 0) {
          paramQQAppInterface.getMessageFacade().setReaded(paramRecentItemConfessMsg.getRecentUserUin(), paramRecentItemConfessMsg.getRecentUserType(), paramRecentItemConfessMsg.mConfessInfo.topicId, true, false);
        }
      }
    }
  }
  ...
  {
    if ((paramInt2 <= 0) || (abwz.a(paramInt1) != 1032)) {
      if (QLog.isColorLevel()) {
    ...
    {
      return;
      localConfessInfo = ((apsa)paramQQAppInterface.getManager(269)).a().a(paramString, paramInt1, paramInt2);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, ConfessInfo paramConfessInfo)
  {
    ...
    Object localObject1 = ((apsa)paramQQAppInterface.getManager(269)).b();
    int i;
    long l;
    if (localObject1 == null)
    {
      i = 24;
      Object localObject2 = String.format(aprw.jdField_d_of_type_JavaLangString, new Object[] { Integer.valueOf(i) });
      localObject1 = amtj.a(2131701549);
      i = ((String)localObject2).indexOf((String)localObject1);
      int j = ((String)localObject1).length();
      localObject1 = new aucf(paramString, paramString, (String)localObject2, paramInt1, -5020, 655369, bbko.a());
      ((aucf)localObject1).jdField_c_of_type_JavaLangString = ((String)localObject2);
      localObject2 = new Bundle();
      ((Bundle)localObject2).putInt("key_action", 31);
      ((aucf)localObject1).a(i, j + i, (Bundle)localObject2);
      paramString = paramQQAppInterface.getMessageFacade().getAIOList(paramString, paramInt1);
      ...
      paramString.initGrayTipMsg(paramQQAppInterface, (aucf)localObject1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    paramQQAppInterface.getMessageFacade().setReaded(paramString, paramInt1, paramInt2, paramBoolean1, paramBoolean2);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    aucf localaucf = new aucf(paramString1, paramString1, paramString2, paramInt1, -5040, 655377, bbko.a());
    localaucf.jdField_c_of_type_JavaLangString = paramString2;
    String str = amtj.a(2131701546);
    int i = paramString2.indexOf(str);
    int j = str.length();
    paramString2 = new Bundle();
    paramString2.putInt("key_action", 34);
    localaucf.a(i, j + i, paramString2);
    paramString1 = paramQQAppInterface.getMessageFacade().getAIOList(paramString1, paramInt1);
    long l;
    if ((paramString1 != null) && (!paramString1.isEmpty()))
    {
      l = ((ChatMessage)paramString1.get(paramString1.size() - 1)).shmsgseq;
      paramString1 = new MessageForUniteGrayTip();
      paramString1.initGrayTipMsg(paramQQAppInterface, localaucf);
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      paramQQAppInterface.getMessageFacade().addMessage(paramString1, paramQQAppInterface.getCurrentAccountUin());
      return;
      l = Math.abs(new Random().nextInt());
      break;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2, ConfessInfo paramConfessInfo)
  {
    if (QLog.isColorLevel())
    {
      localObject = bftf.a(paramString2);
      if (paramConfessInfo != null) {
        break label75;
      }
    }
    ...
    Object localObject = new aucf(paramString1, paramString1, paramString2, paramInt1, -5020, 655376, bbko.a());
    ((aucf)localObject).jdField_c_of_type_JavaLangString = paramString2;
    paramString1 = paramQQAppInterface.getMessageFacade().getAIOList(paramString1, paramInt1);
    long l;
    if ((paramString1 != null) && (!paramString1.isEmpty()))
    {
      l = ((ChatMessage)paramString1.get(paramString1.size() - 1)).shmsgseq;
      paramString1 = new MessageForUniteGrayTip();
      paramString1.initGrayTipMsg(paramQQAppInterface, (aucf)localObject);
      paramString1.isread = true;
      paramString1.shmsgseq = l;
      paramString1.mNeedTimeStamp = true;
      paramString1.updateUniteGrayTipMsgData(paramQQAppInterface);
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<MessageRecord> paramList)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      if ((localMessageRecord.isSend()) || (abwz.a(localMessageRecord.istroop) != 1032) || (!a(localMessageRecord))) {
        break label429;
      }
      ...
      if (((MessageRecord)((List)localObject2).get(j)).getConfessTopicId() == localMessageRecord.getConfessTopicId())
      {
        ...
        if (i == 0)
        {
          ...
          {
            localObject2 = bbli.a(paramQQAppInterface, paramQQAppInterface.getCurrentUin(), localMessageRecord.senderuin, null, localMessageRecord.istroop, (byte)0, (byte)0, (short)0, (String)localObject1);
  ...
  {
    aprw.a(paramQQAppInterface, "redpoint_box_show", 0L);
    aprw.a(paramQQAppInterface, "redpoint_clear_time", bbko.a());
  }
  ...
  public static void a(msg_comm.Msg paramMsg, im_msg_body.Elem paramElem, List<MessageRecord> paramList, QQAppInterface paramQQAppInterface)
  {
      ...
      do
      {
        do
        {
          ...
          for (;;)
          {
            ...
            paramList = (apsa)paramQQAppInterface.getManager(269);
            if (paramList.a(paramElem, (String)localObject3, str1, i) != 1) {
              break;
            }
            localObject1 = new apsb();
            ((apsb)localObject1).jdField_a_of_type_Int = i;
            ((apsb)localObject1).jdField_b_of_type_Int = ((hummer_commelem.MsgElemInfo_servtype21.C2CConfessContext)localObject2).uint32_bg_type.get();
            ((apsb)localObject1).jdField_b_of_type_JavaLangString = ((String)localObject3);
            ((apsb)localObject1).jdField_c_of_type_JavaLangString = str1;
            ((apsb)localObject1).jdField_d_of_type_JavaLangString = ((hummer_commelem.MsgElemInfo_servtype21.C2CConfessContext)localObject2).bytes_confess.get().toStringUtf8();
            ((apsb)localObject1).jdField_e_of_type_JavaLangString = ((hummer_commelem.MsgElemInfo_servtype21.C2CConfessContext)localObject2).bytes_confessor_nick.get().toStringUtf8();
            ((apsb)localObject1).jdField_a_of_type_JavaLangString = paramQQAppInterface.getCurrentNickname();
            ...
            ((apsb)localObject1).jdField_c_of_type_Int = i;
            ...
            ((apsb)localObject1).jdField_a_of_type_Long = l1;
            ...
            ((apsb)localObject1).jdField_d_of_type_Int = i;
            ...
            ((apsb)localObject1).jdField_e_of_type_Int = i;
            l1 = ((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_time.get() - 1L;
            l2 = ((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_seq.get() - 1L;
            paramList.a(paramElem, (apsb)localObject1, l1, l2);
            if (!QLog.isColorLevel()) {
              break;
            }
            l3 = bbko.a();
            QLog.i("ConfessMsgUtil", 2, "decodeConfessMsgElem strConfessorDesc:" + ((apsb)localObject1).jdField_d_of_type_JavaLangString + " msgTime:" + l1 + " msgSeq:" + l2 + " nowTime" + l3);
            return;
    ...
    Object localObject1 = (apsa)paramQQAppInterface.getManager(269);
    int k = ((apsa)localObject1).a(paramElem, paramList, str1, str2, j);
    if ((i == 0) && (k == 1))
    {
      localObject2 = new apsc();
      ((apsc)localObject2).jdField_a_of_type_JavaLangString = paramElem;
      ((apsc)localObject2).jdField_a_of_type_Int = j;
      ((apsc)localObject2).jdField_b_of_type_Int = (j % 4);
      ((apsc)localObject2).jdField_d_of_type_JavaLangString = paramList;
      ((apsc)localObject2).jdField_e_of_type_JavaLangString = str2;
      ...
      label1784:
      ((apsc)localObject2).jdField_c_of_type_Int = i;
      ...
      if (TextUtils.isEmpty(paramList)) {
        if (((apsc)localObject2).jdField_c_of_type_Int == 1)
        {
          paramList = amtj.a(2131701547);
          label1837:
          ((apsc)localObject2).g = paramList;
          label1843:
          ...
          label1866:
          ((apsc)localObject2).jdField_c_of_type_JavaLangString = paramList;
          ...
          label1893:
          ((apsc)localObject2).jdField_a_of_type_Long = l1;
    ...
    {
      ((apsc)localObject2).jdField_d_of_type_Int = i;
      ((apsc)localObject2).jdField_b_of_type_JavaLangString = str1;
      l3 = ((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_time.get() - 1L;
      long l4 = ((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_seq.get();
      paramMsg = paramQQAppInterface.getMessageFacade().getAIOList(paramElem, 1);
      l2 = -1L;
      l1 = l2;
      if (paramMsg != null)
      {
      ...
      if ((l4 < l1 - 5L) && (l1 >= 0L))
      {
        ...
        ThreadManager.getSubThreadHandler().postDelayed(new ConfessMsgUtil.1((apsa)localObject1, paramElem, (apsc)localObject2, l3, l4), 250L);
        return;
        paramList = amtj.a(2131701550);
        break label1837;
        ((apsc)localObject2).g = paramList;
        break label1843;
      }
      ((apsa)localObject1).a(paramElem, (apsc)localObject2, l3, l3, l4);
      if (!QLog.isColorLevel()) {
        break;
      }
      l1 = bbko.a();
      QLog.i("ConfessMsgUtil", 2, "decodeConfessMsgElem 2 strConfessorDesc:" + ((apsc)localObject2).f + " msgTime:" + l3 + " msgSeq:" + l4 + " nowTime" + l1);
      return;
      if ((!paramMsg.msg_head.has()) || (!((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_seq.has())) {
        break;
      }
      ((apsa)localObject1).a(paramElem, paramList, str1, str2, j, ((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_seq.get());
      return;
      i = 0;
      paramElem = "";
      break label1558;
  ...
  {
    if ((abwz.a(paramInt1) == 1032) || (abwz.a(paramInt3) == 1032)) {}
  ...
  public static im_msg_body.Elem b(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      localGroupConfessContext.uint64_confessor_uin.set(Long.parseLong(((apsc)localObject2).jdField_e_of_type_JavaLangString));
      localGroupConfessContext.uint64_confess_to_uin.set(Long.parseLong(((apsc)localObject2).jdField_d_of_type_JavaLangString));
      localGroupConfessContext.uint64_send_uin.set(Long.parseLong(paramMessageRecord.senderuin));
      localGroupConfessContext.bytes_topic.set(ByteStringMicro.copyFromUtf8(((apsc)localObject2).f));
      localGroupConfessContext.bytes_confess_to_nick.set(ByteStringMicro.copyFromUtf8(((apsc)localObject2).jdField_c_of_type_JavaLangString));
      localGroupConfessContext.uint64_confess_time.set(((apsc)localObject2).jdField_a_of_type_Long);
      localGroupConfessContext.uint32_topic_id.set(((apsc)localObject2).jdField_a_of_type_Int);
      localGroupConfessContext.uint32_confessor_sex.set(((apsc)localObject2).jdField_c_of_type_Int);
      localGroupConfessContext.uint32_confess_to_nick_type.set(((apsc)localObject2).jdField_d_of_type_Int);
      localGroupConfessContext.bytes_confessor_nick.set(ByteStringMicro.copyFromUtf8(((apsc)localObject2).g));
  ...
  public static void b(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString)
  {
    ...
    do
    {
      ...
      apsc localapsc = paramQQAppInterface.a();
      if (localapsc != null)
      {
        paramMessageRecord.saveExtInfoToExtStr("ext_key_group_chat_confess_info", localapsc.a());
        paramQQAppInterface.a(paramString, localapsc.jdField_d_of_type_JavaLangString, localapsc.jdField_b_of_type_JavaLangString, localapsc.jdField_e_of_type_JavaLangString, localapsc.jdField_a_of_type_Int);
      }
    } while (!QLog.isColorLevel());
  ...
  public static void b(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    {
      return;
      localObject = (axfy)paramQQAppInterface.getManager(160);
      RedTouchItem localRedTouchItem = ((axfy)localObject).a(10018);
      if ((paramBoolean) && (localRedTouchItem != null)) {
        localRedTouchItem.extMsgs = null;
      }
      ((axfy)localObject).a(10018);
      localObject = ((apsa)paramQQAppInterface.getManager(269)).a();
      if ((localObject != null) && (((apsm)localObject).jdField_a_of_type_Int > 0)) {
        break;
      }
    } while (!QLog.isDevelopLevel());
    ...
    boolean bool2;
    if (localObject != null) {
      if (((apsm)localObject).jdField_a_of_type_Int != 0)
      {
        bool1 = true;
        ((apsm)localObject).jdField_a_of_type_Int = 0;
        bool2 = bool1;
        if (paramBoolean)
        {
          bool2 = bool1 | ((apsm)localObject).a();
          ((apsm)localObject).jdField_a_of_type_JavaLangString = "";
          ((apsm)localObject).jdField_c_of_type_JavaLangString = "";
          ((apsm)localObject).jdField_b_of_type_JavaLangString = "";
          ((apsm)localObject).jdField_b_of_type_Int = 0;
        }
        ThreadManager.post(new ConfessMsgUtil.2((apsm)localObject), 8, null, false);
      }
    }
    for (;;)
    {
      if (bool2) {
        ((aprx)paramQQAppInterface.getBusinessHandler(125)).a((apsm)localObject);
      }
