...
public class ycr
{
  private static final String jdField_a_of_type_JavaLangString = ycr.class.getSimpleName();
  ...
  public static String a(long paramLong)
  {
    ...
    try
    {
      str = BaseApplicationImpl.getContext().getString(2131721486);
      localObject2 = BaseApplicationImpl.getContext().getString(2131721487);
      localObject1 = BaseApplicationImpl.getContext().getString(2131721485);
