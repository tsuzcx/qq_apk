  ...
  extends atbl
{
  ...
  atar(atan paramatan, MessageRecord paramMessageRecord)
  {
    super(paramatan);
  ...
  void a(String paramString, int paramInt, atbj paramatbj)
  {
    ...
    atan.a(this.jdField_a_of_type_Atan).a().a().a(paramString, paramInt, this.b, this.c, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, 106, new atas(this, paramString, paramatbj));
  }
}
