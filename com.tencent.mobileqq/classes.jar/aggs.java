  ...
  implements aoog
{
  ...
  private static aiuh jdField_a_of_type_Aiuh = new aiuf();
  private static SparseArrayCompat<aiuh> jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat;
  ...
  public aggs(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner, BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(true);
    this.jdField_a_of_type_AndroidSupportV4UtilArraySet = new ArraySet();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Ahgk = new ahgk(paramContext, paramQQAppInterface, paramSessionInfo, paramAIOAnimationConatiner, paramBaseChatPie);
    ...
    for (long l = NetConnInfoCenter.getServerTime();; l = paramBaseChatPie.a())
    {
      ...
      this.jdField_a_of_type_Amby = new amby(this, paramQQAppInterface);
      this.jdField_a_of_type_Amca = new amca(paramBaseChatPie);
  ...
  static ChatMessage a(List<ChatMessage> paramList, ArraySet<Long> paramArraySet, long paramLong)
  {
    ...
    if (i < paramList.size())
    {
      ...
      label86:
      Object localObject2;
      if ((bcsa.b(localChatMessage.msgtype)) && (localChatMessage.needShowTimeStamp()))
      {
        j = 1;
  ...
  protected static void a(MessageForStructing paramMessageForStructing, aggl paramaggl, View paramView, boolean paramBoolean)
  {
    if ((paramMessageForStructing == null) || (paramMessageForStructing.structingMsg == null)) {
      return;
    }
    e();
    aiuh localaiuh2 = (aiuh)jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramMessageForStructing.structingMsg.mMsgServiceID);
    aiuh localaiuh1 = localaiuh2;
    if (localaiuh2 == null) {
      localaiuh1 = jdField_a_of_type_Aiuh;
    }
    localaiuh1.a(paramMessageForStructing, paramaggl, paramView, paramBoolean);
  }
    ...
    for (paramChatMessage1 = ((MessageForMarketFace)paramChatMessage1).mMarkFaceMessage;; paramChatMessage1 = (ChatMessage)localObject)
    {
      ...
      if (paramChatMessage1 != null)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            bool1 = bool2;
            if (asfa.a(paramChatMessage1.sbufID, paramChatMessage1.mediaType).equals(asfa.a(((MarkFaceMessage)localObject).sbufID, ((MarkFaceMessage)localObject).mediaType)))
            {
              bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "Ep_show_follow", 0, 0, "", paramChatMessage1.dwTabID + "", "", "");
              bool1 = true;
            }
          }
        }
  ...
  {
    this.jdField_a_of_type_Ahgk.a(paramChatMessage, this).a(paramView, paramChatMessage, paramInt);
  }
  ...
  public void a(ChatMessage paramChatMessage, int paramInt)
  {
    ...
    if (i >= 0)
    {
      ...
      localChatMessage = (ChatMessage)localView.getTag(2131364436);
  ...
  public void a(List<ChatMessage> paramList)
  {
    ...
    if (paramList.size() > 0)
    {
      ...
      for (;;)
      {
        if ((bcsa.a(localChatMessage1.msgtype)) || (adak.j(localChatMessage1.msgtype)))
        {
          i += 1;
          ...
          else
          {
            ...
            if (paramList.size() - k >= 0)
            {
              ...
              {
                if (!bcsa.a(localChatMessage3.msgtype))
                {
                  localChatMessage2 = localChatMessage3;
                  localChatMessage4 = localChatMessage1;
                  i = j;
                  if (!adak.j(localChatMessage3.msgtype)) {
                    break label216;
                  }
                }
                k += 1;
  ...
  public void a(List<ChatMessage> paramList, CharSequence paramCharSequence, int paramInt)
  {
    ...
    paramCharSequence = (anyw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 3000) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) || ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0) && (paramCharSequence != null) && (paramCharSequence.b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)))) {
      ((ascj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(214)).a(paramList, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, paramInt);
    }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_Aggt.a != null)
    {
      amcl localamcl = this.jdField_a_of_type_Aggt.a.a();
      if ((localamcl == null) || (!localamcl.c())) {
        break label41;
      }
      localamcl.d();
    }
    label41:
    while (!this.jdField_a_of_type_Aggt.a.a()) {
      return;
    }
    this.jdField_a_of_type_Aggt.a.a();
  }
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return ahgk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage);
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      bhsq.a(null, "AIO_ChatAdapter_getView" + " | " + localChatMessage.getClass().getName());
      Object localObject2 = this.jdField_a_of_type_Ahgk.a(localChatMessage, this);
      if (paramInt != 0)
      {
      ...
      localObject1 = ((aghc)localObject2).a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage, paramView, paramViewGroup, this.jdField_a_of_type_Aggt);
      if (localObject1 != null)
      {
        ((View)localObject1).setTag(2131364436, localChatMessage);
        if (((localObject2 instanceof agem)) && ((localObject1 instanceof akkq))) {
          localObject2 = (akkq)localObject1;
        }
      }
      bhsq.a("AIO_ChatAdapter_getView" + " | " + localChatMessage.getClass().getName(), null);
    }
  }
