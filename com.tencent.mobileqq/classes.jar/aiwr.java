...
{
  public aiwr(TroopAvatarWallPreviewActivity paramTroopAvatarWallPreviewActivity) {}
  ...
  public void a(boolean paramBoolean, String paramString, long paramLong1, long paramLong2)
  {
    ...
    if (paramBoolean) {}
    for (paramString = this.a.getResources().getString(2131433073);; paramString = this.a.getResources().getString(2131434591))
    {
