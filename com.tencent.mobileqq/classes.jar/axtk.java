...
public class axtk
{
  ...
  public axtk(AppInterface paramAppInterface, axtm paramaxtm, String paramString, byte[] paramArrayOfByte, int paramInt, boolean paramBoolean)
  {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean) {
      awrn.a(BaseApplication.getContext()).a(null, "QIMWebVideoUploader", true, l, 0L, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
    while (QLog.isColorLevel())
    {
      ...
      awrn.a(BaseApplication.getContext()).a(null, "QIMWebVideoUploader", false, l, 0L, this.jdField_a_of_type_JavaUtilHashMap, "");
    }
  }
    ...
    if (this.jdField_a_of_type_JavaIoRandomAccessFile == null) {
      try
      {
        ...
        if (this.jdField_a_of_type_JavaIoRandomAccessFile == null)
        {
          ...
          this.jdField_a_of_type_Axtm.a(this.jdField_b_of_type_Int, this.e);
          a(false);
          return false;
        }
      }
