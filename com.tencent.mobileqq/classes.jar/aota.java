...
public class aota
  extends aouc
{
  public aota(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          wyt.a(localObject2[1], (HashMap)localObject1);
          localObject1 = amme.b((String)((HashMap)localObject1).get("tab"), true);
          i = 0;
          j = 0;
          continue;
        }
