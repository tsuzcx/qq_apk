...
public class aies
  extends ailn
  implements agyg, View.OnClickListener, View.OnLongClickListener, asko
{
  private static final aiex jdField_a_of_type_Aiex = new aiex(null);
  private final int jdField_a_of_type_Int;
  aifa jdField_a_of_type_Aifa = null;
  private final Context jdField_a_of_type_AndroidContentContext;
  private final SparseArray<ArrayList<auko>> jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
  ...
  private final View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new aieu(this);
  ...
  public aies(Context paramContext, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView, View.OnClickListener paramOnClickListener, boolean paramBoolean)
  {
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      if (this.jdField_a_of_type_Aifa == null) {
        this.jdField_a_of_type_Aifa = new aifa(this, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      paramViewGroup.jdField_a_of_type_JavaLangString = ((TroopMemberInfo)localObject2).memberuin;
      localObject1 = bbcz.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((TroopMemberInfo)localObject2).troopuin, ((TroopMemberInfo)localObject2).memberuin);
      a(paramViewGroup, this.jdField_a_of_type_Aifa.a((TroopMemberInfo)localObject2));
      label234:
    ...
    for (;;)
    {
      if ((AppSetting.jdField_d_of_type_Boolean) && (paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        ...
        paramView.setContentDescription((String)localObject1 + ajya.a(2131713756));
      }
      return paramView;
      ...
      localObject1 = bbcz.a((Friends)localObject2);
    ...
    label502:
    paramView.setContentDescription((String)localObject1 + ajya.a(2131713733));
    return paramView;
  }
  
  private void a(List<aiev> paramList)
  {
    try
    {
      Collections.sort(paramList, jdField_a_of_type_Aiex);
      return;
    }
  ...
  private View b(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      if ((AppSetting.jdField_d_of_type_Boolean) && (paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox.isEnabled()))
      {
        ...
        paramView.setContentDescription(localPhoneContact.name + ajya.a(2131713748));
      }
      return paramView;
      paramViewGroup = (aiez)paramView.getTag();
      paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
  ...
  private View c(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (PublicAccountInfo.isLooker(localPublicAccountInfo))
      {
        ...
        return paramView;
        paramViewGroup = (aiey)paramView.getTag();
        paramViewGroup.d.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
      }
      else
      {
  ...
  private void c()
  {
    ...
    for (;;)
    {
      Object localObject2 = agya.a(this, bool, 0, 0);
      Object localObject3 = ((HashMap)localObject2).get(agya.jdField_a_of_type_JavaLangString);
      Object localObject1 = null;
      if (localObject3 != null) {
        localObject1 = (ArrayList)localObject3;
      }
      localObject2 = ((HashMap)localObject2).get(agya.b);
      ...
      if (localObject1 != null)
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          if (localObject4 != null) {
            try
            {
              ...
              {
                localObject4 = ((ajxl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(((PfaFriend)localObject4).uin);
        ...
        if (!((ArrayList)localObject2).isEmpty())
        {
          ...
          ((Groups)localObject1).group_name = this.jdField_a_of_type_AndroidContentContext.getString(2131692765);
  ...
  private void f()
  {
    ...
    ((Groups)localObject).group_name = this.jdField_a_of_type_AndroidContentContext.getString(2131695029);
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_Azlq.a(this.jdField_b_of_type_JavaUtilArrayList, this.jdField_a_of_type_AndroidUtilSparseArray);
      ...
      if (((Iterator)localObject3).hasNext())
      {
        ...
        for (localObject2 = new ArrayList();; localObject2 = new ArrayList((Collection)localObject2))
        {
          ...
          while (((Iterator)localObject5).hasNext()) {
            ((ArrayList)localObject4).add(new aiev((Friends)((Iterator)localObject5).next(), -1));
          }
          d();
          break;
        ...
        while (((Iterator)localObject4).hasNext()) {
          ((List)localObject2).add(((aiev)((Iterator)localObject4).next()).a);
        }
  ...
  {
    aiew localaiew = (aiew)paramView.getTag();
    if (localaiew == null)
    {
      localaiew = new aiew();
      paramView.findViewById(2131368567).setVisibility(0);
      localaiew.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131367211));
      paramView.setTag(localaiew);
    }
    for (;;)
    {
      Groups localGroups = (Groups)getGroup(paramInt);
      localaiew.jdField_a_of_type_AndroidWidgetTextView.setText(localGroups.group_name);
      if (this.jdField_b_of_type_ComTencentWidgetExpandableListView != null) {
  ...
  public void a(azlq paramazlq)
  {
    this.jdField_a_of_type_Azlq = paramazlq;
  }
  
  public void a(ArrayList<auko> paramArrayList)
  {
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.jdField_d_of_type_Int == 33) {
      agya.a(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.app);
    }
    if (this.jdField_a_of_type_Aifa != null)
    {
      this.jdField_a_of_type_Aifa.a();
      this.jdField_a_of_type_Aifa = null;
    }
  ...
  public long getChildId(int paramInt1, int paramInt2)
  {
    ...
    return this.jdField_a_of_type_Azlq.a(localRelationTroopEntity.troopInfo.troopuin).longValue();
  }
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      else if (a(paramInt1, paramInt2) == 2)
      {
        ...
        paramView = this.jdField_a_of_type_Azlq.b(paramInt1, paramInt2, paramView, paramViewGroup, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity, this.jdField_a_of_type_AndroidViewView$OnClickListener, localRelationTroopEntity);
      }
      else
      {
  ...
  public View getGroupView(int paramInt, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView != null)
    {
      localObject = (aiew)paramView.getTag();
      ...
      if (AppSetting.jdField_d_of_type_Boolean)
      {
        ...
        paramViewGroup.setContentDescription(((Groups)localObject).group_name + ajya.a(2131713752));
      }
    }
    for (;;)
    {
      ...
      break;
      label153:
      paramViewGroup.setContentDescription(((Groups)localObject).group_name + ajya.a(2131713743));
    }
  }
  ...
  {
    paramView = (aiew)paramView.getTag();
    ...
    try
    {
      ...
      if (paramView.group_id == 1003)
      {
        ...
        {
          axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005442", "0X8005442", 1, 0, "", "", "", "");
          return;
        }
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005442", "0X8005442", 2, 0, "", "", "", "");
        return;
      }
      if (paramView.group_id == 1002)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.jdField_b_of_type_Int == 0)
        {
          axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005444", "0X8005444", 1, 0, "", "", "", "");
          return;
        }
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005444", "0X8005444", 2, 0, "", "", "", "");
        return;
      }
      if (paramView.group_id == 0)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.jdField_b_of_type_Int == 0)
        {
          axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005443", "0X8005443", 1, 0, "", "", "", "");
          return;
        }
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005443", "0X8005443", 2, 0, "", "", "", "");
        return;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.jdField_b_of_type_Int == 0)
      {
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005445", "0X8005445", 1, 0, "", "", "", "");
        return;
      }
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005445", "0X8005445", 2, 0, "", "", "", "");
      return;
    }
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    bbcq.a(paramView, localbbmf, this.jdField_b_of_type_AndroidViewView$OnClickListener, new aiet(this));
    return true;
  }
