...
public class amyu
  extends amza
{
  public amyu(QQAppInterface paramQQAppInterface)
  {
    super("android.qq.apollo.jsc800", paramQQAppInterface);
  }
  ...
  public static void a()
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      if (localObject != null)
      {
        localObject = (amyu)((amyp)localObject).a("android.qq.apollo.jsc800");
        if (localObject != null)
        {
          ((amyu)localObject).a(true);
  ...
  public void a(String paramString)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1)
    {
      ...
      if (new File(paramString).exists())
      {
        ...
        if (i != 0)
        {
          aixo.a(10, 201, 1001, new Object[] { "unzip jsc lib failed" });
          ajam.a = true;
        }
      }
    }
    for (;;)
    {
      ...
      label189:
      if (i != 0) {
        aixo.a(10, 201, 0, new Object[] { "libjsc so download success" });
      }
      ajam.a("after_JSC_downloaded");
    }
  }
