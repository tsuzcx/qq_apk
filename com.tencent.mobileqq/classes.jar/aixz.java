...
public class aixz
{
  ...
  private static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    ...
    localMessageForText.msg = String.format(anni.a(2131700759), new Object[] { paramString1, paramString3, paramString2 });
    localMessageForText.time = bbyp.a();
  ...
  private static void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    ...
    Object localObject1 = anni.a(2131700762);
    String str1 = String.format("%s(%s)", new Object[] { paramString2, paramString1 });
    Object localObject2 = anni.a(2131700760);
    if (paramInt == 1) {}
    for (paramString2 = anni.a(2131700754);; paramString2 = anni.a(2131700757))
    {
      ...
      paramString2 = anni.a(2131700758);
      paramString4 = anni.a(2131700755);
      localObject2 = new auxc(paramString3, paramString3, (String)localObject1 + str1 + str2 + str3 + "的好友列表中。\n不想和他们是好友关系，可选择" + paramString2 + "。\n不想再被其他好友克隆，可选择" + paramString4 + "。", 0, -5040, 2686977, bbyp.a());
      ...
      ((auxc)localObject2).a(paramInt, str1.length() + paramInt, localBundle);
      ...
      ((auxc)localObject2).a(paramInt, str3.length() + paramInt, (Bundle)localObject1);
      paramString3 = new Bundle();
      paramString3.putInt("key_action", 45);
      paramString3.putString("key_action_DATA", paramString1);
      paramString3.putString("key_a_action_DATA", String.format(anni.a(2131700761), new Object[] { str1, str3 }));
      paramInt = paramInt + str3.length() + "的好友列表中。\n不想和他们是好友关系，可选择".length();
      ((auxc)localObject2).a(paramInt, paramString2.length() + paramInt, paramString3);
      ...
      ((auxc)localObject2).a(paramInt, paramString4.length() + paramInt, paramString1);
      localMessageForUniteGrayTip.initGrayTipMsg(paramQQAppInterface, (auxc)localObject2);
  ...
  {
    MessageForUniteGrayTip localMessageForUniteGrayTip = new MessageForUniteGrayTip();
    localMessageForUniteGrayTip.initGrayTipMsg(paramQQAppInterface, new auxc(paramString, paramString, anni.a(2131700756), 0, -5020, 2686977, bbyp.a()));
    auxd.a(paramQQAppInterface, localMessageForUniteGrayTip);
  }
}
