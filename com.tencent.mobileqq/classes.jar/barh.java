...
public class barh
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, Bitmap paramBitmap, int paramInt2, bari parambari)
  {
    a();
    new barj(paramQQAppInterface, paramString, paramInt1, paramBitmap, paramInt2, parambari).execute(new Void[0]);
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageForScribble paramMessageForScribble)
  {
    ...
    do
    {
      ...
      localbard = new bard(paramQQAppInterface);
      localMessageForScribble = localbard.a(paramMessageForScribble);
  ...
  public static int b(MessageForScribble paramMessageForScribble)
  {
    ...
    if (barq.a(str1, paramMessageForScribble.offSet, str2)) {
      return d;
    }
    return e;
  }
