  ...
  extends aphs
{
  ...
  public apiq(String paramString1, int paramInt1, int paramInt2, int paramInt3, aprm paramaprm, aplk paramaplk, String paramString2, long paramLong, boolean paramBoolean, int paramInt4, int paramInt5, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    this.e = paramInt4;
    this.jdField_a_of_type_Aprm = paramaprm;
  ...
  public String toString()
  {
    ...
    localStringBuilder.append(", mKeyingParams='").append(this.jdField_a_of_type_Aprm).append('\'');
