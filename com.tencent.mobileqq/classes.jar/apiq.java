...
public class apiq
  extends apih
{
  private static apir jdField_a_of_type_Apir;
  public static final ArrayList<WeakReference<apiq>> a;
  private static String e = "";
  protected SongInfo a;
  private WeakReference<apiq> jdField_a_of_type_JavaLangRefWeakReference;
  protected long b = 0L;
  protected String d;
  ...
  public apiq(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    jdField_a_of_type_Apir = new apir(this.jdField_a_of_type_JavaLangString);
  ...
  {
    QQPlayerService.c(jdField_a_of_type_Apir);
  ...
  public boolean Invoke(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    if (paramString.equals("SetCallback"))
    {
      ...
      QQPlayerService.b(jdField_a_of_type_Apir);
      QQPlayerService.a(null);
      return true;
    }
  ...
  public void a(int paramInt)
  {
    ...
    {
      return;
      ark.VariantWrapper localVariantWrapper = b(this.b);
