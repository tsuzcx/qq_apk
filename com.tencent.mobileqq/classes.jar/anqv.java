  ...
  extends anii
{
  ...
  public anqv(AppInterface paramAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, int paramInt, BusinessObserver paramBusinessObserver)
  {
    ...
    try
    {
      ...
      if ("1".equals(paramString2))
      {
        ...
        if (arrayOfByte != null) {
          localJSONObject.put("chat_sig", new String(bgku.encode(arrayOfByte, 0)));
        }
      }
      ...
      for (;;)
      {
        ...
        paramString1 = new NewIntent(paramQQAppInterface.getApplication().getApplicationContext(), niq.class);
  ...
  public static void a(NearbyAppInterface paramNearbyAppInterface, long[] paramArrayOfLong, BusinessObserver paramBusinessObserver)
  {
    ...
    try
    {
      ...
      paramArrayOfLong = new NewIntent(paramNearbyAppInterface.getApplication().getApplicationContext(), niq.class);
  ...
  private void a(Oidb_0x66b.RspBody paramRspBody, NearbyMyTabCard paramNearbyMyTabCard)
  {
    ...
    for (;;)
    {
      aybu.a(this.a, paramNearbyMyTabCard);
    ...
    try
    {
      ...
      if ((paramRspBody1.rpt_msg_uin_data.has()) && (paramRspBody1.rpt_msg_uin_data.size() > 0))
      {
        ...
        if ((paramNearbyMyTabCard.gender == 1) || (paramNearbyMyTabCard.gender == 2)) {
          axdz.a(paramNearbyMyTabCard.uin + "", "self_gender", Integer.valueOf(paramNearbyMyTabCard.gender));
        }
  ...
  private boolean a(oidb_0xada.ReqBody paramReqBody)
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty((CharSequence)localObject)))
    {
      ...
      paramReqBody.version_code.set(ardl.a(BaseApplicationImpl.sApplication));
    ...
    if (paramRspBody.stConfigList.has())
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        else
        {
          ...
          localNearbyMyTabConfig.extraVal = ((NearbyMyTabCard.NearbyMyTabConfigExtraVal)aybu.a.get(Integer.valueOf(localNearbyMyTabConfig.configId)));
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      paramObject = axdz.a("nearby_visitor_file", this.a.getAccount(), 0).edit();
      if (l1 > 0L)
      {
  ...
  cmd0x77f.VisitProfRec a(axdy paramaxdy)
  {
    cmd0x77f.VisitProfRec localVisitProfRec = new cmd0x77f.VisitProfRec();
    localVisitProfRec.uint64_tinyid.set(paramaxdy.jdField_a_of_type_Long);
    localVisitProfRec.uint32_seq.set(paramaxdy.jdField_a_of_type_Int);
    if (paramaxdy.c > 0) {
      localVisitProfRec.uint32_enter_count.set(paramaxdy.c);
    }
    if (paramaxdy.d > 0) {
      localVisitProfRec.uint32_visit_duration.set(paramaxdy.d);
    }
    if (paramaxdy.e > 0) {
      localVisitProfRec.uint32_visit_pic_count.set(paramaxdy.e);
    }
    if (paramaxdy.f > 0) {
      localVisitProfRec.uint32_opflag.set(paramaxdy.f);
    }
    if (QLog.isColorLevel()) {
      QLog.d("NearbyHandler", 2, "convert2VisitRec ,record =" + paramaxdy);
    }
  ...
  public void a(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg, Object paramObject)
  {
    ...
    if (i == 0)
    {
      ...
      if (paramToServiceMsg.msg_self_info.has())
      {
        ...
        ((aqlc)this.a.getManager(210)).a(this.a, paramObject);
        if (QLog.isColorLevel()) {
  ...
  public void a(String paramString)
  {
    ...
    localQueryRecommendReq.uint32_client_version.set(ardl.a(BaseApplicationImpl.sApplication));
    SosoInterface.SosoLbsInfo localSosoLbsInfo = aoor.a("LBSService.Point");
  ...
  public void a(List<axdy> paramList, boolean paramBoolean)
  {
    int j = 0;
    ...
    if (k <= 200)
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        ((cmd0x77f.ReqBody)localObject1).uint32_list_ruleid.set(((axdy)paramList.get(0)).b);
        i = j;
        while (i < k)
        {
          localObject2 = a((axdy)paramList.get(i));
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (paramFromServiceMsg = "0";; paramFromServiceMsg = "-1")
    {
      ...
      paramObject.put("param_NetType", String.valueOf(bgnt.a(BaseApplication.getContext())));
      paramObject.put("param_DeviceType", String.valueOf(akgm.a()));
      long l = paramToServiceMsg.extraData.getLong("request_start_time");
      l = SystemClock.uptimeMillis() - l;
      bctj.a(BaseApplicationImpl.getContext()).a(getCurrentAccountUin(), "actGetNearbyMyTab", bool, l, 0L, paramObject, "");
      if (QLog.isColorLevel()) {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      do
      {
        ...
        {
          anqr.c(this, 10, paramToServiceMsg, paramFromServiceMsg, paramObject);
          return;
        }
        if ("OidbSvc.0x686".equals(str))
        {
          anqr.b(this, 8, paramToServiceMsg, paramFromServiceMsg, paramObject);
          return;
        }
