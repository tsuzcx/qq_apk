...
public class ogq
  implements Runnable
{
  public ogq(VideoSharer paramVideoSharer, int paramInt) {}
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_Int == 0)
    {
      ...
      if (i != 0) {
        this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDancemachineVideoSharer.a.runOnUiThread(new ogr(this, i));
      }
    }
    Bitmap localBitmap;
    do
        ...
        else
        {
          ...
          catch (OutOfMemoryError localOutOfMemoryError)
          {
            ...
            if (VideoSharer.a(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDancemachineVideoSharer) == null) {
              VideoSharer.a(this.jdField_a_of_type_ComTencentBizQqstoryTakevideoDancemachineVideoSharer, new ogs(this, localBitmap));
            }
