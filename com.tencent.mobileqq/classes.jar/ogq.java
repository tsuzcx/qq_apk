  ...
  extends pmn
{
  ...
  private void d(List<Long> paramList)
  {
    ...
    for (int i = 5;; i = paramList.size())
    {
      ...
      while (j < i)
      {
        ...
        ArticleInfo localArticleInfo = pmh.a().a(ogp.a(this.a), l);
        if ((localArticleInfo != null) && (!pha.a(localArticleInfo))) {
  ...
  {
    if (paramInt != ogp.a(this.a)) {
      return;
    }
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      ogp.a(this.a, pmh.a().a(Integer.valueOf(ogp.a(this.a)), paramList), 1);
      Object localObject1 = (Long)paramList.get(0);
      Object localObject2 = pmh.a().a(ogp.a(this.a), ((Long)localObject1).longValue());
      ...
      for (localObject1 = Long.valueOf(((ArticleInfo)localObject2).mArticleID);; localObject1 = "-1")
      {
        ...
        QLog.d("ReadInJoyChannelWaterFallViewController_" + ogp.a(this.a), 1, (String)localObject1);
      ...
      QLog.d("ReadInJoyChannelWaterFallViewController_" + ogp.a(this.a), 1, ((StringBuilder)localObject1).toString());
    }
    label326:
  ...
  public void a(int paramInt, boolean paramBoolean, List<ChannelCoverInfo> paramList)
  {
    ...
    if ((paramInt == ogp.a(this.a)) && (paramBoolean) && (paramList != null) && (!paramList.isEmpty())) {
    ...
    for (;;)
    {
      ...
      if ((paramList != null) && (paramList.size() >= 5))
      {
        ...
        while (i < 5)
        {
          ...
          Object localObject = pmh.a().a(ogp.a(this.a), l);
          if ((localObject != null) && (!pha.a(((BaseArticleInfo)localObject).mArticleContentUrl, ((BaseArticleInfo)localObject).mChannelID, (ArticleInfo)localObject)) && (!pha.a((BaseArticleInfo)localObject)) && (!pmh.a().a(((BaseArticleInfo)localObject).mArticleID)))
          {
  ...
  public void a(boolean paramBoolean1, int paramInt, List<Long> paramList, boolean paramBoolean2)
  {
    ...
    if (paramBoolean1) {
      if ((paramList != null) && (paramInt > 0) && (paramList.size() > 0))
      {
        if (QLog.isColorLevel())
        {
          ...
          QLog.d("ReadInJoyChannelWaterFallViewController_" + ogp.a(this.a), 1, ((StringBuilder)localObject).toString());
        }
        ogp.a(this.a, pmh.a().a(Integer.valueOf(ogp.a(this.a)), paramList), 1);
        localObject = String.format(this.a.a().getResources().getString(2131716884), new Object[] { Integer.valueOf(paramInt) });
    ...
    for (;;)
    {
      ...
      {
        this.a.a.b(true);
        c(this.a.a().getResources().getString(2131717128));
      }
      else
      {
        localObject = this.a.a().getResources().getString(2131716883);
        this.a.a.a(true, (String)localObject);
        continue;
        if (this.a.a.a()) {
          c(this.a.a().getResources().getString(2131717087));
        }
  ...
  {
    if ((paramInt != ogp.a(this.a)) || (paramList == null)) {
      return;
    }
    paramList = pmh.a().a(Integer.valueOf(ogp.a(this.a)), paramList);
  ...
  public void b(boolean paramBoolean1, int paramInt, List<Long> paramList, boolean paramBoolean2)
  {
    ...
    if ((paramBoolean1) && (paramList != null)) {
      ogp.a(this.a, pmh.a().a(Integer.valueOf(ogp.a(this.a)), paramList), 2);
    }
    ppt localppt;
    if ((paramBoolean1) && (paramList == null))
    {
    ...
    for (;;)
    {
      localppt.a(paramBoolean1, bool);
      if ((paramList != null) && (!paramList.isEmpty())) {
        ogp.a(this.a, NetConnInfoCenter.getServerTime());
      }
      if (QLog.isColorLevel()) {
        QLog.d("ReadInJoyChannelWaterFallViewController", 2, "autoLoad:" + ogp.b(this.a) + " noMoreData:" + paramBoolean2 + " fore:" + GesturePWDUtils.isAppOnForeground(this.a.a()));
      }
      if ((!ogp.b(this.a)) && (paramBoolean2) && (GesturePWDUtils.isAppOnForeground(this.a.a())) && (ogp.a(this.a) != 70))
      {
        paramList = this.a.a().getResources().getString(2131716883);
    ...
    do
    {
      ...
      if (paramList.size() > 0)
      {
        if (QLog.isColorLevel())
        {
          ...
          QLog.d("ReadInJoyChannelWaterFallViewController_" + ogp.a(this.a), 1, localStringBuilder.toString());
        }
        ogp.a(this.a, pmh.a().a(Integer.valueOf(ogp.a(this.a)), paramList), 1);
        return;
      }
