...
public class azrn
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bbvj.a(ajsd.aW + ".troop/enter_effects/");
  }
  
  public azrn(QQAppInterface paramQQAppInterface, RelativeLayout paramRelativeLayout)
  {
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
    this.jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
    this.jdField_a_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker = new azrv(this);
  ...
  public static Bitmap a(String paramString, azrw paramazrw)
  {
    Bitmap localBitmap = null;
    if (paramazrw.c == 2) {
      paramString = paramString + "/yearsvip/yearsvip_s" + paramazrw.b + ".png";
    }
    for (;;)
    {
      try
      {
        localBitmap = bbef.a(paramString, null);
        return localBitmap;
      }
      catch (OutOfMemoryError paramString)
      {
        try
        {
          paramString = bbef.a(paramString, null);
          return paramString;
        }
        catch (OutOfMemoryError paramString) {}
      ...
      if (paramazrw.c == 1) {
        paramString = paramString + "/svip/svip_s" + paramazrw.b + ".png";
      }
    }
    return null;
  }
  ...
  private azrl a()
  {
    ...
    azry localazry = (azry)((QQAppInterface)localObject).getManager(231);
    boolean bool = localazry.a();
    if (QLog.isColorLevel()) {
      QLog.d("TroopEnterEffect.Controller", 2, "getGrayTips isShowEnterEffectEveryTime = " + false + " hasShowToday = " + bool);
    }
    if (!bool)
    {
      azrh localazrh = localazry.a();
      if (localazrh.a.size() > 0)
      {
        int k = bblj.a((QQAppInterface)localObject, ((QQAppInterface)localObject).c());
        int i;
        int j;
        if (localazry.b(this.b))
        {
          i = 2;
          j = 0;
        }
        for (;;)
        {
          if (j >= localazrh.a.size()) {
            break label259;
          }
          localObject = (azrl)localazrh.a.get(j);
          bool = localazry.a().getBoolean("gray_tips_no_longer_" + ((azrl)localObject).jdField_a_of_type_Int, false);
          if (QLog.isColorLevel()) {
            QLog.d("TroopEnterEffect.Controller", 2, "getGrayTips id = " + ((azrl)localObject).jdField_a_of_type_Int + " nolongerShow = " + bool);
          }
          if ((!bool) && (((azrl)localObject).a(i, k)))
          {
            return localObject;
            i = 1;
            break;
  ...
  public void a()
  {
    ...
    do
    {
      do
      {
        ...
        return;
        localazry = (azry)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(231);
      } while (localazry == null);
      localazrw = localazry.a(this.b);
    } while ((localazrw == null) || (!a(localazrw)));
    if (System.currentTimeMillis() - localazrw.jdField_a_of_type_Long < 60000L)
    {
      a(localazrw);
      return;
    }
    localazry.b(localazrw);
  }
  
  public void a(azrw paramazrw)
  {
    if (QLog.isColorLevel()) {
      QLog.d("TroopEnterEffect.Controller", 2, "showAnimation: enterEffectData = " + paramazrw + " isAio = " + this.jdField_a_of_type_Boolean);
    }
    Object localObject1;
    String str;
    Object localObject2;
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView == null)
    {
      ...
      if ((TextUtils.isEmpty(str)) || (!str.equals(paramazrw.jdField_a_of_type_JavaLangString))) {
        break label434;
      }
      VasWebviewUtil.reportCommercialDrainage(str, "style", "0X8008E5F", "", 1, 0, 0, "", Integer.toString(paramazrw.jdField_a_of_type_Int), "");
      localObject2 = (azry)((QQAppInterface)localObject1).getManager(231);
      if (localObject2 != null) {
        ((azry)localObject2).b(paramazrw);
      }
      ...
      localView2 = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131377875);
      localView3 = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131372955);
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_AndroidWidgetScrollView = new azro(this, this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext());
        ...
        this.jdField_a_of_type_AndroidWidgetScrollView.addView(this.jdField_a_of_type_AndroidWidgetLinearLayout, -1, baxn.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext(), this.jdField_a_of_type_AndroidWidgetRelativeLayout.getHeight()));
      }
      ...
      this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView.setOnTouchListener(new azrp(this, str, paramazrw));
      this.jdField_a_of_type_ComTencentMobileqqSurfaceviewactionGlSpriteGLView.post(new TroopEnterEffectController.3(this, paramazrw));
      paramazrw = (azry)((QQAppInterface)localObject1).getManager(231);
      localObject1 = a();
      if (localObject1 != null) {
        paramazrw.a((azrl)localObject1, this.b);
      }
      azry.a("Grp_AIO", "action_play", new String[0]);
      return;
      label434:
      VasWebviewUtil.reportCommercialDrainage(str, "style", "0X8008E60", "", 1, 0, 0, "", Integer.toString(paramazrw.jdField_a_of_type_Int), "");
      break;
      label466:
      if ((localView2 != null) && (localView2.getVisibility() == 0)) {
        ...
        ((RelativeLayout.LayoutParams)localObject2).topMargin = baxn.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext(), 50.0F);
      }
    }
  }
  ...
  public boolean a(azrw paramazrw)
  {
    ...
    this.jdField_a_of_type_AndroidUtilSparseArray.put(i, paramazrw);
    return false;
  }
  ...
  public void d()
  {
    ...
    azry localazry = (azry)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(231);
    if (localazry != null) {
      localazry.b(this.b);
    }
  }
