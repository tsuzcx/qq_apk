    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          {
            paramTextView.setBackgroundResource(2130847015);
            paramTextView.setVisibility(0);
            paramTextView.setText(amtj.a(2131702745));
            localObject1 = paramContext.getResources().getDrawable(2130847018);
            ((Drawable)localObject1).setBounds(0, 0, 24, 16);
            paramTextView.setCompoundDrawables(null, null, (Drawable)localObject1, null);
            i = UIUtils.dip2px(paramContext, 6.0F);
            paramTextView.setPadding(i, 0, i, 0);
            paramTextView.setCompoundDrawablePadding(UIUtils.dip2px(paramContext, 2.0F));
            ...
            localObject1 = LayoutInflater.from(paramContext).inflate(2131559584, null);
            LinearLayout localLinearLayout = (LinearLayout)((View)localObject1).findViewById(2131370144);
            ...
            if (i < paramString.length())
            {
              ...
              ((LinearLayout)localObject3).setOnClickListener(new ogj(this, j, (JSONObject)localObject2, paramContext, paramMessageRecord));
              ...
              ((LinearLayout.LayoutParams)localObject4).height = UIUtils.dip2px(paramContext, 50.0F);
              ...
              ((LinearLayout.LayoutParams)localObject5).width = UIUtils.dip2px(paramContext, 20.0F);
              ((LinearLayout.LayoutParams)localObject5).height = UIUtils.dip2px(paramContext, 18.0F);
              ((LinearLayout.LayoutParams)localObject5).leftMargin = UIUtils.dip2px(paramContext, 15.0F);
              localObject5 = ((JSONObject)localObject2).optString("icon_url", "");
              if (!StringUtil.isEmpty((String)localObject5))
              {
                URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
                localURLDrawableOptions.mRequestHeight = UIUtils.dip2px(paramContext, 20.0F);
                localURLDrawableOptions.mRequestWidth = UIUtils.dip2px(paramContext, 18.0F);
              ...
              ((LinearLayout.LayoutParams)localObject3).leftMargin = UIUtils.dip2px(paramContext, 10.0F);
              ...
              ((LinearLayout.LayoutParams)localObject3).height = UIUtils.dip2px(paramContext, 1.0F);
        ...
        catch (JSONException paramString)
        {
          ...
          paramTextView.setOnClickListener(new ogk(this, paramContext, paramTextView, paramMessageRecord));
          return true;
        }
        return false;
      }
