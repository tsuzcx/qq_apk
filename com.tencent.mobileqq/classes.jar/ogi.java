...
public class ogi
{
  ...
  {
    long l = ((Long)bhvy.a("family_comment_card_hide_timestamp", Long.valueOf(-1L))).longValue();
    if (l == -1L)
    {
  ...
  public ReadInJoyCommentListFragment a(String paramString, ogv paramogv, ogm paramogm)
  {
    ...
    try
    {
      ...
      localReadInJoyCommentListFragment.a(paramogv);
      localReadInJoyCommentListFragment.a(paramogm);
