  ...
  extends xop
{
  ...
  private axbn jdField_a_of_type_Axbn;
  private final AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  
  public axay(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_Axbn = new axbn(paramAppInterface);
  }
  ...
  private boolean e(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (bool)
    {
      ...
      while (paramToServiceMsg.hasNext())
      {
        ...
        localObject = (axaw)((Map.Entry)localObject).getValue();
        if ((((axaw)localObject).a() & i) != 0)
        {
          localObject = ((axaw)localObject).a(i);
          if (localObject != null)
          {
            if (QLog.isColorLevel()) {
    ...
    paramToServiceMsg = (axaw)((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface).a.a().get(Integer.valueOf(101));
  ...
  private boolean o(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (int m = 1;; m = 0)
    {
      ...
      if (localObject != null)
      {
        ...
        bbmj.a(arrayOfByte, 0, (short)20002);
        bbmj.a(arrayOfByte, 2, s);
        bbmj.a(arrayOfByte, 4, (byte[])localObject, localObject.length);
        j = s + 4;
      }
      i = j;
      if (localInteger != null)
      {
        bbmj.a(arrayOfByte, j, (short)20031);
        i = j + 2;
        bbmj.a(arrayOfByte, i, (short)4);
        i += 2;
        bbmj.a(arrayOfByte, i, localInteger.intValue());
        i += 4;
      }
      j = i;
      if (localByte != null)
      {
        bbmj.a(arrayOfByte, i, (short)20009);
        i += 2;
        bbmj.a(arrayOfByte, i, (short)1);
        i += 2;
      ...
      {
        bbmj.a(arrayOfByte, j, (short)20032);
        i = j + 2;
        bbmj.a(arrayOfByte, i, (short)12);
        i += 2;
        bbmj.a(arrayOfByte, i, arrayOfInteger[0].intValue());
        i += 4;
        bbmj.a(arrayOfByte, i, arrayOfInteger[1].intValue());
        i += 4;
        bbmj.a(arrayOfByte, i, arrayOfInteger[2].intValue());
      }
  ...
  private boolean r(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    ajxn localajxn = (ajxn)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(51);
  ...
  public boolean b(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    return this.jdField_a_of_type_Axbn.a(paramToServiceMsg, paramUniPacket);
  }
}
