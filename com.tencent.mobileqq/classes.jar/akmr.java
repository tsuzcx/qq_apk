...
@TargetApi(11)
public class akmr
  implements aklr, akwz, SurfaceTexture.OnFrameAvailableListener, TVK_IMediaPlayer.OnCompletionListener, TVK_IMediaPlayer.OnDownloadCallbackListener, TVK_IMediaPlayer.OnErrorListener, TVK_IMediaPlayer.OnInfoListener, TVK_IMediaPlayer.OnVideoPreparedListener
{
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long = -1L;
  private aklt jdField_a_of_type_Aklt;
  private akmt jdField_a_of_type_Akmt;
  private akvs jdField_a_of_type_Akvs;
  private akvt jdField_a_of_type_Akvt = new akms(this);
  private akvv jdField_a_of_type_Akvv;
  ...
  private akvs jdField_b_of_type_Akvs;
  ...
  public akmr(aklt paramaklt, akmt paramakmt)
  {
    this.jdField_a_of_type_ArrayOfFloat = new float[16];
    this.jdField_a_of_type_Aklt = paramaklt;
    this.jdField_a_of_type_Akmt = paramakmt;
    this.jdField_e_of_type_Int = paramakmt.jdField_e_of_type_Int;
    this.jdField_d_of_type_Int = paramakmt.jdField_d_of_type_Int;
    this.jdField_a_of_type_Akvv = paramakmt.jdField_a_of_type_Akvv;
    this.jdField_a_of_type_JavaLangString = paramakmt.jdField_b_of_type_JavaLangString;
    this.jdField_a_of_type_Long = paramakmt.jdField_b_of_type_Long;
    boolean bool2 = akmz.a();
    if ((bool2) || (this.jdField_a_of_type_Akmt.jdField_a_of_type_Boolean)) {
      bool1 = true;
    }
    this.k = bool1;
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_OnlineVideoARRenderable", 2, "Construction mSoftwarePlayConfig:" + this.k + "  isRubbishDevice:" + bool2 + "  isSoftPlay:" + this.jdField_a_of_type_Akmt.jdField_a_of_type_Boolean);
    }
  }
  ...
  {
    a((float[])paramaklz.a("TARGET_SIZE"), (float[])paramaklz.a("POSE"), (float[])paramaklz.a("CAMERA_MATRIX"), (float[])paramaklz.a("CAMERA_POSITION"));
  }
  
  public void a(boolean paramBoolean)
  {
    if (paramBoolean) {
      if (this.jdField_b_of_type_Akvs == null)
      {
        this.jdField_b_of_type_Akvs = akvu.a(this.jdField_a_of_type_Akvv, 3);
        this.jdField_b_of_type_Akvs.a(akmz.jdField_b_of_type_ArrayOfFloat, akmz.jdField_a_of_type_ArrayOfShort);
        this.jdField_b_of_type_Akvs.a("uniform int uDisplayType;\n", null, "    if(uDisplayType == 1){\n        // 需要渲染成圆形\n        float x = vTextureCoord.x;\n        float y = vTextureCoord.y;\n        // 圆心(0.5, 0.5), 0.25=0.5*0.5\n        if(pow(abs(x-0.5), 2.0) + pow(abs(y-0.5), 2.0) >= 0.25) {\n            gl_FragColor[3] = 0.0;\n        }\n    }\n", this.jdField_a_of_type_Akvt);
        this.jdField_b_of_type_Akvs.a(this.jdField_a_of_type_Akmt.jdField_c_of_type_Int, this.jdField_a_of_type_Akmt.jdField_a_of_type_Float, this.jdField_a_of_type_Akmt.jdField_b_of_type_Float, this.jdField_a_of_type_Akmt.jdField_c_of_type_Float);
      }
    }
    while (this.jdField_a_of_type_Akvs != null) {
      return;
    }
    this.jdField_a_of_type_Akvs = akvu.a(this.jdField_a_of_type_Akvv, 1);
    this.jdField_a_of_type_Akvs.a(akmz.jdField_a_of_type_ArrayOfFloat, akmz.jdField_a_of_type_ArrayOfShort);
    this.jdField_a_of_type_Akvs.a("uniform int uDisplayType;\n", null, "    if(uDisplayType == 1){\n        // 需要渲染成圆形\n        float x = vTextureCoord.x;\n        float y = vTextureCoord.y;\n        // 圆心(0.5, 0.5), 0.25=0.5*0.5\n        if(pow(abs(x-0.5), 2.0) + pow(abs(y-0.5), 2.0) >= 0.25) {\n            gl_FragColor[3] = 0.0;\n        }\n    }\n", this.jdField_a_of_type_Akvt);
    this.jdField_a_of_type_Akvs.a(this.jdField_a_of_type_Akmt.jdField_c_of_type_Int, this.jdField_a_of_type_Akmt.jdField_a_of_type_Float, this.jdField_a_of_type_Akmt.jdField_b_of_type_Float, this.jdField_a_of_type_Akmt.jdField_c_of_type_Float);
  }
  ...
  public void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Aklt.a(paramArrayOfByte1);
    } while (!this.l);
    this.l = false;
  }
  ...
  {
    if ((!this.jdField_d_of_type_Boolean) || (paramArrayOfFloat2 == null) || (this.jdField_a_of_type_Akmt == null)) {
      return;
    }
    ...
    label54:
    int m;
    if (this.jdField_a_of_type_Akmt.jdField_b_of_type_Int == 1)
    {
      ...
      if (this.jdField_a_of_type_Akvs != null)
      {
        paramArrayOfFloat2 = this.jdField_a_of_type_Akvs;
        m = this.jdField_a_of_type_Int;
        paramArrayOfFloat3 = this.jdField_a_of_type_Akvv;
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_Akvs != null)
      {
        paramArrayOfFloat2 = this.jdField_b_of_type_Akvs;
  ...
  public float[] a(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3)
  {
    ...
    if (c() == 2) {
      if (this.jdField_a_of_type_Akmt.jdField_a_of_type_Akpn != null)
      {
        Matrix.scaleM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Akmt.jdField_a_of_type_Akpn.jdField_a_of_type_Float * paramArrayOfFloat1[0], this.jdField_a_of_type_Akmt.jdField_a_of_type_Akpn.jdField_b_of_type_Float * paramArrayOfFloat1[1], 1.0F);
        Matrix.translateM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Akmt.jdField_a_of_type_Akpn.jdField_c_of_type_Float, this.jdField_a_of_type_Akmt.jdField_a_of_type_Akpn.d, this.jdField_a_of_type_Akmt.jdField_a_of_type_Akpn.e);
      }
    }
    for (;;)
    {
    ...
    if (this.jdField_a_of_type_Akmt.jdField_c_of_type_Int == 1) {}
    for (;;)
    {
  ...
  public int b()
  {
    if (this.jdField_a_of_type_Akmt != null) {
      return this.jdField_a_of_type_Akmt.jdField_a_of_type_Int;
    }
    return 4;
  }
  ...
  {
    if (this.jdField_a_of_type_Akmt != null) {
      return this.jdField_a_of_type_Akmt.jdField_b_of_type_Int;
    }
    return 0;
  }
  ...
  public String c()
  {
    return this.jdField_a_of_type_Akmt.jdField_a_of_type_JavaLangString;
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Akwy = new akwy(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture);
    this.jdField_a_of_type_Akwy.a(this);
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer = this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IProxyFactory.createMediaPlayer(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Akwy);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_OnlineVideoARRenderable", 2, "start, arResourceInfo=" + this.jdField_a_of_type_Akmt);
    }
    ...
    String str2 = akwx.a(this.jdField_a_of_type_JavaLangString);
    ...
    for (String str1 = "true";; str1 = "false")
    {
      ...
      localTVK_PlayerVideoInfo.setVid(bcdu.d(this.jdField_a_of_type_JavaLangString));
  ...
  public void f()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Akvs != null)
      {
        this.jdField_a_of_type_Akvs.b();
        this.jdField_a_of_type_Akvs = null;
      }
      if (this.jdField_b_of_type_Akvs != null)
      {
        this.jdField_b_of_type_Akvs.b();
        this.jdField_b_of_type_Akvs = null;
      }
      HashMap localHashMap = new HashMap();
      localHashMap.put("decode_type", String.valueOf(this.jdField_f_of_type_Int));
      awrn.a(BaseApplicationImpl.getContext()).a("", "immersed_ar_decode_type", true, 0L, 0L, localHashMap, "", false);
      return;
    }
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Aklt != null) {
          this.jdField_a_of_type_Aklt.a(this.jdField_a_of_type_Akmt.jdField_a_of_type_JavaLangString);
        }
      }
    }
  }
  ...
  public void onCompletion(TVK_IMediaPlayer paramTVK_IMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_Aklt != null) {
      this.jdField_a_of_type_Aklt.b(2, this.jdField_e_of_type_Int - this.jdField_c_of_type_Int);
    }
    ...
    } while (this.jdField_a_of_type_Aklt == null);
    this.jdField_a_of_type_Aklt.a(paramTVK_IMediaPlayer);
  }
  ...
  public void onFrameAvailable(SurfaceTexture paramSurfaceTexture)
  {
    ...
    this.jdField_a_of_type_Aklt.a(this.jdField_a_of_type_JavaLangRunnable);
    if (!this.j)
    {
      this.j = true;
  ...
  public void onVideoPrepared(TVK_IMediaPlayer paramTVK_IMediaPlayer)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Aklt != null)
        {
          this.jdField_a_of_type_Aklt.b(0, this.jdField_e_of_type_Int);
          return;
        }
      }
