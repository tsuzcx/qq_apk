...
public class akmr
  extends bhzs
{
  public akmr(AvatarPendantActivity paramAvatarPendantActivity) {}
  ...
  protected void handlePendantAuth(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      if (this.a.jdField_a_of_type_Bhwj != null) {
        this.a.jdField_a_of_type_Bhwj.c = -1;
      }
      bdll.b(this.a.app, "CliOper", "", "", "0X8005FD4", "0X8005FD4", 0, 0, "", "", "", "");
      if ((this.a.jdField_a_of_type_Ammy != null) && (this.a.jdField_a_of_type_JavaUtilList != null))
      {
        paramObject = ((AvatarPendantManager)this.a.app.getManager(46)).a();
        this.a.jdField_a_of_type_Ammy.a(paramObject, this.a.jdField_a_of_type_JavaUtilList);
      }
    } while ((this.a.jdField_a_of_type_Bhwi == null) || (!this.a.jdField_a_of_type_Bhwi.jdField_a_of_type_Boolean));
    localObject = bhyk.a("linkPendantSet");
    paramObject = localObject;
    if (localObject != null) {
      paramObject = ((String)localObject).replace("[id]", String.valueOf(this.a.jdField_a_of_type_Bhwi.jdField_a_of_type_Int));
    }
    ...
    bdll.b(this.a.app, "CliOper", "", "", "0X8006517", "0X8006517", 0, 0, "", "", "", "");
    return;
    this.a.jdField_a_of_type_AndroidWidgetButton.setText(2131717950);
    ...
    {
      bdll.b((QQAppInterface)localObject, "CliOper", "", "", "0X8005FD6", "0X8005FD6", 0, 0, paramObject, "", "", "");
      if (!this.a.d) {
        break;
      }
      this.a.d = false;
