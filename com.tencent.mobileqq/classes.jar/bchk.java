...
public class bchk
{
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          paramQQAppInterface = localawbw.a(TroopAIONotifyItem.class, false, "troopUin=?", new String[] { paramString }, null, null, null, null);
          localawbw.a();
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localalzf.e(Long.valueOf(paramString).longValue());
      bckr.a(paramQQAppInterface, paramString, 1102858908);
      ChatActivityUtils.a(paramQQAppInterface, paramString, Integer.valueOf(0));
      return;
    }
    ThreadManager.post(new TroopAioNotifyManager.1(paramQQAppInterface, paramString, localalzf), 8, null, true);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, List<TroopAIONotifyItem> paramList)
  {
    ...
    //   21: return
    //   22: aload_0
    //   23: invokevirtual 22	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawbx;
    //   26: invokevirtual 28	awbx:createEntityManager	()Lawbw;
    //   29: astore_0
    //   30: iconst_0
    //   31: istore_2
    //   32: iload_2
    ...
    //   45: checkcast 239	awbv
    //   48: invokevirtual 241	awbw:b	(Lawbv;)Z
    //   51: pop
    //   52: iload_2
    //   53: iconst_1
    //   54: iadd
