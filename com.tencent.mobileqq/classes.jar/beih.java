...
public class beih
{
  public static void a(Context paramContext, TextView paramTextView, int paramInt)
  {
    ...
    int i = paramContext.getResources().getDimensionPixelSize(2131165904);
    int j = paramContext.getResources().getDimensionPixelSize(2131165902);
    switch (paramInt)
    {
    case 4: 
    case 6: 
    ...
    for (;;)
    {
      ...
      return;
      i = paramContext.getResources().getDimensionPixelSize(2131165904);
      paramInt = paramContext.getResources().getDimensionPixelSize(2131165902);
      ...
      paramInt -= j;
      continue;
      i = paramContext.getResources().getDimensionPixelSize(2131165907);
      paramInt = paramContext.getResources().getDimensionPixelSize(2131165905);
      continue;
      i = paramContext.getResources().getDimensionPixelSize(2131165908);
      paramInt = paramContext.getResources().getDimensionPixelSize(2131165906);
      continue;
      k = paramContext.getResources().getDimensionPixelSize(2131165904);
      j = paramContext.getResources().getDimensionPixelSize(2131165903);
      paramTextView.measure(0, 0);
  ...
  public static void a(TextView paramTextView, int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString)
  {
    ...
    for (;;)
    {
      if ((TextUtils.isEmpty(paramString)) && (paramInt1 == 0) && (paramInt2 == 0))
      {
        ...
        paramString = "";
        paramInt1 = 2130849053;
        paramInt2 = 0;
        break;
        if (paramInt3 > 0) {}
        for (paramInt2 = paramInt3;; paramInt2 = 2130849057)
        {
          paramString = "NEW";
          paramInt1 = 0;
          break;
      ...
      Object localObject = paramTextView.getTag(2131312826);
      ...
      for (;;)
      {
        ...
        if (!azzz.a(paramTextView.getText().toString(), paramString))
        {
        ...
        paramTextView.setTag(2131312826, Integer.valueOf(paramInt1));
        paramTextView.setText(paramString);
