  ...
  implements syu
{
  ...
  private List<szh> jdField_a_of_type_JavaUtilList;
  public osn a;
  ...
  private List<szh> a()
  {
    ...
    localArrayList.add(new szh("kandian", 1, false));
    localArrayList.add(new szh("qq_friend", 2, false));
    localArrayList.add(new szh("qzone", 3, false));
    localArrayList.add(new szh("we_chat", 4, false));
    localArrayList.add(new szh("we_chat_circle", 5, false));
    localArrayList.add(new szh("we_bo", 6, false));
    localArrayList.add(new szh("qq_browser", 7, false));
    localArrayList.add(new szh("sys_browser", 8, false));
    return localArrayList;
  }
  
  private List<szh> a(JSONArray paramJSONArray)
  {
    ArrayList localArrayList = new ArrayList();
        ...
        if (i < j)
        {
          ...
          if ((localObject1 instanceof String))
          {
            ...
            if (localObject2 != null) {
              localArrayList.add(new szh((String)localObject1, ((Integer)localObject2).intValue(), false));
            }
          }
          else if ((localObject1 instanceof JSONObject))
          {
            ...
            if ((!TextUtils.isEmpty((CharSequence)localObject2)) && (this.jdField_a_of_type_JavaUtilHashMap.get(localObject2) != null))
            {
              ...
              {
                bool = true;
                localArrayList.add(new szh((String)localObject2, m, bool));
              }
            }
          }
        }
  ...
  private szh a(int paramInt)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    szh localszh;
    while (localIterator.hasNext())
    {
      localszh = (szh)localIterator.next();
      if (localszh.a == paramInt) {
        return localszh;
      }
    }
  ...
  private List<Integer>[] a()
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      localArrayList1.add(Integer.valueOf(((szh)((Iterator)localObject).next()).a));
    }
    ArrayList localArrayList2 = new ArrayList();
    localObject = this.jdField_b_of_type_JavaUtilList.iterator();
    while (((Iterator)localObject).hasNext()) {
      localArrayList2.add(Integer.valueOf(((szh)((Iterator)localObject).next()).a));
    }
    ...
    for (;;)
    {
      ...
      label152:
      localObject = this.jdField_a_of_type_Szk.c;
      break;
      label163:
  ...
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new szh("screen_shot", 9, false));
    localArrayList.add(new szh("set_font", 10, false));
    localArrayList.add(new szh("add_favourite", 12, false));
    localArrayList.add(new szh("export_tencent_docs", 28, false));
    localArrayList.add(new szh("send_pc", 13, false));
    localArrayList.add(new szh("copy_link", 14, false));
    localArrayList.add(new szh("report", 20, false));
    return localArrayList;
  }
  ...
  private void e()
  {
    Object localObject1 = Pattern.compile("(http|https)://.*.mp.qq.com.*").matcher(this.jdField_a_of_type_Szk.c);
    int i = 0;
      ...
      try
      {
        ...
        if (localJSONArray1 == null)
        {
          ...
          if (localJSONArray2 == null)
          {
            ...
            this.jdField_a_of_type_Szk = new szk(null);
            this.jdField_a_of_type_Szk.c = paramString.optString("share_url");
            this.jdField_a_of_type_Szk.jdField_b_of_type_JavaLangString = paramString.optString("desc");
            this.jdField_a_of_type_Szk.a = paramString.optString("title");
            this.jdField_a_of_type_Szk.d = paramString.optString("image_url");
            this.jdField_a_of_type_Szk.e = paramString.optString("puin");
            this.jdField_a_of_type_Szk.f = paramString.optString("nick_name");
            if (TextUtils.isEmpty(this.jdField_a_of_type_Szk.f)) {
              this.jdField_a_of_type_Szk.f = paramString.optString("sourceName");
            }
            ...
            paramString = ((PublicAccountBrowser)this.jdField_a_of_type_AndroidAppActivity).jdField_b_of_type_JavaLangString;
            if ((!((PublicAccountBrowser)this.jdField_a_of_type_AndroidAppActivity).a) || (TextUtils.isEmpty(paramString))) {
              break;
            }
