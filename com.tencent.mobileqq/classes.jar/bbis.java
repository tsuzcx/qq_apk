  ...
  extends bbgk
{
  ...
  public bbis(BaseActivity paramBaseActivity, Bundle paramBundle)
  {
  ...
  protected void a(Bundle paramBundle)
  {
    ...
    for (paramBundle = "0";; paramBundle = "1")
    {
      ...
      bcmc.a("two_comment", "exp", this.d, this.h, "", "");
      return;
    }
  }
  ...
  protected void a(String paramString)
  {
    ...
    try
    {
      ...
      paramString.setObserver(new bbit(this));
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppRuntime().startServlet(paramString);
      return;
    }
    catch (Exception paramString)
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 1, 2131696746, 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
  ...
  public void dismiss()
  {
    ...
    {
      bcmc.a("two_comment", "un", this.d, str, "", "");
