...
public class atzv
  implements Manager
{
  atzx jdField_a_of_type_Atzx = new atzw(this);
  aukp jdField_a_of_type_Aukp;
  public QQAppInterface a;
  public OcrConfig a;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  
  public atzv(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(this.jdField_a_of_type_Atzx);
  ...
  public static boolean a(String paramString, int paramInt)
  {
    ...
    {
      boolean bool2;
      if (auci.a().jdField_a_of_type_Int == 1)
      {
        bool2 = true;
        label68:
        if (QLog.isColorLevel()) {
          QLog.d("Q.ocr", 2, "isSupportOcr, uin:" + paramString + "form:" + paramInt + ",isSupport:" + bool1 + ",dpcSwitch:" + bool2 + ",sdcard:" + aubr.a);
        }
        if ((!bool1) || (!bool2) || (!aubr.a)) {
          break label218;
        }
      }
      label218:
  ...
  public aubh a(List<OCRTextSearchInfo.SougouSearchInfo> paramList)
  {
    aubh localaubh = new aubh();
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      localaubh.jdField_a_of_type_JavaUtilList = new ArrayList();
      aubf localaubf = new aubf();
      localaubf.jdField_a_of_type_Int = 2049;
      localaubf.jdField_a_of_type_JavaLangString = ajya.a(2131707825);
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        OCRTextSearchInfo.SougouSearchInfo localSougouSearchInfo = (OCRTextSearchInfo.SougouSearchInfo)paramList.next();
        aubg localaubg = new aubg();
        localaubg.jdField_a_of_type_JavaLangObject = localSougouSearchInfo;
        localaubf.jdField_a_of_type_JavaUtilList.add(localaubg);
      }
      localaubh.jdField_a_of_type_JavaUtilList.add(localaubf);
    }
    return localaubh;
  }
  ...
  {
    if (!bbfj.g(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
      ((atzt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(113)).notifyUI(3, false, new Object[] { Integer.valueOf(-2), paramString1, null });
    }
    ...
    ((atzt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(113)).a(paramString1, str, paramLong);
  }
  ...
  public void a(boolean paramBoolean, OcrConfig paramOcrConfig)
  {
    ...
    //   45: ifeq +31 -> 76
    //   48: aload_0
    //   49: getfield 26	atzv:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   52: astore_3
    //   53: aload_3
    //   54: monitorenter
    //   55: aload_0
    //   56: aload_2
    //   57: putfield 284	atzv:jdField_a_of_type_ComTencentMobileqqOcrDataOcrConfig	Lcom/tencent/mobileqq/ocr/data/OcrConfig;
    //   60: aload_0
    //   61: getfield 28	atzv:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   64: invokevirtual 64	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   67: aload_0
    //   68: getfield 284	atzv:jdField_a_of_type_ComTencentMobileqqOcrDataOcrConfig	Lcom/tencent/mobileqq/ocr/data/OcrConfig;
    //   71: invokestatic 299	atzv:a	(Ljava/lang/String;Lcom/tencent/mobileqq/ocr/data/OcrConfig;)V
    //   74: aload_3
    //   75: monitorexit
    ...
    //   80: aload_0
    //   81: iload_1
    //   82: invokespecial 346	com/tencent/mobileqq/ocr/OCRManager$3:<init>	(Latzv;Z)V
    //   85: bipush 8
    //   87: aconst_null
    //   88: iconst_0
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Atzx);
