...
public final class uhb
{
  ...
  @JvmStatic
  @NotNull
  public final List<ude> a(@NotNull JSONArray paramJSONArray, @Nullable JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject1 = (Integer)ugz.a().get(localObject2);
          if (localObject1 == null) {
            break label334;
          }
          localArrayList.add(new ude((String)localObject2, ((Integer)localObject1).intValue(), false));
          break label334;
        }
        ...
        if ((TextUtils.isEmpty((CharSequence)localObject1)) || (ugz.a().get(localObject1) == null)) {
          break label334;
        }
        ...
        localObject2 = (Integer)ugz.a().get(localObject1);
      ...
      localArrayList.add(new udw((String)localObject1, j, bool, (String)localObject2));
      break label334;
      label245:
      return (List)localArrayList;
      label251:
    ...
    Object localObject2 = (Integer)ugz.a().get(localObject1);
    if (localObject2 != null) {
      j = ((Integer)localObject2).intValue();
    }
    for (;;)
    {
      label300:
      localArrayList.add(new ude((String)localObject1, j, bool));
      break label334;
      j = 0;
      label334:
      label341:
  ...
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new ude("kandian", 13, false));
    localArrayList.add(new ude("qq_friend", 2, false));
    localArrayList.add(new ude("qzone", 3, false));
    localArrayList.add(new ude("we_chat", 9, false));
    localArrayList.add(new ude("we_chat_circle", 10, false));
    localArrayList.add(new ude("we_bo", 12, false));
    localArrayList.add(new ude("send_pc", 26, false));
    localArrayList.add(new ude("qq_browser", 5, false));
    localArrayList.add(new ude("sys_browser", 4, false));
    return (List)localArrayList;
  }
  ...
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new ude("screen_shot", 21, false));
    localArrayList.add(new ude("set_font", 7, false));
    localArrayList.add(new ude("add_favourite", 6, false));
    localArrayList.add(new ude("copy_link", 1, false));
    localArrayList.add(new ude("report", 11, false));
    return (List)localArrayList;
  }
}
