...
public class way
{
  public ArrayList<Long> a(List<String> paramList)
  {
    ...
    {
      l = awaf.a((String)paramList.next()) + l;
  ...
  public ArrayList<Long> a(List<String> paramList, String paramString)
  {
    ...
    long l2 = awaf.a(paramString);
    paramString = new ArrayList();
    Iterator localIterator = paramList.iterator();
    long l1 = 0L;
    while (localIterator.hasNext())
    {
      l1 = awaf.a((String)localIterator.next()) + l1;
  ...
  public boolean a(List<String> paramList, String paramString, int paramInt1, int paramInt2, MediaFormat paramMediaFormat)
  {
    ...
    {
      localObject4 = new blbt();
      try
      {
        i = blbs.a((String)paramList.get(0), (blbt)localObject4);
      ...
      paramInt1 = j;
      if (AudioHelper.f()) {
        return blbn.a(paramList, paramString, i);
      }
      ...
      localObject5 = new avyy(paramString, paramInt1, paramInt2, axik.r, 1, false, i);
      ((avyy)localObject5).b = true;
    }
    for (;;)
    {
      Object localObject3;
      try
      {
        ...
        localObject3 = new File(((avyy)localObject5).a);
        if (!((File)localObject3).exists()) {
          bbdj.c(((File)localObject3).getAbsolutePath());
        }
        localObject3 = new MediaMuxer(((avyy)localObject5).a, 0);
        ((MediaMuxer)localObject3).setOrientationHint(((avyy)localObject5).g);
  ...
  public ArrayList<Long> b(List<String> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      {
        localLinkedHashMap.put(localObject, Long.valueOf(awaf.a((String)localObject)));
      }
    }
  ...
  public ArrayList<Long> b(List<String> paramList, String paramString)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      {
        paramString.put(localObject, Long.valueOf(awaf.a((String)localObject)));
      }
    }
    paramList = new ArrayList();
