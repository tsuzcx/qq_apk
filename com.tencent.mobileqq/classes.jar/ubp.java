...
public class ubp
{
  ...
  public static String a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    if (ahte.b(paramAbsStructMsg.mMsgActionData))
    {
      paramAbsStructMsg = ahte.b(paramAbsStructMsg.mMsgActionData);
  ...
  public static ubp a()
  {
    if (jdField_a_of_type_Ubp == null) {
      jdField_a_of_type_Ubp = new ubp();
    }
    return jdField_a_of_type_Ubp;
  }
  ...
  public static boolean a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    if ((paramAbsStructMsg instanceof StructMsgForGeneralShare))
    {
      ...
      if (!TextUtils.isEmpty(paramAbsStructMsg.mMsgUrl))
      {
        ...
        try
        {
          ...
          if (bhap.a().a(localUri.getHost())) {
            return true;
          }
          bool = bkyx.c(localUri.getHost());
          if (bool) {
            return true;
          }
        }
    ...
    try
    {
      bool = tyg.b(new URL(paramAbsStructMsg.mMsgUrl).getHost());
      if (!bool) {
        break label407;
      }
      return true;
  ...
  public void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, anqd paramanqd, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if (arrayOfByte == null)
      {
        ...
        paramMessageRecord.extraflag = 32768;
        paramQQAppInterface.a().a(paramMessageRecord.frienduin, paramMessageRecord.istroop, paramMessageRecord.uniseq);
        paramanqd = paramMessageRecord.frienduin;
        int i = paramMessageRecord.istroop;
        long l = paramMessageRecord.uniseq;
        ((MessageHandler)paramQQAppInterface.a(0)).notifyUI(MessageHandler.a(paramMessageRecord.istroop), false, new Object[] { paramanqd, Integer.valueOf(i), Integer.valueOf(-1), null, Long.valueOf(0L), Long.valueOf(l) });
        return;
      }
      paramBoolean = a(paramQQAppInterface, arrayOfByte, paramQQAppInterface.getCurrentAccountUin(), paramMessageRecord.frienduin, paramMessageRecord.selfuin, paramMessageRecord.istroop, paramMessageRecord.uniseq + 1L, 1035, new ubq(this, paramMessageRecord, paramQQAppInterface, paramanqd, paramBoolean));
      if (!paramBoolean) {
        break;
      }
    } while (!QLog.isColorLevel());
