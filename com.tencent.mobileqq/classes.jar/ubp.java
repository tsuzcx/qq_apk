...
public class ubp
  extends BaseAdapter
{
  public ubp(TroopClassChoiceActivity paramTroopClassChoiceActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      paramViewGroup = this.a.getLayoutInflater().inflate(2130971691, null);
    }
    TextView localTextView1 = (TextView)paramViewGroup.findViewById(2131375347);
    TextView localTextView2 = (TextView)paramViewGroup.findViewById(2131375349);
    ImageView localImageView = (ImageView)paramViewGroup.findViewById(2131375348);
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      if (paramInt != 0)
      {
        ...
        localTextView2.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130846362, 0);
      }
      for (;;)
      {
