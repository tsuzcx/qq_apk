...
public class lhq
{
      ...
      synchronized (this.jdField_a_of_type_JavaUtilList)
      {
        if (this.jdField_a_of_type_JavaUtilList.size() > 0)
        {
          ...
          if (i < j) {
            try
            {
              boolean bool = ((lib)this.jdField_a_of_type_JavaUtilList.get(i)).a(paramLong);
              if (!bool) {
                break label101;
              }
              i -= 1;
  ...
  public void a(Bitmap paramBitmap)
  {
    if (this.jdField_a_of_type_Lhf != null)
    {
      ...
      this.jdField_a_of_type_Lhf = null;
    }
    if (paramBitmap != null)
    {
      this.jdField_a_of_type_Lhf = new lhg(paramBitmap);
  ...
  public void a(lgc paramlgc)
  {
    ...
    lib locallib = null;
    if (this.jdField_a_of_type_JavaUtilList.size() > 0) {
      locallib = (lib)this.jdField_a_of_type_JavaUtilList.get(0);
    }
    if ((locallib != null) && (locallib.a()))
    {
      paramlgc.a(locallib.a(), locallib.b(), locallib.c());
      float f1 = this.e;
      f1 = this.jdField_f_of_type_Float;
      f1 = this.jdField_g_of_type_Float;
      if ((locallib != null) && (locallib.b()))
      {
        f1 = locallib.d();
        float f2 = locallib.e();
      ...
      if ((locallib == null) || (!locallib.c())) {
        break label268;
      }
      paramlgc.a(locallib.f(), 1.0F, 0.0F, 0.0F);
      paramlgc.a(locallib.g(), 0.0F, 1.0F, 0.0F);
      paramlgc.a(locallib.h(), 0.0F, 0.0F, 1.0F);
    }
    for (;;)
    {
      c(paramlgc);
      ...
      paramlgc.c();
      return;
      paramlgc.a(i, j, this.jdField_a_of_type_Float);
      break;
      label268:
      if (this.jdField_b_of_type_Float != 0.0F) {
        paramlgc.a(this.jdField_b_of_type_Float, 1.0F, 0.0F, 0.0F);
      }
      if (this.jdField_c_of_type_Float != 0.0F) {
        paramlgc.a(this.jdField_c_of_type_Float, 0.0F, 1.0F, 0.0F);
      }
      if (this.d != 0.0F) {
        paramlgc.a(this.d, 0.0F, 0.0F, 1.0F);
      }
    }
  }
  ...
  public void a(lhg paramlhg)
  {
    ...
    if (paramlhg != null)
    {
      this.jdField_a_of_type_Lhf = paramlhg;
      this.jdField_f_of_type_Int = 0;
    }
  }
  ...
  public void a(lib paramlib)
  {
    ...
    try
    {
      paramlib.a(this);
      paramlib.a();
      this.jdField_a_of_type_JavaUtilList.add(paramlib);
      b();
      return;
    }
    finally {}
  ...
  protected void b(lgc paramlgc)
  {
    ...
    paramlgc.a(2);
    this.jdField_b_of_type_Lhf.a(paramlgc, i2, i3, i - k - m, j - n - i1);
    paramlgc.c();
  }
  ...
  {
    if ((a() == 0) && (this.jdField_a_of_type_Lhr != null) && (this.jdField_a_of_type_Lhr.a(this, paramMotionEvent))) {
      return true;
    }
  ...
  public void c(int paramInt)
  {
    if (this.h != paramInt)
    {
      ...
      if (this.jdField_a_of_type_Lhs != null) {
        this.jdField_a_of_type_Lhs.a(this, paramInt, i);
      }
    }
  }
  ...
  protected void c(lgc paramlgc)
  {
    if (this.jdField_a_of_type_Lhf != null)
    {
      i = b();
      j = c();
      this.jdField_a_of_type_Lhf.a(paramlgc, 0, 0, i, j);
      return;
    }
    int i = b();
    int j = c();
    paramlgc.a(0.0F, 0.0F, i, j, this.jdField_g_of_type_Int);
  }
  ...
  public void e(int paramInt)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Lhf = locallhj;
      this.jdField_f_of_type_Int = paramInt;
      return;
      locallhj = new lhj((Context)localObject, paramInt);
    }
  }
