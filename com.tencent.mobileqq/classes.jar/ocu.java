  ...
  implements aqlb<String>
{
  ...
  public static ocu a()
  {
    ocu localocu = new ocu();
    localocu.jdField_a_of_type_JavaLangString = tyg.jdField_d_of_type_JavaLangString;
    localocu.jdField_b_of_type_JavaLangString = tyg.jdField_e_of_type_JavaLangString;
    localocu.jdField_b_of_type_Boolean = tyg.jdField_a_of_type_Boolean;
    localocu.jdField_c_of_type_Boolean = tyg.p;
    localocu.jdField_a_of_type_Boolean = tyg.jdField_b_of_type_Boolean;
    localocu.jdField_d_of_type_Boolean = tyg.jdField_e_of_type_Boolean;
    localocu.jdField_e_of_type_Boolean = tyg.jdField_f_of_type_Boolean;
    localocu.jdField_f_of_type_Boolean = tyg.jdField_g_of_type_Boolean;
    localocu.jdField_g_of_type_Boolean = tyg.jdField_h_of_type_Boolean;
    localocu.jdField_h_of_type_Boolean = tyg.jdField_i_of_type_Boolean;
    localocu.jdField_i_of_type_Boolean = tyg.l;
    localocu.j = tyg.j;
    localocu.jdField_c_of_type_JavaLangString = tyg.jdField_f_of_type_JavaLangString;
    localocu.jdField_a_of_type_Long = tyg.jdField_a_of_type_Long;
    localocu.k = tyg.m;
    localocu.jdField_a_of_type_Int = tyg.jdField_b_of_type_Int;
    localocu.jdField_d_of_type_JavaLangString = tyg.jdField_i_of_type_JavaLangString;
    localocu.l = tyg.n;
    localocu.m = tyg.jdField_c_of_type_Boolean;
    localocu.n = tyg.o;
    localocu.jdField_a_of_type_JavaUtilArrayList = tyg.jdField_a_of_type_JavaUtilArrayList;
    localocu.jdField_b_of_type_Int = tyg.jdField_c_of_type_Int;
    localocu.jdField_c_of_type_Int = tyg.jdField_d_of_type_Int;
    localocu.jdField_d_of_type_Int = tyg.jdField_e_of_type_Int;
    localocu.o = tyg.k;
    Object localObject = tyg.jdField_g_of_type_JavaLangString;
    localocu.jdField_e_of_type_JavaLangString = ((String)localObject);
    localocu.jdField_f_of_type_JavaLangString = tyg.jdField_h_of_type_JavaLangString;
    try
    {
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        if (((JSONObject)localObject).has("useNewLogic")) {
          b(localocu, (JSONObject)localObject);
        }
        if (((JSONObject)localObject).has("releaseServiceMinMem")) {
          a(localocu, (JSONObject)localObject);
        }
      }
      return localocu;
    }
  ...
  private ocu a(ocu paramocu, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString.has("service_folder_name")) {
          this.jdField_a_of_type_JavaLangString = paramocu.jdField_a_of_type_JavaLangString;
        }
        if (paramString.has("service_folder_icon")) {
          this.jdField_b_of_type_JavaLangString = paramocu.jdField_b_of_type_JavaLangString;
        }
        if (paramString.has("service_folder_redspots")) {
          this.jdField_a_of_type_Boolean = paramocu.jdField_a_of_type_Boolean;
        }
        if (paramString.has("service_folder_delete")) {
          this.jdField_b_of_type_Boolean = paramocu.jdField_b_of_type_Boolean;
        }
        if (paramString.has("ServiceFolder_RedClean_After_Enter")) {
          this.jdField_c_of_type_Boolean = paramocu.jdField_c_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload")) {
          this.jdField_d_of_type_Boolean = paramocu.jdField_d_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_wifi")) {
          this.jdField_e_of_type_Boolean = paramocu.jdField_e_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_4G")) {
          this.jdField_f_of_type_Boolean = paramocu.jdField_f_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_3G")) {
          this.jdField_g_of_type_Boolean = paramocu.jdField_g_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_preload_2G")) {
          this.jdField_h_of_type_Boolean = paramocu.jdField_h_of_type_Boolean;
        }
        if (paramString.has("pub_account_bottom_bar")) {
          this.jdField_i_of_type_Boolean = paramocu.jdField_i_of_type_Boolean;
        }
        if (paramString.has("readInJoy_feeds_image_preload")) {
          this.j = paramocu.j;
        }
        if (paramString.has("kandian_feeds_fling_LToR_host")) {
          this.jdField_c_of_type_JavaLangString = paramocu.jdField_c_of_type_JavaLangString;
        }
        if (paramString.has("kandian_ad_background_showtime")) {
          this.jdField_a_of_type_Long = paramocu.jdField_a_of_type_Long;
        }
        ...
        {
          this.jdField_a_of_type_Int = paramocu.jdField_a_of_type_Int;
          this.jdField_d_of_type_JavaLangString = paramocu.jdField_d_of_type_JavaLangString;
        }
        ...
        if ((i1 != 0) && (paramString.has("host_white_list"))) {
          this.jdField_a_of_type_JavaUtilArrayList = paramocu.jdField_a_of_type_JavaUtilArrayList;
        }
        if (paramString.has("album_predown_enable")) {
          this.jdField_b_of_type_Int = paramocu.jdField_b_of_type_Int;
        }
        if (paramString.has("album_predown_photo_rule")) {
          this.jdField_c_of_type_Int = paramocu.jdField_c_of_type_Int;
        }
        if (paramString.has("album_predown_slide_photocounts")) {
          this.jdField_d_of_type_Int = paramocu.jdField_d_of_type_Int;
        }
        ...
        {
          this.jdField_e_of_type_JavaLangString = paramocu.jdField_e_of_type_JavaLangString;
          this.p = paramocu.p;
          this.jdField_e_of_type_Int = paramocu.jdField_e_of_type_Int;
          this.jdField_f_of_type_Int = paramocu.jdField_f_of_type_Int;
          this.jdField_g_of_type_Int = paramocu.jdField_g_of_type_Int;
          this.jdField_h_of_type_Int = paramocu.jdField_h_of_type_Int;
        }
        if (paramString.has("releaseServiceMinMem"))
        {
          this.jdField_f_of_type_JavaLangString = paramocu.jdField_f_of_type_JavaLangString;
          this.jdField_i_of_type_Int = paramocu.jdField_i_of_type_Int;
          return this;
        }
      }
      catch (JSONException paramocu)
      {
        paramocu.printStackTrace();
      }
    }
    return this;
  }
  
  public static ocu a(aqlg[] paramArrayOfaqlg)
  {
    Object localObject1 = new ocu();
    ...
    if (paramArrayOfaqlg != null)
    {
      ...
      if (paramArrayOfaqlg.length > 0)
      {
        ...
        for (;;)
        {
          if (i1 >= paramArrayOfaqlg.length) {
            break label94;
          }
          str = paramArrayOfaqlg[i1].jdField_a_of_type_JavaLangString;
          try
          {
            localObject2 = ((ocu)localObject1).a((ocu)aqlu.a(str, ocu.class), str);
  ...
  private static void a(ocu paramocu, JSONObject paramJSONObject)
  {
    paramocu.jdField_i_of_type_Int = paramJSONObject.optInt("releaseServiceMinMem", 80);
  }
  ...
  private static void b(ocu paramocu, JSONObject paramJSONObject)
  {
    paramocu.p = paramJSONObject.optBoolean("useNewLogic", false);
    paramocu.jdField_e_of_type_Int = paramJSONObject.optInt("minTotalMem", 1024);
    paramocu.jdField_f_of_type_Int = paramJSONObject.optInt("minAvailableMem", 100);
    paramocu.jdField_g_of_type_Int = paramJSONObject.optInt("minCpuNum", 2);
    paramocu.jdField_h_of_type_Int = paramJSONObject.optInt("minCpuFreq", 1000);
  }
  ...
  public void b()
  {
    tyg.jdField_d_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    tyg.jdField_e_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
    tyg.jdField_a_of_type_Boolean = this.jdField_b_of_type_Boolean;
    tyg.p = this.jdField_c_of_type_Boolean;
    tyg.jdField_b_of_type_Boolean = this.jdField_a_of_type_Boolean;
    tyg.jdField_e_of_type_Boolean = this.jdField_d_of_type_Boolean;
    tyg.jdField_f_of_type_Boolean = this.jdField_e_of_type_Boolean;
    tyg.jdField_g_of_type_Boolean = this.jdField_f_of_type_Boolean;
    tyg.jdField_h_of_type_Boolean = this.jdField_g_of_type_Boolean;
    tyg.jdField_i_of_type_Boolean = this.jdField_h_of_type_Boolean;
    tyg.l = this.jdField_i_of_type_Boolean;
    tyg.j = this.j;
    tyg.jdField_f_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
    tyg.jdField_a_of_type_Long = this.jdField_a_of_type_Long;
    tyg.m = this.k;
    tyg.jdField_b_of_type_Int = this.jdField_a_of_type_Int;
    tyg.jdField_i_of_type_JavaLangString = this.jdField_d_of_type_JavaLangString;
    tyg.n = this.l;
    tyg.jdField_c_of_type_Boolean = this.m;
    tyg.o = this.n;
    tyg.jdField_a_of_type_JavaUtilArrayList = this.jdField_a_of_type_JavaUtilArrayList;
    tyg.jdField_c_of_type_Int = this.jdField_b_of_type_Int;
    tyg.jdField_d_of_type_Int = this.jdField_c_of_type_Int;
    tyg.jdField_e_of_type_Int = this.jdField_d_of_type_Int;
    tyg.k = this.o;
    tyg.jdField_g_of_type_JavaLangString = this.jdField_e_of_type_JavaLangString;
    tyg.jdField_h_of_type_JavaLangString = this.jdField_f_of_type_JavaLangString;
  }
  ...
  public void c()
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface)) {
      tyg.b((QQAppInterface)localAppRuntime);
    }
  }
}
