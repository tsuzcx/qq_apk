  ...
  implements amwq
{
  ...
  public static int b;
  public static int c;
  private anon jdField_a_of_type_Anon;
  private anor jdField_a_of_type_Anor;
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<Activity> jdField_a_of_type_JavaLangRefWeakReference;
  private HashMap<String, amzp> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public ancn(int paramInt, Activity paramActivity)
  {
    this.jdField_b_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_Anon = new anon(anbd.a(), paramActivity);
    this.jdField_a_of_type_Anor = new anor(paramActivity, anbd.a());
  ...
  private void a(long paramLong, int paramInt, andi paramandi)
  {
    ApolloCmdChannel localApolloCmdChannel = anbd.a();
    if (localApolloCmdChannel != null)
    {
      localApolloCmdChannel.callbackFromRequest(paramLong, paramInt, "cs.get_redPacket_result.local", paramandi.a());
      paramandi.jdField_b_of_type_Int = 0;
      paramandi.jdField_a_of_type_Boolean = false;
      return;
    }
    QLog.e("cmgame_process.CmGameSubProcessHandler", 1, "[notifyRedPacketResult] cmdChannel is null");
  }
  
  private void a(long paramLong, String paramString, adnb paramadnb)
  {
    if (paramadnb == null) {
      return;
    }
    ...
    paramadnb.a(str, null, new ancs(this, paramString, paramLong));
  }
  
  private void a(long paramLong, String paramString1, String paramString2)
  {
    Object localObject = anbd.a(this.jdField_d_of_type_Int);
    if (localObject == null) {
    ...
    ((anbg)localObject).a(paramLong, paramString1, paramString2);
  }
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_JavaUtilRegexPattern == null)
        {
          ...
          if (localObject != null)
          {
            localObject = ((andn)localObject).a(this.jdField_d_of_type_Int);
            if (QLog.isColorLevel()) {
  ...
  {
    if ((!paramString1.startsWith("cs.")) && (!paramString1.endsWith(".local")) && (!amwu.a(paramString1)) && (a(paramString1))) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          paramString2 = anbd.a(this.jdField_d_of_type_Int);
        ...
        if ("apollo_router_game.game_ad_linkcmd_get_ad".equals(paramString1))
        {
          ...
          ((anen)localObject2).a(paramString1, (String)localObject1, paramLong, 4, bool, paramString2);
          break;
  ...
  private byte[] a(String paramString)
  {
    ...
    try
    {
      ...
      localObject1 = acwe.a((Context)localObject1);
  ...
  private void c()
  {
    ...
    do
    {
      ...
      {
        return;
        Activity localActivity = ((ande)localObject).a();
  ...
  private void d()
  {
    ...
    if (localActivity != null) {
      anbd.a(this.jdField_d_of_type_Int, localActivity);
    }
  }
  ...
  private void e(long paramLong, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        anbd.a(anbd.a(), i, j, this.jdField_d_of_type_Int, k, paramString);
        i = 0;
      }
      catch (Exception paramString)
      {
  ...
  private void f(long paramLong, String paramString)
  {
    ...
    ((anee)localObject).b(paramLong, paramString);
  }
  ...
  private void h(long paramLong, String paramString)
  {
    ...
    ((anee)localObject).a(paramLong, paramString);
  }
  ...
  private void h(String paramString)
  {
    ...
    paramString = a();
    if (paramString != null) {
      auxu.a(paramString, localIntent, 20180427);
    }
  }
  ...
  private void i(long paramLong, String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
        localCmGameInitParams = ((ande)localObject).a();
      } while (localCmGameInitParams == null);
      localObject = ((ande)localObject).a(localCmGameInitParams.appId, ((ande)localObject).a());
    } while (localObject == null);
    if (localCmGameInitParams.accessTokenRet != 1)
    {
      ...
      ((adnb)localObject).a("login", null, new ancr(this, paramString, paramLong, (adnb)localObject, localCmGameInitParams));
      return;
    }
    a(paramLong, paramString, (adnb)localObject);
  }
  
  private void i(String paramString)
  {
    if (this.jdField_a_of_type_Anon == null) {}
    for (;;)
    {
      return;
      String str = "";
      ...
      try
      {
        ...
        ande localande = anbd.a(this.jdField_d_of_type_Int);
        if (localande != null)
        {
          localande.jdField_c_of_type_Int = 0;
          ansi localansi2 = localande.a();
          ansi localansi1;
          if ((localansi2 != null) && (localansi2.jdField_a_of_type_Long != 0L))
          {
            localansi1 = localansi2;
            if (localansi2.jdField_a_of_type_Int != 0) {}
          }
          else
          {
            localansi1 = this.jdField_a_of_type_Anon.a(paramString);
          }
          if (localansi1 != null)
          {
            this.jdField_a_of_type_Anon.a(localansi1);
            this.jdField_a_of_type_Anon.a(str);
            ThreadManager.getUIHandler().post(new CmGameSubProcessHandler.9(this));
            paramString = localande.a();
            if (paramString != null)
            {
  ...
  private void j(long paramLong, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((andi)localObject).jdField_d_of_type_Int = i;
        if ((((andi)localObject).jdField_a_of_type_Int <= 0) || (((andi)localObject).jdField_d_of_type_Int < ((andi)localObject).jdField_a_of_type_Int)) {
          break label345;
        }
        if (QLog.isColorLevel()) {
          QLog.d("cmgame_process.CmGameSubProcessHandler", 2, "[hanldeGetRedPacketResult] score:" + ((andi)localObject).jdField_d_of_type_Int + "info.grabState:" + ((andi)localObject).jdField_b_of_type_Int);
        }
        if (((andi)localObject).jdField_b_of_type_Int == 3)
        {
          a(paramLong, 0, (andi)localObject);
          if (!"0".equals(((andi)localObject).f)) {
            break label429;
          }
          alil.a(((andi)localObject).jdField_b_of_type_JavaLangString, ((andi)localObject).jdField_a_of_type_Long, ((andi)localObject).jdField_d_of_type_Int + "", Integer.parseInt(((andi)localObject).jdField_d_of_type_JavaLangString), bool1, false, this.jdField_d_of_type_Int);
          return;
        }
      }
      catch (Exception paramString)
      ...
      if (((andi)localObject).jdField_b_of_type_Int == 0)
      {
        if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
          alil.a(anbd.a(), ((andi)localObject).g + "", this.jdField_d_of_type_Int + "", i + "", new CmGameSubProcessHandler.4(this, null, paramLong));
        }
        ((andi)localObject).jdField_b_of_type_Int = 1;
        return;
      }
      ((andi)localObject).jdField_a_of_type_Boolean = true;
      return;
      label345:
      a(paramLong, 0, (andi)localObject);
      if ("0".equals(((andi)localObject).f)) {}
  ...
  private void j(String paramString)
  {
    ...
    try
    {
      localande = anbd.a(this.jdField_d_of_type_Int);
      if (localande == null) {
        return;
      }
      localansi = localande.a();
      paramString = new JSONObject(paramString);
    ...
    localansi.jdField_c_of_type_JavaLangString = paramString.optString("extendInfo");
    paramString = localande.a();
    if (paramString != null)
    {
      paramString.mRoomId = l;
      localansi.jdField_b_of_type_JavaLangString = paramString.mChineseName;
      localansi.jdField_b_of_type_Int = paramString.mActionId;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramString != null)
        {
          ...
          {
            alil.a(anbd.a(), paramString.g + "", this.jdField_d_of_type_Int + "", i + "", new CmGameSubProcessHandler.5(this, null, paramLong));
  ...
  private void k(String paramString)
  {
    ...
    if (localAppInterface != null) {
      anog.a(localAppInterface, paramString);
    }
  }
  ...
  private void l(long paramLong, String paramString)
  {
    ...
    if (localObject == null) {
      paramString = anbd.a((int)paramLong);
    }
    if (paramString != null)
    {
      ...
      if (localObject != null)
      {
        ...
        paramString.a("login", null, new ancq(this, (CmGameInitParams)localObject, paramLong));
      }
    }
    try
    {
  ...
  private void m(long paramLong, String paramString)
  {
    ...
    {
      anbd.a().callbackFromRequest(paramLong, 6, "cs.xy_device_vibrate.local", "{}");
      QLog.e("cmgame_process.CmGameSubProcessHandler", 1, paramString, new Object[0]);
    }
  }
  ...
  private void n(long paramLong, String paramString)
  {
    ...
    {
      anbd.a().callbackFromRequest(paramLong, 4, "cs.xy_device_gyro_sensor_start.local", "{}");
      QLog.e("cmgame_process.CmGameSubProcessHandler", 1, paramString, new Object[0]);
    }
  }
  ...
  public amww a(long paramLong, String paramString1, String paramString2)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return null;
        } while ((localande == null) || (localande.a() == null));
        if (localande.a().getLuaState() == paramLong) {
          break;
        }
      ...
      {
        anog.a(this.jdField_d_of_type_Int, paramString2, a());
        return null;
      }
  ...
  {
    paramString = anfd.a(paramString);
    ande localande = anbd.a(this.jdField_d_of_type_Int);
    if ((paramString == null) || (localande == null))
    {
      QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[playADsVideo], adInfo or launcher is null.");
      return;
    }
    paramString.b = paramLong;
    localande.a(paramString);
  }
  
  public void a(long paramLong, String paramString, amwr paramamwr)
  {
    if ((this.jdField_b_of_type_JavaUtilHashMap != null) && (this.jdField_b_of_type_JavaUtilHashMap.containsKey(paramString))) {
      paramamwr.a((Bitmap)this.jdField_b_of_type_JavaUtilHashMap.get(paramString), 200);
    }
    for (;;)
    {
      return;
      ...
      {
        ThreadManagerV2.excute(new CmGameSubProcessHandler.10(this, ((amzp)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).jdField_a_of_type_JavaLangString, paramamwr, paramString), 128, null, true);
        return;
      }
      paramamwr = anbd.a();
      if (paramamwr != null)
      {
        Object localObject1 = anbd.a(this.jdField_d_of_type_Int);
        if (localObject1 == null)
        {
          QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[getUserInfo], launcher is null, mGameId:" + this.jdField_d_of_type_Int);
          return;
        }
        Object localObject2 = ((ande)localObject1).a();
        try
        {
          ...
          paramamwr.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject1).toString(), paramLong, jdField_a_of_type_Int);
          if (QLog.isColorLevel())
          {
  ...
  public void a(long paramLong, String paramString, amws paramamws)
  {
    if ((this.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramString))) {
      paramamws.a(((amzp)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).jdField_b_of_type_JavaLangString);
    }
    for (;;)
    {
      return;
      ...
      if (paramamws != null)
      {
        ...
        try
        {
          ...
          ((JSONArray)localObject2).put(paramString);
          ((JSONObject)localObject1).put("uidList", localObject2);
          paramamws.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject1).toString(), paramLong, jdField_b_of_type_Int);
          if (QLog.isColorLevel())
          {
  ...
  public void a(amzp paramamzp)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap != null) {
      this.jdField_a_of_type_JavaUtilHashMap.put(paramamzp.jdField_c_of_type_JavaLangString, paramamzp);
    }
  }
  ...
  {
    int i = this.e;
    if (anog.a(a(), paramString, this.jdField_d_of_type_Int, i)) {}
    try
    {
  ...
  public void b(String paramString)
  {
    try
    {
      ...
      paramString = anbd.a(this.jdField_d_of_type_Int);
      if (paramString != null) {
        paramString.a(i);
      }
      return;
  ...
  public void c(long paramLong, String paramString)
  {
    ...
    if (localanen != null)
    {
      localObject1 = anbd.a(this.jdField_d_of_type_Int);
      if (localObject1 == null) {
        QLog.w("cmgame_process.CmGameSubProcessHandler", 1, "[getUserInfo], launcher is null, mGameId:" + this.jdField_d_of_type_Int);
      }
    }
    ...
    Object localObject1 = ((ande)localObject1).a();
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          localanen.a("ltgame_native_api.batch_get_user_info", ((JSONObject)localObject2).toString(), paramLong, jdField_c_of_type_Int, false, null);
          return;
        }
      }
      catch (Exception paramString)
  ...
  {
    Object localObject2 = anbd.b(paramLong);
    Object localObject1 = localObject2;
    if (localObject2 == null) {
      localObject1 = anbd.a((int)paramLong);
    }
    if (localObject1 != null)
    {
      localObject2 = ((ande)localObject1).a();
      if (localObject2 != null) {
        try
        {
          CmGameInitParams localCmGameInitParams = ((ande)localObject1).a();
