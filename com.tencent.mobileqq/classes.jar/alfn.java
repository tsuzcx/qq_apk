...
public class alfn
{
  ...
  public alfn()
  {
    this.jdField_a_of_type_Akuo = new alfr(this, 0, true, true, 3000L, true, false, "QQARScan");
  }
  ...
  private void a(int paramInt, algn paramalgn)
  {
    QLog.i("AREngine_ARCloudControl", 1, "requestToCheckLBSLocation.");
    this.jdField_a_of_type_Algn = paramalgn;
    ...
    this.jdField_a_of_type_ComTencentMobileqqArModelArLBSActivity = algn.a(this.jdField_a_of_type_ComTencentMobileqqArAidlARCommonConfigInfo.recognitions, paramalgn);
    if (Build.VERSION.SDK_INT >= 23)
    {
      if (((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.ACCESS_FINE_LOCATION") != 0)
      {
        ...
        ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).requestPermissions(new alfs(this), 1, new String[] { "android.permission.ACCESS_COARSE_LOCATION", "android.permission.ACCESS_FINE_LOCATION" });
        return;
      }
  ...
  private void a(algs paramalgs)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      this.jdField_a_of_type_Alet.a(paramalgs, new alfq(this, l1, paramalgs));
      return;
    }
  }
  ...
  private void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Alet != null)
    {
      ...
      this.jdField_a_of_type_Alet.a(paramString, paramInt1, paramInt2, new alfo(this));
    }
  }
  
  private void a(byte[] paramArrayOfByte, ArrayList<ARRecognition> paramArrayList)
  {
    if (this.jdField_a_of_type_Algg != null)
    {
      algs localalgs = new algs();
      this.jdField_a_of_type_Algg.a(paramArrayOfByte, paramArrayList, new alfp(this, localalgs), this.jdField_b_of_type_Int, this.jdField_c_of_type_Int, this.jdField_a_of_type_Int);
    }
  }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    long l1;
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Alfu != null))
    {
      l1 = System.currentTimeMillis();
      bool1 = this.jdField_a_of_type_Alfu.a(paramArrayOfByte);
      this.jdField_b_of_type_Boolean = false;
      this.jdField_a_of_type_Alft.c(bool1);
      QLog.i("AREngine_ARCloudControl", 1, "isSameSceneWithBestImg = " + bool1 + " cost time:" + (System.currentTimeMillis() - l1) + "ms");
    }
    if ((!this.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_Alfu == null)) {
      return;
    }
    ...
    if (this.jdField_a_of_type_Alft != null) {
      this.jdField_a_of_type_Alft.b();
    }
    this.jdField_c_of_type_Long = System.currentTimeMillis();
    boolean bool1 = this.jdField_a_of_type_Alfu.a(paramArrayOfByte, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
    ...
    if (this.jdField_a_of_type_Alft != null)
    {
      boolean bool2 = this.jdField_a_of_type_Alft.a();
      l1 = this.jdField_a_of_type_Alft.a();
      if ((bool1) && (!this.jdField_m_of_type_Boolean) && (bool2))
      {
        ...
        i1 = 0;
        bool1 = false;
        this.jdField_a_of_type_Alft.a(bool1);
      }
    }
    for (;;)
    {
      ...
      {
        if (this.jdField_a_of_type_Alft != null) {
          this.jdField_a_of_type_Alft.b(true);
        }
        if ((!this.jdField_f_of_type_Boolean) && (this.jdField_a_of_type_Alft != null))
        {
          l1 = this.jdField_a_of_type_Alft.b();
          aldn.a().a(l1, this.jdField_l_of_type_Long, this.jdField_m_of_type_Long, this.jdField_a_of_type_Alfu.jdField_c_of_type_Int);
          akxa.a().a(l1, this.jdField_m_of_type_Long);
  ...
  public boolean a(alft paramalft, AppInterface paramAppInterface, Activity paramActivity, int paramInt1, int paramInt2, int paramInt3, ARCommonConfigInfo paramARCommonConfigInfo)
  {
    long l2 = System.currentTimeMillis();
    jdField_k_of_type_Boolean = a();
    alip.a().b(System.currentTimeMillis() - l2, jdField_k_of_type_Boolean);
    if (!jdField_k_of_type_Boolean) {
      return false;
    }
    this.jdField_a_of_type_Alfu = new alfu(alfu.jdField_b_of_type_Int);
    this.jdField_a_of_type_Algg = new algg();
    this.jdField_a_of_type_Alfu.a(BaseApplicationImpl.getContext().getApplicationContext());
    this.jdField_a_of_type_Algg.a();
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_e_of_type_Int = paramInt1;
    this.jdField_d_of_type_Int = paramInt2;
    this.jdField_f_of_type_Int = paramInt3;
    this.jdField_a_of_type_Alft = paramalft;
    this.jdField_a_of_type_Alet = new alet(paramAppInterface, true);
    this.jdField_a_of_type_Alet.a();
    ...
    for (long l1 = ARRecognition.a(this.jdField_a_of_type_ComTencentMobileqqArAidlARCommonConfigInfo.recognitions);; l1 = 0L)
    {
      ...
      alip.a().c(System.currentTimeMillis() - l2, jdField_k_of_type_Boolean);
      return true;
    }
  }
  ...
  public void f()
  {
    ...
    {
      this.jdField_a_of_type_Alfu.a();
      this.jdField_a_of_type_Alfu = null;
    }
    if (this.jdField_a_of_type_Algg != null)
    {
      this.jdField_a_of_type_Algg.b();
      this.jdField_a_of_type_Algg = null;
    }
    this.jdField_a_of_type_Alft = null;
