...
public class alfn
{
  ...
  public alfn(BaseChatPie paramBaseChatPie)
  {
  ...
  public View a()
  {
    if (this.jdField_a_of_type_Alcm != null) {
      return this.jdField_a_of_type_Alcm.a();
    }
    return null;
  }
  ...
  public void a(List<aldn> paramList, int paramInt)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null)
    {
    ...
    if (this.jdField_a_of_type_Alcm == null) {
      this.jdField_a_of_type_Alcm = new alcm(a());
    }
    this.jdField_a_of_type_Alcm.a();
    this.jdField_a_of_type_Alcm.a(paramList, paramInt, null);
  }
