...
public class bhzt
{
  private static final bhmt<bhzt, Void> jdField_a_of_type_Bhmt = new bhzu();
  public WeakReference<bhzv> a;
  ...
  {
    return (bhzt)jdField_a_of_type_Bhmt.b(null);
  }
  ...
  public qq_ad_get.QQAdGet.DeviceInfo a()
  {
    for (;;)
    {
      ...
      {
        localObject = new yyq();
        ((yyq)localObject).a = "1018ec";
        localObject = yyp.a(BaseApplicationImpl.getApplication(), (yyq)localObject);
        if (localObject == null) {
          continue;
        }
        localObject = ((yyr)localObject).jdField_a_of_type_TencentGdtQq_ad_get$QQAdGet$DeviceInfo;
  ...
  public void a(int paramInt1, long paramLong, int paramInt2, String paramString, int paramInt3)
  {
    ...
    bhzw.a(paramLong, paramString, paramInt1, paramInt2, 1, paramInt3, this.jdField_a_of_type_TencentGdtQq_ad_get$QQAdGet$DeviceInfo);
  ...
  public void a(long paramLong, int paramInt1, String paramString, int paramInt2, bhzv parambhzv)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambhzv);
  ...
  public void a(vac_adv_get.VacAdvRsp paramVacAdvRsp)
  {
    ...
    {
      ((bhzv)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a((AlumBasicData)localArrayList.get(0));
