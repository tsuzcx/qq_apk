...
public class maw
{
  ...
  private void a(int paramInt1, byte[] paramArrayOfByte, int paramInt2)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      arrayOflrp = paramArrayOfByte.a();
      GLES20.glUseProgram(paramArrayOfByte.a());
      GLES20.glUniform1f(arrayOflrp[2].jdField_a_of_type_Int, 1.0F);
      GLES20.glUniform1f(arrayOflrp[7].jdField_a_of_type_Int, this.jdField_a_of_type_Int);
      GLES20.glUniform1f(arrayOflrp[8].jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      GLES20.glUniformMatrix4fv(arrayOflrp[9].jdField_a_of_type_Int, 1, false, YUVTexture.a, 0);
      GLES20.glUniform1i(arrayOflrp[10].jdField_a_of_type_Int, paramInt1);
      GLES20.glUniform1i(arrayOflrp[11].jdField_a_of_type_Int, 0);
    ...
    for (;;)
    {
      ...
      break;
      label925:
      GLES20.glUniformMatrix4fv(arrayOflrp[1].jdField_a_of_type_Int, 1, false, AVGLUtils.matrixVRotate270, 0);
    }
  }
