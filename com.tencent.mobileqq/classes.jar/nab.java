...
public class nab
{
  ...
  {
    File localFile = new File(ajsd.aW + "photo/");
    if ((!localFile.exists()) && (!localFile.mkdirs()))
    {
      a();
      bcql.a(paramActivity, 1, paramActivity.getString(2131690607), 0).a();
      return;
    }
    ...
    a(paramActivity, localIntent, 2131690590);
  }
  ...
  private void a(Activity paramActivity, Intent paramIntent, int paramInt)
  {
    ...
    a();
    bcql.a(paramActivity, 1, paramInt, 0).a();
  }
  ...
  private void a(Activity paramActivity, String paramString)
  {
    ...
    a(paramActivity, localIntent, 2131690608);
  }
  
  private void b(Activity paramActivity)
  {
    Object localObject = new File(ajsd.aW + "photo/");
    ...
    a(paramActivity, (Intent)localObject, 2131690590);
  }
  
  private void c(Activity paramActivity)
  {
    a(paramActivity, new Intent("android.provider.MediaStore.RECORD_SOUND"), 2131690609);
  }
  ...
  public void a(Activity paramActivity, int paramInt, ValueCallback<Uri> paramValueCallback, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      if (paramInt != 0)
      {
        paramString2 = bfpc.a(paramActivity);
        paramString2.a(new nac(this));
        paramString2.setOnCancelListener(new nad(this));
        if (paramValueCallback.equals("camera"))
        {
          paramString2.a(paramActivity.getString(2131720052), 0);
          paramString2.a(paramActivity.getString(2131692514), 0);
          paramString2.a(new nae(this, paramActivity, paramString1, paramString2));
        }
        for (;;)
        {
          paramString2.show();
          ...
          {
            paramString2.a(paramActivity.getString(2131719288), 0);
            paramString2.a(paramActivity.getString(2131692514), 0);
            paramString2.a(new naf(this, paramActivity, paramString1, paramString2));
          }
          else if (paramValueCallback.equals("microphone"))
          {
            paramString2.a(paramActivity.getString(2131718668), 0);
            paramString2.a(paramActivity.getString(2131692514), 0);
            paramString2.a(new nag(this, paramActivity, paramString1, paramString2));
          }
        }
      }
      a(paramActivity, paramString1);
