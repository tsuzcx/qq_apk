...
public class bckz
{
  ...
  public static ArrayList<bcla> a(long paramLong, DataInputStream paramDataInputStream, int paramInt1, int paramInt2)
  {
              ...
              if (i1 == 4)
              {
                ...
                if (!TextUtils.isEmpty(localObject4))
                {
                  ...
                  if (l != -1L)
                  {
                    ...
                    ((bcla)localObject3).jdField_a_of_type_Long = paramLong;
                    ((bcla)localObject3).jdField_a_of_type_Int = paramInt2;
                    ((bcla)localObject3).b = l;
                    ((bcla)localObject3).jdField_a_of_type_JavaLangString = localObject4;
  ...
  public static ArrayList<bcla> a(long paramLong, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    while (i < paramInt)
    {
      ...
      while (j < k)
      {
        bcla localbcla = (bcla)localArrayList2.get(j);
        if (!localHashMap.containsKey(Long.valueOf(localbcla.b)))
        {
          localArrayList1.add(localbcla);
          localHashMap.put(Long.valueOf(localbcla.b), Boolean.valueOf(true));
        }
        j += 1;
      }
      i += 1;
