...
public class bbeo
  extends bbeq
{
  public bbeo(QQAppInterface paramQQAppInterface)
  {
  ...
  private void h(axiu paramaxiu)
  {
    ...
    {
      return;
      Iterator localIterator = paramaxiu.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        ChatMessage localChatMessage = (ChatMessage)localIterator.next();
        if ((localChatMessage instanceof MessageForMixedMsg)) {
          ((awyg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MIXED_MSG_MANAGER)).a(paramaxiu.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (MessageForMixedMsg)localChatMessage, false, ((MessageForMixedMsg)localChatMessage).forwardID);
        }
      }
    }
  }
  ...
  {
    int i = 0;
    Object localObject = paramaxiu.jdField_a_of_type_JavaUtilList;
    ArrayList localArrayList = new ArrayList(1);
    QQAppInterface localQQAppInterface = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    if (paramaxiu.jdField_a_of_type_Int != 2) {}
    for (boolean bool = true;; bool = false)
    {
      paramaxiu.jdField_a_of_type_JavaUtilHashMap = a(a(localQQAppInterface, (List)localObject, bool), localArrayList);
      paramaxiu.jdField_a_of_type_JavaUtilList = localArrayList;
