  ...
  implements bczs
{
  ...
  private bber jdField_a_of_type_Bber = new bbep(this);
  bbew jdField_a_of_type_Bbew;
  private bbfs jdField_a_of_type_Bbfs;
  private bbix jdField_a_of_type_Bbix;
  private bcwn jdField_a_of_type_Bcwn = new bbeq(this);
  ...
  public bbeo(AppInterface paramAppInterface, Context paramContext, GridView paramGridView, bbix parambbix, bbfs parambbfs, boolean paramBoolean)
  {
  ...
  {
    PtvTemplateManager.PtvTemplateInfo localPtvTemplateInfo1 = bbew.a().a();
  ...
  public void a(int paramInt)
  {
    ...
    bbew.a().a(localPtvTemplateInfo);
    if (!localPtvTemplateInfo.id.equals("0"))
    {
      bbew localbbew = bbew.a();
      localbbew.a(localPtvTemplateInfo, 111);
      localbbew.a(3, localPtvTemplateInfo.categoryId, localPtvTemplateInfo.id);
    }
    this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo = localPtvTemplateInfo;
    bbew.a().a(114, this.jdField_a_of_type_Bbfs);
    if ((TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id)) || (this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id.equals("0")))
    {
      ...
      if (this.jdField_a_of_type_Bbix != null) {
        this.jdField_a_of_type_Bbix.a(localPtvTemplateInfo, this.jdField_a_of_type_JavaLangString);
      }
      bbew.a().a(null);
      bbew.a().a(113, null);
      return;
    ...
    {
      this.jdField_a_of_type_JavaLangString = bbew.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.name, this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.md5);
      if (this.jdField_a_of_type_Bbix != null) {
        this.jdField_a_of_type_Bbix.a(localPtvTemplateInfo, this.jdField_a_of_type_JavaLangString);
      }
      bbew.a().a(113, null);
    ...
    for (;;)
    {
      bhsi.a();
      return;
      if ((!this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.downloading) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo.id)) && (this.jdField_a_of_type_Bbew != null))
      {
        this.jdField_a_of_type_Bbew.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_ComTencentMobileqqShortvideoPtvTemplateManager$PtvTemplateInfo, this.jdField_a_of_type_Bcwn);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      localPtvTemplateItemView.a(paramInt, (PtvTemplateManager.PtvTemplateInfo)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt), this.jdField_a_of_type_Bber);
