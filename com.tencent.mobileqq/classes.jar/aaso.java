...
{
  aaso(aasm paramaasm, long paramLong, String paramString) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.has())
        {
          ...
          if (!TextUtils.isEmpty(paramBundle))
          {
            if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.delayms.has())
            {
              ...
              this.jdField_a_of_type_Aasm.e.put(paramBundle, Integer.valueOf(2147483647));
              if (QLog.isColorLevel()) {
            ...
            if (((WebSSOAgent.UniSsoServerRsp)localObject3).comm.packagesize.has())
            {
              ...
              this.jdField_a_of_type_Aasm.b.put(paramBundle, Long.valueOf(l1));
              if (QLog.isColorLevel()) {
        ...
        aasm.a(this.jdField_a_of_type_Aasm, this.jdField_a_of_type_JavaLangString, l2, paramInt);
        ...
        awcn.d = System.currentTimeMillis();
        l1 = awcn.d - awcn.jdField_a_of_type_Long;
        long l3 = awcn.b - awcn.jdField_a_of_type_Long;
        long l4 = awcn.c - awcn.b;
        long l5 = awcn.d - awcn.c;
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_Aasm.callJs((String)localObject1, new String[] { ((JSONObject)localObject2).toString() });
        try
        {
          ...
          localObject3 = this.jdField_a_of_type_Aasm.mRuntime.a().getCurrentAccountUin();
          ...
          localObject1 = StatisticCollector.getInstance(this.jdField_a_of_type_Aasm.mRuntime.a());
          if (0L != l6) {
            break;
          }
          paramBoolean = true;
          label1110:
          ((StatisticCollector)localObject1).collectPerformance((String)localObject3, paramBundle, paramBoolean, l1, 0L, (HashMap)localObject2, "", false);
          return;
        }
      ...
      return;
      label1197:
      this.jdField_a_of_type_Aasm.e.put(paramBundle, Integer.valueOf((int)l1));
      continue;
      label1218:
      aasm.a(this.jdField_a_of_type_Aasm, this.jdField_a_of_type_JavaLangString, paramInt);
      continue;
      label1233:
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject3)) {
        aasm.b(this.jdField_a_of_type_Aasm, (String)localObject3, paramInt);
      }
      ...
      ((JSONObject)localObject2).put("businessRet", 0);
      ((JSONObject)localObject2).put("msg", anvx.a(2131713719));
    }
    for (;;)
    {
      label1431:
      ...
      ((JSONObject)localObject2).put("businessRet", 0);
      ((JSONObject)localObject2).put("msg", anvx.a(2131713725));
      break;
      label1510:
      label1511:
      do
      {
        ((JSONObject)localObject2).put("ssoRet", 255);
        ((JSONObject)localObject2).put("businessRet", 0);
        ((JSONObject)localObject2).put("msg", anvx.a(2131713724));
        break;
        paramBoolean = false;
        break label1110;
        return;
