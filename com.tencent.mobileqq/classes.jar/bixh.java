  ...
  extends BaseAdapter
{
  ...
  public bixh(DraggableGridView paramDraggableGridView, int paramInt)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      bixf localbixf = new bixf(this.jdField_a_of_type_ComTencentMobileqqWidgetDraggableGridView, this.jdField_a_of_type_Int, paramInt);
      paramView.setOnClickListener(localbixf);
      paramView.setOnLongClickListener(localbixf);
