...
public class ayzm
{
  ...
  public ayzm(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    String str = mol.b(this.jdField_a_of_type_JavaLangString);
    boolean bool2;
    ...
    for (;;)
    {
      ayzp localayzp = new ayzp(this, str, bool2, bool1);
      if (!TextUtils.isEmpty(str)) {
        ThreadManager.post(new SoLibraryChecker.4(this, paramJSONObject, str, localayzp), 8, null, false);
      }
      return;
      if ((i == 3) || (i == 2))
      {
  ...
  private void b()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((!new File(mol.a(this.jdField_a_of_type_JavaLangString) + this.jdField_a_of_type_JavaLangString + "/" + this.b).exists()) && (!TextUtils.isEmpty(str)) && (!"0".equals(str))) {
    ...
    mof.a(this.jdField_a_of_type_JavaLangString, localQQAppInterface, new ayzn(this), false);
  }
  ...
  private void c()
  {
    ...
    long l = System.currentTimeMillis();
    if ((!mof.a(BaseApplicationImpl.getContext(), str, new ayzo(this, l))) && (QLog.isColorLevel())) {
