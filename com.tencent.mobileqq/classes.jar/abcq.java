...
public class abcq
  ...
  implements bfru
{
  private abct jdField_a_of_type_Abct;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new abcr(this);
  private View.OnClickListener b;
  
  public abcq(Context paramContext, QQAppInterface paramQQAppInterface, ExpandableListView paramExpandableListView, abct paramabct)
  {
    super(paramContext, paramQQAppInterface, paramExpandableListView);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new abcs(this);
    this.jdField_a_of_type_Abct = paramabct;
  }
  ...
  private void a(ailv paramailv, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      return;
      str = ajya.a(2131704854);
      i = this.jdField_b_of_type_JavaUtilList.size();
      break;
      str = ajya.a(2131704850);
      i = this.c.size();
      break;
      str = ajya.a(2131704855);
      i = this.d.size();
      break;
      str = ajya.a(2131704861);
      i = this.e.size();
      break;
      str = ajya.a(2131704857);
      i = this.f.size();
      break;
      str = ajya.a(2131704851);
      i = this.g.size();
      break;
      label356:
  ...
  public View getChildView(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      if ((localObject2 == null) || (((aiga)localObject2).a == null)) {
        break label436;
      }
      if (!(((aiga)localObject2).a instanceof TroopInfo)) {
        break label247;
      }
      localTroopInfo = (TroopInfo)((aiga)localObject2).a;
      ...
      paramBoolean = this.jdField_a_of_type_Abct.a(localTroopInfo.troopuin, 1);
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        ...
        if ((((aiga)localObject2).a instanceof DiscussionInfo))
        {
          localObject2 = (DiscussionInfo)((aiga)localObject2).a;
          ...
          paramBoolean = this.jdField_a_of_type_Abct.a(((DiscussionInfo)localObject2).uin, 3000);
          paramInt1 = this.jdField_a_of_type_Ajvi.a(((DiscussionInfo)localObject2).uin);
      ...
      QLog.d("ContactsTroopAdapter", 2, "getChildView data:" + ((aiga)localObject2).a + " groupPosition:" + paramInt1 + " childPosition:" + paramInt2);
      return paramViewGroup;
    }
    label436:
