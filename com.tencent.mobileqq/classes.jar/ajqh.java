  ...
  extends RecyclerView.Adapter
{
  ...
  public ajqh(List<String> paramList)
  {
    if (paramList != null)
    {
      this.a.clear();
  ...
  {
    ImageView localImageView = ((ajqi)paramViewHolder).a;
    if (!TextUtils.isEmpty((String)this.a.get(paramInt)))
    {
      ...
      localURLDrawableOptions.mPlayGifImage = azlo.a(str);
  ...
  {
    return new ajqi(this, LayoutInflater.from(paramViewGroup.getContext()).inflate(2131559161, paramViewGroup, false));
  }
}
