...
public class ywh
  extends QIPCModule
{
  private static volatile ywh a;
  
  private ywh(String paramString)
  {
    super(paramString);
  }
  ...
  {
    yxp.b("gdt_ipc", "Action  " + paramString);
    if ("do_app_jump".equals(paramString))
    {
      if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface))
      {
        paramString = (yxq)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(110);
