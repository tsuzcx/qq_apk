...
{
  public actg(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
  ...
  protected void a(String paramString)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        ...
        localObject = this.a.getResources().getString(2131437941);
      ...
      if (localException.structMsg.msg_type.get() == 1)
      {
        ...
        else
        {
          ...
          for (boolean bool = true;; bool = false)
          {
            ...
            String str1 = this.a.getResources().getString(2131433191);
