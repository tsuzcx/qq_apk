...
{
  public actg(ForwardRecentActivity paramForwardRecentActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject))
    {
      ...
      acto.a(this.a.app, this.a, paramView, (String)localObject, bool);
    }
    for (;;)
    {
      this.a.jdField_a_of_type_Arum.a().putString("uin", "-1010");
      this.a.jdField_a_of_type_Arum.B();
      azmj.b(this.a.app, "CliOper", "", "", "friendchoose", "0X800A2D7", ForwardRecentActivity.a(this.a), 0, "", "", "", ForwardRecentActivity.a(this.a));
      ...
      bjao.a(this.a.app, this.a, localBundle, null);
      paramView = new bizg();
      paramView.c = "1";
      paramView.d = "0";
      paramView.b = 4;
      ...
      azmz.a(this.a.getApplicationContext()).a(this.a.app.getAccount(), "actQZSourceDataReport", true, 0L, 0L, paramView, null);
      if (this.a.jdField_a_of_type_Boolean)
      {
        bfdq.a().a(this.a.app.getAccount(), "", this.a.b, "1000", "33", "0", false);
        if ((this.a.jdField_a_of_type_Arum instanceof aryh))
        {
          paramView = (aryh)this.a.jdField_a_of_type_Arum;
          localObject = new Bundle();
          ((Bundle)localObject).putString("report_type", "102");
          ((Bundle)localObject).putString("act_type", "81");
          ((Bundle)localObject).putString("intext_1", "" + bfdw.a(paramView.d));
          ((Bundle)localObject).putString("intext_2", "" + bfdw.a(-1, aljq.aH));
          ((Bundle)localObject).putString("intext_3", "0");
          bfdq.a().a((Bundle)localObject, "", this.a.app.getCurrentAccountUin(), false);
        }
      }
