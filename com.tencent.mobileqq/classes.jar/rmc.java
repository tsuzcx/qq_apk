...
public class rmc
{
  public static void a(List<String> paramList, int paramInt, @Nullable rmf paramrmf)
  {
    ...
    nmb.a(pay.a(), new rme(paramrmf, paramInt), paramList.toByteArray(), "OidbSvc.0xe2a", 3626, 2);
  }
  
  public static void a(boolean paramBoolean, List<UgcVideo> paramList, @Nullable rmg paramrmg)
  {
    ...
    for (int i = 0;; i = 1)
    {
      ...
      nmb.a(pay.a(), new rmd(paramrmg), paramList.toByteArray(), "OidbSvc.0xe2a", 3626, 1, null, 120000L);
      return;
    }
  }
}
