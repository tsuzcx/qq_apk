  ...
  extends aocj
{
  ...
  protected void a(String paramString)
  {
    ...
    ampp.d(this.a);
    paramString = ampp.a(this.a).getResources().getString(2131718517);
    QQToast.a(ampp.a(this.a), 1, paramString, 0).b(ampp.b(this.a));
  }
  ...
  protected void a(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        QQToast.a(ampp.a(this.a), 1, paramString3, 0).b(ampp.b(this.a));
        bdzj.a(localStructMsg, paramInt3, paramString2, paramString4);
        return;
      }
      ...
      continue;
      label219:
      paramString3 = ampp.a(this.a).getResources().getString(2131717877);
      continue;
      label239:
      paramString1 = ampp.a(this.a).getResources().getString(2131692412);
      QQToast.a(ampp.a(this.a), 2, paramString1, 0).b(ampp.b(this.a));
      long l2 = bdzh.a().a();
      bdzj.a(localStructMsg, paramInt1, paramString2, paramInt2);
      if ((l2 != 0L) && (localStructMsg != null)) {}
      try
      {
        this.a.a.a().a(antf.M, 0, l2, localStructMsg.toByteArray());
        ...
        if (ajma.a(this.a.a, String.valueOf(localStructMsg.req_uin.get()), localStructMsg, false))
        {
        ...
        AutoRemarkActivity.a(ampp.a(this.a), 0, String.valueOf(localStructMsg.req_uin.get()), l1, paramString3);
        return;
      }
      catch (Exception paramString1)
      {
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    while ((!paramBoolean2) || (!ampp.a(this.a))) {
      return;
    }
    String str = ampp.a(this.a).getResources().getString(2131718508);
    QQToast.a(ampp.a(this.a), 1, str, 0).b(ampp.b(this.a));
  }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      ampp.e(this.a);
      return;
      if ((paramBoolean2) && (ampp.a(this.a)))
      {
        paramList = ampp.a(this.a).getResources().getString(2131718515);
        QQToast.a(ampp.a(this.a), 1, paramList, 0).b(ampp.b(this.a));
      }
    }
  }
  ...
  protected void b(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      if (ampp.a(this.a) != null) {
        ampp.a(this.a).finish();
      }
      return;
    }
    QQToast.a(ampp.a(this.a), 2131698467, 0).a();
  }
