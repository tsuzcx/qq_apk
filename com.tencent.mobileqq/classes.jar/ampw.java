...
public final class ampw
{
  ...
  {
    xmx.a(BaseApplicationImpl.getContext(), paramFile);
  }
  ...
  {
    bdiv.a(BaseApplicationImpl.getApplication().getSharedPreferences("ARRecordUtils_AR", 4).edit().putBoolean("ARVideoRecordPressKey12", paramBoolean));
  }
