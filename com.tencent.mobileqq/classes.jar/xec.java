  ...
  extends xee
{
  ...
  private List<xeb> jdField_a_of_type_JavaUtilList = new ArrayList();
  protected xdy a;
  private int b;
  
  public xec(Context paramContext)
  {
    super(paramContext);
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewView.findViewById(2131369913));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362797));
  ...
  public void a(xeb paramxeb)
  {
    ...
    if (this.jdField_a_of_type_Int != 0)
    {
      ...
      ((LinearLayout.LayoutParams)localObject2).setMargins(actj.a(15.0F, ((ImageView)localObject1).getResources()), 0, actj.a(15.0F, ((ImageView)localObject1).getResources()), 0);
    ...
    Object localObject2 = (ImageView)((View)localObject1).findViewById(2131369919);
    TextView localTextView = (TextView)((View)localObject1).findViewById(2131369932);
    if (localDrawable != null)
    {
      ...
      localTextView.setText(nat.a(str, 18, "..."));
    }
    for (;;)
    {
      ((View)localObject1).setOnClickListener(new xed(this, paramxeb.b(), paramxeb.a()));
      ((View)localObject1).setFocusable(true);
      ((View)localObject1).setClickable(true);
      paramxeb = new LinearLayout.LayoutParams(-1, -2, 1.0F);
      paramxeb.gravity = 17;
      ((View)localObject1).setLayoutParams(paramxeb);
