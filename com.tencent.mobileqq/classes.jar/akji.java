...
public class akji
  extends akhu
{
  akji(NewPhotoListActivity paramNewPhotoListActivity)
  {
  ...
  public void caseVideo(View paramView, int paramInt)
  {
    ...
    {
      paramView = bglp.a(this.mActivity, "请选择不超过" + (float)this.mPhotoCommonData.videoSizeLimit / 1024.0F / 1024.0F / 1024.0F + "G的视频");
    ...
    {
      paramView = bglp.a(this.mActivity, "请选择不超过" + this.mPhotoCommonData.videoDurationLimit / 60L / 1000L + "分钟的视频");
      paramView.setPositiveButton(2131694081, new bgmc());
      paramView.show();
      return;
    }
  ...
  public String getExceedMaxSelectNumStr(LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (this.mPhotoCommonData.showMediaType == 6) {
      return ((NewPhotoListActivity)this.mActivity).getResources().getString(2131694274, new Object[] { Integer.valueOf(i) });
    }
    if (this.mPhotoCommonData.showMediaType == 2) {
      return ((NewPhotoListActivity)this.mActivity).getResources().getString(2131694278, new Object[] { Integer.valueOf(i) });
    }
