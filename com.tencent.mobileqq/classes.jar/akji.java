  ...
  implements Manager
{
  ...
  public long a;
  private akjg jdField_a_of_type_Akjg;
  private akjt jdField_a_of_type_Akjt;
  private akjw jdField_a_of_type_Akjw;
  akkb jdField_a_of_type_Akkb;
  private aknq jdField_a_of_type_Aknq = new aknq();
  private akqb jdField_a_of_type_Akqb;
  private akqh jdField_a_of_type_Akqh;
  private akqu jdField_a_of_type_Akqu;
  akzo jdField_a_of_type_Akzo;
  alfx jdField_a_of_type_Alfx;
  Handler jdField_a_of_type_AndroidOsHandler = new akjl(this, ThreadManager.getSubThreadLooper());
  private awbw jdField_a_of_type_Awbw;
  bdvu jdField_a_of_type_Bdvu = new akjq(this);
  bkch jdField_a_of_type_Bkch = new akjp(this);
  private QQLruCache<String, ApolloBaseInfo> jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache = new akjj(this, 2009, 1024, ApolloBaseInfo.calcSelfMemorySize());
  ...
  Comparator<DrawerPushItem> jdField_a_of_type_JavaUtilComparator = new akjm(this);
  ...
  private List<akjs> jdField_b_of_type_JavaUtilList;
  private AtomicBoolean jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private bdvu jdField_c_of_type_Bdvu = new akjn(this);
  private Runnable jdField_c_of_type_JavaLangRunnable = new ApolloManager.5(this);
  private List<WeakReference<akju>> jdField_c_of_type_JavaUtilList = new ArrayList();
  public boolean c;
  public boolean d;
  ...
  public akji(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_b_of_type_Bdvu = new akjr(this);
    ...
    {
      this.jdField_a_of_type_Alfx = new alfx();
      q();
      akrg.b();
    ...
    this.jdField_a_of_type_Akkb = new akkb(paramQQAppInterface);
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramQQAppInterface);
    this.jdField_a_of_type_Akjg = new akjg(paramQQAppInterface);
    o();
  }
  
  public static int a()
  {
    if ((t) && (alee.jdField_e_of_type_Boolean)) {
      return 3;
    }
    return 2;
  }
    ...
    for (;;)
    {
      try
      {
        if (jdField_c_of_type_Int == -1)
        {
          ...
          {
            i1 = bdiv.q(paramAppInterface.getApplication());
            if (i1 != 0) {
              continue;
            }
  ...
  public static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    ApolloBaseInfo localApolloBaseInfo = ((akji)paramQQAppInterface.getManager(153)).a(paramQQAppInterface.c());
    int i1;
  ...
  {
    if ((paramQQAppInterface == null) || (!b(paramQQAppInterface.getApplication())) || (TextUtils.isEmpty(paramString1)) || (alee.jdField_a_of_type_OrgJsonJSONObject == null)) {
      return -1;
    }
    ...
    if (TextUtils.isEmpty(paramString2))
    {
      ...
      {
        paramString2 = (akji)paramQQAppInterface.getManager(153);
    ...
    if ((alee.jdField_a_of_type_OrgJsonJSONObject != null) && (str != null))
    {
      paramQQAppInterface = alee.jdField_a_of_type_OrgJsonJSONObject.optJSONObject(str);
      if (paramQQAppInterface == null) {}
    }
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return 0;
          paramQQAppInterface = ((akji)paramQQAppInterface.getManager(153)).a(paramString);
  ...
  public static void a(int paramInt, String paramString1, String paramString2, String paramString3)
  {
    ...
    localbkcj.jdField_e_of_type_JavaLangString = "tianshu.75";
    localbkcj.jdField_f_of_type_JavaLangString = "tianshu.75";
    localbkcj.g = paramString1;
    localbkcj.h = "";
    localbkcj.jdField_a_of_type_Long = l1;
    localbkcj.jdField_d_of_type_Int = paramInt;
    localbkcj.jdField_e_of_type_Int = 1;
    localbkcj.jdField_f_of_type_Int = 1;
    localbkcj.jdField_l_of_type_JavaLangString = paramString2;
    if (!TextUtils.isEmpty(paramString3)) {
      localbkcj.m = paramString3;
    }
    bkci.a().a(localbkcj);
  }
  ...
  {
    if ((paramList == null) || (paramList.size() == 0) || (this.jdField_a_of_type_Awbw == null)) {
    ...
    for (;;)
    {
      ...
      catch (Exception paramList)
      {
        for (;;)
        {
          ...
          this.jdField_a_of_type_Awbw.a(localDrawerPushItem);
        }
        localawby.c();
        return;
      }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    //   52: dup
    //   53: getstatic 781	alef:jdField_a_of_type_JavaLangString	Ljava/lang/String;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    Object localObject = (akji)paramQQAppInterface.getManager(153);
    bdpx localbdpx = (bdpx)paramQQAppInterface.a(71);
    ApolloBaseInfo localApolloBaseInfo = ((akji)localObject).b(paramString1 + "");
    if ((localApolloBaseInfo == null) || (localApolloBaseInfo.apolloUpdateTime == 0L))
    {
      localbdpx.b(paramString1 + "");
      if (QLog.isColorLevel()) {
    ...
    for (paramQQAppInterface = paramString1.substring(0, 4);; paramQQAppInterface = paramString1)
    {
      ...
      do
      {
        ...
        localObject = ((akji)localObject).b(paramQQAppInterface.c());
        ...
        localbdpx.a(localArrayList, paramString2);
  ...
  private void a(ApolloActionPackage paramApolloActionPackage, List<ApolloActionData> paramList)
  {
    ...
    for (int i1 = 1;; i1 = 0)
    {
      ...
      paramList = ((aleh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).a(paramApolloActionPackage.packageId);
  ...
  public static boolean a()
  {
    ...
    bdcs.a(new File(alef.c, "/def/basic").getAbsolutePath());
    do
    {
      try
      {
        long l2 = System.currentTimeMillis();
        a(BaseApplicationImpl.getApplication().getApplicationContext(), "apollo_def_rsc", alef.jdField_a_of_type_JavaLangString + "/apollo_def_rsc");
        long l3 = System.currentTimeMillis();
        if (QLog.isColorLevel()) {
          QLog.d("ApolloManager", 2, "copy file to sdcard cost:" + (l3 - l2));
        }
        new File(alef.c, "def").mkdirs();
        int i1 = LzmaUtils.a(BaseApplicationImpl.getApplication().getApplicationContext(), alef.jdField_a_of_type_JavaLangString + "/apollo_def_rsc", alef.c + "/def/");
        bdcs.d(alef.jdField_a_of_type_JavaLangString + "/apollo_def_rsc");
        if (i1 != 0) {
          continue;
        }
        boolean bool2 = true;
  ...
  {
    String str = alef.s + paramString1 + ".zip";
    localObject1 = alef.s + paramString1 + ".patch";
    localObject2 = alef.s + paramString1 + ".patched";
    ...
    for (;;)
    {
      try
      {
        if (jdField_d_of_type_Int == -1)
        {
          ...
          if (paramAppInterface != null)
          {
            i1 = bdiv.r(paramAppInterface.getApplication());
  ...
  public static int b(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            paramString = ((akji)localObject).a(paramString);
      ...
      localObject = ((akji)localObject).a(paramQQAppInterface.c());
  ...
  public static void b(boolean paramBoolean)
  {
    ...
    amly.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
  }
  ...
  public static int c(String paramString)
  {
    ...
    do
    {
      ...
      i2 = alee.b.optInt(paramString);
      i1 = i2;
    } while (i2 != 2);
    return jdField_e_of_type_Int;
    return alee.b.optInt(paramString);
  }
  ...
  private void c(TianShuAccess.RspEntry paramRspEntry)
  {
    ...
    Object localObject2 = (aleh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
    Object localObject3 = ((aleh)localObject2).a(i3);
    ...
    for (;;)
    {
      if (i2 < i4)
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject4))
        {
          ...
          if (localObject3 != null)
          {
            localObject5 = ((aleh)localObject2).a(i5);
            if (localObject5 != null)
            {
              ...
              ((aleh)localObject2).a((ApolloActionPackage)localObject5);
              g(i5);
  ...
  public static boolean d()
  {
    ...
    do
    {
      ...
      {
        return false;
        if (!alee.b.has("autoOpenBox")) {
          break;
        }
        if (QLog.isColorLevel()) {
          QLog.d("ApolloManager", 2, new Object[] { "openBoxByH5 autoOpenBox:", Integer.valueOf(alee.b.optInt("autoOpenBox")) });
        }
      } while (alee.b.optInt("autoOpenBox") != 0);
      return true;
    } while (!QLog.isColorLevel());
  ...
  public static boolean f()
  {
    ...
    try
    {
      String str = alef.av + "cmshow_script_engine.js";
      localFile = new File(str);
      bool1 = bool2;
      if (localFile.exists())
      {
        if (new algi(str + ".sig", str).a(1)) {
          break label181;
        }
    ...
    if (bool1)
    {
      jdField_d_of_type_JavaLangString = bdcs.b(localFile);
      return bool1;
    }
  ...
  public static boolean g()
  {
    ...
    try
    {
      String str = alef.av + "cmshow_script_0.js";
      localFile = new File(str);
      bool1 = bool2;
      if (localFile.exists())
      {
    ...
    if (bool1)
    {
      jdField_e_of_type_JavaLangString = bdcs.b(localFile);
      return bool1;
    }
  ...
  private void o()
  {
    this.jdField_a_of_type_Akjt = new akjt(this);
    IntentFilter localIntentFilter = new IntentFilter();
    localIntentFilter.addAction("com.tencent.mobileqq.action.ACTION_APOLLO_STORE_CRASH_EVENT");
    try
    {
      BaseApplicationImpl.getContext().registerReceiver(this.jdField_a_of_type_Akjt, localIntentFilter, "com.tencent.msg.permission.pushnotify", null);
      return;
    }
    catch (Exception localException)
    {
  ...
  private void r()
  {
    ...
    //   18: aload_0
    //   19: getfield 1940	akji:x	Z
    //   22: ifne +550 -> 572
    //   25: aload_0
    //   26: getfield 1940	akji:x	Z
    //   29: ifeq +4 -> 33
    //   32: return
    //   33: aload_0
    //   34: getfield 243	akji:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   37: ifnull +293 -> 330
    //   40: aload_0
    //   41: getfield 243	akji:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   52: lstore_3
    //   53: aload_0
    //   54: getfield 260	akji:jdField_a_of_type_Awbw	Lawbw;
    //   57: ldc 149
    //   59: invokevirtual 1943	awbw:a	(Ljava/lang/Class;)Ljava/util/List;
    ...
    //   152: aload_0
    //   153: getfield 158	akji:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   156: astore 6
    //   158: aload 6
    //   160: monitorenter
    //   161: aload_0
    //   162: getfield 158	akji:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   165: aload 8
    ...
    //   192: aload_0
    //   193: aload 8
    //   195: putfield 425	akji:jdField_a_of_type_ComTencentMobileqqDataApolloBaseInfo	Lcom/tencent/mobileqq/data/ApolloBaseInfo;
    //   198: aload_0
    //   199: aload_0
    //   200: getfield 425	akji:jdField_a_of_type_ComTencentMobileqqDataApolloBaseInfo	Lcom/tencent/mobileqq/data/ApolloBaseInfo;
    //   203: getfield 1959	com/tencent/mobileqq/data/ApolloBaseInfo:apolloAISwitch	I
    //   206: iconst_0
    //   207: invokevirtual 1962	akji:a	(II)V
    //   210: goto -125 -> 85
    //   213: astore 5
    ...
    //   236: ifeq -204 -> 32
    //   239: aload_0
    //   240: getfield 243	akji:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   243: ifnull -211 -> 32
    //   246: aload_0
    //   247: getfield 158	akji:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   250: aload_0
    //   251: getfield 243	akji:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   293: aload_0
    //   294: getfield 158	akji:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    ...
    //   345: athrow
    //   346: aload_0
    //   347: getfield 260	akji:jdField_a_of_type_Awbw	Lawbw;
    //   350: ldc_w 621
    //   353: invokevirtual 1943	awbw:a	(Ljava/lang/Class;)Ljava/util/List;
    //   356: checkcast 104	java/util/ArrayList
    //   359: astore 6
    //   361: aload 6
    //   363: ifnull +124 -> 487
    //   366: aload_0
    //   367: getfield 135	akji:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   370: astore 5
    //   372: aload 5
    //   374: monitorenter
    //   375: aload_0
    //   376: getfield 138	akji:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   434: aload_0
    //   435: aload 7
    //   437: invokevirtual 753	akji:a	(Lcom/tencent/mobileqq/DrawerPushItem;)Z
    //   440: ifne +31 -> 471
    //   443: aload_0
    //   444: getfield 138	akji:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   447: aload 7
    ...
    //   468: goto -253 -> 215
    //   471: aload_0
    //   472: getfield 260	akji:jdField_a_of_type_Awbw	Lawbw;
    //   475: aload 7
    //   477: invokevirtual 1976	awbw:b	(Lawbv;)Z
    //   480: pop
    //   481: goto -80 -> 401
    //   484: aload 5
    //   486: monitorexit
    //   487: aload_0
    //   488: getfield 243	akji:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   491: ifnull +61 -> 552
    //   494: aload_0
    //   495: getfield 243	akji:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   549: putfield 1982	akji:k	Ljava/lang/String;
    //   552: aload_0
    //   553: iconst_1
    //   554: putfield 1940	akji:x	Z
    //   557: goto -324 -> 233
    //   560: astore 5
    //   562: iconst_0
    //   563: istore_1
  ...
  private void s()
  {
    ...
    try
    {
      ??? = (ArrayList)this.jdField_a_of_type_Awbw.a(ApolloPandora.class);
      if (??? != null)
      {
  ...
  public akjg a()
  {
    return this.jdField_a_of_type_Akjg;
  }
  ...
  public akjw a()
  {
    ...
    {
      if (this.jdField_a_of_type_Akjw == null) {
        this.jdField_a_of_type_Akjw = new akjw(this, null);
      }
      return this.jdField_a_of_type_Akjw;
    }
    finally {}
  }
  ...
  public akkb a()
  {
    return this.jdField_a_of_type_Akkb;
  }
  
  public aknq a()
  {
    return this.jdField_a_of_type_Aknq;
  }
  ...
  public akqb a()
  {
    try
    {
      if (this.jdField_a_of_type_Akqb == null) {
        this.jdField_a_of_type_Akqb = new akqb(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      akqb localakqb = this.jdField_a_of_type_Akqb;
      return localakqb;
    }
    finally {}
  }
  ...
  public akqh a()
  {
    try
    {
      if (this.jdField_a_of_type_Akqh == null) {
        this.jdField_a_of_type_Akqh = new akqh(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      akqh localakqh = this.jdField_a_of_type_Akqh;
      return localakqh;
    }
    finally {}
  }
  ...
  public akqu a()
  {
    if (this.jdField_a_of_type_Akqu == null) {
      this.jdField_a_of_type_Akqu = new akqu(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
  ...
  public akzo a()
  {
    if (this.jdField_a_of_type_Akzo == null) {
      this.jdField_a_of_type_Akzo = new akjk(this);
    }
    return this.jdField_a_of_type_Akzo;
  }
  ...
  public bdwa a()
  {
    ...
    return ((bdvx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(47)).a(3);
  }
  ...
  public DrawerPushItem a(String paramString1, String paramString2, JSONObject paramJSONObject, boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      label496:
      if (paramInt == 1) {
        localDrawerPushItem.ext_url = alef.T;
      } else if (paramInt == 2) {
  ...
  public ApolloActionData a(QQAppInterface paramQQAppInterface, String paramString, int... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      akzg.a(paramQQAppInterface, ApolloUtil.a(paramString, 4), paramVarArgs);
  ...
  public ApolloPandora a(String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localApolloPandora = (ApolloPandora)this.jdField_a_of_type_Awbw.a(ApolloPandora.class, paramString);
      ??? = localApolloPandora;
  ...
  public String a()
  {
    if ((!this.f) && (!this.jdField_l_of_type_Boolean)) {
      return alpo.a(2131700836);
    }
    return alpo.a(2131700833);
  }
  ...
  public String a(int paramInt)
  {
    ...
    Object localObject1 = (aleh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
    if (((aleh)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() == 0) {
      ((aleh)localObject1).a();
    }
    for (;;)
    {
      localObject2 = (String)((aleh)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
      ...
      return localObject1;
      if (TextUtils.isEmpty((CharSequence)((aleh)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt)))) {
        ((aleh)localObject1).a(paramInt);
      }
    }
  }
  ...
  public String a(int paramInt, String paramString)
  {
    ...
    for (paramInt = 2;; paramInt = 1)
    {
      ...
      for (;;)
      {
        ...
        if (bool)
        {
          ...
          if (i2 == 1)
          {
            ...
            if (a() != null)
            {
              ...
              {
                localObject2 = localObject1;
                if (!TextUtils.isEmpty(alef.ao))
                {
                  localObject2 = alef.ao;
        ...
        {
          paramString = (String)localObject2;
          if (alef.ao.equals(localObject2)) {
  ...
  public String a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      for (long l1 = 0L; (localApolloBaseInfo.appearAction == null) && (NetConnInfoCenter.getServerTime() - l1 > 180L); l1 = ((Long)this.jdField_a_of_type_JavaUtilMap.get(paramString)).longValue())
      {
        ...
        ((bdpx)paramQQAppInterface.a(71)).a(new long[] { Long.parseLong(paramString) });
  ...
  public String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    if (paramString2.jdField_a_of_type_JavaLangString != null) {
      paramQQAppInterface = bhos.a(paramString1, "facedata", paramString2.jdField_a_of_type_JavaLangString);
    }
    paramString1 = paramQQAppInterface;
    if (paramString2.a() != null) {
      paramString1 = bhos.a(paramQQAppInterface, "dressids", Arrays.toString(paramString2.a()).replaceAll(" ", ""));
    }
    return bhos.a(paramString1, "roleid", String.valueOf(paramString2.jdField_a_of_type_Int));
  }
  ...
  public String a(String paramString, boolean paramBoolean)
  {
    ...
    return a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, alef.ao, paramString);
  }
  ...
  public void a(int paramInt)
  {
    ...
    if (a() != null)
    {
      localObject = new bdvv((List)localObject, localHashMap, "apollo_json_task" + System.currentTimeMillis());
      ((bdvv)localObject).p = true;
      ((bdvv)localObject).j = false;
      ((bdvv)localObject).n = true;
      ((bdvv)localObject).s = false;
      ((bdvv)localObject).jdField_f_of_type_JavaLangString = "apollo_res";
      ((bdvv)localObject).r = true;
      ((bdvv)localObject).q = true;
      a().a((bdvv)localObject, this.jdField_a_of_type_Bdvu, localBundle);
      if ((paramInt & 0x1) == 1) {
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (localaleh.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null) {
      localaleh.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt), paramString);
    }
  ...
  /* Error */
  public void a(akjs paramakjs)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 2393	akji:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   6: ifnonnull +17 -> 23
    //   9: aload_0
    ...
    //   20: putfield 2393	akji:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   23: aload_0
    //   24: getfield 2393	akji:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   27: astore_2
    //   28: aload_2
    //   29: monitorenter
    //   30: aload_0
    //   31: getfield 2393	akji:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   34: aload_1
  ...
  public void a(akju paramakju)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ApolloManager", 2, new Object[] { "[setApolloStatusUpdateListener] listener=", paramakju });
    }
    this.jdField_c_of_type_JavaUtilList.add(new WeakReference(paramakju));
  }
  ...
  public void a(algg paramalgg)
  {
    ...
    try
    {
      if (this.jdField_a_of_type_Alfx != null) {
        this.jdField_a_of_type_Alfx.a(paramalgg);
      }
      return;
    }
    finally
  ...
  public void a(DrawerPushItem paramDrawerPushItem, boolean paramBoolean)
  {
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if ((this.jdField_a_of_type_JavaUtilList != null) && (!a(paramDrawerPushItem)))
      {
        ...
        if ((this.jdField_a_of_type_Awbw != null) && (paramBoolean)) {
          this.jdField_a_of_type_Awbw.a(paramDrawerPushItem);
        }
        if (QLog.isColorLevel()) {
  ...
  {
    if ((paramSessionInfo.jdField_a_of_type_Int != 0) && (paramSessionInfo.jdField_a_of_type_Int != 1) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (bdee.g(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))) {}
    do
    {
      do
      {
  ...
  {
    if ((paramApolloActionData == null) && (!bdcs.a(ApolloUtil.a(paramApolloActionData, 7)))) {}
    while ((!a(bdcs.a(new File(ApolloUtil.a(paramApolloActionData, 7))), paramApolloActionData)) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ((aleh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155)).a(paramApolloActionData);
  }
  ...
  public void a(String paramString1, String paramString2, akjy paramakjy)
  {
    ...
    do
    {
      return;
      localbdwa = a();
    } while ((localbdwa == null) || (localbdwa.a(paramString1) != null));
    File localFile = new File(paramString2);
    paramString2 = new bdvv(paramString1, localFile);
    if (localFile.exists())
    {
    ...
    localbdwa.a(paramString2, new akjz(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramakjy), paramString1);
  }
  ...
  public void a(List<ApolloActionData> paramList, String paramString)
  {
    ...
    do
    {
      ...
      paramList = new bdvv(localArrayList, localHashMap, paramString);
      paramList.n = true;
    ...
    a().a(paramList, this.jdField_b_of_type_Bdvu, localBundle);
  }
  ...
  public void a(List<String> paramList, Map<String, File> paramMap, List<ApolloActionData> paramList1, Bundle paramBundle)
  {
    ...
    if (i1 < paramList1.size())
    {
      ...
      localObject = new bdvv(str1, new File((String)localObject));
      Bundle localBundle = new Bundle();
      localBundle.putSerializable(str1, localApolloActionData);
      ((bdvv)localObject).c = str1;
      ((bdvv)localObject).a(localBundle);
      this.jdField_b_of_type_Bdvu.onDoneFile((bdvv)localObject);
    }
    for (;;)
    {
  ...
  public void a(Map<String, ApolloPreDownloadData> paramMap)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          if ((localObject == null) || (((ApolloPreDownloadData)localObject).status == 0) || (localApolloPreDownloadData.version > ((ApolloPreDownloadData)localObject).version))
          {
            ...
            for (localObject = ApolloUtil.e(localApolloPreDownloadData.dirType) + localApolloPreDownloadData.zipDir;; localObject = alef.t + localApolloPreDownloadData.resId + ".zip")
            {
      ...
      paramMap = new bdvv(localArrayList, localHashMap, "apollo_preDownload");
      paramMap.n = true;
    ...
    a().a(paramMap, this.jdField_c_of_type_Bdvu, localBundle);
  }
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if ((paramBoolean) || (((paramInt & 0x1) == 1) && (!arof.a(ApolloUtil.jdField_a_of_type_JavaLangString))))
    {
      a(paramInt);
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((TextUtils.isEmpty(paramArrayOfByte)) || (alee.a("8.3.3", paramArrayOfByte) >= 0)) {
          break label334;
        }
  ...
  protected boolean a(awbv paramawbv)
  {
    ...
    QLog.e("ApolloManager", 2, "updateEntity em closed e=" + paramawbv.getTableName());
    return false;
  }
  ...
  public boolean a(ApolloActionData paramApolloActionData, int paramInt, algg paramalgg)
  {
    if (paramApolloActionData == null) {}
    for (;;)
    {
      ...
      if ((paramInt & 0x1) == 1)
      {
        ...
        {
          localObject1 = new bdvv((String)localObject1, new File((String)localObject2));
          ((bdvv)localObject1).jdField_f_of_type_JavaLangString = "apollo_res";
          ((bdvv)localObject1).jdField_b_of_type_Int = 1;
          ((bdvv)localObject1).n = true;
          ((bdvv)localObject1).q = true;
          ((bdvv)localObject1).r = true;
          i1 = bdvx.a((bdvv)localObject1, a());
          if (i1 != 0) {
            continue;
          }
          if (QLog.isColorLevel()) {
      ...
      if ((paramInt & 0x4) == 4)
      {
        ...
        {
          localObject2 = new bdvv((String)localObject2, new File((String)localObject1));
          ((bdvv)localObject2).jdField_f_of_type_JavaLangString = "apollo_res";
          ((bdvv)localObject2).jdField_b_of_type_Int = 1;
          ((bdvv)localObject2).n = true;
          ((bdvv)localObject2).q = true;
          ((bdvv)localObject2).r = true;
          paramInt = bdvx.a((bdvv)localObject2, a());
          if (paramInt != 0) {
            continue;
          }
          if (QLog.isColorLevel()) {
      ...
      try
      {
        bdcs.a((String)localObject1, ApolloUtil.a(paramApolloActionData, 6), false);
      ...
      catch (Exception localException)
      {
        ...
        paramalgg.b(paramApolloActionData);
      }
    }
    return true;
  }
  ...
  public boolean a(ApolloActionPackage paramApolloActionPackage)
  {
    ...
    do
    {
      ...
      paramApolloActionPackage = new bdvv(ApolloUtil.b(paramApolloActionPackage), new File(ApolloUtil.a(paramApolloActionPackage)));
      ...
      i1 = bdvx.a(paramApolloActionPackage, a());
    } while (i1 != 0);
    if (QLog.isColorLevel()) {
      QLog.d("ApolloManager", 2, "ret:" + i1);
    }
  ...
  public ApolloBaseInfo b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((0 == 0) && (!this.x))
      {
        ??? = (ApolloBaseInfo)this.jdField_a_of_type_Awbw.a(ApolloBaseInfo.class, paramString);
        if (bool) {
  ...
  public void b(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      i1 = bdiv.q(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication());
      if (i1 != 0) {
        break label139;
      }
  ...
  void b(int paramInt1, int paramInt2)
  {
    if ((!ApolloUtil.a(paramInt1, paramInt2)) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
    {
      ...
      akzg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, str);
    }
  }
  
  public void b(algg paramalgg)
  {
    if ((paramalgg != null) && (this.jdField_a_of_type_Alfx != null)) {
      this.jdField_a_of_type_Alfx.b(paramalgg);
    }
  }
    ...
    if (paramApolloActionData != null)
    {
      ...
      if (((File)localObject).exists()) {
        try
        {
          ...
          {
            boolean bool = arof.c(ApolloUtil.a(paramApolloActionData, 6));
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localDrawerPushItem.msg_id != null) && (localDrawerPushItem.msg_id.equals(paramString)))
        {
          ...
          this.jdField_a_of_type_Awbw.b(localDrawerPushItem);
          if (QLog.isColorLevel()) {
  ...
  public boolean b()
  {
    ...
    try
    {
      localObject1 = bdcs.b(new File(ApolloUtil.jdField_a_of_type_JavaLangString));
      if (QLog.isColorLevel())
      {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
        {
          localObject3 = (aleh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
          ((aleh)localObject3).a(false, localArrayList4);
          ((aleh)localObject3).b();
          ((aleh)localObject3).a(localArrayList1);
          ((aleh)localObject3).b(1);
          ((aleh)localObject3).c(localArrayList2);
          ((aleh)localObject3).d();
          ((aleh)localObject3).d(localArrayList3);
          if ((i1 == 0) && (!jdField_a_of_type_Boolean))
          {
            if (QLog.isColorLevel()) {
              QLog.e("ApolloManager", 1, "parseActionPanelJSon request getUserApolloInfo~");
            }
            ((bdpx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), 128, "refreshAction");
          }
          this.jdField_a_of_type_Alfx.a(Boolean.valueOf(true));
          m();
        }
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
        {
          ...
          if (!((SharedPreferences)localObject3).getBoolean("8.3.3" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false)) {
            ((SharedPreferences)localObject3).edit().putBoolean("8.3.3" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true).commit();
          }
          if (localObject1 != null)
          {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
          ((akji)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).l();
        }
      }
      catch (Exception localException)
      {
  ...
  public boolean b(ApolloActionPackage paramApolloActionPackage)
  {
    ...
    return arof.a(ApolloUtil.a(paramApolloActionPackage));
  }
  ...
  public void c(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      i1 = bdiv.r(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication());
      if (i1 != 0) {
        break label137;
      }
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    if (((paramInt1 & 0x1) != (paramInt2 & 0x1)) || ((paramInt1 & 0x2) != (paramInt2 & 0x2)))
    {
      ...
      if (this.jdField_c_of_type_JavaUtilList != null)
      {
        ...
        while (localIterator.hasNext())
        {
          akju localakju = (akju)((WeakReference)localIterator.next()).get();
          if (localakju != null) {
            localakju.a(paramInt1, bool);
          }
        }
      }
    }
  ...
  public void d(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (alee.a("8.3.3", str1, (String)localObject2))
      {
  ...
  public void h()
  {
    ...
    {
      return;
      localamly = (amly)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(115);
    } while ((localamly == null) || (!localamly.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()));
    QLog.w("ApolloManager", 1, "config is done, then request update");
    ArrayList localArrayList = new ArrayList();
    localamly.b(localArrayList);
    localamly.a(localArrayList);
    localamly.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(false);
  }
  
  public boolean h()
  {
    boolean bool = false;
    if ((BaseApplicationImpl.getContext().getSharedPreferences("apollo_sp", 0).getBoolean("is_new_user_bar_showed" + akro.a().getCurrentAccountUin(), false)) || (this.i)) {
      bool = true;
    }
    return bool;
  }
  ...
  {
    boolean bool = false;
    if ((BaseApplicationImpl.getContext().getSharedPreferences("apollo_sp", 0).getBoolean("is_780_guide_showed" + akro.a().getCurrentAccountUin(), false)) || (this.m)) {
      bool = true;
    }
    return bool;
  }
  ...
  public boolean k()
  {
    return this.jdField_a_of_type_Akqb != null;
  }
  ...
  public void l()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      ApolloActionData localApolloActionData = ((aleh)localObject).a(1450);
      if (localApolloActionData != null) {
        b(localApolloActionData.actionId, localApolloActionData.personNum);
      }
      localObject = ((aleh)localObject).a(1454);
      if (localObject != null) {
  ...
  public void m()
  {
    ...
    {
      Object localObject2 = (aleh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(155);
      localObject1 = ((aleh)localObject2).d(400);
      if (((aleh)localObject2).c(3000059) == null) {
        break label99;
      }
      if (localObject1 != null) {
        break label96;
  ...
  public void n()
  {
    ...
    localbkcg.jdField_a_of_type_Int = 364;
    localbkcg.jdField_b_of_type_Int = 1;
    localArrayList.add(localbkcg);
    localbkcg = new bkcg();
    localbkcg.jdField_a_of_type_Int = 365;
    localbkcg.jdField_b_of_type_Int = 1;
    localArrayList.add(localbkcg);
    localbkcg = new bkcg();
    localbkcg.jdField_a_of_type_Int = 366;
    localbkcg.jdField_b_of_type_Int = 1;
    localArrayList.add(localbkcg);
    localbkcg = new bkcg();
    localbkcg.jdField_a_of_type_Int = 367;
    localbkcg.jdField_b_of_type_Int = 1;
    localArrayList.add(localbkcg);
    localbkcg = new bkcg();
    localbkcg.jdField_a_of_type_Int = 393;
    localbkcg.jdField_b_of_type_Int = 1;
    localArrayList.add(localbkcg);
  ...
  public void onDestroy()
  {
    ...
    try
    {
      BaseApplicationImpl.getContext().unregisterReceiver(this.jdField_a_of_type_Akjt);
      ...
      jdField_d_of_type_Int = -1;
      this.jdField_a_of_type_Awbw.a();
      akzg.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
    ...
    catch (Exception localException1)
    {
      try
      {
        ...
        {
          this.jdField_a_of_type_Akkb.c();
          this.jdField_a_of_type_Akkb = null;
        }
        ApolloGameStateMachine.d();
        ApolloGameUtil.a();
        this.jdField_a_of_type_Akjg.b();
        akpq.a();
        aleb.a();
        if (this.jdField_a_of_type_Akqu != null) {
          this.jdField_a_of_type_Akqu.b();
        }
        if (this.jdField_a_of_type_Akqh != null)
        {
          this.jdField_a_of_type_Akqh.e();
          this.jdField_a_of_type_Akqh = null;
        }
        if (this.jdField_a_of_type_Akqb != null)
        {
          this.jdField_a_of_type_Akqb.c();
          this.jdField_a_of_type_Akqb = null;
        }
        j();
        akrg.a().a();
        aktx localaktx = akrg.a().a();
        if (localaktx != null) {
          localaktx.a();
        }
        alde.a().a();
