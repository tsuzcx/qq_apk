  ...
  implements aoal
{
  ...
  private aoam jdField_a_of_type_Aoam;
  ...
  private final String jdField_a_of_type_JavaLangString = amtj.a(2131699911);
  ...
  public aoan(View paramView)
  {
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.jdField_a_of_type_ComTencentMobileqqArARRecordARVideoRecordButtonView = ((ARVideoRecordButtonView)paramView.findViewById(2131370447));
    this.c = paramView.findViewById(2131364221);
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131362892);
    this.jdField_a_of_type_Boolean = aoae.a();
    if (this.jdField_a_of_type_Boolean) {
      this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    }
    this.c.setOnClickListener(null);
    this.c.setOnTouchListener(new aoao(this));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362894));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131362893));
  ...
  public void a(aoam paramaoam)
  {
    this.jdField_a_of_type_Aoam = paramaoam;
  }
