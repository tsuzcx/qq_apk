...
public class aoan
  implements Manager
{
  private static final LinkedList<aoap> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  ...
  private static void a(aoap paramaoap)
  {
    LinkedList localLinkedList = jdField_a_of_type_JavaUtilLinkedList;
    if (paramaoap != null) {}
    try
    {
      jdField_a_of_type_JavaUtilLinkedList.add(paramaoap);
      return;
    }
    finally {}
  }
  ...
  private static boolean b(aoap paramaoap)
  {
    localLinkedList = jdField_a_of_type_JavaUtilLinkedList;
    if (paramaoap != null) {}
    try
    {
      boolean bool = jdField_a_of_type_JavaUtilLinkedList.remove(paramaoap);
      return bool;
    }
    finally {}
    return false;
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Aoap = new aoao(this);
    a(this.jdField_a_of_type_Aoap);
  ...
  public List<PublicAccountInfo> a(List<PublicAccountInfo> paramList, long paramLong)
  {
    ...
    //   15: areturn
    //   16: aload_0
    //   17: getfield 185	aoan:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   20: ifnonnull +14 -> 34
    //   23: aload_0
    //   24: new 187	java/util/concurrent/ConcurrentHashMap
    //   27: dup
    //   28: invokespecial 230	java/util/concurrent/ConcurrentHashMap:<init>	()V
    //   31: putfield 185	aoan:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   34: aconst_null
    //   35: astore 4
    //   37: aload_0
    //   38: getfield 67	aoan:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    ...
    //   48: astore 4
    //   50: aload 4
    //   52: invokevirtual 239	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   55: aload_1
    //   56: ifnull +77 -> 133
    //   59: aload_1
    //   60: invokeinterface 245 1 0
    //   65: ifle +68 -> 133
    //   68: aload_1
    //   69: invokeinterface 246 1 0
    //   74: astore_1
    //   75: aload_1
    ...
    //   90: checkcast 190	com/tencent/mobileqq/data/PublicAccountInfo
    //   93: astore 5
    //   95: aload_0
    //   96: aload 5
    //   98: invokevirtual 249	aoan:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   101: pop
    //   102: aload_0
    //   103: getfield 185	aoan:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   106: aload 5
    //   108: invokevirtual 194	com/tencent/mobileqq/data/PublicAccountInfo:getUin	()Ljava/lang/String;
    //   111: aload 5
    //   113: invokevirtual 195	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   116: pop
    //   117: goto -42 -> 75
    //   120: astore_1
    //   121: aload 4
    //   123: invokevirtual 252	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   126: aload_0
    //   127: invokevirtual 254	aoan:c	()V
    //   130: aload 6
    //   132: areturn
    //   133: aload_0
    //   134: getfield 185	aoan:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   137: invokevirtual 203	java/util/concurrent/ConcurrentHashMap:entrySet	()Ljava/util/Set;
    //   140: invokeinterface 209 1 0
    //   145: astore_1
    //   146: aload_1
    ...
    //   161: checkcast 221	java/util/Map$Entry
    //   164: invokeinterface 224 1 0
    //   169: checkcast 190	com/tencent/mobileqq/data/PublicAccountInfo
    //   172: astore 5
    //   174: aload 5
    //   176: getfield 257	com/tencent/mobileqq/data/PublicAccountInfo:extendType	I
    //   179: iconst_2
    //   180: if_icmpne -34 -> 146
    //   183: aload 5
    //   185: getfield 261	com/tencent/mobileqq/data/PublicAccountInfo:dateTime	J
    //   188: lload_2
    //   189: lcmp
    //   190: ifge -44 -> 146
    //   193: aload_1
    ...
    //   199: aload_0
    //   200: getfield 67	aoan:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   203: aload 5
    //   205: invokevirtual 265	com/tencent/mobileqq/persistence/EntityManager:remove	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   208: pop
    //   209: aload 6
    //   211: aload 5
    //   213: invokeinterface 266 2 0
    //   218: pop
    //   219: goto -73 -> 146
    //   222: astore_1
    //   223: aload 4
    //   225: invokevirtual 252	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   228: aload_1
    //   229: athrow
    //   230: aload 4
    //   232: invokevirtual 269	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   235: aload 4
    //   237: invokevirtual 252	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   240: goto -114 -> 126
    //   243: astore_1
    //   244: aconst_null
    //   245: astore 4
  ...
  public List<PublicAccountInfo> a(List<PublicAccountInfo> paramList, long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 185	aoan:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   4: ifnonnull +28 -> 32
    //   7: aload_1
    //   8: ifnull +140 -> 148
    //   11: aload_1
    //   12: invokeinterface 245 1 0
    //   17: istore 6
    //   19: aload_0
    //   20: new 187	java/util/concurrent/ConcurrentHashMap
    //   23: dup
    //   24: iload 6
    //   26: invokespecial 273	java/util/concurrent/ConcurrentHashMap:<init>	(I)V
    //   29: putfield 185	aoan:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    ...
    //   42: astore 7
    //   44: aload_0
    //   45: getfield 67	aoan:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   48: invokevirtual 234	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   51: astore 8
    //   53: aload 8
    //   55: astore 7
    //   57: aload 7
    //   59: invokevirtual 239	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   62: aload_1
    //   63: ifnull +133 -> 196
    //   66: aload_1
    ...
    //   72: ifle +124 -> 196
    //   75: aload_1
    //   76: invokeinterface 246 1 0
    //   81: astore_1
    //   82: aload_1
    //   83: invokeinterface 215 1 0
    //   88: ifeq +108 -> 196
    //   91: aload_1
    //   92: invokeinterface 219 1 0
    //   97: checkcast 190	com/tencent/mobileqq/data/PublicAccountInfo
    //   100: astore 8
    //   102: aload_0
    //   103: aload 8
    //   105: invokevirtual 249	aoan:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   108: pop
    //   109: aload 8
    //   111: invokevirtual 276	com/tencent/mobileqq/data/PublicAccountInfo:isNeedShow	()Z
    //   114: ifeq +40 -> 154
    //   117: aload_0
    //   118: getfield 185	aoan:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   121: aload 8
    //   123: invokevirtual 194	com/tencent/mobileqq/data/PublicAccountInfo:getUin	()Ljava/lang/String;
    //   126: aload 8
    //   128: invokevirtual 195	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   131: pop
    //   132: goto -50 -> 82
    //   135: astore_1
    //   136: aload 7
    //   138: invokevirtual 252	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   141: aload_0
    //   142: invokevirtual 254	aoan:c	()V
    //   145: aload 9
    //   147: areturn
    //   148: iconst_0
    //   149: istore 6
    //   151: goto -132 -> 19
    //   154: aload_0
    //   155: getfield 185	aoan:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   158: aload 8
    //   160: invokevirtual 194	com/tencent/mobileqq/data/PublicAccountInfo:getUin	()Ljava/lang/String;
    //   163: invokevirtual 278	java/util/concurrent/ConcurrentHashMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   166: pop
    //   167: aload 8
    //   169: invokevirtual 281	com/tencent/mobileqq/data/PublicAccountInfo:isVisible	()Z
    //   172: ifne -90 -> 82
    //   175: aload 9
    //   177: aload 8
    //   179: invokeinterface 266 2 0
    //   184: pop
    //   185: goto -103 -> 82
    //   188: astore_1
    //   189: aload 7
    //   191: invokevirtual 252	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   194: aload_1
    //   195: athrow
    //   196: iload 4
    //   198: ifne +96 -> 294
    ...
    //   203: ifeq +91 -> 294
    //   206: aload_0
    //   207: getfield 185	aoan:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   210: invokevirtual 203	java/util/concurrent/ConcurrentHashMap:entrySet	()Ljava/util/Set;
    //   213: invokeinterface 209 1 0
    //   218: astore_1
    //   219: aload_1
    //   220: invokeinterface 215 1 0
    //   225: ifeq +69 -> 294
    //   228: aload_1
    //   229: invokeinterface 219 1 0
    //   234: checkcast 221	java/util/Map$Entry
    //   237: invokeinterface 224 1 0
    //   242: checkcast 190	com/tencent/mobileqq/data/PublicAccountInfo
    //   245: astore 8
    //   247: aload 8
    //   249: getfield 257	com/tencent/mobileqq/data/PublicAccountInfo:extendType	I
    //   252: ifne -33 -> 219
    //   255: aload 8
    //   257: getfield 261	com/tencent/mobileqq/data/PublicAccountInfo:dateTime	J
    //   260: lload_2
    //   261: lcmp
    //   262: ifge -43 -> 219
    //   265: aload_1
    //   266: invokeinterface 263 1 0
    //   271: aload_0
    //   272: getfield 67	aoan:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   275: aload 8
    //   277: invokevirtual 265	com/tencent/mobileqq/persistence/EntityManager:remove	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   280: pop
    //   281: aload 9
    //   283: aload 8
    //   285: invokeinterface 266 2 0
    //   290: pop
    //   291: goto -72 -> 219
    //   294: aload 7
    //   296: invokevirtual 269	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   299: aload 7
    //   301: invokevirtual 252	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   304: goto -163 -> 141
    //   307: astore_1
    //   308: aconst_null
    //   309: astore 7
  ...
  public void a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 284	aoan:jdField_a_of_type_Boolean	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifeq +6 -> 14
    //   11: aload_0
    ...
    //   13: return
    //   14: aload_0
    //   15: invokevirtual 286	aoan:d	()V
    //   18: aload_0
    //   19: invokevirtual 254	aoan:c	()V
    //   22: aload_0
    //   23: invokevirtual 289	aoan:f	()V
    //   26: aload_0
    //   27: invokevirtual 292	aoan:e	()V
    //   30: aload_0
    //   31: iconst_1
    //   32: putfield 284	aoan:jdField_a_of_type_Boolean	Z
    //   35: invokestatic 297	uqx:a	()Luqx;
    //   38: aload_0
    //   39: getfield 69	aoan:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   42: aload_0
    //   43: invokevirtual 299	aoan:a	()Ljava/util/List;
    //   46: invokevirtual 302	uqx:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/util/List;)V
    //   49: invokestatic 307	uot:a	()Luot;
    //   52: aload_0
    //   53: getfield 69	aoan:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   56: invokevirtual 309	uot:b	(Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   59: aload_0
    //   60: getfield 69	aoan:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   78: aconst_null
    //   79: ldc_w 322
    //   82: invokevirtual 325	onq:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   85: aload_0
    //   86: invokespecial 327	aoan:h	()V
    //   89: goto -78 -> 11
    //   92: astore_2
    //   93: aload_0
    //   94: monitorexit
  ...
  public void a(ArrayList<MessageRecord> paramArrayList, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        {
          uuc.a(paramQQAppInterface, BaseApplication.getContext(), null, ((Long)localObject).toString());
  ...
  public void a(List<PublicRecommendAccountInfo> paramList)
  {
    ...
    //   1: ifnull +88 -> 89
    //   4: aload_1
    //   5: invokeinterface 245 1 0
    //   10: ifle +79 -> 89
    //   13: aconst_null
    //   14: astore_2
    //   15: aload_0
    //   16: getfield 67	aoan:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   19: invokevirtual 234	com/tencent/mobileqq/persistence/EntityManager:getTransaction	()Lcom/tencent/mobileqq/persistence/EntityTransaction;
    //   22: astore_3
    //   23: aload_3
    //   24: astore_2
    //   25: aload_2
    //   26: invokevirtual 239	com/tencent/mobileqq/persistence/EntityTransaction:begin	()V
    //   29: aload_0
    //   30: getfield 67	aoan:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   33: ldc_w 436
    //   36: invokevirtual 440	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;)Ljava/util/List;
    //   39: astore_3
    //   40: aload_3
    //   41: ifnull +49 -> 90
    //   44: aload_3
    ...
    //   66: checkcast 436	com/tencent/mobileqq/data/PublicRecommendAccountInfo
    //   69: astore 4
    //   71: aload_0
    //   72: getfield 67	aoan:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   75: aload 4
    //   77: invokevirtual 265	com/tencent/mobileqq/persistence/EntityManager:remove	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   80: pop
    //   81: goto -30 -> 51
    //   84: astore_1
    //   85: aload_2
    //   86: invokevirtual 252	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   89: return
    //   90: aload_1
    ...
    //   112: checkcast 436	com/tencent/mobileqq/data/PublicRecommendAccountInfo
    //   115: astore 4
    //   117: aload_0
    //   118: getfield 67	aoan:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   121: aload 4
    //   123: invokevirtual 444	com/tencent/mobileqq/persistence/EntityManager:persist	(Lcom/tencent/mobileqq/persistence/Entity;)V
    //   126: goto -29 -> 97
    //   129: astore_1
    //   130: aload_2
    //   131: invokevirtual 252	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   134: aload_1
    //   135: athrow
    //   136: aload_0
    //   137: getfield 48	aoan:jdField_c_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   140: ifnull +3 -> 143
    //   143: aload_0
    //   144: aload_1
    //   145: checkcast 41	java/util/ArrayList
    //   148: putfield 48	aoan:jdField_c_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   151: aload_2
    //   152: invokevirtual 269	com/tencent/mobileqq/persistence/EntityTransaction:commit	()V
    //   155: aload_2
    //   156: invokevirtual 252	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   159: return
    //   160: astore_1
    //   161: aconst_null
    //   162: astore_2
  ...
  {
    paramSessionInfo = b(paramSessionInfo.curFriendUin);
    return (paramSessionInfo != null) && (uuc.a(paramSessionInfo.accountFlag2) == -10L);
  }
  ...
  public void d()
  {
    ...
    for (int i = ((List)localObject2).size();; i = 0)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        {
          if ((!uuc.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) || (!TextUtils.equals(localPublicAccountInfo.getUin(), AppConstants.OLD_KANDIAN_UIN))) {
