  ...
  extends xop
{
  ...
  public awzr(AppInterface paramAppInterface)
  {
      ...
      if (i1 == 3)
      {
        ...
        try
        {
          ...
          for (;;)
          {
            ...
            ((SummaryCardBusiEntry.comm)localObject3).qqver.set("8.2.8.4440");
            ...
            localObject5[0] = 40;
            bbmj.a((byte[])localObject5, 1, k);
            bbmj.a((byte[])localObject5, 5, i4);
            bbmj.a((byte[])localObject5, 9, (byte[])localObject3, k);
            int m = localObject3.length + 9;
            k = m;
            if (localObject4 != null)
            {
              bbmj.a((byte[])localObject5, m, (byte[])localObject4, i4);
              k = m + i4;
            }
            localObject5[k] = 41;
  ...
  private boolean D(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    {
      localByteBuffer.putInt(ajty.a(localObject3[0]));
      localByteBuffer.putInt(ajty.a(localObject3[1]));
      localByteBuffer.putInt(ajty.a(localObject3[2]));
      localByteBuffer.putInt(ajty.a(localObject3[3]));
      localObject3 = ByteBuffer.allocate(16);
      if ((localObject2 == null) || (localObject2.length != 4)) {
        break label482;
      }
      ((ByteBuffer)localObject3).putInt(ajty.a(localObject2[0]));
      ((ByteBuffer)localObject3).putInt(ajty.a(localObject2[1]));
      ((ByteBuffer)localObject3).putInt(ajty.a(localObject2[2]));
      ((ByteBuffer)localObject3).putInt(ajty.a(localObject2[3]));
    }
    for (;;)
    {
      short s2 = (short)k;
  ...
  public static ReqSummaryCard a(ToServiceMsg paramToServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      if (!bool)
      {
        localObject4 = new SSummaryCardQueryReq(1, Long.parseLong(paramToServiceMsg.getUin()), l2, "8.2.8", k, 109L);
        ...
        try
        {
          ...
          if ((l2 > 0L) || (bool))
          {
            ...
            if (l1 == l2)
            {
              ...
              ((SummaryCardBusiEntry.comm)localObject8).qqver.set("8.2.8.4440");
              ((SummaryCardBusiEntry.comm)localObject8).build.set(i);
              if (((BusinessBuff)localObject7).a() == 17)
              {
              ...
              Object localObject9 = new byte[i1 + 9 + j + 1];
              localObject9[0] = 40;
              bbmj.a((byte[])localObject9, 1, i1);
              bbmj.a((byte[])localObject9, 5, j);
              bbmj.a((byte[])localObject9, 9, (byte[])localObject8, i1);
              j = localObject8.length + 9;
              if (((BusinessBuff)localObject7).a() == null) {
                break label1039;
              }
              bbmj.a((byte[])localObject9, j, ((BusinessBuff)localObject7).a(), ((BusinessBuff)localObject7).a().length);
  ...
  public static ArrayList<afgx> a(ArrayList<byte[]> paramArrayList)
  {
    ...
    if (i < k)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          break label53;
          n = (int)bbmj.a((byte[])localObject1, 1);
          m = (int)bbmj.a((byte[])localObject1, 5);
        } while ((n <= 0) || (n + 9 >= j));
        localObject2 = new byte[n];
        bbmj.a((byte[])localObject2, 0, (byte[])localObject1, 9, n);
        j = n + 9;
        ...
        for (;;)
        {
          try
          {
            ...
            bbmj.a((byte[])localObject2, 0, (byte[])localObject1, j, m);
            localObject1 = new AccountSearchPb.search();
            ((AccountSearchPb.search)localObject1).mergeFrom((byte[])localObject2);
            localObject2 = new afgx();
            ((afgx)localObject2).jdField_a_of_type_Int = n;
            ((afgx)localObject2).jdField_b_of_type_Int = ((AccountSearchPb.search)localObject1).start.get();
            if (((AccountSearchPb.search)localObject1).end.get() != 1) {
              break label496;
            }
            bool = true;
            ((afgx)localObject2).jdField_a_of_type_Boolean = bool;
            ((afgx)localObject2).jdField_b_of_type_JavaUtilList = ((AccountSearchPb.search)localObject1).list.get();
            ((afgx)localObject2).jdField_a_of_type_JavaUtilList = ((AccountSearchPb.search)localObject1).highlight.get();
            ((afgx)localObject2).jdField_a_of_type_JavaLangString = ((AccountSearchPb.search)localObject1).article_more_url.get();
            ((afgx)localObject2).jdField_a_of_type_ComTencentPbAddcontactsAccountSearchPb$hotwordrecord = ((AccountSearchPb.hotwordrecord)((AccountSearchPb.search)localObject1).hotword_record.get());
            ((afgx)localObject2).jdField_c_of_type_JavaUtilList = ((AccountSearchPb.search)localObject1).result_items.get();
            ((afgx)localObject2).jdField_b_of_type_Boolean = ((AccountSearchPb.search)localObject1).bool_keyword_suicide.get();
            if (((((afgx)localObject2).jdField_b_of_type_JavaUtilList == null) || (((afgx)localObject2).jdField_b_of_type_JavaUtilList.size() <= 0)) && ((((afgx)localObject2).jdField_c_of_type_JavaUtilList == null) || (((afgx)localObject2).jdField_c_of_type_JavaUtilList.size() <= 0)) && (!((afgx)localObject2).jdField_b_of_type_Boolean)) {
              break;
            }
    ...
    for (int j = 1;; j = 2)
    {
      ((afgx)localObject2).jdField_c_of_type_Int = j;
      break;
      if (!QLog.isDevelopLevel()) {
        break;
      }
  ...
  private boolean e(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    boolean bool = ((ajxn)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(51)).b(String.valueOf(l));
  ...
  private boolean g(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    paramToServiceMsg.vClientVersion = "8.2.8".getBytes();
  ...
  private Object p(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    ...
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.vUserList != null) && (!paramFromServiceMsg.vUserList.isEmpty()))
    {
      ...
      while (i < paramFromServiceMsg.vUserList.size())
      {
        ...
        String str1 = ajty.a(paramToServiceMsg.dwCountry);
        String str2 = ajty.a(paramToServiceMsg.dwProvince);
        String str3 = ajty.a(paramToServiceMsg.dwCity);
        paramToServiceMsg.locDesc = ((ajty)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(59)).b(new String[] { str1, str2, str3, "0" });
        i += 1;
      }
    }
    return paramFromServiceMsg;
  ...
  private boolean q(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    localObject = new ReqVoiceManage(i, new VoiceInfo(bazo.a((String)localObject), s, (byte)0, null), l);
    SummaryCard.ReqHead localReqHead = new SummaryCard.ReqHead();
    localReqHead.iVersion = 2;
    paramUniPacket.setServantName("SummaryCardServantObj");
  ...
  private boolean t(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        ...
        localSSummaryCardSetLabel.version = "8.2.8";
  ...
  private boolean u(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    try
    {
      ...
      localSSummaryCardLikeIt.version = "8.2.8";
      paramUniPacket.setServantName("SummaryCard");
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (paramToServiceMsg.getServiceCmd().equals("EncounterSvc.ReqGetEntrance")) {
      bool = j(paramToServiceMsg, paramUniPacket);
    }
    do
    {
      return bool;
