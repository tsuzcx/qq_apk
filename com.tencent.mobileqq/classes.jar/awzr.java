...
public class awzr
  implements awzn
{
  private aubn jdField_a_of_type_Aubn;
  private aubo jdField_a_of_type_Aubo;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  
  public awzr(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private aubm a(int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      if (this.jdField_a_of_type_Aubn == null) {
        this.jdField_a_of_type_Aubn = new aubn(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      localObject1 = this.jdField_a_of_type_Aubn;
    }
    for (;;)
    {
      ...
      if (localObject1 == null)
      {
        ...
        localObject2 = this.jdField_a_of_type_Aubn;
      }
      return localObject2;
      if (paramInt == 2)
      {
      ...
      else if (paramInt == 3)
      {
        if (this.jdField_a_of_type_Aubo == null) {
          this.jdField_a_of_type_Aubo = new aubo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        }
        localObject1 = this.jdField_a_of_type_Aubo;
      }
    }
  }
  
  private aubm a(MessageRecord paramMessageRecord)
  {
    ...
    if (paramMessageRecord.isMultiMsg)
    {
      ...
      if (!TextUtils.isEmpty(paramMessageRecord))
      {
        ...
        localObject = this.jdField_a_of_type_Aubo;
      }
    }
    for (;;)
    {
      ...
      localObject = this.jdField_a_of_type_Aubn;
      continue;
  ...
  public axaa a(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    ...
    localaxaa.a = a(Integer.parseInt(str)).a(paramMessageRecord, paramMsgBackupResEntity);
    return localaxaa;
  }
  
  public String a(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    paramMessageRecord = new File(aubm.b);
    if (!paramMessageRecord.exists()) {
      paramMessageRecord.mkdirs();
    }
    paramMessageRecord = new File(aubm.a);
    if (!paramMessageRecord.exists()) {
      paramMessageRecord.mkdirs();
    }
  ...
  {
    aubm localaubm = a(paramMessageRecord);
    if (localaubm != null) {
      localaubm.a(paramMessageRecord, paramList);
    }
  }
  ...
  public void b(MessageRecord paramMessageRecord, List<MsgBackupResEntity> paramList)
  {
    aubm localaubm = a(paramMessageRecord);
    if (localaubm != null) {
      localaubm.b(paramMessageRecord, paramList);
    }
  }
}
