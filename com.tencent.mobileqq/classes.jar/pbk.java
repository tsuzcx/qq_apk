...
{
  pqc a(String paramString, List<pqc> paramList)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      pqc localpqc = (pqc)paramList.next();
      if (localpqc.jdField_a_of_type_JavaLangString.equals(paramString)) {
        return localpqc;
      }
    }
    return null;
      ...
      catch (JSONException localJSONException1)
      {
        for (;;)
        {
          try
          {
            ...
            {
              localArrayList.add(pqc.a(((JSONArray)localObject1).optJSONObject(paramInt1)));
              paramInt1 += 1;
              continue;
            }
            ...
            {
              paramInt1 = 0;
              localObject1 = new pqc();
            }
            ((pqc)localObject1).jdField_b_of_type_JavaLangString = arrayOfString[0];
            ((pqc)localObject1).jdField_a_of_type_JavaLangString = ((String)localObject5);
            localObject3 = arrayOfString[1].split(",");
            localObject5 = arrayOfString[2].split(",");
            ((pqc)localObject1).jdField_b_of_type_JavaUtilList = new ArrayList();
            ((pqc)localObject1).jdField_a_of_type_JavaUtilList = new ArrayList();
            ((pqc)localObject1).jdField_b_of_type_JavaUtilList.add("");
            ((pqc)localObject1).jdField_a_of_type_JavaUtilList.add("");
            paramInt2 = 0;
            if (paramInt2 >= localObject3.length) {
              continue;
            }
            ((pqc)localObject1).jdField_a_of_type_JavaUtilList.add(localObject3[paramInt2]);
            paramInt2 += 1;
            continue;
