...
public class bcwz
{
  ...
  private static String b = bcwx.a(bcwx.v);
  ...
  public static int a(String paramString1, String paramString2)
  {
    ...
    //   8: iload_3
    //   9: istore_2
    //   10: getstatic 13	bcwz:a	Ljava/lang/String;
    //   13: invokestatic 38	bcwz:a	(Ljava/lang/String;)Ljava/security/PublicKey;
    //   16: astore 11
    //   18: aload 11
    //   20: ifnonnull +33 -> 53
    //   23: sipush 129
    ...
    //   168: istore_2
    //   169: aload_0
    //   170: invokestatic 67	bcwy:a	(Ljava/lang/String;)Ljava/util/Map;
    //   173: astore 10
    //   175: aload 10
    ...
    //   264: ifeq -213 -> 51
    //   267: getstatic 26	bcwz:b	Ljava/lang/String;
    //   270: iconst_2
    ...
    //   486: aload 13
    //   488: aload 11
    //   490: invokestatic 133	bcwz:a	([B[BLjava/security/PublicKey;)Z
    //   493: ifne +10 -> 503
    //   496: sipush 137
    //   499: istore_2
    //   500: goto -261 -> 239
    ...
    //   686: iconst_1
    //   687: aaload
    //   688: invokestatic 154	bcwy:a	(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)I
    //   691: istore 4
    //   693: iload 4
    //   695: ifeq +208 -> 903
    //   698: iconst_0
  ...
  private static PublicKey a(String paramString)
  {
    ...
    try
    {
      paramString = KeyFactory.getInstance(bcwy.a).generatePublic(paramString);
      return paramString;
    }
  ...
  private static boolean a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, PublicKey paramPublicKey)
  {
    try
    {
      Signature localSignature = Signature.getInstance(bcwy.b);
