...
public class rhg
  extends BaseAdapter
{
  private List<rpg> jdField_a_of_type_JavaUtilList;
  
  private rhg(ComponentContentRecommendFollowGroup paramComponentContentRecommendFollowGroup) {}
  
  public void a(List<rpg> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(paramViewGroup.getContext()).inflate(2131560304, paramViewGroup, false);
      paramView = new rhh(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentContentRecommendFollowGroup, null);
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131367915));
      paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131367107));
      paramView.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131367098));
      paramView.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131367888));
      ...
      while (i < paramView.jdField_b_of_type_AndroidWidgetLinearLayout.getChildCount())
      {
        ...
        paramView.jdField_a_of_type_ArrayOfAndroidWidgetRelativeLayout[i] = ((RelativeLayout)((RelativeLayout)localObject1).findViewById(2131368095));
        paramView.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i] = ((ImageView)((RelativeLayout)localObject1).findViewById(2131368086));
        paramView.jdField_b_of_type_ArrayOfAndroidWidgetImageView[i] = ((ImageView)((RelativeLayout)localObject1).findViewById(2131380661));
        paramView.c[i] = ((ImageView)((RelativeLayout)localObject1).findViewById(2131377987));
        paramView.jdField_a_of_type_ArrayOfAndroidWidgetTextView[i] = ((TextView)((RelativeLayout)localObject1).findViewById(2131371989));
      ...
      paramView.jdField_a_of_type_Rpg = ((rpg)this.jdField_a_of_type_JavaUtilList.get(paramInt));
      paramView.jdField_a_of_type_AndroidWidgetTextView.setText(paramView.jdField_a_of_type_Rpg.jdField_a_of_type_JavaLangString);
      i = 0;
      if (i >= paramView.jdField_a_of_type_Rpg.jdField_a_of_type_JavaUtilList.size()) {
        break label611;
      }
      localObject1 = (RecommendFollowInfo)paramView.jdField_a_of_type_Rpg.jdField_a_of_type_JavaUtilList.get(i);
    ...
    for (int j = 0;; j = 8)
    {
      ...
      i += 1;
      break label325;
      localObject1 = (rhh)paramView.getTag();
      localView = paramView;
      paramView = (View)localObject1;
      break;
      paramView.jdField_a_of_type_ArrayOfAndroidWidgetImageView[i].setImageDrawable(bheg.b());
      break label473;
      j = 8;
      break label493;
    }
    ...
    int i = 0;
    if (i < paramView.jdField_a_of_type_Rpg.jdField_a_of_type_JavaUtilList.size()) {
      if (((RecommendFollowInfo)paramView.jdField_a_of_type_Rpg.jdField_a_of_type_JavaUtilList.get(i)).isFollowed) {}
    }
    for (i = k;; i = 1)
    {
      if (i != 0)
      {
        paramView.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131701754));
        paramView.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-8947849);
        paramView.jdField_a_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130849451);
      }
      for (;;)
      {
        ...
        i += 1;
        break;
        paramView.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131701789));
        paramView.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-1);
        paramView.jdField_a_of_type_AndroidWidgetLinearLayout.setBackgroundResource(2130849408);
      }
    }
  }
}
