...
class axta
{
  ...
  private axte jdField_b_of_type_Axte;
  public String b;
  public String c;
  
  public axta(axsy paramaxsy)
  {
    this.jdField_a_of_type_Axte = new axte(axsy.a(paramaxsy), axsy.a(paramaxsy));
    this.jdField_b_of_type_Axte = new axte(axsy.b(paramaxsy), axsy.b(paramaxsy));
  }
  ...
  public Pair<Boolean, List<axtf>> a(PowerManager.WakeLock paramWakeLock, String paramString, long paramLong)
  {
    boolean bool = false;
    ...
    return new Pair(Boolean.valueOf(bool), this.jdField_b_of_type_Axte.a(paramString));
  }
