...
public class nft
  extends ajfb
{
  public nft(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b(byte[] paramArrayOfByte)
  {
    ...
    if ((paramArrayOfByte != null) && (paramArrayOfByte.bindlist.has()))
    {
      ...
      if ((paramArrayOfByte != null) && (!paramArrayOfByte.isEmpty()))
      {
        ...
        {
          nfp.a.put(String.valueOf(paramArrayOfByte.puin.get()), String.valueOf(paramArrayOfByte.binduin.get()));
  ...
  public void a(String paramString)
  {
    ...
    paramString = new NewIntent(this.app.getApp(), nfv.class);
