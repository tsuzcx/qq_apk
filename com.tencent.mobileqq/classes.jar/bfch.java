...
public class bfch
{
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, Context paramContext, Intent paramIntent, int paramInt)
  {
    ...
    bfcz localbfcz = (bfcz)paramQQAppInterface.getManager(27);
    if (localbfcz == null) {
      return false;
    }
    if (localbfcz.isPlugininstalled("group_video_plugin.apk")) {
