  ...
  extends nkq
{
  ...
  public olp(ReadInJoySettingActivity paramReadInJoySettingActivity, boolean paramBoolean)
  {
    this.b = paramBoolean;
  }
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    try
    {
      QQToast.a(this.a.getApplicationContext(), 2131717375, 0).a();
    ...
    if ((paramBundle.msg_set_flag_info_rsp.has()) && (paramBundle.msg_set_flag_info_rsp.rpt_msg_flag_info_list.has()))
    {
      ...
      if ((this.b) && (j == 1))
      {
        QQToast.a(this.a.getApplicationContext(), 2131717377, 0).a();
      ...
      if ((!this.b) && (j == 0))
      {
        QQToast.a(this.a.getApplicationContext(), 2131717376, 0).a();
