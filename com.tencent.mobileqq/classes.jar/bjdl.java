...
public class bjdl
{
  private static bjdl jdField_a_of_type_Bjdl;
  ...
  public static bjdl a()
  {
    if (jdField_a_of_type_Bjdl == null) {}
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (jdField_a_of_type_Bjdl == null) {
        jdField_a_of_type_Bjdl = new bjdl();
      }
      return jdField_a_of_type_Bjdl;
    }
  }
  ...
  public String a()
  {
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_JavaLangString = bhsp.a("52b7f2");
    }
  ...
  public String c()
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      ((StringBuilder)localObject2).append("mm=").append(bdgk.d() / 1048576L).append('&');
      ((StringBuilder)localObject2).append("cf=").append(bdgk.a()).append('&');
      ((StringBuilder)localObject2).append("cc=").append(bdgk.b()).append('&');
      ((StringBuilder)localObject2).append("aid=").append(bdgk.f()).append('&');
  ...
  public String f()
  {
    ...
    ((StringBuilder)localObject).append("mm=").append(bdgk.d() / 1048576L).append('&');
    ((StringBuilder)localObject).append("cf=").append(bdgk.a()).append('&');
    ((StringBuilder)localObject).append("cc=").append(bdgk.b()).append('&');
    ((StringBuilder)localObject).append("qqversion=").append("8.3.5");
