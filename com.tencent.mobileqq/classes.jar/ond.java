...
public class ond
{
  private static ond jdField_a_of_type_Ond;
  ...
  private List<one> jdField_b_of_type_JavaUtilList = new ArrayList();
  ...
  private String a(one paramone, BaseArticleInfo paramBaseArticleInfo, TemplateBean paramTemplateBean, ViewBase paramViewBase)
  {
    if (paramBaseArticleInfo == null) {
      return "";
    }
    if ((TextUtils.isEmpty(paramone.jdField_b_of_type_JavaLangString)) || (TextUtils.isEmpty(paramone.c)) || (TextUtils.isEmpty(paramone.jdField_a_of_type_JavaLangString))) {
      return "";
    }
    String str3 = paramone.jdField_a_of_type_JavaLangString;
    String str1 = paramone.jdField_b_of_type_JavaLangString;
    String str2 = paramone.c;
  ...
  public static ond a()
  {
    try
    {
      if (jdField_a_of_type_Ond == null) {
        jdField_a_of_type_Ond = new ond();
      }
      ond localond = jdField_a_of_type_Ond;
      return localond;
    }
    finally {}
  }
  
  private one a(oidb_cmd0x64e.SRTRule paramSRTRule)
  {
    if (paramSRTRule == null) {
      return null;
    }
    one localone = new one(this);
    if (paramSRTRule.uint32_click_number.has()) {
      localone.jdField_b_of_type_JavaUtilList = paramSRTRule.uint32_click_number.get();
    }
    if (paramSRTRule.uint32_feeds_type.has()) {
      localone.jdField_a_of_type_JavaUtilList = paramSRTRule.uint32_feeds_type.get();
    }
    if (paramSRTRule.uint32_network_type.has()) {
      localone.jdField_a_of_type_Int = paramSRTRule.uint32_network_type.get();
    }
    if (paramSRTRule.bytes_app_package_name.has()) {
      localone.jdField_a_of_type_JavaLangString = paramSRTRule.bytes_app_package_name.get().toStringUtf8();
    }
    if (paramSRTRule.bytes_schema.has()) {
      localone.c = paramSRTRule.bytes_schema.get().toStringUtf8();
    }
    if (paramSRTRule.bytes_h5.has()) {
      localone.jdField_b_of_type_JavaLangString = paramSRTRule.bytes_h5.get().toStringUtf8();
    }
    QLog.d("ReadInJoySrtUtils", 1, "convertSRTPbToSRTClassclickNumList = " + localone.jdField_b_of_type_JavaUtilList + " feedsTypeList= " + localone.jdField_a_of_type_JavaUtilList + " netWorkType= " + localone.jdField_a_of_type_Int + " packageName = " + localone.jdField_a_of_type_JavaLangString + " schemaUrl= " + localone.c + " h5Url= " + localone.jdField_b_of_type_JavaLangString);
    return localone;
  }
  ...
  private oidb_cmd0x64e.SRTRule a(one paramone)
  {
    if (paramone == null) {
      return null;
    }
    ...
    if (paramone.c != null) {
      localSRTRule.bytes_schema.set(ByteStringMicro.copyFromUtf8(paramone.c));
    }
    if (paramone.jdField_b_of_type_JavaLangString != null) {
      localSRTRule.bytes_h5.set(ByteStringMicro.copyFromUtf8(paramone.jdField_b_of_type_JavaLangString));
    }
    if (paramone.jdField_a_of_type_JavaLangString != null) {
      localSRTRule.bytes_app_package_name.set(ByteStringMicro.copyFromUtf8(paramone.jdField_a_of_type_JavaLangString));
    }
    if (paramone.jdField_b_of_type_JavaUtilList != null) {
      localSRTRule.uint32_click_number.set(paramone.jdField_b_of_type_JavaUtilList);
    }
    if (paramone.jdField_a_of_type_JavaUtilList != null) {
      localSRTRule.uint32_feeds_type.set(paramone.jdField_a_of_type_JavaUtilList);
    }
    localSRTRule.uint32_network_type.set(paramone.jdField_a_of_type_Int);
    return localSRTRule;
  }
  
  private void a(one paramone, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      if (paramone != null)
      {
        ...
        paramone.uint32_click_number.set(localArrayList1);
        paramone.uint32_feeds_type.set(localArrayList2);
      }
    ...
    this.jdField_a_of_type_TencentImOidbCmd0x64eOidb_cmd0x64e$SRTClickInfo.msg_hit_srt_rule.set(paramone);
  }
  
  private boolean a(one paramone, int paramInt)
  {
    if (paramone == null) {}
    int i;
    int j;
    do
    {
      ...
      {
        return false;
      } while ((paramone.jdField_b_of_type_JavaUtilList == null) || (paramone.jdField_a_of_type_JavaUtilList == null));
      i = paramone.jdField_a_of_type_Int;
      j = nao.a(BaseActivity.sTopActivity);
    } while ((j == 0) || ((i == 1) && (j != 1)) || ((i == 2) && (j == 1)) || (!paramone.jdField_a_of_type_JavaUtilList.contains(Integer.valueOf(paramInt))) || (!paramone.jdField_b_of_type_JavaUtilList.contains(Integer.valueOf(this.jdField_a_of_type_Int))));
    return true;
  }
  ...
  private void c()
  {
    try
    {
      Object localObject = (String)bhvy.a("readinjoy_srt_click_time_key", "");
      String str1;
      int i;
      ...
      for (;;)
      {
        ...
        bhvy.a("readinjoy_srt_click_time_key", ((JSONObject)localObject).toString());
        return;
  ...
  public void a(List<oidb_cmd0x64e.SRTRule> paramList)
  {
    if (paramList != null)
    {
      ...
      {
        one localone = a((oidb_cmd0x64e.SRTRule)localIterator.next());
        if (localone != null) {
          localArrayList.add(localone);
        }
      }
  ...
  {
    if ((this.jdField_b_of_type_JavaUtilList == null) || (this.jdField_b_of_type_JavaUtilList.size() == 0) || (paramBaseArticleInfo == null) || ((paramBaseArticleInfo.mChannelID != 0L) && (!oou.c((int)paramBaseArticleInfo.mChannelID)))) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        one localone = (one)this.jdField_b_of_type_JavaUtilList.get(i);
        int j = onh.a(paramBaseArticleInfo);
        QLog.d("ReadInJoySrtUtils", 1, "startJudge feedsType:" + j + " clickTimes: " + this.jdField_a_of_type_Int + " position" + i);
        if (a(localone, j))
        {
          paramBaseArticleInfo = a(localone, paramBaseArticleInfo, paramTemplateBean, paramViewBase);
          if (TextUtils.isEmpty(paramBaseArticleInfo)) {
            break;
          }
          this.jdField_a_of_type_JavaLangString = paramBaseArticleInfo;
          a(localone, j, this.jdField_a_of_type_Int, i);
