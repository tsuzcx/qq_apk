  ...
  extends bozv
{
  ...
  public void a(Canvas paramCanvas, bpak parambpak, float paramFloat)
  {
    if (parambpak.jdField_a_of_type_Int == 103) {}
    do
    {
      return;
      if (parambpak.jdField_a_of_type_Int == 104)
      {
        ...
        paramCanvas.drawPath(parambpak.jdField_a_of_type_AndroidGraphicsPath, this.jdField_a_of_type_AndroidGraphicsPaint);
        return;
      }
    } while (parambpak.jdField_a_of_type_Int != 105);
    ...
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(jdField_a_of_type_Int);
    this.jdField_a_of_type_AndroidGraphicsCanvas.drawPath(parambpak.jdField_a_of_type_AndroidGraphicsPath, this.jdField_a_of_type_AndroidGraphicsPaint);
    this.jdField_a_of_type_AndroidGraphicsCanvas.restore();
    this.jdField_b_of_type_Boolean = true;
  }
  
  public void a(bowc parambowc, float paramFloat, Bitmap paramBitmap, Rect paramRect)
  {
    this.jdField_a_of_type_Bowc = parambowc;
    this.jdField_c_of_type_Float = paramFloat;
    this.jdField_a_of_type_AndroidGraphicsBitmap = paramBitmap;
    this.jdField_a_of_type_AndroidGraphicsRect = paramRect;
  }
  
  public void a(bpak parambpak)
  {
    if (parambpak.jdField_a_of_type_Int == 103)
    {
      DoodleLayout.a("delete_mosaics");
      ykw.a("0X80076C2");
      List localList = parambpak.jdField_a_of_type_JavaUtilList;
      parambpak = parambpak.b;
      int k = 0;
      while ((k < localList.size()) && (k < parambpak.size()))
      {
        e(((Integer)localList.get(k)).intValue(), ((Integer)parambpak.get(k)).intValue());
        k += 1;
      }
      c();
    }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bpak = new bpak(this.g);
      if (this.jdField_a_of_type_Bozr != null) {
        this.jdField_a_of_type_Bozr.a(this.jdField_a_of_type_Bpak);
      }
      int k;
      int m;
      if (this.g == 103)
      {
        ...
        if ((k >= 0) && (m >= 0))
        {
          this.jdField_a_of_type_Bpak.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(k));
          this.jdField_a_of_type_Bpak.b.add(Integer.valueOf(m));
          d(k, m);
          c();
        }
      }
      ...
      {
        this.jdField_a_of_type_Bpak.jdField_a_of_type_AndroidGraphicsPath.reset();
        this.jdField_a_of_type_Bpak.jdField_a_of_type_AndroidGraphicsPath.moveTo(f1, f2);
        this.jdField_a_of_type_Bpak.jdField_a_of_type_AndroidGraphicsPath.lineTo(f1 + 1.0F, f2 + 1.0F);
        this.jdField_a_of_type_Bpak.jdField_a_of_type_JavaUtilArrayList.add(new bpas(bpas.jdField_a_of_type_Int, f1, f2));
        this.jdField_a_of_type_Bpak.jdField_a_of_type_JavaUtilArrayList.add(new bpas(bpas.jdField_b_of_type_Int, f1 + 1.0F, 1.0F + f2));
      }
      else if (this.g == 105)
      {
        this.jdField_a_of_type_Bpak.jdField_a_of_type_AndroidGraphicsPath.reset();
        ...
        if (this.g == 103)
        {
          k = ((Integer)this.jdField_a_of_type_Bpak.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_Bpak.jdField_a_of_type_JavaUtilList.size() - 1)).intValue();
          m = ((Integer)this.jdField_a_of_type_Bpak.b.get(this.jdField_a_of_type_Bpak.b.size() - 1)).intValue();
          ...
          {
            this.jdField_a_of_type_Bpak.jdField_a_of_type_JavaUtilList.add(Integer.valueOf(n));
            this.jdField_a_of_type_Bpak.b.add(Integer.valueOf(i1));
            d(n, i1);
            c();
          }
        }
        else
        {
          ...
          if (this.g == 104)
          {
            ...
            this.jdField_a_of_type_Bpak.jdField_a_of_type_AndroidGraphicsPath.quadTo(this.jdField_d_of_type_Float, this.jdField_e_of_type_Float, f3, f4);
            this.jdField_a_of_type_Bpak.jdField_a_of_type_JavaUtilArrayList.add(new bpas(bpas.jdField_c_of_type_Int, this.jdField_d_of_type_Float, this.jdField_e_of_type_Float, f3, f4));
            this.jdField_d_of_type_Float = f1;
            this.jdField_e_of_type_Float = f2;
          }
          else if (this.g == 105)
  ...
  public void b()
  {
    ...
    for (int k = 2;; k = 8)
    {
      ...
      try
      {
        ...
        ykq.a("MosaicOperator", "init matrix. scale[%f, %f]. translate[%f, %f].", Float.valueOf(f1), Float.valueOf(f1), Float.valueOf(0.0F), Float.valueOf(0.0F));
      ...
      {
        ykq.c("MosaicOperator", "initMosaicPicMode.", localIllegalArgumentException);
        return;
      }
      localBitmap = null;
      break label24;
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Bowc != null)
    {
      if (this.g != 105) {
        break label50;
      }
      this.jdField_a_of_type_Bowc.a(this.jdField_b_of_type_AndroidGraphicsBitmap, this.jdField_b_of_type_Boolean);
    }
    for (;;)
    {
      ...
      return;
      label50:
      this.jdField_a_of_type_Bowc.a(this.jdField_a_of_type_ArrayOfByte, this.jdField_e_of_type_Int, this.f);
    }
  }
