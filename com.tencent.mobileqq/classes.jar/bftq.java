...
public abstract class bftq
{
  ...
  public bftq(bfts parambfts, bftr parambftr)
  {
    this.jdField_a_of_type_Long = System.currentTimeMillis();
    this.jdField_a_of_type_Bfts = parambfts;
    this.jdField_a_of_type_Bftr = parambftr;
  }
  ...
  public long a(long paramLong)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Bftv != null) {
        this.jdField_a_of_type_Bftv.b(l2 / 1000L);
      }
      ...
      wsv.b(a(), "end seekTo timecost=" + (System.currentTimeMillis() - l1) + " seekTargetTimeUs:" + paramLong + " realStartTime:" + l2);
      return l2;
    }
    catch (RuntimeException localRuntimeException)
    {
      for (;;)
      {
        wsv.c(a(), "decoder flush error %s", localRuntimeException);
      }
    }
  }
  ...
  protected abstract void a(bftr parambftr, MediaCodec paramMediaCodec, MediaFormat paramMediaFormat);
  
  public void a(bftv parambftv)
  {
  ...
  {
    boolean bool2 = false;
    bftn.a(this.jdField_a_of_type_Bfts.jdField_a_of_type_Long, "[" + a() + "] init now");
    ...
    for (;;)
    {
      ...
      try
      {
        this.jdField_a_of_type_AndroidMediaMediaExtractor.setDataSource(this.jdField_a_of_type_Bftr.b);
        bftn.a(this.jdField_a_of_type_Bfts.jdField_a_of_type_Long, "[" + a() + "] extractor setDataSource");
        i = 0;
        bool1 = bool2;
        if (i < this.jdField_a_of_type_AndroidMediaMediaExtractor.getTrackCount())
        {
          ...
          if (!str.startsWith(this.jdField_a_of_type_Bftr.a)) {
            break label353;
          }
          this.jdField_a_of_type_AndroidMediaMediaExtractor.selectTrack(i);
          bftn.a(this.jdField_a_of_type_Bfts.jdField_a_of_type_Long, "[" + a() + "] find and selectTrack");
        }
      }
      catch (IOException localIOException)
      {
        String str;
        wsv.b(a(), "init set data source error :%s", localIOException);
        return false;
      }
      try
      {
        this.jdField_a_of_type_AndroidMediaMediaCodec = MediaCodec.createDecoderByType(str);
        bftn.a(this.jdField_a_of_type_Bfts.jdField_a_of_type_Long, "[" + a() + "] create codec");
        a(this.jdField_a_of_type_Bftr, this.jdField_a_of_type_AndroidMediaMediaCodec, this.jdField_a_of_type_AndroidMediaMediaFormat);
        bftn.a(this.jdField_a_of_type_Bfts.jdField_a_of_type_Long, "[" + a() + "] configureCodec");
        bool1 = true;
      }
      catch (Throwable localThrowable)
      {
        wsv.b(a(), "init createDecoderByType error :%s", localThrowable);
        bool1 = bool2;
        continue;
      }
      if (!bool1) {
      ...
      wsv.b(a(), "create media decoder success!");
      return bool1;
      label353:
      i += 1;
    }
    wsv.d(a(), "create media decoder error!");
    return bool1;
  }
  ...
  public void b()
  {
    ...
    {
      wsv.c(a(), "onRelease error :%s ", localException);
    }
  }
  
  public boolean b()
  {
    wsv.a(a(), "start ! %s", this.jdField_a_of_type_Bftr);
    try
    {
    ...
    catch (Throwable localThrowable)
    {
      ...
      {
        wsv.c(a(), "decode start error :%s", localException);
      }
      localThrowable = localThrowable;
      wsv.c(a(), "decode start error", localThrowable);
      return false;
    }
  }
