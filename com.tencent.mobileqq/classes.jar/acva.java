  ...
  implements acxn, View.OnClickListener, bfps
{
  ...
  public void a()
  {
    ...
    {
      localObject1 = this.jdField_a_of_type_Acux.jdField_a_of_type_Adtg.a(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage, this.jdField_a_of_type_Acux);
        ...
        for (;;)
        {
          ...
          if (this.jdField_a_of_type_Boolean) {
            if (((aebw)localObject3).jdField_a_of_type_Ambh != null) {
              ((aebw)localObject3).jdField_a_of_type_Ambh.a(this.jdField_a_of_type_Acux.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((aebw)localObject3).jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend(), ((aebw)localObject3).jdField_a_of_type_ComTencentMobileqqDataChatMessage.needVipBubble(), true, ((aebw)localObject3).jdField_a_of_type_AndroidViewView, false);
            }
          }
          for (;;)
          {
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataChatMessage != null) {
      if (i == 2131364985)
      {
        if (acux.a(this.jdField_a_of_type_Acux) != null) {
          acux.a(this.jdField_a_of_type_Acux).a(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
        }
        VipUtils.a(this.jdField_a_of_type_Acux.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "chat_history", "ChatHistory", "Clk_delete", 1, 0, new String[0]);
      }
    }
    for (;;)
    {
      ...
      if (i == 2131376910)
      {
        axqw.b(this.jdField_a_of_type_Acux.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009061", "0X8009061", 0, 0, "", "", "", "");
        paramView = (MessageForFile)this.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
        paramView = apue.a(this.jdField_a_of_type_Acux.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView);
        if (paramView != null) {
          ayec.a(paramView, this.jdField_a_of_type_Acux.b, this.jdField_a_of_type_Acux.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1);
        } else {
          bcpw.a(BaseApplicationImpl.getApplication(), 1, BaseApplicationImpl.getApplication().getString(2131720118), 0).b(BaseApplicationImpl.getApplication().getResources().getDimensionPixelSize(2131298865));
        }
      }
      else
      {
        acvd localacvd = this.jdField_a_of_type_Acux.jdField_a_of_type_Adtg.a(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage, this.jdField_a_of_type_Acux);
  ...
  {
    if (this.jdField_a_of_type_Acux.jdField_a_of_type_Boolean) {}
    for (boolean bool1 = false;; bool1 = this.jdField_a_of_type_Acux.jdField_a_of_type_Aibt.a(paramView))
    {
      this.jdField_b_of_type_Boolean = true;
      if ((paramView instanceof ArkAppView)) {
        ((ArkAppView)paramView).onLongClick(paramView);
      }
      if ((this.jdField_a_of_type_Aibw == null) || (!this.jdField_a_of_type_Aibw.a())) {
        break;
      }
      a(paramView);
      return false;
    ...
    this.jdField_a_of_type_ComTencentMobileqqDataChatMessage = ((acve)actn.a(paramView)).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
    ...
    if ((i == -2014) || (i == -2005))
    {
      ...
      localObject4 = apue.a(this.jdField_a_of_type_Acux.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForFile)localObject1);
      if ((localObject4 != null) && (((FileManagerEntity)localObject4).status != 16))
      {
        long l = apue.a(this.jdField_a_of_type_Acux.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((FileManagerEntity)localObject4).fileName);
        localObject2 = ancb.a().c();
        localObject1 = localObject2;
        if (TextUtils.isEmpty((CharSequence)localObject2)) {
          localObject1 = ayfv.a;
        }
        if ((this.d) && (ayfv.a(((FileManagerEntity)localObject4).strFilePath, ((FileManagerEntity)localObject4).fileName, (String)localObject1)) && (((FileManagerEntity)localObject4).fileSize <= l))
        {
          axqw.b(this.jdField_a_of_type_Acux.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009060", "0X8009060", 0, 0, "", "", "", "");
          ((bblr)localObject3).a(2131376910, this.jdField_a_of_type_Acux.b.getString(2131720121), 2130838617);
        }
      }
    }
    Object localObject2 = ((acve)actn.a(paramView)).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
    Object localObject1 = this.jdField_a_of_type_Acux.jdField_a_of_type_Adtg.a((ChatMessage)localObject2, this.jdField_a_of_type_Acux);
    ...
    if ((localObject4 != null) && (localObject4.length > 0))
    {
      ...
      while (i < j)
      {
        bblt localbblt = localObject4[i];
        k = localbblt.a();
        if (((k == 2131364825) || (k == 2131375789) || (k == 2131366632) || (k == 2131365928)) && (localbblt.b() != 2130838306)) {
          ((bblr)localObject3).a(localbblt);
        }
        i += 1;
      }
    }
    ((bblr)localObject3).a(2131364985, this.jdField_a_of_type_Acux.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131690708), 2130838601);
    if (((bblr)localObject3).a() > 0)
    {
      this.jdField_a_of_type_ComTencentMobileqqDataChatMessage = ((acve)actn.a(paramView)).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
    ...
    for (i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        if (this.jdField_a_of_type_Aibw == null)
        {
          this.jdField_a_of_type_Aibw = new aibo(this.jdField_a_of_type_Acux.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie);
          this.jdField_a_of_type_Aibw.a(this);
          this.jdField_a_of_type_Aibw.a(this);
        }
        this.jdField_a_of_type_Aibw.a = ((int)this.jdField_a_of_type_AndroidGraphicsPointF.y);
        ...
        if (bool1)
        {
          ...
          {
            bool2 = true;
            ((aibw)localObject4).a((bblr)localObject3, bool2);
        ...
        {
          if (bool1) {
            this.jdField_a_of_type_Acux.jdField_a_of_type_Aibt.a(paramView, this.jdField_a_of_type_Aibw);
          }
          return true;
          bool2 = false;
          break;
          localObject2 = this.jdField_a_of_type_Aibw.a(paramView, this.jdField_a_of_type_Acux.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie);
          this.jdField_a_of_type_Aibw.a(paramView, k, ((aibx)localObject2).a, (bblr)localObject3, true, ((aibx)localObject2).b);
          break label730;
          label892:
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    Object localObject = this.jdField_a_of_type_Acux.jdField_a_of_type_Adtg.a(((acve)actn.a(paramView)).jdField_a_of_type_ComTencentMobileqqDataChatMessage, this.jdField_a_of_type_Acux);
