  ...
  implements Handler.Callback
{
  ...
  private ajzm jdField_a_of_type_Ajzm;
  ...
  public ajyt(Activity paramActivity)
  {
  ...
  private void a(int paramInt, float paramFloat)
  {
    ...
    while ((this.jdField_a_of_type_Ajzm == null) || (!this.jdField_a_of_type_Ajzm.isShowing())) {
      return;
    }
    int i = (int)(paramInt * paramFloat);
    int j = (int)(paramFloat * 100.0D);
    String str = String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131691169), new Object[] { Integer.valueOf(i), Integer.valueOf(paramInt) });
    if (QLog.isColorLevel()) {
  ...
  private void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    String str = "";
    if ((paramInt1 > 0) && (paramInt2 == 0)) {
      str = String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131691172), new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt1) });
    }
    for (;;)
    {
      a(null, str, bool, paramString);
      bdll.b(null, "dc00898", "", "", "0X8009DC9", "0X8009DC9", 0, 0, this.jdField_c_of_type_JavaLangString, paramInt1 + paramInt2 + "", paramInt1 + "", paramInt2 + "");
      if (paramInt2 <= 0) {
        break;
      }
      bdll.b(null, "dc00898", "", "", "0X8009DCC", "0X8009DCC", 0, 0, "" + paramInt2, "", "", "");
      return;
      if ((paramInt1 > 0) && (paramInt2 > 0))
      {
        str = String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131691174), new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt1 + paramInt2), Integer.valueOf(paramInt2) });
        bool = false;
      }
      else if ((paramInt1 == 0) && (paramInt2 > 0))
      {
        str = String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131691167), new Object[] { Integer.valueOf(paramInt2), Integer.valueOf(paramInt2) });
        bool = false;
      }
      else
      {
  ...
  private void a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 0)
    {
      localObject = ((Resources)localObject).getString(2131691173);
    ...
    for (str = "0";; str = "1")
    {
      bdll.b(null, "dc00898", "", "", "0X8009DC9", "0X8009DC9", 0, 0, this.jdField_c_of_type_JavaLangString, "1", paramString + "", str + "");
      return;
      if ((paramInt == 2) || (paramInt == 3))
      {
        str = ((Resources)localObject).getString(2131691165);
        localObject = null;
        bool = false;
        break;
      }
      if (paramInt == 1)
      {
        str = ((Resources)localObject).getString(2131691170);
        localObject = null;
        bool = false;
        break;
      }
      str = ((Resources)localObject).getString(2131691168);
      localObject = null;
      bool = false;
      break;
      paramString = "0";
  ...
  private void a(String paramString1, String paramString2, boolean paramBoolean, String paramString3)
  {
    ...
    for (String str = anzj.a(2131712480);; str = anzj.a(2131712480) + this.jdField_a_of_type_JavaLangString)
    {
      ...
      localbhpc.setPositiveButton("留在QQ", new ajzg(this, paramBoolean, paramString3)).setNegativeButton(str, new ajzf(this, paramBoolean, paramString3)).show();
      return;
    }
  }
  ...
  private void a(List<Uri> paramList)
  {
    ...
    ((ashd)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(103)).b();
    this.jdField_a_of_type_MqqOsMqqHandler.postDelayed(this.jdField_c_of_type_JavaLangRunnable, 2000L);
    new ajyu(this, paramList).execute(new Void[0]);
  }
  ...
  private void b(ArrayList<String> paramArrayList)
  {
    ...
    ((ashd)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(103)).a(paramArrayList, new ajzd(this, i));
  }
  ...
  private void h()
  {
    ...
    //   9: aload_0
    //   10: getfield 87	ajyt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   13: ldc_w 523
    ...
    //   22: aload_0
    //   23: getfield 370	ajyt:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   32: astore_3
    //   33: aload_0
    //   34: getfield 326	ajyt:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   37: invokestatic 376	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   40: ifne +276 -> 316
    //   43: aload_0
    //   44: getfield 87	ajyt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   47: invokevirtual 528	android/app/Activity:getPackageManager	()Landroid/content/pm/PackageManager;
    //   50: aload_0
    //   51: getfield 326	ajyt:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   54: bipush 64
    ...
    //   112: invokestatic 566	bhml:a	([B)Ljava/lang/String;
    //   115: astore_1
    //   116: ldc 79
    //   118: iconst_1
    //   119: bipush 8
    ...
    //   131: iconst_1
    //   132: aload_0
    //   133: getfield 96	ajyt:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   136: aastore
    //   137: dup
    //   138: iconst_2
    //   139: ldc_w 570
    ...
    //   144: iconst_3
    //   145: aload_0
    //   146: getfield 326	ajyt:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   149: aastore
    //   150: dup
    //   151: iconst_4
    //   152: ldc_w 572
    ...
    //   168: bipush 7
    //   170: aload_0
    //   171: getfield 576	ajyt:e	Ljava/lang/String;
    //   174: aastore
    //   175: invokestatic 421	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   178: aload_0
    //   179: getfield 96	ajyt:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   182: invokestatic 376	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   185: ifne +20 -> 205
    //   188: aload_0
    //   189: getfield 326	ajyt:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   220: iconst_1
    //   221: aload_0
    //   222: getfield 96	ajyt:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   225: aastore
    //   226: dup
    //   227: iconst_2
    //   228: ldc_w 580
    ...
    //   233: iconst_3
    //   234: aload_0
    //   235: getfield 326	ajyt:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   238: aastore
    //   239: dup
    //   240: iconst_4
    //   241: ldc_w 582
    ...
    //   252: aload_0
    //   253: getfield 87	ajyt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   256: sipush 230
    //   259: invokestatic 386	bhlq:a	(Landroid/content/Context;I)Lbhpc;
    //   262: astore_1
    //   263: aload_1
    //   264: ldc_w 585
    //   267: invokestatic 381	anzj:a	(I)Ljava/lang/String;
    //   270: invokevirtual 396	bhpc:setMessage	(Ljava/lang/CharSequence;)Lbhpc;
    //   273: pop
    //   274: aload_1
    //   275: ldc_w 586
    //   278: new 588	ajze
    //   281: dup
    //   282: aload_0
    //   283: invokespecial 589	ajze:<init>	(Lajyt;)V
    //   286: invokevirtual 592	bhpc:setNegativeButton	(ILandroid/content/DialogInterface$OnClickListener;)Lbhpc;
    //   289: pop
    //   290: aload_1
    //   291: iconst_0
    //   292: invokevirtual 596	bhpc:setCancelable	(Z)V
    //   295: aload_1
    //   296: invokevirtual 416	bhpc:show	()V
    //   299: return
    //   300: astore_1
    //   301: ldc 79
    //   303: iconst_1
    ...
    //   354: ldc_w 616
    //   357: aload_0
    //   358: getfield 576	ajyt:e	Ljava/lang/String;
    //   361: invokevirtual 620	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   364: aload_2
    //   365: ldc_w 622
    //   368: aload_0
    //   369: getfield 326	ajyt:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   383: aload_0
    //   384: ldc_w 625
    //   387: invokevirtual 627	ajyt:a	(I)V
    //   390: aload_0
    //   391: getfield 54	ajyt:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   394: aload_0
    //   395: getfield 61	ajyt:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   398: ldc2_w 628
    //   401: invokevirtual 251	mqq/os/MqqHandler:postDelayed	(Ljava/lang/Runnable;J)Z
    //   404: pop
    //   405: aload_0
    //   406: getfield 87	ajyt:jdField_a_of_type_AndroidAppActivity	Landroid/app/Activity;
    //   409: iconst_1
    //   410: aload_0
    //   411: getfield 96	ajyt:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    //   414: aload_2
    //   415: invokestatic 632	adng:a	(Landroid/app/Activity;ILjava/lang/String;Landroid/os/Bundle;)Ladnb;
    //   418: ldc_w 634
    //   421: aconst_null
    //   422: new 636	ajzh
    //   425: dup
    //   426: aload_0
    //   427: aload_3
    //   428: invokespecial 639	ajzh:<init>	(Lajyt;Ljava/lang/String;)V
    //   431: invokevirtual 644	adnb:a	(Ljava/lang/String;Lorg/json/JSONObject;Ladmy;)V
    //   434: return
  ...
  private void i()
  {
    ...
    if (!bool)
    {
      apdr.a((AppActivity)this.jdField_a_of_type_AndroidAppActivity, 3, new ajzi(this));
      return;
    }
  ...
  private void j()
  {
    ...
    if (localOpenID == null)
    {
      ...
      try
      {
        ...
        localQQAppInterface.a().a(l, this.jdField_d_of_type_JavaLangString, Long.valueOf(this.jdField_c_of_type_JavaLangString).longValue(), new ajzk(this));
        return;
      }
  ...
  private void k()
  {
    ((ashd)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(103)).e();
  }
  ...
  public ArrayList<String> a(List<Uri> paramList)
  {
    ...
    avpx localavpx = new avpx(this.jdField_a_of_type_AndroidAppActivity, false, null);
    int i = 0;
    while (i < localArrayList.size())
    {
      String str = localavpx.a((Uri)localArrayList.get(i), false);
  ...
  protected void a(String paramString1, String paramString2)
  {
    ...
    this.jdField_b_of_type_Bhpc = bhlq.a(this.jdField_a_of_type_AndroidAppActivity, 230);
    this.jdField_b_of_type_Bhpc.setMessage(paramString1);
    paramString1 = new ajzl(this);
    this.jdField_b_of_type_Bhpc.setNegativeButton(paramString2, paramString1);
    this.jdField_b_of_type_Bhpc.setOnKeyListener(new ajyv(this));
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    int i = paramArrayList.size();
    this.jdField_a_of_type_Ajzm = new ajzm(this.jdField_a_of_type_AndroidAppActivity);
    this.jdField_a_of_type_Ajzm.a("收藏为QQ表情");
    this.jdField_a_of_type_Ajzm.a(2131690580, new ajyx(this));
    this.jdField_a_of_type_Ajzm.c(2131691162, new ajyy(this, paramArrayList, i));
    this.jdField_a_of_type_Ajzm.b(2131691163, new ajyz(this, i));
    this.jdField_a_of_type_Ajzm.a(paramArrayList, new ajza(this, i, paramArrayList));
    if (i > 1)
    {
      paramArrayList = String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131691166), new Object[] { Integer.valueOf(i) });
      this.jdField_a_of_type_Ajzm.b(paramArrayList);
    }
    this.jdField_a_of_type_Ajzm.setOnDismissListener(new ajzb(this));
    this.jdField_a_of_type_Ajzm.setOnKeyListener(new ajzc(this, i));
    this.jdField_a_of_type_Ajzm.setCanceledOnTouchOutside(false);
    this.jdField_a_of_type_Ajzm.show();
  ...
  {
    if ((this.jdField_a_of_type_Ajzm != null) && (this.jdField_a_of_type_Ajzm.isShowing()))
    {
      if (QLog.isColorLevel()) {
  ...
  protected void d()
  {
    ...
    this.jdField_b_of_type_Bhpc = bhlq.a(this.jdField_a_of_type_AndroidAppActivity, 230);
    this.jdField_b_of_type_Bhpc.setMessage(anzj.a(2131712481));
    this.jdField_b_of_type_Bhpc.setTitle(2131691920);
    ajyw localajyw = new ajyw(this);
    this.jdField_b_of_type_Bhpc.setNegativeButton(2131690580, localajyw);
    this.jdField_b_of_type_Bhpc.setPositiveButton(2131718007, localajyw);
    this.jdField_b_of_type_Bhpc.show();
  }
