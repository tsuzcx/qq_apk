...
{
  public int a;
  private ajxj jdField_a_of_type_Ajxj = new ajyu(this);
  public bcqf a;
  ...
  public ajyt(BaseActivity paramBaseActivity, QQAppInterface paramQQAppInterface, HotChatInfo paramHotChatInfo)
  {
  ...
  private void d()
  {
    ...
    for (String str1 = this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.joinUrl.substring(i + 12);; str1 = null)
    {
      ...
      String str3 = ajyi.a(str1, this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.userCreate);
      if (this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.userCreate != 1)
      {
        ajyi.a(2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.name, this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.troopUin, str3, str1, ajya.a(2131705604) + this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.name + ajya.a(2131705599), ajya.a(2131705601), null, null);
        return;
      }
      String str2 = ajya.a(2131705598);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
        str2 = ajya.a(2131705602) + this.jdField_a_of_type_JavaLangString + ajya.a(2131705603);
      }
      ...
      ajyi.a(2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.name, this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.troopUin, str3, str1, ajya.a(2131705597) + this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.name + ajya.a(2131705600), str2, this.b, str4);
      return;
    }
  }
  ...
  public void a(HotChatInfo paramHotChatInfo)
  {
    ...
    this.jdField_a_of_type_Int = 0;
    this.jdField_a_of_type_JavaLangString = bbcz.q(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo.ownerUin);
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
