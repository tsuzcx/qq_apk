  ...
  extends BaseAdapter
{
  ...
  public ajqf(QQAppInterface paramQQAppInterface, Context paramContext, View.OnClickListener paramOnClickListener1, View.OnClickListener paramOnClickListener2, ChatHistoryC2CLinkFragment paramChatHistoryC2CLinkFragment, ajuh paramajuh)
  {
    ...
    this.jdField_a_of_type_Ajuh = paramajuh;
    this.jdField_a_of_type_JavaTextSimpleDateFormat = new SimpleDateFormat("M月d日");
    this.jdField_a_of_type_Anmw = ((anmw)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.getActivity().app.getManager(51));
  }
  ...
  private void a(ajqk paramajqk, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          a(ajqk.a(paramajqk), (String)localObject);
          i = 1;
          if (i == 0) {
            ajqk.a(paramajqk).setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130850448));
          }
          str1 = a(ajui.a(paramMessageRecord));
          if (!(paramMessageRecord instanceof MessageForArkApp)) {
            break label300;
          }
          str2 = ((MessageForArkApp)paramMessageRecord).getTitle();
          localTextView = ajqk.a(paramajqk);
          localObject = str2;
          ...
          ajqk.b(paramajqk).setText((CharSequence)localObject);
          ajqk.c(paramajqk).setText(bglf.m(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.getActivity().app, paramMessageRecord.senderuin));
          ajqk.a(paramajqk).setOnClickListener(new ajqh(this, str1, paramajqk, paramMessageRecord));
          if (!this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.c) {
            break label312;
          }
          ajqk.a(paramajqk).setVisibility(0);
          bool = this.jdField_a_of_type_Ajuh.a(paramMessageRecord);
          ajqk.a(paramajqk).setChecked(bool);
          paramMessageRecord = (LinearLayout.LayoutParams)ajqk.a(paramajqk).getLayoutParams();
          paramMessageRecord.setMargins(paramMessageRecord.leftMargin, paramMessageRecord.topMargin, zlx.a(this.jdField_a_of_type_AndroidContentContext, 8.0F), paramMessageRecord.bottomMargin);
          ajqk.a(paramajqk).setLayoutParams(paramMessageRecord);
          return;
        }
      ...
      continue;
      label300:
      ajqk.a(paramajqk).setText(str1);
      continue;
      label312:
      ajqk.a(paramajqk).setVisibility(8);
      paramMessageRecord = (LinearLayout.LayoutParams)ajqk.a(paramajqk).getLayoutParams();
      paramMessageRecord.setMargins(paramMessageRecord.leftMargin, paramMessageRecord.topMargin, zlx.a(this.jdField_a_of_type_AndroidContentContext, 50.0F), paramMessageRecord.bottomMargin);
      ajqk.a(paramajqk).setLayoutParams(paramMessageRecord);
      return;
      label374:
      int i = 0;
  ...
  public static void a(ImageView paramImageView, String paramString)
  {
    ...
    Drawable localDrawable = localBaseApplication.getResources().getDrawable(2130850448);
  ...
  private void a(String paramString)
  {
    ...
    if (bool2)
    {
      ...
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800AC87", "0X800AC87", 5, 0, "1", "2", "", "");
    }
    for (;;)
    {
      ...
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800AC87", "0X800AC87", 5, 0, "1", "1", "", "");
    }
  }
  ...
  public void a(URLImageView paramURLImageView, AbsShareMsg paramAbsShareMsg)
  {
    ...
    for (paramAbsShareMsg = Uri.fromFile(new File((String)localObject1)).toString();; paramAbsShareMsg = (AbsShareMsg)localObject1)
    {
      ...
      paramAbsShareMsg.setTag(bgey.b(((ViewGroup.LayoutParams)localObject1).width, ((ViewGroup.LayoutParams)localObject1).height, zlx.a(this.jdField_a_of_type_AndroidContentContext, 6.0F)));
      paramAbsShareMsg.setDecodeHandler(bgey.j);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((localObject2 instanceof MessageForStructing))
    {
      ...
      if ((paramView != null) && ((paramView.getTag() instanceof ajqj)))
      {
        localObject1 = (ajqj)paramView.getTag();
        ((ajqj)localObject1).jdField_a_of_type_JavaLangObject = localObject2;
        ((ajqj)localObject1).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.d;
        if (!(localObject2 instanceof MessageForStructing)) {
          break label402;
        }
        ...
        if ((((MessageForStructing)localObject2).structingMsg != null) && ((((MessageForStructing)localObject2).structingMsg instanceof AbsShareMsg)))
        {
          ...
          a(((ajqj)localObject1).jdField_a_of_type_ComTencentImageURLImageView, (AbsShareMsg)localObject3);
          ((ajqj)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(a((AbsShareMsg)localObject3, "title"));
          localObject3 = bglf.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.getActivity().app, ((MessageForStructing)localObject2).senderuin);
          ((ajqj)localObject1).b.setText((CharSequence)localObject3);
          ...
          ((ajqj)localObject1).c.setText((CharSequence)localObject3);
        }
        label207:
        if (!this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryC2CLinkFragment.c) {
          break label425;
        }
        ((ajqj)localObject1).jdField_a_of_type_AndroidWidgetCheckBox.setVisibility(0);
        ((ajqj)localObject1).jdField_a_of_type_AndroidWidgetCheckBox.setChecked(this.jdField_a_of_type_Ajuh.a(localObject2));
      }
      for (;;)
      {
        EventCollector.getInstance().onListGetView(paramInt, paramView, paramViewGroup, getItemId(paramInt));
        return paramView;
        localObject1 = new ajqj(this);
        paramView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131558884, null);
        ((ajqj)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131376116));
        ((ajqj)localObject1).jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131377916));
        ((ajqj)localObject1).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131377914));
        ((ajqj)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131363645));
        ((ajqj)localObject1).b = ((TextView)paramView.findViewById(2131371397));
        ((ajqj)localObject1).c = ((TextView)paramView.findViewById(2131365242));
        paramView.setTag(localObject1);
        ((ajqj)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(localObject1);
        ((ajqj)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        break;
        label402:
        ((ajqj)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText("");
        ((ajqj)localObject1).b.setText("");
        break label207;
        label425:
        ((ajqj)localObject1).jdField_a_of_type_AndroidWidgetCheckBox.setVisibility(8);
      }
    }
    ...
    {
      if ((paramView != null) && ((paramView.getTag() instanceof ajqk))) {
        localObject1 = (ajqk)paramView.getTag();
      }
      for (;;)
      {
        a((ajqk)localObject1, (MessageRecord)localObject2);
        break;
        paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558825, null);
        localObject1 = new ajqk(this, paramView);
        paramView.setTag(localObject1);
      }
    }
    ...
    {
      if ((paramView == null) || (!(paramView.getTag() instanceof ajqi))) {
        break label633;
      }
      localObject1 = (ajqi)paramView.getTag();
      label576:
      localObject3 = ((ajqi)localObject1).jdField_a_of_type_AndroidWidgetCheckBox;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      ((ajqi)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText((String)localObject2);
      localObject1 = paramView;
      paramView = (View)localObject1;
      break;
      label633:
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558824, null);
      localObject1 = new ajqi();
      ((ajqi)localObject1).jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131369120));
      ((ajqi)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378605));
      paramView.setTag(localObject1);
      paramView.setOnClickListener(new ajqg(this, (ajqi)localObject1));
      break label576;
    }
  }
}
