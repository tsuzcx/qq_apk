  ...
  extends ajpz
{
  ...
  public ajqf(String paramString)
  {
    ...
    if ((this.jdField_a_of_type_AndroidGraphicsDrawableDrawable == null) || (this.jdField_b_of_type_AndroidGraphicsDrawableDrawable == null)) {
      ...
      catch (Exception paramString)
      {
        if (QLog.isColorLevel())
        {
          ...
          BaseApplicationImpl.sImageHashMap.put("apolloMainInfoFail", BitmapFactory.decodeResource(paramString, 2130843142));
          return;
        }
      }
  ...
  public Drawable a(Context paramContext, float paramFloat)
  {
    ...
    do
    {
      do
      {
        ...
        ((ajhv)localObject).jdField_a_of_type_JavaLangString = (ajmu.d + this.jdField_a_of_type_ComTencentMobileqqDataApolloActionData.actionId + File.separator + "txtImg.png");
        ((ajhv)localObject).jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqDataApolloActionData.textImg;
        ...
        localObject = ajhu.a(true, ((ajhv)localObject).jdField_a_of_type_JavaLangString, paramContext, this.jdField_a_of_type_ComTencentMobileqqDataApolloActionData.textImg);
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, EditText paramEditText, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      aaod.a(paramQQAppInterface, paramContext, paramSessionInfo, this);
      paramContext = "";
