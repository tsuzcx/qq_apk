...
public class aabu
{
  ...
  {
    if (this.d == null) {
      this.d = bhjc.a(BaseApplicationImpl.getContext(), "subscribe_ad_attachinfo_cache");
    }
    return this.d;
  }
  ...
  {
    if (paramString != null) {
      bhjc.a(BaseApplicationImpl.getContext(), "subscribe_ad_attachinfo_cache", paramString);
    }
    this.d = paramString;
  }
  ...
  {
    if (this.c == null) {
      this.c = bhjc.a(BaseApplicationImpl.getContext(), "subscribe_ad_livePageInfo_cache");
    }
    return this.c;
  }
