...
public class wtb
  extends BaseAdapter
{
  public wtb(CameraPreviewActivity paramCameraPreviewActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = this.a.getLayoutInflater().inflate(2130969178, null);
      paramViewGroup = new wtc();
      paramViewGroup.a = ((URLImageView)paramView.findViewById(2131365496));
    ...
    for (;;)
    {
      ...
      paramViewGroup = (wtc)paramView.getTag();
    }
