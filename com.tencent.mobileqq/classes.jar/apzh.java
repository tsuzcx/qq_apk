  ...
  extends bbrl<apzg>
{
  ...
  public apzh(AppInterface paramAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!localFile3.exists())
        {
          ...
          bbrq.a(BaseApplicationImpl.getApplication().getRuntime(), "individual_v2_colorscreen_parse_fail", "1", "", Integer.toString(paramInt), null, null, 0.0F, 0.0F);
          bbrp.a("individual_v2_colorscreen_parse_fail", "errCode:1, id:" + paramInt);
      ...
      apzg localapzg;
      localapzg.jdField_a_of_type_JavaLangString = localFile2.getAbsolutePath();
      localapzg.jdField_b_of_type_JavaLangString = (localObject1.getAbsolutePath() + File.separator + "images");
      try
      {
        Object localObject2 = new JSONObject(bbdx.a(localFile3));
        localapzg.jdField_a_of_type_Int = (((JSONObject)localObject2).optInt("repeatCount", localapzg.jdField_a_of_type_Int) - 1);
        localapzg.jdField_a_of_type_Long = ((JSONObject)localObject2).optLong("eastInTime", localapzg.jdField_a_of_type_Long);
        localapzg.jdField_b_of_type_Long = ((JSONObject)localObject2).optLong("eastOutTime", localapzg.jdField_b_of_type_Long);
        localObject2 = localapzg;
        if (QLog.isColorLevel())
        {
  ...
  public void a(int paramInt, bbrm<apzg> parambbrm)
  {
    ThreadManager.post(new ColorScreenManager.1(this, paramInt, parambbrm), 5, null, false);
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    //   5: aload_0
    //   6: aload_1
    //   7: invokevirtual 258	apzh:a	(Ljava/lang/String;)I
    //   10: istore_3
    //   11: iload_3
    //   12: ifle +65 -> 77
    //   15: iload_2
    ...
    //   24: aload_0
    //   25: iload_3
    //   26: invokevirtual 273	apzh:a	(I)Lapzg;
    //   29: astore 5
    //   31: aload_0
    //   32: aload_1
    //   33: aload 5
    //   35: invokevirtual 276	apzh:a	(Ljava/lang/String;Ljava/lang/Object;)V
    //   38: aload 5
    //   40: ifnonnull +37 -> 77
    //   43: aload_0
    //   44: getfield 20	apzh:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   47: ldc_w 278
    //   50: iload_2
    ...
    //   62: fconst_0
    //   63: fconst_0
    //   64: invokestatic 135	bbrq:a	(Lmqq/app/AppRuntime;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;FF)V
    //   67: ldc_w 278
    //   70: iload_2
    //   71: invokestatic 281	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   74: invokestatic 145	bbrp:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   77: aload_0
    //   78: monitorexit
    //   79: return
    //   80: aload_0
    //   81: iload_3
    //   82: invokevirtual 85	apzh:a	(I)Ljava/io/File;
    //   85: astore 6
    ...
    //   174: aload 6
    //   176: iconst_0
    //   177: invokestatic 288	bbdx:a	(Ljava/lang/String;Ljava/lang/String;Z)V
    //   180: goto -156 -> 24
    //   183: astore 6
