...
public class afbj
  extends anvi
{
  public afbj(TroopAssistantActivity paramTroopAssistantActivity) {}
  ...
  protected void onSetGenralSettingsTroopFilter(boolean paramBoolean, Map<String, Integer> paramMap)
  {
    ...
    do
    {
      return;
      int i;
      if (("batch_setting".equals(this.a.b)) && (this.a.jdField_a_of_type_JavaUtilList != null) && (this.a.jdField_a_of_type_JavaUtilList.size() > 0) && (this.a.jdField_a_of_type_Bhhi != null))
      {
        i = 0;
        for (;;)
        {
          ...
          if (((Boolean)this.a.jdField_a_of_type_Bhhi.c.get(paramMap)).booleanValue()) {
            break;
          }
          i += 1;
        }
        QQToast.a(this.a.app.getApp(), 2, anvx.a(2131714568), 0).b(this.a.getTitleBarHeight());
      ...
      if (paramMap.hasNext())
      {
        ...
        i = this.a.app.getTroopMask(str);
        if ((i == 1) || (i == 4)) {
          awtz.a().c(str, this.a.app);
        }
        for (;;)
        {
          this.a.c();
    ...
    if (paramBoolean)
    {
      QQToast.a(this.a.app.getApp(), 2, this.a.getString(2131719665), 0).b(this.a.getTitleBarHeight());
      return;
    }
