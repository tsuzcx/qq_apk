      ...
      try
      {
        ...
        if (paramToServiceMsg.uint32_result.get() == 0)
        {
          ...
          if ((j & 0x1) != 0)
          {
            i = 1;
            break label230;
            localazxn.jdField_a_of_type_Long = l;
            if ((i != 0) || (j == 0)) {
              continue;
            }
            bool = true;
            localazxn.jdField_a_of_type_Boolean = bool;
            bool = true;
            if (QLog.isColorLevel()) {
              QLog.d("OneWayFriendHandler", 0, String.format("handleGetOneWayFriendFlag success=%s result=%s", new Object[] { Boolean.valueOf(bool), localazxn }));
            }
            notifyUI(1, bool, localazxn);
          }
        }
        else
        {
