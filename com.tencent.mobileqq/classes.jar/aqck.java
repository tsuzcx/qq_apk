...
public class aqck
  implements aqct<BubbleRecommendRsp>
{
  public int a()
  {
    return 4;
  ...
  {
    return bant.a(paramContext, "bubble", "mvip.gongneng.android.bubble.index_dynamic_tab");
  }
  
  public String a(FontBubble paramFontBubble)
  {
    return bant.a("bubblePreview").replace("[id]", Integer.toString(paramFontBubble.bubbleId));
  }
  
  public List<FontBubble> a(QQAppInterface paramQQAppInterface, BubbleRecommendRsp paramBubbleRecommendRsp)
  {
    int j = 0;
    paramQQAppInterface = ((ajjj)paramQQAppInterface.getManager(51)).a(paramQQAppInterface.getAccount());
    int i;
