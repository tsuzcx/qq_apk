...
public class xyj
  implements ylm
{
  public xyj(RecommendBannerItemView paramRecommendBannerItemView) {}
  ...
  public void a(boolean paramBoolean, CertifiedAccountMeta.StFeed paramStFeed)
  {
    if (RecommendBannerItemView.a(this.a))
    {
      if (RecommendBannerItemView.a(this.a) != null) {
        yvu.a(RecommendBannerItemView.a(this.a).id.get(), "auth_discover", "reco_follow_clk", 0, 0, new String[] { "", String.valueOf(RecommendBannerItemView.a(this.a)), RecommendBannerItemView.a(this.a).nick.get(), RecommendBannerItemView.a(this.a).desc.get() });
      }
      return;
    }
    if (paramBoolean)
