...
public class bplv
  implements bpip<bpik>
{
  private final int jdField_a_of_type_Int = bppm.b(DoodleLayout.b(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleLayout), 40.0F);
  private Rect jdField_a_of_type_AndroidGraphicsRect;
  
  private bplv(DoodleLayout paramDoodleLayout) {}
  
  public boolean a(bpik parambpik, MotionEvent paramMotionEvent)
  {
    ...
    for (float f1 = bqcd.e;; f1 = 0.0F)
    {
      ...
      case 6: 
        do
        {
          ...
          parambpik = this.jdField_a_of_type_AndroidGraphicsRect;
          parambpik.top -= this.jdField_a_of_type_Int;
          parambpik = this.jdField_a_of_type_AndroidGraphicsRect;
          parambpik.bottom += this.jdField_a_of_type_Int;
