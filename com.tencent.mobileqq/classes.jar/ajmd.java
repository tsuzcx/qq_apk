...
public class ajmd
{
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      paramString = new DataInputStream(new ByteArrayInputStream(baaw.decode(paramString, 0)));
    ...
    catch (Exception paramString)
    {
      ...
      awrn.a(BaseApplicationImpl.getApplication()).a(null, "evSpError", true, 0L, 0L, paramString, null);
      a();
    }
  }
  ...
  public void b()
  {
    try
    {
      ...
      BaseApplicationImpl.getApplication().getSharedPreferences("MemoryManagerMemoryStat", 0).edit().putString(this.jdField_a_of_type_JavaLangString, baaw.encodeToString((byte[])localObject, 0)).commit();
      return;
    }
