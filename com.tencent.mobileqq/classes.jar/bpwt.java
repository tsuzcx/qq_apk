...
public class bpwt
{
  ...
  public static Map<String, aowp> a;
  ...
  public static void a(int paramInt, long paramLong, String paramString, boolean paramBoolean)
  {
    ...
    for (String str = "back";; str = "front")
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "cameraStartTimeCost", true, 0L, 0L, localHashMap, null);
      return;
    }
  }
  ...
  private static void a(String paramString1, String paramString2, HashMap<String, String> paramHashMap)
  {
    ...
    for (paramString1 = new HashMap();; paramString1 = paramHashMap)
    {
      ...
      paramString1.put("DEVICE_TYPE_NAME", aqbi.a().a());
      a(paramString1, "open_custom_camera", paramString2);
      bctj.a(BaseApplicationImpl.getApplication()).a(null, paramString2, true, 0L, 0L, paramString1, null);
      return;
    }
  }
  ...
  public static void d()
  {
    ...
    if (f > 0L)
    {
      ...
      bctj.a(BaseApplicationImpl.sApplication).a(null, "COT", true, l, 0L, localHashMap, null);
      f = 0L;
    }
  }
  ...
  public static void e()
  {
    ...
    if (jdField_c_of_type_Long > 0L)
    {
      ...
      bctj.a(BaseApplicationImpl.sApplication).a(null, "actLoginQ", true, l2, 0L, localHashMap, null);
