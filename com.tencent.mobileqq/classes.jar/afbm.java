  ...
  implements afal, View.OnClickListener
{
  ...
  public afbm(BaseChatPie paramBaseChatPie)
  {
  ...
  private void a(RedTouch paramRedTouch, int paramInt)
  {
    ...
    {
      BusinessInfoCheckUpdate.RedTypeInfo localRedTypeInfo = ((axho)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(paramInt);
  ...
  private void a(RedTouch paramRedTouch, int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0)
    {
      BusinessInfoCheckUpdate.AppInfo localAppInfo = ((axho)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(paramInt1, String.valueOf(paramInt2));
  ...
  private void h()
  {
    this.o = aekt.a(4.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
      ...
      if (this.jdField_a_of_type_AndroidWidgetImageButton != null)
      {
        ...
        if (this.jdField_a_of_type_AndroidWidgetImageButton != null)
        {
          ...
          if (AppSetting.jdField_c_of_type_Boolean) {
            this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(alpo.a(2131714551));
          }
        }
        ...
        if (this.jdField_b_of_type_AndroidWidgetImageButton != null)
        {
          ...
          if (AppSetting.jdField_c_of_type_Boolean) {
            this.jdField_b_of_type_AndroidWidgetImageButton.setContentDescription(alpo.a(2131714548));
          }
        }
        this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131366998));
        if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)
        {
          ...
          ((FrameLayout.LayoutParams)localObject1).leftMargin = aekt.a(8.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
        ...
        {
          this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131366997));
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton != null)
        {
          ...
          if ((localObject2 instanceof LinearLayout.LayoutParams))
          {
            ...
            if (AppSetting.jdField_c_of_type_Boolean) {
              this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setContentDescription(alpo.a(2131714558));
            }
    ...
    while ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof agqn))
    {
      for (;;)
      {
        ...
        if (localObject1 != null)
        {
          ...
          this.jdField_a_of_type_AndroidWidgetImageButton.setBackgroundResource(2130838086);
          ...
          if (localObject1 != null)
          {
            ...
            this.jdField_b_of_type_AndroidWidgetImageButton.setBackgroundResource(2130838024);
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (AppSetting.jdField_c_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(alpo.a(2131714556));
      }
      return;
      bool1 = false;
      break;
    ...
    label114:
    this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(alpo.a(2131714563));
  }
  ...
  public void a(TextView paramTextView)
  {
    ...
    if (paramTextView != null)
    {
      ...
      if ((localObject instanceof RelativeLayout.LayoutParams))
      {
        ...
        ((RelativeLayout.LayoutParams)localObject).leftMargin = aekt.a(14.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
  ...
  public void a(Boolean paramBoolean)
  {
    ...
    {
      azib.a((SystemBarCompact)localObject, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().getWindow(), paramBoolean);
      p();
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    Object localObject1 = (afby)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(23);
    boolean bool = paramBoolean;
    if (localObject1 != null) {
      if (!((afby)localObject1).b())
      {
        bool = paramBoolean;
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton != null) && (this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Boolean))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setText(2131690797);
      if (AppSetting.jdField_c_of_type_Boolean) {
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setContentDescription(alpo.a(2131714559));
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setVisibility(0);
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setEnabled(true);
      ...
      if ((localObject1 instanceof LinearLayout.LayoutParams))
      {
        ...
        ((LinearLayout.LayoutParams)localObject1).leftMargin = aekt.a(2.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
        ((LinearLayout.LayoutParams)localObject1).rightMargin = aekt.a(6.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
      ...
      if ((localObject2 instanceof LinearLayout.LayoutParams))
      {
        ...
        {
          ((LinearLayout.LayoutParams)localObject2).width = (((LinearLayout.LayoutParams)localObject2).width + this.g + this.h + this.k + this.l - aekt.a(8.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources()));
    ...
    localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton;
    if (this.jdField_e_of_type_Boolean) {}
    for (int i1 = 2130838076;; i1 = 2130838077)
    {
      ((PatchedButton)localObject1).setBackgroundResource(i1);
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setText("");
      if (AppSetting.jdField_c_of_type_Boolean) {
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setContentDescription(alpo.a(2131714554));
      }
      localObject1 = this.jdField_a_of_type_AndroidWidgetLinearLayout.getLayoutParams();
      if ((localObject1 instanceof LinearLayout.LayoutParams))
      {
  ...
  public void b(boolean paramBoolean)
  {
    int i2 = 2130838076;
    boolean bool = true;
    Object localObject = (afby)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(23);
    if ((localObject != null) && ((((afby)localObject).b()) || (this.jdField_f_of_type_Boolean))) {}
    for (int i1 = 1;; i1 = 0)
    {
      ...
      label178:
      for (i1 = 2130838076;; i1 = 2130838077)
      {
  ...
  public void c()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout != null) && (a()) && (this.jdField_b_of_type_Boolean))
    {
      ...
      int i1 = aekt.a(10.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout != null) && (this.jdField_b_of_type_Int != -1) && (this.jdField_c_of_type_Int != -1))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(aekt.a(1.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources()));
      }
  ...
  public boolean c()
  {
    afby localafby = (afby)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(23);
    return (localafby != null) && ((localafby.b()) || (this.jdField_f_of_type_Boolean));
  }
  ...
  void f()
  {
    ...
    {
      BusinessInfoCheckUpdate.RedTypeInfo localRedTypeInfo = ((axho)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(10);
