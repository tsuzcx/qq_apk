  ...
  implements wou
{
  ...
  private LocationListener jdField_a_of_type_AndroidLocationLocationListener = new yyi(this);
  public final Object a;
  public final List<yyd> a;
  public final Queue<yyd> a;
  public final ConcurrentHashMap<String, yyd> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = wes.g + "emoji";
  ...
  public static String a(yye paramyye, String paramString)
  {
    return paramyye.a("emoji_pack_url_" + paramString, "");
  }
  
  private static xaq a()
  {
    int i = 0;
    try
    {
      byte[] arrayOfByte = zkr.b(new File(jdField_a_of_type_JavaLangString + "/" + "list.pb"));
      if (arrayOfByte != null) {
        i = arrayOfByte.length;
      }
      yqp.a("DoodleEmojiManager", "restoreFilterItemListLocked file length = %d", Integer.valueOf(i));
      if (arrayOfByte == null) {
        return null;
      }
      ...
      if (i == 18)
      {
        ...
        try
        {
          ...
          return new xaq((qqstory_service.RspGetEmoticonPackList)localObject, arrayOfByte, l);
        }
        catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
        {
          yqp.e("DoodleEmojiManager", "restoreResponseFromFile error : " + localInvalidProtocolBufferMicroException);
          return null;
        }
      }
      return null;
    ...
    {
      yqp.d("DoodleEmojiManager", "restoreResponseFromFile failed FileNotFoundException");
      return null;
      yqp.d("DoodleEmojiManager", "restoreResponseFromFile find illegal file with magic code %d", new Object[] { Integer.valueOf(i) });
      return null;
    }
    catch (Exception localException)
    {
      yqp.c("DoodleEmojiManager", "restoreResponseFromFile failed", localException);
    }
  }
  ...
  /* Error */
  public static void a(xaq paramxaq)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   12: getstatic 51	yye:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   31: invokestatic 273	zkr:d	(Ljava/lang/String;)Z
    //   34: pop
    //   35: getstatic 51	yye:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   38: invokestatic 54	yye:a	(Ljava/lang/String;)V
    ...
    //   67: aload_2
    //   68: aload_0
    //   69: getfield 286	xaq:jdField_a_of_type_Long	J
    //   72: invokevirtual 290	java/io/ObjectOutputStream:writeLong	(J)V
    //   75: aload_2
    //   76: aload_0
    //   77: getfield 293	xaq:jdField_a_of_type_ArrayOfByte	[B
    //   80: arraylength
    //   81: invokevirtual 284	java/io/ObjectOutputStream:writeInt	(I)V
    //   84: aload_2
    //   85: aload_0
    //   86: getfield 293	xaq:jdField_a_of_type_ArrayOfByte	[B
    ...
    //   111: getstatic 51	yye:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   153: ldc_w 313
    //   156: aload_0
    //   157: getfield 293	xaq:jdField_a_of_type_ArrayOfByte	[B
    //   160: arraylength
    //   161: invokestatic 187	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   164: invokestatic 192	yqp:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    //   167: aload_1
    //   168: ifnull +7 -> 175
    //   171: aload_1
    ...
    //   205: ldc_w 318
    //   208: aload_2
    //   209: invokestatic 249	yqp:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   212: aload_0
    //   213: ifnull +7 -> 220
    //   216: aload_0
  ...
  public static void a(yye paramyye, String paramString1, String paramString2)
  {
    paramyye.a("emoji_pack_md5_" + paramString1, paramString2);
  }
  ...
  private static boolean a(File paramFile)
  {
    ...
    {
      return false;
      paramFile = paramFile.listFiles(new yym());
  ...
  public static String b(yye paramyye, String paramString)
  {
    return paramyye.a("emoji_pack_name_" + paramString, "");
  }
  
  private static void b(yye paramyye, String paramString1, String paramString2)
  {
    paramyye.a("emoji_pack_url_" + paramString1, paramString2);
  }
  
  public static String c(yye paramyye, String paramString)
  {
    return paramyye.a("emoji_pack_config_" + paramString, "");
  }
  
  private static void c(yye paramyye, String paramString1, String paramString2)
  {
    paramyye.a("emoji_pack_name_" + paramString1, paramString2);
  }
  
  public static String d(yye paramyye, String paramString)
  {
    return paramyye.a("emoji_pack_md5_" + paramString, "");
  }
  
  private static void d(yye paramyye, String paramString1, String paramString2)
  {
    paramyye.a("emoji_pack_config_" + paramString1, paramString2);
  }
  
  private void e()
  {
    long l = 0L;
    yqp.b("DoodleEmojiManager", "fireRequestEmojiPackList, cookie = " + this.jdField_b_of_type_JavaLangString);
    if (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.getAndSet(true))
    {
      ...
      if (l > 5000L) {
        yqp.d("DoodleEmojiManager", "fireRequestEmojiPackList previous requesting is time out, fire another request, past time = %d", new Object[] { Long.valueOf(l) });
      }
    }
    else
    {
      this.jdField_a_of_type_Long = SystemClock.elapsedRealtime();
      wlb.a().a(new wys(this.jdField_b_of_type_JavaLangString, 50), new yyl(this));
      return;
    }
    yqp.d("DoodleEmojiManager", "fireRequestEmojiPackList now is already requesting, just waiting is ok, requesting past time = %d", new Object[] { Long.valueOf(l) });
  }
  ...
  public String a(@NonNull String paramString1, @NonNull String paramString2)
  {
    ...
    yqp.b("DoodleEmojiManager", "getStringValue, key : %s, value : %s", paramString1, paramString2);
    return paramString2;
  }
  ...
  public List<yyd> a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilList)
    {
      ...
      {
        yqp.d("DoodleEmojiManager", "current emoji packages is null.");
    ...
    yqp.c("DoodleEmojiManager", "current emoji packages's size=" + localArrayList.size());
    return localArrayList;
  }
  
  @NonNull
  public List<yyd> a(boolean paramBoolean)
  {
    if (!a()) {
      return Collections.EMPTY_LIST;
    }
  ...
  public void a(int paramInt1, int paramInt2, yyr paramyyr)
  {
    paramyyr = new WeakReference(paramyyr);
    wlb.a().a(new wzc(paramInt1, paramInt2), new yyk(this, paramyyr));
  }
  ...
  public void a(Context paramContext)
  {
    ...
    {
      paramContext = (yye)wpm.a(8);
      Object localObject1 = new File(jdField_a_of_type_JavaLangString);
      if ((((File)localObject1).exists()) && (((File)localObject1).isDirectory()))
      {
        localObject1 = ((File)localObject1).listFiles(new yyf(this));
        if (localObject1 != null)
        {
          ...
          if (i < j)
          {
            ...
            Object localObject2 = localFile.listFiles(new yyg(this));
            if ((localObject2 != null) && (localObject2.length > 0))
            {
              localObject2 = a(localFile);
              Object localObject3 = b(paramContext, (String)localObject2);
              localObject3 = new yyd((String)localObject2, a(paramContext, (String)localObject2), (String)localObject3, null, c(paramContext, (String)localObject2), d(paramContext, (String)localObject2));
              ((yyd)localObject3).a(localFile.getPath());
      ...
      {
        yqp.c("DoodleEmojiManager", "has valid emoji packages cache. startTime=" + paramContext.jdField_a_of_type_Long + " currentTime=" + System.currentTimeMillis());
  ...
  {
    yqp.b("DoodleEmojiManager", "saveStringValue, key : %s, value : %s", paramString1, paramString2);
    this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putString(paramString1, paramString2).apply();
  }
  
  public void a(wre paramwre, yyr paramyyr)
  {
    yqp.b("DoodleEmojiManager", "requestPoiFaces " + paramyyr);
    ...
    if (localwre != null)
    {
      a(localwre.b, localwre.jdField_a_of_type_Int, paramyyr);
      return;
    }
    localwrf.a(new yyj(this, paramyyr));
    localwrf.c();
  }
  
  protected void a(boolean paramBoolean1, @NonNull xaq paramxaq, boolean paramBoolean2)
  {
    yye localyye = (yye)wpm.a(8);
    ...
    Iterator localIterator = paramxaq.jdField_a_of_type_JavaUtilList.iterator();
    xar localxar;
    yyd localyyd;
    if (localIterator.hasNext())
    {
      localxar = (xar)localIterator.next();
      if (localxar.b != 1) {
        break label476;
      }
      localyyd = (yyd)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(localxar.jdField_a_of_type_JavaLangString);
      if (localyyd == null) {
        break label476;
      }
      ??? = localyyd.a();
      if (TextUtils.equals(localyyd.g, localxar.f)) {
        break label473;
      }
      yqp.a("DoodleEmojiManager", "EmojiPack md5 has changed. old : %s, new : %s", localyyd.g, localxar.f);
    }
    for (;;)
    {
      try
      {
        zkr.d((String)???);
        ??? = null;
        localyyd = new yyd(localxar);
        localyyd.a((String)???);
        b(localyye, localyyd.jdField_a_of_type_JavaLangString, localyyd.jdField_b_of_type_JavaLangString);
        c(localyye, localyyd.jdField_a_of_type_JavaLangString, localyyd.d);
        d(localyye, localyyd.jdField_a_of_type_JavaLangString, localyyd.f);
        a(localyye, localyyd.jdField_a_of_type_JavaLangString, localyyd.g);
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(localxar.jdField_a_of_type_JavaLangString, localyyd);
        if (paramBoolean2)
        {
          yqp.a("DoodleEmojiManager", "from local get doodle item : %s", localyyd);
          localArrayList.remove(localyyd);
          localArrayList.add(localyyd);
        }
      }
      catch (Exception localException)
      {
        ...
        continue;
        yqp.a("DoodleEmojiManager", "from network get doodle item : %s", localException);
        continue;
      }
      do
      {
        synchronized (this.jdField_a_of_type_JavaUtilList)
        {
          ...
          wfo.a().dispatch(new yyo());
          this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(false);
          if ((!paramBoolean2) && (!paramxaq.jdField_a_of_type_Boolean))
          {
            e();
            return;
          }
      ...
      yqp.b("DoodleEmojiManager", "start download the first emoji pack if needed : " + ((yyd)localArrayList.get(0)).jdField_a_of_type_JavaLangString);
      a(((yyd)localArrayList.get(0)).jdField_a_of_type_JavaLangString, false);
      return;
      label473:
      continue;
      label476:
  ...
  public boolean a(String paramString, boolean paramBoolean)
  {
    ...
    yyd localyyd = (yyd)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
    if (localyyd == null)
    {
      yqp.d("DoodleEmojiManager", "can not find pack item by id " + paramString);
      return false;
    }
    ??? = new File(b(localyyd.jdField_a_of_type_JavaLangString));
    if ((a((File)???)) && (!paramBoolean))
    {
      yqp.d("DoodleEmojiManager", "already has local emoji folder, notify download success directly");
      localyyd.a(((File)???).getPath());
      wfo.a().dispatch(new yyn(localyyd, 0, true, 0L, 0L));
      return true;
    }
    if (!TextUtils.isEmpty(localyyd.a()))
    {
      yqp.d("DoodleEmojiManager", "local emoji folder is missing");
      localyyd.a(null);
    }
    if (TextUtils.isEmpty(localyyd.e))
    {
    ...
    {
      if (!this.jdField_a_of_type_JavaUtilQueue.contains(localyyd))
      {
        this.jdField_a_of_type_JavaUtilQueue.offer(localyyd);
  ...
  protected void c()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      {
        this.jdField_a_of_type_Yyd = ((yyd)this.jdField_a_of_type_JavaUtilQueue.poll());
        if (this.jdField_a_of_type_Yyd != null)
        {
          yqp.b("DoodleEmojiManager", "downloader startDownload : " + this.jdField_a_of_type_Yyd);
          Bosses.get().postJob(new yyh(this, this.jdField_a_of_type_Yyd));
        }
        return;
      }
      yqp.b("DoodleEmojiManager", "can not start download because find one is still downloading : " + this.jdField_a_of_type_Yyd);
    }
  }
  
  public void d()
  {
    yqp.b("DoodleEmojiManager", "stopRequestSpeed.");
