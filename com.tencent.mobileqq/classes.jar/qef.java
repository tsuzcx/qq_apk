...
public abstract class qef
{
  ...
  osm jdField_a_of_type_Osm = new qeg(this);
  private qeh jdField_a_of_type_Qeh;
  ...
  private void a(Bundle paramBundle, qig paramqig, int paramInt)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("video_bit_rate", Long.valueOf(paramqig.b()).toString());
      ((JSONObject)localObject).put("video_capacity", Long.valueOf(paramqig.a()).toString());
      ...
      nol.a(null, "", "0X80093D4", "0X80093D4", 0, 0, "", "", "", ((JSONObject)localObject).toString(), false);
      return;
    }
  ...
  private void b(int paramInt)
  {
    ...
    {
      localaxrn.a(str, "actReadInJoyDeliverVideoSendRequest", bool, this.jdField_f_of_type_Long - this.jdField_c_of_type_Long, 0L, localHashMap, "");
      return;
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      localaxrn.a(str, "actReadInJoyDeliverUGCVideo", bool, this.jdField_e_of_type_Long - this.jdField_a_of_type_Long, 0L, localHashMap, "");
      return;
    }
  }
  
  public void a(boolean paramBoolean, Context paramContext, Bundle paramBundle, qig paramqig, qeh paramqeh)
  {
    String str1 = paramqig.a();
    String str2 = paramqig.b();
    String str3 = paramqig.c();
    String str4 = paramqig.d();
    String str5 = paramqig.e();
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Qeh = paramqeh;
    if (paramBundle == null) {}
