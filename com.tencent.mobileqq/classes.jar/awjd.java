  ...
  extends awiz
{
  ...
  String b()
  {
    ...
    {
      localObject = new awju();
      ((awju)localObject).jdField_b_of_type_Int = this.jdField_b_of_type_Int;
      ((awju)localObject).d = this.d;
      ((awju)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
      ((awju)localObject).f = this.f;
      localObject = bayu.a((awju)localObject, n, null);
      if (localObject == null) {
        break label129;
      }
    ...
    Object localObject = bayu.a(this, n, null);
    if (localObject != null) {
      return ((URL)localObject).toString();
    }
    label129:
