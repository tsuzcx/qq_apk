  ...
  implements MusicPlayerProxy
{
  ...
  private ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new bjxp(this);
  private awxx jdField_a_of_type_Awxx = new bjxr(this);
  ...
  private void b()
  {
    try
    {
      if (this.jdField_a_of_type_Awxz != null)
      {
        ...
        this.jdField_a_of_type_Awxz = null;
      }
      return;
    }
    catch (Throwable localThrowable)
  ...
  public com.tencent.qqmini.sdk.launcher.core.model.SongInfo getCurrentSong()
  {
    try
    {
      if (this.jdField_a_of_type_Awxz != null)
      {
        com.tencent.mobileqq.music.SongInfo localSongInfo = this.jdField_a_of_type_Awxz.a();
  ...
  public int getCurrentSongPosition()
  {
    if (this.jdField_a_of_type_Awxz != null) {
      try
      {
        int i = this.jdField_a_of_type_Awxz.d();
        return i;
      }
      catch (Exception localException)
      {
  ...
  public int getDuration()
  {
    if (this.jdField_a_of_type_Awxz != null) {
      try
      {
        int i = this.jdField_a_of_type_Awxz.c();
        return i;
      }
      catch (Exception localException)
      {
  ...
  {
    return this.jdField_a_of_type_Awxz != null;
  }
  ...
  public boolean isPlaying()
  {
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_Awxz == null) || (!this.jdField_a_of_type_Awxz.a(a())))
      {
  ...
  public void seekTo(int paramInt)
  {
    ...
    {
      if (this.jdField_a_of_type_Awxz != null) {
        this.jdField_a_of_type_Awxz.b(paramInt);
      }
      return;
    }
    catch (Exception localException)
  ...
  public void setPlayMode(int paramInt)
  {
    ...
    {
      if (this.jdField_a_of_type_Awxz != null) {
        this.jdField_a_of_type_Awxz.a(paramInt);
      }
      return;
    }
    catch (Exception localException)
  ...
  public void startPlay(com.tencent.qqmini.sdk.launcher.core.model.SongInfo[] paramArrayOfSongInfo, int paramInt)
  {
    ...
    while (this.jdField_a_of_type_Awxz == null) {
      return;
    }
    try
    {
      this.jdField_a_of_type_Awxz.a(new Intent(BaseApplication.getContext(), MusicPlayerActivity.class));
      Bundle localBundle = this.jdField_a_of_type_Awxz.a();
      Object localObject = localBundle;
      if (localBundle == null)
      {
        localObject = new Bundle();
        this.jdField_a_of_type_Awxz.a((Bundle)localObject);
      }
      ...
      this.jdField_a_of_type_Awxz.a(100);
      this.jdField_a_of_type_Awxz.a(a(), (com.tencent.mobileqq.music.SongInfo[])localObject, paramInt);
      return;
    }
