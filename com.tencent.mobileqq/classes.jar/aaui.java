  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      if (!TextUtils.isEmpty(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopColorNick))
      {
        ...
        localObject1 = new ayju(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopColorNick, 16).a();
        paramMessage.setRightText((CharSequence)localObject1);
        bboe.a(this.a.app, paramMessage.a(), (Spannable)localObject1);
        return;
      }
      paramMessage.setRightText(this.a.getString(2131697817));
      bboe.a(this.a.app, paramMessage.a(), new SpannableString(""));
      return;
    ...
    if (this.a.jdField_c_of_type_AndroidWidgetTextView != null) {
      this.a.jdField_c_of_type_AndroidWidgetTextView.setText(ajyc.a(2131701744) + this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.wMemberNum + ajyc.a(2131701750));
    }
    this.a.b(true);
    this.a.e();
    this.a.a(this.a.e);
    ...
    for (;;)
    {
      ...
      if ((localObject2 != null) && (((List)localObject2).size() > 0))
      {
        ...
        for (;;)
        {
          if (((Iterator)localObject2).hasNext())
          {
            ...
            continue;
            if ((this.a.jdField_a_of_type_Basm == null) || (TextUtils.isEmpty(this.a.jdField_a_of_type_Basm.a))) {
              break label1404;
            }
            if (ajyc.a(2131701737).equals(this.a.jdField_a_of_type_Basm.a))
            {
              i = 0;
              break;
            }
            paramMessage = this.a.jdField_a_of_type_Basm.a;
            i = 1;
            break;
          }
        }
      ...
      if ((localView2 != null) && (localView1 != null) && ((localView1 instanceof FormSwitchItem)))
      {
        ...
        localObject1 = "";
        paramMessage = "";
        Boolean localBoolean = (Boolean)this.a.jdField_a_of_type_Bbix.c.get(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
      ...
      for (;;)
      {
        ((FormSimpleItem)localObject2).setRightText(new ayki((CharSequence)localObject1, 3));
        ((TextView)localObject3).setText(paramMessage);
        ((TextView)localObject3).setTextColor(this.a.getResources().getColor(2131166928));
        asfb.a().c(this.a.app, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
        return;
        label1045:
        ...
        default: 
          ...
          break;
        case 2: 
          localObject1 = this.a.getString(2131697890);
          paramMessage = this.a.getString(2131697892);
          break;
        case 3: 
          localObject1 = this.a.getString(2131693206);
          paramMessage = this.a.getString(2131697888);
          break;
        case 4: 
          localObject1 = this.a.getString(2131697894);
          paramMessage = this.a.getString(2131697896);
          break;
          label1204:
          localView2.setVisibility(0);
          localView1.setBackgroundResource(2130839179);
      ...
      if (i == 0) {}
      for (paramMessage = null;; paramMessage = this.a.getResources().getDrawable(2130849288))
      {
