  ...
  extends BaseAdapter
{
  ...
  public aaui(Context paramContext, List<T> paramList)
  {
  ...
  protected abstract void a(aauj paramaauj, T paramT, int paramInt);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramInt < getCount() - 1)
    {
      ...
      localObject2 = new aauj(paramView, null);
      paramView.setTranslationX(0.0F);
      if (this.jdField_a_of_type_JavaUtilList != null) {
        localObject1 = this.jdField_a_of_type_JavaUtilList.get(paramInt);
      }
      a((aauj)localObject2, localObject1, paramInt);
    ...
    for (;;)
    {
      ...
      return localObject2;
      localObject1 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560273, paramViewGroup, false);
