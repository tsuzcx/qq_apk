...
public class bddh
{
  ...
  public static Bitmap a(int paramInt, Bitmap.Config paramConfig, Bitmap[] paramArrayOfBitmap)
  {
    ...
    Object localObject = new bddj[j];
    i = 0;
    while (i < j)
    {
      localObject[i] = new bddj(null);
      i += 1;
    }
  ...
  public static Bitmap a(int paramInt, Bitmap[] paramArrayOfBitmap)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        arrayOfbddj = new bddj[i];
        j = 0;
        while (j < i)
        {
          arrayOfbddj[j] = new bddj(null);
          j += 1;
        }
        ...
        arrayOfbddj[0].a = 0;
        arrayOfbddj[0].b = 0;
        arrayOfbddj[0].c = (paramInt / 2 - 1);
        arrayOfbddj[0].d = paramInt;
        arrayOfbddj[0].e = 1;
        arrayOfbddj[1].a = (paramInt / 2 + 1);
        arrayOfbddj[1].b = 0;
        arrayOfbddj[1].c = paramInt;
        arrayOfbddj[1].d = paramInt;
        arrayOfbddj[1].e = 1;
        paramInt = 0;
    ...
    if (arrayOfbddj[paramInt].e == 1) {
      localRect.set(j / 4, 0, j / 4 * 3, k);
    }
    for (;;)
    {
      localRectF.set(arrayOfbddj[paramInt].a, arrayOfbddj[paramInt].b, arrayOfbddj[paramInt].c, arrayOfbddj[paramInt].d);
      ...
      if (i == 3)
      {
        ...
        arrayOfbddj[1].b = 0;
        arrayOfbddj[1].c = paramInt;
        arrayOfbddj[1].d = (paramInt / 2 - 1);
        arrayOfbddj[1].e = 2;
        arrayOfbddj[2].a = (paramInt / 2 + 1);
        arrayOfbddj[2].b = (paramInt / 2 + 1);
        arrayOfbddj[2].c = paramInt;
        arrayOfbddj[2].d = paramInt;
        arrayOfbddj[2].e = 2;
        break;
      }
      if (i < 4) {
      ...
      arrayOfbddj[2].e = 2;
      arrayOfbddj[3].a = 0;
      arrayOfbddj[3].b = (paramInt / 2 + 1);
      arrayOfbddj[3].c = (paramInt / 2 - 1);
      arrayOfbddj[3].d = paramInt;
      arrayOfbddj[3].e = 2;
      break;
