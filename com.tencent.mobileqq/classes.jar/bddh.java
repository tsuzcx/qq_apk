...
public class bddh
{
  private static volatile bddh jdField_a_of_type_Bddh;
  public static boolean a;
  private long jdField_a_of_type_Long;
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<View> jdField_a_of_type_JavaLangRefWeakReference;
  private WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new bddj(this);
  ...
  public static bddh a()
  {
    if (jdField_a_of_type_Bddh == null) {}
    try
    {
      if (jdField_a_of_type_Bddh == null) {
        jdField_a_of_type_Bddh = new bddh();
      }
      return jdField_a_of_type_Bddh;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    {
      if (i != 0) {
        QIPCServerHelper.getInstance().register(new bddi(this, "QR_LOGIN_QIPC_MODULE_NAME"));
      }
      return;
      i = 0;
    }
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    for (paramArrayOfByte = new String(paramArrayOfByte);; paramArrayOfByte = ajya.a(2131711197))
    {
  ...
  public void a(Bundle paramBundle, boolean paramBoolean)
  {
    ...
    if ((!TextUtils.isEmpty("")) && (!"".equals(localObject1)))
    {
      ...
      localByteBuffer.put(arrayOfByte);
      arrayOfByte = localByteBuffer.array();
      ((ArrayList)localObject2).add(bbea.a((byte[])localObject3));
      ((ArrayList)localObject2).add(bbea.a(arrayOfByte));
    ...
    for (int i = 1;; i = 0)
    {
      ...
      ((ArrayList)localObject2).add(bbea.a(((ByteBuffer)localObject3).array()));
