  ...
  extends wpa<xfh>
{
  ...
  public ArrayList<wsy> a;
  public int c;
  
  static
  {
    jdField_a_of_type_JavaLangString = wnu.a("StorySvc.video_watch_batch");
  }
  ...
  public wov a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new xfh(localRspWatchVideoBatch);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      for (;;)
      {
        yuk.d("Q.qqstory:WatchVideoBatchRequest", paramArrayOfByte.toString());
      }
    }
  }
  ...
  protected byte[] a()
  {
    ...
    {
      wsy localwsy = (wsy)localIterator.next();
      qqstory_service.VideoItem localVideoItem = new qqstory_service.VideoItem();
      localVideoItem.vid.set(ByteStringMicro.copyFromUtf8(localwsy.jdField_a_of_type_JavaLangString));
      Object localObject = a(localwsy.b);
      localVideoItem.to_union_id.set(ByteStringMicro.copyFromUtf8((String)localObject));
      localObject = localVideoItem.is_live_video;
      if (localwsy.jdField_a_of_type_Boolean) {}
      for (int i = 1;; i = 0)
      {
        ((PBUInt32Field)localObject).set(i);
        localVideoItem.create_time.set(localwsy.jdField_a_of_type_Long / 1000L);
        localVideoItem.source.set(localwsy.jdField_a_of_type_Int);
