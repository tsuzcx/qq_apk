...
public class akrv
{
  ...
  public void a()
  {
    this.jdField_a_of_type_JavaLangString = (aknk.a() + "ar_cloud_img/");
  ...
  public void a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, ARRecognition paramARRecognition, akrw paramakrw)
  {
    if (QLog.isColorLevel()) {
      QLog.d("AREngine_ARCloudPretreatmentManagert", 2, "[ScanStarFace]pretreatFaceRecogInfo,  FaceScanModelsLoader.hasFaceModelInit =  " + akoc.b);
    }
    if (!akoc.b)
    {
    ...
    akry localakry = new akry();
    localakry.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    ...
    if (akss.a != null)
    {
      if (akss.a.hasMessages(4))
      {
        if (QLog.isColorLevel()) {
          QLog.d("AREngine_ARCloudPretreatmentManagert", 2, "[DEBUG_SCAN_yt_face] pretreatFaceRecogInfo, remove pending task");
        }
        akss.a.removeMessages(4);
      }
      paramArrayOfByte = Message.obtain(akss.a, new ARCloudPretreatmentManager.1(this, paramARRecognition, localFaceCluster, paramArrayOfByte, paramInt1, paramInt2));
      paramArrayOfByte.what = 4;
      if (akss.a != null) {
        akss.a.sendMessage(paramArrayOfByte);
      }
    }
    for (;;)
    {
      ...
      {
        localakry.jdField_a_of_type_ArrayOfComTencentYTFaceModelFaceStatus = paramARRecognition;
        awqx.b(null, "dc00898", "", "", "0X800834C", "0X800834C", 0, 0, "", "", "", "");
      }
      paramakrw.a(localakry);
      return;
      if (QLog.isColorLevel()) {
  ...
  public void a(byte[] paramArrayOfByte, ARRecognition paramARRecognition, akrw paramakrw)
  {
    paramArrayOfByte = new aksi();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramakrw.a(paramArrayOfByte);
  }
  
  public void a(byte[] paramArrayOfByte, ArrayList<ARRecognition> paramArrayList, akrw paramakrw, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramArrayOfByte.hasNext())
    {
      ...
      if (l3 == 1L) {
        a(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramakrw);
      }
      for (;;)
      {
        break;
        if (l3 == 2L)
        {
          b(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramakrw);
        }
        else if (l3 == 4L)
        {
          l1 = System.currentTimeMillis();
          a(this.jdField_a_of_type_ArrayOfByte, j, i, paramArrayList, paramakrw);
          l1 = System.currentTimeMillis() - l1;
        }
        else if (l3 == 64L)
        {
          d(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramakrw);
        }
        else if (l3 == 128L)
        {
          c(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramakrw);
        }
        else if (l3 == 2048L)
        {
          e(this.jdField_a_of_type_ArrayOfByte, paramArrayList, paramakrw);
        }
      }
    }
    paramArrayList = new YuvImage(this.jdField_a_of_type_ArrayOfByte, paramInt3, j, i, null);
    paramArrayOfByte = a();
    paramArrayOfByte = new akrx(this.jdField_a_of_type_JavaLangString, paramArrayOfByte, this.jdField_a_of_type_ArrayOfByte);
    ...
    aksp localaksp = aksp.a();
    localaksp.c = l1;
    localaksp.b = l2;
    l1 = paramArrayOfByte.jdField_a_of_type_ArrayOfByte.length / 8192;
    paramakrw.a(jdField_a_of_type_Int, paramArrayList, l1);
  }
  ...
  public void b(byte[] paramArrayOfByte, ARRecognition paramARRecognition, akrw paramakrw)
  {
    paramArrayOfByte = new akrz();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramakrw.a(paramArrayOfByte);
  }
  
  public void c(byte[] paramArrayOfByte, ARRecognition paramARRecognition, akrw paramakrw)
  {
    paramArrayOfByte = new akrz();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramakrw.b(paramArrayOfByte);
  }
  
  public void d(byte[] paramArrayOfByte, ARRecognition paramARRecognition, akrw paramakrw)
  {
    paramArrayOfByte = new aksa();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramakrw.a(paramArrayOfByte);
  }
  
  public void e(byte[] paramArrayOfByte, ARRecognition paramARRecognition, akrw paramakrw)
  {
    paramArrayOfByte = new aksb();
    paramArrayOfByte.jdField_a_of_type_Int = ((int)paramARRecognition.b);
    paramakrw.a(paramArrayOfByte);
  }
}
