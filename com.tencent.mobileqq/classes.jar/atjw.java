  ...
  extends atju
{
  ...
  atjv jdField_a_of_type_Atjv;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private FileManagerEntity jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity;
  boolean jdField_a_of_type_Boolean = false;
  long b;
  
  public atjw(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
    ...
    this.jdField_a_of_type_Atjv.a.jdField_a_of_type_JavaLangString = atvo.f(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileName);
    this.jdField_a_of_type_Atjv.a.d = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize;
    this.jdField_a_of_type_Atjv.a.jdField_b_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerType;
    try
    {
      this.jdField_a_of_type_Atjv.a.c = Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin);
      return;
    }
  ...
  private void a(int paramInt, ExcitingTransferOneSlotComplete paramExcitingTransferOneSlotComplete)
  {
    ...
    String str = "";
    if (this.jdField_a_of_type_Atjv.a != null) {
      str = String.valueOf(this.jdField_a_of_type_Atjv.a.c);
    }
    Bundle localBundle = new Bundle();
    localBundle.putInt("param_fromType", 1);
    localBundle.putInt("param_V6SelectType", this.jdField_a_of_type_Int);
    localBundle.putInt("param_ipAddrType", atwt.b(paramExcitingTransferOneSlotComplete.m_strIp));
    ...
    for (int i = 1;; i = 0)
    {
      ...
      atvo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileDownDetail", this.jdField_b_of_type_Long, paramExcitingTransferOneSlotComplete.m_strIp, str, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, paramInt, "", paramExcitingTransferOneSlotComplete.m_DownloadedSize, paramExcitingTransferOneSlotComplete.m_DownloadedSize, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, paramExcitingTransferOneSlotComplete.m_strIp, "", 0, "", null, localBundle);
      return;
    }
    atvo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, "actFileDownDetail", paramExcitingTransferOneSlotComplete.m_TotalTimes, paramExcitingTransferOneSlotComplete.m_strIp, str, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileMd5, paramExcitingTransferOneSlotComplete.m_DownloadedSize, paramExcitingTransferOneSlotComplete.m_DownloadedSize, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize, 0, null, localBundle);
  }
  ...
  private void a(List<String> paramList1, String paramString, int paramInt, List<String> paramList2, boolean paramBoolean)
  {
    if ((paramList1 == null) || (!atcq.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1)))
    {
      ...
      this.jdField_a_of_type_Atjv.b(this.jdField_a_of_type_Int);
      return;
    }
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        if ((paramString != null) && (!paramString.a()))
        {
          ...
          atcq.a(paramString.jdField_a_of_type_JavaUtilList, paramList1, true, true);
          this.jdField_a_of_type_Int = 2;
  ...
  public void OnOneSlotComplete(int paramInt, ExcitingTransferOneSlotComplete paramExcitingTransferOneSlotComplete)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Atjv.a(i, j, paramExcitingTransferOneSlotComplete);
  ...
  {
    paramExcitingTransferDownloadSpeedInfo = atwt.b(paramExcitingTransferDownloadSpeedInfo.mTotalSpeed);
  ...
  protected atjj a(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Atjv = new atjv(paramQQAppInterface);
    return this.jdField_a_of_type_Atjv;
  }
  ...
  protected void a(ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    atvo.a(paramExcitingTransferDownloadCompletedInfo);
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileName = atvo.a(paramExcitingTransferDownloadCompletedInfo);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileName.getBytes().length > 250 - i) {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileName = atvo.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileName, 250 - i);
    }
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileSha3 = atjh.a(atvo.c(paramExcitingTransferDownloadCompletedInfo));
      if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileSize < 104857600L) {
        this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strFileSHA = atjh.a(atvo.a(paramExcitingTransferDownloadCompletedInfo));
      }
    }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nFileType == 0)
    {
      ...
      atwg.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
    }
    for (;;)
    {
  ...
  protected void a(ExcitingTransferDownloadReqInfo paramExcitingTransferDownloadReqInfo)
  {
    ...
    this.jdField_a_of_type_Atjv.c();
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.Uuid, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileIdCrc, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.bSend, false, new atjx(this, paramExcitingTransferDownloadReqInfo));
  }
  ...
  protected void a(boolean paramBoolean1, long paramLong, String paramString1, String paramString2, ByteStringMicro paramByteStringMicro, boolean paramBoolean2, String paramString3, short paramShort, String paramString4, List<String> paramList, String paramString5, Bundle paramBundle, ExcitingTransferDownloadReqInfo paramExcitingTransferDownloadReqInfo)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Atjv.d();
      if (!paramBoolean1)
      {
        this.jdField_a_of_type_Atjv.b(paramLong);
        a(null, 0);
        return;
      }
      ...
      this.jdField_a_of_type_Atjv.c(this.jdField_a_of_type_Boolean);
    ...
    for (paramString1 = new ArrayList();; paramString1 = paramList)
    {
      ...
      paramExcitingTransferDownloadReqInfo.strSaveFileDir = this.jdField_a_of_type_Atut.b();
  ...
  protected boolean a(long paramLong, ByteStringMicro paramByteStringMicro, String paramString)
  {
    ...
    if ((TextUtils.isEmpty(paramString)) || (paramByteStringMicro == null))
    {
      ...
      this.jdField_a_of_type_Atjv.a.jdField_b_of_type_Long = 9048L;
      this.jdField_a_of_type_Atjv.a.jdField_a_of_type_Long = 2L;
      this.jdField_a_of_type_Atjv.a(5);
      this.jdField_a_of_type_Atjv.a(false);
    }
    for (;;)
    {
      ...
      return bool;
      label101:
      this.jdField_a_of_type_Atjv.c(paramLong);
    }
  }
  ...
  public String b()
  {
    String str1 = this.jdField_a_of_type_Atut.c();
  ...
  public void onRecvComplete(int paramInt, ExcitingTransferDownloadCompletedInfo paramExcitingTransferDownloadCompletedInfo)
  {
    ...
    if (paramExcitingTransferDownloadCompletedInfo != null) {
      this.jdField_a_of_type_Atjv.c(0);
    }
    int i;
    if (paramInt != 0)
    {
      i = a(paramInt);
      this.jdField_a_of_type_Atjv.a.jdField_b_of_type_Long = i;
      this.jdField_a_of_type_Atjv.a.jdField_a_of_type_Long = 4L;
      if (i == 9004)
      {
        this.jdField_a_of_type_Atjv.a.jdField_a_of_type_Long = 5L;
        this.jdField_a_of_type_Atjv.a(3);
        a(null, i);
        label107:
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
        if (paramExcitingTransferDownloadCompletedInfo != null)
        {
          this.jdField_a_of_type_Atjv.a(paramExcitingTransferDownloadCompletedInfo);
          paramExcitingTransferDownloadCompletedInfo = this.jdField_a_of_type_Atjv;
          if (i != 0) {
            break label304;
          }
        }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (i == 506)
      {
        this.jdField_a_of_type_Atjv.a.jdField_a_of_type_Long = 3L;
        this.jdField_a_of_type_Atjv.a(i);
        break;
      }
      this.jdField_a_of_type_Atjv.a(i);
      break;
      ...
      this.jdField_a_of_type_Atjv.a.jdField_b_of_type_Long = paramInt;
      this.jdField_a_of_type_Atjv.a.jdField_a_of_type_Long = 0L;
      this.jdField_a_of_type_Atjv.a(0);
  ...
  {
    this.jdField_a_of_type_Atjv.a(paramLong2);
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.status = 2;
