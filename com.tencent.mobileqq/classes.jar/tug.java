  ...
  implements udn
{
  ...
  public tug(SplitedProgressBar paramSplitedProgressBar)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(null);
    this.jdField_a_of_type_AndroidOsHandler = new tuh(this, Looper.getMainLooper());
  ...
  private void a(long paramLong1, long paramLong2)
  {
    ...
    this.b = paramLong2;
    a(paramLong1);
    veg.a("Q.qqstory.player:NewProgressControler", "seek ft:%d , ed:%d", Long.valueOf(paramLong1), Long.valueOf(paramLong2));
  }
  ...
  {
    if (paramudc == this.jdField_a_of_type_JavaLangRefWeakReference.get())
    {
      veg.a("Q.qqstory.player:NewProgressControler", "progress callback :onSeek , ft:%d , et:%d", Long.valueOf(paramLong1), Long.valueOf(paramLong2));
  ...
  {
    if ((paramudc instanceof udi)) {}
    for (udc localudc = ((udi)paramudc).a();; localudc = paramudc)
    {
      if (localudc == this.jdField_a_of_type_JavaLangRefWeakReference.get())
      {
        veg.b("Q.qqstory.player:NewProgressControler", "cannot set the same video view");
        return;
      }
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(localudc);
      if ((paramudc instanceof udi)) {
        ((udi)paramudc).a(this);
      }
      for (;;)
