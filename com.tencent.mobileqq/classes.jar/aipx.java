...
public class aipx
{
  ...
  public SparseArray<WeakReference<aipz>> a;
    ...
    for (;;)
    {
      ...
      try
      {
        if (aing.a() != null)
        {
          ...
          aipx localaipx = aing.a(paramLong);
          if (localaipx != null)
          {
            str = localaipx.c(str);
  ...
  public static void a(long paramLong, int paramInt, String paramString)
  {
    ...
    try
    {
      ...
      localObject = localaipx.c(paramString);
      if (TextUtils.isEmpty((CharSequence)localObject))
      {
        ...
        localaipx.a(2, localArrayList, null, 3, paramLong, true, ((JSONObject)localObject).toString(), "");
        return;
      }
    }
  ...
  public static void a(long paramLong, int paramInt, String paramString1, String paramString2)
  {
    ...
    paramString1 = new aipy(paramString2, paramLong);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramArrayList != null) && (paramArrayList.size() != 0))
        {
          ...
          localaiqs.a("apollo_aio_game.get_user_uin_or_openid", localJSONObject.toString(), -1L, paramInt2, false, null);
        }
      }
  ...
  public void a(int paramInt1, ArrayList<String> paramArrayList, ArrayList<Long> paramArrayList1, int paramInt2, long paramLong, boolean paramBoolean, String paramString1, String paramString2, aipz paramaipz)
  {
    ...
    this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt2, new WeakReference(paramaipz));
  }
  ...
  public void a(ArrayList<Long> paramArrayList, ArrayList<String> paramArrayList1, int paramInt, long paramLong)
  {
    ...
    try
    {
      ...
      label252:
      aing.a().callbackFromRequest(paramLong, 0, "cs.audioRoom_update_userinfo.local", localJSONObject1.toString());
      return;
    }
    catch (Exception paramArrayList)
    {
            ...
            if (((JSONArray)localObject1).length() > 0)
            {
              ...
              if (i < ((JSONArray)localObject1).length())
              {
                ...
                for (;;)
                {
                  ...
                  localObject2 = (aipz)((WeakReference)localObject2).get();
                  if (localObject2 == null) {
                    break label741;
                  }
                  ((aipz)localObject2).a(0, "", (String)localObject1);
              ...
              if (paramString.has("lState"))
              {
                ...
                if (((JSONArray)localObject3).length() > 0) {
                  aing.a().callbackFromRequest(l, 0, "cs.audioRoom_update_userinfo.local", ((JSONObject)localObject2).toString());
                }
