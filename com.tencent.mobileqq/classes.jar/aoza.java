...
public class aoza
{
  ...
  public aoza(QQAppInterface paramQQAppInterface)
  {
  ...
  private TransFileInfo a(MessageRecord paramMessageRecord)
  {
    ...
    if (paramMessageRecord != null)
    {
      ...
      if (localaukn != null) {
        localObject1 = (TransFileInfo)localaukn.a(TransFileInfo.class, new String[] { String.valueOf(paramMessageRecord.time), String.valueOf(paramMessageRecord.msgseq), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramMessageRecord.frienduin });
      }
    }
  ...
  public int a(String paramString1, int paramInt1, String paramString2, long paramLong, int paramInt2, String paramString3, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramString1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(l, ajsf.v, 0);
        ...
        paramString1.fileName = apue.a(paramString2);
        if (0L == paramLong)
        {
          paramString1.fileSize = apue.a(paramString2);
          paramString1.setFilePath(paramString2);
          paramString1.nOpType = paramInt2;
          paramString1.peerNick = null;
          paramString1.peerType = 0;
          paramString1.peerUin = ajsf.v;
          paramString1.srvTime = (awzw.a() * 1000L);
  ...
  public long a(String paramString, long paramLong1, long paramLong2, int paramInt)
  {
    ...
    aukn localaukn = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createEntityManager();
    if (QLog.isColorLevel()) {
      QLog.d("FileManagerDataCenter<FileAssistant>", 2, "strUin[" + apue.e(paramString) + "], peeryType[" + String.valueOf(paramInt) + "], uniseq[" + String.valueOf(paramLong2) + "]");
    }
    MessageRecord localMessageRecord = null;
    if (paramLong2 > 0L) {
      localMessageRecord = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(paramString, paramInt, paramLong2);
    }
    if ((localMessageRecord != null) && (localaukn != null))
    {
      paramString = (TransFileInfo)localaukn.a(TransFileInfo.class, new String[] { String.valueOf(localMessageRecord.time), String.valueOf(localMessageRecord.msgseq), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString });
      if (paramString == null) {}
    }
  ...
  {
    MessageRecord localMessageRecord = axaq.a(-2005);
    ...
    {
      paramString5 = aywi.a(paramString3, paramLong1, 0, paramBoolean2);
    }
    ...
    if (paramBoolean1)
    {
      ...
      localMessageRecord.shmsgseq = axas.a(paramLong2, paramInt1);
      paramLong1 = paramLong5;
      if (paramLong5 == 0L) {
        paramLong1 = axas.a(axas.a());
      }
      localMessageRecord.msgUid = paramLong1;
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(((MessageForFile)localMessageRecord).fileName)) {
        ((MessageForFile)localMessageRecord).fileName = apue.a(paramString3);
      }
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localMessageRecord, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString2, paramString1, paramInt1);
  ...
  public aozs a()
  {
    ...
    for (;;)
    {
      aozs localaozs = this.jdField_a_of_type_Aozs;
      this.jdField_a_of_type_Aozs = null;
      return localaozs;
      QLog.d("FileManagerDataCenter<FileAssistant>", 1, "getTmpController " + this.jdField_a_of_type_Aozs.getClass().getName());
    }
  }
  ...
  public FileManagerEntity a(long paramLong)
  {
    ...
    apen localapen = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
    if (localapen == null)
    {
      QLog.e("FileManagerDataCenter<FileAssistant>", 1, "QueryFileEntityBySessionId get FileManagerProxy null! nSessionId[" + paramLong + "]");
      return null;
    }
    FileManagerEntity localFileManagerEntity = localapen.a(paramLong);
    if (localFileManagerEntity != null)
    {
      localapen.a(localFileManagerEntity);
  ...
  public FileManagerEntity a(long paramLong1, long paramLong2, String paramString, int paramInt)
  {
    ...
    if (localFileManagerEntity != null)
    {
      QLog.i("FileManagerDataCenter<FileAssistant>", 1, "getFileEntityBySessionid for queryall, FileManagerEntity exist, sessionId[" + String.valueOf(localFileManagerEntity.nSessionId) + "], uniseq[" + String.valueOf(localFileManagerEntity.uniseq) + "], strUin[" + apue.e(localFileManagerEntity.peerUin) + "], peerType[" + String.valueOf(localFileManagerEntity.peerType) + "]");
      return localFileManagerEntity;
    }
    ...
    QLog.i("FileManagerDataCenter<FileAssistant>", 1, "getFileEntityBySessionid, new a FileManagerEntity, sessionId[" + String.valueOf(localFileManagerEntity.nSessionId) + "], uniseq[" + String.valueOf(paramLong2) + "], strUin[" + apue.e(paramString) + "], peerType[" + String.valueOf(paramInt) + "]");
    return localFileManagerEntity;
  }
  ...
  public FileManagerEntity a(long paramLong, String paramString, int paramInt)
  {
    ...
    if (paramLong <= 0L)
    {
      QLog.e("FileManagerDataCenter<FileAssistant>", 1, "QueryFileEntityByuniseq uniseq[" + paramLong + "] is error, strUin[" + apue.e(paramString) + "], peerType[" + paramInt + "]");
      return null;
    }
    apen localapen = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
    if (localapen == null)
    {
      QLog.e("FileManagerDataCenter<FileAssistant>", 1, "QueryFileEntityByuniseq get FileManagerProxy null! strUin[" + apue.e(paramString) + "], uniseq[" + paramLong + "], peerType[" + paramInt + "]");
      return null;
    }
    FileManagerEntity localFileManagerEntity = localapen.a(paramLong, paramString, paramInt);
    if (localFileManagerEntity != null)
    {
      aptw.a(localFileManagerEntity);
      return localFileManagerEntity;
    }
    return localapen.b(paramLong, paramString, paramInt);
  }
  ...
  public FileManagerEntity a(String paramString, long paramLong)
  {
    ...
    FileManagerEntity localFileManagerEntity1 = ((apen)localObject).a(paramString, paramLong);
    if (localFileManagerEntity1 != null) {
    ...
    aukn localaukn = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createEntityManager();
    localObject = localaukn.a(FileManagerEntity.class, (String)localObject, null);
  ...
  {
    QLog.d("FileManagerDataCenter<FileAssistant>", 1, "regTmpController" + paramaozs.getClass().getName());
  ...
  public void a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 15	aoza:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6: invokevirtual 251	com/tencent/mobileqq/app/QQAppInterface:a	()Lapen;
    //   9: astore_2
    //   10: aload_2
    //   11: ifnonnull +69 -> 80
    //   14: ldc 71
    ...
    //   60: invokestatic 286	apue:e	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   102: aload_1
    //   103: invokestatic 650	apue:a	(Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;)Ljava/lang/String;
    ...
    //   115: aload_2
    //   116: aload_1
    //   117: invokevirtual 652	apen:b	(Lcom/tencent/mobileqq/filemanager/data/FileManagerEntity;)V
    //   120: aload_0
    //   121: getfield 15	aoza:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   124: invokevirtual 614	com/tencent/mobileqq/app/QQAppInterface:a	()Laozc;
    //   127: iconst_1
    //   128: iconst_3
    //   129: aconst_null
    //   130: invokevirtual 619	aozc:a	(ZILjava/lang/Object;)V
    //   133: goto -56 -> 77
    //   136: astore_1
    //   137: aload_0
    //   138: monitorexit
  ...
  public void a(boolean paramBoolean, int paramInt, String paramString1, String paramString2, long paramLong)
  {
    ...
    if (paramBoolean)
    {
      localFileManagerEntity.lastTime = (awzw.a() * 1000L + 604800000L);
      localFileManagerEntity.isReaded = false;
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(localFileManagerEntity);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
    apue.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localFileManagerEntity.nSessionId, "actFileOf2Of", 0L, "", "", localFileManagerEntity.peerUin, localFileManagerEntity.Uuid, paramInt, paramString1, 0L, 0L, 0L, "", "", 0, paramString1, null);
  }
  ...
  public boolean a(long paramLong, int paramInt)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("FileManagerDataCenter<FileAssistant>", 2, "strUin[" + apue.e(((FileManagerEntity)localObject2).peerUin) + "], peeryType[" + String.valueOf(((FileManagerEntity)localObject2).peerType) + "], uniseq[" + String.valueOf(((FileManagerEntity)localObject2).uniseq) + "]");
    }
    ...
    if ((localObject2 != null) && (localObject2 != null) && (localObject1 != null))
    {
      ...
      ((aukn)localObject2).a((aukm)localObject1);
      return true;
    }
    return false;
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("FileManagerDataCenter<FileAssistant>", 2, "SetRead: strUin[" + apue.e(paramString) + "], peeryType[" + paramInt + "], uniseq[" + paramLong + "]");
    }
  ...
  public FileManagerEntity b(long paramLong, String paramString, int paramInt)
  {
    ...
    if (paramLong > 0L)
    {
      FileManagerEntity localFileManagerEntity = ((apen)localObject).a(paramLong, paramString, paramInt);
      if (localFileManagerEntity != null)
      {
        QLog.i("FileManagerDataCenter<FileAssistant>", 1, "getFileEntityByuniseq for memory, FileManagerEntity exist, sessionId[" + String.valueOf(localFileManagerEntity.nSessionId) + "], uniseq[" + String.valueOf(localFileManagerEntity.uniseq) + "], strUin[" + apue.e(localFileManagerEntity.peerUin) + "], peerType[" + String.valueOf(localFileManagerEntity.peerType) + "]");
        return localFileManagerEntity;
      }
      localObject = ((apen)localObject).b(paramLong, paramString, paramInt);
      if (localObject != null)
      {
        QLog.i("FileManagerDataCenter<FileAssistant>", 1, "getFileEntityByuniseq for db, FileManagerEntity exist, sessionId[" + String.valueOf(((FileManagerEntity)localObject).nSessionId) + "], uniseq[" + String.valueOf(((FileManagerEntity)localObject).uniseq) + "], strUin[" + apue.e(((FileManagerEntity)localObject).peerUin) + "], peerType[" + String.valueOf(((FileManagerEntity)localObject).peerType) + "]");
        return localObject;
      }
    }
    localObject = new FileManagerEntity();
    ((FileManagerEntity)localObject).nSessionId = apue.a().longValue();
    ...
    QLog.i("FileManagerDataCenter<FileAssistant>", 1, "getFileEntityByuniseq, new a FileManagerEntity, sessionId[" + String.valueOf(((FileManagerEntity)localObject).nSessionId) + "], uniseq[" + String.valueOf(paramLong) + "], strUin[" + apue.e(paramString) + "], peerType[" + String.valueOf(paramInt) + "]");
    return localObject;
  }
  ...
  public void b(FileManagerEntity paramFileManagerEntity)
  {
    for (;;)
    {
      ...
      try
      {
        localapen = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        if (localapen == null)
        {
          QLog.e("FileManagerDataCenter<FileAssistant>", 1, "insertToFMListAddOrReplaceDB get FileManagerProxy null! nSessionId[" + paramFileManagerEntity.nSessionId + "], uniseq[" + paramFileManagerEntity.uniseq + "], peerUin[" + apue.e(paramFileManagerEntity.peerUin) + "]");
          return;
        }
        ...
        {
          localapen.b(paramFileManagerEntity);
          continue;
        }
        localapen.c(paramFileManagerEntity);
      }
      finally {}
      localapen.e(paramFileManagerEntity);
    }
  }
