  ...
  implements Handler.Callback
{
  ...
  private aoyz jdField_a_of_type_Aoyz = new aozb(this);
  ...
  public static void b(MessageForArkApp paramMessageForArkApp)
  {
    ...
    } while ((localObject2 == null) || (((aoza)localObject2).a(paramMessageForArkApp)));
    if (QLog.isColorLevel()) {
    ...
    ((aoza)localObject2).a((QQAppInterface)localObject1, paramMessageForArkApp);
  }
  ...
  public void a(MessageForArkApp paramMessageForArkApp)
  {
    ...
    if ((localObject1 != null) && ((localObject1 instanceof QQAppInterface)))
    {
      ...
      if (localObject1 != null)
      {
        ...
        if (localObject1 != null) {
          localObject1 = ((aoyx)localObject1).a(paramMessageForArkApp.ark_app_message.appName);
        }
      }
    }
    for (;;)
    {
      ...
      if (localObject1 != null)
      {
        bool = ((aoyy)localObject1).needProcess(paramMessageForArkApp.ark_app_message.toShareMsgJSONObject());
        if (QLog.isColorLevel()) {
        ...
        if (bool)
        {
          ...
          ((aoyy)localObject1).process(paramMessageForArkApp.ark_app_message.toShareMsgJSONObject(), this.jdField_a_of_type_Aoyz, localObject2);
        }
      }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, String paramString, SessionInfo paramSessionInfo, MessageForArkApp paramMessageForArkApp)
  {
    ...
    for (localObject = ((aoyx)localObject).a(paramString);; localObject = null)
    {
      if (QLog.isColorLevel()) {
      ...
      if (localObject != null)
      {
        boolean bool = ((aoyy)localObject).needProcess(paramMessageForArkApp.ark_app_message.toShareMsgJSONObject());
        if (QLog.isColorLevel()) {
        ...
        for (paramString = "1";; paramString = "2")
        {
          ...
          ((aoyy)localObject).process(paramMessageForArkApp.ark_app_message.toShareMsgJSONObject(), this.jdField_a_of_type_Aoyz, paramQQAppInterface);
          return true;
        }
      }
      return false;
