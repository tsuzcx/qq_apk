...
public class bbti
{
  ...
  ArrayList<bbte> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  bbti()
  {
    ...
    this.jdField_a_of_type_Int = bbtk.a(this.jdField_a_of_type_ComTencentMobileqqShortvideoGestureDownloadInfo);
    QLog.d("QavGesture", 1, String.format("GestureMgr, mStatusGesture[%s]", new Object[] { Integer.valueOf(this.jdField_a_of_type_Int) }));
  }
  
  void a(boolean paramBoolean, bbte parambbte)
  {
    ...
    for (;;)
    {
      try
      {
        this.jdField_a_of_type_JavaUtilArrayList.add(parambbte);
        return;
      }
      finally {}
      this.jdField_a_of_type_JavaUtilArrayList.remove(parambbte);
    }
  }
  ...
  boolean a(BaseApplicationImpl paramBaseApplicationImpl)
  {
    ...
    return paramBaseApplicationImpl.registerReceiver(new bbtj(this), localIntentFilter) != null;
  }
  ...
  boolean c()
  {
    ...
    if ((this.jdField_a_of_type_Int == 1) && (bbtk.b(this.jdField_a_of_type_ComTencentMobileqqShortvideoGestureDownloadInfo))) {}
    for (;;)
    {
      return bool;
      bool = false;
