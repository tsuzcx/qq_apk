  ...
  extends BusinessHandler
{
  ...
  public omv(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
  }
  
  public omv(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          ukq.a("AdVideoDataLink", "视频浮层混排回包: article size=" + localList.size());
          ...
          try
          {
            ...
            ukq.a("AdVideoDataLink", "isAd = " + ((VideoInfo)localObject2).jdField_c_of_type_Boolean + " article = " + ((VideoInfo)localObject2).jdField_c_of_type_JavaLangString);
          }
      ...
      if (!bool3)
      {
        ...
        oiz.a(localBundle, (ArrayList)localObject4);
        ...
        localObject3 = localObject5;
        localObject1 = localStringBuilder;
        oiz.a(localRspBody, localBundle, this.jdField_a_of_type_Long);
        paramFromServiceMsg = null;
        paramObject = null;
        continue;
        paramObject = localObject1;
  ...
  private void a(Object paramObject, long paramLong1, VideoInfo paramVideoInfo, int paramInt1, ArrayList<VideoInfo> paramArrayList1, String paramString1, long paramLong2, boolean paramBoolean, int paramInt2, String paramString2, String paramString3, WeishiRedDotInfo paramWeishiRedDotInfo, int paramInt3, String paramString4, byte[] paramArrayOfByte, ArrayList<oidb_0x885.AdTagInfo> paramArrayList, int paramInt4, int paramInt5, int paramInt6, int paramInt7, ArrayList<VideoInfo> paramArrayList2, Bundle paramBundle, int paramInt8)
  {
    ...
    paramString3.msg_phone_info.set(ujw.a());
    ...
    for (;;)
    {
      ...
      catch (Exception paramString3)
      {
        ...
        if (!QLog.isColorLevel())
        {
          ...
          localJSONObject = new JSONObject();
          localObject3 = olx.a().a(paramInt8, paramArrayList1);
          ...
          ((JSONObject)localObject2).put("last_expo_ad_pos", olx.a().a());
          ((JSONObject)localObject2).put("last_req_video_cnt", olx.a().b());
          ...
          if ((uls.jdField_a_of_type_Int != 2) || (!uls.jdField_c_of_type_Boolean)) {
            break label627;
          }
      ...
      for (;;)
      {
        ukq.a("AdVideoDataLink", paramString1.toString());
        break;
      ...
      label2258:
      a(localReqBody);
      paramInt1 = ((Integer)bmhv.a("key_sp_is_readinjoy_youngster", Integer.valueOf(0))).intValue();
      localReqBody.uint32_youngster_status.set(paramInt1);
      localReqBody.uint32_req_recommend_flag.set(a());
      localReqBody.bytes_req_recommend_json.set(ByteStringMicro.copyFromUtf8(prh.a()));
      if (paramBundle != null)
      {
  ...
  private void a(List<VideoInfo> paramList)
  {
    ...
    odz.a().a("RIJAdRefreshSceneFloatVideo", localHashSet);
  }
  ...
  private void a(oidb_0x6cf.ReqBody paramReqBody)
  {
    ...
    if (i < k)
    {
      ...
      str = bhfn.a(BaseApplicationImpl.getContext(), str);
    ...
    try
    {
      ...
      try
      {
        ...
        if (k == 2) {
          ...
          {
            localVideoInfo.jdField_a_of_type_Omr = new omr();
            localVideoInfo.jdField_a_of_type_Omr.jdField_a_of_type_JavaLangString = str1;
            localVideoInfo.jdField_a_of_type_Omr.jdField_b_of_type_JavaLangString = ((String)localObject6);
            localVideoInfo.jdField_a_of_type_Omr.jdField_c_of_type_JavaLangString = str2;
            localVideoInfo.jdField_a_of_type_Omr.jdField_d_of_type_JavaLangString = str3;
            localVideoInfo.jdField_a_of_type_Omr.jdField_e_of_type_JavaLangString = str4;
            localVideoInfo.jdField_a_of_type_Omr.jdField_f_of_type_JavaLangString = str5;
            localVideoInfo.jdField_a_of_type_Omr.jdField_g_of_type_JavaLangString = str6;
            localVideoInfo.jdField_a_of_type_Omr.jdField_h_of_type_JavaLangString = str7;
            localVideoInfo.jdField_a_of_type_Omr.i = str8;
            localVideoInfo.jdField_a_of_type_Omr.jdField_j_of_type_JavaLangString = str9;
            localVideoInfo.jdField_a_of_type_Omr.jdField_k_of_type_JavaLangString = str10;
            localVideoInfo.jdField_a_of_type_Omr.jdField_l_of_type_JavaLangString = str11;
            localVideoInfo.jdField_a_of_type_Omr.jdField_m_of_type_JavaLangString = str12;
            localVideoInfo.jdField_a_of_type_Omr.jdField_a_of_type_Int = i;
            localVideoInfo.jdField_a_of_type_Omr.jdField_b_of_type_Int = j;
            localVideoInfo.jdField_a_of_type_Omr.jdField_n_of_type_JavaLangString = ((String)localObject5);
            localVideoInfo.jdField_a_of_type_Omr.jdField_c_of_type_Int = k;
          }
        }
      }
      catch (Exception localException4)
      {
        for (;;)
        {
          ...
          {
            localVideoInfo.jdField_b_of_type_Omr = new omr();
            localVideoInfo.jdField_b_of_type_Omr.jdField_a_of_type_JavaLangString = localException4;
            localVideoInfo.jdField_b_of_type_Omr.jdField_b_of_type_JavaLangString = ((String)localObject6);
            localVideoInfo.jdField_b_of_type_Omr.jdField_c_of_type_JavaLangString = str2;
            localVideoInfo.jdField_b_of_type_Omr.jdField_d_of_type_JavaLangString = str3;
            localVideoInfo.jdField_b_of_type_Omr.jdField_e_of_type_JavaLangString = str4;
            localVideoInfo.jdField_b_of_type_Omr.jdField_f_of_type_JavaLangString = str5;
            localVideoInfo.jdField_b_of_type_Omr.jdField_g_of_type_JavaLangString = str6;
            localVideoInfo.jdField_b_of_type_Omr.jdField_h_of_type_JavaLangString = str7;
            localVideoInfo.jdField_b_of_type_Omr.i = str8;
            localVideoInfo.jdField_b_of_type_Omr.jdField_j_of_type_JavaLangString = str9;
            localVideoInfo.jdField_b_of_type_Omr.jdField_k_of_type_JavaLangString = str10;
            localVideoInfo.jdField_b_of_type_Omr.jdField_l_of_type_JavaLangString = str11;
            localVideoInfo.jdField_b_of_type_Omr.jdField_m_of_type_JavaLangString = str12;
            localVideoInfo.jdField_b_of_type_Omr.jdField_a_of_type_Int = i;
            localVideoInfo.jdField_b_of_type_Omr.jdField_b_of_type_Int = j;
            localVideoInfo.jdField_b_of_type_Omr.jdField_n_of_type_JavaLangString = ((String)localObject5);
            localVideoInfo.jdField_b_of_type_Omr.jdField_c_of_type_Int = k;
          }
        }
      }
      try
      {
        ...
        {
          localVideoInfo.jdField_b_of_type_Omr = new omr();
          localVideoInfo.jdField_b_of_type_Omr.jdField_a_of_type_JavaLangString = str1;
          localVideoInfo.jdField_b_of_type_Omr.jdField_b_of_type_JavaLangString = ((String)localObject6);
          localVideoInfo.jdField_b_of_type_Omr.jdField_c_of_type_JavaLangString = str2;
          localVideoInfo.jdField_b_of_type_Omr.jdField_d_of_type_JavaLangString = str3;
          localVideoInfo.jdField_b_of_type_Omr.jdField_e_of_type_JavaLangString = str4;
        ...
        for (;;)
        {
          ...
          catch (JSONException localJSONException1)
          {
            ...
            catch (NumberFormatException localNumberFormatException)
            {
              ...
              return null;
              AdvertisementInfo localAdvertisementInfo = ois.a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo);
              if (!ukr.a(null, localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo)) {
                break label4368;
              }
              ...
              try
              {
                ...
                ois.a(new ufy().a(BaseApplication.getContext()).a(80).b(13).a(localAdvertisementInfo).a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo).b(localJSONObject).a());
                uks.a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoAdInfo);
                ...
                localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$SoftAdDownloadBarInfo.jdField_a_of_type_Uge = uge.a(localVideoInfo.jdField_a_of_type_ComTencentBizPubaccountVideoInfo$SoftAdDownloadBarInfo.jdField_e_of_type_JavaLangString);
              ...
              catch (JSONException localJSONException2)
              {
                ...
                oiz.a(paramArticleSummary, localVideoInfo);
  ...
  public void a(omw paramomw, long paramLong1, VideoInfo paramVideoInfo, int paramInt1, ArrayList<VideoInfo> paramArrayList1, String paramString1, long paramLong2, boolean paramBoolean, int paramInt2, String paramString2, String paramString3, WeishiRedDotInfo paramWeishiRedDotInfo, int paramInt3, String paramString4, byte[] paramArrayOfByte, int paramInt4, ArrayList<VideoInfo> paramArrayList2, int paramInt5)
  {
    a(paramomw, paramLong1, paramVideoInfo, paramInt1, paramArrayList1, paramString1, paramLong2, paramBoolean, paramInt2, paramString2, paramString3, paramWeishiRedDotInfo, paramInt3, paramString4, paramArrayOfByte, paramInt4, paramArrayList2, null, paramInt5);
  }
  ...
  public void a(omw paramomw, long paramLong1, VideoInfo paramVideoInfo, int paramInt1, ArrayList<VideoInfo> paramArrayList1, String paramString1, long paramLong2, boolean paramBoolean, int paramInt2, String paramString2, String paramString3, WeishiRedDotInfo paramWeishiRedDotInfo, int paramInt3, String paramString4, byte[] paramArrayOfByte, int paramInt4, ArrayList<VideoInfo> paramArrayList2, Bundle paramBundle, int paramInt5)
  {
    ...
    ThreadManager.post(new VideoPlayRecommendHandler.1(this, paramomw, paramLong1, paramVideoInfo, paramInt1, paramArrayList1, paramString1, paramLong2, paramBoolean, paramInt2, paramString2, paramString3, paramWeishiRedDotInfo, paramInt3, paramString4, paramArrayOfByte, paramInt4, paramArrayList2, paramBundle, paramInt5), 5, null, true);
  }
  ...
  public void a(omw paramomw, long paramLong1, VideoInfo paramVideoInfo, int paramInt1, ArrayList<VideoInfo> paramArrayList1, String paramString1, long paramLong2, boolean paramBoolean, int paramInt2, String paramString2, String paramString3, WeishiRedDotInfo paramWeishiRedDotInfo, int paramInt3, String paramString4, byte[] paramArrayOfByte, ArrayList<VideoInfo.AdTagInfo> paramArrayList, int paramInt4, int paramInt5, int paramInt6, ArrayList<VideoInfo> paramArrayList2, int paramInt7)
  {
    ...
    ThreadManager.post(new VideoPlayRecommendHandler.2(this, paramArrayList, paramomw, paramLong1, paramVideoInfo, paramInt1, paramArrayList1, paramString1, paramLong2, paramBoolean, paramInt2, paramString2, paramString3, paramWeishiRedDotInfo, paramInt3, paramString4, paramArrayOfByte, paramInt4, paramInt5, paramInt6, paramArrayList2, paramInt7), 5, null, true);
  }
  
  public void a(omw paramomw, long paramLong, String paramString, int paramInt, VideoInfo paramVideoInfo)
  {
    ThreadManager.post(new VideoPlayRecommendHandler.3(this, paramLong, paramInt, paramString, paramomw, paramVideoInfo), 5, null, true);
  }
  
  public void a(omw paramomw, String paramString, int paramInt, boolean paramBoolean)
  {
    oidb_0x6cf.ReqBody localReqBody = new oidb_0x6cf.ReqBody();
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      paramString = qxp.a("OidbSvc.0x6cf", 1743, 1, localReqBody.toByteArray());
      paramString.addAttribute("is_from_first_recommend_video", Boolean.valueOf(true));
      paramString.addAttribute("VALUE_OBSERVER_TAG", Integer.valueOf(paramomw.hashCode()));
