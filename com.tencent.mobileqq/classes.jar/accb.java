  ...
  implements CompoundButton.OnCheckedChangeListener
{
  ...
  public accb(Context paramContext, baxk parambaxk, QQAppInterface paramQQAppInterface)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (acca)paramView.getTag();
    }
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      localObject = (acca)paramCompoundButton.getTag();
      if (i == 0)
      {
        ...
        for (paramBoolean = true;; paramBoolean = false)
        {
          ...
          paramCompoundButton.setOnCheckedChangeListener(((acca)localObject).jdField_a_of_type_AndroidWidgetCompoundButton$OnCheckedChangeListener);
          return;
          i = 2;
          break;
        }
      }
      ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(1)).a(Long.valueOf(((acca)localObject).jdField_a_of_type_JavaLangString).longValue(), paramBoolean);
      return;
    }
  }
}
