  ...
  implements AdIPCManager.Handler
{
  public AdIPCManager.Result handle(AdIPCManager.Params paramParams)
  {
    ...
    for (String str1 = paramParams.getAction();; str1 = null)
    {
      ...
      acho.b("GdtInterstitialAd", String.format("IPCHandlerForClose.handle action:%s to:%s success:%b", new Object[] { str1, str2, Boolean.valueOf(localResult.success) }));
      return localResult;
      ...
      WeakReference localWeakReference = accc.a().a(str1);
      if ((localWeakReference == null) || (localWeakReference.get() == null)) {
        break;
      }
      accd.c(BaseApplicationImpl.getContext(), ((GdtInterstitialFragment)localWeakReference.get()).a(), ((GdtInterstitialFragment)localWeakReference.get()).a());
