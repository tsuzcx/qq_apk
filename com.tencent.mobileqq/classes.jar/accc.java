...
public class accc
  extends ajto
{
  public accc(ShowReactiveActivity paramShowReactiveActivity) {}
  ...
  protected void onGetCalReactiveDays(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (paramBoolean1 = true;; paramBoolean1 = false)
    {
      ...
      {
        localObject = ((ajxl)this.a.app.getManager(51)).c(this.a.app.getCurrentAccountUin());
  ...
  protected void onSetCalReactiveDays(boolean paramBoolean)
  {
    ...
    {
      localObject1 = ((ajxl)this.a.app.getManager(51)).c(this.a.app.getCurrentAccountUin());
      localObject2 = this.a;
      localSwitch = this.a.a.a();
