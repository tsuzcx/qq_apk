...
public class bcbv
{
  ...
  public TextView a;
  bbkq<Integer> jdField_a_of_type_Bbkq = new bcbw(this);
  public bcfj a;
  public bcfm a;
  public bcgj a;
  TouchWebView.OnScrollChangedListener jdField_a_of_type_ComTencentBizUiTouchWebView$OnScrollChangedListener = new bcbx(this);
  ...
  void a(int paramInt, boolean paramBoolean)
  {
    ...
    {
      localObject2 = null;
      if ((paramInt < this.jdField_c_of_type_Int) || (!this.jdField_a_of_type_Bcfm.t)) {
        break label94;
      }
      this.jdField_a_of_type_Bcfm.t = false;
      if (!paramBoolean) {
        break label80;
      }
    ...
    for (;;)
    {
      ...
      {
        localObject1 = localObject2;
        if (!this.jdField_a_of_type_Bcfm.t)
        {
          this.jdField_a_of_type_Bcfm.t = true;
          if (paramBoolean)
          {
        ...
        try
        {
          ...
          if (i >= 40300)
          {
            ...
            if (i <= 40313)
            {
              ...
              {
                str1 = str2;
                if (str2.contains(ajyc.a(2131714695))) {
  ...
  {
    LayoutInflater.from(this.jdField_a_of_type_Bcfj.d.getContext()).inflate(2131558656, this.jdField_a_of_type_Bcfj.d);
    this.jdField_b_of_type_AndroidContentIntent = paramIntent;
    this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_Bcfj.d.findViewById(2131375327));
    a(this.jdField_a_of_type_AndroidViewViewGroup);
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131375469);
    this.jdField_c_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidViewView.setPadding(0, -bbkx.b(12.0F), 0, 0);
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131375450));
    ...
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_Bcfj.d.findViewById(2131377521);
    ...
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new bcby(this));
  ...
  public void a(Intent paramIntent, String paramString)
  {
    ...
    int j = 0;
    if ((paramIntent == null) || (TextUtils.isEmpty(paramString)) || (this.jdField_a_of_type_Bcfm.jdField_a_of_type_Boolean)) {
      return;
    }
    Object localObject;
    if ((this.jdField_a_of_type_Bcfm.jdField_a_of_type_Long & 0x4) == 0L)
    {
      if (!bcgc.a()) {
    ...
    else
    {
      ...
      this.jdField_a_of_type_Bcfm.j = paramIntent.getBooleanExtra("ishiderefresh", false);
      this.jdField_a_of_type_Bcfm.k = paramIntent.getBooleanExtra("ishidebackforward", false);
      boolean bool = paramIntent.getBooleanExtra("hide_left_button", false);
      this.jdField_a_of_type_Bcfm.l = paramIntent.getBooleanExtra("show_right_close_button", false);
      if (QLog.isColorLevel()) {
        QLog.d("QQBrowser", 2, "QQBrowser url=" + nax.b(paramString, new String[0]));
      }
      ...
      if (!this.jdField_a_of_type_Bcfm.jdField_e_of_type_Boolean)
      {
        ...
        paramString = bbdr.a((Drawable)localObject, -1);
        label306:
    ...
    label844:
    label857:
    for (int i = ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_Bcfj.jdField_a_of_type_AndroidAppActivity) + 0;; i = 0)
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_Bcfm.p)
        {
          ...
          label506:
          if (this.jdField_a_of_type_Bcfm.l) {
            a(paramIntent.getStringExtra("left_close_button_text"));
          }
          if (TextUtils.isEmpty(this.jdField_a_of_type_Bcfm.jdField_a_of_type_JavaLangString)) {
            break label844;
          }
        }
        try
        {
          paramIntent = new JSONObject(URLDecoder.decode(this.jdField_a_of_type_Bcfm.jdField_a_of_type_JavaLangString));
          i = k;
          ...
          for (paramIntent = paramIntent.getJSONArray("subTextArray");; paramIntent = null)
          {
            ...
            paramString = bbdr.a((Drawable)localObject, this.jdField_a_of_type_Bcfm.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle.jdField_d_of_type_Int);
            break label306;
            label732:
            if (this.jdField_a_of_type_Bcfm.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle == null) {
              break label372;
            }
            c(this.jdField_a_of_type_Bcfm.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle.jdField_d_of_type_Int);
            break label372;
            m = this.jdField_a_of_type_AndroidViewViewGroup.getTop();
            n = this.jdField_a_of_type_AndroidViewViewGroup.getBottom();
          ...
          a(new bccc(this.jdField_a_of_type_Bcfm.jdField_a_of_type_Int, i, null, null, paramString));
        }
  ...
  public void a(View paramView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    bbkk localbbkk = new bbkk(Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), new bcbz(this, paramView, paramInt2));
    localbbkk.setDuration(paramInt3);
    this.jdField_a_of_type_Bcfm.v = true;
    paramView.startAnimation(localbbkk);
  }
  ...
  public void a(bccc parambccc)
  {
    ...
    if (parambccc != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView.setButtonNum(parambccc.jdField_b_of_type_Int, parambccc.jdField_a_of_type_Int);
      this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView.setButtonText(parambccc.jdField_a_of_type_ArrayOfJavaLangString);
      this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView.setButtonBackgroundResource(2130849661, 2130849662, 2130849663);
      ...
      a(this.jdField_a_of_type_Bcfm.t);
    }
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView.setOnCheckedChangeListener(new bccb(this));
      if (this.jdField_a_of_type_Bcgj != null) {
        this.jdField_a_of_type_Bcgj.a(parambccc.jdField_b_of_type_JavaLangString, true);
      }
      localTouchWebView = this.jdField_a_of_type_Bcfj.a();
      if ((localTouchWebView != null) && (!TextUtils.isEmpty(parambccc.jdField_a_of_type_JavaLangString)))
      {
        str = "ok";
        if (!TextUtils.isEmpty(parambccc.jdField_b_of_type_JavaLangString)) {
          break label263;
        }
    ...
    catch (Exception localException1)
    {
      for (;;)
      {
        try
        {
          ...
          localTouchWebView.callJs(parambccc.jdField_a_of_type_JavaLangString, new String[] { localJSONObject.toString() });
          return;
  ...
  public void a(bccd parambccd)
  {
    Object localObject1;
    Object localObject2;
    boolean bool;
    if ((parambccd != null) && (this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView != null))
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView;
      localObject2 = parambccd.jdField_a_of_type_ArrayOfInt;
      if (parambccd.jdField_a_of_type_Int != 1) {
        break label56;
      }
      bool = true;
      ((WebViewTopTabView)localObject1).setRedHotStatus((int[])localObject2, bool);
      localObject2 = this.jdField_a_of_type_Bcfj.a();
      if (localObject2 != null) {
        break label61;
      }
    }
    for (;;)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          if (TextUtils.isEmpty(parambccd.jdField_a_of_type_JavaLangString)) {
            break;
          }
          ((TouchWebView)localObject2).callJs(parambccd.jdField_a_of_type_JavaLangString, new String[] { ((JSONObject)localObject3).toString() });
          return;
          try
          {
  ...
  public void a(TouchWebView paramTouchWebView)
  {
    ...
    if ((this.jdField_a_of_type_Bcfm.q) && (localViewGroup != null) && (!this.jdField_a_of_type_Bcfm.u) && (a()))
    {
      this.jdField_a_of_type_Bcfm.u = true;
      this.jdField_a_of_type_Bcfm.r = true;
      this.jdField_a_of_type_Bcfm.t = true;
      localViewGroup.setBackgroundResource(2130849678);
      if (ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().getRuntime(), false, null)) {
        this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(null);
      }
      paramTouchWebView.setOnScrollChangedListenerForBiz(new bcca(this));
    }
  }
  ...
  public void a(TouchWebView paramTouchWebView, boolean paramBoolean1, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean2, String paramString1, String paramString2, String paramString3)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationAnimation = new bbkk(Integer.valueOf(paramInt2), Integer.valueOf(paramInt3), this.jdField_a_of_type_Bbkq);
      ...
      this.jdField_b_of_type_AndroidViewAnimationAnimation = new bbkk(Integer.valueOf(paramInt3), Integer.valueOf(paramInt2), this.jdField_a_of_type_Bbkq);
  ...
  {
    if ((this.jdField_a_of_type_AndroidViewViewGroup == null) || (this.jdField_a_of_type_Bcfm.jdField_a_of_type_Boolean)) {}
    do
    {
      return;
  ...
  public void a(String paramString1, String paramString2, String paramString3, boolean paramBoolean, int paramInt1, int paramInt2, JsBridgeListener paramJsBridgeListener, View.OnClickListener paramOnClickListener, aabm paramaabm)
  {
      ...
      if (paramInt1 == 0)
      {
        ...
        try
        {
          ...
          if ((paramString1 != null) && (i == 0))
          {
            ...
            if (this.jdField_a_of_type_Bcfm.jdField_a_of_type_OrgJsonJSONObject.has("txtclr"))
            {
              paramString2 = this.jdField_a_of_type_Bcfm.jdField_a_of_type_OrgJsonJSONObject.optString("txtclr", "");
              if (!TextUtils.isEmpty(paramString2))
              {
          ...
          try
          {
            ...
            paramString1 = bbdr.a(this.jdField_a_of_type_AndroidWidgetImageView.getDrawable(), paramInt1);
    ...
    this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
    if ((this.jdField_a_of_type_Bcfj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment == null) || (!(this.jdField_a_of_type_Bcfj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment instanceof TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment)))
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      i();
    }
      ...
      default: 
        ...
        if (paramInt1 != 0)
        {
          if (this.jdField_b_of_type_AndroidWidgetImageView == null)
          {
            ...
            paramString3 = (RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131375449);
    ...
    for (;;)
    {
      ...
      paramBoolean = false;
      break label457;
      this.jdField_a_of_type_Bcfj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130843255, 2130843254);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(bbdr.a(this.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130843255), this.jdField_a_of_type_AndroidWidgetImageView.getResources().getColor(2131166851)));
      ...
      break label589;
      this.jdField_a_of_type_Bcfj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130843253, 2130843253);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131692737));
      break label589;
      this.jdField_a_of_type_Bcfj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130839757, 2130839757);
      ...
      break label589;
      this.jdField_a_of_type_Bcfj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130839111, 2130839111);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131692741));
      break label589;
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130843299);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131692743));
      ((AnimationDrawable)this.jdField_a_of_type_AndroidWidgetImageView.getDrawable()).start();
      break label589;
      this.jdField_a_of_type_Bcfj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130842002, 2130842005);
      ...
      break label589;
      this.jdField_a_of_type_Bcfj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130849062, 2130849066);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131689628));
      break label589;
      this.jdField_a_of_type_Bcfj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130838579, 2130838579);
      ...
      break label589;
      this.jdField_a_of_type_Bcfj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130849201, 2130849201);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131692740));
      break label589;
      ...
      localLayoutParams.rightMargin = bbkx.b(10.0F);
      paramString3.setLayoutParams(localLayoutParams);
      break label589;
      this.jdField_a_of_type_Bcfj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130839757, 2130839757);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(BaseApplicationImpl.getApplication().getResources().getString(2131719373));
      break label589;
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130843076);
      break label777;
      this.jdField_b_of_type_AndroidWidgetImageView.setImageResource(2130849288);
      break label777;
      if (this.jdField_b_of_type_AndroidWidgetImageView == null) {
        break label777;
      }
  ...
  public void a(JSONObject paramJSONObject, boolean paramBoolean)
  {
    ...
    try
    {
      if ((paramJSONObject.length() > 0) && (!this.jdField_a_of_type_Bcfm.u))
      {
        this.jdField_a_of_type_Bcfm.u = a();
        if ((this.jdField_a_of_type_Bcfm.A) && (this.jdField_a_of_type_Bcfj.jdField_b_of_type_AndroidViewView != null)) {
          this.jdField_a_of_type_Bcfj.jdField_b_of_type_AndroidViewView.setPadding(0, (int)bbdh.a(BaseApplicationImpl.getApplication(), 30.0F), 0, 0);
        }
      }
      if (paramJSONObject == null) {
        return;
      }
      if (!this.jdField_a_of_type_Bcfm.u) {
        return;
      }
      if (QLog.isColorLevel()) {
    ...
    catch (Exception paramJSONObject)
    {
      ...
      while (QLog.isColorLevel())
      {
        ...
        this.jdField_a_of_type_Bcfm.jdField_d_of_type_Int = j;
        return;
        continue;
        i = -1;
        continue;
    ...
    if ((this.jdField_a_of_type_Bcfj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_Bcfj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d != null))
    {
      ...
      {
        this.jdField_a_of_type_Bcfj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d.setBackgroundColor(i);
        axmt.a(true, i, this.jdField_a_of_type_Bcfj.jdField_a_of_type_AndroidAppActivity.getWindow());
      }
    }
    else
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject2))
      {
        ...
        {
          localObject1 = bbdr.a(this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.getDrawable(), i);
        ...
        localObject1 = bbdr.a(this.jdField_a_of_type_AndroidWidgetTextView.getBackground(), i);
        if (localObject1 != null) {
          this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable((Drawable)localObject1);
        }
        localObject1 = bbdr.a(this.jdField_a_of_type_AndroidWidgetImageView.getDrawable(), i);
        if (localObject1 != null)
        {
          this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject1);
          c(i);
        }
        localObject1 = this.jdField_c_of_type_AndroidViewView.findViewById(2131370259);
        localObject2 = bbdr.a(((View)localObject1).getBackground(), i);
        if (localObject2 != null) {
        ...
        {
          if ((TextUtils.isEmpty(this.jdField_b_of_type_AndroidWidgetTextView.getText())) && (!TextUtils.isEmpty(this.jdField_a_of_type_Bcfj.jdField_a_of_type_JavaLangString))) {
            this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Bcfj.jdField_a_of_type_JavaLangString);
          }
          ...
          if ((paramBoolean) && (i > 0))
          {
            a(localViewGroup, this.jdField_a_of_type_Bcfm.jdField_d_of_type_Int, j, i);
            return;
          }
        }
      }
  ...
  {
    this.jdField_a_of_type_Bcfm.t = paramBoolean;
  ...
  public boolean a()
  {
    if ((!this.jdField_a_of_type_Bcfj.jdField_a_of_type_Bcfm.jdField_b_of_type_Boolean) && (!this.jdField_a_of_type_Bcfm.m) && (this.jdField_a_of_type_AndroidViewViewGroup != null) && (this.jdField_a_of_type_Bcfj.d != null) && (Build.VERSION.SDK_INT >= 17))
    {
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Bcfm.C)
    {
      if ((!this.jdField_a_of_type_Bcfm.jdField_b_of_type_Boolean) && (!this.jdField_a_of_type_Bcfm.m))
      {
        Resources localResources = this.jdField_a_of_type_Bcfj.jdField_a_of_type_AndroidAppActivity.getResources();
        this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundColor(localResources.getColor(2131167063));
        if ((this.jdField_a_of_type_Bcfj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_Bcfj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d != null)) {
          this.jdField_a_of_type_Bcfj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d.setBackgroundColor(0);
        }
      }
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(-1);
      this.jdField_c_of_type_AndroidWidgetTextView.setTextColor(-1);
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-1);
      this.jdField_a_of_type_Bcfj.a(this.jdField_a_of_type_AndroidWidgetTextView, true, 2130849040, 2130849538);
      this.jdField_a_of_type_Bcfj.a(this.jdField_a_of_type_AndroidWidgetImageView, false, 2130839757, 2130839753);
    }
  }
  ...
  public void b(int paramInt)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Bcfj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (this.jdField_a_of_type_Bcfj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d != null)) {
        this.jdField_a_of_type_Bcfj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.d.getBackground().mutate().setAlpha(paramInt);
      }
  ...
  public void b(String paramString)
  {
    ...
    paramString = this.jdField_a_of_type_Bcfj.a();
  ...
  public boolean b()
  {
    if ((this.jdField_a_of_type_Bcfj.a() == null) || (this.jdField_a_of_type_Bcfj.a().getPluginEngine() == null)) {}
    WebViewPlugin localWebViewPlugin;
    do
    {
      return false;
      localWebViewPlugin = this.jdField_a_of_type_Bcfj.a().getPluginEngine().a(45, false);
    } while (((localWebViewPlugin instanceof UiApiPlugin)) && (((UiApiPlugin)localWebViewPlugin).g));
    if ((this.jdField_a_of_type_Bcfm.D) || (this.jdField_a_of_type_Bcfm.E)) {}
  ...
  public boolean b(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (!this.jdField_a_of_type_Bcfj.jdField_a_of_type_Bcfm.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_Bcfj.jdField_a_of_type_AndroidAppActivity.getWindow().clearFlags(1024);
      }
    }
    for (;;)
    {
      ...
      b(0);
      this.jdField_a_of_type_AndroidViewViewGroup.setVisibility(8);
      this.jdField_a_of_type_Bcfj.jdField_a_of_type_AndroidAppActivity.getWindow().addFlags(1024);
    }
  }
  ...
  public void c(int paramInt)
  {
    if (b())
    {
      View localView = this.jdField_c_of_type_AndroidViewView.findViewById(2131370259);
      localView.setBackgroundDrawable(bbdr.a(localView.getBackground(), paramInt));
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Bcfj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null)
    {
      if ((paramBoolean) && (b()))
      {
        this.jdField_a_of_type_Bcfj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.n = 100;
        this.jdField_a_of_type_Bcfj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.q();
        this.jdField_a_of_type_Bcfj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.e(true);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_Bcfj.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.e(false);
  }
  ...
  public void f()
  {
    ...
    if (c())
    {
      localObject = this.jdField_c_of_type_AndroidViewView.findViewById(2131370259);
  ...
  public void f(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentWidgetFadeIconImageView != null) && (this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.getVisibility() == 0))
    {
      localDrawable1 = bbdr.a(this.jdField_a_of_type_ComTencentWidgetFadeIconImageView.getDrawable(), paramInt);
    ...
    if (localDrawable2 != null)
    {
      ...
      localDrawable2 = bbdr.a(localDrawable2, paramInt);
      if (localDrawable2 != null) {
    ...
    if (localDrawable1 != null)
    {
      ...
      localDrawable1 = bbdr.a(localDrawable1, paramInt);
      if (localDrawable1 != null)
      {
  ...
  public void g()
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Bcfm.t) && (this.jdField_a_of_type_Bcfm.s))
      {
        this.jdField_a_of_type_Bcfm.s = false;
        this.jdField_a_of_type_Bcfm.s = true;
        this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130849678);
        this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(-1);
        return;
      }
    } while ((this.jdField_a_of_type_Bcfm.t) || (!this.jdField_a_of_type_Bcfm.s));
    this.jdField_a_of_type_Bcfm.s = false;
    this.jdField_a_of_type_Bcfm.s = true;
  ...
  {
    this.jdField_a_of_type_Bcfm.jdField_a_of_type_Int = paramInt;
    if (this.jdField_a_of_type_ComTencentMobileqqWebviewUiWebViewTopTabView != null) {
