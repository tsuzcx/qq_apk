...
public class bcbv
{
  ...
  public static HashMap<Integer, HashMap<Integer, blvg>> a;
  ...
  public static List<Integer> a(Map<Integer, blvg> paramMap)
  {
  ...
  public static Map<Integer, String> a(long paramLong)
  {
    ...
    Map localMap = bcbx.a(LocalMultiProcConfig.getString("EXTEND_INFO" + paramLong, ""));
    if (a(paramLong)) {
  ...
  public static void a(mobile_count_rsp_new parammobile_count_rsp_new)
  {
    if ((parammobile_count_rsp_new != null) && (parammobile_count_rsp_new.vec_soft_infos != null) && (parammobile_count_rsp_new.vec_soft_infos.size() != 0))
    {
      ...
      LocalMultiProcConfig.putString("qzone_soft_infos", bgku.encodeToString(localJceOutputStream.toByteArray(), 0));
    }
  }
  ...
  private static void a(mobile_count_rsp_new parammobile_count_rsp_new, bccx parambccx)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while (parambccx == null);
        if (parammobile_count_rsp_new.iNextTimeout > 0)
        {
          parambccx.jdField_a_of_type_Long = (parammobile_count_rsp_new.iNextTimeout * 1000L);
          if (QLog.isColorLevel()) {
            QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "onReceive getFeedInterval:" + parambccx.jdField_a_of_type_Long);
          }
        }
      } while (parammobile_count_rsp_new.switchTimeout <= 0);
      parambccx.jdField_b_of_type_Long = (parammobile_count_rsp_new.switchTimeout * 1000);
    } while (!QLog.isColorLevel());
    QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "onReceive getActiveAppInterval:" + parambccx.jdField_b_of_type_Long);
  }
  ...
  public static void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg, QQAppInterface paramQQAppInterface, bccx parambccx)
  {
    ...
    do
    {
      ...
      {
        return;
        paramFromServiceMsg = bcbs.a(paramIntent, paramQQAppInterface, "getUndealCount");
    ...
    awnb localawnb = (awnb)paramQQAppInterface.getManager(10);
    if (localawnb != null) {
      localawnb.b(0);
    }
  ...
  private static void a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      long l = System.currentTimeMillis();
      HashMap localHashMap = new HashMap();
      bctj.a(paramQQAppInterface.getApp()).a(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", true, l - bccx.c, 0L, localHashMap, "");
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, Long paramLong)
  {
    ...
    do
    {
      ...
      } while ((paramQQAppInterface == null) || (!(paramQQAppInterface instanceof bccv)));
    ...
    {
      blvg localblvg = (blvg)localHashMap.get(Integer.valueOf(1));
      localblvg.jdField_a_of_type_Long = paramLong.longValue();
      localHashMap.put(Integer.valueOf(1), localblvg);
    }
    ((bccv)paramQQAppInterface).a(localHashMap);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, Intent paramIntent, FromServiceMsg paramFromServiceMsg, bccx parambccx)
  {
    if (QLog.isColorLevel()) {
      QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "inform QZONE_GET_UNREAD isSuccess false");
    }
    if (parambccx != null) {
      parambccx.notifyObserver(null, 1000, false, new Bundle(), ayev.class);
    }
    if (paramQQAppInterface != null)
    {
      ...
      bctj.a(paramQQAppInterface.getApp()).a(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", false, bccx.d - bccx.c, 0L, paramFromServiceMsg, "");
    }
  }
  
  private static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, bccx parambccx)
  {
    if (QLog.isColorLevel()) {
      QLog.d("UndealCount.QZoneUnreadServletLogic", 2, "inform QZONE_GET_UNREAD isSuccess false");
    }
    ...
    if (paramQQAppInterface != null)
    {
      paramArrayOfByte = "|wufbuf: " + bgmj.a(paramArrayOfByte);
      parambccx = new HashMap();
      parambccx.put("param_FailCode", String.valueOf(9045));
      parambccx.put("param_errorDesc", paramArrayOfByte);
      bctj.a(paramQQAppInterface.getApp()).a(paramQQAppInterface.getCurrentAccountUin(), "actQzoneUnread", false, bccx.d - bccx.c, 0L, parambccx, "");
    }
  }
  
  public static void a(String paramString) {}
  
  private static void a(String paramString, bccx parambccx)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (parambccx == null) {
      return;
    ...
    parambccx.notifyObserver(null, 1003, true, localBundle, ayev.class);
  }
  ...
  public static void a(String paramString, ArrayList<String> paramArrayList)
  {
    ...
    {
      paramArrayList = bgsp.a(paramArrayList, ",");
    ...
    if (paramArrayList != null)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        if (localoperat_data != null)
        {
          ...
          localbmji.jdField_a_of_type_Int = localoperat_data.cmd;
          if ((localoperat_data.mapExt != null) && (localoperat_data.mapExt.size() > 0)) {
            localbmji.jdField_a_of_type_JavaUtilMap.putAll(localoperat_data.mapExt);
          }
          localbmji.jdField_a_of_type_JavaUtilMap.put("key_desc", localoperat_data.desc);
  ...
  private static void a(byte[] paramArrayOfByte, mobile_count_rsp_new parammobile_count_rsp_new, QQAppInterface paramQQAppInterface, bccx parambccx)
  {
    HashMap localHashMap = new HashMap();
    boolean bool = a(parammobile_count_rsp_new, localHashMap, paramQQAppInterface);
    int i = 0;
    if (bool) {
      i = bmfd.a().a().a(paramQQAppInterface.getLongAccountUin());
    }
    ...
    if ((paramArrayOfByte != null) && ((paramArrayOfByte instanceof bccv)))
    {
      ((bccv)paramArrayOfByte).a(localHashMap);
      if (QLog.isColorLevel()) {
    ...
    label129:
    a(paramQQAppInterface, paramArrayOfByte, parambccx);
  }
  ...
  public static boolean a(int paramInt, String paramString)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      if (localbcbw.a())
      {
        ...
        if (localbcbw.jdField_a_of_type_Int <= 0) {
          break label53;
        }
        bool1 = bool2;
      }
  ...
  private static boolean a(long paramLong)
  {
    ...
    try
    {
      localObject = (stNuanNuanComment)b(stNuanNuanComment.class, bgku.decode((String)localObject, 0));
  ...
  public static boolean a(mobile_count_rsp_new parammobile_count_rsp_new, HashMap<Integer, blvg> paramHashMap, QQAppInterface paramQQAppInterface)
  {
    if (QLog.isDevelopLevel()) {
    ...
    if (localcount_info != null)
    {
      ...
      {
        localblvg.jdField_a_of_type_Long = localcount_info.stCount.uCount;
        localblvg.jdField_a_of_type_Int = localcount_info.stCount.iControl;
        if (QLog.isDevelopLevel())
        {
        ...
        if ((i == 1) && (localblvg.jdField_a_of_type_Long > 0L) && (paramQQAppInterface != null) && (parammobile_count_rsp_new.isPreLoad == 1) && (!TextUtils.isEmpty(parammobile_count_rsp_new.undealCountTime)) && (!LocalMultiProcConfig.getString4Uin("qzone_passive_undealtime", "", paramQQAppInterface.getLongAccountUin()).equals(parammobile_count_rsp_new.undealCountTime)))
        {
          bool1 = true;
          label423:
          ...
          if (parammobile_count_rsp_new.mapTransData != null)
          {
            ...
            if (arrayOfByte != null) {
              localObject = (PassiveFeedsPush)bmip.a(PassiveFeedsPush.class, arrayOfByte);
            }
          }
          if ((localcount_info.vecUinList != null) && (localcount_info.vecUinList.size() > 0))
          {
            ...
            while (j < localcount_info.vecUinList.size())
            {
              ...
              localblvg.jdField_a_of_type_JavaUtilArrayList.add(localQZoneCountUserInfo);
              j += 1;
            }
            localblvg.jdField_a_of_type_JavaLangString = ((feed_host_info)localcount_info.vecUinList.get(0)).actiondesc;
            if (QLog.isDevelopLevel()) {
          ...
          localblvg.jdField_b_of_type_JavaLangString = localcount_info.trace_info;
          localblvg.c = localcount_info.iSubCountID;
          localblvg.f = localcount_info.strShowMsg;
          localblvg.g = localcount_info.strReportValue;
          localblvg.e = localcount_info.strIconUrl;
          localblvg.jdField_b_of_type_Long = localcount_info.cTime;
          paramHashMap.put(Integer.valueOf(i), localblvg);
        }
      }
    }
    for (;;)
  ...
  public static byte[] a(long paramLong, String paramString1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, Map<Integer, count_info> paramMap, String paramString2, Map<Long, Long> paramMap1)
  {
    ...
    return bcbs.a(paramString1, "getUndealCount", paramLong, paramInt1, paramInt2, paramInt4);
  }
  ...
  public static void b(int paramInt, QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      if (str != null)
      {
        ...
        bmiz.a();
        paramQQAppInterface = (awnb)paramQQAppInterface.getManager(10);
        if ((paramInt & 0x80) == 0) {
          break label84;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((parammobile_count_rsp_new.snnComment != null) && (parammobile_count_rsp_new.snnComment.iStatus != 0) && (paramLong != -1L))
        {
          ...
          LocalMultiProcConfig.putString4Uin("qzone_dual_warm_comment_info", bgku.encodeToString(localJceOutputStream.toByteArray(), 0), paramLong);
        ...
        if ((parammobile_count_rsp_new.sContentOpComment != null) && (parammobile_count_rsp_new.sContentOpComment.iStatus != 0) && (paramLong != -1L))
        {
          ...
          LocalMultiProcConfig.putString4Uin("qzone_dual_warm_operation_comment_info", bgku.encodeToString(((JceOutputStream)localObject).toByteArray(), 0), paramLong);
          return;
        }
      }
  ...
  private static void d(mobile_count_rsp_new parammobile_count_rsp_new, QQAppInterface paramQQAppInterface)
  {
    ...
    bltn.a().a(parammobile_count_rsp_new.stYellowInfo.iYellowType, parammobile_count_rsp_new.stYellowInfo.iYellowLevel, parammobile_count_rsp_new.stYellowInfo.isAnnualVip, parammobile_count_rsp_new.stuStarInfo, parammobile_count_rsp_new.stuCombineDiamondInfo);
  }
  ...
  private static void i(mobile_count_rsp_new parammobile_count_rsp_new, QQAppInterface paramQQAppInterface)
  {
    ...
    if ((parammobile_count_rsp_new != null) && (parammobile_count_rsp_new.length > 0))
    {
      ...
      bmip.a((JceStruct)localObject, parammobile_count_rsp_new);
