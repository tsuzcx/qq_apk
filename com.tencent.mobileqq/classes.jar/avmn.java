...
public class avmn
  extends QIPCModule
{
  private static volatile avmn jdField_a_of_type_Avmn;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
  
  public avmn(String paramString)
  {
    super(paramString);
  ...
  public static avmn a()
  {
    if (jdField_a_of_type_Avmn == null) {}
    try
    {
      if (jdField_a_of_type_Avmn == null) {
        jdField_a_of_type_Avmn = new avmn("WatchTogetherClientIPCModule");
      }
      return jdField_a_of_type_Avmn;
    }
    finally {}
  }
  ...
  public void a(String paramString, WatchTogetherFloatingData paramWatchTogetherFloatingData)
  {
    if (a())
    {
      if ("ACTION_SHOW_WATCH_FLOATING_WINDOWS".equalsIgnoreCase(paramString)) {
        avmi.a().a(BaseApplicationImpl.getContext(), paramWatchTogetherFloatingData);
      }
      do
      {
        return;
