...
public class ucy
{
  ...
  public static void a()
  {
    ...
    Object localObject = sfq.a;
    localObject = new VInstanceManager.Builder().application(BaseApplicationImpl.getApplication()).param(new JSONObject()).preconditionAdapter(new ucx((String)localObject)).serviceJsUrl((String)localObject).isBlockingMode(false);
