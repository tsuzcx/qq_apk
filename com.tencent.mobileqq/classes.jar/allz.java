...
public class allz
{
  ...
  public static atmp a()
  {
    if (jdField_a_of_type_Atmp == null) {
      jdField_a_of_type_Atmp = new almg().createEntityManager();
    }
  ...
  public static String a()
  {
    ...
    {
      jdField_a_of_type_JavaLangString = Environment.getExternalStorageDirectory().getAbsolutePath() + "/tencent/MobileQQ/.Rock/";
  ...
  public static ArrayList<RockDownloadInfo> a(RockDownloaderTask paramRockDownloaderTask)
  {
    ...
    for (;;)
    {
      ...
      paramRockDownloaderTask = (atmo)((Iterator)localObject).next();
  ...
  public static void a(RockDownloaderTask paramRockDownloaderTask)
  {
    ...
    NewIntent localNewIntent = new NewIntent(paramRockDownloaderTask.getRuntime().getApplication(), almf.class);
    ...
    localNewIntent.setObserver(new alma(paramRockDownloaderTask));
  ...
  private static boolean a(Context paramContext, File paramFile)
  {
    try
    {
      RandomAccessFile localRandomAccessFile = new RandomAccessFile(paramFile.getAbsolutePath(), "rw");
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          if (a(paramContext, paramFile.getAbsolutePath()) == null) {
            break;
          }
          return true;
        }
  ...
  public static boolean a(RockDownloaderTask paramRockDownloaderTask)
  {
    ...
    {
      return false;
      localFile = new File(paramRockDownloaderTask.getDownloadInfo().localPath);
    } while ((!localFile.exists()) || (!a(paramRockDownloaderTask.getRuntime().getApplication(), localFile)));
  ...
  {
    boolean bool2 = false;
    paramDownloadInfo = new File(paramDownloadInfo.l);
    paramRockDownloaderTask = new File(paramRockDownloaderTask.getDownloadInfo().getLocalPath());
    boolean bool1 = bool2;
  ...
  private static boolean a(File paramFile)
  {
    try
    {
      paramFile = new RandomAccessFile(paramFile.getAbsolutePath(), "rw");
  ...
  private static void b(RockDownloaderTask paramRockDownloaderTask, DownloadInfo paramDownloadInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((bool1) && (bool2))
      {
        ...
        localObject = (DownloadInfo)bccu.a().a().remove(paramDownloadInfo.jdField_b_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
          QLog.d("RockDownloader", 2, new Object[] { "removedDownload=", localObject });
        }
        bccs.a().a(paramDownloadInfo.jdField_b_of_type_JavaLangString);
      ...
      {
        localObject = new File(paramDownloadInfo.l);
  ...
  private static void b(@NonNull RockDownloaderTask paramRockDownloaderTask, String paramString)
  {
    ...
    if (localObject != null)
    {
      localStringBuilder.append(((RockDownloadInfo)localObject).getBusinessName()).append("&").append(((RockDownloadInfo)localObject).getBusinessScene()).append("&").append(((RockDownloadInfo)localObject).getPackageName()).append("&").append(befc.a("0"));
      ...
      localHashMap.put("IMEI", befc.a("0"));
    ...
    try
    {
      ...
      {
        awqx.b((QQAppInterface)paramRockDownloaderTask.getRuntime(), "dc00898", "", ((QQAppInterface)paramRockDownloaderTask.getRuntime()).c(), paramString, paramString, 1, 1, "", "", localStringBuilder.toString(), "");
        awrn.a(((QQAppInterface)paramRockDownloaderTask.getRuntime()).getApp()).a(((QQAppInterface)paramRockDownloaderTask.getRuntime()).c(), "RockDownloader", true, 0L, 0L, localHashMap, "");
      }
      for (;;)
      {
        if (!QLog.isColorLevel()) {
        ...
        awqx.b(null, "dc00898", "", paramRockDownloaderTask.getRuntime().getAccount(), paramString, paramString, 1, 1, "", "", localStringBuilder.toString(), "");
        awrn.a(paramRockDownloaderTask.getRuntime().getApplication()).a(paramRockDownloaderTask.getRuntime().getAccount(), "RockDownloader", true, 0L, 0L, localHashMap, "");
      }
    }
    catch (Throwable paramRockDownloaderTask)
    {
      for (;;)
      {
        if (QLog.isColorLevel())
        {
          ...
          continue;
          awqx.b(null, "dc00898", "", "", paramString, paramString, 1, 1, "", "", localStringBuilder.toString(), "");
          awrn.a(BaseApplicationImpl.context).a("", "RockDownloader", true, 0L, 0L, localHashMap, "");
        }
      }
  ...
  private static void d(RockDownloaderTask paramRockDownloaderTask)
  {
    ...
    {
      localalmb = new almb(paramRockDownloaderTask, bool);
      Iterator localIterator = bccu.a().a().values().iterator();
      ...
      bccu.a().b(localDownloadInfo1);
      if (bool)
      {
        paramRockDownloaderTask.getRockDownloadListener().onDownloadFail(paramRockDownloaderTask.getDownloadInfo(), ajjy.a(2131647700), 10011);
        paramRockDownloaderTask.getRockDownloadListener().onDownloadFinish(paramRockDownloaderTask.getDownloadInfo());
      }
      return;
    }
  ...
  {
    Object localObject = new NewIntent(paramRockDownloaderTask.getRuntime().getApplication(), almf.class);
