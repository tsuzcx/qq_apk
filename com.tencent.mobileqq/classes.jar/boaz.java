...
public class boaz
{
  private static boaz jdField_a_of_type_Boaz;
  ...
  public static boaz a()
  {
    if (jdField_a_of_type_Boaz == null) {}
    try
    {
      if (jdField_a_of_type_Boaz == null) {
        jdField_a_of_type_Boaz = new boaz();
      }
      return jdField_a_of_type_Boaz;
    }
    finally {}
  }
        ...
        if (localObject != null)
        {
          ...
          if (k > 0)
          {
            ...
            while (i < k)
            {
              ...
              {
                yqu.jdField_a_of_type_JavaLangString = localJSONObject1.getString("downloadInfo");
                if (QLog.isColorLevel()) {
                  QLog.e(jdField_a_of_type_JavaLangString, 2, "QIMBeautyManager WeishiGuideUtils.DOWNLOAD_JSON=  " + yqu.jdField_a_of_type_JavaLangString);
                }
              }
              i += 1;
            }
