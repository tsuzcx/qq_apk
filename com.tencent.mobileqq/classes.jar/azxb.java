...
public class azxb
{
  static int[] a = { -1034, -2060, -2062, -2015, -2065, -2061, -5040, -5021, -2050, -2018, -2023, -2074, -7009, -7010, -7011, -7012 };
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, MessageForPoke paramMessageForPoke)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject = ((amsw)paramQQAppInterface.getManager(51)).b(paramString);
        if (localObject != null) {
          break;
        }
      ...
      Object localObject = String.format(Locale.getDefault(), amtj.a(2131704821), new Object[] { ((Friends)localObject).getFriendNickWithAlias() });
      paramMessageForPoke = new aucf(paramString, paramQQAppInterface.getCurrentUin(), (String)localObject, paramInt, -5040, 655379, l);
      ...
      bcef.b(paramQQAppInterface, "dc00898", "", "", "0X8009891", "0X8009891", 0, 0, "", "", "", "");
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while ((paramString.length() < 5) || (bblk.a(paramMessageRecord.msgtype)) || (abwz.j(paramMessageRecord.msgtype)) || (a(paramMessageRecord.msgtype)));
        paramQQAppInterface = (azwy)paramQQAppInterface.getManager(285);
        if (paramInt == 1)
        {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      localObject = (azwy)paramQQAppInterface.getManager(285);
      localFriends = localamsw.b(paramString);
    } while ((localFriends == null) || (!localFriends.isFriend()));
    if (ahns.a(paramQQAppInterface).b()) {
      if (((azwy)localObject).a(true))
      {
        if (!((azwy)localObject).c(paramString)) {
          break label227;
        }
        ((azwy)localObject).a(paramString);
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      localObject = localamsw.a(paramString, true);
      ...
      return;
      label227:
      ((azwy)localObject).a(paramString, true);
      break;
      if (QLog.isColorLevel()) {
  ...
  {
    if (((b(paramInt)) || (c(paramInt)) || (d(paramInt)) || (e(paramInt))) && (!bftf.b(paramString)) && (!bezm.b(paramQQAppInterface, paramString))) {}
  ...
  private static void b(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        azwy localazwy = (azwy)paramQQAppInterface.getManager(285);
        if (!localazwy.a(false))
        {
          if (QLog.isColorLevel()) {
        ...
        else
        {
          ...
          else if (localazwy.f(paramString))
          {
            if (QLog.isColorLevel()) {
          ...
          {
            float f = localazwy.a();
            Object localObject2 = localamsw.a(paramString, true);
            ...
            else
            {
              ...
              {
                localObject2 = paramQQAppInterface.getMessageFacade().queryLastMsgForMessageTabFromDB(paramString, 0, a());
                if (localObject2 == null) {}
                ...
                if ((!paramBoolean) && ((((ExtensionInfo)localObject1).lastIceBreakCheckTs == 0L) || (Math.abs(((ExtensionInfo)localObject1).lastIceBreakCheckTs - l1) > 86400000L)))
                {
                  ...
                  if (AppNetConnInfo.isNetSupport())
                  {
                    ...
                    j = 1;
                    ((FriendListHandler)paramQQAppInterface.getBusinessHandler(1)).reqLastChatTime(paramString, (int)Math.ceil(f));
                  }
                }
                for (;;)
                {
