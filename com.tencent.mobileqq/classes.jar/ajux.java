...
public class ajux
{
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1))
        {
          ...
          axrn.a(paramContext).a("", "actDeviceAbility", true, 0L, 0L, localHashMap, "");
          return;
          i = 0;
          break;
          label735:
  ...
  {
    int i2 = (int)(bbdx.b() / 1024.0F / 1024.0F);
    ...
    if (bbdx.a())
    {
      k = (int)(bbdx.b() / 1024.0F / 1024.0F);
      j = (int)(bbdx.a() / 1024.0F / 1024.0F);
      if (Build.VERSION.SDK_INT < 9) {
        break label377;
      }
      localObject = bbdx.a(paramContext);
      n = ((List)localObject).size();
      localObject = ((List)localObject).iterator();
      i = -1;
      while (((Iterator)localObject).hasNext())
      {
        if (!((bbdy)((Iterator)localObject).next()).a) {
          break label374;
        }
        i += 1;
      }
    ...
    for (k = n;; k = n)
    {
      ...
      axrn.a(paramContext).a("", "actStorageStats", true, 0L, 0L, (HashMap)localObject, "");
      return;
      label374:
      break;
      label377:
