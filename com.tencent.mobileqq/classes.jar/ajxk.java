...
import com.tencent.mobileqq.activity.home.Conversation.29.1;
import com.tencent.mobileqq.activity.home.Conversation.29.2;
import com.tencent.mobileqq.activity.home.Conversation.29.3;
import com.tencent.mobileqq.activity.home.Conversation.29.4;
import com.tencent.mobileqq.activity.home.Conversation.29.5;
...
public class ajxk
  extends anvi
{
  public ajxk(Conversation paramConversation) {}
  ...
  protected void onCancelMayKnowRecommend(boolean paramBoolean, String paramString)
  {
    ...
    if (paramBoolean)
    {
      anyb localanyb = (anyb)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MAYKNOW_RECOMMEND_MANAGER);
      ArrayList localArrayList = localanyb.c();
      if (localanyb.a(paramString)) {
  ...
  protected void onGetGenralSettings(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    Object localObject1 = (ProxyManager)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.PROXY_MANAGER);
    if (localObject1 == null)
    {
      localObject1 = null;
      awtz.a().i(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (localObject1 != null) {
        break label177;
      }
    }
    for (;;)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if ((localRecentUser.getType() == 1) && (this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getTroopMask(localRecentUser.uin) == 3))
        {
          if (localObject1 != null) {
            ((aoxz)localObject1).delRecentUser(localRecentUser);
          }
          alik.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, 1);
          this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().setReaded(localRecentUser.uin, localRecentUser.getType());
        }
      }
  ...
  {
    if ((paramBoolean) && (bhbx.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()))) {
      this.a.jdField_a_of_type_ComTencentMobileqqAppFrameHelperActivity.b("onGetOnlineInfoByUinOrMobile");
    }
  }
  ...
  protected void onGetStoreFace(boolean paramBoolean, HashSet<String> paramHashSet)
  {
    ...
    this.a.b(new Conversation.29.3(this, paramHashSet));
  }
  ...
  protected void onHideConversationMayKnowRecommend(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      paramObject = (anyb)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MAYKNOW_RECOMMEND_MANAGER);
      paramObject.e();
      this.a.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(1009);
    ...
    QQToast.a(BaseApplication.getContext(), anvx.a(2131702086), 0).a();
    paramBoolean = ((anyb)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MAYKNOW_RECOMMEND_MANAGER)).b("sp_mayknow_ml_s_a_vl");
    paramObject = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
    if (paramBoolean) {}
    for (;;)
    {
  ...
  protected void onMayknowStateChanged(boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (((anyb)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MAYKNOW_RECOMMEND_MANAGER)).b("sp_mayknow_ml_s_a_vl")))
    {
      this.a.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(1009);
      this.a.jdField_a_of_type_MqqOsMqqHandler.removeCallbacks(this.a.jdField_a_of_type_JavaLangRunnable);
      this.a.jdField_a_of_type_MqqOsMqqHandler.postDelayed(this.a.jdField_a_of_type_JavaLangRunnable, 1600L);
  ...
  protected void onSetGenralSettingsTroopFilter(boolean paramBoolean, Map<String, Integer> paramMap)
  {
    ...
    Object localObject = (ProxyManager)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.PROXY_MANAGER);
    label114:
    String str;
    if (localObject == null)
    {
      ...
      i = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getTroopMask(str);
      if (i != 2) {
        break label319;
      }
      awtz.a().a(str, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    for (;;)
    {
      ...
      try
      {
        RecentUser localRecentUser = (RecentUser)((aoxz)localObject).findRecentUser(str, 1);
      ...
      break;
      label319:
      awtz.a().c(str, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    label337:
    this.a.a(9, AppConstants.TROOP_ASSISTANT_UIN, 5000);
    this.a.a(9, AppConstants.HOTCHAT_CENTER_UIN, 5001);
  ...
  protected void onSetVisibilityForNetWorkStatus(boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramBoolean1)
    {
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqAppFrameHelperActivity.b("onSetVisibilityForNetWorkStatus");
    }
  }
  ...
  protected void onUpdateCustomHead(boolean paramBoolean, String paramString)
  {
    ...
    if (!bhbx.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
    {
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    if (!bhbx.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount()))
    {
      this.a.a(0L);
      return;
    }
  ...
  protected void onUpdateFriendList(boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((paramBoolean1) && (paramBoolean2))
    {
      ...
      this.a.a(0L);
      this.a.b(new Conversation.29.1(this));
  ...
  protected void onUpdateHotFriendLevel(boolean paramBoolean, ArrayList<String> paramArrayList)
  {
    ...
    if (paramBoolean) {
      this.a.b(new Conversation.29.5(this, paramArrayList));
    }
  }
  ...
  {
    if (paramBoolean) {
      this.a.b(new Conversation.29.4(this, paramString));
    }
  }
}
