...
{
  public awvs(ProfileTagView paramProfileTagView, View paramView, PointF paramPointF) {}
  ...
  public void onAnimationEnd(Animation paramAnimation)
  {
    ...
    if (paramAnimation != null)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileTagView.i == 0) {
        ...
        {
          paramAnimation = this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileTagView.jdField_a_of_type_Awqt.a.getLabelList();
          if (paramAnimation != null)
          {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileTagView.g(this.jdField_a_of_type_ComTencentMobileqqProfileViewProfileTagView.jdField_a_of_type_Awqt);
