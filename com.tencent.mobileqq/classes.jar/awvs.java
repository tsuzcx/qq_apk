...
public class awvs
  extends anuw
{
  public awvs(LoginWelcomeManager paramLoginWelcomeManager) {}
  ...
  protected void onCardDownload(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        aoip localaoip = (aoip)LoginWelcomeManager.a(this.a).a(20);
        paramObject = localaoip.a((Card)paramObject);
        localaoip.a(str, paramObject, 1, null, (String)localObject, localaoip.a(paramObject, l1, l2), null);
