...
public class bfyx
{
  ...
  private bfza jdField_a_of_type_Bfza;
  private bfzb jdField_a_of_type_Bfzb;
  private bfzc jdField_a_of_type_Bfzc;
  ...
  public bfyx(int paramInt, float paramFloat)
  {
    a();
  ...
  private void a(View paramView, boolean paramBoolean)
  {
    ...
    } while (this.jdField_a_of_type_Bfzc == null);
    TraceCompat.beginSection("onPagerChanged");
    this.jdField_a_of_type_Bfzc.a(localViewHolder);
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_Bfzd = new bfzd(this, null);
    this.jdField_a_of_type_Bfza = new bfza(this, null);
    this.jdField_a_of_type_Bfzb = new bfzb(this, null);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnScrollListener(this.jdField_a_of_type_Bfzd);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.setOnFlingListener(this.jdField_a_of_type_Bfzd);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnLayoutChangeListener(this.jdField_a_of_type_Bfza);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnLayoutChangeListener(this.jdField_a_of_type_Bfzb);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.getAdapter().registerAdapterDataObserver(new bfyy(this));
  }
  
  private void f()
  {
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.removeOnScrollListener(this.jdField_a_of_type_Bfzd);
  ...
  {
    return new bfyz(this, this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.getContext(), paramLinearLayoutManager);
  }
  ...
  public void a(bfzc parambfzc)
  {
    this.jdField_a_of_type_Bfzc = parambfzc;
  }
