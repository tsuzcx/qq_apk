...
public class bitd
{
  ...
  public static Object[] a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        paramContext = nlw.a(paramContext, String.format("https://cgi.connect.qq.com/qqconnectopen/get_urlinfoForQQV2?url=%2$s&uin=%1$s", new Object[] { paramString2, URLEncoder.encode(paramString1) }), null, "GET", null, null, 5000, 5000);
        ...
        if (i == 200)
        {
          paramContext = nlw.a(paramContext);
          if (QLog.isColorLevel()) {
