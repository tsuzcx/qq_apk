  ...
  implements aabj
{
  ...
  private aabk jdField_a_of_type_Aabk;
  
  public aabl(aabk paramaabk)
  {
    this.jdField_a_of_type_Aabk = paramaabk;
    this.jdField_a_of_type_Aabk.setPresenter(this);
  }
  
  private List<aabw> a(CertifiedAccountRead.StGetRecommendUserListRsp paramStGetRecommendUserListRsp)
  {
    ...
    if (paramStGetRecommendUserListRsp.expType.get() == 0)
    {
      if (paramStGetRecommendUserListRsp.vecUser.has())
      {
        ...
        while (paramStGetRecommendUserListRsp.hasNext()) {
          localArrayList.add(new aabw((CertifiedAccountMeta.StUser)paramStGetRecommendUserListRsp.next()));
        }
      }
    }
    else if ((paramStGetRecommendUserListRsp.expType.get() == 1) && (paramStGetRecommendUserListRsp.vecUserWithFeed.has()))
    {
      ...
      while (paramStGetRecommendUserListRsp.hasNext()) {
        localArrayList.add(new aabw((CertifiedAccountMeta.StFeed)paramStGetRecommendUserListRsp.next()));
      }
    }
  ...
  public void a()
  {
    ...
    VSNetworkHelper.a().a((VSBaseRequest)localObject, new aabm(this, l));
  }
  
  public void b()
  {
    if (this.jdField_a_of_type_Aabk != null)
    {
      this.jdField_a_of_type_Aabk.setPresenter(null);
      this.jdField_a_of_type_Aabk = null;
    }
  }
}
