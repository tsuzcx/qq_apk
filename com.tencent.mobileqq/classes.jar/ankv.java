...
public class ankv
{
  ...
  public ankv(int paramInt)
  {
    this(paramInt, 0, "", "");
  }
  
  public ankv(int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
  ...
  private void a(String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Ankw != null) {
        this.jdField_a_of_type_Ankw.a(paramInt);
      }
    ...
    paramString = b();
    StatisticCollector.getInstance(BaseApplicationImpl.getContext()).collectPerformance(paramString, "cmshow_game_rsc_error", true, -1L, -1L, localHashMap, "", true);
  }
  ...
  public static boolean a(int paramInt)
  {
    try
    {
      ...
      CmGameInitParams localCmGameInitParams = ((amyo)localObject).a();
  ...
  private String c()
  {
    ...
    if (this.c == 0) {
      localStringBuilder.append("/sdcard/Android/data/com.tencent.mobileqq/Tencent/MobileQQ/.apollo/game/").append(this.jdField_b_of_type_Int);
    }
    do
    {
      for (;;)
      {
        ...
        localStringBuilder.append("/sdcard/Android/data/com.tencent.mobileqq/Tencent/MobileQQ/.apollo/game/").append(this.jdField_b_of_type_Int).append("/").append(this.jdField_b_of_type_JavaLangString);
      }
    } while ((this.c != 3) && (this.c != 4));
    return bkyi.b();
  }
    ...
    for (;;)
    {
      try
      {
        if (!a(this.jdField_b_of_type_Int, this.c))
        {
          ...
          this.jdField_a_of_type_Ankw.a(0);
          return false;
        }
      ...
      if (((this.c == 0) || (this.c == 1)) && (!new anmn(c() + "/checkList.sig", localThrowable.getAbsolutePath()).a(0)))
      {
        a("checkList.sig", 3);
        return false;
      }
      this.jdField_a_of_type_OrgJsonJSONObject = new JSONObject(FileUtils.readFileToString(localThrowable));
  ...
  public boolean a(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 33	ankv:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   4: invokevirtual 362	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   7: ifeq +41 -> 48
    //   10: aload_0
    //   11: getfield 292	ankv:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   14: ifnull +34 -> 48
    //   17: aload_2
    ...
    //   28: ifne +20 -> 48
    //   31: aload_0
    //   32: getfield 35	ankv:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   35: ifnull +13 -> 48
    //   38: aload_0
    //   39: getfield 35	ankv:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   72: astore_3
    //   73: aload 7
    //   75: invokevirtual 257	java/io/File:exists	()Z
    //   78: ifne +37 -> 115
    //   81: aload 4
    //   83: astore_3
    //   84: aload_0
    //   85: aload_2
    //   86: iconst_1
    //   87: invokespecial 263	ankv:a	(Ljava/lang/String;I)V
    //   90: iconst_0
    //   91: ifeq -43 -> 48
    ...
    //   106: ldc_w 368
    //   109: aload_1
    //   110: invokestatic 268	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   113: iconst_0
    //   114: ireturn
    //   115: aload 4
    //   117: astore_3
    //   118: aload_0
    //   119: getfield 292	ankv:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   122: aload_2
    ...
    //   186: aload_2
    //   187: iconst_4
    //   188: invokespecial 263	ankv:a	(Ljava/lang/String;I)V
    //   191: aload 4
    //   193: ifnull -145 -> 48
    //   196: aload 4
    ...
    //   207: ldc_w 368
    //   210: aload_1
    //   211: invokestatic 268	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   214: iconst_0
    //   215: ireturn
    //   216: aload 4
    //   218: ifnull +8 -> 226
    ...
    //   232: ldc_w 368
    //   235: aload_1
    //   236: invokestatic 268	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   239: goto -13 -> 226
    //   242: astore_3
    //   243: aload 5
    //   245: astore 4
    ...
    //   312: ldc_w 368
    //   315: aload_1
    //   316: invokestatic 268	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   319: goto -93 -> 226
    //   322: astore_1
    //   323: aload_3
    //   324: ifnull +7 -> 331
    ...
    //   337: ldc_w 368
    //   340: aload_2
    //   341: invokestatic 268	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   344: goto -13 -> 331
    //   347: astore_1
    //   348: aload 4
    //   350: astore_3
