...
public class agov
  implements DialogInterface.OnDismissListener, AdapterView.OnItemClickListener, blow
{
  ...
  public abgu a;
  private agox jdField_a_of_type_Agox;
  public Activity a;
  ...
  public agov(Activity paramActivity, WebView paramWebView)
  {
  ...
  public void a(int paramInt, String paramString, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        ...
        zyx.a(2, 2131691142);
        if ((this.h) && (!TextUtils.isEmpty(this.jdField_a_of_type_Abgu.p))) {
      ...
      for (;;)
      {
        ...
        if (paramInt == 11)
        {
          ...
          try
          {
            ...
            if (i != 0)
            {
              ...
              localObject1 = bjtz.b(paramString + 200 + (String)localObject3 + "jubao@article@123");
              ...
              ocd.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1008, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
            }
          }
        ...
        else
        {
          if (paramInt == 2)
          {
            ...
            for (;;)
            {
              this.jdField_a_of_type_Abgu.g = bool1;
          ...
          if (paramInt == 4)
          {
            ...
            try
            {
              ...
              bdll.b(null, "P_CliOper", "VIPCOMIC", "", "0X800619F", "0X800619F", 1000, 0, noe.b(str2, new String[0]), null, null, null);
              bdll.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_48", "browser_share", 0, 1, 0, "", "", "", "");
              if ((str3 == null) || ("".equals(str3))) {
                continue;
              }
              ocd.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1006, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
            }
          ...
          else if (paramInt != 5)
          {
            if (paramInt == 3)
            {
              ...
              tzq.a(1002, (String)localObject1, this.jdField_b_of_type_Int);
              if (!TextUtils.isEmpty(this.jdField_a_of_type_Abgu.p)) {
                this.jdField_a_of_type_Abgu.a((String)localObject4, 2, false);
              }
              for (;;)
              {
            ...
            if (paramInt == 6)
            {
              if (this.jdField_a_of_type_Abgu.a((String)localObject4)) {
                this.jdField_a_of_type_Abgu.a((String)localObject4, 9, false);
              }
              if ((str3 != null) && (!"".equals(str3))) {
                ocd.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1007, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
              }
            }
            else if ((paramInt == 9) || (paramInt == 10))
            {
              ...
              if (paramInt == 9)
              {
                tzq.a(1003, (String)localObject1, this.jdField_b_of_type_Int);
              ...
              for (;;)
              {
                ...
                break;
                tzq.a(1004, (String)localObject1, this.jdField_b_of_type_Int);
                break label1289;
              ...
              {
                if (!TextUtils.isEmpty(this.jdField_a_of_type_Abgu.p)) {
                  this.jdField_a_of_type_Abgu.a((String)localObject4, 3, true);
                }
                for (;;)
                {
                  ...
                  ocd.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1003, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
                  break;
              ...
              if (!TextUtils.isEmpty(this.jdField_a_of_type_Abgu.p)) {
                this.jdField_a_of_type_Abgu.a((String)localObject4, 4, true);
              }
              for (;;)
              {
            ...
            {
              this.jdField_a_of_type_Abgu.a((String)localObject4, 5, true);
            }
            else if (paramInt == 15)
            {
              if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment == null) {
              ...
              a().a(j, new agow(this));
              bdll.b(null, "P_CliOper", "Grp_open", "", "third_app", "add_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 16)
            {
              ...
              this.jdField_a_of_type_AndroidAppActivity.startActivity(paramString);
              bdll.b(null, "P_CliOper", "Grp_open", "", "third_app", "detail_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 17)
            {
              paramString = "";
              ...
              paramBundle.putExtra("hide_more_button", true);
              this.jdField_a_of_type_AndroidAppActivity.startActivity(paramBundle);
              bdll.b(null, "P_CliOper", "Grp_open", "", "third_app", "share_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 7)
            {
              b();
            ...
            else if ((paramInt == 19) || (paramInt == 20))
            {
              ...
              for (i = 6;; i = 7)
              {
                ...
                this.jdField_a_of_type_Abgu.a((String)localObject4, i, false);
                break;
              }
              this.jdField_a_of_type_Abgu.a((String)localObject4, i, true);
            }
            else
            {
              if (paramInt == 12)
              {
                if (!TextUtils.isEmpty(this.jdField_a_of_type_Abgu.p)) {
                  this.jdField_a_of_type_Abgu.a((String)localObject4, 8, false);
                }
                for (;;)
                {
                  ...
                  ocd.a(null, "", "0X800787A", "0X800787A", 0, 0, (String)localObject1, paramBundle, "", "");
                  tzq.a(1005, paramBundle, this.jdField_b_of_type_Int);
                  break;
                  this.jdField_a_of_type_Abgu.a((String)localObject4, 8, false);
                }
              }
              ...
              else if (paramInt == 35)
              {
                ...
                if (this.jdField_b_of_type_JavaUtilArrayList != null)
                {
                  ...
                  do
                  {
                    ...
                    paramString = (obg)((Iterator)localObject2).next();
  ...
  public void a(abgu paramabgu)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Long = this.jdField_a_of_type_Agox.jdField_a_of_type_Long;
      a();
      c();
      ...
      this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetTitle(BaseApplicationImpl.getApplication().getString(2131718159));
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Agox = new agox();
      ...
      try
      {
        this.jdField_a_of_type_Agox.jdField_a_of_type_Long = Long.parseLong(str, 10);
      ...
      catch (NumberFormatException localNumberFormatException2)
      {
        try
        {
          this.jdField_a_of_type_Agox.jdField_b_of_type_Long = Long.parseLong(str, 10);
        ...
        catch (NumberFormatException localNumberFormatException2)
        {
          try
          {
            for (;;)
            {
              this.jdField_a_of_type_Agox.c = Long.parseLong(str, 10);
              ...
              try
              {
                this.jdField_a_of_type_Agox.d = Long.parseLong(paramString, 10);
                return;
              }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      tzq.a(1001, paramString3, this.jdField_b_of_type_Int);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Abgu.p)) {
  ...
  public List<ShareActionSheetBuilder.ActionSheetItem>[] a()
  {
    ...
    for (Object localObject1 = BaseApplicationImpl.getApplication().getRuntime();; localObject1 = null)
    {
      if ((localObject1 != null) && (!TextUtils.isEmpty(((AppRuntime)localObject1).getAccount())) && (!tyo.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:qq")) && ((this.jdField_a_of_type_Long & 0x8) == 0L))
      {
        ...
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695738);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839091;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695751);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839092;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
      ...
      if (((this.jdField_a_of_type_Long & 0x8000000) != 0L) && (bnrf.a()) && (!tyo.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:kandian")) && (localObject1 != null))
      {
        ...
        {
          localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
          ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695752);
          ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839090;
          ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695758);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839095;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695741);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839089;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).action = 10;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).argus = "";
        localArrayList.add(localObject2);
      }
      if ((this.g) && (!tyo.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:sinaWeibo")))
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695755);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839094;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695734);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130842620;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695735);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130842616;
      ...
      if ((!tyo.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:qiDian")) && ((this.jdField_a_of_type_Long & 0x10) == 0L)) {
        bkgt.a(this.jdField_a_of_type_AndroidAppActivity, localArrayList);
      }
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695749);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130844438;
      ...
      if ((this.jdField_e_of_type_Boolean) && (this.jdField_b_of_type_JavaUtilArrayList != null))
      {
        ...
        {
          localObject3 = (obg)localIterator.next();
          ...
          case 2: 
            ...
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).label = BaseApplicationImpl.getApplication().getString(2131694692);
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).icon = 2130842614;
      ...
      if ((this.jdField_f_of_type_Boolean) && (this.jdField_b_of_type_JavaUtilArrayList != null))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          case 3: 
            localObject3 = new ShareActionSheetBuilder.ActionSheetItem();
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).label = BaseApplicationImpl.getApplication().getString(2131695739);
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).icon = 2130842623;
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).iconNeedBg = true;
      ...
      if ((localObject1 != null) && (!TextUtils.isEmpty(((AppRuntime)localObject1).getAccount())) && (!tyo.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:favorite")) && ((this.jdField_a_of_type_Long & 0x2000) == 0L))
      {
        ...
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).icon = 2130844202;
      ...
      if ((!tyo.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:setFont")) && (!this.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_Boolean))
      {
        ...
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).icon = 2130842618;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).iconNeedBg = true;
      ...
      if ((!tyo.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:copyUrl")) && ((this.jdField_a_of_type_Long & 0x20) == 0L))
      {
        ...
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).icon = 2130839087;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).iconNeedBg = true;
  ...
  public void b()
  {
    ...
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new blpa(anzj.a(2131701330), TypedValue.applyDimension(1, 15.0F, anxh.a)));
    localArrayList.add(new blpa(anzj.a(2131701334), TypedValue.applyDimension(1, 16.0F, anxh.a)));
    localArrayList.add(new blpa("", TypedValue.applyDimension(1, 17.0F, anxh.a)));
    localArrayList.add(new blpa("", TypedValue.applyDimension(1, 17.0F, anxh.a)));
    localArrayList.add(new blpa(anzj.a(2131701333), TypedValue.applyDimension(1, 18.0F, anxh.a)));
