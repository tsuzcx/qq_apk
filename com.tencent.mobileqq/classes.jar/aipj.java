  ...
  extends aimu
{
  ...
  aipj(NewPhotoPreviewActivity paramNewPhotoPreviewActivity)
  {
  ...
  protected void c()
  {
    ...
    {
      xiu.a(this.mActivity, this.mPhotoCommonData.selectedPhotoList);
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    if (paramInt1 == 10012)
    {
      ...
      bdcs.a(new File(paramIntent).getParent());
      return;
    }
  ...
  public void onMagicStickClick(View paramView, int paramInt1, Bundle paramBundle, int paramInt2, Intent paramIntent)
  {
    ...
    if ((this.jdField_a_of_type_Aimr.jdField_a_of_type_JavaLangString != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
    {
