...
public class aipj
  implements aigs, aiil, Handler.Callback, View.OnKeyListener
{
  public int a;
  public long a;
  private ailu jdField_a_of_type_Ailu;
  private ainj jdField_a_of_type_Ainj;
  private aioa jdField_a_of_type_Aioa;
  private aioe jdField_a_of_type_Aioe;
  private aioq jdField_a_of_type_Aioq;
  private aios jdField_a_of_type_Aios;
  private aipf jdField_a_of_type_Aipf;
  ...
  private airc jdField_a_of_type_Airc;
  private aizl jdField_a_of_type_Aizl;
  private ajan jdField_a_of_type_Ajan = new aipm(this);
  private ajdd jdField_a_of_type_Ajdd;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new aipk(this);
  ...
  private aioa jdField_b_of_type_Aioa;
  ...
  public aipj(int paramInt)
  {
    ...
    if (localaips != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel = localaips.a();
    ...
    this.jdField_a_of_type_Aipx = new aipx(paramInt);
    this.jdField_e_of_type_Int = paramInt;
    aiqc.a();
    this.jdField_a_of_type_Aiqj = new aiqj(paramInt);
    this.jdField_a_of_type_Ainj = new ainj(paramInt);
  }
  ...
  private void c(CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Aipn = new aipn();
      this.jdField_a_of_type_Aipn.g = localJSONObject.optString("payParam");
      ...
      this.jdField_a_of_type_Aipn.jdField_a_of_type_Int = localJSONObject.optInt("score", -1);
      this.jdField_a_of_type_Aipn.jdField_c_of_type_JavaLangString = localJSONObject.optString("baseUrl");
      this.jdField_a_of_type_Aipn.b = localJSONObject.optString("listId");
      this.jdField_a_of_type_Aipn.jdField_c_of_type_Int = this.jdField_e_of_type_Int;
      if (aing.a() != null) {
        this.jdField_a_of_type_Aipn.jdField_a_of_type_Long = Long.parseLong(aing.a().getCurrentAccountUin());
      }
      this.jdField_a_of_type_Aipn.e = localJSONObject.optString("nickName", String.valueOf(this.jdField_a_of_type_Aipn.jdField_a_of_type_Long));
      if (QLog.isColorLevel()) {
        QLog.d("cmgame_process.CmGameLauncher", 1, "[setRedPacketInfo] " + this.jdField_a_of_type_Aipn.toString());
      }
      return;
    }
  ...
  private void n()
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      aing.a(new Object[] { "[startGameEngine], game is not ready, so status:", Boolean.valueOf(this.k) });
    }
    for (;;)
    {
      return;
      Object localObject1;
      if ((this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams == null) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams.mGamePath)) || (!bace.a(this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams.mGamePath)))
      {
        if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)
      {
        ...
        this.i = true;
        this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "sc.init_global_var.local", aing.b(this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams));
        ...
        localObject1 = "-1";
        label241:
        bajr.a(null, "cmshow", "Apollo", "initialize_game", m, 0, new String[] { localObject2, localObject1 });
        p();
        if (QLog.isColorLevel()) {
      ...
      {
        if (b()) {
          aing.a().callbackFromRequest(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.getLuaState(), 0, "cs.xy_life_cycle_event_activity.local", "{}");
        }
        for (;;)
        {
          o();
          ...
          aing.a(new Object[] { "[startGameEngine] cost:", Long.valueOf(l) });
          if (l <= 0L) {
            break;
          }
          ...
          awrn.a(((AppInterface)localObject2).getApp()).a(((AppInterface)localObject2).getCurrentAccountUin(), "cmgame_open_to_start_engine", true, l, 0L, (HashMap)localObject1, "", false);
          return;
          label516:
          localObject1 = String.valueOf(ailn.a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.extendJson));
          break label241;
          aing.a().callbackFromRequest(a(), 0, "cs.xy_life_cycle_event_activity.local", "{}");
        }
      }
  ...
  public aioa a()
  {
    return this.jdField_a_of_type_Aioa;
  }
  
  public aipn a()
  {
    return this.jdField_a_of_type_Aipn;
  }
  
  public aipx a()
  {
    return this.jdField_a_of_type_Aipx;
  }
  
  public aiqb a()
  {
    if ((this.jdField_a_of_type_Aiqb == null) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams != null)) {
      this.jdField_a_of_type_Aiqb = new aiqb(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView, this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams, (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get());
    }
    return this.jdField_a_of_type_Aiqb;
  }
  
  public aiqj a()
  {
    return this.jdField_a_of_type_Aiqj;
  }
  
  public airc a()
  {
    return this.jdField_a_of_type_Airc;
  }
  ...
  public ajdd a()
  {
    return this.jdField_a_of_type_Ajdd;
  }
  ...
  public zrw a(long paramLong, Activity paramActivity)
  {
    if (this.jdField_a_of_type_Zrw != null) {
      return this.jdField_a_of_type_Zrw;
    }
    zsb.a();
    this.jdField_a_of_type_Zrw = zsb.a(paramActivity, 5, String.valueOf(paramLong));
    ...
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null))
        {
          ...
          localObject = new aiqe();
          ((aiqe)localObject).jdField_e_of_type_Int = paramInt1;
          ((aiqe)localObject).jdField_a_of_type_Long = System.currentTimeMillis();
          ((aiqe)localObject).jdField_a_of_type_Int = this.jdField_e_of_type_Int;
          ((aiqe)localObject).d = paramInt2;
          ((aiqe)localObject).jdField_c_of_type_Int = paramInt3;
          ((aiqe)localObject).jdField_a_of_type_JavaLangString = paramString;
          ((aiqe)localObject).jdField_b_of_type_Int = this.jdField_b_of_type_Int;
          if (QLog.isColorLevel()) {
          ...
          aiqc.a().a((aiqe)localObject);
        }
        if ((this.jdField_a_of_type_Aipf == null) || (!this.jdField_a_of_type_Aipf.a())) {
          break label430;
        }
        paramInt3 = 1;
      }
      ...
      bajr.a(null, "cmshow", "Apollo", (String)localObject, 0, paramInt1, new String[] { String.valueOf(this.jdField_e_of_type_Int), paramString });
      return;
      label425:
      paramInt3 = 1;
      continue;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localApolloFloatActivity.a != null)
        {
          ...
          paramString = "window.mqq && mqq.execEventCallback && mqq.execEventCallback(" + mpw.a("apolloGameWebMessage") + "," + String.valueOf(paramString) + "," + String.valueOf("") + ");";
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    if (this.jdField_a_of_type_Ailu != null) {
      this.jdField_a_of_type_Ailu.a(paramInt, paramString1, paramString2);
    }
  }
  ...
  public void a(ailu paramailu)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel != null) {
      this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addRenderRunner(paramailu);
    }
  }
  ...
  public void a(airi paramairi)
  {
    ...
    do
    {
      return;
      localairm = a();
    } while (localairm == null);
    localairm.a(paramairi);
  }
  ...
  public void a(Activity paramActivity)
  {
    ...
    if (this.jdField_a_of_type_Aiqj != null) {
      this.jdField_a_of_type_Aiqj.a(paramActivity);
    }
    this.jdField_a_of_type_Aipf = new aipf(a(), aing.a());
    this.jdField_a_of_type_Aipf.a(null, this.jdField_e_of_type_Int);
  }
  ...
  public void a(Activity paramActivity, CmGameInitParams paramCmGameInitParams)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramActivity);
      this.jdField_a_of_type_Befq.sendEmptyMessage(204);
  ...
  public void a(Activity paramActivity, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        if (!ajam.a())
        {
          ...
          ajam.a(this.jdField_a_of_type_Ajan);
          ajam.a("CmGameLauncher");
          return;
        }
        ajam.b(this.jdField_a_of_type_Ajan);
        a(paramActivity);
        a(paramActivity);
        this.jdField_a_of_type_Aizl = new aizl(this.jdField_e_of_type_Int);
        if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) {
          break label562;
        }
        if (this.jdField_a_of_type_JavaLangRefWeakReference != null) {
      ...
      if (this.jdField_a_of_type_Airc == null) {
        this.jdField_a_of_type_Airc = new airc((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_e_of_type_Int);
      }
    ...
    {
      QLog.e("cmgame_process.CmGameLauncher", 1, localThrowable, new Object[0]);
      bool2 = aing.a(this.jdField_e_of_type_Int);
      if (!bool2) {}
    }
    label562:
    label755:
      ...
      for (;;)
      {
        try
        {
          if ((paramActivity instanceof ApolloGameActivity))
          {
            ...
            if (this.jdField_a_of_type_Aios != null) {
              this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_Aios);
            }
            if (this.jdField_a_of_type_Aioe != null) {
              this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_Aioe);
            }
            this.jdField_a_of_type_Aios = new aios(this.jdField_e_of_type_Int, paramActivity);
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addCmdHandler(this.jdField_a_of_type_Aios);
            this.jdField_a_of_type_Aioe = new aioe(this.jdField_e_of_type_Int);
            this.jdField_a_of_type_Aioq = new aioq(this);
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addCmdHandler(this.jdField_a_of_type_Aioe);
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.addCmdHandler(this.jdField_a_of_type_Aioq);
  ...
  {
    if (this.jdField_a_of_type_Aipf != null) {
      this.jdField_a_of_type_Aipf.a(paramBitmap, this.jdField_e_of_type_Int);
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        b(paramBundle);
        aing.a(new Object[] { "[checkFinish], loading from main process and tool process is on, before cost:", Long.valueOf(l1) });
  ...
  {
    if (this.jdField_a_of_type_Aioa == null)
    {
      if (paramInt != 0) {
        break label52;
      }
      this.jdField_a_of_type_Aioa = new ainm(aing.a(), this.jdField_e_of_type_Int);
    }
    for (;;)
    {
      if (this.jdField_b_of_type_Aioa == null) {
        this.jdField_b_of_type_Aioa = new ainp(this.jdField_a_of_type_Aioq);
      }
      return;
      label52:
      if (1 == paramInt) {
        this.jdField_a_of_type_Aioa = new ainx(this.jdField_e_of_type_Int);
      }
    }
  }
  ...
  public void b(Activity paramActivity, CmGameInitParams paramCmGameInitParams)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams != null) {
      if (this.jdField_a_of_type_ComTencentMobileqqApolloProcessDataCmGameInitParams == null)
      {
        ...
        str = "-1";
        label164:
        bajr.a(null, "cmshow", "Apollo", "initialize_game", m, 0, new String[] { paramCmGameInitParams, str });
      }
    }
    for (;;)
    {
      ...
      break label152;
      label230:
      str = String.valueOf(ailn.a(this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.extendJson));
      break label164;
  ...
  public void b(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      this.jdField_a_of_type_Befq.removeMessages(203);
      Message localMessage = this.jdField_a_of_type_Befq.obtainMessage(203);
      localMessage.obj = paramString;
      this.jdField_a_of_type_Befq.sendMessageDelayed(localMessage, 1000L);
  ...
  {
    this.jdField_a_of_type_Befq.removeMessages(203);
    if (((!this.jdField_b_of_type_Boolean) || ((!TextUtils.isEmpty(paramString)) && (paramString.contains("inner")))) && (this.jdField_a_of_type_Aipf != null))
    {
      boolean bool = this.jdField_e_of_type_Boolean;
      this.jdField_a_of_type_Befq.post(new CmGameLauncher.9(this, paramString, bool));
    }
  ...
  {
    if (this.jdField_a_of_type_Aioe != null) {
      this.jdField_a_of_type_Aioe.b();
    }
    if (this.jdField_a_of_type_Aioa != null) {
      this.jdField_a_of_type_Aioa.a();
    }
    if (this.jdField_b_of_type_Aioa != null) {
      this.jdField_b_of_type_Aioa.a();
    }
    ApolloCmdChannel localApolloCmdChannel = aing.a();
  ...
  public void f()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Aipw);
        if (this.jdField_a_of_type_Aizl != null) {
          this.jdField_a_of_type_Aizl.b();
        }
        if (this.jdField_a_of_type_Aipf != null) {
          this.jdField_a_of_type_Aipf.a();
        }
        if (this.jdField_a_of_type_Zrw != null) {
          this.jdField_a_of_type_Zrw.b();
        }
        if (this.jdField_a_of_type_Airc != null) {
          this.jdField_a_of_type_Airc.a();
        }
        if (this.jdField_a_of_type_Ainj != null) {
        ...
        return;
        this.jdField_a_of_type_Befq.obtainMessage(202).sendToTarget();
        if (!QLog.isColorLevel()) {
          continue;
        }
  ...
  public void g()
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        {
          if (this.jdField_a_of_type_Ailu != null) {
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeRenderRunner(this.jdField_a_of_type_Ailu);
          }
          if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) {
          ...
          if (this.jdField_a_of_type_Aioe != null) {
            this.jdField_a_of_type_Aioe.d();
          }
          if (this.jdField_a_of_type_Aioq != null)
          {
            this.jdField_a_of_type_Aioq.a();
            this.jdField_a_of_type_ComTencentMobileqqApolloAioChannelApolloCmdChannel.removeCmdHandler(this.jdField_a_of_type_Aioq);
          }
        }
        return;
        label231:
  ...
  public void h()
  {
    ...
    {
      if (this.jdField_a_of_type_Aioe != null) {
        this.jdField_a_of_type_Aioe.a(false);
      }
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)
      {
    ...
    aioy.a("cs.make_room_min.local", "{}", false, null, this.jdField_e_of_type_Int);
    if ((aing.a() != null) && (this.jdField_a_of_type_JavaLangRefWeakReference != null)) {
      aing.a(this.jdField_e_of_type_Int, (Context)this.jdField_a_of_type_JavaLangRefWeakReference.get());
    }
    if (QLog.isColorLevel()) {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      if ((this.jdField_a_of_type_Aipf == null) || (!this.jdField_a_of_type_Aipf.a(this.jdField_e_of_type_Int))) {
        break label271;
      }
      this.jdField_a_of_type_Aipf.a((String)paramMessage.obj, this.jdField_e_of_type_Int, this.jdField_e_of_type_Boolean);
    ...
    for (;;)
    {
      ...
      return false;
      label271:
      aizc.a(this.jdField_e_of_type_Int, (String)paramMessage.obj, a());
    }
  }
  ...
  public void i()
  {
    ...
    aioy.a("cs.close_room.local", "{}", false, null, this.jdField_e_of_type_Int);
  }
  ...
  public void j()
  {
    ...
    QIPCClientHelper.getInstance().callServer("cm_game_module", "action_query_check_game_data", localBundle, new aipl(this));
  }
  ...
  public void onSurfaceReady(int paramInt1, int paramInt2)
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      {
        this.jdField_a_of_type_Befq.sendEmptyMessage(200);
        this.jdField_f_of_type_Boolean = false;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.mIsGameReady = true;
      }
      this.jdField_a_of_type_Aipw = new aipw(this.jdField_e_of_type_Int);
      AppNetConnInfo.registerConnectionChangeReceiver(BaseApplicationImpl.getContext(), this.jdField_a_of_type_Aipw);
    }
  }
}
