...
public class akas
{
  ...
  protected akas(int paramInt1, long paramLong1, int paramInt2, String paramString1, long paramLong2, String paramString2)
  {
  ...
  protected static akas a(Cursor paramCursor)
  {
    if (paramCursor == null) {
      return null;
    }
    ...
    return new akas(i1, l1, m, str, l2, paramCursor);
  }
