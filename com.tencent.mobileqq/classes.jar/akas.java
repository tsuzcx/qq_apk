...
public class akas
{
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    if ((str != null) && (str.equals(paramString1))) {
      return ajya.a(2131706632);
    }
    paramString2 = bbcz.a(paramQQAppInterface, paramString1, paramString2, 1, 0);
    if (paramString2 == paramString1)
    {
      paramQQAppInterface = ((ajxl)paramQQAppInterface.getManager(51)).e(paramString1);
      if (paramQQAppInterface != null) {
        return bbcz.a(paramQQAppInterface);
      }
    }
    return paramString2;
  }
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    while (localObject1 == null)
    {
      ...
      {
        localObject1 = axaq.a((MessageForPtt)paramMessageRecord);
        i = ((MessageForPtt)paramMessageRecord).msgVia;
      }
      else if (paramMessageRecord.msgtype == -2007)
      {
        localObject1 = axaq.a((MessageForMarketFace)paramMessageRecord);
      ...
      {
        localObject1 = axaq.a((MessageForApollo)paramMessageRecord);
        i = 0;
      }
      else if ((paramMessageRecord.msgtype == -2011) || (paramMessageRecord.msgtype == -2051) || (paramMessageRecord.msgtype == -7002))
      {
        localObject1 = axaq.a((MessageForStructing)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2010)
      {
        localObject1 = axaq.a((MessageForFunnyFace)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2020)
      {
        localObject1 = axaq.a((MessageForShakeWindow)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2022)
      {
        localObject1 = axaq.a((MessageForShortVideo)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2071)
      {
        localObject1 = axaq.a((MessageForLightVideo)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5008)
      {
        localObject1 = axaq.a((ChatMessage)paramMessageRecord, false);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5013)
      {
        localObject1 = axaq.c((ChatMessage)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5014)
      {
        localObject1 = axaq.d((ChatMessage)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5012)
      {
        localObject1 = axaq.e((MessageForPoke)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5018)
      {
        localObject1 = axaq.f((MessageForPokeEmo)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -1051)
      {
        localObject1 = axaq.a((MessageForLongTextMsg)paramMessageRecord, true);
        i = 0;
      }
      ...
      {
        localObject1 = axaq.a((MessageForMixedMsg)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -2057)
      {
        localObject1 = axaq.a((MessageForTroopStory)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -7001)
      {
        localObject1 = axaq.g((MessageForScribble)paramMessageRecord);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5016)
      {
        localObject1 = axaq.c((MessageForArkBabyqReply)paramMessageRecord, false);
        i = 0;
      }
      else if (paramMessageRecord.msgtype == -5017)
      {
        localObject1 = axaq.b((MessageForArkApp)paramMessageRecord, false);
        i = 0;
      }
      else
      {
        ...
        localObject1 = axaq.b((MessageForLimitChatConfirm)paramMessageRecord);
        i = 0;
      }
    }
    if (QLog.isColorLevel()) {
    ...
    if (myb.a(paramMessageRecord))
    {
      ...
      localObject4 = myb.a(paramMessageRecord);
      ((im_msg_body.AnonymousGroupMsg)localObject3).uint32_flags.set(((myc)localObject4).jdField_a_of_type_Int);
      if (!TextUtils.isEmpty(((myc)localObject4).jdField_a_of_type_JavaLangString)) {
        ((im_msg_body.AnonymousGroupMsg)localObject3).str_anon_id.set(ByteStringMicro.copyFrom(((myc)localObject4).jdField_a_of_type_JavaLangString.getBytes()));
      }
      if (!TextUtils.isEmpty(((myc)localObject4).jdField_b_of_type_JavaLangString)) {
        ((im_msg_body.AnonymousGroupMsg)localObject3).str_anon_nick.set(ByteStringMicro.copyFrom(((myc)localObject4).jdField_b_of_type_JavaLangString.getBytes()));
      }
      ((im_msg_body.AnonymousGroupMsg)localObject3).uint32_head_portrait.set(((myc)localObject4).jdField_b_of_type_Int);
      ((im_msg_body.AnonymousGroupMsg)localObject3).uint32_expire_time.set(((myc)localObject4).jdField_c_of_type_Int);
      if (!TextUtils.isEmpty(((myc)localObject4).jdField_c_of_type_JavaLangString)) {
        ((im_msg_body.AnonymousGroupMsg)localObject3).str_rank_color.set(ByteStringMicro.copyFrom(((myc)localObject4).jdField_c_of_type_JavaLangString.getBytes()));
      }
    ...
    do
    {
      localObject2 = anml.a(paramMessageRecord);
      ...
      localObject2 = (akvq)paramQQAppInterface.getManager(199);
      if ((localObject2 != null) && (((akvq)localObject2).a()) && (((akvq)localObject2).a() == 1L) && ((paramMessageRecord.istroop == 1) || (paramMessageRecord.istroop == 3000)))
      {
        localObject2 = ((akvq)localObject2).a();
        if (localObject2 != null)
        {
      ...
      if (((ajxl)paramQQAppInterface.getManager(51)).a)
      {
        if (QLog.isColorLevel()) {
      ...
      localObject1 = axaq.a(paramQQAppInterface, paramMessageRecord, (im_msg_body.RichText)localObject1, i);
      if ((localObject1 != null) && ((paramMessageRecord instanceof MessageForStructing)))
      {
        ...
        if ((((MessageForStructing)localObject2).structingMsg != null) && (sif.a(((MessageForStructing)localObject2).structingMsg)))
        {
      ...
      localObject4 = (ajxl)paramQQAppInterface.getManager(51);
      ...
      {
        localObject3 = amnr.b(paramMessageRecord);
    ...
    for (;;)
    {
      try
      {
        localObject2 = (String)atbi.a(paramQQAppInterface.getCurrentAccountUin(), "self_nick", String.valueOf(""));
        k = ((Integer)atbi.a(paramQQAppInterface.getCurrentAccountUin(), "self_gender", Integer.valueOf(-1))).intValue();
        j = ((Integer)atbi.a(paramQQAppInterface.getCurrentAccountUin(), "self_age", Integer.valueOf(-1))).intValue();
        if ((j >= 0) && (k >= 0)) {
          continue;
        }
        localFriends = ((ajxl)localObject4).e(paramQQAppInterface.getCurrentAccountUin());
      ...
      if (paramMessageRecord.msgtype == -2011)
      {
        ...
        k = 0;
        continue;
        localObject4 = ((ajxl)localObject4).b(paramQQAppInterface.getCurrentAccountUin());
      ...
      if ((paramMessageRecord.istroop == 1033) || (paramMessageRecord.istroop == 1034))
      {
        ...
        amnr.a(localElem, paramMessageRecord);
      ...
      im_msg_body.Elem localElem = amnr.a(paramMessageRecord);
      if (localElem != null) {
        ((im_msg_body.RichText)localObject1).elems.add(localElem);
      }
      if (!QLog.isColorLevel()) {
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, ArrayList<String> paramArrayList, aaod paramaaod)
  {
    int i = 0;
    Object localObject1;
    boolean bool1;
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.MessageHandlerUtils", 2, String.format("getPbSendReqFromBlessMsg, hongbao param, temp_id: %d, video_len: %d, redbag_id: %s, redbag_amount: %d, has_readbag: %d, has_video: %d", new Object[] { Long.valueOf(paramaaod.jdField_a_of_type_Long), Long.valueOf(paramaaod.jdField_b_of_type_Long), paramaaod.jdField_a_of_type_ArrayOfByte, Long.valueOf(paramaaod.c), Integer.valueOf(paramaaod.jdField_a_of_type_Int), Integer.valueOf(paramaaod.jdField_b_of_type_Int) }));
      }
      ((msg_svc.MultiMsgAssist)localObject1).uint64_temp_id.set(paramaaod.jdField_a_of_type_Long);
      ((msg_svc.MultiMsgAssist)localObject1).uint64_vedio_len.set(paramaaod.jdField_b_of_type_Long);
      ((msg_svc.MultiMsgAssist)localObject1).uint32_has_readbag.set(paramaaod.jdField_a_of_type_Int);
      if (paramaaod.jdField_a_of_type_Int == 1)
      {
        if (paramaaod.jdField_a_of_type_ArrayOfByte != null) {
          ((msg_svc.MultiMsgAssist)localObject1).bytes_redbag_id.set(ByteStringMicro.copyFrom(paramaaod.jdField_a_of_type_ArrayOfByte));
        }
        ((msg_svc.MultiMsgAssist)localObject1).uint64_redbag_amount.set(paramaaod.c);
      }
      ((msg_svc.MultiMsgAssist)localObject1).uint32_has_vedio.set(paramaaod.jdField_b_of_type_Int);
    }
    int j = axau.a(paramMessageRecord.msgUid);
    int k = (short)(int)paramMessageRecord.msgseq;
    paramaaod = paramQQAppInterface.a().a();
    ...
    if (paramaaod != null) {
      paramArrayList.sync_cookie.set(ByteStringMicro.copyFrom(paramaaod));
    }
    if (paramArrayList != null)
    {
      i = paramArrayList.toByteArray().length;
      paramaaod = (akfv)paramQQAppInterface.a(13);
      j = paramaaod.d();
    ...
    for (;;)
    {
      ...
      if ((paramArrayList.msg_body.has()) && (((im_msg_body.MsgBody)paramArrayList.msg_body.get()).rich_text.has()))
      {
        ...
        {
          paramaaod = new im_msg_body.GeneralFlags();
          localObject1 = new generalflags.ResvAttr();
          if ((!bool1) || ((j > 0) && ((i + 7 >= j) || (j <= 0))) || (paramMessageRecord.vipBubbleDiyTextId <= 0)) {
            break label1203;
          }
          j = 1;
          paramaaod.uint32_bubble_diy_text_id.set(paramMessageRecord.vipBubbleDiyTextId);
          i = j;
          if (QLog.isColorLevel()) {
      ...
      for (i = j;; i = 0)
      {
        ...
        {
          j = 1;
          paramaaod.uint32_bubble_sub_id.set(paramMessageRecord.vipSubBubbleId);
          i = j;
          if (QLog.isColorLevel())
          {
        ...
        for (;;)
        {
          ...
          {
            i = 1;
            paramaaod.bytes_pb_reserve.set(ByteStringMicro.copyFrom(((generalflags.ResvAttr)localObject1).toByteArray()));
          }
          if (i != 0)
          {
            paramMessageRecord = new im_msg_body.Elem();
            paramMessageRecord.general_flags.set(paramaaod);
  ...
  private static im_msg_body.GeneralFlags a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.PbSendMsgReq paramPbSendMsgReq)
  {
    ...
    Object localObject1 = paramMessageRecord.getExtInfoFromExtStr(axaf.jdField_c_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      catch (Exception localException2)
      {
        ...
        localGeneralFlags.babyq_guide_msg_cookie.set(ByteStringMicro.copyFrom(paramQQAppInterface.toByteArray()));
        return localGeneralFlags;
        paramQQAppInterface = bbbr.a(paramMessageRecord.msg);
        if (paramQQAppInterface == null) {
          continue;
        }
      ...
      if (paramPbSendMsgReq != null)
      {
        ...
        localObject2 = (akfv)paramQQAppInterface.a(13);
        k = ((akfv)localObject2).d();
        m = ((akfv)localObject2).b();
        if (m <= 0) {
          break label3296;
        }
        localObject1 = ((BubbleManager)localObject1).a(m, false);
        if ((localObject1 != null) && ((localObject1 == null) || (((ambd)localObject1).a == null) || (((ambd)localObject1).a.size() <= 0))) {
          break label2164;
        }
      }
      label1866:
        ...
        for (j = k;; j = 0) {
          for (;;)
          {
            ...
            if ((paramMessageRecord instanceof MessageForFoldMsg))
            {
              i1 = i;
              n = j;
              if (agvx.a(paramQQAppInterface))
              {
                bool = agvx.b(paramQQAppInterface);
                localObject2 = (agvx)paramQQAppInterface.getManager(125);
                ...
                if (((MessageForFoldMsg)localObject1).redBagId != null)
                {
                  k = i;
                  m = j;
                  if (agvx.b(paramQQAppInterface))
                  {
                    n = 1;
                    i1 = 1;
                    if ((!bool) || (((agvx)localObject2).e)) {
                      break label2170;
                    }
                    i = 1;
                    label1018:
            ...
            if ((paramMessageRecord instanceof MessageForLongTextMsg))
            {
              ...
              localObject1 = ((ajxl)paramQQAppInterface.getManager(51)).a(paramQQAppInterface.c());
              k = j;
              j = i;
              if (localObject1 != null)
              {
              ...
              for (;;)
              {
                ...
                try
                {
                  ...
                  if ((k & 0x1) == 1)
                  {
                    ...
                    if (!((bamk)paramQQAppInterface.getManager(203)).a(paramMessageRecord)) {
                      break label2338;
                    }
                    ...
                    axaq.a(paramPbSendMsgReq, ((MessageForPtt)localObject1).mInputContent, ((MessageForPtt)localObject1).atInfoList);
                    i = k;
                ...
                catch (NumberFormatException localNumberFormatException)
                {
                  ...
                  {
                    k = i;
                    if (aezl.b((MessageForPic)paramMessageRecord))
                    {
                      i = 1;
                  ...
                  catch (Exception paramQQAppInterface)
                  {
                    try
                    {
                      ...
                      localResvAttr.bytes_pb_ptt_waveform.set(ByteStringMicro.copyFrom(bbga.a(paramQQAppInterface.waveformArray).toByteArray()));
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if ((localMessageRecord != null) && (localMessageRecord.msgtype == paramMessageRecord.msgtype) && (bbbr.a(localMessageRecord.msg, paramMessageRecord.msg)))
        {
          ...
          bfnl.a().h(System.currentTimeMillis() - l);
          return true;
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((paramMessageRecord.istroop == 1) || (paramMessageRecord.istroop == 1026) || (paramMessageRecord.istroop == 3000))
      {
        if ((localObject != null) && (((List)localObject).size() > 0))
        {
          ...
          while (((Iterator)localObject).hasNext()) {
            if (akpx.a((MessageRecord)((Iterator)localObject).next(), paramMessageRecord, false, paramBoolean))
            {
              if ((QLog.isColorLevel()) && (localStringBuilder != null))
              {
      ...
      else if (akpx.c(paramMessageRecord.istroop))
      {
        if ((localObject != null) && (((List)localObject).size() > 0))
        {
          localObject = ((List)localObject).iterator();
          while (((Iterator)localObject).hasNext()) {
            if (akpx.a((MessageRecord)((Iterator)localObject).next(), paramMessageRecord, paramBoolean))
            {
              if ((QLog.isColorLevel()) && (localStringBuilder != null))
              {
      ...
      else if (paramMessageRecord.istroop == 7220)
      {
        if ((localObject != null) && (((List)localObject).size() > 0))
        {
          ...
          } while (!akpx.a((MessageRecord)paramQQAppInterface.next(), paramMessageRecord, true));
          if ((QLog.isColorLevel()) && (localStringBuilder != null))
          {
            localStringBuilder.append(" filterType: other");
            QLog.w("Q.msg.MessageHandlerUtils", 2, localStringBuilder.toString());
