  ...
  implements View.OnClickListener
{
  ...
  uti jdField_a_of_type_Uti;
  boolean jdField_a_of_type_Boolean;
  
  public vig(@NonNull Context paramContext, String paramString, int paramInt, uti paramuti, boolean paramBoolean)
  {
    super(paramContext, 16973841);
    super.requestWindowFeature(1);
    super.setContentView(LayoutInflater.from(paramContext).inflate(2131561626, null));
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppTroopManager = ((TroopManager)vhj.a().getManager(52));
    this.jdField_a_of_type_Boolean = paramBoolean;
  }
  
  void a()
  {
    ((ElasticImageView)findViewById(2131364341)).setOnClickListener(this);
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager = ((ViewPager)findViewById(2131379882));
    this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetLeftTabBarView = ((LeftTabBarView)findViewById(2131377306));
    ...
    int i;
    if ((this.jdField_a_of_type_Uti != null) && (this.jdField_a_of_type_Boolean))
    {
      if ((this.jdField_a_of_type_Uti.a != null) && (!this.jdField_a_of_type_Uti.a.isEmpty()))
      {
        ArrayList localArrayList2 = new ArrayList(this.jdField_a_of_type_Uti.a.size());
        Iterator localIterator = this.jdField_a_of_type_Uti.a.iterator();
      ...
      this.jdField_a_of_type_ComTencentBizQqstoryViewWidgetLeftTabBarView.setOnTabChangeListener(new vih(this));
      this.jdField_a_of_type_AndroidSupportV4ViewViewPager.setAdapter(new vij(this, localArrayList1));
      this.jdField_a_of_type_AndroidSupportV4ViewViewPager.setOnPageChangeListener(new vii(this));
    ...
    for (;;)
    {
      wta.a("pub_control", "exp_list", 0, 0, new String[] { String.valueOf(i), "", "", this.jdField_a_of_type_JavaLangString });
      return;
      this.jdField_a_of_type_ComTencentBizQqstoryPlayvideoMyVideoVisiblePersonPageView = new MyVideoVisiblePersonPageView(this, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int);
      break;
      label438:
