  ...
  implements amqb
{
  ...
  private AudioManager.OnAudioFocusChangeListener jdField_a_of_type_AndroidMediaAudioManager$OnAudioFocusChangeListener = new ampp(this);
  ...
  public ampn(AppInterface paramAppInterface, int paramInt)
  {
  ...
  public int a(amld paramamld, int paramInt1, int paramInt2, String paramString, long paramLong, int paramInt3, float paramFloat)
  {
    ...
    if ((this.b > 0) && ((this.jdField_a_of_type_Int == 0) || (localObject1 == null) || (!ampj.d()) || (paramamld == null)))
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      for (localObject1 = null;; localObject1 = null)
      {
        ...
        try
        {
          ...
          {
            localObject1 = ((ApolloSurfaceView)paramamld).getRender();
            if (localObject1 == null) {
              continue;
            }
          ...
          for (localObject1 = paramString;; localObject1 = ((File)localObject1).getPath())
          {
            ...
            localObject1 = ((ApolloTextureView)paramamld).getRender();
            break;
        ...
        {
          QLog.e(jdField_a_of_type_JavaLangString, 1, "[playMusic], errInfo->" + paramamld.getMessage());
          return -1;
        }
        label368:
        ...
        if (paramString != null)
        {
          ...
          localObject1 = ampj.a();
          if (localObject1 != null) {
            ((ApolloCmdChannel)localObject1).playMusicInner(paramamld, paramString.hashCode(), paramLong);
          }
        ...
        for (;;)
        {
          try
          {
            ...
            synchronized (this.jdField_a_of_type_JavaLangObject)
            {
              ...
              if (paramInt2 == 2147483647)
              {
                ...
                if (paramInt2 != 2147483647)
                {
                  paramString.setOnCompletionListener(new ampo(this, paramInt2, paramamld, paramLong));
                  if (QLog.isColorLevel()) {
          ...
          {
            QLog.e(jdField_a_of_type_JavaLangString, 1, "prepare - start :", paramamld);
            return -1;
          }
        }
      }
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_Int == 0) || (ampj.b()) || (ampj.c()) || (!ampj.d())) {
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "DO NOT play music.");
      }
    }
