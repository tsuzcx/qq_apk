...
public class amxo
  implements amkj, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, Handler.Callback, View.OnClickListener, TouchWebView.OnScrollChangedListener
{
  public float a;
  int jdField_a_of_type_Int = 1;
  private amkh jdField_a_of_type_Amkh;
  private amxs jdField_a_of_type_Amxs;
  private amxt jdField_a_of_type_Amxt;
  ...
  public amxo(RelativeLayout paramRelativeLayout, amxx paramamxx)
  {
    ...
    paramamxx = new RelativeLayout.LayoutParams(100, 100);
    this.jdField_a_of_type_Amkh = new amxp(this);
    this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRender().setRenderCallback(this.jdField_a_of_type_Amkh);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout.addView(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView, paramamxx);
    this.jdField_e_of_type_Float = (anll.a() / 16.0F);
    if (this.jdField_e_of_type_Float != 0.0F) {
      this.jdField_d_of_type_Float = (bgln.a() / this.jdField_e_of_type_Float);
    }
    if (this.jdField_d_of_type_Float == 0.0F) {
      this.jdField_d_of_type_Float = bgln.a();
    }
    ...
    this.jdField_a_of_type_Amxt = new amxt();
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = new RelativeLayout(paramRelativeLayout);
    paramamxx = new ImageView(paramRelativeLayout);
    paramamxx.setImageResource(2130839402);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
    localLayoutParams.addRule(13, -1);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.addView(paramamxx, localLayoutParams);
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setBackgroundResource(2130838609);
  ...
  private String b(int paramInt, boolean paramBoolean, ApolloWebAvatarParam paramApolloWebAvatarParam)
  {
    ...
    if (!amzq.a(paramApolloWebAvatarParam.uin, paramApolloWebAvatarParam.roleId, paramApolloWebAvatarParam.dressIds, null))
    {
      QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), anni.a(2131699383), 0).a();
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
      {
        ...
        if ((paramApolloWebAvatarParam.tapRectWidth > 0) && (paramApolloWebAvatarParam.tapRectHeight > 0))
        {
          ...
          this.jdField_a_of_type_Bkgm.sendEmptyMessageDelayed(23, 500L);
          ...
          ((RelativeLayout.LayoutParams)???).topMargin = ((int)(paramApolloWebAvatarParam.y * this.jdField_d_of_type_Float - (float)bgln.j() * this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.rate));
          ((RelativeLayout.LayoutParams)???).rightMargin = ((int)((float)bgln.i() - this.jdField_d_of_type_Float * paramApolloWebAvatarParam.x - ((RelativeLayout.LayoutParams)???).width - ApolloUtil.a(68.0F, this.jdField_d_of_type_Float) * this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.rate / 0.289F));
          ...
          this.jdField_a_of_type_Bkgm.sendMessage(paramApolloWebAvatarParam);
  ...
  private void e()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) {
          if (this.jdField_i_of_type_Int == 0) {
            ...
            for (;;)
            {
              if (!new File(amxb.b(this.jdField_i_of_type_Int)).exists()) {
                break label395;
              }
              this.jdField_a_of_type_Bkgm.sendEmptyMessageDelayed(24, (int)(this.jdField_f_of_type_Float * 1000.0F));
              return;
              k = 0;
              break;
              m = 0;
      ...
      if ((!TextUtils.isEmpty(amzr.a().jdField_a_of_type_JavaLangString)) && ("interactive".equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.tab)))
      {
        this.jdField_a_of_type_Bkgm.sendEmptyMessageDelayed(24, 0L);
        return;
      }
    ...
    for (int m = 1;; m = 0)
    {
      ...
      if ((!amxb.a(this.jdField_c_of_type_Int)) || (m != 0) || (k != 0) || (n == 0)) {
        break;
      }
      try
      {
        bgkl.a(BaseApplicationImpl.getContext(), true);
        this.jdField_a_of_type_AndroidMediaMediaPlayer.reset();
        this.jdField_a_of_type_AndroidMediaMediaPlayer.setDataSource(ancb.jdField_d_of_type_JavaLangString + this.jdField_c_of_type_Int + "/" + "music.amr");
  ...
  private void f()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Bkgm != null) {
        this.jdField_a_of_type_Bkgm.removeMessages(24);
      }
      return;
    }
  ...
  public String a()
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null))
    {
      ...
      String[] arrayOfString = amzq.a(10, -1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
      if ((arrayOfString.length > 0) && (!TextUtils.isEmpty(arrayOfString[0])) && (arrayOfString[0].length() - "action".length() > 0)) {}
      amzr.a().jdField_a_of_type_JavaLangString = arrayOfString[0].substring(0, arrayOfString[0].length() - "action".length());
    ...
    this.jdField_a_of_type_Bkgm.sendEmptyMessageDelayed(22, 100L);
    return a(anni.a(2131699371));
  }
  ...
  public String a(int paramInt, boolean paramBoolean, ApolloWebAvatarParam paramApolloWebAvatarParam)
  {
    ...
    if (!amzq.a(paramApolloWebAvatarParam.uin, paramApolloWebAvatarParam.roleId, paramApolloWebAvatarParam.dressIds, null))
    {
      QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), anni.a(2131699370), 0).a();
      return a("dresses is not download!");
    }
    if ((!TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString)) && (!this.jdField_e_of_type_JavaLangString.equals(paramApolloWebAvatarParam.tab)))
    {
      ...
      this.jdField_a_of_type_Bkgm.postDelayed(new ApolloViewController.2(this, paramInt, paramBoolean, paramApolloWebAvatarParam), 100L);
    }
    for (;;)
    {
      return b("initAvatar成功");
  ...
  public String a(amxs paramamxs)
  {
    if (this.j)
    {
      QLog.e("ApolloViewController", 1, "previewAction 小人已隐藏");
      return a(anni.a(2131699376));
    }
    if (paramamxs == null) {
      return a("actionData is null");
    }
    if (paramamxs.jdField_a_of_type_Int > 1) {}
    for (this.jdField_a_of_type_Amxs = paramamxs; (paramamxs.jdField_c_of_type_Int == 1) && (!TextUtils.isEmpty(paramamxs.jdField_b_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (!paramamxs.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId)); this.jdField_a_of_type_Amxs = null) {
      return a(anni.a(2131699381));
    }
    if ((TextUtils.isEmpty(paramamxs.jdField_b_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)) {
      paramamxs.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId;
    }
    if (TextUtils.isEmpty(paramamxs.jdField_b_of_type_JavaLangString)) {
      return a("未传apolloId");
    }
    if (!this.jdField_a_of_type_JavaUtilHashMap.containsKey(paramamxs.jdField_b_of_type_JavaLangString)) {
      return a(anni.a(2131699379));
    }
    Object localObject1 = (ApolloWebAvatarParam)this.jdField_a_of_type_JavaUtilHashMap.get(paramamxs.jdField_b_of_type_JavaLangString);
    if (localObject1 == null) {
      return a(anni.a(2131699365));
    }
    int m = 0;
    int k = m;
    if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)
    {
      k = m;
      if (paramamxs.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId)) {
        k = 1;
      }
    }
    if ((k != 0) && (!amzq.a(((ApolloWebAvatarParam)localObject1).uin, ((ApolloWebAvatarParam)localObject1).roleId, ((ApolloWebAvatarParam)localObject1).dressIds, null)))
    {
      QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), anni.a(2131699366), 0).a();
      return a(anni.a(2131699377));
    }
    if (!ApolloUtil.a(paramamxs.jdField_b_of_type_Int, paramamxs.jdField_c_of_type_Int))
    {
      if (k != 0) {
        QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), anni.a(2131699384), 0).a();
      }
      return a(anni.a(2131699367));
    }
    ...
    {
      if (k != 0) {
        QQToast.a(BaseApplicationImpl.getContext(), anni.a(2131699382), 0).a();
      }
      return a(anni.a(2131699372));
    }
    if (k != 0) {
      f();
    }
    this.jdField_i_of_type_Int = paramamxs.m;
    this.jdField_f_of_type_Float = paramamxs.jdField_a_of_type_Float;
    boolean bool;
    label556:
    label616:
    float f1;
    ...
    if (paramamxs.l == 0)
    {
      ...
      this.jdField_h_of_type_Boolean = paramamxs.jdField_a_of_type_Boolean;
      if ((this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (paramamxs.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId))) {
        this.jdField_c_of_type_Int = paramamxs.jdField_b_of_type_Int;
      }
      this.jdField_b_of_type_Boolean = true;
      this.jdField_a_of_type_AndroidWidgetFrameLayout.setVisibility(8);
      this.jdField_a_of_type_Bkgm.removeMessages(16);
      this.jdField_f_of_type_Int = paramamxs.jdField_i_of_type_Int;
      this.jdField_d_of_type_JavaLangString = paramamxs.jdField_a_of_type_JavaLangString;
      this.jdField_g_of_type_Int = paramamxs.k;
      if (paramamxs.j != 1) {
        break label1141;
      }
      bool = true;
      this.jdField_f_of_type_Boolean = bool;
      if ((!paramamxs.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Amxt != null)) {
        this.jdField_a_of_type_Amxt.a();
      }
      if ((!TextUtils.isEmpty(paramamxs.jdField_a_of_type_JavaLangString)) && (!paramamxs.jdField_a_of_type_Boolean)) {
        break label1147;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView != null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView.setVisibility(8);
      }
      if (paramamxs.jdField_d_of_type_Int != 0) {
        break label1518;
      }
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.setVisibility(0);
      ...
      if (this.jdField_a_of_type_Int != paramamxs.jdField_c_of_type_Int)
      {
        ...
        if (paramamxs.jdField_c_of_type_Int != 1) {
          break label1218;
        }
        if (ApolloUtil.d(this.jdField_f_of_type_Int))
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(2, null, amxb.a(this.jdField_f_of_type_Int), null);
      ...
      if (!paramamxs.jdField_a_of_type_Boolean) {
        break label1277;
      }
      this.jdField_a_of_type_Amxt.a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView, paramamxs.jdField_b_of_type_Int, ((ApolloWebAvatarParam)localObject1).roleId, paramamxs.jdField_c_of_type_Int);
      this.jdField_a_of_type_Amxt.a(paramamxs.jdField_b_of_type_Float);
      this.jdField_a_of_type_Int = paramamxs.jdField_c_of_type_Int;
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
      if (TextUtils.isEmpty(paramamxs.jdField_a_of_type_JavaLangString)) {
        break label1496;
      }
      if (paramamxs.k != 1) {
        break label1453;
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView != null)
      {
        ...
        n = (int)((float)bgln.j() * ((ApolloWebAvatarParam)localObject1).rate * 1.14F);
        ...
        label1086:
        if (!paramamxs.jdField_a_of_type_Boolean) {
          amlh.a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getWidth(), n, this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView, BaseApplicationImpl.getContext(), "", paramamxs.jdField_a_of_type_JavaLangString, true);
        }
      }
    }
    for (;;)
    {
      ...
      localObject2 = amzq.a(13, paramamxs.jdField_b_of_type_Int, ((ApolloWebAvatarParam)localObject1).roleId, true);
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(1, ((ApolloWebAvatarParam)localObject1).apolloId, paramamxs.jdField_b_of_type_Int, 0, localObject2[0], localObject2[1]);
      if (paramamxs.jdField_c_of_type_Int != 1) {
        break label890;
      }
      localObject2 = amzq.a(13, paramamxs.jdField_b_of_type_Int, ((ApolloWebAvatarParam)localObject1).roleId, false);
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(2, null, paramamxs.jdField_b_of_type_Int, 0, localObject2[0], localObject2[1]);
      break label890;
      label1384:
      ...
      break label1086;
      label1453:
      amzr.a().jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(8);
    ...
    if ((!this.jdField_c_of_type_Boolean) || (this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView == null))
    {
      ...
      this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.init(new amxq(this, (DisplayMetrics)localObject1, paramamxs));
      if (this.jdField_b_of_type_Amkh == null) {
        this.jdField_b_of_type_Amkh = new amxr(this);
      }
      this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getRender().setRenderCallback(this.jdField_b_of_type_Amkh);
      label1745:
      this.jdField_a_of_type_Int = 1;
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.onExecDispose();
      ...
      localObject1 = anni.a(2131699385);
      label1800:
      ...
      label1836:
      if ((paramamxs.jdField_h_of_type_Int != 1) && (paramamxs.jdField_e_of_type_Int > 0)) {
        break label2016;
      }
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetButton.setTag(Integer.valueOf(paramamxs.jdField_b_of_type_Int));
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setTag(Integer.valueOf(paramamxs.jdField_b_of_type_Int));
      break;
      this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.onExecDispose();
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.onExecDispose();
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      localObject1 = this.jdField_a_of_type_Bkgm.obtainMessage(19, paramamxs.jdField_c_of_type_Int, paramamxs.jdField_b_of_type_Int);
      if (paramamxs.jdField_a_of_type_Boolean) {
        ((Message)localObject1).obj = Float.valueOf(paramamxs.jdField_b_of_type_Float);
      }
      this.jdField_a_of_type_Bkgm.sendMessageDelayed((Message)localObject1, 100L);
      break label1745;
      label1995:
      ...
      if (TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext().getResources().getString(2131690014));
      }
      this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      ApolloUtil.a(this.jdField_b_of_type_AndroidWidgetImageView, paramamxs.jdField_e_of_type_Int);
      if (!bool) {
  ...
  public String a(ArrayList<ApolloWebAvatarParam> paramArrayList)
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if (!amzq.a(localApolloWebAvatarParam.uin, localApolloWebAvatarParam.roleId, localApolloWebAvatarParam.dressIds, null))
      {
        QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), anni.a(2131699368), 0).a();
        return a("dresses is not download!");
      }
    }
  ...
  public String a(int[] paramArrayOfInt)
  {
    if (this.j)
    {
      ...
      return a(anni.a(2131699378));
    }
    if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam == null) {
      return a(anni.a(2131699369));
    }
    if (!amzq.a(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.uin, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, paramArrayOfInt, null))
    {
      QQToast.a(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext(), anni.a(2131699386), 0).a();
      return a(anni.a(2131699375));
    }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundColor(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext().getResources().getColor(2131166900));
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(4);
      Object localObject1 = new RelativeLayout.LayoutParams(-2, (int)((float)bgln.j() * 0.6F));
      ((RelativeLayout.LayoutParams)localObject1).addRule(13, -1);
      ((RelativeLayout.LayoutParams)localObject1).leftMargin = ApolloUtil.a(25.0F, this.jdField_d_of_type_Float);
      ((RelativeLayout.LayoutParams)localObject1).rightMargin = ApolloUtil.a(25.0F, this.jdField_d_of_type_Float);
      Object localObject2 = LayoutInflater.from(this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext()).inflate(2131558684, null);
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)((View)localObject2).findViewById(2131364056));
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)((View)localObject2).findViewById(2131362781));
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnClickListener(this);
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)((View)localObject2).findViewById(2131362711));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)((View)localObject2).findViewById(2131362710));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject2).findViewById(2131362708));
      ...
      ((ImageView)localObject1).setId(2131362739);
      ...
      ((ImageView)localObject1).setBackgroundResource(2130838442);
  ...
  {
    this.jdField_a_of_type_Bkgm.removeMessages(23);
    this.jdField_b_of_type_Int = paramInt;
    if (this.jdField_g_of_type_Boolean)
    {
      this.jdField_a_of_type_Bkgm.removeMessages(16);
      this.jdField_a_of_type_Bkgm.sendEmptyMessageDelayed(16, 3000L);
    }
    label218:
    label250:
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)
      {
        if ("mall".equals(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.tab)) {
          ...
          {
            this.jdField_a_of_type_JavaLangString = anni.a(2131699388);
            if (this.jdField_h_of_type_Int == 1) {
              this.jdField_a_of_type_JavaLangString = amxb.a(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId);
            }
        ...
        for (;;)
        {
          ...
          {
            this.jdField_a_of_type_JavaLangString = anni.a(2131699373);
            break;
          }
  ...
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramamkj);
  }
  
  public void a(Activity paramActivity, AppInterface paramAppInterface, String paramString1, String paramString2)
  {
    c(false);
    this.jdField_a_of_type_Bkgm.postDelayed(new ApolloViewController.3(this, paramActivity, paramAppInterface, paramString1, paramString2), 500L);
  }
  ...
  public void c(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = 1;
      this.jdField_a_of_type_Bkgm.obtainMessage(18).sendToTarget();
      return;
      label79:
  ...
  public boolean handleMessage(Message arg1)
  {
    ...
    case 27: 
      do
      {
        do
        {
          do
          {
            for (;;)
            {
              ...
              if ((this.jdField_a_of_type_AndroidMediaAudioManager != null) && (this.jdField_a_of_type_AndroidMediaAudioManager.getRingerMode() == 1))
              {
                ...
                n = 1;
                if ((!new File(amxb.b(this.jdField_i_of_type_Int)).exists()) || (m != 0) || (k != 0) || (n == 0)) {}
              }
              try
              {
                bgkl.a(BaseApplicationImpl.getContext(), true);
                this.jdField_a_of_type_AndroidMediaMediaPlayer.reset();
                this.jdField_a_of_type_AndroidMediaMediaPlayer.setDataSource(amxb.b(this.jdField_i_of_type_Int));
                this.jdField_a_of_type_AndroidMediaMediaPlayer.prepare();
                this.jdField_a_of_type_AndroidMediaMediaPlayer.start();
                if (!TextUtils.isEmpty(amzr.a().jdField_a_of_type_JavaLangString))
                {
                  ??? = amzr.a().jdField_a_of_type_JavaLangString;
                  if (???.startsWith("def"))
                  {
                    ??? = ancb.jdField_c_of_type_JavaLangString + "/" + ???;
                    amzr.a().jdField_a_of_type_JavaLangString = "";
                    ??? = ApolloUtil.a(???, "amr");
                    if (??? == null) {}
                  }
              ...
              catch (Throwable ???)
              {
                try
                {
                  ...
                  ??? = ancb.jdField_a_of_type_JavaLangString + "/" + ???;
                }
                catch (IOException ???)
                {
                  for (;;)
          ...
          ??? = amzq.a(4, -1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
        ...
        if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_Int != 0))
        {
          ...
          if ((this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId)))
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId, amxb.a, null);
          }
        }
        for (;;)
        {
          synchronized (this.jdField_a_of_type_JavaUtilHashMap)
          {
            ...
            if ((???.arg1 > 0) && (!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString)) && (this.jdField_f_of_type_Boolean) && (this.jdField_g_of_type_Int == 0))
            {
              ...
              if (this.jdField_a_of_type_Amxx != null) {
                this.jdField_a_of_type_Amxx.a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView);
              }
              a(false);
              ...
              this.jdField_a_of_type_Bkgm.sendEmptyMessageDelayed(21, 100L);
              return false;
              if (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)
              {
              ...
              for (;;)
              {
                synchronized (this.jdField_a_of_type_JavaUtilHashMap)
                {
                  for (;;)
                  {
                    ...
                    {
                      ???.a(1, localApolloWebAvatarParam.apolloId, amxb.a, null);
                      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
                      {
      ...
      if (!TextUtils.isEmpty((CharSequence)???))
      {
        if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam != null)) {
          synchronized (this.jdField_a_of_type_JavaUtilHashMap)
          {
            if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(???))
            {
              ...
              if (localApolloWebAvatarParam != null)
              {
                ...
                if (??? != null)
                {
                  ...
                  ((amir)???).a(1, localApolloWebAvatarParam.apolloId, localApolloWebAvatarParam.roleId, ApolloUtil.a(localApolloWebAvatarParam.rate), localApolloWebAvatarParam.x, this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getHeight() / this.jdField_d_of_type_Float - localApolloWebAvatarParam.y);
                  if (localApolloWebAvatarParam.roleId != 0) {
                    break label1995;
                  }
                  ((amir)???).a(1, localApolloWebAvatarParam.apolloId, amxb.a, null);
                }
              }
            }
            ...
            ((amir)???).a(1, localApolloWebAvatarParam.apolloId, localApolloWebAvatarParam.dressIds, null);
          }
        }
    ...
    case 19: 
      ...
      {
        f2 = 77.0F;
        f4 = (float)(Math.max(bgln.h(), bgln.g()) / 7L) / 368.0F;
        ??? = ???.obj;
    ...
    for (int k = 1;; k = 0)
    {
      ...
      {
        f1 = 330.0F * f4 / bgln.jdField_a_of_type_Float / 2.0F;
        ...
        this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(2, null, amxb.a(this.jdField_f_of_type_Int), null);
        ??? = amzq.a(13, n, this.jdField_f_of_type_Int, false);
        if (k != 0)
        {
          this.jdField_a_of_type_Amxt.a(this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView, n, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, m);
          this.jdField_a_of_type_Amxt.a(f3);
        }
      }
      for (;;)
      {
        ...
        ??? = amzq.a(13, n, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.roleId, true);
          ...
          if (!TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString))
          {
            if (this.jdField_g_of_type_Int == 1)
            {
              ...
              if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != ???)
              {
                ...
                ???.bottomMargin = (afur.a(f2, this.jdField_c_of_type_AndroidWidgetRelativeLayout.getContext().getResources()) + (this.jdField_a_of_type_AndroidWidgetRelativeLayout.getHeight() - this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getHeight()) / 2);
              ...
              amlh.a(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getWidth(), k, this.jdField_a_of_type_ComTencentMobileqqApolloBarrageBarrageView, BaseApplicationImpl.getContext(), "", this.jdField_d_of_type_JavaLangString, true);
              return true;
              f2 = 42.0F;
              break;
            ...
            amzr.a().jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(0);
        ...
        this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.getRenderImpl().a(1, this.jdField_a_of_type_ComTencentMobileqqApolloStoreApolloWebAvatarParam.apolloId, "Bubble");
        return true;
        if ((this.jdField_a_of_type_Amxs == null) || (this.jdField_a_of_type_Amxs.jdField_a_of_type_Int <= 0)) {
          break;
        }
        ??? = this.jdField_a_of_type_Amxs;
        ???.jdField_a_of_type_Int -= 1;
        a(this.jdField_a_of_type_Amxs);
        return false;
        label2851:
        return true;
        f1 = 0.0F;
  ...
  {
    if (paramView.getId() == 2131362739)
    {
      this.jdField_a_of_type_Bkgm.sendEmptyMessage(15);
      f();
    }
    for (;;)
    {
      ...
      {
        f();
        if ((this.jdField_a_of_type_Amxx != null) && ((paramView.getTag() instanceof Integer))) {
          this.jdField_a_of_type_Amxx.a(((Integer)paramView.getTag()).intValue());
        }
        this.jdField_a_of_type_Bkgm.sendEmptyMessage(15);
      }
    }
  ...
  public void onNotifyLongTouch(String paramString)
  {
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((amkj)this.jdField_a_of_type_JavaLangRefWeakReference.get()).onNotifyLongTouch(paramString);
    }
  }
  ...
  public void onNotifyStatusChanged(int paramInt, String paramString)
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null) && (this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((amkj)this.jdField_a_of_type_JavaLangRefWeakReference.get()).onNotifyStatusChanged(paramInt, paramString);
    }
  }
  ...
  public void onSurfaceReady(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Bkgm.sendEmptyMessage(18);
    if ((this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)) {
      ((amkj)this.jdField_a_of_type_JavaLangRefWeakReference.get()).onSurfaceReady(paramInt1, paramInt2);
    }
  }
}
