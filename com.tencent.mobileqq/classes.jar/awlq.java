  ...
  implements Handler.Callback
{
  ...
  public awlr a;
  private awls jdField_a_of_type_Awls = new awls(null);
  awlv jdField_a_of_type_Awlv;
  ...
  public awlq()
  {
    this.jdField_a_of_type_Awlr = new awlr();
    f();
  ...
  private awmk a()
  {
    awmk localawmk = this.jdField_a_of_type_Awlr.a.b();
    if (localawmk != null) {
      return localawmk;
    }
    localawmk = this.jdField_a_of_type_Awlr.a.a();
    if (localawmk != null)
    {
      this.jdField_a_of_type_Awlv.a(localawmk.jdField_a_of_type_Int, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      return localawmk;
    }
    return null;
  }
  ...
  {
    this.jdField_a_of_type_Awls.jdField_a_of_type_Int = paramAVIOStruct.pFrameIndex;
    paramAVIOStruct.pFrameIndex = 0;
    this.jdField_a_of_type_Awls.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Awls.jdField_b_of_type_Int = 0;
    ahoi.a("handleMessage:writeVideoFrame[false]  mThumbPicControl.mSendThumbOKIndex=" + this.jdField_a_of_type_Awls.jdField_a_of_type_Int);
  }
  ...
  private boolean a()
  {
    boolean bool2 = true;
    bool1 = false;
    synchronized (awlr.a(this.jdField_a_of_type_Awlr))
    {
      Object localObject2 = awlr.a(this.jdField_a_of_type_Awlr);
  ...
  private void h()
  {
    if (this.jdField_a_of_type_Awlv != null) {
      this.jdField_a_of_type_Awlv.c();
    }
    this.jdField_a_of_type_Awlv = null;
    c();
  ...
  public void a(int paramInt1, int paramInt2, ahkw paramahkw)
  {
  ...
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilOffScreenInputSurface != null)
    {
      if (paramBoolean)
      {
        this.jdField_a_of_type_Awlv = new awlv();
        this.jdField_a_of_type_Awlv.a(false, false);
        d();
      }
      awkh.b();
      return;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == -16716524)
    {
      ...
      a(paramMessage.arg1, paramMessage.arg2, (ahkw)paramMessage.obj);
      this.h = true;
      if (this.i) {
        a(a());
      }
    ...
    do
    {
      do
      {
        ...
        f();
        this.jdField_a_of_type_Awlr.a();
        this.jdField_a_of_type_Awlr.a = null;
        this.jdField_a_of_type_Awls.jdField_b_of_type_Int = 0;
        this.jdField_a_of_type_Awls.jdField_a_of_type_Boolean = false;
        this.jdField_a_of_type_Awls.jdField_a_of_type_Int = -1;
        h();
      } while (!QLog.isColorLevel());
    ...
    if (j != 0)
    {
      ahoi.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
      return true;
    }
    if (this.jdField_a_of_type_Awlv != null) {
      awkh.a(PtvFilterUtils.a() / 1000L);
    }
    boolean bool1;
    if (paramMessage.obj != null)
    {
      ...
      for (;;)
      {
        ...
        ahoi.a("handleMessage:[copyDataToByteBuffer] steptime=" + l1 + " us");
        awkh.d(l1);
        ...
        if (this.jdField_a_of_type_Awlr.a != null) {
          break;
        }
        ahoi.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
        return true;
        if (paramMessage.arg1 == 1) {
          localObject = ((awji)paramMessage.obj).jdField_a_of_type_ArrayOfByte;
        }
      }
      ...
      if (localawmk != null)
      {
        this.jdField_a_of_type_Awlv.a(localawmk.jdField_a_of_type_Int);
        ahoi.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] bindTextureId=" + localawmk.jdField_a_of_type_Int);
        ahoi.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] Begin drawFrame mWidth=" + this.jdField_a_of_type_Int + " mHeight=" + this.jdField_b_of_type_Int);
        e();
        ahoi.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] End drawFrame");
        if (!jdField_a_of_type_Boolean) {}
        AVIOStruct localAVIOStruct;
        for (bool1 = true;; bool1 = false)
        {
          PtvFilterUtils.a(bool1);
          ahoi.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] glSyncCommand OK: sNeedSyncUseFlush=" + jdField_a_of_type_Boolean);
          if (paramMessage.arg1 != 1) {
            break label1126;
          }
          localAVIOStruct = ((awji)paramMessage.obj).jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct;
        ...
        {
          this.jdField_a_of_type_Awls.jdField_a_of_type_Boolean = true;
          localObject = localAVIOStruct;
        }
        label713:
        ...
        bool1 = true;
        label739:
        localawmk.a(j, localObject, bool1);
        localawmk.e();
        bool1 = this.jdField_a_of_type_Awlr.a.a();
        ahoi.a("handleMessage:writeVideoFrame  mNewSession=" + this.jdField_a_of_type_Awls.jdField_a_of_type_Boolean + "  Make data ready: frameIndex= " + ((AVIOStruct)localObject).pFrameIndex + "  hasRenaderFrame=" + bool1);
        if (!bool1)
        {
          if (this.jdField_a_of_type_Awls.jdField_a_of_type_Boolean) {
            a((AVIOStruct)localObject);
          }
          localawmk.a();
        }
        ahoi.a("handleMessage:writeVideoFrame frameBufferTime=" + l2 + "  sNeedSyncUseFlush=" + jdField_a_of_type_Boolean);
      }
      l1 = (PtvFilterUtils.a() - l1) / 1000L;
      awkh.c(l1);
    ...
    for (;;)
    {
      ...
      break label739;
      label1143:
      ahoi.a("handleMessage:byteBufferProcessFrame  framebuffer=null");
    }
  }
}
