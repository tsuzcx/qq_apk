  ...
  extends ncx
{
  ...
  static
  {
    ...
    int[] arrayOfInt7 = { 3, 3, 3, 2 };
    int[] arrayOfInt8 = { 3, 3, 3, 4 };
    int[] arrayOfInt9 = { 3, 4, 4, 4 };
    jdField_a_of_type_Array2dOfInt = new int[][] { { 1 }, arrayOfInt1, arrayOfInt2, arrayOfInt3, arrayOfInt4, arrayOfInt5, { 2, 2, 3 }, { 2, 3, 3 }, arrayOfInt6, { 3, 3, 2, 2 }, arrayOfInt7, { 3, 3, 3, 3 }, arrayOfInt8, { 3, 3, 4, 4 }, arrayOfInt9, { 4, 4, 4, 4 } };
  ...
  public ncw(Context paramContext, AVGameAppInterface paramAVGameAppInterface)
  {
  ...
  {
    paramArrayOfnda2 = new ArrayList(8);
    int j = paramArrayOfnda1.length;
    int i = 0;
    while (i < j)
    {
      paramList = paramArrayOfnda1[i];
      if (paramList.a()) {
        paramArrayOfnda2.add(paramList);
      }
      i += 1;
    }
    if (paramArrayOfnda2.isEmpty()) {
      return;
    }
    i = paramArrayOfnda2.size();
    i = Math.min(i, i);
    ...
    for (;;)
    {
      paramArrayOfnda1 = a(i, paramInt1, paramInt2);
      paramInt1 = 0;
      for (;;)
      {
        if (paramInt1 >= i) {
        ...
        paramList = (Rect)paramArrayOfnda1.get(paramInt1);
        if (paramList == null) {
          break;
        }
        ((nda)paramArrayOfnda2.get(paramInt1)).b(paramList.left, paramList.top, paramList.right, paramList.bottom);
        ((nda)paramArrayOfnda2.get(paramInt1)).a(0, 0, 0, 0);
        paramInt1 += 1;
      }
      label176:
      break;
