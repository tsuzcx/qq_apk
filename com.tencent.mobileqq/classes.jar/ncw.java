...
public class ncw
{
  private static final ncw jdField_a_of_type_Ncw = new ncw();
  ...
  {
    paramString = ((ajoy)paramAppInterface.getManager(56)).b(paramString + "");
  ...
  private mobileqq_mp.SendMenuEventRequest a(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      localSendMenuEventRequest.versionInfo.set("8.2.6,3,4370");
  ...
  private String a(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      for (localObject = ((RecentUser)localObject).uin;; localObject = "0")
      {
        ...
        {
          if (rqc.e(paramQQAppInterface))
          {
            i = 1;
            break label153;
          }
          if (rqn.a().a(paramQQAppInterface) != 0) {
            i = 1;
          }
          break label153;
        }
        if ((((RecentUser)localObject).getType() != 7230) || (rol.a().b() == 0)) {
          break label421;
        }
        i = 1;
        break label153;
  ...
  private void a(Context paramContext, QQAppInterface paramQQAppInterface)
  {
    ...
    ahyd.a().a(paramQQAppInterface, 4);
  }
  ...
  private void a(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    if (AudioHelper.b(0))
    {
      babr.a(paramContext, 230, paramContext.getString(2131632717), paramContext.getString(2131632718), new ndj(this), null).show();
      return;
    }
    if (AudioHelper.a(0))
    {
      babr.a(paramContext, 230, paramContext.getString(2131632717), paramContext.getString(2131632719), new ndk(this), null).show();
      return;
    }
    paramQQAppInterface.a().b();
    acnc.a(paramQQAppInterface, (BaseActivity)paramContext, 1, 0);
    ...
    try
    {
      ...
      this.jdField_b_of_type_AndroidContentBroadcastReceiver = new ncy(this);
  ...
  private static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, mobileqq_mp.ButtonInfo paramButtonInfo)
  {
    ...
    if ((paramContext instanceof FragmentActivity))
    {
      ...
      if (localObject != null)
      {
        ...
        if ((localObject instanceof aegy))
        {
          localObject = (aegy)localObject;
          ((aegy)localObject).y += 1;
        }
      }
    }
    ...
    for (;;)
    {
      ...
      ((Intent)localObject).putExtra("assignBackText", paramContext.getResources().getString(2131625011));
      ((Intent)localObject).putExtra("FORCE_BLANK_SCREEN_REPORTE", true);
      ((Intent)localObject).putExtra("big_brother_source_key", rtr.b(paramString));
  ...
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    ...
    localIntent.putExtra("big_brother_source_key", rtr.b(paramString2));
    paramContext.startActivity(localIntent);
  }
  ...
  private void a(Context paramContext, MqqHandler paramMqqHandler, boolean paramBoolean)
  {
    ...
    localIntent.putExtra("from", ncw.class.getName());
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidContentBroadcastReceiver = new ndi(this, paramBoolean, paramMqqHandler);
  ...
  private void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString)
  {
    ...
    rtr.a(localIntent, paramQQAppInterface, paramContext, paramString, -1);
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, mobileqq_mp.ButtonInfo paramButtonInfo, String paramString2)
  {
    ...
    if ((!TextUtils.isEmpty(paramString2)) && (bcev.a(paramString2)))
    {
      awab localawab = new awab();
      int i;
      Bundle localBundle;
      int j;
      if (awab.a((String)localObject) == 0)
      {
        i = 0;
        localBundle = awab.a((String)localObject);
        j = localBundle.getInt("a_launch_mode", 268435456);
        if (i == 0) {
          break label136;
        }
        localawab.a(paramQQAppInterface, paramContext, String.valueOf(l), (String)localObject, paramString2, j);
      }
      for (;;)
      {
        if (!bool) {
        ...
        break;
        label136:
        bool = bcev.a(paramContext, paramString2, localBundle, j);
      }
    }
    a(paramQQAppInterface, paramContext, paramString1, paramButtonInfo);
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, MqqHandler paramMqqHandler)
  {
    ...
    ahyd.a().a(paramQQAppInterface, 3);
  }
  ...
  private void a(mobileqq_mp.SendMenuEventRequest paramSendMenuEventRequest)
  {
    ...
    NewIntent localNewIntent = new NewIntent(localContext, ndu.class);
    ...
    ((PROTOCAL.StQWebReq)localObject).qua.set(bfpk.a());
    ((PROTOCAL.StQWebReq)localObject).deviceInfo.set(bfpj.a().c());
    ...
    localNewIntent.setObserver(new ndc(this, localNewIntent, localContext, str1, localBusinessObserver, localQQAppInterface));
  ...
  private void b(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    if (localUri != null)
    {
      begr localbegr = begr.a((BaseActivity)paramContext);
      String[] arrayOfString = paramContext.getResources().getStringArray(2130903127);
      int j = arrayOfString.length;
      int i = 0;
      while (i < j)
      {
        localbegr.c(arrayOfString[i]);
        i += 1;
      }
      localbegr.c(2131625035);
      localbegr.a(new ncz(this, paramQQAppInterface, paramContext, localUri, paramSessionInfo, localbegr));
      localbegr.show();
    }
    for (;;)
    {
      ...
      try
      {
        ...
        label120:
        this.jdField_b_of_type_AndroidContentBroadcastReceiver = null;
        this.jdField_b_of_type_AndroidContentBroadcastReceiver = new nda(this);
        paramQQAppInterface = new IntentFilter("com.tencent.biz.pubaccount.picResultAction");
        paramContext.registerReceiver(this.jdField_b_of_type_AndroidContentBroadcastReceiver, paramQQAppInterface, "com.tencent.msg.permission.pushnotify", null);
        this.jdField_a_of_type_Int = 2;
        return;
        acnc.a(paramQQAppInterface, (Activity)paramContext, paramSessionInfo, null, null);
        paramQQAppInterface = (ajtg)paramQQAppInterface.a(20);
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    RecentUser localRecentUser = localakeu.a(paramString, 1008);
  ...
  private void c(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    try
    {
      ((FragmentActivity)paramContext).getChatFragment().a().aJ();
    ...
    catch (Exception paramSessionInfo)
    {
      try
      {
        ...
        this.jdField_c_of_type_AndroidContentBroadcastReceiver = new ndb(this, paramQQAppInterface, bool);
  ...
  protected int a(String paramString, int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    case 1024: 
      do
      {
        ...
        return 1;
      } while (!mqb.b(paramQQAppInterface, paramString));
      return 2;
    case 0: 
      return 3;
    case 1: 
  ...
  public NewIntent a(Context paramContext, AppInterface paramAppInterface, long paramLong1, long paramLong2, long paramLong3, long paramLong4, int paramInt, List<Long> paramList)
  {
    ...
    paramContext = new NewIntent(paramContext, ndt.class);
  ...
  public NewIntent a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString, BusinessObserver paramBusinessObserver, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localNewIntent = new NewIntent(paramContext, ndu.class);
      ...
      ((PROTOCAL.StQWebReq)localObject1).qua.set(bfpk.a());
      ((PROTOCAL.StQWebReq)localObject1).deviceInfo.set(bfpj.a().c());
      ...
      localNewIntent.setObserver(new ndd(this, localNewIntent, paramQQAppInterface, paramString, paramContext, paramBusinessObserver));
  ...
  public NewIntent a(String paramString, int paramInt, boolean paramBoolean, Context paramContext, AppInterface paramAppInterface, ndm paramndm)
  {
    paramContext = new NewIntent(paramContext, ndt.class);
    ...
    paramContext.setObserver(new ndg(this, paramContext, paramndm));
    if (paramAppInterface != null) {
      paramAppInterface.startServlet(paramContext);
    }
    return paramContext;
  ...
  public void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, ndl paramndl)
  {
    if ((paramString1 != null) && (!paramString1.equals(this.jdField_c_of_type_JavaLangString))) {
      a(paramString1);
    }
    this.jdField_c_of_type_JavaLangString = paramString1;
    ThreadManager.executeOnSubThread(new PublicAccountManager.1(this, paramString2, paramQQAppInterface, paramndl, paramContext));
  }
  ...
  public void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2, boolean paramBoolean, double paramDouble1, double paramDouble2, BusinessObserver paramBusinessObserver, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    try
    {
      ...
      NewIntent localNewIntent = new NewIntent(paramContext, ndu.class);
      localNewIntent.putExtra("cmd", "CertifiedAccountSvc.certified_account_write.SendMenuEvent");
      paramString2 = new PROTOCAL.StQWebReq();
      paramString2.Seq.set(-1L);
      paramString2.qua.set(bfpk.a());
      paramString2.deviceInfo.set(bfpj.a().c());
      ...
      localNewIntent.setObserver(new nde(this, localNewIntent, paramContext, paramString1, paramBusinessObserver, paramQQAppInterface));
      if (paramQQAppInterface != null) {
        paramQQAppInterface.startServlet(localNewIntent);
      }
      return;
  ...
  public void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, String paramString4, BusinessObserver paramBusinessObserver)
  {
    ...
    catch (Exception paramString2)
    {
      do
      {
        ...
        paramString3 = new NewIntent(paramBaseActivity, ndu.class);
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      awqx.b(null, "dc01160", "Pb_account_lifeservice", "", "0X800661D", "0X800661D", 0, 0, "", "", (String)localObject, "");
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, mobileqq_mp.GetPublicAccountMenuResponse paramGetPublicAccountMenuResponse)
  {
    ...
    do
    {
      ...
      if (((atmp)localObject).a(PublicAccountMenuEntity.class, paramString) == null) {
        break label391;
      }
      PublicAccountMenuEntity localPublicAccountMenuEntity2 = (PublicAccountMenuEntity)((atmp)localObject).a(PublicAccountMenuEntity.class, paramString);
      if (localPublicAccountMenuEntity2 == null) {
        break label381;
      }
      localPublicAccountMenuEntity2.clone(localPublicAccountMenuEntity1);
      ((atmp)localObject).a(localPublicAccountMenuEntity2);
      ((atmp)localObject).a();
    ...
    {
      awqx.a(paramQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005EC2", "0X8005EC2", 0, 0, paramString, paramGetPublicAccountMenuResponse, "", "");
      ...
      awqx.a(paramQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005EC3", "0X8005EC3", 0, 0, paramString, String.valueOf(((mobileqq_mp.ButtonInfo)((List)localObject).get(0)).sub_button.get().size()), "", "");
      return;
      i = 0;
      break label43;
      label381:
      ((atmp)localObject).a(localPublicAccountMenuEntity1);
      break label137;
      label391:
      ((atmp)localObject).a(localPublicAccountMenuEntity1);
      break label137;
  ...
  public void a(String paramString1, Context paramContext, QQAppInterface paramQQAppInterface, String paramString2, int paramInt1, BusinessObserver paramBusinessObserver, MqqHandler paramMqqHandler, int paramInt2, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      if (localButtonInfo.type.has())
      {
        ...
        ndn.a(null, "P_CliOper", "Pb_account_lifeservice", paramString2, "mp_caidan_click", "aio_caidan_click", 0, 0, String.valueOf(paramInt2), String.valueOf(paramInt1), paramString1, String.valueOf(i), false);
        ohp.a().a(paramString2, paramInt1, paramInt2, localButtonInfo);
        ...
        if (i == 2)
        {
          ...
          paramString1 = awul.a(localButtonInfo.url.get());
        }
        ...
        ndn.a(null, "P_CliOper", "Pb_account_lifeservice", paramString2, "0X8005D4B", "0X8005D4B", 0, 0, (String)localObject + ";REFERRER=" + paramString1, "", "", "", false);
      ...
      for (boolean bool = localButtonInfo.is_new_menu.get();; bool = false)
      {
        ...
        if ((paramContext instanceof FragmentActivity))
        {
          ...
          if (paramString1 != null)
          {
            ...
            if ((paramString1 instanceof aegy))
            {
              paramString1 = (aegy)paramString1;
              paramString1.w += 1;
            }
          }
        }
      ...
      paramSessionInfo = bade.a(paramQQAppInterface, paramContext, paramString1);
  ...
  public boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    } while ((babp.e()) || (bace.a() <= 1.048576E+008F));
