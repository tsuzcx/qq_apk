  ...
  implements View.OnClickListener, Animation.AnimationListener
{
  ...
  private bhvt jdField_a_of_type_Bhvt;
  ...
  private bhvq(Activity paramActivity, View paramView, int paramInt1, int paramInt2, boolean paramBoolean)
  {
  ...
  private static View a(Activity paramActivity, List<bhvt> paramList)
  {
    View localView = LayoutInflater.from(paramActivity).inflate(2131562540, null);
    ...
    a(paramActivity, paramList, (LinearLayout)localBounceScrollView.findViewById(2131364770));
    return localView;
  }
  
  private static View a(Activity paramActivity, List<bhvt> paramList, boolean paramBoolean, int paramInt)
  {
    View localView = LayoutInflater.from(paramActivity).inflate(2131562540, null);
    ...
    LinearLayout localLinearLayout = (LinearLayout)((BounceScrollView)localObject1).findViewById(2131364770);
    ...
    {
      localbhvt = (bhvt)paramList.get(paramInt);
      if (paramInt == 0)
      {
        localObject2 = (LinearLayout)LayoutInflater.from(paramActivity).inflate(2131562539, null);
        localObject1 = null;
      }
    }
    for (;;)
    {
      Object localObject3 = (ImageView)((LinearLayout)localObject2).findViewById(2131368165);
      TextView localTextView = (TextView)((LinearLayout)localObject2).findViewById(2131377720);
      if (localbhvt.jdField_a_of_type_ComTencentImageURLDrawable != null)
      {
        ((ImageView)localObject3).setImageDrawable(localbhvt.jdField_a_of_type_ComTencentImageURLDrawable);
        label173:
        if ((localbhvt.jdField_b_of_type_Int == 0) && (localbhvt.jdField_a_of_type_AndroidGraphicsDrawableDrawable == null))
        {
          ((ImageView)localObject3).setVisibility(8);
          ((LinearLayout)localObject2).setPadding(0, 0, 0, 0);
        }
        localTextView.setText(localbhvt.jdField_a_of_type_JavaLangString);
        if (!TextUtils.isEmpty(localbhvt.jdField_b_of_type_JavaLangString)) {
          localTextView.setTextColor(Color.parseColor(localbhvt.jdField_b_of_type_JavaLangString));
        }
        if (localbhvt.jdField_a_of_type_Float > 0.0F) {
          localTextView.setTextSize(localbhvt.jdField_a_of_type_Float);
        }
        if (TextUtils.isEmpty(localbhvt.c)) {
          break label485;
        }
        ((LinearLayout)localObject2).setContentDescription(localbhvt.c + alpo.a(2131708720));
        label301:
        if (localObject1 != null) {
          localLinearLayout.addView((View)localObject1);
        }
        ((LinearLayout)localObject2).setTag(localbhvt);
        if (localbhvt.jdField_a_of_type_Int > 0) {
          ((LinearLayout)localObject2).setId(localbhvt.jdField_a_of_type_Int);
        }
        ...
        {
          localObject1 = (LinearLayout)LayoutInflater.from(paramActivity).inflate(2131562537, null);
          if (!paramBoolean) {
            break label528;
          }
      ...
      {
        localObject2 = (LinearLayout)LayoutInflater.from(paramActivity).inflate(2131562538, null);
        break;
        if (localbhvt.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable != null)
        {
          ((ImageView)localObject3).setImageDrawable(localbhvt.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable);
          break label173;
        }
        if (localbhvt.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
        {
          ((ImageView)localObject3).setImageDrawable(localbhvt.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
          break label173;
        }
        ((ImageView)localObject3).setImageResource(localbhvt.jdField_b_of_type_Int);
        break label173;
        label485:
        ((LinearLayout)localObject2).setContentDescription(localbhvt.jdField_a_of_type_JavaLangString + alpo.a(2131708716));
        break label301;
        return localView;
      }
      label528:
  ...
  public static bhvq a(Activity paramActivity, List<bhvt> paramList, bhvu parambhvu)
  {
    return a(paramActivity, paramList, parambhvu, null);
  }
  
  public static bhvq a(Activity paramActivity, List<bhvt> paramList, bhvu parambhvu, bhvv parambhvv)
  {
    return a(paramActivity, paramList, parambhvu, parambhvv, 0);
  }
  
  public static bhvq a(Activity paramActivity, List<bhvt> paramList, bhvu parambhvu, bhvv parambhvv, int paramInt)
  {
    return a(paramActivity, paramList, parambhvu, parambhvv, paramInt, false);
  }
  
  public static bhvq a(Activity paramActivity, List<bhvt> paramList, bhvu parambhvu, bhvv parambhvv, int paramInt, boolean paramBoolean)
  {
    return a(paramActivity, paramList, parambhvu, parambhvv, paramInt, paramBoolean, -1, 2131755029);
  }
  
  public static bhvq a(Activity paramActivity, List<bhvt> paramList, bhvu parambhvu, bhvv parambhvv, int paramInt1, boolean paramBoolean, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      paramActivity = new bhvq(paramActivity, a(paramActivity, paramList, paramBoolean, paramInt2), paramInt1, i, true);
      ...
      paramActivity.jdField_a_of_type_Bhvu = parambhvu;
      paramActivity.jdField_a_of_type_Bhvv = parambhvv;
      paramActivity.jdField_b_of_type_Boolean = paramBoolean;
      return paramActivity;
    }
  }
  
  private static void a(Activity paramActivity, List<bhvt> paramList, LinearLayout paramLinearLayout)
  {
    a(paramActivity, paramList, paramLinearLayout, false);
  }
  
  private static void a(Activity paramActivity, List<bhvt> paramList, LinearLayout paramLinearLayout, boolean paramBoolean)
  {
    int i = 0;
    if (i < paramList.size())
    {
      bhvt localbhvt = (bhvt)paramList.get(i);
      ...
      if (i == 0)
      {
        localLayoutParams = new LinearLayout.LayoutParams(-1, aekt.a(62.0F, paramActivity.getResources()));
        localObject = (LinearLayout)LayoutInflater.from(paramActivity).inflate(2131562536, null);
        localImageView = (ImageView)((LinearLayout)localObject).findViewById(2131368165);
        TextView localTextView = (TextView)((LinearLayout)localObject).findViewById(2131377720);
        if (localbhvt.jdField_a_of_type_ComTencentImageURLDrawable == null) {
          break label392;
        }
        localImageView.setImageDrawable(localbhvt.jdField_a_of_type_ComTencentImageURLDrawable);
        label110:
        if ((localbhvt.jdField_b_of_type_Int == 0) && (localbhvt.jdField_a_of_type_AndroidGraphicsDrawableDrawable == null))
        {
        ...
        ((LinearLayout)localObject).setContentDescription(localbhvt.c + alpo.a(2131708719));
      }
      for (;;)
      {
        ((LinearLayout)localObject).setTag(localbhvt);
        if (localbhvt.jdField_a_of_type_Int > 0) {
          ((LinearLayout)localObject).setId(localbhvt.jdField_a_of_type_Int);
        }
        ...
        if (i == paramList.size() - 1)
        {
          ...
          if (paramBoolean) {}
          for (int j = 2131562535;; j = 2131562534)
          {
            localObject = (LinearLayout)((LayoutInflater)localObject).inflate(j, null);
            break;
          }
        }
        localLayoutParams = new LinearLayout.LayoutParams(-1, aekt.a(52.0F, paramActivity.getResources()));
        localObject = (LinearLayout)LayoutInflater.from(paramActivity).inflate(2131562535, null);
        break label68;
        label392:
        if (localbhvt.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable != null)
        {
          localImageView.setImageDrawable(localbhvt.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable);
          break label110;
        }
        if (localbhvt.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
        {
          localImageView.setImageDrawable(localbhvt.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
          break label110;
        }
        localImageView.setImageResource(localbhvt.jdField_b_of_type_Int);
        break label110;
        label447:
        ((LinearLayout)localObject).setContentDescription(localbhvt.jdField_a_of_type_JavaLangString + alpo.a(2131708717));
      }
    }
  }
  ...
  {
    if ((paramView.getTag() != null) && ((paramView.getTag() instanceof bhvt))) {
  ...
  public static bhvq b(Activity paramActivity, List<bhvt> paramList, bhvu parambhvu, bhvv parambhvv)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      throw new IllegalArgumentException("parameter items can not be null or zero-length array.");
    }
    ...
    {
      paramActivity = new bhvq(paramActivity, a(paramActivity, paramList), i, j, true);
  ...
  private void b()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidViewView == null)
      {
        ...
        this.jdField_a_of_type_AndroidViewView.setOnClickListener(new bhvr(this));
      }
      if ((AppSetting.c) && (Build.VERSION.SDK_INT >= 14)) {
        getContentView().setAccessibilityDelegate(new bhvs(this));
      }
      return;
    }
  }
  ...
  public void dismiss()
  {
    try
    {
      ...
      {
        super.dismiss();
        if ((this.jdField_a_of_type_Bhvu != null) && (this.jdField_a_of_type_Bhvt != null)) {
          this.jdField_a_of_type_Bhvu.a(this.jdField_a_of_type_Bhvt);
        }
        this.jdField_a_of_type_Bhvt = null;
        if (this.jdField_a_of_type_Bhvv != null) {
          this.jdField_a_of_type_Bhvv.a();
        }
        return;
  ...
  {
    this.jdField_a_of_type_Bhvt = ((bhvt)paramView.getTag());
    dismiss();
  }
