  ...
  implements agma
{
  ...
  public agml(BaseChatPie paramBaseChatPie)
  {
  ...
  private awsk a()
  {
    ...
    return ((awsj)localBaseActivity.app.getManager(325)).b(i);
  }
  ...
  private void d()
  {
    ...
    if ((localObject != null) && (((awsk)localObject).a()))
    {
      ...
      if (localObject != null) {
        ((ChatXListView)localObject).setOnLayoutListener(new agmm(this));
      }
    }
  }
  ...
  private void j()
  {
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Afwy;
    Object localObject2;
    if (localObject1 != null)
    {
      localObject1 = ((afwy)localObject1).a();
      i = a();
      if ((localObject1 != null) && (((List)localObject1).size() == i))
      {
        localObject1 = a();
        if ((localObject1 != null) && (((awsk)localObject1).a()))
        {
          localObject2 = ((awsk)localObject1).a();
          if (localObject2 != null)
          {
            localObject2 = ((awso)localObject2).a();
            if (localObject2 != null) {
              break label100;
            }
    ...
    this.jdField_a_of_type_AndroidOsHandler.postDelayed(new MultiWindowAIOHelper.4(this, (awsk)localObject1), 350L);
  }
  
  public void a()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Afwy != null)) {
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Afwy.d();
    }
