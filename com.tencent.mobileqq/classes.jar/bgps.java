  ...
  extends AccountObserver
{
  ...
  bgps(Intent paramIntent, String paramString, bgpu parambgpu)
  {
  ...
  public void onRegisterCommitPassRespWithLhSig(boolean paramBoolean, int paramInt, String paramString, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString = BaseApplicationImpl.getContext().getString(2131716113);
        ...
        if (QLog.isDevelopLevel()) {
          bgpv.a("LHLoginMng -- onRegisterCommitPassRespWithLhSig", localIntent);
        }
        if (this.jdField_a_of_type_Bgpu != null) {
          this.jdField_a_of_type_Bgpu.a(localIntent, paramBoolean, this.jdField_a_of_type_JavaLangString, paramArrayOfByte3, paramString);
        }
