  ...
  implements View.OnClickListener
{
  ...
  public biyh(@NonNull biyt parambiyt)
  {
    super(parambiyt);
  ...
  private boolean a(String paramString)
  {
    try
    {
      ...
      this.jdField_a_of_type_Biyt.jdField_d_of_type_Int = paramString.jdField_a_of_type_Int;
      this.jdField_a_of_type_Biyt.jdField_e_of_type_Int = paramString.b;
      this.jdField_a_of_type_Biyt.jdField_d_of_type_JavaLangString = paramString.jdField_a_of_type_JavaLangString;
      int i = this.jdField_a_of_type_Biyt.jdField_d_of_type_Int;
      if (i > 0) {
        return true;
      }
    }
  ...
  private void j()
  {
    RelativeLayout localRelativeLayout1 = (RelativeLayout)a(2131299943);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)LayoutInflater.from(a()).inflate(2131496254, localRelativeLayout1, false));
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(-1, aciy.a(50.0F, a()));
    RelativeLayout localRelativeLayout2 = this.jdField_a_of_type_AndroidWidgetRelativeLayout;
    if (this.jdField_a_of_type_Biyt.i)
    {
      i = 0;
      localRelativeLayout2.setVisibility(i);
      localLayoutParams.addRule(12);
      if (bjeh.jdField_e_of_type_Int <= 0) {
        break label110;
      }
    }
    label110:
    for (int i = bjeh.jdField_e_of_type_Int;; i = aciy.a(60.0F, a()))
    {
  ...
  private void k()
  {
    ...
    this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewExtendEditText.setTextEffect(this.jdField_a_of_type_Biyt.jdField_e_of_type_JavaLangString);
    String str = bfuw.a(this.jdField_a_of_type_Biyt.jdField_d_of_type_Int, null, null, null);
    if (TextUtils.isEmpty(str)) {
      this.jdField_a_of_type_Biyt.jdField_d_of_type_Int = -1;
    }
    for (;;)
    {
  ...
  public void a()
  {
    ...
    if (!this.jdField_a_of_type_Biyt.k) {
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
    }
    if ((this.jdField_a_of_type_Biyt.h) || (this.jdField_a_of_type_Biyt.j))
    {
      this.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetCheckBox.setVisibility(0);
      this.jdField_a_of_type_AndroidWidgetCheckBox.setOnCheckedChangeListener(new biyi(this));
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 == 1)
    {
      ...
      if (paramIntent != null)
      {
        ...
        if (paramIntent.containsKey("permission_code")) {
          this.jdField_a_of_type_Biyt.jdField_c_of_type_Int = paramIntent.getInt("permission_code");
        }
        if (paramIntent.containsKey("uin_list"))
        {
          if (this.jdField_a_of_type_Biyt.jdField_a_of_type_JavaUtilArrayList == null) {
            this.jdField_a_of_type_Biyt.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
          }
          this.jdField_a_of_type_Biyt.jdField_a_of_type_JavaUtilArrayList.clear();
          localObject = paramIntent.getStringArrayList("uin_list");
          if (localObject != null) {
            this.jdField_a_of_type_Biyt.jdField_a_of_type_JavaUtilArrayList.addAll((Collection)localObject);
          }
        }
        if (a(this.jdField_a_of_type_Biyt.jdField_c_of_type_Int))
        {
          this.jdField_a_of_type_Biyt.b = paramIntent.getString("key_setting_raw_json");
          this.jdField_a_of_type_Biyt.jdField_a_of_type_JavaLangString = paramIntent.getString("key_selected_tag");
        }
        if (vhg.a().b() == 22) {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Biyt.jdField_a_of_type_AndroidViewView != null) {
        this.jdField_a_of_type_Biyt.jdField_a_of_type_AndroidViewView.setVisibility(8);
      }
      this.jdField_a_of_type_Bigb.a(Message.obtain(null, 22));
    ...
    if (localBundle.containsKey("contentIntentKey"))
    {
      ...
      this.jdField_a_of_type_Biyt.jdField_c_of_type_JavaLangString = paramIntent;
      if (vhg.a().b() == 22) {
    ...
    this.jdField_a_of_type_Biyt.jdField_d_of_type_Int = localBundle.getInt("extra_key_font_id", -1);
    this.jdField_a_of_type_Biyt.jdField_e_of_type_Int = localBundle.getInt("extra_key_font_format_type");
    this.jdField_a_of_type_Biyt.jdField_d_of_type_JavaLangString = localBundle.getString("extra_key_font_url");
    this.jdField_a_of_type_Biyt.f = localBundle.getInt("extra_key_super_font_id", -1);
    this.jdField_a_of_type_Biyt.jdField_e_of_type_JavaLangString = localBundle.getString("extra_key_super_font_info");
    k();
  }
  ...
  public void a_(int paramInt, Object paramObject)
  {
    ...
    {
      if ((this.jdField_a_of_type_Biyt.i) && (!this.jdField_a_of_type_Boolean)) {}
  ...
  public void d()
  {
    this.jdField_a_of_type_JavaLangString = bgld.a(this.jdField_a_of_type_Biyt.jdField_c_of_type_Int);
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (i == 2131300840)
      {
        ...
        this.jdField_a_of_type_Biyt.d(3004);
        localObject1 = new Bundle();
        ((Bundle)localObject1).putInt("permission_code", this.jdField_a_of_type_Biyt.jdField_c_of_type_Int);
        if ((this.jdField_a_of_type_Biyt.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_Biyt.jdField_a_of_type_JavaUtilArrayList.size() > 0))
        {
          ((Bundle)localObject1).putStringArrayList("uin_list", this.jdField_a_of_type_Biyt.jdField_a_of_type_JavaUtilArrayList);
          localObject2 = new ArrayList(this.jdField_a_of_type_Biyt.jdField_a_of_type_JavaUtilArrayList.size());
          localObject3 = this.jdField_a_of_type_Biyt.jdField_a_of_type_JavaUtilArrayList.iterator();
        ...
        if ((a(this.jdField_a_of_type_Biyt.jdField_c_of_type_Int)) && (!TextUtils.isEmpty(this.jdField_a_of_type_Biyt.b))) {
          ((Bundle)localObject1).putString("key_setting_raw_json", this.jdField_a_of_type_Biyt.b);
        }
        if (vhg.a().b() == 22)
        {
        ...
        bfpr.a((BaseActivity)this.jdField_a_of_type_Bihj, paramView, 1, (Bundle)localObject1, "");
        return;
      }
    } while (i != 2131300797);
    this.jdField_a_of_type_Biyt.d(3001);
    Object localObject1 = bfpy.a();
    Object localObject2 = new Bundle();
    ((Bundle)localObject2).putInt("permission_code", this.jdField_a_of_type_Biyt.jdField_c_of_type_Int);
    if ((this.jdField_a_of_type_Biyt.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_Biyt.jdField_a_of_type_JavaUtilArrayList.size() > 0))
    {
      ((Bundle)localObject2).putStringArrayList("uin_list", this.jdField_a_of_type_Biyt.jdField_a_of_type_JavaUtilArrayList);
      paramView = new ArrayList(this.jdField_a_of_type_Biyt.jdField_a_of_type_JavaUtilArrayList.size());
      localObject3 = this.jdField_a_of_type_Biyt.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (((Iterator)localObject3).hasNext()) {
    ...
    if ((a(this.jdField_a_of_type_Biyt.jdField_c_of_type_Int)) && (!TextUtils.isEmpty(this.jdField_a_of_type_Biyt.b))) {
      ((Bundle)localObject2).putString("key_setting_raw_json", this.jdField_a_of_type_Biyt.b);
    }
    ((Bundle)localObject2).putBoolean("is_need_auto_close_from_pri", true);
    if (this.jdField_a_of_type_Biyt.jdField_a_of_type_AndroidViewView != null) {
      this.jdField_a_of_type_Biyt.jdField_a_of_type_AndroidViewView.setVisibility(0);
    }
    paramView = "";
    if (this.jdField_a_of_type_DovComTencentMobileqqActivityRichmediaViewExtendEditText != null) {
    ...
    this.jdField_a_of_type_Bigb.a(Message.obtain(null, 21));
    BaseActivity localBaseActivity = (BaseActivity)this.jdField_a_of_type_Bihj;
    if (this.jdField_a_of_type_Biyt.h) {}
    for (int i = 0;; i = 1)
    {
      bfpr.a(localBaseActivity, (bfpy)localObject1, 1009, "", paramView, "", "", 0, i, 1, 0, 0, 0, "", 10000, (Bundle)localObject2, this.jdField_a_of_type_Biyt.h, this.jdField_a_of_type_Biyt.g, this.jdField_a_of_type_Biyt.jdField_d_of_type_Int, this.jdField_a_of_type_Biyt.f, false, (Bundle)localObject3);
      return;
    }
  }
}
