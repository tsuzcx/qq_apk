...
public class axus
{
  ...
  {
    boolean bool2 = false;
    paramAppInterface = (String)axws.a(paramAppInterface.getAccount(), "key_tabs_array", "");
    for (;;)
    {
      try
      {
  ...
  {
    bool2 = false;
    paramAppInterface = (String)axws.a(paramAppInterface.getCurrentAccountUin(), "key_banner_enter_items", "");
    for (;;)
    {
      try
      {
  ...
  public DatingConfig a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 193	axus:a	Lcom/tencent/mobileqq/data/DatingConfig;
    //   6: ifnull +12 -> 18
    //   9: aload_0
    //   10: getfield 193	axus:a	Lcom/tencent/mobileqq/data/DatingConfig;
    //   13: astore_1
    //   14: aload_0
    //   15: monitorexit
    //   16: aload_1
    ...
    //   30: ldc 197
    //   32: aload_3
    //   33: invokestatic 202	bhmi:a	(Ljava/lang/String;[Ljava/lang/Class;)[Ljava/lang/Object;
    //   36: astore 4
    //   38: aload_2
    //   39: astore_1
    //   40: aload 4
    ...
    //   63: aload_0
    //   64: aload_1
    //   65: putfield 193	axus:a	Lcom/tencent/mobileqq/data/DatingConfig;
    //   68: goto -54 -> 14
    //   71: astore_1
    //   72: aload_0
    //   73: monitorexit
  ...
  public void a()
  {
    ...
    //   14: aload_0
    //   15: aconst_null
    //   16: putfield 193	axus:a	Lcom/tencent/mobileqq/data/DatingConfig;
    //   19: goto -8 -> 11
    //   22: astore_1
    //   23: aload_0
    //   24: monitorexit
