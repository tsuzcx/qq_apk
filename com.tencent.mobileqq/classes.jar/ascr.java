  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      bool = false;
      paramIntent = (ascj)getAppRuntime().getManager(214);
      if (!bool) {
        break label505;
      }
    }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    for (;;)
    {
      ...
      while (!QLog.isColorLevel())
      {
        ...
        localObject1 = bhuf.a(paramIntent.toByteArray());
        break;
        ...
        localObject1 = bhuf.a(paramIntent.getStringExtra("key_report_content").getBytes());
        if (!QLog.isColorLevel()) {
          break label676;
        }
