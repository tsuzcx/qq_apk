...
public class ascr
{
  public static Drawable a(Resources paramResources, int paramInt)
  {
    ...
    if (paramInt == 0) {
      localDrawable = azlj.a(paramResources, paramResources.getColor(2131100539));
    }
    while (paramInt != 1) {
      return localDrawable;
    }
    return azlj.a(paramResources, paramResources.getColor(2131100537));
  }
  ...
  public static String a(int paramInt)
  {
    ...
    default: 
      return ajkc.c;
    case 2: 
      return ajjy.a(2131639812);
    case 4: 
      return ajjy.a(2131639810);
    case 5: 
      return ajjy.a(2131639811);
    }
    return ajjy.a(2131639813);
  }
  ...
  public static void a(Context paramContext, QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    if (!bool)
    {
      ...
      if ((localObject1 != null) && (((ajjj)localObject1).b(paramString2))) {
        i = 1;
      }
    }
    for (;;)
  ...
  public static void a(awau paramawau, long paramLong, String paramString, int paramInt)
  {
    boolean bool;
    switch (paramInt)
    {
    ...
    {
      if (bool) {
        paramawau.a(0, paramString, paramLong, 1);
      }
      if (QLog.isColorLevel()) {
        asfl.a("PttShow", new Object[] { "addLocalMaxMsgSeq", String.format("needUpdateLocal:%b\tfrom:%d\t msgSeq:%d", new Object[] { Boolean.valueOf(bool), Integer.valueOf(paramInt), Long.valueOf(paramLong) }) });
      }
      return;
      long l = paramawau.a(0, paramString);
      if (1L + l == paramLong)
      {
        bool = true;
      }
      else
      {
        ...
        asfl.a("PttShow", new Object[] { "addLocalMaxMsgSeq", String.format("not continuous seq local:%d\tmsgseq:%d\tfrom:%d", new Object[] { Long.valueOf(l), Long.valueOf(paramLong), Integer.valueOf(paramInt) }) });
        bool = false;
        continue;
        bool = true;
      }
  ...
  public static void a(HotChatInfo paramHotChatInfo, QQAppInterface paramQQAppInterface, Activity paramActivity, int paramInt)
  {
    ...
    localIntent.putExtra("url", befm.a(befm.a(befm.a(befm.a(befm.a("http://nearby.qq.com/hot_chat/member_list.html?_wv=3&_bid=2581", "_wv", "3"), "_bid", "2581"), "gc", paramHotChatInfo.troopUin), "rid", paramHotChatInfo.uuid), "from", String.valueOf(0)));
    ...
    if (paramInt == 0) {
      ajnb.a(paramQQAppInterface, "0X800638B");
    }
    while (paramInt != 1) {
      return;
    }
    ajnb.a(paramQQAppInterface, "0X800638C");
  }
