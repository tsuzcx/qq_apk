...
public class amjt
{
  ...
  public static boolean b(Context paramContext)
  {
    ...
    //   25: aload_0
    //   26: invokevirtual 105	android/content/Context:getPackageName	()Ljava/lang/String;
    ...
    //   44: aload 5
    //   46: iconst_1
    //   47: anewarray 16	java/lang/String
    //   50: dup
    //   51: iconst_0
    //   52: ldc 109
    //   54: aastore
    ...
    //   57: aconst_null
    //   58: aconst_null
    //   59: invokevirtual 115	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   62: astore 5
    //   64: aload 5
    //   66: ifnull +97 -> 163
    //   69: aload 5
    //   71: astore 4
    //   73: aload 5
    //   75: invokeinterface 120 1 0
    //   80: ifeq +83 -> 163
    //   83: aload 5
    //   85: astore 4
    //   87: aload 5
    //   89: iconst_0
    //   90: invokeinterface 124 2 0
    //   95: istore_1
    //   96: iload_1
    //   97: ifne +61 -> 158
    //   100: iconst_1
    ...
    //   119: iconst_1
    //   120: iload_1
    //   121: invokestatic 132	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   124: aastore
    //   125: dup
    //   126: iconst_2
    //   127: ldc 134
    ...
    //   131: iconst_3
    //   132: iload_2
    //   133: invokestatic 139	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   136: aastore
    //   137: invokestatic 142	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   140: iload_2
    //   141: istore_3
    //   142: aload 5
    //   144: ifnull +12 -> 156
    ...
    //   165: astore 4
    //   167: aload_0
    //   168: invokestatic 64	amjt:c	(Landroid/content/Context;)Z
    //   171: istore_2
    //   172: aload 5
    //   174: astore 4
    //   176: ldc 29
    ...
    //   189: iconst_1
    //   190: iload_2
    //   191: invokestatic 139	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   194: aastore
    //   195: dup
    //   196: iconst_2
    //   197: ldc 149
    ...
    //   202: aload 5
    //   204: aastore
    //   205: invokestatic 142	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;I[Ljava/lang/Object;)V
    //   208: goto -68 -> 140
    //   211: astore 6
    //   213: aload 5
    //   215: astore 4
    ...
    //   220: ldc 151
    //   222: aload 6
    //   224: invokestatic 155	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   227: aload 5
    //   229: astore 4
    //   231: aload_0
    //   232: invokestatic 64	amjt:c	(Landroid/content/Context;)Z
    //   235: istore_2
    //   236: iload_2
    //   237: istore_3
    //   238: aload 5
