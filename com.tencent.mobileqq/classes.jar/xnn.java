  ...
  implements bfph
{
  ...
  public xnn(Context paramContext)
  {
    ...
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.tencent.map", ajya.a(2131710457));
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.google.android.apps.maps", "Google地图");
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.autonavi.minimap", ajya.a(2131710455));
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put("com.baidu.BaiduMap", ajya.a(2131710456));
  ...
  public static String a(double paramDouble)
  {
    if (paramDouble < 1000.0D) {
      return String.format(ajya.a(2131710463), new Object[] { Double.valueOf(paramDouble) });
    }
    return String.format(ajya.a(2131710462), new Object[] { Double.valueOf(paramDouble / 1000.0D) });
  }
  ...
  {
    axqy.b(null, "dc00899", "Pb_account_lifeservice", "", "rec_locate_android", paramString1, 0, 0, paramString2, paramString3, "", "");
    if (QLog.isColorLevel()) {
  ...
  {
    axqy.b(null, "P_CliOper", "Pb_account_lifeservice", "", "rec_locate", paramString1, 0, 0, paramString2, "", "", "");
    if (QLog.isColorLevel()) {
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Xnp != null) {
        if (!this.jdField_a_of_type_Xnp.b())
        {
  ...
  public void a(GeoPoint paramGeoPoint1, GeoPoint paramGeoPoint2)
  {
    if (!bbfj.g(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      bcql.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 1, paramGeoPoint1.getString(2131694610), 1).b(paramGeoPoint1.getDimensionPixelSize(2131298865));
      return;
    }
    ...
    for (;;)
    {
      ...
      new baib(str, "GET", new xno(this), 1000, localBundle2, true).execute(new HashMap[] { paramGeoPoint1 });
      return;
  ...
  public void a(GeoPoint paramGeoPoint1, GeoPoint paramGeoPoint2, String paramString1, String paramString2)
  {
    ...
    {
      bcql.a(this.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 0, ajya.a(2131710460), 1).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298865));
      return;
    }
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_JavaLangString = ajya.a(2131710458);
    }
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      this.jdField_b_of_type_JavaLangString = ajya.a(2131710454);
    }
    ...
    if (d > 1000.0D)
    {
      ...
      if ((this.jdField_a_of_type_Xnp == null) || (this.jdField_a_of_type_Xnp.b())) {
        break label469;
      }
      this.jdField_a_of_type_Bfpc.c(ajya.a(2131710461));
      label295:
      this.jdField_a_of_type_ArrayOfInt[0] = 0;
      this.jdField_a_of_type_Bfpc.c(ajya.a(2131710459));
      this.jdField_a_of_type_ArrayOfInt[1] = 1;
      this.jdField_a_of_type_Bfpc.c((CharSequence)this.jdField_a_of_type_JavaUtilLinkedHashMap.get("com.tencent.map"));
      ...
      this.jdField_a_of_type_Bfpc.c(paramString1);
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Int = 0;
      break;
      this.jdField_a_of_type_Bfpc.c(ajya.a(2131710453));
      break label295;
  ...
  public void a(JSONObject paramJSONObject, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Xnp != null) {
        this.jdField_a_of_type_Xnp.a(paramJSONObject, paramInt);
      }
      return;
      if (paramInt == 1)
      {
