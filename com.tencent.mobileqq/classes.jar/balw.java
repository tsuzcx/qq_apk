...
public class balw
{
  ...
  public static balw a()
  {
    if (jdField_a_of_type_Balw == null) {}
    try
    {
      if (jdField_a_of_type_Balw == null) {
        jdField_a_of_type_Balw = new balw();
      }
      return jdField_a_of_type_Balw;
    }
    finally {}
  }
  ...
  public String a(String paramString, balx parambalx)
  {
    String str1 = paramString;
    if (parambalx.c != null) {
      str1 = paramString.replace("<$FROM>", parambalx.c);
    }
    paramString = str1;
    if (parambalx.a != null) {
      paramString = str1.replace("<$GC>", parambalx.a);
    }
    str1 = paramString;
    if (parambalx.e != null) {
      str1 = paramString.replace("<$NICK>", parambalx.e);
    }
    paramString = str1;
    if (parambalx.d != null) {
      paramString = str1.replace("<$TYPE>", parambalx.d);
    }
    str1 = paramString;
    if (parambalx.b != null) {
      str1 = paramString.replace("<$UIN>", parambalx.b);
    }
    paramString = str1;
    if (parambalx.f != null) {
      paramString = str1.replace("<$CATEID>", parambalx.f);
    }
    str1 = paramString;
    if (parambalx.g != null) {
      str1 = paramString.replace("<$SUBID>", parambalx.g);
    }
    paramString = str1;
    if (parambalx.j != null) {
      paramString = str1.replace("<$GRAY>", parambalx.j);
    }
    str1 = paramString;
    if (parambalx.h != null) {}
    try
    {
      str1 = paramString.replace("<$TITLE>", URLEncoder.encode(parambalx.h, "UTF-8").replaceAll("\\+", "%20"));
      paramString = str1;
      if (parambalx.i == null) {}
    }
    catch (UnsupportedEncodingException localUnsupportedEncodingException)
    {
      ...
      for (;;)
      {
        try
        {
          paramString = str1.replace("<$CONTENT>", URLEncoder.encode(parambalx.i, "UTF-8").replaceAll("\\+", "%20"));
          return paramString;
        }
  ...
  {
    paramString1 = balx.a().b(paramString2).a(paramString1);
  ...
  {
    paramString3 = balx.a().a(paramString1).b(paramString2).e(paramString3).d("3").c("aio");
  ...
  {
    Object localObject = balx.a().a(paramString);
    if (paramBoolean) {}
    for (paramString = "1";; paramString = "0")
    {
      paramString = ((balx)localObject).f(paramString);
  ...
  {
    paramString = balx.a().a(paramString);
  ...
  public String b(String paramString, balx parambalx)
  {
