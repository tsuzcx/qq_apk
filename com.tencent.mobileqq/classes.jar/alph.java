...
public class alph
  extends alqn<CameraEmotionData>
{
  private ConcurrentHashMap<Integer, CameraEmotionData> a = new ConcurrentHashMap();
  
  public alph(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          ((apno)this.app.getManager(334)).a(localCameraEmotionData);
          ...
          paramToServiceMsg = azri.a(BaseApplication.getContext());
          if (i != 0) {
            break label656;
          }
          bool = true;
  ...
  private void a(List<CameraEmotionRoaming_sso.ImgInfo> paramList, List<alpi> paramList1, List<String> paramList2)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (!bdnn.a(str4))
      {
        ...
        paramList = "";
        label146:
        localalpi.b = paramList;
        if (str2 != null) {
          break label262;
        }
        paramList = "";
        label160:
        localalpi.c = paramList;
        if (str3 != null) {
          break label268;
        }
      }
  ...
  public void a()
  {
    ...
    String str = ((apno)this.app.getManager(334)).a();
    ...
    localReqBody.bytes_version.set(ByteStringMicro.copyFrom("8.3.5".getBytes()));
  ...
  public void a(CameraEmotionData paramCameraEmotionData, int paramInt1, int paramInt2, long paramLong)
  {
    ...
    ((CameraEmotionRoaming_sso.ReqBody)localObject2).bytes_version.set(ByteStringMicro.copyFrom("8.3.5".getBytes()));
  ...
  public void a(CameraEmotionData paramCameraEmotionData, boolean paramBoolean)
  {
    ...
    for (Object localObject1 = "";; localObject1 = paramCameraEmotionData.templateId)
    {
      ...
      ((CameraEmotionRoaming_sso.ReqBody)localObject1).bytes_version.set(ByteStringMicro.copyFrom("8.3.5".getBytes()));
  ...
  public void a(List<String> paramList, boolean paramBoolean)
  {
    ...
    paramList.bytes_version.set(ByteStringMicro.copyFrom("8.3.5".getBytes()));
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    case 3: 
      if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
      {
        ...
        for (paramToServiceMsg = "null";; paramToServiceMsg = Integer.valueOf(paramFromServiceMsg.getResultCode()))
        {
          ...
          aufn.e(String.valueOf(paramFromServiceMsg.getResultCode()), 2);
          return;
        }
        aufn.d("3002", 2);
        return;
    ...
    if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
    {
      ...
      for (paramToServiceMsg = "null";; paramToServiceMsg = Integer.valueOf(paramFromServiceMsg.getResultCode()))
      {
        ...
        aufn.d(String.valueOf(paramFromServiceMsg.getResultCode()), 2);
        return;
      }
      aufn.d("3003", 2);
      return;
