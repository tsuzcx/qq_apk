...
public class ajeu
{
  private static ajeu jdField_a_of_type_Ajeu;
  ...
  public static ajeu a()
  {
    ...
    {
      if (jdField_a_of_type_Ajeu == null) {
        jdField_a_of_type_Ajeu = new ajeu();
      }
      return jdField_a_of_type_Ajeu;
    }
  }
  ...
  private void a(QQAppInterface paramQQAppInterface, List<RecentUser> paramList)
  {
    ...
    if (localArrayList1.size() > 2) {
      ((aloz)paramQQAppInterface.getManager(51)).a(localArrayList1);
    }
    if (localArrayList3.size() > 2) {
      ((almv)paramQQAppInterface.getManager(53)).a(localArrayList3);
    }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Context paramContext, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    label570:
    label576:
    for (Object localObject1 = ((amjk)localObject1).a(true);; localObject1 = null)
    {
      label107:
      int k;
      int j;
      ...
      if (localObject1 == null)
      {
        ...
        RecentBaseData localRecentBaseData = ajfw.a(paramQQAppInterface, paramContext, (RecentUser)localObject2);
      ...
      for (;;)
      {
        ...
        break label107;
        localObject2 = ajdp.a((RecentUser)localObject2, paramQQAppInterface, paramContext, true);
        this.jdField_b_of_type_JavaUtilList.add(localObject2);
      }
      ajfw.a(((List)localObject1).size(), ((List)localObject1).size() - j);
      ...
      for (;;)
      {
        paramContext = new ajfa(paramQQAppInterface);
        ...
        ajdp.a((List)localObject1, paramQQAppInterface, paramContext, this.jdField_b_of_type_JavaUtilList, k);
