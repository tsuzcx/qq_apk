...
final class arrm
{
  ...
  public static arrm a(araj[] paramArrayOfaraj)
  {
    Object localObject1;
    ...
    arrm localarrm = new arrm();
    int j = paramArrayOfaraj.length;
    int i = 0;
    for (;;)
    {
      localObject1 = localarrm;
      if (i >= j) {
        break;
      }
      ...
      try
      {
        ...
        if (localObject1 != null)
        {
          if (((JSONObject)localObject1).has("has_gray")) {
            localarrm.jdField_a_of_type_Boolean = ((JSONObject)localObject1).optBoolean("has_gray");
          }
          a((JSONObject)localObject1, localarrm.jdField_a_of_type_JavaUtilMap);
        }
        i += 1;
      }
  ...
  public static void a(boolean paramBoolean, arrm paramarrm)
  {
    if (paramarrm == null) {
    ...
    {
      return;
      if (!paramarrm.jdField_a_of_type_JavaUtilMap.isEmpty()) {}
      for (i = 1;; i = 0)
      {
        if (i != 0) {
          TdsReaderGlobal.a(paramBoolean, paramarrm.jdField_a_of_type_JavaUtilMap);
        }
        if (!paramarrm.jdField_a_of_type_Boolean) {
          break;
        }
        arrp.a();
        return;
