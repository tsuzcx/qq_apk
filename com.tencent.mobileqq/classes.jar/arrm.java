...
public class arrm
  extends arrj
{
  public arrm(MsgBackupResEntity paramMsgBackupResEntity)
  {
  ...
  public arpi a()
  {
    ...
    if (str1 == null)
    {
      ...
      localarpi.jdField_a_of_type_Boolean = false;
      return localarpi;
    }
    String str2 = a(str1);
    ...
    localarpi.jdField_a_of_type_Boolean = bool1;
    localarpi.jdField_a_of_type_JavaLangString = str2;
    return localarpi;
  }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (!TextUtils.isEmpty(str1))
        {
          try
          {
            paramMsgBackupResEntity = axoa.d(new URL(paramMsgBackupResEntity, null, str1).toString());
  ...
  public String a(String paramString)
  {
    try
    {
      ...
      paramString = arrw.b + paramString;
      return paramString;
    }
