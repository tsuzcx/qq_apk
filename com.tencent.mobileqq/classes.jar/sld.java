  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public sld(DiscussionMemberActivity paramDiscussionMemberActivity)
  {
  ...
  private void a()
  {
    ...
    {
      slc localslc = (slc)((Iterator)localObject2).next();
      if ((localslc.c == null) || (localslc.c.length() == 0))
      {
        localObject1 = "#";
      ...
      for (localObject1 = ((String)localObject1).toUpperCase();; localObject1 = "#")
      {
        ...
        ((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(localObject1)).add(localslc);
        break;
        localObject1 = localslc.c.substring(0, 1);
        break label66;
      }
    }
  ...
  public Object getItem(int paramInt)
  {
    ...
    i = -(i + 1) - 1;
    return (slc)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivityDiscussionMemberActivity.getLayoutInflater().inflate(2130968944, paramViewGroup, false);
      ...
      paramView.c = ((ImageView)localView.findViewById(2131364340));
      paramView.b = ((TextView)localView.findViewById(2131363549));
    }
    paramView = (TroopMemberListActivity.ViewHolder)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
      paramViewGroup = (slc)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
