...
public class bcbo
{
  ...
  public static void a(List<BaseInterface> paramList, WebView paramWebView, String paramString, aqrc paramaqrc)
  {
    if (!bcdy.a(paramString))
    {
      Iterator localIterator = paramList.iterator();
      while (localIterator.hasNext())
      {
        BaseInterface localBaseInterface = (BaseInterface)localIterator.next();
        paramaqrc.a(localBaseInterface, localBaseInterface.getInterfaceName());
        bcbf.a.put(localBaseInterface.getInterfaceName(), localBaseInterface.getClass());
        localBaseInterface.setCurrentUrl(paramString);
      }
    }
