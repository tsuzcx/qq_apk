...
public class bcbo
  extends aogk
{
  public bcbo(ActiveEntitySearchFragment paramActiveEntitySearchFragment) {}
  ...
  public void handleTabSearchError(String paramString1, boolean paramBoolean, String paramString2, int paramInt, String paramString3, long[] paramArrayOfLong)
  {
    ...
    for (;;)
    {
      try
      {
        this.a.jdField_a_of_type_AndroidGraphicsBitmap = BitmapFactory.decodeResource(this.a.getResources(), 2130842378);
        this.a.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(this.a.jdField_a_of_type_AndroidGraphicsBitmap);
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131699278));
        this.a.g.setOnClickListener(new bcbq(this));
      ...
      this.a.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new bcbr(this));
    }
  }
  ...
  public void handleTabSearchResult(String paramString1, boolean paramBoolean1, String paramString2, byte[] paramArrayOfByte, boolean paramBoolean2, List<bcfi> paramList, long[] paramArrayOfLong, String paramString3, List<DynamicTabSearch.SubHotWord> paramList1, boolean paramBoolean3, String paramString4, int paramInt)
  {
    ...
    {
      localObject2 = (bcfi)((Iterator)localObject1).next();
      if (((bcfi)localObject2).a() == null) {
        break label3419;
      }
      ...
      localObject4 = ((bceg)localObject3).a();
      Iterator localIterator = ((List)localObject4).iterator();
      while (localIterator.hasNext())
      {
        Object localObject5 = (bcfj)localIterator.next();
        if ((localObject5 instanceof bceh))
        {
          localObject5 = (bceh)localObject5;
          if (ActiveEntitySearchActivity.b) {
            ((bceh)localObject5).o = 1;
          }
          paramString2.add(Long.valueOf(((bceh)localObject5).d()));
        }
      }
      if (l1 != -1L) {
        break label3413;
      }
      l1 = ((bceg)localObject3).a;
      l2 = ((bceg)localObject3).a;
      if ((((List)localObject4).size() > 0) && (((bceg)localObject3).a == 1001L))
      {
        bdla.b(null, "dc00898", "", "", "0X800A339", "0X800A339", 1, 0, "", "", "", "");
        label572:
        paramInt = i + ((bcfi)localObject2).a().size();
        l3 = l1;
        l1 = l2;
        l2 = l3;
      }
    ...
    for (;;)
    {
      ...
      i = paramInt;
      break label363;
      if ((((List)localObject4).size() > 0) && (((bceg)localObject3).a == 1002L)) {
        bdla.b(null, "dc00898", "", "", "0X800A339", "0X800A339", 2, 0, "", "", "", "");
      }
      break label572;
      ...
      if (!paramBoolean1)
      {
        ...
        bcnc.a("sub_result", "load_result", new String[] { this.a.jdField_b_of_type_JavaLangString, bcnc.a(paramString3), "", bcnc.a("dynamic_tab_search.1", this.a.jdField_a_of_type_ArrayOfLong) });
      }
      ...
      {
        bool1 = true;
        bcmx.a(paramString2, paramList, bool1, this.a.jdField_a_of_type_ArrayOfLong, this.a.jdField_e_of_type_JavaLangString, this.a.jdField_b_of_type_JavaLangString);
        if (i != 0) {
          break label1347;
        }
        if ((this.a.getActivity() instanceof bbzj)) {}
        switch (((bbzj)this.a.getActivity()).a())
        {
        case 2: 
        default: 
          if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        bool1 = false;
        break;
        bcnc.a("sub_result", "no_result", new String[] { this.a.jdField_b_of_type_JavaLangString, bcnc.a(this.a.jdField_a_of_type_ArrayOfLong), "", bcnc.a("dynamic_tab_search.1", paramArrayOfLong) });
        break label892;
        bcnc.a("all_result", "exp_tab_empty", new String[] { this.a.jdField_b_of_type_JavaLangString, bcnc.a(this.a.jdField_a_of_type_ArrayOfLong), "", bcnc.a("dynamic_tab_search.1", paramArrayOfLong) });
        break label892;
        if ((this.a.jdField_a_of_type_ArrayOfByte != null) || (!(this.a.getActivity() instanceof bbzj))) {
          break label892;
        }
        paramString2 = (bbzj)this.a.getActivity();
        ...
        default: 
          break;
        case 1: 
          bcnc.a("all_result", "exp_tab_page", new String[] { this.a.jdField_b_of_type_JavaLangString, bcnc.a(this.a.jdField_b_of_type_JavaUtilList), "", bcnc.a("UnifySearch.Unite", paramString2.a()) });
          break;
        case 3: 
          bcnc.a("sub_result", "exp_result", new String[] { paramString2.a(), bcnc.a(this.a.jdField_b_of_type_JavaUtilList), "", bcnc.a("dynamic_tab_search.1", paramString2.a()) });
          break;
          if (QLog.isColorLevel()) {
      ...
      if ((!TextUtils.isEmpty(ActiveEntitySearchFragment.a(this.a))) && (ActiveEntitySearchFragment.a(this.a).size() > 0))
      {
        ...
        while (paramString4.hasNext())
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject2))
          {
            ...
            for (;;)
            {
              ...
              ((TextView)localObject3).setTag(2131368331, localObject1);
        ...
        if (this.a.jdField_a_of_type_AndroidWidgetLinearLayout.getChildCount() == 0)
        {
          ...
          paramString2 = bbzq.a(paramList, paramBoolean1, this.a.jdField_f_of_type_Boolean);
          if ((paramBoolean1) || (l1 != ActiveEntitySearchFragment.a(this.a)) || (paramBoolean3) || (paramString2 == null) || (paramString2.size() <= 0)) {
            break label2428;
          }
          paramArrayOfByte = (bcfh)this.a.jdField_a_of_type_JavaUtilList.get(this.a.jdField_a_of_type_JavaUtilList.size() - 1);
          ...
          if (!((bcfh)paramString2.get(paramInt) instanceof bceq)) {
            break label2415;
          }
        }
      }
      for (;;)
      {
        if ((paramArrayOfByte instanceof bcfj))
        {
          paramArrayOfByte = (bcfj)paramArrayOfByte;
          j = paramArrayOfByte.a();
          bcnf.a(paramArrayOfByte, j + paramInt, j - 1);
        }
        for (;;)
        {
          k = 0;
          for (;;)
          {
            if (k < paramInt)
            {
              paramArrayOfByte = (bcfh)paramString2.get(k);
              if ((paramArrayOfByte instanceof bcfj)) {
                bcnf.a((bcfj)paramArrayOfByte, j + paramInt, j + k);
              }
              k += 1;
              continue;
          ...
          this.a.jdField_a_of_type_Bcbj.a(this.a.jdField_a_of_type_JavaUtilList);
          ...
          for (;;)
          {
            ...
            {
              this.a.g.setVisibility(0);
              paramString3 = (anyb)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MAYKNOW_RECOMMEND_MANAGER);
              if ((!bool1) && (paramString3.jdField_d_of_type_Boolean)) {
                if (this.a.jdField_a_of_type_Ajdc == null)
                {
                  this.a.jdField_a_of_type_Ajdc = new ajdg(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.getActivity(), this.a.jdField_b_of_type_ComTencentWidgetXListView, null);
                  paramString2 = this.a.jdField_a_of_type_Ajdc.a();
                  ...
                  paramArrayOfByte.setTextColor(this.a.getResources().getColor(2131167110));
                  paramArrayOfByte.setTextSize(1, 17.0F);
                  paramArrayOfByte.setText(anvx.a(2131699282));
                  paramArrayOfByte.setBackgroundResource(2130838912);
                  ...
                  paramArrayOfByte.setText(anvx.a(2131699280));
                  paramArrayOfByte.setBackgroundResource(2130838912);
                  paramString2.addHeaderView(paramArrayOfByte);
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                this.a.jdField_a_of_type_Bcbj.a(this.a.jdField_a_of_type_JavaUtilList);
                break;
                this.a.jdField_a_of_type_Ajdc.e();
                break label2973;
                ...
                try
                {
                  ...
                  this.a.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131699273));
                  if (bool1)
                  {
                    this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
                    this.a.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new bcbp(this, paramString2));
