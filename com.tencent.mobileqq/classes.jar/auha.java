  ...
  implements augg
{
  ...
  augy jdField_a_of_type_Augy;
  public boolean a;
  
  public auha(HotPicPageView paramHotPicPageView, augy paramaugy)
  {
    this.jdField_a_of_type_Augy = paramaugy;
  }
  
  public RecyclerView.ViewHolder a(ViewGroup paramViewGroup, int paramInt)
  {
    return new auhe(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView, LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_AndroidContentContext).inflate(2131558616, paramViewGroup, false), null);
  }
  ...
  public void a(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    {
      augn.a(this.jdField_a_of_type_ComTencentMobileqqHotpicHotPicPageView.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(paramInt);
      this.jdField_a_of_type_Boolean = true;
    }
    if (this.jdField_a_of_type_Int == 1)
    {
      paramViewHolder.itemView.findViewById(2131368200).setVisibility(0);
      paramViewHolder.itemView.findViewById(2131368201).setVisibility(4);
      return;
    }
    if (HotPicPageView.b())
    {
      paramViewHolder.itemView.findViewById(2131368201).setVisibility(0);
      paramViewHolder.itemView.findViewById(2131368200).setVisibility(8);
      return;
    }
