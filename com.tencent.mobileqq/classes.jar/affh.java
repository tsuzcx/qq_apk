  ...
  extends BaseAdapter
{
  ...
  private affh(ClassificationSearchFragment paramClassificationSearchFragment) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          if (paramView == null)
          {
            paramView = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2131560578, paramViewGroup, false);
            ...
            paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131378599));
            paramViewGroup.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365040));
            paramViewGroup.d = ((TextView)paramView.findViewById(2131369515));
            ...
            paramView.setTag(2131369772, Integer.valueOf(paramInt));
        ...
        if (paramView == null)
        {
          paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2131561052, null);
          paramView = new afgi();
        ...
        paramView = (afgi)paramViewGroup.getTag();
        ...
        try
        {
          ...
          if ((((AccountSearchPb.record)localObject1).brief.has()) && (!"".equals(((AccountSearchPb.record)localObject1).brief.get()))) {
            if (this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a(paramView.jdField_a_of_type_AndroidWidgetTextView, this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a()) > 1)
            {
              ...
              paramViewGroup.setLayoutParams(new AbsListView.LayoutParams(new AbsListView.LayoutParams(-1, actj.a(110.0F, this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getResources()))));
              localObject2 = (ImageView)paramViewGroup.findViewById(2131379362);
              ((ImageView)localObject2).setVisibility(4);
              ImageView localImageView = (ImageView)paramViewGroup.findViewById(2131364798);
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            ...
            paramViewGroup.setLayoutParams(new AbsListView.LayoutParams(new AbsListView.LayoutParams(-1, actj.a(90.0F, this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getResources()))));
          }
        }
        paramViewGroup = paramView;
        if (paramView == null)
        ...
        localObject1 = (affg)paramViewGroup.getTag();
        ...
        if (!this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.jdField_a_of_type_Boolean)
        {
          ...
          ((affg)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
          ((affg)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131701923));
          return paramViewGroup;
        }
      ...
      ((affg)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
      ((affg)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131701932));
      ...
      {
        ((affg)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
        ((affg)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131701940));
        return paramViewGroup;
      }
      paramView = paramViewGroup;
    ...
    ((affg)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
    ((affg)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131701936));
    return paramViewGroup;
  }
