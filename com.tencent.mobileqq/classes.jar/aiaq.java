  ...
  extends BaseAdapter
{
  ...
  xam jdField_a_of_type_Xam;
  boolean jdField_a_of_type_Boolean = false;
  boolean b = true;
  
  public aiaq(Context paramContext, JSONArray paramJSONArray, xam paramxam)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Xam = paramxam;
  ...
  public void c()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      if (this.jdField_a_of_type_Xam != null)
      {
        this.jdField_a_of_type_Xam.a("com.tencent.biz.hotchatpostlist.widget.HotChatPostItemView");
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if ((paramView == null) && (this.jdField_a_of_type_Boolean)) {
      paramView = this.jdField_a_of_type_Xam.a("com.tencent.biz.hotchatpostlist.widget.HotChatPostItemView");
    }
    for (;;)
    {
      ...
      if (paramView != null) {
        paramViewGroup.setOnClickListener(new aias(this, paramView.optString("bid"), paramView.optString("pid")));
      }
      try
      {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        xam.a(paramViewGroup, paramView.toString());
        return paramViewGroup;
      }
    }
  }
  ...
  {
    Collections.sort(this.jdField_a_of_type_JavaUtilArrayList, new aiar(this));
