...
public class sni
{
  ...
  public static int a()
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      return ((QQAppInterface)localObject).a().a().a(ajsf.aP, 1008);
    }
    return 0;
  }
  ...
  private static Bitmap a(URL paramURL, ImageView paramImageView)
  {
    if ((paramURL != null) && (paramImageView.getWidth() > 0))
    {
      ...
      localrpk.jdField_a_of_type_Int = paramImageView.getWidth();
      localrpk.b = paramImageView.getHeight();
      paramURL = bbci.a(localrpk.a());
      if (paramURL != null) {
        return paramURL.a();
      }
    }
  ...
  {
    Object localObject = a();
    if (a((otp)localObject))
    {
      localObject = ((otp)localObject).a();
      sne.d("WSPushLog", "WSRedDotPushMsg = " + (String)localObject);
  ...
  public static otp a()
  {
    ...
    {
      localObject = (QQAppInterface)localObject;
      if ((((QQAppInterface)localObject).getManager(274) instanceof otp)) {
        return (otp)((QQAppInterface)localObject).getManager(274);
      }
    }
    return null;
  }
  ...
  public static void a()
  {
    ...
    if (localotp != null)
    {
      ...
      localstSimpleMetaFeed.id = localotp.c();
      localstSimpleMetaFeed.feed_desc = localotp.d();
      localotp.a(localstSimpleMetaFeed);
    }
  }
  ...
  public static void a(Context paramContext, KandianUrlImageView paramKandianUrlImageView, URL paramURL)
  {
    ...
    paramContext = paramContext.getResources().getDrawable(2130841262);
    if (paramURL == null)
    {
    ...
    paramKandianUrlImageView.setPublicAccountImageDownListener(new snj(paramKandianUrlImageView));
  }
  ...
  public static void a(Context paramContext, RoundImageView paramRoundImageView, String paramString)
  {
    ...
    paramContext = new rpk();
    paramContext.jdField_a_of_type_JavaNetURL = paramString;
    rpj.a().a(paramContext, new snk(paramRoundImageView));
  }
  
  public static void a(Context paramContext, String paramString1, String paramString2, int paramInt, snn paramsnn)
  {
    if (paramsnn == null) {
    ...
    if (vzz.a(paramContext))
    {
      ...
      {
        sne.c("815", "走打开shemeUrl:" + paramString1);
        paramsnn.a(paramString1, paramInt);
        return;
      }
      if (!TextUtils.isEmpty(paramString2))
      {
        sne.c("815", "走打开h5Url:" + paramString2);
        paramsnn.b(paramString2, paramInt);
        return;
      }
      sne.c("815", "走打开兜底:" + paramString1);
      paramsnn.a("weishi://main", paramInt);
      return;
    }
    if (!TextUtils.isEmpty(paramString2))
    {
      sne.c("815", "走跳转h5Url:" + paramString2);
      paramsnn.b(paramString2, paramInt);
      return;
    }
    sne.c("815", "走下载，shemeUrl:" + paramString1);
    paramsnn.c(paramString1, paramInt);
  }
  ...
  public static void a(Context paramContext, ArrayList<stSimpleMetaFeed> paramArrayList, int paramInt1, String paramString, stGlobalConfig paramstGlobalConfig, WSRedDotPushMsg paramWSRedDotPushMsg, int paramInt2)
  {
    ...
    try
    {
      ...
      sjt.jdField_a_of_type_Boolean = true;
      return;
    }
    catch (NumberFormatException paramString)
    {
      for (;;)
      {
        sne.b("openVerticalVideoLayerPage parseLong posterId : " + paramString);
      }
    }
  }
  ...
  public static void a(ImageView paramImageView, String paramString1, Drawable paramDrawable1, Drawable paramDrawable2, String paramString2)
  {
    ...
    paramImageView.setImageDrawable(paramDrawable1);
    paramDrawable1.setURLDrawableListener(new snl(paramString2, paramImageView, paramString1));
  ...
  public static void a(KandianUrlImageView paramKandianUrlImageView, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    {
      sne.b("WeishiUtils", "使用webp图片资源：" + (String)localObject1);
    ...
    if (paramstSimpleMetaFeed.images != null)
    {
      ...
      if (paramstSimpleMetaFeed.images.size() > 0)
      {
        ...
        sne.b("WeishiUtils", "使用服务器默认的图片格式资源：" + (String)localObject2);
      }
    }
  ...
  public static void a(KandianUrlImageView paramKandianUrlImageView, String paramString)
  {
    ...
    {
      paramString = a(paramString);
      paramKandianUrlImageView.a(BaseApplicationImpl.getApplication().getApplicationContext().getResources().getDrawable(2130841347)).a(paramString);
    }
  }
  ...
  public static void a(BusinessInfoCheckUpdate.AppInfo paramAppInfo, boolean paramBoolean)
  {
    ...
    {
      sne.b("WSRedDotLog", "saveRedDotAppInfo appInfo = " + paramAppInfo.iNewFlag.get());
      sne.b("WSRedDotLog", "saveRedDotAppInfo hasWsRedDot = " + paramBoolean);
  ...
  public static void a(String paramString)
  {
    ...
    if ((localClipboardManager != null) && (!TextUtils.isEmpty(paramString)))
    {
      ...
      sne.d("WeishiUtils", "Clipboard copyScheme: " + paramString + ", clip: " + localClipData);
  ...
  public static void a(List<stSimpleMetaFeed> paramList)
  {
    ...
    sne.b("PreloadCoverImgLog", "preloadImg size = " + paramList.size());
  ...
  private static boolean a(MessageForStructing paramMessageForStructing)
  {
    ...
    {
      return false;
      sne.d("WSPushLog", "isMsgFromWeishiPush structMsg.frienduin: " + paramMessageForStructing.frienduin);
    } while ((!TextUtils.equals(ajsf.aP, paramMessageForStructing.frienduin)) || (paramMessageForStructing.issend != 0));
    return true;
  }
  ...
  {
    return paramString + "&idx=" + skb.a().e();
  }
  ...
  public static String e()
  {
    ...
    {
      sne.d("WeishiUtils", "getWifiBssid : " + localException.toString());
    }
    return "";
  }
}
