  ...
  implements VComponentAdapter
{
  ...
  private void a(ImageAction paramImageAction, String paramString, int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    paramString.setURLDrawableListener(new snk(this, paramBoolean1, paramImageAction));
  }
      ...
      if (paramString.contains("item_width"))
      {
        ...
        if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (!TextUtils.isEmpty(str))) {
          try
          {
            ...
            localObject1 = new sfg();
            ((sfg)localObject1).jdField_a_of_type_JavaNetURL = new URL((String)localObject2);
            ((sfg)localObject1).jdField_a_of_type_Int = i;
            ((sfg)localObject1).b = j;
            localObject2 = sff.a().a((sfg)localObject1);
            if ((localObject2 != null) && (((sfc)localObject2).a() != null))
            {
              localObject1 = null;
              if (paramBoolean)
              {
              ...
              paramImageAction.onSuccess(((sfc)localObject2).a(), paramString, (Bundle)localObject1);
              return true;
            }
          }
