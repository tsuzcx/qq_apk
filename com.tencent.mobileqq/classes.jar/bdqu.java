  ...
  implements AsyncResult
{
  ...
  public void onReceiveResult(boolean paramBoolean, JSONObject paramJSONObject)
  {
    if ((paramBoolean) && (paramJSONObject != null))
    {
      ...
      bdnw.a("MiniAppInfoLoadTask", "getAppInfoByLink, retCode = " + l + ",errMsg = " + (String)localObject);
      if (l != 0L)
      {
        if ((TextUtils.isEmpty((CharSequence)localObject)) && (bdyl.a())) {
      ...
      {
        ((MiniAppInfo)localObject).launchParam.a(bdqs.a(this.a).launchParam);
        ((MiniAppInfo)localObject).apkgInfo = bdqs.a(this.a).apkgInfo;
        ...
        bdqs.a(this.a, (MiniAppInfo)localObject);
        this.a.c();
        return;
      }
      ...
      if (localObject == null) {
        bdnw.d("MiniAppInfoLoadTask", "getAppInfoByLink  onCmdListener appinfo==null retCode= " + l);
      }
      for (;;)
      {
        this.a.f();
        return;
        bdnw.d("MiniAppInfoLoadTask", "getAppInfoByLink  onCmdListener retCode= " + l + " appid=" + ((MiniAppInfo)localObject).appId);
      }
    }
    bdsx.a(bdqs.a(this.a), "1", null, "load_fail", "shortcut_request_fail");
    bdsc.a("2launch_fail", "shotcut_request_fail", null, bdqs.a(this.a));
