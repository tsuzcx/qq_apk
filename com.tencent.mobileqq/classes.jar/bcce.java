...
public class bcce
{
  ...
  public void a()
  {
    if ((this.jdField_a_of_type_AndroidViewView != null) && (8 == this.c.getVisibility())) {
      if (this.jdField_a_of_type_Bcfx.jdField_a_of_type_AndroidAppActivity == null) {
        break label91;
      }
    }
    label91:
    for (DisplayMetrics localDisplayMetrics = this.jdField_a_of_type_Bcfx.jdField_a_of_type_AndroidAppActivity.getResources().getDisplayMetrics();; localDisplayMetrics = BaseApplicationImpl.getContext().getResources().getDisplayMetrics())
    {
      this.jdField_a_of_type_Int = localDisplayMetrics.widthPixels;
      this.jdField_b_of_type_Int = localDisplayMetrics.heightPixels;
      if ((this.jdField_a_of_type_Bcga == null) || (!this.jdField_a_of_type_Bcga.d) || (!this.jdField_a_of_type_Bcga.F)) {
        break;
      }
      c();
      return;
  ...
  {
    if (bfyf.a(paramActivity))
    {
      paramActivity = paramActivity.findViewById(16908290);
      paramActivity.addOnLayoutChangeListener(new bcci(this, paramActivity));
    }
  }
  ...
  public void a(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Bcga.jdField_c_of_type_Boolean) {
    ...
    for (;;)
    {
      ...
      label320:
      label326:
      for (int k = 2130842113;; k = 2130842112)
      {
  ...
  public void a(View paramView, View.OnClickListener paramOnClickListener)
  {
    ...
    if (this.jdField_a_of_type_Bcfx.jdField_a_of_type_AndroidAppActivity != null)
    {
      localDisplayMetrics = this.jdField_a_of_type_Bcfx.jdField_a_of_type_AndroidAppActivity.getResources().getDisplayMetrics();
      if (!this.jdField_a_of_type_Bcga.d) {
        break label557;
      }
      ...
      this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131363403);
      this.d = paramView.findViewById(2131365777);
      this.f = paramView.findViewById(2131376005);
      this.g = paramView.findViewById(2131375866);
      this.h = paramView.findViewById(2131370397);
      this.e = paramView.findViewById(2131366505);
      this.i = paramView.findViewById(2131369803);
      this.jdField_a_of_type_ComTencentBizWebviewpluginHole = ((Hole)paramView.findViewById(2131367544));
      b();
      if (this.jdField_a_of_type_Bcga.jdField_c_of_type_Boolean) {
        a(paramView);
      }
      if ((this.jdField_a_of_type_Bcga.jdField_c_of_type_Long & 1L) != 0L)
      {
        this.f.setVisibility(0);
        this.jdField_a_of_type_AndroidViewView.setVisibility(0);
      }
      if ((this.jdField_a_of_type_Bcga.jdField_c_of_type_Long & 0x4) != 0L)
      {
        this.d.setVisibility(0);
        this.jdField_a_of_type_AndroidViewView.setVisibility(0);
      }
      if ((this.jdField_a_of_type_Bcga.jdField_c_of_type_Long & 0x2) != 0L)
      {
        this.h.setVisibility(0);
        this.jdField_a_of_type_AndroidViewView.setVisibility(0);
      }
      if ((((this.jdField_a_of_type_Bcga.b & 0x800) != 0L) || ((this.jdField_a_of_type_Bcga.a & 0x80000000) != 0L)) && (this.jdField_a_of_type_Bcfx.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (mvs.a().j(this.jdField_a_of_type_Bcfx.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.h)))
      {
      ...
      paramView.getViewTreeObserver().addOnGlobalLayoutListener(new bccf(this, paramView, localDisplayMetrics));
    }
    for (;;)
    {
      paramView = new bccg(this, localDisplayMetrics);
  ...
  public void a(View paramView, boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Bcga.jdField_c_of_type_Boolean)
    {
      paramView.setBackgroundResource(2130842106);
      return;
    }
    if (this.jdField_a_of_type_Bcga.F)
    {
      paramView.setBackgroundResource(2130842108);
      return;
    }
    if (paramBoolean)
    {
    ...
    paramView.setBackgroundResource(2130842097);
  }
  ...
  public void b()
  {
    if ((this.jdField_a_of_type_Bcga != null) && (this.jdField_a_of_type_Bcga.d) && (this.jdField_a_of_type_Bcga.F) && (this.jdField_a_of_type_AndroidViewView != null) && (8 == this.c.getVisibility())) {
      c();
    }
  }
