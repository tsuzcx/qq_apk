  ...
  implements Handler.Callback, Manager
{
  ...
  public String a;
  private Vector<WeakReference<aowr>> jdField_a_of_type_JavaUtilVector = new Vector();
  private boolean jdField_a_of_type_Boolean;
  private Handler b;
  
  public aowd(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_JavaLangString = aovr.a();
    ...
    this.jdField_a_of_type_Aovz = new aovz(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this);
  }
  ...
  public ArDownloadInfo a(String paramString)
  {
    ...
    //   16: areturn
    //   17: aload_0
    //   18: getfield 102	aowd:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   21: ldc 167
    //   23: aload_1
    ...
    for (;;)
    {
      try
      {
        if (paramInt2 < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          {
            ((aowr)((WeakReference)localObject1).get()).a(paramInt1);
          }
        }
        else
        {
    ...
    for (;;)
    {
      try
      {
        if (i < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          {
            ((aowr)((WeakReference)localObject1).get()).a(paramLong1, paramLong2);
          }
        }
        else
        {
  ...
  public void a(aowr paramaowr)
  {
    if (paramaowr != null) {
      this.jdField_a_of_type_JavaUtilVector.add(new WeakReference(paramaowr));
    }
  }
    ...
    for (;;)
    {
      try
      {
        if (i < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          ((aowr)((WeakReference)localObject2).get()).a(paramArConfigInfo);
          break label600;
        }
    ...
    for (;;)
    {
      try
      {
        if (i < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          ((aowr)((WeakReference)localObject).get()).a(paramArEffectConfig);
          break label134;
        }
        return;
      }
  ...
  public void a(ArDownloadInfo paramArDownloadInfo)
  {
    ...
    //   8: return
    //   9: aload_0
    //   10: getfield 102	aowd:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    ...
    //   21: aload_0
    //   22: getfield 102	aowd:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   25: aload_1
  ...
  public boolean a()
  {
    boolean bool1 = false;
    boolean bool2 = true;
    if (this.jdField_a_of_type_Aovs == null) {}
    for (int i = 3; i == 1; i = this.jdField_a_of_type_Aovs.a) {
      return true;
    }
  ...
  public boolean a(ArConfigInfo paramArConfigInfo)
  {
    ...
    //   34: aload_1
    //   35: aload_0
    //   36: getfield 34	aowd:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   39: invokevirtual 183	com/tencent/common/app/AppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   42: invokestatic 475	com/tencent/mobileqq/ar/aidl/ArConfigInfo:saveArConfigToFile	(Lcom/tencent/mobileqq/ar/aidl/ArConfigInfo;Ljava/lang/String;)Z
    //   45: ifeq +14 -> 59
    //   48: aload_0
    //   49: aload_1
    //   50: putfield 131	aowd:jdField_a_of_type_ComTencentMobileqqArAidlArConfigInfo	Lcom/tencent/mobileqq/ar/aidl/ArConfigInfo;
    //   53: iconst_1
    //   54: istore_2
    //   55: aload_0
    //   56: monitorexit
  ...
  public boolean a(String paramString)
  {
    ...
    do
    {
      ...
      {
        return bool1;
        i = this.jdField_a_of_type_Aovs.b;
        break;
        j = this.jdField_a_of_type_Aovs.c;
        break label55;
      }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqArAidlArEffectConfig != null)
    {
      ...
      aoqx.a().a(this.jdField_a_of_type_ComTencentMobileqqArAidlArEffectConfig);
    }
    ArEffectConfig.a();
  }
    ...
    for (;;)
    {
      try
      {
        if (i < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          else if (((WeakReference)localObject).get() == paramaowr)
          {
  ...
  public void b(ArConfigInfo paramArConfigInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    for (;;)
    {
      try
      {
        ...
        if (!bgnt.d(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp()))
        {
          if (!QLog.isColorLevel()) {
            continue;
          }
  ...
  {
    if (this.jdField_a_of_type_Aovs == null) {}
    for (int i = 1; i == 1; i = this.jdField_a_of_type_Aovs.e) {
      return true;
    }
    return false;
  }
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_Aovs == null)
    {
      this.jdField_a_of_type_Aovs = new aovs();
    ...
    try
    {
      ...
      this.jdField_a_of_type_Aovs.a = Integer.valueOf(localObject[4]).intValue();
      this.jdField_a_of_type_Aovs.b = Integer.valueOf(localObject[5]).intValue();
      this.jdField_a_of_type_Aovs.c = Integer.valueOf(localObject[6]).intValue();
      this.jdField_a_of_type_Aovs.jdField_d_of_type_Int = Integer.valueOf(localObject[7]).intValue();
      this.jdField_a_of_type_Aovs.e = Integer.valueOf(localObject[8]).intValue();
      i = 0;
    }
    catch (Exception localException)
    {
    ...
    if (i != 0)
    {
      this.jdField_a_of_type_Aovs.a = 3;
      this.jdField_a_of_type_Aovs.b = 3;
      this.jdField_a_of_type_Aovs.c = 1000;
      this.jdField_a_of_type_Aovs.jdField_d_of_type_Int = 1;
      this.jdField_a_of_type_Aovs.e = 1;
    }
    if (this.jdField_a_of_type_Aovs.jdField_d_of_type_Int == 1)
    {
      ayma.a(bool);
      if (QLog.isColorLevel()) {
        QLog.d("ArConfig_ArResourceManager", 2, "loadDPCConfig|dpc:" + this.jdField_a_of_type_Aovs.toString());
      }
      return;
    }
  }
  ...
  public int d()
  {
    ...
    return this.jdField_a_of_type_Aovs.a;
  }
    ...
    for (;;)
    {
      try
      {
        if (i < this.jdField_a_of_type_JavaUtilVector.size())
        {
          ...
          {
            ((aowr)((WeakReference)localObject1).get()).b();
          }
        }
        else
        {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      aovr.b(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), bool1, i);
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        for (paramMessage = "1";; paramMessage = "0")
        {
          ...
          bctj.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), "olympic_ar_native_so_report", bool1, 0L, 0L, (HashMap)localObject, null);
        ...
        for (;;)
        {
          try
          {
            ...
            if (bgmg.a(((ArCloudConfigInfo)localObject).jdField_a_of_type_ComTencentMobileqqArModelArFeatureInfo.c)) {
              break label432;
            }
            bool1 = false;
            aovr.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), bool1, bool2);
          ...
          {
            bool1 = bgmg.a(((ArCloudConfigInfo)localObject).jdField_a_of_type_ComTencentMobileqqArModelArModelResource.f);
            if (!bool1)
            {
              bool1 = true;
              bool2 = false;
