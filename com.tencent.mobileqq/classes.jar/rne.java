...
public class rne
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "Q.readinjoy.video." + rne.class.getSimpleName();
  ...
  private static String b()
  {
    ...
    //   0: aconst_null
    //   1: astore_2
    //   2: new 293	java/io/InputStreamReader
    //   5: dup
    //   6: new 295	java/io/FileInputStream
    //   9: dup
    //   10: ldc_w 297
    //   13: invokespecial 300	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   16: ldc_w 302
    //   19: invokespecial 305	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/lang/String;)V
    //   22: astore 4
    //   24: new 307	java/io/BufferedReader
    //   27: dup
    //   28: aload 4
    //   30: invokespecial 310	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   33: astore 5
    //   35: aload 5
    //   37: invokevirtual 313	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   40: astore_3
    //   41: aload_3
    //   42: ifnonnull +44 -> 86
    //   45: aload_2
    ...
    //   48: astore_2
    //   49: aload_3
    //   50: invokestatic 213	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   53: ifeq +7 -> 60
    //   56: ldc_w 315
    //   59: astore_2
    //   60: aload 4
    //   62: ifnull +8 -> 70
    //   65: aload 4
    //   67: invokevirtual 318	java/io/InputStreamReader:close	()V
    //   70: aload_2
    //   71: astore_3
    //   72: aload 5
    //   74: ifnull +10 -> 84
    //   77: aload 5
    //   79: invokevirtual 319	java/io/BufferedReader:close	()V
    //   82: aload_2
    //   83: astore_3
    //   84: aload_3
    //   85: areturn
    //   86: aload_3
    //   87: ldc_w 321
    //   90: invokevirtual 324	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   93: ifeq -58 -> 35
    //   96: aload_3
    //   97: bipush 58
    //   99: invokevirtual 327	java/lang/String:indexOf	(I)I
    //   102: istore_0
    //   103: iload_0
    //   104: iconst_1
    //   105: if_icmple -70 -> 35
    ...
    //   110: iconst_1
    //   111: iadd
    //   112: invokevirtual 331	java/lang/String:substring	(I)Ljava/lang/String;
    //   115: invokevirtual 334	java/lang/String:trim	()Ljava/lang/String;
    //   118: ldc_w 336
    //   121: ldc_w 338
    //   124: invokevirtual 342	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   127: astore_3
    //   128: aload_3
    //   129: invokestatic 213	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   132: istore_1
    //   133: aload_3
    //   134: astore_2
    //   135: iload_1
    ...
    //   154: ifnull +8 -> 162
    //   157: aload 4
    //   159: invokevirtual 318	java/io/InputStreamReader:close	()V
    //   162: aload_2
    //   163: ifnull -79 -> 84
    //   166: aload_2
    //   167: invokevirtual 319	java/io/BufferedReader:close	()V
    //   170: ldc_w 315
    //   173: areturn
    //   174: astore_2
    //   175: ldc_w 315
    ...
    //   187: ifnull +8 -> 195
    //   190: aload 4
    //   192: invokevirtual 318	java/io/InputStreamReader:close	()V
    //   195: aload_3
    //   196: ifnull +7 -> 203
    //   199: aload_3
    //   200: invokevirtual 319	java/io/BufferedReader:close	()V
    //   203: aload_2
    //   204: athrow
    //   205: astore_3
    //   206: goto -3 -> 203
  ...
  private static JSONObject b()
  {
    ...
    //   3: dup
    //   4: invokespecial 343	org/json/JSONObject:<init>	()V
    //   7: astore_1
    //   8: aload_1
    //   9: astore_2
    //   10: aload_1
    //   11: ldc_w 345
    //   14: invokestatic 349	bhlo:a	()Ljava/lang/String;
    //   17: invokevirtual 353	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   20: pop
    //   21: aload_1
    //   22: astore_2
    //   23: aload_1
    //   24: ldc_w 355
    //   27: invokestatic 357	bhlo:b	()Ljava/lang/String;
    //   30: invokevirtual 353	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   33: pop
    //   34: aload_1
    //   35: astore_2
    //   36: aload_1
    //   37: ldc_w 359
    //   40: invokestatic 362	bhlo:a	()J
    //   43: invokevirtual 365	org/json/JSONObject:put	(Ljava/lang/String;J)Lorg/json/JSONObject;
    //   46: pop
    //   47: aload_1
    //   48: astore_2
    //   49: aload_1
    //   50: ldc_w 367
    //   53: invokestatic 369	bhlo:b	()I
    //   56: invokevirtual 372	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   59: pop
    //   60: aload_1
    //   61: astore_2
    //   62: aload_1
    //   63: ldc_w 374
    //   66: invokestatic 376	bhlo:a	()I
    //   69: invokevirtual 372	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   72: pop
    //   73: aload_1
    //   74: astore_2
    //   75: aload_1
    //   76: ldc_w 378
    //   79: invokestatic 381	bhlo:d	()Ljava/lang/String;
    //   82: invokevirtual 353	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   85: pop
    //   86: aload_1
    //   87: astore_2
    //   88: aload_1
    //   89: ldc_w 383
    //   92: invokestatic 385	bhlo:e	()Ljava/lang/String;
    //   95: invokevirtual 353	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   98: pop
    //   99: aload_1
    //   100: astore_2
    //   101: aload_1
    //   102: ldc_w 387
    //   105: invokestatic 390	bhlo:h	()Ljava/lang/String;
    //   108: invokevirtual 353	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   111: pop
    //   112: aload_1
    //   113: astore_2
    //   114: aload_1
    //   115: ldc_w 392
    //   118: getstatic 397	android/os/Build$VERSION:SDK_INT	I
    //   121: invokevirtual 372	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   124: pop
    //   125: aload_1
    //   126: astore_2
    //   127: aload_1
    //   128: ldc_w 399
    //   131: invokestatic 402	bhlo:c	()Ljava/lang/String;
    //   134: invokevirtual 353	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   137: pop
    //   138: aload_1
    //   139: astore_2
    //   140: aload_1
    //   141: ldc_w 404
    //   144: invokestatic 406	bhlo:d	()J
    //   147: invokevirtual 365	org/json/JSONObject:put	(Ljava/lang/String;J)Lorg/json/JSONObject;
    //   150: pop
    //   151: aload_1
    //   152: astore_2
    //   153: aload_1
    //   154: ldc_w 408
    //   157: invokestatic 410	bhlo:e	()J
    //   160: invokevirtual 365	org/json/JSONObject:put	(Ljava/lang/String;J)Lorg/json/JSONObject;
    //   163: pop
    //   164: aload_1
    //   165: astore_2
    //   166: invokestatic 413	bhlo:a	()[J
    //   169: astore_3
    //   170: aload_1
    //   171: astore_2
    //   172: aload_1
    ...
    //   177: iconst_0
    //   178: laload
    //   179: invokevirtual 365	org/json/JSONObject:put	(Ljava/lang/String;J)Lorg/json/JSONObject;
    //   182: pop
    //   183: aload_1
    //   184: astore_2
    //   185: aload_1
    ...
    //   190: iconst_1
    //   191: laload
    //   192: invokevirtual 365	org/json/JSONObject:put	(Ljava/lang/String;J)Lorg/json/JSONObject;
    //   195: pop
    //   196: aload_1
    //   197: astore_2
    //   198: aload_1
    //   199: ldc_w 419
    //   202: iconst_1
    //   203: invokevirtual 372	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   206: pop
    //   207: aload_1
    //   208: astore_2
    //   209: invokestatic 420	rne:b	()Ljava/lang/String;
    //   212: astore_3
    //   213: aload_1
    //   214: astore_2
    //   215: aload_1
    //   216: ldc_w 422
    //   219: aload_3
    //   220: invokevirtual 353	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   223: pop
    //   224: aload_1
    //   225: astore_2
    //   226: aload_1
    //   227: ldc_w 424
    //   230: aload_3
    //   231: invokestatic 426	rne:a	(Ljava/lang/String;)Ljava/lang/String;
    //   234: invokevirtual 353	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   237: pop
    //   238: aload_1
    //   239: astore_2
    //   240: getstatic 35	rne:jdField_a_of_type_Int	I
    //   243: iconst_m1
    ...
    //   252: ldc_w 428
    //   255: iload_0
    //   256: invokevirtual 372	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   259: pop
    //   260: aload_1
    //   261: astore_2
    //   262: aload_1
    //   263: ldc_w 430
    //   266: invokestatic 432	rne:a	()F
    //   269: invokestatic 435	java/lang/String:valueOf	(F)Ljava/lang/String;
    //   272: invokevirtual 353	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   275: pop
    //   276: aload_1
    //   277: areturn
    //   278: aload_1
    //   279: astore_2
    //   280: getstatic 35	rne:jdField_a_of_type_Int	I
    //   283: istore_0
    //   284: goto -35 -> 249
    //   287: astore_3
    //   288: aconst_null
    ...
    //   290: aload_1
    //   291: astore_2
    //   292: invokestatic 278	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   295: ifeq +47 -> 342
    //   298: aload_1
    //   299: astore_2
    //   300: getstatic 33	rne:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   303: iconst_2
    ...
    //   317: aload_3
    //   318: invokevirtual 440	java/lang/Throwable:getMessage	()Ljava/lang/String;
    ...
    //   327: invokestatic 442	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   330: aload_1
    //   331: areturn
    //   332: astore_1
    //   333: aload_2
