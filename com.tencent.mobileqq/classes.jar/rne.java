...
public class rne
  implements ISuperPlayer.OnCaptureImageListener, ISuperPlayer.OnErrorListener, ISuperPlayer.OnInfoListener, ISuperPlayer.OnSeekCompleteListener, ISuperPlayer.OnVideoPreparedListener, rnd
{
  ...
  private SparseArray<rmz> jdField_b_of_type_AndroidUtilSparseArray = new SparseArray();
  ...
  public void a(rmz paramrmz, rnb paramrnb)
  {
    try
    {
      int i = this.jdField_a_of_type_ComTencentSuperplayerApiISuperPlayer.captureImageInTime(paramrmz.c, paramrmz.d, paramrmz.e, 0, 0, 300);
      paramrmz.a = i;
      this.jdField_b_of_type_AndroidUtilSparseArray.put(i, paramrmz);
      this.jdField_a_of_type_AndroidUtilSparseArray.put(i, paramrnb);
      if (QLog.isColorLevel()) {
        QLog.d("PlayerCaptureProxy", 2, "PlayerCaptureProxy try capture captureTask:" + paramrmz);
      }
      return;
    }
    catch (IllegalAccessException paramrnb)
    {
      for (;;)
      {
        paramrnb.printStackTrace();
      }
    }
    finally {}
  }
  ...
  public void onCaptureImageFailed(ISuperPlayer paramISuperPlayer, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (paramInt2 < this.jdField_a_of_type_AndroidUtilSparseArray.size())
      {
        ...
        {
          paramISuperPlayer = (rnb)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt1);
  ...
  public void onCaptureImageSucceed(ISuperPlayer paramISuperPlayer, int paramInt1, int paramInt2, int paramInt3, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt2 < this.jdField_a_of_type_AndroidUtilSparseArray.size())
      {
        ...
        {
          paramISuperPlayer = (rnb)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt1);
          rmz localrmz = (rmz)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt1);
          this.jdField_b_of_type_AndroidUtilSparseArray.remove(paramInt1);
          if (paramISuperPlayer != null) {
            paramISuperPlayer.a(paramBitmap, localrmz);
          }
          this.jdField_a_of_type_AndroidUtilSparseArray.remove(paramInt1);
        }
      }
  ...
  {
    bjda.c(new PlayerCaptureProxy.2(this));
  }
}
