...
public class pcn
  implements Handler.Callback, bdmr, Manager
{
  ...
  public pcn(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    if (bhsi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))
    {
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramMessage = (ReadInJoyActivityDAUInfo)this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.find(ReadInJoyActivityDAUInfo.class, (String)localObject3);
        if (paramMessage != null) {
          continue;
        }
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.persistOrReplace(paramMessage);
      }
      else if ((paramMessage.getStatus() == 1001) || (paramMessage.getStatus() == 1002))
      {
        this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.update(paramMessage);
        continue;
        label745:
