...
public class bdov
{
  private static final SparseArray<Class<? extends bdom>> jdField_a_of_type_AndroidUtilSparseArray;
  private static HashMap<String, Class<? extends bdol>> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  
  static
  {
    jdField_a_of_type_JavaUtilHashMap.put("pavideo", bdtd.class);
    jdField_a_of_type_JavaUtilHashMap.put("video", bdts.class);
    jdField_a_of_type_JavaUtilHashMap.put("picture", bdqo.class);
    jdField_a_of_type_JavaUtilHashMap.put("title", StructMsgItemTitle.class);
    jdField_a_of_type_JavaUtilHashMap.put("summary", bdtj.class);
    jdField_a_of_type_JavaUtilHashMap.put("timer", bdtn.class);
    jdField_a_of_type_JavaUtilHashMap.put("hr", bdqq.class);
    jdField_a_of_type_JavaUtilHashMap.put("image", bdqr.class);
    jdField_a_of_type_JavaUtilHashMap.put("more", bdsx.class);
    jdField_a_of_type_JavaUtilHashMap.put("progress", bdth.class);
    jdField_a_of_type_JavaUtilHashMap.put("checklist", bdub.class);
    jdField_a_of_type_JavaUtilHashMap.put("vote", bdud.class);
    jdField_a_of_type_JavaUtilHashMap.put("price", bdtg.class);
    jdField_a_of_type_JavaUtilHashMap.put("button", bdqi.class);
    jdField_a_of_type_JavaUtilHashMap.put("remark", bdti.class);
    jdField_a_of_type_JavaUtilHashMap.put("paaudio", bdsy.class);
    jdField_a_of_type_JavaUtilHashMap.put("textButton", bdtl.class);
    jdField_a_of_type_JavaUtilHashMap.put("content", bdqn.class);
    jdField_a_of_type_JavaUtilHashMap.put("tips", bdqa.class);
    jdField_a_of_type_JavaUtilHashMap.put("live", bdpu.class);
    jdField_a_of_type_JavaUtilHashMap.put("tr", bdtq.class);
    jdField_a_of_type_JavaUtilHashMap.put("td", bdtk.class);
    jdField_a_of_type_JavaUtilHashMap.put("head", bdqh.class);
    jdField_a_of_type_JavaUtilHashMap.put("type", bdtr.class);
    jdField_a_of_type_JavaUtilHashMap.put("tag", bdpy.class);
    jdField_a_of_type_JavaUtilHashMap.put("taglist", bdpz.class);
    jdField_a_of_type_JavaUtilHashMap.put("group", bdpo.class);
    jdField_a_of_type_JavaUtilHashMap.put("groupitem", bdpq.class);
    jdField_a_of_type_JavaUtilHashMap.put("voice", bdqb.class);
    jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
    jdField_a_of_type_AndroidUtilSparseArray.append(0, bdso.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(1, bdqs.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(2, bdre.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(3, bdry.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(4, bdsf.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(5, bdsg.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(6, bdsi.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(7, bdsk.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(8, bdsm.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(9, bdsn.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(10, bdqt.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(11, bdqv.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(12, bdqx.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(18, bdrb.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(19, bdrd.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(20, bdrf.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(21, bdri.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(22, bdrj.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(23, bdrk.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(24, bdrm.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(25, bdrp.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(26, bdrq.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(27, bdrr.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(28, bdrs.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(29, bdrv.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(30, bdrz.class);
    jdField_a_of_type_AndroidUtilSparseArray.append(31, bdsb.class);
  }
  ...
  /* Error */
  public static bdol a(String paramString, int paramInt)
  {
    // Byte code:
    //   0: ldc 212
    //   2: aload_0
    ...
    //   6: ifne +72 -> 78
    //   9: getstatic 18	bdov:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   12: aload_0
    ...
    //   76: aload_3
    //   77: areturn
    //   78: getstatic 143	bdov:jdField_a_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   81: iload_1
  ...
  /* Error */
  public static bdom a(int paramInt)
  {
    // Byte code:
    //   0: getstatic 143	bdov:jdField_a_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   3: iload_0
