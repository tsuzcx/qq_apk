...
public class aelm
  extends aelq
{
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new aeln(this);
  private baxy jdField_a_of_type_Baxy;
  BaseChatPie jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie;
  
  public aelm(QQAppInterface paramQQAppInterface, aelj paramaelj, QQWalletTransferMsgElem paramQQWalletTransferMsgElem, int paramInt, acvf paramacvf)
  {
  ...
  public boolean b()
  {
    ...
    this.jdField_a_of_type_Aelj.b.setText("QQ专属红包");
    return false;
  }
  ...
  public void c()
  {
    ...
    {
      return;
      if (this.jdField_a_of_type_Aelj.g.getVisibility() != 0) {
        this.jdField_a_of_type_Aelj.g.setVisibility(0);
      }
      LinearLayout localLinearLayout = new LinearLayout(this.jdField_a_of_type_AndroidContentContext);
      localLinearLayout.setOrientation(0);
      this.jdField_a_of_type_Aelj.g.addView(localLinearLayout);
      ...
      ((RelativeLayout.LayoutParams)localObject).bottomMargin = baxn.a(this.jdField_a_of_type_AndroidContentContext, 25.0F);
      int k = baxn.a(this.jdField_a_of_type_AndroidContentContext, 1.0F);
      int i;
      ...
      while ((j < 5) && (j < this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.mQQWalletRedPacketMsg.specifyUinList.size()))
      {
        ...
        localLayoutParams.width = baxn.a(this.jdField_a_of_type_AndroidContentContext, 33.0F);
        localLayoutParams.height = baxn.a(this.jdField_a_of_type_AndroidContentContext, 33.0F);
        ((ImageView)localObject).setScaleType(ImageView.ScaleType.FIT_XY);
        if (j > 0) {
          localLayoutParams.leftMargin = i;
        }
        ((ImageView)localObject).setImageDrawable(bayh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(l), (byte)4));
        ((ImageView)localObject).setBackgroundResource(2130846438);
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.mQQWalletRedPacketMsg.specifyUinList.size() == 2) || (this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.mQQWalletRedPacketMsg.specifyUinList.size() == 3)) {
          i = baxn.a(this.jdField_a_of_type_AndroidContentContext, 10.0F);
          ...
          i = -baxn.a(this.jdField_a_of_type_AndroidContentContext, 8.0F);
        } else {
          i = 0;
        }
      }
  ...
  {
    super.h();
    if ((this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg == null) || (this.jdField_a_of_type_ComTencentMobileqqDataQQWalletRedPacketMsg == null) || (this.jdField_a_of_type_Aelj == null) || (this.jdField_a_of_type_Aelj.f == null)) {}
    while ((this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg.isSender()) || (ahfh.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg))) {
      return;
    }
    View localView = new View(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_Aelj.f.setVisibility(0);
    this.jdField_a_of_type_Aelj.f.addView(localView);
    Object localObject = (RelativeLayout.LayoutParams)localView.getLayoutParams();
    ((RelativeLayout.LayoutParams)localObject).width = baxn.a(this.jdField_a_of_type_AndroidContentContext, 33.5F);
    ((RelativeLayout.LayoutParams)localObject).height = baxn.a(this.jdField_a_of_type_AndroidContentContext, 33.5F);
    ((RelativeLayout.LayoutParams)localObject).leftMargin = baxn.a(this.jdField_a_of_type_AndroidContentContext, 10.0F);
    ...
    for (int i = 1;; i = 0)
    {
      if (i != 0)
      {
        localView.setBackgroundResource(2130846441);
      ...
      for (;;)
      {
        ...
        ahiw.a(localView, 0.6F);
        return;
        localView.setBackgroundResource(2130846440);
