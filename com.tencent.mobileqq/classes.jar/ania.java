  ...
  implements Manager
{
  ...
  private HashMap<String, SoftReference<anic>> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  
  public ania(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private anic a(String paramString)
  {
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
      {
        ...
        {
          localObject1 = (anic)((SoftReference)localObject1).get();
          Object localObject2 = localObject1;
          if (localObject1 == null)
          {
            localObject2 = new anic(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, new anib(this));
  ...
  public void a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilHashMap)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = (anic)((SoftReference)localObject2).get();
          if (localObject2 != null) {
            ((anic)localObject2).b(2);
          }
        }
      }
    }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
      {
        ...
        if (paramString != null)
        {
          paramString = (anic)paramString.get();
          if (paramString != null) {
            paramString.a();
          }
          return;
