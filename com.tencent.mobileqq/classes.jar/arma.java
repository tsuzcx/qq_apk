      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          ...
          if ((!Modifier.isStatic(k)) || (!Modifier.isFinal(k)))
          {
            ...
            localObject4 = (arlz)localField.getAnnotation(arlz.class);
            if (localObject4 != null) {
              paramClass = ((arlz)localObject4).a();
            }
  ...
  public static <T> JSONObject a(T paramT)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        Object localObject2 = (arlz)((Field)localObject1).getAnnotation(arlz.class);
        if (localObject2 != null)
        {
          localObject2 = ((arlz)localObject2).a();
