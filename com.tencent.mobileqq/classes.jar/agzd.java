  ...
  implements Manager
{
  ...
  public agzd(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(long paramLong, agzg paramagzg, String paramString, Map<String, String> paramMap)
  {
    if (a())
    {
    ...
    for (long l2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin();; l2 = 0L)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("QWalletConfigManager", 2, "realGetConfig:" + paramLong + "|" + paramagzg + "|" + paramString + "|" + paramMap + "|" + localReqWalletConfig);
      }
      agwt.a(localReqWalletConfig, new agze(this, paramLong, paramagzg, new WeakReference(this)), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      return;
      l1 = 0L;
      break;
    }
  ...
  public static void a(String paramString, agzh paramagzh)
  {
    ...
    {
      ((agzd)localAppRuntime.getManager(245)).c(paramString, paramagzh);
      return;
    }
    ahio.a(paramString, paramagzh);
  }
  ...
  public static void b(String paramString, agzh paramagzh)
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface))
    {
      ((agzd)localAppRuntime.getManager(245)).d(paramString, paramagzh);
      return;
    }
    ahio.b(paramString, paramagzh);
  }
  
  public int a(String paramString, int paramInt, String... paramVarArgs)
  {
    return agza.a(a(paramString), paramInt, paramVarArgs);
  }
  ...
  public agzb a(String paramString)
  {
  ...
  {
    return agza.a(a(paramString1), paramString2, paramVarArgs);
  }
  
  public JSONArray a(String paramString, String... paramVarArgs)
  {
    return agza.a(a(paramString), paramVarArgs);
  }
  ...
  public void a(Map<String, String> paramMap)
  {
    ...
    do
    {
      ...
      agwt.a(paramMap, 1, new agzf(this));
    } while (!QLog.isColorLevel());
  ...
  public void b(int paramInt)
  {
    ...
    try
    {
      String str = ((ahcw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(273)).a();
  ...
  public void c(String paramString, agzh paramagzh)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletConfigQWalletConfig.addUpdateListener(paramString, paramagzh);
  }
  
  public void d(String paramString, agzh paramagzh)
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityQwalletConfigQWalletConfig.removeUpdateListener(paramString, paramagzh);
  }
