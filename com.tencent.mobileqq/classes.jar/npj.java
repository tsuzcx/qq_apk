...
public class npj
{
  ...
  {
    return ((Integer)npi.a(paramAdvertisementInfo.mAdExtInfo, "game_button_type", Integer.valueOf(0))).intValue();
  }
  
  public static long a(qab paramqab, boolean paramBoolean)
  {
    if (!a(paramqab)) {}
    for (;;)
    {
      return -1L;
      if ((paramqab != null) && (paramqab.jdField_a_of_type_Qeq != null) && (paramqab.jdField_a_of_type_Qeq.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null) && (paramqab.jdField_a_of_type_Qeq.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a != null))
      {
        paramqab = paramqab.jdField_a_of_type_Qeq.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a;
        try
        {
          paramqab = new JSONObject(paramqab.v);
          if (paramqab != null)
          {
            paramqab = paramqab.optJSONObject("GesturesAd_info");
            if (paramqab != null)
            {
              if (paramBoolean) {
                return paramqab.optInt("showGesturesAd_beginTime");
              }
              int i = paramqab.optInt("showGesturesAd_endTime");
              return i;
            }
          }
        }
        catch (Exception paramqab)
        {
          paramqab.printStackTrace();
        }
      }
    }
    return -1L;
  ...
  public static ShapeDrawable a(int paramInt, Context paramContext)
  {
    ...
    float f9 = aciy.a(1.0F, paramContext.getResources());
    float f1 = 6;
    float f2 = 6;
    float f3 = 6;
    float f4 = 6;
    ...
    do
    {
      do
      {
        for (;;)
        {
          ...
          if (paramVideoInfo != null)
          {
            ...
            if (paramVideoInfo.a != null)
            {
              ...
              if (a(paramVideoInfo.a)) {
                localObject1 = paramResources.getText(2131652637).toString();
              }
            }
          }
          ...
          try
          {
            if (bady.a(paramActivity, new JSONObject(paramVideoInfo.a.r).optString("pkg_name"))) {
              return paramResources.getText(2131652634).toString();
            }
            paramActivity = (Activity)localObject1;
            if (TextUtils.isEmpty((CharSequence)localObject1))
            {
              paramActivity = paramResources.getText(2131652632).toString();
              return paramActivity;
            }
          }
      ...
      return paramResources.getText(2131652632).toString();
      paramActivity = (Activity)localObject1;
    } while (!TextUtils.isEmpty((CharSequence)localObject1));
    return paramResources.getText(2131652671).toString();
  }
  ...
  public static String a(AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    Object localObject1 = ajjy.a(2131647054);
    for (;;)
    {
      try
      {
        if (npm.a(paramAdvertisementInfo))
        {
          str = ajjy.a(2131647087);
          localObject1 = str;
        }
      }
      catch (JSONException paramAdvertisementInfo)
      {
        try
        {
          ...
          paramAdvertisementInfo = BaseApplicationImpl.getContext().getResources().getString(2131652632);
          return paramAdvertisementInfo;
        }
        catch (JSONException paramAdvertisementInfo)
        {
  ...
  public static String a(String paramString)
  {
    ...
    if ((i > 0) && (i <= 2)) {
      return ajjy.a(2131646921) + paramString;
    }
    return BaseApplicationImpl.getContext().getResources().getString(2131652634);
  }
  ...
  public static JSONObject a(Context paramContext, AdvertisementInfo paramAdvertisementInfo, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        if (!nbe.a(paramContext, new JSONObject(paramAdvertisementInfo.mAdExt).optString("pkg_name"))) {
          break label102;
        }
        i = 2;
  ...
  public static void a()
  {
    ...
    if ((localObject != null) && ((localObject instanceof nmy))) {
      try
      {
        localObject = (nmy)localObject;
        int i;
        JSONObject localJSONObject1;
        JSONObject localJSONObject2;
        if (((nmy)localObject).a())
        {
          i = nbe.L;
          if (((nmy)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mOrigin > 0) {
            i = ((nmy)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mOrigin;
          }
          localJSONObject1 = new JSONObject();
          localJSONObject2 = new JSONObject();
          localJSONObject2.put("stat_type", nbe.aO);
          localJSONObject2.put("webview_click", ((nmy)localObject).jdField_a_of_type_Long);
          localJSONObject2.put("webview_start", ((nmy)localObject).b);
          localJSONObject2.put("webview_head", ((nmy)localObject).c);
          localJSONObject2.put("webview_body", ((nmy)localObject).d);
          localJSONObject2.put("webview_close", System.currentTimeMillis());
          if (!((nmy)localObject).jdField_a_of_type_Boolean) {
            break label203;
          }
        ...
        for (;;)
        {
          ...
          nbe.a(new nmv().a(nbe.A).b(i).a(((nmy)localObject).jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo).e(localJSONObject1).a());
          npt.a(2);
          return;
          label203:
  ...
  public static void a(Activity paramActivity, int paramInt)
  {
    ...
    npt.a(paramInt, localBitmap);
  }
  
  public static void a(VideoAdInfo paramVideoAdInfo)
  {
    a(npn.a(paramVideoAdInfo));
  }
  
  public static void a(VideoInfo paramVideoInfo, qab paramqab)
  {
    if ((paramVideoInfo == null) || (!paramVideoInfo.c) || (paramqab == null) || (paramVideoInfo.a == null) || (TextUtils.isEmpty(paramVideoInfo.a.v))) {
      return;
    }
    for (;;)
    {
      try
      {
        ...
        {
          if (paramqab.a() != null) {
            paramqab.a().setText(paramVideoInfo.optString("AdsIconText"));
          }
          if (!QLog.isColorLevel()) {
            break;
          }
      ...
      if (paramqab.jdField_a_of_type_Int == 4)
      {
        if (paramqab.a() != null) {
          paramqab.a().setVisibility(8);
        }
      }
      else if (paramqab.a() != null) {
        paramqab.a().setVisibility(8);
      }
    }
  }
  ...
  public static void a(AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    do
    {
      ...
      try
      {
        paramAdvertisementInfo = new GdtAd(rvb.a(paramAdvertisementInfo));
        yju.a().a(paramAdvertisementInfo);
        return;
      }
  ...
  public static void a(AdvertisementInfo paramAdvertisementInfo, int paramInt, VideoFeedsPlayManager paramVideoFeedsPlayManager)
  {
    ...
    if (paramVideoFeedsPlayManager != null) {
      localqeq = paramVideoFeedsPlayManager.a();
    }
    if (paramAdvertisementInfo != null)
    {
  ...
  public static void a(JSONObject paramJSONObject, nmw paramnmw)
  {
    if (paramnmw == null) {}
    do
    {
      for (;;)
      {
        ...
        {
          Object localObject;
          if (!TextUtils.isEmpty(paramnmw.b))
          {
            localObject = new JSONObject();
            ((JSONObject)localObject).put("iconUrl", paramnmw.b);
            paramJSONObject.put("id_pk_icon", localObject);
          }
          if ((paramnmw.a != null) && (paramnmw.b.length() >= 2))
          {
            localObject = (nms)paramnmw.a.get(0);
            JSONObject localJSONObject;
            if (!TextUtils.isEmpty(((nms)localObject).d))
            {
              localJSONObject = new JSONObject();
              localJSONObject.put("iconUrl", ((nms)localObject).d);
              paramJSONObject.put("id_pk_image_bg_left", localJSONObject);
            }
            if (!TextUtils.isEmpty(((nms)localObject).c))
            {
              localJSONObject = new JSONObject();
              localJSONObject.put("text", ((nms)localObject).c);
              paramJSONObject.put("id_pk_label_left", localJSONObject);
            }
            paramnmw = (nms)paramnmw.a.get(1);
            if (!TextUtils.isEmpty(paramnmw.d))
            {
              localObject = new JSONObject();
              ((JSONObject)localObject).put("iconUrl", paramnmw.d);
              paramJSONObject.put("id_pk_image_bg_right", localObject);
            }
            if (!TextUtils.isEmpty(paramnmw.c))
            {
              localObject = new JSONObject();
              ((JSONObject)localObject).put("text", paramnmw.c);
  ...
  public static void a(pxk parampxk, pzs parampzs, qaq paramqaq)
  {
    if ((parampxk == null) || (parampzs == null) || (paramqaq == null)) {}
    while ((!(paramqaq instanceof qab)) || (!a((qab)paramqaq)) || (((qab)paramqaq).a() == null) || (!((qab)paramqaq).a().a())) {
      return;
    }
    parampxk.e();
    parampzs.a(paramqaq);
  ...
  public static void a(qeq paramqeq)
  {
    if ((paramqeq != null) && (paramqeq.jdField_a_of_type_Pqa != null)) {
      paramqeq.jdField_a_of_type_Pqa.e = false;
    }
  }
  
  public static void a(qeq paramqeq, boolean paramBoolean)
  {
    if ((paramqeq != null) && (paramqeq.jdField_a_of_type_Pqa != null)) {
      paramqeq.jdField_a_of_type_Pqa.e = paramBoolean;
    }
  }
  
  public static boolean a(int paramInt)
  {
    return (a.contains(Integer.valueOf(paramInt))) || (odm.b(paramInt));
  }
  ...
  {
    return e(nbe.a(paramVideoAdInfo));
  }
  ...
  public static boolean a(AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    return (i == 3) || ((i == 1) && (nps.a(null, paramAdvertisementInfo)));
  }
  
  public static boolean a(qab paramqab)
  {
    if ((paramqab != null) && (paramqab.jdField_a_of_type_Qeq != null) && (paramqab.jdField_a_of_type_Qeq.jdField_a_of_type_ComTencentBizPubaccountVideoInfo != null) && (paramqab.jdField_a_of_type_Qeq.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a != null))
    {
      paramqab = paramqab.jdField_a_of_type_Qeq.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.a;
      try
      {
        ...
        if (paramqab != null)
        {
          int i = paramqab.optInt("showGesturesAdType");
          if (i > 0) {
            return true;
          }
        }
  ...
  public static boolean a(qbz paramqbz)
  {
    String str = bgmq.a("sp_key_ad_soft_total_area");
    ...
    {
      return true;
      i = nbj.a(bgmq.a("sp_key_ad_soft_ad_max"), 25);
      j = paramqbz.b();
      if (QLog.isColorLevel()) {
  ...
  public static boolean a(qeq paramqeq)
  {
    if ((paramqeq != null) && (paramqeq.jdField_a_of_type_Pqa != null)) {
      return paramqeq.jdField_a_of_type_Pqa.e;
    }
    return false;
  }
  ...
  {
    return (String)npi.a(paramAdvertisementInfo.mAdExtInfo, "game_pkg_name", "");
  }
  ...
  public static void b(AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    try
    {
      nmy localnmy = new nmy();
      localnmy.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo = paramAdvertisementInfo;
      localnmy.jdField_a_of_type_JavaLangString = String.valueOf(paramAdvertisementInfo.mAdAid);
      if (!TextUtils.isEmpty(paramAdvertisementInfo.mAdLandingPage))
      {
        ...
        if (!TextUtils.isEmpty(paramAdvertisementInfo))
        {
          ...
          if ((i > 0) && (i < paramAdvertisementInfo.length() - 1)) {
            localnmy.jdField_a_of_type_JavaLangString = paramAdvertisementInfo.substring(i + 1);
          }
        }
      }
      localnmy.jdField_a_of_type_Long = System.currentTimeMillis();
      npt.a(2, localnmy);
  ...
  public static boolean c(AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    try
    {
      ...
      boolean bool3 = bady.a(BaseApplicationImpl.getContext(), str);
      bool1 = bool2;
      if (!bool3) {
        bool1 = true;
      }
  ...
  public static boolean d(AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    try
    {
      ...
      boolean bool3 = bady.a(BaseApplicationImpl.getContext(), paramAdvertisementInfo);
      bool1 = bool2;
      if (bool3) {
        bool1 = true;
      }
  ...
  {
    if (paramAdvertisementInfo == null) {}
    while ((TextUtils.isEmpty(paramAdvertisementInfo.mPopFormH5Url)) || (!npi.d(paramAdvertisementInfo))) {
      return false;
    }
    return true;
  }
