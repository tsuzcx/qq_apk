...
public class aouu
{
  private static aouu jdField_a_of_type_Aouu;
  private static Object jdField_a_of_type_JavaLangObject = new Object();
  private static String jdField_a_of_type_JavaLangString;
  int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long = System.currentTimeMillis();
  private ArrayList<aouv> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public static aouu a(QQAppInterface paramQQAppInterface)
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if ((jdField_a_of_type_Aouu == null) || (!jdField_a_of_type_Aouu.a()) || (!paramQQAppInterface.getCurrentAccountUin().equals(jdField_a_of_type_JavaLangString)))
      {
        jdField_a_of_type_Aouu = new aouu();
        jdField_a_of_type_JavaLangString = paramQQAppInterface.getCurrentAccountUin();
        jdField_a_of_type_Aouu.a(paramQQAppInterface);
      }
      paramQQAppInterface = jdField_a_of_type_Aouu;
      ...
      try
      {
        ...
        if ((localObject1 != null) && (((List)localObject1).size() > 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            paramQQAppInterface.b((awbv)localObject5);
            continue;
          }
        }
        Object localObject2;
      ...
      while (((Iterator)localObject4).hasNext())
      {
        ...
        else
        {
          ...
          do
          {
            ...
            localObject7 = (aouv)((Iterator)localObject6).next();
          } while ((((aouv)localObject7).b != ((QQOperationVoipTipsTaskExcuteRecord)localObject5).uinType) || (((aouv)localObject7).jdField_a_of_type_Int != ((QQOperationVoipTipsTaskExcuteRecord)localObject5).tipType));
        }
      }
      for (int i = 1;; i = 0)
      {
        if (i == 0)
        {
          localObject6 = new aouv();
          ((aouv)localObject6).b = ((QQOperationVoipTipsTaskExcuteRecord)localObject5).uinType;
          ((aouv)localObject6).jdField_a_of_type_Int = ((QQOperationVoipTipsTaskExcuteRecord)localObject5).tipType;
  ...
  {
    if (jdField_a_of_type_Aouu == null) {
      return;
    }
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      jdField_a_of_type_Aouu.a();
      jdField_a_of_type_Aouu = null;
      return;
    }
  }
  ...
  public int a(String paramString, int paramInt, QQOperationViopTipTask paramQQOperationViopTipTask, QQAppInterface paramQQAppInterface, List<ChatMessage> paramList)
  {
    ...
    if (k >= 0)
    {
      ...
      {
        if ((!abot.p(paramString.msgtype)) || (paramString.extraflag != 0)) {
          break label221;
        }
  ...
  public aouw a(String paramString, int paramInt1, QQAppInterface paramQQAppInterface, List<ChatMessage> paramList, boolean paramBoolean, int paramInt2)
  {
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (paramBoolean)
        {
          ...
          paramList = (aoux)paramQQAppInterface.next();
    ...
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (localObject1 == null)
        {
          ...
          localObject1 = (aouv)paramQQAppInterface.next();
          if ((((aouv)localObject1).b != paramQQOperationVoipTipsTaskExcuteRecord.uinType) || (((aouv)localObject1).jdField_a_of_type_Int != paramQQOperationVoipTipsTaskExcuteRecord.tipType)) {
            continue;
          }
          if (i == 0)
          {
            paramQQAppInterface = new aouv();
          ...
          localawbw.b(paramQQOperationVoipTipsTaskExcuteRecord);
          localawbw.a();
          return;
        }
      }
  ...
  public void a(QQAppInterface paramQQAppInterface, ArrayList<QQOperationViopTipTask> paramArrayList)
  {
    ...
    //   43: return
    //   44: aload_1
    //   45: invokevirtual 149	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Lawbx;
    //   48: invokevirtual 155	awbx:createEntityManager	()Lawbw;
    //   51: astore_3
    //   52: aload_3
    //   53: invokevirtual 468	awbw:a	()Lawby;
    //   56: astore_1
    //   57: aload_1
    //   58: invokevirtual 471	awby:a	()V
    //   61: aload_3
    //   62: ldc 157
    //   64: invokevirtual 474	awbw:a	(Ljava/lang/Class;)Z
    //   67: pop
    //   68: aload_2
    ...
    //   95: invokevirtual 247	awbw:b	(Lawbv;)V
    //   98: goto -24 -> 74
    //   101: astore_2
    //   102: aload_2
    //   103: invokevirtual 226	java/lang/Exception:printStackTrace	()V
    //   106: aload_1
    //   107: invokevirtual 476	awby:b	()V
    //   110: aload_3
    //   111: invokevirtual 228	awbw:a	()V
    //   114: aload_0
    //   115: invokevirtual 312	aouu:a	()V
    //   118: return
    ...
    //   154: aload_1
    //   155: invokevirtual 480	awby:c	()V
    //   158: aload_1
    //   159: invokevirtual 476	awby:b	()V
    //   162: goto -52 -> 110
    //   165: astore_2
    //   166: aload_1
    //   167: invokevirtual 476	awby:b	()V
    //   170: aload_2
    //   171: athrow
  ...
  public void a(String paramString, int paramInt, ArrayList<aoux> paramArrayList, QQAppInterface paramQQAppInterface)
  {
    ((allq)paramQQAppInterface.a(4)).a(paramString, paramInt, paramArrayList, false);
  }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    while (localIterator.hasNext())
    {
      aouv localaouv = (aouv)localIterator.next();
      if ((paramInt1 == localaouv.b) && (paramInt2 == localaouv.jdField_a_of_type_Int)) {
        return true;
      }
    }
    return false;
  ...
  public boolean a(String paramString, int paramInt1, int paramInt2, QQAppInterface paramQQAppInterface, List<ChatMessage> paramList, ArrayList<aoux> paramArrayList, boolean paramBoolean, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      if ((TextUtils.isEmpty(((QQOperationViopTipTask)localObject3).keywordString)) && (((QQOperationViopTipTask)localObject3).frequencyTime == 0))
      {
        ...
        {
          if (paramQQAppInterface.hasNext()) {
            if (((aoux)paramQQAppInterface.next()).jdField_a_of_type_Int == ((QQOperationViopTipTask)localObject3).taskid)
            {
              paramInt1 = 1;
              label632:
              if (paramInt1 == 0)
              {
                paramQQAppInterface = new aoux();
        ...
        for (;;)
        {
          ...
          if ((TextUtils.isEmpty(localQQOperationViopTipTask.keywordString)) && (localQQOperationViopTipTask.frequencyTime == 0))
          {
            ...
            while (((Iterator)localObject2).hasNext()) {
              if (((aoux)((Iterator)localObject2).next()).jdField_a_of_type_Int == localQQOperationViopTipTask.taskid)
              {
                paramInt2 = 1;
                label1325:
                if (paramInt2 == 0)
                {
                  localObject2 = new aoux();
                  ((aoux)localObject2).jdField_a_of_type_Int = localQQOperationViopTipTask.taskid;
                  ((aoux)localObject2).b = i;
                  ((aoux)localObject2).jdField_a_of_type_JavaUtilArrayList = ((ArrayList)localObject1);
