...
public class aouu
{
  ...
  private HashMap<Long, aovq> jdField_a_of_type_JavaUtilHashMap;
  
  private aovo a(String paramString, int paramInt, long paramLong, MessageRecord paramMessageRecord)
  {
    if (paramLong <= 0L)
    {
    ...
    aovo localaovo = new aovo(this, paramLong, paramString, paramInt, paramMessageRecord);
    ...
    for (;;)
    {
      ...
      {
        paramString = new aovv(this, paramMessageRecord.getExtInfoFromExtStr("_m_ForwardFileName"), paramString, null);
      }
      else
      {
        do
        {
          ...
          catch (NumberFormatException paramString)
          {
            do
            {
              ...
              if (paramInt == 0)
              {
                paramString = new aouw(this, paramMessageRecord);
                break;
              }
              if (paramInt == 3000)
              {
                paramString = new aouy(this, paramMessageRecord);
                break;
              }
            } while (paramInt != 1);
          ...
          if (paramInt == 0)
          {
            paramString = new aovf(this, paramMessageRecord);
            break;
          }
          if (paramInt == 3000)
          {
            paramString = new aovh(this, paramMessageRecord);
            break;
          }
        } while (paramInt != 1);
    ...
    for (;;)
    {
      paramString = new aovt(this, paramMessageRecord, paramInt, null);
      break label76;
      if (paramInt == 3000)
      {
        paramInt = 106;
  ...
  private static void b(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, String paramString, long paramLong2, int paramInt2, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean, Bundle paramBundle, aovr paramaovr)
  {
    if (paramaovr == null)
    {
    ...
    xap.a(paramQQAppInterface, paramLong1, paramInt1, paramString, paramInt2, paramInt3, paramInt4, paramInt5, paramBoolean, paramBundle, new aouv(paramString, paramaovr, paramLong2));
  }
}
