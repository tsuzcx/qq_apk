  ...
  extends binq
{
  ...
  public bmrh(birg parambirg)
  {
    super(parambirg);
    this.jdField_a_of_type_AndroidAppActivity = parambirg.jdField_a_of_type_AndroidAppActivity;
    ...
    if (this.jdField_a_of_type_Birj.jdField_a_of_type_Int != i) {
      g(i);
    }
    this.jdField_g_of_type_JavaLangString = bhlo.a(this.jdField_a_of_type_AndroidAppActivity).jdField_a_of_type_JavaLangString;
    this.h = bmrb.a(this.jdField_a_of_type_AndroidAppActivity);
  }
  ...
  private ImageView a(int paramInt, String paramString, View.OnClickListener paramOnClickListener)
  {
    if ((this.jdField_a_of_type_AndroidWidgetImageView != null) && (this.jdField_a_of_type_AndroidWidgetImageView.getVisibility() == 0))
    {
      ...
      ((RelativeLayout.LayoutParams)localObject).leftMargin = (((RelativeLayout.LayoutParams)localObject).width + bhgr.a(this.jdField_a_of_type_AndroidAppActivity, 13.0F));
  ...
  {
    paramRadioButton.setBackgroundDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130846987));
  ...
  private boolean d()
  {
    ...
    {
      bmqw.e("ReaderTitleBarView", bool);
      if (100 != this.jdField_f_of_type_Int) {
        break;
      }
      return true;
  ...
  private void i(int paramInt)
  {
    if (this.jdField_a_of_type_AndroidWidgetTextView == null) {
      bmqw.a("ReaderTitleBarView", "leftView is null");
    }
    ...
    do
    {
      ...
      localDrawable = bhmq.a(localDrawable, paramInt);
    } while (localDrawable == null);
  ...
  private void j()
  {
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      localRadioButton.setId(2131374776);
      localLayoutParams = new ViewGroup.LayoutParams(bhgr.a(this.jdField_a_of_type_AndroidAppActivity, 68.0F), bhgr.a(this.jdField_a_of_type_AndroidAppActivity, 34.0F));
      a(localRadioButton, true);
      localRadioButton.setText(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131715905));
      ...
      localRadioButton.setId(2131374777);
      a(localRadioButton, false);
      localRadioButton.setText(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131715907));
      this.jdField_a_of_type_AndroidWidgetRadioGroup.addView(localRadioButton, localLayoutParams);
    }
    this.jdField_a_of_type_AndroidWidgetRadioGroup.setOnCheckedChangeListener(new bmrj(this));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.removeAllViews();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(this.jdField_a_of_type_AndroidWidgetLinearLayout, new ViewGroup.LayoutParams(bhgr.a(this.jdField_a_of_type_AndroidAppActivity, 186.0F), bhgr.a(this.jdField_a_of_type_AndroidAppActivity, 44.0F)));
  }
  ...
  private void j(int paramInt)
  {
    ...
    if ((!TextUtils.isEmpty(this.e)) && (!TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString))) {
      ...
      default: 
        ...
        if (this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) {
          this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.webView.loadUrl(str);
        }
        break;
      }
    }
    for (int i = paramInt;; i = 0)
    {
      k(i);
      return;
      bmqz.a(this.jdField_g_of_type_JavaLangString, this.h, "5", "502", "", "3", "", "", "");
      str = this.e;
      paramInt = 0;
      break;
      bmqz.a(this.jdField_g_of_type_JavaLangString, this.h, "5", "2206", "", "3", "", "", "");
      paramInt = 1;
  ...
  public void a(Intent paramIntent, String paramString)
  {
    ...
    this.jdField_a_of_type_Birj.jdField_a_of_type_JavaLangString = null;
    super.a(paramIntent, paramString);
    if (d())
    {
      a(this.jdField_a_of_type_Birj.jdField_a_of_type_OrgJsonJSONObject, false);
      if ((this.jdField_a_of_type_Birg.a() != null) && (!this.jdField_a_of_type_Birj.jdField_a_of_type_Boolean))
      {
        this.jdField_a_of_type_Birj.s = true;
        a(this.jdField_a_of_type_Birg.a());
      }
    }
  }
  ...
  {
    super.c();
    if ((this.jdField_a_of_type_Birg.jdField_c_of_type_AndroidViewViewGroup instanceof RefreshView)) {
      ((RefreshView)this.jdField_a_of_type_Birg.jdField_c_of_type_AndroidViewViewGroup).a(false);
    }
    if (this.jdField_a_of_type_Birg.jdField_c_of_type_AndroidViewView != null) {
      this.jdField_a_of_type_Birg.jdField_c_of_type_AndroidViewView.setVisibility(8);
    }
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130850670));
    int i;
    int j;
    int k;
    int m;
    ...
    if (d())
    {
      ...
      bmrb.a(this.jdField_a_of_type_AndroidViewViewGroup, ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidAppActivity));
      if (this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null)
      {
        j = this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getResources().getDimensionPixelSize(2131299011);
        if (!d()) {
          break label665;
        }
        bmrb.a(this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.contentView, -i);
        this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mNeedStatusTrans = true;
        this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mActNeedImmersive = true;
        if (this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mSystemBarComp != null)
        {
          if (!ThemeUtil.isNowThemeIsNight(BaseApplicationImpl.getApplication().getRuntime(), false, null)) {
            break label705;
          }
          this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mSystemBarComp.setBackgroundColor(-6710887);
          localObject = this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getHostActivity().getWindow();
          if (d()) {
            break label783;
          }
          bool = true;
          ImmersiveUtils.a(bool, (Window)localObject);
          this.jdField_a_of_type_Birj.i = true;
        }
      }
      ...
      localDrawable = this.jdField_a_of_type_AndroidWidgetImageView.getResources().getDrawable(2130846965);
      if (!d()) {
        break label789;
      }
      localObject = bhmq.a(localDrawable, -1);
      label522:
      this.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131693613));
      label551:
    ...
    for (;;)
    {
      if (this.jdField_c_of_type_AndroidViewView == null) {
        this.jdField_c_of_type_AndroidViewView = a(2130846966, this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131715906), new bmri(this));
      }
      return;
      f(-16777216);
      d(-16777216);
      ...
      break label311;
      label665:
      if (!(this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment instanceof ReaderHomeTabFragment)) {
        break label361;
      }
      bmrb.a(this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.webView, -j - ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidAppActivity));
      break label361;
      label705:
      this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.mSystemBarComp.setBackgroundColor(-1);
      ...
      localObject = bhmq.a(localDrawable, this.jdField_a_of_type_Birj.jdField_a_of_type_ComTencentMobileqqWebviewWebViewTitleStyle.e);
      break label522;
      label823:
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      break label551;
      label835:
      bmqw.a("ReaderTitleBarView", "mTitleBarLeftTabUrl=" + this.e + ",mTitleBarRightTabUrl=" + this.jdField_f_of_type_JavaLangString);
    }
  }
  ...
  public void h(int paramInt)
  {
    if (paramInt > 0)
    {
      ...
      Window localWindow = this.jdField_a_of_type_Birg.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getHostActivity().getWindow();
      a(d(), localWindow);
    }
  }
}
