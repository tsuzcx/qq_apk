...
class bmrh
  implements bmsc<WeiyunPB.QqSdkFileUploadMsgRsp>
{
  bmrh(bmrf parambmrf, WeiyunTransmissionGlobal.UploadServerInfoCallback paramUploadServerInfoCallback, UploadFile paramUploadFile) {}
  ...
  public void a(WeiyunPB.QqSdkFileUploadMsgRsp paramQqSdkFileUploadMsgRsp)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentWeiyunTransmissionWeiyunTransmissionGlobal$UploadServerInfoCallback.onResult(this.jdField_a_of_type_ComTencentWeiyunTransmissionUploadUploadFile, false, 1828004, anvx.a(2131714437));
      return;
    }
    ...
    if (localObject1 == null)
    {
      ...
      bmrn.a((String)localObject2, (String)localObject1);
    ...
    for (localObject1 = paramQqSdkFileUploadMsgRsp.inside_upload_ip.get();; localObject1 = paramQqSdkFileUploadMsgRsp.outside_upload_ip.get())
    {
      ...
      return;
      localObject1 = bmua.a((ByteStringMicro)localObject1);
      break;
      localObject2 = bmua.a((ByteStringMicro)localObject3);
      break label57;
    }
  }
}
