  ...
  extends DynamicTextItem
{
  ...
  static
  {
    jdField_a_of_type_Float = azkz.a(45.0F);
    jdField_b_of_type_Int = aepi.a(24.0F, BaseApplicationImpl.getContext().getResources());
  }
  
  public blxw(int paramInt, List<String> paramList, Bitmap paramBitmap1, Bitmap paramBitmap2, Typeface paramTypeface)
  {
    ...
    for (;;)
    {
      ...
      new blww().a(0.0F, 0.0F).a(this.d, jdField_b_of_type_Int, 5, 9).a();
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    this.jdField_a_of_type_Blyw.a(paramString, this.d, jdField_b_of_type_Int, this.jdField_a_of_type_AndroidTextTextPaint);
    this.jdField_a_of_type_Blyw.a(new blye((int)jdField_a_of_type_Float));
    this.jdField_b_of_type_Float = this.jdField_a_of_type_Blyw.a(1, this.jdField_a_of_type_Blyw.a()).width();
    this.jdField_c_of_type_Float = this.jdField_a_of_type_Blyw.a(1, this.jdField_a_of_type_Blyw.a()).height();
    paramInt = 0;
    if (paramInt < this.jdField_a_of_type_Blyw.a())
    {
      int j = this.jdField_a_of_type_Blyw.a(paramInt);
      if (i > j) {}
      for (;;)
      {
        paramInt += 1;
    ...
    {
      this.jdField_a_of_type_Blyw.a(new blxe(this.jdField_b_of_type_Float, this.jdField_c_of_type_Float));
      return;
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Blyw == null) {
      return;
    }
    paramCanvas.save();
    this.jdField_a_of_type_AndroidTextTextPaint.setTextAlign(Paint.Align.LEFT);
    paramCanvas.save();
    int i = 0;
    while (i < this.jdField_a_of_type_Blyw.a())
    {
      this.jdField_c_of_type_AndroidGraphicsRectF.set(this.jdField_a_of_type_Blyw.a(i));
      this.jdField_b_of_type_AndroidGraphicsRectF.set(this.jdField_c_of_type_AndroidGraphicsRectF);
      a(this.jdField_a_of_type_Blyw.a(i), this.jdField_b_of_type_AndroidGraphicsRectF, paramCanvas, this.jdField_a_of_type_AndroidTextTextPaint);
    ...
    paramCanvas.translate(0.0F, -azkz.a(5.0F));
    this.jdField_a_of_type_AndroidTextTextPaint.setColor(-16777216);
