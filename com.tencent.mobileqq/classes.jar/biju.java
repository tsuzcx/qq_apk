...
public class biju
  extends biyb
{
  public biju(AuthorityControlFragment paramAuthorityControlFragment) {}
  ...
  protected void a(boolean paramBoolean, List<AppInfo> paramList)
  {
    ...
    if ((paramBoolean) && (paramList != null) && (paramList.size() > 0))
    {
      ...
      paramList = String.format(anni.a(2131699606), new Object[] { Integer.valueOf(i) });
    ...
    {
      bcst.b(localQQAppInterface, "dc00898", "", "", "0X8009E1D", "0X8009E1D", 0, 0, paramList, "", "", "");
      return;
      QQToast.a(AuthorityControlFragment.a(this.a), 1, anni.a(2131699610), 0).a();
      break;
    }
  }
  ...
  protected void a(boolean paramBoolean, List<AppInfo> paramList, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        this.a.setRightButton(2131690167, this.a);
        continue;
        AuthorityControlFragment.a(this.a);
      }
