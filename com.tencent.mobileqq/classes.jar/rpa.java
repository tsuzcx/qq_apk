...
{
  public rpa(AddRequestActivity paramAddRequestActivity, ActionSheet paramActionSheet) {}
    ...
    if (NetworkUtil.d(BaseApplication.getContext()))
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity.a != null)
      {
        ...
        if ((paramView != null) && (1 < paramView.size()))
        {
          ...
          AddRequestActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityAddRequestActivity, 2131434469, 1000L, false);
        }
      }
    }
    for (;;)
