...
public class aodl
  implements RecyclerView.ItemAnimator.ItemAnimatorFinishedListener, View.OnClickListener, aodw
{
  private static int jdField_a_of_type_Int = 2131167208;
  private static int jdField_b_of_type_Int = 2131167194;
  private static int c = 2130839081;
  ...
  private aodg jdField_a_of_type_Aodg;
  ...
  public aodl(Context paramContext, aodw paramaodw)
  {
  ...
  {
    e();
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131558844, null);
    this.jdField_a_of_type_ComTencentMobileqqColornoteListColorNoteListLayout = ((ColorNoteListLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364462));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364466));
    ...
    this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)this.jdField_a_of_type_AndroidViewView.findViewById(2131364465));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new aodm(this));
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(new aodn(this));
    localObject = new aodo(this);
  ...
  private void d()
  {
    ...
    {
      localViewPropertyAnimator.translationX(f).setDuration(180L).setListener(new aodt(this)).start();
      return;
    }
  }
  ...
  private void e()
  {
    ...
    jdField_a_of_type_Int = 2131167208;
    jdField_b_of_type_Int = 2131167194;
    c = 2130839081;
  }
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    c();
    this.jdField_a_of_type_Aodg = new aodg();
    this.jdField_a_of_type_Aodg.a(this);
    this.jdField_a_of_type_Aodg.a(paramBoolean);
    List localList = ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a().a().a();
    this.jdField_a_of_type_Aodg.a(localList);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Aodg);
    this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setVisibility(4);
    this.jdField_a_of_type_Aodg.a(new aodp(this));
    Object localObject;
    if (localList.size() > 0)
    {
      localObject = (ColorNote)localList.get(0);
      if (aocr.b((ColorNote)localObject)) {
        azqs.b(null, "dc00898", "", "", "0X800A8AA", "0X800A8AA", aobv.b(aocr.a(((ColorNote)localObject).getServiceType())), 0, "", "", "", "");
      }
    }
    ...
    this.jdField_a_of_type_AndroidViewView.animate().alpha(0.9F).setDuration(200L).setListener(new aods(this, paramBoolean)).start();
    ...
    for (paramInt2 = i;; paramInt2 = i)
    {
      ...
      paramInt1 = i;
      break;
      azqs.b(null, "dc00898", "", "", "0X800A6CD", "0X800A6CD", 0, 0, localList.size() + "", aobv.a(paramInt1) + "", "", "");
      return;
      label519:
      i = paramInt1;
      paramInt1 = paramInt2;
  ...
  {
    if (this.jdField_a_of_type_Aodg.getItemCount() == 0) {
      d();
    }
  }
