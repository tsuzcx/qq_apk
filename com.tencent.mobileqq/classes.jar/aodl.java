  ...
  extends BusinessHandler
{
  ...
  aodl(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_JavaLangString = paramQQAppInterface.getApplication().getString(2131718813);
    this.jdField_b_of_type_JavaLangString = paramQQAppInterface.getApplication().getString(2131718814);
    this.c = paramQQAppInterface.getApplication().getString(2131718811);
    this.d = paramQQAppInterface.getApplication().getString(2131718815);
    this.f = paramQQAppInterface.getApplication().getString(2131718809);
    this.g = paramQQAppInterface.getApplication().getString(2131718807);
    this.h = paramQQAppInterface.getApplication().getString(2131718810);
    this.e = paramQQAppInterface.getApplication().getString(2131718812);
    this.i = paramQQAppInterface.getApplication().getString(2131718808);
  }
  ...
  private String a(boolean paramBoolean, long paramLong, int paramInt, String paramString)
  {
    ...
    if (paramInt != 1006) {
      if (paramBoolean)
      {
        ...
        localbjxa = (bjxa)this.app.getManager(QQManagerFactory.QIDIAN_MANAGER);
        if ((localbjxa != null) && ((localbjxa.a(paramString)) || (localbjxa.f(paramString)))) {
          break label298;
        }
        str = this.d;
      }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, sso2sns_0x3_blocklist.RspBody paramRspBody)
  {
    ...
    ((awtp)this.app.getManager(QQManagerFactory.SHIELD_LIST_MANAGER)).a(paramFromServiceMsg);
  ...
  private void a(boolean paramBoolean, int paramInt, long[] paramArrayOfLong)
  {
    ...
    for (;;)
    {
      if (j < m)
      {
        ...
        {
          localMessageRecord = bcsa.a(-2012);
          ...
          if ((localObject == null) || (((List)localObject).size() <= 0) || (!acnh.a((MessageRecord)((List)localObject).get(((List)localObject).size() - 1), localMessageRecord, false))) {
            break label297;
          }
          if (QLog.isColorLevel()) {
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, sso2sns_0x3_blocklist.RspBody paramRspBody)
  {
    ...
    paramToServiceMsg = (awtp)this.app.getManager(QQManagerFactory.SHIELD_LIST_MANAGER);
    int j = 0;
  ...
  private void d()
  {
    ...
    ((awtp)this.app.getManager(QQManagerFactory.SHIELD_LIST_MANAGER)).a(localArrayList);
