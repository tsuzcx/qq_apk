...
class bhmt
  extends nkq
{
  bhmt(bhmr parambhmr, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    {
      avcw.a("KEY_STAGE_2_CONNECT_MINI_D55", bool);
      if (this.jdField_a_of_type_Bhmr.h)
      {
        this.jdField_a_of_type_Bhmr.h = false;
    ...
    paramBundle = bhmr.a(this.jdField_a_of_type_Bhmr);
    if (paramInt == 0)
    {
      bdll.b(this.jdField_a_of_type_Bhmr.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc01160", "", "", "0X800A51A", "0X800A51A", 0, 0, "", "", this.jdField_a_of_type_JavaLangString, this.b);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        bdll.b(this.jdField_a_of_type_Bhmr.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc01160", "", "", "0X800A51B", "0X800A51B", 0, paramInt, "", "", this.jdField_a_of_type_JavaLangString, this.b);
        if (paramInt == 25601)
        {
