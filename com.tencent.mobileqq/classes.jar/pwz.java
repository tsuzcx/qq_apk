  ...
  extends pwd
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = pwz.class.getSimpleName();
  }
  
  public pwz(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qli paramqli, Handler paramHandler)
  {
  ...
  private void a(int paramInt, BaseVideoArticleInfo paramBaseVideoArticleInfo)
  {
    ...
    do
    {
      ...
      localplv = (plv)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(274);
    } while (localplv == null);
    long l = NetConnInfoCenter.getServerTime();
    localplv.a(ugf.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramBaseVideoArticleInfo), l);
  }
  ...
  private void a(boolean paramBoolean1, int paramInt, boolean paramBoolean2, List<WeiShiVideoArticleInfo> paramList, long paramLong1, long paramLong2)
  {
    ...
    pkp.a().b(true, paramInt, paramList, paramBoolean1);
  }
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (j == 0)
    {
      ...
      paramFromServiceMsg = sdu.a(localRspBody.rspChannelArticle.rpt_article_list.get(), i, j);
      bool2 = true;
    }
    for (;;)
    {
  ...
  private void b(boolean paramBoolean1, int paramInt, boolean paramBoolean2, List<WeiShiVideoArticleInfo> paramList, long paramLong1, long paramLong2, ToServiceMsg paramToServiceMsg)
  {
    ...
    {
      paramList = b(Integer.valueOf(paramInt));
      pkp.a().a(paramBoolean1, paramInt, paramList, paramBoolean2);
      return;
  ...
  public List<WeiShiVideoArticleInfo> a(Integer paramInteger)
  {
    ...
    Collections.sort(localArrayList, new pxa(this));
    return localArrayList;
  }
  ...
  public void a(int paramInt1, long paramLong, int paramInt2)
  {
    ...
    if (j < paramInt2)
    {
      Collections.sort((List)localObject1, new pxb(this));
      int i = 0;
      for (;;)
      {
        if (i >= paramInt2 - j) {
