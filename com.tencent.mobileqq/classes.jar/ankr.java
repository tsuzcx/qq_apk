  ...
  implements Handler.Callback
{
  ...
  ankr(QQAppInterface paramQQAppInterface, Context paramContext, ankt paramankt)
  {
    super(paramContext);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Ankt = paramankt;
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    if (paramMessage.what == f) {
      if (this.i == c)
      {
        ...
        j = Math.min(j, 99);
        paramMessage = String.format(ajyc.a(2131702868), new Object[] { Integer.valueOf(j) });
        this.jdField_a_of_type_AndroidWidgetTextView.setText(paramMessage);
        this.jdField_a_of_type_Bfmt.sendEmptyMessageDelayed(f, 500L);
      }
    }
      ...
      do
      {
        ...
        if (this.i == d)
        {
          ...
          if (!this.jdField_b_of_type_JavaIoFile.renameTo(this.jdField_a_of_type_JavaIoFile))
          {
            ...
            boolean bool = bbdj.a(this.jdField_b_of_type_JavaIoFile, this.jdField_a_of_type_JavaIoFile);
            bbdj.d(this.jdField_b_of_type_JavaIoFile.getPath());
            if (!bool)
            {
              QLog.d(jdField_a_of_type_JavaLangString, 1, "db fix succ but copy fail final");
              paramMessage = new HashMap();
              axrl.a(BaseApplication.getContext()).a(null, DBFixManager.m, true, -1L, 0L, paramMessage, null, false);
            }
          }
          this.jdField_a_of_type_AndroidWidgetTextView.setText(ajyc.a(2131702869));
          this.jdField_a_of_type_Bfmt.sendEmptyMessageDelayed(g, 100L);
          return false;
        }
      } while (this.i != e);
      dismiss();
      this.jdField_a_of_type_Ankt.a(this.i);
      return false;
    }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131364935));
    ...
    for (int j = 1;; j = 2)
    {
      ...
      super.setOnKeyListener(new anks(this));
      return;
    }
  }
  ...
  {
    super.onStart();
    this.jdField_a_of_type_Bfmt.sendEmptyMessage(f);
  }
}
