...
public class batg
{
  private static batg jdField_a_of_type_Batg;
  ...
  static String g = ajjy.a(2131634348);
  static String h = ajjy.a(2131634346);
  static String i = ajjy.a(2131634347);
  static String j = ajjy.a(2131634345);
  public int a;
  public long a;
  ...
  public static batg a()
  {
    if (jdField_a_of_type_Batg == null) {}
    try
    {
      if (jdField_a_of_type_Batg == null) {
        jdField_a_of_type_Batg = new batg();
      }
      return jdField_a_of_type_Batg;
    }
    finally {}
  }
  ...
  public void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    bace.a(paramContext.getFilesDir() + File.separator + "vipKerwordJson", paramString1);
  }
  ...
  void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    if (TextUtils.isEmpty(paramString2))
    {
      ...
      paramInt1 = avys.jdField_a_of_type_Int;
      avys.jdField_a_of_type_Int = paramInt1 + 1;
      ...
      localMessageRecord.msgUid = apck.b();
      if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord == null) {
        break label249;
      }
    }
    ...
    label230:
    label249:
    for (long l1 = this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.time;; l1 = awao.a())
    {
  ...
  public void a(AppRuntime paramAppRuntime)
  {
    ...
    if (localObject1 != null) {
      aniz.a(((JSONObject)localObject1).optLong("interval", 86400L));
    }
    ...
    {
      aphc.jdField_a_of_type_Boolean = bool1;
      QLog.i("AioVipKeywordHelper", 1, "lottieConfig.switch is " + bool1);
      localObject1 = paramAppRuntime.optJSONObject("ipProductGrayTips");
      if (localObject1 != null)
      {
        arny.jdField_a_of_type_JavaLangString = ((JSONObject)localObject1).optString("leftText", arny.jdField_a_of_type_JavaLangString);
        arny.jdField_b_of_type_JavaLangString = ((JSONObject)localObject1).optString("linkText", arny.jdField_b_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
      ...
      if (localObject1 != null)
      {
        baau.jdField_a_of_type_Int = ((JSONObject)localObject1).optInt("interval", 5000);
        QLog.d("AioVipKeywordHelper", 1, "getStrangerInterval is " + baau.jdField_a_of_type_Int);
      }
      localObject1 = paramAppRuntime.optJSONObject("downloadTimeoutConfig");
      if (localObject1 != null)
      {
        anfj.jdField_b_of_type_Int = ((JSONObject)localObject1).optInt("emotion", anfj.jdField_b_of_type_Int);
        bool1 = bool2;
        if (((JSONObject)localObject1).optInt("emoTryReadNoLen", 0) == 1) {
          bool1 = true;
        }
        anfj.jdField_b_of_type_Boolean = bool1;
      ...
      if (localObject1 != null) {
        bapz.a().a((JSONArray)localObject1);
      }
      angs.a(paramAppRuntime.optJSONArray("h5MagicTips"));
      return;
    }
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      {
        return false;
      } while ((awnu.b()) || (this.jdField_d_of_type_Int == 0));
      l1 = 86400L;
      int i1;
      switch (paramSessionInfo.jdField_a_of_type_Int)
      {
