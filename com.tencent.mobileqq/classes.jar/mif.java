...
public class mif
{
  ...
  mii jdField_a_of_type_Mii = null;
  public boolean a;
  
  public mif(RelativeLayout paramRelativeLayout, int paramInt, mii parammii)
  {
  ...
  public void a(long paramLong, boolean paramBoolean, int paramInt)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidAnimationObjectAnimator != null)
      {
        ...
        a();
        if (this.jdField_a_of_type_Mii != null) {
          this.jdField_a_of_type_Mii.a(paramLong, this.jdField_a_of_type_AndroidWidgetRelativeLayout, true);
        }
        if (!paramBoolean) {
          break label252;
        }
      ...
      for (;;)
      {
        ...
        ((ObjectAnimator)localObject).addListener(new mih(this, i, paramLong));
    ...
    this.jdField_a_of_type_Mii.a(paramLong, this.jdField_a_of_type_AndroidWidgetRelativeLayout, false);
  }
  
  public void a(long paramLong, boolean paramBoolean, int paramInt, mij parammij)
  {
    int i = 4;
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null) {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      parammij = ajyc.a(2131708935) + this.jdField_a_of_type_Boolean + "], height[" + i + "], seq[" + paramLong + "]";
      QLog.w(this.jdField_a_of_type_JavaLangString, 1, parammij, new Throwable("打印调用栈"));
      throw new IllegalArgumentException(parammij);
    }
    ((ObjectAnimator)localObject).setDuration(300L);
    ((ObjectAnimator)localObject).addListener(new mig(this, i, paramLong, parammij));
    this.jdField_a_of_type_AndroidAnimationObjectAnimator = ((ObjectAnimator)localObject);
    ((ObjectAnimator)localObject).start();
    this.jdField_a_of_type_Boolean = false;
    if (this.jdField_a_of_type_Mii != null) {
      this.jdField_a_of_type_Mii.b(paramLong, this.jdField_a_of_type_AndroidWidgetRelativeLayout, true);
    }
    label319:
    label320:
    do
    {
      ...
      this.jdField_a_of_type_Boolean = false;
    } while ((this.jdField_a_of_type_AndroidWidgetRelativeLayout == null) || (this.jdField_a_of_type_Mii == null));
    this.jdField_a_of_type_Mii.b(paramLong, this.jdField_a_of_type_AndroidWidgetRelativeLayout, false);
  }
