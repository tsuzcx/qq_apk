...
public class pvr
{
  private static final LbsManagerService.OnLocationChangeListener jdField_a_of_type_ComTencentMobileqqAppSosoLbsManagerService$OnLocationChangeListener = new pvs("readinjoy_anti_cheating", false);
  private static boolean jdField_a_of_type_Boolean;
  
  private static int a()
  {
    String str1 = a();
    String str2 = (String)bmhv.a("readinjoy_sp_key_last_request_lbs_date", "");
    QLog.d("ReadInJoySpEventReportUtil", 1, new Object[] { "getToadyRequestLbsTime, today = ", str1, ", lastRequestLbsDate = ", str2 });
    if (str1.equals(str2)) {
      return ((Integer)bmhv.a("readinjoy_sp_key_toady_request_lbs_time", Integer.valueOf(0))).intValue();
    }
    return 0;
  }
  ...
  public static void a()
  {
    ...
    bmhv.a("readinjoy_sp_key_app_launch_time", Long.valueOf(l));
  }
  ...
  private static boolean a()
  {
    ...
    if ((SystemUtil.isMIUI()) && (pqu.b((QQAppInterface)localObject)))
    {
    ...
    if (localObject != null)
    {
      ...
      long l1 = ((Long)bmhv.a("readinjoy_sp_key_app_launch_time", Long.valueOf(System.currentTimeMillis()))).longValue();
  ...
  {
    String str = a();
    Object localObject = (String)bmhv.a("readinjoy_sp_key_last_request_lbs_date", "");
    QLog.d("ReadInJoySpEventReportUtil", 1, new Object[] { "updateToadyRequestLbsTime, today = ", str, ", lastRequestLbsDate = ", localObject });
    if (str.equals(localObject))
    {
      localObject = (Integer)bmhv.a("readinjoy_sp_key_toady_request_lbs_time", Integer.valueOf(0));
      QLog.d("ReadInJoySpEventReportUtil", 1, new Object[] { "updateToadyRequestLbsTime, todayTime = ", localObject });
      bmhv.a("readinjoy_sp_key_toady_request_lbs_time", Integer.valueOf(((Integer)localObject).intValue() + 1));
    }
    for (;;)
    {
      bmhv.a("readinjoy_sp_key_last_request_lbs_date", str);
      return;
      QLog.d("ReadInJoySpEventReportUtil", 1, "updateToadyRequestLbsTime, first time today.");
      bmhv.a("readinjoy_sp_key_toady_request_lbs_time", Integer.valueOf(1));
    }
  }
}
