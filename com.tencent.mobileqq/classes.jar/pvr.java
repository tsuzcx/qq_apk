...
class pvr
{
  ...
  private pxa a()
  {
    ...
    if (localAppRuntime != null) {
      return ((pmm)localAppRuntime.getManager(163)).a().a();
    }
    return null;
  }
    ...
    if ((localObject != null) && (((ArrayList)localObject).size() > 0))
    {
      ...
      if (i != -1)
      {
        if ((this.c.containsKey(Integer.valueOf(paramInt1))) && (i < ((ArrayList)this.c.get(Integer.valueOf(paramInt1))).size()))
        {
          ...
          if (localObject != null) {
            ((BaseArticleInfo)localObject).mRecommendSeq = pvq.a(1, paramInt2);
          }
          return localObject;
        }
  ...
  void a(int paramInt)
  {
    ...
    Object localObject3 = ((pxa)localObject2).a(paramInt);
    ...
    Collections.sort((List)localObject1, new pvt(this));
    ...
    localObject2 = ((pxa)localObject2).a(paramInt);
  ...
  void c(int paramInt)
  {
    pxa localpxa = a();
    if (localpxa != null) {
      localpxa.a(paramInt, this.jdField_a_of_type_Pxb);
    }
  }
