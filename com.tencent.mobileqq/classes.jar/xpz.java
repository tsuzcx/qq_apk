...
{
  public xpz(QzDynamicVideoPreviewActivity paramQzDynamicVideoPreviewActivity) {}
  ...
  public void onError(int paramInt)
  {
    ...
    this.a.runOnUiThread(new xqb(this, paramInt));
  }
  ...
  public void onProgress(int paramInt)
  {
    ...
    String str = paramInt + "%";
    this.a.runOnUiThread(new xqa(this, paramInt, str));
  }
}
