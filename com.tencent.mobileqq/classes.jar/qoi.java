...
public class qoi
{
  ...
  {
    if (bhvy.b(paramAppRuntime, "VIDEO_FEEDS_SOFT_AD_LOCAL_CONFIG_DATE")) {
  ...
  {
    if (((paramView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) && (paramView.getTag(2131362550) == null))
    {
      ...
      localValueAnimator.addUpdateListener(new qoo(i, localMarginLayoutParams, j, paramView));
      localValueAnimator.addListener(new qop(paramView));
      paramView.setTag(2131362550, localValueAnimator);
  ...
  public static ObjectAnimator a(View paramView, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == 0)
    {
      ...
      localObjectAnimator1.addListener(new qov(paramView));
      localObjectAnimator1.start();
    }
    for (;;)
    {
      ...
      paramView.setTag(2131374731, localObjectAnimator1);
      ...
      if ((paramInt1 == 8) || (paramInt1 == 4))
      {
        ...
        localObjectAnimator1.start();
        paramView.setLayerType(2, null);
        localObjectAnimator1.addListener(new qow(paramView));
        localObjectAnimator1.start();
      }
    }
  }
  ...
  private static Drawable a(Context paramContext)
  {
    ...
    localGradientDrawable.setCornerRadius(actj.a(3.0F, paramContext.getResources()));
  ...
  public static Long a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (paramBaseArticleInfo.busiType == 6)
    {
      if (ram.a((ArticleInfo)paramBaseArticleInfo)) {
        return Long.valueOf(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qci.jdField_a_of_type_Long);
      }
      return Long.valueOf(paramBaseArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qda.jdField_a_of_type_Long);
    }
  ...
  public static String a(int paramInt)
  {
    ...
    return f(paramInt) + ajya.a(2131716168);
  }
  ...
  {
    return bdik.d(paramQQAppInterface.getCurrentAccountUin() + "_" + paramString + "_" + System.currentTimeMillis());
  }
  ...
  public static void a(Activity paramActivity, Bundle paramBundle, boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramBoolean = ope.a(localBundle.getInt("VIDEO_FROM_TYPE", -1));
        for (;;)
        {
          if (!paramBoolean) {
            break label212;
          ...
          if (paramBundle != null) {
            paramBoolean = ope.a(localBundle.getInt("VIDEO_FROM_TYPE", -1), paramBundle.jdField_b_of_type_Int, paramBundle.jdField_c_of_type_Int, paramBundle.jdField_d_of_type_Int);
          } else {
            paramBoolean = ope.a(localBundle.getInt("VIDEO_FROM_TYPE", -1), Integer.valueOf(localBundle.getString("VIDEO_WIDTH")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_HEIGHT")).intValue(), Integer.valueOf(localBundle.getString("VIDEO_TIME")).intValue());
          }
        }
      }
  ...
  {
    a(paramContext, paramTextView, ajya.a(2131716214), ajya.a(2131716219), bbwq.a("kandian"), null);
  }
  ...
  public static void a(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, View.OnClickListener paramOnClickListener)
  {
    ...
    paramString1.setSpan(new qoj(paramString3, paramContext, paramOnClickListener), i, j, 33);
  ...
  public static void a(Context paramContext, UrlJumpInfo paramUrlJumpInfo)
  {
    if ((paramUrlJumpInfo != null) && (paramContext != null))
    {
      ...
      if (!TextUtils.isEmpty(paramUrlJumpInfo.jdField_a_of_type_JavaLangString)) {
        onh.a(paramContext, paramUrlJumpInfo.jdField_a_of_type_JavaLangString);
      }
    }
    for (;;)
    {
      ...
      {
        if (!nuq.a(paramUrlJumpInfo.jdField_b_of_type_JavaLangString))
        {
          if (!QLog.isColorLevel()) {
            break;
          }
        ...
        if (bbfr.a(paramContext, paramUrlJumpInfo.jdField_b_of_type_JavaLangString)) {
  ...
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    ...
    try
    {
      ...
      int i = actj.a(16.0F, paramContext.getResources());
      localTextView.setPadding(i, 0, i, 0);
      paramString = new Dialog(paramContext, 2131755311);
      paramString.setContentView(localTextView, new ViewGroup.LayoutParams(-2, baxn.a(paramContext, 40.0F)));
  ...
  public static void a(View paramView)
  {
    ...
    paramView = paramView.getTag(2131374731);
  ...
  public static void a(View paramView, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (paramInt1 == 0)
      {
        ...
        localAlphaAnimation.setAnimationListener(new qox(paramView));
        paramView.clearAnimation();
    ...
    localAlphaAnimation.setDuration(paramInt2);
    localAlphaAnimation.setFillAfter(true);
    localAlphaAnimation.setAnimationListener(new qoy(paramView));
    paramView.clearAnimation();
    paramView.startAnimation(localAlphaAnimation);
  }
  ...
  public static void a(View paramView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      if (paramInt2 == 0)
      {
        ...
        paramView.setLayerType(2, null);
        localObjectAnimator2.addListener(new qot(paramView));
    ...
    localObjectAnimator1.setRepeatCount(0);
    paramView.setLayerType(2, null);
    localObjectAnimator1.addListener(new qou(paramView));
    localObjectAnimator1.start();
  }
  ...
  public static void a(View paramView1, View paramView2, int[] paramArrayOfInt, Animator.AnimatorListener paramAnimatorListener)
  {
    ...
    paramArrayOfInt = ValueAnimator.ofObject(new qjy(), new Object[] { new Point(paramView2.getWidth(), paramView2.getHeight()), new Point(paramArrayOfInt[0], paramArrayOfInt[1]) });
    paramArrayOfInt.addUpdateListener(new qos(paramView2, paramView1));
    paramView1 = ObjectAnimator.ofFloat(paramView2, "translationX", new float[] { paramView2.getTranslationX(), -bbll.a(6.0F) });
    paramView2 = ObjectAnimator.ofFloat(paramView2, "translationY", new float[] { paramView2.getTranslationY(), -bbll.a(60.0F) });
  ...
  public static void a(ViewGroup paramViewGroup1, ViewGroup paramViewGroup2, WindowManager paramWindowManager, WindowManager.LayoutParams paramLayoutParams, Animator.AnimatorListener paramAnimatorListener)
  {
    ...
    ValueAnimator localValueAnimator = ValueAnimator.ofObject(new qjy(), new Object[] { new Point(0, 0), new Point((int)bbdh.i() - i, (int)bbdh.j() - j) });
    localValueAnimator.addUpdateListener(new qoq(paramViewGroup2, i, j));
    paramViewGroup2 = ValueAnimator.ofObject(new qjy(), new Object[] { new Point(paramLayoutParams.x, paramLayoutParams.y), new Point(0, 0) });
    paramViewGroup2.addUpdateListener(new qor(paramWindowManager, paramViewGroup1, paramLayoutParams));
    ...
    if (paramVideoInfo.jdField_a_of_type_Int != 0)
    {
      if (paramVideoInfo.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo == null)
      {
        ...
        if (paramVideoInfo.jdField_b_of_type_Boolean)
        {
          ...
          localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qda.b = new ArrayList();
          qdc localqdc = new qdc();
          localqdc.h = paramVideoInfo.jdField_f_of_type_JavaLangString;
          localqdc.e = paramVideoInfo.jdField_c_of_type_JavaLangString;
          localqdc.jdField_d_of_type_JavaLangString = paramVideoInfo.jdField_b_of_type_JavaLangString;
          localqdc.jdField_a_of_type_Long = paramVideoInfo.jdField_d_of_type_Int;
          localArticleInfo.mSocialFeedInfo.jdField_a_of_type_Qda.b.add(localqdc);
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    ((npa)paramQQAppInterface.a(155)).a(paramInt);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    qom localqom = new qom(paramString, paramBoolean);
    if (paramBoolean) {}
    for (int i = 2;; i = 1)
    {
      localpbu.a(paramQQAppInterface, paramString, true, localqom, i);
      return;
    }
  }
  ...
  public static void a(String paramString1, String paramString2, TextView paramTextView)
  {
    if (!TextUtils.isEmpty(paramString1))
    {
      ...
      try
      {
        oky.a(paramTextView, paramString1);
  ...
  {
    bhvy.x(paramAppRuntime, paramInt);
  }
  
  public static void a(AppRuntime paramAppRuntime, Activity paramActivity)
  {
    if (ozb.a(paramActivity, true)) {
      bbdj.a(paramActivity, 230, paramActivity.getString(2131718623), paramActivity.getString(2131718622), 2131690596, 2131718621, new qon(), null).setMessageCount(null).show();
    }
  }
  ...
  public static boolean a(Activity paramActivity, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (i == 1)
    {
      if (onh.a(paramBaseArticleInfo.bytes_jump_url))
      {
        onh.a(paramActivity, onh.a(paramBaseArticleInfo.bytes_jump_url));
        return true;
      }
    }
    else if ((i == 2) && (onh.a(paramBaseArticleInfo.bytes_jump_bundle)) && (bbfr.a(paramActivity, onh.a(paramBaseArticleInfo.bytes_jump_bundle))))
    {
      a(paramActivity, onh.a(paramBaseArticleInfo.bytes_jump_schema));
      return true;
    }
    return false;
  }
  ...
  {
    String str = olo.a(paramBaseArticleInfo);
    if (!TextUtils.isEmpty(str))
    {
      if (qae.a(str))
      {
        onh.a(paramContext, paramBaseArticleInfo, str);
        return true;
      }
      a(paramContext, str);
      return true;
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    try
    {
      boolean bool = osg.a().b(Long.valueOf(paramLong));
      return bool;
    }
  ...
  public static String b(int paramInt)
  {
    ...
    return f(paramInt) + ajya.a(2131716213);
  }
  ...
  public static void b(Context paramContext, TextView paramTextView, String paramString1, String paramString2, String paramString3, View.OnClickListener paramOnClickListener)
  {
    ...
    paramString1 = new SpannableString(paramString1);
    paramString1.setSpan(new qok(paramTextView), i, j, 33);
    paramTextView.setMovementMethod(LinkMovementMethod.getInstance());
    paramTextView.setText(paramString1);
    paramTextView.setOnClickListener(new qol(paramString3, paramContext, paramOnClickListener));
  }
  ...
  public static boolean b(Activity paramActivity, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    {
      if ((onh.a(paramBaseArticleInfo.bytes_jump_bundle)) && (bbfr.a(paramActivity, onh.a(paramBaseArticleInfo.bytes_jump_bundle))))
      {
        a(paramActivity, onh.a(paramBaseArticleInfo.bytes_jump_schema));
        return true;
      }
  ...
  {
    if (paramLong <= 0L) {
      return ajya.a(2131716232);
    }
    return b(paramLong) + ajya.a(2131716228);
  }
  ...
  public static String e(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt >= 10004999)
      {
        ...
        return jdField_d_of_type_JavaTextDecimalFormat.format(paramInt / 10000.0D) + ajya.a(2131716180);
      }
      if (paramInt >= 10000)
      {
        ...
        return jdField_c_of_type_JavaTextDecimalFormat.format(paramInt / 10000.0D) + ajya.a(2131716160);
      }
    } while (paramInt <= 0);
    return paramInt + "";
  }
  ...
  private static String f(int paramInt)
  {
    ...
    if (paramInt >= 100000000) {
      str = jdField_a_of_type_JavaTextDecimalFormat.format(paramInt / 100000000.0D) + ajya.a(2131716207);
    }
    do
    {
      return str;
      if (paramInt >= 10000) {
        return jdField_a_of_type_JavaTextDecimalFormat.format(paramInt / 10000.0D) + ajya.a(2131716205);
      }
    } while (paramInt < 0);
    return paramInt + "";
  }
