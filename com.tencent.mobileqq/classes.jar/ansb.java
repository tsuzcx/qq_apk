  ...
  implements Manager
{
  ...
  private WeakReference<ansd> jdField_a_of_type_JavaLangRefWeakReference;
  private ArrayList<QIMNotifyAddFriend> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private AtomicBoolean jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private AtomicBoolean b = new AtomicBoolean(false);
  
  public ansb(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    String str = bglf.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(paramLong2));
  ...
  public ArrayList<ajbi> a(boolean paramBoolean)
  {
    ...
    if (((FlashChatManager)???).c())
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (localIterator.hasNext()) {
          localArrayList.add(new ajbi((QIMNotifyAddFriend)localIterator.next()));
        }
      }
      this.b.set(true);
      if (QLog.isColorLevel()) {
  ...
  public void a(ansd paramansd)
  {
    if (QLog.isColorLevel()) {
      QLog.d("QIMNewFriendManager", 2, "addListener");
    }
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramansd);
  }
  ...
  public void a(QIMNotifyAddFriend paramQIMNotifyAddFriend)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        paramQIMNotifyAddFriend = (ansd)this.jdField_a_of_type_JavaLangRefWeakReference.get();
  ...
  public void a(ArrayList<QIMNotifyAddFriend> paramArrayList)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 29	ansb:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   4: astore_2
    //   5: aload_2
    //   6: monitorenter
    //   7: aload_0
    //   8: getfield 53	ansb:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    ...
    //   42: astore 4
    //   44: aload_0
    //   45: getfield 27	ansb:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   95: aload_0
    //   96: aload 6
    //   98: invokevirtual 268	ansb:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   101: pop
    //   102: goto -78 -> 24
    //   105: astore_1
  ...
  public void a(List<QIMNotifyAddFriend> paramList)
  {
    ...
    //   44: astore 4
    //   46: aload_0
    //   47: getfield 27	ansb:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   97: aload_0
    //   98: aload 6
    //   100: invokevirtual 268	ansb:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   103: pop
    //   104: goto -78 -> 26
    //   107: astore_1
    ...
    //   129: monitorexit
    //   130: aload_0
    //   131: getfield 40	ansb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   134: bipush 34
    //   136: invokevirtual 156	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   139: checkcast 228	aiyr
    //   142: invokevirtual 230	aiyr:b	()V
    //   145: return
    //   146: aload_3
  ...
  public ArrayList<QIMNotifyAddFriend> b()
  {
    ...
    if ((((FlashChatManager)???).c()) && (((FlashChatManager)???).d()))
    {
      ...
      Collections.sort(localList, new ansc(this));
    }
    while (!QLog.isColorLevel())
    {
      Iterator localIterator;
  ...
  public void b()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 38	ansb:b	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   4: invokevirtual 161	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   7: ifeq +97 -> 104
    //   10: aload_0
    //   11: getfield 29	ansb:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   14: astore_1
    //   15: aload_1
    //   16: monitorenter
    //   17: aload_0
    //   18: getfield 53	ansb:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    ...
    //   29: aload_0
    //   30: getfield 27	ansb:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   71: aload_0
    //   72: aload 4
    //   74: invokevirtual 268	ansb:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   77: pop
    //   78: goto -41 -> 37
    //   81: astore_3
