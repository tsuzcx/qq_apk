...
public class bjlw
{
  ...
  {
    bjko.c("AppUpdate", "httpRequest >>> " + paramString1.toString());
    try
    {
    ...
    catch (JSONException paramContext)
    {
      ...
      for (;;)
      {
        bjko.c("AppUpdate", "httpRequest JSONException", paramContext);
        return;
        i = 0;
        continue;
        paramString1 = "0";
      ...
      bjko.c("AppUpdate", "use supportEtag");
      if (paramBoolean) {
        break label548;
      }
      paramString1 = bjlo.a(paramContext);
      ...
      bjko.c("AppUpdate", "execute asyncTask url >>> " + str2 + " methodName " + str3);
      a(new bjlg(str2, str3, new bjlx(paramContext, paramWebView, str1, str4, str5, paramBoolean)), localBundle);
      return;
    }
    catch (Exception paramContext)
    {
      bjko.c("AppUpdate", "httpRequest Exception", paramContext);
    }
    localBundle = new Bundle();
    localBundle.putString("platform", bizw.a().g());
    localBundle.putString("keystr", bizw.a().a());
    localBundle.putString("uin", paramString2);
    localBundle.putString("resolution", bjls.e());
    localBundle.putString("keytype", "256");
    if (bjlo.a(paramContext))
    {
      paramString1 = "1";
      ...
      while (paramString2.hasNext())
      {
        ...
        bjko.c("AppUpdate", "key = " + (String)localObject1 + " value = " + localObject2.toString());
  ...
  @TargetApi(11)
  protected static void a(bjlg parambjlg, Bundle paramBundle)
  {
