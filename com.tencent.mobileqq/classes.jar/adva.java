...
public class adva
  implements Runnable
{
  public adva(EmoticonManager paramEmoticonManager, int paramInt) {}
    ...
    catch (Exception localException)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqModelEmoticonManager.jdField_a_of_type_AndroidOsHandler != null) {
          this.jdField_a_of_type_ComTencentMobileqqModelEmoticonManager.jdField_a_of_type_AndroidOsHandler.post(new advb(this, localException));
        }
      }
    }
  }
