...
public class aing
{
  ...
  public static aipj a(int paramInt)
  {
    aips localaips = a();
    if (localaips == null) {
      return null;
  ...
  public static aipj a(int paramInt1, int paramInt2)
  {
    aips localaips = a();
    if (localaips == null) {
      return null;
    }
    return localaips.a(paramInt1, paramInt2);
  }
  
  public static aipj a(long paramLong)
  {
  ...
  public static aips a()
  {
    ...
    if ((localAppInterface instanceof CmGameAppInterface)) {
      return (aips)((CmGameAppInterface)localAppInterface).getManager(255);
    }
    return null;
  }
  
  public static aipx a(int paramInt)
  {
    aipj localaipj = a(paramInt);
    if (localaipj != null) {
      return localaipj.a();
    }
  ...
  public static aipx a(long paramLong)
  {
    aipj localaipj = b(paramLong);
    if (localaipj != null) {
      return localaipj.a();
  ...
  public static ApolloSurfaceView a()
  {
    ...
    {
      return null;
      localObject = ((aips)localObject).a();
    } while (localObject == null);
    return ((aipj)localObject).a();
  }
  ...
  public static void a(Activity paramActivity, Conversation paramConversation)
  {
    ...
    {
      return;
      localaifg = (aifg)a().getManager(153);
      if (a(null)) {
        localaifg.k = true;
      }
    } while ((localaifg == null) || (!localaifg.j) || (paramActivity == null) || (!(paramActivity instanceof SplashActivity)) || (paramActivity.isFinishing()) || (!((SplashActivity)paramActivity).isResume()) || (paramConversation == null));
    if (FrameHelperActivity.b())
    {
      FrameHelperActivity.c(true);
      FrameHelperActivity.s();
    }
    a(paramConversation.b, localaifg.a());
    localaifg.j = false;
  ...
  public static void a(View paramView, String paramString)
  {
    ...
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        localTextView.setBackgroundResource(2130838417);
        localTextView.setPadding((int)(babp.jdField_a_of_type_Float * 7.0F), (int)(babp.jdField_a_of_type_Float * 7.0F), (int)(babp.jdField_a_of_type_Float * 7.0F), 0);
        ...
        int i = (int)((float)babp.k() - babp.jdField_a_of_type_Float * 7.0F - localTextView.getMeasuredWidth());
        int j = (int)(localRect.bottom - 6.0F * babp.jdField_a_of_type_Float);
        ...
        bajr.a(a(), "cmshow", "Apollo", "plusbubbleexposure", 0, 0, new String[] { "" + c() });
      }
      return;
    }
  ...
  public static void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, int paramInt3, long paramLong, JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("sqVersion", "8.2.6.4370");
      ...
      paramJSONObject = new NewIntent(paramAppInterface.getApp(), aijp.class);
      ...
      paramJSONObject.setObserver(new ainh());
  ...
  public static void a(CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    else
    {
      ...
      if ((paramStartCheckParam.mStartType == 2) || (paramStartCheckParam.mStartType == 1) || (paramStartCheckParam.mStartType == 3))
      {
        ...
        if (localList != null)
        {
          ...
          if (i < localList.size())
          {
            localObject3 = (aipv)localList.get(i);
            if ((localObject3 == null) || (((aipv)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam == null)) {
              break label713;
            }
            localObject1 = localaips.a(((aipv)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
            if (localObject1 == null) {
              break label713;
            }
            localObject4 = ((aipj)localObject1).a();
            if ((((aipj)localObject1).a() != paramStartCheckParam.gameId) || ((paramStartCheckParam.roomId != 0L) && (paramStartCheckParam.roomId != ((ajdd)localObject4).jdField_a_of_type_Long))) {
              break label713;
            }
            if (((aipj)localObject1).a() == null) {
              break label1490;
            }
          }
        }
    ...
    label849:
    label1490:
    for (localObject1 = ((aipj)localObject1).a().getClass();; localObject1 = null)
    {
      QLog.i("cmgame_process.CmGameUtil", 1, " launchGame found old task.mStartCheckParam:" + ((aipv)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
      if (localObject1 == null)
      {
        if ((localList != null) && (localList.size() >= aips.jdField_a_of_type_ArrayOfJavaLangClass.length))
        {
          localObject2 = (aipv)localList.get(0);
          if ((localObject2 != null) && (((aipv)localObject2).jdField_a_of_type_JavaLangRefWeakReference != null))
          {
            localObject3 = (Activity)((aipv)localObject2).jdField_a_of_type_JavaLangRefWeakReference.get();
            if (localObject3 != null)
            {
              ((Activity)localObject3).finish();
              if (((aipv)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
              {
                aioy.a("cs.close_room.local", "{}", false, null, ((aipv)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                QLog.i("cmgame_process.CmGameUtil", 1, " launchGame close old  task.mStartCheckParam.gameId:" + ((aipv)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
              }
            }
          }
          localaips.jdField_a_of_type_JavaUtilList.remove(0);
        }
        localObject2 = new HashMap();
        i = 0;
        for (;;)
        {
          if (i < localaips.jdField_a_of_type_JavaUtilList.size())
          {
            localObject3 = (aipv)localaips.jdField_a_of_type_JavaUtilList.get(i);
            if ((localObject3 != null) && (((aipv)localObject3).jdField_a_of_type_JavaLangString != null)) {
              ((HashMap)localObject2).put(((aipv)localObject3).jdField_a_of_type_JavaLangString, ((aipv)localObject3).jdField_a_of_type_JavaLangString);
            }
            i += 1;
            continue;
            i += 1;
        ...
        i = 0;
        if (i >= aips.jdField_a_of_type_ArrayOfJavaLangClass.length) {
          break label1483;
        }
        if (TextUtils.isEmpty((String)((HashMap)localObject2).get(aips.jdField_a_of_type_ArrayOfJavaLangClass[i].getSimpleName())))
        {
          localObject2 = aips.jdField_a_of_type_ArrayOfJavaLangClass[i];
      ...
      for (;;)
      {
        ...
        {
          localObject1 = aips.jdField_a_of_type_ArrayOfJavaLangClass[0];
          QLog.e("cmgame_process.CmGameUtil", 1, "can not find activityClass, use first class");
        }
        localObject2 = new aipv();
        ((aipv)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam = paramStartCheckParam;
        ((aipv)localObject2).jdField_a_of_type_JavaLangString = ((Class)localObject1).getSimpleName();
        localaips.jdField_a_of_type_JavaUtilList.add(localObject2);
        for (;;)
        {
          if (QLog.isColorLevel())
          {
            localObject2 = localaips.jdField_a_of_type_JavaUtilList.iterator();
            for (;;)
            {
              if (((Iterator)localObject2).hasNext())
              {
                localObject3 = (aipv)((Iterator)localObject2).next();
                QLog.d("cmgame_process.CmGameUtil", 2, "launchGame task:" + ((aipv)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                continue;
                i += 1;
                break;
                ...
                {
                  aipv localaipv = (aipv)localList.get(i);
                  boolean bool2 = false;
                  localObject3 = localObject1;
                  if (localaipv != null)
                  {
                    localObject3 = localObject1;
                    if (localaipv.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
                    {
                      localObject3 = localaips.a(localaipv.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                      boolean bool1 = bool2;
                      localObject2 = localObject1;
                      if (localObject3 != null)
                      {
                        ajdd localajdd = ((aipj)localObject3).a();
                        bool1 = bool2;
                        localObject2 = localObject1;
                        if (((aipj)localObject3).a() == paramStartCheckParam.gameId) {
                          if (paramStartCheckParam.roomId != 0L)
                          {
                            bool1 = bool2;
                            localObject2 = localObject1;
                            if (paramStartCheckParam.roomId != localajdd.jdField_a_of_type_Long) {}
                          }
                          else
                          {
                            bool2 = true;
                            bool1 = bool2;
                            localObject2 = localObject1;
                            if (((aipj)localObject3).a() != null)
                            {
                              localObject2 = ((aipj)localObject3).a().getClass();
                              bool1 = bool2;
                            }
                          }
                        }
                      ...
                      if (!bool1)
                      {
                        if (localaipv.jdField_a_of_type_JavaLangRefWeakReference != null)
                        {
                          localObject1 = (Activity)localaipv.jdField_a_of_type_JavaLangRefWeakReference.get();
                          if (localObject1 != null)
                          {
                            ((Activity)localObject1).finish();
                            if (localaipv.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) {
                              aioy.a("cs.close_room.local", "{}", false, null, localaipv.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                            }
                            QLog.i("cmgame_process.CmGameUtil", 1, " launchGame close old  task.mStartCheckParam.gameId:" + localaipv.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                          }
                        }
                        ((List)localObject4).add(localaipv);
                        localObject3 = localObject2;
                      }
                    }
                  }
        ...
        for (;;)
        {
          ...
          localObject2 = aips.jdField_a_of_type_ArrayOfJavaLangClass[0];
          break;
  ...
  public static void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      localaiqs = a();
    } while (localaiqs == null);
    localaiqs.a(paramString1, paramString2, -1L, 4, false, null);
  }
  ...
  public static void a(Object... paramVarArgs)
  {
    aikb localaikb = a();
    if (localaikb != null) {
      localaikb.a("cmg_launch", 4, paramVarArgs);
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    ApolloGameData localApolloGameData = ((aiyu)localObject).a(paramStartCheckParam.gameId);
    aifg localaifg = (aifg)paramQQAppInterface.getManager(153);
    if (localaifg != null)
    {
      paramStartCheckParam.game = localApolloGameData;
      if ((localApolloGameData != null) && ((((aiyu)localObject).a(paramStartCheckParam.gameId)) || (paramStartCheckParam.isRequestConf))) {
        break label244;
      }
    }
    label244:
    for (boolean bool = true;; bool = false)
    {
      ...
      paramStartCheckParam.isWhiteUsr = localaifg.b((String)localObject);
      paramStartCheckParam.apolloStatus = localaifg.b((String)localObject);
      paramStartCheckParam.pushItem = localaifg.a().a();
      ...
      paramStartCheckParam.gender = ((ascz)paramQQAppInterface.getManager(106)).b();
      paramStartCheckParam.isEnableMSAA = c(paramStartCheckParam.gameId);
      paramStartCheckParam.mIsTransGame = aiyr.c.contains(Integer.valueOf(paramStartCheckParam.gameId));
      return true;
    }
  }
  ...
  public static int b()
  {
    ...
    aifg localaifg = (aifg)a().getManager(153);
    if ((localaifg != null) && (localaifg.i())) {
      return 1;
    }
    return 0;
  }
  ...
  public static int b(int paramInt)
  {
    try
    {
      ...
      ((StringBuilder)localObject).append(aiys.s).append(paramInt).append(File.separator).append("gameConfig.json");
      ...
      localObject = new JSONObject(bace.b((File)localObject)).optJSONArray("subpackages");
      if (localObject != null)
      {
  ...
  public static aipj b(int paramInt1, int paramInt2)
  {
    aips localaips = a();
    if (localaips == null) {
      return null;
    }
    return localaips.b(paramInt1, paramInt2);
  }
  
  public static aipj b(long paramLong)
  {
    aips localaips = a();
    if (localaips == null) {
      return null;
    }
    return localaips.a(paramLong);
  }
  ...
  public static String b(CmGameInitParams paramCmGameInitParams)
  {
    ...
    for (;;)
    {
      try
      {
        localJSONObject1 = aizc.a(0, aitw.a);
        ...
        if (("1".equals(paramCmGameInitParams.mGameName)) || ("2".equals(paramCmGameInitParams.mGameName)))
        {
          ...
          if ((!ApolloGameStateMachine.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.getAndSet(false)) || (ApolloGameStateMachine.jdField_a_of_type_Aill == null)) {
            break label999;
          }
          localJSONObject1.put("freeMemory", ApolloGameStateMachine.jdField_a_of_type_Aill.jdField_b_of_type_Long);
          localJSONObject1.put("totalMemory", ApolloGameStateMachine.jdField_a_of_type_Aill.jdField_c_of_type_Long);
          localJSONObject1.put("osVersion", aill.jdField_a_of_type_JavaLangString);
          localJSONObject1.put("model", aill.jdField_b_of_type_JavaLangString);
          localJSONObject1.put("cpuType", aill.jdField_c_of_type_JavaLangString);
          localJSONObject1.put("cpuNumber", aill.jdField_a_of_type_Int);
          localJSONObject1.put("cpuFrequency", aill.jdField_a_of_type_Long);
          localJSONObject1.put("gameVersion", paramCmGameInitParams.mVersion);
          localJSONObject1.put("QQVer", "8.2.6.4370");
      ...
      localJSONObject1.put("connType", badq.a(BaseApplicationImpl.getContext()));
      ...
      continue;
      label999:
      localJSONObject1.put("freeMemory", babp.a(Process.myPid()));
      localJSONObject1.put("totalMemory", babp.f());
      localJSONObject1.put("osVersion", babp.e());
      localJSONObject1.put("model", babp.i());
      localJSONObject1.put("cpuType", babp.g());
      localJSONObject1.put("cpuNumber", babp.b());
      localJSONObject1.put("cpuFrequency", babp.a());
    }
  }
  ...
  public static void b()
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localObject = (aifg)a().getManager(153);
        if ((localObject != null) && (((aifg)localObject).j())) {
          ((aifg)localObject).a().b();
        }
        i = a();
      } while (-1 == i);
      localObject = aind.a().a(i);
    } while (localObject == null);
    ((aipo)localObject).c();
  }
  ...
  public static void b(int paramInt)
  {
    try
    {
      ...
      ((baot)a().getBusinessHandler(71)).a("apollo_router_game.game_extend_linkcmd_set_plus_flag", localJSONObject.toString(), -1L, 0);
      return;
    }
    catch (Exception localException) {}
  }
  ...
  public static boolean c(int paramInt)
  {
    ...
    try
    {
      ...
      int i = new JSONObject(bace.b((File)localObject)).optInt("enableMSAA");
  ...
  public static int e()
  {
    ...
    if (jdField_a_of_type_Float < 0.0F) {
      jdField_a_of_type_Float = (float)babp.a() / 1.0F / 1024.0F;
    }
    if (d < 0L) {
      d = Math.ceil(babp.d() / 1073741824.0D);
    }
    if (QLog.isColorLevel()) {
