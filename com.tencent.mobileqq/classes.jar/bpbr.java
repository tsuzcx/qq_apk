  ...
  extends LinearLayout
{
  ...
  public bpbr(Context paramContext, int paramInt1, int paramInt2, float paramFloat, View.OnClickListener paramOnClickListener, bpbj parambpbj)
  {
    super(paramContext);
  ...
  private URLDrawable a(bpba parambpba)
  {
    Object localObject1 = (bojy)bogd.a().c(12);
    Object localObject2 = bojy.a();
    localObject1 = parambpba.b + "_static.png";
    ...
    for (;;)
    {
      ...
      return URLDrawable.getDrawable(parambpba, (URLDrawable.URLDrawableOptions)localObject1);
  ...
  private void a()
  {
    ...
    if (i < this.b)
    {
      View localView = LayoutInflater.from(getContext()).inflate(2131561705, null);
      ...
      for (;;)
      {
        ...
        ((ImageView)localView.findViewById(2131368890)).setPadding(k, k, k, k);
        addView(localView);
        i += 1;
        break;
        if (this.b - 1 == i) {
  ...
  private void a(bpba parambpba, URLImageView paramURLImageView, QIMCommonLoadingView paramQIMCommonLoadingView, ProgressBar paramProgressBar, bpbt parambpbt, boolean paramBoolean, bpbj parambpbj)
  {
    Object localObject1 = (bojy)bogd.a().c(12);
    Object localObject2 = bojy.a();
    localObject1 = parambpba.b + "_dynamic.png";
    localObject2 = new File((String)localObject2);
    String str;
    if (((File)localObject2).exists())
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        parambpbt.onLoadSuccessed(paramURLImageView, (URLDrawable)localObject1);
      }
    ...
    for (;;)
    {
      if (!bool1)
      {
        ...
        new java.lang.ref.WeakReference(parambpbj);
        parambpbj = parambpba.c;
        localObject1 = new HttpNetReq();
        ((HttpNetReq)localObject1).mCallback = new bpbs(this, (File)localObject2, paramQIMCommonLoadingView, paramURLImageView, str, paramBoolean, parambpbt, paramProgressBar);
        ((HttpNetReq)localObject1).mReqUrl = parambpbj;
        if (QLog.isColorLevel()) {
          QLog.d("InformationFaceAdapter", 2, "apng url:" + parambpbj);
        }
        ...
        ((HttpNetReq)localObject1).setUserData(parambpba);
  ...
  public void a(bpax parambpax, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramInt1 == paramInt2 - 1)
    {
      ...
      localObject2 = ((View)localObject1).findViewById(2131368892);
      localURLImageView = (URLImageView)((View)localObject1).findViewById(2131368890);
      localProgressBar = (ProgressBar)((View)localObject1).findViewById(2131368891);
      localQIMCommonLoadingView = (QIMCommonLoadingView)((View)localObject1).findViewById(2131368889);
      if (!(this.jdField_a_of_type_AndroidContentContext instanceof EditPicActivity)) {
        break label153;
      }
      localObject1 = parambpax.b(paramInt2);
      label111:
      if (localObject1 != null) {
        break label163;
      }
      ykq.e("InformationFaceAdapter", "FacePackage's thumbUri is empty , pkg : %s", new Object[] { parambpax.toString() });
    }
    for (;;)
    {
      paramInt2 += 1;
      ...
      break;
      label153:
      localObject1 = parambpax.a(paramInt2);
      break label111;
      label163:
      ...
      else
      {
        ...
        localObject2 = new bpbt((String)localObject1, localURLImageView, localProgressBar);
        localURLImageView.setURLDrawableDownListener((URLDrawableDownListener)localObject2);
        if ((this.jdField_a_of_type_AndroidContentContext instanceof EditPicActivity))
        {
          localObject1 = a((bpba)parambpax.a.get(paramInt2));
          if (localObject1 != null)
          {
            if (((URLDrawable)localObject1).getStatus() != 1) {
              ((URLDrawable)localObject1).restartDownload();
            ...
            if (((URLDrawable)localObject1).getStatus() == 1) {
              ((bpbt)localObject2).onLoadSuccessed(localURLImageView, (URLDrawable)localObject1);
            }
            if (paramBoolean) {}
            for (;;)
            {
        ...
        {
          a((bpba)parambpax.a.get(paramInt2), localURLImageView, localQIMCommonLoadingView, localProgressBar, (bpbt)localObject2, paramBoolean, this.jdField_a_of_type_Bpbj);
        }
      }
    }
  }
