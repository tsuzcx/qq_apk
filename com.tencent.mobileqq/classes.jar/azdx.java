  ...
  implements ViewTreeObserver.OnGlobalLayoutListener
{
  ...
  private azdy jdField_a_of_type_Azdy;
  private int b = 1;
  private int c;
  
  public azdx(Activity paramActivity)
  {
  ...
  public void a()
  {
    ...
    {
      this.b = 1;
      this.jdField_a_of_type_Azdy = null;
      this.c = 0;
      return;
  ...
  public void onGlobalLayout()
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidViewView != null)
      {
        ...
        if ((m != this.c) && (this.jdField_a_of_type_Azdy != null)) {
          this.jdField_a_of_type_Azdy.b(this.b, j, this.c);
        }
        this.c = m;
      }
    } while (j == this.c);
    ...
    {
      this.b = 1;
      if (this.jdField_a_of_type_Azdy != null) {
        this.jdField_a_of_type_Azdy.a(this.b, j, k);
      }
    }
    for (;;)
    {
