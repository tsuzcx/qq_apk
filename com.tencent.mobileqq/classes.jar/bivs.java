...
public final class bivs
{
  ...
  static ContentValues a(awge paramawge, String paramString)
  {
    ContentValues localContentValues = new ContentValues();
    Iterator localIterator = a(paramawge).iterator();
    while (localIterator.hasNext())
    {
      ...
      try
      {
        ...
        if ((localObject1 instanceof awge)) {
          localContentValues.putAll(a((awge)localObject1, str + "."));
        }
      }
  ...
  private static ContentValues a(List<awge> paramList, String paramString)
  {
    ContentValues localContentValues = new ContentValues();
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        localContentValues.put(paramString + i + ".-", ((awge)paramList.get(i)).getClass().getName());
        localContentValues.putAll(a((awge)paramList.get(i), paramString + i + "."));
        i += 1;
      }
    }
    return localContentValues;
  ...
  public static awge a(ContentValues paramContentValues, String paramString)
  {
    return a(paramContentValues, paramString, "");
  }
  
  private static awge a(ContentValues paramContentValues, String paramString1, String paramString2)
  {
    try
    {
      awge localawge = (awge)Class.forName(paramString1).newInstance();
      paramString1 = localawge;
      if (localawge != null)
      {
        paramString1 = a(localawge).iterator();
        while (paramString1.hasNext())
        {
          ...
          else if (localObject2 == List.class)
          {
            ...
            localField.set(localawge, localObject2);
          }
          else if (localObject2 == Long.TYPE)
          {
            localField.set(localawge, paramContentValues.getAsLong((String)localObject1));
          }
          else if (localObject2 == Integer.TYPE)
          {
            localField.set(localawge, paramContentValues.getAsInteger((String)localObject1));
          }
          else if (localObject2 == String.class)
          {
            localField.set(localawge, paramContentValues.getAsString((String)localObject1));
          }
          else if (localObject2 == Byte.TYPE)
          {
            localField.set(localawge, paramContentValues.getAsByte((String)localObject1));
          }
          else if (localObject2 == [B.class)
          {
            localField.set(localawge, paramContentValues.getAsByteArray((String)localObject1));
          }
          else if (localObject2 == Short.TYPE)
          {
            localField.set(localawge, paramContentValues.getAsShort((String)localObject1));
          }
          else if (localObject2 == Boolean.TYPE)
          {
            localField.set(localawge, paramContentValues.getAsBoolean((String)localObject1));
          }
          else if (localObject2 == Float.TYPE)
          {
            localField.set(localawge, paramContentValues.getAsFloat((String)localObject1));
          }
          else if (localObject2 == Double.TYPE)
          {
            localField.set(localawge, paramContentValues.getAsDouble((String)localObject1));
          }
        }
        if (localawge.getId() != -1L)
        {
  ...
  public static azwy a(StructMsgForImageShare paramStructMsgForImageShare)
  {
    if (paramStructMsgForImageShare.getItemCount() > 0)
    {
      paramStructMsgForImageShare = paramStructMsgForImageShare.getItemByIndex(0);
      if ((paramStructMsgForImageShare instanceof azyr))
      {
        paramStructMsgForImageShare = (azyr)paramStructMsgForImageShare;
        if ((paramStructMsgForImageShare.a.size() > 0) && ((paramStructMsgForImageShare.a.get(0) instanceof azwy))) {
          return (azwy)paramStructMsgForImageShare.a.get(0);
        }
      }
    }
    return null;
  ...
  public static bivn a(byte[] paramArrayOfByte)
  {
    if ((paramArrayOfByte == null) || (paramArrayOfByte.length <= 16)) {
      return null;
    }
    ...
    if ((localObject2 instanceof ChatMessage))
    {
      if ((localObject2 instanceof MessageForStructing))
      {
        ...
        {
          localObject1 = azvd.a((byte[])localObject1);
          ((MessageForStructing)localObject2).structingMsg = ((AbsStructMsg)localObject1);
        }
        return new bivn((ChatMessage)localObject2, paramArrayOfByte);
      }
      return new bivn((ChatMessage)localObject2, paramArrayOfByte);
    }
    return null;
  ...
  private static List<Field> a(awge paramawge)
  {
    Class localClass = paramawge.getClass();
    Object localObject1 = (List)a.get(localClass);
    paramawge = (awge)localObject1;
    if (localObject1 == null)
    {
      paramawge = new ArrayList();
      ...
      a.put(localClass.getName(), paramawge);
    }
    return paramawge;
  }
  
  public static List<bivm> a(List<byte[]> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      return null;
    }
    ...
    while (paramList.hasNext())
    {
      ...
      if (l1 != 2L)
      {
        ...
        if (l1 == 1L)
        {
          ...
          if (localObject != null) {
            localArrayList.add(new bivm(l2, l1, ((bivn)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage, ((bivn)localObject).jdField_a_of_type_JavaLangString));
        ...
        else if (l1 == 3L)
        {
          ...
          localObject = a((byte[])localObject);
          if (localObject != null) {
            localArrayList.add(new bivm(l2, l1, (ContentValues)localObject));
          }
        }
      }
    }
  ...
  public static void a(long paramLong, List<bivm> paramList1, List<bivm> paramList2)
  {
    ...
    for (;;)
    {
      ...
      {
        bivm localbivm = (bivm)paramList1.next();
        if (localbivm.b == paramLong) {
          paramList2.add(localbivm);
        }
      }
    }
  }
  ...
  public static void a(Context paramContext, int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = paramContext.getResources().getDimensionPixelSize(2131298914) - (int)bdgz.a(paramContext, 5.0F);
  ...
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    ...
    paramInt = paramContext.getResources().getDimensionPixelSize(2131298914) - (int)bdgz.a(paramContext, 5.0F);
    paramContext = Looper.getMainLooper();
    if (Thread.currentThread() != paramContext.getThread())
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForStructing paramMessageForStructing, List<ChatMessage> paramList, Map<String, String> paramMap, ArrayList<byte[]> paramArrayList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramList = (String)paramMap.get(abti.c(localChatMessage));
        ...
        continue;
        paramList = aupg.a().a(paramQQAppInterface, paramMessageForStructing.uniseq);
      }
  ...
  public static boolean a(Activity paramActivity)
  {
    if (!bdep.a())
    {
      a(paramActivity, 2131694075, 1);
      return false;
    }
    if (bdep.a() < 500L)
    {
      a(paramActivity, 2131694074, 1);
      return false;
    }
    return true;
  }
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, long paramLong, ChatMessage paramChatMessage, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      str = affg.a(paramQQAppInterface, paramChatMessage);
    }
  ...
  public static String[] a(byte[] paramArrayOfByte)
  {
    ...
    //   864: astore 21
    //   866: aload 9
    //   868: invokestatic 901	bivs:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   871: astore 25
    //   873: aload 4
    //   875: astore 23
    //   877: aload 5
    ...
    //   1070: astore 21
    //   1072: aload 9
    //   1074: invokestatic 901	bivs:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   1077: astore 24
    //   1079: aload 4
    //   1081: astore 23
    //   1083: aload 5
  ...
  public static byte[] b(QQAppInterface paramQQAppInterface, long paramLong, ChatMessage paramChatMessage, String paramString)
  {
    ...
    if (((paramChatMessage instanceof MessageForTroopFile)) || ((paramChatMessage instanceof MessageForFile)))
    {
      ...
      localObject = affg.a(paramQQAppInterface, paramChatMessage);
      a((FileManagerEntity)localObject);
      if (localObject == null) {
        break label219;
      }
      localbiva.a(paramQQAppInterface, null, (FileManagerEntity)localObject, paramChatMessage, true);
    }
    for (;;)
    {
      paramQQAppInterface = new ContentValues();
      localObject = (ContentValues)localbiva.a().getExtras().getParcelable("fileContents");
      if (localObject != null) {
        paramQQAppInterface.put("fileContents", a((ContentValues)localObject));
      }
      localObject = abti.c(paramChatMessage);
      ...
      localObject = arrr.a(paramQQAppInterface, (MessageForFile)paramChatMessage);
      break;
      label219:
      label483:
      if (QLog.isColorLevel())
      {
        ...
        if ((paramChatMessage instanceof MessageForTroopFile))
        {
          ...
          {
            a((FileManagerEntity)localObject);
            affg.a((FileManagerEntity)localObject, localMessageForTroopFile);
            if (localObject == null) {
              break label483;
            }
            localbiva.a(paramQQAppInterface, null, (FileManagerEntity)localObject, localMessageForTroopFile, true);
            break;
            if (QLog.isColorLevel()) {
              QLog.d("qqfav", 2, "parcelFileMsg, isMultiMsg T, find in db");
            }
            localObject = bcnt.a(paramQQAppInterface, localMessageForTroopFile);
            if (localObject != null)
            {
              FileManagerEntity localFileManagerEntity = affg.a((bbtn)localObject);
              localObject = bcmu.a(paramQQAppInterface, ((bbtn)localObject).b);
              if ((localObject != null) && (localFileManagerEntity != null) && (!TextUtils.isEmpty(localFileManagerEntity.strTroopFilePath)))
              {
                bbsa localbbsa = ((bcmu)localObject).a(localFileManagerEntity.strTroopFilePath);
                localObject = localFileManagerEntity;
                if (localbbsa != null)
                {
                  localFileManagerEntity.lastTime = localbbsa.c;
                  localFileManagerEntity.selfUin = String.valueOf(localbbsa.b);
                  localObject = localFileManagerEntity;
                }
              }
              else
