  ...
  extends afrl
{
  ...
  public afpr a;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new aftr(this);
  ...
  public aftn(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, boolean paramBoolean)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new afto(this));
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131302060)).setOnClickListener(new aftp(this));
    Button localButton = (Button)findViewById(2131297934);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new aftq(this));
  }
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Afpr = new afpr(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Beez, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Afpr);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new afts(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new aftt(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new aftu(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemLongClickListener(new aftv(this));
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Afpr.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Afpr.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, 1);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          this.jdField_c_of_type_AndroidWidgetTextView.setText(ajjy.a(2131649390));
        ...
        {
          this.jdField_a_of_type_Afpr.a((List)paramMessage.obj, paramMessage.arg1, this.jdField_d_of_type_Boolean, 0);
          this.jdField_a_of_type_Afpr.notifyDataSetChanged();
        }
        if (this.jdField_a_of_type_Afpr.getCount() == 0) {
          a(4, null);
        }
        for (;;)
        {
      ...
      this.jdField_a_of_type_Afpr.a(this.jdField_a_of_type_JavaUtilList, this.jdField_d_of_type_Boolean);
      if ((this.jdField_d_of_type_Boolean) && (this.jdField_a_of_type_Afpr.getCount() < 20))
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(ajjy.a(2131649392));
        this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131306299).setVisibility(8);
        this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
        this.jdField_b_of_type_AndroidViewView.setVisibility(0);
      }
    ...
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Afpr.a((List)localObject, this.jdField_d_of_type_Boolean);
    this.jdField_a_of_type_Afpr.notifyDataSetChanged();
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Afpr);
    this.jdField_a_of_type_ComTencentWidgetXListView.setSelection(0);
    this.jdField_a_of_type_JavaUtilList.clear();
