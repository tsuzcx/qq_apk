  ...
  implements afrc
{
  ...
  public aftn(BaseChatPie paramBaseChatPie)
  {
  ...
  private boolean a(BaseChatPie paramBaseChatPie)
  {
    ...
    {
      boolean bool4 = bftf.b(localSessionInfo.curFriendUin);
      boolean bool5 = bezm.b(paramBaseChatPie.app, localSessionInfo.curFriendUin);
      bool2 = bool1;
      if (!bool4)
      {
        bool2 = bool1;
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130838401);
      if (QLog.isColorLevel()) {
        QLog.d("UnreadBackBottomHelper", 2, "resume button to unread mode");
      }
      if (AppSetting.jdField_c_of_type_Boolean) {
        this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(amtj.a(2131689971) + this.jdField_a_of_type_Int + amtj.a(2131689972));
      }
    }
  }
  ...
  {
    if ((paramInt == 2) && (a(this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie))) {
      a(true);
    }
  }
      ...
      if (Math.abs(paramInt) >= 20) {
        ...
        else if ((this.jdField_a_of_type_AndroidWidgetTextView != null) && (this.jdField_a_of_type_Int == 0) && (!this.jdField_c_of_type_Boolean) && (!this.jdField_b_of_type_Boolean))
        {
          ...
          for (;;)
          {
            ...
            this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130838001);
            this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
            if (AppSetting.jdField_c_of_type_Boolean) {
              this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(amtj.a(2131689971));
            }
            if (this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie == null) {
              break;
            }
