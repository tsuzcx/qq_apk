...
import com.tencent.hippy.qq.module.tkd.TKDWupModule.HippyWupCallbackManager;
  ...
  extends BusinessHandler
{
  ...
  public aogi(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
  }
  
  public aogi(QQAppInterface paramQQAppInterface)
  {
  ...
  private List<BusinessGroupWord> a(List<DynamicBusinessHotWord.GroupWord> paramList)
  {
    ...
    bbyl.jdField_a_of_type_JavaUtilHashMap.clear();
    bbyl.b.clear();
    ...
    while (localIterator.hasNext())
    {
      ...
      bcdm localbcdm = new bcdm(((DynamicBusinessHotWord.GroupID)((DynamicBusinessHotWord.GroupWord)localObject1).group_id.get()).rpt_group_mask.get());
      ...
      bbyl.jdField_a_of_type_JavaUtilHashMap.put(bbyl.a(localbcdm.a), localArrayList2);
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (localRspBody.search_ver.has()) {
        bcnc.a("dynamic_unite_search.1", (long[])localObject2, localRspBody.search_ver.get().toStringUtf8());
      }
    ...
    {
      ((List)localObject2).add(new bcfd((UniteSearch.TabItemGroup)paramObject.get(i)));
      i += 1;
    }
    i = localRspBody.trigger_netword_num.get();
    if (i >= 0) {
      bhhr.q(BaseApplicationImpl.getContext(), i);
    }
    paramObject = localRspBody.item_groups.get();
    paramToServiceMsg = new bchf().a(new Object[] { str1, paramObject, Integer.valueOf(paramToServiceMsg.extraData.getInt("fromType")) });
    ...
    for (;;)
    {
      try
      {
        ...
        if (((DynamicTabSearch.RspBody)localObject1).search_ver.has()) {
          bcnc.a("dynamic_tab_search.1", arrayOfLong, ((DynamicTabSearch.RspBody)localObject1).search_ver.get().toStringUtf8());
        }
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilHashMap != null)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(Long.valueOf(paramToServiceMsg.extraData.getLong("time_stamp"))))
      {
        localObject1 = (aogj)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramToServiceMsg.extraData.getLong("time_stamp")));
    ...
    try
    {
      ...
      ((aogj)localObject1).a(paramToServiceMsg.msg_search_keywords.rcmds, paramToServiceMsg.msg_search_keywords.sessionid);
      return;
    }
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt, boolean paramBoolean)
  {
    ...
    if ((!paramBoolean) && (!bhhr.a(paramQQAppInterface.getCurrentAccountUin(), paramInt)))
    {
      if (QLog.isColorLevel()) {
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    paramQQAppInterface.sversion.set(a("8.4.10"));
  ...
  public void a(ByteStringMicro paramByteStringMicro, aogj paramaogj)
  {
    long l = System.currentTimeMillis();
    this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(l), paramaogj);
    paramaogj = new RequestSearchWord.ReqBody();
    paramaogj.bytes_rowkey.set(paramByteStringMicro);
    paramaogj.uint32_oper_type.set(1);
    paramByteStringMicro = qxp.a("OidbSvc.0xd78_0", 3448, 0, paramaogj.toByteArray());
    ...
    for (;;)
    {
      ...
      if (paramInt3 == 1)
      {
        ...
        if (!paramBoolean1)
        {
          ...
          ((DynamicSearch.RootSearcherRequest)localObject).rpt_busi_mask.set(bcnc.a(jdField_a_of_type_ArrayOfLong));
        ...
        i = 2;
        arrayOfString = bhhr.a(this.app.getCurrentAccountUin());
  ...
  public void a(String paramString1, String paramString2, int paramInt1, List<Long> paramList1, List<Long> paramList2, byte[] paramArrayOfByte, int paramInt2, double paramDouble1, double paramDouble2, Bundle paramBundle)
  {
    ...
    ((DynamicSearch.ExtensionRequestInfo)localObject).longitude.set((float)paramDouble2);
    int i;
    if (bbyl.jdField_a_of_type_JavaUtilHashMap.isEmpty()) {
      i = 0;
    }
    boolean bool;
    ...
    do
    {
      ...
      sendPbReq(paramList2);
      return;
      localIterator1 = bbyl.jdField_a_of_type_JavaUtilHashMap.values().iterator();
      paramInt1 = 2;
      i = paramInt1;
    } while (!localIterator1.hasNext());
    Iterator localIterator2 = ((List)localIterator1.next()).iterator();
    while (localIterator2.hasNext()) {
      if (paramString1.equals((bcdn)localIterator2.next())) {
        paramInt1 = 1;
      }
    }
    for (;;)
  ...
  public void a(byte[] paramArrayOfByte, TKDWupModule.HippyWupCallbackManager paramHippyWupCallbackManager, Integer paramInteger)
  {
    if (QLog.isColorLevel()) {
      QLog.i("Q.uniteSearch.UniteSearchHandler818searchProto_old", 2, "getUniteSearchDiscovery. fromHippy ：");
    }
    paramHippyWupCallbackManager = new DynamicDiscovery.ReqBody();
    paramHippyWupCallbackManager.version.set(ByteStringMicro.copyFromUtf8("8.4.10"));
    paramHippyWupCallbackManager.business.set(128);
    paramHippyWupCallbackManager.extend_type.set(1);
    paramHippyWupCallbackManager.jce_req_buffer.set(ByteStringMicro.copyFrom(paramArrayOfByte));
    ...
    try
    {
      paramArrayOfByte.putWupBuffer(paramHippyWupCallbackManager.toByteArray());
      label107:
      sendPbReq(paramArrayOfByte);
      return;
    }
    catch (Exception paramHippyWupCallbackManager)
    {
      break label107;
    }
  }
  ...
  public void b(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    QLog.d("Q.uniteSearch.UniteSearchHandler818searchProto_old", 1, "sasa_report=" + paramString1 + " module=" + paramString2 + "ver2=" + paramString3 + "ver4=" + paramString5 + "ver7=" + paramString6);
    long l = System.currentTimeMillis();
    String str1 = paramQQAppInterface.getCurrentAccountUin();
    String str2 = dw.a(dw.a());
    paramQQAppInterface = new DynamicKdReport.ReqBody();
    ...
    for (;;)
    {
      try
      {
        ...
        if (localRspBody.error_msg.get() != null)
        {
          ...
          bhhr.a(this.app.getCurrentAccountUin(), i, localRspBody.expire_time.get());
          paramToServiceMsg = localRspBody.result_items.get();
          paramObject = bcgq.a(this.app, paramToServiceMsg, i);
          if (localRspBody.bucket_id.get() == null) {
            break label313;
          }
          paramToServiceMsg = localRspBody.bucket_id.get().toStringUtf8();
          bcjs.jdField_b_of_type_JavaLangString = paramToServiceMsg;
