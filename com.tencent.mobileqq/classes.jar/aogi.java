...
public class aogi
{
  ...
  public static aolq a(BaseApplicationImpl paramBaseApplicationImpl)
  {
    aogg.a().a(419, 0L, false);
    aolr localaolr = new aolr();
    paramBaseApplicationImpl = a(419, paramBaseApplicationImpl);
    if (paramBaseApplicationImpl != null) {
      try
      {
        paramBaseApplicationImpl = localaolr.a(paramBaseApplicationImpl);
        if (paramBaseApplicationImpl != null) {
  ...
  private static aogf[] a(int paramInt, BaseApplicationImpl paramBaseApplicationImpl)
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      localObject1[i] = new aogf(Integer.valueOf(str).intValue(), paramBaseApplicationImpl.getString(paramInt + "_" + str, null));
      i += 1;
    }
    return localObject1;
  }
