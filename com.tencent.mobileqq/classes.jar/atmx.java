...
public class atmx
  extends atnc
{
  public atmx(ajrl paramajrl, String paramString)
  {
    ...
    catch (Exception paramatmz)
    {
      try
      {
        if (paramClass.getName().equals(MessageRecord.class.getName()))
        {
          ...
          paramatmz = paramCursor.getString(paramCursor.getColumnIndex("extStr"));
          int k = paramCursor.getInt(paramCursor.getColumnIndex("istroop"));
          MessageRecord localMessageRecord = awbi.a(i, paramClass, j, paramatmz, k);
          localMessageRecord.msgData = paramClass;
          localMessageRecord._id = l1;
          localMessageRecord.extLong = j;
          localMessageRecord.extStr = paramatmz;
