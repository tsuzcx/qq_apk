...
public class atwa
  ...
  implements Handler.Callback, bleb
{
  ...
  private atwr jdField_a_of_type_Atwr;
  ...
  public atwa(Context paramContext, QQAppInterface paramQQAppInterface, QQGamePubAccountFragment paramQQGamePubAccountFragment)
  {
  ...
  public void a()
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559205, null, false);
    localRelativeLayout.setLayoutParams(new RecyclerView.LayoutParams(-1, 0));
    this.jdField_a_of_type_Atwr = new atwr(localRelativeLayout, this.jdField_a_of_type_AndroidContentContext);
  ...
  {
    this.jdField_a_of_type_AndroidAppDialog = new ReportDialog(this.jdField_a_of_type_AndroidContentContext, 2131755267);
    Object localObject = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131559212, null);
    RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(AIOUtils.dp2px(280.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), -1);
    ((ImageView)((View)localObject).findViewById(2131368597)).setImageDrawable(URLDrawable.getDrawable("https://cmshow.gtimg.cn/client/gameCenter/gameCenter_popView_card@2x.png"));
    TextView localTextView1 = (TextView)((View)localObject).findViewById(2131379893);
    if ((!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(paramString3)))
    {
      localTextView1.setText(paramString2);
      localTextView1.setTextColor(atzc.a(-16733441, 1593879295));
      ((ImageView)((View)localObject).findViewById(2131361945)).setImageDrawable(URLDrawable.getDrawable("https://cmshow.gtimg.cn/client/gameCenter/gameCenter_arrow@2x.png"));
      paramString2 = (CheckBox)((View)localObject).findViewById(2131364520);
      TextView localTextView2 = (TextView)((View)localObject).findViewById(2131379523);
      TextView localTextView3 = (TextView)((View)localObject).findViewById(2131379679);
      localTextView3.setTextColor(atzc.a(-16733441, 1593879295));
      ...
      paramString2.setOnCheckedChangeListener(new atwd(this, paramString1));
      localTextView2.setOnClickListener(new atwe(this, paramString4));
      localTextView1.setOnClickListener(new atwf(this, paramString4, paramString3));
      localTextView3.setOnClickListener(new atwg(this, paramString4, paramJSONObject, (String)localObject));
      this.jdField_a_of_type_AndroidAppDialog.show();
      paramString1 = new HashMap();
      abet.a(paramString1, paramString4);
    ...
    for (;;)
    {
      ...
      abet.a(alvx.a(), "769", "205710", a().gameAppId, "76905", "1", "160", paramString1);
      return;
      localTextView1.setText(amtj.a(2131709430));
      break;
      label410:
  ...
  {
    b();
    this.jdField_a_of_type_AndroidWidgetFrameLayout$LayoutParams.topMargin = AIOUtils.dp2px(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    ...
    if (paramBoolean1)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(amtj.a(2131709414));
      return;
    }
    if (paramBoolean2)
    {
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(amtj.a(2131709416));
  }
  ...
  public void b()
  {
    if (this.jdField_b_of_type_AndroidWidgetLinearLayout == null)
    {
      ...
      ((FrameLayout.LayoutParams)localObject2).leftMargin = AIOUtils.dp2px(7.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      this.jdField_b_of_type_AndroidWidgetTextView.setText(amtj.a(2131709417));
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mFailedDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130847085);
      ((URLDrawable.URLDrawableOptions)localObject1).mLoadingDrawable = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130847085);
      ...
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      localObject3 = new LinearLayout.LayoutParams(AIOUtils.dp2px(15.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), AIOUtils.dp2px(15.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      localFrameLayout.setLayoutParams(new RecyclerView.LayoutParams(-1, AIOUtils.dp2px(120.0F, this.jdField_a_of_type_AndroidContentContext.getResources())));
      this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      ...
      this.jdField_b_of_type_AndroidWidgetTextView.setText(amtj.a(2131709407));
      ...
      ((LinearLayout.LayoutParams)localObject3).leftMargin = AIOUtils.dp2px(7.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      this.jdField_c_of_type_AndroidWidgetTextView.setText(amtj.a(2131709432));
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.clearAnimation();
    this.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(amtj.a(2131709424));
  ...
  {
    blec.a().b(this);
    if (this.jdField_a_of_type_Bldr != null) {
      bldt.b(this.jdField_a_of_type_Bldr);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.arg1 == 0)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setText(amtj.a(2131709425));
      return false;
    }
    this.jdField_a_of_type_AndroidWidgetImageView.clearAnimation();
  ...
  {
    if (a(paramInt)) {
      if ((paramViewHolder instanceof atwr)) {
        ((atwr)paramViewHolder).a(this.jdField_a_of_type_ComTencentMobileqqGamecenterDataFeedsItemData$TopCardInfo, this);
      }
    }
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            if ((!(paramViewHolder instanceof atwj)) && (!(paramViewHolder instanceof atwh))) {
              break;
            }
          ...
          {
            localObject2 = (atwj)paramViewHolder;
            ((atwj)localObject2).a(this, (FeedsItemData)localObject1, paramInt);
            ((atwj)localObject2).d.setTag(a().gameAppId);
            localObject2 = new HashMap();
            abet.a((Map)localObject2, ((FeedsItemData)localObject1).msgId);
            ...
            {
              abet.a(alvx.a(), "769", "205021", (String)localObject1, "76902", "1", "160", (Map)localObject2);
              break;
            }
          }
        } while (((FeedsItemData)localObject1).type != 4);
        ((atwh)paramViewHolder).a(this, (FeedsItemData)localObject1, paramInt);
        localObject2 = new HashMap();
        abet.a((Map)localObject2, ((FeedsItemData)localObject1).msgId);
        ((Map)localObject2).put(Integer.valueOf(2), ((FeedsItemData)localObject1).msgId);
        ((Map)localObject2).put(Integer.valueOf(4), "8");
      ...
      } while (!(paramViewHolder instanceof atxd));
      localObject1 = a(paramInt);
    } while (localObject1 == null);
    ((atxd)paramViewHolder).a((FeedsItemData)localObject1);
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    if (this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt) != null)
    {
      if (paramInt == this.jdField_a_of_type_Int) {
        return this.jdField_a_of_type_Atwr;
      }
      return new atwb(this, (View)this.jdField_a_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt));
    }
    if (this.jdField_b_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt) != null) {
      return new atwc(this, (View)this.jdField_b_of_type_AndroidSupportV4UtilSparseArrayCompat.get(paramInt));
    }
    if (paramInt == 4)
    {
      ...
      ((LinearLayout)localObject1).setPadding(AIOUtils.dp2px(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, AIOUtils.dp2px(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ...
      ((TextView)localObject3).setId(2131378707);
      ((TextView)localObject3).setEllipsize(TextUtils.TruncateAt.END);
      Object localObject4 = new RelativeLayout.LayoutParams(-1, AIOUtils.dp2px(45.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((RelativeLayout.LayoutParams)localObject4).setMargins(AIOUtils.dp2px(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), AIOUtils.dp2px(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), AIOUtils.dp2px(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ...
      ((TextView)localObject4).setId(2131363070);
      ((TextView)localObject4).setEllipsize(TextUtils.TruncateAt.END);
      ((TextView)localObject4).setMaxWidth(AIOUtils.dp2px(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      RelativeLayout.LayoutParams localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.setMargins(AIOUtils.dp2px(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), AIOUtils.dp2px(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, AIOUtils.dp2px(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      localLayoutParams2.addRule(3, 2131378707);
      ((RelativeLayout)localObject2).addView((View)localObject4, localLayoutParams2);
      localObject4 = new TextView(this.jdField_a_of_type_AndroidContentContext);
      ((TextView)localObject4).setTextColor(-6052957);
      ((TextView)localObject4).setTextSize(12.0F);
      ((TextView)localObject4).setMaxLines(1);
      ((TextView)localObject4).setId(2131371967);
      ((TextView)localObject4).setEllipsize(TextUtils.TruncateAt.END);
      localLayoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams2.leftMargin = AIOUtils.dp2px(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      localLayoutParams2.addRule(6, 2131363070);
      localLayoutParams2.addRule(1, 2131363070);
      ((RelativeLayout)localObject2).addView((View)localObject4, localLayoutParams2);
      localObject4 = new TextView(this.jdField_a_of_type_AndroidContentContext);
      ((TextView)localObject4).setTextColor(-6052957);
      ((TextView)localObject4).setTextSize(10.0F);
      ((TextView)localObject4).setMaxLines(1);
      ((TextView)localObject4).setId(2131367410);
      ((TextView)localObject4).setBackgroundColor(1270796256);
      ((TextView)localObject4).setPadding(AIOUtils.dp2px(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), AIOUtils.dp2px(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), AIOUtils.dp2px(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), AIOUtils.dp2px(3.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((TextView)localObject3).setEllipsize(TextUtils.TruncateAt.END);
      localObject3 = new RelativeLayout.LayoutParams(-2, -2);
      ((RelativeLayout.LayoutParams)localObject3).setMargins(0, AIOUtils.dp2px(-1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), AIOUtils.dp2px(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0);
      ((RelativeLayout.LayoutParams)localObject3).addRule(6, 2131363070);
      ...
      ((CornerImageView)localObject2).setId(2131368476);
      localLayoutParams = new LinearLayout.LayoutParams(0, AIOUtils.dp2px(71.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      localLayoutParams.weight = 3.0F;
      localLayoutParams.gravity = 16;
      ((LinearLayout)localObject1).addView((View)localObject2, localLayoutParams);
      paramViewGroup.addView((View)localObject1, localLayoutParams1);
      localObject1 = new ImageView(this.jdField_a_of_type_AndroidContentContext);
      localLayoutParams1 = new RelativeLayout.LayoutParams(-1, AIOUtils.dp2px(1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ((ImageView)localObject1).setImageDrawable(new ColorDrawable(-263173));
      ((ImageView)localObject1).setId(2131365665);
      ((ImageView)localObject1).setPadding(AIOUtils.dp2px(25.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), 0, 0, 0);
      localLayoutParams1.rightMargin = AIOUtils.dp2px(4.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      paramViewGroup.addView((View)localObject1, localLayoutParams1);
      return new atwh(paramViewGroup);
    }
    if ((paramInt == 5) || (paramInt == 7) || (paramInt == 6)) {
      return atxi.a(this.jdField_a_of_type_AndroidContentContext, paramInt, paramViewGroup);
    }
    return new atwj(LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559204, paramViewGroup, false));
  }
  
  public void onViewDetachedFromWindow(RecyclerView.ViewHolder paramViewHolder)
  {
    super.onViewDetachedFromWindow(paramViewHolder);
    if ((paramViewHolder instanceof atwj))
    {
      paramViewHolder = (atwj)paramViewHolder;
      if ((paramViewHolder.a != null) && (atxz.a().a() == paramViewHolder.a))
      {
