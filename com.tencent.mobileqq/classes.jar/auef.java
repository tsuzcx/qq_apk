  ...
  implements Handler.Callback
{
  ...
  private static ConcurrentHashMap<Integer, ConcurrentHashMap<Integer, aueh>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  private aueh b(int paramInt1, int paramInt2, aueg paramaueg)
  {
    paramaueg = new aueh(paramInt1, paramaueg);
    ((ConcurrentHashMap)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt2))).put(Integer.valueOf(paramInt1), paramaueg);
    return paramaueg;
  }
  
  public aueh a(int paramInt1, int paramInt2, @Nonnull aueg paramaueg)
  {
    try
    {
      ...
      aueh localaueh2 = (aueh)((ConcurrentHashMap)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt2))).get(Integer.valueOf(paramInt1));
      aueh localaueh1 = localaueh2;
      if (localaueh2 == null) {
        localaueh1 = b(paramInt1, paramInt2, paramaueg);
      }
      return localaueh1;
    }
    finally {}
  ...
  public void a()
  {
    ...
    while (localIterator1.hasNext())
    {
      ...
      while (localIterator2.hasNext()) {
        ((aueh)((Map.Entry)localIterator2.next()).getValue()).a(false);
      }
    }
  }
  ...
  public void c()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        i = bgae.a(bgae.a(), "libFounderColorFont_818.so");
        if (!QLog.isColorLevel()) {
          break label131;
        }
