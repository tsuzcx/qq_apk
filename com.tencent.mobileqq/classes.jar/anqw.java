...
public class anqw
{
  ...
  public anqw(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, String paramString)
  {
  ...
  public static anqw a(Bundle paramBundle)
  {
    int j = 0;
    int n = -1;
    String str = "";
    ...
    {
      return new anqw(i, j, k, m, n, paramBundle);
      m = -1;
      k = -1;
      i = -1;
    }
