...
public class ansg
  extends anrh
{
  public ansg(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  private boolean C()
  {
    ...
    if (!TextUtils.isEmpty(str)) {
      wjy.a(this.jdField_a_of_type_AndroidContentContext, str, new ansh(this), null);
    }
    for (;;)
    {
      return true;
  ...
  private boolean D()
  {
    ...
    if ((((vxx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(252)).a) && (!"open".equals(this.c)) && (!"openTag".equals(this.c)) && (!"openSquare".equals(this.c)) && (!"publish".equals(this.c))) {
      return F();
    }
  ...
  private boolean E()
  {
    ...
    {
      xvv.b("QQstoryAction", "startStoryMainActivity, isNowTabShow==true");
      ...
      if (!(this.jdField_a_of_type_AndroidContentContext instanceof Activity)) {
        xvv.e("QQstoryAction", "Error: context is not instanceof Activity, context is: " + String.valueOf(this.jdField_a_of_type_AndroidContentContext));
      }
      if (localIntent == null) {
        xvv.e("QQstoryAction", "Error: jumpIntent is null");
      }
      return false;
    }
    xvv.b("QQstoryAction", "startStoryMainActivity, isNowTabShow==false");
  ...
  private boolean F()
  {
    ...
    Object localObject = new xfk((Activity)this.jdField_a_of_type_AndroidContentContext, new ansi(this));
    Intent localIntent = e(new Intent());
    if (localIntent != null)
    {
      int i = localIntent.getIntExtra("action", 0);
      localIntent.putExtra("action", 0);
      return ((xfk)localObject).a(i, localIntent);
    }
    return false;
  }
  ...
  private static void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, int paramInt, String paramString4)
  {
    if (paramString1.equals(paramString2)) {
      xwa.a("mystory", "clk_obj", 0, 0, new String[] { "", "", "", paramString3 });
    }
    ...
    wmu.b(paramActivity, paramString3, paramString1, i);
  }
  ...
  private static void a(Activity paramActivity, HashMap<String, String> paramHashMap)
  {
    ...
    if (!TextUtils.isEmpty(paramHashMap)) {
      wmu.a(paramActivity, new OpenPlayerBuilder(new DiscoverBannerPlayInfo(paramHashMap), 102).a());
    }
  }
  ...
  private static boolean a(Activity paramActivity, HashMap<String, String> paramHashMap, String paramString1, String paramString2, int paramInt1, String paramString3, int paramInt2)
  {
    ...
    if (!TextUtils.isEmpty(paramString2)) {
      wmu.a(paramActivity, paramString2, VideoCollectionEntry.getCollectionKey(1, str, paramString2), i, paramInt1, paramString3, paramInt2, null);
    }
    for (;;)
    {
      return true;
      ...
      wmu.a(paramActivity, paramString1, VideoCollectionEntry.getCollectionKey(1, str, paramString1), i, paramInt1, paramString3, paramInt2, null);
    }
    return false;
  }
  ...
  private static boolean a(Activity paramActivity, HashMap<String, String> paramHashMap, String paramString1, String paramString2, String paramString3, int paramInt1, String paramString4, int paramInt2)
  {
    ...
    if (TextUtils.isEmpty(str))
    {
      ...
      wmu.a(paramActivity, paramString3, paramString4, paramInt2);
    }
    for (;;)
    {
      return true;
      ...
      if (!TextUtils.isEmpty(paramString2))
      {
        wmu.a(paramActivity, paramString2, VideoCollectionEntry.getCollectionKey(1, str, paramString2), i, paramInt1, paramString4, paramInt2, null);
      }
      else
      {
        if (TextUtils.isEmpty(paramString1)) {
        ...
        wmu.a(paramActivity, paramString1, VideoCollectionEntry.getCollectionKey(1, str, paramString1), i, paramInt1, paramString4, paramInt2, null);
      }
    }
    return false;
  }
  ...
  private static boolean a(Activity paramActivity, HashMap<String, String> paramHashMap, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, String paramString5, boolean paramBoolean, int paramInt2)
  {
    if (paramBoolean)
    {
      ...
      if (!TextUtils.isEmpty(paramString2)) {
        wmu.a(paramActivity, paramString2, paramString5, paramInt2, paramInt1, 0, null);
      }
    }
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramString1))
      {
        wmu.a(paramActivity, paramString1, paramString5, paramInt2, paramInt1, 0, null);
      }
      else
      {
        return true;
        if ((!TextUtils.isEmpty(paramString4)) && (paramString4.equals(String.valueOf(1))))
        {
          ...
          wmu.b(paramActivity, paramString3, paramString5, paramInt2);
        }
  ...
  private static boolean a(Activity paramActivity, HashMap<String, String> paramHashMap, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    if (paramString1.equals(paramString4)) {
      xwa.a("mystory", "clk_obj_myday", 0, 0, new String[] { "", "", "", paramString5 });
    }
    ...
    if (!TextUtils.isEmpty(paramString3)) {
      wmu.a(paramActivity, paramString3, paramString6, 1, 109, 1, null);
    }
    for (;;)
    {
      return true;
      ...
      wmu.a(paramActivity, paramString2, paramString6, 1, 109, 1, null);
    }
    return false;
  }
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          default: 
            ...
            wmu.b(paramActivity, str1, paramQQAppInterface, j);
            return true;
            j = 1;
            break;
          case 1: 
          ...
          case 3: 
            ...
            wmu.a(paramActivity, str1, str3, j);
            return true;
          case 4: 
          ...
          case 7: 
            ...
            wmu.b(paramActivity, str1, str3, j);
            return true;
          case 6: 
            j = i;
            if (i == 0) {
            ...
            return true;
          case 5: 
            wmu.a(paramActivity, str5, str3, j, i, 0, null);
            return true;
          case 8: 
            j = i;
            if (i == 0) {
  ...
  public static boolean b(QQAppInterface paramQQAppInterface, Activity paramActivity, HashMap<String, String> paramHashMap, String paramString)
  {
    ...
    if (paramQQAppInterface == null)
    {
      ...
      if (str1 == null)
      {
        ...
        wmu.b(paramActivity, paramQQAppInterface, str2, j);
        break label453;
      }
    }
    for (;;)
    {
      wmu.b(paramActivity, paramQQAppInterface, paramHashMap, j);
      break label453;
      break label130;
      break;
      label435:
  ...
  private Intent c(Intent paramIntent, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      xwa.a("basic", "use_api", 0, 0, new String[] { "5", (String)this.jdField_a_of_type_JavaUtilHashMap.get("parter_api"), "", str });
    }
  ...
  private Intent e(Intent paramIntent)
  {
    ...
    {
      xvv.a("QQstoryAction", "makeStoryJumpActivity() action=%s isFromApi=%s", this.c, Boolean.valueOf(bool));
      xvv.a("QQstoryAction", "makeStoryJumpActivity() attr=%s", String.valueOf(this.jdField_a_of_type_JavaUtilHashMap));
      if (!"open".equals(this.c)) {
        break;
      }
  ...
  private Intent e(Intent paramIntent, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      xwa.a("basic", "use_api", 0, 0, new String[] { "6", (String)this.jdField_a_of_type_JavaUtilHashMap.get("parter_api"), "", str });
    }
