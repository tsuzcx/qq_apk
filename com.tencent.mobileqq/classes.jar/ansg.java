  ...
  implements bgvz
{
  ...
  public ansg(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Ansh = new ansh(this);
  }
  ...
  public static bgwc a(UpgradeInfo paramUpgradeInfo)
  {
  ...
  private void a(EntityManager paramEntityManager, GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    {
      return;
      localAppShareID = bhch.a(paramGetResourceRespInfo);
    ...
    for (;;)
    {
      this.app.getMsgHandler().a.a(localAppShareID.strPkgName, localAppShareID);
  ...
  private boolean a(String paramString, long paramLong)
  {
    ...
    do
    {
      ...
      if ("eggs_android_CI_4.7.1".equals(paramString))
      {
        ...
        {
          FileUtils.deleteFile(new File(this.app.getApplication().getFilesDir(), "eggs_config.zip").getAbsolutePath());
          FileUtils.deleteFile(afut.b);
          FileUtils.deleteFile(afut.c);
          bool1 = false;
          afut.a().a(this.app.getApplication());
  ...
  private void b(UpgradeDetailWrapper paramUpgradeDetailWrapper)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          bdla.b((QQAppInterface)localObject2, "CliOper", "", "", "0X8004DA5", "0X8004DA5", 0, 0, (String)localObject1, "", bgvx.a(), "");
          ...
          ((Intent)localObject1).putExtra("StrTitle", anvx.a(2131701923));
          ((Intent)localObject1).putExtra("StrUpgradeDesc", anvx.a(2131701926));
  ...
  private void b(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      {
        return;
        localamee = (amee)this.app.getManager(QQManagerFactory.WEATHER_MANAGER);
    ...
    this.app.execute(new ConfigHandler.3(this, paramGetResourceRespInfo, localamee, l1));
  }
  ...
  private void c(UpgradeDetailWrapper paramUpgradeDetailWrapper)
  {
    ...
    {
      bjnn.a().a(BaseActivity.sTopActivity, "biz_src_yyb");
  ...
  {
    atpk.jdField_a_of_type_Boolean = true;
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   10: astore 9
    //   12: aload_2
    //   13: invokevirtual 763	com/tencent/qphone/base/remote/FromServiceMsg:isSuccess	()Z
    //   16: ifeq +187 -> 203
    //   19: aload_3
    //   20: ifnull +183 -> 203
    //   23: iconst_1
    ...
    //   61: iload 8
    //   63: invokevirtual 479	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   66: ldc_w 861
    //   69: invokevirtual 63	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   72: iload 6
    //   74: invokevirtual 479	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    ...
    //   83: aload_0
    //   84: iload 6
    //   86: putfield 863	ansg:b	Z
    //   89: iload 6
    //   91: ifne +98 -> 189
    //   94: getstatic 867	com/tencent/common/app/BaseApplicationImpl:sApplication	Lcom/tencent/common/app/BaseApplicationImpl;
    //   97: invokevirtual 871	com/tencent/common/app/BaseApplicationImpl:getResources	()Landroid/content/res/Resources;
    //   100: pop
    //   101: new 197	android/content/Intent
    //   104: dup
    //   105: invokespecial 624	android/content/Intent:<init>	()V
    //   108: astore 12
    //   110: aload 12
    //   112: ldc_w 873
    //   115: iconst_1
    ...
    //   122: ldc_w 628
    //   125: aload 11
    //   127: invokevirtual 637	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   130: pop
    //   131: aload 12
    //   133: ldc_w 639
    //   136: aload 10
    //   138: invokevirtual 637	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   141: pop
    //   142: aload 12
    //   144: ldc_w 875
    //   147: aload 9
    //   149: invokevirtual 637	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   152: pop
    //   153: aload 12
    //   155: ldc_w 877
    //   158: aload_2
    //   159: invokevirtual 637	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   162: pop
    //   163: aload 12
    //   165: ldc_w 879
    //   168: aload_1
    //   169: invokevirtual 637	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   172: pop
    //   173: aload 12
    //   175: ldc_w 881
    //   178: aload_3
    //   179: invokevirtual 637	android/content/Intent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   182: pop
    //   183: aload_0
    //   184: aload 12
    //   186: invokespecial 659	ansg:a	(Landroid/content/Intent;)V
    //   189: aload_0
    //   190: bipush 11
    //   192: iload 8
    //   194: iload 6
    //   196: invokestatic 301	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   199: invokevirtual 349	ansg:notifyUI	(IZLjava/lang/Object;)V
    //   202: return
    //   203: iconst_0
    //   204: istore 8
    //   206: goto -180 -> 26
    //   209: aload_3
    //   210: checkcast 883	MAAccessClient/AccessRsp
    //   213: astore 14
    //   215: aload 14
    //   217: getfield 886	MAAccessClient/AccessRsp:ret	I
    //   220: istore 4
    //   222: iload 4
    //   224: iconst_1
    ...
    //   254: goto -217 -> 37
    //   257: aload 14
    //   259: getfield 889	MAAccessClient/AccessRsp:body	[B
    //   262: ifnull +489 -> 751
    //   265: aload 14
    //   267: getfield 889	MAAccessClient/AccessRsp:body	[B
    //   270: arraylength
    //   271: ifle +480 -> 751
    //   274: new 891	com/qq/taf/jce/JceInputStream
    //   277: dup
    //   278: aload 14
    //   280: getfield 889	MAAccessClient/AccessRsp:body	[B
    //   283: invokespecial 894	com/qq/taf/jce/JceInputStream:<init>	([B)V
    //   286: astore_2
    //   287: new 896	MAAccessClient/CheckSinglePkgSigRsp
    //   290: dup
    //   291: invokespecial 897	MAAccessClient/CheckSinglePkgSigRsp:<init>	()V
    //   294: astore_1
    //   295: aload_1
    //   296: aload_2
    //   297: invokevirtual 901	MAAccessClient/CheckSinglePkgSigRsp:readFrom	(Lcom/qq/taf/jce/JceInputStream;)V
    //   300: aload_1
    //   301: ifnull +28 -> 329
    //   304: aload_1
    //   305: getfield 902	MAAccessClient/CheckSinglePkgSigRsp:ret	I
    //   308: iconst_1
    //   309: if_icmpeq +20 -> 329
    //   312: aload_1
    //   313: getfield 902	MAAccessClient/CheckSinglePkgSigRsp:ret	I
    //   316: iconst_m1
    //   317: if_icmpeq +12 -> 329
    //   320: aload_1
    //   321: getfield 902	MAAccessClient/CheckSinglePkgSigRsp:ret	I
    //   324: bipush 100
    ...
    //   344: goto -44 -> 300
    //   347: aload_1
    //   348: getfield 902	MAAccessClient/CheckSinglePkgSigRsp:ret	I
    //   351: ifne +346 -> 697
    //   354: aload_1
    //   355: getfield 906	MAAccessClient/CheckSinglePkgSigRsp:vtMarket	Ljava/util/ArrayList;
    //   358: ifnull +387 -> 745
    //   361: aload_1
    //   362: getfield 906	MAAccessClient/CheckSinglePkgSigRsp:vtMarket	Ljava/util/ArrayList;
    //   365: invokevirtual 912	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   368: astore_2
    //   369: iconst_0
    //   370: istore 5
    //   372: iload 5
    //   374: istore 7
    //   376: aload_2
    //   377: invokeinterface 917 1 0
    //   382: ifeq +154 -> 536
    //   385: aload_2
    //   386: invokeinterface 921 1 0
    //   391: checkcast 923	MAAccessClient/NoCheckMarket
    //   394: astore_3
    //   395: iload 5
    //   397: istore 7
    //   399: aload_3
    //   400: getfield 926	MAAccessClient/NoCheckMarket:pkgName	Ljava/lang/String;
    ...
    //   413: iload 5
    //   415: ifne +23 -> 438
    //   418: getstatic 867	com/tencent/common/app/BaseApplicationImpl:sApplication	Lcom/tencent/common/app/BaseApplicationImpl;
    //   421: aload_3
    //   422: getfield 926	MAAccessClient/NoCheckMarket:pkgName	Ljava/lang/String;
    //   425: aload_3
    //   426: getfield 929	MAAccessClient/NoCheckMarket:versionCode	I
    //   429: aload_3
    //   430: getfield 932	MAAccessClient/NoCheckMarket:signatureMd5	Ljava/lang/String;
    //   433: invokestatic 937	bkwl:a	(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;)Z
    //   436: istore 6
    //   438: invokestatic 940	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   441: ifeq +45 -> 486
    //   444: ldc 54
    //   446: iconst_4
    ...
    //   460: aload_3
    //   461: getfield 926	MAAccessClient/NoCheckMarket:pkgName	Ljava/lang/String;
    ...
    //   473: aload_3
    //   474: getfield 929	MAAccessClient/NoCheckMarket:versionCode	I
    ...
    //   495: iload 6
    //   497: istore 7
    //   499: invokestatic 940	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   502: ifeq +34 -> 536
    //   505: ldc 54
    //   507: iconst_4
    ...
    //   521: iload 6
    //   523: invokevirtual 479	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    ...
    //   534: istore 7
    //   536: aload_1
    //   537: getfield 947	MAAccessClient/CheckSinglePkgSigRsp:pkgSig	Ljava/lang/String;
    //   540: astore 13
    //   542: aload_1
    //   543: getfield 950	MAAccessClient/CheckSinglePkgSigRsp:tmastUrl	Ljava/lang/String;
    //   546: astore 12
    //   548: aload_1
    //   549: getfield 953	MAAccessClient/CheckSinglePkgSigRsp:pageUrl	Ljava/lang/String;
    //   552: astore_2
    //   553: aload_1
    //   554: getfield 956	MAAccessClient/CheckSinglePkgSigRsp:sigVersionCode	I
    //   557: istore 4
    ...
    //   584: astore 10
    //   586: invokestatic 940	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   589: ifeq +41 -> 630
    //   592: ldc 54
    //   594: iconst_4
    ...
    //   630: aload 14
    //   632: getfield 964	MAAccessClient/AccessRsp:tips	LMAAccessClient/Tips;
    //   635: ifnull +101 -> 736
    //   638: aload 14
    //   640: getfield 964	MAAccessClient/AccessRsp:tips	LMAAccessClient/Tips;
    //   643: getfield 969	MAAccessClient/Tips:title	Ljava/lang/String;
    //   646: astore_3
    //   647: aload 14
    //   649: getfield 964	MAAccessClient/AccessRsp:tips	LMAAccessClient/Tips;
    //   652: getfield 972	MAAccessClient/Tips:content	Ljava/lang/String;
    //   655: astore_2
    //   656: aload 14
    //   658: getfield 964	MAAccessClient/AccessRsp:tips	LMAAccessClient/Tips;
    //   661: getfield 975	MAAccessClient/Tips:button	Ljava/lang/String;
    //   664: astore_1
    //   665: aload_1
    //   666: astore 9
    //   668: iload 7
    ...
    //   713: iload 5
    //   715: ifeq -670 -> 45
    //   718: getstatic 867	com/tencent/common/app/BaseApplicationImpl:sApplication	Lcom/tencent/common/app/BaseApplicationImpl;
    //   721: invokestatic 978	bkwl:a	(Landroid/content/Context;)Z
    //   724: pop
    //   725: iload 5
    //   727: istore 6
    //   729: goto -684 -> 45
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        bgvx.a().a(bool1, str2, paramToServiceMsg);
        return;
        i = 0;
        break;
  ...
  private void e(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      localbbvn = (bbvn)this.app.getManager(QQManagerFactory.STATUS_MANAGER);
    } while (localbbvn == null);
    if (!localbbvn.a(paramGetResourceRespInfo.uiNewVer))
    {
      notifyUI(7, true, Integer.valueOf(100));
      return;
    }
    ...
    this.app.execute(new ConfigHandler.6(this, str, localbbvn, paramGetResourceRespInfo));
  }
      ...
      while (QLog.isColorLevel())
      {
        ...
        if (i == 10)
        {
          ...
          for (paramObject = paramObject.string_tips_action_url.get();; paramObject = "")
          {
            ...
            paramObject = (asqt)this.app.getManager(QQManagerFactory.EXTEND_FRIEND_LIMIT_CHAT_MANAGER);
            paramObject.a(bool1);
            paramObject.a(bool2, (String)localObject, paramFromServiceMsg, paramToServiceMsg);
            this.app.getPreferences().edit().putBoolean("has_auth_real_name_extendfriend", bool1).putBoolean("has_request_auth_real_name_extendfriend", true).commit();
  ...
  public void a(int paramInt, UpgradeDetailWrapper paramUpgradeDetailWrapper, bgvx parambgvx)
  {
    parambgvx = paramUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo;
    if ((paramInt == 0) && (parambgvx != null))
    {
      BaseApplicationImpl.sApplication.getPackageName();
      a(parambgvx);
      a(this.app, parambgvx.strNewTipsDescURL, parambgvx.iTipsWaitDay);
      b(this.app, parambgvx.strBannerPicUrl, parambgvx.iDisplayDay);
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   28: aload_2
    //   29: invokevirtual 763	com/tencent/qphone/base/remote/FromServiceMsg:isSuccess	()Z
    //   32: invokevirtual 479	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   35: ldc_w 944
    ...
    //   68: invokestatic 664	bgvx:a	()Lbgvx;
    //   71: astore_3
    //   72: aload_3
    //   73: invokevirtual 1291	bgvx:a	()Lcom/tencent/mobileqq/upgrade/UpgradeDetailWrapper;
    //   76: astore_1
    //   77: aload_2
    //   78: ifnull +337 -> 415
    //   81: aload_2
    //   82: invokevirtual 763	com/tencent/qphone/base/remote/FromServiceMsg:isSuccess	()Z
    //   85: ifeq +330 -> 415
    //   88: aload 7
    //   90: ifnull +325 -> 415
    //   93: new 767	tencent/im/oidb/oidb_sso$OIDBSSOPkg
    //   96: dup
    //   97: invokespecial 768	tencent/im/oidb/oidb_sso$OIDBSSOPkg:<init>	()V
    //   100: astore_2
    //   101: aload_2
    //   102: aload 7
    //   104: invokevirtual 771	tencent/im/oidb/oidb_sso$OIDBSSOPkg:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   107: pop
    //   108: aload_2
    //   109: getfield 775	tencent/im/oidb/oidb_sso$OIDBSSOPkg:uint32_result	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   112: invokevirtual 1292	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   115: ifeq +300 -> 415
    //   118: aload_2
    //   119: getfield 775	tencent/im/oidb/oidb_sso$OIDBSSOPkg:uint32_result	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   122: invokevirtual 779	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   125: ifne +290 -> 415
    //   128: new 1294	tencent/im/oidb/cmd0x5eb/oidb_0x5eb$RspBody
    //   131: dup
    //   132: invokespecial 1295	tencent/im/oidb/cmd0x5eb/oidb_0x5eb$RspBody:<init>	()V
    //   135: astore 7
    //   137: aload 7
    //   139: aload_2
    //   140: getfield 784	tencent/im/oidb/oidb_sso$OIDBSSOPkg:bytes_bodybuffer	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   143: invokevirtual 328	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   146: invokevirtual 793	com/tencent/mobileqq/pb/ByteStringMicro:toByteArray	()[B
    //   149: invokevirtual 1296	tencent/im/oidb/cmd0x5eb/oidb_0x5eb$RspBody:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   152: pop
    //   153: aload 7
    //   155: getfield 1300	tencent/im/oidb/cmd0x5eb/oidb_0x5eb$RspBody:rpt_msg_uin_data	Lcom/tencent/mobileqq/pb/PBRepeatMessageField;
    //   158: invokevirtual 1303	com/tencent/mobileqq/pb/PBRepeatMessageField:size	()I
    //   161: ifle +254 -> 415
    //   164: aload 7
    //   166: getfield 1300	tencent/im/oidb/cmd0x5eb/oidb_0x5eb$RspBody:rpt_msg_uin_data	Lcom/tencent/mobileqq/pb/PBRepeatMessageField;
    //   169: iconst_0
    //   170: invokevirtual 1306	com/tencent/mobileqq/pb/PBRepeatMessageField:get	(I)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   173: checkcast 1308	tencent/im/oidb/cmd0x5eb/oidb_0x5eb$UdcUinData
    //   176: getfield 1309	tencent/im/oidb/cmd0x5eb/oidb_0x5eb$UdcUinData:uint32_preload_disable_flag	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   179: invokevirtual 779	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   182: istore 4
    //   184: aload_1
    //   185: monitorenter
    ...
    //   220: aload_1
    //   221: iconst_1
    //   222: putfield 1312	com/tencent/mobileqq/upgrade/UpgradeDetailWrapper:jdField_a_of_type_Boolean	Z
    //   225: iload 4
    //   227: iconst_1
    ...
    //   232: istore 5
    //   234: aload_1
    //   235: getfield 1314	com/tencent/mobileqq/upgrade/UpgradeDetailWrapper:jdField_b_of_type_ProtocolKQQConfigUpgradeInfo	Lprotocol/KQQConfig/UpgradeInfo;
    //   238: ifnull +212 -> 450
    //   241: iload 4
    //   243: ifne +244 -> 487
    //   246: aload_1
    //   247: getfield 1315	com/tencent/mobileqq/upgrade/UpgradeDetailWrapper:jdField_a_of_type_Int	I
    //   250: iconst_1
    ...
    //   284: iload 5
    //   286: invokevirtual 479	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    ...
    //   297: istore 6
    //   299: aload_0
    //   300: getfield 205	ansg:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   303: iload 6
    //   305: invokestatic 1319	ansg:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Z)V
    ...
    //   324: aload_1
    //   325: getfield 1314	com/tencent/mobileqq/upgrade/UpgradeDetailWrapper:jdField_b_of_type_ProtocolKQQConfigUpgradeInfo	Lprotocol/KQQConfig/UpgradeInfo;
    //   328: ifnull +135 -> 463
    //   331: aload_1
    //   332: getfield 726	com/tencent/mobileqq/upgrade/UpgradeDetailWrapper:jdField_a_of_type_ComTencentMobileqqUpgradeNewUpgradeConfig	Lcom/tencent/mobileqq/upgrade/NewUpgradeConfig;
    //   335: ifnull +128 -> 463
    //   338: aload_1
    //   339: getfield 1314	com/tencent/mobileqq/upgrade/UpgradeDetailWrapper:jdField_b_of_type_ProtocolKQQConfigUpgradeInfo	Lprotocol/KQQConfig/UpgradeInfo;
    //   342: getfield 577	protocol/KQQConfig/UpgradeInfo:iUpgradeType	I
    //   345: ifeq +118 -> 463
    ...
    //   364: aload_0
    //   365: getfield 205	ansg:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   368: getstatic 1328	com/tencent/mobileqq/app/BusinessHandlerFactory:CONFIG_HANDLER	I
    //   371: invokevirtual 1332	com/tencent/mobileqq/app/QQAppInterface:getBusinessHandler	(I)Lcom/tencent/mobileqq/app/BusinessHandler;
    //   374: checkcast 2	ansg
    //   377: astore_2
    //   378: aload_3
    //   379: aload_1
    //   380: getfield 1314	com/tencent/mobileqq/upgrade/UpgradeDetailWrapper:jdField_b_of_type_ProtocolKQQConfigUpgradeInfo	Lprotocol/KQQConfig/UpgradeInfo;
    //   383: aload_2
    //   384: invokevirtual 1335	bgvx:a	(Lprotocol/KQQConfig/UpgradeInfo;Lbgvz;)Z
    //   387: pop
    //   388: aload_1
    //   389: monitorexit
    //   390: return
    ...
    //   394: goto -342 -> 52
    //   397: astore_2
    //   398: invokestatic 52	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   401: ifeq +14 -> 415
    //   404: ldc_w 544
    //   407: iconst_2
    //   408: ldc_w 587
    //   411: aload_2
    //   412: invokestatic 846	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   415: iconst_0
    //   416: istore 4
    //   418: goto -234 -> 184
    //   421: iload 4
    ...
    //   427: invokestatic 664	bgvx:a	()Lbgvx;
    //   430: invokevirtual 1336	bgvx:b	()V
    //   433: goto +57 -> 490
    //   436: aload_1
    //   437: getfield 1315	com/tencent/mobileqq/upgrade/UpgradeDetailWrapper:jdField_a_of_type_Int	I
    //   440: iconst_2
    ...
    //   450: aload_1
    //   451: iload 4
    //   453: putfield 1338	com/tencent/mobileqq/upgrade/UpgradeDetailWrapper:jdField_b_of_type_Int	I
    //   456: iload 5
    //   458: istore 6
    //   460: goto -161 -> 299
    //   463: invokestatic 52	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   466: ifeq -78 -> 388
    //   469: ldc_w 556
    //   472: iconst_2
    //   473: ldc_w 1340
    //   476: invokestatic 74	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   479: goto -91 -> 388
    //   482: astore_2
    //   483: aload_1
    //   484: monitorexit
  ...
  public void a(ToServiceMsg paramToServiceMsg, Object paramObject)
  {
    if (paramObject == null) {
      if (paramToServiceMsg.extraData.getBoolean("reqRegionConfig")) {
        ((anrz)this.app.getManager(QQManagerFactory.CONDITION_SEARCH_MANAGER)).a(null);
      }
    }
    do
    {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (paramObject.sResType == 2)
        {
          ...
          {
            localObject = (anrz)this.app.getManager(QQManagerFactory.CONDITION_SEARCH_MANAGER);
            if (localObject != null) {
              ((anrz)localObject).a(paramObject);
            }
          }
        ...
        {
          localObject = (asbm)this.app.getManager(QQManagerFactory.EARLY_DOWNLOAD_MANAGER);
          if (localObject != null) {
            ((asbm)localObject).a(paramObject);
          }
        }
      }
    }
  ...
  public void a(String paramString, int paramInt, ArrayList<QQOperationViopTipTask> paramArrayList)
  {
    ...
    Object localObject2 = arpb.a(this.app);
    paramArrayList = paramArrayList.iterator();
    while (paramArrayList.hasNext())
    {
      QQOperationViopTipTask localQQOperationViopTipTask = ((arpb)localObject2).a(((QQOperationViopTipTask)paramArrayList.next()).taskid);
      ...
      ((arpb)localObject2).a(this.app, localQQOperationVoipTipsTaskExcuteRecord);
    }
    notifyUI(8, true, localObject1);
  }
  
  public void a(String paramString, int paramInt, ArrayList<arpe> paramArrayList, boolean paramBoolean)
  {
    if (TextUtils.isEmpty(paramString)) {
      return;
    }
      ...
      try
      {
        ...
        if (paramInt == 3000)
        {
          ...
          if (paramArrayList != null)
          {
            ...
            if (paramArrayList.hasNext())
            {
              arpe localarpe = (arpe)paramArrayList.next();
              MobileTips.TaskInfo localTaskInfo = new MobileTips.TaskInfo();
              localTaskInfo.task_id.set(localarpe.jdField_a_of_type_Int);
              localTaskInfo.msgcnt.set(localarpe.jdField_b_of_type_Int);
              localTaskInfo.keywords.set(localarpe.jdField_a_of_type_JavaUtilArrayList);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (short s = 1;; s = 2)
    {
      ((ByteBuffer)localObject).putInt(bhbx.a(l)).put((byte)0).putShort((short)1).putShort((short)-23463).putShort((short)2).putShort(s);
  ...
  public boolean a()
  {
    boolean bool = bkwl.b(BaseApplicationImpl.sApplication);
    if (QLog.isDevelopLevel()) {
    ...
    try
    {
      localObject2 = bkwg.a(new File(BaseApplicationImpl.sApplication.getPackageResourcePath()));
    ...
    ((ToServiceMsg)localObject2).extraData.putInt("mv", arqj.a(this.app.getApp()));
    ((ToServiceMsg)localObject2).extraData.putInt("sv", DeviceInfoUtil.getOsVersion());
  ...
  public boolean a(String paramString1, int paramInt, String paramString2)
  {
    ...
    localToServiceMsg.extraData.putInt("mv", arqj.a(this.app.getApp()));
    localToServiceMsg.extraData.putInt("sv", DeviceInfoUtil.getOsVersion());
  ...
  {
    Object localObject = (bbvn)this.app.getManager(QQManagerFactory.STATUS_MANAGER);
    if (localObject == null) {
      return null;
    }
    long l = ((bbvn)localObject).a();
  ...
  {
    anrz localanrz = (anrz)this.app.getManager(QQManagerFactory.CONDITION_SEARCH_MANAGER);
    if (localanrz == null) {
      return null;
    }
    GetResourceReqInfo localGetResourceReqInfo = new GetResourceReqInfo();
    ...
    localGetResourceReqInfo.uiCurVer = localanrz.a(true);
    localGetResourceReqInfo.sResType = 2;
    localGetResourceReqInfo.sLanType = 0;
    localGetResourceReqInfo.sReqType = 1;
    return localGetResourceReqInfo;
  ...
  public void e()
  {
    ...
    try
    {
      ...
      ((ByteBuffer)localObject).putInt(bhbx.a(Long.parseLong(this.app.getAccount()))).putShort((short)16);
  ...
  public GetResourceReqInfo f()
  {
    ...
    if (!((SharedPreferences)localObject).getString("SettingQlinkResistTerroristLastAccount", "0").equalsIgnoreCase(str))
    {
      ...
      this.app.getFileTransferHandler().a();
    }
    for (;;)
    {
  ...
  public void f()
  {
    ...
    do
    {
      ...
      {
        return;
        if (asll.a().a(this.app, BaseApplicationImpl.getApplication()) != 0) {
          break;
        }
      } while (!QLog.isColorLevel());
