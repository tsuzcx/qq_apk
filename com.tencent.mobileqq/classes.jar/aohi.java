...
{
  aohi(aohh paramaohh, String paramString, long paramLong, boolean paramBoolean) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    Object localObject = null;
    if (QLog.isColorLevel()) {
      QLog.d("UniformDownloadMgr<FileAssistant>", 2, "handleCheck, success: " + paramBoolean + ", canceled: " + aohh.a(this.jdField_a_of_type_Aohh));
    }
    Activity localActivity = (Activity)aohh.a(this.jdField_a_of_type_Aohh).get();
    if ((aohh.a(this.jdField_a_of_type_Aohh)) || (localActivity == null) || (localActivity.isFinishing())) {
      return;
    }
    ...
    for (;;)
    {
      ...
      catch (InvalidProtocolBufferMicroException paramBundle)
      {
        ...
        continue;
        this.jdField_a_of_type_Aohh.a.sendEmptyMessage(2);
      }
      abju.a(localActivity, localIntent, PublicFragmentActivity.class, ApkFileDownloadFragment.class);
