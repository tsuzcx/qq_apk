...
public class nhp
{
  private static nhp jdField_a_of_type_Nhp;
  ...
  public static nhp a()
  {
    if (jdField_a_of_type_Nhp == null) {}
    try
    {
      if (jdField_a_of_type_Nhp == null) {
        jdField_a_of_type_Nhp = new nhp();
      }
      return jdField_a_of_type_Nhp;
    }
    finally {}
  }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (l1 = Math.abs(l4 - l2);; l1 = 0L)
        {
          ...
          {
            ((bdmc)localObject2).a("", "actAVGameMainCost", bool, l1, l3, (HashMap)localObject1, "", true);
            if (!QLog.isColorLevel()) {
              break;
            }
