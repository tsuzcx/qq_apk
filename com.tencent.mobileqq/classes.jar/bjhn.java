...
public class bjhn
  implements bjhl, NetworkState.NetworkStateListener
{
  private static bjhn jdField_a_of_type_Bjhn;
  ...
  private bjhk jdField_a_of_type_Bjhk = new bjhk();
  ...
  private bjhn()
  {
    this.jdField_a_of_type_Bjhk.a(this);
    a();
  }
  ...
  public static bjhn a()
  {
    try
    {
      if (jdField_a_of_type_Bjhn == null) {
        jdField_a_of_type_Bjhn = new bjhn();
      }
      bjhn localbjhn = jdField_a_of_type_Bjhn;
      return localbjhn;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bjho(this, localHandlerThread.getLooper());
    ...
    for (int i = 1;; i = 0)
    {
      if (paramInt2 != 0)
      {
        if ((paramStatReportRequest != null) && (paramStatReportRequest.size() > 0) && (i == 0))
        {
          ...
          while (paramInt2 < i)
          {
            ...
            paramStatReportResponse = bjgz.a().a(String.valueOf(j));
            if (paramStatReportResponse != null) {
              paramStatReportRequest.addAll(paramStatReportResponse);
            }
            bjgz.a().a(String.valueOf(j), paramStatReportRequest);
            paramInt2 += 1;
          }
        }
      }
      else if ((i != 0) && (paramStatReportRequest != null) && (paramStatReportRequest.size() > 0))
      {
        ...
        while (paramStatReportRequest.hasNext())
        {
          ...
          bjgz.a().a(String.valueOf(paramStatReportResponse.type));
        }
      }
