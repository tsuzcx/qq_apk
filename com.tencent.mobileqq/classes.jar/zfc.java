...
public class zfc
{
  ...
  public static String a(int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      bgmg.c(wes.e + ".nomedia");
      str = wes.e + b(paramInt) + "/";
    }
    for (;;)
    {
      a(str);
      return str;
      str = anhk.br + "edit_video/business_" + paramInt + "/" + b(paramInt) + "/";
      bgmg.c(str + ".nomedia");
    }
  }
  ...
  private static void a(String paramString)
  {
    ...
    if (paramString.isFile())
    {
      ...
      yqp.d("Q.qqstory.publish.edit.PublishFileManager", "delete file : " + bool);
    }
    if (!paramString.exists())
    {
      bool = paramString.mkdirs();
      yqp.d("Q.qqstory.publish.edit.PublishFileManager", "create folder : " + bool);
    }
  }
