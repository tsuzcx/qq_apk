...
{
  public ajmh(NewFlowCameraActivity paramNewFlowCameraActivity) {}
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if ("tencent.av.v2q.StartVideoChat".equals(paramContext))
    {
      ...
      paramContext = BaseActivity2.$(this.a.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewCameraCover, 2131366495);
    ...
    if ("tencent.video.q2v.startUploadPTV".equals(paramContext))
    {
      ...
      case 1: 
        ...
        {
          str = "";
          if (this.a.jdField_a_of_type_Ajnj != null) {
            str = this.a.jdField_a_of_type_Ajnj.a();
          }
    ...
    for (;;)
    {
      ...
      {
        ajlj.a("", paramContext, str, "", NewFlowCameraActivity.a(this.a), "");
        if (QLog.isColorLevel()) {
      ...
      if (i == 2)
      {
        ...
        if (bool)
        {
          ...
          azmj.b(null, "dc00898", "", "", "0X8007BB6", "0X8007BB6", 0, 0, "", "", "", "");
