  ...
  implements Manager
{
  ...
  ThreadLocal<SimpleDateFormat> jdField_a_of_type_JavaLangThreadLocal = new bfqm(this);
  protected Map<String, JSONObject> a;
  protected boolean a;
  protected final int b;
  protected SparseArray<bfqi> b;
  String b;
  protected String c;
  
  public bfql(QQAppInterface paramQQAppInterface)
  {
    ...
    while (i < j)
    {
      ...
      bfqi localbfqi = new bfqi();
      localbfqi.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getString("appinfo_date_" + k, "");
      localbfqi.jdField_b_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getInt("KEY_APP_LIST_TIME_STAMP_" + k, 0);
      this.jdField_b_of_type_AndroidUtilSparseArray.put(k, localbfqi);
      i += 1;
    }
    f();
    d();
    ...
    this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getString("appinfo_all_app_string", anni.a(2131713863));
  }
  ...
  private void f()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      if (((ListIterator)localObject1).hasNext())
      {
        ...
        bfqi localbfqi = (bfqi)this.jdField_b_of_type_AndroidUtilSparseArray.get(((TroopAIOAppInfo)localObject3).groupType);
        zkb.a(localbfqi);
        localbfqi.a(((TroopAIOAppInfo)localObject3).appid, (TroopAIOAppInfo)localObject3);
      }
    }
  ...
  {
    bfqi localbfqi = (bfqi)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
    if (localbfqi != null) {}
    ...
    return localbfqi.jdField_b_of_type_Int;
  }
  
  public TroopAIOAppInfo a(int paramInt1, int paramInt2)
  {
    Object localObject1 = (bfqi)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt2, null);
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        localObject1 = (TroopAIOAppInfo)((bfqi)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt1));
        if (localObject1 != null)
        {
  ...
  public List<TroopAIOAppInfo> a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_Anwd.a(1, paramInt, null, paramBoolean);
    }
    ArrayList localArrayList = new ArrayList();
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      Object localObject2 = (bfqi)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
      zkb.a(localObject2);
      localObject2 = ((bfqi)localObject2).a().iterator();
  ...
  public void a()
  {
    bfqo[] arrayOfbfqo = bfqo.jdField_a_of_type_ArrayOfBfqo;
    int j = arrayOfbfqo.length;
    int i = 0;
    while (i < j)
    {
      bfqo localbfqo = arrayOfbfqo[i];
      Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getString("KEY_APP_CONFIG_PREFIX-" + localbfqo.jdField_a_of_type_JavaLangString, null);
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        localObject = localbfqo.a((String)localObject);
        this.jdField_a_of_type_JavaUtilMap.put(localbfqo.jdField_a_of_type_JavaLangString, localObject);
      }
      i += 1;
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    bfqi localbfqi = (bfqi)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt, null);
    if (localbfqi != null) {}
    for (boolean bool = true;; bool = false)
    {
      zkb.a(bool);
      if (localbfqi != null) {
        localbfqi.jdField_a_of_type_JavaLangString = ((String)localObject);
      }
  ...
  {
    bfqi localbfqi = (bfqi)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt2);
    boolean bool;
    if (localbfqi != null)
    {
      bool = true;
    ...
    do
    {
      ...
      bool = false;
      break;
      TroopAIOAppInfo localTroopAIOAppInfo = (TroopAIOAppInfo)localbfqi.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(Integer.valueOf(paramInt1));
      if (localTroopAIOAppInfo != null)
      {
        zkb.a(localbfqi.a(localTroopAIOAppInfo));
  ...
  public void a(int paramInt, boolean paramBoolean, String paramString)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
      {
        ...
        b();
        ??? = new bcsy(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("add_page").d("Clk_app").a(new String[] { paramString }).a(new String[] { String.valueOf(paramInt) });
        if (paramBoolean)
        {
          paramString = "0";
          ((bcsy)???).a(new String[] { paramString }).a();
          return;
        }
      }
      paramString = "1";
  ...
  public void a(ArrayList<Integer> paramArrayList)
  {
    ...
    bfqi localbfqi = (bfqi)this.jdField_b_of_type_AndroidUtilSparseArray.get(0, null);
    if (localbfqi != null) {}
    for (boolean bool = true;; bool = false)
    {
      zkb.a(bool);
      ...
      } while (localbfqi.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(localInteger));
      QLog.w(".troop.troop_app", 1, "TroopAppMgr:sortTroopAppList error, there is no appid in hashtable");
      return;
    }
    this.jdField_a_of_type_Anwd.a(a(0), paramArrayList);
  }
  ...
  public void a(ArrayList<TroopAIOAppInfo> paramArrayList, int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        localbfqi.a(localTroopAIOAppInfo.appid, localTroopAIOAppInfo);
      }
    }
    label104:
  ...
  public void a(ArrayList<Integer> paramArrayList1, ArrayList<Integer> paramArrayList2)
  {
    ...
    do
    {
      ...
      {
        this.jdField_a_of_type_Anwd.a(a(0), paramArrayList1, paramArrayList2);
        return;
      }
    } while (!QLog.isColorLevel());
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    {
      bfqo localbfqo = arrayOfbfqo[i];
      JSONObject localJSONObject = localbfqo.a(paramJSONObject.optJSONObject(localbfqo.jdField_a_of_type_JavaLangString));
      if (localJSONObject != null) {
        a(localbfqo.jdField_a_of_type_JavaLangString, localJSONObject);
      }
      i += 1;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean) {
          localbfqi.jdField_a_of_type_Int |= 0x2;
        } else {
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean) {
          localbfqi.jdField_a_of_type_Int |= 0x1;
        } else {
  ...
  public boolean a(int paramInt)
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 44	bfql:jdField_b_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   8: iload_1
    //   9: aconst_null
    //   10: invokevirtual 285	android/util/SparseArray:get	(ILjava/lang/Object;)Ljava/lang/Object;
    //   13: checkcast 71	bfqi
    //   16: astore 4
    //   18: aload 4
    //   20: ifnull +20 -> 40
    //   23: iconst_1
    ...
    //   42: goto -17 -> 25
    //   45: aload 4
    //   47: getfield 480	bfqi:jdField_a_of_type_Int	I
    //   50: istore_1
    //   51: iload_1
    //   52: iconst_1
    //   53: iand
  ...
  public boolean a(TroopAIOAppInfo paramTroopAIOAppInfo)
  {
    ...
    Object localObject = (bfqi)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramTroopAIOAppInfo.groupType);
    boolean bool1;
    if (localObject != null)
    {
      bool1 = true;
    ...
    do
    {
      ...
      bool1 = false;
      break;
      localObject = (TroopAIOAppInfo)((bfqi)localObject).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(i));
    } while (localObject == null);
    zkb.a(paramTroopAIOAppInfo.hashVal);
    zkb.a(((TroopAIOAppInfo)localObject).hashVal);
  ...
  public boolean a(List<Integer> paramList, int paramInt)
  {
    ...
    {
      zkb.a(bool1);
      if ((localbfqi != null) && (paramList != null)) {
        break label59;
      }
      return false;
      bool1 = false;
    ...
    new ArrayList();
    Object localObject;
    if (paramList.size() != localbfqi.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size())
    {
      bool1 = bool2;
    ...
    for (;;)
    {
      try
      {
        ...
        if (bool1)
        {
          localbfqi.a(paramList, paramInt);
          b(localbfqi.a(), paramInt);
        }
        return bool1;
      }
      finally {}
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          int k = arrayOfInt[i];
          Object localObject3 = (bfqi)this.jdField_b_of_type_AndroidUtilSparseArray.get(k);
          zkb.a(localObject3);
          localObject3 = (TroopAIOAppInfo)((bfqi)localObject3).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
          if (localObject3 != null)
          {
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    localbfqi.jdField_b_of_type_Int = paramInt1;
  ...
  {
    int i = paramTroopAIOAppInfo.appid;
    bfqi localbfqi = (bfqi)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramTroopAIOAppInfo.groupType);
    if (localbfqi != null) {}
    for (boolean bool = true;; bool = false)
    {
      zkb.a(bool);
    ...
    if ((TroopAIOAppInfo)localbfqi.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(i)) != null) {
      return true;
    }
    localbfqi.a(paramTroopAIOAppInfo.appid, paramTroopAIOAppInfo);
    return false;
  }
  ...
  public void c()
  {
    ...
    try
    {
      ...
      nir.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new bfqn(this), localReqBody.toByteArray(), "OidbSvc.0xa1e", 2590, 0);
      return;
    }
    finally {}
  }
  ...
  public void onDestroy()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      while (i < j)
      {
        int k = arrayOfInt[i];
        a(false, k);
        bfqi localbfqi = (bfqi)this.jdField_b_of_type_AndroidUtilSparseArray.get(k);
        zkb.a(localbfqi);
        localbfqi.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
        localbfqi.a();
        localbfqi.jdField_b_of_type_Int = 0;
        i += 1;
      }
      return;
    }
