  ...
  extends ajwv
{
  ...
  ajwx jdField_a_of_type_Ajwx;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ajxc(this);
  ...
  public ajwy(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new ajwz(this));
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131368135)).setOnClickListener(new ajxa(this));
    Button localButton = (Button)findViewById(2131363719);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new ajxb(this));
  }
  ...
  private void h()
  {
    ...
    this.d = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131371775));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131371326));
    this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidContentContext.getString(2131717624));
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_a_of_type_Ajwx = new ajwx(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Bkfv, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ajwx);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new ajxd(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new ajxe(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new ajxf(this));
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Ajwx.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Ajwx.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, 1);
    a(0, null);
  }
  
  public void a(List<Object> paramList)
  {
    this.jdField_a_of_type_Ajwx.a(paramList);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          this.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131700081));
        ...
        {
          this.jdField_a_of_type_Ajwx.a((List)paramMessage.obj, paramMessage.arg1, this.jdField_c_of_type_Boolean, 0);
          this.jdField_a_of_type_Ajwx.notifyDataSetChanged();
        }
        if (this.jdField_a_of_type_Ajwx.getCount() == 0) {
          a(4, null);
        }
        for (;;)
        {
      ...
      this.jdField_a_of_type_Ajwx.a(this.jdField_a_of_type_JavaUtilList, this.jdField_c_of_type_Boolean);
      if ((this.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_Ajwx.getCount() < 20))
      {
        this.jdField_b_of_type_AndroidWidgetTextView.setText(anni.a(2131700084));
        this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131372927).setVisibility(8);
        this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
        this.jdField_b_of_type_AndroidViewView.setVisibility(0);
      }
    ...
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Ajwx.a((List)localObject, this.jdField_c_of_type_Boolean);
    this.jdField_a_of_type_Ajwx.notifyDataSetChanged();
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ajwx);
    this.jdField_a_of_type_ComTencentWidgetXListView.setSelection(0);
    this.jdField_a_of_type_JavaUtilList.clear();
