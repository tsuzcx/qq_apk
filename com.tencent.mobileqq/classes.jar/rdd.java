...
public class rdd
  extends rdc
{
  public rdd(Context paramContext, FaceDecoder paramFaceDecoder, szd paramszd)
  {
  ...
  public rbp a()
  {
    ...
    return a(this.jdField_a_of_type_Szd, this.jdField_a_of_type_ComTencentMobileqqAppFaceFaceDecoder).f().h().q().l().n().j();
  }
  ...
  public rbp d()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentTitle != null)
    {
      ...
      localRelativeLayout.setOnClickListener(new rde(this));
      localRelativeLayout.setDuplicateParentStateEnabled(true);
      localRelativeLayout.setOnTouchListener(new rdf(this, localRelativeLayout));
      localLinearLayout2.setOnTouchListener(new rdg(this, localRelativeLayout));
      ...
      localLinearLayout2.setOnTouchListener(new rdh(this, localLinearLayout2));
      localLinearLayout1.setOnTouchListener(new rdi(this, localLinearLayout2, localRelativeLayout));
    }
    ...
    localLinearLayout2.setOnClickListener(new rdj(this));
