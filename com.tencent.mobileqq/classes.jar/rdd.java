...
public class rdd
  implements Runnable
{
  public rdd(AccountManageActivity paramAccountManageActivity, String paramString1, SimpleAccount paramSimpleAccount, String paramString2, TextView paramTextView, ImageView paramImageView) {}
        ...
        if (localBitmap == null)
        {
          if ((!AccountManageActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityAccountManageActivity).containsKey(this.jdField_a_of_type_JavaLangString)) || (AccountManageActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityAccountManageActivity).get(this.jdField_a_of_type_JavaLangString) == null))
          {
            ...
            if ((!TextUtils.isEmpty(str1)) && (!this.b.equals(str1))) {
              this.jdField_a_of_type_ComTencentMobileqqActivityAccountManageActivity.runOnUiThread(new rde(this, bool, str1, localBitmap, (Drawable)localObject1));
            }
          }
          else
          {
