  ...
  implements bbhc
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bbhk.class.getSimpleName();
  }
  
  public bbhk(Context paramContext, int paramInt)
  {
  ...
  public View a()
  {
    ...
    default: 
      if (bool) {
        localRelativeLayout.setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166936));
      }
      break;
    }
    for (;;)
    {
      ...
      if (bool) {
        localView.setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166947));
      }
      for (;;)
      {
        ...
        break;
        localView.setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166946));
      }
      ...
      break;
      localRelativeLayout.setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131167337));
    }
  }
}
