...
{
  auhq(auhp paramauhp, String paramString, long paramLong, boolean paramBoolean) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    Object localObject = null;
    if (QLog.isColorLevel()) {
      QLog.d("UniformDownloadMgr<FileAssistant>", 2, "handleCheck, success: " + paramBoolean + ", canceled: " + auhp.a(this.jdField_a_of_type_Auhp));
    }
    Activity localActivity = (Activity)auhp.a(this.jdField_a_of_type_Auhp).get();
    if ((auhp.a(this.jdField_a_of_type_Auhp)) || (localActivity == null) || (localActivity.isFinishing())) {
      return;
    }
    ...
    for (;;)
    {
      ...
      catch (InvalidProtocolBufferMicroException paramBundle)
      {
        ...
        continue;
        this.jdField_a_of_type_Auhp.a.sendEmptyMessage(2);
      }
      aeow.a(localActivity, localIntent, PublicFragmentActivity.class, ApkFileDownloadFragment.class);
