  ...
  implements Handler.Callback
{
  ...
  public auhq(Bundle paramBundle)
  {
  ...
  private oidb_cmd0xb77.ImageInfo a(ayyu paramayyu)
  {
    if (paramayyu == null) {
      return null;
    }
    if (!(paramayyu.a instanceof int[])) {
      return null;
    }
    int[] arrayOfInt = (int[])paramayyu.a;
    if (arrayOfInt.length != 5) {
      return null;
    }
    oidb_cmd0xb77.ImageInfo localImageInfo = new oidb_cmd0xb77.ImageInfo();
    localImageInfo.md5.set(paramayyu.d);
    localImageInfo.uuid.set(paramayyu.c);
    ...
    localImageInfo.file_id.set((int)paramayyu.b);
    return localImageInfo;
  }
  
  private oidb_cmd0xdc2.ReqBody a(String paramString1, String paramString2, Map<ResultRecord, ayyu> paramMap)
  {
    oidb_cmd0xdc2.ReqBody localReqBody = new oidb_cmd0xdc2.ReqBody();
    localReqBody.msg_body.set(aukj.a(this.jdField_a_of_type_AndroidOsBundle, paramString1, paramString2, null));
    ...
    if (paramList.size() == 1)
    {
      ...
      if (((oidb_cmd0xdc2.BatchSendRsp)localObject1).err_code.get() == 901503)
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject1)) {
          paramList = aukj.jdField_a_of_type_JavaLangString;
        }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    aukj.a(this.jdField_a_of_type_ComTencentMobileqqMiniShareOpensdkOpenSdkShareModel, this.jdField_a_of_type_AndroidOsBundle, paramString1.msg_body);
    ...
    aukw.a("KEY_STAGE_2_NORMAL_DC2");
    nir.a(paramString2, new auhu(this), paramString1.toByteArray(), "OidbSvc.0xdc2_9", 3522, 9, localBundle, 0L);
  }
  
  private void a(Map<ResultRecord, ayyu> paramMap)
  {
    ...
    aukw.a("KEY_STAGE_2_IMAGE_DC2");
    nir.a(localAppRuntime, new auht(this), paramMap.toByteArray(), "OidbSvc.0xdc2_9", 3522, 9, localBundle, 0L);
  }
  
  private void a(Map<ResultRecord, ayyu> paramMap, ResultRecord paramResultRecord, oidb_cmd0xdc2.BatchSendReq paramBatchSendReq)
  {
    if (paramMap != null)
    {
      paramMap = a((ayyu)paramMap.get(paramResultRecord));
      if (paramMap != null) {
  ...
  private void b()
  {
    ...
    WeakReference localWeakReference = new WeakReference(new auhr(this));
    ...
    AbsShareMsg.sendSdkShareMessageByServer(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg, str1, i, str2, (ayyt)localWeakReference.get());
  }
  ...
  private void b(List<oidb_cmd0xdc2.BatchSendRsp> paramList)
  {
    ...
    {
      paramList = afur.a(localIntent, new int[] { 2 });
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Augs.b(this.jdField_a_of_type_AndroidAppActivity);
      ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity);
      return;
      paramList = afur.a(localIntent, null);
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_MqqOsMqqHandler.removeMessages(93);
    this.jdField_a_of_type_Augs.b(this.jdField_a_of_type_AndroidAppActivity);
    ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, aukj.jdField_a_of_type_JavaLangString);
  }
  ...
  private void d()
  {
    ...
    aukw.a("KEY_STAGE_2_UPLOAD_IMAGE_MULT");
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
  ...
  public void a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    this.jdField_a_of_type_Augs = new augs();
  }
  ...
  public void a(List<ResultRecord> paramList)
  {
    ...
    paramList = bcwd.a(this.jdField_a_of_type_AndroidOsBundle);
    ...
    if (!bgnt.d(this.jdField_a_of_type_AndroidAppActivity))
    {
      ...
      ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, anni.a(2131703582));
      return;
    }
    a();
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Augs.a(this.jdField_a_of_type_AndroidAppActivity);
      ...
      {
        this.jdField_a_of_type_Augs.b(this.jdField_a_of_type_AndroidAppActivity);
        ForwardUtils.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidOsBundle, anni.a(2131703581));
      }
      else
      {
        e();
