...
public class qam
{
  ...
  {
    paramString = bhni.a(ozs.a(), BaseApplicationImpl.getContext(), paramString);
    if (paramString != null)
    {
  ...
  public static void a(Context paramContext, ArticleInfo paramArticleInfo, boolean paramBoolean)
  {
    ...
    if (paramArticleInfo.isCardJumpUrlAvailable == 1)
    {
      ...
      ozs.d(paramContext, paramArticleInfo.getCardJumpUrl());
      return;
    }
    paramArticleInfo.clickJumpTarget = a(oyu.e, "-1");
    ozs.a(paramContext, paramArticleInfo, paramBoolean);
  }
  ...
  public static void a(KandianUrlImageView paramKandianUrlImageView, Context paramContext, URL paramURL1, URL paramURL2, Runnable paramRunnable)
  {
    ...
    paramKandianUrlImageView.setPublicAccountImageDownListener(new qan(paramRunnable));
    ozc.a(paramKandianUrlImageView, paramURL2, paramContext);
  }
  ...
  public static boolean a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      Object localObject = bhni.a(ozs.a(), BaseApplicationImpl.getContext(), paramString);
      if (localObject != null)
      {
        localObject = ((bhmr)localObject).a;
        if ((localObject != null) && ("6".equals((String)((Map)localObject).get("target"))) && (((Map)localObject).containsKey("v_url_base64"))) {
          return true;
        }
      }
      return tbz.b(tbz.b(paramString));
    }
    return false;
  }
}
