...
public class ldd
{
  private static ldd jdField_a_of_type_Ldd;
  ...
  private lde jdField_a_of_type_Lde = new lde(this);
  private byte[] jdField_a_of_type_ArrayOfByte = new byte[256];
  
  private int a()
  {
    int i = 0;
    String str = bbev.a(BaseApplication.getContext());
    if ("wifi".equals(str)) {
      i = 1;
    }
    for (;;)
        ...
        do
        {
          do
          {
            do
            {
              ...
              {
                return i;
                b(this.jdField_a_of_type_Lde.jdField_a_of_type_JavaLangString.length());
                j = a(this.jdField_a_of_type_Lde.jdField_a_of_type_JavaLangString);
                i = j;
              } while (j < 0);
              b(this.jdField_a_of_type_Lde.jdField_b_of_type_JavaLangString.length());
              j = a(this.jdField_a_of_type_Lde.jdField_b_of_type_JavaLangString);
              i = j;
            } while (j < 0);
            b(this.jdField_a_of_type_Lde.jdField_c_of_type_JavaLangString.length());
            j = a(this.jdField_a_of_type_Lde.jdField_c_of_type_JavaLangString);
            i = j;
          } while (j < 0);
          b(this.jdField_a_of_type_Lde.f.length());
          j = a(this.jdField_a_of_type_Lde.f);
          i = j;
        } while (j < 0);
        b(this.jdField_a_of_type_Lde.d.length());
        j = a(this.jdField_a_of_type_Lde.d);
        i = j;
      } while (j < 0);
      b(this.jdField_a_of_type_Lde.e.length());
      j = a(this.jdField_a_of_type_Lde.e);
      i = j;
    } while (j < 0);
    a(this.jdField_a_of_type_Lde.jdField_c_of_type_Long);
    a(this.jdField_a_of_type_Lde.jdField_a_of_type_Long);
    a(this.jdField_a_of_type_Lde.jdField_a_of_type_Int);
    a(this.jdField_a_of_type_Lde.jdField_b_of_type_Long);
    a(this.jdField_a_of_type_Lde.jdField_b_of_type_Int);
    a(paramInt);
    return 0;
  }
  ...
  public static ldd a()
  {
    if (jdField_a_of_type_Ldd == null) {
      jdField_a_of_type_Ldd = new ldd();
    }
    return jdField_a_of_type_Ldd;
  }
  ...
  {
    int i = 0;
    if (this.jdField_a_of_type_Lde == null) {
      paramInt2 = -1;
    }
    do
    {
      return paramInt2;
      int j = a();
      this.jdField_a_of_type_Lde.e = jdField_a_of_type_ArrayOfJavaLangString[j];
      this.jdField_a_of_type_Lde.d = a();
      this.jdField_a_of_type_Lde.jdField_a_of_type_Int = 0;
      this.jdField_a_of_type_Lde.jdField_b_of_type_Int = paramInt2;
      if (paramLong != 0L) {
        this.jdField_a_of_type_Lde.jdField_b_of_type_Long = paramLong;
      }
      ...
      a(this.jdField_a_of_type_Lde.jdField_a_of_type_Long, arrayOfByte);
      this.jdField_a_of_type_Int = 0;
      paramInt2 = i;
  ...
  public void a(long paramLong1, long paramLong2, long paramLong3)
  {
    ...
    this.jdField_a_of_type_Lde.jdField_b_of_type_Long = paramLong3;
    this.jdField_a_of_type_Lde.jdField_a_of_type_Long = paramLong2;
    this.jdField_a_of_type_Lde.jdField_c_of_type_Long = paramLong1;
    this.jdField_a_of_type_Lde.jdField_c_of_type_JavaLangString = String.valueOf(AppSetting.a());
    this.jdField_a_of_type_Lde.f = AppSetting.d();
  }
}
