        ...
        if ((paramObject != null) && (localObject1 != null))
        {
          ...
          try
          {
            ...
            if (paramInt <= k)
            {
              ...
              m = oqj.a((AdvertisementInfo)localObject3);
              String str = oqj.a((AdvertisementInfo)localObject3);
              ...
              if ((localObject2 == null) || (!(localObject2 instanceof osm))) {
                break label717;
              }
              ((osm)localObject2).a(true, (AdvertisementInfo)localObject3, paramVarArgs);
            }
          }
