  ...
  implements aqwv<String>
{
  ...
  private ArrayList<usv> jdField_a_of_type_JavaUtilArrayList = new ArrayList(0);
  private boolean jdField_a_of_type_Boolean;
  
  public static oni a(String paramString)
  {
    try
    {
      oni localoni = (oni)aqxo.a(paramString, oni.class);
      return localoni;
    }
  ...
  public static oni a(aqxa[] paramArrayOfaqxa)
  {
    oni localoni = null;
    int i = 0;
    while (i < paramArrayOfaqxa.length)
    {
      localoni = a(paramArrayOfaqxa[i].jdField_a_of_type_JavaLangString);
      i += 1;
    }
    return localoni;
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if ((localAppRuntime instanceof QQAppInterface)) {
        bhhr.f(((QQAppInterface)localAppRuntime).getApplication(), this.jdField_a_of_type_JavaLangString);
      }
    }
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        if ((localObject1 instanceof QQAppInterface))
        {
          ...
          while (i < j)
          {
            ...
            localObject2 = new usv(localQQAppInterface, (Context)localObject1, Integer.parseInt(((Element)localObject2).getElementsByTagName("id").item(0).getFirstChild().getNodeValue()), ((Element)localObject2).getElementsByTagName("name").item(0).getFirstChild().getNodeValue(), ((Element)localObject2).getElementsByTagName("icon").item(0).getFirstChild().getNodeValue());
  ...
  {
    if (this.jdField_a_of_type_Boolean) {
      usu.a(this.jdField_a_of_type_JavaUtilArrayList);
    }
  }
}
