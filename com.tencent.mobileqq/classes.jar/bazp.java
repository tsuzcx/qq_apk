...
public class bazp
{
  ...
  public static <T> T b(JSONObject paramJSONObject, Class<T> paramClass)
  {
    ...
    try
    {
      ...
      if ((localField.isAnnotationPresent(bazs.class)) || (Modifier.isStatic(localField.getModifiers()))) {
        break label346;
      }
      if (localField.isAnnotationPresent(bazq.class)) {
        paramClass = ((bazq)localField.getAnnotation(bazq.class)).a();
      }
    ...
    if (List.class.isAssignableFrom(localClass2))
    {
      ...
      if (!localField.isAnnotationPresent(bazr.class)) {
        return null;
      }
      localClass1 = ((bazr)localField.getAnnotation(bazr.class)).a();
