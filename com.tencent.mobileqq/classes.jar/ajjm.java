...
public class ajjm
{
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      Object localObject1 = bace.a(new File(paramQQAppInterface.getApplication().getApplicationContext().getFilesDir(), balu.f.a));
      Object localObject2 = "";
      String str = "";
      j = 1;
      i = j;
  ...
  public static void a(boolean paramBoolean, Context paramContext, List<CustomEmotionData> paramList, AppInterface paramAppInterface, IPicDownloadListener paramIPicDownloadListener)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localbatr = ((bato)paramAppInterface.getManager(47)).a(1);
      } while (localbatr == null);
      ancg localancg = (ancg)paramAppInterface.getManager(149);
      andn localandn = (andn)paramAppInterface.getManager(141);
      ...
      for (;;)
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          {
            if (localbatr.a(localCustomEmotionData.url) != null)
            {
            ...
            boolean bool1 = false;
            File localFile;
            if ((localandn != null) && (localandn.a(localCustomEmotionData))) {
              if ((!TextUtils.isEmpty(localCustomEmotionData.emoPath)) && (localCustomEmotionData.emoPath.startsWith(ajed.bf)))
              {
                ...
                if (paramBoolean) {
                  localancg.b(localCustomEmotionData);
                }
            ...
            for (;;)
            {
              ...
              {
                paramList = localandn.a(localCustomEmotionData.md5);
                break label234;
              }
              if (!TextUtils.isEmpty(localCustomEmotionData.resid))
              {
                paramList = paramList + akhi.a(localCustomEmotionData.resid);
                break label234;
              }
              ...
              break label234;
              batm localbatm = new batm(localCustomEmotionData.url, localFile);
              localbatm.p = false;
              localbatm.f = "emotion_pic";
              localbatm.b = 1;
              paramList = "";
              if (localCustomEmotionData.url.contains("qto_"))
              {
              ...
              localbatr.a(localbatm, new ajjn(paramList, localFile, localCustomEmotionData, bool1, paramBoolean, localancg, paramIPicDownloadListener, localArrayList1, localArrayList2, paramContext, localAtomicInteger2, localAtomicInteger1), null);
            }
            continue;
          }
          if (paramIPicDownloadListener != null) {
