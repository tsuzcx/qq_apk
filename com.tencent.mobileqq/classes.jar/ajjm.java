...
public class ajjm
  implements Runnable
{
  public ajjm(TroopShareUtility paramTroopShareUtility, ajjo paramajjo) {}
  ...
  public void run()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 13	ajjm:jdField_a_of_type_ComTencentMobileqqTroopshareTroopShareUtility	Lcom/tencent/mobileqq/troopshare/TroopShareUtility;
    //   4: getfield 27	com/tencent/mobileqq/troopshare/TroopShareUtility:jdField_a_of_type_ComTencentMobileqqAppBaseActivity	Lcom/tencent/mobileqq/app/BaseActivity;
    //   7: invokevirtual 33	com/tencent/mobileqq/app/BaseActivity:getAppRuntime	()Lmqq/app/AppRuntime;
    //   10: checkcast 35	com/tencent/mobileqq/app/QQAppInterface
    //   13: astore 8
    //   15: aload 8
    //   17: iconst_2
    //   18: invokevirtual 39	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   21: checkcast 41	mqq/manager/TicketManager
    //   24: aload 8
    //   26: invokevirtual 45	com/tencent/mobileqq/app/QQAppInterface:getAccount	()Ljava/lang/String;
    //   29: invokeinterface 49 2 0
    //   34: astore 9
    //   36: aload 8
    //   38: bipush 51
    //   40: invokevirtual 39	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   43: checkcast 51	com/tencent/mobileqq/app/TroopManager
    //   46: aload_0
    //   47: getfield 13	ajjm:jdField_a_of_type_ComTencentMobileqqTroopshareTroopShareUtility	Lcom/tencent/mobileqq/troopshare/TroopShareUtility;
    //   50: getfield 54	com/tencent/mobileqq/troopshare/TroopShareUtility:jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData	Lcom/tencent/mobileqq/troopinfo/TroopInfoData;
    //   53: getfield 60	com/tencent/mobileqq/troopinfo/TroopInfoData:troopUin	Ljava/lang/String;
    //   56: invokevirtual 64	com/tencent/mobileqq/app/TroopManager:b	(Ljava/lang/String;)Lcom/tencent/mobileqq/data/TroopInfo;
    //   59: astore 4
    //   61: aload 9
    //   63: invokestatic 70	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   66: ifne +326 -> 392
    //   69: aload 4
    //   71: ifnull +321 -> 392
    //   74: aload 4
    //   76: getfield 76	com/tencent/mobileqq/data/TroopInfo:wMemberNum	I
    //   79: istore_1
    //   80: iconst_1
    //   81: iload_1
    //   82: if_icmpne +487 -> 569
    //   85: invokestatic 81	com/tencent/mobileqq/util/SystemUtil:a	()Z
    //   88: ifeq +305 -> 393
    //   91: getstatic 86	com/tencent/mobileqq/app/AppConstants:bm	Ljava/lang/String;
    //   94: astore 4
    ...
    //   116: astore 4
    //   118: new 100	java/io/File
    //   121: dup
    //   122: aload 4
    //   124: invokespecial 103	java/io/File:<init>	(Ljava/lang/String;)V
    //   127: astore 5
    //   129: aload 5
    //   131: invokevirtual 106	java/io/File:exists	()Z
    //   134: ifne +422 -> 556
    //   137: aload 5
    //   139: invokevirtual 109	java/io/File:createNewFile	()Z
    //   142: pop
    //   143: new 111	java/io/BufferedOutputStream
    //   146: dup
    //   147: new 113	java/io/FileOutputStream
    //   150: dup
    //   151: aload 5
    //   153: invokespecial 116	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   156: sipush 8192
    //   159: invokespecial 119	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;I)V
    //   162: astore 6
    //   164: aload 6
    //   166: astore 5
    //   168: invokestatic 125	com/tencent/mobileqq/utils/ImageUtil:c	()Landroid/graphics/drawable/Drawable;
    ...
    //   215: bipush 113
    //   217: aload_0
    //   218: getfield 13	ajjm:jdField_a_of_type_ComTencentMobileqqTroopshareTroopShareUtility	Lcom/tencent/mobileqq/troopshare/TroopShareUtility;
    //   221: getfield 54	com/tencent/mobileqq/troopshare/TroopShareUtility:jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData	Lcom/tencent/mobileqq/troopinfo/TroopInfoData;
    //   224: getfield 60	com/tencent/mobileqq/troopinfo/TroopInfoData:troopUin	Ljava/lang/String;
    //   227: iconst_0
    //   228: invokevirtual 154	com/tencent/mobileqq/app/QQAppInterface:a	(ILjava/lang/String;I)Ljava/lang/String;
    //   231: astore 6
    //   233: new 100	java/io/File
    //   236: dup
    //   237: aload 6
    //   239: invokespecial 103	java/io/File:<init>	(Ljava/lang/String;)V
    //   242: astore 10
    //   244: aload 4
    //   246: astore 5
    //   248: iload_1
    ...
    //   253: aload 10
    //   255: invokevirtual 106	java/io/File:exists	()Z
    //   258: ifne +291 -> 549
    //   261: aload 4
    //   263: astore 5
    //   265: aload 7
    ...
    //   280: aload 9
    //   282: ldc 163
    //   284: invokestatic 168	cooperation/qzone/QZoneShareManager:a	(Ljava/util/ArrayList;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/ArrayList;
    //   287: astore 4
    //   289: aload 4
    //   291: ifnull +250 -> 541
    //   294: aload 4
    ...
    //   318: istore_3
    //   319: aload 5
    //   321: invokestatic 70	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   324: ifne +35 -> 359
    //   327: aload 5
    //   329: ldc 180
    ...
    //   382: iload_3
    //   383: aload 4
    //   385: invokespecial 204	ajjn:<init>	(Lajjm;ZLjava/lang/String;)V
