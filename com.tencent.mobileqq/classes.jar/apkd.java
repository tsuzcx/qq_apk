...
public class apkd
  extends aphp
{
  private URLDrawableDownListener.Adapter jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new apke(this);
  ...
  public apkd(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  private void G()
  {
    ...
    while (!QLog.isColorLevel()) {
      for (;;)
      {
        ...
        acgk.a(this.jdField_a_of_type_AndroidAppActivity, (Intent)localObject, str);
      }
    }
  ...
  private boolean a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    for (;;)
    {
      ...
      {
        awul localawul = (awul)paramAbsStructMsg.get(j);
  ...
  private View b()
  {
    ...
    for (;;)
    {
      ...
      if (j != 0)
      {
        ...
        ((ImageView)localObject2).setImageResource(2130839563);
        LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(bajq.a(8.0F), bajq.a(14.0F));
        localLayoutParams.setMargins(bajq.a(7.0F), 0, 0, 0);
        ...
        ((View)localObject2).setBackgroundResource(2130839573);
        localFrameLayout.addView((View)localObject2, new FrameLayout.LayoutParams(-1, bajq.a(33.0F), 16));
        ((View)localObject2).setOnClickListener(new apkf(this));
        ((View)localObject2).setContentDescription(ajjy.a(2131638978));
      }
      ...
      if ((localObject1 != null) && ((this.jdField_a_of_type_Bafb instanceof apjo))) {
        ((apjo)this.jdField_a_of_type_Bafb).a((String)localObject1);
      }
  ...
  private void b(bafb parambafb)
  {
    int k = 1;
    parambafb.setBodyLayoutNoMargin();
    Object localObject1 = new URLImageView(this.jdField_a_of_type_AndroidAppActivity);
    Object localObject2 = new LinearLayout.LayoutParams(-1, aciy.a(152.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
    ...
    {
      ((LinearLayout.LayoutParams)localObject2).leftMargin = aciy.a(24.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
      ((LinearLayout.LayoutParams)localObject2).rightMargin = aciy.a(24.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    }
    ...
    Object localObject3 = ahzm.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg, "cover");
    Drawable localDrawable = this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130849109);
    if (!TextUtils.isEmpty((CharSequence)localObject3))
    {
      localObject3 = URLDrawable.getDrawable((String)localObject3, (int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131165691), aciy.a(165.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), localDrawable, localDrawable, true);
    ...
    for (;;)
    {
      parambafb.addView((View)localObject1, (LinearLayout.LayoutParams)localObject2);
      localObject1 = ahzm.a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg, "title");
      ...
      ((TextView)localObject2).setPadding(aciy.a(24.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), aciy.a(8.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), aciy.a(24.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), aciy.a(20.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
      parambafb.addView((View)localObject2);
      return;
      ((URLImageView)localObject1).setScaleType(ImageView.ScaleType.CENTER_INSIDE);
  ...
  private void e()
  {
    int j = 1;
    if (c() != 0) {}
    for (Object localObject1 = this.jdField_a_of_type_Bafb.getInputValue();; localObject1 = "")
    {
      ...
      {
        localObject2 = aciy.a(new Intent(this.jdField_a_of_type_AndroidAppActivity, SplashActivity.class), new int[] { 2 });
        ...
        {
          localObject3 = awuw.a(((Intent)localObject2).getExtras());
          Object localObject5;
          Object localObject6;
          if ((this.jdField_c_of_type_Int == 13) && ((localObject3 instanceof StructMsgForGeneralShare)))
          {
          ...
          while (((Iterator)localObject4).hasNext())
          {
            ...
            acvh.a().a((SessionInfo)localObject6, (String)localObject1, k);
            baic.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((ResultRecord)localObject5).a, ((SessionInfo)localObject6).b, ((ResultRecord)localObject5).a(), (AbsStructMsg)localObject3, null);
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          else if (apjy.a((Intent)localObject2))
          {
            localObject3 = ForwardUtils.a((Intent)localObject2, ((ResultRecord)localObject3).a, ((ResultRecord)localObject3).a(), ((ResultRecord)localObject3).c);
            ForwardUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, (SessionInfo)localObject3, (Intent)localObject2);
          }
      ...
      for (;;)
      {
        ...
        default: 
          ...
          if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("k_struct_forward", false))
          {
            ...
            awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005456", "0X8005456", 0, 0, (String)localObject4, (String)localObject2, (String)localObject3, "" + j);
          }
        ...
        for (;;)
        {
          ...
          {
            awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", this.jdField_a_of_type_AndroidOsBundle.getString("uin"), "Music_gene", "Music_gene_send", 0, 1, 0, "", "", "", "");
          }
        }
        v();
        return;
  ...
  public List<RecentUser> a(List<RecentUser> paramList)
  {
    ...
    if ((this.jdField_c_of_type_Int == 13) || ("public_account".equals(this.h)) || ("web_share".equals(this.h)) || ("struct_msg_from_h5".equals(this.h)) || ("struct_favorite".equals(this.h)))
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if ((localRecentUser != null) && (!azzz.a(localRecentUser.uin)) && (localRecentUser.getType() != 1020) && (localRecentUser.getType() != 1008) && (localRecentUser.getType() != 1005) && (localRecentUser.getType() != 1009) && (localRecentUser.getType() != 1021) && (localRecentUser.getType() != 1001) && (localRecentUser.getType() != 10002) && (localRecentUser.getType() != 10004) && (localRecentUser.getType() != 1022) && ((localRecentUser.getType() != 1006) || (a(aphf.h))) && (localRecentUser.getType() != 7000) && (localRecentUser.getType() != 6004) && (localRecentUser.getType() != 9501) && ((localRecentUser.getType() != 0) || (!mqb.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, localRecentUser.getType()))) && (((localRecentUser.getType() == 0) && (a(jdField_b_of_type_JavaLangInteger))) || ((localRecentUser.getType() == 1) && (!a(localRecentUser.uin)) && (a(jdField_c_of_type_JavaLangInteger))) || ((localRecentUser.getType() == 3000) && (a(jdField_d_of_type_JavaLangInteger)) && (((localRecentUser.getType() != 1004) && (localRecentUser.getType() != 1000)) || (this.jdField_b_of_type_Boolean))))) {
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("isWebCompShare", false))
    {
      ...
      localBundle.putString("intext_1", "" + bcaj.a(this.jdField_c_of_type_Int));
      localBundle.putString("intext_2", "" + bcaj.a(paramBundle.getInt("uintype"), paramBundle.getString("uin")));
      localBundle.putString("intext_3", "1");
      bcad.a().a(localBundle, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
    }
  ...
  public void a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    for (;;)
    {
      ...
      if ((paramAbsStructMsg != null) && (paramAbsStructMsg.size() != 0))
      {
        ...
        } while (!(localObject1 instanceof awxe));
        for (paramAbsStructMsg = (awxe)localObject1;; paramAbsStructMsg = null)
        {
          if (paramAbsStructMsg == null) {
            break label466;
          }
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            paramAbsStructMsg = (awzf)localObject2;
          }
          for (;;)
          {
            break label102;
            ...
            if (j < localStringBuilder.length())
            {
              ...
              if ('ÿ' == localStringBuilder.charAt(j))
              {
                ...
                if (j + 3 < localStringBuilder.length())
                {
                  ...
                  arrayOfInt = anam.a((char[])localObject1);
                  localObject2 = axkd.c;
                  if (localarnz == null) {
                    break label454;
                  }
            ...
            for (localObject1 = localarnz.a(Integer.toString(arrayOfInt[0]), Integer.toString(arrayOfInt[1]));; localObject1 = null)
            {
              if (localObject1 != null) {}
  ...
  public boolean a()
  {
    ...
    super.a();
    this.jdField_c_of_type_Int = this.jdField_a_of_type_AndroidContentIntent.getIntExtra("req_type", 2147483647);
    ...
    Object localObject = awuw.a(this.jdField_a_of_type_AndroidOsBundle.getByteArray("stuctmsg_bytes"));
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("isWebCompShare", false))
        {
          ...
          ((Bundle)localObject).putString("intext_1", "" + bcaj.a(this.jdField_c_of_type_Int));
          ((Bundle)localObject).putString("intext_3", "1");
          bcad.a().a((Bundle)localObject, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
        }
        return true;
  ...
  protected boolean a(bafb parambafb)
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject instanceof StructMsgForAudioShare)) {
        localLayoutParams.setMargins(0, aciy.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, aciy.a(10.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()));
      }
      ...
      parambafb.addView(((AbsStructMsg)localObject).getPreDialogView(this.jdField_a_of_type_AndroidAppActivity, null), localLayoutParams);
      if (!bool) {
        a(((AbsStructMsg)localObject).getSourceName(), parambafb);
      }
    }
    return true;
  }
  ...
  protected int d()
  {
    ...
    if ((!TextUtils.isEmpty(str)) && (bfhl.a(str).b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), -1, null))) {}
    for (int j = 0;; j = -1)
    {
      if (j == 0) {
        bfhz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "User_AddFav", -1, 0, 69, 0, "", "");
      }
      return j;
    }
  }
  ...
  protected void d()
  {
    ...
    if (this.jdField_a_of_type_AndroidOsBundle.getInt("uintype") == 1)
    {
      ...
      if (((azjh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a((String)localObject1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()))
      {
        bbmy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131631942, 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131167766));
        return;
      }
    }
    if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("isWebCompShare", false))
    ...
    for (Object localObject1 = this.jdField_a_of_type_Bafb.getInputValue();; localObject1 = "")
    {
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl.startsWith("http://article.mp.qq.com")) || (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl.startsWith("http://post.mp.qq.com")))
      {
        ...
        ndn.a(null, "", "0X8007236", "0X8007236", 0, 0, this.jdField_i_of_type_JavaLangString, "" + this.jdField_d_of_type_Int, (String)localObject2, "");
        ndn.a("0X8007236", "", this.jdField_i_of_type_JavaLangString, "" + this.jdField_d_of_type_Int, (String)localObject2, "");
        if ((!TextUtils.isEmpty((CharSequence)localObject1)) || (!"".equals(localObject1))) {
          ndn.a(null, "", "0X8007237", "0X8007237", 0, 0, this.jdField_i_of_type_JavaLangString, "" + this.jdField_d_of_type_Int, (String)localObject2, "");
        }
      }
      this.jdField_a_of_type_AndroidContentIntent.getAction();
      Object localObject2 = Boolean.valueOf(this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("key_flag_from_plugin", false));
      ...
      if (((Boolean)localObject2).booleanValue())
      {
        ...
        if (((Boolean)localObject3).booleanValue())
        {
          ...
          acvh.a().a((SessionInfo)localObject4, (String)localObject1, j);
          baic.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidOsBundle.getString("uin"), ((SessionInfo)localObject4).b, this.jdField_a_of_type_AndroidOsBundle.getInt("uintype"), (AbsStructMsg)localObject3, null);
          if (!TextUtils.isEmpty((CharSequence)localObject1)) {
            mnf.a().a = true;
          }
          localObject1 = new Intent();
  ...
  {
    super.r();
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007C3A", "0X8007C3A", 0, 0, "1", "", "", "");
    if (this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("k_struct_forward", false)) {
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005457", "0X8005457", 0, 0, "", "", "android", "");
    }
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl.startsWith("http://article.mp.qq.com")) || (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgUrl.startsWith("http://post.mp.qq.com")))
    {
      String str = this.jdField_a_of_type_AndroidOsBundle.getString("uin");
      ndn.a(null, "", "0X8007235", "0X8007235", 0, 0, this.jdField_i_of_type_JavaLangString, "" + this.jdField_d_of_type_Int, str, "");
    }
  }
