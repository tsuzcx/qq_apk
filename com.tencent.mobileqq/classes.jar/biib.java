  ...
  extends QIMEffectCameraCaptureUnit
{
  ...
  public biib(bjrl parambjrl, bjrk parambjrk)
  {
    super(parambjrl, parambjrk);
    this.jdField_a_of_type_Bjrd = new bjrd(10012, 105, 11);
  ...
  public void I()
  {
    ...
    localIntent.putExtras(this.jdField_a_of_type_Bjrl.a().getIntent().getExtras());
    localIntent.putExtra("qq_sub_business_id", this.jdField_a_of_type_Bjrd.c);
    localIntent.putExtra("entrance_type", this.jdField_a_of_type_Bjrd.jdField_b_of_type_Int);
  ...
  public View a()
  {
    ...
    Object localObject1 = azcf.a(this.jdField_a_of_type_Bjrl.a().getIntent().getExtras());
    ...
    localObject1 = this.jdField_a_of_type_Bjrl.a().getIntent().getExtras();
    try
    {
      ...
      this.jdField_a_of_type_Bjrl.a().getIntent().putExtras((Bundle)localObject1);
    }
  ...
  protected avul a()
  {
    ...
    if (axim.r > 2000000)
    {
      localavul.j(2000000);
      axim.r = 2000000;
      ved.b("QIMTribeEffectsCameraCaptureUnit", "maxrate:" + axim.r);
    }
    localavul.b(false);
    return localavul;
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    {
      return;
      if (paramInt1 != azam.jdField_a_of_type_Int) {
        break label87;
      }
      if (paramInt2 != -1) {
        break;
    ...
    if ((paramInt1 == 10012) && (paramInt2 == -1))
    {
      ...
      localActivity.startActivityForResult(localIntent, azam.jdField_a_of_type_Int);
      return;
    }
    ved.d("QIMTribeEffectsCameraCaptureUnit", "onActivityResult, requestCode=%d, resultCode=%d, data=%s", new Object[] { Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), paramIntent });
  }
  ...
  public void a(CameraCaptureView.VideoCaptureResult paramVideoCaptureResult, LocalMediaInfo paramLocalMediaInfo)
  {
    ...
    if (this.jdField_a_of_type_Bjrd.jdField_b_of_type_Int != 102)
    {
      ...
      bool2 = true;
      localObject = new bjrj().a(false).e(bool1).f(bool2).g(true).h(this.h).a();
      localBundle = this.jdField_a_of_type_Bjrl.a().getIntent().getExtras();
      this.jdField_a_of_type_Bjrd.a((bjrh)localObject);
  ...
  public void onClick(View paramView)
  {
    ...
    b(this.jdField_a_of_type_Bjrl.a());
  }
  
  protected void w()
  {
    ThreadManager.post(new QIMTribeEffectsCameraCaptureUnit.1(this, this.jdField_a_of_type_Bjrl.a()), 5, null, true);
  }
}
