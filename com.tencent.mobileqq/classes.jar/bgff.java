...
public class bgff
{
  public static boolean a(String paramString, double paramDouble1, double paramDouble2)
  {
    ...
    localExifInterface.setAttribute("GPSLatitude", bgfo.a(paramDouble2));
    localExifInterface.setAttribute("GPSLongitude", bgfo.a(paramDouble1));
    ...
    for (paramString = "N";; paramString = "S")
    {
      ...
      try
      {
        ...
        awrn.a(BaseApplication.getContext()).a(null, "gpsComplement", true, 0L, 0L, paramString, null, true);
        return true;
      }
      catch (IOException paramString)
      {
    ...
    if ((localExifInterface2 != null) && (TextUtils.isEmpty(localExifInterface1.getAttribute("GPSLongitude"))))
    {
      ...
      if ((!TextUtils.isEmpty(paramString2)) && (!TextUtils.isEmpty(str)))
      {
        ...
        try
        {
          ...
          awrn.a(BaseApplication.getContext()).a(null, "gpsComplement", true, 0L, 0L, paramString1, null, true);
          return true;
        }
