...
public class bgff
{
  ...
  public static void a()
  {
    ...
    String str2 = bgev.a("vipPersonalCardMaster");
  ...
  public static void a(QQAppInterface paramQQAppInterface, aymg paramaymg, boolean paramBoolean)
  {
    if ((paramQQAppInterface == null) || (paramaymg == null) || (paramaymg.jdField_a_of_type_ComTencentMobileqqDataCard == null)) {}
    do
    {
      return;
      if (paramBoolean) {
    ...
    if (TextUtils.isEmpty(paramaymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.d)) {
      if (paramaymg.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.a.equals(paramQQAppInterface.getCurrentAccountUin())) {
        if (paramBoolean) {
    ...
    for (;;)
    {
      a(paramQQAppInterface, a(paramaymg.jdField_a_of_type_ComTencentMobileqqDataCard), paramaymg.jdField_a_of_type_ComTencentMobileqqDataCard.lhLevel);
      return;
  ...
  public static void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    bcef.b((QQAppInterface)localAppRuntime, "dc00898", "", "", "", paramString, paramInt2, 0, "", "", "", "");
  }
  
  public static boolean a()
  {
    aqhk localaqhk = aqhl.c();
    if (QLog.isColorLevel()) {
      QLog.d("PrettyAccountUtil", 2, "pretty_account manageOpen:" + localaqhk.a);
    }
    return localaqhk.a;
  }
