...
public class alpu
  extends alpd
{
  private static alpv jdField_a_of_type_Alpv;
  public static final ArrayList<WeakReference<alpu>> a;
  private static String e = "";
  protected SongInfo a;
  private WeakReference<alpu> jdField_a_of_type_JavaLangRefWeakReference;
  protected long c = 0L;
  protected String d;
  ...
  public alpu(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    jdField_a_of_type_Alpv = new alpv(this.jdField_a_of_type_JavaLangString);
  ...
  {
    QQPlayerService.c(jdField_a_of_type_Alpv);
  ...
  public boolean Invoke(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    if (paramString.equals("SetCallback"))
    {
      ...
      QQPlayerService.b(jdField_a_of_type_Alpv);
      QQPlayerService.a(null);
      return true;
    }
