  ...
  implements bceo
{
  ...
  public bcfg(Context paramContext, WebView paramWebView, String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
  ...
  {
    bcds.c("AppUpdate", "AppUpdate onException >>> " + paramException.toString());
    if ((!this.jdField_a_of_type_Boolean) && (bcev.a(this.jdField_a_of_type_AndroidContentContext))) {
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    bcds.c("AppUpdate", "AppUpdate onResult >>> " + localJSONObject.toString());
