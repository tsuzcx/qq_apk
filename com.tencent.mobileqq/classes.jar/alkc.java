  ...
  extends alke
{
  ...
  protected void a()
  {
    ...
    alki.a("glGetAttribLocation u_threshold");
    this.b = GLES20.glGetUniformLocation(this.d, "u_clipBlack");
    alki.a("glGetAttribLocation u_clipBlack");
    this.c = GLES20.glGetUniformLocation(this.d, "u_clipWhite");
    alki.a("glGetAttribLocation u_clipWhite");
  }
  ...
  protected void a(alkh paramalkh)
  {
    ...
    GLES20.glUniform1f(this.a, paramalkh.f);
    GLES20.glUniform1f(this.b, paramalkh.g);
    GLES20.glUniform1f(this.c, paramalkh.h);
  }
}
