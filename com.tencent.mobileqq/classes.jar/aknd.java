...
public class aknd
  implements akvf
{
  public aknd(ArConfigService paramArConfigService) {}
    ...
    if (ArConfigService.c(this.a) != null) {
      try
      {
        ...
        for (;;)
        {
          ...
          try
          {
            ((akpz)ArConfigService.c(this.a).getBroadcastItem(i)).a(paramInt1, paramInt2);
            i += 1;
          }
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ((akpz)ArConfigService.c(this.a).getBroadcastItem(i)).a(paramInt);
        }
        catch (RemoteException localRemoteException)
        {
          localRemoteException.printStackTrace();
        }
        ((akpz)ArConfigService.c(this.a).getBroadcastItem(i)).b(paramInt, 0);
      }
      catch (Exception localException)
      {
        if (QLog.isColorLevel()) {
