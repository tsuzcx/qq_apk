...
public class anhh
{
  ...
  private void b(Bitmap paramBitmap)
  {
    ...
    if (paramBitmap != null)
    {
      ...
      if ((!paramBitmap.isRecycled()) && (!anfe.a().a().c())) {
        paramBitmap.recycle();
      }
    }
  }
  ...
  public Bitmap a(int paramInt1, int paramInt2)
  {
    ...
    {
      anhx.a("BitmapCacheManager", "create bitmap out of memory", localOutOfMemoryError);
    }
    return localObject1;
  }
  ...
  public void a()
  {
    ...
    {
      Bitmap localBitmap = (Bitmap)localIterator.next();
      if ((localBitmap != null) && (!localBitmap.isRecycled()) && (!anfe.a().a().c())) {
        localBitmap.recycle();
      }
    }
