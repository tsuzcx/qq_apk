  ...
  extends MSFServlet
{
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      notifyObserver(paramIntent, j, bool1, localBundle, hn.class);
      return;
      ...
      if (((MqqLbsPack.RspGetPOIList)localObject).msg_head.has())
      {
        ...
        if (k != 0) {
          hp.a("actLbsSendPoiListFailure", k);
        }
        for (;;)
        {
          if (QLog.isColorLevel()) {
        ...
        if (((MqqLbsPack.RspOpenLBSRPReport)localObject).msg_head.has())
        {
          ...
          if (paramFromServiceMsg != null)
          {
            ...
            for (;;)
            {
              ...
              break;
              hp.a("actLbsSendGetPidFailure", k);
            }
            ...
            default: 
              break;
            case 1: 
              hp.a("actLbsSendPoiListFailure", -10006);
              break;
            case 2: 
              break;
            case 3: 
              hp.a("actLbsSendGetPidFailure", -10006);
              break;
            case 4: 
              if (QLog.isColorLevel())
              {
