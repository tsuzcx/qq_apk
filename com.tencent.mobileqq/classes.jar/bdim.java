...
public class bdim
{
  ...
  {
    Object localObject1 = new File(alof.bC);
  ...
  {
    paramString = new File(alof.bC + paramString + ".cfg");
  ...
  public static void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    //   5: dup
    //   6: getstatic 21	alof:bC	Ljava/lang/String;
    ...
    //   39: getstatic 21	alof:bC	Ljava/lang/String;
  ...
  public static boolean a(String paramString, int[] paramArrayOfInt)
  {
    ...
    //   14: getstatic 21	alof:bC	Ljava/lang/String;
