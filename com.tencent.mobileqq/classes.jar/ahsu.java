...
class ahsu
{
  ...
  public ahsu(ahss paramahss)
  {
    this.jdField_a_of_type_ComTencentMobileqqStatisticsBatteryHighFrequencyDetector = new HighFrequencyDetector(ahss.a(paramahss), ahss.a(paramahss));
    this.jdField_b_of_type_ComTencentMobileqqStatisticsBatteryHighFrequencyDetector = new HighFrequencyDetector(ahss.b(paramahss), ahss.b(paramahss));
  }
