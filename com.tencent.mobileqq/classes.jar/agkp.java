  ...
  implements UpCallBack
{
  ...
  agkp(agko paramagko, int paramInt, String paramString)
  {
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_ComTencentMobileqqPicPicResult = ((PicResult)paramagko.a.a.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int));
    this.jdField_a_of_type_ComTencentMobileqqPicPicFowardInfo = ((PicFowardInfo)paramagko.a.a.b.get(paramInt));
  ...
  public MessageRecord a(im_msg_body.RichText arg1)
  {
    ...
    if ((??? != null) && (???.elems.has()))
    {
      ...
      if (??? != null) {
        if (???.not_online_image.has())
        {
          ...
          {
            Logger.a(this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.attachRichText2Msg", "convert2CustomFace for [" + this.jdField_a_of_type_Int + "] ");
            localObject1 = agkn.a(this.jdField_a_of_type_Agko.a, (im_msg_body.NotOnlineImage)localObject1);
          }
        }
      }
    }
    ...
    {
      int i;
      synchronized (this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_JavaUtilArrayList)
      {
        ...
        Logger.a(this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.attachRichText2Msg", "[" + this.jdField_a_of_type_Int + "] OK, " + agkm.a(this.jdField_a_of_type_Agko.a.a, (im_msg_body.CustomFace)localObject1));
      ...
      synchronized (this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_JavaUtilArrayList)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqPicPicFowardInfo.a.b == 1) || (this.jdField_a_of_type_ComTencentMobileqqPicPicFowardInfo.a.b == 3000))
        {
          this.jdField_a_of_type_ComTencentMobileqqPicPicResult.jdField_a_of_type_JavaLangObject = this.jdField_a_of_type_Agko.a.a.a(null, null, this.jdField_a_of_type_Int);
          Logger.b(this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.attachRichText2Msg", "[" + this.jdField_a_of_type_Int + "] failed, errDec ＝ " + this.jdField_a_of_type_ComTencentMobileqqPicPicResult.jdField_a_of_type_ComTencentMobileqqPicPicInfoInterface$ErrInfo.b);
          if (QLog.isColorLevel()) {
          ...
          agkn.a(this.jdField_a_of_type_Agko.a);
          if (agkn.a(this.jdField_a_of_type_Agko.a) == 0) {
            agkm.a(this.jdField_a_of_type_Agko.a.a);
          }
          return null;
          ...
          synchronized (this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_JavaUtilArrayList)
          {
            ...
            Logger.a(this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.attachRichText2Msg", "[" + this.jdField_a_of_type_Int + "] OK, " + agkm.a(this.jdField_a_of_type_Agko.a.a, localNotOnlineImage1));
            if (!QLog.isColorLevel()) {
              continue;
            }
            QLog.d("MultiMsg", 2, "[uploadForwardMultiMsgPics] upload [" + this.jdField_a_of_type_Int + "] OK");
          ...
          if (???.custom_face.has())
          {
            ...
            for (;;)
            {
              synchronized (this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_JavaUtilArrayList)
              {
                ...
                Logger.a(this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.attachRichText2Msg", "[" + this.jdField_a_of_type_Int + "] OK, " + agkm.a(this.jdField_a_of_type_Agko.a.a, localCustomFace1));
                if (QLog.isColorLevel()) {
                  QLog.d("MultiMsg", 2, "[uploadForwardMultiMsgPics] upload [" + this.jdField_a_of_type_Int + "] OK");
                }
                i = 1;
              ...
              im_msg_body.NotOnlineImage localNotOnlineImage2 = agkn.a(this.jdField_a_of_type_Agko.a, localCustomFace2);
              synchronized (this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_JavaUtilArrayList)
              {
                this.jdField_a_of_type_ComTencentMobileqqPicPicResult.jdField_a_of_type_Int = 0;
                this.jdField_a_of_type_ComTencentMobileqqPicPicResult.jdField_a_of_type_JavaLangObject = localNotOnlineImage2;
                Logger.a(this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.attachRichText2Msg", "[" + this.jdField_a_of_type_Int + "] OK, " + agkm.a(this.jdField_a_of_type_Agko.a.a, localNotOnlineImage2));
                if (QLog.isColorLevel()) {
                  QLog.d("MultiMsg", 2, "[uploadForwardMultiMsgPics] upload [" + this.jdField_a_of_type_Int + "] OK");
                }
              }
  ...
  public void b(UpCallBack.SendResult paramSendResult)
  {
    synchronized (this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_JavaUtilArrayList)
    {
      if (paramSendResult.jdField_a_of_type_Int != 0)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqPicPicResult.jdField_a_of_type_JavaLangObject = this.jdField_a_of_type_Agko.a.a.a(null, null, this.jdField_a_of_type_Int);
        Logger.a(this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.b, this.jdField_a_of_type_Agko.a.a.jdField_a_of_type_ComTencentMobileqqPicBasePicOprerator.jdField_a_of_type_JavaLangString, "uploadForwardMultiMsgPics.onSend", "[" + this.jdField_a_of_type_Int + "] failed, errDec = " + this.jdField_a_of_type_ComTencentMobileqqPicPicResult.jdField_a_of_type_ComTencentMobileqqPicPicInfoInterface$ErrInfo.b);
        if (QLog.isColorLevel()) {
          QLog.e("MultiMsg", 2, "[uploadForwardMultiMsgPics] upload [" + this.jdField_a_of_type_Int + "] failed, errDec ＝ " + this.jdField_a_of_type_ComTencentMobileqqPicPicResult.jdField_a_of_type_ComTencentMobileqqPicPicInfoInterface$ErrInfo.b);
        }
        agkn.a(this.jdField_a_of_type_Agko.a);
