  ...
  extends asdn
{
  ...
  public asds(QQAppInterface paramQQAppInterface)
  {
  ...
  public void b()
  {
    boolean bool = auog.a(new File(apqx.a()));
    if (QLog.isColorLevel()) {
  ...
  {
    int i = 0;
    long l1 = apra.a("report_tag_so_cover", 0L);
    ...
    for (;;)
    {
      apra.a(paramBoolean, i, str);
      apra.a("report_tag_so_cover", l2);
      return;
      label102:
      paramBoolean = false;
      continue;
