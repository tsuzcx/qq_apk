  ...
  extends alwz
{
  ...
  public alwx(alwu paramalwu, File paramFile)
  {
    super(null);
  ...
  public void a()
  {
    try
    {
      ...
      if (alwu.a(this.jdField_a_of_type_Alwu).size() > 0)
      {
        localObject1 = alwu.a(this.jdField_a_of_type_Alwu).iterator();
        while (((Iterator)localObject1).hasNext())
        {
          ...
          alwu.a(this.jdField_a_of_type_Alwu, (String)((Pair)localObject2).first, (ICloudAVEngine.ResultBundle)((Pair)localObject2).second, this.jdField_a_of_type_OrgXmlpullV1XmlSerializer);
        }
      }
      return;
    }
    catch (Exception localException1)
    {
      ...
      for (;;)
      {
        ...
        alwu.a(this.jdField_a_of_type_Alwu).clear();
        ...
        alwu.a(this.jdField_a_of_type_Alwu).delete();
      }
    }
  }
  ...
  public boolean a(String paramString, ICloudAVEngine.ResultBundle paramResultBundle)
  {
    try
    {
      ...
      alwu.a(this.jdField_a_of_type_Alwu, paramString, paramResultBundle, this.jdField_a_of_type_OrgXmlpullV1XmlSerializer);
      return true;
    }
