  ...
  implements Handler.Callback
{
  ...
  public boolean g = bfni.e();
  public boolean h;
  
  public alwx(Conversation paramConversation, ViewGroup paramViewGroup)
  {
  ...
  private void a(View paramView1, View paramView2, View paramView3)
  {
    ...
    if (this.jdField_a_of_type_ComNineoldandroidsAnimationValueAnimator == null)
    {
      ...
      this.jdField_a_of_type_ComNineoldandroidsAnimationValueAnimator.addUpdateListener(new alxb(this, paramView2, paramView1, paramView3));
      this.jdField_a_of_type_ComNineoldandroidsAnimationAnimator$AnimatorListener = new alxc(this, paramView3);
    }
  ...
  private void b(View paramView1, View paramView2, View paramView3)
  {
    ...
    if (this.jdField_b_of_type_ComNineoldandroidsAnimationValueAnimator == null)
    {
      ...
      this.jdField_b_of_type_ComNineoldandroidsAnimationValueAnimator.addUpdateListener(new alxd(this, paramView2, paramView1, paramView3));
      this.jdField_b_of_type_ComNineoldandroidsAnimationAnimator$AnimatorListener = new alxe(this, paramView3, paramView1);
    }
  ...
  public void o()
  {
    ...
    localAlphaAnimation.setAnimationListener(new alwy(this));
    ...
    localTranslateAnimation.setAnimationListener(new alwz(this));
    localAnimationSet.addAnimation(localTranslateAnimation);
    localAnimationSet.addAnimation(localAlphaAnimation);
    localAlphaAnimation = new AlphaAnimation(1.0F, 0.0F);
    localAlphaAnimation.setDuration(500L);
    localAlphaAnimation.setStartOffset(1000L);
    localAlphaAnimation.setAnimationListener(new alxa(this));
    localAnimationSet.addAnimation(localAlphaAnimation);
