  ...
  extends aqmk
{
  ...
  public aqmg(GalleryBaseData paramGalleryBaseData)
  {
  ...
  public Drawable a()
  {
    for (;;)
    {
      try
      {
        ...
        {
          localDrawable = new aqmo().a((AIOPicData)this.jdField_a_of_type_ComTencentMobileqqGalleryModelGalleryBaseData);
          localObject2 = a();
        ...
        else
        {
          ...
          {
            localDrawable = new aqms().a((AIOShortVideoData)this.jdField_a_of_type_ComTencentMobileqqGalleryModelGalleryBaseData);
            continue;
          }
          if ((this.jdField_a_of_type_ComTencentMobileqqGalleryModelGalleryBaseData instanceof AIOFilePicData))
          {
            localDrawable = new aqmn().a((AIOFilePicData)this.jdField_a_of_type_ComTencentMobileqqGalleryModelGalleryBaseData);
            continue;
          }
          if (!(this.jdField_a_of_type_ComTencentMobileqqGalleryModelGalleryBaseData instanceof AIOFileVideoData)) {
            break label219;
          }
          localDrawable = new aqmp().a((AIOFileVideoData)this.jdField_a_of_type_ComTencentMobileqqGalleryModelGalleryBaseData);
          continue;
        }
        return null;
      }
