...
public class bhyj
{
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        catch (Exception localException1)
        {
          ...
          if ((this.jdField_a_of_type_AndroidViewView instanceof bhyk)) {
            ((bhyk)this.jdField_a_of_type_AndroidViewView).a(this.jdField_a_of_type_AndroidGraphicsCanvas);
          }
          ...
          if ((this.jdField_a_of_type_AndroidViewView instanceof bhyk)) {
            ((bhyk)this.jdField_a_of_type_AndroidViewView).a(paramCanvas);
          }
          if (QLog.isColorLevel())
          {
  ...
  public void b(Canvas paramCanvas)
  {
    ...
    label159:
    while (!(this.jdField_a_of_type_AndroidViewView instanceof bhyk))
    {
      return;
      QLog.e("MosaicEffect", 1, "onDraw: clipBound is empty " + this.jdField_a_of_type_AndroidGraphicsRect);
      return;
    }
    ((bhyk)this.jdField_a_of_type_AndroidViewView).b(this.jdField_a_of_type_AndroidGraphicsCanvas);
  }
}
