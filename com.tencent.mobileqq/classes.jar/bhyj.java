  ...
  implements View.OnClickListener
{
  ...
  public bhyj(Activity paramActivity, bhym parambhym, int paramInt1, String paramString, int paramInt2)
  {
    super(paramActivity, 2131755829);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Bhym = parambhym;
  ...
  public bhyj(Activity paramActivity, CustomWebView paramCustomWebView, String paramString1, int paramInt1, String paramString2, int paramInt2)
  {
    super(paramActivity, 2131755829);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131363375));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131370922));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131365342));
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)findViewById(2131365195));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131364250));
    ...
    Object localObject2 = new ColorDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131167352));
    Object localObject3;
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Bhym != null) {
      this.jdField_a_of_type_Bhym.callback(3);
    }
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      Object localObject1 = bhyk.a(this.jdField_b_of_type_JavaLangString);
      Object localObject2;
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {
      ...
      for (;;)
      {
        ...
        {
          if (this.jdField_a_of_type_Bhym != null) {
            this.jdField_a_of_type_Bhym.callback(4);
          }
          dismiss();
          if (this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView == null) {
            break;
      ...
      if (this.jdField_a_of_type_Bhym != null) {
        this.jdField_a_of_type_Bhym.callback(1);
      }
      dismiss();
      if (this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView != null) {}
      try
