...
public class zgk
  implements Runnable
{
  public zgk(ApolloSlaveViewBinder paramApolloSlaveViewBinder, ImageView paramImageView, RelativeLayout paramRelativeLayout1, RelativeLayout paramRelativeLayout2, ApolloLinearLayout.ViewHolder paramViewHolder) {}
  ...
  public void run()
  {
    ...
    localTranslateAnimation.setAnimationListener(new zgl(this));
