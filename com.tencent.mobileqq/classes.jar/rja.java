...
public class rja
{
  ...
  public static void a(Bundle paramBundle)
  {
    ...
    try
    {
      localSharedPreferences = bmqa.a(pha.a(), true, true);
  ...
  private static void a(String paramString, ArrayList<Intent> paramArrayList)
  {
    ...
    //   218: ldc_w 280
    //   221: aload_0
    //   222: invokestatic 355	rja:b	(Lorg/json/JSONObject;)Ljava/util/ArrayList;
    //   225: invokevirtual 358	android/os/Bundle:putParcelableArrayList	(Ljava/lang/String;Ljava/util/ArrayList;)V
    //   228: aload 7
    //   230: ldc 89
    //   232: aload_0
    //   233: invokestatic 360	rja:a	(Lorg/json/JSONObject;)Ljava/util/ArrayList;
  ...
  public static void b(Bundle paramBundle)
  {
    ...
    c(paramBundle);
    paramBundle = bmqa.a(pha.a(), true, true);
