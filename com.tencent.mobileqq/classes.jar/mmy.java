...
public class mmy
  implements mnd
{
  mnd jdField_a_of_type_Mnd;
  
  public mmy(EffectFilterPanel paramEffectFilterPanel, mnd parammnd)
  {
    a(parammnd);
  }
  ...
  {
    if (AudioHelper.f()) {
      QLog.w("EffectFilterPanel", 1, "OnItemSelected, id[" + paramInt + "], name[" + paramString + "], seq[" + paramLong + "], Visibility[" + EffectFilterPanel.a(this.jdField_a_of_type_ComTencentAvUiFunchatFilterEffectFilterPanel).getVisibility() + "], mlistener[" + this.jdField_a_of_type_Mnd + "]");
    }
