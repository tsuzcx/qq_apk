  ...
  implements BusinessObserver
{
  ...
  public void onReceive(int paramInt, boolean paramBoolean, android.os.Bundle paramBundle)
  {
    ...
    //   221: aastore
    //   222: invokevirtual 101	bhwk:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   225: return
    //   226: astore 8
    //   228: aload_0
    //   229: getfield 12	bhwm:a	Lbhwk;
    //   232: aload_3
    //   233: ldc 53
    ...
    //   249: aastore
    //   250: invokevirtual 101	bhwk:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   253: aload 6
    ...
    //   266: ifne -41 -> 225
    //   269: aload_0
    //   270: getfield 12	bhwm:a	Lbhwk;
    //   273: getfield 104	bhwk:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   276: invokevirtual 110	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   279: ifeq +12 -> 291
    //   282: aload_0
    //   283: getfield 12	bhwm:a	Lbhwk;
    //   286: aload 7
    //   288: putfield 114	bhwk:f	Ljava/lang/String;
    //   291: invokestatic 119	java/lang/System:currentTimeMillis	()J
    //   294: getstatic 122	bhwk:jdField_a_of_type_Long	J
    //   297: lsub
    //   298: ldc2_w 123
    //   301: lcmp
    //   302: iflt -77 -> 225
    //   305: invokestatic 119	java/lang/System:currentTimeMillis	()J
    //   308: putstatic 122	bhwk:jdField_a_of_type_Long	J
    //   311: aload_0
    //   312: getfield 12	bhwm:a	Lbhwk;
    //   315: aload 6
    //   317: aload 7
    //   319: invokestatic 127	bhwk:a	(Lbhwk;Ljava/lang/String;Ljava/lang/String;)V
    //   322: return
    //   323: astore 6
    //   325: aload_0
    //   326: getfield 12	bhwm:a	Lbhwk;
    //   329: aload_3
    //   330: ldc 53
    ...
    //   346: aastore
    //   347: invokevirtual 101	bhwk:callJs	(Ljava/lang/String;[Ljava/lang/String;)V
    //   350: aload 6
    //   352: athrow
