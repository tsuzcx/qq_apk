  ...
  implements SurfaceTexture.OnFrameAvailableListener
{
  ...
  public zde(int paramInt1, int paramInt2)
  {
  ...
  private void e()
  {
    this.jdField_a_of_type_Zdf = new zdf();
    this.jdField_a_of_type_Zdf.a();
    Log.d("CodecOutputSurface", "textureID=" + this.jdField_a_of_type_Zdf.a());
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Zdf.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Zdf = null;
  ...
  {
    this.jdField_a_of_type_Zdf.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Zdf.a("before updateTexImage");
