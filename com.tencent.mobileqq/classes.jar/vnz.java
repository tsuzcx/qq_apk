...
public class vnz
  implements vlb
{
  private vnz(DoodleLayout paramDoodleLayout) {}
  ...
  {
    if (paramFloat == 1.0F) {
      this.a.jdField_a_of_type_Vmg.a(this.a.a().a());
    }
  }
  ...
  {
    if ((this.a.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleEditView != null) && (paramvlc != null))
    {
      ...
      for (;;)
      {
        this.a.jdField_a_of_type_ComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleEditView.a.a(paramvlc);
        paramvlc.d = true;
