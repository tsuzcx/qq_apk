...
{
  public abrm(AppInterface paramAppInterface)
  {
  ...
  public void a(Context paramContext, GdtBaseAdItem paramGdtBaseAdItem)
  {
    ...
    if (aqmy.a(paramGdtBaseAdItem.jdField_a_of_type_JavaLangString, paramContext))
    {
      abru.a(paramGdtBaseAdItem.f);
      ...
      {
        absl.b(paramContext, paramGdtBaseAdItem);
        return;
      }
      absl.a(paramContext, paramGdtBaseAdItem);
      return;
    }
    if (!TextUtils.isEmpty(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString))
    {
      ...
      label133:
      String str;
      if ((absl.a()) && (paramGdtBaseAdItem.jdField_a_of_type_Boolean))
      {
        localObject = "1";
        if (QLog.isColorLevel()) {
          QLog.d("GdtAdHandler", 2, "doAppJump autoDownload  " + (String)localObject);
        }
        if (!absl.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString)) {
          break label576;
        }
        if (("1".equals(localObject)) && (TextUtils.isEmpty((String)absl.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString).get("acttype")))) {
          paramGdtBaseAdItem.jdField_b_of_type_JavaLangString += "&acttype=42";
        }
        if (TextUtils.isEmpty((String)absl.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString).get("wv"))) {
          paramGdtBaseAdItem.jdField_b_of_type_JavaLangString += "&wv=1";
        }
        str = (String)absl.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString).get("_autodownload");
      ...
      label576:
      abru.a(paramGdtBaseAdItem.f);
      paramContext = (String)bhwr.a(paramGdtBaseAdItem.jdField_b_of_type_JavaLangString).get("auto_download");
