...
public class bcyo
  extends bcxb
{
  alnl jdField_a_of_type_Alnl = null;
  NearbyAppInterface jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface;
  
  public bcyo(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString, byte paramByte, int paramInt3, boolean paramBoolean1, Drawable paramDrawable1, Drawable paramDrawable2, bcxc parambcxc, boolean paramBoolean2)
  {
    super(paramAppInterface, paramInt1, paramInt2, paramString, paramByte, paramInt3, 100, paramBoolean1, paramDrawable1, paramDrawable2, parambcxc, paramBoolean2);
  ...
  protected Bitmap b()
  {
    ...
    return ((bcxl)this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.getManager(216)).a(str);
  }
  ...
  protected void b()
  {
    ...
    if (this.jdField_a_of_type_Alnl == null)
    {
      this.jdField_a_of_type_Alnl = new bcyp(this);
      this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.addObserver(this.jdField_a_of_type_Alnl);
    }
