...
public abstract class bcbe<M extends bcfg, V extends bcnr>
  extends bcbd<M, V>
{
  ...
  private List<bcfm> jdField_a_of_type_JavaUtilList;
  ...
  public bcbe(ListView paramListView, FaceDecoder paramFaceDecoder, FullMessageSearchResult.SearchResultItem paramSearchResultItem, String paramString, QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      AbsStructMsg localAbsStructMsg = bdof.a(paramMessageRecord.msgData);
      ...
      try
      {
        ...
        if (j + 50 < this.jdField_a_of_type_ComTencentMobileqqAppFmsFullMessageSearchResult$SearchResultItem.secondPageMessageUniseq.size())
        {
          ...
          if (j < i)
          {
            ...
            this.jdField_a_of_type_JavaUtilList.add(new bcfm(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppFmsFullMessageSearchResult$SearchResultItem.user, localMessageRecord));
            break label177;
          }
        }
        else
