...
public class bbkd
{
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        catch (Exception localException1)
        {
          ...
          if ((this.jdField_a_of_type_AndroidViewView instanceof bbke)) {
            ((bbke)this.jdField_a_of_type_AndroidViewView).b(this.jdField_a_of_type_AndroidGraphicsCanvas);
          }
          ...
          if ((this.jdField_a_of_type_AndroidViewView instanceof bbke)) {
            ((bbke)this.jdField_a_of_type_AndroidViewView).b(paramCanvas);
          }
          if (QLog.isColorLevel())
          {
  ...
  public void b(Canvas paramCanvas)
  {
    ...
    label159:
    while (!(this.jdField_a_of_type_AndroidViewView instanceof bbke))
    {
      return;
      QLog.e("MosaicEffect", 1, "onDraw: clipBound is empty " + this.jdField_a_of_type_AndroidGraphicsRect);
      return;
    }
    ((bbke)this.jdField_a_of_type_AndroidViewView).c(this.jdField_a_of_type_AndroidGraphicsCanvas);
  }
}
