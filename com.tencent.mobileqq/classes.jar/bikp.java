  ...
  extends WebViewPlugin
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bikp.class.getSimpleName();
  }
  ...
  private void c(String paramString)
  {
    ...
    do
    {
      ...
      paramString = bhey.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Context)localObject, paramString);
  ...
  {
    paramString = bhey.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.mRuntime.a(), paramString);
    if (paramString != null) {
      paramString.a();
    }
  }
      ...
      } else if (paramLong == 8589934601L)
      {
        if ((!TextUtils.isEmpty(paramString)) && ((paramString.contains("chatplay/hall")) || (paramString.contains("avwithstranger/avchathall")) || (paramString.contains("chatplay/avchathall"))) && (paramString.endsWith("#child")))
        {
          if ((paramString.contains("adtag=client.tab")) && (this.mRuntime != null) && (this.mRuntime.a() != null))
          {
            ...
            ((IphoneTitleBarActivity)this.mRuntime.a()).setLeftViewName(2131719160);
          }
          while ((this.mRuntime != null) && (this.mRuntime.a() != null) && (this.mRuntime.a().canGoBack()))
          {
            ...
            return true;
            label178:
            if (((this.mRuntime.a() instanceof biex)) && (!biit.a()))
            {
              paramString = this.mRuntime.a();
              if ((paramString != null) && (paramString.mSwiftTitleUI.leftView != null)) {
                paramString.mSwiftTitleUI.leftView.setText(2131719160);
              }
            }
          }
        }
        ...
        if ((this.mRuntime.a() instanceof IphoneTitleBarActivity))
        {
          ((IphoneTitleBarActivity)this.mRuntime.a()).setLeftViewName(2131690676);
        }
        else if (((this.mRuntime.a() instanceof biex)) && (!biit.a()))
        {
          paramString = this.mRuntime.a();
          if ((paramString != null) && (paramString.mSwiftTitleUI.leftView != null)) {
            paramString.mSwiftTitleUI.leftView.setText(2131690676);
          }
        }
      }
    }
  ...
  public boolean handleSchemaRequest(String paramString1, String paramString2)
  {
            ...
            do
            {
              do
              {
                do
                {
                      ...
                      do
                      {
                        do
                        {
                          do
                          {
                            ...
                            {
                              return bool1;
                              if ((znl.a(paramString1)) && (zmk.a(paramString1))) {
                                return false;
                              }
                              localObject1 = null;
                              localObject2 = a();
                              ...
                              if (paramString1.startsWith("tel:"))
                              {
                                ...
                                if ((!bhkn.jdField_a_of_type_Boolean) && (bhkk.a().a())) {
                                  bhkk.a().a(paramString1);
                                }
                                a(paramString1);
                                return true;
                              }
                          ...
                          this.b = true;
                          paramString1 = bhey.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.mRuntime.a(), paramString1);
                          bool1 = bool2;
                        ...
                        this.b = false;
                        return true;
                        if ((!znl.a(paramString1)) && (!paramString1.startsWith("mqqopensdkapi:"))) {
                          break;
                        }
                        paramString2 = this.mRuntime.a();
                        bool1 = bool2;
                      } while (paramString2 == null);
                      paramString2 = bhey.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString2, paramString1);
                  ...
                  paramString1 = bhey.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString2, paramString1);
                  ...
                  if (paramString1.startsWith("http://clientui.3g.qq.com/mqqapi/"))
                  {
                    ...
                    {
                      paramString2 = nwo.b(paramString1, new String[0]);
                      paramString1 = paramString2;
                      if (paramString2.length() > 512) {
                        paramString1 = paramString2.substring(0, 512);
                      }
                      bdla.b(null, "P_CliOper", "BizTechReport", "", "webview_jump", "http_jumpaction", 0, 1, 0, nwo.b((String)localObject1, new String[0]), paramString1, "", "");
                    }
                    return false;
                  }
    ...
    return true;
    if ((paramString1.startsWith("mqqflyticket://")) || (znl.b(paramString1)))
    {
      c(paramString1);
      return true;
    }
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject1 = bkyp.a(paramString1);
        ...
        {
          paramString2 = bhey.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.mRuntime.a(), paramString1);
          if (paramString2 != null) {
            paramString2.a();
          }
        }
