...
public class bikp
  extends anxg
{
  public bikp(BindGroupFragment paramBindGroupFragment) {}
  ...
  protected void a(boolean paramBoolean, int paramInt, long paramLong)
  {
    ...
    if (paramBoolean)
    {
      BindGroupFragment.c(this.a, anni.a(2131699921));
      BindGroupFragment.a(this.a, String.valueOf(paramLong), 1);
      BindGroupFragment.a(this.a).finish();
      return;
    }
    BindGroupFragment.b(this.a, anni.a(2131699927));
  }
  ...
  protected void c(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    BindGroupFragment.a(this.a);
    BindGroupFragment.b(this.a, anni.a(2131699930));
  }
  ...
  protected void g(boolean paramBoolean, String paramString)
  {
    ...
    if (paramBoolean)
    {
      ...
      localIntent.putExtra("url", bkgj.a(paramString, "gname", BindGroupFragment.c(this.a)));
      this.a.startActivity(localIntent);
      return;
    }
    BindGroupFragment.b(this.a, anni.a(2131699916));
  }
}
