  ...
  public boolean a(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return true;
          ajtu.a((QQAppInterface)localObject);
          return true;
          paramBundle = (akiw)((QQAppInterface)localObject).a(44);
          paramBundle.a(new bgrz(this));
          paramBundle.a("");
          return true;
          paramBundle = (ajuf)((QQAppInterface)localObject).a(4);
          paramBundle.a(null, new GetResourceReqInfo[] { paramBundle.d() });
          return true;
          ((QQAppInterface)localObject).addObserver(new bgsa(this));
          return true;
          boolean bool = paramBundle.getBoolean("visible");
          ((ajzl)((QQAppInterface)localObject).a(3)).a(bool);
          return true;
        ...
        return true;
        ((QQAppInterface)localObject).addObserver(new bgsb(this));
        return true;
        ((QQAppInterface)localObject).registObserver(new bgsc(this, null));
        return true;
        paramBundle = (SignatureHandler)((QQAppInterface)localObject).a(41);
      } while (paramBundle == null);
      paramBundle.a();
      ...
      return true;
      paramBundle = bbcl.j((QQAppInterface)localObject, ((QQAppInterface)localObject).getCurrentAccountUin());
