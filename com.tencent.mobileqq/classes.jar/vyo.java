...
public class vyo
  extends vxu
{
  private static final int g = ImmersiveUtils.b() * 2 / 3;
  ...
  private int jdField_b_of_type_Int = this.jdField_a_of_type_Int * 9 / 16;
  ...
  private float a()
  {
    return this.jdField_d_of_type_Int / this.jdField_c_of_type_Int;
  }
  ...
  private boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (int m = arrayOfInt[0];; m = 0)
    {
      ...
      if ((f1 < 0.0F) && (this.f > this.jdField_b_of_type_Int)) {
        return true;
      }
      if ((f1 <= 0.0F) || (this.f >= this.e) || (m != 0)) {
        break;
      }
      return true;
    }
  ...
  private void c()
  {
    this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(new vyp(this));
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setPreviewVideoClickListener(new vyq(this));
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setNextVideoClickListener(new vyr(this));
    if (a() != null) {
      a().a(new vys(this));
    }
    a().addOnItemTouchListener(new vyt(this));
    this.jdField_a_of_type_ComTencentBizSubscribeWidgetSubscribeFollowInfoView.setOnTouchListener(new vyu(this));
  }
  
  private void c(View paramView)
  {
    this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView = ((VideoPlayerView)paramView.findViewById(2131313506));
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131303732);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131303382);
    ...
    this.jdField_a_of_type_Bepx = new bepx(a(), new vyv(this, null));
  ...
  {
    if (baip.a(paramStFeed.video.fileId.get())) {
      QLog.w(jdField_a_of_type_JavaLangString, 1, "video fileId is empty");
    }
    do
    {
      return;
      if (baip.a(paramStFeed.video.playUrl.get()))
      {
  ...
  private void f()
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView != null)
    {
      this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.a(new int[] { this.jdField_a_of_type_Int, this.e });
      if (!this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.f())
      {
        this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.getLayoutParams().height = this.e;
  ...
  private void g()
  {
    ...
    this.jdField_c_of_type_Int = this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.video.width.get();
    this.jdField_d_of_type_Int = this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed.video.height.get();
    QLog.i(jdField_a_of_type_JavaLangString, 1, "resetVideoHW width:" + this.jdField_c_of_type_Int + ", height:" + this.jdField_d_of_type_Int);
    if (this.jdField_c_of_type_Int <= 0)
    {
      this.jdField_c_of_type_Int = 1920;
      this.jdField_d_of_type_Int = 1080;
    }
    int n = (int)(this.jdField_a_of_type_Int * a());
    int m = n;
    if (n > g) {
      m = g;
    }
  ...
  public vya a()
  {
    return (vya)a().a("RELATIVE_ADAPTER_UNIQUE_KEY");
  }
  ...
  protected void a(CertifiedAccountRead.StGetFeedDetailRsp paramStGetFeedDetailRsp, boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView != null) && (vvy.a(paramStGetFeedDetailRsp.type.get())))
    {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    if ((!awnu.b()) && (this.jdField_a_of_type_ComTencentWidgetImmersiveSystemBarCompact != null)) {
    ...
    this.jdField_a_of_type_ComTencentBizSubscribeWidgetSubscribeFollowInfoView = ((SubscribeFollowInfoView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131303685));
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131302884));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131303042));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131303078));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131302932));
    if (a() != null)
    {
      bjeh.a(a());
      bjeh.c(a());
  ...
  {
    if (("share_key_continue_feeds".equals(paramString)) && (paramwbv != null) && (this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView != null)) {
      this.jdField_a_of_type_ComTencentBizSubscribeVideoplayerVideoPlayerView.setContinueFeeds((List)paramwbv.a);
    }
  }
