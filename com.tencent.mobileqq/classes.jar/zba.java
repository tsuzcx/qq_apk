...
public class zba
{
  ...
  private WeakReference<zbc> jdField_a_of_type_JavaLangRefWeakReference;
  private URL jdField_a_of_type_JavaNetURL;
  private boolean jdField_a_of_type_Boolean;
  
  public zba(String paramString, WeakReference<zbc> paramWeakReference)
  {
    try
    {
    ...
    {
      yxs.d("GdtDrawableLoader", "GdtDrawableLoader error " + paramString, paramWeakReference);
    }
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    yxs.b("GdtDrawableLoader", "notify " + paramBoolean + " " + a());
    this.jdField_a_of_type_Boolean = true;
    if (paramBoolean)
    {
      ((zbc)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a(this.jdField_a_of_type_ComTencentImageURLDrawable);
      return;
    }
    ((zbc)this.jdField_a_of_type_JavaLangRefWeakReference.get()).b(this.jdField_a_of_type_ComTencentImageURLDrawable);
  }
  ...
  private boolean a()
  {
    ...
    yxs.b("GdtDrawableLoader", "retry " + a());
  ...
  private void b()
  {
    ...
    if ((!b()) || (this.jdField_a_of_type_ComTencentImageURLDrawable == null)) {
      yxs.b("GdtDrawableLoader", "update error " + a());
    }
    for (;;)
    {
      return;
      ...
      {
        yxs.b("GdtDrawableLoader", "drawable status is loading " + a());
        i = j;
      ...
      while ((i != 0) && (!this.jdField_a_of_type_Boolean))
      {
        ...
        {
          yxs.b("GdtDrawableLoader", "drawable status is file downloaded " + a());
          i = j;
        }
        else if (this.jdField_a_of_type_ComTencentImageURLDrawable.getStatus() == 1)
        {
          yxs.b("GdtDrawableLoader", "drawable status is successed " + a());
          a(true);
          i = 0;
        }
        else if (this.jdField_a_of_type_ComTencentImageURLDrawable.getStatus() == 2)
        {
          yxs.d("GdtDrawableLoader", "drawable status is failed " + a());
          i = j;
          if (!a())
          {
            a(false);
        ...
        {
          yxs.d("GdtDrawableLoader", "drawable status is cancled " + a());
          a(false);
          i = 0;
        }
        else
        {
          yxs.d("GdtDrawableLoader", "drawable status is " + this.jdField_a_of_type_ComTencentImageURLDrawable.getStatus() + " " + a());
          i = 0;
        }
      }
    }
  ...
  public void a()
  {
    ...
    yxs.b("GdtDrawableLoader", "load " + a());
    ...
    {
      yxs.d("GdtDrawableLoader", "load error " + a());
      return;
    }
