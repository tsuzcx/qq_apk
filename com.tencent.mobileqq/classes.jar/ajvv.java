...
{
  public ajvv(SelectMemberActivity paramSelectMemberActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.a.d == 11)
    {
      if (this.a.jdField_a_of_type_ComTencentCommonAppInnerFrameManager.a() == 0) {
        azmj.b(this.a.app, "CliOper", "", "", "0X8005527", "0X8005527", 0, 0, "", "", "", "");
      }
    }
    else if (this.a.b == 3)
    {
    ...
    {
      azmj.b(null, "dc00899", "Grp_video", "", "invite", "Clk_call", 0, 0, (String)localObject1, (String)localObject2, paramView, "");
      if (this.a.d != 33) {
        break label290;
      }
      aisa.a(this.a, this.a.jdField_e_of_type_JavaUtilArrayList);
      return;
      if (this.a.jdField_a_of_type_ComTencentCommonAppInnerFrameManager.a() != 1) {
        break;
      }
      azmj.b(this.a.app, "CliOper", "", "", "0X8005526", "0X8005526", 0, 0, "", "", "", "");
      break;
    }
    label290:
    if ((this.a.d == 32) && (this.a.jdField_e_of_type_JavaUtilArrayList.size() > this.a.g))
    {
      paramView = MessageFormat.format(this.a.getString(2131719712), new Object[] { Integer.valueOf(this.a.g) });
      QQToast.a(this.a, paramView, 0).b(this.a.jdField_c_of_type_AndroidViewView.getHeight());
      return;
    }
    if (!bdee.d(this.a))
    {
      QQToast.a(this.a, this.a.getString(2131692397), 0).b(this.a.jdField_c_of_type_AndroidViewView.getHeight());
      return;
    }
    if ((this.a.v) && (this.a.jdField_e_of_type_JavaUtilArrayList.size() == 1) && (this.a.jdField_e_of_type_JavaUtilArrayList.get(0) != null))
    {
      ...
      {
        QQToast.a(this.a, this.a.getString(2131719710), 0).b(this.a.jdField_c_of_type_AndroidViewView.getHeight());
        return;
      }
    }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      {
        bdcd.a(this.a, 230, this.a.getString(2131696156), this.a.getString(2131720936), 2131695892, 2131691088, new ajvw(this), new ajvx(this)).show();
        azmj.b(null, "CliOper", "", "", "0X8004CED", "0X8004CED", 0, 0, "", "", "", "");
        return;
      }
      int i;
      ...
      for (paramView = this.a.a(((ResultRecord)localObject1).jdField_c_of_type_JavaLangString);; paramView = null)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            Object localObject3 = ((aloz)this.a.app.getManager(51)).e(((ResultRecord)localObject1).jdField_a_of_type_JavaLangString);
            int j = i;
            ...
            this.a.finish();
            azmj.b(this.a.app, "CliOper", "", "", "0X8006664", "0X8006664", 0, 0, "", "", "", "");
            if (this.a.b == 1)
            {
              paramView = this.a.jdField_e_of_type_JavaUtilArrayList.iterator();
              i = 0;
            ...
            for (;;)
            {
              ...
              if (this.a.d == 24)
              {
                ...
                this.a.setResult(-1, paramView);
                if (this.a.s) {
                  wta.a("set_notsee", "clk_done", 0, 0, new String[] { "", "", "", "" });
                }
                for (;;)
                {
                  this.a.finish();
                  break;
                  wta.a("set_notletsee", "clk_done", 0, 0, new String[] { "", "", "", "" });
                }
              }
              if (this.a.d == 37)
              {
              ...
              for (;;)
              {
                azmj.b(this.a.app, "dc00899", "invite_friend", "", "friend_list", "invite_friend", 0, 0, this.a.jdField_c_of_type_JavaLangString, String.valueOf(j), String.valueOf(i), "");
                return;
