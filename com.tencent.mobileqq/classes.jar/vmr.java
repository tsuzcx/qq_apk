...
public class vmr
{
  ...
  {
    paramString2 = vnd.b(paramString2);
    vmp.d("WeishiScehmeUtil", "openWeishi: scheme = " + paramString2);
    jdField_a_of_type_Boolean = true;
    zfn.a(paramContext, paramString1, paramString2);
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      vmp.d("WeishiScehmeUtil", "openWeishi context = " + paramContext + "scheme = " + paramString2);
      return;
    }
    ...
    vmp.c("WeishiScehmeUtil", "openWeishi final scheme = " + paramString2);
