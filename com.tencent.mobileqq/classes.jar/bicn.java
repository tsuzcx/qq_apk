...
public class bicn
  extends bici
{
  public static bicn a;
  public static final HashMap<Integer, String> a;
  
  static
  {
    jdField_a_of_type_Bicn = new bicn();
  ...
  public Bitmap a(Context paramContext, int paramInt, String paramString)
  {
    ...
    paramString = new bhgn();
    bhgm.a(paramContext, localOptions, paramString);
  ...
  public boolean a(Context paramContext, int paramInt)
  {
    ...
    paramContext = jdField_a_of_type_Bicn.getDir(paramContext, (String)localObject);
