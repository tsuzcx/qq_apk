...
public class blsb
{
  ...
  static
  {
    ...
    jdField_b_of_type_JavaLangString = anni.a(2131710683);
  }
  ...
  {
    Intent localIntent = new Intent();
    localIntent.putExtra("key_left_tab_title", paramContext.getString(2131716198));
    localIntent.putExtra("key_rihgt_tab_title", paramContext.getString(2131716279));
  ...
  @NonNull
  private static Intent a(blsi paramblsi, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo)
  {
    Intent localIntent = new Intent();
    a(localIntent, paramblsi);
  ...
  private static Intent a(blsi paramblsi, String paramString)
  {
    Intent localIntent = new Intent();
    a(localIntent, paramblsi);
  ...
  public static SurfaceView a(Context paramContext, String paramString)
  {
    try
    {
      if (f())
      {
        biti.a().a(jdField_b_of_type_JavaLangString, 1);
        return null;
      }
      try
      {
  ...
  {
    bglp.a(paramActivity, 230).setMessage(2131716779).setPositiveButton(2131716309, new blsc()).setNegativeButton(2131718059, paramOnClickListener).show();
  }
  ...
  public static void a(Activity paramActivity, Bundle paramBundle, blsi paramblsi, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    Intent localIntent = new Intent();
    ...
    QzonePluginProxyActivity.a(paramActivity, paramblsi.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void a(Activity paramActivity, blsi paramblsi, int paramInt)
  {
    c(paramActivity, paramblsi, null, paramInt);
  }
  
  public static void a(Activity paramActivity, blsi paramblsi, int paramInt, Bundle paramBundle)
  {
    Intent localIntent = new Intent();
    localIntent.putExtras(paramBundle);
    a(localIntent, paramblsi);
  ...
  public static void a(Activity paramActivity, blsi paramblsi, int paramInt, String paramString, long paramLong1, long paramLong2)
  {
    Intent localIntent = new Intent();
    a(localIntent, paramblsi);
    ...
    QzonePluginProxyActivity.a(paramActivity, paramblsi.jdField_a_of_type_JavaLangString, localIntent, 0);
  }
  
  public static void a(Activity paramActivity, blsi paramblsi, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString5, int paramInt8, Bundle paramBundle, boolean paramBoolean1, boolean paramBoolean2, int paramInt9, int paramInt10, boolean paramBoolean3)
  {
    a(paramActivity, paramblsi, paramInt1, paramString1, paramString2, paramString3, paramString4, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramString5, paramInt8, paramBundle, paramBoolean1, paramBoolean2, paramInt9, paramInt10, paramBoolean3, null);
  }
  ...
  public static void a(Activity paramActivity, blsi paramblsi, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString5, int paramInt8, Bundle paramBundle1, boolean paramBoolean1, boolean paramBoolean2, int paramInt9, int paramInt10, boolean paramBoolean3, Bundle paramBundle2)
  {
    ...
    for (;;)
    {
      ...
      for (paramInt2 = 1;; paramInt2 = 0)
      {
        ...
        QzonePluginProxyActivity.a(paramActivity, paramblsi.jdField_a_of_type_JavaLangString, paramString1, paramInt1, null, true);
        return;
      }
    }
  }
  ...
  {
    a(paramActivity, paramblsi, paramInt1, paramString1, paramString2, paramString3, paramString4, paramInt2, paramBoolean1, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramString5, paramInt8, paramInt9, paramBoolean2, paramString6, paramBoolean3, null);
  }
  ...
  public static void a(Activity paramActivity, blsi paramblsi, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt2, boolean paramBoolean1, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString5, int paramInt8, int paramInt9, boolean paramBoolean2, String paramString6, boolean paramBoolean3, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      for (paramInt7 = 1;; paramInt7 = 0)
      {
        ...
        QzonePluginProxyActivity.a(paramActivity, paramblsi.jdField_a_of_type_JavaLangString, paramString1, paramInt1, null, paramBoolean2);
        return;
      }
    }
  }
  
  public static void a(Activity paramActivity, blsi paramblsi, long paramLong, int paramInt)
  {
    Intent localIntent = new Intent();
    a(localIntent, paramblsi);
  ...
  public static void a(Activity paramActivity, blsi paramblsi, Intent paramIntent)
  {
    a(paramActivity, paramblsi, paramIntent, -1);
  }
  
  public static void a(Activity paramActivity, blsi paramblsi, Intent paramIntent, int paramInt)
  {
    a(paramIntent, paramblsi);
    if (paramInt >= 0) {
    ...
    for (;;)
    {
      ...
      QzonePluginProxyActivity.a(paramActivity, paramblsi.jdField_a_of_type_JavaLangString, paramIntent, paramInt);
      return;
      paramIntent.putExtra("bNeedCallBack", false);
    }
  }
  
  public static void a(Activity paramActivity, blsi paramblsi, Intent paramIntent, int paramInt, DialogInterface.OnDismissListener paramOnDismissListener)
  {
    QzonePluginProxyActivity.a(paramActivity, paramblsi.jdField_a_of_type_JavaLangString, paramIntent, paramInt, paramOnDismissListener, true);
  }
  
  public static void a(Activity paramActivity, blsi paramblsi, Intent paramIntent, int paramInt, boolean paramBoolean)
  {
    a(paramIntent, paramblsi);
    if (paramInt >= 0) {
      paramIntent.putExtra("bNeedCallBack", true);
    ...
    {
      QzonePluginProxyActivity.a(paramIntent, "com.qzone.misc.web.QZoneTranslucentActivity");
      QzonePluginProxyActivity.a(paramActivity, paramblsi.jdField_a_of_type_JavaLangString, paramIntent, paramInt, null, paramBoolean);
      return;
      paramIntent.putExtra("bNeedCallBack", false);
    }
  }
  
  public static void a(Activity paramActivity, blsi paramblsi, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = a(paramblsi, "com.qzone.album.ui.activity.QZonePersonalAlbumSelectActivity");
    localIntent.putExtras(paramBundle);
    QzonePluginProxyActivity.a(paramActivity, paramblsi.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void a(Activity paramActivity, blsi paramblsi, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt)
  {
    paramBaseBusinessAlbumInfo = a(paramblsi, paramBaseBusinessAlbumInfo);
    QzonePluginProxyActivity.a(paramActivity, paramblsi.jdField_a_of_type_JavaLangString, paramBaseBusinessAlbumInfo, paramInt);
  }
  
  public static void a(Activity paramActivity, blsi paramblsi, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt, String paramString)
  {
    paramBaseBusinessAlbumInfo = a(paramblsi, paramBaseBusinessAlbumInfo);
  ...
  public static void a(Activity paramActivity, blsi paramblsi, CoverCacheData paramCoverCacheData, String paramString, int paramInt)
  {
    paramblsi = blsf.a(paramblsi.jdField_a_of_type_JavaLangString, paramString, "usersummary", true);
    paramCoverCacheData = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramCoverCacheData);
    paramCoverCacheData.putExtra("url", paramblsi);
    if (bhog.a.containsKey("Qzone")) {
      paramCoverCacheData.putExtra("insertPluginsArray", new String[] { "Qzone" });
    }
    paramCoverCacheData.setData(Uri.parse(paramblsi));
    c(paramCoverCacheData);
    paramActivity.startActivityForResult(paramCoverCacheData, paramInt);
  }
  
  public static void a(Activity paramActivity, blsi paramblsi, Long paramLong, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    a(paramActivity, paramblsi, paramLong, paramInt1, paramBoolean, paramInt2, 5);
  }
  
  public static void a(Activity paramActivity, blsi paramblsi, Long paramLong, int paramInt1, boolean paramBoolean, int paramInt2, int paramInt3)
  {
    LocalMultiProcConfig.putBool("key_photo_guide_is_red", paramBoolean);
    paramLong = a(paramActivity, paramLong, paramInt1);
    a(paramLong, paramblsi);
    ...
    QzonePluginProxyActivity.a(paramActivity, paramblsi.jdField_a_of_type_JavaLangString, paramLong, paramInt2);
  }
  
  @Deprecated
  public static void a(Activity paramActivity, blsi paramblsi, String paramString, int paramInt)
  {
    if (TextUtils.isEmpty(paramString)) {
      return;
    }
  ...
  public static void a(Activity paramActivity, blsi paramblsi, String paramString1, int paramInt, Bundle paramBundle, String paramString2)
  {
    Intent localIntent = new Intent();
    a(localIntent, paramblsi);
  ...
  public static void a(Activity paramActivity, blsi paramblsi, String paramString1, int paramInt, String paramString2)
  {
  ...
  public static void a(Activity paramActivity, blsi paramblsi, String paramString1, long paramLong, int paramInt1, int paramInt2, String paramString2, String paramString3)
  {
    Intent localIntent = new Intent();
    ...
    QzonePluginProxyActivity.a(paramActivity, paramblsi.jdField_a_of_type_JavaLangString, localIntent, paramInt1);
  }
  
  public static void a(Activity paramActivity, blsi paramblsi, String paramString1, long paramLong, String paramString2, int paramInt)
  {
  ...
  public static void a(Activity paramActivity, blsi paramblsi, String paramString1, long paramLong, String paramString2, int paramInt, String paramString3, boolean paramBoolean)
  {
    Intent localIntent = new Intent("com.tencent.intent.QZONE_OPEN_VIP");
    a(localIntent, paramblsi);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.module.vipcomponent.ui.DiamondYellowOpenActivity");
  ...
  public static void a(Activity paramActivity, blsi paramblsi, String paramString1, long paramLong, String paramString2, String paramString3, int paramInt)
  {
    Object localObject;
    if (paramActivity == null) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((Intent)localObject).putExtra("userId", paramblsi.jdField_a_of_type_JavaLangString);
        ((Intent)localObject).putExtra("userName", paramblsi.jdField_b_of_type_JavaLangString);
  ...
  public static void a(Activity paramActivity, blsi paramblsi, String paramString1, String paramString2, int paramInt)
  {
    Intent localIntent = new Intent();
    a(localIntent, paramblsi);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.detail.ui.activity.QzoneDetailActivity");
  ...
  public static void a(Activity paramActivity, blsi paramblsi, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    Intent localIntent = new Intent();
    a(localIntent, paramblsi);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.detail.ui.activity.QzoneDetailActivity");
    ...
    QzonePluginProxyActivity.a(paramActivity, paramblsi.jdField_a_of_type_JavaLangString, localIntent, paramInt2);
  }
  
  public static void a(Activity paramActivity, blsi paramblsi, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3)
  {
    ...
    paramblsi = paramString1;
    if (!TextUtils.isEmpty(paramString3)) {
      paramblsi = paramString1 + "&source=" + paramString3;
    }
    paramString1 = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramString1);
    if (QLog.isColorLevel()) {
      QLog.d("QZoneHelper", 2, "forwardToQunAlbumList:" + paramblsi);
    }
    paramString1.putExtra("url", paramblsi);
    if (bhog.a.containsKey("Qzone")) {
      paramString1.putExtra("insertPluginsArray", new String[] { "Qzone" });
    }
    paramString1.setData(Uri.parse(paramblsi));
    c(paramString1);
    paramActivity.startActivityForResult(paramString1, paramInt2);
  }
  
  public static void a(Activity paramActivity, blsi paramblsi, String paramString1, String paramString2, String paramString3, int paramInt)
  {
  ...
  public static void a(Activity paramActivity, blsi paramblsi, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    paramblsi = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunAlbumPhotoList", "https://h5.qzone.qq.com/groupphoto/inqq/photo/{QUN_ID}/{ALBUM_ID}?_wv=3&_proxy=1").replace("{QUN_ID}", paramString1).replace("{ALBUM_ID}", paramString2);
    paramString1 = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramString1);
    paramString1.putExtra("url", paramblsi);
    if (bhog.a.containsKey("Qzone")) {
  ...
  public static void a(Activity paramActivity, blsi paramblsi, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, Bundle paramBundle)
  {
    a(paramActivity, paramblsi, paramString1, paramString2, paramString3, paramString4, paramInt, paramBundle, true, false);
  }
  
  public static void a(Activity paramActivity, blsi paramblsi, String paramString1, String paramString2, String paramString3, String paramString4, long paramLong, int paramInt)
  {
  ...
  public static void a(Activity paramActivity, blsi paramblsi, String paramString1, String paramString2, ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, ArrayList<Long> paramArrayList, int paramInt, String paramString3, String paramString4)
  {
    Intent localIntent = new Intent("com.tencent.intent.QZONE_RESHIP_FROM_QUN_AIO_TO_QUN");
    a(localIntent, paramblsi);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
  ...
  public static void a(Activity paramActivity, blsi paramblsi, String paramString1, String paramString2, boolean paramBoolean, int paramInt)
  {
    paramblsi = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunFeed", "https://h5.qzone.qq.com/groupphoto/inqq/recent/{QUN_ID}/groupphoto?_wv=3&_proxy=1").replace("{QUN_ID}", paramString1);
    ...
    paramString1.putExtra("source_name", BaseApplicationImpl.getContext().getString(2131716498));
    paramString1.setData(Uri.parse(paramblsi));
  ...
  public static void a(Activity paramActivity, blsi paramblsi, boolean paramBoolean, String paramString1, String paramString2, int paramInt1, String paramString3, String paramString4, long paramLong1, long paramLong2, int paramInt2)
  {
  ...
  public static void a(Activity paramActivity, blsi paramblsi, boolean paramBoolean, String paramString1, String paramString2, int paramInt1, ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, ArrayList<Long> paramArrayList3, ArrayList<Long> paramArrayList4, int paramInt2)
  {
    Intent localIntent = new Intent("com.tencent.intent.QZONE_QUOTE_FROM_AIO");
    a(localIntent, paramblsi);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
  ...
  public static void a(Activity paramActivity, String paramString1, int paramInt1, int paramInt2, long paramLong, String paramString2, String paramString3, String paramString4, int paramInt3, int paramInt4)
  {
    ...
    a(paramString1, localblsi);
    QzonePluginProxyActivity.a(paramString1, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
    QzonePluginProxyActivity.a(paramActivity, localblsi.jdField_a_of_type_JavaLangString, paramString1, paramInt3);
  }
  ...
  {
    blsi localblsi = blsi.a();
    localblsi.jdField_a_of_type_JavaLangString = paramString2;
    ...
    b(paramActivity, localblsi, paramString2, -1);
  }
  ...
  public static void a(Context paramContext, blsi paramblsi)
  {
    paramblsi = QzoneConfig.getInstance().getConfig("H5Url", "QzonePictureSettingPage", "https://h5.qzone.qq.com/image/setting/imageSetting?_wv=3&_proxy=1&uin={uin}").replace("{uin}", String.valueOf(paramblsi.jdField_a_of_type_JavaLangString)).replace("{host_uin}", paramblsi.jdField_a_of_type_JavaLangString).replace("{UIN}", String.valueOf(paramblsi.jdField_a_of_type_JavaLangString)).replace("{HOST_UIN}", paramblsi.jdField_a_of_type_JavaLangString);
    if (!bkgj.b(paramblsi).containsKey("_wv")) {
      bkgj.a(paramblsi, "_wv", "5");
    }
    if (QLog.isColorLevel()) {
      QLog.d("QZoneHelper", 2, "jump qzone setting URL:" + paramblsi);
    }
    Intent localIntent = new Intent(BaseApplication.getContext(), QQBrowserActivity.class);
    a(localIntent);
    localIntent.putExtra("url", paramblsi);
    ...
    localIntent.setData(Uri.parse(paramblsi));
    localIntent.addFlags(268435456);
    c(localIntent);
    paramContext.startActivity(localIntent);
  }
  
  public static void a(Context paramContext, blsi paramblsi, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    a(paramContext, paramblsi, paramString, paramInt1, paramInt2, paramInt3, null, null, false);
  }
  
  public static void a(Context paramContext, blsi paramblsi, String paramString, int paramInt1, int paramInt2, int paramInt3, avaj paramavaj, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      QzonePluginProxyActivity.a(paramContext, paramblsi.jdField_a_of_type_JavaLangString, localIntent, paramInt2, paramavaj);
      return;
      i = 0;
      break;
      label107:
  ...
  public static void a(Context paramContext, blsi paramblsi, String paramString1, int paramInt1, int paramInt2, avaj paramavaj, String paramString2, boolean paramBoolean)
  {
    ...
    QzonePluginProxyActivity.a(paramContext, paramblsi.jdField_a_of_type_JavaLangString, paramString1, paramInt1, paramavaj);
  }
  
  public static void a(Context paramContext, blsi paramblsi, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, Bundle paramBundle, boolean paramBoolean1, boolean paramBoolean2)
  {
    Intent localIntent = new Intent();
    a(localIntent, paramblsi);
    localIntent.putExtra("startup_sceneid", 4);
    ...
    try
    {
      ...
      for (paramString1 = paramBundle;; paramString1 = new Bundle())
      {
        ...
        QzonePluginProxyActivity.a(paramContext, paramblsi.jdField_a_of_type_JavaLangString, localIntent, paramInt, null, paramBoolean1);
        return;
      }
      return;
    }
  ...
  public static void a(Intent paramIntent, blsi paramblsi)
  {
    paramIntent.putExtra("qzone_uin", paramblsi.jdField_a_of_type_JavaLangString);
    paramIntent.putExtra("nickname", paramblsi.jdField_b_of_type_JavaLangString);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, blsi paramblsi, int paramInt1, boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2, boolean paramBoolean3, boolean paramBoolean4, String paramString3, boolean paramBoolean5, String paramString4, String paramString5, boolean paramBoolean6, boolean paramBoolean7, boolean paramBoolean8, boolean paramBoolean9, String paramString6, boolean paramBoolean10, boolean paramBoolean11, boolean paramBoolean12, int paramInt2, boolean paramBoolean13, Bundle paramBundle)
  {
    ...
    if (paramBoolean12)
    {
      ...
      if (paramBoolean2)
      {
        paramblsi = agaa.a(anhk.bn);
        paramQQAppInterface.putBoolean("support_photo_merge", true);
        paramQQAppInterface.putString("qcamera_photo_filepath", paramblsi);
        ...
        paramQQAppInterface.putString("pic_confirm_text", anni.a(2131710687));
      }
    ...
    for (;;)
    {
      ...
      break;
      label387:
      bglp.a(paramActivity, 230).setMessage(anni.a(2131710685)).setPositiveButton(2131694081, new blse()).show();
    }
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, PublishMoodInfo paramPublishMoodInfo, Intent paramIntent, int paramInt, boolean paramBoolean)
  {
    ...
    bltb.a(paramQQAppInterface, paramActivity, localBundle, null, paramInt);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, ServiceConnection paramServiceConnection)
  {
    ...
    localblfq.jdField_d_of_type_JavaLangString = "QQ空间";
    localblfq.jdField_a_of_type_JavaLangString = paramQQAppInterface.getCurrentAccountUin();
    localblfq.jdField_e_of_type_JavaLangString = "com.qzone.publish.business.publishqueue.PublishQueueService";
    localblfq.jdField_a_of_type_AndroidContentIntent = localIntent;
  ...
  public static void a(QQAppInterface paramQQAppInterface, avaj paramavaj)
  {
    ThreadManager.post(new QZoneHelper.8(paramQQAppInterface, paramavaj), 8, null, false);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, avaj paramavaj, boolean paramBoolean)
  {
    if ((paramQQAppInterface == null) || (c())) {
      return;
    }
    ...
    {
      bcst.b(paramQQAppInterface, "CliOper", "", "", "0X8005E9C", "0X8005E9C", 1, 0, "", "", "", "");
      bcts.a().a("actQZLoadHitRateRed", true);
    }
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        try
        {
          ...
          for (;;)
          {
            ((Intent)localObject).putExtra("cpuNum", bgln.b());
            ...
            if (!bcow.jdField_d_of_type_Boolean) {
              break label504;
            }
            if (QLog.isColorLevel()) {
              QLog.d("Perf", 2, "disable preload qzone process");
            }
            bcow.e = System.currentTimeMillis();
            return;
            if ("Leba".equals(paramString))
            {
              bcst.b(paramQQAppInterface, "CliOper", "", "", "0X8005E9C", "0X8005E9C", 1, 0, "", "", "", "");
              bcts.a().a("actQZLoadHitRateLeba", true);
              break;
            }
            if (!"FriendProfileCardActivity".equals(paramString)) {
              break;
            }
            bcts.a().a("actQZLoadHitRateProfile", true);
            break;
            QLog.d("QZoneHelper", 1, "preloadQzone is not allowed as crash frequently.");
            bctj.a(BaseApplicationImpl.getContext()).a(paramQQAppInterface.getCurrentAccountUin(), "actNoPreloadQzone", true, 0L, 0L, null, "");
            return;
        ...
        catch (Exception paramString)
        {
          ...
          paramString.jdField_a_of_type_Avaj = paramavaj;
          ...
          blfh.c(paramQQAppInterface.getApp(), paramString);
        }
      }
    }
  }
  ...
  public static void a(WebViewPlugin paramWebViewPlugin, bhod parambhod, Activity paramActivity, String paramString1, String paramString2)
  {
    Intent localIntent = new Intent();
    QzonePluginProxyActivity.a(localIntent, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
    localIntent.putExtra("startup_sceneid", 6);
    ...
    QzonePluginProxyActivity.a(paramActivity, paramString1, localIntent, a(paramWebViewPlugin, parambhod, 1));
  }
  ...
  public static void a(BaseApplication paramBaseApplication, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        localIntent.putExtra("cpuNum", bgln.b());
    ...
    catch (Exception paramString2)
    {
      ...
      paramString2.jdField_a_of_type_JavaLangString = paramString1;
      paramString2.jdField_a_of_type_Avaj = null;
      ...
      blfh.c(paramBaseApplication, paramString2);
    }
  }
  ...
  public static void a(String paramString, Context paramContext)
  {
    ...
    ((Intent)localObject).putExtra("source_name", BaseApplicationImpl.getContext().getString(2131716498));
  ...
  public static void a(String paramString1, ArrayList<String> paramArrayList1, int paramInt1, LbsDataV2.PoiInfo paramPoiInfo, String paramString2, String paramString3, ArrayList<String> paramArrayList2, HashMap<String, String> paramHashMap1, HashMap<String, String> paramHashMap2, String paramString4, int paramInt2)
  {
    ...
    bmfd.a().a("cmd.publishMixMood", paramString2, false);
  }
  ...
  public static void a(String paramString1, ArrayList<String> paramArrayList1, int paramInt1, ArrayList<String> paramArrayList2, int paramInt2, int paramInt3, String paramString2, boolean paramBoolean1, boolean paramBoolean2, int paramInt4, String paramString3)
  {
    ...
    bmfd.a().a("cmd.publishMoodForAll", localBundle, false);
  }
  ...
  {
    bmgu.a(paramString1, paramInt1, paramString2, paramInt2);
  }
  ...
  public static void a(AppRuntime paramAppRuntime, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      bgjw.a(BaseApplicationImpl.getContext(), "com.tencent.mobileqq:picture");
      ...
      bgjw.a(BaseApplicationImpl.getContext(), "com.tencent.mobileqq:qzonevideo");
      blwf.a((Context)localObject);
      if (!TextUtils.isEmpty(str))
      {
      ...
      {
        atwl.c((String)localObject + File.separator + "qz_predownload_config.xml");
        atwl.c((String)localObject + File.separator + "QZ_Per_Config.xml");
        atwl.c((String)localObject + File.separator + "QZONE_UNREAD.xml");
      }
      localObject = bhgg.a(Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "tencent" + File.separator + "MobileQQ" + File.separator + "trace");
      if (localObject != null) {
  ...
  public static void a(boolean paramBoolean, blsh paramblsh)
  {
    if (!paramBoolean)
    {
      paramblsh.a(false, true);
      return;
    }
    ThreadManager.postImmediately(new QZoneHelper.6(paramblsh), null, true);
  }
  ...
  public static boolean a(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    if (QzoneConfig.getInstance().getConfig("QZoneSetting", "aio2qzonedetail", 1) == 1)
    {
      ...
      QzonePluginProxyActivity.a(paramActivity, blsi.a().jdField_a_of_type_JavaLangString, paramString2, 0);
      if (QLog.isColorLevel()) {
    ...
    try
    {
      if (bcnj.a())
      {
        if ((paramContext instanceof FragmentActivity))
        {
          ...
          if (!blvu.a((FragmentActivity)paramContext, ((FragmentActivity)paramContext).app)) {
            return false;
          }
        }
  ...
  {
    return bkgu.a(paramContext, paramString);
  }
  ...
  {
    bglp.a(paramActivity, 230).setMessage(2131716780).setPositiveButton(2131718059, paramOnClickListener).setNegativeButton(2131716309, new blsd()).show();
  }
  
  public static void b(Activity paramActivity, blsi paramblsi, int paramInt)
  {
    paramblsi = QzoneConfig.getInstance().getConfig("H5Url", "QzoneSettingMainPage", "https://h5.qzone.qq.com/qzone/setting?_wv=3&_proxy=1&uin={uin}").replace("{uin}", String.valueOf(paramblsi.jdField_a_of_type_JavaLangString)).replace("{host_uin}", paramblsi.jdField_a_of_type_JavaLangString).replace("{UIN}", String.valueOf(paramblsi.jdField_a_of_type_JavaLangString)).replace("{HOST_UIN}", paramblsi.jdField_a_of_type_JavaLangString);
    if (!bkgj.b(paramblsi).containsKey("_wv")) {
      bkgj.a(paramblsi, "_wv", "5");
    }
    if (QLog.isColorLevel()) {
  ...
  public static void b(Activity paramActivity, blsi paramblsi, Intent paramIntent)
  {
    a(paramIntent, paramblsi);
    QzonePluginProxyActivity.a(paramIntent, "com.qzone.misc.web.QZoneTranslucentActivity2");
    QzonePluginProxyActivity.a(paramActivity, paramblsi.jdField_a_of_type_JavaLangString, paramIntent, 0);
  }
  
  public static void b(Activity paramActivity, blsi paramblsi, Intent paramIntent, int paramInt)
  {
  ...
  public static void b(Activity paramActivity, blsi paramblsi, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = a(paramblsi, "com.qzone.album.business.photolist.activity.QZonePersonalPhotoListActivity");
    localIntent.putExtras(paramBundle);
    QzonePluginProxyActivity.a(paramActivity, paramblsi.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void b(Activity paramActivity, blsi paramblsi, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt)
  {
    paramBaseBusinessAlbumInfo = a(paramblsi, paramBaseBusinessAlbumInfo);
  ...
  public static void b(Activity paramActivity, blsi paramblsi, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt, String paramString)
  {
    Intent localIntent = new Intent();
    a(localIntent, paramblsi);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.album.business.photolist.activity.QZonePersonalPhotoListActivity");
  ...
  public static void b(Activity paramActivity, blsi paramblsi, Long paramLong, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    a(paramActivity, paramblsi, paramLong, paramInt1, paramBoolean, paramInt2, 12);
  }
  
  public static void b(Activity paramActivity, blsi paramblsi, String paramString, int paramInt)
  {
    try
    {
      Intent localIntent = new Intent();
  ...
  public static void b(Activity paramActivity, blsi paramblsi, String paramString1, long paramLong, String paramString2, int paramInt)
  {
  ...
  public static void b(Activity paramActivity, blsi paramblsi, String paramString1, String paramString2, int paramInt)
  {
    paramblsi = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunAlbumDetail", "https://h5.qzone.qq.com/groupphoto/inqq/detail/{QQ_URL}?_wv=3&_proxy=1").replace("{QQ_URL}", URLEncoder.encode(paramString1));
    paramString1 = new Intent(BaseApplication.getContext(), QQBrowserDelegationActivity.class);
    paramString1.putExtra("url", paramblsi);
    paramString1.putExtra("fromQZone", true);
    paramString1.putExtra("injectrecommend", true);
  ...
  {
    if (!bgrj.a(paramQQAppInterface.getApp(), new String[] { paramString1 })) {
      return;
    }
    a(paramIntent, paramQQAppInterface, paramString2, paramBitmap);
    Thread.sleep(1000L);
    bgrj.a(paramQQAppInterface, paramIntent, paramString2, paramBitmap);
    Thread.sleep(1000L);
  }
  ...
  public static void b(WebViewPlugin paramWebViewPlugin, bhod parambhod, Activity paramActivity, String paramString1, String paramString2)
  {
    paramString2 = new Intent();
    ...
    QzonePluginProxyActivity.a(paramActivity, paramString1, paramString2, a(paramWebViewPlugin, parambhod, 6));
  }
  ...
  public static void c(Activity paramActivity, blsi paramblsi, int paramInt)
  {
    paramblsi = new SimpleDateFormat("yyyyMM", Locale.getDefault()).format(new Date());
    paramblsi = QzoneConfig.getInstance().getConfig("H5Url", "QzoneShuoshuoDailyCalendar", "https://h5.qzone.qq.com/v2/shuoshuo-daily/calendar/{date}?_wv=16777216").replace("{date}", paramblsi).replace("{DATE}", paramblsi);
    if (!bkgj.b(paramblsi).containsKey("_wv")) {
      bkgj.a(paramblsi, "_wv", "1027");
    }
    if (QLog.isColorLevel()) {
      QLog.d("QZoneHelper", 2, "jump qzone ShuoshuoDailyCalendar URL:" + paramblsi);
    }
    Intent localIntent = new Intent(BaseApplication.getContext(), QQBrowserActivity.class);
    a(localIntent);
    localIntent.putExtra("url", paramblsi);
  ...
  public static void c(Activity paramActivity, blsi paramblsi, Intent paramIntent, int paramInt)
  {
    Intent localIntent = paramIntent;
    if (paramIntent == null) {
      localIntent = new Intent();
  ...
  public static void c(Activity paramActivity, blsi paramblsi, Bundle paramBundle, int paramInt)
  {
    bmfd.a().a("cmd.cancelKillPictureProcess", null, false);
    Intent localIntent = a(paramblsi, "com.qzone.preview.QzonePictureViewer");
    localIntent.putExtras(paramBundle);
    localIntent.putExtra("fromQZone", false);
    QzonePluginProxyActivity.a(paramActivity, paramblsi.jdField_a_of_type_JavaLangString, localIntent, paramInt, null, false);
  }
  
  public static void c(Activity paramActivity, blsi paramblsi, String paramString, int paramInt)
  {
    ...
    localIntent.putExtra("key_title", anni.a(2131710682));
    localIntent.putExtra("key_desc", "");
    localIntent.putExtra("key_need_save_draft", false);
    QzonePluginProxyActivity.a(paramActivity, paramblsi.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void c(Activity paramActivity, blsi paramblsi, String paramString1, String paramString2, int paramInt)
  {
    if (TextUtils.isEmpty(paramString1)) {
      return;
    }
    paramblsi = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunAlbumSelect", "https://h5.qzone.qq.com/groupphoto/inqq/album/{QUN_ID}/select?_wv=3&_proxy=1").replace("{QUN_ID}", paramString1);
    paramString1 = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramString1);
    paramString1.putExtra("url", paramblsi);
    if (bhog.a.containsKey("Qzone")) {
  ...
  public static void c(Context paramContext, String paramString)
  {
    ...
    a((Activity)paramContext, blsi.a(), localIntent);
  }
  ...
  private static void c(Bitmap paramBitmap, @NonNull QQAppInterface paramQQAppInterface, String paramString1, long paramLong, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      if (Build.VERSION.SDK_INT < 26)
      {
        ...
        bgrj.a(paramQQAppInterface, b(paramQQAppInterface, paramString1, paramLong), paramString2, paramBitmap);
        Thread.sleep(1000L);
        if (bgsi.a(paramQQAppInterface.getApplication(), new String[] { paramString1 }))
        {
          biti.a().a(2131691148);
          return;
        }
  ...
  public static void d(Activity paramActivity, blsi paramblsi, Bundle paramBundle, int paramInt)
  {
    bmfd.a().a("cmd.cancelKillPictureProcess", null, false);
    Intent localIntent = a(paramblsi, "com.qzone.preview.QzonePictureViewer");
    localIntent.putExtras(paramBundle);
  ...
  public static void d(Activity paramActivity, blsi paramblsi, String paramString, int paramInt)
  {
    paramblsi = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunPassiveFeed", "https://h5.qzone.qq.com/groupphoto/inqq/relatedme/{QUN_ID}/{UIN}?_wv=3&_proxy=1").replace("{QUN_ID}", paramString).replace("{UIN}", paramblsi.jdField_a_of_type_JavaLangString);
    paramString = new Intent(BaseApplication.getContext(), QQBrowserDelegationActivity.class);
    paramString.putExtra("url", paramblsi);
    ...
    paramString.putExtra("source_name", BaseApplicationImpl.getContext().getString(2131716498));
    paramString.setData(Uri.parse(paramblsi));
  ...
  public static void e(Activity paramActivity, blsi paramblsi, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = a(paramblsi, "com.qzone.album.business.dlna.activity.DLNAActivity");
    localIntent.putExtras(paramBundle);
    QzonePluginProxyActivity.a(paramActivity, paramblsi.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  ...
  public static void f(Activity paramActivity, blsi paramblsi, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = new Intent();
