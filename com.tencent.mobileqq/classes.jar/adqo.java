  ...
  implements bkpx
{
  ...
  public adqo(BaseChatPie paramBaseChatPie)
  {
  ...
  public boolean a(String paramString, Bundle paramBundle)
  {
    ...
    int i;
    if ((!TextUtils.isEmpty(paramString)) && (paramBundle != null) && (bkft.a((Context)localObject1)))
    {
      ...
      if (!TextUtils.isEmpty(paramString)) {
        adrm.a((QQAppInterface)localObject2, (Context)localObject1, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramString, i);
      }
    }
    label180:
    label194:
    do
    {
      do
      {
        ...
        if ("com.sogou.inputmethod.appid".equals(paramString))
        {
          ...
          paramString = bipr.a(((QQAppInterface)localObject2).getApp(), str, (String)localObject3);
          if (QLog.isColorLevel()) {
          ...
          if (this.jdField_a_of_type_Arvt == null) {
            this.jdField_a_of_type_Arvt = new arvt(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie);
          }
          this.jdField_a_of_type_Arvt.a(paramString);
          return true;
        }
        if (("com.sogou.inputmethod.qqexp".equals(paramString)) || ("com.tencent.qqpinyin.qqexp".equals(paramString)))
        {
          ...
          this.jdField_a_of_type_Arvt.a(i, paramString);
          return true;
        }
      ...
      if ((i == ((QQRecorder.RecorderParam)localObject3).a) && (!bgsp.a(paramString))) {
        break label644;
      }
