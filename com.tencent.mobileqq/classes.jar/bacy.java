...
public class bacy
{
  public static asyb a(badc parambadc)
  {
    if (parambadc != null)
    {
      asyb localasyb = new asyb();
      localasyb.jdField_c_of_type_JavaLangString = parambadc.b;
      String str = parambadc.jdField_a_of_type_JavaLangString;
      localasyb.jdField_a_of_type_JavaLangString = str;
      localasyb.d = str;
      localasyb.jdField_a_of_type_Long = parambadc.jdField_a_of_type_Int;
      localasyb.jdField_c_of_type_Boolean = true;
      return localasyb;
    }
    return null;
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    return c(((bacv)paramQQAppInterface.getManager(346)).a(paramString1, paramString2));
  }
  ...
  public static ArrayList<bfve> a(QQAppInterface paramQQAppInterface, String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
    paramString = ((bacv)paramQQAppInterface.getManager(346)).a(paramString);
    ...
    {
      badc localbadc = (badc)paramString.next();
      bfve localbfve = new bfve();
      localbfve.jdField_a_of_type_JavaLangString = localbadc.b;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString, NavBarAIO paramNavBarAIO, ImageView paramImageView1, ImageView paramImageView2, boolean paramBoolean)
  {
    ...
    ((bacv)paramQQAppInterface.getManager(346)).a(paramString, paramQQAppInterface.getCurrentAccountUin(), new bacz(paramNavBarAIO, paramImageView1, paramImageView2, paramBoolean, paramQQAppInterface, paramString, paramActivity));
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    return !((balw)paramQQAppInterface.getManager(203)).b(paramMessageRecord.senderuin);
  }
  ...
  public static String b(List<badc> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      return "";
    }
    ...
    while (i < paramList.size())
    {
      localStringBuilder.append(((badc)paramList.get(i)).jdField_a_of_type_Int);
      if (i != paramList.size() - 1) {
        localStringBuilder.append("|");
      }
      i += 1;
  ...
  public static String c(List<badc> paramList)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (paramList.hasNext()) {
        localStringBuilder.append(((badc)paramList.next()).jdField_a_of_type_JavaLangString);
      }
    }
    return localStringBuilder.toString();
  }
