...
public final class bacy
{
  ...
  public boolean equals(@Nullable Object paramObject)
  {
    if (this != paramObject)
    {
      if ((paramObject instanceof bacy))
      {
        paramObject = (bacy)paramObject;
