...
public class mvh
{
  ...
  public static mvi a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        mvi localmvi = new mvi();
        localmvi.jdField_b_of_type_Int = 2147483647;
        i = 0;
        if (i < localJSONArray.length())
        {
          JSONObject localJSONObject = localJSONArray.getJSONObject(i);
          if ((localJSONObject.getInt("type") == paramInt) && (localJSONObject.getInt("priority") < localmvi.jdField_b_of_type_Int))
          {
            localmvi.jdField_a_of_type_Int = localJSONObject.getInt("id");
            localmvi.jdField_a_of_type_JavaLangString = localJSONObject.getString("url");
            localmvi.jdField_b_of_type_Int = localJSONObject.getInt("priority");
            localmvi.c = localJSONObject.getInt("type");
          }
        }
        else if (localmvi.jdField_b_of_type_Int < 2147483647)
        {
          QLog.i("QAVConfigUtils", 1, "MoreBtnTips. getHighestPriorityMoreBtnTips. highest. id = " + localmvi.jdField_a_of_type_Int + ", url = " + localmvi.jdField_a_of_type_JavaLangString + ", priority = " + localmvi.jdField_b_of_type_Int + ", type = " + localmvi.c);
          return localmvi;
        }
      }
  ...
  public static void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        new mvi().jdField_b_of_type_Int = 2147483647;
        i = 0;
        if (i >= localJSONArray.length()) {
          break;
        }
