...
public class vts
{
  ...
  {
    return new ArrayList(Arrays.asList(new FeedCloudCommon.Entry[] { vtt.a("host_uin", String.valueOf(bjjo.a().a())), vtt.a("qua", bmsw.a()), vtt.a("network_type", vtt.b()), vtt.a("client_time", String.valueOf(System.currentTimeMillis())), vtt.a("event_id", paramString), vtt.a("mobile_type", Build.MODEL + "_" + Build.VERSION.RELEASE), vtt.a("version", "8.4.5.4745"), vtt.a("platform", "AND"), vtt.a("unique_id", String.valueOf(a())) }));
  }
  ...
  public static void a(int paramInt, String paramString, List<FeedCloudCommon.Entry> paramList, boolean paramBoolean)
  {
    ...
    vtw.a().a().post(new QCircleQualityReporter.1(paramInt, paramString, paramList));
  }
  
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(vtt.a("time_cost", paramString2));
    localArrayList.add(vtt.a("ret_code", paramString3));
    localArrayList.add(vtt.a("url", paramString4));
    localArrayList.add(vtt.a("refer", paramInt + ""));
