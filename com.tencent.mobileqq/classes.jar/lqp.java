...
public class lqp
  implements lqo
{
  private static final lqr jdField_a_of_type_Lqr = new lqq();
  ...
  private lsp jdField_a_of_type_Lsp = new lsp();
  ...
  private final lsp jdField_b_of_type_Lsp = new lsp();
  private float jdField_c_of_type_Float;
  private volatile int jdField_c_of_type_Int;
  private final lsp jdField_c_of_type_Lsp = new lsp();
  ...
  {
    jdField_a_of_type_Lqr.a(1, this.jdField_a_of_type_ArrayOfInt, 0);
    lsq.a();
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, lqs paramlqs)
  {
    a(paramInt1, paramInt2, paramInt3, paramFloat1, paramFloat2, paramFloat3, paramFloat4, paramlqs.a(), paramlqs.a());
  }
  ...
  private static void a(RectF paramRectF, lrr paramlrr)
  {
    int j = paramlrr.e();
    int k = paramlrr.f();
    paramRectF.left /= j;
  ...
  private void a(lrr paramlrr, RectF paramRectF1, RectF paramRectF2)
  {
    a(paramRectF1);
    a(paramlrr, this.jdField_i_of_type_ArrayOfFloat, paramRectF2);
  }
  
  private void a(lrr paramlrr, float[] paramArrayOfFloat, RectF paramRectF)
  {
    lrp[] arrayOflrp = paramlrr.a(this);
    a(arrayOflrp, 0);
    GLES20.glUniformMatrix4fv(arrayOflrp[3].jdField_a_of_type_Int, 1, false, paramArrayOfFloat, 0);
    lsq.a();
    if (paramlrr.a())
    {
      a(2);
    ...
    a(arrayOflrp, 5, 4, paramRectF.left, paramRectF.top, paramRectF.width(), paramRectF.height());
    if (paramlrr.a()) {
      c();
    }
  ...
  private void a(lrp[] paramArrayOflrp, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    f();
    a(paramFloat1, paramFloat2, 0.0F);
    b(paramFloat3, paramFloat4, 1.0F);
    GLES20.glUniformMatrix4fv(paramArrayOflrp[1].jdField_a_of_type_Int, 1, false, a(), 0);
    g();
    lsq.a();
  }
  
  private void a(lrp[] paramArrayOflrp, int paramInt)
  {
    GLES20.glBindBuffer(34962, this.jdField_e_of_type_Int);
    lsq.a();
    GLES20.glVertexAttribPointer(paramArrayOflrp[0].jdField_a_of_type_Int, 2, 5126, false, 8, paramInt * 8);
    lsq.a();
    GLES20.glBindBuffer(34962, 0);
    lsq.a();
  }
  
  private void a(lrp[] paramArrayOflrp, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    a(paramArrayOflrp, paramFloat1, paramFloat2, paramFloat3, paramFloat4);
    int j = paramArrayOflrp[0].jdField_a_of_type_Int;
  ...
  public void a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, lqs paramlqs)
  {
    a(3, 4, 2, paramFloat1, paramFloat2, paramFloat3 - paramFloat1, paramFloat4 - paramFloat2, paramlqs);
  ...
  public void a(int paramInt)
  {
    ...
    for (this.jdField_c_of_type_ArrayOfFloat = Arrays.copyOf(this.jdField_c_of_type_ArrayOfFloat, this.jdField_c_of_type_ArrayOfFloat.length * 2);; this.jdField_c_of_type_ArrayOfFloat = arrayOfFloat)
    {
      ...
      this.jdField_a_of_type_Lsp.a(paramInt);
      return;
      j = 0;
      break;
  ...
  {
    int k = paramlrr.g();
    int[] arrayOfInt = paramlrr.a();
    int j = 0;
    while (j < arrayOfInt.length)
    {
      GLES20.glBindTexture(k, paramlrr.a()[j]);
      j += 1;
    }
    lsq.a();
  ...
  public void a(lrr paramlrr, int paramInt1, int paramInt2)
  {
    int k = paramlrr.g();
    int[] arrayOfInt = paramlrr.a();
    int j = 0;
    ...
    lsq.a();
    GLES20.glTexImage2D(k, 0, paramInt1, paramlrr.e(), paramlrr.f(), 0, paramInt1, paramInt2, null);
  }
  
  public void a(lrr paramlrr, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if ((paramInt3 <= 0) || (paramInt4 <= 0)) {
      return;
    }
    Rect localRect = paramlrr.a();
    ...
    a(this.jdField_a_of_type_AndroidGraphicsRectF, paramlrr);
    a(paramlrr, this.jdField_a_of_type_AndroidGraphicsRectF, this.jdField_b_of_type_AndroidGraphicsRectF);
  }
  
  public void a(lrr paramlrr, int paramInt1, int paramInt2, Bitmap paramBitmap, int paramInt3, int paramInt4)
  {
    int k = paramlrr.g();
    int[] arrayOfInt = paramlrr.a();
    int j = 0;
  ...
  public void a(lrr paramlrr, Bitmap paramBitmap)
  {
    int k = paramlrr.g();
    int[] arrayOfInt = paramlrr.a();
    int j = 0;
  ...
  public boolean a(lrr paramlrr)
  {
    boolean bool = paramlrr.c();
    if (bool) {}
    for (;;)
    {
      synchronized (this.jdField_b_of_type_Lsp)
      {
        paramlrr = paramlrr.a();
        if (paramlrr != null) {
          break label68;
        ...
        return bool;
        if (j < paramlrr.length)
        {
          this.jdField_b_of_type_Lsp.a(paramlrr[j]);
          j += 1;
          continue;
        }
        return bool;
  ...
  {
    int k = 1;
    int m = this.jdField_a_of_type_Lsp.a();
    if ((m & 0x1) == 1)
    {
      j = 1;
      if (j != 0) {
  ...
  public void d()
  {
    synchronized (this.jdField_b_of_type_Lsp)
    {
      lsp locallsp2 = this.jdField_b_of_type_Lsp;
      if (this.jdField_b_of_type_Lsp.b() > 0)
      {
        jdField_a_of_type_Lqr.a(null, locallsp2.b(), locallsp2.a(), 0);
        locallsp2.a();
      }
      locallsp2 = this.jdField_c_of_type_Lsp;
      if (locallsp2.b() > 0)
      {
        jdField_a_of_type_Lqr.b(null, locallsp2.b(), locallsp2.a(), 0);
        locallsp2.a();
      }
      return;
    }
