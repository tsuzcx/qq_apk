  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      try
      {
        ...
        paramFromServiceMsg = acvb.a((PBField)localObject);
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg != JSONObject.NULL))
        {
          ...
          notifyObserver(paramIntent, 1, true, (Bundle)localObject, laz.class);
          return;
        }
        notifyObserver(paramIntent, 1, false, null, laz.class);
        return;
      }
