  ...
  implements bhko
{
  ...
  {
    parambcdb.a().getHandler(bhrk.class).post(new QzoneDeviceTagJsPlugin.1(paramArrayOfString));
  }
  
  private static void b(WebViewPlugin paramWebViewPlugin, bcdb parambcdb, String[] paramArrayOfString)
  {
    parambcdb.a().getHandler(bhrk.class).post(new QzoneDeviceTagJsPlugin.2());
  }
