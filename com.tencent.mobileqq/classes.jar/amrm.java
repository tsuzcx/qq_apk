...
public class amrm
  extends amqc<CustomEmotionData>
{
  protected amrm(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
  }
  
  private void a(int paramInt, List<FavEmotionOcr.OcrInfo> paramList, arba paramarba, List<CustomEmotionData> paramList1)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      while (j < paramList.size())
      {
        ...
        localObject = paramarba.a(paramList1, str);
        int i = k;
        if (localObject != null)
        {
          i = m;
          ...
          if (m != 0)
          {
            paramarba.b((CustomEmotionBase)localObject);
            i = 1;
          }
        }
        j += 1;
    ...
    do
    {
      ...
      if (i < paramList2.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          localObject2 = new arbi((String)localObject1);
          if ((!((arbi)localObject2).a()) || (TextUtils.isEmpty(((arbi)localObject2).c)) || (TextUtils.isEmpty(((arbi)localObject2).d)))
          {
            if (QLog.isColorLevel()) {
      ...
      if (i < paramList1.size())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          localarbi1 = new arbi((String)localObject2);
          if ((!localarbi1.a()) || (TextUtils.isEmpty(localarbi1.c)) || (TextUtils.isEmpty(localarbi1.d)))
          {
            if (QLog.isColorLevel()) {
            ...
            ((List)localObject1).add(localarbi1);
          }
        }
      }
      ...
      {
        localarbi1 = (arbi)localArrayList.get(i);
        int j = 0;
        while (j < ((List)localObject1).size())
        {
          arbi localarbi2 = (arbi)((List)localObject1).get(j);
          if ((localarbi1.c.equals(localarbi2.c)) && (localarbi2.c.equals("0")) && (localarbi2.d.equals(localarbi1.d)))
          {
            paramList1.remove(localarbi2.a);
            ((StringBuilder)localObject2).append(localarbi2.a).append(", ");
          }
          j += 1;
        }
        i += 1;
  ...
  public void a()
  {
    ...
    localPlatInfo.mqqver.set("8.4.8");
  ...
  public void a(CustomEmotionData paramCustomEmotionData, String paramString)
  {
    ...
    if ((this.app == null) || (this.app.getApp() == null))
    {
      ...
      notifyUI(3, false, this.mApp.getApplication().getString(2131691804));
      return;
    }
    if (!NetworkUtil.isNetworkAvailable())
    {
      notifyUI(3, false, this.app.getApp().getString(2131693466));
      return;
    }
    try
    {
      ...
      ((FavEmotionOcr.ReqBody)localObject1).string_version.set("8.4.8");
      ...
      try
      {
        ...
        if ((i != 0) && (paramObject.bytes_bodybuffer.has()) && (paramObject.bytes_bodybuffer.get() != null))
        {
          ...
          if (i < paramFromServiceMsg.size())
          {
            ...
            {
              paramObject = ((arba)this.app.getManager(149)).a();
              if (paramObject != null)
              {
            ...
            {
              notifyUI(3, false, this.mApp.getApplication().getString(2131691810));
              if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        if (i != 0)
        {
          ...
          if (paramFromServiceMsg.list_ocr_info.has())
          {
            ...
            paramObject = (arba)this.app.getManager(149);
  ...
  public void a(Object paramObject, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      ((arba)this.app.getManager(149)).c(localArrayList);
  ...
  public void a(List<CustomEmotionData> paramList, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localReqBody.string_version.set("8.4.8");
  ...
  public void b(List<String> paramList)
  {
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        arbi localarbi = new arbi((String)paramList.next());
        if (!TextUtils.isEmpty(localarbi.d)) {
          localArrayList.add(localarbi.d);
        }
      }
      if (localArrayList.size() > 0) {
        ((arce)this.app.getManager(141)).a(localArrayList);
      }
    }
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramObject == null) || (paramFromServiceMsg == null) || (!paramFromServiceMsg.isSuccess()))
    {
      ...
      if (i == 1)
      {
        paramToServiceMsg = (arbb)this.mApp.getManager(72);
