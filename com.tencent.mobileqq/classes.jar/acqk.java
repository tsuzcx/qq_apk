...
public class acqk
  extends akdk
{
  private LinkedHashMap<String, List<acqj>> jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap();
  private int[] jdField_a_of_type_ArrayOfInt = new int[0];
  private String[] jdField_a_of_type_ArrayOfJavaLangString = new String[0];
  
  public acqk(DiscussionMemberActivity paramDiscussionMemberActivity)
  {
  ...
  private void a()
  {
    ...
    {
      acqj localacqj = (acqj)((Iterator)localObject2).next();
      if ((localacqj.c == null) || (localacqj.c.length() == 0))
      {
        localObject1 = "#";
      ...
      for (localObject1 = ((String)localObject1).toUpperCase();; localObject1 = "#")
      {
        ...
        ((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(localObject1)).add(localacqj);
        break;
        localObject1 = localacqj.c.substring(0, 1);
        break label66;
      }
    }
  ...
  public Object getItem(int paramInt)
  {
    ...
    i = -(i + 1) - 1;
    return (acqj)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivityDiscussionMemberActivity.getLayoutInflater().inflate(2131559030, paramViewGroup, false);
      paramView = new aecn();
      ...
      paramView.c = ((ImageView)localView.findViewById(2131368782));
      paramView.b = ((TextView)localView.findViewById(2131378839));
    }
    paramView = (aecn)localView.getTag();
    if (i < 0)
    {
      i = -(i + 1) - 1;
      paramViewGroup = (acqj)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
