...
public class bfsz
{
  ...
  public static Fragment a(@NonNull Activity paramActivity, @NonNull QQAppInterface paramQQAppInterface, @NonNull String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramString instanceof bftc))
        {
          try
          {
            ((bftc)paramString).attachQQContext(paramActivity, paramQQAppInterface);
            i = 1;
          }
  ...
  {
    QZLog.i("QZoneApiProxy", "onAccountChange: " + paramQQAppInterface.c() + " " + b + " " + jdField_a_of_type_Boolean);
    if (!b) {
  ...
  public static boolean a()
  {
    ...
    QZLog.i("QZoneApiProxy", "needLoadQZoneEnv: forbid this time " + l2 + " " + l1);
    return false;
  }
  ...
  public static boolean a(@Nullable Activity paramActivity, @Nullable QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      do
      {
        ...
        bool2 = c(paramActivity, paramQQAppInterface);
        bool1 = bool2;
      } while (!bool2);
      bool1 = bool2;
    ...
    for (;;)
    {
      ...
      catch (Throwable paramContext)
      {
        try
        {
          ...
          QZLog.e("QZoneApiProxy", "initEnv: end " + b + " " + (l2 - l1));
          return b;
  ...
  public static boolean b(@Nullable Activity paramActivity, @Nullable QQAppInterface paramQQAppInterface)
  {
    ...
    return c(paramActivity, paramQQAppInterface);
  }
  ...
  public static boolean b(@NonNull Context paramContext, @NonNull QQAppInterface paramQQAppInterface)
  {
    ...
    ((bfcz)paramQQAppInterface.getManager(27)).a("qzone_plugin.apk");
  ...
  private static boolean c(@NonNull Activity paramActivity, @NonNull QQAppInterface paramQQAppInterface)
  {
    boolean bool = true;
    ...
    if (BaseApplicationImpl.isCurrentVersionFirstLaunch)
    {
      ...
      if (InstallPlugins.a.jdField_a_of_type_Boolean) {}
      try
      {
