...
{
  private bftc jdField_a_of_type_Bftc;
  ...
  public bfsz(Context paramContext)
  {
    super(paramContext);
    this.jdField_b_of_type_Bfsy = new bfta(this);
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, ArrayList<AdDislikeInfo> paramArrayList)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(Integer.valueOf(1)))
    {
      ...
      a(this.jdField_g_of_type_JavaUtilArrayList, this.jdField_g_of_type_AndroidViewView, 2130841223, paramArrayList.a, bool);
      ...
      a(this.jdField_h_of_type_JavaUtilArrayList, this.jdField_h_of_type_AndroidViewView, 2130841225, paramArrayList.a, bool);
      label352:
      ...
      a(this.jdField_i_of_type_JavaUtilArrayList, this.jdField_i_of_type_AndroidViewView, 2130841216, paramArrayList.a, bool);
    }
    for (;;)
    {
      paramArrayList = new DislikeInfo();
      paramArrayList.a = ajya.a(2131705942);
      paramArrayList.c = 0;
      this.jdField_j_of_type_JavaUtilArrayList.add(paramArrayList);
      a(this.jdField_j_of_type_JavaUtilArrayList, this.jdField_j_of_type_AndroidViewView, 2130841207, paramArrayList.a, false);
      ...
      return;
      a(new ArrayList(), this.jdField_g_of_type_AndroidViewView, 2130841223, ajya.a(2131705926), false);
      break;
      label563:
      a(new ArrayList(), this.jdField_h_of_type_AndroidViewView, 2130841225, ajya.a(2131705929), false);
      break label352;
      label589:
      a(new ArrayList(), this.jdField_i_of_type_AndroidViewView, 2130841216, ajya.a(2131705930), false);
    }
  }
  ...
  public void a(View paramView)
  {
    ...
    this.jdField_j_of_type_AndroidViewView.findViewById(2131375889).setVisibility(4);
    setBackgroundDrawable(new ColorDrawable());
    ((ImageView)paramView.findViewById(2131366288).findViewById(2131369099)).setOnClickListener(this);
    this.jdField_i_of_type_Int = ((int)bbdh.i());
    this.jdField_j_of_type_Int = ((int)bbdh.j());
    ...
    setOnDismissListener(new bftb(this));
  }
  
  public void a(bftc parambftc)
  {
    this.jdField_a_of_type_Bftc = parambftc;
  }
  ...
  public void b(pbf parampbf, ArrayList<AdDislikeInfo> paramArrayList)
  {
    int n = 0;
    ...
    for (parampbf = parampbf.a();; parampbf = localObject)
    {
      if (parampbf != null) {
        n = onh.a(parampbf);
      }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131370708: 
      ...
      this.jdField_a_of_type_ComTencentWidgetNegativeChildrenLayout.setData(this.jdField_g_of_type_JavaUtilArrayList, ((DislikeInfo)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(1))).a, this.jdField_b_of_type_Bfsy);
      a(true);
      return;
    case 2131370716: 
      if (paramView.getTag() != null)
      ...
      this.jdField_a_of_type_ComTencentWidgetNegativeChildrenLayout.setData(this.jdField_g_of_type_JavaUtilArrayList, ((DislikeInfo)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(2))).a, this.jdField_b_of_type_Bfsy);
      a(true);
      return;
    case 2131370712: 
      if (paramView.getTag() != null)
      ...
      this.jdField_a_of_type_ComTencentWidgetNegativeChildrenLayout.setData(this.jdField_g_of_type_JavaUtilArrayList, ((DislikeInfo)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(3))).a, this.jdField_b_of_type_Bfsy);
      a(true);
      return;
    case 2131370706: 
      if (this.jdField_a_of_type_Bftc != null) {
        this.jdField_a_of_type_Bftc.a();
      }
      dismiss();
      return;
    }
