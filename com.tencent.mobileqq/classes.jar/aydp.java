...
public class aydp
{
  private static aydp jdField_a_of_type_Aydp;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
  private WebServiceSSO jdField_a_of_type_ComTencentMobileqqNowNetchannelWebssoWebServiceSSO;
  private volatile boolean jdField_a_of_type_Boolean;
  
  public static aydp a()
  {
    if (jdField_a_of_type_Aydp == null)
    {
      jdField_a_of_type_Aydp = new aydp();
      jdField_a_of_type_Aydp.a(false);
    }
    return jdField_a_of_type_Aydp;
  }
  ...
  private WnsHeadProto.ForwardReq a(byte[] paramArrayOfByte)
  {
    ...
    localForwardReq.version.set(aydr.a());
    localForwardReq.version_code.set(aydr.a());
    localForwardReq.a2.set(aydy.a().d());
    localForwardReq.uid.set(aydy.a().b());
    localForwardReq.tinyid.set(aydy.a().c());
    localForwardReq.stream_type.set(1);
    localForwardReq.original_id.set(String.valueOf(aydy.a()));
    localForwardReq.original_id_type.set(1);
    localForwardReq.original_key.set(aydy.b());
  ...
  public static void b()
  {
    if (jdField_a_of_type_Aydp != null)
    {
      jdField_a_of_type_Aydp.a();
      jdField_a_of_type_Aydp = null;
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, byte[] paramArrayOfByte, ayds paramayds)
  {
    ...
    try
    {
      this.jdField_a_of_type_ComTencentMobileqqNowNetchannelWebssoWebServiceSSO.a(str, paramArrayOfByte.toByteArray(), new aydq(this, paramInt1, paramayds));
      return;
    }
    catch (Exception paramArrayOfByte)
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.post(new ChannelCenter.2(this, paramInt1, paramayds, paramArrayOfByte));
    }
  }
  ...
  protected void a(boolean paramBoolean)
  {
    ...
    {
      aydy.a();
      this.jdField_a_of_type_ComTencentMobileqqNowNetchannelWebssoWebServiceSSO = new WebServiceSSO(i, j, String.valueOf(i), aydy.a(), "", 0);
      b(paramBoolean);
      return;
      i = 1400005918;
      break;
