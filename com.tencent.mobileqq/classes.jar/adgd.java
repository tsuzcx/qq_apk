...
{
  public adgd(AddFriendVerifyActivity paramAddFriendVerifyActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      {
        ReportDialog localReportDialog = new ReportDialog(this.a, 2131755829);
        localReportDialog.setContentView(2131562799);
        ((TextView)localReportDialog.findViewById(2131365644)).setText(this.a.getString(2131691077));
        ((ProgressBar)localReportDialog.findViewById(2131367140)).setVisibility(8);
        ((ImageView)localReportDialog.findViewById(2131380525)).setImageResource(2130839653);
      ...
      else
      {
        ...
        if (NetworkUtil.isNetSupport(this.a))
        {
          ...
          for (int i = AddFriendVerifyActivity.a(this.a).a();; i = 2000)
          {
            ...
            bdla.b(null, "dc00898", "", "", "qq_vip", "0X800A62B", ahcm.a(i), 0, "", "", "", "");
            if (!"d2g".equals(this.a.getIntent().getStringExtra("jump_from"))) {
              break;
            }
            bdla.b(this.a.app, "P_CliOper", "Grp_discuss", "", "discuss_set", "send_ask", 0, 0, AddFriendVerifyActivity.a(this.a), "", "", "");
            break;
          }
        }
