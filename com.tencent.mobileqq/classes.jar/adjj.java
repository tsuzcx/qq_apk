...
public class adjj
  extends anyz
{
  public adjj(AssociatedAccountActivity paramAssociatedAccountActivity) {}
  
  public void onGetSubAccountMsg(boolean paramBoolean, String paramString, bdxt parambdxt)
  {
    if (AssociatedAccountActivity.a(this.a, paramString, parambdxt)) {}
    do
    {
      return;
  ...
  {
    if (AssociatedAccountActivity.a(this.a, paramString, parambdxu)) {}
    do
    {
      return;
      if (QLog.isColorLevel()) {
        QLog.d("AssociatedAccountActivity", 2, "onSubAccountThirdQQUnreadMsgNum mIsFromPull=" + this.a.jdField_b_of_type_Boolean + "  mPullReqNeedBackNum=" + this.a.jdField_a_of_type_Int + " isSuccess=" + paramBoolean + "  mainAccount=" + paramString + "  data=" + parambdxu);
      }
      if (this.a.jdField_b_of_type_Boolean)
      {
    ...
    AssociatedAccountActivity.a(this.a, parambdxu);
  }
}
