  ...
  extends aojs
{
  ...
  public athl(FMActivity paramFMActivity) {}
  ...
  protected void a(boolean paramBoolean, long paramLong1, int paramInt1, List<oidb_0x899.memberlist> paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      } while ((paramString == null) || (bhsr.a(paramString.troopowneruin)));
    ...
    {
      bdll.b(paramString, "P_CliOper", "Grp_files", "", "power", "nopower_upload", 0, 0, (String)localObject1, paramList, "", "");
