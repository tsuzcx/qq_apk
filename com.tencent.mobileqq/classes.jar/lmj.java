  ...
  extends lmn
{
  ...
  private Queue<lmk> jdField_a_of_type_JavaUtilQueue = new LinkedList();
  ...
  public void a()
  {
    this.jdField_a_of_type_JavaUtilQueue.offer(new lmk(this, this.jdField_a_of_type_AndroidGraphicsPathMeasure.getLength()));
  }
  ...
  public void b(Canvas paramCanvas, MySurfaceView paramMySurfaceView, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if ((paramBoolean) && (this.jdField_a_of_type_JavaUtilQueue.size() > 0))
      {
        ...
        locallmk = (lmk)((LinkedList)this.jdField_a_of_type_JavaUtilQueue).getLast();
        ...
        for (;;)
        {
          ...
          paramMySurfaceView = (lmk)localIterator.next();
          localObject2 = paramMySurfaceView;
        ...
        continue;
        f2 = locallmk.jdField_a_of_type_Float;
        if (localObject2 == null) {
          break label683;
        }
        if ((localObject1 != null) && (localObject1 != localObject2)) {
          f1 = (((lmk)localObject1).jdField_a_of_type_Float * (float)(((lmk)localObject2).jdField_a_of_type_Long - l) + ((lmk)localObject2).jdField_a_of_type_Float * (float)(l - ((lmk)localObject1).jdField_a_of_type_Long)) / (float)(((lmk)localObject2).jdField_a_of_type_Long - ((lmk)localObject1).jdField_a_of_type_Long);
        }
      }
    }
    for (;;)
    {
      float f3 = 0.01481482F * this.c * (float)(locallmk.jdField_a_of_type_Long - l) / 500.0F;
      f4 /= 2.0F;
      ...
      for (;;)
      {
        if (f1 <= locallmk.jdField_a_of_type_Float)
        {
          ...
          f1 += f7;
          continue;
          f1 = ((lmk)localObject2).jdField_a_of_type_Float;
          break;
        }
      }
