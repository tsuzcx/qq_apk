...
public class aujf
{
  private static final String jdField_a_of_type_JavaLangString = anni.a(2131717869);
  ...
  private void a(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      njo.a().a = true;
      adrm.b(localQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramBundle, str);
      return;
    }
  ...
  private void a(Bundle paramBundle, String paramString1, String paramString2, long paramLong)
  {
    ...
    {
      paramString1 = aukj.a(paramBundle, paramString1, paramString2, null, l);
      aukj.a(this.jdField_a_of_type_ComTencentMobileqqMiniShareOpensdkOpenSdkShareModel, paramBundle, paramString1);
    ...
    nir.a(paramString2, new aujh(this, paramLong, paramBundle), paramString1.toByteArray(), "OidbSvc.0xb77_9", 2935, 9, localBundle, 0L);
  }
  
  private void a(ayyu paramayyu, Bundle paramBundle, long paramLong)
  {
    String str;
    Object localObject;
    if (System.currentTimeMillis() - paramLong > 10000L)
    {
      ...
      a(new Object[] { Integer.valueOf(0), "", anni.a(2131703581), "" }, -3);
    }
    label143:
    label150:
    label157:
  ...
  private void a(MessageForArkApp paramMessageForArkApp, AbsShareMsg paramAbsShareMsg, Bundle paramBundle)
  {
    try
    {
      ...
      paramMessageForArkApp.saveExtInfoToExtStr(bbyw.w, Integer.toString(-1));
      paramMessageForArkApp.saveExtInfoToExtStr(bbyw.y, paramAbsShareMsg);
      return;
    }
  ...
  private void a(AbsShareMsg paramAbsShareMsg, Bundle paramBundle)
  {
    ...
    aujg localaujg = new aujg(this, paramBundle, System.currentTimeMillis());
    if (a(paramBundle))
    {
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForArkApp = AbsShareMsg.sendSdkFakeMessage(paramBundle, localQQAppInterface, paramAbsShareMsg, str1, i, str2, localaujg);
    ...
    AbsShareMsg.sendSdkShareMessageByServer(localQQAppInterface, paramAbsShareMsg, str1, i, str2, localaujg);
  }
  ...
  private void a(Object[] paramArrayOfObject, int paramInt)
  {
    ...
    ((auke)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(350)).a(this.b, localHashMap);
  }
  ...
  private void b(Object[] paramArrayOfObject, int paramInt)
  {
    ...
    if ((paramInt == 0) || (paramInt == -2))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForArkApp.extraflag = 32770;
    ...
    auif.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataMessageForArkApp, paramInt, (String)paramArrayOfObject[2]);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, AbsShareMsg paramAbsShareMsg, Activity paramActivity, Bundle paramBundle, String paramString)
  {
    ...
    {
      a(new Object[] { Integer.valueOf(0), "", anni.a(2131703582), "" }, -2);
    ...
    bcst.b(null, "dc00898", "", "", "0X8009C93", "0X8009C93", 0, 0, "", ForwardUtils.c(paramBundle.getInt("req_type")), ForwardUtils.a(paramBundle.getInt("uintype")), paramBundle.getString("title"));
  ...
  public void a(MessageForArkApp paramMessageForArkApp, Context paramContext, JSONObject paramJSONObject)
  {
    ...
    if (!bgnt.d(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      augs.a((Activity)paramContext, anni.a(2131703582), new auji(this));
      return;
    }
    ...
    AbsShareMsg.resendSdkFakeMessage(paramMessageForArkApp, paramJSONObject, new aujj(this, paramContext, System.currentTimeMillis()));
