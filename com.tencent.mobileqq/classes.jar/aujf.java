  ...
  implements Manager
{
  ...
  private aujj jdField_a_of_type_Aujj;
  private aujk jdField_a_of_type_Aujk;
  private aujl jdField_a_of_type_Aujl;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private HashMap<Long, WeakReference<auji>> jdField_a_of_type_JavaUtilHashMap = new HashMap(5);
  private boolean jdField_a_of_type_Boolean = true;
  private HashMap<Long, WeakReference<aujg>> b = new HashMap(20);
  private HashMap<Long, Boolean> c = new HashMap(200);
  private HashMap<Long, WeakReference<aujh>> d = new HashMap(5);
  private HashMap<Long, ArrayList<Long>> e = new HashMap(5);
  private HashMap<Long, ArrayList<Long>> f = new HashMap(5);
  
  public aujf(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Asdz = ((asdz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(323));
  }
  ...
  private ArrayList<Long> a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 58	aujf:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   20: aload_0
    //   21: getfield 58	aujf:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
  ...
  private void a(long paramLong, auji paramauji)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.3(this, paramLong, paramauji));
  }
  
  private void a(long paramLong, ArrayList<Long> paramArrayList, aujg paramaujg)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.2(this, paramLong, paramArrayList, paramaujg));
  }
  
  private void a(long paramLong, ArrayList<Long> paramArrayList, aujh paramaujh)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.1(this, paramArrayList, paramLong, paramaujh));
  }
  ...
  public IntimateInfo a(long paramLong1, long paramLong2)
  {
    ...
    if (localIntimateInfo2 == null)
    {
      ...
      localIntimateInfo2 = this.jdField_a_of_type_Asdz.a(str);
  ...
  public void a(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Aujj != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Aujj);
      this.jdField_a_of_type_Aujj = null;
    }
    if (this.jdField_a_of_type_Aujk != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Aujk);
      this.jdField_a_of_type_Aujk = null;
    }
    if (this.jdField_a_of_type_Aujl != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Aujl);
      this.jdField_a_of_type_Aujl = null;
    }
  ...
  public void a(Context paramContext, long paramLong, ArrayList<Long> arg4, aujg paramaujg)
  {
    if (QLog.isColorLevel())
    {
    ...
    for (Object localObject1 = ???.toString();; localObject1 = "null")
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramaujg != null) && (??? != null))
      {
        if (bdee.d(paramContext)) {
          break;
        }
        a(paramLong, ???, paramaujg);
      }
      return;
    }
    ...
    a(paramLong, ???, paramaujg);
    paramaujg = new WeakReference(paramaujg);
    synchronized (this.b)
    {
      this.b.put(Long.valueOf(paramLong), paramaujg);
      ??? = new HashMap(5);
      ???.put("alreadyRequest", localObject1);
      ???.put("notRequest", paramContext);
      paramaujg = new ArrayList(1);
      paramaujg.add(Long.valueOf(paramLong));
      ???.put("groupUin", paramaujg);
      ((asdx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(153)).a(paramLong, paramContext, ???);
      return;
    }
  }
  
  public void a(Context arg1, long paramLong, ArrayList<Long> paramArrayList, aujh paramaujh)
  {
    Object localObject2;
    if (QLog.isColorLevel())
    {
    ...
    {
      QLog.d("MultiCardManager", 2, (String)localObject1);
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramaujh != null) && (paramArrayList != null))
      {
        if (bdee.d(???)) {
          break;
        }
        a(paramLong, paramArrayList, paramaujh);
      }
      return;
    }
    synchronized (this.e)
    ...
    for (;;)
    {
      ...
      paramArrayList = new WeakReference(paramaujh);
      synchronized (this.d)
      {
        this.d.put(Long.valueOf(paramLong), paramArrayList);
        ((alzf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(false, paramLong + "", "0", 9);
        return;
        label317:
  ...
  public void a(String paramString, IntimateInfo paramIntimateInfo)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Asdz.a(paramString, paramIntimateInfo);
