...
public class aitx
{
  ...
  public aitx()
  {
    this.jdField_a_of_type_Ajon = new aity(this);
  }
  ...
  public void a(BaseChatPie paramBaseChatPie)
  {
    ...
    if ((TextUtils.isEmpty(airx.d)) || (TextUtils.isEmpty(airx.e)))
    {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (ajfh.a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
        break label178;
      }
    ...
    bale localbale = ((baky)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true);
    if ((localbale != null) && (localbale.jdField_a_of_type_Boolean))
    {
      QLog.i("sava_ChatPieApolloViewController", 1, "checkNeedPreLoadEngine isGag");
      return;
    }
    if (ajfh.a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
    {
      QLog.d("sava_ChatPieApolloViewController", 1, "Apollo func is double-hidden.");
      return;
    }
    if (!ajfh.b(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
    {
  ...
  public boolean a(BaseChatPie paramBaseChatPie)
  {
    ...
    Object localObject = ((baky)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true);
    if ((localObject != null) && (((bale)localObject).jdField_a_of_type_Boolean)) {
      return false;
    }
    ...
    ajos.b("aio_pre");
    int i = ajfh.b(0);
    ajlo.a(i, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    ajlo.a(i, 1);
    ajlo.a(i, 10);
    ajlo.a(i, null, new int[] { ajln.a(i, false, 0, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, false) });
    localObject = (ajfe)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249);
    ((ajfe)localObject).a(paramBaseChatPie);
    if (ajfh.a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
    {
      if (QLog.isColorLevel()) {
        QLog.d("sava_ChatPieApolloViewController", 2, "Apollo func is double-hidden.");
      }
      ajlo.a(i, 10, 103, new Object[] { "double hidden" });
      return false;
    }
    if (!ajfh.b(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
      return false;
    ...
    if (localObject != null) {
      ((SpriteUIHandler)localObject).a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, paramBaseChatPie.jdField_a_of_type_Acup);
    }
    if (ajki.a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) != 1)
    {
      if (QLog.isColorLevel()) {
  ...
  public void b(BaseChatPie paramBaseChatPie)
  {
    ...
    do
    {
      ...
      ajlo.a(i, 10, 106, new Object[] { "aio is finished" });
    } while (!QLog.isColorLevel());
    QLog.d("sava_ChatPieApolloViewController", 2, "aio is finished, not init apollo.");
    return;
    Object localObject = (aisr)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(227);
    ((aisr)localObject).a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    ((aisr)localObject).a(((aisr)localObject).a);
    if ((this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null) || (this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView != null))
    {
    ...
    boolean bool1;
    if ((Build.VERSION.SDK_INT >= 26) || (airx.p))
    {
      bool1 = true;
      label142:
      if (QLog.isColorLevel()) {
      ...
      localObject = (ajfe)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249);
      ajlo.a(i, 10, 0, new Object[] { "cmshow switch done" });
      ajlo.a(i, 100);
      ajlo.a(i, 101);
      ajos.a("onSurfaceCreated");
      if (!bool1) {
        break label733;
      }
    }
    for (;;)
    {
      ...
      try
      {
        ...
        this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView.init(paramBaseChatPie.jdField_a_of_type_Ajro, 0, this.jdField_a_of_type_ComTencentMobileqqApolloApolloRender);
        ...
        if (paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
          ((ajfe)localObject).a(this.jdField_b_of_type_ComTencentMobileqqApolloApolloTextureView);
        }
        this.jdField_a_of_type_ComTencentMobileqqApolloApolloRender = null;
        if (ajmr.jdField_b_of_type_Boolean) {
          break label827;
        }
        bool2 = true;
        ...
        ThreadManager.postImmediately(new ChatPieApolloViewController.5(this, i, paramBaseChatPie, (ajfe)localObject), null, false);
        ...
        adhl localadhl = (adhl)paramBaseChatPie.a(52);
        if ((localadhl == null) || (!localadhl.jdField_a_of_type_Boolean)) {
          break label891;
        }
        ((RelativeLayout.LayoutParams)localObject).addRule(2, 2131375660);
        ...
        localLayoutParams = new RelativeLayout.LayoutParams(-1, (int)((float)bbdh.j() * 0.171F));
        if ((localadhl == null) || (!localadhl.jdField_a_of_type_Boolean)) {
          break label903;
        }
        localLayoutParams.addRule(2, 2131375660);
        ...
        localObject = (airx)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
        if (localObject == null) {
          break;
        }
        ((airx)localObject).a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramBaseChatPie.jdField_a_of_type_AndroidContentContext);
        return;
      }
      ...
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView.init(paramBaseChatPie.jdField_a_of_type_Ajro, 0, this.jdField_a_of_type_ComTencentMobileqqApolloApolloRender);
      if (paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
        ((ajfe)localObject).a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView);
      }
      ...
      continue;
      label833:
      ThreadManager.excute(new ChatPieApolloViewController.6(this, paramBaseChatPie, (ajfe)localObject), 16, null, false);
      continue;
      label854:
      ...
      continue;
      label869:
      ((RelativeLayout.LayoutParams)localObject).bottomMargin = (-actj.a(5.0F, paramBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.getResources()));
      continue;
      label891:
  ...
  public void c(BaseChatPie paramBaseChatPie)
  {
    ...
    if (paramBaseChatPie == null) {}
    while ((!airx.e()) || (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView != null)) {
      return;
    }
    ...
    Object localObject1 = (adhl)paramBaseChatPie.a(52);
    if ((localObject1 != null) && (((adhl)localObject1).jdField_a_of_type_Boolean)) {
      localLayoutParams.addRule(2, 2131375660);
    }
    for (;;)
    {
      ...
      localObject1 = new ajoy(paramBaseChatPie);
      this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.init((aivc)localObject1);
      if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRender() != null) {
        this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView.getRender().setRenderCallback((aiva)localObject1);
      }
      Object localObject2 = (ajfe)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249);
      ((ajfe)localObject2).a(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView);
      localObject2 = ((ajfe)localObject2).a();
      if (localObject2 != null) {
        ((ajoy)localObject1).a((aiva)localObject2);
      }
      paramBaseChatPie.a().addView(this.jdField_a_of_type_ComTencentMobileqqApolloApolloTextureView, 0, localLayoutParams);
      return;
      label274:
      localLayoutParams.bottomMargin = (-actj.a(5.0F, paramBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx.getResources()));
      break;
      localLayoutParams.addRule(2, 2131368187);
    }
  }
  ...
  public void d(BaseChatPie paramBaseChatPie)
  {
    ...
    do
    {
      ...
      ((airx)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(new WeakReference(paramBaseChatPie));
    } while (!a());
    ((ajfe)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249)).b(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
  }
  ...
  public void e(BaseChatPie paramBaseChatPie)
  {
    ...
    ((ajfe)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249)).a(paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
  }
  ...
  public void f(BaseChatPie paramBaseChatPie)
  {
    ...
    for (;;)
    {
      ((ajfe)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249)).onDestroy();
      if (a()) {
        break label271;
      }
    ...
    label271:
    localObject = (aisr)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(227);
    ((aisr)localObject).a(null);
    ((aisr)localObject).a(null);
    localObject = (airt)paramBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211);
    if (localObject != null) {
      ((airt)localObject).a();
    }
    if (this.jdField_a_of_type_ComTencentMobileqqApolloApolloSurfaceView != null)
