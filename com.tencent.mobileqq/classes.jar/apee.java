...
public class apee
{
  ...
  public apee(int paramInt1, int paramInt2, int paramInt3)
  {
    this.jdField_a_of_type_JavaLangString = "";
    this.jdField_b_of_type_JavaLangString = "";
    this.jdField_c_of_type_JavaLangString = "";
  ...
  public apee(int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, apfk paramapfk, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean1, boolean paramBoolean2, double paramDouble, String[] paramArrayOfString, apef paramapef1, int paramInt5, int paramInt6, apef paramapef2, List<Pair<apef, apef>> paramList, HashMap<String, String> paramHashMap)
  {
    this.jdField_a_of_type_JavaLangString = "";
    this.jdField_b_of_type_JavaLangString = "";
    this.jdField_c_of_type_JavaLangString = "";
    ...
    this.jdField_a_of_type_Apef = paramapef1;
    this.jdField_b_of_type_Apef = paramapef2;
  ...
  private Drawable a(Context paramContext, int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      paramInt1 = bfsm.a(localDrawable) + bfsm.a(paramContext);
  ...
  private Drawable a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, boolean paramBoolean2, Drawable paramDrawable)
  {
    ...
    {
      paramQQAppInterface = new apfx(paramQQAppInterface.getApp().getResources(), this.jdField_a_of_type_AndroidGraphicsNinePatch, this.jdField_b_of_type_AndroidGraphicsNinePatch, this.jdField_a_of_type_Int);
      if (!paramBoolean1)
      {
        paramBoolean1 = true;
  ...
  private Pair<apef, apef> a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      } while (!paramString.equals(((apef)localPair.first).jdField_b_of_type_JavaLangString));
    }
  ...
  public Drawable a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, View paramView, String paramString, int paramInt)
  {
    ...
    for (Object localObject2 = a(paramQQAppInterface, paramBoolean1, paramBoolean3, null);; localObject2 = null)
    {
      ...
      int j;
      if (((localObject2 instanceof apfx)) && (!TextUtils.isEmpty(this.jdField_e_of_type_JavaLangString)))
      {
        if ((this.jdField_a_of_type_Apfk == null) || (paramView == null)) {
          break label375;
        }
        j = paramView.getWidth();
        if (this.jdField_a_of_type_Apfk.jdField_c_of_type_Int == 0) {
          ((apfx)localObject2).a(true, this.jdField_e_of_type_JavaLangString, this.jdField_a_of_type_Apfk.jdField_a_of_type_ArrayOfInt, this.jdField_a_of_type_Apfk.jdField_a_of_type_JavaLangString);
        }
      }
      else if (((localObject2 instanceof apfx)) && (paramBoolean2) && (!paramBoolean3) && (paramInt > 0))
      {
        paramString = paramString + "_" + paramInt;
        localObject1 = (apfx)localObject2;
        if (paramBoolean1) {
          break label398;
        }
      }
      ...
      {
        ((apfx)localObject1).a(paramQQAppInterface, paramString, paramBoolean1);
        ...
        if (i > this.jdField_a_of_type_Apfk.jdField_c_of_type_Int)
        {
          ((apfx)localObject2).a(true, this.jdField_e_of_type_JavaLangString, this.jdField_a_of_type_Apfk.jdField_a_of_type_ArrayOfInt, this.jdField_a_of_type_Apfk.jdField_a_of_type_JavaLangString);
          break;
        }
        ((apfx)localObject2).a(false, null, null, null);
        break;
        label375:
        if (!(localObject2 instanceof apfx)) {
          break;
        }
        ((apfx)localObject2).a(false, null, null, null);
        break;
  ...
  {
    apfk localapfk = this.jdField_a_of_type_Apfk;
    if (!paramBoolean4) {
    ...
    this.jdField_a_of_type_Apfk = localapfk;
    return paramQQAppInterface;
  }
  
  public Pair<apef, apef> a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    for (paramQQAppInterface = "null";; paramQQAppInterface = "first:" + ((Pair)localObject1).first + ",second:" + ((Pair)localObject1).second)
    {
      ...
      return localObject1;
      if (((apeb)localObject2).a == null) {
        break;
      }
      paramQQAppInterface = ((apeb)localObject2).a.jdField_b_of_type_JavaLangString;
      break label102;
      if (((apeb)localObject2).b == null) {
        break;
      }
      paramQQAppInterface = ((apeb)localObject2).b.jdField_b_of_type_JavaLangString;
      break label102;
      paramQQAppInterface = "width";
      if (((apeb)localObject2).c == null) {
        break label102;
      }
      paramQQAppInterface = ((apeb)localObject2).c.jdField_b_of_type_JavaLangString;
      break label102;
      ...
      break label102;
      if (((apeb)localObject2).d == null) {
        break;
      }
      paramQQAppInterface = ((apeb)localObject2).d.jdField_b_of_type_JavaLangString;
      break label102;
      if (((apeb)localObject2).e == null) {
        break;
      }
      paramQQAppInterface = ((apeb)localObject2).e.jdField_b_of_type_JavaLangString;
      break label102;
    }
  }
