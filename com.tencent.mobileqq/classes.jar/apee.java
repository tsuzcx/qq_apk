...
public class apee
{
  ...
  public apee(QQAppInterface paramQQAppInterface, apus paramapus, long paramLong)
  {
    ...
    Object localObject1 = (HashMap)paramapus.a().get("OnlinePreView");
    ...
    paramapus = (HashMap)paramapus.a().get("OfflineConfig");
    localObject1 = paramapus.keySet().iterator();
    while (((Iterator)localObject1).hasNext())
    {
      localObject2 = (String)((Iterator)localObject1).next();
      localObject3 = paramapus.get(localObject2);
  ...
  {
    long l1 = Long.parseLong(apue.c("OfflineConfigFlowSize"));
    try
    {
  ...
  public static String a(Context paramContext, String paramString)
  {
    ...
    return apue.c(paramString);
  }
  
  public static String a(Context paramContext, String paramString1, String paramString2)
  {
    return a(paramContext, "OnlinePreView", apvb.a(paramString1).replace(".", ""), paramString2);
  }
  ...
  {
    long l1 = Long.parseLong(apue.c("OfflineConfigFlowTime"));
    try
    {
  ...
  {
    long l1 = Long.parseLong(apue.c("OfflineConfigFtnThumbMaxSize"));
    try
    {
