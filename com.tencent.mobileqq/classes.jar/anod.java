  ...
  implements View.OnClickListener
{
  ...
  public anoh a;
  URLDrawableDownListener jdField_a_of_type_ComTencentImageURLDrawableDownListener = new anoe(this);
  ...
  public anod(Context paramContext, QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, MqqHandler paramMqqHandler, boolean paramBoolean, anoh paramanoh, int paramInt)
  {
    ...
    this.jdField_a_of_type_Anoh = paramanoh;
    if ((paramBoolean) && (this.jdField_a_of_type_Anoh != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Anoh.b))) {}
    ...
    this.jdField_b_of_type_Int = actj.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.c = actj.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.d = actj.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.e = actj.a(70.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (localObject1 == null)
      {
        ...
        return null;
        paramViewGroup = (anof)paramView.getTag();
        break;
      }
  ...
  public void onClick(View paramView)
  {
    ...
    for (paramView = (anof)paramView;; paramView = null)
    {
      if (paramView == null) {}
      do
      {
        ...
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007FAB", "0X8007FAB", 0, 0, "", "", "", "");
