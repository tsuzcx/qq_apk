  ...
  implements Manager
{
  ...
  public ConcurrentHashMap<Long, anoc> a;
  public MqqHandler a;
  ...
  private ConcurrentHashMap<String, ConcurrentHashMap<String, anoi>> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  public boolean b;
  ...
  private ConcurrentHashMap<String, ConcurrentHashMap<String, anoh>> jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  static
  {
    jdField_a_of_type_JavaLangString = azaa.a(ajsf.aW + "DoutuRes" + File.separator);
  }
  ...
  private int a(List<ChatMessage> paramList, SessionInfo paramSessionInfo, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (j != 0)
      {
        ...
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007FA7", "0X8007FA7", 0, 0, "", "", "", "");
  ...
  private List<DoutuData> a()
  {
    ...
    if (this.jdField_a_of_type_Aukn != null) {
      localList = this.jdField_a_of_type_Aukn.a(DoutuData.class, true, null, null, null, null, null, null);
    }
    return localList;
  }
  ...
  public static void a(RelativeLayout paramRelativeLayout, QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = (anod)paramQQAppInterface.getManager(214);
        ...
        for (paramSessionInfo.isDui = false;; paramSessionInfo.isDui = false)
        {
          do
          {
            if (paramSessionInfo.isDui)
            {
              ...
              {
                axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008012", "0X8008012", 0, 0, "", "", "", "");
  ...
  private boolean a(String paramString)
  {
    ...
    if (bbjn.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))
    {
      if (QLog.isColorLevel()) {
      ...
      for (paramInt = 0;; paramInt = i)
      {
        ...
        for (;;)
        {
          if (paramInt > 0)
          {
            ...
            {
              axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008095", "0X8008095", 0, 0, "", "", "", "");
              this.jdField_e_of_type_Int = (localArrayList.size() - 1);
              if (paramInt == 3) {
                axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008094", "0X8008094", 0, 0, "", "", "", "");
              }
            }
          }
          ...
          for (;;)
          {
            ...
            paramList = new anoo(paramList.senderuin, paramInt - 2, bool);
  ...
  private void f()
  {
    this.jdField_f_of_type_Boolean = bbjn.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    this.jdField_c_of_type_Boolean = bbjn.i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    this.jdField_d_of_type_Boolean = bbjn.k(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    this.jdField_b_of_type_Boolean = bbjn.l(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    long l1 = bbjn.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    int i = bbjn.ao(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    long l2 = bbjn.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    long l3 = bbjn.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    int j = bbjn.al(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (l1 > 0L) {
  ...
  public int a(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((anoh)((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_a_of_type_Int;
    }
    return 0;
  }
  ...
  public long a(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((anoi)((ConcurrentHashMap)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_a_of_type_Long;
    }
    return 0L;
  }
  ...
  public void a(long paramLong)
  {
    ...
    {
      localObject = (anoc)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong));
      ((anoc)localObject).jdField_a_of_type_Int += 1;
    }
    if (QLog.isColorLevel())
    {
    ...
    label203:
    for (int i = ((anoc)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Int;; i = 0)
    {
      QLog.i("DoutuManager", 2, i);
      if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong)) != null) && (((anoc)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Int >= 1))
      {
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(Long.valueOf(paramLong));
        if ((this.jdField_a_of_type_Anny != null) && (this.jdField_a_of_type_Anny.jdField_a_of_type_Long == paramLong)) {
  ...
  public void a(Context paramContext, ViewGroup paramViewGroup, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, MqqHandler paramMqqHandler, anoc paramanoc)
  {
    ...
    Object localObject = (LinearLayout)paramViewGroup.findViewById(2131365327);
    if (localObject != null)
    {
      if (QLog.isColorLevel()) {
      ...
      paramViewGroup = (DoutuEmotionHorizonListView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131365330);
      this.jdField_a_of_type_Anny = ((anny)paramViewGroup.getAdapter());
      if (this.jdField_a_of_type_Anny == null)
      {
        this.jdField_a_of_type_Anny = new anny(paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseActivity, paramSessionInfo, paramMqqHandler, this.jdField_b_of_type_Boolean, paramanoc, this.jdField_a_of_type_Int);
        paramViewGroup.setAdapter(this.jdField_a_of_type_Anny);
      }
      c();
    }
    for (;;)
    {
      if ((this.jdField_g_of_type_Long <= 0L) || (System.currentTimeMillis() - this.jdField_g_of_type_Long <= 0L) || (System.currentTimeMillis() - this.jdField_g_of_type_Long >= 1000L))
      {
          ...
          if (paramContext.hasNext())
          {
            ...
            if (this.jdField_c_of_type_JavaUtilList.size() < 20)
            {
              ...
              if (!TextUtils.isEmpty(paramBaseActivity.pic_md5))
              {
                ...
                localObject = (DoutuEmotionHorizonListView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131365330);
                this.jdField_a_of_type_Anny = new anny(paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseActivity, paramSessionInfo, paramMqqHandler, this.jdField_b_of_type_Boolean, paramanoc, this.jdField_a_of_type_Int);
                ((DoutuEmotionHorizonListView)localObject).setAdapter(this.jdField_a_of_type_Anny);
                ((DoutuEmotionHorizonListView)localObject).setOnScrollStateChangedListener(new anoe(this));
                ((DoutuEmotionHorizonListView)localObject).setTouchListener(new anog(this, paramMqqHandler));
        ...
        if (this.jdField_a_of_type_Anny != null)
        {
          this.jdField_a_of_type_Anny.jdField_b_of_type_JavaUtilList = new ArrayList();
          this.jdField_a_of_type_Anny.jdField_b_of_type_JavaUtilList.addAll(this.jdField_c_of_type_JavaUtilList);
        }
        this.jdField_b_of_type_JavaUtilList.clear();
        h();
        label568:
        if (this.jdField_a_of_type_Anny != null)
        {
          ...
          this.jdField_a_of_type_Anny.notifyDataSetChanged();
        }
    ...
    label818:
    label856:
    for (paramContext = paramanoc.toString();; paramContext = "")
    {
      QLog.d("DoutuManager", 2, paramContext);
      if ((paramanoc != null) && (paramanoc.a()) && (this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Anny != null))
      {
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Long.valueOf(this.jdField_a_of_type_Anny.jdField_a_of_type_Long), new anoc(this.jdField_a_of_type_Anny.jdField_a_of_type_Long, 0));
        a(paramanoc, paramSessionInfo, this.jdField_a_of_type_Anny.jdField_a_of_type_Long);
      }
      if (Build.VERSION.SDK_INT >= 14) {
        paramViewGroup.setScrollX(0);
      }
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(0);
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007FA9", "0X8007FA9", 0, 0, "", "", "", "");
  ...
  public void a(anoc paramanoc, SessionInfo paramSessionInfo, long paramLong)
  {
    ThreadManager.post(new DoutuManager.4(this, paramanoc, paramLong, paramSessionInfo), 5, null, true);
  }
  ...
  public void a(SessionInfo paramSessionInfo, ChatMessage paramChatMessage)
  {
    ...
    {
      ((ConcurrentHashMap)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramChatMessage)).put(paramSessionInfo, new anoi(this, l1, l2));
      return;
    }
    ConcurrentHashMap localConcurrentHashMap = new ConcurrentHashMap();
    localConcurrentHashMap.put(paramSessionInfo, new anoi(this, l1, l2));
  ...
  public void a(SessionInfo paramSessionInfo, ChatMessage paramChatMessage, int paramInt1, int paramInt2)
  {
    ...
    {
      ((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).put(paramSessionInfo, new anoh(this, l1, l2, paramChatMessage.senderuin, paramInt1, paramInt2));
      return;
    }
    ConcurrentHashMap localConcurrentHashMap = new ConcurrentHashMap();
    localConcurrentHashMap.put(paramSessionInfo, new anoh(this, l1, l2, paramChatMessage.senderuin, paramInt1, paramInt2));
  ...
  public void a(List<ChatMessage> paramList, SessionInfo paramSessionInfo, BaseChatPie paramBaseChatPie, int paramInt)
  {
    ...
    label17:
    while (bbbd.b(paramSessionInfo.jdField_a_of_type_JavaLangString)) {
      return;
    }
    if (c()) {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    bbjn.g(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramBoolean);
    if (paramBoolean) {
  ...
  public void a(boolean paramBoolean, List<DoutuData> paramList)
  {
    ...
    if ((this.jdField_a_of_type_Anny != null) && (this.jdField_c_of_type_JavaUtilList.size() == 0))
    {
      if (QLog.isColorLevel()) {
      ...
      h();
      this.jdField_a_of_type_Anny.a();
      if (this.jdField_a_of_type_Anny.jdField_a_of_type_MqqOsMqqHandler != null) {
        this.jdField_a_of_type_Anny.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(81);
      }
    }
    int i;
    if (this.jdField_b_of_type_JavaUtilList.size() > 0) {
  ...
  public void a(boolean paramBoolean, List<DoutuData> paramList, long paramLong)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      i = ((anoc)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Int;
  ...
  public long b(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((anoh)((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_a_of_type_Long;
    }
    return 0L;
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout != null)
    {
      ...
      this.jdField_a_of_type_Anny = null;
      this.jdField_c_of_type_JavaUtilList.clear();
      this.jdField_a_of_type_JavaUtilList.clear();
      g();
    }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    a();
    if ((bbev.a(BaseApplication.getContext())) && (!paramBoolean)) {
      e();
    }
  }
  ...
  public long c(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((anoh)((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_b_of_type_Long;
    }
    return 0L;
  }
  ...
  {
    if (this.jdField_a_of_type_Anny == null) {}
    while ((this.jdField_a_of_type_Anny.jdField_a_of_type_JavaUtilHashMap == null) && (this.jdField_a_of_type_Anny.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData == null)) {
      return;
    }
    Object localObject1 = new anoj();
    ((anoj)localObject1).jdField_a_of_type_JavaLangString = "dc03631";
    localObject1.getClass();
    Object localObject2 = new anok((anoj)localObject1);
    ((anok)localObject2).jdField_a_of_type_JavaLangString = String.valueOf(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
    if (this.jdField_a_of_type_Anny.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData != null)
    {
      ((anok)localObject2).d = this.jdField_a_of_type_Anny.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData.pic_md5;
      ((anok)localObject2).e = this.jdField_a_of_type_Anny.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData.pic_down_url;
    }
    if (this.jdField_a_of_type_Anny.jdField_a_of_type_Anoc != null)
    {
      ((anok)localObject2).c = this.jdField_a_of_type_Anny.jdField_a_of_type_Anoc.c;
      ((anok)localObject2).jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Anny.jdField_a_of_type_Anoc.jdField_b_of_type_JavaLangString;
    }
    if ((this.jdField_a_of_type_Anny.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_Anny.jdField_a_of_type_JavaUtilHashMap.size() > 0))
    {
      ArrayList localArrayList1 = new ArrayList();
      ArrayList localArrayList2 = new ArrayList();
      Iterator localIterator = this.jdField_a_of_type_Anny.jdField_a_of_type_JavaUtilHashMap.keySet().iterator();
      while (localIterator.hasNext())
      {
        String str = (String)localIterator.next();
        localArrayList1.add(str);
        localArrayList2.add(this.jdField_a_of_type_Anny.jdField_a_of_type_JavaUtilHashMap.get(str));
      }
      ((anok)localObject2).jdField_a_of_type_JavaUtilArrayList = localArrayList1;
      ((anok)localObject2).jdField_b_of_type_JavaUtilArrayList = localArrayList2;
    }
    int i;
    if (this.jdField_a_of_type_Anny.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null)
    {
      i = this.jdField_a_of_type_Anny.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int;
      if (i != 0) {
        break label401;
      }
      ((anok)localObject2).f = "c2c";
    }
    for (;;)
    {
      ((anok)localObject2).h = this.jdField_a_of_type_Anny.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;
      ((anok)localObject2).g = "android";
      ((anoj)localObject1).jdField_a_of_type_Anok = ((anok)localObject2);
      localObject1 = ((anoj)localObject1).a();
      localObject2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), anol.class);
      ...
      this.jdField_a_of_type_Anny.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData = null;
      this.jdField_a_of_type_Anny.jdField_a_of_type_JavaUtilHashMap = null;
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet((NewIntent)localObject2);
      return;
      label401:
      if (i == 1) {
        ((anok)localObject2).f = "group";
      } else if (i == 3000) {
        ((anok)localObject2).f = "discuss";
      } else {
        ((anok)localObject2).f = "other";
      }
    }
  }
  ...
  public boolean d()
  {
    return a(bbjn.l(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()));
  }
  ...
  public void e()
  {
    ...
    String str1 = bbjn.l(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    String str2 = bbjn.k(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    ...
    if (!a(str1))
    {
      ...
      bbwg localbbwg = new bbwg(str2, new File(str3));
      localbbwg.n = true;
      ...
      localbbwl.a(localbbwg, new anof(this, str2, str3, str1), null);
      return;
    }
    DuiButtonImageView.a();
    jdField_a_of_type_Boolean = false;
