  ...
  extends aqqt
{
  ...
  aqpz(aqpv paramaqpv, MessageRecord paramMessageRecord)
  {
    super(paramaqpv);
  ...
  void a(String paramString, int paramInt, aqqr paramaqqr)
  {
    ...
    aqpv.a(this.jdField_a_of_type_Aqpv).a().a().a(paramString, paramInt, this.b, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, 106, new aqqa(this, paramString, paramaqqr));
  }
}
