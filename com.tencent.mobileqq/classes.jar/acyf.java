  ...
  implements acxg, View.OnClickListener
{
  ...
  public acyf(BaseChatPie paramBaseChatPie)
  {
  ...
  private void a(RedTouch paramRedTouch, int paramInt)
  {
    ...
    {
      BusinessInfoCheckUpdate.RedTypeInfo localRedTypeInfo = ((auqh)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(paramInt);
  ...
  private void a(RedTouch paramRedTouch, int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0)
    {
      BusinessInfoCheckUpdate.AppInfo localAppInfo = ((auqh)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(paramInt1, String.valueOf(paramInt2));
  ...
  private void h()
  {
    this.o = aciy.a(4.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
    this.jdField_a_of_type_Boolean = awnu.b();
    a();
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (AppSetting.jdField_c_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(ajjy.a(2131648385));
      }
      return;
      bool1 = false;
      break;
    ...
    label114:
    this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(ajjy.a(2131648391));
  }
  ...
  public void a(TextView paramTextView)
  {
    ...
    if (paramTextView != null)
    {
      ...
      if ((localObject instanceof RelativeLayout.LayoutParams))
      {
        ...
        ((RelativeLayout.LayoutParams)localObject).leftMargin = aciy.a(14.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
  ...
  public void a(Boolean paramBoolean)
  {
    ...
    {
      awnu.a((SystemBarCompact)localObject, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().getWindow(), paramBoolean);
      p();
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    int i2 = 2130838011;
    boolean bool = true;
    Object localObject = (acyp)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(23);
    if ((localObject != null) && ((((acyp)localObject).b()) || (this.jdField_f_of_type_Boolean))) {}
    for (int i1 = 1;; i1 = 0)
    {
      ...
      label178:
      for (i1 = 2130838011;; i1 = 2130838012)
      {
  ...
  protected void b()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout != null) && (this.jdField_a_of_type_Boolean) && (this.jdField_b_of_type_Boolean)) {
      if (this.jdField_a_of_type_AndroidWidgetImageButton != null)
      {
        ...
        if (this.jdField_a_of_type_AndroidWidgetImageButton != null)
        {
          this.jdField_a_of_type_AndroidWidgetImageButton.setSelected(false);
          if (AppSetting.jdField_c_of_type_Boolean) {
            this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(ajjy.a(2131648380));
          }
        }
        if (this.jdField_b_of_type_AndroidWidgetImageButton == null) {
          break label787;
        ...
        if (this.jdField_b_of_type_AndroidWidgetImageButton != null)
        {
          this.jdField_b_of_type_AndroidWidgetImageButton.setSelected(false);
          if (AppSetting.jdField_c_of_type_Boolean) {
            this.jdField_b_of_type_AndroidWidgetImageButton.setContentDescription(ajjy.a(2131648377));
          }
        }
        this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131301274));
        if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)
        {
          ...
          ((FrameLayout.LayoutParams)localObject1).leftMargin = aciy.a(8.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
        ...
        {
          this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.c.findViewById(2131301273));
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton != null)
        {
          ...
          if ((localObject2 instanceof LinearLayout.LayoutParams))
          {
            ...
            ((LinearLayout.LayoutParams)localObject2).width = ((int)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getDimension(2131166841));
            ((LinearLayout.LayoutParams)localObject2).height = ((int)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getDimension(2131166841));
            ...
            this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setText("");
            if (AppSetting.jdField_c_of_type_Boolean) {
              this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setContentDescription(ajjy.a(2131648386));
            }
    ...
    while ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aeis))
    {
      for (;;)
      {
        int i1;
        return;
        localObject1 = (ViewStub)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout.findViewById(2131296821);
        if (localObject1 != null)
        {
          this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)((ViewStub)localObject1).inflate());
          this.jdField_a_of_type_AndroidWidgetImageButton.setBackgroundResource(2130838021);
          this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(this);
          continue;
          localObject1 = (ViewStub)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout.findViewById(2131296822);
          if (localObject1 != null)
          {
            this.jdField_b_of_type_AndroidWidgetImageButton = ((ImageButton)((ViewStub)localObject1).inflate());
            this.jdField_b_of_type_AndroidWidgetImageButton.setBackgroundResource(2130837959);
            this.jdField_b_of_type_AndroidWidgetImageButton.setOnClickListener(this);
            continue;
            ((LinearLayout.LayoutParams)localObject1).bottomMargin = ((int)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getDimension(2131166840));
            continue;
            i1 = 2130838012;
            continue;
            o();
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton != null)
    {
      ...
      if ((localObject2 instanceof LinearLayout.LayoutParams))
      {
        ...
        if ((this.jdField_e_of_type_Int != -1) && (this.jdField_f_of_type_Int != -1))
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setText(2131625184);
          if (AppSetting.jdField_c_of_type_Boolean) {
            this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setContentDescription(ajjy.a(2131648389));
          }
          if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)
          {
            localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton;
  ...
  {
    Object localObject1 = (acyp)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(23);
    boolean bool = paramBoolean;
    if (localObject1 != null) {
      if (!((acyp)localObject1).b())
      {
        bool = paramBoolean;
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton != null) && (this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Boolean))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setText(2131625184);
      if (AppSetting.jdField_c_of_type_Boolean) {
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setContentDescription(ajjy.a(2131648387));
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setVisibility(0);
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setEnabled(true);
      ...
      if ((localObject1 instanceof LinearLayout.LayoutParams))
      {
        ...
        ((LinearLayout.LayoutParams)localObject1).leftMargin = aciy.a(2.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
        ((LinearLayout.LayoutParams)localObject1).rightMargin = aciy.a(6.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
      ...
      if ((localObject2 instanceof LinearLayout.LayoutParams))
      {
        ...
        {
          ((LinearLayout.LayoutParams)localObject2).width = (((LinearLayout.LayoutParams)localObject2).width + this.g + this.h + this.k + this.l - aciy.a(8.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources()));
    ...
    localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton;
    if (this.jdField_e_of_type_Boolean) {}
    for (int i1 = 2130838011;; i1 = 2130838012)
    {
      ((PatchedButton)localObject1).setBackgroundResource(i1);
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setText("");
      if (AppSetting.jdField_c_of_type_Boolean) {
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentWidgetPatchedButton.setContentDescription(ajjy.a(2131648383));
      }
      localObject1 = this.jdField_a_of_type_AndroidWidgetLinearLayout.getLayoutParams();
      if ((localObject1 instanceof LinearLayout.LayoutParams))
      {
  ...
  public void c()
  {
    ...
    {
      if (this.q != -1) {}
      for (localLayoutParams.bottomMargin = this.q;; localLayoutParams.bottomMargin = ((int)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getDimension(2131166840)))
      {
        if (QLog.isColorLevel()) {
  ...
  public boolean c()
  {
    acyp localacyp = (acyp)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(23);
    return (localacyp != null) && ((localacyp.b()) || (this.jdField_f_of_type_Boolean));
  }
  ...
  void e()
  {
    ...
    {
      BusinessInfoCheckUpdate.RedTypeInfo localRedTypeInfo = ((auqh)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a(10);
  ...
  public void g()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout != null) && (b()) && (this.jdField_b_of_type_Boolean))
    {
      ...
      int i1 = aciy.a(10.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
    ...
    for (;;)
    {
      return;
      label321:
      localLayoutParams.bottomMargin = ((int)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getDimension(2131166840));
      break;
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout != null) && (this.jdField_b_of_type_Int != -1) && (this.jdField_c_of_type_Int != -1))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(aciy.a(1.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources()));
      }
