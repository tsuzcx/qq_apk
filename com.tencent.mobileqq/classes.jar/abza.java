  ...
  extends abwg
{
  ...
  public abza(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private long a(MessageForDeviceFile paramMessageForDeviceFile, View paramView, arwz paramarwz)
  {
    long l1;
  ...
  private MessageRecord a(long paramLong1, long paramLong2, JSONObject paramJSONObject)
  {
    ...
    MessageForDevPtt localMessageForDevPtt = (MessageForDevPtt)bcry.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, Long.toString(paramLong2), null, 9501);
    ...
    localMessageForDevPtt.msg = (bhlg.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForDevPtt.senderuin, true) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691134));
  ...
  private MessageRecord b(long paramLong1, long paramLong2, JSONObject paramJSONObject)
  {
    ...
    localMessageForDeviceFile.msg = (bhlg.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForDeviceFile.senderuin, true) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691403));
    ...
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      if ((localView != null) && (localObject != null))
      {
        ...
        if ((paramMessageRecord instanceof MessageForDeviceFile)) {
          ((arwz)localObject).a(localView, (MessageForDeviceFile)paramMessageRecord);
        }
      }
      for (int j = i;; j = i - 1)
      {
  ...
  public long a(MessageRecord paramMessageRecord, View paramView, arwz paramarwz)
  {
    if ((paramMessageRecord instanceof MessageForDeviceFile)) {
      return a((MessageForDeviceFile)paramMessageRecord, paramView, paramarwz);
    }
    return 0L;
  }
  ...
  {
    Object localObject1 = (abwi)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong));
    ...
    do
    {
      ...
      localObject2 = ((QQAppInterface)localObject2).a().a(((abwi)localObject1).jdField_a_of_type_JavaLangString, ((abwi)localObject1).jdField_a_of_type_Int, ((abwi)localObject1).jdField_a_of_type_Long);
