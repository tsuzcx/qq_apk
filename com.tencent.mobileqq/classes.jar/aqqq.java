  ...
  extends BaseAdapter
{
  ...
  public aqqq(List<FeedsItemData.LabelInfo> paramList, Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject2).topMargin = actj.a(7.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ((RelativeLayout)localObject1).setPadding(actj.a(1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actj.a(1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actj.a(1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actj.a(1.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      ((ImageSwitcher)localObject3).setFactory(new aqqr(this));
      Object localObject4 = new RelativeLayout.LayoutParams(actj.a(30.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actj.a(30.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      ((ImageSwitcher)localObject4).setFactory(new aqqs(this));
      RelativeLayout.LayoutParams localLayoutParams = new RelativeLayout.LayoutParams(actj.a(30.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actj.a(30.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      localLayoutParams.addRule(5, ((ImageSwitcher)localObject3).getId());
      localLayoutParams.leftMargin = actj.a(22.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ...
      paramViewGroup.jdField_a_of_type_Aqth = new aqth(paramViewGroup.jdField_a_of_type_AndroidWidgetImageSwitcher, paramViewGroup.jdField_b_of_type_AndroidWidgetImageSwitcher);
      localObject2 = new ImageView(this.jdField_a_of_type_AndroidContentContext);
      ((ImageView)localObject2).setId(2131367906);
      localObject3 = new RelativeLayout.LayoutParams(actj.a(34.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actj.a(32.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      ((RelativeLayout.LayoutParams)localObject2).topMargin = actj.a(9.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ...
      ((RelativeLayout.LayoutParams)localObject4).topMargin = actj.a(2.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      ...
      ((ImageView)localObject3).setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849297));
      localObject4 = new RelativeLayout.LayoutParams(actj.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actj.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      ...
      paramView.setPadding(actj.a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actj.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actj.a(5.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), actj.a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      paramView.setTag(paramViewGroup);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      if (aqsv.a(localLabelInfo.redInfo))
      {
        ...
        if (!this.jdField_a_of_type_JavaUtilMap.containsKey(localLabelInfo.name))
        {
          ...
          yoa.a((Map)localObject1, localLabelInfo.msgId);
          ...
          yoa.a(ajac.a(), "769", "205648", localLabelInfo.appId, "76903", "1", "160", (Map)localObject1);
        }
      }
    ...
    for (;;)
    {
      try
      {
        ...
        if (localLabelInfo.friendList.size() >= 4)
        {
          ...
          if (paramInt < localLabelInfo.friendList.size())
          {
            ...
            paramInt += 1;
            continue;
            paramViewGroup = (aqqp)paramView.getTag();
            break;
          }
          paramViewGroup.jdField_a_of_type_Aqth.a((List)localObject1);
        }
      }
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131710327));
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setText(ajya.a(2131710322) + localLabelInfo.friendNum + ajya.a(2131710314));
      return paramView;
      localObject1 = URLDrawable.getDrawable(((FeedsItemData.FriendInfo)localLabelInfo.friendList.get(0)).icon);
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageSwitcher.setVisibility(0);
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageSwitcher.setImageDrawable((Drawable)localObject1);
    ...
    try
    {
      ...
      if ((localLabelInfo.icons != null) && (localLabelInfo.icons.size() > 0))
      {
        ...
        if (localLabelInfo.icons.size() >= 4) {
          paramViewGroup.jdField_a_of_type_Aqth.a(localLabelInfo.icons);
        }
      }
      for (;;)
      {
