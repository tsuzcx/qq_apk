  ...
  implements axft
{
  ...
  public ConcurrentHashMap<Integer, bmwi> a;
  private boolean jdField_a_of_type_Boolean;
  private HashMap<String, Long> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  private boolean jdField_b_of_type_Boolean = true;
  private boolean c;
  
  public bcvn(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    if (this.jdField_a_of_type_AndroidDatabaseContentObserver == null) {
      this.jdField_a_of_type_AndroidDatabaseContentObserver = new bcvo(this, null);
    }
    try
    {
      if (!this.jdField_a_of_type_Boolean) {
        paramQQAppInterface.getApplication().getContentResolver().registerContentObserver(abjl.h, true, this.jdField_a_of_type_AndroidDatabaseContentObserver);
      }
  ...
  private void a(int paramInt, bmwi parambmwi)
  {
    if ((parambmwi == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    ThreadManager.post(new QZoneManagerImp.3(this, new bmwi(parambmwi), paramInt), 5, null, false);
  }
  ...
  private void b()
  {
    ...
    //   1: astore_2
    //   2: aload_0
    //   3: getfield 104	bcvn:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   6: ifnonnull +14 -> 20
    //   9: aload_0
    //   10: new 106	java/util/concurrent/ConcurrentHashMap
    //   13: dup
    //   14: invokespecial 192	java/util/concurrent/ConcurrentHashMap:<init>	()V
    //   17: putfield 104	bcvn:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   20: aload_0
    //   21: getfield 104	bcvn:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   24: invokevirtual 195	java/util/concurrent/ConcurrentHashMap:clear	()V
    //   27: aload_0
    //   28: getfield 54	bcvn:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   48: iconst_0
    //   49: aload_0
    //   50: getfield 54	bcvn:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   65: astore_1
    //   66: aload_2
    //   67: invokestatic 212	bmwi:a	(Landroid/database/Cursor;)Ljava/util/HashMap;
    //   70: astore_3
    //   71: aload_3
    //   72: ifnull +13 -> 85
    //   75: aload_2
    //   76: astore_1
    //   77: aload_0
    //   78: getfield 104	bcvn:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   81: aload_3
    ...
    //   110: aload_0
    //   111: aload_3
    //   112: invokevirtual 101	bcvn:a	(Ljava/lang/Exception;)V
    //   115: aload_2
    //   116: ifnull -12 -> 104
    //   119: aload_2
    ...
    for (;;)
    {
      ...
      try
      {
        if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null)
        {
          ...
          bmwi[] arrayOfbmwi = (bmwi[])this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.values().toArray(new bmwi[this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size()]);
          ...
          ContentValues[] arrayOfContentValues = new ContentValues[arrayOfbmwi.length];
          i = 0;
          if (i < arrayOfbmwi.length)
          {
            ...
            arrayOfContentValues[i] = arrayOfbmwi[i].a();
  ...
  public int a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null)
    {
      bmwi localbmwi = (bmwi)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
      if (localbmwi != null) {
        return (int)localbmwi.jdField_a_of_type_Long;
      }
    }
    return 0;
  }
  
  public bmwi a(int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.d("QZoneManagerImp.", 2, "QZoneManagerImp getFeedCount type :" + paramInt);
    }
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null) {
      return (bmwi)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
    }
    return null;
  }
  ...
  public ArrayList<String> a()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap != null)
    {
      Object localObject = (bmwi)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(2));
      if ((localObject != null) && (((bmwi)localObject).jdField_a_of_type_JavaUtilArrayList != null) && (((bmwi)localObject).jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        Iterator localIterator = ((bmwi)localObject).jdField_a_of_type_JavaUtilArrayList.iterator();
  ...
  public void a()
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), bcvr.class);
    localNewIntent.putExtra("key_uin", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount());
    localNewIntent.putExtra("lastPushMsgTime", bcux.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
  ...
  public void a(int paramInt)
  {
      ...
      for (;;)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication() != null))
        {
          ...
          if (paramInt == 2) {
            try
            {
              NewIntent localNewIntent1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), bcvp.class);
    ...
    NewIntent localNewIntent2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), bcvp.class);
  ...
  public void a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), bcvp.class);
  ...
  public void a(Exception paramException)
  {
    ...
    for (;;)
    {
      ...
      bdmc.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "qzoneconfigdberror", true, 0L, 0L, localHashMap, null, true);
      bnkm.a(paramException, "QZoneConfigProvider error");
      return;
      str = "1";
      continue;
      str = "2";
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    {
      paramString1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), bcvp.class);
  ...
  public void a(HashMap<Integer, bmwi> paramHashMap)
  {
    for (;;)
    {
      int j;
        ...
        else if ((paramHashMap != null) && (paramHashMap.size() != 0) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
        {
          ...
          if (j < m)
          {
            ...
            if ((localInteger != null) && ((localInteger instanceof Map.Entry)))
            {
              ...
              localObject = (bmwi)((Map.Entry)localObject).getValue();
              if (!a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
              {
                if (QLog.isColorLevel()) {
                  QLog.d("FeedAlert.", 2, "QZoneManagerImp.checkShowQZonePush" + Long.toBinaryString(this.jdField_a_of_type_Long) + ",count" + ((bmwi)localObject).jdField_a_of_type_Long);
                }
                if (localInteger.intValue() == 17) {
                  break label303;
                }
              }
              bool = a(localInteger.intValue(), (bmwi)localObject);
  ...
  public boolean a(int paramInt, long paramLong, ArrayList<QZoneCountUserInfo> paramArrayList, String paramString1, boolean paramBoolean1, boolean paramBoolean2, String paramString2)
  {
    ...
    localbmwi.jdField_a_of_type_Long = paramLong;
    localbmwi.jdField_a_of_type_JavaUtilArrayList = paramArrayList;
    localbmwi.jdField_a_of_type_Boolean = paramBoolean1;
    localbmwi.d = paramString1;
    if (!TextUtils.isEmpty(paramString2)) {
      localbmwi.c = paramString2;
    }
    paramBoolean1 = false;
    paramArrayList = (bmwi)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
    if (!localbmwi.a(paramArrayList)) {
      paramBoolean1 = true;
    }
    if (paramBoolean1)
    {
      if ((paramLong > 0L) && (paramArrayList != null) && (paramArrayList.jdField_a_of_type_JavaUtilArrayList != null) && (localbmwi != null) && (localbmwi.jdField_a_of_type_JavaUtilArrayList != null) && (localbmwi.jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        paramString1 = localbmwi.jdField_a_of_type_JavaUtilArrayList.iterator();
        ...
        localbmwi.jdField_a_of_type_JavaUtilArrayList.addAll(paramArrayList.jdField_a_of_type_JavaUtilArrayList);
      }
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt), localbmwi);
      a(paramInt, localbmwi);
    }
    return paramBoolean1;
  }
  
  public boolean a(int paramInt, bmwi parambmwi)
  {
    boolean bool2;
    if (parambmwi == null)
    {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("QZoneManagerImp.", 2, "setFeedCountAll.feedtype=" + paramInt + ",count=" + parambmwi.jdField_a_of_type_Long + ",uin");
    }
    if ((paramInt < 1) || (paramInt > 1010)) {
      return false;
    }
    ...
    if (!parambmwi.a((bmwi)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt)))) {}
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(paramInt), parambmwi);
      return bool1;
    }
  }
  ...
  public void c(int paramInt)
  {
    ...
    try
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getContentResolver().delete(abjl.h, localStringBuilder.toString(), new String[] { str, String.valueOf(paramInt) });
      return;
    }
    catch (Exception localException)
    {
