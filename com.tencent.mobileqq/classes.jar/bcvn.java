...
public class bcvn
{
  private bcuz jdField_a_of_type_Bcuz;
  ...
  public bcvn(QQAppInterface paramQQAppInterface)
  {
    ...
    a();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bcuz);
  }
  
  private AbsStructMsg a(Context paramContext, String paramString)
  {
    String str3 = aszt.a(paramString);
    String str1 = FileUtil.getExtension(paramString);
    if (bcvs.jdField_a_of_type_JavaLangString.indexOf(str1) < 0)
    {
      QLog.e("TeamWorkSender", 1, paramString + " is not docs support file");
      return null;
    }
    if (".doc|.docx".contains(str1)) {
      paramString = amtj.a(2131713827);
    }
    for (str1 = "https://pub.idqqimg.com/pc/misc/files/20180403/29c998e16c094b10a96b3e0d1589c2f6.png";; str1 = "https://pub.idqqimg.com/pc/misc/files/20180403/da40f07bd79e4796b712b44023911be0.png")
    {
      ...
      localIntent.putExtra("app_name", amtj.a(2131713846));
      localIntent.putExtra("brief_key", paramContext.getString(2131695880, new Object[] { str2 }));
      return bchh.a(localIntent.getExtras());
      paramString = amtj.a(2131713823);
    }
  }
  ...
  private TeamWorkFileImportInfo a(String paramString)
  {
    ...
    localTeamWorkFileImportInfo.jdField_b_of_type_JavaLangString = aszt.a(paramString);
    localTeamWorkFileImportInfo.jdField_e_of_type_Int = aszt.a(paramString);
    localTeamWorkFileImportInfo.jdField_b_of_type_Boolean = false;
    localTeamWorkFileImportInfo.jdField_d_of_type_Int = 4;
    localTeamWorkFileImportInfo.jdField_d_of_type_Long = aszt.a(paramString);
  ...
  private String a(int paramInt)
  {
    ...
    case -104: 
    default: 
      return amtj.a(2131713801);
    case -102: 
    case -101: 
    case -100: 
      return amtj.a(2131713791);
    case -103: 
      return amtj.a(2131713821);
    case -116: 
    case -106: 
      return amtj.a(2131713819);
    case -107: 
      return amtj.a(2131713783);
    case -108: 
      return amtj.a(2131713835);
    case -110: 
      return amtj.a(2131713822);
    case -111: 
      return amtj.a(2131713804);
    case -115: 
    case -113: 
    case -112: 
      return amtj.a(2131713788);
    }
    return amtj.a(2131713844);
  }
  
  private void a()
  {
    this.jdField_a_of_type_Bcuz = new bcvo(this);
  }
  ...
  private void a(AbsStructMsg paramAbsStructMsg, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, String paramString, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForStructing = bbli.a(localQQAppInterface, str2, paramString, str1, paramInt, l, paramAbsStructMsg);
      ...
      paramAbsStructMsg = (bcum)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(120);
  ...
  {
    paramString2 = aszt.a(paramString1);
  ...
  public boolean a(MessageForStructing paramMessageForStructing, SessionInfo paramSessionInfo)
  {
    ...
    bcum localbcum = (bcum)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(120);
    if (!TextUtils.isEmpty(localbcum.a(paramSessionInfo))) {
      localbcum.a(paramSessionInfo);
    }
    if (!localbcum.a(paramSessionInfo)) {
      localbcum.a(paramSessionInfo);
    }
