...
final class bcvn
  extends bcvy
{
  bcvn(Context paramContext, String paramString, QQAppInterface paramQQAppInterface, akjt paramakjt) {}
  ...
  public void a(SCGet3rdCloudCheck paramSCGet3rdCloudCheck)
  {
    ...
    if (paramSCGet3rdCloudCheck != null)
    {
      if (paramSCGet3rdCloudCheck.delayHour > 24) {
        bcwc.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, paramSCGet3rdCloudCheck.delayHour);
      }
      if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
      {
        ...
        bcvm.b(this.jdField_a_of_type_AndroidContentContext, 398677);
      }
    }
  }
}
