...
public class bfoq
  implements bfop
{
  private bfop jdField_a_of_type_Bfop;
  
  public bfoq(AbsListView paramAbsListView) {}
  
  public void a(ActionMode paramActionMode, int paramInt, long paramLong, boolean paramBoolean)
  {
    this.jdField_a_of_type_Bfop.a(paramActionMode, paramInt, paramLong, paramBoolean);
    if (this.jdField_a_of_type_ComTencentWidgetAbsListView.getCheckedItemCount() == 0) {
      paramActionMode.finish();
    }
  }
  
  public void a(bfop parambfop)
  {
    this.jdField_a_of_type_Bfop = parambfop;
  }
  
  public boolean onActionItemClicked(ActionMode paramActionMode, MenuItem paramMenuItem)
  {
    return this.jdField_a_of_type_Bfop.onActionItemClicked(paramActionMode, paramMenuItem);
  }
  
  public boolean onCreateActionMode(ActionMode paramActionMode, Menu paramMenu)
  {
    boolean bool = false;
    if (this.jdField_a_of_type_Bfop.onCreateActionMode(paramActionMode, paramMenu))
    {
  ...
  {
    this.jdField_a_of_type_Bfop.onDestroyActionMode(paramActionMode);
  ...
  {
    return this.jdField_a_of_type_Bfop.onPrepareActionMode(paramActionMode, paramMenu);
  }
}
