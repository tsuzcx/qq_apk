  ...
  extends aaho
{
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d6.ResendRspBody paramResendRspBody, Bundle paramBundle)
  {
    ...
    {
      bfmf.b("TroopFileUploadWorker", bfmf.a, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqResendFileResult.but stoped");
      return;
    }
    if ((paramResendRspBody == null) || (!paramBoolean))
    {
      bfmf.a("TroopFileUploadWorker", bfmf.a, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqResendFileResult isSuccess:false  errCode:" + paramInt);
      paramResendRspBody = new bgje(this.a.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item.FileName, this.a.d, 3, 207);
      this.a.jdField_a_of_type_Bflq.c = 1;
      this.a.jdField_a_of_type_Bflq.d = paramInt;
      this.a.a(true, bgme.b, bgme.A, paramResendRspBody);
      return;
    }
    int i = paramResendRspBody.int32_ret_code.get();
    bfmf.c("TroopFileUploadWorker", bfmf.a, "[" + this.a.jdField_a_of_type_JavaLangString + "] onReqResendFileResult isSuccess:true  errCode:" + paramInt + " retCode:" + i);
    if (i < 0)
    {
      ...
      for (;;)
      {
        ...
        bflo.b(this.a.d, this.a.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager$Item, paramInt);
        this.a.a(false, bgme.c, i);
        return;
        paramInt = 101;
        continue;
        paramInt = 102;
      ...
      this.a.a(true, bgme.c, i, paramInt);
      return;
    }
