  ...
  implements Handler.Callback
{
  ...
  public axkx a;
  private axky jdField_a_of_type_Axky = new axky(null);
  axlb jdField_a_of_type_Axlb;
  ...
  public axkw()
  {
    this.jdField_a_of_type_Axkx = new axkx();
    f();
  ...
  private axlq a()
  {
    axlq localaxlq = this.jdField_a_of_type_Axkx.a.b();
    if (localaxlq != null) {
      return localaxlq;
    }
    localaxlq = this.jdField_a_of_type_Axkx.a.a();
    if (localaxlq != null)
    {
      this.jdField_a_of_type_Axlb.a(localaxlq.jdField_a_of_type_Int, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      return localaxlq;
    }
    return null;
  }
  ...
  {
    this.jdField_a_of_type_Axky.jdField_a_of_type_Int = paramAVIOStruct.pFrameIndex;
    paramAVIOStruct.pFrameIndex = 0;
    this.jdField_a_of_type_Axky.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Axky.jdField_b_of_type_Int = 0;
    aiba.a("handleMessage:writeVideoFrame[false]  mThumbPicControl.mSendThumbOKIndex=" + this.jdField_a_of_type_Axky.jdField_a_of_type_Int);
  }
  ...
  private boolean a()
  {
    boolean bool2 = true;
    bool1 = false;
    synchronized (axkx.a(this.jdField_a_of_type_Axkx))
    {
      Object localObject2 = axkx.a(this.jdField_a_of_type_Axkx);
  ...
  private void h()
  {
    if (this.jdField_a_of_type_Axlb != null) {
      this.jdField_a_of_type_Axlb.c();
    }
    this.jdField_a_of_type_Axlb = null;
    c();
  ...
  public void a(int paramInt1, int paramInt2, ahxo paramahxo)
  {
  ...
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqShortvideoUtilOffScreenInputSurface != null)
    {
      if (paramBoolean)
      {
        this.jdField_a_of_type_Axlb = new axlb();
        this.jdField_a_of_type_Axlb.a(false, false);
        d();
      }
      axjn.b();
      return;
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == -16716524)
    {
      ...
      a(paramMessage.arg1, paramMessage.arg2, (ahxo)paramMessage.obj);
      this.h = true;
      if (this.i) {
        a(a());
      }
    ...
    do
    {
      do
      {
        ...
        f();
        this.jdField_a_of_type_Axkx.a();
        this.jdField_a_of_type_Axkx.a = null;
        this.jdField_a_of_type_Axky.jdField_b_of_type_Int = 0;
        this.jdField_a_of_type_Axky.jdField_a_of_type_Boolean = false;
        this.jdField_a_of_type_Axky.jdField_a_of_type_Int = -1;
        h();
      } while (!QLog.isColorLevel());
    ...
    if (j != 0)
    {
      aiba.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
      return true;
    }
    if (this.jdField_a_of_type_Axlb != null) {
      axjn.a(PtvFilterUtils.a() / 1000L);
    }
    boolean bool1;
    if (paramMessage.obj != null)
    {
      ...
      for (;;)
      {
        ...
        aiba.a("handleMessage:[copyDataToByteBuffer] steptime=" + l1 + " us");
        axjn.d(l1);
        ...
        if (this.jdField_a_of_type_Axkx.a != null) {
          break;
        }
        aiba.a("handleMessage:[RenderModeCheck-Recorder][May Lost Frame] mode=" + j);
        return true;
        if (paramMessage.arg1 == 1) {
          localObject = ((axio)paramMessage.obj).jdField_a_of_type_ArrayOfByte;
        }
      }
      ...
      if (localaxlq != null)
      {
        this.jdField_a_of_type_Axlb.a(localaxlq.jdField_a_of_type_Int);
        aiba.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] bindTextureId=" + localaxlq.jdField_a_of_type_Int);
        aiba.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] Begin drawFrame mWidth=" + this.jdField_a_of_type_Int + " mHeight=" + this.jdField_b_of_type_Int);
        e();
        aiba.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] End drawFrame");
        if (!jdField_a_of_type_Boolean) {}
        AVIOStruct localAVIOStruct;
        for (bool1 = true;; bool1 = false)
        {
          PtvFilterUtils.a(bool1);
          aiba.a("handleMessage:[CAMERA_OPENGL_RANDER_DATA] glSyncCommand OK: sNeedSyncUseFlush=" + jdField_a_of_type_Boolean);
          if (paramMessage.arg1 != 1) {
            break label1126;
          }
          localAVIOStruct = ((axio)paramMessage.obj).jdField_a_of_type_ComTencentMaxvideoCommonAVIOStruct;
        ...
        {
          this.jdField_a_of_type_Axky.jdField_a_of_type_Boolean = true;
          localObject = localAVIOStruct;
        }
        label713:
        ...
        bool1 = true;
        label739:
        localaxlq.a(j, localObject, bool1);
        localaxlq.e();
        bool1 = this.jdField_a_of_type_Axkx.a.a();
        aiba.a("handleMessage:writeVideoFrame  mNewSession=" + this.jdField_a_of_type_Axky.jdField_a_of_type_Boolean + "  Make data ready: frameIndex= " + ((AVIOStruct)localObject).pFrameIndex + "  hasRenaderFrame=" + bool1);
        if (!bool1)
        {
          if (this.jdField_a_of_type_Axky.jdField_a_of_type_Boolean) {
            a((AVIOStruct)localObject);
          }
          localaxlq.a();
        }
        aiba.a("handleMessage:writeVideoFrame frameBufferTime=" + l2 + "  sNeedSyncUseFlush=" + jdField_a_of_type_Boolean);
      }
      l1 = (PtvFilterUtils.a() - l1) / 1000L;
      axjn.c(l1);
    ...
    for (;;)
    {
      ...
      break label739;
      label1143:
      aiba.a("handleMessage:byteBufferProcessFrame  framebuffer=null");
    }
  }
}
