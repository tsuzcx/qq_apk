...
public class axkw
{
  ...
  {
    bfhl.a(null, a(paramString)).b(paramQQAppInterface, null).a(paramActivity, paramQQAppInterface.getAccount());
  ...
  public static void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    if (!TextUtils.isEmpty(paramString1))
    {
      ...
      if (localClipboardManager != null)
      {
        ...
        if (paramBoolean) {
          bbmy.a(BaseApplicationImpl.getContext(), 2, ajjy.a(2131640764), 0).a();
        }
      }
    }
  }
