  ...
  extends BaseAdapter
{
  ...
  public xoi(Context paramContext, List<T> paramList)
  {
  ...
  protected abstract void a(xoj paramxoj, T paramT, int paramInt);
