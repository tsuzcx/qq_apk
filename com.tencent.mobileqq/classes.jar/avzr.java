  ...
  implements avpv
{
  ...
  private static final String e = anvx.a(2131705185);
  private static final String f = anvx.a(2131690148);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = anvx.a(2131705181);
    jdField_b_of_type_JavaLangString = anvx.a(2131705180);
    d = anvx.a(2131705186);
    jdField_c_of_type_JavaLangString = anvx.a(2131705189);
  }
      ...
      for (;;)
      {
        ...
        try
        {
          if (paramIntent.hasExtra("data"))
          {
            ...
            localJSONObject.put("errMsg", paramIntent.getString("errMsg", anvx.a(2131705188)));
            localJSONObject.put("idKey", paramIntent.getString("idKey"));
            localJSONObject.put("allResults", localObject1);
          }
          for (;;)
          {
            bdla.b(null, "dc00898", "", "", "0X8009862", "0X8009862", 0, 0, this.jdField_c_of_type_Int + "", "", this.jdField_b_of_type_Int + "", paramInt + "");
            if (QLog.isColorLevel()) {
            ...
            else
            {
              ...
              localJSONObject.put("errMsg", anvx.a(2131705187));
              localJSONObject.put("allResults", localObject1);
              paramInt = 299;
            }
          }
  ...
  private void a(avpm paramavpm)
  {
    paramavpm = paramavpm.a();
    if (paramavpm != null) {
      paramavpm.a(this);
    }
    QLog.d("IdentificationApiPlugin", 1, "doFaceVerify");
    if (((paramavpm instanceof avql)) || ("identify".equals(this.l)))
    {
      e();
      if (!(paramavpm instanceof avql)) {}
    }
    try
    {
      paramavpm = new JSONObject();
      paramavpm.put("ret", 219);
      paramavpm.put("errMsg", f);
      a(paramavpm);
      return;
    }
    catch (JSONException paramavpm)
    {
      QLog.e("IdentificationApiPlugin", 1, new Object[] { "RET_CODE_AREA_NOT_SUPPORT error : ", paramavpm.getMessage() });
    }
  }
  ...
  private void c()
  {
    if (avpm.d.contains(this.l))
    {
      avpp.a(this.jdField_a_of_type_AndroidAppActivity, this.h, this.l, this.n, this.jdField_a_of_type_Long, this.jdField_b_of_type_Int, new avzt(this));
      return;
    }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    } while (!avpm.a.contains(paramString3));
    ...
    try
    {
      ...
      d();
      paramJsBridgeListener = avpm.a();
      paramJsBridgeListener.a(i1, this.n, paramString3, new avzs(this, paramJsBridgeListener));
      return true;
    }
