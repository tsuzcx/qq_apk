...
public class avzr
{
  ...
  private final avzk jdField_a_of_type_Avzk;
  private final bkxg jdField_a_of_type_Bkxg;
  private final String jdField_a_of_type_JavaLangString;
  private ByteBuffer jdField_a_of_type_JavaNioByteBuffer;
  private final List<avzt> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public avzr(bkxg parambkxg, String paramString, avzk paramavzk)
  {
    this.jdField_a_of_type_Bkxg = parambkxg;
  ...
  private void b()
  {
    ...
    avzt localavzt;
    for (int i = 0; localIterator.hasNext(); i = avzt.b(localavzt) + i)
    {
      localavzt = (avzt)localIterator.next();
      avzt.a(localavzt, localBufferInfo, i);
      this.jdField_a_of_type_AndroidMediaMediaMuxer.writeSampleData(a(avzt.a(localavzt)), this.jdField_a_of_type_JavaNioByteBuffer, localBufferInfo);
    }
  ...
  public void a()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Bkxg.a())
      {
  ...
  public void a(int paramInt, ByteBuffer paramByteBuffer, MediaCodec.BufferInfo paramBufferInfo)
  {
    try
    {
      ...
      this.jdField_a_of_type_JavaUtilList.add(new avzt(paramInt, paramBufferInfo.size, paramBufferInfo, null));
      return;
    }
