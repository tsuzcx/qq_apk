...
public class bbze
  extends bcdr
{
  public bbze(SendStoryActivity paramSendStoryActivity, EditText paramEditText, int paramInt)
  {
  ...
  public CharSequence filter(CharSequence paramCharSequence, int paramInt1, int paramInt2, Spanned paramSpanned, int paramInt3, int paramInt4)
  {
    ...
    Arrays.sort(arrayOfFriend, new bbzf(this, paramSpanned));
    ...
    paramInt4 = this.jdField_a_of_type_Int - bcdy.a(localStringBuilder.toString());
    paramInt3 = bcdy.a(paramCharSequence.subSequence(paramInt1, paramInt2).toString());
    if (paramInt4 <= 0) {
      return "";
    }
    ...
    if (paramInt3 < paramInt2)
    {
      ...
      if (Character.isHighSurrogate(paramCharSequence.charAt(paramInt3))) {
        j = bcdy.a(paramCharSequence.subSequence(paramInt3, paramInt3 + 2).toString());
      }
      for (int i = 2;; i = 1)
      {
        paramInt4 -= j;
        ...
        break;
        j = bcdy.a(String.valueOf(paramCharSequence.charAt(paramInt3)));
      }
    }
    label257:
