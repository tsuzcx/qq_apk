...
public class bkok
  implements Observer
{
  private ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new bkoq(this);
  public bkor a;
  ...
  public bkok(QQAppInterface paramQQAppInterface)
  {
  ...
  private Bundle a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Bkor == null)
      {
      ...
      try
      {
        ...
        paramBundle = this.jdField_a_of_type_Bkor.a("com.qqdataline.action.notify", paramBundle);
        if (paramBundle != null) {
          paramBundle.setClassLoader(getClass().getClassLoader());
        }
        return paramBundle;
  ...
  private void a(Bundle paramBundle, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Bkor.a("com.qqdataline.action.notify", paramBundle);
        return;
      }
      catch (Exception paramBundle)
      {
  ...
  private Bundle b(Bundle paramBundle)
  {
    ...
    if (((String)localObject2).equals("DatalineHandler_sendC2CMessage_ToService"))
    {
      ...
      paramBundle.putParcelable("ToServiceMsg", ((amqd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(8)).a(l1, (String)localObject1, i, j, k, (byte[])localObject2, l2));
    }
    do
    {
      do
      {
        do
        {
          do
          {
            ...
            {
              ((amqd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(8)).sendPbReq((ToServiceMsg)paramBundle.getParcelable("ToServiceMsg"));
              return null;
            }
          ...
          localObject2 = ((anuy)localObject2).a();
          paramBundle = (Bundle)localObject1;
      ...
      if (((String)localObject2).equals("DatalineHandler_saveFileManagerEntity"))
      {
        ...
        paramBundle = aszt.a((String)localObject1);
        ...
        localFileManagerEntity.fileSize = aszt.a((String)localObject1);
        localFileManagerEntity.isReaded = true;
        localFileManagerEntity.peerUin = ((String)localObject2);
        if (l1 == 0L) {}
        for (localFileManagerEntity.peerNick = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131694020);; localFileManagerEntity.peerNick = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131694022))
        {
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Bkor == null) && (!this.jdField_a_of_type_Boolean))
    {
  ...
  private void d()
  {
    ...
    {
      CheckPermission.requestSDCardPermission(BaseActivity.sTopActivity, new bkom(this));
      return;
    }
    f();
  }
  ...
  private void f()
  {
    a(0);
    this.b = false;
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bfur.a(BaseActivity.sTopActivity, 230, amtj.a(2131701900), amtj.a(2131701904), 2131694094, 2131719734, new bkon(this), new bkoo(this));
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setOnDismissListener(new bkop(this));
    TextView localTextView = (TextView)this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.findViewById(2131365552);
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-2, -2);
    localLayoutParams.gravity = 17;
    localTextView.setLayoutParams(localLayoutParams);
    localTextView.setMinHeight(DisplayUtil.dip2px(BaseActivity.sTopActivity, 35.0F));
    ...
    for (;;)
    {
      ...
      while (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
      {
        ...
        try
        {
          ...
          localObject1 = localObject2;
          this.jdField_a_of_type_Bkor.a("com.qqdataline.action.notify", localBundle);
          localObject1 = localObject2;
          if (!QLog.isColorLevel()) {
            continue;
          }
  ...
  private void i()
  {
    ...
    localPluginCommunicationHandler.register(new bkol(this, "dataline.remotecall"));
  }
  ...
  private void k()
  {
    ...
    bkoi.a(BaseActivity.sTopActivity, (Bundle)localObject, "com.qqdataline.activity.LiteWifiphotoActivity");
  ...
  public bkoj a()
  {
    ...
    bkoj localbkoj = new bkoj();
    localbkoj.jdField_a_of_type_JavaLangString = localBundle.getString("ServerInfo.serverIp");
    localbkoj.jdField_a_of_type_Int = localBundle.getInt("ServerInfo.serverPort");
    return localbkoj;
  }
  ...
  {
    FileManagerEntity localFileManagerEntity = aszt.a(paramMpfileTaskInfo, paramLong);
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    {
      int i = paramObservable.getUnreadMsgsNum();
