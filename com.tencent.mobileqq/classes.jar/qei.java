...
public abstract class qei
{
  ...
  osp jdField_a_of_type_Osp = new qej(this);
  private qek jdField_a_of_type_Qek;
  ...
  private void a(Bundle paramBundle, qij paramqij, int paramInt)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("video_bit_rate", Long.valueOf(paramqij.b()).toString());
      ((JSONObject)localObject).put("video_capacity", Long.valueOf(paramqij.a()).toString());
      ...
      noo.a(null, "", "0X80093D4", "0X80093D4", 0, 0, "", "", "", ((JSONObject)localObject).toString(), false);
      return;
    }
  ...
  private void b(int paramInt)
  {
    ...
    {
      localaxrl.a(str, "actReadInJoyDeliverVideoSendRequest", bool, this.jdField_f_of_type_Long - this.jdField_c_of_type_Long, 0L, localHashMap, "");
      return;
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      localaxrl.a(str, "actReadInJoyDeliverUGCVideo", bool, this.jdField_e_of_type_Long - this.jdField_a_of_type_Long, 0L, localHashMap, "");
      return;
    }
  }
  
  public void a(boolean paramBoolean, Context paramContext, Bundle paramBundle, qij paramqij, qek paramqek)
  {
    String str1 = paramqij.a();
    String str2 = paramqij.b();
    String str3 = paramqij.c();
    String str4 = paramqij.d();
    String str5 = paramqij.e();
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Qek = paramqek;
    if (paramBundle == null) {}
