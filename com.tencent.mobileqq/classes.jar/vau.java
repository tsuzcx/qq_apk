...
{
  public vau(MarketFaceItemBuilder paramMarketFaceItemBuilder) {}
    ...
    if (paramInt != 0)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if ((((MarketFaceItemBuilder.Holder)localObject2).jdField_a_of_type_ComTencentMobileqqEmoticonviewPicEmoticonInfo != null) && (paramEmoticonPackage.epId.equals(((MarketFaceItemBuilder.Holder)localObject2).jdField_a_of_type_ComTencentMobileqqEmoticonviewPicEmoticonInfo.a.epId)))
        {
          ...
          ((BaseActivity)this.a.b).runOnUiThread(new vav(this, (MarketFaceItemBuilder.Holder)localObject2));
        }
      }
    }
    do
    ...
    for (;;)
    {
      if (localBoolean.booleanValue()) {
        if (localObject2 != null)
        {
          ...
          ((BaseActivity)this.a.b).runOnUiThread(new vaw(this, localEmoticon, (String)localObject2, (MarketFaceItemBuilder.Holder)localObject1));
        }
      }
      for (;;)
      {
        ...
        if ((localEmoticon != null) && (localEmoticon.jobType == 4)) {
          ((BaseActivity)this.a.b).runOnUiThread(new vax(this, (MarketFaceItemBuilder.Holder)localObject1, localEmoticon));
        }
      }
      localObject2 = null;
