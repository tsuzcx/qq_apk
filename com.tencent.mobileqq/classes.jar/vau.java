...
public class vau
{
  ...
  public void a(int paramInt, stGlobalConfig paramstGlobalConfig)
  {
    ...
    vmp.d("WSGlobalConfigLog", "initGlobalConfig globalConfig:" + paramstGlobalConfig);
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    if (localstJumpInfo != null)
    {
      ...
      if (localstJumpInfo.index >= 0)
      {
        ...
        {
          vmp.a("WSGlobalConfigLog", "全屏阻断页是第" + localstJumpInfo.index + "个,id为：" + localstJumpInfo.id);
          bool1 = bool2;
  ...
  public void b(stGlobalConfig paramstGlobalConfig)
  {
    ...
    LocalMultiProcConfig.putInt4Uin("global_key_recommend_page_style", paramstGlobalConfig.aioAction.landingPage, vnd.a());
  }
  ...
  public String d()
  {
    if (!f())
    {
      ...
      {
        this.jdField_a_of_type_UserGrowthStGlobalConfig.download.qqDownloadUrl = (vbq.a() + "&versioncode=" + c());
        vmp.c("WeishiDownloadUtil", "服务器下发QQDownloadUrl失败，使用默认的:" + this.jdField_a_of_type_UserGrowthStGlobalConfig.download.qqDownloadUrl);
      }
      vmp.d("WeishiDownloadUtil", "服务器下发QQDownloadUrl: " + this.jdField_a_of_type_UserGrowthStGlobalConfig.download.qqDownloadUrl);
  ...
  public String e()
  {
    if (Thread.currentThread().getId() != Looper.getMainLooper().getThread().getId())
    {
      ...
      vmp.a("WSGlobalConfigLog", "LocalMultiProcConfig load encrypted_deviceid:" + str);
      return str;
    }
    if (this.jdField_a_of_type_UserGrowthStGlobalConfig != null)
    {
      ...
      if (!TextUtils.isEmpty(str))
      {
        ...
        vmp.a("WSGlobalConfigLog", "LocalMultiProcConfig save encrypted_deviceid:" + str);
        return str;
      }
    }
  ...
  public boolean e()
  {
    return LocalMultiProcConfig.getInt4Uin("global_key_recommend_page_style", 0, vnd.a()) == 1;
  }
