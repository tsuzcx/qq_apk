...
{
  private final baml jdField_a_of_type_Baml = new baml();
  private bamm jdField_a_of_type_Bamm;
  private final blhq jdField_a_of_type_Blhq;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private boolean jdField_a_of_type_Boolean;
  private final baml jdField_b_of_type_Baml = new baml();
  private boolean jdField_b_of_type_Boolean;
  private final baml c = new baml();
  
  public bamk(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Blhq = new blhq(ThreadManager.getSubThreadLooper(), this);
    a(new PTTPreDownloadStrategy(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Blhq));
  }
  ...
  public static int a(QQAppInterface paramQQAppInterface, MessageForPtt paramMessageForPtt)
  {
    ...
    {
      return 2005;
      if ((paramMessageForPtt.url.startsWith(antf.aZ)) && (bhmi.a(paramMessageForPtt.getLocalFilePath()))) {
        return 2003;
      }
  ...
  public static bamk a(QQAppInterface paramQQAppInterface)
  {
    return (bamk)paramQQAppInterface.getManager(127);
  }
  
  private baml a(MessageForPtt paramMessageForPtt)
  {
    baml localbaml = null;
    if (paramMessageForPtt.istroop == 0) {
      localbaml = this.jdField_a_of_type_Baml;
    }
    do
    {
      return localbaml;
      if (paramMessageForPtt.istroop == 1) {
        return this.jdField_b_of_type_Baml;
      }
  ...
  private void a(baml parambaml)
  {
    ...
    int i = 0;
    if (i < parambaml.jdField_a_of_type_JavaUtilArrayList.size())
    {
      MessageForPtt localMessageForPtt = (MessageForPtt)parambaml.jdField_a_of_type_JavaUtilArrayList.get(i);
      if (this.jdField_a_of_type_Bamm.b(localMessageForPtt)) {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    {
      a(this.jdField_a_of_type_Baml);
      a(this.jdField_b_of_type_Baml);
      a(this.c);
    }
  }
  ...
  private void a(boolean paramBoolean, int paramInt, MessageForPtt paramMessageForPtt)
  {
    ...
    if ((paramMessageForPtt.extFlag > 0L) && ((paramMessageForPtt.extFlag & 1L) > 0L))
    {
      ...
      this.jdField_a_of_type_Bamm.b(paramMessageForPtt);
    }
    label129:
    while (((paramMessageForPtt.extFlag & 0x2) != 0L) || (!this.jdField_a_of_type_Bamm.a(paramMessageForPtt, 3)))
    {
  ...
  private boolean a(baml parambaml)
  {
    ...
    for (;;)
    {
      if ((parambaml.jdField_a_of_type_Int < 3) && (parambaml.jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        MessageForPtt localMessageForPtt = (MessageForPtt)parambaml.jdField_a_of_type_JavaUtilArrayList.get(0);
        if (this.jdField_a_of_type_Bamm.a(localMessageForPtt))
        {
          long l;
          ...
          try
          {
            ...
            label113:
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localMessageForPtt.frienduin, localMessageForPtt.istroop, localMessageForPtt.uniseq, localMessageForPtt.msgData);
            parambaml.jdField_a_of_type_JavaUtilArrayList.remove(0);
            for (bool = false;; bool = true)
            {
              ...
              break label102;
              parambaml.jdField_a_of_type_Int += 1;
              parambaml.jdField_a_of_type_JavaUtilArrayList.remove(0);
            }
          }
    ...
    do
    {
      for (;;)
      {
        ...
        if (!((HotChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(60)).b(paramMessageForPtt.frienduin))
        {
          ...
          if ((i == 0) || (i == -1))
          {
            localbaml = a(paramMessageForPtt);
            if (localbaml != null)
            {
              if (!this.jdField_b_of_type_Boolean) {
                break;
              ...
              long l;
              if ((localbaml.jdField_a_of_type_Int < 3) && (this.jdField_a_of_type_Bamm.a(paramMessageForPtt))) {
                if (!g(paramMessageForPtt)) {
                  if (this.jdField_a_of_type_Bamm.b(paramMessageForPtt))
                  {
                    if (paramMessageForPtt.extFlag != -1L) {
                      break label290;
                    }
              ...
              for (;;)
              {
                ...
                bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "changevoice", "0X8006F7D", 0, 0, "" + paramMessageForPtt.istroop, "", "", "");
                return true;
                l = (0x3 ^ 0xFFFFFFFF) & paramMessageForPtt.extFlag;
                break;
                localbaml.jdField_a_of_type_Int += 1;
                continue;
                i = localbaml.jdField_a_of_type_JavaUtilArrayList.size();
                localbaml.getClass();
                if (i + 1 < 99) {
                  localbaml.jdField_a_of_type_JavaUtilArrayList.add(paramMessageForPtt);
                }
              }
            }
          }
  ...
  private boolean f(MessageForPtt paramMessageForPtt)
  {
    ...
    if (this.jdField_a_of_type_Bamm.a(paramMessageForPtt, 1)) {
      if (paramMessageForPtt.extFlag != -1L) {
        break label113;
      }
    }
  ...
  private boolean g(MessageForPtt paramMessageForPtt)
  {
    ...
    else
    {
      ...
      localbeyg.jdField_c_of_type_JavaLangString = paramMessageForPtt.frienduin;
      localbeyg.jdField_a_of_type_Int = paramMessageForPtt.istroop;
      localbeyg.jdField_b_of_type_Int = 2;
      localbeyg.jdField_a_of_type_Long = paramMessageForPtt.uniseq;
      localbeyg.jdField_a_of_type_Boolean = false;
      localbeyg.e = paramMessageForPtt.urlAtServer;
      localbeyg.h = paramMessageForPtt.getLocalFilePath();
    ...
    for (;;)
    {
      localbeyg.jdField_c_of_type_Boolean = bool1;
      localbeyg.f = paramMessageForPtt.md5;
      localbeyg.jdField_c_of_type_Long = paramMessageForPtt.groupFileID;
      localbeyg.jdField_g_of_type_JavaLangString = paramMessageForPtt.groupFileKeyStr;
      localbeyg.d = paramMessageForPtt.subVersion;
      localbeyg.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = paramMessageForPtt;
      localbeyg.jdField_g_of_type_Int = 1;
      localbeyg.jdField_a_of_type_JavaLangObject = new beyl(6, 0);
      try
      {
        bool1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localbeyg);
        if (QLog.isDevelopLevel()) {
  ...
  public void a(bamm parambamm)
  {
    this.jdField_a_of_type_Bamm = parambamm;
  }
  
  public void a(boolean paramBoolean, int paramInt, beyl parambeyl, MessageForPtt paramMessageForPtt)
  {
    parambeyl = this.jdField_a_of_type_Blhq;
    if (paramBoolean) {}
    for (int i = 1;; i = 0)
    {
      parambeyl.obtainMessage(2, i, paramInt, paramMessageForPtt).sendToTarget();
      return;
    }
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean2)
    {
      localObject = this.jdField_a_of_type_Blhq;
      if (paramBoolean1) {}
      for (;;)
      {
        localObject = ((blhq)localObject).obtainMessage(3, i, 0);
        this.jdField_a_of_type_Blhq.sendMessageDelayed((Message)localObject, 30000L);
        return;
        i = 0;
      }
    }
    this.jdField_a_of_type_Blhq.removeMessages(3);
    Object localObject = this.jdField_a_of_type_Blhq;
    if (paramBoolean1) {}
    for (i = j;; i = 0)
    {
      ((blhq)localObject).obtainMessage(3, i, 0).sendToTarget();
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_Blhq.obtainMessage(0, paramMessageForPtt).sendToTarget();
    return true;
  }
  ...
  public boolean b(MessageForPtt paramMessageForPtt)
  {
    ...
    {
      paramMessageForPtt.extFlag = l;
      this.jdField_a_of_type_Blhq.obtainMessage(4, paramMessageForPtt).sendToTarget();
      return true;
      l = 0x2 | paramMessageForPtt.extFlag;
    }
  }
