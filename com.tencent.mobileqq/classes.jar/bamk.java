  ...
  implements Manager
{
  ...
  protected Handler a;
  protected ArrayMap<Long, ArrayList<bamj>> a;
  protected AppInterface a;
  protected String a;
  public WeakReference<bamt> a;
  protected ArrayList<String> a;
  protected HashMap<Long, MessageForUniteGrayTip> a;
  protected List<bamu> a;
  public boolean a;
  protected ArrayMap<Long, ArrayList<bamj>> b;
  public String b;
  ...
  public bamk(AppInterface paramAppInterface)
  {
    ...
    this.jdField_c_of_type_JavaUtilList.add(ajya.a(2131715769));
    this.jdField_d_of_type_JavaUtilList.add(ajya.a(2131715755));
  ...
  private void a(QQAppInterface paramQQAppInterface)
  {
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_JavaUtilArrayList == null)
      {
        ...
        this.jdField_a_of_type_JavaUtilArrayList = bail.a(paramQQAppInterface);
        if (this.jdField_a_of_type_JavaUtilArrayList == null) {
  ...
  public static void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      Object localObject = bbft.d.matcher(paramMessageRecord.msg);
  ...
  private void a(MessageRecord paramMessageRecord, String paramString1, String paramString2, String paramString3)
  {
    ...
    b(Long.parseLong(paramMessageRecord.frienduin), Long.parseLong(paramString1), paramString3, new bamp(this, paramString3));
  }
  ...
  private void a(String paramString)
  {
    ...
    bbkb.c(localQQAppInterface.getApplication(), localQQAppInterface.c(), paramString, false);
  }
  ...
  {
    axqy.b(null, "dc00899", "Grp_robot", "", paramString1, paramString2, 0, 0, paramString3, paramString4, paramString5, paramString6);
  }
  ...
  public static boolean a(TextView paramTextView, MessageRecord paramMessageRecord)
  {
    ...
    if (!TextUtils.isEmpty(str1))
    {
      ...
      String str2 = ajya.a(2131715757);
      SpannableString localSpannableString = new SpannableString(str2);
      localSpannableString.setSpan(new bamm(str1, paramMessageRecord), 0, str2.length(), 33);
  ...
  public static String b(MessageRecord paramMessageRecord)
  {
    if (b(paramMessageRecord))
    {
      ...
      if ((!TextUtils.isEmpty(str)) && (!TextUtils.isEmpty(paramMessageRecord))) {
        return paramMessageRecord + ajya.a(2131715765);
      }
    }
    return null;
  }
  ...
  private void b()
  {
    if ((this.jdField_a_of_type_Ajxj != null) || (this.jdField_a_of_type_ComTencentCommonAppAppInterface == null) || (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface))) {
      return;
    }
    this.jdField_a_of_type_Ajxj = new bamn(this);
  ...
  private void c()
  {
    if ((this.jdField_a_of_type_Ajxj != null) && (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null))
    {
  ...
  private void d()
  {
    Object localObject1 = bbkb.f(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
    if (!TextUtils.isEmpty((CharSequence)localObject1)) {
      try
      {
        ...
        localObject2 = bbkb.g(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());
      }
    ...
    try
    {
      ...
      if (localObject2 != null) {
        a(((anal)localObject2).a(), ((anal)localObject2).a());
      }
      return;
    }
  ...
  public bami a(long paramLong)
  {
    bami localbami = new bami();
    localbami.jdField_a_of_type_JavaUtilArrayList = a(paramLong);
    localbami.b = b(paramLong);
    localbami.jdField_a_of_type_Int = a(paramLong);
    return localbami;
  }
  ...
  public ArrayList<bamj> a(long paramLong)
  {
    ...
    if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap != null) {
      synchronized (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap)
      {
        if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap.containsKey(Long.valueOf(paramLong)))
        {
          ...
          while (localIterator.hasNext())
          {
            bamj localbamj = (bamj)localIterator.next();
            if (localbamj.a()) {
              localArrayList.add(localbamj);
            }
          }
        }
      }
  ...
  public void a(int paramInt1, long paramLong1, long paramLong2, int paramInt2, bams parambams)
  {
    ...
    mxf.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bamq(this, parambams), localReqBody.toByteArray(), "OidbSvc.0x934_1", 2356, 1, new Bundle(), 12000L);
  }
  
  public void a(int paramInt, long paramLong1, long paramLong2, String paramString, bams parambams)
  {
    cmd0x934.ReqBody localReqBody = new cmd0x934.ReqBody();
    ...
    localReqBody.robot_uin.set(paramLong2);
    mxf.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bamr(this, parambams), localReqBody.toByteArray(), "OidbSvc.0x934_1", 2356, 1, new Bundle(), 12000L);
  }
  
  public void a(long paramLong, int paramInt, bams parambams)
  {
    a(4, 0L, paramLong, paramInt, parambams);
  }
  ...
  public void a(long paramLong1, long paramLong2)
  {
    ...
    if (localMessageForUniteGrayTip != null)
    {
      ...
      aqvc.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, localMessageForUniteGrayTip);
    }
  }
      ...
      for (;;)
      {
        synchronized (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap)
        {
          if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap.containsKey(Long.valueOf(paramLong1)))
          {
            ...
            bamj localbamj = (bamj)((Iterator)localObject1).next();
            if (localbamj.a() != paramLong2) {
              continue;
            }
            ...
            if (!localbamj.a())
            {
              localObject1 = localObject4;
              if (paramInt == 1) {
                localObject1 = localbamj;
              }
            }
            localbamj.a(paramInt);
            if (localObject1 != null)
            {
              localArrayList.remove(localObject1);
              localArrayList.add(0, localObject1);
              if (QLog.isColorLevel()) {
                QLog.d("TroopRobotManager", 2, "onSetTroopRobot move position " + ((bamj)localObject1).a());
              }
            }
          }
          return;
  ...
  public void a(long paramLong1, long paramLong2, int paramInt, bams parambams)
  {
    a(1, paramLong1, paramLong2, paramInt, parambams);
  }
  
  public void a(long paramLong1, long paramLong2, String paramString, bams parambams)
  {
    a(3, paramLong1, paramLong2, paramString, parambams);
  }
  
  public void a(long paramLong, String paramString, bams parambams)
  {
    a(Long.valueOf("1").longValue(), paramLong, paramString, parambams);
  }
  
  public void a(long paramLong, ArrayList<bamj> paramArrayList)
  {
  ...
  public void a(long paramLong, ArrayList<bamj> arg3, int paramInt)
  {
    StringBuilder localStringBuilder;
    if (QLog.isColorLevel())
    {
  ...
  {
    String str = bbcz.h(paramQQAppInterface, paramChatMessage.frienduin, paramChatMessage.senderuin);
    paramEditText = bafv.a(paramQQAppInterface, paramContext, paramSessionInfo.jdField_a_of_type_JavaLangString, paramChatMessage.senderuin, str, false, paramEditText, true, true);
    paramContext = new ArrayList();
    paramEditText = bafv.a(paramEditText, paramContext);
    ...
    try
    {
      ...
      new axrc(paramQQAppInterface).a("dc00899").b("Grp_robot").c("sub_page").d("next_msg_clk").a(new String[] { paramChatMessage.frienduin, paramSessionInfo }).a();
      return;
    }
  ...
  public void a(bamt parambamt)
  {
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambamt);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, long paramLong, ArrayList<String> paramArrayList)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      localArrayList = bail.b(paramQQAppInterface);
      if (localArrayList == null)
      {
        ...
        if ((paramArrayList == null) || (paramArrayList.size() == 0))
        {
          ...
          bail.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilArrayList);
          bail.a(paramQQAppInterface, false);
    ...
    for (;;)
    {
      ...
      {
        bail.a(paramQQAppInterface, this.jdField_a_of_type_JavaUtilArrayList);
        bail.b(paramQQAppInterface, localArrayList);
        if (paramArrayList.size() <= 0) {
          break label392;
        }
        bail.a(paramQQAppInterface, true);
        bail.c(paramQQAppInterface, true);
        break label392;
        break;
        i -= 1;
        break label182;
    ...
    try
    {
      ...
      if (paramRobot.uin_range.has())
      {
        ...
        while ((i < paramRobot.uin_range.size()) && (i < 5))
        {
          ...
          localbamu.a = localUinRange.start_uin.get();
          localbamu.b = localUinRange.end_uin.get();
          this.jdField_a_of_type_JavaUtilList.add(localbamu);
          i += 1;
        }
      }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      b(Long.parseLong(paramString1), Long.parseLong(paramString2), paramString3, new bamo(this, paramString3));
      a();
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    if (localJSONArray != null) {
      bbkb.f(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), localJSONArray.toString());
    }
    paramJSONObject = paramJSONObject.optJSONObject("robot_voice_tail");
    if (paramJSONObject != null) {
      bbkb.g(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), paramJSONObject.toString());
    }
    d();
  }
  ...
  public boolean a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      {
        bamu localbamu = (bamu)this.jdField_a_of_type_JavaUtilList.get(i);
        if ((localbamu != null) && (paramLong >= localbamu.a) && (paramLong <= localbamu.b)) {
          bool1 = true;
        }
      }
      else
  ...
  public boolean a(Context paramContext, String paramString, long paramLong)
  {
    if (a(paramLong))
    {
      bail.a(paramContext, paramString, String.valueOf(paramLong));
      return true;
    }
    return false;
  }
  ...
  {
    boolean bool2 = false;
    if (!bail.d(paramQQAppInterface, paramString2))
    {
  ...
  public boolean a(MessageRecord paramMessageRecord)
  {
    ...
    if ((paramMessageRecord.atInfoList != null) && (paramMessageRecord.atInfoList.size() > 0))
    {
      ...
      for (;;)
      {
        ...
        if (a(((MessageForText.AtTroopMemberInfo)localObject).uin))
        {
          ...
          str1 = bbcz.h((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramMessageRecord.frienduin, "" + ((MessageForText.AtTroopMemberInfo)localObject).uin);
          ...
          for (;;)
          {
            ...
            if (str2.equals(((String)this.jdField_c_of_type_JavaUtilList.get(j)).replace("$ROBOTNICK$", str1)))
            {
              ...
              axqy.b((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, "dc00899", "Grp_robot", "", "msg", "conti_dialog_msg", 0, 0, paramMessageRecord.frienduin, this.jdField_a_of_type_JavaLangString, (String)this.jdField_c_of_type_JavaUtilList.get(i), "");
              return true;
            }
            j += 1;
          }
    ...
    while (i < this.jdField_b_of_type_JavaUtilList.size())
    {
      ...
      for (localObject = "";; localObject = ((String)localObject).toUpperCase().replaceAll(" ", ""))
      {
        ...
        axqy.b((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, "dc00899", "Grp_robot", "", "msg", "keyword_msg", 0, 0, paramMessageRecord.frienduin, this.jdField_a_of_type_JavaLangString, (String)this.jdField_b_of_type_JavaUtilList.get(i), "");
        return true;
      }
      i += 1;
    }
  ...
  {
    boolean bool2 = false;
    paramString2 = bbcz.h((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, paramString3, "" + paramString2);
  ...
  public byte[] a()
  {
    return bbdx.a(BaseApplication.getContext().getFileStreamPath("troop_robot_config"));
  }
  
  public byte[] a(String paramString1, String paramString2)
  {
    return bbdx.a(BaseApplication.getContext().getFileStreamPath("troop_robot_panel_data_" + paramString1 + "_" + paramString2));
  }
  
  public ArrayList<bamj> b(long paramLong)
  {
    ArrayList localArrayList = new ArrayList(0);
    if (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap != null) {
      synchronized (this.jdField_b_of_type_AndroidSupportV4UtilArrayMap)
  ...
  public void b(int paramInt, long paramLong1, long paramLong2, String paramString, bams parambams)
  {
    cmd0x934.ReqBody localReqBody = new cmd0x934.ReqBody();
    localReqBody.cmd.set(paramInt, true);
    localReqBody.group_id.set(paramLong1, true);
    localReqBody.keyword.set(paramString, true);
    localReqBody.robot_uin.set(paramLong2);
    mxf.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new baml(this, parambams), localReqBody.toByteArray(), "OidbSvc.0x934_1", 2356, 1, new Bundle(), 12000L);
  }
  
  public void b(long paramLong1, long paramLong2, String paramString, bams parambams)
  {
    b(2, paramLong1, paramLong2, paramString, parambams);
  }
  
  public void b(long paramLong, String paramString, bams parambams)
  {
    b(2, Long.valueOf("1").longValue(), paramLong, paramString, parambams);
  }
