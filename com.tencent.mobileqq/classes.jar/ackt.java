...
class ackt
  extends nmf
{
  ackt(acks paramacks, acle paramacle, JSONObject paramJSONObject, acjr paramacjr) {}
  
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.i(acks.a, 2, "onResult appid=" + acks.a(this.jdField_a_of_type_Acks).a + ", openid=" + this.jdField_a_of_type_Acle.a + ", openkey=" + this.jdField_a_of_type_Acle.b + ", code=" + paramInt + ", req param=" + this.jdField_a_of_type_OrgJsonJSONObject);
    }
    if ((paramInt != 0) || (paramArrayOfByte == null))
    {
      acmy.a(this.jdField_a_of_type_Acjr, paramInt, "getRankingList result error, try again");
      return;
    }
    ...
    if (paramArrayOfByte != null)
    {
      ...
      try
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.e(acks.a, 2, localJSONException.getMessage(), localJSONException);
          }
        }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e(acks.a, 2, paramArrayOfByte.getMessage(), paramArrayOfByte);
        }
      }
      QLog.i(acks.a, 2, "result is, " + paramBundle.toString());
