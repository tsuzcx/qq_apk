  ...
  extends MSFServlet
{
  ...
  protected void a(boolean paramBoolean, newest_feeds_rsp paramnewest_feeds_rsp)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject3 = localanyw.a(String.valueOf(localObject3));
      ...
      if (i == 3) {
        try
        {
          ...
          if (((localNumberFormatException.feedTime <= ((META.StStoryFeed)localObject5).createTime.get()) || (localNumberFormatException.feedType == 2)) && (!TextUtils.isEmpty(((META.StStoryFeed)localObject5).coverImage.url.get())))
          {
            ...
            localNumberFormatException.feedContent = BaseApplicationImpl.getApplication().getString(2131689947);
    ...
    if ((paramnewest_feeds_rsp != null) && (!paramnewest_feeds_rsp.isEmpty()))
    {
      ...
      while (paramnewest_feeds_rsp.hasNext())
      {
        ...
        localObject2 = localanyw.a(String.valueOf(((feed_info)localObject1).opuin));
        if (localObject2 != null)
        {
          l = ((feed_info)localObject1).time;
          str = bayo.a(((feed_info)localObject1).strcontent, localQQAppInterface);
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    {
      paramIntent = baym.a(paramFromServiceMsg.getWupBuffer());
      if (paramIntent != null)
      {
        b(true, paramIntent);
        return;
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    byte[] arrayOfByte = new baym(bayo.a(paramIntent)).encode();
