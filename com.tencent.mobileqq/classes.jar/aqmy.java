...
public class aqmy
{
  ...
  public static int a(aqmc paramaqmc, int paramInt1, int paramInt2)
  {
    int i = paramInt2;
    if (paramInt2 == -1) {
      i = 0;
    }
    Camera.CameraInfo localCameraInfo = paramaqmc.a()[paramInt1];
    if (localCameraInfo.facing == 1) {
      return (paramaqmc.a().a(paramInt1, localCameraInfo.orientation) - i + 360) % 360;
    }
    return (paramaqmc.a().a(paramInt1, localCameraInfo.orientation) + i) % 360;
  }
  ...
  private static boolean a(SharedPreferences paramSharedPreferences, String paramString, int paramInt)
  {
    ...
    //   115: aload 6
    //   117: astore 5
    //   119: invokestatic 284	aqmx:a	()Laqmx;
    //   122: invokevirtual 286	aqmx:a	()Ljava/lang/String;
    //   125: astore 9
    //   127: aload 6
    //   129: astore 5
  ...
  {
    return Build.VERSION.SDK_INT >= aqmw.a().a();
  }
