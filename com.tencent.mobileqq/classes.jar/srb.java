  ...
  implements srh
{
  ...
  public void a(ViewBase paramViewBase, Context paramContext, ProteusItemData paramProteusItemData)
  {
    ...
    paramViewBase = oyu.k + bhkv.encodeToString(String.valueOf(paramProteusItemData).getBytes(), 2);
    ...
    {
      ozs.a(this.a.a.getContext(), paramProteusItemData.getLiveUrl());
      ...
      for (;;)
      {
        paramViewBase = ozs.a(paramProteusItemData, localArticleInfo, i, paramViewBase);
        try
        {
          paramViewBase.put("live_circle_from_page", 1);
          ssy.a(paramContext.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, "0X800B17E", paramViewBase.toString());
          return;
          paramViewBase = "1";
        }
    ...
    ozs.a(this.a.a.getContext(), paramViewBase);
    paramProteusItemData = this.a.a.getContext();
    ...
    {
      paramViewBase = ozs.a(paramProteusItemData, localArticleInfo, 0, paramViewBase);
      ssy.a(paramContext.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, "0X800898A", paramViewBase.toString());
      return;
    }
  }
}
