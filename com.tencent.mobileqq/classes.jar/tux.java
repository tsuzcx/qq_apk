...
public class tux
  extends Handler
{
  public tux(TroopInfoActivity paramTroopInfoActivity) {}
    ...
    do
    {
      ...
      do
      {
        ...
        if (paramMessage.what == 4)
        {
          ...
          for (paramMessage = this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.mRichFingerMemo;; paramMessage = this.a.getResources().getString(2131433068))
          {
        ...
        if (!paramMessage.isEmpty())
        {
          ...
          ((TextView)((View)localObject1).findViewById(2131366441)).setVisibility(0);
        }
