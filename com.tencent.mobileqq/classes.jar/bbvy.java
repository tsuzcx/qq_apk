...
public class bbvy
  implements bceo
{
  public bbvy(ChallengeBragBase paramChallengeBragBase) {}
  ...
  protected void a(Intent paramIntent)
  {
    ...
    if (i != 0)
    {
      ...
      bcds.e("qqBaseActivity", "onSendChallengeComplete error:{KEY_ERROR_CODE:" + i + "; KEY_ERROR_MSG:" + paramIntent.getStringExtra("key_error_msg") + "}");
    }
  ...
  {
    this.a.d();
    bcds.c("qqBaseActivity", "SendChallenge exception." + paramException.getMessage(), paramException);
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        if (localObject != null)
        {
          bcfb.a("400", (String)localObject, this.a.c);
    ...
    {
      bcds.c("qqBaseActivity", "SendChallenge exception." + paramJSONObject.getMessage(), paramJSONObject);
