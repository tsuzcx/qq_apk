  ...
  implements Manager
{
  ...
  bdfn jdField_a_of_type_Bdfn = new bfow(this);
  public bfph a;
  public bfzc a;
  bfzn jdField_a_of_type_Bfzn = new bfov(this);
  protected bfzz a;
  bgbf jdField_a_of_type_Bgbf;
  bhhe jdField_a_of_type_Bhhe = new bfoz(this);
  AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface = null;
  BaseChatPie jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie;
  public Comparator<bfpg> a;
  HashMap<String, Integer> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  String jdField_b_of_type_JavaLangString;
  HashMap<String, List<bfpg>> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  ...
  public bfos(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_Int = 1;
    this.jdField_c_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_b_of_type_Boolean = true;
    this.jdField_a_of_type_JavaUtilComparator = new bfoy(this);
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    a(paramAppInterface);
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
  }
  
  private void a(bfpg parambfpg)
  {
    int i = 0;
    Object localObject = (List)this.jdField_b_of_type_JavaUtilHashMap.get(parambfpg.getFriendUin());
    if (localObject == null)
    {
      localObject = new ArrayList();
      this.jdField_b_of_type_JavaUtilHashMap.put(parambfpg.getFriendUin(), localObject);
    }
    for (;;)
    {
      int j;
      try
      {
        ((List)localObject).add(parambfpg);
        int m = parambfpg.getLimitType();
        int k = -1;
        j = 0;
        if (i < ((List)localObject).size())
        {
          parambfpg = (bfpg)((List)localObject).get(i);
          if ((parambfpg == null) || (parambfpg.getLimitType() != m)) {
            break label158;
          }
          if (k == -1)
          {
  ...
  private void a(String paramString, MessageForDeliverGiftTips paramMessageForDeliverGiftTips)
  {
    ...
    {
      Object localObject = new File(bftg.a(paramString, paramMessageForDeliverGiftTips.animationType, paramMessageForDeliverGiftTips.isInteract()));
      ...
      localObject = new bhhf(bftg.c(paramMessageForDeliverGiftTips), (File)localObject);
      ((bhhf)localObject).jdField_b_of_type_Int = 2;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("AIOAnimationControlManager", 2, "start Download PackageId:" + bftg.b(paramMessageForDeliverGiftTips));
      }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    if (i < localList.size())
    {
      paramString1 = (bfpg)localList.get(i);
      if (!(paramString1 instanceof MessageForDeliverGiftTips)) {
        break label87;
      }
      paramString1 = bftg.b((MessageForDeliverGiftTips)paramString1);
    }
    for (;;)
    {
  ...
  public static boolean a(BaseChatPie paramBaseChatPie, QQAppInterface paramQQAppInterface, Object paramObject)
  {
    ...
    for (;;)
    {
      if (akvv.a(paramObject, paramQQAppInterface)) {
        paramBaseChatPie.p(false);
      }
      return false;
      label37:
      ...
      ((bfos)paramQQAppInterface.getManager(223)).a(paramBaseChatPie);
    }
  }
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      {
        if (paramString2.equals(bftg.b((MessageForDeliverGiftTips)paramString1.get(i)))) {
  ...
  private void h()
  {
    Object localObject = new File(anhk.cx);
    ...
    {
      label111:
      if (bftg.a((String)localObject, i, bool))
      {
      ...
      for (;;)
      {
        ...
        bool = true;
        break label111;
        bgmg.a(arrayOfFile[j].getAbsolutePath());
      }
      return;
      label270:
      i = 0;
  ...
  public bhhk a()
  {
    return ((bhhh)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(47)).a(1);
  }
  
  public void a()
  {
    int i = 0;
    Object localObject = new File(bftg.a(0)).getParentFile();
    if (((File)localObject).exists())
    {
      ...
      if (i < localObject.length)
      {
        if (localObject[i].exists())
        {
          ...
          try
          {
            ...
            if (bftg.a(Integer.parseInt(str))) {
  ...
  {
    if (this.jdField_a_of_type_Bfzc == null) {
      this.jdField_a_of_type_Bfzc = new bfzc(null, paramActivity, this.jdField_a_of_type_ComTencentCommonAppAppInterface);
    }
    this.jdField_a_of_type_Bfzc.a(4);
    this.jdField_a_of_type_AndroidAppActivity = this.jdField_a_of_type_Bfzc.a();
  ...
  public void a(BaseChatPie paramBaseChatPie)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != paramBaseChatPie)
    {
      ...
      this.jdField_a_of_type_Bfzc = paramBaseChatPie.a();
      if (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof TroopChatPie)) {
        break label114;
      }
      this.jdField_a_of_type_Bfzc.a(1);
      this.jdField_a_of_type_Bfzz = ((TroopChatPie)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a();
      this.jdField_a_of_type_Bgbf = ((TroopChatPie)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a();
    }
    label114:
    do
    {
    ...
    } while (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aidf));
    ...
    {
      this.jdField_a_of_type_Bfzc.a(8);
      return;
    }
    this.jdField_a_of_type_Bfzc.a(6);
  }
  ...
  {
    bfpf.a().addObserver(paramObserver);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                ...
                } while ((!b()) && (bftg.a((List)localObject3)));
                if ((this.jdField_a_of_type_Bfzz == null) || (bftg.a((List)localObject3))) {
                  break label397;
                }
              } while ((this.jdField_a_of_type_Bfzz.b()) && (this.jdField_a_of_type_Bfzz.a()));
              this.jdField_a_of_type_Int = 2;
              localObject5 = (MessageForDeliverGiftTips)((List)localObject3).get(0);
              localObject6 = bftg.b((MessageForDeliverGiftTips)localObject5);
            ...
            ((bfst)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(113)).a(((MessageForDeliverGiftTips)localObject5).frienduin, ((MessageForDeliverGiftTips)localObject5).interactId, ((MessageForDeliverGiftTips)localObject5).giftId, new bfpa(this, (MessageForDeliverGiftTips)localObject5, (List)localObject3, paramBoolean, (List)localObject4, (String)localObject6));
            return;
            ...
            return;
          } while ((this.jdField_a_of_type_Bfzc == null) || (bftg.a((List)localObject4)));
          this.jdField_a_of_type_Int = 2;
          localObject3 = (bfpg)((List)localObject4).get(0);
          ...
          {
            localObject3 = ((bfst)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(113)).a((String)localObject1, ((MessageForDeliverGiftTips)localObject5).bagId, new bfpc(this, (MessageForDeliverGiftTips)localObject5, (String)localObject1, paramBoolean));
          ...
          for (;;)
          {
            if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) {
              ((MessageForDeliverGiftTips)localObject5).senderName = bglf.h((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, (String)localObject1, "" + ((MessageForDeliverGiftTips)localObject5).senderUin);
            }
            localObject6 = bftg.b((MessageForDeliverGiftTips)localObject5);
            if ((!this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject6)) || (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(localObject6)).intValue() != 3)) {
              break label1241;
            }
            this.jdField_a_of_type_Bfzc.a(this.jdField_a_of_type_Bdfn);
            if (QLog.isColorLevel()) {
              QLog.d("AIOAnimationControlManager", 2, "Playing! playMaigface id:" + bftg.b((MessageForDeliverGiftTips)localObject5));
            }
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a() == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().a == null) || (!this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().a.a())) {
              break;
            }
        ...
        } while (this.jdField_a_of_type_Bfzz == null);
        this.jdField_a_of_type_Bfzz.a((MessageForDeliverGiftTips)localObject5, (String)localObject6, false, new bfpd(this, paramBoolean));
        return;
        if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
        {
          localObject3 = "0";
          ...
          bcst.b((QQAppInterface)localObject4, "P_CliOper", "Grp_flower", "", "cartoon", "show", 0, 0, (String)localObject1, (String)localObject6, (String)localObject3, "" + muc.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), (String)localObject1));
          if (QLog.isColorLevel())
          {
        ...
        this.jdField_a_of_type_Bfzc.a((MessageForDeliverGiftTips)localObject5);
        this.jdField_a_of_type_Bfzc.jdField_a_of_type_Bfzn = this.jdField_a_of_type_Bfzn;
        return;
        if ((this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject6)) && (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(localObject6)).intValue() == 4))
        {
        ...
        this.jdField_a_of_type_Int = 3;
        return;
        if ((localObject3 instanceof akvv))
        {
          localObject1 = (akvv)localObject3;
          this.jdField_a_of_type_Bfzc.a((akvv)localObject1);
          ((akvv)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, new bfot(this, paramBoolean));
          ((List)localObject4).remove(localObject3);
          return;
        }
      } while ((!(localObject3 instanceof MessageForTroopEffectPic)) || (this.jdField_a_of_type_Bgbf == null));
      ...
      if ((!this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject3)) || (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(localObject3)).intValue() != 3) || (!bftg.a(((MessageForTroopEffectPic)localObject5).effectId))) {
        break;
      }
      Object localObject1 = ((MessageForTroopEffectPic)localObject5).getPicDownloadInfo();
      ((ayxp)localObject1).e = "chatimg";
      Object localObject6 = ((ayxp)localObject1).c();
      ...
      for (;;)
      {
        ...
        try
        {
          if (localFile.exists())
          {
            ...
            localOptions.inSampleSize = ((int)bgmo.a((InputStream)localObject1, 720, 1080));
            ((BufferedInputStream)localObject1).close();
            localObject6 = bgmo.a((String)localObject6, localOptions);
            localObject1 = localObject3;
        ...
        this.jdField_a_of_type_Bgbf.a(((MessageForTroopEffectPic)localObject5).effectId, (Bitmap)localObject1, ((TroopChatPie)localObject3).s, new bfou(this, paramBoolean));
        ((List)localObject4).remove(localObject5);
        return;
        i = 90;
        continue;
    ...
    label1297:
    label1829:
    this.jdField_a_of_type_Bgbf.a((TroopChatPie)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, (MessageForTroopEffectPic)localObject5, false);
    return;
  ...
  public boolean a(bfpg parambfpg, boolean paramBoolean)
  {
    if (parambfpg == null) {
      return false;
    }
    if (((parambfpg instanceof MessageForDeliverGiftTips)) && (!bftg.a((MessageForDeliverGiftTips)parambfpg))) {
      return false;
    }
    a(parambfpg);
    if (paramBoolean)
  ...
  public boolean a(MessageForDeliverGiftTips paramMessageForDeliverGiftTips, boolean paramBoolean)
  {
    ...
    while (!bftg.a(paramMessageForDeliverGiftTips)) {
      return false;
    }
    ...
    {
      return true;
      ((bfst)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(113)).a(paramMessageForDeliverGiftTips.frienduin, paramMessageForDeliverGiftTips.interactId, paramMessageForDeliverGiftTips.giftId, new bfox(this, paramMessageForDeliverGiftTips, paramBoolean));
    }
  }
  ...
  public boolean a(MessageForTroopEffectPic paramMessageForTroopEffectPic, boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilHashMap.containsKey(str)) && (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(str)).intValue() == 3)) {
      if (!bftg.a(paramMessageForTroopEffectPic.effectId))
      {
        this.jdField_a_of_type_JavaUtilHashMap.remove(str);
        bgmg.d(bftg.a(paramMessageForTroopEffectPic.effectId));
  ...
  public long[] a(String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        bfpg localbfpg = (bfpg)((Iterator)localObject).next();
        if ((localbfpg instanceof MessageForDeliverGiftTips)) {
          paramString.add(Long.valueOf(((MessageForDeliverGiftTips)localbfpg).getId()));
        }
      }
    }
  ...
  public void b()
  {
    ...
    for (Object localObject = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;; localObject = this.jdField_b_of_type_JavaLangString)
    {
      ...
      if ((!this.jdField_b_of_type_Boolean) || (bftg.a((List)localObject))) {
        break label135;
      }
      int j;
      for (int i = 0; i < ((List)localObject).size(); i = j + 1)
      {
        bfpg localbfpg = (bfpg)((List)localObject).get(i);
        j = i;
        if (localbfpg.isReaded())
        {
          j = i;
          if (localbfpg.getSenderUin() != this.jdField_a_of_type_ComTencentCommonAppAppInterface.getLongAccountUin())
          {
  ...
  {
    bfpf.a().deleteObserver(paramObserver);
  }
  ...
  {
    if (!bftg.a(paramMessageForDeliverGiftTips)) {
      return false;
    }
    String str = bftg.b(paramMessageForDeliverGiftTips);
    int i;
    boolean bool;
    if ((this.jdField_a_of_type_JavaUtilHashMap.containsKey(str)) && (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(str)).intValue() == 3)) {
      if (!bftg.a(str, paramMessageForDeliverGiftTips.animationType, paramMessageForDeliverGiftTips.isInteract()))
      {
        this.jdField_a_of_type_JavaUtilHashMap.remove(str);
        bgmg.a(bftg.a(paramMessageForDeliverGiftTips));
        a(str, paramMessageForDeliverGiftTips);
        i = 2;
        if (QLog.isColorLevel()) {
          QLog.d("AIOAnimationControlManager", 2, "giftRealAnimationId:" + bftg.b(paramMessageForDeliverGiftTips) + ",state:" + i);
        }
        if ((a()) && (i != 3)) {
          break label188;
        }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Bfzc = null;
    this.jdField_a_of_type_Int = 1;
    this.jdField_a_of_type_Bfzz = null;
  }
  ...
  public void g()
  {
    ...
    if ((this.jdField_a_of_type_Bfzc != null) && (this.jdField_a_of_type_Bfzc.a())) {
      this.jdField_a_of_type_Bfzc.c();
    }
    if ((this.jdField_a_of_type_Bfzz != null) && (!this.jdField_a_of_type_Bfzz.a())) {
