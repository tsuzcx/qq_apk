...
public class agpt
  extends QIPCModule
{
  public static agpt a;
  private Map<Integer, agmu> a;
  ...
  public static agpt a()
  {
    if (jdField_a_of_type_Agpt == null) {}
    try
    {
      if (jdField_a_of_type_Agpt == null) {
        jdField_a_of_type_Agpt = new agpt();
      }
      return jdField_a_of_type_Agpt;
    }
    finally {}
  }
  ...
  private EIPCResult a(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    case 9: 
      ...
      paramQQAppInterface = (ajvm)paramQQAppInterface.getManager(85);
    ...
    case 11: 
      ...
      paramQQAppInterface = (achz)paramQQAppInterface.getManager(321);
    ...
    case 13: 
      ...
      if ((paramQQAppInterface != null) && (paramBundle != null))
      {
        paramQQAppInterface.a().b(ajed.ac, 9002, paramBundle.msg_id.hashCode());
        paramQQAppInterface.C();
      }
      return null;
    case 0: 
      paramQQAppInterface = babh.b(paramQQAppInterface, paramBundle.getString("uin"), true);
      paramBundle = new Bundle();
    ...
    case 7: 
      ...
      EmojiGifHelper.getInstance().compositeAndTransToGifInner(paramQQAppInterface, new agpy(this, paramInt));
      return null;
    case 8: 
    ...
    case 14: 
      ...
      besl.a().a(paramQQAppInterface, new agpz(this, paramInt));
      return null;
    case 1: 
    ...
    case 6: 
      ...
      paramQQAppInterface = (agqj)paramQQAppInterface.getManager(273);
      if (paramQQAppInterface != null) {
        paramQQAppInterface.a(paramBundle);
      }
      return null;
    case 16: 
      ...
      {
        paramBundle = (agmu)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    ...
    case 15: 
      localObject = paramBundle.getString("key");
      paramInt = paramBundle.getInt("code");
      paramBundle = new agqa(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
      paramQQAppInterface = (agmq)paramQQAppInterface.getManager(245);
      if (paramQQAppInterface != null)
      {
        if ((this.jdField_a_of_type_JavaUtilMap != null) && (!this.jdField_a_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramInt)))) {
    ...
    paramBundle = new agqb(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
  ...
  private void a(Bundle paramBundle, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    Object localObject1;
    if (((i != 5) && ((i & 0x10) == 0)) || ((((ajjj)localObject2).b(str)) && (!paramQQAppInterface.getCurrentAccountUin().equals(str)))) {
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(paramBundle)) {
        localObject1 = babh.b(paramQQAppInterface, str, true);
      }
      for (;;)
      {
        ...
        localObject1 = babh.b(paramQQAppInterface, str, true);
        continue;
        paramBundle = babh.q(paramQQAppInterface, str);
        localObject1 = paramBundle;
        if (TextUtils.isEmpty(paramBundle)) {
          localObject1 = str;
        }
  ...
  private void a(AppRuntime paramAppRuntime, Bundle paramBundle)
  {
    if ((paramAppRuntime != null) && (paramBundle != null))
    {
      ...
      if (paramBundle != null)
      {
        paramAppRuntime = (agmq)((QQAppInterface)paramAppRuntime).getManager(245);
  ...
  private EIPCResult b(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    case 1: 
      ...
      ((PreloadManager)paramQQAppInterface.getManager(151)).a(paramBundle, new agqd(this, paramInt));
      return null;
    case 2: 
      ...
      {
        paramBundle = new agqc(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
    ...
    ((PreloadManager)paramQQAppInterface.getManager(151)).a(paramBundle, new agpu(this, paramInt));
    return null;
  }
  ...
  public EIPCResult a(Bundle paramBundle, int paramInt)
  {
    ...
    case 3: 
      for (;;)
      {
        ...
        localObject = new agpv(this, (Bundle)localObject, localResultReceiver);
        if (paramInt == 1) {
      ...
      else
      {
        ...
        else
        {
          if ("getConditionSearchManager".equals(paramString))
          {
            ...
            paramBundle = (ajfw)((QQAppInterface)localObject).getManager(59);
            ...
            if (paramInt != 0)
            {
              ...
              if (i == 0) {
                paramBundle.c(new agpx(this, (Bundle)localObject, i, paramString, paramBundle));
              }
