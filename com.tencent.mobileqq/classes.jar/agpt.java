...
public final class agpt
{
  public static void a(Activity paramActivity)
  {
    ...
    {
      localObject = new xnw(paramActivity);
      ((TextView)((xnw)localObject).findViewById(2131377360)).setText(ajya.a(2131713605));
      QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      str2 = localQQAppInterface.getApplication().getString(2131719421) + str2;
      paramActivity = new agpz(paramActivity, str1, str3, localQQAppInterface);
      ((xnw)localObject).a(str2, paramActivity);
      ((xnw)localObject).a(paramActivity);
      ((xnw)localObject).setCancelable(false);
      ((xnw)localObject).show();
      return;
    }
  ...
  public static void a(Activity paramActivity, String paramString)
  {
    ...
    String str3 = localQQAppInterface.getApplication().getString(2131719421) + (String)localObject1;
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = bbea.a(((MessageDigest)localObject2).digest());
      }
      ...
      axqy.b(localQQAppInterface, "dc00898", "", "", "0X8009DFB", "0X8009DFB", 0, 0, str2, "1", "", "");
      try
      {
        paramString = bbdj.a(paramActivity, 230);
        paramString.setMessage(ajya.a(2131713604));
        paramString.setNegativeButton(2131690596, new agpu(paramActivity));
    ...
    aabq.a(paramActivity, 1, str2, (Bundle)localObject2).a("sdk_dynamic_avatar_edit", null, new agpv(localQQAppInterface, str2, paramActivity, str3, str5, paramString, localIntent));
  }
  ...
  private static void b(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    try
    {
      xnw localxnw = new xnw(paramActivity);
      ((TextView)localxnw.findViewById(2131377360)).setText(paramString1);
      paramString1 = localxnw.findViewById(2131365141);
      View localView = localxnw.findViewById(2131363518);
      paramString1.setVisibility(8);
      localView.setVisibility(8);
      localxnw.findViewById(2131377361).setVisibility(8);
      localxnw.a(paramString2, new agpx(paramActivity, paramString3, paramString4));
      localxnw.setCancelable(false);
      localxnw.show();
      return;
    }
    catch (Exception paramActivity)
  ...
  private static void c(Activity paramActivity)
  {
    ...
    try
    {
      ...
      ((bbgu)localObject).setMessage(ajya.a(2131713606));
      ((bbgu)localObject).setTitle(2131692234);
      paramActivity = new agpy(paramActivity, str1, str2);
      ((bbgu)localObject).setNegativeButton(2131690596, paramActivity);
      ((bbgu)localObject).setPositiveButton(2131719431, paramActivity);
