...
class lpo
{
  ...
  public void a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((this.jdField_a_of_type_JavaIoFileOutputStream == null) || (this.jdField_a_of_type_Int != paramInt2) || (this.jdField_b_of_type_Int != paramInt3) || (this.c != paramInt1))
    {
      ...
      b();
      this.jdField_b_of_type_JavaLangString = (this.jdField_a_of_type_JavaLangString + "_" + lpn.a(paramInt2, paramInt3, paramInt1) + ".yuv");
    ...
    try
    {
      ...
      this.c = paramInt1;
      this.d += 1;
      lpn.a(this.jdField_a_of_type_JavaIoFileOutputStream, paramArrayOfByte);
      return;
    }
