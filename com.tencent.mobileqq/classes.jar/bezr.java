  ...
  extends benu
{
  ...
  public bezr(DeviceFriendListOpenFrame paramDeviceFriendListOpenFrame)
  {
  ...
  protected void a()
  {
    ...
    Object localObject1 = this.jdField_a_of_type_ComTencentOpenAgentDeviceFriendListOpenFrame.jdField_a_of_type_Bfdi.a();
    bfhg.c(DeviceFriendListOpenFrame.jdField_a_of_type_JavaLangString, "-->start constructHashStruct()");
    ...
    bfhg.c(DeviceFriendListOpenFrame.jdField_a_of_type_JavaLangString, "-->end constructHashStruct()");
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.jdField_a_of_type_ComTencentOpenAgentDeviceFriendListOpenFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131562611, paramViewGroup, false);
      paramViewGroup = new bezs();
      paramViewGroup.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131375883));
      paramViewGroup.c = ((TextView)paramView.findViewById(2131378790));
      ...
      if (!this.jdField_a_of_type_ComTencentOpenAgentDeviceFriendListOpenFrame.jdField_a_of_type_Bfdi.a(localFriend.jdField_a_of_type_JavaLangString)) {
        break label386;
      }
      ...
      if ((localFriend.d == null) || ("".equals(localFriend.d))) {
        localFriend.d = bfdp.a(this.jdField_a_of_type_ComTencentOpenAgentDeviceFriendListOpenFrame.jdField_a_of_type_ComTencentOpenAgentFriendChooser.a(), localFriend.jdField_a_of_type_JavaLangString);
      }
      ...
      bfdm.a().a(localFriend.d, this.jdField_a_of_type_ComTencentOpenAgentDeviceFriendListOpenFrame);
    }
    for (;;)
    {
      ...
      return paramView;
      paramViewGroup = (bezs)paramView.getTag();
      break;
      label386:
