...
{
  auil(auie paramauie, TroopFileTransferManager paramTroopFileTransferManager, bfjs parambfjs, FileManagerEntity paramFileManagerEntity) {}
  ...
  public void a(int paramInt, String paramString, WeiyunPB.CrossBidProxyCopyFileToOtherBidMsgRsp paramCrossBidProxyCopyFileToOtherBidMsgRsp)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager.a(this.jdField_a_of_type_Bfjs.a, paramInt, null, paramString);
  }
  ...
  public void a(WeiyunPB.CrossBidProxyCopyFileToOtherBidMsgRsp paramCrossBidProxyCopyFileToOtherBidMsgRsp)
  {
    ...
    if (paramCrossBidProxyCopyFileToOtherBidMsgRsp.length() < 1)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager != null) {
        this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager.a(this.jdField_a_of_type_Bfjs.a, -1, null, anvx.a(2131716284));
      }
    }
    do
    {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTroopUtilsTroopFileTransferManager.a(this.jdField_a_of_type_Bfjs.a, 0, paramCrossBidProxyCopyFileToOtherBidMsgRsp, null);
  }
}
