...
public class ajro
  extends bbri
  implements aczg, aivc, View.OnClickListener
{
  ...
  public ajro(BaseChatPie paramBaseChatPie)
  {
    this.jdField_a_of_type_JavaLangRunnable = new ChatApolloViewListener.3(this);
    if (((paramBaseChatPie instanceof aeom)) || ((paramBaseChatPie instanceof TroopChatPie)) || ((paramBaseChatPie instanceof aeoc)) || ((paramBaseChatPie instanceof aeqb))) {
  ...
  public static void a(int paramInt, QQAppInterface paramQQAppInterface)
  {
    ...
    ((nrf)paramQQAppInterface.a(88)).a(paramInt, "", "", "", "", 0L, false);
  }
  ...
  private void d()
  {
    ...
    nrf localnrf = (nrf)((BaseChatPie)localObject).jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(88);
    String str = Integer.toString(nqn.a(((BaseChatPie)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int));
    ...
    {
      localnrf.a(134247330, "", str, (String)localObject, "", 0L, false);
      return;
    }
  }
  ...
  public void a()
  {
    ...
    nqn localnqn = (nqn)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(88);
    ((bbrd)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71)).a(localnqn.b);
  }
  ...
  public void a(String paramString)
  {
    ...
    do
    {
      do
      {
        ...
        TextView localTextView = (TextView)localLinearLayout.findViewById(2131368605);
  ...
  public void b()
  {
    ...
    nqn localnqn = (nqn)((BaseChatPie)localObject).jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(88);
    if (QLog.isColorLevel()) {
      QLog.d("ChatApolloViewListener", 2, "currentDelay:" + localnqn.c);
    }
    ...
    if (localnqn.c > 0)
    {
      ((MqqHandler)localObject).postDelayed(this.jdField_a_of_type_JavaLangRunnable, localnqn.c * 1000);
      return;
    }
    c();
  ...
  protected void onChangeUserApolloStatus(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      {
        ajey.a(localBaseChatPie.a(), "cmshow_status", true);
        return;
      }
    } while (1 != ((Integer)paramObject.second).intValue());
    ajey.a(localBaseChatPie.a(), "cmshow_status", false);
    ...
    ((airt)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211)).e();
  }
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          case 2131367587: 
            if (localBaseChatPie.c == null)
            {
              ...
              localBaseChatPie.c = new bcqf(localBaseChatPie.jdField_a_of_type_AndroidContentContext, i);
            }
            localBaseChatPie.c.a(ajya.a(2131701581));
            localBaseChatPie.c.show();
            c();
            paramView = (nqn)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(88);
            localObject = (bbrd)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(71);
          }
        } while ((paramView == null) || (localObject == null));
        ((bbrd)localObject).a(paramView.b, localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.b);
        Object localObject = (nrf)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(88);
        String str = Integer.toString(nqn.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int));
        ...
        {
          ((nrf)localObject).a(134247331, "", str, paramView, Integer.toString(nqn.b()), 0L, false);
          return;
        }
    ...
    do
    {
      ...
      do
      {
        do
        {
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  {
                    bcql.a(BaseApplicationImpl.getContext(), ajya.a(2131701583), 1).a();
                    return;
                  }
          ...
          bcql.a(BaseApplicationImpl.getContext(), ajya.a(2131701582), 1).a();
          return;
  ...
  {
    if ((TextUtils.isEmpty(paramString)) || (!bahv.b(paramString))) {
    ...
    do
    {
      do
      {
        do
        {
          ...
          localBaseChatPie = (BaseChatPie)this.jdField_a_of_type_JavaLangRefWeakReference.get();
        } while ((localBaseChatPie == null) || (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null) || (localBaseChatPie.jdField_a_of_type_Aitx == null) || (!localBaseChatPie.jdField_a_of_type_Aitx.a()) || (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo == null));
        if (!bbfj.g(localBaseChatPie.jdField_a_of_type_AndroidContentContext))
        {
        ...
        localObject = ajfh.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if (localObject == null) {
          break;
        }
        localObject = ((ajfe)localObject).a();
      } while ((localObject != null) && (((ajff)localObject).a()));
      localObject = (airx)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153);
      ...
      if (((airx)localObject).b(paramString) != 1)
      {
    ...
    } while (airx.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString) == 2);
    if (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 0) {
      localObject = bbcz.m(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      localBaseChatPie.jdField_a_of_type_Aitx.b();
      ...
      if (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) {
        localObject = bbcz.e(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramString);
      } else if (localBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 3000) {
        localObject = bbcz.b(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, true);
      } else {
        localObject = "";
      }
    }
      ...
      do
      {
        do
        {
          do
          {
            ...
            if (paramInt == 7)
            {
              localObject = (airt)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(211);
              if (((airt)localObject).jdField_a_of_type_Int != -1)
              {
                ApolloGameUtil.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((airt)localObject).jdField_a_of_type_Int, 0L, 0, "", 321, null);
                return;
              }
            }
            Object localObject = ajfh.a(localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            if (localObject != null) {
              ((ajeq)localObject).a(ajfh.a(paramInt), null, paramString);
            }
            paramString = (ajfe)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249);
          } while (paramString == null);
  ...
  protected void onQueryUserApolloAction(boolean paramBoolean, Object paramObject)
  {
    if (this.jdField_a_of_type_JavaLangRefWeakReference == null)
    {
      airx.jdField_a_of_type_Boolean = true;
      if (QLog.isColorLevel()) {
  ...
  public void onSurfaceReady(int paramInt1, int paramInt2)
  {
    ...
    ajfe localajfe = (ajfe)localBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(249);
    if (localajfe.a() != null) {
      ajlo.a(ajfh.b(localajfe.a().e), 100, 0, new Object[] { "onSurfaceReady" });
    }
    if (!localBaseChatPie.jdField_a_of_type_Aitx.jdField_a_of_type_Boolean)
    {
      ajos.a("TraceReport_initApolloSurfaceView_PreLoadJS");
