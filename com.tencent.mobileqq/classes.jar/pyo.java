  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public pyo(Activity paramActivity)
  {
    ...
    if ((paramActivity instanceof QQAppInterface))
    {
      ...
      paramActivity = bgmq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, true).getString("readinjoy_social_weburl_topicvideo", "");
  ...
  private View a()
  {
    View localView = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131493481, null);
    float f = this.jdField_a_of_type_AndroidAppActivity.getResources().getDisplayMetrics().density;
    ElasticHorScrView localElasticHorScrView1 = (ElasticHorScrView)localView.findViewById(2131309901);
    ElasticHorScrView localElasticHorScrView2 = (ElasticHorScrView)localView.findViewById(2131309902);
    ...
    ((TextView)localObject1).setOnClickListener(new pyq(this));
    this.jdField_a_of_type_Begr.setOnDismissListener(new pyr(this));
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    if (this.jdField_a_of_type_Bbms == null) {
      this.jdField_a_of_type_Bbms = new bbms(this.jdField_a_of_type_AndroidAppActivity, paramString2.getResources().getDimensionPixelSize(2131167766));
    }
  ...
  private List<ncb>[] a()
  {
    ...
    ((ncb)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131630983);
    ...
    localObject = new ncb();
    ((ncb)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131630996);
    ...
    localArrayList.add(localObject);
    localObject = new ncb();
    ((ncb)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131631003);
    ((ncb)localObject).jdField_a_of_type_Int = 2130838736;
    ((ncb)localObject).jdField_b_of_type_Int = 9;
    ((ncb)localObject).jdField_b_of_type_JavaLangString = "";
    localArrayList.add(localObject);
    localObject = new ncb();
    ((ncb)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131630986);
    ((ncb)localObject).jdField_a_of_type_Int = 2130838730;
    ((ncb)localObject).jdField_b_of_type_Int = 10;
    ((ncb)localObject).jdField_b_of_type_JavaLangString = "";
    localArrayList.add(localObject);
    localObject = new ncb();
    ((ncb)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131631000);
    ((ncb)localObject).jdField_a_of_type_Int = 2130838735;
    ((ncb)localObject).jdField_b_of_type_Int = 12;
    ((ncb)localObject).jdField_b_of_type_JavaLangString = "";
    localArrayList.add(localObject);
    localObject = new ncb();
    ((ncb)localObject).jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131630980);
    ((ncb)localObject).jdField_a_of_type_Boolean = true;
    ...
    localncb.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131630975);
    ...
    localncb = new ncb();
    localncb.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131630981);
  ...
  private void b()
  {
    ...
    this.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new pyp(this));
  ...
  public void a(ChannelInfo paramChannelInfo, Intent paramIntent, qix paramqix)
  {
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    int j = ((ncd)paramAdapterView).a.jdField_b_of_type_Int;
    int i = 3;
    if (j == 2)
    {
      this.jdField_a_of_type_Boolean = false;
      paramInt = 0;
      aphp.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidContentIntent, 21);
    }
    for (;;)
    {
      ...
      if (j == 3)
      {
        ...
        paramAdapterView.putString("title", ajjy.a(2131649242) + this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelInfo.mChannelName + ajjy.a(2131649239));
        ...
        bfqn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, paramAdapterView, null);
        continue;
      }
      if ((j == 9) || (j == 10))
      {
        ...
        if (j == 9)
        {
          ...
          str = ajjy.a(2131649241) + this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelInfo.mChannelName + ajjy.a(2131649238);
        ...
        {
          nex.a(paramView, str, (String)localObject, paramAdapterView, localBitmap, bool, null, null);
          break;
      ...
      if (j == 12)
      {
        this.jdField_a_of_type_Boolean = false;
        paramInt = 5;
        a(ajjy.a(2131649243) + this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelInfo.mChannelName + ajjy.a(2131649240), null, a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelInfo, 4), this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelInfo.mHeaderPicUrl);
        continue;
      }
      if (j == 4)
      {
        ...
        paramAdapterView.putExtra("big_brother_source_key", obz.f(0));
      ...
      if (j == 6)
      {
        ...
        bfhl.a(a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelInfo, 6)).c(paramAdapterView).b(this.jdField_a_of_type_AndroidAppActivity, paramAdapterView, 101, null);
        continue;
      }
      if (j == 1)
      {
