...
public class xvs
  extends alox
{
  public xvs(QRLoginMgrActivity paramQRLoginMgrActivity) {}
  ...
  protected void onKickOutDevFResult(boolean paramBoolean, long paramLong, int paramInt1, int paramInt2)
  {
    ...
    if ((QRLoginMgrActivity.a(this.a) == null) || (QRLoginMgrActivity.a(this.a).size() == 0))
    {
      ...
      this.a.finish();
      if ((QRLoginMgrActivity.a(this.a) != null) && (QRLoginMgrActivity.a(this.a).size() > 0)) {
        QQToast.a(this.a.getApplicationContext(), 1, 2131717586, 0).a();
      }
    }
    while (paramInt2 != 100)
    {
      return;
      QQToast.a(this.a.getApplicationContext(), 2, 2131717587, 0).a();
    ...
    if (paramBoolean)
    {
      QQToast.a(this.a.getApplicationContext(), 2, 2131717612, 0).a();
      return;
    }
    QQToast.a(this.a.getApplicationContext(), 1, 2131717586, 0).a();
  }
