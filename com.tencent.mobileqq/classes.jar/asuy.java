...
public class asuy
{
  ...
  asvb jdField_a_of_type_Asvb = new asvb(this);
  List<asvc> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  private void a(String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    {
      asvc localasvc = (asvc)localIterator.next();
      if (localasvc != null) {
        localasvc.a(paramString, paramBoolean, paramInt);
      }
    }
  ...
  public asvb a()
  {
    return this.jdField_a_of_type_Asvb;
  }
  
  public void a()
  {
    this.jdField_a_of_type_Asvb = new asvb(this);
  }
  
  public void a(AppInterface paramAppInterface, String paramString1, Context paramContext, String paramString2, asvc paramasvc)
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Asvb.b))
    {
      if (paramasvc != null) {
        paramasvc.a(paramString1, true, 0);
      }
      return;
    }
    asva localasva = new asva(this, paramasvc, paramString1);
    ...
    paramString2 = bfij.a(paramContext);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramContext.setObserver(localasva);
      ...
      catch (Exception paramString2)
      {
        for (;;)
        {
          paramasvc.a(paramString1, false, -10001);
        }
      }
    }
  }
  
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, asvc paramasvc, boolean paramBoolean, String paramString5)
  {
    QLog.i("XProxy", 2, "开始拉取A1，uin = " + paramString1 + " appid = " + paramString4);
    if ((this.jdField_a_of_type_Asvb.a != null) && (!paramBoolean) && (System.currentTimeMillis() - this.jdField_a_of_type_Long < 43200000L))
    {
      if (paramasvc != null) {
        paramasvc.a(paramString2, true, 0);
      }
      return true;
    }
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_JavaUtilList.add(paramasvc);
      return true;
    }
    ...
    for (;;)
    {
      this.jdField_a_of_type_OicqWlogin_sdkRequestWtloginHelper.SetListener(new asuz(this, paramString2));
      this.jdField_a_of_type_JavaUtilList.add(paramasvc);
      ...
      {
        paramString5 = bdcv.a(paramString5);
      }
    }
  }
}
