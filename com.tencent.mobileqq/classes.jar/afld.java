...
public class afld
{
  ...
  /* Error */
  public static afkx a(java.lang.String paramString)
  {
    // Byte code:
    //   0: aload_0
    ...
    //   212: aload 9
    //   214: iconst_0
    //   215: invokestatic 129	afld:a	([BI)I
    //   218: istore_3
    //   219: iload_3
    //   220: ifle +10 -> 230
    //   223: iload_3
    ...
    //   555: new 149	afkx
    //   558: dup
    //   559: invokespecial 150	afkx:<init>	()V
    //   562: astore_0
    //   563: aload 7
    //   565: astore 6
    //   567: aload_0
    //   568: aload 8
    //   570: invokestatic 153	afld:a	(Lafkx;Lmsg/aio_doodle/DoodleMsgProto$DoodleHeader;)V
    //   573: aconst_null
    //   574: astore 8
    //   576: iconst_m1
    //   577: istore_3
    ...
    //   597: aload 9
    //   599: iconst_0
    //   600: invokestatic 129	afld:a	([BI)I
    //   603: istore 4
    //   605: iload 4
    //   607: ifle +11 -> 618
    //   610: iload 4
    ...
    //   670: iconst_1
    //   671: iconst_0
    //   672: invokevirtual 158	afkx:a	(Lafmh;ZZ)V
    //   675: aload 7
    //   677: astore 6
    //   679: aload 7
    ...
    //   713: ifnull -703 -> 10
    //   716: aload_0
    //   717: invokevirtual 163	afkx:a	()Laflq;
    //   720: invokevirtual 168	aflq:d	()F
    //   723: fstore_1
    //   724: aload_0
    //   725: invokevirtual 163	afkx:a	()Laflq;
    //   728: invokevirtual 171	aflq:c	()F
    //   731: fstore_2
    //   732: fload_1
    //   733: fload_2
    //   734: fcmpl
    //   735: ifle +19 -> 754
    //   738: aload_0
    //   739: invokevirtual 163	afkx:a	()Laflq;
    //   742: fload_1
    //   743: invokevirtual 174	aflq:c	(F)V
    //   746: aload_0
    //   747: invokevirtual 163	afkx:a	()Laflq;
    //   750: fload_2
    //   751: invokevirtual 176	aflq:d	(F)V
    //   754: aload_0
    //   755: invokestatic 179	afld:a	(Lafkx;)V
    //   758: aload_0
    //   759: areturn
    //   760: aload 7
    //   762: astore 6
    ...
    //   989: astore 6
    //   991: aload 10
    //   993: invokestatic 188	afld:a	(Lmsg/aio_doodle/DoodleMsgProto$DoodleData;)I
    //   996: istore 4
    //   998: aload 7
    //   1000: astore 6
    //   1002: ldc 76
    ...
    //   1159: aload 10
    //   1161: iload 5
    //   1163: invokestatic 197	afld:a	(Lafmh;Lmsg/aio_doodle/DoodleMsgProto$DoodleData;Z)V
    //   1166: goto -588 -> 578
    //   1169: aload 8
    //   1171: ifnull +15 -> 1186
    //   1174: aload 7
    ...
    //   1181: iconst_1
    //   1182: iconst_0
    //   1183: invokevirtual 158	afkx:a	(Lafmh;ZZ)V
    //   1186: aload 7
    //   1188: astore 6
    //   1190: new 199	afmh
    //   1193: dup
    //   1194: invokespecial 200	afmh:<init>	()V
    //   1197: astore 8
    //   1199: aload 7
    //   1201: astore 6
    //   1203: aload 8
    //   1205: iload 4
    //   1207: putfield 203	afmh:a	I
    //   1210: iconst_1
    //   1211: istore 5
    //   1213: iload 4
    //   1215: istore_3
  ...
  private static DoodleMsgProto.DoodleData a(int paramInt, afmh paramafmh)
  {
  ...
  private static void a(afkx paramafkx)
  {
    if (paramafkx == null) {}
    ...
    {
      return;
      Iterator localIterator1 = paramafkx.a().iterator();
      while (localIterator1.hasNext())
      {
        afmh localafmh = (afmh)localIterator1.next();
        if (localafmh.c() >= 500)
        {
          if (QLog.isColorLevel()) {
            QLog.d("DoodleMsgTranslator", 2, "reduce point before:" + localafmh.c());
          }
          paramafkx = null;
          localIterator2 = localafmh.a().iterator();
          if (localIterator2.hasNext())
          {
            localafmi = (afmi)localIterator2.next();
            if (localIterator2.hasNext()) {
              break label157;
            }
          }
          if (QLog.isColorLevel()) {
            QLog.d("DoodleMsgTranslator", 2, "reduce point end:" + localafmh.c());
          }
        }
      }
    }
    ...
    {
      break;
      if ((Math.abs(localafmi.a() - paramafkx.a()) < 10.0F) && (Math.abs(localafmi.b() - paramafkx.b()) < 10.0F)) {
        localIterator2.remove();
      }
    }
  }
  
  private static void a(afkx paramafkx, DoodleMsgProto.DoodleHeader paramDoodleHeader)
  {
    if ((paramafkx == null) || (paramDoodleHeader == null)) {}
    do
    {
      return;
      BaseApplication localBaseApplication = BaseApplicationImpl.getContext();
      if ((paramDoodleHeader.float_draw_area_width.has()) && (paramDoodleHeader.float_draw_area_height.has())) {
        paramafkx.a().a((int)mum.a(localBaseApplication, paramDoodleHeader.float_draw_area_width.get()), (int)mum.a(localBaseApplication, paramDoodleHeader.float_draw_area_height.get()));
      }
      if (paramDoodleHeader.float_line_width_max.has()) {
        paramafkx.a().a(mum.a(localBaseApplication, paramDoodleHeader.float_line_width_max.get()));
      }
      if (paramDoodleHeader.float_line_width_min.has()) {
        paramafkx.a().b(mum.a(localBaseApplication, paramDoodleHeader.float_line_width_min.get()));
      }
      if (paramDoodleHeader.float_comp_factor_max.has()) {
        paramafkx.a().c(paramDoodleHeader.float_comp_factor_max.get());
      }
      if (paramDoodleHeader.float_comp_factor_min.has()) {
        paramafkx.a().d(paramDoodleHeader.float_comp_factor_min.get());
      }
    } while (!paramDoodleHeader.uint32_time.has());
    paramafkx.a(paramDoodleHeader.uint32_time.get());
  }
  
  private static void a(afmh paramafmh, DoodleMsgProto.DoodleData paramDoodleData, boolean paramBoolean)
  {
    if ((paramafmh == null) || (paramDoodleData == null)) {}
    for (;;)
    {
      return;
      if (paramBoolean)
      {
        if (paramDoodleData.uint32_rgba.has()) {
          paramafmh.b(paramDoodleData.uint32_rgba.get());
        }
        if (paramDoodleData.uint32template_id.has())
        {
          paramafmh.a(paramDoodleData.uint32template_id.get());
          if (paramafmh.a() > 0) {
            paramafmh.b(-1);
          }
        }
        ...
        if (paramDoodleData != null)
        {
          ...
          while (paramDoodleData.hasNext())
          {
            ...
            if ((localLineData.float_X.has()) && (localLineData.float_Y.has()) && (localLineData.uint64_tickcount.has())) {
              paramafmh.a(mum.a(localBaseApplication, localLineData.float_X.get()), mum.a(localBaseApplication, localLineData.float_Y.get()), -1.0F, localLineData.uint64_tickcount.get());
            }
          }
        }
      }
  ...
  private static boolean a(int paramInt, afmh paramafmh, afle paramafle)
  {
    QLog.d("DoodleMsgTranslator", 2, "formatHeader line begin :" + paramInt);
    boolean bool;
    if ((paramafle == null) || (paramafmh == null))
    {
      bool = false;
      return bool;
    }
    ...
    for (int i = localArrayList.size();; i = 0)
    {
      ...
      bool = true;
      int j = 0;
      DoodleMsgProto.DoodleData localDoodleData = a(paramInt, paramafmh);
      if (localDoodleData == null)
      {
        if (paramafle == null) {
          break;
        }
        return paramafle.a(null);
      }
      int k = 0;
      while ((k + j < i) && (k < 1000))
      {
        DoodleMsgProto.LineData localLineData = new DoodleMsgProto.LineData();
        afmi localafmi = (afmi)localArrayList.get(j + k);
        localLineData.float_X.set(a(localBaseApplication, localafmi.a()));
        localLineData.float_X.setHasFlag(true);
        localLineData.float_Y.set(a(localBaseApplication, localafmi.b()));
        localLineData.float_Y.setHasFlag(true);
        localLineData.uint64_tickcount.set(localafmi.a());
      ...
      if (paramafle != null) {
        if ((paramafle.a(localDoodleData)) && (bool)) {
          bool = true;
        }
      }
      for (;;)
  ...
  public static boolean a(afkx paramafkx, afle paramafle)
  {
    if ((paramafkx == null) || (paramafle == null)) {}
    do
    {
      do
      {
        return false;
      } while (paramafkx.a() == null);
      try
      {
        boolean bool1 = b(paramafkx, paramafle);
        paramafkx = paramafkx.a().iterator();
        int i = 0;
        if (paramafkx.hasNext())
        {
          boolean bool2 = a(i, (afmh)paramafkx.next(), paramafle);
          if ((bool2) && (bool1)) {}
      ...
      catch (Exception paramafkx)
      {
        paramafkx.printStackTrace();
      }
    } while (!QLog.isColorLevel());
    QLog.e("DoodleMsgTranslator", 2, "translate data exception:" + paramafkx);
    return false;
  }
  ...
  public static boolean b(afkx paramafkx, afle paramafle)
  {
    boolean bool = false;
    if (paramafkx == null)
    {
      if (paramafle != null) {
        bool = paramafle.a(null);
      }
      return bool;
    }
    BaseApplication localBaseApplication = BaseApplicationImpl.getContext();
    ...
    localDoodleHeader.uint32_time.set((int)paramafkx.a());
    localDoodleHeader.uint32_time.setHasFlag(true);
    ArrayList localArrayList = paramafkx.a();
    if (localArrayList != null) {}
    for (int i = localArrayList.size();; i = 0)
    {
      paramafkx = paramafkx.a();
      localDoodleHeader.uint32_line_count.set(i);
      localDoodleHeader.uint32_line_count.setHasFlag(true);
      localDoodleHeader.float_line_width_max.set(a(localBaseApplication, paramafkx.a()));
      localDoodleHeader.float_line_width_max.setHasFlag(true);
      localDoodleHeader.float_line_width_min.set(a(localBaseApplication, paramafkx.b()));
      localDoodleHeader.float_line_width_min.setHasFlag(true);
      localDoodleHeader.float_comp_factor_max.set(paramafkx.c());
      localDoodleHeader.float_comp_factor_max.setHasFlag(true);
      localDoodleHeader.float_comp_factor_min.set(paramafkx.d());
      localDoodleHeader.float_comp_factor_min.setHasFlag(true);
      localDoodleHeader.float_draw_area_width.set(a(localBaseApplication, paramafkx.a().width()));
      localDoodleHeader.float_draw_area_width.setHasFlag(true);
      localDoodleHeader.float_draw_area_height.set(a(localBaseApplication, paramafkx.a().height()));
      localDoodleHeader.float_draw_area_height.setHasFlag(true);
      if (paramafle == null) {
        break;
      }
      return paramafle.a(localDoodleHeader);
    }
  }
}
