...
public class bahx
{
  ...
  public bahx(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    a();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bahj);
  }
  
  private AbsStructMsg a(Context paramContext, String paramString)
  {
    String str3 = arrr.a(paramString);
    String str1 = arso.a(paramString);
    if (baic.jdField_a_of_type_JavaLangString.indexOf(str1) < 0)
    {
      QLog.e("TeamWorkSender", 1, paramString + " is not docs support file");
      return null;
    }
    if (".doc|.docx".contains(str1)) {
      paramString = alud.a(2131715186);
    }
    for (str1 = "https://pub.idqqimg.com/pc/misc/files/20180403/29c998e16c094b10a96b3e0d1589c2f6.png";; str1 = "https://pub.idqqimg.com/pc/misc/files/20180403/da40f07bd79e4796b712b44023911be0.png")
    {
      ...
      localIntent.putExtra("app_name", alud.a(2131715205));
      localIntent.putExtra("brief_key", paramContext.getString(2131696875, new Object[] { str2 }));
      return azvd.a(localIntent.getExtras());
      paramString = alud.a(2131715182);
    }
  }
  ...
  private TeamWorkFileImportInfo a(String paramString)
  {
    ...
    localTeamWorkFileImportInfo.jdField_b_of_type_JavaLangString = arrr.a(paramString);
    localTeamWorkFileImportInfo.jdField_e_of_type_Int = arrr.a(paramString);
    localTeamWorkFileImportInfo.jdField_b_of_type_Boolean = false;
    localTeamWorkFileImportInfo.jdField_d_of_type_Int = 4;
    localTeamWorkFileImportInfo.jdField_d_of_type_Long = arrr.a(paramString);
  ...
  private String a(int paramInt)
  {
    ...
    case -104: 
    default: 
      return alud.a(2131715160);
    case -102: 
    case -101: 
    case -100: 
      return alud.a(2131715150);
    case -103: 
      return alud.a(2131715180);
    case -116: 
    case -106: 
      return alud.a(2131715178);
    case -107: 
      return alud.a(2131715142);
    case -108: 
      return alud.a(2131715194);
    case -110: 
      return alud.a(2131715181);
    case -111: 
      return alud.a(2131715163);
    case -115: 
    case -113: 
    case -112: 
      return alud.a(2131715147);
    }
    return alud.a(2131715203);
  }
  
  private void a()
  {
    this.jdField_a_of_type_Bahj = new bahy(this);
  }
  ...
  private void a(AbsStructMsg paramAbsStructMsg, TeamWorkFileImportInfo paramTeamWorkFileImportInfo, String paramString, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForStructing = azaf.a(localQQAppInterface, str2, paramString, str1, paramInt, l, paramAbsStructMsg);
      ...
      paramAbsStructMsg = (bagw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(120);
  ...
  {
    paramString2 = arrr.a(paramString1);
  ...
  public boolean a(MessageForStructing paramMessageForStructing, SessionInfo paramSessionInfo)
  {
    ...
    bagw localbagw = (bagw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(120);
    if (!TextUtils.isEmpty(localbagw.a(paramSessionInfo))) {
      localbagw.a(paramSessionInfo);
    }
    if (!localbagw.a(paramSessionInfo)) {
      localbagw.a(paramSessionInfo);
    }
