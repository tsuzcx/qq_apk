...
public class bahx
{
  ...
  public static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    paramString2.putExtra("selfSet_leftViewText", ajyc.a(2131713482));
    if (bcde.a.containsKey("robotsummary")) {
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, int paramInt)
  {
    ...
    paramString5 = actn.a(new Intent(paramContext, SplashActivity.class), null);
    if (paramInt == 1)
    {
  ...
  public static void a(BaseActivity paramBaseActivity, String paramString)
  {
    ...
    localIntent.putExtra("selfSet_leftViewText", ajyc.a(2131713484));
    if (bcde.a.containsKey("robotsummary")) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    do
    {
      ...
      paramString1 = ajyc.a(2131713483) + paramString2;
      localObject2 = new axuk(StructMsgForGeneralShare.class).c(14).a(ajyc.a(2131713486) + paramString3).a(2).a(1).a("web", paramQQAppInterface, (String)localObject2, (String)localObject1, (String)localObject1).d(paramActivity.getResources().getString(2131718643)).a();
      axym localaxym = new axym();
      localaxym.b(1);
      localaxym.a(ajyc.a(2131713485));
      axxg localaxxg = new axxg();
      localaxxg.b(1);
      localaxxg.a(new axwq((String)localObject1));
      localaxxg.a(new StructMsgItemTitle(paramString3));
      localaxxg.a(new axzh(paramString1));
      ((AbsShareMsg)localObject2).addItem(localaxym);
      ...
      aqbc.a(paramActivity, (Intent)localObject2, paramInt);
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, String paramString3)
  {
    try
    {
      ...
      axqw.b(paramQQAppInterface, "dc00898", "", "", paramString1, paramString1, 0, 0, paramString2, "", paramString3, "");
      return;
    }
    catch (Exception paramString2)
    {
      axqw.b(paramQQAppInterface, "dc00898", "", "", paramString1, paramString1, 0, 0, "0", "", paramString3, "");
    }
  }
  ...
  public static void a(boolean paramBoolean, String paramString)
  {
    ...
    for (localObject = (QQAppInterface)localObject;; localObject = null)
    {
      ...
      ((balw)localObject).a(paramBoolean, paramString);
      return;
    }
  }
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    ((akhq)localQQAppInterface.a(20)).a(paramString1, paramString2, paramString3, Boolean.valueOf(paramBoolean));
    return true;
  }
  ...
  public static String b(String paramString)
  {
    ...
    if ((localAppRuntime instanceof QQAppInterface)) {
      return bbcl.a((QQAppInterface)localAppRuntime, paramString, false);
    }
    return null;
  }
