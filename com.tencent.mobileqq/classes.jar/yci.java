...
public class yci
{
  public static SpannableStringBuilder a(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, yck paramyck)
  {
    if (paramCommentEntry.commentType == 1) {
      return c(paramCommentLikeFeedItem, paramCommentEntry, paramyck);
    }
    if (paramCommentEntry.commentType == 2) {
      return d(paramCommentLikeFeedItem, paramCommentEntry, paramyck);
    }
    if (paramCommentEntry.commentType == 5) {
      return c(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramyck);
    }
    if (paramCommentEntry.commentType == 4) {
      return a(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramyck, true);
    }
    return a(paramCommentLikeFeedItem, paramCommentEntry, paramyck);
  }
  
  private static SpannableStringBuilder a(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, yck paramyck, boolean paramBoolean)
  {
    paramContext = ((wpy)wpm.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    if (!TextUtils.isEmpty(str5))
    {
      ...
      if (!bdol.a(paramCommentEntry.content)) {
        break label511;
      }
    }
    label84:
    ...
    label125:
    label511:
    for (paramCommentLikeFeedItem = bbzj.b(paramCommentEntry.content);; paramCommentLikeFeedItem = null)
    {
      String str1;
      String str2;
      if (paramBoolean)
      {
        paramContext = anni.a(2131712988);
        if (i == 0) {
          break label403;
        }
        str1 = "V";
      ...
      for (paramCommentLikeFeedItem = new bdod(str2 + paramContext + ": " + paramCommentLikeFeedItem, 3, 16);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + paramContext + ": " + str6))
      {
        for (;;)
        {
          i = 0;
          if (paramBoolean)
          {
            ...
            a(paramCommentLikeFeedItem, 0, k, paramyck, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
            j = str4.length() + k;
            i = j;
            if (k != j)
            {
          ...
          catch (Exception paramContext)
          {
            ...
            a(paramCommentLikeFeedItem, paramCommentLikeFeedItem.length() - "I".length(), paramCommentLikeFeedItem.length(), 2130846447, 15, 15, 3);
            return paramCommentLikeFeedItem;
          }
        }
        paramContext = anni.a(2131712991);
        break label84;
        str1 = "";
        break label93;
        str2 = "";
  ...
  private static SpannableStringBuilder a(@NonNull CommentEntry paramCommentEntry)
  {
    ...
    String str1 = null;
    if (bdol.a(paramCommentEntry.content)) {
      str1 = bbzj.b(paramCommentEntry.content);
    }
    String str3 = anni.a(2131712989);
    if (str1 != null) {}
    for (paramCommentEntry = new bdod(str3 + ": " + str1, 3, 16);; paramCommentEntry = new SpannableStringBuilder(str3 + ": " + str2))
    {
  ...
  private static SpannableStringBuilder a(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, yck paramyck)
  {
    Object localObject1 = (wpy)wpm.a(2);
    Object localObject3 = ((wpy)localObject1).c(paramCommentEntry.authorUnionId);
    ...
    {
      localObject2 = ((wpy)localObject1).c(paramCommentEntry.replierUnionId);
    ...
    for (paramCommentLikeFeedItem = (CommentLikeFeedItem)localObject2;; paramCommentLikeFeedItem = null)
    {
      ...
      if (!TextUtils.isEmpty(str4))
      {
        ...
        if (bdol.a(paramCommentEntry.content)) {
          paramCommentLikeFeedItem = bbzj.b(paramCommentEntry.content);
        }
        str6 = anni.a(2131712994);
        if (i == 0) {
          break label415;
        }
        localObject2 = "V";
      ...
      label422:
      label429:
      for (paramCommentLikeFeedItem = new bdod(str2 + (String)localObject2 + str3 + ": " + paramCommentLikeFeedItem, 3, 16);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + (String)localObject2 + str3 + ": " + str7))
      {
        j = str2.length();
        ...
        a(paramCommentLikeFeedItem, 0, i, paramyck, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
        j = str3.length() + i;
        paramyck = paramCommentLikeFeedItem;
        if (i != j)
        {
          b(paramCommentLikeFeedItem, i, j, -4473925);
          paramyck = paramCommentLikeFeedItem;
        ...
        {
          paramyck.append(" ");
          paramCommentLikeFeedItem = anni.a(2131712993);
          i = paramyck.length();
          j = paramCommentLikeFeedItem.length();
          paramyck.append(paramCommentLikeFeedItem);
          b(paramyck, i, j + i, -48606);
          i = paramyck.length();
          j = "[icon]  ".length();
          paramyck.append("[icon]  ");
          a(paramyck, i, j + i, 2130848638);
        }
        return paramyck;
        i = 0;
        break;
      ...
      label475:
      if (paramCommentLikeFeedItem != null) {}
      for (paramCommentLikeFeedItem = new bdod(str2 + (String)localObject2 + str3 + str6 + str1 + (String)localObject3 + (String)localObject1 + ": " + paramCommentLikeFeedItem, 3, 14);; paramCommentLikeFeedItem = new SpannableStringBuilder(str2 + (String)localObject2 + str3 + str6 + str1 + (String)localObject3 + (String)localObject1 + ": " + str7))
      {
        j = str2.length();
        a(paramCommentLikeFeedItem, 0, j);
        if (wka.a()) {
        ...
        a(paramCommentLikeFeedItem, i - str1.length(), j, paramyck, paramCommentEntry.replierUnionId, paramCommentEntry.replierRole);
  ...
  public static SpannableStringBuilder a(CommentLikeFeedItem paramCommentLikeFeedItem, List<LikeEntry> paramList, yck paramyck)
  {
    SpannableStringBuilder localSpannableStringBuilder = new SpannableStringBuilder();
    String str1 = paramCommentLikeFeedItem.feedId + "_" + paramList.hashCode();
    Object localObject = wnh.a().a(str1);
    ...
    for (paramCommentLikeFeedItem = paramCommentLikeFeedItem.qq;; paramCommentLikeFeedItem = null)
    {
      ...
      for (;;)
      {
        if (j < paramList.size())
        {
          ...
          localObject = ((wpy)wpm.a(2)).c(localLikeEntry.unionId);
          ...
          for (localObject = "";; localObject = ", ")
          {
            ...
            a(localSpannableStringBuilder, m, n, paramyck, localLikeEntry.unionId);
            break;
            k = 0;
            break label220;
            localObject = "";
      ...
      if (i != 0) {
        wnh.a().a(str1, localSpannableStringBuilder);
      }
  ...
  private static String a(CommentLikeFeedItem paramCommentLikeFeedItem, QQUserUIItem paramQQUserUIItem)
  {
    ...
    for (;;)
    {
      if (i != 0)
      {
        return ((wpu)wpm.a(23)).a(paramQQUserUIItem, paramCommentLikeFeedItem, false, false);
        i = 0;
        break;
      }
      return xfe.a(paramQQUserUIItem);
      label93:
      paramCommentLikeFeedItem = null;
      continue;
      paramCommentLikeFeedItem = null;
  ...
  {
    paramString1 = ((wpy)wpm.a(2)).c(paramString1);
    if (paramBoolean) {
      return ((wpu)wpm.a(23)).a(paramString1, paramString3, false, false);
    }
    return xfe.a(paramString1);
  }
  ...
  {
    paramInt4 = zlx.a(BaseApplicationImpl.getContext(), paramInt4);
    paramInt5 = zlx.a(BaseApplicationImpl.getContext(), paramInt5);
    ...
    for (;;)
    {
      ...
      if (paramInt6 == 0) {
        ...
        localObject = new zpc((Drawable)localObject);
      } else {
        localObject = new zqh((Drawable)localObject);
      }
    }
  }
  
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int paramInt2, yck paramyck, String paramString)
  {
    a(paramSpannableStringBuilder, paramInt1, paramInt2, paramyck, paramString, 0);
  }
  
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, int paramInt1, int paramInt2, yck paramyck, String paramString, int paramInt3)
  {
    paramSpannableStringBuilder.setSpan(new ycj(paramyck, paramString, paramInt3), paramInt1, paramInt2, 33);
  }
  ...
  public static void a(SpannableStringBuilder paramSpannableStringBuilder, String paramString, int paramInt1, int paramInt2)
  {
    ...
    int i = zlx.a(BaseApplicationImpl.getContext(), 13.0F);
    paramString.setBounds(0, 0, i, i);
    paramSpannableStringBuilder.setSpan(new zqh(paramString), paramInt1, paramInt2, 33);
  }
  
  public static SpannableStringBuilder b(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, yck paramyck)
  {
    if (paramCommentEntry.commentType == 1) {
    ...
    if (paramCommentEntry.commentType == 4) {
      return a(paramContext, paramCommentLikeFeedItem, paramCommentEntry, paramyck, false);
    }
    return b(paramCommentLikeFeedItem, paramCommentEntry, paramyck);
  }
  
  private static SpannableStringBuilder b(@NonNull CommentEntry paramCommentEntry)
  {
    String str = anni.a(2131712990);
    ...
    default: 
      return paramCommentEntry;
    case 1: 
      a(paramCommentEntry, j, k, 2130844589, 37, 16);
      return paramCommentEntry;
    case 2: 
      a(paramCommentEntry, j, k, 2130844591, 37, 16);
      return paramCommentEntry;
    case 3: 
      a(paramCommentEntry, j, k, 2130844590, 37, 16);
      return paramCommentEntry;
    case 4: 
      a(paramCommentEntry, j, k, 2130844588, 37, 16);
      return paramCommentEntry;
    }
    a(paramCommentEntry, j, k, 2130844587, 37, 16);
    return paramCommentEntry;
  }
  
  private static SpannableStringBuilder b(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, yck paramyck)
  {
    String str1 = null;
    Object localObject1 = (wpy)wpm.a(2);
    Object localObject2;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (TextUtils.isEmpty((CharSequence)localObject1))
        {
          if (paramCommentLikeFeedItem != null)
          {
            paramCommentEntry = new bdod(paramCommentLikeFeedItem, 3, 16);
            return paramCommentEntry;
            i = 0;
            break;
            label153:
      ...
      if (paramCommentLikeFeedItem != null) {}
      for (paramCommentLikeFeedItem = new bdod(str3 + (String)localObject1 + str1 + (String)localObject2 + ": " + paramCommentLikeFeedItem, 3, 14);; paramCommentLikeFeedItem = new SpannableStringBuilder(str3 + (String)localObject1 + str1 + (String)localObject2 + ": " + str4))
      {
        int j = str3.length();
        i = ((String)localObject1).length() + j;
        a(paramCommentLikeFeedItem, j, i);
        ...
        a(paramCommentLikeFeedItem, i - ((String)localObject1).length(), j, paramyck, paramCommentEntry.replierUnionId, paramCommentEntry.replierRole);
  ...
  private static SpannableStringBuilder c(Context paramContext, CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, yck paramyck)
  {
    paramContext = ((wpy)wpm.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    if (!TextUtils.isEmpty(str3))
    {
      ...
      paramContext = anni.a(2131712983);
      label100:
      if (i == 0) {
        break label370;
      }
    ...
    for (paramCommentLikeFeedItem = "V";; paramCommentLikeFeedItem = "")
    {
      ...
      a(localSpannableStringBuilder, 0, i, paramyck, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      j = i + str2.length();
      if (i != j) {
      ...
      j = "A".length() + i;
      if (i != j) {
        a(localSpannableStringBuilder, i, j, 2130846447, 15, 15, 3);
      }
      return localSpannableStringBuilder;
      i = 0;
      break;
      paramContext = " @" + paramContext + anni.a(2131712983);
      break label100;
    }
  }
  ...
  private static SpannableStringBuilder c(@NonNull CommentEntry paramCommentEntry)
  {
    ...
    for (paramCommentEntry = anni.a(2131712987);; paramCommentEntry = "@" + paramCommentEntry + anni.a(2131712985))
    {
      ...
      int j = "A".length() + i;
      if (i != j) {
        a(localSpannableStringBuilder, i, j, 2130846447, 15, 15);
      }
      return localSpannableStringBuilder;
    }
  }
  
  private static SpannableStringBuilder c(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, yck paramyck)
  {
    Object localObject = ((wpy)wpm.a(2)).c(paramCommentEntry.authorUnionId);
    ...
    if (!TextUtils.isEmpty(str3))
    {
      ...
      localObject = null;
      if (bdol.a(paramCommentEntry.content)) {
        localObject = bbzj.b(paramCommentEntry.content);
      }
      str4 = anni.a(2131712986);
      if (i == 0) {
        break label272;
      }
    ...
    label272:
    label278:
    for (localObject = new bdod(str1 + paramCommentLikeFeedItem + str2 + str4 + ": " + (String)localObject, 3, 16);; localObject = new SpannableStringBuilder(str1 + paramCommentLikeFeedItem + str2 + str4 + ": " + str5))
    {
      int j = str1.length();
      ...
      a((SpannableStringBuilder)localObject, 0, i, paramyck, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      j = str2.length() + i;
      if (i != j) {
  ...
  private static SpannableStringBuilder d(CommentLikeFeedItem paramCommentLikeFeedItem, @NonNull CommentEntry paramCommentEntry, yck paramyck)
  {
    Object localObject = ((wpy)wpm.a(2)).c(paramCommentEntry.authorUnionId);
    String str1 = a(paramCommentLikeFeedItem, (QQUserUIItem)localObject);
    String str2 = a(paramCommentEntry.authorRole, (QQUserUIItem)localObject);
    ...
    for (paramCommentLikeFeedItem = "V";; paramCommentLikeFeedItem = "")
    {
      ...
      a(localSpannableStringBuilder, 0, j, paramyck, paramCommentEntry.authorUnionId, paramCommentEntry.authorRole);
      k = str2.length() + j;
      if (j != k) {
    ...
    a(localSpannableStringBuilder, j, k, 2130844589, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130844591, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130844590, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130844588, 37, 16, 3);
    return localSpannableStringBuilder;
    a(localSpannableStringBuilder, j, k, 2130844587, 37, 16, 3);
    return localSpannableStringBuilder;
  }
}
