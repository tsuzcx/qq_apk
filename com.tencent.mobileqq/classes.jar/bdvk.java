  ...
  extends aqkz<HighwayConfBean>
{
  ...
  @Nullable
  public HighwayConfBean a(aqlg[] paramArrayOfaqlg)
  {
    if ((paramArrayOfaqlg != null) && (paramArrayOfaqlg.length > 0))
    {
      HighwayConfBean localHighwayConfBean = HighwayConfBean.parse(paramArrayOfaqlg[0].a);
      if (QLog.isColorLevel()) {
        QLog.d("HighwayConfProcessor", 2, "onParsed " + paramArrayOfaqlg[0].a);
      }
      return localHighwayConfBean;
    }
    return null;
