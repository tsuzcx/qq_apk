...
final class acjl
  extends QIPCModule
{
  private static volatile acjl a;
  
  private acjl(String paramString)
  {
    super(paramString);
  }
  ...
  public static acjl a()
  {
    ...
    {
      if (a == null) {
        a = new acjl("gdt_ipc_module_server_to_client");
      }
      return a;
    }
    finally {}
  ...
  public void callbackResult(int paramInt, EIPCResult paramEIPCResult)
  {
    ...
    {
      acqy.b("GdtIPCAdapter", String.format("ServerToClientIPCModule.callbackResult success:%b", new Object[] { Boolean.valueOf(bool) }));
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    if (localParams != null)
    {
      ...
      label33:
      acqy.b("GdtIPCAdapter", String.format("ServerToClientIPCModule.onCall action:%s to:%s", new Object[] { paramBundle, str }));
