...
public class acjl
{
  private static acjl jdField_a_of_type_Acjl;
  ...
  static
  {
    jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool = new RecyclablePool(acjm.class, 4);
    jdField_b_of_type_ComTencentCommonsdkPoolRecyclablePool = new RecyclablePool(acjn.class, 4);
  ...
  {
    if (jdField_a_of_type_Acjl == null) {}
    try
    {
      if (jdField_a_of_type_Acjl == null) {
        jdField_a_of_type_Acjl = new acjl();
      }
      return jdField_a_of_type_Acjl;
    }
    finally {}
  }
    ...
    for (;;)
    {
      ...
      if (this.jdField_b_of_type_Boolean)
      {
        ...
        try
        {
          ...
          if (localObject1 == null)
          {
            ...
            for (;;)
            {
              ...
              {
                localObject8 = (acjm)localArrayList.get(i);
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            ...
            localObject2 = null;
            continue;
            if ((localObject2 instanceof acjm))
            {
              localArrayList.add((acjm)localObject2);
              localHashSet2.add(Integer.valueOf(((acjm)localObject2).hashCode()));
            }
            for (;;)
            {
              i += 1;
              break;
              if ((localObject2 instanceof acjn))
              {
                j = ((acjn)localObject2).jdField_a_of_type_Int;
                if (localHashSet2.contains(Integer.valueOf(j))) {
                  localHashMap.put(Integer.valueOf(j), (acjn)localObject2);
                } else {
                  ((acjn)localObject2).recycle();
                }
              }
              else
              {
                ...
                bjmd.a("queueTask poll invalid object");
              }
            }
            a();
            continue;
            ...
            {
              ((acjm)localObject8).jdField_d_of_type_Long = l3;
              ((acjm)localObject8).jdField_g_of_type_Long = ((acjn)localHashMap.get(Integer.valueOf(localObject8.hashCode()))).jdField_a_of_type_Long;
              localHashMap.remove(Integer.valueOf(localObject8.hashCode()));
            }
            l2 = ((acjm)localObject8).jdField_d_of_type_Long - l3;
            if (l2 <= 0L)
            {
              if (HardCoderJNI.hcDebug) {
                Log.d("HardCoder.HCPerfManager", "InLoop STOP:" + i + "/" + localArrayList.size() + " task:" + ((acjm)localObject8).a(l3));
              }
              localArrayList.remove(localObject8);
              localHashSet2.remove(Integer.valueOf(localObject8.hashCode()));
              ((acjm)localObject8).recycle();
              j = i - 1;
            ...
            {
              l2 = Math.min(l1, l2);
              l1 = ((acjm)localObject8).jdField_b_of_type_Long - l3;
              if (l1 > 0L)
              {
                if (HardCoderJNI.hcDebug) {
                  Log.d("HardCoder.HCPerfManager", "InLoop WAIT:" + i + "/" + localArrayList.size() + " task:" + ((acjm)localObject8).a(l3));
                }
                l1 = Math.min(l2, l1);
                j = i;
                localObject9 = localObject2;
              ...
              {
                if (HardCoderJNI.hcDebug) {
                  Log.d("HardCoder.HCPerfManager", "InLoop  RUN:" + i + "/" + localArrayList.size() + " task:" + ((acjm)localObject8).a(l3));
                }
                localObject7 = localObject2;
                if (((acjm)localObject8).jdField_c_of_type_Int > 0) {
                  if ((localObject2 != null) && (localObject2.jdField_c_of_type_Int <= ((acjm)localObject8).jdField_c_of_type_Int))
                  {
                    localObject7 = localObject2;
                    if (localObject2.jdField_c_of_type_Int == ((acjm)localObject8).jdField_c_of_type_Int)
                    {
                      localObject7 = localObject2;
                      if (localObject2.jdField_d_of_type_Long >= ((acjm)localObject8).jdField_d_of_type_Long) {}
                    }
                  }
                  else
                  {
                ...
                if (((acjm)localObject8).jdField_d_of_type_Int > 0) {
                  if ((localObject3 != null) && (localObject3.jdField_d_of_type_Int <= ((acjm)localObject8).jdField_d_of_type_Int))
                  {
                    localObject2 = localObject3;
                    if (localObject3.jdField_d_of_type_Int == ((acjm)localObject8).jdField_d_of_type_Int)
                    {
                      localObject2 = localObject3;
                      if (localObject3.jdField_d_of_type_Long >= ((acjm)localObject8).jdField_d_of_type_Long) {}
                    }
                  }
                  else
                  {
                ...
                if (((acjm)localObject8).jdField_e_of_type_Int > 0)
                {
          ...
          for (localObject7 = "null";; localObject7 = localObject3.a(l3))
          {
            ...
            break;
            localObject7 = ((acjm)localObject4).a(l3);
            break label1091;
            localObject7 = localObject2.a(l3);
            break label1116;
            localObject7 = ((acjm)localObject5).a(l3);
            break label1157;
          }
          l2 = 0L;
          j = 0;
          ...
          if (i > 0)
          {
            ...
            {
              localObject9 = (acjm)((Iterator)localObject7).next();
              Log.i("HardCoder.HCPerfManager", "!cancelBindCore task:" + ((acjm)localObject9).a(l3));
              if ((((acjm)localObject9).jdField_d_of_type_Long <= l3) || (HardCoderJNI.checkEnv))
              {
                if (((acjm)localObject9).jdField_e_of_type_Int == 0)
                {
                  if (!HardCoderJNI.checkEnv) {
                    break label1799;
                  }
                  bjmd.a("bindTid:" + ((acjm)localObject9).jdField_e_of_type_Int);
                }
                localObject6[i] = ((acjm)localObject9).jdField_e_of_type_Int;
                i += 1;
              }
              else
              {
          ...
          for (;;)
          {
            ...
            for (;;)
            {
              ...
              localObject7 = (acjm)((Iterator)localObject6).next();
              Log.i("HardCoder.HCPerfManager", "requestBindCore task:" + ((acjm)localObject7).a(l3));
              if (((acjm)localObject7).jdField_d_of_type_Long <= l3)
              {
                if (!HardCoderJNI.checkEnv) {
                  break;
                }
                bjmd.a("stopTime:" + (((acjm)localObject7).jdField_d_of_type_Long - l3));
              }
              if (((acjm)localObject7).jdField_e_of_type_Int == 0)
              {
                if (!HardCoderJNI.checkEnv) {
                  break label2380;
                }
                bjmd.a("bindTid:" + ((acjm)localObject7).jdField_e_of_type_Int);
              }
              localObject9[m] = ((acjm)localObject7).jdField_e_of_type_Int;
              m += 1;
              k = ((acjm)localObject7).jdField_f_of_type_Int;
              l2 = ((acjm)localObject7).jdField_a_of_type_Long;
              j = ((acjm)localObject7).jdField_g_of_type_Int;
              i = Math.min((int)(((acjm)localObject7).jdField_d_of_type_Long - l3), i);
            }
            a();
          }
          a();
        ...
        if (localObject3 == null)
        {
          if (localObject5 != null)
          {
            Log.i("HardCoder.HCPerfManager", "!cancelHighIOFreq task:" + ((acjm)localObject5).a(l3));
            if ((!jdField_a_of_type_Boolean) && (HardCoderJNI.checkEnv)) {
              HardCoderJNI.cancelHighIOFreq(((acjm)localObject5).jdField_g_of_type_Int, SystemClock.elapsedRealtimeNanos());
            }
          }
          if (localObject3 == null) {
            break label3670;
      ...
      for (;;)
      {
        ...
        if (localObject2 == null)
        {
          if (localObject4 != null)
          {
            Log.i("HardCoder.HCPerfManager", "!cancelCpuHighFreq task:" + ((acjm)localObject4).a(l3));
            if ((!jdField_a_of_type_Boolean) && (HardCoderJNI.checkEnv)) {
              HardCoderJNI.cancelCpuHighFreq(((acjm)localObject4).jdField_g_of_type_Int, SystemClock.elapsedRealtimeNanos());
            }
          }
          if (localObject2 == null) {
            break label3652;
        ...
        for (;;)
        {
          ...
          for (boolean bool = true;; bool = false)
          {
            ...
            if (localObject5 == null) {}
            for (localObject5 = "null";; localObject5 = ((acjm)localObject5).a(l3))
            {
            ...
            if (localObject4 == null) {}
            for (localObject4 = "null";; localObject4 = ((acjm)localObject4).a(l3))
            {
          ...
          if (localObject2 == localObject2)
          {
            ...
            localObject4 = (acjm)localArrayList.get(k);
            if (HardCoderJNI.hcDebug) {
              Log.d("HardCoder.HCPerfManager", "CheckTask:" + k + "/" + localArrayList.size() + " task:" + ((acjm)localObject4).a(l3));
            }
            if ((((acjm)localObject4).jdField_c_of_type_Int <= 0) && (((acjm)localObject4).jdField_d_of_type_Int <= 0) && (((acjm)localObject4).jdField_e_of_type_Int <= 0)) {
              break label3225;
            }
            bool = true;
            bjmd.a(bool);
            if ((((acjm)localObject4).jdField_a_of_type_Long <= 0L) && (((acjm)localObject4).jdField_f_of_type_Int <= 0)) {
              break label3231;
            }
            bool = true;
            bjmd.a(bool);
            localObject5 = "taskInintTime:" + (((acjm)localObject4).jdField_c_of_type_Long - l3);
            if (((acjm)localObject4).jdField_c_of_type_Long > l3) {
              break label3237;
            }
            bool = true;
            bjmd.a((String)localObject5, bool);
            localObject5 = "taskStopTime:" + (((acjm)localObject4).jdField_d_of_type_Long - l3);
            if (((acjm)localObject4).jdField_d_of_type_Long < l3) {
              break label3243;
            }
            bool = true;
            bjmd.a((String)localObject5, bool);
            ...
            label3052:
            bjmd.a((String)localObject5, bool);
            if (((acjm)localObject4).jdField_b_of_type_Long <= l3) {
              break label3279;
            }
            ...
            bool = true;
            bjmd.a(bool);
            localObject5 = "next:" + l1 + " start:" + (((acjm)localObject4).jdField_b_of_type_Long - l3);
            if (l1 > ((acjm)localObject4).jdField_b_of_type_Long - l3) {
              break label3273;
            }
            bool = true;
            label3175:
          ...
          do
          {
            ...
            bool = false;
            break label3175;
            localObject5 = "nextWake:" + l1 + " stop:" + (((acjm)localObject4).jdField_d_of_type_Long - l3);
            if (l1 > ((acjm)localObject4).jdField_d_of_type_Long - l3) {
              break label3600;
            }
            bool = true;
            bjmd.a((String)localObject5, bool);
            ...
            bool = true;
            bjmd.a((String)localObject5, bool);
            localObject5 = "reqTimeStamp:" + j + " stop:" + (((acjm)localObject4).jdField_d_of_type_Long - l3);
            if (j > ((acjm)localObject4).jdField_d_of_type_Long - l3) {
              break label3612;
            }
            bool = true;
            bjmd.a((String)localObject5, bool);
            localObject5 = "reqCpu:" + i + " task:" + ((acjm)localObject4).jdField_c_of_type_Int;
            if (i > ((acjm)localObject4).jdField_c_of_type_Int) {
              break label3618;
            }
            bool = true;
            bjmd.a((String)localObject5, bool);
            localObject5 = "reqIO:" + m + " task:" + ((acjm)localObject4).jdField_d_of_type_Int;
            if (m > ((acjm)localObject4).jdField_d_of_type_Int) {
              break label3624;
            }
            bool = true;
            bjmd.a((String)localObject5, bool);
          } while (((acjm)localObject4).jdField_e_of_type_Int <= 0);
          label3444:
          bjmd.a(localHashSet1.contains(localObject4));
          label3554:
  ...
  {
    acjm localacjm = (acjm)jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool.obtain(acjm.class);
    localacjm.jdField_a_of_type_Int = paramInt1;
    localacjm.jdField_c_of_type_Int = paramInt2;
    localacjm.jdField_d_of_type_Int = paramInt3;
    localacjm.jdField_e_of_type_Int = paramInt4;
    localacjm.jdField_b_of_type_Int = paramInt5;
    localacjm.jdField_f_of_type_Int = paramInt6;
    localacjm.jdField_a_of_type_Long = paramLong;
    localacjm.jdField_g_of_type_Int = paramInt7;
    localacjm.jdField_c_of_type_Long = System.currentTimeMillis();
    localacjm.jdField_b_of_type_Long = (localacjm.jdField_c_of_type_Long + paramInt1);
    localacjm.jdField_d_of_type_Long = (localacjm.jdField_c_of_type_Long + paramInt1 + paramInt5);
    localacjm.jdField_a_of_type_JavaLangString = paramString;
    localacjm.jdField_e_of_type_Long = localacjm.jdField_b_of_type_Long;
    localacjm.jdField_f_of_type_Long = localacjm.jdField_c_of_type_Long;
    if ((paramInt1 < 0) || (paramInt2 < 0) || (paramInt3 < 0) || (paramInt4 < 0) || (paramInt5 <= 0) || ((paramInt2 == 0) && (paramInt3 == 0) && (paramInt4 == 0)))
    {
      Log.e("HardCoder.HCPerfManager", "ErrorParam task:" + localacjm.a(localacjm.jdField_c_of_type_Long));
      return 0;
    }
    boolean bool = this.jdField_a_of_type_JavaUtilConcurrentLinkedBlockingQueue.offer(localacjm);
    if (HardCoderJNI.hcDebug) {
      Log.d("HardCoder.HCPerfManager", "OutCallAddTask ret:" + bool + " task:" + localacjm.a(localacjm.jdField_c_of_type_Long));
    }
    if (bool) {
      return localacjm.hashCode();
    }
    return 0;
  }
  ...
  {
    acjn localacjn = (acjn)jdField_b_of_type_ComTencentCommonsdkPoolRecyclablePool.obtain(acjn.class);
    localacjn.jdField_a_of_type_Long = System.currentTimeMillis();
    localacjn.jdField_a_of_type_Int = paramInt;
    if (paramInt != 0) {}
    for (boolean bool = this.jdField_a_of_type_JavaUtilConcurrentLinkedBlockingQueue.offer(localacjn);; bool = false)
    {
      if (HardCoderJNI.hcDebug) {
