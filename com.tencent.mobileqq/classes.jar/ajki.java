...
public class ajki
{
  ...
  public static int a(int paramInt, String paramString)
  {
    ...
    paramString = new File(ajms.g, paramInt + "/" + paramString + "/");
    ...
    for (;;)
    {
      ...
      int i = ascl.a(localObject.length);
      ...
      try
      {
        ...
        if (paramInt >= ajms.jdField_a_of_type_Int) {
          if (!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/action/" + ajms.R)) {
            continue;
          }
        }
        for (;;)
        {
          return j;
          if ((!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/" + ajms.x)) || (!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/" + ajms.w)) || (!ApolloUtil.c(paramString.getAbsolutePath() + "/" + (String)localObject + "/" + ajms.y))) {
            break;
          }
          if (QLog.isColorLevel()) {
  ...
  public static int a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    paramString = ((airx)paramQQAppInterface.getManager(153)).a(paramString);
    if (paramString == null)
    {
      if (QLog.isColorLevel()) {
  ...
  public static String a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      localStringBuilder.append(ajms.F);
      localStringBuilder.append("/");
      localStringBuilder.append(paramInt2);
      localStringBuilder.append("/dress");
      return localStringBuilder.toString();
  ...
  public static String a(String paramString)
  {
    ...
    int i = ascl.a(paramString.countTokens());
  ...
  public static String a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (airx.a(paramQQAppInterface, paramString) == 2) {
      return "3D";
    }
    return "2D";
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, SpriteTaskParam paramSpriteTaskParam, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      localObject = ((ajmu)paramQQAppInterface.getManager(155)).a(paramSpriteTaskParam.f);
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    while (i < j)
    {
      ...
      localObject = new File(ajms.c + (String)localObject);
      if (!((File)localObject).exists())
      {
        QLog.d("ApolloActionHelper", 1, new Object[] { "[checkBasicActionExit] rsc file not exist:", ((File)localObject).toString() });
        ajhu.a(paramQQAppInterface, paramQQAppInterface.c(), null, 0, null, -1, -1, true);
        return false;
      }
      i += 1;
    }
  ...
  public static boolean a(String paramString, int paramInt, int[] paramArrayOfInt, QQAppInterface paramQQAppInterface, ajic paramajic)
  {
    if (QLog.isColorLevel()) {
      ...
      for (;;)
      {
        ...
        if (!bool)
        {
          ...
          if (paramQQAppInterface != null)
          {
            ...
            paramajic = ((airx)paramQQAppInterface.getManager(153)).a();
          }
        }
        for (;;)
        {
          ajhu.a(paramQQAppInterface, paramString, paramajic, paramInt, paramArrayOfInt, -1, -1, false);
          if (QLog.isColorLevel()) {
  ...
  public static boolean a(String paramString, QQAppInterface paramQQAppInterface, JSONObject paramJSONObject)
  {
    ...
    ApolloBaseInfo localApolloBaseInfo = ((airx)paramQQAppInterface.getManager(153)).b(paramString);
  ...
  public static Object[] a(String paramString, int paramInt, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    Object localObject = ((airx)paramQQAppInterface.getManager(153)).b(paramString);
    if (localObject != null)
    {
      localObject = ((ApolloBaseInfo)localObject).getApolloDress3D();
      if (localObject != null)
      {
        paramInt = ((aiwl)localObject).jdField_a_of_type_Int;
        localObject = ((aiwl)localObject).a();
        if ((paramInt > ajms.jdField_a_of_type_Int) && (localObject != null) && (localObject.length > 0) && ((!paramBoolean) || (a(paramString, paramInt, (int[])localObject, paramQQAppInterface))))
        {
          if (QLog.isColorLevel()) {
  ...
  public static Object[] a(String paramString, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    Object localObject2 = ((airx)paramQQAppInterface.getManager(153)).b(paramString);
    aiwl[] arrayOfaiwl;
    if (localObject2 != null)
    {
      ...
      if (!airx.a((ApolloBaseInfo)localObject2)) {
      ...
      if ((paramBoolean) && (((ApolloBaseInfo)localObject2).apolloLocalTS != ((ApolloBaseInfo)localObject2).apolloServerTS))
      {
        ...
        airx.a(paramQQAppInterface, paramString, "getRoleDressIdByUin");
      }
      arrayOfaiwl = ((ApolloBaseInfo)localObject2).getApolloDress(false);
      if ((arrayOfaiwl != null) && (arrayOfaiwl.length > 0))
      {
        j = arrayOfaiwl.length;
        i = 0;
        label439:
        if (i >= j) {
          break label749;
        }
        aiwl localaiwl = arrayOfaiwl[i];
        localObject2 = localaiwl.a();
        if (a(paramString, localaiwl.jdField_a_of_type_Int, (int[])localObject2, paramQQAppInterface))
        {
          if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      if (j == 0)
      {
        localObject2 = ajhu.a(arrayOfaiwl[0].jdField_a_of_type_Int);
        if (a(paramString, arrayOfaiwl[0].jdField_a_of_type_Int, (int[])localObject2, paramQQAppInterface))
        {
          if (QLog.isColorLevel()) {
            QLog.d("ApolloActionHelper", 2, "valid basic dress.");
          }
          j = arrayOfaiwl[0].jdField_a_of_type_Int;
          paramString = (String)localObject2;
          i = j;
          if (QLog.isColorLevel())
          {
      ...
      for (paramString = (String)localObject2;; paramString = (String)localObject1)
      {
        ...
        i += 1;
        break label439;
        ajfh.a(110, new Object[] { "basicDresses is not vaild" });
      }
      if (QLog.isColorLevel()) {
  ...
  public static String[] a(int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4)
  {
    ...
    if (paramInt4 == 2)
    {
      ...
      default: 
        ...
        if ((paramBoolean) || (paramInt2 < 21)) {
          if (localStringBuilder.indexOf(ajms.u) > -1) {
            localStringBuilder.append("/action");
          }
        }
        break;
    ...
    for (;;)
    {
      ...
      if (paramInt4 != 0)
      {
        localStringBuilder.append(ajms.u);
        paramInt3 = 1;
        paramInt4 = paramInt2;
        break label177;
      }
      ...
      break label177;
      if (paramInt4 != 0) {
        localStringBuilder.append(ajms.u).append(ajms.G);
      }
      for (;;)
      {
        paramInt3 = 1;
        paramInt4 = 1;
        break;
        localStringBuilder.append("def/basic/").append(ajms.G);
      }
      localStringBuilder.append(ajms.u).append(ajms.G);
      paramInt3 = 1;
      paramInt4 = 1;
      break label177;
      int i = a(paramInt3, ajms.G);
      if (-1 != i)
      {
        localStringBuilder.append("role/");
        localStringBuilder.append(paramInt3).append("/").append(ajms.G);
        paramInt4 = i;
        paramInt3 = 1;
        break label177;
      }
      ...
      if (paramInt4 != 0)
      {
        localStringBuilder.append(ajms.u).append(ajms.I);
        paramInt3 = 1;
        paramInt4 = paramInt2;
        break label177;
      }
      localStringBuilder.append("def/role/").append(0).append("/").append(ajms.I);
      paramInt3 = 1;
      paramInt4 = paramInt2;
      break label177;
      if (paramInt4 != 0)
      {
        localStringBuilder.append(ajms.u).append(ajms.K);
        paramInt3 = 1;
        paramInt4 = paramInt2;
        break label177;
      }
      localStringBuilder.append("def/role/").append(0).append("/").append(ajms.K);
      paramInt3 = 1;
      paramInt4 = paramInt2;
      break label177;
      i = a(paramInt3, ajms.H);
      if (-1 != i)
      {
        localStringBuilder.append("role/");
        localStringBuilder.append(paramInt3).append("/").append(ajms.H);
        paramInt4 = i;
        paramInt3 = 1;
        break label177;
      }
  ...
  public static String b(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    paramString = ((airx)paramQQAppInterface.getManager(153)).b(paramString);
    if (paramString != null)
    {
