...
public final class ayoq
{
  ...
  public ayoq(cmd0x383.ApplyGetFileListRspBody.FileInfo paramFileInfo)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public ayoq(group_file_common.FolderInfo paramFolderInfo)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public ayoq(oidb_0x6d8.GetFileListRspBody.Item paramItem)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  {
    String str = baiu.b(paramContext, paramLong);
    paramContext = str;
    int i1;
    int i2;
    if (str != null)
    ...
    for (;;)
    {
      ...
      try
      {
        if (this.n == null)
        {
          ...
          if (i1 != 0)
          {
            this.n = babh.a(paramQQAppInterface, b(), paramLong + "", 1, 0);
            if (this.n.length() <= 10)
            {
              i1 = i5;
              break label307;
  ...
  public String a()
  {
    return azjg.a(this.jdField_a_of_type_Long);
  }
  
  public String a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    return babh.a(paramQQAppInterface, b(), paramLong + "", 1, 0);
  }
  ...
  public void a(ayoq paramayoq)
  {
    if (paramayoq != null)
    {
      if ((paramayoq.jdField_e_of_type_Int != 8) && (paramayoq.jdField_e_of_type_Int != 9)) {
        break label45;
      }
      if (paramayoq.jdField_b_of_type_JavaLangString != null) {
        this.jdField_a_of_type_JavaUtilMap.put(paramayoq.jdField_b_of_type_JavaLangString, paramayoq);
      }
    }
    label45:
    while (((paramayoq.jdField_e_of_type_Int != 11) && (paramayoq.jdField_e_of_type_Int != 10) && (paramayoq.jdField_e_of_type_Int != 12)) || (paramayoq.jdField_b_of_type_JavaLangString == null)) {
      return;
    }
    this.jdField_a_of_type_JavaUtilMap.remove(paramayoq.jdField_b_of_type_JavaLangString);
  }
  
  public void a(ayqd paramayqd, QQAppInterface paramQQAppInterface)
  {
    this.jdField_i_of_type_JavaLangString = paramayqd.jdField_b_of_type_JavaLangString;
    this.j = paramayqd.jdField_c_of_type_JavaLangString;
    this.k = paramayqd.jdField_d_of_type_JavaLangString;
    this.jdField_e_of_type_Int = paramayqd.jdField_b_of_type_Int;
    this.jdField_h_of_type_JavaLangString = paramayqd.jdField_a_of_type_JavaLangString;
    this.jdField_d_of_type_Long = paramayqd.jdField_d_of_type_Long;
    this.jdField_f_of_type_Int = paramayqd.jdField_c_of_type_Int;
    this.jdField_c_of_type_Boolean = paramayqd.jdField_a_of_type_Boolean;
    if (this.jdField_b_of_type_Int == 0)
    {
      this.jdField_b_of_type_Int = paramayqd.jdField_d_of_type_Int;
      this.l = a(BaseApplicationImpl.getApplication(), this.jdField_b_of_type_Int * 1000L);
    }
    if (this.jdField_b_of_type_JavaLangString == null) {
      this.jdField_b_of_type_JavaLangString = paramayqd.jdField_e_of_type_JavaLangString;
    }
    if (this.jdField_f_of_type_JavaLangString == null) {
      this.jdField_f_of_type_JavaLangString = paramayqd.jdField_i_of_type_JavaLangString;
    }
    if (this.jdField_a_of_type_Long == 0L) {
      this.jdField_a_of_type_Long = paramayqd.jdField_c_of_type_Long;
    }
    if (this.jdField_c_of_type_JavaLangString == null) {
      this.jdField_c_of_type_JavaLangString = paramayqd.jdField_g_of_type_JavaLangString;
    }
    if ((this.jdField_a_of_type_Int == 0) || (ayor.a(paramayqd.jdField_b_of_type_Int))) {
      this.jdField_a_of_type_Int = paramayqd.jdField_h_of_type_Int;
    }
    if ((this.jdField_b_of_type_Long == 0L) && (ayor.a(paramayqd.jdField_b_of_type_Int))) {}
    try
    {
      this.jdField_b_of_type_Long = Long.parseLong(paramQQAppInterface.getCurrentAccountUin());
      return;
    }
    catch (NumberFormatException paramayqd)
    {
  ...
  {
    return (azjg.a(paramQQAppInterface, paramLong)) && (this.jdField_d_of_type_Boolean);
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean)
  {
    ...
    boolean bool2 = azjg.a(paramQQAppInterface, paramLong);
  ...
  public void b(ayoq paramayoq)
  {
    ...
    this.jdField_b_of_type_Boolean = false;
    this.jdField_b_of_type_JavaLangString = paramayoq.jdField_b_of_type_JavaLangString;
    this.jdField_f_of_type_JavaLangString = paramayoq.jdField_f_of_type_JavaLangString;
    this.jdField_c_of_type_JavaLangString = paramayoq.jdField_c_of_type_JavaLangString;
    this.jdField_a_of_type_Int = paramayoq.jdField_a_of_type_Int;
    this.jdField_b_of_type_Long = paramayoq.jdField_b_of_type_Long;
    this.jdField_c_of_type_Long = paramayoq.jdField_c_of_type_Long;
    this.jdField_a_of_type_Long = paramayoq.jdField_a_of_type_Long;
    this.jdField_b_of_type_Int = paramayoq.jdField_b_of_type_Int;
    this.jdField_c_of_type_Int = paramayoq.jdField_c_of_type_Int;
    this.jdField_i_of_type_Int = paramayoq.jdField_i_of_type_Int;
    this.jdField_d_of_type_Int = paramayoq.jdField_d_of_type_Int;
    this.jdField_e_of_type_JavaLangString = paramayoq.jdField_e_of_type_JavaLangString;
    this.jdField_h_of_type_Int = paramayoq.jdField_h_of_type_Int;
    this.jdField_d_of_type_JavaLangString = paramayoq.jdField_d_of_type_JavaLangString;
    this.jdField_d_of_type_Boolean = paramayoq.jdField_d_of_type_Boolean;
    this.l = paramayoq.l;
    this.m = paramayoq.m;
  }
  ...
  {
    return (azjg.a(paramQQAppInterface, paramLong)) && (!this.jdField_d_of_type_Boolean) && (!paramBoolean) && (!ayor.a(this.jdField_e_of_type_Int)) && (!ayor.b(this.jdField_e_of_type_Int));
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject == null) || (!(paramObject instanceof ayoq))) {
      return false;
    }
    paramObject = (ayoq)paramObject;
