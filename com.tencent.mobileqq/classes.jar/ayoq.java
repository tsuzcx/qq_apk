  ...
  extends aypg
{
  ...
  public ayoq(ayoz paramayoz, aywc paramaywc, String paramString)
  {
    super(paramayoz, paramaywc);
    this.jdField_c_of_type_Long = 0L;
    this.jdField_d_of_type_Long = 0L;
    this.jdField_a_of_type_Vjx = vjx.a();
    this.m = paramString;
  }
  ...
  public int a()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ArtFilterUploadProcessor", 2, "cancelTask taskId:" + this.jdField_c_of_type_Int + " mRichProtoReq:" + this.jdField_a_of_type_Ayyp + " mTrans:" + this.jdField_b_of_type_ComTencentMobileqqHighwayTransactionTransaction + " mNetReq:" + this.jdField_a_of_type_Aysy);
    }
  ...
  public void a()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localayyp.jdField_a_of_type_JavaLangString = "art_filter_up";
      ...
      if (QLog.isColorLevel()) {
        QLog.d("ArtFilterUploadProcessor", 2, "sendTransferRequest:" + localayyp);
      }
  ...
  public void a(int paramInt1, int paramInt2, String paramString, int paramInt3, vjz paramvjz, boolean paramBoolean)
  {
    this.x = paramInt1;
    this.jdField_b_of_type_Int = paramInt2;
    this.jdField_b_of_type_JavaLangString = paramString;
    this.jdField_c_of_type_Int = paramInt3;
    this.jdField_a_of_type_Vjz = paramvjz;
    this.jdField_b_of_type_Boolean = paramBoolean;
    if (QLog.isColorLevel()) {
      QLog.d("ArtFilterUploadProcessor", 2, "FilterUploadInfo:" + paramvjz);
    }
    if (paramvjz == null) {
      return;
    }
    this.jdField_q_of_type_Long = paramvjz.jdField_a_of_type_Long;
    this.jdField_a_of_type_ArrayOfByte = paramvjz.jdField_a_of_type_ArrayOfByte;
    this.jdField_d_of_type_JavaLangString = paramvjz.jdField_b_of_type_JavaLangString;
    this.jdField_a_of_type_JavaLangString = (EditVideoArtFilter.jdField_a_of_type_JavaLangString + paramvjz.jdField_b_of_type_Long + "_" + paramInt2 + ".png");
    this.jdField_q_of_type_Int = paramvjz.jdField_a_of_type_Int;
    this.p = paramvjz.jdField_b_of_type_Int;
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 0)
    {
      ...
      ((Bundle)localObject).putString("param_art_filter_resource_path", this.jdField_a_of_type_Vjz.jdField_a_of_type_JavaLangString);
      ...
      this.jdField_a_of_type_Vjx.callbackResult(this.x, EIPCResult.createSuccessResult((Bundle)localObject));
      this.jdField_a_of_type_Vjx.jdField_a_of_type_AndroidUtilSparseArray.remove(this.jdField_b_of_type_Int);
    ...
    label604:
    axrn.a(BaseApplication.getContext()).a(null, "afCosttimeAndFlowReport", bool, this.j - this.i, this.jdField_q_of_type_Long, this.jdField_a_of_type_JavaUtilHashMap, "");
  }
  ...
  public void a(ayyp paramayyp, ayze paramayze)
  {
    ...
    } while (paramayze == null);
    int k = 0;
    label26:
    if (k < paramayze.jdField_a_of_type_JavaUtilList.size())
    {
      paramayyp = (ayzg)paramayze.jdField_a_of_type_JavaUtilList.get(k);
      if (QLog.isColorLevel()) {
        QLog.d("ArtFilterUploadProcessor", 2, "getTransferResp:" + paramayyp);
      }
      if (paramayyp.jdField_c_of_type_Int != 0) {
        break label142;
      }
      this.m = paramayyp.jdField_c_of_type_JavaLangString;
      if (this.jdField_a_of_type_Vjx.jdField_b_of_type_JavaLangString.equals(this.jdField_a_of_type_Vjz.jdField_a_of_type_JavaLangString))
      {
        this.jdField_a_of_type_Vjx.jdField_a_of_type_JavaLangString = paramayyp.jdField_c_of_type_JavaLangString;
        aP_();
      }
    }
    for (;;)
    {
      ...
      break;
      label142:
      a(paramayyp.jdField_c_of_type_Int, "getTransferError");
    }
  }
  ...
  void aQ_()
  {
    ...
    Object localObject1 = new ayos(this);
    ...
    localFilterStyle.style_name.set(ByteStringMicro.copyFrom(bbea.a(this.jdField_b_of_type_JavaLangString)));
  ...
  public void b(String paramString)
  {
    ...
    localayrx.jdField_c_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
    localayrx.e = 0;
    localayrx.jdField_a_of_type_Aysb = jdField_a_of_type_Aysb;
    if (QLog.isColorLevel()) {
      QLog.d("ArtFilterUploadProcessor", 2, "sendDownLoadRequest req:" + localayrx);
    }
  ...
  public void onResp(aysz paramaysz)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ArtFilterUploadProcessor", 2, "getDownLoadResponse: " + paramaysz);
    }
    this.jdField_a_of_type_JavaUtilHashMap.put("downloadFileSize", String.valueOf(paramaysz.jdField_a_of_type_Long));
    ...
    if (paramaysz.jdField_a_of_type_JavaLangString != null) {
      QLog.d("ArtFilterUploadProcessor", 1, "download dailed, mErrCode" + paramaysz.jdField_b_of_type_Int + "mErrDesc:" + paramaysz.jdField_a_of_type_JavaLangString);
    }
    a(paramaysz.jdField_b_of_type_Int, paramaysz.jdField_a_of_type_JavaLangString);
  }
}
