...
public class moj
{
      ...
      do
      {
        ...
        if (j == -2)
        {
          ...
          if ((!this.jdField_c_of_type_Boolean) && ((this.jdField_b_of_type_Boolean) || (this.jdField_d_of_type_Boolean)))
          {
            ...
            if (this.jdField_a_of_type_Moo.a != null) {
              this.jdField_a_of_type_Moo.a.j();
            }
          }
  ...
  public void a(bbmc parambbmc)
  {
    ...
    Object localObject = MediaFormat.createVideoFormat("video/avc", parambbmc.jdField_a_of_type_Int, parambbmc.jdField_b_of_type_Int);
    ((MediaFormat)localObject).setInteger("color-format", 2130708361);
    ((MediaFormat)localObject).setInteger("bitrate", parambbmc.c);
    ((MediaFormat)localObject).setInteger("frame-rate", parambbmc.d);
    ((MediaFormat)localObject).setInteger("i-frame-interval", parambbmc.e);
    if (QLog.isColorLevel()) {
    ...
    localObject = new File(parambbmc.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
      QLog.i("QavRecordEncoder", 2, "start, before check file, exits[" + ((File)localObject).exists() + "]");
    }
    if (!((File)localObject).exists()) {
      bhmi.c(((File)localObject).getAbsolutePath());
    }
    if (QLog.isColorLevel()) {
  ...
  protected void a(moa parammoa, boolean paramBoolean)
  {
    if (AudioHelper.f()) {
      QLog.w("QavRecordEncoder", 1, "handleAudioFrame, frame[" + parammoa + "], endOfStream[" + paramBoolean + "], mNoAudio[" + this.jdField_d_of_type_Boolean + "]");
    }
    if (this.jdField_d_of_type_Boolean) {
      return;
    }
    this.jdField_a_of_type_JavaNioByteBuffer.clear();
    this.jdField_a_of_type_JavaNioByteBuffer.put(parammoa.a);
    this.jdField_a_of_type_JavaNioByteBuffer.position(parammoa.a.length);
    ...
    if (j >= 0)
    {
      ...
      this.jdField_b_of_type_AndroidMediaMediaCodec.queueInputBuffer(j, 0, parammoa.a.length, parammoa.jdField_b_of_type_Long, 0);
      if (QLog.isColorLevel()) {
        QLog.d("QavRecordEncoder", 2, "encode, write to codec, size=" + parammoa.a.length);
      }
      label217:
      parammoa = this.jdField_b_of_type_AndroidMediaMediaCodec.getOutputBuffers();
      i = 0;
    }
    for (;;)
    {
  ...
  public void a(byte[] paramArrayOfByte, long paramLong)
  {
    ...
    paramArrayOfByte = new moa(paramArrayOfByte, l);
  ...
  public void b()
  {
    ...
    long l = this.jdField_a_of_type_Long;
    this.jdField_a_of_type_Long = (1L + l);
    moa localmoa = new moa(new byte[0], l);
    localmoa.jdField_b_of_type_Long = this.jdField_b_of_type_Long;
    a(localmoa, true);
    a(true);
    c();
    if (this.jdField_a_of_type_JavaNioByteBuffer != null)
