...
public class moj
{
  ...
  ljj jdField_a_of_type_Ljj = null;
  ljp jdField_a_of_type_Ljp = null;
  
  public moj(VideoAppInterface paramVideoAppInterface, Context paramContext)
  {
  ...
  private boolean a(long paramLong, ViewGroup paramViewGroup)
  {
    ...
    {
      this.jdField_a_of_type_Ljj.b();
      ljm localljm = this.jdField_a_of_type_Ljj.a();
      if (localljm != null) {
        paramViewGroup.removeView((View)localljm);
      }
  ...
  {
    this.jdField_a_of_type_Ljj = null;
    this.jdField_a_of_type_Ljj = ljn.a(paramLong, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_AndroidContentContext, paramString);
    ...
    int i = this.jdField_a_of_type_Ljj.a();
    String str = this.jdField_a_of_type_Ljj.c();
    ...
    this.jdField_a_of_type_Ljj.a(paramString);
    paramViewGroup.addView(paramString);
    this.jdField_a_of_type_Ljj.a();
    return true;
  }
  ...
  {
    float f2 = 0.0F;
    this.jdField_a_of_type_ComTencentAvUiFunchatZimuZimuView = mog.a(paramLong, this.jdField_a_of_type_ComTencentAvAppVideoAppInterface, this.jdField_a_of_type_AndroidContentContext, paramString);
    float f1;
  ...
  public ZimuItem a()
  {
    ...
    {
      a();
      return (ZimuItem)this.jdField_a_of_type_Ljp.a();
    }
    return null;
  }
  ...
  public ljp a()
  {
    ...
    return this.jdField_a_of_type_Ljp;
  }
      ...
      if (localObject != null)
      {
        ...
        if (localObject != null)
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject)) {
            new mcl(AudioHelper.b(), "maybeShowZimu", 1, (String)localObject).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
          }
        }
      }
    }
  ...
  public void a(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Ljj != null)
    {
      this.jdField_a_of_type_Ljp.a(paramLong, null);
      this.jdField_a_of_type_Ljp.a("DisableARZimu", paramLong);
      this.jdField_a_of_type_Ljj.b();
      this.jdField_a_of_type_Ljj = null;
    }
  }
  ...
  public void a(VideoLayerUI paramVideoLayerUI, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvUiFunchatZimuZimuView != null)
    {
      ...
      f = paramVideoLayerUI.c() - miu.b(paramVideoLayerUI.b());
  ...
  {
    if (this.jdField_a_of_type_ComTencentAvUiFunchatZimuZimuView != null) {
      this.jdField_a_of_type_ComTencentAvUiFunchatZimuZimuView.a(paramlhc);
    }
    while (this.jdField_a_of_type_Ljj == null) {
      return;
    }
    this.jdField_a_of_type_Ljj.a(paramlhc);
  }
  ...
  public void a(boolean paramBoolean)
  {
    a();
    ljo.a(paramBoolean);
    this.jdField_a_of_type_Ljp.a(paramBoolean);
  }
  ...
  public boolean a(ViewGroup paramViewGroup, long paramLong)
  {
    ...
    a(paramLong, paramViewGroup);
    this.jdField_a_of_type_Ljp.a(paramLong, null);
    this.jdField_a_of_type_Ljp.a("stopZimuView", paramLong);
    return true;
  }
