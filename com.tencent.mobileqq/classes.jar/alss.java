...
public class alss
  extends anxg
{
  public alss(SelectMemberActivity paramSelectMemberActivity) {}
    ...
    if (paramInt1 == 8)
    {
      if (paramInt2 == 0)
      {
        ...
        if (!this.a.jdField_c_of_type_Boolean)
        {
          ...
          bcst.b(this.a.app, "CliOper", "", "", "Grp", "Send_invite", 0, 0, "", "", "", "");
        }
  ...
  protected void a(boolean paramBoolean, long paramLong1, long paramLong2)
  {
    ...
    if ((paramBoolean) && (str.equals(this.a.jdField_c_of_type_JavaLangString)))
    {
      ...
      if ((this.a.i >= this.a.jdField_a_of_type_Long) && (this.a.jdField_a_of_type_Long > 0L))
      {
        ...
        bcst.b(this.a.app, "dc00899", "invite_friend", "", "friend_list", "exp_needagree", 0, 0, str, muc.a(this.a.app, this.a.app.getCurrentAccountUin(), str) + "", "", "");
      }
    }
  }
