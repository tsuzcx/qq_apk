  ...
  extends anud
{
  ...
  aoie(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    paramString = bhmi.a(paramString);
  ...
  public static void a(int paramInt1, int paramInt2, String paramString, int paramInt3, BaseActivity paramBaseActivity)
  {
    ...
    Object localObject1 = bhyk.a(paramBaseActivity, "theme", "mvip.gongneng.android.theme.index_dynamic_tab");
  ...
  private void a(int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3, ThemeAuth.DiyThemeDetail paramDiyThemeDetail)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramString1))
      {
        ...
        if (paramInt1 == 2) {
          aggu.a(localMobileQQ, this.app.getAccount(), null, str2);
        }
      }
  ...
  private void a(int paramInt, String paramString1, String paramString2, ThemeAuth.SubCmd0x1RspAuth paramSubCmd0x1RspAuth)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      try
      {
        paramString1 = new beio().a(paramString1).a(this.mApp.getApplication());
        bhmi.a(paramString1, true);
    ...
    {
      if (bool) {
        bdll.b(null, "CliOper", "", "", "theme", "0X8007234", 0, 0, String.valueOf(i), "", "", "");
      }
      paramSubCmd0x1RspAuth = paramString2;
      if (TextUtils.isEmpty(paramString2)) {
        paramSubCmd0x1RspAuth = anzj.a(2131713714);
      }
      ...
      for (;;)
      {
        ...
        {
          aggu.a(this.mApp.getApplication(), this.app.getAccount(), null, "null");
  ...
  private void a(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      QLog.d("Theme.ThemeHandler", 1, "Theme Auth themeId=" + str1 + ",version=" + "20000000" + ", userThemeId=" + str3 + ",currentThemeResPath=" + str2 + ", usr=" + behh.a(this.mApp.getAccount(), 2) + ", oldTime=" + l1);
      if ("1000".equals(str1)) {
        break label967;
      }
    ...
    do
    {
      ...
      i = 1;
      beip.a(null, "theme_detail", "205", 157, j, i, str1, "20000000", "1", "");
      return;
      ...
      ((ThemeAuth.ReqBody)localObject3).str_qq_version.set("8.4.5.4745");
      ((ThemeAuth.ReqBody)localObject3).uint32_qq_version.set(Integer.parseInt("4745"));
    ...
    for (int i = 1;; i = -1)
    {
      beip.a(null, "theme_sp_speed", "204", 153, -1, i, String.valueOf(l2 - l1), "6653", "read", "");
      if ((paramBundle.isDirectory()) && (localObject1 != null))
      {
        ...
        beip.a(this.app, "theme_detail", "204", 157, bhnv.a(null), 101, str1, "665", String.valueOf(i), String.valueOf(((ThemeUtil.ThemeInfo)localObject1).fileNum));
        break;
        label967:
  ...
  private void a(ThemeAuth.RspBody paramRspBody)
  {
    ...
    if (i == 0)
    {
      ...
      bdll.b(this.app, "CliOper", "", "", "0X8005B9E", "0X8005B9E", 0, 0, "", "", "", "");
      localMessage = new Message();
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, ThemeAuth.RspBody paramRspBody, boolean paramBoolean)
  {
    ...
    for (paramToServiceMsg = paramToServiceMsg.str_diy_theme_err_msg.get();; paramToServiceMsg = str)
    {
      ...
      if ((this.jdField_a_of_type_Bejb != null) && (this.jdField_a_of_type_AndroidOsBundle != null)) {
        break;
      }
      QLog.e("Theme.ThemeHandler", 1, "handleThemeAuth Set result:null == service || null == reqbundle, result:" + i);
      this.jdField_a_of_type_AndroidOsBundle = null;
      this.jdField_a_of_type_Bejb = null;
      return true;
    ...
    if ((!TextUtils.isEmpty(paramRspBody)) && (paramRspBody.equals(this.jdField_a_of_type_AndroidOsBundle.getString("themeId"))))
    {
      if (QLog.isColorLevel()) {
        QLog.d("Theme.ThemeHandler", 2, "handleThemeAuth set back themeId=" + paramRspBody + ", result=" + i);
      }
      paramToServiceMsg = this.jdField_a_of_type_Bejb;
      if (i == 0)
      {
        i = 4;
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, ThemeAuth.SubCmd0x1RspAuth paramSubCmd0x1RspAuth, String paramString1, String paramString2)
  {
    ...
    int i = paramSubCmd0x1RspAuth.uint32_concise_id.get();
    int j = paramSubCmd0x1RspAuth.uint32_concise_switch.get();
    int k = paramSubCmd0x1RspAuth.int32_suit_id.get();
    if ((QLog.isColorLevel()) || ((paramString2 != null) && (!paramString1.equals(str2)))) {
      QLog.d("Theme.ThemeHandler", 2, "authHandler get themeId=" + str2 + ",ver=" + str1 + ",Url=" + str3 + ", seriesId=" + k + ", reqthemeId:" + paramString1 + ", reqVersion:" + paramString2 + ", sSimpleThemeId:" + i + ", sSimpleOpen:" + j);
    }
    boolean bool;
    if (j == 1)
    {
    ...
    for (paramString1 = "20000000";; paramString1 = str1)
    {
      ...
      if (k <= 0)
      {
        QLog.e("Theme.ThemeHandler", 1, "clear weekTheme because seriesId=" + k);
        ThemeUtil.setWeekLoopTheme(this.mApp, null, null, 0L);
      }
      if (k > 0)
      {
      ...
      {
        return false;
        if ((!"0".equals(str2)) && (!TextUtils.isEmpty(paramString1)) && (!this.c.get()))
        {
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    {
      if (!behm.a(paramString1, paramString2)) {
        a(paramString1, paramString2);
      }
      while (ThemeUtil.isFixTheme(paramString1)) {
        return;
      }
      beis.a(this.app, paramString1, "20000000");
      return;
    }
    a(paramString1, paramString2);
  }
  ...
  public void a()
  {
    ...
    else
    {
      ...
      QLog.d("Theme.ThemeHandler", 1, "sendThemeAuth init: , skThemeId:" + ((Bundle)localObject4).getString("themeId") + ", skVersion:" + ((Bundle)localObject4).getString("version") + ", qqVersion:" + "8.4.5");
      ...
      if (bdgb.a((String)localObject2))
      {
        localObject3 = beis.a(this.app).getString("themeID");
    ...
    for (;;)
    {
      ...
      ((Bundle)localObject4).putString("themePath", new beio().a().d());
    }
    label565:
    Object localObject2 = new beio().a((String)localObject3);
    ((VasQuickUpdateManager)this.app.getManager(184)).queryItemVersion(3, ((beio)localObject2).b(), true, false, 0L, new aoig(this, (beio)localObject2, localMobileQQ, (Bundle)localObject4));
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      return;
      label110:
      ThemeSwitcher.a(paramString1, paramString2, new aoif(this));
    }
  }
  
  /* Error */
  public void a(String paramString1, String paramString2, String paramString3, Bundle paramBundle, bejb parambejb)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 7
    ...
    //   35: aload_2
    //   36: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   39: ldc_w 1156
    //   42: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   45: aload_3
    //   46: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   49: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   52: invokestatic 164	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   55: aload_1
    //   56: invokestatic 217	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   59: ifne +8 -> 67
    //   62: aload 4
    //   64: ifnonnull +13 -> 77
    //   67: ldc 136
    //   69: iconst_2
    //   70: ldc_w 1158
    //   73: invokestatic 379	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   76: return
    //   77: aload 4
    //   79: ldc_w 476
    //   82: aload_1
    //   83: invokevirtual 474	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   86: aload_0
    //   87: aload 5
    //   89: putfield 843	aoie:jdField_a_of_type_Bejb	Lbejb;
    //   92: aload_0
    //   93: aload 4
    //   95: putfield 845	aoie:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   98: new 853	com/tencent/pb/theme/ThemeAuth$SubCmd0x3ReqSet
    //   101: dup
    //   102: invokespecial 1159	com/tencent/pb/theme/ThemeAuth$SubCmd0x3ReqSet:<init>	()V
    //   105: astore_2
    //   106: aload_2
    //   107: getfield 855	com/tencent/pb/theme/ThemeAuth$SubCmd0x3ReqSet:uint32_theme_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   110: aload_1
    //   111: invokestatic 541	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   114: invokevirtual 532	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   117: aload_3
    //   118: invokestatic 217	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   121: istore 8
    //   123: iload 7
    //   125: istore 6
    //   127: iload 8
    //   129: ifne +9 -> 138
    //   132: aload_3
    //   133: invokestatic 541	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   136: istore 6
    //   138: aload_2
    //   139: getfield 1162	com/tencent/pb/theme/ThemeAuth$SubCmd0x3ReqSet:uint32_suit_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   142: iload 6
    //   144: invokevirtual 532	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   147: aload 4
    //   149: ldc_w 1164
    //   152: invokevirtual 1168	android/os/Bundle:getBundle	(Ljava/lang/String;)Landroid/os/Bundle;
    //   155: astore_1
    //   156: aload_1
    //   157: ifnull +9 -> 166
    //   160: aload 4
    //   162: aload_1
    //   163: invokevirtual 721	android/os/Bundle:putAll	(Landroid/os/Bundle;)V
    //   166: ldc_w 1170
    //   169: aload 4
    //   171: ldc_w 1172
    //   174: invokevirtual 520	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   177: invokevirtual 264	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   180: ifeq +277 -> 457
    //   183: new 1174	com/tencent/pb/theme/ThemeAuth$diyThemeInfo
    //   186: dup
    //   187: invokespecial 1175	com/tencent/pb/theme/ThemeAuth$diyThemeInfo:<init>	()V
    //   190: astore_1
    //   191: aload_1
    //   192: getfield 1176	com/tencent/pb/theme/ThemeAuth$diyThemeInfo:uin32_drawer_tab_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   195: aload 4
    //   197: ldc_w 1178
    //   200: invokevirtual 520	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   203: invokestatic 541	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   206: invokevirtual 532	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   209: aload_1
    //   210: getfield 1179	com/tencent/pb/theme/ThemeAuth$diyThemeInfo:uin32_message_tab_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   213: aload 4
    //   215: ldc_w 1181
    //   218: invokevirtual 520	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   221: invokestatic 541	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   224: invokevirtual 532	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   227: aload_1
    //   228: getfield 1182	com/tencent/pb/theme/ThemeAuth$diyThemeInfo:uin32_aio_tab_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   231: aload 4
    //   233: ldc_w 1184
    //   236: invokevirtual 520	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   239: invokestatic 541	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   242: invokevirtual 532	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   245: aload_1
    //   246: getfield 1187	com/tencent/pb/theme/ThemeAuth$diyThemeInfo:uin32_freind_tab_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   249: aload 4
    //   251: ldc_w 1189
    //   254: invokevirtual 520	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   257: invokestatic 541	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   260: invokevirtual 532	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   263: aload_1
    //   264: getfield 1192	com/tencent/pb/theme/ThemeAuth$diyThemeInfo:uin32_dynamics_tab_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   267: aload 4
    //   269: ldc_w 1194
    //   272: invokevirtual 520	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   275: invokestatic 541	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   278: invokevirtual 532	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   281: aload_2
    //   282: getfield 1198	com/tencent/pb/theme/ThemeAuth$SubCmd0x3ReqSet:diy_theme_info	Lcom/tencent/pb/theme/ThemeAuth$diyThemeInfo;
    //   285: aload_1
    //   286: invokevirtual 1199	com/tencent/pb/theme/ThemeAuth$diyThemeInfo:set	(Lcom/tencent/mobileqq/pb/MessageMicro;)V
    //   289: aload_2
    //   290: getfield 1200	com/tencent/pb/theme/ThemeAuth$SubCmd0x3ReqSet:uint32_diy_theme_flag	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   293: iconst_1
    //   294: invokevirtual 532	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    ...
    //   309: iconst_3
    //   310: invokevirtual 532	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   313: aload_1
    //   314: getfield 676	com/tencent/pb/theme/ThemeAuth$ReqBody:int32_plat_id	Lcom/tencent/mobileqq/pb/PBInt32Field;
    //   317: bipush 109
    //   319: invokevirtual 679	com/tencent/mobileqq/pb/PBInt32Field:set	(I)V
    //   322: aload_1
    //   323: getfield 682	com/tencent/pb/theme/ThemeAuth$ReqBody:str_qq_version	Lcom/tencent/mobileqq/pb/PBStringField;
    //   326: ldc_w 684
    //   329: invokevirtual 549	com/tencent/mobileqq/pb/PBStringField:set	(Ljava/lang/String;)V
    //   332: aload_1
    //   333: getfield 687	com/tencent/pb/theme/ThemeAuth$ReqBody:uint32_qq_version	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   336: ldc_w 689
    //   339: invokestatic 541	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   342: invokevirtual 532	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   345: aload_1
    //   346: getfield 851	com/tencent/pb/theme/ThemeAuth$ReqBody:msg_subcmd0x3_req_set	Lcom/tencent/pb/theme/ThemeAuth$SubCmd0x3ReqSet;
    //   349: aload_2
    //   350: invokevirtual 1201	com/tencent/pb/theme/ThemeAuth$SubCmd0x3ReqSet:set	(Lcom/tencent/mobileqq/pb/MessageMicro;)V
    //   353: aload_1
    //   354: iconst_1
    //   355: invokevirtual 698	com/tencent/pb/theme/ThemeAuth$ReqBody:setHasFlag	(Z)V
    //   358: new 35	com/tencent/qphone/base/remote/ToServiceMsg
    //   361: dup
    //   362: ldc_w 700
    //   365: aload_0
    //   366: getfield 57	aoie:mApp	Lcom/tencent/common/app/AppInterface;
    //   369: invokevirtual 703	com/tencent/common/app/AppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   372: ldc_w 705
    //   375: invokespecial 708	com/tencent/qphone/base/remote/ToServiceMsg:<init>	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   378: astore_2
    //   379: aload_2
    //   380: aload_1
    //   381: invokevirtual 711	com/tencent/pb/theme/ThemeAuth$ReqBody:toByteArray	()[B
    //   384: invokevirtual 715	com/tencent/qphone/base/remote/ToServiceMsg:putWupBuffer	([B)V
    //   387: aload_0
    //   388: aload_2
    //   389: invokespecial 727	anud:sendPbReq	(Lcom/tencent/qphone/base/remote/ToServiceMsg;)V
    //   392: invokestatic 134	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   395: ifeq -319 -> 76
    //   398: ldc 136
    //   400: iconst_2
    //   401: ldc_w 1203
    //   404: invokestatic 164	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   407: return
    //   408: astore_1
    //   409: ldc 136
    //   411: iconst_2
    ...
    //   425: aload_1
    //   426: invokevirtual 1206	java/lang/Exception:toString	()Ljava/lang/String;
    //   429: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   432: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   435: invokestatic 379	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   438: return
    //   439: astore_1
    //   440: ldc 136
    //   442: iconst_1
    //   443: ldc_w 1208
    //   446: aload_1
    //   447: invokestatic 1211	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   450: iload 7
    //   452: istore 6
    //   454: goto -316 -> 138
    //   457: aload_2
    //   458: getfield 1200	com/tencent/pb/theme/ThemeAuth$SubCmd0x3ReqSet:uint32_diy_theme_flag	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   461: iconst_0
    //   462: invokevirtual 532	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   465: goto -168 -> 297
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString1.str_qq_version.set("8.4.5.4745");
        paramString1.uint32_qq_version.set(Integer.parseInt("4745"));
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, com.tencent.qphone.base.remote.FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   0: ldc_w 705
    //   3: aload_2
    //   4: invokevirtual 1244	com/tencent/qphone/base/remote/FromServiceMsg:getServiceCmd	()Ljava/lang/String;
    //   7: invokevirtual 264	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   10: ifne +4 -> 14
    //   13: return
    //   14: invokestatic 134	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   17: ifeq +51 -> 68
    //   20: ldc 136
    //   22: iconst_2
    ...
    //   36: aload_2
    //   37: invokevirtual 1249	com/tencent/qphone/base/remote/FromServiceMsg:isSuccess	()Z
    //   40: invokevirtual 299	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   43: ldc_w 1251
    //   46: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   49: aload_3
    //   50: checkcast 1253	[B
    //   53: checkcast 1253	[B
    //   56: invokestatic 1258	bhvd:a	([B)Ljava/lang/String;
    ...
    //   65: invokestatic 164	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   68: new 782	com/tencent/pb/theme/ThemeAuth$RspBody
    //   71: dup
    //   72: invokespecial 1259	com/tencent/pb/theme/ThemeAuth$RspBody:<init>	()V
    //   75: astore 7
    //   77: aload_3
    //   78: ifnull +16 -> 94
    //   81: aload 7
    ...
    //   84: checkcast 1253	[B
    //   87: checkcast 1253	[B
    //   90: invokevirtual 1262	com/tencent/pb/theme/ThemeAuth$RspBody:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   93: pop
    //   94: aload 7
    //   96: getfield 1263	com/tencent/pb/theme/ThemeAuth$RspBody:uint32_sub_cmd	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   99: invokevirtual 1266	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   102: ifeq +601 -> 703
    //   105: aload 7
    //   107: getfield 1263	com/tencent/pb/theme/ThemeAuth$RspBody:uint32_sub_cmd	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   110: invokevirtual 53	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   113: istore 4
    //   115: aload_2
    //   116: invokevirtual 1249	com/tencent/qphone/base/remote/FromServiceMsg:isSuccess	()Z
    //   119: ifeq +590 -> 709
    //   122: aload_3
    //   123: ifnull +586 -> 709
    //   126: iconst_1
    ...
    //   139: aload_1
    //   140: iload 4
    //   142: invokespecial 1268	aoie:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;I)I
    //   145: istore 5
    //   147: ldc 136
    //   149: iconst_1
    //   150: new 138	java/lang/StringBuilder
    //   153: dup
    //   154: invokespecial 139	java/lang/StringBuilder:<init>	()V
    //   157: ldc_w 1270
    //   160: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   163: aload_3
    //   164: checkcast 1253	[B
    //   167: checkcast 1253	[B
    //   170: invokestatic 1258	bhvd:a	([B)Ljava/lang/String;
    ...
    //   182: iload 5
    //   184: invokevirtual 154	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   187: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   190: invokestatic 379	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   193: iconst_3
    //   194: iload 5
    ...
    //   205: aload 7
    //   207: getfield 1276	com/tencent/pb/theme/ThemeAuth$RspBody:msg_subcmd0x1_rsp_auth	Lcom/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth;
    //   210: invokevirtual 1277	com/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   213: checkcast 343	com/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth
    //   216: astore_2
    //   217: aload_2
    //   218: getfield 1278	com/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth:int32_result	Lcom/tencent/mobileqq/pb/PBInt32Field;
    //   221: invokevirtual 795	com/tencent/mobileqq/pb/PBInt32Field:get	()I
    //   224: istore 4
    ...
    //   250: pop
    //   251: aload_3
    //   252: getfield 693	com/tencent/pb/theme/ThemeAuth$ReqBody:msg_subcmd0x1_req_auth	Lcom/tencent/pb/theme/ThemeAuth$SubCmd0x1ReqAuth;
    //   255: invokevirtual 1279	com/tencent/pb/theme/ThemeAuth$SubCmd0x1ReqAuth:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   258: checkcast 524	com/tencent/pb/theme/ThemeAuth$SubCmd0x1ReqAuth
    //   261: astore 8
    //   263: aload 8
    //   265: getfield 535	com/tencent/pb/theme/ThemeAuth$SubCmd0x1ReqAuth:uint32_theme_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   268: invokevirtual 53	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   271: invokestatic 336	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   274: astore_3
    //   275: aload 8
    //   277: getfield 544	com/tencent/pb/theme/ThemeAuth$SubCmd0x1ReqAuth:str_theme_version	Lcom/tencent/mobileqq/pb/PBStringField;
    //   280: invokevirtual 274	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   283: astore 8
    //   285: iload 4
    //   287: ifeq +428 -> 715
    //   290: ldc 136
    //   292: iconst_1
    //   293: new 138	java/lang/StringBuilder
    //   296: dup
    //   297: invokespecial 139	java/lang/StringBuilder:<init>	()V
    //   300: ldc_w 1281
    //   303: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   306: iload 4
    //   308: invokevirtual 154	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   311: ldc_w 896
    //   314: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   317: aload_3
    //   318: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   321: ldc_w 898
    ...
    //   335: invokestatic 379	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   338: aload_0
    //   339: getfield 323	aoie:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   342: ldc_w 1283
    //   345: iload 4
    //   347: invokestatic 336	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   350: iload 4
    //   352: invokestatic 336	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   355: aconst_null
    //   356: fconst_0
    //   357: invokestatic 1288	biaa:a	(Lmqq/app/AppRuntime;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;F)V
    //   360: new 89	java/util/HashMap
    //   363: dup
    //   364: invokespecial 90	java/util/HashMap:<init>	()V
    //   367: astore 9
    //   369: aload 9
    //   371: ldc_w 478
    //   374: iload 4
    //   376: invokestatic 336	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   379: invokevirtual 168	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   382: pop
    //   383: invokestatic 558	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   386: invokestatic 1293	bdmc:a	(Landroid/content/Context;)Lbdmc;
    //   389: ldc_w 287
    //   392: ldc_w 1283
    //   395: iconst_0
    //   396: lconst_0
    ...
    //   402: ldc_w 287
    //   405: iconst_1
    //   406: invokevirtual 1298	bdmc:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   409: aload_0
    //   410: getfield 323	aoie:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   413: ldc_w 665
    //   416: ldc_w 741
    //   419: sipush 157
    //   422: aconst_null
    //   423: invokestatic 663	bhnv:a	(Landroid/content/Context;)I
    //   426: iconst_0
    //   427: iload 4
    //   429: isub
    //   430: aload_3
    ...
    //   433: ldc_w 402
    //   436: ldc_w 287
    //   439: invokestatic 672	beip:a	(Lmqq/app/AppRuntime;Ljava/lang/String;Ljava/lang/String;IIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   442: new 89	java/util/HashMap
    //   445: dup
    //   446: invokespecial 90	java/util/HashMap:<init>	()V
    //   449: astore 9
    //   451: aload 9
    //   453: ldc_w 1300
    //   456: aload_3
    //   457: invokevirtual 168	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   460: pop
    //   461: aload 9
    //   463: ldc_w 1302
    //   466: aload 8
    //   468: invokevirtual 168	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   471: pop
    //   472: aload 9
    //   474: ldc_w 1304
    //   477: iload 4
    //   479: invokestatic 336	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   482: invokevirtual 168	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   485: pop
    //   486: aload_0
    //   487: getfield 57	aoie:mApp	Lcom/tencent/common/app/AppInterface;
    //   490: invokevirtual 247	com/tencent/common/app/AppInterface:getApplication	()Lmqq/app/MobileQQ;
    //   493: invokestatic 1293	bdmc:a	(Landroid/content/Context;)Lbdmc;
    //   496: astore 10
    //   498: aload_0
    //   499: getfield 57	aoie:mApp	Lcom/tencent/common/app/AppInterface;
    //   502: invokevirtual 250	com/tencent/common/app/AppInterface:getAccount	()Ljava/lang/String;
    //   505: astore 11
    //   507: iload 4
    //   509: ifne +390 -> 899
    //   512: iconst_1
    ...
    //   528: ldc_w 287
    //   531: iconst_0
    //   532: invokevirtual 1298	bdmc:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   535: iload 4
    //   537: iconst_1
    ...
    //   561: aload_0
    //   562: getfield 57	aoie:mApp	Lcom/tencent/common/app/AppInterface;
    ...
    //   573: ldc_w 1308
    //   576: iload 4
    //   578: invokeinterface 1078 3 0
    //   583: invokeinterface 81 1 0
    //   588: pop
    //   589: aload_0
    //   590: getfield 57	aoie:mApp	Lcom/tencent/common/app/AppInterface;
    //   593: ldc_w 356
    //   596: ldc_w 338
    //   599: invokestatic 1311	com/tencent/mobileqq/theme/ThemeUtil:setCurrentThemeIdVersion	(Lmqq/app/AppRuntime;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Boolean;
    //   602: pop
    //   603: aload 7
    //   605: getfield 1276	com/tencent/pb/theme/ThemeAuth$RspBody:msg_subcmd0x1_rsp_auth	Lcom/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth;
    //   608: getfield 1314	com/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth:str_err_msg	Lcom/tencent/mobileqq/pb/PBStringField;
    //   611: invokevirtual 274	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   614: astore_1
    //   615: ldc 136
    //   617: iconst_1
    ...
    //   625: ldc_w 1316
    //   628: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   631: iload 4
    //   633: invokevirtual 154	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   636: ldc_w 896
    //   639: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   642: aload_3
    //   643: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   646: ldc_w 1318
    //   649: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   652: aload_1
    //   653: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   656: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    ...
    //   666: aload_1
    //   667: aload_2
    //   668: invokespecial 1320	aoie:a	(ILjava/lang/String;Ljava/lang/String;Lcom/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth;)V
    //   671: return
    //   672: astore_1
    //   673: ldc 136
    //   675: iconst_1
    ...
    //   689: aload_1
    //   690: invokevirtual 432	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   693: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   696: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   699: invokestatic 379	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   702: return
    //   703: iconst_m1
    //   704: istore 4
    //   706: goto -591 -> 115
    ...
    //   710: istore 6
    //   712: goto -583 -> 129
    //   715: invokestatic 134	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   718: ifeq -309 -> 409
    //   721: ldc 136
    //   723: iconst_2
    //   724: new 138	java/lang/StringBuilder
    //   727: dup
    //   728: invokespecial 139	java/lang/StringBuilder:<init>	()V
    //   731: ldc_w 1324
    //   734: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   737: iload 4
    //   739: invokevirtual 154	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   742: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   745: invokestatic 164	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   748: goto -339 -> 409
    //   751: astore 9
    //   753: ldc 136
    //   755: iconst_1
    ...
    //   769: aload 9
    //   771: invokevirtual 1206	java/lang/Exception:toString	()Ljava/lang/String;
    //   774: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   777: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   780: invokestatic 379	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   783: goto -248 -> 535
    //   786: iload 4
    //   788: ifne +16 -> 804
    //   791: aload_0
    ...
    //   794: aload_3
    //   795: aload 8
    //   797: invokespecial 1328	aoie:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth;Ljava/lang/String;Ljava/lang/String;)Z
    //   800: ifeq -787 -> 13
    //   803: return
    //   804: ldc 136
    //   806: iconst_1
    //   807: new 138	java/lang/StringBuilder
    //   810: dup
    //   811: invokespecial 139	java/lang/StringBuilder:<init>	()V
    //   814: ldc_w 1330
    //   817: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   820: iload 4
    //   822: invokevirtual 154	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   825: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   828: invokestatic 379	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   831: aload_0
    //   832: aconst_null
    //   833: aconst_null
    //   834: iconst_1
    //   835: invokevirtual 1006	aoie:a	(Ljava/lang/String;Ljava/lang/String;Z)V
    //   838: return
    //   839: iconst_2
    //   840: iload 5
    ...
    //   845: aload_0
    //   846: aload 7
    //   848: invokespecial 1332	aoie:a	(Lcom/tencent/pb/theme/ThemeAuth$RspBody;)V
    //   851: return
    //   852: iconst_3
    //   853: iload 5
    ...
    //   860: aload 7
    //   862: iload 6
    //   864: invokespecial 1334	aoie:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/pb/theme/ThemeAuth$RspBody;Z)Z
    //   867: ifeq -854 -> 13
    //   870: return
    //   871: ldc 136
    //   873: iconst_1
    //   874: new 138	java/lang/StringBuilder
    //   877: dup
    //   878: invokespecial 139	java/lang/StringBuilder:<init>	()V
    //   881: ldc_w 1336
    //   884: invokevirtual 145	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   887: iload 5
    //   889: invokevirtual 154	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   892: invokevirtual 160	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   895: invokestatic 379	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   898: return
    //   899: iconst_0
    //   900: istore 6
    //   902: goto -387 -> 515
