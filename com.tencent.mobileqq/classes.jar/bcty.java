...
public class bcty
{
  ...
  public static bcty a(oidb_0xe3b.RecommendPerson paramRecommendPerson)
  {
    int j = -1;
    bcty localbcty = new bcty();
    localbcty.jdField_a_of_type_JavaLangString = String.valueOf(paramRecommendPerson.uint64_uin.get());
    Object localObject;
    label74:
    int i;
    label98:
    ...
    for (paramRecommendPerson = localLabel.bytes_name.get().toStringUtf8();; paramRecommendPerson = "")
    {
      ...
      localbcty.jdField_a_of_type_JavaUtilArrayList.add(localRecommendLabel);
      break label173;
      localObject = "";
      break;
      localObject = "";
