  ...
  public void a(msg_comm.MsgType0x210 paramMsgType0x210, msg_comm.Msg paramMsg, List<MessageRecord> paramList, bcre parambcre, MessageHandler paramMessageHandler)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        paramMsgType0x210 = (arxv)paramMessageHandler.app.getManager(QQManagerFactory.DATING_PROXY_MANAGER);
        if (paramMsgType0x210 != null) {
    ...
    for (;;)
    {
      ...
      ((aogw)paramMessageHandler.app.getBusinessHandler(BusinessHandlerFactory.VIPINFO_HANDLER)).a(paramList, paramMsgType0x210);
      break;
      if ((i == 2003) && (paramMsgType0x210.msg_push_lost_dev_found.has()))
      {
        ...
        ((abgm)paramMessageHandler.app.getBusinessHandler(BusinessHandlerFactory.DEVICEPROXYMGR_HANDLER)).a(111, paramList);
        break;
      }
      ...
      if (i == 1)
      {
        ...
        ((aizi)paramMessageHandler.app.getManager(QQManagerFactory.NEW_FRIEND_MANAGER)).b(paramList);
        break;
      }
      ...
      ((aoay)paramMessageHandler.app.getManager(QQManagerFactory.QIM_NEW_FRIEND_MANAGER)).a(paramList);
      break;
      label1337:
      j = 0;
      break label518;
