...
public class tyi
{
  ...
  private static QQHashMap<Integer, tyj> jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap;
  ...
  public static Drawable a(Context paramContext, int paramInt)
  {
    ...
    {
    default: 
      return paramContext.getResources().getDrawable(2130840274);
    case 1: 
      return paramContext.getResources().getDrawable(2130840366);
    }
    return paramContext.getResources().getDrawable(2130840371);
  }
  ...
  {
    tyj localtyj = a(paramQQAppInterface, paramContext, paramInt);
    if (localtyj != null) {
      return localtyj.a();
    }
  ...
  public static tyj a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt)
  {
    int i1 = paramInt;
    if (paramInt == 3) {
      i1 = 2;
    ...
    return (tyj)jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.get(Integer.valueOf(i1));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localSharedPreferences != null)
    {
      ...
      localSet = bhsj.a(localSharedPreferences, "big_data_share_channel_urls", null);
      if (localSet != null) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    if (!a(paramQQAppInterface, paramContext, bhsi.e(paramContext)))
    {
      localObject = new tyj(paramQQAppInterface, paramContext, 1, 2131695772, 2130840366);
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(1), localObject);
    }
    Object localObject = bhsi.h(paramContext);
    String str = bhsi.i(paramContext);
    if ((TextUtils.isEmpty((CharSequence)localObject)) || (TextUtils.isEmpty(str)))
    {
      paramQQAppInterface = new tyj(paramQQAppInterface, paramContext, 2, 2131694671, 2130840371);
    ...
    for (;;)
    {
      ...
      return;
      paramQQAppInterface = new tyj(paramQQAppInterface, paramContext, 2, (String)localObject, str);
      jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(2), paramQQAppInterface);
    }
  }
  ...
  public static void a(ArrayList<tyj> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        tyj localtyj = (tyj)paramArrayList.next();
        jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap.put(Integer.valueOf(localtyj.jdField_a_of_type_Int), localtyj);
      }
    }
  }
    ...
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        while (i1 < i2)
        {
          ...
          localObject = new tyj(paramQQAppInterface, paramContext, i3, ((Element)localObject).getElementsByTagName("name").item(0).getFirstChild().getNodeValue(), ((Element)localObject).getElementsByTagName("icon").item(0).getFirstChild().getNodeValue());
          if (jdField_a_of_type_ComTencentCommonsdkCacheQQHashMap == null) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          tvz.a(paramQQAppInterface, bool, (String)localObject1);
          tvz.b(paramQQAppInterface, i1);
          if (i3 == 1)
          {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          tvz.a(paramQQAppInterface, bool);
          tvz.c(paramQQAppInterface, i1);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          bhsi.b((Context)localObject1, bool);
        }
        localObject1 = paramString.getElementsByTagName("channel_version");
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          i1 = Integer.valueOf(((Element)((NodeList)localObject1).item(0)).getFirstChild().getNodeValue()).intValue();
          i2 = bnrf.b(paramQQAppInterface);
          if (i1 <= i2) {
            break label2992;
          }
          ...
          bnrf.a(paramQQAppInterface, i3, (String)localObject2, i4);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          bhsi.c((Context)localObject1, bool);
          localObject1 = rxg.a();
          if (i1 != 0) {
            break label3033;
          }
          bool = true;
          ((rxg)localObject1).a(bool);
          if (QLog.isColorLevel()) {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          bnrf.b(paramQQAppInterface, bool);
          if (QLog.isColorLevel()) {
        ...
        if (localObject1 != null)
        {
          ...
          bool = true;
          bhsi.a((Context)localObject1, bool, paramQQAppInterface.c());
          if (QLog.isColorLevel()) {
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bool = true;
          bnrf.d(paramQQAppInterface, bool);
        }
        ...
        if ((localObject1 != null) && (((NodeList)localObject1).getLength() > 0))
        {
          ...
          bnrf.i(paramQQAppInterface, bool);
        }
  ...
  public static String b(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt)
  {
    ...
    default: 
      return null;
    case 1: 
      return paramContext.getString(2131695772);
    }
    return paramContext.getString(2131694671);
  }
  ...
  public static boolean b()
  {
    return "1".equals((String)abac.a().a("subscribe_entrance_enable", "1"));
  }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if ((localObject != null) && (((NodeList)localObject).getLength() > 0))
          {
            ...
            if (i1 > bhsi.x(paramQQAppInterface.getApp()))
            {
              ...
              if ((!TextUtils.isEmpty((CharSequence)localObject)) && (!TextUtils.isEmpty(paramString))) {
                bhsi.a(paramQQAppInterface.getApp(), (String)localObject, paramString);
              }
              bhsi.o(paramQQAppInterface.getApp(), i1);
              return false;
            }
          }
        }
  ...
  {
    return (String)abac.a().a("subscribe_account_title", abac.jdField_c_of_type_JavaLangString);
  }
  ...
  public static boolean c()
  {
    String str1 = (String)abac.a().a("subscribe_entrance_enable", "1");
    String str2 = (String)abac.a().a("newfollowlist", "1");
