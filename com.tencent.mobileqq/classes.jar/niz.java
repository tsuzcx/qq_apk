...
public class niz
{
  ...
  private njb jdField_a_of_type_Njb;
  private boolean jdField_a_of_type_Boolean = true;
  
  public niz(ViewGroup paramViewGroup, Context paramContext)
  {
    this.jdField_a_of_type_AndroidViewViewGroup = paramViewGroup;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Njb = new njb(this);
  }
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewRainView.setAnimationEndListener(new nja(this));
