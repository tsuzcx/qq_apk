...
public class ascn
{
  private static final String jdField_a_of_type_JavaLangString = alud.a(2131719925);
  ...
  {
    paramString1 = asdt.a(paramBundle, paramString1, paramString2, null);
    asdt.a((OpenSdkShareModel)this.jdField_a_of_type_AndroidAppActivity.getIntent().getParcelableExtra("KEY_MINI_PROGRAM_SHARE_OBJ"), paramBundle, paramString1);
    ...
    mzy.a(paramString2, new ascp(this, paramLong, paramBundle), paramString1.toByteArray(), "OidbSvc.0xb77_9", 2935, 9, localBundle, 0L);
  }
  
  private void a(awki paramawki, long paramLong)
  {
    String str;
    Object localObject;
    if (System.currentTimeMillis() - paramLong > 10000L)
    {
      ...
      a(new Object[] { Integer.valueOf(0), "", alud.a(2131705185), "" }, -1);
    }
    label145:
    label152:
    label159:
  ...
  private void a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    AbsShareMsg.sendSdkShareMessageByServer(localQQAppInterface, (AbsShareMsg)paramAbsStructMsg, str1, i, str2, new asco(this, l));
  }
  ...
  private void a(Object[] paramArrayOfObject, int paramInt)
  {
    ...
    ((asdm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(350)).a(this.b, localHashMap);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, AbsStructMsg paramAbsStructMsg, Activity paramActivity, Bundle paramBundle, String paramString)
  {
    ...
    {
      a(new Object[] { Integer.valueOf(0), "", alud.a(2131705186), "" }, -1);
    ...
    {
      azqs.b(null, "dc00898", "", "", "0X8009C93", "0X8009C93", 0, 0, "", paramActivity, paramBundle, paramQQAppInterface);
      a(paramAbsStructMsg);
      return;
    }
  }
