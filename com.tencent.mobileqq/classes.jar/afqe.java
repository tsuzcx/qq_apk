...
public class afqe
  extends afpz
  implements afqu, aftj, aftq
{
  private int jdField_a_of_type_Int;
  private afoy jdField_a_of_type_Afoy;
  private afrx jdField_a_of_type_Afrx;
  private ajxl jdField_a_of_type_Ajxl = new afql(this);
  ...
  MqqHandler jdField_a_of_type_MqqOsMqqHandler = new MqqHandler(Looper.getMainLooper(), new afqf(this));
  ...
  public afqe(Activity paramActivity)
  {
    super(paramActivity);
    ...
    this.jdField_a_of_type_Afoy = new afoy(localakac.b("sp_mayknow_entry_list_recommend"));
    int i;
    if (localakac.b())
    {
      i = 2;
    ...
    label189:
    for (paramActivity = new afsp(paramActivity);; paramActivity = new afsi(paramActivity))
    {
      this.jdField_a_of_type_Afrx = paramActivity;
      this.jdField_a_of_type_Afrx.a(new afqg(this));
  ...
  {
    int i = this.jdField_a_of_type_Afoy.b(1);
    if (this.jdField_a_of_type_Afoy.a())
    {
      int m = bbjn.ag(a(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
      int j = 0;
      ...
      {
        i = this.jdField_a_of_type_Afoy.b(1);
        k = i;
        if (QLog.isColorLevel()) {
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      int i = this.jdField_a_of_type_Afoy.a(this.jdField_b_of_type_Int);
      if (a())
      {
        i = this.jdField_a_of_type_Afoy.b(i);
        if ((i == -1) || (paramBoolean2)) {
          i = a(paramBoolean1);
        }
        c(i);
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewContactsViewPager.setOffscreenPageLimit(this.jdField_a_of_type_Afoy.jdField_a_of_type_JavaUtilArrayList.size());
      }
  ...
  private boolean a()
  {
    ...
    akac localakac = (akac)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
    if (localakac != null) {
      bool1 = localakac.b("sp_mayknow_entry_list_recommend");
    }
    for (boolean bool1 = this.jdField_a_of_type_Afoy.a(bool1);; bool1 = false)
    {
      if (bool1)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsViewPagerAdapter.a(this.jdField_a_of_type_Afoy.jdField_a_of_type_JavaUtilArrayList);
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setTabData(this.jdField_a_of_type_Afoy.jdField_a_of_type_ArrayOfJavaLangString, this.jdField_a_of_type_Afoy.jdField_a_of_type_ArrayOfInt);
      }
      bool2 = bool1;
      if (!QLog.isColorLevel()) {
        break;
      }
      QLog.i("ContactsViewController", 2, "checkAndUpdateRecommendTabShow. mCurrentTabPos:" + this.jdField_b_of_type_Int + " isShowRecommendTab:" + this.jdField_a_of_type_Afoy.a() + " changed:" + bool1);
      return bool1;
    }
  }
  ...
  private void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_Afrx.d();
    this.jdField_d_of_type_Int = paramInt;
    if (this.jdField_d_of_type_Int == 2) {}
    for (Object localObject = new afsp(this.jdField_a_of_type_AndroidAppActivity);; localObject = new afsi(this.jdField_a_of_type_AndroidAppActivity))
    {
      this.jdField_a_of_type_Afrx = ((afrx)localObject);
      this.jdField_a_of_type_Afrx.a(new afqh(this));
      this.jdField_a_of_type_Afrx.b();
      this.jdField_a_of_type_Afrx.a(this.jdField_a_of_type_AndroidViewView);
      if (!this.jdField_c_of_type_Boolean) {
        break;
      }
      this.jdField_a_of_type_Afrx.a(false);
      return;
    }
  }
  ...
  private static boolean b()
  {
    ...
    return (localamtb != null) && (localamtb.e());
  }
  ...
  public int a(int paramInt, boolean paramBoolean)
  {
    ...
    {
      str = "";
      switch (this.jdField_a_of_type_Afoy.a(paramInt))
      {
      }
    }
    for (;;)
    {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", str, str, 0, 0, "", "", "", "");
      return 0;
      str = "0X8007F19";
      continue;
      str = "0X8007F1A";
  ...
  public void a(View paramView)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator = ((SimpleSlidingIndicator)paramView.findViewById(2131376281));
    k();
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewHeaderScrollView = ((HeaderScrollView)paramView.findViewById(2131364641));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewContactsViewPager = ((ContactsViewPager)paramView.findViewById(2131364644));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsViewPagerAdapter = new ContactsViewPagerAdapter(((SplashActivity)a()).getSupportFragmentManager(), ((SplashActivity)a()).app, (BaseActivity)a(), this.jdField_a_of_type_Afoy.jdField_a_of_type_JavaUtilArrayList);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewContactsViewPager.setOffscreenPageLimit(this.jdField_a_of_type_Afoy.jdField_a_of_type_JavaUtilArrayList.size());
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewContactsViewPager.setOnPageChangeListener(new afqi(this));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setTabData(this.jdField_a_of_type_Afoy.jdField_a_of_type_ArrayOfJavaLangString, this.jdField_a_of_type_Afoy.jdField_a_of_type_ArrayOfInt);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewPullrefreshContactRefreshHeader.setRefreshHeaderUpdateListener(new afqj(this));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewPullrefreshCommonRefreshLayout.setOnRefreshListener(this);
    this.jdField_a_of_type_Afrx.a(paramView);
    if (b()) {
      n();
    }
    c(a(false));
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewHeaderScrollView.setOnScrollListener(new afqk(this));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      akac localakac = (akac)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
      if ((localakac == null) || (localakac.b("sp_mayknow_entry_list_recommend") == this.jdField_a_of_type_Afoy.a())) {
        break label251;
      }
    }
    label251:
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Afrx.a(paramQQAppInterface);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Afrx.a(paramBoolean);
  ...
  public void f()
  {
    try
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.a(2131364653, sfh.a());
  ...
  public void g()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewHeaderScrollView != null)
    {
      View localView = this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewHeaderScrollView.findViewById(2131370732);
  ...
  public void h()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsViewPagerAdapter != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewContactsViewPager != null))
    {
      ...
      if ((i == this.jdField_a_of_type_Afoy.b(1)) || (i == this.jdField_a_of_type_Afoy.b(2)) || (i == this.jdField_a_of_type_Afoy.b(0))) {
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewHeaderScrollView.scrollTo(0, 0);
      }
    }
    this.h = false;
  ...
  public void i()
  {
    ...
    this.jdField_a_of_type_Afrx.c(bool);
    if (this.jdField_a_of_type_ComTencentMobileqqMiniEntryContactsMiniAppEntryManager != null) {
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setCurrentPosition(this.jdField_a_of_type_Afoy.b(3), false);
    }
  }
