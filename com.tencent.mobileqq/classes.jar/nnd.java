        ...
        if ((paramObject != null) && (localObject1 != null))
        {
          ...
          try
          {
            ...
            if (paramInt <= k)
            {
              ...
              m = npj.a((AdvertisementInfo)localObject3);
              String str = npj.b((AdvertisementInfo)localObject3);
              ...
              if ((localObject2 == null) || (!(localObject2 instanceof nqv))) {
                break label717;
              }
              ((nqv)localObject2).a(true, (AdvertisementInfo)localObject3, paramVarArgs);
            }
          }
