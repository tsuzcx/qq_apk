  ...
  implements QZoneRemotePluginManager
{
  ...
  public anfr(IBinder paramIBinder)
  {
    this.a = paramIBinder;
  }
  ...
  public cooperation.qzone.plugin.PluginRecord a(String paramString)
  {
    ...
    //   19: aload_0
    //   20: getfield 15	anfr:a	Landroid/os/IBinder;
    //   23: bipush 6
    //   25: aload_2
    //   26: aload_3
    //   27: iconst_0
  ...
  /* Error */
  public void a(cooperation.qzone.plugin.OnQZoneLiveSoDownloadListener paramOnQZoneLiveSoDownloadListener, int paramInt)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_3
    ...
    //   36: aload_0
    //   37: getfield 15	anfr:a	Landroid/os/IBinder;
    //   40: bipush 7
    //   42: aload_3
    //   43: aload 4
    //   45: iconst_0
    ...
    //   start	length	slot	name	signature
    //   0	84	0	this	anfr
    //   0	84	1	paramOnQZoneLiveSoDownloadListener	cooperation.qzone.plugin.OnQZoneLiveSoDownloadListener
    //   0	84	2	paramInt	int
  ...
  public boolean a()
  {
    ...
    //   17: aload_0
    //   18: getfield 15	anfr:a	Landroid/os/IBinder;
    //   21: iconst_1
    //   22: aload_3
    //   23: aload 4
    //   25: iconst_0
  ...
  /* Error */
  public boolean a(String paramString, cooperation.qzone.plugin.OnQZonePluginInstallListner paramOnQZonePluginInstallListner, int paramInt)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 4
    ...
    //   49: aload_0
    //   50: getfield 15	anfr:a	Landroid/os/IBinder;
    //   53: iconst_3
    //   54: aload 5
    //   56: aload 6
    //   58: iconst_0
    ...
    //   0	114	2	paramOnQZonePluginInstallListner	cooperation.qzone.plugin.OnQZonePluginInstallListner
