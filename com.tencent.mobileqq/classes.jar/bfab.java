  ...
  extends VasWebviewJsPlugin
{
  ...
  bfaa jdField_a_of_type_Bfaa = new bfac(this);
  public bfae a;
  public String a;
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    bfbe.a(str1, false, bfbe.b);
    for (;;)
    {
      a(localIntent.getExtras());
      bezd.a(paramJSONObject, localIntent, 100);
      return;
      label126:
      bfbe.a(str1, false, bfbe.e);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_1
    //   3: putstatic 181	bfab:f	Ljava/lang/String;
    //   6: getstatic 26	bfab:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   9: invokevirtual 271	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   12: istore_2
    //   13: iload_2
    //   14: ifeq +6 -> 20
    //   17: aload_0
    //   18: monitorexit
    //   19: return
    //   20: getstatic 26	bfab:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   23: iconst_1
    //   24: invokevirtual 274	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   27: new 276	cooperation/comic/jsp/QQComicJsPlugin$4
    //   30: dup
    //   31: aload_0
    //   32: invokespecial 277	cooperation/comic/jsp/QQComicJsPlugin$4:<init>	(Lbfab;)V
    //   35: iconst_5
    //   36: aconst_null
    //   37: iconst_1
    //   38: invokestatic 281	com/tencent/mobileqq/app/ThreadManager:post	(Ljava/lang/Runnable;ILcom/tencent/mobileqq/app/ThreadExcutor$IThreadListener;Z)V
    //   41: goto -24 -> 17
    //   44: astore_1
    //   45: aload_0
    //   46: monitorexit
  ...
  {
    if (this.jdField_a_of_type_Bfae == null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("QQComicDebug", 2, "create a new js plugin");
      }
      this.jdField_a_of_type_Bfae = bfas.a(this.mRuntime, this.jdField_a_of_type_Bfaa);
    }
    if (this.jdField_a_of_type_Bfae != null) {
      this.jdField_a_of_type_Bfae.a(paramString1, paramJSONObject);
    }
    do
    {
      return;
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      {
        paramJsBridgeListener = (String)bezd.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicReference.get();
        paramString1 = new JSONObject();
        ...
        for (;;)
        {
          ...
          paramString1.put("message", ajjy.a(2131644386));
    ...
    else
    {
      ...
      if ("setSwitchChannel".equals(paramString3))
      {
        ...
        if ((paramString3 != null) && (paramString3.length() > 0))
        {
          ...
          paramVarArgs.a.a(new bazi(m, k, paramString1, paramString2, paramJsBridgeListener));
          break label2092;
        }
      }
      else
      {
        ...
        else
        {
          ...
          if ("setTabRedPoint".equals(paramString3))
          {
            ...
            break label2092;
            label1078:
            paramVarArgs.a.a(new bazj(paramJsBridgeListener, j, paramString2));
            break label2092;
          }
          if ("getTitleBarHeight".equals(paramString3))
          {
            paramJsBridgeListener = new JSONObject();
            paramString1 = new JSONObject();
            j = this.mRuntime.a().getResources().getDimensionPixelSize(2131167766);
            i = j;
          ...
          if ("openQQBrowser".equals(paramString3))
          {
            ...
            bezd.a(paramString1, paramString2, -1);
            break label2092;
          }
          ...
          if ("setTitleAndBottomBar".equals(paramString3))
          {
            ...
            paramJsBridgeListener = (bazk)paramString1;
            bool1 = bool2;
            if (!bool3) {
              bool1 = true;
            }
          ...
          if ("getReporterInfo".equals(paramString3))
          {
            paramJsBridgeListener = new JSONObject();
            paramString1 = new JSONObject();
            paramString1.put("mod", bezd.jdField_a_of_type_JavaLangString);
            paramString1.put("land_page", bezd.c);
            paramString1.put("obj_ownerid", bezd.b);
            paramJsBridgeListener.put("data", paramString1);
