  ...
  implements Handler.Callback
{
  ...
  aoir jdField_a_of_type_Aoir;
  aoiz jdField_a_of_type_Aoiz = new agot(this);
  beub jdField_a_of_type_Beub;
  ...
  public agos(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    super(paramQQAppInterface, paramViewGroup, paramFragmentActivity, paramContext);
    this.jdField_b_of_type_MqqOsMqqHandler = new bhsl(ThreadManager.getSubThreadLooper(), this);
    this.jdField_a_of_type_Alwx = new agox(this);
  }
  ...
  {
    long l1;
    if (aoiq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
    {
      t(false);
      l1 = 0L;
    }
    ...
    {
      this.jdField_a_of_type_Aoir.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin(), l1, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, true);
      return;
    }
    this.jdField_a_of_type_Aoir.a(l1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, false);
  }
  ...
  private void bt()
  {
    ...
    {
      String str = aoiy.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e);
      if (aoiq.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str)) {
  ...
  private void bu()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1033)
    {
      this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setBackgroundResource(2130843228);
    ...
    for (;;)
    {
      try
      {
        ...
        {
          aepi.a(this.jdField_a_of_type_ComTencentWidgetXEditTextEx, 2130843247);
        ...
        if (this.jdField_a_of_type_AndroidWidgetTextView.getVisibility() == 0)
        {
          ...
          c(true);
          this.f.setText(alud.a(2131702772) + this.g);
          ...
          localObject1 = alud.a(2131702773);
          if (this.T) {
            localObject1 = alud.a(2131702774);
          }
          this.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject1);
          this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.findViewById(2131369389).setVisibility(8);
          ...
          if (aoiq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
          {
            localObject1 = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131560891, null);
            this.jdField_d_of_type_AndroidViewViewGroup.addView((View)localObject1, new ViewGroup.LayoutParams(-1, -1));
            localObject2 = ((View)localObject1).findViewById(2131380133);
            this.jdField_p_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject1).findViewById(2131367693));
            this.jdField_p_of_type_AndroidWidgetImageView.setOnClickListener(this);
            this.jdField_a_of_type_ComTencentMobileqqConfessConfessProgressView = ((ConfessProgressView)((View)localObject1).findViewById(2131364681));
            ...
            this.o = ((View)localObject1).findViewById(2131367685);
            this.o.setVisibility(8);
            this.jdField_p_of_type_AndroidViewView = ((View)localObject1).findViewById(2131367683);
            if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1033)
            {
            ...
            bv();
            if (!aoiq.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "holmes_guide"))
            {
              aoiq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "holmes_guide", true);
              if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int != 1033) {
                break label933;
              }
              localObject1 = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131560890, null);
              ((View)localObject1).findViewById(2131367688).setOnClickListener(this);
              ((View)localObject1).setOnClickListener(this);
              this.jdField_d_of_type_AndroidViewViewGroup.getViewTreeObserver().addOnGlobalLayoutListener(new agou(this, (View)localObject1, (View)localObject2));
            }
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845190);
      ...
      continue;
      label933:
      View localView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131560889, null);
    }
  }
  ...
  private void bw()
  {
    ...
    ((bhuf)localObject).a(2131690055, 5);
    ((bhuf)localObject).a(2131690673, 5);
    ((bhuf)localObject).c(2131690648);
    ((bhuf)localObject).a(new agoy(this, (bhuf)localObject));
  ...
  private void t(boolean paramBoolean)
  {
    ...
    if (localConfessConvInfo != null)
    {
      ...
      this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130844592);
    }
    for (int i = 0;; i = 1)
    {
      ...
      this.jdField_p_of_type_AndroidWidgetImageView.setContentDescription(String.format(alud.a(2131702782), new Object[] { Integer.valueOf(localConfessConvInfo.holmesTolCount), Integer.valueOf(localConfessConvInfo.holmesCurCount) }));
      ...
      return;
      label215:
      this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130844591);
    }
  }
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    if (this.jdField_a_of_type_Beub == null) {
      this.jdField_a_of_type_Beub = new beub(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    }
  ...
  {
    aoiy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e, true, true);
  }
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    bu();
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Aoiz);
    this.jdField_a_of_type_Aoir = ((aoir)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(125));
    bs();
    return paramBoolean;
  }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int != 1033)
    {
      ...
      if (localObject != null)
      {
        ...
        if (((ChatFragment)localObject).a != null) {
          ((ChatFragment)localObject).a.setStatusBarDrawable(a().getResources().getDrawable(2130845746));
        }
      }
      ...
      this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable(SkinEngine.getInstances().getDefaultThemeDrawable(2130849550));
      this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131369389).setVisibility(8);
      this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setIsDefaultTheme(false);
      this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setBackgroundDrawable(SkinEngine.getInstances().getDefaultThemeDrawable(2130849536));
      this.jdField_d_of_type_AndroidViewViewGroup.setBackgroundDrawable(SkinEngine.getInstances().getDefaultThemeDrawable(2130849473));
      aepi.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout, SkinEngine.getInstances().getDefaultThemeDrawable(2130849280));
      aepi.a(this.jdField_a_of_type_ComTencentWidgetXEditTextEx, SkinEngine.getInstances().getDefaultThemeDrawable(2130849281));
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setTextColor(-16777216);
      localObject = SkinEngine.getInstances().getDefaultThemeDrawable(2130849429);
      Drawable localDrawable1 = SkinEngine.getInstances().getDefaultThemeDrawable(2130849426);
      Drawable localDrawable2 = SkinEngine.getInstances().getDefaultThemeDrawable(2130849430);
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPanelPanelIconLinearLayout.setBackgroundDrawable(SkinEngine.getInstances().getDefaultThemeDrawable(2130849330));
      return;
    }
    aepi.a(this.jdField_a_of_type_ComTencentWidgetXEditTextEx, 2130843247);
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setTextColor(-16777216);
  ...
  public void as()
  {
    ...
    localacjt.i = this.J;
    this.J = false;
    acjm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, str, null, localacjt);
    ...
    ba();
    this.jdField_a_of_type_Ahap.a(1002, new Object[] { str });
  }
  ...
  public void c(Intent paramIntent)
  {
    ...
    this.g = str1;
    paramIntent = (aoiu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(269);
    ...
    for (;;)
    {
      ...
      if (!this.L)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1033)
        {
          ...
          this.jdField_a_of_type_ComTencentMobileqqConfessConfessInfo = localaoip.a(str3, j, k, paramIntent, str1, i, str2, l);
        }
      }
      for (;;)
      {
  ...
  public int e()
  {
    int i = afxr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Normal_MaxPtt") * 1000 - 200;
  ...
  public void onClick(View paramView)
  {
    ...
    if ((i == 2131368638) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1034)) {
      bw();
    }
    do
    {
    ...
    if (i == 2131367693)
    {
      ...
      if (this.o != null)
      {
        ...
        {
          this.o.setVisibility(8);
          paramView = aoiy.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e);
          aoiq.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView, false);
          i = 1;
        }
      }
      String str;
      ...
      for (;;)
      {
        aoiq.a(localQQAppInterface, localContext, paramView, str, j, bool);
        azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009573", "0X8009573", i, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.e + "", "", paramView + "", str + "");
        return;
