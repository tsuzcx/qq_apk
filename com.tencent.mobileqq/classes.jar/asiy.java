...
public class asiy
{
  ...
  public asiy(Context paramContext, MessageRecord paramMessageRecord)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaLangString = asjc.a(paramMessageRecord);
    this.jdField_b_of_type_JavaLangString = asjc.a(paramMessageRecord, 0);
    a();
  }
  
  public asiy(Context paramContext, QQGameMsgInfo paramQQGameMsgInfo)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
  ...
  {
    if (arof.b(paramString1)) {
      return asjb.a(paramString1 + "/" + paramString2, paramInt1, paramInt2);
    }
    return null;
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString2)))
    {
      ...
      aact.a(localHashMap, paramString1);
      ...
      aact.a(akro.a(), "769", paramString3, paramString2, "76906", "1", "160", localHashMap);
    }
  }
  
  public void a(View paramView)
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131366978));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramView.findViewById(2131366979));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131366976));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131366980));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131366977));
    this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView = ((FullPopVideoView)paramView.findViewById(2131379669));
    this.d = ((ImageView)paramView.findViewById(2131368100));
  }
  ...
  public void a(AppInterface paramAppInterface, MessageRecord paramMessageRecord, QQGameMsgInfo paramQQGameMsgInfo)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (paramMessageRecord != null) {
          paramMessageRecord = asjd.a(paramMessageRecord);
        }
        for (;;)
        {
          if (paramMessageRecord == null) {
    ...
    asjd.a(paramAppInterface, paramMessageRecord.resUrl, new asiz(this, paramMessageRecord), false);
    return;
    label355:
    if (QLog.isColorLevel()) {
  ...
  public void a(boolean paramBoolean)
  {
    if (TVK_SDKMgr.isInstalled(this.jdField_a_of_type_AndroidContentContext)) {
      if (a())
      {
        ...
        this.jdField_a_of_type_Ashc = new asgx(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqGamecenterDataFullPopData, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, paramBoolean);
        this.jdField_a_of_type_Ashc.a(new View[] { this.jdField_a_of_type_AndroidWidgetFrameLayout, this.jdField_a_of_type_AndroidWidgetRelativeLayout, this.jdField_a_of_type_AndroidWidgetImageView, this.jdField_b_of_type_AndroidWidgetImageView, this.jdField_c_of_type_AndroidWidgetImageView, this.jdField_a_of_type_ComTencentMobileqqGamecenterViewFullPopVideoView, this.d });
        this.jdField_a_of_type_Ashc.b();
    ...
    while (!QLog.isColorLevel()) {
      ...
      {
        return;
        this.jdField_a_of_type_Ashc = new asgq(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqGamecenterDataFullPopData, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, paramBoolean);
      }
    }
