  ...
  extends awiv<awiz>
{
  ...
  private awjk jdField_a_of_type_Awjk;
  private Long jdField_a_of_type_JavaLangLong;
  private Runnable jdField_a_of_type_JavaLangRunnable;
  private AtomicBoolean jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(true);
  private int b;
  
  public awjj(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(int paramInt, long paramLong, awir paramawir)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ReportLocationHandler", 2, new Object[] { "requestReportLocation: invoked. ", "uinType = [" + paramInt + "], sessionUin = [" + paramLong + "], locationItem = [" + paramawir + "]" });
    }
    RoomOperate.ReqReportLocation localReqReportLocation = new RoomOperate.ReqReportLocation();
    qq_lbs_share.RoomKey localRoomKey = awnj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0, paramLong);
    localReqReportLocation.room_key.set(localRoomKey);
    localReqReportLocation.room_key.setHasFlag(true);
    localReqReportLocation.direction.set(paramawir.a());
    paramawir = paramawir.a();
    if (paramawir == null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("ReportLocationHandler", 2, new Object[] { "requestReportLocation: invoked. ", " latLng: ", paramawir });
      }
      return;
    }
    localReqReportLocation.lat.set(paramawir.latitude);
    localReqReportLocation.lon.set(paramawir.longitude);
    paramawir = new ToServiceMsg("mobileqq.service", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "QQLBSShareSvc.report_location");
    paramawir.putWupBuffer(localReqReportLocation.toByteArray());
    a().sendPbReq(paramawir);
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (a(paramToServiceMsg, paramFromServiceMsg, paramObject))
    {
      try
      {
        ...
        if (awnj.a((qq_lbs_share.ResultInfo)paramToServiceMsg.msg_result.get()))
        {
  ...
  public void a(String paramString, awjk paramawjk)
  {
    this.jdField_a_of_type_Awjk = paramawjk;
  ...
  public boolean a(awit paramawit)
  {
    ...
    return new awit(this.b, "" + this.jdField_a_of_type_JavaLangLong).equals(paramawit);
  }
