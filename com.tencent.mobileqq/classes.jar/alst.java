    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          alss.a(this.a, paramIntent.getBooleanExtra("extra_can_add_colornote", true));
        ...
        } while ((alss.a(this.a) == null) || (??? == null) || (paramIntent == null) || (???.length != paramIntent.length));
        int i = 0;
        while ((paramIntent != null) && (i < paramIntent.length)) {
          try
          {
            ...
            if (j != -1)
            {
              alry localalry = (alry)alss.a(this.a).get();
              if (localalry != null) {
                localalry.onDeleteColorNote(j, paramIntent[i], false);
              }
            }
            i += 1;
          }
      ...
      } while ((!???.equals("key_after_sync_msg")) || (alss.b(this.a) == null));
      ??? = (alur)alss.b(this.a).get();
    } while (??? == null);
