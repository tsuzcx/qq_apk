  ...
  implements avhe, Manager
{
  ...
  public static Bundle a(IVPluginInfo paramIVPluginInfo, avha paramavha)
  {
    int m = 0;
    ...
    for (;;)
    {
      try
      {
        ...
        localObject2 = (anmw)((AppRuntime)localObject1).getManager(51);
        localObject3 = ((anmw)localObject2).e(str2);
        ...
        localObject3 = ((anmw)localObject2).b(str2);
        if (localObject3 == null) {
          break label452;
        }
      ...
      localBundle.putString("payToken", paramavha.a().c);
