...
public class ajbu
{
  ...
  public static int a(long paramLong, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    int i = -1;
    ajcf localajcf = ajac.b(paramLong);
    if (localajcf != null) {
      i = localajcf.a();
    }
  ...
  private static boolean a(long paramLong, String paramString1, String paramString2, boolean paramBoolean, int paramInt)
  {
    if (paramString1.equals("cs.check_pubAccount_state.local")) {
      a(paramString1, paramString2, paramBoolean, new ajbv(paramLong), paramInt);
    }
    label199:
    do
    {
      ...
      do
      {
        do
        {
          ...
          {
            a(paramString1, paramString2, paramBoolean, new ajbw(paramLong), paramInt);
            return false;
          }
          if (!paramString1.equals("cs.get_dress_path.local")) {
            break label199;
          }
          localObject2 = new ajbx(paramLong, paramString1);
          try
          {
            ajcf localajcf = ajac.b(paramLong);
            str = paramString2;
            if (localajcf != null)
            {
              ...
              {
                localJSONObject.put("gameId", localajcf.a());
        ...
        Object localObject1 = new ajby(paramLong);
  ...
  public static boolean a(long paramLong, boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localajct != null)
        {
          paramBoolean = localajct.a(paramLong, paramBoolean, paramString1, paramString2);
          return paramBoolean;
        }
      }
