...
public class atql
  extends atps<atpw>
{
  atql(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(int paramInt1, int paramInt2, long paramLong, LocationRoom.Venue paramVenue)
  {
    ...
    Object localObject = atue.a(this.a, paramInt2, paramLong);
  ...
  {
    atue.a(this.a, paramInt1, paramString, false);
    atud.a(this.a, paramInt1, paramString, false);
  ...
  protected atpw a()
  {
    return atpw.a(this.a);
  }
  
  void a(atpq paramatpq, LocationRoom.Venue paramVenue)
  {
    if ((paramatpq == null) || (paramVenue == null)) {
      return;
    }
    a(1, paramatpq.a(), Long.parseLong(paramatpq.a()), paramVenue);
  }
  ...
  void b(atpq paramatpq, LocationRoom.Venue paramVenue)
  {
    if ((paramatpq == null) || (paramVenue == null)) {
      return;
    }
    a(3, paramatpq.a(), Long.parseLong(paramatpq.a()), paramVenue);
  }
}
