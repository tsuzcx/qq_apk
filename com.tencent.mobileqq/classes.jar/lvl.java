  ...
  implements View.OnClickListener
{
  ...
  public lvl(RedPacketGameView paramRedPacketGameView, AVActivity paramAVActivity)
  {
    this.jdField_a_of_type_ArrayOfLvh = new lvh[4];
    this.jdField_a_of_type_Lvh = new lvh();
    this.jdField_b_of_type_Lvh = new lvh();
    this.jdField_c_of_type_Lvh = new lvh();
    ...
    int n = 0;
    while (n < this.jdField_a_of_type_ArrayOfLvh.length)
    {
      this.jdField_a_of_type_ArrayOfLvh[n] = new lvh();
      this.jdField_a_of_type_ArrayOfLvh[n].jdField_b_of_type_Int = (n * 37 + 30);
      this.jdField_a_of_type_ArrayOfLvh[n].jdField_c_of_type_Int = 30;
      this.jdField_a_of_type_ArrayOfLvh[n].d = 37;
      this.jdField_a_of_type_ArrayOfLvh[n].e = 46;
      this.jdField_a_of_type_ArrayOfLvh[n].a(255);
      n += 1;
    }
    this.jdField_a_of_type_Lvh.jdField_c_of_type_Int = 36;
    this.jdField_a_of_type_Lvh.d = 200;
    this.jdField_a_of_type_Lvh.e = 28;
    this.jdField_a_of_type_Lvh.a(255);
    this.jdField_b_of_type_Lvh.jdField_c_of_type_Int = 36;
    this.jdField_b_of_type_Lvh.d = 200;
    this.jdField_b_of_type_Lvh.e = 28;
    this.jdField_b_of_type_Lvh.a(255);
    this.jdField_c_of_type_Lvh.jdField_c_of_type_Int = 36;
    this.jdField_c_of_type_Lvh.d = 200;
    this.jdField_c_of_type_Lvh.e = 28;
    this.jdField_c_of_type_Lvh.a(255);
    ...
    paramAVActivity.setId(2131373701);
    ...
    paramRedPacketGameView.setId(2131373702);
  ...
  private void e()
  {
    View localView = this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131373701);
    ...
    localView = this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131373702);
  ...
  private void f()
  {
    ...
    {
      this.jdField_a_of_type_Lvh.jdField_b_of_type_Int = n;
      this.jdField_b_of_type_Lvh.jdField_b_of_type_Int = n;
      this.jdField_c_of_type_Lvh.jdField_b_of_type_Int = n;
      this.jdField_a_of_type_Lvh.b(this.h, this.i, 0, 0);
      this.jdField_b_of_type_Lvh.b(this.h, this.i, 0, 0);
  ...
  public void a()
  {
    Object localObject = this.jdField_a_of_type_Lvh.a();
    int i1 = this.e * this.jdField_b_of_type_Int / this.jdField_c_of_type_Int + this.d;
    int n = ((Rect)localObject).width() + i1;
    this.jdField_c_of_type_Lvh.a(i1, ((Rect)localObject).top, n, ((Rect)localObject).bottom);
  ...
  public void a(int paramInt)
  {
    if (this.jdField_a_of_type_Int != paramInt)
    {
      ...
      int i1 = paramInt;
      paramInt = i2;
      while (paramInt < this.jdField_a_of_type_ArrayOfLvh.length)
      {
        i2 = i1 / n;
        if (this.jdField_a_of_type_ArrayOfLvm != null) {
          this.jdField_a_of_type_ArrayOfLvh[paramInt].a = this.jdField_a_of_type_ArrayOfLvm[i2];
        }
        i1 %= n;
        n /= 10;
        paramInt += 1;
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    while (n < this.jdField_a_of_type_ArrayOfLvh.length)
    {
      this.jdField_a_of_type_ArrayOfLvh[n].b(paramInt1, paramInt2, paramInt3, paramInt4);
      n += 1;
    }
    this.h = paramInt1;
    this.i = paramInt2;
  ...
  public void a(long paramLong)
  {
    ...
    else
    {
      ...
      if (!this.jdField_b_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_Lvh.a(n);
        this.jdField_b_of_type_Lvh.a(n);
        this.jdField_c_of_type_Lvh.a(n);
        localObject = this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131373701);
        ...
        localObject = this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131373702);
  ...
  public void a(Canvas paramCanvas, Paint paramPaint)
  {
    ...
    while (n < this.jdField_a_of_type_ArrayOfLvh.length)
    {
      this.jdField_a_of_type_ArrayOfLvh[n].a(paramCanvas, paramPaint);
      n += 1;
    }
    this.jdField_a_of_type_Lvh.a(paramCanvas, paramPaint);
    paramCanvas.save();
    paramCanvas.clipPath(this.jdField_a_of_type_AndroidGraphicsPath);
    this.jdField_b_of_type_Lvh.a(paramCanvas, paramPaint);
    this.jdField_c_of_type_Lvh.a(paramCanvas, paramPaint);
    paramCanvas.restore();
    paramCanvas.restore();
  }
  ...
  {
    this.jdField_a_of_type_Lvh.a = new lvm(paramAVRedPacketManager.a("qav_redpacket_progressbar_bg.png"));
    this.jdField_b_of_type_Lvh.a = new lvm(paramAVRedPacketManager.a("qav_redpacket_progressbar_red.png"));
    this.jdField_c_of_type_Lvh.a = new lvm(paramAVRedPacketManager.a("qav_redpacket_progressbar_yellow.png"));
    this.jdField_a_of_type_ArrayOfLvm = paramArrayOflvm;
    int n = 0;
    while (n < this.jdField_a_of_type_ArrayOfLvh.length)
    {
      this.jdField_a_of_type_ArrayOfLvh[n].a = this.jdField_a_of_type_ArrayOfLvm[0];
      n += 1;
    }
  }
  ...
  public void a(boolean paramBoolean, AVRedPacketManager paramAVRedPacketManager)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if (this.jdField_a_of_type_AndroidGraphicsBitmap != null) {
        localView.setBackgroundDrawable(mux.a(paramAVRedPacketManager, this.jdField_a_of_type_AndroidGraphicsBitmap, 2131166041));
      }
  ...
  public void b()
  {
    ...
    this.jdField_b_of_type_Lvh.b();
    this.jdField_c_of_type_Lvh.b();
    ...
    this.jdField_a_of_type_ArrayOfLvh = null;
    this.jdField_a_of_type_Lvh = null;
    this.jdField_b_of_type_Lvh = null;
    this.jdField_c_of_type_Lvh = null;
  ...
  public void c()
  {
    RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131373701).getLayoutParams();
    localLayoutParams.width = (this.h * 52 / 750);
    localLayoutParams.height = (this.h * 52 / 750);
    localLayoutParams = (RelativeLayout.LayoutParams)this.jdField_a_of_type_ComTencentAvRedpacketUiRedPacketGameView.findViewById(2131373702).getLayoutParams();
