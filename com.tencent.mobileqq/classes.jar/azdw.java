...
public class azdw
{
  ...
  public static int a(ShortVideoResourceManager.SVConfigItem paramSVConfigItem)
  {
    ...
    {
      if (paramSVConfigItem.versionCode < 77)
      {
        i = -2;
        VideoEnvironment.a("ShortVideoPtuResManager", "userCheckNeedDownload:item.versionCode=" + paramSVConfigItem.versionCode + " buildInPendant=" + 77, null);
      }
      return i;
    }
    return -4;
  ...
  {
    return azkt.a(VideoEnvironment.a()) + "ptu_res";
  }
  ...
  {
    return azcr.b(paramString1, paramString2);
  }
