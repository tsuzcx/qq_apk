  ...
  extends atdk
{
  ...
  protected void a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      if (paramBundle != null)
      {
        paramBundle = wxz.a(bakc.b(paramBundle.getWupBuffer()));
        if (paramBundle != null) {
          aael.a(localQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramBundle);
        }
      }
