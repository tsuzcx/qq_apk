...
{
  public vbj(MarketFaceItemBuilder paramMarketFaceItemBuilder, int paramInt, ChatMessage paramChatMessage) {}
  ...
  public void a(EmoticonPackage paramEmoticonPackage)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Int == 2131375567)
      {
      ...
      do
      {
        ...
        if (this.jdField_a_of_type_Int == 2131361852)
        {
          ...
          {
            localQQProgressDialog.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemMarketFaceItemBuilder.jdField_b_of_type_AndroidContentContext.getString(2131436089));
      ...
      if (this.jdField_a_of_type_Int == 2131361853)
      {
        ...
        {
          ChatActivityUtils.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemMarketFaceItemBuilder.jdField_b_of_type_AndroidContentContext, 2131436306, 0);
          return;
        }
        ...
        str = this.jdField_a_of_type_ComTencentMobileqqActivityAioItemMarketFaceItemBuilder.jdField_b_of_type_AndroidContentContext.getString(2131436090);
      }
      for (i = 7;; i = 107)
      {
        if (localQQProgressDialog != null)
        ...
        {
          ChatActivityUtils.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemMarketFaceItemBuilder.jdField_b_of_type_AndroidContentContext, 2131430273, 0);
          return;
        }
        str = this.jdField_a_of_type_ComTencentMobileqqActivityAioItemMarketFaceItemBuilder.jdField_b_of_type_AndroidContentContext.getString(2131436091);
