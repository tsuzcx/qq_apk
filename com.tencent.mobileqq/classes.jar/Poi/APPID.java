  ...
  implements Serializable
{
  ...
  private static APPID[] a;
  private String __T = new String();
  private int __value;
  
  static
  {
    if (!APPID.class.desiredAssertionStatus()) {}
    for (boolean bool = true;; bool = false)
    {
      ...
      QQ_HOST_COVER_WEATHER = new APPID(15, 100206, "QQ_HOST_COVER_WEATHER");
      QQ_HOST_WEATHER_DETAIL = new APPID(16, 100207, "QQ_HOST_WEATHER_DETAIL");
      QQ_PUBLISH_SIGN = new APPID(17, 100208, "QQ_PUBLISH_SIGN");
      QQ_SWITCH_CLIENT = new APPID(18, 100209, "QQ_SWITCH_CLIENT");
      return;
    }
  }
