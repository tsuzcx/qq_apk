  ...
  extends MqqHandler
{
  ...
  public anef(Looper paramLooper, VideoBroadcastReceiver paramVideoBroadcastReceiver)
  {
    super(paramLooper);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        do
        {
          ...
          case 0: 
            ...
            ((SessionInfo)localObject3).curType = i;
            ((SessionInfo)localObject3).curFriendNick = ((String)localObject4);
            if (i == 1006)
            {
              ((SessionInfo)localObject3).curFriendUin = ((String)localObject1);
              localObject1 = ((avsy)localQQAppInterface.getManager(11)).a();
            ...
            for (;;)
            {
              acvv.b(localQQAppInterface, paramMessage, (SessionInfo)localObject3, (String)localObject2);
              return;
              if (i == 1000)
              {
                ...
                ((SessionInfo)localObject3).curFriendUin = str;
                ((SessionInfo)localObject3).troopUin = ((TroopInfo)localObject4).troopcode;
                ((SessionInfo)localObject3).realTroopUin = ((TroopInfo)localObject4).troopuin;
                continue;
              }
              if (i == 1004)
              {
          ...
          case 1: 
            ...
            localObject1 = (QQCustomDialog)paramMessage[0];
        ...
        } while (!((QQCustomDialog)localObject1).isShowing());
        ...
        for (boolean bool1 = true;; bool1 = false)
        {
          ...
          mrd.c(localQQAppInterface.isBackgroundPause, bool2);
          return;
        }
        localObject4 = (Object[])paramMessage.obj;
        paramMessage = (QQCustomDialog)localObject4[0];
      ...
      mrd.e(localQQAppInterface.isBackgroundPause);
      return;
