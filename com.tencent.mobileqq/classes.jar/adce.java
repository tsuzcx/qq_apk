  ...
  implements Handler.Callback
{
  ...
  private adcg jdField_a_of_type_Adcg;
  ...
  private adcg jdField_b_of_type_Adcg;
  private ImageSwitcher jdField_b_of_type_AndroidWidgetImageSwitcher;
  private boolean jdField_b_of_type_Boolean;
  private adcg c;
  private adcg d;
  
  public adce(ImageSwitcher paramImageSwitcher1, ImageSwitcher paramImageSwitcher2, ImageView paramImageView, MqqHandler paramMqqHandler, QQAppInterface paramQQAppInterface)
  {
  ...
  private adcg a(String paramString)
  {
    if (this.d != null)
    {
  ...
  private String a(int paramInt)
  {
    ...
    case 3: 
    default: 
      return alpo.a(2131706386);
    case 0: 
      return alpo.a(2131706388);
    case 1: 
      return alpo.a(2131706390);
    case 2: 
      return alpo.a(2131706389);
    }
    return alpo.a(2131706391);
  }
  ...
  private boolean b()
  {
    ...
    if ((this.jdField_a_of_type_Int >= this.jdField_a_of_type_JavaUtilArrayList.size()) || ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_JavaUtilArrayList.size() == 2)) || ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Int >= this.jdField_a_of_type_JavaUtilArrayList.size() - 1))) {
      if ((this.d != null) && (this.jdField_b_of_type_Int != 4))
      {
        ...
        this.c = this.d;
        this.d = null;
        this.jdField_b_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.c.jdField_a_of_type_Bcxb);
        if (QLog.isColorLevel()) {
        ...
        this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.d.jdField_a_of_type_Bcxb);
        this.jdField_a_of_type_Adcg = this.jdField_b_of_type_Adcg;
        this.jdField_b_of_type_Adcg = this.d;
        this.d = null;
      }
    }
    for (;;)
    {
      ...
      return true;
      label287:
      this.c = adcg.a(str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      break;
      label302:
      ...
      this.jdField_b_of_type_Adcg = adcg.a(str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.jdField_b_of_type_Adcg.jdField_a_of_type_Bcxb);
      continue;
      label478:
      this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(this.d.jdField_a_of_type_Bcxb);
      this.jdField_a_of_type_Adcg = this.jdField_b_of_type_Adcg;
      ...
      this.d = null;
      if (QLog.isColorLevel()) {
        QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "isPlayFinished play one" + this.jdField_b_of_type_Adcg.jdField_a_of_type_JavaLangString);
      }
    }
    label553:
    return false;
  ...
  private void f()
  {
    if ((this.jdField_a_of_type_Adcg != null) && (!this.jdField_a_of_type_Adcg.a()))
    {
      this.jdField_a_of_type_Adcg.a();
      this.jdField_a_of_type_Adcg = null;
    }
    if ((this.jdField_b_of_type_Adcg != null) && (!this.jdField_b_of_type_Adcg.a()))
    {
      this.jdField_b_of_type_Adcg.a();
      this.jdField_b_of_type_Adcg = null;
    }
    if ((this.c != null) && (!this.c.a()))
    {
      this.c.a();
  ...
  void a()
  {
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilArrayList.size() > 1) && (this.jdField_a_of_type_Int > 0))
        {
          ...
          this.jdField_b_of_type_Adcg = this.c;
          this.c = null;
          localObject = this.jdField_b_of_type_Adcg.a();
          this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable((Drawable)localObject);
          if (QLog.isColorLevel()) {
            QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "play two" + this.jdField_b_of_type_Adcg.jdField_a_of_type_JavaLangString);
          }
          this.c = a((String)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int + 1));
          if (this.c == null) {
            this.c = adcg.a((String)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_a_of_type_Int + 1), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          }
          ...
          this.d = adcg.a((String)localObject, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          return;
        }
      }
      catch (Throwable localThrowable)
      {
        ...
        bjqs.a(localThrowable, alpo.a(2131706387));
        return;
      }
      g();
      continue;
      ...
      if (!this.c.a())
      {
        ...
        continue;
        label541:
        if ((this.jdField_b_of_type_Adcg == null) || ((!this.jdField_b_of_type_Adcg.a()) && (!this.jdField_b_of_type_Adcg.jdField_a_of_type_JavaLangString.equals(localThrowable))))
        {
          this.jdField_b_of_type_Adcg = adcg.a(localThrowable, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          continue;
          label587:
          this.jdField_b_of_type_Adcg = a(localThrowable);
          if (this.jdField_b_of_type_Adcg == null) {
            this.jdField_b_of_type_Adcg = adcg.a(localThrowable, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
          }
          bcxb localbcxb = this.jdField_b_of_type_Adcg.a();
          if (localbcxb != null)
          {
            this.jdField_a_of_type_AndroidWidgetImageSwitcher.setImageDrawable(localbcxb);
            if (QLog.isColorLevel()) {
              QLog.i("UndealCount.Q.lebatab.lebaLebaQZoneFacePlayHelper", 2, "play one" + this.jdField_b_of_type_Adcg.jdField_a_of_type_JavaLangString);
            }
          }
        }
      }
    ...
    {
      this.d = adcg.a((String)this.jdField_a_of_type_JavaUtilArrayList.get(0), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (this.jdField_a_of_type_Boolean)
      {
        this.c = adcg.a((String)this.jdField_a_of_type_JavaUtilArrayList.get(1), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        return;
        label772:
        if (QLog.isColorLevel())
        {
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 1))
    {
      ...
      this.d = adcg.a(paramArrayList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  ...
  void a(boolean paramBoolean)
  {
    ...
    localAlphaAnimation1.setAnimationListener(new adcf(this, paramBoolean));
