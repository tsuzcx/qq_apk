...
public class acti
{
  ...
  public acti(String paramString, WeakReference<actk> paramWeakReference)
  {
    try
    {
    ...
    {
      acqy.d("GdtDrawableLoader", "GdtDrawableLoader error " + paramString, paramWeakReference);
    }
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    acqy.b("GdtDrawableLoader", "notify " + paramBoolean + " " + a());
    this.jdField_a_of_type_Boolean = true;
    if (paramBoolean)
    {
      ((actk)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a(this.jdField_a_of_type_ComTencentImageURLDrawable);
      return;
    }
    ((actk)this.jdField_a_of_type_JavaLangRefWeakReference.get()).b(this.jdField_a_of_type_ComTencentImageURLDrawable);
  }
  ...
  private boolean a()
  {
    ...
    acqy.b("GdtDrawableLoader", "retry " + a());
  ...
  private void b()
  {
    ...
    if ((!b()) || (this.jdField_a_of_type_ComTencentImageURLDrawable == null)) {
      acqy.b("GdtDrawableLoader", "update error " + a());
    }
    for (;;)
    {
      return;
      ...
      {
        acqy.b("GdtDrawableLoader", "drawable status is loading " + a());
        i = j;
      ...
      while ((i != 0) && (!this.jdField_a_of_type_Boolean))
      {
        ...
        {
          acqy.b("GdtDrawableLoader", "drawable status is file downloaded " + a());
          i = j;
        }
        else if (this.jdField_a_of_type_ComTencentImageURLDrawable.getStatus() == 1)
        {
          acqy.b("GdtDrawableLoader", "drawable status is successed " + a());
          a(true);
          i = 0;
        }
        else if (this.jdField_a_of_type_ComTencentImageURLDrawable.getStatus() == 2)
        {
          acqy.d("GdtDrawableLoader", "drawable status is failed " + a());
          i = j;
          if (!a())
          {
            a(false);
        ...
        {
          acqy.d("GdtDrawableLoader", "drawable status is cancled " + a());
          a(false);
          i = 0;
        }
        else
        {
          acqy.d("GdtDrawableLoader", "drawable status is " + this.jdField_a_of_type_ComTencentImageURLDrawable.getStatus() + " " + a());
          i = 0;
        }
      }
    }
  ...
  public void a()
  {
    ...
    acqy.b("GdtDrawableLoader", "load " + a());
    ...
    {
      acqy.d("GdtDrawableLoader", "load error " + a());
      return;
    }
