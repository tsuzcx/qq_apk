...
public class bbas
  implements bbad
{
  public bbas(SignTextEditFragment paramSignTextEditFragment) {}
  ...
  public void a(int paramInt, RichStatus paramRichStatus, Object paramObject)
  {
    ...
    if ((paramRichStatus == null) || (paramRichStatus == RichStatus.getEmptyStatus())) {
      if (paramInt == 100) {
        QQToast.a(BaseApplication.context, 2, anni.a(2131712911), 0).a();
      }
    }
    for (int i = 0;; i = 1)
    {
      ...
      if (paramInt == 100)
      {
        ...
        {
          bbce.a().addObserver(this.a.jdField_a_of_type_JavaUtilObserver);
          paramObject = bbce.a().a(this.a.jdField_a_of_type_ComTencentMobileqqRichstatusRichStatus.tplId);
      ...
      {
        return;
        QQToast.a(BaseApplication.context, 1, anni.a(2131712903), 0).a();
        break;
        int j = i;
