...
public class bbas
{
  ...
  public static int a;
  private static bbax jdField_a_of_type_Bbax;
  ...
  private static final String c = ajyc.a(2131714703);
  
  static
  {
    jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(false);
    jdField_a_of_type_Bbax = new bbax();
  ...
  public static String a(Context paramContext, Uri paramUri, String paramString1, String paramString2)
  {
    ...
    //   28: aload_2
    //   29: aload_3
    //   30: invokestatic 149	bbas:a	(Landroid/content/Context;Ljava/io/InputStream;Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
  ...
  public static void a(Context paramContext, bbav parambbav, acxn paramacxn)
  {
    jdField_a_of_type_Bbax.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    jdField_a_of_type_Bbax.jdField_a_of_type_Acxn = paramacxn;
    parambbav.a(paramacxn);
    parambbav.a(new bbau());
  }
  ...
  {
    if ((paramSessionInfo.jdField_a_of_type_Int != 1) && (paramSessionInfo.jdField_a_of_type_Int != 3000) && (paramSessionInfo.jdField_a_of_type_Int != 0) && (!akpy.d(paramSessionInfo.jdField_a_of_type_Int)))
    {
    ...
    paramViewGroup.setOnDragListener(new bbat(localImageView, localColorDrawable1, paramViewGroup, localColorDrawable2, paramContext, paramQQAppInterface, paramSessionInfo));
  }
  ...
  private static bbaw b(Context paramContext, acun paramacun)
  {
    long l = 0L;
    Object localObject1;
    if ((paramacun instanceof adxc))
    {
      localObject1 = apvk.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramacun.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
      l = bbdj.a((String)localObject1);
      paramacun = paramacun.jdField_a_of_type_AndroidViewView;
    }
    for (;;)
    {
      label76:
      ...
      if (TextUtils.isEmpty((CharSequence)localObject1))
      {
        ...
        if ((paramacun instanceof adxe))
        {
          localObject1 = apvk.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramacun.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
          l = bbdj.a((String)localObject1);
          paramacun = ((adxe)paramacun).a;
          continue;
        }
        if ((paramacun instanceof adwa))
        {
          localObject2 = (MessageForPic)paramacun.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject3 = ((MessageForPic)localObject2).getBiggestFilePath();
          String str = apue.a((String)localObject3);
          int i = bgkh.a((String)localObject3);
          localObject1 = ".jpg";
          if (i == 1001) {
            localObject1 = ".png";
          }
          for (;;)
          {
            ...
            if ((!bbdj.d(((MessageForPic)localObject2).getBiggestFilePath(), (String)localObject1)) || (TextUtils.isEmpty(str))) {
              break label76;
            }
            l = ((MessageForPic)localObject2).size;
            paramacun = ((adwa)paramacun).a;
            break;
            if (i == 1005) {
              localObject1 = ".bmp";
            } else if (i == 2000) {
        ...
        if ((paramacun instanceof adzr))
        {
          localObject2 = (MessageForShortVideo)paramacun.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject1 = ShortVideoUtils.a((MessageForShortVideo)localObject2, "mp4");
          l = ((MessageForShortVideo)localObject2).videoFileSize;
          paramacun = ((adzr)paramacun).a;
          continue;
        }
        if ((paramacun instanceof aeah))
        {
          localObject2 = (MessageForShortVideo)paramacun.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject1 = ShortVideoUtils.a((MessageForShortVideo)localObject2, "mp4");
          l = ((MessageForShortVideo)localObject2).videoFileSize;
          paramacun = ((aeah)paramacun).a;
        }
      }
      else
      {
        ...
        return new bbaw((File)localObject2, paramacun, ClipData.newUri(paramContext.getContentResolver(), "uri", (Uri)localObject1));
      }
      paramacun = null;
      localObject1 = null;
    }
  ...
  private static boolean b(DragEvent paramDragEvent, ImageView paramImageView, ColorDrawable paramColorDrawable1, ViewGroup paramViewGroup, ColorDrawable paramColorDrawable2, Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    paramImageView = new ProgressDialog(paramContext, 2131755791);
    paramImageView.setCancelable(true);
    paramImageView.setContentView(2131559386);
    ((TextView)paramImageView.findViewById(2131371557)).setText(ajyc.a(2131714702));
