...
public class ndq
{
  ...
  private static ndq jdField_a_of_type_Ndq;
  private static int jdField_b_of_type_Int = -1;
  private final List<BusinessObserver> jdField_a_of_type_JavaUtilList = new ArrayList(4);
  private final nds jdField_a_of_type_Nds = new nds(Looper.getMainLooper());
  private final List<BusinessObserver> jdField_b_of_type_JavaUtilList = new ArrayList(4);
  private final nds jdField_b_of_type_Nds = new nds(ThreadManager.getSubThreadHandler());
  
  public static ndq a()
  {
    if (jdField_a_of_type_Ndq == null) {}
    try
    {
      jdField_a_of_type_Ndq = new ndq();
      return jdField_a_of_type_Ndq;
    }
    finally {}
  }
  
  private void a(int paramInt, boolean paramBoolean1, Object paramObject, boolean paramBoolean2, boolean paramBoolean3, BusinessObserver paramBusinessObserver, nds paramnds)
  {
    paramObject = new ObserverCenter.1(this, paramBusinessObserver, paramInt, paramnds, paramBoolean1, paramObject);
    if (paramBoolean2)
    {
      paramnds.a(paramObject, paramBoolean3);
      return;
    }
    paramnds.b(paramObject, paramBoolean3);
  }
    ...
    if ((localList != null) && (localList.size() > 0)) {
      try
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if ((paramClass != null) && (paramClass.isAssignableFrom(localBusinessObserver.getClass()))) {
            a(paramInt, paramBoolean1, paramObject, paramBoolean2, paramBoolean3, localBusinessObserver, this.jdField_a_of_type_Nds);
          }
        }
      }
      finally {}
    ...
    if ((localList != null) && (localList.size() > 0)) {
      try
      {
        ...
        while (localIterator.hasNext())
        {
          localBusinessObserver = (BusinessObserver)localIterator.next();
          if ((paramClass != null) && (paramClass.isAssignableFrom(localBusinessObserver.getClass()))) {
            a(paramInt, paramBoolean1, paramObject, paramBoolean2, paramBoolean3, localBusinessObserver, this.jdField_b_of_type_Nds);
          }
        }
      }
      finally {}
  ...
  public void b(BusinessObserver paramBusinessObserver)
  {
    ...
    //   4: return
    //   5: aload_0
    //   6: getfield 28	ndq:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   9: astore_2
    //   10: aload_2
    //   11: monitorenter
    //   12: aload_0
    //   13: getfield 28	ndq:jdField_b_of_type_JavaUtilList	Ljava/util/List;
    //   16: aload_1
    ...
    //   24: monitorexit
    //   25: aload_0
    //   26: getfield 26	ndq:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   29: astore_2
    //   30: aload_2
    //   31: monitorenter
    //   32: aload_0
    //   33: getfield 26	ndq:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   36: aload_1
