...
{
  public ndq(EqqAccountDetailActivity paramEqqAccountDetailActivity) {}
      ...
      try
      {
        ...
        try
        {
          ...
          if (paramInt == 0)
          {
            ...
            axqy.b(EqqAccountDetailActivity.l(this.a), "CliOper", "", "", this.a.b, this.a.c, 0, 0, "", "", EqqAccountDetailActivity.m(this.a).getCurrentAccountUin(), EqqAccountDetailActivity.l(this.a));
            if (!QLog.isColorLevel()) {
              continue;
            }
