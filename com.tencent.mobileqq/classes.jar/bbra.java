  ...
  implements advu
{
  ...
  private agai jdField_a_of_type_Agai;
  private agfe jdField_a_of_type_Agfe;
  private View jdField_a_of_type_AndroidViewView;
  arkm jdField_a_of_type_Arkm = new bbrc(this);
  private bbrd jdField_a_of_type_Bbrd;
  ...
  public bbra(Context paramContext)
  {
    this.jdField_a_of_type_JavaLangRunnable = new TVKVideoController.4(this);
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    this.jdField_a_of_type_Bbrd = new bbrd(this, null);
    this.jdField_a_of_type_Agai = new agai();
  }
  
  private void a(int paramInt)
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Agai != null))
    {
      this.jdField_a_of_type_Agai.a(paramInt);
      this.jdField_a_of_type_Bbrd.postDelayed(this.jdField_a_of_type_JavaLangRunnable, 100L);
    }
  }
  ...
  private void c()
  {
    ...
    {
      this.jdField_a_of_type_Agai.a(this.jdField_a_of_type_Agfe.a(), str1, this.jdField_a_of_type_Agfe.jdField_a_of_type_ArrayOfJavaLangString, 0L, str2, (Context)this.jdField_a_of_type_JavaLangRefWeakReference.get());
      return;
  ...
  private void d()
  {
    int i = arki.a().a(1, this.jdField_a_of_type_Arkm);
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Agai != null) && (i == 0))
    {
  ...
  private void e()
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Agai != null) && (!this.jdField_b_of_type_Boolean))
    {
      this.jdField_a_of_type_Agai.b();
      this.jdField_a_of_type_Int = 4;
      this.jdField_a_of_type_Bbrd.removeCallbacks(this.jdField_a_of_type_JavaLangRunnable);
    }
  }
  ...
  private void g()
  {
    ...
    do
    {
      return;
      if (QLog.isColorLevel()) {
        QLog.d("TVKVideoController", 2, new Object[] { "clickPlay curState:", Integer.valueOf(this.jdField_a_of_type_Int), " ,isCompleted:", Boolean.valueOf(this.jdField_b_of_type_Boolean), " ,path:", this.jdField_a_of_type_Agfe.jdField_a_of_type_JavaLangString });
      }
  ...
  public void a()
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetQqfloatingscreenListenerIVideoOuterStatusListener = FloatingScreenManager.getInstance().setFloatingVideoListener(new bbrb(this));
  }
  ...
  public void a(agfe paramagfe, long paramLong1, long paramLong2)
  {
    if (QLog.isColorLevel()) {
      QLog.d("TVKVideoController", 2, new Object[] { "initTVKVideoController with mediaInfo :", paramagfe.jdField_a_of_type_JavaLangString });
    }
    this.jdField_a_of_type_Long = paramLong1;
    this.jdField_a_of_type_Agfe = paramagfe;
    this.jdField_a_of_type_Agfe.e = paramLong2;
    if (this.jdField_a_of_type_Agai != null)
    {
      this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_Agai.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_a_of_type_Bbrd, this.jdField_a_of_type_Agfe, null);
      if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_AndroidViewView != null))
      {
        this.jdField_a_of_type_Agai.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), (IVideoViewBase)this.jdField_a_of_type_AndroidViewView);
    ...
    if (bace.b(paramString))
    {
      ...
      if (paramString != null)
      {
        ...
        if (!TextUtils.isEmpty(paramString)) {
          localObject = new amym(Color.rgb(214, 214, 214), paramInt1, paramInt2);
        }
      }
    }
    try
  ...
  public void a(String paramString, long paramLong1, long paramLong2)
  {
    ...
    this.jdField_a_of_type_Long = paramLong1;
    this.jdField_a_of_type_Agfe = new agfe();
    this.jdField_a_of_type_Agfe.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Agfe.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_Agfe.b = l;
    this.jdField_a_of_type_Agfe.d = l;
    this.jdField_a_of_type_Agfe.e = paramLong2;
    if (this.jdField_a_of_type_Agai != null)
    {
      this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_Agai.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_a_of_type_Bbrd, this.jdField_a_of_type_Agfe, null);
  ...
  public boolean a(boolean paramBoolean, int paramInt)
  {
    ...
    if (FloatingScreenManager.getInstance().enterFloatingScreen(BaseApplicationImpl.getContext(), this.jdField_a_of_type_AndroidViewView, localFloatingScreenParams, bbqn.a(paramInt)) == 1)
    {
  ...
  public void b()
  {
    ...
    {
      this.jdField_a_of_type_Bbrd.removeCallbacksAndMessages(null);
