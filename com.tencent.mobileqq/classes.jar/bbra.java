...
public class bbra
{
  ...
  public static bbrb a(String paramString)
  {
    int i = 1;
    bbrb localbbrb = new bbrb();
    if (TextUtils.isEmpty(paramString)) {
      return localbbrb;
    }
    for (;;)
      ...
      try
      {
        ...
        if (j == -1)
        {
          ...
          if (-1 == m)
          {
            ...
            localbbrb.jdField_a_of_type_JavaLangString = paramString;
            localbbrb.jdField_a_of_type_Int = Integer.valueOf(str1).intValue();
            if (i == 0) {
              break;
            }
            localbbrb.b = 1;
          ...
          str1 = str1 + ":" + str2;
          continue;
          localbbrb.jdField_a_of_type_JavaLangString = str2;
          localbbrb.jdField_a_of_type_Int = 0;
          continue;
        }
        j += 3;
      }
  ...
  public static bcil a(long paramLong)
  {
    QQAppInterface localQQAppInterface = a();
    if (localQQAppInterface == null) {
      return null;
    }
    return bcil.a(localQQAppInterface, paramLong);
  }
