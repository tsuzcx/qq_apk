  ...
  implements View.OnClickListener, bkzu, IBrowserItemEventListener
{
  ...
  public bbra(Activity paramActivity, bbqb parambbqb)
  {
    super(paramActivity, parambbqb);
    this.jdField_a_of_type_AndroidOsMessageQueue$IdleHandler = new bbrd(this);
    this.jdField_a_of_type_Bbqb = parambbqb;
  }
  ...
  private void a(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_Bbqb.a(paramLong, paramInt1, 1);
  }
  ...
  private void a(RichMediaBrowserInfo paramRichMediaBrowserInfo, AIOFilePictureData paramAIOFilePictureData, bbpt parambbpt, File paramFile, int paramInt)
  {
    ...
    if (parambbpt.a(paramAIOFilePictureData, 16) != null)
    {
      parambbpt = URLDrawable.getFileDrawable(paramAIOFilePictureData.jdField_b_of_type_JavaLangString, null);
      parambbpt.downloadImediatly();
      localURLDrawableOptions.mLoadingDrawable = parambbpt;
    }
    for (;;)
    {
      ...
      try
      {
        parambbpt = URLDrawable.getFileDrawable(paramFile.getAbsolutePath(), localURLDrawableOptions);
        if (parambbpt != null)
        {
          parambbpt.setTag(Integer.valueOf(1));
          this.jdField_a_of_type_Bbqb.mActiveDrawable.put(Integer.valueOf(paramInt), parambbpt);
          paramFile = paramFile.getAbsolutePath();
          this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.setGalleryImageListener(new bbre(this, paramRichMediaBrowserInfo, paramFile, parambbpt, paramAIOFilePictureData));
          this.jdField_a_of_type_JavaLangRunnable = AIOUtils.showDelayView(this.jdField_b_of_type_AndroidWidgetImageView, parambbpt);
          if ((this.jdField_a_of_type_JavaLangRunnable == null) && (parambbpt.getStatus() == 1))
          {
            a(paramRichMediaBrowserInfo, paramFile, parambbpt, paramInt);
            this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.setImageDrawable(parambbpt);
          }
        }
        else
        {
      ...
      catch (Throwable parambbpt)
      {
        for (;;)
        {
          BrowserLogHelper.getInstance().getGalleryLog().d("AIOGalleryFilePicView", 4, "[getView] URLDrawable.getDrawable failed.");
          parambbpt = localObject;
          continue;
          this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.initDrawable(parambbpt, this.mScreenWidthPx, this.mScreenHeightPx, this.jdField_a_of_type_Bbqb.getRotation(paramRichMediaBrowserInfo.orientation));
        }
      }
    }
  }
  ...
  private void a(RichMediaBrowserInfo paramRichMediaBrowserInfo, AIOFilePictureData paramAIOFilePictureData, File paramFile, int paramInt)
  {
    ...
    catch (Throwable localThrowable)
    {
      try
      {
        ...
        this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.initDrawable(localObject1, this.mScreenWidthPx, this.mScreenHeightPx, this.jdField_a_of_type_Bbqb.getRotation(paramRichMediaBrowserInfo.orientation));
        this.jdField_a_of_type_Bbqb.onLoadFinish(paramInt, true);
        return;
    ...
    if (localObject1 != null) {
      this.jdField_a_of_type_Bbqb.mActiveDrawable.put(Integer.valueOf(paramInt), localObject1);
    }
  ...
  private void a(RichMediaBrowserInfo paramRichMediaBrowserInfo, String paramString, URLDrawable paramURLDrawable, int paramInt)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Bbqb.mActiveDrawable.put(Integer.valueOf(paramInt), paramURLDrawable);
      this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.initDrawable(paramURLDrawable, this.mScreenWidthPx, this.mScreenHeightPx, this.jdField_a_of_type_Bbqb.getRotation(paramRichMediaBrowserInfo.orientation));
      this.jdField_a_of_type_Bbqb.onLoadFinish(paramInt, true);
      return;
    }
  ...
  private void a(File paramFile, AIOFilePictureData paramAIOFilePictureData)
  {
    ...
    if (paramFile == null) {
      localFile = new bbpt().a(paramAIOFilePictureData, 20);
    }
    if (localFile == null)
    {
    ...
    auea.a(this.mContext, localFile.getAbsolutePath());
  }
  ...
  private boolean a(AIOFilePictureData paramAIOFilePictureData, GalleryUrlImageView paramGalleryUrlImageView)
  {
    ...
    Object localObject2 = new bbpt();
    if (((bbpt)localObject2).a(paramAIOFilePictureData, 16) != null)
    {
      ...
      localObject2 = ((bbpt)localObject2).a(paramAIOFilePictureData, 16);
  ...
  private boolean b(AIOFilePictureData paramAIOFilePictureData, GalleryUrlImageView paramGalleryUrlImageView)
  {
    ...
    {
      paramAIOFilePictureData = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838111);
      paramGalleryUrlImageView.setImageDrawable(paramAIOFilePictureData);
      this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.initDrawable(paramAIOFilePictureData, this.mScreenWidthPx, this.mScreenHeightPx, 0);
      bool = true;
    }
  ...
  private void l()
  {
    AIOFilePictureData localAIOFilePictureData = this.jdField_a_of_type_Bbqb.a();
    if ((localAIOFilePictureData != null) && (new bbpt().a(localAIOFilePictureData, 20)))
    {
      if (localAIOFilePictureData.jdField_c_of_type_Long > 0L) {
        a(String.format(Locale.CHINA, this.mContext.getString(2131694771), new Object[] { FileUtil.filesizeToString(localAIOFilePictureData.jdField_c_of_type_Long) }));
      }
    }
    else {
      return;
  ...
  public void a(int paramInt)
  {
    ...
    if (localAIOFilePictureData != null)
    {
      ...
      localObject2 = localbbpt.a(localAIOFilePictureData, 20);
      Object localObject1 = localObject2;
      if (localObject2 == null) {
        localObject1 = localbbpt.a(localAIOFilePictureData, 18);
      }
      localObject2 = localObject1;
      if (localObject1 == null) {
        localObject2 = localbbpt.a(localAIOFilePictureData, 16);
      }
      if ((localObject2 != null) || (!bbph.a().a())) {}
    }
    else
    {
      return;
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetShareShareActionSheet.setItemClickListenerV2(new bbrc(this, paramAIOFilePictureData, paramFile));
  }
  ...
  public void a(AIOFilePictureData paramAIOFilePictureData, File paramFile, int paramInt)
  {
    ...
    if (paramFile != null)
    {
      bhhh.a(2, localArrayList1);
      if ((PicShareToWX.a().a()) && (PicShareToWX.a().a(paramFile))) {
        bhhh.a(9, localArrayList1);
      }
      bhhh.a(27, localArrayList1);
      bhhh.a(39, localArrayList2);
      bhhh.a(6, localArrayList2);
      if ((bbph.a().g()) && (!TextUtils.isEmpty(bbph.a().c()))) {
        bhhh.a(54, localArrayList2);
      }
      if (this.jdField_a_of_type_Boolean) {
        bhhh.a(52, localArrayList2);
      }
    ...
    for (;;)
    {
      ...
      paramAIOFilePictureData = this.jdField_a_of_type_Bbqb.a(paramAIOFilePictureData, this.mContext);
  ...
  public void ad_()
  {
    this.jdField_a_of_type_Bbqb.updateSystemUIVisablity();
  }
  ...
  public boolean b()
  {
    if (super.b())
    {
      ...
      {
        bbpt localbbpt = new bbpt();
        File localFile2 = localbbpt.a(localAIOFilePictureData, 20);
        File localFile1 = localFile2;
        if (localFile2 == null) {
          localFile1 = localbbpt.a(localAIOFilePictureData, 18);
        }
        if ((localFile1 != null) || (!bbph.a().a())) {
          break label67;
        }
      }
    }
    label67:
    while ((bbph.a().a()) || (bbph.a().c())) {
      return false;
    }
    return true;
  }
  ...
  public void bindView(int paramInt)
  {
    ...
    RichMediaBrowserInfo localRichMediaBrowserInfo = this.jdField_a_of_type_Bbqb.getItem(paramInt);
    ...
    {
      a(this.jdField_a_of_type_Bbqb.a(), localRichMediaBrowserInfo);
      ...
      URLDrawable localURLDrawable = (URLDrawable)this.jdField_a_of_type_Bbqb.mActiveDrawable.get(Integer.valueOf(paramInt));
      String str2 = localbbpt.a(localAIOFilePictureData, 20);
      String str3 = localbbpt.a(localAIOFilePictureData, 18);
      String str4 = localbbpt.a(localAIOFilePictureData, 16);
      String str1 = "";
      localObject = str1;
      ...
      localObject = localbbpt.a(localAIOFilePictureData, 20);
      ...
      this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.initDrawable(localURLDrawable, this.mScreenWidthPx, this.mScreenHeightPx, this.jdField_a_of_type_Bbqb.getRotation(localRichMediaBrowserInfo.orientation));
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.setMainBrowserPresenter(this.jdField_a_of_type_Bbqb.mainBrowserPresenter);
      localObject = new bbrf(this);
      ((bbrf)localObject).jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView = this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView;
      ((bbrf)localObject).jdField_a_of_type_AndroidWidgetTextView = this.jdField_c_of_type_AndroidWidgetTextView;
      ((bbrf)localObject).jdField_a_of_type_AndroidWidgetImageView = this.jdField_c_of_type_AndroidWidgetImageView;
      ...
      if (localObject != null)
      {
        a(localRichMediaBrowserInfo, localAIOFilePictureData, localbbpt, (File)localObject, paramInt);
      }
      else
      {
        localObject = localbbpt.a(localAIOFilePictureData, 18);
        if (localObject != null)
        {
          a(localRichMediaBrowserInfo, localAIOFilePictureData, (File)localObject, paramInt);
        }
        else if (localbbpt.a(localAIOFilePictureData, 16) != null)
        {
          ...
          BrowserLogHelper.getInstance().getGalleryLog().d("AIOGalleryFilePicView", 4, "getView(): url is " + localbbpt.a(localAIOFilePictureData, 16) + ", file type is " + 16);
        }
        else
        {
          if ((!aufd.a(localAIOFilePictureData.jdField_e_of_type_Int, localAIOFilePictureData.f, localAIOFilePictureData.jdField_e_of_type_Long)) && (localAIOFilePictureData.jdField_g_of_type_Int != 1))
          {
          ...
          localObject = BaseApplicationImpl.getApplication().getResources().getDrawable(2130844234);
          this.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
          this.jdField_c_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
          this.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
          this.jdField_c_of_type_AndroidWidgetTextView.setText(2131692333);
          this.jdField_a_of_type_Bbqb.a().b();
        }
      }
    }
  }
  ...
  public boolean c()
  {
    if ((this.mContext.getIntent().getBooleanExtra("extra.FROM_AIO", false)) || (bbph.a().c() == 3) || (bbph.a().c() == 2)) {}
    for (int i = 1;; i = 0)
    {
  ...
  public void e(boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_Bbqb.a() != null) && (this.jdField_a_of_type_Bbqb.a().b()))
    {
      this.jdField_a_of_type_Bbqb.a().jdField_a_of_type_Boolean = false;
      return;
    }
    showContentView(false);
    b(false);
    this.jdField_a_of_type_Bbqb.a().g();
  }
  ...
  {
    if (((paramView instanceof RelativeLayout)) && ((paramView.getTag() instanceof bbrf)))
    {
      this.mBrowserItemView = ((RelativeLayout)paramView);
      paramView = (bbrf)paramView.getTag();
    ...
    for (;;)
    {
      ...
      paramView.addRule(3, 2131366410);
      ...
      this.jdField_c_of_type_AndroidWidgetImageView.setId(2131366410);
  ...
  public void i()
  {
    ...
    if ((localAIOFilePictureData != null) && (RichMediaBrowserManager.getInstance().getProvider() != null) && (RichMediaBrowserManager.getInstance().getProvider().isPingBinder()))
    {
      ...
      {
        QQToast.a(this.mContext, this.mContext.getString(2131693647), 0).a();
        updateUI();
      }
    }
    else {
    ...
    {
      QQToast.a(this.mContext, this.mContext.getString(2131692622), 0).a();
      updateUI();
      return;
    }
    ...
    long l = atpj.a();
    if ((localAIOFilePictureData.jdField_e_of_type_Long > l) && (auea.a())) {
      try
      {
        auea.a(false, this.mContext, new bbrb(this, localAIOFilePictureData));
        return;
      }
      catch (Throwable localThrowable)
      {
    ...
    this.jdField_a_of_type_Bbqb.a(localThrowable.jdField_a_of_type_Long, localThrowable.jdField_a_of_type_Int, 2);
  ...
  void j()
  {
    ...
    default: 
      ...
      if (d())
      {
        localObject2 = RichMediaBrowserManager.getInstance().getProvider().getForwardData(localAIOFilePictureData.jdField_a_of_type_Long, localAIOFilePictureData.jdField_a_of_type_Int, bbph.a().a());
        if (localObject2 != null)
        {
  ...
  public void k()
  {
    if (this.mBrowserItemView != null)
    {
      ...
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.mBrowserItemView.findViewById(2131374361));
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      return;
      Object localObject = this.jdField_a_of_type_Bbqb.getSelectedItem();
      if ((localObject != null) && (((RichMediaBrowserInfo)localObject).baseData != null) && (((RichMediaBrowserInfo)localObject).baseData.getType() == 102))
      {
        this.jdField_a_of_type_Bbqb.back();
        continue;
        localObject = this.jdField_a_of_type_Bbqb.a();
        if (localObject != null)
        {
          if (RichMediaBrowserManager.getInstance().getProvider() != null) {
          ...
          this.jdField_a_of_type_Bbqb.a(((AIOFilePictureData)localObject).jdField_a_of_type_Long, ((AIOFilePictureData)localObject).jdField_a_of_type_Int, 0);
          updateUI();
          continue;
          d();
          continue;
          ...
          localObject = this.jdField_a_of_type_Bbqb.a();
          if (localObject != null) {
            MiniChatActivity.a(this.mContext, bbph.a().a(), bbph.a().a(), false, 26, ((AIOFilePictureData)localObject).jdField_d_of_type_Long, 0L);
          }
          this.jdField_a_of_type_Bbqb.l();
        }
      }
    }
  }
  ...
  public void onItemSelected(int paramInt)
  {
    ...
    AIOFilePictureData localAIOFilePictureData = this.jdField_a_of_type_Bbqb.a();
    if ((localAIOFilePictureData != null) && (!this.jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView.isOriginalImage()) && ((localObject instanceof SkinnableBitmapDrawable)) && (localAIOFilePictureData.jdField_b_of_type_Int == 1) && (localAIOFilePictureData.jdField_c_of_type_Long > atpj.c()))
    {
    ...
    if (localAIOFilePictureData != null)
    {
      localObject = new bbpt();
      if ((((bbpt)localObject).a(localAIOFilePictureData, 20) == null) && (((bbpt)localObject).a(localAIOFilePictureData, 18) == null) && (((bbpt)localObject).a(localAIOFilePictureData, 16) == null) && ((aufd.a(localAIOFilePictureData.jdField_e_of_type_Int, localAIOFilePictureData.f, localAIOFilePictureData.jdField_e_of_type_Long)) || (localAIOFilePictureData.jdField_g_of_type_Int == 1))) {
        this.jdField_a_of_type_Bbqb.a().b();
      }
    }
    updateUI();
  ...
  public void updateUI()
  {
    ...
    case 1: 
      ...
      g(false);
      d(false);
      this.jdField_a_of_type_Bbqb.onLoadStart(this.jdField_a_of_type_Bbqb.getSelectedIndex(), localAIOFilePictureData.progress);
      return;
    case 2: 
      this.jdField_a_of_type_Bbqb.onLoadFinish(this.jdField_a_of_type_Bbqb.getSelectedIndex(), true);
      f(false);
      c(false);
      g(false);
      d(false);
      this.jdField_a_of_type_AndroidWidgetTextView.setText(anvx.a(2131699561) + localAIOFilePictureData.progress / 100 + "%");
    ...
    c(b());
    d(a(this.jdField_a_of_type_Bbqb.getSelectedItem()));
    boolean bool;
    bbpt localbbpt;
    ...
    for (;;)
    {
      ...
      break;
      label324:
      if ((localbbpt.a(localAIOFilePictureData, 18) != null) || (localbbpt.a(localAIOFilePictureData, 20) != null)) {
        h(true);
      } else {
        h(false);
      }
  ...
  {
    paramString1 = null;
    paramString2 = this.jdField_a_of_type_Bbqb.getItem(paramInt);
    Object localObject;
    ImageView localImageView;
    AIOFilePictureData localAIOFilePictureData;
    if ((paramString2 != null) && (paramString2.baseData != null) && (paramString2.baseData.getType() == 102) && (this.mBrowserItemView != null) && ((paramView.getTag() instanceof bbrf)))
    {
      localObject = (bbrf)paramView.getTag();
      paramView = ((bbrf)localObject).jdField_a_of_type_ComTencentRichmediabrowserViewRecyclerviewBrowserScaleView;
      localImageView = ((bbrf)localObject).jdField_a_of_type_AndroidWidgetImageView;
      localObject = ((bbrf)localObject).jdField_a_of_type_AndroidWidgetTextView;
      localAIOFilePictureData = (AIOFilePictureData)paramString2.baseData;
      paramString2 = new bbpt();
    ...
    for (paramString2 = paramString1.getURL().getRef();; paramString2 = null)
    {
      ...
      do
      {
        ...
        if ((aufd.a(localAIOFilePictureData.jdField_e_of_type_Int, localAIOFilePictureData.f, localAIOFilePictureData.jdField_e_of_type_Long)) || (localAIOFilePictureData.jdField_g_of_type_Int == 1))
        {
          paramString1 = BaseApplicationImpl.getApplication().getResources().getDrawable(2130844234);
          localImageView.setVisibility(0);
          localImageView.setImageDrawable(paramString1);
          ((TextView)localObject).setVisibility(0);
          ((TextView)localObject).setText(2131692333);
          this.jdField_a_of_type_Bbqb.a().b();
        }
        for (;;)
        {
          this.jdField_a_of_type_Bbqb.onLoadFinish(paramInt, false);
          this.jdField_a_of_type_Bbqb.a().d();
          return;
          paramString1 = BaseApplicationImpl.getApplication().getResources().getDrawable(2130838111);
          paramView.setImageDrawable(paramString1);
      ...
      this.jdField_a_of_type_Bbqb.a().c();
      return;
    }
  }
}
