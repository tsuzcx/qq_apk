...
{
  public aerq(QQAppInterface paramQQAppInterface, String paramString, int paramInt, long paramLong1, long paramLong2) {}
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          ArrayList localArrayList1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(paramDownResult.jdField_a_of_type_ArrayOfByte, (HashMap)localObject1, null, (MessageInfo)localObject4);
          ...
          if (((MessageRecord)localArrayList1.get(0)).msgtype == -1035)
          {
            ...
            ((MixedMsgManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(173)).a(true, this.jdField_a_of_type_Int);
            ...
            {
              if (((MessageInfo)localObject4).c.jdField_a_of_type_Long != -1L) {
                ((MessageInfo)localObject4).c.b = this.jdField_a_of_type_Long;
              }
              if (((MessageInfo)localObject4).jdField_a_of_type_ComTencentMobileqqTroopDataMessageNavInfo.jdField_a_of_type_Long != -1L) {
                ((MessageInfo)localObject4).jdField_a_of_type_ComTencentMobileqqTroopDataMessageNavInfo.b = this.jdField_a_of_type_Long;
              }
              ...
              if ((localMessageRecord.shmsgseq > l) && (((MessageInfo)localObject4).a()))
              {
                ...
                localObject4 = (BaseMessageManagerForTroopAndDisc)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(1);
            ...
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(1000, true, this.jdField_a_of_type_JavaLangString);
            if (QLog.isColorLevel()) {
            ...
            ((LongTextMsgManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(165)).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Int, paramDownResult.jdField_a_of_type_Int, 1);
            return;
          }
      ...
      if ((localObject2 instanceof MessageForLongTextMsg))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(999, true, this.jdField_a_of_type_JavaLangString);
      }
      if (QLog.isColorLevel())
      {
