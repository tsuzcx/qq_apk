...
class atha
  extends mxl
{
  atha(atgz paramatgz, atgx paramatgx) {}
    ...
    if ((paramInt == 0) && (paramArrayOfByte != null))
    {
      ...
      if (paramArrayOfByte.lists.has())
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if (!atgz.a(this.jdField_a_of_type_Atgz).contains(Long.valueOf(localComment.comment_id.get()))) {
            atgz.a(this.jdField_a_of_type_Atgz).add(Long.valueOf(localComment.comment_id.get()));
          }
      ...
      this.jdField_a_of_type_Atgx.a(paramBundle);
      return;
    }
