  ...
  implements axrt
{
  ...
  static axrs jdField_a_of_type_Axrs = new athb();
  private axrr jdField_a_of_type_Axrr;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private List<athc> jdField_a_of_type_JavaUtilList = new Vector();
  Set<String> jdField_a_of_type_JavaUtilSet = Collections.synchronizedSet(new HashSet());
  
  public atha(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(String paramString1, String paramString2, Object paramObject, int paramInt1, boolean paramBoolean, int paramInt2, String paramString3)
  {
    ...
    localaxro.c = paramString3;
    localaxro.e = 1;
    localaxro.a(new Object[] { paramString2, paramObject, Integer.valueOf(paramInt1), Boolean.valueOf(paramBoolean), Integer.valueOf(paramInt2) });
  ...
  public void a(athc paramathc)
  {
    if (paramathc == null) {}
    while (this.jdField_a_of_type_JavaUtilList.contains(paramathc)) {
      return;
    }
    this.jdField_a_of_type_JavaUtilList.add(paramathc);
  }
    ...
    for (String str1 = ".mp4";; str2 = "")
    {
      if (!a(paramString2, str1))
      {
        ...
        if ((paramObject != null) && ((paramObject instanceof String[])))
        {
          ...
          if ((paramObject != null) && ("shuayishua_anim".equals(paramObject)))
          {
            ...
            if ((bace.a((String)localObject)) && (bace.a(str3)) && (bace.a(str4)) && (bace.a(str5))) {}
          }
        }
        try
        {
          ...
          bace.a(a() + paramString2, str1, false);
          if (QLog.isColorLevel()) {
        ...
        try
        {
          ...
          bace.a(a() + paramString2, paramString1, false);
          if (QLog.isColorLevel()) {
      ...
      if (paramBoolean2)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            atiu.b("OlympicResources", new Object[] { "download, checkLimit == false, url=", paramString1 });
            return true;
          }
      ...
      ((axro)localObject).jdField_a_of_type_Axrt = this;
      ((axro)localObject).jdField_a_of_type_JavaLangString = paramString1;
      ((axro)localObject).jdField_a_of_type_Int = 0;
      ((axro)localObject).c = (a() + paramString2 + localException);
      ((axro)localObject).e = 1;
      ((axro)localObject).a(new Object[] { paramString2, paramObject, Integer.valueOf(0), Boolean.valueOf(paramBoolean1), Integer.valueOf(paramInt) });
      ((axro)localObject).jdField_a_of_type_Axrs = jdField_a_of_type_Axrs;
      this.jdField_a_of_type_Axrr.a((axsp)localObject);
      return true;
    }
  }
  
  public void b(athc paramathc)
  {
    if (paramathc == null) {
      return;
    }
    this.jdField_a_of_type_JavaUtilList.remove(paramathc);
  }
  ...
  public void onResp(axsq paramaxsq)
  {
    ...
    if (paramaxsq.jdField_a_of_type_Int == 0)
    {
      ...
      localObject2 = new File(localaxro.c);
      ...
      localObject1 = attn.a(((File)localObject2).getAbsolutePath());
    ...
    for (;;)
    {
      ...
      if ((j == 1) || (j == 2))
      {
        if (j == 1)
        {
          ...
          localHashMap.put("url", atiu.a(localaxro.jdField_a_of_type_JavaLangString));
          ...
          {
            localObject3 = str2;
            if (paramaxsq.jdField_a_of_type_JavaUtilHashMap.containsKey("netresp_param_reason")) {
              localObject3 = (String)paramaxsq.jdField_a_of_type_JavaUtilHashMap.get("netresp_param_reason");
            }
          }
          ...
          awrn.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), (String)localObject2, true, 0L, l, localHashMap, "", false);
          atiu.b("OlympicResources", new Object[] { "onResp report Download, reportKey=", localObject2, ", errcode=", Integer.valueOf(i), ", url=", localaxro.jdField_a_of_type_JavaLangString });
        }
      }
      else
      {
        ...
        label499:
        if (QLog.isColorLevel()) {
          QLog.i("OlympicResources", 2, "onResp.url=" + localaxro.jdField_a_of_type_JavaLangString + ", result=" + paramaxsq.jdField_a_of_type_Int + ", errCode=" + i + ",md5 = " + (String)localObject1);
        }
        j = 0;
        for (;;)
        {
          ...
          {
            localObject4 = (athc)this.jdField_a_of_type_JavaUtilList.get(j);
            if (localObject4 != null) {
              ((athc)localObject4).a(localaxro.jdField_a_of_type_JavaLangString, (String)localObject1, localObject2, i, (String)localObject3);
            }
            j += 1;
            continue;
            bool1 = false;
            ...
            if (QLog.isColorLevel()) {
              QLog.i("OlympicResources", 2, "onResp.retry.url=" + localaxro.jdField_a_of_type_JavaLangString + ",md5=" + (String)localObject4 + ", result=" + paramaxsq.jdField_a_of_type_Int + ", errCode=" + i + ",retryCount=" + k);
            }
            a(localaxro.jdField_a_of_type_JavaLangString, (String)localObject4, localObject5, k + 1, bool2, j, localaxro.c);
          }
        }
      }
      label807:
      ...
      while (bool1)
      {
        for (;;)
        {
          ...
          try
          {
            ...
            awrn.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), (String)localObject2, false, 0L, 0L, localHashMap, "", false);
          }
        ...
        ((File)localObject2).delete();
        awrn.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "olympic_down_null", bool1, 0L, 0L, null, "", false);
        localObject3 = null;
        localObject2 = null;
        localObject1 = null;
        break label499;
      }
      QLog.i("OlympicResources", 1, "onResp.url=" + localaxro.jdField_a_of_type_JavaLangString + ", result=" + paramaxsq.jdField_a_of_type_Int + ", errCode=" + i + ",md5 = " + (String)localObject1 + ", errDesc=" + str1);
      return;
      label1015:
      localObject1 = null;
      l = 0L;
  ...
  public void onUpdateProgeress(axsp paramaxsp, long paramLong1, long paramLong2)
  {
    ...
    if ((paramaxsp == null) || (!(paramaxsp instanceof axro))) {
      return;
    }
    String str = ((axro)paramaxsp).jdField_a_of_type_JavaLangString;
    paramaxsp = paramaxsp.a();
    if ((paramaxsp != null) && ((paramaxsp instanceof Object[])))
    {
      localObject = (Object[])paramaxsp;
      paramaxsp = (String)localObject[0];
      localObject = localObject[1];
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.i("OlympicResources", 2, "onUpdateProgeress.url=" + str + ", md5=" + paramaxsp + ", userData=" + localObject + ",curOffset=" + paramLong1 + ",totalLen=" + paramLong2);
      }
      int i = 0;
      while (i < this.jdField_a_of_type_JavaUtilList.size())
      {
        athc localathc = (athc)this.jdField_a_of_type_JavaUtilList.get(i);
        if (localathc != null) {
          localathc.a(str, paramaxsp, localObject, paramLong1, paramLong2);
        }
        i += 1;
      }
      break;
