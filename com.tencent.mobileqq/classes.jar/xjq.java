...
public final class xjq
{
  ...
  public static boolean a(Context paramContext, zll paramzll)
  {
    if (paramzll == null) {
      return false;
    }
    return a(paramContext, String.valueOf(paramzll.jdField_a_of_type_Long), String.valueOf(paramzll.jdField_a_of_type_Int));
  }
