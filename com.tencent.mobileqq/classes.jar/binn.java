...
public class binn
{
  ...
  private OnPluginInstallListener jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener = new bino(this);
  
  public binn(Context paramContext, bimg parambimg, QQAppInterface paramQQAppInterface)
  {
  ...
  private List<String> a()
  {
    ...
    if (bdee.a(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      if (i < k)
      {
        ...
        if ((str.equals("Photoplus.apk")) && (bhou.d())) {}
        for (;;)
        {
          i += 1;
          break;
    ...
    if ((bdcb.e()) || (bdcs.a() <= 1.048576E+008F))
    {
  ...
  private void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    localEditor.commit();
    this.jdField_a_of_type_Bimg.a(paramString, this.jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener, true);
    if (("qqreaderplugin.apk".equals(paramString)) && (bive.a(this.jdField_a_of_type_AndroidContentContext) == -1))
    {
    ...
    biij.a(1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  private void c()
  {
    if (!PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_AndroidContentContext).getString("plugin_pre_install_qq_version", "").equals(bdcb.c()))
    {
      SharedPreferences.Editor localEditor = PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_AndroidContentContext).edit();
  ...
  public void a()
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        try
        {
          if (this.jdField_a_of_type_Bimg.isPlugininstalled(str)) {
            continue;
          }
          int i = a(str);
          if (i >= 10) {
