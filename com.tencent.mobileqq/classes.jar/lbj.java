...
public class lbj
{
  ...
  private static lbg jdField_a_of_type_Lbg;
  
  /* Error */
  public static lbf a(Context paramContext)
  {
    // Byte code:
    //   0: getstatic 17	lbj:jdField_a_of_type_Lbf	Llbf;
    //   3: ifnonnull +81 -> 84
    //   6: aload_0
    //   7: ldc 19
    ...
    //   56: ldc 2
    //   58: monitorenter
    //   59: getstatic 17	lbj:jdField_a_of_type_Lbf	Llbf;
    //   62: astore_2
    //   63: aload_2
    //   64: ifnonnull +17 -> 81
    //   67: new 62	lbf
    ...
    //   73: iload_1
    //   74: i2l
    //   75: invokespecial 65	lbf:<init>	(Landroid/content/Context;IJ)V
    //   78: putstatic 17	lbj:jdField_a_of_type_Lbf	Llbf;
    //   81: ldc 2
    //   83: monitorexit
    //   84: getstatic 17	lbj:jdField_a_of_type_Lbf	Llbf;
    //   87: areturn
    //   88: astore_0
  ...
  public static lbg a(Context paramContext)
  {
    try
    {
      if (jdField_a_of_type_Lbg == null) {
        jdField_a_of_type_Lbg = new lbg(65536);
      }
      return jdField_a_of_type_Lbg;
    }
    finally {}
  }
  
  public static lbf b(Context paramContext)
  {
