...
public class atmh
{
  ...
  private List<atmn> jdField_a_of_type_JavaUtilList;
  private int b = 0;
  
  public atmh(QQAppInterface paramQQAppInterface)
  {
  ...
  private boolean a()
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if ((this.jdField_a_of_type_JavaLangString == null) || (this.jdField_a_of_type_JavaLangString.trim().length() == 0) || (this.jdField_a_of_type_JavaLangString.equals(localFileManagerEntity.peerUin)))
      {
        ...
        {
          i += 1;
          this.jdField_a_of_type_JavaUtilList.add(atmg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localFileManagerEntity));
          break;
        }
      }
    }
  ...
  private boolean a(ForwardFileInfo paramForwardFileInfo)
  {
    ...
    while (paramForwardFileInfo.hasNext())
    {
      ...
      if (localObject != null)
      {
        if (atwl.b(((FileManagerEntity)localObject).getFilePath())) {
        ...
        {
          this.jdField_a_of_type_JavaUtilList.add(atmg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (FileManagerEntity)localObject));
          i += 1;
          break;
        }
      }
  ...
  private boolean b()
  {
    ...
    if ((localObject2 != null) && (((Set)localObject2).size() > 0))
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (((FileInfo)localObject3).a() == 0) {
          this.jdField_a_of_type_JavaUtilList.add(atmg.a((FileInfo)localObject3));
        }
      }
    }
    if ((localObject1 != null) && (((ArrayList)localObject1).size() > 0))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (atvo.a(((WeiYunFileInfo)localObject2).c) == 0) {
          this.jdField_a_of_type_JavaUtilList.add(atmg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (WeiYunFileInfo)localObject2));
        }
      }
    }
  ...
  private boolean b(Intent paramIntent)
  {
    ...
    if (paramIntent.hasNext())
    {
      ...
      if ((i == 0) && (((FileInfo)localObject).hashCode() == k))
      {
        ...
        this.jdField_a_of_type_JavaUtilList.add(atmg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity));
        i = 1;
      }
      for (;;)
      {
        j += 1;
        break;
        this.jdField_a_of_type_JavaUtilList.add(atmg.a((FileInfo)localObject));
      }
    }
    athc.a();
    return true;
  ...
  private boolean c(Intent paramIntent)
  {
    ...
    while (paramIntent.hasNext())
    {
      ...
      do
      {
        ...
        {
          i += 1;
          this.jdField_a_of_type_JavaUtilList.add(atmg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localWeiYunFileInfo));
          break;
        } while (atvo.a(localWeiYunFileInfo.c) == 0);
  ...
  {
    return new atmi(this, paramBaseActivity);
  }
  
  public atmn a()
  {
    return this.jdField_a_of_type_Atmn;
  }
  ...
  public boolean a(Intent paramIntent)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity = bdhu.a(localForwardFileInfo);
    }
    ...
    if (5 != this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.cloudType) {
      atvo.b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
    }
    boolean bool;
    ...
    {
      this.jdField_a_of_type_Atmn = atmg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
      this.b = 3;
      return true;
    }
    return bool;
