...
public class atmh
{
  ...
  public static MessageRecord a(atmo paramatmo)
  {
    if (paramatmo != null) {}
    try
    {
    ...
    catch (Exception paramatmo)
    {
      if (QLog.isColorLevel()) {
        QLog.e("Cursor2EntityConvert", 2, "postRead exception = " + paramatmo.getMessage());
      }
      return null;
    }
      ...
      for (l = paramCursor.getLong(paramCursor.getColumnIndex("_id"));; l = -1L)
      {
        try
        {
          if (paramClass.getName().equals(MessageRecord.class.getName()))
          {
            ...
            paramClass = awbi.a(i, arrayOfByte, j, str, k);
            ...
            if (!this.jdField_a_of_type_Boolean)
            {
              ...
              a(atnp.b(paramClass), paramCursor);
            }
