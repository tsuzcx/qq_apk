...
{
  public nbx(FeedCommentLikeLego paramFeedCommentLikeLego) {}
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131371732: 
      ...
      if (this.a.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelBannerHomeFeed != null)
      {
        ...
        FeedCommentLikeLego.a(this.a).a(this.a.jdField_a_of_type_AndroidContentContext.getString(2131433100)).a(new nby(this)).a(new BannerWebShareMode((BannerFeedItem)this.a.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelBannerHomeFeed.a())).a();
        return;
      }
      localObject1 = null;
      paramView = null;
    ...
    for (;;)
    {
      ...
      if ((this.a.jdField_a_of_type_ComTencentBizQqstoryShareGroupModelShareGroupItem != null) && (this.a.jdField_a_of_type_ComTencentBizQqstoryShareGroupModelShareGroupItem.allowStrangerVisitAndPost == 1))
      {
        ...
        for (paramView = "1";; paramView = "0")
        {
          ...
          return;
          localObject2 = this.a.jdField_a_of_type_AndroidContentContext.getString(2131433100);
          break;
          label1662:
          paramView = "0";
          break label1583;
      ...
      {
        localObject2 = "分享我的一天";
        localObject1 = ((StoryShare)localObject3).a((String)localObject2).a(new nca(this)).a(new FeedDetailShareMode(paramView, this.a.jdField_a_of_type_ComTencentBizQqstoryStoryHomeModelCommentLikeFeedItem.feedId, ((List)localObject1).size()));
        if (!bool1) {
          break label1830;
        }
        paramView = "1";
