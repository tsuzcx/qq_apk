  ...
  extends GestureDetector.SimpleOnGestureListener
{
  ...
  public uwn(SwipeBackLayout paramSwipeBackLayout, Context paramContext)
  {
  ...
  public boolean onFling(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2, float paramFloat1, float paramFloat2)
  {
    ...
    if (SwipeBackLayout.b(this.jdField_a_of_type_ComTencentBizPubaccountUtilSwipeBackLayout))
    {
      ...
      {
        bool1 = bool2;
        if (!this.jdField_a_of_type_ComTencentBizPubaccountUtilSwipeBackLayout.jdField_a_of_type_Uvq.a())
        {
          bool1 = bool2;
