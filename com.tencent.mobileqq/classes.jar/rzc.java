...
public class rzc
  implements ComponentConstant.Event, qvp, ryr, ryu, rzb
{
  private int a;
  ...
  public rzc(Activity paramActivity, ryq paramryq, VVideoView paramVVideoView)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewVideoPlayManager.a(paramryq);
    ...
    this.jdField_a_of_type_Ryq.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewVideoPlayManager);
    this.jdField_a_of_type_Ryq.setEventListener(this);
  ...
  public void a(VVideoView paramVVideoView, JSONObject paramJSONObject)
  {
    ...
    paramVVideoView = this.jdField_a_of_type_Ryq.a();
    try
    {
      paramVVideoView = new rza(paramVVideoView, paramJSONObject);
      if (paramVVideoView != null)
      {
        ...
        if (paramVVideoView.b)
        {
          ...
          this.jdField_a_of_type_Ryq.a(paramVVideoView);
        }
      }
      else
      {
  ...
  {
    boolean bool = false;
    this.jdField_a_of_type_Ryq.a(0, paramBoolean);
    try
    {
      paramVVideoView = new JSONObject();
      paramBoolean = bool;
  ...
  public void a(rza paramrza, long paramLong)
  {
    ...
    {
      paramrza = new JSONObject();
      paramrza.put("currentTime", a(paramLong));
      paramrza.put("totalTime", this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewVideoPlayManager.a() / 1000L);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViolaVideonewVVideoView.a("playTimeChange", paramrza);
      return;
    }
    catch (Exception paramrza)
    {
      paramrza.printStackTrace();
    }
  }
  ...
  public boolean a()
  {
    return this.jdField_a_of_type_Ryq.a();
  }
  ...
  public void b(VVideoView paramVVideoView, int paramInt)
  {
    ...
    this.jdField_a_of_type_Ryq.setControlType(this.jdField_a_of_type_Int);
  }
  ...
  {
    boolean bool = true;
    this.jdField_a_of_type_Ryq.a(1);
    try
    {
      paramVVideoView = new JSONObject();
      if (this.jdField_a_of_type_Int == 2) {}
  ...
  {
    this.jdField_a_of_type_Ryq.setFullScreenDisable(paramBoolean);
  }
  ...
  {
    this.jdField_a_of_type_Ryq.setEndWithLastFrame(paramBoolean);
  }
