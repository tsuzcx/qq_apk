...
public class rru
{
  ...
  public rru()
  {
    ...
    this.jdField_a_of_type_Rom = new rom();
  }
  
  private static rru b(articlesummary.WendaInfo paramWendaInfo)
  {
    boolean bool = true;
    rru localrru = new rru();
    ...
    for (;;)
    {
      localrru.jdField_a_of_type_Boolean = bool;
      if (paramWendaInfo.bytes_question_rowkey.has()) {
        localrru.jdField_a_of_type_JavaLangString = paramWendaInfo.bytes_question_rowkey.get().toStringUtf8();
      }
      if (paramWendaInfo.bytes_question_desc.has()) {
        localrru.jdField_b_of_type_JavaLangString = paramWendaInfo.bytes_question_desc.get().toStringUtf8();
      }
      if (paramWendaInfo.bytes_question_pic_url.has()) {
        localrru.jdField_c_of_type_JavaLangString = paramWendaInfo.bytes_question_pic_url.get().toStringUtf8();
      }
      if (paramWendaInfo.bytes_wenda_url.has()) {
        localrru.jdField_d_of_type_JavaLangString = paramWendaInfo.bytes_wenda_url.get().toStringUtf8();
      }
      if (paramWendaInfo.uint32_follow_count.has()) {
        localrru.jdField_a_of_type_Int = paramWendaInfo.uint32_follow_count.get();
      }
      if (paramWendaInfo.uint32_answer_count.has()) {
        localrru.jdField_b_of_type_Int = paramWendaInfo.uint32_answer_count.get();
      }
      if (paramWendaInfo.bytes_icon_url.has()) {
        localrru.e = paramWendaInfo.bytes_icon_url.get().toStringUtf8();
      }
      if (paramWendaInfo.bytes_answer_url.has()) {
        localrru.f = paramWendaInfo.bytes_answer_url.get().toStringUtf8();
      }
      if (paramWendaInfo.channel_id.has()) {
        localrru.jdField_c_of_type_Int = paramWendaInfo.channel_id.get();
      }
      if (paramWendaInfo.channel_id_name.has()) {
        localrru.h = paramWendaInfo.channel_id_name.get();
      }
      if (paramWendaInfo.channel_second_id.has()) {
        localrru.jdField_d_of_type_Int = paramWendaInfo.channel_second_id.get();
      }
      if (paramWendaInfo.channel_second_id_name.has()) {
        localrru.i = paramWendaInfo.channel_second_id_name.get();
      }
      if (paramWendaInfo.tag_id.has()) {
        localrru.jdField_a_of_type_JavaUtilList = paramWendaInfo.tag_id.get();
      }
      if (paramWendaInfo.tag_id_name.has()) {
        localrru.jdField_b_of_type_JavaUtilList = paramWendaInfo.tag_id_name.get();
      }
      if (paramWendaInfo.author_nick.has()) {
        localrru.j = paramWendaInfo.author_nick.get();
      }
      if (paramWendaInfo.jump_url.has()) {
        localrru.k = paramWendaInfo.jump_url.get();
      }
      if (paramWendaInfo.images_url.has()) {
        localrru.jdField_c_of_type_JavaUtilList = paramWendaInfo.images_url.get();
      }
      if (paramWendaInfo.icon_name.has()) {
        localrru.l = paramWendaInfo.icon_name.get();
      }
      if (paramWendaInfo.icon_color.has()) {
        localrru.m = paramWendaInfo.icon_color.get();
      }
      if (paramWendaInfo.super_wenda_button_title.has()) {
        localrru.n = paramWendaInfo.super_wenda_button_title.get();
      }
      if (paramWendaInfo.answer_detail.has()) {
        localrru.a((articlesummary.AnswerDetail)paramWendaInfo.answer_detail.get());
      }
      return localrru;
      label500:
      bool = false;
  ...
  public articlesummary.WendaInfo a()
  {
    ...
    for (int i1 = 1;; i1 = 0)
    {
      ...
      localWendaInfo.answer_detail.set(this.jdField_a_of_type_Rom.a());
  ...
  {
    this.jdField_a_of_type_Rom = rom.a(paramAnswerDetail);
  }
