...
{
  public rru(AssociatedAccountManageActivity paramAssociatedAccountManageActivity) {}
  ...
  void a(String paramString, View paramView)
  {
    ...
    this.a.runOnUiThread(new rrv(this, paramString, paramView));
  }
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (localView != null)
      {
        ((SingleLineTextView)localView.findViewById(2131362759)).setText(ContactUtils.j(this.a.app, paramString));
        a(paramString, localView);
      }
      localView = AssociatedAccountManageActivity.a(this.a, paramString, 1);
    } while (localView == null);
