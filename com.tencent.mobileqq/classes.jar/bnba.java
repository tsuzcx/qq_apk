  ...
  implements uqm
{
  ...
  public bnba(bmiq parambmiq)
  {
    this(parambmiq, null, 0);
  }
  
  public bnba(bmiq parambmiq, bmir parambmir, int paramInt)
  {
    this(parambmiq, parambmir, null, paramInt);
  }
  
  public bnba(bmiq parambmiq, bmir parambmir, String paramString, int paramInt)
  {
    if (parambmiq == null) {
  ...
  protected void a(com.tribe.async.async.JobContext paramJobContext, bnaz parambnaz)
  {
    ...
    //   3: lstore 7
    //   5: aload_2
    //   6: getfield 136	bnaz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   9: astore_1
    //   10: aload_1
    ...
    //   28: invokespecial 153	bnbp:notifyError	(Ljava/lang/Error;)V
    //   31: ldc 155
    //   33: ldc 157
    //   35: iconst_0
    //   36: iconst_m1
    ...
    //   41: invokestatic 164	wxj:b	(Ljava/lang/String;Ljava/lang/String;II[Ljava/lang/String;)V
    //   44: return
    //   45: aload_0
    //   46: getfield 40	bnba:jdField_a_of_type_JavaLangRefWeakReference	Ljava/lang/ref/WeakReference;
    //   49: invokevirtual 168	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
    //   52: checkcast 170	bmiq
    //   55: astore 14
    //   57: aload_0
    //   58: getfield 42	bnba:b	Ljava/lang/ref/WeakReference;
    //   61: invokevirtual 168	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
    //   64: checkcast 172	bmir
    //   67: astore 15
    //   69: aload 14
    //   71: ifnull +837 -> 908
    //   74: aload 14
    //   76: aload_0
    //   77: getfield 46	bnba:jdField_a_of_type_Int	I
    ...
    //   93: aload 15
    //   95: aload_0
    //   96: getfield 46	bnba:jdField_a_of_type_Int	I
    //   99: invokeinterface 176 2 0
    //   104: ifeq +804 -> 908
    //   107: aload 14
    //   109: invokeinterface 179 1 0
    //   114: aload_0
    //   115: getfield 46	bnba:jdField_a_of_type_Int	I
    //   118: invokevirtual 184	dov/com/tencent/biz/qqstory/takevideo/doodle/ui/doodle/DoodleLayout:a	(I)Landroid/graphics/Bitmap;
    //   121: astore 12
    //   123: aload 12
    //   125: ifnull +44 -> 169
    //   128: aload_2
    //   129: getfield 185	bnaz:jdField_a_of_type_Int	I
    //   132: aload_2
    //   133: getfield 187	bnaz:b	Ljava/lang/String;
    //   136: ldc 189
    //   138: invokestatic 194	bnbs:a	(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   141: astore 13
    //   143: aload 12
    //   145: aload 13
    //   147: aconst_null
    //   148: invokestatic 199	xqw:a	(Landroid/graphics/Bitmap;Ljava/lang/String;Lxqx;)V
    //   151: aload_2
    //   152: getfield 202	bnaz:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   155: aload 13
    //   157: putfield 207	com/tencent/biz/qqstory/database/PublishVideoEntry:mosaicPath	Ljava/lang/String;
    //   160: ldc 51
    //   162: ldc 209
    //   164: aload 13
    //   166: invokestatic 212	wxe:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    //   184: aload_1
    //   185: aload 16
    //   187: invokestatic 224	bdhj:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   190: pop
    //   191: aload 16
    ...
    //   212: invokevirtual 233	dov/com/tencent/biz/qqstory/takevideo/doodle/ui/doodle/DoodleLayout:a	()Lbmqe;
    //   215: astore_1
    //   216: aload_1
    //   217: ifnull +28 -> 245
    //   220: aload_1
    ...
    //   223: iload 6
    //   225: iconst_1
    //   226: invokevirtual 238	bmqe:a	(IIZ)Ljava/lang/String;
    //   229: astore_1
    //   230: aload_1
    //   231: ifnull +14 -> 245
    //   234: aload_2
    //   235: getfield 202	bnaz:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   238: ldc 240
    //   240: aload_1
    ...
    //   257: aload_1
    //   258: aload_2
    //   259: getfield 187	bnaz:b	Ljava/lang/String;
    ...
    //   267: ifnull +14 -> 281
    //   270: aload_2
    //   271: getfield 202	bnaz:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   274: ldc 249
    //   276: aload_1
    ...
    //   281: aload 14
    //   283: aload_0
    //   284: getfield 46	bnba:jdField_a_of_type_Int	I
    //   287: iconst_0
    //   288: invokeinterface 252 3 0
    //   293: astore 13
    //   295: aload_0
    //   296: getfield 44	bnba:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   299: astore 12
    //   301: aload 12
    //   303: astore_1
    //   304: aload 12
    ...
    //   309: aload_2
    //   310: getfield 185	bnaz:jdField_a_of_type_Int	I
    //   313: aload_2
    //   314: getfield 187	bnaz:b	Ljava/lang/String;
    //   317: ldc 254
    //   319: invokestatic 194	bnbs:a	(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   322: astore_1
    //   323: aload 13
    //   325: ifnull +537 -> 862
    //   328: aload 15
    ...
    //   333: aload 15
    //   335: aload_0
    //   336: getfield 46	bnba:jdField_a_of_type_Int	I
    //   339: invokeinterface 176 2 0
    //   344: ifeq +34 -> 378
    //   347: aload 15
    //   349: aload_0
    //   350: getfield 46	bnba:jdField_a_of_type_Int	I
    ...
    //   384: istore_3
    //   385: aload_2
    //   386: getfield 265	bnaz:jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource	Ldov/com/tencent/biz/qqstory/takevideo/EditVideoParams$EditSource;
    //   389: instanceof 267
    //   392: ifeq +37 -> 429
    //   395: iload 6
    //   397: istore 4
    ...
    //   401: istore_3
    //   402: aload_2
    //   403: getfield 202	bnaz:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   406: ldc_w 269
    //   409: iconst_0
    ...
    //   427: istore 4
    //   429: aload_2
    //   430: getfield 276	bnaz:jdField_a_of_type_Bnbh	Lbnbh;
    //   433: getfield 281	bnbh:c	I
    //   436: istore 5
    //   438: aload_2
    //   439: getfield 185	bnaz:jdField_a_of_type_Int	I
    //   442: istore 6
    //   444: iload 6
    //   446: iconst_2
    ...
    //   483: aload_2
    //   484: getfield 265	bnaz:jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource	Ldov/com/tencent/biz/qqstory/takevideo/EditVideoParams$EditSource;
    //   487: instanceof 267
    //   490: ifeq +31 -> 521
    //   493: iconst_0
    //   494: istore 5
    ...
    //   518: invokestatic 59	wxe:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   521: aload 13
    //   523: iload 5
    //   525: invokestatic 288	bnba:a	(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    //   528: astore 12
    //   530: aload 12
    //   532: ifnull +404 -> 936
    //   535: aload 12
    ...
    //   540: iconst_1
    //   541: iconst_0
    //   542: invokestatic 291	xqw:c	(Landroid/graphics/Bitmap;IIZZ)Landroid/graphics/Bitmap;
    //   545: astore 12
    //   547: aload 12
    //   549: ifnull +381 -> 930
    //   552: aload_2
    //   553: getfield 185	bnaz:jdField_a_of_type_Int	I
    //   556: iconst_1
    //   557: if_icmpne +231 -> 788
    //   560: aload_2
    //   561: getfield 185	bnaz:jdField_a_of_type_Int	I
    //   564: aload_2
    //   565: getfield 187	bnaz:b	Ljava/lang/String;
    //   568: ldc 254
    //   570: invokestatic 194	bnbs:a	(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   573: astore 15
    //   575: aload 12
    //   577: aload 15
    //   579: aconst_null
    //   580: invokestatic 199	xqw:a	(Landroid/graphics/Bitmap;Ljava/lang/String;Lxqx;)V
    //   583: aload_2
    //   584: getfield 202	bnaz:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   587: aload 15
    ...
    //   610: if_acmpeq +8 -> 618
    //   613: aload 12
    //   615: invokestatic 297	xqw:a	(Landroid/graphics/Bitmap;)V
    //   618: aload 12
    //   620: ifnull +196 -> 816
    //   623: iload 11
    //   625: ifeq +191 -> 816
    //   628: ldc 51
    //   630: ldc_w 299
    //   633: invokestatic 301	wxe:b	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   678: aastore
    //   679: invokestatic 164	wxj:b	(Ljava/lang/String;Ljava/lang/String;II[Ljava/lang/String;)V
    //   682: ldc 155
    //   684: ldc 157
    //   686: iconst_0
    //   687: iconst_0
    ...
    //   692: invokestatic 164	wxj:b	(Ljava/lang/String;Ljava/lang/String;II[Ljava/lang/String;)V
    //   695: aload_2
    //   696: getfield 202	bnaz:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   699: aload_1
    //   700: putfield 311	com/tencent/biz/qqstory/database/PublishVideoEntry:doodlePath	Ljava/lang/String;
    //   703: aload_0
    //   704: aload_2
    //   705: invokespecial 314	bnbp:notifyResult	(Ljava/lang/Object;)V
    //   708: return
    //   709: astore_1
    //   710: ldc 51
    //   712: ldc_w 316
    //   715: aload_1
    //   716: invokestatic 319	wxe:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   719: aload_0
    ...
    //   730: invokespecial 153	bnbp:notifyError	(Ljava/lang/Error;)V
    //   733: return
    //   734: astore_1
    //   735: ldc 51
    //   737: ldc_w 321
    //   740: aload_1
    //   741: invokestatic 323	wxe:b	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   744: aload_0
    ...
    //   756: invokespecial 153	bnbp:notifyError	(Ljava/lang/Error;)V
    //   759: return
    //   760: astore 15
    //   762: ldc 51
    //   764: ldc_w 316
    //   767: aload 15
    //   769: invokestatic 319	wxe:c	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   772: aload 12
    //   774: getstatic 334	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   777: bipush 60
    //   779: aload_1
    //   780: invokestatic 337	xqw:a	(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap$CompressFormat;ILjava/lang/String;)Z
    //   783: istore 11
    //   785: goto -188 -> 597
    //   788: aload 12
    ...
    //   793: bipush 60
    //   795: aload_1
    //   796: invokestatic 337	xqw:a	(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap$CompressFormat;ILjava/lang/String;)Z
    //   799: istore 11
    //   801: goto -204 -> 597
    //   804: astore_1
    //   805: aload 14
    ...
    //   816: ldc 51
    //   818: ldc_w 339
    //   821: invokestatic 59	wxe:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   824: ldc 155
    //   826: ldc 157
    //   828: iconst_0
    //   829: bipush 254
    ...
    //   835: invokestatic 164	wxj:b	(Ljava/lang/String;Ljava/lang/String;II[Ljava/lang/String;)V
    //   838: aload_2
    //   839: getfield 202	bnaz:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   842: aconst_null
    ...
    //   858: invokespecial 153	bnbp:notifyError	(Ljava/lang/Error;)V
    //   861: return
    //   862: ldc 51
    //   864: ldc_w 343
    //   867: invokestatic 59	wxe:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   870: ldc 155
    //   872: ldc 157
    //   874: iconst_0
    //   875: bipush 254
    ...
    //   881: invokestatic 164	wxj:b	(Ljava/lang/String;Ljava/lang/String;II[Ljava/lang/String;)V
    //   884: aload_2
    //   885: getfield 202	bnaz:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   888: aconst_null
    ...
    //   904: invokespecial 153	bnbp:notifyError	(Ljava/lang/Error;)V
    //   907: return
    //   908: ldc 51
    //   910: ldc_w 347
    //   913: invokestatic 59	wxe:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   916: aload_2
    //   917: getfield 202	bnaz:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   920: aconst_null
    //   921: putfield 311	com/tencent/biz/qqstory/database/PublishVideoEntry:doodlePath	Ljava/lang/String;
    //   924: aload_0
    //   925: aload_2
    //   926: invokespecial 314	bnbp:notifyResult	(Ljava/lang/Object;)V
    //   929: return
    //   930: iconst_0
    //   931: istore 11
    //   933: goto -336 -> 597
