  ...
  extends BaseBubbleBuilder
{
  ...
  private void a(afve paramafve)
  {
    if (paramafve.jdField_a_of_type_ComTencentMobileqqDataMessageForPic.isMixed)
    {
      Object localObject = paramafve.jdField_a_of_type_ComTencentMobileqqDataMessageForPic;
      if (((MessageForPic)localObject).msgtype == -1032)
      {
        paramafve.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
        return;
      }
      String str2 = this.jdField_a_of_type_AndroidContentContext.getString(2131719376);
      String str1;
      if (((MessageForPic)localObject).shareAppID != 0L)
      {
        localObject = bftp.a(((MessageForPic)localObject).shareAppID);
        ...
        if (localAppShareID != null)
        {
          ...
          if (localAppShareID.messagetail != null) {
            str1 = this.jdField_a_of_type_AndroidContentContext.getString(2131690083) + localAppShareID.messagetail;
          }
        }
      }
      for (;;)
      {
        paramafve.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        paramafve.jdField_a_of_type_AndroidWidgetTextView.setText(str1);
        return;
        str1 = str2;
        if (!this.jdField_b_of_type_JavaUtilHashSet.contains(localObject))
        {
          bbjr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), (String)localObject);
          this.jdField_b_of_type_JavaUtilHashSet.add(localObject);
          str1 = str2;
          continue;
          str1 = str2;
          if (((MessageForPic)localObject).msgtype == -3001) {
            str1 = this.jdField_a_of_type_AndroidContentContext.getString(2131691952);
          }
        }
      }
    }
  ...
  {
    paramBaseChatItemLayout = (afve)paramaezf;
    paramaezf = paramView;
    if (paramView == null)
    {
    ...
    if (!paramChatMessage.isSendFromLocal())
    {
      ...
      {
        paramChatMessage = agjt.a(this.jdField_a_of_type_AndroidContentContext, paramChatMessage, paramBaseChatItemLayout.jdField_a_of_type_ComTencentMobileqqActivityAioItemChatThumbView);
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      {
        Object localObject = (afve)AIOUtils.getHolder(paramView);
        MessageForPic localMessageForPic = (MessageForPic)((afve)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
        localObject = ((afve)localObject).jdField_a_of_type_ComTencentImageURLDrawable;
