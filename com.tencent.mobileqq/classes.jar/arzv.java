...
public class arzv
  extends BaseAdapter
{
  public arzv(DataReportViewer paramDataReportViewer) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(this.a.getContext()).inflate(2131559610, paramViewGroup, false);
      paramView = new arzw(this.a, localView);
    ...
    for (;;)
    {
      ...
      return localView;
      localObject = (arzw)paramView.getTag();
      localView = paramView;
