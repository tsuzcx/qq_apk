  ...
  implements DownloadParams.DecodeHandler
{
  ...
  WeakReference<arzw> jdField_a_of_type_JavaLangRefWeakReference;
  
  public arzv(String paramString, arzw paramarzw, Object paramObject)
  {
    if (paramarzw != null) {
      this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramarzw);
    }
  ...
  public Bitmap run(DownloadParams paramDownloadParams, Bitmap paramBitmap)
  {
    ...
    for (paramDownloadParams = null;; paramDownloadParams = (arzw)this.jdField_a_of_type_JavaLangRefWeakReference.get())
    {
      if (paramDownloadParams != null)
      {
        int[] arrayOfInt = arzy.a(Bitmap.createBitmap(paramBitmap, 0, paramBitmap.getHeight() / 2, paramBitmap.getWidth(), paramBitmap.getHeight() / 2));
