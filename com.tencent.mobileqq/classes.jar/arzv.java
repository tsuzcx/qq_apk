  ...
  implements View.OnClickListener
{
  ...
  public arzz a;
  URLDrawableDownListener jdField_a_of_type_ComTencentImageURLDrawableDownListener = new arzw(this);
  ...
  public arzv(Context paramContext, QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, MqqHandler paramMqqHandler, boolean paramBoolean, arzz paramarzz, int paramInt)
  {
    ...
    this.jdField_a_of_type_Arzz = paramarzz;
    if ((paramBoolean) && (this.jdField_a_of_type_Arzz != null) && (!TextUtils.isEmpty(this.jdField_a_of_type_Arzz.b))) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject1 = new arzx(null);
          ((arzx)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout = new RelativeLayout(this.jdField_a_of_type_AndroidContentContext);
          paramView = new ViewGroup.LayoutParams(this.jdField_b_of_type_Int, this.c);
          ((arzx)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.setLayoutParams(paramView);
          ((arzx)localObject1).jdField_a_of_type_ComTencentImageURLImageView = new URLImageView(this.jdField_a_of_type_AndroidContentContext);
          paramView = new RelativeLayout.LayoutParams(this.d, this.e);
          paramView.addRule(13, -1);
          ((arzx)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.addView(((arzx)localObject1).jdField_a_of_type_ComTencentImageURLImageView, paramView);
          ((arzx)localObject1).jdField_a_of_type_AndroidWidgetProgressBar = new ProgressBar(this.jdField_a_of_type_AndroidContentContext);
          ((arzx)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setIndeterminateDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839466));
          paramView = new RelativeLayout.LayoutParams((int)(this.jdField_a_of_type_Float * 30.0F), (int)(this.jdField_a_of_type_Float * 30.0F));
          paramView.addRule(13, -1);
          ((arzx)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout.addView(((arzx)localObject1).jdField_a_of_type_AndroidWidgetProgressBar, paramView);
          paramView = ((arzx)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout;
          paramView.setTag(localObject1);
          ((arzx)localObject1).jdField_a_of_type_ComTencentMobileqqDoutuDoutuData = localDoutuData;
          ((arzx)localObject1).jdField_a_of_type_Int = paramInt;
          ((arzx)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
        ...
        try
        {
          ...
          if (localURL == null)
          {
            ...
            paramView = localURL;
            continue;
            localObject1 = (arzx)paramView.getTag();
          }
        }
    ...
    label566:
    ((arzx)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable((Drawable)localObject2);
    ((arzx)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(this.jdField_a_of_type_ComTencentImageURLDrawableDownListener);
    ((arzx)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setTag(localObject1);
    ((arzx)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setFocusable(true);
    ((arzx)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setFocusableInTouchMode(true);
    ...
    for (;;)
    {
      ...
      break;
      label627:
      ((arzx)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(4);
      ...
      break label566;
      label675:
      ((arzx)localObject1).jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableColorDrawable);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if ((localObject1 != null) && ((localObject1 instanceof arzx))) {}
    for (localObject1 = (arzx)localObject1;; localObject1 = null)
    {
      ...
      for (;;)
      {
        ...
        return;
        DoutuData localDoutuData = ((arzx)localObject1).jdField_a_of_type_ComTencentMobileqqDoutuDoutuData;
        if ((localDoutuData != null) && (localDoutuData.thumb_down_url != null))
        {
          Object localObject2 = (URLDrawable)((arzx)localObject1).jdField_a_of_type_ComTencentImageURLImageView.getDrawable();
          if (localObject2 != null)
          {
            ...
            if (localObject2 != null)
            {
              ...
              bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007FAB", "0X8007FAB", 0, 0, "", String.valueOf(((arzx)localObject1).jdField_a_of_type_Int + 1), localDoutuData.pic_md5, localDoutuData.pic_down_url);
              arzt.d();
