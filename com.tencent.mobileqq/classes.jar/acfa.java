...
public class acfa
  implements bhqd
{
  public acfa(ChatActivityFacade.18 param18) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    {
    default: 
      if ((acex.b != null) && (acex.b.isShowing())) {
        acex.b.dismiss();
      }
      return;
    }
    ...
    for (;;)
    {
      if (paramInt < acex.a.size())
      {
        paramView = (ChatMessage)acex.a.get(paramInt);
        if (paramView.msgtype == -2005)
        {
          localObject = arni.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForFile)paramView);
    ...
    if (BaseChatItemLayout.a)
    {
      ...
      if (paramView.a.jdField_a_of_type_Int == 1008)
      {
        ...
        azmj.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", paramView.a.jdField_a_of_type_JavaLangString, "0X80064FA", "0X80064FA", 0, 0, (String)localObject, "", "", "");
      }
    }
    ...
    {
      if (acex.a.size() == 1) {
        ((FragmentActivity)this.a.jdField_a_of_type_AndroidContentContext).getChatFragment().a().a((ChatMessage)acex.a.get(0));
      }
      for (;;)
      {
        akwk.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "del_multi_msg");
        return;
        ((FragmentActivity)this.a.jdField_a_of_type_AndroidContentContext).getChatFragment().a().a(acex.a);
      }
    }
    paramInt = 0;
    while (paramInt < acex.a.size())
    {
      acex.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)acex.a.get(paramInt));
      paramInt += 1;
    }
    this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(acex.a, false);
  }
}
