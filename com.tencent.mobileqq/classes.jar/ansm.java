  ...
  implements Runnable
{
  ...
  public ansm(BaseActivity paramBaseActivity, Intent paramIntent)
  {
  ...
  public void run()
  {
    ...
    if (FileUtils.b(str))
    {
      ...
      if (((URLDrawable)localObject).getStatus() == 1) {
        this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new ansn(this));
      }
    }
    do
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new anso(this));
      return;
      if (QLog.isColorLevel()) {
        QLog.e("SendVideoActivity", 2, "#SendTask# run(): thumb not exist, path=" + str);
      }
    } while (this.jdField_a_of_type_Boolean);
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.runOnUiThread(new ansp(this));
  }
}
