  ...
  implements Handler.Callback
{
  ...
  private HashMap<String, blht> jdField_a_of_type_JavaUtilHashMap;
  private boolean jdField_a_of_type_Boolean;
  private boolean b;
  
  public blhs(QQAppInterface paramQQAppInterface)
  {
      ...
      try
      {
        ...
        if (i < j)
        {
          ...
          if (!TextUtils.isEmpty((CharSequence)localObject4))
          {
            ...
            localObject4 = new blht(this, localObject3[0], Integer.valueOf(localObject3[1]).intValue(), Integer.valueOf(localObject3[2]).intValue(), Long.valueOf(localObject3[3]).longValue(), Integer.valueOf(localObject3[4]).intValue());
            localHashMap2.put(localObject3[0], localObject4);
            if (QLog.isColorLevel()) {
              QLog.d("NCtr", 2, "LimitEntry:[" + ((blht)localObject4).toString() + "]");
            }
          }
  ...
  private void a(Context paramContext, String paramString)
  {
    ...
    {
      blht localblht = (blht)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
      paramContext = paramContext.getSharedPreferences("config_prefile", 0).edit();
      paramContext.putString("extra_limit_entry_" + this.mApp.getAccount() + "_" + paramString, localblht.toString());
      paramContext.apply();
    }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Boolean)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            l = a().longValue();
            localObject = (blht)((HashMap)localObject).get(paramString);
            if (QLog.isColorLevel()) {
              QLog.d("NCtr", 2, "todayBeginTime = " + new Date(l) + "----" + l + " ，entry.mBaseLineTime = " + new Date(((blht)localObject).jdField_a_of_type_Long) + "----" + ((blht)localObject).jdField_a_of_type_Long);
            }
            if (((blht)localObject).jdField_a_of_type_Long >= 1L) {
              continue;
            }
            if (((blht)localObject).b <= 0) {
              continue;
            }
            ((blht)localObject).jdField_a_of_type_Long = l;
            ((blht)localObject).c += 1;
            paramInt = 1;
            bool2 = bool1;
            if (paramInt != 0)
            {
      ...
      if (!bool2) {
        bdll.b(this.app, "dc00898", "", paramString, "0X8009995", "0X8009995", 0, 0, "" + System.currentTimeMillis(), "", "", "");
      }
      bdll.b(this.app, "dc00898", "", paramString, "0X8009996", "0X8009996", 0, 0, "" + System.currentTimeMillis(), "", "", "");
      if (QLog.isColorLevel()) {
      ...
      bool1 = false;
      continue;
      if ((int)((l - ((blht)localObject).jdField_a_of_type_Long) / 86400000L) >= ((blht)localObject).jdField_a_of_type_Int)
      {
        ((blht)localObject).jdField_a_of_type_Long = l;
        ((blht)localObject).c = 0;
        paramInt = 1;
        if ((((blht)localObject).b > 0) && (((blht)localObject).c < ((blht)localObject).b))
        {
          ((blht)localObject).c += 1;
          paramInt = 1;
        }
  ...
  public void b(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject3 = (blht)((HashMap)localObject1).get(paramString);
        ((HashMap)localObject1).remove(paramString);
        if ((j == ((blht)localObject3).jdField_a_of_type_Int) && (k == ((blht)localObject3).b))
        {
          localHashMap.put(paramString, localObject3);
          break label935;
        }
        localHashMap.put(paramString, new blht(this, paramString, j, k, 0L, 0));
        break label935;
      }
      localHashMap.put(paramString, new blht(this, paramString, j, k, 0L, 0));
      break label935;
    ...
    for (;;)
    {
      ...
      if (localHashMap.size() > 0)
      {
        ...
        {
          str = (String)((Iterator)localObject1).next();
          blht localblht = (blht)localHashMap.get(str);
          ((SharedPreferences.Editor)localObject2).putString("extra_limit_entry_" + (String)localObject3 + "_" + str, localblht.toString());
          paramString.append(str).append(",");
          if (QLog.isColorLevel()) {
            QLog.d("NCtr", 2, "LimitEntry:[" + localblht.toString() + "]");
          }
        }
