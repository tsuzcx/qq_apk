  ...
  extends ClickableSpan
{
  ...
  agcg(agap paramagap, QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  public void onClick(View paramView)
  {
    ...
    {
      QQToast.a(localContext, 2131692035, 0).b(localContext.getResources().getDimensionPixelSize(2131299076));
      return;
    }
    Intent localIntent = new Intent(localContext, QQSpecialCareSettingActivity.class);
    localIntent.putExtra("key_friend_uin", this.jdField_a_of_type_Agap.a.curFriendUin);
