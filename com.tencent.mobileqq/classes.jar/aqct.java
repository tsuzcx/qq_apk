  ...
  extends anii
{
  ...
  public aqct(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      ...
      try
      {
        ...
        ((ByteBuffer)localObject2).putInt(bgjw.a(l)).put((byte)0).putShort((short)1).putShort(this.a).putShort((short)2).putShort(s);
