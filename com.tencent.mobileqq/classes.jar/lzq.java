...
public class lzq
{
  ...
  public static int a(Context paramContext, int paramInt)
  {
    ...
    //   191: aload_0
    //   192: iload_1
    //   193: invokestatic 167	lzq:b	(Landroid/content/Context;I)I
    //   196: istore_2
    //   197: iload_2
    //   198: istore_1
    //   199: aload 5
  ...
  public static void a(long paramLong, int paramInt, Context paramContext, boolean paramBoolean1, String paramString, boolean paramBoolean2)
  {
    ...
    try
    {
      ...
      if (AudioHelper.f()) {
        QLog.w("SmallScreenUtils", 1, "avideo actionOn isFloatWindowOpAllowed, isFloatWindowOpAllowed[" + c(paramContext) + "], isCalling[" + mtd.d(paramContext) + "], isHome[" + a(paramContext) + "], isNeedStartDialog[" + paramBoolean1 + "], actionOnFrom[" + paramInt + "], seq[" + paramLong + "]");
      }
      if (a(paramContext, paramBoolean1, paramString, paramBoolean2)) {
        bdll.b(null, "CliOper", "", "", "0X80057D8", "0X80057D8", 0, 0, "", "", "", "");
      }
      return;
    }
  ...
  public static void a(Context paramContext, lff paramlff)
  {
    int i = paramlff.jdField_d_of_type_Int;
    int j = paramlff.F;
    int k = paramlff.jdField_g_of_type_Int;
    if (QLog.isColorLevel())
    {
    ...
    if (paramlff.jdField_a_of_type_Lfg.jdField_b_of_type_Int > 0) {
      if (paramlff.jdField_a_of_type_Lfh.a > 0L) {
        paramlff = "0X8005A49";
      }
    }
    for (;;)
    {
      if ((paramlff != null) && (c(paramContext))) {
        bdll.b(null, "CliOper", "", "", paramlff, paramlff, 0, 0, "", "", "", "");
      }
      return;
      if (paramlff.jdField_a_of_type_Lfg.jdField_b_of_type_Int == 5)
      {
        paramlff = "0X8005A48";
      }
      else
  ...
  public static void a(View paramView, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramView != null)
    {
      localObject = paramView.getTag(2131373306);
      if (localObject != null) {
        break label190;
      }
      bool = false;
      ...
      localObject = paramView.getTag(2131373307);
      if (localObject != null) {
        break label203;
      }
      bool = false;
    ...
    for (Object localObject = new AlphaAnimation(0.0F, 1.0F);; localObject = new AlphaAnimation(1.0F, 0.0F))
    {
      ...
      localAnimationSet.setAnimationListener(new lzr(paramView, paramBoolean1));
      paramView.startAnimation(localAnimationSet);
      paramView.setVisibility(0);
      paramView.setTag(2131373307, Boolean.valueOf(paramBoolean1));
      paramView.setTag(2131373306, Boolean.valueOf(paramBoolean2));
      return;
        ...
        if (paramVideoAppInterface.getApp() != null)
        {
          ...
          if (paramVideoAppInterface.a() != null)
          {
            ...
            if (paramVideoAppInterface.a().a() != null)
            {
              ...
              if ((((lff)localObject).jdField_d_of_type_Int == 3) || (((lff)localObject).jdField_d_of_type_Int == 4)) {
                str = String.valueOf(((lff)localObject).jdField_g_of_type_Long);
              }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    {
      lbj.e("SmallScreenUtils", paramContext.getMessage());
      return bool2;
    }
    return bool3;
  }
  ...
  public static boolean e(Context paramContext)
  {
    ...
    do
    {
      ...
      bool2 = mrm.a(jdField_b_of_type_ArrayOfJavaLangString, paramContext.getClassName());
      bool1 = bool2;
      if (!QLog.isDevelopLevel()) {
        break;
      }
  ...
  public static boolean f()
  {
    ...
    for (;;)
    {
      ...
      {
        bool1 = bool2;
        if (localmab.jdField_b_of_type_Int > 0) {
          bool1 = false;
        }
      }
    }
  ...
  public static boolean g()
  {
    ...
    for (;;)
    {
      ...
      {
        bool1 = bool2;
        if (localmab.jdField_d_of_type_Int > 0) {
          bool1 = false;
        }
      }
    }
