  ...
  implements bgoj, INetInfoHandler
{
  ...
  public bgow(AppRuntime paramAppRuntime, bgoi parambgoi)
  {
    ...
    try
    {
      if (!this.jdField_a_of_type_JavaUtilLinkedList.isEmpty())
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("QueueDownloader", 2, "getTask | " + paramString + " task find =" + localbgoe);
            }
            return localbgoe;
          }
        }
  ...
  public void a()
  {
    for (;;)
    {
      try
      {
        synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
        {
          ...
          if ((!localbgoe2.a()) && (l > localbgoe2.c + localbgoe2.d))
          {
            ...
            QLog.d("QueueDownloader", 2, "remove task[" + localbgoe2.jdField_a_of_type_JavaLangString + "], isCancal=" + localbgoe2.b() + ", timeOut=" + bool);
          }
        }
        bool = false;
      }
      ...
      for (;;)
      {
        ...
        return;
        label288:
        ThreadManager.postDownLoadTask(new QueueDownloader.1(this, localbgoe1), 2, null, false);
  ...
  public void a(bgoe parambgoe)
  {
    ...
    try
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("QueueDownloader", 2, "removeTask | task=" + parambgoe);
        }
        parambgoe.i();
      ...
      synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
      {
        ...
        if (paramBundle == null)
        {
          ...
          if (parambgoe.b)
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.d("QueueDownloader", 2, "startDownload | task=" + parambgoe.jdField_a_of_type_JavaLangString);
            }
            a();
            return;
          }
