...
{
  public bdhn(Integer paramInteger)
  {
  ...
  protected int a(String paramString, Object paramObject)
  {
    ...
    else if ((paramObject instanceof tls))
    {
      paramObject = ((tls)paramObject).a();
      if (paramObject != null) {
        return tmd.a(paramObject);
      }
    }
  ...
  {
    if ((paramObject1 instanceof tls)) {
      ((tls)paramObject1).a();
    }
  }
}
