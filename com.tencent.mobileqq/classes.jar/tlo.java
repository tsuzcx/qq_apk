...
public class tlo
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "zimage." + tlo.class.getSimpleName();
  }
  
  tlo(int paramInt)
  {
    this.jdField_a_of_type_JavaUtilList = Collections.synchronizedList(new LinkedList());
    this.jdField_a_of_type_Tlq = new tlq(2097152);
    ...
    this.jdField_a_of_type_Tma = new tlp(this);
  }
      ...
      try
      {
        ...
        try
        {
          if (i < this.jdField_b_of_type_JavaUtilList.size())
          {
            ...
            if (localBitmap != null)
            {
              if (tmd.a(localBitmap, paramOptions))
              {
                ...
                if (QLog.isColorLevel()) {
                  tmd.a(jdField_a_of_type_JavaLangString, "getReuseableBitmap found:" + str + " picSize:" + paramOptions.outWidth + "x" + paramOptions.outHeight + " bitmap:" + localBitmap + " state:" + toString());
                }
                return localBitmap;
              }
            }
  ...
  tls a(tlw paramtlw)
  {
    ...
    {
      return null;
      paramtlw = bhdb.a(paramtlw.a());
    } while (paramtlw == null);
    try
    {
      if (paramtlw.a())
      {
        tls localtls = paramtlw.a();
        return localtls;
      }
    }
    finally {}
