    ...
    while (localIterator.hasNext())
    {
      ...
      if (tbd.a(localJSONObject))
      {
        if (!qph.a().a()) {
          ...
          paramList1 = tbd.a(localJSONObject);
        }
      }
      else {
        for (;;)
        {
          paramList1.b = tba.a(paramSparseArray);
          ...
          break;
          paramList1 = tba.a(localJSONObject, paramArticleInfo, paramFastWebArticleInfo);
          paramList1.x = 1;
          paramList1.w = -1;
        }
      }
  ...
  public static void a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, List<BaseData> paramList, List<oidb_cmd0xe7e.ModuleInfo> paramList1, ItemShowDispatcher paramItemShowDispatcher, SparseArray<Float> paramSparseArray)
  {
    ...
    for (;;)
    {
      ...
      while (paramList1.hasNext())
      {
        ...
        try
        {
          ProteusItemData localProteusItemData = tba.a(new JSONObject(paramSparseArray.bytes_json.get().toStringUtf8()), paramArticleInfo, paramFastWebArticleInfo);
          localProteusItemData.x = -99;
          localProteusItemData.b = paramSparseArray.bytes_weight.get();
          tbx.a(paramList, localProteusItemData, paramItemShowDispatcher);
        }
