  ...
  extends ajtb
{
  ...
  public nrf(AppInterface paramAppInterface)
  {
    super(paramAppInterface);
    this.jdField_a_of_type_Akat = new nrg(this);
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        nqn.b = localArrayList;
        if ((localJSONArray2 != null) && (localJSONArray2.length() > 0))
        {
          i = 0;
          if (i < localJSONArray2.length())
          {
            nqn.c.add(String.valueOf(localJSONArray2.getLong(i)));
            i += 1;
            continue;
          }
        }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      return;
      nqn localnqn = (nqn)this.app.getManager(88);
      ...
      localObject = localnqn.a(paramMessageRecord.senderuin);
      ...
      localnqn.a((EcShopData)localObject);
  ...
  public void a(boolean paramBoolean, MessageRecord paramMessageRecord, int paramInt, String paramString)
  {
    try
    {
      ...
      if ("1".equals(paramMessageRecord.getExtInfoFromExtStr("is_AdArrive_Msg")))
      {
        paramString = new nqx();
        paramString.a = 3;
        paramMessageRecord = nqu.a(paramString, paramMessageRecord);
        paramMessageRecord.f = paramInt;
        ((nqu)this.app.a(139)).a(paramMessageRecord, null);
        return;
      }
      if (paramBoolean)
      {
  ...
  public void b(MessageRecord paramMessageRecord)
  {
    ...
    try
    {
      ...
      if ("1".equals(paramMessageRecord.getExtInfoFromExtStr("is_AdArrive_Msg")))
      {
        localObject1 = new nqx();
        ((nqx)localObject1).a = 1;
        localObject1 = nqu.a((nqx)localObject1, paramMessageRecord);
        ((nqu)this.app.a(139)).a((nqx)localObject1, null);
        if ((paramMessageRecord instanceof MessageForStructing))
        {
          ...
          yxv.a(0, 2, nqn.a((axup)paramMessageRecord.mStructMsgItemLists.get(0)));
          return;
        }
        ...
        yxv.a(0, 2, (qq_ad_get.QQAdGetRsp.AdInfo)localObject1);
        return;
      }
    }
    catch (Throwable paramMessageRecord)
    ...
    do
    {
      do
      {
        do
        {
          ...
          paramToServiceMsg = (nqn)this.app.getManager(88);
