...
public class bjos
{
  private static volatile bjos jdField_a_of_type_Bjos;
  public static boolean a;
  private long jdField_a_of_type_Long;
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<View> jdField_a_of_type_JavaLangRefWeakReference;
  private WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new bjou(this);
  ...
  {
    if (jdField_a_of_type_Bjos == null) {}
    try
    {
      if (jdField_a_of_type_Bjos == null) {
        jdField_a_of_type_Bjos = new bjos();
      }
      return jdField_a_of_type_Bjos;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    {
      if (i != 0) {
        QIPCServerHelper.getInstance().register(new bjot(this, "QR_LOGIN_QIPC_MODULE_NAME"));
      }
      return;
      i = 0;
    }
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    for (paramArrayOfByte = new String(paramArrayOfByte);; paramArrayOfByte = anzj.a(2131710068))
    {
  ...
  public void a(Bundle paramBundle, boolean paramBoolean)
  {
    ...
    if ((!TextUtils.isEmpty("")) && (!"".equals(localObject1)))
    {
      ...
      localByteBuffer.put(arrayOfByte);
      arrayOfByte = localByteBuffer.array();
      ((ArrayList)localObject2).add(bhml.a((byte[])localObject3));
      ((ArrayList)localObject2).add(bhml.a(arrayOfByte));
    ...
    for (int i = 1;; i = 0)
    {
      ...
      ((ArrayList)localObject2).add(bhml.a(((ByteBuffer)localObject3).array()));
