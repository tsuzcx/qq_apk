...
public class azgf
  implements azck
{
  public azgf(TroopBarPublishActivity paramTroopBarPublishActivity) {}
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    int j = this.a.jdField_a_of_type_Azcq.b.length();
    int k = this.a.jdField_a_of_type_Azcq.a.length();
    int n = this.a.jdField_a_of_type_Azcq.c.length() + (j + k);
    if ((paramInt1 < this.a.J.length() + n) && (paramInt2 < this.a.J.length() + n))
    {
      if (TroopBarPublishActivity.a(this.a).size() > 1)
      {
        ...
        bfmr.b(this.a.jdField_a_of_type_ComTencentMobileqqTribeViewTEditText);
        return;
      }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        paramInt1 = this.a.J.length() + n;
        break label258;
        if (TextUtils.isEmpty(this.a.jdField_a_of_type_Azcq.b)) {
          break;
        }
        k = 0;
        j = paramInt1;
