  ...
  implements SurfaceTexture.OnFrameAvailableListener
{
  ...
  private bqta jdField_a_of_type_Bqta;
  ...
  public bqsz(int paramInt1, int paramInt2)
  {
  ...
  private void e()
  {
    this.jdField_a_of_type_Bqta = new bqta();
    this.jdField_a_of_type_Bqta.a();
    Log.d("CodecOutputSurface", "textureID=" + this.jdField_a_of_type_Bqta.a());
    this.jdField_a_of_type_AndroidGraphicsSurfaceTexture = new SurfaceTexture(this.jdField_a_of_type_Bqta.a());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bqta = null;
  ...
  {
    this.jdField_a_of_type_Bqta.a(this.jdField_a_of_type_AndroidGraphicsSurfaceTexture, paramBoolean);
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_Bqta.a("before updateTexImage");
