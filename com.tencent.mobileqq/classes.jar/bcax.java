...
public class bcax
{
  ...
  public static int a()
  {
    return bbtm.a().a().getSharedPreferences("qzoneappcenter", 4).getInt("appTabVersionCode", -1);
  }
  ...
  public static String a(WebView paramWebView, HashMap<String, aqre> paramHashMap, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (i < localJSONArray2.length())
        {
          ...
          bcds.c("Common", "nameSpace:" + paramString + ",methodName=" + str1 + ",paramsStr=" + paramWebView);
      ...
      catch (UnsupportedEncodingException paramWebView)
      {
        try
        {
          ...
          {
            paramWebView = (Class)bcbf.jdField_a_of_type_JavaUtilHashMap.get(paramString);
            ...
            if (paramWebView != null)
            {
              ...
              if (j < k)
              {
                ...
                if ((paramWebView.getName().equals(str1)) && (paramWebView.getParameterTypes().length == ((List)localObject).size()))
                {
                  ...
                  try
                  {
                    bcds.c("Common", "callBatch <call> class : " + paramString.getClass().getName() + " , method : " + str1 + "\n , args : " + localObject.toString());
                  ...
                  {
                    bcds.c("Common", "callBatch error", paramWebView);
                  }
                  paramWebView = paramWebView;
                  bcds.b("Common", "callBatch decode params format err", paramWebView);
        ...
        {
          bcds.e("Common", "callBatch args error : " + paramWebView.toString());
        }
      }
      catch (JSONException paramWebView)
      {
        bcds.b("Common", "callBatch request params format err", paramWebView);
        continue;
        j += 1;
        continue;
        ...
        else if ((paramString instanceof Boolean))
        {
          ...
          localJSONObject.put("data", localJSONArray1);
          bcds.c("Common", "Response<callBatch> syncCallBatch result : " + localJSONObject);
        }
        else
        {
          paramWebView = "";
  ...
  public static void a()
  {
    try
    {
      bcds.b("Common", "<initSystemFolder> begin to init system file... ");
  ...
  {
    SharedPreferences.Editor localEditor = bbtm.a().a().getSharedPreferences("qzoneappcenter", 4).edit();
  ...
  {
    bcds.c("Common", "setResourceMD5=" + paramString);
    SharedPreferences.Editor localEditor = bbtm.a().a().getSharedPreferences("qzoneappcenter", 4).edit();
  ...
  public static long[] a()
  {
    SharedPreferences localSharedPreferences = bbtm.a().a().getSharedPreferences("qzoneappcenter", 4);
  ...
  public static String[] a(String paramString)
  {
    ...
    if (paramString.toLowerCase().startsWith("sd://"))
    {
      ...
      if (i != -1)
      {
        ...
        if (new File(f() + File.separator + str1).exists())
        {
          str2 = "file:///" + f() + File.separator + str1;
          str1 = paramString;
        }
      }
    }
    for (;;)
    {
      ...
      bcds.c("Common", "url params= " + str2 + " " + paramString);
  ...
  {
    bcds.c("Common", "setLastResourceZipMd5=" + paramString);
    SharedPreferences.Editor localEditor = bbtm.a().a().getSharedPreferences("qzoneappcenter", 4).edit();
  ...
  {
    return bbtm.a().a().getSharedPreferences("qzoneappcenter", 4).getBoolean("appstoreclearcache", false);
  }
  ...
  {
    return f() + File.separator + "qapp_center_index.htm";
  }
  
  public static String f()
  {
    String str = p();
    bcds.b("Common", "<getSDResDir> getSDResDir=" + str);
  ...
  {
    return bbtm.a().a().getSharedPreferences("qzoneappcenter", 4).getString("relastmd5", "");
  }
  
  public static String n()
  {
    return bbtm.a().a().getSharedPreferences("qzoneappcenter", 4).getString("lastresourcezipmd5", "");
  }
  
  public static String o()
  {
    return bbtm.a().a().getSharedPreferences("qzoneappcenter", 4).getString("appstoreagentversion", "");
  }
  
  public static String p()
  {
    return bbtm.a().a().getSharedPreferences("qzoneappcenter", 4).getString("sdhtmldir", "");
  }
  ...
  public static String q()
  {
    ...
    {
      bcds.c("Common", "exception happened!");
      return "";
    }
    return "";
  }
