...
{
  private final audc jdField_a_of_type_Audc = new audc();
  private audd jdField_a_of_type_Audd;
  private final befq jdField_a_of_type_Befq;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private boolean jdField_a_of_type_Boolean;
  private final audc jdField_b_of_type_Audc = new audc();
  private boolean jdField_b_of_type_Boolean;
  private final audc c = new audc();
  
  public audb(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Befq = new befq(ThreadManager.getSubThreadLooper(), this);
    a(new PTTPreDownloadStrategy(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Befq));
  }
  ...
  public static int a(QQAppInterface paramQQAppInterface, MessageForPtt paramMessageForPtt)
  {
    ...
    {
      return 2005;
      if ((paramMessageForPtt.url.startsWith(ajed.aT)) && (bace.a(paramMessageForPtt.getLocalFilePath()))) {
        return 2003;
      }
  ...
  public static audb a(QQAppInterface paramQQAppInterface)
  {
    return (audb)paramQQAppInterface.getManager(127);
  }
  
  private audc a(MessageForPtt paramMessageForPtt)
  {
    audc localaudc = null;
    if (paramMessageForPtt.istroop == 0) {
      localaudc = this.jdField_a_of_type_Audc;
    }
    do
    {
      return localaudc;
      if (paramMessageForPtt.istroop == 1) {
        return this.jdField_b_of_type_Audc;
      }
    } while (paramMessageForPtt.istroop != 3000);
    return this.c;
  }
  
  private void a(audc paramaudc)
  {
    if (QLog.isColorLevel()) {
      QLog.d("PTTPreDownloader", 2, "cancelCache");
    }
    int i = 0;
    if (i < paramaudc.jdField_a_of_type_JavaUtilArrayList.size())
    {
      MessageForPtt localMessageForPtt = (MessageForPtt)paramaudc.jdField_a_of_type_JavaUtilArrayList.get(i);
      if (this.jdField_a_of_type_Audd.b(localMessageForPtt)) {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    {
      a(this.jdField_a_of_type_Audc);
      a(this.jdField_b_of_type_Audc);
      a(this.c);
    }
  }
  ...
  private void a(boolean paramBoolean, int paramInt, MessageForPtt paramMessageForPtt)
  {
    ...
    if ((paramMessageForPtt.extFlag > 0L) && ((paramMessageForPtt.extFlag & 1L) > 0L))
    {
      ...
      this.jdField_a_of_type_Audd.b(paramMessageForPtt);
    }
    label129:
    while (((paramMessageForPtt.extFlag & 0x2) != 0L) || (!this.jdField_a_of_type_Audd.a(paramMessageForPtt, 3)))
    {
  ...
  private boolean a(audc paramaudc)
  {
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      if ((paramaudc.jdField_a_of_type_Int < 3) && (paramaudc.jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        MessageForPtt localMessageForPtt = (MessageForPtt)paramaudc.jdField_a_of_type_JavaUtilArrayList.get(0);
        if (this.jdField_a_of_type_Audd.a(localMessageForPtt))
        {
          long l;
          ...
          try
          {
            ...
            label113:
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localMessageForPtt.frienduin, localMessageForPtt.istroop, localMessageForPtt.uniseq, localMessageForPtt.msgData);
            paramaudc.jdField_a_of_type_JavaUtilArrayList.remove(0);
            for (bool = false;; bool = true)
            {
              ...
              break label102;
              paramaudc.jdField_a_of_type_Int += 1;
              paramaudc.jdField_a_of_type_JavaUtilArrayList.remove(0);
            }
          }
    ...
    do
    {
      for (;;)
      {
        ...
        if (!((HotChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(60)).b(paramMessageForPtt.frienduin))
        {
          ...
          if ((i == 0) || (i == -1))
          {
            localaudc = a(paramMessageForPtt);
            if (localaudc != null)
            {
              if (!this.jdField_b_of_type_Boolean) {
                break;
              ...
              long l;
              if ((localaudc.jdField_a_of_type_Int < 3) && (this.jdField_a_of_type_Audd.a(paramMessageForPtt))) {
                if (!g(paramMessageForPtt)) {
                  if (this.jdField_a_of_type_Audd.b(paramMessageForPtt))
                  {
                    if (paramMessageForPtt.extFlag != -1L) {
                      break label290;
                    }
              ...
              for (;;)
              {
                ...
                awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "changevoice", "0X8006F7D", 0, 0, "" + paramMessageForPtt.istroop, "", "", "");
                return true;
                l = (0x3 ^ 0xFFFFFFFF) & paramMessageForPtt.extFlag;
                break;
                localaudc.jdField_a_of_type_Int += 1;
                continue;
                i = localaudc.jdField_a_of_type_JavaUtilArrayList.size();
                localaudc.getClass();
                if (i + 1 < 99) {
                  localaudc.jdField_a_of_type_JavaUtilArrayList.add(paramMessageForPtt);
                }
              }
            }
          }
  ...
  private boolean f(MessageForPtt paramMessageForPtt)
  {
    ...
    if (this.jdField_a_of_type_Audd.a(paramMessageForPtt, 1)) {
      if (paramMessageForPtt.extFlag != -1L) {
        break label113;
      }
    }
  ...
  private boolean g(MessageForPtt paramMessageForPtt)
  {
    ...
    else
    {
      ...
      localaxvt.jdField_c_of_type_JavaLangString = paramMessageForPtt.frienduin;
      localaxvt.jdField_a_of_type_Int = paramMessageForPtt.istroop;
      localaxvt.jdField_b_of_type_Int = 2;
      localaxvt.jdField_a_of_type_Long = paramMessageForPtt.uniseq;
      localaxvt.jdField_a_of_type_Boolean = false;
      localaxvt.e = paramMessageForPtt.urlAtServer;
      localaxvt.h = paramMessageForPtt.getLocalFilePath();
    ...
    for (;;)
    {
      localaxvt.jdField_b_of_type_Boolean = bool1;
      localaxvt.f = paramMessageForPtt.md5;
      localaxvt.jdField_c_of_type_Long = paramMessageForPtt.groupFileID;
      localaxvt.jdField_g_of_type_JavaLangString = paramMessageForPtt.groupFileKeyStr;
      localaxvt.d = paramMessageForPtt.subVersion;
      localaxvt.jdField_a_of_type_ComTencentMobileqqDataMessageRecord = paramMessageForPtt;
      localaxvt.jdField_g_of_type_Int = 1;
      localaxvt.jdField_a_of_type_JavaLangObject = new axvy(6, 0);
      try
      {
        bool1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localaxvt);
        if (QLog.isDevelopLevel()) {
  ...
  public void a(audd paramaudd)
  {
    this.jdField_a_of_type_Audd = paramaudd;
  }
  
  public void a(boolean paramBoolean, int paramInt, axvy paramaxvy, MessageForPtt paramMessageForPtt)
  {
    paramaxvy = this.jdField_a_of_type_Befq;
    if (paramBoolean) {}
    for (int i = 1;; i = 0)
    {
      paramaxvy.obtainMessage(2, i, paramInt, paramMessageForPtt).sendToTarget();
      return;
    }
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean2)
    {
      localObject = this.jdField_a_of_type_Befq;
      if (paramBoolean1) {}
      for (;;)
      {
        localObject = ((befq)localObject).obtainMessage(3, i, 0);
        this.jdField_a_of_type_Befq.sendMessageDelayed((Message)localObject, 30000L);
        return;
        i = 0;
      }
    }
    this.jdField_a_of_type_Befq.removeMessages(3);
    Object localObject = this.jdField_a_of_type_Befq;
    if (paramBoolean1) {}
    for (i = j;; i = 0)
    {
      ((befq)localObject).obtainMessage(3, i, 0).sendToTarget();
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_Befq.obtainMessage(0, paramMessageForPtt).sendToTarget();
    return true;
  }
  ...
  public boolean b(MessageForPtt paramMessageForPtt)
  {
    ...
    {
      paramMessageForPtt.extFlag = l;
      this.jdField_a_of_type_Befq.obtainMessage(4, paramMessageForPtt).sendToTarget();
      return true;
      l = 0x2 | paramMessageForPtt.extFlag;
    }
  }
