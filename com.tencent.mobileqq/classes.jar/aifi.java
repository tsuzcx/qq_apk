...
{
  ajxl jdField_a_of_type_Ajxl = (ajxl)this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51);
  public List<ResultRecord> a;
  boolean jdField_a_of_type_Boolean = false;
  
  public aifi(TroopAddFrdsInnerFrame paramTroopAddFrdsInnerFrame)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131560704, paramViewGroup, false);
      paramView = new aifh();
      paramView.jdField_a_of_type_AndroidViewView = localView.findViewById(2131375189);
      paramView.jdField_a_of_type_AndroidViewView.setId(2131377748);
      paramViewGroup = localView.findViewById(2131376777);
      ...
      ((RelativeLayout.LayoutParams)localObject2).rightMargin = actj.a(10.0F, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.getResources());
      ...
      paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131375196));
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131370832));
      paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131376341));
      paramView.jdField_a_of_type_AndroidWidgetButton = ((Button)localView.findViewById(2131375183));
      paramView.d = ((TextView)localView.findViewById(2131375193));
      paramView.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)localView.findViewById(2131364190));
      paramView.e = ((TextView)localView.findViewById(2131378223));
      paramView.jdField_b_of_type_AndroidViewView = localView.findViewById(2131373006);
      ...
      paramView.jdField_b_of_type_AndroidWidgetTextView.setPadding(0, actj.a(2.0F, this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.getResources()), 0, 0);
    ...
    {
      localaifh = (aifh)localView.getTag();
      if (j >= 0) {
        break label1325;
      }
      j = -(j + 1) - 1;
      ...
      localaifh.jdField_a_of_type_ComTencentMobileqqDataTroopMemberInfo = ((TroopMemberInfo)localObject2);
      ...
      localaifh.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(true);
      label485:
      if (!AppSetting.d) {
        break label1442;
      }
    ...
    for (;;)
    {
      localaifh.jdField_b_of_type_AndroidViewView.setVisibility(0);
      localaifh.e.setVisibility(8);
      localaifh.jdField_c_of_type_AndroidWidgetImageView.setImageBitmap(a(((TroopMemberInfo)localObject2).memberuin));
      Object localObject3 = bbcz.h(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((TroopMemberInfo)localObject2).troopuin, ((TroopMemberInfo)localObject2).memberuin);
      ...
      if (!TextUtils.isEmpty(((TroopMemberInfo)localObject2).recommendRemark))
      {
        ...
        if (!TextUtils.equals(((TroopMemberInfo)localObject2).recommendRemark, ((TroopMemberInfo)localObject2).memberuin))
        {
          ...
          {
            paramViewGroup = (ViewGroup)localObject3;
            if (!this.jdField_a_of_type_Ajxl.b(((TroopMemberInfo)localObject2).memberuin)) {
              paramViewGroup = (String)localObject3 + " (" + ((TroopMemberInfo)localObject2).recommendRemark + ")";
            }
          }
        }
      }
      localaifh.jdField_a_of_type_AndroidWidgetTextView.setText(paramViewGroup);
      localaifh.jdField_a_of_type_JavaLangString = ((TroopMemberInfo)localObject2).memberuin;
      localaifh.jdField_c_of_type_AndroidWidgetTextView.setVisibility(8);
      if (AppSetting.d) {
        paramView.append(paramViewGroup);
      }
      if (((TroopMemberInfo)localObject2).commonFrdCnt > 0)
      {
        localaifh.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.getResources().getString(2131689758, new Object[] { Integer.valueOf(((TroopMemberInfo)localObject2).commonFrdCnt) }));
        localaifh.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
        if (AppSetting.d) {
          paramView.append(localaifh.jdField_b_of_type_AndroidWidgetTextView.getText());
        }
        label784:
        if (!this.jdField_a_of_type_Boolean) {
          localaifh.jdField_b_of_type_AndroidViewView.setEnabled(true);
        }
        ...
        localaifh.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
        localaifh.d.setVisibility(0);
        localaifh.d.setText(ajya.a(2131715162));
        if (this.jdField_a_of_type_Boolean)
        {
          localaifh.jdField_b_of_type_AndroidViewView.setEnabled(false);
          localaifh.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(false);
          localaifh.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
        }
        if (!AppSetting.d) {
          break label1437;
        }
        localaifh.d.setContentDescription(ajya.a(2131715164));
        paramInt = 0;
      }
      for (;;)
      {
        label916:
        localObject3 = localaifh.jdField_a_of_type_AndroidViewView;
        if (paramInt != 0)
        {
          paramViewGroup = (ViewGroup)localObject2;
          label930:
          ((View)localObject3).setTag(paramViewGroup);
          localObject2 = localaifh.jdField_a_of_type_AndroidViewView;
          paramViewGroup = localObject1;
          if (paramInt != 0) {
            paramViewGroup = this;
          }
          ((View)localObject2).setOnClickListener(paramViewGroup);
          paramViewGroup = localaifh.jdField_a_of_type_AndroidViewView;
          if (paramInt == 0) {
            break label1313;
          }
          label968:
          paramViewGroup.setClickable(bool);
          paramViewGroup = localaifh.jdField_a_of_type_AndroidWidgetCheckBox;
          if (!this.jdField_a_of_type_Boolean) {
            break label1319;
          }
        }
        ...
        for (paramInt = i;; paramInt = 8)
        {
          ...
          localaifh.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
          localaifh.jdField_b_of_type_AndroidViewView.setTag(localaifh);
          if (AppSetting.d) {
          ...
          localaifh.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(false);
          break label485;
          localaifh.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
          break label784;
          label1080:
          ...
          if (paramInt == 3)
          {
            localaifh.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
            localaifh.d.setVisibility(0);
            localaifh.d.setText(ajya.a(2131715160));
            if (this.jdField_a_of_type_Boolean)
            {
              localaifh.jdField_b_of_type_AndroidViewView.setEnabled(false);
              localaifh.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(false);
            ...
            localaifh.d.setContentDescription(ajya.a(2131715159));
            paramInt = 0;
            break label916;
          }
          if (this.jdField_a_of_type_Boolean)
          {
            localaifh.jdField_b_of_type_AndroidViewView.setEnabled(true);
            localaifh.jdField_a_of_type_AndroidWidgetButton.setVisibility(8);
            localaifh.jdField_a_of_type_AndroidWidgetCheckBox.setEnabled(true);
            localaifh.jdField_a_of_type_AndroidWidgetCheckBox.setChecked(a((TroopMemberInfo)localObject2));
            localaifh.jdField_a_of_type_AndroidWidgetCheckBox.setTag(localaifh);
          }
          for (paramInt = 0;; paramInt = 1)
          {
            localaifh.d.setVisibility(8);
            break;
            localaifh.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
            localaifh.jdField_a_of_type_AndroidWidgetButton.setText(ajya.a(2131689628));
            if (AppSetting.d) {
              localaifh.jdField_a_of_type_AndroidWidgetButton.setContentDescription(ajya.a(2131689628));
            }
          }
          paramViewGroup = null;
          break label930;
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.f == TroopAddFrdsInnerFrame.d)
        {
          ...
          localaifh.e.setText(paramView);
          localaifh.e.setContentDescription(String.format(this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131691898), new Object[] { paramView.toLowerCase() }));
          return localView;
        }
        localaifh.e.setVisibility(8);
  ...
  public void onClick(View paramView)
  {
    ...
    label204:
    paramView = ((aifh)localObject).jdField_a_of_type_ComTencentMobileqqDataTroopMemberInfo;
    ...
    ((Intent)localObject).putExtra("selfSet_leftViewText", this.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberTroopAddFrdsInnerFrame.jdField_a_of_type_ComTencentMobileqqActivitySelectmemberSelectMemberActivity.getString(2131720524));
