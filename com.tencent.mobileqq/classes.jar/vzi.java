  ...
  extends Drawable
{
  ...
  private vzd jdField_a_of_type_Vzd;
  private vzf jdField_a_of_type_Vzf = new vzj(this);
  private Drawable b;
  
  vzi(@NonNull vzd paramvzd, @NonNull Drawable paramDrawable)
  {
    this.jdField_a_of_type_Vzd = paramvzd;
    this.jdField_a_of_type_Vzd.a(this.jdField_a_of_type_Vzf);
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramDrawable;
    this.b = paramDrawable;
    paramvzd = this.jdField_a_of_type_Vzd.a();
    if (paramvzd != null) {
      a(paramvzd);
    }
  }
  ...
  {
    vzb.a(this.jdField_a_of_type_JavaLangString, "updateCurrentDrawable view:%s drawable: %s", getCallback(), paramDrawable);
