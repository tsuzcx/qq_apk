  ...
  implements Manager
{
  ...
  ThreadLocal<SimpleDateFormat> jdField_a_of_type_JavaLangThreadLocal = new bgqn(this);
  protected Map<String, JSONObject> a;
  protected boolean a;
  protected final int b;
  protected SparseArray<bgqj> b;
  String b;
  protected String c;
  
  public bgqm(QQAppInterface paramQQAppInterface)
  {
    ...
    while (i < j)
    {
      ...
      bgqj localbgqj = new bgqj();
      localbgqj.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getString("appinfo_date_" + k, "");
      localbgqj.jdField_b_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getInt("KEY_APP_LIST_TIME_STAMP_" + k, 0);
      this.jdField_b_of_type_AndroidUtilSparseArray.put(k, localbgqj);
      i += 1;
    }
    f();
    d();
    ...
    this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getString("appinfo_all_app_string", anzj.a(2131713972));
  }
  ...
  private void f()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      if (((ListIterator)localObject1).hasNext())
      {
        ...
        bgqj localbgqj = (bgqj)this.jdField_b_of_type_AndroidUtilSparseArray.get(((TroopAIOAppInfo)localObject3).groupType);
        znw.a(localbgqj);
        localbgqj.a(((TroopAIOAppInfo)localObject3).appid, (TroopAIOAppInfo)localObject3);
      }
    }
  ...
  {
    bgqj localbgqj = (bgqj)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
    if (localbgqj != null) {}
    ...
    return localbgqj.jdField_b_of_type_Int;
  }
  
  public TroopAIOAppInfo a(int paramInt1, int paramInt2)
  {
    Object localObject1 = (bgqj)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt2, null);
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        localObject1 = (TroopAIOAppInfo)((bgqj)localObject1).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt1));
        if (localObject1 != null)
        {
  ...
  public List<TroopAIOAppInfo> a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_Aoip.a(1, paramInt, null, paramBoolean);
    }
    ArrayList localArrayList = new ArrayList();
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      Object localObject2 = (bgqj)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt);
      znw.a(localObject2);
      localObject2 = ((bgqj)localObject2).a().iterator();
  ...
  public void a()
  {
    bgqp[] arrayOfbgqp = bgqp.jdField_a_of_type_ArrayOfBgqp;
    int j = arrayOfbgqp.length;
    int i = 0;
    while (i < j)
    {
      bgqp localbgqp = arrayOfbgqp[i];
      Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().getString("KEY_APP_CONFIG_PREFIX-" + localbgqp.jdField_a_of_type_JavaLangString, null);
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        localObject = localbgqp.a((String)localObject);
        this.jdField_a_of_type_JavaUtilMap.put(localbgqp.jdField_a_of_type_JavaLangString, localObject);
      }
      i += 1;
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    bgqj localbgqj = (bgqj)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt, null);
    if (localbgqj != null) {}
    for (boolean bool = true;; bool = false)
    {
      znw.a(bool);
      if (localbgqj != null) {
        localbgqj.jdField_a_of_type_JavaLangString = ((String)localObject);
      }
  ...
  {
    bgqj localbgqj = (bgqj)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramInt2);
    boolean bool;
    if (localbgqj != null)
    {
      bool = true;
    ...
    do
    {
      ...
      bool = false;
      break;
      TroopAIOAppInfo localTroopAIOAppInfo = (TroopAIOAppInfo)localbgqj.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(Integer.valueOf(paramInt1));
      if (localTroopAIOAppInfo != null)
      {
        znw.a(localbgqj.a(localTroopAIOAppInfo));
        ...
        ThreadManager.post(new TroopAppMgr.4(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().createEntityManager(), localTroopAIOAppInfo), 8, null, false);
        return;
      }
  ...
  public void a(int paramInt, boolean paramBoolean, String paramString)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_AndroidUtilSparseArray)
      {
        ...
        b();
        ??? = new bdlq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a("dc00899").b("Grp_AIO").c("add_page").d("Clk_app").a(new String[] { paramString }).a(new String[] { String.valueOf(paramInt) });
        if (paramBoolean)
        {
          paramString = "0";
          ((bdlq)???).a(new String[] { paramString }).a();
          return;
        }
      }
      paramString = "1";
  ...
  public void a(ArrayList<Integer> paramArrayList)
  {
    ...
    bgqj localbgqj = (bgqj)this.jdField_b_of_type_AndroidUtilSparseArray.get(0, null);
    if (localbgqj != null) {}
    for (boolean bool = true;; bool = false)
    {
      znw.a(bool);
      ...
      } while (localbgqj.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(localInteger));
      QLog.w(".troop.troop_app", 1, "TroopAppMgr:sortTroopAppList error, there is no appid in hashtable");
      return;
    }
    this.jdField_a_of_type_Aoip.a(a(0), paramArrayList);
  }
  ...
  public void a(ArrayList<TroopAIOAppInfo> paramArrayList, int paramInt)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        localbgqj.a(localTroopAIOAppInfo.appid, localTroopAIOAppInfo);
      }
    }
    label104:
    ThreadManager.post(new TroopAppMgr.2(this, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().createEntityManager(), paramInt, paramArrayList), 8, null, false);
  }
  ...
  public void a(ArrayList<Integer> paramArrayList1, ArrayList<Integer> paramArrayList2)
  {
    ...
    do
    {
      ...
      {
        this.jdField_a_of_type_Aoip.a(a(0), paramArrayList1, paramArrayList2);
        return;
      }
    } while (!QLog.isColorLevel());
  ...
  public void a(JSONObject paramJSONObject)
  {
    ...
    {
      bgqp localbgqp = arrayOfbgqp[i];
      JSONObject localJSONObject = localbgqp.a(paramJSONObject.optJSONObject(localbgqp.jdField_a_of_type_JavaLangString));
      if (localJSONObject != null) {
        a(localbgqp.jdField_a_of_type_JavaLangString, localJSONObject);
      }
      i += 1;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean) {
          localbgqj.jdField_a_of_type_Int |= 0x2;
        } else {
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    for (;;)
    {
      try
      {
        ...
        if (paramBoolean) {
          localbgqj.jdField_a_of_type_Int |= 0x1;
        } else {
  ...
  public boolean a(int paramInt)
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 44	bgqm:jdField_b_of_type_AndroidUtilSparseArray	Landroid/util/SparseArray;
    //   8: iload_1
    //   9: aconst_null
    //   10: invokevirtual 285	android/util/SparseArray:get	(ILjava/lang/Object;)Ljava/lang/Object;
    //   13: checkcast 71	bgqj
    //   16: astore 4
    //   18: aload 4
    //   20: ifnull +20 -> 40
    //   23: iconst_1
    ...
    //   42: goto -17 -> 25
    //   45: aload 4
    //   47: getfield 480	bgqj:jdField_a_of_type_Int	I
    //   50: istore_1
    //   51: iload_1
    //   52: iconst_1
    //   53: iand
  ...
  public boolean a(TroopAIOAppInfo paramTroopAIOAppInfo)
  {
    ...
    Object localObject = (bgqj)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramTroopAIOAppInfo.groupType);
    boolean bool1;
    if (localObject != null)
    {
      bool1 = true;
    ...
    do
    {
      ...
      bool1 = false;
      break;
      localObject = (TroopAIOAppInfo)((bgqj)localObject).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(i));
    } while (localObject == null);
    znw.a(paramTroopAIOAppInfo.hashVal);
    znw.a(((TroopAIOAppInfo)localObject).hashVal);
  ...
  public boolean a(List<Integer> paramList, int paramInt)
  {
    ...
    {
      znw.a(bool1);
      if ((localbgqj != null) && (paramList != null)) {
        break label59;
      }
      return false;
      bool1 = false;
    ...
    new ArrayList();
    Object localObject;
    if (paramList.size() != localbgqj.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size())
    {
      bool1 = bool2;
    ...
    for (;;)
    {
      try
      {
        ...
        if (bool1)
        {
          localbgqj.a(paramList, paramInt);
          b(localbgqj.a(), paramInt);
        }
        return bool1;
      }
      finally {}
  ...
  public void b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        {
          int k = arrayOfInt[i];
          Object localObject3 = (bgqj)this.jdField_b_of_type_AndroidUtilSparseArray.get(k);
          znw.a(localObject3);
          localObject3 = (TroopAIOAppInfo)((bgqj)localObject3).jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(paramInt));
          if (localObject3 != null)
          {
  ...
  public void b(int paramInt1, int paramInt2)
  {
    ...
    localbgqj.jdField_b_of_type_Int = paramInt1;
  ...
  {
    ThreadManager.post(new TroopAppMgr.3(this, paramArrayList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().createEntityManager(), paramInt), 8, null, false);
  }
  ...
  {
    int i = paramTroopAIOAppInfo.appid;
    bgqj localbgqj = (bgqj)this.jdField_b_of_type_AndroidUtilSparseArray.get(paramTroopAIOAppInfo.groupType);
    if (localbgqj != null) {}
    for (boolean bool = true;; bool = false)
    {
      znw.a(bool);
    ...
    if ((TroopAIOAppInfo)localbgqj.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Integer.valueOf(i)) != null) {
      return true;
    }
    localbgqj.a(paramTroopAIOAppInfo.appid, paramTroopAIOAppInfo);
    return false;
  }
  ...
  public void c()
  {
    ...
    try
    {
      ...
      nkm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new bgqo(this), localReqBody.toByteArray(), "OidbSvc.0xa1e", 2590, 0);
      return;
    }
    finally {}
  }
  ...
  public void onDestroy()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      while (i < j)
      {
        int k = arrayOfInt[i];
        a(false, k);
        bgqj localbgqj = (bgqj)this.jdField_b_of_type_AndroidUtilSparseArray.get(k);
        znw.a(localbgqj);
        localbgqj.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
        localbgqj.a();
        localbgqj.jdField_b_of_type_Int = 0;
        i += 1;
      }
      return;
    }
