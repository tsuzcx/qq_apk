...
public final class bgqm
{
  ...
  static ContentValues a(auko paramauko, String paramString)
  {
    ContentValues localContentValues = new ContentValues();
    Iterator localIterator = a(paramauko).iterator();
    while (localIterator.hasNext())
    {
      ...
      try
      {
        ...
        if ((localObject1 instanceof auko)) {
          localContentValues.putAll(a((auko)localObject1, str + "."));
        }
      }
  ...
  private static ContentValues a(List<auko> paramList, String paramString)
  {
    ContentValues localContentValues = new ContentValues();
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      {
        localContentValues.put(paramString + i + ".-", ((auko)paramList.get(i)).getClass().getName());
        localContentValues.putAll(a((auko)paramList.get(i), paramString + i + "."));
        i += 1;
      }
    }
    return localContentValues;
  ...
  public static auko a(ContentValues paramContentValues, String paramString)
  {
    return a(paramContentValues, paramString, "");
  }
  
  private static auko a(ContentValues paramContentValues, String paramString1, String paramString2)
  {
    try
    {
      auko localauko = (auko)Class.forName(paramString1).newInstance();
      paramString1 = localauko;
      if (localauko != null)
      {
        paramString1 = a(localauko).iterator();
        while (paramString1.hasNext())
        {
          ...
          else if (localObject2 == List.class)
          {
            ...
            localField.set(localauko, localObject2);
          }
          else if (localObject2 == Long.TYPE)
          {
            localField.set(localauko, paramContentValues.getAsLong((String)localObject1));
          }
          else if (localObject2 == Integer.TYPE)
          {
            localField.set(localauko, paramContentValues.getAsInteger((String)localObject1));
          }
          else if (localObject2 == String.class)
          {
            localField.set(localauko, paramContentValues.getAsString((String)localObject1));
          }
          else if (localObject2 == Byte.TYPE)
          {
            localField.set(localauko, paramContentValues.getAsByte((String)localObject1));
          }
          else if (localObject2 == [B.class)
          {
            localField.set(localauko, paramContentValues.getAsByteArray((String)localObject1));
          }
          else if (localObject2 == Short.TYPE)
          {
            localField.set(localauko, paramContentValues.getAsShort((String)localObject1));
          }
          else if (localObject2 == Boolean.TYPE)
          {
            localField.set(localauko, paramContentValues.getAsBoolean((String)localObject1));
          }
          else if (localObject2 == Float.TYPE)
          {
            localField.set(localauko, paramContentValues.getAsFloat((String)localObject1));
          }
          else if (localObject2 == Double.TYPE)
          {
            localField.set(localauko, paramContentValues.getAsDouble((String)localObject1));
          }
        }
        if (localauko.getId() != -1L)
        {
  ...
  public static axwv a(StructMsgForImageShare paramStructMsgForImageShare)
  {
    if (paramStructMsgForImageShare.getItemCount() > 0)
    {
      paramStructMsgForImageShare = paramStructMsgForImageShare.getItemByIndex(0);
      if ((paramStructMsgForImageShare instanceof axyo))
      {
        paramStructMsgForImageShare = (axyo)paramStructMsgForImageShare;
        if ((paramStructMsgForImageShare.a.size() > 0) && ((paramStructMsgForImageShare.a.get(0) instanceof axwv))) {
          return (axwv)paramStructMsgForImageShare.a.get(0);
        }
      }
    }
    return null;
  ...
  public static bgqh a(byte[] paramArrayOfByte)
  {
    if ((paramArrayOfByte == null) || (paramArrayOfByte.length <= 16)) {
      return null;
    }
    ...
    if ((localObject2 instanceof ChatMessage))
    {
      if ((localObject2 instanceof MessageForStructing))
      {
        ...
        {
          localObject1 = axva.a((byte[])localObject1);
          ((MessageForStructing)localObject2).structingMsg = ((AbsStructMsg)localObject1);
        }
        return new bgqh((ChatMessage)localObject2, paramArrayOfByte);
      }
      return new bgqh((ChatMessage)localObject2, paramArrayOfByte);
    }
    return null;
  ...
  private static List<Field> a(auko paramauko)
  {
    Class localClass = paramauko.getClass();
    Object localObject1 = (List)a.get(localClass);
    paramauko = (auko)localObject1;
    if (localObject1 == null)
    {
      paramauko = new ArrayList();
      ...
      a.put(localClass.getName(), paramauko);
    }
    return paramauko;
  }
  
  public static List<bgqg> a(List<byte[]> paramList)
  {
    if ((paramList == null) || (paramList.size() == 0)) {
      return null;
    }
    ...
    while (paramList.hasNext())
    {
      ...
      if (l1 != 2L)
      {
        ...
        if (l1 == 1L)
        {
          ...
          if (localObject != null) {
            localArrayList.add(new bgqg(l2, l1, ((bgqh)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage, ((bgqh)localObject).jdField_a_of_type_JavaLangString));
        ...
        else if (l1 == 3L)
        {
          ...
          localObject = a((byte[])localObject);
          if (localObject != null) {
            localArrayList.add(new bgqg(l2, l1, (ContentValues)localObject));
          }
        }
      }
    }
  ...
  public static void a(long paramLong, List<bgqg> paramList1, List<bgqg> paramList2)
  {
    ...
    for (;;)
    {
      ...
      {
        bgqg localbgqg = (bgqg)paramList1.next();
        if (localbgqg.b == paramLong) {
          paramList2.add(localbgqg);
        }
      }
    }
  }
  ...
  {
    bcql.a(paramContext, paramInt2, paramInt1, 2000).b(paramContext.getResources().getDimensionPixelSize(2131298865) - (int)bbdv.a(paramContext, 5.0F));
  }
  
  public static void a(Context paramContext, String paramString, int paramInt)
  {
    bcql.a(paramContext, paramInt, paramString, 2000).b(paramContext.getResources().getDimensionPixelSize(2131298865) - (int)bbdv.a(paramContext, 5.0F));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForStructing paramMessageForStructing, List<ChatMessage> paramList, Map<String, String> paramMap, ArrayList<byte[]> paramArrayList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramList = (String)paramMap.get(akpx.c(localChatMessage));
        ...
        continue;
        paramList = asua.a().a(paramQQAppInterface, paramMessageForStructing.uniseq);
      }
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, long paramLong, ChatMessage paramChatMessage, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      str = adil.a(paramQQAppInterface, paramChatMessage);
    }
  ...
  public static String[] a(byte[] paramArrayOfByte)
  {
    ...
    //   864: astore 21
    //   866: aload 9
    //   868: invokestatic 869	bgqm:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   871: astore 25
    //   873: aload 4
    //   875: astore 23
    //   877: aload 5
    ...
    //   1070: astore 21
    //   1072: aload 9
    //   1074: invokestatic 869	bgqm:a	(Lorg/w3c/dom/Node;)Ljava/lang/String;
    //   1077: astore 24
    //   1079: aload 4
    //   1081: astore 23
    //   1083: aload 5
  ...
  public static byte[] b(QQAppInterface paramQQAppInterface, long paramLong, ChatMessage paramChatMessage, String paramString)
  {
    ...
    if (((paramChatMessage instanceof MessageForTroopFile)) || ((paramChatMessage instanceof MessageForFile)))
    {
      ...
      localObject = adil.a(paramQQAppInterface, paramChatMessage);
      a((FileManagerEntity)localObject);
      if (localObject == null) {
        break label219;
      }
      localbgpu.a(paramQQAppInterface, null, (FileManagerEntity)localObject, paramChatMessage, true);
    }
    for (;;)
    {
      paramQQAppInterface = new ContentValues();
      localObject = (ContentValues)localbgpu.a().getExtras().getParcelable("fileContents");
      if (localObject != null) {
        paramQQAppInterface.put("fileContents", a((ContentValues)localObject));
      }
      localObject = akpx.c(paramChatMessage);
      ...
      localObject = apug.a(paramQQAppInterface, (MessageForFile)paramChatMessage);
      break;
      label219:
      label483:
      if (QLog.isColorLevel())
      {
        ...
        if ((paramChatMessage instanceof MessageForTroopFile))
        {
          ...
          {
            a((FileManagerEntity)localObject);
            adil.a((FileManagerEntity)localObject, localMessageForTroopFile);
            if (localObject == null) {
              break label483;
            }
            localbgpu.a(paramQQAppInterface, null, (FileManagerEntity)localObject, localMessageForTroopFile, true);
            break;
            if (QLog.isColorLevel()) {
              QLog.d("qqfav", 2, "parcelFileMsg, isMultiMsg T, find in db");
            }
            localObject = bakx.a(paramQQAppInterface, localMessageForTroopFile);
            if (localObject != null)
            {
              FileManagerEntity localFileManagerEntity = adil.a((azqv)localObject);
              localObject = bajy.a(paramQQAppInterface, ((azqv)localObject).b);
              if ((localObject != null) && (localFileManagerEntity != null) && (!TextUtils.isEmpty(localFileManagerEntity.strTroopFilePath)))
              {
                azpi localazpi = ((bajy)localObject).a(localFileManagerEntity.strTroopFilePath);
                localObject = localFileManagerEntity;
                if (localazpi != null)
                {
                  localFileManagerEntity.lastTime = localazpi.c;
                  localFileManagerEntity.selfUin = String.valueOf(localazpi.b);
                  localObject = localFileManagerEntity;
                }
              }
              else
