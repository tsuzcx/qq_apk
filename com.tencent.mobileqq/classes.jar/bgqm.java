...
public class bgqm
{
  ...
  private WeakReference<bgqn> jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(null);
  private String b;
  private String c = "android";
  private String d = "8.4.8";
  ...
  public bgqm(String paramString, int paramInt, bgqn parambgqn)
  {
    this.b = paramString;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambgqn);
  }
  ...
  private bgqe a()
  {
    try
    {
      ...
      if (i == 200)
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            ...
            if (localObject != null) {
              return new bgqe((JSONObject)localObject);
            }
          }
        }
      }
      else
      {
        ...
        localObject = new bgqe();
        ((bgqe)localObject).jdField_a_of_type_Int = i;
        return localObject;
      }
    }
  ...
  private void a(bgqe parambgqe)
  {
    if ((parambgqe != null) && (QLog.isColorLevel())) {
      QLog.i("GetRegisterLiangHaoList", 2, "onResponse " + parambgqe);
    }
    ...
    if (parambgqe != null)
    {
      i = parambgqe.jdField_a_of_type_Int;
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localObject = (bgqn)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localObject != null) {
        break label143;
      }
      return;
    ...
    label143:
    ThreadManagerV2.getUIHandlerV2().post(new GetRegisterLiangHaoList.2(this, parambgqe, (bgqn)localObject));
  }
  ...
  private String b()
  {
    ...
    try
    {
      this.jdField_a_of_type_JavaLangString = bjms.a("ecd027");
