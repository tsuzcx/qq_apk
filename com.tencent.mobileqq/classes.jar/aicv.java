...
public class aicv
  extends akbe
{
  public aicv(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity) {}
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    if (this.a.jdField_a_of_type_Bcqf != null)
    {
      ...
      this.a.jdField_a_of_type_Bcqf = null;
    }
    ...
    if (paramBoolean)
    {
      ...
      if (j == this.a.jdField_a_of_type_Int)
      {
        ...
        this.a.finish();
        localObject = bbcz.a(this.a.app, this.a.getActivity().getApplicationContext(), paramObject);
        localIntent = actj.a(new Intent(this.a.getActivity(), SplashActivity.class), null);
    ...
    while (j != this.a.jdField_a_of_type_Int)
    {
      ...
      {
        this.a.finish();
        localObject = actj.a(new Intent(this.a.getActivity(), SplashActivity.class), null);
        ((Intent)localObject).putExtra("uin", paramObject);
        ((Intent)localObject).putExtra("uintype", 1);
        ((Intent)localObject).putExtra("uinname", bbcz.h(this.a.app, this.a.app.getCurrentAccountUin()) + ajya.a(2131702624));
        ((Intent)localObject).putExtra("isBack2Root", true);
        this.a.startActivity((Intent)localObject);
        axqy.b(this.a.app, "dc00899", "Grp_create", "", "f2f", "cre_suc", 0, 0, paramObject, "", "", "");
        return;
      }
    ...
    if (paramBoolean)
    {
      ...
      if ((paramBusiRespHead != null) && (paramBusiRespHead.int32_reply_code.get() != 0))
      {
        if (!this.a.jdField_c_of_type_Boolean)
        {
          ...
          bcql.a(this.a.jdField_a_of_type_AndroidContentContext, paramList, 0).a();
    ...
    for (;;)
    {
      ...
      default: 
        if (this.a.jdField_a_of_type_JavaUtilList == null)
        {
          ...
          if (this.a.jdField_a_of_type_Aicy != null)
          {
            this.a.jdField_a_of_type_Aicy.notifyDataSetChanged();
      ...
      for (;;)
      {
        ...
        this.a.jdField_a_of_type_AndroidWidgetTextView.setText(this.a.getString(2131719203));
        this.a.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(this.a.getString(2131719203));
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(this.a.getString(2131719204));
        this.a.jdField_b_of_type_AndroidWidgetTextView.setContentDescription(this.a.getString(2131719204));
        ...
        this.a.jdField_a_of_type_AndroidWidgetButton.setText(ajya.a(2131702623));
        this.a.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setText(this.a.getString(2131719208));
        break;
        this.a.jdField_b_of_type_Boolean = false;
        this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setText(this.a.getString(2131719210, new Object[] { localObject }));
        this.a.jdField_a_of_type_AndroidWidgetButton.setText(this.a.getString(2131719206));
        this.a.jdField_a_of_type_AndroidWidgetButton.setTextColor(-1);
        this.a.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.a.getString(2131719206));
        this.a.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130839026);
        break;
        this.a.jdField_b_of_type_Boolean = true;
        this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setVisibility(0);
        this.a.jdField_c_of_type_AndroidWidgetTextView.setText(this.a.getString(2131719209, new Object[] { localObject }));
        this.a.jdField_a_of_type_AndroidWidgetButton.setText(this.a.getString(2131719207));
        this.a.jdField_a_of_type_AndroidWidgetButton.setTextColor(-1);
        this.a.jdField_a_of_type_AndroidWidgetButton.setContentDescription(this.a.getString(2131719207));
        this.a.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130839026);
        break;
        ...
        if (!this.a.jdField_c_of_type_Boolean)
        {
          bcql.a(this.a.jdField_a_of_type_AndroidContentContext, ajya.a(2131702621), 1).a();
          if (this.a.jdField_a_of_type_AndroidOsHandler.hasMessages(1)) {
            this.a.jdField_a_of_type_AndroidOsHandler.removeMessages(1);
          }
          this.a.jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(1, 600L);
