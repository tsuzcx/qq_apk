...
public class pyi
{
  static pyi jdField_a_of_type_Pyi;
  ...
  public static pyi a()
  {
    try
    {
      if (jdField_a_of_type_Pyi == null) {
        jdField_a_of_type_Pyi = new pyi();
      }
      return jdField_a_of_type_Pyi;
    }
    finally {}
  }
  ...
  public Fragment a(TabChannelCoverInfo paramTabChannelCoverInfo)
  {
    ...
    if (paramTabChannelCoverInfo.mChannelCoverId == qez.a()) {
      if (tto.a(paramTabChannelCoverInfo.mChannelJumpUrl))
      {
      ...
      case 41708: 
        ...
        if (paramTabChannelCoverInfo.bid > 0L)
        {
          ...
          if (localObject2 != null)
          {
            ...
            if (!TextUtils.isEmpty(((ptm)localObject2).b("cgi"))) {}
