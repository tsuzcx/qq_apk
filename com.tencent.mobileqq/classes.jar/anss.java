...
public class anss
  extends anqo<CustomEmotionData>
{
  public int a;
  private ajwb jdField_a_of_type_Ajwb = new ansu(this);
  private anse jdField_a_of_type_Anse;
  public anwf a;
  private anwg jdField_a_of_type_Anwg = new answ(this);
  public ayvv a;
  protected ayvz a;
  WeakReference<aywa> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public anss(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger(0);
    this.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicInteger = new AtomicInteger(0);
    this.jdField_a_of_type_JavaUtilMap = new HashMap();
    this.jdField_a_of_type_Ayvz = new anst(this, ThreadManager.getSubThreadLooper());
    this.jdField_a_of_type_Anwf = new ansv(this);
    ...
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      ...
      if (i > 144) {
        ansp.jdField_a_of_type_Int = i;
      }
    }
  }
  
  public static anss a(QQAppInterface paramQQAppInterface)
  {
    return (anss)paramQQAppInterface.getManager(103);
  }
  ...
  private void a(String paramString, anse paramanse)
  {
    ...
    if (localList != null)
    {
      ...
      for (int i = 1;; i = k)
      {
        ...
        if ((str != null) && (str.equals(localCustomEmotionData.md5)))
        {
          ...
          {
            ((ansr)localObject).a(localCustomEmotionData, j);
            if (paramanse != null) {
              paramanse.a(0, str);
            }
          }
          while (paramanse == null) {
            return;
          }
          paramanse.a(1, str);
          return;
    ...
    paramString = new ansa(localQQAppInterface, null, (CustomEmotionData)localObject, null, 2);
    paramString.a(paramanse);
  ...
  private void i()
  {
    ...
    while (i < this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size())
    {
      ...
      {
        anta localanta = (anta)((WeakReference)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i)).get();
        if (localanta != null) {
          localanta.a(j);
        }
      }
  ...
  {
    int i = 0;
    if ((paramList == null) || (paramList.size() == 0) || (!bbev.d(BaseApplication.getContext()))) {
      return 0;
    }
    Object localObject = paramList;
    if (paramList.size() > ansp.jdField_a_of_type_Int)
    {
      j = paramList.size() - ansp.jdField_a_of_type_Int;
      localObject = paramList.subList(j, ansp.jdField_a_of_type_Int + j);
    }
  ...
  protected ajun<CustomEmotionData> a()
  {
    return (ajwa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(72);
  }
  
  protected anqm<CustomEmotionData> a()
  {
    return (ansr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(149);
  }
  
  public aywa a(CustomEmotionData paramCustomEmotionData, auoo paramauoo)
  {
    ...
    localaywa.jdField_c_of_type_Int = 9;
    localaywa.jdField_a_of_type_JavaLangString = "scbqmanyou";
    ...
    {
      b(paramCustomEmotionData, localaywa);
      return localaywa;
    }
    a(paramCustomEmotionData, localaywa);
    return localaywa;
  }
  ...
  public void a(CustomEmotionData paramCustomEmotionData, aywa paramaywa)
  {
    int j = 1;
    int i = 1;
    if ((paramCustomEmotionData == null) || (paramaywa == null)) {
      return;
    }
    ...
    Object localObject = ajxq.a(paramCustomEmotionData.emoPath);
    if ((!TextUtils.isEmpty((CharSequence)localObject)) && (((String)localObject).contains("qto_")))
    {
      ...
      j = ajxq.a(paramCustomEmotionData.eId);
      if (j != 0) {
        break label352;
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        paramaywa.jdField_a_of_type_ArrayOfByte = localExtensionExpRoamTryUp.toByteArray();
        paramaywa.jdField_a_of_type_Long = paramCustomEmotionData.emoId;
        paramaywa.i = paramCustomEmotionData.emoPath;
        if (this.jdField_a_of_type_Ayvv == null) {
          break;
        }
        this.jdField_a_of_type_Ayvv.a(paramaywa);
        return;
        localObject = ajvn.a(paramCustomEmotionData.emoPath);
  ...
  public void a(CustomEmotionData paramCustomEmotionData, String paramString)
  {
    ...
    do
    {
      return;
      localajwa = (ajwa)a();
    } while (localajwa == null);
    localajwa.a(paramCustomEmotionData, paramString);
  }
  ...
  public void a(CustomEmotionData paramCustomEmotionData, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((localObject != null) && (paramBoolean))
      {
        ...
        ((ansr)localObject).b(paramCustomEmotionData);
      }
      for (;;)
      {
        i = 0;
        while (i < this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size())
        {
          if (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i) != null)
          {
            localObject = (anta)((WeakReference)this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.get(i)).get();
            if (localObject != null) {
              ((anta)localObject).a(paramCustomEmotionData, this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get());
            }
          }
          i += 1;
        }
  ...
  public void a(String paramString)
  {
    ...
    anvr.a().a(this.jdField_a_of_type_Anwg);
    ((anvs)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(43)).a(paramString, anvs.jdField_c_of_type_Int, null, false);
  }
  ...
  public void a(List<String> paramList, ansy paramansy)
  {
    if (paramList == null) {}
    int i;
    do
    ...
    ThreadManager.excute(new FavroamingManager.8(this, i, paramansy, paramList), 64, null, true);
  }
  
  public aywa b(CustomEmotionData paramCustomEmotionData, auoo paramauoo)
  {
    return a(paramCustomEmotionData, paramauoo);
  }
  ...
  public void b(CustomEmotionData paramCustomEmotionData, aywa paramaywa)
  {
    if ((paramCustomEmotionData == null) || (paramaywa == null)) {
      return;
    }
    ...
    try
    {
      ...
      paramaywa.jdField_a_of_type_ArrayOfByte = localExtensionExpRoamTryUp.toByteArray();
      paramaywa.jdField_a_of_type_Long = paramCustomEmotionData.getId();
      paramCustomEmotionData = anvs.a(paramCustomEmotionData.emoPath, paramCustomEmotionData.eId, false);
      paramaywa.i = paramCustomEmotionData[1];
      ThreadManager.post(new FavroamingManager.7(this, paramCustomEmotionData, paramaywa), 5, null, true);
      return;
    }
  ...
  public void c()
  {
    ...
    {
      return;
      localajwa = (ajwa)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(72);
    } while (localajwa == null);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Ajwb);
    ThreadManager.excute(new FavroamingManager.3(this, localajwa), 128, null, true);
  }
  ...
  public void d()
  {
    ...
    do
    {
      ...
      Object localObject1 = (ansr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(149);
      localObject2 = ((ansr)localObject1).b("needDownload");
      localObject3 = ((ansr)localObject1).b("overflow");
  ...
  public void e()
  {
    ...
    {
      aywa localaywa = (aywa)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localaywa != null) {
  ...
  public void h()
  {
    ...
    {
      return;
      localObject = (ansr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(149);
