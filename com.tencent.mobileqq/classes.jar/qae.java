  ...
  implements qab
{
  ...
  private Map<String, qaf> jdField_a_of_type_JavaUtilMap = new HashMap();
  private final int b;
  private final int c;
  ...
  private int a(qaf paramqaf, String paramString1, String paramString2)
  {
    try
    {
      Object localObject = (String)bhvy.a(jdField_b_of_type_JavaLangString, "");
      if (TextUtils.isEmpty((CharSequence)localObject)) {
        return paramqaf.jdField_c_of_type_Int;
      }
      ...
      int i = j;
      if (j == 0) {
        i = paramqaf.jdField_c_of_type_Int;
      }
  ...
  public static long a(int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        if (oou.b(paramInt))
        {
          Object localObject = onz.a(String.valueOf(paramInt));
          if (localObject == null) {
            break label235;
          }
          l1 = ((onz)localObject).a(false);
          localObject = (String)bhvy.a(jdField_c_of_type_JavaLangString, "");
          if (TextUtils.isEmpty((CharSequence)localObject))
          {
  ...
  private qaf a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      paramString2 = (qaf)this.jdField_a_of_type_JavaUtilMap.get(str);
      paramString1 = paramString2;
    } while (paramString2 != null);
    paramString1 = new qaf(this);
  ...
  public static void a(int paramInt)
  {
    ...
    {
      g = paramInt;
      onz localonz2 = onz.a(String.valueOf(paramInt));
      onz localonz1 = localonz2;
      if (localonz2 == null)
      {
        localonz1 = new onz();
        onz.a(String.valueOf(paramInt), localonz1);
      }
  ...
  private void a(List<ArticleInfo> paramList, qaf paramqaf, qah paramqah)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      ArticleInfo localArticleInfo = (ArticleInfo)paramList.next();
      if (paramqaf.jdField_a_of_type_JavaLangString.equals(a(localArticleInfo))) {
        paramqah.jdField_a_of_type_JavaUtilList.add(localArticleInfo.innerUniqueID);
      }
      if ((localArticleInfo.mSubArtilceList != null) && (localArticleInfo.mSubArtilceList.size() > 0)) {
        a(localArticleInfo.mSubArtilceList, paramqaf, paramqah);
      }
    }
  }
  
  private void a(qaf paramqaf, String paramString1, String paramString2)
  {
    try
    {
      Object localObject = (String)bhvy.a(jdField_b_of_type_JavaLangString, "");
      ...
      {
        i += 1;
        paramqaf.jdField_c_of_type_Int = i;
        ...
        bhvy.a(jdField_b_of_type_JavaLangString, ((JSONObject)localObject).toString());
        return;
        localObject = new JSONObject((String)localObject);
        break;
      }
    }
    catch (JSONException paramqaf)
    {
      paramqaf.printStackTrace();
      return;
    }
  }
  ...
  {
    if ((paramqag != null) && (paramqag.jdField_a_of_type_JavaUtilList.size() > 0))
    {
      Iterator localIterator = paramqag.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        ...
        if ((localBackOffGroupInfo.bytes_back_off_group.has()) || (localBackOffGroupInfo.bytes_back_off_group.get() == null)) {
          a(localBackOffGroupInfo, paramqag.b);
        }
      }
    }
  }
  ...
  private void a(oidb_cmd0x68b.BackOffGroupInfo paramBackOffGroupInfo, List<ArticleInfo> paramList)
  {
    ...
    do
    {
      ...
      localqaf = a(paramBackOffGroupInfo.bytes_back_off_group.get().toStringUtf8(), String.valueOf(l));
    } while (localqaf == null);
    localqaf.jdField_a_of_type_JavaLangString = paramBackOffGroupInfo.bytes_back_off_group.get().toStringUtf8();
    if (paramBackOffGroupInfo.uint32_max_evoke_count.has()) {}
    for (int i = paramBackOffGroupInfo.uint32_max_evoke_count.get();; i = 0)
    {
      localqaf.jdField_a_of_type_Int = i;
      i = j;
      if (paramBackOffGroupInfo.uint32_max_fresh_evoke_count.has()) {
        i = paramBackOffGroupInfo.uint32_max_fresh_evoke_count.get();
      }
      localqaf.jdField_b_of_type_Int = i;
      paramBackOffGroupInfo = new qah(this);
      a(paramList, localqaf, paramBackOffGroupInfo);
      localqaf.a(paramBackOffGroupInfo);
      return;
    }
  }
  ...
  public static void a(oidb_cmd0x68b.ReqChannelPara paramReqChannelPara, String paramString)
  {
    try
    {
      Object localObject = (String)bhvy.a(jdField_a_of_type_JavaLangString, "");
      ...
      for (;;)
      {
        ...
        bhvy.a(jdField_a_of_type_JavaLangString, ((JSONObject)localObject).toString());
  ...
  public static void b(int paramInt)
  {
    if ((paramInt == 0) || (oou.b(paramInt)))
    {
      onz localonz = onz.a(String.valueOf(paramInt));
      if ((localonz != null) && (localonz.a()))
      {
        c(paramInt);
        localonz.b();
        localonz.c();
        ...
        if (localObject != null)
        {
          ...
          if (TextUtils.isEmpty((CharSequence)localObject))
          {
            ...
            if (!str2.equals(str1))
            {
              ...
              bhvy.a(jdField_c_of_type_JavaLangString, ((JSONObject)localObject).toString());
            }
          }
          else
          {
  ...
  public static boolean c(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (paramBaseArticleInfo.bytes_jump_bundle.has())
    {
      ...
      bool = bbfr.a(BaseApplicationImpl.getApplication(), paramBaseArticleInfo);
  ...
  public boolean a(BaseArticleInfo paramBaseArticleInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      qaf localqaf = a(str2, String.valueOf(paramBaseArticleInfo.mChannelID));
      if (localqaf == null)
      {
      ...
      localqaf.jdField_c_of_type_Int = a(localqaf, str2, String.valueOf(paramBaseArticleInfo.mChannelID));
      QLog.d(jdField_d_of_type_JavaLangString, 1, "judgeHitRule backOffGroup.clickTime is " + localqaf.jdField_c_of_type_Int + " backOffGroup.maxEvokeCount is " + localqaf.jdField_a_of_type_Int + " groupid is " + localqaf.jdField_a_of_type_JavaLangString);
      if (localqaf.jdField_c_of_type_Int >= localqaf.jdField_a_of_type_Int)
      {
        QLog.d(jdField_d_of_type_JavaLangString, 1, "judgeHitRule over groupClick");
        return false;
      }
      Iterator localIterator = localqaf.jdField_a_of_type_JavaUtilDeque.iterator();
      qah localqah;
      do
      {
        bool1 = bool2;
        ...
        localqah = (qah)localIterator.next();
      } while (!localqah.jdField_a_of_type_JavaUtilList.contains(str1));
      QLog.d(jdField_d_of_type_JavaLangString, 1, "judgeHitRule freshInfo.clickTime is " + localqah.jdField_a_of_type_Int + " backOffGroup.maxFreshEvokeCount is " + localqaf.jdField_b_of_type_Int);
      bool1 = bool2;
      if (localqah.jdField_a_of_type_Int >= localqaf.jdField_b_of_type_Int) {
        break;
      }
      if ((paramBoolean) && (!TextUtils.isEmpty(a(paramBaseArticleInfo, null, null))))
      {
        localqah.jdField_a_of_type_Int += 1;
        a(localqaf, str2, String.valueOf(paramBaseArticleInfo.mChannelID));
      }
      return true;
    }
  }
