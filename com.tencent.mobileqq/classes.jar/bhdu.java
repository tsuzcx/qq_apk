...
public final class bhdu
  implements Handler.Callback, bhdk, bjwx, bjxx, DownloadListener
{
  private static bhdu jdField_a_of_type_Bhdu;
  private int jdField_a_of_type_Int;
  private bhdj jdField_a_of_type_Bhdj;
  private bhdv jdField_a_of_type_Bhdv;
  ...
  private WeakReference<bhdw> jdField_a_of_type_JavaLangRefWeakReference;
  private final ArrayList<bhdx> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  public boolean a;
  ...
  private int a(int paramInt1, int paramInt2)
  {
    ...
    String str;
    Bundle localBundle;
    if ((this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper != null) && (this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bhdz != null) && (this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bhdz.jdField_a_of_type_JavaLangString != null))
    {
      str = this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bhdz.jdField_a_of_type_JavaLangString;
      localBundle = new Bundle();
      localBundle.putString(bjwo.b, "100686848");
      localBundle.putString(bjwo.j, this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.strNewSoftwareURL);
      localBundle.putString(bjwo.f, this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName());
      localBundle.putInt(bjwo.k, paramInt1);
      if (paramInt1 == 12) {
        localBundle.putBoolean(bjwo.o, true);
      }
      localBundle.putString(bjwo.i, "ANDROIDQQ.QQUPDATE");
      localBundle.putString(bjwo.l, str);
      if (paramInt2 == 0) {
        break label319;
      }
      localBundle.putString(bjwo.m, "_100686848");
    ...
    {
      localBundle.putString(bjwo.jdField_c_of_type_JavaLangString, "6633");
      localBundle.putInt(bjwo.e, this.jdField_a_of_type_Int);
      localBundle.putBoolean(bjwo.g, true);
      localBundle.putBoolean(bjwo.h, true);
      localBundle.putInt(bjwo.n, 1);
      localBundle.putInt(bjwo.A, this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.bGray);
      bjwk.a(BaseActivity.sTopActivity, localBundle, "biz_src_jc_update", this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_ComTencentApkupdateLogicDataApkUpdateDetail, i);
      return 0;
      str = "新版手Q";
      break;
      label319:
  ...
  public static bhdu a()
  {
    if (jdField_a_of_type_Bhdu == null) {
      jdField_a_of_type_Bhdu = new bhdu();
    }
    return jdField_a_of_type_Bhdu;
  }
  ...
  public static String a()
  {
    ...
    if (localObject != null)
    {
      localObject = ((bhdu)localObject).jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper;
      str1 = str2;
      if (localObject != null)
      {
        str1 = str2;
  ...
  {
    return blhn.a(paramString, "nt", bhdt.a());
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo != null)) {
        if ((((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.iUpgradeType > 0) && (((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.bNewSwitch == 1))
        {
          ...
          if (anvl.a(paramQQAppInterface, ((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.iNewTimeStamp)) {
            break label96;
          }
          bool1 = bool2;
        }
    ...
    for (;;)
    {
      bool2 = bool1;
      if (!bool1) {
        bool2 = ((axam)paramQQAppInterface.getManager(244)).a();
      }
      return bool2;
      bool1 = false;
      break;
  ...
  private void b(int paramInt)
  {
    try
    {
      anvl localanvl = (anvl)((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getRuntime()).a(4);
      ...
      localanvl.a(str, paramInt, this.jdField_a_of_type_JavaLangString);
      return;
    }
    finally
    {
  ...
  {
    paramQQAppInterface = bhea.a(paramQQAppInterface);
    boolean bool2;
    boolean bool1;
  ...
  private void c(int paramInt)
  {
    ...
    do
    {
      ...
      localbhdw = (bhdw)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localbhdw == null);
    if (this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo != null) {
      localbhdw.a(paramInt, this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper, this);
    }
  ...
  private void d(int paramInt)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      if (localIterator.hasNext()) {
        ((bhdx)localIterator.next()).a(paramInt, this);
      }
    }
  }
  ...
  private void g()
  {
    try
    {
      if (!a())
      {
        this.jdField_a_of_type_Bhdv = new bhdv(this);
        this.jdField_a_of_type_Bhdv.a();
      }
      return;
    }
    finally
  ...
  private void h()
  {
    try
    {
      if (a())
      {
        this.jdField_a_of_type_Bhdv.b();
        this.jdField_a_of_type_Bhdv = null;
      }
      return;
    }
    finally
  ...
  private void i()
  {
    ...
    bdll.b((QQAppInterface)localObject, "CliOper", "", "", "0X800716C", "0X800716C", 0, 0, "", "", "", "");
    int i = 0;
    this.jdField_a_of_type_Boolean = false;
    if (bhnv.h(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl)) {
      i = 1;
    }
    ...
    bdmc.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", true, 0L, 0L, (HashMap)localObject, "", true);
  }
  ...
  private void k()
  {
    try
    {
      ...
      if (this.d)
      {
        ...
        {
          bjwk.b(this.jdField_a_of_type_Bhdj);
  ...
  public void a()
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadInfo != null) && (this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadInfo.jdField_c_of_type_Int == 1))
      {
        ...
        anvl.b(localQQAppInterface, false);
        d(false);
        return;
      }
    } while (this.b);
    b(anvl.a(localQQAppInterface, false));
  }
  ...
  public void a(int paramInt)
  {
    ...
    {
      bdmc.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeWritten", bool, 0L, 0L, localHashMap, "", true);
      return;
    }
  }
  ...
  public void a(bhdx parambhdx)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(parambhdx)) {
        this.jdField_a_of_type_JavaUtilArrayList.add(parambhdx);
      }
      return;
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    String str = anvl.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl);
  ...
  public void a(String paramString)
  {
    ...
    b(this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bhdz.jdField_a_of_type_Int);
  }
  ...
  public void a(ArrayList<ApkUpdateDetail> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      {
        if (this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bhdz.jdField_a_of_type_Int == paramArrayList.versioncode) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Bhdj == null)
        {
          ...
          this.jdField_a_of_type_Bhdj = new bhdj(paramString2, this);
          bjwk.a(this.jdField_a_of_type_Bhdj);
      ...
      if (i != 0)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bhdz = null;
        c(-1);
      }
    }
  }
  ...
  boolean a()
  {
    return this.jdField_a_of_type_Bhdv != null;
  }
  ...
  public boolean a(UpgradeInfo paramUpgradeInfo, bhdw parambhdw)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bhdz = anvl.a(paramUpgradeInfo);
    if ((parambhdw == null) || (paramUpgradeInfo == null)) {
      return false;
    }
    ...
    j();
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambhdw);
    if (QLog.isColorLevel()) {
      QLog.d("UpgradeController", 2, "handleUpgradeInfo packageName = " + this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName() + ", bGray = " + paramUpgradeInfo.bGray + ", versioncode = " + this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bhdz.jdField_a_of_type_Int);
    }
    paramUpgradeInfo = new ApkUpdateParam(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName(), paramUpgradeInfo.bGray, this.jdField_a_of_type_ComTencentMobileqqUpgradeUpgradeDetailWrapper.jdField_a_of_type_Bhdz.jdField_a_of_type_Int);
    parambhdw = new ArrayList();
    parambhdw.add(paramUpgradeInfo);
    bjxw.a().b(parambhdw);
    return true;
  }
  ...
  public void b(bhdx parambhdx)
  {
    ...
    {
      if (this.jdField_a_of_type_JavaUtilArrayList.contains(parambhdx)) {
        this.jdField_a_of_type_JavaUtilArrayList.remove(parambhdx);
      }
      return;
    }
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    anvl.b(localQQAppInterface, paramBoolean);
    if (paramBoolean)
    {
      g();
      return;
  ...
  public void c()
  {
    ...
    //   18: aload_0
    //   19: getfield 243	bhdu:b	Z
    //   22: ifeq +21 -> 43
    //   25: aload_0
    //   26: iconst_0
    //   27: putfield 243	bhdu:b	Z
    //   30: aload_0
    //   31: invokevirtual 794	bhdu:e	()V
    //   34: aload_0
    //   35: invokespecial 796	bhdu:h	()V
    //   38: ldc 138
    //   40: invokestatic 798	bjwk:a	(Ljava/lang/String;)V
    //   43: aload_0
    //   44: monitorexit
    //   45: return
    //   46: astore_1
  ...
  public void onDownloadError(DownloadInfo paramDownloadInfo, int paramInt1, String paramString, int paramInt2)
  {
    ...
    bdmc.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", false, 0L, 0L, paramDownloadInfo, "", true);
  }
  ...
  public void onDownloadFinish(DownloadInfo paramDownloadInfo)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject2))
    {
      ...
      {
        paramDownloadInfo = bjwq.a().a(paramDownloadInfo);
        localObject1 = localObject2;
    ...
    for (;;)
    {
      int k = arta.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl);
      ...
      for (i = 101;; i = 9527)
      {
        ...
        bdmc.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", false, 0L, 0L, (HashMap)localObject1, "", true);
        if (bool) {
          break;
        }
        this.jdField_a_of_type_Blhq.sendEmptyMessage(0);
        return;
