  ...
  extends blul
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = blup.class.getSimpleName();
  }
  
  public blup(PeakAppInterface paramPeakAppInterface)
  {
  ...
  public static String a(android.content.Context paramContext, Bitmap paramBitmap)
  {
    ...
    //   3: dup
    //   4: getstatic 34	bljl:b	Ljava/lang/String;
    ...
    //   215: iload_3
    //   216: iload_2
    //   217: invokestatic 123	bfvo:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;II)V
    //   220: iconst_0
    //   221: istore 5
    //   223: iload_3
    //   224: istore 4
    ...
    //   294: invokestatic 123	bfvo:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;II)V
    //   297: iload_2
    //   298: iconst_1
    //   299: iadd
    //   300: istore_2
    //   301: goto -70 -> 231
    //   304: astore 6
    //   306: getstatic 16	blup:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   332: invokestatic 145	bmbx:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   335: goto -136 -> 199
    //   338: astore 8
    //   340: aconst_null
    //   341: astore 6
    //   343: aload 6
    //   345: astore 7
    //   347: getstatic 16	blup:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   373: invokestatic 145	bmbx:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   376: aload 6
    //   378: ifnull +8 -> 386
    //   381: aload 6
    ...
    //   397: goto -187 -> 210
    //   400: astore 6
    //   402: getstatic 16	blup:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   428: invokestatic 145	bmbx:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   431: goto -45 -> 386
    //   434: astore 7
    //   436: aload 8
    //   438: astore 6
    ...
    //   444: aload 6
    //   446: astore 7
    //   448: getstatic 16	blup:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   474: invokestatic 145	bmbx:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   477: aload 6
    //   479: ifnull +8 -> 487
    //   482: aload 6
    ...
    //   498: goto -288 -> 210
    //   501: astore 6
    //   503: getstatic 16	blup:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   529: invokestatic 145	bmbx:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   532: goto -45 -> 487
    //   535: astore_0
    //   536: aload 7
    //   538: ifnull +8 -> 546
    ...
    //   558: athrow
    //   559: astore 6
    //   561: getstatic 16	blup:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   587: invokestatic 145	bmbx:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   590: goto -44 -> 546
    //   593: aload_1
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      if ((localObject != null) && (((GetBulkImageClassifyRsp)localObject).MiltiRsps != null))
      {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          paramObject.add(new bmgk(localSmartFilterRspItem.PituLabel, localSmartFilterRspItem.DisplayLabels));
        }
        bmfh.a().a(paramObject, paramToServiceMsg.hashCode());
      }
      paramToServiceMsg = bmbc.a();
    ...
    for (long l1 = ((Long)this.jdField_a_of_type_JavaUtilMap.get("CameraModuleSvc.GetBulkImageClassify")).longValue();; l1 = 0L)
    {
      ...
      {
        bmfh.a().a(-6, paramToServiceMsg.hashCode());
        break;
      }
      bmfh.a().a(-1, paramToServiceMsg.hashCode());
      break;
    }
  }
  ...
  private void b(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      localbmbc.a(i, String.valueOf(l2 - l1), "CameraModuleSvc.GetFontData", paramObject.Code);
      return;
    }
  }
    ...
    for (int i = paramObject.ValidStatus;; i = -2)
    {
      ...
      if ((paramFromServiceMsg != null) && (paramObject != null))
      {
        ...
        if (this.jdField_a_of_type_JavaUtilMap.containsKey("CameraModuleSvc.GetImgValidStatus"))
        {
          ...
          localbmbc.a(j, String.valueOf(l2 - l1), "CameraModuleSvc.GetImgValidStatus", paramObject.Code);
        }
      }
      else
      {
  ...
  private void d(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      localbmbc.a(i, String.valueOf(l2 - l1), "CameraModuleSvc.GetOnlineUserNum", paramObject.Code);
      return;
    }
  }
        ...
        try
        {
          ...
          if ((paramFromServiceMsg != null) && (localGetRecommandTextByEmotionRsp != null))
          {
            ...
            if (this.jdField_a_of_type_JavaUtilMap.containsKey("CameraModuleSvc.GetRecommandTextByEmotion"))
            {
              ...
              localbmbc.a(i, String.valueOf(l2 - l1), "CameraModuleSvc.GetRecommandTextByEmotion", localGetRecommandTextByEmotionRsp.Code);
            }
          }
          else
          {
            notifyUI(1, bool, new blwu(localArrayList, str, paramObject));
            return;
          }
        }
  ...
  private void f(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      {
        localbmbc.a(i, String.valueOf(l2 - l1), "CameraModuleSvc.GetTextValidStatus", paramObject.Code);
  ...
  public void a(ArrayList<SmartFilterReqItem> paramArrayList, bmfl parambmfl)
  {
    if (!NetworkUtil.isNetworkAvailable()) {
      LogUtils.w("111", "[reqRecommandTextByEmotion] no network....");
    }
    ...
    do
    {
      ...
      send(localToServiceMsg);
    } while (parambmfl == null);
    parambmfl.a(localToServiceMsg.hashCode());
  }
  ...
  public void b(String paramString)
  {
    ...
    FaceChangeUtils.cropFace(paramString, new bluq(this, localToServiceMsg));
  }
