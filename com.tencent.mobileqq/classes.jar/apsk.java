...
public class apsk
{
  ...
  public static Bitmap a(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, aozt paramaozt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        catch (OutOfMemoryError paramString1)
        {
          ...
          localPaint.setColor(-1);
          a(paramAppInterface, paramContext, paramInt1, paramInt2, paramInt3, paramString1, paramString2, paramString3, paramJSONArray, paramaozt, i, j, k, m, str, localCanvas, localPaint);
          ...
          paramAppInterface = paramContext.getResources().getDrawable(2130844890);
          paramAppInterface.setBounds(i / 2 - 45, j - 102 - 42, i / 2 + 45, j - 102);
          paramAppInterface.draw(localCanvas);
          paramAppInterface = amtj.a(2131701566);
  ...
  public static String a(AppInterface paramAppInterface, Context paramContext, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramContext = yyi.a(paramContext, str, paramBitmap);
        paramAppInterface = paramContext;
        if (QLog.isColorLevel())
        {
  ...
  public static String a(String paramString, float paramFloat)
  {
    ...
    int i;
    int j;
    if (apsn.a(paramString) > paramFloat)
    {
    ...
    for (;;)
    {
      if ((i >= paramString.length()) || (apsn.a(paramString.substring(0, i) + "…") > paramFloat))
      {
  ...
  public static ArrayList<apsv> a(JSONArray paramJSONArray)
  {
    ...
    if (i < j)
    {
      ...
      do
      {
        ...
        localArrayList.add(new apsv(str));
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, aozt paramaozt, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString4, Canvas paramCanvas, Paint paramPaint)
  {
    if (paramInt3 == 0)
    {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = (apso)paramJSONArray.next();
        localObject2 = ((apso)localObject1).jdField_a_of_type_JavaUtilArrayList.iterator();
        label721:
        if (((Iterator)localObject2).hasNext())
        {
          localObject3 = (apsp)((Iterator)localObject2).next();
          paramString3.left = (((apsp)localObject3).jdField_a_of_type_AndroidGraphicsRect.left + paramString2.left + 1);
          paramString3.top = (((apsp)localObject3).jdField_a_of_type_AndroidGraphicsRect.top + paramString2.top + 1);
          paramString3.right = (((apsp)localObject3).jdField_a_of_type_AndroidGraphicsRect.right + paramString2.left - 2);
          paramString3.bottom = (((apsp)localObject3).jdField_a_of_type_AndroidGraphicsRect.bottom + paramString2.top - 2);
          paramPaint.setColor(((apso)localObject1).jdField_a_of_type_Int);
          if (!((apso)localObject1).jdField_b_of_type_Boolean) {
            break label913;
          }
          paramInt1 = 178;
          paramPaint.setAlpha(paramInt1);
          paramPaint.setFakeBoldText(((apso)localObject1).jdField_a_of_type_Boolean);
          paramString1 = Paint.Align.CENTER;
          if (((apso)localObject1).c != -1) {
            break label920;
          }
        ...
        {
          label849:
          a(paramCanvas, paramPaint, paramString3, ((apsp)localObject3).jdField_a_of_type_JavaLangString, paramString1, ((apso)localObject1).d, ((apso)localObject1).jdField_b_of_type_Int);
          break label721;
          break;
          label913:
          paramInt1 = 255;
      ...
      if (paramaozt != null)
      {
        paramAppInterface = paramaozt.a(paramAppInterface.getCurrentAccountUin(), true);
        QLog.i("ConfessShareHelper", 4, "preLoadQQSelfHeaderBitmap " + paramAppInterface);
      }
      for (paramAppInterface = new BitmapDrawable(paramAppInterface);; paramAppInterface = paramContext.getResources().getDrawable(2130844883))
      {
        ...
        paramContext = a(paramString4, 8.0F) + amtj.a(2131701567);
  ...
  public static boolean a(Context paramContext, Canvas paramCanvas, int paramInt1, int paramInt2, float paramFloat)
  {
    ...
    apsl[] arrayOfapsl = a(paramInt2, paramInt1);
    paramInt2 = arrayOfapsl.length;
    paramInt1 = 0;
    apsl localapsl;
    if (paramInt1 < paramInt2) {
      localapsl = arrayOfapsl[paramInt1];
    }
    for (;;)
    {
      try
      {
        localDrawable = paramContext.getResources().getDrawable(localapsl.jdField_a_of_type_Int);
        if (localapsl.jdField_a_of_type_Int == 2130844892) {
          break label316;
        }
        if (localapsl.jdField_a_of_type_Int != 2130844885) {
          break label309;
        }
      }
      ...
      m = (int)(localapsl.jdField_b_of_type_Int - j * localapsl.jdField_a_of_type_Float * f1 / 2.0F);
      n = (int)(localapsl.c * f2 - k * localapsl.jdField_a_of_type_Float * f1 / 2.0F);
      f3 = localapsl.jdField_b_of_type_Int;
      localDrawable.setBounds(m, n, (int)(j * localapsl.jdField_a_of_type_Float * f1 / 2.0F + f3), (int)(f2 * localapsl.c + k * localapsl.jdField_a_of_type_Float * f1 / 2.0F));
      if (localapsl.jdField_a_of_type_Boolean)
      {
  ...
  public static apsl[] a(int paramInt1, int paramInt2)
  {
    if (paramInt1 == 0) {
      switch (paramInt2)
      {
    ...
    do
    {
      ...
      {
        return new apsl[0];
        return new apsl[] { new apsl(2130844857, 60, 60, true, 0.75F), new apsl(2130844862, 458, 84, true, 0.75F), new apsl(2130844863, 142, 250, true, 0.75F), new apsl(2130844857, 368, 188, true, 0.75F), new apsl(2130844855, 168, 120, true, 0.75F), new apsl(2130844888, 120, 40, true, 0.75F), new apsl(2130844889, 120, 110, true, 0.75F), new apsl(2130844886, 30, 150, true, 0.75F), new apsl(2130844886, 180, 200, true, 0.75F), new apsl(2130844888, 420, 160, true, 0.75F), new apsl(2130844889, 495, 150, true, 0.75F), new apsl(2130844885, 257, 82, false, 1.0F) };
        return new apsl[] { new apsl(2130844864, 60, 88, true, 0.75F), new apsl(2130844856, 226, 56, true, 0.75F), new apsl(2130844863, 480, 140, true, 0.75F), new apsl(2130844861, 330, 198, true, 0.75F), new apsl(2130844862, 168, 244, true, 0.75F), new apsl(2130844888, 300, 50, true, 0.75F), new apsl(2130844889, 460, 50, true, 0.75F), new apsl(2130844886, 60, 230, true, 0.75F), new apsl(2130844888, 120, 120, true, 0.75F), new apsl(2130844888, 440, 270, true, 0.75F), new apsl(2130844885, 257, 82, false, 1.0F) };
        return new apsl[] { new apsl(2130844857, 174, 58, true, 0.75F), new apsl(2130844859, 70, 146, true, 0.75F), new apsl(2130844861, 390, 106, true, 0.75F), new apsl(2130844856, 206, 240, true, 0.75F), new apsl(2130844858, 470, 225, true, 0.75F), new apsl(2130844889, 120, 88, true, 0.75F), new apsl(2130844889, 480, 70, true, 0.75F), new apsl(2130844886, 110, 230, true, 0.75F), new apsl(2130844888, 340, 210, true, 0.75F), new apsl(2130844885, 257, 82, false, 1.0F) };
        return new apsl[] { new apsl(2130844863, 138, 88, true, 0.75F), new apsl(2130844857, 68, 232, true, 0.75F), new apsl(2130844861, 298, 206, true, 0.75F), new apsl(2130844864, 480, 140, true, 0.75F), new apsl(2130844893, 382, 140, true, 0.75F), new apsl(2130844888, 60, 90, true, 0.75F), new apsl(2130844886, 182, 64, true, 0.75F), new apsl(2130844886, 440, 210, true, 0.75F), new apsl(2130844888, 440, 30, true, 0.75F), new apsl(2130844888, 190, 200, true, 0.75F), new apsl(2130844885, 257, 82, false, 1.0F) };
        if (paramInt1 != 1) {
          break;
        }
        switch (paramInt2)
      ...
      return new apsl[] { new apsl(2130844858, 110, 230, true, 1.0F), new apsl(2130844861, 656, 170, true, 1.0F), new apsl(2130844856, 516, 350, true, 1.0F), new apsl(2130844857, 84, 550, true, 1.0F), new apsl(2130844862, 656, 586, true, 1.0F), new apsl(2130844857, 526, 735, true, 1.0F), new apsl(2130844863, 198, 830, true, 1.0F), new apsl(2130844859, 70, 1016, true, 1.0F), new apsl(2130844861, 397, 952, true, 1.0F), new apsl(2130844864, 670, 880, true, 1.0F), new apsl(2130844856, 220, 1257, true, 1.0F), new apsl(2130844860, 606, 1220, true, 1.0F), new apsl(2130844893, 452, 475, true, 1.0F), new apsl(2130844855, 240, 645, true, 1.0F), new apsl(2130844886, 160, 300, true, 1.0F), new apsl(2130844889, 660, 330, true, 1.0F), new apsl(2130844887, 620, 450, true, 1.0F), new apsl(2130844888, 175, 500, true, 1.0F), new apsl(2130844888, 460, 570, true, 1.0F), new apsl(2130844889, 180, 630, true, 1.0F), new apsl(2130844886, 40, 690, true, 1.0F), new apsl(2130844886, 260, 750, true, 1.0F), new apsl(2130844889, 710, 600, true, 1.0F), new apsl(2130844888, 600, 710, true, 1.0F), new apsl(2130844888, 140, 970, true, 1.0F), new apsl(2130844886, 85, 1200, true, 1.0F), new apsl(2130844886, 600, 1050, true, 1.0F), new apsl(2130844889, 420, 1100, true, 1.0F), new apsl(2130844888, 540, 1250, true, 1.0F), new apsl(2130844892, 375, 134, false, 1.0F) };
      return new apsl[] { new apsl(2130844861, 110, 368, true, 1.0F), new apsl(2130844862, 570, 256, true, 1.0F), new apsl(2130844857, 655, 475, true, 1.0F), new apsl(2130844864, 75, 740, true, 1.0F), new apsl(2130844856, 320, 686, true, 1.0F), new apsl(2130844863, 670, 832, true, 1.0F), new apsl(2130844861, 505, 955, true, 1.0F), new apsl(2130844862, 260, 1020, true, 1.0F), new apsl(2130844860, 75, 1216, true, 1.0F), new apsl(2130844856, 565, 1235, true, 1.0F), new apsl(2130844893, 430, 355, true, 1.0F), new apsl(2130844855, 110, 174, true, 1.0F), new apsl(2130844886, 140, 250, true, 1.0F), new apsl(2130844889, 640, 195, true, 1.0F), new apsl(2130844886, 170, 450, true, 1.0F), new apsl(2130844888, 490, 1220, true, 1.0F), new apsl(2130844887, 350, 520, true, 1.0F), new apsl(2130844887, 630, 410, true, 1.0F), new apsl(2130844889, 60, 500, true, 1.0F), new apsl(2130844889, 680, 655, true, 1.0F), new apsl(2130844889, 310, 1110, true, 1.0F), new apsl(2130844888, 470, 660, true, 1.0F), new apsl(2130844888, 190, 780, true, 1.0F), new apsl(2130844888, 680, 1060, true, 1.0F), new apsl(2130844886, 180, 1230, true, 1.0F), new apsl(2130844892, 375, 134, false, 1.0F) };
      return new apsl[] { new apsl(2130844857, 110, 220, true, 1.0F), new apsl(2130844863, 654, 240, true, 1.0F), new apsl(2130844861, 562, 482, true, 1.0F), new apsl(2130844859, 95, 537, true, 1.0F), new apsl(2130844856, 295, 672, true, 1.0F), new apsl(2130844858, 683, 660, true, 1.0F), new apsl(2130844860, 60, 850, true, 1.0F), new apsl(2130844862, 442, 872, true, 1.0F), new apsl(2130844856, 114, 1046, true, 1.0F), new apsl(2130844857, 680, 950, true, 1.0F), new apsl(2130844862, 230, 1197, true, 1.0F), new apsl(2130844864, 480, 1260, true, 1.0F), new apsl(2130844893, 670, 1200, true, 1.0F), new apsl(2130844886, 140, 630, true, 1.0F), new apsl(2130844886, 500, 960, true, 1.0F), new apsl(2130844886, 330, 1050, true, 1.0F), new apsl(2130844886, 50, 1150, true, 1.0F), new apsl(2130844887, 290, 430, true, 1.0F), new apsl(2130844887, 330, 760, true, 1.0F), new apsl(2130844888, 60, 310, true, 1.0F), new apsl(2130844888, 480, 580, true, 1.0F), new apsl(2130844888, 220, 820, true, 1.0F), new apsl(2130844889, 600, 150, true, 1.0F), new apsl(2130844889, 700, 410, true, 1.0F), new apsl(2130844889, 25, 900, true, 1.0F), new apsl(2130844889, 150, 430, true, 1.0F), new apsl(2130844892, 375, 134, false, 1.0F) };
      return new apsl[] { new apsl(2130844857, 104, 278, true, 1.0F), new apsl(2130844860, 588, 200, true, 1.0F), new apsl(2130844856, 690, 390, true, 1.0F), new apsl(2130844859, 420, 534, true, 1.0F), new apsl(2130844858, 92, 592, true, 1.0F), new apsl(2130844862, 660, 624, true, 1.0F), new apsl(2130844857, 475, 735, true, 1.0F), new apsl(2130844863, 192, 818, true, 1.0F), new apsl(2130844864, 696, 880, true, 1.0F), new apsl(2130844861, 430, 990, true, 1.0F), new apsl(2130844856, 64, 1034, true, 1.0F), new apsl(2130844856, 272, 1250, true, 1.0F), new apsl(2130844860, 584, 1205, true, 1.0F), new apsl(2130844855, 254, 638, true, 1.0F), new apsl(2130844886, 200, 320, true, 1.0F), new apsl(2130844886, 260, 780, true, 1.0F), new apsl(2130844886, 620, 1000, true, 1.0F), new apsl(2130844886, 150, 1250, true, 1.0F), new apsl(2130844887, 70, 420, true, 1.0F), new apsl(2130844887, 460, 590, true, 1.0F), new apsl(2130844887, 630, 450, true, 1.0F), new apsl(2130844888, 70, 800, true, 1.0F), new apsl(2130844888, 280, 980, true, 1.0F), new apsl(2130844888, 610, 720, true, 1.0F), new apsl(2130844888, 480, 1220, true, 1.0F), new apsl(2130844889, 170, 590, true, 1.0F), new apsl(2130844889, 330, 1160, true, 1.0F), new apsl(2130844889, 700, 680, true, 1.0F), new apsl(2130844889, 660, 290, true, 1.0F), new apsl(2130844892, 375, 134, false, 1.0F) };
    } while (paramInt1 != 2);
    return new apsl[] { new apsl(2130844858, 110, 310, true, 1.0F), new apsl(2130844861, 650, 216, true, 1.0F), new apsl(2130844856, 516, 350, true, 1.0F), new apsl(2130844858, 92, 592, true, 1.0F), new apsl(2130844862, 656, 586, true, 1.0F), new apsl(2130844857, 470, 716, true, 1.0F), new apsl(2130844863, 198, 830, true, 1.0F), new apsl(2130844864, 670, 980, true, 1.0F), new apsl(2130844861, 397, 1060, true, 1.0F), new apsl(2130844859, 70, 1016, true, 1.0F), new apsl(2130844886, 200, 320, true, 1.0F), new apsl(2130844855, 240, 438, true, 1.0F), new apsl(2130844893, 452, 475, true, 0.75F), new apsl(2130844886, 200, 600, true, 1.0F), new apsl(2130844886, 1000, 620, true, 1.0F), new apsl(2130844887, 70, 420, true, 1.0F) };
  }
  
  public static Bitmap b(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, aozt paramaozt)
  {
    if ((paramJSONArray == null) || (paramJSONArray.length() < 1) || (paramContext == null))
    {
      paramAppInterface = null;
      ...
      for (;;)
      {
        ...
        catch (OutOfMemoryError paramString1)
        {
          try
          {
            ...
            localPaint.setColor(-1);
            a(paramAppInterface, paramContext, paramInt1, paramInt2, paramInt3, null, paramString2, paramString3, paramJSONArray, paramaozt, i, j, 5, 5, str, localCanvas, localPaint);
            localPaint.setAlpha(255);
            localPaint.setColor(-1);
            return paramString1;
          }
