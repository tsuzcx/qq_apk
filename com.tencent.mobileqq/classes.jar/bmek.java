  ...
  extends bmiv
{
  ...
  public bmek(@NonNull bmix parambmix)
  {
    super(parambmix);
  }
  ...
  public Bitmap a(String paramString)
  {
    ...
    DisplayMetrics localDisplayMetrics = this.jdField_a_of_type_Bmkf.getActivity().getResources().getDisplayMetrics();
    ...
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      ...
      this.jdField_a_of_type_Bmel.obtainMessage(2, paramString).sendToTarget();
    }
    return paramString;
  }
  ...
  {
    super.a();
    this.jdField_a_of_type_Bmel = new bmel(this);
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 == 100)
    {
      ...
      localActivity = this.jdField_a_of_type_Bmix.a().getActivity();
    ...
    ((blnl)blmf.a(5)).a[a()].c(localActivity);
    if (this.jdField_a_of_type_Bmix.jdField_a_of_type_AndroidOsBundle != null) {
      this.jdField_a_of_type_Bmix.jdField_a_of_type_AndroidOsBundle.clear();
    }
    for (;;)
    {
      try
  ...
  {
    DoodleLayout localDoodleLayout = this.jdField_a_of_type_Bmix.jdField_a_of_type_Bmhd.a();
    if (localDoodleLayout != null)
    {
      Bitmap localBitmap3 = localDoodleLayout.a(0, false);
      Bitmap localBitmap2 = this.jdField_a_of_type_Bmix.a();
      ...
      return xmn.a(localBitmap1, paramString);
    }
    return false;
  }
  ...
  public void a_(int paramInt, Object paramObject)
  {
    ...
    if (a(this.jdField_a_of_type_Bmkf.a()))
    {
    ...
    this.jdField_a_of_type_Bmkf.getActivity().startActivityForResult(localIntent, 101);
  }
