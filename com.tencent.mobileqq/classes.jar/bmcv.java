  ...
  implements bmcu
{
  ...
  public static bmcu a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof bmcu))) {
      return (bmcu)localIInterface;
    }
    return new bmcw(paramIBinder);
  }
