  ...
  extends bqjh
{
  ...
  public bqjf(DoodleView paramDoodleView)
  {
  ...
  public static Drawable a(String paramString)
  {
    ...
    //   5: areturn
    //   6: aload_0
    //   7: invokestatic 20	zoc:a	(Ljava/lang/String;)Landroid/graphics/Bitmap;
    //   10: astore_1
    //   11: aload_1
    //   12: ifnull +74 -> 86
      ...
      if (this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b())
      {
        ...
        for (;;)
        {
          if (localIterator.hasNext())
          {
            ...
            localDynamicStickerData.centerP = localbqjl.jdField_b_of_type_AndroidGraphicsPointF;
            localDynamicStickerData.scale = localbqjl.q;
            localDynamicStickerData.rotate = localbqjl.r;
            localDynamicStickerData.translateX = (localbqjl.s + paramInt1);
            localDynamicStickerData.translateY = (localbqjl.t + paramInt2);
            localDynamicStickerData.height = localbqjl.v;
            localDynamicStickerData.width = localbqjl.u;
            localDynamicStickerData.path = localbqjl.jdField_f_of_type_JavaLangString;
            localDynamicStickerData.type = localbqjl.h;
            localDynamicStickerData.data = localbqjl.jdField_g_of_type_JavaLangString;
            localDynamicStickerData.layerWidth = j;
            localDynamicStickerData.layerHeight = i;
            localDynamicStickerData.mapMotionTrack = localbqjl.jdField_a_of_type_JavaUtilMap;
            localDynamicStickerData.setSegmentList(localbqjl.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.getSegmentList());
        ...
        if (((ArrayList)localObject).size() > 0)
        {
          ...
          return bqri.a((ArrayList)localObject);
        }
      }
      return null;
      j = m;
  ...
  public void a(ArrayList<PasterParcelData> paramArrayList, boolean paramBoolean, JSONArray paramJSONArray)
  {
    ...
    if (i < paramArrayList.size())
    {
      ...
      if ((localPasterParcelData.jdField_d_of_type_Int == 3) && (!TextUtils.isEmpty(localPasterParcelData.jdField_e_of_type_JavaLangString)))
      {
        ...
        j = 1;
        localbqqu = bqpb.a(BaseApplicationImpl.getContext(), localPasterParcelData.jdField_e_of_type_JavaLangString);
        if (j == 0) {
          break label443;
        }
        paramJSONArray = localbqqu;
      }
    }
    for (;;)
    {
      ...
      if (paramJSONArray != null)
      {
        ...
        localbqjl = new bqjl(this, paramJSONArray, new bqjp(localPasterParcelData.jdField_a_of_type_AndroidGraphicsPointF.x, localPasterParcelData.jdField_a_of_type_AndroidGraphicsPointF.y, localPasterParcelData.jdField_a_of_type_Float, localPasterParcelData.jdField_b_of_type_Float, localPasterParcelData.jdField_c_of_type_Float, localPasterParcelData.jdField_d_of_type_Float, (int)localPasterParcelData.jdField_e_of_type_Float, (int)localPasterParcelData.f), localPasterParcelData.jdField_a_of_type_JavaLangString, localPasterParcelData.jdField_b_of_type_JavaLangString, localPasterParcelData.jdField_c_of_type_JavaLangString, localPasterParcelData.jdField_d_of_type_Int);
        localbqjl.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper.set(localPasterParcelData.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper);
        localbqjl.jdField_g_of_type_JavaLangString = localPasterParcelData.jdField_e_of_type_JavaLangString;
        localbqjl.jdField_g_of_type_Int = localPasterParcelData.jdField_e_of_type_Int;
        localbqjl.jdField_e_of_type_Int = 0;
        localbqjl.jdField_f_of_type_Int = 1;
        localbqjl.jdField_b_of_type_Boolean = bqpb.a(localbqqu.a());
        localbqjl.c = bqpb.b(localbqqu.a());
        if (localbqjl.jdField_b_of_type_Boolean)
        {
          this.jdField_b_of_type_JavaUtilList.add(localbqjl);
          if (!TextUtils.isEmpty(localPasterParcelData.jdField_d_of_type_JavaLangString))
          {
            localbqjl.jdField_a_of_type_ComTencentMobileqqTroopDataTroopBarPOI = new TroopBarPOI("-1", "", localPasterParcelData.jdField_d_of_type_JavaLangString, 0, "", 0, "");
            localbqjl.jdField_a_of_type_Long = System.currentTimeMillis();
          }
        }
        if ((this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams == null) || (!this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.b())) {
          break label471;
        ...
        this.jdField_a_of_type_JavaUtilList.add(localbqjl);
      }
      for (;;)
      {
        i += 1;
        ...
        paramJSONArray = new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), localbqqu.a());
        break label90;
        label471:
        localbqjl.h = 0;
        paramJSONArray = (bqjh)this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoDoodleUiDoodleDoodleView.a(bqjh.jdField_a_of_type_JavaLangString);
        if (paramJSONArray != null) {
          paramJSONArray.jdField_a_of_type_JavaUtilList.add(localbqjl);
        }
      }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_JavaUtilList != null) && (!this.jdField_a_of_type_JavaUtilList.isEmpty()))
      {
        ...
        {
          Object localObject = (bqjl)localIterator.next();
          if ((((bqjl)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable != null) && ((((bqjl)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable instanceof URLDrawable)))
          {
            localObject = (URLDrawable)((bqjl)localObject).jdField_a_of_type_AndroidGraphicsDrawableDrawable;
            if (localObject != null)
            {
  ...
  public void b()
  {
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      while (localIterator.hasNext())
      {
        Drawable localDrawable = ((bqjl)localIterator.next()).jdField_a_of_type_AndroidGraphicsDrawableDrawable;
        if ((localDrawable instanceof bqrf)) {
          ((bqrf)localDrawable).a();
        }
      }
    }
    super.b();
  ...
  public void c(Canvas paramCanvas)
  {
    ...
    {
      bqjl localbqjl = (bqjl)localIterator.next();
      Object localObject2 = a(a(localbqjl.jdField_f_of_type_JavaLangString));
      if (localObject2 != null) {
        ((Drawable)localObject2).setBounds(0, 0, (int)localbqjl.u, (int)localbqjl.v);
      }
      Object localObject1 = localObject2;
      if (localbqjl.h == 3)
      {
        localObject1 = localObject2;
        if (localbqjl.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
        {
          localObject1 = localObject2;
          if (!(localbqjl.jdField_a_of_type_AndroidGraphicsDrawableDrawable instanceof bqqu)) {}
        }
      }
      for (;;)
      {
        try
        {
          localObject1 = (bqqu)localbqjl.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
          localObject1 = new BitmapDrawable(this.jdField_a_of_type_AndroidContentContext.getResources(), ((bqqu)localObject1).a());
        }
        catch (Exception localException2)
        {
          try
          {
            ...
            paramCanvas.save();
            paramCanvas.translate(-localbqjl.u / 2.0F, -localbqjl.v / 2.0F);
