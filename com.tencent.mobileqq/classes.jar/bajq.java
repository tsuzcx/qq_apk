...
public class bajq
  extends bajx
{
  private static bajq jdField_a_of_type_Bajq;
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private bdpj jdField_a_of_type_Bdpj = new bajs(this);
  ...
  private boolean d;
  private boolean e = atii.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), "is_first_show_atmosphere", true, false);
  private boolean f;
  
  public static bajq a()
  {
    if (jdField_a_of_type_Bajq == null) {}
    try
    {
      if (jdField_a_of_type_Bajq == null) {
        jdField_a_of_type_Bajq = new bajq();
      }
      return jdField_a_of_type_Bajq;
    }
    finally {}
  }
  ...
  private void a(View paramView, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        b(paramView, 2131375812, 2130849463);
        b(paramView, 2131368961, 2130849477, 2130849481);
        b(paramView, 2131368613, 2130849477, 2130849481);
        Object localObject1 = paramView.findViewById(2131375812);
        Object localObject2;
        if (localObject1 != null)
        {
          if (this.jdField_a_of_type_Int == 1)
          {
            a((View)localObject1, 2131368622, 2130849214, 2130849215);
            a((View)localObject1, 2131368627, 2130849494, 2130849495);
          }
        }
        else
        {
          ...
          a(paramView, 2131373354, 2130849317, 2130849318);
          a(paramView, 2131373344, 2130849274, 2130849275);
          a(paramView, 2131373357, 2130849323, 2130849324);
          a(paramView, 2131373336, 2130849255, 2130849256);
          a(paramView, 2131373326, 2130849245, 2130849246);
          a(paramView, 2131373349, 2130849294, 2130849295);
          a(paramView, 2131373333, 2130838026, 2130838027);
          a(paramView, 2131373337, 2130838054, 2130838056);
          a(paramView, 2131373347, 2130838067, 2130838068);
          a(paramView, 2131373320, 2130849225, 2130849226);
          localObject1 = paramView.findViewById(2131368332);
          if (localObject1 != null) {
            a((View)localObject1, a(((View)localObject1).getContext(), 2130849208));
          }
          localObject2 = (TextView)paramView.findViewById(2131366996);
          if ((localObject2 != null) && (!azib.b()))
          {
            ...
            a(paramView, 2131366996, 2130849356, 2130849357, 2130849353);
            ((TextView)localObject2).setPadding(j, i, k, m);
          }
          localObject2 = paramView.findViewById(2131368333);
          if (localObject1 != null) {
            a((View)localObject2, a(((View)localObject1).getContext(), 2130849207));
          }
          b(paramView, 2131371555, 2130849257);
          a(paramView, 2131368332, 2131166995);
          a(paramView, 2131377884, 2131166898);
          a(paramView, 2131368651, 2131166898);
          ...
          localObject2 = paramView.findViewById(2131379417);
          View localView = paramView.findViewById(2131368333);
        ...
        for (int i = 8;; i = 0)
        {
          ...
          localObject1 = b(((View)localObject1).getContext(), 2130849400);
          ...
          return;
          a((View)localObject1, 2131368622, 2130849198, 2130849201);
          break label74;
  ...
  private static boolean b(int paramInt)
  {
    ...
    bdsd localbdsd = bdsd.a;
    localObject = localbdsd.getDir((Context)localObject, localbdsd.getScid(paramInt));
  ...
  public void a(int paramInt)
  {
    ...
    ImageView localImageView = (ImageView)this.jdField_a_of_type_ComTencentMobileqqActivityChatFragment.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131370893);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      bdmq localbdmq2 = (bdmq)localImageView.getTag();
      localbdmq1 = localbdmq2;
      if (localbdmq2 == null)
      {
        localbdmq1 = new bdmq(localImageView);
        localImageView.setTag(localbdmq1);
      }
      switch (paramInt)
      {
      default: 
    ...
    if (i != 0) {
      localbdmq1.a(a("play.png"), 1);
    }
    localbdmq1.a(a("playing.png"), 0);
    return;
    if (i != 0) {
      localbdmq1.a(a("pause.png"), 1);
    }
    localbdmq1.a(a("pausing.png"), 0);
  }
  ...
  public void a(Context paramContext)
  {
    ...
    {
      this.e = false;
      localView = this.jdField_a_of_type_ComTencentMobileqqActivityChatFragment.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131370873);
      if (localView != null) {}
    }
    else
    {
    ...
    localTextView.setText(paramContext.getResources().getString(2131693948));
    ...
    this.jdField_a_of_type_ComTencentWidgetBubblePopupWindow.a().setOnClickListener(new bajr(this));
    atii.a((QQAppInterface)BaseApplicationImpl.sApplication.getRuntime(), "is_first_show_atmosphere", false, false);
    azmj.b(null, "dc00898", "", "", "qq_vip", "0X800A5B9", 1, 0, "", "", "", "");
  }
  ...
  public void a(Context paramContext, View paramView)
  {
    ...
    b(paramContext, 2131369550, 2130849622, 2130849623);
    a(paramContext, 2131373948, 2130844337, 2130844338);
    a(paramContext, 2131370873, 2130844331, 2130844332);
    a(paramContext, 2131370891, 2131166885);
    a(paramContext, 2131370894, 2131166883);
    a(paramContext, 2131370890, 2131166885);
    paramView = (CircleProgress)paramContext.findViewById(2131370888);
    if (paramView != null)
    {
      ColorStateList localColorStateList = a(paramContext.getContext(), 2131166884);
      paramView.setBgAndProgressColor(100, a(paramContext.getContext(), 2131166886).getDefaultColor(), 100, localColorStateList.getDefaultColor());
    }
  ...
  public void a(ChatFragment paramChatFragment, String paramString, int paramInt)
  {
    ...
    if ((paramInt == 1) && (this.jdField_a_of_type_ComTencentMobileqqActivityChatFragment != null) && ((this.jdField_a_of_type_ComTencentMobileqqActivityChatFragment.a() instanceof agiu)) && (((agiu)this.jdField_a_of_type_ComTencentMobileqqActivityChatFragment.a()).G())) {
      return;
    }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (paramInt == 1)
    {
      ...
      if ((paramString.jdField_b_of_type_Int != this.jdField_c_of_type_Int) || (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)))
      {
        ...
        azmj.b(null, "dc00898", "", "", "qq_vip", "0X800A5BB", 1, 0, "", "", "", "");
      }
      a();
      label154:
      if (paramString != null) {
    ...
    {
      azmj.b(null, "dc00898", "", "", "qq_vip", "0X800A5BE", paramInt, 0, "", "", "", "");
      if (QLog.isColorLevel()) {
      ...
      if ((paramString != null) && (paramString.jdField_b_of_type_Int == 0)) {
        azmj.b(null, "dc00898", "", "", "qq_vip", "0X800A5BB", 2, 0, "", "", "", "");
      }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    if (!paramBoolean) {
      azmj.b(null, "dc00898", "", "", "qq_vip", "0X800A5BC", 0, 0, "", "", "", "");
    }
    a();
  }
  ...
  public boolean a(ChatFragment paramChatFragment, int paramInt)
  {
    ...
    if ((paramInt == 1) && ((paramChatFragment.a() instanceof agiu)))
    {
      if ((((agiu)paramChatFragment.a()).G()) || (azib.b())) {}
  ...
  public void b(Context paramContext)
  {
    ...
    this.f = true;
    paramContext = a(paramContext, 2131166957);
  ...
  public void c()
  {
    ...
    azmj.b(null, "dc00898", "", "", "qq_vip", "0X800A5BF", 0, 0, String.valueOf((System.currentTimeMillis() - this.jdField_a_of_type_Long) / 1000L), "", "", "");
  }
}
