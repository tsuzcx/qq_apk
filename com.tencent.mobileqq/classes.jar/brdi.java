  ...
  implements brlf
{
  ...
  public brdi(String paramString, int paramInt1, int paramInt2, long paramLong1, long paramLong2)
  {
  ...
  public brlg a(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt1 <= paramInt2)
    {
      ...
      localbrlg.jdField_a_of_type_JavaIoFile = ((File)localObject);
      if (paramInt2 < 1280) {
        break label278;
      }
      localObject = "720p";
    ...
    label278:
    label307:
    for (localbrlg.jdField_a_of_type_Int = ((int)(819200 * 1.0D / paramInt1 * paramInt2));; localbrlg.jdField_a_of_type_Int = 819200)
    {
      localbrlg.jdField_a_of_type_Float = (paramInt1 / paramInt2);
      paramInt2 = i;
      if (this.jdField_b_of_type_Int <= 30) {
        paramInt2 = this.jdField_b_of_type_Int;
      }
      localbrlg.jdField_b_of_type_Int = paramInt2;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("VideoCompressTask", 2, "CompressTask, step: getEncodeConfig() config.setRotation = " + localbrlg.jdField_b_of_type_Boolean + ", scaleRate=" + localbrlg.jdField_a_of_type_Float + ", videoBitRate=" + localbrlg.jdField_a_of_type_Int + ", videoFrameRate=" + localbrlg.jdField_b_of_type_Int + ", beginTime=" + localbrlg.jdField_a_of_type_Long + ", endTime=" + localbrlg.jdField_b_of_type_Long + ",quality:" + (String)localObject + ",videoLongestEdge=" + paramInt1);
      }
      return localbrlg;
      paramInt2 = paramInt1;
      break;
