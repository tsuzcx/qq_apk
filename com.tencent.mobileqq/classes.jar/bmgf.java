  ...
  extends BaseAdapter
{
  ...
  public bmgf(EditVideoArtFilter paramEditVideoArtFilter, Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_Int = bmtu.b(this.jdField_a_of_type_AndroidContentContext, 120.0F);
    this.b = bmtu.b(this.jdField_a_of_type_AndroidContentContext, 90.0F);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      return localView1;
      paramViewGroup = (bmgg)paramView.getTag();
    ...
    if (paramView == null)
    {
      ...
      paramView = bcwc.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoArtFilter.jdField_a_of_type_AndroidContentContext.getResources(), 2130841173, this.b, this.jdField_a_of_type_Int);
    ...
    if (paramInt == 0) {
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(alpo.a(2131704199));
    }
    for (;;)
    {
      if (paramInt != this.c) {
      ...
      break;
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(alpo.a(2131704302) + localwyq.c);
    }
    label305:
