  ...
  implements Manager
{
  ...
  public MessageForText a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataMessageForText == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForText.senderuin = ajsf.aw;
      this.jdField_a_of_type_ComTencentMobileqqDataMessageForText.frienduin = ajsf.aw;
  ...
  public void a(Intent paramIntent)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityRecentDataRecentItemPullActivePush == null)
    {
      localObject = new RecentUser(ajsf.aw, 9653);
