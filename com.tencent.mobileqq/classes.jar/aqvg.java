  ...
  extends amsu
{
  ...
  protected void onGetHeadInfo(boolean paramBoolean, Setting paramSetting)
  {
    ...
    for (paramSetting = aqvf.a(32, paramSetting.url, paramSetting.bHeadType, paramSetting.bFaceFlags);; paramSetting = null)
    {
      ...
      catch (NumberFormatException localNumberFormatException1)
      {
        for (;;)
        {
          ...
          String str2;
          i = 0;
          aquj.b("StrangerHdHeadUrlFetcher", new Object[] { localNumberFormatException1.toString() });
      ...
      catch (Exception localException1)
      {
        for (;;)
        {
          label186:
          int i = 0;
          aquj.b("StrangerHdHeadUrlFetcher", new Object[] { localException1.toString() });
      ...
      str1 = null;
      break;
      aquj.b("StrangerHdHeadUrlFetcher", new Object[] { "setting.url is null" });
    }
  }
  ...
  protected void onUpdateStrangerHead(boolean paramBoolean1, String paramString, int paramInt, boolean paramBoolean2)
  {
    ...
    {
      String str1 = aqvf.a(32, paramInt, paramString);
