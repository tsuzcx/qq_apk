  ...
  implements DialogInterface.OnCancelListener, View.OnClickListener
{
  ...
  private bdxo jdField_a_of_type_Bdxo;
  ...
  public bdxm(@NonNull Context paramContext)
  {
  ...
  {
    paramContext = LayoutInflater.from(paramContext).inflate(2131493700, null);
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramContext.findViewById(2131304933));
    this.b = ((TextView)paramContext.findViewById(2131304934));
    this.b.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131304935));
    ...
    if (paramArrayOfString != null)
    {
      ...
      if (i < paramArrayOfString.length)
      {
        ...
        for (Object localObject = new MiniNumberPicker(getContext());; localObject = new NumberPicker(getContext()))
        {
          ...
          ((NumberPicker)localObject).setOnValueChangedListener(new bdxn(this, i));
  ...
  {
    if (this.jdField_a_of_type_Bdxo != null) {
      this.jdField_a_of_type_Bdxo.onValCancel();
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Bdxo != null) {
      this.jdField_a_of_type_Bdxo.onValConfirm(this.jdField_a_of_type_ArrayOfInt);
    }
    a();
  }
}
