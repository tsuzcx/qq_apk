...
public class blth
{
  ...
  private bltk jdField_a_of_type_Bltk;
  private bltl jdField_a_of_type_Bltl;
  private bltm jdField_a_of_type_Bltm;
  private bltn jdField_a_of_type_Bltn;
  ...
  public blth(int paramInt, float paramFloat)
  {
    a();
  ...
  private void a(View paramView, boolean paramBoolean)
  {
    ...
    } while (this.jdField_a_of_type_Bltm == null);
    TraceCompat.beginSection("onPagerChanged");
    this.jdField_a_of_type_Bltm.a(localViewHolder);
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Bltm != null)
    {
      this.jdField_a_of_type_Bltm.a();
      if (QLog.isColorLevel()) {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_Bltn = new bltn(this, null);
    this.jdField_a_of_type_Bltk = new bltk(this, null);
    this.jdField_a_of_type_Bltl = new bltl(this, null);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.setOnTouchListener(this.jdField_a_of_type_Bltn);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnScrollListener(this.jdField_a_of_type_Bltn);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.setOnFlingListener(this.jdField_a_of_type_Bltn);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnLayoutChangeListener(this.jdField_a_of_type_Bltk);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.addOnLayoutChangeListener(this.jdField_a_of_type_Bltl);
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.getAdapter().registerAdapterDataObserver(new blti(this));
  }
  
  private void f()
  {
    this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.removeOnScrollListener(this.jdField_a_of_type_Bltn);
  ...
  {
    return new bltj(this, this.jdField_a_of_type_ComTencentWidgetPull2refreshRecyclerViewCompat.getContext(), paramLinearLayoutManager);
  }
