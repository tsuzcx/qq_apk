...
public class nud
{
  ...
  public final int e = bbkx.a(5.0F);
  
  public nud(ViewGroup paramViewGroup, ReadInJoyNavigationGridview paramReadInJoyNavigationGridview, ImageView paramImageView)
  {
    this.jdField_a_of_type_Osp = new nuh(this);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyNavigationGridview.setChannelButtonListener(new nui(this));
  ...
  {
    JSONObject localJSONObject = onk.b();
    switch (paramInt)
    {
    }
    for (;;)
  ...
  public static void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      noo.a(null, "CliOper", "", "", str, str, 0, 0, "", "", "", paramString, false);
      return;
      str = "0X8008B81";
      continue;
      str = "0X8008B83";
  ...
  {
    onk.b().postDelayed(new ReadInJoyNaviController.4(this), paramLong);
  }
  ...
  public void a(int paramInt)
  {
    ...
    onk.b().postDelayed(new ReadInJoyNaviController.1(this), 0L);
  }
  ...
  public void a(ChannelCoverInfo paramChannelCoverInfo)
  {
    ...
    for (;;)
    {
      ...
      {
        onk.b().postDelayed(new ReadInJoyNaviController.2(this, paramChannelCoverInfo), 0L);
        return;
      }
      i += 1;
    }
