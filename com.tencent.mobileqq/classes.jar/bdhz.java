...
public class bdhz
  extends bdfs
{
  private static volatile bdhz jdField_a_of_type_Bdhz;
  ...
  public static bdhz a()
  {
    if (jdField_a_of_type_Bdhz == null) {}
    try
    {
      if (jdField_a_of_type_Bdhz == null) {
        jdField_a_of_type_Bdhz = new bdhz();
      }
      return jdField_a_of_type_Bdhz;
    }
    finally {}
  }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    azri.a(BaseApplicationImpl.getApplication()).a(null, "JumpIllegal", true, 0L, 0L, localHashMap, null);
  }
  ...
  public boolean a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    synchronized (jdField_a_of_type_Bdhz)
    {
      if (!this.jdField_a_of_type_Boolean) {
        a(paramContext);
      }
