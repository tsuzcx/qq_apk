  ...
  implements Observer
{
  ...
  public bado(QQAppInterface paramQQAppInterface, FragmentActivity paramFragmentActivity, SessionInfo paramSessionInfo, RelativeLayout paramRelativeLayout, ImageView paramImageView, aznm paramaznm, boolean paramBoolean, Observer paramObserver)
  {
    this.jdField_a_of_type_JavaLangString = "0";
    this.jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new badp(this);
    ...
    try
    {
      this.jdField_a_of_type_Azpa = this.jdField_a_of_type_Askq.a(Long.valueOf(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)), true);
    ...
    catch (NumberFormatException paramFragmentActivity)
    {
      for (;;)
      {
        ...
        axqw.b(paramQQAppInterface, "P_CliOper", "BizTechReport", ".troop.notification_center", "TroopFeedsCenterLogic init", "", 0, 0, paramSessionInfo.jdField_a_of_type_JavaLangString, "", "", "");
      }
    }
  }
  ...
  private void e(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      return;
      int m = actn.a(10.0F, ((FragmentActivity)localObject).getResources());
      int n = actn.a(8.0F, ((FragmentActivity)localObject).getResources());
      this.jdField_a_of_type_AndroidWidgetImageView = new ImageView(((BaseActivity)localObject).getActivity());
      this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundResource(2130849288);
  ...
  public void a()
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Aznm != null) {
        this.jdField_a_of_type_Aznm.d = false;
      }
  ...
  {
    this.jdField_a_of_type_Bcml = new bcml(paramQQAppInterface, paramContext, paramString1, paramString2);
    try
    {
      this.jdField_a_of_type_Bcml.show();
      return;
    }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Azpa != null)
    {
      ...
      this.jdField_a_of_type_Azpa.a();
      if (this.jdField_a_of_type_Askq == null) {
        this.jdField_a_of_type_Askq = ((askq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(37));
      }
      this.jdField_a_of_type_Askq.a(Long.valueOf(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)));
    }
    if ((this.jdField_a_of_type_Bcml != null) && (this.jdField_a_of_type_Bcml.isShowing())) {
      this.jdField_a_of_type_Bcml.dismiss();
    }
    deleteObservers();
  }
  ...
  public void c(boolean paramBoolean)
  {
    ...
    if ((this.jdField_b_of_type_AndroidWidgetImageView != null) && (this.jdField_a_of_type_Boolean))
    {
      ...
      this.c = true;
      d(false);
      balq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 1102858908);
    ...
    for (this.jdField_a_of_type_JavaLangString = "1";; this.jdField_a_of_type_JavaLangString = "0")
    {
      ...
      if (this.jdField_a_of_type_Aznm != null) {
        this.jdField_a_of_type_Aznm.d = true;
      }
      ...
      localObject2 = (bakk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48);
      this.jdField_a_of_type_AndroidViewView = new TroopAioFeedsCenterView(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Context)localObject1, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, ((bakk)localObject2).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString), this);
    ...
    while (!this.c) {
      if ((this.jdField_a_of_type_Azpa != null) && (this.jdField_a_of_type_Azpa.a != null) && (this.jdField_a_of_type_Azpa.a.size() > 0))
      {
        if (!paramBoolean)
        {
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "notice_center", "push", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "1", "", "");
          return;
          label492:
        ...
        {
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "notice_center", "Clk_entry", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "1", this.jdField_a_of_type_JavaLangString, "");
        }
      }
      else
      {
        if (!paramBoolean)
        {
          axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "notice_center", "push", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0", "", "");
          return;
        }
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "notice_center", "Clk_entry", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0", this.jdField_a_of_type_JavaLangString, "");
        return;
      }
    }
    this.h = true;
  ...
  public void d(boolean paramBoolean)
  {
    ...
    this.jdField_b_of_type_AndroidWidgetImageView.setContentDescription(localFragmentActivity.getString(2131697484));
  }
      ...
      do
      {
        for (;;)
        {
          ...
          while (paramObservable.intValue() == 103)
          {
            this.c = true;
            return;
            axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "notice_center", "Clk_entry", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "1", "", "");
            continue;
            if (!this.g) {
              axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "notice_center", "push", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0", "", "");
            } else {
              axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "notice_center", "Clk_entry", 0, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0", "", "");
            }
          }
        }
      } while (((paramObservable.intValue() != 1008) && (paramObservable.intValue() != 1009)) || (this.jdField_a_of_type_Azpa.a.size() <= 0));
      paramObject = (TroopFeedItem)this.jdField_a_of_type_Azpa.a.get(0);
