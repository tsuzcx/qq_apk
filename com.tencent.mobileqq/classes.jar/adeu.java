...
public class adeu
{
  private static adeu jdField_a_of_type_Adeu;
  ...
  private Map<Integer, adev> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  private int a(int paramInt, boolean paramBoolean)
  {
    ...
    adev localadev = (adev)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    if (localadev != null)
    {
      Object localObject = localadev.jdField_a_of_type_JavaLangRefWeakReference;
      if (localObject != null)
      {
        ...
        if (localObject != null)
        {
          ...
          {
            if ((!((DoodleMsgLayout)localObject).b()) && (this.jdField_a_of_type_Long != localadev.jdField_b_of_type_Long) && (((DoodleMsgLayout)localObject).a()))
            {
              if (paramBoolean)
              {
                a((DoodleMsgLayout)localObject, false);
                if (localadev.jdField_b_of_type_Long == this.jdField_c_of_type_Long) {
            ...
            if (QLog.isColorLevel()) {
              QLog.d(jdField_a_of_type_JavaLangString, 2, "checkPlayable: can not play:" + localadev.jdField_a_of_type_Long + "uniID:" + localadev.jdField_b_of_type_Long + " mPlayedID:" + this.jdField_a_of_type_Long);
            }
          ...
          if (QLog.isColorLevel()) {
            QLog.d(jdField_a_of_type_JavaLangString, 2, "checkPlayable: invisible MsgID:" + localadev.jdField_a_of_type_Long + "uniID:" + localadev.jdField_b_of_type_Long);
          }
        }
      }
    }
  ...
  public static adeu a()
  {
    try
    {
      if (jdField_a_of_type_Adeu == null) {
        jdField_a_of_type_Adeu = new adeu();
      }
      return jdField_a_of_type_Adeu;
    }
    finally {}
  }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        adev localadev = (adev)((Map.Entry)localIterator.next()).getValue();
        if ((localadev == null) || (localadev.jdField_a_of_type_Int < paramInt1) || (localadev.jdField_a_of_type_Int > paramInt2)) {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        Object localObject = (adev)localIterator.next();
        if ((localObject != null) && (((adev)localObject).jdField_a_of_type_Int >= this.d) && (((adev)localObject).jdField_a_of_type_Int <= this.e))
        {
          localObject = ((adev)localObject).jdField_a_of_type_JavaLangRefWeakReference;
          if (localObject != null)
          {
            localObject = (DoodleMsgLayout)((WeakReference)localObject).get();
            if (localObject != null) {
  ...
  private void a(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      do
      {
        do
        {
          ...
          adev localadev = (adev)((Iterator)localObject).next();
          if (localadev.jdField_b_of_type_Long != this.jdField_c_of_type_Long) {
            break;
          }
          localObject = localadev.jdField_a_of_type_JavaLangRefWeakReference;
    ...
    for (;;)
    {
      ...
      break;
      label135:
      localObject = (adev)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(i));
      if ((localObject != null) && ((((adev)localObject).jdField_a_of_type_Long > this.jdField_b_of_type_Long) || (((adev)localObject).jdField_b_of_type_Long == this.jdField_c_of_type_Long)))
      {
        localObject = ((adev)localObject).jdField_a_of_type_JavaLangRefWeakReference;
        if (localObject != null)
        {
  ...
  public static void b()
  {
    try
    {
      if (jdField_a_of_type_Adeu != null)
      {
        jdField_a_of_type_Adeu.a();
        jdField_a_of_type_Adeu = null;
      }
      return;
    }
    finally {}
  ...
  public void a(long paramLong1, long paramLong2, int paramInt, DoodleMsgLayout paramDoodleMsgLayout)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(paramInt), new adev(this, paramLong1, paramLong2, paramInt, paramDoodleMsgLayout));
    boolean bool;
    if (this.jdField_a_of_type_Int != 0)
    {
      bool = true;
  ...
  public void a(DoodleMsgLayout paramDoodleMsgLayout, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          adev localadev = (adev)((Iterator)localObject).next();
          if ((localadev.jdField_a_of_type_JavaLangRefWeakReference != null) && (localadev.jdField_a_of_type_JavaLangRefWeakReference.get() == paramDoodleMsgLayout))
          {
            this.jdField_a_of_type_Long = localadev.jdField_b_of_type_Long;
            if (QLog.isColorLevel()) {
