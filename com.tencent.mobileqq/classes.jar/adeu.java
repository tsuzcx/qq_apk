...
public class adeu
  implements Runnable
{
  public adeu(VideoFilePresenter paramVideoFilePresenter, int paramInt, String paramString) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject = DialogUtil.a(BaseActivity.sTopActivity, 230, "", (String)localObject, null, "我知道了", new adev(this), null);
