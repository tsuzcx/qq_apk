  ...
  implements IServiceCmdCallback
{
  ...
  public axsr(axsp paramaxsp, String paramString)
  {
  ...
  public void e()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaUtilMap)
      {
        ...
        axsp.b(this.jdField_b_of_type_Axsp, new String[] { "fg30CmdCount", "|", String.valueOf(i) });
        ...
        if (localIterator1.hasNext())
        {
          ...
          axsp.b(this.jdField_b_of_type_Axsp, new String[] { "fg30CmdAlarm", "|", str, "|", localStringBuilder.toString() });
        }
      }
  ...
  public void f()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaUtilMap)
      {
        ...
        axsp.b(this.jdField_b_of_type_Axsp, new String[] { "bg5CmdCount", "|", String.valueOf(i) });
        ...
        if (localIterator1.hasNext())
        {
          ...
          axsp.b(this.jdField_b_of_type_Axsp, new String[] { "bg5CmdAlarm", "|", str, "|", localStringBuilder.toString() });
        }
      }
      this.jdField_c_of_type_JavaUtilMap.clear();
      return;
  ...
  public void onCmdRequest(String paramString)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Axtg.a(paramString);
    ...
    if ((localMap == null) || ((localMap != null) && (localMap.size() > 0)))
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        if (!axsp.a())
        {
          ...
          label299:
          if (!axsp.a.contains(localObject)) {
            break label475;
          }
          i = 1;
        }
    ...
    for (;;)
    {
      ...
      axsp.a(this.jdField_b_of_type_Axsp, new String[] { "cmd|", localStringBuilder.toString() });
      localObject = this.jdField_b_of_type_Axsp;
      if (j > this.jdField_c_of_type_Int)
      {
        i = 1;
        axsp.a((axsp)localObject, 3, 0, i, ajya.a(2131701079) + paramString, "2秒钟命令字请求次数：" + j);
      }
      for (;;)
      {
        ...
        if ((axsp.a(this.jdField_b_of_type_Axsp) != null) && (QLog.isColorLevel())) {
          axsp.a(this.jdField_b_of_type_Axsp, "No high frequnecy cmd in last 2seconds");
        }
      }
      break label236;
    }
