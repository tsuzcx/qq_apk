  ...
  extends aodk
{
  public void a()
  {
    ...
    if (i > 10)
    {
      ...
      {
        bool1 = SettingCloneUtil.readValue(BaseApplicationImpl.sApplication, null, BaseApplicationImpl.sApplication.getString(2131694747), "qqsetting_screenshot_key", false);
        boolean bool2 = bhan.a(BaseApplication.getContext());
        if ((bool1) && (bool2))
        {
    ...
    for (;;)
    {
      ...
      while (QLog.isColorLevel())
      {
        ...
        if ((!bhkn.g) && (Build.VERSION.SDK_INT < 11)) {
          bhkk.a().a(BaseActivity2.topActivity.getWindow());
        }
      }
    }
  }
