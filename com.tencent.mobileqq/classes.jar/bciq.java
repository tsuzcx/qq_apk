  ...
  extends DynamicDrawableSpan
{
  ...
  private bciq(Context paramContext, String paramString1, String paramString2, int paramInt, Paint paramPaint)
  {
    super(0);
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.jdField_b_of_type_JavaLangString = a(String.format("%s%s", new Object[] { "@", new bamb(paramString2, 32).a() }));
    this.jdField_b_of_type_Int = paramInt;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    a(paramPaint);
  }
  
  private bciq(Context paramContext, String paramString1, String paramString2, int paramInt, Paint paramPaint, String paramString3)
  {
    this(paramContext, paramString1, paramString2, paramInt, paramPaint);
    this.d = a(String.format("%s%s", new Object[] { "@", new bamb(paramString3, 32).a() }));
  }
  ...
  public static SpannableString a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, EditText paramEditText)
  {
    ...
    try
    {
      paramQQAppInterface = new bciq(paramContext, paramString2, paramString3, i - j - k, paramEditText.getPaint(), paramString4);
    ...
    catch (OutOfMemoryError paramQQAppInterface)
    {
      ...
      paramString1 = new SpannableString(new bamb(paramContext + " ", 16).a());
  ...
  public static SpannableString a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, boolean paramBoolean1, EditText paramEditText, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    bciq[] arrayOfbciq = (bciq[])paramEditText.getEditableText().getSpans(0, paramEditText.getEditableText().toString().length(), bciq.class);
    int i = paramEditText.getWidth();
    int j = paramEditText.getPaddingLeft();
    int k = paramEditText.getPaddingRight();
    try
  ...
  private static bciq a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, boolean paramBoolean1, int paramInt, Paint paramPaint, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      if (paramBoolean2) {
        ...
        {
          paramString1 = bdgc.e(paramQQAppInterface, paramString1, paramString2);
      ...
      while (!TextUtils.isEmpty(paramQQAppInterface))
      {
        if (QLog.isColorLevel()) {
          QLog.d("_At_Me_DISC", 2, " memUin:" + paramString2 + " troopMemName:" + bdeu.a(paramQQAppInterface) + " isTroop:" + paramBoolean2);
        }
        return new bciq(paramContext, paramString2, paramQQAppInterface, paramInt, paramPaint);
        paramQQAppInterface = paramString3;
        continue;
        if (!paramString2.equalsIgnoreCase("0"))
        {
          paramString1 = bdgc.c(paramQQAppInterface, paramString2, true);
          paramQQAppInterface = paramString1;
  ...
  public static String a(Spannable paramSpannable, ArrayList<MessageForText.AtTroopMemberInfo> paramArrayList)
  {
    ...
    bciq[] arrayOfbciq = (bciq[])paramSpannable.getSpans(0, m - 1, bciq.class);
    if (arrayOfbciq.length == 0) {
      return localStringBuffer.toString();
    }
    if (arrayOfbciq.length > 1) {
      Arrays.sort(arrayOfbciq, new bcir(paramSpannable));
    }
    int j = 0;
    int i = 0;
    int n;
    ...
    for (;;)
    {
      if (i >= arrayOfbciq.length) {
        break label345;
      }
      bciq localbciq = arrayOfbciq[i];
      n = paramSpannable.getSpanStart(localbciq) + j;
      i1 = paramSpannable.getSpanEnd(localbciq) + j;
      String str = localbciq.jdField_b_of_type_JavaLangString;
      if (!TextUtils.isEmpty(localbciq.d)) {
        str = localbciq.d;
      }
      try
      {
        ...
        localAtTroopMemberInfo.uin = Long.valueOf(localbciq.jdField_a_of_type_JavaLangString).longValue();
        if ((localbciq.jdField_a_of_type_JavaLangString != null) && (localbciq.jdField_a_of_type_JavaLangString.equalsIgnoreCase("0"))) {
      ...
      catch (JSONException paramQQAppInterface)
      {
        try
        {
          ...
          if (i1 == 0)
          {
            paramString1 = paramStringBuilder;
            localStringBuilder = paramStringBuilder;
            str = "@" + bdgc.c(paramQQAppInterface, paramString2, str);
            paramString1 = paramStringBuilder;
            localStringBuilder = paramStringBuilder;
  ...
  private List<benz> a(Paint paramPaint)
  {
    int i = (int)Math.ceil(paramPaint.measureText(" "));
    List localList = bdrv.a(this.jdField_b_of_type_Int - i * 2, this.jdField_b_of_type_JavaLangString, paramPaint, this.jdField_a_of_type_Beoa, 16);
    localList.add(new benz(1, 0, 0, "  ", null));
    this.jdField_a_of_type_Int = bdrv.a(localList, paramPaint, new Rect());
    return localList;
  }
  ...
  private void a(Paint paramPaint)
  {
    ...
    {
      localObject3 = (benz)((Iterator)localObject2).next();
      switch (((benz)localObject3).c)
      {
      default: 
        break;
      case 1: 
        localCanvas.drawText(((benz)localObject3).jdField_a_of_type_JavaLangString, f1, f2, paramPaint);
        f1 += paramPaint.measureText(((benz)localObject3).jdField_a_of_type_JavaLangString);
        break;
      case 2: 
        localObject3 = (bamw)((benz)localObject3).jdField_a_of_type_AndroidTextStyleCharacterStyle;
        j = ((bamw)localObject3).a().getBounds().height();
        ((bamw)localObject3).draw(localCanvas, "", 0, 0, f1, (i - j) / 2, (i + j) / 2, (j + i) / 2, paramPaint);
        f1 += ((bamw)localObject3).a().getBounds().width();
      }
    }
    localCanvas.save();
    localCanvas.restore();
