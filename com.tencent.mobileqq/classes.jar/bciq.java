  ...
  extends ajtb
{
  ...
  public bciq(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_AndroidSupportV4UtilLruCache = new LruCache(100);
    this.jdField_a_of_type_Bciy = new bciy();
    this.jdField_a_of_type_Bcjg = null;
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new bciw(this);
  ...
  public bcjg a(String paramString)
  {
    if (this.jdField_a_of_type_Bcjg == null) {
      this.jdField_a_of_type_Bcjg = new bcjg(paramString);
    }
    if (!TextUtils.isEmpty(paramString)) {
      this.jdField_a_of_type_Bcjg.jdField_a_of_type_JavaLangString = paramString;
    }
    return this.jdField_a_of_type_Bcjg;
  }
  
  protected mxj a(bcix<oidb_0x8e4.RspBody> parambcix)
  {
    return new bciu(this, parambcix);
  }
  ...
  public void a(int paramInt1, int paramInt2, bcix<oidb_0x8e4.RspBody> parambcix)
  {
    ...
    mxf.a(this.app, a(parambcix), localReqBody.toByteArray(), "OidbSvc.0x8e4_1", 2276, 1, new Bundle(), 5000L);
  }
  ...
  public void a(TextView paramTextView, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      if (((ajxl)localObject).b(paramString1))
      {
        paramString1 = bbcz.j(this.app, paramString1);
        try
        {
      ...
      localObject = ((ajxl)localObject).a(paramString1);
  ...
  public void a(bcix<oidb_0x8e4.RspBody> parambcix)
  {
    if (QLog.isColorLevel()) {
      QLog.e("WerewolvesHandler", 2, "reqInviteId");
    }
    oidb_0x8e4.ReqBody localReqBody = new oidb_0x8e4.ReqBody();
    mxf.a(this.app, a(parambcix), localReqBody.toByteArray(), "OidbSvc.0x8e4_6", 2276, 6, new Bundle(), 5000L);
  }
  ...
  public void a(HotChatInfo paramHotChatInfo, int paramInt1, int paramInt2, bcix<oidb_0x8e4.RspBody> parambcix)
  {
    if (QLog.isColorLevel()) {
      QLog.e("WerewolvesHandler", 2, "exitRoom");
    }
    oidb_0x8ed.ReqBody localReqBody = new oidb_0x8ed.ReqBody();
    bcis localbcis = new bcis(this, parambcix);
    try
    {
      long l = Long.parseLong(paramHotChatInfo.troopUin);
      localReqBody.uint64_room_id.set(l, true);
      localReqBody.rpt_uint64_uins.add(Long.valueOf(this.app.getLongAccountUin()));
      mxf.a(this.app, b(new bcit(this, localbcis, paramHotChatInfo, l, paramInt2, paramInt1, parambcix)), localReqBody.toByteArray(), "OidbSvc.0x8ed_2", 2285, 2, new Bundle(), 5000L);
      return;
    }
    catch (Exception paramHotChatInfo)
    {
  ...
  public void a(HotChatInfo paramHotChatInfo, bcix<oidb_0x8ed.RspBody> parambcix)
  {
    if (QLog.isColorLevel()) {
      QLog.e("WerewolvesHandler", 2, "exitRoom");
    }
    ...
    try
    {
      ...
      localReqBody.uint64_room_id.set(l, true);
      localReqBody.rpt_uint64_uins.add(Long.valueOf(this.app.getLongAccountUin()));
      mxf.a(this.app, b(new bcir(this, parambcix, paramHotChatInfo)), localReqBody.toByteArray(), "OidbSvc.0x8ed_2", 2285, 2, new Bundle(), 5000L);
      atch.a().a(l);
      atbi.a(this.app.getCurrentAccountUin(), "game_room_last_time", Long.valueOf(awzy.a()));
      try
      {
  ...
  public void a(String paramString, long paramLong, bcix<oidb_0x8e4.RspBody> parambcix)
  {
    if (QLog.isColorLevel()) {
    ...
    mxf.a(this.app, a(parambcix), localReqBody.toByteArray(), "OidbSvc.0x8e4_5", 2276, 5, new Bundle(), 5000L);
  }
  
  public void a(String paramString, bcix<oidb_0x8e4.RspBody> parambcix)
  {
    oidb_0x8e4.ReqBody localReqBody = new oidb_0x8e4.ReqBody();
    localReqBody.string_invite_id.set(ByteStringMicro.copyFromUtf8(paramString), true);
    mxf.a(this.app, a(parambcix), localReqBody.toByteArray(), "OidbSvc.0x8e4_3", 2276, 3, new Bundle(), 5000L);
  }
  
  public void a(String paramString, boolean paramBoolean, bcix<oidb_0x8e4.RspBody> parambcix)
  {
    if (TextUtils.isEmpty(paramString))
    {
    ...
    for (int i = 1;; i = 2)
    {
      ...
      mxf.a(this.app, a(parambcix), localReqBody.toByteArray(), "OidbSvc.0x8e4_2", 2276, 2, new Bundle(), 5000L);
      return;
    }
  }
  ...
  public void a(TroopTips0x857.WereWolfPush paramWereWolfPush, byte[] paramArrayOfByte)
  {
    ...
    for (paramWereWolfPush = "";; paramWereWolfPush = str1.substring(0, 1) + "***" + str1.substring(str1.length() - 1) + "|msg len:" + str1.length())
    {
      ...
      this.jdField_a_of_type_Bcjg.a("WereWolfPush", paramArrayOfByte);
      return;
    }
  }
  ...
  protected mxj b(bcix<oidb_0x8ed.RspBody> parambcix)
  {
    return new bciv(this, parambcix);
  }
  
  public void b(int paramInt1, int paramInt2, bcix<oidb_0x8e4.RspBody> parambcix)
  {
    if (QLog.isColorLevel()) {
    ...
    localReqBody.uint32_zone_id.set(paramInt2);
    mxf.a(this.app, a(parambcix), localReqBody.toByteArray(), "OidbSvc.0x8e4_4", 2276, 4, new Bundle(), 5000L);
  }
  
  public void b(String paramString, bcix<oidb_0x8e4.RspBody> parambcix)
  {
    if (QLog.isColorLevel()) {
  ...
  public void b(String paramString, boolean paramBoolean, bcix<oidb_0x8e4.RspBody> parambcix)
  {
    oidb_0x8e4.ReqBody localReqBody = new oidb_0x8e4.ReqBody();
    ...
    {
      paramString.set(i);
      mxf.a(this.app, a(parambcix), localReqBody.toByteArray(), "OidbSvc.0x8e4_7", 2276, 7, new Bundle(), 5000L);
      return;
    }
  }
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_Bciy.removeCallbacksAndMessages(null);
    super.onDestroy();
  }
    ...
    if ("ProfileService.GetSimpleInfo".equals(localObject))
    {
      ...
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        if ((localObject != null) && (paramToServiceMsg != null) && (((ArrayList)localObject).size() > 0) && (paramToServiceMsg.size() > 0))
        {
          ...
          this.jdField_a_of_type_Bciy.sendMessage(paramFromServiceMsg);
        }
      }
    }
  }
