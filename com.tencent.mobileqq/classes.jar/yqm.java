...
public class yqm
{
  ...
  public yqm(BaseActivity paramBaseActivity, int paramInt)
  {
  ...
  private void a(float paramFloat)
  {
    ...
    if (paramFloat > 0.5D)
    {
      ...
      this.b.setBackgroundResource(2130850593);
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840329);
    this.b.setBackgroundResource(2130850593);
    this.b.setTextColor(this.b.getContext().getResources().getColorStateList(2131167009));
    this.c.setTextColor(this.c.getContext().getResources().getColorStateList(2131167009));
  }
  
  public void a(View paramView)
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131378762));
    ...
    this.c = ((TextView)paramView.findViewById(2131369099));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131369082));
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (paramBoolean2)
    {
      ...
      localValueAnimator.addUpdateListener(new yqn(this));
