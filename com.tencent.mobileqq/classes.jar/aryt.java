  ...
  implements baxl
{
  ...
  public aryt(QQAppInterface paramQQAppInterface, Context paramContext, HorizontalListView paramHorizontalListView, HeadSetView paramHeadSetView)
  {
  ...
  public void a(arxh paramarxh)
  {
    this.jdField_a_of_type_Arxh = paramarxh;
    this.jdField_a_of_type_Arxh.a(this);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup = new aryv(paramView);
    ...
    for (;;)
    {
      paramView.setOnClickListener(new aryu(this, str));
      Bitmap localBitmap2 = this.jdField_a_of_type_Arxh.a(paramViewGroup.jdField_a_of_type_JavaLangString);
      Bitmap localBitmap1 = localBitmap2;
      if (localBitmap2 == null) {
        localBitmap1 = bbdr.a();
      }
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(localBitmap1);
      aryd.a(paramView, bbcl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, 0) + "正在共享位置");
      return paramView;
      paramViewGroup = (aryv)paramView.getTag();
      paramViewGroup.jdField_a_of_type_JavaLangString = str;
    }
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        if (!(localObject instanceof aryv)) {
          break label87;
        }
        localObject = (aryv)localObject;
        if ((paramString == null) || (!paramString.equals(((aryv)localObject).jdField_a_of_type_JavaLangString))) {
          break label87;
        }
        if (paramBitmap != null)
        {
          paramString = this.jdField_a_of_type_Arxh.a(paramString);
          if (paramString != null) {
            ((aryv)localObject).jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(paramString);
          }
        }
      }
      return;
