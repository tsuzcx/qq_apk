...
public class bdck
{
  ...
  public static Drawable a(Context paramContext, String paramString)
  {
    ...
    if (paramString.equals("fivea")) {
      paramContext = paramContext.getResources().getDrawable(2130842165);
    }
    for (;;)
    {
      ...
      {
        paramContext = paramContext.getResources().getDrawable(2130842166);
      }
      else if (paramString.equals("qheart"))
      {
        paramContext = paramContext.getResources().getDrawable(2130842167);
      }
      else
      {
        paramContext = localObject1;
        if (!paramString.equals("")) {
          paramContext = new BitmapDrawable(FileUtil.getBitmapByPath(bdaf.a() + paramString + ".png"));
        }
      }
    }
  }
  
  public static bbgy a(bbgy parambbgy)
  {
    if ((!c()) || (!b())) {}
    for (int i = 1; i == 0; i = 0) {
      return parambbgy;
    }
    bbgy localbbgy = new bbgy();
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    bhhr.a(BaseApplicationImpl.getApplication().getSharedPreferences("GestureRecognitionUtils", 4).edit().putBoolean("shared_gesture_recognize_result", paramBoolean));
  }
