...
{
  public yuq(ApolloLinearLayout paramApolloLinearLayout) {}
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      if ((!TextUtils.isEmpty(str)) && ("actionPanel".equals(str)))
      {
        ...
        if (localObject != null)
        {
          ((ImageView)((View)localObject).findViewById(2131363170)).setVisibility(8);
          ...
          if (paramBoolean)
          {
            ...
            paramObject.put("tips", this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext.getString(2131438167));
