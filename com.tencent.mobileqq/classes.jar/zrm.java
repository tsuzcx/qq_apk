...
public class zrm
  implements Runnable
{
  public zrm(MsgNotifyPushDialog paramMsgNotifyPushDialog) {}
  ...
  public void run()
  {
    ...
    try
    {
      ...
      this.a.jdField_a_of_type_AndroidWidgetImageView.postDelayed(new zrn(this, localAnimationDrawable), 500L);
      return;
    }
