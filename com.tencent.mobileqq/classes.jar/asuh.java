  ...
  implements URLDrawableDownListener
{
  ...
  public asuh(Context paramContext, Handler paramHandler, asug paramasug)
  {
  ...
  public int a(asug paramasug)
  {
    return paramasug.a(this.jdField_a_of_type_JavaUtilList);
  }
  
  public asug a(int paramInt)
  {
    if ((this.jdField_a_of_type_JavaUtilList != null) && (!this.jdField_a_of_type_JavaUtilList.isEmpty()) && (paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return (asug)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    }
    return this.jdField_a_of_type_Asug;
  }
  ...
  public void a(List<asug> paramList)
  {
  ...
  {
    return a(paramInt).a(this.jdField_a_of_type_Asug);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject = (asug)this.jdField_a_of_type_JavaUtilList.get(paramInt);
        localDrawable = ((asug)localObject).a(this.jdField_a_of_type_AndroidContentContext);
        if ((((asug)localObject).a()) || (!((asug)localObject).b())) {
          break label221;
        }
        ((URLImageView)paramView).setURLDrawableDownListener(this);
        label110:
        if ((!(localDrawable instanceof awxl)) || (((awxl)localDrawable).a() == null)) {
          break label232;
        }
        int i = agej.a(100.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        localObject = a(((awxl)localDrawable).a(), i, i);
      ...
      for (;;)
      {
        ...
        return paramView;
        localObject = this.jdField_a_of_type_Asug;
        break;
        label221:
  ...
  public void onLoadSuccessed(View paramView, URLDrawable paramURLDrawable)
  {
    try
    {
      ...
      i = bhmq.c(localFile.getAbsolutePath());
    }
