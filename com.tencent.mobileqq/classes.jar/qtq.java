  ...
  implements Manager
{
  ...
  public qtq(AppInterface paramAppInterface)
  {
  ...
  public static RefreshData b(Context paramContext, int paramInt)
  {
    ...
    {
      localObject = (qtq)((AppRuntime)localObject).getManager(270);
      if (localObject != null) {
        return ((qtq)localObject).a(paramContext, paramInt);
      }
    }
    return null;
  }
  ...
  private void b(int paramInt1, String paramString, long paramLong, int paramInt2)
  {
    ...
    quo.a(this.jdField_a_of_type_JavaLangString, paramLong);
    paramInt1 = 0;
    while (paramInt1 < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ((qts)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt1)).a(this.jdField_a_of_type_Int, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long);
      paramInt1 += 1;
    }
  }
  ...
  public RefreshData a(Context paramContext, int paramInt)
  {
    ...
    paramContext = bhsi.a(paramContext, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), paramInt);
  ...
  public void a(qts paramqts)
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(paramqts)) {
        this.jdField_a_of_type_JavaUtilArrayList.add(paramqts);
      }
      return;
    }
  }
  ...
  public boolean a(RefreshData paramRefreshData, int paramInt1, int paramInt2)
  {
    ...
    String str = quo.a((String)localObject);
    if (quo.a((String)localObject)) {
      return true;
    }
    ...
    localObject = new bihu(paramRefreshData.url, localFile);
    ((bihu)localObject).jdField_b_of_type_Int = paramInt1;
    ((bihu)localObject).d = 60L;
    ((bihu)localObject).m = true;
    this.jdField_a_of_type_Bihz.a((bihu)localObject, new qtr(this, str, paramRefreshData, paramInt2), localBundle);
    return false;
  }
  
  public void b(qts paramqts)
  {
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      this.jdField_a_of_type_JavaUtilArrayList.remove(paramqts);
      return;
    }
  }
