...
{
  private static final String jdField_a_of_type_JavaLangString = ajjy.a(2131647350);
  ...
  public qtq(@NonNull Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
  }
  
  public qtq(@NonNull Context paramContext, Runnable paramRunnable)
  {
    this(paramContext, 0);
  ...
  private Drawable a()
  {
    float f = aciy.a(3.0F, getContext().getResources());
  ...
  private SpannableString a()
  {
    ...
    localSpannableString.setSpan(new qtr(this, Color.parseColor("#12B7F5")), i, "《QQ看点用户行为规范》".length() + i, 33);
  ...
  public static boolean a(BaseActivity paramBaseActivity, Runnable paramRunnable)
  {
    ...
    paramRunnable = new qtq(paramBaseActivity, paramRunnable);
    paramRunnable.jdField_a_of_type_ComTencentMobileqqAppBaseActivity = paramBaseActivity;
    paramRunnable.show();
    ndn.a(null, "", "0X800992C", "0X800992C", 0, 0, "", "", "", "");
    return false;
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    paramBundle = LayoutInflater.from(getContext()).inflate(2131494335, null);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramBundle.findViewById(2131299159));
    this.jdField_a_of_type_AndroidWidgetTextView.setFocusable(false);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramBundle.findViewById(2131296670));
    this.jdField_a_of_type_AndroidViewView = paramBundle.findViewById(2131298717);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(a());
    this.jdField_a_of_type_AndroidWidgetTextView.setMovementMethod(new qts());
    ...
    paramBundle.findViewById(2131297607).setBackgroundDrawable(localDrawable);
    setContentView(paramBundle);
    paramBundle = getWindow().getAttributes();
    paramBundle.height = -2;
    paramBundle.width = aciy.a(320.0F, getContext().getResources());
