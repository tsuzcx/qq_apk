...
public class amnr
{
  private static amnr jdField_a_of_type_Amnr = new amnr();
  ...
  private amnr()
  {
    ...
    if (!AppSetting.f().equals(localObject2))
    {
      ...
      bdiv.a((SharedPreferences.Editor)localObject2);
  ...
  public static amnr a()
  {
    return jdField_a_of_type_Amnr;
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Boolean)
        {
          ...
          bdiv.a((SharedPreferences.Editor)localObject1);
          this.jdField_d_of_type_Int = 0;
          bool2 = bool1;
          continue;
        }
