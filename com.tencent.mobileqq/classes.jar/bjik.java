...
public class bjik
{
  ...
  public static void a(List<BaseInterface> paramList, WebView paramWebView, String paramString, avyt paramavyt)
  {
    if (!bjkr.a(paramString))
    {
      Iterator localIterator = paramList.iterator();
      while (localIterator.hasNext())
      {
        BaseInterface localBaseInterface = (BaseInterface)localIterator.next();
        paramavyt.a(localBaseInterface, localBaseInterface.getInterfaceName());
        bjib.a.put(localBaseInterface.getInterfaceName(), localBaseInterface.getClass());
        localBaseInterface.setCurrentUrl(paramString);
      }
    }
