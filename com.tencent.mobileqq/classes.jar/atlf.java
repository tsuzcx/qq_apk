  ...
  implements atkz
{
  ...
  public atlf(Context paramContext)
  {
  ...
  {
    this.jdField_a_of_type_Atld = paramatld;
  }
  
  public void a(atle paramatle)
  {
    this.jdField_a_of_type_Atle = paramatle;
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, long paramLong)
  {
    ...
    do
    {
      ...
      String str = sui.a(paramString1, 0);
      this.b = paramString2;
      this.c = paramString3;
      ...
      if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer == null)
      {
        ...
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnCompletionListener(new atlg(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnErrorListener(new atlh(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnInfoListener(new atli(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnVideoPreparedListener(new atlj(this));
        this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_IMediaPlayer.setOnDownloadCallback(new atlk(this, paramString2, paramString1, paramString3));
      }
      paramString1 = a(str, paramString2, paramLong);
      paramString1.setConfigMap("keep_last_frame", "true");
      if ((!TextUtils.isEmpty(paramString2)) && (suj.a(new File(paramString2))))
      {
    ...
    {
      Bosses.get().postJob(new atll(this, "VideoViewTVKImpl", paramString3, paramString1));
      return;
    }
    this.c = ayxg.b(this.c.replace("https://", "http://"), 1012);
