...
public class sbk
{
  ...
  private ArrayList<sbm> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private ocg jdField_a_of_type_Ocg;
  private rwy jdField_a_of_type_Rwy;
  private boolean jdField_a_of_type_Boolean;
  private ArrayList<VideoInfo> b;
  
  public sbk(AppInterface paramAppInterface, BaseActivity paramBaseActivity, ArrayList<VideoInfo> paramArrayList, rwy paramrwy, VideoFeedsRecyclerView paramVideoFeedsRecyclerView)
  {
  ...
  public ocg a()
  {
    if (this.jdField_a_of_type_Ocg == null)
    {
      this.jdField_a_of_type_Ocg = new sbn(this, null);
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.addObserver(this.jdField_a_of_type_Ocg);
    }
    return this.jdField_a_of_type_Ocg;
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.removeObserver(this.jdField_a_of_type_Ocg);
  ...
  public void a(long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 222	sbk:jdField_a_of_type_Boolean	Z
    //   6: istore_3
    //   7: iload_3
    //   8: ifeq +6 -> 14
    //   11: aload_0
    ...
    //   14: aload_0
    //   15: lload_1
    //   16: putfield 143	sbk:jdField_a_of_type_Long	J
    //   19: aload_0
    //   20: getfield 43	sbk:jdField_a_of_type_ComTencentBizPubaccountVideoInfo	Lcom/tencent/biz/pubaccount/VideoInfo;
    //   23: getfield 226	com/tencent/biz/pubaccount/VideoInfo:n	I
    //   26: ifeq -15 -> 11
    //   29: aload_0
    //   30: getfield 143	sbk:jdField_a_of_type_Long	J
    //   33: aload_0
    //   34: getfield 43	sbk:jdField_a_of_type_ComTencentBizPubaccountVideoInfo	Lcom/tencent/biz/pubaccount/VideoInfo;
    //   37: getfield 226	com/tencent/biz/pubaccount/VideoInfo:n	I
    //   40: sipush 1000
    //   43: imul
    //   44: i2l
    //   45: lcmp
    ...
    //   49: aload_0
    //   50: iconst_1
    //   51: putfield 222	sbk:jdField_a_of_type_Boolean	Z
    ...
    //   75: aload_0
    //   76: getfield 43	sbk:jdField_a_of_type_ComTencentBizPubaccountVideoInfo	Lcom/tencent/biz/pubaccount/VideoInfo;
    ...
    //   91: aload_0
    //   92: getfield 27	sbk:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
  ...
  public void a(VideoInfo paramVideoInfo)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("Q.pubaccount.video.feeds.VideoFeedsRecommendManager", 2, "切换视频 videoInfo.DynamicTriggerSec = " + this.jdField_a_of_type_ComTencentBizPubaccountVideoInfo.n);
    }
  }
  
  public void a(sbm paramsbm)
  {
    this.jdField_a_of_type_JavaUtilArrayList.add(paramsbm);
  }
}
