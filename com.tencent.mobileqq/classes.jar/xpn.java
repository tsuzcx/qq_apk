...
public class xpn
{
  public ArrayList<Long> a(List<String> paramList)
  {
    ...
    {
      l = axsg.a((String)paramList.next()) + l;
  ...
  public ArrayList<Long> a(List<String> paramList, String paramString)
  {
    ...
    long l2 = axsg.a(paramString);
    paramString = new ArrayList();
    Iterator localIterator = paramList.iterator();
    long l1 = 0L;
    while (localIterator.hasNext())
    {
      l1 = axsg.a((String)localIterator.next()) + l1;
  ...
  public boolean a(List<String> paramList, String paramString, int paramInt1, int paramInt2, MediaFormat paramMediaFormat)
  {
    ...
    {
      localObject4 = new bnnu();
      try
      {
        i = bnnt.a((String)paramList.get(0), (bnnu)localObject4);
      ...
      paramInt1 = j;
      if (AudioHelper.f()) {
        return bnno.a(paramList, paramString, i);
      }
      ...
      localObject5 = new axqz(paramString, paramInt1, paramInt2, azds.r, 1, false, i);
      ((axqz)localObject5).b = true;
    }
    for (;;)
    {
      Object localObject3;
      try
      {
        ...
        localObject3 = new File(((axqz)localObject5).a);
        if (!((File)localObject3).exists()) {
          bdcs.c(((File)localObject3).getAbsolutePath());
        }
        localObject3 = new MediaMuxer(((axqz)localObject5).a, 0);
        ((MediaMuxer)localObject3).setOrientationHint(((axqz)localObject5).g);
  ...
  public ArrayList<Long> b(List<String> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      {
        localLinkedHashMap.put(localObject, Long.valueOf(axsg.a((String)localObject)));
      }
    }
  ...
  public ArrayList<Long> b(List<String> paramList, String paramString)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      {
        paramString.put(localObject, Long.valueOf(axsg.a((String)localObject)));
      }
    }
    paramList = new ArrayList();
