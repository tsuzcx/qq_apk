...
public class aynz
  extends PopupWindow
  implements View.OnClickListener, baeq
{
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ayob(this);
  private Animation jdField_a_of_type_AndroidViewAnimationAnimation;
  TextView jdField_a_of_type_AndroidWidgetTextView;
  aynl jdField_a_of_type_Aynl = new ayoa(this);
  ayoc jdField_a_of_type_Ayoc;
  ...
  public aynz(TroopChatPie paramTroopChatPie, BaseActivity paramBaseActivity, View paramView, int paramInt1, int paramInt2)
  {
  ...
  private View a(aynz paramaynz, Activity paramActivity, int paramInt)
  {
    View localView = paramaynz.getContentView();
    this.jdField_a_of_type_ComTencentMobileqqTroopQuickatUiAtPanelTouchController = ((AtPanelTouchController)localView.findViewById(2131364691));
    ...
    ((RelativeLayout)localView.findViewById(2131369309)).setPadding(0, 0, 0, bbll.b(24.0F) + a(paramActivity));
    localView.findViewById(2131377635).setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131371241));
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131699587);
    ...
    {
      this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)localView.findViewById(2131364710));
      this.jdField_a_of_type_ComTencentWidgetXListView.getLayoutParams();
      this.jdField_a_of_type_ComTencentWidgetXListView.setOverScrollMode(2);
      this.jdField_a_of_type_ComTencentMobileqqTroopQuickatUiAtPanelTouchController.setAtPanelTouchListener(paramaynz);
      this.jdField_a_of_type_ComTencentMobileqqTroopQuickatUiAtPanelTouchController.setMode(paramInt);
      this.jdField_a_of_type_Ayoc = new ayoc(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_AndroidViewView$OnClickListener);
      this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Ayoc);
      paramaynz = (amwi)ampl.a().a(553);
      if ((paramaynz == null) || (paramaynz.a.size() <= 0)) {
        break label451;
      }
      this.jdField_a_of_type_Ayoc.a(paramaynz.a);
    }
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioItemRoundRectUrlImageView = ((RoundRectUrlImageView)localView.findViewById(2131363043));
      paramaynz = aync.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app).a();
      if (paramaynz != null)
      {
        paramActivity = URLDrawable.URLDrawableOptions.obtain();
        paramActivity = URLDrawable.getDrawable(paramaynz.c, paramActivity);
        this.jdField_a_of_type_ComTencentMobileqqActivityAioItemRoundRectUrlImageView.setAllRadius(bbll.b(16.0F));
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityAioItemRoundRectUrlImageView.setTag(paramaynz);
        if (AppSetting.d) {
          this.jdField_a_of_type_ComTencentMobileqqActivityAioItemRoundRectUrlImageView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131695525));
        }
        aync.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app).a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.c(), 101, paramaynz.jdField_a_of_type_CooperationVipPbTianShuAccess$AdItem.iAdId.get() + "");
      }
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.addObserver(this.jdField_a_of_type_Aynl);
      return localView;
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(paramActivity.getResources().getColor(2131166836));
      break;
      label451:
      this.jdField_a_of_type_Ayoc.a(aynk.a());
    }
  }
  
  public static aynz a(TroopChatPie paramTroopChatPie, BaseActivity paramBaseActivity, int paramInt1, int paramInt2)
  {
    View localView = LayoutInflater.from(paramBaseActivity).inflate(2131560959, null);
    paramTroopChatPie = new aynz(paramTroopChatPie, paramBaseActivity, localView, paramInt1, paramInt2);
    ...
    ((RelativeLayout)localView.findViewById(2131371242)).setOnClickListener(paramTroopChatPie);
  ...
  void a(String paramString)
  {
    ...
    {
      return;
      aync localaync = (aync)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(339);
      localBundle = aynp.a(true, localTroopInfo.isTroopOwner(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getCurrentAccountUin()), localTroopInfo.isAdmin(), localTroopInfo.troopowneruin, this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.a(), 0);
      if (!localaync.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2, localTroopInfo.troopuin, 0)) {
        break;
      }
    ...
    return;
    aynp.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, 1, paramString, null, localBundle, 1);
  }
  ...
  public void b()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.removeObserver(this.jdField_a_of_type_Aynl);
    this.jdField_a_of_type_Ayoc.c();
  }
  ...
  void e()
  {
    ...
    aync localaync = (aync)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(339);
    boolean bool = localaync.a(2, 1, localTroopInfo.uin);
    Bundle localBundle = aynp.a(true, localTroopInfo.isTroopOwner(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getCurrentAccountUin()), localTroopInfo.isAdmin(), localTroopInfo.troopowneruin, this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.a(), 0);
    switch (localamwh.a.a())
    {
    default: 
      if (localaync.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2, localTroopInfo.troopuin, 0)) {
    ...
    for (;;)
    {
      ...
      {
        if (bool) {
          localaync.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, localTroopInfo.troopuin, 1, 2, 0, localBundle);
        } else {
          localaync.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, localTroopInfo.troopuin, 1, 2, 0, localBundle);
        }
      }
      else if (bool)
      {
      ...
      else
      {
        localaync.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, localTroopInfo.troopuin, 1, 2, 0, localBundle);
        continue;
        aynp.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app, localamwh.a.b(), localamwh.a.a(), localamwh.a.b(), localBundle, 1);
      }
    }
  }
  ...
  void f()
  {
    ...
    aync localaync = (aync)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getManager(339);
    boolean bool = localaync.a(4, 1, this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.a());
    localObject = aynp.a(bool, ((TroopInfo)localObject).isTroopOwner(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.getCurrentAccountUin()), ((TroopInfo)localObject).isAdmin(), ((TroopInfo)localObject).troopowneruin, this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.a(), 0);
    if (bool) {
      localaync.b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.a(), 1, 4, 0, (Bundle)localObject);
    }
    for (;;)
    {
      ...
      return;
      localaync.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildTroopChatPie.a(), 1, 4, 0, (Bundle)localObject);
    }
  }
  ...
  {
    if (paramView.getId() == 2131363043)
    {
      paramView = (aynj)paramView.getTag();
      Intent localIntent;
      if (paramView != null)
      {
      ...
      for (;;)
      {
        aync.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app).a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app.c(), 102, paramView.jdField_a_of_type_CooperationVipPbTianShuAccess$AdItem.iAdId.get() + "");
        return;
        label143:
