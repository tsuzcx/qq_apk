  ...
  public void a(lby paramlby)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        lbw locallbw = a();
        this.a = paramlby;
        QIPCClientHelper.getInstance().register(locallbw);
        if (QLog.isColorLevel())
        {
      ...
      catch (Exception paramlby)
      {
        QLog.e("AioShareMusic.AioShareMusicIPCWebClient", 1, "register ipc module error.", paramlby);
      }
    }
  }
