  ...
  extends ReportDialog
{
  ...
  public axhm(Context paramContext, ArrayList<axho> paramArrayList)
  {
    super(paramContext, 2131755826);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new axhn(this);
  ...
  public void a(axhp paramaxhp)
  {
    this.jdField_a_of_type_Axhp = paramaxhp;
  }
  
  protected void a(ArrayList<axho> paramArrayList)
  {
    ...
    localRoundCornerLinearLayout.setBackgroundResource(2130845434);
    ...
    {
      axho localaxho = (axho)paramArrayList.next();
      ViewGroup localViewGroup = (ViewGroup)localLayoutInflater.inflate(2131559512, localRoundCornerLinearLayout, false);
      ImageView localImageView = (ImageView)localViewGroup.findViewById(2131368236);
      TextView localTextView1 = (TextView)localViewGroup.findViewById(2131378707);
      TextView localTextView2 = (TextView)localViewGroup.findViewById(2131377933);
      localTextView1.setText(localaxho.jdField_b_of_type_JavaLangString);
      if (TextUtils.isEmpty(localaxho.c))
      {
        localTextView2.setVisibility(8);
        label167:
        if (TextUtils.isEmpty(localaxho.a)) {
          break label227;
        }
        a(localImageView, localaxho.a);
      }
      for (;;)
      {
        localViewGroup.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
        localViewGroup.setTag(localaxho);
        localRoundCornerLinearLayout.addView(localViewGroup);
        break;
        localTextView2.setText(localaxho.c);
        break label167;
        label227:
        if (localaxho.jdField_b_of_type_Int > 0) {
          localImageView.setImageResource(localaxho.jdField_b_of_type_Int);
        }
      }
    }
