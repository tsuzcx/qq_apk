  ...
  extends anud
{
  ...
  oam jdField_a_of_type_Oam;
  
  public oal(AppInterface paramAppInterface)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!localGetArticleLikeCountRespond.ret.ret_code.has()) || (localGetArticleLikeCountRespond.ret.ret_code.get() != 0))
        {
          ...
          this.jdField_a_of_type_Oam.a(bool, paramToServiceMsg, i);
          return;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((!paramFromServiceMsg.ret.ret_code.has()) || (paramFromServiceMsg.ret.ret_code.get() != 0))
        {
          ...
          this.jdField_a_of_type_Oam.a(bool2, paramToServiceMsg, bool1);
          return;
        }
      }
      catch (Exception paramToServiceMsg)
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_Oam.a(bool1, paramToServiceMsg);
        return;
      }
      catch (Exception paramToServiceMsg)
      {
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Oam != null) {
        this.jdField_a_of_type_Oam.a(bool1);
      }
      return;
    }
    catch (Exception paramToServiceMsg)
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Oam != null) {
        this.jdField_a_of_type_Oam.a(bool1, i);
      }
      return;
    }
    catch (Exception paramToServiceMsg)
    ...
    for (;;)
    {
      try
      {
        ...
        if ((!paramToServiceMsg.ret.ret_code.has()) || (paramToServiceMsg.ret.ret_code.get() == 0))
        {
          ...
          if (this.jdField_a_of_type_Oam != null) {
            this.jdField_a_of_type_Oam.b(bool2, i);
          }
          return;
        }
      }
  ...
  private void g(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      {
        paramFromServiceMsg.mergeFrom((byte[])paramObject);
        localuyc.jdField_a_of_type_JavaLangString = ((String)paramToServiceMsg.extraData.get(this.jdField_a_of_type_JavaLangString));
        paramToServiceMsg = localuyc.jdField_a_of_type_JavaLangString;
        if (paramFromServiceMsg.ret.has()) {
          if ((!paramFromServiceMsg.ret.ret_code.has()) || (paramFromServiceMsg.ret.ret_code.get() == 0))
          {
            bool = true;
            if (paramFromServiceMsg.article_share_url.has()) {
              localuyc.jdField_b_of_type_JavaLangString = paramFromServiceMsg.article_share_url.get().toStringUtf8();
            }
            if (paramFromServiceMsg.puin.has()) {
              localuyc.c = (paramFromServiceMsg.puin.get() + "");
            }
            if (paramFromServiceMsg.article_img_url.has()) {
              localuyc.d = paramFromServiceMsg.article_img_url.get().toStringUtf8();
            }
            if (paramFromServiceMsg.article_title.has()) {
              localuyc.e = paramFromServiceMsg.article_title.get().toStringUtf8();
            }
            if (paramFromServiceMsg.enable_comment.has()) {
              localuyc.jdField_a_of_type_Int = paramFromServiceMsg.enable_comment.get();
            }
            if (paramFromServiceMsg.comment_url.has()) {
              localuyc.f = paramFromServiceMsg.comment_url.get().toStringUtf8();
            }
            if (paramFromServiceMsg.firstItem.has())
            {
              localuyc.jdField_a_of_type_Uyd = new uyd();
              localuyc.jdField_a_of_type_Uyd.jdField_a_of_type_JavaLangString = paramFromServiceMsg.firstItem.url.get().toStringUtf8();
              localuyc.jdField_a_of_type_Uyd.d = paramFromServiceMsg.firstItem.photo_author_name.get().toStringUtf8();
              localuyc.jdField_a_of_type_Uyd.c = paramFromServiceMsg.firstItem.photo_time.get().toStringUtf8();
              localuyc.jdField_a_of_type_Uyd.jdField_b_of_type_JavaLangString = paramFromServiceMsg.firstItem.publicaccount_name.get().toStringUtf8();
            }
            ...
            {
              localuye = new uye();
              localuye.jdField_a_of_type_JavaLangString = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).url.get().toStringUtf8();
              localuye.jdField_b_of_type_JavaLangString = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).content.get().toStringUtf8();
              localuye.c = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).static_url.get().toStringUtf8();
              localuye.jdField_a_of_type_Int = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).width.get();
              localuye.jdField_b_of_type_Int = ((ArticleComment.PhotoItemInfo)paramFromServiceMsg.item.get(i)).height.get();
    ...
    for (;;)
    {
      ...
      break;
      label628:
      while (this.jdField_a_of_type_Oam != null)
      {
        this.jdField_a_of_type_Oam.a(bool, localuyc, (byte[])paramObject, paramToServiceMsg);
        return;
        bool = false;
        continue;
        bool = false;
        paramToServiceMsg = localuye;
      }
    }
  }
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    this.jdField_a_of_type_Oam.a(bool, paramToServiceMsg);
  }
      ...
      try
      {
        ...
        if ((paramFromServiceMsg.uint32_ret_code.has()) && (paramFromServiceMsg.uint32_ret_code.get() == 0))
        {
          if (paramFromServiceMsg.uint32_read_count.has())
          {
            ...
            if (this.jdField_a_of_type_Oam != null) {
              this.jdField_a_of_type_Oam.c(bool, i);
            }
            return;
            bool = false;
            break;
  ...
  public void a()
  {
    this.jdField_a_of_type_Oam = null;
  }
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    localGetPhotoCollectionInfoRequest.versionInfo.set("8.4.5,3,4745");
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, int paramInt3, ArrayList<uyf> paramArrayList)
  {
    if (QLog.isColorLevel()) {
    ...
    paramString2 = ByteStringMicro.copyFromUtf8("8.4.5");
    localReportGalleryInfoRequest.mv.set(paramString2);
    paramString2 = ByteStringMicro.copyFromUtf8("4745");
    localReportGalleryInfoRequest.subv.set(paramString2);
    paramString2 = ByteStringMicro.copyFromUtf8(antf.c[bhnv.a(this.mApp.getApp().getBaseContext())]);
    ...
    if ((paramArrayList != null) && (paramArrayList.size() > 0) && (paramInt1 == 2))
    {
      ...
      {
        paramString3 = (uyf)paramString2.next();
  ...
  public void b(String paramString)
  {
    ...
    localGetRecommendInfoRequest.versionInfo.set("8.4.5,3,4745");
