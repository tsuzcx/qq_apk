...
public class anzl
{
  ...
  private final TreeMap<Integer, anzm> jdField_a_of_type_JavaUtilTreeMap = new TreeMap();
  public boolean a;
  public long b;
  public String b;
  public long c = 0L;
  ...
  public String toString()
  {
    ...
    if (QLog.isDevelopLevel())
    {
      ...
      {
        anzm localanzm = (anzm)((Iterator)localObject).next();
        str = str + "\n" + localanzm;
      }
