...
{
  public int a;
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new bnpi(this);
  public String a;
  ...
  private int a(int paramInt)
  {
    ...
    if ((localbiod instanceof bioz)) {
      i = ((bioz)localbiod).switchRequestCode(this, (byte)paramInt);
    }
    return i;
  }
  ...
  private void a(int paramInt)
  {
    ...
    {
      return;
      j = this.mRuntime.a().getResources().getDimensionPixelSize(2131299011);
      if (!bmtd.d()) {}
      for (int i = 1; i != 0; i = 0)
      {
        QQToast.a(this.mRuntime.a(), 2131716919, 0).b(j);
        return;
      }
      a();
      switch (paramInt)
      ...
      case 1: 
        ...
        localbmtk.jdField_a_of_type_JavaLangString = this.mRuntime.a().getCurrentAccountUin();
        BaseBusinessAlbumInfo localBaseBusinessAlbumInfo = new BaseBusinessAlbumInfo();
        localBaseBusinessAlbumInfo.jdField_a_of_type_JavaLangString = localbmtk.jdField_a_of_type_JavaLangString;
        ...
        localBaseBusinessAlbumInfo.jdField_b_of_type_JavaLangString = this.mRuntime.a().getString(2131716412);
        bmtd.b(this.mRuntime.a(), localbmtk, localBaseBusinessAlbumInfo, -1, "cover_mall_record_video");
        return;
      }
      QLog.i("CoverStore", 1, "VIDEO_COVER click select record video.");
    } while (!bnko.a(this.mRuntime.a(), new bnpg(this, j), 1));
    b(j);
  }
      ...
      do
      {
        do
        {
          ...
          for (;;)
          {
            ...
            Object localObject = bnni.a(str);
            if (localObject == null) {
              break;
            }
            double d1 = bnni.a((bnnl)localObject);
            if (d1 > 0.0D)
            {
              ((bnnl)localObject).jdField_a_of_type_Int = ((int)(((bnnl)localObject).jdField_a_of_type_Int / d1));
              ((bnnl)localObject).jdField_b_of_type_Int = ((int)(((bnnl)localObject).jdField_b_of_type_Int / d1));
            }
            localObject = bnni.a(str, ((bnnl)localObject).jdField_a_of_type_Int, ((bnnl)localObject).jdField_b_of_type_Int);
  ...
  private void a(String paramString)
  {
    ...
    ((bmtk)localObject).jdField_a_of_type_JavaLangString = this.mRuntime.a().getAccount();
    paramString.putString("keyAction", "actionSelectPicture");
    paramString.putBoolean("key_need_change_to_jpg", false);
    bmtd.a(this.mRuntime.a(), (bmtk)localObject, paramString, a(3));
  }
    ...
    for (;;)
    {
      ...
      try
      {
        if (i < paramArrayList.size())
        {
          ...
          Object localObject2 = bnni.a((String)localObject1);
          if (localObject2 == null) {
            break label339;
          }
          double d1 = bnni.a((bnnl)localObject2);
          if (d1 > 0.0D)
          {
            ((bnnl)localObject2).jdField_a_of_type_Int = ((int)(((bnnl)localObject2).jdField_a_of_type_Int / d1));
            ((bnnl)localObject2).jdField_b_of_type_Int = ((int)(((bnnl)localObject2).jdField_b_of_type_Int / d1));
          }
          localObject2 = bnni.a((String)localObject1, ((bnnl)localObject2).jdField_a_of_type_Int, ((bnnl)localObject2).jdField_b_of_type_Int);
          ...
          bdmc.a(BaseApplicationImpl.getContext()).a(null, "Qzone.EventTransformPhotoBase64", bool, l2 - l1, 0L, (HashMap)localObject1, null);
        }
      }
  ...
  {
    bmul.a(this.mRuntime.a().getLongAccountUin(), this.mRuntime.a(), "cover_mall_record_video", new bnph(this, paramInt));
  }
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if (paramString3.equals("showStoreButton"))
    {
      ...
      paramJsBridgeListener = (TextView)this.mRuntime.a().findViewById(2131369073);
      if (paramJsBridgeListener != null)
      {
        paramJsBridgeListener.setVisibility(0);
        paramJsBridgeListener.setTextColor(-1);
        paramJsBridgeListener.setText(anzj.a(2131710512));
        paramJsBridgeListener.setOnClickListener(new bnpf(this));
      }
    }
    label810:
    do
    {
      for (;;)
      {
        ...
        else if (paramString3.equals("openYellowDiamond"))
        {
          ...
          paramString2 = anzj.a(2131710510);
      ...
      if (paramString3.equals("leftButtonClick"))
      {
        ...
        ((TextView)this.mRuntime.a().findViewById(2131369042)).performClick();
        return true;
      }
