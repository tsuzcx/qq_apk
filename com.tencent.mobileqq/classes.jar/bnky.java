...
public class bnky
{
  private static bnky jdField_a_of_type_Bnky;
  ...
  public static bnky a()
  {
    if (jdField_a_of_type_Bnky == null) {}
    try
    {
      if (jdField_a_of_type_Bnky == null) {
        jdField_a_of_type_Bnky = new bnky();
      }
      return jdField_a_of_type_Bnky;
    }
    finally {}
  }
        ...
        if (localObject != null)
        {
          ...
          if (k > 0)
          {
            ...
            while (i < k)
            {
              ...
              {
                xoo.jdField_a_of_type_JavaLangString = localJSONObject1.getString("downloadInfo");
                if (QLog.isColorLevel()) {
                  QLog.e(jdField_a_of_type_JavaLangString, 2, "QIMBeautyManager WeishiGuideUtils.DOWNLOAD_JSON=  " + xoo.jdField_a_of_type_JavaLangString);
                }
              }
              i += 1;
            }
