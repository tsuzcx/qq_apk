  ...
  implements aped, ARNativeBridge.ActionCallback
{
  ...
  public apew(apef paramapef, apex paramapex, GLSurfaceView paramGLSurfaceView)
  {
    this.jdField_a_of_type_Boolean = false;
    this.jdField_a_of_type_Apef = paramapef;
    this.jdField_a_of_type_Apex = paramapex;
    ...
    this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge = ((ARNativeBridge)this.jdField_a_of_type_Apef.a(0));
  }
  ...
  public void a(int paramInt)
  {
    ...
    case 2: 
      ...
      this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge.nativeCreateEngineBusiness(this.b, this.jdField_a_of_type_Apex.b, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getAssets(), this.jdField_a_of_type_Apex.c, this.d, this.e, 100);
    ...
    case 7: 
      ...
      return;
    case 9: 
      this.jdField_a_of_type_Apef.a(new Interactive3DRenderable.1(this));
      return;
    case 8: 
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqArARNativeBridge.nativeOnDrawFrame(this.b, paramapel.a, (float[])paramapel.a("CAMERA_POSITION"));
  }
  ...
  public int b()
  {
    return this.jdField_a_of_type_Apex.jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo.d;
  }
  ...
  public String c()
  {
    return this.jdField_a_of_type_Apex.jdField_a_of_type_JavaLangString;
  }
  ...
  public void callback(int paramInt1, String paramString1, int paramInt2, String paramString2)
  {
    ...
    do
    {
      ...
      case 57: 
      default: 
        this.jdField_a_of_type_Apef.a(this, this.jdField_a_of_type_Apex.jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo, paramInt1, 0, paramString2);
        return;
      }
  ...
  public void d()
  {
    ...
    {
      String str = this.jdField_a_of_type_Apex.c;
      ...
      this.jdField_a_of_type_Apbp = new apbp(1, this.jdField_a_of_type_ArrayOfJavaLangString);
      a(2);
      this.g = 0;
      this.f = 0;
    }
    if (this.jdField_a_of_type_Apef != null) {
      this.jdField_a_of_type_Apef.a(this, this.jdField_a_of_type_Apex.jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo, 100, 0, null);
    }
  }
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_Int == 9)
    {
      ...
      if (this.jdField_a_of_type_Apef != null)
      {
        this.jdField_a_of_type_Apef.a(this.jdField_a_of_type_Apex.jdField_a_of_type_JavaLangString);
        QLog.d("AREngine_Interactive3DRenderable", 2, "onDestroy, remove hsRender here, " + this);
        this.jdField_a_of_type_Apef.a(this, this.jdField_a_of_type_Apex.jdField_a_of_type_ComTencentMobileqqArAidlArCloudConfigInfo, 101, 0, null);
      }
      if (this.jdField_a_of_type_Int == 9) {
        a(10);
      }
