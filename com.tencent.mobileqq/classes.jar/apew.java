  ...
  implements aoua, apev
{
  ...
  public volatile aoty a;
  aotz jdField_a_of_type_Aotz;
  public aouf a;
  private aoul jdField_a_of_type_Aoul = new aoul(this);
  private apgc jdField_a_of_type_Apgc;
  ...
  public apew()
  {
    this.jdField_a_of_type_Aouf = new aouf();
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  }
  
  private aoty a(String paramString)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(paramString)) {
      return (aoty)this.jdField_a_of_type_JavaUtilMap.get(paramString);
    }
    return null;
  }
  ...
  private void b(GL10 paramGL10)
  {
    ...
    this.jdField_a_of_type_Aoul.onDrawFrame(paramGL10);
    ...
    paramGL10 = this.jdField_a_of_type_Aoty;
    if ((paramGL10 != null) && (paramGL10.d()))
    {
      System.currentTimeMillis();
      GLES20.glEnable(2929);
      aoug localaoug = this.jdField_a_of_type_Aouf.a(paramGL10.b(), paramGL10.c());
      if (localaoug != null) {
        paramGL10.a(localaoug);
      }
      GLES20.glDisable(2929);
      System.currentTimeMillis();
    }
  ...
  public int a()
  {
    return this.jdField_a_of_type_Aoul.a();
  }
  
  public long a()
  {
    return this.jdField_a_of_type_Aouf.jdField_a_of_type_Long;
  }
  ...
  public void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Aoul.b(paramInt);
  }
  ...
  public void a(int paramInt1, SurfaceTexture paramSurfaceTexture, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    this.jdField_a_of_type_Aoul.a(paramInt1, paramSurfaceTexture);
    this.jdField_a_of_type_Aoul.a(paramInt2, paramInt3, paramInt4, paramInt5);
  ...
  {
    this.jdField_a_of_type_Aouf.a(paramArrayOfFloat);
  }
  
  public void a(long paramLong)
  {
    this.jdField_a_of_type_Aouf.jdField_a_of_type_Long = paramLong;
  }
  
  public void a(aoty paramaoty, ArCloudConfigInfo paramArCloudConfigInfo, int paramInt1, int paramInt2, Object paramObject)
  {
    if ((paramArCloudConfigInfo != null) && (paramArCloudConfigInfo.a()) && (this.jdField_a_of_type_Aotz != null)) {
      this.jdField_a_of_type_Aotz.a(paramArCloudConfigInfo, paramInt1, paramInt2, paramObject);
    }
  }
  
  public void a(aotz paramaotz)
  {
    this.jdField_a_of_type_Aotz = paramaotz;
  }
  
  public void a(aoud paramaoud)
  {
    this.jdField_a_of_type_Aouf.a(paramaoud);
  }
  ...
  {
    if (this.jdField_a_of_type_Aotz == null) {
      return;
    }
    this.jdField_a_of_type_Aotz.a(paramArVideoResourceInfo, paramaoua);
  }
  ...
  {
    this.jdField_a_of_type_Aoul.a(paramFloatBuffer, paramSize);
  }
  ...
  public boolean a(aouc paramaouc)
  {
    QLog.i("AREngine_UniformGLRenderManagerImpl", 1, "startModelRender. resourceInfo.key = " + paramaouc.jdField_a_of_type_JavaLangString + ", resourceInfo.arType = " + paramaouc.jdField_a_of_type_Int + ", resourceInfo.trackMode = " + paramaouc.jdField_b_of_type_Int);
    if (!this.e)
    {
      QLog.i("AREngine_UniformGLRenderManagerImpl", 1, "startModelRender. fail because of render not ready");
      return false;
    }
    aoty localaoty2 = a(paramaouc.jdField_a_of_type_JavaLangString);
    aoty localaoty1 = localaoty2;
    if (localaoty2 == null)
    {
      localaoty1 = aoue.a(this, paramaouc, this.jdField_a_of_type_AndroidOpenglGLSurfaceView);
      QLog.d("AREngine_UniformGLRenderManagerImpl", 1, "crate new render here 1" + localaoty1);
      this.jdField_a_of_type_JavaUtilMap.put(paramaouc.jdField_a_of_type_JavaLangString, localaoty1);
      QLog.d("AREngine_UniformGLRenderManagerImpl", 1, "crate new render here " + localaoty1);
    }
    if (localaoty1 == null)
    {
      ...
      paramaouc = this.jdField_a_of_type_Aoty;
      this.jdField_a_of_type_Aoty = null;
      this.jdField_a_of_type_AndroidOpenglGLSurfaceView.queueEvent(new UniformGLRenderManagerImpl.1(this, paramaouc));
      return false;
    }
    this.jdField_a_of_type_AndroidOpenglGLSurfaceView.queueEvent(new UniformGLRenderManagerImpl.2(this, localaoty1, paramaouc));
    return true;
  }
  ...
  public boolean a(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    if (this.jdField_a_of_type_Aoul != null)
    {
      this.jdField_a_of_type_Aoul.a(paramBoolean);
      this.jdField_a_of_type_Aoul.a(paramFloat2);
      return true;
    }
    return false;
  }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext()) {
        ((aoty)localIterator.next()).f();
      }
      this.jdField_a_of_type_JavaUtilMap.clear();
      this.jdField_a_of_type_Aoty = null;
      this.jdField_a_of_type_Aoul.g();
      this.jdField_a_of_type_Aouf.a();
      this.e = false;
  ...
  {
    if ((this.jdField_a_of_type_Aotz == null) || (this.jdField_a_of_type_Aoty == null))
    {
    ...
    default: 
      return;
    case 0: 
      this.jdField_a_of_type_Aotz.a(this.jdField_a_of_type_Aoty.c(), paramInt2);
      return;
    case 1: 
      this.jdField_a_of_type_Aotz.c(this.jdField_a_of_type_Aoty.c(), paramInt2);
      return;
    case 2: 
      this.jdField_a_of_type_Aotz.b(this.jdField_a_of_type_Aoty.c(), paramInt2);
      return;
    }
    this.jdField_a_of_type_Aotz.d(this.jdField_a_of_type_Aoty.c(), paramInt2);
  }
  
  public void b(long paramLong)
  {
    this.jdField_a_of_type_Aouf.c = paramLong;
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Aotz = null;
  }
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    while (i != 0)
    {
      if (!this.jdField_b_of_type_Boolean)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqArARRecordVideoRecordController.a(this.jdField_a_of_type_Bath, i, j);
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Aotz != null) {
        this.jdField_a_of_type_Aotz.a(null, 1001, 0, localBitmap);
      }
  ...
  public void onSurfaceChanged(GL10 paramGL10, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Apgc != null) {
      this.jdField_a_of_type_Apgc.a(paramGL10, paramInt1, paramInt2);
    }
    this.jdField_a_of_type_Aoul.onSurfaceChanged(paramGL10, paramInt1, paramInt2);
    if (this.jdField_a_of_type_Aotz != null) {
  ...
  public void onSurfaceCreated(GL10 paramGL10, EGLConfig paramEGLConfig)
  {
    ...
    aoqx.a().a(paramGL10.glGetString(7937));
    this.jdField_a_of_type_Aoul.onSurfaceCreated(paramGL10, paramEGLConfig);
    if (this.jdField_a_of_type_Apgc != null) {
      this.jdField_a_of_type_Apgc.a(paramGL10);
    }
    ...
    aoxh.a(paramGL10.glGetString(7937), paramGL10.glGetString(7936), paramGL10.glGetString(7938), paramEGLConfig.toString());
  }
}
