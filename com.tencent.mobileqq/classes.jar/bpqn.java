  ...
  implements IEventReceiver
{
  ...
  private void a(View paramView)
  {
    ...
    paramView = new SpannableString(anni.a(2131709563));
    ...
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx.addTextChangedListener(new bpqp(this));
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setOnEditorActionListener(new bpqo(this));
  }
