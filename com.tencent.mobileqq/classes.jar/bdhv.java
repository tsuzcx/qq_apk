...
public class bdhv
  implements bdll
{
  public bdhv(DownloadInterfaceNew paramDownloadInterfaceNew, String paramString) {}
  
  public void a(int paramInt, String paramString)
  {
    bdii.e("DownloadInterfaceNew", "[innerQuery] [onException] errorCode=" + paramInt + ", errorMsg=" + paramString);
  }
  
  public void a(List<DownloadInfo> paramList)
  {
    bdii.c("DownloadInterfaceNew", "[innerQuery] onResult = " + paramList.size());
    ...
    bdii.c("DownloadInterfaceNew", "[innerQuery] querySucess : " + paramList);
