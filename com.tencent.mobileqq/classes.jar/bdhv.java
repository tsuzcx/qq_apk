...
public class bdhv
{
  ...
  static
  {
    jdField_a_of_type_JavaUtilComparator = new bdhx();
    jdField_b_of_type_JavaUtilComparator = new bdhw();
  ...
  {
    return bbdm.a(a(paramString));
  }
  
  public static String a(byte[] paramArrayOfByte)
  {
    return bbdm.a(a(paramArrayOfByte));
  }
  ...
  public static String b(String paramString)
  {
    try
    {
      paramString = bbdm.a(a(paramString.getBytes("UTF-8")));
      return paramString;
    }
  ...
  public static String d(String paramString)
  {
    ...
    paramString = new bdhv().b(paramString);
