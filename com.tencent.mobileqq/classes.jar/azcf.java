  ...
  extends MSFServlet
{
  ...
  {
    int j = 0;
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), azcf.class);
  ...
  private void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      notifyObserver(paramIntent, 2, bool1, localBundle, azce.class);
      return;
  ...
  {
    int i = 0;
    azcb localazcb = (azcb)paramQQAppInterface.getManager(QQManagerFactory.ONLINE_STATUS_PERMISSION_MANAGER);
    ...
    for (;;)
    {
      localazcb.a(new OnlineStatusFriendsPermissionItem(bool, paramQQAppInterface));
      if (paramIntent != null) {
        localazcb.a(paramIntent);
      }
      return;
      label134:
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          azcb localazcb = (azcb)((QQAppInterface)getAppRuntime()).getManager(QQManagerFactory.ONLINE_STATUS_PERMISSION_MANAGER);
          localObject = new OnlineStatusFriendsPermissionItem(bool, (List)localObject);
          localazcb.a(paramRspBody);
          localazcb.a((OnlineStatusFriendsPermissionItem)localObject);
          return;
        }
        localObject = null;
      }
  ...
  private void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    //   211: aload_0
    //   212: aload 7
    //   214: invokespecial 430	azcf:a	(Ltencent/im/oidb/cmd0xe63/oidb_cmd0xe63$RspBody;)V
    //   217: iconst_1
    //   218: istore 6
    //   220: aload_0
    //   221: aload_1
    ...
    //   225: aload 9
    //   227: ldc 225
    //   229: invokevirtual 229	azcf:notifyObserver	(Landroid/content/Intent;IZLandroid/os/Bundle;Ljava/lang/Class;)V
    //   232: return
    //   233: astore 7
    //   235: aconst_null
    //   236: astore_2
