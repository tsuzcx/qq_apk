...
{
  public vpl(DiscussChatPie paramDiscussChatPie) {}
  ...
  private void d(String paramString)
  {
    try
    {
      if (!this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.isFinishing()) {
        DialogUtil.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 230, "发送失败", this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131433711), new vpo(this, paramString), null).show();
      }
      return;
    }
  ...
  protected void a(String paramString1, int paramInt1, int paramInt2, SendMessageHandler paramSendMessageHandler, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    for (;;)
    {
      this.a.b(196608);
      return;
      QQToast.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 2131433708, 1).b(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
      continue;
      QQToast.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 2131433709, 1).b(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
      continue;
      DialogUtil.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 230, "发送失败", this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131435264), new vpm(this, paramString1), null).show();
      continue;
      if (Looper.myLooper() != Looper.getMainLooper()) {
        this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.runOnUiThread(new vpn(this, paramString1));
      } else {
        d(paramString1);
      }
    }
