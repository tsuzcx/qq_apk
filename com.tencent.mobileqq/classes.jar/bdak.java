...
public class bdak
{
  ...
  {
    long l = 0L;
    paramContext = paramContext.getSharedPreferences(String.valueOf(aljq.G), 0);
  ...
  public static String a(Context paramContext, String paramString)
  {
    ...
    SharedPreferences localSharedPreferences = paramContext.getSharedPreferences(String.valueOf(aljq.G), 0);
  ...
  public static String a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (localList.size() > 0)
    {
      ...
      if (i < localList.size())
      {
        ...
        for (str2 = bdbt.a(paramQQAppInterface, str3, true);; str2 = bdbt.b(paramQQAppInterface, str3, true))
        {
