...
{
  public rfy(AddFriendVerifyActivity paramAddFriendVerifyActivity) {}
  ...
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    default: 
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.dismiss();
      QQToast.a(this.a, 1, 2131434443, 1).b(this.a.getTitleBarHeight());
      return;
    case 0: 
    case 1: 
      this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.dismiss();
      ...
      if (localObject != null) {
        QQToast.a(this.a, 2, 2131434442, 1).b(this.a.getTitleBarHeight());
      }
      for (;;)
      {
        try
    ...
    this.a.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.dismiss();
    QQToast.a(this.a, 1, 2131434414, 1).b(this.a.getTitleBarHeight());
  }
  ...
  protected void a(String paramString)
  {
    ...
    paramString = new rgw(this.a, paramString);
  ...
  protected void b(boolean paramBoolean, long paramLong, int paramInt1, TroopInfo paramTroopInfo, int paramInt2, String paramString)
  {
    ...
    do
    {
      ...
      paramTroopInfo = this.a.getString(2131430284, new Object[] { this.a.app.getCurrentNickname() }) + paramTroopInfo;
