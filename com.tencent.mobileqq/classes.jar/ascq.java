...
public class ascq
{
  ...
  public static ascp a(AppInterface paramAppInterface)
  {
    ascp localascp = new ascp();
    ...
    localascp.jdField_a_of_type_Boolean = paramAppInterface.getBoolean("isShowCard", false);
    localascp.jdField_b_of_type_Boolean = paramAppInterface.getBoolean("isShowList", false);
    localascp.jdField_a_of_type_Long = paramAppInterface.getLong("expireTime", 0L);
    localascp.jdField_a_of_type_JavaLangString = paramAppInterface.getString("entranceJumpUrl", "");
    localascp.jdField_b_of_type_JavaLangString = paramAppInterface.getString("entranceJumpUrlForHost", "");
    localascp.c = paramAppInterface.getString("entranceJumpUrlForGuest", "");
    if (QLog.isColorLevel()) {
      QLog.e("Q..troop.faceScore", 2, "FaceScoreUtils.getConfig config.expireTime=" + localascp.jdField_a_of_type_Boolean + "  config.isShowList=" + localascp.jdField_b_of_type_Boolean + "  config.expireTime=" + localascp.jdField_a_of_type_Long + "  config.entranceJumpUrl=" + localascp.jdField_a_of_type_JavaLangString + "  config.entranceJumpUrlForHost=" + localascp.jdField_b_of_type_JavaLangString + "  config.entranceJumpUrlForGuest=" + localascp.c);
    }
    return localascp;
  }
  ...
  public static void a(AppInterface paramAppInterface, ascp paramascp)
  {
    try
    {
      String str = "nearby_face_score_config_" + paramAppInterface.getCurrentAccountUin();
      paramAppInterface.getApplication().getApplicationContext().getSharedPreferences(str, 4).edit().putBoolean("isShowCard", paramascp.jdField_a_of_type_Boolean).putBoolean("isShowList", paramascp.jdField_b_of_type_Boolean).putLong("expireTime", paramascp.jdField_a_of_type_Long).putString("entranceJumpUrl", paramascp.jdField_a_of_type_JavaLangString).putString("entranceJumpUrlForHost", paramascp.jdField_b_of_type_JavaLangString).putString("entranceJumpUrlForGuest", paramascp.c).commit();
      if (QLog.isColorLevel()) {
        QLog.e("Q..troop.faceScore", 2, "FaceScoreUtils.saveConfig config.expireTime=" + paramascp.jdField_a_of_type_Boolean + "  config.isShowList=" + paramascp.jdField_b_of_type_Boolean + "  config.expireTime=" + paramascp.jdField_a_of_type_Long + "  config.entranceJumpUrl=" + paramascp.jdField_a_of_type_JavaLangString + "  config.entranceJumpUrlForHost=" + paramascp.jdField_b_of_type_JavaLangString + "  config.entranceJumpUrlForGuest=" + paramascp.c);
      }
      return;
    }
    finally
  ...
  {
    awqx.b(null, "dc00899", "grp_lbs", paramString2, "face_score", paramString1, 0, 0, a(0, paramVarArgs), a(1, paramVarArgs), a(2, paramVarArgs), a(3, paramVarArgs));
  }
