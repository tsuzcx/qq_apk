  ...
  implements asdc
{
  ...
  public void a()
  {
    if (QLog.isColorLevel()) {
      QLog.d("Action", 2, "fun startMagicPlay begins, sumPlayTimes:" + this.a.jdField_c_of_type_Int + ",actionGlobalData.openSound:" + this.a.jdField_a_of_type_Ascr.d);
    }
    Object localObject;
    if (this.a.jdField_c_of_type_Int == 0)
    {
      this.a.b();
      if ((this.a.jdField_a_of_type_Asdf.c != null) && (this.a.jdField_a_of_type_Asdf.c.length() > 0) && (this.a.jdField_a_of_type_Ascr.d))
      {
        if (this.a.jdField_a_of_type_Asdf.e > 0)
        {
          localObject = this.a.jdField_a_of_type_Asdf;
          ((asdf)localObject).e -= 1;
        }
        if (QLog.isColorLevel()) {
          QLog.d("Action", 2, "fun startMagicPlay begins, start play Sound.");
        }
        this.a.jdField_a_of_type_Asdr.a(this.a.jdField_a_of_type_Asdf.c, this.a.jdField_a_of_type_Asdf.e);
      }
      if (this.a.jdField_a_of_type_Asdf.a)
      {
        this.a.jdField_a_of_type_AndroidOsVibrator = ((Vibrator)BaseApplicationImpl.getContext().getSystemService("vibrator"));
        if (this.a.jdField_a_of_type_Asdf.h != -1) {
          break label311;
        }
    ...
    {
      localObject = this.a;
      ((ascp)localObject).jdField_c_of_type_Int += 1;
      if (QLog.isColorLevel()) {
        QLog.d("Action", 2, "fun startMagicPlay ends, sumPlayTimes:" + this.a.jdField_c_of_type_Int);
      }
      return;
      label311:
      this.a.jdField_a_of_type_AndroidOsVibrator.vibrate(this.a.jdField_a_of_type_Asdf.h * 1000);
    }
  }
  ...
  public void b()
  {
    ...
    do
    {
      ...
      if (this.a.jdField_a_of_type_Int == -1)
      {
        ...
        {
          this.a.jdField_a_of_type_Asdr.a(this.a.jdField_a_of_type_Asdf);
          return;
        }
