...
public class amvj
  extends amvk
{
  public amvj(int paramInt, amvm paramamvm, amvi paramamvi)
  {
    super(paramInt, paramamvm, paramamvi);
  }
  
  public amvj(int paramInt, String paramString, amvm paramamvm, amvi paramamvi)
  {
    super(paramInt, paramString, paramamvm, paramamvi);
  }
  ...
  private amlc b()
  {
    ...
    try
    {
      ...
      {
        localJSONObject.put("is3DBetaTester", amuo.a(localQQAppInterface));
  ...
  private amlc d(String paramString)
  {
    try
    {
      QLog.d("CmShow_SpriteActionScript", 1, new Object[] { "handleJsError mSpriteFrom:", Integer.valueOf(this.jdField_a_of_type_Amvm.e) });
      paramString = new JSONObject(paramString).optString("data");
      anaw.a(amuo.b(this.jdField_a_of_type_Amvm.e), 1000, 50, new Object[] { paramString });
      return null;
    }
    catch (Exception paramString)
    {
  ...
  private amlc f(String paramString)
  {
    try
    {
      ...
      if ((i == amuo.b(1)) || (i == amuo.b(2))) {
        anaw.a(i, null, new int[] { anav.a(i, false, this.jdField_a_of_type_Amvm.jdField_b_of_type_Int, -1, true) });
      }
      anaw.b(i);
      if ((i == amuo.b(1)) || (i == amuo.b(2)))
      {
        anaw.a(amuo.b(this.jdField_a_of_type_Amvm.e), false);
        return null;
      }
    }
    catch (Throwable paramString)
  ...
  private amlc j(String paramString)
  {
    try
    {
      if (this.jdField_a_of_type_Amvm.e != 0) {
        return null;
      }
  ...
  private amlc m(String paramString)
  {
    try
    {
      ...
      paramString = this.jdField_a_of_type_Amvi;
      if (paramString != null) {
        return null;
      }
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if ("pet".equals(paramString.getString("config_name")))
        {
          ...
          if (localObject != null)
          {
            localObject = (amhd)((QQAppInterface)localObject).getManager(153);
            if (((amhd)localObject).j == null) {
              break label124;
            }
            paramString = new JSONArray(((amhd)localObject).j);
  ...
  private amlc p(String paramString)
  {
    ...
    paramString = this.jdField_a_of_type_Amvm.a();
    if (paramString != null)
    {
      paramString.a();
      return null;
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject = amuo.a(ApolloUtil.a());
          if (localObject != null)
          {
  ...
  private amlc q(String paramString)
  {
    ...
    try
    {
      ...
      if ((this.jdField_a_of_type_Amvm == null) || (this.jdField_a_of_type_Amvm.a() == null))
      {
      ...
      if (this.jdField_a_of_type_Amvm.a().a() == null)
      {
    ...
    ApolloUtil.a(this.jdField_a_of_type_Amvm.a().a(), (String)localObject);
    return null;
    label122:
    ...
    if (i > 0)
    {
      ApolloGameUtil.a(this.jdField_a_of_type_Amvm.a(), i, 333002, "message", 1);
      return null;
    }
  ...
  public amlc a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localamlc.jdField_b_of_type_Boolean = true;
        JSONObject localJSONObject = new JSONObject();
        if ((1 == localQQAppInterface.c()) && (((this.jdField_a_of_type_Amvm.jdField_a_of_type_Int != 1) && (this.jdField_a_of_type_Amvm.jdField_a_of_type_Int != 3000)) || (((1 == localQQAppInterface.a()) || (this.jdField_a_of_type_Amvm.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_Amvm.jdField_a_of_type_Int == -2)) && (!localQQAppInterface.q()) && (!localQQAppInterface.r()) && (localQQAppInterface.s()) && (!MediaPlayerManager.a(localQQAppInterface).a()) && ((localQQAppInterface.a() == null) || (!localQQAppInterface.a().k())) && (!localQQAppInterface.d()))))
        {
  ...
  {
    amkg localamkg = a();
    if ((localamkg == null) || (localamkg.getLuaState() != paramLong)) {}
    do
    {
      do
      {
      ...
      if ("cs.script_update_boundinglist.local".equals(paramString1)) {
        return a(paramString2, localamkg.getRenderImpl().a());
      }
  ...
  public amlc a(String paramString)
  {
    ...
    try
    {
      ...
      amvs localamvs = this.jdField_a_of_type_Amvi.a();
      if (localamvs != null)
      {
        int i = 0;
        if (i < localJSONArray1.length())
        {
          ...
          if (j == 1) {
            localJSONObject2.put("petPath", localamvs.a(new JSONArray(paramString.optString("actionList"))));
          }
          for (;;)
          {
            ...
            i += 1;
            break;
            localObject = localamvs.a((String)localObject);
  ...
  public void a(int paramInt)
  {
    try
    {
      ...
      ApolloUtil.a().callbackFromRequest(this.jdField_a_of_type_Amvm.a().getLuaState(), 0, "sc.script_notify_user_operation.local", localJSONObject.toString());
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString, int paramInt5)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (!this.jdField_a_of_type_Amvm.jdField_b_of_type_Boolean) {
          break label890;
        }
        ...
        if (localObject != null)
        {
          ...
          localJSONObject.put("freeMemory", ((aneb)localObject).d);
          localJSONObject.put("totalMemory", ((aneb)localObject).jdField_c_of_type_Long);
          localJSONObject.put("maxMemory", ((aneb)localObject).jdField_b_of_type_Long);
        }
        localJSONObject.put("aioType", ApolloGameUtil.a(ApolloUtil.a(), paramInt4, this.jdField_a_of_type_Amvm.jdField_a_of_type_JavaLangString));
        ...
        localJSONObject.put("uin", this.jdField_a_of_type_Amvm.jdField_b_of_type_JavaLangString);
        ...
        {
          paramString.put(amzq.a(1, Integer.valueOf(localObject[paramInt2]).intValue()));
          paramInt2 += 1;
          continue;
        }
        ...
        localJSONObject.put("traceFeatureId", this.jdField_a_of_type_Amvm.a());
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    try
    {
      ...
      {
        ApolloCmdChannel.getChannel(paramString1).callbackFromRequest(this.jdField_a_of_type_Amvm.a().getLuaState(), 0, "sc.script_on_sprite_single_clicked.local", localJSONObject.toString());
        return;
      }
      paramString1 = ApolloUtil.a();
      if (paramString1 != null)
      {
        ApolloCmdChannel.getChannelFromOtherProcess(paramString1).callbackFromRequest(this.jdField_a_of_type_Amvm.a().getLuaState(), 0, "sc.script_on_sprite_single_clicked.local", localJSONObject.toString());
        return;
      }
    }
  ...
  {
    if ((this.jdField_a_of_type_Amvm != null) && (this.jdField_a_of_type_Amvm.a() != null)) {
      a(this.jdField_a_of_type_Amvm.a().getWidth(), this.jdField_a_of_type_Amvm.a().getInitHeight(), this.jdField_a_of_type_Amvm.a().getHeight(), this.jdField_a_of_type_Amvm.jdField_a_of_type_Int, this.jdField_a_of_type_Amvm.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Amvm.e);
    }
  }
  ...
  public amlc c(String paramString)
  {
    try
    {
      int i = this.jdField_a_of_type_Amvm.e;
      if (i != 0) {}
      return null;
    }
    catch (Throwable paramString)
