...
{
  public aryk(MapWidget paramMapWidget, int paramInt, aryp paramaryp) {}
  ...
  public void onFailure(int paramInt, String paramString, Throwable paramThrowable)
  {
    ...
    if (MapWidget.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget) != null) {
      MapWidget.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget).a(false, this.jdField_a_of_type_Aryp);
    }
  }
    ...
    for (;;)
    {
      if (paramObject != null)
      {
        ...
        if (bfwr.a())
        {
          ...
          label124:
          this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.jdField_a_of_type_ComTencentTencentmapMapsdkMapsModelPolyline = this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.jdField_a_of_type_ComTencentTencentmapMapsdkMapsTencentMap.addPolyline(new PolylineOptions().addAll(paramObject).color(paramInt).width(baxn.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.getContext(), 5.0F)));
          if (this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.jdField_a_of_type_ComTencentTencentmapMapsdkMapsModelPolyline != null)
          {
      ...
      {
        ((aryo)localObject1).a(bool, this.jdField_a_of_type_Aryp);
        return;
        ...
        this.jdField_a_of_type_Aryp.a = paramObject.duration;
        this.jdField_a_of_type_Aryp.b = paramObject.distance;
        ...
        this.jdField_a_of_type_Aryp.a = ((float)((TransitResultObject.Route)localObject1).duration);
        this.jdField_a_of_type_Aryp.b = ((TransitResultObject.Route)localObject1).distance;
