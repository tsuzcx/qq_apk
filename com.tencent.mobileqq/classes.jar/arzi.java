  ...
  extends aryv
{
  ...
  public arzi(Intent paramIntent)
  {
    super(paramIntent);
    ...
    for (paramInt = paramBundle.wMemberNum;; paramInt = 0)
    {
      ...
      for (;;)
      {
        ...
        if (j == 3000)
        {
          ...
          paramBundle = (alrk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53);
          paramInt = i;
          if (paramBundle != null)
          {
            i = paramBundle.a(str);
  ...
  public List<RecentUser> a(List<RecentUser> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localRecentUser != null) && ((localRecentUser.getType() != 1006) || (a(aryl.jdField_h_of_type_JavaLangInteger))) && (localRecentUser.getType() != 9501) && (localRecentUser.getType() != 6004) && (localRecentUser.getType() != 7000)) {
        if ((localRecentUser.getType() == 0) && (!bdeu.a(localRecentUser.uin)) && (!bdeu.c(localRecentUser.uin)) && (!ndv.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localRecentUser.uin, localRecentUser.getType())) && (a(jdField_b_of_type_JavaLangInteger)))
        {
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    if (d())
    {
      ...
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "autofriendpay.buyerselectpage.list", 0, 0, "", "", "", "");
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "autofriendpay.buyerconfirmpage.show", 0, 0, "", "", "", "");
    }
    label280:
    label307:
    do
    {
      do
      {
        ...
        if ((this.jdField_d_of_type_Int == 1) && (this.e == 2)) {
          azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "autofriendpay.payerselectpage.list", 0, 0, "", "", "", "");
        }
      } while ((this.jdField_a_of_type_Bdjz != null) && (this.jdField_a_of_type_Bdjz.isShowing()));
      boolean bool;
      String str3;
      String str2;
      String str1;
      ...
      for (;;)
      {
        bdgm.a(this.jdField_a_of_type_AndroidAppActivity, 230, str3, str1, alud.a(2131705135), alud.a(2131705133), new arzj(this, paramInt, paramBundle), new arzk(this)).show();
        return;
        bool = false;
        break;
        str1 = str2;
  ...
  protected void d()
  {
    String str = this.jdField_a_of_type_Bdjz.getEditString();
    ...
    do
    {
      ...
      {
        return;
        Object localObject = a(aryl.a.intValue(), this.jdField_a_of_type_AndroidOsBundle);
      ...
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "editsay.button", 0, 0, "", "", "", "");
    } while ((TextUtils.isEmpty(str)) || (str.equals(this.jdField_h_of_type_JavaLangString)));
    azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Vip_pay_mywallet", "", "wallet", "autofriendpay.buyerconfirmpage.send", 0, 0, "", "", "", "");
  }
}
