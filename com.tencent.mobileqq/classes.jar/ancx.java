...
public class ancx
  implements DialogInterface.OnDismissListener, Handler.Callback, AdapterView.OnItemClickListener, bkhw
{
  ...
  public ancx(Context paramContext, AppInterface paramAppInterface)
  {
    try
    {
  ...
  private int a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.f = (anni.a(2131699162) + this.jdField_a_of_type_JavaLangString);
  ...
  private void b()
  {
    ...
    for (localObject = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; localObject = null)
    {
      ...
      {
        if ((localObject != null) && (localAppInterface != null) && (bltb.a(localAppInterface, (Context)localObject, localBundle, null)))
        {
          localObject = a();
          if (localObject != null) {
            break label172;
  ...
  private void c()
  {
    Object localObject1 = new bcvp(StructMsgForGeneralShare.class).c(96).a(this.f).e(this.c).a(anni.a(2131699190), null).b("web", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326", "https://cmshow.qq.com/apollo/html/intro.html?_wv=1027&_bid=2326").a();
    Object localObject2 = bcwc.a(2);
    ((bcvt)localObject2).a(this.d, this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString);
    ...
    if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
    {
      ...
      if (localObject1 != null) {
        aufz.a((Activity)localObject1, (Intent)localObject2, 14002);
      }
    }
  }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (Activity localActivity = (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get();; localActivity = null)
    {
      ...
      {
        localbkic = new bkic(localActivity);
        localbkic.a(localArrayList);
      }
      if ((this.jdField_a_of_type_Bkho == null) && (localActivity != null))
      {
        ...
        this.jdField_a_of_type_Bkho = bkic.a(localActivity, localbkic, new ancy(this, paramString), this, this, false);
      }
      if ((this.jdField_a_of_type_Bkho == null) || (this.jdField_a_of_type_Bkho.isShowing())) {
        break;
      }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localBundle.putString("summary", anni.a(2131699147));
        ...
        bltb.a((AppInterface)localObject, paramMessage, localBundle, this, 15);
        return false;
      }
