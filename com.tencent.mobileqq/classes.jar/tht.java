...
public final class tht
  extends tgo
{
  public static final thu a = new thu(null);
  
  public tht(@NotNull BridgeModule paramBridgeModule)
  {
  ...
  private final void b(JSONObject paramJSONObject, String paramString)
  {
    ...
    {
      tyo.a(paramJSONObject, str, (tfg)new thv(this, paramString));
      break;
    }
  }
  ...
  {
    UiApiPlugin.a(true, paramString, (tfg)new thw(this));
  }
  ...
  public void a()
  {
    a("openPluginView", (Function2)new UIBridgeInvokeHandler.register.1((tht)this));
    a("arouseReadInJoyNativeCommentView", (Function2)new UIBridgeInvokeHandler.register.2((tht)this));
    a("biuCommentAladdinConfig", (Function2)new UIBridgeInvokeHandler.register.3((tht)this));
    a("showCommentEditor", (Function2)new UIBridgeInvokeHandler.register.4((tht)this));
