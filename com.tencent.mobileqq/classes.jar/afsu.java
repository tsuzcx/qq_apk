  ...
  implements afrc, ahoo
{
  ...
  public afsu(BaseChatPie paramBaseChatPie)
  {
  ...
  public EmotionKeywordHorizonListView a(EditText paramEditText)
  {
    ...
    LinearLayout localLinearLayout = (LinearLayout)localEmotionKeywordLayout.findViewById(2131365988);
    EmotionKeywordHorizonListView localEmotionKeywordHorizonListView = (EmotionKeywordHorizonListView)localEmotionKeywordLayout.findViewById(2131366017);
    TextView localTextView = (TextView)localEmotionKeywordLayout.findViewById(2131365987);
    ...
    this.jdField_a_of_type_Ahnc = new ahnc(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramEditText, this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie, localEmotionKeywordHorizonListView);
    localEmotionKeywordHorizonListView.setAdapter(this.jdField_a_of_type_Ahnc);
    localEmotionKeywordHorizonListView.setPadding(0, 0, 0, 0);
    if (this.jdField_a_of_type_Ahns == null) {
      this.jdField_a_of_type_Ahns = ahns.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    }
    this.jdField_a_of_type_Ahns.a(new ahnf(this.jdField_a_of_type_Ahnc));
    localEmotionKeywordLayout.setOnVisibilityListener(new afsv(this));
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      return;
      if (this.jdField_a_of_type_Ahns != null) {
        this.jdField_a_of_type_Ahns.a(null);
      }
      ScenesRecommendManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(null);
      return;
      if ((this.jdField_a_of_type_Ahns != null) && (this.jdField_a_of_type_Ahnc != null)) {
        this.jdField_a_of_type_Ahns.a(new ahnf(this.jdField_a_of_type_Ahnc));
      }
      ScenesRecommendManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this);
      return;
      localahns = ahns.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    } while ((localahns.a()) || (!ahns.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false)));
    ThreadManager.executeOnSubThread(new StickerRecHelper.1(this, localahns));
  }
  
  public void a(ahom paramahom)
  {
    ...
    while ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.getEmotionKeyWordLayout() == null) || (this.jdField_a_of_type_Ahnc == null) || (paramahom == null)) {
      return;
    }
    if (this.jdField_a_of_type_Ahns == null) {
      this.jdField_a_of_type_Ahns = ahns.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    ...
    this.jdField_a_of_type_Ahns.a(paramahom, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin);
  }
  
  public void a(Editable paramEditable)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.getEmotionKeyWordLayout() == null) || (this.jdField_a_of_type_Ahnc == null)) {
      return;
    }
    int i = ahns.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), 6);
    ...
    for (;;)
    {
      ...
      for (boolean bool = this.jdField_a_of_type_Ahns.a(paramEditable, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);; bool = false)
      {
  ...
  public boolean a()
  {
    return ahns.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentUin(), false);
  }
  ...
  public void b()
  {
    ...
    ((afst)this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.getHelper(41)).b();
  }
  ...
  public boolean b()
  {
    ...
    return this.jdField_a_of_type_Ahns.b();
  }
