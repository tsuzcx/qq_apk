...
public final class atfy
{
  ...
  public static Bitmap a(String paramString, int paramInt)
  {
    ...
    {
      return localObject;
      localObject = yyi.a(paramString, -1);
      if (localObject == null)
      {
      ...
      localBitmap = bfpx.a(BaseApplicationImpl.sApplication.getResources(), 2130844239);
  ...
  public static String a(FileManagerEntity paramFileManagerEntity, String paramString)
  {
    ...
    {
      paramFileManagerEntity = FileUtil.getExtension(str);
  ...
  public static void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    {
      QQToast.a(localBaseApplicationImpl, paramInt1, str, paramInt2).b(localBaseApplicationImpl.getResources().getDimensionPixelSize(2131299076));
      return;
    }
  }
  ...
  public static void a(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    for (int i = 1;; i = 0)
    {
      QQToast.a(localBaseApplicationImpl, paramInt, paramString, i).b(localBaseApplicationImpl.getResources().getDimensionPixelSize(2131299076));
      return;
    }
  }
  ...
  public static boolean a(FileManagerEntity paramFileManagerEntity, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      int i = aszt.a(paramFileManagerEntity);
      if (i == 2)
      {
      ...
      else if (i == 4)
      {
        ...
        if ((localAppRuntime instanceof QQAppInterface)) {
          try
          {
            paramFileManagerEntity = bfby.a((QQAppInterface)localAppRuntime, paramFileManagerEntity);
            if (paramFileManagerEntity != null)
            {
