...
public class bdtx
  implements bfoq
{
  public bdtx(QidianProfileCardActivity paramQidianProfileCardActivity, String paramString) {}
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        if (this.jdField_a_of_type_ComTencentQidianQidianProfileCardActivity.jdField_a_of_type_Bdto.d(this.jdField_a_of_type_ComTencentQidianQidianProfileCardActivity.jdField_a_of_type_Auuw.a.jdField_a_of_type_JavaLangString)) {
