...
public class bcfh
  extends bceg
  implements DialogInterface.OnDismissListener, bcvg, bfve
{
  ...
  public bbjq a;
  private bcfn jdField_a_of_type_Bcfn;
  ...
  {
    if (paramInt == 1) {
      return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131720142, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131691306) });
    }
    if (paramInt == 3) {
      return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131720142, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131719516) });
    }
    if (paramInt == 10) {
      return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131720142, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131719511) });
    }
    if (paramInt == 12) {
      return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131720142, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131696713) });
    }
    return this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131720142, new Object[] { this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.getString(2131720657) });
  }
  
  private void a(int paramInt, String paramString)
  {
    bbdj.a(this.jdField_a_of_type_AndroidAppActivity, a(paramInt), 2131691902, 2131720896, new bcfk(this, paramInt, paramString), new bcfl(this, paramInt, paramString)).show();
  }
  
  private void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Xmq.p)) {
      this.jdField_a_of_type_Xmq.a(paramString1, 3, true);
    }
    for (;;)
    {
      axqy.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_40", "weixin_share", 0, 1, 0, "", "", "", "");
      if ((paramString2 != null) && (!"".equals(paramString2))) {
        nol.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1003, 0, paramString2, paramString4, paramString3, AccountDetailActivity.a(paramString3), false);
      }
      ...
      if (this.jdField_a_of_type_Xmq.a != null) {
      ...
      try
      {
        ...
        label159:
        aaep.b(this.jdField_a_of_type_Xmq.a, localJSONObject);
        this.jdField_a_of_type_Xmq.a(paramString1, 3, true);
      }
  ...
  private void b(String paramString)
  {
    ...
    wij.a(2, 2131691309);
    if ((this.i) && (!TextUtils.isEmpty(this.jdField_a_of_type_Xmq.p))) {
  ...
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Xmq.p)) {
      this.jdField_a_of_type_Xmq.a(paramString, 8, false);
    }
    for (;;)
    {
      String str = this.jdField_f_of_type_JavaLangString;
      if (this.jdField_a_of_type_Bceh.a() != null) {
        str = this.jdField_a_of_type_Bceh.a().getUrl();
      }
      paramString = "";
      ...
      nol.a(null, "", "0X800787A", "0X800787A", 0, 0, (String)localObject, str, "", "");
      sgg.a(1005, str, this.jdField_e_of_type_Int);
      return;
      this.jdField_a_of_type_Xmq.a(paramString, 8, false);
    }
  }
  ...
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Xmq.p)) {
      this.jdField_a_of_type_Xmq.a(paramString, 4, true);
    }
    for (;;)
    {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_Bceh.a().loadUrl("javascript:" + str + ";");
  }
  
  private void e(String paramString)
  {
    if (!TextUtils.isEmpty(this.jdField_a_of_type_Xmq.p)) {
      this.jdField_a_of_type_Xmq.a(paramString, 2, false);
    }
    for (;;)
    {
      ...
      try
      {
        ...
        label120:
        aaep.b(this.jdField_a_of_type_Xmq.a, paramString);
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Bbjq != null) {
        this.jdField_a_of_type_Bbjq.g();
      }
    } while ((this.jdField_a_of_type_Qzu == null) || (!this.jdField_a_of_type_Qzu.a()));
  ...
  public void a(int paramInt, bbjs parambbjs)
  {
    ...
    if ((paramInt == 72) && (parambbjs != null))
    {
      localBundle.putString("to_qq", parambbjs.jdField_c_of_type_JavaLangString);
      localBundle.putString("to_uin_name", parambbjs.jdField_a_of_type_JavaLangString);
      localBundle.putInt("to_uin_type", parambbjs.f);
    }
        ...
        catch (Exception localException)
        {
          ...
          try
          {
            ...
            if (m != 0)
            {
              ...
              localObject1 = bdik.b(paramString + 200 + (String)localObject2 + "jubao@article@123");
              ...
              nol.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1008, 0, str4, str2, str3, AccountDetailActivity.a(str3), false);
            }
          }
          ...
          if (this.jdField_a_of_type_Bcfn == null) {
            continue;
          }
          this.jdField_a_of_type_Bcfn.a(paramString);
          continue;
          if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) {
            continue;
          }
          throw new InvalidParameterException("ACTION_REFRESH_FREIEND_VIEW should be handled by QQBrowserActivity!");
          paramBundle = (bcfo)this.jdField_a_of_type_Bceh.a().a(-2);
          ...
          boolean bool = true;
          this.jdField_a_of_type_Xmq.g = bool;
          if (!QLog.isColorLevel()) {
            continue;
          }
          QLog.d("SwiftBrowserShareMenuHandler", 2, new Object[] { "ShareArkFromH5 mShare.isShareArk=", Boolean.valueOf(this.jdField_a_of_type_Xmq.g), ",\n shareUrl=", nau.b(paramString, new String[0]) });
          ...
          try
          {
            ...
            axqy.b(null, "P_CliOper", "VIPCOMIC", "", "0X800619F", "0X800619F", 1000, 0, nau.b(str3, new String[0]), null, null, null);
            axqy.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_48", "browser_share", 0, 1, 0, "", "", "", "");
            if ((str4 == null) || ("".equals(str4))) {
              continue;
            }
            nol.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1006, 0, str4, str2, str3, AccountDetailActivity.a(str3), false);
          }
          ...
          paramString = (bcfs)this.jdField_a_of_type_Bceh.a().a(16);
          if (paramString == null) {
            continue;
          }
          paramString.a("http://appchannel.html5.qq.com/directdown?app=qqbrowser&channel=10367", true);
          axqy.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_46", "qqbrowser_share", 0, 1, 0, "", "", "", "");
          axqy.b(null, "P_CliOper", "VIPCOMIC", "", "0X80061A0", "0X80061A0", 1000, 0, nau.b(str3, new String[0]), null, null, null);
          if ((str4 == null) || ("".equals(str4))) {
            continue;
          }
          nol.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1005, 0, str4, str2, str3, AccountDetailActivity.a(str3), false);
          continue;
          ...
          sgg.a(1002, (String)localObject1, this.jdField_e_of_type_Int);
          if ((this.jdField_a_of_type_Xmq.a() == null) || (this.jdField_a_of_type_Xmq.a().jdField_a_of_type_Int != 0)) {
            continue;
          }
          ...
          if (!this.jdField_a_of_type_Xmq.a(paramString)) {
            continue;
          }
          this.jdField_a_of_type_Xmq.a(paramString, 9, false);
          if ((str4 == null) || ("".equals(str4))) {
            continue;
          }
          nol.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1007, 0, str4, str2, str3, AccountDetailActivity.a(str3), false);
          continue;
          ...
          sgg.a(1003, (String)localObject1, this.jdField_e_of_type_Int);
          ...
          wij.a(0, m);
          continue;
          sgg.a(1004, (String)localObject1, this.jdField_e_of_type_Int);
          continue;
          ...
          this.jdField_a_of_type_Xmq.a().show();
          ...
          this.jdField_a_of_type_Xmq.a(paramString, 5, true);
          continue;
          if (paramInt != 15) {
            continue;
          }
          ...
          return;
          a().a(n, new bcfi(this));
          axqy.b(null, "P_CliOper", "Grp_open", "", "third_app", "add_menu", 0, 1, 0, "" + m, "" + n, "", "");
          continue;
          if (paramInt != 16) {
            continue;
          }
          ...
          axqy.b(null, "P_CliOper", "Grp_open", "", "third_app", "detail_menu", 0, 1, 0, "" + m, "" + n, "", "");
          continue;
          if (paramInt != 17) {
            continue;
          }
          ...
          paramBundle.putExtra("hide_more_button", true);
          this.jdField_a_of_type_AndroidAppActivity.startActivity(paramBundle);
          axqy.b(null, "P_CliOper", "Grp_open", "", "third_app", "share_menu", 0, 1, 0, "" + m, "" + n, "", "");
          continue;
          if (paramInt != 18) {
            continue;
          }
          ...
          paramString = (bcfo)this.jdField_a_of_type_Bceh.a().a(-2);
          ...
          this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_a_of_type_Bcfo.h = false;
          ...
          axqy.b(null, "P_CliOper", "Grp_open", "", "third_app", "refresh_menu", 0, 1, 0, "" + m, "" + n, "", "");
          continue;
          ...
          this.jdField_a_of_type_Xmq.a(paramString, m, false);
          continue;
          m = 7;
          continue;
          this.jdField_a_of_type_Xmq.a(paramString, m, true);
          continue;
          if (paramInt != 21) {
            continue;
          }
          paramString = (bcfc)this.jdField_a_of_type_Bceh.a().a(64);
          if (paramString == null) {
            continue;
          }
          ...
          paramBundle = "";
          nol.a(null, "", "0X8007071", "0X8007071", 0, 0, paramBundle, "", "", "");
          nol.a("0X8007071", "", paramBundle, "", "", "");
          continue;
          if (paramInt != 12) {
            continue;
          }
          ...
          paramString = (nnr)((Iterator)localObject1).next();
          ...
          paramBundle = "";
          ayee.a(paramString, paramBundle);
          continue;
          m = 1;
          continue;
          paramBundle = this.jdField_a_of_type_Xmq.b();
          continue;
          if (paramInt != 70) {
            continue;
          }
          ...
          axqy.b(null, "dc00898", "", "", "0X800A9A4", "0X800A9A4", 0, 0, "1", "", "", "");
          bbaq.a(this.jdField_a_of_type_Bceh.a(), new bcfj(this));
          continue;
          l1 = 0L;
          continue;
          l1 = 0L;
  ...
  {
    ((bcfo)this.jdField_a_of_type_Bceh.a().a(-2)).jdField_a_of_type_Long = paramLong;
  }
  ...
  public void a(bbjs parambbjs, bcvf parambcvf)
  {
    ...
    a(parambbjs.jdField_c_of_type_Int, parambbjs);
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      sgg.a(1001, paramString3, this.jdField_e_of_type_Int);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Xmq.p)) {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          try
          {
            ...
            label138:
            aaep.b(this.jdField_a_of_type_Xmq.a, paramString2);
            this.jdField_a_of_type_Xmq.a(paramString1, 1, false);
          }
  ...
  public void a(xmq paramxmq, long paramLong)
  {
    if (paramxmq == null) {}
    label296:
    do
    {
      for (;;)
      {
        ...
        if ((this.jdField_a_of_type_AndroidAppActivity != null) && (!this.jdField_a_of_type_AndroidAppActivity.isFinishing()))
        {
          ...
          if (this.jdField_a_of_type_Bbjq == null)
          {
            this.jdField_a_of_type_Bbjq = new bbjq(this.jdField_a_of_type_AndroidAppActivity, false, 2);
            this.jdField_a_of_type_Bbjq.a(a());
          }
          paramxmq = null;
          localObject1 = (bcfc)this.jdField_a_of_type_Bceh.a().a(64);
          if (localObject1 != null) {
            paramxmq = ((bcfc)localObject1).a();
          }
          localObject1 = (bcfo)this.jdField_a_of_type_Bceh.a().a(-2);
          if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (localObject1 != null))
          {
            if (((bcfo)localObject1).m)
            {
              paramxmq = "<font color='#777777'>应用由 </font><font color='#00a5e0'>" + this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.o + "</font><font color='#777777'> 提供</font>";
              this.jdField_a_of_type_Bbjq.a(Html.fromHtml(paramxmq));
              axqy.b(null, "P_CliOper", "Grp_open", "", "third_app", "exp_menu", 0, 1, 0, "" + this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_j_of_type_Int, "" + this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.i, "", "");
            }
          }
          else
          {
          ...
          try
          {
            ...
            else
            {
              ...
              localObject2 = paramxmq;
              if (paramxmq == null) {
                localObject2 = "";
              }
              nol.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005F78", "0X8005F78", 0, 0, this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.jdField_j_of_type_JavaLangString, (String)localObject1, this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment.k, (String)localObject2, false);
              if (this.jdField_f_of_type_Boolean)
              {
                nol.a(null, "", "0X8008CAA", "0X8008CAA", 0, 0, "", "", "", "", false);
                return;
                if (!TextUtils.isEmpty(paramxmq))
                {
                  this.jdField_a_of_type_Bbjq.a(paramxmq);
                  break label296;
                }
    ...
    nol.a(null, "", "0X8008CAB", "0X8008CAB", 0, 0, "", "", "", "", false);
  }
  ...
  public boolean a()
  {
    ...
    if (((bcfx)this.jdField_a_of_type_Bceh.a().a(2)).a.jdField_e_of_type_Boolean) {
      return false;
    }
    if (this.jdField_a_of_type_Bceh.a() != null)
    {
      this.jdField_a_of_type_Bceh.a();
  ...
  public List<bbjs>[] a()
  {
    ...
    Object localObject1 = (bcfo)this.jdField_a_of_type_Bceh.a().a(-2);
    if ((this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment != null) && (localObject1 != null) && (((bcfo)localObject1).m))
    {
      localArrayList1.add(bbjs.a(15));
      localArrayList1.add(bbjs.a(16));
      localArrayList1.add(bbjs.a(17));
      localArrayList1.add(bbjs.a(18));
    ...
    {
      if ((localObject1 != null) && (!TextUtils.isEmpty(((AppRuntime)localObject1).getAccount())) && (this.h) && (!sfk.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:diandian")) && (!TextUtils.isEmpty(this.jdField_a_of_type_Xmq.p))) {
        localArrayList1.add(bbjs.a(34));
      }
      ...
      if ((!sfk.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:qiDian")) && ((this.jdField_a_of_type_Long & 0x10) == 0L)) {
        bduf.a(this.jdField_a_of_type_AndroidAppActivity, localArrayList1);
      }
      ...
      if (this.k)
      {
        ...
        if ((localObject3 != null) && (((amgn)localObject3).a()) && (((amgn)localObject3).e()) && (!amhh.c((String)localObject2)))
        {
          boolean bool = ((amgn)localObject3).c();
          localObject3 = bbjs.a(70);
          localObject2 = BaseApplicationImpl.getApplication();
          if (bool) {
            break label983;
          }
          m = 2131719455;
          ((bbjs)localObject3).jdField_a_of_type_JavaLangString = ((BaseApplicationImpl)localObject2).getString(m);
          if (bool) {
            break label990;
          }
          m = 2130845393;
          label816:
          ((bbjs)localObject3).jdField_b_of_type_Int = m;
          if (bfwr.a())
          {
            if (bool) {
              break label997;
          ...
          label851:
          ((bbjs)localObject3).jdField_d_of_type_JavaLangString = ((String)localObject2);
      ...
      if ((this.jdField_e_of_type_Boolean) && (this.jdField_b_of_type_JavaUtilArrayList != null))
      {
        ...
        for (;;)
        {
          ...
          localObject3 = (nnr)((Iterator)localObject2).next();
          localbbjs = bbjs.a(30);
      ...
      if ((this.jdField_f_of_type_Boolean) && (this.jdField_b_of_type_JavaUtilArrayList != null))
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          case 3: 
            localArrayList2.add(bbjs.a(35));
          }
        }
      }
      localObject2 = (bcfc)this.jdField_a_of_type_Bceh.a().a(64);
      if ((localObject2 != null) && (((bcfc)localObject2).a()) && (!sfk.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:screenShotShare"))) {
        localArrayList2.add(bbjs.a(21));
      }
      if ((localObject1 != null) && (!TextUtils.isEmpty(((AppRuntime)localObject1).getAccount())) && (!sfk.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:favorite")) && ((this.jdField_a_of_type_Long & 0x2000) == 0L)) {
        localArrayList2.add(bbjs.a(6));
      }
      if ((localObject1 != null) && (!TextUtils.isEmpty(((AppRuntime)localObject1).getAccount())) && (!sfk.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:exportTencentDocs")) && ((((bcfx)this.jdField_a_of_type_Bceh.a().a(2)).a.jdField_b_of_type_Long & 0x4000) == 0L))
      {
        localObject2 = a();
        localObject1 = localObject2;
      ...
      if ((!sfk.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:setFont")) && (!this.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_Boolean)) {
        localArrayList2.add(bbjs.a(7));
      }
      if ((!sfk.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:copyUrl")) && ((this.jdField_a_of_type_Long & 0x20) == 0L)) {
        localArrayList2.add(bbjs.a(1));
      }
      if (((TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString)) || (!"docs.qq.com".equals(Uri.parse(this.jdField_f_of_type_JavaLangString).getHost()))) && (!sfk.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:screenLongShotShare")) && ((this.jdField_a_of_type_Long & 0x8000) == 0L) && (this.jdField_a_of_type_Bceh != null) && (this.jdField_a_of_type_Bceh.a() != null) && (this.jdField_a_of_type_Bceh.a().getX5WebViewExtension() != null)) {
        localArrayList2.add(bbjs.a(71));
      }
  ...
  {
    if ((this.jdField_a_of_type_Bceh.a() == null) || (this.jdField_d_of_type_Boolean)) {
      return;
    }
    this.jdField_b_of_type_Int = paramInt;
    paramInt = jdField_a_of_type_ArrayOfInt[paramInt];
    this.jdField_a_of_type_Bceh.a().getSettings().setTextZoom(paramInt);
  }
  ...
  public void c()
  {
    this.jdField_a_of_type_Qzu = new qzw(this.jdField_a_of_type_AndroidAppActivity.getLayoutInflater()).a(this).a(this.jdField_b_of_type_Int).a().a(this.jdField_a_of_type_Bceh.a());
  }
