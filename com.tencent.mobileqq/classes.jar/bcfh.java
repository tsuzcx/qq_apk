  ...
  extends amab
{
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    ...
    bcfc.a(this.a).a(paramInt1, paramInt2);
  }
  ...
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    ...
    label123:
    bcfc.a(this.a).a(paramInt1, paramInt2, paramString);
  }
  ...
  protected void a(boolean paramBoolean, long paramLong, int paramInt1, TroopInfo paramTroopInfo, int paramInt2, String paramString)
  {
    ...
    bcfc.a(this.a).a(paramBoolean, paramLong, paramTroopInfo);
  }
  
  protected void a(boolean paramBoolean, long paramLong, RespBatchProcess paramRespBatchProcess)
  {
    if ((paramRespBatchProcess == null) || (paramRespBatchProcess.batch_response_list == null) || (paramRespBatchProcess.batch_response_list.size() == 0) || (bcfc.a(this.a) == null)) {}
    int j;
    do
    {
      do
      {
        ...
        {
          return;
        } while ((!String.valueOf(paramLong).equals(bcfc.a(this.a).troopUin)) || (bcfc.a(this.a) == null) || (bcfc.a(this.a) == null));
        if (bcfc.a(this.a).a != null) {
          bcfc.a(this.a).a.setCompoundDrawablesWithIntrinsicBounds(null, null, null, null);
        }
      } while (!String.valueOf(paramLong).equals(bcfc.a(this.a).troopUin));
      ...
      if (i < j)
      {
        ...
        for (;;)
        {
          ...
          if (localBatchResponse.type == 1) {
            bcfc.a(this.a, localBatchResponse);
          }
        }
      }
    } while (j <= 0);
  ...
  protected void a(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, List<TroopClipPic> paramList)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((!paramBoolean) || (!bdal.a(paramString1, bcfc.a(this.a).troopUin)));
      if (paramInt1 == 0)
      {
    ...
    if ((paramInt1 == 1) || (paramInt1 == 2)) {
      paramString2 = bcfc.a(this.a).getString(2131696542);
    }
    for (;;)
    {
      bcfc.a(this.a).a(paramString2);
      return;
      if (paramInt1 == 19) {
        paramString2 = bcfc.a(this.a).getString(2131696540);
      } else if (paramInt1 == 65) {
        paramString2 = bcfc.a(this.a).getString(2131696541);
      }
    }
  }
  ...
  protected void b(boolean paramBoolean, long paramLong1, int paramInt1, List<oidb_0x899.memberlist> paramList, long paramLong2, int paramInt2, String paramString)
  {
    ...
    if (paramInt1 != 2) {}
    while ((!paramBoolean) || (bcfc.a(this.a) == null) || (paramList == null) || (paramList.isEmpty())) {
      return;
    }
    bcfc.a(this.a).a(paramLong1, paramList);
  }
  ...
  {
    if ((bcfc.a(this.a) == null) || (bcfc.a(this.a) == null)) {}
    while (!bdal.a(paramString1, bcfc.a(this.a).troopUin)) {
      return;
    }
    if (paramInt1 == 0)
    {
    ...
    if (TextUtils.isEmpty(paramString2))
    {
      ...
      paramString1 = bcfc.a(this.a).getString(2131696542);
    }
    for (;;)
    {
      bcfc.a(this.a).a(paramString1);
      return;
      label106:
      if (paramInt1 == 2) {
        paramString1 = bcfc.a(this.a).getString(2131696540);
      } else if (paramInt1 == 3) {
        paramString1 = bcfc.a(this.a).getString(2131696553);
      } else if (paramInt1 == 4) {
        paramString1 = bcfc.a(this.a).getString(2131696554);
      } else {
        paramString1 = bcfc.a(this.a).getString(2131696551);
      }
    }
  }
  ...
  {
    if ((paramBoolean) && (bcfc.a(this.a) != null)) {
      bcfc.a(this.a).c(paramString);
    }
  }
  
  protected void c(boolean paramBoolean, String paramString, int paramInt)
  {
    if ((paramBoolean) && (bcfc.a(this.a) != null) && (paramString.equals(bcfc.a(this.a).troopUin))) {
      this.a.a = paramInt;
    }
  }
}
