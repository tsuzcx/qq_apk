...
public class apji
{
  ...
  private apjo jdField_a_of_type_Apjo;
  public apjp a;
  ...
  public apji()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$OnLocationListener = new apjm(this, 0, true, true, 3000L, true, false, "QQARScan");
  }
  ...
  private void a(int paramInt, apki paramapki)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqArModelArLBSActivity = apki.a(this.jdField_a_of_type_ComTencentMobileqqArAidlARCommonConfigInfo.recognitions, paramapki);
    if (Build.VERSION.SDK_INT >= 23)
    {
      if (((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.ACCESS_FINE_LOCATION") != 0)
      {
        ...
        ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).requestPermissions(new apjn(this), 1, new String[] { "android.permission.ACCESS_COARSE_LOCATION", "android.permission.ACCESS_FINE_LOCATION" });
        return;
      }
  ...
  private void a(apkn paramapkn)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      this.jdField_a_of_type_Apiu.a(paramapkn, new apjl(this, l1, paramapkn));
      return;
    }
  }
  ...
  private void a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Apiu != null)
    {
      ...
      this.jdField_a_of_type_Apiu.a(paramString, paramInt1, paramInt2, new apjj(this));
    }
  }
  ...
  private void a(byte[] paramArrayOfByte, ArrayList<ARRecognition> paramArrayList)
  {
    if (this.jdField_a_of_type_Apkb != null)
    {
      ...
      this.jdField_a_of_type_Apkb.a(paramArrayOfByte, paramArrayList, new apjk(this, localapkn), this.jdField_b_of_type_Int, this.jdField_c_of_type_Int, this.jdField_a_of_type_Int);
    }
  }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    long l1;
    if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Apjp != null))
    {
      l1 = System.currentTimeMillis();
      bool1 = this.jdField_a_of_type_Apjp.a(paramArrayOfByte);
      this.jdField_b_of_type_Boolean = false;
      this.jdField_a_of_type_Apjo.c(bool1);
      QLog.i("AREngine_ARCloudControl", 1, "isSameSceneWithBestImg = " + bool1 + " cost time:" + (System.currentTimeMillis() - l1) + "ms");
    }
    if ((!this.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_Apjp == null)) {
      return;
    }
    ...
    if (this.jdField_a_of_type_Apjo != null) {
      this.jdField_a_of_type_Apjo.b();
    }
    this.jdField_c_of_type_Long = System.currentTimeMillis();
    boolean bool1 = this.jdField_a_of_type_Apjp.a(paramArrayOfByte, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int);
    ...
    if (this.jdField_a_of_type_Apjo != null)
    {
      boolean bool2 = this.jdField_a_of_type_Apjo.a();
      l1 = this.jdField_a_of_type_Apjo.a();
      if ((bool1) && (!this.jdField_m_of_type_Boolean) && (bool2))
      {
        ...
        i1 = 0;
        bool1 = false;
        this.jdField_a_of_type_Apjo.a(bool1);
      }
    }
    for (;;)
    {
      ...
      {
        if (this.jdField_a_of_type_Apjo != null) {
          this.jdField_a_of_type_Apjo.b(true);
        }
        if ((!this.jdField_f_of_type_Boolean) && (this.jdField_a_of_type_Apjo != null))
        {
          l1 = this.jdField_a_of_type_Apjo.b();
          apho.a().a(l1, this.jdField_l_of_type_Long, this.jdField_m_of_type_Long, this.jdField_a_of_type_Apjp.jdField_c_of_type_Int);
          apba.a().a(l1, this.jdField_m_of_type_Long);
          this.jdField_f_of_type_Boolean = true;
        }
        a(new ARCloudControl.3(this, paramArrayOfByte));
        return;
        paramArrayOfByte = this.jdField_a_of_type_Apjp.a();
      }
      label675:
      i1 = 0;
      break;
  ...
  public boolean a(apjo paramapjo, AppInterface paramAppInterface, Activity paramActivity, int paramInt1, int paramInt2, int paramInt3, ARCommonConfigInfo paramARCommonConfigInfo)
  {
    long l2 = System.currentTimeMillis();
    jdField_k_of_type_Boolean = a();
    apmk.a().b(System.currentTimeMillis() - l2, jdField_k_of_type_Boolean);
    if (!jdField_k_of_type_Boolean) {
      return false;
    }
    this.jdField_a_of_type_Apjp = new apjp(apjp.jdField_b_of_type_Int);
    this.jdField_a_of_type_Apkb = new apkb();
    this.jdField_a_of_type_Apjp.a(BaseApplicationImpl.getContext().getApplicationContext());
    this.jdField_a_of_type_Apkb.a();
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_e_of_type_Int = paramInt1;
    this.jdField_d_of_type_Int = paramInt2;
    this.jdField_f_of_type_Int = paramInt3;
    this.jdField_a_of_type_Apjo = paramapjo;
    this.jdField_a_of_type_Apiu = new apiu(paramAppInterface, true);
    this.jdField_a_of_type_Apiu.a();
    ...
    for (long l1 = ARRecognition.a(this.jdField_a_of_type_ComTencentMobileqqArAidlARCommonConfigInfo.recognitions);; l1 = 0L)
    {
      ...
      apmk.a().c(System.currentTimeMillis() - l2, jdField_k_of_type_Boolean);
      return true;
    }
  }
  ...
  public void f()
  {
    ...
    if (this.jdField_a_of_type_Apjp != null)
    {
      this.jdField_a_of_type_Apjp.a();
      this.jdField_a_of_type_Apjp = null;
    }
    if (this.jdField_a_of_type_Apkb != null)
    {
      this.jdField_a_of_type_Apkb.b();
      this.jdField_a_of_type_Apkb = null;
    }
    this.jdField_a_of_type_Apjo = null;
