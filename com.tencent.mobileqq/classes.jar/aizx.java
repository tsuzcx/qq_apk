...
public class aizx
{
  public static SoConfig.SoInfo a(String paramString)
  {
    ...
    localBundle.putInt("call_type", azij.b);
  ...
  public static void a(LaunchParam paramLaunchParam, int paramInt, OnUpdateListener paramOnUpdateListener)
  {
    ...
    localBundle.putParcelable("receiver", aivz.a(new ComIPCUtils.1(null, paramOnUpdateListener)));
    QIPCClientHelper.getInstance().callServer("QWalletIPCModule", "ComIPCUtils", localBundle, null);
  }
  ...
  public static void a(String paramString, aith paramaith)
  {
    ...
    localBundle.putInt("code", paramaith.hashCode());
    localBundle.putParcelable("receiver", aivz.a(new ComIPCUtils.2(null, paramaith, paramString)));
    QIPCClientHelper.getInstance().callServer("QWalletIPCModule", "ComIPCUtils", localBundle, null);
  }
