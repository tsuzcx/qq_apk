...
{
  private static volatile rjz jdField_a_of_type_Rjz;
  ...
  static
  {
    jdField_a_of_type_Rka = new rka(null);
  }
  
  private final long a()
  {
    return a().getLong(rlr.a("RIJ_REWARD_TASK_KEY_KEY_LAST_UPDATE_TS"), 0L);
  }
  ...
  {
    a().edit().putLong(rlr.a("RIJ_REWARD_TASK_KEY_KEY_LAST_UPDATE_TS"), paramLong).apply();
  }
  ...
  {
    return jdField_a_of_type_Rka.a();
  }
  ...
  public final int a()
  {
    ...
    return a().getInt(rlr.a("RIJ_REWARD_TASK_KEY_KEY_TASK_COMPLETED_COUNT"), 0);
  }
  
  @Nullable
  public final RIJRewardTask a()
  {
    return rlr.a("RIJ_REWARD_TASK_KEY_KEY_CURRENT_TASK");
  }
  ...
  {
    a().edit().putInt(rlr.a("RIJ_REWARD_TASK_KEY_KEY_TASK_COMPLETED_COUNT"), paramInt).apply();
  }
  
  public final void a(@Nullable RIJRewardTask paramRIJRewardTask)
  {
    rlr.a("RIJ_REWARD_TASK_KEY_KEY_CURRENT_TASK", paramRIJRewardTask);
  }
  ...
  public final int b()
  {
    ...
    return a().getInt(rlr.a("RIJ_REWARD_TASK_KEY_KEY_TASK_PROGRESS_IN_MS"), 0);
  }
  
  @Nullable
  public final RIJRewardTask b()
  {
    return rlr.a("RIJ_REWARD_TASK_KEY_KEY_LAST_TASK");
  }
  
  public final void b(int paramInt)
  {
    a(NetConnInfoCenter.getServerTimeMillis());
    a().edit().putInt(rlr.a("RIJ_REWARD_TASK_KEY_KEY_TASK_PROGRESS_IN_MS"), paramInt).apply();
  }
  
  public final void b(@Nullable RIJRewardTask paramRIJRewardTask)
  {
    rlr.a("RIJ_REWARD_TASK_KEY_KEY_LAST_TASK", paramRIJRewardTask);
  }
}
