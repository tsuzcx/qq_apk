...
public class aigt
{
  ...
  public static int a(@NonNull String paramString)
  {
    try
    {
      ...
      {
        jdField_a_of_type_Int = bhhr.b(paramString);
  ...
  @Nullable
  public static aigv a(String paramString)
  {
    return (aigv)bhdb.a("StickerBubbleGifCache_" + paramString);
  }
  
  public static aigy a(int paramInt1, String paramString, int paramInt2, int[] paramArrayOfInt)
  {
    ...
    {
      return new aigy(paramArrayOfInt, paramString, bool, new aigp(d1, d2), new aigo(0.0D, 200.0D), 49);
      d1 = -jdField_a_of_type_JavaUtilRandom.nextInt(8000) + 4000;
      break;
    }
  }
  
  public static aigy a(@NonNull Point paramPoint, @NonNull String paramString, int paramInt)
  {
    ...
    {
      return new aigy(paramPoint, paramString, bool, new aigp(d1, d2), new aigo(0.0D, 200.0D), 85);
  ...
  public static Drawable a(@NonNull String paramString)
  {
    try
    {
      if (((!paramString.equals(jdField_a_of_type_JavaLangString)) || (jdField_a_of_type_AndroidGraphicsDrawableDrawable == null)) && (a(paramString) > 0)) {
        jdField_a_of_type_AndroidGraphicsDrawableDrawable = aigs.a(a(paramString));
      }
  ...
  public static void a(@NonNull aigr paramaigr, @NonNull String paramString)
  {
    try
    {
      jdField_a_of_type_Int = paramaigr.jdField_a_of_type_Int;
      jdField_a_of_type_AndroidGraphicsDrawableDrawable = aigs.a(jdField_a_of_type_Int);
      bhhr.b(paramaigr.jdField_a_of_type_Int, paramString);
      jdField_a_of_type_JavaLangString = paramString;
      return;
    }
    finally
  ...
  public static void a(String paramString, BitmapDrawable[] paramArrayOfBitmapDrawable, int paramInt)
  {
    if (a())
    {
      ...
      if (bhdb.a(str) == null) {
        bhdb.a(str, new aigv(paramString, paramArrayOfBitmapDrawable, paramInt));
      }
    }
  }
  ...
  public static int[] a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      paramQQAppInterface = ahcw.a(paramQQAppInterface, 7);
  ...
  public static aigy b(@NonNull Point paramPoint, @NonNull String paramString, int paramInt)
  {
    boolean bool = a(paramInt);
    double d1;
    if (bool)
    ...
    for (double d2 = -1000 - jdField_a_of_type_JavaUtilRandom.nextInt(500);; d2 = -2000 - jdField_a_of_type_JavaUtilRandom.nextInt(1000))
    {
      return new aigy(paramPoint, paramString, bool, new aigp(d1, d2), new aigo(0.0D, 200.0D), 81);
      d1 = -jdField_a_of_type_JavaUtilRandom.nextInt(6000) + 3000;
      break;
    }
  }
  ...
  public static void b(Object paramObject, View paramView)
  {
    ...
    if (jdField_a_of_type_AndroidViewAnimationAnimation == null)
    {
      ...
      jdField_a_of_type_AndroidViewAnimationAnimation.setAnimationListener(new aigu());
    }
    if (QLog.isColorLevel()) {
