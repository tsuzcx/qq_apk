...
public class bgut
{
  ...
  private bguw jdField_a_of_type_Bguw = new bguw();
  private Object jdField_a_of_type_JavaLangObject = new ReentrantLock();
  private Runnable jdField_a_of_type_JavaLangRunnable;
  String jdField_a_of_type_JavaLangString = null;
  private AtomicBoolean jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler;
  private WeakReference<bguy> jdField_a_of_type_MqqUtilWeakReference;
  boolean jdField_a_of_type_Boolean = true;
  private bguv[] jdField_a_of_type_ArrayOfBguv;
  ...
  public bgut(bguy parambguy, int paramInt)
  {
    this.jdField_a_of_type_MqqUtilWeakReference = new WeakReference(parambguy);
  ...
  private HttpURLConnection a(bgux parambgux)
  {
    Object localObject1 = parambgux.a();
    String str1 = (String)parambgux.jdField_a_of_type_JavaUtilHashMap.remove("mType");
    String str2;
    int i1;
    int k;
    int i;
    ...
    for (;;)
    {
      String str3 = bgva.b((String)localObject1);
      parambgux.jdField_e_of_type_Boolean = bgva.jdField_d_of_type_JavaLangString.equals(str3);
      if (!str3.equals(this.jdField_a_of_type_JavaLangString))
      {
        if ((j == 1) || (str3.equals(bgva.jdField_d_of_type_JavaLangString))) {
      ...
      for (int m = 1;; m = 0)
      {
        ...
        if ((!this.jdField_a_of_type_Boolean) && (m != 0)) {
          if ((str3.equals(bgva.jdField_d_of_type_JavaLangString)) || (str3.equals(bgva.jdField_f_of_type_JavaLangString)) || (str3.equals(bgva.h))) {
            if (!parambgux.jdField_f_of_type_Boolean) {
              switch (parambgux.jdField_h_of_type_Int)
              {
              default: 
                localObject1 = bgva.b(str1, str2, i1);
                i = 1;
                a((HttpURLConnection)localObject1, parambgux);
                parambgux.jdField_d_of_type_Int = j;
                i2 = bdwu.a().a();
                if (parambgux.jdField_a_of_type_Bdxx == null)
                {
                  localObject3 = bdxr.a(i2);
                  n = ((bdxu)localObject3).a();
                  if ("POST".equals(parambgux.e())) {
                    j = 89500;
                  }
                }
                break;
        ...
        for (;;)
        {
          ...
          a(parambgux, "gettingConn", "getConnection type:" + i2 + " activeNetworkInfo: " + localObject2 + " defaultHost:" + str2 + " defaultPort: " + i1 + " last apnType:" + this.jdField_a_of_type_JavaLangString + " forceDirect:" + this.jdField_a_of_type_Boolean + ",connectTimeOut:" + n + ",readTimeout:" + j);
          ((HttpURLConnection)localObject1).setInstanceFollowRedirects(false);
          localObject2 = parambgux.jdField_a_of_type_JavaUtilHashMap.entrySet().iterator();
          ...
          i = 0;
          break label285;
          localObject1 = bgva.a(str1, str2, i1);
          i = 1;
          break label285;
          localObject1 = bgva.b(str1, str2, i1);
          i = 1;
          break label285;
          if (str3.equals(bgva.b))
          {
            localObject1 = bgva.a(str1, str2, i1);
            i = 1;
            break label285;
          ...
          i = 0;
          break label285;
          j = ((bdxu)localObject3).b();
          continue;
          n = parambgux.jdField_a_of_type_Bdxx.b(i2);
          j = parambgux.jdField_a_of_type_Bdxx.a(i2);
        }
        if (parambgux.e().equals("POST"))
        {
          ((HttpURLConnection)localObject1).setDoOutput(true);
          if (parambgux.b() != null) {
            ((HttpURLConnection)localObject1).setFixedLengthStreamingMode(parambgux.b().length);
          }
        }
        parambgux.jdField_c_of_type_JavaLangString = ((HttpURLConnection)localObject1).getRequestProperties().toString();
        try
        {
  ...
  private void a(bgux parambgux1, bgux parambgux2, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.d("SSCM", 2, "msg statuschanged: " + paramInt);
    }
    parambgux1.a().a(parambgux1, parambgux2, paramInt);
  }
  
  private void a(HttpURLConnection paramHttpURLConnection, bgux parambgux)
  {
    String str;
    bguu localbguu;
    if ((parambgux.i) && ((paramHttpURLConnection instanceof HttpsURLConnection)))
    {
      paramHttpURLConnection = (HttpsURLConnection)paramHttpURLConnection;
      str = parambgux.jdField_e_of_type_JavaLangString;
      localbguu = new bguu(this, str, parambgux);
      if (parambgux.j)
      {
        paramHttpURLConnection.setRequestProperty("host", str);
        paramHttpURLConnection.setSSLSocketFactory(new bgvb(str, localbguu));
        paramHttpURLConnection.setHostnameVerifier(localbguu);
      }
    }
    else
    {
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      if (this.jdField_a_of_type_Bguw.a() > 0) {
        return false;
      }
    }
    if ((this.jdField_a_of_type_ArrayOfBguv == null) || (this.jdField_a_of_type_ArrayOfBguv.length == 0)) {
      return false;
    }
    if (this.e > 0) {
      return false;
    }
    bguv[] arrayOfbguv = this.jdField_a_of_type_ArrayOfBguv;
    int k = arrayOfbguv.length;
    int i = 0;
    for (;;)
    {
      if (i < k)
      {
        bguv localbguv = arrayOfbguv[i];
        if ((localbguv != null) && (localbguv.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean != null) && (localbguv.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())) {
          return false;
        }
      }
      else
      {
        if (paramBoolean)
        {
          ...
          arrayOfbguv = this.jdField_a_of_type_ArrayOfBguv;
          k = arrayOfbguv.length;
          i = j;
          while (i < k)
          {
            arrayOfbguv[i].sendEmptyMessage(1);
            i += 1;
          }
          this.e = 0;
          this.jdField_d_of_type_Int = 0;
          this.jdField_b_of_type_Boolean = false;
          this.jdField_a_of_type_ArrayOfBguv = null;
        }
        return true;
      }
      i += 1;
  ...
  public int a(bgux parambgux)
  {
    ...
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      if ((parambgux != null) && (parambgux.a() != null))
      {
        parambgux.a(9366, -1, "close");
        parambgux.a().b(parambgux, parambgux);
        k = i;
        return k;
      }
    }
    ...
    for (;;)
    {
      try
      {
        if (this.jdField_a_of_type_Bguw.a() < k)
        {
          i = this.jdField_a_of_type_Int + 1;
          this.jdField_a_of_type_Int = i;
          parambgux.a(i);
          parambgux.jdField_e_of_type_Long = SystemClock.uptimeMillis();
          this.jdField_a_of_type_Bguw.a(parambgux);
          parambgux.a().a(parambgux, null, 0);
  ...
  public String a()
  {
    if (this.jdField_a_of_type_Bguw != null) {
      return this.jdField_a_of_type_Bguw.a();
    }
    return "";
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (this.jdField_a_of_type_ArrayOfBguv == null)
        {
          this.jdField_a_of_type_ArrayOfBguv = new bguv[4];
          if (i < 4)
          {
            HandlerThread localHandlerThread = ThreadManager.newFreeHandlerThread("httpcommunicator_norm_" + i, 5);
            localHandlerThread.start();
            this.jdField_a_of_type_ArrayOfBguv[i] = new bguv(this, localHandlerThread.getLooper());
            this.jdField_a_of_type_ArrayOfBguv[i].jdField_a_of_type_Int = i;
            i += 1;
            continue;
          }
        }
  ...
  void a(int paramInt, HttpURLConnection paramHttpURLConnection, bgux parambgux)
  {
    if ((paramHttpURLConnection == null) || (parambgux == null)) {
      return;
    }
    parambgux.c(paramInt);
    parambgux.b("Content-Type", paramHttpURLConnection.getContentType());
    parambgux.jdField_d_of_type_JavaLangString = paramHttpURLConnection.getHeaderFields().toString();
    if (paramHttpURLConnection.getHeaderField("User-ReturnCode") != null) {
      parambgux.b("User-ReturnCode", paramHttpURLConnection.getHeaderField("User-ReturnCode"));
    }
    if (paramHttpURLConnection.getHeaderField("X-User-ReturnCode") != null) {
      parambgux.b("X-User-ReturnCode", paramHttpURLConnection.getHeaderField("X-User-ReturnCode"));
    }
    if (paramHttpURLConnection.getHeaderField("content-range") != null) {
      parambgux.b("content-range", paramHttpURLConnection.getHeaderField("content-range"));
    }
    if (paramHttpURLConnection.getHeaderField("Range") != null) {
      parambgux.b("Range", paramHttpURLConnection.getHeaderField("Range"));
    }
    if (paramHttpURLConnection.getHeaderField("X-Range") != null) {
      parambgux.b("X-Range", paramHttpURLConnection.getHeaderField("X-Range"));
    }
    if (paramHttpURLConnection.getHeaderField("Content-Encoding") != null) {
      parambgux.b("Content-Encoding", paramHttpURLConnection.getHeaderField("Content-Encoding"));
    }
    if (paramHttpURLConnection.getHeaderField("Transfer-Encoding") != null) {
      parambgux.b("Transfer-Encoding", paramHttpURLConnection.getHeaderField("Transfer-Encoding"));
    }
    if (paramHttpURLConnection.getHeaderField("X-RtFlag") != null) {
      parambgux.b("X-RtFlag", paramHttpURLConnection.getHeaderField("X-RtFlag"));
    }
    if (paramHttpURLConnection.getHeaderField("X-httime") != null) {
      parambgux.b("X-httime", paramHttpURLConnection.getHeaderField("X-httime"));
    }
    if (paramHttpURLConnection.getHeaderField("X-piccachetime") != null) {
      parambgux.b("X-piccachetime", paramHttpURLConnection.getHeaderField("X-piccachetime"));
    }
    parambgux.jdField_a_of_type_Long = -1L;
    ...
    for (;;)
    {
      try
      {
        parambgux.jdField_a_of_type_Long = Long.valueOf(str.substring(i + 1)).longValue();
        parambgux.jdField_b_of_type_Long = paramHttpURLConnection.getContentLength();
        a(parambgux, "copyRespHeader", "resultCode:" + paramInt + " totalLen:" + parambgux.jdField_a_of_type_Long + ",totalBlockLen:" + parambgux.jdField_b_of_type_Long);
        return;
      }
      catch (Exception localException)
      {
      ...
      parambgux.jdField_a_of_type_Long = paramHttpURLConnection.getContentLength();
      parambgux.jdField_b_of_type_Long = parambgux.jdField_a_of_type_Long;
    }
  }
  ...
  void a(long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      bctj.a(BaseApplication.getContext()).a(null, "LongHttpRespTime", false, paramLong, 0L, localHashMap, "");
      return;
      i = j;
    }
  }
  
  public void a(bguv parambguv)
  {
    if (this.jdField_c_of_type_Boolean) {}
    int i;
    do
    {
      ...
      {
        return;
      } while (parambguv == null);
      parambguv.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
      i = parambguv.jdField_a_of_type_Int;
      if ((i >= 0) && (i < 4))
      {
        ??? = new HandlerThread("httpcommunicator_norm_new_" + i, 5);
        ((HandlerThread)???).start();
        bguv localbguv = new bguv(this, ((HandlerThread)???).getLooper());
        localbguv.jdField_a_of_type_Int = i;
        synchronized (this.jdField_a_of_type_JavaLangObject)
        {
          this.jdField_a_of_type_ArrayOfBguv[i] = localbguv;
          if (parambguv.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) {
            this.e -= 1;
          }
  ...
  void a(bguv parambguv, bgux parambgux)
  {
    if ((!this.jdField_b_of_type_Boolean) && (!parambgux.l)) {
      throw new IOException("httpcommunicator closed");
    }
    if (parambgux.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) {
      throw new IOException("request cancelled");
    }
    if ((parambguv != null) && (parambguv.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())) {
      throw new RuntimeException("thread should close");
    }
    if (parambgux.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
      a(parambgux, "interrupt", "preempted");
  ...
  /* Error */
  public void a(bgux parambgux, bguv parambguv)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokevirtual 386	bgux:a	()Lbguz;
    //   4: astore 30
    //   6: aconst_null
    //   7: astore 23
    //   9: aconst_null
    ...
    //   43: aconst_null
    //   44: iconst_1
    //   45: invokespecial 673	bgut:a	(Lbgux;Lbgux;I)V
    //   48: iconst_0
    //   49: istore 5
    //   51: iconst_0
    //   52: istore 10
    ...
    //   59: ldc_w 675
    //   62: ldc_w 487
    //   65: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   68: aload_0
    //   69: aload_2
    //   70: aload_1
    //   71: invokevirtual 677	bgut:a	(Lbguv;Lbgux;)V
    //   74: aload_0
    //   75: aload_1
    //   76: invokespecial 679	bgut:a	(Lbgux;)Ljava/net/HttpURLConnection;
    //   79: astore 25
    //   81: aload 25
    //   83: astore 23
    //   85: aload_1
    //   86: aload 23
    //   88: putfield 682	bgux:jdField_a_of_type_JavaNetHttpURLConnection	Ljava/net/HttpURLConnection;
    //   91: aload_1
    //   92: invokestatic 471	android/os/SystemClock:uptimeMillis	()J
    //   95: putfield 684	bgux:jdField_c_of_type_Long	J
    //   98: aload_0
    //   99: aload_1
    //   100: ldc_w 686
    //   103: ldc_w 487
    //   106: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   109: iconst_1
    //   110: istore 10
    //   112: invokestatic 689	java/lang/System:currentTimeMillis	()J
    //   115: pop2
    //   116: aload_1
    //   117: invokevirtual 229	bgux:e	()Ljava/lang/String;
    //   120: ldc 227
    ...
    //   133: aload_1
    //   134: aload_2
    //   135: invokespecial 694	com/tencent/mobileqq/utils/httputils/HttpCommunicator$1:<init>	(Lbgut;Lbgux;Lbguv;)V
    //   138: astore 25
    //   140: aload_0
    //   141: getfield 378	bgut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   144: aload 25
    //   146: ldc2_w 608
    //   149: invokevirtual 698	mqq/os/MqqHandler:postDelayed	(Ljava/lang/Runnable;J)Z
    //   152: pop
    //   153: aload_1
    //   154: invokevirtual 352	bgux:b	()[B
    //   157: astore 31
    //   159: aload 23
    ...
    //   193: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   196: iconst_0
    //   197: istore 4
    //   199: iload 4
    //   201: aload 31
    ...
    //   208: aload_2
    //   209: aload_1
    //   210: invokevirtual 677	bgut:a	(Lbguv;Lbgux;)V
    //   213: aload 24
    //   215: aload 31
    //   217: iload 4
    //   219: sipush 10240
    ...
    //   251: ifnull +13 -> 264
    //   254: aload_2
    //   255: getfield 633	bguv:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   266: ldc_w 723
    //   269: ldc_w 487
    //   272: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   275: aload 23
    ...
    //   310: aload_2
    //   311: aload_1
    //   312: invokevirtual 677	bgut:a	(Lbguv;Lbgux;)V
    //   315: aload 23
    ...
    //   325: aload 23
    //   327: aload_1
    //   328: invokevirtual 738	bgut:a	(ILjava/net/HttpURLConnection;Lbgux;)V
    //   331: aload_2
    //   332: ifnull +234 -> 566
    //   335: aload_2
    //   336: getfield 633	bguv:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   390: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   393: aload_2
    //   394: ifnull +13 -> 407
    //   397: aload_2
    //   398: getfield 633	bguv:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   425: aload_1
    //   426: invokevirtual 748	bgux:d	()Ljava/lang/String;
    ...
    //   438: aload_1
    //   439: invokevirtual 752	bgux:c	()Ljava/lang/String;
    ...
    //   448: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   451: aload_0
    //   452: getfield 378	bgut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   455: ifnull +17 -> 472
    //   458: aload 25
    //   460: ifnull +12 -> 472
    //   463: aload_0
    //   464: getfield 378	bgut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   467: aload 25
    ...
    //   482: ifeq +27 -> 509
    //   485: aload_1
    //   486: invokevirtual 229	bgux:e	()Ljava/lang/String;
    //   489: ldc 227
    ...
    //   502: iload 10
    //   504: lload 12
    //   506: invokevirtual 755	bgut:a	(Lbgux;ZJ)V
    //   509: iconst_0
    //   510: ifeq +11 -> 521
    ...
    //   565: return
    //   566: aload_0
    //   567: getfield 378	bgut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   570: ifnull +17 -> 587
    //   573: aload 25
    //   575: ifnull +12 -> 587
    //   578: aload_0
    //   579: getfield 378	bgut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   582: aload 25
    ...
    //   613: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   616: iload 4
    //   618: sipush 302
    ...
    //   656: aload_1
    //   657: getfield 362	bgux:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   669: aload_1
    //   670: getfield 541	bgux:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   679: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   682: aload 23
    //   684: ldc_w 775
    ...
    //   714: ifne +380 -> 1094
    //   717: aload_1
    //   718: getfield 778	bgux:k	Z
    //   721: istore 11
    //   723: iload 11
    //   725: ifeq +369 -> 1094
    //   728: aload_1
    //   729: getfield 781	bgux:jdField_g_of_type_Boolean	Z
    //   732: ifeq +324 -> 1056
    //   735: aload_1
    //   736: invokevirtual 784	bgux:a	()Ljava/util/HashMap;
    //   739: ldc_w 408
    ...
    //   781: invokestatic 802	ayyp:a	(Ljava/lang/String;)Z
    //   784: istore 11
    //   786: iload 11
    //   788: ifne +306 -> 1094
    //   791: iload 4
    ...
    //   832: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   835: aload_2
    //   836: ifnull +13 -> 849
    //   839: aload_2
    //   840: getfield 633	bguv:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   867: aload_1
    //   868: invokevirtual 748	bgux:d	()Ljava/lang/String;
    ...
    //   880: aload_1
    //   881: invokevirtual 752	bgux:c	()Ljava/lang/String;
    ...
    //   890: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   893: aload_1
    //   894: getfield 804	bgux:jdField_f_of_type_Int	I
    //   897: sipush -9527
    ...
    //   921: aload_1
    //   922: getfield 362	bgux:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   934: aload_1
    //   935: getfield 541	bgux:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   944: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   947: aload_0
    //   948: getfield 378	bgut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   951: ifnull +17 -> 968
    //   954: aload 25
    //   956: ifnull +12 -> 968
    //   959: aload_0
    //   960: getfield 378	bgut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   963: aload 25
    ...
    //   978: ifeq +27 -> 1005
    //   981: aload_1
    //   982: invokevirtual 229	bgux:e	()Ljava/lang/String;
    //   985: ldc 227
    ...
    //   998: iload 10
    //   1000: lload 12
    //   1002: invokevirtual 755	bgut:a	(Lbgux;ZJ)V
    //   1005: iconst_0
    //   1006: ifeq +11 -> 1017
    ...
    //   1059: dup
    //   1060: aload_1
    //   1061: invokevirtual 120	bgux:a	()Ljava/lang/String;
    ...
    //   1085: ldc_w 808
    //   1088: ldc_w 810
    //   1091: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   1094: aload_1
    //   1095: invokevirtual 812	bgux:b	()Z
    //   1098: ifne +229 -> 1327
    //   1101: aload 30
    //   1103: aload 31
    ...
    //   1151: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   1154: aload_2
    //   1155: ifnull +13 -> 1168
    //   1158: aload_2
    //   1159: getfield 633	bguv:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   1186: aload_1
    //   1187: invokevirtual 748	bgux:d	()Ljava/lang/String;
    ...
    //   1199: aload_1
    //   1200: invokevirtual 752	bgux:c	()Ljava/lang/String;
    ...
    //   1209: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   1212: aload_0
    //   1213: getfield 378	bgut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   1216: ifnull +17 -> 1233
    //   1219: aload 25
    //   1221: ifnull +12 -> 1233
    //   1224: aload_0
    //   1225: getfield 378	bgut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   1228: aload 25
    ...
    //   1243: ifeq +27 -> 1270
    //   1246: aload_1
    //   1247: invokevirtual 229	bgux:e	()Ljava/lang/String;
    //   1250: ldc 227
    ...
    //   1263: iload 10
    //   1265: lload 12
    //   1267: invokevirtual 755	bgut:a	(Lbgux;ZJ)V
    //   1270: iconst_0
    //   1271: ifeq +11 -> 1282
    ...
    //   1324: goto -63 -> 1261
    //   1327: aload_1
    //   1328: getfield 814	bgux:jdField_b_of_type_Boolean	Z
    //   1331: ifeq +12 -> 1343
    //   1334: aload 30
    //   1336: aload 31
    //   1338: invokeinterface 813 2 0
    //   1343: aload_1
    //   1344: getfield 816	bgux:jdField_h_of_type_Boolean	Z
    //   1347: ifne +14 -> 1361
    //   1350: aload_1
    //   1351: ldc_w 818
    //   1354: aload_1
    //   1355: invokevirtual 120	bgux:a	()Ljava/lang/String;
    //   1358: invokevirtual 820	bgux:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   1361: aload_1
    //   1362: aload 31
    //   1364: invokevirtual 821	bgux:a	(Ljava/lang/String;)V
    //   1367: aload_1
    //   1368: getfield 781	bgux:jdField_g_of_type_Boolean	Z
    //   1371: ifeq +56 -> 1427
    //   1374: aload 31
    ...
    //   1390: ldc_w 408
    //   1393: aload 22
    //   1395: invokevirtual 820	bgux:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   1398: aload_0
    //   1399: aload_1
    //   1400: ldc_w 769
    ...
    //   1424: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   1427: aload_1
    //   1428: ldc_w 830
    //   1431: invokevirtual 832	bgux:b	(Ljava/lang/String;)V
    //   1434: iload 5
    //   1436: iconst_1
    //   1437: iadd
    //   1438: istore 5
    ...
    //   1604: aload_1
    //   1605: aload 27
    //   1607: invokevirtual 848	bgut:a	(ZILjava/net/HttpURLConnection;Lbgux;Ljava/lang/Throwable;)V
    //   1610: iload 10
    //   1612: ifeq +46 -> 1658
    //   1615: iload_3
    //   1616: sipush 200
    ...
    //   1655: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   1658: aload_2
    //   1659: ifnull +13 -> 1672
    //   1662: aload_2
    //   1663: getfield 633	bguv:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   1690: aload_1
    //   1691: invokevirtual 748	bgux:d	()Ljava/lang/String;
    ...
    //   1703: aload_1
    //   1704: invokevirtual 752	bgux:c	()Ljava/lang/String;
    ...
    //   1713: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   1716: aload_1
    //   1717: getfield 804	bgux:jdField_f_of_type_Int	I
    //   1720: sipush -9527
    ...
    //   1744: aload_1
    //   1745: getfield 362	bgux:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   1757: aload_1
    //   1758: getfield 541	bgux:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   1767: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   1770: aload_0
    //   1771: getfield 378	bgut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   1774: ifnull +17 -> 1791
    //   1777: aload 23
    //   1779: ifnull +12 -> 1791
    //   1782: aload_0
    //   1783: getfield 378	bgut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   1786: aload 23
    ...
    //   1802: ifeq +27 -> 1829
    //   1805: aload_1
    //   1806: invokevirtual 229	bgux:e	()Ljava/lang/String;
    //   1809: ldc 227
    ...
    //   1822: iload 10
    //   1824: lload 12
    //   1826: invokevirtual 755	bgut:a	(Lbgux;ZJ)V
    //   1829: aload 24
    //   1831: ifnull +8 -> 1839
    //   1834: aload 24
    ...
    //   1878: ifnull +13 -> 1891
    //   1881: aload_2
    //   1882: getfield 633	bguv:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   1885: invokevirtual 438	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   1888: ifne -1335 -> 553
    //   1891: aload_1
    //   1892: getfield 652	bgux:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   1926: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   1929: return
    ...
    //   1996: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   1999: aload_2
    //   2000: ifnull +13 -> 2013
    //   2003: aload_2
    //   2004: getfield 633	bguv:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   2031: aload_1
    //   2032: invokevirtual 748	bgux:d	()Ljava/lang/String;
    ...
    //   2044: aload_1
    //   2045: invokevirtual 752	bgux:c	()Ljava/lang/String;
    ...
    //   2054: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   2057: iload_3
    //   2058: ifeq +57 -> 2115
    //   2061: aload_1
    //   2062: getfield 804	bgux:jdField_f_of_type_Int	I
    //   2065: sipush -9527
    ...
    //   2089: aload_1
    //   2090: getfield 362	bgux:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   2102: aload_1
    //   2103: getfield 541	bgux:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   2112: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   2115: aload_0
    //   2116: getfield 378	bgut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   2119: ifnull +17 -> 2136
    //   2122: aload 25
    //   2124: ifnull +12 -> 2136
    //   2127: aload_0
    //   2128: getfield 378	bgut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   2131: aload 25
    ...
    //   2147: ifeq +27 -> 2174
    //   2150: aload_1
    //   2151: invokevirtual 229	bgux:e	()Ljava/lang/String;
    //   2154: ldc 227
    ...
    //   2167: iload 10
    //   2169: lload 12
    //   2171: invokevirtual 755	bgut:a	(Lbgux;ZJ)V
    //   2174: aload 27
    //   2176: ifnull +8 -> 2184
    //   2179: aload 27
    ...
    //   2219: aconst_null
    //   2220: iconst_2
    //   2221: invokespecial 673	bgut:a	(Lbgux;Lbgux;I)V
    //   2224: iload 4
    //   2226: sipush 200
    ...
    //   2255: astore 22
    //   2257: aload_1
    //   2258: getfield 865	bgux:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   2261: ifnull +227 -> 2488
    //   2264: aload_1
    //   2265: getfield 865	bgux:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   2268: arraylength
    //   2269: ifle +219 -> 2488
    //   2272: aload 22
    ...
    //   2281: istore 7
    //   2283: aload_1
    //   2284: getfield 865	bgux:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   2287: arraylength
    //   2288: iconst_1
    //   2289: if_icmpne +105 -> 2394
    //   2292: aload_1
    //   2293: getfield 865	bgux:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   2296: iconst_0
    //   2297: aaload
    //   2298: ifnull +96 -> 2394
    //   2301: aload_1
    //   2302: getfield 865	bgux:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   2305: iconst_0
    //   2306: aaload
    ...
    //   2332: astore 28
    //   2334: aload_1
    //   2335: getfield 865	bgux:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   2338: astore 31
    //   2340: aload 31
    //   2342: arraylength
    //   2343: istore 5
    ...
    //   2391: goto -134 -> 2257
    //   2394: aload_1
    //   2395: getfield 865	bgux:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   2398: astore 29
    //   2400: aload 29
    //   2402: arraylength
    //   2403: istore 8
    ...
    //   2487: athrow
    //   2488: aload_1
    //   2489: getfield 567	bgux:jdField_a_of_type_Long	J
    //   2492: lconst_0
    //   2493: lcmp
    //   2494: ifne +26 -> 2520
    //   2497: aload_1
    //   2498: invokevirtual 229	bgux:e	()Ljava/lang/String;
    //   2501: ldc 227
    ...
    //   2538: aload_1
    //   2539: getfield 567	bgux:jdField_a_of_type_Long	J
    ...
    //   2548: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   2551: aload_1
    //   2552: getfield 684	bgux:jdField_c_of_type_Long	J
    //   2555: lconst_0
    //   2556: lcmp
    //   2557: ifeq +15 -> 2572
    //   2560: aload_1
    ...
    //   2564: aload_1
    //   2565: getfield 684	bgux:jdField_c_of_type_Long	J
    //   2568: lsub
    //   2569: putfield 887	bgux:jdField_d_of_type_Long	J
    //   2572: aload 30
    //   2574: aload_1
    //   2575: aload_1
    //   2576: iconst_3
    ...
    //   2611: astore 26
    //   2613: aload_1
    //   2614: getfield 901	bgux:jdField_d_of_type_Boolean	Z
    //   2617: ifeq +243 -> 2860
    //   2620: aload_1
    //   2621: invokevirtual 903	bgux:a	()Z
    //   2624: ifne +236 -> 2860
    //   2627: new 905	bgof
    //   2630: dup
    //   2631: aload 26
    //   2633: aload_1
    //   2634: getfield 567	bgux:jdField_a_of_type_Long	J
    //   2637: l2i
    //   2638: invokespecial 908	bgof:<init>	(Lcom/tencent/commonsdk/pool/ByteArrayPool;I)V
    //   2641: astore 26
    //   2643: aload_1
    //   2644: getfield 901	bgux:jdField_d_of_type_Boolean	Z
    //   2647: ifeq +282 -> 2929
    //   2650: aload 28
    //   2652: sipush 10240
    ...
    //   2716: aload_2
    //   2717: aload_1
    //   2718: invokevirtual 677	bgut:a	(Lbguv;Lbgux;)V
    //   2721: lload 14
    //   2723: iload 6
    //   2725: i2l
    //   2726: ladd
    ...
    //   2791: lstore 16
    //   2793: aload_1
    //   2794: invokevirtual 903	bgux:a	()Z
    //   2797: ifeq +142 -> 2939
    //   2800: iload 6
    //   2802: istore 7
    //   2804: lload 20
    ...
    //   2816: aload_1
    //   2817: aload 27
    //   2819: invokevirtual 918	bgux:a	([B)V
    //   2822: iload 6
    //   2824: istore 7
    //   2826: lload 20
    //   2828: lstore 18
    ...
    //   2987: lstore 16
    //   2989: aload_1
    //   2990: invokevirtual 903	bgux:a	()Z
    //   2993: ifeq +475 -> 3468
    //   2996: iload 5
    //   2998: ifle +91 -> 3089
    //   3001: iload_3
    ...
    //   3060: aload_1
    //   3061: aload 29
    //   3063: invokevirtual 918	bgux:a	([B)V
    //   3066: iload_3
    //   3067: istore 7
    //   3069: lload 14
    //   3071: lstore 18
    ...
    //   3101: lstore 16
    //   3103: aload_1
    //   3104: getfield 901	bgux:jdField_d_of_type_Boolean	Z
    //   3107: ifeq +24 -> 3131
    //   3110: iload_3
    //   3111: istore 7
    //   3113: lload 14
    ...
    //   3228: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   3231: aload_2
    //   3232: ifnull +13 -> 3245
    //   3235: aload_2
    //   3236: getfield 633	bguv:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   3263: aload_1
    //   3264: invokevirtual 748	bgux:d	()Ljava/lang/String;
    ...
    //   3276: aload_1
    //   3277: invokevirtual 752	bgux:c	()Ljava/lang/String;
    ...
    //   3286: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   3289: iload_3
    //   3290: ifeq +57 -> 3347
    //   3293: aload_1
    //   3294: getfield 804	bgux:jdField_f_of_type_Int	I
    //   3297: sipush -9527
    ...
    //   3321: aload_1
    //   3322: getfield 362	bgux:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   3334: aload_1
    //   3335: getfield 541	bgux:jdField_d_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   3344: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   3347: aload_0
    //   3348: getfield 378	bgut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   3351: ifnull +17 -> 3368
    //   3354: aload 25
    //   3356: ifnull +12 -> 3368
    //   3359: aload_0
    //   3360: getfield 378	bgut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   3363: aload 25
    ...
    //   3379: ifeq +27 -> 3406
    //   3382: aload_1
    //   3383: invokevirtual 229	bgux:e	()Ljava/lang/String;
    //   3386: ldc 227
    ...
    //   3399: iload 10
    //   3401: lload 12
    //   3403: invokevirtual 755	bgut:a	(Lbgux;ZJ)V
    //   3406: aload 27
    //   3408: ifnull +8 -> 3416
    //   3411: aload 27
    ...
    //   3536: invokevirtual 918	bgux:a	([B)V
    //   3539: iload_3
    //   3540: istore 7
    //   3542: lload 14
    //   3544: lstore 18
    ...
    //   3613: goto -2089 -> 1524
    //   3616: aload_1
    //   3617: getfield 186	bgux:jdField_e_of_type_Boolean	Z
    //   3620: ifeq +302 -> 3922
    //   3623: aload_1
    //   3624: getfield 200	bgux:jdField_h_of_type_Int	I
    //   3627: ifeq +295 -> 3922
    //   3630: aload_1
    //   3631: getfield 198	bgux:jdField_f_of_type_Boolean	Z
    //   3634: ifne +288 -> 3922
    //   3637: aload_0
    //   3638: aload_1
    //   3639: ldc_w 937
    //   3642: ldc_w 939
    //   3645: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   3648: aload_1
    //   3649: iconst_1
    //   3650: putfield 198	bgux:jdField_f_of_type_Boolean	Z
    //   3653: aload_0
    //   3654: aload_1
    //   3655: aload_2
    //   3656: invokevirtual 669	bgut:a	(Lbgux;Lbguv;)V
    ...
    //   3670: ldc_w 612
    //   3673: aload_1
    //   3674: getfield 200	bgux:jdField_h_of_type_Int	I
    ...
    //   3687: invokestatic 625	bctj:a	(Landroid/content/Context;)Lbctj;
    //   3690: aconst_null
    //   3691: ldc_w 941
    //   3694: iconst_0
    //   3695: lconst_0
    ...
    //   3697: aload 22
    //   3699: ldc_w 487
    //   3702: invokevirtual 630	bctj:a	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;)V
    //   3705: iload 4
    //   3707: sipush 200
    ...
    //   3746: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   3749: aload_2
    //   3750: ifnull +13 -> 3763
    //   3753: aload_2
    //   3754: getfield 633	bguv:jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    //   3781: aload_1
    //   3782: invokevirtual 748	bgux:d	()Ljava/lang/String;
    ...
    //   3794: aload_1
    //   3795: invokevirtual 752	bgux:c	()Ljava/lang/String;
    ...
    //   3804: invokevirtual 279	bgut:a	(Lbgux;Ljava/lang/String;Ljava/lang/String;)V
    //   3807: aload_0
    //   3808: getfield 378	bgut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   3811: ifnull +17 -> 3828
    //   3814: aload 25
    //   3816: ifnull +12 -> 3828
    //   3819: aload_0
    //   3820: getfield 378	bgut:jdField_a_of_type_MqqOsMqqHandler	Lmqq/os/MqqHandler;
    //   3823: aload 25
    ...
    //   3838: ifeq +27 -> 3865
    //   3841: aload_1
    //   3842: invokevirtual 229	bgux:e	()Ljava/lang/String;
    //   3845: ldc 227
    ...
    //   3858: iload 10
    //   3860: lload 12
    //   3862: invokevirtual 755	bgut:a	(Lbgux;ZJ)V
    //   3865: iconst_0
    //   3866: ifeq +11 -> 3877
    ...
    //   3927: aload 23
    //   3929: aload_1
    //   3930: invokevirtual 943	bgut:b	(ILjava/net/HttpURLConnection;Lbgux;)V
    //   3933: lconst_0
    //   3934: lstore 14
    //   3936: iconst_1
    //   3937: istore_3
    ...
    //   0	4985	0	this	bgut
    //   0	4985	1	parambgux	bgux
    //   0	4985	2	parambguv	bguv
    //   25	4948	3	i	int
    //   197	4726	4	j	int
    //   49	4932	5	k	int
    //   39	4416	6	m	int
    ...
    //   4790	73	29	localObject40	Object
    //   4	4082	30	localbguz	bguz
    //   157	2197	31	localObject41	Object
    // Exception table:
    //   from	to	target	type
  ...
  void a(bgux parambgux, String paramString1, String paramString2)
  {
    try
    {
      bdxz.a(bdxz.b(parambgux.jdField_c_of_type_Int), parambgux.e().equals("POST"), bdxz.c(parambgux.jdField_b_of_type_Int), parambgux.jdField_a_of_type_JavaLangString, paramString1, paramString2);
      return;
    }
    catch (OutOfMemoryError parambgux) {}
  }
  
  protected void a(bgux parambgux, boolean paramBoolean, long paramLong)
  {
    parambgux.jdField_g_of_type_Int = ((int)paramLong);
    int i = parambgux.jdField_b_of_type_Int;
    int j = parambgux.jdField_c_of_type_Int;
    int k = parambgux.jdField_d_of_type_Int;
    if (((i == -1) || (j == -1)) && (QLog.isColorLevel())) {
      QLog.e("flowstat", 2, "fileType:" + i + ",busiType:" + j);
    }
    if ((this.jdField_a_of_type_MqqUtilWeakReference != null) && (this.jdField_a_of_type_MqqUtilWeakReference.get() != null)) {
      ((bguy)this.jdField_a_of_type_MqqUtilWeakReference.get()).countFlow(paramBoolean, k, i, j, paramLong);
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.richmedia.HttpCommunicator", 2, "queueSize:" + this.jdField_a_of_type_Bguw.a() + " mConcurrentRunningMsgs:" + this.e + " mConcurrentLimit:" + this.jdField_d_of_type_Int + " reason:" + paramString + " tid:" + Thread.currentThread().getId());
      }
      if (this.jdField_a_of_type_Bguw.a() == 0) {
        return;
      }
    ...
    {
      paramString = this.jdField_a_of_type_Bguw.a(false);
      if (paramString != null)
      {
        arrayOfbguv = this.jdField_a_of_type_ArrayOfBguv;
        j = arrayOfbguv.length;
      }
    }
    for (;;)
    {
      ...
      if (i < j)
      {
        localbguv = arrayOfbguv[i];
        localbgux = localbguv.jdField_a_of_type_Bgux;
        if (localbguv.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) {
          break label268;
        }
        this.jdField_a_of_type_Bguw.a(paramString);
        paramString.b();
        localbguv.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
        localbguv.jdField_a_of_type_Bgux = paramString;
        localbguv.a(paramString);
        this.e += 1;
      ...
      for (;;)
      {
        return;
        label268:
        if ((!this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) || (!localbguv.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) || (localbgux == null) || (localbgux.b() <= paramString.b())) {
          break;
        }
        localbguv.a();
      }
  ...
  void a(boolean paramBoolean, int paramInt, HttpURLConnection paramHttpURLConnection, bgux parambgux, Throwable paramThrowable)
  {
    if ((paramThrowable instanceof IllegalArgumentException))
    {
      parambgux.a(9020, paramInt, paramThrowable.toString());
      return;
    }
    if ((paramThrowable instanceof IllegalStateException))
    {
      parambgux.a(9057, paramInt, paramThrowable.toString());
      return;
    }
    if ((paramThrowable instanceof IOException))
    {
      ...
      {
        parambgux.a(9037, paramInt, paramThrowable.toString());
        return;
      }
      if ("httpcommunicator closed".equals(paramThrowable.getMessage()))
      {
        parambgux.a(9366, paramInt, paramThrowable.getMessage());
        return;
      }
      if ("preempted by higher msg".equals(paramThrowable.getMessage()))
      {
        parambgux.a(9361, paramInt, paramThrowable.toString());
        return;
      }
      if ("content-length zero".equals(paramThrowable.getMessage()))
      {
        paramHttpURLConnection = bdsx.a("Q", -9531L);
        parambgux.b(bgux.jdField_f_of_type_JavaLangString, paramHttpURLConnection);
        parambgux.a(-9527, paramInt, "content zero");
        return;
      }
      if ((paramThrowable instanceof MalformedURLException))
      {
        parambgux.a(9048, paramInt, paramThrowable.toString());
        return;
      }
      if ((paramThrowable instanceof InterruptedIOException))
      {
        if ((paramThrowable instanceof SocketTimeoutException))
        {
          if (paramBoolean)
          {
            parambgux.a(9014, paramInt, paramThrowable.toString());
            return;
          }
          parambgux.a(9050, paramInt, paramThrowable.toString());
          return;
        }
        parambgux.a(9049, paramInt, paramThrowable.toString());
        return;
      }
      if ((paramThrowable instanceof SocketException))
      {
        ...
        {
          parambgux.a(9052, paramInt, paramHttpURLConnection);
          return;
        }
        if ((paramThrowable instanceof NoRouteToHostException))
        {
          parambgux.a(9053, paramInt, paramHttpURLConnection);
          return;
        }
        if ((paramThrowable instanceof PortUnreachableException))
        {
          parambgux.a(9054, paramInt, paramHttpURLConnection);
          return;
        }
        parambgux.a(9051, paramInt, paramHttpURLConnection);
        return;
      }
      if ((paramThrowable instanceof UnknownHostException))
      {
        parambgux.a(9055, paramInt, paramThrowable.toString());
        return;
      }
      if ((paramThrowable instanceof EOFException))
      {
        parambgux.a(9056, paramInt, paramThrowable.getMessage());
        return;
      }
      ...
      for (;;)
      {
        parambgux.a(9047, paramInt, paramThrowable);
        parambgux.b(bgux.jdField_f_of_type_JavaLangString, paramHttpURLConnection);
        return;
        ...
        else
        {
          ...
          {
            parambgux.a(9064, paramInt, paramThrowable);
            return;
          }
    ...
    {
      parambgux.a(9022, paramInt, paramThrowable.toString());
      return;
    }
    ...
    {
      parambgux.a(9058, paramInt, paramHttpURLConnection);
      return;
    }
    if ((!TextUtils.isEmpty(paramHttpURLConnection)) && (paramHttpURLConnection.contains("DecryptError")))
    {
      parambgux.a(9059, paramInt, paramHttpURLConnection);
      return;
    }
    try
    {
      parambgux.a(9322, paramInt, Log.getStackTraceString(paramThrowable));
      return;
    }
  ...
  void b(int paramInt, HttpURLConnection paramHttpURLConnection, bgux parambgux)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramHttpURLConnection = bdsx.a(paramInt, l1);
        parambgux.b(bgux.jdField_f_of_type_JavaLangString, paramHttpURLConnection);
        parambgux.a(-9527, paramInt, paramHttpURLConnection);
        return;
      }
  ...
  public void b(bgux parambgux)
  {
    ...
    {
      this.jdField_a_of_type_Bguw.a(parambgux);
      parambgux.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
      return;
    }
  }
  
  public void b(bgux parambgux, bguv parambguv)
  {
    int i = 0;
    if ((parambgux != null) && (parambguv != null)) {
      try
      {
        a(parambgux, "responseTimeout", "");
        if (parambgux.b() == null) {}
        for (;;)
        {
          a(90000L, i);
          a(parambguv);
          parambgux.a(9014, 0, "response timeout");
          parambgux.a().b(parambgux, parambgux);
          return;
          i = parambgux.b().length;
        }
        return;
      }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.e("Q.richmedia.HttpCommunicator", 2, "onResponseTimeout", parambgux);
        }
      }
    }
  }
  ...
  public void c()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      do
      {
        localbgux = this.jdField_a_of_type_Bguw.a(true);
        if (localbgux == null) {
          break;
        }
      } while ((localbgux == null) || (localbgux.a() == null));
      localbgux.a(9366, -1, "httpcommunicator_close");
      localbgux.a().b(localbgux, localbgux);
    }
    this.jdField_a_of_type_Bguw.a();
    if (this.jdField_a_of_type_ArrayOfBguv != null)
    {
      bguv[] arrayOfbguv = this.jdField_a_of_type_ArrayOfBguv;
      int j = arrayOfbguv.length;
      while (i < j)
      {
        arrayOfbguv[i].sendEmptyMessage(1);
        i += 1;
