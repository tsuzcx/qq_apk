...
public class ahov
{
  private static ahov jdField_a_of_type_Ahov;
  public static String a;
  private static final String jdField_b_of_type_JavaLangString = AppConstants.SDCARD_AIO_TIM_THEME_DIR + "icons/";
  private static final String jdField_c_of_type_JavaLangString = AppConstants.SDCARD_AIO_TIM_THEME_DIR + "zip/";
  private static final String jdField_d_of_type_JavaLangString = amtj.a(2131714017);
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString2.mkdirs();
        paramString1 = new bgoe(paramString1, new File(jdField_c_of_type_JavaLangString + "android_tim_theme_icons.zip"));
        paramString1.f = "profileCardDownload";
        paramString1.e = "VIP_profilecard";
        return bgog.a(paramString1, null);
      }
  ...
  {
    if (jdField_a_of_type_Ahov == null) {
      jdField_a_of_type_Ahov = new ahov();
    }
    return jdField_a_of_type_Ahov;
  }
  ...
  private boolean a(String paramString)
  {
    ...
    //   11: getstatic 49	ahov:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   37: ireturn
    //   38: aload_2
    //   39: invokevirtual 314	java/io/File:getPath	()Ljava/lang/String;
    //   42: invokestatic 318	com/tencent/mobileqq/utils/FileUtils:calcMd5	(Ljava/lang/String;)Ljava/lang/String;
    //   45: astore_3
    //   46: aload_3
    //   47: invokestatic 178	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   50: ifne -14 -> 36
    //   53: aload_3
    //   54: aload_1
    //   55: invokevirtual 321	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   58: ifeq -22 -> 36
    //   61: getstatic 45	ahov:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   64: invokestatic 144	com/tencent/mobileqq/utils/FileUtils:deleteFilesInDirectory	(Ljava/lang/String;)V
    //   67: aload_2
    //   68: getstatic 45	ahov:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   71: invokestatic 326	npo:a	(Ljava/io/File;Ljava/lang/String;)V
    //   74: iconst_1
    //   75: ireturn
    //   76: astore_1
    ...
    //   80: ifeq -44 -> 36
    //   83: aload_1
    //   84: invokevirtual 327	java/lang/UnsatisfiedLinkError:printStackTrace	()V
    //   87: iconst_0
    //   88: ireturn
    //   89: astore_1
    ...
    //   93: ifeq -57 -> 36
    //   96: aload_1
    //   97: invokevirtual 328	java/lang/Exception:printStackTrace	()V
    //   100: iconst_0
    //   101: ireturn
  ...
  public Drawable a(int paramInt)
  {
    ...
    localObject = bfvo.a(jdField_b_of_type_JavaLangString + "skin_header_bar.png", localOptions);
    if (localObject != null)
    {
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    if (localObject != null)
    {
      localObject = ((amsw)localObject).e(paramSessionInfo.curFriendUin);
      if ((localObject != null) && (((Friends)localObject).netTypeIconId == 10))
      {
        paramSessionInfo.isTimUserOnline = true;
        if (paramSessionInfo.isTimUserOnline)
        {
          ...
          bool1 = true;
          label129:
          paramSessionInfo.isTimUserTitleForm = bool1;
          if ((a(paramQQAppInterface) != 1) || (!bool3)) {
            break label209;
          }
          bool1 = true;
          label150:
          paramSessionInfo.isTimUserOnlineIcon = bool1;
    ...
    {
      paramSessionInfo.isTimUserBubbleForm = bool1;
      return;
      if (a()) {
        break;
      }
  ...
  public Drawable b(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (localObject2 == null)
      {
        localBitmap = bfvo.a(jdField_b_of_type_JavaLangString + "skin_aio_qim_header_flag.png", (BitmapFactory.Options)localObject3);
        localObject1 = localObject2;
        if (localBitmap != null)
        {
          ...
          if (localBitmap == null)
          {
            localObject1 = bfvo.a(jdField_b_of_type_JavaLangString + "title_bg_round.9.png", (BitmapFactory.Options)localObject3);
          ...
          if (localObject2 == null)
          {
            localBitmap = bfvo.a(jdField_b_of_type_JavaLangString + "aio_qim_online_icon.png", (BitmapFactory.Options)localObject3);
            localObject1 = localObject2;
            if (localBitmap != null)
            {
              localObject1 = new BitmapDrawable(localBitmap);
              ...
              {
                localObject2 = bfvo.a(jdField_b_of_type_JavaLangString + "tim_title_immersive_bar.png", (BitmapFactory.Options)localObject3);
                localObject1 = localBitmap;
                if (localObject2 != null)
                {
                  ...
                  if (localObject2 == null)
                  {
                    localObject1 = bfvo.a(jdField_b_of_type_JavaLangString + "aio_tim_user_online_title_icon.png", (BitmapFactory.Options)localObject3);
