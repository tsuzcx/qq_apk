...
public abstract class ahov
  extends BaseBubbleBuilder
{
  public ahov(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
  ...
  private View a(Context paramContext, View paramView, MessageRecord paramMessageRecord, String paramString1, String paramString2, int paramInt, boolean paramBoolean, View.OnClickListener paramOnClickListener)
  {
    ...
    for (;;)
    {
      ...
      {
        Drawable localDrawable = localResources.getDrawable(2130850462);
        localDrawable.setBounds(0, 0, agej.a(12.0F, localResources), agej.a(12.0F, localResources));
        paramString1 = localResources.getDrawable(2130850463);
        paramString1.setBounds(0, 0, agej.a(12.0F, localResources), agej.a(12.0F, localResources));
        try
        {
        ...
        paramContext.setBounds(0, 0, agej.a(12.0F, localResources), agej.a(12.0F, localResources));
  ...
  public View a(QQAppInterface paramQQAppInterface, BaseChatItemLayout paramBaseChatItemLayout, SessionInfo paramSessionInfo, MessageRecord paramMessageRecord, View.OnClickListener paramOnClickListener)
  {
    ...
    RelativeLayout localRelativeLayout = (RelativeLayout)paramBaseChatItemLayout.findViewById(2131378081);
    auvi localauvi = ((FlashChatManager)paramQQAppInterface.getManager(217)).a;
    ...
    do
    {
      ...
      if ((!TextUtils.isEmpty(localauvi.b)) && (bool) && ("1".equals(str))) {
        break;
      }
    } while (localRelativeLayout == null);
    paramBaseChatItemLayout.removeView(localRelativeLayout);
    return paramBaseChatItemLayout;
    bdll.b(paramQQAppInterface, "dc00898", "", "", "0X8008279", "0X8008279", i, 0, "", "", "", "");
    a(paramBaseChatItemLayout, paramMessageRecord, paramOnClickListener, paramSessionInfo, localRelativeLayout, localauvi.b, localauvi.d, -1, true);
    return paramBaseChatItemLayout;
  }
  ...
  protected void a(BaseChatItemLayout paramBaseChatItemLayout, MessageRecord paramMessageRecord, View.OnClickListener paramOnClickListener, Context paramContext, RelativeLayout paramRelativeLayout, String paramString1, String paramString2, int paramInt, boolean paramBoolean)
  {
    if (paramRelativeLayout == null)
    {
      ...
      paramRelativeLayout.setId(2131378081);
    }
    for (int i = 1;; i = 0)
    {
      ...
      ((RelativeLayout.LayoutParams)localObject1).topMargin = agej.a(-2.0F, (Resources)localObject2);
      ((RelativeLayout.LayoutParams)localObject1).leftMargin = agej.a(0.0F, (Resources)localObject2);
      ...
      if (bool)
      {
        ...
        ((RelativeLayout.LayoutParams)localObject1).leftMargin = (agej.a(18.0F, (Resources)localObject2) + j);
      ...
      for (;;)
      {
        ...
        return;
        j = ((RelativeLayout.LayoutParams)localObject1).leftMargin;
        ((RelativeLayout.LayoutParams)localObject1).leftMargin = (agej.a(9.0F, (Resources)localObject2) + j);
        break;
        label230:
