...
public class xxz
  extends RecyclerView.Adapter<xya>
{
  protected CertifiedAccountMeta.StEntry a;
  protected List<xze> a;
  ...
  public xya a(ViewGroup paramViewGroup, int paramInt)
  {
    Object localObject = paramViewGroup.getContext();
    paramViewGroup = new RecyclerView.LayoutParams(bcwh.a((Context)localObject, 144.0F), bcwh.a((Context)localObject, 213.0F));
    if (paramInt == 3)
    {
      ...
      return new xya(this, (View)localObject);
    }
    if (paramInt == 1)
    {
  ...
  public void a(xxy paramxxy)
  {
    this.jdField_a_of_type_Xxy = paramxxy;
  }
  
  public void a(xya paramxya)
  {
    super.onViewAttachedToWindow(paramxya);
    int i = paramxya.getAdapterPosition() - a();
    if ((!bhns.a(i, a())) && (a().get(i) != null)) {
      yvu.a(((xze)a().get(i)).jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser.id.get(), "auth_page", "recom_exp", 0, 0, new String[] { "", "", String.valueOf(i), ((xze)a().get(i)).jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser.nick.get() });
    }
  }
  
  public void a(xya paramxya, int paramInt)
  {
    if (paramxya == null) {}
    do
    {
      return;
      if ((paramxya.itemView instanceof RecommendBannerEntryItemView))
      {
        ((RecommendBannerEntryItemView)paramxya.itemView).setEntry(this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StEntry);
        return;
      }
      paramInt -= a();
      if ((paramxya.itemView instanceof RecommendBannerItemView))
      {
        paramxya = (RecommendBannerItemView)paramxya.itemView;
        paramxya.setData(((xze)a().get(paramInt)).jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser, paramInt);
        paramxya.setRecommendBannerFolwListener(this.jdField_a_of_type_Xxy);
        return;
      }
    } while (!(paramxya.itemView instanceof RecommendBannerFeedItemView));
    ((RecommendBannerFeedItemView)paramxya.itemView).setData(((xze)a().get(paramInt)).jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed, paramInt);
  }
  ...
  public int getItemViewType(int paramInt)
  {
    ...
    return ((xze)a().get(paramInt - a())).jdField_a_of_type_Int;
  }
}
