...
public class bhlb<K, V>
{
  ...
  int[] jdField_a_of_type_ArrayOfInt = bhkv.jdField_a_of_type_ArrayOfInt;
  int jdField_c_of_type_Int = 0;
  Object[] jdField_c_of_type_ArrayOfJavaLangObject = bhkv.jdField_a_of_type_ArrayOfJavaLangObject;
  
  private static int a(int[] paramArrayOfInt, int paramInt1, int paramInt2)
  {
    try
    {
      paramInt1 = bhkv.a(paramArrayOfInt, paramInt1, paramInt2);
      return paramInt1;
    }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      Object localObject3;
      boolean bool;
      if ((paramObject instanceof bhlb))
      {
        paramObject = (bhlb)paramObject;
        if (b() != paramObject.b()) {
          return false;
        }
        i = 0;
