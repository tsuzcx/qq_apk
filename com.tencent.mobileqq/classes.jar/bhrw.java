...
public class bhrw
  extends bhro
{
  public static bhrw a;
  public static String a;
  
  static
  {
    jdField_a_of_type_Bhrw = new bhrw();
    jdField_a_of_type_JavaLangString = "theme.";
  }
  
  private boolean a(String paramString)
  {
    if ((bhuk.a()) && ((paramString.startsWith("theme.android")) || (paramString.endsWith(".cfg"))))
    {
  ...
  public boolean deleteFiles(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    if (paramQQAppInterface != null) {
      if (!ThemeUtil.isIOSTheme(paramString))
      {
        ...
        {
          localObject = new beik().a((String)localObject);
          if (paramString.startsWith(jdField_a_of_type_JavaLangString)) {}
          for (paramQQAppInterface = ((beik)localObject).a(paramQQAppInterface.getApp(), paramString, "").c();; paramQQAppInterface = ((beik)localObject).b(paramQQAppInterface.getApp()))
          {
  ...
  protected void doOnCompleted(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2)
  {
    if (!ThemeUtil.isIOSTheme(paramString1))
    {
      ...
      if (paramInt1 != 0)
      {
        ...
        bhpe.a(null, "individual_v2_theme_download_fail", String.valueOf(paramInt1), "from" + paramString3 + ",httpCode=" + paramInt2 + ",errorCode:" + paramInt1 + ", scid:" + paramString1 + ", cfgScid:" + paramString2, paramQQAppInterface, String.valueOf(paramInt2), null, 0.0F, 0.0F);
  ...
  public VasQuickUpdateEngine.TagItemInfo getItemInfo(QQAppInterface paramQQAppInterface, long paramLong, String paramString)
  {
    ...
    localObject = new VasQuickUpdateEngine.TagItemInfo();
    localbeik = new beik().a(str);
    if (paramString.startsWith(jdField_a_of_type_JavaLangString))
    {
      ((VasQuickUpdateEngine.TagItemInfo)localObject).bPreConfig = false;
      ((VasQuickUpdateEngine.TagItemInfo)localObject).bSaveInDir = false;
      ((VasQuickUpdateEngine.TagItemInfo)localObject).strSavePath = localbeik.a(paramQQAppInterface.getApp(), paramString, "").c();
      return localObject;
    }
    ((VasQuickUpdateEngine.TagItemInfo)localObject).bPreConfig = true;
    ((VasQuickUpdateEngine.TagItemInfo)localObject).bSaveInDir = false;
    ((VasQuickUpdateEngine.TagItemInfo)localObject).strSavePath = localbeik.b(paramQQAppInterface.getApp());
    return localObject;
