...
public class lvr
  extends lvz
{
  private lvr(AVServiceForQQ paramAVServiceForQQ) {}
  ...
  public int a(long paramLong, int paramInt)
  {
    ...
    if (this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface != null)
    {
      ...
      if (((lco)((Iterator)localObject).next()).d != 1) {
        break label123;
      }
      paramInt += 1;
    }
  ...
  public void a(long paramLong, String paramString)
  {
    ...
    AVServiceForQQ.a(this.a, mts.a());
    AVServiceForQQ.a(this.a).a(null);
    AVServiceForQQ.a(this.a).c();
    AVServiceForQQ.a(this.a).d();
    if ((lbu.a().a().jdField_a_of_type_Lfa.jdField_a_of_type_Int == 3) && ((paramLong == -1L) || (paramLong == lbu.a().a().jdField_a_of_type_Lfa.jdField_a_of_type_Long)))
    {
    ...
    for (;;)
    {
      ...
      localVideoController.a().jdField_a_of_type_Lez.b = paramString;
      localVideoController.a().aB = true;
      return;
      this.a.b = lbu.a(AVServiceForQQ.a(this.a), String.valueOf(paramLong), new int[0]);
      lbu.a().a(this.a.b, false);
      ...
      AVServiceForQQ.a(this.a).a();
      if (lbu.a().c(this.a.b).jdField_g_of_type_Boolean)
      {
        i = localVideoController.f();
        localVideoController.a("enterRoom", lbu.a().c(this.a.b).jdField_a_of_type_Lfa.jdField_a_of_type_Long, false, false, -1);
        localVideoController.a(-1L, i, localVideoController.f());
        break label344;
      }
      int i = localVideoController.f();
      localVideoController.a("enterRoom", lbu.a().c(this.a.b).jdField_a_of_type_Lfa.jdField_a_of_type_Long, true, false, -1);
      localVideoController.a(-1L, i, localVideoController.f());
      break label344;
      label613:
  ...
  public void c()
  {
    ...
    for (;;)
    {
      ...
      lbc.c(this.a.jdField_a_of_type_JavaLangString, "DataReport onClose: ");
      ...
      lhq.a(this.a.jdField_a_of_type_JavaLangString, this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
      mbp.b(this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin());
      mll.a(localVideoController.a());
