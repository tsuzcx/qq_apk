...
public class blzr
{
  ...
  public static final int[] g = { 107, 2130844140, 2130844140, 2131373304 };
  public static final int[] h = { 112, 2130844144, 2130844144, 2131373307 };
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 108, 2130849108, 2130849108, 2131373301 };
    jdField_b_of_type_ArrayOfInt = new int[] { 101, 2130849109, 2130849109, 2131373302 };
    jdField_c_of_type_ArrayOfInt = new int[] { 102, 2130849111, 2130849111, 2131373306 };
    jdField_d_of_type_ArrayOfInt = new int[] { 103, 2130849112, 2130849112, 2131373305 };
    jdField_e_of_type_ArrayOfInt = new int[] { 104, 2130849110, 2130849110, 2131373303 };
    jdField_f_of_type_ArrayOfInt = new int[] { 105, 2130849107, 2130849107, 2131373300 };
  }
  
  public blzr(int paramInt)
  {
  ...
  public ProviderView a(Context paramContext, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_e_of_type_Boolean)
      {
        ...
        ((ProviderView)localObject1).setId(2131363941);
        continue;
        localObject1 = localObject2;
        if (this.jdField_c_of_type_Boolean)
        {
          localObject1 = new QIMFilterProviderView(paramContext);
          ((ProviderView)localObject1).setId(2131363943);
          continue;
          localObject1 = new StaticStickerProviderView(paramContext);
          ((ProviderView)localObject1).setId(2131363952);
          continue;
          ...
          if (this.jdField_f_of_type_Boolean)
          {
            ...
            ((ProviderView)localObject1).setId(2131363951);
            continue;
            localObject1 = localObject2;
