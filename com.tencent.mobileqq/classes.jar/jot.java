...
{
  public jot(SmallScreenMultiVideoControlUI paramSmallScreenMultiVideoControlUI) {}
  ...
  protected void a(String paramString, String[] paramArrayOfString)
  {
    ...
    if (i == 1) {
      this.a.jdField_a_of_type_AndroidContentResResources.getString(2131429010);
    }
    for (;;)
    {
      this.a.a(Long.valueOf(paramString).longValue(), 82, true, -1);
      return;
      String.format(this.a.jdField_a_of_type_AndroidContentResResources.getString(2131429009), new Object[] { Integer.valueOf(i) });
    }
  }
  ...
  protected void b(long paramLong)
  {
    ...
    super.b(paramLong);
    this.a.g();
    this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(new jow(this), 500L);
  }
  ...
  protected void b(long paramLong1, long paramLong2, int paramInt, boolean paramBoolean)
  {
    ...
    this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().removeCallbacks(this.a.jdField_a_of_type_Jpa);
    this.a.jdField_a_of_type_Jpa.a = "onMemberPPTInOrOut";
    this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(this.a.jdField_a_of_type_Jpa, 1000L);
    return;
  ...
  protected void b(long paramLong, boolean paramBoolean)
  {
    ...
    label199:
    for (Object localObject1 = this.a.jdField_a_of_type_AndroidContentResResources.getString(2131429156);; localObject1 = this.a.jdField_a_of_type_AndroidContentResResources.getString(2131429157))
    {
  ...
  protected void c(long paramLong)
  {
    ...
    super.c(paramLong);
    this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().postDelayed(new jou(this, paramLong), 1500L);
  }
  ...
  protected void c(long paramLong, boolean paramBoolean)
  {
    ...
    label193:
    for (Object localObject1 = this.a.jdField_a_of_type_AndroidContentResResources.getString(2131429154);; localObject1 = this.a.jdField_a_of_type_AndroidContentResResources.getString(2131429155))
    {
      ((StringBuilder)localObject2).append((String)localObject1);
      this.a.jdField_a_of_type_ComTencentAvUtilsTipsManager.a(70, ((StringBuilder)localObject2).toString(), 5000L, 0);
      this.a.e(paramBoolean);
  ...
  protected void d()
  {
    ...
    SmallScreenService localSmallScreenService = (SmallScreenService)this.a.jdField_a_of_type_JavaLangRefWeakReference.get();
    if (localSmallScreenService != null) {
      localSmallScreenService.b.post(new jov(this));
    }
    while (!QLog.isColorLevel()) {
      return;
    }
