...
public class ped
{
  ...
  private peg jdField_a_of_type_Peg;
  sly jdField_a_of_type_Sly;
  
  public ped(peg parampeg)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_ComTencentWidgetAbsListView$OnScrollListener = new pef(this);
    this.jdField_a_of_type_Peg = parampeg;
    this.jdField_a_of_type_AndroidOsHandler = new Handler();
    this.jdField_a_of_type_Sly = new peh(this, this);
  }
  ...
  public ArticleInfo a(Activity paramActivity)
  {
    ...
    ArticleInfo localArticleInfo2 = pkm.a().a(0, l);
  ...
  public peg a()
  {
    return this.jdField_a_of_type_Peg;
  }
  
  public pwe a(ArticleInfo paramArticleInfo, int paramInt1, int paramInt2)
  {
    ArticleInfo localArticleInfo = null;
    if (paramInt2 < a() - 1) {
      localArticleInfo = (ArticleInfo)a(paramInt2 + 1);
    }
    return new pwe(this.jdField_a_of_type_Peg.a(), paramArticleInfo, paramInt1, this.jdField_a_of_type_Peg.b(), this.jdField_a_of_type_Peg.a(), paramInt2, this.jdField_a_of_type_Peg.d(), a(), localArticleInfo, this.jdField_a_of_type_Peg.a());
  }
  ...
  public void a(int paramInt, ArrayList<BaseArticleInfo> paramArrayList, ArrayList<DislikeInfo> paramArrayList1, Object paramObject, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if ((a().a() instanceof BaseActivity))
    {
      ...
      if (AdvertisementInfo.isAdvertisementInfo(localBaseArticleInfo))
      {
        ...
        pkm.a().a(a().a(), paramArrayList, l1, paramArrayList1, paramBoolean1);
      }
    }
    for (;;)
    {
      try
      {
        ...
        paramArrayList.put("folder_status", pay.d);
        paramArrayList.put("kandian_mode", pay.e());
        if (localBaseArticleInfo != null)
        {
          paramArrayList.put("feeds_type", "" + pay.a(localBaseArticleInfo));
          paramArrayList.put("rowkey", uhv.a(localBaseArticleInfo));
        }
        paramArrayList = paramArrayList.toString();
        odq.a(null, "", "0X8007059", "0X8007059", 0, 0, "", "", pay.a(paramArrayList1), paramArrayList, false);
      }
      ...
      if ((a().a() instanceof PluginBaseActivity))
      {
        ...
        bcef.b(null, "CliOper", "", "", "0X8007060", "0X8007060", 0, 0, "", "", "", paramArrayList.toString());
      }
    }
  }
  ...
  public void a(AdvertisementInfo paramAdvertisementInfo, ReadInJoyXListView paramReadInJoyXListView)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        } while (localObject != ((pvc)paramReadInJoyXListView.getChildAt(j).getTag(2131380831)).a());
        for (paramAdvertisementInfo = paramReadInJoyXListView.getChildAt(j);; paramAdvertisementInfo = null)
        {
          ...
          for (;;)
          {
            paramReadInJoyXListView = new pee(this, (BaseArticleInfo)localObject, i);
            localObject = (Animation)paramAdvertisementInfo.getTag(2131369487);
            if (localObject == null) {
              break;
            }
  ...
  public void a(BaseArticleInfo paramBaseArticleInfo1, BaseArticleInfo paramBaseArticleInfo2, boolean paramBoolean)
  {
    if ((a() != null) && (a().contains(paramBaseArticleInfo1)))
    {
      ...
      this.jdField_a_of_type_Peg.a().notifyDataSetChanged();
    }
  }
  ...
  public void a(List<BaseArticleInfo> paramList)
  {
    if ((paramList != null) && (this.jdField_a_of_type_JavaUtilList.getClass().isInstance(paramList)) && (paramList.size() > 0))
    {
      ...
      this.jdField_a_of_type_Peg.e(true);
    }
    ...
    for (int i = 0;; i = paramList.size())
    {
      ...
      this.jdField_a_of_type_Peg.a().a(System.nanoTime());
      rtr.a().a(this.jdField_a_of_type_Peg.a(), a());
      return;
    }
  }
  ...
  public void a(List<ArticleInfo> paramList, int paramInt)
  {
    ...
    if (i < paramList.size())
    {
      ...
      for (;;)
      {
        ...
        if (ptk.a(l)) {
          ptk.a().a(this.jdField_a_of_type_Peg.b(), l);
        } else {
          pkm.a().a(this.jdField_a_of_type_Peg.b(), localArticleInfo);
        }
      }
    }
    a(this.jdField_a_of_type_Peg.b(), paramInt);
  }
  
  public void b()
  {
    QLog.d("RIJDataManager", 1, "invalidAllArticles");
    ozp.a(a().a(), "default_feeds");
    if (a() != null)
    {
