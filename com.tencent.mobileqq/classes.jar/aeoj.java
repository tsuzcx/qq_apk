  ...
  implements Manager
{
  ...
  public aeoj(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(AcsMsg paramAcsMsg)
  {
    ...
    do
    {
        ...
        do
        {
          for (;;)
          {
            ...
            try
            {
              ...
              if (QLog.isColorLevel()) {
                QLog.d("ActivateFriends.Manager", 2, "setAlarmTimer at " + aeno.a(l, "yyyyMMdd HH:mm:ss") + " msg: " + (String)localObject1 + " alarmId: " + i);
              }
      ...
      QLog.d("ActivateFriends.Manager", 2, "has already setAlarmTimer at " + aeno.a(l, "yyyyMMdd HH:mm:ss"));
      return;
    } while (!QLog.isColorLevel());
    label391:
    label430:
