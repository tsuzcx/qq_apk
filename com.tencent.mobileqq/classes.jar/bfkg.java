  ...
  public boolean a(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return true;
          ajfs.a((QQAppInterface)localObject);
          return true;
          paramBundle = (ajum)((QQAppInterface)localObject).a(44);
          paramBundle.a(new bfkh(this));
          paramBundle.a("");
          return true;
          paramBundle = (ajgd)((QQAppInterface)localObject).a(4);
          paramBundle.a(null, new GetResourceReqInfo[] { paramBundle.d() });
          return true;
          ((QQAppInterface)localObject).addObserver(new bfki(this));
          return true;
          boolean bool = paramBundle.getBoolean("visible");
          ((ajlf)((QQAppInterface)localObject).a(3)).a(bool);
          return true;
        ...
        return true;
        ((QQAppInterface)localObject).addObserver(new bfkj(this));
        return true;
        ((QQAppInterface)localObject).registObserver(new bfkk(this, null));
        return true;
        paramBundle = (SignatureHandler)((QQAppInterface)localObject).a(41);
      } while (paramBundle == null);
      paramBundle.a();
      ...
      return true;
      paramBundle = babh.j((QQAppInterface)localObject, ((QQAppInterface)localObject).getCurrentAccountUin());
