  ...
  extends bbbz
{
  ...
  private WtloginObserver jdField_a_of_type_MqqObserverWtloginObserver = new bbcb(this);
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bbca.class.getSimpleName();
  }
  
  public bbca(RegisterNewBaseActivity paramRegisterNewBaseActivity)
  {
  ...
  public void a(String paramString)
  {
    try
    {
      ...
      if (azit.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.app, this.c.getBytes(), paramString.getBytes(), this.d, this.jdField_a_of_type_MqqObserverWtloginObserver) != 0)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.c();
        this.jdField_a_of_type_ComTencentMobileqqActivityRegisterNewBaseActivity.a(2131716463, 1);
      }
      return;
    }
