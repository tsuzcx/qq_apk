  ...
  implements View.OnClickListener
{
  ...
  public blmw(Activity paramActivity)
  {
    super(paramActivity);
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_ArrayOfInt = new int[] { 2131380419, 2131380420, 2131380421, 2131380422 };
    this.jdField_b_of_type_ArrayOfInt = new int[] { 2131380424, 2131380425, 2131380426, 2131380427, 2131380428, 2131380429, 2131380430, 2131380431 };
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
  }
  
  private void d()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131698585));
  ...
  public void a()
  {
    this.d = ((int)bhlo.i());
    this.e = ((int)bhlo.j());
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidAppActivity.getSystemService("layout_inflater")).inflate(2131560076, null);
    setContentView(this.jdField_a_of_type_AndroidViewView);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131380423));
    this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131380415));
    this.jdField_b_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131380417);
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setEnabled(false);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380418));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131380416));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380435));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380434));
    ...
    setOnDismissListener(new blmx(this));
    setTouchable(true);
    setFocusable(true);
  ...
  protected void a(IBinder paramIBinder)
  {
    ...
    this.jdField_c_of_type_AndroidViewView.setOnKeyListener(new blmy(this));
  ...
  public void a(View paramView, blna paramblna)
  {
    this.jdField_a_of_type_Blna = paramblna;
    a(paramView.getWindowToken());
    paramblna = new int[2];
    paramView.getLocationOnScreen(paramblna);
    int j;
    int i;
    int n;
    if (!this.jdField_c_of_type_Boolean)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("KandianPopupWindow", 2, "x = " + paramblna[0] + ", y = " + paramblna[1]);
      }
      if (QLog.isColorLevel()) {
      ...
      i = paramblna[1];
      i = (int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131298713);
      n = this.jdField_b_of_type_Int - paramblna[0] - paramView.getWidth() / 2 + i;
      if (QLog.isColorLevel()) {
      ...
      if (j - (k + m) > this.jdField_c_of_type_Int) {
        if (n > this.jdField_b_of_type_Int * 0.1D)
        {
          ...
          j = paramblna[1] + paramView.getHeight() / 2 + agej.a(9.5F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    ...
    for (;;)
    {
      ozs.jdField_a_of_type_Boolean = true;
      return;
      ...
      for (;;)
      {
        ...
        j = paramblna[1] + paramView.getHeight() / 2 - agej.a(9.5F, this.jdField_a_of_type_AndroidAppActivity.getResources()) - this.jdField_c_of_type_Int;
        showAtLocation(paramView, 0, i, j);
        if (!QLog.isColorLevel()) {
          break;
        }
      ...
      showAtLocation(paramView, 0, paramblna[0] + paramView.getWidth() / 2 - agej.a(10.5F, this.jdField_a_of_type_AndroidAppActivity.getResources()) - (int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131298714), paramblna[1] + paramView.getHeight() / 2 - this.jdField_c_of_type_Int / 2);
    }
  }
  
  public void a(blmz paramblmz)
  {
    this.jdField_a_of_type_Blmz = paramblmz;
  }
  ...
  public boolean a(int paramInt, ArrayList<DislikeInfo> paramArrayList)
  {
    ...
    while ((paramArrayList == null) || (paramArrayList.size() == 0))
    {
      ...
      this.jdField_b_of_type_Int = ((int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131298714));
    ...
    this.jdField_b_of_type_Int = ((int)(this.d - this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131298713) * 2.0F));
    setWidth(this.jdField_b_of_type_Int);
  ...
  public void b()
  {
    ...
    if (this.jdField_b_of_type_AndroidViewView != null) {
      this.jdField_b_of_type_AndroidViewView.setBackgroundResource(2130843012);
    }
    if (this.jdField_c_of_type_AndroidWidgetImageView != null)
    {
      this.jdField_c_of_type_AndroidWidgetImageView.setImageResource(2130843021);
      if (RelativeLayout.LayoutParams.class.isInstance(this.jdField_c_of_type_AndroidWidgetImageView.getLayoutParams()))
      {
        ...
        localLayoutParams.addRule(3, 2131380416);
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        return;
        if (this.jdField_a_of_type_Blna != null) {
          this.jdField_a_of_type_Blna.a(paramView, this.jdField_a_of_type_Int, this.jdField_b_of_type_JavaUtilArrayList, null);
        }
        dismiss();
        continue;
        if (this.jdField_a_of_type_Blmz != null) {
          this.jdField_a_of_type_Blmz.a();
        }
        dismiss();
        continue;
        i += 1;
        ...
        label281:
        if (this.jdField_a_of_type_Boolean) {
          this.jdField_a_of_type_AndroidWidgetTextView.setText(String.format(this.jdField_a_of_type_AndroidAppActivity.getString(2131698586), new Object[] { Integer.valueOf(this.jdField_b_of_type_JavaUtilArrayList.size()) }));
        }
