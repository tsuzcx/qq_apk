  ...
  extends BaseAdapter
{
  ...
  public static final int c = bdkf.b(10.0F);
  float jdField_a_of_type_Float;
  private Context jdField_a_of_type_AndroidContentContext;
  private ArrayList<blmx> jdField_a_of_type_JavaUtilArrayList = new ArrayList(10);
  ...
  static
  {
    jdField_a_of_type_Int = bdkf.b(40.0F);
    jdField_b_of_type_Int = bdkf.b(5.0F);
  }
  
  public blmw(Context paramContext, int paramInt)
  {
  ...
  private View a()
  {
    ...
    for (;;)
    {
      ...
      ((URLImageView)localObject1).setId(2131367808);
      ...
      localObject3 = new blmx();
      ((blmx)localObject3).jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localObject1);
      ((blmx)localObject3).jdField_a_of_type_AndroidViewView = localFrameLayout;
      ((blmx)localObject3).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject2);
      ((blmx)localObject3).jdField_a_of_type_Boolean = this.jdField_a_of_type_Boolean;
  ...
  private void b(ImageView paramImageView, String paramString)
  {
    ...
    localObject1 = bdpt.a(BaseApplicationImpl.sApplication.getRuntime(), (String)localObject1 + (String)localObject2, paramString, null, new int[] { 16 }, "-Transition-", null);
  ...
  public void a()
  {
    TransitionCategoryItem localTransitionCategoryItem = bncp.a().a();
    ...
    {
      localblmx = (blmx)localIterator.next();
      if (localblmx.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem == null) {
        break label116;
      }
      if (localTransitionCategoryItem == null) {
        break label111;
      }
      bool2 = TextUtils.equals(localTransitionCategoryItem.a, localblmx.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem.a);
      bool1 = bool2;
      if (!bool2)
      {
        if (((localTransitionCategoryItem != null) && (!localTransitionCategoryItem.c())) || (!localblmx.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem.c())) {
          break label105;
        }
        bool1 = true;
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (this.jdField_b_of_type_Float = ((this.jdField_a_of_type_Float - paramViewGroup.getPaddingLeft() - paramViewGroup.getPaddingRight()) / 3.2F + 0.5F);; this.jdField_b_of_type_Float = ((this.jdField_a_of_type_Float - paramViewGroup.getPaddingLeft() - paramViewGroup.getPaddingRight()) / 4.0F + 0.5F))
    {
      ...
      if ((paramViewGroup.getTag() != null) && ((paramViewGroup.getTag() instanceof blmx))) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    blmx localblmx = (blmx)paramViewGroup.getTag();
    TextView localTextView = localblmx.jdField_a_of_type_AndroidWidgetTextView;
    URLImageView localURLImageView = localblmx.jdField_a_of_type_ComTencentImageURLImageView;
    ...
    localblmx.jdField_a_of_type_DovComQqImCaptureDataTransitionCategoryItem = localTransitionCategoryItem;
    paramView = bncp.a().a();
    if (paramView != null) {}
    for (boolean bool1 = TextUtils.equals(paramView.a, localTransitionCategoryItem.a);; bool1 = false)
    {
      ...
      try
      {
        ...
        paramViewGroup.setContentDescription(localTransitionCategoryItem.b + alpo.a(2131715446));
        return paramViewGroup;
      }
