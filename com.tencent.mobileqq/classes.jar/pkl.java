  ...
  extends pkt
{
  ...
  private WeakReference<puw> jdField_b_of_type_JavaLangRefWeakReference;
  private boolean jdField_b_of_type_Boolean;
  private boolean c;
  
  public pkl(AppInterface paramAppInterface, puw parampuw)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramAppInterface);
    this.jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(parampuw);
  ...
  private void a(List<rcz> paramList, int paramInt)
  {
    if (paramList == null) {}
    for (;;)
    {
      ...
      if (localObject != null)
      {
        ...
        while (paramList.hasNext()) {
          a((EntityManager)localObject, ((rcz)paramList.next()).a().longValue(), paramInt);
        }
      }
    }
  }
  
  private void a(List<rcz> paramList, boolean paramBoolean)
  {
    ...
    {
      return;
      paramList = (puw)this.jdField_b_of_type_JavaLangRefWeakReference.get();
