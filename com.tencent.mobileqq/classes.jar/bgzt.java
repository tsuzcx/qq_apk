...
public class bgzt
{
  ...
  public static void a(long paramLong, Activity paramActivity, String paramString, bgzv parambgzv)
  {
    ...
    bgzu localbgzu2 = b();
    if (QLog.isColorLevel()) {
      QLog.d("QZoneVideoCommonUtils", 2, "support record=" + localbgzu1.a() + ", support trim=" + localbgzu2.a());
    }
    if ((!localbgzu1.a()) && (!localbgzu2.a()))
    {
      if (localbgzu1.b()) {}
      for (paramString = localbgzu1.a();; paramString = null)
      {
        String str;
        if (paramString != null)
        {
        ...
        {
          str = paramActivity.getString(2131718263);
        }
        if (parambgzv != null) {
          parambgzv.onFail(paramActivity, str);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.w("QZoneVideoCommonUtils", 2, "qzone video is not supported, recordSupport tips=" + localbgzu1.a() + ",trimSupport tips=" + localbgzu2.a() + ",show tips=" + str);
        return;
      }
    }
    a(paramLong, paramActivity, localbgzu1.a(), localbgzu2.a(), paramString);
    PerfTracer.traceEnd("Video_component_pre_launch");
  }
  
  public static void a(long paramLong, Activity paramActivity, String paramString, bgzv parambgzv, Bundle paramBundle)
  {
    PerfTracer.traceStart("Video_component_pre_launch");
    if (paramActivity == null)
    {
    ...
    if ((!localbgzu1.a()) && (!localbgzu2.a()))
    {
      ...
      for (paramString = localbgzu1.a();; paramString = null)
      {
        ...
        {
          paramBundle = paramActivity.getString(2131718263);
        }
        if (parambgzv != null) {
          parambgzv.onFail(paramActivity, paramBundle);
        }
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.w("QZoneVideoCommonUtils", 2, "qzone video is not supported, recordSupport tips=" + localbgzu1.a() + ",trimSupport tips=" + localbgzu2.a() + ",show tips=" + paramBundle);
        return;
      }
    }
