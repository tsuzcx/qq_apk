...
class xmj
  extends Handler
{
  xmj(xmi paramxmi, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if ((paramMessage.what == 203) && ((paramMessage.obj instanceof Bundle)))
    {
      ...
      if ((paramMessage.getInt("req_state", 0) == 2) && (!TextUtils.isEmpty(xmi.a(this.a))) && (!TextUtils.isEmpty(xmi.b(this.a))) && (xmi.b(this.a).equals(localObject)))
      {
    ...
    try
    {
      ...
      {
        label113:
        this.a.callJs(xmi.a(this.a) + "(" + ((JSONObject)localObject).toString() + ");");
        return;
        label158:
