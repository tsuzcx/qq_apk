  ...
  implements View.OnTouchListener
{
  ...
  private blkm jdField_a_of_type_Blkm = new aukt(this);
  ...
  public aukp(Activity paramActivity)
  {
    super(paramActivity);
  }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)BaseApplicationImpl.getContext().getSystemService("layout_inflater")).inflate(2131560936, this.jdField_a_of_type_AndroidViewViewGroup, false);
      ...
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131380726));
      this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131373044));
      this.h = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376597));
      this.h.setText(anzj.a(2131715040));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131373043));
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewView.findViewById(2131372754));
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370732));
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131379048));
      this.g = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363230));
      this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131366623));
    }
  }
  ...
  public void a(long paramLong, View.OnLongClickListener paramOnLongClickListener)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqVideoplatformViewBaseVideoView = ((BaseVideoView)baph.b(this.jdField_a_of_type_AndroidAppActivity, paramLong, null, null));
      ...
      this.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetDragContainerLayout.setGestureChangeListener(this.jdField_a_of_type_Blkm);
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    localTextView.setCompoundDrawablesWithIntrinsicBounds(0, 2130844330, 0, 0);
    ...
    if (auog.b(paramString1))
    {
      ...
      paramString2.setOnClickListener(new aukq(this, paramString1));
    ...
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(new aukr(this));
  }
  ...
  public void d()
  {
    if (Build.VERSION.SDK_INT >= 11)
    {
      ...
      this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new auks(this));
    }
  }
  ...
  public void d(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130845736);
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130845734);
