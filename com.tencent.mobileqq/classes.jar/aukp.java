...
public class aukp
{
  ...
  private aukr jdField_a_of_type_Aukr;
  ...
  aukp(akfu paramakfu, String paramString)
  {
  ...
  /* Error */
  private List<? extends auko> a(Class<? extends auko> paramClass, String paramString1, boolean paramBoolean, String paramString2, String[] paramArrayOfString, String paramString3, String paramString4, String paramString5, String paramString6, aukz paramaukz, int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: iload_3
    ...
    //   12: aload 8
    //   14: aload 9
    //   16: invokevirtual 55	aukp:a	(ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   19: astore 5
    //   21: aload 5
    //   23: ifnull +122 -> 145
    //   26: new 57	auki
    //   29: dup
    //   30: aload 5
    //   32: invokespecial 60	auki:<init>	(Landroid/database/Cursor;)V
    //   35: astore 4
    //   37: aload 4
    //   39: astore 5
    //   41: aload_0
    ...
    //   44: aload 4
    //   46: aload 10
    //   48: invokevirtual 63	aukp:a	(Ljava/lang/Class;Ljava/lang/String;Landroid/database/Cursor;Laukz;)Ljava/util/List;
    //   51: astore_1
    //   52: aload 4
    //   54: ifnull +10 -> 64
    //   57: aload 4
    ...
    //   0	154	0	this	aukp
    //   0	154	1	paramClass	Class<? extends auko>
  ...
  private boolean a(String paramString, auko paramauko, boolean paramBoolean)
  {
    ...
    for (boolean bool2 = ((Boolean)jdField_a_of_type_JavaUtilMap.get(str)).booleanValue();; bool2 = false)
    {
      ...
      {
        return bool1;
        bool2 = this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(aulp.a(paramauko));
        paramauko = aulp.b(paramauko);
        if (paramauko != null) {
          this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramauko);
        }
  ...
  {
    return this.jdField_a_of_type_Akfu.a().a(paramString1, paramString2, paramArrayOfString);
  }
  
  protected ContentValues a(auko paramauko)
  {
    List localList = aulp.a(paramauko.getClassForTable());
    ...
    if (i < j)
    {
      ...
      localObject = ((Field)localObject).get(paramauko);
  ...
  public Cursor a(boolean paramBoolean, String paramString1, String[] paramArrayOfString1, String paramString2, String[] paramArrayOfString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    try
    {
      if (d(paramString1))
      {
        paramString1 = this.jdField_a_of_type_Akfu.b().a(paramString1, paramArrayOfString1, paramString2, paramArrayOfString2, paramString5, paramString6);
        return paramString1;
      }
    }
  ...
  public auko a(Class<? extends auko> paramClass, long paramLong)
  {
    try
    {
      paramClass = a(paramClass, aulp.a(paramClass), false, "_id=?", new String[] { String.valueOf(paramLong) }, null, null, null, null, null, 3);
      if (paramClass != null) {
        return (auko)paramClass.get(0);
      }
    }
  ...
  public auko a(Class<? extends auko> paramClass, Cursor paramCursor)
  {
    try
    {
      paramClass = a(paramClass, aulp.a(paramClass), paramCursor);
      return paramClass;
    }
  ...
  public auko a(Class<? extends auko> paramClass, String paramString)
  {
    Object localObject = aulp.a(paramClass);
    ...
    while (i < j)
    {
      ...
      if (localField.isAnnotationPresent(aumc.class))
      {
        ...
        try
        {
          paramClass = a(paramClass, aulp.a(paramClass), false, (String)localObject, new String[] { paramString }, null, null, null, null, null, 3);
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (localauko != null)
          {
            ...
            if (auko.class.isAssignableFrom(localClass))
            {
              localObject = a(localClass, paramCursor);
              ((auko)localObject)._status = 1002;
              localField.set(localauko, localObject);
            }
            localObject = localField.getName();
        ...
        else
        {
          ...
          if (localClass == Double.TYPE)
          {
            ...
            if (paramaukz != null)
            {
              paramaukz.a(new NoColumnError((String)localObject, localClass));
              break label568;
              if ((l != -1L) && (paramString != null)) {}
              for (localauko._status = 1001;; localauko._status = 1002)
              {
                localauko.postRead();
                return localauko;
              }
  ...
  public auko a(Class<? extends auko> paramClass, String paramString, String[] paramArrayOfString)
  {
  ...
  public auko a(Class<? extends auko> paramClass, String... paramVarArgs)
  {
    ...
    try
    {
      paramClass = a(paramClass, aulp.a(paramClass), false, localStringBuffer.toString(), paramVarArgs, null, null, null, null, null, 3);
      if (paramClass != null) {
        return (auko)paramClass.get(0);
      }
    }
  ...
  public aukr a()
  {
    if (this.jdField_a_of_type_Aukr == null) {
      this.jdField_a_of_type_Aukr = new aukr(this.jdField_a_of_type_Akfu);
    }
    return this.jdField_a_of_type_Aukr;
  }
  
  public List<? extends auko> a(Class<? extends auko> paramClass)
  {
    try
    {
      paramClass = a(paramClass, aulp.a(paramClass), false, null, null, null, null, null, null, null, 2);
      return paramClass;
    }
    catch (InstantiationException paramClass)
    {
  ...
  public List<? extends auko> a(Class<? extends auko> paramClass, String paramString, Cursor paramCursor)
  {
    return a(paramClass, paramString, paramCursor, null);
  }
  
  public List<? extends auko> a(Class<? extends auko> paramClass, String paramString, Cursor paramCursor, aukz paramaukz)
  {
    localObject4 = null;
  ...
  /* Error */
  public List<? extends auko> a(Class<? extends auko> paramClass, String paramString1, String paramString2, String paramString3, String[] paramArrayOfString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 6
    ...
    //   4: astore 7
    //   6: aload_0
    //   7: getfield 33	aukp:jdField_a_of_type_Akfu	Lakfu;
    //   10: invokevirtual 235	akfu:b	()Lcom/tencent/mobileqq/app/SQLiteDatabase;
    //   13: aload_2
    //   14: aload_3
    //   15: aload 4
    //   17: aload 5
    ...
    //   34: aconst_null
    //   35: aload_2
    //   36: invokevirtual 473	aukp:a	(Ljava/lang/Class;Ljava/lang/String;Landroid/database/Cursor;)Ljava/util/List;
    //   39: astore_1
    //   40: aload_1
    //   41: astore_3
    //   42: aload_3
    ...
    //   start	length	slot	name	signature
    //   0	119	0	this	aukp
    //   0	119	1	paramClass	Class<? extends auko>
  ...
  public List<? extends auko> a(Class<? extends auko> paramClass, String paramString1, boolean paramBoolean, String paramString2, String[] paramArrayOfString, String paramString3, String paramString4, String paramString5, String paramString6)
  {
  ...
  public List<? extends auko> a(Class<? extends auko> paramClass, String paramString1, boolean paramBoolean, String paramString2, String[] paramArrayOfString, String paramString3, String paramString4, String paramString5, String paramString6, aukz paramaukz)
  {
    return a(paramClass, paramString1, paramBoolean, paramString2, paramArrayOfString, paramString3, paramString4, paramString5, paramString6, paramaukz, 1);
  }
  
  /* Error */
  public List<? extends auko> a(Class<? extends auko> paramClass, String paramString, String[] paramArrayOfString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    ...
    //   30: aconst_null
    //   31: aload_2
    //   32: invokevirtual 473	aukp:a	(Ljava/lang/Class;Ljava/lang/String;Landroid/database/Cursor;)Ljava/util/List;
    //   35: astore_1
    //   36: aload_1
    //   37: astore_3
    //   38: aload_3
    ...
    //   start	length	slot	name	signature
    //   0	157	0	this	aukp
    //   0	157	1	paramClass	Class<? extends auko>
  ...
  public List<? extends auko> a(Class<? extends auko> paramClass, boolean paramBoolean, String paramString1, String[] paramArrayOfString, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    try
    {
      paramString1 = a(paramClass, aulp.a(paramClass), paramBoolean, paramString1, paramArrayOfString, paramString2, paramString3, paramString4, paramString5);
      return paramString1;
    }
    catch (Exception paramString1)
    {
  ...
  public void a(auko paramauko)
  {
    ...
    catch (Throwable paramauko)
    {
      while (!QLog.isColorLevel()) {}
      QLog.e("EntityManager", 2, "persist error", paramauko);
    }
  }
  ...
  protected void a(auko paramauko, boolean paramBoolean)
  {
    ...
    String str;
    if (paramauko._status == 1000)
    {
      str = paramauko.getTableName();
      a(str, paramauko, false);
      paramauko.prewrite();
    }
    for (;;)
    {
      try
      {
        localContentValues = a(paramauko);
        if (!paramBoolean) {
          continue;
        }
  ...
  public boolean a(auko paramauko)
  {
    ...
    try
    {
      if ((paramauko._status == 1001) || (paramauko._status == 1002))
      {
        ContentValues localContentValues = a(paramauko);
        int i = this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramauko.getTableName(), localContentValues, "_id=?", new String[] { String.valueOf(paramauko._id) });
        return i > 0;
      }
    }
    catch (Exception localException)
  ...
  public boolean a(auko paramauko, String paramString, String[] paramArrayOfString)
  {
    boolean bool1 = false;
    boolean bool2 = false;
    if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase == null) {
    ...
    paramauko.prewrite();
    if (paramauko._status == 1001)
    {
      bool1 = bool2;
      if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramauko.getTableName(), paramString, paramArrayOfString) > 0) {
        bool1 = true;
      }
      paramauko._status = 1003;
    }
    paramauko.postwrite();
    return bool1;
  }
  
  public boolean a(Class<? extends auko> paramClass)
  {
    if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase == null) {
      this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase = this.jdField_a_of_type_Akfu.a();
    }
  ...
  public void b(auko paramauko)
  {
    ...
    {
      while (!QLog.isColorLevel()) {}
      QLog.e("EntityManager", 2, "persistOrReplace error", paramauko);
    }
  }
  ...
  public boolean b(auko paramauko)
  {
    ...
    paramauko.prewrite();
    if (paramauko._status == 1001) {
      if (this.jdField_a_of_type_ComTencentMobileqqAppSQLiteDatabase.a(paramauko.getTableName(), "_id=?", new String[] { String.valueOf(paramauko._id) }) > 0) {
        paramauko._status = 1003;
      }
    }
    for (;;)
  ...
  public boolean b(String paramString)
  {
    try
    {
      this.jdField_a_of_type_Akfu.b().a(paramString);
      return true;
    }
    catch (Exception paramString)
    {
  ...
  public boolean d(String paramString)
  {
    ...
    do
    {
      ...
      localSQLiteDatabase = this.jdField_a_of_type_Akfu.b();
