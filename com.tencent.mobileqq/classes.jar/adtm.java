...
{
  public adtm(AddFriendVerifyActivity paramAddFriendVerifyActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject)) {
      if (!this.a.isFinishing())
      {
        ...
        ((nlo)localObject).jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131698786));
        ((nlo)localObject).jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130850440);
        ((nlo)localObject).a();
      }
    }
    for (;;)
