...
public class two
{
  ...
  public static void a(ProteusInnerData paramProteusInnerData, int paramInt)
  {
    ...
    obb.a(new trn().a(localQQAppInterface).a(BaseApplication.getContext()).a(obb.a).b(obb.Y).a(tws.a(paramProteusInnerData)).d(paramInt).d(obb.a(paramProteusInnerData)).a());
  }
}
