...
public class bmep
{
  ...
  {
    Intent localIntent = blsb.a(paramQQAppInterface.getApp());
  ...
  private String a(String paramString, int paramInt)
  {
    ...
    for (String str = paramString; paramInt == 0; str = BaseApplication.getContext().getString(2131718384)) {
      return str;
    }
    int i = a(paramInt);
    if (i <= 1) {
    ...
    if (paramInt == 3000532) {
      paramString = BaseApplication.getContext().getString(2131718951);
    }
    for (;;)
    {
      return str + "(" + BaseApplication.getContext().getString(2131692965) + i + BaseApplication.getContext().getString(2131718237) + paramString + ")";
      if (paramInt == 3000533)
      {
        paramString = BaseApplication.getContext().getString(2131718952);
      }
      else if (paramInt == 3000534)
      {
        paramString = BaseApplication.getContext().getString(2131718953);
      }
      else
      {
        if (paramInt != 3000535) {
        ...
        paramString = BaseApplication.getContext().getString(2131718954);
      }
    }
    return str;
  }
  ...
  public void a(android.content.Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    //   194: astore 7
    //   196: getstatic 409	bgvi:e	Z
    //   199: ifne +175 -> 374
    //   202: invokestatic 414	bmeq:a	()Lbmeq;
    //   205: aload 9
    //   207: aload_1
    //   208: aload 7
    //   210: aload_2
    //   211: aload_3
    //   212: ldc_w 415
    //   215: invokevirtual 418	bmeq:a	(Landroid/app/PendingIntent;Landroid/content/Context;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;I)Landroid/app/Notification;
    //   218: astore_2
    //   219: aload_1
    //   220: iconst_0
    //   221: aload_2
    //   222: invokestatic 423	bkfm:a	(Landroid/content/Context;ILandroid/app/Notification;)V
    ...
    //   371: goto -175 -> 196
    //   374: ldc_w 439
    //   377: invokestatic 444	bgln:k	()Ljava/lang/String;
    //   380: invokevirtual 448	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   383: ifeq +23 -> 406
    //   386: invokestatic 414	bmeq:a	()Lbmeq;
    //   389: aload 9
    //   391: aload_1
    //   392: aload 7
    //   394: aload_2
    //   395: aload_3
    //   396: ldc_w 415
    //   399: invokevirtual 450	bmeq:b	(Landroid/app/PendingIntent;Landroid/content/Context;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;I)Landroid/app/Notification;
    //   402: astore_2
    //   403: goto -184 -> 219
    //   406: invokestatic 414	bmeq:a	()Lbmeq;
    //   409: aload 9
    //   411: aload_1
    //   412: aload 7
    //   414: aload_2
    //   415: aload_3
    //   416: ldc_w 415
    //   419: invokevirtual 453	bmeq:c	(Landroid/app/PendingIntent;Landroid/content/Context;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;I)Landroid/app/Notification;
    //   422: astore_2
    //   423: goto -204 -> 219
    //   426: astore_1
    //   427: ldc 224
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean1, int paramInt2, String paramString5, String paramString6, boolean paramBoolean2, boolean paramBoolean3, int paramInt3)
  {
    ...
    a(paramInt1, paramQQAppInterface);
    paramInt1 = 1;
    Object localObject3 = (bccv)paramQQAppInterface.getManager(10);
    Object localObject1;
    switch (paramInt2)
    {
    default: 
    ...
    for (;;)
    {
      ...
      if (paramInt2 == 366)
      {
        ...
        paramInt3 = 2130847508;
        localObject1 = null;
        localObject3 = null;
        if (paramInt2 != 8) {
          break label1077;
        }
        localObject5 = awlf.a(paramQQAppInterface);
        localObject1 = localObject3;
        if (((awlf)localObject5).a(paramString3, paramString4)) {
          localObject1 = ((awlf)localObject5).a(paramString3, paramString4, null);
        }
        ...
        paramString1 = bmeq.a().a((PendingIntent)localObject4, paramQQAppInterface.getApp(), paramString3, paramString1, paramString2, paramInt3);
      }
      for (;;)
      {
        for (;;)
        {
          for (;;)
          {
            for (;;)
            {
              ...
              bkfm.a(paramQQAppInterface.getApp(), 0, paramString1);
              if (localStatus != AppRuntime.Status.dnd) {
                break label1443;
              }
              if (!QLog.isColorLevel()) {
              ...
              paramInt1 = ((bccv)localObject3).a(1);
              ((bccv)localObject3).a(1, paramInt1);
              if (paramInt1 > 0) {
                break label1552;
              }
              paramInt1 = 1;
                  ...
                  try
                  {
                    for (;;)
                    {
                      ...
                      if (paramBoolean2)
                      {
                        ...
                        localObject1 = localObject3;
                        ((blrv)localObject4).c = String.valueOf(322);
                        localObject1 = localObject3;
                        ((blrv)localObject4).d = String.valueOf(2);
                        localObject1 = localObject3;
                        ((blrv)localObject4).e = String.valueOf(6);
                        localObject1 = localObject3;
                        QZoneClickReport.report(paramQQAppInterface.getAccount(), (blrv)localObject4, true);
                      }
                      localObject1 = localObject3;
                      localObject4 = Uri.parse(paramString5);
                      localObject1 = localObject3;
                      localObject5 = new bmer(((Uri)localObject4).getQueryParameter("room"), paramString2, paramBoolean1, paramInt2, paramString5, paramString6);
                      localObject1 = localObject3;
                      if (bccf.a == null)
                      {
                        localObject1 = localObject3;
                        bccf.a = Collections.synchronizedList(new ArrayList());
                      }
                      if (paramBoolean2)
                      {
                        localObject1 = localObject3;
                        bccf.a.add(localObject5);
                      }
                      try
                      {
          ...
          if (paramBoolean1)
          {
            ...
            {
              paramString1 = BaseApplication.getContext().getString(2131717432);
              break label240;
            }
            paramString1 = BaseApplication.getContext().getString(2131717432) + "(" + BaseApplication.getContext().getString(2131692965) + paramInt1 + BaseApplication.getContext().getString(2131718237) + BaseApplication.getContext().getString(2131718950) + ")";
            break label240;
          }
          paramString1 = BaseApplication.getContext().getString(2131717432);
          break label240;
          ...
          if (paramInt2 == 366)
          {
            paramInt3 = 2130841393;
            localBitmap = bggl.a(paramQQAppInterface.getApp().getResources(), 2130843954);
            localObject5 = awlf.a(paramQQAppInterface);
            localObject1 = localBitmap;
            if (((awlf)localObject5).a(paramString3, paramString4)) {
              localObject1 = ((awlf)localObject5).a(paramString3, paramString4, localBitmap);
            }
            paramString3 = (String)localObject1;
            break label296;
          }
          try
          {
            paramString3 = BitmapFactory.decodeResource(paramQQAppInterface.getApp().getResources(), 2130848489);
          ...
          catch (OutOfMemoryError paramString4)
          {
            ...
            catch (Throwable localThrowable)
            {
              try
              {
                paramString4 = BitmapFactory.decodeResource(paramQQAppInterface.getApp().getResources(), 2130848386);
                paramString3 = paramString4;
        ...
        if ("oppo".equalsIgnoreCase(bgln.k())) {
          paramString1 = bmeq.a().b(localException5, paramQQAppInterface.getApp(), paramString3, paramString1, paramString2, paramInt3);
        } else {
          paramString1 = bmeq.a().c(localException5, paramQQAppInterface.getApp(), paramString3, paramString1, paramString2, paramInt3);
        }
      }
      label1443:
      if (paramBoolean3) {
      ...
      for (;;)
      {
        if (paramQQAppInterface != null)
        {
          blsb.a(paramQQAppInterface, getClass().getSimpleName());
