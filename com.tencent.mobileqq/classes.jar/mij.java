...
public class mij
  implements Runnable
{
  public mij(VideoPlayManager paramVideoPlayManager, VideoPlayManager.VideoPlayParam paramVideoPlayParam, VideoPlayerWrapper paramVideoPlayerWrapper) {}
  ...
  public void run()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoPlayManager$VideoPlayParam.e == 2) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoPlayManager$VideoPlayParam.e == 6))
    {
      ...
      localThirdVideoManager.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoPlayManager$VideoPlayParam.jdField_a_of_type_JavaLangString, "PubAccountArticleCenter.GetUrlByVid", new mik(this, localThirdVideoManager));
    }
    for (;;)
    {
