  ...
  extends apqr
{
  ...
  private xbf jdField_a_of_type_Xbf;
  private View c;
  ...
  public apri(Activity paramActivity)
  {
    super(paramActivity);
  }
  ...
  public void a()
  {
    ...
    {
      this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)BaseApplicationImpl.getContext().getSystemService("layout_inflater")).inflate(2131560507, this.jdField_a_of_type_AndroidViewViewGroup, false);
      ...
      this.h = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378692));
      this.i = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378706));
      this.jdField_g_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131379601);
      this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131379605);
      ...
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378426));
      this.jdField_d_of_type_AndroidWidgetTextView.setVisibility(8);
      this.jdField_d_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131371912);
      this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.jdField_d_of_type_AndroidViewView.findViewById(2131379603));
      ...
      this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378144));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371063));
      this.jdField_a_of_type_Xbf = new xbf(null, this.jdField_a_of_type_AndroidAppActivity);
    }
  }
  ...
  public void a(List<apqk> paramList, String paramString1, long paramLong1, long paramLong2, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean, String paramString6, short paramShort)
  {
    this.jdField_a_of_type_Xbf.a(paramList);
    this.jdField_a_of_type_Xbf.e = "/";
    this.jdField_a_of_type_Xbf.jdField_b_of_type_Long = paramLong1;
    this.jdField_a_of_type_Xbf.jdField_a_of_type_Long = paramLong2;
    this.jdField_a_of_type_Xbf.jdField_b_of_type_JavaLangString = paramString2;
    this.jdField_a_of_type_Xbf.c = paramString3;
    this.jdField_a_of_type_Xbf.d = paramString4;
    this.jdField_a_of_type_Xbf.jdField_a_of_type_JavaLangString = paramString5;
    this.jdField_a_of_type_Xbf.a(paramBoolean, paramString6, paramShort);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Xbf);
    this.jdField_e_of_type_AndroidViewView.setVisibility(8);
  ...
  public void b(String paramString1, String paramString2)
  {
    if (this.jdField_a_of_type_Xbf != null) {
      this.jdField_a_of_type_Xbf.notifyDataSetChanged();
    }
  }
