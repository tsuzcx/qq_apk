...
public class vdq
{
  private static WSStatisticsReporter.Builder a(String paramString)
  {
    ...
    {
      String str2 = uyo.a(10);
      str1 = str2;
      if (!TextUtils.isEmpty(str2)) {}
    }
    for (String str1 = uyo.a(9);; str1 = uyo.a(uzy.a(paramString))) {
      return new WSStatisticsReporter.Builder().setSceneFrom(b(paramString)).setSopName(a(paramString)).setTestId(str1).setPushId(uxx.a().a()).setFlush(true).setImmediatelyUpload(uyo.c());
    }
  }
  ...
  public static void a(String paramString1, String paramString2, int paramInt, stJumpInfo paramstJumpInfo)
  {
    ...
    localMap.put("global_key", uvo.a().a(paramstJumpInfo.trace_id));
  ...
  public static void a(String paramString1, String paramString2, int paramInt, stSimpleMetaFeed paramstSimpleMetaFeed)
  {
    ...
    localHashMap.put("cover_type", uyo.b(paramstSimpleMetaFeed, false));
    ...
    for (localObject = String.valueOf(paramstSimpleMetaFeed.videoTag.tagId);; localObject = "0")
    {
      ...
      if ((paramInt == 0) && (((uvn)localObject).a()))
      {
        localHashMap.put("is_cache_info", String.valueOf(((uvn)localObject).b()));
        localHashMap.put("is_cache_file", String.valueOf(((uvn)localObject).a()));
        localHashMap.put("exp_duration", String.valueOf(((uvn)localObject).a()));
      }
  ...
  private static void a(String paramString1, String paramString2, int paramInt, urt paramurt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        l1 = ((urw)localObject).a();
        localHashMap = new HashMap();
        localHashMap.put("event_type", paramInt + "");
        localHashMap.put("feed_id", localurx.a);
        localHashMap.put("owner_id", localurx.jdField_e_of_type_JavaLangString);
        if (paramInt == 2) {
          if (localObject != null) {
            break label402;
          }
      ...
      for (long l2 = 0L;; l2 = ((urw)localObject).a(paramBoolean))
      {
        if (l2 <= 0L) {
          break label412;
        }
        ...
        localHashMap.put("video_length", String.valueOf(localurx.jdField_c_of_type_Int));
        localHashMap.put("recommend_id", "");
        localHashMap.put("poolType", String.valueOf(localurx.d));
        localHashMap.put("global_key", uvo.a().a(localurx.jdField_f_of_type_JavaLangString));
        localHashMap.put("feed_pass_key", localurx.jdField_g_of_type_JavaLangString);
        uya.e("WS_VIDEO_PLAY_TIME", "[WSVerticalBeaconReport.java][reportVerticalVideoPlay] map:" + localHashMap.toString());
        localObject = new HashMap();
        ((Map)localObject).put("type", String.valueOf(localurx.jdField_e_of_type_Int));
        ((Map)localObject).put("cover_type", uyo.c(localurx.jdField_c_of_type_JavaLangString));
        ((Map)localObject).put("material_type", String.valueOf(localurx.jdField_f_of_type_Int));
        ((Map)localObject).put("play_scene", paramString2);
        ((Map)localObject).put("tag_id", String.valueOf(paramurt.jdField_a_of_type_Urx.jdField_g_of_type_Int));
  ...
  public static void a(String paramString1, String paramString2, urt paramurt)
  {
    a(paramString1, paramString2, 1, paramurt, false);
  }
  
  public static void a(String paramString1, String paramString2, urt paramurt, boolean paramBoolean)
  {
    a(paramString1, paramString2, 2, paramurt, paramBoolean);
  }
