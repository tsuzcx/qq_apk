  ...
  implements InputFilter
{
  ...
  public aiax(ExtendEditText paramExtendEditText, int paramInt)
  {
  ...
  {
    aiaw localaiaw = ExtendEditText.a(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewExtendEditText);
    if (localaiaw == null)
    {
