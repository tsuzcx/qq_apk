...
public class sdf
  extends Handler
{
  public sdf(ChatSettingForTroop paramChatSettingForTroop) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      for (paramMessage = this.a.getString(2131430597);; paramMessage = new QQText(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopCard, 3))
      {
    ...
    for (;;)
    {
      ...
      {
        localObject2 = (FormSimpleItem)localView.findViewById(2131371577);
        localSwitch = ((FormSwitchItem)localObject4).a();
        localObject3 = (TextView)localView.findViewById(2131371578);
        ((TextView)localObject3).setBackgroundResource(2130838625);
        localObject1 = "";
        paramMessage = "";
        ...
        ((View)localObject4).setBackgroundResource(2130838630);
      ...
      for (;;)
      {
        ...
        return;
        label1174:
        ((View)localObject4).setBackgroundResource(2130838633);
        ((View)localObject4).getBackground().setAlpha(255);
        if (!localSwitch.isChecked())
        {
          localSwitch.setTag(Boolean.TRUE);
        ...
        default: 
          ...
          break;
        case 2: 
          localObject1 = this.a.getString(2131430248);
          paramMessage = this.a.getString(2131430256);
          break;
        case 3: 
          localObject1 = this.a.getString(2131435704);
          paramMessage = this.a.getString(2131430257);
          break;
        case 4: 
          localObject1 = this.a.getString(2131430247);
          paramMessage = this.a.getString(2131430255);
          break;
          label1336:
          localView.setVisibility(0);
          ((View)localObject4).setBackgroundResource(2130838633);
      ...
      {
        localObject1 = (TextView)paramMessage.findViewById(2131363378);
        if (localObject1 != null)
        {
        ...
        paramMessage = (ProgressBar)paramMessage.findViewById(2131364791);
        if (paramMessage != null) {
          paramMessage.setVisibility(8);
        }
      }
      QQToast.a(this.a, 2, this.a.getString(2131434485), 0).a();
      return;
      i = paramMessage.arg1;
      ...
      if (i == 0) {}
      for (paramMessage = null;; paramMessage = this.a.getResources().getDrawable(2130846051))
      {
