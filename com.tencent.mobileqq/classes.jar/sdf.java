...
public class sdf
{
  ...
  public String b;
  private List<sdg> jdField_b_of_type_JavaUtilList = new ArrayList();
  public int c;
  private long c;
  public String c;
  public int d;
  ...
  public sdf(int paramInt, List<sdg> paramList)
  {
    this.jdField_a_of_type_Long = -1L;
    this.jdField_c_of_type_Int = 6;
    this.jdField_d_of_type_Int = 0;
    if ((paramList == null) || (paramList.isEmpty())) {
      vkw.a("It not allowed to new the story album by null picList", new Object[0]);
    }
    for (;;)
    {
      this.jdField_a_of_type_Int = paramInt;
  ...
  public static sdf a(int paramInt)
  {
    sdf localsdf = new sdf(-1);
    localsdf.jdField_d_of_type_Int = paramInt;
    return localsdf;
  }
  
  public static sdf a(StoryAlbumEntry paramStoryAlbumEntry)
  {
    sdf localsdf = new sdf(paramStoryAlbumEntry.albumType);
    localsdf.jdField_b_of_type_Long = paramStoryAlbumEntry.startTime;
    localsdf.jdField_c_of_type_Long = paramStoryAlbumEntry.endTime;
    localsdf.jdField_b_of_type_JavaLangString = paramStoryAlbumEntry.albumName;
    localsdf.jdField_a_of_type_JavaLangString = paramStoryAlbumEntry.transId;
    localsdf.jdField_b_of_type_Int = paramStoryAlbumEntry.textId;
    localsdf.jdField_c_of_type_JavaLangString = paramStoryAlbumEntry.albumDesc;
    localsdf.jdField_d_of_type_JavaLangString = paramStoryAlbumEntry.geoHashStr;
    localsdf.f = paramStoryAlbumEntry.state;
    localsdf.jdField_c_of_type_Int = paramStoryAlbumEntry.minCount;
    localsdf.e = paramStoryAlbumEntry.debugInfo;
    localsdf.jdField_a_of_type_Long = paramStoryAlbumEntry.getId();
    localsdf.a(paramStoryAlbumEntry.extraInfo);
    return localsdf;
  }
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    while (i < paramArrayOfByte.size())
    {
      ...
      localsdg.a((SerializationPB.PicInfo)paramArrayOfByte.get(i));
      ((List)localObject).add(localsdg);
      i += 1;
    }
  ...
  {
    return TextUtils.equals(paramString1.substring(0, paramString1.indexOf(ajjy.a(2131648607))), paramString2.substring(0, paramString2.indexOf(ajjy.a(2131648604))));
  }
  ...
  private byte[] a()
  {
    ...
    if ((this.jdField_b_of_type_JavaUtilList != null) && (this.jdField_b_of_type_JavaUtilList.size() > 0))
    {
      ...
      {
        localArrayList.add(((sdg)this.jdField_b_of_type_JavaUtilList.get(i)).a());
        i += 1;
      }
  ...
  public String a()
  {
    ...
    long l1 = ((sdg)this.jdField_b_of_type_JavaUtilList.get(0)).jdField_b_of_type_Long;
    long l2 = ((sdg)this.jdField_b_of_type_JavaUtilList.get(this.jdField_b_of_type_JavaUtilList.size() - 1)).jdField_b_of_type_Long;
    ...
    boolean bool = vlf.a(l1 * 1000L);
    if (bool) {}
    for (localObject1 = str1.substring(str1.indexOf(ajjy.a(2131648601)) + 1);; localObject1 = str1)
    {
      ...
      if (!TextUtils.equals(str1.substring(0, str1.indexOf(ajjy.a(2131648603))), str2.substring(0, str2.indexOf(ajjy.a(2131648606))))) {
        break label273;
      }
      return (String)localObject1 + "-" + str2.substring(str2.indexOf(ajjy.a(2131648602)) + 1);
    }
    label273:
    return (String)localObject1 + "-" + str2.substring(str2.indexOf(ajjy.a(2131648605)) + 1);
    label316:
  ...
  {
    urk.d("Q.qqstory.recommendAlbum.logic.StoryAlbum", "setState:" + paramInt);
    this.f = paramInt;
  }
  ...
  public void a(List<sdg> paramList)
  {
    ...
    this.jdField_b_of_type_JavaUtilList.addAll(paramList);
    scu.b(this.jdField_b_of_type_JavaUtilList);
  }
  
  public void a(sdf paramsdf)
  {
    a(paramsdf.b(), paramsdf.c());
    if (!TextUtils.isEmpty(paramsdf.jdField_d_of_type_JavaLangString)) {
      this.jdField_d_of_type_JavaLangString = paramsdf.jdField_d_of_type_JavaLangString;
    }
    if (paramsdf.jdField_a_of_type_JavaUtilList != null) {
      this.jdField_a_of_type_JavaUtilList = paramsdf.jdField_a_of_type_JavaUtilList;
    }
  }
  
  public void a(sdt paramsdt)
  {
    this.e = paramsdt.toString();
  }
  
  public void a(sec paramsec)
  {
    int i;
    if (paramsec != null)
    {
      if ((paramsec.jdField_a_of_type_JavaUtilList == null) || (paramsec.jdField_a_of_type_JavaUtilList.size() <= 0)) {
        break label85;
      }
      i = new Random().nextInt(paramsec.jdField_a_of_type_JavaUtilList.size());
    }
    label85:
    for (this.jdField_a_of_type_JavaLangString = ((String)paramsec.jdField_a_of_type_JavaUtilList.get(i));; this.jdField_a_of_type_JavaLangString = paramsec.jdField_b_of_type_JavaLangString)
    {
      this.jdField_c_of_type_JavaLangString = paramsec.jdField_a_of_type_JavaLangString;
      this.jdField_c_of_type_Int = paramsec.jdField_b_of_type_Int;
      this.jdField_b_of_type_Int = paramsec.jdField_c_of_type_Int;
      return;
    }
  }
  ...
  {
    vkw.a(paramsdf);
    urk.a("Q.qqstory.recommendAlbum.logic.StoryAlbum", "%s merge album %s", this, paramsdf);
    this.f = 0;
    paramsdf = paramsdf.jdField_b_of_type_JavaUtilList.iterator();
    while (paramsdf.hasNext())
    {
      sdg localsdg = (sdg)paramsdf.next();
      if (!this.jdField_b_of_type_JavaUtilList.contains(localsdg)) {
        this.jdField_b_of_type_JavaUtilList.add(localsdg);
      }
    }
    scu.b(this.jdField_b_of_type_JavaUtilList);
  }
  ...
  public boolean c()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (new File(localsdg.jdField_a_of_type_JavaLangString).exists()) {
  ...
  public long d()
  {
    ...
    return ((sdg)this.jdField_b_of_type_JavaUtilList.get(0)).jdField_b_of_type_Long;
  }
  ...
  public long e()
  {
    ...
    return ((sdg)this.jdField_b_of_type_JavaUtilList.get(this.jdField_b_of_type_JavaUtilList.size() - 1)).d;
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      if ((a()) && (((sdf)paramObject).a())) {
        return this.jdField_d_of_type_Int == ((sdf)paramObject).jdField_d_of_type_Int;
      }
      if (this.jdField_a_of_type_Long == ((sdf)paramObject).jdField_a_of_type_Long) {}
      for (;;)
      {
        return bool;
        bool = false;
  ...
  public long g()
  {
    ...
    return ((sdg)this.jdField_b_of_type_JavaUtilList.get(this.jdField_b_of_type_JavaUtilList.size() - 1)).jdField_b_of_type_Long;
  }
