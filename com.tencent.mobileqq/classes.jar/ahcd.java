...
public class ahcd
{
  private static ahcd jdField_a_of_type_Ahcd;
  ...
  private static final String jdField_d_of_type_JavaLangString = amtj.a(2131708962);
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString2.mkdirs();
        paramString1 = new bgoe(paramString1, new File(jdField_c_of_type_JavaLangString + "android_qim_theme_icons.zip"));
  ...
  private boolean a(String paramString)
  {
    ...
    //   11: getstatic 49	ahcd:jdField_c_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   58: ifeq -22 -> 36
    //   61: getstatic 45	ahcd:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   64: invokestatic 144	com/tencent/mobileqq/utils/FileUtils:deleteFilesInDirectory	(Ljava/lang/String;)V
    //   67: aload_2
    //   68: getstatic 45	ahcd:jdField_b_of_type_JavaLangString	Ljava/lang/String;
  ...
  public void a(ArrayList<ahce> paramArrayList, ArrayList<int[]> paramArrayList1)
  {
  ...
  {
    if ((!paramBoolean) && ((!(paramObject instanceof agqd)) || ((paramObject instanceof agqn)))) {}
    do
    {
      return false;
        ...
        if (localBitmap != null)
        {
          ...
          if (localObject2 == null)
          {
            ...
            if (localBitmap != null)
            {
              ...
              {
                localObject2 = bfvo.a(jdField_b_of_type_JavaLangString + "qim_title_immersive_bar.png", (BitmapFactory.Options)localObject3);
                localObject1 = localBitmap;
                if (localObject2 != null)
                {
                  ...
                  if (localObject2 == null)
                  {
                    localObject1 = bfvo.a(jdField_b_of_type_JavaLangString + "aio_qim_user_online_title_icon.png", (BitmapFactory.Options)localObject3);
