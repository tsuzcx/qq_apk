...
public class ahcd
  implements Runnable
{
  public ahcd(ScribbleResMgr paramScribbleResMgr, ScribbleResMgr.ResInfo paramResInfo) {}
  ...
  public void run()
  {
    ...
    do
    {
      ...
      ((HttpNetReq)localObject2).jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$INetEngineListener = new ahce(this);
