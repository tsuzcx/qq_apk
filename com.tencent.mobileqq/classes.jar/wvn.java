  ...
  implements wiq
{
  ...
  public wvn(int paramInt, String paramString)
  {
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_d_of_type_Boolean = true;
  ...
  public long a(String paramString)
  {
    try
    {
      ...
      if (arrayOfObject != null)
      {
        ...
        if (m < n)
        {
          wwf localwwf = (wwf)arrayOfObject[m];
          if (TextUtils.equals(paramString, localwwf.jdField_a_of_type_JavaLangString)) {
            return localwwf.jdField_b_of_type_Long;
          }
        }
      }
    }
    catch (Exception localException)
    {
      ...
      {
        int m;
        yuk.c("Q.qqstory.msgTab.nodeList.MsgTabNodeInfo", "getRecommendIdByVid:%s", localException);
  ...
  public MsgTabNodeEntity a()
  {
    ...
    while (localIterator.hasNext()) {
      localJSONArray.put(((wwf)localIterator.next()).a());
    }
    ...
    if (this.jdField_b_of_type_JavaUtilList != null)
    {
      ...
      while (localIterator.hasNext()) {
        localJSONArray.put(((xiw)localIterator.next()).a());
      }
  ...
  public void a(MsgTabNodeEntity paramMsgTabNodeEntity)
  {
    ...
    try
    {
      ...
      while (m < i1)
      {
        ...
        localObject = new wwf();
        ((wwf)localObject).a(localJSONObject);
        this.jdField_a_of_type_JavaUtilList.add(localObject);
        if (!((wwf)localObject).jdField_a_of_type_Boolean) {
    ...
    {
      yuk.c("Q.qqstory.msgTab.nodeList.MsgTabNodeInfo", "convertFrom(entity) errors", localJSONException1);
      ...
      if ((!TextUtils.isEmpty(paramMsgTabNodeEntity.localSuccessVideoList)) && (!paramMsgTabNodeEntity.localSuccessVideoList.equals("null"))) {
        try
        {
          ...
          while (m < i1)
          {
            ...
            localObject = new xiw();
            ((xiw)localObject).a(localJSONObject);
  ...
  public void a(qqstory_service.MsgTabNodeInfo paramMsgTabNodeInfo)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      localwwf.a(localMsgTabNodeVideoInfo, localArrayDeque);
    ...
    for (int m = 0;; m = 1)
    {
      ...
      if (paramMsgTabNodeInfo.redpoint.has())
      {
        ...
        yuk.a("Q.qqstory.msgTab.nodeList.MsgTabNodeInfo", "MsgTabNodeInfo convertFrom, unionId:%s, uid:%s, redPoint:%s", this.jdField_a_of_type_JavaLangString, Long.valueOf(this.jdField_b_of_type_Long), Boolean.valueOf(this.jdField_c_of_type_Boolean));
      }
  ...
  {
    this.jdField_d_of_type_Int = paramwvn.jdField_d_of_type_Int;
    this.jdField_b_of_type_Boolean = paramwvn.jdField_b_of_type_Boolean;
    this.h = paramwvn.h;
  }
  ...
  public boolean a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((TextUtils.isEmpty(localwwf.jdField_a_of_type_JavaLangString)) || (TextUtils.isEmpty(localwwf.jdField_b_of_type_JavaLangString))) {
        return false;
      }
    }
  ...
  {
    if ((paramObject instanceof wvn))
    {
      paramObject = (wvn)paramObject;
