...
public class bcbk
  extends aogh
{
  public bcbk(ActiveEntitySearchFragment paramActiveEntitySearchFragment) {}
  ...
  public void a(String paramString1, boolean paramBoolean, String paramString2, int paramInt, String paramString3, long[] paramArrayOfLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.a.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131699275));
        this.a.g.setOnClickListener(new bcbm(this));
      ...
      this.a.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(new bcbn(this));
    }
  }
  ...
  public void a(String paramString1, boolean paramBoolean1, String paramString2, byte[] paramArrayOfByte, boolean paramBoolean2, List<bcfi> paramList, long[] paramArrayOfLong, String paramString3, List<DynamicTabSearch.SubHotWord> paramList1, boolean paramBoolean3, String paramString4, int paramInt)
  {
    ...
    if (paramInt == 2)
    {
      ...
      {
        if (this.a.isAdded()) {
          this.a.jdField_a_of_type_AndroidWidgetImageView.setImageBitmap(BitmapFactory.decodeResource(this.a.getResources(), 2130842367));
        }
        if (2 == paramInt)
        {
          paramString1 = this.a.getString(2131718369);
      ...
      catch (OutOfMemoryError paramString1)
      {
        for (;;)
        {
          ...
          continue;
          paramString1 = anvx.a(2131699272);
        }
      }
    }
            ...
            if ((paramList == null) || (paramList.isEmpty()))
            {
              ...
              if ((!bool1) && (paramString3.jdField_d_of_type_Boolean)) {
                if (this.a.jdField_a_of_type_Ajdc == null)
                {
                  ...
                  paramArrayOfByte.setText(anvx.a(2131699277));
                  ...
                  paramArrayOfByte.setText(anvx.a(2131699283));
                  paramArrayOfByte.setBackgroundResource(2130838912);
                  paramString2.addHeaderView(paramArrayOfByte);
            ...
            for (;;)
            {
              for (;;)
              {
                ...
                try
                {
                  ...
                  this.a.jdField_b_of_type_AndroidWidgetTextView.setText(anvx.a(2131699272));
                  if (bool1)
                  {
                    this.a.jdField_a_of_type_AndroidWidgetButton.setVisibility(0);
                    this.a.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new bcbl(this, paramString2));
