...
public abstract class bcbk<M extends bcfo, V extends bcnx>
  extends bcbj<M, V>
{
  ...
  private List<bcfu> jdField_a_of_type_JavaUtilList;
  ...
  public bcbk(ListView paramListView, aoof paramaoof, FullMessageSearchResult.SearchResultItem paramSearchResultItem, String paramString, QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      AbsStructMsg localAbsStructMsg = bdow.a(paramMessageRecord.msgData);
      ...
      try
      {
        ...
        if (j + 50 < this.jdField_a_of_type_ComTencentMobileqqAppFmsFullMessageSearchResult$SearchResultItem.secondPageMessageUniseq.size())
        {
          ...
          if (j < i)
          {
            ...
            this.jdField_a_of_type_JavaUtilList.add(new bcfu(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppFmsFullMessageSearchResult$SearchResultItem.user, localMessageRecord));
            break label177;
          }
        }
        else
