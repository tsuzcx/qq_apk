...
{
  ooc(oob paramoob, int paramInt, JSONObject paramJSONObject, Context paramContext, MessageRecord paramMessageRecord) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      if ((oob.a(this.jdField_a_of_type_Oob) != null) && (oob.a(this.jdField_a_of_type_Oob).isShowing())) {
        oob.a(this.jdField_a_of_type_Oob).dismiss();
      }
      ...
      if (!StringUtil.isEmpty((String)localObject))
      {
        ...
        localObject = uuc.b("3046055438");
        if (this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord != null) {
          localObject = uuc.b(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.frienduin);
        }
        ...
        ((onx)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(BusinessHandlerFactory.ESHOP_AD_HANDLER)).a(8, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
        ...
        ((onx)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).getBusinessHandler(BusinessHandlerFactory.ESHOP_AD_HANDLER)).a(7, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
        QQToast.a(BaseApplicationImpl.getContext(), BaseApplicationImpl.getContext().getResources().getString(2131692186), 1).a();
      }
    }
  }
