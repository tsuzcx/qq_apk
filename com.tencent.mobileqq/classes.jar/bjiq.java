...
public class bjiq
{
  ...
  public static void a(bjif parambjif, String paramString, long paramLong)
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("module_id", parambjif.a);
    localHashMap.put("module_url", parambjif.d);
    localHashMap.put("module_version", parambjif.b);
    localHashMap.put("resolveClassState", paramString);
    localHashMap.put("param_FailCode", "v" + parambjif.b + "_" + paramString);
    boolean bool = "1".equalsIgnoreCase(paramString);
    a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), parambjif.a + "_resolveClassRes", bool, paramLong, 0L, localHashMap, "");
  }
  
  public static void a(bjif parambjif, boolean paramBoolean, long paramLong)
  {
    if (paramBoolean) {}
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("module_id", parambjif.a);
      localHashMap.put("module_url", parambjif.d);
      localHashMap.put("module_version", String.valueOf(parambjif.b));
      localHashMap.put("downloadState", str);
      localHashMap.put("param_FailCode", "v" + parambjif.b + "_" + str);
      a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), parambjif.a + "_downloadRes", paramBoolean, paramLong, 0L, localHashMap, "");
      return;
    }
  }
  ...
  public static void b(bjif parambjif, boolean paramBoolean, long paramLong)
  {
    if (paramBoolean) {}
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("param_FailCode", "v" + parambjif.b + "_" + str);
      a(BaseApplicationImpl.getApplication().getRuntime().getAccount(), parambjif.a + "_loadRes", paramBoolean, paramLong, 0L, localHashMap, "");
      return;
    }
  }
}
