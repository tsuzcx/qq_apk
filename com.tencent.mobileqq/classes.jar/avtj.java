...
class avtj
  extends ntf
{
  avtj(avti paramavti, int paramInt1, int paramInt2, avtl paramavtl) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    for (Object localObject = "null";; localObject = paramBundle.toString())
    {
      ...
      this.jdField_a_of_type_Avti.a(this.c, paramArrayOfByte, this.jdField_a_of_type_Int, this.jdField_a_of_type_Avtl);
      return;
    }
    avti.a(this.jdField_a_of_type_Avti, paramInt, null, paramBundle, this.jdField_a_of_type_Avtl);
    return;
    label162:
    ...
    try
    {
      ...
      if (((CommProtocolProto.commResponse)localObject).code.get() == 1008)
      {
        ...
        avti.a(this.jdField_a_of_type_Avti, this.c, paramArrayOfByte, true, this.jdField_a_of_type_Int - 1, this.jdField_a_of_type_Avtl);
        return;
      }
    }
    catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException1)
    {
      ...
      try
      {
        ...
        avti.a(this.jdField_a_of_type_Avti, localLoginCheckRsp);
        if (avti.a(this.jdField_a_of_type_Avti) == null)
        {
          QLog.i("ODCsChannel", 2, "login: fail，errorCode=" + paramInt + " data=" + Arrays.toString(paramArrayOfByte));
          if (this.jdField_a_of_type_Int > 0)
          {
            this.jdField_a_of_type_Avti.a(this.c, paramArrayOfByte, this.jdField_a_of_type_Int - 1, this.jdField_a_of_type_Avtl);
            return;
          }
        }
      }
      catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException2)
      {
        ...
        avti.a(this.jdField_a_of_type_Avti, paramInt, (CommProtocolProto.commResponse)localObject, paramBundle, this.jdField_a_of_type_Avtl);
        return;
      }
      if (QLog.isColorLevel()) {
        QLog.d("ODCsChannel", 2, new Object[] { "MSF.C.NetConnTag", " uid=" + localLoginCheckRsp.uid.get() + " user_sig=" + localLoginCheckRsp.user_sig.get() });
      }
      this.jdField_a_of_type_Avti.a(this.c, paramArrayOfByte, true, this.jdField_a_of_type_Int, this.jdField_a_of_type_Avtl);
    }
  }
}
