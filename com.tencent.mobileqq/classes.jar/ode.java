...
public class ode
  extends anii
{
  public ode(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b(byte[] paramArrayOfByte)
  {
    ...
    if ((paramArrayOfByte != null) && (paramArrayOfByte.bindlist.has()))
    {
      ...
      if ((paramArrayOfByte != null) && (!paramArrayOfByte.isEmpty()))
      {
        ...
        {
          oda.a.put(String.valueOf(paramArrayOfByte.puin.get()), String.valueOf(paramArrayOfByte.binduin.get()));
  ...
  public void a(String paramString)
  {
    ...
    paramString = new NewIntent(this.app.getApp(), odg.class);
