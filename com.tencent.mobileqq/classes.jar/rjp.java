...
public class rjp
  extends pmn
{
  public rjp(ReadInJoyDeliverUGCActivity paramReadInJoyDeliverUGCActivity) {}
  ...
  public void a(int paramInt1, long paramLong, String paramString1, int paramInt2, String paramString2, String paramString3)
  {
    ...
    if (paramInt1 == 0)
    {
      ReadInJoyDeliverUGCActivity.d(this.a, 2, this.a.getString(2131716995));
    ...
    try
    {
      ...
      ReadInJoyDeliverUGCActivity.a(this.a).put("comment", new String(bgku.encode(paramString1.getBytes(), 0)));
    ...
    for (;;)
    {
      ...
      oat.a(null, "CliOper", "", "", "0X800982D", "0X800982D", 0, 0, paramLong + "", "1", "", paramString1.toString(), false);
