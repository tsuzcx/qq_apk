  ...
  extends BaseAdapter
{
  ...
  public ance(EditVideoArtFilter paramEditVideoArtFilter, Context paramContext)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramViewGroup = new ancf(this);
      localView1 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130969056, null);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView1.findViewById(2131364856));
      paramViewGroup.jdField_a_of_type_AndroidViewView = localView1.findViewById(2131364855);
    ...
    for (;;)
    {
      ...
      return localView1;
      paramViewGroup = (ancf)paramView.getTag();
    ...
    if (paramView == null)
    {
      ...
      paramView = BitmapManager.a(this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoArtFilter.jdField_a_of_type_AndroidContentContext.getResources(), 2130839555, this.b, this.jdField_a_of_type_Int);
