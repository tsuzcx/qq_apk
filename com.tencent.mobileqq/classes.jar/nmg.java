  ...
  implements ViewTreeObserver.OnGlobalLayoutListener
{
  ...
  public nmg(View paramView, nmh paramnmh)
  {
    this(paramView, paramnmh, UIUtils.dip2px(paramView.getContext(), 160.0F));
  }
  
  public nmg(View paramView, nmh paramnmh, int paramInt)
  {
  ...
  public void a()
  {
    this.jdField_a_of_type_Nmh = null;
    try
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Nmh != null)
        {
          ...
          if (bool != this.jdField_a_of_type_Boolean)
          {
            ...
            this.jdField_a_of_type_Nmh.a(bool, localRect.right, localRect.bottom);
          }
        }
        return;
      }
