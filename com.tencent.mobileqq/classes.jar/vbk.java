...
public class vbk
  extends uzu
  implements TextureView.SurfaceTextureListener, bnht
{
  ...
  private void a()
  {
    if (uwz.a().a() != null)
    {
      ...
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnPreparedListener(new vbl(this));
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnErrorListener(new vbn(this));
      this.jdField_a_of_type_AndroidMediaMediaPlayer.setOnCompletionListener(new vbo(this));
  ...
  private void b()
  {
    ...
    localLayoutParams.topMargin = (((DisplayMetrics)localObject).heightPixels * 2 / 3 - bgtn.a(20.0F));
  ...
  private void c()
  {
    this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369299).setVisibility(0);
  ...
  private void d()
  {
    ...
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new vbq(this));
  ...
  private void g()
  {
    ...
    {
      ((AppActivity)a()).requestPermissions(new vbr(this), 0, new String[] { "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
      return;
    }
    h();
  }
  ...
  private void h()
  {
    ...
    localBundle.putInt("VIDEO_STORY_FROM_TYPE", bnqb.A.a());
  ...
  protected void a(View paramView)
  {
    ...
    this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)paramView.findViewById(2131373165));
    if ((this.jdField_b_of_type_Boolean) && (uwz.a().a()))
    {
      ThreadManager.excute(new QCircleFolderSplashPart.1(this), 16, null, true);
      this.jdField_a_of_type_AndroidViewViewStub = ((ViewStub)paramView.findViewById(2131373821));
      if (this.jdField_a_of_type_AndroidViewViewStub != null) {
        this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewStub.inflate());
      }
      this.jdField_a_of_type_AndroidViewTextureView = ((TextureView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131377766));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131363662));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131363663));
      this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131369240));
      this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131368137));
    ...
    for (;;)
    {
      ...
      a();
      d();
      vrf.a("", 19, this.jdField_a_of_type_Int);
      return;
      label283:
  ...
  public void onActivityStarted(Activity paramActivity)
  {
    ...
    for (;;)
    {
      try
      {
        this.jdField_a_of_type_AndroidMediaMediaPlayer.setDataSource(a(), uwz.a().a());
