  ...
  extends ajfb
{
  ...
  public mjk(QQAppInterface paramQQAppInterface)
  {
  ...
  public ToServiceMsg a(long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    paramLong1 = apck.b();
    long l = apck.a();
    Object localObject = new awbn();
    ((awbn)localObject).jdField_a_of_type_Int = paramInt2;
    ((awbn)localObject).jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    paramString = a(13, paramString, (awbn)localObject, l, awbk.b(paramLong1), paramLong2);
