  ...
  implements View.OnTouchListener
{
  ...
  public awlc(Context paramContext)
  {
    this.jdField_a_of_type_Bhap = new awlg(this);
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new awlh(this);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidWidgetTextView = new TextView(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_AndroidWidgetTextView.setOnTouchListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(amtj.a(2131704206));
  ...
  private void b()
  {
    ...
    for (;;)
    {
      ...
      localValueAnimator.addUpdateListener(new awle(this, localLayoutParams, localValueAnimator));
      ...
      localValueAnimator.addUpdateListener(new awlf(this, localLayoutParams, localValueAnimator));
      localValueAnimator.setDuration(200L);
      localValueAnimator.setTarget(this.jdField_a_of_type_AndroidWidgetTextView);
      localValueAnimator.start();
      return;
  ...
  public void a()
  {
    ...
    try
    {
      ...
      ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).removeObserver(this.jdField_a_of_type_Bhap);
      return;
    }
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, long paramLong, String paramString2)
  {
    ...
    Object localObject;
    if (!this.jdField_b_of_type_Boolean) {
      if (!lzb.c(this.jdField_a_of_type_AndroidContentContext))
      {
        if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130842281);
        try
        {
          ...
          if (paramInt1 == 0)
          {
            this.jdField_a_of_type_AndroidWidgetTextView.setText(amtj.a(2131704257));
            this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new awld(this, paramInt1, paramLong, paramString2, paramString1, paramInt2));
            ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).addObserver(this.jdField_a_of_type_Bhap);
            return;
            i = 2010;
          }
        }
        catch (Exception localException1)
        {
          for (;;)
          {
            ...
            continue;
            this.jdField_a_of_type_AndroidWidgetTextView.setText(amtj.a(2131704248));
          }
        }
      }
    }
