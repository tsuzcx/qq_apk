...
public class bqnd
  implements bqlu
{
  private bqnd(DoodleLayout paramDoodleLayout) {}
  ...
  public void a(DynamicTextItem paramDynamicTextItem, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      this.a.f();
      if (QLog.isColorLevel()) {
        QLog.d("DoodleLayout", 2, "raymondguo count " + localbqjx.b() + ", items:" + localbqjx.jdField_a_of_type_JavaUtilArrayList.size());
      }
      return;
      localbqjx.b(paramDynamicTextItem);
      paramInt = 1;
      continue;
      if (paramInt == 0)
      {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    this.a.jdField_a_of_type_Bqnc.q();
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      this.a.setTrackerState(this.a.a().jdField_a_of_type_Bqka, 0);
      return;
      DoodleLayout.a(this.a, new bqne(this, paramBoolean));
    }
  }
}
