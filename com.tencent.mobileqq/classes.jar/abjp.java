...
public abstract class abjp
  extends abkl
  implements abkc, bljm, bljn, bljo, bllv, bllw
{
  protected abjo a;
  protected abjt a;
  protected abkb a;
  ...
  public abjp(Activity paramActivity, abjt paramabjt)
  {
    this.jdField_a_of_type_Abkc = new abjq(this);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Abjt = paramabjt;
  }
  
  protected abjo a(Context paramContext)
  {
    return new abkh();
  }
  ...
  protected RelativeLayout a()
  {
    return (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131561408, null);
  }
  ...
  {
    if ((this.jdField_a_of_type_Abkb != null) && (this.jdField_a_of_type_Abkb.a())) {
      this.jdField_a_of_type_Abkb.b();
    }
    if ((this.jdField_a_of_type_Abkb != null) && (this.jdField_a_of_type_Abkb.b())) {
      this.jdField_a_of_type_Abkb.c();
    }
  ...
  public void a(ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      b((ViewGroup)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131376925));
      this.jdField_a_of_type_ComTencentWidgetGallery = ((Gallery)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131367342));
      this.d = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131363243);
      this.jdField_a_of_type_Abjo = a(this.jdField_a_of_type_AndroidAppActivity);
      if (this.jdField_a_of_type_Abjo != null) {
        this.jdField_a_of_type_Abjo.a(this.jdField_a_of_type_AndroidAppActivity, this, this.b);
      }
      this.jdField_a_of_type_Abkb = a();
      if (this.jdField_a_of_type_Abkb != null) {
        this.jdField_a_of_type_Abkb.a(this.jdField_a_of_type_AndroidAppActivity, this);
      }
      this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter = a(this.jdField_a_of_type_AndroidAppActivity);
      this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter.a(this.jdField_a_of_type_Abjt);
      if (this.jdField_a_of_type_Abkb != null)
      {
        this.jdField_a_of_type_ComTencentCommonGalleryactivityAbstractImageAdapter.a(this.jdField_a_of_type_Abkb);
        this.jdField_a_of_type_Abkb.a();
      }
      ...
      this.jdField_a_of_type_ComTencentWidgetGallery.setSpacing(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131297091));
      this.jdField_a_of_type_ComTencentWidgetGallery.setSelection(this.jdField_a_of_type_Abjt.b());
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localAlphaAnimation.setDuration(this.jdField_a_of_type_Abkg.a().a());
  ...
  public void b(boolean paramBoolean)
  {
    if (b())
    {
      a(paramBoolean, this.jdField_a_of_type_Abkg.a().b());
      return;
    }
  ...
  public void b(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localAlphaAnimation.setInterpolator(new blhp());
    localAlphaAnimation.setDuration(this.jdField_a_of_type_Abkg.a().a());
    ...
    localScaleAnimation.setDuration(this.jdField_a_of_type_Abkg.a().a());
    AnimationSet localAnimationSet = new AnimationSet(true);
    localAnimationSet.setFillAfter(true);
    localAnimationSet.addAnimation(localAlphaAnimation);
    localAnimationSet.addAnimation(localScaleAnimation);
    localAnimationSet.setAnimationListener(new abjs(this));
    this.d.startAnimation(localAlphaAnimation);
  ...
  public boolean d()
  {
    return this.jdField_a_of_type_Abkg.a().a();
  }
  ...
  public boolean e()
  {
    ...
    if (c()) {
      b(false, this.jdField_a_of_type_Abkg.a().c());
    }
    for (;;)
    {
  ...
  public void onItemSelected(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Abjo != null) && (a())) {
        this.jdField_a_of_type_Abjo.a(paramAdapterView, paramInt);
      }
      this.jdField_a_of_type_Abjt.a(paramInt);
      if ((!d()) && (this.jdField_a_of_type_Abkb != null) && (!this.jdField_a_of_type_Abkb.a())) {
        this.jdField_a_of_type_Abkb.a();
      }
  ...
  public void q()
  {
    if (this.jdField_a_of_type_Abkg.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Abkg.jdField_a_of_type_Boolean = false;
      return;
    }
    b(true, this.jdField_a_of_type_Abkg.jdField_a_of_type_Abjn.c());
  }
