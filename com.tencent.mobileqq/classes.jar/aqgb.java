...
public class aqgb
  extends aqbc
{
  ajvi jdField_a_of_type_Ajvi;
  private akim jdField_a_of_type_Akim = new aqgc(this);
  private bduv jdField_a_of_type_Bduv = new aqgd(this);
  ...
  public aqgb(Intent paramIntent)
  {
    super(paramIntent);
    this.jdField_c_of_type_Int = -1;
    this.jdField_b_of_type_Ajvl = new aqge(this);
  }
  ...
  private void G()
  {
    ...
    {
      bcpw.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131692321), 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298865));
    ...
    if (TroopInfo.isQidianPrivateTroop(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.k))
    {
      ...
      ((bduw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(85)).b(this.k, ((TroopInfo)localObject).troopowneruin);
      return;
    }
  ...
  public static final AbsShareMsg a(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    if (paramString2 == null)
    {
      ...
      paramString2 = ((axuk)localObject1).c(84).a(2).a(ajyc.a(2131704803) + paramQQAppInterface).a("plugin", "", "AppCmd://OpenContactInfo/?uin=", (String)localObject2, (String)localObject2).d(paramActivity.getResources().getString(2131718642)).a();
      localObject1 = new axxg();
      ((axuo)localObject1).b(1);
      ((axuo)localObject1).a(new axwq((String)localObject2));
      ((axuo)localObject1).a(new StructMsgItemTitle(paramQQAppInterface));
    ...
    {
      if (paramBoolean) {}
      for (paramActivity = ajyc.a(2131704826);; paramActivity = ajyc.a(2131704808))
      {
        paramQQAppInterface = new axzh(paramActivity + paramQQAppInterface);
        paramQQAppInterface.d(paramActivity + paramString1);
        ((axuo)localObject1).a(paramQQAppInterface);
        paramString2.addItem(a(ajyc.a(2131704833)));
        paramString2.addItem((axun)localObject1);
        return paramString2;
        paramQQAppInterface = paramString2.trim();
        break;
        paramString2 = "&headtext=" + URLEncoder.encode(bbcl.a(paramQQAppInterface));
        break label47;
      }
    }
  }
  ...
  private void a(CardOCRInfo paramCardOCRInfo)
  {
    ...
    for (;;)
    {
      ...
      localObject2 = ((axuk)localObject2).c(73).a(this.jdField_a_of_type_AndroidAppActivity.getString(2131698604, new Object[] { paramCardOCRInfo.a })).a(2).a("shareBusinessCard", "", (String)localObject3, (String)localObject3, (String)localObject3).d(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131719422)).a();
      localObject3 = new axym();
      ((axuo)localObject3).b(1);
      ((axuo)localObject3).a(this.jdField_a_of_type_AndroidAppActivity.getString(2131698601));
      axxg localaxxg = new axxg();
      localaxxg.b(3);
      localaxxg.a(new axwq(paramCardOCRInfo.jdField_b_of_type_JavaLangString + "/?02"));
      localaxxg.a(new StructMsgItemTitle(paramCardOCRInfo.a));
      localaxxg.a(new axzh((String)localObject1));
      ((AbsShareMsg)localObject2).addItem((axun)localObject3);
      ((AbsShareMsg)localObject2).addItem(localaxxg);
      ...
      amew.a(paramCardOCRInfo.jdField_b_of_type_JavaLangString);
      this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg = axuy.a(((StructMsgForImageShare)axuy.a((Bundle)localObject1)).getBytes());
  ...
  {
    if (!bdto.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1)) {}
    do
    {
      return;
      localObject1 = ((ajxn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(paramString1);
    ...
    Object localObject1 = bdto.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1);
    if (TextUtils.isEmpty((CharSequence)localObject1)) {}
    for (;;)
    {
      localObject1 = ((axuk)localObject2).c(14).a(2).a(1).a(ajyc.a(2131704823) + paramString2).a("plugin", str4, "", str2, str3).d(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131718638)).a();
      localObject2 = new axxg();
      ((axuo)localObject2).b(1);
      ((axuo)localObject2).a(new axwq(str1));
      ((axuo)localObject2).a(new StructMsgItemTitle(paramString2));
      ((axuo)localObject2).a(new axzh(ajyc.a(2131704835) + bdto.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1)));
      ((AbsShareMsg)localObject1).addItem(a(ajyc.a(2131704827)));
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    int i1 = ((ajvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53)).a(paramString);
    ...
    x();
    bcpw.a(this.jdField_a_of_type_AndroidAppActivity, -1, ajyc.a(2131704831), 0).b(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131298865));
  }
  ...
  private View b()
  {
    ...
    {
      new RelativeLayout.LayoutParams(-1, -2).setMargins(actn.a(-15.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, actn.a(-15.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0);
      if (QLog.isColorLevel()) {
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    Object localObject1 = bbcl.i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1);
    if (TextUtils.isEmpty((CharSequence)localObject1)) {}
    for (;;)
    {
      localObject1 = ((axuk)localObject2).c(14).a(2).a(1).a(ajyc.a(2131704821) + paramString2).a("plugin", "", str2, str1, str1).d(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131718638)).a();
      localObject2 = new axxg();
      ((axuo)localObject2).b(1);
      ((axuo)localObject2).a(new axwq(str1));
      ((axuo)localObject2).a(new StructMsgItemTitle(paramString2));
      ((axuo)localObject2).a(new axzh(ajyc.a(2131704787) + paramString1));
      ((AbsShareMsg)localObject1).addItem(a(ajyc.a(2131704797)));
      ((AbsShareMsg)localObject1).addItem((axun)localObject2);
      this.jdField_a_of_type_AndroidOsBundle.putByteArray("stuctmsg_bytes", ((AbsShareMsg)localObject1).getBytes());
      this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg = ((AbsShareMsg)localObject1);
      l();
  ...
  {
    AbsShareMsg localAbsShareMsg = new axuk(StructMsgForGeneralShare.class).c(15).a(ajyc.a(2131704813) + this.jdField_l_of_type_JavaLangString).e(this.jdField_j_of_type_JavaLangString).a();
    Object localObject = (ajvk)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(53);
    if (localObject != null)
    {
      localObject = ((ajvk)localObject).a(paramString1);
      if (localObject == null) {}
    }
    for (paramString1 = bbcl.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, ((DiscussionInfo)localObject).ownerUin);; paramString1 = null)
    {
      localObject = paramString1;
      if (TextUtils.isEmpty(paramString1)) {
        localObject = ajyc.a(2131704809);
      }
      paramString1 = axux.a(2);
      paramString1.a(paramString2, this.jdField_l_of_type_JavaLangString, ajyc.a(2131704832) + (String)localObject, 1);
      localAbsShareMsg.addItem(a(ajyc.a(2131704793)));
  ...
  private void e()
  {
    ...
    for (;;)
    {
      String str2 = bahh.a("", this.k, 0) + "100";
      AbsShareMsg localAbsShareMsg = new axuk(StructMsgForGeneralShare.class).c(15).a(this.jdField_a_of_type_AndroidAppActivity.getString(2131718645) + str1).e(this.jdField_h_of_type_JavaLangString).a();
      axuo localaxuo = axux.a(2);
      Object localObject1 = this.jdField_a_of_type_AndroidAppActivity.getString(2131719513);
      ...
      for (;;)
      {
        localaxuo.a(str2, str1, (String)localObject1, 1);
        localAbsShareMsg.addItem(a(ajyc.a(2131704795)));
  ...
  protected View a()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsStructMsg != null)
      {
        ...
        continue;
        localView1 = a(String.format("[%s]%s", new Object[] { ajyc.a(2131704811), this.q }), baxt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, this.p));
        continue;
        localView1 = a(String.format("[%s]%s", new Object[] { ajyc.a(2131704836), this.q }), baxt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 11, this.p));
        continue;
        localView1 = a(String.format("[%s]%s", new Object[] { ajyc.a(2131704806), this.q }), baxt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 4, this.p));
        continue;
        localView1 = a(String.format("[%s]%s", new Object[] { ajyc.a(2131704820), this.q }), baxt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 101, this.p));
        continue;
        localView1 = b();
      }
    }
  ...
  protected void a()
  {
    ...
    int i1 = ((askl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(11)).d();
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Ajvi.a(Long.parseLong(this.p), true);
      a(2131694930);
      continue;
      this.k = null;
      this.jdField_l_of_type_JavaLangString = null;
  ...
  public boolean a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_b_of_type_Ajvl);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bduv);
    this.jdField_a_of_type_Ajvi = ((ajvi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(6));
  ...
  protected boolean a(bbgg parambbgg)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg != null)
      {
        ...
        localLayoutParams.setMargins(actn.a(-15.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, actn.a(-15.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0);
        if (QLog.isColorLevel()) {
          QLog.d("ForwardOption.ForwardShareCardOption", 2, "updateImageView addStructView");
        }
  ...
  public String b()
  {
    return this.jdField_a_of_type_AndroidAppActivity.getString(2131719423);
  }
  ...
  protected void d()
  {
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80056B4", "0X80056B4", 0, 0, "", "", "", "");
    super.d();
    if (this.jdField_i_of_type_Boolean) {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8007013", "0X8007013", 0, 0, "", "", "", "");
    }
  }
  ...
  protected void r()
  {
    super.r();
    if (this.jdField_i_of_type_Boolean) {
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8007012", "0X8007012", 0, 0, "", "", "", "");
    }
  }
  ...
  public void w()
  {
    ...
    if (this.jdField_b_of_type_Ajvl != null) {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_b_of_type_Ajvl);
    }
