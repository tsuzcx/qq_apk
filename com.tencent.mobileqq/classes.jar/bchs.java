...
public class bchs
{
  public static final String a = bbvj.a(ajsd.aW + "tencent/MobileQQ/webso/offline/");
  public static String b;
  public static final String c = BaseApplication.getContext().getFilesDir() + "/webso/offline/";
  
  public static String a()
  {
    Object localObject = "Android Qzone/" + bgyi.a();
    String str;
    switch (naj.a())
    {
    case 0: 
    ...
    for (;;)
    {
      ...
      ((StringBuilder)localObject).append(" ").append("QQ/").append("8.3.0").append(".").append("4480").append(str).append(" Pixel/").append(BaseApplicationImpl.getContext().getResources().getDisplayMetrics().widthPixels).append(" StatusBarHeight/" + i);
  ...
  public static boolean a(byte[] paramArrayOfByte, String paramString)
  {
    ...
    //   16: astore 7
    //   18: ldc_w 315
    //   21: invokestatic 200	bchs:a	(Ljava/lang/String;)V
    //   24: aload_0
    //   25: ifnull +10 -> 35
    //   28: aload_1
