  ...
  extends bdjz
{
  ...
  private afil jdField_a_of_type_Afil = new bdjv(this);
  private ArkViewImplement.LoadCallback jdField_a_of_type_ComTencentArkArkViewImplement$LoadCallback = new bdjw(this);
  ...
  public bdju(Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
  }
  
  private afii a(bdjx parambdjx)
  {
    this.jdField_a_of_type_Afii = new afih();
    ...
    if (QLog.isDebugVersion()) {
      QLog.d("QQCustomArkDialog", 4, "w=" + i + ",h=" + j + ", appName:" + parambdjx.jdField_a_of_type_JavaLangString);
    }
    this.jdField_a_of_type_Afii.a(parambdjx.jdField_a_of_type_JavaLangString, parambdjx.b, parambdjx.c, parambdjx.d, parambdjx.jdField_a_of_type_Float, parambdjx.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    if ((this.e != 0) && (this.f != 0)) {
      this.jdField_a_of_type_Afii.setFixSize(this.e, this.f);
    }
    for (;;)
    {
      ankc.a = false;
      return this.jdField_a_of_type_Afii;
      this.jdField_a_of_type_Afii.setFixSize(this.d, this.g);
      this.jdField_a_of_type_Afii.setMaxSize(this.d, this.jdField_a_of_type_Int);
      this.jdField_a_of_type_Afii.setMinSize(this.b, this.c);
    }
  }
  ...
  {
    paramBundle = a(new bdjx(paramBundle));
