...
{
  private static bcer jdField_a_of_type_Bcer;
  ...
  public Handler a;
  private RecyclablePool jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool = new RecyclablePool(bces.class, 5);
  ...
  private LinkedHashMap<String, bces> jdField_a_of_type_JavaUtilLinkedHashMap = new LinkedHashMap(4);
  private LinkedList<bces> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  ...
  public static bcer a()
  {
    if (jdField_a_of_type_Bcer == null) {}
    try
    {
      if (jdField_a_of_type_Bcer == null) {
        jdField_a_of_type_Bcer = new bcer();
      }
      return jdField_a_of_type_Bcer;
    }
    finally {}
  }
  
  private void a(bces parambces)
  {
    if ((parambces.jdField_a_of_type_Int > 0) && (Math.random() < 0.1500000059604645D)) {
      if (parambces.jdField_c_of_type_JavaLangString == null)
      {
        if (this.c >= 20) {
          break label704;
        }
    ...
    for (int i = 1;; i = 0) {
      for (;;)
      {
        if (i != 0)
        {
          ...
          localHashMap.put("stage", parambces.jdField_a_of_type_JavaLangString);
          localHashMap.put("nestStage", parambces.jdField_c_of_type_JavaLangString);
          localHashMap.put("fromStage", parambces.jdField_b_of_type_JavaLangString);
          ...
          localHashMap.put("startPss", String.valueOf(parambces.g / 1024L));
          localHashMap.put("startHeap", String.valueOf(parambces.jdField_a_of_type_Long / 1024L));
          localHashMap.put("startCache", String.valueOf(parambces.jdField_c_of_type_Long / 1024L));
          localHashMap.put("startNativePss", String.valueOf(parambces.h / 1024L));
          if (parambces.jdField_a_of_type_Int > 0)
          {
            localHashMap.put("avgPss", String.valueOf(parambces.k / parambces.jdField_a_of_type_Int / 1024L));
            localHashMap.put("avgHeap", String.valueOf(parambces.m / parambces.jdField_a_of_type_Int / 1024L));
            localHashMap.put("avgNativePss", String.valueOf(parambces.l / parambces.jdField_a_of_type_Int / 1024L));
          }
          localHashMap.put("maxPss", String.valueOf(parambces.n / 1024L));
          localHashMap.put("maxNativePss", String.valueOf(parambces.o / 1024L));
          localHashMap.put("maxHeap", String.valueOf(parambces.p / 1024L));
          localHashMap.put("endPss", String.valueOf(parambces.i / 1024L));
          localHashMap.put("endNativePss", String.valueOf(parambces.j / 1024L));
          localHashMap.put("endHeap", String.valueOf(parambces.d / 1024L));
          localHashMap.put("endCache", String.valueOf(parambces.f / 1024L));
          if (parambces.jdField_a_of_type_Boolean)
          {
            ??? = "0";
        ...
        {
          QLog.d("SceneTracker", 2, new Object[] { parambces.jdField_a_of_type_JavaLangString, "alloc:", Long.valueOf(parambces.jdField_a_of_type_Long), "->", Long.valueOf(parambces.d), "; free:", Long.valueOf(parambces.jdField_b_of_type_Long), "->", Long.valueOf(parambces.e) });
        }
        synchronized (this.jdField_a_of_type_JavaUtilLinkedHashMap)
        {
          if (!this.jdField_a_of_type_JavaUtilLinkedList.contains(parambces)) {
            this.jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool.recycle(parambces);
          }
          return;
          if (this.b < 20)
          {
  ...
  private boolean a(MemoryManager.DebugMemoryInfo paramDebugMemoryInfo, long paramLong1, long paramLong2, bces parambces)
  {
    synchronized (this.jdField_a_of_type_JavaUtilLinkedHashMap)
    {
      ...
      {
        bces localbces = (bces)localIterator.next();
        if (localbces != parambces)
        {
          localbces.m += paramLong1;
          localbces.l = paramDebugMemoryInfo.nativePss;
          localbces.k += paramDebugMemoryInfo.pss;
          localbces.n = Math.max(paramDebugMemoryInfo.pss, localbces.n);
          localbces.jdField_a_of_type_Int += 1;
          localbces.o = Math.max(paramDebugMemoryInfo.nativePss, localbces.o);
          localbces.p = Math.max(paramLong1, localbces.p);
        }
      }
    }
      ...
      try
      {
        for (;;)
        {
          synchronized (this.jdField_a_of_type_JavaUtilLinkedHashMap)
          {
            ...
            if (i >= 0)
            {
              bces localbces = (bces)this.jdField_a_of_type_JavaUtilLinkedList.get(i);
              long l1;
              if (localbces.d == 0L)
              {
                ...
                if (localbces.e == 0L)
                {
                  ...
                  localStringBuilder.append(localbces.jdField_a_of_type_JavaLangString).append("(From ").append(localbces.jdField_b_of_type_JavaLangString).append(")").append(":Alloc ").append(localbces.jdField_a_of_type_Long).append("->").append(l1).append(";Free ").append(localbces.jdField_b_of_type_Long).append("->").append(l2).append("|");
                  i -= 1;
                }
              }
              else
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    bces localbces2 = (bces)this.jdField_a_of_type_ComTencentCommonsdkPoolRecyclablePool.obtain(bces.class);
    localbces2.jdField_a_of_type_JavaLangString = paramString;
    if (!this.jdField_a_of_type_JavaUtilSet.contains(paramString)) {}
    for (boolean bool = true;; bool = false)
    {
      localbces2.jdField_a_of_type_Boolean = bool;
      if (localbces2.jdField_a_of_type_Boolean) {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilLinkedHashMap)
      {
        ...
        Iterator localIterator = this.jdField_a_of_type_JavaUtilLinkedHashMap.values().iterator();
        while (localIterator.hasNext()) {
          localbces1 = (bces)localIterator.next();
        }
        if (localbces1 == null) {
          return;
        }
      }
      localbces2.jdField_b_of_type_JavaLangString = localbces1.jdField_a_of_type_JavaLangString;
      if (localbces1.jdField_c_of_type_JavaLangString == null) {
        localbces1.jdField_c_of_type_JavaLangString = localbces2.jdField_a_of_type_JavaLangString;
      }
      label172:
      this.jdField_a_of_type_JavaUtilLinkedHashMap.put(paramString, localbces2);
      if (this.jdField_a_of_type_JavaUtilLinkedList.size() > 8)
      {
        paramString = (bces)this.jdField_a_of_type_JavaUtilLinkedList.remove(0);
      ...
      this.jdField_a_of_type_JavaUtilLinkedList.add(localbces2);
      this.jdField_a_of_type_AndroidOsHandler.removeMessages(2);
      if (this.jdField_a_of_type_Int == 1)
      {
        localbces2.jdField_a_of_type_Long = (Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory());
        localbces2.jdField_b_of_type_Long = Runtime.getRuntime().freeMemory();
        return;
      }
  ...
  public void b(String paramString)
  {
    ...
    do
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilLinkedHashMap)
      {
        paramString = (bces)this.jdField_a_of_type_JavaUtilLinkedHashMap.remove(paramString);
        if (paramString == null) {
          return;
        }
      }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    {
      this.jdField_a_of_type_AndroidOsHandler.removeMessages(2);
      paramMessage = (bces)paramMessage.obj;
