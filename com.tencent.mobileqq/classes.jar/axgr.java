  ...
  implements Manager
{
  ...
  public axgr(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Axgz = new axgz(paramQQAppInterface);
  }
  ...
  private void a(ChatMessage paramChatMessage, String paramString1, String paramString2, String paramString3, ammo paramammo)
  {
    if ((!this.jdField_a_of_type_Axgz.a()) && (QLog.isColorLevel()))
    {
    ...
    this.jdField_a_of_type_Axgz.a(paramChatMessage);
    new Handler(ThreadManager.getSubThreadLooper()).postDelayed(new AIOMessageSpreadManager.2(this, paramChatMessage, paramString1, paramammo, paramString2, paramString3), 1000L);
  }
  ...
  {
    boolean bool2 = false;
    int i = this.jdField_a_of_type_Axgz.a();
    int j = ammp.a().a();
    boolean bool1;
    if (j == 0)
    {
  ...
  {
    this.jdField_a_of_type_Axgz.a(paramammm);
  }
    ...
    do
    {
      ...
      catch (Exception localException1)
      {
        ...
        if (((String)localObject3).equalsIgnoreCase("keyword")) {
          awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009078", "0X8009078", 0, 0, "", "", "", "");
        }
        while ((localException1 instanceof MessageForFile))
        {
          ...
          if (paramChatMessage == null)
          {
            ...
            if (((String)localObject3).equalsIgnoreCase("precent")) {
              awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800907B", "0X800907B", 0, 0, "", "", "", "");
            } else if (((String)localObject3).equalsIgnoreCase("text_keyword")) {
              awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009072", "0X800907B", 0, 0, "", "", "", "");
            }
          }
          else
          {
            axea.a(paramChatMessage, paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 2);
            return;
          }
        }
      }
      if ((localException1 instanceof MessageForTroopFile))
      {
        ...
        localObject2 = azjg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
        localObject3 = new TeamWorkFileImportInfo();
        ((TeamWorkFileImportInfo)localObject3).c = ((ayqd)localObject2).jdField_a_of_type_JavaLangString;
        ((TeamWorkFileImportInfo)localObject3).jdField_b_of_type_JavaLangString = ((ayqd)localObject2).g;
        ((TeamWorkFileImportInfo)localObject3).j = apck.a(((ayqd)localObject2).g);
        ...
        ((TeamWorkFileImportInfo)localObject3).jdField_d_of_type_JavaLangString = ((ayqd)localObject2).jdField_e_of_type_JavaLangString;
        ((TeamWorkFileImportInfo)localObject3).jdField_b_of_type_Int = ((ayqd)localObject2).h;
        ...
        axea.a((TeamWorkFileImportInfo)localObject3, paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((TeamWorkFileImportInfo)localObject3).jdField_d_of_type_Int);
        return;
      }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      QLog.e("AIOMessageSpreadManager", 1, apck.a());
      return;
    }
    if (QLog.isColorLevel()) {
