...
{
  bned jdField_a_of_type_Bned;
  
  public bnef(bnec parambnec, bned parambned)
  {
    this.jdField_a_of_type_Bned = parambned;
  }
  
  public void onDownloadCanceled(String paramString)
  {
    paramString = Message.obtain(this.jdField_a_of_type_Bnec.a, 2);
    paramString.obj = this.jdField_a_of_type_Bned;
    paramString.sendToTarget();
  }
  
  public void onDownloadFailed(String paramString, DownloadResult paramDownloadResult)
  {
    paramString = Message.obtain(this.jdField_a_of_type_Bnec.a, 3);
    paramString.obj = this.jdField_a_of_type_Bned;
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramDownloadResult != null)
        {
          ...
          this.jdField_a_of_type_Bned.jdField_a_of_type_Int = paramDownloadResult.retCode;
        }
      }
  ...
  public void onDownloadProgress(String paramString, long paramLong, float paramFloat)
  {
    ...
    if (this.jdField_a_of_type_Bned != null) {
      this.jdField_a_of_type_Bned.jdField_a_of_type_Float = i;
    }
    paramString = Message.obtain(this.jdField_a_of_type_Bnec.a, 5);
    paramString.obj = this.jdField_a_of_type_Bned;
    paramString.sendToTarget();
  }
  ...
  public void onDownloadSucceed(String paramString, DownloadResult paramDownloadResult)
  {
    ...
    paramString = Message.obtain(this.jdField_a_of_type_Bnec.a, 4);
    paramString.obj = this.jdField_a_of_type_Bned;
    paramString.sendToTarget();
  }
}
