  ...
  extends ReportDialog
{
  ...
  public bitc(Context paramContext, Intent paramIntent)
  {
    super(paramContext, 2131755832);
    String str2 = paramIntent.getStringExtra("qzone_plugin_activity_name");
    Object localObject1 = LayoutInflater.from(paramContext).inflate(2131562519, null);
    Object localObject2 = getWindow();
    ((Window)localObject2).setWindowAnimations(2131755827);
    ...
    this.a = ((TextView)((View)localObject1).findViewById(2131371603));
    localObject2 = paramIntent.getStringExtra("leftViewText");
    if (localObject2 == null) {
      localObject2 = paramContext.getString(2131690676);
    }
    for (;;)
    {
      if ("com.qzone.album.business.albumlist.activity.QZonePersonalAlbumActivity".equals(str2))
      {
        localObject3 = ((ViewStub)((View)localObject1).findViewById(2131378393)).inflate();
        localObject1 = paramIntent.getStringExtra("key_left_tab_title");
        if (!TextUtils.isEmpty((CharSequence)localObject1)) {
          break label917;
        }
        localObject1 = paramContext.getString(2131716909);
      }
      label917:
      for (;;)
      {
        ...
        for (paramContext = paramContext.getString(2131716990);; paramContext = paramIntent)
        {
          paramIntent = (ExtendButton)((View)localObject3).findViewById(2131363848);
          Object localObject4 = (ExtendButton)((View)localObject3).findViewById(2131363849);
          ...
          ((TextView)paramContext.findViewById(2131369231)).setText((CharSequence)localObject2);
          ((ProgressBar)((ViewStub)paramContext.findViewById(2131369292)).inflate()).setVisibility(0);
          return;
          localObject4 = ((ViewStub)((View)localObject1).findViewById(2131364985)).inflate();
          TextView localTextView = (TextView)((ViewStub)((View)localObject4).findViewById(2131369278)).inflate();
          String str1 = "";
          long l;
          if ("com.qzone.homepage.ui.activity.QZoneUserHomeActivity".equals(str2))
          {
            ...
            {
              localObject1 = anvx.a(2131711662);
          ...
          for (;;)
          {
            ...
            {
              localObject1 = paramContext.getString(2131717136);
              localObject3 = paramContext.getString(2131717060);
            }
            else if ("com.qzone.cover.ui.activity.QzoneCoverPhotoWallActivity".equals(str2))
            {
              localObject1 = paramContext.getString(2131717034);
              localObject3 = localObject2;
            }
            else if ("com.qzone.cover.ui.activity.QZoneCoverStoreActivity".equals(str2))
            {
              localObject1 = paramContext.getString(2131717035);
              localObject3 = localObject2;
            }
            else if ("com.qzone.detail.ui.activity.QzoneDetailActivity".equals(str2))
            {
              ...
              {
                localObject3 = paramContext.getString(2131698852);
                localObject1 = str1;
              }
            }
            else if ("com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity".equals(str2))
            {
              str1 = paramContext.getString(2131717512);
              ...
              if (!TextUtils.isEmpty(paramIntent))
              {
                ...
                for (;;)
                {
                  ...
                  case 8: 
                  case 11: 
                    localObject1 = paramContext.getString(2131717427);
                    localObject3 = localObject2;
                    break;
            ...
            {
              localObject1 = paramContext.getString(2131717452);
              localObject3 = localObject2;
            }
            else if ("com.qzone.setting.QZoneSettingManager".equals(str2))
            {
              localObject1 = paramContext.getString(2131717461);
              localObject3 = localObject2;
            }
            else if ("com.qzone.album.business.photolist.activity.QZonePersonalPhotoListActivity".equals(str2))
            {
              ...
              {
                localObject1 = paramIntent + anvx.a(2131711661);
                localObject3 = localObject2;
              }
              else
              {
            ...
            {
              localObject1 = paramContext.getString(2131717379);
              localObject3 = localObject2;
            }
            else
            {
              ...
              {
                localObject1 = paramContext.getString(2131717268);
                localObject3 = localObject2;
              }
            }
          }
  ...
  public void setOnDismissListener(@Nullable DialogInterface.OnDismissListener paramOnDismissListener)
  {
    ...
    super.setOnDismissListener(new bitd(paramOnDismissListener));
  }
}
