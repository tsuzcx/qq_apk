  ...
  extends azqj
{
  ...
  public azux()
  {
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new azuy(this);
    this.jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new azuz(this);
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramBundle = paramBundle.getDrawable(2130841414);
        if (TextUtils.isEmpty(this.S))
        {
          ...
          paramView.setContentDescription(paramBundle.getString(2131694904));
          paramView.setDisplayRuleDef(bekg.a);
          paramView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
          paramView.setContentDescription(paramBundle.getText(2131720338));
        }
      }
  ...
  public boolean a(azsa paramazsa)
  {
    ...
    this.U = paramazsa.a("video_info");
    this.j = paramazsa.a("index");
    this.k = paramazsa.a("index_name");
    this.l = paramazsa.a("index_type");
    return true;
  }
}
