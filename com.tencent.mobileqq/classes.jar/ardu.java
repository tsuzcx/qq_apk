...
public class ardu
{
  private static ardu jdField_a_of_type_Ardu;
  private int jdField_a_of_type_Int;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
  private arch jdField_a_of_type_Arch = new ardv(this);
  ...
  private Vector<ardw> jdField_a_of_type_JavaUtilVector = new Vector();
  private CopyOnWriteArrayList<aqyp> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  
  public static ardu a()
  {
    if (jdField_a_of_type_Ardu == null) {}
    try
    {
      if (jdField_a_of_type_Ardu == null) {
        jdField_a_of_type_Ardu = new ardu();
      }
      return jdField_a_of_type_Ardu;
    }
    finally {}
  }
  ...
  private void c()
  {
    ...
    while (localIterator.hasNext()) {
      ((aqyp)localIterator.next()).onBindedToClient();
    }
  }
  ...
  private void d()
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext()) {
      ((aqyp)localIterator.next()).onDisconnectWithService();
    }
  }
  ...
  private void e()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqEmosmWebEmojiIPCAlarmer == null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmosmWebEmojiIPCAlarmer = new EmojiIPCAlarmer(this.jdField_a_of_type_Arch);
  ...
  private void f(Bundle paramBundle)
  {
    ...
    Iterator localIterator = this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
    while (localIterator.hasNext()) {
      ((aqyp)localIterator.next()).onPushMsg(paramBundle);
    }
  }
  ...
  public ardw a(int paramInt)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      ...
      while (localIterator.hasNext())
      {
        ardw localardw = (ardw)localIterator.next();
        if (localardw.jdField_a_of_type_Int == paramInt)
        {
          if (QLog.isColorLevel()) {
            QLog.i("Q.emoji.web.EmoWebIPCOperator", 2, "remove req queue seq:" + paramInt);
          }
          this.jdField_a_of_type_ComTencentMobileqqEmosmWebEmojiIPCAlarmer.a(localardw.jdField_a_of_type_JavaLangRunnable);
          this.jdField_a_of_type_JavaUtilVector.remove(localardw);
          if (QLog.isColorLevel()) {
  ...
  public ardw a(Bundle paramBundle)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      int i = this.jdField_a_of_type_Int;
      this.jdField_a_of_type_Int = (i + 1);
      paramBundle = new ardw(i, paramBundle);
      e();
      if (QLog.isColorLevel()) {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      } while ((localObject == null) || ((this.jdField_a_of_type_ComTencentMobileqqEmosmClient != null) && (this.jdField_a_of_type_ComTencentMobileqqEmosmClient.onReqToServer(((ardw)localObject).jdField_a_of_type_AndroidOsBundle))));
  ...
  public void a(aqyp paramaqyp)
  {
    ...
    do
    {
      return;
      if (QLog.isColorLevel()) {
        QLog.i("Q.emoji.web.EmoWebIPCOperator", 2, "RegisterObserver key:" + paramaqyp.key);
      }
    } while (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(paramaqyp));
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramaqyp);
  }
  ...
  public void b(aqyp paramaqyp)
  {
    if (paramaqyp != null)
    {
      if (QLog.isColorLevel()) {
        QLog.i("Q.emoji.web.EmoWebIPCOperator", 2, "unRegisterObserver key:" + paramaqyp.key);
      }
      if (this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.contains(paramaqyp)) {
        this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(paramaqyp);
      }
    }
  }
  ...
  public void e(Bundle paramBundle)
  {
    ...
    while (((Iterator)localObject).hasNext()) {
      ((aqyp)((Iterator)localObject).next()).onResponse(paramBundle);
    }
  }
}
