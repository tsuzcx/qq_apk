...
{
  static final String jdField_a_of_type_JavaLangString = sxp.a("StoryGroupSvc.do_group_video_forward");
  public int a;
  akav jdField_a_of_type_Akav = new vwv(this);
  public Handler a;
  public QQAppInterface a;
  public MessageForTroopStory a;
  mxk jdField_a_of_type_Mxk = new vwu(this);
  protected boolean a;
  public int b;
  public String b;
  public int c;
  ...
  private vwt(QQAppInterface paramQQAppInterface, Bundle paramBundle, SessionInfo paramSessionInfo)
  {
  ...
  private vwt(QQAppInterface paramQQAppInterface, MessageForTroopStory paramMessageForTroopStory)
  {
  ...
  public static vwt a(QQAppInterface paramQQAppInterface, Bundle paramBundle, SessionInfo paramSessionInfo)
  {
    try
    {
      paramQQAppInterface = new vwt(paramQQAppInterface, paramBundle, paramSessionInfo);
  ...
  public static vwt a(QQAppInterface paramQQAppInterface, MessageForTroopStory paramMessageForTroopStory)
  {
    return new vwt(paramQQAppInterface, paramMessageForTroopStory);
  }
  ...
  public void b()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        mxi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Mxk, localReqGroupVideoForward.toByteArray(), jdField_a_of_type_JavaLangString);
        return;
      }
  ...
  public void c()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(this.jdField_a_of_type_ComTencentMobileqqDataMessageForTroopStory, this.jdField_a_of_type_Akav);
  }
