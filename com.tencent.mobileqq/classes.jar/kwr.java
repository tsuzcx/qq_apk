...
public abstract class kwr<T1 extends MessageMicro, T2 extends MessageMicro>
{
  ...
  {
    Object localObject = kwo.a(this);
    ((kwq)localObject).a("QAVMessageHandler", paramLong);
    if ((((kwq)localObject).a != null) && (((kwq)localObject).b != null)) {}
    try
    {
      MessageMicro localMessageMicro = (MessageMicro)((kwq)localObject).a.newInstance();
      localObject = (MessageMicro)((kwq)localObject).b.newInstance();
