...
public class rcx
{
  ...
  private static volatile rcx jdField_a_of_type_Rcx;
  ...
  public rcx()
  {
    this.jdField_a_of_type_Rcy = null;
  }
  
  public static rcx a()
  {
    if (jdField_a_of_type_Rcx == null) {}
    try
    {
      if (jdField_a_of_type_Rcx == null) {
        jdField_a_of_type_Rcx = new rcx();
      }
      return jdField_a_of_type_Rcx;
    }
    finally {}
  }
  ...
  {
    return jdField_a_of_type_Rcx != null;
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      localJSONObject.put("articles_request_type", ooq.a());
      if (!ooq.b()) {
        break label312;
      }
      i = 1;
    ...
    if (this.jdField_b_of_type_Boolean) {
      ndn.a(null, "", "0X8009296", "0X8009296", 0, 0, String.valueOf((NetConnInfoCenter.getServerTimeMillis() - this.jdField_b_of_type_Long) / 1000.0D), "", "", localJSONObject.toString(), false);
    }
    for (;;)
    {
      ooq.a(false);
      ...
      str = "0";
      break;
      ndn.a(null, "", "0X80089D1", "0X80089D1", 0, 0, String.valueOf((NetConnInfoCenter.getServerTimeMillis() - this.jdField_b_of_type_Long) / 1000.0D), "", "", localJSONObject.toString(), false);
    }
  }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_Rcy == null) {
      this.jdField_a_of_type_Rcy = new rcy(this, null);
    }
