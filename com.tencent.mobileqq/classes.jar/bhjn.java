...
public class bhjn
{
  ...
  public bhjn(QQAppInterface paramQQAppInterface, Context paramContext, Handler paramHandler)
  {
    ...
    bhjq.a(paramContext, this.jdField_a_of_type_JavaUtilMap);
  }
  ...
  private void a(UPDATE_INFO paramUPDATE_INFO, PluginRecord paramPluginRecord)
  {
    ...
    paramPluginRecord.mInstalledPath = bhjq.a(BaseApplicationImpl.getContext(), paramPluginRecord.id).getAbsolutePath();
  }
  
  private void a(PluginRecord paramPluginRecord)
  {
    File localFile = bhjq.c(BaseApplicationImpl.getContext(), paramPluginRecord.id);
    if ((localFile != null) && (localFile.exists())) {
      localFile.delete();
    }
    bhjq.a(paramPluginRecord);
    LpReportInfo_dc01500.reportConfig(paramPluginRecord.id, paramPluginRecord.old_ver, paramPluginRecord.ver, 0);
  }
  
  private void a(String paramString)
  {
    paramString = bhjq.c(BaseApplicationImpl.getContext(), paramString);
  ...
  {
    PluginIntent localPluginIntent = new PluginIntent(BaseApplicationImpl.getContext(), bhhq.class);
    localPluginIntent.a = a();
    localPluginIntent.b = bhgc.a().a();
    localPluginIntent.a(new bhjo(this));
  ...
  public void a(bhjp parambhjp)
  {
    this.jdField_a_of_type_Bhjp = parambhjp;
  }
