...
public class npy
{
  ...
  public static void a(BaseActivity paramBaseActivity, String paramString1, String paramString2, String paramString3, Bitmap paramBitmap, boolean paramBoolean, String paramString4, shf paramshf)
  {
    int k = 0;
    int j = 0;
      ...
      for (paramString1 = "";; paramString1 = paramString2)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            paramshf = new npz(paramString2, paramshf);
            WXShareHelper.a().a(paramshf);
