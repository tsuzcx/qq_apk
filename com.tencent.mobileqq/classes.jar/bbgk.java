...
public class bbgk
  extends Dialog
  implements View.OnClickListener, apuc, bequ
{
  protected int a;
  protected long a;
  protected Handler a;
  ...
  public bbgk(BaseActivity paramBaseActivity, Bundle paramBundle)
  {
  ...
  protected void a()
  {
    ...
    if (!TextUtils.isEmpty(str)) {
      bcmc.c.put(this.jdField_a_of_type_JavaLangString, str);
    }
  }
  ...
  public void a(Activity paramActivity)
  {
    ...
    paramActivity = LayoutInflater.from(paramActivity).inflate(2131559768, null);
  ...
  protected void a(Bundle paramBundle)
  {
    ...
    //   14: putfield 187	bbgk:c	Ljava/lang/String;
    ...
    //   57: putfield 196	bbgk:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   60: aload_0
    //   61: aload_0
    //   62: getfield 196	bbgk:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   65: ldc 198
    //   67: invokevirtual 201	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   70: putfield 72	bbgk:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   73: aload_0
    //   74: aload_0
    //   75: getfield 196	bbgk:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   78: ldc 203
    //   80: invokevirtual 207	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   83: putfield 209	bbgk:jdField_a_of_type_Int	I
    //   86: aload_0
    //   87: aload_0
    //   88: getfield 196	bbgk:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   91: ldc 211
    //   93: invokevirtual 207	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   96: putfield 213	bbgk:jdField_b_of_type_Int	I
    //   99: aload_0
    //   100: aload_0
    //   101: getfield 196	bbgk:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   104: ldc 215
    //   106: invokevirtual 201	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   109: putfield 217	bbgk:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   112: aload_0
    //   113: new 219	java/util/ArrayList
    //   116: dup
    //   117: invokespecial 220	java/util/ArrayList:<init>	()V
    //   120: putfield 222	bbgk:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   123: aload_0
    //   124: getfield 196	bbgk:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   127: ldc 224
    ...
    //   135: astore_1
    //   136: aload_0
    //   137: getfield 222	bbgk:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   140: aload_1
    ...
    //   152: dup
    //   153: aload_0
    //   154: invokespecial 242	bbgl:<init>	(Lbbgk;)V
    //   157: putfield 244	bbgk:jdField_a_of_type_Bbgl	Lbbgl;
    ...
    //   169: astore_1
    //   170: aload_0
    //   171: getfield 40	bbgk:jdField_a_of_type_ComTencentMobileqqAppBaseActivity	Lcom/tencent/mobileqq/app/BaseActivity;
    //   174: aload_0
    //   175: getfield 244	bbgk:jdField_a_of_type_Bbgl	Lbbgl;
    //   178: aload_1
    ...
    //   184: astore_1
    //   185: aload_0
    //   186: invokevirtual 258	bbgk:dismiss	()V
    //   189: return
    //   190: astore_1
    //   191: aload_0
    //   192: invokevirtual 258	bbgk:dismiss	()V
    //   195: return
    //   196: astore_1
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqWidgetInputMethodRelativeLayout = ((InputMethodRelativeLayout)paramView.findViewById(2131376034));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131365645));
    this.jdField_a_of_type_AndroidWidgetEditText = ((EditText)paramView.findViewById(2131368343));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131376395));
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)paramView.findViewById(2131369193));
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetButton.setSelected(true);
    this.jdField_a_of_type_AndroidWidgetButton.setEnabled(true);
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    paramView.findViewById(2131378271).setOnClickListener(this);
  ...
  {
    paramapuf.a(null, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_AndroidWidgetEditText, null);
  }
  ...
  protected void a(String paramString)
  {
    try
    {
      athj.a("qbrowserCommentOnSend", new JSONObject(TroopBarPublishUtils.a(paramString, null, null)), this.jdField_a_of_type_JavaUtilArrayList, null);
      return;
    }
  ...
  {
    Object localObject;
    if ((!TextUtils.isEmpty(paramString1)) && ((this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity instanceof begc)))
    {
      localObject = ((begc)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity).b();
      if (localObject != null)
      {
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (paramBoolean)
      {
        athj.a("qbrowserCommentOnCreate", null, this.jdField_a_of_type_JavaUtilArrayList, null);
        ...
        this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131696720));
        return;
      }
  ...
  protected boolean a()
  {
    String str = (String)bcmc.c.get(this.jdField_a_of_type_JavaLangString);
    bcmc.c.clear();
    if (!TextUtils.isEmpty(str))
    {
  ...
  public void c()
  {
    ...
    for (int i = str.length();; i = 0)
    {
      if (i == 0)
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2131696738, 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      if (i < this.jdField_b_of_type_Int)
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131696736, new Object[] { Integer.valueOf(this.jdField_b_of_type_Int) }), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      if (i > this.jdField_a_of_type_Int)
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getString(2131696737, new Object[] { Integer.valueOf(this.jdField_a_of_type_Int) }), 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      if (!ndd.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity))
      {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 2131694702, 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
        return;
      }
      a(str);
      return;
  ...
  public void dismiss()
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.unregisterReceiver(this.jdField_a_of_type_Bbgl);
      this.jdField_a_of_type_Bbgl = null;
    }
    if (this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemAndEmojiEmoticonPanel != null) {
    ...
    athj.a("qbrowserCommentOnClose", null, this.jdField_a_of_type_JavaUtilArrayList, null);
    super.dismiss();
  }
