  ...
  extends ajfb
{
  ...
  public void a(int paramInt1, int paramInt2, ListenChangeVoicePanel paramListenChangeVoicePanel)
  {
    ...
    localvoiceChangeReq.str_qq_version.set("8.2.6");
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        QLog.e("VoiceChangeHandler", 1, "onReceive~ isSuccess=false ,data=" + bakz.a((byte[])paramObject));
        bcad.a().a("voiceChange.Auth", 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 0, ajjy.a(2131651050), true);
