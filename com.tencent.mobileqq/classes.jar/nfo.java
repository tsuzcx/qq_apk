...
public class nfo
{
  ...
  public static void a()
  {
    ...
    do
    {
      ...
      b = new ArrayList();
      a = new ArrayList();
      localObject1 = new File(nfp.f);
    } while ((!((File)localObject1).exists()) || (!((File)localObject1).isFile()));
    Object localObject1 = bace.a((File)localObject1);
    for (;;)
    {
      int i;
      try
    ...
    for (int j = 1;; j = 0)
    {
      ...
      for (;;)
      {
        ...
        if (!TextUtils.isEmpty(str))
        {
          ...
          {
            localObject2 = (ngh)paramAppInterface.getBusinessHandler(0);
            if (localObject2 == null) {
              break label339;
            }
            ((ngh)localObject2).a(i, null, paramString2, null, null, 0L, false);
            return;
            i += 1;
            break;
          }
