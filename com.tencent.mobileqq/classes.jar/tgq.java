  ...
  extends PopupWindow
{
  ...
  public tgq(Activity paramActivity)
  {
    super(paramActivity);
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)localObject).inflate(2131560056, null);
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364999));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379143));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131379142));
    localObject = a((LayoutInflater)localObject);
    if (localObject != null) {
      this.jdField_a_of_type_AndroidWidgetFrameLayout.addView((View)localObject);
    }
    setBackgroundDrawable(new ColorDrawable(0));
    this.jdField_a_of_type_Int = ((int)(this.c - this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131298700) * 2.0F));
  ...
  protected final void a(View paramView)
  {
    ...
    int j = (int)this.jdField_a_of_type_AndroidAppActivity.getResources().getDimension(2131298700);
    ...
    if (i - (m + n) > this.jdField_b_of_type_Int)
    {
      ...
      for (;;)
      {
        i = arrayOfInt[1] + paramView.getHeight() + bgtn.a(4.0F);
    ...
    for (;;)
    {
      i = arrayOfInt[1] - this.jdField_b_of_type_Int - bgtn.a(4.0F);
