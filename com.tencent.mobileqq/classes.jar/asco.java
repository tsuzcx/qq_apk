  ...
  extends GestureDetector
{
  ...
  Animator.AnimatorListener jdField_a_of_type_AndroidAnimationAnimator$AnimatorListener = new ascp(this);
  Context jdField_a_of_type_AndroidContentContext;
  Rect jdField_a_of_type_AndroidGraphicsRect;
  View jdField_a_of_type_AndroidViewView;
  ImageView jdField_a_of_type_AndroidWidgetImageView;
  ascs jdField_a_of_type_Ascs = new ascs(this, null);
  ...
  public asco(Context paramContext, GestureDetector.SimpleOnGestureListener paramSimpleOnGestureListener, BaseChatPie paramBaseChatPie)
  {
    ...
    else
    {
      ...
      this.jdField_j_of_type_Int = paramContext.getResources().getDimensionPixelOffset(2131298998);
    ...
    for (int i1 = 0;; i1 = ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidContentContext))
    {
      ...
      if (!(paramBaseChatPie instanceof ahzo)) {
        break;
      }
  ...
  private String a(asch paramasch)
  {
    if (paramasch.jdField_a_of_type_ComTencentMobileqqDataEmoticon == null)
    {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) {
      try
      {
        int i1 = Integer.parseInt(paramasch.jdField_a_of_type_ComTencentMobileqqDataEmoticon.eId);
        int i2 = Integer.parseInt(paramasch.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId);
        paramasch = arpm.a(i2, i1);
        EmoticonPackage localEmoticonPackage = ((awmr)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(String.valueOf(i2));
        char[] arrayOfChar = new char[5];
        arrayOfChar[0] = '\024';
        arrayOfChar[1] = paramasch[3];
        arrayOfChar[2] = paramasch[2];
        arrayOfChar[3] = paramasch[1];
        arrayOfChar[4] = paramasch[0];
        if ((localEmoticonPackage != null) && (localEmoticonPackage.isAPNG == 2)) {
          arrayOfChar[1] = 'ǿ';
        }
        paramasch = new StringBuilder(String.valueOf(arrayOfChar));
        EmojiStickerManager.a(paramasch);
        return paramasch.toString();
      }
  ...
  private void a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, MotionEvent paramMotionEvent, ListView paramListView, int paramInt)
  {
    if (paramMotionEvent.getRawY() < paramInt)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.q(true);
  ...
  private void e()
  {
    ...
    bglp.a(this.jdField_a_of_type_AndroidContentContext, 230).setTitle(anni.a(2131713081)).setMessage(anni.a(2131713074)).setPositiveButton(anni.a(2131713080), new ascr(this)).setNegativeButton("取消", new ascq(this)).show();
    int i1;
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
    {
  ...
  void a(float paramFloat1, float paramFloat2)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView != null))
    {
      ...
      localViewPropertyAnimator.setListener(this.jdField_a_of_type_Ascs);
  ...
  void a(View paramView, boolean paramBoolean)
  {
    ...
    if (paramView != null)
    {
      localapwt = (apwt)paramView.getTag(2131363971);
      localObject = (ChatMessage)paramView.getTag(2131364423);
      bool = false;
      if (localObject != null) {
      ...
      if (localapwt != null)
      {
        ...
        ((apym)localObject).b(paramBoolean);
      }
    }
    label77:
    ...
    {
      if (bool) {}
      for (i1 = 2130849989;; i1 = 2130849813)
      {
        ...
        localapwt.a(paramView, (Drawable)localObject);
        return;
      }
    }
    if (bool) {}
    for (int i1 = 2130849990;; i1 = 2130849814)
    {
      localObject = ((Resources)localObject).getDrawable(i1);
      break label112;
      break;
  ...
  void a(String paramString)
  {
    ...
    QQToast.a(this.jdField_a_of_type_AndroidContentContext, paramString, 0).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298998));
  }
  ...
  boolean a()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout != null)
    {
      ...
      while (i1 >= 0)
      {
        ...
        if (((View)localObject).getId() == 2131374084)
        {
          ...
          double d1;
          if (((localObject instanceof asbq)) || ((localObject instanceof Emoticon)) || ((localObject instanceof asaz)))
          {
            this.s = 1;
          ...
          {
            return true;
            if ((!(localObject instanceof ascv)) && (!(localObject instanceof asch))) {
              break;
            }
            this.s = 0;
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
    {
      ...
      {
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131374119);
    ...
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131374118);
      if (localObject1 != null) {
        return ((View)localObject1).onTouchEvent(paramMotionEvent);
      }
    }
    ...
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityFlingTopGestureLayout.findViewById(2131374121);
      if (localObject1 != null) {
        return ((View)localObject1).onTouchEvent(paramMotionEvent);
      }
    }
      ...
      if (a())
      {
        ...
        if ((b(paramMotionEvent.getRawX(), paramMotionEvent.getRawY())) || (!this.jdField_d_of_type_Boolean))
        {
          ...
          for (;;)
          {
            ...
            if ((this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getTag(2131374120) instanceof Integer)) {
              i1 = ((Integer)this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getTag(2131374120)).intValue();
            }
            ...
            {
              localObject1 = (ascv)localObject1;
              if (((ascv)localObject1).jdField_a_of_type_Int == 1)
              {
                this.t = 2;
                break label1625;
              }
              if (((ascv)localObject1).jdField_a_of_type_Int != 2) {
                break label1625;
              }
              this.t = 3;
              break label1625;
            }
            if ((localObject1 instanceof asch))
            {
              this.t = 4;
              break label1625;
            }
            if (!(localObject1 instanceof asaz)) {
              break label1625;
            }
            this.t = 5;
            break label1625;
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        Object localObject4;
        asaz localasaz;
        if ((paramMotionEvent instanceof asbq))
        {
          localObject1 = (asbq)paramMotionEvent;
          localObject2 = null;
          localObject4 = null;
          localObject3 = null;
          localasaz = null;
        ...
        for (;;)
        {
          ...
          label2644:
          View localView;
          if ((!EmojiStickerManager.f) && (bgmg.a() > 1.048576E+008F))
          {
            i1 = 1;
            paramMotionEvent = null;
            if ((localObject1 == null) || (((asbq)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon == null)) {
              break label3289;
            }
            if (i1 == 0) {
              break label3272;
            }
            paramMotionEvent = ((asbq)localObject1).a("fromAIO", true, false, null, (int)(this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getWidth() * this.jdField_b_of_type_Double), (int)(this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getHeight() * this.jdField_b_of_type_Double));
            ...
            if ((localView == null) || (localView.getId() != 2131364379)) {
              break label7552;
            }
            ...
            localObject6 = (ChatMessage)localView.getTag(2131364423);
            ...
            i2 = ((Rect)localObject5).left + BaseChatItemLayout.jdField_k_of_type_Int - this.jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerFrameLayout.getWidth() - i15 + this.jdField_h_of_type_Int + (int)this.jdField_e_of_type_Double;
          ...
          for (;;)
          {
            ...
            if (i2 != 0)
            {
              ...
              if ((paramMotionEvent instanceof ascv))
              {
                localObject4 = (ascv)paramMotionEvent;
                localObject2 = null;
                localObject3 = null;
                localasaz = null;
                localObject1 = null;
              ...
              if ((paramMotionEvent instanceof asch))
              {
                localObject2 = (asch)paramMotionEvent;
                localObject4 = null;
                localObject3 = null;
                localasaz = null;
                localObject1 = null;
              ...
              if (!(paramMotionEvent instanceof asaz)) {
                break label7724;
              }
              localasaz = (asaz)paramMotionEvent;
              localObject2 = null;
              localObject4 = null;
              localObject3 = null;
              localObject1 = null;
              ...
              break label2644;
              label3272:
              paramMotionEvent = ((asbq)localObject1).a(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float);
              break label2704;
              label3289:
              if (localObject4 != null)
              {
                paramMotionEvent = ((ascv)localObject4).b(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float);
                break label2704;
              }
              ...
              if (localObject2 != null)
              {
                paramMotionEvent = ((asch)localObject2).b(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float);
                break label2704;
              }
              if (localasaz == null) {
                break label2704;
              }
              paramMotionEvent = localasaz.b(this.jdField_a_of_type_AndroidContentContext, this.jdField_g_of_type_Float, 0, 0);
              break label2704;
              i2 = ((Rect)localObject5).right - BaseChatItemLayout.jdField_k_of_type_Int + i15 - this.jdField_h_of_type_Int - (int)this.jdField_e_of_type_Double;
              break label2958;
              label3406:
            ...
            for (;;)
            {
              if ((localObject6 != null) && (((ChatMessage)localObject6).extraflag != 32772) && (((ChatMessage)localObject6).extraflag != 32768) && (bool3) && (bool4) && (((ChatMessage)localObject6).msgtype != -2009) && (((ChatMessage)localObject6).msgtype != -2016) && (!(localObject6 instanceof MessageForLongMsg)) && (!(localObject6 instanceof MessageForLongTextMsg)) && (bool2) && (i5 != 0) && (i4 == 0) && (i3 == 0) && (i1 == 0))
              {
                ...
                if ((localObject1 != null) && (((asbq)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon != null))
                {
                  localObject5 = ((asbq)localObject1).jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId;
                  if (f2 - i16 + this.r <= i8) {
                    break label4509;
                  }
                ...
                for (;;)
                {
                  ...
                  if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null) && (localObject5 != null))
                  {
                    ...
                    if (bool1)
                    {
                      ...
                      if (localObject1 != null)
                      {
                        ((asbq)localObject1).jdField_a_of_type_ComTencentMobileqqEmoticonEmojiStickerManager$StickerInfo = ((EmojiStickerManager.StickerInfo)localObject6);
                        ((ChatMessage)localObject5).stickerHidden = false;
                        this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a((arxg)localObject1);
                      }
                      do
                      {
                        for (;;)
                        {
                          ...
                          if (localObject3 != null)
                          {
                            adrm.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, (Emoticon)localObject3, (EmojiStickerManager.StickerInfo)localObject6);
                          }
                          else
                          {
                            if (localObject4 != null)
                            {
                              if (((ascv)localObject4).jdField_a_of_type_Int == 1) {}
                              for (paramMotionEvent = bdol.b(((ascv)localObject4).jdField_b_of_type_Int);; paramMotionEvent = bdol.a(((ascv)localObject4).jdField_b_of_type_Int))
                              {
                            ...
                            paramMotionEvent = a((asch)localObject2);
                            this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(paramMotionEvent, (EmojiStickerManager.StickerInfo)localObject6);
                          }
                        }
                      } while (localasaz == null);
                      ...
                      localObject5 = localasaz.e;
                      if (!TextUtils.isEmpty(localasaz.d)) {}
                      for (bool1 = true;; bool1 = false)
                      {
                        adrm.a(paramMotionEvent, (Context)localObject2, (SessionInfo)localObject4, (String)localObject5, true, bool1, localasaz.d, (EmojiStickerManager.StickerInfo)localObject6);
                        break;
                      }
                      label5860:
                      ...
                      a(String.format(anni.a(2131713083), new Object[] { Integer.valueOf(EmojiStickerManager.jdField_e_of_type_Int) }));
                        ...
                        if (i1 == 2)
                        {
                          ...
                          if ((localObject1 instanceof FragmentActivity))
                          {
                            ...
                            if (((FragmentActivity)localObject1).getChatFragment() != null)
                            {
                              ...
                              if ((((localObject1 instanceof ahxp)) || ((localObject1 instanceof ahzy)) || ((localObject1 instanceof ahzo))) && (EmojiStickerManager.a().jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() > 0))
                              {
