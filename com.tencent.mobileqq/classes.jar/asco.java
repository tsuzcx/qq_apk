  ...
  implements asda
{
  ...
  public void a()
  {
    if (QLog.isColorLevel()) {
      QLog.d("Action", 2, "fun startMagicPlay begins, sumPlayTimes:" + this.a.jdField_c_of_type_Int + ",actionGlobalData.openSound:" + this.a.jdField_a_of_type_Ascp.d);
    }
    Object localObject;
    if (this.a.jdField_c_of_type_Int == 0)
    {
      this.a.b();
      if ((this.a.jdField_a_of_type_Asdd.c != null) && (this.a.jdField_a_of_type_Asdd.c.length() > 0) && (this.a.jdField_a_of_type_Ascp.d))
      {
        if (this.a.jdField_a_of_type_Asdd.e > 0)
        {
          localObject = this.a.jdField_a_of_type_Asdd;
          ((asdd)localObject).e -= 1;
        }
        if (QLog.isColorLevel()) {
          QLog.d("Action", 2, "fun startMagicPlay begins, start play Sound.");
        }
        this.a.jdField_a_of_type_Asdp.a(this.a.jdField_a_of_type_Asdd.c, this.a.jdField_a_of_type_Asdd.e);
      }
      if (this.a.jdField_a_of_type_Asdd.a)
      {
        this.a.jdField_a_of_type_AndroidOsVibrator = ((Vibrator)BaseApplicationImpl.getContext().getSystemService("vibrator"));
        if (this.a.jdField_a_of_type_Asdd.h != -1) {
          break label311;
        }
    ...
    {
      localObject = this.a;
      ((ascn)localObject).jdField_c_of_type_Int += 1;
      if (QLog.isColorLevel()) {
        QLog.d("Action", 2, "fun startMagicPlay ends, sumPlayTimes:" + this.a.jdField_c_of_type_Int);
      }
      return;
      label311:
      this.a.jdField_a_of_type_AndroidOsVibrator.vibrate(this.a.jdField_a_of_type_Asdd.h * 1000);
    }
  }
  ...
  public void b()
  {
    ...
    do
    {
      ...
      if (this.a.jdField_a_of_type_Int == -1)
      {
        ...
        {
          this.a.jdField_a_of_type_Asdp.a(this.a.jdField_a_of_type_Asdd);
          return;
        }
