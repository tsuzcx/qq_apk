  ...
  extends asbv
{
  ...
  public asco(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void f()
  {
    ...
    {
      localObject = (asbm)((QQAppInterface)localObject).getManager(QQManagerFactory.EARLY_DOWNLOAD_MANAGER);
      if (localObject != null)
      {
        localObject = (asco)((asbm)localObject).a("android.qq.readinjoy.viola_biz_810");
        if (localObject != null)
        {
          ((asco)localObject).a(true);
  ...
  public void a(String paramString)
  {
    ...
    if (new File(paramString).exists())
    {
      ...
      if (localXmlData != null)
      {
        ...
        asbl.a(localXmlData, new String[] { "loadState", "Version" });
      }
