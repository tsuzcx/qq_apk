...
public class amsg
  extends amsf
{
  public amsg(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    SharedPreferences localSharedPreferences = amme.a();
  ...
  {
    if ((paramanct == null) || (paramAppInterface == null) || (paramContext == null))
    {
    ...
    paramContext = ((amme)paramAppInterface.getManager(QQManagerFactory.APOLLO_MANAGER)).a((QQAppInterface)paramAppInterface, paramAppInterface.getCurrentAccountUin(), new int[] { 2, 4 });
    if (paramContext != null)
    {
      ...
      anck.a(paramanct, 12, paramContext);
    }
    for (;;)
    {
      return 0;
      ...
      anck.a(paramanct, 5, paramAppInterface);
    }
  }
}
