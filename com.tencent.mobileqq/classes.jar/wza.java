  ...
  extends AsyncTask<Void, Void, Integer>
{
  ...
  public wza(Activity paramActivity, String paramString1, String paramString2, int paramInt1, WeakReference<AppInterface> paramWeakReference, int paramInt2)
  {
  ...
  {
    if (!azgr.d((AppInterface)this.jdField_a_of_type_MqqUtilWeakReference.get())) {
      return -1002;
    }
    azgr.d(null);
    ...
    ((azfn)localObject).jdField_b_of_type_JavaLangString = paramString1;
    ...
    for (;;)
    {
      ...
      {
        i = azfu.a(paramString3, paramString1, paramString4, 0);
        paramString2.delete();
        if (i != 0)
        {
  ...
  protected void a(Integer paramInteger)
  {
    ...
    a(alpo.a(2131716742) + paramInteger, null);
  }
  
  protected void onPreExecute()
  {
    a(this.jdField_a_of_type_AndroidAppActivity, 2131695284);
  }
}
