        ...
        do
        {
          ...
          do
          {
            do
            {
              ...
              {
                return;
                if ((paramMsg.msg_body.has()) && (((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has()) && (!parambbkm.a) && (!parambbkm.f)) {
                  break;
                }
              } while (!QLog.isColorLevel());
              QLog.e("VideoDecoder", 2, "<---decodeC2CMsgPkg_Video return null:hasBody:" + paramMsg.msg_body.has() + ",hasMsgContent" + ((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has() + ",isReaded:" + parambbkm.a + "syncOther:" + parambbkm.f);
              return;
          ...
          return;
          localHashMap = (HashMap)parambbkm.a(1000);
          parambbkm = (HashSet)parambbkm.a(1001);
          if (i != 1) {
            break label505;
          }
          if (lld.c()) {
