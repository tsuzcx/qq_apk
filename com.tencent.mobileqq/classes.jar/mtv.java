...
public class mtv
{
  static volatile mtv jdField_a_of_type_Mtv;
  public int a;
  ...
  mtx jdField_a_of_type_Mtx;
  public int b;
  Runnable b;
  int c = 0;
  int d = -1;
  
  private mtv(Context paramContext)
  {
    ...
    if (Looper.myLooper() != null) {
      this.jdField_a_of_type_Mtx = new mtx(this);
    }
  ...
  public static mtv a(Context paramContext)
  {
    if (jdField_a_of_type_Mtv == null) {}
    try
    {
      if (jdField_a_of_type_Mtv == null) {
        jdField_a_of_type_Mtv = new mtv(paramContext);
      }
      return jdField_a_of_type_Mtv;
    }
    finally {}
  }
  ...
  private String b()
  {
    ...
    {
      lba.f("SignalStrengthReport", "getGateway e:" + localException);
    }
    return "";
  }
  ...
  private int g()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        ...
        if (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)
        {
          ...
          {
            lba.f("SignalStrengthReport", "getPingInterval config:" + (String)localObject);
    ...
    {
      lba.f("SignalStrengthReport", "getPingInterval e:" + localException);
      i = j;
    }
    return i;
  }
  ...
  int a(SignalStrength paramSignalStrength)
  {
    ...
    for (;;)
    {
      ...
      {
        lba.f("SignalStrengthReport", "getLevelPercentBySignalStrength reflect getLevel e:" + paramSignalStrength);
        return 0;
      }
    }
  }
  ...
  public void a()
  {
    ...
    {
      return;
      lba.f("SignalStrengthReport", "report start");
    ...
    } while ((this.jdField_a_of_type_Mtx == null) || (this.jdField_a_of_type_AndroidTelephonyTelephonyManager == null));
    this.jdField_a_of_type_AndroidTelephonyTelephonyManager.listen(this.jdField_a_of_type_Mtx, 256);
  }
  ...
  int b(SignalStrength paramSignalStrength)
  {
    ...
    //   112: invokestatic 149	lba:f	(Ljava/lang/String;Ljava/lang/String;)V
    //   115: iconst_m1
    //   116: istore_2
    //   117: goto -74 -> 43
    //   120: aload_1
    ...
    //   183: invokestatic 149	lba:f	(Ljava/lang/String;Ljava/lang/String;)V
    //   186: iconst_m1
    //   187: ireturn
    //   188: iload_2
    //   189: ireturn
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Int = -1;
    if ((this.jdField_a_of_type_Mtx != null) && (this.jdField_a_of_type_AndroidTelephonyTelephonyManager != null)) {
      this.jdField_a_of_type_AndroidTelephonyTelephonyManager.listen(this.jdField_a_of_type_Mtx, 0);
    }
    ...
    this.jdField_a_of_type_JavaLangString = "";
    lba.f("SignalStrengthReport", "report stop");
  }
  ...
  public int c()
  {
    ...
    {
      lba.f("SignalStrengthReport", "getWifiLevelPercent e:" + localException);
      i = j;
    }
    return i;
  }
  ...
  public int d()
  {
    ...
    {
      lba.f("SignalStrengthReport", "getWifiDbm e:" + localException);
    }
    return -1;
  }
}
