...
public class bahf
  extends bagz
{
  public bahf(TeamWorkFileImportInfo paramTeamWorkFileImportInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    Object localObject1;
    Object localObject2;
    if ((this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo != null) && (paramQQAppInterface != null) && (this.jdField_a_of_type_Bagw != null))
    {
      localObject3 = bagk.a(this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo);
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          catch (JSONException localJSONException)
          {
            ...
            this.jdField_a_of_type_Bagw.b(paramQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo);
            return;
            this.jdField_a_of_type_Bagw.a(paramQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo);
            return;
          }
          ...
          this.jdField_a_of_type_Bagw.b(this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo);
          this.jdField_a_of_type_Bagw.c(paramQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo);
          return;
          if (!TextUtils.isEmpty((CharSequence)localObject2)) {
            break label596;
          }
          if (TextUtils.isEmpty(str2))
          {
            ...
            localObject1 = bahp.a((String)localObject1);
            break;
          }
          localObject1 = str2;
          break;
