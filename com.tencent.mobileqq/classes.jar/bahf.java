  ...
  implements Manager
{
  ...
  aycd jdField_a_of_type_Aycd = new bahj(this);
  public bahu a;
  public baro a;
  barz jdField_a_of_type_Barz = new bahi(this);
  protected basl a;
  batr jdField_a_of_type_Batr;
  bbwt jdField_a_of_type_Bbwt = new bahm(this);
  AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface = null;
  BaseChatPie jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie;
  public Comparator<baht> a;
  HashMap<String, Integer> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  String jdField_b_of_type_JavaLangString;
  HashMap<String, List<baht>> jdField_b_of_type_JavaUtilHashMap = new HashMap();
  ...
  public bahf(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_Int = 1;
    this.jdField_c_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_b_of_type_Boolean = true;
    this.jdField_a_of_type_JavaUtilComparator = new bahl(this);
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    a(paramAppInterface);
    this.jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper());
  }
  
  private void a(baht parambaht)
  {
    int i = 0;
    Object localObject = (List)this.jdField_b_of_type_JavaUtilHashMap.get(parambaht.getFriendUin());
    if (localObject == null)
    {
      localObject = new ArrayList();
      this.jdField_b_of_type_JavaUtilHashMap.put(parambaht.getFriendUin(), localObject);
    }
    for (;;)
    {
      int j;
      try
      {
        ((List)localObject).add(parambaht);
        int m = parambaht.getLimitType();
        int k = -1;
        j = 0;
        if (i < ((List)localObject).size())
        {
          parambaht = (baht)((List)localObject).get(i);
          if ((parambaht == null) || (parambaht.getLimitType() != m)) {
            break label158;
          }
          if (k == -1)
          {
  ...
  private void a(String paramString, MessageForDeliverGiftTips paramMessageForDeliverGiftTips)
  {
    ...
    {
      Object localObject = new File(balu.a(paramString, paramMessageForDeliverGiftTips.animationType, paramMessageForDeliverGiftTips.isInteract()));
      ...
      localObject = new bbwu(balu.c(paramMessageForDeliverGiftTips), (File)localObject);
      ((bbwu)localObject).jdField_b_of_type_Int = 2;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("AIOAnimationControlManager", 2, "start Download PackageId:" + balu.b(paramMessageForDeliverGiftTips));
      }
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    if (i < localList.size())
    {
      paramString1 = (baht)localList.get(i);
      if (!(paramString1 instanceof MessageForDeliverGiftTips)) {
        break label87;
      }
      paramString1 = balu.b((MessageForDeliverGiftTips)paramString1);
    }
    for (;;)
    {
  ...
  public static boolean a(BaseChatPie paramBaseChatPie, QQAppInterface paramQQAppInterface, Object paramObject)
  {
    ...
    for (;;)
    {
      if (ahfh.a(paramObject, paramQQAppInterface)) {
        paramBaseChatPie.o(false);
      }
      return false;
      label37:
      ...
      ((bahf)paramQQAppInterface.getManager(223)).a(paramBaseChatPie);
    }
  }
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      {
        if (paramString2.equals(balu.b((MessageForDeliverGiftTips)paramString1.get(i)))) {
  ...
  private void h()
  {
    Object localObject = new File(ajsd.ct);
    ...
    {
      label111:
      if (balu.a((String)localObject, i, bool))
      {
      ...
      for (;;)
      {
        ...
        bool = true;
        break label111;
        bbdx.a(arrayOfFile[j].getAbsolutePath());
      }
      return;
      label270:
      i = 0;
  ...
  public bbwz a()
  {
    return ((bbww)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(47)).a(1);
  }
  
  public void a()
  {
    int i = 0;
    Object localObject = new File(balu.a(0)).getParentFile();
    if (((File)localObject).exists())
    {
      ...
      if (i < localObject.length)
      {
        if (localObject[i].exists())
        {
          ...
          try
          {
            ...
            if (balu.a(Integer.parseInt(str))) {
  ...
  {
    if (this.jdField_a_of_type_Baro == null) {
      this.jdField_a_of_type_Baro = new baro(null, paramActivity, this.jdField_a_of_type_ComTencentCommonAppAppInterface);
    }
    this.jdField_a_of_type_Baro.a(4);
    this.jdField_a_of_type_AndroidAppActivity = this.jdField_a_of_type_Baro.a();
  ...
  public void a(BaseChatPie paramBaseChatPie)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != paramBaseChatPie)
    {
      ...
      this.jdField_a_of_type_Baro = paramBaseChatPie.a();
      if (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof TroopChatPie)) {
        break label114;
      }
      this.jdField_a_of_type_Baro.a(1);
      this.jdField_a_of_type_Basl = ((TroopChatPie)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a();
      this.jdField_a_of_type_Batr = ((TroopChatPie)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie).a();
    }
    label114:
    do
    {
    ...
    } while (!(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof aerj));
    ...
    {
      this.jdField_a_of_type_Baro.a(8);
      return;
    }
    this.jdField_a_of_type_Baro.a(6);
  }
  ...
  {
    bahs.a().addObserver(paramObserver);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                ...
                } while ((!b()) && (balu.a((List)localObject3)));
                if ((this.jdField_a_of_type_Basl == null) || (balu.a((List)localObject3))) {
                  break label397;
                }
              } while ((this.jdField_a_of_type_Basl.b()) && (this.jdField_a_of_type_Basl.a()));
              this.jdField_a_of_type_Int = 2;
              localObject5 = (MessageForDeliverGiftTips)((List)localObject3).get(0);
              localObject6 = balu.b((MessageForDeliverGiftTips)localObject5);
            ...
            ((balh)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(113)).a(((MessageForDeliverGiftTips)localObject5).frienduin, ((MessageForDeliverGiftTips)localObject5).interactId, ((MessageForDeliverGiftTips)localObject5).giftId, new bahn(this, (MessageForDeliverGiftTips)localObject5, (List)localObject3, paramBoolean, (List)localObject4, (String)localObject6));
            return;
            ...
            return;
          } while ((this.jdField_a_of_type_Baro == null) || (balu.a((List)localObject4)));
          this.jdField_a_of_type_Int = 2;
          localObject3 = (baht)((List)localObject4).get(0);
          ...
          {
            localObject3 = ((balh)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(113)).a((String)localObject1, ((MessageForDeliverGiftTips)localObject5).bagId, new bahp(this, (MessageForDeliverGiftTips)localObject5, (String)localObject1, paramBoolean));
          ...
          for (;;)
          {
            if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) {
              ((MessageForDeliverGiftTips)localObject5).senderName = bbcz.h((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, (String)localObject1, "" + ((MessageForDeliverGiftTips)localObject5).senderUin);
            }
            localObject6 = balu.b((MessageForDeliverGiftTips)localObject5);
            if ((!this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject6)) || (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(localObject6)).intValue() != 3)) {
              break label1241;
            }
            this.jdField_a_of_type_Baro.a(this.jdField_a_of_type_Aycd);
            if (QLog.isColorLevel()) {
              QLog.d("AIOAnimationControlManager", 2, "Playing! playMaigface id:" + balu.b((MessageForDeliverGiftTips)localObject5));
            }
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a() == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().a == null) || (!this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().a.a())) {
              break;
            }
        ...
        } while (this.jdField_a_of_type_Basl == null);
        this.jdField_a_of_type_Basl.a((MessageForDeliverGiftTips)localObject5, (String)localObject6, false, new bahq(this, paramBoolean));
        return;
        if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie != null)
        {
          localObject3 = "0";
          ...
          axqy.b((QQAppInterface)localObject4, "P_CliOper", "Grp_flower", "", "cartoon", "show", 0, 0, (String)localObject1, (String)localObject6, (String)localObject3, "" + mua.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), (String)localObject1));
          if (QLog.isColorLevel())
          {
        ...
        this.jdField_a_of_type_Baro.a((MessageForDeliverGiftTips)localObject5);
        this.jdField_a_of_type_Baro.jdField_a_of_type_Barz = this.jdField_a_of_type_Barz;
        return;
        if ((this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject6)) && (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(localObject6)).intValue() == 4))
        {
        ...
        this.jdField_a_of_type_Int = 3;
        return;
        if ((localObject3 instanceof ahfh))
        {
          localObject1 = (ahfh)localObject3;
          this.jdField_a_of_type_Baro.a((ahfh)localObject1);
          ((ahfh)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, new bahg(this, paramBoolean));
          ((List)localObject4).remove(localObject3);
          return;
        }
      } while ((!(localObject3 instanceof MessageForTroopEffectPic)) || (this.jdField_a_of_type_Batr == null));
      ...
      if ((!this.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject3)) || (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(localObject3)).intValue() != 3) || (!balu.a(((MessageForTroopEffectPic)localObject5).effectId))) {
        break;
      }
      Object localObject1 = ((MessageForTroopEffectPic)localObject5).getPicDownloadInfo();
      ((aunn)localObject1).e = "chatimg";
      Object localObject6 = ((aunn)localObject1).c();
      ...
      for (;;)
      {
        ...
        try
        {
          if (localFile.exists())
          {
            ...
            localOptions.inSampleSize = ((int)bbef.a((InputStream)localObject1, 720, 1080));
            ((BufferedInputStream)localObject1).close();
            localObject6 = bbef.a((String)localObject6, localOptions);
            localObject1 = localObject3;
        ...
        this.jdField_a_of_type_Batr.a(((MessageForTroopEffectPic)localObject5).effectId, (Bitmap)localObject1, ((TroopChatPie)localObject3).s, new bahh(this, paramBoolean));
        ((List)localObject4).remove(localObject5);
        return;
        i = 90;
        continue;
    ...
    label1297:
    label1829:
    this.jdField_a_of_type_Batr.a((TroopChatPie)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, (MessageForTroopEffectPic)localObject5, false);
    return;
  ...
  public boolean a(baht parambaht, boolean paramBoolean)
  {
    if (parambaht == null) {
      return false;
    }
    if (((parambaht instanceof MessageForDeliverGiftTips)) && (!balu.a((MessageForDeliverGiftTips)parambaht))) {
      return false;
    }
    a(parambaht);
    if (paramBoolean)
  ...
  public boolean a(MessageForDeliverGiftTips paramMessageForDeliverGiftTips, boolean paramBoolean)
  {
    ...
    while (!balu.a(paramMessageForDeliverGiftTips)) {
      return false;
    }
    ...
    {
      return true;
      ((balh)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(113)).a(paramMessageForDeliverGiftTips.frienduin, paramMessageForDeliverGiftTips.interactId, paramMessageForDeliverGiftTips.giftId, new bahk(this, paramMessageForDeliverGiftTips, paramBoolean));
    }
  }
  ...
  public boolean a(MessageForTroopEffectPic paramMessageForTroopEffectPic, boolean paramBoolean)
  {
    ...
    if ((this.jdField_a_of_type_JavaUtilHashMap.containsKey(str)) && (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(str)).intValue() == 3)) {
      if (!balu.a(paramMessageForTroopEffectPic.effectId))
      {
        this.jdField_a_of_type_JavaUtilHashMap.remove(str);
        bbdx.d(balu.a(paramMessageForTroopEffectPic.effectId));
  ...
  public long[] a(String paramString)
  {
    ...
    if (localObject != null)
    {
      ...
      {
        baht localbaht = (baht)((Iterator)localObject).next();
        if ((localbaht instanceof MessageForDeliverGiftTips)) {
          paramString.add(Long.valueOf(((MessageForDeliverGiftTips)localbaht).getId()));
        }
      }
    }
  ...
  public void b()
  {
    ...
    for (Object localObject = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;; localObject = this.jdField_b_of_type_JavaLangString)
    {
      ...
      if ((!this.jdField_b_of_type_Boolean) || (balu.a((List)localObject))) {
        break label135;
      }
      int j;
      for (int i = 0; i < ((List)localObject).size(); i = j + 1)
      {
        baht localbaht = (baht)((List)localObject).get(i);
        j = i;
        if (localbaht.isReaded())
        {
          j = i;
          if (localbaht.getSenderUin() != this.jdField_a_of_type_ComTencentCommonAppAppInterface.getLongAccountUin())
          {
  ...
  {
    bahs.a().deleteObserver(paramObserver);
  }
  ...
  {
    if (!balu.a(paramMessageForDeliverGiftTips)) {
      return false;
    }
    String str = balu.b(paramMessageForDeliverGiftTips);
    int i;
    boolean bool;
    if ((this.jdField_a_of_type_JavaUtilHashMap.containsKey(str)) && (((Integer)this.jdField_a_of_type_JavaUtilHashMap.get(str)).intValue() == 3)) {
      if (!balu.a(str, paramMessageForDeliverGiftTips.animationType, paramMessageForDeliverGiftTips.isInteract()))
      {
        this.jdField_a_of_type_JavaUtilHashMap.remove(str);
        bbdx.a(balu.a(paramMessageForDeliverGiftTips));
        a(str, paramMessageForDeliverGiftTips);
        i = 2;
        if (QLog.isColorLevel()) {
          QLog.d("AIOAnimationControlManager", 2, "giftRealAnimationId:" + balu.b(paramMessageForDeliverGiftTips) + ",state:" + i);
        }
        if ((a()) && (i != 3)) {
          break label188;
        }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_Baro = null;
    this.jdField_a_of_type_Int = 1;
    this.jdField_a_of_type_Basl = null;
  }
  ...
  public void g()
  {
    ...
    if ((this.jdField_a_of_type_Baro != null) && (this.jdField_a_of_type_Baro.a())) {
      this.jdField_a_of_type_Baro.c();
    }
    if ((this.jdField_a_of_type_Basl != null) && (!this.jdField_a_of_type_Basl.a())) {
