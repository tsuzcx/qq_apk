...
public final class mwh
  implements Runnable
{
  public mwh(List paramList, int paramInt, String paramString) {}
      ...
      try
      {
        ...
        if (BaseApplicationImpl.sProcessId == 1)
        {
          ...
          if (ReadInJoyUtils.c((QQAppInterface)localObject1))
          {
            ...
            if (ReadinjoySPEventReport.a() <= 0L) {
              continue;
            }
            l = ReadinjoySPEventReport.a();
            ...
            ((oidb_cmd0x80a.AttributeList)localObject1).att_value.set(String.valueOf(ReadinjoySPEventReport.b()));
            this.jdField_a_of_type_JavaUtilList.add(localObject1);
