  ...
  extends Handler
{
  ...
  public awzf(MusicPlayerActivity paramMusicPlayerActivity)
  {
  ...
  private void a(int[] paramArrayOfInt, boolean paramBoolean)
  {
    ...
    if ((paramArrayOfInt != null) && (paramArrayOfInt.length >= 2) && (localMusicPlayerActivity != null))
    {
      ...
      ((ImageView)localMusicPlayerActivity.findViewById(2131371460)).setImageDrawable(localGradientDrawable);
      localMusicPlayerActivity.findViewById(2131371463).setBackgroundColor(i);
      i = paramArrayOfInt[1];
      ...
      MusicPlayerActivity.a(localMusicPlayerActivity, 2130841762, i);
      MusicPlayerActivity.a(localMusicPlayerActivity, 2130841763, i);
      MusicPlayerActivity.a(localMusicPlayerActivity, 2130840073, i);
      if (paramBoolean)
      {
        MusicPlayerActivity.a(localMusicPlayerActivity, 2130841296, i);
        MusicPlayerActivity.a(localMusicPlayerActivity, 2130841298, i);
        MusicPlayerActivity.a(localMusicPlayerActivity, 2130841297, i);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
          ...
          do
          {
            do
            {
              do
              {
                do
                {
                  ...
                  if ((paramMessage instanceof Integer))
                  {
                    ...
                    MusicPlayerActivity.a((MusicPlayerActivity)localObject1, 2130841762, j);
                    MusicPlayerActivity.a((MusicPlayerActivity)localObject1, 2130841763, j);
                  }
                  if ((i == 3) || (i == 4)) {
                    MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setImageResource(2130841763);
                  }
                  for (;;)
                  {
                    MusicPlayerActivity.a((MusicPlayerActivity)localObject1);
                    return;
                    MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setImageResource(2130841762);
                  }
                } while (!(paramMessage.obj instanceof awzh));
                localObject2 = (awzh)paramMessage.obj;
                ...
                if (MusicPlayerActivity.a((MusicPlayerActivity)localObject1).isSelected()) {
                  MusicPlayerActivity.a((MusicPlayerActivity)localObject1).setImageResource(2130841297);
                }
                for (;;)
                {
                  MusicPlayerActivity.c((MusicPlayerActivity)localObject1).setVisibility(i);
                  MusicPlayerActivity.c((MusicPlayerActivity)localObject1).setImageResource(2130841296);
                  ...
                  return;
                  MusicPlayerActivity.a((MusicPlayerActivity)localObject1).setImageResource(2130841298);
                }
              ...
              for (;;)
              {
                ...
                paramMessage = (URLImageView)((MusicPlayerActivity)localObject1).findViewById(2131371469);
                localURLDrawable = URLDrawable.getDrawable((String)localObject3, URLDrawable.URLDrawableOptions.obtain());
                localObject4 = awyn.a((String)localObject3);
              ...
              for (;;)
              {
                ...
                MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setText(2131693894);
                return;
                localObject3 = new awyn((String)localObject3, MusicPlayerActivity.a((MusicPlayerActivity)localObject1), Boolean.valueOf(bool1));
                if (localURLDrawable.getStatus() == 1)
                {
                  localObject4 = localURLDrawable.getCurrDrawable();
                  if ((localObject4 instanceof RegionDrawable)) {
                    ((awyn)localObject3).run(null, ((RegionDrawable)localObject4).getBitmap());
                  }
                }
                else
                {
              ...
              MusicPlayerActivity.b((MusicPlayerActivity)localObject1).setText(((MusicPlayerActivity)localObject1).getString(2131693892, new Object[] { paramMessage }));
              return;
              MusicPlayerActivity.a((MusicPlayerActivity)localObject1);
              return;
            } while (!(paramMessage.obj instanceof View));
            localObject2 = (View)paramMessage.obj;
            paramMessage = bkqo.a((Context)localObject1).b(3).a(((MusicPlayerActivity)localObject1).getString(paramMessage.arg1)).a(paramMessage.arg2);
            paramMessage.c(49);
            paramMessage = new bkqq(paramMessage).b(Color.argb(13, 255, 255, 255)).a(5).a();
      ...
      } while (!(localObject1 instanceof awzh));
      localObject1 = (awzh)localObject1;
    ...
    WXShareHelper.a().a(String.valueOf(l), ((awzh)localObject1).a, (Bitmap)localObject2, ((awzh)localObject1).b, ((awzh)localObject1).d, i, ((awzh)localObject1).e);
  }
}
