...
public class oed
{
  ...
  pbj jdField_a_of_type_Pbj = new oee(this);
  ...
  public oed(ReadInjoyFriendsBiuComponentFragment paramReadInjoyFriendsBiuComponentFragment, Context paramContext)
  {
    a(paramContext);
  ...
  {
    ReadInJoyUserInfo localReadInJoyUserInfo = ReadInJoyUserInfoModule.a(paramLong, new oef(this, paramLong));
  ...
  {
    paramArrayList = SocializeFeedsInfo.a(null, "5", this.jdField_a_of_type_Pbj, paramArrayList);
    this.c.setSpannableFactory(ayki.a);
  ...
  public void a(Context paramContext)
  {
    ...
    this.c = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131364438));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131363291));
  }
  ...
  public void a(MultiBiuSameContent paramMultiBiuSameContent, int paramInt)
  {
    ...
    Object localObject = onj.a(paramMultiBiuSameContent.jdField_b_of_type_Int, true);
    if (localObject != null) {
    ...
    ((SpannableStringBuilder)localObject).append(new ayki(localStringBuilder, 7, 16));
