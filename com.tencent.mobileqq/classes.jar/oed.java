...
public class oed
{
  ...
  public static boolean a(AdvertisementInfo paramAdvertisementInfo, ProteusBannerVideoItemData paramProteusBannerVideoItemData, Context paramContext, int paramInt)
  {
    ...
    return false;
    label109:
    if (ors.b.equals(paramAdvertisementInfo))
    {
      if (paramInt == 0) {
        return false;
      }
    ...
    if (ors.c.equals(paramAdvertisementInfo))
    {
      if (paramInt == 0) {
        return false;
      }
      ...
      if ((paramInt == 2) && (paramContext != null) && (qzy.a(paramContext))) {
        return true;
      }
    }
    return false;
