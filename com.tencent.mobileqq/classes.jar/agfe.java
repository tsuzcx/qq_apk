  ...
  extends agdi
{
  ...
  public agfe(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, int paramInt)
  {
  ...
  private void e()
  {
    ...
    View localView = getLayoutInflater().inflate(2131559212, this.jdField_a_of_type_ComTencentWidgetXListView, false);
    this.jdField_a_of_type_AndroidViewView = getLayoutInflater().inflate(2131561470, this.jdField_a_of_type_ComTencentWidgetXListView, false);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131370882));
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setClickable(false);
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.jdField_a_of_type_AndroidViewView.setClickable(false);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131375056).setVisibility(0);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131371996).setVisibility(8);
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131370442)).setText(this.jdField_a_of_type_AndroidContentContext.getString(2131719099));
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new agff(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new agfg(this));
  }
  
  private void f()
  {
    this.jdField_b_of_type_AndroidWidgetEditText = ((EditText)findViewById(2131365763));
    this.jdField_b_of_type_AndroidWidgetEditText.setFilters(new InputFilter[] { new InputFilter.LengthFilter(15) });
    this.jdField_b_of_type_AndroidWidgetEditText.addTextChangedListener(new agfh(this));
    this.jdField_b_of_type_AndroidWidgetEditText.setImeOptions(3);
    agdj localagdj = new agdj(this);
    this.jdField_b_of_type_AndroidWidgetEditText.setOnEditorActionListener(localagdj);
    this.jdField_b_of_type_AndroidWidgetEditText.setOnKeyListener(localagdj);
    this.jdField_b_of_type_AndroidWidgetEditText.setHint(this.jdField_a_of_type_AndroidContentContext.getString(2131690738));
  ...
  private void g()
  {
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new agfi(this));
    Button localButton = (Button)findViewById(2131363479);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new agfj(this));
  }
  ...
  protected void a()
  {
    ...
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A174", "0X800A174", this.jdField_b_of_type_Int, 0, "", "", "s_qq_history_tab", "");
  }
