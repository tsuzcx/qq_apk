  ...
  implements biia
{
  ...
  public abgl(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b()
  {
    ...
    do
    {
      ...
      localObject3 = bkfg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationInfo().sourceDir);
    ...
    for (int i = 1;; i = 0)
    {
      String str1 = bkfg.a((Context)localObject1);
      ...
      if (localObject3 != null) {
        localObject1 = ((bihz)localObject3).encode(localObject2);
      }
