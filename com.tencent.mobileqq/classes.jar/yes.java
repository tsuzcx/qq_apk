  ...
  extends ybz
{
  ...
  public yes(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b(MessageForDeviceFile paramMessageForDeviceFile)
  {
    ...
    if (i < this.jdField_a_of_type_JavaUtilArrayList.size())
    {
      ...
      if ((localView != null) && (localObject != null)) {
        ((anis)localObject).a(localView, paramMessageForDeviceFile);
      }
      for (;;)
      {
        i += 1;
  ...
  {
    paramLong = (ycb)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramLong);
    if (paramLong == null) {
      return null;
    }
  ...
  public MessageForDeviceFile a(String paramString, MessageForDeviceFile paramMessageForDeviceFile)
  {
    ...
    MessageForDeviceFile localMessageForDeviceFile = (MessageForDeviceFile)axaq.a(paramMessageForDeviceFile);
    if ("device_groupchat".equals(paramMessageForDeviceFile.extStr))
    {
      ...
      localMessageForDeviceFile.srcFileName = apue.a(localMessageForDeviceFile.filePath);
      localMessageForDeviceFile.fileSize = apue.a(localMessageForDeviceFile.filePath);
      localMessageForDeviceFile.msgStatus = 2;
      localMessageForDeviceFile.nFileStatus = 1;
      localMessageForDeviceFile.progress = 0.0F;
      ((akfw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).a(localMessageForDeviceFile);
      ...
      paramString = bbdr.a(BaseApplication.getContext(), Uri.parse(localMessageForDeviceFile.filePath));
      bbdr.a(BaseApplication.getContext(), localMessageForDeviceFile.filePath, paramString, 160, 160);
      aenv.a(((yak)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(localMessageForDeviceFile.frienduin), localMessageForDeviceFile.filePath, paramString), localMessageForDeviceFile);
    ...
    localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691594);
    if (paramString.compareTo(yeu.d) == 0)
    {
      localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691595);
      label361:
      ((akfw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).a(localMessageForDeviceFile);
      paramMessageForDeviceFile = (yak)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51);
    ...
    for (;;)
    {
      localMessageForDeviceFile.fileSize = apue.a(str1);
      if (!bbev.d(BaseApplication.getContext()))
      {
        localMessageForDeviceFile.nFileStatus = 6;
        localMessageForDeviceFile.msgStatus = 1;
      ...
      break;
      if (paramString.compareTo(yeu.c) != 0) {
        break label361;
      }
      localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691593);
      ...
      break label361;
      label545:
      if (paramString.compareTo(yeu.f) == 0)
      {
  ...
  public void a(View paramView, anis paramanis)
  {
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    Object localObject2 = ((yak)localObject1).a(Long.parseLong(localMessageForDeviceFile.frienduin));
    int i = 0;
    long l = 0L;
    ...
    if (paramSession.actionInfo.strServiceName.compareTo(yeu.d) == 0)
    {
    ...
    for (int j = 0;; j = 1)
    {
      ymw.a((AppRuntime)localObject2, l, "Net_SendMsg_Pic", 0, j, i);
      if ((paramSession.actionInfo.strServiceName.compareTo(yeu.c) == 0) && (paramSession.bSend) && (paramBoolean))
      {
        ...
        ((yak)localObject1).a(Long.parseLong(localMessageForDeviceFile.frienduin), str, String.valueOf(((Session)localObject2).uSessionID), paramSession.strFileNameSrc, paramSession.emFileType, localBundle);
        localObject1 = (MessageForDeviceFile)axaq.a(-4500);
        ((MessageForDeviceFile)localObject1).strServiceName = yeu.c;
        ...
        ((MessageForDeviceFile)localObject1).time = awzw.a();
        ...
        ((MessageForDeviceFile)localObject1).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691593);
  ...
  public void a(String paramString, long paramLong, boolean paramBoolean)
  {
    ...
    DeviceInfo localDeviceInfo = ((yak)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(localMessageForDeviceFile.frienduin));
    ...
    for (int i = localDeviceInfo.productId;; i = 0)
    {
      ...
      if (paramBoolean)
      {
        ...
        label76:
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691292);
        if (paramString.compareTo(yeu.d) != 0) {
          break label251;
        }
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691297);
      }
      for (;;)
      {
        if (QLog.isDevelopLevel()) {
        ...
        if (paramString.compareTo(yeu.c) == 0)
        {
          ...
          if (!paramBoolean)
          {
            ...
            if (localMessageForDeviceFile.isSend())
            {
              ...
              if (apue.a(localMessageForDeviceFile.filePath) == 0) {
                ymw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 1, 2, i);
              } else {
                ymw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 2, 2, i);
              }
            }
            else
            {
              ...
              for (;;)
              {
                ymw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendPrint", 2, j, i);
                break;
          ...
          {
            if (apue.a(localMessageForDeviceFile.filePath) == 0) {
              ymw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 1, 1, i);
            } else {
              ymw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 2, 1, i);
            }
          }
          else
          {
            ymw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendPrint", 1, 0, i);
          }
        }
      }
    }
  ...
  {
    MessageForStructing localMessageForStructing = axaq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 9501, 100L, paramAbsStructMsg);
    ...
    ((yak)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(paramString), paramAbsStructMsg);
  }
  ...
  public void a(String paramString1, String paramString2, List<String> paramList, Bundle paramBundle)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      localMessageForDeviceFile.srcFileName = apue.a((String)localObject1);
      localMessageForDeviceFile.fileSize = apue.a((String)localObject1);
      ...
      if (paramString1.compareTo(yeu.d) == 0)
      {
        localMessageForDeviceFile.nFileMsgType = 2;
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691595);
      }
      int i;
      if (paramString1.compareTo(yeu.c) == 0)
      {
        int i3 = 1;
        int i2 = 1;
        int i1 = 1;
      ...
      if ((localObject2 != null) && (((yak)localObject2).a(paramString2))) {
        if (paramString1.compareTo(yeu.d) == 0)
        {
          String str = bbdr.a(BaseApplication.getContext(), Uri.parse((String)localObject1));
          bbdr.a(BaseApplication.getContext(), (String)localObject1, str, 160, 160);
          localMessageForDeviceFile.uSessionID = ((yak)localObject2).a(Long.parseLong(paramString2), (String)localObject1, str);
        }
      }
      for (;;)
      {
        ...
        localArrayList.add(localMessageForDeviceFile);
        break;
        if (paramString1.compareTo(yeu.f) == 0)
        {
          localMessageForDeviceFile.uSessionID = ((yak)localObject2).a(Long.parseLong(paramString2), (String)localObject1, 0);
        }
        else
        {
          if (paramString1.compareTo(yeu.c) == 0)
          {
            localObject2 = ((yak)localObject2).a(Long.parseLong(paramString2));
            i = 0;
            if (localObject2 != null) {
              i = ((DeviceInfo)localObject2).productId;
            }
            ...
            ymw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 1, 0, i);
          }
          for (;;)
          {
            ...
            break label526;
            label722:
            ymw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 2, 0, i);
          }
          localObject1 = ((DeviceFileHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(50)).a((String)localObject1, paramString1, null, Long.parseLong(paramString2));
          if (localObject1 == null) {
            break;
  ...
  public void a(String paramString, List<String> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      localMessageForDeviceFile.srcFileName = apue.a(str);
      localMessageForDeviceFile.fileSize = apue.a(str);
      localMessageForDeviceFile.issend = 1;
      localMessageForDeviceFile.isread = true;
      localMessageForDeviceFile.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
      localMessageForDeviceFile.senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
      ...
      localMessageForDeviceFile.time = awzw.a();
      localMessageForDeviceFile.progress = 0.0F;
      localMessageForDeviceFile.msg = (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131694515) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691595));
      localMessageForDeviceFile.nFileMsgType = 2;
      ...
      str = bbdr.a(BaseApplication.getContext(), Uri.parse(localMessageForDeviceFile.filePath));
      bbdr.a(BaseApplication.getContext(), localMessageForDeviceFile.filePath, str, 160, 160);
      int i = ((yak)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(localMessageForDeviceFile.frienduin), localMessageForDeviceFile.filePath, str);
      localMessageForDeviceFile.uSessionID = i;
      a(localMessageForDeviceFile.uSessionID, localMessageForDeviceFile.frienduin, localMessageForDeviceFile.istroop, localMessageForDeviceFile.uniseq);
      aenv.a(i, localMessageForDeviceFile);
    }
  }
  ...
  public boolean a(String paramString, List<FileInfo> paramList)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        {
          localMessageForDeviceFile.strServiceName = yeu.b;
          continue;
          label512:
          if (localMessageForDeviceFile.strServiceName.compareTo(yeu.f) == 0)
          {
            localMessageForDeviceFile.uSessionID = localyak.a(Long.parseLong(paramString), ((FileInfo)localObject).c(), 0);
          }
          else
          {
    ...
    if ((localyak != null) && (localyak.a(l1, 9))) {}
    for (int i = 1;; i = 0)
    {
      ArrayList localArrayList = new ArrayList();
      paramList = paramList.iterator();
      for (;;)
      {
        ...
        localMessageForDeviceFile = (MessageForDeviceFile)axaq.a(-4500);
        ...
        localMessageForDeviceFile.srcFileName = apue.a(((FileInfo)localObject).c());
        localMessageForDeviceFile.fileSize = apue.a(((FileInfo)localObject).c());
        localMessageForDeviceFile.issend = 1;
        localMessageForDeviceFile.isread = true;
        localMessageForDeviceFile.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
        localMessageForDeviceFile.senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
        ...
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691594);
        localMessageForDeviceFile.nFileMsgType = 1;
        if (localMessageForDeviceFile.strServiceName.compareTo(yeu.d) == 0)
        {
          localMessageForDeviceFile.nFileMsgType = 2;
          localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131691595);
        }
        ((akfw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).a(localMessageForDeviceFile);
        if ((localyak == null) || (!localyak.a(paramString))) {
          break label600;
        }
        if (localMessageForDeviceFile.strServiceName.compareTo(yeu.d) != 0) {
          break label512;
        }
        localMessageForDeviceFile.uSessionID = localyak.a(Long.parseLong(paramString), ((FileInfo)localObject).c(), null);
        if (!bbev.d(BaseApplication.getContext()))
        {
          localMessageForDeviceFile.nFileStatus = 6;
          localMessageForDeviceFile.msgStatus = 1;
  ...
  public void b(Bundle paramBundle)
  {
    ...
    Object localObject = ((yak)localObject).a(Long.parseLong(paramBundle.frienduin));
    long l = 0L;
    int i;
    if (localObject != null)
    {
    ...
    {
      int j;
      if (paramBundle.strServiceName.compareTo(yeu.d) == 0)
      {
        localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
        if (m == 0)
        {
          j = 0;
          ymw.a((AppRuntime)localObject, l, "Net_SendMsg_Pic", 0, j, i);
        }
      }
      else
      {
