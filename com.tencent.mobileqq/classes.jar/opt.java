  ...
  extends BaseAdapter
{
  ...
  private ArrayList<rgc> jdField_a_of_type_JavaUtilArrayList;
  
  public void a(List<rgc> paramList)
  {
    if (paramList != null)
    {
      this.jdField_a_of_type_JavaUtilArrayList.clear();
      rgc localrgc = new rgc();
      this.jdField_a_of_type_JavaUtilArrayList.add(localrgc);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      ((opv)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView = ((BubbleImageView)localObject3);
      ...
      ((opv)localObject1).jdField_b_of_type_ComTencentMobileqqWidgetBubbleImageView = ((BubbleImageView)localObject3);
      paramView.addView((View)localObject3);
      ...
      ((opv)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)localObject3);
      paramView.addView((View)localObject3);
      localObject3 = new TextView(this.jdField_a_of_type_AndroidContentContext);
      ...
      ((TextView)localObject3).setBackgroundResource(2130843050);
      ((opv)localObject1).jdField_b_of_type_AndroidWidgetTextView = ((TextView)localObject3);
      paramView.addView((View)localObject3);
      paramView.setTag(localObject1);
      label501:
      localObject2 = (rgc)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
      if (localObject2 != null)
      {
        ...
        if (TextUtils.isEmpty(((rgc)localObject2).d)) {
          break label706;
        }
        localObject3 = URLDrawable.getDrawable(((rgc)localObject2).d, (URLDrawable.URLDrawableOptions)localObject4);
        if (((URLDrawable)localObject3).getStatus() == 2) {
          ((URLDrawable)localObject3).restartDownload();
        }
        ((opv)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView.setImageDrawable((Drawable)localObject3);
        label601:
        localObject3 = new StringBuilder();
        if (!TextUtils.isEmpty(((rgc)localObject2).c)) {
          ((StringBuilder)localObject3).append(((rgc)localObject2).c);
        }
        if (!TextUtils.isEmpty(((rgc)localObject2).a)) {
          ((StringBuilder)localObject3).append(((rgc)localObject2).a);
        }
        ((opv)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(((StringBuilder)localObject3).toString());
        if (((rgc)localObject2).b > 0) {
          break label719;
        }
        ((opv)localObject1).jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
      }
    }
    for (;;)
    {
      ...
      break;
      localObject1 = (opv)paramView.getTag();
      break label501;
      label706:
      ((opv)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView.setImageDrawable((Drawable)localObject3);
      break label601;
      label719:
      if (((rgc)localObject2).b < 1000)
      {
        ((opv)localObject1).jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
        ((opv)localObject1).jdField_b_of_type_AndroidWidgetTextView.setText("+" + ((rgc)localObject2).b);
      }
      else
      {
        ((opv)localObject1).jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
        ((opv)localObject1).jdField_b_of_type_AndroidWidgetTextView.setText("+999");
      }
    }
  }
