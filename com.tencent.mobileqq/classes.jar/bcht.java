  ...
  extends bchd
{
  ...
  public bcht(QQAppInterface paramQQAppInterface, View paramView, StructMsgForGeneralShare paramStructMsgForGeneralShare)
  {
    ...
    if ((paramQQAppInterface != null) && ((paramQQAppInterface instanceof agpx)))
    {
      paramQQAppInterface = (agpx)paramQQAppInterface;
    ...
    {
      return;
      if ((paramQQAppInterface != null) && ((paramQQAppInterface instanceof alik)))
      {
        paramQQAppInterface = (alik)paramQQAppInterface;
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin = this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.frienduin;
        this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType = this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.istroop;
        this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendNick = paramQQAppInterface.jdField_a_of_type_JavaLangString;
        return;
      }
  ...
  public boolean a(View paramView, String paramString)
  {
    ...
    {
      return false;
      paramView = paramView.findViewById(2131371651);
      if (paramView == null)
      {
        int i;
        ...
        for (paramView = ((bcgw)this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.mStructMsgItemLists.get(0)).h;; paramView = "")
        {
      ...
      paramView = (bcjl)paramView.getTag();
    ...
    if ((paramView != null) && (paramView.size() > 0))
    {
      ...
      if ((!bool1) && (!TextUtils.isEmpty((CharSequence)localObject)) && (((String)localObject).equals(paramString)) && (!bool2))
      {
        ...
        {
          if (paramView != null) {
            awhn.a(paramView, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (Activity)this.jdField_a_of_type_AndroidContentContext, 1);
          }
          return true;
        }
      }
      ...
      amxb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X8006390");
    }
    for (;;)
    {
      return true;
      label272:
      amxb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X80060B3");
      continue;
      label285:
      if (bool2) {
        if (!TextUtils.isEmpty((CharSequence)localObject)) {
          amxb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X8006391");
        } else {
          amxb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "0X80060B4");
        }
      }
    }
  }
  ...
  public boolean a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        return true;
        if ((!bcvs.a(paramString)) && (localStructMsgForGeneralShare.mSourceAppid != bcvs.a)) {
          continue;
        }
        ...
        return true;
        if ((!(localContext instanceof BaseActivity)) || (!avsc.a((BaseActivity)localContext, (String)localObject2, localStructMsgForGeneralShare.message))) {
          continue;
        }
        return true;
        ...
        paramString = nny.a(paramString, "platformId=qq_m");
        ...
        if ((TextUtils.isEmpty(str2)) || (!bftf.b(localStructMsgForGeneralShare.uin))) {
          continue;
        }
        ...
        paramString = bfwg.a(localNumberFormatException, localContext, Uri.parse("mqqapi://card/show_pslcard?" + HttpUtil.encodeUrl(paramString)).toString());
        if (paramString == null) {
          continue;
        }
        paramString.a();
        ...
        if (!bkwt.a(this.jdField_a_of_type_AndroidContentContext, str2)) {
          continue;
        }
        return true;
        if ((TextUtils.isEmpty(str2)) || (!ugf.c(str2)) || (!tgc.b(str2))) {
          continue;
        }
        tgc.a(localContext, null, tgc.b(str2), null);
        return true;
        if ((this.jdField_a_of_type_ComTencentMobileqqDataChatMessage == null) || (this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend()) || (this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.istroop != 0) || (!bftf.b(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.frienduin)) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.getExtInfoFromExtStr("guide_msg_cookie")))) {
          continue;
        }
        paramString = bftf.a(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage.getExtInfoFromExtStr("guide_msg_cookie"));
        if (paramString == null) {
          continue;
        }
        ...
        try
        {
          ...
          if (((babyq_cookie.BabyQCookie)localObject3).uint32_type.get() == 206) {
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().sendSpecialMessage("babyq_game_tribe");
          }
          ...
          if (localStructMsgForGeneralShare.uinType == 0)
          {
            ...
            aewt.a((Intent)localObject4, localNumberFormatException, localStructMsgForGeneralShare.message);
            if ((ugf.a(localNumberFormatException, localStructMsgForGeneralShare.uin) != -1) || (str2.startsWith("http://browserApp.p.qq.com/")))
            {
              ...
              {
                paramString.putInt("uin_type", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType);
                paramString.putString("uin_name", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendNick);
              }
              paramString.putBoolean("switch_msg_btn", ugf.a());
            ...
            bool = apsz.a(localNumberFormatException, localStructMsgForGeneralShare.uin);
            ...
            {
              paramString = "https://ti.qq.com/honest-say/group.html?_bid=3104&_qStyle=1&_wv=9191&_nav_alpha=0&_nav_txtclr=FFFFFF&_nav_titleclr=FFFFFF&_nav_anim=true&_wwv=128&gc=$GCODE$&src_type=share&from=appstore_aio&adtag=qq_to_qq".replace("$GCODE$", awkh.a(localStructMsgForGeneralShare.uin));
              ...
              if ((localContext instanceof FragmentActivity))
              {
                ...
                if (localObject2 != null)
                {
                  ...
                  if ((paramString != null) && ((paramString instanceof TroopChatPie))) {
                    apsz.a((TroopChatPie)paramString);
                  }
                }
              }
            }
            ...
            QQToast.a(BaseApplicationImpl.getContext(), apsz.jdField_a_of_type_JavaLangString, 0).a();
            return false;
          }
        }
        catch (InvalidProtocolBufferMicroException paramString)
        {
          ...
          ((Intent)localObject4).putExtra("big_brother_source_key", ugf.b(localStructMsgForGeneralShare.source_puin));
          continue;
        ...
        if ((localStructMsgForGeneralShare.mMsgServiceID != 14) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType != 1)) {
          continue;
        }
        paramString = bezm.a(localStructMsgForGeneralShare, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin);
        if (TextUtils.isEmpty(paramString)) {
          continue;
        }
        ((Intent)localObject4).removeExtra("url");
        ...
        i = 1;
        odq.a(null, "", "0X8007555", "0X8007555", 0, 0, paramString, "", "" + i, "");
        odq.a("0X8007555", "", paramString, "", "" + i, "");
        ...
        ugf.a(localStructMsgForGeneralShare.message, (Intent)localObject4, str2);
        ...
        aeub.a(localContext, (Intent)localObject4, str2);
        bcef.b(null, "P_CliOper", "Pb_account_lifeservice", "", "aio_msg_url", "aio_url_clickqq", 0, 1, 0, str2, "", "", "");
        if (!bool) {
          continue;
        }
        ...
        bcef.b(localNumberFormatException, "CliOper", "", "", "0X80052BB", "0X80052BB", 0, 0, "", "", "", "");
        continue;
        bcef.b(localNumberFormatException, "CliOper", "", "", "0X80052BC", "0X80052BC", 0, 0, "", "", "", "");
        continue;
        i = 2;
        continue;
        continue;
      ...
      bcef.b(null, "CliOper", "", (String)localObject3, "0X80061B0", "0X80061B0", i, 0, str1, (String)localObject4, (String)localObject1, str2);
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.mMsgServiceID == 107)
      {
        ...
        {
          StructMsgForGeneralShare.receiptServer = new bchu(this, "receipt_msg");
      ...
      l = bftp.a(localStructMsgForGeneralShare.mSourceAppid);
      ...
      if ((localContext instanceof FragmentActivity))
      {
        ...
        if (localObject3 != null)
        {
          ...
          {
            localObject4 = (ahiu)localObject3;
            ((ahiu)localObject4).j += 1;
            localObject3 = (ahiu)localObject3;
            ((ahiu)localObject3).h += 1;
          }
        }
      }
      if (!c(paramString)) {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.message != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.message.istroop == 1008)) {
        ocw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.uin);
      }
      return false;
      i = 1;
    }
  ...
  public boolean c(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      paramString1 = bfwg.a(localQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramString1);
      if (paramString1 == null) {
        break;
      }
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.message != null) && (bftf.b(this.jdField_a_of_type_ComTencentMobileqqStructmsgStructMsgForGeneralShare.message.senderuin))) {
