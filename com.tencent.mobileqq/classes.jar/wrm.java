...
public class wrm
  extends AsyncTask<wro, wrq, wrp>
{
  public final wgj a;
  
  public wrm(wgj paramwgj)
  {
    if (paramwgj == null) {
  ...
  public static String a(String paramString)
  {
    ...
    //   57: ldc 50
    //   59: ldc 52
    //   61: invokestatic 57	yqp:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   64: aload_3
    //   65: astore_0
    //   66: aload_2
    //   67: ifnull +9 -> 76
    ...
    //   85: invokestatic 67	wrm:a	([B)Ljava/lang/String;
    //   88: astore 4
    //   90: aload 4
    //   92: astore_3
    //   93: aload_3
  ...
  {
    yqp.b("FileDownloadTask", paramString);
  }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    yqp.b("FileDownloadTask", "expectedMd5 = " + paramString2);
    yqp.b("FileDownloadTask", "file Md5    = " + paramString1);
  ...
  protected wrp a(wro... paramVarArgs)
  {
    ...
    if (a(paramVarArgs.b, paramVarArgs.c))
    {
      ...
      return new wrp(paramVarArgs, 0, "has local file already");
    }
    this.a.a(new wrn(this, paramVarArgs));
    ...
    if ((i == 0) && (!a(paramVarArgs.b, paramVarArgs.c)))
    {
      ...
      try
      {
        zkr.d(paramVarArgs.b);
        return new wrp(paramVarArgs, -1, "file md5 mismatch");
      }
    ...
    return new wrp(paramVarArgs, i, "error=" + i);
  }
}
