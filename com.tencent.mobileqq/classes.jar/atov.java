...
public class atov
  extends atcd
{
  public atov(NearbyPeopleProfileActivity paramNearbyPeopleProfileActivity) {}
  ...
  protected void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, String paramString)
  {
    ...
    do
    {
      ...
      str = bbkk.a(paramString, "<head>", "</head>");
      paramString = bbkk.a(paramString, "<body>", "</body>");
    } while (!this.a.isResume());
    bbjc.a(this.a, str, paramString, paramInt3 - paramInt1).show();
  }
  ...
  public void a(boolean paramBoolean1, long paramLong, boolean paramBoolean2, boolean paramBoolean3, byte[] paramArrayOfByte, String paramString)
  {
    ...
    anml.c("profileCard", new Object[] { ((StringBuilder)localObject).toString() });
    localObject = this.a;
    ...
    if (paramBoolean1) {
      if (paramBoolean2)
      {
        anml.c(NearbyPeopleProfileActivity.class.getSimpleName(), new Object[] { "onGetShowLoveLimit , can chat, someting is wrong" });
    ...
    for (;;)
    {
      ...
      if (paramBoolean3)
      {
        if (NearbyPeopleProfileActivity.a(this.a) != null)
        {
          ...
          bbac.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne);
          QLog.d("Q.nearby_people_card.", 1, "ShowLoveEditorActivity 已在725下架");
        }
      }
      else
      {
        anml.c(NearbyPeopleProfileActivity.class.getSimpleName(), new Object[] { "cant show love, wording is " + paramString });
        paramArrayOfByte = paramString;
        if (TextUtils.isEmpty(paramString)) {
          paramArrayOfByte = ((Activity)localObject).getResources().getString(2131699345);
        }
        anml.a(this.a, paramArrayOfByte);
        continue;
        anml.a((Activity)localObject, ((Activity)localObject).getString(2131699344));
      }
    }
  }
  ...
  protected void a(boolean paramBoolean1, NearbyPeopleCard paramNearbyPeopleCard, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        ((ataj)this.a.app.getManager(207)).a(paramNearbyPeopleCard.uin, false);
  ...
  public void a(boolean paramBoolean1, NearbyPeopleCard paramNearbyPeopleCard, boolean paramBoolean2, String paramString)
  {
    ...
    if (paramBoolean1)
    {
      ...
      if (this.a.t)
      {
        this.a.jdField_a_of_type_Atbz.a(true);
        this.a.t = false;
      }
  ...
  protected void a(boolean paramBoolean, String paramString)
  {
    if (paramBoolean)
    {
      paramString = (ataj)this.a.app.getManager(207);
      if (NearbyPeopleProfileActivity.a(this.a) != null) {
    ...
    return;
    label157:
    this.a.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new atow(this, paramString));
  ...
  {
    if ((NearbyPeopleProfileActivity.a(this.a) == null) || (TextUtils.isEmpty(NearbyPeopleProfileActivity.a(this.a).uin)) || (TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString1)) || (bbbr.a(paramString2, paramString1))) {}
    do
    {
      do
      {
        return;
      } while ((!bbbr.a(paramString2, NearbyPeopleProfileActivity.a(this.a).uin)) || (!bbbr.a(paramString1, this.a.app.getCurrentAccountUin())));
      if (!paramBoolean)
      {
        this.a.b(this.a.getResources().getString(2131693543));
  ...
  public void a(boolean paramBoolean, String paramString1, List<atfm> paramList, String paramString2, int paramInt1, int paramInt2)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      this.a.a();
      this.a.a(2, ajya.a(2131707250));
      return;
    }
    this.a.a();
    this.a.a(1, ajya.a(2131707241) + paramString2);
  }
  ...
  protected void a(boolean paramBoolean, UpdatePhotoList.HeadInfo paramHeadInfo)
  {
    ...
    if (this.a.jdField_a_of_type_Long > 0L) {
      bazx.a(this.a.jdField_a_of_type_Atbz, this.a.app, this.a.jdField_a_of_type_Long, null, this.a.jdField_d_of_type_Int, arrayOfByte, l, true, this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Long, NearbyPeopleProfileActivity.a(this.a.j), NearbyPeopleProfileActivity.a(this.a), NearbyPeopleProfileActivity.a(this.a));
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      return;
      if (!bbkk.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString)) {
        bazx.a(this.a.jdField_a_of_type_Atbz, this.a.app, 0L, this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString, this.a.jdField_d_of_type_Int, arrayOfByte, l, true, this.a.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Long, NearbyPeopleProfileActivity.a(this.a.j), NearbyPeopleProfileActivity.a(this.a), NearbyPeopleProfileActivity.a(this.a));
      }
    }
  }
}
