...
public class amrf
{
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        bfyz.a(BaseApplicationImpl.getContext(), paramInt, j, k, m, (String)localObject1, (String)localObject3, paramString);
        if (QLog.isColorLevel()) {
  ...
  private static boolean a(String paramString1, String paramString2)
  {
    ...
    //   149	632	11	localBufferedReader	java.io.BufferedReader
    //   473	187	12	localObject2	Object
    // Exception table:
    //   from	to	target	type
