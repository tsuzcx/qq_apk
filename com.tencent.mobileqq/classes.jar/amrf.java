  ...
  implements SurfaceTexture.OnFrameAvailableListener, GLSurfaceView.Renderer
{
  ...
  amqz jdField_a_of_type_Amqz;
  amre jdField_a_of_type_Amre = new amre();
  ...
  private hi jdField_a_of_type_Hi = new hi();
  ...
  private amrg[] jdField_a_of_type_ArrayOfAmrg = new amrg[300];
  ...
  public amrf(amqu paramamqu)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Amqu = paramamqu;
    this.jdField_a_of_type_Amqz = paramamqu.a();
  }
  
  public int a()
  {
    return this.jdField_a_of_type_Amre.a();
  }
  ...
  protected void a()
  {
    ...
    try
    {
      ...
      localObject = BitmapFactory.decodeResource(BaseApplicationImpl.getApplication().getResources(), 2130844413, (BitmapFactory.Options)localObject);
      if (localObject != null)
      {
    ...
    try
    {
      localObject = new BitmapFactory.Options();
      ((BitmapFactory.Options)localObject).inPreferredConfig = Bitmap.Config.ARGB_8888;
      localObject = BitmapFactory.decodeResource(this.jdField_a_of_type_Amqu.a().getResources(), 2130844414, (BitmapFactory.Options)localObject);
      if (localObject != null)
      {
        GLUtils.texImage2D(3553, 0, (Bitmap)localObject, 0);
        ((Bitmap)localObject).recycle();
  ...
  {
    this.u = 1;
    this.jdField_a_of_type_Amqz.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_Amqz.c = 0L;
    this.jdField_a_of_type_Amqz.jdField_b_of_type_Long = 0L;
  ...
  public void a(FloatBuffer paramFloatBuffer, Size paramSize)
  {
    ...
    if ((this.jdField_a_of_type_AndroidUtilSize == null) && (this.jdField_a_of_type_Amre != null))
    {
      this.jdField_a_of_type_AndroidUtilSize = paramSize;
      this.jdField_a_of_type_Amre.a(paramSize.getHeight(), paramSize.getWidth(), anbw.jdField_a_of_type_Int, anbw.jdField_b_of_type_Int);
    }
  }
  ...
  public void c()
  {
    ...
    if (i4 < 300)
    {
      localamrg2 = this.jdField_a_of_type_ArrayOfAmrg[i4];
      if ((localamrg2 != null) && (!localamrg2.jdField_a_of_type_Boolean))
      {
        if (this.jdField_a_of_type_JavaUtilRandom.nextFloat() > 0.7F - localamrg2.jdField_b_of_type_Float * 0.35F - Math.abs(localamrg2.jdField_a_of_type_Float * 0.3F - 0.15F)) {
          localamrg2.jdField_a_of_type_Boolean = true;
        }
      }
      else
      {
        if (localamrg2 != null)
        {
          localamrg1 = localamrg2;
          i3 = i2;
          if (!localamrg2.jdField_a_of_type_Boolean) {
            break label370;
          }
        }
        if (i2 <= i7) {
    ...
    for (;;)
    {
      ...
      float f4 = localamrg2.jdField_b_of_type_Float;
      localamrg2.jdField_b_of_type_Float = (f3 * 0.3F + 0.2F * localamrg2.jdField_b_of_type_Float + f2 + f4);
      if (localamrg2.jdField_b_of_type_Float <= 1.0D) {
        break label184;
      }
      localamrg2.jdField_a_of_type_Boolean = true;
      break label184;
      ...
      if (localamrg2 == null)
      {
        localamrg1 = new amrg(this);
        this.jdField_a_of_type_ArrayOfAmrg[i4] = localamrg1;
      }
      f3 = this.jdField_a_of_type_JavaUtilRandom.nextFloat();
      if (f3 < 0.4D) {
        localamrg1.jdField_a_of_type_Float = (f3 * 2.35F + 0.02F);
      }
      for (;;)
      {
        localamrg1.jdField_b_of_type_Float = (this.jdField_a_of_type_JavaUtilRandom.nextFloat() * 0.05F + f1);
        localamrg1.jdField_a_of_type_Boolean = false;
        i3 = i2 + 1;
        label370:
        if ((localamrg1 == null) || (localamrg1.jdField_a_of_type_Boolean) || (localamrg1.jdField_b_of_type_Float >= 1.0D)) {
          break label542;
        }
        this.jdField_c_of_type_ArrayOfFloat[(i1 * 2)] = (this.jdField_a_of_type_ArrayOfAmrg[i4].jdField_a_of_type_Float * i5);
        this.jdField_c_of_type_ArrayOfFloat[(i1 * 2 + 1)] = (this.jdField_a_of_type_ArrayOfAmrg[i4].jdField_b_of_type_Float * i6);
        i1 += 1;
        i2 = i3;
        break;
        if (f3 > 0.6F) {
          localamrg1.jdField_a_of_type_Float = ((1.0F - f3) * 2.35F + 0.02F);
        }
      }
  ...
  public void onDrawFrame(GL10 paramGL10)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        a(this.jdField_a_of_type_ArrayOfFloat, this.jdField_a_of_type_Hi.a(), this.jdField_a_of_type_Hi.d(), this.jdField_a_of_type_Hi.b(), paramGL10, this.jdField_a_of_type_Hi.b(), this.jdField_a_of_type_Hi.c());
        a(0, this.jdField_a_of_type_Hi.a());
        d();
        e();
        f();
      ...
      if (this.jdField_a_of_type_Amqz.jdField_a_of_type_Long == 0L) {
        break;
      }
      while (this.jdField_a_of_type_Amqz.c > this.jdField_a_of_type_Amqz.jdField_b_of_type_Long)
      {
        paramGL10 = this.jdField_a_of_type_Amqz;
      ...
      continue;
      label318:
      if ((this.jdField_a_of_type_Amre != null) && (this.u == 2)) {
        this.jdField_a_of_type_Amre.a(this.jdField_a_of_type_JavaNioFloatBuffer);
      }
    }
  }
