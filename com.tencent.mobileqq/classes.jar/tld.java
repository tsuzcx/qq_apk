...
class tld
  implements URLDrawable.URLDrawableListener, tlh
{
  private static tlf jdField_a_of_type_Tlf = new tlf(null);
  ...
  tld(ReadInJoyCapsuleView paramReadInJoyCapsuleView)
  {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    localURLDrawableOptions.mLoadingDrawable = tkx.a();
    localURLDrawableOptions.mFailedDrawable = tkx.a();
  ...
  private void c()
  {
    ...
    int i = tkx.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelCoverInfo.mChannelCoverId, false);
    if (i != 0) {
  ...
  private void d()
  {
    ...
    a(true);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView.setColorFilter(tkx.a());
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView.setTextColor(-1);
    int i = tkx.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructChannelCoverInfo.mChannelCoverId, true);
    if (i != 0) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView.setDrawableLeft(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView.getContext().getResources().getDrawable(i));
    }
  }
  ...
  void a(ChannelCoverInfo paramChannelCoverInfo, View.OnClickListener paramOnClickListener)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyCapsuleView.setOnClickListener(new tle(this, paramOnClickListener));
    if ((TextUtils.isEmpty(paramChannelCoverInfo.externalExposureBackgroundUrl)) || (bmhv.c(paramChannelCoverInfo.mChannelCoverId)))
    {
      c();
      return;
    }
  ...
  public void onLoadSuccessed(URLDrawable paramURLDrawable)
  {
    ...
    jdField_a_of_type_Tlf.a(this, paramURLDrawable);
  }
}
