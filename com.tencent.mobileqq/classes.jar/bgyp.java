...
public class bgyp
{
  ...
  static
  {
    ...
    jdField_b_of_type_JavaLangString = ajya.a(2131711920);
  }
  ...
  {
    Intent localIntent = new Intent();
    localIntent.putExtra("key_left_tab_title", paramContext.getString(2131717655));
    localIntent.putExtra("key_rihgt_tab_title", paramContext.getString(2131717736));
  ...
  @NonNull
  private static Intent a(bgyw parambgyw, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyw);
  ...
  private static Intent a(bgyw parambgyw, String paramString)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyw);
  ...
  public static SurfaceView a(Context paramContext, String paramString)
  {
    try
    {
      if (f())
      {
        bdis.a().a(jdField_b_of_type_JavaLangString, 1);
        return null;
      }
      try
      {
  ...
  {
    bbdj.a(paramActivity, 230).setMessage(2131718239).setPositiveButton(2131717766, new bgyq()).setNegativeButton(2131719547, paramOnClickListener).show();
  }
  ...
  public static void a(Activity paramActivity, Bundle paramBundle, bgyw parambgyw, String paramString1, String paramString2, String paramString3, int paramInt)
  {
    Intent localIntent = new Intent();
    ...
    QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void a(Activity paramActivity, bgyw parambgyw, int paramInt)
  {
    c(paramActivity, parambgyw, null, paramInt);
  }
  
  public static void a(Activity paramActivity, bgyw parambgyw, int paramInt, Bundle paramBundle)
  {
    Intent localIntent = new Intent();
    localIntent.putExtras(paramBundle);
    a(localIntent, parambgyw);
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, int paramInt, String paramString, long paramLong1, long paramLong2)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyw);
    ...
    QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, localIntent, 0);
  }
  
  public static void a(Activity paramActivity, bgyw parambgyw, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString5, int paramInt8, Bundle paramBundle, boolean paramBoolean1, boolean paramBoolean2, int paramInt9, int paramInt10, boolean paramBoolean3)
  {
    a(paramActivity, parambgyw, paramInt1, paramString1, paramString2, paramString3, paramString4, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramString5, paramInt8, paramBundle, paramBoolean1, paramBoolean2, paramInt9, paramInt10, paramBoolean3, null);
  }
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString5, int paramInt8, Bundle paramBundle1, boolean paramBoolean1, boolean paramBoolean2, int paramInt9, int paramInt10, boolean paramBoolean3, Bundle paramBundle2)
  {
    ...
    for (;;)
    {
      ...
      for (paramInt2 = 1;; paramInt2 = 0)
      {
        ...
        QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, paramString1, paramInt1, null, true);
        return;
      }
    }
  }
  ...
  {
    a(paramActivity, parambgyw, paramInt1, paramString1, paramString2, paramString3, paramString4, paramInt2, paramBoolean1, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramString5, paramInt8, paramInt9, paramBoolean2, paramString6, paramBoolean3, null);
  }
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, int paramInt1, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt2, boolean paramBoolean1, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString5, int paramInt8, int paramInt9, boolean paramBoolean2, String paramString6, boolean paramBoolean3, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      for (paramInt7 = 1;; paramInt7 = 0)
      {
        ...
        QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, paramString1, paramInt1, null, paramBoolean2);
        return;
      }
    }
  }
  
  public static void a(Activity paramActivity, bgyw parambgyw, long paramLong, int paramInt)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyw);
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, Intent paramIntent)
  {
    a(paramActivity, parambgyw, paramIntent, -1);
  }
  
  public static void a(Activity paramActivity, bgyw parambgyw, Intent paramIntent, int paramInt)
  {
    a(paramIntent, parambgyw);
    if (paramInt >= 0) {
    ...
    for (;;)
    {
      ...
      QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, paramIntent, paramInt);
      return;
      paramIntent.putExtra("bNeedCallBack", false);
    }
  }
  
  public static void a(Activity paramActivity, bgyw parambgyw, Intent paramIntent, int paramInt, DialogInterface.OnDismissListener paramOnDismissListener)
  {
    QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, paramIntent, paramInt, paramOnDismissListener, true);
  }
  
  public static void a(Activity paramActivity, bgyw parambgyw, Intent paramIntent, int paramInt, boolean paramBoolean)
  {
    a(paramIntent, parambgyw);
    if (paramInt >= 0) {
      paramIntent.putExtra("bNeedCallBack", true);
    ...
    {
      QzonePluginProxyActivity.a(paramIntent, "com.qzone.misc.web.QZoneTranslucentActivity");
      QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, paramIntent, paramInt, null, paramBoolean);
      return;
      paramIntent.putExtra("bNeedCallBack", false);
    }
  }
  ...
  @Deprecated
  public static void a(Activity paramActivity, bgyw parambgyw, Intent paramIntent, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, ArrayList<String> paramArrayList, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      paramString2 = String.valueOf(axau.a());
      paramIntent.putExtra("key_upload_client_key", paramString2);
      paramString1.putExtra("key_upload_client_key", paramString2);
      QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, paramString1, paramInt2);
      return;
      i = 0;
      continue;
      i = 3;
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = a(parambgyw, "com.qzone.album.ui.activity.QZonePersonalAlbumSelectActivity");
    localIntent.putExtras(paramBundle);
    QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void a(Activity paramActivity, bgyw parambgyw, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt)
  {
    paramBaseBusinessAlbumInfo = a(parambgyw, paramBaseBusinessAlbumInfo);
    QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, paramBaseBusinessAlbumInfo, paramInt);
  }
  
  public static void a(Activity paramActivity, bgyw parambgyw, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt, String paramString)
  {
    paramBaseBusinessAlbumInfo = a(parambgyw, paramBaseBusinessAlbumInfo);
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, CoverCacheData paramCoverCacheData, String paramString, int paramInt)
  {
    parambgyw = bgyt.a(parambgyw.jdField_a_of_type_JavaLangString, paramString, "usersummary", true);
    paramCoverCacheData = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramCoverCacheData);
    paramCoverCacheData.putExtra("url", parambgyw);
    if (bcds.a.containsKey("Qzone")) {
      paramCoverCacheData.putExtra("insertPluginsArray", new String[] { "Qzone" });
    }
    paramCoverCacheData.setData(Uri.parse(parambgyw));
    c(paramCoverCacheData);
    paramActivity.startActivityForResult(paramCoverCacheData, paramInt);
  }
  
  public static void a(Activity paramActivity, bgyw parambgyw, Long paramLong, int paramInt1, int paramInt2, int paramInt3, aqyd paramaqyd)
  {
    paramLong = a(paramActivity, paramLong, paramInt1);
    a(paramLong, parambgyw);
    a(paramLong, paramInt2);
    QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, paramLong, paramInt3, paramaqyd);
  }
  
  public static void a(Activity paramActivity, bgyw parambgyw, Long paramLong, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    a(paramActivity, parambgyw, paramLong, paramInt1, paramBoolean, paramInt2, 5);
  }
  
  public static void a(Activity paramActivity, bgyw parambgyw, Long paramLong, int paramInt1, boolean paramBoolean, int paramInt2, int paramInt3)
  {
    ...
    QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, paramLong, paramInt2);
  }
  
  @Deprecated
  public static void a(Activity paramActivity, bgyw parambgyw, String paramString, int paramInt)
  {
    if (TextUtils.isEmpty(paramString)) {
      return;
    }
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, String paramString1, int paramInt, Bundle paramBundle, String paramString2)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyw);
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, String paramString1, int paramInt, String paramString2)
  {
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, String paramString1, long paramLong, int paramInt1, int paramInt2, String paramString2, String paramString3)
  {
    Intent localIntent = new Intent();
    ...
    QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, localIntent, paramInt1);
  }
  
  public static void a(Activity paramActivity, bgyw parambgyw, String paramString1, long paramLong, String paramString2, int paramInt)
  {
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, String paramString1, long paramLong, String paramString2, int paramInt, String paramString3, boolean paramBoolean)
  {
    Intent localIntent = new Intent("com.tencent.intent.QZONE_OPEN_VIP");
    a(localIntent, parambgyw);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.module.vipcomponent.ui.DiamondYellowOpenActivity");
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, String paramString1, long paramLong, String paramString2, String paramString3, int paramInt)
  {
    Object localObject;
    if (paramActivity == null) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        ((Intent)localObject).putExtra("userId", parambgyw.jdField_a_of_type_JavaLangString);
        ((Intent)localObject).putExtra("userName", parambgyw.jdField_b_of_type_JavaLangString);
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, String paramString1, String paramString2, int paramInt)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyw);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.detail.ui.activity.QzoneDetailActivity");
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyw);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.detail.ui.activity.QzoneDetailActivity");
    ...
    QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, localIntent, paramInt2);
  }
  
  public static void a(Activity paramActivity, bgyw parambgyw, String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3)
  {
    ...
    parambgyw = paramString1;
    if (!TextUtils.isEmpty(paramString3)) {
      parambgyw = paramString1 + "&source=" + paramString3;
    }
    paramString1 = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramString1);
    if (QLog.isColorLevel()) {
      QLog.d("QZoneHelper", 2, "forwardToQunAlbumList:" + parambgyw);
    }
    paramString1.putExtra("url", parambgyw);
    if (bcds.a.containsKey("Qzone")) {
      paramString1.putExtra("insertPluginsArray", new String[] { "Qzone" });
    }
    paramString1.setData(Uri.parse(parambgyw));
    c(paramString1);
    paramActivity.startActivityForResult(paramString1, paramInt2);
  }
  
  public static void a(Activity paramActivity, bgyw parambgyw, String paramString1, String paramString2, String paramString3, int paramInt)
  {
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt)
  {
    parambgyw = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunAlbumPhotoList", "https://h5.qzone.qq.com/groupphoto/inqq/photo/{QUN_ID}/{ALBUM_ID}?_wv=3&_proxy=1").replace("{QUN_ID}", paramString1).replace("{ALBUM_ID}", paramString2);
    paramString1 = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramString1);
    paramString1.putExtra("url", parambgyw);
    if (bcds.a.containsKey("Qzone")) {
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, Bundle paramBundle)
  {
    a(paramActivity, parambgyw, paramString1, paramString2, paramString3, paramString4, paramInt, paramBundle, true, false);
  }
  
  public static void a(Activity paramActivity, bgyw parambgyw, String paramString1, String paramString2, String paramString3, String paramString4, long paramLong, int paramInt)
  {
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, String paramString1, String paramString2, ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, ArrayList<Long> paramArrayList, int paramInt, String paramString3, String paramString4)
  {
    Intent localIntent = new Intent("com.tencent.intent.QZONE_RESHIP_FROM_QUN_AIO_TO_QUN");
    a(localIntent, parambgyw);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, String paramString1, String paramString2, boolean paramBoolean, int paramInt)
  {
    parambgyw = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunFeed", "https://h5.qzone.qq.com/groupphoto/inqq/recent/{QUN_ID}/groupphoto?_wv=3&_proxy=1").replace("{QUN_ID}", paramString1);
    ...
    paramString1.putExtra("source_name", BaseApplicationImpl.getContext().getString(2131717954));
    paramString1.setData(Uri.parse(parambgyw));
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, boolean paramBoolean, String paramString1, String paramString2, int paramInt1, String paramString3, String paramString4, long paramLong1, long paramLong2, int paramInt2)
  {
  ...
  public static void a(Activity paramActivity, bgyw parambgyw, boolean paramBoolean, String paramString1, String paramString2, int paramInt1, ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, ArrayList<Long> paramArrayList3, ArrayList<Long> paramArrayList4, int paramInt2)
  {
    Intent localIntent = new Intent("com.tencent.intent.QZONE_QUOTE_FROM_AIO");
    a(localIntent, parambgyw);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
  ...
  public static void a(Activity paramActivity, String paramString1, int paramInt1, int paramInt2, long paramLong, String paramString2, String paramString3, String paramString4, int paramInt3, int paramInt4)
  {
    ...
    localbgyw.jdField_a_of_type_JavaLangString = paramString1;
    ...
    a(paramString1, localbgyw);
    QzonePluginProxyActivity.a(paramString1, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
    QzonePluginProxyActivity.a(paramActivity, localbgyw.jdField_a_of_type_JavaLangString, paramString1, paramInt3);
  }
  ...
  {
    bgyw localbgyw = bgyw.a();
    localbgyw.jdField_a_of_type_JavaLangString = paramString2;
    ...
    b(paramActivity, localbgyw, paramString2, -1);
  }
  ...
  public static void a(Context paramContext, bgyw parambgyw)
  {
    parambgyw = QzoneConfig.getInstance().getConfig("H5Url", "QzonePictureSettingPage", "https://h5.qzone.qq.com/image/setting/imageSetting?_wv=3&_proxy=1&uin={uin}").replace("{uin}", String.valueOf(parambgyw.jdField_a_of_type_JavaLangString)).replace("{host_uin}", parambgyw.jdField_a_of_type_JavaLangString).replace("{UIN}", String.valueOf(parambgyw.jdField_a_of_type_JavaLangString)).replace("{HOST_UIN}", parambgyw.jdField_a_of_type_JavaLangString);
    if (!bfnx.b(parambgyw).containsKey("_wv")) {
      bfnx.a(parambgyw, "_wv", "5");
    }
    if (QLog.isColorLevel()) {
      QLog.d("QZoneHelper", 2, "jump qzone setting URL:" + parambgyw);
    }
    Intent localIntent = new Intent(BaseApplication.getContext(), QQBrowserActivity.class);
    a(localIntent);
    localIntent.putExtra("url", parambgyw);
    ...
    localIntent.setData(Uri.parse(parambgyw));
    localIntent.addFlags(268435456);
    c(localIntent);
    paramContext.startActivity(localIntent);
  }
  
  public static void a(Context paramContext, bgyw parambgyw, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    a(paramContext, parambgyw, paramString, paramInt1, paramInt2, paramInt3, null, null, false);
  }
  
  public static void a(Context paramContext, bgyw parambgyw, String paramString, int paramInt1, int paramInt2, int paramInt3, aqyd paramaqyd, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      QzonePluginProxyActivity.a(paramContext, parambgyw.jdField_a_of_type_JavaLangString, localIntent, paramInt2, paramaqyd);
      return;
      i = 0;
      break;
      label107:
  ...
  public static void a(Context paramContext, bgyw parambgyw, String paramString1, int paramInt1, int paramInt2, aqyd paramaqyd, String paramString2, boolean paramBoolean)
  {
    ...
    QzonePluginProxyActivity.a(paramContext, parambgyw.jdField_a_of_type_JavaLangString, paramString1, paramInt1, paramaqyd);
  }
  
  public static void a(Context paramContext, bgyw parambgyw, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, Bundle paramBundle, boolean paramBoolean1, boolean paramBoolean2)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyw);
    localIntent.putExtra("startup_sceneid", 4);
    ...
    try
    {
      ...
      for (paramString1 = paramBundle;; paramString1 = new Bundle())
      {
        ...
        QzonePluginProxyActivity.a(paramContext, parambgyw.jdField_a_of_type_JavaLangString, localIntent, paramInt, null, paramBoolean1);
        return;
      }
      return;
    }
  ...
  public static void a(Intent paramIntent, bgyw parambgyw)
  {
    paramIntent.putExtra("qzone_uin", parambgyw.jdField_a_of_type_JavaLangString);
    paramIntent.putExtra("nickname", parambgyw.jdField_b_of_type_JavaLangString);
  }
  ...
  private static void a(@NonNull QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, bgyw parambgyw, int paramInt1, boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2, boolean paramBoolean3, boolean paramBoolean4, String paramString3, boolean paramBoolean5, String paramString4, String paramString5, boolean paramBoolean6, boolean paramBoolean7, boolean paramBoolean8, boolean paramBoolean9, String paramString6, boolean paramBoolean10, boolean paramBoolean11, boolean paramBoolean12, int paramInt2, boolean paramBoolean13, Bundle paramBundle)
  {
    ...
    if (paramBoolean12)
    {
      ...
      if (paramBoolean2)
      {
        parambgyw = acxs.a(ajsd.bj);
        paramQQAppInterface.putBoolean("support_photo_merge", true);
        paramQQAppInterface.putString("qcamera_photo_filepath", parambgyw);
        ...
        paramQQAppInterface.putString("pic_confirm_text", ajya.a(2131711924));
      }
    ...
    for (;;)
    {
      paramActivity.overridePendingTransition(2130772285, 2130772281);
      return;
      ...
      break;
      label387:
      bbdj.a(paramActivity, 230).setMessage(ajya.a(2131711922)).setPositiveButton(2131694794, new bgys()).show();
    }
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, PublishMoodInfo paramPublishMoodInfo, Intent paramIntent, int paramInt, boolean paramBoolean)
  {
    ...
    bgzl.a(paramQQAppInterface, paramActivity, localBundle, null, paramInt);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, ServiceConnection paramServiceConnection)
  {
    ...
    localbglq.jdField_e_of_type_JavaLangString = "com.qzone.publish.business.publishqueue.PublishQueueService";
  ...
  public static void a(QQAppInterface paramQQAppInterface, aqyd paramaqyd)
  {
    ThreadManager.post(new QZoneHelper.8(paramQQAppInterface, paramaqyd), 8, null, false);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, aqyd paramaqyd)
  {
    ...
    {
      axqy.b(paramQQAppInterface, "CliOper", "", "", "0X8005E9C", "0X8005E9C", 1, 0, "", "", "", "");
      axrv.a().a("actQZLoadHitRateRed", true);
    }
    for (;;)
    {
      ...
      try
      {
        ...
        ((Intent)localObject).putExtra("cpuNum", bbdh.b());
      ...
      catch (Exception paramString)
      {
        ...
        paramString.jdField_a_of_type_Aqyd = paramaqyd;
        ...
        bglh.c(paramQQAppInterface.getApp(), paramString);
      }
      if (!axnx.jdField_d_of_type_Boolean) {
        break label463;
      }
      if (QLog.isColorLevel()) {
        QLog.d("Perf", 2, "disable preload qzone process");
      }
      axnx.e = System.currentTimeMillis();
      return;
      if ("Leba".equals(paramString))
      {
        axqy.b(paramQQAppInterface, "CliOper", "", "", "0X8005E9C", "0X8005E9C", 1, 0, "", "", "", "");
        axrv.a().a("actQZLoadHitRateLeba", true);
      }
      else if ("FriendProfileCardActivity".equals(paramString))
      {
        axrv.a().a("actQZLoadHitRateProfile", true);
      }
    }
    QLog.d("QZoneHelper", 1, "preloadQzone is not allowed as crash frequently.");
    axrn.a(BaseApplicationImpl.getContext()).a(paramQQAppInterface.getCurrentAccountUin(), "actNoPreloadQzone", true, 0L, 0L, null, "");
    return;
    label443:
    label463:
    return;
  ...
  public static void a(WebViewPlugin paramWebViewPlugin, bcdp parambcdp, Activity paramActivity, String paramString1, String paramString2)
  {
    Intent localIntent = new Intent();
    QzonePluginProxyActivity.a(localIntent, "com.qzone.publish.ui.activity.QZoneUploadPhotoRealActivity");
    localIntent.putExtra("startup_sceneid", 6);
    ...
    QzonePluginProxyActivity.a(paramActivity, paramString1, localIntent, a(paramWebViewPlugin, parambcdp, 1));
  }
  ...
  public static void a(BaseApplication paramBaseApplication, String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        localIntent.putExtra("cpuNum", bbdh.b());
    ...
    catch (Exception paramString2)
    {
      ...
      paramString2.jdField_a_of_type_JavaLangString = paramString1;
      paramString2.jdField_a_of_type_Aqyd = null;
      ...
      bglh.c(paramBaseApplication, paramString2);
    }
  }
  ...
  public static void a(String paramString, Context paramContext)
  {
    ...
    ((Intent)localObject).putExtra("source_name", BaseApplicationImpl.getContext().getString(2131717954));
  ...
  public static void a(String paramString1, ArrayList<String> paramArrayList1, int paramInt1, LbsDataV2.PoiInfo paramPoiInfo, String paramString2, String paramString3, ArrayList<String> paramArrayList2, HashMap<String, String> paramHashMap1, HashMap<String, String> paramHashMap2, String paramString4, int paramInt2)
  {
    ...
    bhlc.a().a("cmd.publishMixMood", paramString2, false);
  }
  ...
  public static void a(String paramString1, ArrayList<String> paramArrayList1, int paramInt1, ArrayList<String> paramArrayList2, int paramInt2, int paramInt3, String paramString2, boolean paramBoolean1, boolean paramBoolean2, int paramInt4, String paramString3)
  {
    ...
    bhlc.a().a("cmd.publishMoodForAll", localBundle, false);
  }
  ...
  {
    bhms.a(paramString1, paramInt1, paramString2, paramInt2);
  }
  ...
  public static void a(AppRuntime paramAppRuntime, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      bbbr.a(BaseApplicationImpl.getContext(), "com.tencent.mobileqq:picture");
      ...
      bbbr.a(BaseApplicationImpl.getContext(), "com.tencent.mobileqq:qzonevideo");
      bhcg.a((Context)localObject);
      if (!TextUtils.isEmpty(str))
      {
      ...
      {
        apvd.c((String)localObject + File.separator + "qz_predownload_config.xml");
        apvd.c((String)localObject + File.separator + "QZ_Per_Config.xml");
        apvd.c((String)localObject + File.separator + "QZONE_UNREAD.xml");
      }
      localObject = bbvj.a(Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "tencent" + File.separator + "MobileQQ" + File.separator + "trace");
      if (localObject != null) {
  ...
  public static void a(boolean paramBoolean, bgyv parambgyv)
  {
    if (!paramBoolean)
    {
      parambgyv.a(false, true);
      return;
    }
    ThreadManager.postImmediately(new QZoneHelper.6(parambgyv), null, true);
  }
  ...
  public static boolean a(Activity paramActivity, String paramString1, String paramString2)
  {
    ...
    if (QzoneConfig.getInstance().getConfig("QZoneSetting", "aio2qzonedetail", 1) == 1)
    {
      ...
      QzonePluginProxyActivity.a(paramActivity, bgyw.a().jdField_a_of_type_JavaLangString, paramString2, 0);
      if (QLog.isColorLevel()) {
  ...
  public static boolean a(Context paramContext, Intent paramIntent, boolean paramBoolean)
  {
    ...
    try
    {
      if ((axmv.a()) && (bhby.c()))
      {
        if (((paramContext instanceof FragmentActivity)) && (!bhby.a((FragmentActivity)paramContext, ((FragmentActivity)paramContext).app))) {
          return false;
        }
  ...
  {
    bbdj.a(paramActivity, 230).setMessage(2131718240).setPositiveButton(2131719547, paramOnClickListener).setNegativeButton(2131717766, new bgyr()).show();
  }
  
  public static void b(Activity paramActivity, bgyw parambgyw, int paramInt)
  {
    parambgyw = QzoneConfig.getInstance().getConfig("H5Url", "QzoneSettingMainPage", "https://h5.qzone.qq.com/qzone/setting?_wv=3&_proxy=1&uin={uin}").replace("{uin}", String.valueOf(parambgyw.jdField_a_of_type_JavaLangString)).replace("{host_uin}", parambgyw.jdField_a_of_type_JavaLangString).replace("{UIN}", String.valueOf(parambgyw.jdField_a_of_type_JavaLangString)).replace("{HOST_UIN}", parambgyw.jdField_a_of_type_JavaLangString);
    if (!bfnx.b(parambgyw).containsKey("_wv")) {
      bfnx.a(parambgyw, "_wv", "5");
    }
    if (QLog.isColorLevel()) {
  ...
  public static void b(Activity paramActivity, bgyw parambgyw, Intent paramIntent)
  {
    a(paramIntent, parambgyw);
    QzonePluginProxyActivity.a(paramIntent, "com.qzone.misc.web.QZoneTranslucentActivity2");
    QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, paramIntent, 0);
  }
  
  public static void b(Activity paramActivity, bgyw parambgyw, Intent paramIntent, int paramInt)
  {
  ...
  public static void b(Activity paramActivity, bgyw parambgyw, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = a(parambgyw, "com.qzone.album.business.photolist.activity.QZonePersonalPhotoListActivity");
    localIntent.putExtras(paramBundle);
    QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void b(Activity paramActivity, bgyw parambgyw, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt)
  {
    paramBaseBusinessAlbumInfo = a(parambgyw, paramBaseBusinessAlbumInfo);
  ...
  public static void b(Activity paramActivity, bgyw parambgyw, BaseBusinessAlbumInfo paramBaseBusinessAlbumInfo, int paramInt, String paramString)
  {
    Intent localIntent = new Intent();
    a(localIntent, parambgyw);
    QzonePluginProxyActivity.a(localIntent, "com.qzone.album.business.photolist.activity.QZonePersonalPhotoListActivity");
  ...
  public static void b(Activity paramActivity, bgyw parambgyw, Long paramLong, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    a(paramActivity, parambgyw, paramLong, paramInt1, paramBoolean, paramInt2, 12);
  }
  
  public static void b(Activity paramActivity, bgyw parambgyw, String paramString, int paramInt)
  {
    try
    {
      Intent localIntent = new Intent();
  ...
  public static void b(Activity paramActivity, bgyw parambgyw, String paramString1, long paramLong, String paramString2, int paramInt)
  {
  ...
  public static void b(Activity paramActivity, bgyw parambgyw, String paramString1, String paramString2, int paramInt)
  {
    parambgyw = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunAlbumDetail", "https://h5.qzone.qq.com/groupphoto/inqq/detail/{QQ_URL}?_wv=3&_proxy=1").replace("{QQ_URL}", URLEncoder.encode(paramString1));
    paramString1 = new Intent(BaseApplication.getContext(), QQBrowserDelegationActivity.class);
    paramString1.putExtra("url", parambgyw);
    paramString1.putExtra("fromQZone", true);
    paramString1.putExtra("injectrecommend", true);
  ...
  {
    if (!bbjc.a(paramQQAppInterface.getApp(), new String[] { paramString1 })) {
      return;
    }
    a(paramIntent, paramQQAppInterface, paramString2, paramBitmap);
    Thread.sleep(1000L);
    bbjc.a(paramQQAppInterface, paramIntent, paramString2, paramBitmap);
    Thread.sleep(1000L);
  }
  ...
  public static void b(WebViewPlugin paramWebViewPlugin, bcdp parambcdp, Activity paramActivity, String paramString1, String paramString2)
  {
    paramString2 = new Intent();
    ...
    QzonePluginProxyActivity.a(paramActivity, paramString1, paramString2, a(paramWebViewPlugin, parambcdp, 6));
  }
  ...
  public static void c(Activity paramActivity, bgyw parambgyw, int paramInt)
  {
    parambgyw = new SimpleDateFormat("yyyyMM", Locale.getDefault()).format(new Date());
    parambgyw = QzoneConfig.getInstance().getConfig("H5Url", "QzoneShuoshuoDailyCalendar", "https://h5.qzone.qq.com/v2/shuoshuo-daily/calendar/{date}?_wv=16777216").replace("{date}", parambgyw).replace("{DATE}", parambgyw);
    if (!bfnx.b(parambgyw).containsKey("_wv")) {
      bfnx.a(parambgyw, "_wv", "1027");
    }
    if (QLog.isColorLevel()) {
      QLog.d("QZoneHelper", 2, "jump qzone ShuoshuoDailyCalendar URL:" + parambgyw);
    }
    Intent localIntent = new Intent(BaseApplication.getContext(), QQBrowserActivity.class);
    a(localIntent);
    localIntent.putExtra("url", parambgyw);
  ...
  public static void c(Activity paramActivity, bgyw parambgyw, Intent paramIntent, int paramInt)
  {
    Intent localIntent = paramIntent;
    if (paramIntent == null) {
      localIntent = new Intent();
  ...
  public static void c(Activity paramActivity, bgyw parambgyw, Bundle paramBundle, int paramInt)
  {
    bhlc.a().a("cmd.cancelKillPictureProcess", null, false);
    Intent localIntent = a(parambgyw, "com.qzone.preview.QzonePictureViewer");
    localIntent.putExtras(paramBundle);
    localIntent.putExtra("fromQZone", false);
    QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, localIntent, paramInt, null, false);
  }
  
  public static void c(Activity paramActivity, bgyw parambgyw, String paramString, int paramInt)
  {
    ...
    localIntent.putExtra("key_title", ajya.a(2131711919));
    localIntent.putExtra("key_desc", "");
    localIntent.putExtra("key_need_save_draft", false);
    QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void c(Activity paramActivity, bgyw parambgyw, String paramString1, String paramString2, int paramInt)
  {
    if (TextUtils.isEmpty(paramString1)) {
      return;
    }
    parambgyw = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunAlbumSelect", "https://h5.qzone.qq.com/groupphoto/inqq/album/{QUN_ID}/select?_wv=3&_proxy=1").replace("{QUN_ID}", paramString1);
    paramString1 = new Intent(paramActivity, QQBrowserActivity.class);
    a(paramString1);
    paramString1.putExtra("url", parambgyw);
    if (bcds.a.containsKey("Qzone")) {
  ...
  public static void c(Context paramContext, String paramString)
  {
    ...
    a((Activity)paramContext, bgyw.a(), localIntent);
  }
  ...
  private static void c(Bitmap paramBitmap, @NonNull QQAppInterface paramQQAppInterface, String paramString1, long paramLong, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      if (Build.VERSION.SDK_INT < 26)
      {
        ...
        bbjc.a(paramQQAppInterface, b(paramQQAppInterface, paramString1, paramLong), paramString2, paramBitmap);
        Thread.sleep(1000L);
        if (bbkd.a(paramQQAppInterface.getApplication(), new String[] { paramString1 }))
        {
          bdis.a().a(2131691315);
          return;
        }
  ...
  public static void d(Activity paramActivity, bgyw parambgyw, Bundle paramBundle, int paramInt)
  {
    bhlc.a().a("cmd.cancelKillPictureProcess", null, false);
    Intent localIntent = a(parambgyw, "com.qzone.preview.QzonePictureViewer");
    localIntent.putExtras(paramBundle);
  ...
  public static void d(Activity paramActivity, bgyw parambgyw, String paramString, int paramInt)
  {
    parambgyw = QzoneConfig.getInstance().getConfig("QunAlbumSetting", "QunPassiveFeed", "https://h5.qzone.qq.com/groupphoto/inqq/relatedme/{QUN_ID}/{UIN}?_wv=3&_proxy=1").replace("{QUN_ID}", paramString).replace("{UIN}", parambgyw.jdField_a_of_type_JavaLangString);
    paramString = new Intent(BaseApplication.getContext(), QQBrowserDelegationActivity.class);
    paramString.putExtra("url", parambgyw);
    ...
    paramString.putExtra("source_name", BaseApplicationImpl.getContext().getString(2131717954));
    paramString.setData(Uri.parse(parambgyw));
  ...
  {
    QzonePluginProxyActivity.a(paramActivity, paramString, paramIntent, paramInt, true);
  }
  ...
  public static void e(Activity paramActivity, bgyw parambgyw, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = a(parambgyw, "com.qzone.album.business.dlna.activity.DLNAActivity");
    localIntent.putExtras(paramBundle);
    QzonePluginProxyActivity.a(paramActivity, parambgyw.jdField_a_of_type_JavaLangString, localIntent, paramInt);
  }
  
  public static void e(Activity paramActivity, String paramString, Intent paramIntent, int paramInt)
  {
  ...
  public static void f(Activity paramActivity, bgyw parambgyw, Bundle paramBundle, int paramInt)
  {
    Intent localIntent = new Intent();
