...
public class apyb
  implements agma, Handler.Callback, apxx
{
  ...
  private bhwq jdField_a_of_type_Bhwq = new apyc(this);
  ...
  public apyb(BaseChatPie paramBaseChatPie)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetScroller = new Scroller(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, new bkon());
  ...
  {
    float f1 = 0.0F;
    float f2 = (Math.abs(paramFloat) - (BaseChatItemLayout.V + BaseChatItemLayout.W)) / afur.a(20.0F, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getResources());
    if (f2 < 0.0F) {}
    for (;;)
    {
  ...
  private int a()
  {
    return afur.a(59.0F, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getResources());
  }
  ...
  private int a(ChatMessage paramChatMessage)
  {
    ...
    for (;;)
    {
      ...
      {
        paramChatMessage = new bdnt(((MessageForText)paramChatMessage).sb, 8);
        if ((paramChatMessage.a != null) && (paramChatMessage.a.length > 0))
        {
          ...
          while (i < j)
          {
            if ((paramChatMessage[i] instanceof bdob)) {
              return 7;
            }
            i += 1;
          }
  ...
  private void a(float paramFloat1, float paramFloat2)
  {
    ...
    if ((f1 > this.jdField_a_of_type_Int) || (paramFloat2 > this.jdField_a_of_type_Int))
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getAdapter() instanceof bkky))
      {
        ListAdapter localListAdapter = ((bkky)this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getAdapter()).getWrappedAdapter();
        if ((localListAdapter instanceof afwy)) {
          ((afwy)localListAdapter).d();
        }
      }
  ...
  private void a(MotionEvent paramMotionEvent)
  {
    ...
    if (((localView instanceof BaseChatItemLayout)) && (a(((BaseChatItemLayout)localView).findViewById(2131364379), paramMotionEvent)))
    {
      this.jdField_a_of_type_AndroidViewView = localView;
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131364402);
    }
    if (QLog.isColorLevel()) {
  ...
  private void a(View paramView, int paramInt)
  {
    ...
    if (!this.jdField_d_of_type_Boolean) {
      if (paramInt >= i)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationAnimatorSet.addListener(new apyd(this));
  ...
  private void b()
  {
    if (!b())
    {
      ...
      if (localObject != null)
      {
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A92F", "0X800A92F", a((ChatMessage)localObject), b((ChatMessage)localObject), "", "", "", "");
        ...
        if ((localObject instanceof MessageForStructing))
        {
          ...
          if ((((MessageForStructing)localObject).structingMsg != null) && (((MessageForStructing)localObject).structingMsg.mMsgServiceID == 81) && (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)) {
            yqu.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, (MessageForStructing)localObject, "reply");
          }
        }
      }
    }
  ...
  private void b(int paramInt)
  {
    ...
    if (paramInt >= a())
    {
      ...
      {
        bool = bghu.b(BaseApplicationImpl.getApplication().getApplicationContext(), this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        if ((!this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.q()) || (bool)) {
          break label110;
        }
        paramInt = 1;
      }
      for (;;)
      {
        ...
        label110:
        paramInt = i;
        if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.o())
        {
          paramInt = i;
          if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.p())
          {
            paramInt = i;
            if (!bool) {
              paramInt = 1;
  ...
  private boolean b()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int == 1) && (((bfsk)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(48)).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, true).jdField_a_of_type_Boolean))
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131696676, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131298998));
      return true;
    }
    return false;
  }
  ...
  private int c()
  {
    return afur.a(89.0F, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getResources());
  }
  ...
  private boolean c()
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_Apye != null) && (apye.a(this.jdField_a_of_type_Apye, localChatMessage))) {
        return apye.b(this.jdField_a_of_type_Apye, localChatMessage);
      }
  ...
  private boolean c(MotionEvent paramMotionEvent)
  {
    ...
    int j = (int)(paramMotionEvent.getY() + 0.5F) - ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext);
    if (k < this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getWidth() - BaseChatItemLayout.j - afur.a(5.0F, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext.getResources()) - BaseChatItemLayout.R) {}
    for (int i = 1; i != 0; i = 0)
    {
      i = j;
      ...
      boolean bool = a(((BaseChatItemLayout)localView).findViewById(2131364379), paramMotionEvent);
      if (QLog.isColorLevel()) {
  ...
  private boolean d()
  {
    ...
    {
      this.f = 1;
      if (((a() instanceof MessageForPtt)) && (((MessageForPtt)a()).playProgress > 0.0F)) {
        this.f = 2;
      }
      if (this.f != 2)
      {
  ...
  public void a(int paramInt)
  {
    ...
    do
    {
      ...
      if (((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof ahzy)) || ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof TroopChatPie)) || ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof ahzo))) {
        bool = true;
      }
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) {
        this.jdField_a_of_type_Apye = new apye(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, null);
      }
    ...
    } while ((this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqWidgetDrawerFrame == null));
