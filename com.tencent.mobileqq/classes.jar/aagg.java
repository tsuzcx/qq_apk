  ...
  extends aacn
{
  ...
  public aagg(Bundle paramBundle)
  {
    super(paramBundle);
  }
  ...
  public aaco a(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    return new aaco(paramViewGroup);
  }
  ...
  public void a(CertifiedAccountMeta.StFeed paramStFeed)
  {
    ...
    if ((((CertifiedAccountMeta.StUser)localObject2).youZhan.size() > 0) && (((CertifiedAccountMeta.StYouZanShop)((CertifiedAccountMeta.StUser)localObject2).youZhan.get(0)).goodNum.get() > 0))
    {
      ...
      localaagh = new aagh(this, (CertifiedAccountMeta.StUser)localObject2);
      abbe.a(((CertifiedAccountMeta.StUser)localObject2).id.get(), "auth_" + aapa.a(getExtraTypeInfo()), "exp_shop", 0, 0, new String[0]);
      localObject1 = getActivity();
      if (!aaek.a(((CertifiedAccountMeta.StUser)localObject2).attr.get())) {
        break label337;
      }
    }
    label337:
    for (paramStFeed = anzj.a(2131701132);; paramStFeed = ((CertifiedAccountMeta.StUser)localObject2).nick.get())
    {
      paramStFeed = aabh.a((Context)localObject1, 13.5F, "#878B99", String.format("%s", new Object[] { paramStFeed }));
      ...
      paramStFeed.setOnClickListener(localaagh);
      localLinearLayout.addView(paramStFeed, new LinearLayout.LayoutParams(-2, -2));
      paramStFeed = aabh.a(getActivity(), 13.5F, "#878B99", "的小店");
      localObject1 = new LinearLayout.LayoutParams(-2, -2);
      paramStFeed.setCompoundDrawablePadding(ImmersiveUtils.a(2.0F));
      localObject2 = getActivity().getResources().getDrawable(2130839281);
  ...
  {
    if (((getBlockMerger().a(0) instanceof aagi)) && (((aagi)getBlockMerger().a(0)).a() != null)) {
      ((aagi)getBlockMerger().a(0)).a().a(paramHorizontalRvInnerView);
    }
  }
  ...
  public void handleShareDataChange(String paramString, aabn paramaabn)
  {
    ...
    if ((paramString.equals("share_key_subscribe_feeds_update")) && (paramaabn.a != null))
    {
      this.jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StFeed = ((CertifiedAccountMeta.StFeed)paramaabn.a);
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    case 100000: 
      return new aabt(this, this.jdField_a_of_type_AndroidWidgetFrameLayout);
    }
  ...
  {
    paramBundle = aabh.a(getContext(), 16.0F, "#222222", anzj.a(2131700398));
