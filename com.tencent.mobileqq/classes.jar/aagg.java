  ...
  implements DialogInterface.OnDismissListener, View.OnClickListener
{
  ...
  private aago jdField_a_of_type_Aago;
  private aagp jdField_a_of_type_Aagp;
  ...
  public aagg(Activity paramActivity)
  {
    super(paramActivity, 2131755407);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(getContext()).inflate(2131558766, null);
    b();
    setCancelable(true);
    d();
  ...
  private void d()
  {
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131364757));
    ...
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.setOnInputBackListener(new aagh(this));
    ...
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new aagi(this));
  ...
  private void e()
  {
    aagj localaagj = new aagj(this);
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if ((localAppRuntime instanceof QQAppInterface))
    {
      int i = getContext().getResources().getDimensionPixelSize(2131298998);
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel = ((EmoticonMainPanel)this.jdField_a_of_type_AndroidViewView.findViewById(2131365881));
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setCallBack(localaagj);
    ...
    this.jdField_a_of_type_ComTencentMobileqqEmoticonviewSystemAndEmojiEmoticonPanel = new SystemAndEmojiEmoticonPanel(this.jdField_a_of_type_AndroidAppActivity, localaagj);
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Aage.a(new aagl(this));
  ...
  private void i()
  {
    ...
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.setOnEditorActionListener(new aagm(this));
    this.jdField_a_of_type_ComTencentBizSubscribeCommentCommentEditText.addTextChangedListener(new aagn(this));
  }
  ...
  public String a()
  {
    ...
    for (;;)
    {
      return bmpg.b(((String)localObject).replaceAll(anni.a(2131704587), anni.a(2131704589)).replaceAll(anni.a(2131704586), "/MM").replaceAll(BaseApplicationImpl.sApplication.getResources().getString(2131716316), "/chigua")).trim();
      localObject = str;
  ...
  public void a(aago paramaago)
  {
    this.jdField_a_of_type_Aago = paramaago;
  }
  
  public void a(aagp paramaagp)
  {
    this.jdField_a_of_type_Aagp = paramaagp;
  }
  ...
  protected void c()
  {
    if (this.jdField_a_of_type_AndroidViewView != null)
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationAlphaAnimation.setAnimationListener(new aagk(this));
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      continue;
      if (this.jdField_a_of_type_Aago != null)
      {
        this.jdField_a_of_type_Aago.a();
        continue;
  ...
  public void onDismiss(DialogInterface paramDialogInterface)
  {
    ...
    if (this.jdField_a_of_type_Aagp != null) {
