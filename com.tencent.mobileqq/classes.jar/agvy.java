  ...
  public void handleMessage(Message arg1)
  {
    ...
    case 1: 
      synchronized (agvx.a())
      {
        ...
        if ((ReportInfo)agvx.a(this.a).get(Long.valueOf(localReportHeader.seqno)) != null)
        {
          if (QLog.isColorLevel()) {
      ...
      if (localObject5 != null)
      {
        ...
        agvx.a(this.a).add(localObject5);
      }
      agvx.a(this.a).put(Long.valueOf(localObject1.seqno), localReportInfo);
      agvx.b(this.a).add(localObject1);
      agvx.a().notify();
      return;
    case 2: 
      for (;;)
      {
        synchronized (agvx.a())
        {
          ...
          localObject5 = (ReportInfo)agvx.a(this.a).get(Long.valueOf(l));
          if (localObject5 != null) {
            break;
          }
          if (QLog.isColorLevel())
    ...
    case 3: 
      for (;;)
      {
        synchronized (agvx.a())
        {
          ...
          localObject4 = (ReportInfo)agvx.a(this.a).get(Long.valueOf(l));
      ...
      else
      {
        ...
        agvx.a(this.a).add(???);
        agvx.b(this.a, 5);
        localObject4 = agvx.b(this.a).obtainMessage();
        if (localObject4 != null)
        {
          ((Message)localObject4).arg1 = 5;
          ((Message)localObject4).obj = new Object[] { Long.valueOf(l), ??? };
          agvx.b(this.a).sendMessageDelayed((Message)localObject4, 10000L);
        }
        return;
      }
      break;
    ...
    for (??? = ???.step;; ??? = ".")
    {
      ...
      synchronized (agvx.a())
      {
        ...
        if ((ReportInfo)agvx.a(this.a).get(Long.valueOf(((ReportHeader)???).seqno)) != null)
        {
          if (QLog.isColorLevel()) {
      ...
      localReportInfo.body.reportItems.add(localObject5);
      agvx.a(this.a).put(Long.valueOf(localObject3.seqno), localReportInfo);
      agvx.b(this.a).add(localObject3);
      agvx.a(this.a).add(localObject5);
      agvx.a(this.a, 1);
      return;
      ??? = ".";
