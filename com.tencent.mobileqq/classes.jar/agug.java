  ...
  implements Manager
{
  ...
  private agtw jdField_a_of_type_Agtw;
  private agud jdField_a_of_type_Agud;
  private aguj jdField_a_of_type_Aguj;
  ...
  private List<agtl> jdField_a_of_type_JavaUtilList;
  private MqqHandler jdField_a_of_type_MqqOsMqqHandler = ThreadManager.getFileThreadHandler();
  private volatile boolean jdField_a_of_type_Boolean;
  private final aguj jdField_b_of_type_Aguj = new aguh(this);
  private File jdField_b_of_type_JavaIoFile;
  private List<agtk> jdField_b_of_type_JavaUtilList = new CopyOnWriteArrayList();
  private boolean jdField_b_of_type_Boolean = true;
  private File c;
  private File d;
  
  public agug(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Awbw = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    this.jdField_a_of_type_Aube = ((aube)paramQQAppInterface.getManager(14));
    a(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentAccountUin());
    d();
    if (this.jdField_a_of_type_JavaUtilList != null) {
      this.jdField_a_of_type_JavaUtilList.clear();
    }
    a(new aguf(paramQQAppInterface));
    this.jdField_a_of_type_Agtw = new agtw(paramQQAppInterface);
    a(this.jdField_a_of_type_Agtw);
    this.jdField_a_of_type_Agud = new agud(paramQQAppInterface);
    a(this.jdField_a_of_type_Agud);
  }
  ...
  public static agug a(QQAppInterface paramQQAppInterface)
  {
    return (agug)paramQQAppInterface.getManager(314);
  }
  ...
  public static File a(String paramString)
  {
    try
    {
      ...
      paramString = new File(agtz.jdField_a_of_type_JavaLangString + paramString);
      return paramString;
    }
  ...
  private Object a(String paramString)
  {
    ...
    //   1: astore 5
    //   3: aload_1
    //   4: invokestatic 210	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   7: ifeq +8 -> 15
    //   10: aload 5
    //   12: astore_1
    //   13: aload_1
    //   14: areturn
    //   15: new 212	java/io/ObjectInputStream
    //   18: dup
    //   19: new 214	java/io/BufferedInputStream
    //   22: dup
    //   23: new 216	java/io/FileInputStream
    //   26: dup
    //   27: aload_1
    //   28: invokespecial 217	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   31: invokespecial 220	java/io/BufferedInputStream:<init>	(Ljava/io/InputStream;)V
    //   34: invokespecial 221	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   37: astore_3
    //   38: aload_3
    //   39: astore_2
    //   40: aload_3
    //   41: invokevirtual 225	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   44: astore 4
    //   46: aload 4
    //   48: astore_2
    //   49: aload_2
    ...
    //   52: ifnull -39 -> 13
    //   55: aload_3
    //   56: invokevirtual 228	java/io/ObjectInputStream:close	()V
    //   59: aload_2
    //   60: areturn
    //   61: astore_1
    //   62: aload_2
    ...
    //   68: aload_3
    //   69: astore_2
    //   70: invokestatic 234	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   73: ifeq +43 -> 116
    //   76: aload_3
    //   77: astore_2
    //   78: ldc 236
    ...
    //   84: dup
    //   85: invokespecial 143	java/lang/StringBuilder:<init>	()V
    //   88: ldc 238
    ...
    //   102: aload 4
    //   104: invokevirtual 241	java/lang/Exception:toString	()Ljava/lang/String;
    //   107: invokevirtual 149	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   110: invokevirtual 152	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   113: invokestatic 245	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   116: aload 5
    //   118: astore_1
    //   119: aload_3
    //   120: ifnull -107 -> 13
    //   123: aload_3
    //   124: invokevirtual 228	java/io/ObjectInputStream:close	()V
    //   127: aconst_null
    //   128: areturn
    //   129: astore_1
    //   130: aconst_null
    ...
    //   135: aload_3
    //   136: astore_2
    //   137: invokestatic 234	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   140: ifeq +13 -> 153
    //   143: aload_3
    //   144: astore_2
    //   145: ldc 236
    //   147: iconst_2
    //   148: ldc 247
    //   150: invokestatic 245	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   153: aload 5
    //   155: astore_1
    //   156: aload_3
    //   157: ifnull -144 -> 13
    //   160: aload_3
    //   161: invokevirtual 228	java/io/ObjectInputStream:close	()V
    //   164: aconst_null
    //   165: areturn
    //   166: astore_1
    //   167: aconst_null
    ...
    //   173: ifnull +7 -> 180
    //   176: aload_2
    //   177: invokevirtual 228	java/io/ObjectInputStream:close	()V
    //   180: aload_1
    //   181: athrow
    //   182: astore_2
    //   183: goto -3 -> 180
  ...
  private List<agtk> a(List<agtk> paramList, StickerRecommendSortEntity paramStickerRecommendSortEntity)
  {
    int i2 = 0;
    int j;
    int m;
    ...
    if (paramStickerRecommendSortEntity != null)
    {
      try
      {
        ...
        arrayOfagtk[i] = ((agtk)paramList.get(i1));
        i += 1;
      }
      ...
      if (n < m)
      {
        ...
        arrayOfagtk[i] = ((agtk)paramList.get(j));
        i += 1;
        break label460;
      }
    }
    for (;;)
    {
      if (i1 < k)
      {
        ...
        if ((i < i3) && (j < i3))
        {
          arrayOfagtk[j] = ((agtk)paramList.get(i));
          i = j + 1;
          break label469;
        }
      }
      ...
      {
        paramList = Arrays.asList(arrayOfagtk);
        return paramList;
        return null;
      }
      i = j;
  ...
  private void a(String paramString, Object paramObject)
  {
    // Byte code:
    //   0: aload_1
    //   1: invokestatic 210	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   4: ifeq +4 -> 8
    //   7: return
    //   8: new 379	java/io/ObjectOutputStream
    //   11: dup
    //   12: new 381	java/io/BufferedOutputStream
    //   15: dup
    //   16: new 383	java/io/FileOutputStream
    //   19: dup
    //   20: aload_1
    //   21: invokespecial 384	java/io/FileOutputStream:<init>	(Ljava/lang/String;)V
    //   24: invokespecial 387	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   27: invokespecial 388	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   30: astore 4
    //   32: aload 4
    //   34: astore_3
    //   35: aload 4
    //   37: aload_2
    //   38: invokevirtual 392	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   41: aload 4
    //   43: astore_3
    //   44: aload 4
    //   46: invokevirtual 395	java/io/ObjectOutputStream:flush	()V
    //   49: aload 4
    //   51: ifnull -44 -> 7
    //   54: aload 4
    //   56: invokevirtual 396	java/io/ObjectOutputStream:close	()V
    //   59: return
    //   60: astore_1
    //   61: aload_1
    //   62: invokevirtual 397	java/io/IOException:printStackTrace	()V
    //   65: return
    //   66: astore 5
    //   68: aconst_null
    //   69: astore_2
    //   70: aload_2
    //   71: astore_3
    //   72: invokestatic 234	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   75: ifeq +44 -> 119
    //   78: aload_2
    //   79: astore_3
    //   80: ldc 236
    ...
    //   105: aload 5
    //   107: invokevirtual 241	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   116: invokestatic 245	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   119: aload_2
    //   120: ifnull -113 -> 7
    //   123: aload_2
    //   124: invokevirtual 396	java/io/ObjectOutputStream:close	()V
    //   127: return
    //   128: astore_1
    //   129: aload_1
    //   130: invokevirtual 397	java/io/IOException:printStackTrace	()V
    //   133: return
    //   134: astore_1
    //   135: aconst_null
    //   136: astore_3
    ...
    //   138: ifnull +7 -> 145
    //   141: aload_3
    //   142: invokevirtual 396	java/io/ObjectOutputStream:close	()V
    //   145: aload_1
    //   146: athrow
    //   147: astore_2
    //   148: aload_2
    //   149: invokevirtual 397	java/io/IOException:printStackTrace	()V
    //   152: goto -7 -> 145
    //   155: astore_1
    //   156: goto -19 -> 137
    //   159: astore 5
  ...
  private void a(String paramString1, String paramString2, int paramInt, String paramString3)
  {
    ...
    for (boolean bool = true;; bool = false) {
      for (;;)
      {
        ...
        ((baps)localObject).jdField_a_of_type_Bapx = new agui(this, paramString2, bool, paramString3);
        ((baps)localObject).jdField_a_of_type_JavaLangString = paramString1;
        ((baps)localObject).jdField_a_of_type_Int = 0;
        ((baps)localObject).jdField_c_of_type_JavaLangString = this.d.getAbsolutePath();
        ...
        try
        {
          ...
          ((QQAppInterface)paramString2).getNetEngine(0).a((baqv)localObject);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  private void a(boolean paramBoolean, long paramLong)
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      azmz.a(BaseApplication.getContext()).a(null, "StickerRecInitCost", paramBoolean, 0L, 0L, localHashMap, "");
      return;
    }
  }
  ...
  private void a(boolean paramBoolean, String paramString)
  {
    ...
    if ((paramBoolean) && (this.jdField_a_of_type_JavaUtilList != null))
    {
      ...
      {
        Object localObject = (agtl)localIterator.next();
        if (((agtl)localObject).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString))
        {
          localObject = ((agtl)localObject).a(paramString);
          if ((localObject != null) && (!((List)localObject).isEmpty())) {
            localArrayList.addAll((Collection)localObject);
          }
        }
      }
      paramString = agtm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localArrayList);
      ...
      while (paramString.hasNext()) {
        ((agtk)paramString.next()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
      if (QLog.isColorLevel()) {
  ...
  private void a(byte[] paramArrayOfByte)
  {
    try
    {
      ...
      else
      {
        ...
        localObject = bdiv.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "words_version_key805_gray_one", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      if (QLog.isColorLevel())
      {
        QLog.d("StickerRecManager", 2, bhop.a(paramArrayOfByte));
        return;
        if (QLog.isColorLevel()) {
  ...
  private void a(byte[] paramArrayOfByte, String paramString1, String paramString2, boolean paramBoolean, StickerRecommendSortEntity paramStickerRecommendSortEntity)
  {
    ...
    while (i < localList.size())
    {
      ...
      agua localagua = new agua();
      localagua.e(i);
      localagua.a(localImgInfo.uint64_img_size.get());
      localagua.a(localImgInfo.uint32_img_width.get());
      localagua.b(localImgInfo.uint32_img_height.get());
      localagua.d(localImgInfo.bytes_img_md5.get().toStringUtf8());
      localagua.b(localImgInfo.bytes_img_down_url.get().toStringUtf8());
      localagua.b(localImgInfo.uint64_thumb_size.get());
      localagua.d(localImgInfo.uint32_thumb_img_height.get());
      localagua.c(localImgInfo.uint32_thumb_img_width.get());
      localagua.c(localImgInfo.bytes_thumb_down_url.get().toStringUtf8());
      localagua.e(localImgInfo.bytes_thumb_img_md5.get().toStringUtf8());
      localagua.f(localImgInfo.uint32_src_type.get());
      localagua.f(localImgInfo.bytes_src_desc.get().toStringUtf8());
      localagua.g(localImgInfo.bytes_web_url.get().toStringUtf8());
      localagua.h("");
      localagua.i(localImgInfo.bytes_pack_name.get().toStringUtf8());
      localagua.g(localImgInfo.uint32_pack_id.get());
      paramArrayOfByte.add(localagua);
      i += 1;
    }
    ...
    for (paramArrayOfByte = localRspBody.bytes_rsp_other.get().toStringUtf8();; paramArrayOfByte = "999")
    {
      if (paramBoolean)
      {
        this.jdField_b_of_type_Aguj.a(paramStickerRecommendSortEntity, paramString1, paramArrayOfByte);
        return;
      }
      if (this.jdField_a_of_type_Aguj != null)
      {
        this.jdField_a_of_type_Aguj.a(paramStickerRecommendSortEntity, paramString1, paramArrayOfByte);
        return;
        break;
      }
      return;
  ...
  public static boolean a(agtk paramagtk)
  {
    return paramagtk.a();
  }
  ...
  private boolean a(File paramFile1, File paramFile2)
  {
    ...
    try
    {
      ...
      ndr.a(paramFile1, localFile.getAbsolutePath() + File.separator);
  ...
  private boolean a(File paramFile, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        paramFile = bdcs.c(paramFile.getPath());
  ...
  public static boolean b(agtk paramagtk)
  {
    return !a(paramagtk);
  }
  ...
  public static String d(String paramString)
  {
    ...
    {
      paramString = Utils.Crc64String(paramString);
      paramString = agtz.jdField_a_of_type_JavaLangString + paramString;
      return paramString;
    }
    catch (Exception paramString)
    {
  ...
  {
    Object localObject = new File(agtz.jdField_a_of_type_JavaLangString);
  ...
  private void i()
  {
    azmz.a(BaseApplication.getContext()).a(null, "StickerRecEmptyImg", false, 0L, 0L, null, "");
  }
  ...
  {
    return baiy.i(bdje.c(baiy.a(paramString)).toLowerCase());
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      try
      {
        if (bdcs.a(this.c.getAbsolutePath())) {
          break label116;
        }
    ...
    if (QLog.isColorLevel())
    {
      QLog.d("StickerRecManager", 2, bhop.a(localException1));
    ...
    l2 = bdiv.o(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    if ((!bdcs.a(this.jdField_b_of_type_JavaIoFile.getAbsolutePath())) || ((l2 != 0L) && (System.currentTimeMillis() - l2 >= 86400000L)))
    {
      bdiv.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), 0L);
      localObject1 = new HashSet();
      localObject2 = this.jdField_a_of_type_Aube.b();
      localList = this.jdField_a_of_type_Aube.jdField_a_of_type_JavaUtilList;
      ...
      {
        arof.c(this.jdField_b_of_type_JavaIoFile.getAbsolutePath());
    ...
    for (;;)
    {
      ...
      if (localObject1 != null) {
        this.jdField_a_of_type_ComTencentMobileqqDataCard = ((aloz)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      }
  ...
  public void a(agtl paramagtl)
  {
    ...
    } while (this.jdField_a_of_type_JavaUtilList.contains(paramagtl));
    this.jdField_a_of_type_JavaUtilList.add(paramagtl);
  }
  
  public void a(aguj paramaguj)
  {
    this.jdField_a_of_type_Aguj = paramaguj;
  }
  ...
  protected void a(Context paramContext, String paramString)
  {
    try
    {
      this.jdField_b_of_type_Boolean = bdiv.E(paramContext, paramString);
      return;
    }
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        QLog.d("StickerRecManager", 2, bhop.a(paramIntent));
        continue;
      }
      finally {}
      label122:
      ...
      {
        ((amfi)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(285)).a(paramFromServiceMsg);
        continue;
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 65	agug:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6: astore 5
    //   8: aload 5
    //   10: ifnonnull +6 -> 16
    //   13: aload_0
    //   14: monitorexit
    //   15: return
    //   16: new 1120	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody
    //   19: dup
    //   20: invokespecial 1121	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:<init>	()V
    //   23: astore 5
    //   25: aload 5
    //   27: iconst_1
    //   28: invokevirtual 1125	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:setHasFlag	(Z)V
    //   31: new 142	java/lang/StringBuilder
    //   34: dup
    //   35: invokespecial 143	java/lang/StringBuilder:<init>	()V
    //   38: aload_1
    //   39: invokevirtual 149	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   42: invokestatic 1128	android/os/SystemClock:uptimeMillis	()J
    //   45: invokevirtual 491	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   48: invokevirtual 152	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   51: astore 6
    //   53: invokestatic 1131	com/tencent/common/config/AppSetting:a	()I
    //   56: invokestatic 1133	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   59: astore 7
    //   61: aload_0
    //   62: getfield 65	agug:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   65: invokevirtual 91	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   68: invokestatic 1138	aowf:a	(Landroid/content/Context;)Ljava/lang/String;
    //   71: astore 8
    //   73: invokestatic 234	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   76: ifeq +82 -> 158
    //   79: ldc 236
    //   81: iconst_2
    ...
    //   116: iload_2
    //   117: invokevirtual 286	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   120: ldc_w 1146
    //   123: invokevirtual 149	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   126: aload 7
    //   128: invokevirtual 149	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   131: ldc_w 1148
    //   134: invokevirtual 149	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   137: aload 8
    ...
    //   148: iload_3
    //   149: invokevirtual 286	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   152: invokevirtual 152	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   155: invokestatic 404	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   158: aload 5
    //   160: getfield 1153	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:bytes_session_id	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   163: aload 6
    //   165: invokestatic 1157	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   168: invokevirtual 1161	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   171: aload 5
    //   173: getfield 1164	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:uint64_src_uin	Lcom/tencent/mobileqq/pb/PBUInt64Field;
    //   176: aload_1
    //   177: invokestatic 1170	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   180: invokevirtual 1172	com/tencent/mobileqq/pb/PBUInt64Field:set	(J)V
    //   183: aload 5
    //   185: getfield 1175	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:uint32_src_term	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   188: iload_2
    //   189: invokevirtual 1177	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   192: aload 5
    //   194: getfield 1180	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:bytes_appid	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   197: aload 7
    //   199: invokestatic 1157	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   202: invokevirtual 1161	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   205: aload 5
    //   207: getfield 1183	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:bytes_version	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   210: aload 8
    //   212: invokestatic 1157	com/tencent/mobileqq/pb/ByteStringMicro:copyFromUtf8	(Ljava/lang/String;)Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   215: invokevirtual 1161	com/tencent/mobileqq/pb/PBBytesField:set	(Lcom/tencent/mobileqq/pb/ByteStringMicro;)V
    //   218: aload 5
    //   220: getfield 1186	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:uin32_gender	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   223: iload_3
    //   224: invokevirtual 1177	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   227: aload 5
    //   229: getfield 1189	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:uint32_age	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   232: iload 4
    //   234: invokevirtual 1177	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   237: aload 5
    //   239: invokevirtual 1192	com/tencent/pb/emosm/PicSearchWordsSvr$ReqBody:toByteArray	()[B
    //   242: astore_1
    //   243: aload_1
    //   244: arraylength
    //   245: iconst_4
    //   246: iadd
    //   247: invokestatic 1198	java/nio/ByteBuffer:allocate	(I)Ljava/nio/ByteBuffer;
    //   250: astore 5
    //   252: aload 5
    //   254: aload_1
    //   255: arraylength
    //   256: iconst_4
    //   257: iadd
    //   258: invokevirtual 1200	java/nio/ByteBuffer:putInt	(I)Ljava/nio/ByteBuffer;
    //   261: aload_1
    //   262: invokevirtual 1203	java/nio/ByteBuffer:put	([B)Ljava/nio/ByteBuffer;
    //   265: pop
    //   266: aload 5
    //   268: invokevirtual 1206	java/nio/ByteBuffer:array	()[B
    //   271: astore_1
    //   272: new 1208	mqq/app/NewIntent
    //   275: dup
    //   276: aload_0
    //   277: getfield 65	agug:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   280: invokevirtual 91	com/tencent/mobileqq/app/QQAppInterface:getApp	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   283: ldc_w 1210
    //   286: invokespecial 1213	mqq/app/NewIntent:<init>	(Landroid/content/Context;Ljava/lang/Class;)V
    //   289: astore 5
    //   291: aload 5
    //   293: ldc_w 1215
    //   296: aload_1
    //   297: invokevirtual 1219	mqq/app/NewIntent:putExtra	(Ljava/lang/String;[B)Landroid/content/Intent;
    //   300: pop
    //   301: aload 5
    //   303: ldc_w 1221
    //   306: ldc_w 1095
    //   309: invokevirtual 1224	mqq/app/NewIntent:putExtra	(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    //   312: pop
    //   313: aload_0
    //   314: getfield 65	agug:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   317: aload 5
    //   319: invokevirtual 1228	com/tencent/mobileqq/app/QQAppInterface:startServlet	(Lmqq/app/NewIntent;)V
    //   322: goto -309 -> 13
    //   325: astore_1
    //   326: aload_0
    //   327: monitorexit
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqDataCard != null)
        {
          ...
          localObject2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), agul.class);
  ...
  public void a(List<agum> paramList, boolean paramBoolean, int paramInt, String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      localObject2 = (agum)localIterator.next();
      if (localObject2 != null)
      {
        str1 = ((agum)localObject2).jdField_a_of_type_JavaLangString;
        localObject1 = ((agum)localObject2).jdField_a_of_type_JavaUtilList;
        ...
        {
          localObject1 = (agtk)((Iterator)localObject5).next();
          if (((agtk)localObject1).b() != null)
          {
            String str2 = ((agtk)localObject1).c();
            if (!TextUtils.isEmpty(str2)) {
              ((StringBuilder)localObject4).append(str2);
            }
            ((StringBuilder)localObject4).append(((agtk)localObject1).b());
            ((StringBuilder)localObject4).append(";");
            if (((agtk)localObject1).a() != null)
            {
              ((StringBuilder)localObject3).append(((agtk)localObject1).a());
              ((StringBuilder)localObject3).append(";");
            }
            if (!((agtk)localObject1).b()) {
              break label599;
            }
            paramList = (List<agum>)localObject1;
          }
        }
      }
    }
    ...
    for (;;)
    {
      ...
      localObject3 = new aguk();
      ((aguk)localObject3).l = "dc04577";
      ((aguk)localObject3).jdField_b_of_type_JavaLangString = str1;
      ((aguk)localObject3).k = ((agum)localObject2).jdField_b_of_type_JavaLangString;
      ((aguk)localObject3).jdField_c_of_type_JavaLangString = String.valueOf(AppSetting.a());
      ((aguk)localObject3).jdField_a_of_type_JavaLangString = String.valueOf(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
      if (paramList != null)
      {
        ...
        ((aguk)localObject3).f = ((String)localObject1);
        ((aguk)localObject3).g = paramList.a();
      }
      ((aguk)localObject3).d = ((String)localObject4);
      ((aguk)localObject3).e = ((String)localObject5);
      if (paramBoolean)
      {
        if (paramInt != 0) {
          break label536;
        }
        ((aguk)localObject3).h = "c2c";
      }
      for (;;)
      {
        ((aguk)localObject3).j = paramString;
        ((aguk)localObject3).i = "android";
        paramList = ((aguk)localObject3).a();
        localObject1 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), agul.class);
        ((NewIntent)localObject1).putExtra("key_cmd", "MQInference.CommonReport");
        ((NewIntent)localObject1).putExtra("key_body", bdku.a(paramList.toString().getBytes()));
        if (QLog.isColorLevel())
        {
          ((aguk)localObject3).jdField_b_of_type_JavaLangString = c(((aguk)localObject3).jdField_b_of_type_JavaLangString);
          QLog.d("StickerRecManager", 2, "report content:" + ((aguk)localObject3).a().toString());
        }
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet((NewIntent)localObject1);
        break label22;
        break;
        if (paramInt == 1) {
          ((aguk)localObject3).h = "group";
        } else if (paramInt == 3000) {
          ((aguk)localObject3).h = "discuss";
        } else if (paramInt == 11000) {
          ((aguk)localObject3).h = "qzone";
        } else {
          ((aguk)localObject3).h = "other";
        }
      }
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    bdiv.v(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramBoolean);
  }
  ...
  public boolean a(String paramString1, int paramInt, String paramString2, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    try
    {
      ...
      if (!bool)
      {
        ...
        if ((!paramBoolean2) || (this.jdField_a_of_type_Aguj == null)) {
          break label251;
        }
    ...
    catch (Exception paramString1)
    {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d("StickerRecManager", 2, bhop.a(paramString1));
        }
      }
    }
    return true;
  ...
  public String b(String paramString)
  {
    ...
    return baiy.i(bdje.c(baiy.a(paramString)));
  }
  ...
  public Collection<String> b()
  {
    ...
    Object localObject1 = ((apke)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(149)).a();
    if (localObject1 != null)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (("isUpdate".equals(((CustomEmotionData)localObject2).RomaingType)) || ("needDownload".equals(((CustomEmotionData)localObject2).RomaingType)) || ("overflow".equals(((CustomEmotionData)localObject2).RomaingType)) || ("overflow_downloaded".equals(((CustomEmotionData)localObject2).RomaingType))) {
          ...
          {
            localObject2 = localaube.a(((CustomEmotionData)localObject2).emoPath, ((CustomEmotionData)localObject2).eId);
  ...
  public void b(List<agum> paramList)
  {
    paramList = new ArrayList(paramList).iterator();
    while (paramList.hasNext())
    {
      Object localObject1 = (agum)paramList.next();
      if (localObject1 != null)
      {
        Object localObject2 = ((agum)localObject1).jdField_a_of_type_JavaLangString;
        StickerRecommendSortEntity localStickerRecommendSortEntity = (StickerRecommendSortEntity)this.jdField_a_of_type_Awbw.a(StickerRecommendSortEntity.class, "usrMessage=?", new String[] { localObject2 });
        Object localObject3;
        if (localStickerRecommendSortEntity != null)
        {
          localStickerRecommendSortEntity.convertToList();
          localObject1 = ((agum)localObject1).jdField_a_of_type_JavaUtilList.iterator();
          while (((Iterator)localObject1).hasNext())
          {
            localObject2 = (agtk)((Iterator)localObject1).next();
            if (!((agtk)localObject2).a())
            {
              localObject2 = (agua)localObject2;
              localObject3 = Integer.valueOf(((agua)localObject2).d());
              if (((agua)localObject2).b())
              {
          ...
          this.jdField_a_of_type_Awbw.a(localStickerRecommendSortEntity);
        }
        else
        {
          localStickerRecommendSortEntity = new StickerRecommendSortEntity((String)localObject2);
          localObject2 = ((agum)localObject1).jdField_a_of_type_JavaUtilList.iterator();
          while (((Iterator)localObject2).hasNext())
          {
            localObject3 = (agtk)((Iterator)localObject2).next();
            if (!((agtk)localObject3).a())
            {
              localObject3 = (agua)localObject3;
              if (((agua)localObject3).b()) {
                localStickerRecommendSortEntity.addClicked(Integer.valueOf(((agua)localObject3).d()));
              } else {
                localStickerRecommendSortEntity.addExposed(Integer.valueOf(((agua)localObject3).d()));
              }
            }
          }
          localObject1 = ((agum)localObject1).jdField_b_of_type_JavaUtilList.iterator();
          while (((Iterator)localObject1).hasNext())
          {
            localObject2 = (agtk)((Iterator)localObject1).next();
            if (!((agtk)localObject2).a()) {
              localStickerRecommendSortEntity.addNoExpose(Integer.valueOf(((agua)localObject2).d()));
            }
          }
          if ((localStickerRecommendSortEntity.noExposeList != null) && (localStickerRecommendSortEntity.noExposeList.size() == 0))
          {
          ...
          this.jdField_a_of_type_Awbw.b(localStickerRecommendSortEntity);
        }
      }
    }
  }
  ...
  public void g()
  {
    if (this.jdField_a_of_type_Agtw == null) {
      return;
    }
    this.jdField_a_of_type_Agtw.a();
  }
