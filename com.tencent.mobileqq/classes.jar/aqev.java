...
public class aqev
  extends alsv
{
  public aqev(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
  ...
  public void a(aqgk paramaqgk)
  {
    ...
    else if ((this.a.jdField_b_of_type_Int == 0) && (paramaqgk != null) && (!this.a.jdField_b_of_type_JavaUtilList.contains(paramaqgk)))
    {
      this.a.jdField_b_of_type_JavaUtilList.add(paramaqgk);
      if (this.a.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.size() != this.a.jdField_d_of_type_JavaUtilList.size()) {
        break label162;
      }
      Face2FaceAddFriendActivity.a(this.a, paramaqgk);
    }
    for (;;)
    {
      paramaqgk = this.a;
      ...
      ((Message)localObject).obj = paramaqgk;
  ...
  public void a(aqgo paramaqgo)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if ((this.a.jdField_f_of_type_Long == 0L) || (l2 >= 1000L) || (paramaqgo.a != 0L)) {
          break label269;
        }
        localObject = Message.obtain();
        ((Message)localObject).what = 16;
        ((Message)localObject).obj = paramaqgo;
        l3 = 1000L - l2;
    ...
    } while ((this.a.jdField_b_of_type_Int != 1) || (this.a.jdField_a_of_type_JavaUtilList.contains(paramaqgo)));
    label269:
    this.a.jdField_a_of_type_JavaUtilList.add(paramaqgo);
    if ((this.a.l) && (this.a.jdField_a_of_type_Aqgl != null))
    {
      this.a.jdField_a_of_type_AndroidWidgetTextView.setText(String.valueOf(this.a.jdField_a_of_type_JavaUtilList.size()));
      this.a.jdField_a_of_type_Aqgl.a(paramaqgo);
      return;
    }
    Face2FaceAddFriendActivity.a(this.a, paramaqgo);
    this.a.e();
  }
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, String paramString)
  {
    ...
    if (i == 0)
    {
      Iterator localIterator = this.a.jdField_a_of_type_Aqfv.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        ...
        if ((paramBusiRespHead != null) && (paramBusiRespHead.a() == 2) && (paramString.equals(paramBusiRespHead.b())))
        {
          ...
          if (!(paramBusiRespHead instanceof aqgk)) {
            break label477;
          }
        }
      }
    ...
    label477:
    for (paramBusiRespHead = paramBusiRespHead.e + "_" + ((aqgk)paramBusiRespHead).jdField_b_of_type_JavaLangString;; paramBusiRespHead = paramString)
    {
      this.a.jdField_a_of_type_Aqfv.a(paramBusiRespHead);
      ...
      break;
      azmj.b(null, "P_CliOper", "Grp_set", "", "Radar_grp_guest", "suc_join", 0, 0, paramString, "8.3.3", "", this.a.app.getCurrentAccountUin());
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, List<aqgk> paramList)
  {
    ...
    if (paramList == null)
    {
      ...
      if (this.a.jdField_b_of_type_Int == 1) {
        bdcd.a(this.a, 230, this.a.getString(2131720796), alpo.a(2131704672), 2131690648, 2131692277, new aqew(this), null).show();
      }
    }
    label179:
    label185:
    do
    {
      ...
      for (;;)
      {
        ...
        {
          paramList = (aqgn)paramBusiRespHead.next();
    ...
    label421:
    bdcd.a(this.a, 230, this.a.getString(2131720796), alpo.a(2131704665), 2131690648, 2131692277, new aqex(this), null).show();
  }
}
