...
public class bbee
{
  ...
  public static String a()
  {
    Object localObject = "Android Qzone/" + bfpk.a();
    String str;
    switch (mpl.a())
    {
    case 0: 
    ...
    for (;;)
    {
      ...
      ((StringBuilder)localObject).append(" ").append("QQ/").append("8.2.6").append(".").append("4370").append(str).append(" Pixel/").append(BaseApplicationImpl.getContext().getResources().getDisplayMetrics().widthPixels).append(" StatusBarHeight/" + i);
  ...
  public static boolean a(byte[] paramArrayOfByte, String paramString)
  {
    ...
    //   16: astore 7
    //   18: ldc_w 302
    //   21: invokestatic 186	bbee:a	(Ljava/lang/String;)V
    //   24: aload_0
    //   25: ifnull +10 -> 35
    //   28: aload_1
    //   29: invokestatic 192	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   32: ifeq +7 -> 39
    //   35: iconst_0
    //   36: istore_3
    //   37: iload_3
    //   38: ireturn
    //   39: new 304	java/io/File
    //   42: dup
    //   43: aload_1
    //   44: invokespecial 305	java/io/File:<init>	(Ljava/lang/String;)V
    //   47: astore 6
    //   49: aload 6
    //   51: invokevirtual 308	java/io/File:exists	()Z
    //   54: ifeq +9 -> 63
    //   57: aload 6
    //   59: invokevirtual 311	java/io/File:delete	()Z
    //   62: pop
    //   63: aload 6
    //   65: invokevirtual 314	java/io/File:createNewFile	()Z
    //   68: pop
    //   69: new 316	java/io/ByteArrayInputStream
    //   72: dup
    //   73: aload_0
    //   74: iconst_0
    //   75: aload_0
    //   76: arraylength
    //   77: invokespecial 319	java/io/ByteArrayInputStream:<init>	([BII)V
    //   80: astore_1
    //   81: new 321	java/io/BufferedOutputStream
    //   84: dup
    //   85: new 323	java/io/FileOutputStream
    //   88: dup
    //   89: aload 6
    //   91: invokespecial 326	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   94: sipush 4096
    //   97: invokespecial 329	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;I)V
    //   100: astore 6
    //   102: aload 10
    //   104: astore_0
    //   105: aload 6
    ...
    //   112: aload 9
    //   114: astore 8
    //   116: invokestatic 335	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   119: sipush 4096
    //   122: invokevirtual 339	com/tencent/commonsdk/pool/ByteArrayPool:getBuf	(I)[B
    //   125: astore 9
    //   127: aload 9
    //   129: astore 7
    //   131: aload 9
    ...
    //   145: aload_1
    //   146: aload 9
    //   148: invokevirtual 345	java/io/InputStream:read	([B)I
    //   151: istore_2
    //   152: iload_2
    //   153: iconst_m1
    ...
    //   179: iconst_0
    //   180: iload_2
    //   181: invokevirtual 350	java/io/OutputStream:write	([BII)V
    //   184: goto -57 -> 127
    //   187: astore_0
    //   188: aload 7
    //   190: astore 8
    ...
    //   203: astore 4
    //   205: aload 7
    //   207: invokevirtual 351	java/io/IOException:printStackTrace	()V
    //   210: invokestatic 335	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   213: aload 8
    //   215: invokevirtual 355	com/tencent/commonsdk/pool/ByteArrayPool:returnBuf	([B)V
    //   218: aload_1
    //   219: ifnull +7 -> 226
    //   222: aload_1
    //   223: invokevirtual 358	java/io/InputStream:close	()V
    //   226: aload 6
    //   228: ifnull +8 -> 236
    //   231: aload 6
    //   233: invokevirtual 359	java/io/OutputStream:close	()V
    //   236: iconst_0
    //   237: ireturn
    //   238: aload 9
    //   240: astore 7
    ...
    //   254: astore 8
    //   256: aload 6
    //   258: invokevirtual 362	java/io/OutputStream:flush	()V
    //   261: iconst_1
    //   262: istore_3
    //   263: invokestatic 335	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   266: aload 9
    //   268: invokevirtual 355	com/tencent/commonsdk/pool/ByteArrayPool:returnBuf	([B)V
    //   271: aload_1
    //   272: ifnull +7 -> 279
    //   275: aload_1
    //   276: invokevirtual 358	java/io/InputStream:close	()V
    //   279: aload 6
    //   281: ifnull -244 -> 37
    //   284: aload 6
    //   286: invokevirtual 359	java/io/OutputStream:close	()V
    //   289: iconst_1
    //   290: ireturn
    //   291: astore_0
    //   292: aload_0
    //   293: invokevirtual 211	java/lang/Exception:printStackTrace	()V
    //   296: iconst_0
    //   297: ireturn
    //   298: astore_0
    //   299: aload_0
    //   300: invokevirtual 211	java/lang/Exception:printStackTrace	()V
    //   303: iconst_0
    //   304: ireturn
    //   305: astore 7
    //   307: aconst_null
    ...
    //   320: astore 4
    //   322: aload 7
    //   324: invokevirtual 211	java/lang/Exception:printStackTrace	()V
    //   327: invokestatic 335	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   330: aload 8
    //   332: invokevirtual 355	com/tencent/commonsdk/pool/ByteArrayPool:returnBuf	([B)V
    //   335: aload_1
    //   336: ifnull +7 -> 343
    //   339: aload_1
    //   340: invokevirtual 358	java/io/InputStream:close	()V
    //   343: aload 6
    //   345: ifnull +8 -> 353
    //   348: aload 6
    //   350: invokevirtual 359	java/io/OutputStream:close	()V
    //   353: iconst_0
    //   354: ireturn
    //   355: astore_0
    //   356: aload_0
    //   357: invokevirtual 211	java/lang/Exception:printStackTrace	()V
    //   360: iconst_0
    //   361: ireturn
    //   362: astore 6
    //   364: aconst_null
    ...
    //   369: aload 4
    //   371: astore_0
    //   372: invokestatic 335	com/tencent/commonsdk/pool/ByteArrayPool:getGenericInstance	()Lcom/tencent/commonsdk/pool/ByteArrayPool;
    //   375: aload_0
    //   376: invokevirtual 355	com/tencent/commonsdk/pool/ByteArrayPool:returnBuf	([B)V
    //   379: aload_1
    //   380: ifnull +7 -> 387
    //   383: aload_1
    //   384: invokevirtual 358	java/io/InputStream:close	()V
    //   387: aload 5
    //   389: ifnull +8 -> 397
    //   392: aload 5
    //   394: invokevirtual 359	java/io/OutputStream:close	()V
    //   397: aload 6
    //   399: athrow
    //   400: astore_0
    //   401: aload_0
    //   402: invokevirtual 211	java/lang/Exception:printStackTrace	()V
    //   405: goto -8 -> 397
    //   408: astore 6
    //   410: aconst_null
    //   411: astore 5
  ...
  private static String b()
  {
    ...
    for (;;)
    {
      try
      {
        a = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "tencent/MobileQQ/webso/offline/";
  ...
  public static String c(String paramString)
  {
    ...
    catch (Throwable paramString)
    {
      ...
      try
      {
        paramString = bace.b(paramString);
        return paramString;
      }
      catch (Throwable paramString)
      {
