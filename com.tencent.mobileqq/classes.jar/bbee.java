  ...
  implements bbed
{
  ...
  public static bbed a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.tencent.mobileqq.richmedia.ICallBack");
    if ((localIInterface != null) && ((localIInterface instanceof bbed))) {
      return (bbed)localIInterface;
    }
    return new bbef(paramIBinder);
  }
