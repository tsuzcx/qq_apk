...
public class lgc
{
  ...
  public static lgd a(byte[] paramArrayOfByte)
  {
    ...
    localObject = new lgd(j, k);
    System.arraycopy(paramArrayOfByte, 9, ((lgd)localObject).a, 0, j);
    System.arraycopy(paramArrayOfByte, j + 9, ((lgd)localObject).b, 0, k);
    return localObject;
  }
