  ...
  extends awls
{
  ...
  private static ConcurrentHashMap<String, SoftReference<ArrayList<awlv>>> c = new ConcurrentHashMap();
  private ajxv jdField_a_of_type_Ajxv = new awmd(this);
  private aktg jdField_a_of_type_Aktg;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  private String jdField_a_of_type_JavaLangString;
  private Comparator<FTSEntity> jdField_a_of_type_JavaUtilComparator = new awmb(this);
  ...
  public awlz(QQAppInterface paramQQAppInterface)
  {
  ...
  private int a(String paramString, int paramInt)
  {
    if (this.jdField_a_of_type_Aktg == null) {
      this.jdField_a_of_type_Aktg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
    }
    int i = 0;
    if (!this.jdField_a_of_type_Aktg.a(paramString, paramInt)) {
      i = 10;
    }
    if (paramInt == 3000) {
      return i + 2;
  ...
  private ArrayList<awme> a(ArrayList<FTSEntity> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if ((localFTSMessage != null) && (localFTSMessage.msgExts != null))
      {
        ...
        String str = akpy.a((String)localObject2, i);
        if (!((HashMap)localObject1).containsKey(str))
        {
          awme localawme = new awme();
          localawme.jdField_a_of_type_JavaUtilList = new ArrayList();
          localawme.jdField_a_of_type_JavaUtilList.add(localFTSMessage);
          localawme.jdField_a_of_type_Int = localFTSMessage.mSearchScene;
          localawme.b = localFTSMessage.mProximity;
          localawme.c = a((String)localObject2, i);
          localawme.jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)localFTSMessage.msgExts).time;
          localawme.jdField_a_of_type_JavaUtilHashSet = new HashSet();
          localawme.jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(localFTSMessage.mOId));
          localawme.d = localFTSMessage.searchStrategy;
          localawme.e = localFTSMessage.senderNum;
          localawme.f = localFTSMessage.friendNum;
          localawme.g = localFTSMessage.friendIndex;
          ((HashMap)localObject1).put(str, localawme);
        }
        else
        {
          localObject2 = (awme)((HashMap)localObject1).get(str);
          if (((awme)localObject2).jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(localFTSMessage.mOId)))
          {
            if (localFTSMessage.mSearchScene == ((awme)localObject2).jdField_a_of_type_Int)
            {
              if (localFTSMessage.mProximity < ((awme)localObject2).b) {
                ((awme)localObject2).b = localFTSMessage.mProximity;
              }
              if (((FTSMessageCodec.TextMsgExts)localFTSMessage.msgExts).time > ((awme)localObject2).jdField_a_of_type_Long) {
                ((awme)localObject2).jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)localFTSMessage.msgExts).time;
              }
              if (localFTSMessage.senderNum > ((awme)localObject2).e) {
                ((awme)localObject2).e = localFTSMessage.senderNum;
              }
              if (localFTSMessage.friendNum > ((awme)localObject2).f) {
                ((awme)localObject2).f = localFTSMessage.friendNum;
              }
              if (localFTSMessage.friendIndex > ((awme)localObject2).g) {
                ((awme)localObject2).g = localFTSMessage.friendIndex;
              }
            }
            for (;;)
            {
              if (localFTSMessage.mSearchScene < ((awme)localObject2).jdField_a_of_type_Int) {
                ((awme)localObject2).jdField_a_of_type_Int = localFTSMessage.mSearchScene;
              }
              if (localFTSMessage.searchStrategy < ((awme)localObject2).d) {
                ((awme)localObject2).d = localFTSMessage.searchStrategy;
              }
              ((awme)localObject2).jdField_a_of_type_JavaUtilList.add(localFTSMessage);
              break;
              if (localFTSMessage.mSearchScene < ((awme)localObject2).jdField_a_of_type_Int)
              {
                ((awme)localObject2).b = localFTSMessage.mProximity;
  ...
  private List<awlv> a(String paramString1, String paramString2, String paramString3, boolean paramBoolean1, ArrayList<FTSEntity> paramArrayList, boolean paramBoolean2)
  {
    Object localObject1 = new HashMap();
    paramArrayList = paramArrayList.iterator();
    int i = 0;
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if ((localObject2 != null) && (((FTSMessage)localObject2).msgExts != null))
      {
        ...
        localObject4 = akpy.a((String)localObject3, j);
        if (!((HashMap)localObject1).containsKey(localObject4))
        {
          localObject5 = new awme();
          ((awme)localObject5).jdField_a_of_type_JavaUtilList = new ArrayList();
          ((awme)localObject5).jdField_a_of_type_JavaUtilList.add(localObject2);
          ((awme)localObject5).b = ((FTSMessage)localObject2).mProximity;
          ((awme)localObject5).c = a((String)localObject3, j);
          ((awme)localObject5).jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject2).msgExts).time;
          ((awme)localObject5).jdField_a_of_type_JavaUtilHashSet = new HashSet();
          ((awme)localObject5).jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(((FTSMessage)localObject2).mOId));
          ((awme)localObject5).d = ((FTSMessage)localObject2).searchStrategy;
          ((HashMap)localObject1).put(localObject4, localObject5);
        }
        else
        {
          localObject3 = (awme)((HashMap)localObject1).get(localObject4);
          if (!((awme)localObject3).jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(((FTSMessage)localObject2).mOId)))
          {
            i = 1;
          }
          else
          {
            if (((FTSMessage)localObject2).mProximity < ((awme)localObject3).b) {
              ((awme)localObject3).b = ((FTSMessage)localObject2).mProximity;
            }
            if (((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject2).msgExts).time > ((awme)localObject3).jdField_a_of_type_Long) {
              ((awme)localObject3).jdField_a_of_type_Long = ((FTSMessageCodec.TextMsgExts)((FTSMessage)localObject2).msgExts).time;
            }
            if (((FTSMessage)localObject2).searchStrategy < ((awme)localObject3).d) {
              ((awme)localObject3).d = ((FTSMessage)localObject2).searchStrategy;
            }
            ((awme)localObject3).jdField_a_of_type_JavaUtilList.add(localObject2);
          }
        }
      }
    }
    ...
    Collections.sort(paramArrayList, new awma(this));
    localObject1 = bbma.a(paramString2);
    ...
    if (paramArrayList != null)
    {
      ...
      {
        localObject4 = (awme)((Iterator)localObject3).next();
        if (a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(((FTSMessage)((awme)localObject4).jdField_a_of_type_JavaUtilList.get(0)).uin), ((FTSMessage)((awme)localObject4).jdField_a_of_type_JavaUtilList.get(0)).istroop))
        {
          ...
          {
            paramArrayList = new awmg((QQAppInterface)localObject5, paramArrayList, paramString2, (ArrayList)localObject1, ((awme)localObject4).jdField_a_of_type_JavaUtilList, paramString3, null);
            paramArrayList.jdField_a_of_type_Int = ((awme)localObject4).d;
            paramArrayList.b = ((awme)localObject4).e;
            paramArrayList.c = ((awme)localObject4).f;
            paramArrayList.d = ((awme)localObject4).g;
            ((List)localObject2).add(paramArrayList);
            i = awil.a("fts_native_chathistory_maxnum", 3);
  ...
  private List<awlu> a(String paramString, ArrayList<FTSEntity> paramArrayList)
  {
    ArrayList localArrayList = bbma.a(paramString);
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      paramArrayList.add(new awmf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, localArrayList, (FTSEntity)localObject2));
    }
    return paramArrayList;
  }
  ...
  public List<awlv> a(awvg paramawvg)
  {
    if (paramawvg == null) {
      return null;
    }
    ...
    for (boolean bool = paramawvg.jdField_a_of_type_AndroidOsBundle.getBoolean("fts_search_is_limited", true);; bool = true)
    {
      if (bbma.g(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == 1) {
        return b(paramawvg, bool);
      }
      return a(paramawvg, bool);
    }
  }
  
  public List<awlv> a(awvg arg1, boolean paramBoolean)
  {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          if (localObject1 != null)
          {
            ...
            axrl.a(BaseApplication.getContext()).a(null, "SearchMessageStatistic_FTS", true, (l7 - l5) / 1000000L, 0L, (HashMap)localObject5, null);
            l8 = System.nanoTime();
            if (QLog.isColorLevel()) {
              if (??? == null) {
                break label1500;
          ...
          for (int i1 = ???.size();; i1 = 0)
          {
            ...
            if (n == 0)
            {
              ...
              axrl.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l1, 0L, ???, null);
            }
            ??? = (awvg)localObject1;
            if (n == 0) {
              if (localObject1 != null)
            ...
            axrl.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l2, 0L, (HashMap)localObject5, null);
            return localObject4;
  ...
  public List<awlv> a(String paramString, boolean paramBoolean)
  {
    if (!bbev.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
      return null;
    }
    ??? = (ajxu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(81);
    Object localObject2 = new ArrayList();
    ((ArrayList)localObject2).add(paramString);
    ((ajxu)???).a((ArrayList)localObject2);
    ...
    axrl.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l2, 0L, (HashMap)localObject2, null);
    return paramString;
    label654:
    ...
    if (localArrayList == null)
    {
      ...
      axrl.a(BaseApplication.getContext()).a(null, "SearchMessageStatistic_FTS", true, (l3 - l6) / 1000000L, 0L, paramString, null);
      l4 = System.nanoTime();
      if (QLog.isColorLevel()) {
        if (localArrayList == null) {
          break label1267;
    ...
    for (int n = localArrayList.size();; n = 0)
    {
      ...
      ((HashMap)localObject2).put("groupSortCost", String.valueOf(l1));
      axrl.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l2, 0L, paramString, null);
      return ???;
  ...
  public void a(awvg paramawvg, awut<awlv> paramawut)
  {
    bbmb.e = System.nanoTime();
    bbmb.f = 0L;
    ThreadManager.post(new FTSMessageSearchEngine.1(this, paramawvg, paramawut), 8, null, true);
  }
  ...
  public List<awlu> b(awvg paramawvg)
  {
    if (QLog.isColorLevel()) {
      QLog.d("FTSMessageSearchEngine", 2, "========== search message use FTSMessageSearchEngine");
    }
    ...
    Object localObject = paramawvg.jdField_a_of_type_JavaLangString;
    if (paramawvg.jdField_a_of_type_AndroidOsBundle == null) {
      return new ArrayList();
    }
    long l3 = paramawvg.jdField_a_of_type_AndroidOsBundle.getLong("uin");
    int i = paramawvg.jdField_a_of_type_AndroidOsBundle.getInt("uinType");
    paramawvg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a((String)localObject, FTSMessage.class, false, false, l3, i);
    l3 = System.nanoTime();
    localObject = a((String)localObject, paramawvg);
    long l4 = System.nanoTime();
    if (paramawvg != null) {}
    for (i = paramawvg.size();; i = 0)
    {
  ...
  public List<awlv> b(awvg arg1, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
      QLog.d("FTSMessageSearchEngine", 2, "========== search message use FTSMessageSearchEngine");
    }
    ...
    Object localObject4 = bbma.a(str);
    ...
    for (int i2 = 0;; i2 = 1)
    {
      ...
      axrl.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, 0L, 0L, localHashMap, null);
      return localObject3;
      i1 = ???.size();
      break label362;
    }
    ...
    long l1 = System.nanoTime();
    localObject4 = bbma.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject4);
    ...
    if ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
    {
      ...
      while (((Iterator)localObject5).hasNext())
      {
        localObject6 = (bbmc)((Iterator)localObject5).next();
        if ((((bbmc)localObject6).jdField_a_of_type_Int != 0) && (((bbmc)localObject6).jdField_a_of_type_Int != 1004)) {
          break label2300;
        }
        j += 1;
      }
    ...
    for (;;)
    {
      ...
      if ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
      {
        ...
        {
          localObject5 = ((bbmc)((ArrayList)localObject4).get(i5)).jdField_a_of_type_JavaLangString;
          int i9 = ((bbmc)((ArrayList)localObject4).get(i5)).jdField_a_of_type_Int;
          localObject6 = ((bbmc)((ArrayList)localObject4).get(i5)).jdField_a_of_type_AndroidUtilPair;
          int i6 = m;
          ...
          {
            i = k;
            if (bbma.h(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == 1)
            {
      ...
      for (m = i;; m = i)
      {
        ...
        for (;;)
        {
          ...
          l3 += l4;
          localObject3 = bbma.a(localHashMap);
          localObject5 = ((ArrayList)localObject5).iterator();
          while (((Iterator)localObject5).hasNext())
          {
            localObject6 = (awme)((Iterator)localObject5).next();
            localObject7 = (FTSMessage)((awme)localObject6).jdField_a_of_type_JavaUtilList.get(0);
            ...
            {
              localObject7 = new awmg(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localHashMap, localHashMap, (ArrayList)localObject3, ((awme)localObject6).jdField_a_of_type_JavaUtilList, null, null);
              ((awmg)localObject7).jdField_a_of_type_Int = ((awme)localObject6).d;
              ((awmg)localObject7).b = ((awme)localObject6).e;
              ((awmg)localObject7).c = ((awme)localObject6).f;
              ((awmg)localObject7).d = ((awme)localObject6).g;
          ...
          axrl.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l3, 0L, ???, null);
  ...
  public void b(awvg paramawvg, awut<awlu> paramawut)
  {
    ThreadManager.post(new FTSMessageSearchEngine.2(this, paramawvg, paramawut), 8, null, true);
  }
