...
public class bgpk
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, TroopTipsEntity paramTroopTipsEntity)
  {
    ...
    MessageForGrayTips localMessageForGrayTips = (MessageForGrayTips)bcry.a(-2043);
    ...
    if (paramTroopTipsEntity.highlightNum != 0) {
      bgul.a(localMessageForGrayTips, paramTroopTipsEntity.highlightItems);
    }
    if (paramTroopTipsEntity.optShowLatest == 1) {
      localMessageForGrayTips.shmsgseq = 0L;
    }
    if (!aoci.a(paramQQAppInterface, localMessageForGrayTips, false))
    {
      if (QLog.isColorLevel()) {
      ...
      if (!((bgre)paramQQAppInterface.getManager(132)).a(paramTroopTipsEntity.troopUin))
      {
        bfoy localbfoy = new bfoy();
        Object localObject1 = new bfoy();
        ((bfoy)localObject1).a.a(4, localMessageForGrayTips.shmsgseq, localMessageForGrayTips.uniseq);
        localbfoy.a((bfoy)localObject1);
        localMessageForGrayTips.mMessageInfo = ((bfoy)localObject1);
        ((axfw)paramQQAppInterface.getManager(37)).a(paramTroopTipsEntity.troopUin, localbfoy);
        Object localObject2 = new aczl(paramQQAppInterface);
        localObject1 = ((aczl)localObject2).jdField_a_of_type_Apaw;
        localObject2 = ((aczl)localObject2).jdField_a_of_type_JavaUtilMap;
        localObject1 = (RecentUser)((apaw)localObject1).findRecentUserByUin(paramTroopTipsEntity.troopUin, 1);
        int i = localbfoy.b(paramQQAppInterface, true, paramTroopTipsEntity.troopUin);
        if (i >= ((RecentUser)localObject1).msgType)
        {
          ((RecentUser)localObject1).msgType = i;
          ((RecentUser)localObject1).msg = bgiv.a(paramQQAppInterface, paramTroopTipsEntity.troopUin, localbfoy, ((RecentUser)localObject1).msg, localMessageForGrayTips, true);
          ((Map)localObject2).put(adak.a(paramTroopTipsEntity.troopUin, 1), localObject1);
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    ((aoip)paramQQAppInterface.a(20)).notifyUI(61, true, new Object[] { paramString, str, Boolean.valueOf(false) });
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, long paramLong)
  {
    ...
    String str = ((Resources)localObject).getString(2131696834);
    localObject = ((Resources)localObject).getString(2131696830);
    ...
    for (String str = "";; str = paramString1)
    {
      ...
      try
      {
        ...
        if (!TextUtils.isEmpty(paramString1)) {
          bgts.a(paramQQAppInterface, paramString1, i);
        }
        return;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, bgpm parambgpm, boolean paramBoolean)
  {
    if ((paramQQAppInterface == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)))
    {
      if (QLog.isColorLevel())
      {
        parambgpm = new StringBuilder().append("checkIdentity error. app null: ");
      ...
      {
        parambgpm = parambgpm.append(String.valueOf(paramBoolean)).append(", troopUin: ");
        paramQQAppInterface = paramString1;
        if (TextUtils.isEmpty(paramString1)) {
          paramQQAppInterface = "";
        }
        paramString1 = parambgpm.append(paramQQAppInterface).append(", memberUin: ");
    ...
    ((TroopManager)paramQQAppInterface.getManager(52)).a(paramString1, paramString2, new bgpl(paramString1, paramString2, paramBoolean, paramQQAppInterface, parambgpm));
  }
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2)
  {
    try
    {
      ...
      Object localObject2 = aunj.a(localFileInfo);
  ...
  private static void b(bgpm parambgpm, int paramInt)
  {
    if (parambgpm == null) {
      return;
    }
    ...
    {
      parambgpm.a(paramInt);
      return;
    }
    ThreadManager.getUIHandler().post(new HWTroopUtils.2(parambgpm, paramInt));
  }
