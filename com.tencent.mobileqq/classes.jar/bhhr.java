...
public class bhhr
{
  ...
  {
    return PreferenceManager.getDefaultSharedPreferences(paramContext).getInt(paramString + "_" + "subscript_recommend_config_version" + "_" + "8.4.10.4875", 0);
  }
  ...
  {
    return PreferenceManager.getDefaultSharedPreferences(paramContext).getInt("readinjoy_crop_and_group_version_4875_" + paramString, 0);
  }
  ...
  {
    return PreferenceManager.getDefaultSharedPreferences(paramContext).getInt("readinjoy_remote_reset_config_version_4875_" + paramString, 0);
  }
  ...
  public static boolean b(Context paramContext, String paramString)
  {
    ...
    return !TextUtils.equals(PreferenceManager.getDefaultSharedPreferences(paramContext).getString(paramString, ""), "8.4.10");
  }
  ...
  {
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
    paramContext.putString("config_app_version_" + paramString, "8.4.10");
    paramContext.commit();
  }
  ...
  {
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
    paramContext.putInt(paramString + "_" + "subscript_recommend_config_version" + "_" + "8.4.10.4875", paramInt);
    paramContext.commit();
  }
  ...
  {
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
    paramContext.putInt("readinjoy_crop_and_group_version_4875_" + paramString, paramInt);
    paramContext.commit();
  }
  ...
  {
    paramContext = PreferenceManager.getDefaultSharedPreferences(paramContext).edit();
    paramContext.putInt("readinjoy_remote_reset_config_version_4875_" + paramString, paramInt);
    paramContext.commit();
  }
