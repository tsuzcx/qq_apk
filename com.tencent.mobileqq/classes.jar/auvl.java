...
public class auvl
  extends apaq
{
  public auvl(AppletsSettingFragment paramAppletsSettingFragment) {}
  ...
  protected void onGetAppletsSettingSwitch(boolean paramBoolean, List<apaz> paramList)
  {
    ...
    if (paramBoolean)
    {
      ...
      if ((paramList != null) && (paramBoolean) && (paramList.size() > 0))
      {
        ...
        {
          Object localObject1 = (apaz)paramList.next();
          Object localObject2;
          if ((((apaz)localObject1).jdField_a_of_type_JavaUtilList != null) && (((apaz)localObject1).jdField_a_of_type_JavaUtilList.size() > 0) && (((apaz)localObject1).jdField_a_of_type_JavaUtilList.get(0) != null) && (((AppletItem)((apaz)localObject1).jdField_a_of_type_JavaUtilList.get(0)).a() == 1L))
          {
            AppletsSettingFragment.a(this.a, (AppletItem)((apaz)localObject1).jdField_a_of_type_JavaUtilList.get(0));
            ...
            {
              ((alcz)localObject2).a(paramBoolean);
              if (TextUtils.isEmpty(((apaz)localObject1).jdField_a_of_type_JavaLangString)) {
                break;
              }
              AppletsSettingFragment.b(this.a).setText(((apaz)localObject1).jdField_a_of_type_JavaLangString);
              this.a.a.a(((apaz)localObject1).jdField_a_of_type_JavaLangString);
              break;
              paramBoolean = false;
              break label244;
              paramBoolean = false;
          ...
          if (!TextUtils.isEmpty(((apaz)localObject1).jdField_a_of_type_JavaLangString))
          {
            AppletsSettingFragment.c(this.a).setText(((apaz)localObject1).jdField_a_of_type_JavaLangString);
            this.a.a.b(((apaz)localObject1).jdField_a_of_type_JavaLangString);
          }
          if ((((apaz)localObject1).jdField_a_of_type_JavaUtilList != null) && (((apaz)localObject1).jdField_a_of_type_JavaUtilList.size() > 0))
          {
            AppletsSettingFragment.a(this.a).clear();
            localObject1 = ((apaz)localObject1).jdField_a_of_type_JavaUtilList.iterator();
