...
public class anbd
{
  ...
  public static ande a(int paramInt)
  {
    andn localandn = a();
    if (localandn == null) {
      return null;
  ...
  public static ande a(int paramInt1, int paramInt2)
  {
    andn localandn = a();
    if (localandn == null) {
      return null;
    }
    return localandn.a(paramInt1, paramInt2);
  }
  
  public static ande a(long paramLong)
  {
  ...
  public static andn a()
  {
    ...
    if ((localAppInterface instanceof CmGameAppInterface)) {
      return (andn)((CmGameAppInterface)localAppInterface).getManager(255);
    }
    return null;
  }
  
  public static ands a(int paramInt)
  {
    ande localande = a(paramInt);
    if (localande != null) {
      return localande.a();
    }
  ...
  public static ands a(long paramLong)
  {
    ande localande = b(paramLong);
    if (localande != null) {
      return localande.a();
  ...
  public static ApolloSurfaceView a()
  {
    ...
    {
      return null;
      localObject = ((andn)localObject).a();
    } while (localObject == null);
    return ((ande)localObject).a();
  }
  ...
  public static void a(Activity paramActivity, Conversation paramConversation)
  {
    ...
    {
      return;
      localamsx = (amsx)a().getManager(153);
      if (a(null)) {
        localamsx.k = true;
      }
    } while ((localamsx == null) || (!localamsx.j) || (paramActivity == null) || (!(paramActivity instanceof SplashActivity)) || (paramActivity.isFinishing()) || (!((SplashActivity)paramActivity).isResume()) || (paramConversation == null));
    if (FrameHelperActivity.b())
    {
      FrameHelperActivity.c(true);
      FrameHelperActivity.s();
    }
    a(paramConversation.b, localamsx.a());
    localamsx.j = false;
  ...
  public static void a(View paramView, String paramString)
  {
    ...
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        localTextView.setBackgroundResource(2130838607);
        localTextView.setPadding((int)(bhlo.jdField_a_of_type_Float * 7.0F), (int)(bhlo.jdField_a_of_type_Float * 7.0F), (int)(bhlo.jdField_a_of_type_Float * 7.0F), 0);
        ...
        int i = (int)((float)bhlo.k() - bhlo.jdField_a_of_type_Float * 7.0F - localTextView.getMeasuredWidth());
        int j = (int)(localRect.bottom - 6.0F * bhlo.jdField_a_of_type_Float);
  ...
  public static void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, int paramInt3, long paramLong, JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("sqVersion", "8.4.5.4745");
      ...
      paramJSONObject = new NewIntent(paramAppInterface.getApp(), amxh.class);
      ...
      paramJSONObject.setObserver(new anbe());
  ...
  public static void a(CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    else
    {
      ...
      if ((paramStartCheckParam.mStartType == 2) || (paramStartCheckParam.mStartType == 1) || (paramStartCheckParam.mStartType == 3))
      {
        ...
        if (localList != null)
        {
          ...
          if (i < localList.size())
          {
            localObject3 = (andq)localList.get(i);
            if ((localObject3 == null) || (((andq)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam == null)) {
              break label713;
            }
            localObject1 = localandn.a(((andq)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
            if (localObject1 == null) {
              break label713;
            }
            localObject4 = ((ande)localObject1).a();
            if ((((ande)localObject1).a() != paramStartCheckParam.gameId) || ((paramStartCheckParam.roomId != 0L) && (paramStartCheckParam.roomId != ((ansi)localObject4).jdField_a_of_type_Long))) {
              break label713;
            }
            if (((ande)localObject1).a() == null) {
              break label1490;
            }
          }
        }
    ...
    label849:
    label1490:
    for (localObject1 = ((ande)localObject1).a().getClass();; localObject1 = null)
    {
      QLog.i("cmgame_process.CmGameUtil", 1, " launchGame found old task.mStartCheckParam:" + ((andq)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
      if (localObject1 == null)
      {
        if ((localList != null) && (localList.size() >= andn.jdField_a_of_type_ArrayOfJavaLangClass.length))
        {
          localObject2 = (andq)localList.get(0);
          if ((localObject2 != null) && (((andq)localObject2).jdField_a_of_type_JavaLangRefWeakReference != null))
          {
            localObject3 = (Activity)((andq)localObject2).jdField_a_of_type_JavaLangRefWeakReference.get();
            if (localObject3 != null)
            {
              ((Activity)localObject3).finish();
              if (((andq)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
              {
                anct.a("cs.close_room.local", "{}", false, null, ((andq)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                QLog.i("cmgame_process.CmGameUtil", 1, " launchGame close old  task.mStartCheckParam.gameId:" + ((andq)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
              }
            }
          }
          localandn.jdField_a_of_type_JavaUtilList.remove(0);
        }
        localObject2 = new HashMap();
        i = 0;
        for (;;)
        {
          if (i < localandn.jdField_a_of_type_JavaUtilList.size())
          {
            localObject3 = (andq)localandn.jdField_a_of_type_JavaUtilList.get(i);
            if ((localObject3 != null) && (((andq)localObject3).jdField_a_of_type_JavaLangString != null)) {
              ((HashMap)localObject2).put(((andq)localObject3).jdField_a_of_type_JavaLangString, ((andq)localObject3).jdField_a_of_type_JavaLangString);
            }
            i += 1;
            continue;
            i += 1;
        ...
        i = 0;
        if (i >= andn.jdField_a_of_type_ArrayOfJavaLangClass.length) {
          break label1483;
        }
        if (TextUtils.isEmpty((String)((HashMap)localObject2).get(andn.jdField_a_of_type_ArrayOfJavaLangClass[i].getSimpleName())))
        {
          localObject2 = andn.jdField_a_of_type_ArrayOfJavaLangClass[i];
      ...
      for (;;)
      {
        ...
        {
          localObject1 = andn.jdField_a_of_type_ArrayOfJavaLangClass[0];
          QLog.e("cmgame_process.CmGameUtil", 1, "can not find activityClass, use first class");
        }
        localObject2 = new andq();
        ((andq)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam = paramStartCheckParam;
        ((andq)localObject2).jdField_a_of_type_JavaLangString = ((Class)localObject1).getSimpleName();
        localandn.jdField_a_of_type_JavaUtilList.add(localObject2);
        for (;;)
        {
          if (QLog.isColorLevel())
          {
            localObject2 = localandn.jdField_a_of_type_JavaUtilList.iterator();
            for (;;)
            {
              if (((Iterator)localObject2).hasNext())
              {
                localObject3 = (andq)((Iterator)localObject2).next();
                QLog.d("cmgame_process.CmGameUtil", 2, "launchGame task:" + ((andq)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                continue;
                i += 1;
                break;
                ...
                {
                  andq localandq = (andq)localList.get(i);
                  boolean bool2 = false;
                  localObject3 = localObject1;
                  if (localandq != null)
                  {
                    localObject3 = localObject1;
                    if (localandq.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
                    {
                      localObject3 = localandn.a(localandq.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                      boolean bool1 = bool2;
                      localObject2 = localObject1;
                      if (localObject3 != null)
                      {
                        ansi localansi = ((ande)localObject3).a();
                        bool1 = bool2;
                        localObject2 = localObject1;
                        if (((ande)localObject3).a() == paramStartCheckParam.gameId) {
                          if (paramStartCheckParam.roomId != 0L)
                          {
                            bool1 = bool2;
                            localObject2 = localObject1;
                            if (paramStartCheckParam.roomId != localansi.jdField_a_of_type_Long) {}
                          }
                          else
                          {
                            bool2 = true;
                            bool1 = bool2;
                            localObject2 = localObject1;
                            if (((ande)localObject3).a() != null)
                            {
                              localObject2 = ((ande)localObject3).a().getClass();
                              bool1 = bool2;
                            }
                          }
                        }
                      ...
                      if (!bool1)
                      {
                        if (localandq.jdField_a_of_type_JavaLangRefWeakReference != null)
                        {
                          localObject1 = (Activity)localandq.jdField_a_of_type_JavaLangRefWeakReference.get();
                          if (localObject1 != null)
                          {
                            ((Activity)localObject1).finish();
                            if (localandq.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) {
                              anct.a("cs.close_room.local", "{}", false, null, localandq.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                            }
                            QLog.i("cmgame_process.CmGameUtil", 1, " launchGame close old  task.mStartCheckParam.gameId:" + localandq.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                          }
                        }
                        ((List)localObject4).add(localandq);
                        localObject3 = localObject2;
                      }
                    }
                  }
        ...
        for (;;)
        {
          ...
          localObject2 = andn.jdField_a_of_type_ArrayOfJavaLangClass[0];
          break;
  ...
  public static void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      localanen = a();
    } while (localanen == null);
    localanen.a(paramString1, paramString2, -1L, 4, false, null);
  }
  ...
  public static void a(Object... paramVarArgs)
  {
    amxt localamxt = a();
    if (localamxt != null) {
      localamxt.a("cmg_launch", 4, paramVarArgs);
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    ApolloGameData localApolloGameData = ((annx)localObject).a(paramStartCheckParam.gameId);
    amsx localamsx = (amsx)paramQQAppInterface.getManager(153);
    if (localamsx != null)
    {
      paramStartCheckParam.game = localApolloGameData;
      if ((localApolloGameData != null) && ((((annx)localObject).a(paramStartCheckParam.gameId)) || (paramStartCheckParam.isRequestConf))) {
        break label244;
      }
    }
    label244:
    for (boolean bool = true;; bool = false)
    {
      ...
      paramStartCheckParam.isWhiteUsr = localamsx.c((String)localObject);
      paramStartCheckParam.apolloStatus = localamsx.b((String)localObject);
      paramStartCheckParam.pushItem = localamsx.a().a();
      ...
      paramStartCheckParam.gender = ((axup)paramQQAppInterface.getManager(106)).b();
      paramStartCheckParam.isEnableMSAA = c(paramStartCheckParam.gameId);
      paramStartCheckParam.mIsTransGame = annu.c.contains(Integer.valueOf(paramStartCheckParam.gameId));
      return true;
    }
  }
  ...
  public static int b()
  {
    ...
    amsx localamsx = (amsx)a().getManager(153);
    if ((localamsx != null) && (localamsx.j())) {
      return 1;
    }
    return 0;
  }
  ...
  public static int b(int paramInt)
  {
    try
    {
      ...
      ((StringBuilder)localObject).append(annv.s).append(paramInt).append(File.separator).append("gameConfig.json");
      ...
      localObject = new JSONObject(bhmi.b((File)localObject)).optJSONArray("subpackages");
      if (localObject != null)
      {
  ...
  public static ande b(int paramInt1, int paramInt2)
  {
    andn localandn = a();
    if (localandn == null) {
      return null;
    }
    return localandn.b(paramInt1, paramInt2);
  }
  
  public static ande b(long paramLong)
  {
    andn localandn = a();
    if (localandn == null) {
      return null;
    }
    return localandn.a(paramLong);
  }
  ...
  public static String b(CmGameInitParams paramCmGameInitParams)
  {
    ...
    for (;;)
    {
      try
      {
        localJSONObject1 = anog.a(0, aniv.a);
        ...
        if (("1".equals(paramCmGameInitParams.mGameName)) || ("2".equals(paramCmGameInitParams.mGameName)))
        {
          ...
          if ((!ApolloGameStateMachine.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.getAndSet(false)) || (ApolloGameStateMachine.jdField_a_of_type_Amzd == null)) {
            break label999;
          }
          localJSONObject1.put("freeMemory", ApolloGameStateMachine.jdField_a_of_type_Amzd.jdField_b_of_type_Long);
          localJSONObject1.put("totalMemory", ApolloGameStateMachine.jdField_a_of_type_Amzd.jdField_c_of_type_Long);
          localJSONObject1.put("osVersion", amzd.jdField_a_of_type_JavaLangString);
          localJSONObject1.put("model", amzd.jdField_b_of_type_JavaLangString);
          localJSONObject1.put("cpuType", amzd.jdField_c_of_type_JavaLangString);
          localJSONObject1.put("cpuNumber", amzd.jdField_a_of_type_Int);
          localJSONObject1.put("cpuFrequency", amzd.jdField_a_of_type_Long);
          localJSONObject1.put("gameVersion", paramCmGameInitParams.mVersion);
          localJSONObject1.put("QQVer", "8.4.5.4745");
      ...
      localJSONObject1.put("connType", bhnv.a(BaseApplicationImpl.getContext()));
      ...
      continue;
      label999:
      localJSONObject1.put("freeMemory", bhlo.a(Process.myPid()));
      localJSONObject1.put("totalMemory", bhlo.f());
      localJSONObject1.put("osVersion", bhlo.e());
      localJSONObject1.put("model", bhlo.i());
      localJSONObject1.put("cpuType", bhlo.g());
      localJSONObject1.put("cpuNumber", bhlo.b());
      localJSONObject1.put("cpuFrequency", bhlo.a());
    }
  }
  ...
  public static void b()
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localObject = (amsx)a().getManager(153);
        if ((localObject != null) && (((amsx)localObject).k())) {
          ((amsx)localObject).a().b();
        }
        i = a();
      } while (-1 == i);
      localObject = anav.a().a(i);
    } while (localObject == null);
    ((andj)localObject).c();
  }
  ...
  public static boolean c(int paramInt)
  {
    ...
    try
    {
      ...
      int i = new JSONObject(bhmi.b((File)localObject)).optInt("enableMSAA");
  ...
  public static int e()
  {
    ...
    if (jdField_a_of_type_Float < 0.0F) {
      jdField_a_of_type_Float = (float)bhlo.a() / 1.0F / 1024.0F;
    }
    if (d < 0L) {
      d = Math.ceil(bhlo.d() / 1073741824.0D);
    }
    if (QLog.isColorLevel()) {
