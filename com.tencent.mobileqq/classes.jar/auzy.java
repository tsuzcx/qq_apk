...
public class auzy
{
  ...
  private final auzr jdField_a_of_type_Auzr;
  private final bjgv jdField_a_of_type_Bjgv;
  private final String jdField_a_of_type_JavaLangString;
  private ByteBuffer jdField_a_of_type_JavaNioByteBuffer;
  private final List<avaa> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public auzy(bjgv parambjgv, String paramString, auzr paramauzr)
  {
  ...
  private void b()
  {
    ...
    avaa localavaa;
    for (int i = 0; localIterator.hasNext(); i = avaa.b(localavaa) + i)
    {
      localavaa = (avaa)localIterator.next();
      avaa.a(localavaa, localBufferInfo, i);
      this.jdField_a_of_type_AndroidMediaMediaMuxer.writeSampleData(a(avaa.a(localavaa)), this.jdField_a_of_type_JavaNioByteBuffer, localBufferInfo);
    }
  ...
  public void a()
  {
    try
    {
      ...
      if (this.jdField_a_of_type_Bjgv.a())
      {
  ...
  public void a(int paramInt, ByteBuffer paramByteBuffer, MediaCodec.BufferInfo paramBufferInfo)
  {
    try
    {
      ...
      this.jdField_a_of_type_JavaUtilList.add(new avaa(paramInt, paramBufferInfo.size, paramBufferInfo, null));
      return;
    }
