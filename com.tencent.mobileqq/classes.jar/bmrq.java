...
public class bmrq
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, bmrs parambmrs)
  {
    paramQQAppInterface = a(paramQQAppInterface, paramString, new bmrr(parambmrs, paramString));
    if (!bhsr.a(paramQQAppInterface))
    {
      if (parambmrs != null)
      {
        ...
        parambmrs.a(0, new String[] { paramQQAppInterface });
      }
      return;
    }
