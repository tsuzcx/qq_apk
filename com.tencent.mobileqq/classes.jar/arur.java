  ...
  extends ImageSpan
{
  ...
  public arur(Context paramContext, int paramInt, String paramString)
  {
  ...
  public arur(Context paramContext, int paramInt1, String paramString, int paramInt2)
  {
  ...
  private void a(Drawable paramDrawable, int paramInt)
  {
    ...
    if ((afzb.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord)) || (bfyd.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord)))
    {
  ...
  public Drawable getDrawable()
  {
    if (this.jdField_a_of_type_JavaLangString != null)
    {
      ...
      for (localObject = this.jdField_a_of_type_ComTencentImageURLDrawable.getIntrinsicWidth() + "";; localObject = null)
      {
        ...
        this.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new arus(this));
        return this.jdField_a_of_type_ComTencentImageURLDrawable;
