...
import com.tencent.biz.pubaccount.readinjoy.video.playfeedback.ScreenCaptureHelper.captureViewLowApi.1;
...
public final class sjs
{
  ...
  static
  {
    jdField_a_of_type_Sju = new sju(null);
  }
  ...
  @RequiresApi(26)
  private final void a(Activity paramActivity, View paramView, float paramFloat, sjt paramsjt)
  {
    ...
    {
      localBitmap = Bitmap.createBitmap((int)(paramView.getWidth() * paramFloat), (int)(paramView.getHeight() * paramFloat), jdField_a_of_type_AndroidGraphicsBitmap$Config);
      arrayOfInt = new int[2];
      paramView.getLocationInWindow(arrayOfInt);
    }
    try
    {
      PixelCopy.request(paramActivity, new Rect(arrayOfInt[0], arrayOfInt[1], arrayOfInt[0] + paramView.getWidth(), arrayOfInt[1] + paramView.getHeight()), localBitmap, (PixelCopy.OnPixelCopyFinishedListener)new sjw(localBitmap, this, paramView, paramFloat, paramsjt), this.jdField_a_of_type_AndroidOsHandler);
      return;
    }
  ...
  private final void a(Bitmap paramBitmap, rtb paramrtb)
  {
    String str = bdzx.a.toString() + File.separator + bdsh.c(new StringBuilder().append("screen_capture").append(System.currentTimeMillis()).toString());
    rsk localrsk = new rsk(paramBitmap, str);
    localrsk.a((URLDrawable.DownloadListener)new sjx(this, str, paramrtb, paramBitmap));
    localrsk.a();
  }
  
  private final void a(Bitmap paramBitmap, sjt paramsjt)
  {
    int i;
    if (!paramBitmap.isRecycled())
    {
  ...
  private final void a(View paramView, boolean paramBoolean, float paramFloat, sjt paramsjt)
  {
    ThreadManager.getFileThreadHandler().post((Runnable)new ScreenCaptureHelper.captureViewLowApi.1(this, paramView, paramFloat, paramsjt));
  }
  
  private final void a(String paramString, rtb paramrtb)
  {
    ...
    paramString = (rtc)new rtf(localContext, (QQAppInterface)localAppRuntime, paramString);
    paramString.a(paramrtb);
    paramString.a();
  }
  ...
  private final boolean b(TextureView paramTextureView)
  {
    ...
    tmp9_5;
    paramTextureView.getLocationOnScreen(arrayOfInt);
    if ((arrayOfInt[0] < 0) || (arrayOfInt[0] > zby.a((Context)BaseApplicationImpl.getContext()))) {
      return false;
    }
    return (arrayOfInt[1] >= 0) && (arrayOfInt[1] <= zby.b((Context)BaseApplicationImpl.getContext()));
  }
  
  public final void a(@NotNull Activity paramActivity, boolean paramBoolean, float paramFloat, @Nullable rtb paramrtb)
  {
    Intrinsics.checkParameterIsNotNull(paramActivity, "activity");
    a(paramActivity, paramBoolean, paramFloat, (sjt)new sjv(this, paramrtb));
  }
  
  public final void a(@NotNull Activity paramActivity, boolean paramBoolean, float paramFloat, @Nullable sjt paramsjt)
  {
    Intrinsics.checkParameterIsNotNull(paramActivity, "activity");
    try
    {
      ...
      if (Build.VERSION.SDK_INT >= 26)
      {
        ...
        a(paramActivity, (View)localObject, paramFloat, paramsjt);
        return;
      }
      Intrinsics.checkExpressionValueIsNotNull(localObject, "captureView");
      a((View)localObject, paramBoolean, paramFloat, paramsjt);
      return;
    }
