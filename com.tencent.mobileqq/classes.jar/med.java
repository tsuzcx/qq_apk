...
public class med
  implements Runnable
{
  public med(VideoFeedsPlayManager paramVideoFeedsPlayManager) {}
  ...
  public void run()
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          do
          {
            ...
            if (localObject1 != null)
            {
              ...
              VideoFeedsPlayManager.a(this.a, new mee(this, (MessageForShortVideo)localObject2));
        ...
        ((ThirdVideoManager)localObject3).a(((VideoFeedsPlayManager.VideoPlayParam)localObject2).jdField_a_of_type_ComTencentBizPubaccountVideoInfo.jdField_a_of_type_JavaLangString, "PubAccountArticleCenter.GetUrlByVid", new mef(this, (VideoPlayerWrapper)localObject1, l, (ThirdVideoManager)localObject3));
        return;
