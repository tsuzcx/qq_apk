  ...
  implements awjg, Manager
{
  ...
  private awji jdField_a_of_type_Awji;
  private awjj jdField_a_of_type_Awjj;
  ...
  private awjd[] jdField_a_of_type_ArrayOfAwjd = new awjd[jdField_a_of_type_JavaUtilSet.size()];
  ...
  public awjh(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Awbw = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    this.jdField_a_of_type_Awjj = new awjj(paramQQAppInterface, this);
    this.jdField_a_of_type_Awjf = awjf.a();
    this.jdField_a_of_type_Awji = new awji(this);
  ...
  private PrecoverRetryInfo a(PrecoverResource paramPrecoverResource)
  {
    ...
    try
    {
      paramPrecoverResource = this.jdField_a_of_type_Awbw.a(PrecoverRetryInfo.class, false, "pk = ?", new String[] { paramPrecoverResource.businessId + "_" + paramPrecoverResource.md5 }, null, null, null, null);
  ...
  private void a(awbv paramawbv)
  {
    ...
    label37:
    for (Object localObject = "null";; localObject = paramawbv)
    {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("PrecoverManager", 2, new Object[] { "insertEntity, entity.Name=", paramawbv.getClass().getSimpleName() });
    }
    localObject = this.jdField_a_of_type_Awbw.a();
    try
    {
      ((awby)localObject).a();
    ...
    catch (Exception paramawbv)
    {
      if (QLog.isColorLevel())
      {
        QLog.d("PrecoverManager", 2, new Object[] { "insertEntity, exception=", paramawbv.getMessage() });
        paramawbv.printStackTrace();
      }
      return;
    }
    finally
  ...
  private boolean a(Class<? extends awbv> paramClass)
  {
    return a("delete_all", paramClass);
  }
  
  /* Error */
  private boolean a(String paramString, Class<? extends awbv> paramClass)
  {
    // Byte code:
    ...
    //   83: goto -70 -> 13
    //   86: aload_0
    //   87: getfield 82	awjh:jdField_a_of_type_Awbw	Lawbw;
    //   90: invokevirtual 241	awbw:a	()Lawby;
    //   93: astore_3
    //   94: aload_3
    //   95: invokevirtual 245	awby:a	()V
    //   98: aload_2
    ...
    //   154: aload_0
    //   155: getfield 82	awjh:jdField_a_of_type_Awbw	Lawbw;
    //   158: aload_1
    //   159: invokevirtual 298	awbw:b	(Ljava/lang/String;)Z
    //   162: pop
    //   163: aload_3
    //   164: invokevirtual 250	awby:c	()V
    //   167: aload_3
    //   168: invokevirtual 251	awby:b	()V
    //   171: iconst_1
    //   172: ireturn
    //   173: ldc_w 300
    //   176: iconst_2
    ...
    //   229: aload_3
    //   230: invokevirtual 251	awby:b	()V
    //   233: iconst_0
    //   234: ireturn
    //   235: astore_1
    //   236: aload_3
    //   237: invokevirtual 251	awby:b	()V
    //   240: aload_1
    //   241: athrow
    ...
    //   0	242	2	paramClass	Class<? extends awbv>
  ...
  private boolean b()
  {
    ...
    int i = this.jdField_a_of_type_Awjf.a;
    if (i == 2)
    {
      if (QLog.isColorLevel()) {
  ...
  public int a()
  {
    if (this.jdField_a_of_type_Awjf != null) {
      return this.jdField_a_of_type_Awjf.a;
    }
    return 0;
  }
  ...
  public awjf a()
  {
    return this.jdField_a_of_type_Awjf;
  }
  
  public awji a()
  {
    return this.jdField_a_of_type_Awji;
  }
  
  public awjj a()
  {
    return this.jdField_a_of_type_Awjj;
  }
  ...
  protected <T extends awbv> List<T> a(String paramString, String[] paramArrayOfString, Class<T> paramClass)
  {
    String str;
    if (QLog.isColorLevel())
    {
    ...
    {
      label123:
      paramString = this.jdField_a_of_type_Awbw.a(paramClass, false, paramString, paramArrayOfString, null, null, null, null);
      return paramString;
    }
  ...
  public void a(int paramInt, String paramString, PrecoverResource paramPrecoverResource, Object paramObject)
  {
    ...
    this.jdField_a_of_type_Awjj.b(this);
  ...
  protected void a(PrecoverResource paramPrecoverResource)
  {
    ...
    paramPrecoverResource = this.jdField_a_of_type_Awbw.a();
    try
    {
      paramPrecoverResource.a();
      this.jdField_a_of_type_Awbw.b(localPrecoverRetryInfo);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (???.hasNext())
        {
          ...
          localObject5 = awjn.a((String)((Pair)localObject4).second);
          if ((localObject5 == null) || (((Pair)localObject5).first == null) || (((Pair)localObject5).second == null)) {
            continue;
          }
          if (QLog.isColorLevel()) {
            QLog.d("PrecoverManager", 2, new Object[] { "onHandleConfigs, businessid=", ((awje)((Pair)localObject5).first).a, ", name=", ((awje)((Pair)localObject5).first).b, ", list.size=", Integer.valueOf(((List)((Pair)localObject5).second).size()) });
          }
          if (TextUtils.isEmpty(((awje)((Pair)localObject5).first).a)) {
            continue;
          }
          String str = ((awje)((Pair)localObject5).first).a;
  ...
  {
    boolean bool = awjn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + "_config_cover");
    if (QLog.isColorLevel()) {
      QLog.d("PrecoverManager", 2, new Object[] { "checkReportConfigCover, succ=", Boolean.valueOf(paramBoolean), ", need=", Boolean.valueOf(bool) });
    }
    if (bool)
    {
      awjn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + "_config_cover");
      this.jdField_a_of_type_Awji.a(paramBoolean);
    }
  }
  
  public boolean a()
  {
    boolean bool = awjn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "get_config_time");
    int j = awjn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "get_config_count", 0);
    if (bool)
    {
      awjn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "get_config_time");
      awjn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "get_config_count", 1);
      return true;
    }
    if (a() != null) {}
    ...
    awjn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "get_config_count", j + 1);
    return true;
  }
  ...
  protected boolean a(PrecoverResource paramPrecoverResource)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (localPrecoverRetryInfo.totalRetryCount <= this.jdField_a_of_type_Awjf.c) {
          break;
        }
      } while (!QLog.isColorLevel());
      ...
      if (localPrecoverRetryInfo.itemRetryCount < this.jdField_a_of_type_Awjf.b)
      {
        localPrecoverRetryInfo.itemRetryCount += 1;
        localPrecoverRetryInfo.totalRetryCount += 1;
        localPrecoverRetryInfo.retryUpdateTime = l;
