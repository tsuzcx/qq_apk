  ...
  extends awji
{
  ...
  public awjh(QQAppInterface paramQQAppInterface, awiz paramawiz)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Awiz = paramawiz;
  }
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    localObject2 = new awit(i, (String)localObject3);
    localObject3 = this.jdField_a_of_type_Awiz.a((awit)localObject2);
    ...
    if (localIterator.hasNext())
    {
      ...
      awir localawir1 = new awir(str, new LatLng(localUserData.lat.get(), localUserData.lon.get()), localUserData.direction.get());
      if ((localawir1.a().latitude == 0.0D) && (localawir1.a().longitude == 0.0D))
      {
        awir localawir2 = ((LocationRoom)localObject3).a(str);
        if (localawir2 != null)
        {
          localObject1 = "[filter]";
          localawir1.a(localawir2.a(), Double.valueOf(localawir2.a()));
          ((List)localObject4).add(localawir1);
          label590:
          if (!QLog.isColorLevel()) {
            break label794;
          }
    ...
    this.jdField_a_of_type_Awiz.a((awit)localObject2, paramObject, (List)localObject4);
  }
  ...
  protected void b(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Awiz.a(new awit(localInteger.intValue(), str), (LocationRoom.Venue)localObject, paramObject.intValue(), paramBoolean, i);
      if (paramBoolean)
      {
        if (QLog.isColorLevel()) {
          QLog.d("LocationObserver", 2, new Object[] { "[venue] onVenueOpt: invoked. success ", " uin: ", str, " uinType: ", localInteger, " optType: ", paramObject });
        }
        this.jdField_a_of_type_Awiz.a.a(localInteger.intValue(), str);
        return;
      }
  ...
  protected void c(boolean paramBoolean, Object paramObject)
  {
    ...
    paramObject = new awit(paramObject.intValue(), str);
    this.jdField_a_of_type_Awiz.a(paramObject, ((Integer)localObject).intValue());
  }
  ...
  protected void d(boolean paramBoolean, Object paramObject)
  {
    ...
    paramObject = new awit(paramObject.intValue(), (String)localObject);
    this.jdField_a_of_type_Awiz.b(paramObject, -1);
  }
  ...
  protected void e(boolean paramBoolean, Object paramObject)
  {
    ...
    case 2: 
    case 3: 
      awiw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject);
      return;
    }
    awiw.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject, i);
  }
  ...
  protected void f(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      awjn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject);
    }
    label80:
    do
    {
      ...
      if (i == 101)
      {
        awjn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramObject, i);
        return;
      }
      if (i == 102)
      {
  ...
  protected void g(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_Awiz.a.a(localInteger.intValue(), (String)localObject);
      this.jdField_a_of_type_Awiz.a.b(localInteger.intValue(), (String)localObject);
      if (QLog.isColorLevel()) {
      ...
      {
        this.jdField_a_of_type_Awiz.b(localInteger.intValue(), (String)localObject);
        bdla.b(null, "CliOper", "", "", "0X800A764", "0X800A764", 0, 0, "", "0", "0", "");
      }
      for (;;)
      {
        this.jdField_a_of_type_Awiz.a(false);
        return;
        if (paramObject.intValue() == 2)
        {
          this.jdField_a_of_type_Awiz.b(localInteger.intValue(), (String)localObject);
          if (this.jdField_a_of_type_Awiz.a()) {
            bdla.b(null, "CliOper", "", "", "0X800A76B", "0X800A76B", awiz.a(this.jdField_a_of_type_Awiz.a()), 0, "", "0", "0", "");
          }
        }
      }
    }
    ...
    awit localawit = new awit(localInteger.intValue(), (String)localObject);
    this.jdField_a_of_type_Awiz.a(localawit, true);
    this.jdField_a_of_type_Awiz.a(localawit, j, paramObject.intValue());
    int i = 0;
    if (j == 10101) {}
    for (i = 3;; i = 2) {
      do
      {
        this.jdField_a_of_type_Awiz.a(localInteger.intValue(), (String)localObject, this.jdField_a_of_type_Awiz.a(), i);
        return;
