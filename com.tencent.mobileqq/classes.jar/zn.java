...
public final class zn
{
  ...
  static
  {
    ...
    int[] arrayOfInt4 = { 6, 30, -1, -1, -1, -1, -1 };
    ...
    int[] arrayOfInt20 = { 6, 34, 62, 90, 118, -1, -1 };
    int[] arrayOfInt21 = { 6, 26, 50, 74, 98, 122, -1 };
    int[] arrayOfInt22 = { 6, 30, 54, 78, 102, 126, -1 };
    int[] arrayOfInt23 = { 6, 34, 60, 86, 112, 138, -1 };
    int[] arrayOfInt24 = { 6, 34, 62, 90, 118, 146, -1 };
    int[] arrayOfInt25 = { 6, 30, 54, 78, 102, 126, 150 };
    int[] arrayOfInt26 = { 6, 28, 54, 80, 106, 132, 158 };
    int[] arrayOfInt27 = { 6, 32, 58, 84, 110, 136, 162 };
    int[] arrayOfInt28 = { 6, 26, 54, 82, 110, 138, 166 };
    int[] arrayOfInt29 = { 6, 30, 58, 86, 114, 142, 170 };
    c = new int[][] { arrayOfInt1, arrayOfInt2, arrayOfInt3, { 6, 26, -1, -1, -1, -1, -1 }, arrayOfInt4, arrayOfInt5, arrayOfInt6, arrayOfInt7, { 6, 26, 46, -1, -1, -1, -1 }, arrayOfInt8, arrayOfInt9, arrayOfInt10, arrayOfInt11, arrayOfInt12, { 6, 26, 48, 70, -1, -1, -1 }, arrayOfInt13, arrayOfInt14, arrayOfInt15, { 6, 30, 58, 86, -1, -1, -1 }, arrayOfInt16, { 6, 28, 50, 72, 94, -1, -1 }, { 6, 26, 50, 74, 98, -1, -1 }, arrayOfInt17, arrayOfInt18, arrayOfInt19, { 6, 30, 58, 86, 114, -1, -1 }, arrayOfInt20, arrayOfInt21, arrayOfInt22, { 6, 26, 52, 78, 104, 130, -1 }, { 6, 30, 56, 82, 108, 134, -1 }, arrayOfInt23, { 6, 30, 58, 86, 114, 142, -1 }, arrayOfInt24, arrayOfInt25, { 6, 24, 50, 76, 102, 128, 154 }, arrayOfInt26, arrayOfInt27, arrayOfInt28, arrayOfInt29 };
    ...
    d = new int[][] { arrayOfInt1, { 8, 1 }, arrayOfInt2, arrayOfInt3, { 8, 4 }, arrayOfInt4, arrayOfInt5, arrayOfInt6, arrayOfInt7, { 5, 8 }, { 4, 8 }, arrayOfInt8, arrayOfInt9, arrayOfInt10, arrayOfInt11 };
  }
