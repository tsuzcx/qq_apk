...
public final class zn
{
  ...
  static
  {
    ...
    int[] arrayOfInt19 = { 6, 30, 56, 82, 108, 134, -1 };
    ...
    c = new int[][] { { -1, -1, -1, -1, -1, -1, -1 }, arrayOfInt1, arrayOfInt2, arrayOfInt3, { 6, 30, -1, -1, -1, -1, -1 }, arrayOfInt4, { 6, 22, 38, -1, -1, -1, -1 }, { 6, 24, 42, -1, -1, -1, -1 }, { 6, 26, 46, -1, -1, -1, -1 }, arrayOfInt5, arrayOfInt6, { 6, 32, 58, -1, -1, -1, -1 }, { 6, 34, 62, -1, -1, -1, -1 }, arrayOfInt7, { 6, 26, 48, 70, -1, -1, -1 }, arrayOfInt8, { 6, 30, 54, 78, -1, -1, -1 }, arrayOfInt9, { 6, 30, 58, 86, -1, -1, -1 }, { 6, 34, 62, 90, -1, -1, -1 }, arrayOfInt10, arrayOfInt11, arrayOfInt12, { 6, 28, 54, 80, 106, -1, -1 }, arrayOfInt13, arrayOfInt14, arrayOfInt15, arrayOfInt16, arrayOfInt17, arrayOfInt18, arrayOfInt19, { 6, 34, 60, 86, 112, 138, -1 }, arrayOfInt20, { 6, 34, 62, 90, 118, 146, -1 }, arrayOfInt21, arrayOfInt22, arrayOfInt23, arrayOfInt24, arrayOfInt25, { 6, 30, 58, 86, 114, 142, 170 } };
    arrayOfInt1 = new int[] { 8, 2 };
    arrayOfInt2 = new int[] { 8, 5 };
    arrayOfInt3 = new int[] { 7, 8 };
    arrayOfInt4 = new int[] { 2, 8 };
    arrayOfInt5 = new int[] { 1, 8 };
    d = new int[][] { { 8, 0 }, { 8, 1 }, arrayOfInt1, { 8, 3 }, { 8, 4 }, arrayOfInt2, { 8, 7 }, { 8, 8 }, arrayOfInt3, { 5, 8 }, { 4, 8 }, { 3, 8 }, arrayOfInt4, arrayOfInt5, { 0, 8 } };
  }
