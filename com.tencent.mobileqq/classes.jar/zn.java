...
public final class zn
{
  ...
  static
  {
    int[] arrayOfInt1 = { 6, 22, -1, -1, -1, -1, -1 };
    int[] arrayOfInt2 = { 6, 24, 42, -1, -1, -1, -1 };
    int[] arrayOfInt3 = { 6, 34, 62, -1, -1, -1, -1 };
    int[] arrayOfInt4 = { 6, 26, 48, 70, -1, -1, -1 };
    int[] arrayOfInt5 = { 6, 28, 54, 80, 106, -1, -1 };
    int[] arrayOfInt6 = { 6, 26, 52, 78, 104, 130, -1 };
    int[] arrayOfInt7 = { 6, 30, 58, 86, 114, 142, -1 };
    int[] arrayOfInt8 = { 6, 30, 54, 78, 102, 126, 150 };
    int[] arrayOfInt9 = { 6, 28, 54, 80, 106, 132, 158 };
    int[] arrayOfInt10 = { 6, 30, 58, 86, 114, 142, 170 };
    c = new int[][] { { -1, -1, -1, -1, -1, -1, -1 }, { 6, 18, -1, -1, -1, -1, -1 }, arrayOfInt1, { 6, 26, -1, -1, -1, -1, -1 }, { 6, 30, -1, -1, -1, -1, -1 }, { 6, 34, -1, -1, -1, -1, -1 }, { 6, 22, 38, -1, -1, -1, -1 }, arrayOfInt2, { 6, 26, 46, -1, -1, -1, -1 }, { 6, 28, 50, -1, -1, -1, -1 }, { 6, 30, 54, -1, -1, -1, -1 }, { 6, 32, 58, -1, -1, -1, -1 }, arrayOfInt3, { 6, 26, 46, 66, -1, -1, -1 }, arrayOfInt4, { 6, 26, 50, 74, -1, -1, -1 }, { 6, 30, 54, 78, -1, -1, -1 }, { 6, 30, 56, 82, -1, -1, -1 }, { 6, 30, 58, 86, -1, -1, -1 }, { 6, 34, 62, 90, -1, -1, -1 }, { 6, 28, 50, 72, 94, -1, -1 }, { 6, 26, 50, 74, 98, -1, -1 }, { 6, 30, 54, 78, 102, -1, -1 }, arrayOfInt5, { 6, 32, 58, 84, 110, -1, -1 }, { 6, 30, 58, 86, 114, -1, -1 }, { 6, 34, 62, 90, 118, -1, -1 }, { 6, 26, 50, 74, 98, 122, -1 }, { 6, 30, 54, 78, 102, 126, -1 }, arrayOfInt6, { 6, 30, 56, 82, 108, 134, -1 }, { 6, 34, 60, 86, 112, 138, -1 }, arrayOfInt7, { 6, 34, 62, 90, 118, 146, -1 }, arrayOfInt8, { 6, 24, 50, 76, 102, 128, 154 }, arrayOfInt9, { 6, 32, 58, 84, 110, 136, 162 }, { 6, 26, 54, 82, 110, 138, 166 }, arrayOfInt10 };
    arrayOfInt1 = new int[] { 8, 1 };
    arrayOfInt2 = new int[] { 8, 2 };
    arrayOfInt3 = new int[] { 8, 4 };
    arrayOfInt4 = new int[] { 7, 8 };
    arrayOfInt5 = new int[] { 5, 8 };
    d = new int[][] { { 8, 0 }, arrayOfInt1, arrayOfInt2, { 8, 3 }, arrayOfInt3, { 8, 5 }, { 8, 7 }, { 8, 8 }, arrayOfInt4, arrayOfInt5, { 4, 8 }, { 3, 8 }, { 2, 8 }, { 1, 8 }, { 0, 8 } };
  }
