  ...
  implements bkor
{
  ...
  public static bkor a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("cooperation.qqdataline.ipc.IDatalineService");
    if ((localIInterface != null) && ((localIInterface instanceof bkor))) {
      return (bkor)localIInterface;
    }
    return new bkot(paramIBinder);
  }
