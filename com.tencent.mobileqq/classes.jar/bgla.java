...
public class bgla
  extends bgix
{
  private bgkz jdField_a_of_type_Bgkz = new bgkz();
  private String jdField_a_of_type_JavaLangString = "";
  private bgkz jdField_b_of_type_Bgkz = new bgkz();
  ...
  {
    if (this.jdField_a_of_type_Bgkz != null) {
      this.jdField_a_of_type_Bgkz.b();
    }
  }
  
  private void b(String... paramVarArgs)
  {
    if (this.jdField_b_of_type_Bgkz != null) {
      this.jdField_b_of_type_Bgkz.b();
    }
  }
  ...
  private void c(String... paramVarArgs)
  {
    try
    {
      paramVarArgs = bcdu.d(new JSONObject(paramVarArgs[0]).optString("url"));
      paramVarArgs = a() + paramVarArgs + ".mp3";
      QLog.d("QzoneSoundPlugin", 2, "playLocalSound : " + paramVarArgs);
      if (new File(paramVarArgs).exists())
      {
        this.jdField_b_of_type_Bgkz.a(paramVarArgs);
        this.jdField_b_of_type_Bgkz.a();
      }
      return;
    }
  ...
  private void d(String... paramVarArgs)
  {
    try
    {
      ...
      if (new File(paramVarArgs).exists())
      {
        this.jdField_a_of_type_Bgkz.a(paramVarArgs);
        this.jdField_a_of_type_Bgkz.a();
      }
      return;
    }
    catch (Exception paramVarArgs) {}
  ...
  private void e(String... paramVarArgs)
  {
    if ((paramVarArgs != null) && (paramVarArgs.length > 0)) {
      try
      {
        ...
        localObject2 = bcdu.d(((JSONObject)localObject2).optString("url"));
        ...
        {
          DownloaderFactory.getInstance(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a()).getCommonDownloader().download((String)localObject1, this.jdField_b_of_type_JavaLangString, new bglb(this, paramVarArgs));
          return;
        }
        if (QLog.isColorLevel()) {
