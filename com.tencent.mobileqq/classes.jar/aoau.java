...
{
  public static int a;
  private static aoau jdField_a_of_type_Aoau;
  private Map<Integer, ArrayList<View>> jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  
  public static aoau a()
  {
    if (jdField_a_of_type_Aoau == null) {}
    try
    {
      if (jdField_a_of_type_Aoau == null) {
        jdField_a_of_type_Aoau = new aoau();
      }
      return jdField_a_of_type_Aoau;
    }
    finally {}
  }
