  ...
  implements ppu
{
  ...
  public pqk(Context paramContext, ArticleInfo paramArticleInfo1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean, int paramInt5, ArticleInfo paramArticleInfo2, sel paramsel)
  {
  ...
  public sel a()
  {
    return this.jdField_a_of_type_Sel;
  }
  ...
  public int b()
  {
    ...
    return this.jdField_a_of_type_Sel.getItemViewType(this.jdField_b_of_type_Int + 1);
  }
  ...
  public int c()
  {
    return qrc.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo);
  }
  ...
  public boolean g()
  {
    ...
    do
    {
      ...
      {
        return false;
      } while ((this.jdField_a_of_type_Int == 41403) || (pbd.a(this.jdField_a_of_type_Int)) || (bnrf.a(this.jdField_a_of_type_Int)));
      localBaseArticleInfo = this.jdField_a_of_type_Sel.a(this.jdField_a_of_type_Int);
    ...
    if (ozs.j(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo))
    {
  ...
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo == null) {}
    while ((!bnrf.a(this.d)) && ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mGroupId == -1L) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mGroupCount <= 0L) || ((c() != 1) && (c() != 2))) && (!qrc.b(a()))) {
      return false;
    }
    return true;
  }
