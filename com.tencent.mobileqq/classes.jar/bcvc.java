  ...
  implements bmqs, Manager
{
  ...
  private HashMap<Long, bcve> jdField_a_of_type_JavaUtilHashMap;
  ...
  public bcvc(QQAppInterface paramQQAppInterface)
  {
    ...
    d();
    a();
    this.jdField_a_of_type_Avce = new avce(paramQQAppInterface);
        ...
        if ((localObject != null) && (localObject.length > 0))
        {
          ...
          for (;;)
          {
            ...
            try
            {
              ...
              if (l > 0L)
              {
                bcve localbcve = new bcve(this);
                localbcve.jdField_a_of_type_Long = this.jdField_a_of_type_AndroidContentSharedPreferences.getLong("gc_unread" + str1 + "_" + str2, 0L);
                localbcve.jdField_a_of_type_Boolean = this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean("gc_newmsg" + str1 + "_" + str2, false);
                localbcve.jdField_b_of_type_Boolean = this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean("gc_redpoint" + str1 + "_" + str2, false);
                localbcve.c = this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean("gc_tab" + str1 + "_" + str2, false);
                localbcve.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidContentSharedPreferences.getString("gc_text" + str1 + "_" + str2, "");
                localbcve.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_AndroidContentSharedPreferences.getString("gc_icon" + str1 + "_" + str2, "");
                localbcve.jdField_a_of_type_Int = this.jdField_a_of_type_AndroidContentSharedPreferences.getInt("gc_type" + str1 + "_" + str2, -1);
                this.jdField_a_of_type_JavaUtilArrayList.add(Long.valueOf(l));
                this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(l), localbcve);
              }
            }
    ...
    if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilHashMap != null))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(Long.valueOf(l)))
        {
          ...
          {
            bcve localbcve = (bcve)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(l));
            localEditor.putLong("gc_unread" + str2 + "_" + l, localbcve.jdField_a_of_type_Long);
            localEditor.putBoolean("gc_newmsg" + str2 + "_" + l, localbcve.jdField_a_of_type_Boolean);
            localEditor.putBoolean("gc_redpoint" + str2 + "_" + l, localbcve.jdField_b_of_type_Boolean);
            localEditor.putBoolean("gc_tab" + str2 + "_" + l, localbcve.c);
            localEditor.putString("gc_text" + str2 + "_" + l, localbcve.jdField_a_of_type_JavaLangString);
            localEditor.putString("gc_icon" + str2 + "_" + l, localbcve.jdField_b_of_type_JavaLangString);
            localEditor.putInt("gc_type" + str2 + "_" + l, localbcve.jdField_a_of_type_Int);
            break;
          }
        }
      }
  ...
  public avce a()
  {
    return this.jdField_a_of_type_Avce;
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      if ((localBoolean == null) || (!localBoolean.booleanValue()))
      {
        ...
        jdField_a_of_type_ArrayOfByte = FileUtils.fileToBytes((File)localObject2);
  ...
  public void a(long paramLong1, boolean paramBoolean, long paramLong2)
  {
    ...
    {
      localObject = (bcve)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong1));
      ((bcve)localObject).jdField_a_of_type_Boolean = paramBoolean;
      ((bcve)localObject).jdField_a_of_type_Long = paramLong2;
      this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong1), localObject);
      e();
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), bcvf.class);
  ...
  public void a(String paramString, JSONArray paramJSONArray)
  {
    ...
    abuf.a(paramString, localJSONArray.toString());
  }
  ...
  public void a(JSONArray paramJSONArray)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        arrayOfString = abuf.a("APPOINTMENT_DOWNLOAD_LIST").split("\\|");
        i = 0;
        ...
        abuf.a("APPID_PKGNAME_" + str1, str2);
        if (bool)
        {
          abuf.c(str1, "APPOINTMENT_RES_LIST");
          abuf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "426", "202238", str1, "42601", "1", "116");
        }
      }
      ...
      for (j = 1;; j = 0)
      {
        ...
        abuf.c(str1, "APPOINTMENT_LIST");
        abuf.a(str1, paramJSONArray.get(i).toString(), "APPOINT_APPID_DETAIL_");
        abuf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "426", "202238", str1, "42601", "1", "116");
        break label282;
        j += 1;
        break;
  ...
  public void a(MsgBody paramMsgBody)
  {
    ...
    for (;;)
    {
      ...
      case 1: 
        c();
        abuf.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "426", "205581", "", "42601", "1", "116");
        return;
      case 2: 
        try
        {
      ...
      case 3: 
        try
        {
          ...
          paramMsgBody = new bcvd(this, i);
          if (i == 1)
          {
            abuv.a().a(paramMsgBody);
            return;
          }
        }
        catch (JSONException paramMsgBody)
        ...
        if (i == 2)
        {
          abuv.a().b(paramMsgBody);
          return;
        }
        if (i == 3)
        {
          abuv.a().c(paramMsgBody);
          return;
        }
        break;
      case 4: 
  ...
  public boolean a(long paramLong)
  {
    if (this.jdField_a_of_type_JavaUtilHashMap.containsKey(Long.valueOf(paramLong))) {
      return ((bcve)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Boolean;
    }
    return false;
  }
    ...
    if ((paramList != null) && (paramList.size() > 0))
    {
      ...
      if (m < paramList.size())
      {
        ...
        do
        {
          ...
          localbcve = (bcve)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(localPluginInfo.Id));
          if (QLog.isColorLevel()) {
            QLog.d("GameCenterManagerImp", 2, "setNewUnread.i=" + m + ",before unreaddata:" + localbcve.toString());
          }
          if (localPluginInfo.Count > 0L)
          {
            j = i;
            if (localbcve.jdField_a_of_type_Long != localPluginInfo.Count)
            {
              bool2 = true;
              bool1 = bool2;
              j = i;
            ...
            localbcve.jdField_a_of_type_Long = localPluginInfo.Count;
            localbcve.jdField_a_of_type_JavaLangString = localPluginInfo.Text;
            localbcve.jdField_a_of_type_Boolean = false;
            localbcve.jdField_b_of_type_Boolean = false;
            if (TextUtils.isEmpty(localbcve.jdField_a_of_type_JavaLangString))
            {
              localbcve.jdField_a_of_type_Int = 1;
              localbcve.c = localPluginInfo.Tab;
              bool2 = bool1;
            }
          }
          do
          {
            ...
            if (QLog.isColorLevel())
            {
              QLog.d("GameCenterManagerImp", 2, "setNewUnread.i=" + m + ",unreaddata:" + localbcve.toString());
              k = j;
              bool3 = bool2;
            }
            bool1 = bool3;
            i = k;
            break;
            localbcve.jdField_a_of_type_Int = 4;
            break label296;
            if (localPluginInfo.Flag)
            {
              if (localbcve.jdField_a_of_type_Long > 0L) {
                break;
              }
              j = i;
              if (!localbcve.jdField_a_of_type_Boolean)
              {
                bool2 = true;
                bool1 = bool2;
                j = i;
              ...
              localbcve.jdField_a_of_type_Boolean = localPluginInfo.Flag;
              localbcve.jdField_b_of_type_Boolean = false;
              localbcve.jdField_a_of_type_Long = 0L;
              localbcve.jdField_a_of_type_JavaLangString = localPluginInfo.Text;
              if (TextUtils.isEmpty(localbcve.jdField_a_of_type_JavaLangString)) {}
              for (localbcve.jdField_a_of_type_Int = 3;; localbcve.jdField_a_of_type_Int = 6)
              {
                localbcve.c = localPluginInfo.Tab;
                bool2 = bool1;
                break;
        ...
        } while ((localbcve.jdField_a_of_type_Long > 0L) || ((localPluginInfo.Id == 769L) && (localbcve.jdField_a_of_type_Boolean)));
        j = i;
        if (!localbcve.jdField_b_of_type_Boolean)
        {
          bool2 = true;
          bool1 = bool2;
          j = i;
        ...
        localbcve.jdField_b_of_type_Boolean = localPluginInfo.RedPoint;
        localbcve.jdField_a_of_type_Boolean = false;
        localbcve.jdField_a_of_type_Long = 0L;
        localbcve.jdField_a_of_type_JavaLangString = localPluginInfo.Text;
        localbcve.jdField_b_of_type_JavaLangString = localPluginInfo.PicUrl;
        if (TextUtils.isEmpty(localbcve.jdField_a_of_type_JavaLangString)) {
          if (TextUtils.isEmpty(localbcve.jdField_b_of_type_JavaLangString)) {
            localbcve.jdField_a_of_type_Int = 2;
          }
        }
        for (;;)
        {
          ...
          bool2 = bool1;
          break;
          localbcve.jdField_a_of_type_Int = 7;
          continue;
          localbcve.jdField_a_of_type_Int = 5;
        }
      }
      e();
      if (QLog.isColorLevel()) {
      ...
      if (i != -1)
      {
        paramList = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), bcvf.class);
  ...
  public void onCmdRsp(Intent paramIntent, String paramString, long paramLong, JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      abuf.a("APPOINTMENT_LASTGET_TIME", NetConnInfoCenter.getServerTime());
      abuf.a("APPOINTMENT_LOAD_GAP", paramJSONObject.optLong("load_gap"));
      abuf.a(paramJSONObject.optLong("res_valid") * 1000L);
