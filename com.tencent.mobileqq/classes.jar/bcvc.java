  ...
  extends BusinessHandler
{
  ...
  public bcvc(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_Boolean = bfyz.b(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentUin(), "tencent_docs_config_enable_assistant", false);
    this.jdField_b_of_type_Boolean = bfyz.b(paramQQAppInterface.getApp(), paramQQAppInterface.getCurrentUin(), "tencent_docs_config_preload_tool_process", false);
  }
  ...
  private String a(ReSendCmd paramReSendCmd)
  {
    ...
    {
      paramReSendCmd = localTicketManager.getSkey(this.mApp.getCurrentAccountUin(), 16L, new bcve(this, localTicketManager, paramReSendCmd));
  ...
  private String a(ReSendCmd paramReSendCmd, boolean paramBoolean)
  {
    ...
    if (localObject != null)
    {
      ...
      bcvd localbcvd = new bcvd(this, (TicketManager)localObject, paramReSendCmd);
      localObject = ((TicketManager)localObject).getPskey(str, 16L, new String[] { "docs.qq.com" }, localbcvd);
  ...
  public static String a(String paramString, bctv parambctv)
  {
    int j = 1;
    localObject2 = null;
    try
    {
      i = parambctv.jdField_a_of_type_Int;
      if (i != 0) {
        break label453;
      }
      i = 1;
    }
    catch (JSONException parambctv)
    {
      for (;;)
      {
        int i;
        ...
        if (QLog.isColorLevel()) {
          QLog.e("TeamWorkHandler", 2, parambctv, new Object[0]);
        }
        continue;
        paramString = null;
      }
    ...
    localJSONObject.put("url", URLEncoder.encode(parambctv.e));
    if (parambctv.j != null) {
      localJSONObject.put("title", URLEncoder.encode(parambctv.j));
    }
    ...
    if (parambctv.k == null)
    {
      ...
      localObject1 = new StringBuilder("https://docs.qq.com/cgi-bin/online_docs/wxqrcode").append('?').append("domainId=").append(parambctv.i).append("&padId=").append(parambctv.h).append("&dataType=");
      if (parambctv.jdField_b_of_type_Int != 3) {
        break label382;
      }
    }
    for (;;)
    {
      localObject1 = bcvf.a(paramString, j + "&page=" + "pages/shareFriend/shareFriend" + "&ac=" + "share" + "&t=" + "0" + "&policy=" + String.valueOf(i) + "&right_flag=" + "1" + "&param=" + localJSONObject.toString() + "&type=" + "1", "docs.qq.com");
      if (localObject1 == null) {
        break label448;
      }
      parambctv = new JSONObject((String)localObject1);
      paramString = parambctv;
      for (;;)
      {
        try
        {
          if (parambctv.optInt("retcode", -1) != 0)
          {
            parambctv.put("retcode", -1);
            paramString = parambctv;
            if (QLog.isColorLevel())
            {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("TeamWorkHandler", 2, parambctv.toString());
      }
      return (String)parambctv.opt("key");
      localObject1 = parambctv.k;
      break;
      j = 0;
    }
  }
    ...
    if (paramString1 != null)
    {
      ...
      if (localObject.length == 2)
      {
        ...
        try
        {
          ...
          paramString1 = bcvf.a(localStringBuilder2.toString(), paramString2, "https://docs.qq.com/cgi-bin/online_docs/doc_delete", "docs.qq.com", localStringBuilder1.toString(), (Map)localObject, false);
          return paramString1;
        }
  ...
  public static JSONObject a(String paramString1, String paramString2)
  {
    ...
    //   10: ldc_w 371
    //   13: invokevirtual 79	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   16: aload_0
    ...
    //   23: ldc 154
    //   25: invokestatic 283	bcvf:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   28: astore_3
    //   29: aload_3
    //   30: ifnull +150 -> 180
    //   33: new 198	org/json/JSONObject
    //   36: dup
    //   37: aload_3
    //   38: invokespecial 284	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   41: astore_1
    //   42: aload_1
    //   43: astore_0
    //   44: aload_1
    //   45: ldc_w 286
    //   48: iconst_m1
    //   49: invokevirtual 290	org/json/JSONObject:optInt	(Ljava/lang/String;I)I
    //   52: ifeq +48 -> 100
    //   55: aload_1
    //   56: ldc_w 286
    //   59: iconst_m1
    //   60: invokevirtual 222	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   63: pop
    //   64: aload_1
    //   65: astore_0
    //   66: invokestatic 294	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   69: ifeq +31 -> 100
    //   72: ldc 128
    //   74: iconst_2
    ...
    //   95: invokestatic 143	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   98: aload_1
    //   99: astore_0
    //   100: aload_0
    //   101: astore_1
    ...
    //   106: new 198	org/json/JSONObject
    //   109: dup
    //   110: invokespecial 199	org/json/JSONObject:<init>	()V
    //   113: astore_1
    //   114: aload_1
    //   115: ldc_w 286
    //   118: iconst_m1
    //   119: invokevirtual 222	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   122: pop
    //   123: invokestatic 294	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   126: ifeq +13 -> 139
    //   129: ldc 128
    //   131: iconst_2
    //   132: aload_1
    //   133: invokevirtual 276	org/json/JSONObject:toString	()Ljava/lang/String;
    //   136: invokestatic 299	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   139: aload_1
    //   140: areturn
    //   141: astore_1
    //   142: aload_2
    //   143: astore_0
    //   144: invokestatic 294	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   147: ifeq +14 -> 161
    //   150: ldc 128
    //   152: iconst_2
    //   153: aload_1
    //   154: iconst_0
    //   155: anewarray 307	java/lang/Object
    //   158: invokestatic 310	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   161: goto -61 -> 100
    //   164: astore_0
    //   165: aload_0
    //   166: invokevirtual 372	org/json/JSONException:printStackTrace	()V
    //   169: goto -46 -> 123
    //   172: astore_2
    //   173: aload_1
    //   174: astore_0
  ...
  public static JSONObject a(String paramString1, String paramString2, int paramInt, String paramString3, String paramString4, String paramString5)
  {
    ...
    //   31: aload_1
    //   32: ldc_w 381
    //   35: invokestatic 383	java/net/URLEncoder:encode	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    //   47: iload_2
    //   48: invokevirtual 253	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   51: ldc_w 387
    ...
    //   72: invokevirtual 88	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   75: ldc 154
    //   77: invokestatic 283	bcvf:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   80: astore_3
    //   81: aload_3
    //   82: ifnull +187 -> 269
    //   85: new 198	org/json/JSONObject
    //   88: dup
    //   89: aload_3
    //   90: invokespecial 284	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   93: astore_1
    //   94: aload_1
    //   95: astore_0
    //   96: aload_1
    //   97: ldc_w 286
    //   100: iconst_m1
    //   101: invokevirtual 290	org/json/JSONObject:optInt	(Ljava/lang/String;I)I
    //   104: ifeq +49 -> 153
    //   107: aload_1
    //   108: ldc_w 286
    //   111: iconst_m1
    //   112: invokevirtual 222	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   115: pop
    //   116: aload_1
    //   117: astore_0
    //   118: invokestatic 294	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   121: ifeq +32 -> 153
    //   124: ldc_w 391
    //   127: iconst_2
    //   128: new 74	java/lang/StringBuilder
    //   131: dup
    //   132: invokespecial 75	java/lang/StringBuilder:<init>	()V
    //   135: ldc_w 296
    ...
    //   145: invokevirtual 88	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   148: invokestatic 143	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   151: aload_1
    //   152: astore_0
    //   153: aload_0
    //   154: astore_1
    ...
    //   159: new 198	org/json/JSONObject
    //   162: dup
    //   163: invokespecial 199	org/json/JSONObject:<init>	()V
    //   166: astore_1
    //   167: aload_1
    //   168: ldc_w 286
    //   171: iconst_m1
    //   172: invokevirtual 222	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   175: pop
    //   176: invokestatic 294	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   179: ifeq +14 -> 193
    //   182: ldc_w 391
    //   185: iconst_2
    //   186: aload_1
    //   187: invokevirtual 276	org/json/JSONObject:toString	()Ljava/lang/String;
    //   190: invokestatic 299	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   193: aload_1
    //   194: areturn
    //   195: astore_1
    //   196: aload 6
    //   198: astore_0
    //   199: invokestatic 294	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   202: ifeq +15 -> 217
    //   205: ldc_w 391
    //   208: iconst_2
    //   209: aload_1
    //   210: iconst_0
    //   211: anewarray 307	java/lang/Object
    //   214: invokestatic 310	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   217: goto -64 -> 153
    //   220: astore_1
    //   221: aload 7
    //   223: astore_0
    //   224: invokestatic 294	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   227: ifeq +15 -> 242
    //   230: ldc_w 391
    //   233: iconst_2
    //   234: aload_1
    //   235: iconst_0
    //   236: anewarray 307	java/lang/Object
    //   239: invokestatic 310	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   242: goto -89 -> 153
    //   245: astore_0
    //   246: aload_0
    //   247: invokevirtual 372	org/json/JSONException:printStackTrace	()V
    //   250: goto -74 -> 176
    //   253: astore_3
    //   254: aload_1
    //   255: astore_0
  ...
  public static JSONObject a(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      String str = bcvf.b(paramJSONObject, paramString, "https://docs.qq.com/cgi-go/imp/import_form_cache", "docs.qq.com");
      if (str != null)
      {
  ...
  public static JSONObject a(JSONObject paramJSONObject, String paramString1, String paramString2)
  {
    try
    {
      paramString2 = bcvf.a(paramJSONObject, paramString1, "https://docs.qq.com/cgi-go/imp/import_form_file", paramString2);
  ...
  {
    paramString1 = bcvf.b("doc_url=" + URLEncoder.encode(paramString3), paramString1, "https://docs.qq.com/cgi-bin/online_docs/doc_content", "docs.qq.com");
  ...
  public static boolean a(String paramString, bctv parambctv)
  {
    Object localObject = UUID.randomUUID().toString().replaceAll("-", "");
    parambctv = new StringBuilder("https://docs.qq.com/cgi-bin/api/wechatshare/shareTips").append('?').append("domainId=").append(parambctv.i).append("&padId=").append(parambctv.h).append("&xsrf=").append((String)localObject);
    localObject = new StringBuilder().append("TOK=").append((String)localObject);
    try
    {
      paramString = bcvf.a(paramString, parambctv.toString(), "docs.qq.com", ((StringBuilder)localObject).toString());
      if (paramString != null)
      {
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3, boolean paramBoolean1, boolean paramBoolean2, int paramInt, List<String> paramList1, List<String> paramList2, List<String> paramList3)
  {
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      ...
      paramString1 = bcvf.a(paramString1, paramString2.toString(), "docs.qq.com", paramString3.toString());
      if (paramString1 == null) {
        break;
      }
  ...
  public static JSONObject b(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      String str = bcvf.b(paramJSONObject, paramString, "https://docs.qq.com/cgi-go/imp/import_form_url", "docs.qq.com");
      if (str != null)
      {
        paramJSONObject = new JSONObject(str);
        paramString = paramJSONObject;
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    try
    {
      ...
      if (j == 0)
      {
        ...
        QLog.i("TeamWorkHandler" + bctz.i, 2, " handleGetUserAuthDocsGrayTips  | policy=" + k + " privilege =" + m + " memberNum = " + n + " remainTime = " + i1 + " setTime= " + i);
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          QLog.i("TeamWorkHandler" + bctz.i, 2, " handleGetUserAuthDocsGrayTips ,result: " + j);
          return;
          bool = false;
          paramToServiceMsg = this.app.getApp().getString(2131718877);
          continue;
          bool = false;
    ...
    {
      QLog.e("TeamWorkHandler" + bctz.i, 1, " handleGetUserAuthDocsGrayTips exception = " + paramToServiceMsg.toString());
      return;
    }
    label425:
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          {
            bcef.b(null, "CliOper", "", "", "0X8009550", "0X8009550", 0, 0, "", "", "", "");
            break label309;
            notifyUI(9, bool, new Object[] { localDocsGrayTipsInfo, paramToServiceMsg, Long.valueOf(l) });
            if (!QLog.isColorLevel()) {
              break;
            }
            QLog.i("TeamWorkHandler" + bctz.i, 2, " handleSetUserAuthDocsGrayTips ,result: " + i);
          }
          else if ("2".equals(localDocsGrayTipsInfo.d))
          {
            bcef.b(null, "CliOper", "", "", "0X8009552", "0X8009552", 0, 0, "", "", "", "");
          }
        }
      }
      catch (Exception paramToServiceMsg)
      {
        QLog.e("TeamWorkHandler" + bctz.i, 1, " handleSetUserAuthDocsGrayTips  exception = " + paramToServiceMsg.toString());
        return;
      }
      boolean bool = false;
      paramToServiceMsg = localDocsGrayTipsInfo.k;
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    try
    {
      ...
      if (k == 0)
      {
        ...
        QLog.i("TeamWorkHandler" + bctz.i, 1, " handleGetGroupAuthDocsGrayTips  | policy = " + i + " userInfoList.size() = " + paramFromServiceMsg.size() + " totalMembers = " + n + " privilegeMembers = " + i1 + " privilege = " + i2 + " memberNum = " + i3 + " remainTime = " + m + " setTime = " + j + " docsGrayTipsInfo.policy = " + localDocsGrayTipsInfo.m + " docsGrayTipsInfo.privilege = " + localDocsGrayTipsInfo.n);
      ...
      for (;;)
      {
        QLog.i("TeamWorkHandler" + bctz.i, 1, " handleGetGroupAuthDocsGrayTips. result = " + k + ", isSuccess = " + bool);
        if (bool) {
          break;
        }
    ...
    {
      QLog.e("TeamWorkHandler" + bctz.i, 1, " handleGetGroupAuthDocsGrayTips exception = " + paramToServiceMsg.toString());
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          if ("1".equals(localDocsGrayTipsInfo.d))
          {
            bcef.b(null, "CliOper", "", "", "0X8009550", "0X8009550", 1, 0, "", "", "", "");
            break label303;
            QLog.i("TeamWorkHandler" + bctz.i, 1, " handleSetGroupAuthDocsGrayTips. result = " + i);
            notifyUI(11, bool, new Object[] { localDocsGrayTipsInfo, paramToServiceMsg, Long.valueOf(l) });
          }
          else if ("2".equals(localDocsGrayTipsInfo.d))
          {
            bcef.b(null, "CliOper", "", "", "0X8009552", "0X8009552", 1, 0, "", "", "", "");
          }
        }
      }
      catch (Exception paramToServiceMsg)
      {
        QLog.e("TeamWorkHandler" + bctz.i, 1, " handleSetGroupAuthDocsGrayTips  exception = " + paramToServiceMsg.toString());
        return;
      }
      boolean bool = false;
      paramToServiceMsg = localDocsGrayTipsInfo.k;
  ...
  public String a(String paramString1, String paramString2, String paramString3)
  {
    try
    {
      ...
      paramString1 = bcvf.a(paramString1, this.app.getCurrentAccountUin(), "https://docs.qq.com/cgi-bin/online_docs/tool_decryptuin", "docs.qq.com", paramString2, null, false);
      if (TextUtils.isEmpty(paramString1)) {
        return null;
      }
  ...
  public JSONObject a()
  {
    ...
    //   1: astore_1
    //   2: aload_0
    //   3: getfield 148	bcvc:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   6: invokevirtual 149	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   9: ldc_w 850
    //   12: ldc 154
    //   14: invokestatic 283	bcvf:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   17: astore_3
    //   18: aload_3
    //   19: ifnull +148 -> 167
    //   22: new 198	org/json/JSONObject
    //   25: dup
    //   26: aload_3
    //   27: invokespecial 284	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   30: astore_2
    //   31: aload_2
    //   32: astore_1
    //   33: aload_2
    //   34: ldc_w 286
    //   37: iconst_m1
    //   38: invokevirtual 290	org/json/JSONObject:optInt	(Ljava/lang/String;I)I
    //   41: ifeq +48 -> 89
    //   44: aload_2
    //   45: ldc_w 286
    //   48: iconst_m1
    //   49: invokevirtual 222	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   52: pop
    //   53: aload_2
    //   54: astore_1
    //   55: invokestatic 294	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   58: ifeq +31 -> 89
    //   61: ldc 128
    //   63: iconst_2
    //   64: new 74	java/lang/StringBuilder
    //   67: dup
    //   68: invokespecial 75	java/lang/StringBuilder:<init>	()V
    //   71: ldc_w 296
    ...
    //   84: invokestatic 143	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   87: aload_2
    //   88: astore_1
    //   89: aload_1
    //   90: astore_2
    //   91: aload_1
    //   92: ifnonnull +20 -> 112
    //   95: new 198	org/json/JSONObject
    //   98: dup
    //   99: invokespecial 199	org/json/JSONObject:<init>	()V
    //   102: astore_2
    //   103: aload_2
    //   104: ldc_w 286
    //   107: iconst_m1
    //   108: invokevirtual 222	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   111: pop
    ...
    //   120: iconst_2
    //   121: aload_2
    //   122: invokevirtual 276	org/json/JSONObject:toString	()Ljava/lang/String;
    //   125: invokestatic 299	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   128: aload_2
    //   129: areturn
    //   130: astore_2
    //   131: invokestatic 294	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   134: ifeq +14 -> 148
    //   137: ldc 128
    //   139: iconst_2
    //   140: aload_2
    //   141: iconst_0
    //   142: anewarray 307	java/lang/Object
    //   145: invokestatic 310	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   148: goto -59 -> 89
    //   151: astore_1
    //   152: aload_1
    //   153: invokevirtual 372	org/json/JSONException:printStackTrace	()V
    //   156: goto -44 -> 112
    //   159: astore_3
    //   160: aload_2
    //   161: astore_1
  ...
  public JSONObject a(String paramString)
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: invokestatic 325	java/util/UUID:randomUUID	()Ljava/util/UUID;
    //   5: invokevirtual 326	java/util/UUID:toString	()Ljava/lang/String;
    //   8: ldc_w 328
    //   11: ldc_w 330
    //   14: invokevirtual 333	java/lang/String:replaceAll	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   17: astore 4
    //   19: new 74	java/lang/StringBuilder
    //   22: dup
    //   23: ldc_w 853
    //   26: invokespecial 234	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   29: bipush 63
    //   31: invokevirtual 237	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    //   34: ldc_w 855
    //   37: invokevirtual 79	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   40: invokestatic 418	java/lang/System:currentTimeMillis	()J
    //   43: invokevirtual 858	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   46: ldc_w 343
    ...
    //   57: astore_2
    //   58: aload_1
    //   59: invokestatic 454	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   62: ifne +15 -> 77
    //   65: aload_2
    //   66: ldc_w 860
    //   69: invokevirtual 79	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    //   95: astore_1
    //   96: aload_0
    //   97: getfield 148	bcvc:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   100: invokevirtual 149	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   103: aload_2
    //   104: invokevirtual 88	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   107: ldc 154
    //   109: aload_1
    //   110: invokevirtual 88	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   113: invokestatic 485	bcvf:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   116: astore 4
    //   118: aload 4
    //   120: invokestatic 454	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   123: ifne +143 -> 266
    //   126: new 198	org/json/JSONObject
    //   129: dup
    //   130: aload 4
    //   132: invokespecial 284	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   135: astore_2
    //   136: aload_2
    //   137: astore_1
    //   138: aload_2
    //   139: ldc_w 286
    //   142: iconst_m1
    //   143: invokevirtual 290	org/json/JSONObject:optInt	(Ljava/lang/String;I)I
    //   146: ifeq +40 -> 186
    //   149: aload_2
    //   150: astore_1
    //   151: invokestatic 294	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   154: ifeq +32 -> 186
    //   157: ldc 128
    //   159: iconst_2
    ...
    //   181: invokestatic 143	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   184: aload_2
    //   185: astore_1
    //   186: aload_1
    //   187: astore_2
    ...
    //   192: new 198	org/json/JSONObject
    //   195: dup
    //   196: invokespecial 199	org/json/JSONObject:<init>	()V
    //   199: astore_2
    //   200: aload_2
    //   201: ldc_w 286
    //   204: iconst_m1
    //   205: invokevirtual 222	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   208: pop
    //   209: invokestatic 294	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   212: ifeq +13 -> 225
    //   215: ldc 128
    //   217: iconst_2
    //   218: aload_2
    //   219: invokevirtual 276	org/json/JSONObject:toString	()Ljava/lang/String;
    //   222: invokestatic 299	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   225: aload_2
    //   226: areturn
    //   227: astore_2
    //   228: aload_3
    //   229: astore_1
    //   230: invokestatic 294	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   233: ifeq +14 -> 247
    //   236: ldc 128
    //   238: iconst_2
    //   239: aload_2
    //   240: iconst_0
    //   241: anewarray 307	java/lang/Object
    //   244: invokestatic 310	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   247: goto -61 -> 186
    //   250: astore_1
    //   251: aload_1
    //   252: invokevirtual 372	org/json/JSONException:printStackTrace	()V
    //   255: goto -46 -> 209
    //   258: astore_3
    //   259: aload_2
    //   260: astore_1
  ...
  public JSONObject a(JSONObject paramJSONObject)
  {
    ...
    //   6: aconst_null
    //   7: areturn
    //   8: invokestatic 325	java/util/UUID:randomUUID	()Ljava/util/UUID;
    //   11: invokevirtual 326	java/util/UUID:toString	()Ljava/lang/String;
    //   14: ldc_w 328
    //   17: ldc_w 330
    //   20: invokevirtual 333	java/lang/String:replaceAll	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   23: astore 4
    //   25: new 74	java/lang/StringBuilder
    //   28: dup
    //   29: ldc_w 865
    //   32: invokespecial 234	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   35: bipush 63
    //   37: invokevirtual 237	java/lang/StringBuilder:append	(C)Ljava/lang/StringBuilder;
    //   40: ldc_w 855
    //   43: invokevirtual 79	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   46: invokestatic 418	java/lang/System:currentTimeMillis	()J
    //   49: invokevirtual 858	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   52: ldc_w 343
    //   55: invokevirtual 79	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   58: aload 4
    ...
    //   84: aload_1
    //   85: aload_0
    //   86: getfield 148	bcvc:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   89: invokevirtual 149	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   92: aload_2
    //   93: invokevirtual 88	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   96: ldc 154
    //   98: aload 4
    //   100: invokevirtual 88	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   103: invokestatic 868	bcvf:a	(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   106: astore 4
    //   108: aload 4
    //   110: ifnull +143 -> 253
    //   113: new 198	org/json/JSONObject
    //   116: dup
    //   117: aload 4
    //   119: invokespecial 284	org/json/JSONObject:<init>	(Ljava/lang/String;)V
    //   122: astore_2
    //   123: aload_2
    //   124: astore_1
    //   125: aload_2
    //   126: ldc_w 286
    //   129: iconst_m1
    //   130: invokevirtual 290	org/json/JSONObject:optInt	(Ljava/lang/String;I)I
    //   133: ifeq +40 -> 173
    //   136: aload_2
    //   137: astore_1
    //   138: invokestatic 294	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   141: ifeq +32 -> 173
    //   144: ldc 128
    //   146: iconst_2
    ...
    //   168: invokestatic 143	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   171: aload_2
    //   172: astore_1
    //   173: aload_1
    //   174: astore_2
    ...
    //   179: new 198	org/json/JSONObject
    //   182: dup
    //   183: invokespecial 199	org/json/JSONObject:<init>	()V
    //   186: astore_2
    //   187: aload_2
    //   188: ldc_w 286
    //   191: iconst_m1
    //   192: invokevirtual 222	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   195: pop
    //   196: invokestatic 294	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   199: ifeq +13 -> 212
    //   202: ldc 128
    //   204: iconst_2
    //   205: aload_2
    //   206: invokevirtual 276	org/json/JSONObject:toString	()Ljava/lang/String;
    //   209: invokestatic 299	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   212: aload_2
    //   213: areturn
    //   214: astore_2
    //   215: aload_3
    //   216: astore_1
    //   217: invokestatic 294	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   220: ifeq +14 -> 234
    //   223: ldc 128
    //   225: iconst_2
    //   226: aload_2
    //   227: iconst_0
    //   228: anewarray 307	java/lang/Object
    //   231: invokestatic 310	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/Throwable;[Ljava/lang/Object;)V
    //   234: goto -61 -> 173
    //   237: astore_1
    //   238: aload_1
    //   239: invokevirtual 372	org/json/JSONException:printStackTrace	()V
    //   242: goto -46 -> 196
    //   245: astore_3
    //   246: aload_2
    //   247: astore_1
  ...
  public void a(DocsGrayTipsInfo paramDocsGrayTipsInfo, int paramInt, long paramLong)
  {
    ...
    try
    {
      if (!NetworkUtil.isNetSupport(BaseApplicationImpl.getContext()))
      {
        ...
        for (paramDocsGrayTipsInfo = this.app.getApp().getString(2131694064);; paramDocsGrayTipsInfo = paramDocsGrayTipsInfo.l)
        {
  ...
  public void a(DocsGrayTipsInfo paramDocsGrayTipsInfo, long paramLong)
  {
    try
    {
      ...
      QLog.i("TeamWorkHandler" + bctz.i, 2, "get user auth | uin = " + paramDocsGrayTipsInfo.jdField_a_of_type_JavaLangString + " docUrl = " + paramDocsGrayTipsInfo.jdField_b_of_type_JavaLangString);
      return;
    }
    catch (Exception paramDocsGrayTipsInfo)
    {
      QLog.e("TeamWorkHandler" + bctz.i, 1, "get user auth exception = " + paramDocsGrayTipsInfo.toString());
    }
  }
  ...
  public void b(DocsGrayTipsInfo paramDocsGrayTipsInfo, int paramInt, long paramLong)
  {
    ...
    try
    {
      ...
      ((ToServiceMsg)localObject1).addAttribute("seq", Long.valueOf(paramLong));
      sendPbReq((ToServiceMsg)localObject1);
      QLog.i("TeamWorkHandler" + bctz.i, 1, "set group auth | uin = " + paramDocsGrayTipsInfo.jdField_a_of_type_JavaLangString + " docUrl = " + paramDocsGrayTipsInfo.jdField_b_of_type_JavaLangString + " setploicy = " + paramDocsGrayTipsInfo.h + " setonly= " + paramDocsGrayTipsInfo.i + " setprivilege=" + paramDocsGrayTipsInfo.g + " bNeedtime = " + paramDocsGrayTipsInfo.r + " settime=" + paramInt);
      return;
    }
    catch (Exception paramDocsGrayTipsInfo)
    {
      QLog.e("TeamWorkHandler" + bctz.i, 1, "set group auth exception = " + paramDocsGrayTipsInfo.toString());
    }
  }
  ...
  public void b(DocsGrayTipsInfo paramDocsGrayTipsInfo, long paramLong)
  {
    try
    {
      ...
      ((ToServiceMsg)localObject).addAttribute("seq", Long.valueOf(paramLong));
      sendPbReq((ToServiceMsg)localObject);
      QLog.i("TeamWorkHandler" + bctz.i, 1, "get group auth | uin = " + paramDocsGrayTipsInfo.jdField_a_of_type_JavaLangString + " docUrl = " + paramDocsGrayTipsInfo.jdField_b_of_type_JavaLangString + ", msgSeq = " + paramLong);
      return;
    }
    catch (Exception paramDocsGrayTipsInfo)
    {
      QLog.e("TeamWorkHandler" + bctz.i, 1, "get group auth exception = " + paramDocsGrayTipsInfo.toString());
    }
  }
