...
public class aoya
{
  public static azij a(Class<FTSMessage> paramClass, String paramString)
  {
    return new azij(a(paramString), paramClass, new String[] { paramString }, false, 1);
  }
  
  public static azij a(String[] paramArrayOfString1, String[] paramArrayOfString2, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2)
  {
    paramArrayOfString1 = new azij(a(paramArrayOfString1, paramArrayOfString2, paramBoolean1, paramBoolean2), paramClass, paramArrayOfString2, paramBoolean1, 1);
    paramArrayOfString1.jdField_b_of_type_Boolean = paramBoolean2;
    return paramArrayOfString1;
  }
  
  public static azij a(String[] paramArrayOfString1, String[] paramArrayOfString2, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    paramArrayOfString1 = new azij(a(paramArrayOfString1, paramArrayOfString2, paramBoolean1, paramBoolean2), paramClass, paramArrayOfString2, paramBoolean1, 1);
    paramArrayOfString1.jdField_b_of_type_Boolean = paramBoolean2;
  ...
  public static azij a(String[] paramArrayOfString1, String[] paramArrayOfString2, Class<? extends FTSEntity> paramClass, boolean paramBoolean1, boolean paramBoolean2, int paramInt, String paramString)
  {
    paramArrayOfString1 = new azij(a(paramArrayOfString1, paramArrayOfString2, paramBoolean1, paramBoolean2, paramInt, paramString), paramClass, paramArrayOfString2, paramBoolean1, 1);
    paramArrayOfString1.jdField_b_of_type_Boolean = paramBoolean2;
