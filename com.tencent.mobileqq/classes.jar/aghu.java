...
public class aghu
  extends bbqu
{
  public aghu(AvatarPendantActivity paramAvatarPendantActivity) {}
  ...
  protected void handlePendantAuth(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      if (this.a.jdField_a_of_type_Bbnp != null) {
        this.a.jdField_a_of_type_Bbnp.c = -1;
      }
      axqw.b(this.a.app, "CliOper", "", "", "0X8005FD4", "0X8005FD4", 0, 0, "", "", "", "");
      if ((this.a.jdField_a_of_type_Ailh != null) && (this.a.jdField_a_of_type_JavaUtilList != null))
      {
        paramObject = ((AvatarPendantManager)this.a.app.getManager(46)).a();
        this.a.jdField_a_of_type_Ailh.a(paramObject, this.a.jdField_a_of_type_JavaUtilList);
      }
    } while ((this.a.jdField_a_of_type_Bbno == null) || (!this.a.jdField_a_of_type_Bbno.jdField_a_of_type_Boolean));
    localObject = bbpp.a("linkPendantSet");
    paramObject = localObject;
    if (localObject != null) {
      paramObject = ((String)localObject).replace("[id]", String.valueOf(this.a.jdField_a_of_type_Bbno.jdField_a_of_type_Int));
    }
    ...
    axqw.b(this.a.app, "CliOper", "", "", "0X8006517", "0X8006517", 0, 0, "", "", "", "");
    return;
    this.a.jdField_a_of_type_AndroidWidgetButton.setText(2131719357);
    ...
    {
      axqw.b((QQAppInterface)localObject, "CliOper", "", "", "0X8005FD6", "0X8005FD6", 0, 0, paramObject, "", "", "");
      if (!this.a.d) {
        break;
      }
      this.a.d = false;
