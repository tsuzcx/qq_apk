  ...
  implements rzs
{
  ...
  private rle jdField_a_of_type_Rle = new rle();
  private rli jdField_a_of_type_Rli;
  private rwg jdField_a_of_type_Rwg;
  @Nullable
  ...
  public rwf(Context paramContext)
  {
    this(paramContext, "");
  }
  
  public rwf(Context paramContext, String paramString)
  {
  ...
  {
    if ((this.jdField_a_of_type_Sab != null) && ((this.jdField_a_of_type_Sab.a() instanceof ISPlayerVideoView)))
    {
      if (QLog.isColorLevel()) {
        QLog.d(this.jdField_b_of_type_JavaLangString, 2, "seamlessAttachVideoView: ");
      }
      SPSeamlessHelper.get().attachVideoView(paramViewGroup, (ISPlayerVideoView)this.jdField_a_of_type_Sab.a(), new ViewGroup.LayoutParams(-1, -1));
  ...
  private SuperPlayerOption a(boolean paramBoolean)
  {
    ...
    TCodecManager.getInstance().getReusePolicy().eraseType = rle.a.a();
    if (QLog.isColorLevel()) {
  ...
  private void a(sae paramsae)
  {
    if (paramsae != null)
    {
      paramsae.c(this.jdField_d_of_type_Boolean);
      paramsae.b(this.jdField_e_of_type_Boolean);
      paramsae.a(bnrf.f());
    }
  }
  ...
  private sab b()
  {
    ...
    return this.jdField_a_of_type_Rzv.a(this.jdField_a_of_type_AndroidContentContext, VersionUtils.isIceScreamSandwich());
  }
  ...
  private void b(String paramString1, String paramString2, int paramInt1, long paramLong1, long paramLong2, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString3)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_b_of_type_JavaLangString, 2, "#VideoPlayerWrapper# playerStartByUrl, url:" + paramString2 + ", fileSize:" + paramLong2 + ", videoDuration:" + paramInt2 + "，mState:" + rwe.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()));
    }
    if (!s())
    {
      QLog.e(this.jdField_b_of_type_JavaLangString, 1, "not idle or complete state, should't reopen mediaplayer, vid:" + paramString1 + "，mState:" + rwe.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()) + " ,mIsSeamlessPlay:" + this.jdField_h_of_type_Boolean);
      return;
    }
    n();
    if (paramBoolean2)
    {
      paramString2 = scq.a(paramString2);
      a(paramString2);
    }
    for (;;)
    {
      paramString1 = new sae(paramInt1, paramString1, paramString2);
      paramString1.a(paramBoolean3);
      paramString1.a(paramInt2 * 1000);
      paramString1.d(paramBoolean1);
      paramString1.b(paramString3);
      a(paramString1);
      if ((this.jdField_a_of_type_AndroidContentContext != null) && (this.jdField_a_of_type_Rzt != null)) {
        this.jdField_a_of_type_Rzt.a(this.jdField_a_of_type_AndroidContentContext, paramString1, paramLong1, a(paramBoolean3));
      }
  ...
  {
    this.jdField_a_of_type_Rzv = sac.a.a();
    if (this.jdField_a_of_type_AndroidContentContext != null)
    {
      if (QLog.isColorLevel()) {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (!this.jdField_h_of_type_Boolean)
      {
        this.jdField_f_of_type_Boolean = rxg.a().a();
        this.jdField_a_of_type_Rzt = this.jdField_a_of_type_Rzv.a(null);
      }
      this.jdField_a_of_type_Rzt.a(this);
  ...
  public long a()
  {
    ...
    return this.jdField_a_of_type_Rzt.b();
  }
  ...
  public View a()
  {
    if (this.jdField_a_of_type_Sab != null) {
      return this.jdField_a_of_type_Sab.a();
    }
    return null;
  }
  ...
  public sab a()
  {
    return this.jdField_a_of_type_Sab;
  }
  ...
  {
    if (this.jdField_a_of_type_Rzt != null) {
      this.jdField_a_of_type_Rzt.a(paramFloat);
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_Rzt != null) && (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) && (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 2) && (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 1) && (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 4) && (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 8))
    {
      ...
      this.jdField_a_of_type_Rzt.a(paramInt, 1);
  ...
  {
    if ((this.jdField_a_of_type_Rzt != null) && (paramInt1 > 0) && (paramInt2 > 0)) {
      this.jdField_a_of_type_Rzt.a(paramInt1, paramInt2, bnrf.f());
    }
  }
  ...
  public void a(ViewGroup paramViewGroup, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_Rzt != null) {}
    for (sab localsab = this.jdField_a_of_type_Rzt.a();; localsab = null)
    {
      int j;
      if ((paramBoolean1) && (this.jdField_h_of_type_Boolean) && (localsab != null))
      {
        j = 1;
        if (j == 0) {
          break label160;
        }
        this.jdField_a_of_type_Sab = localsab;
      }
      for (;;)
      {
        if ((paramViewGroup != null) && (this.jdField_a_of_type_Sab != null) && (this.jdField_a_of_type_Sab.a() != null))
        {
          if (j == 0) {
            break label168;
          }
      ...
      label168:
      paramViewGroup.addView(this.jdField_a_of_type_Sab.a(), new ViewGroup.LayoutParams(-1, -1));
      a(this.jdField_a_of_type_Sab);
      return;
    }
  }
  ...
  public void a(@Nullable String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((j != 1) || (this.jdField_a_of_type_Rwg == null)) {
          break label175;
        }
        this.jdField_a_of_type_Rwg.a(this, paramString);
      }
      ...
      if (this.jdField_a_of_type_Rwg != null) {
        this.jdField_a_of_type_Rwg.d(this);
      }
  ...
  public void a(String paramString, int paramInt, long paramLong, boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_b_of_type_JavaLangString, 2, "#VideoPlayerWrapper# playerStart, vid:" + paramString + ", playType:" + paramInt + ", startPosition:" + paramLong + "，mState:" + rwe.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()));
    }
    if (!s())
    {
      QLog.e(this.jdField_b_of_type_JavaLangString, 1, "not idle or complete state, should't reopen mediaplayer, vid:" + paramString + "，mState:" + rwe.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()) + ", mSeamlessPlay:" + this.jdField_h_of_type_Boolean);
      return;
    }
    n();
    paramString = new sae(paramInt, paramString);
    paramString.a(paramBoolean);
    paramString.a("cache_video");
    a(paramString);
    if ((this.jdField_a_of_type_AndroidContentContext != null) && (this.jdField_a_of_type_Rzt != null)) {
      this.jdField_a_of_type_Rzt.a(this.jdField_a_of_type_AndroidContentContext, paramString, paramLong, a(paramBoolean));
    }
    this.jdField_e_of_type_Long = 0L;
    this.jdField_d_of_type_Long = 0L;
  ...
  public void a(rwg paramrwg)
  {
    this.jdField_a_of_type_Rwg = paramrwg;
  }
  
  public void a(@NotNull rzt paramrzt)
  {
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_b_of_type_JavaLangString, 2, "[IPlayer] onVideoPrepared(): stremDumpInfo=" + paramrzt.a());
    }
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(2);
    if (this.jdField_a_of_type_Rwg != null) {
      this.jdField_a_of_type_Rwg.a(this, this.jdField_a_of_type_JavaLangObject);
    }
    if (this.jdField_a_of_type_Rzt != null) {
      this.jdField_d_of_type_Long = this.jdField_a_of_type_Rzt.a();
    }
    if ((this.jdField_b_of_type_Long > 0L) && (this.jdField_d_of_type_Long > 0L)) {
      this.jdField_a_of_type_Int = ((int)((float)this.jdField_b_of_type_Long / 1024.0F * 8.0F / ((float)this.jdField_d_of_type_Long / 1000.0F)));
    }
    ThreadManager.post(new VideoPlayerWrapper.1(this, paramrzt), 5, null, false);
  }
  
  public void a(@NotNull rzt paramrzt, int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_Rwg != null) {
      this.jdField_a_of_type_Rwg.a(this, false, paramInt2, paramInt1, null);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Rwg != null) {
      this.jdField_a_of_type_Rwg.a(this, true, 0, paramInt1, paramBitmap);
    }
  }
  ...
  public void a(sab paramsab)
  {
    ...
    this.jdField_a_of_type_Rzt.a(this.jdField_a_of_type_Sab);
    this.jdField_a_of_type_Rzt.a(this.jdField_d_of_type_Int);
  }
  ...
  public boolean a(String paramString)
  {
    ...
    this.jdField_a_of_type_Rzt = this.jdField_a_of_type_Rzv.a(paramString);
    if (this.jdField_a_of_type_Rzt != null)
    {
      this.i = false;
      this.jdField_a_of_type_Rzt.a(this);
  ...
  public boolean a(@NotNull rzt paramrzt, int paramInt1, int paramInt2, int paramInt3, @Nullable String paramString)
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(6);
    if (this.jdField_a_of_type_Rwg != null) {
      this.jdField_a_of_type_Rwg.a(this, paramInt2, paramInt3, paramInt1, paramString, null);
    }
    return false;
  }
  ...
  public boolean a(@NotNull rzt paramrzt, int paramInt, @Nullable Object paramObject)
  {
    ...
    {
      if (this.jdField_a_of_type_Rwg != null) {
        this.jdField_a_of_type_Rwg.a(this, paramInt, paramObject);
      }
      return false;
      if (QLog.isColorLevel()) {
      ...
      if (!this.jdField_c_of_type_Boolean)
      {
        ...
        {
          paramrzt = (TPPlayerMsg.TPMediaCodecInfo)paramObject;
          this.jdField_a_of_type_Rle.a(paramrzt);
        }
        bkdz.c(new VideoPlayerWrapper.2(this));
        continue;
        if (this.jdField_a_of_type_Rwg != null) {
          this.jdField_a_of_type_Rwg.a(this, "");
        }
      }
    }
  }
  ...
  public long b()
  {
    ...
    if (this.jdField_a_of_type_Rzt != null) {
      return this.jdField_a_of_type_Rzt.a();
    }
    return -1L;
  }
  ...
  public View b()
  {
    ...
    View localView = this.jdField_a_of_type_Sab.a();
  ...
  public void b(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Rzt != null) {
      this.jdField_a_of_type_Rzt.a(paramInt);
    }
    if (QLog.isColorLevel()) {
  ...
  public void b(@NotNull rzt paramrzt)
  {
    if (QLog.isColorLevel()) {
    ...
    if (this.jdField_a_of_type_Rwg != null) {
      this.jdField_a_of_type_Rwg.b(this);
    }
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Rzt != null) {
        ThreadManager.executeOnSubThread(new VideoPlayerWrapper.3(this, this.jdField_a_of_type_Rzt));
      }
      if ((paramBoolean) && (this.jdField_a_of_type_Sab != null) && (this.jdField_a_of_type_Sab.a() != null))
      {
        ViewParent localViewParent = this.jdField_a_of_type_Sab.a().getParent();
        if ((localViewParent instanceof ViewGroup)) {
          ((ViewGroup)localViewParent).removeView(this.jdField_a_of_type_Sab.a());
        }
      }
      this.jdField_a_of_type_Rwg = null;
  ...
  public void c(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Rzt != null) {
      this.jdField_a_of_type_Rzt.a(paramBoolean);
    }
  }
  ...
  public void d()
  {
    ...
    do
    {
      ...
      if (!k())
      {
        QLog.e(this.jdField_b_of_type_JavaLangString, 1, "VideoPlayerWrapper: start failed, wrong state:" + rwe.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()) + ", just return;");
        return;
      }
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(3);
  ...
  public void d(boolean paramBoolean)
  {
    ...
    while ((this.jdField_a_of_type_Rzt == null) || (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() == 6) || (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() == 8)) {
      return;
    }
    this.jdField_a_of_type_Rzt.b(paramBoolean);
  }
  ...
  public void f()
  {
    ...
    {
      if (!k()) {
        QLog.e(this.jdField_b_of_type_JavaLangString, 1, "VideoPlayerWrapper: pause failed, wrong state:" + rwe.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()) + ", just return;");
      }
    }
    else {
      return;
  ...
  public int g()
  {
    if ((this.jdField_a_of_type_Rzt != null) && (this.jdField_b_of_type_Long != 0L)) {
  ...
  public void o()
  {
    ...
    this.i = true;
    if (this.jdField_a_of_type_Rzt != null) {
      this.jdField_a_of_type_Rzt.a(null);
    }
    this.jdField_d_of_type_JavaLangString = c();
    this.jdField_a_of_type_Rzt = null;
  }
