...
public class abfg
{
  ...
  private boolean jdField_a_of_type_Boolean = abet.a("gamecenter_shot_switch");
  private boolean b;
  ...
  private void a(Context paramContext, String paramString, abfi paramabfi)
  {
    if (FileUtil.isFileExists(jdField_b_of_type_JavaLangString + paramString)) {
      ThreadManagerV2.executeOnFileThread(new ScreenshotManager.1(this, paramString, paramabfi));
    }
  }
  ...
  public void a(abfi paramabfi)
  {
    if (FileUtil.deleteFile(jdField_a_of_type_JavaLangString))
    {
      paramabfi.a(0, "delShotFile succ");
      return;
    }
    paramabfi.a(-500, "delShotFile fail");
  }
  ...
  public void a(WebView paramWebView, abfi paramabfi)
  {
    if (!a(paramabfi)) {
      return;
    }
    ...
    {
      paramabfi.a(0, "removeShotMask no visible");
      return;
    }
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(4);
      paramabfi.a(0, "removeShotMask succ");
      return;
    }
    catch (Throwable paramWebView)
    {
      paramabfi.a(-400, "removeShotMask fail");
    }
  }
  
  public void a(WebView paramWebView, String paramString, abfi paramabfi)
  {
    if (!a(paramabfi)) {
      return;
    }
    ...
    ThreadManagerV2.executeOnSubThread(new ScreenshotManager.2(this, paramString, paramabfi));
  }
  
  public void a(String paramString, abfi paramabfi)
  {
    try
    {
      JSONObject localJSONObject = new JSONObject();
      localJSONObject.put("switch", abet.a("gamecenter_shot_switch"));
      localJSONObject.put("fileExist", FileUtil.isFileExists(jdField_a_of_type_JavaLangString + paramString));
      paramabfi.a(0, localJSONObject.toString());
      return;
    }
    catch (Exception paramString)
    {
      paramabfi.a(-700, "queryShotInfo error");
    }
  }
  ...
  public boolean a(abfi paramabfi)
  {
    if (!abet.a("gamecenter_shot_switch"))
    {
      if (paramabfi != null) {
        paramabfi.a(-1, "shot switch is false");
      }
      return false;
    }
    return true;
  ...
  public boolean a(Bitmap paramBitmap, String paramString)
  {
    if (paramBitmap != null) {
      try
      {
        ...
        ypi.a(jdField_a_of_type_JavaLangString);
  ...
  public void b(abfi paramabfi)
  {
    QLog.i("ScreenshotManager", 1, "closeShot");
    if (abet.a("gamecenter_shot_switch", false))
    {
      this.jdField_a_of_type_Boolean = false;
      paramabfi.a(0, "closeShot succ");
      return;
    }
    paramabfi.a(-600, "closeShot fail");
  }
  
  public void b(WebView paramWebView, String paramString, abfi paramabfi)
  {
    if (!a(paramabfi)) {
      return;
    }
    ...
    {
      paramabfi.a(-300, "preloadMask not init");
      a(paramWebView.getContext(), paramString, paramabfi);
    ...
    catch (Throwable paramWebView)
    {
      ...
      paramabfi.a(-301, "add view error");
    }
  }
  
  public void c(abfi paramabfi)
  {
    QLog.i("ScreenshotManager", 1, "open");
    if (abet.a("gamecenter_shot_switch", true))
    {
      this.jdField_a_of_type_Boolean = true;
      paramabfi.a(0, "openShot succ");
      return;
    }
    paramabfi.a(-600, "openShot fail");
  }
}
