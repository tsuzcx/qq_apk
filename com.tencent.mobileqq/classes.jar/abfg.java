...
public class abfg
  implements abfh
{
  private abfi jdField_a_of_type_Abfi;
  private SQLiteDatabase jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase;
  public String a;
  private SQLiteDatabase b;
  
  public abfg(Context paramContext, String paramString)
  {
    if (!TextUtils.isEmpty(paramString)) {
      this.jdField_a_of_type_JavaLangString = paramString;
    }
    this.jdField_a_of_type_Abfi = new abfi(paramContext, "config_db" + paramString, null, 15);
  }
  ...
  public int a(Uri paramUri, String paramString, ContentValues[] paramArrayOfContentValues)
  {
    ...
    //   17: lstore 7
    //   19: aload_0
    //   20: getfield 51	abfg:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    ...
    //   44: astore 11
    //   46: aload_0
    //   47: getfield 51	abfg:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   50: aload_2
    //   51: ldc 75
    //   53: aload 11
    ...
    //   59: lcmp
    //   60: ifgt +73 -> 133
    //   63: new 64	android/database/SQLException
    //   66: dup
    ...
    //   79: aload_1
    //   80: invokevirtual 84	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   83: invokevirtual 39	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   86: invokespecial 87	android/database/SQLException:<init>	(Ljava/lang/String;)V
    //   89: athrow
    //   90: astore_1
    //   91: ldc 89
    //   93: iconst_1
    ...
    //   106: aload_1
    //   107: invokevirtual 94	android/database/SQLException:getMessage	()Ljava/lang/String;
    //   110: invokevirtual 35	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   113: invokevirtual 39	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   116: invokestatic 100	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   119: aload_0
    //   120: getfield 51	abfg:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   123: invokevirtual 103	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   126: aload_0
    //   127: invokevirtual 61	abfg:a	()V
    //   130: iload 4
    //   132: ireturn
    //   133: iload 5
    //   135: iconst_1
    ...
    //   145: goto -112 -> 33
    //   148: aload_0
    //   149: getfield 51	abfg:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   152: invokevirtual 106	android/database/sqlite/SQLiteDatabase:setTransactionSuccessful	()V
    ...
    //   181: aload_1
    //   182: invokevirtual 84	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   185: ldc 113
    //   187: invokevirtual 35	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   190: lload 9
    //   192: lload 7
    //   194: lsub
    //   195: invokevirtual 116	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   198: ldc 118
    ...
    //   208: invokevirtual 39	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   211: invokestatic 124	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   214: aload_0
    //   215: getfield 51	abfg:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   218: invokevirtual 103	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   221: goto -95 -> 126
    //   224: astore_1
    //   225: aload_0
    //   226: getfield 51	abfg:jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase	Landroid/database/sqlite/SQLiteDatabase;
    //   229: invokevirtual 103	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   232: aload_1
    //   233: athrow
    //   234: astore_1
    //   235: goto -144 -> 91
  ...
  public boolean a()
  {
    ...
    try
    {
      this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase = this.jdField_a_of_type_Abfi.getWritableDatabase();
      if (this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase != null)
      {
        bool1 = bool2;
        if (this.jdField_a_of_type_AndroidDatabaseSqliteSQLiteDatabase.isOpen()) {}
  ...
  public boolean b()
  {
    ...
    try
    {
      this.jdField_b_of_type_AndroidDatabaseSqliteSQLiteDatabase = this.jdField_a_of_type_Abfi.getReadableDatabase();
      if (this.jdField_b_of_type_AndroidDatabaseSqliteSQLiteDatabase != null)
      {
        bool1 = bool2;
        if (this.jdField_b_of_type_AndroidDatabaseSqliteSQLiteDatabase.isOpen()) {}
