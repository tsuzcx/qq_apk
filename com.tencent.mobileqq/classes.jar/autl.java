...
{
  public autl(ForwardSdkBaseOption paramForwardSdkBaseOption) {}
    ...
    synchronized (ForwardSdkBaseOption.jdField_a_of_type_JavaLangObject)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          this.a.jdField_a_of_type_Aupn = aupn.a(paramBundle);
          if ((this.a instanceof ForwardSdkShareOption)) {
            ((auuc)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.SDK_SHARE)).a().a(this.a.b, this.a.jdField_a_of_type_Aupn);
          }
