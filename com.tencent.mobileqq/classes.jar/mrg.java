...
public class mrg
{
  ...
  public mrg(mrg parammrg, long paramLong)
  {
    this.o = paramLong;
    this.jdField_a_of_type_Mrg = parammrg;
  }
  ...
  {
    float f2 = 0.0F;
    for (mrg localmrg = this.jdField_a_of_type_Mrg; (localmrg != null) && (!localmrg.jdField_a_of_type_Boolean); localmrg = localmrg.jdField_a_of_type_Mrg) {
      localmrg.jdField_b_of_type_Boolean = true;
    }
    this.jdField_a_of_type_Mrg = localmrg;
    if (localmrg != null)
    {
      if (localmrg.jdField_a_of_type_Long != 0L) {
        this.jdField_b_of_type_Long = (this.jdField_a_of_type_Long - localmrg.jdField_a_of_type_Long);
      }
      if (localmrg.k != 0L) {
        this.l = (this.k - localmrg.k);
      }
    }
    if (localmrg == null)
    {
    ...
    label137:
    for (float f1 = f2;; f1 = localmrg.jdField_b_of_type_Float)
    {
      this.jdField_b_of_type_Float = a(f1, this.l / 1000L);
      return;
      f1 = localmrg.jdField_a_of_type_Float;
      break;
    }
  }
  ...
  boolean c()
  {
    ...
    mrg localmrg = this.jdField_a_of_type_Mrg;
    if (localmrg != null)
    {
      if ((localmrg.jdField_b_of_type_Int != this.jdField_b_of_type_Int) || (localmrg.jdField_c_of_type_Int != this.jdField_c_of_type_Int) || (localmrg.jdField_d_of_type_Int != this.jdField_d_of_type_Int) || (localmrg.jdField_e_of_type_Int != this.jdField_e_of_type_Int) || (localmrg.jdField_f_of_type_Int != this.jdField_f_of_type_Int) || (localmrg.jdField_g_of_type_Int != this.jdField_g_of_type_Int) || (localmrg.n != this.n) || (localmrg.jdField_c_of_type_Boolean != this.jdField_c_of_type_Boolean) || (localmrg.jdField_d_of_type_Boolean != this.jdField_d_of_type_Boolean) || (localmrg.jdField_h_of_type_Int != this.jdField_h_of_type_Int) || (localmrg.jdField_a_of_type_Int != this.jdField_a_of_type_Int) || (localmrg.o + 1L != this.o))
      {
        m = System.currentTimeMillis();
        return true;
      }
