...
public class amxz
  implements Manager
{
  private static final LinkedList<amyb> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  private static volatile boolean jdField_c_of_type_Boolean;
  private int jdField_a_of_type_Int = 50;
  private amyb jdField_a_of_type_Amyb;
  ...
  public amxz(QQAppInterface paramQQAppInterface)
  {
  ...
  private static void a(amyb paramamyb)
  {
    LinkedList localLinkedList = jdField_a_of_type_JavaUtilLinkedList;
    if (paramamyb != null) {}
    try
    {
      jdField_a_of_type_JavaUtilLinkedList.add(paramamyb);
      return;
    }
    finally {}
  }
  ...
  private static boolean b(amyb paramamyb)
  {
    localLinkedList = jdField_a_of_type_JavaUtilLinkedList;
    if (paramamyb != null) {}
    try
    {
      boolean bool = jdField_a_of_type_JavaUtilLinkedList.remove(paramamyb);
      return bool;
    }
    finally {}
    return false;
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Amyb = new amya(this);
    a(this.jdField_a_of_type_Amyb);
  ...
  public List<PublicAccountInfo> a(List<PublicAccountInfo> paramList, long paramLong)
  {
    ...
    //   15: areturn
    //   16: aload_0
    //   17: getfield 185	amxz:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   20: ifnonnull +14 -> 34
    //   23: aload_0
    //   24: new 187	java/util/concurrent/ConcurrentHashMap
    //   27: dup
    //   28: invokespecial 230	java/util/concurrent/ConcurrentHashMap:<init>	()V
    //   31: putfield 185	amxz:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   34: aconst_null
    //   35: astore 4
    //   37: aload_0
    //   38: getfield 67	amxz:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    ...
    //   95: aload_0
    //   96: aload 5
    //   98: invokevirtual 249	amxz:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   101: pop
    //   102: aload_0
    //   103: getfield 185	amxz:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   106: aload 5
    ...
    //   126: aload_0
    //   127: invokevirtual 254	amxz:c	()V
    //   130: aload 6
    //   132: areturn
    //   133: aload_0
    //   134: getfield 185	amxz:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    ...
    //   199: aload_0
    //   200: getfield 67	amxz:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   203: aload 5
  ...
  public List<PublicAccountInfo> a(List<PublicAccountInfo> paramList, long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 185	amxz:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   4: ifnonnull +28 -> 32
    //   7: aload_1
    //   8: ifnull +140 -> 148
    //   11: aload_1
    ...
    //   29: putfield 185	amxz:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    ...
    //   42: astore 7
    //   44: aload_0
    //   45: getfield 67	amxz:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    ...
    //   102: aload_0
    //   103: aload 8
    //   105: invokevirtual 249	amxz:a	(Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   108: pop
    //   109: aload 8
    //   111: invokevirtual 276	com/tencent/mobileqq/data/PublicAccountInfo:isNeedShow	()Z
    //   114: ifeq +40 -> 154
    //   117: aload_0
    //   118: getfield 185	amxz:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   121: aload 8
    ...
    //   141: aload_0
    //   142: invokevirtual 254	amxz:c	()V
    //   145: aload 9
    //   147: areturn
    //   148: iconst_0
    //   149: istore 6
    //   151: goto -132 -> 19
    //   154: aload_0
    //   155: getfield 185	amxz:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   158: aload 8
    ...
    //   203: ifeq +91 -> 294
    //   206: aload_0
    //   207: getfield 185	amxz:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    ...
    //   271: aload_0
    //   272: getfield 67	amxz:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   275: aload 8
  ...
  public void a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 284	amxz:jdField_a_of_type_Boolean	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifeq +6 -> 14
    //   11: aload_0
    ...
    //   13: return
    //   14: aload_0
    //   15: invokevirtual 286	amxz:d	()V
    //   18: aload_0
    //   19: invokevirtual 254	amxz:c	()V
    //   22: aload_0
    //   23: invokevirtual 289	amxz:f	()V
    //   26: aload_0
    //   27: invokevirtual 292	amxz:e	()V
    //   30: aload_0
    //   31: iconst_1
    //   32: putfield 284	amxz:jdField_a_of_type_Boolean	Z
    //   35: invokestatic 297	uda:a	()Luda;
    //   38: aload_0
    //   39: getfield 69	amxz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   42: aload_0
    //   43: invokevirtual 299	amxz:a	()Ljava/util/List;
    //   46: invokevirtual 302	uda:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/util/List;)V
    //   49: invokestatic 307	uaw:a	()Luaw;
    //   52: aload_0
    //   53: getfield 69	amxz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   56: invokevirtual 309	uaw:b	(Lcom/tencent/mobileqq/app/QQAppInterface;)V
    //   59: aload_0
    //   60: getfield 69	amxz:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   63: bipush 88
    //   65: invokevirtual 313	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   68: checkcast 315	ofx
    //   71: astore_2
    //   72: aload_2
    //   73: ifnull +11 -> 84
    //   76: aload_2
    //   77: aconst_null
    //   78: ldc_w 317
    //   81: invokevirtual 320	ofx:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   84: aload_0
    //   85: invokespecial 322	amxz:h	()V
    //   88: goto -77 -> 11
    //   91: astore_2
    //   92: aload_0
    //   93: monitorexit
  ...
  public void a(ArrayList<MessageRecord> paramArrayList, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      while (paramArrayList.hasNext())
      {
        ...
        {
          ugf.a(paramQQAppInterface, BaseApplication.getContext(), null, ((Long)localObject).toString());
  ...
  public void a(List<PublicRecommendAccountInfo> paramList)
  {
    ...
    //   14: astore_2
    //   15: aload_0
    //   16: getfield 67	amxz:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    ...
    //   29: aload_0
    //   30: getfield 67	amxz:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   33: ldc_w 431
    //   36: invokevirtual 435	com/tencent/mobileqq/persistence/EntityManager:query	(Ljava/lang/Class;)Ljava/util/List;
    //   39: astore_3
    //   40: aload_3
    //   41: ifnull +49 -> 90
    //   44: aload_3
    ...
    //   66: checkcast 431	com/tencent/mobileqq/data/PublicRecommendAccountInfo
    //   69: astore 4
    //   71: aload_0
    //   72: getfield 67	amxz:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   75: aload 4
    ...
    //   112: checkcast 431	com/tencent/mobileqq/data/PublicRecommendAccountInfo
    //   115: astore 4
    //   117: aload_0
    //   118: getfield 67	amxz:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   121: aload 4
    //   123: invokevirtual 439	com/tencent/mobileqq/persistence/EntityManager:persist	(Lcom/tencent/mobileqq/persistence/Entity;)V
    //   126: goto -29 -> 97
    //   129: astore_1
    //   130: aload_2
    ...
    //   135: athrow
    //   136: aload_0
    //   137: getfield 48	amxz:jdField_c_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   140: ifnull +3 -> 143
    //   143: aload_0
    //   144: aload_1
    //   145: checkcast 41	java/util/ArrayList
    //   148: putfield 48	amxz:jdField_c_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   151: aload_2
  ...
  public boolean a(SessionInfo paramSessionInfo)
  {
    ...
    return (paramSessionInfo != null) && (ugf.a(paramSessionInfo.accountFlag2) == -10L);
  }
  ...
  public void d()
  {
    ...
    for (int i = ((List)localObject2).size();; i = 0)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        {
          if ((!ugf.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) || (!TextUtils.equals(localPublicAccountInfo.getUin(), AppConstants.OLD_KANDIAN_UIN))) {
