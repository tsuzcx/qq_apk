...
public class pcx
  implements Runnable
{
  public pcx(Share paramShare, String paramString, int paramInt, boolean paramBoolean) {}
    ...
    for (int i1 = j | 0x4;; i1 = j)
    {
      ...
      catch (Exception localException1)
      {
        ...
        try
        {
          ...
          ThreadManager.getUIHandler().post(new pcy(this, (SwiftBrowserComponentsProvider.SwiftBrowserComponentProviderSupporter)localObject1));
          return;
        }
