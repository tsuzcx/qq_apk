...
public class adtv
  implements Runnable
{
  public adtv(ForwardSdkBaseOption paramForwardSdkBaseOption) {}
  ...
  public void run()
  {
    ...
    if ((!this.a.k) || (TextUtils.isEmpty(this.a.i)))
    {
      ...
      this.a.x();
      this.a.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new adtw(this));
      return;
    }
    ...
    for (i = 0;; i = 1)
    {
      ...
      for (;;)
      {
        ...
        this.a.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new adtx(this));
        return;
