...
public class nwf
{
  ...
  public static String a(Context paramContext, String paramString, android.os.Bundle paramBundle1, android.os.Bundle paramBundle2)
  {
    ...
    //   81: astore_1
    //   82: aload_2
    //   83: invokestatic 57	com/tencent/biz/common/util/HttpUtil:encodeUrl	(Landroid/os/Bundle;)Ljava/lang/String;
    //   86: astore 6
    //   88: aload_1
    //   89: astore_2
    //   90: aload 6
    ...
    //   96: astore_2
    //   97: aload 6
    //   99: invokevirtual 61	java/lang/String:length	()I
    //   102: ifle +41 -> 143
    //   105: new 63	java/lang/StringBuilder
    //   108: dup
    //   109: invokespecial 67	java/lang/StringBuilder:<init>	()V
    //   112: aload_1
    //   113: invokevirtual 71	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   116: astore_2
    //   117: aload_1
    //   118: ldc 73
    ...
    //   129: aload_2
    //   130: aload_1
    //   131: invokevirtual 71	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   134: aload 6
    ...
    //   143: aload 10
    //   145: astore_1
    //   146: new 81	java/net/URL
    //   149: dup
    //   150: aload_2
    //   151: invokespecial 84	java/net/URL:<init>	(Ljava/lang/String;)V
    //   154: astore_2
    //   155: aload 10
    //   157: astore_1
    //   158: aload_2
    //   159: aload_0
    //   160: invokestatic 87	nwf:a	(Landroid/content/Context;)Ljava/net/Proxy;
    //   163: invokevirtual 91	java/net/URL:openConnection	(Ljava/net/Proxy;)Ljava/net/URLConnection;
    //   166: checkcast 93	javax/net/ssl/HttpsURLConnection
    //   169: astore_0
    //   170: aload_0
    //   171: sipush 15000
    //   174: invokevirtual 97	javax/net/ssl/HttpsURLConnection:setConnectTimeout	(I)V
    //   177: aload_0
    //   178: sipush 30000
    //   181: invokevirtual 100	javax/net/ssl/HttpsURLConnection:setReadTimeout	(I)V
    //   184: aload_0
    //   185: ldc 102
    //   187: invokevirtual 105	javax/net/ssl/HttpsURLConnection:setRequestMethod	(Ljava/lang/String;)V
    //   190: aload_0
    //   191: aload_2
    //   192: invokestatic 108	nwf:a	(Ljavax/net/ssl/HttpsURLConnection;Ljava/net/URL;)V
    //   195: aload_0
    //   196: ldc 110
    //   198: ldc 112
    //   200: invokevirtual 116	javax/net/ssl/HttpsURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   203: aload_0
    //   204: ldc 118
    //   206: ldc 120
    //   208: invokevirtual 116	javax/net/ssl/HttpsURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   211: aload_3
    //   212: ifnull +113 -> 325
    //   215: aload_3
    //   216: invokevirtual 126	android/os/Bundle:keySet	()Ljava/util/Set;
    //   219: invokeinterface 132 1 0
    //   224: astore_1
    //   225: aload_1
    //   226: invokeinterface 138 1 0
    //   231: ifeq +94 -> 325
    //   234: aload_1
    ...
    //   244: aload_3
    //   245: aload_2
    //   246: invokevirtual 146	android/os/Bundle:get	(Ljava/lang/String;)Ljava/lang/Object;
    //   249: astore 6
    //   251: aload 6
    //   253: instanceof 31
    //   256: ifeq -31 -> 225
    ...
    //   266: invokevirtual 116	javax/net/ssl/HttpsURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   269: goto -44 -> 225
    //   272: astore_3
    //   273: aconst_null
    //   274: astore_1
    ...
    //   294: iconst_1
    //   295: aload_3
    //   296: invokevirtual 151	java/io/IOException:getMessage	()Ljava/lang/String;
    //   299: aastore
    //   300: dup
    //   301: iconst_2
    //   302: aload_3
    ...
    //   310: ifnull -284 -> 26
    //   313: aload_2
    //   314: invokevirtual 154	javax/net/ssl/HttpsURLConnection:disconnect	()V
    //   317: aload_0
    //   318: areturn
    //   319: ldc 73
    //   321: astore_1
    ...
    //   340: getstatic 164	android/os/Build$VERSION:SDK	Ljava/lang/String;
    //   343: invokevirtual 71	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   346: ldc 166
    //   348: invokevirtual 71	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   351: getstatic 171	android/os/Build:MODEL	Ljava/lang/String;
    //   354: invokevirtual 71	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   357: ldc 166
    //   359: invokevirtual 71	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   362: getstatic 174	android/os/Build$VERSION:RELEASE	Ljava/lang/String;
    //   365: invokevirtual 71	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   368: invokevirtual 79	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   371: invokevirtual 116	javax/net/ssl/HttpsURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   374: aload_0
    //   375: invokevirtual 177	javax/net/ssl/HttpsURLConnection:connect	()V
    //   378: aload_0
    //   379: invokevirtual 180	javax/net/ssl/HttpsURLConnection:getResponseCode	()I
    //   382: istore 4
    //   384: iload 4
    //   386: sipush 200
    //   389: if_icmpne +430 -> 819
    //   392: aload_0
    //   393: invokevirtual 184	javax/net/ssl/HttpsURLConnection:getInputStream	()Ljava/io/InputStream;
    //   396: astore_1
    //   397: aload_1
    //   398: astore_3
    //   399: new 186	java/io/ByteArrayOutputStream
    //   402: dup
    //   403: invokespecial 187	java/io/ByteArrayOutputStream:<init>	()V
    //   406: astore 6
    //   408: aload_1
    //   409: astore_2
    //   410: aload_1
    ...
    //   416: astore 7
    //   418: aload_0
    //   419: invokevirtual 190	javax/net/ssl/HttpsURLConnection:getContentEncoding	()Ljava/lang/String;
    //   422: ifnull +45 -> 467
    //   425: aload_1
    //   426: astore_2
    //   427: aload_1
    ...
    //   433: astore 7
    //   435: aload_0
    //   436: invokevirtual 190	javax/net/ssl/HttpsURLConnection:getContentEncoding	()Ljava/lang/String;
    //   439: invokevirtual 193	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   442: ldc 112
    ...
    //   455: aload_1
    //   456: astore 7
    //   458: new 195	java/util/zip/GZIPInputStream
    //   461: dup
    //   462: aload_1
    //   463: invokespecial 198	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   466: astore_2
    //   467: aload_2
    //   468: astore 8
    //   470: aload_2
    ...
    //   489: aload_2
    //   490: aload_1
    //   491: invokevirtual 204	java/io/InputStream:read	([B)I
    //   494: istore 5
    //   496: iload 5
    //   498: iconst_m1
    ...
    //   513: iconst_0
    //   514: iload 5
    //   516: invokevirtual 208	java/io/ByteArrayOutputStream:write	([BII)V
    //   519: goto -38 -> 481
    //   522: astore_2
    //   523: aload 8
    //   525: astore_1
    ...
    //   541: iconst_1
    //   542: aload_2
    //   543: invokevirtual 151	java/io/IOException:getMessage	()Ljava/lang/String;
    //   546: aastore
    //   547: dup
    //   548: iconst_2
    //   549: aload_2
    ...
    //   558: ifnull +10 -> 568
    //   561: aload_1
    //   562: invokevirtual 212	java/io/InputStream:close	()V
    //   565: aload 6
    //   567: astore_3
    //   568: aload_3
    ...
    //   572: ldc 214
    //   574: astore_1
    //   575: invokestatic 217	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   578: ifeq +30 -> 608
    //   581: ldc 14
    //   583: iconst_2
    //   584: ldc 219
    ...
    //   591: iconst_0
    //   592: iload 4
    //   594: invokestatic 225	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   597: aastore
    //   598: dup
    //   599: iconst_1
    //   600: aload_1
    //   601: aastore
    //   602: invokestatic 229	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   605: invokestatic 232	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   608: aload_0
    //   609: ifnull +312 -> 921
    //   612: aload_0
    //   613: invokevirtual 154	javax/net/ssl/HttpsURLConnection:disconnect	()V
    //   616: aload_1
    //   617: areturn
    //   618: aload 6
    //   620: astore_3
    ...
    //   622: ifnull -54 -> 568
    //   625: aload_2
    //   626: invokevirtual 212	java/io/InputStream:close	()V
    //   629: aload 6
    //   631: astore_3
    //   632: goto -64 -> 568
    //   635: astore_3
    ...
    //   657: iconst_1
    //   658: aload_3
    //   659: invokevirtual 235	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   662: aastore
    //   663: dup
    //   664: iconst_2
    //   665: aload_3
    ...
    //   673: ifnull -647 -> 26
    //   676: aload_2
    //   677: invokevirtual 154	javax/net/ssl/HttpsURLConnection:disconnect	()V
    //   680: aload_0
    //   681: areturn
    //   682: astore_2
    //   683: aconst_null
    ...
    //   701: iconst_1
    //   702: aload_2
    //   703: invokevirtual 235	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   706: aastore
    //   707: dup
    //   708: iconst_2
    //   709: aload_2
    ...
    //   718: ifnull -150 -> 568
    //   721: aload_1
    //   722: invokevirtual 212	java/io/InputStream:close	()V
    //   725: aload 6
    //   727: astore_3
    //   728: goto -160 -> 568
    //   731: astore_3
    ...
    //   753: iconst_1
    //   754: aload_3
    //   755: invokevirtual 240	java/lang/Throwable:getMessage	()Ljava/lang/String;
    //   758: aastore
    //   759: dup
    //   760: iconst_2
    //   761: aload_3
    ...
    //   769: ifnull -743 -> 26
    //   772: aload_2
    //   773: invokevirtual 154	javax/net/ssl/HttpsURLConnection:disconnect	()V
    //   776: aload_0
    //   777: areturn
    //   778: astore_1
    //   779: aload_3
    //   780: ifnull +7 -> 787
    //   783: aload_3
    //   784: invokevirtual 212	java/io/InputStream:close	()V
    //   787: aload_1
    //   788: athrow
    //   789: astore_1
    //   790: aload_0
    ...
    //   795: ifnull +7 -> 802
    //   798: aload_2
    //   799: invokevirtual 154	javax/net/ssl/HttpsURLConnection:disconnect	()V
    //   802: aload_0
    //   803: athrow
    //   804: new 31	java/lang/String
    //   807: dup
    //   808: aload_3
    //   809: invokevirtual 244	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   812: invokespecial 247	java/lang/String:<init>	([B)V
    //   815: astore_1
    //   816: goto -241 -> 575
    //   819: ldc 14
    //   821: iconst_1
    //   822: new 63	java/lang/StringBuilder
    //   825: dup
    ...
    //   834: iload 4
    //   836: invokevirtual 252	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   839: invokevirtual 79	java/lang/StringBuilder:toString	()Ljava/lang/String;
  ...
  private static Proxy a(Context paramContext)
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (NetworkUtil.isMobileNetworkInfo((NetworkInfo)localObject)))
      {
  ...
  {
    nwg localnwg = new nwg(paramURL);
    paramHttpsURLConnection.setRequestProperty("host", paramURL.getHost());
    paramHttpsURLConnection.setSSLSocketFactory(new SniSSLSocketFactory(paramURL.getHost(), localnwg));
    paramHttpsURLConnection.setHostnameVerifier(localnwg);
  }
}
