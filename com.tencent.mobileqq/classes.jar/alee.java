...
public class alee
{
  ...
  protected static String a(String paramString)
  {
    ...
    return paramString.replace("[client]", "androidQQ").replace("[version]", "8.3.3.4515").replace("[platformId]", "2").replace("[device]", Build.DEVICE).replace("[system]", Build.VERSION.RELEASE).replace("[systemInt]", Integer.toString(Build.VERSION.SDK_INT));
  }
  ...
  public static void a(String paramString)
  {
    ...
    {
      return;
      alef.ah = a(paramString);
    } while (!QLog.isColorLevel());
    QLog.d("ApolloConfigUtils", 2, "sApolloStoreUrl = " + alef.ah);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject1 != null)
        {
          ...
          bdiv.k((Context)localObject2, Integer.parseInt(paramString));
          ...
          bdiv.l((Context)localObject2, Integer.parseInt((String)localObject3));
        }
      }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (i < paramString.length())
        {
          ...
          if (!a("8.3.3", ((JSONObject)localObject3).optString("minVersion"), ((JSONObject)localObject3).optString("maxVersion"))) {
            break label1520;
          }
        ...
        if (((JSONObject)localObject1).has("gameConfig"))
        {
          ...
          if ((paramString != null) && (paramString.has("aio")))
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localObject1)) {
              alef.aD = (String)localObject1;
            }
            if (!TextUtils.isEmpty((CharSequence)localObject2)) {
              alef.aE = ((String)localObject2).trim();
            }
            if (!TextUtils.isEmpty((CharSequence)localObject3)) {
              alef.aF = ((String)localObject3).trim();
            }
          }
        }
        if (akji.a.get()) {
        ...
        paramString = (akji)paramQQAppInterface.getManager(153);
        akji.a.set(true);
        paramString.h();
        return;
        label1520:
                          ...
                          do
                          {
                            do
                            {
                              do
                              {
                                ...
                                alef.ai = a(paramString2);
                              } while (!QLog.isColorLevel());
                              QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloStoreInteractUrl=", alef.ai });
                              return;
                            ...
                            alef.aj = a(paramString2);
                          } while (!QLog.isColorLevel());
                          QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloNewStoreUrl=", alef.aj });
                          return;
                          if (!"game_center".equals(paramString1)) {
                            break;
                          }
                        } while (TextUtils.isEmpty(paramString2));
                        alef.ak = a(paramString2);
                      } while (!QLog.isColorLevel());
                      QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloGameCenterUrl=", alef.ak });
                      return;
                      if (!"new_interact".equals(paramString1)) {
                        break;
                      }
                    } while (TextUtils.isEmpty(paramString2));
                    alef.al = a(paramString2);
                  } while (!QLog.isColorLevel());
                  QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloNewInteractUrl=", alef.al });
                  return;
                  if (!"game_city".equals(paramString1)) {
                    break;
                  }
                } while (TextUtils.isEmpty(paramString2));
                alef.am = a(paramString2);
              } while (!QLog.isColorLevel());
              QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloGameCityUrl=", alef.am });
              return;
              if ("apollo_drawer_game_box_lottie".equals(paramString1))
              {
                alef.ar = paramString2;
                return;
              }
      ...
      try
      {
        ...
        if (paramJSONObject != null)
        {
          ...
          if (i < paramJSONObject.length())
          {
            ...
            if (!a("8.3.3", localJSONObject.optString("minVersion"), localJSONObject.optString("maxVersion"))) {
              continue;
            }
      ...
      try
      {
        ...
        if (localJSONArray != null)
        {
          ...
          if (i < localJSONArray.length())
          {
            ...
            if (a("8.3.3", str1, str2))
            {
              if (!TextUtils.isEmpty((CharSequence)localObject2))
              {
                alef.at = (String)localObject2;
                alef.au = localJSONObject.optString("id");
                alef.av = alef.jdField_a_of_type_JavaLangString + "/script/" + alef.au + "/";
                if (paramBoolean)
                {
              ...
              if (QLog.isColorLevel())
              {
                QLog.d("ApolloConfigUtils", 2, new Object[] { "parseBaseScriptConfig: localversion target.url=" + (String)localObject2, ",scriptId:", alef.au, ",isUpdate:", Boolean.valueOf(paramBoolean) });
                localObject3 = localObject1;
              }
            }
            else
            {
              ...
              if (a("8.3.3", str1) < 0)
              {
                ...
                if (a((String)localObject1, str1) < 0)
                {
                  if (!TextUtils.isEmpty((CharSequence)localObject2))
                  {
                    alef.aw = (String)localObject2;
                    alef.ax = localJSONObject.optString("id");
                    alef.ay = alef.jdField_a_of_type_JavaLangString + "/script/" + alef.ax + "/";
                  }
                  if (QLog.isColorLevel()) {
                    QLog.d("ApolloConfigUtils", 2, "parseBaseScriptConfig: newestMinVersion=" + str1 + " target.url=" + (String)localObject2 + ", id=" + alef.ax);
                  }
                  localObject3 = str1;
                }
              }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localApolloPreDownloadData.resId = bhli.b(localApolloPreDownloadData.url);
          ...
          if ((!TextUtils.isEmpty(localApolloPreDownloadData.minVer)) && (!TextUtils.isEmpty(localApolloPreDownloadData.maxVer)) && (!a("8.3.3", localApolloPreDownloadData.minVer, localApolloPreDownloadData.maxVer))) {
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        akqu.a(jdField_a_of_type_OrgJsonJSONArray);
        ...
        if (localJSONObject2 != null)
        {
          akpd.a("aio.enter.bg", localJSONObject2.optString("entranceBkgUrl"));
          ...
          else
          {
            ...
            akpd.a("aio.enter", paramQQAppInterface);
            akpd.a("aio.enter.name", localJSONObject2.optString("entranceName"));
          }
        }
        else
        {
