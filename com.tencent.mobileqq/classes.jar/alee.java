...
public class alee
  extends QIPCModule
{
  public static alee a;
  private Map<Integer, alas> a;
  ...
  public static alee a()
  {
    if (jdField_a_of_type_Alee == null) {}
    try
    {
      if (jdField_a_of_type_Alee == null) {
        jdField_a_of_type_Alee = new alee();
      }
      return jdField_a_of_type_Alee;
    }
    finally {}
  }
  ...
  private EIPCResult a(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    case 9: 
      ...
      paramQQAppInterface = (aold)paramQQAppInterface.getManager(85);
    ...
    case 11: 
      ...
      paramQQAppInterface = (agdg)paramQQAppInterface.getManager(321);
    ...
    case 12: 
      ...
      if (paramBundle != null)
      {
        ...
        paramQQAppInterface = (agdg)paramQQAppInterface.getManager(321);
        if (paramQQAppInterface != null) {
          paramQQAppInterface.a(agci.a(paramBundle).hashCode());
        }
      }
      return null;
    case 13: 
      ...
      if ((paramQQAppInterface != null) && (paramBundle != null))
      {
        paramQQAppInterface.a().b(antf.ad, 9002, paramBundle.msg_id.hashCode());
        paramQQAppInterface.E();
      }
      return null;
    case 0: 
      paramQQAppInterface = bhlg.b(paramQQAppInterface, paramBundle.getString("uin"), true);
      paramBundle = new Bundle();
    ...
    case 7: 
      ...
      EmojiGifHelper.getInstance().compositeAndTransToGifInner(paramQQAppInterface, new alej(this, paramInt));
      return null;
    case 8: 
    ...
    case 17: 
      ...
      if (bool)
      {
        paramQQAppInterface = new bdgm(paramQQAppInterface, paramBundle).a();
        paramBundle = new Bundle();
        paramBundle.putSerializable("res", paramQQAppInterface);
        return EIPCResult.createSuccessResult(paramBundle);
      }
      new bdgh(paramQQAppInterface, paramBundle).a(new alek(this, paramInt));
      return null;
    case 18: 
      paramInt = alib.a(paramBundle.getString("path"));
    ...
    case 16: 
      ...
      {
        paramBundle = (alas)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    ...
    case 15: 
      localObject = paramBundle.getString("key");
      paramInt = paramBundle.getInt("code");
      paramBundle = new alel(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
      paramQQAppInterface = (alao)paramQQAppInterface.getManager(245);
      if (paramQQAppInterface != null)
      {
        if ((this.jdField_a_of_type_JavaUtilMap != null) && (!this.jdField_a_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramInt)))) {
    ...
    paramBundle = new alem(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
  ...
  private void a(Bundle paramBundle, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    Object localObject1;
    if (((i != 5) && ((i & 0x10) == 0)) || ((((anyw)localObject2).b(str)) && (!paramQQAppInterface.getCurrentAccountUin().equals(str)))) {
      if (!TextUtils.isEmpty(paramBundle))
      {
        localObject1 = (TroopManager)paramQQAppInterface.getManager(52);
        localObject2 = ((anyw)localObject2).e(str);
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(paramBundle)) {
        localObject1 = bhlg.b(paramQQAppInterface, str, true);
      }
      for (;;)
      {
        ...
        localObject1 = bhlg.b(paramQQAppInterface, str, true);
        continue;
        paramBundle = bhlg.q(paramQQAppInterface, str);
        localObject1 = paramBundle;
        if (TextUtils.isEmpty(paramBundle)) {
          localObject1 = str;
        }
  ...
  private void a(AppRuntime paramAppRuntime, Bundle paramBundle)
  {
    if ((paramAppRuntime != null) && (paramBundle != null))
    {
      ...
      if (paramBundle != null)
      {
        paramAppRuntime = (alao)((QQAppInterface)paramAppRuntime).getManager(245);
  ...
  private EIPCResult b(QQAppInterface paramQQAppInterface, Bundle paramBundle, int paramInt)
  {
    ...
    case 1: 
      ...
      ((PreloadManager)paramQQAppInterface.getManager(151)).a(paramBundle, new aleo(this, paramInt));
      return null;
    case 2: 
      ...
      {
        paramBundle = new alen(this, (ResultReceiver)paramBundle.getParcelable("receiver"));
    ...
    ((PreloadManager)paramQQAppInterface.getManager(151)).a(paramBundle, new alef(this, paramInt));
    return null;
  }
  ...
  public EIPCResult a(Bundle paramBundle, int paramInt)
  {
    ...
    case 3: 
      for (;;)
      {
        ...
        localObject = new aleg(this, (Bundle)localObject, localResultReceiver);
        if (paramInt == 1) {
    ...
    for (;;)
    {
      ...
      else
      {
        if ("getVideoResPathByMID".equals(paramString))
        {
          ...
          paramString = ((PreloadManager)((QQAppInterface)localObject).getManager(151)).e(paramString);
          if (QLog.isColorLevel()) {
        ...
        else
        {
          if ("getConditionSearchManager".equals(paramString))
          {
            ...
            paramBundle = (anve)((QQAppInterface)localObject).getManager(59);
            ...
            if (paramInt != 0)
            {
              ...
              if (i == 0) {
                paramBundle.c(new alei(this, (Bundle)localObject, i, paramString, paramBundle));
              }
