...
public class akez
  extends ajtb
{
  public akez(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
          ...
          for (;;)
          {
            ...
            if (paramObject.msg_quota.has())
            {
              ...
              if (paramObject.uint32_comm_quota.has()) {
                aiiz.a(paramObject.uint32_comm_quota.get(), this.app);
              }
              if (paramObject.uint32_svip_quota.has()) {
                aiiz.b(paramObject.uint32_svip_quota.get(), this.app);
              }
              aiiz.b(this.app);
              continue;
                ...
                if ((localObject1 != null) && (((List)localObject1).size() > 0))
                {
                  ...
                  while (((Iterator)localObject1).hasNext())
                  {
                    ...
                    if ((((RemindPB.RemindItem)localObject2).uint64_uin.has()) && (((RemindPB.RemindItem)localObject2).uint32_id.has()))
                    {
                      ...
                      paramObject.add(str);
                      aiiz.a(str, ((RemindPB.RemindItem)localObject2).uint32_id.get(), this.app);
                    }
                  }
                  aiiz.a(paramObject, this.app);
                  continue;
                  if (paramObject.rep_clear_uin.has())
                  {
                    ...
                    if ((localObject1 != null) && (((List)localObject1).size() > 0))
                    {
                      ...
                      while (((Iterator)localObject1).hasNext())
                      {
                        ...
                        aiiz.c((String)localObject2, this.app);
                      }
                      aiiz.b(paramObject, this.app);
                    }
                  }
                }
              }
    ...
    bdes.a().a(paramFromServiceMsg.getServiceCmd(), 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 1000277, ajya.a(2131711400), true);
  }
