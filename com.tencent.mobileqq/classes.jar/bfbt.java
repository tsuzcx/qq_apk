...
public class bfbt
  implements View.OnClickListener, bfbu
{
  protected int a;
  protected View a;
  ...
  public bfbt(PublishHomeWorkFragment paramPublishHomeWorkFragment, String paramString)
  {
  ...
  private void a(View paramView)
  {
    ...
    {
      bgjt.a("Grp_edu", "homework", "createHW_doc_clk", 0, 0, new String[] { paramView, ((Bundle)localObject).getString("reportIdentity", ""), ((Bundle)localObject).getString("reportCourse", "") });
      return;
    }
  }
  ...
  private boolean b()
  {
    bezs localbezs = (bezs)aqlk.a().a(605);
    if ((localbezs != null) && (!localbezs.b())) {
      return false;
    }
  ...
  private void c(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_AndroidWidgetTextView != null)
    {
      if (paramBoolean)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetTextView.setCompoundDrawablesWithIntrinsicBounds(2130837954, 0, 0, 0);
      }
    }
    else {
      return;
  ...
  public void a()
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiPublishHomeWorkFragment.a(2131373061);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiPublishHomeWorkFragment.a(2131373063));
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiPublishHomeWorkFragment.a(2131372306);
    bezs localbezs = (bezs)aqlk.a().a(605);
    if (localbezs != null)
    {
      if (!localbezs.b()) {
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_ComTencentMobileqqTroopHomeworkEntryUiPublishHomeWorkFragment.a(2131379243));
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setOnClickListener(this);
      if (!this.jdField_a_of_type_JavaLangBoolean.booleanValue()) {
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      }
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131379375));
      this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131379213);
  ...
  public void a(int paramInt)
  {
    ...
    {
      bgjt.a("Grp_edu", "homework", "createHW_doc", 0, 0, new String[] { str, localBundle.getString("reportIdentity", ""), localBundle.getString("reportCourse", "") });
      return;
    }
  }
