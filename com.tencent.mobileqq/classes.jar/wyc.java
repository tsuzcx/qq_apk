  ...
  implements View.OnClickListener
{
  ...
  private final vuj jdField_a_of_type_Vuj = (vuj)vux.a(15);
  protected wgz a;
  private wpl jdField_a_of_type_Wpl;
  private wpu jdField_a_of_type_Wpu;
  private wyq jdField_a_of_type_Wyq;
  private wyr jdField_a_of_type_Wyr;
  private final xnp jdField_a_of_type_Xnp = (xnp)vux.a(11);
  ...
  public wyc(ViewGroup paramViewGroup)
  {
  ...
  private void a(VideoListFeedItem paramVideoListFeedItem)
  {
    ...
    if (paramVideoListFeedItem.mHadLike == 1) {
      this.jdField_a_of_type_ComTencentBizQqstoryViewPressDarkImageView.setImageResource(2130846480);
    }
    while (paramVideoListFeedItem.mLikeCount > 0)
    {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(UIUtils.formatCount(paramVideoListFeedItem.mLikeCount));
      return;
      this.jdField_a_of_type_ComTencentBizQqstoryViewPressDarkImageView.setImageResource(2130846793);
    }
    this.jdField_a_of_type_AndroidWidgetTextView.setText(amtj.a(2131700330));
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    localMediaScanner.queryMediaInfoAsync(new wyi(this, paramString3, paramString4, paramString2, paramString5, paramString6, paramString1, localLocalMediaInfo), localLocalMediaInfo);
  }
  ...
  private void b(VideoListFeedItem paramVideoListFeedItem)
  {
    ...
    {
      this.jdField_b_of_type_AndroidWidgetTextView.setText(UIUtils.formatCount(paramVideoListFeedItem.mCommentCount));
      return;
    }
    this.jdField_b_of_type_AndroidWidgetTextView.setText(amtj.a(2131700333));
  }
  ...
  private void d()
  {
    ...
    if (((Boolean)localvuq.b("first_clk_forward", Boolean.valueOf(true))).booleanValue())
    {
      VideoViewVideoHolder localVideoViewVideoHolder = ((StoryPlayerGroupHolder)a()).a();
      QQCustomDialog localQQCustomDialog = bfur.a(b(), 230);
      localQQCustomDialog.setTitle(amtj.a(2131700331)).setMessage(amtj.a(2131700324)).setPositiveButton(amtj.a(2131700332), new wyg(this)).setOnDismissListener(new wyf(this, localVideoViewVideoHolder));
      localQQCustomDialog.show();
      if (localVideoViewVideoHolder != null) {
        localVideoViewVideoHolder.c(true);
      }
      localvuq.b("first_clk_forward", Boolean.valueOf(false));
      xwa.a("play_video", "exp_window", 0, 0, new String[0]);
    }
    for (;;)
    {
      xwa.a("play_video", "clk_repost", 0, 0, new String[] { "", "", "", this.jdField_a_of_type_Wsk.jdField_a_of_type_JavaLangString });
      return;
      e();
    }
  }
  ...
  private void e()
  {
    ...
    Object localObject2 = (vvj)vux.a(2);
    ...
    Object localObject1 = this.jdField_a_of_type_Wsk.a();
    ...
    for (;;)
    {
      xwa.a("share", "clk_video", 0, 0, new String[] { localStoryVideoItem.mVid });
      return;
      localObject1 = ((VideoListFeedItem)localObject1).feedId;
      break;
      label171:
      a(b().getString(2131719472), true);
      this.jdField_a_of_type_Vnf.a(localStoryVideoItem.mVid, 0, true, new wyh(this, localVideoViewVideoHolder, localStoryVideoItem, (QQUserUIItem)localObject2, (String)localObject1));
      if (localVideoViewVideoHolder != null) {
        localVideoViewVideoHolder.c(true);
      }
  ...
  {
    new wyd(this);
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131381174);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131381175);
    this.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
    this.d = paramView.findViewById(2131369916);
    this.d.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentBizQqstoryViewPressDarkImageView = ((PressDarkImageView)paramView.findViewById(2131369922));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131369920));
    this.jdField_e_of_type_AndroidViewView = paramView.findViewById(2131364803);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131364837));
    this.jdField_b_of_type_ComTencentBizQqstoryViewPressDarkImageView = ((PressDarkImageView)paramView.findViewById(2131364850));
  ...
  {
    paramMap.put(new wyn(this), "");
    paramMap.put(new wyl(this), "");
    paramMap.put(new wym(this), "");
    paramMap.put(new wyo(this), "");
    paramMap.put(new wyk(this), "");
    paramMap.put(new wyp(this), "");
    this.jdField_a_of_type_Wyq = new wyq(this);
    a(this.jdField_a_of_type_Wyq);
  }
  ...
  public void a(@NonNull wsk paramwsk, @NonNull StoryVideoItem paramStoryVideoItem)
  {
    ...
    VideoListFeedItem localVideoListFeedItem = (VideoListFeedItem)this.jdField_a_of_type_Xnp.a(paramwsk.jdField_b_of_type_JavaLangString, true);
    Object localObject;
    boolean bool1;
    boolean bool2;
    if ((!paramStoryVideoItem.isUploadSuc()) || (localVideoListFeedItem == null))
    {
      ...
      {
        xvv.d((String)localObject, "hide BottomWidget because uploading=%s, no-feed=%s , feed id = %s", new Object[] { Boolean.valueOf(bool1), Boolean.valueOf(bool2), paramwsk.jdField_b_of_type_JavaLangString });
        k();
        return;
        bool1 = false;
        break;
    ...
    label512:
    int k;
    if (TextUtils.equals(this.jdField_c_of_type_JavaLangString, paramwsk.jdField_a_of_type_JavaLangString))
    {
      this.jdField_e_of_type_Boolean = false;
      localObject = ((vvj)vux.a(2)).c(paramStoryVideoItem.mOwnerUid);
    ...
    for (int m = 1;; m = 0)
    {
      ...
      xwa.a("play_video", "exp_repost", 0, 0, new String[] { "", "", "", paramwsk.jdField_a_of_type_JavaLangString });
      return;
      ...
      {
        i = 1;
        xvv.d(this.jdField_b_of_type_JavaLangString, "show BottomWidget because friend and showBottomWidgetFlag=3");
        break label435;
      }
      i = 0;
      xvv.d(this.jdField_b_of_type_JavaLangString, "hide BottomWidget");
      break label435;
  ...
  {
    return (paramwsk.jdField_a_of_type_Vxd == null) || (paramwsk.jdField_a_of_type_Vxd.a != 13);
  }
  ...
  public boolean d()
  {
    ...
    for (;;)
    {
      ...
      wsk localwsk = this.jdField_a_of_type_Wsk;
      StoryVideoItem localStoryVideoItem = localwsk.a();
      VideoListFeedItem localVideoListFeedItem = localwsk.a();
      int i;
      boolean bool;
      if (localStoryVideoItem != null)
      {
        localObject = ((vvj)localObject).b(localStoryVideoItem.mOwnerUid);
        if ((localObject == null) || (!((QQUserUIItem)localObject).isVip)) {
          break label309;
        }
        i = 1;
        if (((localObject != null) && (((QQUserUIItem)localObject).isMe())) && ((this.jdField_a_of_type_Wod == null) || (!(this.jdField_a_of_type_Wod instanceof wor)))) {
          break label348;
        }
        ...
        l = ((vxd)localObject).a(localStoryVideoItem.mVid);
      }
      for (;;)
      {
        ...
        for (localObject = ((MsgTabPlayInfo)((OpenPlayerBuilder.Data)localObject).mInfo).nodeUnionId;; localObject = null)
        {
          ...
          for (localObject = String.valueOf(l);; localObject = String.valueOf(xwa.a((String)localObject, localVideoListFeedItem)))
          {
            xwa.a("play_video", "dbl_like", i, j, new String[] { "", localObject, "", localwsk.jdField_a_of_type_JavaLangString });
            return true;
            localObject = null;
            break;
            i = 0;
  ...
  public void g()
  {
    ...
    if (this.jdField_a_of_type_Wyq != null) {
      b(this.jdField_a_of_type_Wyq);
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    Object localObject3 = this.jdField_a_of_type_Wsk.a();
    ...
    {
      i = 1;
      bool5 = wkp.a(localStoryVideoItem);
      bool2 = false;
      l = 0L;
      ...
      l = ((vxd)localObject1).a(localStoryVideoItem.mVid);
    }
    for (;;)
    {
      label277:
      ...
      case 2131381175: 
        for (;;)
        {
          ...
          QQToast.a(wkp.a(), 1, amtj.a(2131700328), 0).a();
          break;
          i = 0;
          break label101;
          bool2 = true;
        ...
        if (this.jdField_a_of_type_Wpu == null) {
          this.jdField_a_of_type_Wpu = new wpu();
        }
        localObject1 = amtj.a(2131700329);
        ...
        while (localQQUserUIItem == null)
        {
          ...
          if ((((OpenPlayerBuilder.Data)localObject3).mInfo instanceof MsgTabPlayInfo)) {
            bool1 = vxw.a(QQStoryContext.a()).a(((MsgTabPlayInfo)((OpenPlayerBuilder.Data)localObject3).mInfo).nodeUnionId);
          }
          localObject1 = (String)localObject1 + amtj.a(2131700326);
          this.jdField_a_of_type_Wpl = new wpl(b(), this.jdField_a_of_type_Wsk.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Wpu, (String)localObject1, 4444, bool2, bool1);
          this.jdField_a_of_type_Wpl.show();
          this.jdField_a_of_type_Wpl.setOnDismissListener(new wye(this, (VideoViewVideoHolder)localObject2));
          if (!(this.jdField_a_of_type_Wod instanceof wor)) {
            break label1261;
          }
          localObject1 = ((wor)this.jdField_a_of_type_Wod).jdField_a_of_type_Vxd;
          ...
          localObject2 = "2";
          xwa.a("play_video", "input_reply", j, 0, new String[] { localObject1, localObject2, "", localStoryVideoItem.mVid });
          break;
        }
      ...
      case 2131377252: 
        for (;;)
        {
          ...
          {
            localObject1 = ((vvf)vux.a(23)).a(localQQUserUIItem, (String)localObject1, false, true);
            break label352;
          }
          ...
          {
            xwa.a("play_video", "clk_reply", j, 1, new String[] { localObject1, localObject2, "", localStoryVideoItem.mVid });
            break;
            localObject1 = "1";
            break label741;
          }
          ...
          for (;;)
          {
            if (localObject3 != null)
            {
              ...
              if (((VideoListFeedItem)localObject3).mHadLike == 1)
              {
                ...
                j = 106;
                label957:
                vse.a((CommentLikeFeedItem)localObject3, bool4, k, j);
                i();
              ...
              {
                xwa.a("play_video", (String)localObject1, j, k, new String[] { localObject2, localObject3, String.valueOf(localStoryVideoItem.mOwnerUid), this.jdField_a_of_type_Wsk.jdField_a_of_type_JavaLangString });
                break;
                bool3 = false;
                break label907;
                label1128:
                ...
                localObject1 = "like";
                break label1039;
                j = xwa.a((String)localObject2, (VideoListFeedItem)localObject3);
                break label1048;
                localObject2 = "1";
                break label1063;
              }
