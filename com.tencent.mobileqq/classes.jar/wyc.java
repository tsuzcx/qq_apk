  ...
  extends wlf<xah>
{
  ...
  public wyc(String paramString, List<String> paramList, List<Long> paramList1, List<Integer> paramList2, int paramInt)
  {
  ...
  public String a()
  {
    return wjz.a("StoryGroupSvc.add_video");
  }
  ...
  public wla a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      return new xah(localRspAddGroupVideo);
    }
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      for (;;)
      {
        yqp.b("AddGroupVideoRequest", "decodeResponse", paramArrayOfByte);
      }
    }
  }
