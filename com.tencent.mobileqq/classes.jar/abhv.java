...
public class abhv
  implements aqur
{
  public abhv(GesturePWDCreateActivity paramGesturePWDCreateActivity) {}
  ...
  public void a(List<aquq> paramList)
  {
    ...
    do
    {
      ...
      if ((paramList != null) && (paramList.size() >= 3))
      {
        ...
        this.a.jdField_a_of_type_AndroidWidgetTextView.setText(2131692985);
      ...
      bcql.a(this.a, 1, this.a.getString(2131693005), 0).b(this.a.getTitleBarHeight());
      ...
      axqy.b(this.a.app, "CliOper", "", "", "Setting_tab", "Gesture_password", 0, 1, "", "", "", "");
      bcql.a(this.a, 2, this.a.getString(2131692987), 0).b(this.a.getTitleBarHeight());
    ...
    bcql.a(this.a, 1, this.a.getString(2131692986), 0).b(this.a.getTitleBarHeight());
  }
