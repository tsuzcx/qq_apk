...
public class tos
  extends syq
{
  public final List<tnf> a = new ArrayList();
  
  public tos(qqstory_service.RspStoryPlayerTagInfo paramRspStoryPlayerTagInfo)
  {
    ...
    label163:
    for (paramRspStoryPlayerTagInfo = new vuz((qqstory_struct.CompInfoBase)((qqstory_struct.TagInfoBaseVidList)localObject).comp_info.get());; paramRspStoryPlayerTagInfo = null)
    {
      ...
      {
        this.a.add(new tnf(str, new vvh(localTagInfoBase), paramRspStoryPlayerTagInfo, (String)localObject));
        break;
        return;
      }
    }
