...
public class bhil<T>
  extends Animation
{
  static final bhis jdField_a_of_type_Bhis = new bhim();
  static final bhis b;
  static final bhis c;
  static final bhis d;
  static final bhis e = new bhiq();
  ...
  static
  {
    jdField_b_of_type_Bhis = new bhin();
    jdField_c_of_type_Bhis = new bhio();
    jdField_d_of_type_Bhis = new bhip();
  }
  
  public bhil(T paramT1, T paramT2, bhir<T> parambhir)
  {
    this(paramT1, paramT2, parambhir, false, false, null);
  }
  
  public bhil(T paramT1, T paramT2, bhir<T> parambhir, boolean paramBoolean1, boolean paramBoolean2)
  {
    this(paramT1, paramT2, parambhir, paramBoolean1, paramBoolean2, null);
  }
  
  public bhil(T paramT1, T paramT2, bhir<T> parambhir, boolean paramBoolean1, boolean paramBoolean2, bhis<T> parambhis)
  {
    ...
    for (;;)
    {
      ...
      {
        this.f = jdField_a_of_type_Bhis;
      }
      else if (Float.class == localClass)
      {
        this.f = jdField_b_of_type_Bhis;
      }
      else if (Rect.class == localClass)
      {
        this.f = jdField_c_of_type_Bhis;
      }
      else if (Point.class == localClass)
      {
        this.f = jdField_d_of_type_Bhis;
      }
      else
      {
  ...
  public void a(bhir<T> parambhir)
  {
    this.jdField_a_of_type_Bhir = parambhir;
  }
  
  protected void applyTransformation(float paramFloat, Transformation paramTransformation)
  {
    if (this.jdField_a_of_type_Bhir != null) {
      this.jdField_a_of_type_Bhir.a(this, paramFloat, this.f.a(paramFloat, this.jdField_a_of_type_JavaLangObject, this.jdField_b_of_type_JavaLangObject), paramTransformation);
    }
  }
