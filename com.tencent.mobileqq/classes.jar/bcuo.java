...
public class bcuo
{
  ...
  public static JceStruct a(byte[] paramArrayOfByte, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      localObject1 = ((WNSStream)localObject1).unpack(bhjl.b(paramArrayOfByte));
  ...
  private static void a(QQAppInterface paramQQAppInterface, mobile_get_config_rsp parammobile_get_config_rsp)
  {
    ...
    try
    {
      aavd.a(parammobile_get_config_rsp.config, true);
      label32:
      ...
      aave.a(parammobile_get_config_rsp.config, parammobile_get_config_rsp.cookies, str1, paramQQAppInterface);
      return;
    }
  ...
  public static byte[] a(JceStruct paramJceStruct, String paramString, long paramLong, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    //   41: aload 7
    //   43: getstatic 13	bcuo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   46: lload_2
    ...
    //   139: pop
    //   140: ldc_w 260
    //   143: invokestatic 265	bcvt:a	(Ljava/lang/String;)Lcooperation/qzone/LbsDataV2$GpsInfo;
    //   146: astore 11
    //   148: ldc 91
    //   150: astore 7
    //   152: ldc 91
    ...
    //   160: ldc_w 260
    //   163: invokestatic 267	bcvt:a	(Ljava/lang/String;)V
    //   166: aload 10
    //   168: bipush 38
    ...
    //   267: iload 6
    //   269: lload_2
    //   270: invokestatic 284	bcuo:a	(IJ)Lcom/qq/taf/jce/JceStruct;
    //   273: astore 7
    //   275: aload 7
    //   277: astore_0
    //   278: aload 8
    //   280: getstatic 38	bcuo:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    //   313: invokestatic 295	bhjl:a	([B)[B
    //   316: areturn
    //   317: dconst_1
    //   318: aload 11
