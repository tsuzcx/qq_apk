  ...
  implements View.OnTouchListener
{
  ...
  public axxu(Context paramContext)
  {
    this.jdField_a_of_type_Biun = new axxy(this);
    this.jdField_a_of_type_AndroidContentBroadcastReceiver = new axxz(this);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidWidgetTextView = new TextView(this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_AndroidWidgetTextView.setOnTouchListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131703977));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setPadding(0, 0, 0, zft.b(this.jdField_a_of_type_AndroidContentContext, 15.0F));
  ...
  private void b()
  {
    ...
    {
      j = j - this.jdField_a_of_type_AndroidWidgetTextView.getWidth() - zft.b(this.jdField_a_of_type_AndroidContentContext, 10.0F);
      if (localLayoutParams.y - this.jdField_a_of_type_AndroidWidgetTextView.getHeight() / 2 <= i * 0.8F) {
        break label251;
      }
      i = i - this.jdField_a_of_type_AndroidWidgetTextView.getHeight() - zft.b(this.jdField_a_of_type_AndroidContentContext, 10.0F);
    }
    for (;;)
    {
      ValueAnimator localValueAnimator = ValueAnimator.ofInt(new int[] { localLayoutParams.x, j });
      localValueAnimator.addUpdateListener(new axxw(this, localLayoutParams, localValueAnimator));
      ...
      localValueAnimator.addUpdateListener(new axxx(this, localLayoutParams, localValueAnimator));
      localValueAnimator.setDuration(200L);
      localValueAnimator.setTarget(this.jdField_a_of_type_AndroidWidgetTextView);
      localValueAnimator.start();
      return;
      j = zft.b(this.jdField_a_of_type_AndroidContentContext, 10.0F);
      break;
      label251:
      if (localLayoutParams.y - this.jdField_a_of_type_AndroidWidgetTextView.getHeight() / 2 > i * 0.6F) {
        ...
        i = zft.b(this.jdField_a_of_type_AndroidContentContext, 10.0F);
      }
    }
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).removeObserver(this.jdField_a_of_type_Biun);
      return;
    }
  ...
  public void a(int paramInt1, String paramString1, int paramInt2, long paramLong, String paramString2)
  {
    ...
    Object localObject;
    if (!this.jdField_b_of_type_Boolean) {
      if (!lzq.c(this.jdField_a_of_type_AndroidContentContext))
      {
        if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        ((WindowManager.LayoutParams)localObject).x = (j - zft.b(this.jdField_a_of_type_AndroidContentContext, 62.0F) - zft.b(this.jdField_a_of_type_AndroidContentContext, 10.0F));
        ((WindowManager.LayoutParams)localObject).y = ((int)((k - zft.b(this.jdField_a_of_type_AndroidContentContext, 67.0F)) * 0.25F));
        this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundResource(2130842239);
        try
        {
          ...
          if (paramInt1 == 0)
          {
            this.jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131704028));
            this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new axxv(this, paramInt1, paramLong, paramString2, paramString1, paramInt2));
            ((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).addObserver(this.jdField_a_of_type_Biun);
            return;
            i = 2010;
          }
        }
        catch (Exception localException1)
        {
          for (;;)
          {
            ...
            continue;
            this.jdField_a_of_type_AndroidWidgetTextView.setText(anzj.a(2131704019));
          }
        }
      }
    }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      if (i == 2)
      {
        if ((this.jdField_a_of_type_Boolean) || (Math.abs(paramMotionEvent.getX() - this.jdField_a_of_type_Int) > zft.b(this.jdField_a_of_type_AndroidContentContext, 10.0F)) || (Math.abs(paramMotionEvent.getY() - this.jdField_b_of_type_Int) > zft.b(this.jdField_a_of_type_AndroidContentContext, 10.0F)))
        {
          ...
          paramView.y = (k - this.jdField_b_of_type_Int - zft.b(this.jdField_a_of_type_AndroidContentContext, 25.0F));
