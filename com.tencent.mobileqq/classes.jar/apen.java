...
public class apen
{
  ...
  private apeq jdField_a_of_type_Apeq = new apeo(this);
  private Object jdField_a_of_type_JavaLangObject = new Object();
  private List<apeq> jdField_a_of_type_JavaUtilList = new ArrayList();
  ...
  public apen(long paramLong, String paramString, Bundle paramBundle)
  {
  ...
  public static String a(int paramInt)
  {
    ...
    case 1: 
      return str + "[" + String.valueOf(paramInt) + "]";
    case 2: 
      return ajjy.a(2131650102);
    case 3: 
      return ajjy.a(2131650090);
    case 4: 
      return ajjy.a(2131650095);
    case 5: 
      return ajjy.a(2131650092);
    case 6: 
      return ajjy.a(2131650103);
    case 7: 
      return ajjy.a(2131650100);
    case 8: 
      return ajjy.a(2131650101);
    case 9: 
      return ajjy.a(2131650099);
    case 10: 
      return "SDK下载服务错误";
    case 11: 
      return ajjy.a(2131650094);
    case 12: 
      return "下载器DC失败";
    case 13: 
      return ajjy.a(2131650093);
    }
    return ajjy.a(2131650098);
  }
  ...
  private List<apeq> a()
  {
    ...
    synchronized (this.jdField_b_of_type_JavaLangObject)
    {
      ...
      while (i < j)
      {
        localArrayList.add((apeq)this.jdField_a_of_type_JavaUtilList.get(i));
        i += 1;
      }
  ...
  private boolean a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 150	apen:jdField_a_of_type_Apep	Lapep;
    //   8: ifnull +24 -> 32
    //   11: aload_0
    //   12: getfield 150	apen:jdField_a_of_type_Apep	Lapep;
    //   15: aconst_null
    //   16: invokeinterface 155 2 0
    //   21: pop
    //   22: aload_0
    //   23: getfield 150	apen:jdField_a_of_type_Apep	Lapep;
    ...
    //   36: aload_0
    //   37: iconst_1
    //   38: putfield 29	apen:jdField_a_of_type_Int	I
    //   41: aload_0
    //   42: new 159	aper
    //   45: dup
    //   46: aload_0
    //   47: getfield 51	apen:jdField_a_of_type_Long	J
    //   50: invokespecial 162	aper:<init>	(J)V
    //   53: putfield 150	apen:jdField_a_of_type_Apep	Lapep;
    //   56: aload_0
    //   57: getfield 150	apen:jdField_a_of_type_Apep	Lapep;
    //   60: aload_0
    //   61: getfield 45	apen:jdField_a_of_type_Apeq	Lapeq;
    //   64: invokeinterface 155 2 0
    //   69: pop
    //   70: iload_3
    //   71: istore_1
    //   72: aload_0
    //   73: getfield 150	apen:jdField_a_of_type_Apep	Lapep;
    //   76: aload_0
    //   77: getfield 47	apen:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   80: aload_2
    //   81: invokeinterface 165 3 0
    //   86: ifeq +39 -> 125
    //   89: getstatic 22	apen:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   92: iconst_1
    ...
    //   105: aload_0
    //   106: getfield 51	apen:jdField_a_of_type_Long	J
    ...
    //   129: aload_0
    //   130: iconst_2
    //   131: putfield 29	apen:jdField_a_of_type_Int	I
    //   134: aload_0
    //   135: new 180	apez
    //   138: dup
    //   139: aload_0
    //   140: getfield 51	apen:jdField_a_of_type_Long	J
    //   143: invokespecial 181	apez:<init>	(J)V
    //   146: putfield 150	apen:jdField_a_of_type_Apep	Lapep;
    //   149: goto -93 -> 56
    //   152: astore_2
    //   153: aload_0
    //   154: monitorexit
  ...
  public int a()
  {
    if (this.jdField_a_of_type_Apep != null)
    {
      ...
      return this.jdField_a_of_type_Apep.a();
    }
  ...
  public void a(apeq paramapeq)
  {
    synchronized (this.jdField_b_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_JavaUtilList.contains(paramapeq)) {
        this.jdField_a_of_type_JavaUtilList.remove(paramapeq);
      }
      return;
    }
  }
  
  public void a(apeq paramapeq, boolean paramBoolean)
  {
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        ...
        if ((apeq)this.jdField_a_of_type_JavaUtilList.get(i) == paramapeq)
        {
          if (paramBoolean == true)
          {
            ...
            paramapeq = (apeq)this.jdField_a_of_type_JavaUtilList.remove(i);
            this.jdField_a_of_type_JavaUtilList.add(paramapeq);
      ...
      if (paramapeq != null)
      {
        ...
        apeq localapeq = (apeq)this.jdField_a_of_type_JavaUtilList.remove(i - 1);
        this.jdField_a_of_type_JavaUtilList.add(paramapeq);
        this.jdField_a_of_type_JavaUtilList.add(localapeq);
      }
      for (;;)
      {
  ...
  public boolean a(Bundle paramBundle)
  {
    ...
    String str1 = apck.b(apbo.a().c() + (String)localObject1);
    String str2 = apbo.a().b() + (String)localObject1;
    ...
    return a(apei.a((String)localObject1), (Bundle)localObject2);
  }
  ...
  public int b()
  {
    if (this.jdField_a_of_type_Apep != null)
    {
      ...
      return this.jdField_a_of_type_Apep.c();
    }
  ...
  public int c()
  {
    if (this.jdField_a_of_type_Apep != null)
    {
      ...
      return this.jdField_a_of_type_Apep.d();
    }
  ...
  public int d()
  {
    if (this.jdField_a_of_type_Apep != null)
    {
      ...
      return this.jdField_a_of_type_Apep.b();
    }
  ...
  public int e()
  {
    if (this.jdField_a_of_type_Apep != null)
    {
      ...
      return this.jdField_a_of_type_Apep.f();
    }
  ...
  {
    if (this.jdField_a_of_type_Apep != null) {
      return this.jdField_a_of_type_Apep.e();
    }
