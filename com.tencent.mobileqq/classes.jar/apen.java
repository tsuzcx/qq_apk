...
public class apen
{
  private static apen jdField_a_of_type_Apen = new apen();
  ...
  private apen()
  {
    ...
    if (!AppSetting.f().equals(localObject2))
    {
      ...
      bhsi.a((SharedPreferences.Editor)localObject2);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Boolean)
        {
          ...
          bhsi.a((SharedPreferences.Editor)localObject1);
          this.jdField_d_of_type_Int = 0;
          bool2 = bool1;
          continue;
        }
