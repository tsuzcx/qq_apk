  ...
  implements Manager
{
  ...
  {
    this.jdField_a_of_type_Axdh = new axdh();
  ...
  {
    bcst.b(paramQQAppInterface, "dc00899", "grp_lbs", paramString2, "pay_like", paramString1, 0, 0, paramString3, paramString4, paramString5, paramString6);
  ...
  {
    if ((this.jdField_a_of_type_Axdh == null) || (this.jdField_a_of_type_Axdh.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg == null)) {
      return null;
    }
    return a(this.jdField_a_of_type_Axdh.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_first_info.get());
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    try
    {
      ...
      {
        this.jdField_a_of_type_Axdh.jdField_a_of_type_Int = paramInt1;
        this.jdField_a_of_type_Axdh.c = paramInt2;
        this.jdField_a_of_type_Axdh.d = paramInt3;
        if (QLog.isColorLevel()) {
  ...
  public void a(long paramLong, int paramInt1, int paramInt2)
  {
    for (;;)
    {
      try
      {
        ...
        axdf localaxdf = (axdf)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
        if (localaxdf == null)
        {
          if ((paramInt1 > 0) || (paramInt2 > 0))
          {
            localaxdf = new axdf();
            localaxdf.jdField_a_of_type_Long = paramLong;
            localaxdf.jdField_a_of_type_Int += paramInt1;
            localaxdf.b += paramInt2;
            localaxdf.c += this.jdField_a_of_type_Axdh.b * paramInt2;
            this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong), localaxdf);
            localObject2 = this.jdField_a_of_type_Axdh;
            ((axdh)localObject2).f += 1;
            localObject2 = this.jdField_a_of_type_Axdh;
            ((axdh)localObject2).e -= this.jdField_a_of_type_Axdh.b * paramInt2;
          }
          if (QLog.isColorLevel())
          {
      ...
      localObject1.c += this.jdField_a_of_type_Axdh.b * paramInt2;
      this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong), localObject1);
      Object localObject2 = this.jdField_a_of_type_Axdh;
      ((axdh)localObject2).e -= this.jdField_a_of_type_Axdh.b * paramInt2;
      continue;
      label377:
      boolean bool = false;
  ...
  public void a(Activity paramActivity, QQAppInterface paramQQAppInterface, String paramString1, axdi paramaxdi, String paramString2)
  {
    for (;;)
    {
      try
      {
        if (QLog.isColorLevel()) {
          QLog.d("NearbyLikeLimitManager", 2, "checkCanDoVote, uin=" + paramString1 + ", from=" + paramString2 + ", mLimitInfo=" + this.jdField_a_of_type_Axdh);
        }
        ...
        if ((bool1) && (c()))
        {
          ...
          if (i != 0)
          {
            paramActivity = bglp.a(paramActivity, 0, null, localSpannableString, anni.a(2131705988), anni.a(2131705984), anni.a(2131705983), new axdb(this, bool1, paramString1, paramaxdi, paramQQAppInterface, paramString2, paramActivity), new axdc(this, paramActivity, paramQQAppInterface, paramString2));
        ...
        if (a())
        {
          ...
          paramaxdi.a(paramString1, false);
  ...
  {
    bglp.a(paramActivity, 230).setTitle(anni.a(2131705989)).setMessage(anni.a(2131705985)).setNegativeButton(anni.a(2131705987), new axde(this)).setPositiveButton(anni.a(2131705986), new axdd(this, paramActivity)).show();
  }
  
  public void a(axdh paramaxdh, List<axdf> paramList, int paramInt)
  {
    try
    {
      this.jdField_a_of_type_Axdh = paramaxdh;
      if (paramInt == 511) {
        this.jdField_a_of_type_JavaUtilHashMap.clear();
      }
      paramaxdh = new StringBuilder();
      if ((paramList != null) && (paramList.size() > 0))
      {
        paramList = paramList.iterator();
        while (paramList.hasNext())
        {
          axdf localaxdf = (axdf)paramList.next();
          this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(localaxdf.jdField_a_of_type_Long), localaxdf);
          if (QLog.isColorLevel()) {
            paramaxdh.append(localaxdf).append(" | ");
          }
        }
      }
      if (!QLog.isColorLevel()) {
    ...
    QLog.d("NearbyLikeLimitManager", 2, "updateFromServer, mLimitInfo=" + this.jdField_a_of_type_Axdh + ", mLikeItemMap=[" + paramaxdh + "]");
    label165:
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Axdh.e >= this.jdField_a_of_type_Axdh.b)
        {
          bool1 = bool2;
          bool2 = bool1;
          if (QLog.isColorLevel())
  ...
  public boolean a(long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Axdh.f < this.jdField_a_of_type_Axdh.c) {
          break label165;
        }
        bool1 = true;
      }
      ...
      if (QLog.isColorLevel())
      {
        ...
        bool1 = false;
        break label219;
        if ((this.jdField_a_of_type_Axdh.f >= this.jdField_a_of_type_Axdh.c) && (localObject.b > 0))
        {
  ...
  public boolean a(String paramString)
  {
    ...
    //   56: ireturn
    //   57: aload_0
    //   58: getfield 35	axda:jdField_a_of_type_JavaUtilHashSet	Ljava/util/HashSet;
    //   61: aload_1
  ...
  public SpannableString b()
  {
    ...
    return a(this.jdField_a_of_type_Axdh.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_user_num_limit_info.get());
  }
  ...
  public boolean b(long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        axdf localaxdf = (axdf)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
        boolean bool1;
        if ((this.jdField_a_of_type_Axdh == null) || (localaxdf == null))
        {
          if (QLog.isColorLevel())
          {
        ...
        if (localaxdf.jdField_a_of_type_Int >= this.jdField_a_of_type_Axdh.d)
        {
          bool1 = true;
          bool2 = bool1;
          if (QLog.isColorLevel())
  ...
  public SpannableString c()
  {
    ...
    return a(this.jdField_a_of_type_Axdh.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg.rpt_msg_zan_limit_info.get());
  }
  ...
  public boolean c()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Axdh != null) && (this.jdField_a_of_type_Axdh.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg != null)) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
  ...
  public boolean c(long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 30	axda:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   6: lload_1
    ...
    //   13: checkcast 335	axdf
    //   16: astore 5
    //   18: aload_0
    //   19: getfield 25	axda:jdField_a_of_type_Axdh	Laxdh;
    //   22: astore 6
    //   24: aload 6
    //   26: ifnull +8 -> 34
    //   29: aload 5
    ...
    //   16	27	5	localaxdf	axdf
    //   64	5	5	localObject	Object
    //   22	3	6	localaxdh	axdh
    // Exception table:
    //   from	to	target	type
    //   2	24	64	finally
    //   42	48	64	finally
  ...
  public boolean d()
  {
    if ((this.b) && (this.jdField_a_of_type_Axdh != null) && (this.jdField_a_of_type_Axdh.jdField_a_of_type_TencentImOidbOidb_0x8e7Oidb_0x8e7$WarnMsg != null)) {}
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
  ...
  public void onDestroy()
  {
    try
    {
      this.jdField_a_of_type_Axdh = null;
      this.jdField_a_of_type_JavaUtilHashMap.clear();
      if (QLog.isColorLevel()) {
