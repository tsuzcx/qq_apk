  ...
  implements View.OnClickListener
{
  ...
  public bmcr(QQComicTabBarView paramQQComicTabBarView, int paramInt, boolean paramBoolean, List<WebViewTabBarData> paramList)
  {
  ...
  void a(QQComicTabBarView paramQQComicTabBarView)
  {
    ...
    {
      localObject = ((QQBrowserActivity)paramQQComicTabBarView.getContext()).getHostFragment();
    ...
    try
    {
      ...
      ((bmcg)localObject).dispatchJsEvent("qbrowserTabClick", null, localJSONObject);
