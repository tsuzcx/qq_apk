  ...
  implements bkch
{
  ...
  public static bkch a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("cooperation.smartdevice.ipc.ISmartDeviceService");
    if ((localIInterface != null) && ((localIInterface instanceof bkch))) {
      return (bkch)localIInterface;
    }
    return new bkcj(paramIBinder);
  }
