...
public abstract class bdbk
  extends bdaf
  implements bday
{
  Paint jdField_a_of_type_AndroidGraphicsPaint;
  RectF jdField_a_of_type_AndroidGraphicsRectF = new RectF();
  bdbl jdField_a_of_type_Bdbl;
  FaceInfo jdField_a_of_type_ComTencentMobileqqUtilFaceInfo;
  boolean b;
  boolean c;
  
  protected bdbk(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString, byte paramByte, int paramInt3, int paramInt4, boolean paramBoolean1, Drawable paramDrawable1, Drawable paramDrawable2, bdbl parambdbl, boolean paramBoolean2)
  {
    super(paramDrawable1, paramDrawable2);
    this.jdField_c_of_type_Boolean = true;
    long l1 = System.currentTimeMillis();
    a(paramAppInterface);
    this.jdField_a_of_type_Bdbl = parambdbl;
    if ((paramInt1 == 101) || (paramInt1 == 1001)) {
      paramInt3 = 3;
    }
    this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo = new FaceInfo(paramInt1, paramString, false, paramByte, bdbu.a((byte)paramInt3), paramBoolean1, paramInt2, paramBoolean2, paramInt4);
    if ((paramInt1 == 4) && (!bcpx.a(paramString))) {
      this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.jdField_a_of_type_Int = 113;
    }
    if ((this instanceof bdcx))
    {
      paramAppInterface = b();
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Bdbl != null) {
        this.jdField_a_of_type_Bdbl.onLoadingStateChanged(-1, this.jdField_a_of_type_Int);
      }
  ...
  public static bdbk a(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString)
  {
  ...
  public static bdbk a(AppInterface paramAppInterface, int paramInt, String paramString)
  {
    int i = a(paramInt);
  ...
  public static bdbk a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2)
  {
    int i = a(paramInt1);
  ...
  public static bdbk a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, Drawable paramDrawable1, Drawable paramDrawable2)
  {
    return a(paramAppInterface, paramInt1, paramString, paramInt2, paramDrawable1, paramDrawable2, null);
  }
  
  public static bdbk a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, Drawable paramDrawable1, Drawable paramDrawable2, int paramInt3)
  {
    return a(paramAppInterface, paramInt1, paramString, paramInt2, paramDrawable1, paramDrawable2, null);
  }
  
  public static bdbk a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, Drawable paramDrawable1, Drawable paramDrawable2, bdbl parambdbl)
  {
    return a(paramAppInterface, paramInt1, paramString, paramInt2, paramDrawable1, paramDrawable2, parambdbl, false);
  }
  
  public static bdbk a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, Drawable paramDrawable1, Drawable paramDrawable2, bdbl parambdbl, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((paramAppInterface instanceof QQAppInterface)) {
        return new bdbm(paramAppInterface, paramInt1, 200, paramString, (byte)0, paramInt2, 100, false, paramDrawable1, paramDrawable2, parambdbl, paramBoolean);
      }
    } while (!(paramAppInterface instanceof NearbyAppInterface));
    return new bdcx(paramAppInterface, paramInt1, 200, paramString, (byte)1, paramInt2, false, paramDrawable1, paramDrawable2, parambdbl, paramBoolean);
  }
  
  public static bdbk a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, bdbl parambdbl)
  {
    return a(paramAppInterface, paramInt1, paramString, paramInt2, parambdbl, false);
  }
  
  public static bdbk a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, bdbl parambdbl, boolean paramBoolean)
  {
    if ((TextUtils.isEmpty(paramString)) || (paramAppInterface == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if ((paramAppInterface instanceof QQAppInterface)) {
        return new bdbm(paramAppInterface, 32, paramInt1, paramString, (byte)1, paramInt2, 100, true, localDrawable, localDrawable, parambdbl, paramBoolean);
      }
    } while (!(paramAppInterface instanceof NearbyAppInterface));
    return new bdcx(paramAppInterface, 32, paramInt1, paramString, (byte)1, paramInt2, true, localDrawable, localDrawable, parambdbl, paramBoolean);
  }
  
  public static bdbk a(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2, boolean paramBoolean)
  {
    if ((TextUtils.isEmpty(paramString)) || (paramAppInterface == null)) {
      if (QLog.isColorLevel()) {
        QLog.i("Q.qqhead.FaceDrawable", 2, "getFaceDrawable fail, uin=" + paramString + ", idType=" + paramInt1 + ",appIntf=" + paramAppInterface + ",shape=" + paramInt2);
    ...
    do
    {
      ...
      localDrawable = a(32, paramInt2);
      if ((paramAppInterface instanceof QQAppInterface)) {
        return new bdbm(paramAppInterface, 32, paramInt1, paramString, (byte)1, paramInt2, 100, true, localDrawable, localDrawable, null, paramBoolean);
      }
    } while (!(paramAppInterface instanceof NearbyAppInterface));
    return new bdcx(paramAppInterface, 32, paramInt1, paramString, (byte)1, paramInt2, true, localDrawable, localDrawable, null, paramBoolean);
  }
  
  public static bdbk a(AppInterface paramAppInterface, int paramInt, String paramString, boolean paramBoolean)
  {
    return a(paramAppInterface, paramInt, paramString, paramBoolean, false);
  }
  
  public static bdbk a(AppInterface paramAppInterface, int paramInt, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((TextUtils.isEmpty(paramString)) || (paramAppInterface == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      if ((paramAppInterface instanceof QQAppInterface)) {
        return new bdbm(paramAppInterface, 32, paramInt, paramString, (byte)1, 3, 100, paramBoolean1, localDrawable, localDrawable, null, paramBoolean2);
      }
    } while (!(paramAppInterface instanceof NearbyAppInterface));
    return new bdcx(paramAppInterface, 32, paramInt, paramString, (byte)1, 3, paramBoolean1, localDrawable, localDrawable, null, paramBoolean2);
  }
  
  public static bdbk a(AppInterface paramAppInterface, String paramString, byte paramByte)
  {
  ...
  public static bdbk b(AppInterface paramAppInterface, int paramInt1, String paramString, int paramInt2)
  {
    return a(paramAppInterface, paramInt1, paramString, paramInt2, false);
  }
  
  public static bdbk b(AppInterface paramAppInterface, String paramString, byte paramByte)
  {
  ...
  public void a()
  {
    if (!this.jdField_b_of_type_Boolean)
    {
      ...
      setCallback(null);
      this.jdField_a_of_type_Bdbl = null;
      a(null);
    }
    super.a();
  }
  ...
  public void a(FaceInfo paramFaceInfo, Bitmap paramBitmap)
  {
    ...
    {
      invalidateSelf();
      if ((i == this.jdField_a_of_type_Int) || (this.jdField_a_of_type_Bdbl == null)) {
        break;
      }
      this.jdField_a_of_type_Bdbl.onLoadingStateChanged(i, this.jdField_a_of_type_Int);
      return;
      i = j;
      if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null) {
        break label107;
  ...
  {
    if ((this.jdField_c_of_type_Boolean) && (bibv.a()))
    {
