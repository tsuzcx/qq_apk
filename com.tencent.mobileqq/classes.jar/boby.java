...
public class boby
{
  ...
  private static final String b = "https://dlied5sdk.myapp.com/weiyun/android/qq/" + a + "/weiyunLibrary" + 1004 + ".zip";
  private static final String c = "https://dlied5sdk.myapp.com/weiyun/android/qq/" + a + "/librarySize" + 1004 + ".txt";
  ...
  public static void a(Context paramContext, bocb parambocb)
  {
    ...
    {
      if (parambocb != null) {
        parambocb.a(localFile1.getAbsolutePath(), localFile2.getAbsolutePath());
      }
      return;
    }
    String str2 = bocd.a(123L);
    String str1 = str2 + "weiyunLibrary.zip";
    str2 = str2 + "sizeLibrary.txt";
    boan.a().a(b, str1, "SoHelper", new bobz(str2, str1, parambocb, paramContext, localFile1, localFile2));
  }
  ...
  public static boolean a(Context paramContext)
  {
    ...
    paramContext = bobx.a(paramContext, "0", "key_local_so_version");
