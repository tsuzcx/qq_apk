  ...
  extends BaseAdapter
{
  ...
  {
    this.jdField_a_of_type_Ajxl = ((ajxl)paramChatSettingForTroop.app.getManager(51));
    a();
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      localaazb = new aazb();
      localaazb.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131367679));
      localaazb.jdField_a_of_type_AndroidWidgetTextView = ((ColorNickTextView)localView.findViewById(2131370647));
      localView.setTag(localaazb);
      if (ThemeUtil.isInNightMode(this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.app)) {
        localaazb.jdField_a_of_type_AndroidWidgetImageView.setColorFilter(1996488704);
      }
      localView.setVisibility(0);
      localView.setFocusable(false);
      localTextView = localaazb.jdField_a_of_type_AndroidWidgetTextView;
      localImageView = localaazb.jdField_a_of_type_AndroidWidgetImageView;
      if ((!this.jdField_a_of_type_Boolean) || (paramInt != getCount() - 1)) {
        break label248;
      }
      localTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.getString(2131693672));
      ...
      localaazb.jdField_a_of_type_JavaLangString = "";
    }
    label248:
    String str;
    for (;;)
    {
      ...
      return localView;
      localaazb = (aazb)paramView.getTag();
      localView = paramView;
      break;
      if (paramInt < this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.jdField_d_of_type_JavaUtilList.size())
      {
        ...
        localaazb.jdField_a_of_type_JavaLangString = str;
    ...
    for (paramViewGroup = bbcz.c(this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.app, this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopuin, str, true);; paramViewGroup = str)
    {
      if (!TextUtils.isEmpty(paramViewGroup))
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.jdField_d_of_type_Boolean)
        {
          ...
          if (TextUtils.isDigitsOnly(paramView)) {
            paramViewGroup = ajya.a(2131701759);
          }
        }
        paramView = new ayjw(paramViewGroup, 12).a();
        localTextView.setText(paramView);
        bbos.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.app, localTextView, paramView);
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.a(localaazb, null, true);
      localImageView.setTag(2131376870, str);
      localImageView.setTag(Integer.valueOf(3));
      break;
      bbcz.a(this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.app, this.jdField_a_of_type_ComTencentMobileqqActivityChatSettingForTroop.jdField_a_of_type_ComTencentMobileqqDataTroopInfo.troopuin, str, new aave(this, localaazb, str, localTextView));
    }
  }
