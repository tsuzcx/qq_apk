...
public class autu
{
  ...
  public autu(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
        localalto = (alto)localQQAppInterface.getManager(51);
        localExtensionInfo = localalto.a(paramString, true);
        bool1 = localalto.a(false);
      } while ((bool1) || (localExtensionInfo == null));
      i = autp.a(6, paramString, localExtensionInfo, bool1);
      j = autp.a(5, paramString, localExtensionInfo, bool1);
      l1 = localExtensionInfo.lastFriendshipTime;
      l2 = localExtensionInfo.lastChatTime;
      int k = autp.b();
      bool1 = autp.a(k, l2 * 1000L);
      bool2 = autp.a(k, l1 * 1000L);
    ...
    if (bdns.c(l2) == 2131720894)
    {
      bool1 = true;
      label279:
      if (bdns.c(l3) != 2131720894) {
        break label507;
      }
      bool2 = true;
      label292:
