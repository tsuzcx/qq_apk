...
public class bpkx
  implements bpil
{
  public bpkx(DoodleLayout paramDoodleLayout) {}
  
  public void a()
  {
    yqp.b("DoodleLayout", "deleteInteractPaster.");
    if (DoodleLayout.a(this.a) != null)
    {
      bpaa localbpaa = (bpaa)DoodleLayout.a(this.a).a(bpaa.class);
      if (localbpaa != null) {
        localbpaa.b();
      }
    }
  ...
  public boolean a(bpim parambpim)
  {
    if (this.a.a != null)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        yqu.a("video_shoot_new", "qa_edit", 2, 0, new String[0]);
        return true;
      }
    }
    return false;
