...
public class azym
{
  ...
  public static Bitmap a(int paramInt, Bitmap.Config paramConfig, Bitmap[] paramArrayOfBitmap)
  {
    ...
    Object localObject = new azyo[j];
    i = 0;
    while (i < j)
    {
      localObject[i] = new azyo(null);
      i += 1;
    }
  ...
  public static Bitmap a(int paramInt, Bitmap[] paramArrayOfBitmap)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        arrayOfazyo = new azyo[i];
        j = 0;
        while (j < i)
        {
          arrayOfazyo[j] = new azyo(null);
          j += 1;
        }
        ...
        arrayOfazyo[0].a = 0;
        arrayOfazyo[0].b = 0;
        arrayOfazyo[0].c = (paramInt / 2 - 1);
        arrayOfazyo[0].d = paramInt;
        arrayOfazyo[0].e = 1;
        arrayOfazyo[1].a = (paramInt / 2 + 1);
        arrayOfazyo[1].b = 0;
        arrayOfazyo[1].c = paramInt;
        arrayOfazyo[1].d = paramInt;
        arrayOfazyo[1].e = 1;
        paramInt = 0;
    ...
    if (arrayOfazyo[paramInt].e == 1) {
      localRect.set(j / 4, 0, j / 4 * 3, k);
    }
    for (;;)
    {
      localRectF.set(arrayOfazyo[paramInt].a, arrayOfazyo[paramInt].b, arrayOfazyo[paramInt].c, arrayOfazyo[paramInt].d);
      ...
      if (i == 3)
      {
        ...
        arrayOfazyo[1].b = 0;
        arrayOfazyo[1].c = paramInt;
        arrayOfazyo[1].d = (paramInt / 2 - 1);
        arrayOfazyo[1].e = 2;
        arrayOfazyo[2].a = (paramInt / 2 + 1);
        arrayOfazyo[2].b = (paramInt / 2 + 1);
        arrayOfazyo[2].c = paramInt;
        arrayOfazyo[2].d = paramInt;
        arrayOfazyo[2].e = 2;
        break;
      }
      if (i < 4) {
      ...
      arrayOfazyo[2].e = 2;
      arrayOfazyo[3].a = 0;
      arrayOfazyo[3].b = (paramInt / 2 + 1);
      arrayOfazyo[3].c = (paramInt / 2 - 1);
      arrayOfazyo[3].d = paramInt;
      arrayOfazyo[3].e = 2;
      break;
