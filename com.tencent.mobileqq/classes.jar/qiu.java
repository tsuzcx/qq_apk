  ...
  extends ont
{
  ...
  public void a(boolean paramBoolean, String paramString1, int paramInt, String paramString2)
  {
    ...
    while (!qim.a(this.a).contains(paramString1)) {
      return;
    }
    paramString2 = new bbmy(qim.a(this.a));
    paramString2.d(2000);
    if (paramBoolean)
    {
      paramString2.a(bbmy.a(2));
      paramString2.c(2131626723);
      paramString2.b(qim.a(this.a).getResources().getDimensionPixelSize(2131167766) - (int)bacc.a(qim.a(this.a), 5.0F));
    }
    for (;;)
    {
      qim.a(this.a).remove(paramString1);
      return;
