...
public class qiu
  extends qii
{
  public qiu(qep paramqep, Handler paramHandler, AppInterface paramAppInterface, EntityManager paramEntityManager, qxn paramqxn, ExecutorService paramExecutorService)
  {
  ...
  public void a(long paramLong, int paramInt)
  {
    ...
    ((oidb_cmd0x75e.ReqBody)localObject).uint32_network_type.set(qer.a());
    ...
    localObject = qxp.a("OidbSvc.0x75e", 1886, 0, ((oidb_cmd0x75e.ReqBody)localObject).toByteArray());
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      bmhv.b(this.jdField_a_of_type_ComTencentCommonAppAppInterface);
      return;
