  ...
  extends AlbumListAdapter
{
  ...
  public akmb(AlbumListFragment paramAlbumListFragment)
  {
    super(paramAlbumListFragment);
  }
  
  private static void c(akmc paramakmc, String paramString, QQAlbumInfo paramQQAlbumInfo)
  {
    String str = paramQQAlbumInfo.name;
    if (paramString.contains("/qq_collection/"))
    {
      paramakmc.f += paramQQAlbumInfo.mMediaFileCount;
      return;
    }
    if ((str.equals("qq_images")) || (paramString.contains("/mobileqq/photo")) || (paramString.contains("/mobileqq/diskcache")))
    {
      paramakmc.g += paramQQAlbumInfo.mMediaFileCount;
      return;
    }
    if (str.equals("qqfile_recv"))
    {
      paramakmc.h += paramQQAlbumInfo.mMediaFileCount;
      return;
    }
    if (str.equals("qq_favorite"))
    {
      paramakmc.j += paramQQAlbumInfo.mMediaFileCount;
      return;
    }
    ...
    {
      paramakmc.k += paramQQAlbumInfo.mMediaFileCount;
      return;
    }
    if (aklj.a(paramString))
    {
      paramakmc.d += paramQQAlbumInfo.mMediaFileCount;
      return;
    }
    paramakmc.e += paramQQAlbumInfo.mMediaFileCount;
  }
  
  private static void d(akmc paramakmc, String paramString, QQAlbumInfo paramQQAlbumInfo)
  {
    String str = paramQQAlbumInfo.name;
    if (str.equals("qq_screenshot"))
    {
      paramakmc.b += paramQQAlbumInfo.mMediaFileCount;
      return;
    }
    ...
    {
      paramakmc.c += paramQQAlbumInfo.mMediaFileCount;
      return;
    }
    ...
    {
      paramakmc.a += paramQQAlbumInfo.mMediaFileCount;
      return;
    }
    if (aklj.a(paramString))
    {
