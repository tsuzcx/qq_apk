...
public class akge
  extends bhow
{
  public akge(AvatarPendantActivity paramAvatarPendantActivity) {}
  ...
  protected void handlePendantAuth(boolean paramBoolean, Object paramObject)
  {
    ...
    do
    {
      ...
      if (this.a.jdField_a_of_type_Bhll != null) {
        this.a.jdField_a_of_type_Bhll.c = -1;
      }
      bdla.b(this.a.app, "CliOper", "", "", "0X8005FD4", "0X8005FD4", 0, 0, "", "", "", "");
      if ((this.a.jdField_a_of_type_Amfs != null) && (this.a.jdField_a_of_type_JavaUtilList != null))
      {
        paramObject = ((AvatarPendantManager)this.a.app.getManager(QQManagerFactory.CHAT_AVATAR_PENDANT_MANAGER)).a();
        this.a.jdField_a_of_type_Amfs.a(paramObject, this.a.jdField_a_of_type_JavaUtilList);
      }
    } while ((this.a.jdField_a_of_type_Bhlk == null) || (!this.a.jdField_a_of_type_Bhlk.jdField_a_of_type_Boolean));
    localObject = bhnp.a("linkPendantSet");
    paramObject = localObject;
    if (localObject != null) {
      paramObject = ((String)localObject).replace("[id]", String.valueOf(this.a.jdField_a_of_type_Bhlk.jdField_a_of_type_Int));
    }
    ...
    bdla.b(this.a.app, "CliOper", "", "", "0X8006517", "0X8006517", 0, 0, "", "", "", "");
    return;
    this.a.jdField_a_of_type_AndroidWidgetButton.setText(2131718577);
    ...
    {
      bdla.b((QQAppInterface)localObject, "CliOper", "", "", "0X8005FD6", "0X8005FD6", 0, 0, paramObject, "", "", "");
      if (!this.a.d) {
        break;
      }
      this.a.d = false;
