...
public abstract class bhcq
{
  ...
  public bhcq(Context paramContext)
  {
    this(paramContext, 3);
  }
  
  public bhcq(Context paramContext, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_AndroidHardwareSensor != null) {
      this.jdField_a_of_type_AndroidHardwareSensorEventListener = new bhcr(this);
    }
  }
