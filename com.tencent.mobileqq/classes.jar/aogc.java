  ...
  implements Camera.AutoFocusCallback
{
  ...
  SensorEventListener jdField_a_of_type_AndroidHardwareSensorEventListener = new aogd(this);
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new aoge(this, Looper.getMainLooper());
    ...
    try
    {
      if (this.jdField_a_of_type_AndroidHardwareCamera != null)
      {
        ...
        if (localParameters.isZoomSupported())
        {
          ...
          {
            b(i1, this.i);
            bcef.b(null, "dc00898", "", "", "0X80085B0", "0X80085B0", 0, 0, "", "", "", "");
          }
        }
      }
      return;
  ...
  public int a(int paramInt, long paramLong)
  {
    ...
    //   16: aload_0
    //   17: getfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    ...
    //   29: aload_0
    //   30: getfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   33: ifnull +37 -> 70
    //   36: getstatic 46	aogc:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   39: astore 6
    //   41: aload 6
    //   43: monitorenter
    //   44: iconst_0
    //   45: putstatic 48	aogc:jdField_c_of_type_Int	I
    //   48: invokestatic 366	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   51: invokevirtual 370	java/lang/Thread:getId	()J
    //   54: putstatic 52	aogc:jdField_a_of_type_Long	J
    //   57: aload 6
    //   59: monitorexit
    //   60: iconst_0
    //   61: ireturn
    ...
    //   125: ifle +76 -> 201
    //   128: iload_1
    //   129: invokestatic 403	aogc:b	(I)I
    //   132: istore 4
    //   134: aload_0
    //   135: iload 4
    //   137: iconst_1
    //   138: invokestatic 408	bjmi:a	(II)Landroid/hardware/Camera;
    //   141: putfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   144: aload_0
    //   145: getfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    ...
    //   158: iconst_1
    //   159: iconst_1
    //   160: invokestatic 408	bjmi:a	(II)Landroid/hardware/Camera;
    //   163: putfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   166: iconst_1
    //   167: istore 4
    //   169: aload_0
    //   170: getfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   173: ifnull +28 -> 201
    ...
    //   198: putfield 413	aogc:m	I
    //   201: aload_0
    //   202: getfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   205: ifnonnull +154 -> 359
    //   208: ldc 173
    //   210: iconst_1
    //   211: ldc_w 415
    //   214: invokestatic 277	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   217: getstatic 46	aogc:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   220: astore 6
    //   222: aload 6
    //   224: monitorenter
    //   225: bipush 253
    //   227: putstatic 48	aogc:jdField_c_of_type_Int	I
    //   230: invokestatic 366	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   233: invokevirtual 370	java/lang/Thread:getId	()J
    //   236: putstatic 52	aogc:jdField_a_of_type_Long	J
    //   239: aload 6
    //   241: monitorexit
    //   242: bipush 253
    //   244: ireturn
    ...
    //   271: getstatic 46	aogc:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   274: astore 6
    //   276: aload 6
    //   278: monitorenter
    //   279: bipush 253
    //   281: putstatic 48	aogc:jdField_c_of_type_Int	I
    //   284: invokestatic 366	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   287: invokevirtual 370	java/lang/Thread:getId	()J
    //   290: putstatic 52	aogc:jdField_a_of_type_Long	J
    //   293: aload 6
    //   295: monitorexit
    //   296: bipush 253
    //   298: ireturn
    ...
    //   340: iconst_m1
    //   341: iconst_1
    //   342: invokestatic 408	bjmi:a	(II)Landroid/hardware/Camera;
    //   345: putfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   348: goto -147 -> 201
    //   351: astore 7
    //   353: aload 6
    //   355: monitorexit
    ...
    //   358: athrow
    //   359: aload_0
    //   360: getfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   363: sipush 1280
    //   366: sipush 720
    //   369: invokestatic 431	aoel:a	()Laoel;
    //   372: getfield 432	aoel:jdField_a_of_type_Int	I
    //   375: invokestatic 435	hg:a	(Landroid/hardware/Camera;III)V
    //   378: bipush 90
    //   380: istore 5
    //   382: iload 5
    //   384: istore 4
    //   386: getstatic 437	bbub:g	Ljava/lang/String;
    //   389: invokestatic 298	bbub:d	(Ljava/lang/String;)Z
    //   392: ifeq +16 -> 408
    //   395: iload 5
    //   397: istore 4
    //   399: iload_1
    ...
    //   417: getstatic 439	bbub:e	Ljava/lang/String;
    //   420: invokestatic 298	bbub:d	(Ljava/lang/String;)Z
    //   423: ifne +253 -> 676
    //   426: iload 4
    //   428: istore 5
    //   430: getstatic 441	bbub:f	Ljava/lang/String;
    //   433: invokestatic 443	bbub:b	(Ljava/lang/String;)Z
    //   436: ifeq +6 -> 442
    //   439: goto +237 -> 676
    //   442: aload_0
    //   443: getfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   446: iload 5
    //   448: invokevirtual 446	android/hardware/Camera:setDisplayOrientation	(I)V
    //   451: aload_0
    //   452: getfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    ...
    //   500: putfield 360	aogc:jdField_d_of_type_Int	I
    //   503: aload_0
    //   504: aload 8
    //   506: getfield 470	android/hardware/Camera$Size:height	I
    //   509: putfield 472	aogc:e	I
    //   512: aload_0
    //   513: iconst_0
    //   514: putfield 149	aogc:jdField_a_of_type_Boolean	Z
    //   517: aload_0
    //   518: aload 6
    //   520: invokevirtual 321	android/hardware/Camera$Parameters:getZoom	()I
    //   523: putfield 323	aogc:i	I
    //   526: aload_0
    //   527: aload 6
    ...
    //   586: aload_0
    //   587: getfield 360	aogc:jdField_d_of_type_Int	I
    //   590: aload_0
    //   591: getfield 472	aogc:e	I
    //   594: imul
    //   595: aload 7
    ...
    //   613: aload_0
    //   614: getfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   617: iload 4
    //   619: newarray byte
    ...
    //   636: aload 7
    //   638: athrow
    //   639: getstatic 46	aogc:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   642: astore 6
    //   644: aload 6
    //   646: monitorenter
    //   647: iconst_0
    //   648: putstatic 48	aogc:jdField_c_of_type_Int	I
    //   651: invokestatic 366	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   654: invokevirtual 370	java/lang/Thread:getId	()J
    //   657: putstatic 52	aogc:jdField_a_of_type_Long	J
    //   660: aload 6
    //   662: monitorexit
    //   663: iconst_0
    //   664: ireturn
  ...
  public void a()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Aogf = null;
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (this.jdField_a_of_type_AndroidHardwareCamera != null) {
      aoln.a().a(new ARCamera.1(this, paramInt1, paramInt2, paramInt3, paramInt4));
    }
  }
  ...
  public boolean a()
  {
    ...
    //   11: iconst_0
    //   12: aload_0
    //   13: getfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   16: aastore
    ...
    //   23: aload_0
    //   24: getfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   27: ifnull +124 -> 151
    //   30: aload_0
    //   31: getfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   34: invokevirtual 557	android/hardware/Camera:release	()V
    //   37: aload_0
    //   38: aconst_null
    //   39: putfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   42: getstatic 46	aogc:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   45: astore_1
    //   46: aload_1
    //   47: monitorenter
    //   48: bipush 253
    //   50: putstatic 48	aogc:jdField_c_of_type_Int	I
    //   53: invokestatic 366	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   56: invokevirtual 370	java/lang/Thread:getId	()J
    //   59: putstatic 52	aogc:jdField_a_of_type_Long	J
    //   62: aload_1
    //   63: monitorexit
    //   64: iconst_1
    //   65: ireturn
    ...
    //   82: aload_0
    //   83: aconst_null
    //   84: putfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   87: getstatic 46	aogc:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   90: astore_1
    //   91: aload_1
    //   92: monitorenter
    //   93: bipush 253
    //   95: putstatic 48	aogc:jdField_c_of_type_Int	I
    //   98: invokestatic 366	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   101: invokevirtual 370	java/lang/Thread:getId	()J
    //   104: putstatic 52	aogc:jdField_a_of_type_Long	J
    //   107: aload_1
    //   108: monitorexit
    //   109: iconst_1
    //   110: ireturn
    ...
    //   117: aload_0
    //   118: aconst_null
    //   119: putfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   122: getstatic 46	aogc:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   125: astore_1
    //   126: aload_1
    //   127: monitorenter
    //   128: bipush 253
    //   130: putstatic 48	aogc:jdField_c_of_type_Int	I
    //   133: invokestatic 366	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   136: invokevirtual 370	java/lang/Thread:getId	()J
    //   139: putstatic 52	aogc:jdField_a_of_type_Long	J
    //   142: aload_1
    //   143: monitorexit
    //   144: aload_2
    //   145: athrow
  ...
  /* Error */
  public boolean a(android.hardware.Camera.PreviewCallback paramPreviewCallback, android.graphics.SurfaceTexture paramSurfaceTexture, aogf paramaogf)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 4
    ...
    //   25: iconst_2
    //   26: aload_0
    //   27: getfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   30: aastore
    ...
    //   37: aload_0
    //   38: getfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   41: ifnull +76 -> 117
    //   44: aload_0
    //   45: getfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   48: aload_1
    //   49: invokevirtual 501	android/hardware/Camera:setPreviewCallbackWithBuffer	(Landroid/hardware/Camera$PreviewCallback;)V
    //   52: aload_0
    //   53: getfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   56: aload_2
    //   57: invokevirtual 595	android/hardware/Camera:setPreviewTexture	(Landroid/graphics/SurfaceTexture;)V
    //   60: aload_0
    //   61: getfield 144	aogc:jdField_a_of_type_AndroidHardwareCamera	Landroid/hardware/Camera;
    //   64: invokevirtual 598	android/hardware/Camera:startPreview	()V
    //   67: aload_0
    //   68: aload_3
    //   69: putfield 506	aogc:jdField_a_of_type_Aogf	Laogf;
    //   72: aload_0
    //   73: getfield 96	aogc:jdField_a_of_type_AndroidHardwareSensorManager	Landroid/hardware/SensorManager;
    //   76: ifnull +24 -> 100
    //   79: aload_0
    //   80: getfield 96	aogc:jdField_a_of_type_AndroidHardwareSensorManager	Landroid/hardware/SensorManager;
    //   83: aload_0
    //   84: getfield 65	aogc:jdField_a_of_type_AndroidHardwareSensorEventListener	Landroid/hardware/SensorEventListener;
    //   87: aload_0
    //   88: getfield 96	aogc:jdField_a_of_type_AndroidHardwareSensorManager	Landroid/hardware/SensorManager;
    //   91: iconst_1
  ...
  public void onAutoFocus(boolean paramBoolean, Camera paramCamera)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Aogf != null) {
        this.jdField_a_of_type_Aogf.a(paramBoolean);
      }
