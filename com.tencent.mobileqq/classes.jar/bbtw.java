  ...
  implements SensorEventListener
{
  ...
  public void onSensorChanged(SensorEvent paramSensorEvent)
  {
    ...
    if ((bbtt.jdField_b_of_type_Int == 1) && (bbtt.jdField_b_of_type_Boolean))
    {
      this.a.c = ((int)paramSensorEvent.values[0]);
      bbtt.jdField_b_of_type_Boolean = false;
    }
    if (bbtt.jdField_b_of_type_Int == 3)
    {
      bbtt.jdField_b_of_type_Int = 0;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        bbtt.jdField_b_of_type_Boolean = true;
        return;
      }
