  ...
  extends aczw
{
  ...
  private adyu jdField_a_of_type_Adyu;
  protected Rect a;
  public View a;
  public bbqf a;
  public String a;
  ...
  public aczn(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  public boolean a(String paramString)
  {
    ...
    localObject = bbdj.a(paramString);
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    this.jdField_a_of_type_Bbqf = ((bbqf)paramVarArgs[6]);
  ...
  public boolean b()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Adyu = null;
      this.c = actn.a(Long.valueOf(this.jdField_a_of_type_JavaLangString).longValue(), this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
      localObject = actn.a(actn.a(this.jdField_a_of_type_ComTencentWidgetListView, this.c));
      if ((localObject != null) && ((localObject instanceof adyu))) {
        this.jdField_a_of_type_Adyu = ((adyu)localObject);
      }
      while (this.jdField_a_of_type_Adyu == null)
      {
        a(true);
        return false;
        if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_Adyu.a != null)
      {
        localObject = this.jdField_a_of_type_Adyu.a.a();
    ...
    {
      label284:
      m += (int)(this.jdField_a_of_type_Bbqf.a * k);
      j += (int)(this.jdField_a_of_type_Bbqf.b * i);
      localObject = this.jdField_a_of_type_AndroidGraphicsRect;
      float f = this.jdField_a_of_type_Bbqf.c;
      k = (int)(k * f);
      f = this.jdField_a_of_type_Bbqf.d;
      ...
      if (this.jdField_a_of_type_AndroidViewView == null)
      {
        this.jdField_a_of_type_Aczo = null;
        ...
        localObject = actn.a(actn.a(this.jdField_a_of_type_ComTencentWidgetListView, this.c));
        if ((localObject != null) && ((localObject instanceof aczo)))
        {
          this.jdField_a_of_type_Aczo = ((aczo)localObject);
          label484:
          ...
          j = this.jdField_a_of_type_Aczo.a.getRight() - this.jdField_a_of_type_Aczo.a.getLeft();
          i = this.jdField_a_of_type_Aczo.a.getBottom() - this.jdField_a_of_type_Aczo.a.getTop();
        }
      }
      for (;;)
      {
