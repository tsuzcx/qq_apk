...
public class zfs
  extends zcv<CertifiedAccountMeta.StComment>
  implements View.OnClickListener, Animation.AnimationListener, CompoundButton.OnCheckedChangeListener, IEventReceiver
{
  private static final String jdField_a_of_type_JavaLangString = zfs.class.getSimpleName();
  ...
  private View.OnLayoutChangeListener jdField_a_of_type_AndroidViewView$OnLayoutChangeListener = new zfv(this);
  private ViewStub jdField_a_of_type_AndroidViewViewStub;
  private Animation jdField_a_of_type_AndroidViewAnimationAnimation;
  private AbsListView.OnScrollListener jdField_a_of_type_AndroidWidgetAbsListView$OnScrollListener = new zfu(this);
  public ListView a;
  ...
  protected zfb a;
  private final zfz jdField_a_of_type_Zfz;
  private zga jdField_a_of_type_Zga;
  private zgb jdField_a_of_type_Zgb;
  private zgc jdField_a_of_type_Zgc;
  private zgy jdField_a_of_type_Zgy;
  private zha jdField_a_of_type_Zha;
  private zhf jdField_a_of_type_Zhf;
  ...
  public zfs(Activity paramActivity, boolean paramBoolean, CertifiedAccountMeta.StFeed paramStFeed, zgb paramzgb, ExtraTypeInfo paramExtraTypeInfo)
  {
    super(paramActivity, paramBoolean);
    this.jdField_a_of_type_AndroidAppActivity = paramActivity;
    this.jdField_a_of_type_Zfz = new zfz(this);
    vli.a().registerSubscriber(this.jdField_a_of_type_Zfz);
    this.jdField_a_of_type_Zgb = paramzgb;
  ...
  private zfb a()
  {
    if (this.jdField_a_of_type_Zfb == null)
    {
      this.jdField_a_of_type_Zfb = new zfb();
      this.jdField_e_of_type_Int = this.jdField_a_of_type_Zfb.hashCode();
    }
    return this.jdField_a_of_type_Zfb;
  }
  ...
  private void a(long paramLong, String paramString1, String paramString2)
  {
    ...
    {
      QQToast.a(a(), 1, a().getResources().getString(2131694073), 0).a();
      return;
    }
  ...
  private void a(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_Zhf == null) {
      this.jdField_a_of_type_Zhf = new zhf((Activity)this.jdField_a_of_type_AndroidContentContext);
    }
    String str2;
    String str1;
    if (paramStReply != null) {
      ...
      {
        str2 = String.format(this.jdField_a_of_type_AndroidContentContext.getString(2131692094), new Object[] { paramStReply.postUser.nick.get() });
        str1 = str2;
        if (str2.length() > 10)
        {
        ...
        this.jdField_a_of_type_Zhf.b(str1);
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_Zhf.a(new zfw(this, paramStComment, paramStReply));
      c(paramStComment, paramStReply);
      this.jdField_a_of_type_Zhf.a(paramBoolean2);
      return;
      if ((paramStComment != null) && (paramStComment.postUser != null))
      {
        str2 = String.format(this.jdField_a_of_type_AndroidContentContext.getString(2131692094), new Object[] { paramStComment.postUser.nick.get() });
        str1 = str2;
        if (str2.length() > 10)
        {
          str1 = str2.substring(0, 10);
      ...
      {
        this.jdField_a_of_type_Zhf.b(this.jdField_a_of_type_AndroidContentContext.getString(2131692089));
      }
    }
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_Zhf != null) && (this.jdField_a_of_type_AndroidWidgetTextView != null)) {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Zhf.a());
      }
      return;
      k = 0;
    }
  ...
  private void a(Object[] paramArrayOfObject)
  {
    ...
    do
    {
        ...
        do
        {
          do
          {
            ...
            do
            {
              do
              {
                do
                {
                  for (;;)
                  {
                    ...
                    if (paramArrayOfObject[3] != null)
                    {
                      ...
                      if (this.jdField_a_of_type_Zgb != null) {
                        this.jdField_a_of_type_Zgb.a((CertifiedAccountRead.StGetFeedDetailRsp)localObject2, VSNetworkHelper.isProtocolCache((String)localObject1), localLong.longValue(), (String)localObject1);
                      }
                    ...
                    for (;;)
                    {
                      ...
                      if (this.jdField_a_of_type_Zgb != null) {
                        this.jdField_a_of_type_Zgb.a(null, VSNetworkHelper.isProtocolCache((String)localObject1), localLong.longValue(), (String)localObject1);
                      }
                      if (!this.h) {
                  ...
                  if (this.jdField_a_of_type_Zhf != null) {
                    this.jdField_a_of_type_Zhf.b(this.jdField_a_of_type_AndroidWidgetTextView);
                  }
                ...
                if ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoCommentRsp))
                {
                  ...
                  if ((localLong.longValue() != 0L) && (this.jdField_a_of_type_Zgy != null) && (this.jdField_a_of_type_Zgy.a(String.valueOf(paramArrayOfObject[4])))) {
                    m();
                  }
                  if (localLong.longValue() == 0L)
                  {
                    if ((this.jdField_a_of_type_Zgy != null) && (this.jdField_a_of_type_Zgy.a(String.valueOf(paramArrayOfObject[4]), (CertifiedAccountMeta.StComment)localObject2))) {
                      m();
                    }
                    b(1);
                  }
                }
                a(localLong.longValue(), amtj.a(2131701342), (String)localObject1);
              ...
              if ((localLong.longValue() == 0L) && ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoCommentRsp)))
              {
                ...
                if ((this.jdField_a_of_type_Zgy != null) && (this.jdField_a_of_type_Zgy.a(paramArrayOfObject))) {
                  m();
                }
                b(-1);
              }
              a(localLong.longValue(), amtj.a(2131701336), amtj.a(2131701345));
              return;
            ...
            if ((paramArrayOfObject[3] instanceof CertifiedAccountWrite.StDoReplyRsp))
            {
              ...
              if ((localLong.longValue() != 0L) && (this.jdField_a_of_type_Zgy != null) && (this.jdField_a_of_type_Zgy.a(((CertifiedAccountMeta.StComment)localObject2).id.get(), paramArrayOfObject))) {
                m();
              }
              if ((localLong.longValue() == 0L) && (this.jdField_a_of_type_Zgy != null) && (this.jdField_a_of_type_Zgy.a(((CertifiedAccountMeta.StComment)localObject2).id.get(), paramArrayOfObject, (CertifiedAccountMeta.StReply)localObject1))) {
                m();
              }
            }
            a(localLong.longValue(), amtj.a(2131701335), amtj.a(2131701346));
            return;
          } while (a(5, paramArrayOfObject));
          a(localLong.longValue(), amtj.a(2131701341), amtj.a(2131701348));
      ...
      } while ((localLong.longValue() != 0L) || (this.jdField_a_of_type_Zgy == null) || (TextUtils.isEmpty(paramArrayOfObject)) || (TextUtils.isEmpty((CharSequence)localObject1)));
      this.jdField_a_of_type_Zgy.a(paramArrayOfObject, (String)localObject1);
      m();
      return;
    ...
    label414:
    label486:
    if (this.jdField_a_of_type_Zgy != null)
    {
    ...
    label1207:
    for (paramArrayOfObject = this.jdField_a_of_type_Zfb.a((List)localObject1, (String)paramArrayOfObject[5]);; paramArrayOfObject = (Object[])localObject1)
    {
      this.jdField_a_of_type_Zgy.a(paramArrayOfObject);
      m();
      return;
    }
  }
  ...
  {
    if ((paramStUser != null) && (zbc.a() != null) && (paramStUser.id.get().equals(zbc.a().id.get()))) {}
  ...
  private void b(int paramInt)
  {
    ...
    vli.a().dispatch(new zfo(5, new Object[] { b(), Integer.valueOf(this.jdField_d_of_type_Int) }));
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    {
      localTextView = (TextView)this.jdField_c_of_type_AndroidViewView.findViewById(2131371413);
      if (localTextView != null)
      {
        if (!paramBoolean) {
          break label37;
        }
        localTextView.setText(2131693350);
      }
    }
    return;
    label37:
  ...
  private void c(int paramInt)
  {
    ...
    if (paramInt == 0) {
      this.jdField_a_of_type_Zgy.a(a().poster.id.get());
    }
  ...
  private void c(CertifiedAccountMeta.StComment paramStComment, CertifiedAccountMeta.StReply paramStReply)
  {
    ...
    this.jdField_a_of_type_Zhf.setOnShowListener(new zfx(this, paramStComment, paramStReply));
    this.jdField_a_of_type_Zhf.a(new zfy(this, paramStComment, paramStReply));
  }
  ...
  private void n()
  {
    this.jdField_a_of_type_AndroidWidgetListView = ((ListView)a(2131366415));
    this.jdField_b_of_type_AndroidViewView = a(2131364834);
    this.jdField_e_of_type_AndroidViewView = a(2131366416);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)a(2131364864));
    this.jdField_c_of_type_AndroidViewView = a(2131364845);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)a(2131378449));
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_d_of_type_AndroidViewView = a(2131363827);
    ...
    this.jdField_a_of_type_Zgc = new zgc(this);
    this.jdField_a_of_type_Zgy = new zgy(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Zgc);
    this.jdField_a_of_type_Zgy.a(this.jdField_d_of_type_JavaLangString);
    this.jdField_a_of_type_AndroidWidgetListView.setAdapter(this.jdField_a_of_type_Zgy);
    this.jdField_a_of_type_AndroidWidgetListView.setEmptyView(this.jdField_c_of_type_AndroidViewView);
    if (this.jdField_b_of_type_AndroidViewView != null) {
      this.jdField_b_of_type_AndroidViewView.setOnClickListener(new zft(this));
    }
  }
  ...
  private void p()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 313	zfs:jdField_a_of_type_Zfb	Lzfb;
    //   6: ifnonnull +16 -> 22
    //   9: getstatic 65	zfs:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   12: iconst_1
    //   13: ldc_w 922
    ...
    //   22: aload_0
    //   23: aload_0
    //   24: invokespecial 326	zfs:a	()Lzfb;
    //   27: aload_0
    //   28: invokespecial 299	zfs:b	()Ljava/lang/String;
    //   31: invokevirtual 632	zfb:a	(Ljava/lang/String;)Ljava/util/ArrayList;
    //   34: putfield 305	zfs:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   37: aload_0
    //   38: aload_0
    //   39: invokespecial 326	zfs:a	()Lzfb;
    //   42: aload_0
    //   43: invokespecial 299	zfs:b	()Ljava/lang/String;
    //   46: invokevirtual 925	zfb:a	(Ljava/lang/String;)LNS_COMM/COMM$StCommonExt;
    //   49: putfield 286	zfs:jdField_a_of_type_NS_COMMCOMM$StCommonExt	LNS_COMM/COMM$StCommonExt;
    //   52: aload_0
    //   53: getfield 305	zfs:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   56: ifnull -37 -> 19
    //   59: aload_0
    //   60: getfield 330	zfs:jdField_a_of_type_Zgy	Lzgy;
    //   63: ifnull +44 -> 107
    //   66: aload_0
    //   67: getfield 330	zfs:jdField_a_of_type_Zgy	Lzgy;
    //   70: invokevirtual 927	zgy:a	()V
    //   73: aload_0
    //   74: getfield 330	zfs:jdField_a_of_type_Zgy	Lzgy;
    //   77: aload_0
    //   78: getfield 305	zfs:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   81: invokevirtual 783	zgy:a	(Ljava/util/Collection;)Z
    //   84: pop
    //   85: aload_0
    //   86: getfield 679	zfs:i	Z
    //   89: ifeq +11 -> 100
    //   92: aload_0
    //   93: getfield 330	zfs:jdField_a_of_type_Zgy	Lzgy;
    //   96: iconst_0
    //   97: invokevirtual 929	zgy:a	(I)V
    //   100: aload_0
    //   101: getfield 330	zfs:jdField_a_of_type_Zgy	Lzgy;
    //   104: invokevirtual 932	zgy:notifyDataSetChanged	()V
    //   107: aload_0
    //   108: getfield 339	zfs:jdField_a_of_type_AndroidWidgetListView	Landroid/widget/ListView;
    //   111: ifnull +47 -> 158
    //   114: aload_0
    //   115: getfield 97	zfs:jdField_g_of_type_Int	I
    //   118: aload_0
    //   119: invokevirtual 149	zfs:a	()I
    //   122: if_icmpeq +36 -> 158
    //   125: aload_0
    //   126: getfield 679	zfs:i	Z
    //   129: ifeq +29 -> 158
    //   132: aload_0
    //   133: aload_0
    //   134: invokevirtual 149	zfs:a	()I
    //   137: putfield 97	zfs:jdField_g_of_type_Int	I
    //   140: getstatic 65	zfs:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   143: iconst_1
    //   144: ldc_w 934
    //   147: invokestatic 373	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   150: aload_0
    //   151: getfield 339	zfs:jdField_a_of_type_AndroidWidgetListView	Landroid/widget/ListView;
    //   154: iconst_0
    //   155: invokevirtual 937	android/widget/ListView:setSelection	(I)V
    //   158: aload_0
    //   159: getfield 305	zfs:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   162: ifnull -143 -> 19
    //   165: aload_0
    //   166: getfield 305	zfs:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   169: invokevirtual 647	java/util/ArrayList:size	()I
    //   172: ifle -153 -> 19
    //   175: aload_0
    //   176: aload_0
    //   177: invokespecial 326	zfs:a	()Lzfb;
    //   180: aload_0
    //   181: invokespecial 299	zfs:b	()Ljava/lang/String;
    //   184: invokevirtual 800	zfb:a	(Ljava/lang/String;)I
    //   187: putfield 131	zfs:jdField_d_of_type_Int	I
    //   190: goto -171 -> 19
    //   193: astore_1
    //   194: aload_0
    //   195: monitorexit
    ...
    for (;;)
    {
      try
      {
        ...
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_JavaUtilArrayList.size() > 0))
        {
          ...
          {
            this.jdField_b_of_type_AndroidWidgetTextView.setText(zgv.a(this.jdField_d_of_type_Int));
          ...
          if (this.jdField_a_of_type_Zgy.getCount() == 0)
          {
            bool = true;
            b(bool);
          }
  ...
  {
    this.jdField_a_of_type_Zga = paramzga;
  }
  ...
  public boolean d()
  {
    return (this.jdField_a_of_type_Zhf != null) && (this.jdField_a_of_type_Zhf.isShowing());
  }
  
  protected void e()
  {
    vli.a().unRegisterSubscriber(this.jdField_a_of_type_Zfz);
    a().a();
    this.jdField_a_of_type_Zfb = null;
  ...
  public void onAnimationStart(Animation paramAnimation)
  {
    ...
    ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).mSystemBarComp.setStatusBarMask(new PorterDuffColorFilter(paramAnimation.getColor(2131167203), PorterDuff.Mode.SRC_ATOP));
  }
