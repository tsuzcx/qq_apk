...
public class aorw
{
  private static aorw jdField_a_of_type_Aorw;
  private int jdField_a_of_type_Int = -1;
  private TdsReaderView jdField_a_of_type_ComTencentKwstudioOfficePreviewTdsReaderView;
  
  public static aorw a()
  {
    if (jdField_a_of_type_Aorw == null) {
      jdField_a_of_type_Aorw = new aorw();
    }
    return jdField_a_of_type_Aorw;
  }
  ...
  public TdsReaderView a(Activity paramActivity, String paramString, aory paramaory)
  {
    ...
    this.jdField_a_of_type_ComTencentKwstudioOfficePreviewTdsReaderView = TdsReaderView.newInstance(new aorz(paramActivity, false, paramaory, null));
    if (this.jdField_a_of_type_ComTencentKwstudioOfficePreviewTdsReaderView != null)
    {
  ...
  public boolean a(Activity paramActivity, String paramString, aory paramaory, boolean paramBoolean)
  {
    boolean bool = false;
    paramBoolean = bool;
    ...
    for (paramActivity = "pre open file true! wait callback!";; paramActivity = "pre open file false! strPath=" + paramString)
    {
      ...
      if (paramaory != null) {
        paramaory.a(paramBoolean);
      }
      return paramBoolean;
      paramActivity = TdsReaderView.newInstance(new aorz(paramActivity, true, null, null));
