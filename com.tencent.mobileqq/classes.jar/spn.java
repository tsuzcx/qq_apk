  ...
  implements stm
{
  ...
  public spn(Context paramContext)
  {
    this(paramContext, "");
  }
  
  public spn(Context paramContext, String paramString)
  {
    this.jdField_b_of_type_Int = -1;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    b(paramString);
    this.jdField_c_of_type_JavaLangString = omx.b();
  }
  
  private int a(ViewGroup paramViewGroup)
  {
    if ((this.jdField_a_of_type_Stv != null) && ((this.jdField_a_of_type_Stv.a() instanceof ISPlayerVideoView)))
    {
      if (QLog.isColorLevel()) {
        QLog.d(this.jdField_b_of_type_JavaLangString, 2, "seamlessAttachVideoView: ");
      }
      SPSeamlessHelper.get().attachVideoView(paramViewGroup, (ISPlayerVideoView)this.jdField_a_of_type_Stv.a(), new ViewGroup.LayoutParams(-1, -1));
  ...
  private SuperPlayerOption a(boolean paramBoolean)
  {
    ...
    localSuperPlayerOption.enableP2P = paramBoolean;
    localSuperPlayerOption.accurateSeekOnOpen = true;
    localSuperPlayerOption.enableCodecReuse = set.a.c();
    localSuperPlayerOption.enableVideoFrameCheck = set.a.d();
    TCodecManager.getInstance().getReusePolicy().eraseType = set.a.a();
    if (QLog.isColorLevel()) {
  ...
  private void a(sty paramsty)
  {
    if (paramsty != null)
    {
      paramsty.c(this.jdField_d_of_type_Boolean);
      paramsty.b(this.jdField_e_of_type_Boolean);
      paramsty.a(bmhv.g());
    }
  }
  ...
  private stv b()
  {
    ...
    return this.jdField_a_of_type_Stp.a(this.jdField_a_of_type_AndroidContentContext, VersionUtils.isIceScreamSandwich());
  }
  
  private void b(String paramString)
  {
    this.jdField_a_of_type_Stp = stw.a.a();
    if (this.jdField_a_of_type_AndroidContentContext != null)
    {
      if (QLog.isColorLevel()) {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (!this.jdField_h_of_type_Boolean)
      {
        this.jdField_f_of_type_Boolean = sqp.a().a();
        this.jdField_a_of_type_Stn = this.jdField_a_of_type_Stp.a(null);
      }
  ...
  private void b(String paramString1, String paramString2, int paramInt1, long paramLong1, long paramLong2, int paramInt2, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString3)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_b_of_type_JavaLangString, 2, "#VideoPlayerWrapper# playerStartByUrl, url:" + paramString2 + ", fileSize:" + paramLong2 + ", videoDuration:" + paramInt2 + "，mState:" + spm.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()));
    }
    if (!s())
    {
      QLog.e(this.jdField_b_of_type_JavaLangString, 1, "not idle or complete state, should't reopen mediaplayer, vid:" + paramString1 + "，mState:" + spm.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()) + " ,mIsSeamlessPlay:" + this.jdField_h_of_type_Boolean);
      return;
    }
    n();
    if (paramBoolean2)
    {
      paramString2 = swx.a(paramString2);
      a(paramString2);
    }
    for (;;)
    {
      paramString1 = new sty(paramInt1, paramString1, paramString2);
      paramString1.a(paramBoolean3);
      paramString1.a(paramInt2 * 1000);
      paramString1.d(paramBoolean1);
      paramString1.b(paramString3);
      a(paramString1);
      if ((this.jdField_a_of_type_AndroidContentContext != null) && (this.jdField_a_of_type_Stn != null)) {
        this.jdField_a_of_type_Stn.a(this.jdField_a_of_type_AndroidContentContext, paramString1, paramLong1, a(paramBoolean3));
      }
  ...
  public long a()
  {
    ...
    return this.jdField_a_of_type_Stn.b();
  }
  ...
  public View a()
  {
    if (this.jdField_a_of_type_Stv != null) {
      return this.jdField_a_of_type_Stv.a();
    }
    return null;
  }
  ...
  public stv a()
  {
    return this.jdField_a_of_type_Stv;
  }
  
  public void a()
  {
    if (this.jdField_a_of_type_Stv != null) {
      this.jdField_a_of_type_Stv.a();
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Stn != null) {
      this.jdField_a_of_type_Stn.a(paramFloat);
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_Stn != null) && (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 0) && (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 2) && (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 1) && (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 4) && (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() != 8))
    {
      ...
      this.jdField_a_of_type_Stn.a(paramInt, 1);
  ...
  {
    if ((this.jdField_a_of_type_Stn != null) && (paramInt1 > 0) && (paramInt2 > 0)) {
      this.jdField_a_of_type_Stn.a(paramInt1, paramInt2, bmhv.g());
    }
  }
  ...
  public void a(ViewGroup paramViewGroup, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_Stn != null) {}
    for (stv localstv = this.jdField_a_of_type_Stn.a();; localstv = null)
    {
      int j;
      if ((paramBoolean1) && (this.jdField_h_of_type_Boolean) && (localstv != null))
      {
        j = 1;
        if (j == 0) {
          break label160;
        }
        this.jdField_a_of_type_Stv = localstv;
      }
      for (;;)
      {
        if ((paramViewGroup != null) && (this.jdField_a_of_type_Stv != null) && (this.jdField_a_of_type_Stv.a() != null))
        {
          if (j == 0) {
            break label168;
          }
      ...
      label168:
      paramViewGroup.addView(this.jdField_a_of_type_Stv.a(), new ViewGroup.LayoutParams(-1, -1));
      a(this.jdField_a_of_type_Stv);
      return;
    }
  }
  ...
  public void a(String paramString, int paramInt, long paramLong, boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_b_of_type_JavaLangString, 2, "#VideoPlayerWrapper# playerStart, vid:" + paramString + ", playType:" + paramInt + ", startPosition:" + paramLong + "，mState:" + spm.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()));
    }
    if (!s())
    {
      QLog.e(this.jdField_b_of_type_JavaLangString, 1, "not idle or complete state, should't reopen mediaplayer, vid:" + paramString + "，mState:" + spm.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()) + ", mSeamlessPlay:" + this.jdField_h_of_type_Boolean);
      return;
    }
    n();
    paramString = new sty(paramInt, paramString);
    paramString.a(paramBoolean);
    paramString.a("cache_video");
    a(paramString);
    if ((this.jdField_a_of_type_AndroidContentContext != null) && (this.jdField_a_of_type_Stn != null)) {
      this.jdField_a_of_type_Stn.a(this.jdField_a_of_type_AndroidContentContext, paramString, paramLong, a(paramBoolean));
    }
    this.jdField_e_of_type_Long = 0L;
    this.jdField_d_of_type_Long = 0L;
  ...
  {
    if (this.jdField_a_of_type_Stn != null) {
      this.jdField_a_of_type_Stn.a(paramMap);
    }
  }
  
  public void a(spo paramspo)
  {
    this.jdField_a_of_type_Spo = paramspo;
  }
  
  public void a(@NotNull stn paramstn)
  {
    if (QLog.isColorLevel()) {
      QLog.d(this.jdField_b_of_type_JavaLangString, 2, "[IPlayer] onVideoPrepared(): stremDumpInfo=" + paramstn.a());
    }
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(2);
    if (this.jdField_a_of_type_Spo != null) {
      this.jdField_a_of_type_Spo.a(this, this.jdField_a_of_type_JavaLangObject);
    }
    if (this.jdField_a_of_type_Stn != null) {
      this.jdField_d_of_type_Long = this.jdField_a_of_type_Stn.a();
    }
    if ((this.jdField_b_of_type_Long > 0L) && (this.jdField_d_of_type_Long > 0L)) {
      this.jdField_a_of_type_Int = ((int)((float)this.jdField_b_of_type_Long / 1024.0F * 8.0F / ((float)this.jdField_d_of_type_Long / 1000.0F)));
    }
    ThreadManager.post(new VideoPlayerWrapper.1(this, paramstn), 5, null, false);
  }
  
  public void a(@NotNull stn paramstn, int paramInt1, int paramInt2)
  {
    if (this.jdField_a_of_type_Spo != null) {
      this.jdField_a_of_type_Spo.a(this, false, paramInt2, paramInt1, null);
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Spo != null) {
      this.jdField_a_of_type_Spo.a(this, true, 0, paramInt1, paramBitmap);
    }
  }
  
  public void a(stv paramstv)
  {
    if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Stn.a(this.jdField_a_of_type_Stv);
    this.jdField_a_of_type_Stn.a(this.jdField_d_of_type_Int);
  }
  ...
  public boolean a(String paramString)
  {
    ...
    this.jdField_a_of_type_Stn = this.jdField_a_of_type_Stp.a(paramString);
    if (this.jdField_a_of_type_Stn != null)
    {
      this.i = false;
      this.jdField_a_of_type_Stn.a(this);
  ...
  public boolean a(@NotNull stn paramstn, int paramInt1, int paramInt2, int paramInt3, @Nullable String paramString)
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(6);
    if (this.jdField_a_of_type_Spo != null) {
      this.jdField_a_of_type_Spo.a(this, paramInt2, paramInt3, paramInt1, paramString, null);
    }
    return false;
  }
  ...
  public boolean a(@NotNull stn paramstn, int paramInt, @Nullable Object paramObject)
  {
    ...
    {
      if (this.jdField_a_of_type_Spo != null) {
        this.jdField_a_of_type_Spo.a(this, paramInt, paramObject);
      }
      return false;
      if (QLog.isColorLevel()) {
      ...
      if (!this.jdField_c_of_type_Boolean)
      {
        ...
        {
          paramstn = (TPPlayerMsg.TPMediaCodecInfo)paramObject;
          this.jdField_a_of_type_Set.a(paramstn);
        }
        bjum.c(new VideoPlayerWrapper.2(this));
        continue;
        if (this.jdField_a_of_type_Spo != null) {
          this.jdField_a_of_type_Spo.a(this, "");
        }
      }
    }
  }
  ...
  public long b()
  {
    ...
    if (this.jdField_a_of_type_Stn != null) {
      return this.jdField_a_of_type_Stn.a();
    }
    return -1L;
  }
  ...
  public View b()
  {
    ...
    View localView = this.jdField_a_of_type_Stv.a();
  ...
  public void b(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Stn != null) {
      this.jdField_a_of_type_Stn.a(paramInt);
    }
    if (QLog.isColorLevel()) {
  ...
  public void b(@NotNull stn paramstn)
  {
    if (QLog.isColorLevel()) {
    ...
    if (this.jdField_a_of_type_Spo != null) {
      this.jdField_a_of_type_Spo.b(this);
    }
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Stn != null) {
        ThreadManager.executeOnSubThread(new VideoPlayerWrapper.3(this, this.jdField_a_of_type_Stn));
      }
      if ((paramBoolean) && (this.jdField_a_of_type_Stv != null) && (this.jdField_a_of_type_Stv.a() != null))
      {
        ViewParent localViewParent = this.jdField_a_of_type_Stv.a().getParent();
        if ((localViewParent instanceof ViewGroup)) {
          ((ViewGroup)localViewParent).removeView(this.jdField_a_of_type_Stv.a());
        }
      }
      this.jdField_a_of_type_Spo = null;
      this.jdField_a_of_type_Stv = null;
  ...
  public void c(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Stn != null) {
      this.jdField_a_of_type_Stn.a(paramBoolean);
    }
  }
  ...
  public void d()
  {
    ...
    do
    {
      ...
      if (!k())
      {
        QLog.e(this.jdField_b_of_type_JavaLangString, 1, "VideoPlayerWrapper: start failed, wrong state:" + spm.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()) + ", just return;");
        return;
      }
      this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.set(3);
  ...
  public void d(boolean paramBoolean)
  {
    ...
    while ((this.jdField_a_of_type_Stn == null) || (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() == 6) || (this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() == 8)) {
      return;
    }
    this.jdField_a_of_type_Stn.b(paramBoolean);
  }
  ...
  public void f()
  {
    ...
    {
      if (!k()) {
        QLog.e(this.jdField_b_of_type_JavaLangString, 1, "VideoPlayerWrapper: pause failed, wrong state:" + spm.a(this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get()) + ", just return;");
      }
    }
    else {
      return;
  ...
  public int g()
  {
    if ((this.jdField_a_of_type_Stn != null) && (this.jdField_b_of_type_Long != 0L)) {
  ...
  public void o()
  {
    ...
    this.i = true;
    if (this.jdField_a_of_type_Stn != null) {
      this.jdField_a_of_type_Stn.a(null);
    }
