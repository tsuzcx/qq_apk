...
public class amqa
  implements amqe, amqn, Handler.Callback
{
  ...
  private volatile ampz jdField_a_of_type_Ampz;
  private volatile amqd jdField_a_of_type_Amqd;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alpo.a(2131701137);
    jdField_b_of_type_JavaLangString = alpo.a(2131701138);
    jdField_c_of_type_JavaLangString = alpo.a(2131701133);
    jdField_d_of_type_JavaLangString = alpo.a(2131701134);
    jdField_e_of_type_JavaLangString = alpo.a(2131701136);
    jdField_f_of_type_JavaLangString = alpo.a(2131701140);
    jdField_g_of_type_JavaLangString = alpo.a(2131701135);
    jdField_h_of_type_JavaLangString = alpo.a(2131701139);
  }
  ...
  private boolean c()
  {
    return (a()) && (this.jdField_a_of_type_Ampz.a());
  }
  ...
  private void d(int paramInt)
  {
    ...
    if (c())
    {
      ...
      {
        this.jdField_a_of_type_Amqd.a(0);
        this.jdField_a_of_type_Amqd.b();
      }
      if ((paramInt == 2) || (paramInt == 4) || (paramInt == 6) || (paramInt == 1) || (paramInt == 3))
      {
        this.jdField_a_of_type_Ampz.a(false, true);
        this.m = paramInt;
    ...
    {
      return;
      this.jdField_a_of_type_Ampz.a(false, false);
      if (!QLog.isColorLevel()) {
        break;
      }
      ...
      if (this.jdField_a_of_type_Ampz != null) {
        this.jdField_a_of_type_Ampz.a(false, false);
      }
  ...
  private void e(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (!this.jdField_c_of_type_Boolean) {
        if (paramInt == 11) {
          ampw.a(jdField_a_of_type_JavaLangString, false);
        }
      }
      for (;;)
      {
  ...
  private void j()
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Ampz != null) && (this.jdField_a_of_type_Ampz.a())) {
        this.jdField_a_of_type_Ampz.a(false, true);
      }
    } while (this.jdField_a_of_type_Amqd == null);
    this.jdField_a_of_type_Amqd.b();
  }
  ...
  private void l()
  {
    ...
    for (;;)
    {
      ...
      return;
      if ((this.m == -1) && (this.jdField_a_of_type_Ampz != null)) {
        this.jdField_a_of_type_Ampz.a(false, false);
      }
    }
  }
  ...
  private void n()
  {
    ...
    if ((this.jdField_a_of_type_Ampz == null) || (this.jdField_a_of_type_Amqd == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (this.jdField_a_of_type_Amqd.a() != 0) {
            break label145;
          }
          if (!ampw.a(104857600L))
          {
            ampw.a(jdField_c_of_type_JavaLangString, jdField_d_of_type_JavaLangString);
            return;
          }
          if (this.jdField_a_of_type_Ampz.a(true, null)) {
            break;
          }
          ampw.a(jdField_a_of_type_JavaLangString, false);
        } while (!QLog.isColorLevel());
        ...
        return;
        a("0X8008A54");
        this.jdField_a_of_type_Amqd.a(1);
      } while (!QLog.isColorLevel());
      QLog.i("ARVideoRecordUIControllerImpl", 2, "startVideoRecord end");
      return;
      if (c())
      {
        this.jdField_a_of_type_Ampz.a(true, true);
        this.m = 7;
        this.jdField_d_of_type_Boolean = true;
        a("0X8008A55");
        if (QLog.isColorLevel()) {
  ...
  public void a(Object paramObject)
  {
    ...
    {
      return;
      if ((paramObject instanceof amqd))
      {
        this.jdField_a_of_type_Amqd = ((amqd)paramObject);
        this.jdField_a_of_type_Amqd.a(this);
        return;
      }
    } while (!(paramObject instanceof ampz));
    this.jdField_a_of_type_Ampz = ((ampz)paramObject);
    this.jdField_a_of_type_Ampz.a(this);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Ampz = null;
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Ampz != null) && (this.jdField_a_of_type_Ampz.b());
  }
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Ampz != null) && (this.jdField_a_of_type_Ampz.b()) && (!this.jdField_a_of_type_Ampz.a());
  }
  ...
  public void d()
  {
    ...
    if ((!this.jdField_e_of_type_Boolean) || (!this.jdField_f_of_type_Boolean)) {}
    while (this.jdField_a_of_type_Ampz == null) {
      return;
    }
    this.jdField_a_of_type_Ampz.a(System.currentTimeMillis());
  }
    ...
    for (int n = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.RECORD_AUDIO");; n = 0)
    {
      ...
      for (int i1 = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.WRITE_EXTERNAL_STORAGE");; i1 = 0)
      {
        ...
        for (int i2 = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.READ_EXTERNAL_STORAGE");; i2 = 0)
        {
          ...
          ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).requestPermissions(new amqb(this), 1, new String[] { "android.permission.RECORD_AUDIO", "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
          return true;
          ...
          this.jdField_a_of_type_Ampz.a(false, null);
          return true;
          if (this.jdField_a_of_type_Ampz == null) {
            break;
          }
