  ...
  implements IBinder.DeathRecipient
{
  ...
  {
    lbd.g("QQServiceForAV", "binderDied, video process died!");
    ...
    try
    {
      ...
      if ((this.a.a.jdField_a_of_type_Int == 1004) || (this.a.a.jdField_a_of_type_Int == 1000) || (this.a.a.jdField_a_of_type_Int == 1020))
      {
        ...
        {
          lbd.g("QQServiceForAV", "video chatting!");
          lbd.g("QQServiceForAV", "linkToVideoProcessDeath-->uinType=" + this.a.a.jdField_a_of_type_Int + " friendUin=" + (String)localObject1 + " senderUin=" + (String)localObject2);
        ...
        if (QQServiceForAV.a(this.a.a))
        {
          if (localQQAppInterface != null)
          {
            lde.a("MobileQQ:BootAction", 5000L);
        ...
        {
          lbd.g("QQServiceForAV", "ACTION_STOP_VIDEO_CHAT, stopReason = VideoConstants.CLOSE_DOUBLE, mUinType = " + this.a.a.jdField_a_of_type_Int + ", peerUin = " + this.a.a.jdField_b_of_type_JavaLangString);
        ...
        if (localQQAppInterface != null)
        {
          ...
          if ((l1 > 0L) && (this.a.a.jdField_b_of_type_Boolean))
          {
            ...
            lbd.g("QQServiceForAV", "linkToVideoProcessDeath MULTI_VIDEO_V2Q -->uinType=" + this.a.a.jdField_a_of_type_Int + " roomNum=" + j);
            this.a.a.sendBroadcast((Intent)localObject1);
          }
          this.a.a.jdField_b_of_type_Boolean = false;
          localQQAppInterface.getAVNotifyCenter().a(0, 0);
        }
        mtt.a(this.a.a.getApplicationContext());
    ...
    catch (RemoteException localRemoteException)
    {
      for (;;)
      {
        ...
        lbd.h("QQServiceForAV", "linkToDeath stopPumpMessage exception msg = " + localRemoteException.getMessage());
        continue;
        String str1 = str2;
