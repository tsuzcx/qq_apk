...
public class bjoj
  implements bjut
{
  protected bjoj(bjoi parambjoi) {}
  
  public void a(Exception paramException)
  {
    bjtx.c("OpenSdkFriendService", "CheckAvatarUpdate Exception. " + paramException.getMessage(), paramException);
  }
  ...
  public void a(JSONObject paramJSONObject)
  {
    try
    {
      ...
      if (i == 0)
      {
        ...
        localObject = bjzm.a(bjjo.a().a(), "prefer_last_avatar_update_time").edit();
      ...
      {
        bjtx.e("OpenSdkFriendService", "CheckAvatarUpdateCallback error. ret=" + i + ", msg=" + (String)localObject);
        return;
      }
    }
    catch (JSONException paramJSONObject)
    {
      bjtx.c("OpenSdkFriendService", "CheckAvatarUpdate Exception. " + paramJSONObject.getMessage(), paramJSONObject);
    }
  }
}
