...
public class vfs
{
  ...
  static ArrayList<vgc> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  static boolean jdField_a_of_type_Boolean;
  private static int b;
  private Activity jdField_a_of_type_AndroidAppActivity;
  protected AdapterView.OnItemClickListener a;
  
  public vfs(Activity paramActivity, ArrayList<vgc> paramArrayList, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    this.jdField_a_of_type_ComTencentWidgetAdapterView$OnItemClickListener = new vft(this);
  ...
  private ArrayList<vgc> a(ArrayList<vgc> paramArrayList)
  {
  ...
  private void a(RelativeLayout paramRelativeLayout)
  {
    ...
    int j = (b - i) / 2;
    paramRelativeLayout = (GridView)paramRelativeLayout.findViewById(2131376099);
    ...
    paramRelativeLayout.setAdapter(new vfu(this));
  }
  ...
  public View a(Activity paramActivity, View paramView, ViewGroup paramViewGroup)
  {
    if ((paramView != null) && ((paramView instanceof RelativeLayout)))
    {
      ...
      if ((localObject != null) && ((localObject instanceof vfw)))
      {
    ...
    paramActivity = (RelativeLayout)LayoutInflater.from(paramActivity).inflate(2131559598, paramViewGroup, false);
    paramView = paramActivity.getLayoutParams();
    paramView.height = jdField_a_of_type_Int;
    paramActivity.setLayoutParams(paramView);
    paramView = new vfw();
    paramView.jdField_a_of_type_ComTencentWidgetGridView = ((GridView)paramActivity.findViewById(2131376099));
    paramView.jdField_a_of_type_ComTencentBizPubaccountReadinjoyVideoVideoFeedsAlphaMaskView = ((VideoFeedsAlphaMaskView)paramActivity.findViewById(2131370613));
    paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramActivity.findViewById(2131376085));
