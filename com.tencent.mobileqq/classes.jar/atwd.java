...
public class atwd
  extends ajfb
{
  public atwd(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(Activity paramActivity, String paramString, QQAppInterface paramQQAppInterface, PersonalityLabel paramPersonalityLabel, atwx paramatwx)
  {
    byte[] arrayOfByte = PersonalityLabel.convertToBytes(paramPersonalityLabel);
    paramActivity.runOnUiThread(new PersonalityLabelHandler.1(paramString, paramQQAppInterface, paramatwx, arrayOfByte));
    paramActivity = (ajjj)paramQQAppInterface.getManager(51);
  ...
  {
    acjz localacjz = (acjz)this.mApp.getManager(282);
        ...
        do
        {
          for (;;)
          {
            ...
            else
            {
              ...
              paramFromServiceMsg = localajjj.a(paramObject);
            ...
            try
            {
              ...
              for (paramToServiceMsg = ((PersonalityLabelPhoto)paramToServiceMsg.personalityLabelPhotos.get(0)).get128SizeUrl() + atva.d;; paramToServiceMsg = "")
              {
