...
class atwd
  extends aahm
{
  atwd(atwc paramatwc, atmc paramatmc) {}
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d6.DownloadFileRspBody paramDownloadFileRspBody, Bundle paramBundle)
  {
    if (paramDownloadFileRspBody == null)
    {
      ...
      this.jdField_a_of_type_Atmc.a(-1, "");
      return;
    }
    paramBundle = TroopFileTransferManager.a(atwc.a(this.jdField_a_of_type_Atwc).b);
    if (paramBundle == null)
    {
      QLog.e("VideoForTroop<QFile>", 1, "getUrl: onReqDownloadFileResult: get troopFileTransferManager failed.");
      return;
    }
    TroopFileTransferManager.Item localItem = paramBundle.a(atwc.a(this.jdField_a_of_type_Atwc));
    if (localItem == null)
    {
      this.jdField_a_of_type_Atmc.a(-2, "");
      return;
    }
    ...
    if ((paramInt == -133) || (paramInt == -132) || (paramInt == -134))
    {
      ...
      paramDownloadFileRspBody = String.format(this.jdField_a_of_type_Atwc.a.getApp().getBaseContext().getString(2131697056), new Object[] { localItem.FileName });
      this.jdField_a_of_type_Atmc.a(paramInt, paramDownloadFileRspBody);
      return;
    }
    if ((paramInt == -103) || (paramInt == -301))
    {
      QLog.w("VideoForTroop<QFile>", 1, "file invalidate retCode = " + paramInt);
      paramDownloadFileRspBody = String.format(this.jdField_a_of_type_Atwc.a.getApp().getBaseContext().getString(2131697057), new Object[] { localItem.FileName });
      this.jdField_a_of_type_Atmc.a(paramInt, paramDownloadFileRspBody);
      return;
    }
    ...
    {
      paramDownloadFileRspBody = paramBundle;
      if (atlb.a().a(this.jdField_a_of_type_Atwc.a, 3))
      {
        QLog.i("VideoForTroop<QFile>", 1, "[IPv6-File] troopVideo download. is config enable IPv6. domain[" + str + "]");
        paramDownloadFileRspBody = new atlc(str, 0);
        paramDownloadFileRspBody = atlb.a().a(this.jdField_a_of_type_Atwc.a, paramDownloadFileRspBody, 3);
        if ((paramDownloadFileRspBody == null) || (paramDownloadFileRspBody.a())) {
          break label645;
        }
        paramDownloadFileRspBody = (atld)paramDownloadFileRspBody.a.get(0);
    ...
    for (;;)
    {
      paramDownloadFileRspBody = atuh.a(paramDownloadFileRspBody, localItem.DownloadUrl, localItem.FilePath, localItem.cookieValue, "");
      ...
      {
        this.jdField_a_of_type_Atmc.a(paramDownloadFileRspBody, localItem.cookieValue);
        return;
        label645:
      ...
      {
        this.jdField_a_of_type_Atmc.a(-3, "");
        return;
        label674:
        paramDownloadFileRspBody = paramBundle;
      }
