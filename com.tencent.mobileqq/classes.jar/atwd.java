...
public class atwd
{
  ...
  public static atwd a()
  {
    try
    {
      if (jdField_a_of_type_Atwd == null) {
        jdField_a_of_type_Atwd = new atwd();
      }
      atwd localatwd = jdField_a_of_type_Atwd;
      return localatwd;
    }
    finally {}
  }
  
  private TroopAssistantData a(awbw paramawbw, QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilMap)
    {
      ...
      paramawbw = localTroopAssistantData;
  ...
  {
    jdField_a_of_type_Atwd = null;
  }
  
  /* Error */
  private void a(awbw arg1)
  {
    // Byte code:
    //   0: aload_1
    //   1: ldc 64
    ...
    //   8: ldc 93
    //   10: aconst_null
    //   11: invokevirtual 98	awbw:a	(Ljava/lang/Class;ZLjava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    //   14: astore_2
    //   15: aload_2
    //   16: ifnull +198 -> 214
    //   19: aload_2
    ...
    //   32: dup
    //   33: aload_0
    //   34: invokespecial 109	atwe:<init>	(Latwd;)V
    ...
    //   76: aload_0
    //   77: getfield 38	atwd:jdField_b_of_type_JavaLangObject	Ljava/lang/Object;
    //   80: astore_1
    //   81: aload_1
    //   82: monitorenter
    //   83: aload_0
    //   84: aload_2
    //   85: putfield 145	atwd:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   88: aload_0
    //   89: getfield 145	atwd:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   92: ifnonnull +16 -> 108
    //   95: aload_0
    ...
    //   105: putfield 145	atwd:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   108: aload_1
    //   109: monitorexit
    //   110: aload_0
    //   111: getfield 47	atwd:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   114: astore_1
    //   115: aload_1
    //   116: monitorenter
    //   117: aload_0
    //   118: getfield 47	atwd:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   121: invokeinterface 153 1 0
    //   126: aload_0
    //   127: getfield 145	atwd:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   154: astore_3
    //   155: aload_0
    //   156: getfield 47	atwd:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   159: aload_3
  ...
  private void a(awbw paramawbw, TroopAssistantData paramTroopAssistantData)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        ...
        ThreadManager.post(new TroopAssistantManager.4(this, paramTroopAssistantData, paramawbw), 8, null, false);
        return;
        paramawbw = finally;
        throw paramawbw;
        i += 1;
  ...
  private boolean a(awbw paramawbw, String paramString)
  {
    ...
    synchronized (this.jdField_b_of_type_JavaLangObject)
    {
      ...
      if (paramString != null)
      {
        ThreadManager.post(new TroopAssistantManager.3(this, paramawbw, paramString), 8, null, false);
        return true;
        paramawbw = finally;
        throw paramawbw;
      }
  ...
  private boolean a(QQAppInterface paramQQAppInterface, int paramInt, long paramLong)
  {
    ...
    case 2: 
      if (bool)
      {
        localObject = localamjk.a(aljq.C, 5000);
        ((RecentUser)localObject).uin = aljq.C;
    ...
    for (;;)
    {
      ...
      if (paramInt != 3)
      {
        paramQQAppInterface = localamjk.b(aljq.C, 5000);
        if (paramQQAppInterface != null) {
          localamjk.b(paramQQAppInterface);
        }
      }
    }
  }
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if (this.jdField_a_of_type_JavaUtilSet != null)
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if ((!TextUtils.isEmpty(str)) && (!afai.a(str, 1, paramQQAppInterface))) {
              i += 1;
            }
          }
          else
      ...
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if (afai.a(localTroopAssistantData.troopUin, 1, paramQQAppInterface)) {
              continue;
            }
    ...
    try
    {
      ...
      if (((List)localObject1).size() > 0)
      {
        ...
        if (((Iterator)localObject1).hasNext())
        {
          ...
          {
            a(paramawbw, (TroopAssistantData)localObject3);
  ...
  public void a(QQAppInterface paramQQAppInterface, nac paramnac)
  {
    ThreadManager.post(new TroopAssistantManager.2(this, paramQQAppInterface, paramnac), 8, null, true);
  }
  ...
  public void a(MessageRecord paramMessageRecord, QQAppInterface paramQQAppInterface)
  {
    ...
    a(paramMessageRecord, paramMessageRecord.frienduin, paramMessageRecord.time, localawbw, paramQQAppInterface);
    localawbw.a();
  }
  ...
  {
    TroopAssistantData localTroopAssistantData = a(paramawbw, paramQQAppInterface, paramString);
    ...
    for (localTroopAssistantData.lastmsgtime = paramMessageRecord.time;; localTroopAssistantData.lastmsgtime = paramLong)
    {
      ...
      a(paramawbw, localTroopAssistantData);
  ...
  public void a(String paramString, long paramLong, awbw paramawbw, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      a(paramQQAppInterface, 0, paramLong);
      return;
      localTroopAssistantData = a(paramawbw, paramQQAppInterface, paramString);
      break;
      label94:
      a(paramawbw, localTroopAssistantData);
    }
  ...
  public void a(String paramString, QQAppInterface paramQQAppInterface)
  {
    awbw localawbw = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    amjk localamjk = paramQQAppInterface.a().a();
    RecentUser localRecentUser = localamjk.b(paramString, 1);
    QQMessageFacade.Message localMessage;
    if (localRecentUser != null)
    {
      paramString = a(localawbw, paramQQAppInterface, paramString);
    ...
    for (paramString.lastmsgtime = localMessage.time;; paramString.lastmsgtime = localRecentUser.lastmsgtime)
    {
      ...
      a(localawbw, paramString);
      e(paramString.troopUin, paramQQAppInterface);
      ajeu.a().a(localRecentUser.uin + "-" + localRecentUser.getType());
      if ((!(localRecentUser.msg instanceof ajhh)) && (!(localRecentUser.msg instanceof ajhy)) && (!(localRecentUser.msg instanceof ajhk)) && (!(localRecentUser.msg instanceof ajhq)) && (!(localRecentUser.msg instanceof ajhg)) && (!(localRecentUser.msg instanceof bjzl)) && (!(localRecentUser.msg instanceof ajhv)) && (!(localRecentUser.msg instanceof ajhp)) && (!(localRecentUser.msg instanceof ajhs))) {
  ...
  public void b(QQAppInterface paramQQAppInterface)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_JavaUtilSet = bdiw.a((SharedPreferences)localObject2, "troop_assis_new_unread_list", null);
      if (this.jdField_a_of_type_JavaUtilSet == null)
      {
        this.jdField_a_of_type_JavaUtilSet = new HashSet();
  ...
  public void c(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      {
        localObject = localawbw;
        RecentUser localRecentUser = localamjk.a(String.valueOf(localTroopAssistantData.troopUin), 1);
        localObject = localawbw;
  ...
  public void i(QQAppInterface paramQQAppInterface)
  {
    ...
    if (((ArrayList)localObject3).size() > 0)
    {
      ...
      if (((Iterator)localObject3).hasNext())
      {
        ...
        localObject5 = a(localawbw, paramQQAppInterface, ((RecentUser)???).uin);
        ...
        {
          a(localawbw, (TroopAssistantData)localObject5);
          ((amjk)localObject1).b((RecentUser)???);
    ...
    if (((ArrayList)localObject2).size() > 0)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        ??? = ((amjk)localObject1).a(((TroopAssistantData)localObject3).troopUin, 1);
        ...
        if (a(localawbw, ((TroopAssistantData)localObject3).troopUin))
        {
          ((amjk)localObject1).a((RecentUser)???);
  ...
  public void k(QQAppInterface paramQQAppInterface)
  {
    try
    {
      ...
      if (a(paramQQAppInterface) == true)
      {
        ...
        a().a(localawbw, paramQQAppInterface);
        localawbw.a();
      }
      c(paramQQAppInterface);
      if (atwf.a().a(paramQQAppInterface) == true)
      {
        localawbw = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
        atwf.a().a(localawbw, paramQQAppInterface);
        localawbw.a();
      }
      return;
    }
