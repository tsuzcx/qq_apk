  ...
  implements Manager
{
  ...
  public bgtu(QQAppInterface paramQQAppInterface)
  {
  ...
  private MessageForTroopReward a(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, int paramInt3)
  {
    ...
    localMessageForTroopReward.msgUid = bcsa.a(paramInt1);
    localMessageForTroopReward.msg = bhnt.a(null);
  ...
  {
    adah localadah = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(0).a();
    Lock localLock = localadah.a(paramString, paramInt);
    localLock.lock();
    try
    {
      paramString = (List)localadah.b().get(a(paramString, paramInt));
      if (paramString != null)
      {
