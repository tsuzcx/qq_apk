...
public class aptw
{
  ...
  {
    String str = String.valueOf(NetworkUtil.getSystemNetwork(BaseApplicationImpl.getApplication().getApplicationContext()));
    ...
    Object localObject = FMTSrvAddrProvider.getInstance().getAllIpList(12);
  ...
  public static String b()
  {
    ...
    Object localObject = FMTSrvAddrProvider.getInstance().getAllIpList(14);
    if ((localObject == null) || (((ArrayList)localObject).isEmpty())) {
      return null;
    }
    localObject = (FileStorageServerListInfo)((ArrayList)localObject).get((int)(Math.random() * ((ArrayList)localObject).size() + 1.0D));
  ...
  {
    String str1 = String.valueOf(DeviceInfoUtil.getCarrier());
