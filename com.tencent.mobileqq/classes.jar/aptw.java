...
{
  public aptw(QRScanEntryView paramQRScanEntryView) {}
  
  public void onClick(View paramView)
  {
    this.a.findViewById(2131369294).setAlpha(1.0F);
    ...
    for (String str1 = localScanTorchActivity.a;; str1 = str2)
    {
      ...
      localIntent.putExtra("title", localScanTorchActivity.getString(2131715971));
