  ...
  implements Handler.Callback, View.OnClickListener
{
  ...
  private List<bdnb> jdField_g_of_type_JavaUtilList;
  private int i;
  
  public aptw(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, appt paramappt, int paramInt4, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqVasVasQuickUpdateManager$CallBacker = new apua(this);
    this.i = paramInt4;
  ...
  private ImageView a(bdnb parambdnb)
  {
    if ((this.e == null) || (this.e.size() < 1) || (parambdnb == null) || (TextUtils.isEmpty(parambdnb.a)))
    {
    ...
    while (localIterator.hasNext())
    {
      ...
      bdnb localbdnb = a(localImageView);
      if ((localbdnb != null) && (parambdnb.a.equals(localbdnb.a))) {
  ...
  private LinearLayout a()
  {
    ...
    ((URLImageView)localObject2).setId(2131365716);
    ((URLImageView)localObject2).setAdjustViewBounds(true);
    ((RelativeLayout)localObject1).addView((View)localObject2, localLayoutParams1);
    ((URLImageView)localObject2).setScaleType(ImageView.ScaleType.FIT_XY);
    localObject2 = new ImageView(this.jdField_a_of_type_AndroidContentContext);
    localLayoutParams1 = new RelativeLayout.LayoutParams(-2, -2);
    ((ImageView)localObject2).setId(2131373959);
    localLayoutParams1.addRule(10, -1);
    localLayoutParams1.addRule(11, -1);
    ((ImageView)localObject2).setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849728));
    ((RelativeLayout)localObject1).addView((View)localObject2, localLayoutParams1);
    localLinearLayout.addView((View)localObject1, localLayoutParams);
    localObject1 = new TextView(this.jdField_a_of_type_AndroidContentContext);
    ((TextView)localObject1).setId(2131365718);
    ...
    ((ProgressButton)localObject1).setId(2131365715);
    localLayoutParams = new LinearLayout.LayoutParams(-2, (int)(25.0F * this.jdField_a_of_type_Float));
    localLayoutParams.topMargin = ((int)(this.jdField_a_of_type_Float * 10.0F));
    localLayoutParams.gravity = 1;
    ((ProgressButton)localObject1).setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839141));
  ...
  private bdnb a(View paramView)
  {
    ...
    if ((paramView instanceof bdnb)) {}
    for (paramView = (bdnb)paramView;; paramView = null) {
      return paramView;
    }
  }
  ...
  private ProgressButton a(EmoticonPackage paramEmoticonPackage)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      bdnb localbdnb = a(localProgressButton);
      if ((localbdnb != null) && (paramEmoticonPackage.epId.equals(localbdnb.a))) {
  ...
  private void a(View paramView, bdnb parambdnb)
  {
    if ((paramView == null) || (parambdnb == null)) {
      return;
    }
    int j;
    Object localObject2;
    ...
    if (this.jdField_a_of_type_Aube != null)
    {
      ...
      if (!this.jdField_g_of_type_JavaUtilList.contains(parambdnb))
      {
        this.jdField_a_of_type_Aube.a(parambdnb);
        ...
        int k = this.jdField_a_of_type_JavaUtilList.indexOf(parambdnb);
        localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c();
        localObject3 = parambdnb.a;
        String str = k + 1 + "";
        ...
        this.jdField_g_of_type_JavaUtilList.add(parambdnb);
      }
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
        QLog.d("RecommendEmotionAdapter", 2, "updateUI epid = " + parambdnb.a + "expose num = " + parambdnb.s);
      }
      paramView.setVisibility(0);
      if (parambdnb == paramView.getTag(2131379913)) {
        break;
      }
      paramView.setTag(2131379913, parambdnb);
      try
      {
        localObject1 = (URLImageView)paramView.findViewById(2131365717);
        localObject2 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846583);
        localObject3 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846584);
        ((URLImageView)localObject1).setImageDrawable(URLDrawable.getDrawable(parambdnb.b, (Drawable)localObject2, (Drawable)localObject3));
        ((URLImageView)localObject1).setTag(parambdnb);
        ((URLImageView)localObject1).setOnClickListener(this);
        localObject2 = (TextView)paramView.findViewById(2131365718);
        ((TextView)localObject2).setText(parambdnb.c);
        ((TextView)localObject2).setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166979));
        ((URLImageView)localObject1).setContentDescription(parambdnb.c);
        localObject1 = (ProgressButton)paramView.findViewById(2131365715);
        ((ProgressButton)localObject1).setText(parambdnb.d);
        ((ProgressButton)localObject1).setTag(parambdnb);
        ((ProgressButton)localObject1).setContentDescription(parambdnb.d);
        ...
        localObject2 = (URLImageView)paramView.findViewById(2131365716);
        ((URLImageView)localObject2).setImageDrawable(null);
        ((URLImageView)localObject2).setVisibility(8);
        localObject2 = (ImageView)paramView.findViewById(2131373959);
        ((ImageView)localObject2).setVisibility(8);
        ((ImageView)localObject2).setTag(parambdnb);
        if (parambdnb.r == 1)
        {
          if (QLog.isColorLevel()) {
            QLog.d("RecommendEmotionAdapter", 2, "emoticon Effect mNeedShowRedEffect:" + this.jdField_c_of_type_Boolean + ", id:" + parambdnb.a);
          }
          j = this.jdField_a_of_type_JavaUtilList.indexOf(parambdnb);
          ...
          {
            localObject3 = new apub(this);
            ((apub)localObject3).jdField_a_of_type_AndroidViewView = paramView;
            ((apub)localObject3).jdField_a_of_type_Bdnb = parambdnb;
            ((apub)localObject3).jdField_a_of_type_Int = j;
            ThreadManager.post(new RecommendEmotionAdapter.1(this, (apub)localObject3), 8, null, true);
          }
        }
        if ((this.e != null) && (!this.e.contains(localObject2))) {
          this.e.add(localObject2);
        }
        float f1 = ((apnf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(43)).a(parambdnb.a);
        if (f1 < 0.0F) {
          break label826;
        }
        ((ProgressButton)localObject1).setProgress((int)f1);
        ((ProgressButton)localObject1).setText(alpo.a(2131713653));
        return;
      }
      ...
      break label132;
      label799:
      if (!this.jdField_f_of_type_JavaUtilList.contains(parambdnb)) {
        this.jdField_f_of_type_JavaUtilList.add(parambdnb);
      }
    }
    label826:
    ((ProgressButton)localObject1).setText(parambdnb.d);
  ...
  private void a(bdnb parambdnb, int paramInt)
  {
    boolean bool = true;
    ...
    for (;;)
    {
      if ((this.jdField_a_of_type_AndroidContentContext instanceof Activity))
      {
        ...
        for (;;)
        {
          EmojiHomeUiPlugin.openEmojiDetailPage((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), 8, parambdnb.a, false, localIntent2, bool);
          return;
          bool = false;
        }
      }
  ...
  {
    boolean bool = false;
    if (apsi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Apsm) == this.jdField_c_of_type_Int) {
      bool = true;
    }
    return bool;
  }
  
  private boolean a(bdnb parambdnb)
  {
    return ((apnf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(43)).a(parambdnb.a) >= 0.0F;
  }
  ...
  public View a(apow paramapow, int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup = (apuc)paramapow;
    paramapow = paramView;
    int j;
    if (paramView == null)
    {
      paramView = apsr.a().a(this.jdField_c_of_type_Int);
      if (paramView == null)
      {
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (j < this.jdField_a_of_type_Int)
      {
        try
        {
          ...
          {
            paramView.addView(paramapow, (ViewGroup.LayoutParams)localObject);
            break;
          }
          paramapow = paramView;
        }
        catch (Exception paramapow)
        {
          QLog.e("RecommendEmotionAdapter", 1, "getEmotionView ; position = " + paramInt + "; has exception ,e = " + paramapow.getMessage());
          paramView = null;
          return paramView;
        }
        catch (OutOfMemoryError paramapow)
        {
      ...
      a(this.jdField_c_of_type_Int, paramapow);
      ...
      paramView = (apsj)this.jdField_a_of_type_JavaUtilList.get(k);
      if ((paramView instanceof bdnb)) {}
      for (paramView = (bdnb)paramView;; paramView = null)
      {
        ...
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X8005813", 0, 0, paramView.a, paramInt + "", "", paramView.r + "");
        break;
      }
      j += 1;
    }
  ...
  public void a(int paramInt)
  {
    ...
    bdnb localbdnb = a(this.jdField_a_of_type_ComTencentMobileqqWidgetProgressButton);
    if (localbdnb == null)
    {
      QLog.e("RecommendEmotionAdapter", 1, "payBack pkg is null");
      return;
    }
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X800613B", 0, 0, localbdnb.a, "", "", "0");
    a(this.jdField_a_of_type_ComTencentMobileqqWidgetProgressButton, localbdnb, true, this.i);
  }
  ...
  public void a(ProgressButton paramProgressButton, bdnb parambdnb, boolean paramBoolean, int paramInt)
  {
    if ((paramProgressButton == null) || (parambdnb == null) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface == null)) {
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d("RecommendEmotionAdapter", 2, "downloadOrPay epid = " + parambdnb.a);
    }
    if ((parambdnb.o == 2) || (parambdnb.o == 6))
    {
      a(parambdnb, paramInt);
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X800613D", 0, 0, parambdnb.a, "", "", parambdnb.r + "");
      ...
      int j = this.jdField_a_of_type_JavaUtilList.indexOf(parambdnb);
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c();
      parambdnb = parambdnb.a;
      String str = j + 1 + "";
      if (this.jdField_a_of_type_Boolean) {}
      for (paramProgressButton = "1";; paramProgressButton = "")
      {
        VasWebviewUtil.reportCommercialDrainage((String)localObject, "ep_mall", "0X800613D", "", 0, 0, 0, "", parambdnb, str, paramProgressButton, "", paramInt + "", "", 0, 0, 0, 0);
        return;
      }
    }
    Object localObject = (apnf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(43);
    ((aube)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(14)).a(parambdnb.a, -1, new aptx(this, parambdnb, paramBoolean, (apnf)localObject, paramProgressButton, paramInt));
  }
  ...
  public void b()
  {
    ...
    new QueryTask(new apty(this), new aptz(this)).a(null);
  }
  ...
  public void c()
  {
    ...
    if (this.i == 0)
    {
      ...
      {
        bdnb localbdnb = (bdnb)((Iterator)localObject).next();
        if (!this.jdField_g_of_type_JavaUtilList.contains(localbdnb))
        {
          this.jdField_g_of_type_JavaUtilList.add(localbdnb);
          if (this.jdField_a_of_type_Aube != null) {
            this.jdField_a_of_type_Aube.a(localbdnb);
          }
        }
      }
      ...
      if (localObject != null)
      {
        ...
        if (this.jdField_a_of_type_JavaUtilList != null)
        {
          ...
          for (int m = 1;; m = 0)
          {
            ...
            localObject = (apsj)this.jdField_a_of_type_JavaUtilList.get(j);
            if ((localObject != null) && ((localObject instanceof bdnb)))
            {
              localObject = (bdnb)localObject;
              if (this.jdField_a_of_type_Aube != null) {
                this.jdField_a_of_type_Aube.a((bdnb)localObject);
              }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      Object localObject2 = apnf.a(((BaseActivity)this.jdField_a_of_type_AndroidContentContext).getAppRuntime(), paramMessage.epId);
      if (localObject2 == null) {
        return true;
      }
      int j = (int)((apor)localObject2).a();
      if (QLog.isColorLevel()) {
        QLog.d("RecommendEmotionAdapter", 2, "handleMessage refreashProgress epid = " + paramMessage.epId + ";progress = " + j);
      }
      if (j == 100) {
        azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X800581C", 0, 0, paramMessage.epId, "", "", "");
      }
      ...
      paramMessage.setText(((bdnb)localObject1).d);
      b();
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X8005816", 0, 1, ((bdnb)localObject1).a, "", "", "");
      continue;
      if ((paramMessage.obj instanceof apub))
      {
        paramMessage = (apub)paramMessage.obj;
        if ((paramMessage == null) || (paramMessage.jdField_a_of_type_Boolean)) {
          return true;
        }
        paramMessage.jdField_a_of_type_Boolean = true;
        if ((paramMessage.jdField_a_of_type_AndroidViewView == null) || (paramMessage.jdField_a_of_type_Bdnb == null) || (paramMessage.jdField_a_of_type_JavaIoFile == null) || (paramMessage.jdField_a_of_type_AndroidViewView.getVisibility() != 0)) {
          return true;
        }
        if (((URLImageView)paramMessage.jdField_a_of_type_AndroidViewView.findViewById(2131365717)).getTag() != paramMessage.jdField_a_of_type_Bdnb) {
          return true;
        }
        ...
        try
        {
          ...
          localObject2 = (URLImageView)paramMessage.jdField_a_of_type_AndroidViewView.findViewById(2131365716);
    ...
    do
    {
      do
      {
        ...
        if ((paramView instanceof URLImageView))
        {
          ...
          int k = this.jdField_a_of_type_JavaUtilList.indexOf(localbdnb);
          String str1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c();
          String str2 = localbdnb.a;
          String str3 = k + 1 + "";
          if (this.jdField_a_of_type_Boolean) {}
          for (paramView = "1";; paramView = "")
          {
            ...
            azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X80065DD", 0, 0, localbdnb.a, "", "", localbdnb.r + "");
            a(localbdnb, this.i);
            ...
            localbdnb.r = 0;
            this.jdField_a_of_type_Aube.i(localbdnb.a, this.i);
            return;
          }
        }
      } while (!(paramView instanceof ProgressButton));
      azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "ep_mall", "0X8005814", 0, 0, localbdnb.a, "", "", localbdnb.r + "");
      a((ProgressButton)paramView, localbdnb, false, this.i);
