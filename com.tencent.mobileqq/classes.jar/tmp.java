...
public class tmp
  implements sep, sgr, tmr
{
  private int jdField_a_of_type_Int = -1;
  private long jdField_a_of_type_Long;
  protected Activity a;
  protected VVideoView a;
  sgs jdField_a_of_type_Sgs;
  @Nullable
  ...
  public tmp(Activity paramActivity, VVideoView paramVVideoView, int paramInt, ViolaInstance paramViolaInstance, String paramString, boolean paramBoolean)
  {
    this.e = paramBoolean;
    this.jdField_a_of_type_Sgs = new sgs(paramInt, paramString, paramBoolean);
    this.f = paramBoolean;
    ...
    this.jdField_a_of_type_Sgs.a(paramVVideoView);
  ...
  private int a()
  {
    switch (this.jdField_a_of_type_Sgs.a())
    {
    case 6: 
    default: 
      return 6;
  ...
  private void a(int paramInt, String paramString, JSONObject paramJSONObject)
  {
    try
    {
      ...
      paramString.put("width", this.jdField_a_of_type_Sgs.b());
      paramString.put("height", this.jdField_a_of_type_Sgs.c());
  ...
  {
    this.jdField_a_of_type_Sgs.a(paramString1, paramString2);
    boolean bool = this.jdField_a_of_type_Sgs.e();
    if ((bool) || (this.jdField_a_of_type_Sgs.i()) || (this.jdField_a_of_type_Sgs.d()))
    {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      QLog.e("VVideoControlListenerImpl", 2, "seamlessPlay error state: " + this.jdField_a_of_type_Sgs.a());
      this.e = true;
      this.f = true;
      this.jdField_a_of_type_Sgs.f();
    } while (this.jdField_a_of_type_Tmt == null);
    this.jdField_a_of_type_Sgs.a(this.jdField_a_of_type_Tmt.jdField_a_of_type_Int, this.jdField_a_of_type_Tmt.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Tmt.jdField_d_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_Tmt.jdField_d_of_type_Int);
  }
  ...
  {
    this.jdField_a_of_type_Sgs.a(paramFloat);
  }
  ...
  public void a(int paramInt, VVideoView paramVVideoView, boolean paramBoolean, String paramString, VComponentAdapter.OnVideoViewMethodListener paramOnVideoViewMethodListener)
  {
    ...
    else
    {
      ...
      rwv.b(this.jdField_a_of_type_AndroidAppActivity);
    }
    for (;;)
    {
  ...
  {
    this.jdField_a_of_type_Sgs.a.a(paramVideoPreDownloadMgr);
  }
  
  public void a(VVideoView paramVVideoView)
  {
    if ((this.jdField_a_of_type_Tmt != null) && (!this.jdField_a_of_type_Sgs.a()))
    {
      this.jdField_a_of_type_Sgs.b(this.jdField_a_of_type_Boolean);
      this.jdField_a_of_type_Sgs.a(this.jdField_a_of_type_Tmt.jdField_a_of_type_Int, this.jdField_a_of_type_Tmt.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Tmt.jdField_d_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_Tmt.jdField_d_of_type_Int);
    }
  }
  ...
  public void a(VVideoView paramVVideoView, int paramInt)
  {
    if (!this.jdField_c_of_type_Boolean) {
      this.jdField_a_of_type_Sgs.b(paramInt);
    }
  }
  ...
  public void a(VVideoView paramVVideoView, String paramString)
  {
    ...
    {
      if (this.f) {
        this.jdField_a_of_type_Sgs.a(this.jdField_c_of_type_Int);
      }
      return;
  ...
  public void a(VVideoView paramVVideoView, String paramString, VComponentAdapter.OnVideoViewMethodListener paramOnVideoViewMethodListener)
  {
    try
    {
      ...
      paramVVideoView.put("currentTime", a(this.jdField_a_of_type_Sgs.b()));
      paramVVideoView.put("totalTime", this.jdField_a_of_type_Sgs.a() / 1000L);
      JSONObject localJSONObject = new JSONObject();
      localJSONObject.put("width", this.jdField_a_of_type_Sgs.b());
      localJSONObject.put("height", this.jdField_a_of_type_Sgs.c());
  ...
  public void a(VVideoView paramVVideoView, JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      b_(paramJSONObject.optBoolean("endWithLastFrame"));
      ...
      this.jdField_a_of_type_Tmt = new tmt(paramJSONObject.getJSONObject("video_info"));
      this.jdField_a_of_type_Sgs.e(paramJSONObject.optBoolean("muted", false));
      this.jdField_a_of_type_Sgs.a(Float.valueOf(paramJSONObject.optString("rate", "1.0")).floatValue());
      if (paramJSONObject.optBoolean("debugInfoEnable", bkwm.i(pay.a())))
      {
        paramVVideoView = paramJSONObject.optString("debugInfo");
        bkwm.h(pay.a(), true);
        this.jdField_a_of_type_Sgs.a(paramVVideoView);
      }
      if (this.jdField_a_of_type_Tmt.e == 1)
      {
        this.jdField_c_of_type_Int = rwv.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Tmt.jdField_b_of_type_Int, this.jdField_a_of_type_Tmt.jdField_c_of_type_Int);
        this.jdField_a_of_type_Sgs.a(this.jdField_c_of_type_Int);
      }
      if (this.d)
      {
        a(this.jdField_a_of_type_Tmt.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Tmt.jdField_d_of_type_JavaLangString);
        return;
      }
      if (bool1)
      {
  ...
  {
    this.jdField_a_of_type_Sgs.e(paramBoolean);
  }
  ...
  {
    paramOnVideoViewMethodListener.OnMethodSuccess(paramString, new JSONObject(this.jdField_a_of_type_Sgs.a()));
  }
  ...
  {
    this.jdField_a_of_type_Sgs.d(paramBoolean);
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("VVideoControlListenerImpl", 2, "play: status=" + this.jdField_a_of_type_Sgs.a() + ", isPreload=" + this.jdField_a_of_type_Sgs.a() + ", videoinfo=" + this.jdField_a_of_type_Tmt + ", mStartPosition:" + this.jdField_a_of_type_Long);
    }
    if ((this.jdField_a_of_type_Tmt != null) && (this.jdField_a_of_type_Sgs.a())) {
      this.jdField_a_of_type_Sgs.a(this.jdField_a_of_type_Tmt.jdField_a_of_type_Int, this.jdField_a_of_type_Tmt.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Tmt.jdField_d_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_Tmt.jdField_d_of_type_Int);
    }
    ...
    {
      return;
      if (this.jdField_a_of_type_Sgs.b())
      {
  ...
  {
    this.jdField_a_of_type_Sgs.c(paramBoolean);
  }
  ...
  public void c()
  {
    ...
    seo.a().a(true, "viola video");
    if (this.jdField_b_of_type_Boolean) {
      rwv.a(this.jdField_a_of_type_AndroidAppActivity);
    }
  }
  ...
  {
    this.jdField_a_of_type_Sgs.c(paramInt);
  }
  ...
  public void c(VVideoView paramVVideoView, String paramString, VComponentAdapter.OnVideoViewMethodListener paramOnVideoViewMethodListener)
  {
    ...
    {
      paramVVideoView = new JSONObject();
      paramVVideoView.put("videoToken", this.jdField_a_of_type_Sgs.a());
      paramOnVideoViewMethodListener.OnMethodSuccess(paramString, paramVVideoView);
      return;
    }
    catch (JSONException paramVVideoView)
  ...
  public void g()
  {
    this.jdField_a_of_type_Sgs.i();
  }
  
  public void g(VVideoView paramVVideoView)
  {
    this.jdField_a_of_type_Sgs.h();
  }
  ...
  public void onBufferEnd()
  {
    ...
    while (!this.jdField_a_of_type_Sgs.g()) {
      return;
    }
    a(4, null);
  }
  ...
  public void onHeadsetStateChanged(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Sgs.e(true);
  }
  ...
  public void onProgressChanged(long paramLong)
  {
    try
    {
      ...
      localJSONObject.put("totalTime", this.jdField_a_of_type_Sgs.a() / 1000L);
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Int == -1) {
          this.jdField_a_of_type_Int = seo.a().a(3);
        }
