...
public class thv
  implements ahml, bfol, bfph, tbe, tbf
{
  ...
  private ajse jdField_a_of_type_Ajse = new thz(this);
  ...
  public Runnable a;
  private final ssv jdField_a_of_type_Ssv = new tia(this);
  thg jdField_a_of_type_Thg;
  thh jdField_a_of_type_Thh;
  public tif a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajya.a(2131706971);
    jdField_b_of_type_JavaLangString = ajya.a(2131706975);
    jdField_c_of_type_JavaLangString = ajya.a(2131706973);
    jdField_d_of_type_JavaLangString = ajya.a(2131706980);
    jdField_e_of_type_JavaLangString = ajya.a(2131706972);
    jdField_f_of_type_JavaLangString = ajya.a(2131706976);
    jdField_g_of_type_JavaLangString = ajya.a(2131706977);
    jdField_h_of_type_JavaLangString = ajya.a(2131706979);
  ...
  public thv(Context paramContext, Conversation paramConversation, ListView paramListView, PullRefreshHeader paramPullRefreshHeader, DrawerFrame paramDrawerFrame, BreathEffectView paramBreathEffectView)
  {
    this.jdField_f_of_type_Int = 1;
    this.jdField_g_of_type_Int = 1;
    this.jdField_a_of_type_Atzo = new thy(this);
    this.jdField_a_of_type_JavaLangRunnable = new MsgTabStoryNodeListManager.11(this);
    vxp.a(paramPullRefreshHeader);
    ...
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentBizQqstoryMsgTabNodeViewMsgTabStoryNodeView.findViewById(2131376527);
    this.jdField_a_of_type_ComTencentBizQqstoryMsgTabNodeViewDotAnimationView = ((DotAnimationView)this.jdField_a_of_type_ComTencentBizQqstoryMsgTabNodeViewMsgTabStoryNodeView.findViewById(2131365319));
    this.jdField_a_of_type_AndroidOsVibrator = ((Vibrator)this.jdField_a_of_type_AndroidContentContext.getSystemService("vibrator"));
    this.jdField_a_of_type_Thg = new thg(paramContext);
    ...
    r();
    this.jdField_a_of_type_ComTencentBizQqstoryMsgTabNodeViewMsgNodeShotView.setLayoutParams(new RecyclerView.LayoutParams(actj.a(67.0F, this.jdField_b_of_type_AndroidViewView.getResources()), actj.a(102.0F, this.jdField_b_of_type_AndroidViewView.getResources())));
    this.jdField_a_of_type_Thg.a(this.jdField_a_of_type_ComTencentBizQqstoryMsgTabNodeViewMsgNodeShotView);
    this.jdField_a_of_type_Thg.a(this);
    this.jdField_a_of_type_Thg.a(this);
    this.jdField_a_of_type_ComTencentBizQqstoryMsgTabNodeViewMsgTabStoryNodeView.a.setAdapter(this.jdField_a_of_type_Thg);
    this.jdField_a_of_type_Thh = new thh(this, this.jdField_a_of_type_Thg, (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
    this.jdField_a_of_type_ComTencentBizQqstoryMsgTabNodeViewMsgTabStoryNodeView.a.setOnScrollListener(new tib(this));
    this.jdField_a_of_type_AndroidDatabaseDataSetObserver = new tic(this);
    this.jdField_b_of_type_Float = vzl.a(this.jdField_a_of_type_AndroidContentContext, -50.0F);
    this.jdField_c_of_type_Float = vzl.a(this.jdField_a_of_type_AndroidContentContext, -50.0F);
    this.jdField_d_of_type_Float = vzl.a(this.jdField_a_of_type_AndroidContentContext, -120.0F);
    this.jdField_d_of_type_Int = vzl.a(this.jdField_a_of_type_AndroidContentContext, -80.0F);
    this.jdField_e_of_type_Int = vzl.a(this.jdField_a_of_type_AndroidContentContext, 12.0F);
  ...
  private void a(float paramFloat, boolean paramBoolean)
  {
    ...
    if ((paramFloat <= this.jdField_c_of_type_Float) && (paramFloat > this.jdField_e_of_type_Float)) {
      if (paramFloat <= this.jdField_d_of_type_Float)
      {
        ...
        label294:
        if (paramFloat <= vzl.a(this.jdField_a_of_type_AndroidContentContext, -75.0F)) {
          break label372;
        }
  ...
  {
    Object localObject = new unw("mainHallConfig");
    String str;
    if ((!TextUtils.isEmpty(((unw)localObject).jdField_c_of_type_JavaLangString)) && (naj.a(((unw)localObject).jdField_c_of_type_JavaLangString)))
    {
      str = ((unw)localObject).jdField_c_of_type_JavaLangString;
      if ((((unw)localObject).jdField_a_of_type_Int != 0) && (((unw)localObject).jdField_a_of_type_Int != 1)) {
        break label85;
      }
    ...
    label85:
    while ((((unw)localObject).jdField_a_of_type_Int == 2) || (((unw)localObject).jdField_a_of_type_Int != 3))
    {
      return;
  ...
  private void a(View paramView, Activity paramActivity, tff paramtff)
  {
    if (paramtff.jdField_a_of_type_Int == 12)
    {
      paramtff.jdField_i_of_type_JavaLangString = "";
      paramtff = new OpenPlayerBuilder(new MsgTabPlayInfo(paramtff.jdField_a_of_type_JavaLangString, 0, null, paramtff.jdField_f_of_type_JavaLangString, paramtff.jdField_e_of_type_JavaLangString), 106);
      paramtff.a(a());
      paramtff = paramtff.a();
      paramtff.mUIStyle.bottomWidgetShowFlag = 3;
      if ((paramView instanceof StoryMsgNodeFrameLayout))
      {
        tvc.a(paramActivity, paramtff, ((StoryMsgNodeFrameLayout)paramView).a);
        return;
      }
      tvc.a(paramActivity, paramtff, paramView);
      return;
    }
    tfv localtfv = new tfv(jdField_i_of_type_JavaLangString);
    localtfv.jdField_a_of_type_Boolean = true;
    Stream.of(paramtff).map(new ThreadOffFunction(jdField_i_of_type_JavaLangString, 2)).map(localtfv).map(new tfi(paramtff)).map(new UIThreadOffFunction(null)).subscribe(new tie(this, paramtff, paramView, paramActivity));
  }
  ...
  private void a(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityConversation.jdField_a_of_type_Ahkd.a(true, this.jdField_c_of_type_Float);
      this.jdField_a_of_type_ComTencentMobileqqActivityConversation.jdField_a_of_type_Ahkd.c(false);
      return;
    }
    if (this.jdField_b_of_type_AndroidViewView.getTranslationY() != this.jdField_d_of_type_Int) {
      this.jdField_b_of_type_AndroidViewView.setTranslationY(this.jdField_d_of_type_Int);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityConversation.jdField_a_of_type_Ahkd.a(false, this.jdField_c_of_type_Float);
    this.jdField_a_of_type_ComTencentMobileqqActivityConversation.jdField_a_of_type_Ahkd.c(true);
  }
  
  private void b(boolean paramBoolean)
  {
    View localView = this.jdField_a_of_type_ComTencentMobileqqWidgetPullRefreshHeader.findViewById(2131375051);
    if (paramBoolean) {}
    for (int j = 0;; j = 8)
    {
  ...
  private boolean c()
  {
    if (!d())
    {
      ved.b(jdField_i_of_type_JavaLangString, "showTipWindowForShot() canShowTipsWindows() == false");
      return false;
    }
    if (!e())
    {
      ved.b(jdField_i_of_type_JavaLangString, "showTipWindowForShot() isShotViewVisible() == false");
      return false;
    }
    Object localObject;
    if (this.jdField_a_of_type_Bfxy == null)
    {
      ved.b(jdField_i_of_type_JavaLangString, "showTipWindowForShot() mTipWindow == null, so create it!");
      localObject = bfxy.a(this.jdField_a_of_type_AndroidContentContext).a(true).a(ajya.a(2131706978)).a(16.0F).b(5).a(-1);
      ((bfxz)localObject).c(50);
      this.jdField_a_of_type_Bfxy = new bfya((bfxz)localObject).b(Color.argb(255, 0, 0, 0)).a(5).a().b(5).a();
      this.jdField_a_of_type_Bfxy.a(82);
      this.jdField_a_of_type_Bfxy.a(new thx(this));
    }
    if (!this.jdField_a_of_type_Bfxy.isShowing())
    {
      this.jdField_a_of_type_Bfxy.c(this.jdField_a_of_type_AndroidViewView, actj.a(7.0F, this.jdField_b_of_type_AndroidViewView.getResources()), actj.a(-5.0F, this.jdField_b_of_type_AndroidViewView.getResources()));
      localObject = new Rect();
      this.jdField_a_of_type_AndroidViewView.getGlobalVisibleRect((Rect)localObject);
      ved.a(jdField_i_of_type_JavaLangString, "showTipWindowForShot() is not showing, so show it!, %s", ((Rect)localObject).toShortString());
      this.jdField_a_of_type_Thh.a.a(tsr.a().getCurrentAccountUin(), "8.3.0".replace(".", ""));
      vei.a("msg_tab", "exp_tips", 0, 0, new String[] { "1", "", "", "" });
      this.jdField_c_of_type_Boolean = false;
      ((tcs)tcz.a(10)).b("key_msg_tab_show_shot_tips_new", Boolean.valueOf(false));
      return true;
    }
    return false;
  }
  ...
  private boolean e()
  {
    ...
    {
      ved.a(jdField_i_of_type_JavaLangString, "isShotViewVisible result = %b", Boolean.valueOf(bool1));
      return bool1;
    }
  }
  ...
  private boolean f()
  {
    ...
    ved.a(jdField_i_of_type_JavaLangString, "isMsgTabVisible %b", Boolean.valueOf(bool1));
    return bool1;
  }
  ...
  private void n()
  {
    ...
    {
      ved.a(str, "onNodeScrollOut(), is storyView attached? %b", Boolean.valueOf(bool));
      vei.a("msg_tab", "show_story", 0, 0, new String[0]);
      o();
      this.jdField_a_of_type_Thh.a("exp_story", 6);
  ...
  private void p()
  {
    vei.a("msg_tab", "hide_story", 0, 0, new String[0]);
  }
  ...
  private void q()
  {
    if (this.jdField_a_of_type_Bfxy != null)
    {
      if (this.jdField_a_of_type_Bfxy.isShowing())
      {
        ...
        ved.b(jdField_i_of_type_JavaLangString, "dismissTipWindows() dismiss");
      }
      for (;;)
      {
        this.jdField_a_of_type_Bfxy = null;
        return;
        ved.b(jdField_i_of_type_JavaLangString, "dismissTipWindows() not showing, not need dismiss()");
      }
    }
    ved.b(jdField_i_of_type_JavaLangString, "dismissTipWindows() but mTipWindow is null");
  }
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    {
      return;
      localtff = (tff)this.jdField_a_of_type_Thg.a(((bfpb)localObject).jdField_c_of_type_Int);
    } while (localtff == null);
    paramView = this.jdField_a_of_type_AndroidContentContext;
    localObject = ((bfpb)localObject).jdField_a_of_type_JavaLangString;
    if (jdField_a_of_type_JavaLangString.equals(localObject)) {
      if ((6 == localtff.jdField_a_of_type_Int) || (7 == localtff.jdField_a_of_type_Int) || (9 == localtff.jdField_a_of_type_Int) || (5 == localtff.jdField_a_of_type_Int))
      {
        QQStoryMemoriesActivity.a(paramView, 26, localtff.jdField_a_of_type_JavaLangString, false);
        paramView = "1";
      }
    }
    for (;;)
    {
      vei.a("msg_tab", "clk_press", 0, 0, new String[] { localtff.jdField_a_of_type_Int + "", paramView, "", localtff.jdField_a_of_type_JavaLangString });
      return;
      if (8 == localtff.jdField_a_of_type_Int)
      {
        QQStoryShareGroupProfileActivity.a(paramView, 2, localtff.jdField_a_of_type_JavaLangString, String.valueOf(localtff.jdField_b_of_type_Long), 17, 0);
        break;
      }
      if (12 != localtff.jdField_a_of_type_Int) {
        break;
      }
      a(paramView);
      break;
      ...
      else if (jdField_c_of_type_JavaLangString.equals(localObject))
      {
        ...
        ((Intent)localObject).putExtra("uin", String.valueOf(localtff.jdField_b_of_type_Long));
      ...
      {
        this.jdField_a_of_type_Thh.b(localtff);
        paramView = "7";
      }
      else if (jdField_d_of_type_JavaLangString.equals(localObject))
      {
        this.jdField_a_of_type_Thh.a(localtff, 0);
        paramView = "4";
      }
      else if (jdField_e_of_type_JavaLangString.equals(localObject))
      {
        this.jdField_a_of_type_Thh.a(localtff, 1);
        paramView = "5";
      }
      else if ("debug info".equals(localObject))
      {
        Toast.makeText(paramView, localtff.toString(), 1).show();
        paramView = "";
      }
      else
      {
  ...
  public void a()
  {
    ...
    ((tfy)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(251)).a().b();
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    do
    {
      ...
      int k = this.jdField_a_of_type_Thg.getItemViewType(paramInt);
      localtff = (tff)this.jdField_a_of_type_Thg.a(paramInt);
      if (localtff != null)
      {
        localObject1 = "";
        if (localtff.jdField_a_of_type_Int == 5)
        {
          if (localtff.jdField_d_of_type_Int <= 0) {
            break;
          }
          localObject1 = "2";
        }
        ...
        if (!localtff.jdField_c_of_type_Boolean) {
          break label552;
        }
        j = 1;
        ...
        l = localtff.a(localtff.jdField_e_of_type_JavaLangString);
        vei.a("msg_tab", "clk_story", 0, 0, new String[] { localtff.jdField_a_of_type_Int + ":" + localtff.jdField_e_of_type_JavaLangString + ":" + l, localObject2, localStringBuilder.toString(), localtff.jdField_a_of_type_JavaLangString });
      }
      switch (k)
      {
      }
    ...
    label275:
    if (QLog.isDevelopLevel()) {
      QLog.e(jdField_i_of_type_JavaLangString, 2, "发现一个野生的类型: " + localtff.jdField_a_of_type_Int);
    }
    while (localtff != null)
    {
      paramView = new tgh();
      paramView.jdField_c_of_type_Int = localtff.jdField_a_of_type_Int;
      paramView.jdField_b_of_type_JavaLangString = localtff.jdField_a_of_type_JavaLangString;
      paramView.jdField_b_of_type_Long = localtff.jdField_e_of_type_Long;
      localtff.jdField_c_of_type_Boolean = false;
      syo.a().a(paramView, null);
      if (localtff.jdField_b_of_type_Int > 0) {
        ((tcs)tcz.a(10)).b("key_force_refresh_msg_node_list", Boolean.valueOf(true));
      }
      this.jdField_a_of_type_Thg.notifyItemChanged(paramInt);
      ved.a(jdField_i_of_type_JavaLangString, "onItemClick, unionId:%s", paramView.jdField_b_of_type_JavaLangString);
      return;
      localObject1 = "1";
      break label87;
      label544:
      ...
      break label158;
      label557:
      vei.a("msg_tab", "clk_story", 0, 0, new String[] { localtff.jdField_a_of_type_Int + "", localObject2, localStringBuilder.toString(), localtff.jdField_a_of_type_JavaLangString });
      break label275;
      ...
      if (localObject1 == null)
      {
        ...
        ((vwj)localObject1).a((Activity)localObject3, (Bundle)localObject2, 0);
      ...
      for (;;)
      {
        ...
        vei.a("msg_tab", "clk_story", 0, 0, new String[] { "1", "", ((StringBuilder)localObject1).toString(), "" });
        return;
        paramView = ((tgd)localObject1).jdField_c_of_type_JavaLangString;
        break;
        label873:
        ((vwj)localObject1).a((Context)localObject3, (Bundle)localObject2);
        break label715;
        label885:
        vzr.a(QQStoryContext.a(), this.jdField_a_of_type_AndroidContentContext, paramView, true);
        if (!((tgd)localObject1).jdField_a_of_type_Boolean) {
          break label715;
        }
        localObject3 = ((tfz)QQStoryContext.a().getManager(252)).a();
        if ((localObject3 != null) && (TextUtils.equals(((tgd)localObject1).jdField_d_of_type_JavaLangString, ((tgd)localObject3).jdField_d_of_type_JavaLangString)))
        {
          ((tgd)localObject3).jdField_b_of_type_Boolean = true;
          tcs.f(true);
          ved.b("Q.qqstory.config.takevideo", "onItemClick configId=%s", ((tgd)localObject1).jdField_d_of_type_JavaLangString);
          localObject1 = new tge();
          stb.a().dispatch((Dispatcher.Dispatchable)localObject1);
          break label715;
        }
        ((tgd)localObject1).jdField_b_of_type_Boolean = true;
        localObject2 = ((tgd)localObject1).jdField_d_of_type_JavaLangString;
        if (localObject3 == null) {}
        for (localObject1 = "";; localObject1 = ((tgd)localObject3).jdField_d_of_type_JavaLangString)
        {
          ved.b("Q.qqstory.config.takevideo", "onItemClick oldId=%s, newId=%s", localObject2, localObject1);
          break;
        }
        label1039:
        paramInt = 0;
      ...
      if ((localtff != null) && (!vzl.b()))
      {
        ved.b(jdField_i_of_type_JavaLangString, "onItemClick(), unionId=%s, videoCover=%s", localtff.jdField_a_of_type_JavaLangString, localtff.jdField_g_of_type_JavaLangString);
        a(paramView, (Activity)localObject3, localtff);
        continue;
        if ((localtff != null) && (!vzl.b()))
        {
          ved.b(jdField_i_of_type_JavaLangString, "onItemClick(), unionId=%s, videoCover=%s, vid=%s", localtff.jdField_a_of_type_JavaLangString, localtff.jdField_g_of_type_JavaLangString, localtff.jdField_e_of_type_JavaLangString);
          localtff.jdField_a_of_type_JavaUtilList.clear();
          a(paramView, (Activity)localObject3, localtff);
          continue;
          if (((localObject3 instanceof Activity)) && (localtff != null) && (!TextUtils.isEmpty(localtff.jdField_e_of_type_JavaLangString)))
          {
            localObject1 = this.jdField_a_of_type_Thg.a();
            if ((localObject1 != null) && (!((List)localObject1).isEmpty()))
            {
              localObject1 = new OpenPlayerBuilder(new VidListPlayInfo("", localtff.jdField_e_of_type_JavaLangString), 107).a().d();
              tvc.a((Activity)localObject3, ((OpenPlayerBuilder)localObject1).a(), paramView);
              localtff.jdField_b_of_type_Int = 0;
              if (this.jdField_a_of_type_Thh != null) {
                this.jdField_a_of_type_Thh.a(localtff);
              }
              tiy.b(localtff);
            }
            tiy.b(localtff);
            continue;
            vei.a("home_page-exp-d4", "5");
            ...
            vzr.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, localtff.jdField_d_of_type_JavaLangString, true);
            localtff.jdField_b_of_type_Int = 0;
            if (this.jdField_a_of_type_Thh != null) {
              this.jdField_a_of_type_Thh.a(localtff);
            }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Thh.a(paramQQAppInterface);
    ...
    if ((this.jdField_a_of_type_ComTencentBizQqstoryMsgTabNodeViewMsgTabStoryNodeView != null) && (this.jdField_a_of_type_ComTencentBizQqstoryMsgTabNodeViewMsgTabStoryNodeView.a != null))
    {
      ...
      ved.b(jdField_i_of_type_JavaLangString, "onAccountChanged set Scroll to 0!");
    }
    if (this.jdField_a_of_type_Boolean)
    {
      paramQQAppInterface.addObserver(this.jdField_a_of_type_Atzo);
      paramQQAppInterface.addObserver(this.jdField_a_of_type_Ajse);
  ...
  public void b()
  {
    ved.c(jdField_i_of_type_JavaLangString, "MsgTab launch()");
    this.jdField_a_of_type_Tif = new tif();
    vxp.a(this.jdField_a_of_type_ComTencentBizQqstoryMsgTabNodeViewMsgTabStoryNodeView);
    if ((this.jdField_a_of_type_ComTencentBizQqstoryMsgTabNodeViewMsgTabStoryNodeView != null) && (this.jdField_a_of_type_ComTencentMobileqqWidgetPullRefreshHeader != null))
    {
      ...
      ((RelativeLayout.LayoutParams)localObject).addRule(3, 2131375051);
      ...
      this.jdField_d_of_type_Boolean = ((Boolean)((tcs)localObject).b("first_show_node", Boolean.valueOf(true))).booleanValue();
      this.jdField_a_of_type_ComTencentBizQqstoryMsgTabNodeViewMsgTabStoryNodeView.addOnLayoutChangeListener(new tid(this, (tcs)localObject));
    }
    for (;;)
    {
  ...
  {
    int j = this.jdField_a_of_type_Thg.getItemViewType(paramInt);
    String[] arrayOfString = (String[])jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(j));
    tff localtff = (tff)this.jdField_a_of_type_Thg.a(paramInt);
    if (localtff == null) {}
    do
    {
      return;
    ...
    this.jdField_a_of_type_Bfpc = bfpc.a(this.jdField_a_of_type_AndroidContentContext);
    ...
    if (j < k)
    {
      ...
      QQUserUIItem localQQUserUIItem = ((tdl)tcz.a(2)).b(localtff.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      this.jdField_a_of_type_Bfpc.a(new bfpb(paramView, paramInt, 0), 5);
      j += 1;
      break label96;
      ...
      this.jdField_a_of_type_Bfpc.a(new thw(this, localtff));
      this.jdField_a_of_type_Bfpc.show();
      if (localtff == null) {
        break;
      }
      vei.a("msg_tab", "press_story", 0, 0, new String[] { localtff.jdField_a_of_type_Int + "", "", "", localtff.jdField_a_of_type_JavaLangString });
      return;
    }
  }
  ...
  public void c()
  {
    ved.c(jdField_i_of_type_JavaLangString, "MsgTab shutdown()");
    if (!this.jdField_a_of_type_Boolean) {
      return;
    }
    try
    ...
    catch (NullPointerException localNullPointerException)
    {
      for (;;)
      {
        axpu.a(vzg.b("QQStoryMsgTabShutdown, Null", localNullPointerException), "QQStoryMsgTabShutdown NullPointerException");
      }
    }
  ...
  public void d()
  {
    if (this.jdField_a_of_type_Thh != null)
    {
      ved.b(jdField_i_of_type_JavaLangString, "updateAllFriendNodeItems()");
      this.jdField_a_of_type_Thh.a(6);
    }
  }
  ...
  public void h()
  {
    ...
    {
      ved.b(jdField_i_of_type_JavaLangString, "startBreath() show breathView");
      this.jdField_a_of_type_ComTencentMobileqqPortalBreathEffectView.c();
      vei.a("msg_tab", "exp_newpub", 0, 0, new String[0]);
      return;
    }
    ved.a(jdField_i_of_type_JavaLangString, "startBreath() not show enableStory=%b, mode=%d", Boolean.valueOf(this.jdField_a_of_type_ComTencentWidgetARMapHongBaoListView.mEnableStory), Integer.valueOf(getMode()));
  }
  ...
  public boolean interceptDrawer(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    {
      ved.a(paramMotionEvent, "interceptDrawer error. contentView:%s, listView:%s, scrollY:%s", Boolean.valueOf(bool1), Boolean.valueOf(bool2), paramView);
      return false;
      bool1 = false;
      break;
      bool2 = false;
  ...
  public void j()
  {
    this.jdField_a_of_type_Thg.notifyDataSetChanged();
  ...
  public void l()
  {
    ...
    AbstractGifImage.resumeAll();
    if ((this.jdField_a_of_type_Thg != null) && (this.jdField_a_of_type_Boolean)) {
      this.jdField_a_of_type_Thg.notifyDataSetChanged();
    }
    if (QLog.isColorLevel()) {
  ...
  public void onFlingScrollHeader(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityConversation.jdField_a_of_type_Ahkd.a(paramInt2);
  }
  ...
  public void onTouchMoving(ARMapHongBaoListView paramARMapHongBaoListView, boolean paramBoolean, MotionEvent paramMotionEvent)
  {
    ...
    case 2: 
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityConversation.jdField_a_of_type_Ahkd.a(f1);
      return;
    }
    ...
    for (;;)
    {
      ...
      if (paramARMapHongBaoListView.mForStory)
      {
        ...
        {
          paramMotionEvent = (TextView)this.jdField_a_of_type_ComTencentMobileqqWidgetPullRefreshHeader.findViewById(2131375055);
          if ((paramMotionEvent.getText().toString() != null) && (paramMotionEvent.getText().toString().contains(ajya.a(2131706968)))) {}
          for (this.jdField_f_of_type_Int = 3;; this.jdField_f_of_type_Int = 2)
          {
            paramARMapHongBaoListView.mForStory = true;
            break;
            ved.b(jdField_i_of_type_JavaLangString, "story node start refresh onTouchMoving");
          }
        }
