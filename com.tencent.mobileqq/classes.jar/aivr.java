...
public class aivr
{
  private WeakReference<aiwc> jdField_a_of_type_JavaLangRefWeakReference;
  private final ConcurrentHashMap<String, aivx> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  
  aivr(aiwc paramaiwc)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramaiwc);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    if (!a())
    {
      paramaiwc = (AppInterface)MobileQQ.sMobileQQ.waitAppRuntime(null).getAppRuntime("modular_web");
      if (paramaiwc != null)
      {
  ...
  public static void a(aivr paramaivr, AppInterface paramAppInterface, int paramInt, boolean paramBoolean)
  {
    boolean bool2 = true;
    ...
    do
    {
      do
      {
        ...
        Object localObject = new File(aivc.a());
        ...
        localObject = new batm("https://cmshow.gtimg.cn/qqshow/admindata/comdata/vipApollo_thunder_config/xydata.json", (File)localObject);
        ...
        ((batm)localObject).a(new aivt(localSharedPreferences, paramInt, paramaivr));
        paramaivr = (bato)paramAppInterface.getManager(47);
        paramBoolean = bool2;
        if (paramaivr != null)
        {
          paramaivr = paramaivr.a(3);
          paramBoolean = bool2;
          if (paramaivr != null)
          {
            paramaivr.a((batm)localObject, ((batm)localObject).a(), null);
            paramBoolean = false;
          }
        }
        if (paramBoolean) {
          ThreadManager.executeOnNetWorkThread(new ApolloSSOConfig.3((batm)localObject));
        }
  ...
  private boolean a()
  {
    ...
    Object localObject1 = new File(aivc.a());
    Object localObject2;
    int i;
    Object localObject4;
    int i1;
    ...
    if (((File)localObject1).exists())
    {
      try
      {
        localObject2 = aivc.a((File)localObject1);
        ...
        localObject2 = new aivx();
        ((aivx)localObject2).jdField_a_of_type_Int = n;
        ((aivx)localObject2).jdField_a_of_type_JavaLangString = ((String)localObject4);
        ...
        if (k < i2)
        {
          ...
          localObject8 = new aivw(null);
          ((aivw)localObject8).jdField_a_of_type_JavaLangString = str1;
          ((aivw)localObject8).jdField_a_of_type_Int = i3;
          ((aivw)localObject8).b = str2;
      ...
      localObject7 = new aivv();
      ((aivv)localObject7).jdField_a_of_type_JavaLangString = ((String)localObject5);
      ((aivv)localObject7).jdField_a_of_type_Int = n;
      ((aivv)localObject7).jdField_a_of_type_JavaUtilList.addAll((Collection)localObject6);
      ((aivx)localObject2).jdField_a_of_type_JavaUtilList.add(localObject7);
      break label1055;
      label543:
      ...
      localObject4 = new aivu();
      ((aivu)localObject4).jdField_a_of_type_JavaLangString = str1;
      ((aivu)localObject4).b = str2;
    ...
    for (;;)
    {
      if (k < i1)
      {
        ...
        if (localObject8 != null)
        {
          ...
          if (!TextUtils.isEmpty(str1))
          {
            ...
            localObject8 = new aivw(null);
            ((aivw)localObject8).jdField_a_of_type_JavaLangString = str1;
            ((aivw)localObject8).jdField_a_of_type_Int = i2;
            ((aivw)localObject8).b = str2;
      ...
      {
        ((aivu)localObject4).jdField_a_of_type_JavaUtilList.addAll((Collection)localObject7);
        ...
        if (localObject5 != null)
        {
          ...
          while (((Iterator)localObject6).hasNext())
          {
            ...
            ((aivu)localObject4).jdField_a_of_type_JavaUtilHashMap.put(localObject7, ((JSONObject)localObject5).optString((String)localObject7));
          }
        }
        ((aivx)localObject2).b.add(localObject4);
        break label1069;
        label935:
        if (QLog.isColorLevel())
        {
  ...
  public String a(String paramString)
  {
    ...
    {
      paramString = (aivx)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
      if (paramString != null) {
  ...
  public Set<String> a(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      Object localObject = (aivx)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString);
      if (localObject != null)
      {
        paramString = new HashSet();
        localObject = ((aivx)localObject).jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject).hasNext())
        {
          aivv localaivv = (aivv)((Iterator)localObject).next();
          if ((localaivv != null) && (!TextUtils.isEmpty(localaivv.jdField_a_of_type_JavaLangString))) {
            paramString.add(localaivv.jdField_a_of_type_JavaLangString);
          }
        }
        return paramString;
      }
  ...
  public JSONObject a(String paramString1, String paramString2, String paramString3, AppInterface paramAppInterface)
  {
    ...
    paramString2 = (aivx)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString2);
    if (paramString2 != null)
    {
      paramString2 = paramString2.jdField_a_of_type_JavaUtilList.iterator();
      while (paramString2.hasNext())
      {
        aivv localaivv = (aivv)paramString2.next();
        if ((localaivv != null) && (paramString3.equals(localaivv.jdField_a_of_type_JavaLangString))) {
          return localaivv.a(paramString1, paramAppInterface);
        }
      }
    }
    return null;
  ...
  void a(AppInterface paramAppInterface)
  {
    ...
    localObject1 = new NewIntent(paramAppInterface.getApp(), aquf.class);
    ...
    ((NewIntent)localObject1).setObserver(new aivs(this, paramAppInterface));
  ...
  public boolean a(String paramString1, String paramString2)
  {
    ...
    {
      paramString1 = (aivx)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString1);
      if (paramString1 != null)
      {
        paramString1 = paramString1.jdField_a_of_type_JavaUtilList.iterator();
        while (paramString1.hasNext())
        {
          aivv localaivv = (aivv)paramString1.next();
          if ((localaivv != null) && (paramString2.equals(localaivv.jdField_a_of_type_JavaLangString))) {
            return true;
          }
        }
      }
