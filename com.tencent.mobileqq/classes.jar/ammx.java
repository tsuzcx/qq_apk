...
public class ammx
{
  ...
  public static ammx a()
  {
    if (jdField_a_of_type_Ammx == null) {}
    try
    {
      if (jdField_a_of_type_Ammx == null) {
        jdField_a_of_type_Ammx = new ammx();
      }
      return jdField_a_of_type_Ammx;
    }
    finally {}
  }
  ...
  public static void a(FragmentActivity paramFragmentActivity, Intent paramIntent)
  {
    ...
    try
    {
      ...
      if (!localApolloWebViewFragment.isAdded()) {
        paramIntent.beginTransaction().add(2131367344, localApolloWebViewFragment).commitAllowingStateLoss();
      }
  ...
  {
    // Byte code:
    //   0: getstatic 25	ammx:b	Ljava/util/Stack;
    ...
    //   11: aload_3
    //   12: ifnull +41 -> 53
    //   15: getstatic 23	ammx:jdField_a_of_type_JavaUtilStack	Ljava/util/Stack;
    //   18: aload_3
    ...
    //   35: aload_0
    //   36: invokevirtual 259	ammx:b	()V
    //   39: return
    //   40: getstatic 25	ammx:b	Ljava/util/Stack;
    ...
    //   91: aload_1
    //   92: ldc 66
    //   94: getstatic 32	ammx:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    //   109: getstatic 23	ammx:jdField_a_of_type_JavaUtilStack	Ljava/util/Stack;
    //   112: aload_2
    //   113: invokevirtual 253	java/util/Stack:push	(Ljava/lang/Object;)Ljava/lang/Object;
    //   116: pop
    //   117: aload_0
    //   118: getfield 41	ammx:jdField_a_of_type_AndroidSupportV4AppFragmentActivity	Landroid/support/v4/app/FragmentActivity;
    ...
    //   147: aload_0
    //   148: getfield 41	ammx:jdField_a_of_type_AndroidSupportV4AppFragmentActivity	Landroid/support/v4/app/FragmentActivity;
    //   151: aload_3
