  ...
  extends MSFServlet
{
  ...
  private void a(amkx paramamkx, oidb_0xdea.GetBarrageListRspBody paramGetBarrageListRspBody)
  {
    ...
    paramamkx.a(amkw.a().a(localList1, paramamkx.jdField_a_of_type_Amkv.b)).b(localList2).a(m).b(n).c(k).a(bool).a();
  }
  
  void a(amkx paramamkx)
  {
    if (paramamkx == null)
    {
      if (QLog.isColorLevel()) {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("DanmuDataHolder", 2, "request called, param:" + paramamkx.a());
    }
    Object localObject = new oidb_0xdea.GetBarrageListReqBody();
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint64_group_code.set(paramamkx.jdField_a_of_type_Amkv.b);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint64_barrage_seq.set(paramamkx.jdField_a_of_type_Amkv.jdField_a_of_type_Long);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_last_update_time.set(paramamkx.jdField_a_of_type_Int);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_start_index.set(paramamkx.e);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_barrage_count.set(paramamkx.f);
    int i;
    if ((paramamkx.jdField_a_of_type_Amkv.jdField_a_of_type_Int == 2) || (paramamkx.jdField_a_of_type_Amkv.jdField_a_of_type_Int == 4))
    {
      i = 1;
      if (i == 0) {
        break label327;
      }
      ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_video_start_time.set(paramamkx.jdField_c_of_type_Int);
      ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_video_end_time.set(paramamkx.jdField_d_of_type_Int);
      label180:
      ((oidb_0xdea.GetBarrageListReqBody)localObject).terminal.set(0);
      switch (paramamkx.jdField_a_of_type_Amkv.jdField_a_of_type_Int)
      {
      }
    }
    for (;;)
    {
      ...
      localObject = amkw.a().a();
      NewIntent localNewIntent = new NewIntent(((QQAppInterface)localObject).getApp(), amld.class);
      localNewIntent.putExtra("KEY_SEND_DATA", localReqBody.toByteArray());
      localNewIntent.putExtra("KEY_GROUP_UIN", paramamkx.jdField_a_of_type_Amkv.b);
      localNewIntent.putExtra("KEY_TOPIC_UIN", paramamkx.jdField_a_of_type_Amkv.jdField_a_of_type_Long);
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if ((l1 == 0L) || (l2 == 0L))
    {
      ...
      for (;;)
      {
        amlf.a(bool1, i, -1, false, "onReceive, topicUin:0, groupUin:0");
        return;
        bool1 = false;
      }
    }
    paramIntent = amkw.a().a(l2, l1);
    amkx localamkx = amkw.a().a(paramIntent);
    if (localamkx == null)
    {
      if (QLog.isColorLevel()) {
      ...
      {
        amlf.a(bool1, i, -1, false, "onReceive, holder null");
        return;
      }
    }
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      {
        bool2 = true;
        int j = localamkx.jdField_a_of_type_Amkv.jdField_a_of_type_Int;
        if (!bool1) {
          break label379;
        }
        paramIntent = "DanmuRsp Valid";
        label246:
        amlf.a(bool2, i, j, bool1, paramIntent);
        if (!bool1) {
          break label395;
        }
        paramFromServiceMsg = localamkx.jdField_a_of_type_Amlb;
        amkv localamkv = localamkx.jdField_a_of_type_Amkv;
        bool2 = localamkx.jdField_a_of_type_Boolean;
        i = localamkx.b;
        if (!localamkx.jdField_a_of_type_Amkv.jdField_a_of_type_Boolean) {
          break label386;
        }
        paramIntent = localamkx.jdField_c_of_type_JavaUtilList;
        label305:
        paramFromServiceMsg.a(localamkv, true, bool2, i, (ArrayList)paramIntent, localamkx.jdField_a_of_type_JavaUtilList);
        localamkx.jdField_a_of_type_Amkv.jdField_a_of_type_Boolean = true;
      }
      for (;;)
      {
        if ((!bool1) || (localamkx.jdField_a_of_type_Boolean)) {
          break label424;
        }
        if (QLog.isColorLevel()) {
        ...
        break label246;
        label386:
        paramIntent = localamkx.jdField_d_of_type_JavaUtilList;
        break label305;
        label395:
        localamkx.jdField_a_of_type_Amlb.a(localamkx.jdField_a_of_type_Amkv, false, localamkx.jdField_a_of_type_Boolean, localamkx.b, null, null);
      }
      label424:
      break;
    }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    bbmj.a((byte[])localObject, 0, paramIntent.length + 4);
    bbmj.a((byte[])localObject, 4, paramIntent, paramIntent.length);
