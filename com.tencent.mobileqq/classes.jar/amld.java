...
public class amld
{
  ...
  public amld(Context paramContext)
  {
  ...
  private void a(String paramString1, String paramString2)
  {
    ...
    //   51	36	9	localQZipFile	com.tencent.commonsdk.zip.QZipFile
  ...
  public boolean a(URL paramURL, String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    //   506: putstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   509: getstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    ...
    //   522: getstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    ...
    //   622: aload 11
    //   624: invokestatic 328	com/tencent/open/base/MD5Utils:encodeFileHexStr	(Ljava/lang/String;)Ljava/lang/String;
    //   627: aload_3
    //   628: invokevirtual 331	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   631: ifeq +171 -> 802
    //   634: ldc_w 333
    //   637: iconst_1
    //   638: ldc_w 335
    //   641: invokestatic 341	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   644: iload 4
    //   646: iconst_1
    ...
    //   653: iconst_2
    //   654: ldc_w 343
    //   657: invokestatic 341	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   660: aload_0
    //   661: aload 11
    //   663: aload 12
    //   665: invokespecial 345	amld:a	(Ljava/lang/String;Ljava/lang/String;)V
    //   668: iconst_1
    //   669: istore 7
    //   671: getstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   674: ifnull +18 -> 692
    //   677: getstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   680: invokevirtual 349	org/apache/http/impl/client/DefaultHttpClient:getConnectionManager	()Lorg/apache/http/conn/ClientConnectionManager;
    //   683: invokeinterface 354 1 0
    //   688: aconst_null
    //   689: putstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   692: iload 7
    //   694: istore 9
    //   696: iload 7
    //   698: ifne -633 -> 65
    ...
    //   726: dup
    //   727: aload 14
    //   729: invokestatic 359	com/tencent/mobileqq/utils/HttpDownloadUtil:getEscapeSequence	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   772: iconst_2
    //   773: ldc_w 361
    //   776: invokestatic 341	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   779: aload_2
    ...
    //   791: aload 10
    //   793: aload_2
    //   794: invokevirtual 365	java/io/File:renameTo	(Ljava/io/File;)Z
    //   797: istore 7
    //   799: goto -128 -> 671
    //   802: ldc_w 333
    //   805: iconst_1
    //   806: ldc_w 367
    //   809: invokestatic 341	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   812: iload 8
    //   814: istore 9
    //   816: getstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   819: ifnull -754 -> 65
    //   822: getstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   825: invokevirtual 349	org/apache/http/impl/client/DefaultHttpClient:getConnectionManager	()Lorg/apache/http/conn/ClientConnectionManager;
    //   828: invokeinterface 354 1 0
    //   833: aconst_null
    //   834: putstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   837: iload 8
    //   839: ireturn
    //   840: astore_1
    //   841: aload_1
    //   842: invokevirtual 368	java/lang/Exception:printStackTrace	()V
    //   845: iload 8
    //   847: istore 9
    //   849: getstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   852: ifnull -787 -> 65
    //   855: getstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   858: invokevirtual 349	org/apache/http/impl/client/DefaultHttpClient:getConnectionManager	()Lorg/apache/http/conn/ClientConnectionManager;
    //   861: invokeinterface 354 1 0
    //   866: aconst_null
    //   867: putstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   870: iload 8
    //   872: ireturn
    //   873: astore_1
    //   874: aload_1
    //   875: invokevirtual 368	java/lang/Exception:printStackTrace	()V
    //   878: iload 8
    //   880: istore 9
    //   882: getstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   885: ifnull -820 -> 65
    //   888: getstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   891: invokevirtual 349	org/apache/http/impl/client/DefaultHttpClient:getConnectionManager	()Lorg/apache/http/conn/ClientConnectionManager;
    //   894: invokeinterface 354 1 0
    //   899: aconst_null
    //   900: putstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   903: iload 8
    //   905: ireturn
    //   906: astore_1
    //   907: getstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   910: ifnull +18 -> 928
    //   913: getstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   916: invokevirtual 349	org/apache/http/impl/client/DefaultHttpClient:getConnectionManager	()Lorg/apache/http/conn/ClientConnectionManager;
    //   919: invokeinterface 354 1 0
    //   924: aconst_null
    //   925: putstatic 267	amld:jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient	Lorg/apache/http/impl/client/DefaultHttpClient;
    //   928: aload_1
    //   929: athrow
    // Local variable table:
    //   start	length	slot	name	signature
