...
{
  private static final asya jdField_a_of_type_Asya = new asya();
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
  
  public static asya a()
  {
    return jdField_a_of_type_Asya;
  }
  ...
  private void a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 1)
    {
      ...
      if (str.contains("__IMEI__"))
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject1)) {
          paramString = bflr.b((String)localObject1);
        }
        paramString = str.replace("__IMEI__", paramString);
      }
      str = paramString;
      if (paramString.contains("__APP__")) {
        str = paramString.replace("__APP__", bflr.b("android_qq"));
      }
    }
    ...
    try
    {
      ...
      {
        azri.a(BaseApplicationImpl.getContext()).a(null, paramString, bool1, 0L, 0L, (HashMap)localObject1, "");
        return;
      }
    ...
    catch (Throwable localThrowable)
    {
      ...
      for (paramString = "imaxExporsureSucessRate";; paramString = "imaxClickExporsureSucessRate")
      {
        azri.a(BaseApplicationImpl.getContext()).a(null, paramString, bool2, 0L, 0L, (HashMap)localObject1, "");
        return;
        k = j;
        bool3 = bool2;
        localObject1 = paramString;
    ...
    for (;;)
    {
      azri.a(BaseApplicationImpl.getContext()).a(null, paramString, bool3, 0L, 0L, localHashMap, "");
      throw localObject2;
  ...
  {
    ajkg.a(paramBaseActivity, 0L, 4096L, 1);
  }
  
  void a(QQAppInterface paramQQAppInterface, ajit paramajit, AbsListView paramAbsListView, String paramString)
  {
    int i;
    ...
    for (;;)
    {
      ...
      while (j < k + 1)
      {
        Object localObject = paramajit.getItem(j);
  ...
  void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, View paramView, String paramString2)
  {
    ...
    if ((localnlo != null) && (asye.a(paramView)) && (paramString2.equals(localnlo.c)))
    {
      ...
      if (paramString2 != null)
      {
        ...
        if ((paramString1 != null) && (paramString1.size() > 0))
        {
          ...
          if ("false".equals(paramString1.getExtInfoFromExtStr("recent_list_advertisement_message_first_report")))
          {
            ...
            {
              azqs.a(paramQQAppInterface, "dc00898", "", localnlo.jdField_a_of_type_Nlq.jdField_a_of_type_JavaLangString, "0X8008F5D", "0X8008F5D", 0, 0, localnlo.jdField_a_of_type_Nlq.c, String.valueOf(((Integer)paramView.getTag()).intValue() + 1), nmh.a(), localnlo.jdField_a_of_type_Nlq.b);
              azqs.a(paramQQAppInterface, "dc00898", "", localnlo.jdField_a_of_type_Nlq.jdField_a_of_type_JavaLangString, "0X8008F5C", "0X8008F5C", 0, 0, localnlo.jdField_a_of_type_Nlq.c, "", nmh.a(), localnlo.jdField_a_of_type_Nlq.b);
            }
          }
        }
      }
      if ((localnlo != null) && (!localnlo.jdField_a_of_type_Boolean))
      {
        ...
        if ((localnlo != null) && (localnlo.jdField_a_of_type_Nlq != null)) {
          azqs.a(paramQQAppInterface, "dc00898", "", localnlo.jdField_a_of_type_Nlq.jdField_a_of_type_JavaLangString, "0X8008F5F", "0X8008F5F", 0, 0, localnlo.jdField_a_of_type_Nlq.c, "", "", localnlo.jdField_a_of_type_Nlq.b);
        }
      }
    }
  }
  ...
  {
    if (paramnlo != null) {
      azqs.a(paramQQAppInterface, "dc00898", "", paramnlo.jdField_a_of_type_Nlq.jdField_a_of_type_JavaLangString, "0X8009102", "0X8009102", 0, 0, paramnlo.jdField_a_of_type_Nlq.c, "", nmh.a(), paramnlo.jdField_a_of_type_Nlq.b);
    }
  ...
  public void a(nlo paramnlo, Activity paramActivity, AppInterface paramAppInterface)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          azqs.b(null, "dc00898", "", paramnlo.jdField_a_of_type_Nlq.jdField_a_of_type_JavaLangString, "0X80090FE", "0X80090FE", 0, 0, paramnlo.jdField_a_of_type_Nlq.c, "", nmh.a(), paramnlo.jdField_a_of_type_Nlq.b);
          a((BaseActivity)paramActivity);
          i = 1;
          continue;
          azqs.b(null, "dc00898", "", paramnlo.jdField_a_of_type_Nlq.jdField_a_of_type_JavaLangString, "0X8009101", "0X8009101", 0, 0, paramnlo.jdField_a_of_type_Nlq.c, "", nmh.a(), paramnlo.jdField_a_of_type_Nlq.b);
          azqs.b(null, "dc00898", "", paramnlo.jdField_a_of_type_Nlq.jdField_a_of_type_JavaLangString, "0X8009100", "0X8009100", 0, 0, paramnlo.jdField_a_of_type_Nlq.c, "", nmh.a(), paramnlo.jdField_a_of_type_Nlq.b);
  ...
  public void a(nlo paramnlo, QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (paramInt2 == 2)
      {
        ...
        paramQQAppInterface = new asyb(this, paramInt1);
    ...
    paramnlo = new asyb(this, paramnlo, paramQQAppInterface);
    paramnlo.b = 2;
  ...
  void b(QQAppInterface paramQQAppInterface, ajit paramajit, AbsListView paramAbsListView, String paramString)
  {
    int i;
    if ((paramAbsListView != null) && (paramajit != null) && (paramQQAppInterface != null))
    {
  ...
  {
    nlo localnlo2 = asyc.a().b(paramString1);
    ...
    if (localnlo2 == null)
    {
      ...
      localnlo1 = nlo.a(asye.b(paramQQAppInterface.c(), paramString1));
      if (localnlo1 == null) {
        if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        return;
        asyc.a().a(localnlo1);
      } while ((localnlo1 == null) || (!asye.a(paramView)) || (!paramString2.equals(localnlo1.c)));
      paramString2 = paramQQAppInterface.a();
      if (paramString2 != null)
      {
        paramString1 = paramString2.b(paramString1, paramInt);
        if ((paramString1 != null) && (paramString1.size() > 0))
        {
          ...
          if ("false".equals(paramString1.getExtInfoFromExtStr("recent_list_advertisement_message_first_report")))
          {
            ...
            if ((localnlo1 != null) && (localnlo1.jdField_a_of_type_Nlq != null)) {
              azqs.a(paramQQAppInterface, "dc00898", "", localnlo1.jdField_a_of_type_Nlq.jdField_a_of_type_JavaLangString, "0X8008F5D", "0X8008F5D", 0, 0, localnlo1.jdField_a_of_type_Nlq.c, String.valueOf(((Integer)paramView.getTag()).intValue() + 1), nmh.a(), localnlo1.jdField_a_of_type_Nlq.b);
            }
          }
        }
      }
    ...
    if (localnlo1.a())
    {
      ...
      asye.b(paramQQAppInterface.c(), localnlo1.jdField_a_of_type_JavaLangString, localnlo1.a());
    }
    azqs.a(paramQQAppInterface, "dc00898", "", localnlo1.jdField_a_of_type_Nlq.jdField_a_of_type_JavaLangString, "0X8008F5F", "0X8008F5F", 0, 0, localnlo1.jdField_a_of_type_Nlq.c, "", "", localnlo1.jdField_a_of_type_Nlq.b);
  }
  ...
  public void b(nlo paramnlo, Activity paramActivity, AppInterface paramAppInterface)
  {
    if ((!TextUtils.isEmpty(paramnlo.jdField_a_of_type_Nlq.q)) && (paramnlo.jdField_a_of_type_Nlq.f != -1)) {
      azla.a(paramAppInterface, paramActivity, "1", "1", "1", "1", "1", "1", paramnlo.jdField_a_of_type_Nlq.q, "" + paramnlo.jdField_a_of_type_Nlq.f, "1", "1", "", "", "1", "1", "", "", "", "", "", "", "", null);
    }
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          b((QQAppInterface)((WeakReference)paramMessage.get("key_app")).get(), (ajit)((WeakReference)paramMessage.get("key_adapter")).get(), (AbsListView)((WeakReference)paramMessage.get("key_listview")).get(), (String)localObject);
          return true;
          localObject = paramMessage.getData();
        } while (localObject == null);
        Object localObject = ((Bundle)localObject).getString("key_ad_id");
        paramMessage = (HashMap)paramMessage.obj;
        a((QQAppInterface)((WeakReference)paramMessage.get("key_app")).get(), (ajit)((WeakReference)paramMessage.get("key_adapter")).get(), (AbsListView)((WeakReference)paramMessage.get("key_listview")).get(), (String)localObject);
        return true;
