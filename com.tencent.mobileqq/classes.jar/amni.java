  ...
  extends BaseAdapter
{
  ...
  public amni(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewLayoutInflater = ((LayoutInflater)paramContext.getSystemService("layout_inflater"));
    this.jdField_a_of_type_Int = paramContext.getResources().getColor(2131165629);
  }
  ...
  public Drawable a(ApolloActionPackage paramApolloActionPackage)
  {
    ...
    {
      localURLDrawable2 = amdn.a("" + paramApolloActionPackage.mIconSelectedUrl.hashCode(), null, paramApolloActionPackage.mIconSelectedUrl, true);
    ...
    for (URLDrawable localURLDrawable1 = localURLDrawable2;; localURLDrawable1 = null)
    {
      ...
      {
        paramApolloActionPackage = amdn.a("" + paramApolloActionPackage.mIconUnselectedUrl.hashCode(), null, paramApolloActionPackage.mIconUnselectedUrl, true);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131558691, paramViewGroup, false);
      paramView = new amnj(this);
      paramView.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131378106));
      ...
      paramView.jdField_a_of_type_AndroidViewView = localView.findViewById(2131378103);
      paramView.jdField_a_of_type_AndroidViewView.setBackgroundColor(this.jdField_a_of_type_Int);
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131378104));
      paramView.b = localView.findViewById(2131380786);
    ...
    for (;;)
    {
      ...
      return localView;
      localObject = (amnj)paramView.getTag();
      localView = paramView;
