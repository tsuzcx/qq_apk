  ...
  extends asnn
{
  ...
  public asnz(QQAppInterface paramQQAppInterface)
  {
  ...
  private boolean b()
  {
    ...
    for (long l = SystemUtil.getSDCardAvailableSize() * 1024L; this.jdField_a_of_type_Asno.d > l; l = SystemUtil.getSystemAvailableSize() * 1024L) {
      return true;
    }
    return false;
  }
  ...
  public void a()
  {
    this.jdField_a_of_type_Asno.jdField_a_of_type_Long = 5L;
    this.jdField_a_of_type_Long = 3L;
    this.jdField_a_of_type_Asno.jdField_b_of_type_Long = 9004L;
    a(false);
  }
  ...
  public void a(int paramInt1, int paramInt2, ExcitingTransferOneSlotComplete paramExcitingTransferOneSlotComplete)
  {
    ...
    localasno.jdField_b_of_type_Int = this.jdField_a_of_type_Asno.jdField_b_of_type_Int;
    localasno.jdField_a_of_type_Int = this.jdField_a_of_type_Asno.jdField_a_of_type_Int;
    localasno.c = this.jdField_a_of_type_Asno.c;
    localasno.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_Asno.jdField_a_of_type_JavaLangString;
    localasno.d = this.jdField_a_of_type_Asno.d;
    localasno.jdField_a_of_type_Long = paramInt1;
    localasno.jdField_b_of_type_Long = paramInt2;
    HashMap localHashMap = new HashMap();
    localHashMap.put("param_V6SelectType", String.valueOf(this.jdField_a_of_type_Int));
    if (paramExcitingTransferOneSlotComplete != null) {
      localHashMap.put("param_ipAddrType", String.valueOf(ataw.b(paramExcitingTransferOneSlotComplete.m_strIp)));
    }
    for (;;)
    {
      localHashMap.put("param_stackType", String.valueOf(ataw.b()));
      localHashMap.put("param_loginType", String.valueOf(ataw.c()));
      localHashMap.put("param_ishttps", String.valueOf(this.c));
      super.a(localasno, paramExcitingTransferOneSlotComplete, localHashMap);
      return;
  ...
  protected HashMap<String, String> b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo != null)
    {
      ...
      localHashMap.put("param_FailCode", String.valueOf(a(this.jdField_a_of_type_Asno.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloadCompletedInfo.m_nSrvReturnCode)));
      ...
      localHashMap.put("param_ipStackType", String.valueOf(ataw.a()));
    ...
    for (;;)
    {
      ...
      localHashMap.put("param_fsizeo", String.valueOf(this.jdField_a_of_type_Asno.d));
      localHashMap.put("param_PeerUin", String.valueOf(this.jdField_a_of_type_Asno.c));
      ...
      continue;
      localHashMap.put("param_FailCode", String.valueOf(this.jdField_a_of_type_Asno.jdField_b_of_type_Long));
    }
  }
  
  public void b()
  {
    this.jdField_a_of_type_Asno.jdField_a_of_type_Long = 1L;
    if (this.jdField_a_of_type_Boolean) {}
    for (this.jdField_a_of_type_Long = 3L;; this.jdField_a_of_type_Long = 2L)
    {
      this.jdField_a_of_type_Asno.jdField_b_of_type_Long = 9037L;
      a(false);
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_Asno.jdField_a_of_type_Long = 2L;
    this.jdField_a_of_type_Long = 2L;
    this.jdField_a_of_type_Asno.jdField_b_of_type_Long = paramLong;
    a(false);
  }
  ...
  public void c()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloaderFirstPkgRp.mCSStartTime = bbko.a();
  }
  ...
  public void d()
  {
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerExcitingtransferExcitingtransfersdkExcitingTransferDownloaderFirstPkgRp.mCSEndTime = bbko.a();
  }
