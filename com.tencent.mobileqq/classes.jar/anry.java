...
public class anry
  implements ansk
{
  public anry(ApolloPanel paramApolloPanel) {}
  ...
  public anst a(int paramInt)
  {
    ...
    {
    default: 
      return new anrh(this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    case 0: 
      return new anrh(this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    case 2: 
      return new anqf(this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    case 100: 
    ...
    return new ansq(this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_AndroidContentContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
  }
  ...
  public void a(List<anst> paramList, List<ApolloActionPackage> paramList1, boolean paramBoolean)
  {
    ...
    int m;
    int k;
    if ((localObject1 != null) && (((amxp)localObject1).jdField_a_of_type_Int > 0) && (!paramList.isEmpty()))
    {
      i = 0;
      if (i < paramList.size())
      {
        localObject2 = (anst)paramList.get(i);
        if ((localObject2 instanceof anqo))
        {
          ApolloPanel.jdField_a_of_type_Int = i;
          if (QLog.isColorLevel()) {
            QLog.d("ApolloPanel", 2, new Object[] { "[initPanelData] checkGameTab jumpGameId:", Integer.valueOf(((amxp)localObject1).jdField_a_of_type_Int), ",gameTabIndex:" + ApolloPanel.jdField_a_of_type_Int });
          }
          ((anqo)localObject2).a((amxp)localObject1);
    ...
    for (;;)
    {
      ...
      if (k == 0)
      {
        ...
        if (!paramBoolean)
        {
          ...
          if (((amsx)this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).o)
          {
