...
public class avjs
  extends ajup
{
  public avjs(ActiveEntitySearchActivity paramActiveEntitySearchActivity) {}
  ...
  public void a(String paramString, int paramInt, List<avld> paramList, List<UnifySearchAssociationWord.SuggestUrlItem> paramList1, UnifySearchAssociationWord.SuggestUrlItem paramSuggestUrlItem)
  {
    ...
    if (paramString.equals(this.a.jdField_a_of_type_JavaLangString))
    {
      ...
      avsv.a(null, new ReportModelDC02528().module("subweb_search").action("exp_thinkword_list").obj1(avwf.a(this.a.jdField_a_of_type_ArrayOfLong)).ver1(this.a.a()).ver4(localStringBuilder.toString()).ver7("{experiment_id:" + avsv.b + "}"));
    }
  }
