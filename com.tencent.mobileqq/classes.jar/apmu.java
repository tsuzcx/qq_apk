...
public class apmu
  extends aphp
{
  private URLDrawableDownListener.Adapter jdField_a_of_type_ComTencentImageURLDrawableDownListener$Adapter = new apmv(this);
  AbsShareMsg jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg;
  String h = "";
  boolean i = false;
  
  public apmu(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  private void a(boolean paramBoolean, String paramString, long paramLong)
  {
    ...
    {
      if (str2.startsWith(ajjy.a(2131639045))) {
    ...
    for (;;)
    {
      ...
      abju.a(this.jdField_a_of_type_AndroidAppActivity, localIntent, MiniChatActivity.class, MiniMultiForwardFragment.class);
      return;
      str1 = str2;
      if (!str2.startsWith(ajjy.a(2131639016))) {
        break;
      }
  ...
  private boolean a(AbsShareMsg paramAbsShareMsg)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject = (awul)paramAbsShareMsg.get(j);
        ...
        awul localawul = (awul)((List)localObject).get(k);
        if ((!(localawul instanceof awzo)) || (((awzo)localawul).a())) {
          break label132;
        }
        bool1 = true;
      }
      ...
      do
      {
        do
        {
          ...
          paramAbsShareMsg = (awxe)localObject;
          bool1 = bool2;
        } while (paramAbsShareMsg.i == 1);
        bool1 = bool2;
      } while (paramAbsShareMsg.i == 3);
      return true;
      label179:
      j += 1;
    }
  ...
  private View b()
  {
    ...
    for (;;)
    {
      ...
      if (j != 0)
      {
        ...
        ((ImageView)localObject).setImageResource(2130839563);
        ...
        ((View)localObject).setBackgroundResource(2130839573);
        localFrameLayout.addView((View)localObject, new FrameLayout.LayoutParams(-1, bajq.a(33.0F), 16));
        ((View)localObject).setOnClickListener(new apmw(this));
        ((View)localObject).setContentDescription(ajjy.a(2131639017));
      }
  ...
  private void b(bafb parambafb)
  {
    ...
    {
      localObject3 = URLDrawable.getDrawable((String)localObject3, -1, aciy.a(165.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), localDrawable, localDrawable, true);
  ...
  private View c()
  {
    Object localObject1 = ajjy.a(2131639034);
    ...
    if (k == 1) {
      localObject1 = ajjy.a(2131639033) + (String)localObject2;
    }
    int j;
    if ((k == 0) || (k == -1))
    {
      localObject1 = (awul)this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mStructMsgItemLists.get(0);
      if ((localObject1 instanceof awum))
      {
        localObject1 = (awul)((awum)localObject1).a.get(0);
        if ((localObject1 instanceof StructMsgItemTitle))
        {
          localObject1 = ((StructMsgItemTitle)localObject1).Y;
          if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.hasTSum()) && (((String)localObject1).endsWith(ajjy.a(2131639014))))
          {
            j = 1;
            if (j == 0) {
              break label565;
            ...
            label183:
            localObject2 = ajjy.a(2131639003) + (String)localObject1;
          }
        }
      }
    }
    for (;;)
    {
      ...
      ((EllipsizingTextView)localObject4).setText(new axkd((CharSequence)localObject2, 3, 16));
      ((EllipsizingTextView)localObject4).setMaxLines(2);
      ((EllipsizingTextView)localObject4).setEllipsize(TextUtils.TruncateAt.END);
      ((EllipsizingTextView)localObject4).setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColorStateList(2131099999));
      ...
      localObject4 = new LinearLayout.LayoutParams(bajq.a(8.0F), bajq.a(14.0F));
      ((LinearLayout.LayoutParams)localObject4).gravity = 17;
      ((LinearLayout.LayoutParams)localObject4).setMargins(bajq.a(3.0F), 0, 0, 0);
      ...
      if (k == 1)
      {
        bool = true;
        label450:
        ((View)localObject2).setOnClickListener(new apmx(this, bool, (String)localObject1, l));
      ...
      while ((k != 0) && (k != -1))
      {
        ...
        j = 0;
        break;
        localObject1 = ajjy.a(2131639011);
        break label183;
        bool = false;
        break label450;
      }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg != null)
    {
      ...
      for (;;)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForAudioShare)) {
          ...
          localLayoutParams.setMargins(aciy.a(-10.0F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0, aciy.a(-7.5F, this.jdField_a_of_type_AndroidAppActivity.getResources()), 0);
        }
      }
  ...
  protected void b()
  {
    ...
    {
      ViewGroup.LayoutParams localLayoutParams = ((LinearLayout)this.jdField_a_of_type_Bafb.findViewById(2131297765)).getLayoutParams();
  ...
  protected boolean c()
  {
    ...
    if (f())
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
      {
        ...
        {
          localObject2 = aciy.a(new Intent(this.jdField_a_of_type_AndroidAppActivity, ChatActivity.class), null);
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
      {
        ...
        if (!this.jdField_a_of_type_AndroidOsBundle.getBoolean("k_back", true))
        {
          localObject1 = aciy.a(new Intent(this.jdField_a_of_type_AndroidAppActivity, ChatActivity.class), null);
  ...
  protected int d()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
    {
      localObject1 = bfid.a((StructMsgForImageShare)this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg);
      if ((localObject1 == null) || (!bfhl.b(((awwr)localObject1).S).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), -1, null))) {}
    }
    else
    {
      for (j = 0;; j = 0)
  ...
  protected void d()
  {
    ...
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800567B", "0X800567B", 0, 0, j + "", "", "", "");
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForGeneralShare))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = ((awyc)localObject2).a.iterator();
          while (((Iterator)localObject2).hasNext())
          {
            Object localObject3 = (awul)((Iterator)localObject2).next();
            if ((localObject3 instanceof awzo))
            {
              localObject3 = (awzo)localObject3;
              if (((awzo)localObject3).a()) {
                new.a("0X80065FF", ((StructMsgForGeneralShare)localObject1).uinType, new.a(((awzo)localObject3).p, ((StructMsgForGeneralShare)localObject1).mSourceName), ((awzo)localObject3).U, "");
              }
            }
          }
        }
    ...
    for (;;)
    {
      ...
      localObject1 = "";
      if (j != 0) {
        localObject1 = this.jdField_a_of_type_Bafb.getInputValue();
      }
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
      {
        if (adww.b(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgActionData))
        {
          localObject1 = adww.b(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgActionData);
          if ((localObject1 != null) && (localObject1.length > 3))
          {
            localObject1 = localObject1[3];
            if ((localObject1 != null) && (((String)localObject1).equals("1")))
            {
              ndn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "", "0X80072A5", "0X80072A5", 0, 0, "", "", "", "");
              ndn.a("0X80072A5", "", "", "", "", "");
            }
          }
        }
  ...
  protected void y()
  {
    ((xvq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(49)).a().a(this.jdField_a_of_type_AndroidOsBundle.getString("uin"), this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg);
    this.jdField_a_of_type_AndroidAppActivity.finish();
  }
}
