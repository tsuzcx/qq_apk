...
public class bjlo
{
  ...
  {
    PackageManager localPackageManager = bizw.a().a().getPackageManager();
    try
    {
    ...
    {
      bjko.b("AppUtil", "getApkVersonCode>>>", paramString);
    }
    return 0;
  }
  ...
  public static Bitmap a(String paramString)
  {
    try
    {
      ...
      if ((paramString != null) && (paramString.applicationInfo != null))
      {
        ...
        if (paramString != null)
        {
          paramString = bjkm.b(paramString);
          return paramString;
        }
      }
    }
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramString = bizw.a().a().getPackageManager().getPackageArchiveInfo(paramString, 1);
        if (paramString != null)
        {
      ...
      {
        bjko.c("AppUtil", "getApkName>>>", paramString);
      }
    }
    return null;
  }
  ...
  public static String a(String[] paramArrayOfString)
  {
    ...
    //   19: astore_1
    //   20: new 244	java/io/DataOutputStream
    //   23: dup
    //   24: aload_1
    //   25: invokevirtual 250	java/lang/Process:getOutputStream	()Ljava/io/OutputStream;
    //   28: invokespecial 253	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   31: astore_2
    //   32: new 255	java/io/DataInputStream
    //   35: dup
    //   36: aload_1
    //   37: invokevirtual 259	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   40: invokespecial 262	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   43: astore_0
    //   44: aload_0
    //   45: ifnull +88 -> 133
    //   48: aload_2
    //   49: ifnull +84 -> 133
    //   52: aload_0
    //   53: invokevirtual 265	java/io/DataInputStream:readLine	()Ljava/lang/String;
    //   56: astore_0
    //   57: aload_2
    //   58: ldc_w 267
    //   61: invokevirtual 270	java/io/DataOutputStream:writeBytes	(Ljava/lang/String;)V
    //   64: aload_2
    //   65: invokevirtual 273	java/io/DataOutputStream:flush	()V
    //   68: aload_1
    //   69: invokevirtual 276	java/lang/Process:waitFor	()I
    //   72: pop
    //   73: aload_0
    //   74: astore_2
    //   75: aload_1
    //   76: ifnull +9 -> 85
    //   79: aload_1
    //   80: invokevirtual 279	java/lang/Process:destroy	()V
    //   83: aload_0
    //   84: astore_2
    //   85: aload_2
    //   86: areturn
    ...
    //   96: ifnull -11 -> 85
    //   99: aload_1
    //   100: invokevirtual 279	java/lang/Process:destroy	()V
    //   103: aload_0
    //   104: areturn
    //   105: astore_0
    //   106: aconst_null
    ...
    //   109: ifnull +7 -> 116
    //   112: aload_1
    //   113: invokevirtual 279	java/lang/Process:destroy	()V
    //   116: aload_0
    //   117: athrow
    //   118: astore_0
    //   119: goto -11 -> 108
  ...
  public static void a(Context paramContext, String paramString1, String paramString2)
  {
    try
    {
      ...
      bjko.c("add", ">>has add platformid=qzone_m");
    ...
    catch (Exception localException)
    {
      ...
      if (paramString1 != null)
      {
        ...
        catch (Exception paramString1)
        {
          ...
          Toast.makeText(paramContext, anvx.a(2131700132), 0).show();
          return;
        }
      }
      Toast.makeText(paramContext, anvx.a(2131700133), 0).show();
    }
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (!TextUtils.isEmpty(paramString3))
    {
      ...
      bjko.c("add", ">>has add appCustom=" + paramString3);
    }
    paramString1.putExtra("platformId", "qzone_m");
    bjko.c("add", ">>has add platformid=qzone_m");
    try
    ...
    {
      Toast.makeText(paramContext, anvx.a(2131700134), 0).show();
    }
  }
  ...
  public static void a(QZipFile paramQZipFile, ZipEntry paramZipEntry, boolean paramBoolean)
  {
    ...
    //   10: aload_0
    //   11: aload_1
    //   12: invokevirtual 349	com/tencent/commonsdk/zip/QZipFile:getInputStream	(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
    //   15: astore_0
    //   16: iload_2
    //   17: ifeq +27 -> 44
    //   20: aload_0
    ...
    //   23: aload_0
    //   24: aload 5
    //   26: invokevirtual 355	java/io/InputStream:read	([B)I
    //   29: istore_3
    //   30: iconst_m1
    //   31: iload_3
    //   32: if_icmpne -12 -> 20
    ...
    //   36: ifnull +7 -> 43
    //   39: aload_0
    //   40: invokevirtual 358	java/io/InputStream:close	()V
    //   43: return
    //   44: aload_0
    //   45: astore 4
    //   47: aload_0
    //   48: aload 5
    //   50: invokevirtual 355	java/io/InputStream:read	([B)I
    //   53: pop
    //   54: goto -19 -> 35
    //   57: astore_0
    //   58: aload 4
    //   60: ifnull +8 -> 68
    //   63: aload 4
    //   65: invokevirtual 358	java/io/InputStream:close	()V
    //   68: aload_0
    //   69: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  public static boolean a(Context paramContext)
  {
    if (paramContext == null)
    {
      bjko.e("AppUtil", "isPackageScanAllowed context is null");
      return true;
    }
    try
    {
      boolean bool = bizw.a().a().getSharedPreferences("package_scan", 0).getBoolean("qqsetting_package_scan_flag", true);
      return bool;
    }
    catch (Exception paramContext)
    {
    ...
    if (localIntent == null)
    {
      ...
      try
      {
        for (;;)
        {
          ...
          try
          {
            ((aodv)((BaseActivity)paramContext).app.getBusinessHandler(BusinessHandlerFactory.STARTAPPCHECK_HANDLER)).b(paramString.trim(), paramContext, localIntent);
            return true;
          }
          catch (Exception paramBundle)
          {
            for (;;)
            {
              try
              {
                new aodv((QQAppInterface)null).a(paramString.trim(), paramContext, localIntent);
              }
              catch (Exception paramString)
              {
      ...
      {
        Toast.makeText(paramContext, anvx.a(2131700135), 0).show();
        return false;
      }
    }
  }
  ...
  public static boolean a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    try
    {
      ...
      if (new File(paramString1).exists())
      {
        ...
        {
          bjko.b("AppUtil", "installApp>>> put source " + paramString2);
          paramString1.putExtra("big_brother_source_key", paramString2);
        }
        if (!TextUtils.isEmpty(paramString3))
        {
          bjko.b("AppUtil", "installApp>>> put ref id " + paramString3);
    ...
    {
      bjko.c("AppUtil", "installApp>>>", paramContext);
    }
    return false;
  }
  ...
  {
    return bhfn.a(bizw.a().a(), paramString);
  }
  ...
  public static int b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        bjko.c("AppUtil", "getApkVersonCodeFromApkFile>>>", paramString);
      }
    }
    return 0;
  }
  ...
  public static String b(Context paramContext)
  {
    ...
    {
      bjko.b("AppUtil", "getCurProcessName err", paramContext);
    }
    return null;
  }
  ...
  {
    bjko.b("AppUtil", "getAppVersionCode: " + paramString);
    localObject1 = null;
    try
    {
      a(paramString);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        bjko.e("AppUtil", "openManifest failed: " + localException.getMessage());
      }
    }
    ...
    for (;;)
    {
      ...
      {
        String str;
        bjko.e("AppUtil", "error: " + paramString.getMessage());
        localObject1.close();
        return 0;
      }
      ...
      if ((!TextUtils.isEmpty(str)) && (str.equals("manifest")))
      {
        ...
        if (i < localObject1.getAttributeCount())
        {
          if (localObject1.getAttributeName(i).equals("versionCode"))
          {
            ...
            localObject1.close();
            bjko.b("AppUtil", "apkPath:" + paramString + ",versionCode:" + str);
