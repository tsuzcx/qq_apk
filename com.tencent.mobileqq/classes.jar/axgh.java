  ...
  extends WebViewClient
{
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    if ((paramString.startsWith("mqqapi:")) && (paramString.contains("getTcntDocData")) && (((amme)localObject).a()))
    {
      paramWebView = Uri.parse(paramString).getQueryParameter("id");
      axfz.a(paramWebView, this.b.jdField_a_of_type_ComTencentBizUiTouchWebView);
      if ((this.b.jdField_a_of_type_Bazp instanceof TeamWorkDocEditBrowserActivity.TeamWorkDocEditBrowserFragment)) {
        axfz.a(paramWebView, this.b.jdField_a_of_type_ComTencentBizUiTouchWebView);
      }
      for (;;)
      {
    ...
    for (;;)
    {
      acio.b(this.b.jdField_a_of_type_AndroidContentIntent, (String)localObject);
      paramString = bbdc.a((String)localObject);
      if ((this.b.jdField_a_of_type_Bazp == null) || (!this.b.jdField_a_of_type_Bazp.c(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, (String)localObject))) {
        break label398;
      }
      ...
      break;
      label361:
      QLog.d("WebLog_WebViewWrapper", 2, "shouldOverrideUrlLoading:" + mpw.b((String)localObject, new String[0]));
    }
    label398:
    if ((("http".equals(paramString)) || ("data".equals(paramString))) && (!((String)localObject).contains("/cgi-bin/httpconn?htcmd=0x6ff0080"))) {
      CustomWebView.addContextLog(mpw.b((String)localObject, new String[0]));
    }
    try
    {
      ...
      if ((this.b.jdField_a_of_type_Bazp != null) && (this.b.jdField_a_of_type_Bazp.b(paramWebView, (String)localObject))) {
        return true;
      }
      ...
      {
        boolean bool = this.b.jdField_a_of_type_Bazp.a(this.b.jdField_a_of_type_ComTencentBizUiTouchWebView, (String)localObject);
        if (bool) {
          return true;
        }
      }
