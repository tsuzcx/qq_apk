...
final class avpq
  extends ayra
{
  avpq(Activity paramActivity, String paramString, Runnable paramRunnable) {}
  
  public void onFailedResponse(String paramString1, int paramInt, String paramString2)
  {
    QLog.e("FaceLoginHelper", 1, new Object[] { "cmd : ", paramString1, " code : ", Integer.valueOf(paramInt), " message : ", paramString2 });
    if (paramInt == 89) {
      QQToast.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131698552), 0).a();
    }
    for (;;)
    {
