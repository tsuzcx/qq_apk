...
{
  public afmk(TroopMemberListActivity paramTroopMemberListActivity) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (j == 2131365306)
        {
          ...
          if (this.a.jdField_d_of_type_Int == 20)
          {
            ...
            localObject1 = ((afnh)localObject2).a.getTag();
            ...
            localObject1 = (afna)this.a.jdField_a_of_type_Afnc.getItem(i);
            this.a.a((afna)localObject1);
            break;
            i = 0;
            break label100;
            label314:
          ...
          {
            if (this.a.jdField_a_of_type_Afnc.jdField_b_of_type_JavaUtilList.contains(localObject1)) {
              this.a.jdField_a_of_type_Afnc.jdField_b_of_type_JavaUtilList.remove(localObject1);
            }
            for (;;)
            {
              TroopMemberListActivity.a(this.a);
              this.a.jdField_a_of_type_Afnc.notifyDataSetChanged();
              break;
              if (i != 0) {
                this.a.jdField_a_of_type_Afnc.jdField_b_of_type_JavaUtilList.add(localObject1);
              }
            }
          }
          if (bool1)
          {
            ...
            if (localObject2 != null) {
              ((afnh)localObject2).a.a(true);
            }
            if (!TextUtils.isEmpty(this.a.u))
            {
              localObject2 = this.a.a(this.a.u, bool1);
              if (localObject2 != null) {
                ((afnh)localObject2).a.b(true);
              }
            }
      ...
      else if ((j == 2131363818) && (this.a.c))
      {
        ...
        {
          if (this.a.isResume()) {
            QQToast.a(this.a, this.a.getString(2131693948), 0).b(this.a.getTitleBarHeight());
          }
        }
