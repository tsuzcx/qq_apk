...
{
  public avbm(ForwardSdkBaseOption paramForwardSdkBaseOption) {}
    ...
    synchronized (ForwardSdkBaseOption.jdField_a_of_type_JavaLangObject)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          this.a.jdField_a_of_type_Auxp = auxp.a(paramBundle);
          if ((this.a instanceof ForwardSdkShareOption)) {
            ((avcd)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(350)).a().a(this.a.b, this.a.jdField_a_of_type_Auxp);
          }
