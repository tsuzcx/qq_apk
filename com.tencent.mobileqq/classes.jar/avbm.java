  ...
  implements ServiceConnection
{
  ...
  public void onServiceConnected(ComponentName arg1, android.os.IBinder paramIBinder)
  {
    ...
    //   25: aload_0
    //   26: getfield 12	avbm:a	Lavbl;
    //   29: invokestatic 47	avbl:a	(Lavbl;)Landroid/os/Messenger;
    //   32: ifnull +95 -> 127
    //   35: aload_0
    //   36: getfield 12	avbm:a	Lavbl;
    //   39: new 49	android/os/Messenger
    //   42: dup
    //   43: aload_2
    //   44: invokespecial 52	android/os/Messenger:<init>	(Landroid/os/IBinder;)V
    //   47: invokestatic 55	avbl:a	(Lavbl;Landroid/os/Messenger;)Landroid/os/Messenger;
    //   50: pop
    //   51: aconst_null
    //   52: iconst_1
    ...
    //   68: aload_1
    //   69: aload_0
    //   70: getfield 12	avbm:a	Lavbl;
    //   73: invokestatic 47	avbl:a	(Lavbl;)Landroid/os/Messenger;
    //   76: putfield 72	android/os/Message:replyTo	Landroid/os/Messenger;
    //   79: aload_0
    //   80: getfield 12	avbm:a	Lavbl;
    //   83: invokestatic 75	avbl:b	(Lavbl;)Landroid/os/Messenger;
    //   86: aload_1
    //   87: invokevirtual 79	android/os/Messenger:send	(Landroid/os/Message;)V
    //   90: aload_0
    //   91: getfield 12	avbm:a	Lavbl;
    //   94: astore_1
    //   95: aload_1
    //   96: monitorenter
    //   97: aload_0
    //   98: getfield 12	avbm:a	Lavbl;
    //   101: invokestatic 82	avbl:a	(Lavbl;)Ljava/util/concurrent/atomic/AtomicInteger;
    //   104: iconst_1
    //   105: invokevirtual 88	java/util/concurrent/atomic/AtomicInteger:set	(I)V
    //   108: aload_1
    //   109: monitorexit
    //   110: aload_0
    //   111: getfield 12	avbm:a	Lavbl;
    //   114: aload_0
    //   115: getfield 12	avbm:a	Lavbl;
    //   118: invokestatic 82	avbl:a	(Lavbl;)Ljava/util/concurrent/atomic/AtomicInteger;
    //   121: invokevirtual 92	java/util/concurrent/atomic/AtomicInteger:get	()I
    //   124: invokestatic 95	avbl:a	(Lavbl;I)V
    //   127: return
    //   128: astore_1
    //   129: ldc 30
    //   131: iconst_1
  ...
  public void onServiceDisconnected(ComponentName paramComponentName)
  {
    synchronized (this.a)
    {
      avbl.a(this.a).set(-1);
      avbl.a(this.a, null);
      avbl.a(this.a, avbl.a(this.a).get());
