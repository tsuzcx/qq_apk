  ...
  extends bogb
{
  ...
  private static String a(Context paramContext)
  {
    try
    {
      ...
      mvk.a("CaptureTemplateManager", "getQQShortVideoFilterConfig:" + jdField_a_of_type_JavaLangString + "template_config.xml" + "|" + localFile.exists());
      if (localFile.exists()) {
        return FileUtils.readFileToString(localFile);
      }
      bhhr.ag(paramContext, BaseApplicationImpl.getApplication().getRuntime().getAccount(), 0);
      return null;
    }
    catch (IOException paramContext)
    {
      ykq.e("CaptureTemplateManager", paramContext.toString());
    }
    return null;
  }
  ...
  public final boij a()
  {
    return this.jdField_a_of_type_Boij;
  }
  ...
  public void a(boij paramboij, Activity paramActivity, int paramInt)
  {
    if (paramInt == 0)
    {
      if (this.jdField_a_of_type_ArrayOfDovComQqImCapturePartQIMTemplateItem[2] != null) {}
      this.jdField_a_of_type_ArrayOfBoij[2] = paramboij;
      if (this.jdField_a_of_type_ArrayOfBoij[1] != null) {}
      this.jdField_a_of_type_ArrayOfBoij[1] = paramboij;
    }
    while (paramInt == -1)
    {
      return;
    ...
    this.jdField_a_of_type_ArrayOfBoij[paramInt] = paramboij;
  }
  ...
  public void a(QIMTemplateItem paramQIMTemplateItem, Activity paramActivity, int paramInt)
  {
    ...
    {
      localbohj.a(localQIMTemplateItem);
  ...
  public boolean a(Context paramContext)
  {
    ...
    catch (Exception paramContext)
    {
      for (;;)
      {
        ykq.c("CaptureTemplateManager", "initFromCache", paramContext);
        bool1 = bool2;
      }
    }
    ykq.b("CaptureTemplateManager", "initFromCache " + bool1);
    return bool1;
  }
  
  public boolean a(boij paramboij, int paramInt)
  {
    boolean bool2 = false;
    boolean bool3 = false;
    if (paramboij != null)
    {
      boij localboij = this.jdField_a_of_type_ArrayOfBoij[paramInt];
      boolean bool1 = bool3;
      if (localboij != null)
      {
        bool1 = bool3;
        if (paramboij.b().equals(localboij.b())) {
          bool1 = true;
        }
      }
      bool2 = bool1;
      if (QLog.isColorLevel())
      {
        QLog.d("QCombo", 2, "isApplying :" + paramboij);
        bool2 = bool1;
      }
    }
    return bool2;
  ...
  {
    ykq.b("CaptureTemplateManager", "preInitCombo: " + paramList.size());
    bohj localbohj = (bohj)bogd.a(5);
    ...
    if (paramList.hasNext())
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        {
          localboij = localbohj.a(localQIMTemplateItem);
          localboij.a = localboij.a();
          if (localboij.a == 1)
          {
            localboij.b = ((int)(10000.0F * localboij.a()));
            ykq.b("CaptureTemplateManager", "preInitCombo progress: " + localQIMTemplateItem.b + ", progress: " + localboij.b);
            bool = true;
          }
        }
        for (;;)
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Bohu != null) {
      this.jdField_a_of_type_Bohu.a(this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList);
    }
  }
