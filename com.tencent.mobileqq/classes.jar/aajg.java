...
public class aajg
  implements Runnable
{
  public aajg(ArkAppModuleReg.ModuleQQ paramModuleQQ, String paramString1, String paramString2, String paramString3, long paramLong) {}
    ...
    do
    {
      do
      {
        do
        {
          ...
          ((QQCustomDialog)localObject2).setNegativeButton(2131432998, null);
          ((QQCustomDialog)localObject2).setPositiveButton(2131432999, null);
