  ...
  implements View.OnClickListener
{
  ...
  {
    Object localObject4 = (zro)paramView.getTag();
    Object localObject1;
    if (((zro)localObject4).a.jdField_a_of_type_Boolean)
    {
      ...
      ((Intent)localObject1).putExtra("filepath", this.a.e + ((zro)localObject4).a.jdField_a_of_type_JavaLangString);
      ((Intent)localObject1).putExtra("filename", "" + ((zro)localObject4).a.jdField_a_of_type_JavaLangString);
      ((Intent)localObject1).putExtra("nSessionId", this.a.jdField_b_of_type_Long);
      ((Intent)localObject1).putExtra("isHttps", zrm.a(this.a));
      if (!TextUtils.isEmpty(zrm.a(this.a))) {
        ((Intent)localObject1).putExtra("httpsDomain", zrm.a(this.a));
      }
      ((Intent)localObject1).putExtra("httpsPort", zrm.a(this.a));
    ...
    for (;;)
    {
      ...
      localForwardFileInfo.b(((zro)localObject4).a.jdField_b_of_type_Long);
      localForwardFileInfo.d(((zro)localObject4).a.jdField_a_of_type_JavaLangString);
      localForwardFileInfo.d(((zro)localObject4).a.jdField_a_of_type_Long);
      ...
      if (this.a.jdField_a_of_type_Long == 0L)
      {
        ...
        Object localObject5 = ((QQAppInterface)localObject3).getFileManagerDataCenter().b(((zro)localObject4).a.jdField_b_of_type_Long);
        ...
        {
          ((zro)localObject4).a.jdField_b_of_type_Long = ((FileManagerEntity)localObject1).nSessionId;
          ((FileManagerEntity)localObject1).isZipInnerFile = true;
        }
        localForwardFileInfo.b(((zro)localObject4).a.jdField_b_of_type_Long);
        if (localForwardFileInfo.d() == 0L)
        {
          aszk.a(amtj.a(2131716051));
        }
        else
        {
          ...
          {
            aswh localaswh = (aswh)((Iterator)localObject5).next();
            if ((aszt.a(localaswh.jdField_a_of_type_JavaLangString) == 0) && (localaswh.jdField_a_of_type_Long != 0L))
            {
              FileManagerEntity localFileManagerEntity = ((QQAppInterface)localObject3).getFileManagerDataCenter().b(localaswh.jdField_b_of_type_Long);
              ...
              if (localObject1 != null)
              {
                ...
                localaswh.jdField_b_of_type_Long = ((FileManagerEntity)localObject1).nSessionId;
              }
              ((ArrayList)localObject4).add(Long.valueOf(localaswh.jdField_b_of_type_Long));
            }
          }
      ...
      else
      {
        ...
        {
          localObject3 = (aswh)((Iterator)localObject2).next();
          if (aszt.a(((aswh)localObject3).jdField_a_of_type_JavaLangString) == 0) {
            ((ArrayList)localObject1).add(Long.valueOf(((aswh)localObject3).jdField_b_of_type_Long));
          }
        }
