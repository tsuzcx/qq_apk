...
public class ayfa
  implements Manager
{
  ayfc jdField_a_of_type_Ayfc = new ayfb(this);
  public QQAppInterface a;
  public OcrConfig a;
  EntityManager jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  
  public ayfa(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(this.jdField_a_of_type_Ayfc);
  ...
  public static boolean a(String paramString, int paramInt)
  {
    ...
    {
      boolean bool2;
      if (ayhn.a().jdField_a_of_type_Int == 1)
      {
        bool2 = true;
        label68:
        if (QLog.isColorLevel()) {
          QLog.d("Q.ocr", 2, "isSupportOcr, uin:" + paramString + "form:" + paramInt + ",isSupport:" + bool1 + ",dpcSwitch:" + bool2 + ",sdcard:" + aygw.a);
        }
        if ((!bool1) || (!bool2) || (!aygw.a)) {
          break label218;
        }
      }
      label218:
  ...
  public aygm a(List<OCRTextSearchInfo.SougouSearchInfo> paramList)
  {
    aygm localaygm = new aygm();
    if ((paramList != null) && (!paramList.isEmpty()))
    {
      localaygm.jdField_a_of_type_JavaUtilList = new ArrayList();
      aygk localaygk = new aygk();
      localaygk.jdField_a_of_type_Int = 2049;
      localaygk.jdField_a_of_type_JavaLangString = anni.a(2131706586);
      ...
      while (paramList.hasNext())
      {
        ...
        localaygl.jdField_a_of_type_JavaLangObject = localSougouSearchInfo;
        localaygk.jdField_a_of_type_JavaUtilList.add(localaygl);
      }
      localaygm.jdField_a_of_type_JavaUtilList.add(localaygk);
    }
    return localaygm;
  }
  ...
  {
    if (!bgnt.g(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
      ((ayey)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(113)).notifyUI(3, false, new Object[] { Integer.valueOf(-2), paramString1, null });
    }
    ...
    ((ayey)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(113)).a(paramString1, str, paramLong);
  }
  ...
  public void a(boolean paramBoolean, OcrConfig paramOcrConfig)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: invokestatic 110	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   5: ifeq +39 -> 44
    //   8: ldc 224
    //   10: iconst_2
    ...
    //   34: aload_2
    //   35: invokevirtual 290	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   38: invokevirtual 81	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   41: invokestatic 118	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   44: iload_1
    //   45: ifeq +31 -> 76
    //   48: aload_0
    //   49: getfield 26	ayfa:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   52: astore_3
    //   53: aload_3
    //   54: monitorenter
    //   55: aload_0
    //   56: aload_2
    //   57: putfield 283	ayfa:jdField_a_of_type_ComTencentMobileqqOcrDataOcrConfig	Lcom/tencent/mobileqq/ocr/data/OcrConfig;
    //   60: aload_0
    //   61: getfield 28	ayfa:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   64: invokevirtual 63	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   67: aload_0
    //   68: getfield 283	ayfa:jdField_a_of_type_ComTencentMobileqqOcrDataOcrConfig	Lcom/tencent/mobileqq/ocr/data/OcrConfig;
    //   71: invokestatic 298	ayfa:a	(Ljava/lang/String;Lcom/tencent/mobileqq/ocr/data/OcrConfig;)V
    //   74: aload_3
    //   75: monitorexit
    //   76: new 342	com/tencent/mobileqq/ocr/OCRManager$3
    //   79: dup
    //   80: aload_0
    //   81: iload_1
    //   82: invokespecial 345	com/tencent/mobileqq/ocr/OCRManager$3:<init>	(Layfa;Z)V
    //   85: bipush 8
    //   87: aconst_null
    //   88: iconst_0
    //   89: invokestatic 53	com/tencent/mobileqq/app/ThreadManager:post	(Ljava/lang/Runnable;ILcom/tencent/mobileqq/app/ThreadExcutor$IThreadListener;Z)V
    //   92: aload_0
    //   93: monitorexit
    //   94: return
    //   95: astore_2
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Ayfc);
