  ...
  extends ayet
{
  ...
  private xba jdField_a_of_type_Xba = new ayfb(this);
  ...
  private FileManagerEntity a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      paramQQAppInterface = (QQAppInterface)localObject;
    } while (!apug.a((FileManagerEntity)localObject));
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo != null) && (paramQQAppInterface != null))
    {
      ...
      Object localObject = new azpi();
      ((azpi)localObject).jdField_a_of_type_JavaUtilUUID = UUID.nameUUIDFromBytes(this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo.d.getBytes());
      ((azpi)localObject).jdField_b_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo.d;
      ((azpi)localObject).c = this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo.jdField_b_of_type_JavaLangString;
      ((azpi)localObject).jdField_a_of_type_Int = this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo.jdField_b_of_type_Int;
      ...
      xam.a(paramQQAppInterface, Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo.jdField_a_of_type_JavaLangString).longValue(), (TroopFileTransferManager.Item)localObject, 0, false, false, this.jdField_a_of_type_Xba);
