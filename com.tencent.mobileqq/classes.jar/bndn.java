  ...
  implements Animatable
{
  ...
  Property<bndn, Float> jdField_a_of_type_AndroidUtilProperty = new bndo(this, Float.class, "backScale");
  private String jdField_a_of_type_JavaLangString;
  private boolean jdField_a_of_type_Boolean;
  private float jdField_b_of_type_Float;
  private int jdField_b_of_type_Int = 0;
  Property<bndn, Integer> jdField_b_of_type_AndroidUtilProperty = new bndp(this, Integer.class, "backAlpha");
    ...
    for (;;)
    {
      ...
      try
      {
        if ("1/4".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841178);
        }
        if ("1/2".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841177);
        }
        if ("1x".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841179);
        }
        if ("2x".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841180);
        }
        if ("4x".equals(paramString)) {
          return this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841181);
        }
        if (PickerContainer.jdField_a_of_type_JavaLangString.equals(paramString))
        {
          paramString = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841182);
          return paramString;
        }
      }
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidAnimationValueAnimator != null)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bndq(this));
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bndr(this));
