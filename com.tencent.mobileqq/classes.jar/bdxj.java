  ...
  extends AccountObserver
{
  ...
  bdxj(Intent paramIntent, String paramString, bdxl parambdxl)
  {
  ...
  public void onRegisterCommitPassRespWithLhSig(boolean paramBoolean, int paramInt, String paramString, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString = BaseApplicationImpl.getContext().getString(2131717515);
        ...
        if (QLog.isDevelopLevel()) {
          bdxm.a("LHLoginMng -- onRegisterCommitPassRespWithLhSig", localIntent);
        }
        if (this.jdField_a_of_type_Bdxl != null) {
          this.jdField_a_of_type_Bdxl.a(localIntent, paramBoolean, this.jdField_a_of_type_JavaLangString, paramArrayOfByte3, paramString);
        }
