  ...
  implements DialogInterface.OnCancelListener, View.OnClickListener
{
  ...
  private bdxl jdField_a_of_type_Bdxl;
  private int jdField_b_of_type_Int;
  private TextView jdField_b_of_type_AndroidWidgetTextView;
  private int c;
  
  public bdxj(Context paramContext)
  {
  ...
  {
    paramContext = LayoutInflater.from(paramContext).inflate(2131493690, null);
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131312258));
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          else
          {
            try
            {
              localField.set(localNumberPicker, new ColorDrawable(bdyk.a("#3CB371")));
              i += 1;
            }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, bdxl parambdxl)
  {
    this.jdField_a_of_type_AndroidWidgetDatePicker.init(paramInt1, paramInt2, paramInt3, new bdxk(this));
    this.jdField_a_of_type_Bdxl = parambdxl;
  }
  ...
  {
    if (this.jdField_a_of_type_Bdxl != null) {
      this.jdField_a_of_type_Bdxl.onDateCancel();
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    {
      this.jdField_a_of_type_Bdxl.onDateConfirm(String.valueOf(this.jdField_a_of_type_Int), paramView, str);
      a();
      return;
