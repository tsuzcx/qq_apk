...
public class bdxj
{
  ...
  public ArrayList<Entity> a(String paramString)
  {
    ...
    Object localObject2 = (anvg)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getFTSDBManager().a(2);
    Object localObject1 = ((anvg)localObject2).a(paramString);
    ...
    if (j < ((List)localObject1).size())
    {
      ...
      {
        localObject6 = (RecentUser)((anuz)localObject4).findRecentUserByUin(((TroopIndex)localObject5).mTroopUin, 1);
    ...
    for (;;)
    {
      ...
      localObject7 = ((anvg)localObject2).b((String)localObject7);
      ...
      if ((((amsw)localObject1).b(((TroopIndex)localObject8).mMemberUin)) && (!((String)localObject6).equals(((TroopIndex)localObject8).mMemberUin)) && (!paramString.equals(((TroopIndex)localObject8).mMemberUin)))
      {
        if (((HashMap)localObject5).containsKey(((TroopIndex)localObject8).mMemberUin)) {
          break label676;
        }
        bdxm localbdxm = new bdxm(this, f3);
        localbdxm.b = f1;
        localbdxm.jdField_a_of_type_Int = 1;
        RecentUser localRecentUser = (RecentUser)((anuz)localObject4).findRecentUserByUin(((TroopIndex)localObject8).mMemberUin, 0);
        if (localRecentUser != null) {
          localbdxm.jdField_a_of_type_Long = localRecentUser.lastmsgtime;
        }
        ((HashMap)localObject5).put(((TroopIndex)localObject8).mMemberUin, localbdxm);
      }
      for (;;)
      {
        j += 1;
        break;
        label676:
        localObject8 = (bdxm)((HashMap)localObject5).get(((TroopIndex)localObject8).mMemberUin);
        ((bdxm)localObject8).jdField_a_of_type_Int += 1;
        ((bdxm)localObject8).b += f1;
      }
      if (QLog.isColorLevel()) {
      ...
      Collections.sort(paramString, new bdxk(this));
      i = paramString.size();
      if ((i > 1) && (((bdxm)((Map.Entry)paramString.get(i - 1)).getValue()).a() == ((bdxm)((Map.Entry)paramString.get(0)).getValue()).a())) {}
      for (i = 1;; i = 0)
      {
        if (i != 0)
        {
          ...
          Collections.sort(paramString, new bdxl(this));
        }
        localObject2 = new ArrayList();
        i = 0;
        if (i < paramString.size())
        {
          localObject3 = (bdxm)((Map.Entry)paramString.get(i)).getValue();
          localObject4 = ((amsw)localObject1).b((String)((Map.Entry)paramString.get(i)).getKey());
          if (localObject4 != null)
          {
            ((ArrayList)localObject2).add(localObject4);
            if ((i < 20) && (QLog.isColorLevel())) {
              QLog.i("RelationFriendsSearchHelper", 2, "top20:uin" + StringUtil.getSimpleUinForPrint(((Friends)localObject4).uin) + ",scores:" + ((bdxm)localObject3).a() + ",frequency:" + ((bdxm)localObject3).jdField_a_of_type_Int + ",activefactor:" + ((bdxm)localObject3).b + ",c2clastmsgtime:" + ((bdxm)localObject3).jdField_a_of_type_Long);
            }
          }
          for (;;)
          {
