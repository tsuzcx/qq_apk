  ...
  implements PluginManagerUpdater
{
  ...
  public aqjs(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    this.e = paramString3;
    ...
    this.jdField_a_of_type_Aqjr = new aqjr(paramContext, paramString1, paramString3);
    ...
    for (;;)
    {
      ...
      if ((paramString2 != null) && (paramString2.endsWith("0"))) {
        this.jdField_a_of_type_JavaLangString = "http://down.qq.com/reading/android/plugin/release/3/reader-plugin-manager-release-gray.apk";
      } else {
        this.jdField_a_of_type_JavaLangString = "http://down.qq.com/reading/android/plugin/release/3/reader-plugin-manager-release.apk";
      }
    }
    if ((paramString2 != null) && (paramString2.endsWith("0"))) {}
  ...
  private boolean a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        throw new Error(this.jdField_a_of_type_JavaLangString + ajjy.a(2131635674));
      }
      finally
      {
        localObject1 = null;
      ...
      try
      {
        if (((HttpURLConnection)localObject1).getResponseCode() != 200) {
          throw new Error(ajjy.a(2131635676) + 200 + ajjy.a(2131635677) + ((HttpURLConnection)localObject1).getResponseCode());
        }
  ...
  public File a()
  {
    ...
    aqnp localaqnp = new aqnp();
    localaqnp.a(BaseApplicationImpl.getContext());
    localaqnp.a(this.jdField_a_of_type_JavaLangString, new aqju(this, localFile, arrayOfException, l, localCountDownLatch));
    localaqnp.b(aqnr.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaIoFile.getAbsolutePath()));
  ...
  {
    throw new UnsupportedOperationException(ajjy.a(2131635675));
  }
  ...
  public Future<File> update()
  {
    ...
    this.jdField_a_of_type_JavaUtilConcurrentFuture = ajtb.a(192).submit(new aqjt(this));
    return this.jdField_a_of_type_JavaUtilConcurrentFuture;
  }
