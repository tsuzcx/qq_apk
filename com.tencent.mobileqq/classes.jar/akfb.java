  ...
  implements ajua
{
  ...
  public akfb(QQAppInterface paramQQAppInterface, akfa paramakfa)
  {
  ...
  protected List<FTSOptSync> a(SQLiteDatabase paramSQLiteDatabase, atmp paramatmp)
  {
    try
    {
      ...
      paramSQLiteDatabase = paramatmp.a(FTSTroopSync.class, FTSTroopSync.class.getSimpleName(), false, "_id>?", new String[] { String.valueOf(this.jdField_a_of_type_Int) }, null, null, null, "300");
    ...
    catch (Throwable paramSQLiteDatabase)
    {
      ...
      awrn.a(BaseApplicationImpl.getApplication().getApplicationContext()).a(null, "actGetOptFailed", true, 0L, 0L, paramSQLiteDatabase, null);
    }
    return null;
  }
  ...
  public List<com.tencent.mobileqq.fts.entity.FTSEntity> a(String paramString)
  {
    ...
    aprg localaprg = new aprg().a(TroopIndex.class).a(new aprh[] { new aprh("TroopIndex", paramString, true) }).a(true);
    if (((avwf.a(paramString)) || (avwf.b(paramString))) && (!avwf.c(paramString))) {
      localaprg.a(200);
    }
    return this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase.a(localaprg.a());
  }
  ...
  public boolean a(FTSDatatbase paramFTSDatatbase, FTSDatabase paramFTSDatabase)
  {
    ...
    this.jdField_a_of_type_Akfd = new akfc(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this);
    this.jdField_e_of_type_Boolean = true;
    if (QLog.isColorLevel()) {
      QLog.d("Q.fts.troop.operator", 2, "init success");
    }
    this.jdField_e_of_type_Int = apre.b(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, "TroopIndex");
    return true;
  }
  ...
  public boolean a(ArrayList<FTSOptSync> paramArrayList)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 28	akfb:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   4: invokevirtual 152	com/tencent/mobileqq/app/QQAppInterface:getEntityManagerFactory	()Latmq;
    //   7: invokevirtual 158	atmq:createEntityManager	()Latmp;
    //   10: astore 5
    //   12: aconst_null
    //   13: astore_3
    //   14: aconst_null
    //   15: astore_2
    //   16: aload 5
    //   18: invokevirtual 403	atmp:a	()Latmr;
    //   21: astore 4
    //   23: aload 4
    //   25: astore_2
    //   26: aload 4
    ...
    //   77: invokevirtual 425	atmp:b	(Latmo;)V
    //   80: goto -35 -> 45
    //   83: astore_1
    //   84: aload_2
    //   85: astore_3
    ...
    //   124: ifnull +7 -> 131
    //   127: aload_2
    //   128: invokevirtual 435	atmr:b	()V
    //   131: iconst_0
    //   132: ireturn
    //   133: aload 4
    //   135: astore_2
    ...
    //   138: astore_3
    //   139: aload 4
    //   141: invokevirtual 437	atmr:c	()V
    //   144: aload 4
    //   146: ifnull +8 -> 154
    //   149: aload 4
    //   151: invokevirtual 435	atmr:b	()V
    //   154: iconst_1
    //   155: ireturn
    //   156: astore_1
    //   157: aload_3
    //   158: ifnull +7 -> 165
    //   161: aload_3
    //   162: invokevirtual 435	atmr:b	()V
    //   165: aload_1
    //   166: athrow
    ...
    //   21	129	4	localatmr	atmr
    //   10	57	5	localatmp	atmp
    // Exception table:
    //   from	to	target	type
  ...
  public List<com.tencent.mobileqq.fts.entity.FTSEntity> b(String paramString)
  {
    ...
    paramString = new aprg().a(TroopIndex.class).a(new aprh[] { new aprh("ext1", paramString, true) }).a(true);
  ...
  public void b(ArrayList<FTSOptSync> paramArrayList)
  {
    ...
    this.jdField_a_of_type_Akfa.post(new FTSTroopOperator.2(this, paramArrayList));
  }
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      do
      {
        for (;;)
        {
          try
          {
            bool1 = apre.a(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, b());
            bool2 = bool1;
            bool2 = bool1;
          }
          catch (Throwable localThrowable1)
          {
            try
            {
              ...
              bool1 = apre.b(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, b());
              if (QLog.isColorLevel()) {
        ...
        i = apre.a(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, b());
        if (QLog.isColorLevel()) {
  ...
  public void e()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase != null) && (this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase.d()))
    {
      ...
      localObject1 = a((SQLiteDatabase)localObject1, localatmp);
      if (QLog.isColorLevel())
      {
      ...
      if (localFTSTroopSync.mOpt == 3)
      {
        ...
        localObject3 = this.jdField_a_of_type_Ajjj.b(String.valueOf(localFTSTroopSync.mMemberUin));
      ...
      for (;;)
      {
        ...
        n = apre.a(this.jdField_a_of_type_ComTencentMobileqqFtsFTSDatabase, localArrayList, b(), 1);
        if (n != -1) {
        ...
        if (localObject4 != null)
        {
          localObject5 = localatmp.a(FTSTroopTime.class, FTSTroopTime.class.getSimpleName(), false, "mTroopUin=? ", new String[] { String.valueOf(localFTSTroopSync.mTroopUin) }, null, null, null, null);
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject1 != null)
        {
          ...
          if (((Iterator)localObject4).hasNext())
          {
            ...
            i3 = i;
            i1 = j;
            if (!azzz.d(((TroopMemberInfo)localObject5).memberuin)) {
              break label1690;
            }
            i3 = i;
            i1 = j;
            localObject3 = this.jdField_a_of_type_Ajjj.b(String.valueOf(((TroopMemberInfo)localObject5).memberuin));
            if (localObject3 == null) {
              break label1702;
            }
            i3 = i;
      ...
      for (;;)
      {
        ...
        if ((QLog.isColorLevel()) || (l1 > 60000L))
        {
          ...
          awrn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()).a(null, "actFTSTroopCost", true, l1, 0L, (HashMap)localObject2, null, false);
  ...
  public void f()
  {
    this.jdField_a_of_type_Akfa.post(new FTSTroopOperator.1(this));
  }
