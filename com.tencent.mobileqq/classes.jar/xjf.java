...
public class xjf
{
  public static final HashMap<String, xjf> a;
  int jdField_a_of_type_Int = 0;
  public SharedPreferences a;
  public ClassLoader a;
  public Object a;
  public String a;
  mzs jdField_a_of_type_Mzs = new mzs();
  public xje a;
  ...
  public xjf(String paramString1, String paramString2)
  {
  ...
  public void a()
  {
    bciq localbciq = (bciq)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(107);
    try
    {
      if (this.jdField_b_of_type_Boolean)
      {
        localbciq.notifyUI(3, true, Integer.valueOf(4));
        return;
      }
      ...
      if ((!mzb.a(BaseApplicationImpl.getContext(), str, new xjg(this, l, localbciq, localBaseApplication))) && (QLog.isColorLevel()))
      {
  ...
  public void a(BaseActivity paramBaseActivity)
  {
    ...
    {
      this.jdField_a_of_type_Xje = new xje(paramBaseActivity, 0, this.jdField_a_of_type_Xje);
      return;
    }
    this.jdField_a_of_type_Xje = new xje(paramBaseActivity, 0, this.e, this.jdField_a_of_type_JavaLangClassLoader);
  }
  ...
  public void a(JSONObject paramJSONObject, QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = mzh.b(this.jdField_a_of_type_JavaLangString);
    boolean bool2;
    ...
    for (;;)
    {
      ThreadManager.post(new ViewPluginLoader.5(this, paramJSONObject, paramQQAppInterface, new xji(this, paramQQAppInterface, bool2, bool1)), 8, null, false);
      return;
      if ((i == 3) || (i == 2))
      {
  ...
  public void b()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((!new File(mzh.a(this.jdField_a_of_type_JavaLangString) + this.jdField_a_of_type_JavaLangString + "/" + this.jdField_b_of_type_JavaLangString).exists()) && (!TextUtils.isEmpty(str)) && (!"0".equals(str))) {
    ...
    mzb.a(this.jdField_a_of_type_JavaLangString, localQQAppInterface, new xjh(this, localQQAppInterface), false);
  }
  
  public void c()
  {
    this.jdField_a_of_type_Xje = null;
  }
}
