...
public class qjv
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new qjy(this, Looper.getMainLooper());
  ...
  public qjv(Activity paramActivity, AppRuntime paramAppRuntime, View paramView, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131312924));
  }
  ...
  public void a(VideoInfo paramVideoInfo)
  {
    ...
    do
    {
      ...
      i = bgmq.K(this.jdField_a_of_type_MqqAppAppRuntime);
    } while (i >= 3);
    bgmq.C(this.jdField_a_of_type_MqqAppAppRuntime, i + 1);
    ...
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131312931);
    if (!TextUtils.isEmpty(paramVideoInfo.g)) {
      localTextView.setText(ajjy.a(2131650370));
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new qjw(this));
      this.jdField_b_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new qjx(this));
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new VideofeedsUserGuideController.4(this), 300L);
      return;
      localTextView.setText(ajjy.a(2131650369));
    }
  }
