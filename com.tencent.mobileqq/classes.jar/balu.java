  ...
  implements PopupWindow.OnDismissListener
{
  ...
  public balu(BaseActivity paramBaseActivity)
  {
  ...
  public void a(TroopChatPie paramTroopChatPie, View paramView)
  {
    ...
    if (this.jdField_a_of_type_Balv == null)
    {
      this.jdField_a_of_type_Balv = balv.a(paramTroopChatPie, this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, -1, -1);
      this.jdField_a_of_type_Balv.setOnDismissListener(this);
      baky.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app).a();
    }
    ...
    this.jdField_a_of_type_Balv.setAnimationStyle(2131755386);
    this.jdField_a_of_type_Balv.showAtLocation(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getWindow().getDecorView(), 80, 0, 0);
    this.jdField_a_of_type_Balv.a();
  }
  ...
  public boolean a()
  {
    ...
    {
      bool1 = bool2;
      if (this.jdField_a_of_type_Balv.isShowing())
      {
        this.jdField_a_of_type_Balv.dismiss();
        bool1 = true;
      }
    }
    return bool1;
  ...
  {
    baky.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app).a(false);
