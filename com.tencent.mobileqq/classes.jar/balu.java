...
public class balu
{
  ...
  public static baly a;
  static batl a;
  public static String a;
  public static HashMap<String, Boolean> a;
  public static baly[] a;
  public static baly b;
  public static baly c;
  public static baly d;
  public static baly e;
  public static baly f;
  public static baly g;
  public static baly h;
  public static baly i;
  
  static
  {
    jdField_a_of_type_Baly = new baly("recommendEmotion.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_emoji_aioPanal/", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_emoji_aioPanal/xydata.json", "recommendEmotionVersion", "vipData_emoji_aio_recommend.json");
    b = new baly("IndividuationUrls.json", "", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_individuation_url/android.json", "individuationUrlJsonNewVersion", "vipData_individuation_url_json");
    c = new baly("Individuation.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_individuation/", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_individuation/xydata.json", "IndividuationVersion", "individ_json");
    d = new baly("EmoticonWording.json", "", "https://i.gtimg.cn/club/item/parcel/client_wording.json", "EmoticonWordingVersion", "wording_json");
    e = new baly("WebviewCrashReport.json", "", "https://i.gtimg.cn/qqshow/admindata/comdata/vip_crash_report/WebviewCrashReport.json", "WebviewCrashJSONVersion", "WebviewCrashReport.json");
    f = new baly("Qutu_xydata.json", "", "https://i.gtimg.cn/qqshow/admindata/comdata/vipQutu_release_zip/xydata.json", "QutuXYDataJsonVersion", "xydata.json");
    g = new baly("iRedPacket_v2.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipRedPacketDataV2/", "https://i.gtimg.cn/qqshow/admindata/comdata/vipRedPacketDataV2/xydata.mobile.v1.json", "vipRedPacketData_json_v2", "vipRedPacketData_json_v2");
    h = new baly("UrlIntercept.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_url_to_api", "https://i.gtimg.cn/qqshow/admindata/comdata/vipData_url_to_api/android.json", "UrlIntercept_json", "UrlIntercept_json");
    i = new baly("font_info.json", "https://i.gtimg.cn/qqshow/admindata/comdata/vipList_font_data", "https://i.gtimg.cn/qqshow/admindata/comdata/vipList_font_data/version.json", "FontInfoList_json", "FontInfoList_json");
    jdField_a_of_type_ArrayOfBaly = new baly[] { jdField_a_of_type_Baly, c, d };
    jdField_a_of_type_JavaLangString = "https://i.gtimg.cn/xydata";
    jdField_a_of_type_JavaUtilHashMap = new HashMap();
    jdField_a_of_type_Batl = new balv();
  }
  ...
  public static JSONObject a(QQAppInterface paramQQAppInterface, baly parambaly, boolean paramBoolean)
  {
    Object localObject = paramQQAppInterface.getApplication().getApplicationContext();
    String str = parambaly.jdField_a_of_type_JavaLangString;
    localObject = new File(((Context)localObject).getFilesDir(), str);
    if (((File)localObject).exists()) {
      try
      {
        paramQQAppInterface = bace.a((File)localObject, -1);
    ...
    for (;;)
    {
      ...
      if (paramBoolean) {
        a(paramQQAppInterface, parambaly);
      }
    }
  }
  ...
  public static void a(AppInterface paramAppInterface, baly parambaly, String paramString, File paramFile, Bundle paramBundle)
  {
    if (paramFile == null) {}
    String str1;
    do
    {
      return;
      str1 = paramString;
    } while ((paramString == null) && (parambaly == null));
    label427:
    label435:
    label441:
    label444:
    for (;;)
    {
      try
      {
        for (;;)
        {
          ...
          parambaly = parambaly.jdField_a_of_type_JavaLangString;
          ...
          String str3 = parambaly + "_" + j;
          if (QLog.isColorLevel()) {
            QLog.d("ClubContentJsonTask", 2, "club_downloadFile,method:" + paramString + ",key:" + parambaly + ", server version:" + j + ",ifromet:" + str2);
          }
          ...
          paramFile = new batm(str1, paramFile);
          paramFile.n = true;
          paramFile.jdField_a_of_type_JavaLangString = parambaly;
          ((bato)paramAppInterface.getManager(47)).a(1).a(paramFile, jdField_a_of_type_Batl, paramBundle);
          if (QLog.isColorLevel()) {
          ...
          try
          {
            ...
            paramString.put("param_key", parambaly);
            paramString.put("param_ifromet", str2);
            awrn.a(paramAppInterface.getApplication().getApplicationContext()).a(paramAppInterface.getAccount(), "VipClubContentJsonTaskLoad", true, 1L, 0L, paramString, "", false);
          }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    int j = 0;
    while (j < jdField_a_of_type_ArrayOfBaly.length)
    {
      a(paramQQAppInterface, jdField_a_of_type_ArrayOfBaly[j]);
      j += 1;
    }
  }
  
  public static void a(QQAppInterface paramQQAppInterface, baly parambaly)
  {
    int j = 10;
    int k = 0;
    if ((paramQQAppInterface == null) || (parambaly == null)) {}
    do
    {
      return;
      File localFile = new File(paramQQAppInterface.getApplication().getApplicationContext().getFilesDir(), parambaly.jdField_a_of_type_JavaLangString);
      if (!localFile.exists())
      {
        if (QLog.isColorLevel()) {
          QLog.d("ClubContentJsonTask", 2, "downloadIfNotExist, not exist: " + parambaly.jdField_a_of_type_JavaLangString);
        }
        for (;;)
        {
          try
          ...
          ((Bundle)localObject).putString("version_key", parambaly.d);
          ((Bundle)localObject).putString("method", "downloadIfNotExist");
          ((Bundle)localObject).putString("ifromet", "null1");
          a(paramQQAppInterface, parambaly, anam.a("VIP_emosm", parambaly.b), localFile, (Bundle)localObject);
          return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, baly parambaly, int paramInt, boolean paramBoolean)
  {
    File localFile = new File(paramQQAppInterface.getApplication().getApplicationContext().getFilesDir(), parambaly.jdField_a_of_type_JavaLangString);
    Bundle localBundle = new Bundle();
    localBundle.putInt("version", paramInt);
    localBundle.putString("version_key", parambaly.d);
    localBundle.putString("method", "updateJson");
    localBundle.putString("ifromet", String.valueOf(paramBoolean));
    a(paramQQAppInterface, parambaly, null, localFile, localBundle);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    //   13: ifnonnull +4 -> 17
    //   16: return
    //   17: getstatic 465	fv:jdField_c_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   20: iconst_0
    //   21: invokevirtual 471	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   24: new 473	balw
    //   27: dup
    //   28: invokespecial 474	balw:<init>	()V
    //   31: putstatic 476	balu:jdField_a_of_type_Balw	Lbalw;
    //   34: aload 6
    //   36: ldc_w 478
    ...
    //   55: invokestatic 491	bapv:a	(Lmqq/app/AppRuntime;Ljava/lang/String;Ljava/lang/String;)Z
    //   58: pop
    //   59: aload 6
    //   61: ldc_w 493
    ...
    //   178: astore 5
    //   180: getstatic 476	balu:jdField_a_of_type_Balw	Lbalw;
    //   183: aload 4
    //   185: putfield 516	balw:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   188: getstatic 476	balu:jdField_a_of_type_Balw	Lbalw;
    //   191: aload 5
    //   193: putfield 517	balw:b	Ljava/lang/String;
    ...
    //   278: istore_3
    //   279: iload_3
    //   280: putstatic 533	fv:jdField_e_of_type_Boolean	Z
    //   283: getstatic 533	fv:jdField_e_of_type_Boolean	Z
    //   286: ifeq +488 -> 774
    //   289: aload 4
    //   291: ldc_w 535
    ...
    //   412: getstatic 537	fv:jdField_f_of_type_Boolean	Z
    ...
    //   436: getstatic 550	fv:jdField_b_of_type_Float	F
    ...
    //   448: getstatic 554	fv:jdField_c_of_type_Float	F
    ...
    //   472: getstatic 562	fv:jdField_e_of_type_Float	F
    ...
    //   484: getstatic 566	fv:jdField_f_of_type_Float	F
    ...
    //   496: getstatic 571	fv:jdField_b_of_type_Int	I
    ...
    //   508: getstatic 465	fv:jdField_c_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   511: iconst_1
    //   512: invokevirtual 471	java/util/concurrent/atomic/AtomicBoolean:set	(Z)V
    //   515: getstatic 595	adra:a	Lcom/tencent/util/LRULinkedHashMap;
    //   518: astore 4
    //   520: aload 4
    //   522: monitorenter
    //   523: getstatic 595	adra:a	Lcom/tencent/util/LRULinkedHashMap;
    //   526: invokevirtual 600	com/tencent/util/LRULinkedHashMap:clear	()V
    //   529: aload 4
    //   531: monitorexit
    //   532: aload_0
    //   533: invokestatic 605	bajo:a	(Lcom/tencent/common/app/AppInterface;)V
    //   536: aload 6
    //   538: ldc_w 607
    ...
    //   625: putstatic 627	aqdf:jdField_a_of_type_Int	I
    //   628: aload 6
    //   630: ldc_w 629
    ...
    //   664: iconst_1
    //   665: iadd
    //   666: putstatic 641	gc:jdField_a_of_type_Int	I
    //   669: getstatic 644	gc:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   672: aload_0
    //   673: ldc_w 646
    ...
    //   682: getstatic 653	gc:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   685: astore 4
    //   687: aload_0
    //   688: ldc_w 655
    ...
    //   715: aload_0
    //   716: ifnull -700 -> 16
    //   719: getstatic 660	bami:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   722: astore 4
    //   724: aload_0
    //   725: ldc_w 531
