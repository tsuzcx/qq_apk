...
public class bigj
  extends bifz
  implements bigl, biif, bjmk, bjml
{
  public float a;
  public long a;
  protected Handler a;
  ...
  public bigj(@NonNull bigb parambigb)
  {
    super(parambigb);
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    urk.c("Q.qqstory.record.EditVideoPlayer", "updateVideoDrawablePlayerUI width" + paramInt1 + "heightRatio=" + f + "dst_height" + this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.d + "dst_width=" + this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.jdField_c_of_type_Int);
    this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.a(paramInt1, paramInt2, f, false, bjlo.a(5.0F));
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    urk.d("Q.qqstory.record.EditVideoPlayer", "pausePreview but the player has not started : " + this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.jdField_a_of_type_Int);
  }
  ...
  private void o()
  {
    ...
    urk.d("Q.qqstory.record.EditVideoPlayer", "restartPreview but the player is not stopping : " + this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer.jdField_a_of_type_Int);
  }
  ...
  public long a(int paramInt)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      {
        localObject = (biie)((List)localObject).get(paramInt);
        return ((biie)localObject).d - ((biie)localObject).jdField_c_of_type_Long;
      }
    }
    return -1L;
  }
  ...
  public Bitmap a(int paramInt)
  {
    ...
    if (Looper.myLooper() == this.jdField_a_of_type_AndroidOsHandler.getLooper())
    {
      ...
      if ((localObject != null) && (paramInt < ((List)localObject).size())) {}
      for (localObject = (biie)((List)localObject).get(paramInt); localObject == null; localObject = null) {
        return null;
      }
      return a((biie)localObject);
    }
  ...
  public Bitmap a(@NonNull biie parambiie)
  {
    Bitmap localBitmap = null;
    Object localObject = (bibh)a(bibh.class);
    int j;
    int i;
    if (localObject != null)
    {
      j = ((bibh)localObject).a(parambiie.jdField_c_of_type_Int);
      i = ((bibh)localObject).a(this.jdField_a_of_type_Bigb.a());
      urk.a("Q.qqstory.record.EditVideoPlayer", "generateVideoFrameBitmap for %d, playModeNeeded = %d, currentPlayMode = %d", Integer.valueOf(parambiie.jdField_c_of_type_Int), Integer.valueOf(j), Integer.valueOf(i));
    }
    for (;;)
    {
      localObject = (bibg)a(bibg.class);
      int k;
      byte[] arrayOfByte;
      if (localObject != null)
      {
        k = ((bibg)localObject).a();
        arrayOfByte = ((bibg)localObject).a(parambiie.jdField_c_of_type_Int);
      }
      for (localObject = ((bibg)localObject).a(this.jdField_a_of_type_Bigb.a());; localObject = null)
      {
        ...
        try
        {
          ...
          urk.a("Q.qqstory.record.EditVideoPlayer", "generateVideoFrameBitmap, playMode=%d, info=%s", Integer.valueOf(j), parambiie);
          if (j == 1)
          {
            localBitmap = ((MultiBlockVideoPlayer)this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer).a(parambiie.b - 1L, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.a(), this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.b());
            return localBitmap;
          }
          parambiie = ((MultiBlockVideoPlayer)this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer).a(parambiie.jdField_a_of_type_Long, this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.a(), this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource.b());
          return parambiie;
        }
        finally
        {
  ...
  public List<? extends biio> a()
  {
    if ((this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer instanceof MultiBlockVideoPlayer))
    {
      ...
      if (localList != null)
      {
        ...
        if (i > 1) {}
        for (biie localbiie = (biie)localList.get(i - 1); (localbiie != null) && (localbiie.b - localbiie.jdField_a_of_type_Long < 3L); localbiie = null) {
  ...
  public void a()
  {
    ...
    boolean bool1 = bigb.a(this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_Long, 262144);
    ...
    if ((bool1) && (bool2))
    {
      ...
      if (!(this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource instanceof EditRecordVideoSource)) {
        break label459;
      }
      this.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditRecordVideoSource = ((EditRecordVideoSource)this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams$EditSource);
      this.jdField_a_of_type_DovComTencentMobileqqShortvideoWidgetImageViewVideoPlayer = ((ImageViewVideoPlayer)a(2131300803));
      ...
      localObject = null;
      str1 = null;
      Bundle localBundle = this.jdField_a_of_type_Bigb.jdField_a_of_type_DovComTencentBizQqstoryTakevideoEditVideoParams.jdField_a_of_type_AndroidOsBundle;
      if (localBundle == null) {
        break label569;
      }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        break label272;
        label492:
        urq.jdField_a_of_type_Long = this.jdField_a_of_type_Bihj.getActivity().getIntent().getLongExtra("stop_record_time", 0L);
  ...
  public void a(int paramInt)
  {
    ...
    long l2;
    long l1;
    if ((paramInt == 1) && (this.jdField_a_of_type_Long == 0L) && (!this.jdField_a_of_type_Bigb.a()))
    {
    ...
    for (;;)
    {
      ...
      if (l3 != 0L) {
        urp.b("video_edit", "startEditVideoTime", this.jdField_a_of_type_Bigb.b(), 0, new String[] { String.valueOf(l4 - l3) });
      }
      return;
      label229:
      l1 = 0L;
  ...
  public void a(int paramInt, @NonNull bitz parambitz)
  {
    ...
    if (!this.jdField_a_of_type_Boolean) {
      parambitz.a.hasFragments = false;
    }
    for (;;)
    {
      return;
      ...
      {
        localObject1 = (biie)((Iterator)localObject2).next();
        if (localObject1 == null)
        {
          urk.e("Q.qqstory.record.EditVideoPlayer", "editVideoPrePublish error. RecordVideoBlockInfo is null.");
        }
        else if (((biie)localObject1).jdField_c_of_type_Int == paramInt)
        {
      ...
      try
      {
        ((JSONObject)localObject2).put("vfFrameIndexStart", ((biie)localObject1).jdField_a_of_type_Long);
        ((JSONObject)localObject2).put("vfFrameIndexEnd", ((biie)localObject1).b);
        ((JSONObject)localObject2).put("afTimeStart", ((biie)localObject1).jdField_c_of_type_Long);
        ((JSONObject)localObject2).put("afTimeEnd", ((biie)localObject1).d);
        parambitz.a.fragments = ((JSONObject)localObject2).toString();
        urk.b("Q.qqstory.record.EditVideoPlayer", "fragments = %s.", parambitz.a.fragments);
        urk.b("Q.qqstory.record.EditVideoPlayer", "editVideoPrePublish : %s", parambitz.a.fragments);
        if (parambitz.a.hasFragments) {
          continue;
        }
  ...
  public void a(biie parambiie)
  {
    urk.a("Q.qqstory.record.EditVideoPlayer", "updateVideoFrameBitmap info=%s", parambiie);
    Object localObject = a(parambiie);
    if (localObject != null)
    {
      ...
      if (localBitmap != null)
      {
        ...
        biie localbiie = (biie)((List)localObject).get(parambiie.jdField_c_of_type_Int);
        ((List)localObject).set(parambiie.jdField_c_of_type_Int, localbiie.a(localBitmap));
  ...
  public void f()
  {
    ...
    switch (this.jdField_a_of_type_Bigb.jdField_a_of_type_Int)
    {
    case 0: 
    case 2: 
    case 5: 
  ...
  public void i()
  {
    ...
    if (localBitmap1 != null)
    {
      ...
      if (this.jdField_b_of_type_Boolean) {
        Stream.of(localBitmap1).map(new ThreadOffFunction("Q.qqstory.record.EditVideoPlayer", 2)).map(new biiq(0.2F, false)).map(new biir(10)).map(new UIThreadOffFunction(this)).subscribe(new bigk(this));
      }
    }
    this.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
  }
