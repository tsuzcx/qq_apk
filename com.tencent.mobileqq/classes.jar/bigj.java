...
public class bigj
{
  ...
  private static bbgu jdField_a_of_type_Bbgu;
  private static bign jdField_a_of_type_Bign = new bign(Looper.getMainLooper());
  ...
  {
    Message localMessage = jdField_a_of_type_Bign.obtainMessage();
    localMessage.what = 3001;
    jdField_a_of_type_Bign.sendMessage(localMessage);
  }
  ...
  public static void b(Activity paramActivity, int paramInt)
  {
    ...
    jdField_a_of_type_Bign.removeMessages(3000);
    Message localMessage = jdField_a_of_type_Bign.obtainMessage();
    localMessage.what = 3000;
    localMessage.obj = paramActivity;
    localMessage.arg1 = paramInt;
    jdField_a_of_type_Bign.sendMessageDelayed(localMessage, 1000L);
  }
  ...
  private static void d(Activity paramActivity, int paramInt)
  {
    ...
    label44:
    while (((jdField_a_of_type_Bbgu != null) && (jdField_a_of_type_Bbgu.isShowing())) || (!a()))
    {
      return;
      break;
    }
    ...
    label161:
    for (String str2 = BaseApplicationImpl.getContext().getString(2131692710);; str2 = BaseApplicationImpl.getContext().getString(2131692712))
    {
      jdField_a_of_type_Bbgu = bbdj.a(paramActivity, 230, str1, str2, 2131692713, 2131692714, new bigk(paramInt, paramActivity), new bigl());
      jdField_a_of_type_Bbgu.setOnDismissListener(new bigm());
      jdField_a_of_type_Bbgu.show();
      return;
      str1 = BaseApplicationImpl.getContext().getString(2131692716);
      break;
    }
  }
}
