...
public class rhw
{
  ...
  public rhw()
  {
    ...
    this.jdField_a_of_type_Rep = new rep();
  }
  
  private static rhw b(articlesummary.WendaInfo paramWendaInfo)
  {
    boolean bool = true;
    rhw localrhw = new rhw();
    ...
    for (;;)
    {
      localrhw.jdField_a_of_type_Boolean = bool;
      if (paramWendaInfo.bytes_question_rowkey.has()) {
        localrhw.jdField_a_of_type_JavaLangString = paramWendaInfo.bytes_question_rowkey.get().toStringUtf8();
      }
      if (paramWendaInfo.bytes_question_desc.has()) {
        localrhw.jdField_b_of_type_JavaLangString = paramWendaInfo.bytes_question_desc.get().toStringUtf8();
      }
      if (paramWendaInfo.bytes_question_pic_url.has()) {
        localrhw.jdField_c_of_type_JavaLangString = paramWendaInfo.bytes_question_pic_url.get().toStringUtf8();
      }
      if (paramWendaInfo.bytes_wenda_url.has()) {
        localrhw.jdField_d_of_type_JavaLangString = paramWendaInfo.bytes_wenda_url.get().toStringUtf8();
      }
      if (paramWendaInfo.uint32_follow_count.has()) {
        localrhw.jdField_a_of_type_Int = paramWendaInfo.uint32_follow_count.get();
      }
      if (paramWendaInfo.uint32_answer_count.has()) {
        localrhw.jdField_b_of_type_Int = paramWendaInfo.uint32_answer_count.get();
      }
      if (paramWendaInfo.bytes_icon_url.has()) {
        localrhw.e = paramWendaInfo.bytes_icon_url.get().toStringUtf8();
      }
      if (paramWendaInfo.bytes_answer_url.has()) {
        localrhw.f = paramWendaInfo.bytes_answer_url.get().toStringUtf8();
      }
      if (paramWendaInfo.channel_id.has()) {
        localrhw.jdField_c_of_type_Int = paramWendaInfo.channel_id.get();
      }
      if (paramWendaInfo.channel_id_name.has()) {
        localrhw.h = paramWendaInfo.channel_id_name.get();
      }
      if (paramWendaInfo.channel_second_id.has()) {
        localrhw.jdField_d_of_type_Int = paramWendaInfo.channel_second_id.get();
      }
      if (paramWendaInfo.channel_second_id_name.has()) {
        localrhw.i = paramWendaInfo.channel_second_id_name.get();
      }
      if (paramWendaInfo.tag_id.has()) {
        localrhw.jdField_a_of_type_JavaUtilList = paramWendaInfo.tag_id.get();
      }
      if (paramWendaInfo.tag_id_name.has()) {
        localrhw.jdField_b_of_type_JavaUtilList = paramWendaInfo.tag_id_name.get();
      }
      if (paramWendaInfo.author_nick.has()) {
        localrhw.j = paramWendaInfo.author_nick.get();
      }
      if (paramWendaInfo.jump_url.has()) {
        localrhw.k = paramWendaInfo.jump_url.get();
      }
      if (paramWendaInfo.images_url.has()) {
        localrhw.jdField_c_of_type_JavaUtilList = paramWendaInfo.images_url.get();
      }
      if (paramWendaInfo.icon_name.has()) {
        localrhw.l = paramWendaInfo.icon_name.get();
      }
      if (paramWendaInfo.icon_color.has()) {
        localrhw.m = paramWendaInfo.icon_color.get();
      }
      if (paramWendaInfo.super_wenda_button_title.has()) {
        localrhw.n = paramWendaInfo.super_wenda_button_title.get();
      }
      if (paramWendaInfo.answer_detail.has()) {
        localrhw.a((articlesummary.AnswerDetail)paramWendaInfo.answer_detail.get());
      }
      return localrhw;
      label500:
      bool = false;
  ...
  public articlesummary.WendaInfo a()
  {
    ...
    for (int i1 = 1;; i1 = 0)
    {
      ...
      localWendaInfo.answer_detail.set(this.jdField_a_of_type_Rep.a());
  ...
  {
    this.jdField_a_of_type_Rep = rep.a(paramAnswerDetail);
  }
