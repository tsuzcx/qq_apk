...
public abstract class afuz
  implements afty, Handler.Callback, TextWatcher, View.OnClickListener, begg, begh, belq, Observer
{
  static int e;
  ...
  afuc jdField_a_of_type_Afuc;
  private ajjh jdField_a_of_type_Ajjh = new afve(this);
  akcg jdField_a_of_type_Akcg;
  public Context a;
  ...
  baim jdField_a_of_type_Baim = new afvb(this);
  ...
  public afuz(Context paramContext, SessionInfo paramSessionInfo, QQAppInterface paramQQAppInterface)
  {
  ...
  private void A()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130848520);
  ...
  private void B()
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130843949);
      localImageView = (ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131302816);
      localImageView.setBackgroundResource(0);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130848841));
      localImageView = (ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131302286);
      Object localObject = localImageView.getLayoutParams();
      if ((localObject instanceof RelativeLayout.LayoutParams))
      {
        localObject = (RelativeLayout.LayoutParams)localObject;
        ((RelativeLayout.LayoutParams)localObject).width = aciy.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        ((RelativeLayout.LayoutParams)localObject).height = aciy.a(35.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
        localImageView.setLayoutParams((ViewGroup.LayoutParams)localObject);
      }
      localImageView.setBackgroundResource(0);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849303));
      this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131101257));
      this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131101257));
    ...
    this.jdField_b_of_type_AndroidWidgetTextView.setAlpha(0.8F);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setBackgroundResource(2130843948);
    ImageView localImageView = (ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131302816);
    localImageView.setBackgroundResource(0);
    if (awnu.b()) {
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130843886));
    }
    for (;;)
    {
      localImageView = (ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131302286);
      localImageView.setBackgroundResource(0);
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130849304));
      return;
      localImageView.setImageDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130848842));
    }
  }
  ...
  private void C()
  {
    ...
    mfo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, 3);
  }
  ...
  private void F()
  {
    ...
    List localList1 = this.jdField_a_of_type_Aftz.a();
  ...
  private void a(int paramInt)
  {
    ...
    if (this.jdField_c_of_type_AndroidWidgetTextView == null)
    {
      ...
      ((TextView)localObject1).setId(2131304839);
      ((TextView)localObject1).setBackgroundResource(2130838181);
  ...
  {
    return this.jdField_a_of_type_Afuc.a(paramInt);
  }
  ...
  public SpannableString a(boolean paramBoolean)
  {
    ...
    {
      bool1 = true;
      str1 = babh.a(localQQAppInterface, ((SessionInfo)localObject).jdField_a_of_type_Int, ((SessionInfo)localObject).jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo.mSourceMsgSenderUin + "");
    ...
    {
      localObject = azef.a(localQQAppInterface, localContext, str2, str3, str1, bool1, localXEditTextEx, bool2, true);
  ...
  {
    if (paramView == null) {
      paramLayoutInflater = paramLayoutInflater.inflate(2131493203, paramViewGroup, false);
    }
    for (;;)
    {
      this.jdField_a_of_type_AndroidViewViewGroup = ((ViewGroup)paramLayoutInflater.findViewById(2131296648));
      this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131298518));
  ...
  protected void a(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidViewWindowManager$LayoutParams = new WindowManager.LayoutParams(-1, baik.a(0), 2, 32, -1);
    this.jdField_a_of_type_AndroidViewWindowManager$LayoutParams.gravity = 81;
    this.jdField_a_of_type_AndroidViewWindowManager$LayoutParams.windowAnimations = 2131689644;
    this.jdField_a_of_type_Baik = new baik(((ViewGroup)((Activity)this.jdField_a_of_type_AndroidContentContext).getWindow().getDecorView().findViewById(16908290)).getChildAt(0), this.jdField_a_of_type_AndroidViewWindowManager.getDefaultDisplay().getHeight(), this.jdField_a_of_type_Baim);
    this.jdField_j_of_type_Int = this.jdField_a_of_type_Baik.a();
    this.jdField_j_of_type_Int = baik.a(this.jdField_j_of_type_Int);
    paramContext = new afvc(this);
    AppRuntime localAppRuntime = BaseApplicationImpl.getApplication().getRuntime();
    if ((localAppRuntime instanceof QQAppInterface))
    {
      int k = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131167766);
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel = ((EmoticonMainPanel)View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131493455, null));
      ...
      this.jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonMainPanel.setDispatchKeyEventListener(new afvd(this));
      return;
    }
  ...
  public void a(ChatMessage paramChatMessage, int paramInt, long paramLong, String paramString)
  {
    ...
    do
    {
      return;
      if (paramLong == 0L) {
        adni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, Long.parseLong(paramChatMessage.senderuin));
      }
      paramString = aekk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage, paramInt, paramLong, paramString);
    ...
    paramString = azei.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqDataMessageForReplyText$SourceMsgInfo, paramInt - k, this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getPaint(), null);
    if (paramString != null)
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setTag(2131307025, paramString);
      ...
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setMovementMethod(azeh.a());
  ...
  protected void a(List<ChatMessage> paramList1, List<ChatMessage> paramList2)
  {
    ...
    this.jdField_a_of_type_Aftz.a(paramList2, null, 0);
    ...
    if (paramBoolean)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.getOverScrollHeaderView() == null)
      {
        if (this.jdField_a_of_type_AndroidViewView == null) {
          this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131493267, null);
        }
  ...
  public boolean a()
  {
    ...
    this.jdField_a_of_type_Afuc = new afuc(this);
    this.jdField_a_of_type_Afuc.a(2);
    b();
    e();
    g();
    d();
    ...
    x();
    a();
    this.jdField_a_of_type_Akcg = new akcg();
    this.jdField_a_of_type_Akcg.a = new ackd(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    this.jdField_a_of_type_Akcg.jdField_h_of_type_Boolean = true;
    return true;
  }
  ...
  protected void b(List<ChatMessage> paramList1, List<ChatMessage> paramList2)
  {
    ...
    default: 
      if (localafvn != null) {
        this.jdField_g_of_type_Int = localafvn.a(paramList1, paramList2, this.jdField_g_of_type_Int);
      }
      break;
    }
    for (;;)
    {
      ...
      return;
      k = afvn.b(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, this.jdField_g_of_type_Int, paramList1, paramList2);
      if (k != 0)
      {
      ...
      if (localafvn != null)
      {
        ...
        if (localafvn != null)
        {
          this.jdField_g_of_type_Int = localafvn.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, this.jdField_g_of_type_Int, paramList1, paramList2);
          continue;
          if (localafvn != null)
          {
            localafvn.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView, 0, paramList1, paramList2);
            k = paramList1.size();
  ...
  public void beforeTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    if (paramInt3 == 0)
    {
      paramCharSequence = (azef[])this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getEditableText().getSpans(paramInt1, paramInt1 + paramInt2, azef.class);
  ...
  protected void c()
  {
    if (jdField_e_of_type_Int == 0) {
      jdField_e_of_type_Int = this.jdField_a_of_type_AndroidContentContext.getResources().getInteger(2131361806);
    }
  }
  ...
  protected void d()
  {
    ...
    {
      if (("1103".equals(ThemeUtil.curThemeId)) || ("2920".equals(ThemeUtil.curThemeId))) {
        this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130848738);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_AndroidViewViewGroup.setBackgroundResource(2130848928);
  }
  ...
  protected void e()
  {
    this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView = ((ChatXListView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131303604));
    ...
    Object localObject = new View(this.jdField_a_of_type_AndroidContentContext);
    int k = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131167766);
    ((View)localObject).setLayoutParams(new AbsListView.LayoutParams(-1, k));
    ((View)localObject).setId(2131296774);
    ...
    this.jdField_a_of_type_Aftz.a(this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
    localObject = this.jdField_a_of_type_Aftz;
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 3) {}
    for (boolean bool = true;; bool = false)
    {
      ((aftz)localObject).a(bool);
  ...
  protected void g()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131309578));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131311534));
    this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_c_of_type_JavaLangString);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131302804));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setOnClickListener(this);
    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
    this.jdField_d_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131309585));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131311618));
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
    ImageView localImageView1 = (ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131302816);
    localImageView1.setOnClickListener(this);
    if ((this.jdField_e_of_type_Boolean) && (!this.jdField_d_of_type_Boolean))
    {
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_d_of_type_AndroidWidgetRelativeLayout.findViewById(2131302811));
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 2) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_f_of_type_Int == 5))
    {
      ImageView localImageView2 = (ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131302286);
      Object localObject = localImageView2.getLayoutParams();
      if ((localObject instanceof RelativeLayout.LayoutParams))
      {
        localObject = (RelativeLayout.LayoutParams)localObject;
        ((RelativeLayout.LayoutParams)localObject).width = aciy.a(13.5F, this.jdField_a_of_type_AndroidContentContext.getResources());
        ((RelativeLayout.LayoutParams)localObject).height = aciy.a(13.5F, this.jdField_a_of_type_AndroidContentContext.getResources());
        localImageView2.setLayoutParams((ViewGroup.LayoutParams)localObject);
      }
      localImageView2.setImageResource(2130848806);
      this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
      localImageView1.setImageResource(2130848923);
      if (Build.VERSION.SDK_INT >= 16) {
  ...
  protected void h()
  {
    this.jdField_b_of_type_AndroidViewViewGroup = ((ViewGroup)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131302567));
    this.jdField_a_of_type_ComTencentWidgetXPanelContainer = ((XPanelContainer)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131309736));
    i();
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx = ((XEditTextEx)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131302566));
    ...
    try
    {
      ...
      this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131301272));
      this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
      Object localObject = (PanelIconLinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131305547);
      ((PanelIconLinearLayout)localObject).setPanelIconListener(new afva(this));
      if (this.jdField_d_of_type_Boolean)
      {
        ((PanelIconLinearLayout)localObject).setCustomHeight(aciy.a(50.0F, ((PanelIconLinearLayout)localObject).getContext().getResources()));
        ...
        {
          this.jdField_b_of_type_AndroidViewViewGroup.setBackgroundResource(2130848527);
          this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setBackgroundResource(2130848528);
          this.jdField_a_of_type_AndroidWidgetButton.setBackgroundResource(2130838091);
          this.jdField_a_of_type_AndroidWidgetButton.setTextColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131101246));
        }
        localObject = new afvf(this, null);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      a(paramMessage.arg1);
      continue;
      adra.a(paramMessage, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
      continue;
      boolean bool = bajo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
      if (QLog.isColorLevel()) {
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, "MSG_EFRESH_FONT_BUBBLE, needRefresh=" + bool);
      }
      if (bool) {
        this.jdField_a_of_type_Aftz.notifyDataSetChanged();
      }
    }
  }
  ...
  public void k()
  {
    ...
    this.jdField_a_of_type_Afuc.a(4);
    ...
    for (;;)
    {
      ...
      com.etrump.mixlayout.ETTextView.jdField_f_of_type_Boolean = true;
  ...
  public void l()
  {
    if (this.jdField_d_of_type_Boolean)
    {
      ...
      if ((localakaq != null) && (localakaq.a(this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Int) > 0))
      {
        if (QLog.isColorLevel()) {
  ...
  public void m()
  {
    ...
    this.jdField_a_of_type_Afuc.a(8);
  ...
  public void n()
  {
    this.jdField_a_of_type_Afuc.a(3);
  }
  ...
  public void o()
  {
    ...
    this.jdField_a_of_type_Afuc.a(9);
  }
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131302816: 
      ...
      Intent localIntent = aciy.a(new Intent(paramView.getContext(), SplashActivity.class), new int[] { 0, 2 });
      ...
      if ((BaseApplicationImpl.getApplication().getRuntime() instanceof QQAppInterface)) {
        ((aful)((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()).a(147)).a();
      }
    ...
    case 2131301272: 
      ...
      awqx.b(null, "dc00898", "", "", "0X800A194", "0X800A194", k, 1, "", "", "", "");
      return;
    case 2131302566: 
      if (QLog.isColorLevel()) {
    ...
    case 2131296722: 
      ...
      return;
    case 2131304839: 
      this.jdField_g_of_type_Int = this.jdField_a_of_type_Aftz.getCount();
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      AbstractGifImage.pauseAll();
      ApngImage.pauseByTag(0);
      com.etrump.mixlayout.ETTextView.jdField_f_of_type_Boolean = false;
      AbstractVideoImage.pauseAll();
      QQLiveImage.pauseAll((Activity)this.jdField_a_of_type_AndroidContentContext);
      return;
      this.jdField_a_of_type_Aftz.b();
  ...
  public void p()
  {
    ...
    this.jdField_a_of_type_Afuc.a(11);
  ...
  {
    this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a();
    this.jdField_a_of_type_Afuc.a(10);
  ...
  protected void u()
  {
    ...
    if ((localList != null) && (localList.size() > 0))
    {
      ...
      this.jdField_a_of_type_Aftz.a(localList, null, 0);
    }
  }
  ...
  protected void v()
  {
    if ((this.jdField_a_of_type_Aftz != null) && (this.jdField_a_of_type_Aftz.getCount() > 0))
    {
      this.jdField_a_of_type_Long = SystemClock.uptimeMillis();
      ((ackd)this.jdField_a_of_type_Akcg.a).a(this.jdField_a_of_type_Long);
      this.jdField_a_of_type_Akcg.jdField_e_of_type_Boolean = false;
  ...
  protected void w()
  {
    this.jdField_a_of_type_AndroidWidgetImageButton = ((ImageButton)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131296722));
    this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(0);
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(this);
    aciy.a(this.jdField_a_of_type_AndroidWidgetImageButton, (int)(this.jdField_a_of_type_Float * 5.0F + 0.5F), (int)(this.jdField_a_of_type_Float * 5.0F + 0.5F), 0, 0);
    if (this.jdField_d_of_type_Boolean) {
  ...
  public void x()
  {
    ...
    if ((k != 1033) && (k != 1034))
    {
      ...
      awqe.a(1, 0, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, k);
    }
  ...
  public void z()
  {
    ...
    if (localChatMessage != null) {
      a(localChatMessage, 0, adni.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, Long.parseLong(localChatMessage.senderuin)), null);
    }
  }
}
