  ...
  extends bjbw
{
  ...
  private bjhm jdField_a_of_type_Bjhm = new bjhg(this);
  ...
  public bjhf(@NonNull String paramString, @NonNull List<String> paramList, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    super(null);
  ...
  public int a(Activity paramActivity, int paramInt)
  {
    ...
    do
    {
      do
      {
        ...
        localDoodleLayout = bjji.a().a(paramInt);
      } while ((localDoodleLayout == null) || (localDoodleLayout.a() == null));
      localDoodleLayout.a().b(4);
      localDynamicTextItem = new bjhi().a(Integer.valueOf(this.jdField_a_of_type_JavaLangString).intValue(), this.jdField_a_of_type_JavaUtilList);
    } while (localDynamicTextItem == null);
    float f = blcq.a * this.c / localDynamicTextItem.a();
    bkbc localbkbc = new bkbc(this.jdField_a_of_type_Float * blcq.a, this.b * blcq.a, f, 0.0F, 0.0F, 0.0F, localDynamicTextItem.a(), localDynamicTextItem.b());
    if (localDoodleLayout.a().a(localbkbc, this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataSegmentKeeper, localDoodleLayout.d()) != null)
    {
    ...
    bcql.a(paramActivity, paramActivity.getString(2131698326), 0).a();
  ...
  public int b()
  {
    ...
    this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextConfigManager.a(this.jdField_a_of_type_DovComQqImCaptureTextDynamicTextConfigManager$DynamicTextConfigBean, this.jdField_a_of_type_Bjhm);
