  ...
  extends ayoi
{
  ...
  public ayql(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  /* Error */
  private Object b(DownloadParams paramDownloadParams, ayqm paramayqm)
  {
    // Byte code:
    //   0: iconst_1
    //   1: istore_3
    ...
    //   6: astore 7
    //   8: aload_2
    //   9: getfield 148	ayqm:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   12: astore 10
    //   14: aload 10
    //   16: ifnonnull +8 -> 24
    //   19: aload 7
    ...
    //   40: ifeq +63 -> 103
    //   43: aload_2
    //   44: getfield 162	ayqm:jdField_a_of_type_Boolean	Z
    //   47: ifeq +56 -> 103
    //   50: aload 7
    //   52: astore_2
    ...
    //   110: astore 12
    //   112: aload 12
    //   114: getstatic 197	aywm:a	Landroid/graphics/Bitmap$Config;
    ...
    //   306: aload_0
    //   307: aload 9
    //   309: invokevirtual 264	ayql:a	([B)I
    //   312: istore 4
    //   314: iconst_4
    //   315: newarray byte
    //   317: astore 9
    ...
    //   326: aload_0
    //   327: aload 9
    //   329: invokevirtual 264	ayql:a	([B)I
    ...
    //   365: invokestatic 283	ayql:a	(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    //   368: astore 9
    //   370: aload 9
    //   372: astore_1
    //   373: aload_2
    ...
    //   448: invokestatic 294	ayoj:b	(Landroid/graphics/BitmapFactory$Options;II)I
  ...
  public ayqm a(URL paramURL)
  {
    boolean bool2 = true;
    try
    {
      paramURL = paramURL.getFile().split("\\|");
      ayqm localayqm = new ayqm(this);
      localayqm.jdField_a_of_type_JavaLangString = paramURL[0];
      localayqm.jdField_a_of_type_Int = Integer.parseInt(paramURL[1]);
      localayqm.jdField_b_of_type_Int = Integer.parseInt(paramURL[2]);
      localayqm.jdField_a_of_type_Long = Long.parseLong(paramURL[3]);
      if (paramURL.length > 4)
      {
        if (Integer.parseInt(paramURL[4]) == 1)
        {
          bool1 = true;
          localayqm.jdField_a_of_type_Boolean = bool1;
        }
      }
      else
      {
        if (paramURL.length > 5)
        {
          ...
          bool1 = true;
          label106:
          localayqm.jdField_b_of_type_Boolean = bool1;
        }
  ...
  public Object a(DownloadParams paramDownloadParams, ayqm paramayqm)
  {
    paramDownloadParams = paramayqm.jdField_a_of_type_JavaLangString;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramDownloadParams.inPreferredConfig = aywm.b;
        ...
        paramayqm = SafeBitmapFactory.decodeFile(localFile.getAbsolutePath(), paramDownloadParams);
        paramDownloadParams = paramayqm;
        if (paramayqm == null) {
          continue;
        }
        paramDownloadParams = a(paramayqm);
        if (!paramayqm.equals(paramDownloadParams.mBitmap)) {
          paramayqm.recycle();
        }
        paramayqm = new RoundRectBitmap(new ayxa(localFile.getAbsolutePath()).a(paramDownloadParams.mBitmap), paramDownloadParams.mCornerRadius, paramDownloadParams.mBoardColor, paramDownloadParams.mBorderWidth);
        paramDownloadParams = paramayqm;
        if (this.a == null) {
          continue;
        }
        paramayqm.mDisplayWidth = this.a.getResources().getDisplayMetrics().widthPixels;
        paramayqm.mDisplayHeight = this.a.getResources().getDisplayMetrics().heightPixels;
        return paramayqm;
      }
  ...
  {
    paramFile = aglb.a(BaseApplicationImpl.getContext());
    ...
    do
    {
      ...
      {
        return paramFile;
        if (apug.a(paramURLDrawableHandler.jdField_a_of_type_JavaLangString) == 2) {}
        for (i = 1;; i = 0)
        {
      ...
      return apug.a(this.a, paramDownloadParams, 16);
      if (paramURLDrawableHandler.c)
      {
        paramFile = apty.a(this.a, paramURLDrawableHandler.jdField_a_of_type_JavaLangString);
        if (paramFile != null) {
      ...
      for (;;)
      {
        ...
        if (paramFile == null)
        {
          ...
          i = apug.a(paramURLDrawableHandler.jdField_a_of_type_JavaLangString);
          paramDownloadParams = a(paramFile.getResources().getDrawable(apug.a(i)));
        }
        if (paramDownloadParams != null) {
          break;
        }
        return null;
        paramFile = a(BaseApplicationImpl.getContext().getResources().getDrawable(2130843444));
        continue;
        paramFile = paramFile.a(paramDownloadParams.url, new ayqn(this));
      }
      paramFile = paramDownloadParams;
    } while (!paramURLDrawableHandler.jdField_b_of_type_Boolean);
    return apug.a(this.a, paramDownloadParams, 16);
