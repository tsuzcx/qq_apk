  ...
  implements Manager
{
  ...
  private ArrayList<bafb> jdField_a_of_type_JavaUtilArrayList;
  ...
  private ArrayList<axaq> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    axam localaxam = (axam)paramQQAppInterface.getManager(62);
    if (localaxam != null) {}
    for (int i = localaxam.a(paramQQAppInterface.c() + "_all_third_last_msg_time");; i = 0)
    {
      if (QLog.isColorLevel()) {
  ...
  public static int a(QQAppInterface paramQQAppInterface, akaq paramakaq)
  {
    int i;
    if ((paramQQAppInterface == null) || (!paramQQAppInterface.isRunning()) || (paramakaq == null))
    {
      i = 0;
      return i;
    }
    ...
    if (localaxat != null)
    {
      Iterator localIterator = localaxat.b().iterator();
      i = 0;
      j = i;
      ...
      if ((localObject == null) || (TextUtils.isEmpty(((SubAccountInfo)localObject).subuin)) || (localaxat.a(((SubAccountInfo)localObject).subuin) != 1)) {
        break label238;
      }
    }
    label179:
    label191:
    label238:
    for (int j = paramakaq.a(((SubAccountInfo)localObject).subuin, 7000);; j = 0)
    {
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      j = localaxam.a(paramQQAppInterface.c() + "_" + paramString + "_msgNum");
      i = j;
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2)
  {
    ...
    paramQQAppInterface = (axam)paramQQAppInterface.getManager(62);
  ...
  private int a(String paramString)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        i = ((Integer)((axaq)localObject).jdField_a_of_type_JavaLangObject).intValue();
        return i;
      }
      ...
      if (localObject != null)
      {
        ...
        if (this.jdField_c_of_type_JavaUtilArrayList != null) {
          this.jdField_c_of_type_JavaUtilArrayList.add(new axaq(paramString, Integer.valueOf(i)));
        }
        return i;
      }
      return 0;
  ...
  private axaq a(String paramString)
  {
    if (this.jdField_c_of_type_JavaUtilArrayList != null) {
      try
      {
        ...
        while (i < j)
        {
          ...
          for (axaq localaxaq = (axaq)this.jdField_c_of_type_JavaUtilArrayList.get(i); localaxaq != null; localaxaq = null)
          {
            boolean bool = TextUtils.equals(localaxaq.jdField_a_of_type_JavaLangString, paramString);
            if (!bool) {
              break;
            }
            return localaxaq;
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2)
  {
    ...
    for (;;)
    {
      paramQQAppInterface = babh.b(paramQQAppInterface, paramString2, true);
      ...
      return paramString1;
      paramString1 = localBaseApplication.getString(2131624123);
      continue;
      paramString1 = localBaseApplication.getString(2131624003);
      continue;
      paramString1 = localBaseApplication.getString(2131624002);
      continue;
      paramString1 = localBaseApplication.getString(2131652854);
      continue;
      paramString1 = localBaseApplication.getString(2131624162);
    }
  ...
  private String a(String paramString)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        paramString = (String)((axaq)localObject).jdField_a_of_type_JavaLangObject;
        return paramString;
      }
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getSharedPreferences("qq_subaccount_associated_cache", 0);
      if (localObject != null)
      {
        ...
        if (this.jdField_c_of_type_JavaUtilArrayList != null) {
          this.jdField_c_of_type_JavaUtilArrayList.add(new axaq(paramString, localObject));
        }
        return localObject;
      }
      return "";
  ...
  public static ArrayList<String> a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localaxam != null)
    {
      ...
      localaxam.jdField_b_of_type_JavaUtilConcurrentLocksLock.lock();
    }
    for (;;)
    {
      try
      {
        axaq localaxaq = localaxam.a(paramString);
        if (localaxaq != null)
        {
          localArrayList.addAll((ArrayList)localaxaq.jdField_a_of_type_JavaLangObject);
          localaxam.jdField_b_of_type_JavaUtilConcurrentLocksLock.unlock();
          if (QLog.isColorLevel()) {
        ...
        {
          localaxam.jdField_c_of_type_JavaUtilArrayList.add(new axaq(paramString, localArrayList));
          continue;
        }
        i += 1;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject2 = (axat)paramQQAppInterface.getManager(61);
      } while (localObject2 == null);
      long l1 = babl.a().a(paramQQAppInterface.getApp());
      long l2 = amom.a(paramQQAppInterface.getApp());
      if (QLog.isColorLevel()) {
      ...
      if (l1 < l2)
      {
        if (l1 == 0L)
        {
          ...
          bool = babl.a().a(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
          localObject1 = ((axat)localObject2).a("sub.uin.default");
          if ((localObject1 != null) && (((SubAccountInfo)localObject1).subuin != null))
          {
            ((axat)localObject2).g(((SubAccountInfo)localObject1).subuin);
            i = ((axat)localObject2).c(((SubAccountInfo)localObject1).subuin) - paramQQAppInterface.a().a(((SubAccountInfo)localObject1).subuin, 7000);
            if (i != 0)
            {
              paramQQAppInterface.a().c(((SubAccountInfo)localObject1).subuin, 7000, i);
              paramQQAppInterface.a().a(new String[] { ajed.x, ((SubAccountInfo)localObject1).subuin });
            }
            if (bool)
            {
              if (QLog.isColorLevel()) {
          ...
          babl.a().a(paramQQAppInterface.getApp());
        }
      }
      else
      {
        if (!babl.a().b(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount()))
        {
          if (QLog.isColorLevel()) {
            QLog.d("SUB_ACCOUNT", 2, "initAllData() showedBefore:false, isFirstTime to user SubAccount.");
          }
          babl.a().a(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount(), true);
          a(paramQQAppInterface, 7);
        }
        localObject1 = paramQQAppInterface.a().a();
        localObject3 = ((akeu)localObject1).b(ajed.x, 7000);
        if (((axat)localObject2).a() <= 0) {
          break label788;
        }
        if (QLog.isColorLevel()) {
          QLog.d("SUB_ACCOUNT", 2, "initAllData() getBindedNumber > 0, go to initAllData");
        }
        localObject4 = ((axat)localObject2).b();
      ...
      for (;;)
      {
        ...
        if ((localObject3 != null) && (l1 == 0L))
        {
          ...
          if (localObject2 != null) {
            j = ((axat)localObject2).c(localSubAccountInfo.subuin);
          }
          int n = j - m;
          if (QLog.isColorLevel()) {
          ...
          if (n != 0)
          {
            ...
            paramQQAppInterface.a().a(new String[] { ajed.x, localSubAccountInfo.subuin });
          }
        }
        bool = false;
        ...
        if (bool) {
          paramQQAppInterface.getSubAccountKey(paramQQAppInterface.getAccount(), localSubAccountInfo.subuin, new axan(paramQQAppInterface));
        }
      }
      if (QLog.isColorLevel()) {
        QLog.d("SUB_ACCOUNT", 2, "initAllData() delete subaccount recentuser, add default subaccount box");
      }
      Object localObject2 = ((axat)localObject2).b();
      int j = ((ArrayList)localObject2).size();
      int i = 0;
      if (i < j)
      {
        localObject3 = (SubAccountInfo)((ArrayList)localObject2).get(i);
        if ((localObject3 == null) || (ajed.x.equals(((SubAccountInfo)localObject3).subuin))) {}
        for (;;)
        {
          i += 1;
          break;
          localObject3 = ((akeu)localObject1).b(((SubAccountInfo)localObject3).subuin, 7000);
          if (localObject3 != null) {
            ((akeu)localObject1).b((RecentUser)localObject3);
          }
        }
      }
      localObject2 = ((akeu)localObject1).b(ajed.x, 7000);
      ...
      {
        a(paramQQAppInterface, (akeu)localObject1, ajed.x, 7);
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte paramByte, ArrayList<String> paramArrayList)
  {
    ...
    for (paramArrayList = (String)localIterator.next();; paramArrayList = null)
    {
      try
      {
        ...
        Object localObject2 = (axat)paramQQAppInterface.getManager(61);
        if (localObject2 == null) {
          continue;
        }
        paramArrayList = ((axat)localObject2).a(paramArrayList);
        if (paramArrayList == null)
        {
      ...
      catch (Exception localException)
      {
        for (;;)
        {
          ...
          long l1 = 0L;
          continue;
          paramArrayList = bach.a(paramArrayList);
          continue;
          label377:
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (localObject != null)
    {
      ...
      for (;;)
      {
        ...
        if ((localRecentUser != null) && (localRecentUser.getType() == 7000) && (!ajed.x.equals(localRecentUser.uin)))
        {
          if (QLog.isColorLevel()) {
    ...
    a(paramQQAppInterface, localakeu, ajed.x, i);
  }
  
  private static void a(QQAppInterface paramQQAppInterface, akeu paramakeu, String paramString, int paramInt)
  {
    int i = 1;
    if (QLog.isColorLevel()) {
    ...
    if ((paramString == null) || (paramString.length() == 0) || (paramInt == 0)) {
      if (QLog.isColorLevel())
      {
        paramakeu = new StringBuilder().append("updateRecentUser() return,");
        if (paramString != null) {
          break label103;
        }
    ...
    do
    {
      ...
      {
        localRecentUser = paramakeu.b(paramString, 7000);
        if (localRecentUser != null) {
          paramakeu.b(localRecentUser);
        }
      }
      localRecentUser = paramakeu.b(ajed.x, 7000);
      if (localRecentUser != null) {
        break label693;
      }
    ...
    for (;;)
    {
      localRecentUser.uin = ajed.x;
      Object localObject;
      long l1;
      long l2;
      if (ajed.x.equals(paramString))
      {
        paramString = (axat)paramQQAppInterface.getManager(61);
      ...
      for (;;)
      {
        ...
        while (paramInt != 0)
        {
          ...
          paramInt = 1;
          continue;
          paramQQAppInterface = (axat)paramQQAppInterface.getManager(61);
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, RecentItemSubAccount paramRecentItemSubAccount, MsgSummary paramMsgSummary)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject5 = (axat)paramQQAppInterface.getManager(61);
      ...
      return;
      localArrayList = ((axat)localObject5).b();
      ...
      paramMsgSummary.strContent = paramContext.getString(2131653996);
    } while (!QLog.isColorLevel());
    ...
    int j = a(paramQQAppInterface, localakaq);
    label281:
    Object localObject3;
    if ((i < l) || (j > 0))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if ((localObject3 != null) && (!TextUtils.isEmpty(((SubAccountInfo)localObject3).subuin)) && (((axat)localObject5).a(((SubAccountInfo)localObject3).subuin) == 1))
        {
          List localList = ((axat)localObject5).a(((SubAccountInfo)localObject3).subuin);
    ...
    for (;;)
    {
      ...
      if ((localObject1 != null) && (localObject2 != null))
      {
        ...
        if (!TextUtils.isEmpty((CharSequence)localObject3))
        {
          ...
          if (((((SubAccountMessage)localObject2).mEmoRecentMsg == null) || (((SubAccountMessage)localObject2).mEmoRecentMsg.length() == 0)) && (((SubAccountMessage)localObject2).msg != null)) {
            ((SubAccountMessage)localObject2).mEmoRecentMsg = new axkd(((SubAccountMessage)localObject2).msg, 3, 16);
          }
          ...
          paramRecentItemSubAccount.mMsgExtroInfo = ("[" + paramContext.getString(2131651682) + "]");
      ...
      if ((j > 0) && (localakaq != null))
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          ...
          {
            i = localakaq.a(((SubAccountInfo)localObject2).subuin, 7000);
            if (i > 0)
            {
      ...
      localObject2 = ((axat)localObject5).a();
      ...
      for (;;)
      {
        ...
        if (i > 0)
        {
          paramMsgSummary.strContent = paramContext.getString(2131653941, new Object[] { String.valueOf(i) });
          if (QLog.isColorLevel()) {
        ...
        paramMsgSummary.strContent = paramContext.getString(2131653935);
        return;
        k = i;
        i = j;
        j = k;
  ...
  public static void a(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity)
  {
    ...
    localObject1 = paramBaseActivity.getString(2131654001);
    Object localObject2 = paramBaseActivity.getString(2131653963, new Object[] { Integer.valueOf(2) });
    localObject1 = babr.a(paramBaseActivity, 230).setTitle((String)localObject1).setMessage((CharSequence)localObject2);
    ((bafb)localObject1).setOwnerActivity(paramBaseActivity);
    ((bafb)localObject1).setPositiveButton(paramBaseActivity.getString(2131653983), new axap(paramQQAppInterface, paramBaseActivity));
      ...
      if (paramString != null)
      {
        ...
        while (paramString.hasNext())
        {
          ...
          if (!"sub.uin.all".equals(localObject))
          {
            ...
            if (paramQQAppInterface != null)
            {
              localObject = (axat)paramQQAppInterface.getManager(61);
              if (localObject != null)
              {
                ((axat)localObject).a(paramString);
                ((axat)localObject).c(paramString);
                if (babh.c(paramQQAppInterface, paramString, false) != null) {
                  break;
                }
              }
            }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    if ((!ajed.x.equals(paramString)) && ((paramString == null) || (paramString.length() < 5))) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      return;
      akeu localakeu = paramQQAppInterface.a().a();
      if ((localakeu.b(ajed.x, 7000) != null) && (QLog.isColorLevel())) {
        QLog.d("SUB_ACCOUNT", 2, "bindRecentItem() bind, delete defaultRU");
      }
      a(paramQQAppInterface, localakeu, paramString, paramInt);
    } while (!QLog.isColorLevel());
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, ArrayList<String> paramArrayList, int paramInt1, int paramInt2)
  {
    ...
    {
      return;
      localaxam = (axam)paramQQAppInterface.getManager(62);
    } while (localaxam == null);
    ...
    for (;;)
    {
      try
      {
        paramString2 = localaxam.a(paramString1);
        ...
        if (paramString2 != null) {
          ...
          localaxam.jdField_c_of_type_JavaUtilArrayList.add(new axaq(paramString1, localArrayList));
        }
      }
      finally
      {
    ...
    localaxam.a(paramString1 + "_sysTime", Integer.valueOf(paramInt1));
    localaxam.jdField_a_of_type_Long = paramInt2;
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    do
    {
      do
      {
        ...
        paramString1 = (axam)paramQQAppInterface.getManager(62);
      } while (paramString1 == null);
      paramQQAppInterface = paramQQAppInterface.c() + "_" + paramString2;
      paramString2 = bakz.a(paramArrayOfByte);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    if (ajed.x.equals(paramString)) {
      if (paramBoolean) {
        a(paramQQAppInterface, paramQQAppInterface.a().a(), ajed.x, 7);
      }
    }
    for (;;)
    {
      ...
      paramQQAppInterface.sendEmptyMessage(1009);
      return;
      ((axat)paramQQAppInterface.getManager(61)).a(paramString, paramBoolean);
      akeu localakeu = paramQQAppInterface.a().a();
      if (paramBoolean) {
        a(paramQQAppInterface, localakeu, paramString, 4);
      } else {
        a(paramQQAppInterface, localakeu, paramString, 5);
      }
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if ((((akeu)localObject).b(ajed.x, 7000) != null) && (QLog.isColorLevel())) {
        QLog.d("SUB_ACCOUNT", 2, "bindRecentItem() bind, delete defaultRU");
      }
      ...
      while (paramArrayList.hasNext())
      {
        ...
        a(paramQQAppInterface, (akeu)localObject, str, paramInt);
        if (QLog.isColorLevel()) {
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    localaxam.a(paramQQAppInterface.c() + "_display_third_qq_checked", String.valueOf(paramBoolean));
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if ((localaxat != null) && (paramQQAppInterface != null))
      {
        Iterator localIterator = localaxat.a().iterator();
        while (localIterator.hasNext())
        {
          String str = (String)localIterator.next();
          if (!TextUtils.isEmpty(str))
          {
            int i = localaxat.c(str);
            localaxat.b(str);
            if ((paramBoolean) || (i > 0))
            {
              if (QLog.isColorLevel()) {
              ...
              akch localakch = paramQQAppInterface.a();
              if (localakch != null) {
                localakch.a(str, paramString);
              }
            }
          }
        }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    axam localaxam = (axam)paramQQAppInterface.getManager(62);
    if (localaxam != null) {
      return localaxam.a(paramQQAppInterface.c() + "_all_third_last_msg_time", Integer.valueOf(paramInt));
    }
    return false;
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (paramQQAppInterface != null)
    {
      ...
      localObject = ((axat)localObject).a();
      label45:
      paramQQAppInterface = (axam)paramQQAppInterface.getManager(62);
      bool1 = bool2;
      if (paramQQAppInterface != null) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    label381:
    for (Object localObject = ((axat)localObject).a(paramString);; localObject = null)
    {
      axar localaxar = (axar)paramQQAppInterface.getManager(28);
      if (localaxar != null)
      {
        paramBoolean = localaxar.a();
        if (!paramBoolean)
        {
          localObject = new axau();
          ((axau)localObject).jdField_a_of_type_JavaLangString = "";
          ((axau)localObject).b = paramQQAppInterface.getAccount();
          ((axau)localObject).c = paramString;
          ((axau)localObject).jdField_a_of_type_Int = 1009;
      ...
      if ((paramString == null) || (paramString.length() == 0) || (localObject == null) || (((String)localObject).length() == 0) || (((String)localObject).trim().equals("")))
      {
        ...
        ((axau)localObject).b = paramQQAppInterface.getAccount();
        ((axau)localObject).c = paramString;
        ((axau)localObject).jdField_a_of_type_Int = 1010;
        paramQQAppInterface.a().notifyUI(8003, false, localObject);
        return false;
      }
      if (QLog.isColorLevel()) {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    if (localaxam != null)
    {
      if (!localaxam.jdField_b_of_type_Boolean) {
        return false;
      }
      if (BaseActivity.mAppForground)
      {
        bool = localaxam.d(paramQQAppInterface, paramBoolean);
        paramBoolean = bool;
        if (bool) {
          localaxam.d(paramQQAppInterface);
        }
      }
      for (paramBoolean = bool;; paramBoolean = bool)
      {
        if ((!paramBoolean) && (localaxam.jdField_b_of_type_JavaLangRunnable != null)) {
          ThreadManager.getSubThreadHandler().removeCallbacks(localaxam.jdField_b_of_type_JavaLangRunnable);
        }
        return paramBoolean;
        localaxam.jdField_a_of_type_Boolean = true;
      }
    }
    return false;
  }
  ...
  private boolean a(String paramString, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject == null)
        {
          this.jdField_c_of_type_JavaUtilArrayList.add(new axaq(paramString, paramObject));
          bool1 = true;
          this.jdField_b_of_type_JavaUtilConcurrentLocksLock.unlock();
          bool2 = bool1;
          if (!bool1) {
        ...
        if (((paramObject instanceof Integer)) && ((((axaq)localObject).jdField_a_of_type_JavaLangObject instanceof Integer)))
        {
          if ((Integer)((axaq)localObject).jdField_a_of_type_JavaLangObject == (Integer)paramObject) {
            break label346;
          }
          bool2 = true;
          bool1 = bool2;
          ...
          ((axaq)localObject).jdField_a_of_type_JavaLangObject = paramObject;
          bool1 = bool2;
          continue;
        }
      ...
      if ((((axaq)localObject).jdField_a_of_type_JavaLangObject instanceof String))
      {
        bool1 = TextUtils.equals((String)((axaq)localObject).jdField_a_of_type_JavaLangObject, (String)paramObject);
        if (!bool1)
        {
          bool2 = true;
          continue;
  ...
  public static byte[] a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (localaxam != null)
    {
      paramQQAppInterface = localaxam.a(paramQQAppInterface.c() + "_" + paramString + "_cookie");
      if (!TextUtils.isEmpty(paramQQAppInterface)) {
        return bakz.a(paramQQAppInterface);
      }
    }
    return null;
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    ...
    do
    {
      ...
      paramString = (axam)paramQQAppInterface.getManager(62);
  ...
  public static void b(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
        localObject1 = (axam)paramQQAppInterface.getManager(62);
        if (localObject1 == null) {
          break label110;
        }
        l1 = System.currentTimeMillis();
        l2 = (l1 - ((axam)localObject1).jdField_b_of_type_Long) / 1000L;
        if (l2 >= ((axam)localObject1).jdField_a_of_type_Long) {
          break;
        }
      } while (!QLog.isColorLevel());
      QLog.d("SUB_ACCOUNT", 2, "getSubAccountSpecialCareListFromService skip adviseGap=" + ((axam)localObject1).jdField_a_of_type_Long + "  realGap=" + l2);
      return;
      ((axam)localObject1).jdField_b_of_type_Long = l1;
      localObject1 = (axat)paramQQAppInterface.getManager(61);
    } while (localObject1 == null);
    Object localObject2 = new ArrayList();
    if (paramBoolean) {
      ((List)localObject2).addAll(((axat)localObject1).b());
    }
    for (;;)
    {
      ...
      break;
      ((List)localObject2).add(((axat)localObject1).a(paramString));
    }
  }
  ...
  public static void c(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        paramString = localakeu.b(paramString, 7000);
        if (paramString != null)
        {
      ...
      } while (((axat)paramQQAppInterface.getManager(61)).a() != 0);
      a(paramQQAppInterface, localakeu, ajed.x, 7);
    } while (!QLog.isColorLevel());
  ...
  public static boolean c(QQAppInterface paramQQAppInterface)
  {
    ...
    Object localObject1 = (axat)paramQQAppInterface.getManager(61);
    axam localaxam = (axam)paramQQAppInterface.getManager(62);
    if ((localObject1 == null) || (localaxam == null)) {
      return false;
    }
    localObject1 = ((axat)localObject1).a();
    Object localObject2 = new ArrayList();
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      if ((localObject3 != null) && (!TextUtils.isEmpty(((SimpleAccount)localObject3).getUin())) && (!((SimpleAccount)localObject3).getUin().equals(paramQQAppInterface)) && (!((List)localObject1).contains(((SimpleAccount)localObject3).getUin())))
      {
        ...
        String str = localaxam.a((String)localObject3 + "_last_cookie");
        if (!TextUtils.isEmpty(str)) {
          localaxam.a((String)localObject3 + "_cookie", str);
        }
        localaxam.a((String)localObject3 + "_msgNum", Integer.valueOf(0));
        localaxam.a((String)localObject3 + "_msgFlag", Integer.valueOf(0));
        localaxam.a((String)localObject3 + "_redBagTime", Integer.valueOf(0));
      }
    }
    if (QLog.isColorLevel()) {
  ...
  public static boolean d(QQAppInterface paramQQAppInterface)
  {
    ...
    axam localaxam = (axam)paramQQAppInterface.getManager(62);
    return (localaxam == null) || (!TextUtils.equals(localaxam.a(paramQQAppInterface.c() + "_display_third_qq_checked"), String.valueOf(false)));
  }
  ...
  private boolean d(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    Object localObject3 = (axat)paramQQAppInterface.getManager(61);
    if ((((List)localObject2).size() >= 1) && (localObject3 != null))
    {
      localObject1 = new ArrayList();
      String str = paramQQAppInterface.c();
      localObject3 = ((axat)localObject3).a();
      localObject2 = ((List)localObject2).iterator();
      while (((Iterator)localObject2).hasNext())
      {
  ...
  public ArrayList<Pair<String, Integer>> a(String paramString)
  {
    ...
    //   45: areturn
    //   46: aload_0
    //   47: getfield 38	axam:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   50: invokeinterface 256 1 0
    //   55: aload_0
    //   56: getfield 1020	axam:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   59: ifnull +29 -> 88
    //   62: ldc_w 912
    //   65: aload_1
    ...
    //   72: aload_3
    //   73: aload_0
    //   74: getfield 1020	axam:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   77: invokevirtual 432	java/util/ArrayList:addAll	(Ljava/util/Collection;)Z
    //   80: pop
    //   81: aload_0
    //   82: getfield 1020	axam:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   85: invokevirtual 71	java/util/ArrayList:clear	()V
    //   88: aload_0
    //   89: getfield 38	axam:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   92: invokeinterface 271 1 0
    //   97: aload_3
    //   98: areturn
    //   99: aload_0
    //   100: getfield 1020	axam:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   110: iflt -22 -> 88
    //   113: aload_0
    //   114: getfield 1020	axam:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   117: iload_2
    ...
    //   144: pop
    //   145: aload_0
    //   146: getfield 1020	axam:jdField_b_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   149: iload_2
    ...
    //   161: astore_1
    //   162: aload_0
    //   163: getfield 38	axam:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
  ...
  public void a(SubAccountBaseActivity paramSubAccountBaseActivity)
  {
    ...
    while (i >= 0)
    {
      localObject = (bafb)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      if ((localObject == null) || (((bafb)localObject).getOwnerActivity() != paramSubAccountBaseActivity) || (((bafb)localObject).isShowing())) {}
      try
      {
        ((bafb)localObject).dismiss();
        label116:
  ...
  public void a(QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, Pair<String, Integer> paramPair, android.content.DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    //   222: istore 6
    //   224: aload_0
    //   225: getfield 38	axam:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   228: invokeinterface 256 1 0
    //   233: aload_0
    //   234: getfield 1189	axam:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   237: ifnull +141 -> 378
    //   240: aload_0
    //   241: getfield 1189	axam:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   253: iflt +125 -> 378
    //   256: aload_0
    //   257: getfield 1189	axam:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   260: iload 5
    //   262: invokevirtual 296	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   265: checkcast 879	bafb
    //   268: astore 10
    //   270: aload 10
    //   272: ifnull +298 -> 570
    //   275: aload 10
    //   277: invokevirtual 1215	bafb:getTag	()Ljava/lang/Object;
    //   280: instanceof 315
    //   283: ifeq +287 -> 570
    //   286: aload 10
    //   288: invokevirtual 1215	bafb:getTag	()Ljava/lang/Object;
    ...
    //   306: ifeq +264 -> 570
    //   309: aload 10
    //   311: invokevirtual 1196	bafb:isShowing	()Z
    //   314: istore 7
    //   316: iload 7
    //   318: ifeq +8 -> 326
    //   321: aload 10
    //   323: invokevirtual 1199	bafb:dismiss	()V
    //   326: aload_0
    //   327: getfield 1189	axam:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   330: iload 5
    ...
    //   388: aload 8
    //   390: iconst_0
    //   391: invokestatic 922	babh:c	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Z)Ljava/lang/String;
    //   394: astore 9
    //   396: aload 9
    //   398: ifnull +181 -> 579
    //   401: aload 9
    ...
    //   436: aload_2
    //   437: sipush 230
    //   440: invokestatic 877	babr:a	(Landroid/content/Context;I)Lbafb;
    //   443: aload 10
    //   445: invokevirtual 883	bafb:setTitle	(Ljava/lang/String;)Lbafb;
    //   448: aload_1
    //   449: invokevirtual 887	bafb:setMessage	(Ljava/lang/CharSequence;)Lbafb;
    //   452: astore_1
    //   453: aload_1
    //   454: aload_3
    //   455: invokevirtual 1221	bafb:setTag	(Ljava/lang/Object;)V
    //   458: aload_1
    //   459: aload_2
    //   460: invokevirtual 891	bafb:setOwnerActivity	(Landroid/app/Activity;)V
    //   463: aload_1
    //   464: aload_2
    //   465: ldc_w 892
    //   468: invokevirtual 870	com/tencent/mobileqq/app/BaseActivity:getString	(I)Ljava/lang/String;
    //   471: aload 4
    //   473: invokevirtual 900	bafb:setPositiveButton	(Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Lbafb;
    //   476: pop
    //   477: aload_1
    //   478: new 1223	axao
    //   481: dup
    ...
    //   483: aload 8
    //   485: iload 6
    //   487: invokespecial 1226	axao:<init>	(Laxam;Ljava/lang/String;I)V
    //   490: invokevirtual 1230	bafb:setOnCancelListener	(Landroid/content/DialogInterface$OnCancelListener;)V
    //   493: aload_1
    //   494: invokevirtual 907	bafb:show	()V
    //   497: aload_0
    //   498: getfield 1189	axam:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   501: ifnonnull +14 -> 515
    //   504: aload_0
    //   505: new 54	java/util/ArrayList
    //   508: dup
    //   509: invokespecial 55	java/util/ArrayList:<init>	()V
    //   512: putfield 1189	axam:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   515: aload_0
    //   516: getfield 1189	axam:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   519: aload_1
    //   520: invokevirtual 289	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   523: pop
    //   524: aload_0
    //   525: getfield 38	axam:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    ...
    //   553: astore_1
    //   554: aload_0
    //   555: getfield 38	axam:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
  ...
  public void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    //   54: return
    //   55: aload_0
    //   56: getfield 38	axam:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    //   59: invokeinterface 256 1 0
    //   64: aload_0
    //   65: getfield 1189	axam:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   68: ifnull +253 -> 321
    //   71: aload_0
    //   72: getfield 1189	axam:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   84: iflt +237 -> 321
    //   87: aload_0
    //   88: getfield 1189	axam:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   91: iload 5
    //   93: invokevirtual 296	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   96: checkcast 879	bafb
    //   99: astore 7
    //   101: aload 7
    //   103: ifnull +162 -> 265
    //   106: aload 7
    //   108: invokevirtual 1215	bafb:getTag	()Ljava/lang/Object;
    //   111: astore 8
    //   113: aload 8
    //   115: ifnull +193 -> 308
    //   118: aload 8
    ...
    //   169: ifeq +173 -> 342
    //   172: aload 7
    //   174: invokevirtual 1196	bafb:isShowing	()Z
    //   177: istore 6
    //   179: iload 6
    //   181: ifeq +8 -> 189
    //   184: aload 7
    //   186: invokevirtual 1199	bafb:dismiss	()V
    //   189: aload_0
    //   190: getfield 1189	axam:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   193: iload 5
    ...
    //   262: goto +80 -> 342
    //   265: aload_0
    //   266: getfield 1189	axam:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   269: iload 5
    ...
    //   278: astore_1
    //   279: aload_0
    //   280: getfield 38	axam:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
    ...
    //   305: goto -138 -> 167
    //   308: aload_0
    //   309: getfield 1189	axam:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   312: iload 5
    //   314: invokevirtual 1027	java/util/ArrayList:remove	(I)Ljava/lang/Object;
    //   317: pop
    //   318: goto +24 -> 342
    //   321: aload_0
    //   322: getfield 38	axam:jdField_a_of_type_JavaUtilConcurrentLocksLock	Ljava/util/concurrent/locks/Lock;
  ...
  public void onDestroy()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_JavaUtilArrayList != null)
      {
        ...
        while (localIterator.hasNext())
        {
          bafb localbafb = (bafb)localIterator.next();
          try
          {
