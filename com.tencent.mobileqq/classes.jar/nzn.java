  ...
  extends ajtd
{
  ...
  public nzn(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a()
  {
    ...
    try
    {
      ...
      localReqAdvertisePara.msg_phone_info.set(oai.a());
      localReqBody.req_advertise_para.set(localReqAdvertisePara);
      mxi.a(this.app, new nzo(this), localReqBody.toByteArray(), "OidbSvc.0x6cf", 1743, 0, new Bundle(), 6000L);
      return;
    }
