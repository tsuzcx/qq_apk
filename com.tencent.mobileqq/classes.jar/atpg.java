...
{
  public atpg(MapWidget paramMapWidget, int paramInt, atpl paramatpl) {}
  ...
  public void onFailure(int paramInt, String paramString, Throwable paramThrowable)
  {
    ...
    if (MapWidget.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget) != null) {
      MapWidget.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget).a(false, this.jdField_a_of_type_Atpl);
    }
  }
    ...
    for (;;)
    {
      if (paramObject != null)
      {
        ...
        if (bhxo.a())
        {
          ...
          label124:
          this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.jdField_a_of_type_ComTencentTencentmapMapsdkMapsModelPolyline = this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.jdField_a_of_type_ComTencentTencentmapMapsdkMapsTencentMap.addPolyline(new PolylineOptions().addAll(paramObject).color(paramInt).width(bcwh.a(this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.getContext(), 5.0F)));
          if (this.jdField_a_of_type_ComTencentMobileqqLocationUiMapWidget.jdField_a_of_type_ComTencentTencentmapMapsdkMapsModelPolyline != null)
          {
      ...
      {
        ((atpk)localObject1).a(bool, this.jdField_a_of_type_Atpl);
        return;
        ...
        this.jdField_a_of_type_Atpl.a = paramObject.duration;
        this.jdField_a_of_type_Atpl.b = paramObject.distance;
        ...
        this.jdField_a_of_type_Atpl.a = ((float)((TransitResultObject.Route)localObject1).duration);
        this.jdField_a_of_type_Atpl.b = ((TransitResultObject.Route)localObject1).distance;
