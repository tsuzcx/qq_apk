  ...
  extends Handler
{
  ...
  public bemx(ADView paramADView)
  {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        azum localazum = (azum)this.jdField_a_of_type_ComTencentMobileqqWidgetADView.a.getChildAt(this.jdField_a_of_type_ComTencentMobileqqWidgetADView.a.a()).getTag();
        i = localazum.a;
        this.jdField_a_of_type_ComTencentMobileqqWidgetADView.setContentDescription(localazum.n);
        i *= 1000;
      }
