  ...
  extends BaseAdapter
{
  ...
  private final List<afru> jdField_a_of_type_JavaUtilList;
  private boolean jdField_a_of_type_Boolean;
  
  public aajt(Context paramContext, CompoundButton.OnCheckedChangeListener paramOnCheckedChangeListener)
  {
  ...
  private void b(List<afru> paramList)
  {
    ...
    for (;;)
    {
      ...
      while (i >= 0)
      {
        ...
        if (((localafru == null) || (localafru.jdField_a_of_type_Int == 1) || (localafru.jdField_a_of_type_Int == 2)) && (localafru != null)) {
          paramList.remove(localafru);
        }
        i -= 1;
      }
    }
  ...
  public afru a(short paramShort)
  {
    int i = 0;
    while (i < this.jdField_a_of_type_JavaUtilList.size())
    {
      if (((afru)this.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_Short == paramShort) {
        return (afru)this.jdField_a_of_type_JavaUtilList.get(i);
      }
      i += 1;
    }
    return null;
  ...
  public void a(List<afru> paramList)
  {
    ...
    for (;;)
    {
      try
      {
        if (i < paramArrayOfShort.length)
        {
          ...
          int m = ((afru)this.jdField_a_of_type_JavaUtilList.get(j)).jdField_a_of_type_Short;
          if (k == m)
          {
            bool = true;
            i += 1;
  ...
  public Object getItem(int paramInt)
  {
    if ((paramInt >= 0) && (paramInt < getCount())) {
      return (afru)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    }
    return null;
  }
  ...
  {
    afru localafru = (afru)getItem(paramInt);
    if (localafru == null) {
      return 0L;
    }
    return localafru.jdField_a_of_type_Int;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (!(paramView instanceof FormSwitchItem))
    {
      ...
      paramView = (afru)getItem(paramInt);
      if (paramView != null)
      {
        ...
        paramViewGroup.setSecendLineText(this.jdField_a_of_type_AndroidContentContext.getString(2131699121));
