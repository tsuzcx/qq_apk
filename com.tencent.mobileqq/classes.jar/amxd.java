...
{
  amxd(amxc paramamxc, float paramFloat, int paramInt, String paramString, amxv paramamxv, JSONObject paramJSONObject) {}
  
  public void onLoadComplete(SoundPool paramSoundPool, int paramInt1, int paramInt2)
  {
    float f = 1.0F;
    if (amxc.a(this.jdField_a_of_type_Amxc) != null)
    {
      try
      {
        ...
        paramSoundPool = this.jdField_a_of_type_Amxv;
