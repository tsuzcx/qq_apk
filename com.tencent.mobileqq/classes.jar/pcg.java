...
public class pcg
{
  ...
  private HashMap<String, pch> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  private AppRuntime jdField_a_of_type_MqqAppAppRuntime;
  
  public pcg(AppRuntime paramAppRuntime, TroopMemberApiService paramTroopMemberApiService)
  {
  ...
  public void a()
  {
    ...
    pzi localpzi = (pzi)this.jdField_a_of_type_MqqAppAppRuntime.getManager(261);
    Iterator localIterator = this.jdField_a_of_type_JavaUtilHashMap.entrySet().iterator();
    while (localIterator.hasNext()) {
      localpzi.b((bbwf)((Map.Entry)localIterator.next()).getValue());
    }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    String str = ((pzi)this.jdField_a_of_type_MqqAppAppRuntime.getManager(261)).a();
    if (!pyx.a(str)) {
      str = "";
    }
    for (;;)
    {
      boolean bool = bbjn.u(((AppInterface)this.jdField_a_of_type_MqqAppAppRuntime).getApp().getApplicationContext(), ((AppInterface)this.jdField_a_of_type_MqqAppAppRuntime).getCurrentAccountUin());
  ...
  public void b(Bundle paramBundle)
  {
    ...
    Object localObject1 = (pzi)this.jdField_a_of_type_MqqAppAppRuntime.getManager(261);
    ...
    label208:
    for (localObject1 = ((pzi)localObject1).a(0, "", l1, (String)localObject2, str2, l2, l3, bool);; localObject1 = ((pzi)localObject1).a(1, str1, l1, (String)localObject2, str2, l2, l3, bool))
    {
  ...
  public void c(Bundle paramBundle)
  {
    ...
    {
      return;
      localObject = (pzi)this.jdField_a_of_type_MqqAppAppRuntime.getManager(261);
      ...
      long l2 = paramBundle.getLong("startTime");
      long l3 = paramBundle.getLong("endTime");
      pch localpch = new pch(this.jdField_a_of_type_MqqAppAppRuntime, str1, paramBundle, this.jdField_a_of_type_ComTencentBizTroopTroopMemberApiService);
      this.jdField_a_of_type_JavaUtilHashMap.put(str1, localpch);
      bool = ((pzi)localObject).a(str1, str2, str3, l1, l2, l3, localpch);
      if (QLog.isColorLevel()) {
  ...
  public void d(Bundle paramBundle)
  {
    ...
    Object localObject = (pzi)this.jdField_a_of_type_MqqAppAppRuntime.getManager(261);
    String str = paramBundle.getString("skinId");
    paramBundle.getString("skinUrl");
    boolean bool = ((pzi)localObject).a(str);
