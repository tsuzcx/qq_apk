  ...
  extends ReportDialog
{
  ...
  private bisn jdField_a_of_type_Bisn;
  String jdField_a_of_type_JavaLangString;
  private int jdField_b_of_type_Int = 48;
  private ImageView jdField_b_of_type_AndroidWidgetImageView;
  private int c = -2;
  
  public bisl(Context paramContext)
  {
    this(paramContext, 0);
  }
  
  public bisl(Context paramContext, int paramInt)
  {
    this(paramContext, paramInt, 2131561446, 48);
  }
  
  public bisl(Context paramContext, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131363641));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371603));
    this.jdField_a_of_type_Int = paramInt1;
    this.jdField_b_of_type_Int = paramInt3;
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378996));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131378997));
  ...
  {
    setOnKeyListener(new bism(this, paramBoolean));
  }
  ...
  public void dismiss()
  {
    ...
    //   4: aload_0
    //   5: invokestatic 159	acxo:a	(Landroid/app/Dialog;)V
    //   8: return
    //   9: astore_1
    //   10: aload_0
    //   11: invokestatic 159	acxo:a	(Landroid/app/Dialog;)V
    //   14: return
    //   15: astore_1
    //   16: aload_0
    //   17: invokestatic 159	acxo:a	(Landroid/app/Dialog;)V
    //   20: aload_1
    //   21: athrow
