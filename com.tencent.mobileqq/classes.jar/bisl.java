...
public class bisl
  implements bivy
{
  public bisl(DownloadInterfaceNew paramDownloadInterfaceNew, String paramString) {}
  
  public void a(int paramInt, String paramString)
  {
    bisy.e("DownloadInterfaceNew", "[innerQuery] [onException] errorCode=" + paramInt + ", errorMsg=" + paramString);
  }
  
  public void a(List<DownloadInfo> paramList)
  {
    bisy.c("DownloadInterfaceNew", "[innerQuery] onResult = " + paramList.size());
    ...
    bisy.c("DownloadInterfaceNew", "[innerQuery] querySucess : " + paramList);
