  ...
  extends biwr
{
  ...
  private static final String[] jdField_a_of_type_ArrayOfJavaLangString = { ajya.a(2131689815), ajya.a(2131689816), ajya.a(2131689817) };
  ...
  public bisl(Activity paramActivity, View paramView, biws parambiws)
  {
  ...
  private void a(Runnable paramRunnable)
  {
    ...
    localAnimationSet.setAnimationListener(new bisn(this, paramRunnable));
  ...
  {
    if (!this.jdField_b_of_type_Boolean) {}
    while (bjaa.a().a("has_enter_aio_gif", false, 0)) {
      return false;
    }
    return true;
  }
  ...
  {
    int i = 200;
    Intent localIntent = this.jdField_a_of_type_Bijd.a().getIntent();
    if (localIntent != null) {
  ...
  private void e()
  {
    ...
    this.jdField_b_of_type_AndroidViewAnimationAnimation.setAnimationListener(new bism(this));
  ...
  private void f()
  {
    ...
    localAnimationSet.addAnimation(localScaleAnimation);
    localAnimationSet.addAnimation(localTranslateAnimation);
    localAnimationSet.setAnimationListener(new biso(this));
    this.jdField_b_of_type_AndroidViewView.startAnimation(localAnimationSet);
  }
  ...
  private void k()
  {
    ...
    bjaa.a().a("has_enter_aio_gif", true, 0);
  }
  ...
  protected void a()
  {
    this.jdField_c_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131366393);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131367066);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidViewView.findViewById(2131367067));
  }
