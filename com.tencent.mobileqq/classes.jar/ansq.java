...
public class ansq
{
  ...
  public static String a(String paramString)
  {
    ...
    boolean bool = auoq.a(localCompressInfo);
  ...
  public static void a(List<String> paramList)
  {
    ...
    Object localObject1 = (QQAppInterface)bizu.a();
    ansr localansr = (ansr)((QQAppInterface)localObject1).getManager(149);
    ajwa localajwa = (ajwa)((QQAppInterface)localObject1).a(72);
    ...
    for (;;)
    {
      ...
      if (!a(localCustomEmotionData1.emoOriginalPath))
      {
        ...
        localansr.c(localCustomEmotionData1);
        localajwa.notifyUI(2, true, null);
        a(false, 1, 0);
        i = k + 1;
        k = i;
        break;
      ...
      localObject2 = ajsf.bh + akvu.a(str1) + str3 + (String)localObject2;
      boolean bool = bbdj.d((String)localObject1, (String)localObject2);
      if (QLog.isColorLevel()) {
      ...
      if (((Iterator)localObject1).hasNext())
      {
        ...
        {
          localansr.a(localCustomEmotionData2, localList.indexOf(localCustomEmotionData2));
          i = 1;
        }
      }
      for (;;)
      {
        ...
        {
          localansr.a(localCustomEmotionData2);
        }
        else
        {
          n = 1;
  ...
  public static void a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    if (paramBoolean)
    {
      ...
      axrl.a(BaseApplication.getContext()).a(null, "FavEmoUploadLocal", false, 0L, 0L, localHashMap, null);
      if (!paramBoolean) {
        break label91;
      }
    }
  ...
  public static boolean a(String paramString)
  {
    try
    {
      amsg localamsg = (amsg)ampm.a().a(561);
      if (new File(paramString).length() >= localamsg.a) {
        return false;
      }
      if (!auoy.a(paramString))
      {
        ...
        if (localOptions.outWidth < localamsg.b)
        {
