  ...
  extends anrh
{
  ...
  private anst jdField_a_of_type_Anst;
  
  public ansq(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  private void d()
  {
    this.jdField_a_of_type_AndroidAppDialog = bfur.a(this.jdField_a_of_type_AndroidContentContext, 2131692601, this.jdField_a_of_type_AndroidContentContext.getString(2131692588), 2131692590, 2131692589, new ansr(this), new anss(this));
  ...
  private void e()
  {
    ...
    for (String str5 = (String)this.jdField_a_of_type_JavaUtilHashMap.get("offerid");; str5 = "")
    {
      ...
      this.jdField_a_of_type_Anst = new anst(this, null);
      this.jdField_a_of_type_Amzh = new amzh(this.jdField_a_of_type_Anst);
