...
{
  public ansq(EmoticonFromGroupManager.5 param5, URLDrawable paramURLDrawable, CustomEmotionData paramCustomEmotionData, ansx paramansx, answ paramansw) {}
  
  public void onLoadCanceled(URLDrawable paramURLDrawable)
  {
    ansm.a(this.jdField_a_of_type_ComTencentMobileqqEmosmFavroamingEmoticonFromGroupManager$5.this$0).a.remove(this.jdField_a_of_type_ComTencentImageURLDrawable);
  }
  ...
  public void onLoadSuccessed(URLDrawable paramURLDrawable)
  {
    ...
    do
    {
      ...
      {
        return;
        str = ansm.a(this.jdField_a_of_type_ComTencentMobileqqEmosmFavroamingEmoticonFromGroupManager$5.this$0, paramURLDrawable);
      } while ("".equals(str));
    ...
    try
    {
      ...
      this.jdField_a_of_type_Ansx.d(this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData);
      this.jdField_a_of_type_Answ.c(this.jdField_a_of_type_ComTencentMobileqqDataCustomEmotionData);
      return;
    }
