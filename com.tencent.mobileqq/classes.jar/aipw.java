...
public class aipw
  extends amsu
{
  public aipw(RecommendFriendFragment paramRecommendFriendFragment) {}
  ...
  protected void onMayknowStateChanged(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      if (this.a.jdField_a_of_type_Aipx != null) {
        this.a.jdField_a_of_type_Aipx.notifyDataSetChanged();
      }
