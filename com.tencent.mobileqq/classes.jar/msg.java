  ...
  implements Manager
{
  ...
  public String a;
  HashMap<String, msi> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  public msg(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Azgl = new msh(this);
  ...
  public msi a(String paramString, long paramLong)
  {
    msi localmsi2 = (msi)this.jdField_a_of_type_JavaUtilHashMap.get(paramString + paramLong);
    msi localmsi1 = localmsi2;
    if (localmsi2 == null)
    {
      localmsi1 = new msi(this);
      localmsi1.jdField_a_of_type_JavaLangString = paramString;
      localmsi1.jdField_a_of_type_Long = paramLong;
      this.jdField_a_of_type_JavaUtilHashMap.put(localmsi1.a(), localmsi1);
    }
    return localmsi1;
  }
  ...
  public void a(String paramString1, String paramString2, long paramLong)
  {
    ...
    new azgk("http://now.qq.com/cgi-bin/now/web/room/get_live_room_url", "GET", this.jdField_a_of_type_Azgl, 1001, localBundle, true).execute(new HashMap[] { paramString2 });
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, long paramLong, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication();
    paramString2.put("CONTEXT", MobileQQ.getContext());
    new azgk("http://now.qq.com/cgi-bin/now/web/room/check_live_stat", "GET", this.jdField_a_of_type_Azgl, 1003, localBundle, true).execute(new HashMap[] { paramString2 });
  }
  ...
  public boolean b()
  {
    ...
    Iterator localIterator = ((auqh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(36)).a().iterator();
