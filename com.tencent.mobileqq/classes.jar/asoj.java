...
public class asoj
  implements AdapterView.OnItemClickListener, asuv
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajsd.aW + "TempMail" + File.separator;
    j = ajya.a(2131700126);
    jdField_b_of_type_JavaLangString = "0X8007F0A ";
  }
  
  public asoj(QQAppInterface paramQQAppInterface, Context paramContext, Activity paramActivity, BaseChatPie paramBaseChatPie, MqqHandler paramMqqHandler)
  {
  ...
  {
    URL localURL = aywm.a(paramMessageForPic, 131075);
    if (ayoi.a(localURL.toString()) != null) {
      return ayoi.d(localURL.toString());
    }
    localURL = aywm.a(paramMessageForPic, 1);
    if (ayoi.a(localURL.toString()) != null) {
      return ayoi.d(localURL.toString());
    }
    paramMessageForPic = aywm.a(paramMessageForPic, 65537);
    if (ayoi.a(paramMessageForPic.toString()) != null) {
      return ayoi.d(paramMessageForPic.toString());
    }
    return null;
  }
  ...
  public static String a(MessageForPic paramMessageForPic, List<String> paramList1, List<String> paramList2)
  {
    ...
    paramMessageForPic = "";
    if (str2.indexOf(".") == -1) {
      paramMessageForPic = bbdx.b(str1);
    }
    paramMessageForPic = ajya.a(2131700130) + paramList1.size() + "." + paramMessageForPic;
    paramList1 = paramMessageForPic + ajya.a(2131700125);
      ...
      if (paramMessageForStructing == null)
      {
        ...
        if (((StructMsgForGeneralShare)localObject2).mStructMsgItemLists != null)
        {
          ...
          for (;;)
          {
            ...
            Object localObject3 = (axup)((Iterator)localObject2).next();
            localObject1 = paramMessageForStructing;
            if ((localObject3 instanceof axxi))
            {
              localObject3 = (axxi)localObject3;
              localObject1 = paramMessageForStructing;
              if (((axxi)localObject3).a != null)
              {
                localObject3 = ((axxi)localObject3).a.iterator();
                for (;;)
                {
                  localObject1 = paramMessageForStructing;
                  ...
                  localObject1 = (axup)((Iterator)localObject3).next();
                  if ((localObject1 instanceof axzj)) {
                    paramMessageForStructing = ((axzj)localObject1).Y;
                  }
                }
              }
            }
  ...
  public void a(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          paramArrayList = Intent.createChooser((Intent)paramMap.remove(0), ajya.a(2131700124));
    ...
    this.jdField_a_of_type_AndroidContentContext.startActivity(Intent.createChooser(localIntent, ajya.a(2131700122)));
  }
  ...
  public void a(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList, Intent paramIntent)
  {
    ...
    //   19: ifne +725 -> 744
    //   22: aload_0
    //   23: getfield 103	asoj:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   26: ldc_w 415
    ...
    //   37: iconst_0
    //   38: aload_0
    //   39: getfield 101	asoj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   42: aload 6
    //   44: getfield 421	com/tencent/mobileqq/data/ChatMessage:selfuin	Ljava/lang/String;
    //   47: invokestatic 426	bbcz:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   50: aastore
    //   51: dup
    //   52: iconst_1
    //   53: aload_0
    //   54: getfield 101	asoj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   57: aload 6
    //   59: getfield 429	com/tencent/mobileqq/data/ChatMessage:frienduin	Ljava/lang/String;
    //   62: invokestatic 426	bbcz:b	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   65: aastore
    ...
    //   80: pop
    //   81: getstatic 56	asoj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   84: iconst_1
    //   85: invokestatic 438	bbdx:a	(Ljava/lang/String;Z)V
    //   88: new 47	java/io/File
    //   91: dup
    //   92: getstatic 56	asoj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   165: getstatic 56	asoj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   168: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   171: getstatic 64	asoj:j	Ljava/lang/String;
    ...
    //   180: invokestatic 448	bbdx:a	(Ljava/lang/String;)Ljava/io/File;
    //   183: pop
    ...
    //   199: getstatic 56	asoj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   202: invokevirtual 43	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   205: getstatic 64	asoj:j	Ljava/lang/String;
    ...
    //   442: astore 7
    //   444: aload 5
    //   446: invokestatic 521	aylc:a	(Ljava/lang/String;)Z
    //   449: ifeq +1189 -> 1638
    //   452: aload 5
    //   454: invokestatic 522	aylc:d	(Ljava/lang/String;)Ljava/lang/String;
    //   457: astore 7
    //   459: goto +1179 -> 1638
    //   462: aload 6
    //   464: astore 7
    ...
    //   753: aload_0
    //   754: getfield 103	asoj:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   757: ldc_w 547
    ...
    //   768: iconst_0
    //   769: aload_0
    //   770: getfield 101	asoj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   773: aload 6
    //   775: getfield 429	com/tencent/mobileqq/data/ChatMessage:frienduin	Ljava/lang/String;
    //   778: invokestatic 549	bbcz:g	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;)Ljava/lang/String;
    //   781: aastore
    ...
    //   801: aload_0
    //   802: getfield 103	asoj:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   805: ldc_w 547
    ...
    //   816: iconst_0
    //   817: aload_0
    //   818: getfield 101	asoj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   821: aload_0
    //   822: getfield 101	asoj:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   833: invokestatic 558	bbcz:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    //   836: aastore
    ...
    //   868: aload 12
    //   870: aload 13
    //   872: invokestatic 563	asoj:a	(Lcom/tencent/mobileqq/data/MessageForPic;Ljava/util/List;Ljava/util/List;)Ljava/lang/String;
    //   875: astore 5
    //   877: goto -415 -> 462
    //   880: aload 16
    //   882: instanceof 565
    ...
    //   951: ldc_w 574
    //   954: invokestatic 62	ajya:a	(I)Ljava/lang/String;
    ...
    //   993: ldc_w 577
    //   996: invokestatic 62	ajya:a	(I)Ljava/lang/String;
    ...
    //   1111: ldc_w 595
    //   1114: invokestatic 62	ajya:a	(I)Ljava/lang/String;
    //   1117: astore 5
    //   1119: goto -657 -> 462
    //   1122: ldc_w 597
    //   1125: aload 7
    ...
    //   1136: ifeq +14 -> 1150
    //   1139: ldc_w 603
    //   1142: invokestatic 62	ajya:a	(I)Ljava/lang/String;
    //   1145: astore 5
    //   1147: goto -41 -> 1106
    //   1150: aload 7
    ...
    //   1163: aload_0
    //   1164: aload 7
    //   1166: invokevirtual 608	asoj:a	(Lcom/tencent/mobileqq/data/MessageForStructing;)Ljava/lang/String;
    //   1169: astore 5
    //   1171: goto -65 -> 1106
    //   1174: aload 7
    ...
    //   1277: aload_1
    //   1278: aload_0
    //   1279: getstatic 64	asoj:j	Ljava/lang/String;
    //   1282: invokevirtual 630	asoj:a	(Ljava/lang/String;)Landroid/net/Uri;
    ...
    //   1336: getstatic 56	asoj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   1367: invokestatic 637	bbdx:d	(Ljava/lang/String;Ljava/lang/String;)Z
    //   1370: ifeq -63 -> 1307
    //   1373: aload_1
    //   1374: aload_0
    //   1375: aload 13
    ...
    //   1394: invokevirtual 630	asoj:a	(Ljava/lang/String;)Landroid/net/Uri;
    ...
    //   1512: getstatic 56	asoj:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   1543: invokestatic 637	bbdx:d	(Ljava/lang/String;Ljava/lang/String;)Z
    //   1546: ifeq -63 -> 1483
    //   1549: aload_1
    //   1550: aload_0
    //   1551: aload 11
    ...
    //   1570: invokevirtual 630	asoj:a	(Ljava/lang/String;)Landroid/net/Uri;
  ...
  public boolean a()
  {
    Iterator localIterator = asua.a().a.entrySet().iterator();
    boolean bool2 = false;
    if (localIterator.hasNext())
    {
      ...
      if (((Boolean)((Map.Entry)localObject).getValue()).booleanValue())
      {
        ...
        bool2 |= ajwb.a((MessageRecord)localObject);
        if (akqa.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject)) {}
      }
    }
    while (bool2)
    {
      ...
      do
      {
        do
        {
          ...
          localObject = bakx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForTroopFile)localObject);
        } while (localObject == null);
        bool1 = bool2;
        if (((azqv)localObject).jdField_b_of_type_Int == 8) {
          break;
        }
        bool1 = bool2;
        if (((azqv)localObject).jdField_b_of_type_Int == 9) {
          break;
        }
        bool1 = bool2;
        if (((azqv)localObject).jdField_b_of_type_Int == 6) {
          break;
        }
        bool1 = bool2;
        if (((azqv)localObject).jdField_b_of_type_Int == 7) {
          break;
        }
        if (((azqv)localObject).jdField_b_of_type_Int == 11)
        {
          bool1 = bool2;
          if (apvd.a(((azqv)localObject).jdField_a_of_type_JavaLangString)) {
            break;
          }
        }
      } while (((azqv)localObject).jdField_b_of_type_Int != 10);
      boolean bool1 = bool2;
      bool2 = bool1;
      break;
    }
  ...
  {
    if (((paramChatMessage instanceof MessageForPic)) && (ajwb.a(paramChatMessage))) {
      return false;
    }
    ...
    else if (((paramChatMessage instanceof MessageForPic)) && (aezl.a((MessageForPic)paramChatMessage)))
    {
      return false;
    }
    return akqa.a(paramChatMessage);
  }
  ...
  public List<bbjs>[] a(Context paramContext)
  {
    ...
    for (int m = 1;; m = 0)
    {
      ...
      ((bbjs)localObject).jdField_a_of_type_JavaLangString = paramContext.getString(2131696716);
      ((bbjs)localObject).jdField_b_of_type_Int = 2130838758;
      ((bbjs)localObject).c = 9;
      ((bbjs)localObject).jdField_b_of_type_JavaLangString = "";
      localArrayList.add(localObject);
      localObject = new bbjs();
      ((bbjs)localObject).jdField_a_of_type_JavaLangString = paramContext.getString(2131696702);
      ((bbjs)localObject).jdField_b_of_type_Int = 2130839046;
      ((bbjs)localObject).c = 25;
      ((bbjs)localObject).jdField_b_of_type_JavaLangString = "";
      localArrayList.add(localObject);
      if (this.jdField_a_of_type_Boolean)
      {
        localObject = new bbjs();
        ((bbjs)localObject).jdField_a_of_type_JavaLangString = paramContext.getString(2131692911);
        ((bbjs)localObject).jdField_b_of_type_Int = 2130839641;
        ((bbjs)localObject).c = 50;
        ((bbjs)localObject).jdField_b_of_type_JavaLangString = "";
        localArrayList.add(localObject);
      }
      ...
      {
        localbbjs = new bbjs();
        localbbjs.jdField_a_of_type_JavaLangString = paramContext.getString(2131696704);
        localbbjs.jdField_b_of_type_Int = 2130839079;
      ...
      {
        localbbjs = new bbjs();
        localbbjs.jdField_a_of_type_JavaLangString = paramContext.getString(2131696719);
        localbbjs.jdField_b_of_type_Int = 2130839209;
        localbbjs.jdField_b_of_type_Boolean = true;
        localbbjs.c = 27;
        localbbjs.jdField_b_of_type_JavaLangString = "";
        ((ArrayList)localObject).add(localbbjs);
      ...
      localbbjs.jdField_a_of_type_JavaLangString = paramContext.getString(2131696700);
      ...
      ((ArrayList)localObject).add(localbbjs);
      localbbjs = new bbjs();
      localbbjs.jdField_a_of_type_JavaLangString = paramContext.getString(2131696695);
      localbbjs.jdField_b_of_type_Int = 2130839609;
      localbbjs.jdField_b_of_type_Boolean = true;
      localbbjs.c = 47;
      localbbjs.jdField_b_of_type_JavaLangString = "";
      ((ArrayList)localObject).add(localbbjs);
  ...
  public void b()
  {
    Iterator localIterator = asua.a().a().iterator();
    ...
    do
    {
      ...
      k = adte.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localChatMessage);
    } while ((!(localChatMessage instanceof MessageForPic)) || (k != 1) || (bbfh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForPic)localChatMessage, false)));
    for (boolean bool = true;; bool = false)
    {
      if ((this.jdField_a_of_type_Bbjq == null) || (this.jdField_a_of_type_Boolean != bool))
      {
        ...
        int m = this.jdField_a_of_type_Bbjq.b();
        this.jdField_a_of_type_Bbjq.c(Math.max(k, m));
  ...
  public void b(Map<String, String> paramMap, ArrayList<ChatMessage> paramArrayList)
  {
    ...
    if (k < paramArrayList.size())
    {
      ...
      for (;;)
      {
        ...
        {
          localObject1 = ajya.a(2131700123);
        }
        else if ((localChatMessage instanceof MessageForShortVideo))
        {
          localObject1 = ajya.a(2131700127);
        }
        else
        {
    ...
    for (;;)
    {
      ...
      localObject1 = ajya.a(2131700129);
      break;
      ...
      else
      {
        ...
        if (((MessageForStructing)localObject1).structingMsg.mMsgUrl != null)
        {
          ...
          if (((localChatMessage instanceof MessageForArkFlashChat)) && (localChatMessage.msg != null))
          {
            ...
            bcql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694466, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
            return;
          }
          localObject1 = null;
          break;
  ...
  public boolean b()
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      if (((Boolean)((Map.Entry)localObject).getValue()).booleanValue())
      {
        localObject = (ChatMessage)((Map.Entry)localObject).getKey();
        bool2 |= ajwb.a((MessageRecord)localObject);
        if (akqa.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject)) {}
      }
    }
    while (bool2)
    {
      ...
      do
      {
        ...
        localObject = (MessageForTroopFile)localObject;
      } while (bakx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForTroopFile)localObject) == null);
      boolean bool1 = bool2;
      bool2 = bool1;
      break;
    }
  ...
  public boolean b(ChatMessage paramChatMessage)
  {
    ...
    if (((paramChatMessage instanceof MessageForPic)) && (aezl.a((MessageForPic)paramChatMessage))) {
      return false;
    }
    return akqa.a(paramChatMessage);
  }
  ...
  public void c()
  {
    ...
    {
      this.jdField_a_of_type_Bbjq.a(null);
  ...
  public boolean c()
  {
    ...
    Object localObject1 = asua.a().a();
    if (((List)localObject1).size() == 0)
    {
      bcql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131698475, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      return false;
    }
    ...
    if (localArrayList1.size() > 0)
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        bakx.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject2);
      }
    }
    ...
    if (localArrayList2.size() > 0)
    {
      ...
      localObject2 = apug.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForFile)localObject1);
      if (localObject2 == null)
      {
        aptx.a(2131692667);
        return false;
      ...
      apug.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject1, BaseActivity.sTopActivity);
    }
    while ((localArrayList1.size() == 0) && (localArrayList2.size() == 0))
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        apug.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject2, BaseActivity.sTopActivity);
      }
    }
    return true;
  }
  ...
  public boolean e()
  {
    ...
    {
      bcql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694460, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      return false;
    }
    ((adio)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(1)).a(localList, 3);
    return true;
  }
  ...
  public boolean g()
  {
    ...
    if (localList.isEmpty())
    {
      bcql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 2131694465, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      return false;
    }
    ((adio)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(1)).a(localList, 4);
    return true;
  }
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    do
    {
      ...
      default: 
        return;
      case 9: 
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", e, e, 0, 0, "", "", "", "");
        paramInt = -1;
        ...
        while (paramInt != -1)
        {
          bcql.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_AndroidContentContext.getString(paramInt), 0).a();
          return;
        ...
        if (this.jdField_a_of_type_Bcww != null) {
          this.jdField_a_of_type_Bcww = new asok(this);
        }
        WXShareHelper.a().a(this.jdField_a_of_type_Bcww);
        ((adio)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(1)).a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Acup, true);
        return;
      case 25: 
        axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", f, f, 0, 0, "", "", "", "");
        if (!d())
        {
          bbdj.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131694458)).setPositiveButton(17039370, new asoo(this)).setNegativeButton(17039360, new ason(this)).show();
          return;
        }
        break;
      }
    } while ((asua.a().a().isEmpty()) || (!e()));
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
    return;
    axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", i, i, 0, 0, "", "", "", "");
    paramView = asua.a().a();
    ...
    if (paramView.hasNext())
    {
      ...
      k = adte.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (ChatMessage)localObject1);
      if (((localObject1 instanceof MessageForPic)) && (k == 1))
      {
        if (bbfh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForPic)localObject1, false)) {
          break label1246;
        }
    ...
    for (;;)
    {
      ...
      {
        bcql.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getString(2131718839), 0).a();
        return;
      }
      paramView = BaseApplicationImpl.getApplication().getRuntime().getAccount();
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_b_of_type_JavaLangString;
      Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.c;
      k = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a;
      if (paramInt != 0) {
        bcql.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getString(2131718839), 0).a();
      }
      aqnq.a(this.jdField_a_of_type_AndroidAppActivity, paramView, (String)localObject1, (String)localObject2, k, paramAdapterView, 102);
      return;
      if (!b())
      {
        bbdj.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131694469)).setPositiveButton(17039370, new asoq(this)).setNegativeButton(17039360, new asop(this)).show();
        return;
      }
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80067F7", "0X80067F7", 0, 0, "", "", "", "");
      if (!c()) {
        break;
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
      return;
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", g, g, 0, 0, "", "", "", "");
      if (!a())
      {
        bbdj.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131694467)).setPositiveButton(17039370, new asos(this)).setNegativeButton(17039360, new asor(this)).show();
        return;
      }
      if (!bidk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(), this.jdField_a_of_type_MqqOsMqqHandler)) {
        break;
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
      return;
      axqy.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", h, h, 0, 0, "", "", "", "");
      if (!f())
      {
        bbdj.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(this.jdField_a_of_type_AndroidContentContext.getString(2131694464)).setPositiveButton(17039370, new asou(this)).setNegativeButton(17039360, new asot(this)).show();
        return;
      }
      if ((asua.a().a().isEmpty()) || (!g())) {
        break;
      }
      this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(false, null, false);
      return;
      paramAdapterView = new asun(this.jdField_a_of_type_AndroidAppActivity);
      paramView = (asuw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(324);
      if ((paramView == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Acup == null)) {
        break;
      }
      localObject1 = new ArrayList();
      localObject2 = asua.a().a.entrySet().iterator();
      while (((Iterator)localObject2).hasNext())
      {
      ...
      localObject1 = asur.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (List)localObject1, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_Acup.a, this);
      if ((localObject1 == null) || (((List)localObject1).isEmpty()))
      {
        bcql.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidContentContext.getString(2131718838), 0).a();
        return;
      }
      ...
      paramView.a(new asol(this, paramAdapterView, paramView, (List)localObject1));
      ...
      paramView.a((List)localObject1, 1, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a);
      return;
    }
  }
}
