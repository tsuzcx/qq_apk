...
public class pkd
{
  private static pkd jdField_a_of_type_Pkd;
  ...
  private List<pke> jdField_b_of_type_JavaUtilList = new ArrayList();
  ...
  private String a(pke parampke, BaseArticleInfo paramBaseArticleInfo, TemplateBean paramTemplateBean, ViewBase paramViewBase)
  {
    if (paramBaseArticleInfo == null) {
      return "";
    }
    if ((TextUtils.isEmpty(parampke.jdField_b_of_type_JavaLangString)) || (TextUtils.isEmpty(parampke.c)) || (TextUtils.isEmpty(parampke.jdField_a_of_type_JavaLangString))) {
      return "";
    }
    String str3 = parampke.jdField_a_of_type_JavaLangString;
    String str1 = parampke.jdField_b_of_type_JavaLangString;
    String str2 = parampke.c;
    ...
    {
      parampke = str1.replace("${rowkey}", paramTemplateBean).replace("${uin}", pkh.a());
      paramBaseArticleInfo = str2.replace("${rowkey}", paramTemplateBean).replace("${uin}", pkh.a());
    }
    ...
    catch (UnsupportedEncodingException parampke)
    {
      for (;;)
      {
        parampke.printStackTrace();
      }
    }
  }
  ...
  public static pkd a()
  {
    try
    {
      if (jdField_a_of_type_Pkd == null) {
        jdField_a_of_type_Pkd = new pkd();
      }
      pkd localpkd = jdField_a_of_type_Pkd;
      return localpkd;
    }
    finally {}
  }
  
  private pke a(oidb_cmd0x64e.SRTRule paramSRTRule)
  {
    ...
    if (paramSRTRule.uint32_click_number.has()) {
      localpke.jdField_b_of_type_JavaUtilList = paramSRTRule.uint32_click_number.get();
    }
    if (paramSRTRule.uint32_feeds_type.has()) {
      localpke.jdField_a_of_type_JavaUtilList = paramSRTRule.uint32_feeds_type.get();
    }
    if (paramSRTRule.uint32_network_type.has()) {
      localpke.jdField_a_of_type_Int = paramSRTRule.uint32_network_type.get();
    }
    if (paramSRTRule.bytes_app_package_name.has()) {
      localpke.jdField_a_of_type_JavaLangString = paramSRTRule.bytes_app_package_name.get().toStringUtf8();
    }
    if (paramSRTRule.bytes_schema.has()) {
      localpke.c = paramSRTRule.bytes_schema.get().toStringUtf8();
    }
    if (paramSRTRule.bytes_h5.has()) {
      localpke.jdField_b_of_type_JavaLangString = paramSRTRule.bytes_h5.get().toStringUtf8();
    }
    QLog.d("ReadInJoySrtUtils", 1, "convertSRTPbToSRTClassclickNumList = " + localpke.jdField_b_of_type_JavaUtilList + " feedsTypeList= " + localpke.jdField_a_of_type_JavaUtilList + " netWorkType= " + localpke.jdField_a_of_type_Int + " packageName = " + localpke.jdField_a_of_type_JavaLangString + " schemaUrl= " + localpke.c + " h5Url= " + localpke.jdField_b_of_type_JavaLangString);
    return localpke;
  }
  ...
  private oidb_cmd0x64e.SRTRule a(pke parampke)
  {
    if (parampke == null) {
      return null;
    }
    ...
    if (parampke.c != null) {
      localSRTRule.bytes_schema.set(ByteStringMicro.copyFromUtf8(parampke.c));
    }
    if (parampke.jdField_b_of_type_JavaLangString != null) {
      localSRTRule.bytes_h5.set(ByteStringMicro.copyFromUtf8(parampke.jdField_b_of_type_JavaLangString));
    }
    if (parampke.jdField_a_of_type_JavaLangString != null) {
      localSRTRule.bytes_app_package_name.set(ByteStringMicro.copyFromUtf8(parampke.jdField_a_of_type_JavaLangString));
    }
    if (parampke.jdField_b_of_type_JavaUtilList != null) {
      localSRTRule.uint32_click_number.set(parampke.jdField_b_of_type_JavaUtilList);
    }
    if (parampke.jdField_a_of_type_JavaUtilList != null) {
      localSRTRule.uint32_feeds_type.set(parampke.jdField_a_of_type_JavaUtilList);
    }
    localSRTRule.uint32_network_type.set(parampke.jdField_a_of_type_Int);
    return localSRTRule;
  }
  
  private void a(pke parampke, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    do
    {
      ...
      if (parampke != null)
      {
        ...
        parampke.uint32_click_number.set(localArrayList1);
        parampke.uint32_feeds_type.set(localArrayList2);
      }
    ...
    this.jdField_a_of_type_TencentImOidbCmd0x64eOidb_cmd0x64e$SRTClickInfo.msg_hit_srt_rule.set(parampke);
  }
  
  private boolean a(pke parampke, int paramInt)
  {
    if (parampke == null) {}
    int i;
    int j;
    do
    {
      ...
      {
        return false;
      } while ((parampke.jdField_b_of_type_JavaUtilList == null) || (parampke.jdField_a_of_type_JavaUtilList == null));
      i = parampke.jdField_a_of_type_Int;
      j = NetworkUtil.getNetworkType(BaseActivity.sTopActivity);
    } while ((j == 0) || ((i == 1) && (j != 1)) || ((i == 2) && (j == 1)) || (!parampke.jdField_a_of_type_JavaUtilList.contains(Integer.valueOf(paramInt))));
    return parampke.jdField_b_of_type_JavaUtilList.contains(Integer.valueOf(this.jdField_a_of_type_Int));
  }
  ...
  private void c()
  {
    try
    {
      Object localObject = (String)bmhv.a("readinjoy_srt_click_time_key", "");
      String str1;
      int i;
      ...
      for (;;)
      {
        ...
        bmhv.a("readinjoy_srt_click_time_key", ((JSONObject)localObject).toString());
        return;
  ...
  public void a(List<oidb_cmd0x64e.SRTRule> paramList)
  {
    if (paramList != null)
    {
      ...
      {
        pke localpke = a((oidb_cmd0x64e.SRTRule)localIterator.next());
        if (localpke != null) {
          localArrayList.add(localpke);
        }
      }
  ...
  {
    if ((this.jdField_b_of_type_JavaUtilList == null) || (this.jdField_b_of_type_JavaUtilList.size() == 0) || (paramBaseArticleInfo == null) || ((paramBaseArticleInfo.mChannelID != 0L) && (!plm.c((int)paramBaseArticleInfo.mChannelID)))) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        pke localpke = (pke)this.jdField_b_of_type_JavaUtilList.get(i);
        int j = pqw.a(paramBaseArticleInfo);
        QLog.d("ReadInJoySrtUtils", 1, "startJudge feedsType:" + j + " clickTimes: " + this.jdField_a_of_type_Int + " position" + i);
        if (a(localpke, j))
        {
          paramBaseArticleInfo = a(localpke, paramBaseArticleInfo, paramTemplateBean, paramViewBase);
          if (TextUtils.isEmpty(paramBaseArticleInfo)) {
            break;
          }
          this.jdField_a_of_type_JavaLangString = paramBaseArticleInfo;
          a(localpke, j, this.jdField_a_of_type_Int, i);
