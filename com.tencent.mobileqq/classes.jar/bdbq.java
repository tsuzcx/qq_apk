  ...
  implements Handler.Callback, Manager, BusinessObserver
{
  ...
  private ConcurrentHashMap<Long, bdbt> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap;
  private int b = -1;
  ...
  public bdbq(QQAppInterface paramQQAppInterface)
  {
  ...
  private void a(MessageForPtt paramMessageForPtt, int paramInt)
  {
    if (paramMessageForPtt != null)
    {
      ...
      paramMessageForPtt.sttText = anni.a(2131713314);
      ...
      bctj.a(BaseApplication.getContext()).a(null, "ptttotextSuc", false, 0L, 0L, localHashMap, null);
    }
    try
    {
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    return ((bdbq)paramQQAppInterface.getManager(17)).a();
  }
  ...
  public void a(int paramInt)
  {
    ...
    try
    {
      ...
      localHashMap.put("appversion", "8.4.1");
      localbctj.a("", "PttSttEntryChange", false, 0L, 0L, localHashMap, "");
      return;
    }
  ...
  public void a(bdbs parambdbs)
  {
    this.jdField_a_of_type_Bdbs = parambdbs;
  }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      while (paramArrayOfByte != null)
      {
        ...
        localObject = (bdbt)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(localLong);
        paramArrayOfByte = (byte[])localObject;
        if (localObject == null)
        {
          paramArrayOfByte = new bdbt(null);
  ...
  public Long b(MessageForPtt paramMessageForPtt, int paramInt)
  {
    ...
    {
      if (!bgsp.a(paramMessageForPtt.urlAtServer)) {
        break label160;
      }
      QLog.e("", 1, new Object[] { "stt err, c2c no fileID ", paramMessageForPtt });
      a(paramMessageForPtt, 2003);
      if (this.jdField_a_of_type_Bdbs != null) {
        this.jdField_a_of_type_Bdbs.a(false, paramMessageForPtt);
      }
    }
    for (;;)
    {
      return localLong;
      if (bgsp.a(paramMessageForPtt.md5))
      {
      ...
      else
      {
        ...
        boolean bool = bhhv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "have_add_ptt_svip_gray_msg", false);
        if ((((aqxd)localObject).jdField_a_of_type_Int == 2) && (!bool) && (VipUtils.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && (aher.d))
        {
          localObject = new auxc(paramMessageForPtt.frienduin, paramMessageForPtt.selfuin, anni.a(2131713315), paramMessageForPtt.istroop, -5020, 655392, paramMessageForPtt.time);
          ...
          bhhv.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "have_add_ptt_svip_gray_msg", true);
        ...
        while (!this.jdField_a_of_type_JavaUtilHashMap.containsKey(localLong))
        {
          ...
          bdbu.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageForPtt, localLong, paramInt);
          return localLong;
          if (QLog.isColorLevel()) {
            QLog.d("Q.stt", 1, "stage2 first translate It is need add gray msg and insert falied:conf.stage == " + ((aqxd)localObject).jdField_a_of_type_Int + " && " + bool);
          }
        }
      }
    }
  ...
  public boolean b(MessageForPtt paramMessageForPtt)
  {
    ...
    {
      return true;
      bgog.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      if (QLog.isColorLevel()) {
        QLog.d("Q.stt", 2, "needAuotoChange AutoChangeFlag=" + aher.d + " AutoChangeSetTime=" + aher.jdField_a_of_type_Long + " isTranslating=" + a(paramMessageForPtt) + "mPtt.msgTime=" + paramMessageForPtt.msgTime + " mPtt.time=" + paramMessageForPtt.time + " mPtt.sttAbility=" + paramMessageForPtt.sttAbility + " isRedPackPTT=" + akxm.a(paramMessageForPtt));
      }
    } while ((!a(paramMessageForPtt)) && (!akxm.a(paramMessageForPtt)) && (aher.d) && ((aher.jdField_a_of_type_Long < paramMessageForPtt.msgTime) || (aher.jdField_a_of_type_Long < paramMessageForPtt.time)) && (paramMessageForPtt.voiceChangeFlag != 1) && ((paramMessageForPtt.sttAbility == 1) || (paramMessageForPtt.sttAbility == 3)));
    return false;
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (MessageForPtt localMessageForPtt = (MessageForPtt)this.jdField_a_of_type_JavaUtilHashMap.remove(paramMessage.obj);; localMessageForPtt = null)
    {
      ...
      if ((localMessageForPtt != null) && (this.jdField_a_of_type_Bdbs != null))
      {
        a(localMessageForPtt, 2002);
        this.jdField_a_of_type_Bdbs.a(false, localMessageForPtt);
      }
      return true;
      ...
      for (localMessageForPtt = (MessageForPtt)this.jdField_a_of_type_JavaUtilHashMap.remove(Long.valueOf(l));; localMessageForPtt = null)
      {
        ...
        bctj.a(BaseApplication.getContext()).a(null, "ptttotextSuc", true, 0L, 0L, localHashMap, null);
        ...
        if (QLog.isColorLevel()) {
          QLog.d("PttItemBuilder", 2, "ptt convert to text success,seq is:" + localMessageForPtt.uniseq + ",sttAbility is:" + localMessageForPtt.sttAbility + ",sttText is:" + bgjw.a(localMessageForPtt.sttText));
        }
        if (this.jdField_a_of_type_Bdbs == null) {
          break;
        }
        this.jdField_a_of_type_Bdbs.a(true, localMessageForPtt);
        return true;
      }
    }
  }
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_Bdbs = null;
  }
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      } while (this.jdField_a_of_type_Bdbs == null);
      this.jdField_a_of_type_Bdbs.a(false, paramBundle);
      return;
    } while (!QLog.isColorLevel());
