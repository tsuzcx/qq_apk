...
{
  public bdbq(OpenAuthorityFragment paramOpenAuthorityFragment) {}
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 0: 
      ...
      if (i != 0) {
        QLog.d("OpenAuthorityFragment", 1, "rec | cmd: G_A_L_D | uin : *" + bdem.a(this.a.jdField_a_of_type_Bdna.jdField_a_of_type_JavaLangString) + " | ret : success | code : " + i);
      }
      break;
    }
    label2308:
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          bded.a().a(this.a.jdField_a_of_type_Bdna.jdField_a_of_type_JavaLangString, "", OpenAuthorityFragment.a(this.a), "1", "6", "" + i, false);
          if (TextUtils.isEmpty(localPreAuthResponse.msg.get()))
          {
            paramMessage = String.format(this.a.getResources().getString(2131694893), new Object[] { Integer.valueOf(i) });
            if (i == 110405)
            {
              this.a.a(paramMessage, new bdbr(this));
          ...
          {
            paramMessage = String.format(this.a.getResources().getString(2131696781), new Object[] { localPreAuthResponse.msg.get(), Integer.valueOf(i) });
            continue;
          }
          if ((i == 110509) && (OpenAuthorityFragment.a(this.a) < 0))
          {
            ...
            bdnb.a().a(this.a.jdField_a_of_type_JavaLangString, 4096, this.a.jdField_a_of_type_MqqObserverSSOAccountObserver, true);
          ...
          if (i == 100044)
          {
            ...
            ((Bundle)localObject3).putString("uin", this.a.jdField_a_of_type_Bdna.jdField_a_of_type_JavaLangString);
            ...
            bded.a().a((Bundle)localObject3, OpenAuthorityFragment.a(this.a), this.a.jdField_a_of_type_Bdna.jdField_a_of_type_JavaLangString, false);
          }
          ...
          this.a.a(paramMessage, new bdbs(this, localPreAuthResponse, (JSONObject)localObject1));
          continue;
        ...
        if (this.a.jdField_a_of_type_ComTencentOpenAgentOpenCardContainer.a(this.a.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface.a().a(OpenAuthorityFragment.a(this.a)), localPreAuthResponse.authorized_union_text.get()))
        {
          ...
          axrl.a(BaseApplicationImpl.getApplication()).a(this.a.jdField_a_of_type_JavaLangString, "connect_sso_pageview", false, System.currentTimeMillis() - this.a.jdField_a_of_type_Long, 0L, paramMessage, "");
          this.a.b("wtl_loggednunauthorized", this.a.jdField_a_of_type_Bdna.jdField_a_of_type_JavaLangString);
        ...
        for (;;)
        {
          ...
          if (!this.a.jdField_e_of_type_Boolean) {
            this.a.b("wtl_loggednauthorized", this.a.jdField_a_of_type_Bdna.jdField_a_of_type_JavaLangString);
          }
          this.a.i();
        }
        if (QLog.isColorLevel()) {
        ...
        if (i != 0)
        {
          QLog.d("OpenAuthorityFragment", 1, "rec | cmd: A_D | uin : *" + bdem.a(this.a.jdField_a_of_type_Bdna.jdField_a_of_type_JavaLangString) + " | ret : success | code : " + i);
          try
          {
            ...
            if (TextUtils.isEmpty((CharSequence)localObject2))
            {
              ...
              this.a.a(paramMessage, new bdbt(this));
            }
            label1474:
            do
            {
              this.a.b(i, paramMessage);
              return true;
              paramMessage = String.format(this.a.getResources().getString(2131696781), new Object[] { localObject2, Integer.valueOf(i) });
              break;
            ...
            paramMessage = bdnz.a(OpenAuthorityFragment.a(this.a), this.a.jdField_a_of_type_Bdna.jdField_a_of_type_JavaLangString);
        ...
        catch (JSONException paramMessage)
        {
          ...
          for (paramMessage = "1";; paramMessage = "0")
          {
            ...
            axrl.a(BaseApplicationImpl.getApplication()).a(this.a.jdField_a_of_type_JavaLangString, "connect_sso_lognback", true, System.currentTimeMillis() - this.a.jdField_b_of_type_Long, 0L, (HashMap)localObject1, "");
            this.a.b("wtl_lognback", this.a.jdField_a_of_type_Bdna.jdField_a_of_type_JavaLangString);
            break;
            ...
            {
              ForwardUtils.a(((SdkAuthorize.AuthorizeResponse)localObject1).ret.get(), this.a.jdField_a_of_type_Bdna);
              bdcs.a().a(this.a.jdField_a_of_type_AndroidOsBundle, true);
              break label2055;
            }
          ...
          axrl.a(BaseApplicationImpl.getApplication()).a(this.a.jdField_a_of_type_JavaLangString, "connect_sso_lognback", true, System.currentTimeMillis() - this.a.jdField_b_of_type_Long, 0L, (HashMap)localObject1, "");
          this.a.b("wtl_lognauthorizenback", this.a.jdField_a_of_type_Bdna.jdField_a_of_type_JavaLangString);
        }
      }
      break;
      label2407:
      if (this.a.jdField_f_of_type_Boolean)
      {
        ...
        ((HashMap)localObject1).put("p2", "auth");
        axrl.a(BaseApplicationImpl.getApplication()).a(this.a.jdField_a_of_type_JavaLangString, "connect_sso_lognback", true, System.currentTimeMillis() - this.a.jdField_b_of_type_Long, 0L, (HashMap)localObject1, "");
        this.a.b("wtl_loggednunauthorizedback", this.a.jdField_a_of_type_Bdna.jdField_a_of_type_JavaLangString);
        break;
      }
      ((HashMap)localObject1).put("appid", OpenAuthorityFragment.a(this.a));
      ((HashMap)localObject1).put("p1", "logged");
      ((HashMap)localObject1).put("p2", "uauth");
      axrl.a(BaseApplicationImpl.getApplication()).a(this.a.jdField_a_of_type_JavaLangString, "connect_sso_lognback", true, System.currentTimeMillis() - this.a.jdField_b_of_type_Long, 0L, (HashMap)localObject1, "");
      this.a.b("wtl_loggednauthorizedback", this.a.jdField_a_of_type_Bdna.jdField_a_of_type_JavaLangString);
      break;
      QLog.d("OpenAuthorityFragment", 1, "handleMessage GET_APP_INFO_DONE");
      paramMessage = (aqaq)paramMessage.obj;
      ...
      if ((!this.a.jdField_g_of_type_Boolean) && (paramMessage != null) && (paramMessage.jdField_a_of_type_JavaUtilList != null) && (!paramMessage.jdField_a_of_type_JavaUtilList.isEmpty()))
      {
        ...
        n = ForwardUtils.a(((xmy)paramMessage.jdField_a_of_type_JavaUtilList.get(i)).b.get());
        if (n < 100) {
          break label3064;
        }
      }
      for (;;)
      {
        localObject1 = (xmy)paramMessage.jdField_a_of_type_JavaUtilList.get(i);
        if (localObject1 != null) {
          ThreadManager.executeOnNetWorkThread(new OpenAuthorityFragment.9.4(this, (xmy)localObject1));
        }
        if (this.a.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface != null) {
          QLog.d("OpenAuthorityFragment", 1, new Object[] { "user uin = ", bdem.a(this.a.jdField_a_of_type_ComTencentQqconnectWtloginOpenSDKAppInterface.getCurrentAccountUin()) });
        }
