  ...
  extends azqj
{
  ...
  protected azqk(Collection<azqj> paramCollection)
  {
    this.jdField_a_of_type_JavaLangString = "item";
  ...
  {
    if (((paramazqj instanceof azql)) && (!b())) {
      ((azql)paramazqj).S = null;
    }
  ...
  public void a(AbsShareMsg paramAbsShareMsg)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext()) {
      ((azqj)localIterator.next()).a(paramAbsShareMsg);
    }
  }
  ...
  public void a(ObjectInput paramObjectInput)
  {
    ...
    for (;;)
    {
      label182:
      str = b();
      if ((str != null) && (localObject != null) && ((localObject instanceof azsm)))
      {
        if ((!str.endsWith("Layout4")) && (!str.endsWith("Layout2")) && (!str.endsWith("Layout9"))) {
          break label350;
        }
        ((azsm)localObject).p = azsm.jdField_m_of_type_Int;
      }
      int j;
      for (;;)
      {
        ...
        i1 += 1;
        break;
        localObject = azqt.a(str);
        j = i;
        if ("button".equals(str))
        {
          ((azqj)localObject).Q = String.valueOf(i);
          ((azqj)localObject).R = this.R;
          j = i + 1;
        }
        if ((localObject == null) || (!azqk.class.isInstance(localObject))) {
          break label874;
        }
        ...
        if (str.endsWith("Layout3")) {
          ((azsm)localObject).p = azsm.jdField_n_of_type_Int;
        }
      }
  ...
  public void a(String paramString1, String paramString2, int paramInt, String paramString3)
  {
    ...
    a(new azsm(paramString1, paramString3));
  ...
  {
    this.jdField_k_of_type_Int = paramInt;
    a(new azsm(paramString1, paramString4));
    a(new StructMsgItemTitle(paramString2));
    a(new azvd(paramString3));
  }
  ...
  public void a(XmlSerializer paramXmlSerializer)
  {
    ...
    for (Object localObject = "0";; localObject = String.valueOf(this.jdField_n_of_type_Int))
    {
      ...
      localObject = this.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (((Iterator)localObject).hasNext()) {
        ((azqj)((Iterator)localObject).next()).a(paramXmlSerializer);
      }
    }
  ...
  public boolean a(azsa paramazsa)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_d_of_type_JavaLangString = paramazsa.a("actionData");
      this.jdField_e_of_type_JavaLangString = paramazsa.a("a_actionData");
      this.jdField_f_of_type_JavaLangString = paramazsa.a("i_actionData");
      this.b = paramazsa.a("url");
      this.jdField_g_of_type_JavaLangString = paramazsa.a("brief");
      this.q = paramazsa.a("apurl");
      Object localObject1 = paramazsa.a("flag");
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {}
      try
      {
        this.jdField_i_of_type_Int = Integer.parseInt((String)localObject1);
        localObject1 = paramazsa.a("mode");
        if (TextUtils.isEmpty((CharSequence)localObject1)) {}
      }
      catch (NumberFormatException localNumberFormatException8)
      {
        ...
        catch (NumberFormatException localNumberFormatException8)
        {
          try
          {
            ...
            {
              this.jdField_h_of_type_JavaLangString = paramazsa.a("businessData");
              this.jdField_i_of_type_JavaLangString = paramazsa.a("commonData");
              this.j = paramazsa.a("index");
              this.jdField_k_of_type_JavaLangString = paramazsa.a("index_name");
              this.jdField_l_of_type_JavaLangString = paramazsa.a("index_type");
              this.o = paramazsa.a("canvas");
              this.jdField_m_of_type_JavaLangString = paramazsa.a("rurl");
              this.p = paramazsa.a("disType");
              this.jdField_n_of_type_JavaLangString = paramazsa.a("tid");
              if (this.jdField_a_of_type_Int > 10)
              {
                localObject1 = paramazsa.a;
                if (localObject1 != null)
                {
                  localObject3 = ((azsa)localObject1).a("action_type");
          ...
          catch (IllegalArgumentException localNumberFormatException8)
          {
            try
            {
              ...
              localObject3 = ((azsa)localObject1).a("dest_type");
              if (TextUtils.isEmpty((CharSequence)localObject3)) {}
            }
            catch (NumberFormatException localNumberFormatException8)
            {
              try
              {
                ...
                localObject3 = ((azsa)localObject1).a("product_type");
                if (TextUtils.isEmpty((CharSequence)localObject3)) {}
              }
              catch (NumberFormatException localNumberFormatException8)
              {
                try
                {
                  ...
                  this.r = ((azsa)localObject1).a("advertiser_id");
                  this.s = ((azsa)localObject1).a("aid");
                  this.t = ((azsa)localObject1).a("app_download_schema");
                  this.u = ((azsa)localObject1).a("canvas_json");
                  this.v = ((azsa)localObject1).a("customized_invoke_url");
                  this.w = ((azsa)localObject1).a("effect_url");
                  this.x = ((azsa)localObject1).a("landing_page");
                  this.y = ((azsa)localObject1).a("landing_page_report_url");
                  this.z = ((azsa)localObject1).a("noco_id");
                  this.A = ((azsa)localObject1).a("product_id");
                  this.B = ((azsa)localObject1).a("rl");
                  this.C = ((azsa)localObject1).a("subordinate_product_id");
                  this.D = ((azsa)localObject1).a("traceid");
                  this.E = ((azsa)localObject1).a("via");
                  this.F = ((azsa)localObject1).a("video_url");
                  this.G = ((azsa)localObject1).a("appname");
                  this.H = ((azsa)localObject1).a("customized_invoke_url");
                  this.I = ((azsa)localObject1).a("pkg_name");
                  this.J = ((azsa)localObject1).a("pkgurl");
                  this.q = ((azsa)localObject1).a("apurl");
                  if (this.jdField_a_of_type_Int > 11)
                  {
                    localObject1 = paramazsa.a;
                    if (localObject1 != null)
                    {
                      this.K = ((azsa)localObject1).a("api_click_monitor_url");
                      this.L = ((azsa)localObject1).a("api_exposure_monitor_url");
                      this.M = ((azsa)localObject1).a("trace_info_aid");
                    }
                  }
                  if (this.jdField_a_of_type_Int > 12)
                  {
                    ...
                    if (localObject1 != null)
                    {
                      this.N = ((azsa)localObject1).a("corporate_image_name");
                      this.O = ((azsa)localObject1).a("corporate_logo");
                    }
                  }
                  if (this.jdField_a_of_type_Int > 13)
                  {
                    localObject1 = paramazsa.a.a("mini_program_type");
                    if (TextUtils.isEmpty((CharSequence)localObject1)) {}
                  }
                }
                catch (NumberFormatException localNumberFormatException8)
                {
                  try
                  {
                    ...
                    if (this.jdField_a_of_type_Int > 14)
                    {
                      ...
                      if (localObject1 != null)
                      {
                        localObject3 = ((azsa)localObject1).a("tab_id");
                  ...
                  catch (NumberFormatException localNumberFormatException8)
                  {
                    try
                    {
                      ...
                      localObject1 = ((azsa)localObject1).a("is_hidden");
                    ...
                    catch (NumberFormatException localNumberFormatException8)
                    {
                      ...
                      catch (NumberFormatException localNumberFormatException4)
                      {
                        ...
                        for (Object localObject2 = localNumberFormatException8.a("layout");; localObject2 = azqt.a(localNumberFormatException8.b))
                        {
                          try
                          {
                            ...
                            {
                              localObject2 = azqt.a(j);
                              bool1 = bool2;
                              if (localObject2 == null) {
                                break;
                              }
                              bool1 = bool2;
                              if (!((azqj)localObject2).a(localNumberFormatException8)) {
                                break;
                              }
                              a((azqj)localObject2);
                              break label857;
  ...
  public void b(View paramView)
  {
    if (!TextUtils.isEmpty(this.b))
    {
      ...
      default: 
        ...
        localObject = paramView.findViewById(2131368083);
    ...
    do
    {
      ...
      paramView.setBackgroundResource(2130838186);
      break;
      paramView = paramView.findViewById(2131377074);
  ...
  public void c(View paramView)
  {
    ...
    for (;;)
    {
      ...
      continue;
      paramView.setBackgroundResource(2130838199);
      continue;
      paramView.setBackgroundResource(2130838202);
    }
  }
  ...
  protected void d(View paramView)
  {
    ...
    do
    {
      do
      {
        ...
        if (!TextUtils.isEmpty(this.b))
        {
          this.jdField_m_of_type_Int = 2130838190;
          break;
        }
        this.jdField_m_of_type_Int = 2130838204;
        break;
        if (!TextUtils.isEmpty(this.b))
        {
      ...
      int i = aekt.a(4.0F, paramView.getResources());
      float f1 = i;
      float f2 = i;
      float f3 = i;
      float f4 = i;
      localStateListDrawable = azsd.a(paramView.getResources(), this.jdField_l_of_type_Int, new float[] { f1, f2, f3, f4, 0.0F, 0.0F, 0.0F, 0.0F });
