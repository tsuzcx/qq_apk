...
public class quv
  extends qup
{
  public quv(Context paramContext, aobu paramaobu, snh paramsnh)
  {
  ...
  public qqt a()
  {
    ...
    return d(this.jdField_a_of_type_Snh, this.jdField_a_of_type_Aobu).q().g().l().j().n();
  }
  ...
  public qqt d()
  {
    ...
    if ((this.jdField_a_of_type_Qqs != null) && ((this.jdField_a_of_type_Qqs instanceof ComponentContentBigImageVideo)))
    {
      ...
      ((ComponentContentBigImageVideo)this.jdField_a_of_type_Qqs).setOnClickListener(new quw(this));
