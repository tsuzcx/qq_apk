  ...
  implements qus
{
  ...
  private Map<String, qux> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  private int a(qux paramqux, String paramString1, String paramString2)
  {
    try
    {
      Object localObject = (String)bnrf.a(jdField_b_of_type_JavaLangString, "");
  ...
  public static long a(int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        if (pbd.b(paramInt))
        {
          Object localObject = pag.a(String.valueOf(paramInt));
          if (localObject == null) {
            break label232;
          }
          l1 = ((pag)localObject).a(false);
          localObject = (String)bnrf.a(c, "");
          if (TextUtils.isEmpty((CharSequence)localObject))
          {
  ...
  private qux a(BaseArticleInfo paramBaseArticleInfo)
  {
  ...
  private qux a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      paramString2 = (qux)this.jdField_a_of_type_JavaUtilMap.get(str);
      paramString1 = paramString2;
    } while (paramString2 != null);
    paramString1 = new qux(this);
    this.jdField_a_of_type_JavaUtilMap.put(str, paramString1);
    return paramString1;
  }
  
  private qux a(oidb_cmd0x68b.BackOffGroupInfo paramBackOffGroupInfo, String paramString1, String paramString2)
  {
    int j = 0;
  ...
  public static void a(int paramInt)
  {
    ...
    if ((paramInt == 0) || (pbd.b(paramInt)))
    {
      ...
      pag localpag2 = pag.a(String.valueOf(paramInt));
      pag localpag1 = localpag2;
      if (localpag2 == null)
      {
        localpag1 = new pag();
        pag.a(String.valueOf(paramInt), localpag1);
      }
  ...
  private void a(List<ArticleInfo> paramList, qux paramqux, quz paramquz)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      ArticleInfo localArticleInfo = (ArticleInfo)paramList.next();
      if (paramqux.jdField_a_of_type_JavaLangString.equals(c(localArticleInfo))) {
        paramquz.jdField_a_of_type_JavaUtilHashMap.put(localArticleInfo.innerUniqueID, new quw(this, localArticleInfo.innerUniqueID));
      }
      if ((localArticleInfo.mSubArtilceList != null) && (localArticleInfo.mSubArtilceList.size() > 0)) {
        a(localArticleInfo.mSubArtilceList, paramqux, paramquz);
      }
    }
  }
  
  private void a(qux paramqux, String paramString1, String paramString2)
  {
    try
    {
      Object localObject = (String)bnrf.a(jdField_b_of_type_JavaLangString, "");
      ...
      for (;;)
      {
        ...
        bnrf.a(jdField_b_of_type_JavaLangString, ((JSONObject)localObject).toString());
        return;
        localObject = new JSONObject((String)localObject);
        break;
      }
    }
    catch (JSONException paramqux)
    {
      paramqux.printStackTrace();
      return;
    }
  }
  
  private void a(quy paramquy)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramquy.jdField_a_of_type_JavaUtilList.size() > 0)
    {
      Iterator localIterator = paramquy.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        Object localObject = (oidb_cmd0x68b.BackOffGroupInfo)localIterator.next();
        String str = qfm.a(((oidb_cmd0x68b.BackOffGroupInfo)localObject).bytes_back_off_group);
        if (!TextUtils.isEmpty(str))
        {
          localObject = a((oidb_cmd0x68b.BackOffGroupInfo)localObject, String.valueOf(paramquy.jdField_a_of_type_Int), str);
          if ((localObject != null) && (paramquy.b != null) && (!localArrayList.contains(str)))
          {
            quz localquz = new quz(this);
            a(paramquy.b, (qux)localObject, localquz);
            ((qux)localObject).a(localquz);
  ...
  public static void a(oidb_cmd0x68b.ReqChannelPara paramReqChannelPara, String paramString)
  {
    try
    {
      Object localObject = (String)bnrf.a(jdField_a_of_type_JavaLangString, "");
      ...
      for (;;)
      {
        ...
        bnrf.a(jdField_a_of_type_JavaLangString, ((JSONObject)localObject).toString());
  ...
  {
    return qfm.a(paramBaseArticleInfo.weishiUGInfo.bytes_back_off_group, "");
  }
  ...
  public static void b(int paramInt)
  {
    if ((paramInt == 0) || (pbd.b(paramInt)))
    {
      pag localpag = pag.a(String.valueOf(paramInt));
      if ((localpag != null) && (localpag.a()))
      {
        c(paramInt);
        localpag.b();
        localpag.c();
        ...
        if (localObject != null)
        {
          ...
          if (TextUtils.isEmpty((CharSequence)localObject))
          {
            ...
            if (!str2.equals(str1))
            {
              ...
              bnrf.a(c, ((JSONObject)localObject).toString());
            }
          }
          else
          {
  ...
  public static boolean e(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (paramBaseArticleInfo.bytes_jump_bundle.has())
    {
      ...
      bool = bhny.a(BaseApplicationImpl.getApplication(), paramBaseArticleInfo);
  ...
  public void a(BaseArticleInfo paramBaseArticleInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (j != 0)
    {
      ...
      tyd.a(paramBaseArticleInfo, i);
    }
  }
  
  public void a(Object paramObject)
  {
    if (!(paramObject instanceof quy)) {
      return;
    }
  ...
  public boolean a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    localObject1 = ((qux)localObject1).jdField_a_of_type_JavaUtilDeque.iterator();
    while (((Iterator)localObject1).hasNext())
    {
      Object localObject2 = (quz)((Iterator)localObject1).next();
      if (((quz)localObject2).jdField_a_of_type_JavaUtilHashMap.containsKey(paramBaseArticleInfo))
      {
        localObject2 = (quw)((quz)localObject2).jdField_a_of_type_JavaUtilHashMap.get(paramBaseArticleInfo);
        if ((localObject2 != null) && (((quw)localObject2).jdField_a_of_type_Int != 0))
        {
          ((quw)localObject2).jdField_a_of_type_Int -= 1;
          return true;
        }
      }
    }
  ...
  {
    qux localqux = a(paramBaseArticleInfo);
    if (localqux == null) {
      return false;
    }
    Object localObject = a(paramBaseArticleInfo);
    String str = b(paramBaseArticleInfo);
    if (qfm.a(paramBaseArticleInfo.weishiUGInfo.uint32_residence_threshold, 0) > a((int)paramBaseArticleInfo.mChannelID))
    {
      QLog.d("UGRuleManager", 1, "judgeHitRule is not reach minTime");
      jdField_a_of_type_Int = 110;
      return false;
    }
    localqux.c = a(localqux, str, String.valueOf(paramBaseArticleInfo.mChannelID));
    QLog.d("UGRuleManager", 1, "judgeHitRule backOffGroup.clickTime is " + localqux.c + " backOffGroup.maxEvokeCount is " + localqux.jdField_a_of_type_Int + " groupid is " + localqux.jdField_a_of_type_JavaLangString);
    if (localqux.c >= localqux.jdField_a_of_type_Int)
    {
      QLog.d("UGRuleManager", 1, "judgeHitRule over groupClick");
      return false;
    }
    Iterator localIterator = localqux.jdField_a_of_type_JavaUtilDeque.iterator();
    while (localIterator.hasNext())
    {
      quz localquz = (quz)localIterator.next();
      if (localquz.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject))
      {
        QLog.d("UGRuleManager", 1, "judgeHitRule freshInfo.clickTime is " + localquz.jdField_a_of_type_Int + " backOffGroup.maxFreshEvokeCount is " + localqux.jdField_b_of_type_Int);
        if (localquz.jdField_a_of_type_Int < localqux.jdField_b_of_type_Int)
        {
          if (!TextUtils.isEmpty(a(paramBaseArticleInfo, null, null)))
          {
            localObject = (quw)localquz.jdField_a_of_type_JavaUtilHashMap.get(paramBaseArticleInfo.innerUniqueID);
            if (localObject != null) {
              ((quw)localObject).jdField_a_of_type_Int += 1;
            }
            localquz.jdField_a_of_type_Int += 1;
            a(localqux, str, String.valueOf(paramBaseArticleInfo.mChannelID));
          }
          return true;
        }
      }
