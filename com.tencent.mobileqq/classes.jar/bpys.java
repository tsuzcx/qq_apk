  ...
  extends bpyt
{
  ...
  private void d()
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("RMRecordState", 2, "[@] [startRecordVideo]Lock.CAPTURE_LOCK=" + bqhu.jdField_a_of_type_Boolean);
    }
    if (!bqhu.jdField_a_of_type_Boolean) {}
    synchronized (bqhu.jdField_a_of_type_JavaLangObject)
    {
      bqhu.jdField_a_of_type_Boolean = true;
      bqhu.jdField_a_of_type_JavaLangObject.notifyAll();
      if (QLog.isColorLevel()) {
        QLog.d("RMRecordState", 2, "[@] [startRecordVideo]Lock.CAPTURE_LOCK=" + bqhu.jdField_a_of_type_Boolean);
      }
  ...
  {
    RMVideoStateMgr localRMVideoStateMgr = RMVideoStateMgr.a();
    localRMVideoStateMgr.jdField_a_of_type_Bpyz.b();
  ...
  public void a(bqgz parambqgz, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    parambqgz = RMVideoStateMgr.a();
    if (parambqgz.jdField_a_of_type_Boolean) {}
    for (parambqgz.jdField_a_of_type_Double = (System.currentTimeMillis() - parambqgz.jdField_a_of_type_Long);; parambqgz.jdField_a_of_type_Double = paramInt1)
    {
      if (!this.jdField_a_of_type_Boolean)
      {
        this.jdField_a_of_type_Boolean = paramBoolean;
        if ((parambqgz.d()) && (!parambqgz.jdField_a_of_type_DovComTencentMobileqqShortvideoMediadeviceAudioCapture.e) && (!parambqgz.f)) {
          parambqgz.jdField_a_of_type_AndroidOsHandler.post(new RMVideoRecordState.2(this));
        }
        if (QLog.isColorLevel()) {
          QLog.d("RMRecordState", 2, "[@] timeExpire: mIsRecordOver=" + this.jdField_a_of_type_Boolean + " mStateMgr.mTotalTime=" + parambqgz.jdField_a_of_type_Double);
        }
        parambqgz.jdField_a_of_type_Bpyz.a((int)(parambqgz.jdField_a_of_type_Double + bqhw.a().a().a()), this.jdField_a_of_type_Boolean);
        if (this.jdField_a_of_type_Boolean) {
          parambqgz.jdField_a_of_type_AndroidOsHandler.post(new RMVideoRecordState.3(this));
        }
      }
      return;
    }
  ...
  public void c()
  {
    RMVideoStateMgr localRMVideoStateMgr = RMVideoStateMgr.a();
    if (QLog.isColorLevel()) {
      QLog.d("RMRecordState", 2, "[@] [stopRecordVideo]Lock.CAPTURE_LOCK = " + bqhu.jdField_a_of_type_Boolean);
    }
    if (bqhu.jdField_a_of_type_Boolean)
    {
      bqhu.jdField_a_of_type_Boolean = false;
      ...
      localRMVideoStateMgr.jdField_a_of_type_Bpyz.f();
      ...
      {
        if (localRMVideoStateMgr.jdField_a_of_type_Bqim != null) {
          localRMVideoStateMgr.b = localRMVideoStateMgr.jdField_a_of_type_Bqim.a(localRMVideoStateMgr);
        }
      ...
      long l2 = localRMVideoStateMgr.jdField_a_of_type_Bpyz.a();
      if (QLog.isColorLevel()) {
      ...
      {
        localRMVideoStateMgr.jdField_a_of_type_Bpyz.a(true);
        localRMVideoStateMgr.a(true);
      }
      if (QLog.isColorLevel()) {
        QLog.d("RMRecordState", 2, "[@] stopRecordVideo end Lock.CAPTURE_LOCK = " + bqhu.jdField_a_of_type_Boolean);
      }
    }
  }
