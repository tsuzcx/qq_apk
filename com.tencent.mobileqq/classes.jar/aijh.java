  ...
  implements View.OnClickListener, bdbc
{
  ...
  private aijj jdField_a_of_type_Aijj = new aijj();
  aijo jdField_a_of_type_Aijo;
  protected ajjp a;
  ...
  public aijh(QQAppInterface paramQQAppInterface, Context paramContext, XListView paramXListView, aijo paramaijo)
  {
    ...
    this.jdField_a_of_type_Aijo = paramaijo;
  }
  
  protected View a()
  {
    return View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131559327, null);
  }
  ...
  public void a(View paramView, RecentBaseData paramRecentBaseData, Drawable paramDrawable)
  {
    ...
    do
    {
      ...
      if (paramDrawable == null)
      {
        localDrawable = paramDrawable;
        if (this.jdField_a_of_type_Ajjp != null) {
          localDrawable = this.jdField_a_of_type_Ajjp.a(paramRecentBaseData.a(), paramRecentBaseData.a());
        }
      }
    } while (this.jdField_a_of_type_Aijj == null);
    this.jdField_a_of_type_Aijj.a(paramView, paramRecentBaseData, this.jdField_a_of_type_AndroidContentContext, localDrawable);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    try
    {
      ...
      if ((localObject instanceof RecentBaseData))
      {
        ...
        {
          paramView = this.jdField_a_of_type_Aijj.a(paramInt, localObject, this.jdField_a_of_type_Ajjp, paramView, paramViewGroup, this.jdField_a_of_type_AndroidContentContext, this, null, null);
          return paramView;
        }
      }
    }
    ...
    {
      ajkl.a(this.jdField_a_of_type_AndroidContentContext, false, paramView);
  ...
  public void onClick(View paramView)
  {
    ...
    } while (this.jdField_a_of_type_Aijo == null);
    this.jdField_a_of_type_Aijo.a(paramView);
    paramView.b();
  }
  ...
  public void onDecodeTaskCompleted(int paramInt1, int paramInt2, String paramString, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      if (paramInt1 < paramInt2)
      {
        ...
        i = ((Integer)ajjp.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, i, paramString).first).intValue();
        if (i == -2147483648) {
          break label667;
        }
