...
public class yia
{
  ...
  public yia(String paramString1, int paramInt, @Nullable String paramString2)
  {
  ...
  public yia(String paramString1, int paramInt1, @Nullable String paramString2, int paramInt2)
  {
    this.jdField_b_of_type_Int = -1;
    this.jdField_a_of_type_JavaLangString = paramString1;
    this.jdField_b_of_type_JavaLangString = paramString2;
