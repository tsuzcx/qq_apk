  ...
  implements Animatable
{
  ...
  Property<bqwt, Integer> jdField_a_of_type_AndroidUtilProperty = new bqwu(this, Integer.class, "bfIndex");
  private String jdField_a_of_type_JavaLangString;
  private WeakReference<bqwz> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  Property<bqwt, Integer> jdField_b_of_type_AndroidUtilProperty = new bqwv(this, Integer.class, "textAlpha");
  ...
  Property<bqwt, Float> jdField_c_of_type_AndroidUtilProperty = new bqww(this, Float.class, "textPos");
  ...
  private void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_AndroidAnimationValueAnimator != null)
      {
        ...
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new bqwx(this));
        this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new bqwy(this));
  ...
  private void b(Context paramContext)
  {
    ...
    this.jdField_a_of_type_JavaUtilMap.put("1/2", paramContext.getResources().getDrawable(2130841496));
    this.jdField_a_of_type_JavaUtilMap.put("1/4", paramContext.getResources().getDrawable(2130841497));
    this.jdField_a_of_type_JavaUtilMap.put("1x", paramContext.getResources().getDrawable(2130841498));
    this.jdField_a_of_type_JavaUtilMap.put("2x", paramContext.getResources().getDrawable(2130841499));
    this.jdField_a_of_type_JavaUtilMap.put("4x", paramContext.getResources().getDrawable(2130841500));
    this.jdField_a_of_type_JavaUtilMap.put(PickerContainer.jdField_a_of_type_JavaLangString, paramContext.getResources().getDrawable(2130841523));
    this.jdField_b_of_type_JavaUtilMap.put("1/2", paramContext.getResources().getDrawable(2130841540));
    this.jdField_b_of_type_JavaUtilMap.put("1/4", paramContext.getResources().getDrawable(2130841541));
    this.jdField_b_of_type_JavaUtilMap.put("1x", paramContext.getResources().getDrawable(2130841542));
    this.jdField_b_of_type_JavaUtilMap.put("2x", paramContext.getResources().getDrawable(2130841543));
    this.jdField_b_of_type_JavaUtilMap.put("4x", paramContext.getResources().getDrawable(2130841544));
    this.jdField_b_of_type_JavaUtilMap.put(PickerContainer.jdField_a_of_type_JavaLangString, paramContext.getResources().getDrawable(2130841545));
  }
  ...
  private void c(int paramInt)
  {
    ...
    do
    {
      ...
      localbqwz = (bqwz)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localbqwz == null);
    localbqwz.a(this.jdField_c_of_type_Int, this.jdField_a_of_type_Int, this.jdField_a_of_type_AndroidGraphicsDrawableAnimationDrawable.getNumberOfFrames());
  }
  ...
  public boolean a(Context paramContext, int paramInt1, int paramInt2, int paramInt3, bqwz parambqwz)
  {
    b();
    a(paramContext);
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambqwz);
    b(paramContext);
