...
public class abyw
  implements apsy, AdArkAdapter
{
  private View jdField_a_of_type_AndroidViewView;
  private AdArkAdapter.ArkNotifyCallback jdField_a_of_type_ComTencentAdTangramArkAdArkAdapter$ArkNotifyCallback;
  
  private agnx a(ArkAppView paramArkAppView, QQCustomArkDialog.AppInfo paramAppInfo)
  {
    agnx localagnx = new agnx();
    paramAppInfo.container = localagnx;
    int i = paramArkAppView.getWidth();
    int j = paramArkAppView.getHeight();
    localagnx.a(paramAppInfo.appName, paramAppInfo.appView, paramAppInfo.appMinVersion, paramAppInfo.metaData, paramAppInfo.scale, paramAppInfo.session);
  ...
  public View buildArkView(AdArkAdapter.Params paramParams)
  {
    if ((paramParams != null) && (paramParams.isValid()))
    {
      ...
      localArkAppView.setCallback(new abyx(this, localCallback));
      ...
      if ((paramParams.context.get() instanceof Activity))
      {
        ...
        if (localFrameLayout != null)
        {
          ...
          if (this.jdField_a_of_type_AndroidViewView != null) {
            this.jdField_a_of_type_AndroidViewView.getViewTreeObserver().addOnGlobalLayoutListener(new abyy(this, localCallback));
          }
        }
      }
      localArkAppView.setInputCallback(new abyz(this, localCallback));
  ...
  public String getArkFormData(AdArkAdapter.DataParams paramDataParams)
  {
    ...
    try
    {
      ...
      localObject1 = localObject3;
      localObject4 = achn.a((PBField)localObject4);
