...
{
  public aanx(ARLocalFaceRecog paramARLocalFaceRecog) {}
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 1: 
      ...
      if ((localObject2 != null) && (localObject2.length > 0) && (!this.a.jdField_c_of_type_Boolean))
      {
        ...
        paramMessage = Message.obtain(this.a.jdField_b_of_type_AndroidOsHandler, new aany(this, j, (float[][])localObject3, (float[][])localObject4, paramMessage));
        paramMessage.what = 1;
        i = j;
