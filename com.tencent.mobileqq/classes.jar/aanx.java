...
public class aanx
  implements bfxi
{
  private anwx jdField_a_of_type_Anwx;
  private BaseChatPie jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie;
  
  public aanx(BaseChatPie paramBaseChatPie)
  {
  ...
  public boolean a(String paramString, Bundle paramBundle)
  {
    ...
    int i;
    if ((!TextUtils.isEmpty(paramString)) && (paramBundle != null) && (bfni.a((Context)localObject1)))
    {
      ...
      if (!TextUtils.isEmpty(paramString)) {
        aanz.a((QQAppInterface)localObject2, (Context)localObject1, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, paramString, i);
      }
    }
    label180:
    label194:
    do
    {
      do
      {
        ...
        if ("com.sogou.inputmethod.appid".equals(paramString))
        {
          ...
          paramString = bdfb.a(((QQAppInterface)localObject2).getApp(), str, (String)localObject3);
          if (QLog.isColorLevel()) {
          ...
          if (this.jdField_a_of_type_Anwx == null) {
            this.jdField_a_of_type_Anwx = new anwx(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie);
          }
          this.jdField_a_of_type_Anwx.a(paramString);
          return true;
        }
        if (("com.sogou.inputmethod.qqexp".equals(paramString)) || ("com.tencent.qqpinyin.qqexp".equals(paramString)))
        {
          ...
          this.jdField_a_of_type_Anwx.a(i, paramString);
          return true;
        }
      ...
      if ((i == ((QQRecorder.RecorderParam)localObject3).a) && (!bbkk.a(paramString))) {
        break label644;
      }
