...
public class amns
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = ajyc.a(2131702394);
  }
  ...
  public static im_msg_body.Elem a(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      localC2CConfessContext.uint64_confessor_uin.set(Long.parseLong(((amnp)localObject2).jdField_c_of_type_JavaLangString));
      localC2CConfessContext.uint64_confess_to_uin.set(Long.parseLong(((amnp)localObject2).jdField_b_of_type_JavaLangString));
      localC2CConfessContext.uint64_send_uin.set(Long.parseLong(paramMessageRecord.senderuin));
      localC2CConfessContext.bytes_confess.set(ByteStringMicro.copyFromUtf8(((amnp)localObject2).jdField_d_of_type_JavaLangString));
      localC2CConfessContext.bytes_confessor_nick.set(ByteStringMicro.copyFromUtf8(((amnp)localObject2).jdField_e_of_type_JavaLangString));
      localC2CConfessContext.uint64_confess_time.set(((amnp)localObject2).jdField_a_of_type_Long);
      localC2CConfessContext.uint32_bg_type.set(((amnp)localObject2).jdField_b_of_type_Int);
      localC2CConfessContext.uint32_topic_id.set(((amnp)localObject2).jdField_a_of_type_Int);
      localC2CConfessContext.uint32_confessor_sex.set(((amnp)localObject2).jdField_c_of_type_Int);
      localC2CConfessContext.uint32_confess_num.set(((amnp)localObject2).jdField_d_of_type_Int);
      localC2CConfessContext.uint32_biz_type.set(((amnp)localObject2).f);
      localC2CConfessContext.uint32_confess_to_sex.set(((amnp)localObject2).jdField_e_of_type_Int);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    if ((paramQQAppInterface != null) && (amnk.a(paramQQAppInterface, "redpoint_leba_show"))) {
      amnk.a(paramQQAppInterface, "redpoint_leba_show", 0L);
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, String paramString1, int paramInt2, String paramString2)
  {
    ...
    paramQQAppInterface = (amno)paramQQAppInterface.getManager(269);
    ...
    {
      paramString1 = String.format("&topicId=%d&fromEncodeUin=%s&fromGender=%d&toUin=%s", new Object[] { Integer.valueOf(paramInt1), atbn.a(paramString1), Integer.valueOf(paramInt2), atbn.a(paramString2) });
  ...
  public static void a(QQAppInterface paramQQAppInterface, RecentItemConfessMsg paramRecentItemConfessMsg, boolean paramBoolean)
  {
    ...
    {
      return;
      if ((paramRecentItemConfessMsg.mType == 1032) && (TextUtils.equals(paramRecentItemConfessMsg.mUin, ajsf.aN))) {
      ...
      while (QLog.isDevelopLevel())
      {
        ...
        if (paramBoolean) {
          paramQQAppInterface.a().a(ajsf.aM, 1032, paramRecentItemConfessMsg.a(), paramQQAppInterface.getCurrentAccountUin(), paramRecentItemConfessMsg.mType, paramRecentItemConfessMsg.mConfessInfo.topicId);
        }
        if (i > 0) {
  ...
  {
    if ((paramInt2 <= 0) || (akpy.a(paramInt1) != 1032)) {
      if (QLog.isColorLevel()) {
    ...
    {
      return;
      localConfessInfo = ((amno)paramQQAppInterface.getManager(269)).a().a(paramString, paramInt1, paramInt2);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, int paramInt2, ConfessInfo paramConfessInfo)
  {
    ...
    Object localObject1 = ((amno)paramQQAppInterface.getManager(269)).b();
    int i;
    long l;
    if (localObject1 == null)
    {
      i = 24;
      Object localObject2 = String.format(amnk.jdField_d_of_type_JavaLangString, new Object[] { Integer.valueOf(i) });
      localObject1 = ajyc.a(2131702392);
      i = ((String)localObject2).indexOf((String)localObject1);
      int j = ((String)localObject1).length();
      localObject1 = new aquz(paramString, paramString, (String)localObject2, paramInt1, -5020, 655369, awzw.a());
      ((aquz)localObject1).jdField_c_of_type_JavaLangString = ((String)localObject2);
      localObject2 = new Bundle();
      ((Bundle)localObject2).putInt("key_action", 31);
      ((aquz)localObject1).a(i, j + i, (Bundle)localObject2);
      ...
      paramString.initGrayTipMsg(paramQQAppInterface, (aquz)localObject1);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    aquz localaquz = new aquz(paramString1, paramString1, paramString2, paramInt1, -5040, 655377, awzw.a());
    localaquz.jdField_c_of_type_JavaLangString = paramString2;
    String str = ajyc.a(2131702389);
    int i = paramString2.indexOf(str);
    int j = str.length();
    paramString2 = new Bundle();
    paramString2.putInt("key_action", 34);
    localaquz.a(i, j + i, paramString2);
    ...
    if ((paramString1 != null) && (!paramString1.isEmpty()))
    {
      ...
      paramString1.initGrayTipMsg(paramQQAppInterface, localaquz);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, int paramInt2, ConfessInfo paramConfessInfo)
  {
    if (QLog.isColorLevel())
    {
      localObject = bbbd.a(paramString2);
      if (paramConfessInfo != null) {
        break label75;
      }
    }
    ...
    Object localObject = new aquz(paramString1, paramString1, paramString2, paramInt1, -5020, 655376, awzw.a());
    ((aquz)localObject).jdField_c_of_type_JavaLangString = paramString2;
    paramString1 = paramQQAppInterface.a().a(paramString1, paramInt1);
    long l;
    if ((paramString1 != null) && (!paramString1.isEmpty()))
    {
      l = ((ChatMessage)paramString1.get(paramString1.size() - 1)).shmsgseq;
      paramString1 = new MessageForUniteGrayTip();
      paramString1.initGrayTipMsg(paramQQAppInterface, (aquz)localObject);
      paramString1.isread = true;
      paramString1.shmsgseq = l;
      paramString1.mNeedTimeStamp = true;
      paramString1.updateUniteGrayTipMsgData(paramQQAppInterface);
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<MessageRecord> paramList)
  {
    ...
    if (localIterator.hasNext())
    {
      ...
      if ((localMessageRecord.isSend()) || (akpy.a(localMessageRecord.istroop) != 1032) || (!a(localMessageRecord))) {
        break label429;
      }
      ...
      if (((MessageRecord)((List)localObject2).get(j)).getConfessTopicId() == localMessageRecord.getConfessTopicId())
      {
        ...
        if (i == 0)
        {
          ...
          {
            localObject2 = axaq.a(paramQQAppInterface, paramQQAppInterface.c(), localMessageRecord.senderuin, null, localMessageRecord.istroop, (byte)0, (byte)0, (short)0, (String)localObject1);
  ...
  {
    amnk.a(paramQQAppInterface, "redpoint_box_show", 0L);
    amnk.a(paramQQAppInterface, "redpoint_clear_time", awzw.a());
  }
  ...
  {
    if ((paramMessageRecord != null) && (paramMessageRecord.istroop == 1032) && (ajsf.aM.equals(paramMessageRecord.frienduin)))
    {
      if (QLog.isColorLevel()) {
  ...
  public static void a(msg_comm.Msg paramMsg, im_msg_body.Elem paramElem, List<MessageRecord> paramList, QQAppInterface paramQQAppInterface)
  {
      ...
      do
      {
        do
        {
          ...
          for (;;)
          {
            ...
            paramList = (amno)paramQQAppInterface.getManager(269);
            if (paramList.a(paramElem, (String)localObject3, str1, i) != 1) {
              break;
            }
            localObject1 = new amnp();
            ((amnp)localObject1).jdField_a_of_type_Int = i;
            ((amnp)localObject1).jdField_b_of_type_Int = ((hummer_commelem.MsgElemInfo_servtype21.C2CConfessContext)localObject2).uint32_bg_type.get();
            ((amnp)localObject1).jdField_b_of_type_JavaLangString = ((String)localObject3);
            ((amnp)localObject1).jdField_c_of_type_JavaLangString = str1;
            ((amnp)localObject1).jdField_d_of_type_JavaLangString = ((hummer_commelem.MsgElemInfo_servtype21.C2CConfessContext)localObject2).bytes_confess.get().toStringUtf8();
            ((amnp)localObject1).jdField_e_of_type_JavaLangString = ((hummer_commelem.MsgElemInfo_servtype21.C2CConfessContext)localObject2).bytes_confessor_nick.get().toStringUtf8();
            ((amnp)localObject1).jdField_a_of_type_JavaLangString = paramQQAppInterface.getCurrentNickname();
            ...
            ((amnp)localObject1).jdField_c_of_type_Int = i;
            ...
            ((amnp)localObject1).jdField_a_of_type_Long = l1;
            ...
            ((amnp)localObject1).jdField_d_of_type_Int = i;
            ...
            ((amnp)localObject1).jdField_e_of_type_Int = i;
            l1 = ((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_time.get() - 1L;
            l2 = ((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_seq.get() - 1L;
            paramList.a(paramElem, (amnp)localObject1, l1, l2);
            if (!QLog.isColorLevel()) {
              break;
            }
            l3 = awzw.a();
            QLog.i("ConfessMsgUtil", 2, "decodeConfessMsgElem strConfessorDesc:" + ((amnp)localObject1).jdField_d_of_type_JavaLangString + " msgTime:" + l1 + " msgSeq:" + l2 + " nowTime" + l3);
            return;
    ...
    Object localObject1 = (amno)paramQQAppInterface.getManager(269);
    int k = ((amno)localObject1).a(paramElem, paramList, str1, str2, j);
    if ((i == 0) && (k == 1))
    {
      localObject2 = new amnq();
      ((amnq)localObject2).jdField_a_of_type_JavaLangString = paramElem;
      ((amnq)localObject2).jdField_a_of_type_Int = j;
      ((amnq)localObject2).jdField_b_of_type_Int = (j % 4);
      ((amnq)localObject2).jdField_d_of_type_JavaLangString = paramList;
      ((amnq)localObject2).jdField_e_of_type_JavaLangString = str2;
      ...
      label1784:
      ((amnq)localObject2).jdField_c_of_type_Int = i;
      ...
      if (TextUtils.isEmpty(paramList)) {
        if (((amnq)localObject2).jdField_c_of_type_Int == 1)
        {
          paramList = ajyc.a(2131702390);
          label1837:
          ((amnq)localObject2).g = paramList;
          label1843:
          ...
          label1866:
          ((amnq)localObject2).jdField_c_of_type_JavaLangString = paramList;
          ...
          label1893:
          ((amnq)localObject2).jdField_a_of_type_Long = l1;
    ...
    {
      ((amnq)localObject2).jdField_d_of_type_Int = i;
      ((amnq)localObject2).jdField_b_of_type_JavaLangString = str1;
      ...
      if ((l4 < l1 - 5L) && (l1 >= 0L))
      {
        ...
        ThreadManager.getSubThreadHandler().postDelayed(new ConfessMsgUtil.1((amno)localObject1, paramElem, (amnq)localObject2, l3, l4), 250L);
        return;
        paramList = ajyc.a(2131702393);
        break label1837;
        ((amnq)localObject2).g = paramList;
        break label1843;
      }
      ((amno)localObject1).a(paramElem, (amnq)localObject2, l3, l3, l4);
      if (!QLog.isColorLevel()) {
        break;
      }
      l1 = awzw.a();
      QLog.i("ConfessMsgUtil", 2, "decodeConfessMsgElem 2 strConfessorDesc:" + ((amnq)localObject2).f + " msgTime:" + l3 + " msgSeq:" + l4 + " nowTime" + l1);
      return;
      if ((!paramMsg.msg_head.has()) || (!((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_seq.has())) {
        break;
      }
      ((amno)localObject1).a(paramElem, paramList, str1, str2, j, ((msg_comm.MsgHead)paramMsg.msg_head.get()).msg_seq.get());
      return;
      i = 0;
      paramElem = "";
      break label1558;
  ...
  {
    if ((akpy.a(paramInt1) == 1032) || (akpy.a(paramInt3) == 1032)) {}
  ...
  public static im_msg_body.Elem b(MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      localGroupConfessContext.uint64_confessor_uin.set(Long.parseLong(((amnq)localObject2).jdField_e_of_type_JavaLangString));
      localGroupConfessContext.uint64_confess_to_uin.set(Long.parseLong(((amnq)localObject2).jdField_d_of_type_JavaLangString));
      localGroupConfessContext.uint64_send_uin.set(Long.parseLong(paramMessageRecord.senderuin));
      localGroupConfessContext.bytes_topic.set(ByteStringMicro.copyFromUtf8(((amnq)localObject2).f));
      localGroupConfessContext.bytes_confess_to_nick.set(ByteStringMicro.copyFromUtf8(((amnq)localObject2).jdField_c_of_type_JavaLangString));
      localGroupConfessContext.uint64_confess_time.set(((amnq)localObject2).jdField_a_of_type_Long);
      localGroupConfessContext.uint32_topic_id.set(((amnq)localObject2).jdField_a_of_type_Int);
      localGroupConfessContext.uint32_confessor_sex.set(((amnq)localObject2).jdField_c_of_type_Int);
      localGroupConfessContext.uint32_confess_to_nick_type.set(((amnq)localObject2).jdField_d_of_type_Int);
      localGroupConfessContext.bytes_confessor_nick.set(ByteStringMicro.copyFromUtf8(((amnq)localObject2).g));
  ...
  public static void b(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString)
  {
    ...
    do
    {
      ...
      amnq localamnq = paramQQAppInterface.a();
      if (localamnq != null)
      {
        paramMessageRecord.saveExtInfoToExtStr("ext_key_group_chat_confess_info", localamnq.a());
        paramQQAppInterface.a(paramString, localamnq.jdField_d_of_type_JavaLangString, localamnq.jdField_b_of_type_JavaLangString, localamnq.jdField_e_of_type_JavaLangString, localamnq.jdField_a_of_type_Int);
      }
    } while (!QLog.isColorLevel());
  ...
  public static void b(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    {
      return;
      localObject = (atxb)paramQQAppInterface.getManager(160);
      RedTouchItem localRedTouchItem = ((atxb)localObject).a(10018);
      if ((paramBoolean) && (localRedTouchItem != null)) {
        localRedTouchItem.extMsgs = null;
      }
      ((atxb)localObject).a(10018);
      localObject = ((amno)paramQQAppInterface.getManager(269)).a();
      if ((localObject != null) && (((amoa)localObject).jdField_a_of_type_Int > 0)) {
        break;
      }
    } while (!QLog.isDevelopLevel());
    ...
    boolean bool2;
    if (localObject != null) {
      if (((amoa)localObject).jdField_a_of_type_Int != 0)
      {
        bool1 = true;
        ((amoa)localObject).jdField_a_of_type_Int = 0;
        bool2 = bool1;
        if (paramBoolean)
        {
          bool2 = bool1 | ((amoa)localObject).a();
          ((amoa)localObject).jdField_a_of_type_JavaLangString = "";
          ((amoa)localObject).jdField_c_of_type_JavaLangString = "";
          ((amoa)localObject).jdField_b_of_type_JavaLangString = "";
          ((amoa)localObject).jdField_b_of_type_Int = 0;
        }
        ThreadManager.post(new ConfessMsgUtil.2((amoa)localObject), 8, null, false);
      }
    }
    for (;;)
    {
      if (bool2) {
        ((amnl)paramQQAppInterface.a(125)).a((amoa)localObject);
      }
