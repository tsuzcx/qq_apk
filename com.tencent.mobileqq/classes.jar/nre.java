...
public class nre
{
  ...
  protected nsj a;
  nyl jdField_a_of_type_Nyl = null;
  nyp jdField_a_of_type_Nyp = new nrg(this);
  ...
  public nre(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, AccountDetail paramAccountDetail, boolean paramBoolean)
  {
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_Anmu = new nru(this);
    this.jdField_a_of_type_AndroidOsHandler$Callback = new nsa(this);
    ...
    c();
    this.jdField_a_of_type_Nsj = new nsj(this, this);
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Nsj);
  ...
  private aarr a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail != null) {
      localaarr = new aarr(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.name, this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.summary);
    }
    return localaarr;
  }
  ...
  {
    if ((TextUtils.isEmpty(paramnyl.g)) || (TextUtils.isEmpty(paramnyl.f))) {
      return null;
    }
    ...
    a(localView, paramnyl.i);
    TextView localTextView = (TextView)localView.findViewById(2131378776);
    String str1 = paramnyl.jdField_a_of_type_JavaLangString;
    String str2 = paramnyl.jdField_b_of_type_JavaLangString;
    if (!TextUtils.isEmpty(str1))
    {
      localTextView.setText(str1);
      localView.setOnClickListener(new nrf(this, paramnyl, str2));
      return localView;
    }
    return null;
  }
  
  private View a(nyl paramnyl, int paramInt)
  {
    View localView = ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getLayoutInflater().inflate(2131559285, null);
    a(localView, paramnyl.i);
    ((TextView)localView.findViewById(2131378776)).setText(paramnyl.jdField_a_of_type_JavaLangString);
    ((TextView)localView.findViewById(2131364999)).setText(paramnyl.jdField_b_of_type_JavaLangString);
    localView.setOnClickListener(new nsh(this, paramInt, paramnyl));
    return localView;
  }
  ...
  private void a(long paramLong1, long paramLong2)
  {
    ...
    localObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication(), oaz.class);
  ...
  private void a(View paramView, String paramString)
  {
    ...
    paramView = (ImageView)paramView.findViewById(2131368826);
    paramView.setImageDrawable(URLDrawable.getDrawable(paramString));
    paramView.setVisibility(0);
  }
  
  private void a(ViewGroup paramViewGroup, List<nyl> paramList)
  {
    ...
    localPhotoWallViewForAccountDetail.setPhotoWallCallback(this.jdField_a_of_type_Nyp);
  ...
  {
    ReportDialog localReportDialog = new ReportDialog((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 2131755823);
    ...
    localTextView2.setOnClickListener(new nrw(this, localReportDialog));
    localTextView3.setOnClickListener(new nrx(this, paramString));
    try
    {
  ...
  private void a(nyl paramnyl)
  {
    if (this.jdField_a_of_type_AndroidWidgetTextView != null)
    {
      int i = paramnyl.jdField_d_of_type_Int;
      if ((i == 1) || (i == 2)) {
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    localObject = (bfrd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(132);
    Bundle localBundle = new Bundle();
    localBundle.putBoolean("mIsAbleBindTroop", this.d);
    localBundle.putStringArrayList("mBindedTroopUins", paramJSONObject);
    ((bfrd)localObject).a(this.jdField_a_of_type_JavaLangString, localBundle);
    d();
  }
    ...
    while ((i < 3) && (i + 1 <= k))
    {
      ...
      try
      {
        if (TextUtils.isEmpty(paramJSONArray.getString(i))) {
          localImageView.setImageResource(2130839551);
        }
        for (;;)
        {
  ...
  private boolean a(nyk paramnyk, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
      QLog.d("AccountDetailGroupListContainer", 2, "addPublicAccountGroup start");
    }
    Object localObject = paramnyk.jdField_a_of_type_JavaUtilList;
    if (localObject == null) {}
    ...
    do
    {
      return false;
      localViewGroup = a();
      if (paramnyk.jdField_a_of_type_Int != 1) {
        break;
      }
      localObject = paramnyk.jdField_a_of_type_JavaUtilList.iterator();
      while (((Iterator)localObject).hasNext())
      {
        nyl localnyl = (nyl)((Iterator)localObject).next();
        if (TextUtils.isEmpty(localnyl.jdField_e_of_type_JavaLangString)) {
          ((Iterator)localObject).remove();
        } else if ((localnyl.jdField_b_of_type_Int == 1) && (this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.followType != 1)) {
          ((Iterator)localObject).remove();
        }
      }
    } while (paramnyk.jdField_a_of_type_JavaUtilList.size() < 3);
    a(localViewGroup, paramnyk.jdField_a_of_type_JavaUtilList);
    ...
    {
      paramnyk = new View((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get());
      paramnyk.setLayoutParams(new LinearLayout.LayoutParams(-1, (int)(9.0F * this.jdField_a_of_type_Float)));
      paramnyk.setBackgroundColor(Color.parseColor("#f0f0f0"));
    ...
    if (paramInt2 < i)
    {
      ...
      for (;;)
      {
        a(localViewGroup, (nyl)((List)localObject).get(paramInt2), paramInt1);
        paramInt2 += 1;
        break;
        if (paramInt2 == i - 1)
        {
  ...
  private boolean a(nyl paramnyl)
  {
    if ((paramnyl.jdField_a_of_type_Int == 3) && ((paramnyl.jdField_c_of_type_Int == 3) || (paramnyl.jdField_c_of_type_Int == 16) || (paramnyl.jdField_c_of_type_Int == 21) || (paramnyl.jdField_c_of_type_Int == 13))) {}
    while ((paramnyl.jdField_e_of_type_Int == 5) || ((paramnyl.jdField_b_of_type_Int == 1) && (this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.followType != 1))) {
      return true;
    }
    return false;
  }
  ...
  private View b()
  {
    return ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getLayoutInflater().inflate(2131559071, null);
  }
  
  private View b(nyl paramnyl)
  {
    View localView = ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getLayoutInflater().inflate(2131559285, null);
    a(localView, paramnyl.i);
    String str = paramnyl.h;
    if (str != null)
    {
      str = str.trim();
    ...
    ((TextView)localView.findViewById(2131378776)).setText(paramnyl.jdField_a_of_type_JavaLangString);
    localView.setOnClickListener(new nrs(this, str, paramnyl));
    return localView;
  }
  ...
  private void b(String paramString)
  {
    ...
    localIntent.putExtra("big_brother_source_key", tzo.b(this.jdField_a_of_type_JavaLangString));
  ...
  private View c(nyl paramnyl)
  {
    View localView = ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getLayoutInflater().inflate(2131559071, null);
    ((TextView)localView.findViewById(2131364999)).setText(paramnyl.jdField_b_of_type_JavaLangString);
    ((TextView)localView.findViewById(2131378776)).setText(paramnyl.jdField_a_of_type_JavaLangString);
    return localView;
  }
  ...
  private void c(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt == 1)
      {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(2131693233);
        this.jdField_b_of_type_AndroidWidgetTextView.setText(2131693234);
        this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
        return;
      }
    } while (paramInt != 2);
    this.jdField_a_of_type_AndroidWidgetTextView.setText(2131693230);
    this.jdField_b_of_type_AndroidWidgetTextView.setText(2131693235);
    this.jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
  }
  ...
  private void c(String paramString)
  {
    ...
    for (;;)
    {
      oat.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", this.jdField_a_of_type_JavaLangString, "0X8005A27", "0X8005A27", 0, 0, paramString, "", "", "", false);
      return;
    }
  }
  
  private View d(nyl paramnyl)
  {
    boolean bool = false;
    if ((paramnyl.jdField_a_of_type_JavaLangString.contains(anni.a(2131698551))) && (this.jdField_a_of_type_Boolean)) {
      return null;
    }
    View localView = ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getLayoutInflater().inflate(2131559574, null);
    ((TextView)localView.findViewById(2131378776)).setText(paramnyl.jdField_a_of_type_JavaLangString);
    String str = paramnyl.jdField_c_of_type_JavaLangString;
    if (!TextUtils.isEmpty(str))
    {
      localView.findViewById(2131369401).setVisibility(0);
      localView.setOnClickListener(new nsc(this, str, paramnyl));
      bool = true;
    }
    try
    {
      for (;;)
      {
        paramnyl = new JSONArray(paramnyl.jdField_e_of_type_JavaLangString);
        a(bool, (LinearLayout)localView.findViewById(2131368501), paramnyl);
        return localView;
        localView.findViewById(2131369401).setVisibility(8);
      }
    }
    catch (JSONException paramnyl)
    {
      for (;;)
      {
        if (QLog.isColorLevel()) {
  ...
  private View e(nyl paramnyl)
  {
    View localView = ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getLayoutInflater().inflate(2131559285, null);
    a(localView, paramnyl.i);
    ((TextView)localView.findViewById(2131378776)).setText(paramnyl.jdField_a_of_type_JavaLangString);
    ((TextView)localView.findViewById(2131364999)).setText(paramnyl.jdField_b_of_type_JavaLangString);
    localView.setOnClickListener(new nsd(this, paramnyl));
    return localView;
  }
  
  private View f(nyl paramnyl)
  {
    View localView = ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getLayoutInflater().inflate(2131559285, null);
    a(localView, paramnyl.i);
    ((TextView)localView.findViewById(2131378776)).setText(paramnyl.jdField_a_of_type_JavaLangString);
    ((TextView)localView.findViewById(2131364999)).setText(paramnyl.jdField_b_of_type_JavaLangString);
    localView.setOnClickListener(new nse(this, paramnyl));
    return localView;
  }
  
  private View g(nyl paramnyl)
  {
    View localView = ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getLayoutInflater().inflate(2131559285, null);
    a(localView, paramnyl.i);
    ((TextView)localView.findViewById(2131378776)).setText(paramnyl.jdField_a_of_type_JavaLangString);
    ((TextView)localView.findViewById(2131364999)).setText(paramnyl.jdField_b_of_type_JavaLangString);
    localView.setOnClickListener(new nsf(this, paramnyl));
    return localView;
  }
  
  private View h(nyl paramnyl)
  {
    View localView = ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getLayoutInflater().inflate(2131559285, null);
    a(localView, paramnyl.i);
    ((TextView)localView.findViewById(2131378776)).setText(paramnyl.jdField_a_of_type_JavaLangString);
    ((TextView)localView.findViewById(2131364999)).setText(paramnyl.jdField_b_of_type_JavaLangString);
    localView.setOnClickListener(new nsg(this, paramnyl));
    return localView;
  }
  
  private View i(nyl paramnyl)
  {
    View localView = ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getLayoutInflater().inflate(2131559285, null);
    a(localView, paramnyl.i);
    String str = paramnyl.jdField_c_of_type_JavaLangString;
    ((TextView)localView.findViewById(2131378776)).setText(paramnyl.jdField_a_of_type_JavaLangString);
    ((TextView)localView.findViewById(2131364999)).setText(paramnyl.jdField_b_of_type_JavaLangString);
    localView.setOnClickListener(new nsi(this, str, paramnyl));
    return localView;
  }
  ...
  private void i()
  {
    ...
    b(this.jdField_a_of_type_AndroidWidgetLinearLayout);
    View localView = ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getLayoutInflater().inflate(2131559600, null);
    String str = "";
    ...
    ((TextView)localView.findViewById(2131364292)).setText(str);
    this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(localView);
  }
  
  private View j(nyl paramnyl)
  {
    View localView = ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getLayoutInflater().inflate(2131563044, null);
    ((TextView)localView.findViewById(2131364999)).setText(paramnyl.jdField_b_of_type_JavaLangString);
    ((TextView)localView.findViewById(2131378776)).setText(paramnyl.jdField_a_of_type_JavaLangString);
    return localView;
  }
  ...
  private void j()
  {
    ...
    View localView = ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getLayoutInflater().inflate(2131559600, null);
    ((TextView)localView.findViewById(2131364292)).setText(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.summary);
    ((ImageView)localView.findViewById(2131368826)).setVisibility(8);
    ((TextView)localView.findViewById(2131378776)).setText(2131694657);
    this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(localView);
  }
  
  private View k(nyl paramnyl)
  {
    this.jdField_a_of_type_Nyl = paramnyl;
    if (paramnyl.jdField_e_of_type_Int != 6)
    {
      if (QLog.isColorLevel()) {
        QLog.d("AccountDetailGroupListContainer", 2, "Unhandled ConfigInfo(" + paramnyl.jdField_a_of_type_Int + ", " + paramnyl.jdField_c_of_type_Int + ", " + paramnyl.jdField_e_of_type_Int + ")");
      }
      return null;
    }
    paramnyl = ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getLayoutInflater().inflate(2131562903, null);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramnyl.findViewById(2131377812));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramnyl.findViewById(2131377823));
    ((TextView)paramnyl.findViewById(2131378776)).setText(this.jdField_a_of_type_Nyl.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      if ((i == 0) && (this.jdField_a_of_type_Int > -1))
      {
        ...
        paramnyl.setOnClickListener(new nrh(this));
      }
      for (;;)
      {
        return paramnyl;
        a(this.jdField_a_of_type_Nyl);
        paramnyl.setOnClickListener(new nri(this));
      }
      i = -10000;
    }
  }
  ...
  private void k()
  {
    ...
    new aarp(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get(), a(), 1, a()).a();
  }
  
  private View l(nyl paramnyl)
  {
    View localView = ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getLayoutInflater().inflate(2131562939, null);
    ((TextView)localView.findViewById(2131378776)).setText(paramnyl.jdField_a_of_type_JavaLangString);
    Switch localSwitch = (Switch)localView.findViewById(2131377805);
    if (paramnyl.jdField_d_of_type_Int == 1) {
      localSwitch.setChecked(true);
    }
    for (;;)
    {
      localSwitch.setOnCheckedChangeListener(new nrp(this, paramnyl, localSwitch));
      return localView;
      localSwitch.setChecked(false);
    }
  }
  
  private View m(nyl paramnyl)
  {
    if ((this.jdField_a_of_type_Boolean) && (paramnyl.jdField_a_of_type_JavaLangString.contains(anni.a(2131698553)))) {
      return null;
    }
    View localView = ((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getLayoutInflater().inflate(2131559285, null);
    a(localView, paramnyl.i);
    ...
    ((TextView)localView.findViewById(2131378776)).setText(paramnyl.jdField_a_of_type_JavaLangString);
    ((TextView)localView.findViewById(2131364999)).setText(paramnyl.jdField_b_of_type_JavaLangString);
    localView.setOnClickListener(new nrq(this, str, paramnyl));
    return localView;
  }
  ...
  void a()
  {
    ...
    Object localObject = ((bfrd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(132)).a(this.jdField_a_of_type_JavaLangString);
    if (localObject != null)
    {
  ...
  void a(int paramInt)
  {
    bkho localbkho = (bkho)bkif.b((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), null);
    localbkho.a(2131693231, 5, false);
    localbkho.a(2131693230, 5, false);
    localbkho.a(2131693233, 5, false);
    if (paramInt == 0) {
      localbkho.d(0);
    }
    for (;;)
    {
      ...
      localbkho.setOnDismissListener(new nrm(this));
      localbkho.a(new nrn(this, localbkho));
  ...
  void a(ViewGroup paramViewGroup)
  {
    ...
    View localView = LayoutInflater.from((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get()).inflate(2131559961, paramViewGroup, false);
    LinearLayout localLinearLayout = (LinearLayout)localView.findViewById(2131368501);
    Object localObject = localView.findViewById(2131364999);
    this.jdField_a_of_type_AndroidViewViewGroup = localLinearLayout;
    if (j == 0)
    {
      if (this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail != null) {
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_public", "", "connect", "exp_num", 0, 0, "", "", "", this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.uin);
      }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail != null) {
        bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_public", "", "connect", "exp_grp", 0, 0, "", "", "", this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.uin);
      }
      localLinearLayout.setVisibility(0);
      ((View)localObject).setVisibility(8);
    }
    localView.setOnClickListener(new nrr(this, j));
    paramViewGroup.addView(localView);
    b(paramViewGroup);
  }
  
  void a(ViewGroup paramViewGroup, nyl paramnyl, int paramInt)
  {
    if (QLog.isColorLevel()) {
    ...
    if (paramnyl.jdField_a_of_type_Int == 3) {
      ...
      {
        this.jdField_a_of_type_AndroidViewView = k(paramnyl);
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_AndroidViewView = a(paramnyl);
        break label58;
      }
      if (paramnyl.jdField_c_of_type_Int == 8)
      {
        this.jdField_a_of_type_AndroidViewView = b(paramnyl);
        break label58;
      }
      if (paramnyl.jdField_c_of_type_Int == 11)
      {
        this.jdField_a_of_type_AndroidViewView = e(paramnyl);
        break label58;
      }
      if (paramnyl.jdField_c_of_type_Int == 20)
      {
        this.jdField_a_of_type_AndroidViewView = f(paramnyl);
        break label58;
      }
      if (paramnyl.jdField_c_of_type_Int == 2)
      {
        this.jdField_a_of_type_AndroidViewView = g(paramnyl);
        break label58;
      }
      if (paramnyl.jdField_c_of_type_Int == 17)
      {
        this.jdField_a_of_type_AndroidViewView = h(paramnyl);
        break label58;
      }
      if (paramnyl.jdField_c_of_type_Int == 19)
      {
        this.jdField_a_of_type_AndroidViewView = a(paramnyl, 9);
        break label58;
      }
      if (paramnyl.jdField_c_of_type_Int == 18)
      {
        this.jdField_a_of_type_AndroidViewView = a(paramnyl, 10);
        break label58;
      }
      if (paramnyl.jdField_c_of_type_Int == 22)
      {
        this.jdField_a_of_type_AndroidViewView = i(paramnyl);
        break label58;
      }
      if (paramnyl.jdField_c_of_type_Int == 24)
      {
        this.jdField_a_of_type_AndroidViewView = j(paramnyl);
        break label58;
      }
      if (!QLog.isColorLevel()) {
        break;
      ...
      {
        this.jdField_a_of_type_AndroidViewView = m(paramnyl);
        break label58;
      }
      if (paramnyl.jdField_a_of_type_Int == 2)
      {
        this.jdField_a_of_type_AndroidViewView = l(paramnyl);
        break label58;
      }
      if (paramnyl.jdField_a_of_type_Int == 4)
      {
        this.jdField_a_of_type_AndroidViewView = c(paramnyl);
        break label58;
      }
      if (paramnyl.jdField_a_of_type_Int == 5)
      {
        this.jdField_a_of_type_AndroidViewView = d(paramnyl);
        break label58;
      }
      ...
      break;
      label492:
      if ((paramnyl.jdField_a_of_type_Int == 2) || ((paramnyl.jdField_a_of_type_Int == 5) && (!paramnyl.jdField_e_of_type_JavaLangString.equals("[]")))) {
  ...
  void a(nyl paramnyl, int paramInt)
  {
    bkho localbkho = (bkho)bkif.b((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), null);
    localbkho.a(2131693231, 5, false);
    ...
    for (;;)
    {
      if ((paramInt != 1) && (paramInt == 2)) {}
      localbkho.c(2131690582);
      localbkho.setOnDismissListener(new nrj(this));
      localbkho.a(new nrk(this, paramnyl, localbkho));
      if (!localbkho.isShowing())
      {
        this.f = false;
        localbkho.show();
  ...
  void a(nyl paramnyl, Switch paramSwitch)
  {
    boolean bool = true;
    if (paramnyl.jdField_d_of_type_Int == 1) {}
    for (;;)
  ...
  void a(nyl paramnyl, Switch paramSwitch, boolean paramBoolean)
  {
    bgpa localbgpa = bglp.a((Context)this.jdField_a_of_type_JavaLangRefWeakReference.get(), 0);
    localbgpa.setCanceledOnTouchOutside(false);
    String str2 = anni.a(2131698549);
    String str1 = paramnyl.jdField_d_of_type_JavaLangString;
    if (3 == paramnyl.jdField_e_of_type_Int) {
      str1 = String.format(((BaseActivity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getString(2131691874), new Object[] { this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.name });
    }
    localbgpa.setTitle(str2);
    localbgpa.setMessage(str1);
    localbgpa.setOnCancelListener(new nry(this, paramnyl, paramSwitch));
    paramnyl = new nrz(this, paramnyl, paramBoolean, paramSwitch);
    localbgpa.setNegativeButton(anni.a(2131698548), paramnyl);
    localbgpa.setPositiveButton(anni.a(2131698554), paramnyl);
    try
    {
      localbgpa.show();
      return;
  ...
  void a(nyl paramnyl, boolean paramBoolean)
  {
    if (paramBoolean) {}
    for (int i = 1;; i = 2)
    {
      nqo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, paramnyl, i);
      return;
    }
  }
  ...
  protected boolean a()
  {
    ...
    {
      bool1 = bool2;
      if (tzo.a(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.accountFlag) != -2) {
        bool1 = false;
      }
    }
    if (QLog.isColorLevel()) {
  ...
  public void b()
  {
    if (this.jdField_a_of_type_Nsj != null)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Nsj);
    }
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail != null)
    {
      ...
      if (localList == null) {
        localList = nyk.a(this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.newGroupInfoList);
      }
    }
    for (;;)
    {
      ...
      if (localList != null)
      {
        ...
        if (i < j)
        {
          if ((((nyk)localList.get(i)).jdField_a_of_type_Int != 0) && (((nyk)localList.get(i)).jdField_a_of_type_Int != 1)) {
            break label128;
          }
          bool = a((nyk)localList.get(i), i, j, bool);
        }
      }
      label128:
      for (;;)
  ...
  public void g()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        nir.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new nrt(this), localReqBody.toByteArray(), "OidbSvc.0x487_0", 1159, 0);
        return;
      }
  ...
  public void h()
  {
    ...
    for (localObject1 = ((TicketManager)localObject1).getSkey(str);; localObject1 = null)
    {
      ...
      if (localObject3 != null)
      {
        ...
        if (((String)localObject3).endsWith(anni.a(2131698555))) {
      ...
      new bfpp("https://buluo.qq.com/cgi-bin/bar/qunlist_all", "POST", new nrv(this), 1000, null).a((HashMap)localObject3);
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqDataAccountDetail.uin;
      bcst.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_tribe", "", "exp_tribechat_data", "exp_tribechat_aio", 0, 0, this.jdField_a_of_type_JavaLangString, (String)localObject1, "", "");
      return;
    }
  }
}
