...
public class oss
{
  ...
  public String a()
  {
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_OrgJsonJSONObject.put("source", ozs.d());
  ...
  public oss a(String paramString)
  {
    try
    {
