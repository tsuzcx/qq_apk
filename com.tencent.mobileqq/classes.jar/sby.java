...
public class sby
  extends BaseAdapter
{
  public sby(sbw paramsbw) {}
  
  public scg a(int paramInt)
  {
    if (sbw.a != null) {
      return (scg)sbw.a.get(paramInt);
    }
    return null;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = LayoutInflater.from(sbw.a()).inflate(2131493840, paramViewGroup, false);
      paramViewGroup = new sbz(this);
      localObject1 = paramView.getLayoutParams();
      ((ViewGroup.LayoutParams)localObject1).height = ((sbw.b() - aciy.a(110.0F, sbw.a().getResources())) / 3);
      ...
      paramViewGroup.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131309204));
      localObject2 = paramViewGroup.jdField_a_of_type_ComTencentImageURLImageView.getLayoutParams();
      ((ViewGroup.LayoutParams)localObject2).width = ((sbw.c() - aciy.a(2.0F, sbw.a().getResources())) / 2);
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131309220));
      if (((ViewGroup.LayoutParams)localObject1).height - ((ViewGroup.LayoutParams)localObject2).height - aciy.a(40.0F, sbw.a().getResources()) > aciy.a(16.0F, sbw.a().getResources()))
      {
        i = 2;
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      {
        localObject2 = ((scg)localObject1).a;
        ...
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(((scg)localObject1).b);
        if (QLog.isColorLevel()) {
          QLog.d("PublicAccountImageCollectionRecommendViewWrapper", 2, "recommendInfo position = " + paramInt + "; url =" + localObject2 + "; title = " + ((scg)localObject1).b);
        }
      }
      return paramView;
      i = 1;
      break;
      paramViewGroup = (sbz)paramView.getTag();
    }
  }
}
