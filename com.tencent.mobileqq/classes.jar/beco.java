  ...
  implements ShareActionSheet.IShareActionSheetV2BottomBar
{
  ...
  public beco(Context paramContext)
  {
  ...
  private View a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity != null)
    {
      ...
      {
        this.jdField_a_of_type_Beau = this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.a().getShare().a();
        localObject1 = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity).inflate(2131562946, null);
        if ((this.jdField_a_of_type_Beau == null) || (!this.jdField_a_of_type_Beau.jdField_a_of_type_Boolean)) {
          break label413;
        }
        ((RelativeLayout)localObject1).setVisibility(0);
        this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((RelativeLayout)localObject1).findViewById(2131379788));
        this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new becp(this));
        if (this.jdField_a_of_type_Beau.c != 1) {
          break label304;
        }
        this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.getText(2131690237));
        this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)((RelativeLayout)localObject1).findViewById(2131377020));
        this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)((RelativeLayout)localObject1).findViewById(2131379788));
        this.b = ((TextView)((RelativeLayout)localObject1).findViewById(2131379786));
        this.b.setTextColor(Color.parseColor("#777777"));
        if (this.jdField_a_of_type_Beau.c == 2) {
          this.b.setTextColor(Color.parseColor("#fe6c6c"));
        }
        this.b.setText(this.jdField_a_of_type_Beau.jdField_a_of_type_JavaLangString);
        this.c = ((TextView)((RelativeLayout)localObject1).findViewById(2131379787));
        this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((RelativeLayout)localObject1).findViewById(2131369320));
        if (2 != this.jdField_a_of_type_Beau.c) {
          break label359;
        }
        if (!TextUtils.isEmpty(this.jdField_a_of_type_Beau.b)) {
          break label334;
        }
    ...
    for (;;)
    {
      ...
      this.c.setText(this.jdField_a_of_type_Beau.b);
      continue;
      label359:
      if (TextUtils.isEmpty(this.jdField_a_of_type_Beau.f))
      {
        this.c.setVisibility(8);
      }
      else
      {
        this.c.setVisibility(0);
        a(this.jdField_a_of_type_Beau.f, this.jdField_a_of_type_Beau.d);
        continue;
  ...
  {
    String str = this.jdField_a_of_type_Beau.g;
    if (paramInt == 0)
    {
      this.c.setText(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.getString(2131719235));
      return;
    }
  ...
  {
    super.setItemClickListenerV2(new becq(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, this.jdField_a_of_type_ComTencentSmttSdkWebView, this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo, paramOnItemClickListener));
  }
}
