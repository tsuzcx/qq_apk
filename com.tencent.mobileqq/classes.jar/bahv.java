...
public class bahv
{
  private static bkfu<Integer> jdField_a_of_type_Bkfu;
  ...
  private static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    jdField_a_of_type_Bkfu.a(a(paramQQAppInterface.getCurrentAccountUin()), Integer.valueOf(paramInt));
  ...
  {
    SharedPreferences localSharedPreferences = paramQQAppInterface.getPreferences();
    jdField_a_of_type_Bkfu = new bkfu(1);
    int i = localSharedPreferences.getInt("receipt_msg_sent_num", 0);
    jdField_a_of_type_Bkfu.a(a(paramQQAppInterface.getCurrentAccountUin()), Integer.valueOf(i));
    jdField_a_of_type_Boolean = true;
  }
  
  private static int c(QQAppInterface paramQQAppInterface)
  {
    int i = ((Integer)jdField_a_of_type_Bkfu.a(a(paramQQAppInterface.getCurrentAccountUin()), Integer.valueOf(0))).intValue();
    if (QLog.isColorLevel()) {
