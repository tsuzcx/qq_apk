  ...
  implements bbiy, bblz
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new bhxy(this);
  ...
  public bhxx(Context paramContext, bhxz parambhxz)
  {
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    for (int i = 0;; i = 1)
    {
      this.jdField_a_of_type_Bbly = new bbly(paramString, localHandler, i);
      this.jdField_a_of_type_Bbly.a(BaseApplication.getContext());
  ...
  public void a(int paramInt1, String paramString, int paramInt2)
  {
    ...
    {
      this.jdField_a_of_type_Bhxz.b(this.jdField_b_of_type_Int, paramString);
      this.jdField_b_of_type_Int = 0;
      return;
    }
    this.jdField_a_of_type_Bhxz.a(3, this.e);
  }
  ...
  {
    avbt.b(paramString);
    this.jdField_a_of_type_Bhxz.a(paramString, paramDouble);
  }
  
  public void a(String paramString1, QQRecorder.RecorderParam paramRecorderParam, String paramString2)
  {
    avbt.a(paramString1);
    this.jdField_a_of_type_Bhxz.c();
  }
  ...
  public void b(String paramString)
  {
    ...
    if ((this.jdField_a_of_type_Bhxz != null) && (!TextUtils.isEmpty(str1)))
    {
      this.jdField_a_of_type_Bhxz.a(1, paramString);
      d(str1);
      return;
    }
    ...
    for (;;)
    {
      if (i != 0)
      {
        if (new StatFs(Environment.getExternalStorageDirectory().getAbsolutePath()).getAvailableBlocks() > 1)
        {
          ...
          paramString = ayph.a(paramString, null, 2, null);
        ...
        bcql.a(BaseApplication.getContext(), 2131719060, 0).a();
        return;
      }
    }
    bcql.a(BaseApplication.getContext(), 2131694694, 0).a();
  }
}
