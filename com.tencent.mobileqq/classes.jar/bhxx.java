  ...
  extends PopupWindow
{
  ...
  View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new bhxz(this);
  View jdField_a_of_type_AndroidViewView;
  ImageView jdField_a_of_type_AndroidWidgetImageView;
  LinearLayout jdField_a_of_type_AndroidWidgetLinearLayout;
  bhyb jdField_a_of_type_Bhyb;
  bhyc jdField_a_of_type_Bhyc = new bhya(this);
  ...
  public bhxx(@NonNull Context paramContext)
  {
    super(paramContext);
    ...
    this.jdField_b_of_type_JavaLangString = alud.a(2131706309);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560079, null);
  ...
  private void e()
  {
    ...
    {
      if (i1 <= 1) {
        ((View)this.jdField_f_of_type_JavaUtilArrayList.get(0)).setBackgroundResource(2130842569);
      }
    }
    else {
      return;
    }
    ((View)this.jdField_f_of_type_JavaUtilArrayList.get(0)).setBackgroundResource(2130842571);
    ((View)this.jdField_f_of_type_JavaUtilArrayList.get(i1 - 1)).setBackgroundResource(2130842570);
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, ArrayList<DislikeInfo> paramArrayList, String paramString)
  {
    ...
    for (paramInt1 = paramArrayList.size();; paramInt1 = 0)
    {
      ...
      paramArrayList = new DislikeInfo();
      paramArrayList.jdField_a_of_type_JavaLangString = BaseApplicationImpl.getContext().getString(2131718924);
      paramArrayList.jdField_c_of_type_Int = 8;
      paramArrayList.jdField_b_of_type_JavaLangString = "";
      this.jdField_e_of_type_JavaUtilArrayList.add(paramArrayList);
      a(this.jdField_a_of_type_JavaUtilArrayList, this.jdField_b_of_type_AndroidViewView, 2130841344, alud.a(2131706315), true);
      a(this.jdField_b_of_type_JavaUtilArrayList, this.jdField_c_of_type_AndroidViewView, 2130841348, alud.a(2131706325), true);
      a(this.jdField_c_of_type_JavaUtilArrayList, this.jdField_d_of_type_AndroidViewView, 2130841337, a(this.jdField_c_of_type_JavaUtilArrayList), false);
      a(this.jdField_d_of_type_JavaUtilArrayList, this.jdField_e_of_type_AndroidViewView, 2130841341, alud.a(2131706321), false);
      a(this.jdField_e_of_type_JavaUtilArrayList, this.jdField_f_of_type_AndroidViewView, 2130841336, BaseApplicationImpl.getContext().getString(2131718924), false);
      a();
  ...
  {
    this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131371041);
    this.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131371037);
    this.jdField_d_of_type_AndroidViewView = paramView.findViewById(2131371043);
    this.jdField_e_of_type_AndroidViewView = paramView.findViewById(2131371040);
    this.jdField_f_of_type_AndroidViewView = paramView.findViewById(2131371039);
    ...
    ((ImageView)paramView.findViewById(2131366384).findViewById(2131369349)).setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
    this.i = ((int)bdgk.i());
    this.j = ((int)bdgk.j());
    ...
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(1L), alud.a(2131706322));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(2L), alud.a(2131706320));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(3L), alud.a(2131706311));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(4L), alud.a(2131706312));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(5L), alud.a(2131706317));
    this.jdField_a_of_type_JavaUtilMap.put(Long.valueOf(6L), alud.a(2131706316));
    this.m = ((int)this.jdField_a_of_type_AndroidContentContext.getResources().getDimension(2131298594));
    this.jdField_e_of_type_AndroidViewView.findViewById(2131376442).setVisibility(4);
    setBackgroundDrawable(new ColorDrawable());
    setOnDismissListener(new bhxy(this));
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(this.jdField_a_of_type_AndroidViewView$OnClickListener);
  }
  
  public void a(View paramView, bhyb parambhyb)
  {
    if (isShowing()) {
      dismiss();
    }
    ...
    try
    {
      bool = a(paramView, parambhyb);
      if (bool)
      {
        showAtLocation(paramView, 51, parambhyb[0], parambhyb[1]);
        a(0.8F);
        a(this);
      }
      return;
  ...
  protected void a(ArrayList<DislikeInfo> paramArrayList, View paramView, int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    if (!paramArrayList.isEmpty())
    {
      ...
      {
        ((TextView)paramView.findViewById(2131368577)).setText(paramString);
        localTextView = (TextView)paramView.findViewById(2131368573);
        localImageView = (ImageView)paramView.findViewById(2131368562);
        ((ImageView)paramView.findViewById(2131368518)).setImageResource(paramInt);
        paramString = "";
        if (!paramBoolean) {
          break label150;
        }
  ...
  protected void c(View paramView)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.jdField_a_of_type_Bhyb == null);
      paramView = paramView.getTag();
    } while (!(paramView instanceof DislikeInfo));
    ArrayList localArrayList = new ArrayList();
    localArrayList.add((DislikeInfo)paramView);
    this.jdField_a_of_type_Bhyb.a(null, this.o, localArrayList, null);
  }
