...
public class aico
  extends Handler
{
  public aico(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment) {}
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        if ((ChatHistoryTroopMemberFragment.b(this.a)) && (ChatHistoryTroopMemberFragment.d(this.a)))
        {
          ...
          paramMessage.obj = this.a.jdField_a_of_type_Aidh.a();
          ChatHistoryTroopMemberFragment.a(this.a, paramMessage);
        }
        return;
        this.a.y();
        ...
        {
          if (this.a.jdField_a_of_type_Aidh.b != null) {
            this.a.jdField_a_of_type_Aidh.b.clear();
          }
        ...
        QQToast.a(this.a.getActivity(), this.a.getString(2131691554), 0).b(this.a.jdField_b_of_type_AndroidViewView.getHeight());
      ...
      return;
    } while (this.a.jdField_a_of_type_Aidh == null);
    this.a.jdField_a_of_type_Aidh.a();
    return;
    ...
    for (this.a.o = "0"; this.a.jdField_a_of_type_Aidh != null; this.a.o = "1")
    {
      label1154:
      this.a.jdField_a_of_type_Aidh.a();
      return;
