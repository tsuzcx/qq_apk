...
public class avnu
{
  ...
  public static avnu a()
  {
    try
    {
      if (jdField_a_of_type_Avnu == null) {
        jdField_a_of_type_Avnu = new avnu();
      }
      avnu localavnu = jdField_a_of_type_Avnu;
      return localavnu;
    }
    finally {}
  }
  ...
  private void a(EntityManager arg1)
  {
    ...
    //   32: dup
    //   33: aload_0
    //   34: invokespecial 130	avnv:<init>	(Lavnu;)V
    ...
    //   76: aload_0
    //   77: getfield 38	avnu:jdField_b_of_type_JavaLangObject	Ljava/lang/Object;
    //   80: astore_1
    //   81: aload_1
    //   82: monitorenter
    //   83: aload_0
    //   84: aload_2
    //   85: putfield 166	avnu:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   88: aload_0
    //   89: getfield 166	avnu:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   92: ifnonnull +16 -> 108
    //   95: aload_0
    ...
    //   105: putfield 166	avnu:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   108: aload_1
    //   109: monitorexit
    //   110: aload_0
    //   111: getfield 47	avnu:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   114: astore_1
    //   115: aload_1
    //   116: monitorenter
    //   117: aload_0
    //   118: getfield 47	avnu:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   121: invokeinterface 174 1 0
    //   126: aload_0
    //   127: getfield 166	avnu:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    ...
    //   154: astore_3
    //   155: aload_0
    //   156: getfield 47	avnu:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   159: aload_3
  ...
  private boolean a(QQAppInterface paramQQAppInterface, int paramInt, long paramLong)
  {
    ...
    case 2: 
      if (bool)
      {
        localObject = (RecentUser)localanuz.findRecentUserByUin(AppConstants.TROOP_ASSISTANT_UIN, 5000);
    ...
    for (;;)
    {
      ...
      if (paramInt != 3)
      {
        paramQQAppInterface = (RecentUser)localanuz.findRecentUser(AppConstants.TROOP_ASSISTANT_UIN, 5000);
        if (paramQQAppInterface != null) {
          localanuz.delRecentUser(paramQQAppInterface);
        }
      }
    }
  }
  ...
  {
    anuz localanuz = paramQQAppInterface.getProxyManager().a();
    paramString = (RecentUser)localanuz.findRecentUser(paramString, 1);
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if (this.jdField_a_of_type_JavaUtilSet != null)
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if ((!TextUtils.isEmpty(str)) && (!afqy.a(str, 1, paramQQAppInterface))) {
              i += 1;
            }
          }
          else
      ...
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_JavaUtilList != null) && (this.jdField_a_of_type_JavaUtilList.size() > 0))
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if (afqy.a(localTroopAssistantData.troopUin, 1, paramQQAppInterface)) {
              continue;
            }
  ...
  public void a(QQAppInterface paramQQAppInterface, nmf paramnmf)
  {
    ThreadManager.post(new TroopAssistantManager.2(this, paramQQAppInterface, paramnmf), 8, null, true);
  }
  ...
  public void a(EntityManager paramEntityManager, QQAppInterface paramQQAppInterface)
  {
    try
    {
      a(paramQQAppInterface);
      anuz localanuz = paramQQAppInterface.getProxyManager().a();
      Object localObject2 = localanuz.getRecentList(false);
  ...
  public void a(String paramString, QQAppInterface paramQQAppInterface)
  {
    EntityManager localEntityManager = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    anuz localanuz = paramQQAppInterface.getProxyManager().a();
    RecentUser localRecentUser = (RecentUser)localanuz.findRecentUser(paramString, 1);
    QQMessageFacade.Message localMessage;
    ...
    for (paramString.lastmsgtime = localMessage.time;; paramString.lastmsgtime = localRecentUser.lastmsgtime)
    {
      ...
      if ((!(localRecentUser.msg instanceof akny)) && (!(localRecentUser.msg instanceof akoo)) && (!(localRecentUser.msg instanceof akob)) && (!(localRecentUser.msg instanceof akog)) && (!(localRecentUser.msg instanceof aknx)) && (!(localRecentUser.msg instanceof bkyo)) && (!(localRecentUser.msg instanceof akol)) && (!(localRecentUser.msg instanceof akof)) && (!(localRecentUser.msg instanceof akoi))) {
    ...
    for (;;)
    {
      synchronized (this.jdField_b_of_type_JavaLangObject)
      {
        if (this.jdField_a_of_type_JavaUtilList != null)
        {
          ...
          TroopAssistantData localTroopAssistantData = (TroopAssistantData)localIterator.next();
          if ((afqy.a(localTroopAssistantData.troopUin, 1, paramQQAppInterface)) || (bdvp.b(paramQQAppInterface, localTroopAssistantData.troopUin))) {
            continue;
          }
  ...
  public void b(QQAppInterface paramQQAppInterface)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      this.jdField_a_of_type_JavaUtilSet = bfza.a((SharedPreferences)localObject2, "troop_assis_new_unread_list", null);
      if (this.jdField_a_of_type_JavaUtilSet == null)
      {
        this.jdField_a_of_type_JavaUtilSet = new HashSet();
  ...
  public void c(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      ...
      {
        localObject = localEntityManager;
        RecentUser localRecentUser = (RecentUser)localanuz.findRecentUserByUin(String.valueOf(localTroopAssistantData.troopUin), 1);
        localObject = localEntityManager;
  ...
  public void i(QQAppInterface paramQQAppInterface)
  {
    ...
    ??? = ((anuz)localObject1).getRecentList(false);
    Object localObject5;
    if ((??? != null) && (((List)???).size() > 0))
    {
      ??? = ((List)???).iterator();
    ...
    if (((ArrayList)localObject3).size() > 0)
    {
      ...
      if (((Iterator)localObject3).hasNext())
      {
        ...
        for (((TroopAssistantData)localObject5).lastmsgtime = ((QQMessageFacade.Message)localObject6).time;; ((TroopAssistantData)localObject5).lastmsgtime = ((RecentUser)???).lastmsgtime)
        {
          ...
          ((anuz)localObject1).delRecentUser((BaseRecentUser)???);
    ...
    if (((ArrayList)localObject2).size() > 0)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        ??? = (RecentUser)((anuz)localObject1).findRecentUserByUin(((TroopAssistantData)localObject3).troopUin, 1);
        ...
        {
          ((anuz)localObject1).saveRecentUser((BaseRecentUser)???);
  ...
  public void k(QQAppInterface paramQQAppInterface)
  {
    try
    {
      ...
      if (avnw.a().a(paramQQAppInterface) == true)
      {
        localEntityManager = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
        avnw.a().a(localEntityManager, paramQQAppInterface);
        localEntityManager.close();
      }
      return;
    }
