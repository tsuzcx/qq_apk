  ...
  extends BaseAdapter
{
  ...
  private pwp(ComponentContentRecommendFollowList paramComponentContentRecommendFollowList) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup = new pwq(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyRebuildCmpComponentContentRecommendFollowList, null);
      ...
      paramViewGroup.jdField_c_of_type_AndroidWidgetTextView.setText(ajya.a(2131702341));
    ...
    for (paramInt = i;; paramInt = 8)
    {
      ...
      return paramView;
      paramViewGroup = (pwq)paramView.getTag();
      break;
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView.setImageDrawable(bbef.b());
      break label291;
      paramViewGroup.jdField_c_of_type_AndroidWidgetTextView.setText(ajya.a(2131702331));
