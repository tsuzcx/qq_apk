...
public class vwg
{
  ...
  private vwg(JSONObject paramJSONObject)
  {
    int j;
    try
    {
  ...
  public static vwg a(@Nullable String paramString)
  {
    try
    {
  ...
  public static vwg a(JSONObject paramJSONObject)
  {
    try
    {
      paramJSONObject = new vwg(paramJSONObject);
