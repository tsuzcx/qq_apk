  ...
  implements Manager
{
  ...
  private aqkj jdField_a_of_type_Aqkj;
  private assm jdField_a_of_type_Assm;
  private assn jdField_a_of_type_Assn;
  private asso jdField_a_of_type_Asso;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private HashMap<Long, WeakReference<assl>> jdField_a_of_type_JavaUtilHashMap = new HashMap(5);
  private boolean jdField_a_of_type_Boolean = true;
  private HashMap<Long, WeakReference<assj>> b = new HashMap(20);
  private HashMap<Long, Boolean> c = new HashMap(200);
  private HashMap<Long, WeakReference<assk>> d = new HashMap(5);
  private HashMap<Long, ArrayList<Long>> e = new HashMap(5);
  private HashMap<Long, ArrayList<Long>> f = new HashMap(5);
  
  public assi(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Aqkj = ((aqkj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(323));
  }
  ...
  private ArrayList<Long> a(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 58	assi:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   20: aload_0
    //   21: getfield 58	assi:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
  ...
  private void a(long paramLong, assl paramassl)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.3(this, paramLong, paramassl));
  }
  
  private void a(long paramLong, ArrayList<Long> paramArrayList, assj paramassj)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.2(this, paramLong, paramArrayList, paramassj));
  }
  
  private void a(long paramLong, ArrayList<Long> paramArrayList, assk paramassk)
  {
    ThreadManager.getSubThreadHandler().post(new MultiCardManager.1(this, paramArrayList, paramLong, paramassk));
  }
  ...
  public IntimateInfo a(long paramLong1, long paramLong2)
  {
    ...
    if (localIntimateInfo2 == null)
    {
      ...
      localIntimateInfo2 = this.jdField_a_of_type_Aqkj.a(str);
  ...
  public void a(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Assn == null) {
      this.jdField_a_of_type_Assn = new assn(this, null);
    }
    if (this.jdField_a_of_type_Asso == null) {
      this.jdField_a_of_type_Asso = new asso(this, null);
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Assm);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Assn);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Asso);
  }
  ...
  public void a(Context arg1, long paramLong, assl paramassl)
  {
    if (QLog.isColorLevel()) {
      QLog.d("MultiCardManager", 2, String.format("getGroupRecommendUinLists, uin: %d", new Object[] { Long.valueOf(paramLong) }));
    }
    if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramassl != null))
    {
      if (!bbfj.d(???)) {
        a(paramLong, paramassl);
      }
    }
    else {
      return;
    ...
    synchronized (this.f)
    {
      ...
      if (localArrayList != null)
      {
        ...
        paramassl.a(paramLong, localArrayList);
        return;
      }
    }
    paramassl = new WeakReference(paramassl);
    synchronized (this.jdField_a_of_type_JavaUtilHashMap)
    {
      this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(paramLong), paramassl);
      ((aqkh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(153)).a(paramLong, 10000L);
      return;
    }
  }
  
  public void a(Context paramContext, long paramLong, ArrayList<Long> arg4, assj paramassj)
  {
    if (QLog.isColorLevel())
    {
    ...
    for (Object localObject1 = ???.toString();; localObject1 = "null")
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramassj != null) && (??? != null))
      {
    ...
    synchronized (this.b)
    {
      this.b.put(Long.valueOf(paramLong), paramassj);
      ??? = new HashMap(5);
      ???.put("alreadyRequest", localObject1);
      ???.put("notRequest", paramContext);
      paramassj = new ArrayList(1);
      paramassj.add(Long.valueOf(paramLong));
      ???.put("groupUin", paramassj);
      ((aqkh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(153)).a(paramLong, paramContext, ???);
      return;
    }
  }
  
  public void a(Context arg1, long paramLong, ArrayList<Long> paramArrayList, assk paramassk)
  {
    Object localObject2;
    if (QLog.isColorLevel())
    {
    ...
    {
      QLog.d("MultiCardManager", 2, (String)localObject1);
      if ((this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null) && (paramassk != null) && (paramArrayList != null))
      {
        if (bbfj.d(???)) {
          break;
        }
        a(paramLong, paramArrayList, paramassk);
      }
      return;
    }
    synchronized (this.e)
    ...
    for (;;)
    {
      ...
      paramArrayList = new WeakReference(paramassk);
      synchronized (this.d)
      {
        this.d.put(Long.valueOf(paramLong), paramArrayList);
        ((akhp)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(false, paramLong + "", "0", 9);
        return;
        label317:
  ...
  public void a(String paramString, IntimateInfo paramIntimateInfo)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_Aqkj.a(paramString, paramIntimateInfo);
  ...
  public void b(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Assn != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Assn);
      this.jdField_a_of_type_Assn = null;
    }
    if (this.jdField_a_of_type_Asso != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Asso);
