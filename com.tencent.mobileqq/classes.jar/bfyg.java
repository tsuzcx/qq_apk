...
public class bfyg
{
  ...
  public static Dialog a(Activity paramActivity, String paramString1, String paramString2, int paramInt)
  {
    ...
    paramActivity.setContentView(2131561172);
    TextView localTextView3 = (TextView)paramActivity.findViewById(2131379985);
    TextView localTextView4 = (TextView)paramActivity.findViewById(2131379964);
    TextView localTextView1 = (TextView)paramActivity.findViewById(2131379955);
    TextView localTextView2 = (TextView)paramActivity.findViewById(2131379951);
    localTextView3.setText(paramString1);
    localTextView4.setText(new SpannableString(paramString2));
    paramString1 = (ImageView)paramActivity.findViewById(2131364396);
    ((ImageButton)paramActivity.findViewById(2131364627)).setOnClickListener(new bfyh(paramActivity));
    if (paramInt >= 0)
    {
  ...
  public static Bitmap a(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokestatic 173	bfzb:a	(Landroid/content/Context;)Z
    //   4: ifne +7 -> 11
    //   7: aconst_null
    //   8: astore_1
    //   9: aload_1
    //   10: areturn
    //   11: getstatic 174	bfzb:a	Ljava/lang/String;
    //   14: astore_2
    //   15: aload_0
    ...
    //   20: aload_0
    //   21: aload_2
    //   22: invokestatic 186	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   25: aconst_null
    //   26: ldc 188
    //   28: iconst_1
    ...
    //   35: aastore
    //   36: aconst_null
    //   37: invokevirtual 194	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   40: astore_0
    //   41: aload_0
    //   42: ifnull +60 -> 102
    //   45: aconst_null
    ...
    //   79: aload_2
    //   80: arraylength
    //   81: invokestatic 215	bfpx:a	([BII)Landroid/graphics/Bitmap;
    //   84: astore_2
    //   85: goto -38 -> 47
    //   88: aload_2
    //   89: astore_1
    ...
    //   117: aload_0
    //   118: astore_1
    //   119: invokestatic 223	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   122: ifeq +34 -> 156
    //   125: aload_0
    //   126: astore_1
    //   127: getstatic 12	bfyg:a	Ljava/lang/String;
    //   130: iconst_2
    //   131: new 225	java/lang/StringBuilder
    //   134: dup
    //   135: invokespecial 227	java/lang/StringBuilder:<init>	()V
    //   138: ldc 229
    //   140: invokevirtual 233	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   143: aload_2
    //   144: invokevirtual 234	java/lang/Exception:toString	()Ljava/lang/String;
    //   147: invokevirtual 233	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   150: invokevirtual 235	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   153: invokestatic 239	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   156: aload_0
    //   157: ifnull -45 -> 112
    //   160: aload_0
    //   161: invokeinterface 218 1 0
    //   166: goto -54 -> 112
    //   169: astore_0
    //   170: aconst_null
    //   171: astore_1
  ...
  public static Bitmap a(String paramString1, String paramString2, String paramString3, QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    return QQAppInterface.getCircleFaceBitmap(bfpx.a(paramString2), 50, 50);
  }
  ...
  public static SparseArray<String> a(Context paramContext, String paramString)
  {
    ...
    //   19: astore_0
    //   20: aload_2
    //   21: invokestatic 186	android/net/Uri:parse	(Ljava/lang/String;)Landroid/net/Uri;
    //   24: astore_2
    //   25: new 225	java/lang/StringBuilder
    //   28: dup
    //   29: invokespecial 227	java/lang/StringBuilder:<init>	()V
    //   32: ldc_w 270
    //   35: invokevirtual 233	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   38: aload_1
    ...
    //   48: invokevirtual 235	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   51: astore_1
    //   52: aload_0
    //   53: aload_2
    //   54: iconst_2
    ...
    //   71: aconst_null
    //   72: aconst_null
    //   73: invokevirtual 194	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   76: astore_1
    //   77: aload_1
    //   78: ifnull +133 -> 211
    //   81: aload_1
    //   82: astore_0
    //   83: new 278	android/util/SparseArray
    //   86: dup
    //   87: invokespecial 279	android/util/SparseArray:<init>	()V
    //   90: astore_2
    //   91: aload_1
    //   92: astore_0
    //   93: aload_1
    ...
    //   133: invokeinterface 286 2 0
    //   138: aload_3
    //   139: invokevirtual 290	android/util/SparseArray:put	(ILjava/lang/Object;)V
    //   142: goto -51 -> 91
    //   145: astore_2
    //   146: aload_1
    //   147: astore_0
    //   148: invokestatic 223	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   151: ifeq +34 -> 185
    //   154: aload_1
    //   155: astore_0
    //   156: getstatic 12	bfyg:a	Ljava/lang/String;
    //   159: iconst_2
    //   160: new 225	java/lang/StringBuilder
    //   163: dup
    //   164: invokespecial 227	java/lang/StringBuilder:<init>	()V
    //   167: ldc 229
    //   169: invokevirtual 233	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   172: aload_2
    //   173: invokevirtual 234	java/lang/Exception:toString	()Ljava/lang/String;
    //   176: invokevirtual 233	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    for (localObject1 = ((BaseApplicationImpl)localObject1).getRuntime();; localObject1 = null)
    {
      ...
      do
      {
        ...
        if ((localObject1 instanceof QQAppInterface)) {
          return ((QQAppInterface)localObject1).getServerConfigValue(paramConfigType, paramString);
        }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Intent paramIntent, String paramString, Bitmap paramBitmap)
  {
    ...
    int i = bfvh.a(paramQQAppInterface.getApp());
    ...
    label128:
    for (paramIntent = bgbt.a().a(paramBitmap, i);; paramIntent = Bitmap.createScaledBitmap(paramBitmap, i, i, false))
    {
            ...
            catch (InterruptedException localInterruptedException2)
            {
              try
              {
                ...
                if (QLog.isColorLevel())
                {
                  ...
                  localObject2 = localObject1;
                  continue;
                  localObject1 = bfsm.a(paramQQAppInterface.getFaceDrawable(localObject2.getStringExtra("uin")));
                  continue;
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, String paramString2, int paramInt1, MqqHandler paramMqqHandler, int paramInt2, String paramString3, int paramInt3)
  {
    ...
    {
      paramString1 = paramQQAppInterface.getApp().getString(2131691947);
  ...
  {
    return bfzb.a(paramContext, paramArrayOfString);
  }
}
