  ...
  extends alko
{
  ...
  public aman(QQAppInterface paramQQAppInterface)
  {
  ...
  private List<BusinessGroupWord> a(List<UnifySearchBusiHotWord.GroupWord> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      ayho localayho = new ayho(((UnifySearchBusiHotWord.GroupID)((UnifySearchBusiHotWord.GroupWord)localObject1).group_id.get()).rpt_group_mask.get());
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        localArrayList2.add(new ayhp(localHotWordItem.word_id.get().toStringUtf8(), localHotWordItem.word.get().toStringUtf8()));
      }
      aycr.a.put(aycr.a(localayho.a), localArrayList2);
      ...
      localObject1 = new ayhn((String)localObject1, (String)localObject2);
      aycr.b.put(aycr.a(localayho.a), localObject2);
      localArrayList1.add(new BusinessGroupWord(localayho, localArrayList2, (ayhn)localObject1));
    }
  ...
  private void a(String paramString1, long paramLong1, long paramLong2, String paramString2)
  {
    ...
    new azmo(this.app).a("dc00899").b("grp_search_engineer").c("search_net").d(paramString1).a(new String[] { paramLong2 + "", "" + (l - paramLong1), "" + paramString2, wta.a(null) }).a();
  }
  ...
  {
    return (azwu.a()) && ((paramLong == 1100L) || (paramLong == 1012L) || (paramLong == 1003L));
  }
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if (localRspBody.search_ver.has()) {
        ayrd.a("UnifySearch.Unite", (long[])localObject2, localRspBody.search_ver.get().toStringUtf8());
      }
    ...
    {
      ((List)localObject2).add(new ayjf((UnifySearchUnite.TabItemGroup)paramObject.get(i)));
      i += 1;
    }
    i = localRspBody.trigger_netword_num.get();
    if (i >= 0) {
      bdiv.s(BaseApplicationImpl.getContext(), i);
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (((UnifyTabSearch.RspBody)localObject1).search_ver.has()) {
          ayrd.a("UnifySearch.Tab", arrayOfLong, ((UnifyTabSearch.RspBody)localObject1).search_ver.get().toStringUtf8());
        }
        ...
        Object localObject3 = new aylk();
        if (bool2) {
          ((aylk)localObject3).a(true);
        }
        paramToServiceMsg = ((aylk)localObject3).a(new Object[] { str1, paramObject, Integer.valueOf(paramToServiceMsg.extraData.getInt("fromType")) });
  ...
  public List<ayjk> a(Object... paramVarArgs)
  {
    ...
    label202:
    for (boolean bool1 = ayra.b(i);; bool1 = true)
    {
  ...
  public void a()
  {
    ...
    localReqBody.version.set(ByteStringMicro.copyFromUtf8("8.3.3"));
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (!bdiv.b(paramQQAppInterface.getCurrentAccountUin(), paramInt))
    {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (paramInt3 == 1)
      {
        ...
        if (!paramBoolean1)
        {
          ...
          ((UnifySearchCommon.RootSearcherRequest)localObject1).rpt_busi_mask.set(ayrd.a(jdField_a_of_type_ArrayOfLong));
        ...
        i = 2;
        localObject2 = bdiv.b(this.app.getCurrentAccountUin());
        ...
        paramList2.extraData.putLongArray("masks", aydw.a(paramList1));
  ...
  public void a(String paramString1, String paramString2, int paramInt1, List<Long> paramList1, List<Long> paramList2, byte[] paramArrayOfByte, int paramInt2, double paramDouble1, double paramDouble2, Bundle paramBundle, String paramString3)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (aycr.a.isEmpty())
        {
          ...
          if (paramBundle != null)
          {
            ...
            if (!bool) {
              ayrd.a("sub_result", "active_search", new String[] { paramString1, ayrd.a(paramList1), "" + paramInt1, "" });
            }
      ...
      catch (UnsupportedEncodingException paramString3)
      {
        ...
        continue;
        localObject = aycr.a.values().iterator();
        paramInt1 = 2;
      }
      label566:
      int i = paramInt1;
      if (((Iterator)localObject).hasNext())
      {
        ...
        while (localIterator.hasNext()) {
          if (paramString1.equals((ayhp)localIterator.next())) {
            paramInt1 = 1;
          }
        }
      }
  ...
  public void a(UnifySearchCommon.ResultItemGroup paramResultItemGroup, long paramLong, String paramString, int paramInt, List<ayjk> paramList)
  {
    ...
    {
      localObject1 = new aykr(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
      ((aykr)localObject1).a(((UnifySearchCommon.ResultItem)localObject3).layout_id.get());
      ((aykr)localObject1).c(null);
      ((aykr)localObject1).a(bool2);
      if ((localObject1 != null) && (((ayju)localObject1).b()))
      {
        ((ayju)localObject1).r = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
        ((ayju)localObject1).a = bool1;
      ...
      for (;;)
      {
        ...
        default: 
          break;
        case 2: 
          localObject1 = new ayjs(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 3: 
          localObject1 = new ayko(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 4: 
          localObject1 = new ayjt(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 7: 
          localObject1 = new aykb(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 6: 
          localObject1 = new aykk(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 8: 
          localObject1 = new aykh(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 9: 
          localObject1 = new ayki(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 11: 
          localObject1 = new ayjy(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 12: 
          localObject1 = new ayjw(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 13: 
          localObject1 = new ayjz(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 14: 
          localObject1 = new aykj(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 15: 
          localObject1 = new aykg(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 16: 
          localObject1 = new ayke(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 17: 
          localObject1 = new aykf(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
        case 18: 
          localObject1 = new aykd(paramString, paramLong, localArrayList1, (UnifySearchCommon.ResultItem)localObject3, paramInt);
          break;
          l2 = l1 - 1L;
          continue;
          label939:
          ...
          {
            localObject1 = new ayku(paramString, str7, -4, str5);
            ((ayku)localObject1).r = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
            localArrayList2.add(localObject1);
            l2 = l1;
          }
          else
          {
            localObject1 = new ayij(paramString, (String)localObject1, str4, str5, str6, str7, l2, localArrayList1, paramInt);
            l2 = l1;
            if (localObject1 != null)
            {
              ((ayij)localObject1).r = ((UnifySearchCommon.ResultItem)localObject3).seporator_type.get();
              ((ayij)localObject1).c = bool1;
              ((ayij)localObject1).g = i;
              ((ayij)localObject1).a = paramInt;
              localArrayList2.add(localObject1);
              l2 = l1;
            }
          }
      ...
      for (boolean bool3 = true;; bool3 = false)
      {
        ...
        paramList.add(new ayje(paramString, paramLong, str1, localArrayList2, l1, (String)localObject1, (String)localObject2, localArrayList1, bool1, bool2, bool3, str2, str3));
        return;
        bool2 = false;
        break;
      }
      label1262:
      paramList.add(new ayii(paramString, paramLong, str1, localArrayList2, l1, (String)localObject1, (String)localObject2, localArrayList1, bool1, bool2, bool3, str2, str3));
      return;
    }
  }
  ...
  {
    return bdcs.a(BaseApplication.getContext().getFileStreamPath(paramString));
  }
  ...
  public void b(ToServiceMsg paramToServiceMsg, int paramInt, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        bdiv.b(this.app.getCurrentAccountUin(), i, paramInt);
        paramToServiceMsg = localRspBody.result_items.get();
        paramToServiceMsg = ayks.b(this.app, paramToServiceMsg, i);
        if (QLog.isColorLevel()) {
