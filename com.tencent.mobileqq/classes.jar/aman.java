...
{
  aman(RockDownloaderTask paramRockDownloaderTask) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (1 == paramInt)
    {
      ...
      if (localObject == null)
      {
        ...
        {
          this.a.getRockDownloadListener().onDownloadFail(this.a.getDownloadInfo(), ajya.a(2131713500), 10003);
          this.a.getRockDownloadListener().onDownloadFinish(this.a.getDownloadInfo());
        }
        amam.a(this.a, "0x800A1E6");
      }
    }
    else
    {
