...
public class ahmi
{
  ...
  public static RecentBaseData a(RecentUser paramRecentUser, QQAppInterface paramQQAppInterface, Context paramContext, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        {
          ahop.a(paramQQAppInterface.getApp(), false, paramRecentUser);
      ...
      continue;
      if (TextUtils.equals(paramRecentUser.uin, ajsf.az))
      {
        localObject1 = localObject3;
  ...
  public static void a(List<RecentUser> paramList, QQAppInterface paramQQAppInterface, Context paramContext, List<RecentBaseData> paramList1, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        bfwd.a(((RecentUser)localObject2).uin);
        String str = ahnn.a(((RecentUser)localObject2).uin, ((RecentUser)localObject2).getType());
        Object localObject1 = ahnn.a().a(str);
        if (localObject1 == null)
        {
        ...
        else
        {
          ...
          {
            ahop.a(paramContext, false, paramList);
