  ...
  extends RecyclerView.LayoutManager
{
  ...
  public xio(Context paramContext, int paramInt)
  {
  ...
  public void scrollToPosition(int paramInt)
  {
    ...
    {
      return;
      f1 = paramInt * this.jdField_f_of_type_Float;
    } while (f1 == this.jdField_e_of_type_Float);
    this.jdField_e_of_type_Float = f1;
    a();
    requestLayout();
  ...
  {
    paramRecyclerView = new xip(this, paramRecyclerView.getContext());
