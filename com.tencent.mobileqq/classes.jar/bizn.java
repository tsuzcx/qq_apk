...
{
  bizn(bizl parambizl, RequestEvent paramRequestEvent, String paramString) {}
  ...
  public void onCallback(EIPCResult paramEIPCResult)
  {
    ...
    atxy.a(bizl.a(this.jdField_a_of_type_Bizl).getAttachedActivity(), this.jdField_a_of_type_JavaLangString, j);
    if (this.jdField_a_of_type_ComTencentQqminiSdkLauncherCoreModelRequestEvent != null)
    {
