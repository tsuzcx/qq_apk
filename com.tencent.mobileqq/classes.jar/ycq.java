  ...
  implements wnt
{
  ...
  public HashMap<String, WeakReference<ycs>> a;
  public List<HotSortVideoEntry> a;
  yda a;
  protected boolean a;
  protected boolean b;
  
  public ycq(Context paramContext, boolean paramBoolean)
  {
    super(paramContext);
  ...
  private static void b(ImageView paramImageView, int paramInt, String paramString)
  {
    if (paramImageView == null) {
      yuk.e("Q.qqstory.shareGroup.ShareGroupsListAdapter", "update imageView error. imageView is null.");
    }
    do
    {
      return;
    ...
    zps.b(paramImageView, zpp.a(paramString), 80, 80, null, "StoryDiscoverHeadImage");
  }
  ...
  protected View a(int paramInt, ViewGroup paramViewGroup)
  {
    ...
    if (paramInt == 1)
    {
      localView = localLayoutInflater.inflate(2131561844, paramViewGroup, false);
      localView.setTag(new ycs(localView, this));
    }
    do
    {
      return localView;
      if (paramInt == 0)
      {
        paramViewGroup = localLayoutInflater.inflate(2131561779, paramViewGroup, false);
        paramViewGroup.setTag(new ycx(paramViewGroup, this));
        return paramViewGroup;
      }
      if (paramInt == 2)
      {
        paramViewGroup = localLayoutInflater.inflate(2131561843, paramViewGroup, false);
        paramViewGroup.setTag(new ycw(paramViewGroup, this));
        return paramViewGroup;
      }
    } while (paramInt != 7);
    paramViewGroup = localLayoutInflater.inflate(2131561840, paramViewGroup, false);
    paramViewGroup.setTag(new ycv(paramViewGroup, this));
    return paramViewGroup;
  }
  ...
  public void a(String paramString, List<ykj> paramList)
  {
    ...
    if ((paramList != null) && (paramList.get() != null))
    {
      ...
      ((ycs)paramList.get()).a.setData(localVideoCollectionItem);
    }
    label55:
    while (!QLog.isColorLevel()) {
      return;
  ...
  public void a(yda paramyda)
  {
    super.a(paramyda, paramyda);
