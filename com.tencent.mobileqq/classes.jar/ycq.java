...
public class ycq
  implements wja
{
  private vzl<String, FeedVideoInfo> a = new vzl(300);
  ...
  public FeedVideoInfo a(int paramInt1, String paramString1, int paramInt2, List<StoryVideoItem> paramList, String paramString2, boolean paramBoolean1, int paramInt3, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (ykq.a()) {
          ykq.b("Q.qqstory.home.data.FeedVideoManager", "**before** update feed video list:" + localFeedVideoInfo);
        }
        ...
        paramString1 = new ycr(paramString1, paramInt1);
        wad.a().dispatch(paramString1);
        if (ykq.a()) {
          ykq.a("Q.qqstory.home.data.FeedVideoManager", "**after** update feed video list:%s", paramList);
        }
  ...
  public FeedVideoInfo a(String paramString, int paramInt)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 20	ycq:a	Lvzl;
    //   6: aload_0
    //   7: aload_1
    //   8: iload_2
    //   9: invokespecial 68	ycq:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   12: invokevirtual 71	vzl:a	(Ljava/lang/Object;)Lvzk;
    ...
    //   82: invokestatic 87	ykq:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   85: aload_3
    //   86: astore_1
    //   87: goto -64 -> 23
    //   90: astore_1
  ...
  public void a(FeedVideoInfo paramFeedVideoInfo)
  {
    ...
    new xwn(4, paramFeedVideoInfo).c();
    ykq.d("Q.qqstory.home.data.FeedVideoManager", "triggerSyncVideoList for %s", new Object[] { paramFeedVideoInfo });
  }
