  ...
  implements View.OnClickListener
{
  ...
  apuc jdField_a_of_type_Apuc = new wjs(this);
  ...
  public wjq(Context paramContext, View paramView, wjt paramwjt)
  {
  ...
  private void e()
  {
    ((PatchedButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131367006)).setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(this);
    this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new wjr(this);
  ...
  private void f()
  {
    wxe.b("Q.qqstory.detail.KeyboardAndEmojiManager", "on keyboard up. mIsForceChange = %s.", Boolean.valueOf(this.d));
    ...
    if (this.jdField_a_of_type_Wjt != null) {
      this.jdField_a_of_type_Wjt.b(this.d);
    }
    this.d = false;
  }
  ...
  private void g()
  {
    wxe.b("Q.qqstory.detail.KeyboardAndEmojiManager", "on keyboard down. mIsForceChange = %s.", Boolean.valueOf(this.d));
    ...
    {
      if (this.jdField_a_of_type_Wjt != null) {
        this.jdField_a_of_type_Wjt.c(bool);
      }
      this.c = false;
      this.d = false;
      return;
  ...
  {
    ((PatchedButton)this.jdField_a_of_type_AndroidViewView.findViewById(2131367006)).setText(paramString);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      wxe.b("Q.qqstory.detail.KeyboardAndEmojiManager", "setKeyBoardState: %s." + paramBoolean);
      return;
      label79:
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      } while ((this.jdField_a_of_type_Wjt != null) && (this.jdField_a_of_type_Wjt.b()));
      this.c = true;
      ...
      return;
    } while (this.jdField_a_of_type_Wjt == null);
    this.jdField_a_of_type_Wjt.d();
  }
}
