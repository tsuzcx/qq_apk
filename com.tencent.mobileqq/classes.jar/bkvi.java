...
public final class bkvi
{
  ...
  public static void a(Activity paramActivity)
  {
    ...
    if (DeviceProfileManager.a(paramActivity, arrayOfInteger, new amqv()) >= arrayOfInteger.length)
    {
  ...
  public static void a(Context paramContext)
  {
    ...
    localBusinessTask.a(new bkvj(paramContext), true);
    localBusinessTask.a();
  }
