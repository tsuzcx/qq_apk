  ...
  implements Manager
{
  ...
  public String a;
  ArrayList<anze> jdField_a_of_type_JavaUtilArrayList = new ArrayList(2);
  ...
  public anzc(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_a_of_type_Bhyn = new anzd(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Apac = ((apac)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.GET_ROAMMESSAGE_HANDLER));
    this.jdField_a_of_type_Aohj = ((aohj)paramQQAppInterface.getCacheManager().getCache(2));
  ...
  private List<MessageRecord> a(String paramString1, String paramString2, String paramString3)
  {
    ...
    paramString1 = bhff.a(paramString2, paramString1, localSQLiteDatabase, paramString3, null);
    ...
    return ((azhs)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createMessageRecordEntityManager()).a(paramString1.toString(), null, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  private void a(List<MessageRecord> paramList1, Pair<Long, Long> paramPair, List<MessageRecord> paramList2, String paramString, long paramLong)
  {
    if (((MessageRecord)paramList1.get(paramList1.size() - 1)).time <= ((Long)paramPair.second).longValue())
    {
      ...
      {
        paramPair = this.jdField_a_of_type_Aohj;
      ...
      for (paramList1 = this.jdField_a_of_type_JavaLangString;; paramList1 = paramString)
      {
        ...
        paramList1 = this.jdField_a_of_type_Aohj;
        if (this.jdField_a_of_type_JavaLangString != null) {
          paramString = this.jdField_a_of_type_JavaLangString;
        }
        paramList1.b(paramString, paramLong - 5L, 0);
        bhbx.a("Q.roammsg.MessageRoamManager", new Object[] { "judgeClearRoamDateIndex: " + paramLong });
        if (this.jdField_a_of_type_JavaLangString != null) {
          b(paramLong);
        }
        return;
    ...
    for (;;)
    {
      ...
      {
        paramList2 = this.jdField_a_of_type_Aohj;
        if (this.jdField_a_of_type_JavaLangString == null) {
          break label619;
        }
      ...
      if (this.jdField_a_of_type_JavaLangString != null)
      {
        ...
        paramList1 = "null";
        label478:
        bhbx.a("Q.roammsg.MessageRoamManager", new Object[] { paramList1 });
  ...
  private boolean a(Calendar paramCalendar)
  {
    ...
    paramCalendar = this.jdField_a_of_type_Aohj.a(this.jdField_a_of_type_JavaLangString, i, j + 1);
  ...
  private boolean a(JSONObject paramJSONObject)
  {
    ...
    {
      bhbx.a("Q.roammsg.MessageRoamManager", new Object[] { "parseCloudSearchCfg Field[lastNumber]: " + paramJSONObject + ", matchLastNumber: " + bool1 });
      return bool1;
    }
  }
  ...
  private void b(int paramInt, Calendar paramCalendar, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (paramCalendar != null)
        {
          localRoamMessagePreloadInfo = this.jdField_a_of_type_Aohj.a(this.jdField_a_of_type_JavaLangString, paramCalendar, 0);
          localObject = null;
          break;
        }
        if ((paramInt == 3) && (this.jdField_a_of_type_JavaUtilCalendar != null))
        {
          localRoamMessagePreloadInfo = this.jdField_a_of_type_Aohj.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaUtilCalendar, 2);
          localObject = null;
          break;
        }
        ...
        localRoamMessagePreloadInfo = this.jdField_a_of_type_Aohj.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaUtilCalendar, 1);
        localObject = null;
        break;
  ...
  private void b(long paramLong)
  {
    ...
    if (this.jdField_a_of_type_Boolean) {
      ...
      {
        localCalendar = this.jdField_a_of_type_Aohj.b(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaUtilCalendar, null);
        ...
        do
        {
          do
          {
            do
            {
              ...
              localCalendar = this.jdField_a_of_type_Aohj.a(this.jdField_a_of_type_JavaLangString, this.jdField_c_of_type_JavaUtilCalendar, null);
  ...
  private boolean b(Calendar paramCalendar)
  {
    ...
    if ((l > ((Long)localPair.first).longValue()) && (l <= ((Long)localPair.second).longValue()))
    {
      ...
      if (paramCalendar != null)
      {
        ...
        this.jdField_a_of_type_Aohj.a(paramCalendar);
      }
      return true;
    }
    return false;
  ...
  private boolean b(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      bhbx.a("Q.roammsg.MessageRoamManager", new Object[] { "parseCloudSearchCfg Field[userType]: " + paramJSONObject });
      return bool;
      bool = false;
    }
  }
  ...
  public int a(String paramString, int paramInt, StringBuilder paramStringBuilder)
  {
    ...
    for (paramString = bhff.a(MessageRecord.getOldTableName(paramString, paramInt), MessageRecord.getTableName(paramString, paramInt), localSQLiteDatabase, "", localStringBuilder.toString(), ""); paramString == null; paramString = bhff.a(MessageRecord.getOldTableName(paramString, paramInt), MessageRecord.getTableName(paramString, paramInt), localSQLiteDatabase, localStringBuilder.toString()))
    {
      return 0;
  ...
  public int a(String paramString, long paramLong1, long paramLong2)
  {
    ...
    paramString = a(MessageRecord.getTableName(paramString, 0), null, "( msgtype " + acnh.b() + " and isValid=1 and " + str + " ) " + "ORDER BY time asc , longMsgIndex asc", paramLong1, paramLong2);
    if (paramString == null) {
      return 0;
    }
  ...
  {
    List localList = this.jdField_a_of_type_Aohj.a();
    int m;
    int n;
    int i1;
    int i;
    if (!localList.isEmpty())
    {
      ...
      paramCalendar = this.jdField_a_of_type_Aohj.a(this.jdField_a_of_type_JavaLangString, m, n);
      i = 0;
      if (i >= localList.size()) {
        break label383;
      }
    ...
    for (;;)
    {
      if (i < localList.size())
      {
        ...
        str = this.jdField_a_of_type_Aohj.a(str)[1];
        ...
        for (;;)
        {
          ...
          if ((paramCalendar.getSerState(j - 1) == 2) && (NetworkUtil.isNetSupport(BaseApplication.getContext())))
          {
            paramCalendar = new Bundle();
  ...
  public aohj a()
  {
    return this.jdField_a_of_type_Aohj;
  }
  
  public RoamMessagePreloadInfo a(int paramInt)
  {
    return this.jdField_a_of_type_Aohj.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_JavaUtilCalendar, paramInt);
  }
  ...
  public List<MessageRecord> a()
  {
    ...
    for (;;)
    {
      ...
      localObject2 = "( msgtype " + acnh.b() + " and isValid=1 ) " + "ORDER BY time asc , longMsgIndex asc";
      ...
      try
      {
        ...
        if (localazil != null)
        {
          localObject2 = localazil.a((String)localObject1, (String)localObject2);
  ...
  {
    Object localObject = (azil)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.SLOW_TABLE_MANAGER);
    if (localObject == null) {
    ...
    {
      return paramString3;
      this.jdField_a_of_type_Long = ((azil)localObject).a(paramString1);
      if (this.jdField_a_of_type_Long <= paramLong2) {
        break label169;
      }
      paramString2 = "slowTable";
      paramString1 = ((azil)localObject).a(paramString1, paramString3);
      if (paramString1 != null) {
        break;
      }
      i = 0;
    ...
    for (int k = 0;; k = paramString1.size())
    {
      ...
      localObject = ((azil)localObject).a(paramString1, paramString3);
      label236:
      String str;
      if (localObject == null)
      {
  ...
  public void a(int paramInt1, int paramInt2, Object paramObject)
  {
    ...
    {
      ((anze)this.jdField_a_of_type_JavaUtilArrayList.get(i)).b(paramInt1, paramInt2, paramObject);
      i += 1;
    }
  }
  ...
  public void a(anze paramanze)
  {
    ...
    while (localIterator.hasNext()) {
      ((anze)localIterator.next()).a(paramanze);
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(paramanze);
  }
  
  void a(bhyo parambhyo)
  {
    if ((parambhyo.jdField_a_of_type_Int == 0) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
    {
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences().edit().putLong("cloudSearchCfgLastModify", parambhyo.i).commit();
      if (200 == parambhyo.f) {
    ...
    if (QLog.isColorLevel())
    {
      File localFile = new File(anzb.b);
      long l = 0L;
      if (localFile.exists()) {
        l = localFile.lastModified();
      }
      QLog.d("Q.roammsg.MessageRoamManager", 2, "onDone status=" + parambhyo.a() + ",errCode=" + parambhyo.jdField_a_of_type_Int + ",httpCode=" + parambhyo.f + ",local lastModify=" + l + ",server lastModify=" + parambhyo.i);
    }
  }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList == null)
    {
      ...
      if ((paramBoolean) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade() != null)) {
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().destroyChatActivity();
      }
      this.jdField_a_of_type_JavaLangString = paramString;
      this.jdField_a_of_type_Aohj.a(paramString);
  ...
  public void a(Calendar paramCalendar, RoamMessagePreloadInfo paramRoamMessagePreloadInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      RoamDate localRoamDate = this.jdField_a_of_type_Aohj.a(this.jdField_a_of_type_JavaLangString, i, j);
      ...
      case 1: 
      case 2: 
        bool = NetworkUtil.isNetSupport(BaseApplication.getContext());
        if ((n != 2) || (!bool)) {
          break label486;
        }
        a(26, null);
        ...
        this.jdField_a_of_type_Apac.a(this.jdField_a_of_type_JavaLangString, paramCalendar, paramBoolean1, 8, false, paramBoolean2);
      ...
      case 3: 
        ...
        while ((NetworkUtil.isNetSupport(BaseApplication.getContext())) && (paramRoamMessagePreloadInfo != null))
        {
          this.jdField_a_of_type_JavaUtilHashMap.clear();
          this.jdField_a_of_type_JavaUtilHashMap.put(this.jdField_a_of_type_JavaUtilCalendar, paramRoamMessagePreloadInfo);
  ...
  public void a(List<MessageRecord> paramList, String paramString, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Long = localazil.a(paramString);
    ...
    if ((i >= j) || (((MessageRecord)paramList.get(i)).time > this.jdField_a_of_type_Long))
    {
      ...
      localazil.a(paramString, paramList.subList(0, i));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().addMessagePoolOnly(paramList.subList(i, j), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramBoolean);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
      ...
      break;
      label220:
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().addMessage(paramList, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramBoolean);
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (paramBoolean)
      {
        ...
        {
          a(26, null);
          this.jdField_a_of_type_Apac.a(this.jdField_a_of_type_JavaLangString, 0, 1, i, j + 1, k);
          return;
          paramBoolean = false;
          break;
          label100:
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Apac.b(paramInt));
    r();
    return (this.jdField_a_of_type_Apac.a == null) || (this.jdField_a_of_type_Apac.a.size() == 0);
  }
  ...
  public BitSet b(Calendar paramCalendar1, Calendar paramCalendar2)
  {
    ...
    if (!localList.isEmpty())
    {
      ...
      if ((localCalendar.before(paramCalendar2)) || (localCalendar.equals(paramCalendar2)))
      {
        ...
        localCalendar.get(5);
        paramCalendar1 = this.jdField_a_of_type_Aohj.a(this.jdField_a_of_type_JavaLangString, n, i1);
        int j = 0;
        int m = 0;
        while (j < localList.size())
        {
          ...
          if (((String)((Map.Entry)localList.get(j)).getKey()).equals(paramCalendar1))
          {
            ...
            {
              if (this.jdField_a_of_type_Aohj.a(localRoamDate, k - 1))
              {
                localBitSet.set(i, true);
                if (QLog.isColorLevel()) {
  ...
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Apac.a(paramInt));
  }
  ...
  public void b(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    List localList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().getMsgList(this.jdField_a_of_type_JavaLangString, 0);
    Object localObject;
    if (localList != null)
    {
    ...
    if ((localObject != null) && (!((List)localObject).isEmpty()) && (b(((MessageRecord)((List)localObject).get(((List)localObject).size() - 1)).time, (Calendar)localCalendar.clone())))
    {
      ...
      this.jdField_a_of_type_Aohj.a(this.jdField_a_of_type_JavaLangString, localCalendar.getTimeInMillis() / 1000L, 2);
    }
  }
  
  public void b(anze paramanze)
  {
    this.jdField_a_of_type_JavaUtilArrayList.remove(paramanze);
  }
  
  void b(bhyo parambhyo)
  {
    boolean bool = true;
    Object localObject;
    ...
    if ((parambhyo.a() == 3) && (parambhyo.jdField_a_of_type_Int == 0))
    {
      ...
      localObject = new File(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getFilesDir(), parambhyo.jdField_a_of_type_JavaLangString);
      if (((File)localObject).exists())
      {
        parambhyo = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getSharedPreferences("vip_message_roam_banner_file", 0);
        localEditor = parambhyo.edit();
      }
    }
    for (;;)
    {
      ...
      try
      {
        localObject = new JSONArray(FileUtils.readFileContent((File)localObject));
        i = 0;
        ...
        if (bool)
        {
          parambhyo.edit().putLong("blue_banner_last_update_timestamp", NetConnInfoCenter.getServerTimeMillis()).commit();
          return;
        }
        if (!QLog.isColorLevel()) {
          break label482;
      ...
      catch (JSONException parambhyo)
      {
        ...
        QLog.e("Q.roammsg.MessageRoamManager", 2, "JSONException,blue banner parse json error : " + parambhyo.toString());
        return;
      }
      ...
      QLog.e("Q.roammsg.MessageRoamManager", 2, "Exception,blue banner parse json error : " + parambhyo.toString());
      return;
      if (QLog.isColorLevel())
      {
        ...
        if (QLog.isColorLevel())
        {
          QLog.e("Q.roammsg.MessageRoamManager", 2, "blue banner download failed, task.status = " + parambhyo.a() + " , task.errCode = " + parambhyo.jdField_a_of_type_Int);
          return;
          label477:
          bool = false;
          continue;
  ...
  public void b(MessageRecord paramMessageRecord)
  {
    ...
    long l = paramMessageRecord.time;
    if (this.jdField_a_of_type_JavaLangString == null) {
      this.jdField_a_of_type_Aohj.a(str);
    }
    ...
    if (this.jdField_a_of_type_JavaLangString != null)
    {
      ...
      localObject = "null";
      label150:
      bhbx.a("Q.roammsg.MessageRoamManager", new Object[] { localObject });
      ...
      if ((paramMessageRecord instanceof MessageForLongMsg))
      {
        ...
        bhbx.a("Q.roammsg.MessageRoamManager", new Object[] { "judgeClearRoamDateIndex: delList.size() = " + ((List)localObject).size() });
      }
      ...
      {
        localObject = this.jdField_a_of_type_Aohj;
        if (this.jdField_a_of_type_JavaLangString == null) {
          break label416;
        }
        paramMessageRecord = this.jdField_a_of_type_JavaLangString;
        label285:
        ((aohj)localObject).a(paramMessageRecord, l - 5L, 1);
        paramMessageRecord = this.jdField_a_of_type_Aohj;
        if (this.jdField_a_of_type_JavaLangString != null) {
          str = this.jdField_a_of_type_JavaLangString;
        }
        paramMessageRecord.b(str, l - 5L, 0);
        bhbx.a("Q.roammsg.MessageRoamManager", new Object[] { "judgeClearRoamDateIndex: " + l });
        if (this.jdField_a_of_type_JavaLangString != null) {
          b(l);
        }
      }
  ...
  public void b(Calendar paramCalendar, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      paramCalendar = this.jdField_a_of_type_Aohj.a(this.jdField_a_of_type_JavaLangString, i, j);
    ...
    this.jdField_a_of_type_Apac.a(this.jdField_a_of_type_JavaLangString, paramCalendar, false, 0, true, paramBoolean);
  }
  ...
  public void b(boolean paramBoolean)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext()) {
      ((anze)localIterator.next()).a(paramBoolean, null);
    }
  }
      ...
      if ((localCalendar.before(paramCalendar2)) || (localCalendar.equals(paramCalendar2)))
      {
        ...
        while (j < localList.size())
        {
          ...
          if (((String)((Map.Entry)localList.get(j)).getKey()).equals(paramCalendar1))
          {
            ...
            if (k <= RoamDate.getDays(n, i1))
            {
              if ((i == 0) && (!this.jdField_a_of_type_Aohj.a(localRoamDate, k - 1)))
              {
                c();
                a(18, null);
                if (QLog.isColorLevel()) {
  ...
  public void c()
  {
    Object localObject = this.jdField_a_of_type_Aohj.a();
    if (localObject != null)
    {
      if (QLog.isColorLevel())
      {
  ...
  public void e()
  {
    ...
    for (;;)
    {
      ...
      str2 = "( msgtype " + acnh.b() + " and isValid=1 and" + str2 + " ) " + "ORDER BY time asc , longMsgIndex asc";
    ...
    for (;;)
    {
      ...
      case 2: 
        ...
        if ((n == 2) && (bool))
        {
          ...
          paramCalendar.setTime(new Date(i - 1900, j - 1, k));
          QLog.d("Q.roammsg.MessageRoamManager", 1, "handleRoamDateQuery getRoamHistoryForSomeDay year = " + i + " month = " + j + " day = " + k + " call stack = " + Log.getStackTraceString(new Throwable()));
          this.jdField_a_of_type_Apac.a(this.jdField_a_of_type_JavaLangString, paramCalendar, false, 8, false);
          return;
        }
        break;
      case 3: 
        ...
        while (paramCalendar.hasNext()) {
          ((anze)paramCalendar.next()).a(true, null);
        }
        break;
      }
      if (QLog.isColorLevel()) {
      ...
      paramCalendar = this.jdField_a_of_type_JavaUtilArrayList.iterator();
      while (paramCalendar.hasNext()) {
        ((anze)paramCalendar.next()).a(false, null);
      }
    }
  }
  ...
  public void e(boolean paramBoolean)
  {
    ...
    {
      localObject = ((bhyq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.DOWNLOADER_FACTORY)).a(1);
      if ((localObject != null) && (((bhyt)localObject).a("https://imgcache.qq.com/club/mobile/messageroam/xiaoximanyou2.json") == null))
      {
        bhyo localbhyo = new bhyo("https://imgcache.qq.com/club/mobile/messageroam/xiaoximanyou2.json", new File(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getFilesDir(), "https://imgcache.qq.com/club/mobile/messageroam/xiaoximanyou2.json"));
        localbhyo.p = false;
        ((bhyt)localObject).a(localbhyo, this.jdField_a_of_type_Bhyn, null);
      }
    }
  }
  ...
  public void m()
  {
    ...
    for (;;)
    {
      ...
      for (int k = 0; localIterator.hasNext(); k = m)
      {
        ...
        RoamDate localRoamDate = this.jdField_a_of_type_Aohj.a(this.jdField_a_of_type_JavaLangString, m, n);
        localObject = localRoamDate;
        if (localRoamDate == null) {
          localObject = new RoamDate(String.valueOf(this.jdField_a_of_type_JavaLangString), this.jdField_a_of_type_Aohj.a(m, n));
        }
        if (2 != ((RoamDate)localObject).getSerState(i1 - 1))
        {
          ((RoamDate)localObject).setLocState(i1 - 1, 3);
          this.jdField_a_of_type_Aohj.a((RoamDate)localObject);
        }
        i = i1;
        j = n;
      }
  ...
  public void o()
  {
    bhbx.a("Q.roammsg.MessageRoamManager", new Object[] { "parseCloudSearchCfg start...." });
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject))
      {
        try
        {
          ...
          if (i < ((JSONArray)localObject).length())
          {
            ...
            {
              bhbx.a("Q.roammsg.MessageRoamManager", new Object[] { "curr ver: 8.4.10, config qqVer:" + str });
            }
            else
            {
              str = localJSONObject.getString("canSearchInCloud");
              if (!"1".equals(str)) {
                bhbx.a("Q.roammsg.MessageRoamManager", new Object[] { "parseCloudSearchCfg Field[canSearchInCloud]: " + str });
              }
            }
          }
        }
        ...
        bhbx.a("Q.roammsg.MessageRoamManager", new Object[] { "parseCloudSearchCfg done .... canCloudSearch: " + this.jdField_c_of_type_Boolean });
        return;
    ...
    for (;;)
    {
      if (j < k)
      {
        if (arrayOfString[j].equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
        {
          ...
          bhbx.a("Q.roammsg.MessageRoamManager", new Object[] { "match Field[whitlist]:" + str });
        }
      }
      else
      {
        ...
        if (!bool1)
        {
          bhbx.a("Q.roammsg.MessageRoamManager", new Object[] { "parseCloudSearchCfg  matchUserType: " + bool1 });
        }
        else
        {
          ...
          if ((bool1) && (bool2))
          {
            this.jdField_c_of_type_Boolean = true;
            break label265;
            bhbx.a("Q.roammsg.MessageRoamManager", new Object[] { "parseCloudSearchCfg json text is empty" });
            break label265;
            bhbx.a("Q.roammsg.MessageRoamManager", new Object[] { "parseCloudSearchCfg file not exist" });
            break label265;
          }
        }
        i += 1;
