  ...
  implements Manager
{
  ...
  private static final String[] b = { "", anzj.a(2131712450), anzj.a(2131712446) };
  protected SparseArray<String[]> a;
  protected final QQAppInterface a;
  protected LinkedHashMap<String, bgqe> a;
  
  static
  {
    jdField_a_of_type_JavaLangString = ".troop.school_troop." + bgqd.class.getSimpleName();
    jdField_a_of_type_ArrayOfJavaLangString = new String[] { "", anzj.a(2131712447), anzj.a(2131712449) };
  }
  
  public bgqd(QQAppInterface paramQQAppInterface)
  {
  ...
  public bgqe a(SessionInfo paramSessionInfo, MessageRecord paramMessageRecord)
  {
    ...
    do
    {
      ...
      str1 = l2 + "_" + i;
      localbgqe = (bgqe)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(str1);
      if (localbgqe == null) {
        break;
      }
      paramSessionInfo = localbgqe;
    ...
    bgqe localbgqe = new bgqe();
    localbgqe.jdField_a_of_type_Long = l2;
    localbgqe.jdField_a_of_type_Int = i;
    localbgqe.jdField_a_of_type_JavaLangString = paramSessionInfo.jdField_a_of_type_JavaLangString;
    localbgqe.a(paramMessageRecord);
    ...
    while (i < k)
    {
      ...
      while (j < n)
      {
        ...
        if (i1 != -1)
        {
          localbgqe.jdField_b_of_type_Int = m;
          localbgqe.jdField_b_of_type_JavaLangString = str2;
          localbgqe.c = i1;
          localbgqe.d = (str2.length() + i1);
          this.jdField_a_of_type_JavaUtilLinkedHashMap.put(str1, localbgqe);
          return localbgqe;
        }
        j += 1;
      }
    ...
    localbgqe.jdField_b_of_type_Int = -1;
    this.jdField_a_of_type_JavaUtilLinkedHashMap.put(str1, localbgqe);
    if (QLog.isColorLevel()) {
      QLog.i(jdField_a_of_type_JavaLangString, 2, "detectKeyword time cost: " + (System.currentTimeMillis() - l1) + ", result = " + localbgqe.jdField_b_of_type_Int);
    }
    return localbgqe;
  }
