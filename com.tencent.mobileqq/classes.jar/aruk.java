...
public class aruk
  extends arum
{
  public aruk(Intent paramIntent)
  {
    super(paramIntent);
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    anjs.a(paramQQAppInterface, this.jdField_a_of_type_AndroidOsBundle.getString("forward_ark_app_name"), this.jdField_a_of_type_AndroidOsBundle.getString("forward_ark_app_view"));
  }
  ...
  protected boolean a(String paramString1, int paramInt1, String paramString2, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      paramString2 = (ArkAppMessage)anjp.a(2, paramString2, this.jdField_a_of_type_AndroidOsBundle, paramString1);
      ...
      for (;;)
      {
        ...
        {
          acex.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localSessionInfo, paramString1, paramInt1);
          return true;
          label602:
  ...
  protected void d()
  {
    ...
    {
      return;
      azmj.b(null, "dc00898", "", "", "0X800A631", "0X800A631", 0, 0, str1, ForwardUtils.b(i), str2, "");
  ...
  public void e()
  {
    ...
    if ((!TextUtils.isEmpty(str1)) && (!TextUtils.isEmpty(str2))) {
      anfp.a(str1, str3, str2, new arul(this));
    }
  }
}
