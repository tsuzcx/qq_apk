...
{
  awzm(awyf paramawyf, String paramString) {}
  
  public void onClick(View paramView)
  {
    bcek localbcek = new bcek(this.jdField_a_of_type_Awyf.jdField_a_of_type_ComTencentMobileqqNearbyProfilecardNearbyPeopleProfileActivity.app).b("grp_lbs").c("data_card").d("live_clk").e(awyf.a(this.jdField_a_of_type_Awyf).uin);
    Object localObject;
