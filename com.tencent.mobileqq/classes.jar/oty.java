  ...
  implements AladdinConfigHandler
{
  public static JSONObject a()
  {
    ...
    try
    {
      Object localObject = Aladdin.getConfig(291);
      if (localObject == null) {
  ...
  public static int[] a()
  {
    ...
    //   20: aload_1
    //   21: ldc 108
    //   23: invokevirtual 112	java/lang/String:split	(Ljava/lang/String;)[Ljava/lang/String;
    //   26: astore_3
    //   27: aload_3
    //   28: arraylength
    //   29: ifne +5 -> 34
    ...
    //   52: iload_0
    //   53: aaload
    //   54: invokestatic 118	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   57: iastore
    //   58: iload_0
    //   59: iconst_1
    //   60: iadd
    ...
    //   66: ldc 68
    //   68: iconst_1
    //   69: new 70	java/lang/StringBuilder
    //   72: dup
    //   73: invokespecial 71	java/lang/StringBuilder:<init>	()V
    //   76: ldc 120
    //   78: invokevirtual 77	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   81: aload_1
    //   82: invokevirtual 81	java/lang/Throwable:getMessage	()Ljava/lang/String;
    ...
    //   91: invokestatic 90	com/tencent/TMG/utils/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   94: aconst_null
    //   95: astore_1
    //   96: aload_1
    //   97: areturn
  ...
  public boolean onReceiveConfig(int paramInt1, int paramInt2, String paramString)
  {
    try
    {
      paramString = osq.a(paramString).entrySet().iterator();
