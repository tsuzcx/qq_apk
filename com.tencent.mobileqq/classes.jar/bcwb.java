...
class bcwb
  extends bcoc
{
  bcwb(bcvo parambcvo, int paramInt, String paramString, MessageForDeliverGiftTips paramMessageForDeliverGiftTips, boolean paramBoolean) {}
  ...
  public void a(int paramInt, oidb_0x962.RspBody paramRspBody)
  {
    ...
    if ((this.jdField_a_of_type_Bcvo.a != null) && (this.jdField_a_of_type_Boolean)) {
      this.jdField_a_of_type_Bcvo.a.a.getEntityManagerFactory().createEntityManager().a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips);
    }
  }
}
