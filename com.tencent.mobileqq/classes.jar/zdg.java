...
public class zdg
{
  ...
  private wgk jdField_a_of_type_Wgk = new wgk();
  ArrayList<bhkn> b;
  private ArrayList<zdw> jdField_c_of_type_JavaUtilArrayList = new ArrayList();
  
  static
  {
    jdField_a_of_type_JavaLangString = BaseApplicationImpl.sApplication.getFilesDir() + File.separator + "blessVoiceChange.json";
    jdField_b_of_type_JavaLangString = anhk.ba + "voiceChange/bless/";
    jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
    a();
  }
  
  public zdg(EditVideoMusic paramEditVideoMusic, EditVideoParams paramEditVideoParams, Handler paramHandler)
  {
  ...
  private boolean a()
  {
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList == null)
    {
      ...
      if (i < ListenChangeVoicePanel.jdField_a_of_type_ArrayOfInt.length)
      {
        ...
        for (j = 0;; j = 2)
        {
          ((ArrayList)localObject1).add(new bhkn(k, (String)localObject4, (String)localObject5, 0, j, 1, new bhko(ListenChangeVoicePanel.jdField_b_of_type_ArrayOfInt[i], null, null, null)));
          i += 1;
          break;
        }
      }
    ...
    if (localObject1 == null)
    {
      ...
      {
        localObject1 = (bhkn)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject1 != null) {
          ((bhkn)localObject1).jdField_b_of_type_Int = 0;
        }
        i += 1;
      }
      return false;
    ...
    for (;;)
    {
      ...
      catch (Exception localException2)
      {
        ...
        localObject4 = (bhkn)localIterator.next();
        if (localArrayList.contains(Integer.valueOf(((bhkn)localObject4).jdField_a_of_type_Int))) {
          continue;
        }
        ((bhkn)localObject4).jdField_b_of_type_Int = 0;
        continue;
      ...
      {
        localObject5 = (bhkn)((Iterator)localObject4).next();
        if (!localArrayList.contains(Integer.valueOf(((bhkn)localObject5).jdField_a_of_type_Int))) {
          ((bhkn)localObject5).jdField_b_of_type_Int = 0;
        }
      }
      label929:
      j += 1;
    ...
    if (this.jdField_b_of_type_JavaUtilArrayList != null)
    {
      localObject3 = (bhkn)this.jdField_b_of_type_JavaUtilArrayList.get(j);
      label956:
      ...
      else
      {
        ...
        if (k != 0)
        {
          ...
          {
            j = k;
            if (bgyd.a(((JSONObject)localObject4).getString("QQVersion"), "8.4.1"))
            {
              k = 0;
              j = k;
              if (QLog.isColorLevel())
        ...
        if (j == 0)
        {
          ((bhkn)localObject3).jdField_b_of_type_Int = j;
        }
        else
        {
          ...
          for (;;)
          {
            ...
            ((bhkn)localObject3).d = 1;
            ((bhkn)localObject3).c = 0;
            if (!TextUtils.isEmpty(((JSONObject)localObject6).getString("name"))) {
              break label1364;
            }
            localObject4 = ((bhkn)localObject3).jdField_a_of_type_JavaLangString;
            label1225:
            ((bhkn)localObject3).jdField_a_of_type_JavaLangString = ((String)localObject4);
            if (!TextUtils.isEmpty(((JSONObject)localObject6).getString("description"))) {
              break label1377;
            }
            localObject4 = ((bhkn)localObject3).jdField_b_of_type_JavaLangString;
            label1253:
            ((bhkn)localObject3).jdField_b_of_type_JavaLangString = ((String)localObject4);
            ((bhkn)localObject3).jdField_a_of_type_Bhko.jdField_a_of_type_JavaLangString = ((String)localObject5);
            break label1632;
            localObject5 = bgwh.jdField_b_of_type_JavaLangString + (String)localObject5;
    ...
    for (int j = ((JSONObject)localObject4).getInt("tag");; j = 0)
    {
      ...
      if (localArrayList.size() > 0)
      {
        ...
        {
          localObject4 = (bhkn)((Iterator)localObject3).next();
          if (!localArrayList.contains(Integer.valueOf(((bhkn)localObject4).jdField_a_of_type_Int))) {
            ((bhkn)localObject4).jdField_b_of_type_Int = 0;
          }
        }
      ...
      while (i < this.jdField_b_of_type_JavaUtilArrayList.size())
      {
        localObject3 = (bhkn)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject3 != null) {
          ((bhkn)localObject3).jdField_b_of_type_Int = 0;
        }
        i += 1;
      }
      return true;
      ...
      while (i < this.jdField_b_of_type_JavaUtilArrayList.size())
      {
        localObject4 = (bhkn)this.jdField_b_of_type_JavaUtilArrayList.get(i);
        if (localObject4 != null) {
          ((bhkn)localObject4).jdField_b_of_type_Int = 0;
        }
        i += 1;
  ...
  private void d()
  {
    ...
    new zdh(this, this.jdField_a_of_type_Wgk, l).executeOnExecutor(Bosses.get().getExecutor(16), new wro[] { new wro(str1, str2, null) });
  }
  ...
  public void a(zdw paramzdw)
  {
    ...
    if (a((Object[])localObject2))
    {
      ...
      if (!localFile.exists()) {
        bgmg.a(new File((String)localObject1), localFile);
      }
      localObject2 = new bhkm((String)localObject2, i, 64000, 2, paramzdw.c);
      bhkp.a(BaseApplicationImpl.getContext(), (bhkm)localObject2, jdField_c_of_type_JavaLangString, new zdi(paramzdw, (String)localObject1), new bhkr(false, false, false, true, true, null));
      localObject1 = new Properties();
      ((Properties)localObject1).setProperty("bless_param_voice_id", "" + paramzdw.c);
      aipg.a("bless_event_voice_click", (Properties)localObject1);
    }
  }
  ...
  protected void b()
  {
    ...
    if (a((Object[])localObject))
    {
      ...
      if (localFile.exists()) {
        bgmg.a(localFile, new File((String)localObject));
      }
    }
  }
  ...
  public void c()
  {
    ...
    synchronized (this.jdField_c_of_type_JavaUtilArrayList)
    {
      ...
      {
        bhkn localbhkn = (bhkn)localIterator.next();
        if (localbhkn.jdField_b_of_type_Int == 2)
        {
          zdw localzdw = new zdw(4, localbhkn.jdField_a_of_type_JavaLangString, localbhkn.jdField_a_of_type_Bhko.jdField_a_of_type_Int, localbhkn.jdField_a_of_type_Int);
          if ((localbhkn.jdField_a_of_type_Bhko.jdField_a_of_type_Int == 0) && (!TextUtils.isEmpty(localbhkn.jdField_a_of_type_Bhko.jdField_a_of_type_JavaLangString))) {
            localzdw.g = (jdField_b_of_type_JavaLangString + localbhkn.jdField_a_of_type_Bhko.jdField_a_of_type_JavaLangString.substring(localbhkn.jdField_a_of_type_Bhko.jdField_a_of_type_JavaLangString.lastIndexOf("/") + 1));
          }
          this.jdField_c_of_type_JavaUtilArrayList.add(localzdw);
        }
      }
    }
