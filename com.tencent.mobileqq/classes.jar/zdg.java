  ...
  extends WebViewPlugin
{
  ...
  private SparseArray<WeakReference<zdi>> jdField_a_of_type_AndroidUtilSparseArray;
  ...
  zdi a(int paramInt)
  {
    ...
    Object localObject = new zdi(this, null);
    ((zdi)localObject).jdField_a_of_type_Int = paramInt;
    localObject = new WeakReference(localObject);
    this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, localObject);
    return (zdi)((WeakReference)localObject).get();
  }
  ...
  boolean a(int paramInt)
  {
    ...
    localObject = (zdi)((WeakReference)localObject).get();
    if (localObject == null) {
      return false;
    }
    try
  ...
  public void onDestroy()
  {
    ...
    if ((this.jdField_a_of_type_AndroidUtilSparseArray != null) && (this.jdField_a_of_type_AndroidUtilSparseArray.size() > 0))
    {
      ...
      {
        zdi localzdi = (zdi)((WeakReference)this.jdField_a_of_type_AndroidUtilSparseArray.get(i)).get();
        if (localzdi != null) {
          a(localzdi.jdField_a_of_type_Int);
        }
        i += 1;
      }
    }
