...
public class gk
  extends QIPCModule
{
  private static gk jdField_a_of_type_Gk;
  ...
  public static gk a()
  {
    try
    {
      if (jdField_a_of_type_Gk == null) {
        jdField_a_of_type_Gk = new gk("VasFontIPCModule");
      }
      gk localgk = jdField_a_of_type_Gk;
      return localgk;
    }
    finally {}
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    do
    {
      ...
      if (i.equals(paramString))
      {
        ...
        paramString.putInt("key_shield_font", gm.a);
