...
public class auwh
  extends autc
{
  public auwh(ChooseInterestTagActivity paramChooseInterestTagActivity) {}
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2, List<InterestTagInfo> paramList1, List<InterestTagInfo> paramList2, String paramString1, int paramInt3, int paramInt4, String paramString2)
  {
    ...
    do
    {
      do
      {
        ...
        if (ChooseInterestTagActivity.a(this.a).getVisibility() == 0)
        {
          ChooseInterestTagActivity.a(this.a).setText(alpo.a(2131702186));
          ChooseInterestTagActivity.a(this.a).setOnClickListener(null);
          return;
        }
      } while (ChooseInterestTagActivity.b(this.a).getVisibility() != 0);
      ChooseInterestTagActivity.b(this.a).setText(alpo.a(2131702150));
      ChooseInterestTagActivity.c(this.a).setVisibility(8);
      return;
      if ((paramList1 == null) || (paramList1.isEmpty()))
      {
        if (ChooseInterestTagActivity.a(this.a).getVisibility() == 0)
        {
          ChooseInterestTagActivity.a(this.a).setText(alpo.a(2131702164));
          ChooseInterestTagActivity.a(this.a).setOnClickListener(null);
          return;
        }
        if (ChooseInterestTagActivity.b(this.a).getVisibility() == 0)
        {
          ChooseInterestTagActivity.b(this.a).setText(alpo.a(2131702172));
    ...
    if (paramInt3 == 0)
    {
      ...
      ChooseInterestTagActivity.a(this.a, new auwm(this.a, ChooseInterestTagActivity.a(this.a), ChooseInterestTagActivity.b(this.a), ChooseInterestTagActivity.a(this.a)));
      ChooseInterestTagActivity.a(this.a).setAdapter(ChooseInterestTagActivity.a(this.a));
      label765:
  ...
  public void a(boolean paramBoolean, String paramString1, List<auwl> paramList, String paramString2, int paramInt1, int paramInt2)
  {
    if (!paramBoolean)
    {
      if (TextUtils.isEmpty(paramString2))
      {
        ChooseInterestTagActivity.a(this.a, 2, alpo.a(2131702176), 500);
        return;
      }
      ChooseInterestTagActivity.a(this.a, 0, alpo.a(2131702149) + paramString2, 500);
      return;
    }
    if ((paramInt2 == 1) && (!TextUtils.isEmpty(paramString1)))
    {
      ...
      paramList.putExtra("selfSet_leftViewText", alpo.a(2131702165));
      paramList.putExtra("title", alpo.a(2131702187));
    ...
    ChooseInterestTagActivity.a(this.a, 1, alpo.a(2131702166), 500);
  }
}
