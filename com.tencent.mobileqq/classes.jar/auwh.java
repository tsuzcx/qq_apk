...
public class auwh
{
  public static void a(NearbyAppInterface paramNearbyAppInterface)
  {
    ...
    axqc.a(paramNearbyAppInterface.getAccount(), "nearby_enter_time", Long.valueOf(0L));
    if ((anzr)paramNearbyAppInterface.a(axoc.c) != null)
    {
      oidb_0x91f.ReqBody localReqBody = new oidb_0x91f.ReqBody();
      localReqBody.uint32_state.set(0);
      ntb.a(paramNearbyAppInterface, new auwi(paramNearbyAppInterface), localReqBody.toByteArray(), "OidbSvc.0x91f", 2335, 5, null, 0L);
    }
    axqc.a(paramNearbyAppInterface.getAccount(), false);
    axqc.a(paramNearbyAppInterface.getAccount(), "nearby_people_disclaimer_ok_5.8.0", Boolean.valueOf(false));
  ...
  public static void b(NearbyAppInterface paramNearbyAppInterface)
  {
    ...
    {
      localFile.delete();
      axql.a("Q.nearby", "clearNearbyCache", new Object[0]);
    }
    axqc.a(paramNearbyAppInterface.getAccount(), "history_valid", Boolean.valueOf(false));
  }
}
