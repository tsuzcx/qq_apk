...
{
  private atvv(PersonalityLabelGalleryActivity paramPersonalityLabelGalleryActivity) {}
  
  private void a(atvu paramatvu, PersonalityLabelInfo paramPersonalityLabelInfo)
  {
    if (this.a.jdField_b_of_type_Boolean)
    {
      if (paramatvu.jdField_a_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramatvu.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramatvu.jdField_b_of_type_AndroidWidgetImageView.getVisibility() != 0) {
        paramatvu.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      if (paramatvu.jdField_d_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramatvu.jdField_d_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramatvu.jdField_c_of_type_AndroidWidgetImageView.getVisibility() != 0) {
        paramatvu.jdField_c_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      paramatvu.jdField_b_of_type_AndroidViewView.setTag(paramPersonalityLabelInfo);
      paramatvu.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
      paramatvu.jdField_b_of_type_AndroidViewView.setTag(2131296572, Integer.valueOf(4));
      paramatvu.jdField_b_of_type_AndroidViewView.setTag(2131299411, paramatvu);
      paramatvu = paramatvu.jdField_b_of_type_AndroidWidgetImageView;
      if (!this.a.jdField_b_of_type_Boolean) {
        break label384;
      }
    }
    ...
    {
      paramatvu.setImageResource(i);
      return;
      if (PersonalityLabelGalleryActivity.a(this.a))
      {
        if (paramatvu.jdField_a_of_type_AndroidWidgetImageView.getVisibility() != 0) {
          paramatvu.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        }
        if (paramatvu.jdField_b_of_type_AndroidWidgetImageView.getVisibility() != 0) {
          paramatvu.jdField_b_of_type_AndroidWidgetImageView.setVisibility(0);
        }
        ...
        if (paramatvu.jdField_c_of_type_AndroidWidgetImageView.getVisibility() != 8) {
          paramatvu.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
        }
        paramatvu.jdField_b_of_type_AndroidViewView.setTag(paramPersonalityLabelInfo);
        paramatvu.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
        paramatvu.jdField_b_of_type_AndroidViewView.setTag(2131296572, Integer.valueOf(1));
        break;
      }
      if (paramatvu.jdField_a_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramatvu.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramatvu.jdField_b_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramatvu.jdField_b_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      if (paramatvu.jdField_d_of_type_AndroidWidgetImageView.getVisibility() != 0) {
        paramatvu.jdField_d_of_type_AndroidWidgetImageView.setVisibility(0);
      }
      if (paramatvu.jdField_c_of_type_AndroidWidgetImageView.getVisibility() != 8) {
        paramatvu.jdField_c_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      paramatvu.jdField_b_of_type_AndroidViewView.setTag(paramPersonalityLabelInfo);
      paramatvu.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
      paramatvu.jdField_b_of_type_AndroidViewView.setTag(2131296572, Integer.valueOf(3));
      break;
    }
  }
  ...
  private void b(PersonalityLabelInfo paramPersonalityLabelInfo)
  {
    ...
    baaf.a(this.a, false, true);
  }
  
  public void a(PersonalityLabelInfo paramPersonalityLabelInfo)
  {
    bfpy localbfpy = bfpy.a();
    localbfpy.a = this.a.app.getCurrentAccountUin();
    localbfpy.b = this.a.app.getCurrentNickname();
    Bundle localBundle = new Bundle();
    localBundle.putString("key_title", this.a.getString(2131652217));
    ...
    bfpr.a(this.a, localbfpy, localBundle, 1);
  }
  
  void a(PersonalityLabelInfo paramPersonalityLabelInfo, atvu paramatvu)
  {
    String str = paramatvu.jdField_b_of_type_AndroidWidgetTextView.getText().toString();
    if (paramPersonalityLabelInfo.praiseCount > 0L)
    {
      ...
      if (!TextUtils.equals(paramPersonalityLabelInfo, str)) {
        paramatvu.jdField_b_of_type_AndroidWidgetTextView.setText(paramPersonalityLabelInfo);
      }
      paramPersonalityLabelInfo = paramatvu.jdField_b_of_type_AndroidWidgetTextView;
      if (!this.a.jdField_b_of_type_Boolean) {
        break label375;
      }
    }
    ...
    for (float f = 0.5F;; f = 1.0F)
    {
      ...
      return;
      paramPersonalityLabelInfo = this.a.getResources().getString(2131633533);
      break;
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = this.a.getLayoutInflater().inflate(2131495359, paramViewGroup, false);
      paramViewGroup = new atvu(null);
      paramViewGroup.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131301659);
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131303211));
      paramViewGroup.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131297291);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131296572));
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131296573));
      paramViewGroup.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131299411));
      paramViewGroup.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131313746));
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView = ((GlowCountRecyclerView)paramView.findViewById(2131309276));
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131313748));
      paramViewGroup.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131311524);
      paramViewGroup.jdField_d_of_type_AndroidViewView = paramView.findViewById(2131299097);
      paramViewGroup.jdField_c_of_type_AndroidViewView.setOnClickListener(this);
      paramViewGroup.jdField_c_of_type_AndroidViewView.setTag(2131296572, Integer.valueOf(5));
      if (!PersonalityLabelGalleryActivity.a(this.a)) {
      ...
      localObject1 = new atvt(this.a, null);
      ...
      localObject2 = (Integer)paramViewGroup.jdField_a_of_type_AndroidViewView.getTag(2131303211);
      if ((localObject2 == null) || (((Integer)localObject2).intValue() != ((PersonalityLabelInfo)localObject1).bgColor))
      {
        ...
        paramViewGroup.jdField_a_of_type_AndroidViewView.setTag(2131303211, Integer.valueOf(((PersonalityLabelInfo)localObject1).bgColor));
      }
      ...
      paramViewGroup.jdField_b_of_type_AndroidViewView.setTag(2131313748, paramViewGroup);
      if (!PersonalityLabelGalleryActivity.a(this.a))
      {
        if (((PersonalityLabelInfo)localObject1).praiseFlag <= 0) {
          break label830;
        }
        paramViewGroup.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130844764);
      }
      if (PersonalityLabelGalleryActivity.a(this.a))
      {
        ...
        paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setTag(2131296572, Integer.valueOf(2));
      }
      ...
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.setAdapter(new atwa(this.a, ((PersonalityLabelInfo)localObject1).id));
      ...
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqProfilePersonalityLabelGlowCountRecyclerView.setOnScrollListener(new atvw(this, (PersonalityLabelInfo)localObject1));
      label694:
    ...
    for (paramInt = i;; paramInt = -2)
    {
      ...
      return paramView;
      paramViewGroup = (atvu)paramView.getTag();
      break;
      paramViewGroup.jdField_d_of_type_AndroidWidgetImageView.setImageResource(2130844752);
      break label435;
      bool1 = false;
      break label524;
      paramInt = 8;
  ...
  {
    Object localObject1 = paramView.getTag(2131296572);
    int i;
    if ((localObject1 != null) && ((localObject1 instanceof Integer)))
    {
      ...
      {
        paramView = begr.a(paramView.getContext());
        paramView.c("从手机相册选择");
        paramView.c("从空间相册选择");
        paramView.d("取消");
        paramView.a(new atvx(this, (PersonalityLabelInfo)localObject1, paramView));
        paramView.show();
        awqx.b(this.a.app, "dc00898", "", "", "0X8007FD2", "0X8007FD2", 0, 0, "", "", "", "");
      }
    }
    label192:
    do
    ...
    if (i == 3)
    {
      ...
      {
        ((atwd)this.a.app.a(112)).a(PersonalityLabelGalleryActivity.a(this.a), localPersonalityLabelInfo.id);
    ...
    for (;;)
    {
      ...
      if (localObject2 != null) {}
      for (localObject1 = ((PersonalityLabelZan)localObject2).nick;; localObject1 = babh.a(this.a.app, this.a.app.getCurrentAccountUin()))
      {
        localPersonalityLabelZan.nick = ((String)localObject1);
        localPersonalityLabelInfo.zanUins.add(0, localPersonalityLabelZan);
        a(localPersonalityLabelInfo, (atvu)paramView.getTag(2131313748));
        ((ImageView)paramView.findViewById(2131313746)).setImageResource(2130844764);
        ...
        awqx.b(this.a.app, "dc00898", "", "", "0X8007FD0", "0X8007FD0", 0, 0, "", "", "", "");
        return;
      }
      if (this.a.jdField_a_of_type_Bbmy == null) {
        this.a.jdField_a_of_type_Bbmy = bbmy.a(this.a, "每个标签每天只能点一个赞哦。", 0);
      }
      if (this.a.jdField_a_of_type_Bbmy.c()) {
        break;
      }
      this.a.jdField_a_of_type_Bbmy.b(this.a.getTitleBarHeight());
      return;
      if (i == 4)
      {
        ...
        {
          babr.a(this.a, (String)localObject1, 2131625035, 2131627099, new atvy(this, paramView, (PersonalityLabelInfo)localObject2), new atvz(this)).show();
          return;
        }
      }
      if (i != 5) {
