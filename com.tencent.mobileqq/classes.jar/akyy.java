  ...
  implements akyx
{
  ...
  public boolean a(String paramString, ark.VariantWrapper[] paramArrayOfVariantWrapper, ark.VariantWrapper paramVariantWrapper)
  {
    ...
    if ("AttachEvent".equals(paramString))
    {
      ...
      {
        if (!alan.a(this.a.jdField_a_of_type_JavaLangString, this.a.jdField_a_of_type_Long, this.a.jdField_a_of_type_ComTencentArkArk$Application, "permission.SENSORS")) {
          return false;
        }
        paramString = new akyz(this, l);
      }
      while ((paramString != null) && (!"Position".equals(paramVariantWrapper)))
      {
        this.a.jdField_a_of_type_Alad.a(paramString, l);
        return true;
        if ("Orientation".equals(paramVariantWrapper))
        {
          ...
          paramString = new akza(this, l);
        }
        else
        {
          if ("Position".equals(paramVariantWrapper))
          {
            if (!alan.a(this.a.jdField_a_of_type_JavaLangString, this.a.jdField_a_of_type_Long, this.a.jdField_a_of_type_ComTencentArkArk$Application, "permission.POSITION")) {
              return false;
            }
            ...
            if ((!paramVariantWrapper.getBoolean(str, false)) && (alar.a))
            {
              ...
              alat.a(paramArrayOfVariantWrapper, paramString);
            }
            for (;;)
            {
              return true;
              if (1 == alat.a(paramArrayOfVariantWrapper, "ark_authority_api_location", paramString))
              {
                paramString = new akzf(this, l);
                this.a.jdField_a_of_type_Alad.a(paramString, l);
              }
              else
              {
                akyv.a(this.a, l, false, 0.0D, 0.0D);
    ...
    if ("DetachEvent".equals(paramString))
    {
      ...
      this.a.jdField_a_of_type_Alad.a(paramArrayOfVariantWrapper[0].GetString());
      return true;
    }
