  ...
  extends alpd
{
  ...
  public amci(QQAppInterface paramQQAppInterface)
  {
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   172: iload 6
    //   174: aload_3
    //   175: invokevirtual 137	amci:notifyUI	(IZLjava/lang/Object;)V
    //   178: return
    //   179: astore_2
    //   180: iconst_0
    //   181: istore 5
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      ((alys)this.app.getManager(102)).a(paramToServiceMsg);
      paramObject = paramToServiceMsg;
      bool2 = bool1;
      continue;
      label589:
  ...
  private void j(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      ((bhps)this.app.getManager(194)).a(paramToServiceMsg, paramFromServiceMsg, paramObject);
      return;
    }
    catch (Exception paramToServiceMsg)
    {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          ((Oidb_0x6de.DevInfo)localObject1).bytes_imei.set(ByteStringMicro.copyFromUtf8(bdgk.a()));
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          ((Oidb_0x6df.DevInfo)localObject1).bytes_imei.set(ByteStringMicro.copyFromUtf8(bdgk.a()));
  ...
  public void a(long paramLong, byte[] paramArrayOfByte)
  {
    ...
    do
    {
      ...
      try
      {
        ((bhps)this.app.getManager(194)).b(i);
        return;
      }
      catch (Exception paramArrayOfByte) {}
    } while (!QLog.isColorLevel());
  ...
  public void a(String paramString)
  {
    ...
    paramString = bdfc.a().a(paramString, "Version");
    int j = 0;
    i = j;
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    bhpl.a(paramToServiceMsg, paramFromServiceMsg, paramObject);
  }
}
