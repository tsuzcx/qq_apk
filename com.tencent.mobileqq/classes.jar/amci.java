...
public class amci
{
  ...
  public static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      paramQQAppInterface = bhhs.a(localSharedPreferences, "special_sound" + paramQQAppInterface.getCurrentAccountUin(), null);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    Object localObject = bhhs.a(paramQQAppInterface.getApp().getSharedPreferences("com.tencent.mobileqq_preferences", 4), "special_sound" + paramQQAppInterface.getCurrentAccountUin(), null);
    if (localObject != null)
    {
  ...
  public static void a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      localObject2 = bhhs.a((SharedPreferences)localObject1, "special_sound" + paramQQAppInterface.getCurrentAccountUin(), null);
      ...
      bhhs.a(localEditor, "special_sound" + paramQQAppInterface.getCurrentAccountUin(), paramString).commit();
      return;
    }
  }
  ...
  {
    paramQQAppInterface = (aocb)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.SPECIAL_CARE_HANDLER);
    if (paramQQAppInterface != null) {
  ...
  public static void a(List<String> paramList, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        localObject1 = bhhs.a((SharedPreferences)localObject1, "special_sound" + paramQQAppInterface.getCurrentAccountUin(), null);
      ...
      bhhs.a(localEditor, "special_sound" + paramQQAppInterface.getCurrentAccountUin(), paramList).commit();
      return;
    }
  }
  ...
  public static void b(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      localObject2 = bhhs.a((SharedPreferences)localObject2, "special_sound" + paramQQAppInterface.getCurrentAccountUin(), null);
      if (localObject2 != null)
      {
