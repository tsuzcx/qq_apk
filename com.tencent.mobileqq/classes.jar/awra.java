...
public class awra
{
  ...
  @SuppressLint({"NewApi"})
  public static void a(View paramView, String paramString1, awra paramawra, String paramString2)
  {
    if ((paramView == null) || (paramawra == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (a(paramawra.jdField_o_of_type_Long))) {}
    do
    {
      do
      {
          ...
          do
          {
            do
            {
              do
              {
                do
                {
                  do
                  {
                    do
                    {
                      do
                      {
                        do
                        {
                          do
                          {
                              ...
                              do
                              {
                                do
                                {
                                  do
                                  {
                                    ...
                                    {
                                      return;
                                      paramawra = paramawra.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString2);
                                    } while (paramawra == null);
                                    if ((!paramString1.equalsIgnoreCase("color")) || (!(paramView instanceof TextView))) {
                                      break;
                                    }
                                    paramView = (TextView)paramView;
                                    if ((paramawra instanceof ColorStateList))
                                    {
                                      paramView.setTextColor((ColorStateList)paramawra);
                                      return;
                                    }
                                  } while (!(paramawra instanceof String));
                                  paramString1 = (String)paramawra;
                            ...
                            if ((paramawra instanceof Drawable))
                            {
                              paramString1 = ((Drawable)paramawra).getConstantState().newDrawable();
                              paramawra = new Rect();
                              paramString1.getPadding(paramawra);
                              int i1 = paramView.getPaddingTop();
                              int i2 = paramawra.top;
                              int i3 = paramView.getPaddingLeft();
                              int i4 = paramawra.left;
                              int i5 = paramView.getPaddingRight();
                              int i6 = paramawra.right;
                              int i7 = paramView.getPaddingBottom();
                              int i8 = paramawra.bottom;
                              paramawra = paramView.findViewById(2131373574);
                              if (Build.VERSION.SDK_INT >= 16)
                              {
                                paramView.setBackground(paramString1);
                                if (paramawra != null) {
                                  paramawra.setBackground(paramString1);
                                }
                              }
                              for (;;)
                              {
                                ...
                                if (paramawra != null) {
                                  paramawra.setBackgroundDrawable(paramString1);
                                }
                              }
                            }
                          } while (!(paramawra instanceof String));
                      ...
                      } while (!(paramawra instanceof Drawable));
                      paramView = (TextView)paramView;
                    } while (!(paramawra instanceof Drawable));
                    paramView.setCompoundDrawablesWithIntrinsicBounds(((Drawable)paramawra).getConstantState().newDrawable(), null, null, null);
                    return;
                ...
                paramView.setCompoundDrawablesWithIntrinsicBounds(null, null, ((Drawable)paramawra).getConstantState().newDrawable(), null);
                return;
            ...
            paramView.setImageDrawable(((Drawable)paramawra).getConstantState().newDrawable());
            return;
        ...
        paramView.setContentBackground(((Drawable)paramawra).getConstantState().newDrawable());
        return;
        if ((!paramString1.equalsIgnoreCase("apngDrawable")) || (!(paramView instanceof ImageView))) {
          break;
        }
      } while (!(paramawra instanceof URLDrawable));
      ((ImageView)paramView).setImageDrawable((URLDrawable)paramawra);
      return;
    } while ((!paramString1.equalsIgnoreCase("shimmer_mask")) || (!(paramView instanceof ShimmerLinearLayout)) || (!(paramawra instanceof BitmapDrawable)));
    paramString1 = (BitmapDrawable)paramawra;
    paramawra = (ShimmerLinearLayout)paramView;
  ...
  public Drawable a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Object localObject3 = bddf.a(paramQQAppInterface, -1L);
        localObject1 = str;
  ...
  public JSONObject a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    //   47: lcmp
    //   48: ifne +23 -> 71
    //   51: getstatic 786	awra:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   54: ifnull +17 -> 71
    //   57: getstatic 786	awra:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   60: astore_1
    //   61: aload_1
    //   62: areturn
    //   63: ldc_w 788
    ...
    //   73: lcmp
    //   74: ifeq +13 -> 87
    //   77: getstatic 790	awra:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   80: ifnull +7 -> 87
    //   83: getstatic 790	awra:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   86: areturn
    ...
    //   121: aload_1
    //   122: ldc2_w 559
    //   125: invokestatic 565	bddf:a	(Lcom/tencent/mobileqq/app/QQAppInterface;J)Ljava/lang/String;
    //   128: astore_1
    //   129: aload_1
    //   130: ifnull +142 -> 272
    //   133: aload_1
    ...
    //   336: putstatic 786	awra:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   339: aload 5
    //   341: astore_1
    //   342: getstatic 786	awra:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   345: astore 6
    //   347: aload 6
    //   349: astore_1
    //   350: aload 5
    ...
    //   383: putstatic 790	awra:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   386: aload 5
    //   388: astore_1
    //   389: getstatic 790	awra:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   392: astore 6
    //   394: aload 6
    //   396: astore_1
    //   397: aload 5
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        catch (Exception paramQQAppInterface)
        {
          ...
          if (!awsh.a(paramQQAppInterface)) {
            continue;
          }
          str1 = awsk.a(paramQQAppInterface.getApp());
          localObject2 = bduc.a(paramQQAppInterface, str1 + "logo.png", "-wzry-card-logo-", a(paramQQAppInterface, str1 + "logo.png", true, true), new int[] { 7 }, "-wzry-card-logo-", null);
