...
public class sst
{
  private static int a(List<BaseData> paramList)
  {
    ...
    while (i > 0)
    {
      ...
      if ((srx.a(localBaseData)) && (localBaseData.r != 0))
      {
  ...
  {
    int i = 2;
    if (paramBaseData.r == 9) {
      i = ((RecommendAdData)paramBaseData).w;
    }
    int j = 0;
    for (int k = i; j < paramList.size(); k = i)
    {
      i = k;
      if (((BaseData)paramList.get(j)).r == 6)
      {
        k -= 1;
        i = k;
        if (k == 1) {
  ...
  public static void a(List<BaseData> paramList)
  {
    ...
    if (((Iterator)localObject).hasNext()) {
      if (((BaseData)((Iterator)localObject).next()).r != 6) {
        break label144;
      }
    }
    label144:
  ...
  public static void a(List<BaseData> paramList1, List<BaseData> paramList2)
  {
    ...
    if (paramList1 != null)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if ((localBaseData.r == 9) || (localBaseData.r == 10) || (localBaseData.r == 11) || (localBaseData.r == 17) || (localBaseData.r == 24)) {
    ...
    if (paramList2 != null)
    {
      ...
      while (paramList2.hasNext())
      {
        ...
        if ((((BaseData)localObject1).r == 10) || (((BaseData)localObject1).r == 11) || (((BaseData)localObject1).r == 17) || (((BaseData)localObject1).r == 24))
        {
          a(paramList1, (BaseData)localObject1, null);
        }
        else
        {
          if (((BaseData)localObject1).r == 22) {}
  ...
  public static void a(List<BaseData> paramList1, List<BaseData> paramList2, ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, SparseArray<Float> paramSparseArray, ItemShowDispatcher paramItemShowDispatcher)
  {
    ...
    if (paramList1 != null)
    {
      ...
      {
        BaseData localBaseData = (BaseData)localIterator.next();
        if ((localBaseData.r == 7) || (localBaseData.r == 6) || (localBaseData.r == 8)) {
    ...
    if (paramList2 != null)
    {
      ...
      while (paramList2.hasNext())
      {
        ...
        if ((localObject instanceof ProteusItemData)) {
          ssb.a(paramArticleInfo, (ProteusItemData)localObject, 5, paramSparseArray);
        }
  ...
  public static void a(boolean paramBoolean, List<BaseData> paramList, FastWebArticleInfo paramFastWebArticleInfo, ArticleInfo paramArticleInfo)
  {
    ...
    if (i < paramList.size())
    {
      ...
      do
      {
        ...
        break;
        k = j;
      } while (((BaseData)localObject).r != 15);
    }
  ...
  {
    int j = 0;
    if (paramBaseData.r == 22)
    {
      boolean bool = ((ProteusInnerData)paramBaseData).h();
      int n = ((ProteusInnerData)paramBaseData).w;
      int i = paramList.size() - 1;
      int k = 0;
      int m;
      if (i > 0)
      {
        ...
        {
          m = k;
          if (!srx.a(paramBaseData)) {
            break label170;
          }
          m = k;
          if (paramBaseData.r == 0) {
            break label170;
          }
          k += 1;
          m = k;
  ...
  public static void b(List<BaseData> paramList)
  {
    ...
    for (;;)
    {
      ...
      } while (((BaseData)localIterator.next()).r != 16);
      for (int i = 1; i == 0; i = 0)
      {
  ...
  public static void c(List<BaseData> paramList, List<CommentInfo> paramList1)
  {
    ...
    for (;;)
    {
      j += 1;
      break;
      QLog.d(sst.class.getSimpleName(), 2, "update comment data! size : " + i);
      return;
    }
  }
  ...
  private static void f(List<BaseData> paramList)
  {
    ...
    {
      localBaseData = (BaseData)localIterator.next();
      if ((localBaseData.r == 10) || (localBaseData.r == 17) || (localBaseData.r == 24)) {
        localArrayList.add(localBaseData);
      }
    }
    for (;;)
    {
      break label22;
      if ((localBaseData.r == 22) && (((ProteusInnerData)localBaseData).h()))
      {
        i = 1;
        continue;
        if (i == 0) {
