...
{
  public xtf(QzDynamicVideoPreviewActivity paramQzDynamicVideoPreviewActivity) {}
  ...
  public void onError(int paramInt)
  {
    ...
    this.a.runOnUiThread(new xth(this, paramInt));
  }
  ...
  public void onProgress(int paramInt)
  {
    ...
    String str = paramInt + "%";
    this.a.runOnUiThread(new xtg(this, paramInt, str));
  }
}
