  ...
  extends ContentObserver
{
  ...
  public atin(Handler paramHandler, Context paramContext, String paramString1, String paramString2)
  {
    super(paramHandler);
  ...
  public void onChange(boolean paramBoolean)
  {
    ...
    //   7: aload_0
    //   8: getfield 24	atin:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    //   11: ifnull +10 -> 21
    //   14: aload_0
    //   15: getfield 16	atin:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   18: ifnonnull +4 -> 22
    //   21: return
    //   22: ldc 47
    ...
    //   27: astore_2
    //   28: aload_0
    //   29: getfield 24	atin:jdField_a_of_type_AndroidContentContext	Landroid/content/Context;
    ...
    //   90: astore 4
    //   92: aload_0
    //   93: getfield 26	atin:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   110: aload_0
    //   111: aload_2
    //   112: invokevirtual 93	atin:a	(Landroid/database/Cursor;)V
    //   115: aload_2
    //   116: ifnull -95 -> 21
    //   119: aload_0
    //   120: aload_2
    //   121: invokevirtual 93	atin:a	(Landroid/database/Cursor;)V
    //   124: return
    //   125: aload_0
    //   126: getfield 26	atin:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   143: aload_0
    //   144: aload_2
    //   145: invokevirtual 93	atin:a	(Landroid/database/Cursor;)V
    //   148: aload_2
    //   149: ifnull -128 -> 21
    //   152: aload_0
    //   153: aload_2
    //   154: invokevirtual 93	atin:a	(Landroid/database/Cursor;)V
    //   157: return
    //   158: aload_0
    //   159: getfield 28	atin:b	Ljava/lang/String;
    //   162: invokestatic 91	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   165: ifeq +18 -> 183
    //   168: aload_0
    //   169: aload_2
    //   170: invokevirtual 93	atin:a	(Landroid/database/Cursor;)V
    //   173: aload_2
    //   174: ifnull -153 -> 21
    //   177: aload_0
    //   178: aload_2
    //   179: invokevirtual 93	atin:a	(Landroid/database/Cursor;)V
    //   182: return
    //   183: aload_2
    //   184: aload_2
    //   185: ldc 65
    ...
    //   204: ifne +115 -> 319
    //   207: aload_0
    //   208: getfield 28	atin:b	Ljava/lang/String;
    ...
    //   229: aload_0
    //   230: aload_2
    //   231: invokevirtual 93	atin:a	(Landroid/database/Cursor;)V
    //   234: aload_2
    //   235: ifnull -214 -> 21
    //   238: aload_0
    //   239: aload_2
    //   240: invokevirtual 93	atin:a	(Landroid/database/Cursor;)V
    //   243: return
    //   244: aload 5
    ...
    //   304: ifne +15 -> 319
    //   307: aload_0
    //   308: getfield 16	atin:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   311: iconst_1
    //   312: aload_3
    ...
    //   323: aload_0
    //   324: aload_2
    //   325: invokevirtual 93	atin:a	(Landroid/database/Cursor;)V
    //   328: return
    //   329: astore 4
    //   331: aload 4
    ...
    //   344: aload_0
    //   345: aload_2
    //   346: invokevirtual 93	atin:a	(Landroid/database/Cursor;)V
    //   349: aload_2
    //   350: ifnull -329 -> 21
    //   353: aload_0
    //   354: aload_2
    //   355: invokevirtual 93	atin:a	(Landroid/database/Cursor;)V
    //   358: return
    //   359: astore_3
    //   360: aconst_null
    //   361: astore_2
    ...
    //   366: aload_0
    //   367: aload_2
    //   368: invokevirtual 93	atin:a	(Landroid/database/Cursor;)V
    //   371: aload_3
    //   372: athrow
    //   373: astore_3
    //   374: goto -12 -> 362
