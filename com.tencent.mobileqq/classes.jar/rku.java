  ...
  implements rkk
{
  public static String a(String paramString, ImageData paramImageData)
  {
    ...
    while (!((Boolean)bhvh.a("sp_native_web_sharpp_pic_switch", Boolean.valueOf(false))).booleanValue()) {
      return paramString;
    }
    ...
    paramImageData = bfng.a(paramString);
    ...
    for (;;)
    {
      QLog.d(pai.a, 2, "sharpSupport, url : " + paramString);
      return paramString;
  ...
  {
    return new rkv(LayoutInflater.from(paramContext).inflate(2131559920, null), paramBaseData);
  }
