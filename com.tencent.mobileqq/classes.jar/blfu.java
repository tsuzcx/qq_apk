...
public class blfu
  implements blgk, blgm, blgp, INetEngine.INetEngineListener
{
  static INetEngine.IBreakDownFix jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$IBreakDownFix = new blfw();
  private static Singleton<blfu, Void> jdField_a_of_type_ComTencentWeiyunUtilsSingleton;
  ...
  private final blft jdField_a_of_type_Blft = new blft();
  private blgi jdField_a_of_type_Blgi;
  private blgj jdField_a_of_type_Blgj;
  ...
  private final HashMap<Long, blfr> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private List<blgh> jdField_a_of_type_JavaUtilList;
  ...
  static
  {
    jdField_a_of_type_ComTencentWeiyunUtilsSingleton = new blfv();
  }
  
  private blfu()
  {
    AppNetConnInfo.registerConnectionChangeReceiver(this.jdField_a_of_type_AndroidContentContext, new blfx(this));
  }
  
  public static blfu a()
  {
    return (blfu)jdField_a_of_type_ComTencentWeiyunUtilsSingleton.get(null);
  }
  ...
  private void a()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      {
        localObject = (blfr)this.jdField_a_of_type_JavaUtilHashMap.get(localObject);
        if ((localObject == null) || (((blfr)localObject).d())) {
          localIterator.remove();
        }
      }
    }
  ...
  private boolean a(long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    ...
    {
      blfr localblfr1 = (blfr)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
      if (localblfr1 == null)
      {
        a(paramLong);
        return false;
    ...
    if (paramBoolean1) {
      localblfr2.a(paramBoolean2);
    }
    if (paramBoolean3) {
      localblfr2.b(paramBoolean4);
    }
    a(localblfr2, 1, 0, null);
    return true;
  }
  ...
  private static boolean a(Context paramContext, File paramFile)
  {
    ...
    //   7: invokestatic 222	blhk:a	()Ljava/lang/String;
    ...
    //   22: astore_3
    //   23: aload_3
    //   24: invokestatic 236	aszt:a	(Ljava/lang/String;)I
    //   27: istore_2
    //   28: iload_2
    //   29: ifeq +13 -> 42
    //   32: iload_2
  ...
  private void b()
  {
    ...
    blfr localblfr = (blfr)this.jdField_a_of_type_JavaUtilHashMap.get(localLong);
    if ((localblfr == null) || (!a(localblfr.c())) || (localblfr.d()))
    {
      b();
      return;
    }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqTransfileINetEngine == null) {
      this.jdField_a_of_type_ComTencentMobileqqTransfileINetEngine = blgq.a();
    }
    this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsThreadPoolWrapper.submit(new blgb(this, localLong, localNetReq));
  }
  ...
  public int a()
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilHashMap)
    {
      ...
      if (!localArrayList.isEmpty()) {
        this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsThreadPoolWrapper.submit(new blgc(this, localArrayList));
      }
      return j + i;
    }
  }
  
  public blfr a(long paramLong)
  {
    synchronized (this.jdField_a_of_type_JavaUtilHashMap)
    {
      blfr localblfr = (blfr)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
      if (localblfr == null) {
        return null;
      }
    }
    return blfr.a(localObject.a(), localObject.a().a(), localObject.b(), localObject.a().a());
  }
  
  public blft a()
  {
    return this.jdField_a_of_type_Blft.a();
  }
  
  public String a(blfn paramblfn, String paramString, blgh paramblgh)
  {
    return b(paramblfn, paramString, true, paramblgh);
  }
  
  public String a(blfn paramblfn, String paramString, boolean paramBoolean, blgh paramblgh)
  {
    return b(paramblfn, paramString, paramBoolean, paramblgh);
  }
  
  public String a(String paramString1, String paramString2, String paramString3, String paramString4, blgh paramblgh)
  {
    int i = jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.getAndIncrement();
    a(paramString1, paramString2, paramString3, paramString4, new blfy(this, paramblgh, i), Integer.toString(i));
    return Integer.toString(i);
  }
  
  void a(int paramInt, blfr paramblfr)
  {
    if (paramblfr == null) {}
    do
    {
      ...
      {
        this.jdField_a_of_type_ComTencentWeiyunUtilsDualHashMap.put(Long.valueOf(paramblfr.a()), Integer.toString(paramInt));
        ??? = this.jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)???).hasNext())
        {
          blgh localblgh = (blgh)((Iterator)???).next();
          if (localblgh != null) {
            localblgh.a(Integer.toString(paramInt));
          }
        }
      }
    } while (paramblfr.a() == null);
    paramblfr.a().a(Integer.toString(paramInt));
  }
  
  public void a(int paramInt, blfr paramblfr, String paramString)
  {
    for (;;)
    {
      blfr localblfr;
      ...
      {
        long l = paramblfr.a();
        localblfr = (blfr)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(l));
        if (localblfr == null)
        {
          this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(l), paramblfr);
          i = 1;
          a(paramInt, paramblfr);
          if (i != 0)
          {
            paramblfr.b(paramString);
            if (i == 0) {
              break label175;
            }
            a(paramblfr, 1, 0, null);
          }
        }
        else
        {
          ...
          paramblfr.a().jdField_a_of_type_Int = localblfr.a().jdField_a_of_type_Int;
          paramblfr.a().jdField_b_of_type_Int = localblfr.a().jdField_b_of_type_Int;
          this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(l), paramblfr);
          i = 1;
        }
      }
      localblfr.a(paramblfr.b());
      localblfr.b(paramblfr.c());
      continue;
      label175:
      paramblfr = localblfr;
      continue;
  ...
  public void a(long paramLong, int paramInt, String paramString)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilHashMap)
    {
      localblfr = (blfr)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
      if (localblfr == null) {
        return;
      }
    }
    if (!localblfr.d())
    {
      ...
      {
        a(localblfr, 5, 1810004, null);
        return;
      }
      a(localblfr, 5, paramInt, paramString);
    }
  }
  
  public void a(long paramLong, blfp paramblfp)
  {
    blfr localblfr;
    synchronized (this.jdField_a_of_type_JavaUtilHashMap)
    {
    ...
    if (!localblfr.d())
    {
      if ((paramblfp == null) || (TextUtils.isEmpty(paramblfp.c)))
      {
        a(localblfr, 5, 1829002, null);
        return;
      }
      if (!a(localblfr.c()))
      {
      ...
      ??? = blfr.a(localblfr, paramblfp.c, localblfr.d(), paramblfp.jdField_b_of_type_JavaLangString, jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$IBreakDownFix, this, a(localblfr.d(), localblfr.a().jdField_a_of_type_JavaLangString));
      localblfr.a((HttpNetReq)???);
      localblfr.a(paramblfp.e);
      localblfr.a().d = paramblfp.e;
      a(paramLong, (NetReq)???);
    }
  }
  
  public void a(long paramLong, boolean paramBoolean, blfr paramblfr)
  {
    synchronized (this.jdField_a_of_type_JavaUtilHashMap)
    {
      blfr localblfr = (blfr)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
      if (localblfr != null) {
        a(localblfr, 5, 1810002, null);
      }
      if (paramblfr != null)
      {
        paramblfr.a().jdField_a_of_type_Int = 0;
        paramblfr.a().jdField_b_of_type_Int = 1810002;
        a(paramblfr, true);
      }
      return;
    }
  ...
  public void a(long paramLong, boolean paramBoolean1, blfs paramblfs, boolean paramBoolean2)
  {
    synchronized (this.jdField_a_of_type_JavaUtilHashMap)
    {
      blfr localblfr = (blfr)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
    ...
    paramblfs = paramblfs.jdField_a_of_type_Blfr;
    label66:
    do
    {
      a((blfr)???, paramBoolean2);
      return;
      ??? = paramblfs;
    } while (paramblfs != null);
  }
  ...
  public void a(long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString)
  {
    ...
    if (!localblfr.d())
    {
      localblfr.b(paramString);
      if (paramBoolean1)
      {
        a(localblfr, 4, 0, null);
        return;
      }
      if (paramBoolean2)
      {
        a(localblfr, 5, 1810008, null);
        return;
      }
      if (paramBoolean3)
      {
        a(localblfr, 5, 1810031, null);
        return;
      }
      if (!a(localblfr.c()))
      {
      ...
      this.jdField_a_of_type_Blgn.a(localblfr, DownloadType.FILE_ORDINARY.ordinal());
    }
  }
  
  void a(blfr paramblfr, int paramInt1, int paramInt2)
  {
    this.jdField_a_of_type_Blft.a();
    this.jdField_a_of_type_Blft.a(paramblfr, paramInt1, paramInt2);
  }
  
  void a(blfr paramblfr, int paramInt1, int paramInt2, String paramString)
  {
    if (paramblfr == null) {}
    boolean bool;
    label47:
    ...
    int i = paramblfr.a().jdField_a_of_type_Int;
    paramblfr.a().jdField_a_of_type_Int = paramInt1;
    paramblfr.a().jdField_b_of_type_Int = paramInt2;
    paramblfr.a().jdField_a_of_type_JavaLangString = blfq.a(paramInt2, paramString);
    this.jdField_a_of_type_Blgj.a(paramblfr, true);
    a(paramblfr, i, paramInt1);
    return;
    a(paramblfr.a());
    i = 1;
    paramInt1 = 1;
    for (;;)
    {
      for (;;)
      {
        for (;;)
        {
          for (;;)
          {
            if ((i != 0) || (paramblfr.a().a()))
            {
              ...
              {
                this.jdField_a_of_type_JavaUtilHashSet.remove(Long.valueOf(paramblfr.a()));
              }
            }
            synchronized (this.jdField_b_of_type_JavaUtilHashSet)
            {
              this.jdField_b_of_type_JavaUtilHashSet.remove(Long.valueOf(paramblfr.a()));
              paramblfr.c(false);
              this.jdField_a_of_type_Blgl.a(paramblfr);
              break;
              bool = false;
              break label139;
              paramblfr = finally;
          ...
          synchronized (this.jdField_a_of_type_JavaUtilHashSet)
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqTransfileINetEngine.cancelReq(paramblfr.a());
            a(paramblfr.a());
          }
        }
        if (paramInt2 == 1810002) {
          synchronized (this.jdField_a_of_type_JavaUtilHashMap)
          {
            this.jdField_a_of_type_JavaUtilHashMap.remove(Long.valueOf(paramblfr.a()));
            synchronized (this.jdField_a_of_type_ComTencentWeiyunUtilsDualHashMap)
            {
              this.jdField_a_of_type_ComTencentWeiyunUtilsDualHashMap.removeByKey(Long.valueOf(paramblfr.a()));
              synchronized (this.jdField_a_of_type_JavaUtilHashSet)
              {
                this.jdField_a_of_type_JavaUtilHashSet.remove(Long.valueOf(paramblfr.a()));
              }
        ...
        for (;;)
        {
          ...
          if ((paramInt2 == 1810003) || (paramInt2 == 1810004)) {
            synchronized (this.jdField_a_of_type_JavaUtilHashSet)
            {
              this.jdField_a_of_type_JavaUtilHashSet.add(Long.valueOf(paramblfr.a()));
              paramInt1 = 1;
            }
          }
          synchronized (this.jdField_b_of_type_JavaUtilHashSet)
          {
            this.jdField_b_of_type_JavaUtilHashSet.add(Long.valueOf(paramblfr.a()));
          }
        }
        synchronized (this.jdField_a_of_type_JavaUtilHashMap)
        {
        ...
        {
          this.jdField_b_of_type_JavaUtilHashSet.remove(Long.valueOf(paramblfr.a()));
          paramblfr.a().jdField_b_of_type_JavaLangString = paramblfr.d();
          paramblfr.a().jdField_b_of_type_Long = paramblfr.a().jdField_a_of_type_Long;
          paramblfr.a().jdField_a_of_type_Blfr = paramblfr;
          a(paramblfr.a());
          break;
          paramblfr = finally;
          throw paramblfr;
  ...
  void a(blfr paramblfr, boolean paramBoolean)
  {
    if (paramblfr == null) {}
    do
    {
      ...
      while (localIterator.hasNext())
      {
        blgh localblgh = (blgh)localIterator.next();
        if (localblgh != null) {
          localblgh.a(paramblfr.a(), paramblfr.a(), paramblfr.b(), paramBoolean);
        }
      }
    } while (paramblfr.a() == null);
    paramblfr.a().a(paramblfr.a(), paramblfr.a(), paramblfr.b(), paramBoolean);
  }
  
  public void a(blgh paramblgh)
  {
    this.jdField_a_of_type_JavaUtilList.add(paramblgh);
  }
  
  public void a(blgi paramblgi, Context paramContext)
  {
    this.jdField_a_of_type_Blgi = paramblgi;
    if (this.jdField_a_of_type_Blgi == null) {
      throw new NullPointerException("IFetchListener can not be null!");
    }
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    paramblgi = new ReleaseLooperHandler("weiyun_download-work-thread");
    this.jdField_a_of_type_Blgj = new blgj(this, paramblgi);
    this.jdField_a_of_type_Blgl = new blgl(this, paramblgi);
    this.jdField_a_of_type_Blgn = new blgn(this, this.jdField_a_of_type_Blgi, paramblgi);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_Blgj.a(WeiyunTransmissionGlobal.getInstance().getHostInterface().getCurrentUid());
  }
  
  public void a(String paramString1, String paramString2, String paramString3, blgg paramblgg)
  {
    a(paramString1, paramString2, null, paramString3, paramblgg, null);
  }
  
  public void a(String paramString1, String paramString2, String paramString3, String paramString4, blgg paramblgg, String paramString5)
  {
    paramString1 = blfr.a(paramString4, paramString1, paramString2, paramString3, jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$IBreakDownFix, new blfz(this, paramblgg, paramString4, paramString2));
    if (this.jdField_b_of_type_ComTencentMobileqqTransfileINetEngine == null) {
      this.jdField_b_of_type_ComTencentMobileqqTransfileINetEngine = blgq.b();
    }
    this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsThreadPoolWrapper.submit(new blga(this, paramString1));
    if (paramString5 != null) {
      this.jdField_b_of_type_JavaUtilMap.put(paramString5, paramString1);
    }
  }
  
  public void a(String arg1, List<blfr> paramList)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
      {
        ...
        localblfr = (blfr)paramList.next();
        long l = localblfr.a();
        int i = localblfr.a().jdField_a_of_type_Int;
        localblfr.a().jdField_a_of_type_Int = 0;
        this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(l), localblfr);
        switch (i)
        {
        case 0: 
        case 1: 
        case 2: 
          a(localblfr, 1, 0, null);
        }
      }
      a(localblfr, 3, 0, null);
      continue;
      a(localblfr, 5, localblfr.a().jdField_b_of_type_Int, localblfr.a().jdField_a_of_type_JavaLangString);
      continue;
      label199:
      return;
    }
  ...
  void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaUtilHashMap)
      {
        ...
        localblfr = (blfr)((Map.Entry)localIterator.next()).getValue();
        if ((!localblfr.c()) || (!paramBoolean2))
        {
          if (!localblfr.a().b()) {
            continue;
          }
          localblfr.c(true);
          if (this.jdField_a_of_type_ComTencentMobileqqTransfileINetEngine != null) {
            this.jdField_a_of_type_ComTencentMobileqqTransfileINetEngine.cancelReq(localblfr.a());
          }
          a(localblfr, 5, 1810004, null);
        }
      }
      if ((localblfr.c()) && (paramBoolean2) && (localblfr.a().d())) {
        a(localblfr.a(), false, false, false, false);
      }
    }
  }
  ...
  public boolean a()
  {
    blft localblft = this.jdField_a_of_type_Blft.a();
    int i = localblft.jdField_a_of_type_Int;
    return localblft.jdField_b_of_type_Int + i > 0;
  }
  ...
  public boolean a(String paramString)
  {
    ...
    this.jdField_a_of_type_Blgj.a(paramString.longValue(), true);
    return true;
  }
  ...
  public int b()
  {
    ??? = this.jdField_a_of_type_Blft.a();
    int i = ((blft)???).d;
    int j = ((blft)???).jdField_a_of_type_Int;
    int k = ((blft)???).jdField_b_of_type_Int;
    ArrayList localArrayList = new ArrayList();
    synchronized (this.jdField_a_of_type_JavaUtilHashMap)
    {
      localArrayList.addAll(this.jdField_a_of_type_JavaUtilHashMap.keySet());
      if (!localArrayList.isEmpty()) {
        this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsThreadPoolWrapper.submit(new blgd(this, localArrayList));
      }
      return k + (i + j);
    }
  }
  
  String b(blfn paramblfn, String paramString, boolean paramBoolean, blgh paramblgh)
  {
    int i = jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.getAndIncrement();
    paramString = blfr.a(WeiyunTransmissionGlobal.getInstance().getHostInterface().getCurrentUid(), paramblfn, paramString, new blfs());
    paramString.b(paramBoolean);
    paramString.a().c = paramblfn.jdField_a_of_type_JavaLangString;
    paramString.a(paramblgh);
    this.jdField_a_of_type_Blgj.a(i, paramString);
    return Integer.toString(i);
  }
  
  public void b(blgh paramblgh)
  {
    if (this.jdField_a_of_type_JavaUtilList.contains(paramblgh)) {
      this.jdField_a_of_type_JavaUtilList.remove(paramblgh);
    }
  }
  
  public boolean b(long paramLong)
  {
    this.jdField_a_of_type_Blgj.a(paramLong, true);
    return true;
  }
  ...
  public int c()
  {
    ...
    synchronized (this.jdField_b_of_type_JavaUtilHashSet)
    {
      ...
      if (!localArrayList.isEmpty()) {
        this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsThreadPoolWrapper.submit(new blge(this, localArrayList));
      }
      return i;
    }
  }
  ...
  public void onResp(NetResp paramNetResp)
  {
    ...
    do
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        if ((paramNetResp == null) || (!(paramNetResp instanceof blfr))) {
          break;
        }
        paramNetResp = (blfr)paramNetResp;
  ...
  public void onUpdateProgeress(NetReq paramNetReq, long paramLong1, long paramLong2)
  {
    ...
    if ((paramNetReq != null) && ((paramNetReq instanceof blfr)))
    {
      paramNetReq = (blfr)paramNetReq;
      if (paramNetReq != null) {
        break label26;
      }
    }
    ...
    blfs localblfs = paramNetReq.a();
    if (paramLong1 < paramLong2) {}
    for (;;)
    {
      localblfs.jdField_b_of_type_Long = paramLong1;
      a(paramNetReq, false);
      return;
