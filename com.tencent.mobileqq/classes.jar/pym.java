...
public class pym
{
  ...
  public static void a(Context paramContext, pau parampau, ViewGroup.LayoutParams paramLayoutParams)
  {
    a(paramContext, parampau, paramLayoutParams, null);
  }
  
  public static void a(Context paramContext, pau parampau, ViewGroup.LayoutParams paramLayoutParams, View paramView)
  {
  ...
  public static void a(pau parampau, RingAvatarView paramRingAvatarView, ImageView paramImageView)
  {
    if ((paramRingAvatarView == null) || (paramImageView == null) || (parampau == null)) {}
    do
    {
      return;
      parampau = parampau.a();
  ...
  public static void a(qda paramqda, ReadInJoyYAFolderTextView paramReadInJoyYAFolderTextView, puy parampuy, SpannableStringBuilder paramSpannableStringBuilder)
  {
    ...
    if (onh.a(paramqda))
    {
      List localList = paramqda.jdField_a_of_type_Qcg.a;
      ...
      {
        paramqda = paramSpannableStringBuilder.substring(1);
        localStringBuilder.append(paramqda);
        ...
        paramqda = bbcz.b((QQAppInterface)onh.a(), String.valueOf(l), true);
        paramSpannableStringBuilder = "@" + paramqda;
        paramqda = paramSpannableStringBuilder;
      ...
      {
        localStringBuilder.append(paramqda).append(paramSpannableStringBuilder);
        paramSpannableStringBuilder = new pxa();
        paramSpannableStringBuilder.jdField_a_of_type_Int = j;
        paramSpannableStringBuilder.b = (paramqda.length() + j);
      ...
      label329:
      paramqda = new SpannableStringBuilder(new aykk(localStringBuilder, 7, 16));
      paramSpannableStringBuilder = ((List)localObject).iterator();
      while (paramSpannableStringBuilder.hasNext())
      {
        localObject = (pxa)paramSpannableStringBuilder.next();
        paramqda.setSpan(new pva(((pxa)localObject).jdField_a_of_type_Long, -3355444, parampuy), ((pxa)localObject).jdField_a_of_type_Int, ((pxa)localObject).b, 17);
      }
      localSpannableStringBuilder.append(paramqda);
    }
    for (;;)
    {
      paramReadInJoyYAFolderTextView.setText(localSpannableStringBuilder);
      return;
      if (!TextUtils.isEmpty(paramqda.jdField_a_of_type_JavaLangString)) {
        try
        {
          localSpannableStringBuilder.append(new aykk(axau.b(paramqda.jdField_a_of_type_JavaLangString), 7, 16));
        }
        catch (Exception paramqda)
        {
          QLog.d("UtilsForComponent", 1, "parse bytes_comments failed ", paramqda);
        }
      }
    }
  }
  ...
  public static boolean a(ArticleInfo paramArticleInfo)
  {
    ...
    {
      bool1 = bool2;
      if (!ram.i(paramArticleInfo)) {
        if (!ram.k(paramArticleInfo)) {
          break label36;
        }
      }
    }
  ...
  {
    return (ram.a(paramArticleInfo) == 23) || (ram.b(paramArticleInfo) == 56);
  }
