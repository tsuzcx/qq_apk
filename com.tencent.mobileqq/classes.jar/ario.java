  ...
  implements Observer, Manager
{
  ...
  aufl jdField_a_of_type_Aufl = null;
  ...
  public ario(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    befe.a(paramQQAppInterface, paramMessageRecord);
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, boolean paramBoolean, int paramInt2)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          return;
          if (((befs)paramQQAppInterface.a(146)).a(paramString, paramInt1)) {
            break;
          }
        } while (!QLog.isColorLevel());
    ...
    for (;;)
    {
      ...
      if (paramInt1 == 1)
      {
        ...
        if ((!mhj.d(BaseApplicationImpl.getApplication())) && ((!jdField_b_of_type_Boolean) || (paramBoolean)))
        {
          ...
          if ((!h) && (jdField_b_of_type_Int > 2))
          {
            ...
            awrn.a(BaseApplication.getContext()).a(paramQQAppInterface.getCurrentAccountUin(), "qqlsReprotTag", true, 0L, 0L, paramString, "");
            if (QLog.isColorLevel()) {
  ...
  public void a(String paramString, int paramInt)
  {
    for (;;)
    {
      ...
      synchronized (jdField_a_of_type_ArrayOfByte)
      {
        ...
        int k = this.jdField_a_of_type_Aufl.c(localRecentBaseData.a(), localRecentBaseData.a());
        if (localRecentBaseData.a().equals(ajed.H))
        {
          i = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(ajed.H, localRecentBaseData.a());
          if ((i != 0) || (k != 0)) {
            continue;
          }
      ...
      if (localRecentBaseData.a().equals(ajed.D))
      {
        i = ((ajnf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(34)).d();
      }
      else if (localRecentBaseData.a().equals(ajed.aa))
      {
        i = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(ajed.aa, localRecentBaseData.a());
      }
      else
      {
        i = j;
  ...
  public boolean a(QQAppInterface paramQQAppInterface, String paramString, int paramInt1, boolean paramBoolean1, int paramInt2, boolean paramBoolean2)
  {
    ...
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      ...
      if ((paramInt1 != 1001) || (amwo.b((MessageRecord)localObject3))) {
        break label2462;
      }
      paramString = ajed.I;
      if ((!ajed.ah.equals(paramString)) && (!ajed.ag.equals(paramString)) && (!ajed.I.equals(paramString))) {
        break label314;
      }
      paramQQAppInterface = agzt.a(new RecentUser(paramString, paramInt1), paramQQAppInterface, paramQQAppInterface.getApp());
    ...
    label637:
    int j;
    if ((!bgmq.a(paramQQAppInterface)) && (paramInt1 == 7220) && (ajed.az.equals(paramString)))
    {
      localObject1 = ajed.ay;
      i = 1008;
      if (QLog.isColorLevel()) {
      ...
      if ((FriendsStatusUtil.a((String)localObject1, paramQQAppInterface)) || (acxd.a((String)localObject1, i, paramQQAppInterface))) {
        return false;
      }
      localakeu = paramQQAppInterface.a().a();
      localObject2 = localakeu.a(true, false).iterator();
      if (((Iterator)localObject2).hasNext())
      {
        ...
        if (paramString != null)
        {
          ...
          if (TextUtils.isEmpty(paramString.uin))
          {
            ...
            } while ((localRecentBaseData.a().equals(ajed.ah)) || (localRecentBaseData.a().equals(ajed.ag)));
            paramInt1 = 0;
            if (!localRecentBaseData.a().equals(ajed.H)) {
              break label1060;
            }
            paramInt1 = paramQQAppInterface.a().a(ajed.H, localRecentBaseData.a());
          }
          for (;;)
          {
            label701:
            ...
            if ((localRecentBaseData.a() == 3000) || (localRecentBaseData.a() == 0) || (localRecentBaseData.a() == 8))
            {
              ...
              j = this.jdField_a_of_type_Aufl.c(localRecentBaseData.a(), localRecentBaseData.a());
              if (!QLog.isColorLevel()) {
                break label2536;
              }
            ...
            if ((paramString != null) && (paramString.getType() == i) && (ajed.x.equals(paramString.uin)))
            {
              paramString = new RecentUser((String)localObject1, i);
              break label485;
            }
            if (((paramString != null) && (paramString.getType() == i) && (ajed.H.equals(paramString.uin))) || ((paramString != null) && (paramString.getType() == i) && (ajed.aa.equals(paramString.uin)))) {
              break label485;
            }
            if ((paramString != null) && (ajed.D.equals(paramString.uin)) && ((ajed.M.equals(localObject1)) || (ajed.aw.equals(localObject1)) || (ajed.aD.equals(localObject1)))) {
              break label2544;
            }
            if ((paramString == null) || (paramString.getType() != 1032) || (akbm.a(i) != 1032)) {
              break;
            }
            break label485;
            label1036:
            if (((aufl)paramQQAppInterface.getManager(38)).c((String)localObject1, i) != 0) {
              break label547;
            }
            return false;
            label1060:
            if (localRecentBaseData.a().equals(ajed.D))
            {
              if (((String)localObject1).equals(ajed.M)) {
                paramInt1 = paramQQAppInterface.a().a(ajed.M, localRecentBaseData.a());
              } else {
                paramInt1 = ((ajnf)paramQQAppInterface.getManager(34)).d();
              }
            }
            else if (localRecentBaseData.a().equals(ajed.aa))
            {
              paramInt1 = paramQQAppInterface.a().a(ajed.aa, localRecentBaseData.a());
            }
            else
            {
              if (localRecentBaseData.a().equals(ajed.ae))
              {
                localObject4 = (amvw)paramQQAppInterface.getManager(71);
                if (localObject4 == null) {
                  break label2443;
                }
                paramInt1 = ((amvw)localObject4).a().a();
                break label2553;
              }
              if (localRecentBaseData.a().equals(ajed.av))
              {
                localObject4 = (aril)paramQQAppInterface.getManager(145);
                if (localObject4 == null) {
                  break label2556;
                }
                paramInt1 = ((aril)localObject4).a();
                break label2556;
              }
          ...
          localObject2 = null;
          if (paramString != null) {
            if (paramString.uin.equals(ajed.H))
            {
              paramInt1 = paramQQAppInterface.a().a(ajed.H, paramString.getType());
              paramString = agzt.a(paramString, paramQQAppInterface, paramQQAppInterface.getApp());
            }
          }
          for (;;)
          {
            ...
            if ((ajnf.a(paramQQAppInterface, paramString.a())) && (ajed.ac.equals(paramString.a()))) {
              paramString.mTitleName = paramQQAppInterface.getApp().getString(2131624068);
            }
            localObject1 = jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.iterator();
            label1358:
            ...
            {
              localObject2 = (RecentBaseData)((Iterator)localObject1).next();
              if ((!ajnf.a(paramQQAppInterface, ((RecentBaseData)localObject2).a())) || (!ajnf.a(paramQQAppInterface, paramString.a()))) {
                break label1988;
              }
              jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(localObject2);
            ...
            return true;
            if (paramString.uin.equals(ajed.D))
            {
              if (((String)localObject1).equals(ajed.M))
              {
                paramInt1 = paramQQAppInterface.a().a(ajed.M, paramString.getType());
                break;
              }
              paramInt1 = ((ajnf)paramQQAppInterface.getManager(34)).d();
              awqx.b(paramQQAppInterface, "dc00898", "", "", "0X80077D5", "0X80077D5", 0, 0, "", "", "", "");
              break;
            }
            if (paramString.uin.equals(ajed.aa))
            {
              paramInt1 = paramQQAppInterface.a().a(ajed.aa, paramString.getType());
              break;
            }
            ...
            else
            {
              if (i == 1012)
              {
                paramString = (amvw)paramQQAppInterface.getManager(71);
                if (paramString == null) {
                  break label2430;
                }
              ...
              if (i == 1030)
              {
                ...
                {
                  paramString = (alrl)paramQQAppInterface.getManager(240);
              ...
              else
              {
                ...
                paramString = (aril)paramQQAppInterface.getManager(145);
                paramInt1 = paramString.a();
                paramString = paramString.a;
              }
            }
    ...
    for (;;)
    {
      ...
      paramString = (arim)paramQQAppInterface.getManager(284);
      paramInt1 = 1;
      paramString = paramString.a();
      break label1304;
      label2428:
      ...
      do
      {
        localObject3 = localakeu.a((String)localObject1, i);
        paramString = (String)localObject2;
        paramInt1 = j;
        if (localObject3 == null) {
          break label1304;
        }
        ((RecentUser)localObject3).lastmsgtime = awao.a();
        localObject2 = agzt.a((RecentUser)localObject3, paramQQAppInterface, paramQQAppInterface.getApp());
        paramString = (String)localObject2;
        paramInt1 = j;
        if (i != 8) {
          break label1304;
        ...
        if ((paramString.a().equals(ajed.H)) && (((RecentBaseData)localObject2).a().equals(paramString.a())))
        {
          jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(localObject2);
          jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramString.a() + paramString.a());
          break label1443;
        }
        if ((paramString.a().equals(ajed.ap)) && (((RecentBaseData)localObject2).a().equals(paramString.a())))
        {
          jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(localObject2);
          jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramString.a() + paramString.a());
          break label1443;
        }
        if ((paramString.a().equals(ajed.aa)) && (((RecentBaseData)localObject2).a().equals(paramString.a())))
        {
          jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(localObject2);
          jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramString.a() + paramString.a());
          break label1443;
        }
        if ((!paramString.a().equals(ajed.D)) || (!((RecentBaseData)localObject2).a().equals(paramString.a()))) {
          break label1358;
        }
        jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.remove(localObject2);
        jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(paramString.a() + paramString.a());
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Aufl != null) {
      this.jdField_a_of_type_Aufl = null;
    }
  }
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    if ((paramObject != null) && ((paramObject instanceof atcu)))
    {
      ...
      if (bahj.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
        break label77;
      }
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        do
        {
          return;
          i = ((ajnf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(34)).d();
        } while ((TextUtils.isEmpty(((atcu)paramObject).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) || (((atcu)paramObject).a == 0L));
        if ((i != 0) && (!f)) {
          break;
        }
      } while (!QLog.isColorLevel());
      ...
      return;
      bool1 = SettingCloneUtil.readValue(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131628378), "qqsetting_lock_screen_whenexit_key", true);
      bool2 = SettingCloneUtil.readValue(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131653032), "qqsetting_notify_showcontent_key", true);
    } while ((!Boolean.valueOf(bool1).booleanValue()) || (!Boolean.valueOf(bool2).booleanValue()));
    a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ajed.D, 4000, false, arik.a(ajed.D, 4000, null));
  }
}
