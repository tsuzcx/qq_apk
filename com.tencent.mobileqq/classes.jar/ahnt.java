...
public class ahnt
{
  ...
  public ahnt(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  public ahnt(QQAppInterface paramQQAppInterface, baxl parambaxl)
  {
    this(paramQQAppInterface, parambaxl, false);
  }
  
  public ahnt(QQAppInterface paramQQAppInterface, baxl parambaxl, boolean paramBoolean)
  {
    this.jdField_a_of_type_Baxk = new baxk(BaseApplication.getContext(), paramQQAppInterface);
    this.jdField_a_of_type_Baxk.a(parambaxl);
  ...
  public static Pair<Integer, Integer> a(QQAppInterface paramQQAppInterface, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      ...
      i = m;
      j = k;
      if (!String.valueOf(ajsf.G).equals(paramString))
      {
        i = m;
        j = k;
        if (!String.valueOf(ajsf.J).equals(paramString)) {
          if (String.valueOf(ajsf.w).equals(paramString))
          {
            i = 2130840082;
            j = k;
          }
          else if (ajsf.E.equals(paramString))
          {
            i = 2130840216;
            j = k;
          }
          else if (ajsf.az.equals(paramString))
          {
            j = 110;
            i = -2147483648;
          }
          else
          {
            ...
            else if (ajsf.al.equals(paramString))
            {
              i = 2130844655;
              j = k;
            }
            else if (ajsf.am.equals(paramString))
            {
              i = 2130844654;
              j = k;
            }
            else if (ajsf.an.equals(paramString))
            {
              i = 2130844656;
              j = k;
            }
            else if (ajsf.ao.equals(paramString))
            {
              i = 2130844653;
              j = k;
            }
            else if (ajsf.ap.equals(paramString))
            {
              i = 2130844657;
              j = k;
            }
            else
            {
              ...
              if ((localajyf != null) && (localajyf.a(paramString))) {
                paramInt = n;
              }
              for (;;)
              {
              ...
              else
              {
                ...
                else
                {
                  ...
                  i = 2130846126;
                  continue;
                  if (TextUtils.isEmpty(sfh.e)) {}
                  for (i = sbc.a();; i = 2147483647)
                  {
                    j = 112;
                    break;
                  }
                  ...
                  j = k;
                  continue;
                  i = ((bahi)paramQQAppInterface.getManager(183)).a();
                  j = k;
                  continue;
                  if (TextUtils.equals(paramString, ajsf.aM))
                  {
                    i = 2130844177;
                    j = k;
                  }
                  else if (TextUtils.equals(paramString, ajsf.aN))
                  {
                    i = 2130844178;
                    j = k;
                  }
  ...
  public Drawable a(RecentBaseData paramRecentBaseData)
  {
    ...
    for (Object localObject = ((askl)localObject).c(paramRecentBaseData.mPhoneNumber);; localObject = null)
    {
      if (localObject != null)
      {
        localObject = baxt.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentBaseData.mPhoneNumber, (byte)3);
        paramRecentBaseData = (RecentBaseData)localObject;
        if (localObject == null) {
          paramRecentBaseData = bbdr.b();
        }
      }
      for (;;)
      {
        ...
        else
        {
          ...
          else
          {
            ...
            if (j == 26)
            {
              paramRecentBaseData = avdy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramRecentBaseData.a());
            }
            else if (j == 1034)
            {
              j = 2130844159;
            ...
            else if (ardf.a(j, paramRecentBaseData))
            {
  ...
  public Drawable a(String paramString, int paramInt)
  {
    ...
    if (paramInt == 105)
    {
      paramString = sfh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, BaseApplication.getContext(), 1);
      if ((paramString != null) && (paramString.a() != null)) {
        return paramString.a();
      }
      return sfh.a(BaseApplication.getContext(), 1);
    }
    if (paramInt == 111)
    {
      paramString = sfh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, BaseApplication.getContext(), 3);
      if ((paramString != null) && (paramString.a() != null)) {}
      for (paramString = paramString.a();; paramString = sfh.a(BaseApplication.getContext(), 3)) {
        return onk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString);
      }
    }
    if (paramInt == 106) {
      return nqq.a(BaseApplication.getContext());
    }
    if (paramInt == 108) {
      return ((afaz)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(138)).a();
    }
    if (paramInt == 110)
    {
      paramString = sfh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, BaseApplication.getContext(), 2);
      if ((paramString != null) && (paramString.a() != null)) {
        return paramString.a();
      }
      return sfh.a(BaseApplication.getContext(), 2);
    }
    if (paramInt == 112) {
      return BaseApplicationImpl.sApplication.getResources().getDrawable(sbc.a());
    }
    ...
    for (int i = 1;; i = paramInt)
    {
      ...
      if (this.jdField_a_of_type_Baxk != null) {
        if (paramInt == 32) {
          localObject1 = this.jdField_a_of_type_Baxk.a(i, paramString, 200);
        }
      }
      for (;;)
      {
        ...
        else
        {
          ...
          if ((this.jdField_a_of_type_Baxk != null) && (!this.jdField_a_of_type_Baxk.a()))
          {
            if (i != 32) {
              break label516;
            }
        ...
        for (;;)
        {
          ...
          return a(paramInt);
          localObject1 = this.jdField_a_of_type_Baxk.a(i, paramString);
          break;
          localObject2 = Boolean.valueOf(this.jdField_a_of_type_Baxk.a());
          break label407;
          label516:
          this.jdField_a_of_type_Baxk.a(paramString, i, true, (byte)0);
          if ((i == 1001) && (this.jdField_a_of_type_Baxk.a(101, paramString) == null)) {
            this.jdField_a_of_type_Baxk.a(paramString, 101, true, (byte)0);
          }
        }
        label564:
        if (paramInt == 103)
        {
          localObject2 = BaseApplication.getContext().getResources().getDrawable(2130840065);
  ...
  {
    paramString1 = baxt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString1, (byte)3);
    try
    {
      ...
      localURLDrawableOptions.mRequestWidth = actn.a(paramInt1, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getResources());
      localURLDrawableOptions.mRequestHeight = actn.a(paramInt2, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getResources());
      ...
      if (axmt.a())
      {
        if (!TextUtils.isEmpty(paramString3))
        {
          ...
          paramString3.setDecodeHandler(bavi.i);
          return paramString3;
        }
      }
  ...
  public URLDrawable a(int paramInt, String paramString)
  {
    ...
    case 1000: 
      ...
      localDrawable = bbdr.c();
      return URLDrawable.getDrawable(paramString.iconUrl, localDrawable, localDrawable);
    case 112: 
      paramString = BaseApplicationImpl.sApplication.getResources().getDrawable(sbc.a());
      return URLDrawable.getDrawable(sfh.e, paramString, paramString);
    }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    if (this.jdField_a_of_type_Baxk != null)
    {
      this.jdField_a_of_type_Baxk.a(paramQQAppInterface);
