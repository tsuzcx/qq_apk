...
public class ahnt
  extends ahno
  implements ahoj, ahqz, ahrg, azwv
{
  private int jdField_a_of_type_Int;
  private ahmn jdField_a_of_type_Ahmn;
  private ahpm jdField_a_of_type_Ahpm;
  private alox jdField_a_of_type_Alox = new ahoa(this);
  ...
  MqqHandler jdField_a_of_type_MqqOsMqqHandler = new MqqHandler(Looper.getMainLooper(), new ahnu(this));
  ...
  public ahnt(Activity paramActivity)
  {
    super(paramActivity);
    ...
    this.jdField_a_of_type_Ahmn = new ahmn(localalro.b("sp_mayknow_entry_list_recommend"));
    int i;
    if (localalro.b())
    {
      i = 2;
    ...
    label189:
    for (paramActivity = new ahqf(paramActivity);; paramActivity = new ahpy(paramActivity))
    {
      this.jdField_a_of_type_Ahpm = paramActivity;
      this.jdField_a_of_type_Ahpm.a(new ahnv(this));
  ...
  {
    int i = this.jdField_a_of_type_Ahmn.b(1);
    if (this.jdField_a_of_type_Ahmn.a())
    {
      int m = bdiv.ah(a(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
      int j = 0;
      ...
      {
        i = this.jdField_a_of_type_Ahmn.b(1);
        k = i;
        if (QLog.isColorLevel()) {
  ...
  private void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_c_of_type_Boolean)
    {
      ...
      int i = this.jdField_a_of_type_Ahmn.a(this.jdField_b_of_type_Int);
      if (a())
      {
        i = this.jdField_a_of_type_Ahmn.b(i);
        if ((i == -1) || (paramBoolean2)) {
          i = a(paramBoolean1);
        }
        c(i);
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewContactsViewPager.setOffscreenPageLimit(this.jdField_a_of_type_Ahmn.jdField_a_of_type_JavaUtilArrayList.size());
      }
  ...
  private boolean a()
  {
    ...
    alro localalro = (alro)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
    if (localalro != null) {
      bool1 = localalro.b("sp_mayknow_entry_list_recommend");
    }
    for (boolean bool1 = this.jdField_a_of_type_Ahmn.a(bool1);; bool1 = false)
    {
      if (bool1)
      {
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsViewPagerAdapter.a(this.jdField_a_of_type_Ahmn.jdField_a_of_type_JavaUtilArrayList);
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setTabData(this.jdField_a_of_type_Ahmn.jdField_a_of_type_ArrayOfJavaLangString, this.jdField_a_of_type_Ahmn.jdField_a_of_type_ArrayOfInt);
      }
      bool2 = bool1;
      if (!QLog.isColorLevel()) {
        break;
      }
      QLog.i("ContactsViewController", 2, "checkAndUpdateRecommendTabShow. mCurrentTabPos:" + this.jdField_b_of_type_Int + " isShowRecommendTab:" + this.jdField_a_of_type_Ahmn.a() + " changed:" + bool1);
      return bool1;
    }
  }
  ...
  private void b(int paramInt)
  {
    ...
    this.jdField_a_of_type_Ahpm.d();
    this.jdField_d_of_type_Int = paramInt;
    if (this.jdField_d_of_type_Int == 2) {}
    for (Object localObject = new ahqf(this.jdField_a_of_type_AndroidAppActivity);; localObject = new ahpy(this.jdField_a_of_type_AndroidAppActivity))
    {
      this.jdField_a_of_type_Ahpm = ((ahpm)localObject);
      this.jdField_a_of_type_Ahpm.a(new ahnw(this));
      this.jdField_a_of_type_Ahpm.b();
      this.jdField_a_of_type_Ahpm.a(this.jdField_a_of_type_AndroidViewView);
      if (!this.jdField_c_of_type_Boolean) {
        break;
      }
      this.jdField_a_of_type_Ahpm.b(false);
      return;
    }
  }
  ...
  private static boolean b()
  {
    ...
    return (localaokc != null) && (localaokc.e());
  }
  ...
  public int a(int paramInt, boolean paramBoolean)
  {
    ...
    {
      str = "";
      switch (this.jdField_a_of_type_Ahmn.a(paramInt))
      {
      }
    }
    for (;;)
  ...
  public void a(View paramView)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator = ((SimpleSlidingIndicator)paramView.findViewById(2131376786));
    k();
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewHeaderScrollView = ((HeaderScrollView)paramView.findViewById(2131364719));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewContactsViewPager = ((ContactsViewPager)paramView.findViewById(2131364722));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsViewPagerAdapter = new ContactsViewPagerAdapter(((SplashActivity)a()).getSupportFragmentManager(), ((SplashActivity)a()).app, (BaseActivity)a(), this.jdField_a_of_type_Ahmn.jdField_a_of_type_JavaUtilArrayList);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewContactsViewPager.setOffscreenPageLimit(this.jdField_a_of_type_Ahmn.jdField_a_of_type_JavaUtilArrayList.size());
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewContactsViewPager.setOnPageChangeListener(new ahnx(this));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setTabData(this.jdField_a_of_type_Ahmn.jdField_a_of_type_ArrayOfJavaLangString, this.jdField_a_of_type_Ahmn.jdField_a_of_type_ArrayOfInt);
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewPullrefreshContactRefreshHeader.setRefreshHeaderUpdateListener(new ahny(this));
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewPullrefreshCommonRefreshLayout.setOnRefreshListener(this);
    this.jdField_a_of_type_Ahpm.a(paramView);
    if (b()) {
      n();
    }
    c(a(false));
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewHeaderScrollView.setOnScrollListener(new ahnz(this));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      alro localalro = (alro)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(159);
      if ((localalro == null) || (localalro.b("sp_mayknow_entry_list_recommend") == this.jdField_a_of_type_Ahmn.a())) {
        break label251;
      }
    }
    label251:
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_Ahpm.a(paramQQAppInterface);
  ...
  public void b(boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Ahpm.b(paramBoolean);
  ...
  public void f()
  {
    try
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.a(2131364731, swy.a());
  ...
  public void g()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewHeaderScrollView != null)
    {
      View localView = this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewHeaderScrollView.findViewById(2131371043);
  ...
  public void h()
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityContactsAdapterContactsViewPagerAdapter != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewContactsViewPager != null))
    {
      ...
      if ((i == this.jdField_a_of_type_Ahmn.b(1)) || (i == this.jdField_a_of_type_Ahmn.b(2)) || (i == this.jdField_a_of_type_Ahmn.b(0))) {
        this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewHeaderScrollView.scrollTo(0, 0);
      }
    }
    this.h = false;
  ...
  public void i()
  {
    ...
    this.jdField_a_of_type_Ahpm.a(bool);
    if (this.jdField_a_of_type_ComTencentMobileqqMiniEntryContactsMiniAppEntryManager != null) {
  ...
  {
    if (this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityContactsViewSimpleSlidingIndicator.setCurrentPosition(this.jdField_a_of_type_Ahmn.b(3), false);
    }
  }
