  ...
  implements Handler.Callback
{
  ...
  Comparator<lmt> jdField_a_of_type_JavaUtilComparator = new lms(this);
  private final ConcurrentHashMap<ChatRoomInfo, ConcurrentLinkedQueue<lmt>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  private final ConcurrentLinkedQueue<lmu> b = new ConcurrentLinkedQueue();
  
  public lmr(VideoAppInterface paramVideoAppInterface)
  {
  ...
  private ChatRoomInfo a(chatroom_sso.RoomKey paramRoomKey)
  {
    ...
    int i = ((lid)localObject1).d();
    long l5 = ((lid)localObject1).a();
    long l3 = ((lid)localObject1).b();
    long l4 = ((lid)localObject1).e();
    long l2 = l4;
    long l1 = l3;
    Object localObject2;
    if (i == paramRoomKey.type.get())
    {
      ...
      if (l5 == paramRoomKey.id.get())
      {
        ...
        if (localObject2 != null) {
          ((VideoController)localObject2).a("pushMsg", (lid)localObject1);
        }
        l1 = ((lid)localObject1).b();
        l2 = ((lid)localObject1).e();
      }
    }
    if ((i == paramRoomKey.type.get()) && (l5 == paramRoomKey.id.get()) && (l1 == paramRoomKey.room_id.get()) && (l2 == paramRoomKey.create_ts.get())) {}
    for (localObject1 = a((lid)localObject1);; localObject1 = null)
    {
  ...
  private ConcurrentLinkedQueue<lmt> a(ChatRoomInfo paramChatRoomInfo)
  {
  ...
  private void a(lmt paramlmt)
  {
    if ((paramlmt == null) || (paramlmt.jdField_a_of_type_ComTencentAvChatroomChatRoomInfo == null)) {}
    ChatRoomInfo localChatRoomInfo;
    do
    {
      return;
      localChatRoomInfo = paramlmt.jdField_a_of_type_ComTencentAvChatroomChatRoomInfo;
      long l1 = 0L;
      try
      {
      ...
      l2 = AudioHelper.b();
      if (QLog.isColorLevel()) {
        QLog.i("ChatRoomMng", 2, "sendMsg, seq[" + l2 + "], room[" + localChatRoomInfo + "], msg[" + paramlmt + "]");
      }
      paramlmt.a();
      ...
      localMsg.msg.set(paramlmt.jdField_a_of_type_JavaLangString);
      localMsg.uin.set(l1);
      ...
      localObject = new NewIntent(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getApplication(), lgc.class);
      ...
      ((NewIntent)localObject).putExtra("localSeq", paramlmt.jdField_b_of_type_Long);
      mwd.a((Intent)localObject, l2);
      this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.startServlet((NewIntent)localObject);
    } while (paramlmt.e != lmt.jdField_a_of_type_Int);
    a(1, localChatRoomInfo);
  }
  
  private void b(lmt paramlmt)
  {
    if (!this.jdField_a_of_type_AndroidOsHandler.hasMessages(2, paramlmt))
    {
      Message localMessage = Message.obtain();
      localMessage.what = 2;
      localMessage.obj = paramlmt;
      this.jdField_a_of_type_AndroidOsHandler.sendMessage(localMessage);
    }
  }
  ...
  public ChatRoomInfo a(lid paramlid)
  {
    ChatRoomInfo localChatRoomInfo = a(paramlid, true);
    Object localObject;
    ...
    for (;;)
    {
      ...
      if ((QLog.isDevelopLevel()) && (paramlid != null)) {
        QLog.i("ChatRoomMng", 4, "enterChatRoom, SessionType[" + paramlid.jdField_d_of_type_Int + "], relationType[" + paramlid.E + "], relationId[" + paramlid.g + "], peerUin[" + paramlid.jdField_d_of_type_JavaLangString + "], extraUin[" + paramlid.f + "], isDoubleVideoMeeting[" + paramlid.J + "], room[" + localChatRoomInfo + "]");
      }
      return localChatRoomInfo;
      label189:
  ...
  public ChatRoomInfo a(lid paramlid, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (localChatRoomInfo2 == null)
      {
        ...
        if (paramBoolean)
        {
          ...
          {
            QLog.i("ChatRoomMng", 4, "getRoomInfo, SessionType[" + paramlid.jdField_d_of_type_Int + "], relationType[" + paramlid.E + "], relationId[" + paramlid.g + "], peerUin[" + paramlid.jdField_d_of_type_JavaLangString + "], extraUin[" + paramlid.f + "], isDoubleVideoMeeting[" + paramlid.J + "], type[" + i + "], roomID[" + l2 + "], id[" + l5 + "], createTime[" + l1 + "], room[" + localChatRoomInfo1 + "]");
            localObject = localChatRoomInfo1;
          }
        }
      }
  ...
  public lmt a(ChatRoomInfo paramChatRoomInfo, long paramLong)
  {
    if (paramChatRoomInfo == null) {
      return null;
    }
    ...
    if ((paramChatRoomInfo != null) && (paramChatRoomInfo.size() > 0))
    {
      ...
      do
      {
        ...
        paramChatRoomInfo = (lmt)localIterator.next();
          ...
          do
          {
            do
            {
              do
              {
                ...
                for (;;)
                {
                  ...
                  catch (InvalidProtocolBufferMicroException paramArrayOfByte)
                  {
                    try
                    {
                      ...
                      ((lmt)localObject2).a(lmt.jdField_b_of_type_Int);
                      b((lmt)localObject2);
                      if (!((lmt)localObject2).b()) {
                        break;
                      }
                ...
                ((lmt)localObject2).jdField_d_of_type_Long = l1;
                ((lmt)localObject2).a(lmt.jdField_c_of_type_Int);
                b((lmt)localObject2);
              ...
              } while ((((ChatRoomInfo)localObject1).jdField_b_of_type_Boolean) || (TextUtils.isEmpty(((lmt)localObject2).jdField_a_of_type_JavaLangString)) || (((lmt)localObject2).jdField_a_of_type_JavaLangString.indexOf('\024') < 0));
              lmv.a("0X800A8D5");
  ...
  public void a(VideoController paramVideoController, lid paramlid)
  {
    ChatRoomInfo localChatRoomInfo2 = a(paramlid, false);
    boolean bool = paramVideoController.a("onSwitchTerminalSuccess", paramlid);
    ChatRoomInfo localChatRoomInfo1 = a(paramlid, false);
    paramVideoController = localChatRoomInfo1;
    if (localChatRoomInfo1 == null) {
      paramVideoController = a(paramlid);
    }
    if (paramVideoController != null)
    {
      ...
      paramlid = Message.obtain();
      paramlid.obj = paramVideoController;
      paramlid.what = 3;
      this.jdField_a_of_type_AndroidOsHandler.sendMessage(paramlid);
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(ChatRoomInfo paramChatRoomInfo, String paramString, long paramLong)
  {
    ...
    paramString = new lmt(paramChatRoomInfo, l1, paramString, paramLong, -9223372036854775808L, lmt.jdField_a_of_type_Int);
    a(paramChatRoomInfo).add(paramString);
    a(paramString);
  }
  
  public void a(ChatRoomInfo paramChatRoomInfo, List<lmt> paramList)
  {
  ...
  public void a(ChatRoomInfo paramChatRoomInfo, chatroom_sso.Msg paramMsg, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if (localIterator.hasNext())
      {
        locallmt = (lmt)localIterator.next();
        if (locallmt != null) {
          if (locallmt.a(paramMsg))
          {
            bool = true;
            locallmt.jdField_c_of_type_Long = paramMsg.msg_time.get();
            locallmt.a(lmt.jdField_d_of_type_Int);
          }
        }
      }
    }
    for (;;)
    {
      ...
      {
        bool = true;
        ((lmt)localObject).jdField_d_of_type_Long = paramMsg.msg_id.get();
        ((lmt)localObject).jdField_c_of_type_Long = paramMsg.msg_time.get();
        ((lmt)localObject).a(lmt.jdField_d_of_type_Int);
        label140:
        if (!bool)
        {
          localObject = new lmt(paramChatRoomInfo, paramMsg.uin.get(), paramMsg.msg.get(), paramMsg.msg_time.get(), paramMsg.msg_id.get(), lmt.jdField_d_of_type_Int);
        ...
        else
        {
          ...
          return;
          if ((locallmt.jdField_d_of_type_Long != -9223372036854775808L) || (locallmt.jdField_a_of_type_Long != l) || (!TextUtils.equals(locallmt.jdField_a_of_type_JavaLangString, paramMsg.msg.get()))) {
            break label329;
          }
          localObject = locallmt;
        }
      }
      label320:
      label329:
  ...
  {
    ChatRoomInfo localChatRoomInfo = a(paramlid, false);
    a(localChatRoomInfo);
    if ((QLog.isDevelopLevel()) && (paramlid != null)) {
      QLog.i("ChatRoomMng", 4, "quitChatRoom, SessionType[" + paramlid.jdField_d_of_type_Int + "], relationType[" + paramlid.E + "], relationId[" + paramlid.g + "], peerUin[" + paramlid.jdField_d_of_type_JavaLangString + "], extraUin[" + paramlid.f + "], isDoubleVideoMeeting[" + paramlid.J + "], room[" + localChatRoomInfo + "]");
    }
  }
  
  public void a(lmu paramlmu)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ChatRoomMng", 2, "addObserver, observer[" + paramlmu + "]");
    }
    if ((paramlmu != null) && (!this.b.contains(paramlmu))) {
      this.b.add(paramlmu);
    }
  }
  ...
  public void b(ChatRoomInfo paramChatRoomInfo)
  {
    ...
    mwd.a((Intent)localObject, l);
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.startServlet((NewIntent)localObject);
  }
  
  public void b(lmu paramlmu)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ChatRoomMng", 2, "removeObserver, observer[" + paramlmu + "]");
    }
    if (paramlmu != null) {
      this.b.remove(paramlmu);
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    if (paramMessage.what == 1)
    {
      ...
      while (localIterator.hasNext())
      {
        locallmu = (lmu)localIterator.next();
        if (locallmu != null) {
          locallmu.a(i, paramMessage);
        }
      }
    }
    if (paramMessage.what == 2)
    {
      paramMessage = (lmt)paramMessage.obj;
      localIterator = this.b.iterator();
      while (localIterator.hasNext())
      {
        locallmu = (lmu)localIterator.next();
        if (locallmu != null) {
          locallmu.a(paramMessage);
        }
      }
    }
