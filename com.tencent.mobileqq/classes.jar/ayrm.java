...
public class ayrm
{
  ...
  private Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new ayrn(this);
  ...
  public ayrm(View paramView)
  {
    if (paramView != null)
    {
      this.jdField_a_of_type_AndroidViewView = paramView;
      this.jdField_a_of_type_Int = DisplayUtil.dip2px(this.jdField_a_of_type_AndroidViewView.getContext(), 15.0F);
