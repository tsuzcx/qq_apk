...
public class mqx
{
  ...
  public static Bitmap a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    Bitmap localBitmap = bgyo.a(paramString, localOptions);
    if (localBitmap == null) {
  ...
  public static mqb a(VideoAppInterface paramVideoAppInterface)
  {
    return (mqb)paramVideoAppInterface.a(7);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          paramBundle = new avhz((String)localObject, paramQQAppInterface.getCurrentAccountUin(), paramBundle, i, -5040, 65560, 0L);
  ...
  public static boolean a()
  {
    ...
    if ((!lph.a(4, 1800000L)) && (!lph.a(8, 1400000L))) {}
    for (;;)
    {
  ...
  {
    boolean bool = mvk.a(paramVideoAppInterface).getBoolean("qav_userguide_for_recever", true);
    if (QLog.isColorLevel()) {
