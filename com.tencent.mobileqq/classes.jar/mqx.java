  ...
  extends mqu
{
  ...
  public mqx(Context paramContext, WeakReference<ZimuView> paramWeakReference, int paramInt1, int paramInt2, float paramFloat)
  {
  ...
  {
    lek.c(this.jdField_a_of_type_JavaLangString, "getSPEED: " + this.i);
    return this.i;
  }
  ...
  protected void a(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(this.jdField_a_of_type_Mqq.b);
    this.jdField_a_of_type_AndroidGraphicsPaint.setFakeBoldText(true);
    this.jdField_a_of_type_AndroidGraphicsPaint.setStrokeWidth(this.jdField_a_of_type_Mqq.jdField_a_of_type_Float);
    float f1 = -this.jdField_a_of_type_AndroidGraphicsPaint.getFontMetrics().ascent;
    paramCanvas.drawText((String)this.jdField_a_of_type_Ljf.a, 0.0F, f1, this.jdField_a_of_type_AndroidGraphicsPaint);
    this.jdField_a_of_type_AndroidGraphicsPaint.setStyle(Paint.Style.FILL_AND_STROKE);
    this.jdField_a_of_type_AndroidGraphicsPaint.setColor(this.jdField_a_of_type_Mqq.jdField_a_of_type_Int);
    ...
    float f2 = this.jdField_a_of_type_Mqq.jdField_a_of_type_Float / 6.0F;
    paramCanvas.drawText((String)this.jdField_a_of_type_Ljf.a, 0.0F + f2, f1 - f2, this.jdField_a_of_type_AndroidGraphicsPaint);
  }
}
