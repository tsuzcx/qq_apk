  ...
  implements View.OnClickListener
{
  ...
  public mqx(View paramView, BaseData paramBaseData, FaceDecoder paramFaceDecoder)
  {
  ...
  public void b(BaseData paramBaseData1, BaseData paramBaseData2, boolean paramBoolean)
  {
    ...
    if (!TextUtils.isEmpty(paramBaseData1.authorNickName))
    {
      ...
      this.e.setCompoundDrawablesWithIntrinsicBounds(2130840711, 0, 0, 0);
    ...
    for (;;)
    {
      ...
      break label117;
      label270:
      this.e.setCompoundDrawablesWithIntrinsicBounds(2130840712, 0, 0, 0);
