...
public class bbta
{
  ...
  public static boolean c()
  {
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      if (!bool1)
      {
        ...
        QLog.d("DanceGameVideoManager", 1, String.format("isDanceGameSupport supportFrameType[%d], gpuinfo[%s], model[%s]", new Object[] { Integer.valueOf(i), bbvz.jdField_a_of_type_JavaLangString, Build.MODEL }));
        bool2 = bool1;
      }
      return bool2;
    }
  ...
  public void a(Packet paramPacket, String paramString, int paramInt)
  {
    ...
    localByteBuffer.putInt(bftf.a(l)).put((byte)0).putShort((short)1).putShort((short)27245).putShort((short)2).putShort((short)paramInt);
    paramString = new oidb_sso.OIDBSSOPkg();
  ...
  public void b(FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    for (;;)
    {
      try
      {
        ...
        if (i == 0)
        {
          long l = bftf.a(ByteBuffer.wrap(paramFromServiceMsg.bytes_bodybuffer.get().toByteArray()).getInt());
