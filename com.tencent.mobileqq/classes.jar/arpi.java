  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    try
    {
      ...
      localObject1 = bbca.encodeToString(((cmd0xccb.RspBody)localObject2).res_id.get().toByteArray(), 0);
    ...
    catch (Exception paramFromServiceMsg)
    {
      ...
      notifyObserver(paramIntent, 0, false, paramIntent.getExtras(), arpf.class);
      return;
    }
    int n;
    ...
    notifyObserver(paramIntent, 0, bool, paramIntent.getExtras(), arpf.class);
    return;
    label770:
    for (;;)
    {
