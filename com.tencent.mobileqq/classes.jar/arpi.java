...
public class arpi
{
  public static List<ChatMessage> a(List<ChatMessage> paramList)
  {
    ...
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if ((!akpx.j(localChatMessage.msgtype)) && (!acuo.a(localChatMessage))) {
  ...
  {
    asua.a().jdField_a_of_type_Int = 7;
    ...
    do
    {
      ...
      if (paramIntent.size() > 0)
      {
        ...
        while (paramQQAppInterface.hasNext())
        {
          ...
          asua.a().jdField_a_of_type_JavaUtilHashMap.put(localObject1, Boolean.valueOf(true));
        }
      }
