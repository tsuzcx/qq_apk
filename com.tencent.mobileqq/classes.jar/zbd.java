  ...
  implements Runnable
{
  ...
  private zbd(GroupIconHelper paramGroupIconHelper)
  {
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      for (;;)
      {
        synchronized (GroupIconHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppGroupIconHelper))
        {
          ...
          localzbg = (zbg)GroupIconHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppGroupIconHelper).get(localObject7);
          if ((localzbg != null) && (localzbg.jdField_b_of_type_Int >= 8))
          {
            ...
            QLog.d("Q.qqhead.dih", 2, "CheckDisIcon, maxCreateCnt: " + (String)localObject7 + ",crateIconCount=" + localzbg.jdField_b_of_type_Int);
          }
        }
        if ((localzbg != null) && (!localzbg.e))
        {
          if (QLog.isColorLevel()) {
        ...
        {
          if ((localzbg == null) || (localzbg.jdField_a_of_type_JavaLangString == null) || (localzbg.jdField_a_of_type_Byte == 3)) {
            break label866;
          }
          if ((localzbg.jdField_a_of_type_Byte == 1) && (l - localzbg.jdField_a_of_type_Long >= GroupIconHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppGroupIconHelper)))
          {
            ...
            j = localzbg.jdField_a_of_type_JavaUtilArrayList.size();
            localzbg.jdField_a_of_type_Byte = 2;
            if (j <= 0) {
              break label885;
            }
            bool2 = true;
            bool1 = bool2;
            if (localzbg.jdField_b_of_type_JavaLangString != null)
            {
              String str = GroupIconHelper.a(localzbg.jdField_a_of_type_JavaUtilArrayList, false);
              bool1 = bool2;
              if (localzbg.jdField_b_of_type_JavaLangString.equals(str)) {
                bool1 = false;
              }
            }
            bool2 = bool1;
            if (bool1)
            {
              ((ArrayList)localObject4).add(Pair.create(localObject7, localzbg));
    ...
    for (boolean bool2 = bool1;; bool2 = false)
    {
      if (QLog.isColorLevel())
      {
        QLog.d("Q.qqhead.dih", 2, "CheckDisIcon expired: " + (String)localObject7 + ", isTryCreate: " + bool2 + localzbg.toString());
        break label878;
        if ((localzbg.jdField_a_of_type_Byte == 2) && (l - localzbg.jdField_a_of_type_Long >= GroupIconHelper.b(this.jdField_a_of_type_ComTencentMobileqqAppGroupIconHelper)))
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.qqhead.dih", 2, "CheckDisIcon timeout: " + (String)localObject7 + localzbg.toString());
          }
          ...
          for (;;)
          {
            ...
            if ((this.jdField_a_of_type_Boolean) && (localObject4 != null))
            {
              ...
              while ((j < ((ArrayList)localObject4).size()) && (this.jdField_a_of_type_Boolean))
              {
                ...
                GroupIconHelper.a(this.jdField_a_of_type_ComTencentMobileqqAppGroupIconHelper, (String)((Pair)localObject7).first, (zbg)((Pair)localObject7).second, true);
                j += 1;
              }
            }
