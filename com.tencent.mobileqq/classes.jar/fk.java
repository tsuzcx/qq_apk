...
public class fk
{
  ...
  private ArrayList<ff> jdField_a_of_type_JavaUtilArrayList = new ArrayList(16);
  public boolean a;
  ...
  public fk(CharacterStyle paramCharacterStyle, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
  ...
  public fk(String paramString, int paramInt1, int paramInt2, ETFont paramETFont, boolean paramBoolean)
  {
  ...
  private int a(ETEngine paramETEngine, String paramString)
  {
    ...
    {
      localObject = new ff("");
      ((ff)localObject).d(this.e);
      ((ff)localObject).e(0);
      ((ff)localObject).a(this);
      this.jdField_a_of_type_JavaUtilArrayList.add(localObject);
      this.g = 0;
      this.e += 1;
    }
    Object localObject = new ff[j];
    int i = 0;
    while (i < j)
    {
      localObject[i] = new ff("");
      i += 1;
    }
    i = 0;
    while (i < j)
  ...
  private void a(CharacterStyle paramCharacterStyle, int paramInt)
  {
    ...
    if ((paramCharacterStyle instanceof axkk)) {
      i = ((axkk)paramCharacterStyle).a().getBounds().width();
    }
    for (;;)
    {
      label26:
      ...
      for (;;)
      {
        paramCharacterStyle = new ff(paramCharacterStyle, paramInt);
  ...
  private void a(ETEngine paramETEngine, String paramString)
  {
    ...
    for (;;)
    {
      paramETEngine = new ff(paramString);
      paramETEngine.b(i);
      paramETEngine.c(j);
