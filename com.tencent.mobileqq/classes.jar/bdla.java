...
{
  private static volatile bdla jdField_a_of_type_Bdla;
  ...
  private bdla(Context paramContext)
  {
    this.jdField_a_of_type_AndroidContentContext = paramContext.getApplicationContext();
    this.jdField_a_of_type_Boolean = bdkv.a(this.jdField_a_of_type_AndroidContentContext, true);
  }
  
  public static bdla a(Context paramContext)
  {
    if (jdField_a_of_type_Bdla == null) {}
    try
    {
      if (jdField_a_of_type_Bdla == null) {
        jdField_a_of_type_Bdla = new bdla(paramContext);
      }
      return jdField_a_of_type_Bdla;
    }
    finally {}
  }
  ...
  private void b(boolean paramBoolean)
  {
    ...
    for (Object localObject = (QQAppInterface)localObject;; localObject = null)
    {
      ...
      bdll.b((QQAppInterface)localObject, "dc00898", "", "", "0X80075F3", "0X80075F3", 0, 0, new SimpleDateFormat("yyyyMMdd", Locale.US).format(localDate), "", "", "");
      MTAReportManager.setMTAReporter(jdField_a_of_type_Bdla);
