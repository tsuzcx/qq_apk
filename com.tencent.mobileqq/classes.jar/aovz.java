...
public class aovz
  extends aoxg
{
  public aovz(QQAppInterface paramQQAppInterface, Context paramContext)
  {
  ...
  protected boolean b()
  {
    ...
    aono.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, str, new aowa(this));
    return false;
  }
  ...
  protected boolean c()
  {
    ...
    ThreadManager.getUIHandler().post(new AVGameShareJoinRoomAction.2(this, localmxc, str2, str1));
    return true;
  }
}
