...
public class becv
{
  ...
  public becv(AppInterface paramAppInterface, beby parambeby, Intent paramIntent, Context paramContext, boolean paramBoolean)
  {
    this.jdField_a_of_type_ComTencentBizUiTouchWebView = a(paramContext, paramBoolean);
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    this.jdField_a_of_type_Beby = parambeby;
    this.jdField_a_of_type_AndroidContentIntent = paramIntent;
    a(this.jdField_a_of_type_ComTencentBizUiTouchWebView, paramAppInterface, paramIntent);
  }
  
  public becv(AppInterface paramAppInterface, beby parambeby, Intent paramIntent, TouchWebView paramTouchWebView)
  {
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    this.jdField_a_of_type_Beby = parambeby;
    this.jdField_a_of_type_AndroidContentIntent = paramIntent;
  ...
  {
    becw localbecw = new becw(this);
    paramTouchWebView.setWebChromeClient(localbecw);
    this.jdField_a_of_type_Nmx = localbecw;
  }
  ...
  public TouchWebView a(TouchWebView paramTouchWebView, AppInterface paramAppInterface, Intent paramIntent)
  {
    ...
    String str1 = a(this.jdField_a_of_type_Beby);
    boolean bool;
    ...
    for (;;)
    {
      localWebSettings.setUserAgentString(befr.a((String)localObject, str1, bool));
      ...
      try
      {
        ...
        if (paramTouchWebView.getX5WebViewExtension() != null)
        {
          paramTouchWebView.getX5WebViewExtension().setWebViewClientExtension(new becz(this, paramTouchWebView, this.jdField_a_of_type_Beby));
          aekj.b(paramIntent, "use_x5", "1");
          label514:
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("WebLog_WebViewWrapper", 2, new Object[] { "sReportPerformance:", Boolean.valueOf(beep.x), " cost:", Long.valueOf(befq.jdField_a_of_type_Long) });
          }
          ...
          paramAppInterface.put("coreInit", String.valueOf(befq.jdField_a_of_type_Long));
          paramAppInterface.put("coldStart", String.valueOf(beep.s));
          azmz.a(BaseApplicationImpl.getApplication().getApplicationContext()).a(null, "actWebviewInit", true, 0L, 0L, paramAppInterface, null);
        }
      }
  ...
  {
    if (Build.VERSION.SDK_INT >= 21) {}
    for (Object localObject = new becx(this);; localObject = new becy(this))
    {
