  ...
  extends MSFServlet
{
  public static NewIntent a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    Object localObject = (bdxs)paramQQAppInterface.getManager(QQManagerFactory.SUB_ACCOUNT_MANAGER);
    if (localObject != null) {}
    for (localObject = ((bdxs)localObject).a(paramString);; localObject = null)
    {
      if ((!TextUtils.isEmpty(paramString)) && (!TextUtils.isEmpty((CharSequence)localObject)))
      {
        localNewIntent = new NewIntent(paramQQAppInterface.getApplication(), bdxr.class);
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (bool3)
    {
      try
      {
        Object localObject1 = bhjl.b(paramFromServiceMsg.getWupBuffer());
        ...
        bdxj.a = ((cmd0xe34.RspBody)localObject2).ReqInterval.get();
      ...
      for (j = 1;; j = 0)
      {
        ...
        localObject3 = (bdxs)getAppRuntime().getManager(QQManagerFactory.SUB_ACCOUNT_MANAGER);
        if (localObject3 != null)
        {
          ((bdxs)localObject3).a((SubAccountMessage)localObject2);
          ((bdxs)localObject3).b((SubAccountMessage)localObject2);
          ((bdxs)localObject3).c(((SubAccountMessage)localObject2).subUin);
        }
        localObject2 = new bdxt();
        ((bdxt)localObject2).b = paramFromServiceMsg.getUin();
        ((bdxt)localObject2).jdField_c_of_type_JavaLangString = String.valueOf(l);
        ((bdxt)localObject2).jdField_c_of_type_Boolean = true;
        ((bdxt)localObject2).d = true;
        ((bdxt)localObject2).a = 0;
        if (!(getAppRuntime() instanceof QQAppInterface)) {
          break;
        }
        ((QQAppInterface)getAppRuntime()).getMsgHandler().notifyUI(8003, true, localObject2);
        break;
        label607:
  ...
  public void a(Intent paramIntent, Packet paramPacket)
  {
    ...
    do
    {
        ...
        if (i < ((ArrayList)localObject1).size())
        {
          ...
          try
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localArrayList.get(i))) {
              ((cmd0xe34.LoginSig)localObject2).bytes_sig.set(ByteStringMicro.copyFrom(PkgTools.hexToBytes((String)localArrayList.get(i))));
            }
      ...
      paramPacket.putSendData(bhjl.a(((oidb_sso.OIDBSSOPkg)localObject1).toByteArray()));
