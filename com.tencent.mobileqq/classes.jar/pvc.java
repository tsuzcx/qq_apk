  ...
  implements rfp
{
  ...
  public pvc(ArticleInfo paramArticleInfo, int paramInt, Context paramContext, Resources paramResources, puy parampuy)
  {
    ...
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo != null)
    {
      ...
      if (this.jdField_a_of_type_Puy != null)
      {
        ...
        if (this.jdField_a_of_type_Puy.a != null) {
          i = this.jdField_a_of_type_Puy.a.e();
        }
      }
      ram.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo, i);
      return;
    }
  ...
  public void updateDrawState(TextPaint paramTextPaint)
  {
    ...
    for (int i = this.b;; i = 16777215)
    {
      ...
      this.jdField_a_of_type_AndroidTextTextPaint.setTextSize(actj.a(2, this.jdField_a_of_type_Int, this.jdField_a_of_type_AndroidContentResResources));
