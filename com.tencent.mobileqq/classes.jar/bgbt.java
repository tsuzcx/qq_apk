...
public class bgbt
  extends atdk
{
  private static bgbt jdField_a_of_type_Bgbt;
  private WeakReference<bgbp> jdField_a_of_type_JavaLangRefWeakReference;
  
  public static bgbt a()
  {
    if (jdField_a_of_type_Bgbt == null) {}
    try
    {
      if (jdField_a_of_type_Bgbt == null) {
        jdField_a_of_type_Bgbt = new bgbt();
      }
      return jdField_a_of_type_Bgbt;
    }
    finally {}
  }
      ...
      while (paramMobileQbossAdvRsp.hasNext())
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          if ((str != null) && (a(str).booleanValue()))
          {
            ...
            bgbr.a().d(localtAdvDesc.res_traceinfo, null);
          }
        }
  ...
  public void a(ArrayList<Integer> paramArrayList, bgbp parambgbp, String paramString)
  {
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambgbp);
    parambgbp = BaseApplicationImpl.getApplication().getRuntime();
    NewIntent localNewIntent = new NewIntent(BaseApplicationImpl.getApplication(), awdh.class);
    localNewIntent.putExtra("selfuin", Long.parseLong(parambgbp.getAccount()));
    localNewIntent.putIntegerArrayListExtra("appid", paramArrayList);
    localNewIntent.putExtra("requestType", paramString);
    parambgbp.registObserver(this);
    parambgbp.startServlet(localNewIntent);
  ...
  protected void h(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (bgbp localbgbp = (bgbp)this.jdField_a_of_type_JavaLangRefWeakReference.get();; localbgbp = null)
    {
      if (paramBoolean)
      {
        if (localbgbp != null) {
          localbgbp.a(paramBundle, str1, (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
        }
      ...
      for (;;)
      {
        ...
        if (localbgbp != null) {
          localbgbp.a(i, str2, str1, paramBundle);
        }
      }
    }
  }
