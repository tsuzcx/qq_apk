...
public class axjn
{
  ...
  public static String a(axgq paramaxgq)
  {
    String str = String.format("%s_%d", new Object[] { paramaxgq.jdField_a_of_type_JavaLangString, Integer.valueOf(b(paramaxgq.jdField_a_of_type_Int)) });
    if (!TextUtils.isEmpty(paramaxgq.b)) {
      str = String.format("%s_%d_%s", new Object[] { paramaxgq.jdField_a_of_type_JavaLangString, Integer.valueOf(b(paramaxgq.jdField_a_of_type_Int)), paramaxgq.b });
    }
    return axjg.c + str + ".db";
  }
  ...
  {
    auog.c(axjg.jdField_a_of_type_JavaLangString);
  }
  ...
  public static void a(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    ...
    int i = bcsa.b(paramMessageRecord.msgUid);
  ...
  public static void a(MsgBackupMsgEntity paramMsgBackupMsgEntity)
  {
    if ((b) && (paramMsgBackupMsgEntity != null))
    {
      if (!TextUtils.isEmpty(paramMsgBackupMsgEntity.chatUin)) {
        paramMsgBackupMsgEntity.chatUin = MsgBackupJniProxy.decryptFromString(paramMsgBackupMsgEntity.chatUin, axgj.c);
      }
      if (paramMsgBackupMsgEntity.extraData != null) {
        paramMsgBackupMsgEntity.extraData = MsgBackupJniProxy.decryptFromByteArray(paramMsgBackupMsgEntity.extraData, axgj.c);
      }
      if (paramMsgBackupMsgEntity.extensionData != null) {
        paramMsgBackupMsgEntity.extensionData = MsgBackupJniProxy.decryptFromByteArray(paramMsgBackupMsgEntity.extensionData, axgj.c);
      }
    }
  }
  ...
  {
    if ((b) && (paramMsgBackupResEntity != null) && (paramMsgBackupResEntity.extraData != null) && (axgj.b != null)) {
      paramMsgBackupResEntity.extraData = MsgBackupJniProxy.encryptFromByteArray(paramMsgBackupResEntity.extraData, axgj.b);
    }
  }
  
  public static void a(String paramString, axgq paramaxgq)
  {
    paramString = paramString.substring(0, paramString.indexOf(".")).split("_");
    paramaxgq.jdField_a_of_type_JavaLangString = paramString[0];
    paramaxgq.jdField_a_of_type_Int = c(Integer.parseInt(paramString[1]));
    if (paramString.length > 2) {
      paramaxgq.b = paramString[2];
    }
  }
  ...
  public static boolean a()
  {
    ...
    for (;;)
    {
      ...
      if (bool2)
      {
        File localFile = new File(axjg.b);
  ...
  public static long b(MessageRecord paramMessageRecord)
  {
    ...
    return bcsa.b(paramMessageRecord.msgUid);
  }
  ...
  {
    if ((b) && (paramMsgBackupMsgEntity != null) && (axgj.b != null))
    {
      if (!TextUtils.isEmpty(paramMsgBackupMsgEntity.chatUin)) {
        paramMsgBackupMsgEntity.chatUin = MsgBackupJniProxy.encryptFromString(paramMsgBackupMsgEntity.chatUin, axgj.b);
      }
      if (paramMsgBackupMsgEntity.extraData != null) {
        paramMsgBackupMsgEntity.extraData = MsgBackupJniProxy.encryptFromByteArray(paramMsgBackupMsgEntity.extraData, axgj.b);
      }
      if (paramMsgBackupMsgEntity.extensionData != null) {
        paramMsgBackupMsgEntity.extensionData = MsgBackupJniProxy.encryptFromByteArray(paramMsgBackupMsgEntity.extensionData, axgj.b);
      }
    }
  }
  ...
  {
    if ((b) && (paramMsgBackupResEntity != null) && (paramMsgBackupResEntity.extraData != null) && (axgj.c != null)) {
      paramMsgBackupResEntity.extraData = MsgBackupJniProxy.decryptFromByteArray(paramMsgBackupResEntity.extraData, axgj.c);
    }
  }
