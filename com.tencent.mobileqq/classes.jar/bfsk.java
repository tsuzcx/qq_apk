...
public class bfsk
{
  ...
  public static String a(int paramInt)
  {
    ...
    {
    default: 
      return bfbm.a().a().getString(2131695031);
    case 0: 
      return "";
    case 1: 
      return bfbm.a().a().getString(2131695036);
    case 2: 
      return bfbm.a().a().getString(2131695040);
    case 3: 
      return bfbm.a().a().getString(2131695038);
    case 4: 
      return bfbm.a().a().getString(2131695034);
    case 5: 
      return bfbm.a().a().getString(2131695031);
    }
    return bfbm.a().a().getString(2131695031);
  ...
  public static String a(String paramString)
  {
    ...
    {
      bfrz.a("WadlJsBridgeUtil", "getAppid error packageName is empty");
      return "";
    }
    ...
    for (;;)
    {
      try
      {
        ...
        bfrz.a("WadlJsBridgeUtil", "getAppid error", localOutOfMemoryError1);
      }
      catch (OutOfMemoryError localOutOfMemoryError1)
      {
        try
        {
          ...
          bfrz.c("WadlJsBridgeUtil", "getAppid packageName=" + str3 + ",appId=" + str1);
          return str1;
        }
  ...
  public static boolean a(String paramString1, String paramString2)
  {
    ...
    bfrz.c("WadlJsBridgeUtil", "savePackageInfo:appid:" + paramString2 + ",packageName:" + paramString1 + ",flag:" + bool);
    return bool;
  }
