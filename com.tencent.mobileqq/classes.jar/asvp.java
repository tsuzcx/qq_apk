...
public class asvp
  extends asvm
{
  public asvp(QQPlayerService paramQQPlayerService) {}
  ...
  public void a(asvi paramasvi)
  {
    ...
    try
    {
      ...
      QQPlayerService.a(this.a).register(paramasvi);
      return;
    }
    finally {}
  }
  ...
  public void b(asvi paramasvi)
  {
    if (QLog.isColorLevel()) {
      QLog.d("QQPlayerService", 2, "AIDL : unRegisterCallback");
    }
    if ((paramasvi != null) && (QQPlayerService.a(this.a) != null)) {
      QQPlayerService.a(this.a).unregister(paramasvi);
    }
  }
