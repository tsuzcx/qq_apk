...
public class qgc
{
  ...
  private TemplateBean a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if ((paramBaseArticleInfo.mProteusTemplateBean != null) && (!((syz)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusFactoryBaseTemplateFactory).a(paramBaseArticleInfo.mProteusTemplateBean))) {
          return paramBaseArticleInfo.mProteusTemplateBean;
        }
        if (this.jdField_a_of_type_Qca == null) {
          return null;
        }
        JSONObject localJSONObject = this.jdField_a_of_type_Qca.a(147, paramBaseArticleInfo);
        localTemplateBean = this.jdField_a_of_type_Qca.a(147, localJSONObject);
        try
        {
  ...
  private void a(pvc parampvc, VafContext paramVafContext)
  {
    paramVafContext = parampvc.a();
    if (paramVafContext != null)
    {
      parampvc = paramVafContext.b(parampvc.g() + 1);
      if ((parampvc != null) && (parampvc.mProteusTemplateBean == null)) {
        parampvc.mProteusTemplateBean = a(parampvc);
      }
    }
  }
  ...
  public int a()
  {
    if (b == 2147483647)
    {
      AIOUtils.catchedExceptionInReleaseV2(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException(amtj.a(2131702705)));
  ...
  public int a(ArticleInfo paramArticleInfo)
  {
    ...
    {
      AIOUtils.catchedExceptionInReleaseV2(jdField_a_of_type_JavaLangString, "", new IllegalArgumentException(amtj.a(2131702706)));
      return 147;
    }
  ...
  public ProteusItemView a(VafContext paramVafContext, int paramInt, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = localObject2;
        tpl.a(str, (String)localObject3, "DynamicPTS.getView", l2 - l1);
        localObject1 = localObject2;
      }
  ...
  public ProteusItemView a(VafContext paramVafContext, JSONObject paramJSONObject)
  {
    ...
    //   0: ldc_w 343
    //   3: iconst_1
    //   4: invokestatic 346	syz:a	(Ljava/lang/String;Z)Lsyz;
    //   7: astore_3
    //   8: aload_3
    //   9: ifnull +64 -> 73
    //   12: aload_3
    //   13: aload_2
    //   14: invokevirtual 350	syz:getTemplateBean	(Lorg/json/JSONObject;)Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;
    //   17: astore_2
    //   18: aload_1
    ...
    //   54: aconst_null
    //   55: aload_2
    //   56: invokestatic 355	ozp:a	(Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/container/Container;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;)V
    //   59: aload_3
    //   60: aload_2
    ...
    //   66: aload_1
    //   67: aload_2
    //   68: invokestatic 362	ozp:a	(Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/container/Container;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/virtualview/core/VafContext;Lcom/tencent/biz/pubaccount/readinjoy/view/proteus/bean/TemplateBean;)V
    //   71: aload_3
    //   72: areturn
    //   73: aconst_null
    //   74: astore_2
    ...
    //   79: aconst_null
    //   80: astore_1
    //   81: getstatic 18	qgc:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   84: iconst_1
    //   85: aload_2
    //   86: iconst_0
  ...
  public void a(ProteusItemView paramProteusItemView, int paramInt1, BaseArticleInfo paramBaseArticleInfo, VafContext paramVafContext, FaceDecoder paramFaceDecoder, slt paramslt, pvc parampvc, int paramInt2)
  {
    bjun.a("DynamicPTS.bindData");
    long l1 = System.currentTimeMillis();
    ...
    if (qge.a()) {
      qge.a(jdField_a_of_type_JavaLangString, "[bindData] " + paramBaseArticleInfo + " adapterViewType: " + paramInt1);
    }
    Object localObject1 = localObject2;
    if (localObject2 != null)
    {
      ...
      if (localTemplateBean != null)
      {
        ...
        {
          bjun.a("DynamicPTS.bindData.reuseView");
          localObject1 = paramVafContext.getViewFactory().inflate(paramVafContext, localTemplateBean);
          if (localObject1 != null)
          {
            ((Container)localObject1).setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841733));
            paramProteusItemView.d();
            paramProteusItemView.a((Container)localObject1);
            ozp.a((Container)localObject1, null, localTemplateBean);
          }
          paramBaseArticleInfo.mProteusTemplateBean = localTemplateBean;
          localObject1 = null;
          bjun.a();
    ...
    if (localTemplateBean != null)
    {
      bjun.a("DynamicPTS.bindData.compareWithOldTemplateBean");
      ozp.a((Container)localObject2, (TemplateBean)localObject1, localTemplateBean);
      bjun.a();
    }
    bjun.a("DynamicPTS.bindData.bindView");
    this.jdField_a_of_type_Qca.a(paramInt1, (Container)localObject2, parampvc, paramInt2);
    bjun.a();
    ozp.a(paramInt1, paramProteusItemView, paramVafContext, paramFaceDecoder, paramslt, parampvc, paramBaseArticleInfo);
    a(parampvc, paramVafContext);
    ozp.a((Container)localObject2, parampvc, localTemplateBean);
    long l2 = System.currentTimeMillis();
    ...
    {
      tpl.a(paramBaseArticleInfo, paramProteusItemView, "DynamicPTS.bindData", l2 - l1);
      bjun.a();
      return;
    }
  }
