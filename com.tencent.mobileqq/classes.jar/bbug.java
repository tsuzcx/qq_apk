  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject = new NewIntent(BaseApplicationImpl.getApplication(), bbun.class);
          ...
          ((NewIntent)localObject).putExtra("has_report_yes", new Boolean(bbuf.jdField_a_of_type_Boolean));
          BaseApplicationImpl.getApplication().getRuntime().startServlet((NewIntent)localObject);
          bbuf.jdField_a_of_type_Float = bbuf.jdField_a_of_type_Int - bbuf.b + bbuf.c;
          localObject = BaseApplicationImpl.getApplication().getRuntime().getAccount();
          if (!TextUtils.isEmpty((CharSequence)localObject)) {
            bbuf.jdField_a_of_type_JavaLangString = (String)localObject;
          }
          bbuf.jdField_a_of_type_Long = NetConnInfoCenter.getServerTimeMillis();
          QLog.i("SSOHttpUtils", 1, "SSOHttpUtils do report success steps:" + bbuf.jdField_a_of_type_Float);
        }
        ...
        if (((JSONObject)localObject).has("svr_steps"))
        {
          ...
          paramBundle = new NewIntent(BaseApplicationImpl.getApplication(), bbun.class);
