...
public class aenw
  extends BaseAdapter
{
  public aenw(StartLiveTopicLabelListView paramStartLiveTopicLabelListView) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramViewGroup = new aeny(this.a, null);
    ...
    for (;;)
    {
      paramView.setOnClickListener(new aenx(this));
      ((TopicViewItem)paramView).setText(paramViewGroup.a);
      return paramView;
      paramViewGroup = (aeny)paramView.getTag();
      break;
      label130:
