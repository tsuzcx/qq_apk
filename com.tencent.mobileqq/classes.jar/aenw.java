  ...
  implements aenz
{
  ...
  public aenw(QQAppInterface paramQQAppInterface, aeob paramaeob, Context paramContext, Intent paramIntent)
  {
  ...
  {
    paramVarArgs = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131493037, null);
    paramVarArgs.setOnClickListener(new aenx(this));
    ((TextView)paramVarArgs.findViewById(2131296866)).setText(this.jdField_a_of_type_JavaLangString);
    return paramVarArgs;
  }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    do
    {
      ...
      return;
      this.jdField_a_of_type_JavaLangString = String.format(ajjy.a(2131646912), new Object[] { str });
