  ...
  extends BusinessHandler
{
  ...
  aneg(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(int paramInt, String paramString)
  {
    ...
    localblbx.jdField_e_of_type_JavaLangString = "tianshu.47";
    localblbx.jdField_f_of_type_JavaLangString = "tianshu.47";
    localblbx.g = paramString;
    localblbx.h = "";
  ...
  private void a(@NonNull PrivExtV2Rsp paramPrivExtV2Rsp, String paramString)
  {
    ...
    Friends localFriends = localamsw.d(paramString);
    ...
    {
      paramPrivExtV2Rsp = (amuo)this.app.getManager(131);
    ...
    for (;;)
    {
      bgnx.a().a(this.app, localVipUserInfo);
      return;
      label555:
  ...
  private void a(VipMedalList paramVipMedalList, String paramString)
  {
    ...
    amsw localamsw = (amsw)this.app.getManager(51);
    paramString = localamsw.d(paramString);
  ...
  private boolean a(PrivExtV2Rsp paramPrivExtV2Rsp)
  {
    if (paramPrivExtV2Rsp.data_flag != null) {
      bkjx.a("drawer_trace_info", paramPrivExtV2Rsp.data_flag.trace_info);
    }
    bkjx.a(paramPrivExtV2Rsp.isQQLivePgc, paramPrivExtV2Rsp.qqLiveMsg);
    bgov.a(this.app, "setting_me_vip_sync_freq", paramPrivExtV2Rsp.iSyncFreq);
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, PayRuleCfg paramPayRuleCfg, boolean paramBoolean)
  {
    ...
    for (paramQQAppInterface = Boolean.valueOf(false);; paramQQAppInterface = Integer.valueOf(paramPayRuleCfg.enable))
    {
      ...
      return false;
      long l1 = bgov.a(paramQQAppInterface, "last_pull_pay_rule", 0L);
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, PrivExtV2Rsp paramPrivExtV2Rsp, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      if (localObject != null) {
        if (((VipUserInfo)localObject).bUpdate == 0)
        {
          ...
          bgoa.a(paramPrivExtV2Rsp.trafficResult, paramToServiceMsg.extraData);
          if ((localObject != null) && (((VipUserInfo)localObject).bUpdate == 1) && (paramPrivExtV2Rsp.trafficResult != null) && (paramPrivExtV2Rsp.trafficResult.bUpdate == 1) && (paramPrivExtV2Rsp.medalInfoList != null) && (paramPrivExtV2Rsp.medalInfoList.bUpdate == 1)) {
            bgov.a(this.app, "setting_me_get_vip_info_sequence", NetConnInfoCenter.getServerTime());
          }
          bgov.a(this.app, "setting_me_last_request_success_time", NetConnInfoCenter.getServerTime());
          if ((paramPrivExtV2Rsp.medalInfoList != null) && (paramPrivExtV2Rsp.medalInfoList.bUpdate == 1))
          {
            ...
            l1 = 1L;
            label233:
            bgov.a(this.app, "key_long_setting_me_vip_medal_list_record", l1);
          }
          paramToServiceMsg = paramPrivExtV2Rsp.itemCfgList;
          if (paramToServiceMsg != null)
          {
            l1 = bgov.a(this.app, "name_plate_config_version", 0L);
            ...
            {
              bgov.a(this.app, "name_plate_config_version", paramToServiceMsg.iItemCfgVer);
          ...
          {
            bgov.a(this.app, "last_pull_pay_rule", NetConnInfoCenter.getServerTime());
      ...
      for (;;)
      {
        ...
        bgou.a().a(this.app, paramPrivExtV2Rsp.map_menum);
        return paramBoolean;
    ...
    bhvw.a().a("ClubInfoSvc.queryPrivExt", 100, paramFromServiceMsg.getBusinessFailCode(), this.app.getCurrentAccountUin(), 1000277, "[CMD:ClubInfoSvc.queryPrivExtfailed]", true);
    return paramBoolean;
  }
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ("ClubInfoSvc.queryPrivExt".equals(str))
    {
      ...
      {
        bgff.jdField_a_of_type_Long = System.currentTimeMillis() / 1000L;
        bgff.a((VAResourcesRsp)paramObject);
