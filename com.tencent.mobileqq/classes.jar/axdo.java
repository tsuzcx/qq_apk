  ...
  extends SSLSocketFactory
{
  ...
  public axdo(SSLSocketFactory paramSSLSocketFactory)
  {
  ...
  private Socket a(Socket paramSocket)
  {
    ...
    {
      paramSocket = new axdr(this, (SSLSocket)paramSocket, null);
      ((axdr)paramSocket).setEnabledProtocols(new String[] { "TLSv1.1", "TLSv1.2" });
      return paramSocket;
    }
    return paramSocket;
  }
