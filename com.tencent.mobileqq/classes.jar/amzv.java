...
public class amzv
{
  ...
  public static amzv a()
  {
    try
    {
      if (jdField_a_of_type_Amzv == null) {
        jdField_a_of_type_Amzv = new amzv();
      }
      amzv localamzv = jdField_a_of_type_Amzv;
      return localamzv;
    }
    finally {}
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    {
      return;
      localancd = (ancd)paramQQAppInterface.getManager(155);
      localObject1 = localancd.a(paramSessionInfo);
    ...
    if (i >= 0)
    {
      ...
      ApolloGameData localApolloGameData = localancd.a(((MessageForApollo)localObject1).gameId);
      if ((localApolloGameData == null) || (!anca.a("8.4.1", localApolloGameData.minVer, localApolloGameData.maxVer))) {
        break label262;
      }
    }
    label262:
        ...
        do
        {
          do
          {
            do
            {
              ...
              localObject1 = localancd.a(((MessageForApollo)localObject1).gameId);
            } while ((localObject1 != null) && (anca.a("8.4.1", ((ApolloGameData)localObject1).minVer, ((ApolloGameData)localObject1).maxVer)));
            paramQQAppInterface = ((amul)paramQQAppInterface.getManager(249)).a();
