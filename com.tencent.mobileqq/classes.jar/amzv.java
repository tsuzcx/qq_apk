...
public abstract class amzv
{
  ...
  public static byte a(int paramInt, String arg1)
  {
    ...
    //   2: iload_0
    //   3: iconst_1
    //   4: invokestatic 11	amzv:a	(IZ)V
    //   7: aload_1
    //   8: iload_0
    //   9: invokestatic 14	amzv:a	(I)Ljava/lang/String;
    //   12: invokestatic 17	amzv:a	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   51: iload_0
    //   52: invokestatic 14	amzv:a	(I)Ljava/lang/String;
    ...
    //   80: astore_1
    //   81: aload 4
    //   83: invokestatic 69	bdcs:b	(Ljava/io/File;)Ljava/lang/String;
    //   86: astore 4
    //   88: aload 4
    //   90: astore_1
    //   91: aload_1
    ...
    //   96: aload_1
    //   97: aload 6
    //   99: invokestatic 72	amzv:a	(ILjava/lang/String;Ljava/util/HashMap;)Z
    //   102: ifeq +322 -> 424
    //   105: iload_0
    //   106: invokestatic 75	amzv:a	(I)Ljava/lang/Object;
    //   109: astore_1
    //   110: aload_1
    //   111: monitorenter
    //   112: aload 6
    ...
    //   157: invokestatic 105	amzv:c	(ILjava/lang/String;)Ljava/lang/String;
    //   160: astore 7
    //   162: new 45	java/lang/StringBuilder
    //   165: dup
    //   166: invokespecial 46	java/lang/StringBuilder:<init>	()V
    //   169: iload_0
    //   170: invokestatic 14	amzv:a	(I)Ljava/lang/String;
    ...
    //   208: ifeq +211 -> 419
    //   211: aload 9
    //   213: invokestatic 114	awiz:a	(Ljava/lang/String;)Ljava/lang/String;
    //   216: astore 9
    //   218: aload 6
    ...
    //   254: iload_0
    //   255: iconst_0
    //   256: invokestatic 11	amzv:a	(IZ)V
    //   259: iload_2
    //   260: ireturn
    //   261: astore_1
    //   262: iload_0
    //   263: iconst_0
    //   264: invokestatic 11	amzv:a	(IZ)V
    ...
    //   301: iload_0
    //   302: invokestatic 14	amzv:a	(I)Ljava/lang/String;
    //   305: iconst_0
    //   306: invokestatic 148	bdcs:a	(Ljava/lang/String;Z)V
    //   309: iconst_m1
    //   310: ireturn
    //   311: astore 4
    //   313: aload 4
  ...
  public static void a(String paramString1, String paramString2)
  {
    ...
    //   370: aload 8
    //   372: aload 9
    //   374: invokestatic 314	bdcs:b	(Ljava/io/File;Ljava/io/File;)Z
    //   377: ifne +125 -> 502
    //   380: aload 8
    //   382: aload 9
    //   384: invokestatic 316	bdcs:a	(Ljava/io/File;Ljava/io/File;)Z
    //   387: pop
    //   388: goto +114 -> 502
    //   391: astore_0
    //   392: aconst_null
  ...
  {
    if (paramInt == 0) {
      return anah.a(paramString, paramHashMap);
    }
    if (paramInt == 1) {
      return anaj.a(paramString, paramHashMap);
    }
    if (paramInt == 2) {
      return anai.a(paramString, paramHashMap);
    }
    return false;
  }
  ...
  {
    if (paramInt == 0) {
      return anah.a(paramString);
    }
    if (paramInt == 1) {
      return anaj.a(paramString);
    }
    if (paramInt == 2) {
      return anai.a(paramString);
    }
    return "";
  }
  ...
  {
    if (paramInt == 0) {
      return anah.b(paramString);
    }
    if (paramInt == 1) {
      return anaj.b(paramString);
    }
    if (paramInt == 2) {
      return anai.b(paramString);
    }
    return "";
  }
}
