...
public class ahgl
  ...
  implements afsn, ShortVideoConstants
{
  static ColorDrawable jdField_a_of_type_AndroidGraphicsDrawableColorDrawable = new asbg(-10065297, c, d);
  ...
  private View a(View paramView, ahgr paramahgr, ahgo paramahgo, MessageForShortVideo paramMessageForShortVideo)
  {
    if (paramMessageForShortVideo.isSendFromLocal())
    {
      ...
      if (paramahgo.a(str))
      {
        if (QLog.isColorLevel()) {
          QLog.i("ShortVideoPTVItemBuilder", 2, "getBubbleView: 占坑 msgSeq: " + paramahgr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq);
        }
        ...
        paramahgo.b(URLDrawable.getDrawable(new File(str), localURLDrawableOptions));
        a(paramahgr);
        Utils.executeAsyncTaskOnSerialExcuter(new ahgq(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, paramMessageForShortVideo), new Void[] { (Void)null });
      }
    }
    label146:
    do
    {
      return paramView;
      paramahgo.setImageDrawable(URLDrawableHelper.getFailedDrawable());
      b(paramahgr);
    } while (!QLog.isColorLevel());
    QLog.i("ShortVideoPTVItemBuilder", 2, "getBubbleView():You must get thumb before send video. msgSeq: " + paramahgr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq);
    return paramView;
  }
  
  private View a(View paramView, ahgr paramahgr, ahgo paramahgo, MessageForShortVideo paramMessageForShortVideo, String paramString1, String paramString2)
  {
    if (paramahgo.a(paramString1))
    {
      if (QLog.isColorLevel()) {
        QLog.i("ShortVideoPTVItemBuilder", 2, "getBubbleView: 刷缩略图 " + paramString1 + " msgSeq: " + paramahgr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq);
      }
      URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
      localURLDrawableOptions.mLoadingDrawable = jdField_a_of_type_AndroidGraphicsDrawableColorDrawable;
      localURLDrawableOptions.mFailedDrawable = jdField_a_of_type_AndroidGraphicsDrawableColorDrawable;
      paramahgo.b(URLDrawable.getDrawable(new File(paramString1), localURLDrawableOptions));
    }
    for (;;)
    {
      paramahgr.jdField_a_of_type_ComTencentMobileqqWidgetAudioAnimationView.d();
      ...
      a(paramahgr, paramMessageForShortVideo.videoFileProgress);
      return paramView;
      if (QLog.isColorLevel()) {
        QLog.i("ShortVideoPTVItemBuilder", 2, "getBubbleView: 刷缩略图用缓存 " + paramString1 + " msgSeq: " + paramahgr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq);
      }
      paramString1 = paramahgo.b;
      if ((paramString1 != null) && (paramString1.getStatus() == 1)) {
        paramahgo.b(paramString1);
      }
    }
    if ((ShortVideoUtils.isVideoSoLibLoaded()) && (ahgs.b))
    {
      b(paramahgr);
      return paramView;
    }
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("ShortVideoPTVItemBuilder", 2, "getBubbleView():短视频已过期不启动下载流程 1 msgSeq: " + paramahgr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq);
      }
      b(paramahgr, 2131718121);
      return paramView;
    }
  ...
  private void a(ahgr paramahgr, ahgo paramahgo, int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
    if (paramahgo.a(paramString2))
    {
      if (QLog.isColorLevel()) {
      ...
      if (ShortVideoUtils.isVideoSoLibLoaded())
      {
        ...
        localVideoDrawableParams.mRequestedFPS = ahgs.a;
        paramString1.mExtraInfo = localVideoDrawableParams;
        paramahgo.b(URLDrawable.getDrawable(new File(paramString2), paramString1));
      }
    }
    for (;;)
    {
  ...
  private void a(ahgr paramahgr, MessageForShortVideo paramMessageForShortVideo)
  {
    if (QLog.isColorLevel()) {
    ...
    {
      paramahgr.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.setFailedIconVisable(true, this);
  ...
  private void a(ahgr paramahgr, MessageForShortVideo paramMessageForShortVideo, ahgo paramahgo, int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
  ...
  private void a(ahgr paramahgr, MessageForShortVideo paramMessageForShortVideo, URLDrawable paramURLDrawable)
  {
    ...
    paramahgr.jdField_a_of_type_ComTencentMobileqqWidgetAudioAnimationView.c();
    jdField_b_of_type_JavaLangRefWeakReference = new WeakReference(paramMessageForShortVideo);
    paramURLDrawable.setOnAudioPlayOnceListener(new ahgn(this));
  }
  
  private void a(ahgr paramahgr, MessageForShortVideo paramMessageForShortVideo, String paramString, ahgo paramahgo, int paramInt1, int paramInt2)
  {
    if (QLog.isColorLevel()) {
    ...
    if (ahgs.b)
    {
      ...
      if (paramahgo.a(str))
      {
        ...
        if ((ShortVideoUtils.isVideoSoLibLoaded()) && (FileUtils.fileExistsAndNotEmpty(str)))
        {
          ...
          paramahgo.b(paramString);
        }
      }
      for (;;)
      {
        if (!paramMessageForShortVideo.isSend()) {
          new bbkg(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 2003, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, 1002);
        }
        if (paramMessageForShortVideo.subBusiType == 1) {
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006199", "0X8006199", 0, 0, "", "", "" + paramMessageForShortVideo.uuid, "" + paramMessageForShortVideo.isSend());
        }
        b(paramahgr);
        paramahgr.jdField_a_of_type_ComTencentMobileqqWidgetAudioAnimationView.setVisibility(0);
        return;
        label337:
        paramahgo.a(paramString);
      }
    }
    ...
    {
      if (!paramahgo.a(paramMessageForShortVideo)) {
        break label426;
      }
      paramString = URLDrawable.URLDrawableOptions.obtain();
      paramString.mRequestWidth = paramInt1;
      ...
      paramString.mLoadingDrawable = jdField_a_of_type_AndroidGraphicsDrawableColorDrawable;
      paramString.mFailedDrawable = jdField_a_of_type_AndroidGraphicsDrawableColorDrawable;
      paramahgo.b(URLDrawable.getDrawable(new File(paramMessageForShortVideo), paramString));
    }
    for (;;)
    {
      c(paramahgr);
      return;
      label426:
      paramMessageForShortVideo = paramahgo.b;
      if ((paramMessageForShortVideo != null) && (paramMessageForShortVideo.getStatus() == 1)) {
        paramahgo.b(paramMessageForShortVideo);
      }
    }
  }
  
  private void a(FileMsg paramFileMsg, ahgr paramahgr, MessageForShortVideo paramMessageForShortVideo, ahgo paramahgo)
  {
    if (QLog.isColorLevel())
    {
    ...
    else
    {
      ...
      if (FileUtils.fileExistsAndNotEmpty(paramMessageForShortVideo))
      {
        ...
        localURLDrawableOptions.mLoadingDrawable = jdField_a_of_type_AndroidGraphicsDrawableColorDrawable;
        localURLDrawableOptions.mFailedDrawable = jdField_a_of_type_AndroidGraphicsDrawableColorDrawable;
        paramahgo.b(URLDrawable.getDrawable(new File(paramMessageForShortVideo), localURLDrawableOptions));
      }
    }
    for (;;)
    {
    ...
    if ((paramChatMessage != null) && (paramListView != null))
    {
      ...
      if (i > -1)
      {
        ...
        if (paramListView != null)
        {
          ...
          if ((paramListView != null) && ((paramListView instanceof ahgr)))
          {
            paramListView = (ahgr)paramListView;
            if (paramListView != null) {
  ...
  private View b(View paramView, ahgr paramahgr, ahgo paramahgo, MessageForShortVideo paramMessageForShortVideo, String paramString1, String paramString2)
  {
    if (!paramMessageForShortVideo.isSend()) {
      new bbkg(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 2003, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, 1002);
    }
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.i("ShortVideoPTVItemBuilder", 2, "getBubbleView: 刷视频 " + paramString2 + " msgSeq: " + paramahgr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq);
      }
      ...
      if (!paramahgo.a(paramString1)) {
        ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = paramahgo.b;
      }
      VideoDrawable.VideoDrawableParams localVideoDrawableParams = new VideoDrawable.VideoDrawableParams();
      localVideoDrawableParams.mPlayVideoFrame = true;
      ...
      paramahgo.b((URLDrawable)localObject);
      if ((((URLDrawable)localObject).getCurrDrawable() instanceof VideoDrawable))
      {
        ...
        paramahgr.jdField_a_of_type_ComTencentMobileqqWidgetAudioAnimationView.c();
        if (QLog.isColorLevel()) {
          QLog.i("ShortVideoPTVItemBuilder", 2, "getBubbleView: 刷视频, isAudioPlaying= " + bool + ", videoPath:" + paramString2 + " msgSeq: " + paramahgr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq);
        }
      }
    }
    for (;;)
    {
      if (!FileUtils.fileExistsAndNotEmpty(paramString1))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.i("ShortVideoPTVItemBuilder", 2, "getBubbleView: Video file exist and status finish. Thumb not exist. msgSeq: " + paramahgr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq);
        }
      }
      if (!paramMessageForShortVideo.isSendFromLocal()) {
        break label568;
      }
      paramahgo = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getTransFileController().findProcessor(paramMessageForShortVideo.frienduin, paramMessageForShortVideo.uniseq);
      if (!BaseTransProcessor.class.isInstance(paramahgo)) {
        break label561;
      }
      if (((BaseTransProcessor)paramahgo).getFileStatus() == 1002L) {
        a(paramahgr, paramMessageForShortVideo.videoFileProgress);
      }
      return paramView;
      label417:
      paramahgr.jdField_a_of_type_ComTencentMobileqqWidgetAudioAnimationView.d();
      break;
      localObject = paramahgo.b;
      if ((localObject != null) && (((URLDrawable)localObject).getStatus() == 1))
      {
        paramahgo.b((URLDrawable)localObject);
        if ((((URLDrawable)localObject).getCurrDrawable() instanceof VideoDrawable))
        {
          paramahgo = (VideoDrawable)((URLDrawable)localObject).getCurrDrawable();
          if (QLog.isColorLevel()) {
            QLog.i("ShortVideoPTVItemBuilder", 2, "getBubbleView: 刷视频用缓存, isAudioPlaying= " + paramahgo.isAudioPlaying() + ", videoPath:" + paramString2 + " msgSeq: " + paramahgr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq);
          }
          if (paramahgo.isAudioPlaying()) {
            paramahgr.jdField_a_of_type_ComTencentMobileqqWidgetAudioAnimationView.c();
          } else {
            paramahgr.jdField_a_of_type_ComTencentMobileqqWidgetAudioAnimationView.d();
          }
  ...
  public afqq a(View paramView)
  {
    ...
    {
      paramView = (ahgr)((View)paramView.getParent()).getTag();
      if (paramView != null) {
        return paramView.jdField_a_of_type_Ahgo;
      }
    }
    return null;
  }
  ...
  public View a(int paramInt1, int paramInt2, ChatMessage paramChatMessage, View paramView, ViewGroup paramViewGroup, aftk paramaftk)
  {
    ...
    paramaftk = afsl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    if (paramaftk != null) {
      paramaftk.a(paramView, this);
    }
    ...
    try
    {
      paramViewGroup = (ahgr)paramView.getTag();
  ...
  {
    paramBaseChatItemLayout = (ahgr)paramafqr;
    ...
    if (paramView == null)
    {
      ...
      paramView = new ahgo((Context)localObject1);
      ...
      paramafqr.addView(paramView, (ViewGroup.LayoutParams)localObject2);
      ...
      paramafqr.addView((View)localObject2, localLayoutParams);
      ...
      ((AudioAnimationView)localObject3).setIcon(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838255));
      paramafqr.addView((View)localObject3, localLayoutParams);
      localObject1 = new ImageView((Context)localObject1);
      localLayoutParams = new RelativeLayout.LayoutParams(-2, -2);
      localLayoutParams.addRule(13);
      ((ImageView)localObject1).setVisibility(8);
      paramafqr.addView((View)localObject1, localLayoutParams);
      paramafqr.setOnClickListener(this);
      paramafqr.setOnTouchListener(paramaftk);
      paramafqr.setOnLongClickListener(paramaftk);
      paramBaseChatItemLayout.jdField_a_of_type_Ahgo = paramView;
    ...
    for (;;)
    {
      paramView = paramBaseChatItemLayout.jdField_a_of_type_Ahgo;
      paramaftk = (MessageForShortVideo)paramChatMessage;
      paramView.c = paramaftk.isSend();
      paramBaseChatItemLayout.jdField_a_of_type_ComTencentMobileqqWidgetCircleProgressView.setIsSend(paramaftk.isSend());
      if (e)
      {
      ...
      for (;;)
      {
        ...
        paramafqr.setContentDescription(((StringBuilder)localObject1).toString());
        if (paramaftk.md5 != null) {
          break;
        }
        return a(paramafqr, paramBaseChatItemLayout, paramView, paramaftk);
        label530:
      ...
      paramChatMessage = ShortVideoUtils.getShortVideoThumbPicPath(paramaftk.thumbMD5, "jpg");
      localObject1 = ShortVideoUtils.getShortVideoSavePath(paramaftk, "mp4");
      if (QLog.isColorLevel()) {
        QLog.i("ShortVideoPTVItemBuilder", 2, "getBubbleView() videoPath" + (String)localObject1 + "thumbPath=" + paramChatMessage);
      }
      if ((ahgs.b) && (ShortVideoUtils.isVideoSoLibLoaded()) && (FileUtils.fileExistsAndNotEmpty((String)localObject1)) && ((!paramaftk.isSendFromLocal()) || (paramaftk.videoFileStatus == 1003) || (paramaftk.videoFileStatus == 2003))) {
        return b(paramafqr, paramBaseChatItemLayout, paramView, paramaftk, paramChatMessage, (String)localObject1);
      }
      if (FileUtils.fileExistsAndNotEmpty(paramChatMessage)) {
        return a(paramafqr, paramBaseChatItemLayout, paramView, paramaftk, paramChatMessage, (String)localObject1);
      }
      if (paramaftk.videoFileStatus == 5002)
      {
        if (QLog.isColorLevel()) {
        ...
        b(paramBaseChatItemLayout, 2131718121);
  ...
  public String a(ChatMessage paramChatMessage)
  {
    if (bhfj.a(paramChatMessage.issend)) {
      return anvx.a(2131713518);
    }
    return anvx.a(2131713507);
  }
  ...
  public void a(int paramInt, Context paramContext, ChatMessage paramChatMessage)
  {
    ...
    if ((paramChatMessage != null) && ((paramChatMessage instanceof MessageForShortVideo)))
    {
      ...
      admh.b(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForShortVideo);
    }
    label38:
    do
    {
      do
      {
        ...
        {
          paramInt = azkc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage.istroop, paramChatMessage.frienduin);
          if (paramInt == 3) {
            paramContext = "1";
          }
          for (;;)
          {
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005624", "0X8005624", 0, 0, paramContext, "", "", "");
      ...
      if (paramContext != null) {
        ...
        else
        {
          ...
          else
          {
            ...
            ((QQMessageFacade)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.MGR_MSG_FACADE)).getBaseMessageManager(localMessageForShortVideo.istroop).d(localMessageForShortVideo);
            paramInt = i;
            if (QLog.isColorLevel())
            {
  ...
  void a(ahgr paramahgr)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ShortVideoPTVItemBuilder", 2, "showLoading() msgSeq: " + paramahgr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq);
    }
    paramahgr.jdField_a_of_type_ComTencentMobileqqWidgetCircleProgressView.setIndeterminate(true);
    paramahgr.jdField_a_of_type_ComTencentMobileqqWidgetCircleProgressView.a();
    paramahgr.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
  }
  
  void a(ahgr paramahgr, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ShortVideoPTVItemBuilder", 2, "showProgress(), progress = " + paramInt + " msgSeq: " + paramahgr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq);
    }
    CircleProgressView localCircleProgressView = paramahgr.jdField_a_of_type_ComTencentMobileqqWidgetCircleProgressView;
    int i = paramInt;
    if (paramInt > 100)
    {
      if (QLog.isColorLevel()) {
        QLog.d("ShortVideoPTVItemBuilder", 2, "startShowProgress, illegal process:" + paramInt + " msgSeq: " + paramahgr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq);
      }
      i = 100;
    }
  ...
  {
    super.a(paramView);
    paramView = (ahgr)AIOUtils.getHolder(paramView);
    ...
    localbkzi.a(new ahgm(this, localMessageForShortVideo, paramView, localbkzi));
    localbkzi.show();
  }
  ...
  public void a(View paramView, FileMsg paramFileMsg, int paramInt1, int paramInt2)
  {
    ...
    {
      return;
      localahgo = paramView.jdField_a_of_type_Ahgo;
      ...
      {
        b(paramFileMsg, paramView, localMessageForShortVideo, str, localahgo, paramInt1, paramInt2);
        return;
      }
    } while ((paramFileMsg.fileType != 7) && (paramFileMsg.fileType != 18) && (paramFileMsg.fileType != 16));
    a(paramFileMsg, paramView, localMessageForShortVideo, str, localahgo, paramInt1, paramInt2);
  }
  
  void a(MessageForShortVideo paramMessageForShortVideo)
  {
    bcxr localbcxr = bcwz.a(2, 3);
    ...
    if (QLog.isColorLevel()) {
      QLog.e("ShortVideoPTVItemBuilder", 2, "downloadThumb thumbPath" + localbcxb.i);
    }
  ...
  protected void a(MessageForShortVideo paramMessageForShortVideo, ahgr paramahgr)
  {
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      localObject = bcwz.a(1, 3);
      ((bcxr)localObject).a(bcwz.a(((bcxr)localObject).jdField_b_of_type_Int, paramMessageForShortVideo, (bcxr)localObject));
  ...
  void a(MessageForShortVideo paramMessageForShortVideo, boolean paramBoolean)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidContentContext, 1, 2131718340, 0).b(this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131299080));
      return;
      i = 0;
      break;
    }
    label114:
    localObject = bcwz.a(2, 3);
    ...
    localbcxb.a(paramMessageForShortVideo.istroop, 0);
    i = j;
    if (paramBoolean) {
      i = 2;
    }
    ...
    localbcxb.g = 2;
    if (QLog.isColorLevel()) {
      QLog.d("ShortVideoPTVItemBuilder", 2, " startDownloadVideo downloadvideo fileType==" + localbcxb.e + ", uniseq:" + paramMessageForShortVideo.uniseq + "localPath=" + localbcxb.h);
    }
    ((bcxr)localObject).a(localbcxb);
    ((bcxr)localObject).a(paramMessageForShortVideo);
    bcwz.a((bcxr)localObject, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  
  protected void a(FileMsg paramFileMsg, ahgr paramahgr, MessageForShortVideo paramMessageForShortVideo, String paramString, ahgo paramahgo, int paramInt1, int paramInt2)
  {
    ...
    case 2003: 
      ...
      if (QLog.isColorLevel()) {
        QLog.i("ShortVideoPTVItemBuilder", 2, "THUMB STATUS_RECV_FINISHED: videoExists=" + bool + ", sAutoPlayInAIO=" + ahgs.b);
      }
      if ((bool) && (ahgs.b))
      {
        a(paramahgr, paramahgo, paramInt1, paramInt2, paramFileMsg, paramString);
        return;
      }
      a(paramahgr, paramMessageForShortVideo, paramahgo, paramInt1, paramInt2, paramFileMsg, paramString);
      return;
    case 5002: 
      if (QLog.isColorLevel()) {
    ...
    if (FileUtils.fileExistsAndNotEmpty(paramFileMsg)) {
      if (paramahgo.a(paramFileMsg))
      {
        ...
        if (ShortVideoUtils.isVideoSoLibLoaded())
        {
          ...
          paramString.mRequestedFPS = ahgs.a;
          paramMessageForShortVideo.mExtraInfo = paramString;
          paramahgo.b(URLDrawable.getDrawable(new File(paramFileMsg), paramMessageForShortVideo));
        }
      }
    }
    for (;;)
    {
      b(paramahgr);
      return;
      paramFileMsg = paramahgo.b;
      if ((paramFileMsg != null) && (paramFileMsg.getStatus() == 1))
      {
        paramahgo.b(paramFileMsg);
        continue;
        paramahgo.setImageDrawable(jdField_a_of_type_AndroidGraphicsDrawableColorDrawable);
      }
    }
  }
  ...
  public bhjs[] a(View paramView)
  {
    ...
    Object localObject = (ahgr)AIOUtils.getHolder(paramView);
    paramView = (MessageForShortVideo)((ahgr)localObject).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
    if (paramView.md5 != null)
    {
      ...
      if (FileUtils.fileExistsAndNotEmpty(str)) {
        if ((((ahgr)localObject).jdField_a_of_type_ComTencentMobileqqWidgetCircleProgressView == null) || (!((ahgr)localObject).jdField_a_of_type_ComTencentMobileqqWidgetCircleProgressView.a())) {
          break label271;
        }
      }
    }
    ...
    {
      int j = k;
      if (((ahgr)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.c != null)
      {
        j = k;
        if (((ahgr)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.c.getVisibility() == 0) {
          j = 1;
        }
      }
  ...
  void b(ahgr paramahgr)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ShortVideoPTVItemBuilder", 2, "hideProgress() msgSeq: " + paramahgr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq);
    }
    paramahgr.jdField_a_of_type_ComTencentMobileqqWidgetCircleProgressView.c();
    paramahgr.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
  }
  
  void b(ahgr paramahgr, int paramInt)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ShortVideoPTVItemBuilder", 2, "showWarnProgress() msgSeq: " + paramahgr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq);
    }
    paramahgr.jdField_a_of_type_ComTencentMobileqqWidgetCircleProgressView.c();
    paramahgr.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
    paramahgr.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845692);
    paramahgr.jdField_a_of_type_ComTencentMobileqqWidgetAudioAnimationView.setVisibility(4);
  }
  ...
  protected void b(MessageForShortVideo paramMessageForShortVideo, ahgr paramahgr)
  {
    ...
    do
    {
      ...
      {
        paramahgr = bcwz.a(4, 3);
        paramahgr.a(bcwz.a(paramahgr.jdField_b_of_type_Int, paramMessageForShortVideo, paramahgr));
        bcwz.a(paramahgr, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        return;
      }
    } while (!QLog.isColorLevel());
  ...
  protected void b(FileMsg paramFileMsg, ahgr paramahgr, MessageForShortVideo paramMessageForShortVideo, String paramString, ahgo paramahgo, int paramInt1, int paramInt2)
  {
    switch (paramFileMsg.status)
    {
    default: 
    ...
    case 2004: 
      do
      {
        ...
        paramahgr.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.setFailedIconVisable(false, this);
        return;
        if (QLog.isColorLevel()) {
        ...
        paramahgr.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.setFailedIconVisable(true, this);
        b(paramahgr);
        paramahgr.jdField_a_of_type_ComTencentMobileqqWidgetAudioAnimationView.setVisibility(8);
        return;
        if (QLog.isColorLevel()) {
        ...
        a(paramahgr, paramMessageForShortVideo.videoFileProgress);
        return;
        a(paramahgr, paramMessageForShortVideo, paramString, paramahgo, paramInt1, paramInt2);
        return;
        a(paramahgr, paramMessageForShortVideo);
        return;
        a(paramFileMsg, paramahgr, paramMessageForShortVideo, paramahgo);
        return;
      } while (!QLog.isColorLevel());
  ...
  void c(ahgr paramahgr)
  {
    if (QLog.isColorLevel()) {
      QLog.d("ShortVideoPTVItemBuilder", 2, "showPauseProgress() msgSeq: " + paramahgr.jdField_a_of_type_ComTencentMobileqqDataChatMessage.uniseq);
    }
    paramahgr.jdField_a_of_type_ComTencentMobileqqWidgetCircleProgressView.c();
    paramahgr.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
    paramahgr.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130845691);
    paramahgr.jdField_a_of_type_ComTencentMobileqqWidgetAudioAnimationView.setVisibility(4);
  }
  ...
  {
    ahgr localahgr = (ahgr)AIOUtils.getHolder(paramView);
    MessageForShortVideo localMessageForShortVideo = (MessageForShortVideo)localahgr.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
    ...
    if (!FileUtils.fileExistsAndNotEmpty(str))
    {
      ...
      bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005E96", "0X8005E96", 0, 0, "", "", "", "");
    }
    for (;;)
    {
      if (!localMessageForShortVideo.isSend()) {
        new bbkg(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 2003, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curType, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.curFriendUin, 1003);
      }
      if (localMessageForShortVideo.isBlessMsg) {
        bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006199", "0X8006199", 0, 0, "", "", "" + localMessageForShortVideo.uuid, "" + localMessageForShortVideo.isSend());
      }
      super.onClick(paramView);
      break;
      if (FileUtils.fileExistsAndNotEmpty((String)localObject))
      {
        if ((ahgs.b) && (ShortVideoUtils.isVideoSoLibLoaded()))
        {
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005E95", "0X8005E95", 0, 0, "", "", "", "");
          if (this.jdField_a_of_type_ComTencentWidgetListView == null) {
            break;
          }
          if ((localahgr.jdField_a_of_type_Ahgo.getDrawable() == null) || (!(localahgr.jdField_a_of_type_Ahgo.getDrawable() instanceof URLDrawable))) {
            continue;
          }
          localObject = (URLDrawable)localahgr.jdField_a_of_type_Ahgo.getDrawable();
          if ((((URLDrawable)localObject).getStatus() != 1) || (!(((URLDrawable)localObject).getCurrDrawable() instanceof VideoDrawable))) {
            continue;
          }
          a(localahgr, localMessageForShortVideo, (URLDrawable)localObject);
          continue;
        }
        ShortVideoRealItemBuilder.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, localMessageForShortVideo, localahgr.jdField_a_of_type_Ahgo, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, false, true, true, true, null);
      }
    }
  }
}
