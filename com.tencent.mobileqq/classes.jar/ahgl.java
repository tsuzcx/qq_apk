...
public class ahgl
{
  ...
  public ahgl(Conversation paramConversation)
  {
  ...
  private void b()
  {
    this.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragFrameLayout = ((DragFrameLayout)this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a().findViewById(2131364694));
    ...
    this.b = this.jdField_a_of_type_AndroidViewView.findViewById(2131363098);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131363097).setBackgroundColor(this.jdField_a_of_type_ComTencentMobileqqActivityConversation.a().getColor(2131165422));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367579));
    this.jdField_a_of_type_AndroidViewView.setOnTouchListener(new ahgm(this));
    ((ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367581)).setOnClickListener(new ahgn(this));
  }
  ...
  public void a()
  {
    bgxb.a(this.jdField_a_of_type_AndroidViewView);
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new ahgo(this, paramString2));
    PreloadManager.a().c(paramString1, new ahgp(this));
  }
}
