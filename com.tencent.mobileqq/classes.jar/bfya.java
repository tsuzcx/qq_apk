...
public class bfya
{
  ...
  {
    return baxn.a(bfxz.a(this.jdField_a_of_type_Bfxz), paramFloat);
  }
  ...
  {
    Object localObject = new bfyc(a(paramInt3));
    ((bfyc)localObject).resize(paramInt1, paramInt2);
  ...
  public bfxz a()
  {
    ...
    this.jdField_a_of_type_Bfxz.c(localDrawable1);
    localDrawable1 = a(a(this.c), a(this.d), 49, this.b);
    Drawable localDrawable2 = a(a(this.d), a(this.c), 51, this.b);
    this.jdField_a_of_type_Bfxz.b(localDrawable2);
    this.jdField_a_of_type_Bfxz.a(localDrawable1);
    return this.jdField_a_of_type_Bfxz;
  }
