...
public abstract class bfya
{
  ...
  private static final Interpolator sDragScrollInterpolator = new bfyb();
  private static final Interpolator sDragViewScrollCapInterpolator = new bfyc();
  private static final bfyh sUICallback = new bfyj();
  ...
  public static bfyh getDefaultUIUtil()
  {
    return sUICallback;
  }
  ...
  void onDraw(Canvas paramCanvas, RecyclerView paramRecyclerView, RecyclerView.ViewHolder paramViewHolder, List<bfye> paramList, int paramInt, float paramFloat1, float paramFloat2)
  {
    int j = paramList.size();
    int i = 0;
    while (i < j)
    {
      bfye localbfye = (bfye)paramList.get(i);
      localbfye.c();
      int k = paramCanvas.save();
      onChildDraw(paramCanvas, paramRecyclerView, localbfye.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder, localbfye.e, localbfye.f, localbfye.jdField_b_of_type_Int, false);
  ...
  void onDrawOver(Canvas paramCanvas, RecyclerView paramRecyclerView, RecyclerView.ViewHolder paramViewHolder, List<bfye> paramList, int paramInt, float paramFloat1, float paramFloat2)
  {
    int j = paramList.size();
    int i = 0;
    while (i < j)
    {
      bfye localbfye = (bfye)paramList.get(i);
      int k = paramCanvas.save();
      onChildDrawOver(paramCanvas, paramRecyclerView, localbfye.jdField_b_of_type_AndroidSupportV7WidgetRecyclerView$ViewHolder, localbfye.e, localbfye.f, localbfye.jdField_b_of_type_Int, false);
      paramCanvas.restoreToCount(k);
      i += 1;
    }
    if (paramViewHolder != null)
    ...
    if (i >= 0)
    {
      paramCanvas = (bfye)paramList.get(i);
  ...
  public void onMoved(RecyclerView paramRecyclerView, RecyclerView.ViewHolder paramViewHolder1, int paramInt1, RecyclerView.ViewHolder paramViewHolder2, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((localLayoutManager instanceof bfyg)) {
      ((bfyg)localLayoutManager).a(paramViewHolder1.itemView, paramViewHolder2.itemView, paramInt3, paramInt4);
    }
    do
    {
      do
