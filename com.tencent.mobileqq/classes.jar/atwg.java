...
public class atwg
{
  ...
  public static atwh a(int paramInt1, int paramInt2, atwi paramatwi, boolean paramBoolean)
  {
    ...
    default: 
      ...
      if (i > j)
      {
        i3 = i;
        n = j;
        switch (paramatwi.jdField_a_of_type_Int)
        {
        default: 
          paramatwi = new atwh();
          paramatwi.jdField_a_of_type_Int = paramInt1;
          paramatwi.b = paramInt2;
          return paramatwi;
        }
      }
      break;
  ...
  public static atwh a(int paramInt1, int paramInt2, String paramString)
  {
    int i = g;
    int j = h;
    atwh localatwh = new atwh();
    float f1;
    if (bgmg.b(paramString))
    {
      ...
      localatwh.jdField_a_of_type_Int = localOptions.outWidth;
      localatwh.b = localOptions.outHeight;
      paramString = localatwh;
  ...
  public static atwh a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    int i;
    if (paramInt1 > paramInt2) {
      i = paramInt2;
    ...
    {
      atwi localatwi = a(i, j);
      i = a(paramInt1, paramInt2, jdField_a_of_type_Int);
      return a(paramInt1 * i, i * paramInt2, localatwi, false);
      i = paramInt1;
    }
  }
  
  public static atwh a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (bgmg.b(paramFileManagerEntity.strMiddleThumPath))
    {
      ...
      localatwh.jdField_a_of_type_Int = localOptions.outWidth;
      localatwh.b = localOptions.outHeight;
      paramFileManagerEntity = localatwh;
  ...
  private static atwi a(int paramInt1, int paramInt2)
  {
    int i = 0;
    int j = 1;
    ...
    for (;;)
    {
      atwi localatwi = new atwi();
      localatwi.jdField_a_of_type_Int = paramInt2;
      localatwi.b = paramInt1;
      return localatwi;
      paramInt1 = 2;
      paramInt2 = 2;
      continue;
  ...
  public static String a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (!TextUtils.isEmpty(paramFileManagerEntity.strFileMd5)) {
      paramFileManagerEntity = bkdr.a(paramFileManagerEntity.strFileMd5);
    }
    for (;;)
    {
      ...
      {
        paramFileManagerEntity = bkdr.a(paramFileManagerEntity.Uuid);
      }
      else if (atwl.b(paramFileManagerEntity.getFilePath()))
      {
        localObject = atvo.e(paramFileManagerEntity.getFilePath());
        if ((localObject != null) && (localObject.length > 0)) {
          paramFileManagerEntity = bgmj.a((byte[])localObject).toUpperCase();
        } else {
          paramFileManagerEntity = bkdr.a(paramFileManagerEntity.fileName);
        }
      }
      else
      {
  ...
  public static String a(String paramString)
  {
    ...
    {
      return null;
      String str1 = bgmj.a(atvo.e(paramString));
      a();
      str1 = atut.a().d() + a(5, str1);
      ...
      for (;;)
      {
        for (;;)
        {
          ...
          {
            if (!bgmg.b(str2)) {
              ayzh.a(paramString, str2, true, "", 1);
            }
            if ((!bgmg.b(str2)) || (bgmg.b(new File(str2), new File(str1)) != true)) {
              break;
            }
            return str1;
          }
  ...
  private static String a(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ayzh.a(paramString1, str, true, "", paramInt);
        if (bgmg.b(str)) {
          break label220;
        }
      ...
      continue;
      label220:
      if (!bgmg.b(new File(str), new File(paramString2)))
      {
        bgmg.a(str, true);
  ...
  public static URL a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject1)) {
      localObject2 = bgmj.a(atvo.e(paramFileManagerEntity.getFilePath())).toUpperCase();
    }
    localObject1 = atut.a().d() + a(5, bkdr.a((String)localObject2));
    if ((bgmg.b(str)) && (!atwl.b(paramFileManagerEntity.strMiddleThumPath)) && (bgmg.b(new File(str), new File((String)localObject1)) == true)) {
  ...
  {
    File localFile = new File(atut.a().d());
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
  }
  ...
  private static void a(FileManagerEntity paramFileManagerEntity, String paramString)
  {
    ...
    paramString = a(paramString, atut.a().d() + a(5, str), 1);
    if (paramString == null) {
  ...
  {
    if ((paramFileManagerEntity.status == 16) && (!atvo.e(paramFileManagerEntity))) {}
    while ((paramFileManagerEntity.cloudType == 1) && (atvo.a(paramFileManagerEntity))) {
      return true;
    }
    return false;
  }
