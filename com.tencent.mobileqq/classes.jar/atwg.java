...
{
  atwg(atwa paramatwa, String paramString1, JSONObject paramJSONObject, String paramString2) {}
  
  public void onClick(View paramView)
  {
    Object localObject = new HashMap();
    abet.a((Map)localObject, this.jdField_a_of_type_JavaLangString);
    ((Map)localObject).put(Integer.valueOf(2), this.jdField_a_of_type_JavaLangString);
    ((Map)localObject).put(Integer.valueOf(10), "2");
    abet.a(alvx.a(), "769", "205711", this.jdField_a_of_type_Atwa.a().gameAppId, "76905", "1", "160", (Map)localObject);
    localObject = new Intent();
    ((Intent)localObject).setClass(atwa.a(this.jdField_a_of_type_Atwa), ForwardRecentActivity.class);
    ...
    ((Intent)localObject).putExtra("scale", atwa.a(this.jdField_a_of_type_Atwa).getResources().getDisplayMetrics().scaledDensity);
