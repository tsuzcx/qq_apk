...
public class afac
  extends BaseAdapter
  implements View.OnClickListener, bfry
{
  public static int a;
  ...
  public afac(Context paramContext, QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, MqqHandler paramMqqHandler)
  {
    ...
    {
      this.jdField_b_of_type_JavaUtilList.add(new afae());
      i += 1;
    }
    this.jdField_a_of_type_JavaUtilList.addAll(this.jdField_b_of_type_JavaUtilList);
    this.jdField_a_of_type_Float = this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().density;
    this.c = actn.a(85.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.d = actn.a(85.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.e = actn.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.f = actn.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.g = actn.a(2.5F, this.jdField_a_of_type_AndroidContentContext.getResources());
  }
  
  public afae a(int paramInt)
  {
    if (paramInt < this.jdField_a_of_type_JavaUtilList.size()) {
      return (afae)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    }
    return null;
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    {
      this.jdField_a_of_type_JavaUtilList.clear();
      axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008C71", "0X8008C71", aezn.a(aezn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a()), 0, "", "", "", "");
    }
    this.jdField_a_of_type_JavaLangString = paramString;
    while (i < paramInt)
    {
      this.jdField_a_of_type_JavaUtilList.add(new afae());
      i += 1;
    }
    this.jdField_b_of_type_Int = -1;
    notifyDataSetChanged();
  ...
  public void a(afae paramafae)
  {
    if (paramafae != null)
    {
      int i = paramafae.jdField_a_of_type_Int;
      if ((i >= 0) && (i < this.jdField_a_of_type_JavaUtilList.size())) {
        ((afae)this.jdField_a_of_type_JavaUtilList.get(i)).a(paramafae);
      }
      notifyDataSetChanged();
    }
  }
  ...
  public void b()
  {
    ...
    if (TextUtils.isEmpty(((afae)this.jdField_a_of_type_JavaUtilList.get(i - 1)).d)) {}
    while (i <= this.jdField_b_of_type_Int) {
      return;
    }
    this.jdField_b_of_type_Int = i;
    aezn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.jdField_a_of_type_JavaUtilList.size(), this.jdField_a_of_type_JavaLangString);
  }
  
  public void b(View paramView)
  {
    if ((paramView != null) && ((paramView.getTag() instanceof afad)))
    {
      paramView = (afad)paramView.getTag();
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((paramView == null) || (paramView.getTag() == null))
    {
      ...
      paramViewGroup.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(localafae);
      paramViewGroup.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
      if (!localafae.jdField_a_of_type_Boolean) {
        break label822;
      }
      String str = aezn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(localafae);
      localObject2 = aezn.a(str);
      localObject1 = localObject2;
      if (localObject2 == null)
      {
        aezn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).c(localafae);
        localObject1 = localObject2;
        if (QLog.isColorLevel()) {
    ...
    {
      if ((localafae.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null) || (localObject1 != null))
      {
        paramViewGroup.jdField_a_of_type_AndroidWidgetRelativeLayout.setMinimumWidth(0);
        localObject2 = localafae.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
        paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView.setTag(localafae.jdField_a_of_type_JavaLangString + localafae.e);
      ...
      for (localObject1 = new GifDrawable((AbstractGifImage)localObject1);; localObject1 = localObject2)
      {
        ...
        for (;;)
        {
          if ((localafae.jdField_a_of_type_Afaf != null) && (!localafae.jdField_a_of_type_Afaf.jdField_a_of_type_Boolean))
          {
            aezn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(localafae);
            localafae.jdField_a_of_type_Afaf.jdField_a_of_type_Boolean = true;
          }
          return paramView;
          paramViewGroup = (afad)paramView.getTag();
          break;
          if (j > this.f)
          {
            i = i * this.f / j;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ((paramView != null) && ((paramView instanceof afad))) {}
      for (paramView = (afad)paramView;; paramView = null)
      {
        if (paramView == null) {
          break label149;
        }
        paramView = (afae)paramView.jdField_a_of_type_JavaLangRefWeakReference.get();
        if ((paramView == null) || (paramView.jdField_a_of_type_JavaLangString == null) || (paramView.jdField_a_of_type_Afaf == null)) {
          break;
        }
        ThreadManager.post(new ZhituPicAdapter.1(this, paramView), 8, null, false);
        aezn.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(paramView);
