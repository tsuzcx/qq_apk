...
public class bnax
{
  private static bnax jdField_a_of_type_Bnax;
  private Handler jdField_a_of_type_AndroidOsHandler = new Handler(Looper.getMainLooper(), new bnay(this));
  private bnaz jdField_a_of_type_Bnaz = new bnaz(this, null);
  private bnbb jdField_a_of_type_Bnbb;
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  
  private bnax(AppInterface paramAppInterface)
  {
    this.jdField_a_of_type_ComTencentCommonAppAppInterface = paramAppInterface;
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null) {
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.registObserver(this.jdField_a_of_type_Bnaz);
    }
  }
  
  public static bnax a(AppInterface paramAppInterface)
  {
    if (jdField_a_of_type_Bnax == null) {
      jdField_a_of_type_Bnax = new bnax(paramAppInterface);
    }
    return jdField_a_of_type_Bnax;
  }
  ...
  public static void a()
  {
    if (jdField_a_of_type_Bnax != null)
    {
      jdField_a_of_type_Bnax.b();
      jdField_a_of_type_Bnax = null;
    }
  }
  ...
  private void a(double paramDouble1, double paramDouble2, int paramInt)
  {
    ...
    NewIntent localNewIntent = new NewIntent(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getApp(), bmao.class);
    ...
    switch (bdee.a(BaseApplicationImpl.getApplication().getBaseContext()))
    {
    default: 
      i = 0;
    }
  ...
  private void a(boolean paramBoolean, ArrayList<String> paramArrayList, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Bnbb != null)
    {
      ...
      this.jdField_a_of_type_Bnbb.a(paramInt, paramBoolean, (ArrayList)localObject);
    }
  }
  ...
  private void b()
  {
    if (this.jdField_a_of_type_ComTencentCommonAppAppInterface != null)
    {
      ...
      this.jdField_a_of_type_ComTencentCommonAppAppInterface.unRegistObserver(this.jdField_a_of_type_Bnaz);
      this.jdField_a_of_type_ComTencentCommonAppAppInterface = null;
    }
    this.jdField_a_of_type_Bnbb = null;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (bool2)
        {
          ...
          SosoInterface.a(new bnba(this, 0, true, true, 30000L, false, false, "NewFlowCameraActivity", paramInt));
        }
        if (this.jdField_a_of_type_Bnbb != null) {
          this.jdField_a_of_type_Bnbb.a(paramInt, bool2);
        }
        return;
      }
