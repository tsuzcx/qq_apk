public abstract class axbe
{
  ...
  public axbe(int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  {
    if ((paramInt >= this.jdField_c_of_type_Int) && (this.jdField_a_of_type_Axbf != null)) {
  ...
  {
    this.jdField_a_of_type_Axbf = paramaxbf;
  }
