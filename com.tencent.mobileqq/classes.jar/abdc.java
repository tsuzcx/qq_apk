  ...
  implements BusinessObserver
{
  ...
  {
    if ((this.a.jdField_a_of_type_Bhht != null) && (!this.a.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
      this.a.jdField_a_of_type_Bhht.dismiss();
    }
    if (!paramBoolean)
    {
      bhzt.a().a(2131691425);
      if (this.a.jdField_a_of_type_Abdd != null) {
        this.a.jdField_a_of_type_Abdd.a(false);
      }
    }
    do
    {
      ...
      bhzt.a().a(2131691425);
    } while (this.a.jdField_a_of_type_Abdd == null);
    this.a.jdField_a_of_type_Abdd.a(false);
    return;
    int j;
    for (;;)
    {
      try
      {
        ...
        if (j != 0)
        {
          bhzm.a("LightAppUtil", "GETLightAppSettingCallBack failed,resultCode=" + j);
          bhzt.a().a(2131691425);
          if (this.a.jdField_a_of_type_Abdd != null) {
            this.a.jdField_a_of_type_Abdd.a(false);
          }
          ...
          abdm.a(this.a.jdField_a_of_type_MqqAppAppRuntime, "Net_Get_LiteappSetting", 0, j, paramInt);
          return;
        }
      }
      ...
      try
      {
        ...
        bhzt.a().a(2131691425);
        if ((this.a.jdField_a_of_type_Bhht != null) && (this.a.jdField_a_of_type_Bhht.isShowing()) && (this.a.jdField_a_of_type_AndroidAppActivity != null) && (!this.a.jdField_a_of_type_AndroidAppActivity.isFinishing())) {
          this.a.jdField_a_of_type_Bhht.dismiss();
        }
        if (this.a.jdField_a_of_type_Abdd != null) {
          this.a.jdField_a_of_type_Abdd.a(true);
        }
        abdm.a(null, "Net_LiteApp_Setting", 0, 1, this.a.jdField_a_of_type_ComTencentDeviceDatadefDeviceInfo.productId);
        return;
      }
    ...
    for (;;)
    {
      if (paramInt < paramBundle.length())
      {
        ...
        for (;;)
        {
          if (!abdb.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Integer.valueOf(localLightAppSettingInfo.jdField_c_of_type_Int)))
          {
            abdb.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Integer.valueOf(localLightAppSettingInfo.jdField_c_of_type_Int), localLightAppSettingInfo);
            abdb.jdField_a_of_type_JavaUtilArrayList.add(localLightAppSettingInfo);
          }
      ...
      {
        if ((this.a.c) || (abdb.jdField_a_of_type_JavaUtilArrayList.size() <= 0)) {
          break;
        }
        ...
        ((aara)((QQAppInterface)paramBundle).getBusinessHandler(51)).a(abdb.jdField_a_of_type_JavaUtilArrayList);
        break;
        label909:
        abdm.a(null, "Net_Get_LiteappSetting", 0, j, paramInt);
        return;
        label920:
        paramInt = 0;
        break label223;
