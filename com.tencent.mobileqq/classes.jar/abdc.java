  ...
  extends WebViewPlugin
{
  ...
  private void b()
  {
    if (this.jdField_a_of_type_Niw == null) {
      this.jdField_a_of_type_Niw = new niw(this.jdField_a_of_type_ComTencentBizPubaccountCustomWebView, new abdd(this));
    }
  }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null)
      {
        ...
        this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getLayoutInflater().inflate(2131559032, null));
        this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378958));
        this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131378952));
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_AndroidWidgetImageView != null) {
          this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new abde(this));
        }
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Niw != null)
        {
          ...
          this.jdField_a_of_type_Niw = null;
        }
