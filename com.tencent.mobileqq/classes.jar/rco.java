...
public class rco
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = "zimage." + rco.class.getSimpleName();
  }
  
  rco(int paramInt)
  {
    this.jdField_a_of_type_JavaUtilList = Collections.synchronizedList(new LinkedList());
    this.jdField_a_of_type_Rcq = new rcq(2097152);
    ...
    this.jdField_a_of_type_Rda = new rcp(this);
  }
      ...
      try
      {
        ...
        try
        {
          if (i < this.jdField_b_of_type_JavaUtilList.size())
          {
            ...
            if (localBitmap != null)
            {
              if (rdc.a(localBitmap, paramOptions))
              {
                ...
                if (QLog.isColorLevel()) {
                  rdc.a(jdField_a_of_type_JavaLangString, "getReuseableBitmap found:" + str + " picSize:" + paramOptions.outWidth + "x" + paramOptions.outHeight + " bitmap:" + localBitmap + " state:" + toString());
                }
                return localBitmap;
              }
            }
  ...
  rcs a(rcw paramrcw)
  {
    ...
    {
      return null;
      paramrcw = babe.a(paramrcw.a());
    } while ((paramrcw == null) || (!paramrcw.a()));
    return paramrcw.a();
  }
