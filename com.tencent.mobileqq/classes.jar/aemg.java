  ...
  implements aeov, View.OnClickListener, bhrf
{
  ...
  public void a()
  {
    ...
    {
      localObject1 = this.jdField_a_of_type_Aemd.jdField_a_of_type_Aflj.a(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage, this.jdField_a_of_type_Aemd);
        ...
        for (;;)
        {
          ...
          if (this.jdField_a_of_type_Boolean) {
            if (((afyi)localObject3).jdField_a_of_type_Ansf != null) {
              ((afyi)localObject3).jdField_a_of_type_Ansf.a(this.jdField_a_of_type_Aemd.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((afyi)localObject3).jdField_a_of_type_ComTencentMobileqqDataChatMessage.isSend(), ((afyi)localObject3).jdField_a_of_type_ComTencentMobileqqDataChatMessage.needVipBubble(), true, ((afyi)localObject3).jdField_a_of_type_AndroidViewView, false);
            }
          }
          for (;;)
          {
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqDataChatMessage != null) {
      if (i == 2131365069)
      {
        if (aemd.a(this.jdField_a_of_type_Aemd) != null) {
          aemd.a(this.jdField_a_of_type_Aemd).a(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
        }
        VipUtils.a(this.jdField_a_of_type_Aemd.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "chat_history", "ChatHistory", "Clk_delete", 1, 0, new String[0]);
      }
    }
    for (;;)
    {
      ...
      if (i == 2131377432)
      {
        azmj.b(this.jdField_a_of_type_Aemd.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009061", "0X8009061", 0, 0, "", "", "", "");
        paramView = (MessageForFile)this.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
        paramView = arni.a(this.jdField_a_of_type_Aemd.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramView);
        if (paramView != null) {
          bacb.a(paramView, this.jdField_a_of_type_Aemd.b, this.jdField_a_of_type_Aemd.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1);
        } else {
          QQToast.a(BaseApplicationImpl.getApplication(), 1, BaseApplicationImpl.getApplication().getString(2131720665), 0).b(BaseApplicationImpl.getApplication().getResources().getDimensionPixelSize(2131298914));
        }
      }
      else
      {
        aemj localaemj = this.jdField_a_of_type_Aemd.jdField_a_of_type_Aflj.a(this.jdField_a_of_type_ComTencentMobileqqDataChatMessage, this.jdField_a_of_type_Aemd);
  ...
  {
    if (this.jdField_a_of_type_Aemd.jdField_a_of_type_Boolean) {}
    for (boolean bool1 = false;; bool1 = this.jdField_a_of_type_Aemd.jdField_a_of_type_Ajtb.a(paramView))
    {
      this.jdField_b_of_type_Boolean = true;
      if ((paramView instanceof ArkAppView)) {
        ((ArkAppView)paramView).onLongClick(paramView);
      }
      if ((this.jdField_a_of_type_Ajte == null) || (!this.jdField_a_of_type_Ajte.a())) {
        break;
      }
      a(paramView);
      return false;
    ...
    this.jdField_a_of_type_ComTencentMobileqqDataChatMessage = ((aemk)aekt.a(paramView)).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
    ...
    if ((i == -2014) || (i == -2005))
    {
      ...
      localObject4 = arni.a(this.jdField_a_of_type_Aemd.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForFile)localObject1);
      if ((localObject4 != null) && (((FileManagerEntity)localObject4).status != 16))
      {
        long l = arni.a(this.jdField_a_of_type_Aemd.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((FileManagerEntity)localObject4).fileName);
        localObject2 = aotn.a().c();
        localObject1 = localObject2;
        if (TextUtils.isEmpty((CharSequence)localObject2)) {
          localObject1 = badt.a;
        }
        if ((this.d) && (badt.a(((FileManagerEntity)localObject4).strFilePath, ((FileManagerEntity)localObject4).fileName, (String)localObject1)) && (((FileManagerEntity)localObject4).fileSize <= l))
        {
          azmj.b(this.jdField_a_of_type_Aemd.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009060", "0X8009060", 0, 0, "", "", "", "");
          ((bdkz)localObject3).a(2131377432, this.jdField_a_of_type_Aemd.b.getString(2131720668), 2130838688);
        }
      }
    }
    Object localObject2 = ((aemk)aekt.a(paramView)).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
    Object localObject1 = this.jdField_a_of_type_Aemd.jdField_a_of_type_Aflj.a((ChatMessage)localObject2, this.jdField_a_of_type_Aemd);
    ...
    if ((localObject4 != null) && (localObject4.length > 0))
    {
      ...
      while (i < j)
      {
        bdlb localbdlb = localObject4[i];
        k = localbdlb.a();
        if (((k == 2131364910) || (k == 2131376287) || (k == 2131366750) || (k == 2131366015)) && (localbdlb.b() != 2130838366)) {
          ((bdkz)localObject3).a(localbdlb);
        }
        i += 1;
      }
    }
    ((bdkz)localObject3).a(2131365069, this.jdField_a_of_type_Aemd.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131690760), 2130838672);
    if (((bdkz)localObject3).a() > 0)
    {
      this.jdField_a_of_type_ComTencentMobileqqDataChatMessage = ((aemk)aekt.a(paramView)).jdField_a_of_type_ComTencentMobileqqDataChatMessage;
    ...
    for (i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        if (this.jdField_a_of_type_Ajte == null)
        {
          this.jdField_a_of_type_Ajte = new ajsw(this.jdField_a_of_type_Aemd.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie);
          this.jdField_a_of_type_Ajte.a(this);
          this.jdField_a_of_type_Ajte.a(this);
        }
        this.jdField_a_of_type_Ajte.a = ((int)this.jdField_a_of_type_AndroidGraphicsPointF.y);
        ...
        if (bool1)
        {
          ...
          {
            bool2 = true;
            ((ajte)localObject4).a((bdkz)localObject3, bool2);
        ...
        {
          if (bool1) {
            this.jdField_a_of_type_Aemd.jdField_a_of_type_Ajtb.a(paramView, this.jdField_a_of_type_Ajte);
          }
          return true;
          bool2 = false;
          break;
          localObject2 = this.jdField_a_of_type_Ajte.a(paramView, this.jdField_a_of_type_Aemd.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie);
          this.jdField_a_of_type_Ajte.a(paramView, k, ((ajtf)localObject2).a, (bdkz)localObject3, true, ((ajtf)localObject2).b);
          break label730;
          label892:
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    Object localObject = this.jdField_a_of_type_Aemd.jdField_a_of_type_Aflj.a(((aemk)aekt.a(paramView)).jdField_a_of_type_ComTencentMobileqqDataChatMessage, this.jdField_a_of_type_Aemd);
