...
public class ler
  implements muv
{
  public ler(DeviceCapabilityExamination paramDeviceCapabilityExamination) {}
  ...
  public void a(int paramInt, long paramLong, String paramString1, String paramString2)
  {
    ...
    axrn.a(BaseApplication.getContext()).a(this.a.a.getCurrentAccountUin(), "QAV_REPORT_VIDEO_EFFECT_TEST", true, 0L, 0L, localHashMap, "", true);
  }
}
