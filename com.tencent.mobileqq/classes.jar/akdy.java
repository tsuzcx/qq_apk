  ...
  protected Boolean a(Void... paramVarArgs)
  {
    for (;;)
    {
      try
      {
        ...
        akdt.a((QQAppInterface)localObject);
        if ((!akdt.jdField_a_of_type_Boolean) || (akdt.jdField_c_of_type_Boolean) || (akdt.jdField_a_of_type_AndroidContentIntent == null)) {
          return Boolean.valueOf(false);
        }
        if ((akdt.b != 0) && (Build.VERSION.SDK_INT > akdt.b)) {
          return Boolean.valueOf(false);
        }
        ...
        if (bbmy.a() == 0)
        {
          ...
          if (i != 0)
          {
            if (!akdt.a((QQAppInterface)localObject)) {
              return Boolean.valueOf(false);
            }
            localObject = PreferenceManager.getDefaultSharedPreferences(((QQAppInterface)localObject).getApp());
            long l3 = System.currentTimeMillis();
            if (akdt.a() == -1L) {
              akdt.a(((SharedPreferences)localObject).getLong("push_open_notify_lasttime", l3));
            }
            long l1 = 0L;
            i = 0;
            ...
            if (n == 1)
            {
              l1 = akdt.jdField_c_of_type_Int * akdt.jdField_a_of_type_Long;
              i = akdt.d;
              j = i;
              m = i1;
              l2 = l1;
              ...
              if (i1 >= i)
              {
                ...
                if (n == 1)
                {
                  l2 = akdt.jdField_c_of_type_Int * akdt.jdField_a_of_type_Long;
                  j = akdt.d;
                  k = n;
                  m = i1;
                }
              ...
              else
              {
                if (QLog.isColorLevel()) {
                  QLog.d("PushOpenNotify", 2, new Object[] { "PopOpenMsgNotifation, stage:", Integer.valueOf(k), " stagecount:", Integer.valueOf(m), " count:", Integer.valueOf(i2), " countMax:", Integer.valueOf(j), " pushInteral:", Long.valueOf(l2), " timeDiff:", Long.valueOf(l3 - akdt.a()) });
                }
                if ((l3 - akdt.a() <= l2) && (i2 != 0)) {
                  break label754;
                }
                akdt.a(l3);
            ...
            else
            {
              if (n == 2)
              {
                l1 = akdt.e * akdt.jdField_a_of_type_Long;
                i = akdt.f;
                continue;
              }
              if (n != 3) {
              ...
              l1 = akdt.g * akdt.jdField_a_of_type_Long;
              i = 2147483647;
              continue;
            }
            if (n == 2)
            {
              l2 = akdt.e * akdt.jdField_a_of_type_Long;
              j = akdt.f;
              m = i1;
              k = n;
              continue;
            ...
            l1 = akdt.g;
            l2 = akdt.jdField_a_of_type_Long;
            l2 = l1 * l2;
            j = 2147483647;
            m = i1;
            k = n;
