  ...
  extends axuo
{
  ...
  private void b(Context paramContext, ViewGroup paramViewGroup)
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      int i = actn.a(11.0F, paramContext);
      int j = actn.a(14.0F, paramContext);
      paramViewGroup.setPadding(j, i, j, actn.a(12.0F, paramContext));
    }
  }
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    {
      Object localObject11 = (axun)((Iterator)localObject10).next();
      if ((localObject11 instanceof axwq))
      {
        localObject11 = (axwq)localObject11;
        if (((axwq)localObject11).p == axwq.o) {
          ((axwq)localObject11).p = axwq.m;
        }
      }
    }
    if ((paramView != null) && ((paramView instanceof TextViewWrapLayout)))
    {
      ...
      localObject4 = (axun)((Iterator)localObject9).next();
      ((axun)localObject4).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
      localObject5 = ((axun)localObject4).jdField_a_of_type_JavaLangString;
      if ((("picture".equals(localObject5)) || ("vote".equals(localObject5)) || ("video".equals(localObject5))) && (localObject3 == null)) {
        localObject3 = ((axun)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131367947), paramBundle);
      }
    }
    for (;;)
    {
      ...
      if (("title".equals(localObject5)) && (localObject2 == null))
      {
        ...
        localObject2 = (TextView)((axun)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131378378), paramBundle);
      }
      else if (localObject1 == null)
      {
        if (("summary".equals(localObject5)) || ("timer".equals(localObject5)))
        {
          localObject1 = (TextView)((axun)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131378362), paramBundle);
        }
        else if ("checklist".equals(localObject5))
        {
          paramView = (LinearLayout)((axun)localObject4).a(paramContext, ((TextViewWrapLayout)localObject8).findViewById(2131378089), paramBundle);
          continue;
          ...
          {
            localObject5 = (axun)((Iterator)localObject10).next();
            ((axun)localObject5).jdField_a_of_type_JavaLangRefWeakReference = this.jdField_a_of_type_JavaLangRefWeakReference;
            localObject6 = ((axun)localObject5).jdField_a_of_type_JavaLangString;
            if ((("picture".equals(localObject6)) || ("vote".equals(localObject6)) || ("video".equals(localObject6))) && (localObject3 == null)) {
              localObject3 = ((axun)localObject5).a(paramContext, null, paramBundle);
            }
          }
          for (;;)
          {
            ...
            if (("title".equals(localObject6)) && (localObject2 == null))
            {
              ...
              localObject2 = (TextView)((axun)localObject5).a(paramContext, null, paramBundle);
            }
            else if (localObject1 == null)
            {
              if (("summary".equals(localObject6)) || ("timer".equals(localObject6)))
              {
                localObject1 = (TextView)((axun)localObject5).a(paramContext, null, paramBundle);
              }
              else if ("checklist".equals(localObject6))
              {
                paramView = (LinearLayout)((axun)localObject5).a(paramContext, null, paramBundle);
                continue;
                ...
                if ((this.k == 1) || (this.k == 3)) {
                  if (this.k == 1)
                  {
                    localObject2 = new RelativeLayout.LayoutParams(actn.a(50.0F, (Resources)localObject9), actn.a(50.0F, (Resources)localObject9));
                    ((RelativeLayout.LayoutParams)localObject2).topMargin = actn.a(3.0F, (Resources)localObject9);
                    ...
                    ((RelativeLayout.LayoutParams)localObject10).topMargin = actn.a(12.0F, (Resources)localObject9);
                    ...
                    ((RelativeLayout.LayoutParams)localObject10).leftMargin = actn.a(10.0F, (Resources)localObject9);
                    ...
                    if (localObject6 != null)
                    {
                      ...
                      i = k;
                      if ((paramContext instanceof axzh))
                      {
                        paramContext = (axzh)paramContext;
                        i = k;
                        if (paramContext != null)
                        {
                          if (TextUtils.isEmpty(paramContext.b())) {
                    ...
                    paramContext = ((axzz)paramContext).jdField_a_of_type_JavaUtilArrayList;
                ...
                for (;;)
                {
                  ...
                  for (;;)
                  {
                    ...
                    return localObject4;
                    localObject2 = new RelativeLayout.LayoutParams(actn.a(115.0F, (Resources)localObject9), actn.a(70.0F, (Resources)localObject9));
                    ((RelativeLayout.LayoutParams)localObject2).topMargin = actn.a(3.0F, (Resources)localObject9);
                    break label819;
                    label1399:
                    ((RelativeLayout.LayoutParams)localObject10).topMargin = actn.a(7.0F, (Resources)localObject9);
                    ((RelativeLayout.LayoutParams)localObject7).topMargin = 0;
                    break label881;
                    if (!this.jdField_a_of_type_Boolean)
                    {
                      if (localObject1 != null) {
                        ((TextView)localObject1).setLineSpacing(actn.a(1.0F, (Resources)localObject9), 1.0F);
                      }
                      localObject2 = new RelativeLayout.LayoutParams(actn.a(50.0F, (Resources)localObject9), actn.a(50.0F, (Resources)localObject9));
                      ((RelativeLayout.LayoutParams)localObject2).topMargin = actn.a(7.0F, (Resources)localObject9);
                      ((RelativeLayout.LayoutParams)localObject2).leftMargin = actn.a(10.0F, (Resources)localObject9);
                      ((RelativeLayout.LayoutParams)localObject2).addRule(3, ((TextView)localObject5).getId());
                      ((RelativeLayout.LayoutParams)localObject2).addRule(11);
                      ((RelativeLayout.LayoutParams)localObject7).topMargin = actn.a(5.0F, (Resources)localObject9);
                    ...
                    localObject2 = new RelativeLayout.LayoutParams(actn.a(32.0F, (Resources)localObject9), actn.a(32.0F, (Resources)localObject9));
                    ((RelativeLayout.LayoutParams)localObject2).leftMargin = actn.a(6.0F, (Resources)localObject9);
                    ((RelativeLayout.LayoutParams)localObject2).addRule(11);
