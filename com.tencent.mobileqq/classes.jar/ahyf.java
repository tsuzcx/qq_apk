  ...
  extends BaseAdapter
{
  ...
  private ahyf(ClassificationSearchFragment paramClassificationSearchFragment) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      if (paramView == null)
      {
        paramView = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2131560877, paramViewGroup, false);
        ...
        localObject1 = new ahyz();
        ((ahyz)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367958));
        ((ahyz)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371790));
        ((ahyz)localObject1).jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131380110));
        ((ahyz)localObject1).jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365443));
        ((ahyz)localObject1).d = ((TextView)paramView.findViewById(2131370302));
        ((ahyz)localObject1).jdField_a_of_type_ComTencentPbAddcontactsAccountSearchPb$record = ((AccountSearchPb.record)getItem(paramInt));
        ((ahyz)localObject1).jdField_b_of_type_Int = ClassificationSearchFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment);
        paramView.setTag(2131370568, Integer.valueOf(paramInt));
        paramView.setTag(localObject1);
        localView = paramView;
        if ((((ahyz)localObject1).jdField_a_of_type_AndroidWidgetImageView instanceof ThemeImageView))
        {
          ((ThemeImageView)((ahyz)localObject1).jdField_a_of_type_AndroidWidgetImageView).setSupportMaskView(false);
          localView = paramView;
        }
      }
      ...
      if (AppSetting.c)
      {
        ...
        if (paramView == null)
        {
          localView = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2131561405, null);
          paramView = new ahyy();
          ...
          paramView.jdField_c_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131378646));
          paramView.d = ((TextView)localView.findViewById(2131363073));
          paramView.jdField_b_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363702));
        ...
        paramView = (ahyy)localView.getTag();
        ...
        int i = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.getResources().getDimensionPixelSize(2131297456);
        ...
        try
        {
          ...
          if ((((AccountSearchPb.record)localObject1).brief.has()) && (!"".equals(((AccountSearchPb.record)localObject1).brief.get()))) {
            if (this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a(paramView.jdField_a_of_type_AndroidWidgetTextView, this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a()) > 1)
            {
              ...
              localObject2 = (ImageView)localView.findViewById(2131380989);
              ((ImageView)localObject2).setVisibility(4);
              ImageView localImageView = (ImageView)localView.findViewById(2131365187);
        ...
        if (paramView == null)
        {
          localView = this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.a().getLayoutInflater().inflate(2131559487, null);
          localView.setOnClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment);
          paramView = new ahye();
          localView.setTag(paramView);
        ...
        localObject1 = (ahye)localView.getTag();
        if (this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.jdField_a_of_type_Int == 3)
        {
          if (!this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactClassificationSearchFragment.jdField_a_of_type_Boolean)
          {
            ...
            ((ahye)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
            ((ahye)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(amtj.a(2131701069));
            paramView = localView;
          }
          else
          {
            ...
            if (NetworkUtil.isNetSupport(BaseApplicationImpl.getContext()))
            {
              ...
              ((ahye)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
              ((ahye)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(amtj.a(2131701078));
        ...
        {
          ((ahye)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
          ((ahye)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(amtj.a(2131701086));
          paramView = localView;
        }
        else
        {
          ...
          {
            ((ahye)localObject1).jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
            ((ahye)localObject1).jdField_a_of_type_AndroidWidgetTextView.setText(amtj.a(2131701082));
            paramView = localView;
          }
        }
      }
