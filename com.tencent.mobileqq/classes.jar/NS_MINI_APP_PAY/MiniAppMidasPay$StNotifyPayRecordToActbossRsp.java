...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24, 32 }, new String[] { "extInfo", "total_pay", "surplus", "lottery_count" }, new Object[] { null, Long.valueOf(0L), Long.valueOf(0L), Long.valueOf(0L) }, StNotifyPayRecordToActbossRsp.class);
