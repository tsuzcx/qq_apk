...
{
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 16, 24 }, new String[] { "extInfo", "remainder", "rechargeNum" }, new Object[] { null, Integer.valueOf(0), Integer.valueOf(0) }, StQueryStarCurrencyRsp.class);
