...
public class muo
{
  private static BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new mup();
  static String jdField_a_of_type_JavaLangString = "actAVGSensorCaseReport";
  int jdField_a_of_type_Int = 0;
  private long jdField_a_of_type_Long;
  ArrayList<muq> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  muq jdField_a_of_type_Muq = null;
  ...
  private void a(int paramInt, ArrayList<muq> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          muq localmuq = (muq)paramArrayList.next();
          JSONObject localJSONObject = new JSONObject();
          localJSONObject.put("i", localmuq.jdField_a_of_type_Int);
          localJSONObject.put("off", localmuq.jdField_a_of_type_Long);
          localJSONObject.put("on", localmuq.jdField_b_of_type_Long);
          localJSONObject.put("why", localmuq.jdField_c_of_type_Long);
      ...
      catch (JSONException paramArrayList)
      {
        ...
        for (localObject1 = "JSONException. ";; localObject1 = ((JSONObject)localObject1).toString())
        {
          ...
          this.jdField_a_of_type_Muq = null;
          if (paramInt == 1) {
            break;
          }
  ...
  void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, int paramInt, boolean paramBoolean4, VideoController paramVideoController)
  {
    ...
    long l = System.currentTimeMillis();
    paramVideoController = this.jdField_a_of_type_Muq;
    this.jdField_a_of_type_Muq = null;
    if (paramVideoController != null)
    {
  ...
  void c()
  {
    this.jdField_a_of_type_Muq = new muq(this);
    this.jdField_a_of_type_Muq.jdField_a_of_type_Int = this.h;
    this.h += 1;
    this.jdField_a_of_type_Muq.jdField_a_of_type_Long = System.currentTimeMillis();
    this.jdField_a_of_type_JavaUtilArrayList.add(this.jdField_a_of_type_Muq);
  }
