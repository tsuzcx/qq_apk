...
public class amir
{
  ...
  {
    axqw.b(null, "dc00898", "", "", "0X800AA80", "0X800AA80", amhi.b(this.jdField_a_of_type_Int), 0, String.valueOf(paramInt), "", "", "");
    ...
    if (paramInt == 17039360)
    {
      ...
      if (!TextUtils.isEmpty(paramColorNote.getSubType()))
      {
        i = paramInt;
        str1 = str2;
        if (apvk.a(paramColorNote.getSubType()) == 4)
        {
          str1 = "0X800AA83";
          i = 1;
        }
      }
      switch (apue.a(paramColorNote.getMainTitle()))
      {
      case 5: 
      case 8: 
      default: 
        ...
        axqw.b(null, "dc00898", "", "", str1, str1, paramInt, 0, "", "", "", "");
      }
    }
    do
    {
      ...
      if (paramInt == 17104896)
      {
        ...
        axqw.b(null, "dc00898", "", "", "0X800AA83", "0X800AA83", paramInt, 0, "", "", "", "");
        return;
      }
  ...
  {
    Object localObject = new amjb();
    ArrayList localArrayList = new ArrayList();
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      localArrayList.add(((amjb)localObject).a(paramContext, (ColorNote)localIterator.next()));
    }
    ...
    while (paramContext.hasNext())
    {
      ...
      ((HistoryFormItem)localObject).setItemOnClickListener(new amis(this, (HistoryFormItem)localObject));
      ((HistoryFormItem)localObject).setOnIconClickListener(new amit(this, (HistoryFormItem)localObject));
      i += 1;
    }
    return localArrayList;
  }
  
  public void a(amiu paramamiu)
  {
    this.jdField_a_of_type_Amiu = paramamiu;
  }
