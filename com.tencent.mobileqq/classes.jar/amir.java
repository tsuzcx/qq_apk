  ...
  extends anyz
{
  ...
  protected void onDeleteAllSysMsg(boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      if (amik.a(this.a) != null) {
        amik.a(this.a).finish();
      }
      return;
    }
    QQToast.a(amik.a(this.a), 2131698933, 0).a();
  }
  ...
  protected void onGetDelSystemMsgError()
  {
    ...
    amik.d(this.a);
    String str = amik.a(this.a).getResources().getString(2131719146);
    QQToast.a(amik.a(this.a), 1, str, 0).b(amik.b(this.a));
  }
  ...
  protected void onGetDelSystemMsgFin(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    while ((!paramBoolean2) || (!amik.a(this.a))) {
      return;
    }
    String str = amik.a(this.a).getResources().getString(2131719146);
    QQToast.a(amik.a(this.a), 1, str, 0).b(amik.b(this.a));
  ...
  protected void onGetSystemMsgFin(boolean paramBoolean1, boolean paramBoolean2, List<MessageRecord> paramList)
  {
    ...
    for (;;)
    {
      amik.e(this.a);
      return;
      if ((paramBoolean2) && (amik.a(this.a)))
      {
        paramList = amik.a(this.a).getResources().getString(2131719153);
        QQToast.a(amik.a(this.a), 1, paramList, 0).b(amik.b(this.a));
      }
    }
  }
  ...
  protected void onSendSystemMsgActionError(String paramString)
  {
    ...
    amik.d(this.a);
    paramString = amik.a(this.a).getResources().getString(2131719155);
    QQToast.a(amik.a(this.a), 1, paramString, 0).b(amik.b(this.a));
  }
  ...
  protected void onSendSystemMsgActionFin(boolean paramBoolean, String paramString1, int paramInt1, String paramString2, int paramInt2, int paramInt3, String paramString3, String paramString4, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        QQToast.a(amik.a(this.a), 1, paramString3, 0).b(amik.b(this.a));
      ...
      continue;
      label219:
      paramString3 = amik.a(this.a).getResources().getString(2131718500);
      continue;
      label239:
      paramString1 = amik.a(this.a).getResources().getString(2131692562);
      QQToast.a(amik.a(this.a), 2, paramString1, 0).b(amik.b(this.a));
      long l2 = bdzx.a().a();
      ...
      try
      {
        ...
        if (ajbi.a(this.a.a, String.valueOf(localStructMsg.req_uin.get()), localStructMsg, false))
        {
        ...
        AutoRemarkActivity.a(amik.a(this.a), 0, String.valueOf(localStructMsg.req_uin.get()), l1, paramString3);
        return;
      }
      catch (Exception paramString1)
      {
