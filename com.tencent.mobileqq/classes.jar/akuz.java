...
public final class akuz
  implements akuw, Handler.Callback, bdld, bdll, bdml
{
  private static akuz jdField_a_of_type_Akuz;
  private int jdField_a_of_type_Int;
  private akuv jdField_a_of_type_Akuv;
  ...
  private WeakReference<akvb> jdField_a_of_type_JavaLangRefWeakReference;
  private final ArrayList<akvc> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  public boolean a;
  ...
  private int a(int paramInt1, int paramInt2)
  {
    ...
    String str;
    Bundle localBundle;
    if ((this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper != null) && (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akve != null) && (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akve.jdField_a_of_type_JavaLangString != null))
    {
      str = this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akve.jdField_a_of_type_JavaLangString;
      localBundle = new Bundle();
      localBundle.putString(bdlb.b, "100686848");
      localBundle.putString(bdlb.j, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.strNewSoftwareURL);
      localBundle.putString(bdlb.f, this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName());
      localBundle.putInt(bdlb.k, paramInt1);
      if (paramInt1 == 12) {
        localBundle.putBoolean(bdlb.o, true);
      }
      localBundle.putString(bdlb.i, "ANDROIDQQ.QQUPDATE");
      localBundle.putString(bdlb.l, str);
      if (paramInt2 == 0) {
        break label319;
      }
      localBundle.putString(bdlb.m, "_100686848");
    ...
    {
      localBundle.putString(bdlb.jdField_c_of_type_JavaLangString, "6633");
      localBundle.putInt(bdlb.e, this.jdField_a_of_type_Int);
      localBundle.putBoolean(bdlb.g, true);
      localBundle.putBoolean(bdlb.h, true);
      localBundle.putInt(bdlb.n, 1);
      localBundle.putInt(bdlb.A, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.bGray);
      bdkx.a(BaseActivity.sTopActivity, localBundle, "biz_src_jc_update", this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_ComTencentApkupdateLogicDataApkUpdateDetail, i);
      return 0;
      str = "新版手Q";
      break;
      label319:
  ...
  public static akuz a()
  {
    if (jdField_a_of_type_Akuz == null) {
      jdField_a_of_type_Akuz = new akuz();
    }
    return jdField_a_of_type_Akuz;
  }
  ...
  public static String a()
  {
    ...
    if (localObject != null)
    {
      localObject = ((akuz)localObject).jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper;
      str1 = str2;
      if (localObject != null)
      {
        str1 = str2;
  ...
  {
    return bfnx.a(paramString, "nt", akuy.a());
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (localObject != null)
    {
      ...
      if ((localObject != null) && (((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo != null)) {
        if ((((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.iUpgradeType > 0) && (((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.bNewSwitch == 1))
        {
          ...
          if (ajud.a(paramQQAppInterface, ((UpgradeDetailWrapper)localObject).jdField_a_of_type_ProtocolKQQConfigUpgradeInfo.iNewTimeStamp)) {
            break label96;
          }
          bool1 = bool2;
        }
    ...
    for (;;)
    {
      bool2 = bool1;
      if (!bool1) {
        bool2 = ((asfc)paramQQAppInterface.getManager(244)).a();
      }
      return bool2;
      bool1 = false;
      break;
  ...
  private void b(int paramInt)
  {
    try
    {
      ajud localajud = (ajud)((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getRuntime()).a(4);
      ...
      localajud.a(str, paramInt, this.jdField_a_of_type_JavaLangString);
      return;
    }
    finally
    {
  ...
  private void c(int paramInt)
  {
    ...
    do
    {
      ...
      localakvb = (akvb)this.jdField_a_of_type_JavaLangRefWeakReference.get();
    } while (localakvb == null);
    if (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_ProtocolKQQConfigUpgradeInfo != null) {
      localakvb.a(paramInt, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper, this);
    }
  ...
  private void d(int paramInt)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      ...
      if (localIterator.hasNext()) {
        ((akvc)localIterator.next()).a(paramInt, this);
      }
    }
  }
  ...
  private void h()
  {
    try
    {
      if (a())
      {
        this.jdField_a_of_type_Akva.b();
        this.jdField_a_of_type_Akva = null;
      }
      return;
    }
    finally
  ...
  private void i()
  {
    ...
    axqy.b((QQAppInterface)localObject, "CliOper", "", "", "0X800716C", "0X800716C", 0, 0, "", "", "", "");
    int i = 0;
    this.jdField_a_of_type_Boolean = false;
    if (bbfj.h(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl)) {
      i = 1;
    }
    ...
    axrn.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", true, 0L, 0L, (HashMap)localObject, "", true);
  }
  ...
  private void k()
  {
    try
    {
      ...
      if (this.d)
      {
        bdmk.a().b(this);
        bdmk.a().a();
        if (this.jdField_a_of_type_Akuv != null)
        {
          bdkx.b(this.jdField_a_of_type_Akuv);
          this.jdField_a_of_type_Akuv = null;
        }
  ...
  public void a()
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadInfo != null) && (this.jdField_a_of_type_ComTencentOpenDownloadnewDownloadInfo.jdField_c_of_type_Int == 1))
      {
        ...
        ajud.b(localQQAppInterface, false);
        d(false);
        return;
      }
    } while (this.b);
    b(ajud.a(localQQAppInterface, false));
  }
  ...
  public void a(int paramInt)
  {
    ...
    {
      axrn.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeWritten", bool, 0L, 0L, localHashMap, "", true);
      return;
    }
  }
  ...
  public void a(akvc paramakvc)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      if (!this.jdField_a_of_type_JavaUtilArrayList.contains(paramakvc)) {
        this.jdField_a_of_type_JavaUtilArrayList.add(paramakvc);
      }
      return;
    }
  }
  ...
  {
    String str = ajud.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl);
  ...
  public void a(String paramString)
  {
    ...
    b(this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akve.jdField_a_of_type_Int);
  }
  ...
  public void a(ArrayList<ApkUpdateDetail> paramArrayList)
  {
    if ((paramArrayList != null) && (paramArrayList.size() > 0))
    {
      ...
      {
        if (this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akve.jdField_a_of_type_Int == paramArrayList.versioncode) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Akuv == null)
        {
          ...
          this.jdField_a_of_type_Akuv = new akuv(paramString2, this);
          bdkx.a(this.jdField_a_of_type_Akuv);
      ...
      if (i != 0)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akve = null;
        c(-1);
      }
    }
  }
  ...
  boolean a()
  {
    return this.jdField_a_of_type_Akva != null;
  }
  ...
  {
    // Byte code:
    //   0: new 629	java/io/File
    //   3: dup
    //   4: aload_1
    //   5: invokespecial 631	java/io/File:<init>	(Ljava/lang/String;)V
    //   8: astore_1
    //   9: aload_1
    //   10: invokevirtual 634	java/io/File:exists	()Z
    //   13: ifeq +73 -> 86
    //   16: new 636	java/io/FileInputStream
    //   19: dup
    //   20: aload_1
    //   21: invokespecial 639	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   24: astore_3
    //   25: aload_3
    //   26: astore_1
    //   27: iconst_2
    ...
    //   34: aload_3
    //   35: aload 4
    //   37: invokevirtual 643	java/io/FileInputStream:read	([B)I
    //   40: pop
    //   41: aload 4
    //   43: iconst_0
    //   44: baload
    ...
    //   62: ifnull +7 -> 69
    //   65: aload_3
    //   66: invokevirtual 646	java/io/FileInputStream:close	()V
    //   69: iconst_0
    //   70: ireturn
    //   71: astore_1
    //   72: aload_1
    //   73: invokevirtual 649	java/io/IOException:printStackTrace	()V
    //   76: iconst_0
    //   77: ireturn
    //   78: aload_3
    //   79: ifnull +7 -> 86
    //   82: aload_3
    //   83: invokevirtual 646	java/io/FileInputStream:close	()V
    //   86: iconst_1
    //   87: ireturn
    //   88: astore_1
    //   89: aload_1
    //   90: invokevirtual 649	java/io/IOException:printStackTrace	()V
    //   93: goto -7 -> 86
    //   96: astore 4
    //   98: aconst_null
    //   99: astore_3
    ...
    //   106: ldc 210
    //   108: aload 4
    //   110: invokestatic 651	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   113: aload_3
    //   114: ifnull -28 -> 86
    //   117: aload_3
    //   118: invokevirtual 646	java/io/FileInputStream:close	()V
    //   121: goto -35 -> 86
    //   124: astore_1
    //   125: aload_1
    //   126: invokevirtual 649	java/io/IOException:printStackTrace	()V
    //   129: goto -43 -> 86
    //   132: astore_3
    //   133: aconst_null
    //   134: astore_1
    ...
    //   136: ifnull +7 -> 143
    //   139: aload_1
    //   140: invokevirtual 646	java/io/FileInputStream:close	()V
    //   143: aload_3
    //   144: athrow
    //   145: astore_1
    //   146: aload_1
    //   147: invokevirtual 649	java/io/IOException:printStackTrace	()V
    //   150: goto -7 -> 143
    //   153: astore_3
    //   154: goto -19 -> 135
    //   157: astore 4
  ...
  public boolean a(UpgradeInfo paramUpgradeInfo, akvb paramakvb)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akve = ajud.a(paramUpgradeInfo);
    if ((paramakvb == null) || (paramUpgradeInfo == null)) {
      return false;
    }
    ...
    j();
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramakvb);
    if (QLog.isColorLevel()) {
      QLog.d("UpgradeController", 2, "handleUpgradeInfo packageName = " + this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName() + ", bGray = " + paramUpgradeInfo.bGray + ", versioncode = " + this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akve.jdField_a_of_type_Int);
    }
    paramUpgradeInfo = new ApkUpdateParam(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl.getPackageName(), paramUpgradeInfo.bGray, this.jdField_a_of_type_ComTencentMobileqqAppUpgradeUpgradeDetailWrapper.jdField_a_of_type_Akve.jdField_a_of_type_Int);
    paramakvb = new ArrayList();
    paramakvb.add(paramUpgradeInfo);
    bdmk.a().b(paramakvb);
    return true;
  }
  ...
  public void b(akvc paramakvc)
  {
    ...
    {
      if (this.jdField_a_of_type_JavaUtilArrayList.contains(paramakvc)) {
        this.jdField_a_of_type_JavaUtilArrayList.remove(paramakvc);
      }
      return;
    }
  }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    ajud.b(localQQAppInterface, paramBoolean);
    if (paramBoolean)
    {
      g();
      return;
  ...
  public void c()
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: invokestatic 326	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   5: ifeq +13 -> 18
    //   8: ldc_w 328
    //   11: iconst_2
    //   12: ldc_w 758
    //   15: invokestatic 333	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   18: aload_0
    //   19: getfield 243	akuz:b	Z
    //   22: ifeq +21 -> 43
    //   25: aload_0
    //   26: iconst_0
    //   27: putfield 243	akuz:b	Z
    //   30: aload_0
    //   31: invokevirtual 760	akuz:e	()V
    //   34: aload_0
    //   35: invokespecial 762	akuz:h	()V
    //   38: ldc 138
    //   40: invokestatic 764	bdkx:a	(Ljava/lang/String;)V
    //   43: aload_0
    //   44: monitorexit
    //   45: return
    //   46: astore_1
  ...
  public void onDownloadError(DownloadInfo paramDownloadInfo, int paramInt1, String paramString, int paramInt2)
  {
    ...
    axrn.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", false, 0L, 0L, paramDownloadInfo, "", true);
  }
  ...
  public void onDownloadFinish(DownloadInfo paramDownloadInfo)
  {
    ...
    if (TextUtils.isEmpty((CharSequence)localObject2))
    {
      ...
      {
        paramDownloadInfo = bdle.a().a(paramDownloadInfo);
        localObject1 = localObject2;
    ...
    for (;;)
    {
      int k = aney.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl);
      ...
      for (i = 101;; i = 9527)
      {
        ...
        axrn.a(this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl).a("", "UpgradeErr", false, 0L, 0L, (HashMap)localObject1, "", true);
        if (bool) {
          break;
        }
        this.jdField_a_of_type_Bfob.sendEmptyMessage(0);
        return;
