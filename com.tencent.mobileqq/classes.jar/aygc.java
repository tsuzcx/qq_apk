...
public class aygc
{
  ...
  private static volatile aygc jdField_a_of_type_Aygc;
  ...
  {
    if (jdField_a_of_type_Aygc == null) {}
    try
    {
      if (jdField_a_of_type_Aygc == null) {
        jdField_a_of_type_Aygc = new aygc();
      }
      return jdField_a_of_type_Aygc;
    }
    finally {}
  }
  ...
  public static void a(String paramString, TouchWebView paramTouchWebView)
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 34	aygc:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   6: ifnonnull +13 -> 19
    //   9: new 36	java/util/HashMap
    //   12: dup
    //   13: invokespecial 37	java/util/HashMap:<init>	()V
    //   16: putstatic 34	aygc:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   19: aload_0
    //   20: ifnull +30 -> 50
    //   23: getstatic 34	aygc:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   26: aload_0
    ...
    //   34: aload_3
    //   35: ifnonnull +24 -> 59
    //   38: getstatic 34	aygc:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   41: aload_0
    //   42: iconst_1
    ...
    //   50: aload_0
    //   51: aload_1
    //   52: invokestatic 55	armi:a	(Ljava/lang/String;Lcom/tencent/biz/ui/TouchWebView;)V
    //   55: ldc 2
    //   57: monitorexit
    //   58: return
    //   59: aload_3
    ...
    //   63: istore_2
    //   64: getstatic 34	aygc:jdField_a_of_type_JavaUtilHashMap	Ljava/util/HashMap;
    //   67: aload_0
    //   68: iload_2
    //   69: iconst_1
    //   70: iadd
    ...
    synchronized (jdField_a_of_type_ArrayOfByte)
    {
      if (!a())
      {
        ...
        if (SwiftReuseTouchWebView.b == 0) {
          bcfz.a().a((Bundle)localObject);
        }
        QLog.i("TenDocWebViewPool", 1, "init");
        localObject = SwiftReuseTouchWebView.a(BaseApplicationImpl.sApplication);
        ((TouchWebView)localObject).setWebViewClient(new ayge(this));
        ((TouchWebView)localObject).setWebChromeClient(new aygd(this));
  ...
  public boolean a(String paramString)
  {
    ...
    if (a())
    {
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        localTouchWebView.setWebViewClient(new ayge(this));
        localTouchWebView.setWebChromeClient(new aygd(this));
