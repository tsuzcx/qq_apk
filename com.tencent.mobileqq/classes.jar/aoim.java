...
public class aoim
{
  private static aoim jdField_a_of_type_Aoim;
  ...
  public static aoim a()
  {
    try
    {
      if (jdField_a_of_type_Aoim == null) {
        jdField_a_of_type_Aoim = new aoim();
      }
      aoim localaoim = jdField_a_of_type_Aoim;
      return localaoim;
    }
    finally {}
  }
