...
public abstract class bjli
{
  bjli(TraeAudioManager paramTraeAudioManager) {}
  ...
  public void a(Context paramContext, Intent paramIntent, bjlj parambjlj)
  {
    if ("android.bluetooth.adapter.action.STATE_CHANGED".equals(paramIntent.getAction()))
    {
      ...
      if (i == 10)
      {
        ...
        parambjlj.a("DEVICE_BLUETOOTHHEADSET", false);
      }
  ...
  public abstract boolean a(Context paramContext, bjlj parambjlj);
