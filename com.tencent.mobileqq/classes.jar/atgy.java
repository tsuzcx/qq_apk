...
public class atgy
{
  ...
  private void b(QQAppInterface paramQQAppInterface, Context paramContext, RedTouch paramRedTouch)
  {
    ...
    int i;
    switch (((bjxw)localObject).jdField_a_of_type_Int)
    {
    default: 
      return;
    case 1: 
      i = ((bjxw)localObject).jdField_b_of_type_Int;
      if (i > 99) {
    ...
    case 3: 
      ...
      return;
    case 2: 
      localObject = ((bjxw)localObject).jdField_b_of_type_JavaLangString;
      ...
      localRedTypeInfo.red_content.set(bcwh.a(paramContext, 3.0F) + "");
      ...
      return;
    case 4: 
      paramContext = ((bjxw)localObject).jdField_b_of_type_JavaLangString;
  ...
  private void b(QQAppInterface paramQQAppInterface, String paramString, BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    for (int i = 1;; i = 2)
    {
      azmj.b(paramQQAppInterface, "dc00899", "Grp_tribe", "", "dynamic", "exp_tribe", 0, 0, i + "", "", "", "");
      return;
    }
  }
  ...
  protected void a(QQAppInterface paramQQAppInterface, Context paramContext, RedTouch paramRedTouch)
  {
    ...
    if (paramQQAppInterface != null)
    {
      if (!aoeh.a(paramQQAppInterface, "redpoint_leba_show")) {
        break label356;
      }
      localObject = ((aoel)paramQQAppInterface.getManager(269)).b();
      if (localObject == null) {
        break label263;
      }
      localObject = ((aoeh)localObject).a(paramQQAppInterface);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      try
      {
        ...
        paramQQAppInterface.setMaxWidth(aekt.a(200.0F, paramContext.getResources()));
        paramRedTouch.weight = 1.0F;
        paramRedTouch.width = 0;
        paramRedTouch.rightMargin = aekt.a(4.0F, paramContext.getResources());
  ...
  public void a(QQAppInterface paramQQAppInterface, avoh paramavoh, RedTouch paramRedTouch)
  {
    if (paramRedTouch == null) {
      return;
    }
    this.jdField_a_of_type_Int = paramavoh.d;
    this.jdField_b_of_type_Int = paramavoh.c;
    switch (paramavoh.jdField_a_of_type_Int)
    {
    case 1: 
    case 2: 
    case 4: 
    ...
    case 3: 
      ...
      paramQQAppInterface = (String)paramavoh.jdField_a_of_type_JavaUtilList.get(0);
      paramavoh = new BusinessInfoCheckUpdate.RedTypeInfo();
      paramavoh.red_type.set(3);
      paramavoh.red_content.set(paramQQAppInterface);
      paramavoh.red_desc.set("{'av':1, 'dot':1}");
      paramRedTouch.a(paramavoh);
      return;
    case 5: 
      BusinessInfoCheckUpdate.RedTypeInfo localRedTypeInfo = new BusinessInfoCheckUpdate.RedTypeInfo();
      localRedTypeInfo.red_type.set(5);
      paramQQAppInterface = paramavoh.jdField_b_of_type_Int + "";
      if (paramavoh.jdField_b_of_type_Int > 99) {
  ...
  protected void a(QQAppInterface paramQQAppInterface, RedTouch paramRedTouch)
  {
    ...
    wta.a("dynamic", "exp_story", 0, paramQQAppInterface.b(), new String[0]);
    BusinessInfoCheckUpdate.RedTypeInfo localRedTypeInfo = new BusinessInfoCheckUpdate.RedTypeInfo();
    ...
    case 35: 
      ...
      while (i != -1)
      {
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            wsv.d("Q.lebatab.LebaSpecificRedTouch", "tag red dot json parse error , %s", new Object[] { localException.getMessage() });
          }
        }
        localRedTypeInfo.red_content.set(paramQQAppInterface);
        ...
        try
        {
          ...
          wsv.e("Q.lebatab.LebaSpecificRedTouch", "updateStoryRedTouch() APPID_STORY_IMG: red display=%d", new Object[] { Long.valueOf(l) });
          if (l != 0L) {
            break label445;
          }
          paramRedTouch.d();
        ...
        {
          wsv.c("Q.lebatab.LebaSpecificRedTouch", "updateStoryRedTouch() APPID_STORY_IMG: Error parse json: ", paramQQAppInterface);
          i = -1;
        }
      }
      label436:
      wsv.b("Q.lebatab.LebaSpecificRedTouch", "updateStoryRedTouch() APPID_STORY_IMG: str_custom_buffer is null");
      label445:
  ...
  public void a(QQAppInterface paramQQAppInterface, RedTouch paramRedTouch, String paramString1, String paramString2, long paramLong)
  {
    ...
    {
      paramString2 = ((axho)localObject2).a(paramString1);
      if (paramString2 != null)
      {
        ...
        {
          paramString1 = null;
          localObject2 = ((axho)localObject2).a(paramString2);
          if (QLog.isColorLevel()) {
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Context paramContext, long paramLong, RedTouch paramRedTouch, String paramString, Map<Long, atha> paramMap, int paramInt)
  {
    this.jdField_a_of_type_JavaUtilMap = paramMap;
    boolean bool = false;
    paramMap = String.valueOf(paramLong);
    if ((paramMap != null) && (bjxw.jdField_a_of_type_JavaLangString.equals(paramMap)))
    {
    ...
    do
    {
      ...
      if (beij.jdField_a_of_type_JavaLangString.equals(paramString))
      {
        beij.a(paramQQAppInterface, paramRedTouch);
        a(paramLong, paramRedTouch);
        return true;
      }
      if (7759L == paramLong)
