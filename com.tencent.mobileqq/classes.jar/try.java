  ...
  implements View.OnClickListener
{
  ...
  private tsc jdField_b_of_type_Tsc;
  ...
  public try(VafContext paramVafContext)
  {
  ...
  {
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)paramContext.getSystemService("layout_inflater")).inflate(2131562788, null);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131380549));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131368412));
    this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368525));
    this.jdField_c_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368526));
    this.jdField_d_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131368527));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362045));
    this.jdField_e_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367611));
    this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131367608));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362045));
    this.jdField_f_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367606));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367609));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367615));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367607));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362115));
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131362112));
    this.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369878));
    this.jdField_b_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376703));
    this.jdField_c_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369839));
    this.jdField_d_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131376660));
    this.jdField_e_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367613));
    this.jdField_f_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367617));
    this.jdField_g_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367612));
    this.jdField_h_of_type_ComTencentImageURLImageView = ((URLImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131367616));
    ...
    this.jdField_a_of_type_AndroidViewView.setOnClickListener(new trz(this));
  }
  ...
  private void a(RelativeLayout.LayoutParams paramLayoutParams, float paramFloat1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, float paramFloat2)
  {
    ...
    float f1 = this.jdField_a_of_type_Tsc.jdField_a_of_type_Int - paramInt5 * paramFloat1;
    ...
    this.jdField_e_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setScaleX(this.jdField_a_of_type_Tsc.jdField_a_of_type_Float + paramFloat2 * paramFloat1);
    this.jdField_e_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setScaleY(this.jdField_a_of_type_Tsc.jdField_a_of_type_Float + paramFloat2 * paramFloat1);
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    paramJSONObject = new tsc();
    paramJSONObject.jdField_a_of_type_Float = (j / 100.0F);
    paramJSONObject.jdField_a_of_type_Int = m;
    paramJSONObject.jdField_b_of_type_Int = agej.a(i1 / 2, this.jdField_a_of_type_AndroidContentContext.getResources());
    paramJSONObject.jdField_c_of_type_Int = agej.a(i2 / 2, this.jdField_a_of_type_AndroidContentContext.getResources());
    localObject = new tsc();
    ((tsc)localObject).jdField_a_of_type_Float = (k / 100.0F);
    ((tsc)localObject).jdField_a_of_type_Int = n;
    ((tsc)localObject).jdField_b_of_type_Int = agej.a(i3 / 2, this.jdField_a_of_type_AndroidContentContext.getResources());
    ((tsc)localObject).jdField_c_of_type_Int = agej.a(i4 / 2, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_a_of_type_Tsc = paramJSONObject;
    this.jdField_b_of_type_Tsc = ((tsc)localObject);
  }
  ...
  {
    if ((this.jdField_a_of_type_Tsc == null) || (this.jdField_b_of_type_Tsc == null) || (this.jdField_b_of_type_Boolean)) {
      return;
    }
    ...
    int m = a(this.i, this.jdField_b_of_type_Tsc.jdField_b_of_type_Int, this.jdField_d_of_type_Int);
    int n = a(this.jdField_h_of_type_Int, this.jdField_b_of_type_Tsc.jdField_c_of_type_Int, this.jdField_e_of_type_Int);
    m -= j;
    n -= k;
    int i1 = -this.jdField_b_of_type_Tsc.jdField_a_of_type_Int + this.jdField_a_of_type_Tsc.jdField_a_of_type_Int;
    float f1 = this.jdField_b_of_type_Tsc.jdField_a_of_type_Float - this.jdField_a_of_type_Tsc.jdField_a_of_type_Float;
    if (paramBoolean)
    {
      a(localLayoutParams2, 1.0F, j, k, m, n, i1, f1);
      a(localLayoutParams1, 1.0F, this.jdField_c_of_type_Int);
      a(this.jdField_b_of_type_AndroidWidgetTextView, 1.0F, 0.2F, 1.7F, agej.a(34.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      a(this.jdField_c_of_type_AndroidWidgetTextView, 1.0F, 0.2F, 2.0F, agej.a(34.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      a(this.jdField_d_of_type_AndroidWidgetTextView, 1.0F, 0.2F, 2.0F, agej.a(34.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      return;
    }
    ValueAnimator localValueAnimator = ValueAnimator.ofFloat(new float[] { 0.0F, 1.0F });
    localValueAnimator.addUpdateListener(new tsa(this, localLayoutParams2, j, k, m, n, i1, f1, localLayoutParams1));
    localValueAnimator.addListener(new tsb(this));
  ...
  private void c()
  {
    this.jdField_c_of_type_Int = agej.a(84.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_e_of_type_Int = agej.a(60.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_d_of_type_Int = agej.a(60.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_a_of_type_Int = agej.a(52.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_b_of_type_Int = agej.a(135.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  }
  ...
  private void e()
  {
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.getLayoutParams().height = agej.a(128.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.jdField_b_of_type_Int = agej.a(128.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
  ...
  private void f()
  {
    ...
    localLayoutParams.leftMargin = a(this.jdField_g_of_type_Int, this.jdField_a_of_type_Tsc.jdField_b_of_type_Int, this.jdField_d_of_type_Int);
    localLayoutParams.topMargin = a(this.jdField_f_of_type_Int, this.jdField_a_of_type_Tsc.jdField_c_of_type_Int, this.jdField_e_of_type_Int);
    ...
    this.jdField_e_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setRotation(this.jdField_a_of_type_Tsc.jdField_a_of_type_Int);
    this.jdField_e_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setScaleX(this.jdField_a_of_type_Tsc.jdField_a_of_type_Float);
    this.jdField_e_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setScaleY(this.jdField_a_of_type_Tsc.jdField_a_of_type_Float);
  ...
  protected void a()
  {
    ...
    for (;;)
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestWidth = agej.a(28.0F, this.jdField_a_of_type_AndroidViewView.getResources());
      ((URLDrawable.URLDrawableOptions)localObject1).mRequestHeight = agej.a(28.0F, this.jdField_a_of_type_AndroidViewView.getResources());
      ...
      ((URLDrawable)localObject3).setTag(bhez.b(((URLDrawable.URLDrawableOptions)localObject1).mRequestWidth, ((URLDrawable.URLDrawableOptions)localObject1).mRequestHeight, agej.a(25.0F, this.jdField_a_of_type_AndroidViewView.getResources())));
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      tqa.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, j, null);
      ubd.a((Activity)this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo, this.jdField_a_of_type_Ppu.a(), this.jdField_a_of_type_Ppu.e(), false, tpz.b(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo), localtlt);
  ...
  public void onComMeasure(int paramInt1, int paramInt2)
  {
    ...
    if ((!this.jdField_a_of_type_Boolean) && (!this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.isShowBrandAnimate) && (this.jdField_a_of_type_Tsc != null) && (this.jdField_b_of_type_Tsc != null))
    {
      paramInt1 = this.jdField_a_of_type_AndroidWidgetTextView.getMeasuredHeight();
      this.jdField_f_of_type_Int = (this.jdField_a_of_type_Int + paramInt1 + agej.a(8.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      this.jdField_g_of_type_Int = 0;
      this.jdField_h_of_type_Int = (paramInt1 + this.jdField_a_of_type_Int + this.jdField_b_of_type_Int + agej.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources()));
      this.i = agej.a(12.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
      f();
    }
  }
