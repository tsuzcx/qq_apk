  ...
  extends barf
{
  ...
  alwx jdField_a_of_type_Alwx = new barm(this);
  private baam jdField_a_of_type_Baam = (baam)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(17);
  ...
  public barl(String paramString1, String paramString2, boolean paramBoolean1, String paramString3, String paramString4, int paramInt1, int paramInt2, boolean paramBoolean2, bayf parambayf, long paramLong)
  {
    super(paramString1, paramString2, paramBoolean1, parambayf);
    ...
    this.jdField_a_of_type_Bass.s = paramString1;
    this.jdField_a_of_type_Bass.t = this.jdField_a_of_type_JavaLangString;
    if ((!paramBoolean1) && (paramBoolean2))
    {
      this.jdField_a_of_type_Bass.p = this.jdField_a_of_type_JavaLangString;
      this.jdField_a_of_type_Bass.q = paramString1;
    }
    for (this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;; this.jdField_b_of_type_JavaLangString = paramString1)
    {
      e(false);
      e(paramInt2);
      this.jdField_a_of_type_Bass.h = 0;
      if (bdhb.c(paramString3)) {
        this.jdField_a_of_type_Bass.jdField_c_of_type_JavaLangString = paramString3;
      }
      if ((paramString4 != null) && (!bdhb.c(paramString4))) {
        this.jdField_a_of_type_Bass.g = paramString4;
      }
      if (paramInt2 == 65538)
      {
        this.jdField_a_of_type_Bass.jdField_f_of_type_JavaLangString = this.jdField_a_of_type_Bass.jdField_c_of_type_JavaLangString;
        this.jdField_a_of_type_Bass.jdField_b_of_type_JavaLangString = "gif";
      }
      if (paramInt2 == 2) {
        baws.a(AppSetting.a());
      }
      if ((paramInt2 == 2) && (paramBoolean1))
      {
        ...
        {
          this.jdField_b_of_type_Long = azah.a(paramString1.msgUid);
  ...
  public static barn a(byte[] paramArrayOfByte, long[] paramArrayOfLong)
  {
    barn localbarn = new barn();
    long l = paramArrayOfLong[0];
    byte[] arrayOfByte;
    if (paramArrayOfByte[0] == 1)
    {
      localbarn.jdField_a_of_type_Byte = paramArrayOfByte[1];
      int k = bdqa.a(paramArrayOfByte, 2) + 4;
      ...
      bdqa.a(arrayOfByte, 0, paramArrayOfByte, j, i);
      i += j;
      l = bdqa.a(paramArrayOfByte, i + 2 + bdqa.a(paramArrayOfByte, i));
      if (arrayOfByte != null) {
        if (l > 10000L) {
    ...
    {
      localbarn.jdField_a_of_type_JavaLangString = paramArrayOfByte;
      return localbarn;
    }
  }
  ...
  {
    paramString1 = alof.aX + paramString1 + "/";
    Object localObject;
    switch (paramInt)
    {
    default: 
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        paramArrayOfByte = bbck.a(paramString1 + "ptt/" + c() + "/", true);
        String str2 = ".amr";
        localObject = str2;
  ...
  private void a(boolean paramBoolean, ayzx paramayzx)
  {
    int i = paramayzx.jdField_a_of_type_Short;
    short s1 = (short)paramayzx.jdField_a_of_type_Int;
    Object localObject = paramayzx.jdField_a_of_type_JavaLangString;
    if (paramBoolean) {
      if (paramayzx.jdField_b_of_type_Int != 0)
      {
        this.q = paramayzx.jdField_b_of_type_Int;
        a(this.jdField_c_of_type_JavaLangString, 0, this.jdField_a_of_type_Bass.jdField_b_of_type_Long, this.q);
        a(2, 9312, "friend_block");
        d();
        azuj.b((String)localObject);
        azuj.a((String)localObject);
        if (paramayzx.jdField_b_of_type_Int == 58) {
          g();
        }
        if (QLog.isColorLevel()) {
    ...
    do
    {
          ...
          do
          {
            do
            {
              ...
              if (i == -1)
              {
                this.d = true;
                c(2);
                this.jdField_a_of_type_Bass.jdField_a_of_type_Basu.jdField_a_of_type_JavaUtilHashMap.put("param_sliceNum", String.valueOf(azuj.b((String)localObject)));
                this.jdField_a_of_type_Bass.jdField_a_of_type_Long = new File(this.jdField_a_of_type_Bass.jdField_c_of_type_JavaLangString).length();
                azuj.a((String)localObject);
                this.jdField_a_of_type_Bass.g = paramayzx.jdField_a_of_type_QQServiceStreamInfo.fileKey;
                if (paramayzx.jdField_a_of_type_QQServiceStreamInfo.pttTransFlag == 1) {}
                for (s2 = 1;; s2 = 0)
                {
                  this.p = s2;
                  this.jdField_a_of_type_Long = paramayzx.jdField_a_of_type_QQServiceStreamInfo.msgTime;
                  e();
                  return;
                }
              }
            } while (this.d);
            s2 = azuj.a((String)localObject);
            if (s2 > 10)
            {
              if (QLog.isColorLevel()) {
            ...
            k = azuj.c((String)localObject);
            int m = azuj.b((String)localObject);
            this.jdField_b_of_type_Int = i;
            if (QLog.isColorLevel()) {
              QLog.d("streamptt.send", 2, "server reset.ResetSeq: " + i + " packnum: " + m + ",slices:" + k + " uniseq:" + this.jdField_a_of_type_Bass.jdField_b_of_type_Long + ",flowLayer:" + s1 + ",prelayer:" + s2);
            }
          } while (s2 >= s1);
          azuj.a((String)localObject, s1);
          paramayzx = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_c_of_type_JavaLangString, 0, this.jdField_a_of_type_Bass.jdField_b_of_type_Long);
          l = 0L;
          localObject = new Bundle();
          if (paramayzx != null)
          {
            l = paramayzx.vipSubBubbleId;
            ((Bundle)localObject).putInt("DiyTextId", paramayzx.vipBubbleDiyTextId);
          }
          a(true, i, (short)k, l, (Bundle)localObject);
          this.jdField_a_of_type_Bass.a(2, 2);
          return;
        } while (this.d);
        j = azuj.c((String)localObject);
        k = azuj.a((String)localObject);
        if (paramayzx.jdField_a_of_type_Int >= k) {
          break;
        }
      ...
      if (this.jdField_c_of_type_Int == i)
      {
        if (this.jdField_a_of_type_Int < 8)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("streamptt.send", 2, "client check timeout.retry:severAckSlice:" + this.jdField_b_of_type_Int + " packnum: " + j + " maxSendSeq:" + this.jdField_c_of_type_Int + " uniseq:" + this.jdField_a_of_type_Bass.jdField_b_of_type_Long + ",retryCount:" + this.jdField_a_of_type_Int + ",flowLayer:" + k);
          }
          paramayzx = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_c_of_type_JavaLangString, 0, this.jdField_a_of_type_Bass.jdField_b_of_type_Long);
          l = 0L;
          localObject = new Bundle();
  ...
  public MessageRecord a(long paramLong1, StreamInfo paramStreamInfo, long paramLong2, Bundle paramBundle)
  {
    ...
    bdqa.a(this.jdField_a_of_type_Bass.g.length(), (byte[])localObject1, 0, 3, "utf-8");
    ...
    ((MessageForPtt)localObject1).senderuin = this.jdField_a_of_type_Bass.p;
    ...
    ((MessageForPtt)localObject1).urlAtServer = this.jdField_a_of_type_Bass.g;
    ((MessageForPtt)localObject1).url = MessageForPtt.getMsgFilePath(((MessageForPtt)localObject1).voiceType, this.jdField_a_of_type_Bass.jdField_c_of_type_JavaLangString);
    Object localObject2 = new File(this.jdField_a_of_type_Bass.jdField_c_of_type_JavaLangString);
    int i;
    if (((File)localObject2).exists())
    {
      ((MessageForPtt)localObject1).fileSize = ((File)localObject2).length();
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800610E", "0X800610E", 1, 0, "", "", "", "8.3.5");
      ((MessageForPtt)localObject1).itemType = 2;
      ((MessageForPtt)localObject1).isread = false;
      ((MessageForPtt)localObject1).shmsgseq = ((short)paramStreamInfo.msgSeq);
      ((MessageForPtt)localObject1).msgUid = azah.a((int)paramStreamInfo.random);
      if ((paramStreamInfo.pttTransFlag != 1) && (!baam.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) {
        break label746;
      }
      i = 1;
      label313:
    ...
    {
      ((MessageForPtt)localObject1).longPttVipFlag = azah.a((QQAppInterface)localObject2, paramStreamInfo);
      ...
      } while (!abti.a((MessageRecord)paramStreamInfo.next(), (MessageRecord)localObject1, true));
      if (QLog.isColorLevel()) {
        QLog.w("streamptt", 2, "same Ptt :" + ((MessageForPtt)localObject1).getBaseInfoString());
      }
      return null;
      ((MessageForPtt)localObject1).fileSize = 1000L;
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800610E", "0X800610E", 2, 0, "", "", "", "8.3.5");
      break;
      i = 0;
      break label313;
    }
    ...
    this.jdField_a_of_type_Bass.a(((MessageForPtt)localObject1).uniseq);
    return localObject1;
  }
  ...
  {
    this.jdField_a_of_type_Bass.jdField_a_of_type_Basu.d = true;
    b(2);
    this.jdField_b_of_type_Boolean = false;
    if (QLog.isColorLevel()) {
      QLog.d("RecordParams", 2, "startReceiveOneStreamPack:" + paramStreamInfo.pttFormat + ", " + paramStreamInfo.pttTime);
    }
    this.jdField_a_of_type_Bass.a(4, paramStreamData.vData.length);
    switch (this.jdField_a_of_type_Bass.jdField_b_of_type_Int)
    {
    }
    do
    {
      do
      {
        do
        {
          ...
          i = azuj.a(this.jdField_a_of_type_Bass.g);
          if (QLog.isColorLevel()) {
          ...
          this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.sendAppDataIncerment(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), false, bdin.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()), 2, 0, paramStreamData.vData.length);
          azuj.c(this.jdField_a_of_type_Bass.g, paramLong1);
          if (i != paramStreamInfo.shFlowLayer)
          {
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Bass.g, azuj.c(this.jdField_a_of_type_Bass.g), paramLong1);
            return;
          }
          if (azuj.a(this.jdField_a_of_type_Bass.g, paramStreamData.shPackSeq))
          {
            this.jdField_a_of_type_Bass.a(2, 2);
            short s1 = (short)(azuj.a(this.jdField_a_of_type_Bass.g) + 1);
            azuj.a(this.jdField_a_of_type_Bass.g, s1);
            if (QLog.isColorLevel()) {
          ...
          {
            if (QLog.isColorLevel()) {
              QLog.d("streamptt.recv", 2, "cancelled:" + this.jdField_a_of_type_Bass.g);
            }
            this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(this.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Bass.g, this.jdField_a_of_type_Bass.jdField_b_of_type_Long);
            azuj.a(this.jdField_a_of_type_Bass.g, true);
            azuj.a(this.jdField_a_of_type_Bass.g);
            return;
          }
          azuj.a(this.jdField_a_of_type_Bass.g, paramStreamInfo.shFlowLayer);
          azuj.a(this.jdField_a_of_type_Bass.g, paramStreamData.vData, paramStreamData.vData.length, paramStreamData.shPackSeq);
        } while (paramStreamInfo.shPackNum <= 0);
        this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(this.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Bass.g, this.jdField_a_of_type_Bass.jdField_b_of_type_Long);
        azuj.a(this.jdField_a_of_type_Bass.g, false);
        azuj.a(this.jdField_a_of_type_Bass.g);
      ...
      if (!azuj.e(paramStreamData)) {
        break;
      }
    } while (!QLog.isColorLevel());
    QLog.d("streamptt.recv", 2, "find stream offline duplicate,stop stream recv");
    return;
    azuj.c(paramStreamData);
    c(2);
    if (QLog.isColorLevel()) {
      QLog.d("streamptt.recv", 2, "startReceiveOneStreamPack received success path: " + this.jdField_a_of_type_Bass.g);
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_JavaLangString, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Bass.g, (short)-1, paramLong1);
    this.jdField_a_of_type_Bass.jdField_b_of_type_Boolean = true;
    this.jdField_a_of_type_Bass.g = paramStreamInfo.fileKey;
    ...
    for (int i = 1;; i = 0)
    {
      ...
      e();
      bavt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, true, 3);
      bavt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 1, true, 2);
      return;
    }
  }
  ...
  public void a(short paramShort, boolean paramBoolean, int paramInt1, int paramInt2, long paramLong, Bundle paramBundle)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Bass.d = 1001;
      b(2);
      this.jdField_b_of_type_Boolean = false;
  ...
  {
    if (bawk.b(this.jdField_j_of_type_Int)) {
      break label10;
    }
    label10:
    label593:
    ...
    {
      return;
      if ((this.jdField_a_of_type_Bass.jdField_b_of_type_Int == 2) && (!this.f) && (!bawk.b(this.jdField_j_of_type_Int)))
      {
        long l = (System.nanoTime() - this.k) / 1000000L;
        HashMap localHashMap = new HashMap();
        if (!this.jdField_a_of_type_Bass.jdField_a_of_type_Basu.d) {
          localHashMap.put("param_step", this.jdField_a_of_type_Bass.jdField_b_of_type_Bast.a(1) + ";" + this.jdField_a_of_type_Bass.jdField_a_of_type_Basu.a(2) + ";" + this.jdField_a_of_type_Bass.jdField_c_of_type_Bast.a(3));
        }
        if (paramBoolean)
        {
          if (this.jdField_a_of_type_Bass.jdField_a_of_type_Int == 0)
          {
            ...
            localHashMap.putAll(this.jdField_a_of_type_Bass.jdField_a_of_type_Basu.jdField_a_of_type_JavaUtilHashMap);
            azri.a(BaseApplication.getContext()).a(null, "actC2CStreamPttUpload", true, l, this.jdField_a_of_type_Bass.jdField_a_of_type_Long, localHashMap, "");
            if (TextUtils.isEmpty(this.jdField_a_of_type_Bass.jdField_c_of_type_JavaLangString)) {
              break;
            }
            bavt.a(this.jdField_a_of_type_Bass.jdField_c_of_type_JavaLangString, true, paramBoolean, 0, this.jdField_a_of_type_Bass.jdField_a_of_type_Long);
            return;
          }
          azri.a(BaseApplication.getContext()).a(null, "actC2CStreamPttDownload", true, l, this.jdField_a_of_type_Bass.jdField_a_of_type_Long, localHashMap, "");
          return;
        }
        if (this.jdField_a_of_type_Bass.jdField_a_of_type_Int == 0) {
          if (!barf.a(this.jdField_j_of_type_Int, localHashMap))
          {
            ...
            {
              localHashMap.put(barf.k, this.jdField_j_of_type_JavaLangString);
              localHashMap.put("param_toUin", this.jdField_b_of_type_JavaLangString);
              azri.a(BaseApplication.getContext()).a(null, "actC2CStreamPttUpload", false, l, this.jdField_a_of_type_Bass.jdField_a_of_type_Long, localHashMap, "");
              if (!TextUtils.isEmpty(this.jdField_a_of_type_Bass.jdField_c_of_type_JavaLangString)) {
                bavt.a(this.jdField_a_of_type_Bass.jdField_c_of_type_JavaLangString, true, paramBoolean, 0, this.jdField_a_of_type_Bass.jdField_a_of_type_Long);
              }
            }
        ...
        for (;;)
        {
          if (this.jdField_a_of_type_Bass.jdField_b_of_type_Int != 2) {
            break label593;
          }
          baws.b(true, String.valueOf(this.jdField_j_of_type_Int) + "_" + this.jdField_j_of_type_JavaLangString);
          return;
          ...
          localHashMap.put("param_errorDesc", this.jdField_j_of_type_JavaLangString);
          azri.a(BaseApplication.getContext()).a(null, "actC2CStreamPttDownload", false, l, this.jdField_a_of_type_Bass.jdField_a_of_type_Long, localHashMap, "");
        }
      }
    }
  }
  ...
  void d()
  {
    ...
    {
      QLog.d(str, 2, "onError elapsed:" + l + " errCode:" + this.jdField_j_of_type_Int + " errDesc:" + this.jdField_j_of_type_JavaLangString + " reason:" + (String)this.jdField_a_of_type_JavaUtilHashMap.get("param_reason") + " uniseq:" + this.jdField_a_of_type_Bass.jdField_b_of_type_Long);
      ...
      d(1005);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(this.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Bass.g, this.jdField_a_of_type_Bass.jdField_b_of_type_Long);
      return;
    }
    d(2005);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(this.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Bass.g, this.jdField_a_of_type_Bass.jdField_b_of_type_Long);
    ...
    for (paramBoolean = true;; paramBoolean = false)
    {
      for (;;)
      {
        try
        {
          ...
          MessageForPtt localMessageForPtt = (MessageForPtt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_c_of_type_JavaLangString, 0, this.jdField_a_of_type_Bass.jdField_b_of_type_Long);
          localMessageForPtt.url = this.jdField_a_of_type_Bass.jdField_c_of_type_JavaLangString;
          localMessageForPtt.fileSize = this.jdField_a_of_type_Bass.e;
          localMessageForPtt.itemType = this.jdField_a_of_type_Bass.jdField_b_of_type_Int;
          if (this.jdField_a_of_type_Bass.jdField_f_of_type_Int != 1) {
            break label337;
          }
          localMessageForPtt.isread = paramBoolean;
          localMessageForPtt.urlAtServer = this.jdField_a_of_type_Bass.g;
          if (baam.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))
          {
            ...
            if (localMessageForPtt.isSend())
            {
              ...
              localMessageForPtt.longPttVipFlag = azah.a(localQQAppInterface, (String)localObject);
              ...
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_c_of_type_JavaLangString, 0, this.jdField_a_of_type_Bass.jdField_b_of_type_Long, localMessageForPtt.msgData);
              localMessageForPtt.time = this.jdField_a_of_type_Long;
              this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_c_of_type_JavaLangString, 0, this.jdField_a_of_type_Bass.jdField_b_of_type_Long, this.jdField_a_of_type_Long);
              localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_c_of_type_JavaLangString, 0);
              if ((localObject == null) || (this.jdField_a_of_type_Bass.g == null) || (!this.jdField_a_of_type_Bass.g.equals(((QQMessageFacade.Message)localObject).pttUrl))) {
                break;
              }
  ...
  void e()
  {
    ...
    if (this.jdField_a_of_type_Bass.jdField_a_of_type_Int == 0)
    {
      ...
      QLog.d((String)localObject, 2, "onSuccess elapsed:" + l + " uniseq:" + this.jdField_a_of_type_Bass.jdField_b_of_type_Long);
      a(true);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Alwx);
      if (this.jdField_a_of_type_Bass.jdField_a_of_type_Int == 0) {
        d(true);
      ...
      d(1003);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(this.jdField_a_of_type_Bass.p, this.jdField_a_of_type_Bass.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Bass.jdField_b_of_type_Long);
    }
    label172:
    do
    {
      ...
      d(2003);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(this.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_Bass.g, this.jdField_a_of_type_Bass.jdField_b_of_type_Long);
      localObject = (MessageForPtt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_c_of_type_JavaLangString, 0, this.jdField_a_of_type_Bass.jdField_b_of_type_Long);
    } while ((localObject == null) || (this.jdField_a_of_type_Baam == null) || (!this.jdField_a_of_type_Baam.b((MessageForPtt)localObject)));
    this.jdField_a_of_type_Baam.b((MessageForPtt)localObject, 2);
  }
