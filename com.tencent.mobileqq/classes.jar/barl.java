...
public class barl
  extends banb
{
  private static final byte[] d = bdic.a(1, 16000);
  ...
  public barl(bamu parambamu, baub parambaub)
  {
  ...
  private batl a()
  {
    batl localbatl = new batl();
    localbatl.jdField_a_of_type_JavaLangString = (this.jdField_a_of_type_JavaLangString + this.jdField_a_of_type_Baub.p);
    localbatl.jdField_b_of_type_Int = this.jdField_a_of_type_Int;
    localbatl.jdField_c_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
    localbatl.e = this.jdField_a_of_type_Baub.q;
    localbatl.jdField_b_of_type_JavaLangString = (this.jdField_a_of_type_Baub.i.substring(0, this.jdField_a_of_type_Baub.i.lastIndexOf(File.separator)) + "/tmp_" + localbatl.jdField_a_of_type_JavaLangString + "_" + this.jdField_a_of_type_Int + ".silk");
    localbatl.jdField_a_of_type_Int = 6;
    if (this.jdField_a_of_type_Int == 0) {}
    for (localbatl.jdField_a_of_type_Boolean = true;; localbatl.jdField_a_of_type_Boolean = false)
    {
      localbatl.jdField_c_of_type_Int = this.jdField_a_of_type_Baub.jdField_o_of_type_Int;
      localbatl.d = this.jdField_a_of_type_Baub.p;
      return localbatl;
    }
  }
  ...
  private void f()
  {
    if ((this.jdField_a_of_type_Baub.jdField_a_of_type_ComWxVoiceVadWXVadSeg != null) && ((this.jdField_a_of_type_Baub.jdField_a_of_type_ComWxVoiceVadWXVadSeg instanceof WXVadSeg)))
    {
      WXVadSeg localWXVadSeg = this.jdField_a_of_type_Baub.jdField_a_of_type_ComWxVoiceVadWXVadSeg;
      this.jdField_a_of_type_Long = (localWXVadSeg.mbtm * 32L);
      this.jdField_b_of_type_Long = (localWXVadSeg.metm * 32L);
      this.jdField_a_of_type_Int = 0;
      if (QLog.isColorLevel()) {
        QLog.d("PttSliceUploadProcessor", 2, "generateFileByOneSeg, bps=" + this.jdField_a_of_type_Long + " EPS=" + this.jdField_b_of_type_Long + " segPos=" + this.jdField_a_of_type_Baub.p + " size=" + this.jdField_a_of_type_Baub.jdField_o_of_type_Int);
      }
    }
    try
    {
  ...
  private void g()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 124	barl:o	Z
    //   4: ifeq +4 -> 8
    //   7: return
    //   8: aload_0
    //   9: invokespecial 190	barl:a	()Lbatl;
    //   12: astore 7
    //   14: aconst_null
    //   15: astore 6
    //   17: aconst_null
    ...
    //   22: astore_3
    //   23: aload_0
    //   24: getfield 163	barl:jdField_b_of_type_Long	J
    //   27: aload_0
    //   28: getfield 158	barl:jdField_a_of_type_Long	J
    //   31: lsub
    //   32: ldc2_w 191
    //   35: lcmp
    //   36: ifle +371 -> 407
    ...
    //   51: astore_3
    //   52: aload_0
    //   53: getfield 177	barl:jdField_a_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   56: aload 4
    //   58: iconst_0
    //   59: sipush 6400
    ...
    //   69: aload_0
    //   70: aload_0
    //   71: getfield 158	barl:jdField_a_of_type_Long	J
    //   74: ldc2_w 191
    //   77: ladd
    //   78: putfield 158	barl:jdField_a_of_type_Long	J
    //   81: aload 6
    //   83: astore_3
    //   84: aload 7
    //   86: iconst_0
    //   87: putfield 198	batl:jdField_b_of_type_Boolean	Z
    //   90: iload_1
    //   91: istore_2
    //   92: aload 6
    //   94: astore_3
    //   95: aload 7
    //   97: getfield 198	batl:jdField_b_of_type_Boolean	Z
    //   100: ifne +146 -> 246
    //   103: iload_1
    //   104: istore_2
    //   105: aload 6
    //   107: astore_3
    //   108: aload_0
    //   109: getfield 163	barl:jdField_b_of_type_Long	J
    //   112: aload_0
    //   113: getfield 158	barl:jdField_a_of_type_Long	J
    //   116: lsub
    //   117: ldc2_w 191
    //   120: lcmp
    //   121: ifge +125 -> 246
    ...
    //   146: astore_3
    //   147: aload_0
    //   148: getfield 163	barl:jdField_b_of_type_Long	J
    //   151: aload_0
    //   152: getfield 158	barl:jdField_a_of_type_Long	J
    //   155: lsub
    //   156: l2i
    //   157: newarray byte
    //   159: astore 8
    ...
    //   163: astore_3
    //   164: aload_0
    //   165: getfield 177	barl:jdField_a_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   168: aload 8
    //   170: iconst_0
    //   171: aload_0
    //   172: getfield 163	barl:jdField_b_of_type_Long	J
    //   175: aload_0
    //   176: getfield 158	barl:jdField_a_of_type_Long	J
    //   179: lsub
    //   180: l2i
    ...
    //   189: astore_3
    //   190: aload_0
    //   191: getfield 202	barl:jdField_a_of_type_Awuk	Lawuk;
    //   194: aload 8
    //   196: iconst_0
    //   197: iload_1
    //   198: invokevirtual 207	awuk:a	([BII)Lawuh;
    //   201: getfield 210	awuh:jdField_a_of_type_Int	I
    //   204: ifne +42 -> 246
    //   207: aload 6
    //   209: astore_3
    ...
    //   230: aload 7
    //   232: iconst_1
    //   233: putfield 198	batl:jdField_b_of_type_Boolean	Z
    //   236: aload 6
    //   238: astore_3
    //   239: aload_0
    //   240: iconst_0
    //   241: putfield 65	barl:jdField_a_of_type_Int	I
    //   244: iload_1
    //   245: istore_2
    //   246: aload 6
    //   248: astore_3
    ...
    //   284: aload_0
    //   285: getfield 158	barl:jdField_a_of_type_Long	J
    ...
    //   296: aload_0
    //   297: getfield 50	barl:jdField_a_of_type_Baub	Lbaub;
    //   300: getfield 55	baub:p	I
    ...
    //   311: aload_0
    //   312: getfield 65	barl:jdField_a_of_type_Int	I
    ...
    //   326: astore_3
    //   327: aload_0
    //   328: getfield 202	barl:jdField_a_of_type_Awuk	Lawuk;
    //   331: aload 4
    //   333: iconst_0
    //   334: iload_2
    //   335: invokevirtual 207	awuk:a	([BII)Lawuh;
    //   338: astore 8
    //   340: aload 8
    //   342: ifnull +14 -> 356
    //   345: aload 6
    //   347: astore_3
    //   348: aload 8
    //   350: getfield 210	awuh:jdField_a_of_type_Int	I
    //   353: ifne +148 -> 501
    //   356: aload 6
    //   358: astore_3
    ...
    //   379: aload_0
    //   380: aload 7
    //   382: getfield 198	batl:jdField_b_of_type_Boolean	Z
    //   385: iconst_0
    //   386: invokespecial 122	barl:a	(ZZ)V
    //   389: iconst_0
    //   390: ifeq -383 -> 7
    ...
    //   409: astore_3
    //   410: aload_0
    //   411: getfield 163	barl:jdField_b_of_type_Long	J
    //   414: aload_0
    //   415: getfield 158	barl:jdField_a_of_type_Long	J
    //   418: lsub
    //   419: l2i
    //   420: newarray byte
    //   422: astore 4
    ...
    //   426: astore_3
    //   427: aload_0
    //   428: getfield 177	barl:jdField_a_of_type_JavaIoRandomAccessFile	Ljava/io/RandomAccessFile;
    //   431: aload 4
    //   433: iconst_0
    //   434: aload_0
    //   435: getfield 163	barl:jdField_b_of_type_Long	J
    //   438: aload_0
    //   439: getfield 158	barl:jdField_a_of_type_Long	J
    //   442: lsub
    //   443: l2i
    ...
    //   451: aload 7
    //   453: iconst_1
    //   454: putfield 198	batl:jdField_b_of_type_Boolean	Z
    //   457: aload 6
    //   459: astore_3
    //   460: aload_0
    //   461: iconst_0
    //   462: putfield 65	barl:jdField_a_of_type_Int	I
    //   465: goto -375 -> 90
    //   468: astore_3
    //   469: aload 5
    //   471: astore 4
    ...
    //   528: aload 8
    //   530: getfield 210	awuh:jdField_a_of_type_Int	I
    ...
    //   548: dup
    //   549: aload 7
    //   551: getfield 103	batl:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   591: astore 4
    //   593: aload 7
    //   595: getfield 107	batl:jdField_a_of_type_Boolean	Z
    //   598: ifeq +132 -> 730
    //   601: aload 4
    //   603: getstatic 24	barl:d	[B
    //   606: invokevirtual 247	java/io/FileOutputStream:write	([B)V
    //   609: aload_0
    //   610: aload_0
    //   611: getfield 65	barl:jdField_a_of_type_Int	I
    //   614: aload 8
    //   616: getfield 210	awuh:jdField_a_of_type_Int	I
    //   619: getstatic 24	barl:d	[B
    //   622: arraylength
    //   623: iadd
    //   624: iadd
    //   625: putfield 65	barl:jdField_a_of_type_Int	I
    //   628: aload 4
    //   630: aload 8
    //   632: getfield 249	awuh:jdField_a_of_type_ArrayOfByte	[B
    //   635: aload 8
    //   637: getfield 250	awuh:jdField_b_of_type_Int	I
    //   640: aload 8
    //   642: getfield 210	awuh:jdField_a_of_type_Int	I
    //   645: invokevirtual 253	java/io/FileOutputStream:write	([BII)V
    //   648: aload 4
    //   650: invokevirtual 256	java/io/FileOutputStream:flush	()V
    //   653: aload_0
    //   654: aload 7
    //   656: putfield 117	barl:jdField_a_of_type_Batl	Lbatl;
    //   659: aload_0
    //   660: aload 7
    //   662: invokevirtual 259	barl:a	(Lbatl;)V
    ...
    //   687: aload_0
    //   688: getfield 65	barl:jdField_a_of_type_Int	I
    ...
    //   729: return
    //   730: aload 7
    //   732: getfield 198	batl:jdField_b_of_type_Boolean	Z
    //   735: ifne -107 -> 628
    //   738: aload_0
    //   739: aload_0
    //   740: getfield 65	barl:jdField_a_of_type_Int	I
    //   743: aload 8
    //   745: getfield 210	awuh:jdField_a_of_type_Int	I
    //   748: iadd
    //   749: putfield 65	barl:jdField_a_of_type_Int	I
    //   752: goto -124 -> 628
    //   755: astore 5
    //   757: goto -281 -> 476
    //   760: astore 5
  ...
  public void a(batl parambatl)
  {
    if (QLog.isColorLevel()) {
      QLog.d("PttSliceUploadProcessor", 2, "submitSlice, info:" + parambatl);
    }
    barm localbarm = new barm(this, SystemClock.uptimeMillis());
    this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction = new Transaction(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin(), 68, parambatl.jdField_b_of_type_JavaLangString, (int)this.r, a(parambatl.jdField_b_of_type_JavaLangString), localbarm, batk.a(parambatl).toByteArray(), false);
    ...
    if (QLog.isColorLevel()) {
      QLog.d("PttSliceUploadProcessor", 2, "<BDH_LOG> Transaction submit RetCode:" + i + " T_ID:" + this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.getTransationId() + " UniSeq:" + this.jdField_a_of_type_Baub.jdField_a_of_type_Long + " bean:" + parambatl + " Cmd:");
    }
    if (i != 0)
    {
  ...
  byte[] a(String paramString)
  {
    ...
    //   19: aload 4
    //   21: aload_0
    //   22: getfield 361	barl:jdField_a_of_type_Baoj	Lbaoj;
    //   25: getfield 364	baoj:jdField_a_of_type_Long	J
    ...
    //   119: astore_3
    //   120: aload 7
    //   122: invokestatic 384	bhli:a	(Ljava/io/File;)Ljava/lang/String;
    //   125: astore_1
    //   126: aload_1
    //   127: ifnull +14 -> 141
    //   130: aload 4
  ...
  public void aS_()
  {
    this.jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Baub.jdField_o_of_type_JavaLangString;
    ...
    if (QLog.isColorLevel()) {
      QLog.d("PttSliceUploadProcessor", 2, "start, voiceID=" + this.jdField_a_of_type_JavaLangString + " pos=" + this.jdField_a_of_type_Baub.p + " num=" + this.jdField_a_of_type_Baub.jdField_o_of_type_Int + " this=" + this);
    }
    this.jdField_a_of_type_Awuk = new awuk();
    this.jdField_a_of_type_Awuk.a(new SilkCodecWrapper(BaseApplication.getContext()));
    try
    {
      this.jdField_a_of_type_Awuk.a(16000, 16000, 1);
      f();
      return;
    }
