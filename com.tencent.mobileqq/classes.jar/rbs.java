  ...
  implements TextWatcher
{
  ...
  public rbs(ReadInJoyUgcSearchTopicFragment paramReadInJoyUgcSearchTopicFragment) {}
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    if (this.jdField_a_of_type_Int > 0)
    {
      ...
      if ((j ^ i) != 0)
      {
        ...
        Drawable localDrawable = this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcReadInJoyUgcSearchTopicFragment.getResources().getDrawable(2130839544);
        localDrawable.setBounds(0, 0, bhtq.b(16.0F), bhtq.b(16.0F));
    ...
    for (;;)
    {
      ...
      pfa.a().h(ReadInJoyUgcSearchTopicFragment.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyUgcReadInJoyUgcSearchTopicFragment));
      return;
      i = 0;
      break;
      label156:
