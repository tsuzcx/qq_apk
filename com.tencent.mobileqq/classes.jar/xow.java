...
public class xow
  implements akai, akoa, IMemoryManager, IAppStateChangeListener
{
  private static xow jdField_a_of_type_Xow;
  ...
  private Vector<xox> jdField_a_of_type_JavaUtilVector;
  public boolean a;
  ...
  public static xow a()
  {
    if (jdField_a_of_type_Xow == null) {}
    try
    {
      if (jdField_a_of_type_Xow == null) {
        jdField_a_of_type_Xow = new xow();
      }
      return jdField_a_of_type_Xow;
    }
    finally {}
  }
  ...
  public static void a(String paramString, int paramInt)
  {
    ...
    for (Object localObject = ((AppRuntime)localObject).getAccount();; localObject = null)
    {
      ...
      {
        if (paramString != null) {
          axrn.a(BaseApplicationImpl.getApplication()).a((String)localObject, paramString, true, 0L, 0L, localHashMap, "", true);
        }
        return;
        if (paramInt == l)
        {
  ...
  {
    a(2);
    xou.a(BaseApplicationImpl.class.getClassLoader());
  }
    ...
    for (String str2 = "low_mem_report_rdm_time";; str2 = "bg_mem_report_rdm_time")
    {
      ...
      if (l1 > 0L) {
        if (Math.abs(l2 - l1) > 3600000L)
        {
          ...
          if (!akag.a().a.jdField_a_of_type_Boolean) {
            break label531;
          }
          str1 = "1";
          localHashMap.put("ClearEnable", str1);
          localHashMap.put("DpcConfigId", akag.a().a.jdField_a_of_type_JavaLangString);
          ...
          label396:
          axrn.a(BaseApplicationImpl.getApplication()).a(null, str1, true, 0L, 0L, localHashMap, null);
  ...
  {
    xos localxos = akag.a().a;
    if (QLog.isColorLevel()) {
      QLog.d("MemoryClearManagerNew", 2, "onNeedTrimMemory|clear= " + localxos.jdField_a_of_type_Boolean + "configId" + localxos.jdField_a_of_type_JavaLangString);
    }
    if ((a(paramxot.jdField_b_of_type_Int * localxos.jdField_b_of_type_Int * 1000)) && (localxos.jdField_a_of_type_Boolean)) {}
    try
    {
      b(paramInt, paramxot);
      return;
    ...
    catch (Exception paramxot)
    {
      ...
      QLog.d("MemoryClearManagerNew", 2, "clearMemory Exception= " + paramxot);
    }
  }
  ...
  public void a(xox paramxox)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.add(paramxox);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((i1 > 600) && (i1 - this.n > 250) && (this.jdField_a_of_type_Boolean))
    {
      ...
      if (Math.abs(l1 - l2) >= 3600000L)
      {
        ...
        localHashMap.put("topActivity", akdg.a());
        ...
        localHashMap.put("sProcessId", String.valueOf(BaseApplicationImpl.sProcessId));
        axrn.a(BaseApplicationImpl.getApplication()).a(null, "MemoryIncreaseInfo", true, 0L, 0L, localHashMap, "", true);
  ...
  public void b()
  {
    try
    {
      ...
      ((SharedPreferences.Editor)localObject).putString("topActivity", akdg.a());
      ((SharedPreferences.Editor)localObject).putString("key_mem_info", axri.a().a());
      ((SharedPreferences.Editor)localObject).putInt("hackArtResult", HackVm.jdField_d_of_type_Int);
      ((SharedPreferences.Editor)localObject).putString("clear_config_id", akag.a().a.jdField_a_of_type_JavaLangString);
      ((SharedPreferences.Editor)localObject).putBoolean("clear_config_enable", akag.a().a.jdField_a_of_type_Boolean);
  ...
  public void b(int paramInt, xot paramxot)
  {
    long l6;
    Object localObject3;
    int i1;
    ...
    for (;;)
    {
      try
      {
        ...
        synchronized (this.jdField_a_of_type_JavaUtilVector)
        {
          ...
          {
            i1 += ((xox)((Iterator)localObject3).next()).a();
            continue;
          }
          l2 = i1;
          l1 = i1;
          ...
          i2 = (int)(i1 * paramxot.jdField_b_of_type_Float);
          l3 = i1;
          BaseApplicationImpl.sImageCache.trimToSize(i2);
          if ((paramxot.a > 0.0F) && (paramxot.a < 1.0F))
          {
            l4 = MemoryManager.a() * 1L / 32L;
            if (BaseApplicationImpl.sImageCache.maxSize() >= l4) {
              BaseApplicationImpl.sImageCache.resetMaxSize(paramxot.a);
            }
          }
          i10 = 0 + (i1 - i2);
          l4 = i10;
    ...
    if (((Iterator)???).hasNext())
    {
      ...
      if (localObject3 != null)
      {
        ...
        if (localObject4 != null)
        {
          ...
          ((QQLruCache)localObject4).clearOnLowMemory((int)(((QQLruCache)localObject4).size() * paramxot.jdField_b_of_type_Float));
        ...
        else
        {
          ...
          if (((Iterator)localObject3).hasNext())
          {
            ...
            {
              localLruCache.trimToSize((int)(localLruCache.size() * paramxot.jdField_b_of_type_Float));
          ...
          if (paramInt == 1)
          {
            paramxot = this.jdField_b_of_type_JavaUtilList.iterator();
            if (!paramxot.hasNext()) {
              break label1449;
            }
            ??? = (WeakReference)paramxot.next();
            if (??? == null) {
              break label1446;
            }
            ...
            if (paramInt == 1)
            {
              paramxot = this.jdField_a_of_type_JavaUtilList.iterator();
              if (!paramxot.hasNext()) {
                break label1468;
              }
              ??? = (WeakReference)paramxot.next();
              ...
              break label1465;
              label842:
              paramxot = SkinEngine.getInstances().releasePreloadDrawableCache();
              Object localObject1;
              l2 = localObject1;
              i1 = i9;
              if (paramxot.length < 2) {
                break label1522;
              }
              if ((paramxot[0] instanceof Integer)) {
                i2 = Integer.parseInt(paramxot[0].toString());
              }
              l2 = localObject1;
              i1 = i2;
              if (!(paramxot[1] instanceof Long)) {
                break label1522;
              }
              l2 = Long.parseLong(paramxot[1].toString());
              i1 = i2;
              break label1522;
            }
          }
  ...
  public void b(xox paramxox)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.remove(paramxox);
      return;
    }
  }
  ...
  public final void d()
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("sProcessId", String.valueOf(BaseApplicationImpl.sProcessId));
      axrn.a(BaseApplicationImpl.getApplication()).a(null, "memory_oom_Info", true, 0L, 0L, localHashMap, null);
