  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_Acwl.a).inflate(2131559151, null);
    }
    ...
    localURLDrawable.setDecodeHandler(bavw.y);
