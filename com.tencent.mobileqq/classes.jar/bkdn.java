...
public final class bkdn
{
  private static int jdField_a_of_type_Int;
  private static final bkdt jdField_a_of_type_Bkdt = new bkdt(84298576L);
  private static final bkdt b = new bkdt(50613072L);
  private static final bkdt c = new bkdt(101010256L);
  ...
  public static String a(File paramFile)
  {
    ...
    //   56: ldc 188
    //   58: invokestatic 191	bkdn:a	(Ljava/lang/String;I)[B
    //   61: astore_1
    //   62: aload_1
    ...
    //   80: astore_2
    //   81: aload_1
    //   82: invokestatic 201	bkdn:a	(Ljava/io/RandomAccessFile;)[B
    //   85: astore_3
    //   86: aload_3
    //   87: ifnonnull +45 -> 132
    //   90: aload_1
    ...
    //   139: dup
    //   140: aconst_null
    //   141: invokespecial 215	bkdp:<init>	(Lbkdo;)V
    //   144: astore 4
    //   146: aload_1
    //   147: astore_0
    //   148: aload_1
    ...
    //   150: aload 4
    //   152: aload_3
    //   153: invokevirtual 218	bkdp:a	([B)V
    //   156: aload_1
    //   157: astore_0
    //   158: aload_1
    //   159: astore_2
    //   160: aload 4
    //   162: getfield 221	bkdp:a	Ljava/util/Properties;
    //   165: ldc 223
  ...
  private static byte[] a(byte[] paramArrayOfByte)
  {
    ...
    do
    {
      do
      {
        ...
        arrayOfByte = new byte[jdField_a_of_type_Bkdt.a().length];
        ((ByteBuffer)localObject).get(arrayOfByte);
        localObject = paramArrayOfByte;
      } while (jdField_a_of_type_Bkdt.equals(new bkdt(arrayOfByte)));
      localObject = paramArrayOfByte;
    } while (b.equals(new bkdt(arrayOfByte)));
    Object localObject = new ByteArrayOutputStream();
    ((ByteArrayOutputStream)localObject).write(b.a());
    ((ByteArrayOutputStream)localObject).write(new bkdu(paramArrayOfByte.length).a());
  ...
  private static void b(File paramFile, String paramString)
  {
    ...
    finally
    {
      try
      {
        ...
        localbkdp = new bkdp(null);
        localbkdp.a(paramFile);
        localbkdp.a.setProperty("apkSecurityCode", paramString);
        paramFile = localbkdp.a();
        localRandomAccessFile.seek(jdField_a_of_type_Int);
        localRandomAccessFile.write(new bkdu(paramFile.length).a());
  ...
  private static void c(File paramFile, String paramString)
  {
    try
    {
      ...
      bkdp localbkdp = new bkdp(null);
      localbkdp.a(arrayOfByte);
      localbkdp.a.setProperty("apkSecurityCode", paramString);
      paramString = localbkdp.a();
