...
public abstract class atcc
{
  ...
  public atcc(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    if ((paramChatMessage.isMultiMsg) && (!TextUtils.isEmpty((CharSequence)localObject)))
    {
      ...
      if (j == 3)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqDataMessageForTroopFile == null) {
          this.jdField_a_of_type_ComTencentMobileqqDataMessageForTroopFile = ((MessageForTroopFile)bbzh.a(-2017));
        }
        atvo.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForTroopFile);
        ...
        atvo.a(paramChatMessage, this.jdField_a_of_type_ComTencentMobileqqDataMessageForTroopFile);
        ((ChatMessage)localObject).istroop = 1;
        if ((j == 1) || (j == 2)) {
          atvo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((ChatMessage)localObject).uniseq, ((ChatMessage)localObject).frienduin, ((ChatMessage)localObject).istroop, paramChatMessage);
        }
        return localObject;
      }
      if ((j == 1) || (j == 2))
      {
        ...
        for (;;)
        {
          if (this.jdField_a_of_type_ComTencentMobileqqDataMessageForFile == null) {
            this.jdField_a_of_type_ComTencentMobileqqDataMessageForFile = ((MessageForFile)bbzh.a(i));
          }
          atvo.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForFile);
          localObject = this.jdField_a_of_type_ComTencentMobileqqDataMessageForFile;
          ((ChatMessage)localObject).isMultiMsg = paramChatMessage.isMultiMsg;
          ((ChatMessage)localObject).frienduin = paramChatMessage.getExtInfoFromExtStr("_m_ForwardReceiverUin");
          ((ChatMessage)localObject).senderuin = paramChatMessage.getExtInfoFromExtStr("_m_ForwardSenderUin");
          atwt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageRecord)localObject, paramChatMessage);
          atvo.a(paramChatMessage, this.jdField_a_of_type_ComTencentMobileqqDataMessageForFile);
          break;
          i = -2014;
        }
      }
      ...
      return (ChatMessage)bbzh.a(-2005);
    }
  ...
  public abstract asyo a();
  
  public abstract asyr a();
