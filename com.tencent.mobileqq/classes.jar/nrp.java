...
{
  public nrp(AuthorizeConfig.2 param2) {}
      ...
      if (paramBundle != null)
      {
        ...
        try
        {
          ...
          if (paramInt == 0)
          {
            ...
            bdla.b(null, "P_CliOper", "Pb_account_lifeservice", "", "webview_whitelist", "update_success", 0, 1, 0, "", "", "", "");
            return;
          }
          if (paramInt == 304)
          {
            ...
            this.a.this$0.g();
            this.a.this$0.i();
            bdla.b(null, "P_CliOper", "Pb_account_lifeservice", "", "webview_whitelist", "update_not_modify", 0, 1, 0, "", "", "", "");
            return;
          }
        }
