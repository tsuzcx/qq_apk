  ...
  extends ViewBase
{
  ...
  private npo jdField_a_of_type_Npo = new npo();
  private nrn jdField_a_of_type_Nrn;
  ...
  private nro jdField_b_of_type_Nro;
  private int c = -1;
  private int d;
  private int e;
  private int f;
  ...
  public nrp(VafContext paramVafContext)
  {
  ...
  private Boolean a(float paramFloat1, float paramFloat2)
  {
    ...
    boolean bool3 = true;
    boolean bool1 = true;
    float f1 = this.jdField_a_of_type_Nro.d;
    float f2 = this.jdField_a_of_type_Nro.c;
    float f3 = this.jdField_b_of_type_Nro.d;
    float f4 = this.jdField_b_of_type_Nro.c;
    if (f1 == f3)
    {
      if (paramFloat2 <= f1) {}
      for (;;)
  ...
  private nro a(String paramString)
  {
  ...
  {
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2131494219, null);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302873));
    this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302875));
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyCutImageView = ((ReadInjoyCutImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131302874));
  ...
  private void a(View paramView)
  {
    ...
    if ((this.jdField_a_of_type_Opw != null) && (this.jdField_a_of_type_Opw.a() != null) && (this.jdField_a_of_type_Opw.a().a() != null))
    {
      this.jdField_b_of_type_Int = this.jdField_a_of_type_Opw.a().a().getPaddingTop();
      this.c = this.jdField_a_of_type_Opw.a().a().getTop();
      if (this.jdField_a_of_type_Int <= 0) {
        this.jdField_a_of_type_Int = this.jdField_a_of_type_Opw.a().a().getBottom();
      }
    }
    for (;;)
    {
  ...
  private void a(String paramString)
  {
    ...
    if (localObject.length == 2)
    {
      ...
      this.jdField_a_of_type_Nro = a(paramString);
      this.jdField_b_of_type_Nro = a((String)localObject);
    }
  }
  ...
  private void a(String paramString, Drawable paramDrawable)
  {
    ...
    do
    {
      ...
      if ((paramDrawable != null) && (paramDrawable.getStatus() == 1))
      {
        ...
        this.jdField_a_of_type_Nrn = new nrn(paramDrawable.getCurrDrawable(), this.d, this.jdField_a_of_type_Int - (this.jdField_b_of_type_Int + this.c));
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(this.jdField_a_of_type_Nrn);
        this.jdField_a_of_type_JavaLangString = paramString;
        return;
      }
    } while (paramDrawable == null);
    paramDrawable.setURLDrawableListener(new nrq(this, paramString));
  }
  
  private void a(ArrayList<String> paramArrayList)
  {
    if ((npj.l(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo)) && (paramArrayList != null) && (paramArrayList.size() > 0))
    {
  ...
  private void c()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) {
      if (!npj.i(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))
      {
  ...
  private void e()
  {
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo == null) || (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.c)) || (this.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdMaterialWidth == 0) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdMaterialHeight == 0) || (this.jdField_a_of_type_JavaLangRunnable != null) || (this.jdField_a_of_type_Npo.a() != null) || (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyCutImageView == null)) {
      return;
    }
    a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.c);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyCutImageView.setOnTouchListener(new nrr(this));
    if ((this.jdField_a_of_type_Nro != null) && (this.jdField_b_of_type_Nro != null)) {
      this.jdField_a_of_type_Npo.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyCutImageView, this.jdField_a_of_type_Nro, this.jdField_b_of_type_Nro, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.i, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.j, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo.mAdvertisementExtInfo.m);
    }
    this.jdField_a_of_type_Npo.a(new nrs(this));
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, double paramDouble)
  {
    ...
    } while (this.jdField_a_of_type_Nrn == null);
    if (this.jdField_a_of_type_Nrn.getCallback() == null) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(this.jdField_a_of_type_Nrn);
    }
    ...
    this.jdField_a_of_type_Nrn.a(paramInt1, paramInt2);
  }
  ...
  public void a(opw paramopw)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) && (npj.i(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))) {
      d();
    }
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) && (npj.l(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))) {
      a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView);
    }
  }
  ...
  public void reset()
  {
    ...
    {
      this.jdField_a_of_type_Npo.a();
      this.jdField_a_of_type_Npo.a(null);
      this.jdField_a_of_type_Npo = null;
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyAdViewReadInjoyCutImageView.setImageSrc(null);
    }
    if (this.jdField_a_of_type_Nrn != null)
    {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(null);
      this.jdField_a_of_type_Nrn.a();
      this.jdField_a_of_type_Nrn = null;
    }
  }
