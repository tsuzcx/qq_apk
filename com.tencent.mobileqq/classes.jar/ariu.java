  ...
  implements Handler.Callback, Manager
{
  ...
  public ariu(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        for (int i = 1;; i = 0)
        {
          ...
          localObject = bcev.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp());
          if (localObject != null)
          {
  ...
  private void b()
  {
    ...
    localObject2 = ajjy.a(2131649193);
    str4 = "登录TIM";
    str2 = ajjy.a(2131649192);
    ...
    babr.a(BaseActivity.sTopActivity, 230, str5, str6, (String)localObject3, (String)localObject1, new ariv(this), new ariw(this)).show();
    awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X80085D9", "0X80085D9", 0, 0, "", "", "", "");
  }
  ...
  {
    if (!bady.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim", "775E696D09856872FDD8AB4F3F06B1E0"))
    {
      bbmy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131654349, 0).a();
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "jumpTimLogin tim not install ");
      }
      return;
    }
    String str = bady.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim");
    int i = amlh.a().b();
    if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      {
        localbbms = new bbms(BaseActivity.sTopActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getDimensionPixelOffset(2131167766));
        localbbms.a(ajjy.a(2131649191));
        localbbms.show();
        ...
        localWtloginHelper.SetListener(new arix(this, localbbms, localWtloginHelper, paramBundle));
        paramBundle = util.getPkgSigFromApkName(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "com.tencent.tim");
        i = localWtloginHelper.GetA1WithA1(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), 16L, 16L, "com.tencent.tim".getBytes(), 1L, 16L, 16L, "8.2.6".getBytes(), paramBundle, new WUserSigInfo(), new WFastLoginInfo());
      }
      if (i == -1001) {
        break;
      }
      ...
      if ((localbbms != null) && (localbbms.isShowing())) {
        localbbms.dismiss();
      }
      bbmy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131654348, 0).a();
      return;
    } while (j >= i);
    bbmy.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), 1, 2131654350, 0).a();
  }
