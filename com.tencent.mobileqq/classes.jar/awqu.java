...
public class awqu
{
  ...
  private static awqw jdField_a_of_type_Awqw = new awqw();
  ...
  public static int a()
  {
    ...
    if (!((ajoy)((AppRuntime)localObject).getManager(56)).a(Long.valueOf(Long.parseLong("2290230341"))))
    {
      if (QLog.isColorLevel()) {
  ...
  {
    bgbz.a().a(new awqv(paramQQAppInterface));
    bgbz.a().a().x();
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, ConfigurationService.Config paramConfig, int paramInt, String paramString)
  {
    ...
    int j = baig.a(paramQQAppInterface.getApp(), "qzone_xp_config_version", paramString);
    if (QLog.isColorLevel()) {
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        try
        {
          ...
          baig.a(paramQQAppInterface.getApp(), "qzone_xp_config_version", paramString, i);
          return;
        }
  ...
  private static void b(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    ...
    NewIntent localNewIntent = new NewIntent(BaseApplicationImpl.getApplication(), awdi.class);
    ...
    for (String str = "1";; str = "0")
    {
      ...
      BaseApplicationImpl.getApplication().getRuntime().registObserver(jdField_a_of_type_Awqw);
      BaseApplicationImpl.getApplication().getRuntime().startServlet(localNewIntent);
      awqx.b(paramQQAppInterface, "CliOper", "", "", "0X800915C", "0X800915C", 0, 0, "", "", "", "");
      return;
    }
  }
}
