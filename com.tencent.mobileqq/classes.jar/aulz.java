  ...
  implements Manager
{
  ...
  public aulz(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(String paramString)
  {
    ...
    while (!bbep.a(paramString, localSQLiteDatabase)) {
      return 0;
    }
  ...
  public long a(String paramString)
  {
    ...
    do
    {
      return l3;
      l2 = l1;
      if (bbep.a(paramString, localSQLiteDatabase)) {
        l3 = l1;
      }
      try
      {
  ...
  public Cursor a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      paramString2 = bbep.b(null, paramString1, localSQLiteDatabase, (String)localObject1);
    ...
    for (;;)
    {
      ...
      if (paramString1.indexOf("mr_discusssion_") != -1)
      {
        ...
        paramString2 = bbep.b(null, paramString1, localSQLiteDatabase, (String)localObject2);
      ...
      Object localObject2 = bbep.a(null, paramString1, localSQLiteDatabase, paramString2, null);
  ...
  public auko a()
  {
    ...
    try
    {
      if (this.jdField_a_of_type_ComTencentMobileqqDataQQEntityManagerFactory == null)
      {
        this.jdField_a_of_type_ComTencentMobileqqDataQQEntityManagerFactory = new auly(str);
  ...
  public aukv a()
  {
    ...
    {
      if ((this.jdField_a_of_type_Aukv == null) || (!this.jdField_a_of_type_Aukv.a())) {
        this.jdField_a_of_type_Aukv = ((aukv)a().createMessageRecordEntityManager());
      }
  ...
  public List<MessageRecord> a(String paramString1, String paramString2)
  {
    ...
    {
      return null;
      paramString1 = bbep.a(null, paramString1, localSQLiteDatabase, paramString2, null);
