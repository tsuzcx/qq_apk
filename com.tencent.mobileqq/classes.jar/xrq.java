...
{
  final Runnable jdField_a_of_type_JavaLangRunnable = new xrs(this);
  ...
  public void a(AVCodec.AVCodecCallback paramAVCodecCallback, MessageStruct paramMessageStruct)
  {
    ...
    paramAVCodecCallback.jdField_a_of_type_Xrn = null;
    ...
    paramAVCodecCallback.jdField_a_of_type_AndroidOsHandler.post(new xru(this));
    e();
  }
                    ...
                    case 3: 
                      ...
                      else
                      {
                        ...
                        if (((RMVideoStateMgr)localObject).jdField_a_of_type_AndroidOsHandler != null) {
                          ((RMVideoStateMgr)localObject).jdField_a_of_type_AndroidOsHandler.post(new xrw(this));
                        }
  ...
  void d()
  {
    ...
    localRMVideoStateMgr.jdField_a_of_type_AndroidOsHandler.postDelayed(new xrr(this), 50L);
  }
  ...
  void e()
  {
    ...
    if (b())
    {
      ...
      localRMVideoStateMgr.jdField_a_of_type_AndroidOsHandler.post(new xrt(this));
    }
  }
