  ...
  extends wdr
{
  ...
  public beue(String paramString)
  {
  ...
  private void c()
  {
    ...
    localTransferRequest.mUpCallBack = new beuf(this);
  ...
  protected void a()
  {
    if ((TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) || (!zeb.c(this.jdField_a_of_type_JavaLangString)))
    {
      ykq.d("tribe_publish_TribeVideoFileObject", "end composite success but file not exist:%s", new Object[] { this.jdField_a_of_type_JavaLangString });
