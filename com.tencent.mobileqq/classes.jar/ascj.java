  ...
  implements Manager
{
  ...
  public ConcurrentHashMap<Long, asci> a;
  public MqqHandler a;
  ...
  private ConcurrentHashMap<String, ConcurrentHashMap<String, asco>> jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  public boolean b;
  ...
  private ConcurrentHashMap<String, ConcurrentHashMap<String, ascn>> jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  static
  {
    jdField_a_of_type_JavaLangString = bfcj.a(antf.ba + "DoutuRes" + File.separator);
  }
  
  public ascj(QQAppInterface paramQQAppInterface)
  {
  ...
  private int a(List<ChatMessage> paramList, SessionInfo paramSessionInfo, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (j != 0)
      {
        ...
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007FA7", "0X8007FA7", 0, 0, "", "", "", "");
  ...
  public static void a(RelativeLayout paramRelativeLayout, QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = (ascj)paramQQAppInterface.getManager(214);
  ...
  private void a(ChatMessage paramChatMessage)
  {
    ...
    if (paramChatMessage.isSend())
    {
      ...
      if (((MessageForMarketFace)localObject2).mMarkFaceMessage != null)
      {
        ...
        paramChatMessage = asfa.a(paramChatMessage.sbufID, paramChatMessage.mediaType);
      }
      i = 1;
    }
    for (;;)
    {
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800AF0B", "0X800AF0B", 0, 0, String.valueOf(i), "", paramChatMessage, "");
      return;
      label84:
        ...
        for (paramList.isDui = false;; paramList.isDui = false)
        {
          do
          {
            if (paramList.isDui)
            {
              ...
              {
                bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008012", "0X8008012", 0, 0, "", "", "", "");
  ...
  private boolean a(String paramString)
  {
    ...
    if (bhsi.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))
    {
      if (QLog.isColorLevel()) {
      ...
      for (paramInt = 0;; paramInt = i)
      {
        ...
        for (;;)
        {
          if (paramInt > 0)
          {
            ...
            {
              bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008095", "0X8008095", 0, 0, "", "", "", "");
              this.jdField_e_of_type_Int = (localArrayList.size() - 1);
              if (paramInt == 3) {
                bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008094", "0X8008094", 0, 0, "", "", "", "");
              }
            }
          }
          ...
          for (;;)
          {
            ...
            paramList = new asct(paramList.senderuin, paramInt - 2, bool);
  ...
  private void f()
  {
    this.jdField_f_of_type_Boolean = bhsi.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    this.jdField_c_of_type_Boolean = bhsi.i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    this.jdField_d_of_type_Boolean = bhsi.k(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    this.jdField_b_of_type_Boolean = bhsi.l(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    long l1 = bhsi.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    int i = bhsi.ap(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    long l2 = bhsi.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    long l3 = bhsi.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    int j = bhsi.am(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (l1 > 0L) {
  ...
  public int a(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((ascn)((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_a_of_type_Int;
    }
    return 0;
  }
  ...
  public long a(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((asco)((ConcurrentHashMap)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_a_of_type_Long;
    }
    return 0L;
  }
  ...
  public void a(long paramLong)
  {
    ...
    {
      localObject = (asci)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong));
      ((asci)localObject).jdField_a_of_type_Int += 1;
    }
    if (QLog.isColorLevel())
    {
    ...
    label203:
    for (int i = ((asci)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Int;; i = 0)
    {
      QLog.i("DoutuManager", 2, i);
      if ((this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong)) != null) && (((asci)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Int >= 1))
      {
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(Long.valueOf(paramLong));
        if ((this.jdField_a_of_type_Asce != null) && (this.jdField_a_of_type_Asce.jdField_a_of_type_Long == paramLong)) {
  ...
  public void a(Context paramContext, ViewGroup paramViewGroup, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, MqqHandler paramMqqHandler, asci paramasci)
  {
    ...
    Object localObject = (LinearLayout)paramViewGroup.findViewById(2131365691);
    if (localObject != null)
    {
      if (QLog.isColorLevel()) {
      ...
      paramViewGroup = (DoutuEmotionHorizonListView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131365694);
      this.jdField_a_of_type_Asce = ((asce)paramViewGroup.getAdapter());
      if (this.jdField_a_of_type_Asce == null)
      {
        this.jdField_a_of_type_Asce = new asce(paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseActivity, paramSessionInfo, paramMqqHandler, this.jdField_b_of_type_Boolean, paramasci, this.jdField_a_of_type_Int);
        paramViewGroup.setAdapter(this.jdField_a_of_type_Asce);
      }
      c();
    }
    for (;;)
    {
      if ((this.jdField_g_of_type_Long <= 0L) || (System.currentTimeMillis() - this.jdField_g_of_type_Long <= 0L) || (System.currentTimeMillis() - this.jdField_g_of_type_Long >= 1000L))
      {
          ...
          if (paramContext.hasNext())
          {
            ...
            if (this.jdField_c_of_type_JavaUtilList.size() < 20)
            {
              ...
              if (!TextUtils.isEmpty(paramBaseActivity.pic_md5))
              {
                ...
                this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)View.inflate(paramContext, 2131558595, null));
                localObject = (DoutuEmotionHorizonListView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131365694);
                this.jdField_a_of_type_Asce = new asce(paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramBaseActivity, paramSessionInfo, paramMqqHandler, this.jdField_b_of_type_Boolean, paramasci, this.jdField_a_of_type_Int);
                ((DoutuEmotionHorizonListView)localObject).setAdapter(this.jdField_a_of_type_Asce);
                ((DoutuEmotionHorizonListView)localObject).setOnScrollStateChangedListener(new asck(this));
                ((DoutuEmotionHorizonListView)localObject).setTouchListener(new ascm(this, paramMqqHandler));
        ...
        if (this.jdField_a_of_type_Asce != null)
        {
          this.jdField_a_of_type_Asce.jdField_b_of_type_JavaUtilList = new ArrayList();
          this.jdField_a_of_type_Asce.jdField_b_of_type_JavaUtilList.addAll(this.jdField_c_of_type_JavaUtilList);
        }
        this.jdField_b_of_type_JavaUtilList.clear();
        h();
        label568:
        if (this.jdField_a_of_type_Asce != null)
        {
          this.jdField_a_of_type_Asce.a();
          this.jdField_a_of_type_Asce.notifyDataSetChanged();
        }
    ...
    label818:
    label856:
    for (paramContext = paramasci.toString();; paramContext = "")
    {
      QLog.d("DoutuManager", 2, paramContext);
      if ((paramasci != null) && (paramasci.a()) && (this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Asce != null))
      {
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(Long.valueOf(this.jdField_a_of_type_Asce.jdField_a_of_type_Long), new asci(this.jdField_a_of_type_Asce.jdField_a_of_type_Long, 0));
        a(paramasci, paramSessionInfo, this.jdField_a_of_type_Asce.jdField_a_of_type_Long);
      }
      if (Build.VERSION.SDK_INT >= 14) {
        paramViewGroup.setScrollX(0);
      }
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(0);
      bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007FA9", "0X8007FA9", 0, 0, "", "", "", "");
  ...
  public void a(asci paramasci, SessionInfo paramSessionInfo, long paramLong)
  {
    ThreadManager.post(new DoutuManager.4(this, paramasci, paramLong, paramSessionInfo), 5, null, true);
  }
  ...
  public void a(SessionInfo paramSessionInfo, ChatMessage paramChatMessage)
  {
    ...
    {
      ((ConcurrentHashMap)this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramChatMessage)).put(paramSessionInfo, new asco(this, l1, l2));
      return;
    }
    ConcurrentHashMap localConcurrentHashMap = new ConcurrentHashMap();
    localConcurrentHashMap.put(paramSessionInfo, new asco(this, l1, l2));
  ...
  public void a(SessionInfo paramSessionInfo, ChatMessage paramChatMessage, int paramInt1, int paramInt2)
  {
    ...
    {
      ((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).put(paramSessionInfo, new ascn(this, l1, l2, paramChatMessage.senderuin, paramInt1, paramInt2));
      return;
    }
    ConcurrentHashMap localConcurrentHashMap = new ConcurrentHashMap();
    localConcurrentHashMap.put(paramSessionInfo, new ascn(this, l1, l2, paramChatMessage.senderuin, paramInt1, paramInt2));
  ...
  public void a(List<ChatMessage> paramList, SessionInfo paramSessionInfo, BaseChatPie paramBaseChatPie, int paramInt)
  {
    ...
    label17:
    while (bhjx.b(paramSessionInfo.jdField_a_of_type_JavaLangString)) {
      return;
    }
    if (c()) {
  ...
  public void a(boolean paramBoolean)
  {
    ...
    bhsi.h(BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), paramBoolean);
    if (paramBoolean) {
  ...
  public void a(boolean paramBoolean, List<DoutuData> paramList)
  {
    ...
    if ((this.jdField_a_of_type_Asce != null) && (this.jdField_c_of_type_JavaUtilList.size() == 0))
    {
      if (QLog.isColorLevel()) {
      ...
      h();
      this.jdField_a_of_type_Asce.a();
      if (this.jdField_a_of_type_Asce.jdField_a_of_type_MqqOsMqqHandler != null) {
        this.jdField_a_of_type_Asce.jdField_a_of_type_MqqOsMqqHandler.sendEmptyMessage(81);
      }
    }
    int i;
    if (this.jdField_b_of_type_JavaUtilList.size() > 0) {
  ...
  public void a(boolean paramBoolean, List<DoutuData> paramList, long paramLong)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      i = ((asci)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(Long.valueOf(paramLong))).jdField_a_of_type_Int;
  ...
  public long b(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((ascn)((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_a_of_type_Long;
    }
    return 0L;
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetLinearLayout != null)
    {
      ...
      this.jdField_a_of_type_Asce = null;
      this.jdField_c_of_type_JavaUtilList.clear();
      this.jdField_a_of_type_JavaUtilList.clear();
      g();
    }
  ...
  public void b(boolean paramBoolean)
  {
    ...
    a();
    if ((bhnv.a(BaseApplication.getContext())) && (!paramBoolean)) {
      e();
    }
  }
  ...
  public long c(SessionInfo paramSessionInfo)
  {
    ...
    if ((this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str) != null) && (((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo) != null)) {
      return ((ascn)((ConcurrentHashMap)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get(paramSessionInfo)).jdField_b_of_type_Long;
    }
    return 0L;
  }
  ...
  {
    if (this.jdField_a_of_type_Asce == null) {}
    while ((this.jdField_a_of_type_Asce.jdField_a_of_type_JavaUtilHashMap == null) && (this.jdField_a_of_type_Asce.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData == null)) {
      return;
    }
    Object localObject1 = new ascp();
    ((ascp)localObject1).jdField_a_of_type_JavaLangString = "dc03631";
    localObject1.getClass();
    Object localObject2 = new ascq((ascp)localObject1);
    ((ascq)localObject2).jdField_a_of_type_JavaLangString = String.valueOf(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()).longValue());
    if (this.jdField_a_of_type_Asce.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData != null)
    {
      ((ascq)localObject2).d = this.jdField_a_of_type_Asce.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData.pic_md5;
      ((ascq)localObject2).e = this.jdField_a_of_type_Asce.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData.pic_down_url;
    }
    if (this.jdField_a_of_type_Asce.jdField_a_of_type_Asci != null)
    {
      ((ascq)localObject2).c = this.jdField_a_of_type_Asce.jdField_a_of_type_Asci.c;
      ((ascq)localObject2).jdField_b_of_type_JavaLangString = this.jdField_a_of_type_Asce.jdField_a_of_type_Asci.jdField_b_of_type_JavaLangString;
    }
    if ((this.jdField_a_of_type_Asce.jdField_a_of_type_JavaUtilHashMap != null) && (this.jdField_a_of_type_Asce.jdField_a_of_type_JavaUtilHashMap.size() > 0))
    {
      ArrayList localArrayList1 = new ArrayList();
      ArrayList localArrayList2 = new ArrayList();
      Iterator localIterator = this.jdField_a_of_type_Asce.jdField_a_of_type_JavaUtilHashMap.keySet().iterator();
      while (localIterator.hasNext())
      {
        String str = (String)localIterator.next();
        localArrayList1.add(str);
        localArrayList2.add(this.jdField_a_of_type_Asce.jdField_a_of_type_JavaUtilHashMap.get(str));
      }
      ((ascq)localObject2).jdField_a_of_type_JavaUtilArrayList = localArrayList1;
      ((ascq)localObject2).jdField_b_of_type_JavaUtilArrayList = localArrayList2;
    }
    int i;
    if (this.jdField_a_of_type_Asce.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null)
    {
      i = this.jdField_a_of_type_Asce.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int;
      if (i != 0) {
        break label401;
      }
      ((ascq)localObject2).f = "c2c";
    }
    for (;;)
    {
      ((ascq)localObject2).h = this.jdField_a_of_type_Asce.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString;
      ((ascq)localObject2).g = "android";
      ((ascp)localObject1).jdField_a_of_type_Ascq = ((ascq)localObject2);
      localObject1 = ((ascp)localObject1).a();
      localObject2 = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), ascr.class);
      ...
      this.jdField_a_of_type_Asce.jdField_a_of_type_ComTencentMobileqqDoutuDoutuData = null;
      this.jdField_a_of_type_Asce.jdField_a_of_type_JavaUtilHashMap = null;
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.startServlet((NewIntent)localObject2);
      return;
      label401:
      if (i == 1) {
        ((ascq)localObject2).f = "group";
      } else if (i == 3000) {
        ((ascq)localObject2).f = "discuss";
      } else {
        ((ascq)localObject2).f = "other";
      }
    }
  }
  ...
  public boolean d()
  {
    return a(bhsi.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()));
  }
  ...
  public void e()
  {
    ...
    String str1 = bhsi.m(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    String str2 = bhsi.l(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    ...
    if (!a(str1))
    {
      ...
      bihu localbihu = new bihu(str2, new File(str3));
      localbihu.n = true;
      ...
      localbihz.a(localbihu, new ascl(this, str2, str3, str1), null);
      return;
    }
    DuiButtonImageView.a();
    jdField_a_of_type_Boolean = false;
