  ...
  extends arwf
{
  ...
  public ascj(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, EmoticonPackage paramEmoticonPackage, arxd paramarxd, BaseChatPie paramBaseChatPie, int paramInt4)
  {
  ...
  public View a(arwg paramarwg, int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    Object localObject1 = (ascl)paramarwg;
    int i;
    if (getItemViewType(paramInt) == 0)
    {
      ...
      if (paramView == null)
      {
        ...
        for (;;)
        {
          ...
          paramarwg.setLayoutParams(paramViewGroup);
      ...
      ((EmoticonPanelLinearLayout)paramarwg).setCallBack(this.b);
      a(this.c, paramarwg);
      paramView = (ViewGroup)paramarwg;
      ((ascl)localObject1).jdField_a_of_type_ArrayOfComTencentImageURLImageView = new URLImageView[this.jdField_a_of_type_Int];
      i = 0;
      while (i < this.jdField_a_of_type_Int)
      {
        ((ascl)localObject1).jdField_a_of_type_ArrayOfComTencentImageURLImageView[i] = ((URLImageView)paramView.getChildAt(i));
        i += 1;
      }
      ...
      for (;;)
      {
        ...
        for (paramView = (arxg)paramView;; paramView = null)
        {
          ...
          if (paramView == null)
          {
            ...
            localLinearLayout.setLayoutParams(paramarwg);
            paramView = arza.a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticonPackage.epId, true);
            ...
            if (paramView.a)
            {
              ...
              ((ImageView)localObject2).setBackgroundDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130847100));
              localLinearLayout.addView((View)localObject2, paramarwg);
              paramViewGroup.addView(localLinearLayout);
              ((ascl)localObject1).jdField_a_of_type_AndroidWidgetLinearLayout = localLinearLayout;
              ((ascl)localObject1).jdField_a_of_type_AndroidWidgetLinearLayout.setOnClickListener(new asck(this, paramView));
              if (this.g != 2) {
                break label896;
              }
              ((ascl)localObject1).jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
              label825:
            ...
            {
              VasWebviewUtil.reportCommercialDrainage(paramarwg, "ep_mall", "exp_bq_detail", null, 1, 0, 0, null, (String)localObject1, paramView);
              paramView = paramViewGroup;
              return paramView;
              paramarwg = anni.a(2131712956);
              break;
              ((ascl)localObject1).jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(0);
              break label825;
              paramarwg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
              break label843;
            }
          }
          return paramView;
