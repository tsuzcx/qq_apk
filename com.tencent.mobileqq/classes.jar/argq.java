...
public class argq
{
  private argl jdField_a_of_type_Argl;
  private argp jdField_a_of_type_Argp;
  private arhb jdField_a_of_type_Arhb;
  
  private void a(XmlPullParser paramXmlPullParser, argl paramargl)
  {
    paramargl.jdField_a_of_type_JavaLangString = paramXmlPullParser.getAttributeValue(null, "name");
    String str = paramXmlPullParser.getAttributeValue(null, "timeout");
    if (str != null) {
      paramargl.jdField_a_of_type_Int = Integer.parseInt(str);
    }
    paramXmlPullParser = paramXmlPullParser.getAttributeValue(null, "nextActionIfTimeout");
    if (paramXmlPullParser != null) {
      paramargl.jdField_a_of_type_Boolean = Boolean.parseBoolean(paramXmlPullParser);
    }
  }
  ...
  public argn a(String paramString)
  {
    try
    {
          ...
          try
          {
            ...
            if (localObject2 != null)
            {
              ...
              else
              {
                ...
                {
                  localObject2 = new argr();
                  ((argr)localObject2).jdField_a_of_type_JavaLangString = localXmlPullParser.getAttributeValue(null, "type");
                  str = localXmlPullParser.getAttributeValue(null, "timeout");
                  ((argr)localObject2).jdField_b_of_type_JavaLangString = str;
                  if (str != null) {
                    paramString.jdField_c_of_type_Int = Integer.parseInt(str);
                  }
                  ((argr)localObject2).jdField_c_of_type_JavaLangString = localXmlPullParser.getAttributeValue(null, "text");
                  paramString.jdField_a_of_type_Argr = ((argr)localObject2);
                  return paramString;
                }
  ...
  public List<argl> a(String paramString)
  {
    ...
    catch (Exception localException3)
    {
      for (;;)
      {
        try
        {
          ...
          {
            this.jdField_a_of_type_Argl = new argl();
            paramString.add(this.jdField_a_of_type_Argl);
            a(localXmlPullParser, this.jdField_a_of_type_Argl);
            ...
            if ((localObject != null) && ("send".equalsIgnoreCase(((String)localObject).trim()))) {
              this.jdField_a_of_type_Argl.d = true;
            }
          }
          else
          {
            ...
            {
              this.jdField_a_of_type_Argp = new argp();
              this.jdField_a_of_type_Argl.jdField_a_of_type_Argp = this.jdField_a_of_type_Argp;
              this.jdField_a_of_type_Argp.jdField_a_of_type_JavaLangString = localXmlPullParser.getAttributeValue(null, "type");
              continue;
            }
            if (((String)localObject).equalsIgnoreCase("gravity"))
            {
              this.jdField_a_of_type_Argp.jdField_b_of_type_JavaLangString = "gravity";
              localObject = localXmlPullParser.getAttributeValue(null, "value");
              if (localObject != null) {
                this.jdField_a_of_type_Argp.jdField_a_of_type_Int = Integer.parseInt((String)localObject);
              }
              localObject = localXmlPullParser.getAttributeValue(null, "stopType");
              if (localObject == null) {
                break label1316;
              }
              this.jdField_a_of_type_Argp.jdField_c_of_type_JavaLangString = ((String)localObject);
              break label1316;
            }
            if ("mic".equalsIgnoreCase((String)localObject))
            {
              this.jdField_a_of_type_Argp.jdField_b_of_type_JavaLangString = "mic";
              localObject = localXmlPullParser.getAttributeValue(null, "value");
              if (localObject != null) {
                this.jdField_a_of_type_Argp.jdField_a_of_type_Int = Integer.parseInt((String)localObject);
              }
            ...
            {
              this.jdField_a_of_type_Argp.jdField_b_of_type_JavaLangString = "touch";
              localObject = localXmlPullParser.getAttributeValue(null, "stopType");
              if (localObject == null) {
                break label1322;
              }
            ...
            {
              localObject = new args();
              str = localXmlPullParser.getAttributeValue(null, "min");
              if (str != null) {
                ((args)localObject).jdField_a_of_type_Int = Integer.parseInt(str);
              }
              str = localXmlPullParser.getAttributeValue(null, "max");
              if (str != null)
              {
                ((args)localObject).jdField_b_of_type_Int = Integer.parseInt(str);
                if (((args)localObject).jdField_b_of_type_Int == -1) {
                  ((args)localObject).jdField_b_of_type_Int = 2147483647;
                }
              }
              str = localXmlPullParser.getAttributeValue(null, "sum");
              if (str != null) {
                ((args)localObject).jdField_c_of_type_Int = Integer.parseInt(str);
              }
              this.jdField_a_of_type_Argp.jdField_a_of_type_JavaUtilList.add(localObject);
              continue;
            }
            ...
            {
              this.jdField_a_of_type_Arhb = new arhb();
              this.jdField_a_of_type_Argl.jdField_a_of_type_JavaUtilList.add(this.jdField_a_of_type_Arhb);
              localObject = localXmlPullParser.getAttributeValue(null, "min");
              if (localObject != null) {
                this.jdField_a_of_type_Arhb.jdField_a_of_type_Int = Integer.parseInt((String)localObject);
              }
              localObject = localXmlPullParser.getAttributeValue(null, "max");
              if (localObject == null) {
                break label1325;
              }
              this.jdField_a_of_type_Arhb.jdField_b_of_type_Int = Integer.parseInt((String)localObject);
              if (this.jdField_a_of_type_Arhb.jdField_b_of_type_Int != -1) {
                break label1325;
              }
              this.jdField_a_of_type_Arhb.jdField_b_of_type_Int = 2147483647;
              break label1325;
            }
            if (((String)localObject).equalsIgnoreCase("video"))
            {
              if (this.jdField_a_of_type_Arhb == null) {
                continue;
              }
              localObject = localXmlPullParser.getAttributeValue(null, "src");
              this.jdField_a_of_type_Arhb.jdField_a_of_type_JavaLangString = ((String)localObject);
              localObject = localXmlPullParser.getAttributeValue(null, "srcAlpha");
              this.jdField_a_of_type_Arhb.jdField_b_of_type_JavaLangString = ((String)localObject);
              localObject = localXmlPullParser.getAttributeValue(null, "duration");
              if (localObject != null) {
                this.jdField_a_of_type_Arhb.jdField_f_of_type_Int = Integer.parseInt((String)localObject);
              }
              localObject = localXmlPullParser.getAttributeValue(null, "fps");
              if (localObject != null) {
                this.jdField_a_of_type_Arhb.jdField_g_of_type_Int = Integer.parseInt((String)localObject);
              }
              localObject = localXmlPullParser.getAttributeValue(null, "repeat");
              if (localObject == null) {
                break label1328;
              }
              this.jdField_a_of_type_Arhb.jdField_c_of_type_Int = Integer.parseInt((String)localObject);
              break label1328;
            }
            if ("sound".equalsIgnoreCase((String)localObject))
            {
              ...
              localObject = localXmlPullParser.getAttributeValue(null, "src");
              this.jdField_a_of_type_Arhb.jdField_c_of_type_JavaLangString = ((String)localObject);
              localObject = localXmlPullParser.getAttributeValue(null, "duration");
              if (localObject != null) {
                this.jdField_a_of_type_Arhb.jdField_d_of_type_Int = Integer.parseInt((String)localObject);
              }
              localObject = localXmlPullParser.getAttributeValue(null, "repeat");
              if (localObject == null) {
                break label1331;
              }
              this.jdField_a_of_type_Arhb.jdField_e_of_type_Int = Integer.parseInt((String)localObject);
              break label1331;
            }
            if ("vibrator".equalsIgnoreCase((String)localObject))
            {
              ...
              this.jdField_a_of_type_Arhb.jdField_a_of_type_Boolean = true;
        ...
        catch (Exception localException3)
        {
          try
          {
            this.jdField_a_of_type_Arhb.h = Integer.parseInt((String)localObject);
            continue;
            if ("swipeGesture".equalsIgnoreCase((String)localObject))
            {
              ...
              {
                this.jdField_a_of_type_Argp.jdField_b_of_type_Int = 2;
                break label1334;
              }
              if ("down".equalsIgnoreCase((String)localObject))
              {
                this.jdField_a_of_type_Argp.jdField_b_of_type_Int = 3;
                break label1334;
              }
              if ("left".equalsIgnoreCase((String)localObject))
              {
                this.jdField_a_of_type_Argp.jdField_b_of_type_Int = 0;
                break label1334;
              }
              if (!"right".equalsIgnoreCase((String)localObject)) {
                break label1334;
              }
              this.jdField_a_of_type_Argp.jdField_b_of_type_Int = 1;
              break label1334;
            }
            if ("dbTapGesture".equalsIgnoreCase((String)localObject))
            {
              ...
              this.jdField_a_of_type_Argp.jdField_b_of_type_Int = 5;
              continue;
            }
            if ((!"tapGesture".equalsIgnoreCase((String)localObject)) || (this.jdField_a_of_type_Argp == null)) {
              continue;
            }
            this.jdField_a_of_type_Argp.jdField_b_of_type_Int = 4;
            continue;
            Object localObject = localXmlPullParser.getName();
            if (((String)localObject).equalsIgnoreCase("action"))
            {
              this.jdField_a_of_type_Argl = null;
              continue;
            }
            if (((String)localObject).equalsIgnoreCase("process"))
            {
              this.jdField_a_of_type_Argp = null;
              continue;
            }
            if (!((String)localObject).equalsIgnoreCase("playRes")) {
              continue;
            }
            this.jdField_a_of_type_Arhb = null;
            continue;
            localException2 = localException2;
            paramString = null;
            continue;
