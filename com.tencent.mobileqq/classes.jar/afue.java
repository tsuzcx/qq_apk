...
public class afue
  extends adra
{
  public afue(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
  ...
  public void a(ChatMessage paramChatMessage, Context paramContext, BaseChatItemLayout paramBaseChatItemLayout, acju paramacju, int paramInt1, int paramInt2)
  {
    ...
    if (paramContext.d != null)
    {
      ...
      paramContext.d.setText(ajjy.a(2131641050));
    }
    for (;;)
    {
      ...
      if ((paramChatMessage instanceof MessageForScribble)) {
        paramContext.d.setText(ajjy.a(2131641049));
      } else {
        paramContext.d.setText(ajjy.a(2131641051));
      }
    }
  }
