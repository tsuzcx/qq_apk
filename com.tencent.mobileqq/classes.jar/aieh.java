...
public class aieh
  extends Handler
{
  public aieh(SelectMemberActivity paramSelectMemberActivity, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
      ...
      if (!TextUtils.isEmpty(this.a.g))
      {
        ...
        bcpw.a(this.a, 2, paramMessage, 1500).b(this.a.getTitleBarHeight());
        postDelayed(new SelectMemberActivity.16.1(this), 1500L);
        return;
      }
      if (this.a.c) {}
      for (int i = 2131693678;; i = 2131693677)
      {
    ...
    paramMessage = str;
    if (str == null) {
      paramMessage = this.a.getString(2131693676);
    }
    bcpw.a(this.a, 1, paramMessage, 1500).b(this.a.getTitleBarHeight());
  }
}
