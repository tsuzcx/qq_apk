...
public class bgds
{
  ...
  public bgds(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
  ...
  private void a(JSONObject paramJSONObject)
  {
    ...
    String str = nmp.b(this.jdField_a_of_type_JavaLangString);
    boolean bool2;
    ...
    for (;;)
    {
      bgdv localbgdv = new bgdv(this, str, bool2, bool1);
      if (!TextUtils.isEmpty(str)) {
        ThreadManager.post(new SoLibraryChecker.4(this, paramJSONObject, str, localbgdv), 8, null, false);
      }
      return;
      if ((i == 3) || (i == 2))
      {
  ...
  private void b()
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((!new File(nmp.a(this.jdField_a_of_type_JavaLangString) + this.jdField_a_of_type_JavaLangString + "/" + this.b).exists()) && (!TextUtils.isEmpty(str)) && (!"0".equals(str))) {
    ...
    nmj.a(this.jdField_a_of_type_JavaLangString, localQQAppInterface, new bgdt(this), false);
  }
  ...
  private void c()
  {
    ...
    long l = System.currentTimeMillis();
    if ((!nmj.a(BaseApplicationImpl.getContext(), str, new bgdu(this, l))) && (QLog.isColorLevel())) {
