...
public class omr
{
  ...
  public static float a(Context paramContext, qtv paramqtv)
  {
    int j = 28;
    int i;
    if (paramqtv != null)
    ...
    for (;;)
    {
      return bbdh.a(paramContext) - baxn.a(paramContext, i);
      label56:
      if ((paramqtv.a != null) && (paramqtv.a.mChannelID == 56L))
      {
        i = j;
        if (onh.s()) {}
      }
  ...
  public static float a(android.view.View paramView)
  {
    ...
    //   5: monitorenter
    //   6: aload_0
    //   7: getstatic 31	omr:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    ...
    //   18: istore_3
    //   19: getstatic 31	omr:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   22: getfield 96	android/graphics/Rect:top	I
    //   25: ifne +24 -> 49
    //   28: getstatic 31	omr:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    ...
    //   47: fload_1
    //   48: freturn
    //   49: getstatic 31	omr:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   52: getfield 96	android/graphics/Rect:top	I
    //   55: ifle +22 -> 77
    //   58: ldc 83
    //   60: iload_3
    //   61: getstatic 31	omr:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    ...
    //   77: fload_2
    //   78: fstore_1
    //   79: getstatic 31	omr:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   82: getfield 99	android/graphics/Rect:bottom	I
    //   85: ifle -41 -> 44
    //   88: fload_2
    //   89: fstore_1
    //   90: getstatic 31	omr:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
    //   93: getfield 99	android/graphics/Rect:bottom	I
    //   96: iload_3
    //   97: if_icmpge -53 -> 44
    //   100: getstatic 31	omr:jdField_a_of_type_AndroidGraphicsRect	Landroid/graphics/Rect;
  ...
  {
    return (paramInt - (actj.a(24.0F, paramResources) + actj.a(3.0F, paramResources))) / 2;
  }
  ...
  public static Pair<Integer, Integer> a()
  {
    ...
    return new Pair(Integer.valueOf((localResources.getDisplayMetrics().widthPixels - actj.a(3.0F, localResources)) / 3), Integer.valueOf(localResources.getDimensionPixelSize(2131298552)));
  }
  
  public static Pair<Integer, Integer> a(int paramInt1, int paramInt2)
  {
    Resources localResources = BaseApplicationImpl.getApplication().getResources();
    int i = actj.a(1.5F, localResources);
    if (paramInt2 == 56) {
      i = actj.a(3.0F, localResources);
    }
    ...
    {
      f1 = localbhwc.a;
      f2 = localbhwc.jdField_b_of_type_Float;
      paramInt2 = actj.a(localbhwc.jdField_b_of_type_Int, localResources);
    }
    for (;;)
    {
      switch (paramInt1)
      ...
      for (paramInt1 = (int)((localResources.getDisplayMetrics().widthPixels - actj.a(6, localResources) - i * 2) / 2.1F);; paramInt1 = paramInt2)
      {
        i = (int)(paramInt1 / f2);
        paramInt2 = paramInt1;
        paramInt1 = i;
        for (;;)
        {
          ...
          paramInt2 = localResources.getDisplayMetrics().widthPixels - actj.a(12, localResources);
          paramInt1 = (int)((localResources.getDisplayMetrics().widthPixels - actj.a(6, localResources) - i * 2) / 2.5F * 1.3356F);
          continue;
          paramInt2 = (int)((localResources.getDisplayMetrics().widthPixels - actj.a(12, localResources) - i) * 0.5F);
  ...
  public static String a(String paramString)
  {
    ...
    do
    {
      return str;
      str = paramString;
    } while (!aylc.a(paramString));
    paramString = new StringBuilder(paramString);
    int i = 0;
    while (i < ayjy.a.length)
    {
      str = ayjy.a[i];
      int j = -1;
      for (;;)
  ...
  {
    a(paramImageView, onh.a(paramString), paramContext);
  }
  ...
  public static void a(ImageView paramImageView, URL paramURL, Context paramContext)
  {
    if (paramURL == null)
    {
      ...
      paramImageView.setImageResource(2130841259);
      return;
    }
    ...
    for (Object localObject = (BaseActivity)paramContext;; localObject = null)
    {
      ...
      {
        if ((!bbfj.h(paramContext)) && (bool) && (!rpg.a().a(paramURL)))
        {
          paramImageView.setImageResource(2130841259);
          return;
        }
        localObject = URLDrawable.URLDrawableOptions.obtain();
        ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = paramContext.getResources().getDrawable(2130841259);
        ((URLDrawable.URLDrawableOptions)localObject).mFailedDrawable = paramContext.getResources().getDrawable(2130841259);
    ...
    for (BaseActivity localBaseActivity = (BaseActivity)paramContext;; localBaseActivity = null)
    {
      ...
      for (boolean bool = SettingCloneUtil.readValue(localBaseActivity, str, null, "qqsetting_kandian_download_pic_flag", false);; bool = false)
      {
        ...
        if (!paramBoolean)
        {
          ...
          {
            paramKandianUrlImageView.a(paramContext.getResources().getDrawable(2130840109)).a(paramURL);
            return;
          }
          paramKandianUrlImageView.a(paramContext.getResources().getDrawable(2130841259)).a(paramURL);
          return;
        }
  ...
  public static void a(ViewBase paramViewBase, BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    par localpar = osg.a().a();
    if ((localpar != null) && (localpar.b()))
    {
    ...
    {
      a(true, paramViewBase, localpar);
      return;
    }
    if ((localpar != null) && (localpar.a()))
    {
      a(true, paramViewBase, localpar);
  ...
  public static void a(boolean paramBoolean, ViewBase paramViewBase, par parampar)
  {
  ...
  public static boolean a(qtv paramqtv)
  {
    if (paramqtv == null)
    {
      if (QLog.isColorLevel()) {
    ...
    return a(paramqtv.c, paramqtv.d);
  }
  
  public static Pair<Integer, Integer> b()
  {
    Resources localResources = BaseApplicationImpl.getApplication().getResources();
    int i = (localResources.getDisplayMetrics().widthPixels - actj.a(3.0F, localResources)) / 2;
  ...
  {
    Resources localResources = BaseApplicationImpl.getApplication().getResources();
    int i = (localResources.getDisplayMetrics().widthPixels - actj.a(3.0F, localResources)) / 3;
