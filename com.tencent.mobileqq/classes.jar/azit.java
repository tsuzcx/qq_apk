...
public class azit
{
  private static azit jdField_a_of_type_Azit;
  ...
  public int a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, String paramString, WtloginObserver paramWtloginObserver)
  {
    ...
    return paramQQAppInterface.regGetSMSVerifyLoginAccount(paramArrayOfByte1, paramArrayOfByte2, paramString, "8.4.10", paramWtloginObserver);
  }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    localQQCustomDialog.setTitle(2131716494);
    localQQCustomDialog.setMessage(2131716493);
    paramQQAppInterface = new aziu(this, str, paramActivity, paramQQAppInterface);
    paramActivity = new aziv(this);
    localQQCustomDialog.setPositiveButton(2131716492, paramQQAppInterface);
