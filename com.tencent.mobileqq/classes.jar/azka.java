  ...
  implements wxt
{
  ...
  private void g(String paramString)
  {
    ...
    a();
    localObject = new bcqf((Context)localObject, ((BaseActivity)localObject).getTitleBarHeight());
    ((bcqf)localObject).a(paramString);
    ((bcqf)localObject).setCancelable(false);
    ((bcqf)localObject).setOnDismissListener(new azkc(this));
    this.jdField_a_of_type_Bcqf = ((bcqf)localObject);
  ...
  private void h(String paramString)
  {
    ...
    {
      bcql.a((Context)localObject, 2131694608, 0).b(((BaseActivity)localObject).getTitleBarHeight());
      return;
    }
    g(((BaseActivity)localObject).getString(2131720592));
  ...
  private void j(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localIntent.putExtra("param_title", this.mRuntime.a().getString(2131693682));
        localIntent.putExtra("param_done_button_wording", this.mRuntime.a().getString(2131694794));
        localIntent.putExtra("param_done_button_highlight_wording", this.mRuntime.a().getString(2131694795));
        localIntent.putExtra("param_only_friends", true);
      ...
      catch (JSONException localJSONException1)
      {
        try
        {
          ...
          if (!TextUtils.isEmpty(paramString))
          {
            ...
            paramString.putString("troop_info_title", localActivity.getString(2131696415));
  ...
  private void m(String paramString)
  {
    ...
    g(((Activity)localObject).getString(2131720597));
    localObject = new Intent((Context)localObject, TroopCreateLogicActivity.class);
  ...
  {
    c();
    bfpc localbfpc = (bfpc)bfpp.a(this.mRuntime.a(), null);
    localbfpc.a(2131720590);
    localbfpc.a(2131720591, 3);
    localbfpc.c(2131690596);
    localbfpc.setOnDismissListener(new azkd(this));
    localbfpc.a(new azke(this));
  ...
  public void b(String paramString)
  {
    ...
    if (!bbfj.d(localBaseActivity)) {
      bcql.a(localBaseActivity, 2131694608, 0).b(localBaseActivity.getTitleBarHeight());
    }
  ...
  public void d(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 65	azka:mRuntime	Lbcdp;
    //   4: invokevirtual 70	bcdp:a	()Landroid/app/Activity;
    //   7: astore_3
    ...
    catch (JSONException paramString)
    {
      try
      {
        ...
        if (paramString != null)
        {
          ...
          azjz.a(localActivity, localActivity.getIntent().getExtras(), paramString);
        }
        return;
      }
      catch (JSONException paramString) {}
  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      paramString3 = this.jdField_a_of_type_Wxr;
      if (j == -1) {}
      ...
      if (paramString3.equals("insertCreateGroupSuccessMsg")) {
        try
        {
          ...
          this.jdField_a_of_type_Wxr.a(paramJsBridgeListener, paramString1, i, paramString2, this);
        }
      ...
      {
        bcql.a(this.mRuntime.a(), 0, "该api功能已下架!", 0).a();
        break label2264;
      }
      ...
      {
        paramJsBridgeListener.a("8.3.0.4480");
        break label2264;
      }
      if (paramString3.equals("isNetworkConnected"))
      {
        paramJsBridgeListener.a(Boolean.valueOf(bdid.d(bcyb.a().a())));
        break label2264;
      }
    ...
    else
    {
      ...
      if ("updateTroopBindedPubAccount".equals(paramString3))
      {
        try
        {
          ...
          if (j > 0)
          {
            ...
            this.jdField_a_of_type_Wxr.a(l, paramString1);
          }
          if (!QLog.isColorLevel()) {
            break label2264;
          }
      ...
      else if ("getLastSpeakMessage".equals(paramString3))
      {
        try
        {
          ...
          paramString2 = paramString2.optString("callback");
          this.jdField_a_of_type_Wxr.a(paramJsBridgeListener, paramString1, new azkb(this, paramString2));
          if (!QLog.isColorLevel()) {
            break label2264;
          }
      ...
      else if ("notifyTroopEnterEffectStatus".equals(paramString3))
      {
        try
        {
          ...
          this.jdField_a_of_type_Wxr.a(i, j, k, paramString1);
      ...
      else if ("returnToTroopAIO".equals(paramString3))
      {
        ...
        SensorAPIJavaScript.returnToAio(this.jdField_a_of_type_Wxr, this.mRuntime.a(), paramJsBridgeListener, true);
        break label2264;
      }
      else
      {
        if ("notifyCreateTroops".equals(paramString3))
        {
          try
          {
            ...
            paramString2 = paramString2.optString("callback");
            this.jdField_a_of_type_Wxr.b(paramJsBridgeListener, paramString1, paramString2, this);
          }
          catch (JSONException paramJsBridgeListener)
          {
            if (!QLog.isColorLevel()) {
          ...
          for (;;)
          {
            try
            {
              ...
              if ((paramString2 != null) && (paramString2.length() > 0))
              {
                ...
                this.jdField_a_of_type_Wxr.a(paramString3);
  ...
  public void onActivityResult(Intent paramIntent, byte paramByte, int paramInt)
  {
      ...
      do
      {
        do
        {
          do
          {
            ...
            paramInt = azon.a(paramByte);
            if (paramInt != 0) {
              bcql.a(this.mRuntime.a(), paramInt, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
            }
    ...
    {
      if (bool) {
        bcql.a((Context)localObject2, 2131720589, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      }
      for (;;)
      {
        ...
        return;
        bcql.a((Context)localObject2, 2131720594, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      }
    }
    if (paramByte == 1002) {
      paramIntent = ((BaseActivity)localObject2).getString(2131720602);
    }
    for (;;)
    {
      bcql.a((Context)localObject2, paramIntent, 0).b(((BaseActivity)localObject2).getTitleBarHeight());
      return;
      if (bool) {
        paramIntent = ((BaseActivity)localObject2).getString(2131720588);
      } else {
        paramIntent = ((BaseActivity)localObject2).getString(2131720593);
      }
    }
  }
