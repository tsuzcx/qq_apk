  ...
  implements View.OnClickListener, QzoneConfig.QzoneConfigChangeListener
{
  ...
  public adty(Conversation paramConversation)
  {
  ...
  public void a(View paramView)
  {
    ...
    if (paramView != null)
    {
      this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131365230);
      this.b = paramView.findViewById(2131374492);
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365231));
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Int == 1)
      {
        ...
        vvh.a(this.jdField_a_of_type_ComTencentMobileqqActivityHomeConversation.a(), "openfolder", localHashMap);
