  ...
  implements bbot<bbmx>
{
  ...
  public List<bbmx> a(Object... paramVarArgs)
  {
    ...
    for (;;)
    {
          ...
          for (;;)
          {
            try
            {
              ...
              case 10: 
                ...
                paramVarArgs.s = localResultItem.seporator_type.get();
            ...
            localObject4 = str6;
            continue;
            paramVarArgs = new bbnf(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bbob(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bbng(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bbno(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bbnx(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bbnu(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bbnv(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bbnl(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bbnj(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bbnm(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bbnw(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bbnt(str2, l3, localArrayList2, localResultItem, j);
            continue;
            paramVarArgs = new bbnr(str2, l3, localArrayList2, localResultItem, j);
            continue;
            l2 = l1 - 1L;
            continue;
            if (!bbup.b(l2))
            ...
            {
              paramVarArgs = new bboh(str2, str14, -4, str12);
              paramVarArgs.s = localResultItem.seporator_type.get();
              localArrayList3.add(paramVarArgs);
              l2 = l1;
            }
            ...
            {
              paramVarArgs = new bblw(str2, str10, str11, str12, str13, str14, l2, localArrayList2, j, str1, (String)localObject1, n, (String)localObject2, paramVarArgs, (String)localObject4);
              l2 = l1;
      ...
      {
        localArrayList1.add(new bblv(str2, l3, str7, localArrayList3, l1, paramVarArgs, (String)localObject1, localArrayList2, bool1, bool2, bool3, str8, str9));
        break;
        bool2 = false;
        break label1589;
      }
