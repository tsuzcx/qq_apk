  ...
  implements Handler.Callback
{
  ...
  private final bobd jdField_a_of_type_Bobd;
  private final ReleaseLooperHandler jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler;
  
  public bobc(bobd parambobd, ReleaseLooperHandler paramReleaseLooperHandler)
  {
    this.jdField_a_of_type_Bobd = parambobd;
  ...
  private boak a(Cursor paramCursor)
  {
    Object localObject = boag.a(paramCursor.getInt(2), paramCursor.getString(6), paramCursor.getString(3), paramCursor.getString(7), paramCursor.getLong(8), paramCursor.getInt(9), paramCursor.getString(4), paramCursor.getString(5), null);
    ((boag)localObject).f = paramCursor.getString(11);
    boal localboal = new boal();
    localboal.jdField_a_of_type_Int = paramCursor.getInt(12);
    localboal.jdField_b_of_type_Int = paramCursor.getInt(13);
    localboal.jdField_a_of_type_JavaLangString = paramCursor.getString(14);
    localboal.jdField_a_of_type_Long = paramCursor.getLong(15);
    localboal.jdField_b_of_type_Long = paramCursor.getLong(16);
    localboal.jdField_b_of_type_JavaLangString = paramCursor.getString(17);
    localboal.c = ((boag)localObject).jdField_a_of_type_JavaLangString;
    localboal.d = paramCursor.getString(10);
    localObject = boak.a(paramCursor.getString(1), (boag)localObject, paramCursor.getString(18), localboal);
    ((boak)localObject).a(paramCursor.getLong(0));
    return localObject;
  }
  
  private void a(ContentValues paramContentValues, boal paramboal, boolean paramBoolean)
  {
    boolean bool = false;
    ...
    {
      i = 0;
      paramContentValues = this.jdField_a_of_type_Bobd;
      if (i > 0) {
        bool = true;
      }
      paramContentValues.a(l, bool, paramboal, paramBoolean);
      return;
    }
    if (l >= 0L) {}
  ...
  /* Error */
  private void b(int paramInt, boak paramboak)
  {
    // Byte code:
    //   0: aload_2
    //   1: ifnonnull +4 -> 5
    //   4: return
    //   5: aload_2
    //   6: invokevirtual 184	boak:a	()Lboag;
    //   9: astore 12
    //   11: aload_2
    //   12: invokevirtual 187	boak:a	()Lboal;
    //   15: astore 13
    ...
    //   28: ifnull -24 -> 4
    //   31: aload_2
    //   32: invokevirtual 190	boak:a	()Ljava/lang/String;
    //   35: astore 8
    //   37: aload 12
    //   39: getfield 114	boag:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   42: astore 10
    //   44: aload_2
    //   45: invokevirtual 192	boak:b	()Ljava/lang/String;
    //   48: astore 14
    ...
    //   92: aload 11
    //   94: ldc 162
    //   96: getstatic 23	bobc:jdField_a_of_type_ArrayOfJavaLangString	[Ljava/lang/String;
    //   99: aload 15
    ...
    //   187: astore 8
    //   189: aload 12
    //   191: getfield 222	boag:c	Ljava/lang/String;
    //   194: astore 10
    ...
    //   290: ldc 37
    //   292: aload 12
    //   294: getfield 243	boag:jdField_a_of_type_Long	J
    ...
    //   305: ldc 39
    //   307: aload 12
    //   309: getfield 250	boag:jdField_b_of_type_Int	I
    ...
    //   320: ldc 55
    //   322: aload_2
    //   323: invokevirtual 192	boak:b	()Ljava/lang/String;
    ...
    //   379: aload 13
    //   381: getfield 113	boal:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    //   384: invokestatic 270	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   387: ifne +15 -> 402
    //   390: aload 14
    //   392: ldc 21
    //   394: aload 13
    //   396: getfield 113	boal:jdField_b_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   482: aload_2
    //   483: lload 6
    //   485: invokevirtual 128	boak:a	(J)V
    //   488: aload_0
    //   489: getfield 64	bobc:jdField_a_of_type_Bobd	Lbobd;
    //   492: iload_1
    //   493: aload_2
    //   494: aload 8
    ...
    //   548: ldc 45
    //   550: aload 13
    //   552: getfield 102	boal:jdField_a_of_type_Int	I
    ...
    //   563: ldc 47
    //   565: aload 13
    //   567: getfield 104	boal:jdField_b_of_type_Int	I
    ...
    //   578: ldc 49
    //   580: aload 13
    //   582: getfield 106	boal:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   585: invokevirtual 227	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   588: aload 14
    //   590: ldc 51
    //   592: aload 13
    //   594: getfield 109	boal:jdField_a_of_type_Long	J
    ...
    //   605: ldc 53
    //   607: aload 13
    //   609: getfield 111	boal:jdField_b_of_type_Long	J
    ...
    //   9	351	12	localboag	boag
    //   15	593	13	localboal	boal
  ...
  private void b(long paramLong, boolean paramBoolean)
  {
    ...
    //   34: astore 6
    //   36: aload_0
    //   37: getfield 64	bobc:jdField_a_of_type_Bobd	Lbobd;
    //   40: astore 7
    //   42: iload 5
    //   44: istore_3
    //   45: iload 4
    ...
    //   70: aload 10
    //   72: ldc 162
    //   74: getstatic 57	bobc:b	[Ljava/lang/String;
    //   77: ldc 164
    //   79: iconst_1
    ...
    //   113: aload_0
    //   114: aload 7
    //   116: invokespecial 296	bobc:a	(Landroid/database/Cursor;)Lboak;
    //   119: astore 6
    //   121: aload 7
  ...
  private void b(String paramString)
  {
    ...
    //   15: ifnonnull +15 -> 30
    //   18: aload_0
    //   19: getfield 64	bobc:jdField_a_of_type_Bobd	Lbobd;
    //   22: aload_1
    //   23: aload_2
    ...
    //   77: aload 5
    //   79: ldc 162
    //   81: getstatic 57	bobc:b	[Ljava/lang/String;
    //   84: aload 4
    ...
    //   143: aload_0
    //   144: aload_2
    //   145: invokespecial 296	bobc:a	(Landroid/database/Cursor;)Lboak;
  ...
  public void a(int paramInt, boak paramboak)
  {
    if (paramboak == null) {
      return;
    }
    this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler.sendMessage(Message.obtain(null, 1, paramInt, 0, paramboak));
  }
  ...
  public void a(boak paramboak, boolean paramBoolean)
  {
    if (paramboak == null) {
      return;
    }
    boal localboal = paramboak.b();
    ContentValues localContentValues = new ContentValues();
    localContentValues.put("_id", Long.valueOf(paramboak.a()));
    localContentValues.put("state", Integer.valueOf(localboal.jdField_a_of_type_Int));
    localContentValues.put("error_code", Integer.valueOf(localboal.jdField_b_of_type_Int));
    localContentValues.put("error_msg", localboal.jdField_a_of_type_JavaLangString);
    localContentValues.put("total_size", Long.valueOf(localboal.jdField_a_of_type_Long));
    localContentValues.put("cur_size", Long.valueOf(localboal.jdField_b_of_type_Long));
    if (!TextUtils.isEmpty(localboal.jdField_b_of_type_JavaLangString)) {
      localContentValues.put("local_path", localboal.jdField_b_of_type_JavaLangString);
    }
    if (!TextUtils.isEmpty(paramboak.c())) {
      localContentValues.put("file_version", paramboak.c());
    }
    paramboak = this.jdField_a_of_type_ComTencentWeiyunTransmissionUtilsHandlerReleaseLooperHandler;
    if (paramBoolean) {}
    for (int i = 1;; i = 0)
    {
      paramboak.sendMessage(Message.obtain(null, 2, i, 0, new Object[] { localContentValues, localboal }));
      return;
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    default: 
      return false;
    case 1: 
      b(paramMessage.arg1, (boak)paramMessage.obj);
      return true;
    case 2: 
      ContentValues localContentValues = (ContentValues)((Object[])(Object[])paramMessage.obj)[0];
      boal localboal = (boal)((Object[])(Object[])paramMessage.obj)[1];
      if (paramMessage.arg1 == 1) {
        bool1 = true;
      }
      a(localContentValues, localboal, bool1);
      return true;
    case 3: 
