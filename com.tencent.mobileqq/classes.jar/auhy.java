...
class auhy
{
  ...
  public auhy(auhi paramauhi, View paramView, int paramInt)
  {
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_ComTencentWidgetFixSizeImageView = ((FixSizeImageView)paramView.findViewById(2131362962));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131376639));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370830));
    this.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView = ((DragTextView)paramView.findViewById(2131378649));
    this.b = paramView.findViewById(2131362956);
  }
  ...
  private void a()
  {
    ...
    for (String str = this.jdField_a_of_type_AndroidWidgetTextView.getText().toString();; str = "")
    {
      ...
      for (int i = ((Integer)this.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView.getTag()).intValue();; i = 0)
      {
        ...
        {
          localStringBuilder.append(auhi.a(this.jdField_a_of_type_Auhi).getString(2131719883, new Object[] { str })).append(auhi.a(this.jdField_a_of_type_Auhi).getString(2131690566));
          if (i > 0)
          {
            if (i != 1) {
              break label220;
        ...
        for (;;)
        {
          ...
          if (this.jdField_a_of_type_Int == 2)
          {
            localStringBuilder.append(auhi.a(this.jdField_a_of_type_Auhi).getString(2131719884, new Object[] { str })).append(auhi.a(this.jdField_a_of_type_Auhi).getString(2131690566));
            break;
          }
          localStringBuilder.append(str).append(auhi.a(this.jdField_a_of_type_Auhi).getString(2131690566));
          break;
          label220:
          if (i == 2) {
  ...
  public void b(int paramInt)
  {
    if (paramInt > 0) {
      if (this.jdField_a_of_type_Int == 2)
      {
        bfqb.a(this.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView, 3, paramInt, 2130849292, 99, null);
    ...
    for (;;)
    {
      a();
      return;
      bfqb.a(this.jdField_a_of_type_ComTencentMobileqqActivityRecentCurDragTextView, 3, paramInt, 2130849295, 99, null);
      break;
