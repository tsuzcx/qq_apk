  ...
  extends ViewBase
{
  ...
  public unz(VafContext paramVafContext)
  {
  ...
  {
    this.jdField_a_of_type_AndroidViewView = ((LayoutInflater)this.jdField_a_of_type_AndroidContentContext.getSystemService("layout_inflater")).inflate(2131560096, null);
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369312));
    this.jdField_b_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView = ((NativeReadInjoyImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369313));
  ...
  private void a(View paramView)
  {
    ...
    if ((this.jdField_a_of_type_Qfw != null) && (this.jdField_a_of_type_Qfw.a() != null) && (this.jdField_a_of_type_Qfw.a().a() != null))
    {
      this.jdField_b_of_type_Int = this.jdField_a_of_type_Qfw.a().a().getPaddingTop();
      this.c = this.jdField_a_of_type_Qfw.a().a().getTop();
      if (this.jdField_a_of_type_Int <= 0) {
        this.jdField_a_of_type_Int = this.jdField_a_of_type_Qfw.a().a().getBottom();
      }
    }
    for (;;)
    {
  ...
  private void a(String paramString, Drawable paramDrawable)
  {
    ...
    do
    {
      ...
      if ((paramDrawable != null) && (paramDrawable.getStatus() == 1))
      {
        ...
        this.jdField_a_of_type_Uny = new uny(paramDrawable.getCurrDrawable(), this.d, this.jdField_a_of_type_Int - (this.jdField_b_of_type_Int + this.c));
        this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(this.jdField_a_of_type_Uny);
        this.jdField_a_of_type_JavaLangString = paramString;
        return;
      }
    } while (paramDrawable == null);
    paramDrawable.setURLDrawableListener(new uoa(this, paramString));
  }
  
  private void b()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) {
      if (!uks.h(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))
      {
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, double paramDouble)
  {
    ...
    } while (this.jdField_a_of_type_Uny == null);
    if (this.jdField_a_of_type_Uny.getCallback() == null) {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(this.jdField_a_of_type_Uny);
    }
    ...
    this.jdField_a_of_type_Uny.a(paramInt1, paramInt2);
  }
  ...
  public void a(qfw paramqfw)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo != null) && (uks.h(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructAdvertisementInfo))) {
      c();
    }
  }
  ...
  public void reset()
  {
    ...
    if (this.jdField_a_of_type_Uny != null)
    {
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewImplNativeReadInjoyImageView.setImageDrawable(null);
      this.jdField_a_of_type_Uny.a();
      this.jdField_a_of_type_Uny = null;
    }
  }
