  ...
  extends BusinessHandler
{
  ...
  private amwl jdField_a_of_type_Amwl = new amxo(this);
  private anaa jdField_a_of_type_Anaa = new amxp(this);
  ...
  public amxn(QQAppInterface paramQQAppInterface)
  {
    ...
    this.app.addObserver(this.jdField_a_of_type_Anaa);
    a();
  }
  ...
  private ToServiceMsg a(boolean paramBoolean, long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    localbbln.jdField_a_of_type_Int = paramInt2;
    localbbln.jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    paramString = bblf.a(this.app, 13, paramString, localbbln, paramLong2, bblk.b(paramLong1));
  ...
  public void a()
  {
    Object localObject1 = (amzy)this.app.getBusinessHandler(10);
    if ((((amzy)localObject1).a() != 0) && (((amzy)localObject1).e() == 1))
    {
