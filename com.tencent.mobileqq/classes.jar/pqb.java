  ...
  public HashMap<String, String> a()
  {
    ...
    for (String str = "";; str = this.jdField_a_of_type_JavaLangString)
    {
      ...
      if (this.jdField_a_of_type_Int == 2)
      {
        ...
        localHashMap.put("param_device_info", pza.a(false));
      }
      ...
      localHashMap.put("param_version", "8.2.6.4370");
      localHashMap.put("param_subversion", "8.2.6");
      ...
      localHashMap.put("param_prepareOptimizeConfigJson", obz.j());
      localHashMap.put("param_httpbuffertime_for_playpreload", String.valueOf(bgmq.f()));
      localHashMap.put("param_dynamic_buffer_switch", String.valueOf(bgmq.g()));
      localHashMap.put("param_dynamic_buffer_config_json", bgmq.b());
