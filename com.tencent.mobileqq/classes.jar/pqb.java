...
public abstract class pqb
{
  ...
  public void a()
  {
    ...
    while (localIterator.hasNext()) {
      ((pqa)localIterator.next()).cancel(true);
    }
    this.b.clear();
  ...
  public void b(pqa parampqa)
  {
    if (parampqa == null) {
      return;
    }
    this.b.remove(parampqa);
  }
