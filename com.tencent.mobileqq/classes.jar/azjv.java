...
class azjv
  extends mmm
{
  azjv(azjq paramazjq, azjp paramazjp, String paramString1, String paramString2) {}
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if ((paramInt != 0) || (paramArrayOfByte == null) || (this.jdField_a_of_type_Azjp == null))
    {
      if (QLog.isColorLevel()) {
        QLog.i(".troop.send_gift", 2, "send_oidb_0x6c2. onResult error=" + paramInt + " data=" + paramArrayOfByte + " callback=" + this.jdField_a_of_type_Azjp);
      }
    ...
    try
    {
      ...
      if ((paramInt == 0) && (localRspBody.msg_gift_bag_info.has()))
      {
        ...
        if (paramArrayOfByte != null)
        {
          ...
          this.jdField_a_of_type_Azjq.a.put(paramArrayOfByte, paramBundle);
          this.jdField_a_of_type_Azjq.a(paramBundle);
        }
        this.jdField_a_of_type_Azjp.a(paramBundle);
        return;
      }
    }
    ...
    if ((paramInt == 1) && (localRspBody.int32_player.has()))
    {
      ...
      this.jdField_a_of_type_Azjp.c(paramInt);
      return;
    }
    this.jdField_a_of_type_Azjp.a(-1, "Invalid RspData. subCmd:" + paramInt);
    return;
    label357:
    paramArrayOfByte = localRspBody.bytes_errmsg.get().toStringUtf8();
    this.jdField_a_of_type_Azjp.a(paramInt, paramArrayOfByte);
  }
}
