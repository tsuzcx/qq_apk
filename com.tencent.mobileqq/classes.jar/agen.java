  ...
  implements bfpt
{
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if ((this.a.jdField_a_of_type_Agbo.getCount() <= 0) || (paramInt <= 0)) {}
    do
    {
      return;
      paramAdapterView = (agep)this.a.jdField_a_of_type_Agbo.getItem(paramInt - 1);
    ...
    try
    {
      paramAdapterView = azjx.a(this.a.jdField_a_of_type_ComTencentMobileqqDataMessageRecord.msgData);
