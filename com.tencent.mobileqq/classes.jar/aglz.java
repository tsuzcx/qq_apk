  ...
  extends agmi
{
  ...
  private ahql jdField_a_of_type_Ahql;
  protected Rect a;
  public View a;
  public bhze a;
  public String a;
  ...
  public aglz(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
  ...
  public boolean a(String paramString)
  {
    ...
    localObject = bhmi.a(paramString);
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    this.jdField_a_of_type_Bhze = ((bhze)paramVarArgs[6]);
  ...
  public boolean b()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Ahql = null;
      this.c = agej.a(Long.valueOf(this.jdField_a_of_type_JavaLangString).longValue(), this.jdField_a_of_type_ComTencentWidgetListView.getAdapter());
      localObject = agej.a(agej.a(this.jdField_a_of_type_ComTencentWidgetListView, this.c));
      if ((localObject != null) && ((localObject instanceof ahql))) {
        this.jdField_a_of_type_Ahql = ((ahql)localObject);
      }
      while (this.jdField_a_of_type_Ahql == null)
      {
        a(true);
        return false;
        if (QLog.isColorLevel()) {
      ...
      if (this.jdField_a_of_type_Ahql.a != null)
      {
        localObject = this.jdField_a_of_type_Ahql.a.a();
    ...
    {
      label284:
      m += (int)(this.jdField_a_of_type_Bhze.a * k);
      j += (int)(this.jdField_a_of_type_Bhze.b * i);
      localObject = this.jdField_a_of_type_AndroidGraphicsRect;
      float f = this.jdField_a_of_type_Bhze.c;
      k = (int)(k * f);
      f = this.jdField_a_of_type_Bhze.d;
      ...
      if (this.jdField_a_of_type_AndroidViewView == null)
      {
        this.jdField_a_of_type_Agma = null;
        ...
        localObject = agej.a(agej.a(this.jdField_a_of_type_ComTencentWidgetListView, this.c));
        if ((localObject != null) && ((localObject instanceof agma)))
        {
          this.jdField_a_of_type_Agma = ((agma)localObject);
          label484:
          if (this.jdField_a_of_type_Agma == null) {
            break label587;
          }
          if (this.jdField_b_of_type_AndroidViewView == null) {
            break label642;
          }
          j = this.jdField_a_of_type_Agma.a.getRight() - this.jdField_a_of_type_Agma.a.getLeft();
          i = this.jdField_a_of_type_Agma.a.getBottom() - this.jdField_a_of_type_Agma.a.getTop();
        }
      }
      for (;;)
      {
