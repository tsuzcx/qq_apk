  ...
  implements Manager
{
  ...
  batw jdField_a_of_type_Batw = null;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  protected ArrayList<awnc> a;
    ...
    if (paramBusinessCard != null)
    {
      ...
      if (str != null)
      {
        ...
        if (str.length() != 0)
        {
          ...
          this.jdField_a_of_type_Awbw.b(paramBusinessCard);
          bool1 = bool2;
  ...
  {
    if (paramBusinessCard != null) {
      this.jdField_a_of_type_Awbw.a(paramBusinessCard);
    }
  }
  ...
  {
    List localList = this.jdField_a_of_type_Awbw.a(BusinessCard.class);
  ...
  public void a(ArrayList<awnc> paramArrayList)
  {
  ...
  public void a(List<BusinessCard> paramList, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (paramBoolean) {
        this.jdField_a_of_type_Awbw.a(BusinessCard.class.getSimpleName());
      }
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_Awbw.a(BusinessCard.class);
  }
  ...
  public BusinessCard d(String paramString)
  {
    ...
    BusinessCard localBusinessCard2 = (BusinessCard)this.jdField_a_of_type_Awbw.a(BusinessCard.class, paramString);
