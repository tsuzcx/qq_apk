...
public class bjqw
  implements bjqu, NetworkState.NetworkStateListener
{
  private static bjqw jdField_a_of_type_Bjqw;
  ...
  private bjqt jdField_a_of_type_Bjqt = new bjqt();
  ...
  private bjqw()
  {
    this.jdField_a_of_type_Bjqt.a(this);
    a();
  }
  
  public static bjqw a()
  {
    try
    {
      if (jdField_a_of_type_Bjqw == null) {
        jdField_a_of_type_Bjqw = new bjqw();
      }
      bjqw localbjqw = jdField_a_of_type_Bjqw;
      return localbjqw;
    }
    finally {}
  }
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new bjqx(this, localHandlerThread.getLooper());
    ...
    for (int i = 1;; i = 0)
    {
      if (paramInt2 != 0)
      {
        if ((paramStatReportRequest != null) && (paramStatReportRequest.size() > 0) && (i == 0))
        {
          ...
          while (paramInt2 < i)
          {
            ...
            paramStatReportResponse = bjqj.a().a(String.valueOf(j));
            if (paramStatReportResponse != null) {
              paramStatReportRequest.addAll(paramStatReportResponse);
            }
            bjqj.a().a(String.valueOf(j), paramStatReportRequest);
            paramInt2 += 1;
          }
        }
      }
      else if ((i != 0) && (paramStatReportRequest != null) && (paramStatReportRequest.size() > 0))
      {
        ...
        while (paramStatReportRequest.hasNext())
        {
          ...
          bjqj.a().a(String.valueOf(paramStatReportResponse.type));
        }
      }
