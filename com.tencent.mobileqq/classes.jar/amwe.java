...
@TargetApi(14)
public class amwe
  implements amvh, SurfaceTexture.OnFrameAvailableListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener
{
  ...
  private anfd jdField_a_of_type_Anfd = new amwf(this);
  ...
  public amwe(amvj paramamvj, amwg paramamwg)
  {
    this.jdField_a_of_type_ArrayOfFloat = new float[16];
    this.jdField_a_of_type_Amvj = paramamvj;
    this.jdField_a_of_type_Amwg = paramamwg;
    this.jdField_a_of_type_JavaLangString = paramamwg.jdField_b_of_type_JavaLangString;
    this.jdField_c_of_type_Int = paramamwg.jdField_e_of_type_Int;
    this.jdField_a_of_type_Int = paramamwg.jdField_d_of_type_Int;
    this.jdField_a_of_type_Anff = paramamwg.jdField_a_of_type_Anff;
    paramamvj = Build.MODEL.toLowerCase();
    if ((Build.MANUFACTURER.toLowerCase().contains("meizu")) && (paramamvj.contains("m040"))) {
  ...
  private void g()
  {
    if (this.jdField_a_of_type_Anfc == null)
    {
      ...
      this.jdField_a_of_type_Anfc.a(this.jdField_a_of_type_Amwg.jdField_c_of_type_Int, this.jdField_a_of_type_Amwg.jdField_a_of_type_Float, this.jdField_a_of_type_Amwg.jdField_b_of_type_Float, this.jdField_a_of_type_Amwg.jdField_c_of_type_Float);
    }
  }
  ...
  {
    if ((!this.jdField_e_of_type_Boolean) || (paramArrayOfFloat2 == null) || (paramArrayOfFloat3 == null) || (paramArrayOfFloat4 == null) || (this.jdField_a_of_type_Amwg == null)) {
      return;
    }
    ...
    int j;
    anff localanff;
    if ((this.jdField_a_of_type_Amwg != null) && (this.jdField_a_of_type_Amwg.jdField_b_of_type_Int == 1)) {
      if (this.jdField_a_of_type_Anfc != null)
      {
        paramArrayOfFloat2 = this.jdField_a_of_type_Anfc;
        j = this.jdField_d_of_type_Int;
        localanff = this.jdField_a_of_type_Anff;
        ...
        paramArrayOfFloat2.a(new int[] { j }, localanff, paramArrayOfFloat1, paramArrayOfFloat3);
      }
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Anfc != null)
      {
        paramArrayOfFloat3 = this.jdField_a_of_type_Anfc;
        j = this.jdField_d_of_type_Int;
        localanff = this.jdField_a_of_type_Anff;
        ...
        paramArrayOfFloat3.a(new int[] { j }, localanff, paramArrayOfFloat1, paramArrayOfFloat2);
      }
    }
  }
  ...
  public float[] a(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3)
  {
    ...
    if (c() == 2)
    {
      if (this.jdField_a_of_type_Amwg.jdField_a_of_type_Amzd != null)
      {
        Matrix.scaleM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Amwg.jdField_a_of_type_Amzd.jdField_a_of_type_Float * paramArrayOfFloat1[0], this.jdField_a_of_type_Amwg.jdField_a_of_type_Amzd.jdField_b_of_type_Float * paramArrayOfFloat1[1], 1.0F);
        Matrix.translateM(this.jdField_a_of_type_ArrayOfFloat, 0, this.jdField_a_of_type_Amwg.jdField_a_of_type_Amzd.jdField_c_of_type_Float, this.jdField_a_of_type_Amwg.jdField_a_of_type_Amzd.d, this.jdField_a_of_type_Amwg.jdField_a_of_type_Amzd.e);
      }
      return this.jdField_a_of_type_ArrayOfFloat;
    }
    if (this.jdField_a_of_type_Amwg.jdField_c_of_type_Int == 1) {}
    for (;;)
    {
  ...
  public int b()
  {
    if (this.jdField_a_of_type_Amwg != null) {
      return this.jdField_a_of_type_Amwg.jdField_a_of_type_Int;
    }
    return 2;
  }
  ...
  {
    if (this.jdField_a_of_type_Amwg != null) {
      return this.jdField_a_of_type_Amwg.jdField_b_of_type_Int;
    }
    return 0;
  }
  ...
  public String c()
  {
    return this.jdField_a_of_type_Amwg.jdField_a_of_type_JavaLangString;
  }
  ...
  public void d()
  {
    ...
    //   43: aload_0
    //   44: getfield 376	amwe:jdField_b_of_type_Boolean	Z
    //   47: ifne +20 -> 67
    //   50: aload_0
    //   51: getfield 167	amwe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   54: ifnull +13 -> 67
    //   57: aload_0
    //   58: getfield 167	amwe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    ...
    //   89: aload_0
    //   90: getfield 376	amwe:jdField_b_of_type_Boolean	Z
    ...
    //   102: aload_0
    //   103: getfield 167	amwe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    ...
    //   116: aload_0
    //   117: iconst_0
    //   118: putfield 385	amwe:h	Z
    //   121: aload_0
    //   122: iconst_0
    //   123: putfield 309	amwe:jdField_e_of_type_Boolean	Z
    //   126: new 387	java/io/FileInputStream
    //   129: dup
    //   130: new 153	java/io/File
    //   133: dup
    //   134: aload_0
    //   135: getfield 80	amwe:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   154: astore_2
    //   155: aload_0
    //   156: getfield 167	amwe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   159: aload 4
    ...
    //   166: aload_0
    //   167: iconst_1
    //   168: putfield 248	amwe:jdField_b_of_type_Int	I
    //   171: aload_3
    //   172: astore_2
    //   173: aload_0
    //   174: getfield 167	amwe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   177: astore 4
    //   179: aload_3
    //   180: astore_2
    //   181: aload_0
    //   182: getfield 50	amwe:jdField_c_of_type_Int	I
    //   185: ifne +96 -> 281
    //   188: aload_3
    //   189: astore_2
    //   190: aload 4
    ...
    //   198: aload_0
    //   199: iconst_1
    //   200: putfield 400	amwe:g	Z
    //   203: aload_3
    //   204: astore_2
    //   205: aload_0
    //   206: getfield 167	amwe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   209: invokevirtual 403	android/media/MediaPlayer:prepare	()V
    //   212: aload_3
    //   213: astore_2
    //   214: aload_0
    //   215: iconst_0
    //   216: putfield 405	amwe:f	Z
    //   219: aload_3
    //   220: astore_2
    //   221: aload_0
    //   222: getfield 167	amwe:jdField_a_of_type_AndroidMediaMediaPlayer	Landroid/media/MediaPlayer;
    //   225: invokevirtual 407	android/media/MediaPlayer:start	()V
    //   228: aload_3
    //   229: astore_2
    //   230: aload_0
    //   231: iconst_1
    //   232: putfield 376	amwe:jdField_b_of_type_Boolean	Z
    //   235: aload_3
    //   236: astore_2
    //   237: aload_0
    //   238: getfield 72	amwe:jdField_a_of_type_Amvj	Lamvj;
    //   241: ifnull +19 -> 260
    //   244: aload_3
    //   245: astore_2
    //   246: aload_0
    //   247: getfield 72	amwe:jdField_a_of_type_Amvj	Lamvj;
    //   250: iconst_0
    //   251: aload_0
    //   252: getfield 50	amwe:jdField_c_of_type_Int	I
    ...
    //   338: astore_2
    //   339: aload_0
    //   340: invokevirtual 420	amwe:f	()V
    //   343: aload_3
    //   344: ifnull -229 -> 115
    //   347: aload_3
    ...
    //   416: astore_2
    //   417: aload_0
    //   418: invokevirtual 420	amwe:f	()V
    //   421: aload_3
    //   422: ifnull -307 -> 115
    //   425: aload_3
  ...
  public void onCompletion(MediaPlayer paramMediaPlayer)
  {
    ...
    if (this.jdField_a_of_type_Amvj != null) {
      this.jdField_a_of_type_Amvj.b(2, this.jdField_c_of_type_Int - this.jdField_b_of_type_Int);
    }
  ...
  public boolean onError(MediaPlayer paramMediaPlayer, int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Amvj != null) {
      this.jdField_a_of_type_Amvj.a(this.jdField_a_of_type_Amwg.jdField_a_of_type_JavaLangString);
    }
    ...
    paramMediaPlayer.put("url", this.jdField_a_of_type_Amwg.jdField_a_of_type_JavaLangString);
    azri.a(BaseApplicationImpl.getContext()).a("", "immersed_ar_on_error", true, 0L, 0L, paramMediaPlayer, "", false);
    f();
    return false;
  }
