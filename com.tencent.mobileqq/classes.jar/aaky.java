...
{
  public aaky(AuthDevActivity paramAuthDevActivity) {}
  ...
  public void OnCheckDevLockSms(WUserSigInfo paramWUserSigInfo, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    do
    {
      ...
      paramWUserSigInfo = (akgd)this.a.app.a(34);
      if (paramWUserSigInfo != null) {
        paramWUserSigInfo.a();
      }
  ...
  public void OnCloseDevLock(WUserSigInfo paramWUserSigInfo, int paramInt, ErrMsg paramErrMsg)
  {
    ...
    if (paramInt == 0)
    {
      ...
      AuthDevActivity.a(this.a).setVisibility(8);
      aoes.a().a(this.a.app, this.a, this.a.app.getCurrentAccountUin(), false);
      bcql.a(this.a.getApplicationContext(), 2, this.a.getString(2131692109), 0).b(this.a.getTitleBarHeight());
      paramWUserSigInfo = this.a.app.getHandler(LoginInfoActivity.class);
      if (paramWUserSigInfo != null) {
    ...
    bcql.a(this.a.getApplicationContext(), 1, this.a.getString(2131692108), 0).b(this.a.getTitleBarHeight());
  }
}
