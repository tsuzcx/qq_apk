  ...
  extends lli
{
  ...
  private Queue<llf> jdField_a_of_type_JavaUtilQueue = new LinkedList();
  ...
  public void a()
  {
    this.jdField_a_of_type_JavaUtilQueue.offer(new llf(this, this.jdField_a_of_type_AndroidGraphicsPathMeasure.getLength()));
  }
  ...
  public void b(Canvas paramCanvas, MySurfaceView paramMySurfaceView, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      if ((paramBoolean) && (this.jdField_a_of_type_JavaUtilQueue.size() > 0))
      {
        ...
        localllf = (llf)((LinkedList)this.jdField_a_of_type_JavaUtilQueue).getLast();
        ...
        for (;;)
        {
          ...
          paramMySurfaceView = (llf)localIterator.next();
          localObject2 = paramMySurfaceView;
        ...
        continue;
        f2 = localllf.jdField_a_of_type_Float;
        if (localObject2 == null) {
          break label683;
        }
        if ((localObject1 != null) && (localObject1 != localObject2)) {
          f1 = (((llf)localObject1).jdField_a_of_type_Float * (float)(((llf)localObject2).jdField_a_of_type_Long - l) + ((llf)localObject2).jdField_a_of_type_Float * (float)(l - ((llf)localObject1).jdField_a_of_type_Long)) / (float)(((llf)localObject2).jdField_a_of_type_Long - ((llf)localObject1).jdField_a_of_type_Long);
        }
      }
    }
    for (;;)
    {
      float f3 = 0.01481482F * this.c * (float)(localllf.jdField_a_of_type_Long - l) / 500.0F;
      f4 /= 2.0F;
      ...
      for (;;)
      {
        if (f1 <= localllf.jdField_a_of_type_Float)
        {
          ...
          f1 += f7;
          continue;
          f1 = ((llf)localObject2).jdField_a_of_type_Float;
          break;
        }
      }
