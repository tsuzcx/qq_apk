  ...
  implements bjiz
{
  ...
  private bjjg jdField_a_of_type_Bjjg;
  
  public bjjf(bjja parambjja)
  {
    bjix localbjix = parambjja.a;
    if (localbjix != null) {
      localbjix.setNetTransportEventListener("sig_check", this);
    }
    this.jdField_a_of_type_Bjja = parambjja;
  }
  
  public void a(bjjg parambjjg)
  {
    this.jdField_a_of_type_Bjjg = parambjjg;
  }
  
  public void a(Object paramObject1, Object paramObject2)
  {
    if (this.jdField_a_of_type_Bjjg == null) {}
    label7:
    do
    {
      do
      {
        do
        {
          ...
          {
            return;
          } while (this.jdField_a_of_type_Bjja == null);
          paramObject1 = this.jdField_a_of_type_Bjja.a;
    ...
    try
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Bjjg.a(paramObject1.toString());
        return;
      }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        l2 = l1;
        continue;
        localObject2 = this.jdField_a_of_type_Bjja.a;
        if (localObject2 == null) {
          continue;
        }
        localObject1 = paramString.toByteArray();
        localObject4 = ((bjix)localObject2).getCodec("sig_check");
        paramString = (String)localObject1;
        if (localObject4 != null) {
          paramString = ((bjiy)localObject4).encode(localObject1);
        }
        ((bjix)localObject2).send(paramString);
        return;
      }
      try
      {
