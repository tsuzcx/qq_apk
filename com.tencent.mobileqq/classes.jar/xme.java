  ...
  extends WebViewPlugin
{
  ...
  static
  {
    jdField_a_of_type_JavaLangString = xme.class.getSimpleName();
  }
  ...
  public boolean handleEvent(String paramString, long paramLong, Map<String, Object> paramMap)
  {
    if ((paramLong == 8589934601L) && (this.b != null) && (!"".equals(this.b)))
    {
      ...
      if ("com.tencent.mobileqq.opencenter.vipInfo".equals(this.b))
      {
        ...
        if ((paramMap != null) && ((paramMap instanceof bchx))) {
          paramString.putExtra("key_pay_action_result", ((bchx)paramMap).e());
        }
      }
