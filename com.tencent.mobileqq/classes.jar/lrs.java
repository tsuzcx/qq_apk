...
{
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new lrt(this);
  ...
  private void a(View paramView)
  {
    ...
    ((Activity)localObject).findViewById(2131306534).setVisibility(0);
    paramView = (TextView)((Activity)localObject).findViewById(2131306536);
    localObject = (TextView)((Activity)localObject).findViewById(2131306535);
    ...
    String str1 = lba.a(this.jdField_a_of_type_AndroidContentContext);
    str2 = str2 + "\n----------\n";
    str1 = str2 + a(str1);
    paramView.setText(i + "|" + lll.a().a("load"));
  ...
  {
    Object localObject = (Activity)this.jdField_a_of_type_AndroidContentContext;
    View localView = ((Activity)localObject).findViewById(2131306533);
    if (localView != null)
    {
      localView.setOnClickListener(this);
      localView.setVisibility(0);
    }
    localView = ((Activity)localObject).findViewById(2131306535);
    if (localView != null) {
      localView.setOnClickListener(this);
    }
    localObject = ((Activity)localObject).findViewById(2131306534);
    if (localObject != null) {
  ...
  public void onClick(View paramView)
  {
    ...
    ((Activity)this.jdField_a_of_type_AndroidContentContext).findViewById(2131306534).setVisibility(8);
  }
}
