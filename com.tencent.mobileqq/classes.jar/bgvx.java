...
{
  @NonNull
  public static final bgvx a;
  @NonNull
  public static final bgvx b;
  @NonNull
  public static final bgvx c;
  @NonNull
  public static final bgvx d;
  @NonNull
  public static final bgvx e;
  @NonNull
  public static final bgvx f;
  ...
  static
  {
    ...
    c(jdField_a_of_type_Bgvx);
    d(jdField_a_of_type_Bgvx);
    jdField_b_of_type_Bgvx = new bgvx();
    b(jdField_b_of_type_Bgvx);
    d(jdField_b_of_type_Bgvx);
    jdField_c_of_type_Bgvx = new bgvx();
    a(jdField_c_of_type_Bgvx);
    d(jdField_c_of_type_Bgvx);
    d = new bgvx();
    c(d);
    e(d);
    e = new bgvx();
  ...
  private static void a(bgvx parambgvx)
  {
    parambgvx.jdField_b_of_type_ArrayOfFloat[1] = 0.26F;
    parambgvx.jdField_b_of_type_ArrayOfFloat[2] = 0.45F;
  }
  ...
  private static void b(bgvx parambgvx)
  {
    parambgvx.jdField_b_of_type_ArrayOfFloat[0] = 0.3F;
    parambgvx.jdField_b_of_type_ArrayOfFloat[1] = 0.5F;
    parambgvx.jdField_b_of_type_ArrayOfFloat[2] = 0.7F;
  }
  
  private static void c(bgvx parambgvx)
  {
    parambgvx.jdField_b_of_type_ArrayOfFloat[0] = 0.55F;
    parambgvx.jdField_b_of_type_ArrayOfFloat[1] = 0.74F;
  }
  
  private static void d(bgvx parambgvx)
  {
    parambgvx.jdField_a_of_type_ArrayOfFloat[0] = 0.35F;
    parambgvx.jdField_a_of_type_ArrayOfFloat[1] = 1.0F;
  }
  
  private static void e(bgvx parambgvx)
  {
    parambgvx.jdField_a_of_type_ArrayOfFloat[1] = 0.3F;
    parambgvx.jdField_a_of_type_ArrayOfFloat[2] = 0.4F;
  }
