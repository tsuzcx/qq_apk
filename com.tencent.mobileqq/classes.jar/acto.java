  ...
  implements Manager
{
  ...
  public acto(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b(MessageRecord paramMessageRecord, AppGuideTipsConfig paramAppGuideTipsConfig)
  {
    ...
    paramMessageRecord = new aqvb(str, (String)localObject, paramAppGuideTipsConfig.tipsMsg, paramMessageRecord.istroop, -5022, 2621441, l);
    ...
    aqvc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (MessageForUniteGrayTip)localObject);
  }
  ...
  public void a(BaseChatPie paramBaseChatPie, MessageRecord paramMessageRecord)
  {
    ...
    label22:
    while (amnr.a(paramMessageRecord)) {
      return;
    }
    ...
    for (;;)
    {
      ...
      axqy.b(null, "dc00898", "", "", "0X8008947", "0X8008947", 0, 0, "", "", "", "");
      return;
      localAppGuideTipsConfig.allow = false;
      break label92;
      label277:
  ...
  public void a(java.util.List<AppGuideTipsConfig> paramList)
  {
    ...
    //   15: astore_3
    //   16: aload_0
    //   17: getfield 50	acto:jdField_a_of_type_Aukp	Laukp;
    //   20: invokevirtual 402	aukp:a	()Laukr;
    //   23: astore 4
    //   25: aload 4
    //   27: astore_3
    //   28: aload_3
    //   29: invokevirtual 406	aukr:a	()V
    //   32: aload_0
    //   33: getfield 32	acto:jdField_a_of_type_JavaUtilMap	Ljava/util/Map;
    //   36: invokeinterface 409 1 0
    //   41: aload_0
    //   42: iconst_0
    //   43: putfield 93	acto:jdField_a_of_type_Boolean	Z
    //   46: iconst_0
    //   47: istore_2
    //   48: iload_2
    //   49: aload_1
    ...
    //   58: aload_1
    //   59: iload_2
    //   60: invokeinterface 412 2 0
    //   65: checkcast 95	com/tencent/mobileqq/data/AppGuideTipsConfig
    //   68: astore 4
    //   70: aload 4
    //   72: ifnull +234 -> 306
    //   75: aload_0
    //   76: getfield 50	acto:jdField_a_of_type_Aukp	Laukp;
    //   79: ldc 95
    //   81: aload 4
    //   83: getfield 387	com/tencent/mobileqq/data/AppGuideTipsConfig:tipsType	Ljava/lang/String;
    //   86: invokevirtual 415	aukp:a	(Ljava/lang/Class;Ljava/lang/String;)Lauko;
    //   89: checkcast 95	com/tencent/mobileqq/data/AppGuideTipsConfig
    //   92: astore 5
    //   94: aload 5
    //   96: ifnull +210 -> 306
    //   99: aload 4
    //   101: aload 5
    //   103: getfield 256	com/tencent/mobileqq/data/AppGuideTipsConfig:addCount	I
    //   106: putfield 256	com/tencent/mobileqq/data/AppGuideTipsConfig:addCount	I
    //   109: aload 4
    //   111: aload 5
    //   113: getfield 248	com/tencent/mobileqq/data/AppGuideTipsConfig:lastAddTime	J
    //   116: putfield 248	com/tencent/mobileqq/data/AppGuideTipsConfig:lastAddTime	J
    //   119: goto +187 -> 306
    //   122: new 95	com/tencent/mobileqq/data/AppGuideTipsConfig
    //   125: dup
    //   126: invokespecial 416	com/tencent/mobileqq/data/AppGuideTipsConfig:<init>	()V
    //   129: astore 4
    //   131: aload 4
    //   133: sipush 1001
    //   136: invokevirtual 419	com/tencent/mobileqq/data/AppGuideTipsConfig:setStatus	(I)V
    //   139: aload_0
    //   140: getfield 50	acto:jdField_a_of_type_Aukp	Laukp;
    //   143: aload 4
    //   145: ldc_w 421
    //   148: iconst_1
    //   149: anewarray 103	java/lang/String
    //   152: dup
    //   153: iconst_0
    //   154: ldc 238
    //   156: aastore
    //   157: invokevirtual 424	aukp:a	(Lauko;Ljava/lang/String;[Ljava/lang/String;)Z
    //   160: pop
    //   161: iconst_0
    //   162: istore_2
    //   163: iload_2
    //   164: aload_1
    //   165: invokeinterface 397 1 0
    //   170: if_icmpge +30 -> 200
    //   173: aload_1
    //   174: iload_2
    //   175: invokeinterface 412 2 0
    //   180: checkcast 95	com/tencent/mobileqq/data/AppGuideTipsConfig
    //   183: astore 4
    //   185: aload 4
    //   187: ifnull +126 -> 313
    //   190: aload_0
    //   191: aload 4
    //   193: invokevirtual 382	acto:a	(Lauko;)Z
    //   196: pop
    //   197: goto +116 -> 313
    //   200: aload_3
    //   201: invokevirtual 425	aukr:c	()V
    //   204: aload_3
    //   205: ifnull -192 -> 13
    //   208: aload_3
    //   209: invokevirtual 427	aukr:b	()V
    //   212: return
    //   213: astore 4
    //   215: aload_3
    //   216: astore_1
    ...
    //   219: astore_3
    //   220: aload_3
    //   221: invokevirtual 362	java/lang/Exception:printStackTrace	()V
    //   224: invokestatic 193	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   227: ifeq +33 -> 260
    //   230: getstatic 22	acto:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   233: iconst_2
    ...
    //   247: aload_3
    //   248: invokevirtual 432	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   251: invokevirtual 202	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   254: invokevirtual 208	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   257: invokestatic 435	com/tencent/qphone/base/util/QLog:w	(Ljava/lang/String;ILjava/lang/String;)V
    //   260: aload_1
    //   261: ifnull -248 -> 13
    //   264: aload_1
    //   265: invokevirtual 427	aukr:b	()V
    //   268: return
    //   269: astore_1
    //   270: aconst_null
    //   271: astore_3
    ...
    //   273: ifnull +7 -> 280
    //   276: aload_3
    //   277: invokevirtual 427	aukr:b	()V
    //   280: aload_1
    //   281: athrow
    //   282: astore_1
    //   283: goto -11 -> 272
