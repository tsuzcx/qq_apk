...
public class ltc
  implements Handler.Callback, lti
{
  public int a;
  public Handler a;
  ...
  public ltc(VideoAppInterface paramVideoAppInterface, AVActivity paramAVActivity)
  {
  ...
  {
    ViewGroup localViewGroup = (ViewGroup)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131365646);
    Object localObject1 = null;
    Object localObject2;
    View localView;
    if (localViewGroup != null)
    {
      localObject2 = (RedPacketGameView)localViewGroup.findViewById(2131373447);
      ...
      if (localObject2 == null)
      {
        ...
        localView = localViewGroup.findViewById(2131373414);
        if (localView == null) {
          break label128;
        }
      }
  ...
  {
    ViewGroup localViewGroup = (ViewGroup)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131365646);
    RedPacketGameView localRedPacketGameView = (RedPacketGameView)localViewGroup.findViewById(2131373447);
  ...
  public void a(int paramInt)
  {
    ...
    c();
    RedPacketGameView localRedPacketGameView = (RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131373447);
  ...
  public void a(int paramInt, ltj paramltj)
  {
    if (QLog.isColorLevel()) {
    ...
    catch (Exception paramltj)
    {
      if (QLog.isColorLevel()) {
        QLog.d("AVRedPacketManager", 2, "AVRedPacketGameControl.preLoadRes  exception", paramltj);
      }
    }
  }
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    {
      return;
      localRedPacketGameView = (RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131373447);
  ...
  public boolean a()
  {
    Object localObject = (RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131373447);
  ...
  public void b()
  {
    ...
    ((RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131373447)).d();
  }
  ...
  public void b(AVRedPacketManager.LocalFrameSyncInfo paramLocalFrameSyncInfo)
  {
    ...
    ((RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131373447)).b(paramLocalFrameSyncInfo);
  }
