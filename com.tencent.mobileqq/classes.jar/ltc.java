...
public class ltc
{
  ...
  /* Error */
  public static List<ltd> a(java.lang.String paramString1, java.lang.String paramString2)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 11
    ...
    //   317: new 158	ltd
    //   320: dup
    //   321: invokespecial 159	ltd:<init>	()V
    //   324: astore 4
    //   326: aload_1
    //   327: iload_2
    ...
    //   346: putfield 176	ltd:expressionID	Ljava/lang/String;
    //   349: aload 5
    ...
    //   376: putfield 183	ltd:expressionFeat	Ljava/util/List;
    //   379: iconst_0
    //   380: istore_3
    //   381: iload_3
    //   382: aload 6
    ...
    //   392: aload 4
    //   394: getfield 183	ltd:expressionFeat	Ljava/util/List;
    ...
    //   705: d2f
    //   706: fastore
    //   707: invokestatic 238	ltc:a	([F)[F
    //   710: putfield 242	ltd:expressionAngle	[F
    //   713: aload 5
    ...
    //   743: bipush 7
    //   745: newarray double
    //   747: putfield 248	ltd:expressionWeight	[D
    //   750: iconst_0
    //   751: istore_3
    //   752: iload_3
    //   753: bipush 7
    ...
    //   758: aload 4
    //   760: getfield 248	ltd:expressionWeight	[D
    //   763: iload_3
    //   764: aload 6
    //   766: iload_3
    ...
    //   775: goto -23 -> 752
    //   778: aload 4
    //   780: getstatic 18	ltc:a	[D
    //   783: putfield 248	ltd:expressionWeight	[D
    //   786: aload 5
    //   788: ldc 250
    ...
    //   811: iconst_3
    //   812: newarray int
    //   814: putfield 253	ltd:a	[I
    //   817: aload 4
    //   819: getfield 253	ltd:a	[I
    //   822: iconst_0
    //   823: aload 6
    //   825: iconst_0
  ...
  public static lte a(ltd paramltd, List<PointF> paramList, float[] paramArrayOfFloat)
  {
    lte locallte = new lte();
    Object localObject = paramltd.expressionFeat;
    float[] arrayOfFloat = paramltd.expressionAngle;
    double[] arrayOfDouble = paramltd.expressionWeight;
    int[] arrayOfInt = paramltd.a;
    ...
    if (paramList.size() == 83) {
      paramltd = FaceDetectUtil.facePointf83to90(paramList);
    }
    List localList = FaceOffUtil.getFullCoords(paramltd, 2.0F);
    if ((localList.size() < 106) || (((List)localObject).size() < 106)) {
      return locallte;
    }
    paramltd = new ArrayList(((List)localObject).size());
    ...
    {
      paramltd.add(new PointF(((PointF)((List)localObject).get(i)).x / f1, ((PointF)((List)localObject).get(i)).y / f2));
      paramList.add(new PointF(((PointF)localList.get(i)).x / f3, ((PointF)localList.get(i)).y / f4));
      i += 1;
    }
    localObject = new float[7];
    float f9 = a((PointF)paramltd.get(37), (PointF)paramltd.get(41)) / a((PointF)paramltd.get(35), (PointF)paramltd.get(39));
    ...
    for (f1 = (f6 - f9) / 4 + f9;; f1 = f6)
    {
      ...
      float f10 = a((PointF)paramltd.get(47), (PointF)paramltd.get(51)) / a((PointF)paramltd.get(45), (PointF)paramltd.get(49));
      ...
      for (f2 = (f7 - f10) / 4 + f10;; f2 = f7)
      {
        ...
        float f11 = a((PointF)paramltd.get(73), (PointF)paramltd.get(81)) / a((PointF)paramltd.get(65), (PointF)paramltd.get(66));
        ...
        for (f3 = (f8 - f11) / 4 + f11;; f3 = f8)
        {
          ...
          f4 = (((PointF)paramltd.get(44)).x - ((PointF)paramltd.get(35)).x) / (((PointF)paramltd.get(39)).x - ((PointF)paramltd.get(35)).x);
          float f5 = (((PointF)paramltd.get(54)).x - ((PointF)paramltd.get(45)).x) / (((PointF)paramltd.get(49)).x - ((PointF)paramltd.get(45)).x);
          ...
          f5 = 0.0F;
          f4 = 0.0F;
          paramltd = new StringBuilder("Score:");
          ...
          while (i < 7)
          {
            ...
            paramltd.append("[").append(localObject[i]).append("]");
            paramList.append("[").append(arrayOfDouble[i]).append("]");
            i += 1;
          }
          f4 = f5 / f4;
          if (QLog.isColorLevel()) {
            QLog.d("AVActUtil", 2, "raymond__ getExpressionSimilarity2 ,totalScore = " + 100.0F * f4 + "," + paramltd.toString() + paramList.toString());
          }
          if (QLog.isColorLevel())
          {
  ...
  public static boolean a(float paramFloat, double[] paramArrayOfDouble, int[] paramArrayOfInt, ltd paramltd, List<PointF> paramList, float[] paramArrayOfFloat)
  {
    boolean bool = false;
    paramltd.expressionWeight = paramArrayOfDouble;
    paramltd.a = paramArrayOfInt;
    float f = a(paramltd, paramList, paramArrayOfFloat).a;
    if (f > paramFloat) {
      bool = true;
    }
    if (QLog.isColorLevel()) {
  ...
  public static boolean a(lte paramlte)
  {
    boolean bool = false;
    if ((paramlte.b < paramlte.c) && (paramlte.c - paramlte.b > 0.05D)) {
      if (paramlte.d <= paramlte.e) {
        break label118;
      }
    }
    for (;;)
    {
      ...
      return bool;
      if ((paramlte.b <= paramlte.c) || (paramlte.b - paramlte.c <= 0.05D) || (paramlte.d >= paramlte.e)) {
        label118:
        bool = true;
      }
    }
