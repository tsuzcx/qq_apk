...
public class axje
{
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (!paramString.equals("")) {
          paramContext = new BitmapDrawable(apvb.a(axgw.a() + paramString + ".png"));
        }
      }
    }
  }
  
  public static avsp a(avsp paramavsp)
  {
    if ((!c()) || (!b())) {}
    for (int i = 1; i == 0; i = 0) {
      return paramavsp;
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    bbjn.a(BaseApplicationImpl.getApplication().getSharedPreferences("GestureRecognitionUtils", 4).edit().putBoolean("shared_gesture_recognize_result", paramBoolean));
  }
