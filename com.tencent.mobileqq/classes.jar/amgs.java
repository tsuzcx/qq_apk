...
public class amgs
{
  ...
  public static Bundle a(int paramInt1, String paramString, boolean paramBoolean, int paramInt2)
  {
    ...
    if (BaseApplicationImpl.sProcessId == 1)
    {
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        localBundle.putBoolean("extra_after_sync_msg", amkg.a());
        localObject = amkg.a(paramString);
        ...
        amkg.a(paramString.getApp(), 3, true);
        return localBundle;
        paramInt1 = 1;
        break;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, akte paramakte)
  {
    amgv.a(paramQQAppInterface.a().a().a(paramQQAppInterface.getCurrentAccountUin(), paramakte));
  }
  ...
  private static void a(ColorNote paramColorNote)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if ((((amhf)localObject).a()) || (i != 0) || (paramColorNote.getServiceType() == 16973824))
      {
        ((amhf)localObject).a(localQQAppInterface.c(), paramColorNote, null, false);
        if (QLog.isColorLevel()) {
          QLog.d("ColorNoteHelper", 2, "addColorNoteInner~~~ " + paramColorNote);
        }
        if (paramColorNote.mExtra != 2)
        {
          localObject = bbjn.a(BaseApplicationImpl.getContext(), localQQAppInterface.c());
      ...
      QLog.d("ColorNoteHelper", 2, "addColorNoteInner~~~ fail cause count limit, maxCount = " + amhf.a + " , currCount = " + ((amhf)localObject).a());
      return;
    }
  }
  ...
  protected static void a(String paramString, int paramInt)
  {
    ...
    paramString = ((amhf)localObject1).a(paramString, paramInt);
    if (paramString == null) {}
    do
    {
      return;
      ((amhf)localObject1).c(((QQAppInterface)localObject2).c(), paramString, null);
      amkg.a(((QQAppInterface)localObject2).getApp(), 3, false);
      ...
      localIntent.putExtra("extra_can_add_colornote", ((amhf)localObject1).a());
      localIntent.putExtras(paramString.parseBundle());
      BaseApplicationImpl.getContext().sendBroadcast(localIntent);
      localObject1 = new ArrayList();
      ((ArrayList)localObject1).add(paramString);
      amgv.a((ArrayList)localObject1);
  ...
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
    amhf localamhf = localQQAppInterface.a().a();
    amkg.a(localQQAppInterface.getApp(), true, false);
    return localamhf.a(localQQAppInterface.c(), paramColorNote);
  }
}
