...
public class amgs
{
  ...
  private SurfaceHolder.Callback jdField_a_of_type_AndroidViewSurfaceHolder$Callback = new amgt(this);
  public SurfaceView a;
  
  public amgs(Context paramContext, int paramInt)
  {
  ...
  AVVideoCtrl a()
  {
    AVContext localAVContext = anai.a(this.jdField_a_of_type_AndroidContentContext).a();
