...
class ozf
  extends mxj
{
  ozf(oze paramoze, ozh paramozh) {}
  
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    if (QLog.isColorLevel()) {
      QLog.d(oze.a, 2, "getAtlasFavoriteStatus onResult, errorCode=" + paramInt);
    }
    ...
    for (;;)
    {
      ...
      catch (Exception paramArrayOfByte)
      {
        if (this.jdField_a_of_type_Ozh != null) {
          this.jdField_a_of_type_Ozh.a(false, null, false, null);
        }
        QLog.e(oze.a, 1, "getAtlasFavoriteStatus onResult(), exception=" + paramArrayOfByte.toString());
      }
      boolean bool = false;
      continue;
      label242:
      if (this.jdField_a_of_type_Ozh != null) {
        this.jdField_a_of_type_Ozh.a(true, paramBundle, bool, localArrayList);
      }
    }
  }
}
