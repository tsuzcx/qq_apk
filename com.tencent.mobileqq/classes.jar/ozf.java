  ...
  implements pgb
{
  ...
  private static ozf jdField_a_of_type_Ozf;
  ...
  private Map<Pair<Long, Pair<View, BaseArticleInfo>>, Long> jdField_a_of_type_JavaUtilMap = new TreeMap(new ozg(this));
  private ozj jdField_a_of_type_Ozj;
  ...
  static
  {
    ...
    jdField_b_of_type_JavaUtilMap = new TreeMap(new ozh());
  }
  ...
  {
    return sel.a(paramArticleInfo, paramInt);
  }
  ...
  private static String a(ArticleInfo paramArticleInfo, int paramInt)
  {
    ...
    for (paramInt = 1; (!oyj.a(i1)) && (paramInt == 0); paramInt = 0) {
      return "";
    }
    if (paramInt == 0) {}
  ...
  public static List<BaseArticleInfo> a(String paramString)
  {
    ...
    catch (JSONException paramString)
    {
      for (;;)
      {
        ...
        if (i2 == 1)
        {
          ...
          localObject1 = qfn.a((articlesummary.ArticleSummary)((oidb_cmd0x68b.RspGetFollowTabFeeds)localObject3).msg_article_summary.get(), 70, 0, null);
              ...
              if (((articlesummary.FeedsInfo)((articlesummary.ArticleSummary)localObject3).msg_feeds_info.get()).msg_pos_ad_info.has())
              {
                ...
                if (localObject2 != null)
                {
                  ...
                  if (((articlesummary.PosAdInfo)localObject2).int32_ret.get() == 0)
                  {
                    ...
                    qfn.a((articlesummary.ArticleSummary)localObject3, 0, 0, paramString);
    ...
    if ((localIterator != null) && (localIterator.hasNext()))
    {
      ...
      for (;;)
      {
        localObject2 = bhkv.decode(paramString.getBytes(), 0);
        i2 = localObject2[0];
        localObject1 = null;
        if (i2 != 0) {
          break;
        ...
        paramString = qfn.a(paramString, 0, 0, null);
  ...
  public static ozf a()
  {
    if (jdField_a_of_type_Ozf == null) {}
    try
    {
      if (jdField_a_of_type_Ozf == null) {
        jdField_a_of_type_Ozf = new ozf();
      }
      return jdField_a_of_type_Ozf;
    }
    finally {}
  }
  ...
  private void a(List<BaseArticleInfo> paramList)
  {
    ...
    for (;;)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        {
          localBaseArticleInfo.articleViewModel = tbm.a(localBaseArticleInfo);
  ...
  {
    paramArticleInfo = sel.a(paramArticleInfo, paramInt);
  ...
  private static String c(String paramString)
  {
    try
    {
      ...
      for (;;)
      {
        ...
        paramString = nnr.a(BaseApplicationImpl.getContext(), str, "GET", localBundle, a());
        if (paramString != null) {
          break;
        }
        return "";
    ...
    if ((paramString != null) && (Integer.parseInt(paramString.getString(d)) > 0))
    {
      ...
      bnrf.a(d, Integer.valueOf(jdField_a_of_type_Int));
  ...
  private void c()
  {
    jdField_a_of_type_Int = ((Integer)bnrf.a(d, Integer.valueOf(0))).intValue();
    QLog.d(jdField_b_of_type_JavaLangString, 2, "local version " + jdField_a_of_type_Int);
    try
    {
      jdField_a_of_type_OrgJsonJSONObject = new JSONObject((String)bnrf.a(f, ""));
      jdField_b_of_type_OrgJsonJSONObject = new JSONObject((String)bnrf.a(g, ""));
      jdField_c_of_type_OrgJsonJSONObject = new JSONObject((String)bnrf.a(e, ""));
      return;
    }
  ...
  private static void e()
  {
    ...
    {
      return;
      bnrf.a(f, jdField_a_of_type_OrgJsonJSONObject.toString());
    } while ((jdField_c_of_type_OrgJsonJSONObject == null) || (jdField_c_of_type_OrgJsonJSONObject.length() == 0));
    bnrf.a(e, jdField_c_of_type_OrgJsonJSONObject.toString());
  }
  
  private static String f()
  {
    Object localObject2 = sel.a();
    if (localObject2 == null)
    {
    ...
    if (localObject1 != null)
    {
      ...
      localObject2 = new ozi((TicketManager)localObject1, (QQAppInterface)localObject2);
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Ozj == null) {
      return;
    }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i1 < i2)
        {
          ...
          localObject = new String(bhkv.encode(arrayOfByte, 0));
  ...
  public void a(ozj paramozj)
  {
    this.jdField_a_of_type_Ozj = paramozj;
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (a(str))
        {
          ...
          paramArticleSummary = new String(bhkv.encode(paramArticleInfo, 0));
          if (jdField_c_of_type_OrgJsonJSONObject != null)
          {
  ...
  public void b()
  {
    this.jdField_a_of_type_Ozj = null;
  }
