  ...
  implements Handler.Callback, Manager
{
  ...
  public bbxu(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Bbxv = new bbxv(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
  }
  
  private void a(bbxt parambbxt)
  {
    int i = this.jdField_a_of_type_Bbxv.a(parambbxt);
  ...
  private void b(bbxt parambbxt)
  {
    ThreadManager.post(new ScribbleDownloader.1(this, parambbxt), 5, null, false);
  }
  
  private void d()
  {
    if (this.jdField_a_of_type_Bbxv.a() < 2)
    {
      bbxt localbbxt = this.jdField_a_of_type_Bbxv.a();
      if (localbbxt == null)
      {
  ...
  {
    int i = this.jdField_a_of_type_Bbxv.a(paramMessageForScribble);
  ...
  public void a(MessageForScribble paramMessageForScribble)
  {
    ...
    if (a())
    {
      a(new bbxt(paramMessageForScribble, 200));
      return;
    }
  ...
  public void b(MessageForScribble paramMessageForScribble)
  {
    ...
    a(new bbxt(paramMessageForScribble, 201));
  }
