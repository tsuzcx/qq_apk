...
public class uzf
{
  private List<vcf> jdField_a_of_type_JavaUtilList;
  ...
  private boolean a(JceStruct paramJceStruct, String paramString, int paramInt)
  {
    ...
    {
      vmp.d("WeiShiCacheManager", paramJceStruct + ", cache list size = " + paramInt + ", bytes length = " + arrayOfByte.length);
      return bool;
    }
  }
  ...
  private String d()
  {
    return BaseApplicationImpl.getApplication().getCacheDir().getAbsolutePath() + "/file/weishi/ws_follow_data_" + vnd.a();
  }
  ...
  {
    ThreadManager.post(new WeiShiCacheManager.1(this, paramuyy), 8, null, true);
  }
  ...
  public boolean a()
  {
    ...
    long l3 = l1 - l2;
    vmp.d("WeiShiCacheManager", "validTimestamp-currentTimestamp = " + l1 + "-" + l2 + " = " + l3);
    return l3 > 0L;
  }
  ...
  public void b(uyy paramuyy)
  {
    ThreadManager.post(new WeiShiCacheManager.2(this, new WeakReference(paramuyy)), 8, null, true);
  }
  ...
  public void c(List<vcf> paramList)
  {
    if (this.jdField_a_of_type_JavaUtilList == null) {
  ...
  public void c(uyy paramuyy)
  {
    ThreadManager.executeOnFileThread(new WeiShiCacheManager.9(this, paramuyy));
  }
}
