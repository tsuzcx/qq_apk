  ...
  implements tcx
{
  ...
  public tct(Activity paramActivity)
  {
  ...
  private static void b(boolean paramBoolean, int paramInt, KandianMsgBoxRedPntInfo paramKandianMsgBoxRedPntInfo)
  {
    ...
    for (;;)
    {
      try
      {
        localpqg.k(1037);
        localpqg.a(0);
        localpqg.a("message_type", String.valueOf(paramKandianMsgBoxRedPntInfo.messageType));
        localpqg.a("feedsid", String.valueOf(paramKandianMsgBoxRedPntInfo.feedsID));
        localpqg.a("feedstype", String.valueOf(paramKandianMsgBoxRedPntInfo.feedsType));
        if (paramKandianMsgBoxRedPntInfo.mMsgType == 2)
        {
          localpqg.a("sys_msg_id", String.valueOf(paramKandianMsgBoxRedPntInfo.sysMsgID));
          localpqg.a("sys_msg_from", String.valueOf(paramKandianMsgBoxRedPntInfo.sysMsgFrom));
        }
        localpqg.a("reddot_num", String.valueOf(paramKandianMsgBoxRedPntInfo.mMsgCnt));
        localpqg.b("msgbox1000000000");
        if (paramBoolean) {
          break label220;
        }
        localpqg.a("behavior_type", String.valueOf(paramInt));
      }
      ...
      olh.a(null, "CliOper", "", String.valueOf(paramKandianMsgBoxRedPntInfo.mUin), str, str, 0, 0, String.valueOf(paramKandianMsgBoxRedPntInfo.mUin), "", "", localpqg.a(), false);
      return;
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setOnClickListener(new tcu(this));
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject2)) {
          localObject1 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131694128);
        }
        localJSONObject.put("msgbox_redpoint_content", new QQText(bcsc.b((String)localObject1), 7, 17));
        ...
        localJSONObject.put("msgbox_redpoint_count", String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131694129), new Object[] { bmhv.b(paramKandianMsgBoxRedPntInfo.mMsgCnt) }));
        ...
        {
          localTemplateBean = ProteusParser.getTemplateBean(tmh.a("default_feeds", true), localJSONObject);
        }
