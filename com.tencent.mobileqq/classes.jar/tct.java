...
class tct
  implements tyi
{
  tct(tcs paramtcs, srq paramsrq) {}
  
  public void a(String paramString, Bitmap paramBitmap)
  {
    paramString = BaseApplicationImpl.getContext();
    Object localObject = new PollContainerLayout(paramString);
    ((PollContainerLayout)localObject).a(this.jdField_a_of_type_Srq, -1, null);
    ...
    if (vlc.a((Bitmap)localObject, paramString)) {
      this.jdField_a_of_type_Tcs.a("result", new File(paramString).toURI().toString());
    }
    for (;;)
    {
      ((Bitmap)localObject).recycle();
      tcs.a(this.jdField_a_of_type_Tcs, true);
      return;
      this.jdField_a_of_type_Tcs.a("result", this.jdField_a_of_type_Tcs.a.mVideoThumbnailUrl);
    }
  }
  ...
  {
    this.jdField_a_of_type_Tcs.a("result", this.jdField_a_of_type_Tcs.a.mVideoThumbnailUrl);
    tcs.b(this.jdField_a_of_type_Tcs, true);
  }
}
