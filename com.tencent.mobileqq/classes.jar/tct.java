  ...
  extends BaseAdapter
{
  ...
  public tct(List<DiandianTopConfig> paramList, int paramInt)
  {
  ...
  public android.view.View getView(int paramInt, android.view.View paramView, android.view.ViewGroup paramViewGroup)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 21	tct:jdField_a_of_type_JavaUtilList	Ljava/util/List;
    //   4: iload_1
    ...
    //   22: dup
    //   23: aconst_null
    //   24: invokespecial 62	tcw:<init>	(Ltck;)V
    //   27: astore 4
    //   29: aload_3
    ...
    //   54: putfield 91	tcw:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   57: aload 4
    //   59: aload_2
    //   60: ldc 92
    //   62: invokevirtual 86	android/view/View:findViewById	(I)Landroid/view/View;
    //   65: checkcast 94	android/widget/TextView
    //   68: putfield 97	tcw:jdField_a_of_type_AndroidWidgetTextView	Landroid/widget/TextView;
    //   71: aload 4
    //   73: aload_2
    //   74: ldc 98
    //   76: invokevirtual 86	android/view/View:findViewById	(I)Landroid/view/View;
    //   79: checkcast 94	android/widget/TextView
    //   82: putfield 101	tcw:b	Landroid/widget/TextView;
    //   85: aload 4
    //   87: aload_2
    //   88: ldc 102
    //   90: invokevirtual 86	android/view/View:findViewById	(I)Landroid/view/View;
    //   93: checkcast 94	android/widget/TextView
    //   96: putfield 105	tcw:c	Landroid/widget/TextView;
    //   99: aload 4
    //   101: new 107	tcv
    //   104: dup
    //   105: aload_0
    //   106: getfield 13	tct:jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewHeadersReadInJoyDiandianHeaderController	Lcom/tencent/biz/pubaccount/readinjoy/view/headers/ReadInJoyDiandianHeaderController;
    //   109: aconst_null
    //   110: invokespecial 110	tcv:<init>	(Lcom/tencent/biz/pubaccount/readinjoy/view/headers/ReadInJoyDiandianHeaderController;Ltck;)V
    //   113: putfield 113	tcw:jdField_a_of_type_Tcv	Ltcv;
    //   116: aload_2
    //   117: aload 4
    //   119: invokevirtual 117	android/view/View:setTag	(Ljava/lang/Object;)V
    //   122: aload_2
    //   123: aload 4
    //   125: getfield 113	tcw:jdField_a_of_type_Tcv	Ltcv;
    //   128: invokevirtual 121	android/view/View:setOnClickListener	(Landroid/view/View$OnClickListener;)V
    //   131: aload 4
    //   133: getfield 113	tcw:jdField_a_of_type_Tcv	Ltcv;
    //   136: aload_0
    //   137: getfield 23	tct:jdField_a_of_type_Int	I
    //   140: iconst_2
    //   141: imul
    //   142: iload_1
    //   143: iadd
    //   144: putfield 122	tcv:jdField_a_of_type_Int	I
    ...
    //   152: aload 6
    //   154: aload_0
    //   155: getfield 13	tct:jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewHeadersReadInJoyDiandianHeaderController	Lcom/tencent/biz/pubaccount/readinjoy/view/headers/ReadInJoyDiandianHeaderController;
    ...
    //   164: aload 6
    //   166: aload_0
    //   167: getfield 13	tct:jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewHeadersReadInJoyDiandianHeaderController	Lcom/tencent/biz/pubaccount/readinjoy/view/headers/ReadInJoyDiandianHeaderController;
    ...
    //   200: ldc 156
    //   202: invokestatic 161	bggq:a	(Landroid/content/Context;F)I
    //   205: aload_2
    //   206: invokevirtual 155	android/view/View:getContext	()Landroid/content/Context;
    //   209: ldc 156
    //   211: invokestatic 161	bggq:a	(Landroid/content/Context;F)I
    //   214: invokestatic 166	bgey:a	(II)[I
    //   217: invokevirtual 167	com/tencent/image/URLDrawable:setTag	(Ljava/lang/Object;)V
    //   220: aload 4
    //   222: getfield 91	tcw:jdField_a_of_type_ComTencentImageURLImageView	Lcom/tencent/image/URLImageView;
    //   225: aload 6
    ...
    //   261: aload 4
    //   263: getfield 97	tcw:jdField_a_of_type_AndroidWidgetTextView	Landroid/widget/TextView;
    //   266: iconst_0
    //   267: invokevirtual 184	android/widget/TextView:setVisibility	(I)V
    //   270: aload 4
    //   272: getfield 101	tcw:b	Landroid/widget/TextView;
    //   275: aload 5
    ...
    //   291: ifne +234 -> 525
    //   294: aload 4
    //   296: getfield 105	tcw:c	Landroid/widget/TextView;
    //   299: aload 5
    ...
    //   310: aload 4
    //   312: getfield 105	tcw:c	Landroid/widget/TextView;
    //   315: aload 5
    ...
    //   323: aload_0
    //   324: getfield 13	tct:jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewHeadersReadInJoyDiandianHeaderController	Lcom/tencent/biz/pubaccount/readinjoy/view/headers/ReadInJoyDiandianHeaderController;
    ...
    //   369: aload_0
    //   370: getfield 13	tct:jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewHeadersReadInJoyDiandianHeaderController	Lcom/tencent/biz/pubaccount/readinjoy/view/headers/ReadInJoyDiandianHeaderController;
    ...
    //   401: iconst_0
    //   402: invokestatic 256	oat:a	(Lcom/tencent/mobileqq/app/QQAppInterface;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    //   405: aload_0
    //   406: getfield 13	tct:jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewHeadersReadInJoyDiandianHeaderController	Lcom/tencent/biz/pubaccount/readinjoy/view/headers/ReadInJoyDiandianHeaderController;
    //   409: iconst_1
    ...
    //   420: aload_0
    //   421: iload_1
    //   422: invokevirtual 267	tct:getItemId	(I)J
    ...
    //   434: checkcast 59	tcw
    //   437: astore 4
    //   439: goto -308 -> 131
    //   442: aload 4
    //   444: getfield 97	tcw:jdField_a_of_type_AndroidWidgetTextView	Landroid/widget/TextView;
    //   447: bipush 8
    ...
    //   508: aload 4
    //   510: getfield 105	tcw:c	Landroid/widget/TextView;
    //   513: ldc_w 294
    ...
    //   522: goto -212 -> 310
    //   525: aload 4
    //   527: getfield 105	tcw:c	Landroid/widget/TextView;
    //   530: ldc_w 294
