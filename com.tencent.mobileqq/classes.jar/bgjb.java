  ...
  implements Closeable
{
  ...
  public bgjb(InputStream paramInputStream, int paramInt, Charset paramCharset)
  {
    ...
    if (!paramCharset.equals(bgiu.jdField_a_of_type_JavaNioCharsetCharset)) {
  ...
  public bgjb(InputStream paramInputStream, Charset paramCharset)
  {
  ...
  public String a()
  {
    ...
    for (;;)
    {
      ...
      for (int j = i - 1;; j = i)
      {
        ...
        return localObject2;
        localObject2 = new bgjc(this, this.b - this.jdField_a_of_type_Int + 80);
        for (;;)
        {
