...
public class ajes
  extends ajet
{
  public ajes(int paramInt, ajfb paramajfb)
  {
    super(paramInt, paramajfb);
  }
  ...
  private aivx b()
  {
    ...
    try
    {
      ...
      localJSONObject.put("is3DBetaTester", ajfj.a(this.jdField_a_of_type_Ajfb.a()));
  ...
  private aivx d(String paramString)
  {
    try
    {
      QLog.d("cmshow_scripted_SpriteActionScript", 1, new Object[] { "handleJsError mSpriteFrom:", Integer.valueOf(this.jdField_a_of_type_Ajfb.e) });
      paramString = new JSONObject(paramString).optString("data");
      ajlq.a(ajfj.b(this.jdField_a_of_type_Ajfb.e), 1000, 50, new Object[] { paramString });
      return null;
    }
    catch (Exception paramString)
    {
  ...
  private aivx f(String paramString)
  {
    try
    {
      ...
      if ((i == ajfj.b(1)) || (i == ajfj.b(2))) {
        ajlq.a(i, null, new int[] { ajlp.a(i, false, this.jdField_a_of_type_Ajfb.jdField_b_of_type_Int, -1, true) });
      }
      ajlq.b(i);
      if ((i == ajfj.b(1)) || (i == ajfj.b(2)))
      {
        ajlq.a(ajfj.b(this.jdField_a_of_type_Ajfb.e), false);
        return null;
      }
    }
    catch (Throwable paramString)
  ...
  private aivx j(String paramString)
  {
    try
    {
      if (this.jdField_a_of_type_Ajfb.e != 0) {
        return null;
      }
      paramString = new JSONObject(paramString).optString("text");
      this.jdField_a_of_type_Ajfg.a().a(paramString);
      return null;
    }
    catch (Throwable paramString)
    {
  ...
  private aivx l(String paramString)
  {
    try
    {
      ...
      this.jdField_a_of_type_Ajfg.a().a(i, j);
      this.jdField_a_of_type_Ajfg.a().a(i);
      return null;
    }
    catch (Throwable paramString)
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if ("pet".equals(paramString.getString("config_name")))
        {
          ...
          airz localairz = (airz)this.jdField_a_of_type_Ajfb.a().getManager(153);
          if (localairz.j == null) {
            break label122;
          }
          paramString = new JSONArray(localairz.j);
  ...
  private aivx p(String paramString)
  {
    ...
    paramString = this.jdField_a_of_type_Ajfb.a();
    if (paramString != null)
    {
      paramString.a();
      return null;
  ...
  private aivx q(String paramString)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_Ajfb.a().a() == null)
      {
    ...
    ApolloUtil.a(this.jdField_a_of_type_Ajfb.a().a(), (String)localObject);
    return null;
    label122:
    ...
    if (i > 0)
    {
      ApolloGameUtil.a(this.jdField_a_of_type_Ajfb.a(), i, 333002, "message", 1);
      return null;
    }
  ...
  public aivx a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localaivx.jdField_b_of_type_Boolean = true;
        JSONObject localJSONObject = new JSONObject();
        if ((1 == localQQAppInterface.c()) && (((this.jdField_a_of_type_Ajfb.jdField_a_of_type_Int != 1) && (this.jdField_a_of_type_Ajfb.jdField_a_of_type_Int != 3000)) || (((1 == localQQAppInterface.a()) || (this.jdField_a_of_type_Ajfb.jdField_a_of_type_Int == 0) || (this.jdField_a_of_type_Ajfb.jdField_a_of_type_Int == -2)) && (!localQQAppInterface.k()) && (!localQQAppInterface.l()) && (localQQAppInterface.m()) && (!MediaPlayerManager.a(localQQAppInterface).a()) && ((localQQAppInterface.a() == null) || (!localQQAppInterface.a().k())) && (!localQQAppInterface.c()))))
        {
  ...
  public aivx a(long paramLong, String paramString1, String paramString2)
  {
    ...
    QQAppInterface localQQAppInterface = a();
    if (localQQAppInterface == null) {}
    while ((localaivb == null) || (localaivb.getLuaState() != paramLong)) {
      return null;
    }
    if ((paramString1.startsWith("apollo_")) && (!paramString1.startsWith("cs.")) && (!paramString1.endsWith(".local")) && (!aivv.a(paramString1)))
    {
      ...
      ((bbqp)localQQAppInterface.a(71)).a(paramString1, paramString2.toString(), paramLong, 4);
      paramString1 = null;
    }
    for (;;)
    {
      ...
      {
        paramString1 = a(paramString2, localaivb.getRenderImpl().a());
      }
      ...
      else
      {
        ...
        {
          if ((ApolloGameUtil.a(localQQAppInterface) == 2) && (this.jdField_a_of_type_Ajfb != null) && (this.jdField_a_of_type_Ajfb.e == 0))
          {
            paramString1 = ((ajmw)localQQAppInterface.getManager(155)).c(3000059);
            if (paramString1 != null)
            {
              ...
              {
                paramString2.jdField_a_of_type_JavaLangString = String.valueOf(this.jdField_a_of_type_Ajfb.a().getCurrentAccountUin());
                ((ajfg)this.jdField_a_of_type_Ajfb.a().getManager(249)).a().a(paramString2);
              }
            }
            paramString1 = null;
          }
    ...
    try
    {
      ...
      if (localajfc != null)
      {
        ...
        if (i < localJSONArray1.length())
        {
          ...
          if (j == 1) {
            localJSONObject2.put("petPath", localajfc.a(new JSONArray(paramString.optString("actionList"))));
          }
          for (;;)
          {
            ...
            i += 1;
            break;
            localObject = localajfc.a((String)localObject);
  ...
  public void a(int paramInt)
  {
    for (;;)
    {
      try
      {
        ...
        ApolloCmdChannel.getChannel(this.jdField_a_of_type_Ajfb.a()).callbackFromRequest(this.jdField_a_of_type_Ajfb.a().getLuaState(), 0, "sc.script_panel_status_change.local", ((JSONObject)localObject).toString());
        localObject = "";
        if (1 == paramInt)
        {
          localObject = "panel_close_clk";
          VipUtils.a(this.jdField_a_of_type_Ajfb.a(), "cmshow", "Apollo", (String)localObject, ApolloUtil.b(this.jdField_a_of_type_Ajfb.jdField_a_of_type_Int), ApolloUtil.h(this.jdField_a_of_type_Ajfb.jdField_b_of_type_Int), new String[] { "", "", "", String.valueOf(System.currentTimeMillis() / 1000L) });
          return;
        }
      }
      catch (Throwable localThrowable)
  ...
  public void a(int paramInt1, int paramInt2)
  {
    try
    {
      ...
      ApolloCmdChannel.getChannel(this.jdField_a_of_type_Ajfb.a()).callbackFromRequest(this.jdField_a_of_type_Ajfb.a().getLuaState(), 0, "sc.script_draw_area_change.local", localJSONObject.toString());
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString, int paramInt5)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Object localObject1 = this.jdField_a_of_type_Ajfb.a();
        ...
        if (!this.jdField_a_of_type_Ajfb.jdField_b_of_type_Boolean) {
          break label1017;
        }
        i = 2;
        ...
        if (localObject2 != null)
        {
          ...
          localJSONObject.put("freeMemory", ((ajot)localObject2).d);
          localJSONObject.put("totalMemory", ((ajot)localObject2).jdField_c_of_type_Long);
          localJSONObject.put("maxMemory", ((ajot)localObject2).jdField_b_of_type_Long);
        }
        localJSONObject.put("aioType", ApolloGameUtil.a((AppInterface)localObject1, paramInt4, this.jdField_a_of_type_Ajfb.jdField_a_of_type_JavaLangString));
        ...
        localJSONObject.put("uin", this.jdField_a_of_type_Ajfb.jdField_b_of_type_JavaLangString);
        ...
        if (!ajfj.a((QQAppInterface)localObject1)) {
          break label1023;
        }
        paramInt2 = 1;
        ...
        {
          paramString.put(ajkk.a(1, Integer.valueOf(localObject2[paramInt2]).intValue()));
          paramInt2 += 1;
          continue;
        }
        ...
        if ((ajkk.a((QQAppInterface)localObject1)) && ((paramInt5 == 1) || (paramInt5 == 2)))
        {
          ...
          paramString = (airz)((QQAppInterface)localObject1).getManager(153);
          if (paramString != null) {
  ...
  public void a(int paramInt, String paramString1, String paramString2)
  {
    try
    {
      ...
      ApolloCmdChannel.getChannel(this.jdField_a_of_type_Ajfb.a()).callbackFromRequest(this.jdField_a_of_type_Ajfb.a().getLuaState(), 0, "sc.script_on_sprite_single_clicked.local", localJSONObject.toString());
      return;
    }
  ...
  public void a(int paramInt, ArrayList<String> paramArrayList)
  {
    ...
    ApolloCmdChannel.getChannel(this.jdField_a_of_type_Ajfb.a()).callbackFromRequest(this.jdField_a_of_type_Ajfb.a().getLuaState(), 0, "sc.script_user_dressOrStatus_changed.local", localJSONObject.toString());
  }
  ...
  public void a(long paramLong1, long paramLong2, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      ApolloCmdChannel.getChannel(this.jdField_a_of_type_Ajfb.a()).callbackFromRequest(this.jdField_a_of_type_Ajfb.a().getLuaState(), 0, "sc.script_notify_screen_size_change.local", localJSONObject.toString());
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  {
    int i = 0;
    if ((this.jdField_a_of_type_Ajfb == null) || (this.jdField_a_of_type_Ajfb.a() == null) || (!this.jdField_a_of_type_Ajfb.c()) || (!this.jdField_a_of_type_Boolean))
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramInt2 < j)
        {
          localJSONArray2.put(ajkk.a(1, Integer.valueOf(paramArrayOfInt[paramInt2]).intValue()));
          paramInt2 += 1;
          continue;
        }
        ajkk.a(paramString, paramQQAppInterface, localJSONObject);
        localJSONObject.put("dress", localJSONArray2);
        localJSONObject.put("role", ajkk.a(0, paramInt1));
        paramQQAppInterface = this.jdField_a_of_type_Ajfb.a();
        if (paramQQAppInterface != null)
        {
          paramArrayOfInt = paramQQAppInterface.a(paramString, this.jdField_a_of_type_Ajfb, true);
          paramQQAppInterface = paramArrayOfInt;
          if (paramArrayOfInt == null) {
            paramQQAppInterface = new JSONObject();
          }
          localJSONObject.put("pet", paramQQAppInterface);
          localJSONObject.put("nameplate", ajfc.a(this.jdField_a_of_type_Ajfb.a(), paramString, paramInt1, true));
          paramQQAppInterface = this.jdField_a_of_type_Ajfb.jdField_b_of_type_JavaLangString;
          if ((TextUtils.isEmpty(paramQQAppInterface)) || (!paramQQAppInterface.equals(paramString))) {
            break label478;
          }
          paramQQAppInterface = ajyc.a(2131714304);
          if (!TextUtils.isEmpty(paramQQAppInterface)) {
            localJSONObject.put("nickname", ajfj.a(bbca.encodeToString(paramQQAppInterface.getBytes("utf-8"), 0)));
          }
        }
        localJSONArray1.put(localJSONObject);
        ((JSONObject)localObject).put("dressInfo", localJSONArray1);
        ApolloCmdChannel.getChannel(this.jdField_a_of_type_Ajfb.a()).callbackFromRequest(this.jdField_a_of_type_Ajfb.a().getLuaState(), 0, "sc.script_notify_dress_ready.local", ((JSONObject)localObject).toString());
        return;
      }
      ...
      label478:
      paramQQAppInterface = ajfj.a(this.jdField_a_of_type_Ajfb.a(), this.jdField_a_of_type_Ajfb.jdField_a_of_type_Int, paramString, this.jdField_a_of_type_Ajfb.jdField_a_of_type_JavaLangString, true);
    }
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    {
      localJSONObject = new JSONObject();
      localJSONObject.put("text", new String(ajfj.a(bbca.encodeToString(paramString2.getBytes("utf-8"), 0))));
      if (!TextUtils.isEmpty(paramString1))
      {
        localJSONObject.put("uin", paramString1);
        paramString1 = ajfc.a(paramString2, 0, airz.a(a(), paramString1));
        if (TextUtils.isEmpty(paramString1))
        {
        ...
        ApolloCmdChannel.getChannel(this.jdField_a_of_type_Ajfb.a()).callbackFromRequest(this.jdField_a_of_type_Ajfb.a().getLuaState(), 0, "sc.script_add_bubble.local", localJSONObject.toString());
        return;
      }
    }
    catch (Throwable paramString1)
    ...
    String str = ajfc.a(paramString2, 0, 1);
    paramString2 = ajfc.a(paramString2, 0, 2);
    if (airz.a(a()) == 1) {}
  ...
  public void a(String paramString1, String paramString2, int paramInt)
  {
    ...
    try
    {
      ...
      paramString1.put("model", ajkk.a(str, a()));
      paramString1.put("text", paramString2);
      if (!TextUtils.isEmpty(str)) {
        paramString1.put("uin", str);
      }
      paramString1.put("bubble", ajfc.a(paramString2, 0, paramInt, airz.a(a(), str)));
      ApolloCmdChannel.getChannel(this.jdField_a_of_type_Ajfb.a()).callbackFromRequest(this.jdField_a_of_type_Ajfb.a().getLuaState(), 0, "sc.script_add_bubble.local", paramString1.toString());
      return;
    }
    catch (Throwable paramString1)
    {
  ...
  {
    if ((this.jdField_a_of_type_Ajfb != null) && (this.jdField_a_of_type_Ajfb.a() != null)) {
      a(this.jdField_a_of_type_Ajfb.a().getWidth(), this.jdField_a_of_type_Ajfb.a().getInitHeight(), this.jdField_a_of_type_Ajfb.a().getHeight(), this.jdField_a_of_type_Ajfb.jdField_a_of_type_Int, this.jdField_a_of_type_Ajfb.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Ajfb.e);
    }
  }
  ...
  public void b(int paramInt)
  {
    try
    {
      ...
      ApolloCmdChannel.getChannel(this.jdField_a_of_type_Ajfb.a()).callbackFromRequest(this.jdField_a_of_type_Ajfb.a().getLuaState(), 0, "sc.script_set_sprite_visibility.local", localJSONObject.toString());
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  public aivx c(String paramString)
  {
    ...
    try
    {
      ...
      paramString = ajfj.a(paramString, this.jdField_a_of_type_Ajfb);
      localQQAppInterface = a();
      if ((paramString == null) || (localQQAppInterface == null)) {
        break label129;
      }
      ajer localajer = this.jdField_a_of_type_Ajfg.a();
      if ((localajer != null) && (!localajer.a(paramString)))
      {
        if (!QLog.isColorLevel()) {
          break label129;
        }
  ...
  public void c(int paramInt)
  {
    try
    {
      ...
      ApolloCmdChannel.getChannel(this.jdField_a_of_type_Ajfb.a()).callbackFromRequest(this.jdField_a_of_type_Ajfb.a().getLuaState(), 0, "sc.script_notify_user_operation.local", localJSONObject.toString());
      return;
    }
    catch (Throwable localThrowable)
    {
