...
public class pou
{
  private static pou jdField_a_of_type_Pou;
  private int jdField_a_of_type_Int;
  private DecimalFormat jdField_a_of_type_JavaTextDecimalFormat = new DecimalFormat("0.00");
  private ConcurrentHashMap<Integer, WeakReference<pbh>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  
  public static pou a()
  {
    if (jdField_a_of_type_Pou == null) {
      jdField_a_of_type_Pou = new pou();
    }
    return jdField_a_of_type_Pou;
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      localObject = (pbh)((WeakReference)localObject).get();
    } while (localObject == null);
    ((pbh)localObject).a(paramToServiceMsg, paramFromServiceMsg, paramObject);
  }
  ...
  private boolean a(ToServiceMsg paramToServiceMsg)
  {
    int i;
    int k;
    if (paramToServiceMsg.getAttribute(pbh.f) != null)
    {
      i = ((Integer)paramToServiceMsg.getAttribute(pbh.f)).intValue();
      if (i == 2)
      {
        k = 1;
  ...
  public void a(ToServiceMsg paramToServiceMsg)
  {
    ...
    onk.a().post(paramToServiceMsg);
  }
  
  public final void a(ToServiceMsg paramToServiceMsg, pbh parampbh)
  {
    if ((paramToServiceMsg == null) || (parampbh == null)) {
      return;
    }
    paramToServiceMsg.extraData.putBoolean("req_pb_protocol_flag", true);
    parampbh = new WeakReference(parampbh);
    onk.a().post(new ReadInJoyMSFService.1(this, paramToServiceMsg, parampbh));
    a(paramToServiceMsg);
  }
    ...
    for (;;)
    {
      ...
      if (paramFromServiceMsg.getResultCode() == 2008)
      {
        ...
        if (paramFromServiceMsg == null) {
          paramToServiceMsg = onk.a().getApplication();
        }
