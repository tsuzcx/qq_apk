...
public class amnv
{
  amnx jdField_a_of_type_Amnx;
  WeakReference<amnw> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public static void a(Activity paramActivity, QQAppInterface paramQQAppInterface, Runnable paramRunnable1, Runnable paramRunnable2)
  {
    ...
    do
    {
      do
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.i("BindMsgConstant", 2, String.format("checkReadContactPermission [%s, %s]", new Object[] { Boolean.valueOf(bool), Boolean.valueOf(befo.k()) }));
        }
        if (!bool) {
          break;
        }
      ...
      if (befo.k())
      {
        ...
        localamnx.jdField_a_of_type_JavaLangRunnable = paramRunnable1;
        localamnx.jdField_b_of_type_JavaLangRunnable = paramRunnable2;
        localamnx.jdField_a_of_type_Int = 1;
        paramQQAppInterface.a().a(paramActivity, localamnx, null, new String[] { "android.permission.READ_CONTACTS", "android.permission.WRITE_CONTACTS", "android.permission.GET_ACCOUNTS" });
        return;
      }
  ...
  {
    amnw localamnw;
    if (this.jdField_a_of_type_Amnx != null)
    {
      this.jdField_a_of_type_Amnx.jdField_b_of_type_Int = a();
      QLog.d("contact.PermissionChecker", 1, "onPermissionResult = " + this.jdField_a_of_type_Amnx.jdField_b_of_type_Int);
      ...
      localamnw.a(paramBoolean, this.jdField_a_of_type_Amnx);
    }
    for (;;)
    {
      this.jdField_a_of_type_Amnx = null;
      return;
      label78:
      localamnw = (amnw)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      break;
      label92:
      this.jdField_a_of_type_Amnx.a(paramBoolean);
    }
  }
  ...
  public void a(Activity paramActivity, amnx paramamnx, amnw paramamnw, String... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramActivity = paramamnx;
        if (paramamnx == null) {
          paramActivity = new amnx();
        }
        paramamnx = new StringBuilder(512);
        ...
        if (i < j)
        {
          ...
          paramamnx.append(str).append(",");
          i += 1;
        }
        else
        {
          paramActivity.jdField_a_of_type_JavaUtilList = localArrayList;
          this.jdField_a_of_type_Amnx = paramActivity;
          this.jdField_a_of_type_JavaLangRefWeakReference = null;
          if (paramamnw != null) {
            this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramamnw);
          }
          QLog.d("contact.PermissionChecker", 1, "requestPermissions = " + paramamnx.toString());
