  ...
  extends MqqHandler
{
  ...
  public ajvd(Looper paramLooper, VideoBroadcastReceiver paramVideoBroadcastReceiver)
  {
    super(paramLooper);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
        ...
        do
        {
          ...
          case 0: 
            ...
            if (i == 1006)
            {
              ...
              localObject1 = ((aroh)localQQAppInterface.getManager(11)).a();
            ...
            for (;;)
            {
              aael.b(localQQAppInterface, paramMessage, (SessionInfo)localObject3, (String)localObject2);
              return;
              if (i == 1000)
              {
          ...
          case 1: 
            ...
            localObject1 = (bafb)paramMessage[0];
      ...
      mga.e(localQQAppInterface.isBackground_Pause);
      return;
      paramMessage = (bafb)((Object[])(Object[])paramMessage.obj)[0];
    } while (!paramMessage.isShowing());
    paramMessage.dismiss();
    return;
