...
{
  private static bdmt jdField_a_of_type_Bdmt;
  private ConcurrentLinkedQueue<bdmv> jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue;
  ...
  public static bdmt a()
  {
    if (jdField_a_of_type_Bdmt != null) {
      return jdField_a_of_type_Bdmt;
    }
    try
    {
      if (jdField_a_of_type_Bdmt == null) {
        jdField_a_of_type_Bdmt = new bdmt();
      }
  ...
  private void b(MonitorHttpInfo paramMonitorHttpInfo, String paramString1, String paramString2)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue != null)
    {
      ...
      while (i < m)
      {
        ...
        if ((localObject instanceof bdmv))
        {
          localObject = (bdmv)localObject;
          int k = 0;
          try
          {
            j = a(str, ((bdmv)localObject).a());
            if (QLog.isColorLevel()) {
              QLog.d("NetworkMonitor", 2, new Object[] { "url=", str, " bean's url=", ((bdmv)localObject).a(), " lcs length=", Integer.valueOf(j) });
            }
            if (j < 10) {
              break label258;
            }
  ...
  public void a(String paramString)
  {
    ...
    bdmv localbdmv = new bdmv(this, paramString);
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.add(localbdmv);
    if (QLog.isColorLevel()) {
    ...
    {
      paramString = (bdmv)this.jdField_a_of_type_JavaUtilConcurrentConcurrentLinkedQueue.peek();
      if ((paramString == null) || (paramString.a - localbdmv.a <= 600000L)) {
        break;
      }
  ...
  public void addDownloadURL(String paramString)
  {
    ...
    if (1 != BaseApplicationImpl.sProcessId)
    {
      ...
      QIPCClientHelper.getInstance().callServer("NetworkMonitorIPCModule", "ACTION_REPORT_DOWNLOAD_URL", localBundle, new bdmu(this));
      return;
    }
    a(paramString);
  }
