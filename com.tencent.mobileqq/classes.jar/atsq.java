  ...
  implements IExcitingTransferSendListener
{
  ...
  public atsq(QQAppInterface paramQQAppInterface, long paramLong1, long paramLong2, int paramInt, atst paramatst, atsw paramatsw)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_c_of_type_Int = 0;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.d = paramLong1;
    this.jdField_a_of_type_Atst = paramatst;
    this.jdField_a_of_type_Atsw = paramatsw;
  ...
  private ExcitingTransferEngine.ExcitingSendInfo a()
  {
    ...
    localExcitingSendInfo.mFileEntry.strLocalFilePath = this.jdField_a_of_type_Atst.a();
    localExcitingSendInfo.mFileEntry.strFileName = this.jdField_a_of_type_Atst.b();
    localExcitingSendInfo.mFileEntry.uFileSize = this.jdField_a_of_type_Atst.a();
    localExcitingSendInfo.mFileEntry.buf10MMd5 = this.jdField_a_of_type_Atst.b();
    localExcitingSendInfo.mFileEntry.bufMd5 = this.jdField_a_of_type_Atst.a();
    localExcitingSendInfo.mFileEntry.bufSha = this.jdField_a_of_type_Atst.d();
    localExcitingSendInfo.mFileEntry.bufSha3 = this.jdField_a_of_type_Atst.c();
    ...
    Object localObject = this.jdField_a_of_type_Atsw.a();
    int i;
    ...
    localObject = this.jdField_a_of_type_Atsw.b();
    if (localObject != null)
    {
      i = ((List)localObject).size();
      if (i > 0)
    ...
    localExcitingSendInfo.mBusInfo.bufBusinessExt = this.jdField_a_of_type_Atsw.a();
    ...
    localExcitingSendInfo.mReqInfo.bSupportHttps = this.jdField_a_of_type_Atsw.b();
    localExcitingSendInfo.mReqInfo.strSSLCName = this.jdField_a_of_type_Atsw.a();
  ...
  {
    if (this.jdField_a_of_type_Atsx != null) {
      this.jdField_a_of_type_Atsx.a(paramLong1, paramLong2, paramLong3);
    }
  }
  
  public void a(atsx paramatsx)
  {
    this.jdField_a_of_type_Atsx = paramatsx;
  }
  ...
  public void a(ExcitingTransferUploadResultRp paramExcitingTransferUploadResultRp)
  {
    ...
    if (this.jdField_a_of_type_Atsx != null) {
      this.jdField_a_of_type_Atsx.a(0, paramExcitingTransferUploadResultRp);
    }
  }
  ...
  public void b(int paramInt, ExcitingTransferUploadResultRp paramExcitingTransferUploadResultRp)
  {
    ...
    if (this.jdField_a_of_type_Atsx != null) {
      this.jdField_a_of_type_Atsx.a(paramInt, paramExcitingTransferUploadResultRp);
    }
  }
  ...
  public void onExcitingSendResult(boolean paramBoolean, int paramInt, ExcitingTransferUploadResultRp paramExcitingTransferUploadResultRp)
  {
    ...
    if (paramExcitingTransferUploadResultRp != null)
    {
      ...
      if (paramBoolean) {
        this.jdField_c_of_type_Long = this.jdField_a_of_type_Atst.a();
      }
      this.jdField_b_of_type_Long = 0L;
      if (paramExcitingTransferUploadResultRp != null)
      {
        ...
        if (this.jdField_a_of_type_Atst.a() - paramExcitingTransferUploadResultRp.m_u64StartSize <= 0L) {
          break label312;
        }
      }
    }
    ...
    label306:
    label312:
    for (long l = this.jdField_a_of_type_Atst.a() - paramExcitingTransferUploadResultRp.m_u64StartSize;; l = 0L)
    {
  ...
  public void onExcitingSendStart()
  {
    ...
    } while (this.jdField_a_of_type_Atsx == null);
    this.jdField_a_of_type_Atsx.aq_();
  }
  ...
  public void onExcitingSubSenderResult(int paramInt, ExcitingTransferUploaderRp paramExcitingTransferUploaderRp)
  {
    ...
    for (String str = paramExcitingTransferUploaderRp.toString();; str = "")
    {
      QLog.i("ExcitingTransfer.BaseUploader<FileAssistant>", 1, str);
      if (this.jdField_a_of_type_Atsx != null) {
        this.jdField_a_of_type_Atsx.a(paramInt, paramExcitingTransferUploaderRp);
      }
      return;
    }
  }
