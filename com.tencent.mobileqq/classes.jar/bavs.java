  ...
  extends anii
{
  ...
  public long a;
  private baqr jdField_a_of_type_Baqr = new baqr(paramAppInterface, this.jdField_a_of_type_Bavr);
  private bavr jdField_a_of_type_Bavr = new bavr();
  private Random jdField_a_of_type_JavaUtilRandom = new Random();
  
  public bavs(AppInterface paramAppInterface)
  {
  ...
  private void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    for (long l = Long.valueOf(paramArrayOfByte1).longValue();; l = 0L)
    {
      ...
      {
        if (this.jdField_a_of_type_Bavr.b())
        {
          this.jdField_a_of_type_Bavr.a(2);
          paramArrayOfByte1 = (baqs)paramArrayOfByte2.get(0);
          this.jdField_a_of_type_Baqr.a(paramArrayOfByte2);
          this.jdField_a_of_type_Baqr.a(paramArrayOfByte1, l);
          if (!QLog.isColorLevel()) {
            break;
          }
  ...
  private void b(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (j == 4)
        {
          this.jdField_a_of_type_Bavr.a(0);
  ...
  {
    Object localObject = lfo.a(paramArrayOfByte);
    paramArrayOfByte = ((lfp)localObject).a;
    localObject = ((lfp)localObject).b;
    AudioTransClientTransInfo.IntHead localIntHead = new AudioTransClientTransInfo.IntHead();
    for (;;)
    {
      try
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Bavr.d())
        {
          ...
          this.jdField_a_of_type_Baqr.a(paramLong);
          return;
        }
        ...
        {
          this.jdField_a_of_type_Bavr.c(4);
          return;
        }
      } while (!this.jdField_a_of_type_Bavr.g());
      this.jdField_a_of_type_Bavr.c(4);
      return;
    } while (this.jdField_a_of_type_Bavr.c());
    this.jdField_a_of_type_Bavr.c(4);
  }
  ...
  public void a(long paramLong, boolean paramBoolean)
  {
    ...
    {
      return;
      i = this.jdField_a_of_type_Bavr.c();
  ...
  public void a(String paramString1, String paramString2, String paramString3, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3, boolean paramBoolean, int paramInt4)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString1 = lfo.a(paramString1.toByteArray(), paramString2.toByteArray());
        if (this.jdField_a_of_type_Baqr == null) {
          break;
        }
        if (this.jdField_a_of_type_Baqr.a()) {
          break label200;
        }
        if (!QLog.isColorLevel()) {
          break;
    ...
    label200:
    this.jdField_a_of_type_Baqr.a(paramString1);
  }
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          if ("TransInfoCreate.CreateSession".equals(paramString2))
          {
            ...
            if (!this.jdField_a_of_type_Bavr.c())
            {
              if (QLog.isColorLevel()) {
                QLog.e("PeakAudioTransHandler", 2, "sendCmdToService create last session not close state = " + this.jdField_a_of_type_Bavr.a());
              }
              if (paramBoolean) {}
              for (paramInt1 = 0;; paramInt1 = 1)
              {
                this.jdField_a_of_type_Bavr.c(paramInt1);
                return;
              }
            }
            if (this.jdField_a_of_type_Baqr.a())
            {
              ...
              this.jdField_a_of_type_Bavr.a(1);
              return;
            }
          ...
          if ("TransInfo.JoinSession".equals(paramString2))
          {
            ...
            localToServiceMsg.putWupBuffer(lfo.a(paramString1.toByteArray(), paramString2.toByteArray()));
            if (this.jdField_a_of_type_Bavr.a()) {
              break;
            }
            if (QLog.isColorLevel()) {
              QLog.e("PeakAudioTransHandler", 2, "sendCmdToService other  session not open ! state =" + this.jdField_a_of_type_Bavr.a());
            }
            paramInt1 = -1;
            if (i == 5) {
              if (!paramBoolean) {
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      paramObject = lfo.a(paramFromServiceMsg.getWupBuffer());
