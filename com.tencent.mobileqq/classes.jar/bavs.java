...
public class bavs
{
  ...
  private WeakReference<bavt> jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(null);
  private final String b = "a4d7xwsbelhregistercard";
  private final String c = "https://proxy.vip.qq.com/cgi-bin/srfentry.fcgi";
  
  public bavs(String paramString, bavt parambavt)
  {
    this.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(parambavt);
  }
  ...
  private bavn a()
  {
    try
    {
      ...
      if (i == 200)
      {
        ...
        if (localObject != null)
        {
          ...
          if (localObject != null)
          {
            ...
            if (localObject != null) {
              return new bavn((JSONObject)localObject);
            }
          }
        }
      }
      else
      {
        ...
        localObject = new bavn();
        ((bavn)localObject).a = i;
        return localObject;
      }
    }
  ...
  private void a(bavn parambavn)
  {
    ...
    else
    {
      ...
      localObject2 = awrn.a(BaseApplicationImpl.getApplication());
      if (i != 0) {
        break label153;
      }
    }
    ...
    {
      ((awrn)localObject2).a(null, "reg_lh_check_uin", bool, l1 - l2, 0L, (HashMap)localObject1, "", true);
      localObject1 = (bavt)this.jdField_a_of_type_JavaLangRefWeakReference.get();
      if (localObject1 != null) {
        break label159;
      }
      return;
      localObject1 = parambavn.toString();
      break;
      i = -30009;
      break label63;
    }
    label159:
    ThreadManagerV2.getUIHandlerV2().post(new CheckRegisterLiangHao.2(this, (bavt)localObject1, parambavn));
  }
