...
public class avfw
  extends anyu
{
  public avfw(ShieldFriendsListFragment paramShieldFriendsListFragment) {}
  ...
  protected void onUpdateFriendShieldFlag(long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, String paramString)
  {
    ...
    if (!paramBoolean2)
    {
      ...
      if (!paramBoolean1)
      {
        ...
        if (ShieldFriendsListFragment.a(paramString, paramLong, paramBoolean1)) {
          QQToast.a(BaseApplication.getContext(), anzj.a(2131712866), 0).b(BaseApplication.getContext().getResources().getDimensionPixelSize(2131299011));
        }
      }
    }
    do
    {
      ...
      paramString = ((anyw)this.a.getActivity().app.getManager(51)).e(String.valueOf(paramLong));
