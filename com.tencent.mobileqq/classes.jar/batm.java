...
public class batm
{
  ...
  public String a;
  ArrayList<batm> jdField_a_of_type_JavaUtilArrayList;
  ...
  public batm(String paramString, File paramFile)
  {
    ...
    this.jdField_a_of_type_Batn = new batn();
  ...
  public batm(List<String> paramList, Map<String, File> paramMap, String paramString)
  {
    this.jdField_a_of_type_Int = 0;
    this.jdField_b_of_type_Int = 3;
    this.jdField_a_of_type_Float = 0.0F;
  ...
  public batl a()
  {
    return this.jdField_a_of_type_Batl;
  }
  ...
  public void a(batm parambatm)
  {
    if (QLog.isColorLevel()) {
      QLog.d("DownloadTask", 2, "DownloadTask.addDuplicateListenerTask,task.key=" + parambatm.jdField_a_of_type_JavaLangString);
    }
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilArrayList.size() < 5) {
        this.jdField_a_of_type_JavaUtilArrayList.add(parambatm);
      }
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.s))
        {
          ...
          if (i1 >= 0)
          {
            batm localbatm = (batm)this.jdField_a_of_type_JavaUtilArrayList.get(i1);
            if ((localbatm == null) || (localbatm.a() == null)) {
              break label135;
            }
            localbatm.a(a());
            localbatm.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
            localbatm.jdField_a_of_type_Float = this.jdField_a_of_type_Float;
            localbatm.jdField_a_of_type_Long = this.jdField_a_of_type_Long;
            localbatm.jdField_b_of_type_Long = this.jdField_b_of_type_Long;
            localbatm.a().onProgress(localbatm);
          }
        }
      }
      return;
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.s))
        {
          ...
          if (i1 >= 0)
          {
            ...
            localbatm.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
            localbatm.jdField_a_of_type_Float = this.jdField_a_of_type_Float;
            localbatm.a().onCancel(localbatm);
          }
        }
      }
      return;
      ...
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        if ((this.jdField_a_of_type_JavaUtilArrayList != null) && (this.s))
        {
          ...
          if (i1 >= 0)
          {
            ...
            localbatm.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
            localbatm.jdField_a_of_type_Float = this.jdField_a_of_type_Float;
            localbatm.a().onDoneFile(localbatm);
          }
        }
      }
      return;
  ...
  {
    return ((paramObject instanceof batm)) && (((batm)paramObject).jdField_a_of_type_JavaUtilList.equals(this.jdField_a_of_type_JavaUtilList));
  }
