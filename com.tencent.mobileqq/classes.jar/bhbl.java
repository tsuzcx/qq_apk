  ...
  implements TextWatcher
{
  ...
  public void afterTextChanged(Editable paramEditable)
  {
    ...
    paramEditable = String.format("%d/%d", new Object[] { Integer.valueOf(j), Integer.valueOf(bhbk.a(this.a)) });
    if (j > bhbk.a(this.a))
    {
      ...
      bhbk.a(this.a).setText(paramEditable);
      paramEditable = bhbk.a(this.a);
      if (j <= 0) {
        break label132;
      }
    }
