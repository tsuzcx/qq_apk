...
public class bhbl
{
  ...
  private static final String c = anvx.a(2131714086);
  
  static
  {
    jdField_a_of_type_JavaLangBoolean = Boolean.valueOf(false);
    jdField_a_of_type_Bhbq = new bhbq();
  ...
  public static String a(Context paramContext, Uri paramUri, String paramString1, String paramString2)
  {
    ...
    //   28: aload_2
    //   29: aload_3
    //   30: invokestatic 149	bhbl:a	(Landroid/content/Context;Ljava/io/InputStream;Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
  ...
  public static void a(Context paramContext, bhbo parambhbo, aftk paramaftk)
  {
    jdField_a_of_type_Bhbq.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramContext);
    jdField_a_of_type_Bhbq.jdField_a_of_type_Aftk = paramaftk;
    parambhbo.a(paramaftk);
    parambhbo.a(new bhbn());
  }
  ...
  {
    if ((paramSessionInfo.curType != 1) && (paramSessionInfo.curType != 3000) && (paramSessionInfo.curType != 0) && (!acnh.e(paramSessionInfo.curType)))
    {
      QLog.d("SystemDragUtils", 1, "unsupported UinType:" + paramSessionInfo.curType);
      return;
    }
    ...
    paramViewGroup.setOnDragListener(new bhbm(localImageView, localColorDrawable1, paramViewGroup, localColorDrawable2, paramContext, paramQQAppInterface, paramSessionInfo));
  }
  ...
  private static bhbp b(Context paramContext, afqr paramafqr)
  {
    long l = 0L;
    Object localObject1;
    if ((paramafqr instanceof ahdv))
    {
      localObject1 = aufd.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramafqr.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
      l = FileUtils.getFileSizes((String)localObject1);
      paramafqr = paramafqr.jdField_a_of_type_AndroidViewView;
    }
    for (;;)
    {
      label76:
      ...
      if (TextUtils.isEmpty((CharSequence)localObject1))
      {
        ...
        if ((paramafqr instanceof ahdx))
        {
          localObject1 = aufd.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramafqr.jdField_a_of_type_ComTencentMobileqqDataChatMessage);
          l = FileUtils.getFileSizes((String)localObject1);
          paramafqr = ((ahdx)paramafqr).a;
          continue;
        }
        if ((paramafqr instanceof agql))
        {
          localObject2 = (MessageForPic)paramafqr.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject3 = ((MessageForPic)localObject2).getBiggestFilePath();
          String str = auea.a((String)localObject3);
          int i = blvp.a((String)localObject3);
          localObject1 = ".jpg";
          if (i == 1001) {
            localObject1 = ".png";
          }
          for (;;)
          {
            ...
            if ((((MessageForPic)localObject2).getBiggestFilePath() == null) || (!FileUtils.copyFile(((MessageForPic)localObject2).getBiggestFilePath(), (String)localObject1)) || (TextUtils.isEmpty(str))) {
              break label76;
            }
            l = ((MessageForPic)localObject2).size;
            paramafqr = ((agql)paramafqr).a;
            break;
            if (i == 1005) {
              localObject1 = ".bmp";
            } else if (i == 2000) {
        ...
        if ((paramafqr instanceof ahgk))
        {
          localObject2 = (MessageForShortVideo)paramafqr.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          ...
          paramafqr = ((ahgk)paramafqr).a;
          continue;
        }
        if ((paramafqr instanceof ahha))
        {
          localObject2 = (MessageForShortVideo)paramafqr.jdField_a_of_type_ComTencentMobileqqDataChatMessage;
          localObject1 = ShortVideoUtils.getShortVideoSavePath((MessageForShortVideo)localObject2, "mp4");
          l = ((MessageForShortVideo)localObject2).videoFileSize;
          paramafqr = ((ahha)paramafqr).a;
        }
      }
      else
      {
        ...
        return new bhbp((File)localObject2, paramafqr, ClipData.newUri(paramContext.getContentResolver(), "uri", (Uri)localObject1));
      }
      paramafqr = null;
      localObject1 = null;
    }
  ...
  private static boolean b(DragEvent paramDragEvent, ImageView paramImageView, ColorDrawable paramColorDrawable1, ViewGroup paramViewGroup, ColorDrawable paramColorDrawable2, Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    paramImageView = new ReportProgressDialog(paramContext, 2131755829);
    paramImageView.setCancelable(true);
    paramImageView.setContentView(2131559607);
    ((TextView)paramImageView.findViewById(2131372740)).setText(anvx.a(2131714085));
