  ...
  extends bced
{
  ...
  public bcej(String paramString)
  {
    this.f = paramString;
    b();
  ...
  public bcej(JSONObject paramJSONObject)
  {
    a(paramJSONObject);
    this.jdField_d_of_type_JavaLangString = String.valueOf(hashCode());
  }
  ...
  private void b()
  {
    ...
    //   3: lstore_2
    //   4: aload_0
    //   5: getfield 15	bcej:f	Ljava/lang/String;
    //   8: invokestatic 51	arso:b	(Ljava/lang/String;)Z
    //   11: ifeq +386 -> 397
    //   14: aconst_null
    //   15: astore 4
    ...
    //   30: aload 5
    //   32: aload_0
    //   33: getfield 15	bcej:f	Ljava/lang/String;
    ...
    //   57: putfield 71	bcej:jdField_a_of_type_Int	I
    //   60: aload 5
    //   62: astore 4
    //   64: aload_0
    //   65: aload 5
    ...
    //   78: putfield 73	bcej:jdField_b_of_type_Int	I
    //   81: aload 5
    //   83: astore 4
    ...
    //   166: astore 4
    //   168: aload_0
    //   169: getfield 71	bcej:jdField_a_of_type_Int	I
    //   172: istore_1
    //   173: aload 5
    //   175: astore 4
    //   177: aload_0
    //   178: aload_0
    //   179: getfield 73	bcej:jdField_b_of_type_Int	I
    //   182: putfield 71	bcej:jdField_a_of_type_Int	I
    //   185: aload 5
    //   187: astore 4
    //   189: aload_0
    //   190: iload_1
    //   191: putfield 73	bcej:jdField_b_of_type_Int	I
    //   194: aload 5
    //   196: astore 4
    ...
    //   222: iconst_1
    //   223: aload_0
    //   224: getfield 15	bcej:f	Ljava/lang/String;
    //   227: aastore
    //   228: dup
    //   229: iconst_2
    //   230: ldc 100
    ...
    //   234: iconst_3
    //   235: aload_0
    //   236: getfield 71	bcej:jdField_a_of_type_Int	I
    ...
    //   249: iconst_5
    //   250: aload_0
    //   251: getfield 73	bcej:jdField_b_of_type_Int	I
    ...
    //   281: astore 4
    //   283: aload_0
    //   284: getfield 71	bcej:jdField_a_of_type_Int	I
    //   287: ifle +14 -> 301
    //   290: aload 5
    //   292: astore 4
    //   294: aload_0
    //   295: getfield 73	bcej:jdField_b_of_type_Int	I
    //   298: ifgt +89 -> 387
    //   301: aload 5
    //   303: astore 4
    //   305: aload_0
    //   306: aload_0
    //   307: getfield 111	bcej:jdField_d_of_type_Int	I
    //   310: putfield 71	bcej:jdField_a_of_type_Int	I
    //   313: aload 5
    //   315: astore 4
    //   317: aload_0
    //   318: aload_0
    //   319: getfield 111	bcej:jdField_d_of_type_Int	I
    //   322: bipush 9
    //   324: imul
    //   325: i2f
    //   326: ldc 112
    //   328: fdiv
    //   329: f2i
    //   330: putfield 73	bcej:jdField_b_of_type_Int	I
    //   333: aload 5
    //   335: astore 4
    ...
    //   360: iconst_1
    //   361: aload_0
    //   362: getfield 71	bcej:jdField_a_of_type_Int	I
    ...
    //   375: iconst_3
    //   376: aload_0
    //   377: getfield 73	bcej:jdField_b_of_type_Int	I
    ...
    //   420: iconst_1
    //   421: aload_0
    //   422: getfield 15	bcej:f	Ljava/lang/String;
    //   425: aastore
  ...
  public Stream<bced> a(XMediaEditor paramXMediaEditor)
  {
    ...
    if (!arso.b(this.jdField_g_of_type_JavaLangString))
    {
      if (this.jdField_g_of_type_Int >= 0) {
        this.jdField_g_of_type_Int = -2147483646;
      }
      localObject1 = ((Stream)localObject2).map(new bcek(paramXMediaEditor));
    }
    ...
    if (TextUtils.isEmpty(this.e))
    {
      ...
      localObject2 = ((Stream)localObject1).map(new bcef(1, paramXMediaEditor, str));
    }
    ...
    for (localObject1 = ((Stream)localObject2).map(new bcef(2, paramXMediaEditor, str));; localObject1 = localObject2)
    {
      ...
      if ((localObject2 instanceof bcfr))
      {
        ...
        if (this.jdField_d_of_type_JavaLangString.equals(((bcfr)localObject2).a.getTag())) {
          ((bcfo)((bcdu)paramXMediaEditor.getAdapter()).a.a(2)).a((bcfe)localObject2, this, 0);
        }
      }
  ...
  public Stream<bcej> b(XMediaEditor paramXMediaEditor)
  {
    ...
    return localStream.map(new bcel(paramXMediaEditor, this.jdField_d_of_type_Int)).map(new UIThreadOffFunction(null));
  }
