...
public class bhqa
{
  private static bhqa jdField_a_of_type_Bhqa;
  ...
  public static bhqa a()
  {
    if (jdField_a_of_type_Bhqa == null) {}
    try
    {
      if (jdField_a_of_type_Bhqa == null) {
        jdField_a_of_type_Bhqa = new bhqa();
      }
      return jdField_a_of_type_Bhqa;
    }
    finally {}
  }
  ...
  private HashMap<String, Object> a(String paramString1, String paramString2, String[] paramArrayOfString)
  {
    ...
    do
    {
      ...
      {
        return paramString1;
        localObject1 = bhom.a("com.adobe.xmp.XmpUtil", "extractXMPMeta", false, a(new Class[] { String.class }), new Object[] { paramString1 });
    ...
    for (;;)
    {
      i += 1;
      break;
      Object localObject2 = bhom.a(localObject1, "getProperty", false, a(new Class[] { String.class, String.class }), new Object[] { paramString2, paramString1 });
      if (localObject2 != null)
      {
        localObject2 = bhom.a(localObject2, "getValue", false, new Class[0], new Object[0]);
        if (localObject2 != null) {
  ...
  public void a(bhqd parambhqd)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      parambhqd.a(this.jdField_a_of_type_Boolean);
      return;
    }
    if ((a()) || (!b())) {}
    for (int i = 1; i == 0; i = 0)
    ...
    QzoneModuleManager.getInstance().downloadModule("xmpcore.jar", new bhqb(this, parambhqd));
  }
