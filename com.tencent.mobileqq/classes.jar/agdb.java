  ...
  implements agdg
{
  ...
  public agdb(PhotoPreviewActivity paramPhotoPreviewActivity) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoPreviewActivity.a((String)localObject2) == 1)
      {
        ...
        localView = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoPreviewActivity.getLayoutInflater().inflate(2131495376, null);
      ...
      for (;;)
      {
        ...
        ((ImageView)localObject1).setContentDescription(ajjy.a(2131642352) + paramInt);
        return localView;
        i = 0;
        break;
    ...
    for (;;)
    {
      ...
      break;
      label799:
      ((ImageView)localObject1).setContentDescription(ajjy.a(2131642350) + paramInt);
      return localObject1;
      label830:
      localObject2 = null;
      continue;
