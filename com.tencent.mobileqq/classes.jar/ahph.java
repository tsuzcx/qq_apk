  ...
  extends BaseAdapter
{
  ...
  public ahph(ahpg paramahpg, Context paramContext, int paramInt1, int paramInt2)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      paramView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560720, null);
    ...
    for (;;)
    {
      ...
      {
        paramViewGroup.setImageDrawable(this.jdField_a_of_type_Ahpg.a.a(localMessageRecord.istroop, localMessageRecord.senderuin));
