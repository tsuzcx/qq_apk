...
public class biuj
{
  ...
  {
    bisy.c("AppUpdate", "httpRequest >>> " + paramString1.toString());
    try
    {
    ...
    catch (JSONException paramContext)
    {
      ...
      for (;;)
      {
        bisy.c("AppUpdate", "httpRequest JSONException", paramContext);
        return;
        i = 0;
        continue;
        paramString1 = "0";
      ...
      bisy.c("AppUpdate", "use supportEtag");
      if (paramBoolean) {
        break label548;
      }
      ...
      bisy.c("AppUpdate", "execute asyncTask url >>> " + str2 + " methodName " + str3);
      a(new bitt(str2, str3, new biuk(paramContext, paramWebView, str1, str4, str5, paramBoolean)), localBundle);
      return;
    }
    catch (Exception paramContext)
    {
      bisy.c("AppUpdate", "httpRequest Exception", paramContext);
    }
    localBundle = new Bundle();
    localBundle.putString("platform", biip.a().g());
    localBundle.putString("keystr", biip.a().a());
    localBundle.putString("uin", paramString2);
    localBundle.putString("resolution", biuf.e());
    localBundle.putString("keytype", "256");
    if (biub.a(paramContext))
    {
      paramString1 = "1";
      ...
      while (paramString2.hasNext())
      {
        ...
        bisy.c("AppUpdate", "key = " + (String)localObject1 + " value = " + localObject2.toString());
  ...
  @TargetApi(11)
  protected static void a(bitt parambitt, Bundle paramBundle)
  {
