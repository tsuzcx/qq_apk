  ...
  implements View.OnClickListener
{
  ...
  public vhk(Activity paramActivity, vhm paramvhm)
  {
  ...
  private void a(View paramView)
  {
    ...
    localObjectAnimator1.setInterpolator(new vgp(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    localObjectAnimator2.setInterpolator(new vgp(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    localObjectAnimator3.setInterpolator(new vgp(0.33F, 0.0F, 0.67F, 1.0F));
    ...
    paramView.setInterpolator(new vgp(0.33F, 0.0F, 0.67F, 1.0F));
  ...
  private void h()
  {
    this.jdField_a_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131307644);
    this.jdField_a_of_type_AndroidViewView.setVisibility(0);
    this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131307640);
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView = ((RecyclerView)this.jdField_a_of_type_AndroidViewView.findViewById(2131307646));
      ...
      this.jdField_a_of_type_Vgy = new vgy(this.jdField_a_of_type_AndroidViewView.getContext(), this, this.jdField_a_of_type_Vhm);
      this.jdField_a_of_type_Vgy.a(vhg.a().a());
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.setAdapter(this.jdField_a_of_type_Vgy);
      this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView.getRecycledViewPool().setMaxRecycledViews(this.jdField_a_of_type_Vgy.getItemViewType(0), 10);
      this.jdField_a_of_type_Vgy.a(new vhl(this));
      new beqc(new vhf(this.jdField_a_of_type_Vgy)).attachToRecyclerView(this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView);
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131307647));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131307648));
      this.c = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131307639));
      this.c.setOnClickListener(this);
      this.d = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131307638));
      ...
      if (a())
      {
        ...
        vhg.a().a(this.jdField_a_of_type_Int);
      }
      return;
      i = 0;
      break;
  ...
  public String a()
  {
    if (this.jdField_a_of_type_Vgy != null) {
      return this.jdField_a_of_type_Vgy.a();
    }
    return "";
  }
  ...
  public void a()
  {
    ...
    for (int i1 = localList.size();; i1 = 0)
    {
      ...
      if (i1 > 0)
      {
        ...
        {
          this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131101415));
          this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131101415));
          if (this.d.getVisibility() != 0)
          {
            localObject = vhg.a().a().iterator();
            i = 0;
            j = 0;
            i2 = 0;
            if (((Iterator)localObject).hasNext())
      ...
      for (;;)
      {
        ...
        if (localSlideItemInfo.jdField_b_of_type_Int == 0)
        {
          ...
          if (m != 0)
          {
            ...
            localObject = "0";
            urp.a("pic_choose", "exp_autoCut", i3, 0, new String[] { localObject, i2 + "", j + "", i + "" });
            this.d.setVisibility(0);
            if (k == 0) {
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131633754, new Object[] { Integer.valueOf(this.jdField_a_of_type_Int / 1000) }));
            }
            this.jdField_a_of_type_AndroidWidgetTextView.setText(vhj.a(l));
          ...
          {
            if (this.jdField_a_of_type_Vgy != null) {
              this.jdField_a_of_type_Vgy.a(localList);
            }
            return;
            i3 = 1;
            break;
            ...
            if (n != 0)
            {
              this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131101170));
              this.jdField_a_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131101416));
            }
            for (;;)
            {
              this.d.setVisibility(8);
              break;
              this.jdField_b_of_type_AndroidWidgetTextView.setTextColor(this.jdField_a_of_type_AndroidAppActivity.getResources().getColor(2131101537));
            ...
            if (n != 0)
            {
              ...
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131633756));
            }
            for (;;)
            {
              ...
              break label684;
              label763:
              this.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_AndroidAppActivity.getString(2131633755));
            }
            bool = false;
            break label521;
            if (m == 0)
  ...
  {
    if (this.jdField_a_of_type_Vgy != null) {
      this.jdField_a_of_type_Vgy.a(paramInt);
    }
  }
  
  public void b()
  {
    List localList = vhg.a().a();
    if ((this.jdField_a_of_type_AndroidSupportV7WidgetLinearLayoutManager != null) && (this.jdField_a_of_type_AndroidSupportV7WidgetRecyclerView != null))
    {
      ...
      while (i <= j)
      {
        ...
        if (localObject != null)
        {
          ...
          if ((localObject instanceof vhb))
          {
            SlideItemInfo localSlideItemInfo1 = (SlideItemInfo)((vhb)localObject).a.getTag();
  ...
  public void onClick(View paramView)
  {
    ...
    case 2131310483: 
      ...
      i = vhg.a().a().indexOf(paramView);
      if ((this.jdField_a_of_type_Vhm != null) && (paramView != null)) {
        this.jdField_a_of_type_Vhm.a(paramView.jdField_b_of_type_JavaLangString);
      }
      a(i);
      return;
    case 2131307639: 
      if (((this.jdField_a_of_type_AndroidAppActivity instanceof PhotoListActivity)) || ((this.jdField_a_of_type_AndroidAppActivity instanceof NewPhotoListActivity)))
      {
        ...
        if (this.jdField_a_of_type_Vhm != null) {
          this.jdField_a_of_type_Vhm.a();
        }
        paramView = vhg.a().a();
        if ((paramView.size() >= 1) && (paramView.size() <= 10) && (((SlideItemInfo)paramView.get(0)).a() <= 20999L)) {
          vhg.a().a(this.jdField_a_of_type_AndroidAppActivity, null, 2);
        }
      }
      for (;;)
      {
        try
        {
          ...
          urp.a("pic_fictitious", "clk_next", this.jdField_a_of_type_AndroidAppActivity.getIntent(), new String[0]);
          if ((!vhg.a().a()) || (this.jdField_a_of_type_AndroidAppActivity == null)) {
            break;
          }
          urp.a("video_edit_new", "change_pic", this.jdField_a_of_type_AndroidAppActivity.getIntent(), new String[0]);
          return;
        }
        ...
        QLog.d(this.jdField_a_of_type_JavaLangString, 2, befj.a(paramView));
        return;
        i = 1;
        break label114;
        label320:
    ...
    for (;;)
    {
      ...
      if (localSlideItemInfo.jdField_b_of_type_Int == 0)
      {
        ...
        {
          urp.a("pic_choose", "clk_autoCut", n, 0, new String[] { paramView, k + "", j + "", i + "" });
          vhg.a().i();
          return;
          m = 0;
          break;
