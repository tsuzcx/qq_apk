...
public class vhk
{
  public static MessageForQCircleIceBreak a(QQAppInterface paramQQAppInterface, String paramString, int paramInt, byte[] paramArrayOfByte, MessageRecord paramMessageRecord)
  {
    ...
    {
      return paramString;
      MessageForQCircleIceBreak localMessageForQCircleIceBreak = (MessageForQCircleIceBreak)bbzh.a(-7013);
      long l1 = bbyp.a() - 5L;
      long l2;
      ...
      try
      {
        ...
        if (anqc.a(paramQQAppInterface, localMessageForQCircleIceBreak, false)) {
          continue;
        }
  ...
  public static MessageForUniteGrayTip a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2, MessageRecord paramMessageRecord)
  {
    if (QLog.isColorLevel()) {
      QLog.i("QCircleChatUtil", 2, String.format("addGrayTipsMessage frdUin:%s msg:%s ", new Object[] { paramString1, bgjw.a(paramString2) }));
    }
    ...
    for (long l1 = paramMessageRecord.shmsgseq;; l1 = Math.abs(new Random().nextInt()))
    {
      ...
      paramString1 = new auxc(paramString1, paramQQAppInterface.getCurrentAccountUin(), paramString2, paramInt, -5022, 656395, l2);
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<String> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if (paramBoolean) {
          paramQQAppInterface.a().a(anhk.aT, 1044, str, paramQQAppInterface.getCurrentAccountUin());
        }
        if (i > 0)
        {
