...
public class ahly
{
  ...
  public static ArrayList<ahlx> a;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = VFSAssistantUtils.getSDKPrivatePath(AppConstants.SDCARD_PE) + File.separator;
  ...
  public static ahlx a(int paramInt)
  {
    if (jdField_a_of_type_JavaUtilArrayList.size() > paramInt) {
      return (ahlx)jdField_a_of_type_JavaUtilArrayList.get(paramInt);
    }
    return null;
  }
  ...
  public static Drawable a(int paramInt)
  {
    ...
    ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = BaseApplicationImpl.getContext().getResources().getDrawable(2130841511);
    ((URLDrawable.URLDrawableOptions)localObject).mFailedDrawable = BaseApplicationImpl.getContext().getResources().getDrawable(2130841511);
  ...
  public static String a(int paramInt)
  {
    ...
    if (TextUtils.isEmpty(str2)) {
      str1 = amtj.a(2131707022);
    }
    return str1;
  }
  
  public static List<ahlx> a(String paramString)
  {
        ...
        for (;;)
        {
          if (i < j) {
            try
            {
              ...
              localahlx.jdField_a_of_type_Int = k;
              localahlx.jdField_a_of_type_JavaLangString = b(k);
              jdField_a_of_type_JavaUtilArrayList.add(localahlx);
              i += 1;
            }
  ...
  public static void a()
  {
    ...
    for (;;)
    {
      ...
      try
      {
        localObject1 = FileUtils.getByte((File)localObject1);
  ...
  public static ahlx b(int paramInt)
  {
    Object localObject;
    ahlx localahlx;
    if (jdField_a_of_type_JavaUtilArrayList.size() != 0)
    {
      ...
      do
      {
        ...
        localahlx = (ahlx)((Iterator)localObject).next();
      } while (localahlx.jdField_a_of_type_Int != paramInt);
    }
    for (;;)
    {
      localObject = localahlx;
      if (localahlx == null)
      {
        localObject = new ahlx();
        ((ahlx)localObject).jdField_a_of_type_Int = paramInt;
        ((ahlx)localObject).jdField_a_of_type_JavaLangString = b(paramInt);
      }
      return localObject;
      localahlx = null;
    }
