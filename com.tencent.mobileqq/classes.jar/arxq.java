...
class arxq
  implements atqq
{
  arxq(arxo paramarxo, QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean) {}
  ...
  public void b(atqr paramatqr)
  {
    try
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d("StructLongTextMsg", 2, "upload multi msg pack failed, result.errStr=" + paramatqr.b + ",result.errStr=" + paramatqr.jdField_a_of_type_JavaLangString);
      }
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("StructLongTextMsg", 2, "upload multi msg pack failed, catch exception", paramatqr);
      }
      arxo.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqDataMessageRecord);
    }
  }
