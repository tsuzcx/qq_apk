  ...
  implements bhbq
{
  ...
  private String a(File paramFile1, File paramFile2, String paramString)
  {
    ...
    try
    {
      ...
      bgmg.d(str1, new File(str2, paramString).getAbsolutePath());
      bgmg.a(str1, str2, false);
      if (paramFile2.exists()) {
        bgmg.a(paramFile2.getAbsolutePath(), false);
      }
      QLog.d("GLDrawable", 1, "unzip succ..." + new File(str1).length() + "..." + bita.a(str1));
      if ((bgmg.c(str2, paramFile2.getAbsolutePath())) && (a(paramFile2, paramString, l))) {
        return "sucess";
      }
  ...
  private void c(bhbr parambhbr)
  {
    if (!aqyj.c().a()) {
      return;
    }
    Object localObject = new bhbm();
    bhbn.a((bhbs)localObject);
    BaseApplicationImpl localBaseApplicationImpl = BaseApplicationImpl.getApplication();
    String str = bhbj.a(localBaseApplicationImpl);
    GLDrawableLoaderImpl.3 local3 = new GLDrawableLoaderImpl.3(this, str, localBaseApplicationImpl, (bhbm)localObject, parambhbr);
    localObject = new GLDrawableLoaderImpl.4(this, (bhbm)localObject, parambhbr);
    if (parambhbr != null) {
      parambhbr.a();
    }
  ...
  {
    // Byte code:
    //   0: getstatic 184	bhbk:jdField_a_of_type_Boolean	Z
    //   3: ifeq +4 -> 7
    //   6: return
    //   7: iconst_1
    //   8: putstatic 169	bhbk:b	Z
    ...
    //   17: if_acmpne +3 -> 20
    //   20: getstatic 184	bhbk:jdField_a_of_type_Boolean	Z
    //   23: ifne +15 -> 38
    //   26: invokestatic 174	bhbn:a	()Z
    //   29: ifne +9 -> 38
    //   32: invokestatic 320	bhbn:b	()Z
    //   35: ifeq +13 -> 48
    //   38: aload_0
    //   39: aload_1
    //   40: invokespecial 322	bhbk:b	(Lbhbr;)V
    //   43: iconst_0
    //   44: putstatic 169	bhbk:b	Z
    //   47: return
    //   48: ldc 2
    //   50: monitorenter
    //   51: getstatic 184	bhbk:jdField_a_of_type_Boolean	Z
    //   54: ifne +15 -> 69
    //   57: invokestatic 174	bhbn:a	()Z
    //   60: ifne +9 -> 69
    //   63: invokestatic 320	bhbn:b	()Z
    //   66: ifeq +16 -> 82
    //   69: aload_0
    //   70: aload_1
    //   71: invokespecial 322	bhbk:b	(Lbhbr;)V
    //   74: ldc 2
    //   76: monitorexit
    //   77: iconst_0
    //   78: putstatic 169	bhbk:b	Z
    //   81: return
    //   82: aload_0
    //   83: aload_1
    //   84: invokespecial 324	bhbk:c	(Lbhbr;)V
    //   87: ldc 2
    //   89: monitorexit
    //   90: iconst_0
    //   91: putstatic 169	bhbk:b	Z
    //   94: return
    //   95: astore_1
    //   96: ldc 2
    //   98: monitorexit
    ...
    //   101: astore_1
    //   102: iconst_0
    //   103: putstatic 169	bhbk:b	Z
    //   106: aload_1
    //   107: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	108	0	this	bhbk
    //   0	108	1	parambhbr	bhbr
    // Exception table:
    //   from	to	target	type
    //   51	69	95	finally
    //   69	77	95	finally
