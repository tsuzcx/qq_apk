...
public class ajvs
{
  ...
  private static ArrayList<ajvt> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  ...
  public static int a()
  {
    ...
    {
      ajvt localajvt = (ajvt)jdField_a_of_type_JavaUtilArrayList.get(i);
      k = j;
      if (localajvt != null)
      {
        k = j;
        if (localajvt.jdField_c_of_type_Int == 0) {
          k = j + 1;
        }
      }
      i += 1;
  ...
  private static ajvt a()
  {
    ...
    for (;;)
    {
      ...
      if (localajvt != null)
      {
        localObject = localajvt;
        if (localajvt.jdField_c_of_type_Int == 1) {
          break;
        }
      }
      i += 1;
  ...
  public static ajvt a(boolean paramBoolean)
  {
    Object localObject;
    if (jdField_a_of_type_JavaUtilArrayList == null)
    {
    ...
    if (paramBoolean)
    {
      ...
      for (;;)
      {
        ...
        localajvt = (ajvt)jdField_a_of_type_JavaUtilArrayList.get(i);
        if (localajvt != null)
        {
          localObject = localajvt;
          if (localajvt.jdField_c_of_type_Int == 0) {
  ...
  public static void a()
  {
    ...
    for (;;)
    {
      ...
      {
        ajvt localajvt = (ajvt)jdField_a_of_type_JavaUtilArrayList.get(i);
        if ((localajvt == null) || (localajvt.jdField_c_of_type_Int == 1)) {
  ...
  private static void a(QQAppInterface paramQQAppInterface, ajvt paramajvt)
  {
    if ((paramQQAppInterface == null) || (jdField_a_of_type_JavaUtilArrayList == null) || (paramajvt == null) || (paramajvt.jdField_b_of_type_Int < 1) || (paramajvt.jdField_b_of_type_Int > 7) || (TextUtils.isEmpty(paramajvt.jdField_a_of_type_JavaLangString)))
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.qwallet.push", 2, "params error, pcPayDatas=" + jdField_a_of_type_JavaUtilArrayList + ",app=" + paramQQAppInterface + ",pcPayData=" + paramajvt);
      }
      return;
    }
    if (paramajvt.jdField_b_of_type_Int == 1) {
    ...
    for (;;)
    {
      ...
      {
        jdField_a_of_type_JavaUtilArrayList.add(paramajvt);
        if (b(paramQQAppInterface))
        {
          ...
          b(paramQQAppInterface, paramajvt);
          return;
        }
      }
      if (jdField_a_of_type_Long != 0L) {
      ...
      c(paramQQAppInterface, paramajvt);
    }
  }
  ...
  private static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (k == 1)
      {
        ...
        if ((k == 1) && (m == 2))
        {
          FileUtils.deleteFile(paramQQAppInterface.getApp().getFilesDir() + "/" + QWalletHelper.getRecommendFileName(paramQQAppInterface.getCurrentAccountUin()));
          FileUtils.deleteFile(paramQQAppInterface.getApp().getFilesDir() + "/" + QWalletHelper.getRecommendFileName(paramQQAppInterface.getCurrentAccountUin()) + "_");
          i = 1;
          continue;
        }
        if ((k == 2) && (m == 1))
        ...
        if ((k == 2) && (m == 2))
        {
          FileUtils.deleteFile(paramQQAppInterface.getApp().getFilesDir() + "/" + QWalletHelper.getPersonalInfoFileName(paramQQAppInterface.getCurrentAccountUin()));
          i = 1;
          continue;
        }
        if ((k != 8) || (m != 1)) {
        ...
        ((ajyg)paramQQAppInterface.getManager(245)).b(0);
        break label462;
      }
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          akat.a(0, paramQQAppInterface, null);
          return;
        }
        catch (Exception paramQQAppInterface) {}
      }
  ...
  private static void b(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      return;
      boolean bool2 = bfyg.a(paramQQAppInterface.getApp());
      if (QLog.isColorLevel()) {
      ...
      if (!bool2)
      {
        ...
        if (localajvt == null)
        {
          ...
          localajvt = (ajvt)jdField_a_of_type_JavaUtilArrayList.get(0);
          if (localajvt == null)
          {
          ...
          i = a(localajvt.jdField_b_of_type_Int);
          if (i == 0)
          {
            jdField_a_of_type_JavaUtilArrayList.remove(0);
            b(paramQQAppInterface);
        ...
        for (;;)
        {
          ...
          {
            localajvt.jdField_c_of_type_Int = 2;
          }
          if (!QLog.isColorLevel()) {
            break;
          }
          ...
          if (bool1)
          {
            ...
            bool2 = bool1;
            if (43200L * 1000L + localajvt.jdField_c_of_type_Long > l) {
              bool2 = false;
            }
          }
          if (bool2) {
  ...
  private static void b(QQAppInterface paramQQAppInterface, ajvt paramajvt)
  {
    String str1;
    boolean bool1;
    if (bfyg.a(paramQQAppInterface.getApp()))
    {
      ...
      String str2 = String.format(BaseApplication.getContext().getString(2131716342), new Object[] { Integer.valueOf(a()) });
      if (!TextUtils.isEmpty(paramajvt.jdField_b_of_type_JavaLangString))
      {
        str1 = paramajvt.jdField_b_of_type_JavaLangString;
        ...
        localIntent.putExtra("time", bfzl.b(BaseApplication.getContext(), paramajvt.jdField_b_of_type_Long));
    ...
    else
    {
      ...
      bool2 = msm.d(paramQQAppInterface.getApp());
      boolean bool3 = paramQQAppInterface.isVideoChatting();
      boolean bool4 = paramQQAppInterface.isPttRecordingOrPlaying();
      boolean bool5 = bfrf.a(paramQQAppInterface.getApp().getApplicationContext(), paramQQAppInterface);
      if (QLog.isColorLevel()) {
    ...
    for (boolean bool2 = false;; bool2 = true)
    {
      ...
      if (bool1)
      {
        ...
        bftt.a(Uri.fromFile(paramQQAppInterface), false, true);
      }
      return;
      str1 = BaseApplication.getContext().getString(2131716341);
      break;
      bool1 = true;
      break label327;
    }
    label495:
    bftt.a(2131230759, false);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte, long paramLong1, int paramInt1, long paramLong2, int paramInt2)
  {
    ...
    //   23: lload 5
    //   25: iload 7
    //   27: invokestatic 268	ajvs:a	(JIJI)Z
    //   30: ifeq +19 -> 49
    ...
    //   48: return
    //   49: new 659	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$MsgBody
    //   52: dup
    //   53: invokespecial 660	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$MsgBody:<init>	()V
    //   56: aload_1
    //   57: invokevirtual 661	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$MsgBody:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   60: checkcast 659	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$MsgBody
    //   63: astore_1
    //   64: aload_1
    //   65: getfield 665	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$MsgBody:msg_online_push	Ltencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush;
    //   68: invokevirtual 668	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:has	()Z
    //   71: ifeq -52 -> 19
    //   74: aload_1
    //   75: getfield 665	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$MsgBody:msg_online_push	Ltencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush;
    //   78: invokevirtual 671	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   81: checkcast 667	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush
    //   84: astore 12
    //   86: aload 12
    //   88: ifnull -69 -> 19
    //   91: iconst_m1
    ...
    //   107: istore 8
    //   109: aload 12
    //   111: getfield 674	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:uint32_action	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   114: invokevirtual 284	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   117: ifeq +13 -> 130
    //   120: aload 12
    //   122: getfield 674	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:uint32_action	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   125: invokevirtual 286	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   128: istore 4
    //   130: aload 12
    //   132: getfield 677	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:uint32_timestamp	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   135: invokevirtual 284	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   138: ifeq +13 -> 151
    //   141: aload 12
    //   143: getfield 677	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:uint32_timestamp	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   146: invokevirtual 286	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   149: istore 7
    //   151: aload 11
    //   153: astore 10
    //   155: aload 12
    //   157: getfield 680	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:bytes_extend	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   160: invokevirtual 293	com/tencent/mobileqq/pb/PBBytesField:has	()Z
    //   163: ifeq +39 -> 202
    //   166: aload 12
    //   168: getfield 680	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:bytes_extend	Lcom/tencent/mobileqq/pb/PBBytesField;
    //   171: invokevirtual 296	com/tencent/mobileqq/pb/PBBytesField:get	()Lcom/tencent/mobileqq/pb/ByteStringMicro;
    //   174: astore 13
    //   176: aload 11
    //   178: astore 10
    //   180: aload 13
    //   182: ifnull +20 -> 202
    //   185: new 317	java/lang/String
    //   188: dup
    //   189: aload 13
    //   191: invokevirtual 302	com/tencent/mobileqq/pb/ByteStringMicro:toByteArray	()[B
    //   194: ldc_w 319
    //   197: invokespecial 322	java/lang/String:<init>	([BLjava/lang/String;)V
    //   200: astore 10
    //   202: aload 12
    //   204: getfield 684	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:str_serialno	Lcom/tencent/mobileqq/pb/PBStringField;
    //   207: invokevirtual 687	com/tencent/mobileqq/pb/PBStringField:has	()Z
    //   210: ifeq +12 -> 222
    //   213: aload 12
    //   215: getfield 684	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:str_serialno	Lcom/tencent/mobileqq/pb/PBStringField;
    //   218: invokevirtual 689	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   221: astore_1
    //   222: aload 12
    //   224: getfield 692	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:str_billno	Lcom/tencent/mobileqq/pb/PBStringField;
    //   227: invokevirtual 687	com/tencent/mobileqq/pb/PBStringField:has	()Z
    //   230: ifeq +12 -> 242
    //   233: aload 12
    //   235: getfield 692	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:str_billno	Lcom/tencent/mobileqq/pb/PBStringField;
    //   238: invokevirtual 689	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   241: astore_1
    //   242: aload 12
    //   244: getfield 695	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:str_appinfo	Lcom/tencent/mobileqq/pb/PBStringField;
    //   247: invokevirtual 687	com/tencent/mobileqq/pb/PBStringField:has	()Z
    //   250: ifeq +12 -> 262
    //   253: aload 12
    //   255: getfield 695	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:str_appinfo	Lcom/tencent/mobileqq/pb/PBStringField;
    //   258: invokevirtual 689	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   261: astore_1
    //   262: aload 12
    //   264: getfield 698	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:uint32_amount	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   267: invokevirtual 284	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   270: ifeq +13 -> 283
    //   273: aload 12
    //   275: getfield 698	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:uint32_amount	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   278: invokevirtual 286	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   281: istore 8
    //   283: aload 12
    //   285: getfield 701	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:str_jumpurl	Lcom/tencent/mobileqq/pb/PBStringField;
    //   288: invokevirtual 687	com/tencent/mobileqq/pb/PBStringField:has	()Z
    //   291: ifeq +12 -> 303
    //   294: aload 12
    //   296: getfield 701	tencent/im/s2c/msgtype0x210/submsgtype0x7e/submsgtype0x7e$WalletMsgPush:str_jumpurl	Lcom/tencent/mobileqq/pb/PBStringField;
    //   299: invokevirtual 689	com/tencent/mobileqq/pb/PBStringField:get	()Ljava/lang/String;
    //   302: astore_1
    //   303: new 140	org/json/JSONObject
    //   306: dup
    //   307: invokespecial 369	org/json/JSONObject:<init>	()V
    //   310: astore 11
    //   312: new 140	org/json/JSONObject
    //   315: dup
    //   316: invokespecial 369	org/json/JSONObject:<init>	()V
    //   319: astore 12
    ...
    //   334: ldc 151
    //   336: iload 4
    //   338: invokevirtual 382	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   341: pop
    //   342: aload 12
    //   344: ldc_w 703
    //   347: aload 13
    //   349: invokevirtual 377	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   352: pop
    //   353: aload 11
    //   355: ldc_w 705
    //   358: aload_0
    //   359: invokevirtual 211	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   362: invokevirtual 377	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   365: pop
    //   366: aload 11
    //   368: ldc_w 371
    //   371: ldc_w 707
    //   374: invokevirtual 377	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   377: pop
    //   378: aload 11
    //   380: ldc_w 384
    //   383: ldc_w 709
    //   386: invokevirtual 377	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   389: pop
    //   390: aload 11
    //   392: ldc_w 400
    //   395: aload 12
    //   397: invokevirtual 377	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   400: pop
    ...
    //   494: lconst_0
    //   495: invokeinterface 716 4 0
    //   500: lstore_2
    //   501: invokestatic 721	com/tencent/mobileqq/msf/core/NetConnInfoCenter:getServerTimeMillis	()J
    //   504: ldc2_w 508
    //   507: ldiv
    //   508: lstore 5
    //   510: lload 5
    ...
    //   544: lconst_0
    //   545: invokeinterface 725 4 0
    //   550: pop
    //   551: new 727	android/os/Bundle
    //   554: dup
    //   555: invokespecial 728	android/os/Bundle:<init>	()V
    //   558: astore_0
    //   559: aload_0
    //   560: ldc_w 474
    //   563: aload 11
    //   565: invokevirtual 358	org/json/JSONObject:toString	()Ljava/lang/String;
    //   568: invokevirtual 732	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   571: aload_0
    //   572: ldc_w 480
    //   575: ldc_w 482
    //   578: invokevirtual 732	android/os/Bundle:putString	(Ljava/lang/String;Ljava/lang/String;)V
    //   581: new 461	android/content/Intent
    //   584: dup
    //   585: invokestatic 464	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   588: ldc_w 447
    //   591: invokespecial 467	android/content/Intent:<init>	(Landroid/content/Context;Ljava/lang/Class;)V
    //   594: astore 12
    //   596: aload 12
    //   598: ldc_w 553
    //   601: invokevirtual 472	android/content/Intent:addFlags	(I)Landroid/content/Intent;
    //   604: pop
    //   605: aload 12
    //   607: aload_0
    //   608: invokevirtual 736	android/content/Intent:putExtras	(Landroid/os/Bundle;)Landroid/content/Intent;
    //   611: pop
    //   612: aload 12
    //   614: ldc_w 489
    //   617: iconst_5
    //   618: invokevirtual 492	android/content/Intent:putExtra	(Ljava/lang/String;I)Landroid/content/Intent;
    //   621: pop
    //   622: invokestatic 464	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   625: aload 12
    //   627: invokevirtual 503	com/tencent/qphone/base/util/BaseApplication:startActivity	(Landroid/content/Intent;)V
    //   630: invokestatic 739	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   633: ifeq -614 -> 19
    //   636: ldc 78
    //   638: iconst_4
    ...
    //   652: iload 4
    //   654: invokevirtual 307	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   657: ldc_w 743
    //   660: invokevirtual 87	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   663: iload 7
    //   665: invokevirtual 307	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   668: ldc_w 745
    ...
    //   719: iload 8
    //   721: invokevirtual 307	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   724: ldc_w 755
    ...
    //   742: aload 11
    //   744: invokevirtual 358	org/json/JSONObject:toString	()Ljava/lang/String;
    ...
    //   753: invokestatic 760	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   756: return
    //   757: astore_0
    //   758: aload_0
    //   759: invokevirtual 313	java/lang/Exception:printStackTrace	()V
    ...
    //   777: return
    //   778: astore 13
    //   780: invokestatic 739	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   783: ifeq +8 -> 791
    //   786: aload 13
    //   788: invokevirtual 313	java/lang/Exception:printStackTrace	()V
    ...
    //   823: dup
    //   824: invokespecial 369	org/json/JSONObject:<init>	()V
    //   827: astore_0
    //   828: aload_0
    //   829: ldc_w 766
    //   832: iconst_0
    //   833: invokevirtual 382	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   836: pop
    //   837: aload_0
    //   838: ldc_w 768
    //   841: ldc_w 392
    //   844: invokevirtual 377	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   847: pop
    //   848: aload_0
    //   849: ldc_w 770
    //   852: iconst_4
    //   853: invokevirtual 382	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   856: pop
    //   857: aload_0
    //   858: ldc_w 772
    //   861: aload 12
    //   863: invokevirtual 377	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   866: pop
    //   867: new 774	ayan
    //   870: dup
    //   871: iconst_4
    //   872: iconst_0
    //   873: aload_0
    //   874: invokevirtual 358	org/json/JSONObject:toString	()Ljava/lang/String;
    //   877: invokespecial 777	ayan:<init>	(IILjava/lang/String;)V
    //   880: astore_0
    //   881: invokestatic 783	com/tencent/mobileqq/openapi/OpenApiManager:getInstance	()Lcom/tencent/mobileqq/openapi/OpenApiManager;
    //   884: aload_0
    //   885: invokevirtual 787	com/tencent/mobileqq/openapi/OpenApiManager:onPayMsgRsp	(Layan;)V
    //   888: goto -337 -> 551
    //   891: astore 12
    //   893: invokestatic 739	com/tencent/qphone/base/util/QLog:isDevelopLevel	()Z
    //   896: ifeq -29 -> 867
    //   899: aload 12
    //   901: invokevirtual 313	java/lang/Exception:printStackTrace	()V
    //   904: goto -37 -> 867
    //   907: iconst_0
    //   908: istore 9
    //   910: goto -459 -> 451
  ...
  private static void c(QQAppInterface paramQQAppInterface, ajvt paramajvt)
  {
    if (QLog.isColorLevel()) {
      QLog.d("Q.qwallet.push", 2, "startBackgroundPay");
    }
    if ((paramQQAppInterface == null) || (paramQQAppInterface.getApp() == null) || (paramajvt == null)) {}
    for (;;)
    {
      return;
      String str = String.format(BaseApplication.getContext().getString(2131716342), new Object[] { Integer.valueOf(a()) });
      Object localObject = paramajvt.jdField_b_of_type_JavaLangString;
      paramajvt = (ajvt)localObject;
      if (TextUtils.isEmpty((CharSequence)localObject)) {
        paramajvt = BaseApplication.getContext().getString(2131716341);
      }
      ...
      try
      {
        paramQQAppInterface = NotificationFactory.createNotificationCompatBuilder("CHANNEL_ID_SHOW_BADGE").setSmallIcon(2130841438).setWhen(System.currentTimeMillis()).setAutoCancel(true).setContentTitle(str).setContentText(paramajvt).setContentIntent(paramQQAppInterface).build();
        paramajvt = QQNotificationManager.getInstance();
        if (paramajvt != null)
        {
          paramajvt.cancel("Q.qwallet.push", 238);
          paramajvt.notify("Q.qwallet.push", 238, paramQQAppInterface);
          return;
        }
      }
