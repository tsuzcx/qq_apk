...
public class ahmp
{
  ...
  public ahmp(tAdvDesc paramtAdvDesc)
  {
  ...
  public static ahmp a(tAdvDesc paramtAdvDesc)
  {
    ...
    default: 
      return null;
    case 1012: 
      return new ahmp(paramtAdvDesc);
    case 1108: 
      return new biae(paramtAdvDesc);
    }
    return new biag(paramtAdvDesc);
  }
  ...
  protected void a()
  {
    ...
    try
    {
      ...
      localObject = new ahmq();
      ((ahmq)localObject).jdField_a_of_type_JavaLangString = str2;
      ((ahmq)localObject).jdField_b_of_type_JavaLangString = str3;
      ((ahmq)localObject).c = ahmr.a().a(str2);
    ...
    catch (Exception localException)
    {
      ...
      bhku.a().a(2741, this.jdField_a_of_type_BOSSStrategyCenterTAdvDesc.task_id, 102, "json parseError exception = " + localException.getMessage() + " json string = " + str1);
    }
  }
  ...
  public boolean b()
  {
    ...
    {
      ahmq localahmq = (ahmq)this.jdField_a_of_type_AndroidUtilSparseArray.valueAt(i);
      if ((localahmq == null) || (TextUtils.isEmpty(localahmq.c)) || (!localahmq.a())) {
        return false;
      }
      i += 1;
    }
