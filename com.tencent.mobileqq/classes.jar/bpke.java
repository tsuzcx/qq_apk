  ...
  extends bpkh
{
  ...
  public void a()
  {
    ...
    if (localRMVideoStateMgr != null)
    {
      ...
      if (localRMVideoStateMgr.jdField_a_of_type_Bpkn != null) {
        localRMVideoStateMgr.jdField_a_of_type_Bpkn.a();
      }
  ...
  public void a(AVCodec.AVCodecCallback paramAVCodecCallback, MessageStruct paramMessageStruct)
  {
    ...
    paramAVCodecCallback.jdField_a_of_type_Bpkb = null;
    if (QLog.isColorLevel()) {
  ...
  {
    if ((paramObject instanceof bdbl)) {
      switch (paramInt)
      {
      }
    }
      ...
      if (paramVarArgs != null) {
        if ((paramVarArgs[0] instanceof Boolean))
        {
          ...
          if ((localObject != null) && (((String)localObject).endsWith(":story"))) {
            ykv.b("take_video", "camera_initial", 0, 0, new String[0]);
          }
        ...
        else if ((paramVarArgs[0] instanceof String))
        {
          ...
          {
            this.d = true;
            RMVideoStateMgr.a().a(2002, anvx.a(2131712913), false);
          }
          if (QLog.isColorLevel()) {
            QLog.d("RMVideoInitState", 2, "[@] EVENT_CREATE_CAMERA, error = " + paramVarArgs[0]);
          }
          if (1 == bpia.a) {
            QzoneVideoBeaconReport.reportVideoEvent(bprm.a + "", "qzone_video_record", "2", null);
          }
          localObject = BaseApplicationImpl.sApplication.getQQProcessName();
          if ((localObject != null) && (((String)localObject).endsWith(":story")))
          {
            ykv.b("take_video", "camera_initial", 0, -1, new String[0]);
            continue;
            if ((paramVarArgs != null) && ((paramVarArgs[0] instanceof String)))
            {
              ...
              {
                this.d = true;
                RMVideoStateMgr.a().a(2003, anvx.a(2131712924), false);
              }
              if (QLog.isColorLevel())
              {
                ...
                {
                  this.d = true;
                  RMVideoStateMgr.a().a(2002, anvx.a(2131712925), false);
                }
                if (QLog.isColorLevel()) {
                ...
                if (1 == bpia.a)
                {
                  QzoneVideoBeaconReport.reportVideoEvent(bprm.a + "", "qzone_video_record", "4", null);
                  continue;
                  if ((paramObject instanceof AudioCapture))
                  {
                    ...
                    case 3: 
                      ...
                      else
                      {
                        ...
                        while (1 == bpia.a)
                        {
                          QzoneVideoBeaconReport.reportVideoEvent(bprm.a + "", "qzone_video_record", "5", null);
                          break;
                          if (QLog.isColorLevel()) {
                    ...
                    case 5: 
                      ...
                      for (;;)
                      {
                        ...
                        {
                          RMVideoStateMgr.a().b(0, anvx.a(2131712916), false);
                          ((RMVideoStateMgr)localObject).f = true;
                        }
                        if (1 != bpia.a) {
                          break;
                        }
                        QzoneVideoBeaconReport.reportVideoEvent(bprm.a + "", "qzone_video_record", "6", null);
                        break;
                        ((RMVideoStateMgr)localObject).b(false);
                      }
                    case 6: 
    ...
    for (;;)
    {
      if (!((RMVideoStateMgr)localObject).f)
      {
        RMVideoStateMgr.a().b(0, anvx.a(2131712915), false);
        ((RMVideoStateMgr)localObject).f = true;
      }
      if (1 != bpia.a) {
        break;
      }
      QzoneVideoBeaconReport.reportVideoEvent(bprm.a + "", "qzone_video_record", "7", null);
      break;
      ((RMVideoStateMgr)localObject).b(false);
    }
  }
