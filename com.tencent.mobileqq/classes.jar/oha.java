...
public class oha
{
  ...
  public static final int e = bgtn.a(5.0F);
  public int a;
  ...
  public oha(ViewGroup paramViewGroup, ReadInJoyNavigationGridview paramReadInJoyNavigationGridview, ImageView paramImageView)
  {
    this.jdField_a_of_type_Pmn = new ohe(this);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewReadInJoyNavigationGridview.setChannelButtonListener(new ohf(this));
  ...
  {
    JSONObject localJSONObject = pha.b();
    switch (paramInt)
    {
    }
    for (;;)
  ...
  public static void a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      oat.a(null, "CliOper", "", "", str, str, 0, 0, "", "", "", paramString, false);
      return;
      str = "0X8008B81";
      continue;
      str = "0X8008B83";
  ...
  {
    pha.b().postDelayed(new ReadInJoyNaviController.4(this), paramLong);
  }
  ...
  public void a(int paramInt)
  {
    ...
    pha.b().postDelayed(new ReadInJoyNaviController.1(this), 0L);
  }
  ...
  public void a(ChannelCoverInfo paramChannelCoverInfo)
  {
    ...
    for (;;)
    {
      ...
      {
        pha.b().postDelayed(new ReadInJoyNaviController.2(this, paramChannelCoverInfo), 0L);
        return;
      }
      i += 1;
    }
