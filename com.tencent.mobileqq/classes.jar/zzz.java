...
public class zzz
{
    ...
    try
    {
      if (jdField_a_of_type_NS_CERTIFIED_ACCOUNTCertifiedAccountMeta$StUser == null)
      {
        ...
        if (VSNetworkHelper.a() != null) {
          VSNetworkHelper.a().a(new SubscribePersonalDetailRequest(BaseApplicationImpl.getApplication().getRuntime().getAccount(), localStCommonExt), new aaaa());
        }
      }
  ...
  public static void a(CertifiedAccountRead.StGetMainPageRsp paramStGetMainPageRsp)
  {
    ...
    } while (!aaaf.a(localStUser.attr.get()));
