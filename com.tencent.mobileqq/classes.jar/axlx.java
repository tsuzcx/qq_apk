  ...
  implements Handler.Callback, URLDrawable.URLDrawableListener
{
  ...
  WeakReference<axly> jdField_a_of_type_MqqUtilWeakReference;
  ...
  public axlx(Context paramContext, String paramString, View paramView)
  {
    ColorDrawable localColorDrawable = new ColorDrawable(0);
    localColorDrawable.setBounds(0, 0, 0, this.jdField_a_of_type_Int);
  ...
  public void onLoadSuccessed(URLDrawable paramURLDrawable)
  {
    ...
    if ((i > 0) && (j > 0))
    {
      ...
      {
        paramURLDrawable = (axly)this.jdField_a_of_type_MqqUtilWeakReference.get();
