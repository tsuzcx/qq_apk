...
public class src
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new srf(this, Looper.getMainLooper());
  ...
  public src(Activity paramActivity, AppRuntime paramAppRuntime, View paramView, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131380601));
  }
  ...
  public void a(VideoInfo paramVideoInfo)
  {
    ...
    do
    {
      ...
      i = bmhv.E(this.jdField_a_of_type_MqqAppAppRuntime);
    } while (i >= 3);
    bmhv.A(this.jdField_a_of_type_MqqAppAppRuntime, i + 1);
    ...
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131380606);
    if (!TextUtils.isEmpty(paramVideoInfo.g)) {
      localTextView.setText(anvx.a(2131715524));
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new srd(this));
      this.jdField_b_of_type_AndroidViewAnimationTranslateAnimation.setAnimationListener(new sre(this));
      this.jdField_a_of_type_AndroidOsHandler.postDelayed(new VideofeedsUserGuideController.4(this), 300L);
      return;
      localTextView.setText(anvx.a(2131715523));
    }
  }
