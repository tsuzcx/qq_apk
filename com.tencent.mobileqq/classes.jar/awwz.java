...
{
  private DialogInterface.OnKeyListener jdField_a_of_type_AndroidContentDialogInterface$OnKeyListener = new awxa(this);
  private TextView jdField_a_of_type_AndroidWidgetTextView;
  public awxb a;
  private FileSaveProgressView jdField_a_of_type_ComTencentMobileqqMultimsgSaveFileSaveProgressView;
  
  public awwz(@NonNull Context paramContext)
  {
    super(paramContext, 2131755186);
    a(paramContext);
  }
  ...
  private void a(@NonNull Context paramContext)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqMultimsgSaveFileSaveProgressView = ((FileSaveProgressView)paramContext.findViewById(2131376875));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131364112));
