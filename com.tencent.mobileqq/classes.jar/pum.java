  ...
  extends pwd
{
  ...
  private HashMap<String, pur<Parcelable>> jdField_a_of_type_JavaUtilHashMap = new HashMap();
  ...
  private ConcurrentHashMap<String, pur<FastWebArticleInfo>> b = new ConcurrentHashMap();
  
  static
  {
    jdField_a_of_type_JavaLangString = pum.class.getSimpleName();
  }
  
  public pum(AppInterface paramAppInterface, EntityManager paramEntityManager, ExecutorService paramExecutorService, qli paramqli, Handler paramHandler)
  {
  ...
  {
    int i = bhov.a(null);
    Object localObject = bkwm.f(pay.a());
  ...
  private void b()
  {
    this.jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache = new pun(this, 2012, 30, 1);
  }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = qlk.a(paramFromServiceMsg, paramObject, localRspBody);
    boolean bool1 = false;
    boolean bool2 = false;
    ...
    for (;;)
    {
      paramFromServiceMsg = (puq)a(Integer.valueOf(i));
      ...
      if (str != null)
      {
        ...
        this.b.put(str, new pur(this, paramToServiceMsg));
      }
      for (;;)
      {
        ...
        {
          paramFromServiceMsg = (pur)this.b.get(str);
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = qlk.a(paramFromServiceMsg, paramObject, paramToServiceMsg);
    paramFromServiceMsg = new swh();
    boolean bool;
    ...
    for (;;)
    {
      paramToServiceMsg = (pup)a(Integer.valueOf(i));
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    int k = qlk.a(paramFromServiceMsg, paramObject, localRspBody);
    paramFromServiceMsg = (tcn)a(Integer.valueOf(i));
    paramToServiceMsg = "";
  ...
  public int a(String paramString1, String paramString2, String paramString3, int paramInt, puq parampuq)
  {
    for (;;)
    {
      Object localObject1;
      try
      {
        QLog.d("Q.readinjoy.fast_web", 1, "getArticleContent, rowkey : " + paramString2 + ", url : " + paramString1 + " callback: " + parampuq + ", reqType : " + paramInt);
        if ((paramInt != 2) && (paramString2 != null))
        {
          localObject1 = (pur)this.b.get(paramString2);
          if (localObject1 != null)
          {
            if (!((pur)localObject1).a()) {
              continue;
            }
        ...
        ((oidb_cmd0xad6.Client)localObject2).bytes_version.set(ByteStringMicro.copyFromUtf8("8.4.8"));
        ...
        if (paramInt == 1)
        {
          ...
          paramString3 = qlk.a("OidbSvc.0xad6", 2774, 0, ((oidb_cmd0xad6.ReqBody)localObject1).toByteArray());
          ...
          if (parampuq != null)
          {
            parampuq.a(true, ((pur)localObject1).a, (FastWebArticleInfo)((pur)localObject1).a());
            odq.a(null, "CliOper", "", "", "0X8009C51", "0X8009C51", 0, 0, "", "", "", "", false);
          }
          QLog.d("Q.readinjoy.fast_web", 2, "hit cache, rowkey : " + paramString2 + ", url : " + paramString1 + " isUserWeb " + ((pur)localObject1).a);
          return -1;
        }
        if (paramInt == 3)
        {
  ...
  {
    paramString = (pur)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
  ...
  {
    paramString = (pur)this.b.get(paramString);
    if (paramString != null) {
  ...
  {
    return swt.a((List)this.jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache.get(paramString));
  }
  ...
  public void a(@NonNull ArticleInfo paramArticleInfo, int paramInt, tcn paramtcn)
  {
    ...
    for (;;)
    {
      ...
      localFeedParam.multi_level_info.set(paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rep.a());
      ...
      try
      {
        ...
        localObject = qlk.a("OidbSvc.0xbd3", 3027, 0, localReqBody.toByteArray());
        int i = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
  ...
  public void a(ArticleInfo paramArticleInfo, pup parampup, boolean paramBoolean)
  {
    Object localObject1 = new oidb_cmd0xb54.ReqBody();
    Object localObject2 = new oidb_cmd0xb54.Client();
    ((oidb_cmd0xb54.Client)localObject2).bytes_version.set(ByteStringMicro.copyFromUtf8("8.4.8"));
    ...
    if (bkwm.j(this.jdField_a_of_type_ComTencentCommonAppAppInterface) != 1) {
    ...
    Object localObject3 = (pur)this.b.get(paramArticleInfo.innerUniqueID);
    if (localObject3 != null)
    {
      localObject3 = (FastWebArticleInfo)((pur)localObject3).a();
    ...
    localObject1 = qlk.a("OidbSvc.0xb54", 2900, 0, ((oidb_cmd0xb54.ReqBody)localObject1).toByteArray());
    int i = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
  ...
  public void a(BaseArticleInfo paramBaseArticleInfo, List<BaseData> paramList)
  {
    ...
    qlg.a(localReqBody.bytes_qq, pay.a());
    Object localObject = new oidb_cmd0xe7e.WebInfo();
    qlg.a(((oidb_cmd0xe7e.WebInfo)localObject).bytes_url, paramBaseArticleInfo.mArticleContentUrl);
    try
    {
      qlg.a(((oidb_cmd0xe7e.WebInfo)localObject).bytes_domain, new URL(paramBaseArticleInfo.mArticleContentUrl).getHost());
      localReqBody.rpt_web_info.set((MessageMicro)localObject);
      qlg.a(localReqBody.bytes_rowkey, paramBaseArticleInfo.innerUniqueID);
      localObject = new ArrayList();
    ...
    catch (MalformedURLException localMalformedURLException)
    {
      for (;;)
      {
        qlg.a(((oidb_cmd0xe7e.WebInfo)localObject).bytes_domain, "post.mp.qq.com");
        ...
        if ((paramBaseArticleInfo instanceof PtsData))
        {
          ...
          a(qlk.a("OidbSvc.0xe7e", 3710, 0, localReqBody.toByteArray()));
        }
        else
        {
  ...
  {
    pur localpur = (pur)this.jdField_a_of_type_JavaUtilHashMap.get(paramString);
    if (localpur == null)
    {
      paramParcelable = new pur(this, paramParcelable);
      this.jdField_a_of_type_JavaUtilHashMap.put(paramString, paramParcelable);
      return;
    }
    localpur.a(paramParcelable);
  }
  
  public void a(String paramString1, String paramString2, String paramString3, int paramInt, pup parampup)
  {
    oidb_cmd0xad7.ReqBody localReqBody = new oidb_cmd0xad7.ReqBody();
    Object localObject = new oidb_cmd0xad7.Client();
    ((oidb_cmd0xad7.Client)localObject).bytes_version.set(ByteStringMicro.copyFromUtf8("8.4.8"));
    ...
    try
    {
      ...
      if (paramInt == 72)
      {
        ...
        paramString3 = qlk.a("OidbSvc.0xad7", 2775, 0, localReqBody.toByteArray());
        int i = this.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.incrementAndGet();
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (paramToServiceMsg = localRspBody.rpt_insert_module_info.get();; paramToServiceMsg = null)
    {
      ...
      pkp.a().a(new puo(this, paramToServiceMsg, paramFromServiceMsg));
      return;
    }
  }
  ...
  public void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    paramFromServiceMsg = (pup)b(Integer.valueOf(i));
    paramObject = (pur)this.b.get(str2);
    if (paramObject == null) {
      return;
    }
    ...
    if (j == 0)
    {
      pus.a(localRspBody, paramObject, paramFromServiceMsg, str1);
      pus.b(localRspBody, paramObject, paramFromServiceMsg, str1);
      pus.a(localRspBody, paramObject, paramFromServiceMsg);
      pus.c(localRspBody, paramObject, paramFromServiceMsg, str1);
      pus.a(localRspBody, paramObject);
      if (((Boolean)paramToServiceMsg.getAttribute("fetchBusiness", Boolean.valueOf(false))).booleanValue()) {
        pus.b(localRspBody, paramObject, paramFromServiceMsg);
      }
    }
    for (;;)
    {
