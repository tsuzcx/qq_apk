  ...
  implements Runnable
{
  ...
  public yza(SpriteContext paramSpriteContext, boolean paramBoolean1, boolean paramBoolean2, String paramString)
  {
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ThreadManager.getUIHandler().post(new yzb(this, (IApolloRenderView)localObject1));
      return;
