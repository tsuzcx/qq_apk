...
final class mzj
  implements myy
{
  mzj(WeakReference paramWeakReference, String paramString1, int paramInt, String paramString2) {}
  ...
  public void loaded(String paramString, int paramInt)
  {
    ...
    for (long l = this.jdField_a_of_type_Int;; l = -1L)
    {
      ...
      QLog.i(mzi.jdField_a_of_type_JavaLangString, 1, "finish predown bid=" + this.b + ", code=" + paramInt);
      mzi.a();
      if (mzi.b() == 0)
      {
        ...
        paramString.putExtra("verify", mzi.a((ArrayList)localObject, false));
        if (QLog.isColorLevel()) {
          QLog.d(mzi.jdField_a_of_type_JavaLangString, 2, "sendBroadcast to close TMAssistant sdk process");
        }
