...
public class mzj
{
  ...
  protected mzj a()
  {
    mzj localmzj = new mzj();
    try
    {
      localmzj.jdField_a_of_type_Int = this.jdField_a_of_type_Int;
      localmzj.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_JavaLangString;
      localmzj.jdField_b_of_type_JavaLangString = this.jdField_b_of_type_JavaLangString;
      localmzj.jdField_c_of_type_JavaLangString = this.jdField_c_of_type_JavaLangString;
      localmzj.jdField_a_of_type_Mzi = this.jdField_a_of_type_Mzi;
      localmzj.f = this.f;
      localmzj.g = this.g;
      localmzj.h = this.h;
      localmzj.i = this.i;
      ...
      localmzj.e = this.e;
      localmzj.j = this.j;
      localmzj.jdField_b_of_type_Int = this.jdField_b_of_type_Int;
      localmzj.jdField_b_of_type_Long = this.jdField_b_of_type_Long;
      localmzj.jdField_c_of_type_Long = this.jdField_c_of_type_Long;
      localmzj.m = this.m;
      localmzj.l = this.l;
      localmzj.jdField_a_of_type_Long = this.jdField_a_of_type_Long;
      localmzj.k = this.k;
      return localmzj;
    }
  ...
  public final void a(AvGameList.GameListItemInfo paramGameListItemInfo)
  {
    ...
    this.jdField_a_of_type_Mzi.a((AvGameCommon.GameInfo)paramGameListItemInfo.game_info.get());
