...
public abstract class aqeq
  extends aqbc
  implements bdeg
{
  protected static final Object a;
  private Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new aqer(this);
  protected Handler a;
  public aqaq a;
  aqey jdField_a_of_type_Aqey = new aqey(this);
  protected aqez a;
  ...
  public aqeq(Intent paramIntent)
  {
    super(paramIntent);
    this.jdField_a_of_type_MqqObserverBusinessObserver = new aqeu(this);
    this.jdField_b_of_type_AndroidOsHandler = new aqex(this);
  }
  ...
  private void L()
  {
    try
    {
      bdjo.a().a(0, "SHARE_TO_QQ", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), String.valueOf(this.jdField_b_of_type_Long), "4", Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, null);
      return;
    }
  ...
  private void a(String paramString, Bundle paramBundle, boolean paramBoolean)
  {
    if (this.jdField_c_of_type_Boolean) {
      aqgh.a(paramString, paramBundle, paramBoolean);
    }
  }
  ...
  {
    if (this.jdField_c_of_type_Boolean) {
      aqgh.a(paramString, paramBoolean);
    }
  }
  ...
  private boolean p()
  {
    if ((!this.jdField_c_of_type_Boolean) || (!this.n) || (this.jdField_a_of_type_Aqaq == null)) {
      return false;
    }
    ...
    {
      str = this.jdField_a_of_type_Aqaq.e();
      ...
      for (str = "1";; str = "0")
      {
        ...
        bded.a().a((Bundle)localObject, "" + this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), false);
        return true;
      }
    }
    return false;
  ...
  private boolean q()
  {
    ...
    if ((i1 == 5) && (!TextUtils.isEmpty(str)) && (!str.startsWith("http://")) && (!str.startsWith("https://")))
    {
      ...
      for (localObject = ((File)localObject).getAbsolutePath();; localObject = "")
      {
        ...
        localObject = new aqet(this);
        bbcv.a(this.jdField_a_of_type_AndroidAppActivity, 233, ajyc.a(2131720249), ajyc.a(2131719484), -1, 2131719483, (DialogInterface.OnClickListener)localObject, null).show();
        return true;
      }
    }
    return false;
  ...
  protected void G()
  {
    ...
    if (naw.a((String)localObject1, "UTF-8") > 80) {
      localObject3 = naw.a((String)localObject1, 80, "UTF-8", null);
    }
    localObject1 = localObject2;
    if (naw.a((String)localObject2, "UTF-8") > 130) {
      localObject1 = naw.a((String)localObject2, 130, "UTF-8", null);
    }
  ...
  public final void H()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.ssoGetTicketNoPasswd(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 4096, this.jdField_a_of_type_Aqey);
  }
  ...
  public void K()
  {
    ...
    do
    {
      ...
      axrl.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "sha_share2qq", 1, "", "", String.valueOf(this.jdField_b_of_type_Long));
      if (this.jdField_c_of_type_Int != 5) {
        break label645;
      }
      localObject1 = "connect_sharepic";
      nax.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject2, (String)localObject1, "send", this.jdField_b_of_type_Long, f(), String.valueOf(i1));
      a(0, "", "");
      ...
      ((Bundle)localObject1).putString("intext_2", "" + bdej.a(i1, (String)localObject2));
    ...
    for (int i1 = 0;; i1 = this.jdField_a_of_type_Aqaq.a())
    {
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    if (this.jdField_a_of_type_Xoc == null)
    {
      ...
      this.jdField_a_of_type_Xoc.a(new aqes(this));
    }
    for (;;)
    {
      ...
      this.jdField_a_of_type_Xoc.a((String)localObject, c());
      ...
      if (paramInt1 == 0)
      {
        ...
        L();
        this.jdField_a_of_type_Xoc.b(null, null);
      }
      try
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Xoc.b(this.jdField_a_of_type_AndroidAppActivity.getString(2131718747), c());
          break;
          if (paramInt1 == 1003) {
            this.jdField_a_of_type_Xoc.a(2131692233);
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      if (!q())
      {
        ...
        if (paramInt == g.intValue()) {
          this.jdField_a_of_type_Bbgg.setEditLint("");
        }
      }
    ...
    localBundle.putString("intext_1", "" + bdej.a(this.jdField_c_of_type_Int));
    localBundle.putString("intext_2", "" + bdej.a(paramBundle.getInt("uintype"), paramBundle.getString("uin")));
    localBundle.putString("intext_3", "0");
    bded.a().a(localBundle, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
  }
  ...
  protected void a(String paramString, boolean paramBoolean)
  {
    ...
    localbbgg.setTitle(this.jdField_a_of_type_AndroidAppActivity.getString(2131719482));
    Object localObject;
    if (paramBoolean)
    {
      localObject = paramString;
      if (TextUtils.isEmpty(paramString)) {
        localObject = this.jdField_a_of_type_AndroidAppActivity.getString(2131719485);
      }
      localbbgg.setMessageWithUrl((String)localObject);
    }
    for (;;)
    {
      localObject = localbbgg.setPositiveButton(2131719411, new aqew(this));
      StringBuilder localStringBuilder = new StringBuilder().append(this.jdField_a_of_type_AndroidAppActivity.getString(2131690572));
      paramString = str;
      if (TextUtils.isEmpty(str)) {
        paramString = "";
      }
      ((bbgg)localObject).setNegativeButton(paramString, new aqev(this));
      localbbgg.setCancelable(false);
      localbbgg.show();
      return;
      localbbgg.setMessage(2131719485);
    }
  }
  ...
  public boolean a()
  {
    ...
    for (;;)
    {
      ...
      ((Bundle)localObject2).putString("intext_1", "" + bdej.a(this.jdField_c_of_type_Int));
      ((Bundle)localObject2).putString("intext_3", "0");
      bded.a().a((Bundle)localObject2, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
      if ((this.jdField_c_of_type_Int == 5) && (TextUtils.isEmpty(str1)) && (TextUtils.isEmpty((CharSequence)localObject1)))
      {
        ...
        a(-1, ajyc.a(2131704798), ajyc.a(2131704810));
      }
      try
      {
        bdjo.a().a(1, "SHARE_CHECK_AGENT", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), String.valueOf(this.jdField_b_of_type_Long), null, Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "分享的图片不存在");
        return false;
        localObject1 = null;
        continue;
        if (((aqfm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(350)).a().a())
        {
        ...
        if ((l1 > 0L) && (!"101735437".equals(String.valueOf(l1))))
        {
          ...
          if (TextUtils.isEmpty((CharSequence)localObject2))
          {
            ...
            long l4 = aqft.a();
            e("KEY_GET_APP_INFO");
            xmt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), l1, (String)localObject1, l2, l3, this.jdField_a_of_type_MqqObserverBusinessObserver, (String)localObject2, l4, true);
            return true;
          }
  ...
  protected void e()
  {
    if (this.jdField_a_of_type_Aqaq.a())
    {
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Aqaq.a())) {
        this.jdField_a_of_type_AndroidOsBundle.putString("struct_share_key_source_icon", this.jdField_a_of_type_Aqaq.a());
      }
      String str = this.jdField_a_of_type_Aqaq.e();
      if (!TextUtils.isEmpty(str)) {
        this.jdField_a_of_type_AndroidOsBundle.putString("struct_share_key_source_icon_big", str);
      }
      if ((!TextUtils.isEmpty(this.jdField_a_of_type_Aqaq.b())) && (this.jdField_b_of_type_Long != Long.parseLong("1103584836"))) {
        this.jdField_a_of_type_AndroidOsBundle.putString("struct_share_key_source_url", this.jdField_a_of_type_Aqaq.b());
      }
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Aqaq.c())) {
        this.jdField_a_of_type_AndroidOsBundle.putString("struct_share_key_source_name", this.jdField_a_of_type_Aqaq.c());
      }
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Aqaq.d())) {
        this.jdField_a_of_type_AndroidOsBundle.putString("struct_share_key_source_a_action_data", this.jdField_a_of_type_Aqaq.d());
      }
      if (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg != null)
      {
  ...
  protected void o()
  {
    ...
    localBundle.putString("intext_1", "" + bdej.a(this.jdField_c_of_type_Int));
    localBundle.putString("intext_2", "" + bdej.a(this.jdField_a_of_type_AndroidOsBundle.getInt("uintype"), this.jdField_a_of_type_AndroidOsBundle.getString("uin")));
    localBundle.putString("intext_3", "0");
    bded.a().a(localBundle, "", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
  }
