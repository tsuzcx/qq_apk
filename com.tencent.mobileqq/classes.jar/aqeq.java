  ...
  implements Manager
{
  ...
  ante jdField_a_of_type_Ante = new aqet(this);
  private aqeg jdField_a_of_type_Aqeg;
  public aqeh a;
  private aqej jdField_a_of_type_Aqej = new aqes(this);
  private aqep jdField_a_of_type_Aqep = new aqer(this);
  private AppInterface jdField_a_of_type_ComTencentCommonAppAppInterface;
  public Runnable a;
  public String a;
  public ArrayList<WeakReference<aokb>> a;
  public ConcurrentHashMap<String, DynamicAvatar> a;
  public volatile boolean a;
  private Runnable b;
  public String b;
  public ArrayList<WeakReference<aokb>> b;
  public ArrayList<WeakReference<aokb>> c;
  public ArrayList<WeakReference<aokb>> d;
  ...
  public aqeq(AppInterface paramAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentCommonAppAppInterface.addObserver(this.jdField_a_of_type_Aqep, true);
    this.d = new ArrayList();
    this.c = new ArrayList();
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_b_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
    this.jdField_a_of_type_Aqeh = new aqeh(paramAppInterface);
    ...
    a();
    jdField_a_of_type_Int = this.jdField_a_of_type_Aqeg.jdField_a_of_type_Int;
  ...
  private Setting a(int paramInt, String paramString)
  {
    ...
    if (paramInt == 18)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof NearbyAppInterface)) {
        localObject1 = ((aoke)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(axoc.k)).a(paramString);
      }
    }
    do
    {
  ...
  public static String a(aokb paramaokb, boolean paramBoolean)
  {
    if (paramaokb == null) {
      return "";
    }
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(paramaokb.jdField_b_of_type_Int).append("_").append(paramaokb.jdField_c_of_type_Int).append("_").append(paramaokb.jdField_a_of_type_JavaLangString);
    if ((paramBoolean) || ((paramaokb.jdField_e_of_type_Boolean) && (!TextUtils.isEmpty(paramaokb.jdField_b_of_type_JavaLangString)))) {
      localStringBuilder.append("_").append(paramaokb.jdField_b_of_type_JavaLangString);
    }
    return localStringBuilder.toString();
  }
  ...
  private void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    synchronized (this.c)
    {
      ...
      if (j >= 0)
      {
        ...
        {
          aokb localaokb = (aokb)localWeakReference.get();
          if (localaokb == null) {
            this.c.remove(j);
          } else if (paramString1.equals(localaokb.jdField_d_of_type_JavaLangString)) {
            if (TextUtils.isEmpty(paramString2))
            {
              localaokb.jdField_a_of_type_ComTencentImageURLDrawable = null;
              localaokb.a();
              this.c.remove(j);
            }
            else
            {
              localaokb.jdField_b_of_type_JavaLangString = paramString2;
              localaokb.jdField_c_of_type_JavaLangString = paramString3;
              if ((localaokb.jdField_a_of_type_MqqUtilWeakReference == null) || (localaokb.jdField_a_of_type_MqqUtilWeakReference.get() == null) || (!paramString2.equals(((DynamicAvatarView)localaokb.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_JavaLangString))) {
                break label225;
              }
  ...
  public aqeg a()
  {
    if (this.jdField_a_of_type_Aqeg == null) {
      a();
    }
    if (QLog.isColorLevel()) {
      QLog.d("Q.dynamicAvatar", 2, "getConfig DynamicAvatarConfig|" + this.jdField_a_of_type_Aqeg);
    }
    return this.jdField_a_of_type_Aqeg;
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Aqeg = new aqeg();
    if (QLog.isColorLevel()) {
      QLog.d("Q.dynamicAvatar", 2, "DynamicAvatarConfig|init config:" + this.jdField_a_of_type_Aqeg + ",costTime:" + (System.currentTimeMillis() - l));
    }
  }
  
  public void a(aokb paramaokb)
  {
    if (paramaokb == null) {
      return;
    }
    synchronized (this.d)
    {
      this.d.remove(paramaokb.jdField_b_of_type_MqqUtilWeakReference);
    }
    synchronized (this.jdField_a_of_type_JavaUtilArrayList)
    {
      this.jdField_a_of_type_JavaUtilArrayList.remove(paramaokb.jdField_b_of_type_MqqUtilWeakReference);
      this.jdField_b_of_type_JavaUtilArrayList.remove(paramaokb.jdField_b_of_type_MqqUtilWeakReference);
      synchronized (this.c)
      {
        this.c.remove(paramaokb.jdField_b_of_type_MqqUtilWeakReference);
        return;
      }
      paramaokb = finally;
      throw paramaokb;
  ...
  public void a(aokb paramaokb, boolean paramBoolean)
  {
    if (paramaokb == null) {
      return;
    }
    if (paramBoolean)
    {
      String str = a(paramaokb, false);
      ArrayList localArrayList2 = (ArrayList)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramaokb.jdField_e_of_type_Int);
      ArrayList localArrayList1 = localArrayList2;
      if (localArrayList2 == null)
      {
        localArrayList1 = new ArrayList();
        this.jdField_a_of_type_AndroidUtilSparseArray.put(paramaokb.jdField_e_of_type_Int, localArrayList1);
      }
      localArrayList1.add(str);
      localArrayList1.add(a(paramaokb, true));
      if ((paramaokb.jdField_e_of_type_Int == 1) || (paramaokb.jdField_e_of_type_Int == 0)) {
        ThreadManager.post(new DynamicAvatarManager.6(this, paramaokb, System.currentTimeMillis()), 5, null, true);
      }
      if (paramaokb.jdField_a_of_type_MqqUtilWeakReference.get() != null) {
        ((DynamicAvatarView)paramaokb.jdField_a_of_type_MqqUtilWeakReference.get()).jdField_a_of_type_JavaLangString = "";
      }
    }
    ThreadManager.postImmediately(new DynamicAvatarManager.7(this, paramaokb), null, true);
  }
  
  public void a(aokb paramaokb, boolean paramBoolean1, boolean paramBoolean2)
  {
    if ((this.c.size() < jdField_a_of_type_Int) || (paramBoolean1))
    {
      ??? = paramaokb.jdField_d_of_type_JavaLangString;
      synchronized (this.c)
      {
        this.c.add(paramaokb.jdField_b_of_type_MqqUtilWeakReference);
        if (paramBoolean1) {}
      }
      for (;;)
      {
        ...
        {
          this.d.remove(paramaokb.jdField_b_of_type_MqqUtilWeakReference);
          ??? = new DynamicAvatarManager.3(this, paramaokb, (String)???);
          if (!paramBoolean2)
          {
            l1 = 0L;
            long l2 = l1;
        ...
        if (paramaokb.jdField_e_of_type_Int == 0) {
          l1 = 1500L;
        } else {
          l1 = 400L;
        }
    ...
    synchronized (this.d)
    {
      this.d.add(paramaokb.jdField_b_of_type_MqqUtilWeakReference);
      return;
    }
  }
  
  public void a(aqek paramaqek)
  {
    if (paramaqek == null) {}
    while (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) {
      return;
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          if ((paramaqek == null) || (paramaqek.jdField_a_of_type_JavaUtilArrayList == null) || (paramaqek.jdField_a_of_type_JavaUtilArrayList.isEmpty())) {
            continue;
          }
          paramaqek = paramaqek.jdField_a_of_type_JavaUtilArrayList.iterator();
          if (!paramaqek.hasNext()) {
            continue;
          }
          localObject1 = DynamicAvatar.convertFrom((aqel)paramaqek.next());
          if (localObject1 == null) {
            continue;
          }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramString.basicSmallUrl)) {
        localObject = aqeh.a(paramString.basicSmallUrl);
      }
      try
      {
        ...
        if (!TextUtils.isEmpty(paramString.basicMiddleUrl)) {
          localObject = aqeh.a(paramString.basicMiddleUrl);
        }
      }
      catch (Exception localException1)
      {
        try
        {
          do
          {
            ...
            paramString = aqeh.a(paramString.basicBigUrl);
            try
            {
  ...
  {
    if ((paramBoolean) && (this.jdField_a_of_type_Aqeg != null) && (this.jdField_a_of_type_Aqeg.jdField_a_of_type_Boolean)) {}
    synchronized (this.jdField_a_of_type_Aqeg)
    {
      this.jdField_a_of_type_Aqeg.a();
      if (QLog.isColorLevel()) {
        QLog.d("Q.dynamicAvatar", 2, "---onDpcPullFinished---|mDynamicAvatarConfig:" + this.jdField_a_of_type_Aqeg);
      }
      if (QLog.isColorLevel()) {
  ...
  public boolean a(int paramInt)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.dynamicAvatar", 2, "isPlayDynamicAvatar|source:" + paramInt + ",isPlay:" + bool1 + "\n" + this.jdField_a_of_type_Aqeg);
      }
      return bool1;
      bool1 = this.jdField_a_of_type_Aqeg.jdField_c_of_type_Boolean;
      continue;
      bool1 = this.jdField_a_of_type_Aqeg.d;
      continue;
      bool1 = this.jdField_a_of_type_Aqeg.f;
      continue;
      bool1 = this.jdField_a_of_type_Aqeg.g;
      continue;
      bool1 = this.jdField_a_of_type_Aqeg.jdField_e_of_type_Boolean;
      continue;
      bool1 = this.jdField_a_of_type_Aqeg.h;
      continue;
      bool1 = true;
      continue;
      bool1 = this.jdField_a_of_type_Aqeg.f;
  ...
  @TargetApi(11)
  public boolean a(aokb paramaokb)
  {
    int i = 640;
    Object localObject1;
    Object localObject2;
    ...
    if (!paramaokb.f)
    {
      localObject1 = a(paramaokb, false);
      localObject2 = (ArrayList)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramaokb.jdField_e_of_type_Int);
    ...
    File localFile = aqeh.a(paramaokb.jdField_b_of_type_JavaLangString);
    if (paramaokb.jdField_d_of_type_Int == 640) {}
    for (;;)
    {
      URLDrawable.URLDrawableOptions localURLDrawableOptions = URLDrawable.URLDrawableOptions.obtain();
      localURLDrawableOptions.mRequestWidth = i;
      localURLDrawableOptions.mRequestHeight = i;
      localObject2 = paramaokb.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
      localObject1 = localObject2;
      ...
      ((VideoDrawable.VideoDrawableParams)localObject1).mRequestedFPS = this.jdField_a_of_type_Aqeg.jdField_c_of_type_Int;
      int j = i;
      if (bdfk.b()) {
        j = bheg.a(i);
      }
      ...
      boolean bool2 = paramaokb.a(URLDrawable.getDrawable(localFile, localURLDrawableOptions));
      bool1 = bool2;
      if (!bool2) {
        break;
      }
      ...
      bool1 = bool2;
      if (aokb.jdField_a_of_type_ArrayOfInt.length <= paramaokb.jdField_e_of_type_Int) {
        break;
      }
      bool1 = bool2;
      ...
      aqfc.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, "0X800711C", aokb.jdField_a_of_type_ArrayOfInt[paramaokb.jdField_e_of_type_Int]);
      return bool2;
      if (paramaokb.jdField_d_of_type_Int == 200) {
        i = 200;
      } else {
        i = 100;
      }
  ...
  public void b(aokb paramaokb)
  {
    ...
    do
    {
      ...
      ??? = a(paramaokb, false);
      localArrayList = (ArrayList)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramaokb.jdField_e_of_type_Int);
    ...
    a(paramaokb, true, true);
  }
  
  public void b(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (this.jdField_a_of_type_Aqeh == null) {
      return;
    }
    this.jdField_a_of_type_Aqeh.a(paramString);
  }
    ...
    synchronized (this.d)
    {
      ...
      if (i >= 0)
      {
        ...
        if ((localWeakReference1 != null) && (localWeakReference1.get() != null)) {
          ((aokb)localWeakReference1.get()).a();
        } else {
          this.d.remove(i);
        }
      }
      ...
      synchronized (this.c)
      {
        ...
        if (m >= jdField_a_of_type_Int)
        {
          ...
          if (j >= k - i)
          {
            ...
            ((ArrayList)localObject2).add(((aokb)localWeakReference2.get()).jdField_b_of_type_JavaLangString);
            break label434;
          }
        }
        else
        ...
        if (this.jdField_a_of_type_Aqeh != null) {
          this.jdField_a_of_type_Aqeh.a((ArrayList)localObject2);
        }
      }
      synchronized (this.d)
      {
        ...
        while (i >= 0)
        {
          ...
          {
            a((aokb)((WeakReference)localObject2).get(), false, false);
            i -= 1;
            continue;
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_ComTencentCommonAppAppInterface.removeObserver(this.jdField_a_of_type_Aqep);
    this.jdField_a_of_type_Aqeh.b();
    this.jdField_a_of_type_Aqeh = null;
    this.jdField_a_of_type_Aqep = null;
