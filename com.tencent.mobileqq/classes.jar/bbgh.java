...
public class bbgh
{
  private static bbgh jdField_a_of_type_Bbgh;
  private int jdField_a_of_type_Int = -1;
  
  public static bbgh a()
  {
    if (jdField_a_of_type_Bbgh == null) {
      jdField_a_of_type_Bbgh = new bbgh();
    }
    return jdField_a_of_type_Bbgh;
  }
  ...
  public void a(BoyDataReport paramBoyDataReport)
  {
    ...
    while (paramBoyDataReport.hasNext())
    {
      ...
      {
        localObject2 = (bbgi)localHashMap.get(((BoyDataReport.BoyItem)localObject1).mId);
        ((bbgi)localObject2).b();
      ...
      else
      {
        ...
        for (int i = 1;; i = 0)
        {
          localObject2 = new bbgi(this, (String)localObject2, 1, i);
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      paramBoyDataReport.put(localObject2, String.valueOf(((bbgi)localHashMap.get(localObject2)).a()));
    }
    bdmc.a(BaseApplicationImpl.getContext()).a(null, "dg_action_match", true, 0L, 0L, paramBoyDataReport, "");
  }
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (this.jdField_a_of_type_Int == 0)
    {
      ...
      localbdmc = bdmc.a(BaseApplicationImpl.getContext());
    ...
    {
      localbdmc.a(null, "dg_entrance_state", bool, 0L, 0L, (HashMap)localObject, "");
