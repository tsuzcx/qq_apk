...
public class aoai
  implements Handler.Callback, aoam, aoaw
{
  ...
  private volatile aoah jdField_a_of_type_Aoah;
  private volatile aoal jdField_a_of_type_Aoal;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = amtj.a(2131699916);
    jdField_b_of_type_JavaLangString = amtj.a(2131699917);
    jdField_c_of_type_JavaLangString = amtj.a(2131699912);
    jdField_d_of_type_JavaLangString = amtj.a(2131699913);
    jdField_e_of_type_JavaLangString = amtj.a(2131699915);
    jdField_f_of_type_JavaLangString = amtj.a(2131699919);
    jdField_g_of_type_JavaLangString = amtj.a(2131699914);
    jdField_h_of_type_JavaLangString = amtj.a(2131699918);
  }
  ...
  private boolean c()
  {
    return (a()) && (this.jdField_a_of_type_Aoah.a());
  }
  ...
  private void d(int paramInt)
  {
    ...
    if (c())
    {
      if (this.jdField_a_of_type_Aoal != null)
      {
        this.jdField_a_of_type_Aoal.a(0);
        this.jdField_a_of_type_Aoal.b();
      }
      if ((paramInt == 2) || (paramInt == 4) || (paramInt == 6) || (paramInt == 1) || (paramInt == 3))
      {
        this.jdField_a_of_type_Aoah.a(false, true);
        this.m = paramInt;
    ...
    {
      return;
      this.jdField_a_of_type_Aoah.a(false, false);
      if (!QLog.isColorLevel()) {
        break;
      }
      ...
      if (this.jdField_a_of_type_Aoah != null) {
        this.jdField_a_of_type_Aoah.a(false, false);
      }
  ...
  private void e(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (!this.jdField_c_of_type_Boolean) {
        if (paramInt == 11) {
          aoae.a(jdField_a_of_type_JavaLangString, false);
        }
      }
      for (;;)
      {
  ...
  private void j()
  {
    ...
    {
      return;
      if ((this.jdField_a_of_type_Aoah != null) && (this.jdField_a_of_type_Aoah.a())) {
        this.jdField_a_of_type_Aoah.a(false, true);
      }
    } while (this.jdField_a_of_type_Aoal == null);
    this.jdField_a_of_type_Aoal.b();
  }
  ...
  private void l()
  {
    ...
    for (;;)
    {
      aoal localaoal = this.jdField_a_of_type_Aoal;
      if (localaoal != null)
      {
        localaoal.a(0);
        localaoal.b();
      ...
      return;
      if ((this.m == -1) && (this.jdField_a_of_type_Aoah != null)) {
        this.jdField_a_of_type_Aoah.a(false, false);
      }
    }
  }
  ...
  private void n()
  {
    ...
    if ((this.jdField_a_of_type_Aoah == null) || (this.jdField_a_of_type_Aoal == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        {
          return;
          if (this.jdField_a_of_type_Aoal.a() != 0) {
            break label145;
          }
          if (!aoae.a(104857600L))
          {
            aoae.a(jdField_c_of_type_JavaLangString, jdField_d_of_type_JavaLangString);
            return;
          }
          if (this.jdField_a_of_type_Aoah.a(true, null)) {
            break;
          }
          aoae.a(jdField_a_of_type_JavaLangString, false);
        } while (!QLog.isColorLevel());
        ...
        return;
        a("0X8008A54");
        this.jdField_a_of_type_Aoal.a(1);
      } while (!QLog.isColorLevel());
      QLog.i("ARVideoRecordUIControllerImpl", 2, "startVideoRecord end");
      return;
      if (c())
      {
        this.jdField_a_of_type_Aoah.a(true, true);
        this.m = 7;
        this.jdField_d_of_type_Boolean = true;
        a("0X8008A55");
        if (QLog.isColorLevel()) {
  ...
  public void a(Object paramObject)
  {
    ...
    {
      return;
      if ((paramObject instanceof aoal))
      {
        this.jdField_a_of_type_Aoal = ((aoal)paramObject);
        this.jdField_a_of_type_Aoal.a(this);
        return;
      }
    } while (!(paramObject instanceof aoah));
    this.jdField_a_of_type_Aoah = ((aoah)paramObject);
    this.jdField_a_of_type_Aoah.a(this);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Aoah = null;
  ...
  public boolean a()
  {
    return (this.jdField_a_of_type_Aoah != null) && (this.jdField_a_of_type_Aoah.b());
  }
  ...
  public boolean b()
  {
    return (this.jdField_a_of_type_Aoah != null) && (this.jdField_a_of_type_Aoah.b()) && (!this.jdField_a_of_type_Aoah.a());
  }
  ...
  public void d()
  {
    ...
    if ((!this.jdField_e_of_type_Boolean) || (!this.jdField_f_of_type_Boolean)) {}
    while (this.jdField_a_of_type_Aoah == null) {
      return;
    }
    this.jdField_a_of_type_Aoah.a(System.currentTimeMillis());
  }
    ...
    for (int n = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.RECORD_AUDIO");; n = 0)
    {
      ...
      for (int i1 = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.WRITE_EXTERNAL_STORAGE");; i1 = 0)
      {
        ...
        for (int i2 = ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).checkSelfPermission("android.permission.READ_EXTERNAL_STORAGE");; i2 = 0)
        {
          ...
          ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).requestPermissions(new aoaj(this), 1, new String[] { "android.permission.RECORD_AUDIO", "android.permission.READ_EXTERNAL_STORAGE", "android.permission.WRITE_EXTERNAL_STORAGE" });
          return true;
          ...
          this.jdField_a_of_type_Aoah.a(false, null);
          return true;
          if (this.jdField_a_of_type_Aoah == null) {
            break;
          }
