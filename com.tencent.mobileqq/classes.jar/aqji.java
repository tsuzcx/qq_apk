  ...
  extends aqiz
{
  ...
  private View a(int paramInt1, int paramInt2, boolean paramBoolean, View paramView, ViewGroup paramViewGroup)
  {
    ...
    aqjk localaqjk = (aqjk)paramView.getTag();
    int i = 0;
    for (;;)
    {
      View localView;
      if (i < 4)
      {
        localView = b(paramInt1, paramInt2 * 4 + i, paramBoolean, localaqjk.a[i], paramViewGroup);
        if (localView != null) {}
      }
      else
      {
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new aqjk(null));
    ...
    for (FileManagerEntity localFileManagerEntity = (FileManagerEntity)paramViewGroup;; localView = null)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          localaqiy = new aqiy();
          paramViewGroup = paramView;
          localaqiy.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView = ((AsyncImageView)paramView.findViewById(2131367910));
          paramViewGroup = paramView;
          localaqiy.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367927));
          paramViewGroup = paramView;
          localaqiy.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131367924));
          paramViewGroup = paramView;
          ...
          paramViewGroup = paramView;
          paramView.setTag(localaqiy);
          try
          {
            localaqiy.jdField_a_of_type_JavaLangObject = localFileManagerEntity;
            ...
            arni.a(localaqiy.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView, localFileManagerEntity);
            paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692573) + localFileManagerEntity.fileName;
            ...
            paramViewGroup = paramViewGroup + this.jdField_a_of_type_ComTencentMobileqqFilemanagerActivityBaseFileAssistantActivity.getString(2131692574);
            ...
            localaqiy.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(paramViewGroup);
            localaqiy.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetAsyncImageView.setContentDescription(paramViewGroup);
            return paramView;
          }
        ...
        continue;
        paramViewGroup = paramViewGroup + alpo.a(2131710077);
