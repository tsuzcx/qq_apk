  ...
  implements Manager
{
  ...
  public bakt(AppInterface paramAppInterface)
  {
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4, int paramInt5, oidb_0x6b6.SendFlowerReq paramSendFlowerReq, oidb_0x6b6.ThrowFlowerReq paramThrowFlowerReq, long paramLong, baks parambaks)
  {
    if (parambaks == null)
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6b6. callback=" + parambaks);
      }
      label37:
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        default: 
          ...
          if (mye.a().a(paramString2))
          {
            paramThrowFlowerReq = new oidb_0x6b6.AnonymousGroupMsg();
            paramString2 = mye.a().a(paramString2);
          ...
          if ((paramInt3 >= 4) && (System.currentTimeMillis() - atem.jdField_a_of_type_Long < 600000L))
          {
            paramString2 = new oidb_0x6b6.GPSInfo();
            paramString2.int32_gps_type.set(1, true);
            paramString2.int64_longitude.set(atem.jdField_a_of_type_ArrayOfLong[0], true);
            paramString2.int64_latitude.set(atem.jdField_a_of_type_ArrayOfLong[1], true);
          ...
          mxi.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new baku(this, parambaks), localReqBody.toByteArray(), paramString1 + "_" + paramInt2, paramInt1, paramInt2, paramString2, paramLong);
          return;
          if (paramInt2 != 11) {
            continue;
          }
  ...
  private void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, oidb_0x6c3.GetStockReq paramGetStockReq, oidb_0x6c3.GetExtraDataReq paramGetExtraDataReq, long paramLong, baks parambaks)
  {
    if (parambaks == null)
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6c3. troopUin is null. callback=" + parambaks);
      }
      return;
    }
    ...
    for (paramGetStockReq = paramGetStockReq.getSkey(this.jdField_a_of_type_ComTencentCommonAppAppInterface.getCurrentAccountUin());; paramGetStockReq = "")
    {
      ...
      mxi.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bakw(this, parambaks), localReqBody.toByteArray(), paramString1 + "_" + paramInt4, paramInt1, paramInt4, paramGetStockReq, paramLong);
      return;
    }
  }
  
  private void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, long paramLong, baks parambaks)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (parambaks == null))
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6c2. troopUin=" + paramString1 + " giftBagID=" + paramString2 + " callback=" + parambaks);
      }
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        default: 
          ...
          mxi.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new baky(this, parambaks, paramString1, paramString2), localReqBody.toByteArray(), "OidbSvc.0x6c2_" + paramInt3, 1730, paramInt3, (Bundle)localObject, paramLong);
          return;
        }
      }
  ...
  private void a(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, baks parambaks)
  {
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      mxi.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bakz(this, parambaks), paramString1.toByteArray(), "OidbSvc.0x962_" + paramInt3, 2402, 1, paramString2, 500L);
      return;
    }
  ...
  private void b(baks parambaks)
  {
    ...
    mxi.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bakv(this, parambaks), localReqBody.toByteArray(), "OidbSvc.0xcd1_0", 3281, 0, null, 0L);
  }
  
  private void b(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, long paramLong, baks parambaks)
  {
    if ((TextUtils.isEmpty(paramString2)) || (TextUtils.isEmpty(paramString3)) || (parambaks == null))
    {
      if (QLog.isColorLevel()) {
        QLog.e(".troop.send_gift", 2, "send_oidb_0x6b5. troopUin=" + paramString2 + " giftBagID=" + paramString3 + " callback=" + parambaks);
      }
      return;
    }
    ...
    for (;;)
    {
      try
      {
        ...
        paramInt2 = 1;
        mxi.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bakx(this, parambaks, paramString2, paramString3), localReqBody.toByteArray(), paramString1 + "_" + paramInt2, paramInt1, paramInt2, (Bundle)localObject, paramLong);
        return;
      }
      catch (NumberFormatException paramString1) {}
      if (!QLog.isColorLevel()) {
  ...
  public TroopGiftBagInfo a(String paramString1, String paramString2, baks parambaks)
  {
    ...
    TroopGiftBagInfo localTroopGiftBagInfo = (TroopGiftBagInfo)this.jdField_a_of_type_Aukn.a(TroopGiftBagInfo.class, paramString2);
    ...
    a(paramString1, paramString2, 0, 0, 1000L, parambaks);
    return null;
  }
  ...
  public void a(int paramInt, baks parambaks)
  {
    if (!(this.jdField_a_of_type_ComTencentCommonAppAppInterface instanceof QQAppInterface)) {
      return;
    }
    ...
    mxi.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new balb(this, parambaks), localReqBody.toByteArray(), "OidbSvc.0x9e9_0", 2537, 0);
  }
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4, int paramInt5, int paramInt6, int paramInt7, baks parambaks)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramInt1, paramInt2, paramInt3, paramString2, paramInt4, 0, null, localThrowFlowerReq, 0L, parambaks);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2, int paramInt4, int paramInt5, long paramLong, int paramInt6, int paramInt7, int paramInt8, int paramInt9, baks parambaks, int paramInt10)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramInt1, paramInt2, paramInt3, paramString2, paramInt4, paramInt9, localSendFlowerReq, null, 0L, parambaks);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, int paramInt5, baks parambaks)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramInt1, paramInt2, paramString2, paramInt3, paramInt4, null, localGetExtraDataReq, 0L, parambaks);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, baks parambaks)
  {
    a(paramString1, paramInt1, paramInt2, paramString2, paramInt3, paramInt4, false, false, parambaks);
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, int paramInt3, int paramInt4, boolean paramBoolean1, boolean paramBoolean2, baks parambaks)
  {
    if (QLog.isColorLevel()) {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      a(paramString1, paramInt1, paramInt2, paramString2, paramInt3, paramInt4, localGetStockReq, null, 0L, parambaks);
      return;
    }
  }
  
  public void a(String paramString1, int paramInt1, int paramInt2, String paramString2, String paramString3, long paramLong, baks parambaks)
  {
    if (QLog.isColorLevel()) {
      QLog.e(".troop.send_gift .troop.send_gift", 2, "grabGift. troopUin:" + paramString2 + " bagID:" + paramString3);
    }
    b(paramString1, paramInt1, paramInt2, paramString2, paramString3, paramLong, parambaks);
  }
  
  public void a(String paramString, baks parambaks)
  {
    try
    {
      ...
      mxi.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface, new balc(this, parambaks), paramString.toByteArray(), "OidbSvc.0xa48_1", 2632, 1, new Bundle(), 6000L);
      return;
    }
    catch (Exception paramString)
    {
      parambaks.a(-1, "troop uin error");
    }
  }
  
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, long paramLong, baks parambaks)
  {
    if (QLog.isColorLevel()) {
    ...
    a(paramString1, paramString2, paramInt1, paramInt2, 0, paramLong, parambaks);
  }
  
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2, baks parambaks)
  {
    if (QLog.isColorLevel()) {
      QLog.d(".troop.send_gift .troop.send_gift", 2, "reportInteract. troopUin:" + paramString1 + " giftID:" + paramString2);
    }
    a(paramString1, paramString2, paramInt2, paramInt1, 3, parambaks);
  }
  
  public void a(String paramString1, String paramString2, int paramInt, baks parambaks)
  {
    if (QLog.isColorLevel()) {
      QLog.d(".troop.send_gift .troop.send_gift", 2, "chechInteract. troopUin:" + paramString1 + " giftID:" + paramString2);
    }
    a(paramString1, paramString2, 0, paramInt, 1, parambaks);
  }
  
  public void a(xce paramxce, int paramInt, String paramString, long paramLong, baks parambaks)
  {
    if ((paramxce == null) || (parambaks == null)) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      localReqBody.product_id.set(paramxce.jdField_a_of_type_Int, true);
      localReqBody.amount.set(paramxce.f, true);
      ...
      try
      {
        ...
        mxi.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, new bala(this, parambaks, paramxce), localReqBody.toByteArray(), "OidbSvc.0xdad_" + paramInt, 3501, paramInt, paramString, 0L);
        return;
      }
      catch (NumberFormatException paramxce) {}
    } while (!QLog.isColorLevel());
  ...
  {
    if ((this.jdField_a_of_type_Aukn == null) || (paramaukm == null)) {}
    do
    {
      do
      {
  ...
  public void b(String paramString1, String paramString2, int paramInt, baks parambaks)
  {
    if (QLog.isColorLevel()) {
      QLog.d(".troop.send_gift .troop.send_gift", 2, "startInteract. troopUin:" + paramString1 + " giftID:" + paramString2);
    }
    a(paramString1, paramString2, 0, paramInt, 2, parambaks);
  }
