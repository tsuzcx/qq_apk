  ...
  extends QzoneExternalRequest
{
  ...
  public bgse(long paramLong)
  {
    ...
    this.jdField_a_of_type_NS_NEW_MOBILE_REPORTAccessReqHead.terminal.androidId = String.valueOf(babp.f());
    this.jdField_a_of_type_NS_NEW_MOBILE_REPORTAccessReqHead.terminal.imsi = String.valueOf(b());
    this.jdField_a_of_type_NS_NEW_MOBILE_REPORTAccessReqHead.terminal.mode = String.valueOf(babp.i());
    this.jdField_a_of_type_NS_NEW_MOBILE_REPORTAccessReqHead.terminal.manufacture = String.valueOf(babp.h());
    ...
    this.jdField_a_of_type_NS_NEW_MOBILE_REPORTAccessReqHead.uniqueId = String.valueOf(bcez.c());
    this.jdField_a_of_type_NS_NEW_MOBILE_REPORTAccessReqHead.installPkgList = new ArrayList();
    Object localObject = bcev.a(BaseApplicationImpl.getApplication());
    if (localObject != null)
    {
  ...
  public static String a()
  {
    ...
    try
    {
      jdField_a_of_type_JavaLangString = befc.a("b94d1a");
      label27:
      return jdField_a_of_type_JavaLangString;
    }
