...
public abstract class afdd
{
  public afcy a;
  protected afdg a;
  protected akfc a;
  private akil jdField_a_of_type_Akil = new afdf(this);
  protected Context a;
  protected TextView a;
  private bfos jdField_a_of_type_Bfos = new afde(this);
  ...
  public afdd(QQAppInterface paramQQAppInterface, Context paramContext, XListView paramXListView, afdg paramafdg)
  {
    this.jdField_a_of_type_Boolean = true;
  ...
  private void f()
  {
    ...
    this.jdField_a_of_type_Afcy.a(null);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Afcy);
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131713269));
  ...
  private void h()
  {
    ...
    if (a()) {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(ajya.a(2131713270));
    }
  }
  
  protected abstract afcy a();
  ...
  {
    Object localObject = akuf.a("recommend_troop");
    double d1;
    int k;
    double d2;
    String str;
    ...
    ((oidb_0x935.GPS)localObject).bytes_client_version.set(ByteStringMicro.copyFromUtf8("8.3.0"));
  ...
  {
    this.jdField_a_of_type_Akfc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin(), a());
  }
  ...
  protected boolean a()
  {
    return this.jdField_a_of_type_Akfc.a == 1;
  }
  ...
  protected void c()
  {
    this.jdField_a_of_type_Afcy.a(this.jdField_a_of_type_Akfc.b);
