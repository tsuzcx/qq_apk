...
public class arzm
{
  ...
  {
    boolean bool = arzl.a(paramQQAppInterface.getApp(), paramQQAppInterface.getAccount());
    if (!bool) {
      ((anri)paramQQAppInterface.getBusinessHandler(BusinessHandlerFactory.CARD_HANLDER)).y();
    }
