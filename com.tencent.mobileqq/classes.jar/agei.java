  ...
  extends agdk
{
  ...
  agbq jdField_a_of_type_Agbq;
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new agem(this);
  ...
  public agei(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, boolean paramBoolean)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetEditText.addTextChangedListener(new agej(this));
  ...
  private void g()
  {
    ((ImageButton)findViewById(2131367678)).setOnClickListener(new agek(this));
    Button localButton = (Button)findViewById(2131363480);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new agel(this));
  }
  ...
  private void h()
  {
    ...
    this.jdField_a_of_type_Agbq = new agbq(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Bfmt, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Agbq);
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new agen(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new ageo(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new agep(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemLongClickListener(new ageq(this));
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_Agbq.a(this.jdField_a_of_type_JavaLangString);
    if (QLog.isColorLevel()) {
    ...
    this.jdField_b_of_type_Int = 0;
    this.jdField_a_of_type_Agbq.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_JavaLangString, 1);
  }
  
  public void a(List<TroopLinkElement> paramList)
  {
    this.jdField_a_of_type_Agbq.a(paramList);
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    do
    {
      do
      {
        ...
        {
          this.jdField_c_of_type_AndroidWidgetTextView.setText(ajyc.a(2131706106));
        ...
        {
          this.jdField_a_of_type_Agbq.a((List)paramMessage.obj, paramMessage.arg1, this.jdField_d_of_type_Boolean, 0);
          this.jdField_a_of_type_Agbq.notifyDataSetChanged();
        }
        if (this.jdField_a_of_type_Agbq.getCount() == 0) {
          a(4, null);
        }
        for (;;)
        {
      ...
      this.jdField_a_of_type_Agbq.a(this.jdField_a_of_type_JavaUtilList, this.jdField_d_of_type_Boolean);
      if ((this.jdField_d_of_type_Boolean) && (this.jdField_a_of_type_Agbq.getCount() < 20))
      {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(ajyc.a(2131706107));
        this.jdField_c_of_type_AndroidWidgetLinearLayout.findViewById(2131371996).setVisibility(8);
        this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(0);
        this.jdField_b_of_type_AndroidViewView.setVisibility(0);
      }
    ...
    this.jdField_b_of_type_AndroidViewView.setVisibility(8);
    this.jdField_c_of_type_AndroidWidgetLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Agbq.a((List)localObject, this.jdField_d_of_type_Boolean);
    this.jdField_a_of_type_Agbq.notifyDataSetChanged();
    this.jdField_a_of_type_ComTencentWidgetXListView.setAdapter(this.jdField_a_of_type_Agbq);
    this.jdField_a_of_type_ComTencentWidgetXListView.setSelection(0);
    this.jdField_a_of_type_JavaUtilList.clear();
