  ...
  implements axwp
{
  ...
  public agei(Context paramContext, LocalMediaInfo paramLocalMediaInfo)
  {
  ...
  public Bitmap a(URL paramURL)
  {
    ...
    if (localLocalMediaInfo != null)
    {
        ...
        catch (OutOfMemoryError localOutOfMemoryError2)
        {
          try
          {
            ...
            if ((!localSafeDecodeOption.isInJustDecodeBounds) && (localSafeDecodeOption.needRegionDecode))
            {
              ...
              ((awrn)localObject2).a(null, "safeDecode", bool, l, localSafeDecodeOption.rawWidth * i, (HashMap)localObject1, "");
            }
            if (paramURL != null) {
              break;
            }
      ...
      i = axwd.a(localLocalMediaInfo.path);
      ...
      for (;;)
      {
        ...
        return afzu.a((Bitmap)localObject1, i);
        k = (k - j) / 2;
