  ...
  extends bqqu
{
  ...
  private String jdField_d_of_type_JavaLangString = anzj.a(2131713871);
  ...
  public bqre(Context paramContext, String paramString)
  {
  ...
  protected void b()
  {
    ...
    {
      this.jdField_d_of_type_JavaLangString = anzj.a(2131713869);
      ...
      if (!bhmi.a(this.jdField_c_of_type_JavaLangString)) {
        break label1272;
      }
      ...
      this.jdField_a_of_type_AndroidTextTextPaint.setShadowLayer(bqqu.g, 0.0F, 0.0F, 1711276032);
      this.jdField_b_of_type_AndroidTextTextPaint.setShadowLayer(bqqu.g, 0.0F, 0.0F, 1711276032);
      if (Build.VERSION.SDK_INT >= 21)
      {
    ...
    for (;;)
    {
      ...
      for (this.jdField_d_of_type_Int = i1;; this.jdField_d_of_type_Int = i4)
      {
        ...
        this.jdField_e_of_type_Int = this.jdField_a_of_type_Bqqi.a("T", 0L, 165L, 0, 255, new LinearInterpolator());
        this.h = this.jdField_a_of_type_Bqqi.a("X", 0L, 330L, 0, this.t, new DecelerateInterpolator());
        this.i = this.jdField_a_of_type_Bqqi.a("X", 330L, 340L, this.t, this.u, new AccelerateInterpolator());
        this.j = this.jdField_a_of_type_Bqqi.a("X", 825L, 200L, 0, 100, new DecelerateInterpolator());
        this.k = this.jdField_a_of_type_Bqqi.a("X", 825L, 355L, a(10.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), a(20.0F, this.jdField_a_of_type_AndroidContentContext.getResources()), new DecelerateInterpolator());
        ...
        if ((this.jdField_d_of_type_JavaLangString == null) || (this.jdField_d_of_type_JavaLangString.contains(anzj.a(2131713873))) || (this.jdField_d_of_type_JavaLangString.contains(anzj.a(2131713872))) || (this.jdField_d_of_type_JavaLangString.endsWith(anzj.a(2131713867))) || (this.jdField_d_of_type_JavaLangString.endsWith(anzj.a(2131713868)))) {
          break;
        }
        this.jdField_d_of_type_JavaLangString += anzj.a(2131713870);
        break;
        label1272:
