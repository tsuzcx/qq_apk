...
{
  private static bgnd jdField_a_of_type_Bgnd;
  ...
  private bfdi jdField_a_of_type_Bfdi;
  private PluginManagerClient jdField_a_of_type_ComTencentMobileqqPluginsdkPluginManagerClient;
  private boolean jdField_a_of_type_Boolean;
  private int jdField_b_of_type_Int;
  private bfdi jdField_b_of_type_Bfdi;
  private String jdField_b_of_type_JavaLangString;
  private String c;
  
  public static bgnd a()
  {
    if (jdField_a_of_type_Bgnd == null) {
      jdField_a_of_type_Bgnd = new bgnd();
    }
    return jdField_a_of_type_Bgnd;
  }
  ...
  private void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Bfdi = null;
    this.jdField_a_of_type_AndroidAppActivity = null;
    this.jdField_b_of_type_Bfdi = null;
    this.jdField_a_of_type_AndroidContentContext = null;
    b(paramInt);
    String str = ajjy.a(2131648424);
    if (-4 == paramInt) {
      str = ajjy.a(2131648419);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
  ...
  private void a(String paramString, PluginBaseInfo paramPluginBaseInfo)
  {
    ...
    if ((-2 != paramPluginBaseInfo.mState) && (4 != paramPluginBaseInfo.mState) && (!badq.g(BaseApplicationImpl.getContext())) && (System.currentTimeMillis() - this.jdField_a_of_type_Long > 5000L))
    {
      a(-4);
      return;
    }
  ...
  private void b()
  {
    if ((this.c != null) && (this.c.compareToIgnoreCase("openActivity") == 0))
    {
      ...
      this.jdField_a_of_type_Beez.sendEmptyMessageDelayed(1002, 2000L);
    }
    if ((this.jdField_b_of_type_JavaLangString != null) && (this.jdField_b_of_type_JavaLangString.compareToIgnoreCase("launchService") == 0))
    {
      ...
      if ((this.jdField_a_of_type_AndroidContentContext != null) && (this.jdField_b_of_type_Bfdi != null))
      {
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "[SmartDevicePluginLoader]  launchPluginService:");
        }
        bfcz.c(this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_Bfdi);
        this.jdField_b_of_type_Bfdi = null;
        this.jdField_a_of_type_AndroidContentContext = null;
      }
    }
  ...
  public void a(Activity paramActivity, AppRuntime paramAppRuntime, String paramString1, Intent paramIntent, String paramString2, int paramInt, DialogInterface.OnDismissListener paramOnDismissListener, Class<? extends Activity> paramClass)
  {
    ...
    paramAppRuntime = new bbms(paramActivity, paramActivity.getResources().getDimensionPixelSize(2131167766));
    if ((!bool) || (paramOnDismissListener != null))
    {
      paramAppRuntime.a(ajjy.a(2131648417));
      paramAppRuntime.setOnDismissListener(new bgne(this, paramOnDismissListener));
      if (bool) {
        paramAppRuntime.setOnShowListener(new bgnf(this, paramAppRuntime));
      }
    }
    for (;;)
    {
      paramOnDismissListener = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      ((xrh)paramOnDismissListener.a(51)).b();
      paramIntent.putExtra("userQqResources", 2);
      paramIntent.putExtra("useSkinEngine", true);
      paramIntent.putExtra("param_plugin_gesturelock", true);
      this.jdField_a_of_type_Bfdi = new bfdi(this.jdField_a_of_type_Int);
      this.jdField_a_of_type_Bfdi.jdField_b_of_type_JavaLangString = "qqsmartdevice.apk";
      this.jdField_a_of_type_Bfdi.d = PluginInfo.e;
      this.jdField_a_of_type_Bfdi.jdField_a_of_type_JavaLangString = paramString1;
      this.jdField_a_of_type_Bfdi.e = paramString2;
      this.jdField_a_of_type_Bfdi.jdField_a_of_type_JavaLangClass = paramClass;
      this.jdField_a_of_type_Bfdi.jdField_a_of_type_AndroidContentIntent = paramIntent;
      this.jdField_a_of_type_Bfdi.jdField_b_of_type_Int = paramInt;
      this.jdField_a_of_type_Bfdi.jdField_a_of_type_AndroidAppDialog = paramAppRuntime;
      this.jdField_a_of_type_Bfdi.c = 10000;
      this.jdField_a_of_type_Bfdi.f = null;
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "[SmartDevicePluginLoader] launchPluginActivity: plugin is installed " + this.jdField_a_of_type_Bfdi.e);
        }
        if (bool)
        {
          bfcz.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bfdi);
          this.jdField_a_of_type_AndroidAppActivity = null;
          this.jdField_a_of_type_Bfdi = null;
          return;
        }
        if (this.jdField_a_of_type_Bbms == null)
        {
          ...
          this.jdField_a_of_type_Bbms.a(ajjy.a(2131648418));
        }
      ...
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "[SmartDevicePluginLoader] launchPluginActivity: waiting for plugin to install " + this.jdField_a_of_type_Bfdi.e);
      }
      this.c = "openActivity";
      PluginManagerHelper.getPluginInterface(BaseApplicationImpl.getContext(), this);
      return;
  ...
  public void a(AppRuntime paramAppRuntime, ServiceConnection paramServiceConnection)
  {
    ...
    this.jdField_b_of_type_Bfdi = new bfdi(this.jdField_a_of_type_Int);
    this.jdField_b_of_type_Bfdi.jdField_b_of_type_JavaLangString = "qqsmartdevice.apk";
    this.jdField_b_of_type_Bfdi.d = PluginInfo.e;
    this.jdField_b_of_type_Bfdi.jdField_a_of_type_JavaLangString = paramAppRuntime.getAccount();
    this.jdField_b_of_type_Bfdi.e = "com.tencent.device.ipc.QQSmartDeviceService";
    this.jdField_b_of_type_Bfdi.jdField_a_of_type_AndroidContentIntent = localIntent;
    this.jdField_b_of_type_Bfdi.jdField_a_of_type_AndroidContentServiceConnection = paramServiceConnection;
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      bfcz.c(paramAppRuntime.getApplication(), this.jdField_b_of_type_Bfdi);
      this.jdField_b_of_type_Bfdi = null;
      this.jdField_a_of_type_AndroidContentContext = null;
      return;
    }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      continue;
      b(0);
      if ((this.jdField_a_of_type_AndroidAppActivity != null) && (this.jdField_a_of_type_Bfdi != null))
      {
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "[SmartDevicePluginLoader]  launchPluginActivity:" + this.jdField_a_of_type_Bfdi.e);
        }
        bfcz.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_Bfdi);
      }
      this.jdField_a_of_type_AndroidAppActivity = null;
      this.jdField_a_of_type_Bfdi = null;
      this.jdField_a_of_type_Beez.sendEmptyMessageDelayed(1003, 600L);
      continue;
      if (this.jdField_a_of_type_Bbms != null)
      {
