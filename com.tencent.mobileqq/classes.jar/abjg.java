...
public class abjg
  implements adku, aobt, IMemoryManager, IAppStateChangeListener
{
  private static abjg jdField_a_of_type_Abjg;
  ...
  private Vector<abjh> jdField_a_of_type_JavaUtilVector;
  public boolean a;
  ...
  {
    if (jdField_a_of_type_Abjg == null) {}
    try
    {
      if (jdField_a_of_type_Abjg == null) {
        jdField_a_of_type_Abjg = new abjg();
      }
      return jdField_a_of_type_Abjg;
    }
    finally {}
  }
  ...
  public static void a(String paramString, int paramInt)
  {
    ...
    for (Object localObject = ((AppRuntime)localObject).getAccount();; localObject = null)
    {
      ...
      {
        if (paramString != null) {
          bdmc.a(BaseApplicationImpl.getApplication()).a((String)localObject, paramString, true, 0L, 0L, localHashMap, "", true);
        }
        return;
        if (paramInt == l)
        {
  ...
  {
    a(2);
    abje.a(BaseApplicationImpl.class.getClassLoader());
  }
    ...
    for (String str2 = "low_mem_report_rdm_time";; str2 = "bg_mem_report_rdm_time")
    {
      ...
      if (l1 > 0L) {
        if (Math.abs(l2 - l1) > 3600000L)
        {
          ...
          label402:
          bdmc.a(BaseApplicationImpl.getApplication()).a(null, str1, true, 0L, 0L, localHashMap, null);
  ...
  {
    abjc localabjc = MagnifierSDK.a().a().a;
    if (QLog.isColorLevel()) {
      QLog.d("MemoryClearManagerNew", 2, "onNeedTrimMemory|clear= " + localabjc.jdField_a_of_type_Boolean + "configId" + localabjc.jdField_a_of_type_JavaLangString);
    }
    if ((a(paramabjd.jdField_b_of_type_Int * localabjc.jdField_b_of_type_Int * 1000)) && (localabjc.jdField_a_of_type_Boolean)) {}
    try
    {
      b(paramInt, paramabjd);
      return;
    }
    catch (Exception paramabjd)
    {
      while (!QLog.isColorLevel()) {}
      QLog.d("MemoryClearManagerNew", 2, "clearMemory Exception= " + paramabjd);
    }
  }
  ...
  public void a(abjh paramabjh)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.add(paramabjh);
      return;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if ((i1 > 600) && (i1 - this.n > 250) && (this.jdField_a_of_type_Boolean))
    {
      ...
      if (Math.abs(l1 - l2) >= 3600000L)
      {
        ...
        localHashMap.put("topActivity", aodx.a());
        ...
        localHashMap.put("sProcessId", String.valueOf(BaseApplicationImpl.sProcessId));
        bdmc.a(BaseApplicationImpl.getApplication()).a(null, "MemoryIncreaseInfo", true, 0L, 0L, localHashMap, "", true);
  ...
  public void b()
  {
    try
    {
      ...
      ((SharedPreferences.Editor)localObject).putString("topActivity", aodx.a());
      ((SharedPreferences.Editor)localObject).putString("key_mem_info", bdlx.a().a());
  ...
  public void b(int paramInt, abjd paramabjd)
  {
    long l6;
    Object localObject3;
    int i1;
    ...
    for (;;)
    {
      try
      {
        ...
        synchronized (this.jdField_a_of_type_JavaUtilVector)
        {
          ...
          {
            i1 += ((abjh)((Iterator)localObject3).next()).a();
            continue;
          }
          l2 = i1;
          l1 = i1;
          ...
          i2 = (int)(i1 * paramabjd.jdField_b_of_type_Float);
          l3 = i1;
          BaseApplicationImpl.sImageCache.trimToSize(i2);
          if ((paramabjd.a > 0.0F) && (paramabjd.a < 1.0F))
          {
            l4 = MemoryManager.a() * 1L / 32L;
            if (BaseApplicationImpl.sImageCache.maxSize() >= l4) {
              BaseApplicationImpl.sImageCache.resetMaxSize(paramabjd.a);
            }
          }
          i10 = 0 + (i1 - i2);
          l4 = i10;
    ...
    if (((Iterator)???).hasNext())
    {
      ...
      if (localObject3 != null)
      {
        ...
        if (localObject4 != null)
        {
          ...
          ((QQLruCache)localObject4).clearOnLowMemory((int)(((QQLruCache)localObject4).size() * paramabjd.jdField_b_of_type_Float));
        ...
        else
        {
          ...
          if (((Iterator)localObject3).hasNext())
          {
            ...
            {
              localLruCache.trimToSize((int)(localLruCache.size() * paramabjd.jdField_b_of_type_Float));
          ...
          if (paramInt == 1)
          {
            paramabjd = this.jdField_b_of_type_JavaUtilList.iterator();
            if (!paramabjd.hasNext()) {
              break label1449;
            }
            ??? = (WeakReference)paramabjd.next();
            if (??? == null) {
              break label1446;
            }
            ...
            if (paramInt == 1)
            {
              paramabjd = this.jdField_a_of_type_JavaUtilList.iterator();
              if (!paramabjd.hasNext()) {
                break label1468;
              }
              ??? = (WeakReference)paramabjd.next();
              ...
              break label1465;
              label842:
              paramabjd = SkinEngine.getInstances().releasePreloadDrawableCache();
              Object localObject1;
              l2 = localObject1;
              i1 = i9;
              if (paramabjd.length < 2) {
                break label1522;
              }
              if ((paramabjd[0] instanceof Integer)) {
                i2 = Integer.parseInt(paramabjd[0].toString());
              }
              l2 = localObject1;
              i1 = i2;
              if (!(paramabjd[1] instanceof Long)) {
                break label1522;
              }
              l2 = Long.parseLong(paramabjd[1].toString());
              i1 = i2;
              break label1522;
            }
          }
  ...
  public void b(abjh paramabjh)
  {
    synchronized (this.jdField_a_of_type_JavaUtilVector)
    {
      this.jdField_a_of_type_JavaUtilVector.remove(paramabjh);
      return;
    }
  }
  ...
  public final void d()
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      localHashMap.put("sProcessId", String.valueOf(BaseApplicationImpl.sProcessId));
      bdmc.a(BaseApplicationImpl.getApplication()).a(null, "memory_oom_Info", true, 0L, 0L, localHashMap, null);
