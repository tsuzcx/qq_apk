  ...
  implements vpk
{
  private boolean a(List<String> paramList)
  {
    ...
    {
      xvv.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleAlbumEntraConfig type: 日迹主页影集入口配置, content: \n", paramList);
      paramList = (via)vux.a(30);
        ...
        catch (NumberFormatException localNumberFormatException3)
        {
          try
          {
            for (;;)
            {
              ...
              xvv.e("Q.qqstory.config.QQStoryConfigServletHandler", "get enableCqMode= " + str11 + " from json error:" + localNumberFormatException1);
              continue;
              localNumberFormatException2 = localNumberFormatException2;
              xvv.e("Q.qqstory.config.QQStoryConfigServletHandler", "get highBitrate= " + str11 + " from json error:" + localNumberFormatException2);
              continue;
              bool = false;
            }
            localNumberFormatException3 = localNumberFormatException3;
            xvv.e("Q.qqstory.config.QQStoryConfigServletHandler", "get codecProfile= " + str11 + " from json error:" + localNumberFormatException3);
          }
          catch (NumberFormatException localNumberFormatException4)
          {
            for (;;)
            {
              xvv.e("Q.qqstory.config.QQStoryConfigServletHandler", "get maxVideoSize= " + str11 + " from json error:" + localNumberFormatException4);
            }
          }
        }
      }
  ...
  private boolean a(List<String> paramList, String paramString)
  {
    ...
    {
      return false;
      xvv.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleQzoneSync2QQStory config=%s", paramList);
    ...
    catch (Throwable paramString)
    {
      for (;;)
      {
        xvv.e("Q.qqstory.config.QQStoryConfigServletHandler", "handleQzoneSync2QQStory  parseLong error");
      }
    }
  ...
  private boolean b(List<String> paramList)
  {
    ...
    for (paramList = "";; paramList = str)
    {
      xvv.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleAlbumConfig type: 影集配置, content: \n", paramList);
      if ((!TextUtils.isEmpty(str)) && (str.trim().length() != 0)) {
        break;
      }
      localvia.e();
  ...
  private boolean b(List<String> paramList, int paramInt)
  {
    ...
    return ((vuu)vux.a(5)).a(paramList);
  }
  ...
  private boolean c(List<String> paramList)
  {
    ...
    vxx localvxx = (vxx)QQStoryContext.a().getManager(252);
    String str = (String)paramList.get(0);
    if (str == null) {}
    for (paramList = "";; paramList = str)
    {
      xvv.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleMsgTabTakeVideoNodeConfig type: 日迹拍摄配置, content: \n", paramList);
      if ((!TextUtils.isEmpty(str)) && (str.trim().length() != 0)) {
        break;
      }
      localvxx.a();
  ...
  private boolean d(List<String> paramList)
  {
    ...
    xvv.a("Q.qqstory.config.QQStoryConfigServletHandler", "handledAIOSyncToStory config=%s", (String)paramList.get(0));
    return false;
  }
  ...
  private boolean e(List<String> paramList)
  {
    ...
    xvv.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig config=%s", paramList);
    paramList = (String)paramList.get(0);
    if (TextUtils.isEmpty(paramList))
    {
      xvv.d("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig clear config");
      vuq.c(false);
      vuq.d(false);
      return true;
    }
    try
    {
      ...
      xvv.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig showSyncBtn = %d,defaultStatus=%d", Integer.valueOf(i), Integer.valueOf(j));
      if (i == 1)
      {
        bool = true;
        vuq.c(bool);
    ...
    {
      yos.a("handleStorySync2QzoneConfig:" + paramList.toString(), new Object[0]);
  ...
  private boolean f(List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramList = (vus)JsonORM.a(new JSONObject(paramList), vus.class);
        localvuq = (vuq)vux.a(10);
        localvuq.b("boolean_enable_revert_play_mode", Boolean.valueOf(true));
        localvuq.b("boolean_enable_fast_play_mode", Boolean.valueOf(true));
        localvuq.b("boolean_enable_slow_play_mode", Boolean.valueOf(true));
        localvuq.b("boolean_enable_hw_encode_pic_to_video", Boolean.valueOf(true));
        localvuq.b("boolean_enable_flow_decode", Boolean.valueOf(true));
        localvuq.b("boolean_use_flow_decode_first", Boolean.valueOf(false));
        localvuq.b("key_story_home_preload_count", Integer.valueOf(4));
        localvuq.b("key_story_video_preload_duration", Integer.valueOf(2));
        vut[] arrayOfvut;
        int k;
        if (paramList.f != null)
        {
          arrayOfvut = paramList.f;
          k = arrayOfvut.length;
          i = 0;
          if (i < k)
          {
            ...
            localvuq.b("boolean_use_flow_decode_first", Boolean.valueOf(true));
          }
        }
        if (paramList.jdField_a_of_type_ArrayOfVut != null)
        {
          arrayOfvut = paramList.jdField_a_of_type_ArrayOfVut;
          k = arrayOfvut.length;
          i = 0;
          if (i < k)
          {
            ...
            localvuq.b("boolean_enable_revert_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.jdField_b_of_type_ArrayOfVut != null)
        {
          arrayOfvut = paramList.jdField_b_of_type_ArrayOfVut;
          k = arrayOfvut.length;
          i = 0;
          if (i < k)
          {
            ...
            localvuq.b("boolean_enable_fast_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.c != null)
        {
          arrayOfvut = paramList.c;
          k = arrayOfvut.length;
          i = 0;
          if (i < k)
          {
            ...
            localvuq.b("boolean_enable_slow_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.d != null)
        {
          arrayOfvut = paramList.d;
          k = arrayOfvut.length;
          i = 0;
          if (i < k)
          {
            ...
            localvuq.b("boolean_enable_hw_encode_pic_to_video", Boolean.valueOf(false));
          }
        }
        if (paramList.e != null)
        {
          arrayOfvut = paramList.e;
          k = arrayOfvut.length;
          i = 0;
          if (i < k)
          {
            ...
            localvuq.b("boolean_enable_flow_decode", Boolean.valueOf(false));
          }
        }
      ...
      localvuq.b("string_story_global_log_level", Integer.valueOf(i));
      localvuq.b("string_auto_play_report_control", paramList.jdField_b_of_type_JavaLangString);
      if ((paramList.jdField_a_of_type_Int > 0) && (paramList.jdField_a_of_type_Int < 20)) {
        localvuq.b("key_story_home_preload_count", Integer.valueOf(paramList.jdField_a_of_type_Int));
      }
      if ((paramList.jdField_b_of_type_Int > 0) && (paramList.jdField_b_of_type_Int < 10))
      {
        localvuq.b("key_story_video_preload_duration", Integer.valueOf(paramList.jdField_b_of_type_Int));
        break label726;
        i = j;
  ...
  private boolean g(List<String> paramList)
  {
    ...
    paramList = (String)paramList.get(0);
    if (!TextUtils.isEmpty(paramList)) {
      bfyz.i(localQQAppInterface.getApp(), localQQAppInterface.getCurrentUin(), paramList);
    }
    for (;;)
    {
      ((vla)localQQAppInterface.getManager(181)).b(paramList);
      if (QLog.isColorLevel()) {
        QLog.d("Q.qqstory.config.QQStoryConfigServletHandler", 2, "handleStoryPlayerProxyConfigCmd configContent = " + paramList);
      }
      return true;
      bfyz.i(localQQAppInterface.getApp(), localQQAppInterface.getCurrentUin(), null);
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          {
            localvuq.b("CertificationLinkText", localObject1);
            localvuq.b("CertificationLinkUrl", localObject2);
            ...
            localvuq.b("localVideoScanInterval", String.valueOf(i));
            localObject1 = localJSONObject.optJSONObject("mainHallConfig");
            if (localObject1 == null) {
              break label554;
            }
            localvuq.b("mainHallConfig", ((JSONObject)localObject1).toString());
            localObject1 = localJSONObject.optJSONObject("troopStoryHallConfig");
            if (localObject1 == null) {
              break label567;
            }
            localvuq.b("troopStoryHallConfig", ((JSONObject)localObject1).toString());
            ...
            bool = true;
            localvuq.b("key_share_encrypt_flag", Boolean.valueOf(bool));
            ...
            bool = true;
            localvuq.b("key_show_in_friend_story_main_page", Boolean.valueOf(bool));
            ...
            localvuq.b("boolean_enable_multi_video_fragment", Boolean.valueOf(true));
            i = 0;
            if (i < j)
            {
              ...
              localvuq.b("boolean_enable_multi_video_fragment", Boolean.valueOf(false));
            }
            i = localJSONObject.optInt("qim_sync_to_qq", 0);
            QLog.d("Q.qqstory.commonConfig", 2, "qim_sync_to_qq: " + paramList);
            localvuq.b("key_qim_int_qim_sync_to_qq_default", Integer.valueOf(i));
            return true;
          }
          localvuq.b("CertificationLinkText", "");
          localvuq.b("CertificationLinkUrl", "");
          continue;
        }
        localvuq.b("CertificationLinkText", "");
      }
      ...
      continue;
      label540:
      localvuq.b("localVideoScanInterval", "1441");
      continue;
      label554:
      localvuq.b("mainHallConfig", "");
      continue;
      label567:
      localvuq.b("troopStoryHallConfig", "");
      continue;
      label580:
      localvuq.b("key_share_encrypt_flag", Boolean.valueOf(false));
      continue;
      label595:
      localvuq.b("key_show_in_friend_story_main_page", Boolean.valueOf(true));
      continue;
      label610:
      localvuq.b("boolean_enable_multi_video_fragment", Boolean.valueOf(true));
      continue;
  ...
  public boolean a(int paramInt, Intent paramIntent, ConfigurationService.Config paramConfig)
  {
    ...
    Object localObject = vuq.a(paramInt);
    int i = bfyz.a(QQStoryContext.a().getApp(), (String)localObject, str);
    int j = paramConfig.version.get();
    localObject = aqlw.a(paramConfig, i, paramInt);
    if (localObject == null) {
      return bool2;
    }
    switch (paramInt)
