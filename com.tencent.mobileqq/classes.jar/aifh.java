...
{
  aifh(aifg paramaifg, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  public ApolloBaseInfo a(String paramString, ApolloBaseInfo paramApolloBaseInfo)
  {
    ...
    try
    {
      aifg.a(this.a).remove(Long.valueOf(Long.parseLong(paramApolloBaseInfo.uin)));
  ...
  protected void a(boolean paramBoolean, String paramString, ApolloBaseInfo paramApolloBaseInfo1, ApolloBaseInfo paramApolloBaseInfo2)
  {
    ...
    try
    {
      if (aifg.a(this.a).size() < 1024) {
        aifg.a(this.a).add(Long.valueOf(Long.parseLong(paramApolloBaseInfo1.uin)));
      }
      return;
    }
