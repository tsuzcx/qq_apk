  ...
  public boolean onKey(View paramView, int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    if (paramKeyEvent.getKeyCode() == 67)
    {
      ...
      if (paramKeyEvent.getAction() == 0)
      {
        ...
        bool1 = bool2;
        if (this.a.jdField_a_of_type_ComTencentWidgetXEditTextEx.getTag(2131373095) != null)
        {
          ...
          this.a.jdField_a_of_type_ComTencentWidgetXEditTextEx.setMinHeight(aekt.a(36.0F, paramView.getResources()));
    ...
    do
    {
      do
      {
        do
        {
          return bool1;
          bool1 = bool2;
        } while (this.a.jdField_a_of_type_ComTencentWidgetXEditTextEx.getTag(2131373095) == null);
        bool1 = bool2;
      } while (Build.VERSION.SDK_INT < 21);
      bool1 = bool2;
    } while (aekt.a(36.0F, paramView.getResources()) != this.a.jdField_a_of_type_ComTencentWidgetXEditTextEx.getMinHeight());
