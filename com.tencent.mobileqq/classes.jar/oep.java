  ...
  implements bfpt
{
  ...
  public oep(Context paramContext, int paramInt, ListView paramListView)
  {
    this.jdField_a_of_type_Osm = new oeq(this);
    this.c = paramInt;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_ComTencentWidgetListView = paramListView;
    this.jdField_a_of_type_JavaUtilArrayList = ((ArrayList)osg.a().a(paramInt));
  ...
  {
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)LayoutInflater.from(paramContext).inflate(2131558718, null, false));
    LinearLayout localLinearLayout = (LinearLayout)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131364656);
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView = ((HorizontalListView)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131379471));
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setOverScrollMode(2);
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setDividerWidth(actj.a(6.0F, paramContext.getResources()));
    this.jdField_a_of_type_Oen = new oen(paramContext, this.jdField_a_of_type_JavaUtilArrayList, this.c);
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setAdapter(this.jdField_a_of_type_Oen);
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setOverScrollMode(2);
    if (this.c == 56)
    {
      this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setOnTouchListener(new oer(this, paramContext));
      localLinearLayout.setPadding(0, (int)bbdv.a(paramContext, 2.0F), 0, (int)bbdv.a(paramContext, 2.0F));
    }
    if (this.c == 41523) {
      this.jdField_a_of_type_AndroidWidgetLinearLayout.setPadding(0, actj.a(10.0F, paramContext.getResources()), 0, 0);
    }
  }
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    if (this.jdField_a_of_type_JavaUtilArrayList.size() > paramInt)
    {
      ...
      nuq.b(this.jdField_a_of_type_AndroidContentContext, paramAdapterView.mChannelCoverId, paramAdapterView.mChannelCoverName, paramAdapterView.mChannelType, 4, paramView);
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      return;
      label225:
      nuq.a(this.jdField_a_of_type_AndroidContentContext, paramAdapterView.mChannelCoverId, paramAdapterView.mChannelCoverName, paramAdapterView.mChannelType, 4, paramView);
      break;
      label249:
