...
class ozh
{
  ...
  private pak a()
  {
    ...
    if (localAppRuntime != null) {
      return ((osl)localAppRuntime.getManager(163)).a().a();
    }
    return null;
  }
    ...
    if ((localObject != null) && (((ArrayList)localObject).size() > 0))
    {
      ...
      if (i != -1)
      {
        if ((this.c.containsKey(Integer.valueOf(paramInt1))) && (i < ((ArrayList)this.c.get(Integer.valueOf(paramInt1))).size()))
        {
          ...
          if (localObject != null) {
            ((BaseArticleInfo)localObject).mRecommendSeq = ozg.a(1, paramInt2);
          }
          return localObject;
        }
  ...
  void a(int paramInt)
  {
    ...
    Object localObject3 = ((pak)localObject2).a(paramInt);
    ...
    Collections.sort((List)localObject1, new ozj(this));
    ...
    localObject2 = ((pak)localObject2).a(paramInt);
  ...
  void c(int paramInt)
  {
    pak localpak = a();
    if (localpak != null) {
      localpak.a(paramInt, this.jdField_a_of_type_Pal);
    }
  }
