...
public class ozh
{
  ...
  public static int a()
  {
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      if ((localRecentUserBaseData != null) && (localRecentUserBaseData.mUser != null) && (localRecentUserBaseData.mUser.getType() == 1008) && (uaw.b((QQAppInterface)pay.a(), localRecentUserBaseData.mUser.uin))) {
  ...
  {
    String str4 = ugf.a(AppConstants.KANDIAN_DAILY_UIN) + "";
    ...
    for (Object localObject1 = str3;; localObject2 = null)
    {
      ...
      for (;;)
      {
        if (ugf.b(AppConstants.KANDIAN_DAILY_UIN) > 0) {}
        for (i = 1;; i = 0)
        {
          ...
          odq.a(null, "CliOper", "", "", paramString, paramString, 0, 0, str4, localObject3, str1, localJSONObject.toString(), false);
          ...
          new pwu(null, null, qli.a(), null).a(paramString);
          return;
          localObject1 = null;
          break;
        }
  ...
  public static void a(Intent paramIntent)
  {
    ...
    pay.a((KandianRedDotInfo)paramIntent.getSerializableExtra("daily_lock_screen_report_red_info"));
  }
  ...
  public static void a(List<ArticleInfo> paramList, List<Long> paramList1, boolean paramBoolean)
  {
    ...
    {
      return;
      Collections.sort(paramList, new ozi());
      localStringBuilder = new StringBuilder(1024);
      paramList = paramList.iterator();
      while (paramList.hasNext())
      {
        ArticleInfo localArticleInfo = (ArticleInfo)paramList.next();
        if ((pay.a(localArticleInfo) > 0) && (paramList1.contains(Long.valueOf(localArticleInfo.mRecommendSeq))))
        {
  ...
  {
    return "" + bkwm.a("readinjoy_daily_mode_channel_id", Integer.valueOf(41505));
  }
