  ...
  extends bgeq
{
  ...
  public String a;
  public URL a;
  public ConcurrentHashMap<String, bnsq> a;
  public int b;
  protected String b;
  public String c;
  public int d;
  ...
  public bgel(String paramString)
  {
    b(paramString);
    a();
  ...
  public bgel(JSONObject paramJSONObject)
  {
    a(paramJSONObject);
    this.jdField_d_of_type_JavaLangString = String.valueOf(hashCode());
  }
  ...
  public static String b()
  {
    ...
    {
      localVFSFile.mkdirs();
      bhmi.c(TroopHWJsPlugin.jdField_a_of_type_JavaLangString + ".nomedia");
    }
  ...
  public bnsq a(String paramString1, String paramString2)
  {
    ...
    {
      paramString2 = new bnsq(xiz.a(), paramString1, paramString2);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString1, paramString2);
      return paramString2;
    }
    return (bnsq)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString1);
  }
  ...
  public Stream<bgel> a(XMediaEditor paramXMediaEditor)
  {
    ...
    if (!auog.b(this.jdField_c_of_type_JavaLangString)) {
      localObject1 = ((Stream)localObject2).map(new bgem(this.jdField_d_of_type_Int));
    }
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      localObject1 = ((Stream)localObject1).map(new bgen(0, paramXMediaEditor, paramXMediaEditor.a("troopuin")));
    }
    for (;;)
    {
      localObject2 = paramXMediaEditor.findViewHolderForLayoutPosition(this.jdField_c_of_type_Int);
      if ((localObject2 instanceof bgfm))
      {
        localObject2 = (bgfm)localObject2;
        if (this.jdField_d_of_type_JavaLangString.equals(((bgfm)localObject2).a.getTag())) {
          ((bgfi)((bgec)paramXMediaEditor.getAdapter()).a.a(1)).a((bgfm)localObject2, this, 0);
        }
      }
