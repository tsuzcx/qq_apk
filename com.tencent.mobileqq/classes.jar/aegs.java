...
public class aegs
  extends xpf
  implements aegr, agpb, agqu, agqw, View.OnClickListener, SeekBar.OnSeekBarChangeListener, bfpk, INetInfoHandler
{
  ...
  MessageQueue.IdleHandler jdField_a_of_type_AndroidOsMessageQueue$IdleHandler = new aehk(this);
  ImageButton jdField_a_of_type_AndroidWidgetImageButton;
  ImageView jdField_a_of_type_AndroidWidgetImageView;
  public LinearLayout a;
  public SeekBar a;
  TextView jdField_a_of_type_AndroidWidgetTextView;
  axjs jdField_a_of_type_Axjs;
  public bbjq a;
  bcpu jdField_a_of_type_Bcpu;
  bcuq jdField_a_of_type_Bcuq;
  ...
  public aegs(Activity paramActivity, xpj paramxpj, aejb paramaejb, String paramString)
  {
    ...
    this.jdField_a_of_type_MqqOsMqqHandler = new aehl(this);
    this.jdField_a_of_type_Aeic = ((aeic)paramxpj);
    this.jdField_a_of_type_Aejb = paramaejb;
    ((agqx)this.jdField_a_of_type_Agqv).a(paramaejb);
    this.jdField_b_of_type_JavaLangString = paramString;
    if ((paramString == null) && (PeakActivity.class.isInstance(paramActivity))) {
      this.jdField_b_of_type_JavaLangString = bjal.a().getCurrentAccountUin();
    }
    paramxpj = (PeakAppInterface)((PeakActivity)paramActivity).getAppRuntime();
    if (paramxpj != null) {
      ((akaz)paramxpj.a(2)).a(paramActivity);
    }
  }
  ...
  private void F()
  {
    ...
    this.jdField_c_of_type_AndroidWidgetImageButton.setContentDescription(ajya.a(2131700032));
    this.jdField_c_of_type_AndroidWidgetImageButton.setId(2131373021);
    this.jdField_c_of_type_AndroidWidgetImageButton.setImageResource(2130845348);
  ...
  private void H()
  {
    ...
    int i3 = this.jdField_a_of_type_Aeic.b();
    if ((i3 >= i1) && (i3 <= i2 + i1 - 1))
    {
  ...
  private <T extends aeiy> T a(long paramLong1, long paramLong2)
  {
    Iterator localIterator = this.jdField_a_of_type_Aeic.a().iterator();
    while (localIterator.hasNext())
    {
      aeiy localaeiy = (aeiy)localIterator.next();
      if ((localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long == paramLong1) && (localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int == paramLong2)) {
        return localaeiy;
      }
    }
    return null;
  ...
  private bcpu a(Context paramContext)
  {
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, String paramString, ArrayList<bbjs> paramArrayList)
  {
    bbjs localbbjs = new bbjs();
    localbbjs.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(paramInt1);
    localbbjs.jdField_b_of_type_Int = paramInt2;
    localbbjs.jdField_c_of_type_Int = paramInt3;
    localbbjs.jdField_b_of_type_JavaLangString = paramString;
    paramArrayList.add(localbbjs);
  }
  
  private void a(int paramInt1, int paramInt2, int paramInt3, ArrayList<bbjs> paramArrayList)
  {
    bbjs localbbjs = new bbjs();
    localbbjs.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(paramInt1);
    localbbjs.jdField_b_of_type_Int = paramInt2;
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, ArrayList<bbjs> paramArrayList, int paramInt4)
  {
    bbjs localbbjs = new bbjs();
    localbbjs.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(paramInt1);
    localbbjs.jdField_b_of_type_Int = paramInt2;
    localbbjs.jdField_c_of_type_Int = paramInt3;
    localbbjs.jdField_b_of_type_JavaLangString = "";
    localbbjs.jdField_e_of_type_Int = paramInt4;
    paramArrayList.add(localbbjs);
  }
  ...
  private void a(int paramInt, File paramFile)
  {
    ...
    for (;;)
    {
      if (localObject1 != null) {
        axqy.b(null, "dc00898", "", "", (String)localObject1, (String)localObject1, 0, 0, "", "", "", "");
      }
      ...
      bcql.a((Context)localObject1, 1, ajya.a(2131700051), 0).a();
      return;
    ...
    int i2 = this.jdField_a_of_type_Aeic.b();
    ...
    a((Activity)localObject1, ajya.a(2131700050), false, 0);
    if (vyf.a(BaseApplication.getContext(), paramFile.getAbsolutePath(), (String)localObject2)) {
  ...
  private void a(aeiy paramaeiy)
  {
    if (paramaeiy == null) {}
    do
    {
      return;
      if (AIOShortVideoData.class.isInstance(paramaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
      {
        AIOShortVideoData localAIOShortVideoData = (AIOShortVideoData)paramaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
        if (localAIOShortVideoData.jdField_b_of_type_Int == 0)
        {
          paramaeiy.jdField_a_of_type_Aeiz.jdField_h_of_type_Boolean = false;
          paramaeiy.jdField_a_of_type_Aeiz.jdField_d_of_type_Boolean = false;
        }
        for (;;)
        {
          ...
          paramaeiy.jdField_a_of_type_Aeiz.jdField_g_of_type_Boolean = false;
          return;
          this.jdField_d_of_type_AndroidWidgetTextView.setText(ShortVideoUtils.a(localAIOShortVideoData.jdField_a_of_type_Int * 1000));
          paramaeiy.jdField_a_of_type_Aeiz.jdField_i_of_type_Boolean = false;
        }
      }
      if ((paramaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOFileVideoData))
      {
        this.jdField_b_of_type_AndroidWidgetSeekBar.setProgress(0);
        paramaeiy.jdField_a_of_type_Aeiz.jdField_g_of_type_Boolean = false;
        return;
  ...
  private void a(Uri paramUri, ArrayList<bbjs> paramArrayList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        i1 = whj.a((Bitmap)localObject1, true, 3, localSparseArray) | 0x0;
        if (QLog.isColorLevel()) {
          QLog.i("AIOGalleryScene", 2, String.format("checkQQCode bmp!=null result=%d", new Object[] { Integer.valueOf(i1) }));
        }
        if (localObject1 == null)
        {
          i2 = whj.a(paramUri, this.jdField_a_of_type_AndroidAppActivity, 3, localSparseArray);
          i1 = i2;
          if (QLog.isColorLevel())
          {
  ...
  private void a(AIOFileVideoData paramAIOFileVideoData, int paramInt)
  {
    ...
    this.jdField_a_of_type_Bbjq.a(paramAIOFileVideoData);
    this.jdField_a_of_type_Bbjq.a();
  }
  
  private void a(AIOImageData paramAIOImageData, aeiy paramaeiy)
  {
    if (paramAIOImageData != null)
    {
      this.jdField_a_of_type_Aehr = new aehr(this);
      this.jdField_a_of_type_Aehr.jdField_a_of_type_Long = paramAIOImageData.jdField_f_of_type_Long;
      this.jdField_a_of_type_Aehr.jdField_a_of_type_Int = paramAIOImageData.jdField_f_of_type_Int;
      if (QLog.isColorLevel()) {
        QLog.d("AIOGalleryScene", 2, "dealSaveOriginalImage");
      }
      this.jdField_a_of_type_Aejb.a(this.jdField_a_of_type_Aehr.jdField_a_of_type_Long, this.jdField_a_of_type_Aehr.jdField_a_of_type_Int, 24);
    }
  }
  
  private void a(AIOImageData paramAIOImageData, aeiy paramaeiy, File paramFile)
  {
    this.jdField_a_of_type_Bbjq.a(new aeho(this, paramAIOImageData, paramaeiy, paramFile));
    this.jdField_a_of_type_Bbjq.a(new aegu(this));
  }
  ...
  private void a(AIOShortVideoData paramAIOShortVideoData, int paramInt)
  {
    ...
    for (i1 = 1;; i1 = 1)
    {
      ...
      if ((bfnz.d()) && ((paramAIOShortVideoData.jdField_b_of_type_Int != 1) || (i1 == 0))) {
        a(2131692916, 2130839647, 61, localArrayList1);
      }
      if (i1 == 0)
      {
        a(2131692906, 2130839637, 63, localArrayList1);
        a(2131692910, 2130839640, 60, localArrayList1);
        a(2131692918, 2130839648, 58, localArrayList1);
      }
      if ((this.jdField_g_of_type_Int != -1) && (!TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) && (this.r)) {
        a(2131692920, 2130839649, 62, localArrayList2);
      }
      if (i1 == 0) {
        a(2131692913, 2130839643, 64, localArrayList2, 5);
      }
      a(paramAIOShortVideoData, localFile, paramInt, localaeiy);
      paramAIOShortVideoData = (List[])new ArrayList[] { localArrayList1, localArrayList2 };
      this.jdField_a_of_type_Bbjq.a(paramAIOShortVideoData);
      this.jdField_a_of_type_Bbjq.a();
      return;
      if (QLog.isColorLevel()) {
  ...
  private void a(AIOShortVideoData paramAIOShortVideoData, aeiy paramaeiy)
  {
    if (paramAIOShortVideoData != null)
    {
      ...
      this.jdField_a_of_type_Aejb.a(paramAIOShortVideoData.jdField_f_of_type_Long, paramAIOShortVideoData.jdField_f_of_type_Int, 256);
    }
  }
  
  private void a(AIOShortVideoData paramAIOShortVideoData, File paramFile, int paramInt, aeiy paramaeiy)
  {
    this.jdField_a_of_type_Bbjq.a(new aegy(this, paramAIOShortVideoData, paramFile, paramInt, paramaeiy));
    this.jdField_a_of_type_Bbjq.a(new aegz(this));
  }
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    {
      aeiy localaeiy = this.jdField_a_of_type_Aeic.a();
      if ((localaeiy != null) && ((localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData)))
      {
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.a((AIOShortVideoData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData) != null))
        {
          this.jdField_c_of_type_AndroidWidgetImageButton.setVisibility(0);
          return true;
        }
      }
      else if ((localaeiy != null) && ((localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOFileVideoData)) && (vyf.c(((AIOFileVideoData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_c_of_type_JavaLangString)))
      {
        this.jdField_c_of_type_AndroidWidgetImageButton.setVisibility(0);
        return true;
      }
  ...
  private void b(aeiy paramaeiy)
  {
    AIOImageData localAIOImageData = (AIOImageData)paramaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
    ...
    for (;;)
    {
      ...
      Object localObject = bfpc.c(this.jdField_a_of_type_AndroidAppActivity);
      if ((!a((bfpc)localObject, localAIOImageData)) && (akpx.a(this.jdField_g_of_type_Int) != 1032))
      {
        ...
        if (localFile != null) {
          if (!this.jdField_c_of_type_Boolean)
          {
            ...
            {
              a(2131692904, 2130839633, 48, (ArrayList)localObject);
            ...
            if ((this.jdField_g_of_type_Int != 1037) && (this.jdField_g_of_type_Int != 1044)) {
              a(2131692907, 2130839638, 49, (ArrayList)localObject);
            }
            if ((PicShareToWX.a().a()) && (PicShareToWX.a().a(localFile))) {
              a(2131692917, 2130845906, 69, (ArrayList)localObject);
            }
            if (!aqwf.a().a()) {
              a(2131692916, 2130839647, 53, (ArrayList)localObject);
            }
            if (!this.jdField_h_of_type_Boolean) {
              a(2131692906, 2130839637, 57, (ArrayList)localObject);
            }
            if ((this.jdField_g_of_type_Int != 1037) && (this.jdField_g_of_type_Int != 1044))
            {
              if (localAIOImageData.jdField_e_of_type_JavaLangString != null) {
                a(2131692911, 2130839641, 50, (ArrayList)localObject, 3);
              }
              if ((this.jdField_i_of_type_Boolean) && (localAIOImageData.jdField_e_of_type_JavaLangString != null)) {
                a(2131692908, 2130839639, 51, (ArrayList)localObject, 3);
              }
            }
            a(2131692918, 2130839648, 58, (ArrayList)localObject);
            if ((this.jdField_g_of_type_Int != 1037) && (this.jdField_g_of_type_Int != 1044))
            {
              if ((this.jdField_g_of_type_Int != -1) && (!TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) && (this.r)) {
                a(2131692920, 2130839649, 54, localArrayList, 3);
              }
              if (this.jdField_g_of_type_Boolean) {
                a(2131692912, 2130839642, 52, localArrayList, 2);
              }
        ...
        for (;;)
        {
          if ((localAIOImageData.jdField_e_of_type_Int == 4) && (!localAIOImageData.jdField_i_of_type_Boolean)) {
            a(2131693393, 2130845768, 66, (ArrayList)localObject);
          }
          a(localAIOImageData, paramaeiy, localFile);
          paramaeiy = (List[])new ArrayList[] { localObject, localArrayList };
          this.jdField_a_of_type_Bbjq.a(paramaeiy);
          this.jdField_a_of_type_Bbjq.a();
          return;
          a(2131693384, 2130839638, 49, (ArrayList)localObject);
          a(2131693394, 2130839647, 53, (ArrayList)localObject);
          continue;
      ...
      if ((akpx.a(this.jdField_g_of_type_Int) == 1032) && (localFile != null)) {
        ((bfpc)localObject).b(2131693394);
      }
      ((bfpc)localObject).c(2131690596);
      ((bfpc)localObject).a(new aegx(this, (bfpc)localObject, localAIOImageData, localFile));
      ((bfpc)localObject).show();
      ((bfpc)localObject).a(this);
      return;
    }
  }
  
  public static void b(aeiy paramaeiy, Activity paramActivity, int paramInt)
  {
    ...
    for (int i1 = 0;; i1 = 1)
    {
      ...
      for (int i2 = 4;; i2 = 2)
      {
        localBundle.putString("forward_urldrawable_big_url", paramaeiy.a(i2));
        if (paramActivity.getIntent().getBooleanExtra("image_share_by_server", false))
        {
          paramaeiy = Long.toString(paramActivity.getIntent().getLongExtra("appid", 0L));
          i2 = paramActivity.getIntent().getIntExtra("curType", 0);
          localBundle.putBoolean("key_forward_image_share", true);
          localBundle.putString("key_forward_image_share_appid", paramaeiy);
        ...
        try
        {
          ...
          aqbe.a(paramActivity, paramaeiy, paramInt);
          return;
        }
  ...
  {
    RelativeLayout localRelativeLayout = (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131561103, null);
    Object localObject = new RelativeLayout.LayoutParams(-2, -2);
    ((RelativeLayout.LayoutParams)localObject).addRule(12, -1);
    if (paramBoolean) {
      ((RelativeLayout.LayoutParams)localObject).addRule(0, 2131373022);
    }
    for (;;)
    {
      ...
      this.jdField_b_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_a_of_type_AndroidWidgetLinearLayout.findViewById(2131375776));
      ...
      this.jdField_b_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localRelativeLayout.findViewById(2131378679));
      this.jdField_a_of_type_AndroidWidgetSeekBar = ((SeekBar)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131378681));
      this.jdField_a_of_type_AndroidWidgetSeekBar.setMax(10000);
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131378680));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_b_of_type_AndroidWidgetRelativeLayout.findViewById(2131364259));
      this.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_c_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)localRelativeLayout.findViewById(2131363721));
      this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)localRelativeLayout.findViewById(2131374698));
      return;
  ...
  void C()
  {
    for (;;)
    {
      ...
      try
      {
        localAIORichMediaData = this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
      ...
      if ((localAIORichMediaData instanceof AIOFilePicData))
      {
        ...
        if (localObject2 == null)
        {
          ...
          default: 
            ...
            if ((localAIORichMediaData instanceof AIOFilePicData))
            {
              if (this.jdField_a_of_type_Aejb.asBinder().pingBinder())
              {
                localObject3 = this.jdField_a_of_type_Aejb.a(localAIORichMediaData.jdField_f_of_type_Long, localAIORichMediaData.jdField_f_of_type_Int, this.jdField_g_of_type_Int);
                if (localObject3 != null)
                {
          ...
          for (;;)
          {
            ...
            return;
            axqy.b(null, "dc00898", "", "", "0X800A187", "0X800A187", 0, 0, "", "", "", "");
            i2 = 0;
            bool = true;
            i1 = 125;
            i3 = 19002;
  ...
  public void E()
  {
    if ((this.jdField_a_of_type_Agqv != null) && (this.jdField_a_of_type_Agqv.a != null) && (this.jdField_a_of_type_Agqv.a.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Agqv.c()))
    {
      ...
      localObject = bbdj.a(this.jdField_a_of_type_AndroidAppActivity, 230, null, (String)localObject, 2131694648, 2131720929, new aehi(this), new aehj(this));
  ...
  {
    return (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131560956, null);
  }
  ...
  protected AbstractImageAdapter a(Context paramContext)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter = new AIOGalleryAdapter(paramContext, this.jdField_a_of_type_Aejb, true, i1);
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.a(this.jdField_a_of_type_Agqv);
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.jdField_a_of_type_Aegm = new aehd(this);
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.a(this.jdField_a_of_type_Aeic);
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.a(new aehe(this));
    ...
    for (;;)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter = new AIOGalleryAdapter(paramContext, this.jdField_a_of_type_Aejb, bool1, i1);
      break;
      bool1 = bool2;
    }
  }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Aeic.a((aeiy)localObject);
    this.q = localBundle.getBoolean("muate_play");
    if (QLog.isColorLevel()) {
      QLog.d("AIOGalleryScene", 2, "initData , mIsMute = " + this.q);
    }
    ((aeiy)localObject).jdField_b_of_type_AndroidGraphicsRect = ((Rect)localBundle.getParcelable("KEY_THUMBNAL_BOUND"));
    ...
    {
      this.jdField_a_of_type_Aeic.a(true);
    ...
    for (boolean bool = false;; bool = true)
    {
      ...
      if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
        this.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidAppActivity.getString(2131693390);
      }
      ...
      return;
      ((aeiy)localObject).jdField_c_of_type_Boolean = false;
      break;
    }
  }
  ...
  {
    super.a(paramInt);
    this.jdField_a_of_type_Aehs.jdField_a_of_type_Boolean = true;
    u();
  }
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    do
    {
      ...
      {
        bcql.a(this.jdField_a_of_type_AndroidAppActivity, 2131719571, 0).a();
        return;
      }
    } while ((paramInt1 != 10002) || (this.jdField_a_of_type_Axjs == null));
    this.jdField_a_of_type_Axjs.a(paramInt2);
  }
  ...
  public void a(int paramInt1, View paramView, String paramString1, String[] paramArrayOfString, String paramString2, MessageForShortVideo paramMessageForShortVideo, int paramInt2)
  {
    ...
    aeiy localaeiy = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.a(paramInt1);
    if (localaeiy == null) {}
    for (;;)
    {
      return;
      if (AIOShortVideoData.class.isInstance(localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
      {
        if (QLog.isColorLevel()) {
          QLog.d("AIOGalleryScene", 2, "carverW notifyVideoUrl setShortVideoDrawableWithUrls ,AIOShortVideoData id=" + localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long);
        }
        aejk.a().a(localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long, paramArrayOfString, System.currentTimeMillis(), paramMessageForShortVideo, paramInt2, paramString2);
        paramString1 = new agra();
        ...
        paramString1.jdField_a_of_type_Long = localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long;
        paramString1.jdField_b_of_type_Int = localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int;
        paramArrayOfString = new File(((AIOShortVideoData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_b_of_type_JavaLangString);
        if (paramArrayOfString.exists())
        {
          ...
          this.jdField_a_of_type_Agqv.a(paramView, paramString1);
          paramView = (AIOShortVideoData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
          if (!this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.a(((AIOShortVideoData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_a_of_type_Long)) {
            break label481;
          }
          this.jdField_a_of_type_Agqv.f();
          this.jdField_a_of_type_Agqv.a((AIOShortVideoData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData, false, false);
        }
        for (;;)
        {
          if ((this.jdField_a_of_type_Aejb == null) || (paramView.a(0) != null)) {
            break label499;
          }
          if (QLog.isColorLevel()) {
            QLog.d("AIOGalleryScene", 2, "setShortVideoDrawableWithUrls, get THUMB");
          }
          this.jdField_a_of_type_Aejb.a(paramView.jdField_f_of_type_Long, paramView.jdField_f_of_type_Int, 0);
          return;
          paramString1.d = 0L;
          break;
          label481:
          this.jdField_a_of_type_Agqv.a((AIOShortVideoData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData, false, true);
        }
      }
      else
      {
        label499:
        if (AIOFileVideoData.class.isInstance(localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
        {
          paramMessageForShortVideo = (AIOFileVideoData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
          if (paramMessageForShortVideo.jdField_a_of_type_Boolean)
          {
            QLog.i("VideoPlayControllerForFile", 1, "filevideo is playing:" + localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long);
            return;
          }
          ...
          if ("I:E".equals(paramString1)) {
            try
            {
              ...
              if (paramMessageForShortVideo.jdField_b_of_type_Long == -134L)
              {
                ...
                if (paramInt1 != 0)
                {
                  paramString1 = bbdj.a(this.jdField_a_of_type_AndroidAppActivity, 230, "", paramString1, null, ajya.a(2131700045), new aehh(this), null);
  ...
  public void a(int paramInt, Object paramObject, aeiy paramaeiy)
  {
    a(bbdj.a(this.jdField_a_of_type_AndroidAppActivity, 230, this.jdField_a_of_type_AndroidAppActivity.getString(2131718837), this.jdField_a_of_type_AndroidAppActivity.getString(2131718836), new aegv(this, paramInt, paramObject, paramaeiy), new aegw(this)));
  }
  ...
  public void a(long paramLong)
  {
    boolean bool = true;
    int i1;
    if ((this.jdField_a_of_type_Xpw != null) && (this.jdField_a_of_type_Xpw.a() == this))
    {
      i1 = 1;
      if (i1 != 0) {
        break label49;
    ...
    do
    {
      ...
      i1 = 0;
      break;
      localaeiy = this.jdField_a_of_type_Aeic.a();
      if ((localaeiy != null) && (localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData != null)) {
        break label88;
      }
    } while (!QLog.isColorLevel());
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("AIOGalleryScene", 2, "onRevokeMsg seq:" + paramLong + ", selectItem seq:" + localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long + ", isFromMultiMsg:" + this.jdField_c_of_type_Boolean + ", OriSeq:" + this.jdField_a_of_type_Long);
      }
      if ((this.jdField_a_of_type_Aejb != null) && (!bool)) {
        this.jdField_a_of_type_Aejb.a(paramLong);
      }
      this.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new AIOGalleryScene.28(this, paramLong, localaeiy, bool));
      return;
      bool = false;
    }
  }
  ...
  public void a(long paramLong1, int paramInt1, int paramInt2, int paramInt3, long paramLong2, boolean paramBoolean)
  {
    ...
    if (paramInt2 == 2)
    {
      localObject1 = this.jdField_a_of_type_Aeic.a();
      paramInt2 = 0;
      if (paramInt2 < ((List)localObject1).size())
      {
        localObject2 = (aeiy)((List)localObject1).get(paramInt2);
        if ((((aeiy)localObject2).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long != paramLong1) || (((aeiy)localObject2).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int != paramInt1)) {
          break label156;
        }
        ((aeiy)localObject2).jdField_a_of_type_Int = paramInt3;
    ...
    do
    {
      do
      {
        do
        {
          for (;;)
          {
            ...
            if (paramInt2 == 24)
            {
              localObject1 = this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
              if ((((AIORichMediaData)localObject1).jdField_f_of_type_Long == paramLong1) && (((AIORichMediaData)localObject1).jdField_f_of_type_Int == paramInt1))
              {
                ...
                {
                  this.jdField_b_of_type_AndroidWidgetTextView.setText(ajya.a(2131700041) + paramInt3 / 100.0D + "%");
              ...
              else
              {
                ...
                if (localObject1 != null) {
                  ((aeiy)localObject1).jdField_a_of_type_Aeiz.jdField_a_of_type_Int = paramInt3;
                }
              }
            }
            else if (paramInt2 == 4)
            {
              ...
              if ((((AIORichMediaData)localObject1).jdField_f_of_type_Long == paramLong1) && (((AIORichMediaData)localObject1).jdField_f_of_type_Int == paramInt1))
              {
                this.jdField_a_of_type_Aeic.a().jdField_a_of_type_Int = paramInt3;
                this.jdField_b_of_type_AndroidWidgetTextView.setText(ajya.a(2131700035) + apvd.a((paramLong2 * (paramInt3 / 10000.0D))) + "/" + apvd.a(paramLong2) + ")");
                this.jdField_a_of_type_AndroidWidgetSeekBar.setProgress(paramInt3);
                return;
              }
              localObject1 = a(paramLong1, paramInt1);
              if (localObject1 != null) {
                ((aeiy)localObject1).jdField_a_of_type_Int = paramInt3;
              }
            }
            else if (paramInt2 == 1)
            {
              ...
              {
                localObject2 = (aeiy)((List)localObject1).get(paramInt1);
                if (((aeiy)localObject2).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long == paramLong1)
                {
                  ((aeiy)localObject2).jdField_a_of_type_Int = paramInt3;
            ...
            else if (paramInt2 == 256)
            {
              ...
              if ((((AIORichMediaData)localObject1).jdField_f_of_type_Long == paramLong1) && (((AIORichMediaData)localObject1).jdField_f_of_type_Int == paramInt1))
              {
                this.jdField_b_of_type_AndroidWidgetTextView.setText(ajya.a(2131700066) + paramInt3 + "%");
      ...
      localObject2 = (AIOFilePicData)((aeiy)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
      ((AIOFilePicData)localObject2).jdField_f_of_type_Boolean = true;
      if (this.jdField_a_of_type_Aehr == null)
      {
        this.jdField_a_of_type_Aehr = new aehr(this);
        this.jdField_a_of_type_Aehr.jdField_a_of_type_Long = ((aeiy)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long;
        this.jdField_a_of_type_Aehr.jdField_a_of_type_Int = ((aeiy)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int;
      }
    } while ((((AIOFilePicData)localObject2).jdField_f_of_type_Long != paramLong1) || (this.jdField_a_of_type_AndroidWidgetSeekBar == null));
    a(true);
    this.jdField_a_of_type_Aeic.a().jdField_a_of_type_Int = paramInt3;
    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajya.a(2131700068) + apvd.a((paramLong2 * (paramInt3 / 10000.0D))) + "/" + apvd.a(paramLong2) + ")");
    this.jdField_a_of_type_AndroidWidgetSeekBar.setProgress(paramInt3);
  }
  ...
  public void a(long paramLong, int paramInt1, int paramInt2, int paramInt3, String paramString, boolean paramBoolean)
  {
    ...
    if (paramInt2 == 2)
    {
      localObject1 = this.jdField_a_of_type_Aeic;
      if (paramInt3 == 1)
      {
        paramInt2 = ((aeic)localObject1).a(paramLong, paramInt1, paramInt2, paramString, false);
        ...
        paramInt2 = 0;
        label133:
        if (paramInt2 >= this.jdField_a_of_type_Aeic.a()) {
          break label460;
        }
        paramString = this.jdField_a_of_type_Aeic.a(paramInt2);
        if (paramString != null) {
          break label178;
        }
      }
    ...
    else
    {
      ...
      bcql.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131718834), 0).a();
      u();
      label425:
      if ((this.jdField_a_of_type_Aehr != null) && (this.jdField_a_of_type_Aehr.jdField_a_of_type_Long == paramLong) && (this.jdField_a_of_type_Aehr.jdField_a_of_type_Int == paramInt1)) {
        this.jdField_a_of_type_Aehr = null;
      }
    }
    label460:
    label461:
    ...
    do
    {
      ...
      {
        return;
        bcql.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131718830), 0).a();
        break;
        paramString = a(paramLong, paramInt1);
        if (paramString == null) {
          break label425;
        }
        paramString.jdField_a_of_type_Aeiz.jdField_e_of_type_Boolean = false;
        break label425;
        if (paramInt2 != 4) {
          break label869;
        }
      } while ((this.jdField_a_of_type_Aehr == null) || (this.jdField_a_of_type_Aehr.jdField_a_of_type_Long != paramLong) || (this.jdField_a_of_type_Aehr.jdField_a_of_type_Int != paramInt1));
      localObject2 = this.jdField_a_of_type_Aeic;
      if (paramInt3 == 1)
      {
        localObject1 = paramString;
        ((aeic)localObject2).a(paramLong, paramInt1, paramInt2, (String)localObject1, false);
        if (paramInt3 != 1) {
          break label796;
        }
      ...
      for (;;)
      {
        try
        {
          paramString = URLDrawable.getDrawable(this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.a(4), paramString);
          if (paramString == null) {
            break;
          }
          ...
          default: 
            ...
            paramString.setURLDrawableListener(this.jdField_a_of_type_Aehr);
            paramString.startDownload();
            this.jdField_a_of_type_Aehr.jdField_a_of_type_ComTencentImageURLDrawable = paramString;
            paramString = this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
            if ((paramString.jdField_f_of_type_Long != paramLong) || (paramString.jdField_f_of_type_Int != paramInt1)) {
              break label837;
            }
            this.jdField_a_of_type_Aeic.a().jdField_a_of_type_Aeiz.jdField_c_of_type_Boolean = false;
            u();
            return;
            localObject1 = "I:E";
          }
        ...
        catch (Throwable paramString)
        {
          ...
          paramString = null;
          continue;
          this.jdField_a_of_type_Aehr.onLoadSuccessed(paramString);
          continue;
          this.jdField_a_of_type_Aehr.onLoadFialed(paramString, null);
          continue;
          this.jdField_a_of_type_Aehr.onLoadCanceled(paramString);
          continue;
        }
        if (!"TroopFileError".equals(paramString)) {
          bcql.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131695341), 0).a();
        }
        this.jdField_a_of_type_Aehr = null;
        continue;
        paramString = a(paramLong, paramInt1);
        if (paramString != null)
        {
          ...
          paramString.jdField_a_of_type_Aeiz.jdField_c_of_type_Boolean = false;
        }
      }
      if (paramInt2 == 256)
      {
        ...
        for (;;)
        {
          this.jdField_a_of_type_Aehs.jdField_b_of_type_Boolean = false;
          u();
          return;
          bcql.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131718830), 0).a();
        }
      ...
      if ((paramInt2 == 1) || (paramInt2 == 0))
      {
        ...
        for (;;)
        {
          paramInt1 = ((aeic)localObject1).a(paramLong, paramInt1, paramInt2, paramString, false);
          paramInt2 = this.jdField_a_of_type_ComTencentWidgetGallery.getFirstVisiblePosition();
          paramInt3 = this.jdField_a_of_type_ComTencentWidgetGallery.getChildCount();
          if ((paramInt1 >= paramInt2) && (paramInt1 <= paramInt3 + paramInt2 - 1))
          {
      ...
      if ((paramInt2 == 20) && (this.jdField_a_of_type_Aehr != null) && (this.jdField_a_of_type_Aehr.jdField_a_of_type_Long == paramLong))
      {
        localObject2 = this.jdField_a_of_type_Aeic;
        if (paramInt3 == 1) {}
        for (localObject1 = paramString;; localObject1 = "I:E")
        {
          ...
          paramString = this.jdField_a_of_type_Aeic.a();
          ...
          paramString.mPlayGifImage = true;
          paramString.mUseExifOrientation = false;
          localObject1 = this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.a(20);
        ...
        if (!"TroopFileError".equals(paramString))
        {
          if (!this.jdField_a_of_type_AndroidAppActivity.getString(2131692857).equals(paramString)) {
            break label1645;
          }
          bcql.a(this.jdField_a_of_type_AndroidAppActivity, paramString, 0).a();
        }
        for (;;)
        {
          a(false);
    ...
    paramInt1 = 0;
    label1680:
    if (paramInt1 < this.jdField_a_of_type_Aeic.a())
    {
      localObject1 = this.jdField_a_of_type_Aeic.a(paramInt1);
      if ((localObject1 != null) && (((aeiy)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData != null) && (AIOFileVideoData.class.isInstance(((aeiy)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))) {
        break label1735;
      }
    }
    label1735:
    ...
    } while (((aeiy)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long != paramLong);
    if (paramInt3 == 1)
    {
    ...
    {
      u();
      if (this.jdField_a_of_type_Aeic.a() != localObject1) {
        break;
      }
  ...
  {
    paramInt1 = this.jdField_a_of_type_Aeic.a(paramLong, paramInt1, paramInt2, paramString1, false);
    paramInt2 = this.jdField_a_of_type_ComTencentWidgetGallery.getFirstVisiblePosition();
    int i1 = this.jdField_a_of_type_ComTencentWidgetGallery.getChildCount();
    if (QLog.isDevelopLevel()) {
  ...
  {
    b(paramaeiy, this.jdField_a_of_type_AndroidAppActivity, 0);
  }
  ...
  public void a(agra paramagra)
  {
    ...
    label78:
    for (String str = "null";; str = paramagra.jdField_a_of_type_Long + "")
    {
      QLog.d("AIOGalleryScene", 2, str);
      if ((paramagra == null) || (!paramagra.jdField_b_of_type_Boolean) || (!paramagra.jdField_a_of_type_Boolean)) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Aeic.a().jdField_a_of_type_Aeiz.jdField_g_of_type_Boolean = true;
    u();
  }
  ...
  public void a(agra paramagra, int paramInt)
  {
    ...
    {
      localObject1 = this.jdField_a_of_type_Aeic.a();
      if ((localObject1 != null) && (((aeiy)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData != null) && (paramagra != null)) {
        break label96;
      }
    }
    label96:
    ...
    {
      return;
      localObject1 = paramagra.jdField_a_of_type_Long + "";
      break;
      localObject2 = a(paramagra.jdField_a_of_type_Long, paramagra.jdField_b_of_type_Int);
      if (localObject2 != null) {
        ((aeiy)localObject2).jdField_a_of_type_Aeiz.jdField_d_of_type_Boolean = false;
      }
    } while (((aeiy)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long != paramagra.jdField_a_of_type_Long);
    u();
  }
  ...
  public void a(agra paramagra, int paramInt1, int paramInt2, String paramString)
  {
      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              return;
              localObject = paramagra.jdField_a_of_type_Long + "";
              break;
              localObject = this.jdField_a_of_type_Aeic.a();
            } while (((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long != paramagra.jdField_a_of_type_Long);
            if (!paramagra.jdField_b_of_type_Boolean) {
              break label231;
            }
          ...
          paramString = qtx.a(paramInt1, paramInt2);
          localObject = (AIOFileVideoData)((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
        ...
        if (agqx.class.isInstance(this.jdField_a_of_type_Agqv)) {
          f1 = ((agqx)this.jdField_a_of_type_Agqv).a(paramagra.jdField_a_of_type_Long);
        }
        paramString.putFloat("progress", f1);
        this.jdField_a_of_type_Aejb.a(((AIOFileVideoData)localObject).jdField_f_of_type_Long, 10, paramString);
        u();
        return;
        paramagra = a(paramagra.jdField_a_of_type_Long, paramagra.jdField_b_of_type_Int);
      } while (paramagra == null);
      paramagra.jdField_a_of_type_Aeiz.jdField_k_of_type_Boolean = true;
    ...
    ((AIOShortVideoData)((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).a(paramString);
    u();
  }
  ...
  public void a(agra paramagra, long paramLong)
  {
    ...
    label57:
    for (paramagra = "null";; paramagra = paramagra.jdField_a_of_type_Long + "")
    {
      QLog.d("AIOGalleryScene", 2, paramagra);
  ...
  public void a(agra paramagra, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        return;
        str = paramagra.jdField_a_of_type_Long + "";
        break;
        paramagra = a(paramagra.jdField_a_of_type_Long, paramagra.jdField_b_of_type_Int);
      } while (paramagra == null);
      paramagra.jdField_a_of_type_Aeiz.jdField_j_of_type_Boolean = paramBoolean;
    } while (paramagra.jdField_a_of_type_Aeiz.jdField_g_of_type_Boolean);
  ...
  public void a(Activity paramActivity, String paramString, boolean paramBoolean, int paramInt)
  {
    if (this.jdField_a_of_type_AndroidAppDialog == null)
    {
      ...
      this.jdField_a_of_type_Bcpu = a(paramActivity);
    ...
    if (!paramBoolean) {
      this.jdField_a_of_type_AndroidAppDialog.setOnKeyListener(new aehf(this));
    }
  ...
  public void a(ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_Axjs = axjs.a(bjal.a());
    if (this.jdField_a_of_type_Axjs != null) {
      this.jdField_b_of_type_AndroidWidgetImageView = this.jdField_a_of_type_Axjs.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidWidgetRelativeLayout, this.jdField_b_of_type_JavaLangString);
    }
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setId(2131373027);
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(this.jdField_a_of_type_AndroidAppActivity.getString(2131695339));
    this.jdField_a_of_type_AndroidWidgetTextView.setPadding(i1, i1, i1, i1);
    this.jdField_a_of_type_AndroidWidgetTextView.setBackgroundDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130843012));
    ...
    this.jdField_d_of_type_AndroidWidgetImageButton.setContentDescription(ajya.a(2131700069));
    this.jdField_d_of_type_AndroidWidgetImageButton.setId(2131373022);
    ...
    if ((f()) && (!(this.jdField_a_of_type_AndroidAppActivity.getIntent().getExtras().getParcelable("extra.EXTRA_CURRENT_IMAGE") instanceof AIODevLittleVideoData)))
    {
      ...
      this.jdField_b_of_type_AndroidWidgetImageButton.setContentDescription(ajya.a(2131700064));
      this.jdField_b_of_type_AndroidWidgetImageButton.setId(2131373023);
      ...
      i1 = 1;
      label799:
      if (((i1 != 0) || ((this.jdField_k_of_type_Int == 4) && (localBundle.getBoolean("key_allow_forward_photo_preview_edit", false)))) && (akpx.a(this.jdField_g_of_type_Int) != 1032) && (this.jdField_g_of_type_Int != 1037) && (this.jdField_g_of_type_Int != 1044))
      {
        this.jdField_a_of_type_AndroidWidgetImageButton.setContentDescription(ajya.a(2131700060));
        ...
        this.jdField_a_of_type_AndroidWidgetImageButton.setId(2131373024);
        ...
        localLayoutParams.addRule(0, 2131373022);
      }
    }
    for (;;)
    {
      ...
      if ((agpc.class.isInstance(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter)) && (ProGallery.class.isInstance(this.jdField_a_of_type_ComTencentWidgetGallery))) {
      ...
      this.jdField_a_of_type_Agqv.a(this);
      this.jdField_a_of_type_Agqv.e(this.jdField_k_of_type_Int);
      ((ProGallery)this.jdField_a_of_type_ComTencentWidgetGallery).setGestureListener(this);
      this.jdField_l_of_type_Int = (axns.a(this.jdField_a_of_type_AndroidAppActivity) / 2);
      aegp.a().a(this);
      return;
      i1 = 0;
      break;
  ...
  public void a(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    {
      if (this.jdField_a_of_type_Aeic.a()) {
        z();
      }
    }
    else
    {
      ...
      if (AIOGalleryAdapter.GalleryImageStruct.class.isInstance(paramView))
      {
        ...
        {
          a((aeiy)localObject);
          if ((((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.a(4)) || (((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.a(20)))
          {
            if (((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.h <= 0L) {
              break label600;
            }
            this.jdField_a_of_type_AndroidWidgetTextView.setText(String.format(Locale.CHINA, this.jdField_a_of_type_AndroidAppActivity.getString(2131695342), new Object[] { apvd.a(((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.h) }));
            label196:
            c(true);
    ...
    for (;;)
    {
      a(paramAdapterView);
      u();
      if ((paramAdapterView != null) && (this.jdField_a_of_type_Axjs != null))
      {
        if (!(paramAdapterView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData)) {
          break label894;
        }
        this.jdField_a_of_type_Axjs.a((AIOShortVideoData)paramAdapterView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData);
      }
      return;
      int i2 = this.jdField_a_of_type_Aeic.a();
      int i1 = 0;
      ...
      for (;;)
      {
        ...
        this.jdField_n_of_type_Int = this.jdField_a_of_type_Aeic.a();
        this.jdField_a_of_type_Aejb.a(0);
        break;
        label576:
        i1 = 0;
        continue;
      ...
      localObject = this.jdField_a_of_type_Aeic.a(paramInt);
      if ((localObject != null) && ((((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOFilePicData)))
      {
        this.jdField_a_of_type_AndroidWidgetTextView.setText(String.format(Locale.CHINA, this.jdField_a_of_type_AndroidAppActivity.getString(2131695342), new Object[] { apvd.a(((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.h) }));
        if (((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.h <= apei.c()) {
          break label848;
        }
        c(true);
      ...
      for (;;)
      {
        if ((localObject == null) || (!(((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOImageData)) || (((AIOImageData)((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_g_of_type_Int != 1)) {
          break label854;
        }
        this.jdField_a_of_type_AndroidWidgetTextView.setText(String.format(Locale.CHINA, this.jdField_a_of_type_AndroidAppActivity.getString(2131695342), new Object[] { apvd.a(((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.h) }));
        if (((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.h <= apei.c()) {
    ...
    label894:
    this.jdField_a_of_type_Axjs.a(null);
  }
  
  void a(String paramString, int paramInt)
  {
    if (this.jdField_a_of_type_Aejb != null) {
      this.jdField_a_of_type_Aejb.a(paramString, paramInt);
    }
  }
  ...
  void a(String paramString1, int paramInt1, boolean paramBoolean, String paramString2, String paramString3, String paramString4, String paramString5, int paramInt2, Intent paramIntent)
  {
    ...
    if (!TextUtils.isEmpty(str)) {
      if (i1 != 80) {
        ...
        for (;;)
        {
          localIntent.putExtra("report_params", whj.a(paramString3, paramString1, paramString5, paramString2, paramIntent, paramInt1));
  ...
  public boolean a(int paramInt, KeyEvent paramKeyEvent)
  {
    if (82 == paramKeyEvent.getKeyCode()) {
      try
      {
        if (!AIODevLittleVideoData.class.isInstance(this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) {
          c(3);
        }
        return true;
      }
  ...
  {
    w();
    aeiy localaeiy = this.jdField_a_of_type_Aeic.b();
    if (localaeiy != null) {
      localaeiy.jdField_b_of_type_Boolean = true;
    }
    if (!g()) {
    ...
    this.jdField_a_of_type_Aehs.jdField_d_of_type_Boolean = false;
    u();
  ...
  {
    super.b(paramInt);
    this.jdField_a_of_type_Aehs.jdField_a_of_type_Boolean = false;
    u();
  }
  ...
  {
    this.jdField_a_of_type_Aeic.a().jdField_a_of_type_Aeiz.jdField_g_of_type_Boolean = true;
    int i1 = this.jdField_a_of_type_Aeic.a(paramLong, 0, 0, "", false);
    aeiy localaeiy = this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.a(i1);
    if (AIOFileVideoData.class.isInstance(localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
    {
      ((AIOFileVideoData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).a();
  ...
  public void b(agra paramagra, int paramInt)
  {
    ...
    do
    {
      ...
      paramagra.jdField_a_of_type_Aeiz.jdField_h_of_type_Boolean = true;
    } while (paramagra.jdField_a_of_type_Aeiz.jdField_g_of_type_Boolean);
    this.jdField_e_of_type_AndroidWidgetTextView.setText("");
    u();
  }
  ...
  public void c()
  {
    this.jdField_a_of_type_Aehs.jdField_d_of_type_Boolean = true;
    u();
    if (!h()) {
  ...
  void c(int paramInt)
  {
    if (this.jdField_a_of_type_Bbjq == null)
    {
      ...
      this.jdField_a_of_type_Bbjq.a(this.jdField_a_of_type_AndroidAppActivity.getString(2131692919));
    }
    this.jdField_a_of_type_Bbjq.a(new aeha(this));
    aeiy localaeiy = this.jdField_a_of_type_Aeic.a();
    Object localObject3;
    Object localObject2;
    Object localObject1;
    ...
    {
      localObject3 = (AIOImageData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
      ...
      for (i1 = 2;; i1 = 1)
      {
        i2 = localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_g_of_type_Int;
        if (i2 != 0) {
          break;
        }
        i3 = 1;
        ...
        paramInt = 1;
        label203:
        axqy.b(null, "dc00898", "", "", "0X8009EFB", "0X8009EFB", i1, 0, String.valueOf(i3), String.valueOf(i2), String.valueOf(paramInt), "");
        return;
        b(localaeiy);
      }
    }
    if (AIOShortVideoData.class.isInstance(localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
    {
      localObject1 = (AIOShortVideoData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
    ...
    for (;;)
    {
      ...
      if (((AIOShortVideoData)localObject1).jdField_b_of_type_Int == 1)
      {
        ...
        {
          localObject3 = (AIOFilePicData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
        ...
        {
          i1 = 5;
          a((AIOFileVideoData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData, paramInt);
          break label170;
          if (i2 == 1)
          {
            i3 = 2;
  ...
  public void d()
  {
    ...
    if (this.jdField_a_of_type_Axjs != null) {
      this.jdField_a_of_type_Axjs.b();
    }
    this.jdField_a_of_type_Aehs.jdField_f_of_type_Boolean = true;
    u();
  }
  ...
  public void d(int paramInt)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.w("AIOGalleryScene", 2, "[setProgress] current:" + this.jdField_a_of_type_Bcpu.a() + ", progress:" + paramInt);
    }
  ...
  public void d(agra paramagra)
  {
    ...
    do
    {
      ...
      localObject2 = a(paramagra.jdField_a_of_type_Long, paramagra.jdField_b_of_type_Int);
      if (localObject2 != null) {
        ((aeiy)localObject2).jdField_a_of_type_Aeiz.jdField_d_of_type_Boolean = true;
      }
    } while ((((aeiy)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long != paramagra.jdField_a_of_type_Long) || (((aeiy)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int != paramagra.jdField_b_of_type_Int));
    u();
  }
  ...
  public void e()
  {
    if (this.jdField_l_of_type_Boolean)
    {
      ...
      aeiy localaeiy = this.jdField_a_of_type_Aeic.a();
      if (localaeiy != null) {
        localIntent.putExtra("extra.EXTRA_CURRENT_IMAGE", localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData);
      }
  ...
  public boolean e()
  {
    ...
    do
    {
      return bool1;
      Object localObject = this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
      if ((localObject != null) && (AIOImageData.class.isInstance(localObject)) && (this.jdField_a_of_type_Aeic.a().jdField_a_of_type_Aeiz != null) && (this.jdField_a_of_type_Aeic.a().jdField_a_of_type_Aeiz.jdField_c_of_type_Boolean))
      {
        if (this.jdField_a_of_type_Aehr != null) {
          this.jdField_a_of_type_Aejb.b(this.jdField_a_of_type_Aehr.jdField_a_of_type_Long, this.jdField_a_of_type_Aehr.jdField_a_of_type_Int, 4);
        }
        this.jdField_a_of_type_Aeic.a().jdField_a_of_type_Aeiz.jdField_c_of_type_Boolean = false;
        u();
        return true;
      ...
      if (this.jdField_j_of_type_Boolean)
      {
        ...
        if (localObject != null)
        {
          ...
          localIntent.putExtra("extra.EXTRA_CURRENT_IMAGE", ((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData);
  ...
  {
    aeiy localaeiy = this.jdField_a_of_type_Aeic.a();
    if ((localaeiy != null) && (AIOShortVideoData.class.isInstance(localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) && (((AIOShortVideoData)localaeiy.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_b_of_type_Int == 0) && (this.jdField_a_of_type_Agqv != null)) {
      this.jdField_a_of_type_Agqv.k();
    }
    AppNetConnInfo.unregisterNetInfoHandler(this);
    super.f();
    if (this.jdField_m_of_type_Int > 0) {
      axqy.b(null, "CliOper", "", "", "View_pic", "View_pic_spin", 0, 0, "" + this.jdField_m_of_type_Int, "", "", "");
    }
    aegp.a().b(this);
    if (this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter != null) {
      this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIOGalleryAdapter.c();
    }
    this.jdField_a_of_type_Axjs = null;
    if (this.jdField_a_of_type_Bbjq != null)
    {
  ...
  public boolean f()
  {
    if (akpx.a(this.jdField_g_of_type_Int) == 1032) {}
    label228:
    label229:
    for (;;)
    {
      return false;
      if ((this.jdField_g_of_type_Int != 1037) && (this.jdField_g_of_type_Int != 1044) && (!this.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_Aeic != null))
      {
        Object localObject = this.jdField_a_of_type_Aeic.a();
        if (AIOImageData.class.isInstance(((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
        {
          AIOImageData localAIOImageData = (AIOImageData)((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
        ...
        for (;;)
        {
          ...
          {
            return bool;
            if (AIOShortVideoData.class.isInstance(((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
            {
              localObject = ((AIOShortVideoData)((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).a(1);
            ...
            if (!AIOFileVideoData.class.isInstance(((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) {
              break;
            }
            localObject = (AIOFileVideoData)((aeiy)localObject).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
  ...
  public void l()
  {
    ...
    super.l();
    D();
    Object localObject1 = this.jdField_a_of_type_Aeic.a();
    if ((localObject1 == null) || (((aeiy)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData == null)) {}
    do
    {
      do
      {
        do
        {
          ...
          if ((!(((aeiy)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData)) || (((AIOShortVideoData)((aeiy)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_b_of_type_Int != 1)) {
            break;
          }
          localObject1 = a();
        ...
        return;
        if ((!(((aeiy)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData)) || (((AIOShortVideoData)((aeiy)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_b_of_type_Int != 0)) {
          break;
        }
      } while (this.jdField_a_of_type_Agqv == null);
      this.jdField_a_of_type_Agqv.h();
      return;
    } while ((!AIOFileVideoData.class.isInstance(((aeiy)localObject1).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) || (this.jdField_a_of_type_Agqv == null) || (!this.jdField_a_of_type_Agqv.c()));
    this.jdField_a_of_type_Agqv.h();
  }
  ...
  public void m()
  {
    ...
    aeiy localaeiy = this.jdField_a_of_type_Aeic.b();
    if (localaeiy != null) {
      localaeiy.jdField_b_of_type_Boolean = false;
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    {
      return;
      paramView = this.jdField_a_of_type_Aeic.a();
      if ((paramView != null) && (this.jdField_a_of_type_Aejb.asBinder().pingBinder()))
      {
        this.jdField_a_of_type_Aehr = new aehr(this);
        this.jdField_a_of_type_Aehr.jdField_a_of_type_Long = paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Long;
        this.jdField_a_of_type_Aehr.jdField_a_of_type_Int = paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData.jdField_f_of_type_Int;
        if (AIOImageData.class.isInstance(paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
        {
          paramView.jdField_a_of_type_Aeiz.jdField_c_of_type_Boolean = true;
          u();
          this.jdField_a_of_type_Aejb.a(this.jdField_a_of_type_Aehr.jdField_a_of_type_Long, this.jdField_a_of_type_Aehr.jdField_a_of_type_Int, 4);
          return;
        }
        if (AIOFilePicData.class.isInstance(paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
        {
          ...
          long l1 = apei.a();
          if ((paramView.jdField_a_of_type_Long > l1) && (apug.a())) {
            try
            {
              apug.a(false, this.jdField_a_of_type_AndroidAppActivity, new aegt(this));
              return;
            }
          ...
          a(true);
          this.jdField_a_of_type_Aejb.a(this.jdField_a_of_type_Aehr.jdField_a_of_type_Long, this.jdField_a_of_type_Aehr.jdField_a_of_type_Int, 20);
          this.jdField_a_of_type_ComTencentWidgetGallery.b(true);
          this.jdField_a_of_type_ComTencentWidgetGallery.a(true);
          return;
          ...
          return;
          x();
          axqy.b(null, "dc00898", "", "", "0X8009EFD", "0X8009EFD", a(), b(), "" + a("0X8009EFD"), "", "", "");
          return;
          C();
          axqy.b(null, "dc00898", "", "", "0X8009EFC", "0X8009EFC", a(), b(), "" + a("0X8009EFC"), "", "", "");
          return;
          paramView = this.jdField_a_of_type_Aeic.a();
          ...
          else if ((paramView != null) && (paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData != null) && ((paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOImageData)) && (((AIOImageData)paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_b_of_type_Int == 3) && (this.jdField_a_of_type_Aehr != null))
          {
            ...
            Object localObject;
            if ((this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData))
            {
              if (((AIOShortVideoData)this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData).jdField_b_of_type_Int == 0)
              {
                if (this.jdField_a_of_type_Agqv != null)
                {
                  this.jdField_a_of_type_Agqv.f();
                  if (this.jdField_a_of_type_Agqv.c()) {
                    paramView.setImageResource(2130845268);
                  }
                  for (;;)
                  {
                    this.jdField_a_of_type_MqqOsMqqHandler.postDelayed(this.jdField_b_of_type_JavaLangRunnable, 100L);
                    return;
                    paramView.setImageResource(2130845267);
                  }
                }
              }
              else
            ...
            else if (((this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOFileVideoData)) && (this.jdField_a_of_type_Agqv != null))
            {
              this.jdField_a_of_type_Agqv.f();
              if (this.jdField_a_of_type_Agqv.c()) {
                paramView.setImageResource(2130845268);
              ...
              paramView = this.jdField_a_of_type_Aeic.a();
              if (this.jdField_a_of_type_Agqv != null) {
                l1 = this.jdField_a_of_type_Agqv.a();
              }
              for (;;)
              {
                if ((paramView != null) && ((paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData)))
                {
                  ...
                  if (localObject != null)
                  {
                    this.jdField_a_of_type_Bcuq.a((agra)localObject, paramView.jdField_a_of_type_Long, l1);
                    this.jdField_a_of_type_Bcuq.a(paramView.jdField_a_of_type_JavaLangString, paramView.jdField_c_of_type_Int, paramView.jdField_d_of_type_Int);
                    bool1 = bool2;
                    if (paramView.jdField_c_of_type_Int > paramView.jdField_d_of_type_Int) {
                      bool1 = true;
                    }
                    if (!this.jdField_a_of_type_Bcuq.a(bool1, paramView.jdField_g_of_type_Int)) {
                      break;
                    }
                    e();
                    return;
                    ...
                    if (AIOShortVideoData.class.isInstance(paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
                    {
                      ...
                      {
                        if (this.jdField_a_of_type_Aejb != null) {
                          this.jdField_a_of_type_Aejb.b(paramView.jdField_f_of_type_Long, paramView.jdField_f_of_type_Int, 256);
                        }
                        u();
                        break label1084;
                      }
                      ...
                      this.jdField_a_of_type_Aehs.jdField_c_of_type_Boolean = false;
                      u();
                      break label1084;
                    }
                    if (AIOImageData.class.isInstance(paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData))
                    {
                      ...
                      if (paramView.jdField_a_of_type_Aeiz.jdField_c_of_type_Boolean)
                      {
                        if (this.jdField_a_of_type_Aejb != null) {
                          this.jdField_a_of_type_Aejb.b(this.jdField_a_of_type_Aehr.jdField_a_of_type_Long, this.jdField_a_of_type_Aehr.jdField_a_of_type_Int, 4);
                        }
                        paramView.jdField_a_of_type_Aeiz.jdField_c_of_type_Boolean = false;
                      }
                      for (;;)
                      {
                        u();
                        break;
                        if (this.jdField_a_of_type_Aejb != null) {
                          this.jdField_a_of_type_Aejb.b(((AIOImageData)localObject).jdField_f_of_type_Long, ((AIOImageData)localObject).jdField_f_of_type_Int, 24);
                        }
                        paramView.jdField_a_of_type_Aeiz.jdField_f_of_type_Boolean = true;
                      }
                    }
                    if (!AIOFilePicData.class.isInstance(paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) {
                      break label1084;
                    ...
                    paramView = (AIOFilePicData)paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
                    if (this.jdField_a_of_type_Aejb != null) {
                      this.jdField_a_of_type_Aejb.b(paramView.jdField_f_of_type_Long, paramView.jdField_f_of_type_Int, 24);
                    }
              ...
              if ((paramView != null) && ((paramView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOFileVideoData)))
              {
                ...
                if (vyf.c(paramView.jdField_c_of_type_JavaLangString))
                {
                  if (this.jdField_a_of_type_Bcuq != null) {
                    this.jdField_a_of_type_Bcuq.b();
                  }
                  this.jdField_a_of_type_Bcuq = new bcuq(this.jdField_a_of_type_AndroidAppActivity);
                  this.jdField_a_of_type_Bcuq.a(paramView.jdField_c_of_type_JavaLangString, paramView.jdField_f_of_type_Long, l1);
                  if (bbdx.b(paramView.jdField_b_of_type_JavaLangString)) {
                    this.jdField_a_of_type_Bcuq.a(paramView.jdField_b_of_type_JavaLangString, paramView.jdField_a_of_type_Int, paramView.jdField_b_of_type_Int);
                  }
                  if (paramView.jdField_a_of_type_Int > paramView.jdField_b_of_type_Int) {}
                  while (this.jdField_a_of_type_Bcuq.a(bool1, paramView.jdField_g_of_type_Int))
                  {
                    e();
                    return;
                    bool1 = false;
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if ((!AIOFileVideoData.class.isInstance(paramAdapterView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData)) || (this.jdField_a_of_type_Agqv == null)) {
          break label312;
        }
        if ((localMotionEvent == null) || (this.jdField_a_of_type_Agqv == null) || (!this.jdField_a_of_type_Agqv.a(localMotionEvent))) {
          break label314;
        }
        paramAdapterView = (AIOFileVideoData)paramAdapterView.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
        paramAdapterView.a(paramView, this.jdField_a_of_type_Agqv);
        ...
        e();
        continue;
        if ((this.jdField_a_of_type_Agqv != null) && (localMotionEvent != null) && (this.jdField_a_of_type_Agqv.a(localMotionEvent)))
        {
          if (!this.jdField_a_of_type_Aehs.jdField_b_of_type_Boolean) {
            this.jdField_a_of_type_Agqv.f();
          }
        }
        else {
  ...
  public void onNetMobile2Wifi(String paramString)
  {
    ...
    if (this.jdField_a_of_type_Agqv != null) {
      this.jdField_a_of_type_Agqv.d(1);
    }
    aejk.a().a();
  }
  ...
  public void onProgressChanged(SeekBar paramSeekBar, int paramInt, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      paramSeekBar = this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
    ...
    label67:
    label127:
    while ((!AIOFileVideoData.class.isInstance(paramSeekBar)) || (this.jdField_a_of_type_Agqv == null))
    {
      Object localObject;
      do
      {
  ...
  public void u()
  {
    if ((this.jdField_a_of_type_Aehs.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_Aehs.jdField_d_of_type_Boolean) || (this.jdField_a_of_type_Aehs.jdField_e_of_type_Boolean) || (this.jdField_a_of_type_Aehs.jdField_f_of_type_Boolean))
    {
      if (QLog.isColorLevel()) {
    ...
    if ((this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOShortVideoData))
    {
      ...
      {
        this.jdField_d_of_type_AndroidWidgetImageButton.setVisibility(8);
        localObject2 = (AIOShortVideoData)this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
        if (((AIOShortVideoData)localObject2).jdField_b_of_type_Int != 0) {
          break label683;
        }
        this.jdField_c_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
        i1 = this.jdField_a_of_type_Aejb.a(((AIOShortVideoData)localObject2).jdField_f_of_type_Long, ((AIOShortVideoData)localObject2).jdField_f_of_type_Int);
        this.jdField_a_of_type_Agqv.a(8, "");
        if (!((aeiy)localObject1).jdField_a_of_type_Aeiz.jdField_a_of_type_Boolean) {
          break label364;
        }
        if (QLog.isColorLevel()) {
          QLog.i("AIOGalleryScene", 2, "updateUI selectedItem.longVideoSaving");
        }
        ((aeiy)localObject1).jdField_a_of_type_Aeiz.jdField_a_of_type_Boolean = false;
        this.jdField_a_of_type_AndroidWidgetSeekBar.setProgress(0);
        this.jdField_b_of_type_AndroidWidgetTextView.setText(ajya.a(2131700067));
        this.jdField_d_of_type_AndroidWidgetImageButton.setVisibility(8);
        this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
      }
    ...
    {
      label1507:
      if ((this.jdField_k_of_type_Int == 4) || (akpx.a(this.jdField_g_of_type_Int) == 1032))
      {
        this.jdField_d_of_type_AndroidWidgetImageButton.setVisibility(8);
        return;
        ...
        else if (((aeiy)localObject1).jdField_a_of_type_Aeiz.jdField_d_of_type_Boolean)
        {
          if (QLog.isColorLevel()) {
        ...
        else if (!((aeiy)localObject1).jdField_a_of_type_Aeiz.jdField_g_of_type_Boolean)
        {
          if (QLog.isColorLevel()) {
            QLog.i("AIOGalleryScene", 2, "updateUI selectedItem.hasEnterPlaying longVideoDownloading=" + ((aeiy)localObject1).jdField_a_of_type_Aeiz.jdField_h_of_type_Boolean + " selectedItem.state=" + ((aeiy)localObject1).jdField_a_of_type_Aeiz + " longVideoGetUrl=" + ((aeiy)localObject1).jdField_a_of_type_Aeiz.jdField_j_of_type_Boolean);
          }
          this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
          this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
          if (((aeiy)localObject1).jdField_a_of_type_Aeiz.jdField_h_of_type_Boolean) {
            this.jdField_c_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
          }
          if (((aeiy)localObject1).jdField_a_of_type_Aeiz.jdField_j_of_type_Boolean) {
            this.jdField_c_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
          }
        }
        else if (((aeiy)localObject1).jdField_a_of_type_Aeiz.jdField_k_of_type_Boolean)
        {
          this.jdField_a_of_type_Agqv.a(0, ((AIOShortVideoData)localObject2).a());
          this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
          ((aeiy)localObject1).jdField_a_of_type_Aeiz.jdField_k_of_type_Boolean = false;
        }
        else
        {
          if (QLog.isColorLevel()) {
          ...
          if (((AIOShortVideoData)localObject2).jdField_b_of_type_Int == 1) {
            if (this.jdField_a_of_type_Aehs.jdField_c_of_type_Boolean)
            {
              this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
              this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
            }
            else if (!((aeiy)localObject1).jdField_a_of_type_Aeiz.jdField_g_of_type_Boolean)
            {
              this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
              this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
              if (((aeiy)localObject1).jdField_a_of_type_Aeiz.jdField_i_of_type_Boolean) {
                this.jdField_c_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
              }
            }
            else
            {
              ...
              this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(0);
              continue;
              if ((this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOImageData))
              {
                localObject1 = (AIOImageData)this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
                localObject2 = this.jdField_a_of_type_Aeic.a();
                this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
                this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
                this.jdField_c_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
                a(false);
                i1 = this.jdField_a_of_type_Aejb.a(((AIOImageData)localObject1).jdField_f_of_type_Long, ((AIOImageData)localObject1).jdField_f_of_type_Int);
                if (((aeiy)localObject2).jdField_a_of_type_Aeiz.jdField_c_of_type_Boolean)
                {
                  this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
                  this.jdField_d_of_type_AndroidWidgetImageButton.setVisibility(8);
                  this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(8);
                  this.jdField_a_of_type_AndroidWidgetSeekBar.setProgress(0);
                  this.jdField_b_of_type_AndroidWidgetTextView.setText(ajya.a(2131700043) + ((aeiy)localObject2).jdField_a_of_type_Aeiz.jdField_a_of_type_Int + "%");
                  this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                }
                for (;;)
                {
                  ...
                  this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(8);
                  this.jdField_a_of_type_AndroidWidgetSeekBar.setProgress(0);
                  this.jdField_b_of_type_AndroidWidgetTextView.setText(ajya.a(2131700074) + ((aeiy)localObject2).jdField_a_of_type_Aeiz.jdField_a_of_type_Int + "%");
                  this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                  if (this.jdField_a_of_type_Aehr != null) {
                    break label322;
                  }
                  this.jdField_a_of_type_Aehr = new aehr(this);
                  this.jdField_a_of_type_Aehr.jdField_a_of_type_Long = ((AIOImageData)localObject1).jdField_f_of_type_Long;
                  this.jdField_a_of_type_Aehr.jdField_a_of_type_Int = ((AIOImageData)localObject1).jdField_f_of_type_Int;
                  this.jdField_a_of_type_Aeic.a().jdField_a_of_type_Aeiz.jdField_c_of_type_Boolean = true;
                  ((AIOImageData)localObject1).jdField_f_of_type_Boolean = false;
                  break label322;
                  if (((aeiy)localObject2).jdField_a_of_type_Aeiz.jdField_e_of_type_Boolean)
                  {
                    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
                    this.jdField_d_of_type_AndroidWidgetImageButton.setVisibility(8);
                    this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(8);
                    this.jdField_a_of_type_AndroidWidgetSeekBar.setProgress(0);
                    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajya.a(2131700031));
                    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                    ((aeiy)localObject2).jdField_a_of_type_Aeiz.jdField_e_of_type_Boolean = false;
                  }
                  else if ((i1 != -1) && (!((aeiy)localObject2).jdField_a_of_type_Aeiz.jdField_f_of_type_Boolean))
                  {
                    this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
                    this.jdField_d_of_type_AndroidWidgetImageButton.setVisibility(8);
                    this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(8);
                    this.jdField_a_of_type_AndroidWidgetSeekBar.setProgress((int)(i1 / 100.0D * 10000.0D));
                    this.jdField_b_of_type_AndroidWidgetTextView.setText(ajya.a(2131700044) + i1 + "%");
                    this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(0);
                  }
                  else
                  {
              ...
              else if ((this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOFilePicData))
              {
                localObject1 = (AIOFilePicData)this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
                this.jdField_a_of_type_AndroidWidgetImageButton.setVisibility(0);
                if (((AIOFilePicData)localObject1).jdField_a_of_type_Long > 10485760)
                {
                  this.jdField_a_of_type_AndroidWidgetImageButton.setEnabled(false);
                  if (!apvd.b(((AIOFilePicData)localObject1).jdField_d_of_type_JavaLangString)) {
                    break label1615;
                  }
                  this.jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
                  label1526:
              ...
              else if ((this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData instanceof AIOFileVideoData))
              {
                localObject1 = (AIOFileVideoData)this.jdField_a_of_type_Aeic.a().jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData;
                this.jdField_a_of_type_Agqv.a(8, "");
                this.jdField_d_of_type_AndroidWidgetImageButton.setVisibility(8);
                a(true);
                ...
                {
                  this.jdField_a_of_type_Agqv.a(0, ((AIOFileVideoData)localObject1).a());
                  this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
                }
    ...
    for (;;)
    {
      label683:
      label1615:
      if (!this.jdField_a_of_type_Aeic.a().jdField_a_of_type_Aeiz.jdField_g_of_type_Boolean)
      {
        this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
        this.jdField_b_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
      }
  ...
  public void w()
  {
    if ((this.t) || (this.jdField_a_of_type_Boolean) || (this.jdField_b_of_type_Boolean)) {
      this.jdField_a_of_type_ComTencentWidgetGallery.setSelection(this.jdField_a_of_type_Aeic.b());
    }
  }
  ...
  protected void x()
  {
    ...
    localIntent.putExtra("uintype", this.jdField_g_of_type_Int);
    localIntent.putExtra("extra.IS_FROM_CHAT_AIO_GALLERY", true);
    localIntent.putExtra("extra.EXTRA_CURRENT_IMAGE", ((aeiy)this.jdField_a_of_type_Xpj.a()).jdField_a_of_type_ComTencentMobileqqActivityAioPhotoAIORichMediaData);
    localIntent.putExtra("leftViewText", this.jdField_a_of_type_AndroidAppActivity.getString(2131690832));
  ...
  public void y()
  {
    if ((this.jdField_a_of_type_ComTencentWidgetGallery == null) || (this.jdField_a_of_type_Aeic == null)) {}
    do
    {
      int i1;
      int i2;
      ...
      do
      {
        ...
        i3 = this.jdField_a_of_type_Aeic.b();
  ...
  public void z()
  {
    ...
    if (this.jdField_a_of_type_Aeic.c() == 0)
    {
      aunu.b(false);
      bcql.a(this.jdField_a_of_type_AndroidAppActivity, 2131693020, 0).a();
      this.jdField_a_of_type_AndroidAppActivity.finish();
    }
    for (;;)
    {
      ...
      int i1 = this.jdField_a_of_type_Aeic.b();
