  ...
  implements View.OnClickListener
{
  ...
  public bbie(Context paramContext)
  {
  ...
  private void b(String paramString)
  {
    ...
    aeub.a(this.jdField_a_of_type_AndroidContentContext, localIntent, paramString);
  }
  ...
  void a(View paramView)
  {
    if (paramView != null)
    {
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131368240));
      this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131363419));
      this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131371620));
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131365453));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131370527));
      this.jdField_a_of_type_ArrayOfAndroidWidgetTextView[0] = ((TextView)paramView.findViewById(2131364055));
      this.jdField_a_of_type_ArrayOfAndroidWidgetTextView[1] = ((TextView)paramView.findViewById(2131364056));
      this.jdField_a_of_type_ArrayOfAndroidWidgetTextView[2] = ((TextView)paramView.findViewById(2131364057));
      this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131363420);
      this.jdField_a_of_type_ArrayOfAndroidViewView[0] = paramView.findViewById(2131363601);
      this.jdField_a_of_type_ArrayOfAndroidViewView[1] = paramView.findViewById(2131363603);
      this.jdField_a_of_type_ArrayOfAndroidViewView[2] = paramView.findViewById(2131363602);
      this.jdField_b_of_type_AndroidViewView = paramView.findViewById(2131364058);
      if ((this.jdField_a_of_type_AndroidWidgetImageView instanceof ThemeImageView)) {
        ((ThemeImageView)this.jdField_a_of_type_AndroidWidgetImageView).setMaskShape(bjuk.jdField_c_of_type_Int);
      }
      if ((this.jdField_b_of_type_AndroidWidgetImageView instanceof ThemeImageView)) {
        ((ThemeImageView)this.jdField_b_of_type_AndroidWidgetImageView).setMaskShape(bjuk.jdField_c_of_type_Int);
      }
      this.jdField_b_of_type_AndroidWidgetImageView.getViewTreeObserver().addOnGlobalLayoutListener(new bbif(this));
      paramView.setOnClickListener(new bbig(this));
    }
  }
  ...
  void b()
  {
    ...
    if (this.jdField_b_of_type_JavaLangString != null)
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidViewView[i].setBackgroundColor(this.jdField_a_of_type_AndroidContentContext.getResources().getColor(2131166947));
    }
    for (;;)
    {
      i += 1;
    ...
    label363:
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(new bbih(this));
  }
  ...
  public void onClick(View paramView)
  {
    ...
    default: 
      ...
      {
        bbda.a(null, this.jdField_c_of_type_Int, 0, "0X8009D2D", this.jdField_b_of_type_Int, i, this.g);
        label81:
        if (str != null)
        {
          if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      i = 3;
      break;
      bbda.a(null, this.jdField_c_of_type_Int, 0, "0X8009D41", this.jdField_b_of_type_Int, i, this.g);
      break label81;
      label210:
      bfvp localbfvp = bfwg.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.jdField_a_of_type_AndroidContentContext, str);
      if (localbfvp != null)
      {
        localbfvp.a();
      }
