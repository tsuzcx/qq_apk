...
public abstract class aark
{
  ...
  public static aark a(String paramString, JSONObject paramJSONObject)
  {
    if ("dex".equals(paramString))
    {
      ...
      do
      {
        ...
        if (PatchCommonUtil.isDalvik()) {
          return new aarn(paramJSONObject);
        }
        if (PatchCommonUtil.isArtLM()) {
          return new aarm(paramJSONObject);
        }
      } while (!PatchCommonUtil.isArtGeN());
      return new aarl(paramJSONObject);
    }
    if ("Native".equals(paramString)) {
      return new aaro(paramJSONObject);
    }
