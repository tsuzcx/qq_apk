  ...
  implements Serializable
{
  ...
  public static tail_opmask convert(int paramInt)
  {
    ...
    for (;;)
    {
      tail_opmask[] arrayOftail_opmask = __values;
      if (i >= arrayOftail_opmask.length) {
        break;
      }
      if (arrayOftail_opmask[i].value() == paramInt) {
        return __values[i];
      }
      i += 1;
    }
  ...
  public static tail_opmask convert(String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (arrayOftail_opmask[i].toString().equals(paramString)) {
        return __values[i];
      }
      i += 1;
    }
