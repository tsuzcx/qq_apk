  ...
  implements BusinessObserver
{
  ...
  private final ConcurrentHashMap<Integer, ConcurrentHashMap<Integer, zxa>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  ...
  private void a(int paramInt, Bundle paramBundle, boolean paramBoolean)
  {
    ...
    {
      vrh.a(601, localVSBaseRequest.getCmdName(), localVSBaseRequest.getTraceId(), l1, 100004);
    ...
    paramBundle = (zxa)((ConcurrentHashMap)localObject2).remove(Integer.valueOf(localVSBaseRequest.getCurrentSeq()));
    if (paramBundle == null)
    {
      vrh.a(601, localVSBaseRequest.getCmdName(), localVSBaseRequest.getTraceId(), l1, 100004);
    ...
    if (localObject1 != null)
    {
      ...
      try
      {
        localObject2 = localVSBaseRequest.parseResponseWrapper(bguc.b(((FromServiceMsg)localObject1).getWupBuffer()));
        ...
        {
          vrh.a(601, localVSBaseRequest.getCmdName(), localVSBaseRequest.getTraceId(), l1, 100003);
      ...
      {
        vrh.a(601, localVSBaseRequest.getCmdName(), localVSBaseRequest.getTraceId(), l1, 100001);
        a().post(new VSDispatchObserver.4(this, localVSBaseRequest, paramBundle, l2, localException));
        return;
      }
      vrh.a(601, localVSBaseRequest.getCmdName(), localVSBaseRequest.getTraceId(), l1, (int)l3);
    ...
    vrh.a(601, localVSBaseRequest.getCmdName(), localVSBaseRequest.getTraceId(), l1, 100002);
    a().post(new VSDispatchObserver.5(this, localVSBaseRequest, paramBundle, l2));
  }
  
  private void a(VSBaseRequest paramVSBaseRequest, zxa paramzxa, long paramLong, String paramString, boolean paramBoolean, MessageMicro paramMessageMicro)
  {
    if (((!paramBoolean) || (paramLong != 0L)) && (paramVSBaseRequest.isNeedRetry(paramLong)) && (paramVSBaseRequest.getRetryCount() > 0))
    {
      ...
      VSNetworkHelper.a().a(paramVSBaseRequest, paramzxa);
    ...
    paramzxa.onReceive(paramBoolean, paramLong, paramString, paramMessageMicro);
  }
  
  private void a(VSBaseRequest paramVSBaseRequest, byte[] paramArrayOfByte)
  {
    if (bgsp.a(paramVSBaseRequest.getRequestKey()))
    {
      yqp.d("VSNetworkHelper| Protocol Cache", "requestKey is empty");
      return;
    }
  ...
  public void a(VSBaseRequest paramVSBaseRequest, zxa paramzxa)
  {
    ...
    try
    {
      localConcurrentHashMap1.put(Integer.valueOf(paramVSBaseRequest.getNewSeq()), paramzxa);
      return;
    }
