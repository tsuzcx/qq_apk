  ...
  extends BaseAdapter
{
  ...
  public ArrayList<mwt> a;
  public boolean a;
  public int b;
  public boolean b;
  
  public mwu(PoiMapActivity paramPoiMapActivity)
  {
    this.jdField_a_of_type_Int = -1;
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  }
  
  public mwt a(int paramInt)
  {
    int i = paramInt;
    ...
    return (mwt)this.jdField_a_of_type_JavaUtilArrayList.get(i);
  }
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPoiMapActivity.l = localmwt.a;
    this.jdField_a_of_type_ComTencentBizPoiMapActivity.m = localmwt.jdField_b_of_type_JavaLangString;
    PoiMapActivity.a(this.jdField_a_of_type_ComTencentBizPoiMapActivity, localmwt.f);
    this.jdField_a_of_type_ComTencentBizPoiMapActivity.jdField_b_of_type_JavaLangString = localmwt.jdField_c_of_type_JavaLangString;
    this.jdField_a_of_type_ComTencentBizPoiMapActivity.j = localmwt.jdField_b_of_type_Int;
    this.jdField_a_of_type_ComTencentBizPoiMapActivity.k = localmwt.jdField_c_of_type_Int;
    com.tencent.mobileqq.widget.QQMapView.jdField_b_of_type_Boolean = true;
    PoiMapActivity.a(this.jdField_a_of_type_ComTencentBizPoiMapActivity).animateCamera(CameraUpdateFactory.newLatLng(new LatLng(localmwt.jdField_b_of_type_Int / 1000000.0D, localmwt.jdField_c_of_type_Int / 1000000.0D)));
  }
  ...
  public void a(ArrayList<mwt> paramArrayList, boolean paramBoolean, int paramInt)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131376003));
      ...
      paramViewGroup.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131375799);
      paramViewGroup.jdField_d_of_type_AndroidViewView = paramView.findViewById(2131370421);
      paramViewGroup.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131365065);
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131376002));
      paramViewGroup.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131377940));
      paramViewGroup.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131373472));
    ...
    paramViewGroup.jdField_a_of_type_AndroidWidgetTextView.setText(((mwt)localObject).a);
    paramViewGroup.jdField_b_of_type_AndroidWidgetTextView.setText(((mwt)localObject).jdField_b_of_type_JavaLangString);
    localObject = ((mwt)localObject).a + ((mwt)localObject).jdField_b_of_type_JavaLangString;
    ...
    for (paramViewGroup = (String)localObject + this.jdField_a_of_type_ComTencentBizPoiMapActivity.getString(2131695230);; paramViewGroup = (String)localObject + this.jdField_a_of_type_ComTencentBizPoiMapActivity.getString(2131695231))
    {
