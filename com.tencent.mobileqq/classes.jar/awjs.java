...
public class awjs
{
  public static List<ChatMessage> a(List<ChatMessage> paramList)
  {
    ...
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if ((!adak.k(localChatMessage.msgtype)) && (!aggr.a(localChatMessage))) {
  ...
  {
    axpf.a().jdField_a_of_type_Int = 7;
    ...
    do
    {
      ...
      if (paramIntent.size() > 0)
      {
        ...
        while (paramQQAppInterface.hasNext())
        {
          ...
          axpf.a().jdField_a_of_type_JavaUtilHashMap.put(localObject1, Boolean.valueOf(true));
        }
      }
