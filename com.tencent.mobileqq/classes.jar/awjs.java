  ...
  implements View.OnClickListener
{
  ...
  public awjs(Context paramContext)
  {
  ...
  private void a(ArrayList<String> paramArrayList)
  {
    if (QLog.isColorLevel())
    {
      ...
      QLog.d("HeadSetViewModule", 2, new Object[] { "refreshHeadSet: invoked. ", " uins: ", str1, " headAdapter.count: ", Integer.valueOf(this.jdField_a_of_type_Awnf.getCount()) });
    }
    if (this.jdField_a_of_type_Awnf == null) {
      return;
    }
  ...
  private void b(ArrayList<String> paramArrayList)
  {
    if (paramArrayList.size() == 1) {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityPublicFragmentActivity.getResources().getString(2131693683));
    }
    for (;;)
    {
      awmp.a(this.jdField_a_of_type_AndroidWidgetTextView, "" + this.jdField_a_of_type_AndroidWidgetTextView.getText());
      return;
      paramArrayList = paramArrayList.size() + this.jdField_a_of_type_ComTencentMobileqqActivityPublicFragmentActivity.getString(2131693703);
  ...
  private void c()
  {
    ...
    if (awnx.a(this.jdField_a_of_type_ComTencentMobileqqActivityPublicFragmentActivity.app).a(this.jdField_a_of_type_ComTencentMobileqqActivityPublicFragmentActivity, this.jdField_a_of_type_Awit)) {
      this.jdField_a_of_type_ComTencentMobileqqActivityPublicFragmentActivity.finish();
    }
    bdla.b(null, "CliOper", "", "", "0X800A76F", "0X800A76F", 0, 0, "", "0", "0", "");
  }
  ...
  private void d()
  {
    ...
    bkzi localbkzi = bkzi.a(this.jdField_a_of_type_ComTencentMobileqqActivityPublicFragmentActivity);
    localbkzi.a(2131691905, 3);
    localbkzi.a(2131694251);
    localbkzi.c(2131690697);
    localbkzi.a(new awjt(this, localbkzi));
    localbkzi.show();
    bdla.b(null, "CliOper", "", "", "0X800A76D", "0X800A76D", 0, 0, "", "0", "0", "");
  }
  ...
  {
    this.jdField_a_of_type_Awnf = paramawnf;
  }
  
  void a(List<awir> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    paramList = paramList.iterator();
    while (paramList.hasNext()) {
      localArrayList.add(String.valueOf(((awir)paramList.next()).a()));
    }
    a(localArrayList);
  }
