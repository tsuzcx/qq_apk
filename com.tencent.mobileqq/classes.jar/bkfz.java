  ...
  extends MSFServlet
{
  public static void a(long paramLong, int paramInt1, String paramString, int paramInt2, qq_ad_get.QQAdGet.DeviceInfo paramDeviceInfo)
  {
    try
    {
      ...
      paramDeviceInfo = new NewIntent(paramString.getApplication(), bkfz.class);
      paramDeviceInfo.putExtra("data", bdpd.a(localVacAdvReq.toByteArray()));
  ...
  public static void a(long paramLong, String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4, qq_ad_get.QQAdGet.DeviceInfo paramDeviceInfo)
  {
    try
    {
      ...
      paramString = new NewIntent(localAppRuntime.getApplication(), bkfz.class);
      paramString.putExtra("data", bdpd.a(localMobileAdvReportReq.toByteArray()));
  ...
  public void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    try
    {
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        {
          bkfw.a().a(i, paramFromServiceMsg);
          return;
        }
  ...
  public void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    try
    {
      if (paramFromServiceMsg.isSuccess())
      {
        ...
        bdqa.a(new byte[i], 0, paramFromServiceMsg.getWupBuffer(), 4, i);
      }
      return;
    }
    catch (Exception paramIntent)
