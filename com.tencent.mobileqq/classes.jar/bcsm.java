  ...
  implements bcsk
{
        ...
        try
        {
          ...
          if (str2 == null)
          {
            ...
            if (paramPtt.bytes_pb_reserve.has())
            {
              ...
              ((RichMsg.PttRec)localObject1).voiceLength.set(bhbx.a(l1));
              ...
              paramMessageHandler = bcsa.a(-2002);
              ...
              alcm.b((String)localObject2, paramMessageHandler);
  ...
  private void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, MessageRecord paramMessageRecord, List<im_msg_body.Elem> paramList)
  {
    ...
    boolean bool = ((bgls)paramMessageHandler.app.getManager(QQManagerFactory.TROOP_ROBOT_MANAGER)).a(((msg_comm.MsgHead)paramMsg.msg_head.get()).from_uin.get());
  ...
  private void a(MessageRecord paramMessageRecord, im_msg_body.Elem paramElem)
  {
    ...
    try
    {
      ...
      if (((generalflags.ResvAttr)localObject).uint32_holiday_flag.has())
      {
        ...
        if (i == 1) {
          paramMessageRecord.saveExtInfoToExtStr(bcrn.c, String.valueOf(i));
        }
        if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      ((MessageForPtt)paramMessageRecord).waveformArray = bhfx.a(paramElem);
      if (QLog.isColorLevel())
      {
  ...
  {
    parambcre = (im_msg_body.Ptt)((im_msg_body.RichText)((im_msg_body.MsgBody)paramMsg.msg_body.get()).rich_text.get()).ptt.get();
    Object localObject = parambcre.bytes_file_name.get().toStringUtf8();
    if (((String)localObject).endsWith(".amr")) {}
    for (paramList = a(paramMessageHandler, paramMsg, paramList, parambcre, (String)localObject, "");; paramList = null)
    {
      if (paramList == null) {}
      do
      {
        ...
        {
          return;
          parambcre = ((im_msg_body.RichText)((im_msg_body.MsgBody)paramMsg.msg_body.get()).rich_text.get()).elems.get();
        ...
        return;
        if (QLog.isColorLevel()) {
          ((StringBuilder)localObject).append("elemsSize").append(parambcre.size()).append("\n");
        }
        a(paramMsg, paramList, parambcre, (StringBuilder)localObject);
        a(paramMessageHandler, paramMsg, paramList, parambcre);
        aqvh.a(paramMsg, paramList, paramMessageHandler.app);
      } while (!QLog.isColorLevel());
      QLog.d("GrpDisPTTDecoder", 2, ((StringBuilder)localObject).toString());
      return;
    }
