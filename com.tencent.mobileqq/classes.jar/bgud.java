  ...
  extends RemoteCommand
{
  ...
  private void a(QQAppInterface paramQQAppInterface, Activity paramActivity, FileManagerEntity paramFileManagerEntity)
  {
    ...
    {
      aptt.a(paramActivity, 2131692673, 2131692678, new bgue(this, paramActivity, paramFileManagerEntity));
      return;
    }
  ...
  private void a(String paramString)
  {
    ...
    try
    {
      ...
      if (i > 0)
      {
        ...
        {
          a(localQQAppInterface, localActivity, apug.a(new FileInfo(paramString)));
          return;
        }
        bgwf.a("QRRemoteCommond", "No Activity to use to forward file");
        return;
      }
    }
    catch (FileNotFoundException paramString)
    {
      bgwf.a("QRRemoteCommond", "file not found", paramString);
    }
  }
  ...
  public Bundle invoke(Bundle paramBundle, RemoteCommand.OnInvokeFinishLinstener paramOnInvokeFinishLinstener)
  {
    ...
    Object localObject1 = (akdh)a().getManager(56);
    ...
    for (paramBundle = paramBundle.getString("uin"); localObject1 != null; paramBundle = null)
    {
      for (;;)
      {
        if (((akdh)localObject1).b(paramBundle) != null) {
        ...
        ((Bundle)localObject2).putInt("qq_vip_level", bguf.a(a(), null));
        return localObject2;
        ((Bundle)localObject2).putShort("qq_vip_info", bguf.a(a(), null));
        return localObject2;
        if (a() == null) {
          break;
        }
        paramBundle = paramBundle.getString("publicaccount_uin");
        ((Bundle)localObject2).putBoolean("publicaccount_is_follow", sgg.a(a(), paramBundle));
        return localObject2;
        if (a() == null) {
          break;
        }
        localObject1 = paramBundle.getString("publicaccount_uin");
        Object localObject3 = (akdh)a().getManager(56);
        paramBundle = paramOnInvokeFinishLinstener;
        if (localObject3 != null) {
          paramBundle = ((akdh)localObject3).b((String)localObject1);
        }
        if (paramBundle != null)
        {
        ...
        case 2: 
          for (;;)
          {
            ...
            bgzl.a(a(), a().getApplication().getApplicationContext(), paramBundle, null);
            continue;
        ...
        if (paramOnInvokeFinishLinstener != null)
        {
          paramOnInvokeFinishLinstener = (avps)paramOnInvokeFinishLinstener.getManager(36);
          if (paramOnInvokeFinishLinstener != null)
          {
            paramBundle = paramOnInvokeFinishLinstener.a(paramBundle.getString("path"));
            if (paramBundle != null) {
              ((Bundle)localObject2).putParcelable("redTouchInfo", avpv.a(paramBundle));
            }
          }
        }
        for (;;)
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (localObject2 != null) {
          paramBundle.add(avpv.a((BusinessInfoCheckUpdate.AppInfo)localObject2));
        }
      }
