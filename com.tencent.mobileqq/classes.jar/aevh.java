...
public class aevh
  implements mwh
{
  public aevh(ScoreQAVFragment paramScoreQAVFragment) {}
  ...
  public void a(Object paramObject, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        if (msw.a("qav_score_bad.jpg")) {
          this.a.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(new BitmapDrawable(this.a.getResources(), msw.b() + "qav_score_bad.jpg"));
        }
        ScoreQAVFragment.a(this.a).setVisibility(0);
        this.a.jdField_a_of_type_AndroidWidgetTextView.setVisibility(0);
        this.a.b.setText(2131695590);
      ...
      if (paramInt > 3)
      {
        ...
        try
        {
          if (msw.a("qav_score_good.jpg")) {
            this.a.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(new BitmapDrawable(this.a.getResources(), msw.b() + "qav_score_good.jpg"));
          }
