...
public class oaf
{
  public static JSONObject a(JSONObject paramJSONObject, AdData paramAdData)
  {
    try
    {
      if (paramAdData.jdField_a_of_type_Nxz == null) {
      ...
      {
        Object localObject3 = sfd.a((String)paramAdData.jdField_a_of_type_JavaUtilArrayList.get(0), 4);
        Object localObject2 = sfd.a((String)paramAdData.jdField_a_of_type_JavaUtilArrayList.get(1), 4);
        localObject1 = sfd.a((String)paramAdData.jdField_a_of_type_JavaUtilArrayList.get(2), 4);
