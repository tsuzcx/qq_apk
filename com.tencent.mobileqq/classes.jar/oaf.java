...
public class oaf
{
  ...
  public static oidb_0x6cf.PhoneInfo a()
  {
    ...
    Object localObject2 = yyp.a(BaseApplication.getContext(), (yyq)localObject1);
    if (localObject2 != null) {}
    for (localObject1 = ((yyr)localObject2).a;; localObject1 = null)
    {
      if ((localObject2 != null) && (((yyr)localObject2).a != null) && (((yyr)localObject2).a.muid != null) && (((yyr)localObject2).a.muid_type != null))
      {
        localPhoneInfo.bytes_muid.set(ByteStringMicro.copyFromUtf8(((yyr)localObject2).a.muid.get()));
        localPhoneInfo.uint32_muid_type.set(((yyr)localObject2).a.muid_type.get());
      }
      localObject2 = b();
      ...
      localPhoneInfo.bytes_ads_context.set(ByteStringMicro.copyFromUtf8(nmc.a()));
