...
public class axhz
  extends axeu
{
  public axhz(ChooseInterestTagActivity paramChooseInterestTagActivity) {}
  ...
  public void a(boolean paramBoolean, int paramInt1, int paramInt2, List<InterestTagInfo> paramList1, List<InterestTagInfo> paramList2, String paramString1, int paramInt3, int paramInt4, String paramString2)
  {
    ...
    do
    {
      do
      {
        ...
        if (ChooseInterestTagActivity.a(this.a).getVisibility() == 0)
        {
          ChooseInterestTagActivity.a(this.a).setText(anni.a(2131700618));
          ChooseInterestTagActivity.a(this.a).setOnClickListener(null);
          return;
        }
      } while (ChooseInterestTagActivity.b(this.a).getVisibility() != 0);
      ChooseInterestTagActivity.b(this.a).setText(anni.a(2131700582));
      ChooseInterestTagActivity.c(this.a).setVisibility(8);
      return;
      if ((paramList1 == null) || (paramList1.isEmpty()))
      {
        if (ChooseInterestTagActivity.a(this.a).getVisibility() == 0)
        {
          ChooseInterestTagActivity.a(this.a).setText(anni.a(2131700596));
          ChooseInterestTagActivity.a(this.a).setOnClickListener(null);
          return;
        }
        if (ChooseInterestTagActivity.b(this.a).getVisibility() == 0)
        {
          ChooseInterestTagActivity.b(this.a).setText(anni.a(2131700604));
    ...
    if (paramInt3 == 0)
    {
      ...
      ChooseInterestTagActivity.a(this.a, new axie(this.a, ChooseInterestTagActivity.a(this.a), ChooseInterestTagActivity.b(this.a), ChooseInterestTagActivity.a(this.a)));
      ChooseInterestTagActivity.a(this.a).setAdapter(ChooseInterestTagActivity.a(this.a));
      label765:
  ...
  public void a(boolean paramBoolean, String paramString1, List<axid> paramList, String paramString2, int paramInt1, int paramInt2)
  {
    if (!paramBoolean)
    {
      if (TextUtils.isEmpty(paramString2))
      {
        ChooseInterestTagActivity.a(this.a, 2, anni.a(2131700608), 500);
        return;
      }
      ChooseInterestTagActivity.a(this.a, 0, anni.a(2131700581) + paramString2, 500);
      return;
    }
    if ((paramInt2 == 1) && (!TextUtils.isEmpty(paramString1)))
    {
      ...
      paramList.putExtra("selfSet_leftViewText", anni.a(2131700597));
      paramList.putExtra("title", anni.a(2131700619));
    ...
    ChooseInterestTagActivity.a(this.a, 1, anni.a(2131700598), 500);
  }
}
