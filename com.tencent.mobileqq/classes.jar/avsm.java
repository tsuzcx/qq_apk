  ...
  implements Handler.Callback, Manager
{
  ...
  private ConcurrentHashMap<Integer, avst> b = new ConcurrentHashMap();
  ...
  public avsm(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Avsu = new avsl(paramQQAppInterface, this);
    d();
  }
  ...
  private void a(RedTouchItem paramRedTouchItem, int paramInt)
  {
    ...
    if (localRedTouchItem == null)
    {
      ...
      avsv.a(localRedTouchItem, paramRedTouchItem);
    ...
    do
    {
      ...
      j = avsv.a(localRedTouchItem.redtouchType);
      k = avsv.a(paramRedTouchItem.redtouchType);
      if (k > j)
      {
        localRedTouchItem = new RedTouchItem();
        avsv.a(localRedTouchItem, paramRedTouchItem);
  ...
  private void a(RedTouchItem paramRedTouchItem, boolean paramBoolean)
  {
    ...
    {
      this.jdField_a_of_type_Avsu.a(paramRedTouchItem, localRedPointConfig1.redPointId);
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_Avst.jdField_a_of_type_Int = -1;
    this.b.put(Integer.valueOf(this.jdField_a_of_type_Avst.jdField_a_of_type_Int), this.jdField_a_of_type_Avst);
    avst localavst1 = new avst();
    localavst1.jdField_a_of_type_Int = 10018;
    localavst1.jdField_a_of_type_Avst = this.jdField_a_of_type_Avst;
    this.b.put(Integer.valueOf(localavst1.jdField_a_of_type_Int), localavst1);
    localavst1 = new avst();
    localavst1.jdField_a_of_type_Int = -3;
    localavst1.jdField_a_of_type_Avst = this.jdField_a_of_type_Avst;
    this.b.put(Integer.valueOf(localavst1.jdField_a_of_type_Int), localavst1);
    localavst1.jdField_a_of_type_JavaUtilList = new ArrayList();
    Object localObject1 = new avst();
    ((avst)localObject1).jdField_a_of_type_Int = -7;
    this.b.put(Integer.valueOf(((avst)localObject1).jdField_a_of_type_Int), localObject1);
    ((avst)localObject1).jdField_a_of_type_Avst = localavst1;
    localavst1.jdField_a_of_type_JavaUtilList.add(localObject1);
    ((avst)localObject1).jdField_a_of_type_JavaUtilList = new ArrayList();
    avst localavst2 = new avst();
    localavst2.jdField_a_of_type_Int = -4;
    this.b.put(Integer.valueOf(localavst2.jdField_a_of_type_Int), localavst2);
    localavst2.jdField_a_of_type_Avst = localavst1;
    localavst1.jdField_a_of_type_JavaUtilList.add(localavst2);
    localavst2.jdField_a_of_type_JavaUtilList = new ArrayList();
    Object localObject2 = new avst();
    ((avst)localObject2).jdField_a_of_type_Int = 10015;
    this.b.put(Integer.valueOf(((avst)localObject2).jdField_a_of_type_Int), localObject2);
    ((avst)localObject2).jdField_a_of_type_Avst = ((avst)localObject1);
    ((avst)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    localObject2 = new avst();
    ((avst)localObject2).jdField_a_of_type_Int = 10016;
    this.b.put(Integer.valueOf(((avst)localObject2).jdField_a_of_type_Int), localObject2);
    ((avst)localObject2).jdField_a_of_type_Avst = ((avst)localObject1);
    ((avst)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    localObject2 = new avst();
    ((avst)localObject2).jdField_a_of_type_Int = 100601;
    ((avst)localObject2).jdField_a_of_type_Avst = ((avst)localObject1);
    ((avst)localObject1).jdField_a_of_type_JavaUtilList.add(localObject2);
    this.b.put(Integer.valueOf(100601), localObject2);
    localObject1 = new avst();
    ((avst)localObject1).jdField_a_of_type_Int = 10019;
    this.b.put(Integer.valueOf(((avst)localObject1).jdField_a_of_type_Int), localObject1);
    ((avst)localObject1).jdField_a_of_type_Avst = localavst2;
    localavst2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new avst();
    ((avst)localObject1).jdField_a_of_type_Int = 10020;
    this.b.put(Integer.valueOf(((avst)localObject1).jdField_a_of_type_Int), localObject1);
    ((avst)localObject1).jdField_a_of_type_Avst = localavst2;
    localavst2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new avst();
    ((avst)localObject1).jdField_a_of_type_Int = 10022;
    this.b.put(Integer.valueOf(((avst)localObject1).jdField_a_of_type_Int), localObject1);
    ((avst)localObject1).jdField_a_of_type_Avst = localavst2;
    localavst2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new avst();
    ((avst)localObject1).jdField_a_of_type_Int = 10021;
    this.b.put(Integer.valueOf(((avst)localObject1).jdField_a_of_type_Int), localObject1);
    ((avst)localObject1).jdField_a_of_type_Avst = localavst2;
    localavst2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new avst();
    ((avst)localObject1).jdField_a_of_type_Int = 10023;
    ((avst)localObject1).jdField_a_of_type_Avst = localavst2;
    this.b.put(Integer.valueOf(((avst)localObject1).jdField_a_of_type_Int), localObject1);
    localavst2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new avst();
    ((avst)localObject1).jdField_a_of_type_Int = 10024;
    ((avst)localObject1).jdField_a_of_type_Avst = localavst2;
    this.b.put(Integer.valueOf(((avst)localObject1).jdField_a_of_type_Int), localObject1);
    localavst2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new avst();
    ((avst)localObject1).jdField_a_of_type_Int = 10025;
    ((avst)localObject1).jdField_a_of_type_Avst = localavst2;
    this.b.put(Integer.valueOf(((avst)localObject1).jdField_a_of_type_Int), localObject1);
    localavst2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localObject1 = new avst();
    ((avst)localObject1).jdField_a_of_type_Int = 10026;
    ((avst)localObject1).jdField_a_of_type_Avst = localavst2;
    this.b.put(Integer.valueOf(((avst)localObject1).jdField_a_of_type_Int), localObject1);
    localavst2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localavst2 = new avst();
    localavst2.jdField_a_of_type_Int = -2;
    localavst2.jdField_a_of_type_Avst = this.jdField_a_of_type_Avst;
    this.b.put(Integer.valueOf(localavst2.jdField_a_of_type_Int), localavst2);
    this.jdField_a_of_type_Avst.jdField_a_of_type_JavaUtilList = Arrays.asList(new avst[] { localavst1, localavst2 });
    localavst2.jdField_a_of_type_JavaUtilList = new ArrayList();
    localObject1 = new avst();
    ((avst)localObject1).jdField_a_of_type_Int = 100510;
    this.b.put(Integer.valueOf(((avst)localObject1).jdField_a_of_type_Int), localObject1);
    ((avst)localObject1).jdField_a_of_type_Avst = localavst2;
    localavst2.jdField_a_of_type_JavaUtilList.add(localObject1);
    localavst1 = new avst();
    localavst1.jdField_a_of_type_Int = 10011;
    localavst1.jdField_a_of_type_Avst = ((avst)localObject1);
    this.b.put(Integer.valueOf(localavst1.jdField_a_of_type_Int), localavst1);
    localObject2 = new ArrayList();
    ((List)localObject2).add(localavst1);
    ((avst)localObject1).jdField_a_of_type_JavaUtilList = ((List)localObject2);
    localObject1 = new ArrayList();
    localObject2 = new avst();
    ((avst)localObject2).jdField_a_of_type_Int = 100523;
    ((avst)localObject2).jdField_a_of_type_Avst = localavst1;
    this.b.put(Integer.valueOf(((avst)localObject2).jdField_a_of_type_Int), localObject2);
    ((List)localObject1).add(localObject2);
    localObject2 = new avst();
    ((avst)localObject2).jdField_a_of_type_Int = 100517;
    ((avst)localObject2).jdField_a_of_type_Avst = localavst1;
    this.b.put(Integer.valueOf(((avst)localObject2).jdField_a_of_type_Int), localObject2);
    ((List)localObject1).add(localObject2);
    localavst1.jdField_a_of_type_JavaUtilList = ((List)localObject1);
    localavst1 = new avst();
    localavst1.jdField_a_of_type_Int = -5;
    localavst1.jdField_a_of_type_Avst = localavst2;
    localavst2.jdField_a_of_type_JavaUtilList.add(localavst1);
    localavst1.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.b.put(Integer.valueOf(localavst1.jdField_a_of_type_Int), localavst1);
    localavst1 = new avst();
    localavst1.jdField_a_of_type_Int = -6;
    localavst1.jdField_a_of_type_Avst = localavst2;
    localavst2.jdField_a_of_type_JavaUtilList.add(localavst1);
    localavst1.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.b.put(Integer.valueOf(localavst1.jdField_a_of_type_Int), localavst1);
    localObject1 = new avst();
    ((avst)localObject1).jdField_a_of_type_Int = 10014;
    ((avst)localObject1).jdField_a_of_type_Avst = localavst1;
    localavst1.jdField_a_of_type_JavaUtilList.add(localObject1);
    this.b.put(Integer.valueOf(((avst)localObject1).jdField_a_of_type_Int), localObject1);
    localavst1 = new avst();
    localavst1.jdField_a_of_type_Int = 10013;
    localavst1.jdField_a_of_type_Avst = localavst2;
    localavst2.jdField_a_of_type_JavaUtilList.add(localavst1);
    this.b.put(Integer.valueOf(localavst1.jdField_a_of_type_Int), localavst1);
  }
  ...
  private void e()
  {
    ...
    a();
    ??? = (ConcurrentHashMap)bdhb.a("red_point_configs_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
    if (??? != null)
    {
    ...
    try
    {
      ??? = (ConcurrentHashMap)bdhb.a("red_point_info_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      if (??? != null)
      {
        this.c.clear();
        this.c.putAll((Map)???);
  ...
  private void e(int paramInt)
  {
    ...
    if ((localRedTouchItem1 != null) && (localRedTouchItem1.passThroughLevel > 0))
    {
      ...
      {
        avst localavst = (avst)this.b.get(Integer.valueOf(i));
        if ((localavst == null) || (localavst.jdField_a_of_type_Avst == null)) {
          break;
        }
        RedTouchItem localRedTouchItem2 = (RedTouchItem)this.c.get(Integer.valueOf(localavst.jdField_a_of_type_Avst.jdField_a_of_type_Int));
        if (localRedTouchItem2 != null) {
          localRedTouchItem2.unReadFlag = false;
        }
        if (localavst.jdField_a_of_type_Avst.jdField_a_of_type_JavaUtilList != null)
        {
          i = 0;
          while (i < localavst.jdField_a_of_type_Avst.jdField_a_of_type_JavaUtilList.size())
          {
            j = ((avst)localavst.jdField_a_of_type_Avst.jdField_a_of_type_JavaUtilList.get(i)).jdField_a_of_type_Int;
            ...
            if ((localRedTouchItem2 != null) && (localRedTouchItem2.unReadFlag) && (!localRedTouchItem2.isClosed) && (localRedTouchItem2.passThroughLevel > 0)) {
              a(localRedTouchItem2, localavst.jdField_a_of_type_Avst.jdField_a_of_type_Int);
            }
            i += 1;
          }
        }
        i = localavst.jdField_a_of_type_Avst.jdField_a_of_type_Int;
        paramInt += 1;
      }
    }
  }
  ...
  private void f()
  {
    bdhb.a("red_point_info_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), this.c);
  }
  ...
  private void g()
  {
    ...
    if ((localConcurrentHashMap != null) && (localConcurrentHashMap.size() > 0))
    {
      ...
      {
        ((avsw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a(localArrayList, false);
        long l = SystemClock.elapsedRealtime();
        auwq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "pull_red_touch_time2", Long.valueOf(l));
      }
      return;
    }
    if (QLog.isColorLevel()) {
    ...
    ((avsw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a();
  }
  ...
  public String a()
  {
    if (this.jdField_a_of_type_JavaLangString == null) {
      this.jdField_a_of_type_JavaLangString = ((String)auwq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "red_point_config_version", ""));
    }
    if (QLog.isColorLevel()) {
  ...
  public void a()
  {
    if (this.jdField_a_of_type_JavaUtilVector.size() > 0)
    {
      ...
      f();
      this.jdField_a_of_type_Avsu.a(this.jdField_a_of_type_JavaUtilVector);
  ...
  public void a(int paramInt, boolean paramBoolean1, long paramLong, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (paramBoolean2 = true;; paramBoolean2 = false)
    {
      ...
      ((avsw)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(91)).a(localArrayList);
      return;
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      auwq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "red_point_config_version", paramString);
    }
  }
  ...
  public void a(cmd0x6f5.RspBody paramRspBody)
  {
    ...
    if ((paramRspBody != null) && (paramRspBody.rpt_task_info != null) && (paramRspBody.rpt_task_info.has()))
    {
      ...
      bdhb.a("red_point_configs_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), localConcurrentHashMap);
    }
  }
  ...
  public void a(short paramShort)
  {
    ...
    long l1 = ((Long)auwq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), "pull_red_touch_time2", Long.valueOf(0L))).longValue();
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramArrayOfByte)
    {
      ...
      for (int i = 0;; i = localRedPointConfig.redPointId)
      {
        ...
        ambm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
        this.jdField_a_of_type_Avsu.a(Collections.singletonList(paramArrayOfByte));
        return;
      }
