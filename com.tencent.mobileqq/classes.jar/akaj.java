...
public class akaj
{
  ...
  public void a()
  {
    ...
    try
    {
      ...
      localObject = new DataInputStream(new ByteArrayInputStream(bbco.decode((String)localObject, 0)));
  ...
  public void c()
  {
    try
    {
      ...
      BaseApplicationImpl.getApplication().getSharedPreferences("MemoryManagerMemoryStat", 0).edit().putString("LowMemoryStat", bbco.encodeToString((byte[])localObject, 0)).commit();
      return;
    }
    catch (Exception localException) {}
  }
