  ...
  extends ViewBase
{
  ...
  private RecyclerView.OnScrollListener jdField_a_of_type_AndroidSupportV7WidgetRecyclerView$OnScrollListener = new qel(this);
  ...
  private qej jdField_a_of_type_Qej;
  private qet jdField_a_of_type_Qet;
  ...
  public qek(VafContext paramVafContext)
  {
  ...
  {
    this.jdField_a_of_type_Qeu = new qeu(paramVafContext);
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.setAdapter(this.jdField_a_of_type_Qeu);
    this.jdField_a_of_type_Qeu.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView);
    this.jdField_a_of_type_Qeu.a(new qem(this));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.addOnChildAttachStateChangeListener(new qen(this));
  ...
  private void b()
  {
    ...
    {
      return;
      int m = this.jdField_a_of_type_Qeu.a();
        ...
        if (m > k)
        {
          ...
          if (i < m)
          {
            ...
            if (i == 0)
            {
              ...
              this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = localContext.getResources().getDrawable(2130849431);
              this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = localContext.getResources().getDrawable(2130849432);
  ...
  private void c()
  {
    if ((this.jdField_e_of_type_Boolean) && (this.jdField_a_of_type_Qet != null))
    {
      if (this.jdField_a_of_type_Qeu.a() > 1)
      {
        this.jdField_a_of_type_Qet.a();
        this.jdField_a_of_type_Qet.a(this.jdField_b_of_type_Int);
        this.jdField_a_of_type_Qet.b(this.jdField_c_of_type_Int);
      }
    }
    else {
      return;
    }
    this.jdField_a_of_type_Qet.b();
  }
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.a().setPath(this.jdField_a_of_type_JavaLangString);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.a().setBgColor(this.jdField_b_of_type_JavaLangString);
    ...
    for (float f1 = 1.0F;; f1 = 0.0F)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.setOnStateChangeListener(new qer(this));
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_Qeu.a(paramppu);
    a();
  }
  
  public void a(qej paramqej)
  {
    this.jdField_a_of_type_Qej = paramqej;
  }
  
  public void a(qfd paramqfd)
  {
    this.jdField_a_of_type_Qeu.a(paramqfd);
  }
  ...
  public void onComMeasure(int paramInt1, int paramInt2)
  {
    ...
    if ((localSideBarView != null) && (localSideBarView.getLayoutParams() != null))
    {
      ...
      {
        QLog.i("RvPolymericContainer", 2, "sideBarView, onComMeasure, height = " + this.jdField_a_of_type_AndroidWidgetRelativeLayout.getMeasuredHeight());
        QLog.i("RvPolymericContainer", 2, "sideBarView, onComMeasure, width = " + this.jdField_a_of_type_AndroidWidgetRelativeLayout.getMeasuredWidth());
      }
  ...
  public void onParseValueFinished()
  {
    ...
    d();
    if ((this.jdField_a_of_type_Int == 1) && (this.jdField_a_of_type_Qet == null))
    {
      this.jdField_a_of_type_Qet = new qet();
      this.jdField_a_of_type_Qet.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView);
      this.jdField_a_of_type_Qet.a(new qeq(this));
    }
    if (this.jdField_a_of_type_Qff == null)
    {
      this.jdField_a_of_type_Qff = new qff(this.jdField_f_of_type_Boolean, this.jdField_a_of_type_ArrayOfInt[0], this.jdField_a_of_type_ArrayOfInt[1], this.jdField_a_of_type_ArrayOfInt[2], this.jdField_a_of_type_ArrayOfInt[3]);
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyProteusViewPolymericProteusRecycleView.addItemDecoration(this.jdField_a_of_type_Qff);
    }
    ...
    for (int i = 0;; i = 8)
    {
      ...
      this.jdField_a_of_type_Qeu.a(this.jdField_d_of_type_Boolean);
      c();
      return;
    }
  }
  ...
  public boolean setAttribute(int paramInt, Object paramObject)
  {
    ...
    case 1052: 
      try
      {
        ...
        this.jdField_a_of_type_Qeu.a(localList);
    ...
    case 54: 
      ...
      for (;;)
      {
        ...
        {
          QLog.e("RvPolymericContainer", 2, "setCellArray:remoteArray: ", paramObject);
        }
        i += 1;
        continue;
    ...
    case 1135: 
      for (;;)
      {
        ...
        {
          QLog.e("RvPolymericContainer", 2, "setEdgeDragHeight:type: ", paramObject);
          continue;
        }
        return true;
        i = 1004;
    ...
    for (;;)
    {
      ...
      {
        QLog.e("RvPolymericContainer", 2, "setEdgeDragCenterY:type: ", paramObject);
        continue;
      }
      return true;
      i = 1004;
