...
public class agqx
  extends amab
{
  public agqx(TroopChatPie paramTroopChatPie) {}
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    if ((paramInt1 == 9) && (this.a.af)) {
      QQToast.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 1, alpo.a(2131715648), 0).a();
    }
  }
  ...
  protected void a(int paramInt1, int paramInt2, String paramString)
  {
    if ((paramInt1 == 2) || (paramInt1 == 9))
    {
      if (paramInt2 == 0)
      {
        ...
        String str = alpo.a(2131715653);
        if (this.a.af) {
          str = alpo.a(2131715651);
        }
        ...
        ((alzf)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a().a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      }
    }
    else {
      return;
    }
    QQToast.a(this.a.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 1, alpo.a(2131715646), 0).a();
  }
  
  protected void a(bbqf parambbqf)
  {
    if (QLog.isColorLevel()) {
      QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, "onPushTroopEnterEffect: troopUin = " + parambbqf.b + ", data.id = " + parambbqf.jdField_a_of_type_Int);
    }
    ...
    parambbqf = this.a.a();
    parambbqf.a(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
    parambbqf.a();
  }
  ...
  {
    if (!bdal.a(String.valueOf(paramLong1), this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {}
    do
    {
      return;
      if (QLog.isColorLevel())
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      localHashMap.put("netType", bdee.a(BaseApplication.getContext()) + "");
      azmz.a(BaseApplication.getContext()).a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "multiMsgNickTimeoutR", false, 30000L, 0L, localHashMap, "");
      do
      {
        return;
        if (paramBoolean) {
        ...
        i = 1;
        break;
        if ((this.a.c != null) && (aukx.a().jdField_a_of_type_Int != 2)) {
          this.a.c.dismiss();
        }
        aukx.a().b.clear();
      ...
      if (aukx.a().jdField_a_of_type_Int == 6)
      {
        ((afar)TroopChatPie.a(this.a).a(11)).a((Map)paramObject, aukx.a().jdField_a_of_type_JavaUtilArrayList, aukx.a().jdField_a_of_type_Int);
        return;
      }
      ((afau)TroopChatPie.b(this.a).a(1)).a((Map)paramObject, aukx.a().jdField_a_of_type_JavaUtilArrayList, aukx.a().jdField_a_of_type_Int);
      return;
      label405:
      i = 0;
    }
  ...
  protected void a(boolean paramBoolean, String paramString, int paramInt, List<String> paramList)
  {
    ...
    if ((paramBoolean) && (bcpq.a(paramInt)) && (paramString.equalsIgnoreCase((String)localObject)))
    {
      if ((paramInt != 2) && (paramInt != 3) && (paramInt != 1) && (paramInt != 5)) {
        break label129;
      }
      paramList = (afbt)this.a.a(28);
      if (paramList != null) {
    ...
    for (;;)
    {
      ...
      if ((paramInt == 4) && (paramList != null) && (paramList.size() > 0))
      {
        if (!this.a.am)
        {
          ...
          localObject = (afbt)this.a.a(28);
          if (localObject != null) {
            ((afbt)localObject).a(paramBoolean, paramString);
          }
        }
  ...
  protected void a(boolean paramBoolean, String paramString, long paramLong1, long paramLong2)
  {
    ...
    if (i != 0) {
      new bbzb(this.a.jdField_a_of_type_AndroidContentContext, "3171", "libWXVoice.so", "WXVoice").a();
    }
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString.equals(paramString1)) && (this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin().equals(paramString2)) && (paramInt1 == 1) && (paramInt2 == 0))
    {
      ...
      azmj.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_AIO", "", "AIOchat", "Get_history", 0, 0, paramString1, "", "", "");
      if (QLog.isColorLevel()) {
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt, String paramString3, String paramString4)
  {
    ...
    {
      if ((!bcgk.a(paramInt)) && (TroopChatPie.a(this.a) != null) && ((TroopChatPie.a(this.a).a instanceof bccj))) {
        ((bccj)TroopChatPie.a(this.a).a).b(this.a);
      }
  ...
  protected void a(boolean paramBoolean1, String paramString, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      bchk.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      return;
    }
  }
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, List<bcrz> paramList, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        localbcrz = (bcrz)paramList.next();
        if (!TextUtils.equals(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, localbcrz.jdField_a_of_type_JavaLangString)) {
          continue;
        }
        if (localbcrz.jdField_a_of_type_Long == 1104445552L)
        {
          if (QLog.isColorLevel()) {
            QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, new Object[] { "onUpdateTroopUnreadMsg homework. num=", Integer.valueOf(localbcrz.b) });
          }
          ...
          if ((TroopChatPie.a(this.a) != null) && ((TroopChatPie.a(this.a).a instanceof bccj))) {
            ((bccj)TroopChatPie.a(this.a).a).a(false, this.a);
          }
        }
      }
      for (;;)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, "receive troop album  red dot, push=" + paramBoolean2 + ", num=" + localbcrz.b);
        }
        Message localMessage = TroopChatPie.c(this.a).obtainMessage(85);
        localMessage.arg1 = localbcrz.b;
        localMessage.sendToTarget();
        break label72;
        break;
        label328:
        if (localbcrz.jdField_a_of_type_Long == 1106611799L)
        {
          if (QLog.isColorLevel()) {
            QLog.d(this.a.jdField_a_of_type_JavaLangString, 2, "receive game feed red dot, push=" + paramBoolean2 + ", num=" + localbcrz.b);
          }
  ...
  protected void c(String paramString1, String paramString2)
  {
    if (this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString.equals(paramString1))
    {
      List localList = this.a.jdField_a_of_type_Aelz.a();
      ...
      paramString1 = ((bckt)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(152)).a(paramString1, paramString2);
      if (paramString1 != null)
      {
  ...
  protected void c(boolean paramBoolean, String paramString1, String paramString2)
  {
    ...
    {
      paramString2 = (bcsj)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234);
  ...
  {
    if ((this.a.N) || (this.a.jdField_a_of_type_Bcsa == null)) {}
    boolean bool1;
    boolean bool2;
    do
    {
      ...
      bool1 = ((atlc)this.a.a(33)).c();
      bool2 = ((afbq)this.a.a(43)).c();
    } while ((this.a.V) || (bool1) || (bool2));
    if (!paramBoolean)
    {
      this.a.jdField_a_of_type_Bcsa.a(2);
      return;
    }
    paramString2 = ((bcsj)this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(234)).a(paramString1);
    if (!TextUtils.isEmpty(paramString2))
    {
      this.a.c(true);
      this.a.f.setText(paramString2);
    }
    if (this.a.jdField_a_of_type_Bcsa != null)
    {
      this.a.jdField_a_of_type_Bcsa.a(paramString1);
      if (this.a.jdField_a_of_type_Bcsa.a())
      {
        this.a.jdField_a_of_type_Bcsa.d();
        TroopChatPie.a(this.a, true);
        return;
      }
      this.a.jdField_a_of_type_Bcsa.a(0);
  ...
  protected void d(boolean paramBoolean, String paramString, List<TroopAIONotifyItem> paramList)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (this.a.jdField_a_of_type_Bblx == null);
      bool1 = this.a.jdField_a_of_type_Bblx.a();
      bool2 = this.a.jdField_a_of_type_Bblx.d();
      int j = 0;
      int i = j;
      if (paramList != null)
      {
        ...
        if (paramList.size() > 0)
        {
          this.a.jdField_a_of_type_Bblx.a(paramList);
          i = j;
          if (!bool2)
          {
            i = j;
            if (!bool1)
            {
              this.a.jdField_a_of_type_Bblx.f();
              i = 1;
            }
          }
        }
