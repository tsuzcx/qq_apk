...
public final class allb
  implements alcv, alcw, alcx, TVK_SDKMgr.InstallListener
{
  private int jdField_a_of_type_Int;
  private long jdField_a_of_type_Long;
  private aldf jdField_a_of_type_Aldf;
  private allc jdField_a_of_type_Allc;
  private alld jdField_a_of_type_Alld;
  private alle jdField_a_of_type_Alle;
  ...
  public allb(Activity paramActivity, aldf paramaldf)
  {
    this.jdField_a_of_type_Aldf = paramaldf;
  ...
  private void j()
  {
    if ((this.jdField_a_of_type_Boolean) && (this.jdField_c_of_type_Boolean)) {
      if (this.jdField_a_of_type_Allc != null) {
        this.jdField_a_of_type_Allc.a();
      }
    }
    while ((this.jdField_b_of_type_Boolean) || (this.jdField_d_of_type_Boolean) || (this.jdField_a_of_type_Allc == null)) {
      return;
    }
    QLog.d("ScanEntryResourceDelegate", 1, "ARBaseSo res download fail");
    this.jdField_a_of_type_Allc.b();
  }
  ...
  private void k()
  {
    ...
    if (this.jdField_a_of_type_Allc != null) {
      this.jdField_a_of_type_Allc.a(k / 2);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      if (this.jdField_a_of_type_Alld != null) {
        this.jdField_a_of_type_Alld.a((this.jdField_c_of_type_Int + this.jdField_d_of_type_Int) / 2);
      }
      return;
  ...
  public void a(long paramLong, allc paramallc, alld paramalld)
  {
    if (paramLong == 0L) {
      return;
    }
  ...
  public void a(alle paramalle)
  {
    this.jdField_a_of_type_Alle = paramalle;
  }
  ...
  public void a(ARCommonConfigInfo paramARCommonConfigInfo)
  {
    ...
    try
    {
      ...
      TVK_SDKMgr.setOnLogListener(new allh());
      if (this.jdField_a_of_type_Alle != null) {
        this.jdField_a_of_type_Alle.a(paramARCommonConfigInfo);
      }
      this.i = true;
      return;
    }
  ...
  public void c(int paramInt)
  {
    ...
    try
    {
      this.jdField_a_of_type_Aldf.b(paramInt);
      return;
    }
    catch (Exception localException)
    {
  ...
  public void e()
  {
    ...
    a(this.jdField_a_of_type_Long, this.jdField_a_of_type_Allc, this.jdField_a_of_type_Alld);
  }
  
  public void f()
  {
    this.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_Allc = null;
    this.jdField_a_of_type_Alld = null;
  }
  ...
  public void g()
  {
    try
    {
      this.jdField_a_of_type_Boolean = this.jdField_a_of_type_Aldf.b();
      if (!this.jdField_a_of_type_Boolean)
      {
        this.jdField_b_of_type_Boolean = true;
        this.jdField_a_of_type_Aldf.c();
      }
      for (;;)
      {
  ...
  public void i()
  {
    ...
    {
      this.h = true;
      this.jdField_a_of_type_Aldf.a(1);
      this.e = alcn.a();
      if (this.e) {
        break label156;
      }
      this.g = true;
      this.jdField_a_of_type_Aldf.a(0);
  ...
  public void j_(int paramInt)
  {
    ...
    for (;;)
    {
      if ((this.e) && (this.f) && (this.jdField_a_of_type_Alld != null)) {
        this.jdField_a_of_type_Alld.a();
      }
      return;
      this.e = true;
      this.g = false;
