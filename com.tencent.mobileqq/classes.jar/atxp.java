...
public class atxp
  implements auaa
{
  public atxp(QQGamePubAccountFragment paramQQGamePubAccountFragment) {}
  ...
  public void a(int paramInt)
  {
    ...
    try
    {
      ...
      if (paramInt < QQGamePubAccountFragment.a(this.a).size())
      {
        ...
        abet.a(alvx.a(), "769", "205017", this.a.a(paramInt), "76901", "1", "160", new String[] { atzc.a((MessageRecord)QQGamePubAccountFragment.a(this.a).get(paramInt)), "" + paramInt, "8" });
        ((VasExtensionHandler)QQGamePubAccountFragment.a(this.a).getBusinessHandler(71)).a(2, ((MessageRecord)QQGamePubAccountFragment.a(this.a).get(0)).getExtInfoFromExtStr("pa_msgId"), "");
        return;
      }
