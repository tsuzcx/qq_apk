  ...
  implements apcf
{
  ...
  public Context a;
  DialogInterface.OnCancelListener jdField_a_of_type_AndroidContentDialogInterface$OnCancelListener = new apbv(this);
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private DBFixManager jdField_a_of_type_ComTencentMobileqqDatabaseCorruptDBFixManager;
  String jdField_a_of_type_JavaLangString;
  private String h = "";
  
  public apbu(Context paramContext, QQAppInterface paramQQAppInterface)
  {
  ...
  private void c()
  {
    ...
    jdField_a_of_type_AndroidAppDialog = new apcd(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_AndroidContentContext, this);
  ...
  private void d()
  {
    jdField_a_of_type_AndroidAppDialog = bdcd.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(alpo.a(2131703244)).setPositiveButton(alpo.a(2131703250), new apbz(this));
    jdField_a_of_type_AndroidAppDialog.setOnKeyListener(new apca(this));
    jdField_a_of_type_AndroidAppDialog.setOnCancelListener(this.jdField_a_of_type_AndroidContentDialogInterface$OnCancelListener);
    a(jdField_a_of_type_AndroidAppDialog, "fix succ");
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", this.jdField_a_of_type_JavaLangString, e, e, 0, 0, "", "", "", "");
  }
  
  private void e()
  {
    jdField_a_of_type_AndroidAppDialog = bdcd.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(alpo.a(2131703245)).setPositiveButton("重启QQ", new apcb(this));
    jdField_a_of_type_AndroidAppDialog.setOnCancelListener(this.jdField_a_of_type_AndroidContentDialogInterface$OnCancelListener);
  ...
  private void f()
  {
    jdField_a_of_type_AndroidAppDialog = bdcd.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(alpo.a(2131703247)).setPositiveButton(alpo.a(2131703243), new apbw(this)).setNegativeButton(alpo.a(2131703249), new apcc(this));
    jdField_a_of_type_AndroidAppDialog.setOnCancelListener(this.jdField_a_of_type_AndroidContentDialogInterface$OnCancelListener);
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Int != apcd.d)
    {
  ...
  public void b()
  {
    jdField_a_of_type_AndroidAppDialog = bdcd.a(this.jdField_a_of_type_AndroidContentContext, 230).setMessage(alpo.a(2131703246)).setPositiveButton(alpo.a(2131703248), new apby(this)).setNegativeButton("取消", new apbx(this));
    jdField_a_of_type_AndroidAppDialog.setOnCancelListener(this.jdField_a_of_type_AndroidContentDialogInterface$OnCancelListener);
    a(jdField_a_of_type_AndroidAppDialog, "checked corrupt");
    azmj.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", this.jdField_a_of_type_JavaLangString, b, b, 0, 0, "", "", "", "");
  }
}
