      ...
      do
      {
        do
        {
          do
          {
            ...
            {
              bdmc.a(BaseApplicationImpl.getApplication()).a(null, "actSubscribeOpenCost", true, jdField_c_of_type_Long, 0L, null, null);
              return;
            }
            if (TextUtils.equals(paramString1, "SUBSCRIPT_AIO_COST"))
            {
              bdmc.a(BaseApplicationImpl.getApplication()).a(null, "actSubscribeAIOOpenCost", true, jdField_c_of_type_Long, 0L, null, null);
              return;
            }
            ...
            bdmc.a(BaseApplicationImpl.getApplication()).a(null, "actKandianOpenCost", true, jdField_c_of_type_Long, 0L, paramString1, null);
          ...
          {
            bdmc.a(BaseApplicationImpl.getApplication()).a(null, "actKandianToSubscribeCost", true, jdField_c_of_type_Long, 0L, null, null);
            return;
          }
        } while (TextUtils.equals(paramString1, "LEBA_KANDIAN_FEEDS_COST"));
        if (TextUtils.equals(paramString1, "SERVICE_FOLDER_COST"))
        {
          bdmc.a(BaseApplicationImpl.getApplication()).a(null, "actServiceFolderToServiceNumListCost", true, jdField_c_of_type_Long, 0L, null, null);
          return;
        }
        if (TextUtils.equals(paramString1, "recommend_tab_cost"))
        {
          ...
          for (paramString1 = "0";; paramString1 = "1")
          {
            ...
            bdmc.a(BaseApplicationImpl.getApplication()).a(null, "actKandianTabOpenCost", true, jdField_c_of_type_Long, 0L, paramString2, null);
        ...
        if (TextUtils.equals(paramString1, "video_tab_cost"))
        {
          ...
          for (i = 1;; i = 0)
          {
            ...
            bdmc.a(BaseApplicationImpl.getApplication()).a(null, "actKandianTabOpenCost", true, jdField_c_of_type_Long, 0L, paramString1, null);
