...
final class sgf
  implements wxw
{
  sgf(ryg paramryg, String paramString) {}
  ...
  public void a(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (this.jdField_a_of_type_Ryg != null) {
          this.jdField_a_of_type_Ryg.a(this.jdField_a_of_type_JavaLangString, localJSONObject);
        }
        return;
      }
      ...
      if ("onCommentLike".equals(localObject1)) {
        try
        {
          ...
          this.jdField_a_of_type_Ryg.a(this.jdField_a_of_type_JavaLangString, (JSONObject)localObject2);
          return;
        }
        catch (JSONException paramBundle)
        {
        ...
        try
        {
          ...
          this.jdField_a_of_type_Ryg.a(this.jdField_a_of_type_JavaLangString, paramBundle);
          return;
        }
        catch (JSONException paramBundle)
        {
        ...
        try
        {
          ...
          if (this.jdField_a_of_type_Ryg != null)
          {
            this.jdField_a_of_type_Ryg.a(this.jdField_a_of_type_JavaLangString, (JSONObject)localObject1);
            return;
          }
        }
        catch (JSONException paramBundle)
