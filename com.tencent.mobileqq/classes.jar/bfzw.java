  ...
  implements ServiceConnection
{
  ...
  public bfzw(bfzv parambfzv, ServiceConnection paramServiceConnection, Context paramContext, int paramInt)
  {
  ...
  public void onServiceConnected(ComponentName arg1, IBinder paramIBinder)
  {
    do
    {
      ...
      {
        synchronized (bfzv.a(this.jdField_a_of_type_Bfzv))
        {
          do
          {
            paramIBinder = (bfzw)bfzv.a(this.jdField_a_of_type_Bfzv).poll();
            ...
            bfzv.a(this.jdField_a_of_type_Bfzv, paramIBinder, 300);
            return;
      ...
      bfzv.a(this.jdField_a_of_type_Bfzv, false);
    } while (!QLog.isColorLevel());
