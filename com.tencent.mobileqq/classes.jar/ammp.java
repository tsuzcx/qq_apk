...
public class ammp
  implements amnb
{
  public ammp(ApolloPanel paramApolloPanel) {}
  ...
  public amnk a(int paramInt)
  {
    ...
    {
    default: 
      return new amly(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    case 0: 
      return new amly(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    case 2: 
      return new amkz(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
    case 100: 
      if (alnr.c("gamePanelSwitch") != 1)
      {
      ...
      return new amli(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie);
    }
    return new amnh(this.a.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.mContext, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo);
  }
  
  public void a()
  {
    ApolloPanel.a(this.a).post(new ApolloPanel.37.1(this));
  }
  ...
  public void a(List<amnk> paramList, List<ApolloActionPackage> paramList1, boolean paramBoolean)
  {
    if (QLog.isColorLevel()) {
    ...
    int m;
    int k;
    if ((localObject1 != null) && (((alsj)localObject1).jdField_a_of_type_Int > 0) && (!paramList.isEmpty()))
    {
      i = 0;
      if (i < paramList.size())
      {
        localObject2 = (amnk)paramList.get(i);
        if ((localObject2 instanceof amli))
        {
          ApolloPanel.jdField_a_of_type_Int = i;
          if (QLog.isColorLevel()) {
            QLog.d("ApolloPanel", 2, new Object[] { "[initPanelData] checkGameTab jumpGameId:", Integer.valueOf(((alsj)localObject1).jdField_a_of_type_Int), ",gameTabIndex:" + ApolloPanel.jdField_a_of_type_Int });
          }
          ((amli)localObject2).a((alsj)localObject1);
    ...
    for (;;)
    {
      ...
      if (k == 0)
      {
        ...
        if (!paramBoolean)
        {
          ...
          if (((alnr)this.a.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie.app.getManager(153)).o)
          {
