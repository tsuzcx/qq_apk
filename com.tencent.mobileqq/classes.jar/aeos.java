  ...
  implements DialogInterface.OnClickListener, QQPermissionCallback
{
  ...
  private static final String[] jdField_b_of_type_ArrayOfJavaLangString = { anni.a(2131700580), "QQ使用电话权限确定本机号码和设备ID，以保证帐号登录的安全性。QQ不会拨打其他号码或终止通话。\n请在设置中开启电话权限或存储空间，以正常使用QQ功能。" };
  private aeov jdField_a_of_type_Aeov;
  ...
  private void a(AppActivity paramAppActivity, int paramInt)
  {
    ...
    bcst.a(null, "dc00898", "", "", str1, str1, paramInt, 0, "", "", str2, "");
  }
  ...
  public void a()
  {
    ...
    aeou localaeou = new aeou(this);
    bgpa localbgpa = bglp.a(this.jdField_a_of_type_MqqAppAppActivity, 230);
    String str1 = anni.a(2131708974);
    if (i > 1) {}
    for (i = 2131693438;; i = 2131693437)
    {
      String str2 = anni.a(i);
      localbgpa.setTitle(str1);
      localbgpa.setMessage(str2);
      localbgpa.setNegativeButton(anni.a(2131693436), localaeou);
      localbgpa.setPositiveButton(anni.a(2131693435), localaeou);
      localbgpa.show();
      return;
    }
  }
  
  public void a(aeov paramaeov)
  {
  ...
  public boolean a(AppActivity paramAppActivity, boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (anrj.a(0)))
    {
      paramAppActivity = new aeot(this);
      anrj.a(this.jdField_a_of_type_MqqAppAppActivity, "", paramAppActivity, paramAppActivity).show();
      return false;
    }
