  ...
  extends akie
{
  ...
  public akka(Context paramContext, QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, int paramInt)
  {
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = getLayoutInflater().inflate(2131561955, this.jdField_a_of_type_ComTencentWidgetXListView, false);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131371882));
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setClickable(false);
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    this.jdField_a_of_type_AndroidViewView.setClickable(false);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131376445).setVisibility(0);
    this.jdField_a_of_type_AndroidViewView.findViewById(2131373040).setVisibility(8);
    ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371433)).setText(this.jdField_a_of_type_AndroidContentContext.getString(2131717758));
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnTouchListener(new akkb(this));
    this.jdField_a_of_type_ComTencentWidgetXListView.setOnItemClickListener(new akkc(this));
  }
  
  private void f()
  {
    this.jdField_b_of_type_AndroidWidgetEditText = ((EditText)findViewById(2131366151));
    this.jdField_b_of_type_AndroidWidgetEditText.setFilters(new InputFilter[] { new InputFilter.LengthFilter(15) });
    this.jdField_b_of_type_AndroidWidgetEditText.addTextChangedListener(new akkd(this));
    this.jdField_b_of_type_AndroidWidgetEditText.setImeOptions(3);
    akif localakif = new akif(this);
    this.jdField_b_of_type_AndroidWidgetEditText.setOnEditorActionListener(localakif);
    this.jdField_b_of_type_AndroidWidgetEditText.setOnKeyListener(localakif);
    this.jdField_b_of_type_AndroidWidgetEditText.setHint(this.jdField_a_of_type_AndroidContentContext.getString(2131690665));
  ...
  private void g()
  {
    this.jdField_a_of_type_AndroidWidgetImageButton.setOnClickListener(new akke(this));
    Button localButton = (Button)findViewById(2131363745);
    localButton.setVisibility(0);
    localButton.setOnClickListener(new akkf(this));
  }
  ...
  protected void a()
  {
    ...
    bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800A174", "0X800A174", this.jdField_b_of_type_Int, 0, "", "", "s_qq_history_tab", "");
  }
