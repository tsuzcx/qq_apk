  ...
  extends AsyncTask<Void, Void, Bitmap>
{
  ...
  private akka(PhotoCropActivity paramPhotoCropActivity) {}
  ...
  protected Bitmap a(Void... paramVarArgs)
  {
    try
    {
      ...
      for (paramVarArgs = Bitmap.Config.ARGB_8888;; paramVarArgs = Bitmap.Config.RGB_565)
      {
        ...
        bheg.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity.jdField_c_of_type_JavaLangString, localOptions);
        localOptions.inSampleSize = akln.a(localOptions, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity.g, this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity.g);
        localOptions.inJustDecodeBounds = false;
        paramVarArgs = bheg.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity.jdField_c_of_type_JavaLangString, localOptions);
  ...
  protected void a(Bitmap paramBitmap)
  {
    ...
    if (this.jdField_a_of_type_Int == 1) {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity, anvx.a(2131707521), 0).a();
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Int == 2) {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity, anvx.a(2131707522), 0).a();
      } else {
        QQToast.a(this.jdField_a_of_type_ComTencentMobileqqActivityPhotoPhotoCropActivity, anvx.a(2131707520), 0).a();
      }
    }
  }
}
