  ...
  extends aoqm
{
  ...
  public aoqn(aoqo paramaoqo)
  {
    this.jdField_a_of_type_Aoqo = paramaoqo;
  }
  
  public aoqn(aoqo paramaoqo, QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Aoqo = paramaoqo;
  ...
  {
    if (this.jdField_a_of_type_Aoqo == null) {
      if (QLog.isColorLevel()) {
        QLog.d("AppletsObserver", 2, "No Set ResponseResultListener, ignore Response!");
      }
    }
    while (4 != this.jdField_a_of_type_Aoqo.a()) {
      return;
    }
    this.jdField_a_of_type_Aoqo.a(paramBoolean, paramObject);
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        this.jdField_a_of_type_Aoqo.a(localRspBody);
        this.jdField_a_of_type_Aoqo.b(paramBoolean, paramObject);
        a();
        return;
      }
      catch (InvalidProtocolBufferMicroException localInvalidProtocolBufferMicroException)
      {
        ...
        this.jdField_a_of_type_Aoqo.b(paramObject);
        continue;
      }
  ...
  private void b(boolean paramBoolean, Object paramObject)
  {
    ...
    while (5 != this.jdField_a_of_type_Aoqo.a()) {
      return;
    }
    this.jdField_a_of_type_Aoqo.a(paramBoolean, paramObject);
    if (QLog.isColorLevel()) {
  ...
  private void c(boolean paramBoolean, Object paramObject)
  {
    ...
    while (7 != this.jdField_a_of_type_Aoqo.a()) {
      return;
    }
    this.jdField_a_of_type_Aoqo.a(paramBoolean, paramObject);
    if (QLog.isColorLevel()) {
    ...
    if (paramBoolean) {
      this.jdField_a_of_type_Aoqo.a(paramObject);
    }
    for (;;)
    {
      this.jdField_a_of_type_Aoqo.b(paramBoolean, paramObject);
