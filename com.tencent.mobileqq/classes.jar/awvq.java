  ...
  extends awul
{
  ...
  List<awul> jdField_a_of_type_JavaUtilList = null;
  ...
  private View a(View paramView)
  {
    ...
    ((ImageView)localObject).setImageResource(2130843521);
    int j = aciy.a(9.0F, paramView.getResources());
    LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(aciy.a(8.0F, paramView.getResources()), j);
    localLayoutParams.leftMargin = aciy.a(24.0F, paramView.getResources());
    localLayoutParams.rightMargin = aciy.a(4.0F, paramView.getResources());
    localLinearLayout.addView((View)localObject, localLayoutParams);
    paramView.setPadding(0, 0, 0, 0);
    localObject = paramView.findViewById(2131312537);
    if (localObject != null) {
  ...
  private void a(Resources paramResources, ImageView paramImageView)
  {
    ...
    {
      paramImageView.setBackgroundResource(2130843520);
      return;
    }
    paramImageView.setBackgroundResource(2130843519);
  }
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof LinearLayout)))
    {
      ...
      localObject2 = (awul)this.jdField_a_of_type_JavaUtilList.get(j);
      paramView = ((awul)localObject2).jdField_a_of_type_JavaLangString;
      if (!"summary".equals(paramView)) {
        break label334;
      }
      paramView = new LinearLayout(paramContext);
      paramView.setId(2131310772);
      paramView.setOrientation(0);
      localObject1 = new LinearLayout.LayoutParams(-1, aciy.a(42.0F, localResources));
      ((LinearLayout.LayoutParams)localObject1).leftMargin = aciy.a(13.0F, localResources);
      ((LinearLayout.LayoutParams)localObject1).rightMargin = aciy.a(13.0F, localResources);
      ((LinearLayout.LayoutParams)localObject1).topMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0;
      localObject3 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131310773);
      if (localObject3 != null) {
        break label323;
      }
      this.jdField_a_of_type_AndroidViewViewGroup.addView(paramView, (ViewGroup.LayoutParams)localObject1);
      label198:
      localObject1 = ((awul)localObject2).a(paramContext, null, paramBundle);
      localObject2 = new LinearLayout.LayoutParams(-1, -2);
      ((LinearLayout.LayoutParams)localObject2).weight = 1.0F;
      ((LinearLayout.LayoutParams)localObject2).gravity = 16;
      paramView.addView((View)localObject1, (ViewGroup.LayoutParams)localObject2);
      localObject1 = new ImageView(paramContext);
      ((ImageView)localObject1).setId(2131310771);
    ...
    do
    {
      for (;;)
      {
        ...
        paramView = ((awul)localObject2).a(paramContext, null, paramBundle);
        ...
        ((LinearLayout.LayoutParams)localObject1).topMargin = 0;
        ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0;
        localObject2 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131310773);
    ...
    label430:
    Object localObject1 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131310773);
    paramView = (View)localObject1;
    if (localObject1 == null)
    {
      paramView = new LinearLayout(paramContext);
      paramView.setOrientation(1);
      paramView.setId(2131310773);
      if (!this.jdField_a_of_type_Boolean) {
        break label646;
      }
    ...
    for (;;)
    {
      ...
      paramView.setBackgroundColor(localResources.getColor(2131101420));
      ((LinearLayout.LayoutParams)localObject1).leftMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).rightMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).topMargin = 0;
      ((LinearLayout.LayoutParams)localObject1).bottomMargin = 0;
      this.jdField_a_of_type_AndroidViewViewGroup.addView(paramView, (ViewGroup.LayoutParams)localObject1);
      localObject3 = ((awul)localObject2).a(paramContext, null, paramBundle);
      ...
      localObject2 = new LinearLayout.LayoutParams(-1, aciy.a(48.0F, localResources));
      ((LinearLayout.LayoutParams)localObject2).gravity = 16;
      paramView.addView((View)localObject1, (ViewGroup.LayoutParams)localObject2);
      this.i += 1;
      break;
  ...
  public void a()
  {
    ...
    {
      return;
      localLinearLayout = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131310773);
    } while (localLinearLayout == null);
    localLinearLayout.setVisibility(8);
    this.jdField_a_of_type_Boolean = false;
    a(this.jdField_a_of_type_AndroidContentContext.getResources(), (ImageView)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131310771));
  }
  ...
  public boolean a(awwc paramawwc)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_JavaLangString = paramawwc.a("url");
      this.i = 0;
      Object localObject = paramawwc.a("expand");
      if ((localObject != null) && (((String)localObject).toLowerCase().equals("true"))) {
        this.jdField_a_of_type_Boolean = true;
      }
      localObject = paramawwc.a("animation");
      if ((localObject != null) && (((String)localObject).toLowerCase().equals("false"))) {
        this.jdField_b_of_type_Boolean = false;
      }
      localObject = paramawwc.a("duration");
      if (localObject != null) {}
      try
      {
        this.jdField_c_of_type_Long = Long.parseLong((String)localObject);
        label157:
        if ((paramawwc.jdField_a_of_type_JavaUtilList != null) && (paramawwc.a() > 0))
        {
          Iterator localIterator = paramawwc.jdField_a_of_type_JavaUtilList.iterator();
          localObject = null;
          if (localIterator.hasNext())
          {
            awwc localawwc = (awwc)localIterator.next();
            if (("summary".equals(localawwc.jdField_b_of_type_JavaLangString)) || ("hr".equals(localawwc.jdField_b_of_type_JavaLangString))) {
              paramawwc = awuv.a(localawwc.jdField_b_of_type_JavaLangString);
            }
            do
            {
              localObject = paramawwc;
              if (paramawwc == null) {
                break;
              }
              localObject = paramawwc;
              if (!paramawwc.a(localawwc)) {
                break;
              }
              a(paramawwc);
              localObject = paramawwc;
              break;
              paramawwc = (awwc)localObject;
            } while (!"item".equals(localawwc.jdField_b_of_type_JavaLangString));
            paramawwc = localawwc.a("layout");
            try
            {
              if (!TextUtils.isEmpty(paramawwc)) {}
              for (int j = Integer.parseInt(paramawwc);; j = 0)
              {
                paramawwc = awuv.a(j);
                this.i += 1;
                break;
  ...
  public void b()
  {
    ...
    {
      return;
      localObject1 = (LinearLayout)this.jdField_a_of_type_AndroidViewViewGroup.findViewById(2131310773);
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      if (this.jdField_b_of_type_Boolean)
      {
        localObject2 = new awvs((ViewGroup)localObject1);
        ((awvs)localObject2).setDuration(this.jdField_c_of_type_Long);
        ((awvs)localObject2).setInterpolator(new DecelerateInterpolator());
      ...
      for (;;)
      {
        ...
        localObject2 = (bcqv)((QQAppInterface)localObject3).a(85);
        localObject3 = new StringBuilder();
        ((StringBuilder)localObject3).append(this.d).append("&expand=").append(this.jdField_a_of_type_Boolean);
        ((bcqv)localObject2).a(((StringBuilder)localObject3).toString(), 1, false, 0.0D, 0.0D, (String)localObject1, 1, "", "", "");
        return;
    ...
    if (this.jdField_b_of_type_Boolean)
    {
      localObject2 = new awvr((ViewGroup)localObject1);
      ((awvr)localObject2).setDuration(this.jdField_c_of_type_Long);
      ((awvr)localObject2).setInterpolator(new AccelerateInterpolator());
      ((LinearLayout)localObject1).startAnimation((Animation)localObject2);
    }
    for (;;)
    {
