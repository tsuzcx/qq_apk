  ...
  extends Handler
{
  ...
  public aoyf(Looper paramLooper, QQAppInterface paramQQAppInterface, aoxx paramaoxx)
  {
    super(paramLooper);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    Object localObject1 = (aoyb)paramMessage.obj;
    label270:
    boolean bool;
    for (;;)
    {
      try
      {
        ...
        default: 
          ...
          if (System.currentTimeMillis() - this.b > 300000L)
          {
            ...
            localObject1 = (aoyc)this.jdField_a_of_type_Aoxx.a(1);
            if (localObject1 != null) {
              paramMessage.append(((aoyc)localObject1).a());
            }
            localObject1 = (aoyg)this.jdField_a_of_type_Aoxx.a(2);
            if (localObject1 != null) {
              paramMessage.append(((aoyg)localObject1).a()).append("\n");
            }
      ...
      finally
      {
        ...
        Object localObject2 = (aoyc)this.jdField_a_of_type_Aoxx.a(1);
        if (localObject2 == null) {
          continue;
        }
        ((StringBuilder)localObject1).append(((aoyc)localObject2).a());
        localObject2 = (aoyg)this.jdField_a_of_type_Aoxx.a(2);
        if (localObject2 == null) {
          continue;
        }
        ((StringBuilder)localObject1).append(((aoyg)localObject2).a()).append("\n");
        QLog.d("Q.fts.BgCpu.Total", 1, ((StringBuilder)localObject1).toString());
        this.d = 0L;
        this.c = 0L;
        this.b = System.currentTimeMillis();
      }
      if (((aoyb)localObject1).c())
      {
      ...
      else if (QLog.isColorLevel())
      {
        ...
        if (((aoyb)localObject1).d()) {
          ((aoyb)localObject1).e();
        }
        bool = this.jdField_a_of_type_Aoxx.b;
        if (bool)
        {
          this.d += SystemClock.currentThreadTimeMillis() - l3;
          this.c += System.currentTimeMillis() - l2;
