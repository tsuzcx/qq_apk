  ...
  extends vhk
{
  ...
  public vew(@NonNull vhm paramvhm)
  {
    super(paramvhm);
  }
  ...
  {
    super.a();
    this.jdField_a_of_type_Vex = new vex(this);
  }
  ...
  public void a(int paramInt, Object paramObject)
  {
    ...
    if (a(this.jdField_a_of_type_Vix.a()))
    {
    ...
    this.jdField_a_of_type_Vix.getActivity().startActivityForResult(localIntent, 101);
  }
  ...
  public void a(String paramString)
  {
    ...
    DisplayMetrics localDisplayMetrics = this.jdField_a_of_type_Vix.getActivity().getResources().getDisplayMetrics();
    ...
    catch (OutOfMemoryError localOutOfMemoryError)
    {
      ...
      if (i != 0)
      {
        ...
        if (i % 90 == 0)
        {
          if (this.jdField_a_of_type_Vhm.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoArtFilter != null) {
            this.jdField_a_of_type_Vhm.jdField_a_of_type_ComTencentBizQqstoryTakevideoEditVideoArtFilter.b = i;
          }
      ...
      this.jdField_a_of_type_Vex.obtainMessage(2, paramString).sendToTarget();
    }
  }
  ...
  {
    DoodleLayout localDoodleLayout = this.jdField_a_of_type_Vhm.jdField_a_of_type_Vga.a();
    Bitmap localBitmap3 = localDoodleLayout.b(0);
    Bitmap localBitmap2 = this.jdField_a_of_type_Vhm.a();
    boolean bool1;
    ...
    do
    {
      do
      {
        ...
        bool2 = vxv.a(localBitmap1, paramString);
        bool1 = bool2;
