...
public class awrt
{
  ...
  public static void a(String paramString, int paramInt)
  {
    ...
    bcef.b(null, "dc02676", "grp_lbs", paramString, "video_quality", "play_load_again", paramInt, 0, String.valueOf(jdField_a_of_type_Int), "", "", "||" + paramString + "|||" + jdField_a_of_type_JavaLangString);
  }
  ...
  public static void a(String paramString1, int paramInt, String paramString2, String paramString3)
  {
    ...
    bcef.b(null, "dc02676", "grp_lbs", paramString1, "video_quality", "play_result", paramInt, 0, paramString2, paramString3, "", "||" + paramString1 + "|||" + jdField_a_of_type_JavaLangString);
  }
  ...
  public static void a(String paramString1, int paramInt, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean)
  {
    ...
    for (int j = 1;; j = 2)
    {
      bcef.b(null, "dc02676", "grp_lbs", paramString1, "video_quality", "play_support_online", paramInt, i, paramString2, paramString3, paramString4, j + "|" + paramString1 + "|||" + jdField_a_of_type_JavaLangString);
      return;
      i = 0;
      break;
    }
  ...
  public static void a(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    for (int i = 1;; i = 0)
    {
      bcef.b(null, "dc02676", "grp_lbs", paramString, "video_quality", "play_loading_time", paramInt, i, String.valueOf(l1), String.valueOf(l2), String.valueOf(l3), String.valueOf(l4) + "||" + paramString + "|||" + jdField_a_of_type_JavaLangString);
      return;
    }
  }
