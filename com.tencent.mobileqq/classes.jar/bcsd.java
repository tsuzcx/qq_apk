class bcsd
{
  private static bcsd jdField_a_of_type_Bcsd;
  private static bcsd jdField_b_of_type_Bcsd;
  ...
  public static bcsd a(int paramInt)
  {
    if (paramInt == 0)
    {
      if (jdField_a_of_type_Bcsd == null) {
        jdField_a_of_type_Bcsd = new bcsd(0);
      }
      return jdField_a_of_type_Bcsd;
    }
    if (jdField_b_of_type_Bcsd == null) {
      jdField_b_of_type_Bcsd = new bcsd(1);
    }
    return jdField_b_of_type_Bcsd;
  }
