  ...
  extends alwv
{
  ...
  public ahhd(View paramView)
  {
    super(paramView);
  }
  
  private void a(ahgi paramahgi)
  {
    ThreadManagerV2.executeOnFileThread(new SpringHbEntryPendantHolder.1(this, paramahgi));
  }
  
  static boolean a()
  {
    QLog.d("springHb_SpringHbEntryPendantHolder", 1, "canPendantClick：" + jdField_b_of_type_Boolean + ",isPendanting:" + ahgl.jdField_b_of_type_Boolean);
    return (jdField_b_of_type_Boolean) && (ahgl.jdField_b_of_type_Boolean);
  }
  ...
  private void b(ahgi paramahgi)
  {
    DownloadParam localDownloadParam = new DownloadParam();
    localDownloadParam.filePos = 0;
    localDownloadParam.url = paramahgi.jdField_a_of_type_JavaLangString;
    if (QLog.isColorLevel()) {
      QLog.i("springHb_SpringHbEntryPendantHolder", 2, "tryLoadDefaultRes -->,getResPath...start,resUrl:" + paramahgi.jdField_a_of_type_JavaLangString);
    }
    PreloadManager.a().a(localDownloadParam, new ahhe(this, paramahgi));
  }
  ...
  private void c(ahgi paramahgi)
  {
    DownloadParam localDownloadParam = new DownloadParam();
    localDownloadParam.filePos = 0;
    localDownloadParam.url = paramahgi.jdField_b_of_type_JavaLangString;
    if (QLog.isColorLevel()) {
      QLog.i("springHb_SpringHbEntryPendantHolder", 2, "tryLoadActivityRes -->,getResPath...start,resUrl:" + paramahgi.jdField_b_of_type_JavaLangString);
    }
    PreloadManager.a().a(localDownloadParam, new ahhf(this, paramahgi));
  }
  ...
  private void d(ahgi paramahgi)
  {
    if (bbjw.a(paramahgi.c)) {
      return;
    }
    DownloadParam localDownloadParam = new DownloadParam();
    localDownloadParam.filePos = 0;
    localDownloadParam.url = paramahgi.c;
    if (QLog.isColorLevel()) {
      QLog.i("springHb_SpringHbEntryPendantHolder", 2, "tryLoadLogoRes -->,getResPath...start,resUrl:" + paramahgi.c);
    }
    PreloadManager.a().a(localDownloadParam, new ahhg(this));
  }
  ...
  private void h()
  {
    try
    {
      ...
      {
        c(this.jdField_a_of_type_Auqf.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
        this.jdField_a_of_type_Auqf.jdField_a_of_type_AndroidGraphicsDrawableDrawable = null;
      }
      this.c = false;
      if (this.jdField_b_of_type_Auqf != null)
      {
        c(this.jdField_b_of_type_Auqf.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
        this.jdField_b_of_type_Auqf.jdField_a_of_type_AndroidGraphicsDrawableDrawable = null;
      }
      this.d = false;
      this.e = false;
      p();
    ...
    for (;;)
    {
      try
      {
        ...
        if (!jdField_b_of_type_Boolean)
        {
          ...
          BitmapDrawable localBitmapDrawable = new BitmapDrawable(ahgl.a("spring_hb/qvip_pay_entry_drum_default.png", true));
          localObject = QWalletPicHelper.getDrawableForWallet(str, aywk.jdField_a_of_type_AndroidGraphicsDrawableDrawable, localBitmapDrawable, (Bundle)localObject);
          if (localObject != null)
          {
            this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = ((Drawable)localObject);
            this.jdField_a_of_type_Ahhi = new ahhi(this, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidViewView, this.jdField_b_of_type_AndroidGraphicsDrawableDrawable);
    ...
    for (;;)
    {
      try
      {
        if (!this.d)
        {
          ...
          localObject = QWalletPicHelper.getDrawableForWallet(str, aywk.jdField_a_of_type_AndroidGraphicsDrawableDrawable, (Bundle)localObject);
          if (localObject != null)
          {
            this.jdField_b_of_type_Auqf.jdField_a_of_type_AndroidGraphicsDrawableDrawable = ((Drawable)localObject);
            this.jdField_a_of_type_Ahhi = new ahhi(this, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidViewView, this.jdField_b_of_type_Auqf.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
            this.d = true;
          }
        }
        else
    ...
    for (;;)
    {
      try
      {
        if (!this.c)
        {
          ...
          if (localObject != null)
          {
            this.jdField_a_of_type_Auqf.jdField_a_of_type_AndroidGraphicsDrawableDrawable = ((Drawable)localObject);
            this.jdField_a_of_type_Ahhi = new ahhi(this, this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_AndroidViewView, this.jdField_a_of_type_Auqf.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
            this.c = true;
          }
        }
        else
  ...
  private void m()
  {
    try
    {
      if (jdField_b_of_type_Boolean)
      {
        if (!ahgl.jdField_b_of_type_Boolean) {
          return;
        }
        p();
        if (this.jdField_a_of_type_AndroidAnimationValueAnimator == null)
        {
          this.k = actn.a(7.5F, this.jdField_a_of_type_AndroidViewView.getResources());
  ...
  {
    float f1 = -actn.a(20.0F, this.jdField_a_of_type_AndroidViewView.getResources());
  ...
  public void a()
  {
    try
    {
      ...
      j = actn.a(160.0F, this.jdField_a_of_type_AndroidViewView.getResources());
      a(i - j - 0, 0, j, actn.a(jdField_a_of_type_Float, this.jdField_a_of_type_AndroidViewView.getResources()), this.jdField_a_of_type_AndroidViewView);
      return;
    }
    catch (Throwable localThrowable)
    {
  ...
  public void a(int paramInt)
  {
    super.a(paramInt);
    if (this.jdField_a_of_type_Auqf != null) {
      this.jdField_a_of_type_Auqf.g = paramInt;
    }
    if (this.jdField_b_of_type_Auqf != null) {
      this.jdField_b_of_type_Auqf.g = paramInt;
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, View paramView)
  {
    ...
    if (this.jdField_a_of_type_Auqf == null)
    {
      ...
      this.jdField_a_of_type_Auqf.a(paramInt1, paramInt2, paramInt3, paramInt4, paramView);
    }
    if (this.jdField_b_of_type_Auqf == null)
    {
      this.jdField_b_of_type_Auqf = new auqf();
      this.jdField_b_of_type_Auqf.a(paramInt1, paramInt2, paramInt3, paramInt4, paramView);
    }
  }
  ...
  public boolean a(int paramInt)
  {
    ...
    if (this.c)
    {
      ...
      b(this.jdField_a_of_type_Auqf.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
      b(this.jdField_b_of_type_Auqf.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
  ...
  public void b()
  {
    try
    {
      ...
      ahgi localahgi = ((ahfz)BaseActivity.sTopActivity.app.getManager(342)).a();
      if (!bbjw.a(localahgi.jdField_b_of_type_JavaLangString))
      {
        c(localahgi);
        return;
      }
      if (!bbjw.a(localahgi.jdField_a_of_type_JavaLangString))
      {
        b(localahgi);
        return;
      }
