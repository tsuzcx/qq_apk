...
public class oav
{
  public static int a(@NonNull AdData paramAdData, AdvertisementInfo paramAdvertisementInfo)
  {
    ...
    if (!TextUtils.isEmpty(paramAdData.jdField_l_of_type_JavaLangString)) {
      paramAdvertisementInfo.mSinglePicture = sfd.a(paramAdData.jdField_l_of_type_JavaLangString, 4);
    }
    return 2;
  }
  ...
  public static AdvertisementInfo a(AdData paramAdData)
  {
    ...
    for (;;)
    {
      ...
      localAdvertisementInfo.mOrigin = nmf.K;
      try
      {
          ...
          try
          {
            for (;;)
            {
              for (;;)
              {
                ...
                localAdvertisementInfo.mAdvertisementExtInfo = new nyh(localAdvertisementInfo.mAdExtInfo);
  ...
  public static void a(AdData paramAdData, int paramInt)
  {
    ...
    if (localQQAppInterface != null) {
      nmf.a(localQQAppInterface, paramAdData, paramInt);
    }
  }
