...
{
  ahew(ahev paramahev, MessageForQzoneFeed paramMessageForQzoneFeed) {}
  
  public void onClick(View paramView)
  {
    this.jdField_a_of_type_ComTencentMobileqqDataMessageForQzoneFeed.actionUrl = ahev.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQzoneFeed.actionUrl);
    if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQzoneFeed.actionUrl))
    {
      EventCollector.getInstance().onViewClicked(paramView);
      return;
    }
    Object localObject2 = bkyp.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQzoneFeed.actionUrl);
    ...
    if (("110".equals(localObject1)) || ("279".equals(localObject1)) || ("318".equals(localObject1)))
    {
      ...
      localUserInfo.qzone_uin = this.jdField_a_of_type_Ahev.a.getCurrentAccountUin();
      localUserInfo.nickname = this.jdField_a_of_type_Ahev.a.getCurrentNickname();
      ...
      QZoneClickReport.startReportImediately(this.jdField_a_of_type_Ahev.a.getAccount(), (QZoneClickReport.ReportInfo)localObject1);
      ...
      StatisticCollector.getInstance(BaseApplicationImpl.getContext()).collectPerformance(this.jdField_a_of_type_Ahev.a.getAccount(), "actQZSourceDataReport", true, 0L, 0L, (HashMap)localObject1, null);
      label278:
      localObject1 = null;
      if (localObject2 != null) {
    ...
    for (;;)
    {
      ...
      QZoneClickReport.startReportImediately(this.jdField_a_of_type_Ahev.a.getAccount(), (QZoneClickReport.ReportInfo)localObject2);
      bdla.b(this.jdField_a_of_type_Ahev.a, "dc00898", "", "", "0x8009434", "0x8009434", 0, 0, "", "2", "", "");
      bdla.b(this.jdField_a_of_type_Ahev.a, "CliOper", "", "", "0X8006000", "0X8006000", 0, 0, "", "", "", "");
      break;
      this.jdField_a_of_type_Ahev.a(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQzoneFeed.actionUrl);
      break label278;
      label474:
