  ...
  extends bgpa
{
  ...
  public bgql(Context paramContext, int paramInt)
  {
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetClearableEditText = ((ClearableEditText)findViewById(2131368651));
  }
  ...
  public bgpa setPositiveButton(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.rBtn.setOnClickListener(new bgqm(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
