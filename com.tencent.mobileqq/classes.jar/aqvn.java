...
{
  aqvn(aqvm paramaqvm, String paramString, long paramLong, boolean paramBoolean) {}
  
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    Object localObject = null;
    if (QLog.isColorLevel()) {
      QLog.d("UniformDownloadMgr<FileAssistant>", 2, "handleCheck, success: " + paramBoolean + ", canceled: " + aqvm.a(this.jdField_a_of_type_Aqvm));
    }
    Activity localActivity = (Activity)aqvm.a(this.jdField_a_of_type_Aqvm).get();
    if ((aqvm.a(this.jdField_a_of_type_Aqvm)) || (localActivity == null) || (localActivity.isFinishing())) {
      return;
    }
    ...
    for (;;)
    {
      ...
      catch (InvalidProtocolBufferMicroException paramBundle)
      {
        ...
        continue;
        this.jdField_a_of_type_Aqvm.a.sendEmptyMessage(2);
      }
      adpn.a(localActivity, localIntent, PublicFragmentActivity.class, ApkFileDownloadFragment.class);
