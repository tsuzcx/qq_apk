...
public class aqvn
{
  ...
  public static Bitmap a(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, aqcx paramaqcx)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        catch (OutOfMemoryError paramString1)
        {
          ...
          localPaint.setColor(-1);
          a(paramAppInterface, paramContext, paramInt1, paramInt2, paramInt3, paramString1, paramString2, paramString3, paramJSONArray, paramaqcx, i, j, k, m, str, localCanvas, localPaint);
          ...
          paramAppInterface = paramContext.getResources().getDrawable(2130844964);
          paramAppInterface.setBounds(i / 2 - 45, j - 102 - 42, i / 2 + 45, j - 102);
          paramAppInterface.draw(localCanvas);
          paramAppInterface = anvx.a(2131701917);
  ...
  public static String a(AppInterface paramAppInterface, Context paramContext, Bitmap paramBitmap)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramContext = znl.a(paramContext, str, paramBitmap);
        paramAppInterface = paramContext;
        if (QLog.isColorLevel())
        {
  ...
  public static String a(String paramString, float paramFloat)
  {
    ...
    int i;
    int j;
    if (aqvq.a(paramString) > paramFloat)
    {
    ...
    for (;;)
    {
      if ((i >= paramString.length()) || (aqvq.a(paramString.substring(0, i) + "…") > paramFloat))
      {
  ...
  public static String a(String paramString, AppInterface paramAppInterface)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        paramAppInterface = HttpUtil.uploadImageWithHttps(NetworkUtil.toDirectIpUrl("https://cgi.connect.qq.com/qqconnectopen/upload_share_image", 1007), "cgi.connect.qq.com", str1, str2, null, localHashMap, (Map)localObject1, false);
        localObject2 = paramAppInterface;
        if (paramAppInterface == null) {
          localObject2 = HttpUtil.uploadImageWithHttps("https://cgi.connect.qq.com/qqconnectopen/upload_share_image", "cgi.connect.qq.com", str1, str2, null, localHashMap, (Map)localObject1, true);
        }
        if (QLog.isColorLevel()) {
  ...
  public static ArrayList<aqvy> a(JSONArray paramJSONArray)
  {
    ...
    if (i < j)
    {
      ...
      do
      {
        ...
        localArrayList.add(new aqvy(str));
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, aqcx paramaqcx, int paramInt4, int paramInt5, int paramInt6, int paramInt7, String paramString4, Canvas paramCanvas, Paint paramPaint)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = (aqvr)paramJSONArray.next();
        localObject2 = ((aqvr)localObject1).jdField_a_of_type_JavaUtilArrayList.iterator();
        label721:
        if (((Iterator)localObject2).hasNext())
        {
          localObject3 = (aqvs)((Iterator)localObject2).next();
          paramString3.left = (((aqvs)localObject3).jdField_a_of_type_AndroidGraphicsRect.left + paramString2.left + 1);
          paramString3.top = (((aqvs)localObject3).jdField_a_of_type_AndroidGraphicsRect.top + paramString2.top + 1);
          paramString3.right = (((aqvs)localObject3).jdField_a_of_type_AndroidGraphicsRect.right + paramString2.left - 2);
          paramString3.bottom = (((aqvs)localObject3).jdField_a_of_type_AndroidGraphicsRect.bottom + paramString2.top - 2);
          paramPaint.setColor(((aqvr)localObject1).jdField_a_of_type_Int);
          if (!((aqvr)localObject1).jdField_b_of_type_Boolean) {
            break label913;
          }
          paramInt1 = 178;
          paramPaint.setAlpha(paramInt1);
          paramPaint.setFakeBoldText(((aqvr)localObject1).jdField_a_of_type_Boolean);
          paramString1 = Paint.Align.CENTER;
          if (((aqvr)localObject1).c != -1) {
            break label920;
          }
        ...
        {
          label849:
          a(paramCanvas, paramPaint, paramString3, ((aqvs)localObject3).jdField_a_of_type_JavaLangString, paramString1, ((aqvr)localObject1).d, ((aqvr)localObject1).jdField_b_of_type_Int);
          break label721;
          break;
          label913:
          paramInt1 = 255;
      ...
      if (paramaqcx != null)
      {
        paramAppInterface = paramaqcx.a(paramAppInterface.getCurrentAccountUin(), true);
        QLog.i("ConfessShareHelper", 4, "preLoadQQSelfHeaderBitmap " + paramAppInterface);
      }
      for (paramAppInterface = new BitmapDrawable(paramAppInterface);; paramAppInterface = paramContext.getResources().getDrawable(2130844957))
      {
        ...
        paramContext = a(paramString4, 8.0F) + anvx.a(2131701918);
  ...
  public static final void a(String paramString, Canvas paramCanvas, Rect paramRect)
  {
    ...
    try
    {
      localObject = znl.a(paramString, -1);
      m = ((gr)localObject).a();
  ...
  public static boolean a(Context paramContext, Canvas paramCanvas, int paramInt1, int paramInt2, float paramFloat)
  {
    ...
    aqvo[] arrayOfaqvo = a(paramInt2, paramInt1);
    paramInt2 = arrayOfaqvo.length;
    paramInt1 = 0;
    aqvo localaqvo;
    if (paramInt1 < paramInt2) {
      localaqvo = arrayOfaqvo[paramInt1];
    }
    for (;;)
    {
      try
      {
        localDrawable = paramContext.getResources().getDrawable(localaqvo.jdField_a_of_type_Int);
        if (localaqvo.jdField_a_of_type_Int == 2130844966) {
          break label316;
        }
        if (localaqvo.jdField_a_of_type_Int != 2130844959) {
          break label309;
        }
      }
      ...
      m = (int)(localaqvo.jdField_b_of_type_Int - j * localaqvo.jdField_a_of_type_Float * f1 / 2.0F);
      n = (int)(localaqvo.c * f2 - k * localaqvo.jdField_a_of_type_Float * f1 / 2.0F);
      f3 = localaqvo.jdField_b_of_type_Int;
      localDrawable.setBounds(m, n, (int)(j * localaqvo.jdField_a_of_type_Float * f1 / 2.0F + f3), (int)(f2 * localaqvo.c + k * localaqvo.jdField_a_of_type_Float * f1 / 2.0F));
      if (localaqvo.jdField_a_of_type_Boolean)
      {
  ...
  public static aqvo[] a(int paramInt1, int paramInt2)
  {
    if (paramInt1 == 0) {
      switch (paramInt2)
      {
    ...
    do
    {
      ...
      {
        return new aqvo[0];
        return new aqvo[] { new aqvo(2130844931, 60, 60, true, 0.75F), new aqvo(2130844936, 458, 84, true, 0.75F), new aqvo(2130844937, 142, 250, true, 0.75F), new aqvo(2130844931, 368, 188, true, 0.75F), new aqvo(2130844929, 168, 120, true, 0.75F), new aqvo(2130844962, 120, 40, true, 0.75F), new aqvo(2130844963, 120, 110, true, 0.75F), new aqvo(2130844960, 30, 150, true, 0.75F), new aqvo(2130844960, 180, 200, true, 0.75F), new aqvo(2130844962, 420, 160, true, 0.75F), new aqvo(2130844963, 495, 150, true, 0.75F), new aqvo(2130844959, 257, 82, false, 1.0F) };
        return new aqvo[] { new aqvo(2130844938, 60, 88, true, 0.75F), new aqvo(2130844930, 226, 56, true, 0.75F), new aqvo(2130844937, 480, 140, true, 0.75F), new aqvo(2130844935, 330, 198, true, 0.75F), new aqvo(2130844936, 168, 244, true, 0.75F), new aqvo(2130844962, 300, 50, true, 0.75F), new aqvo(2130844963, 460, 50, true, 0.75F), new aqvo(2130844960, 60, 230, true, 0.75F), new aqvo(2130844962, 120, 120, true, 0.75F), new aqvo(2130844962, 440, 270, true, 0.75F), new aqvo(2130844959, 257, 82, false, 1.0F) };
        return new aqvo[] { new aqvo(2130844931, 174, 58, true, 0.75F), new aqvo(2130844933, 70, 146, true, 0.75F), new aqvo(2130844935, 390, 106, true, 0.75F), new aqvo(2130844930, 206, 240, true, 0.75F), new aqvo(2130844932, 470, 225, true, 0.75F), new aqvo(2130844963, 120, 88, true, 0.75F), new aqvo(2130844963, 480, 70, true, 0.75F), new aqvo(2130844960, 110, 230, true, 0.75F), new aqvo(2130844962, 340, 210, true, 0.75F), new aqvo(2130844959, 257, 82, false, 1.0F) };
        return new aqvo[] { new aqvo(2130844937, 138, 88, true, 0.75F), new aqvo(2130844931, 68, 232, true, 0.75F), new aqvo(2130844935, 298, 206, true, 0.75F), new aqvo(2130844938, 480, 140, true, 0.75F), new aqvo(2130844967, 382, 140, true, 0.75F), new aqvo(2130844962, 60, 90, true, 0.75F), new aqvo(2130844960, 182, 64, true, 0.75F), new aqvo(2130844960, 440, 210, true, 0.75F), new aqvo(2130844962, 440, 30, true, 0.75F), new aqvo(2130844962, 190, 200, true, 0.75F), new aqvo(2130844959, 257, 82, false, 1.0F) };
        if (paramInt1 != 1) {
          break;
        }
        switch (paramInt2)
      ...
      return new aqvo[] { new aqvo(2130844932, 110, 230, true, 1.0F), new aqvo(2130844935, 656, 170, true, 1.0F), new aqvo(2130844930, 516, 350, true, 1.0F), new aqvo(2130844931, 84, 550, true, 1.0F), new aqvo(2130844936, 656, 586, true, 1.0F), new aqvo(2130844931, 526, 735, true, 1.0F), new aqvo(2130844937, 198, 830, true, 1.0F), new aqvo(2130844933, 70, 1016, true, 1.0F), new aqvo(2130844935, 397, 952, true, 1.0F), new aqvo(2130844938, 670, 880, true, 1.0F), new aqvo(2130844930, 220, 1257, true, 1.0F), new aqvo(2130844934, 606, 1220, true, 1.0F), new aqvo(2130844967, 452, 475, true, 1.0F), new aqvo(2130844929, 240, 645, true, 1.0F), new aqvo(2130844960, 160, 300, true, 1.0F), new aqvo(2130844963, 660, 330, true, 1.0F), new aqvo(2130844961, 620, 450, true, 1.0F), new aqvo(2130844962, 175, 500, true, 1.0F), new aqvo(2130844962, 460, 570, true, 1.0F), new aqvo(2130844963, 180, 630, true, 1.0F), new aqvo(2130844960, 40, 690, true, 1.0F), new aqvo(2130844960, 260, 750, true, 1.0F), new aqvo(2130844963, 710, 600, true, 1.0F), new aqvo(2130844962, 600, 710, true, 1.0F), new aqvo(2130844962, 140, 970, true, 1.0F), new aqvo(2130844960, 85, 1200, true, 1.0F), new aqvo(2130844960, 600, 1050, true, 1.0F), new aqvo(2130844963, 420, 1100, true, 1.0F), new aqvo(2130844962, 540, 1250, true, 1.0F), new aqvo(2130844966, 375, 134, false, 1.0F) };
      return new aqvo[] { new aqvo(2130844935, 110, 368, true, 1.0F), new aqvo(2130844936, 570, 256, true, 1.0F), new aqvo(2130844931, 655, 475, true, 1.0F), new aqvo(2130844938, 75, 740, true, 1.0F), new aqvo(2130844930, 320, 686, true, 1.0F), new aqvo(2130844937, 670, 832, true, 1.0F), new aqvo(2130844935, 505, 955, true, 1.0F), new aqvo(2130844936, 260, 1020, true, 1.0F), new aqvo(2130844934, 75, 1216, true, 1.0F), new aqvo(2130844930, 565, 1235, true, 1.0F), new aqvo(2130844967, 430, 355, true, 1.0F), new aqvo(2130844929, 110, 174, true, 1.0F), new aqvo(2130844960, 140, 250, true, 1.0F), new aqvo(2130844963, 640, 195, true, 1.0F), new aqvo(2130844960, 170, 450, true, 1.0F), new aqvo(2130844962, 490, 1220, true, 1.0F), new aqvo(2130844961, 350, 520, true, 1.0F), new aqvo(2130844961, 630, 410, true, 1.0F), new aqvo(2130844963, 60, 500, true, 1.0F), new aqvo(2130844963, 680, 655, true, 1.0F), new aqvo(2130844963, 310, 1110, true, 1.0F), new aqvo(2130844962, 470, 660, true, 1.0F), new aqvo(2130844962, 190, 780, true, 1.0F), new aqvo(2130844962, 680, 1060, true, 1.0F), new aqvo(2130844960, 180, 1230, true, 1.0F), new aqvo(2130844966, 375, 134, false, 1.0F) };
      return new aqvo[] { new aqvo(2130844931, 110, 220, true, 1.0F), new aqvo(2130844937, 654, 240, true, 1.0F), new aqvo(2130844935, 562, 482, true, 1.0F), new aqvo(2130844933, 95, 537, true, 1.0F), new aqvo(2130844930, 295, 672, true, 1.0F), new aqvo(2130844932, 683, 660, true, 1.0F), new aqvo(2130844934, 60, 850, true, 1.0F), new aqvo(2130844936, 442, 872, true, 1.0F), new aqvo(2130844930, 114, 1046, true, 1.0F), new aqvo(2130844931, 680, 950, true, 1.0F), new aqvo(2130844936, 230, 1197, true, 1.0F), new aqvo(2130844938, 480, 1260, true, 1.0F), new aqvo(2130844967, 670, 1200, true, 1.0F), new aqvo(2130844960, 140, 630, true, 1.0F), new aqvo(2130844960, 500, 960, true, 1.0F), new aqvo(2130844960, 330, 1050, true, 1.0F), new aqvo(2130844960, 50, 1150, true, 1.0F), new aqvo(2130844961, 290, 430, true, 1.0F), new aqvo(2130844961, 330, 760, true, 1.0F), new aqvo(2130844962, 60, 310, true, 1.0F), new aqvo(2130844962, 480, 580, true, 1.0F), new aqvo(2130844962, 220, 820, true, 1.0F), new aqvo(2130844963, 600, 150, true, 1.0F), new aqvo(2130844963, 700, 410, true, 1.0F), new aqvo(2130844963, 25, 900, true, 1.0F), new aqvo(2130844963, 150, 430, true, 1.0F), new aqvo(2130844966, 375, 134, false, 1.0F) };
      return new aqvo[] { new aqvo(2130844931, 104, 278, true, 1.0F), new aqvo(2130844934, 588, 200, true, 1.0F), new aqvo(2130844930, 690, 390, true, 1.0F), new aqvo(2130844933, 420, 534, true, 1.0F), new aqvo(2130844932, 92, 592, true, 1.0F), new aqvo(2130844936, 660, 624, true, 1.0F), new aqvo(2130844931, 475, 735, true, 1.0F), new aqvo(2130844937, 192, 818, true, 1.0F), new aqvo(2130844938, 696, 880, true, 1.0F), new aqvo(2130844935, 430, 990, true, 1.0F), new aqvo(2130844930, 64, 1034, true, 1.0F), new aqvo(2130844930, 272, 1250, true, 1.0F), new aqvo(2130844934, 584, 1205, true, 1.0F), new aqvo(2130844929, 254, 638, true, 1.0F), new aqvo(2130844960, 200, 320, true, 1.0F), new aqvo(2130844960, 260, 780, true, 1.0F), new aqvo(2130844960, 620, 1000, true, 1.0F), new aqvo(2130844960, 150, 1250, true, 1.0F), new aqvo(2130844961, 70, 420, true, 1.0F), new aqvo(2130844961, 460, 590, true, 1.0F), new aqvo(2130844961, 630, 450, true, 1.0F), new aqvo(2130844962, 70, 800, true, 1.0F), new aqvo(2130844962, 280, 980, true, 1.0F), new aqvo(2130844962, 610, 720, true, 1.0F), new aqvo(2130844962, 480, 1220, true, 1.0F), new aqvo(2130844963, 170, 590, true, 1.0F), new aqvo(2130844963, 330, 1160, true, 1.0F), new aqvo(2130844963, 700, 680, true, 1.0F), new aqvo(2130844963, 660, 290, true, 1.0F), new aqvo(2130844966, 375, 134, false, 1.0F) };
    } while (paramInt1 != 2);
    return new aqvo[] { new aqvo(2130844932, 110, 310, true, 1.0F), new aqvo(2130844935, 650, 216, true, 1.0F), new aqvo(2130844930, 516, 350, true, 1.0F), new aqvo(2130844932, 92, 592, true, 1.0F), new aqvo(2130844936, 656, 586, true, 1.0F), new aqvo(2130844931, 470, 716, true, 1.0F), new aqvo(2130844937, 198, 830, true, 1.0F), new aqvo(2130844938, 670, 980, true, 1.0F), new aqvo(2130844935, 397, 1060, true, 1.0F), new aqvo(2130844933, 70, 1016, true, 1.0F), new aqvo(2130844960, 200, 320, true, 1.0F), new aqvo(2130844929, 240, 438, true, 1.0F), new aqvo(2130844967, 452, 475, true, 0.75F), new aqvo(2130844960, 200, 600, true, 1.0F), new aqvo(2130844960, 1000, 620, true, 1.0F), new aqvo(2130844961, 70, 420, true, 1.0F) };
  }
  
  public static Bitmap b(AppInterface paramAppInterface, Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3, JSONArray paramJSONArray, aqcx paramaqcx)
  {
    if ((paramJSONArray == null) || (paramJSONArray.length() < 1) || (paramContext == null))
    {
      paramAppInterface = null;
      ...
      for (;;)
      {
        ...
        catch (OutOfMemoryError paramString1)
        {
          try
          {
            ...
            localPaint.setColor(-1);
            a(paramAppInterface, paramContext, paramInt1, paramInt2, paramInt3, null, paramString2, paramString3, paramJSONArray, paramaqcx, i, j, 5, 5, str, localCanvas, localPaint);
            localPaint.setAlpha(255);
            localPaint.setColor(-1);
            return paramString1;
          }
