...
public class bdei
{
  ...
  public static bdei a(bdei parambdei)
  {
    if (parambdei == null)
    {
    ...
    localbdei.jdField_a_of_type_JavaLangString = parambdei.jdField_a_of_type_JavaLangString;
    localbdei.jdField_a_of_type_Int = parambdei.jdField_a_of_type_Int;
    localbdei.jdField_b_of_type_JavaLangString = parambdei.jdField_b_of_type_JavaLangString;
    localbdei.jdField_c_of_type_JavaLangString = parambdei.jdField_c_of_type_JavaLangString;
    ArrayList localArrayList = new ArrayList();
    if (parambdei.jdField_a_of_type_JavaUtilArrayList != null) {
      localArrayList.addAll(parambdei.jdField_a_of_type_JavaUtilArrayList);
    }
    localbdei.jdField_a_of_type_JavaUtilArrayList = localArrayList;
    localArrayList = new ArrayList();
    if (parambdei.jdField_b_of_type_JavaUtilArrayList != null) {
      localArrayList.addAll(parambdei.jdField_b_of_type_JavaUtilArrayList);
    }
    localbdei.jdField_b_of_type_JavaUtilArrayList = localArrayList;
    localArrayList = new ArrayList();
    if (parambdei.jdField_c_of_type_JavaUtilArrayList != null) {
      localArrayList.addAll(parambdei.jdField_c_of_type_JavaUtilArrayList);
    }
    localbdei.jdField_c_of_type_JavaUtilArrayList = localArrayList;
    localbdei.jdField_a_of_type_JavaLangObject = parambdei.jdField_a_of_type_JavaLangObject;
    localbdei.jdField_b_of_type_Int = parambdei.jdField_b_of_type_Int;
    localbdei.jdField_a_of_type_Boolean = parambdei.jdField_a_of_type_Boolean;
    localbdei.jdField_b_of_type_Boolean = parambdei.jdField_b_of_type_Boolean;
    localbdei.jdField_c_of_type_Boolean = parambdei.jdField_c_of_type_Boolean;
    localbdei.d = parambdei.d;
    return localbdei;
  }
