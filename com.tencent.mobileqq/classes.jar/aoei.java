  ...
  extends BusinessHandler
{
  ...
  aoei(QQAppInterface paramQQAppInterface)
  {
  ...
  public static void a(int paramInt1, int paramInt2, String paramString, int paramInt3, BaseActivity paramBaseActivity)
  {
    ...
    Object localObject1 = bhnp.a(paramBaseActivity, "theme", "mvip.gongneng.android.theme.index_dynamic_tab");
  ...
  private void a(int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3, ThemeAuth.DiyThemeDetail paramDiyThemeDetail)
  {
    ...
    for (;;)
    {
      ...
      if (!android.text.TextUtils.isEmpty(paramString1))
      {
        ...
        if (paramInt1 == 2) {
          afrb.a(localMobileQQ, this.app.getAccount(), null, str2);
        }
      }
  ...
  private void a(int paramInt, String paramString1, String paramString2, ThemeAuth.SubCmd0x1RspAuth paramSubCmd0x1RspAuth)
  {
    ...
    {
      bdfe.a(bool1, i, paramSubCmd0x1RspAuth, bool2, bool3);
      ...
      try
      {
        paramString1 = new beik().a(paramString1).a(this.mApp.getApplication());
    ...
    {
      if (bool1) {
        bdla.b(null, "CliOper", "", "", "theme", "0X8007234", 0, 0, String.valueOf(i), "", "", "");
      }
      paramSubCmd0x1RspAuth = paramString2;
      if (android.text.TextUtils.isEmpty(paramString2)) {
        paramSubCmd0x1RspAuth = anvx.a(2131714293);
      }
      ...
      for (;;)
      {
        ...
        {
          afrb.a(this.mApp.getApplication(), this.app.getAccount(), null, "null");
  ...
  private void a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      i = 1;
      beil.a(null, "theme_detail", "205", 157, j, i, str1, "20000000", "1", "");
      return;
      ...
      ((ThemeAuth.ReqBody)localObject3).str_qq_version.set("8.4.10.4875");
      ((ThemeAuth.ReqBody)localObject3).uint32_qq_version.set(Integer.parseInt("4875"));
    ...
    for (int i = 1;; i = -1)
    {
      beil.a(null, "theme_sp_speed", "204", 153, -1, i, String.valueOf(l2 - l1), "6653", "read", "");
      if ((paramBundle.isDirectory()) && (localObject1 != null))
      {
        ...
        beil.a(this.app, "theme_detail", "204", 157, NetworkUtil.getSystemNetwork(null), 101, str1, "665", String.valueOf(i), String.valueOf(((ThemeUtil.ThemeInfo)localObject1).fileNum));
        break;
        label967:
  ...
  private void a(ThemeAuth.RspBody paramRspBody)
  {
    ...
    if (i == 0)
    {
      ...
      bdla.b(this.app, "CliOper", "", "", "0X8005B9E", "0X8005B9E", 0, 0, "", "", "", "");
      localMessage = new Message();
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, ThemeAuth.RspBody paramRspBody, boolean paramBoolean)
  {
    ...
    for (paramToServiceMsg = paramToServiceMsg.str_diy_theme_err_msg.get();; paramToServiceMsg = str)
    {
      ...
      if ((this.jdField_a_of_type_Beix != null) && (this.jdField_a_of_type_AndroidOsBundle != null)) {
        break;
      }
      QLog.e("Theme.ThemeHandler", 1, "handleThemeAuth Set result:null == service || null == reqbundle, result:" + i);
      this.jdField_a_of_type_AndroidOsBundle = null;
      this.jdField_a_of_type_Beix = null;
      return true;
    ...
    if ((!android.text.TextUtils.isEmpty(paramRspBody)) && (paramRspBody.equals(this.jdField_a_of_type_AndroidOsBundle.getString("themeId"))))
    {
      ...
      paramToServiceMsg = this.jdField_a_of_type_Beix;
      if (i == 0)
      {
        i = 4;
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, ThemeAuth.SubCmd0x1RspAuth paramSubCmd0x1RspAuth, String paramString1, String paramString2)
  {
    ...
    if (j == 1)
    {
      ...
      bool3 = true;
      label230:
      bdfe.a(bool1, i, paramString1, bool2, bool3);
  ...
  private void b(String paramString1, String paramString2)
  {
    ...
    {
      if (!behh.a(paramString1, paramString2)) {
        a(paramString1, paramString2);
      }
      while (ThemeUtil.isFixTheme(paramString1)) {
        return;
      }
      beio.a(this.app, paramString1, "20000000");
      return;
    }
    a(paramString1, paramString2);
  }
  ...
  public void a()
  {
    ...
    else
    {
      ...
      QLog.d("Theme.ThemeHandler", 1, "sendThemeAuth init: , skThemeId:" + ((Bundle)localObject4).getString("themeId") + ", skVersion:" + ((Bundle)localObject4).getString("version") + ", qqVersion:" + "8.4.10");
      ...
      if (bdfk.a((String)localObject2))
      {
        localObject3 = beio.a(this.app).getString("themeID");
    ...
    for (;;)
    {
      ...
      ((Bundle)localObject4).putString("themePath", new beik().a().d());
    }
    label565:
    Object localObject2 = new beik().a((String)localObject3);
    ((VasQuickUpdateManager)this.app.getManager(QQManagerFactory.VAS_QUICKUPDATE_MANAGER)).queryItemVersion(3, ((beik)localObject2).b(), true, false, 0L, new aoek(this, (beik)localObject2, localMobileQQ, (Bundle)localObject4));
  }
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      return;
      label110:
      ThemeSwitcher.a(paramString1, paramString2, new aoej(this));
    }
  }
  
  /* Error */
  public void a(String paramString1, String paramString2, String paramString3, Bundle paramBundle, beix parambeix)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 7
    ...
    //   86: aload_0
    //   87: aload 5
    //   89: putfield 858	aoei:jdField_a_of_type_Beix	Lbeix;
    //   92: aload_0
    //   93: aload 4
    //   95: putfield 860	aoei:jdField_a_of_type_AndroidOsBundle	Landroid/os/Bundle;
    //   98: new 868	com/tencent/pb/theme/ThemeAuth$SubCmd0x3ReqSet
    //   101: dup
    //   102: invokespecial 1179	com/tencent/pb/theme/ThemeAuth$SubCmd0x3ReqSet:<init>	()V
    //   105: astore_2
    //   106: aload_2
    //   107: getfield 870	com/tencent/pb/theme/ThemeAuth$SubCmd0x3ReqSet:uint32_theme_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   110: aload_1
    //   111: invokestatic 550	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   114: invokevirtual 541	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   117: aload_3
    ...
    //   129: ifne +9 -> 138
    //   132: aload_3
    //   133: invokestatic 550	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   136: istore 6
    //   138: aload_2
    //   139: getfield 1182	com/tencent/pb/theme/ThemeAuth$SubCmd0x3ReqSet:uint32_suit_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   142: iload 6
    //   144: invokevirtual 541	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   147: aload 4
    //   149: ldc_w 1184
    //   152: invokevirtual 1188	android/os/Bundle:getBundle	(Ljava/lang/String;)Landroid/os/Bundle;
    //   155: astore_1
    //   156: aload_1
    //   157: ifnull +9 -> 166
    //   160: aload 4
    //   162: aload_1
    //   163: invokevirtual 732	android/os/Bundle:putAll	(Landroid/os/Bundle;)V
    //   166: ldc_w 1190
    //   169: aload 4
    //   171: ldc_w 1192
    //   174: invokevirtual 529	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   177: invokevirtual 266	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   180: ifeq +277 -> 457
    //   183: new 1194	com/tencent/pb/theme/ThemeAuth$diyThemeInfo
    //   186: dup
    //   187: invokespecial 1195	com/tencent/pb/theme/ThemeAuth$diyThemeInfo:<init>	()V
    //   190: astore_1
    //   191: aload_1
    //   192: getfield 1196	com/tencent/pb/theme/ThemeAuth$diyThemeInfo:uin32_drawer_tab_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   195: aload 4
    //   197: ldc_w 1198
    //   200: invokevirtual 529	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   203: invokestatic 550	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   206: invokevirtual 541	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   209: aload_1
    //   210: getfield 1199	com/tencent/pb/theme/ThemeAuth$diyThemeInfo:uin32_message_tab_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   213: aload 4
    //   215: ldc_w 1201
    //   218: invokevirtual 529	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   221: invokestatic 550	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   224: invokevirtual 541	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   227: aload_1
    //   228: getfield 1202	com/tencent/pb/theme/ThemeAuth$diyThemeInfo:uin32_aio_tab_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   231: aload 4
    //   233: ldc_w 1204
    //   236: invokevirtual 529	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   239: invokestatic 550	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   242: invokevirtual 541	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   245: aload_1
    //   246: getfield 1207	com/tencent/pb/theme/ThemeAuth$diyThemeInfo:uin32_freind_tab_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   249: aload 4
    //   251: ldc_w 1209
    //   254: invokevirtual 529	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   257: invokestatic 550	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   260: invokevirtual 541	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   263: aload_1
    //   264: getfield 1212	com/tencent/pb/theme/ThemeAuth$diyThemeInfo:uin32_dynamics_tab_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   267: aload 4
    //   269: ldc_w 1214
    //   272: invokevirtual 529	android/os/Bundle:getString	(Ljava/lang/String;)Ljava/lang/String;
    //   275: invokestatic 550	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   278: invokevirtual 541	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   281: aload_2
    //   282: getfield 1218	com/tencent/pb/theme/ThemeAuth$SubCmd0x3ReqSet:diy_theme_info	Lcom/tencent/pb/theme/ThemeAuth$diyThemeInfo;
    //   285: aload_1
    //   286: invokevirtual 1219	com/tencent/pb/theme/ThemeAuth$diyThemeInfo:set	(Lcom/tencent/mobileqq/pb/MessageMicro;)V
    //   289: aload_2
    //   290: getfield 1220	com/tencent/pb/theme/ThemeAuth$SubCmd0x3ReqSet:uint32_diy_theme_flag	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   293: iconst_1
    //   294: invokevirtual 541	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    ...
    //   309: iconst_3
    //   310: invokevirtual 541	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   313: aload_1
    //   314: getfield 687	com/tencent/pb/theme/ThemeAuth$ReqBody:int32_plat_id	Lcom/tencent/mobileqq/pb/PBInt32Field;
    //   317: bipush 109
    //   319: invokevirtual 690	com/tencent/mobileqq/pb/PBInt32Field:set	(I)V
    //   322: aload_1
    //   323: getfield 693	com/tencent/pb/theme/ThemeAuth$ReqBody:str_qq_version	Lcom/tencent/mobileqq/pb/PBStringField;
    //   326: ldc_w 695
    //   329: invokevirtual 558	com/tencent/mobileqq/pb/PBStringField:set	(Ljava/lang/String;)V
    //   332: aload_1
    //   333: getfield 698	com/tencent/pb/theme/ThemeAuth$ReqBody:uint32_qq_version	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   336: ldc_w 700
    //   339: invokestatic 550	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   342: invokevirtual 541	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   345: aload_1
    ...
    //   349: aload_2
    //   350: invokevirtual 1221	com/tencent/pb/theme/ThemeAuth$SubCmd0x3ReqSet:set	(Lcom/tencent/mobileqq/pb/MessageMicro;)V
    //   353: aload_1
    //   354: iconst_1
    //   355: invokevirtual 709	com/tencent/pb/theme/ThemeAuth$ReqBody:setHasFlag	(Z)V
    //   358: new 35	com/tencent/qphone/base/remote/ToServiceMsg
    //   361: dup
    //   362: ldc_w 711
    //   365: aload_0
    //   366: getfield 57	aoei:mApp	Lcom/tencent/common/app/AppInterface;
    //   369: invokevirtual 714	com/tencent/common/app/AppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   372: ldc_w 716
    //   375: invokespecial 719	com/tencent/qphone/base/remote/ToServiceMsg:<init>	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   378: astore_2
    //   379: aload_2
    //   380: aload_1
    //   381: invokevirtual 722	com/tencent/pb/theme/ThemeAuth$ReqBody:toByteArray	()[B
    //   384: invokevirtual 726	com/tencent/qphone/base/remote/ToServiceMsg:putWupBuffer	([B)V
    //   387: aload_0
    //   388: aload_2
    //   389: invokespecial 738	com/tencent/mobileqq/app/BusinessHandler:sendPbReq	(Lcom/tencent/qphone/base/remote/ToServiceMsg;)V
    ...
    //   425: aload_1
    //   426: invokevirtual 1226	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   443: ldc_w 1228
    //   446: aload_1
    //   447: invokestatic 1231	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   450: iload 7
    //   452: istore 6
    //   454: goto -316 -> 138
    //   457: aload_2
    //   458: getfield 1220	com/tencent/pb/theme/ThemeAuth$SubCmd0x3ReqSet:uint32_diy_theme_flag	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   461: iconst_0
    //   462: invokevirtual 541	com/tencent/mobileqq/pb/PBUInt32Field:set	(I)V
    //   465: goto -168 -> 297
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramString1.str_qq_version.set("8.4.10.4875");
        paramString1.uint32_qq_version.set(Integer.parseInt("4875"));
  ...
  public void onReceive(ToServiceMsg paramToServiceMsg, com.tencent.qphone.base.remote.FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    //   0: ldc_w 716
    //   3: aload_2
    //   4: invokevirtual 1264	com/tencent/qphone/base/remote/FromServiceMsg:getServiceCmd	()Ljava/lang/String;
    ...
    //   36: aload_2
    //   37: invokevirtual 1269	com/tencent/qphone/base/remote/FromServiceMsg:isSuccess	()Z
    ...
    //   50: checkcast 1273	[B
    //   53: checkcast 1273	[B
    //   56: invokestatic 1279	com/tencent/mobileqq/utils/httputils/PkgTools:toHexStr	([B)Ljava/lang/String;
    ...
    //   71: dup
    //   72: invokespecial 1280	com/tencent/pb/theme/ThemeAuth$RspBody:<init>	()V
    //   75: astore 7
    //   77: aload_3
    //   78: ifnull +16 -> 94
    //   81: aload 7
    ...
    //   84: checkcast 1273	[B
    //   87: checkcast 1273	[B
    //   90: invokevirtual 1283	com/tencent/pb/theme/ThemeAuth$RspBody:mergeFrom	([B)Lcom/tencent/mobileqq/pb/MessageMicro;
    //   93: pop
    //   94: aload 7
    //   96: getfield 1284	com/tencent/pb/theme/ThemeAuth$RspBody:uint32_sub_cmd	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   99: invokevirtual 1287	com/tencent/mobileqq/pb/PBUInt32Field:has	()Z
    //   102: ifeq +601 -> 703
    //   105: aload 7
    //   107: getfield 1284	com/tencent/pb/theme/ThemeAuth$RspBody:uint32_sub_cmd	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    //   110: invokevirtual 53	com/tencent/mobileqq/pb/PBUInt32Field:get	()I
    //   113: istore 4
    //   115: aload_2
    //   116: invokevirtual 1269	com/tencent/qphone/base/remote/FromServiceMsg:isSuccess	()Z
    //   119: ifeq +590 -> 709
    //   122: aload_3
    //   123: ifnull +586 -> 709
    //   126: iconst_1
    ...
    //   139: aload_1
    //   140: iload 4
    //   142: invokespecial 1289	aoei:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;I)I
    //   145: istore 5
    //   147: ldc 138
    //   149: iconst_1
    ...
    //   163: aload_3
    //   164: checkcast 1273	[B
    //   167: checkcast 1273	[B
    //   170: invokestatic 1279	com/tencent/mobileqq/utils/httputils/PkgTools:toHexStr	([B)Ljava/lang/String;
    ...
    //   205: aload 7
    //   207: getfield 1297	com/tencent/pb/theme/ThemeAuth$RspBody:msg_subcmd0x1_rsp_auth	Lcom/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth;
    //   210: invokevirtual 1298	com/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   213: checkcast 345	com/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth
    //   216: astore_2
    //   217: aload_2
    //   218: getfield 1299	com/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth:int32_result	Lcom/tencent/mobileqq/pb/PBInt32Field;
    ...
    //   250: pop
    //   251: aload_3
    //   252: getfield 704	com/tencent/pb/theme/ThemeAuth$ReqBody:msg_subcmd0x1_req_auth	Lcom/tencent/pb/theme/ThemeAuth$SubCmd0x1ReqAuth;
    //   255: invokevirtual 1300	com/tencent/pb/theme/ThemeAuth$SubCmd0x1ReqAuth:get	()Lcom/tencent/mobileqq/pb/MessageMicro;
    //   258: checkcast 533	com/tencent/pb/theme/ThemeAuth$SubCmd0x1ReqAuth
    //   261: astore 8
    //   263: aload 8
    //   265: getfield 544	com/tencent/pb/theme/ThemeAuth$SubCmd0x1ReqAuth:uint32_theme_id	Lcom/tencent/mobileqq/pb/PBUInt32Field;
    ...
    //   274: astore_3
    //   275: aload 8
    //   277: getfield 553	com/tencent/pb/theme/ThemeAuth$SubCmd0x1ReqAuth:str_theme_version	Lcom/tencent/mobileqq/pb/PBStringField;
    ...
    //   338: aload_0
    //   339: getfield 325	aoei:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   342: ldc_w 1304
    //   345: iload 4
    ...
    //   355: aconst_null
    //   356: fconst_0
    //   357: invokestatic 1309	bhpe:a	(Lmqq/app/AppRuntime;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;F)V
    ...
    //   382: pop
    //   383: invokestatic 567	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   386: invokestatic 1315	com/tencent/mobileqq/statistics/StatisticCollector:getInstance	(Landroid/content/Context;)Lcom/tencent/mobileqq/statistics/StatisticCollector;
    //   389: ldc_w 289
    //   392: ldc_w 1304
    //   395: iconst_0
    //   396: lconst_0
    ...
    //   402: ldc_w 289
    //   405: iconst_1
    //   406: invokevirtual 1321	com/tencent/mobileqq/statistics/StatisticCollector:collectPerformance	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   409: aload_0
    //   410: getfield 325	aoei:app	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   413: ldc_w 676
    //   416: ldc_w 752
    //   419: sipush 157
    //   422: aconst_null
    //   423: invokestatic 674	com/tencent/mobileqq/utils/NetworkUtil:getSystemNetwork	(Landroid/content/Context;)I
    //   426: iconst_0
    //   427: iload 4
    //   429: isub
    //   430: aload_3
    ...
    //   433: ldc_w 410
    //   436: ldc_w 289
    //   439: invokestatic 683	beil:a	(Lmqq/app/AppRuntime;Ljava/lang/String;Ljava/lang/String;IIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   485: pop
    //   486: aload_0
    //   487: getfield 57	aoei:mApp	Lcom/tencent/common/app/AppInterface;
    //   490: invokevirtual 249	com/tencent/common/app/AppInterface:getApplication	()Lmqq/app/MobileQQ;
    //   493: invokestatic 1315	com/tencent/mobileqq/statistics/StatisticCollector:getInstance	(Landroid/content/Context;)Lcom/tencent/mobileqq/statistics/StatisticCollector;
    //   496: astore 10
    //   498: aload_0
    //   499: getfield 57	aoei:mApp	Lcom/tencent/common/app/AppInterface;
    ...
    //   528: ldc_w 289
    //   531: iconst_0
    //   532: invokevirtual 1321	com/tencent/mobileqq/statistics/StatisticCollector:collectPerformance	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   535: iload 4
    //   537: iconst_1
    ...
    //   561: aload_0
    //   562: getfield 57	aoei:mApp	Lcom/tencent/common/app/AppInterface;
    ...
    //   588: pop
    //   589: aload_0
    //   590: getfield 57	aoei:mApp	Lcom/tencent/common/app/AppInterface;
    //   593: ldc_w 364
    //   596: ldc_w 340
    //   599: invokestatic 1334	com/tencent/mobileqq/theme/ThemeUtil:setCurrentThemeIdVersion	(Lmqq/app/AppRuntime;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Boolean;
    //   602: pop
    //   603: aload 7
    //   605: getfield 1297	com/tencent/pb/theme/ThemeAuth$RspBody:msg_subcmd0x1_rsp_auth	Lcom/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth;
    //   608: getfield 1337	com/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth:str_err_msg	Lcom/tencent/mobileqq/pb/PBStringField;
    ...
    //   666: aload_1
    //   667: aload_2
    //   668: invokespecial 1343	aoei:a	(ILjava/lang/String;Ljava/lang/String;Lcom/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth;)V
    //   671: return
    //   672: astore_1
    //   673: ldc 138
    //   675: iconst_1
    ...
    //   769: aload 9
    //   771: invokevirtual 1226	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   794: aload_3
    //   795: aload 8
    //   797: invokespecial 1351	aoei:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/pb/theme/ThemeAuth$SubCmd0x1RspAuth;Ljava/lang/String;Ljava/lang/String;)Z
    //   800: ifeq -787 -> 13
    //   803: return
    //   804: ldc 138
    //   806: iconst_1
    ...
    //   833: aconst_null
    //   834: iconst_1
    //   835: invokevirtual 1021	aoei:a	(Ljava/lang/String;Ljava/lang/String;Z)V
    //   838: return
    //   839: iconst_2
    //   840: iload 5
    ...
    //   845: aload_0
    //   846: aload 7
    //   848: invokespecial 1355	aoei:a	(Lcom/tencent/pb/theme/ThemeAuth$RspBody;)V
    //   851: return
    //   852: iconst_3
    //   853: iload 5
    ...
    //   860: aload 7
    //   862: iload 6
    //   864: invokespecial 1357	aoei:a	(Lcom/tencent/qphone/base/remote/ToServiceMsg;Lcom/tencent/pb/theme/ThemeAuth$RspBody;Z)Z
    //   867: ifeq -854 -> 13
    //   870: return
    //   871: ldc 138
    //   873: iconst_1
