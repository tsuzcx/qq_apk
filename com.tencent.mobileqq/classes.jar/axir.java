  ...
  implements azla
{
  ...
  public axir(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, String paramString, int paramInt, ArrayList<MessageRecord> paramArrayList, HashMap<String, String> paramHashMap)
  {
  ...
  public void onSend(azlb paramazlb)
  {
    if (paramazlb.jdField_a_of_type_Int == 0) {
      if (QLog.isColorLevel()) {
        QLog.d("MultiMsg_TAG", 2, "send real struct msg for weixin done, cost : " + (System.currentTimeMillis() - axio.b()));
      }
    }
    for (;;)
    {
      ...
      try
      {
        ...
        {
          str1 = String.format(((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getApplication().getString(2131694146), new Object[] { ContactUtils.getNick((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Int) });
          continue;
        }
        ...
        l = paramazlb.c.hashCode();
        paramazlb = this.jdField_a_of_type_JavaUtilArrayList.iterator();
        if (paramazlb.hasNext())
        {
          ((MessageRecord)paramazlb.next()).msgseq = l;
          continue;
        }
      ...
      {
        paramazlb.printStackTrace();
        return;
      }
      axio.a().a(this.jdField_a_of_type_JavaUtilHashMap, l, (QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get());
