...
public class uep
{
  private List<uho> jdField_a_of_type_JavaUtilList;
  ...
  private boolean a(JceStruct paramJceStruct, String paramString, int paramInt)
  {
    ...
    boolean bool = bhmi.a(arrayOfByte, paramString, false);
    paramString = new StringBuilder().append("write cache to ").append(paramString);
    if (bool) {}
    for (paramJceStruct = " succeed";; paramJceStruct = " failed")
    {
      uqf.d("WeiShiCacheManager", paramJceStruct + ", cache list size = " + paramInt + ", bytes length = " + arrayOfByte.length);
      return bool;
    }
  }
  ...
  private String d()
  {
    return BaseApplicationImpl.getApplication().getCacheDir().getAbsolutePath() + "/file/weishi/ws_follow_data_" + uqt.a();
  }
  ...
  {
    ThreadManager.post(new WeiShiCacheManager.1(this, paramuel), 8, null, true);
  }
  ...
  public boolean a()
  {
    ...
    long l3 = l1 - l2;
    uqf.d("WeiShiCacheManager", "validTimestamp-currentTimestamp = " + l1 + "-" + l2 + " = " + l3);
    return l3 > 0L;
  }
  ...
  public void b(uel paramuel)
  {
    ThreadManager.post(new WeiShiCacheManager.2(this, new WeakReference(paramuel)), 8, null, true);
  }
  ...
  public void c(List<uho> paramList)
  {
    if (this.jdField_a_of_type_JavaUtilList == null) {
  ...
  public void c(uel paramuel)
  {
    ThreadManager.executeOnFileThread(new WeiShiCacheManager.9(this, paramuel));
  }
}
