  ...
  implements Manager
{
  ...
  private apxc jdField_a_of_type_Apxc = new aqbc(this);
  private apyc jdField_a_of_type_Apyc;
  aqbq jdField_a_of_type_Aqbq;
  aqbz jdField_a_of_type_Aqbz;
  public aqca a;
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  public String a;
  private WeakReference<aqbg> jdField_a_of_type_JavaLangRefWeakReference;
  ...
  public aqbb(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Aqca = new aqbd(this);
  ...
  public static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    Card localCard = ((aloz)paramQQAppInterface.getManager(51)).a(paramQQAppInterface.getCurrentAccountUin());
    int i;
    if (localCard == null)
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, ArrayList<apyr> paramArrayList)
  {
    if (paramQQAppInterface == null) {
    ...
    {
      return;
      paramArrayList = apyr.a(paramArrayList);
      paramQQAppInterface = paramQQAppInterface.getApp().getSharedPreferences(paramQQAppInterface.getCurrentAccountUin(), 0).edit();
  ...
  private void d()
  {
    ...
    do
    {
      ...
      try
      {
        ...
        Object localObject3 = ((amjk)localObject1).a(false);
        ...
        if ((localObject3 != null) && (((List)localObject3).size() > 0))
        {
          ...
          while (((Iterator)localObject3).hasNext())
          {
            ...
            if ((localRecentUser.getType() == 1044) && (!localRecentUser.uin.equals(aljq.aU))) {
  ...
  public aqbq a()
  {
    if (this.jdField_a_of_type_Aqbq != null) {
      return this.jdField_a_of_type_Aqbq;
    }
    synchronized (jdField_b_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_Aqbq != null)
      {
        aqbq localaqbq1 = this.jdField_a_of_type_Aqbq;
        return localaqbq1;
      }
    }
    this.jdField_a_of_type_Aqbq = new aqbq(this);
    aqbq localaqbq2 = this.jdField_a_of_type_Aqbq;
    return localaqbq2;
  }
  ...
  public aqbz a()
  {
    if (this.jdField_a_of_type_Aqbz != null) {
      return this.jdField_a_of_type_Aqbz;
    }
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      if (this.jdField_a_of_type_Aqbz != null)
      {
        aqbz localaqbz1 = this.jdField_a_of_type_Aqbz;
        return localaqbz1;
      }
    }
    this.jdField_a_of_type_Aqbz = new aqbz(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    this.jdField_a_of_type_Aqbz.a(this.jdField_a_of_type_Aqca);
    aqbz localaqbz2 = this.jdField_a_of_type_Aqbz;
    return localaqbz2;
  }
  
  public String a()
  {
    if (this.jdField_a_of_type_Apyc != null) {
      return this.jdField_a_of_type_Apyc.jdField_b_of_type_JavaLangString;
    }
    return "";
  }
  ...
  public void a()
  {
    this.jdField_a_of_type_Apyc = null;
  }
  ...
  public void a(aqbg paramaqbg)
  {
    ...
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramaqbg);
  }
  ...
  public void a(boolean paramBoolean, apyb paramapyb)
  {
  ...
  public boolean a(Context paramContext)
  {
    ...
    if ((!this.jdField_c_of_type_Boolean) && (this.jdField_d_of_type_Boolean))
    {
      if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
        this.jdField_b_of_type_JavaLangString = paramContext.getString(2131699706);
      }
      if (TextUtils.isEmpty(this.jdField_c_of_type_JavaLangString)) {
        this.jdField_c_of_type_JavaLangString = paramContext.getString(2131699704);
      }
      if (TextUtils.isEmpty(this.jdField_d_of_type_JavaLangString)) {
        this.jdField_d_of_type_JavaLangString = "https://ti.qq.com/realname/index.html";
      }
      paramContext = bdcd.a(paramContext, 230, this.jdField_b_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString, paramContext.getString(2131699705), paramContext.getString(2131699707), new aqbe(this, paramContext), new aqbf(this));
  ...
  public void onDestroy()
  {
    if (this.jdField_a_of_type_Aqbz != null)
    {
      this.jdField_a_of_type_Aqbz.b();
      this.jdField_a_of_type_Aqbz = null;
    }
