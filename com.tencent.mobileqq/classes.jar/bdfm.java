...
class bdfm
{
  ...
  bdfm(LoadParam paramLoadParam, LoadParam.LoadItem paramLoadItem)
  {
  ...
  static int a()
  {
    ...
    try
    {
      int i = aqxe.a().a(526, ((QQAppInterface)localAppRuntime).getLongAccountUin());
      return i;
    }
  ...
  protected static boolean a(@NonNull bdgs parambdgs)
  {
    return (!TextUtils.isEmpty(parambdgs.c)) && (new File(parambdgs.c).exists());
  }
  
  protected static boolean a(@NonNull bdgs parambdgs, @NonNull SoConfig.SoDetailInfo paramSoDetailInfo)
  {
    return (paramSoDetailInfo.relatedFileInfo == null) || ((!TextUtils.isEmpty(parambdgs.f)) && (new File(parambdgs.f).exists()));
  }
  ...
  boolean a(SoConfig.SoInfo paramSoInfo)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      if (QLog.isColorLevel()) {
        QLog.i("SoLoadWidget.AbsGetSoTask", 2, "[initConfig] isConfValid=" + bool + ",info:" + paramSoInfo + ",is64:" + bdgg.a());
      }
      return bool;
