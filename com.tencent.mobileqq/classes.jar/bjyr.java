...
public class bjyr
{
  public static int a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    if (ShortVideoTrimmer.a(paramContext, 0, 0))
    {
      ...
      {
        i = j;
        if (((azgw)localObject).jdField_a_of_type_Boolean)
        {
          ...
          localObject = new bjys(paramString2, (int)(((azgw)localObject).b * 1024L), (int)((azgw)localObject).jdField_a_of_type_Long);
          if ((!new azhl().a(localFile, (azhm)localObject, true)) || (((bjys)localObject).a != null)) {
            break label339;
          }
          if (QLog.isColorLevel()) {
  ...
  public static int a(JSONObject paramJSONObject, String paramString1, String paramString2)
  {
    ...
    //   327: astore_1
    //   328: aload_1
    //   329: invokevirtual 279	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   332: astore 4
    //   334: aload 4
    //   336: ifnull +130 -> 466
    //   339: aload 5
    //   341: aload 4
    //   343: invokevirtual 282	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   346: ldc_w 284
    //   349: invokevirtual 282	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   352: pop
    //   353: goto -25 -> 328
    //   356: astore 4
    //   358: aload_0
    ...
    //   362: aload 4
    //   364: astore_2
    //   365: invokestatic 44	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   368: ifeq +13 -> 381
    //   371: ldc 46
    //   373: iconst_2
    //   374: ldc_w 286
    //   377: aload_2
    //   378: invokestatic 289	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   381: aload_1
    //   382: ifnull +7 -> 389
    //   385: aload_1
    //   386: invokevirtual 257	java/net/HttpURLConnection:disconnect	()V
    //   389: aload_0
    //   390: ifnull +258 -> 648
    //   393: aload_0
    //   394: invokevirtual 254	java/io/DataOutputStream:close	()V
    //   397: iconst_m1
    //   398: istore_3
    //   399: iload_3
    //   400: ireturn
    //   401: astore 4
    //   403: aload_1
    //   404: invokevirtual 258	java/io/BufferedInputStream:close	()V
    //   407: aload 4
    //   409: athrow
    //   410: astore 4
    //   412: aload_0
    ...
    //   420: aload_1
    //   421: astore 5
    //   423: invokestatic 44	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   426: ifeq +19 -> 445
    //   429: aload_2
    //   430: astore 4
    //   432: aload_1
    ...
    //   438: ldc_w 286
    //   441: aload_0
    //   442: invokestatic 289	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   445: aload_1
    //   446: ifnull +7 -> 453
    //   449: aload_1
    //   450: invokevirtual 257	java/net/HttpURLConnection:disconnect	()V
    //   453: aload_2
    //   454: ifnull +194 -> 648
    //   457: aload_2
    //   458: invokevirtual 254	java/io/DataOutputStream:close	()V
    //   461: iconst_m1
    //   462: istore_3
    //   463: goto -64 -> 399
    //   466: aload 5
    //   468: invokevirtual 290	java/lang/StringBuffer:toString	()Ljava/lang/String;
    //   471: pop
    //   472: aload_1
  ...
  public static String a(String paramString)
  {
    ...
    //   1: astore 5
    //   3: aload_0
    //   4: invokestatic 293	bjyr:b	(Ljava/lang/String;)Ljava/lang/String;
    //   7: astore 6
  ...
  public static JSONObject a(AppRuntime paramAppRuntime, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (localObject = ((TicketManager)localObject).getSkey(paramAppRuntime.getAccount());; localObject = null)
    {
      ...
      localBundle.putString("bkn", String.valueOf(bclo.b((String)localObject)));
  ...
  public static String b(String paramString)
  {
    ...
    for (;;)
    {
      return bduw.a(((StringBuilder)localObject).toString());
