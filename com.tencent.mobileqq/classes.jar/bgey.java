...
public abstract class bgey
  implements DownloadParams.DecodeHandler
{
  public static final DownloadParams.DecodeHandler A = new bgfp();
  ...
  static
  {
    ...
    jdField_a_of_type_ComTencentImageDownloadParams$DecodeHandler = new bgez();
    b = new bgfk();
    c = new bgfq();
    d = new bgfr();
    e = new bgfs();
