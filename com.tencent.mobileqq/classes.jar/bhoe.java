...
public class bhoe
{
  ...
  public static ArrayList<bhof> a(String paramString)
  {
  ...
  public static ArrayList<bhof> a(JSONArray paramJSONArray)
  {
    Object localObject2;
    ...
    for (;;)
    {
      ...
      try
      {
        if (i < paramJSONArray.length())
        {
          ...
          {
            localArrayList.add(new bhof(str1));
            localObject2 = str1;
          }
          localArrayList.add(new bhof(str1, str3, str2, str4));
          i += 1;
  ...
  public static LinkedHashMap<String, Integer> a(String[] paramArrayOfString, List<bhof> paramList)
  {
    int j = 0;
    ...
    {
      bhof localbhof = (bhof)paramList.next();
      if (localLinkedHashMap.containsKey(localbhof.jdField_a_of_type_JavaLangString))
      {
        i += 1;
      }
      else
      {
        localLinkedHashMap.put(localbhof.jdField_a_of_type_JavaLangString, Integer.valueOf(i));
        i += 1;
      }
    }
