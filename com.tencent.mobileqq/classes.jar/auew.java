...
public class auew
  extends aueo
{
  private static final String b = bayb.a(aufb.jdField_a_of_type_JavaLangString + "shortvideo" + File.separator);
  ...
  public auew(MsgBackupResEntity paramMsgBackupResEntity)
  {
  ...
  public aucn a()
  {
    ...
    localaucn.jdField_a_of_type_JavaLangString = str1;
    if ((!bool1) && (!bool2)) {}
