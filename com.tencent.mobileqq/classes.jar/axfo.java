  ...
  extends bahv
{
  ...
  public axfo(Context paramContext)
  {
    super(paramContext);
  ...
  private void a(View paramView)
  {
    ...
    {
      this.jdField_a_of_type_Axdv = this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.b().a().a();
      paramView = (RelativeLayout)paramView.findViewById(2131297339);
      if ((this.jdField_a_of_type_Axdv == null) || (!this.jdField_a_of_type_Axdv.jdField_a_of_type_Boolean)) {
        break label372;
      }
      paramView.setVisibility(0);
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131312235));
      this.jdField_c_of_type_AndroidWidgetTextView.setOnClickListener(new axfp(this));
      if (this.jdField_a_of_type_Axdv.jdField_c_of_type_Int != 1) {
        break label269;
      }
      this.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.getText(2131624720));
    }
    for (;;)
    {
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131309799));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131312235));
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131312233));
      this.jdField_d_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor("#000000"));
      if (this.jdField_a_of_type_Axdv.jdField_c_of_type_Int == 2) {
        this.jdField_d_of_type_AndroidWidgetTextView.setTextColor(Color.parseColor("#fe6c6c"));
      }
      this.jdField_d_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Axdv.jdField_a_of_type_JavaLangString);
      this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131312234));
      this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131302879));
      if (2 != this.jdField_a_of_type_Axdv.jdField_c_of_type_Int) {
        break label322;
      }
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Axdv.b)) {
        break;
      }
      ...
      label269:
      if (this.jdField_a_of_type_Axdv.jdField_c_of_type_Int == 2) {
        this.jdField_c_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.getText(2131624239));
      }
    }
    this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_e_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_Axdv.b);
    return;
    label322:
    if (TextUtils.isEmpty(this.jdField_a_of_type_Axdv.f))
    {
      this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(8);
      return;
    }
    this.jdField_e_of_type_AndroidWidgetTextView.setVisibility(0);
    a(this.jdField_a_of_type_Axdv.f, this.jdField_a_of_type_Axdv.jdField_d_of_type_Int);
    return;
    label372:
  ...
  protected View a()
  {
    View localView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2131496895, null);
    a(localView);
    ...
    for (int j = 0;; j = 1)
    {
      ...
      for (int k = 0;; k = 1)
      {
        ...
        if (j != 0)
        {
          ...
          {
            if (((bahx)((Iterator)localObject4).next()).jdField_d_of_type_Int != 0) {
              break label951;
            }
            i += 1;
          }
        ...
        for (;;)
        {
          ...
          if (k != 0)
          {
            ...
            {
              if (((bahx)((Iterator)localObject1).next()).jdField_d_of_type_Int != 0) {
                break label948;
              }
              i += 1;
            }
          ...
          for (;;)
          {
            ...
            ((TextView)localObject1).setOnClickListener(new axfq(this));
            if (j == 0) {
  ...
  {
    super.a(new axfr(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity, this.jdField_a_of_type_ComTencentSmttSdkWebView, this.jdField_a_of_type_ComTencentMobileqqTeamworkTeamWorkFileImportInfo, paramOnItemClickListener));
  }
  ...
  {
    String str = this.jdField_a_of_type_Axdv.g;
    if (paramInt == 0)
    {
      this.jdField_e_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityQQBrowserActivity.getString(2131654213));
      return;
    }
