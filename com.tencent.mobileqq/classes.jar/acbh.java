...
public class acbh
  extends Handler
{
  public acbh(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity) {}
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            if (this.a.jdField_c_of_type_JavaUtilHashMap.containsKey(paramMessage.e))
            {
              ...
              this.a.jdField_c_of_type_JavaUtilHashMap.put(paramMessage.e, Integer.valueOf(i));
              break label444;
              if ((this.a.b != 1) || (((TroopManager)this.a.app.getManager(51)).b(this.a.jdField_d_of_type_JavaLangString, paramMessage.e) == null)) {
                break label1245;
              }
              i = 2;
              continue;
            ...
            paramMessage = this.a.getResources().getString(2131437905);
