...
public class acbh
  extends alox
{
  public acbh(AssociatedAccountManageActivity paramAssociatedAccountManageActivity) {}
  ...
  protected void onUpdateFriendInfo(String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if (localView != null)
      {
        ((SingleLineTextView)localView.findViewById(2131370958)).setText(bdbt.h(this.a.app, paramString));
        a(paramString, localView);
      }
      localView = AssociatedAccountManageActivity.a(this.a, paramString, 1);
    } while (localView == null);
