...
public class bbyk
  implements bceo
{
  protected bbyk(bbyj parambbyj) {}
  
  public void a(Exception paramException)
  {
    bcds.c("OpenSdkFriendService", "CheckAvatarUpdate Exception. " + paramException.getMessage(), paramException);
  }
  ...
  public void a(JSONObject paramJSONObject)
  {
    try
    {
      ...
      if (i == 0)
      {
        ...
        localObject = bcjl.a(bbtm.a().a(), "prefer_last_avatar_update_time").edit();
      ...
      {
        bcds.e("OpenSdkFriendService", "CheckAvatarUpdateCallback error. ret=" + i + ", msg=" + (String)localObject);
        return;
      }
    }
    catch (JSONException paramJSONObject)
    {
      bcds.c("OpenSdkFriendService", "CheckAvatarUpdate Exception. " + paramJSONObject.getMessage(), paramJSONObject);
    }
  }
}
