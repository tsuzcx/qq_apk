  ...
  implements View.OnClickListener
{
  ...
  public yxr(Context paramContext, ApolloGameViewBinder paramApolloGameViewBinder)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramViewGroup = new yxt(null);
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidViewViewGroup[0] = ((ViewGroup)paramView.findViewById(2131363149));
      paramViewGroup.jdField_a_of_type_ArrayOfComTencentImageURLImageView[0] = ((URLImageView)paramView.findViewById(2131363150));
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetTextView[0] = ((TextView)paramView.findViewById(2131363152));
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetImageView[0] = ((ImageView)paramView.findViewById(2131363151));
      ...
      paramViewGroup.b[0] = ((ImageView)paramView.findViewById(2131363153));
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidViewViewGroup[1] = ((ViewGroup)paramView.findViewById(2131363154));
      paramViewGroup.jdField_a_of_type_ArrayOfComTencentImageURLImageView[1] = ((URLImageView)paramView.findViewById(2131363155));
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetTextView[1] = ((TextView)paramView.findViewById(2131363157));
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetImageView[1] = ((ImageView)paramView.findViewById(2131363156));
      ...
      paramViewGroup.b[1] = ((ImageView)paramView.findViewById(2131363158));
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidViewViewGroup[2] = ((ViewGroup)paramView.findViewById(2131363159));
      paramViewGroup.jdField_a_of_type_ArrayOfComTencentImageURLImageView[2] = ((URLImageView)paramView.findViewById(2131363160));
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetTextView[2] = ((TextView)paramView.findViewById(2131363162));
      paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetImageView[2] = ((ImageView)paramView.findViewById(2131363161));
      ...
      paramViewGroup.b[2] = ((ImageView)paramView.findViewById(2131363163));
    ...
    for (Object localObject1 = ApolloGameViewBinder.a((ApolloGameViewBinder)localObject1);; localObject1 = null)
    {
      ...
      for (;;)
      {
        ...
        {
          paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetImageView[j].setImageResource(2130838075);
        ...
        for (;;)
        {
          if (i != 0)
          {
            localObject2 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130846051);
            ...
            ((URLDrawable.URLDrawableOptions)localObject3).mLoadingDrawable = ((Resources)localObject2).getDrawable(2130838118);
            ((URLDrawable.URLDrawableOptions)localObject3).mFailedDrawable = ((Resources)localObject2).getDrawable(2130838118);
          ...
          for (;;)
          {
            if ((i < ApolloGameUtil.a()) && (this.jdField_a_of_type_JavaLangRefWeakReference != null) && (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null) && (((ApolloGameViewBinder)this.jdField_a_of_type_JavaLangRefWeakReference.get()).a(localApolloGameData.gameId)) && (paramViewGroup.b[j].getVisibility() != 0))
            {
              ...
              if (ApolloGameViewBinder.jdField_a_of_type_Boolean)
              {
                ...
                ((ImageView)localObject2).postDelayed(new yxs(this, (ImageView)localObject2), 200L);
              }
            }
            for (;;)
            {
              j += 1;
              break label386;
              paramViewGroup = (yxt)paramView.getTag();
              break;
              if ((localApolloGameRedDot != null) && (!localApolloGameRedDot.mIsShow))
              {
                i = 1;
                paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetImageView[j].setImageResource(2130838079);
                paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetImageView[j].setVisibility(0);
                break label589;
              }
              ...
              {
                i = 1;
                paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetImageView[j].setImageResource(2130838049);
                paramViewGroup.jdField_a_of_type_ArrayOfAndroidWidgetImageView[j].setVisibility(0);
                break label589;
              }
              ...
              break label680;
              paramViewGroup.jdField_a_of_type_ArrayOfComTencentImageURLImageView[j].setImageResource(2130838118);
              break label773;
  ...
  public void onClick(View paramView)
  {
    ...
    if (localApolloGameViewBinder != null) {
      if (ApolloGameViewBinder.a(localApolloGameViewBinder) != null) {
        if (paramView.getId() == 2131363149) {
          paramView = paramView.findViewById(2131363153);
        }
      }
    }
    for (;;)
    {
      ...
      {
        break label218;
        if (paramView.getId() == 2131363154)
        {
          paramView = paramView.findViewById(2131363158);
          break;
        }
        if (paramView.getId() != 2131363159) {
          break label400;
        }
