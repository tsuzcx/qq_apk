...
public class yxr
{
  ...
  private static MessageMicro a(MessageMicro paramMessageMicro, JSONObject paramJSONObject)
  {
    ...
    //   8: invokestatic 22	yxr:c	(Ljava/lang/Class;)Z
    //   11: ifeq +14 -> 25
    //   14: aload_1
    //   15: ifnull +10 -> 25
    //   18: aload_1
    ...
    //   25: ldc 30
    //   27: ldc 32
    //   29: invokestatic 38	yxs:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   32: aconst_null
    //   33: areturn
    //   34: aload_0
    ...
    //   80: ldc 30
    //   82: ldc 71
    //   84: invokestatic 38	yxs:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   87: goto -40 -> 47
    //   90: astore_0
    //   91: ldc 30
    //   93: ldc 73
    //   95: aload_0
    //   96: invokestatic 76	yxs:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   99: aconst_null
    //   100: areturn
    //   101: astore_0
    //   102: ldc 30
    //   104: ldc 73
    //   106: aload_0
    //   107: invokestatic 76	yxs:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   110: aconst_null
    //   111: areturn
    //   112: aload_1
    //   113: aload 5
    ...
    //   178: ldc 30
    //   180: ldc 71
    //   182: invokestatic 38	yxs:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   185: goto -138 -> 47
    //   188: astore 4
    //   190: ldc 30
    //   192: ldc 73
    //   194: aload 4
    //   196: invokestatic 76	yxs:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   199: goto -152 -> 47
    //   202: astore 4
    //   204: ldc 30
    //   206: ldc 73
    //   208: aload 4
    //   210: invokestatic 76	yxs:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   213: goto -166 -> 47
    //   216: astore 4
    //   218: ldc 30
    //   220: ldc 73
    //   222: aload 4
    //   224: invokestatic 76	yxs:d	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   227: goto -180 -> 47
    //   230: ldc 97
    //   232: aload 5
    ...
    //   240: aload 4
    //   242: invokestatic 100	yxr:a	(Lcom/tencent/mobileqq/pb/PBField;Ljava/lang/Object;)Lcom/tencent/mobileqq/pb/PBField;
    //   245: astore 4
    //   247: aload 4
    //   249: ifnonnull +13 -> 262
    //   252: ldc 30
    //   254: ldc 71
    //   256: invokestatic 38	yxs:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   259: goto -212 -> 47
    //   262: aload 5
    //   264: aload 4
    //   266: invokestatic 102	yxr:a	(Ljava/lang/Object;)Ljava/lang/Object;
    //   269: aload 5
    //   271: invokevirtual 18	java/lang/Object:getClass	()Ljava/lang/Class;
    //   274: invokestatic 105	yxr:a	(Ljava/lang/Class;)Ljava/lang/Class;
    //   277: invokestatic 108	yxr:a	(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Class;)V
    //   280: goto -233 -> 47
    //   283: aload_0
    //   284: instanceof 110
    //   287: ifeq +13 -> 300
    ...
    //   300: ldc 30
    //   302: ldc 71
    //   304: invokestatic 38	yxs:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   307: aconst_null
    //   308: areturn
  ...
  public static PBField a(PBField paramPBField, Object paramObject)
  {
    ...
    {
      yxs.d("GdtJsonPbUtil", "pbFromJson error");
      return null;
    }
  ...
  private static PBField a(PBField paramPBField, JSONArray paramJSONArray)
  {
    ...
    {
      yxs.d("GdtJsonPbUtil", "pbRepeatFromJsonArray error");
      return null;
    }
    try
    {
    ...
    catch (NoSuchFieldException localNoSuchFieldException1)
    {
      for (;;)
      {
        ...
        boolean bool;
        paramPBField = null;
        yxs.d("GdtJsonPbUtil", "getClassOfPBArray", localNoSuchFieldException1);
      }
    }
    catch (IllegalAccessException localIllegalAccessException1)
    {
      for (;;)
      {
        label77:
        paramPBField = null;
        yxs.d("GdtJsonPbUtil", "getClassOfPBArray", localIllegalAccessException1);
        continue;
        ...
        catch (InstantiationException paramPBField)
        {
          for (;;)
          {
            yxs.d("GdtJsonPbUtil", "getClassOfPBArray", paramPBField);
            paramPBField = null;
          }
        }
      ...
      for (;;)
      {
        ...
        {
          yxs.d("GdtJsonPbUtil", "pbRepeatFromJsonArray", localNoSuchFieldException2);
          Object localObject2 = null;
          continue;
        }
        catch (IllegalAccessException localIllegalAccessException2)
        {
          yxs.d("GdtJsonPbUtil", "pbRepeatFromJsonArray", localIllegalAccessException2);
      ...
      for (;;)
      {
        ...
        catch (JSONException localJSONException)
        {
          for (;;)
          {
            yxs.d("GdtJsonPbUtil", "pbRepeatFromJsonArray", localJSONException);
            continue;
  ...
  private static PBPrimitiveField a(PBPrimitiveField paramPBPrimitiveField, Object paramObject)
  {
    ...
    {
      yxs.d("GdtJsonPbUtil", "pbFromJsonPrimitive error");
      return null;
    }
    try
    {
    ...
    catch (Throwable paramObject)
    {
      for (;;)
      {
        yxs.d("GdtJsonPbUtil", "pbFromJsonPrimitive", paramObject);
        paramObject = null;
      }
    }
    return paramObject;
  ...
  private static Class a(Class paramClass)
  {
    if (paramClass == null)
    {
      yxs.d("GdtJsonPbUtil", "getValueClassOfPBField error");
      return null;
    }
    try
    {
    ...
    {
      yxs.d("GdtJsonPbUtil", "getValueClassOfPBField", paramClass);
    }
    return null;
  }
  ...
  public static Object a(PBField paramPBField)
  {
    if (paramPBField == null)
    {
      yxs.d("GdtJsonPbUtil", "pbToJson error");
      return null;
    }
    if (a(paramPBField.getClass())) {
    ...
    yxs.d("GdtJsonPbUtil", "pbToJson error, " + paramPBField.getClass().getName() + " is not supported");
    return null;
  }
  ...
  private static Object a(PBPrimitiveField<?> paramPBPrimitiveField)
  {
    ...
    {
      yxs.d("GdtJsonPbUtil", "pbPrimitiveFieldToJson", paramPBPrimitiveField);
    }
    return "";
  }
  ...
  private static Object a(Object paramObject)
  {
    if (paramObject == null)
    {
      yxs.d("GdtJsonPbUtil", "getOfPB error");
      return null;
    }
    try
    {
    ...
    {
      yxs.d("GdtJsonPbUtil", "getOfPB", paramObject);
    }
    return null;
  }
  ...
  private static JSONArray a(PBField paramPBField)
  {
    ...
    {
      yxs.d("GdtJsonPbUtil", "pbRepeatToJson error");
      return null;
    }
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          yxs.d("GdtJsonPbUtil", "pbMessagebToJson error");
        }
        catch (IllegalAccessException localIllegalAccessException)
        {
          yxs.d("GdtJsonPbUtil", "pbMessagebToJson", localIllegalAccessException);
        }
        continue;
        label179:
        ...
        if ((localObject1 != null) && (localObject1 != JSONObject.NULL)) {
          ...
          {
            yxs.d("GdtJsonPbUtil", "pbMessagebToJson", localJSONException);
          }
        }
      }
    }
  ...
  private static void a(Object paramObject1, Object paramObject2)
  {
    ...
    {
      yxs.d("GdtJsonPbUtil", "addOfPB error");
      return;
    }
    ...
    for (;;)
    {
      ...
      {
        yxs.d("GdtJsonPbUtil", "addOfPB", paramObject1);
        return;
      }
  ...
  private static void a(Object paramObject1, Object paramObject2, Class paramClass)
  {
    ...
    {
      yxs.d("GdtJsonPbUtil", "setOfPB error");
      return;
    }
    try
    {
    ...
    {
      yxs.d("GdtJsonPbUtil", "setOfPB", paramObject1);
    }
  }
