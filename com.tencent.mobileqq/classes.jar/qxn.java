...
public class qxn
{
  private static qxn jdField_a_of_type_Qxn;
  private int jdField_a_of_type_Int;
  private DecimalFormat jdField_a_of_type_JavaTextDecimalFormat = new DecimalFormat("0.00");
  private ConcurrentHashMap<Integer, WeakReference<qhj>> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
  
  public static qxn a()
  {
    if (jdField_a_of_type_Qxn == null) {
      jdField_a_of_type_Qxn = new qxn();
    }
    return jdField_a_of_type_Qxn;
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    do
    {
      ...
      localObject = (qhj)((WeakReference)localObject).get();
    } while (localObject == null);
    ((qhj)localObject).a(paramToServiceMsg, paramFromServiceMsg, paramObject);
  }
  ...
  private boolean a(ToServiceMsg paramToServiceMsg)
  {
    int i;
    int k;
    if (paramToServiceMsg.getAttribute(qhj.f) != null)
    {
      i = ((Integer)paramToServiceMsg.getAttribute(qhj.f)).intValue();
      if (i == 2)
      {
        k = 1;
  ...
  public void a(ToServiceMsg paramToServiceMsg)
  {
    ...
    pno.a().post(paramToServiceMsg);
  }
  
  public final void a(ToServiceMsg paramToServiceMsg, qhj paramqhj)
  {
    if ((paramToServiceMsg == null) || (paramqhj == null)) {
      return;
    }
    paramToServiceMsg.extraData.putBoolean("req_pb_protocol_flag", true);
    paramqhj = new WeakReference(paramqhj);
    pno.a().post(new ReadInJoyMSFService.1(this, paramToServiceMsg, paramqhj));
    a(paramToServiceMsg);
  }
    ...
    for (;;)
    {
      ...
      if (paramFromServiceMsg.getResultCode() == 2008)
      {
        ...
        if (paramFromServiceMsg == null) {
          paramToServiceMsg = pkh.a().getApplication();
        }
