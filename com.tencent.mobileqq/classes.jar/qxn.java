  ...
  implements qxd
{
  ...
  public qxn(XListView paramXListView, List<BaseData> paramList, qxb paramqxb)
  {
  ...
  private qxb a()
  {
    ...
    {
      bejx localbejx = (bejx)this.jdField_a_of_type_ComTencentWidgetXListView.getAdapter();
      if ((localbejx.getWrappedAdapter() instanceof qxb)) {
        return (qxb)localbejx.getWrappedAdapter();
      }
    }
    return null;
  }
  ...
  private boolean a(int paramInt)
  {
    ...
    {
      aciy.a("ItemHeightHelper", "", new IllegalArgumentException(" data == null index: " + paramInt + "   itemArrayList.size() :" + this.jdField_a_of_type_JavaUtilList.size()));
      return true;
    }
    return false;
  }
  ...
  private int b(int paramInt)
  {
    ...
    try
    {
      localObject = ((qxb)localObject).a(paramInt, null, this.jdField_a_of_type_ComTencentWidgetXListView, true);
  ...
  public void a(int paramInt, View paramView)
  {
    ...
    paramView.getViewTreeObserver().addOnGlobalLayoutListener(new qxo(this, paramInt, paramView));
  }
}
