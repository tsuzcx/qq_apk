  ...
  extends beot
{
  ...
  public able(QQLSActivity paramQQLSActivity)
  {
  ...
  private View b(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView != null)
    {
      ...
      if (!(paramViewGroup instanceof ablj)) {}
    }
    for (paramViewGroup = (ablj)paramViewGroup;; paramViewGroup = null)
    {
      if (paramViewGroup == null)
      {
        paramView = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getLayoutInflater().inflate(2131495258, null);
        paramViewGroup = new ablj();
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131307347));
      ...
      for (;;)
      {
        Object localObject = (ImageView)paramView.findViewById(2131307341);
        if (localObject != null)
        {
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    ((BaseChatItemLayout)localObject).setId(2131297536);
    ...
    if ((paramView == null) || (!(paramView.getTag() instanceof ablf)))
    {
      paramViewGroup = new ablf();
      paramView = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getLayoutInflater().inflate(2131495253, null);
      paramViewGroup.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131307225));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131307220));
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqActivityAioItemBreathAnimationLayout = ((BreathAnimationLayout)paramView.findViewById(2131307221));
      paramView.setTag(paramViewGroup);
    }
    for (;;)
    {
      ...
      if ((localMessageRecord instanceof MessageForPtt))
      {
        ...
        ((TextView)paramView.findViewById(2131307222)).setText(new axjq((CharSequence)localObject, 16).a());
        ...
        localMarginLayoutParams.setMargins(aciy.a(5.0F, this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getResources()), aciy.a(7.0F, this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getResources()), 0, 0);
        int j = adlr.a(QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity), localMessageForPtt);
        int i = j;
        if (j == -1)
        {
        ...
        axte.a(QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity), i, localMessageRecord);
        aclk.a(QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity)).a(paramView, this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity);
      ...
      try
      {
        localObject = baiu.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity, 3, localMessageRecord.time * 1000L);
        ...
        audb.a(QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity)).b(localMessageForPtt);
        return paramView;
        paramViewGroup = (ablf)paramView.getTag();
        continue;
        label569:
        localMarginLayoutParams.setMargins(0, aciy.a(7.0F, this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getResources()), 0, 0);
      }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      if (paramView != null)
      {
        ...
        if ((paramView.getTag() instanceof abli)) {}
      }
      else
      {
        paramViewGroup = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getLayoutInflater().inflate(2131495257, null);
        paramView = new abli();
        localObject1 = (TextView)paramViewGroup.findViewById(2131307347);
        localObject2 = (ImageView)paramViewGroup.findViewById(2131307350);
    ...
    MessageRecord localMessageRecord = (MessageRecord)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    Object localObject2 = (abli)paramViewGroup.getTag();
    if (localMessageRecord.istroop == 7000)
    {
      paramView = null;
      if (this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.jdField_a_of_type_Axat != null) {
        paramView = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.jdField_a_of_type_Axat.b(localMessageRecord.frienduin);
      }
    ...
    for (;;)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.jdField_a_of_type_JavaUtilArrayList.size() > 0) && (((String)localObject1).equals("")) && ((localMessageRecord.msgtype == -2016) || (localMessageRecord.msgtype == -2009) || (localMessageRecord.msgtype == -2026)))
      {
        ...
        ((abli)localObject2).jdField_a_of_type_AndroidWidgetTextView.setTextColor(-570319);
        ((abli)localObject2).jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        label371:
        if ((localMessageRecord.istroop != 1) || ((localMessageRecord instanceof MessageForPubAccount))) {
          break label1472;
        }
        paramView = bami.a(localMessageRecord, QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).a().a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity, localMessageRecord, false));
        if (paramView == null) {
          break label1440;
        }
        ((abli)localObject2).jdField_a_of_type_AndroidWidgetTextView.setText(paramView);
        ...
        if ((localMessageRecord.istroop == 1001) || (localMessageRecord.istroop == 1010) || (localMessageRecord.istroop == 10002))
        {
          ...
          {
            paramView = (MessageForNearbyLiveTip)awbi.a(-2053);
            paramView.msgData = localMessageRecord.msgData;
            paramView.parse();
            localObject1 = paramView.nickName;
            paramView = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getString(2131633432) + (String)localObject1 + paramView.msg;
            continue;
          }
          localObject1 = babh.q(QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity), localMessageRecord.senderuin);
          paramView = (View)localObject1;
          if (localObject1 == null) {
            paramView = "";
          }
          Object localObject3;
          if (localMessageRecord.frienduin.equals(ajed.ah))
          {
            ((TextView)QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).findViewById(2131307343)).setText(BaseApplicationImpl.getApplication().getString(2131625880));
            localObject1 = BaseApplicationImpl.getApplication().getString(2131625879);
            ((DragTextView)QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).findViewById(2131307349)).setVisibility(8);
            ...
            ((TextView)QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).findViewById(2131307343)).setText(localObject3[4]);
            paramView = localObject3[5];
            continue;
          }
          if (localMessageRecord.frienduin.equals(ajed.ag))
          {
            ((TextView)QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).findViewById(2131307343)).setText(BaseApplicationImpl.getApplication().getString(2131628085));
            localObject1 = BaseApplicationImpl.getApplication().getString(2131628084);
            ((DragTextView)QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).findViewById(2131307349)).setVisibility(8);
        ...
        if ((localMessageRecord.istroop == 9501) && ("device_groupchat".equals(localMessageRecord.extStr)))
        {
          ...
          {
            localObject1 = babh.b(QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity), localMessageRecord.senderuin, true);
            paramView = (View)localObject1;
            if (!TextUtils.isEmpty(localMessageRecord.senderuin))
            {
              paramView = (View)localObject1;
              if (localMessageRecord.senderuin.equals(localMessageRecord.frienduin)) {
                paramView = ydt.a(((xrh)QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).a(51)).a(Long.parseLong(localMessageRecord.senderuin)));
              }
            }
            localObject1 = paramView;
            if (paramView == null) {
        ...
        {
          paramView = this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getResources().getString(2131631782) + QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).a().b(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity, localMessageRecord, false);
          continue;
        }
        if ((localMessageRecord.istroop == 1) && ((localMessageRecord instanceof MessageForPubAccount))) {
      ...
      for (paramView = rsp.a(QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity), BaseApplicationImpl.getContext()) + ":";; paramView = "")
      {
        paramView = paramView + QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).a().b(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity, localMessageRecord, false);
        break;
        if (akbm.a(localMessageRecord.istroop) == 1032)
        {
        ...
        {
          ((TextView)QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).findViewById(2131307343)).setText(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity.getResources().getString(2131628967));
        ...
        break;
        ((abli)localObject2).jdField_a_of_type_AndroidWidgetTextView.setTextColor(-4210755);
        ((abli)localObject2).jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        break label371;
        ((abli)localObject2).jdField_a_of_type_AndroidWidgetTextView.setText(new axkd((CharSequence)localObject1, 5, 16, QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).a()));
        return paramViewGroup;
        ((abli)localObject2).jdField_a_of_type_AndroidWidgetTextView.setText(new axkd((CharSequence)localObject1, 5, 16, QQLSActivity.a(this.jdField_a_of_type_ComTencentMobileqqActivityQQLSActivity).a()));
        return paramViewGroup;
      }
