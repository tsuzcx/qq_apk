...
public class zka
{
  ...
  private static zka jdField_a_of_type_Zka;
  ...
  public static zka a()
  {
    try
    {
      if (jdField_a_of_type_Zka == null) {
        jdField_a_of_type_Zka = new zka();
      }
      zka localzka = jdField_a_of_type_Zka;
      return localzka;
    }
    finally {}
  }
  
  public void a(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, zke paramzke)
  {
    boolean bool = true;
    ...
    {
      this.jdField_a_of_type_AndroidOsHandler.post(new SubscribeDraftManager.1(this, paramString1, paramString2, paramString3, paramString4, paramzke));
      return;
    }
    if (paramzke != null) {
      paramzke.a(3, false, paramString2, new Object[0]);
    }
    QLog.d(jdField_a_of_type_JavaLangString, 4, "modifyDraft failed because something is empty");
  }
  
  public void a(Context paramContext, String paramString1, String paramString2, int paramInt, zkl paramzkl)
  {
    ...
    do
    {
      ...
      paramContext.a(new zkb(this, paramzkl, paramString1, paramContext));
      paramContext.a(new zkc(this, paramString1, paramString2, paramzkl, paramContext));
    } while (paramContext.isShowing());
    paramContext.show();
  }
  
  public void a(String paramString1, String paramString2, zke paramzke)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new SubscribeDraftManager.4(this, paramString1, paramString2, paramzke));
  }
  
  public void a(String paramString, zke paramzke)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new SubscribeDraftManager.2(this, paramString, paramzke));
  }
  ...
  public void b(String paramString1, String paramString2, zke paramzke)
  {
    if ((TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)))
    {
      QLog.d(jdField_a_of_type_JavaLangString, 4, "deletDraft failed because uin or draftID is empty");
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new SubscribeDraftManager.5(this, paramString1, paramString2, paramzke));
  }
}
