...
public class alsf
{
  ...
  static
  {
    ...
    String[] arrayOfString = { "R815T", "W6500", "K5", "S39h", "MK150", "GN137", "GN705T", "GN708T", "E3T", "K5", "Mi-4c", "MI 4S", "MI NOTE Pro", "Nexus 6P", "vivo X3S W", "Nexus 5X" };
    jdField_a_of_type_Array2dOfJavaLangString = new String[][] { { "OPPO", "PHILIPS", "KONKA", "Sony", "Meitu", "GiONEE", "GiONEE", "GiONEE", "GiONEE", "alps", "Xiaomi", "Xiaomi", "Xiaomi", "Huawei", "BBK", "LGE" }, arrayOfString };
  }
  ...
  private static float a(Context paramContext)
  {
    ...
    float f2 = Float.valueOf(amrm.a(paramContext, "key_font_level", String.valueOf(16.0F))).floatValue();
    float f1;
    if (f2 >= 13.92F)
    {
      f1 = f2;
  ...
  private static void a(Context paramContext, float paramFloat)
  {
    ...
    amrm.a(paramContext, "key_font_level", String.valueOf(paramFloat));
  }
