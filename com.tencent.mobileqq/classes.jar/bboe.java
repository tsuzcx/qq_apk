...
public class bboe
{
  ...
  public ArrayList<awge> a(String paramString)
  {
    ...
    Object localObject2 = (amog)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(2);
    Object localObject1 = ((amog)localObject2).a(paramString);
    ...
    if (j < ((List)localObject1).size())
    {
      ...
      {
        localObject6 = ((amnz)localObject4).a(((TroopIndex)localObject5).mTroopUin, 1);
    ...
    for (float f2 = f1;; f2 = 0.0F)
    {
      ...
      localObject7 = ((amog)localObject2).b((String)localObject7);
      ...
      if ((((alto)localObject1).b(((TroopIndex)localObject8).mMemberUin)) && (!((String)localObject6).equals(((TroopIndex)localObject8).mMemberUin)) && (!paramString.equals(((TroopIndex)localObject8).mMemberUin)))
      {
        if (((HashMap)localObject5).containsKey(((TroopIndex)localObject8).mMemberUin)) {
          break label668;
        }
        bboh localbboh = new bboh(this, f3);
        localbboh.b = f2;
        localbboh.jdField_a_of_type_Int = 1;
        RecentUser localRecentUser = ((amnz)localObject4).a(((TroopIndex)localObject8).mMemberUin, 0);
        if (localRecentUser != null) {
          localbboh.jdField_a_of_type_Long = localRecentUser.lastmsgtime;
        }
        ((HashMap)localObject5).put(((TroopIndex)localObject8).mMemberUin, localbboh);
      }
      for (;;)
      {
        j += 1;
        break;
        localObject8 = (bboh)((HashMap)localObject5).get(((TroopIndex)localObject8).mMemberUin);
        ((bboh)localObject8).jdField_a_of_type_Int += 1;
        ((bboh)localObject8).b += f2;
      }
      if (QLog.isColorLevel()) {
      ...
      Collections.sort(paramString, new bbof(this));
      i = paramString.size();
      if ((i > 1) && (((bboh)((Map.Entry)paramString.get(i - 1)).getValue()).a() == ((bboh)((Map.Entry)paramString.get(0)).getValue()).a())) {}
      for (i = 1;; i = 0)
      {
        if (i != 0)
        {
          ...
          Collections.sort(paramString, new bbog(this));
        }
        localObject2 = new ArrayList();
        i = 0;
        if (i < paramString.size())
        {
          localObject3 = (bboh)((Map.Entry)paramString.get(i)).getValue();
          localObject4 = ((alto)localObject1).b((String)((Map.Entry)paramString.get(i)).getKey());
          if (localObject4 != null)
          {
            ((ArrayList)localObject2).add(localObject4);
            if ((i < 20) && (QLog.isColorLevel())) {
              QLog.i("RelationFriendsSearchHelper", 2, "top20:uin" + bdnn.e(((Friends)localObject4).uin) + ",scores:" + ((bboh)localObject3).a() + ",frequency:" + ((bboh)localObject3).jdField_a_of_type_Int + ",activefactor:" + ((bboh)localObject3).b + ",c2clastmsgtime:" + ((bboh)localObject3).jdField_a_of_type_Long);
            }
          }
          for (;;)
          {
