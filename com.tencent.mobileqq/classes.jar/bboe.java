  ...
  extends aafe
{
  ...
  private CSGet3rdCloudCheck a(Context paramContext, ToServiceMsg paramToServiceMsg)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramContext = bhns.a(((DhcpInfo)localObject2).dns1);
      ...
      catch (Exception localException1)
      {
        try
        {
          localObject2 = bhns.a(((DhcpInfo)localObject2).dns2);
          ...
          paramContext = bjms.a("f5cc92");
          if (!TextUtils.isEmpty(paramContext)) {
            localCSGet3rdCloudCheck.imei = paramContext;
          }
          localCSGet3rdCloudCheck.mac = bhns.a();
          localCSGet3rdCloudCheck.vid = bhns.b();
      ...
      if (QLog.isColorLevel())
      {
        ...
        localCSGet3rdCloudCheck.operType = bhns.a(paramContext);
        continue;
        label493:
        paramContext = null;
      }
  ...
  private SCGet3rdCloudCheck a(ToServiceMsg paramToServiceMsg, SCGet3rdCloudCheck paramSCGet3rdCloudCheck)
  {
    ...
    do
    {
      ...
      if (((Integer)paramToServiceMsg.getAttribute("network_type", Integer.valueOf(-1))).intValue() == 1)
      {
        ...
        if (bhns.b((Context)localObject1) != 1)
        {
          if (QLog.isColorLevel()) {
  ...
  public CSGUIDRegist a(Context paramContext)
  {
    ...
    localCSGUIDRegist.imei = bjms.a("f5cc92");
    localCSGUIDRegist.imsi = bjms.b("f5cc92");
    localCSGUIDRegist.mac = bhns.a();
  ...
  public Object a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    localObject2 = new bhnt();
    ((bhnt)localObject2).jdField_a_of_type_MConchSCPullConchs = ((SCPullConchs)((UniPacket)localObject1).get("SCPullConchs", null));
    ((bhnt)localObject2).jdField_a_of_type_MWIFISCGet3rdCloudCheck = a(paramToServiceMsg, paramFromServiceMsg);
    return localObject2;
    label463:
    label492:
    return null;
  ...
  public boolean a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    for (;;)
    {
      ...
      paramToServiceMsg = bhnr.a(this.a.getApp(), this.a.getCurrentAccountUin());
      if (QLog.isColorLevel()) {
