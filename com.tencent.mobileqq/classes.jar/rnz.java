...
public class rnz
  extends rod
{
  public rnz(ReadInJoyDiandianHeaderController paramReadInJoyDiandianHeaderController)
  {
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0xc90.RspBody paramRspBody)
  {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty(this.a.jdField_a_of_type_JavaLangString)) {
        this.a.jdField_b_of_type_AndroidWidgetTextView.setOnClickListener(new roa(this));
      }
      ...
      this.a.jdField_a_of_type_Roc = new roc(this.a, this.a.jdField_a_of_type_JavaUtilList);
      this.a.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetDisableSlideHorizontalListView.setAdapter(this.a.jdField_a_of_type_Roc);
