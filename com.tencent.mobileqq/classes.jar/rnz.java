  ...
  implements rnw
{
  ...
  private Map<String, rob> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  private int a(rob paramrob, String paramString1, String paramString2)
  {
    try
    {
      Object localObject = (String)bmhv.a(jdField_b_of_type_JavaLangString, "");
  ...
  public static long a(int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        if (plm.b(paramInt))
        {
          Object localObject = pkn.a(String.valueOf(paramInt));
          if (localObject == null) {
            break label232;
          }
          l1 = ((pkn)localObject).a(false);
          localObject = (String)bmhv.a(c, "");
          if (TextUtils.isEmpty((CharSequence)localObject))
          {
  ...
  private rob a(BaseArticleInfo paramBaseArticleInfo)
  {
  ...
  private rob a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      paramString2 = (rob)this.jdField_a_of_type_JavaUtilMap.get(str);
      paramString1 = paramString2;
    } while (paramString2 != null);
    paramString1 = new rob(this);
    this.jdField_a_of_type_JavaUtilMap.put(str, paramString1);
    return paramString1;
  }
  
  private rob a(oidb_cmd0x68b.BackOffGroupInfo paramBackOffGroupInfo, String paramString1, String paramString2)
  {
    int j = 0;
  ...
  public static void a(int paramInt)
  {
    ...
    if ((paramInt == 0) || (plm.b(paramInt)))
    {
      ...
      pkn localpkn2 = pkn.a(String.valueOf(paramInt));
      pkn localpkn1 = localpkn2;
      if (localpkn2 == null)
      {
        localpkn1 = new pkn();
        pkn.a(String.valueOf(paramInt), localpkn1);
      }
  ...
  private void a(List<ArticleInfo> paramList, rob paramrob, rod paramrod)
  {
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      ArticleInfo localArticleInfo = (ArticleInfo)paramList.next();
      if (paramrob.jdField_a_of_type_JavaLangString.equals(c(localArticleInfo))) {
        paramrod.jdField_a_of_type_JavaUtilHashMap.put(localArticleInfo.innerUniqueID, new roa(this, localArticleInfo.innerUniqueID));
      }
      if ((localArticleInfo.mSubArtilceList != null) && (localArticleInfo.mSubArtilceList.size() > 0)) {
        a(localArticleInfo.mSubArtilceList, paramrob, paramrod);
      }
    }
  }
  
  private void a(rob paramrob, String paramString1, String paramString2)
  {
    try
    {
      Object localObject = (String)bmhv.a(jdField_b_of_type_JavaLangString, "");
      ...
      for (;;)
      {
        ...
        bmhv.a(jdField_b_of_type_JavaLangString, ((JSONObject)localObject).toString());
        return;
        localObject = new JSONObject((String)localObject);
        break;
      }
    }
    catch (JSONException paramrob)
    {
      paramrob.printStackTrace();
      return;
    }
  }
  
  private void a(roc paramroc)
  {
    ArrayList localArrayList = new ArrayList();
    if (paramroc.jdField_a_of_type_JavaUtilList.size() > 0)
    {
      Iterator localIterator = paramroc.jdField_a_of_type_JavaUtilList.iterator();
      while (localIterator.hasNext())
      {
        Object localObject = (oidb_cmd0x68b.BackOffGroupInfo)localIterator.next();
        String str = qxl.a(((oidb_cmd0x68b.BackOffGroupInfo)localObject).bytes_back_off_group);
        if (!TextUtils.isEmpty(str))
        {
          localObject = a((oidb_cmd0x68b.BackOffGroupInfo)localObject, String.valueOf(paramroc.jdField_a_of_type_Int), str);
          if ((localObject != null) && (paramroc.b != null) && (!localArrayList.contains(str)))
          {
            rod localrod = new rod(this);
            a(paramroc.b, (rob)localObject, localrod);
            ((rob)localObject).a(localrod);
  ...
  public static void a(oidb_cmd0x68b.ReqChannelPara paramReqChannelPara, String paramString)
  {
    try
    {
      Object localObject = (String)bmhv.a(jdField_a_of_type_JavaLangString, "");
      ...
      for (;;)
      {
        ...
        bmhv.a(jdField_a_of_type_JavaLangString, ((JSONObject)localObject).toString());
  ...
  {
    return qxl.a(paramBaseArticleInfo.weishiUGInfo.bytes_back_off_group, "");
  }
  ...
  public static void b(int paramInt)
  {
    if ((paramInt == 0) || (plm.b(paramInt)))
    {
      pkn localpkn = pkn.a(String.valueOf(paramInt));
      if ((localpkn != null) && (localpkn.a()))
      {
        c(paramInt);
        localpkn.b();
        localpkn.c();
        ...
        if (localObject != null)
        {
          ...
          if (TextUtils.isEmpty((CharSequence)localObject))
          {
            ...
            if (!str2.equals(str1))
            {
              ...
              bmhv.a(c, ((JSONObject)localObject).toString());
            }
          }
          else
          {
  ...
  public static boolean e(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (paramBaseArticleInfo.bytes_jump_bundle.has())
    {
      ...
      bool = bhfn.a(BaseApplicationImpl.getApplication(), paramBaseArticleInfo);
  ...
  public void a(BaseArticleInfo paramBaseArticleInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (j != 0)
    {
      ...
      usp.a(paramBaseArticleInfo, i);
    }
  }
  
  public void a(Object paramObject)
  {
    if (!(paramObject instanceof roc)) {
      return;
    }
  ...
  public boolean a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    localObject1 = ((rob)localObject1).jdField_a_of_type_JavaUtilDeque.iterator();
    while (((Iterator)localObject1).hasNext())
    {
      Object localObject2 = (rod)((Iterator)localObject1).next();
      if (((rod)localObject2).jdField_a_of_type_JavaUtilHashMap.containsKey(paramBaseArticleInfo))
      {
        localObject2 = (roa)((rod)localObject2).jdField_a_of_type_JavaUtilHashMap.get(paramBaseArticleInfo);
        if ((localObject2 != null) && (((roa)localObject2).jdField_a_of_type_Int != 0))
        {
          ((roa)localObject2).jdField_a_of_type_Int -= 1;
          return true;
        }
      }
    }
  ...
  {
    rob localrob = a(paramBaseArticleInfo);
    if (localrob == null) {
      return false;
    }
    Object localObject = a(paramBaseArticleInfo);
    String str = b(paramBaseArticleInfo);
    if (qxl.a(paramBaseArticleInfo.weishiUGInfo.uint32_residence_threshold, 0) > a((int)paramBaseArticleInfo.mChannelID))
    {
      QLog.d("UGRuleManager", 1, "judgeHitRule is not reach minTime");
      jdField_a_of_type_Int = 110;
      return false;
    }
    localrob.c = a(localrob, str, String.valueOf(paramBaseArticleInfo.mChannelID));
    QLog.d("UGRuleManager", 1, "judgeHitRule backOffGroup.clickTime is " + localrob.c + " backOffGroup.maxEvokeCount is " + localrob.jdField_a_of_type_Int + " groupid is " + localrob.jdField_a_of_type_JavaLangString);
    if (localrob.c >= localrob.jdField_a_of_type_Int)
    {
      QLog.d("UGRuleManager", 1, "judgeHitRule over groupClick");
      return false;
    }
    Iterator localIterator = localrob.jdField_a_of_type_JavaUtilDeque.iterator();
    while (localIterator.hasNext())
    {
      rod localrod = (rod)localIterator.next();
      if (localrod.jdField_a_of_type_JavaUtilHashMap.containsKey(localObject))
      {
        QLog.d("UGRuleManager", 1, "judgeHitRule freshInfo.clickTime is " + localrod.jdField_a_of_type_Int + " backOffGroup.maxFreshEvokeCount is " + localrob.jdField_b_of_type_Int);
        if (localrod.jdField_a_of_type_Int < localrob.jdField_b_of_type_Int)
        {
          if (!TextUtils.isEmpty(a(paramBaseArticleInfo, null, null)))
          {
            localObject = (roa)localrod.jdField_a_of_type_JavaUtilHashMap.get(paramBaseArticleInfo.innerUniqueID);
            if (localObject != null) {
              ((roa)localObject).jdField_a_of_type_Int += 1;
            }
            localrod.jdField_a_of_type_Int += 1;
            a(localrob, str, String.valueOf(paramBaseArticleInfo.mChannelID));
          }
          return true;
        }
      }
