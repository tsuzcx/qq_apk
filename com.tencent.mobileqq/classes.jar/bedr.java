...
{
  public long a;
  private bedt jdField_a_of_type_Bedt;
  ...
  public bedr(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_Long = 0L;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Bedz = new bedz(paramQQAppInterface);
  }
  ...
  private void a(ChatMessage paramChatMessage, String paramString1, String paramString2, String paramString3, aroo paramaroo)
  {
    if ((!this.jdField_a_of_type_Bedz.a()) && (QLog.isColorLevel()))
    {
    ...
    this.jdField_a_of_type_Bedz.a(paramChatMessage);
    new Handler(ThreadManager.getSubThreadLooper()).postDelayed(new AIOMessageSpreadManager.2(this, paramChatMessage, paramString1, paramaroo, paramString2, paramString3), 1000L);
  }
  ...
  {
    boolean bool2 = false;
    int i = this.jdField_a_of_type_Bedz.a();
    int j = arop.a().a();
    boolean bool1;
    if (j == 0)
    {
  ...
  {
    this.jdField_a_of_type_Bedz.a(paramarom);
  }
  ...
  public void a(ChatMessage paramChatMessage, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      try
      {
        ...
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().queryMsgItemByUniseq(paramChatMessage.frienduin, paramChatMessage.istroop, l);
      ...
      catch (Exception localException1)
      {
        ...
        if (((String)localObject3).equalsIgnoreCase("keyword")) {
          bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009078", "0X8009078", 0, 0, "", "", "", "");
        }
        while ((localException1 instanceof MessageForFile))
        {
          ...
          if (paramChatMessage == null)
          {
            ...
            if (((String)localObject3).equalsIgnoreCase("precent")) {
              bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X800907B", "0X800907B", 0, 0, "", "", "", "");
            } else if (((String)localObject3).equalsIgnoreCase("text_keyword")) {
              bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8009072", "0X800907B", 0, 0, "", "", "", "");
            }
          }
          else
          {
            beaz.a(paramChatMessage, paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 2);
            return;
          }
        }
      }
      if ((localException1 instanceof MessageForTroopFile))
      {
        ...
        localObject2 = bgke.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramChatMessage);
        localObject3 = new TeamWorkFileImportInfo();
        ((TeamWorkFileImportInfo)localObject3).c = ((bfjs)localObject2).jdField_a_of_type_JavaLangString;
        ((TeamWorkFileImportInfo)localObject3).jdField_b_of_type_JavaLangString = ((bfjs)localObject2).g;
        ((TeamWorkFileImportInfo)localObject3).j = auea.a(((bfjs)localObject2).g);
        ...
        ((TeamWorkFileImportInfo)localObject3).jdField_d_of_type_JavaLangString = ((bfjs)localObject2).jdField_e_of_type_JavaLangString;
        ((TeamWorkFileImportInfo)localObject3).jdField_b_of_type_Int = ((bfjs)localObject2).h;
        ((TeamWorkFileImportInfo)localObject3).jdField_e_of_type_JavaLangString = paramSessionInfo.troopUin;
        ((TeamWorkFileImportInfo)localObject3).jdField_a_of_type_JavaLangString = paramSessionInfo.curFriendUin;
        ...
        beaz.a((TeamWorkFileImportInfo)localObject3, paramContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, ((TeamWorkFileImportInfo)localObject3).jdField_d_of_type_Int);
        return;
      }
    ...
    try
    {
      ...
      for (localTeamWorkFileImportInfo.jdField_e_of_type_Int = 3;; localTeamWorkFileImportInfo.jdField_e_of_type_Int = 6)
      {
        ...
        localTeamWorkFileImportInfo.jdField_a_of_type_Int = paramSessionInfo.curType;
        localTeamWorkFileImportInfo.jdField_a_of_type_JavaLangString = paramSessionInfo.curFriendUin;
        localTeamWorkFileImportInfo.jdField_e_of_type_JavaLangString = paramSessionInfo.troopUin;
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    {
      QLog.e("AIOMessageSpreadManager", 1, auea.a());
      return;
    }
    if (QLog.isColorLevel()) {
  ...
  public void b(MessageRecord paramMessageRecord)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getMessageFacade().removeMsgByUniseq(paramMessageRecord.frienduin, paramMessageRecord.istroop, l, true);
      return;
    }
