  ...
  implements Manager
{
  ...
  public aold(QQAppInterface paramQQAppInterface)
  {
  ...
  public static String a(Context paramContext)
  {
    ...
    tmp6_5[0] = 2131689794;
    int[] tmp11_6 = tmp6_5;
    tmp11_6[1] = 2131689799;
    int[] tmp16_11 = tmp11_6;
    tmp16_11[2] = 2131689798;
    int[] tmp21_16 = tmp16_11;
    tmp21_16[3] = 2131689792;
    int[] tmp26_21 = tmp21_16;
    tmp26_21[4] = 2131689791;
    int[] tmp31_26 = tmp26_21;
    tmp31_26[5] = 2131689796;
    int[] tmp36_31 = tmp31_26;
    tmp36_31[6] = 2131689795;
    int[] tmp42_36 = tmp36_31;
    tmp42_36[7] = 2131689790;
    int[] tmp48_42 = tmp42_36;
    tmp48_42[8] = 2131689793;
    int[] tmp54_48 = tmp48_42;
    tmp54_48[9] = 2131689797;
    tmp54_48;
  ...
  public static String a(Context paramContext, SubMsgType0x76.MsgBody paramMsgBody)
  {
    ...
    if (TextUtils.isEmpty(str2))
    {
      ...
      str1 = String.format(paramContext.getString(2131689787), new Object[] { paramMsgBody.msg_geographic_notify.bytes_local_city.get().toStringUtf8() });
    }
    label63:
    do
    {
      ...
      if (paramMsgBody.uint32_msg_type.get() == 2) {
        return paramContext.getString(2131689785);
      }
      str1 = str2;
    } while (paramMsgBody.uint32_msg_type.get() != 3);
    return paramContext.getString(2131689789);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, submsgtype0xeb.MsgBody paramMsgBody)
  {
    ...
    int j = 0;
    Object localObject1 = paramQQAppInterface.a().b(antf.ad, 9002);
    ...
    {
      if (i != 0) {
        paramQQAppInterface.a().c(antf.ad, 9002);
      }
      if (!QLog.isColorLevel()) {
        break;
      }
  ...
  public void a(int paramInt)
  {
    ...
    for (;;)
    {
      if ((paramInt == 2) || (paramInt == 3))
      {
        ...
        bdll.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8007210", "0X8007211", 0, 0, "", "", "", "");
        this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putLong("key_last_birth_msg_stamp", bcrg.a()).commit();
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramBoolean2)
    {
      ((anum)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).l(paramBoolean1);
      return;
    }
    this.jdField_a_of_type_AndroidContentSharedPreferences.edit().putBoolean(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131694405) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramBoolean1).commit();
  }
  ...
  {
    if (paramBoolean) {
      ((anum)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(2)).u();
    }
    return this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131694405) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), true);
  }
  ...
  public boolean b(boolean paramBoolean)
  {
    ...
    return this.jdField_a_of_type_AndroidContentSharedPreferences.getBoolean(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131694405) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), false);
  }
  ...
  public void c()
  {
    ...
    aolc.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, true, false, true);
  }
