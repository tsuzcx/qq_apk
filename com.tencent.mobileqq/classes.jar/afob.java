...
{
  public afob(NearbyProfileFragment paramNearbyProfileFragment) {}
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      if ((i == 1) || (!NearbyDataManager.a(this.a.a.app)))
      {
        ...
        ThreadManager.post(new afoc(this), 5, null, false);
      }
      for (;;)
      {
        ...
        localNearbyFacePowerDialog.a(new afod(this, paramView, localNearbyFacePowerDialog));
