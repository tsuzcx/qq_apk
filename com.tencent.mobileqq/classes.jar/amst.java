...
public class amst
  extends anii
{
  public amst(AppInterface paramAppInterface)
  {
  ...
  public void a(int paramInt, String paramString, ArrayList<amsb> paramArrayList)
  {
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      {
        amsb localamsb = (amsb)paramArrayList.next();
        STCommon.STLocalCVerInfo localSTLocalCVerInfo = new STCommon.STLocalCVerInfo();
        localSTLocalCVerInfo.busId.set(localamsb.jdField_a_of_type_Int);
        localSTLocalCVerInfo.itemId.set(localamsb.jdField_a_of_type_JavaLangString);
        localSTLocalCVerInfo.localVer.set(localamsb.jdField_b_of_type_Int);
    ...
    paramArrayList = new NewIntent(this.mApp.getApp(), amsu.class);
  ...
  public void a(ReportInfoManager.ReportChannlInfo paramReportChannlInfo)
  {
    ...
    try
    {
      ...
      localJSONObject2.put("qq_version", "8.4.1.4680");
      ...
      paramReportChannlInfo = new NewIntent(this.mApp.getApp(), amsu.class);
  ...
  public void a(String paramString1, int paramInt1, int paramInt2, long paramLong1, String paramString2, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    try
    {
      ...
      paramString2 = new NewIntent(this.mApp.getApp(), amsu.class);
  ...
  public void a(String paramString, int paramInt, long paramLong)
  {
    ...
    try
    {
      ...
      localObject = new NewIntent(this.mApp.getApp(), amsu.class);
      ...
      if (("apollo_game_av.get_usraccinfo".equals(paramString)) && (paramArrayOfByte != null) && (paramFromServiceMsg.isSuccess()))
      {
        ...
        try
        {
          ...
          if ((paramArrayOfByte != null) && (paramArrayOfByte.size() > 0))
          {
            ...
            paramIntent = ampj.a(paramIntent.getIntExtra("gameId", -1));
            if (paramIntent != null)
            {
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      localUniSsoServerReqComm.mqqver.set("8.4.1.4680");
      WebSSOAgent.UniSsoServerReq localUniSsoServerReq = new WebSSOAgent.UniSsoServerReq();
  ...
  public void a(String paramString1, String paramString2, long paramLong, int paramInt, boolean paramBoolean, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        paramArrayOfByte = new NewIntent(this.mApp.getApp(), amsu.class);
  ...
  public void b(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      {
        ((amsk)localObject1).c(paramFromServiceMsg.getResultCode(), paramIntent);
        return;
      }
    }
    ...
    {
      ((amsk)localObject1).c(paramArrayOfByte.subCode.get(), paramIntent);
      return;
    }
    Object localObject2 = new amsj();
    if (paramArrayOfByte.updateFlag.get() == 1)
    {
      bool = true;
      ((amsj)localObject2).jdField_a_of_type_Boolean = bool;
    ...
    {
      ((amsj)localObject2).jdField_b_of_type_Boolean = bool;
      ((amsj)localObject2).jdField_a_of_type_Int = paramArrayOfByte.svrVer.get();
      ((amsj)localObject2).jdField_b_of_type_Int = i;
      ((amsj)localObject2).jdField_d_of_type_JavaLangString = paramArrayOfByte.url.get();
      ((amsj)localObject2).c = paramArrayOfByte.md5.get();
      ((amsj)localObject2).jdField_a_of_type_ArrayOfByte = paramArrayOfByte.patchContent.get().toByteArray();
      ((amsj)localObject2).e = paramArrayOfByte.patchUrl.get();
      ((amsj)localObject2).jdField_b_of_type_Long = paramArrayOfByte.packageSize.get();
      ((amsj)localObject2).jdField_a_of_type_Long = paramArrayOfByte.tipsSize.get();
      ((amsj)localObject2).jdField_a_of_type_JavaLangString = paramArrayOfByte.itemId.get();
      ((amsj)localObject2).jdField_b_of_type_JavaLangString = paramIntent;
      ((amsj)localObject2).jdField_d_of_type_Int = 1;
      ((amsk)localObject1).a((amsj)localObject2);
      return;
      bool = false;
      break;
    }
  ...
  public void c(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    if ((localamrt == null) || (localamrt.a() == null))
    {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          if (i < paramFromServiceMsg.length())
          {
            ...
            localObject1 = new amnv(((JSONObject)localObject1).optString("icon"), (String)localObject2, paramArrayOfByte);
            localamrt.a().updateUserInfo((amnv)localObject1);
            if (j == amqt.jdField_a_of_type_Int) {
              localamrt.a().getOpenApiHead(l, paramArrayOfByte);
            } else if (j == amqt.jdField_b_of_type_Int) {
              localamrt.a().getOpenApiNick(l, paramArrayOfByte);
            }
          }
        }
      }
      ...
      for (;;)
      {
        try
        {
          ...
          localamrt.a().nativeOpenApiGetHeadCallBack(l, paramFromServiceMsg.getString(0), -1, 0, 0, null);
        ...
        localamrt.a().callbackFromRequest(l, 0, "cs.preload_userInfoList.local", paramFromServiceMsg.toString());
        return;
        if (j == amqt.jdField_a_of_type_Int)
        {
          paramIntent = new JSONObject(str).optJSONArray("uidList");
          localamrt.a().nativeOpenApiGetHeadCallBack(l, paramIntent.getString(0), paramFromServiceMsg.getResultCode(), 0, 0, null);
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_HEAD error openid=" + paramIntent.getString(0));
          return;
        }
        if (j == amqt.jdField_b_of_type_Int)
        {
          paramIntent = new JSONObject(str).optJSONArray("uidList");
          localamrt.a().nativeOpenApiGetNickCallBack(l, paramIntent.getString(0), paramFromServiceMsg.getResultCode(), null);
        ...
        localamrt.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), "cs.preload_userInfoList.local", paramIntent.toString());
        ...
        {
          paramFromServiceMsg = new JSONObject(str).optJSONArray("uidList");
          localamrt.a().nativeOpenApiGetNickCallBack(l, paramFromServiceMsg.getString(0), -1, null);
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_NICK error openid=" + paramFromServiceMsg.getString(0));
        }
        else if (j == amqt.c)
        {
          localamrt.a().callbackFromRequest(l, -1, "cs.preload_userInfoList.local", "{}");
          QLog.e("cmgame_process.CmGameSSoHandler", 1, "GET_OPENID_INFO_FROM_PRELOAD error ");
        }
      }
      label859:
  ...
  public void d(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        do
        {
          for (;;)
          {
            ...
            try
            {
              ...
              if (i == 4)
              {
                localamrt.a().callbackFromRequest(l, (int)localUniSsoServerRsp.ret.get(), str3, paramArrayOfByte);
                return;
              }
            }
            catch (Throwable paramArrayOfByte)
            {
              ...
              try
              {
                ...
                if (i == 4)
                {
                  localamrt.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), paramIntent, "{}");
                  return;
                }
              }
        ...
        paramArrayOfByte = ampj.a(localJSONObject1.optInt("gameId"));
    ...
    localamrt.a().callbackFromRequest(l, paramFromServiceMsg.getResultCode(), str3, "{}");
  }
