...
class aljk
  implements asjr
{
  aljk(aljj paramaljj, Rect paramRect, long paramLong, Object paramObject, asjo paramasjo, boolean[] paramArrayOfBoolean, Bitmap paramBitmap) {}
  
  public void a(int paramInt)
  {
    if ((this.jdField_a_of_type_Asjo != null) && (aljj.a(this.jdField_a_of_type_Aljj) != null)) {
      this.jdField_a_of_type_ArrayOfBoolean[0] = this.jdField_a_of_type_Asjo.a(this.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_a_of_type_Long);
    }
    for (;;)
    {
  ...
  public void a(List<aljf> arg1, long paramLong)
  {
    int i = 0;
    label55:
    boolean bool;
    ...
    if (i < ???.size())
    {
      if (((aljf)???.get(i)).jdField_a_of_type_Int != 2) {
        break label217;
      }
      ??? = (aljf)???.get(i);
