...
public class afoq
{
  public static void a(akok paramakok, MessageRecord paramMessageRecord, QQMessageFacade paramQQMessageFacade, QQAppInterface paramQQAppInterface)
  {
    if ((paramakok == null) || (paramMessageRecord == null) || (paramQQMessageFacade == null) || (paramQQAppInterface == null)) {}
    Object localObject;
    int k;
    int i;
    do
    {
      ...
      k = aydb.a().b(paramQQAppInterface);
      if (k <= 0) {
        break;
      }
      int j = 0;
    ...
    try
    {
      paramakok.a((QQMessageFacade.Message)localObject);
      paramQQMessageFacade.a().unReadNum = k;
      return;
    }
    catch (Throwable paramakok)
    {
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.d("TroopSuspiciousHelper", 2, "add GroupSuspiciousMsg ERROR", paramakok);
        }
      }
    }
  ...
  public static void a(akqx paramakqx, QQAppInterface paramQQAppInterface, structmsg.RspNextSystemMsg paramRspNextSystemMsg, String paramString)
  {
    ...
    if (i < j)
    {
      ...
      for (;;)
      {
        ...
        localMessageRecord.frienduin = ajsf.O;
    ...
    localObject = (askq)paramQQAppInterface.getManager(37);
    boolean bool;
    if (localArrayList.size() > 0)
    {
      if ((localArrayList.size() < 20) && (localObject != null)) {
        ((askq)localObject).b(true);
      }
      ...
      if ((akau.a(localArrayList)) && (paramQQAppInterface.isBackground_Stop))
      {
        bool = true;
    ...
    for (;;)
    {
      paramakqx.a(4019, true, localArrayList);
      return;
      bool = false;
      break;
      if (localObject != null) {
  ...
  public static void a(akqx paramakqx, QQAppInterface paramQQAppInterface, structmsg.RspSystemMsgNew paramRspSystemMsgNew, List<structmsg.StructMsg> paramList, int paramInt, String paramString)
  {
    ...
    aydb.a().b(paramQQAppInterface, paramInt);
    paramRspSystemMsgNew = new ArrayList();
    int i = paramList.size();
    Object localObject = (askq)paramQQAppInterface.getManager(37);
    if (localObject != null) {
      ((askq)localObject).b(false);
    }
    Collections.sort(paramList, new afor());
    paramInt = 0;
    if (paramInt < i)
    {
      localObject = axaq.a(-2018);
      ((MessageRecord)localObject).msgtype = -2018;
      ((MessageRecord)localObject).selfuin = paramString;
      ((MessageRecord)localObject).frienduin = ajsf.O;
    ...
    paramQQAppInterface.a().a(ajsf.O, 0);
    if (paramRspSystemMsgNew.size() > 0)
    {
      paramList = paramQQAppInterface.a();
      paramString = String.valueOf(paramString);
      if ((!akau.a(paramRspSystemMsgNew)) || (!paramQQAppInterface.isBackground_Stop)) {
        break label568;
      }
    }
    label568:
    for (boolean bool = true;; bool = false)
    {
      ...
      paramakqx.a(4019, true, paramRspSystemMsgNew);
      return;
    }
  }
  ...
  public static void a(structmsg.StructMsg paramStructMsg, String paramString)
  {
    ...
    {
      bbbb.a("Grp_contacts_news", "notice", paramString, 0, 0, new String[] { str1, str2, paramStructMsg });
      return;
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    List localList = paramQQAppInterface.a().b(ajsf.O, 0);
