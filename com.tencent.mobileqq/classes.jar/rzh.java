...
public class rzh
{
  ...
  public rzh(FragmentActivity paramFragmentActivity, FragmentManager paramFragmentManager, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup.setId(2131364512);
  ...
  private void a(VVideoView paramVVideoView, View paramView, int paramInt)
  {
    ...
    b(paramVVideoView, paramView);
    int i = qoi.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[0];
    ...
    this.jdField_a_of_type_AndroidViewViewGroup.setVisibility(8);
    this.jdField_a_of_type_AndroidViewView.setVisibility(8);
    qoi.a(this.jdField_a_of_type_AndroidViewView, 0, 300);
    qoi.a(this.jdField_a_of_type_AndroidViewViewGroup, 0, 300);
    qoi.a(paramView, this.jdField_a_of_type_ArrayOfInt, this.jdField_b_of_type_ArrayOfInt, new int[] { 0, ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity) }, new int[] { i, j }, 300L, true);
    ...
    j = qoi.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1];
    int k = this.c[1];
    int[] arrayOfInt2 = this.c;
    qoi.a(paramVVideoView, new int[] { 0, paramInt + i }, arrayOfInt1, new int[] { 0, j - k }, arrayOfInt2, 300L, true);
    paramView.addOnLayoutChangeListener(new rzi(this));
  }
  ...
  private void a(VVideoView paramVVideoView, View paramView, boolean paramBoolean)
  {
    ...
    qoi.a(this.jdField_a_of_type_AndroidViewView, 8, 300);
    qoi.a(this.jdField_a_of_type_AndroidViewViewGroup, 8, 300);
    ...
    if (paramBoolean)
    {
      ...
      localObject[0] = 0;
      localObject[1] = qoi.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1];
    }
    for (;;)
    {
      qoi.a(this.jdField_a_of_type_AndroidViewViewGroup, new int[] { 0, qoi.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1] - this.jdField_a_of_type_AndroidViewViewGroup.getHeight() }, arrayOfInt, (int[])localObject, arrayOfInt, 300L, true);
      ...
      localObject = qoi.a(paramView, new int[] { 0, i }, new int[] { j, k }, (int[])localObject, arrayOfInt, 300L, false);
      ((Animator)localObject).addListener(new rzj(this, paramVVideoView, paramView));
  ...
  private void c()
  {
    ...
    {
      int i;
      if (axlk.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getApplicationContext()))
      {
        i = axlk.d(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getApplicationContext());
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height = qoi.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    ...
    b();
    this.c = new int[] { qoi.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[0], this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height };
  }
  ...
  public void a(View paramView, float paramFloat)
  {
    ...
    {
      int i = (int)(paramView.getHeight() / paramView.getWidth() * qoi.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[0]);
      this.jdField_a_of_type_AndroidViewViewGroup$LayoutParams.height = ((int)(qoi.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)[1] - i - paramFloat - ImmersiveUtils.getStatusBarHeight(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity)));
  ...
  public void a(VVideoView paramVVideoView, View paramView, ArticleInfo paramArticleInfo, AnchorData paramAnchorData, int paramInt)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment == null)
      {
        Fragment localFragment = this.jdField_a_of_type_AndroidSupportV4AppFragmentManager.findFragmentById(2131364512);
    ...
    } while (this.jdField_a_of_type_Rzl == null);
    this.jdField_a_of_type_Rzl.a(true);
  }
  
  public void a(rzl paramrzl)
  {
    this.jdField_a_of_type_Rzl = paramrzl;
  }
  ...
  public void a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (this.jdField_a_of_type_Rzl != null) {
        this.jdField_a_of_type_Rzl.a(false);
      }
    }
  }
  ...
  public void b()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment == null)
    {
      ...
      this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment.a((Bundle)localObject, new rzk(this), this.jdField_a_of_type_AndroidViewViewGroup);
      localObject = this.jdField_a_of_type_AndroidSupportV4AppFragmentManager.beginTransaction();
      ((FragmentTransaction)localObject).add(2131364512, this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyCommentReadInJoyCommentListFragment);
