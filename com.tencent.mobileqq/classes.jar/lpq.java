...
public class lpq
{
  ...
  private static final String jdField_a_of_type_JavaLangString = lcj.h() + "SKINCOLOR" + File.separator;
  ...
  public static float a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        jdField_a_of_type_Float = locallpc.a();
        lcg.c("EffectBeautyTools", "mBeautyRatio:" + jdField_a_of_type_Float);
      }
      catch (Exception localException)
      {
        lcg.c("EffectBeautyTools", "getNewBeautyRatio Exception:" + localException);
  ...
  private static lps a(String paramString)
  {
    if (TextUtils.isEmpty(paramString))
    {
      lcg.c("EffectBeautyTools", "parseConfig|content is empty.");
      return null;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        locallps = new lps(i, str1, str2);
        try
        {
          lcg.c("EffectBeautyTools", "parseConfig:" + i + "|" + str1 + "|" + str2);
          return locallps;
        }
      ...
      try
      {
        ...
        lcg.c("EffectBeautyTools", "parseConfig failed. info = " + localJSONObject);
        return locallps;
      }
      catch (JSONException localJSONException2)
      {
        localJSONException2.printStackTrace();
        lcg.c("EffectBeautyTools", "parseConfig|parse failed.context = " + paramString);
        return locallps;
      }
    }
  }
    ...
    try
    {
      if (b())
      {
        ...
        if (new File(jdField_a_of_type_JavaLangString).exists()) {
          bbdx.a(jdField_a_of_type_JavaLangString);
        }
      }
      ...
      if ((paramContext != null) && (!TextUtils.isEmpty(paramContext.jdField_a_of_type_JavaLangString)))
      {
        ...
        lcg.c("EffectBeautyTools", "preDownloadResource :" + ((File)localObject).exists());
        if (!((File)localObject).exists())
        {
          localObject = new ayrx();
          ((ayrx)localObject).jdField_a_of_type_Aysc = new lpr();
          ...
          ((ayrx)localObject).c = (lcj.h() + "skin_color.zip");
  ...
  public static boolean a()
  {
    ...
    for (;;)
    {
      ...
      {
        lpc locallpc = lpc.a();
        if ((locallpc == null) || (!locallpc.a()) || (!c())) {
          continue;
        }
        jdField_a_of_type_Int = 2;
        lcg.c("EffectBeautyTools", "mIsSupportFlag:" + jdField_a_of_type_Int);
      }
      catch (Exception localException)
      {
        lcg.c("EffectBeautyTools", "isSupportNewBeauty Exception:" + localException);
  ...
  private static boolean b()
  {
    ...
    lcg.c("EffectBeautyTools", "getIsFirstLauncher:" + i);
    if (i == 0) {
      bool = true;
    }
    return bool;
