...
public class alqz
{
  ...
  private adlm jdField_a_of_type_Adlm = new alra(this);
  private alre jdField_a_of_type_Alre;
  private alrh jdField_a_of_type_Alrh;
  AdapterView.OnItemClickListener jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new alrd(this);
  ...
  private ArrayList<adli> jdField_a_of_type_JavaUtilArrayList;
  ...
  public alqz(BaseChatPie paramBaseChatPie)
  {
  ...
  private void a(boolean paramBoolean)
  {
    ...
    Object localObject1 = (alsa)this.jdField_a_of_type_JavaUtilList.get(this.jdField_b_of_type_Int);
    ...
    for (;;)
    {
      localObject2 = (adli)this.jdField_a_of_type_JavaUtilArrayList.get(this.jdField_b_of_type_Int);
      ((adli)localObject2).a(((alsa)localObject1).a, ((alsa)localObject1).b, ((alsa)localObject1).c, ((alsa)localObject1).f, alsz.a(), null, this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a());
      Object localObject3;
      int j;
      if (Boolean.FALSE.equals(this.jdField_b_of_type_JavaUtilArrayList.get(this.jdField_b_of_type_Int)))
      {
        altc.a(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "ShowView", ((alsa)localObject1).a, null, altc.g, 0, 0);
        ...
        {
          localObject3 = (altf)this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(95);
      ...
      {
        k -= j;
        ((adli)localObject2).setViewRect(((adli)localObject2).descaleRect(new Rect(0, 0, i, k)));
        ((adli)localObject2).setFixSize(i, k);
        ((adli)localObject2).setMaxSize(i, k);
        ((adli)localObject2).a(this.jdField_a_of_type_Adlm);
        QLog.d("ArkAiAppPanel", 2, String.format("ArkAiAppPanel.initArkApp app:%s view%s width:%d height:%d.", new Object[] { ((alsa)localObject1).a, ((alsa)localObject1).b, Integer.valueOf(i), Integer.valueOf(k) }));
        this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView.a((adlj)localObject2, null);
  ...
  private void d()
  {
    ...
    for (int i = 0;; i = this.jdField_a_of_type_JavaUtilList.size())
    {
      ...
      while ((j < jdField_a_of_type_Int) && (j < i))
      {
        ...
        adli localadli = new adli();
        localadli.a = new ArkAppMessage.Config();
        localadli.a.round = Integer.valueOf(1);
        this.jdField_a_of_type_JavaUtilArrayList.add(localadli);
      ...
      {
        localObject = (adli)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        if (localObject != null) {
          ((adli)localObject).doOnEvent(2);
        }
        i += 1;
      }
    ...
    this.jdField_a_of_type_Alre.a((List)localObject);
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView = ((ArkAppView)this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppRootLayout.findViewById(2131362768));
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppView.setCallback(new alrb(this));
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView = ((HorizontalListView)this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppRootLayout.findViewById(2131362770));
    ...
    this.jdField_a_of_type_Alre = new alre(this, localContext);
    this.jdField_a_of_type_ComTencentWidgetHorizontalListView.setAdapter(this.jdField_a_of_type_Alre);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppRootLayout.findViewById(2131362780));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new alrc(this));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)this.jdField_a_of_type_ComTencentMobileqqActivityAioItemArkAppRootLayout.findViewById(2131362782));
  }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
      ...
      while (i < this.jdField_a_of_type_JavaUtilArrayList.size())
      {
        adli localadli = (adli)this.jdField_a_of_type_JavaUtilArrayList.get(i);
        if (localadli != null) {
  ...
  public void a(List<alsa> paramList, int paramInt, alrh paramalrh)
  {
  ...
  public void c()
  {
    ...
    if (this.jdField_a_of_type_JavaUtilList != null)
    {
      ...
      {
        alsa localalsa = (alsa)this.jdField_a_of_type_JavaUtilList.get(i);
        if (localalsa != null) {
          alsw.a(localalsa.a);
        }
        i += 1;
      ...
      if (this.jdField_a_of_type_Alrh != null) {
        this.jdField_a_of_type_Alrh.a(this.jdField_a_of_type_JavaUtilList);
      }
