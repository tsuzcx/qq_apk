...
{
  private static final int jdField_b_of_type_Int = AIOUtils.dp2px(20.0F, BaseApplicationImpl.getContext().getResources());
  private static final int c = AIOUtils.dp2px(12.0F, BaseApplicationImpl.getContext().getResources());
  ...
  public boky(int paramInt, List<String> paramList, Typeface paramTypeface, Bitmap paramBitmap)
  {
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    int j = (int)this.jdField_a_of_type_AndroidTextTextPaint.measureText(anvx.a(2131700716));
    this.jdField_a_of_type_AndroidTextStaticLayout = bomr.a(paramString, 0, paramString.length(), this.jdField_a_of_type_AndroidTextTextPaint, j, Layout.Alignment.ALIGN_NORMAL, 1.0F, 0.0F, false, null, 0, 3);
    ...
    ykq.b("BubbleTextItem", "set text " + paramString + " max " + j + " tw " + f1 + " th " + f2);
  }
