  ...
  extends bokw
{
  ...
  public boky(FilterDesc paramFilterDesc)
  {
    super(paramFilterDesc);
    this.jdField_a_of_type_Float = -1.0F;
    this.jdField_a_of_type_Bola = new bola(this);
    this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc = paramFilterDesc;
  }
  
  public static int a(Context paramContext, List<FilterDesc> paramList, bolj parambolj, int paramInt)
  {
    boolean bool2 = true;
    boolean bool1 = true;
    if (paramInt == 0) {
  ...
  public static void a(Context paramContext, List<FilterDesc> paramList)
  {
    ...
    QQFilterRenderManager localQQFilterRenderManager = bncu.a(bncu.b);
    if ((localQQFilterRenderManager == null) && (bnic.a() == null))
    {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if ((bnic.a() == null) || (paramContext == null) || (paramContext.size() <= 0)) {
          break;
        }
  ...
  public static boolean a(bolr parambolr, int paramInt)
  {
    if (parambolr != null)
    {
      bolr localbolr = bpye.a().a[paramInt];
      if ((parambolr != null) && (localbolr != null) && (parambolr.b().equals(localbolr.b()))) {}
      for (boolean bool = true;; bool = false)
      {
        if (QLog.isColorLevel()) {
          QLog.d("QCombo", 2, new Object[] { "isApplying :" + parambolr + " ", Boolean.valueOf(bool) });
        }
        return bool;
      }
    }
  ...
  public static void b(List<FilterDesc> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      new bokz(bool2, bool1, localArrayList, paramBoolean).execute(new Void[0]);
      return;
      if (localFilterDesc.id == 9)
      {
        localArrayList.clear();
  ...
  public int a()
  {
    ...
    String str = this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc.getResFold(bqbq.b);
    if ((!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc.resurl)) && (!TextUtils.isEmpty(str)) && (bpya.a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc)))
    {
      b(2);
      return 2;
    }
  ...
  public int b()
  {
    ...
    bpya.a().a(this.jdField_a_of_type_ComTencentMobileqqRichmediaCaptureDataFilterDesc, this.jdField_a_of_type_Bola);
    a();
    return super.b();
  }
