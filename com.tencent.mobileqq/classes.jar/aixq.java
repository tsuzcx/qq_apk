  ...
  extends aixl
{
  ...
  public aixq(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(ajfs paramajfs, int paramInt, AppInterface paramAppInterface, Context paramContext)
  {
    ...
    if (this.jdField_b_of_type_Int > 0)
    {
      if (ApolloUtil.c(5, this.jdField_b_of_type_Int))
      {
        ...
        ajfj.a(paramajfs, 6, paramContext);
        this.d = true;
      ...
      super.a(paramajfs, paramInt, paramAppInterface, paramContext);
  ...
  {
    paramajfs = new Intent();
    paramajfs.putExtra("extra_key_url_append", "&tab=interactive&suin=" + paramQQAppInterface.getCurrentAccountUin());
    ApolloUtil.a(paramContext, paramajfs, "drawer", ajmu.ai, null);
  ...
  public void a(ajfs paramajfs, Context paramContext, QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    ajfj.a(paramajfs, this.jdField_a_of_type_JavaLangString, 7, 0);
