  ...
  implements rgu
{
  ...
  public rgq(Activity paramActivity)
  {
  ...
  private static void b(boolean paramBoolean, int paramInt, KandianMsgBoxRedPntInfo paramKandianMsgBoxRedPntInfo)
  {
    ...
    for (;;)
    {
      try
      {
        localonr.k(1037);
        localonr.a(0);
        localonr.a("message_type", String.valueOf(paramKandianMsgBoxRedPntInfo.messageType));
        localonr.a("feedsid", String.valueOf(paramKandianMsgBoxRedPntInfo.feedsID));
        localonr.a("feedstype", String.valueOf(paramKandianMsgBoxRedPntInfo.feedsType));
        if (paramKandianMsgBoxRedPntInfo.mMsgType == 2)
        {
          localonr.a("sys_msg_id", String.valueOf(paramKandianMsgBoxRedPntInfo.sysMsgID));
          localonr.a("sys_msg_from", String.valueOf(paramKandianMsgBoxRedPntInfo.sysMsgFrom));
        }
        localonr.a("reddot_num", String.valueOf(paramKandianMsgBoxRedPntInfo.mMsgCnt));
        localonr.b("msgbox1000000000");
        if (paramBoolean) {
          break label220;
        }
        localonr.a("behavior_type", String.valueOf(paramInt));
      }
      ...
      noo.a(null, "CliOper", "", String.valueOf(paramKandianMsgBoxRedPntInfo.mUin), str, str, 0, 0, String.valueOf(paramKandianMsgBoxRedPntInfo.mUin), "", "", localonr.a(), false);
      return;
  ...
  private void c()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.setOnClickListener(new rgr(this));
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (TextUtils.isEmpty((CharSequence)localObject2)) {
          localObject1 = this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131694395);
        }
        localJSONObject.put("msgbox_redpoint_content", new ayki(axas.b((String)localObject1), 7, 17));
        ...
        localJSONObject.put("msgbox_redpoint_count", String.format(this.jdField_a_of_type_AndroidAppActivity.getResources().getString(2131694396), new Object[] { bhvh.b(paramKandianMsgBoxRedPntInfo.mMsgCnt) }));
        ...
        {
          localTemplateBean = ProteusParser.getTemplateBean(rpu.a("default_feeds", true), localJSONObject);
        }
