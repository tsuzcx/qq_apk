  ...
  implements DialogInterface.OnCancelListener, View.OnClickListener
{
  ...
  public bhjv(@NonNull Context paramContext)
  {
  ...
  {
    paramContext = LayoutInflater.from(paramContext).inflate(2131559355, null);
    ...
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramContext.findViewById(2131370922));
    this.b = ((TextView)paramContext.findViewById(2131370923));
    this.b.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramContext.findViewById(2131370924));
    ...
    if (paramArrayOfString != null)
    {
      ...
      if (i < paramArrayOfString.length)
      {
        ...
        for (Object localObject = new MiniNumberPicker(getContext());; localObject = new NumberPicker(getContext()))
        {
          ...
          ((NumberPicker)localObject).setOnValueChangedListener(new bhjw(this, i));
  ...
  public void onCancel(DialogInterface paramDialogInterface)
  {
    if (this.jdField_a_of_type_Bhjx != null) {
      this.jdField_a_of_type_Bhjx.onValCancel();
    }
  }
  ...
  public void onClick(View paramView)
  {
    ...
    if (this.jdField_a_of_type_Bhjx != null) {
      this.jdField_a_of_type_Bhjx.onValConfirm(this.jdField_a_of_type_ArrayOfInt);
    }
    a();
  }
}
