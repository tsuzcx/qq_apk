  ...
  implements Manager
{
  ...
  private ajjh jdField_a_of_type_Ajjh = new ajfy(this);
  ...
  static
  {
    ...
    jdField_a_of_type_ArrayOfInt = new int[] { 2130844960, 2130844029, 2130844029, 2130844029, 2130844726, 2130844726, 2130844977, 2130844977, 2130844506, 2130844506, 2130844506, 2130844960, 2130844960, 2130844787, 2130844960 };
  ...
  public ajfw(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(int paramInt, boolean paramBoolean)
  {
    ...
    if (paramInt == 1)
    {
      ...
      if (QLog.isColorLevel())
      {
        ...
        {
          bool = true;
          QLog.d("ConditionSearch.Manager", 2, bool + " | isNetAvaiable = " + badq.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()));
        }
      }
      else
      {
        ...
        localObject = ((axxj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(193)).a(this.jdField_a_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
          QLog.d("ConditionSearch.Manager", 2, "update, find task=" + localObject);
        }
        if ((localObject != null) && ((localObject instanceof ajfz))) {
          ((ajfz)localObject).realStart();
        }
      }
    }
    label246:
    while (paramInt != 2)
    {
      ...
      if (!badq.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp())) {
        return 2;
      }
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        localObject = (ajgd)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(4);
        ((ajgd)localObject).a(null, new GetResourceReqInfo[] { ((ajgd)localObject).e() });
        return 0;
      }
    }
    label264:
  ...
  public List<BaseAddress> a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqConditionsearchDataAddressData != null)
    {
      ...
      Collections.sort(localArrayList, new ajfx(this));
    }
  ...
  public void a(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      paramGetResourceRespInfo = new ajfz(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, paramGetResourceRespInfo, localFile);
      ...
      bool = ((axxj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(193)).a(10023, "prd", (String)localObject, 0, (String)localObject, localFile.getAbsolutePath(), 2, 0, false, paramGetResourceRespInfo);
    } while (!QLog.isColorLevel());
  ...
  void a(boolean paramBoolean1, List<CondFitUser> paramList, boolean paramBoolean2, int paramInt)
  {
    ...
    if (this.jdField_b_of_type_JavaUtilLinkedList != null)
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        ((ajgc)((Iterator)localObject).next()).a(paramBoolean1, paramList, paramBoolean2, paramInt);
      }
    }
  }
  ...
  public int[] a()
  {
    ...
    {
      localCard = ((ajjj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      if (localCard == null) {
        break label357;
      }
  ...
  public String c(String paramString)
  {
    ...
    {
      String[] arrayOfString = baip.a(paramString, '-');
      str = paramString;
      if (arrayOfString.length >= 2)
      {
  ...
  {
    if ((paramObject instanceof ajga))
    {
    ...
    do
    {
      this.jdField_a_of_type_JavaUtilLinkedList.add((ajga)paramObject);
      do
      {
        return;
      } while (!(paramObject instanceof ajgc));
      if (this.jdField_b_of_type_JavaUtilLinkedList == null) {
    ...
    this.jdField_b_of_type_JavaUtilLinkedList.add((ajgc)paramObject);
  }
  ...
  public int d()
  {
    if (this.jdField_g_of_type_Boolean)
    {
      Card localCard = ((ajjj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(51)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      if (localCard == null) {
        break label134;
      }
      if (localCard.shGender != 0) {
  ...
  public void d(Object paramObject)
  {
    ...
    while ((!(paramObject instanceof ajgc)) || (this.jdField_b_of_type_JavaUtilLinkedList == null)) {
      return;
    }
