...
public class ajfw
{
  ...
  public static RecentBaseData a(QQAppInterface paramQQAppInterface, Context paramContext, @NonNull RecentUser paramRecentUser)
  {
    try
    {
      paramQQAppInterface = ajdp.a(paramRecentUser, paramQQAppInterface, paramContext, false);
  ...
  public static String a(Context paramContext)
  {
    ...
    String str = paramContext.getString("8.3.3_has_crash_when_parcel_because", "");
    paramContext.edit().putString("8.3.3_has_crash_when_parcel_because", "").apply();
    return str;
  }
  ...
  public static void a(Context paramContext, boolean paramBoolean, @Nullable Throwable paramThrowable)
  {
    try
    {
      ...
      for (;;)
      {
        ...
        jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.set(true);
        return;
        paramContext.putBoolean("8.3.3_has_crash_when_parcel", true);
        if (paramThrowable != null)
        {
          ...
          paramContext.putString("8.3.3_has_crash_when_parcel_because", localStringWriter.getBuffer().toString());
        }
      }
      return;
    }
  ...
  {
    return paramContext.getSharedPreferences("BootOptimize", 0).getBoolean("8.3.3_has_crash_when_parcel", false);
  }
  ...
  private static boolean b(@NonNull QQAppInterface paramQQAppInterface)
  {
    ...
    boolean bool3 = paramQQAppInterface.getBoolean("8.3.3_has_crash_when_parcel", false);
    long l = paramQQAppInterface.getLong("_last_crash_time", 0L);
    if (System.currentTimeMillis() - l < 1800000L) {}
    for (boolean bool1 = true;; bool1 = false)
    {
      if (QLog.isColorLevel()) {
        QLog.d("BootOptimize", 2, new Object[] { "getUseBootOptimize=[isDebugVersion=", Boolean.valueOf(false), ", use_parcel:", Boolean.valueOf(bool2), ", has_crash=", Boolean.valueOf(bool3), ", appVersion=", "8.3.3", ", lastCrashTime=", Long.valueOf(l), " recentCrash=", Boolean.valueOf(bool1), "]" });
      }
