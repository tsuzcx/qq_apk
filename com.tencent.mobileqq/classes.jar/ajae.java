  ...
  extends alif
{
  public int a;
  public String a;
  public LinkedHashMap<String, List<ajac>> a;
  public List<ajac> a;
  public int[] a;
  public String[] a;
  public int b;
  ...
  public ajae(ChatHistoryTroopMemberFragment paramChatHistoryTroopMemberFragment)
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 1) || (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 11)) {
      paramChatHistoryTroopMemberFragment = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131691649);
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 5) {
        paramChatHistoryTroopMemberFragment = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131695789);
      } else {
        paramChatHistoryTroopMemberFragment = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719265);
      }
    }
  }
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        ((TextView)paramView).setText(this.jdField_a_of_type_ArrayOfJavaLangString[paramInt] + this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719731, new Object[] { Integer.valueOf(localList.size()) }));
  ...
  public Object[] a()
  {
    ...
    Object localObject6 = (bfdm)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getManager(203);
    Object localObject9;
    ...
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)
      {
        ...
        localajac = (ajac)localIterator.next();
        if (((bfdm)localObject6).b(localajac.jdField_a_of_type_JavaLangString))
        {
          ...
          ((List)localObject8).add(localajac);
        }
      }
      ...
      {
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_n_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_n_of_type_JavaLangString.contains(localajac.jdField_a_of_type_JavaLangString))) {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_JavaLangString.contains(localajac.jdField_a_of_type_JavaLangString)) && (!this.jdField_a_of_type_JavaUtilList.contains(localajac))) {
          this.jdField_a_of_type_JavaUtilList.add(localajac);
        }
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_JavaUtilArrayList != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_JavaUtilArrayList.contains(localajac.jdField_a_of_type_JavaLangString)) && (!this.jdField_a_of_type_JavaUtilList.contains(localajac)))
        {
          this.jdField_a_of_type_JavaUtilList.add(localajac);
          this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_JavaUtilArrayList.remove(localajac.jdField_a_of_type_JavaLangString);
        }
      }
      ...
      {
        if ((!this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && ((localajac.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_JavaUtilList.contains(localajac.jdField_a_of_type_JavaLangString)))) {
          ((List)localObject9).add(localajac);
        }
        if ((!this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && (localajac.jdField_b_of_type_Boolean)) {
          localArrayList1.add(localajac);
        }
        if ((!localajac.jdField_a_of_type_JavaLangString.equals(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin())) && (localajac.jdField_d_of_type_Long == 1L)) {
          ((List)localObject10).add(localajac);
        }
      }
      if (((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f.equals(localajac.jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString.contains(localajac.jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && ((localajac.jdField_a_of_type_Int == 332) || (localajac.jdField_a_of_type_Int == 333))))
      {
        ((List)localObject7).add(localajac);
        if (QLog.isColorLevel()) {
          QLog.d("zivonchen", 2, "constructHashStruct uin = " + localajac.jdField_a_of_type_JavaLangString + ", name = " + localajac.jdField_g_of_type_JavaLangString + ", level = " + localajac.jdField_a_of_type_Int);
        }
      }
      else if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 5) && (!TextUtils.isEmpty(localajac.u)))
      {
        ((List)localObject7).add(localajac);
      }
      else
      {
        if (localajac.jdField_c_of_type_JavaLangString == null) {
          break label4292;
        }
        if (localajac.jdField_c_of_type_JavaLangString.length() == 0) {
          break label4292;
        }
        for (;;)
        {
          ...
          ((List)localObject1.get(localObject4)).add(localajac);
          break;
          localObject3 = localajac.jdField_c_of_type_JavaLangString.substring(0, 1);
        }
      }
    }
    localObject6 = new ajaf(0, true);
    ...
    else
    {
      for (;;)
      {
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.h) {
          localObject1.remove(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131718566));
        }
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 21)
        {
          this.jdField_a_of_type_Int = 0;
          Collections.sort((List)localObject7, (Comparator)localObject6);
          ((LinkedHashMap)localObject4).put(amtj.a(2131700740), this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList);
          break label4323;
        }
        if ((((List)localObject9).size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 12))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131718566), localObject9);
        }
        if ((localArrayList1.size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 3))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719240), localArrayList1);
        }
        if ((((List)localObject10).size() > 0) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 3))
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131691191), localObject10);
        }
        if (((List)localObject7).size() > 0)
        {
          Collections.sort((List)localObject7, (Comparator)localObject6);
        ...
        for (localObject3 = ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment);; localObject3 = this.jdField_a_of_type_JavaLangString)
        {
          ...
          ((LinkedHashMap)localObject4).put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719267), localObject8);
          break label4330;
          if (c1 > 'Z') {
            break;
          }
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 2)
        {
          ...
          {
            localObject7 = (ajac)((Iterator)localObject6).next();
            if (TextUtils.isEmpty(((ajac)localObject7).r)) {
              ((ajac)localObject7).r = a((String[])localObject4, ((ajac)localObject7).jdField_b_of_type_Long, (Calendar)localObject3);
            }
            if (localObject1.get(((ajac)localObject7).r) == null) {
              localObject1.put(((ajac)localObject7).r, new ArrayList());
            }
            ((List)localObject1.get(((ajac)localObject7).r)).add(localObject7);
          }
          ...
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject1.get(localObject4[i]), new ajaf(2, false));
        ...
        else if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 6)
        {
          ...
          {
            localObject6 = (ajac)((Iterator)localObject4).next();
            if (TextUtils.isEmpty(((ajac)localObject6).r))
            {
              if (((ajac)localObject6).jdField_b_of_type_Long == 0L) {
                ((ajac)localObject6).jdField_b_of_type_Long = ((ajac)localObject6).jdField_a_of_type_Long;
              }
              ((ajac)localObject6).r = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.a(((ajac)localObject6).jdField_b_of_type_Long, (Calendar)localObject3, ChatHistoryTroopMemberFragment.d(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment), ChatHistoryTroopMemberFragment.e(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment));
            }
            if (localObject2.get(((ajac)localObject6).r) == null) {
              localObject2.put(((ajac)localObject6).r, new ArrayList());
            }
            if (!TextUtils.isEmpty(((ajac)localObject6).r)) {
              ((List)localObject2.get(((ajac)localObject6).r)).add(localObject6);
            }
          }
          localObject3 = new LinkedHashMap();
          ...
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject2.get(ChatHistoryTroopMemberFragment.e(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment).get(i)), new ajaf(2, false));
        ...
        else
        {
          ...
          {
            localObject7 = (ajac)((Iterator)localObject6).next();
            if (TextUtils.isEmpty(((ajac)localObject7).q)) {
              ((ajac)localObject7).q = b((String[])localObject4, ((ajac)localObject7).jdField_a_of_type_Long, (Calendar)localObject3);
            }
            if (localObject2.get(((ajac)localObject7).q) == null) {
              localObject2.put(((ajac)localObject7).q, new ArrayList());
            }
            ((List)localObject2.get(((ajac)localObject7).q)).add(localObject7);
          }
          localObject3 = new LinkedHashMap();
          i = localObject4.length - 1;
          if (i >= 0)
          {
            ...
            Collections.sort((List)localObject2.get(localObject4[i]), new ajaf(3, false));
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 1)
      {
        ...
        {
          localObject10 = (ajac)((Iterator)localObject9).next();
          if (((bfdm)localObject6).b(((ajac)localObject10).jdField_a_of_type_JavaLangString))
          {
            if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 5) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 2) && (!ChatHistoryTroopMemberFragment.f(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment))) {
              if ((this.jdField_c_of_type_JavaUtilList != null) && (this.jdField_c_of_type_JavaUtilList.contains(((ajac)localObject10).jdField_a_of_type_JavaLangString)))
              {
                ((List)localObject3).add(localObject10);
                ((ajac)localObject10).jdField_d_of_type_Boolean = true;
              }
              else
              {
                ((List)localObject8).add(localObject10);
                ((ajac)localObject10).jdField_d_of_type_Boolean = false;
              }
            }
          }
          else if ((this.jdField_c_of_type_JavaUtilList != null) && (this.jdField_c_of_type_JavaUtilList.contains(((ajac)localObject10).jdField_a_of_type_JavaLangString)))
          {
            ((ajac)localObject10).jdField_d_of_type_Boolean = true;
            if (((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.f.equals(((ajac)localObject10).jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_g_of_type_JavaLangString.contains(((ajac)localObject10).jdField_a_of_type_JavaLangString))) || ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.e) && ((((ajac)localObject10).jdField_a_of_type_Int == 332) || (((ajac)localObject10).jdField_a_of_type_Int == 333)))) {
        ...
        localObject2.clear();
        Collections.sort((List)localObject3, new ajaf(1, false));
        if (((List)localObject3).size() > 0) {
          localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719267), localObject3);
        }
        if (((List)localObject4).size() > 0)
        {
          Collections.sort((List)localObject4, new ajaf(1, false));
        ...
        for (localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131694226);; localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131694225))
        {
          localObject2.put(localObject3, localObject4);
          Collections.sort((List)localObject7, new ajaf(1, false));
          if (((List)localObject7).size() > 0) {
            localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719263), localObject7);
          }
          Collections.sort((List)localObject8, new ajaf(1, false));
          if (((List)localObject8).size() <= 0) {
            break;
          }
          localObject2.put(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719262), localObject8);
          break;
        }
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 7)
      {
        ...
        while (i < j)
        {
          localObject9 = (ajac)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList.get(i);
          ((ajac)localObject9).l = 0;
          ((HashMap)localObject8).put(((ajac)localObject9).jdField_a_of_type_JavaLangString, localObject9);
          i += 1;
        }
        if (ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment) != null)
        {
          ...
          {
            localObject9 = (ajac)((HashMap)localObject8).remove(String.valueOf(ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)[i]));
        ...
        if (ChatHistoryTroopMemberFragment.b(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment) != null)
        {
          ...
          {
            localObject9 = (ajac)((HashMap)localObject8).remove(String.valueOf(ChatHistoryTroopMemberFragment.b(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)[i]));
            if (localObject9 == null) {
              break label4375;
            }
        ...
        if (ChatHistoryTroopMemberFragment.c(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment) != null)
        {
          ...
          {
            localObject9 = (ajac)((HashMap)localObject8).remove(String.valueOf(ChatHistoryTroopMemberFragment.c(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment)[i]));
            if (localObject9 == null) {
              break label4382;
            }
        ...
        Collections.sort((List)localObject3, new ajaf(2, true));
        if (!((List)localObject3).isEmpty()) {
          localObject2.put(amtj.a(2131700753), localObject3);
        }
        if (!((List)localObject4).isEmpty()) {
          localObject2.put(amtj.a(2131700813), localObject4);
        }
        if (!((List)localObject6).isEmpty()) {
          localObject2.put(amtj.a(2131700779), localObject6);
        }
        Collections.sort((List)localObject7, new ajaf(2, true));
        if (((List)localObject7).isEmpty()) {
          break label4389;
        }
        localObject2.put(amtj.a(2131700738), localObject7);
        break label4389;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 8)
      {
        ...
        {
          localObject8 = (ajac)((Iterator)localObject7).next();
          localObject9 = (oidb_0xa2a.UserInfo)((HashMap)localObject6).get(((ajac)localObject8).jdField_a_of_type_JavaLangString);
          if (localObject9 != null)
          {
            ((List)localObject3).add(localObject8);
            ((ajac)localObject8).jdField_m_of_type_Int = ((oidb_0xa2a.UserInfo)localObject9).score.get();
          }
          else
          {
        ...
        if (((List)localObject3).size() > 0)
        {
          Collections.sort((List)localObject3, new ajaf(8, false));
          localObject2.put(amtj.a(2131700775), localObject3);
        }
        if (((List)localObject4).size() <= 0) {
          break label4392;
        }
        Collections.sort((List)localObject4, new ajaf(8, false));
        localObject2.put(amtj.a(2131700768), localObject4);
        break label4392;
      }
      if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_m_of_type_Int == 4)
      {
        ...
        localObject6 = amtj.a(2131700744);
        localObject7 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList.iterator();
        while (((Iterator)localObject7).hasNext())
        {
          localObject8 = (ajac)((Iterator)localObject7).next();
          j = ((ajac)localObject8).jdField_a_of_type_Int;
          i = j;
          if (j >= 10000) {
            i = ((ajac)localObject8).jdField_a_of_type_Int - 10000;
          }
          if ((i >= 321) && (i <= 327))
          {
    ...
    for (;;)
    {
      if (i >= 0)
      {
        ...
        {
          Collections.sort((List)((LinkedHashMap)localObject3).get(localObject4[i]), new ajaf(0, false));
      ...
      else
      {
        if (((LinkedHashMap)localObject3).get(localObject6) != null)
        {
          Collections.sort((List)((LinkedHashMap)localObject3).get(localObject6), new ajaf(0, false));
  ...
  public Object getItem(int paramInt)
  {
    ...
    int i = -(i + 1) - 1;
    return (ajac)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
  }
  ...
  public int getItemViewType(int paramInt)
  {
    if (ChatHistoryTroopMemberFragment.e(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment))
    {
      ...
      {
        i = -(i + 1) - 1;
        ajac localajac = (ajac)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
        if ((TextUtils.isEmpty(localajac.jdField_m_of_type_JavaLangString)) && (!TextUtils.isEmpty(localajac.p)) && (!TextUtils.isEmpty(localajac.jdField_g_of_type_JavaLangString)) && (!localajac.jdField_g_of_type_JavaLangString.equals(localajac.p))) {
          return 1;
        }
      }
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      if (i == 0)
      {
        ...
        localObject1 = localObject2;
        label83:
        ((ajaj)localObject1).jdField_a_of_type_JavaLangString = "";
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int != 9) {
          break label307;
        }
        localObject2 = (ajac)this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_JavaUtilList.get(paramInt);
        ((ajaj)localObject1).g.setTag(((ajac)localObject2).jdField_a_of_type_JavaLangString);
        ((ajaj)localObject1).jdField_b_of_type_AndroidViewView.setTag(((ajac)localObject2).jdField_a_of_type_JavaLangString);
        ((ajaj)localObject1).jdField_a_of_type_AndroidViewView.setTag(((ajac)localObject2).jdField_a_of_type_JavaLangString);
        ((ajaj)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setTag(Integer.valueOf(paramInt));
        this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.a((ajaj)localObject1, (ajac)localObject2, a(((ajac)localObject2).jdField_a_of_type_JavaLangString, 2), false, false);
        label195:
        if ((((ajaj)localObject1).jdField_e_of_type_AndroidViewView != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_a_of_type_ComTencentMobileqqWidgetIndexView != null))
        {
          ...
          ((ajaj)localObject1).jdField_e_of_type_AndroidViewView.setVisibility(0);
        }
      }
    }
    for (;;)
    {
      ...
      {
        j = -(j + 1) - 1;
        localObject2 = (ajac)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[j])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[j] - 1);
        ((ajaj)localObject1).g.setTag(((ajac)localObject2).jdField_a_of_type_JavaLangString);
        ((ajaj)localObject1).jdField_b_of_type_AndroidViewView.setTag(((ajac)localObject2).jdField_a_of_type_JavaLangString);
        ((ajaj)localObject1).jdField_a_of_type_AndroidViewView.setTag(((ajac)localObject2).jdField_a_of_type_JavaLangString);
        ((ajaj)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setTag(Integer.valueOf(paramInt));
        Object localObject3;
        if (((ajac)localObject2).jdField_c_of_type_Boolean)
        {
          localObject3 = new bczs(((ajac)localObject2).jdField_b_of_type_JavaLangString, 16).a();
          ((ajaj)localObject1).jdField_e_of_type_AndroidWidgetTextView.setText((CharSequence)localObject3);
          bgdk.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, ((ajaj)localObject1).jdField_e_of_type_AndroidWidgetTextView, (Spannable)localObject3);
          ((ajaj)localObject1).c.setImageResource(2130839608);
          ((ajaj)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setOnClickListener(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.c);
        ...
        for (;;)
        {
          ...
          ((ajaj)localObject1).f.setVisibility(8);
          break;
          localObject3 = this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment;
          Bitmap localBitmap = a(((ajac)localObject2).jdField_a_of_type_JavaLangString, 2);
          if (i == 1) {}
          for (;;)
          {
            ((ChatHistoryTroopMemberFragment)localObject3).a((ajaj)localObject1, (ajac)localObject2, localBitmap, false, bool);
            break;
            bool = false;
          }
          label605:
        ...
        i = VipUtils.d(2);
        ((ajaj)localObject1).jdField_e_of_type_AndroidWidgetTextView.setMaxWidth(i);
        ChatHistoryTroopMemberFragment.a(this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface, ((ajaj)localObject1).jdField_e_of_type_AndroidWidgetTextView, ((ajaj)localObject1).d, ((ajac)localObject2).jdField_a_of_type_JavaLangString, i);
        break label195;
      }
      ((ajaj)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.b(false);
      ((ajaj)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setVisibility(8);
      ((ajaj)localObject1).jdField_a_of_type_AndroidWidgetTextView.setVisibility(8);
      ((ajaj)localObject1).jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      ((ajaj)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setOnClickListener(null);
      ((ajaj)localObject1).g.setTag("");
      ((ajaj)localObject1).jdField_b_of_type_AndroidViewView.setTag("");
      ((ajaj)localObject1).jdField_a_of_type_AndroidViewView.setTag("");
      ((ajaj)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setTag(Integer.valueOf(-1));
      if ((this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 9) || (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 19))
      {
        ((ajaj)localObject1).jdField_b_of_type_AndroidWidgetTextView.setVisibility(8);
        label826:
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.jdField_d_of_type_Int == 12)
        {
          ...
          {
            localObject2 = (ajac)((List)localObject2).get(i);
            if (!this.jdField_a_of_type_JavaUtilList.contains(localObject2)) {
              break label1081;
            }
            ((ajaj)localObject1).jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
      ...
      for (;;)
      {
        ((ajaj)localObject1).jdField_a_of_type_ComTencentMobileqqWidgetTroopMemberListSlideItem.setContentDescription("");
        break;
        ((ajaj)localObject1).jdField_b_of_type_AndroidWidgetTextView.setVisibility(0);
        localObject2 = (List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[j]);
        if (localObject2 == null) {
          break label826;
        }
        if (this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719267).equals(String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[j])))
        {
          ((ajaj)localObject1).jdField_b_of_type_AndroidWidgetTextView.setText(String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[j]));
          break label826;
        }
        ((ajaj)localObject1).jdField_b_of_type_AndroidWidgetTextView.setText(String.valueOf(this.jdField_a_of_type_ArrayOfJavaLangString[j]) + this.jdField_a_of_type_ComTencentMobileqqActivityHistoryChatHistoryTroopMemberFragment.getString(2131719731, new Object[] { Integer.valueOf(((List)localObject2).size()) }));
        break label826;
        label1081:
        ((ajaj)localObject1).jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
      }
      label1094:
      ((ajaj)localObject1).jdField_e_of_type_AndroidViewView.setVisibility(8);
    }
  }
