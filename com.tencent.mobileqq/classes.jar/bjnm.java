  ...
  implements Manager
{
  ...
  public bjnm(QQAppInterface paramQQAppInterface)
  {
  ...
  private bczs a(String paramString)
  {
    paramString = new bczs(paramString, 16);
    paramString.setSpan(new ForegroundColorSpan(BaseApplicationImpl.context.getResources().getColor(2131166246)), 0, paramString.length(), 33);
    return paramString;
  }
  
  public static bjnm a()
  {
    return a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime());
  }
  
  public static bjnm a(QQAppInterface paramQQAppInterface)
  {
    return (bjnm)paramQQAppInterface.getManager(313);
  }
  ...
  {
    return (anpv.a(paramInt)) && (a(paramString));
  }
  
  public static boolean a(QQMessageFacade.Message paramMessage)
  {
    if (paramMessage == null) {}
    while ((!anpv.a(paramMessage.istroop)) || (!a(paramMessage.frienduin))) {
      return false;
    }
    return true;
  }
  ...
  public String a(String paramString, QQMessageFacade.Message paramMessage)
  {
    ...
    if (alem.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.frienduin)) {
      str = amtj.a(2131706745) + paramString;
    }
    return str;
  }
  ...
  public void a(QQMessageFacade.Message paramMessage, Intent paramIntent, SpannableStringBuilder paramSpannableStringBuilder)
  {
    if ((a(paramMessage.frienduin, paramMessage.senderuin)) && (paramMessage.istroop == 1))
    {
      ...
      paramSpannableStringBuilder.append(new bczs("[" + paramIntent + "]", 16));
      paramSpannableStringBuilder.append(a(amtj.a(2131706744)));
      paramSpannableStringBuilder.append(new bczs(paramMessage.nickName, 16));
    }
  }
  
  public void a(QQMessageFacade.Message paramMessage, SpannableStringBuilder paramSpannableStringBuilder)
  {
    if ((alem.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.senderuin)) && (paramMessage.istroop == 0)) {
      paramSpannableStringBuilder.append(a(amtj.a(2131706746)));
    }
  }
  ...
  public String b(String paramString, QQMessageFacade.Message paramMessage)
  {
    ...
    if ((bool) || ((localObject != null) && (((Boolean)localObject).booleanValue())))
    {
      ...
      localObject = amtj.a(2131706747) + paramString;
    }
    do
    {
      do
    ...
    return localResources.getString(2131698717) + paramString;
  }
  
  public void b()
  {
    ((amov)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(2)).h();
  }
  ...
  {
    return alem.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + paramMessage.senderuin);
  }
