  ...
  implements afrr
{
  ...
  public aheu(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt, BaseChatPie paramBaseChatPie)
  {
  ...
  public FrameLayout a(LinearLayout paramLinearLayout)
  {
    ...
    this.jdField_a_of_type_Ahxr = new ahxr();
    this.jdField_a_of_type_Ahxr.jdField_a_of_type_ComTencentMobileqqDataChatMessage = this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg;
    this.jdField_a_of_type_Ahxr.jdField_a_of_type_AndroidWidgetRelativeLayout = this.jdField_a_of_type_Ahxh.b(this.jdField_a_of_type_Ahxr, this.jdField_a_of_type_AndroidContentContext);
    this.jdField_a_of_type_Ahxr.jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg);
    Object localObject1 = paramLinearLayout.findViewById(2131374891);
    ...
    if (localObject1 == null)
    {
      ...
      this.jdField_a_of_type_Ahxr.jdField_a_of_type_AndroidWidgetRelativeLayout = this.jdField_a_of_type_Ahxh.b(this.jdField_a_of_type_Ahxr, this.jdField_a_of_type_AndroidContentContext);
      this.jdField_a_of_type_Ahxr.jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg);
      ((FrameLayout)localObject2).addView(this.jdField_a_of_type_Ahxr.jdField_a_of_type_AndroidWidgetRelativeLayout, a(i, j, k, m));
      View localView = paramLinearLayout.findViewById(2131374920);
      localObject1 = localObject2;
      if (this.jdField_a_of_type_Ahxr.b != null)
      {
    ...
    for (;;)
    {
      ...
      return localObject1;
      label305:
      ((FrameLayout)localObject2).addView(this.jdField_a_of_type_Ahxr.b, (ViewGroup.LayoutParams)localObject1);
      break;
      ...
      if ((localObject1 instanceof FrameLayout))
      {
        ...
        this.jdField_a_of_type_Ahxr.jdField_a_of_type_AndroidWidgetRelativeLayout = this.jdField_a_of_type_Ahxh.b(this.jdField_a_of_type_Ahxr, this.jdField_a_of_type_AndroidContentContext);
        this.jdField_a_of_type_Ahxr.jdField_a_of_type_AndroidWidgetRelativeLayout.setTag(this.jdField_a_of_type_ComTencentMobileqqDataMessageForQQWalletMsg);
        ((FrameLayout)localObject1).addView(this.jdField_a_of_type_Ahxr.jdField_a_of_type_AndroidWidgetRelativeLayout, a(i, j, k, m));
        localObject2 = new RelativeLayout.LayoutParams(i, j);
        paramLinearLayout = paramLinearLayout.findViewById(2131374920);
        if (paramLinearLayout != null) {
          paramLinearLayout.setLayoutParams((ViewGroup.LayoutParams)localObject2);
        } else {
          ((FrameLayout)localObject1).addView(this.jdField_a_of_type_Ahxr.b, (ViewGroup.LayoutParams)localObject2);
        }
      }
      else
      {
  ...
  public void a(RedPackGrapInfo paramRedPackGrapInfo)
  {
    ...
    this.jdField_a_of_type_Int = ahxx.a(paramRedPackGrapInfo.iMsgType);
  ...
  {
    int i = ahxx.a(paramMessageForQQWalletMsg.messageType);
    paramMessageForQQWalletMsg = ahxx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Ahxr, paramMessageForQQWalletMsg.mQQWalletRedPacketMsg.elem, i, this);
    if ((paramMessageForQQWalletMsg instanceof ahxu)) {
      ((ahxu)paramMessageForQQWalletMsg).a(new FaceDecoder(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
    }
    try
    {
  ...
  public boolean a(FrameLayout paramFrameLayout, RedPackGrapInfo paramRedPackGrapInfo, akto paramakto)
  {
    if (paramFrameLayout == null) {
      return false;
    }
    this.jdField_a_of_type_Ahxh.a(paramakto);
    paramFrameLayout = (RelativeLayout)paramFrameLayout.findViewById(2131374891);
    if (paramFrameLayout == null) {
      return false;
    }
    ...
    if (this.jdField_a_of_type_AndroidContentContext != null) {
      this.jdField_a_of_type_AndroidContentContext.getString(2131716638);
    }
    return this.jdField_a_of_type_Ahxh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioCoreBaseChatPie, paramFrameLayout, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_Int, paramRedPackGrapInfo.iSkinId, "");
  }
