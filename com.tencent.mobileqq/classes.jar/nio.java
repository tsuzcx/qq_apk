  ...
  implements View.OnClickListener, AbsListView.OnScrollListener
{
  ...
  private mya jdField_a_of_type_Mya = new nip(this);
  ...
  public nio(Activity paramActivity, QQAppInterface paramQQAppInterface, SwipListView paramSwipListView, View paramView, String paramString)
  {
    ...
    this.b = this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131296618);
    this.c = this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131296617);
    e();
    a(this);
  }
  ...
  private void f()
  {
    ...
    this.d = this.e;
    this.jdField_a_of_type_Boolean = true;
    localmxn.a(this.jdField_a_of_type_JavaLangString, this.d, 2);
  }
  ...
  public void d()
  {
    ...
    if (localmxn != null) {
      localmxn.a(this.jdField_a_of_type_JavaLangString, 0, 2);
    }
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2131558744, null);
      paramView = new nir();
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131363236));
      paramView.b = ((TextView)localView.findViewById(2131363237));
      paramView.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)localView.findViewById(2131363235));
      localView.setTag(paramView);
      localView.setOnClickListener(this);
      localView.setOnTouchListener(new niq(this));
    ...
    for (Object localObject1 = (RoomInfo)localObject1;; localObject1 = null)
    {
      ...
      {
        localObject2 = new StringBuilder(njh.a(((RoomInfo)localObject1).id));
        if (((StringBuilder)localObject2).length() == 9)
        {
          ((StringBuilder)localObject2).insert(6, "-");
          ((StringBuilder)localObject2).insert(3, "-");
        }
        localObject2 = this.jdField_a_of_type_AndroidAppActivity.getString(2131690379) + " " + ((StringBuilder)localObject2).toString();
        paramView.jdField_a_of_type_AndroidWidgetTextView.setText((CharSequence)localObject2);
        localObject2 = String.format(this.jdField_a_of_type_AndroidAppActivity.getString(2131690378), new Object[] { Integer.valueOf(((RoomInfo)localObject1).players.size()) });
      ...
      return localView;
      localObject1 = (nir)paramView.getTag();
      localView = paramView;
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      return;
    } while (!(localObject instanceof nir));
    localObject = ((nir)localObject).jdField_a_of_type_ComTencentAvgameGamelogicDataRoomInfo;
    mxn localmxn = (mxn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(373);
    if (localmxn != null) {
      localmxn.a(this.jdField_a_of_type_AndroidAppActivity, 5, String.valueOf(((RoomInfo)localObject).id), this.jdField_a_of_type_JavaLangString);
    }
    if (this.jdField_a_of_type_JavaLangString != null) {}
    for (localObject = this.jdField_a_of_type_JavaLangString;; localObject = "")
    {
      bcef.b(null, "dc00898", "", "", "0X800B01C", "0X800B01C", 0, 0, "", "", (String)localObject, "");
      break;
    }
  }
