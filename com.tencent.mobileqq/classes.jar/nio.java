  ...
  implements ohx
{
  ...
  private nir jdField_a_of_type_Nir = new nir();
  private Map<Integer, List<niq>> b = new HashMap();
  private Map<String, List<Double>> c = new HashMap();
  
  private nio()
  {
    ohs.a(this);
    bgmy.a().a(this.jdField_a_of_type_Nir);
  }
  ...
  private JSONObject a()
  {
    ...
    localJSONObject.put("cpu_type", babp.g());
    localJSONObject.put("cpu_frequency", babp.a());
    localJSONObject.put("cache_memory", babp.d());
    localJSONObject.put("device_model", babp.d());
    localJSONObject.put("os_version", babp.e());
    if (NetworkState.isWifiConn()) {}
    for (int i = 1;; i = 2)
    {
      localJSONObject.put("network_type", i);
      localJSONObject.put("package_name", "8.2.6.4370");
  ...
  {
    boolean bool = ((Boolean)bgmq.a("sp_key_readinjoy_feeds_drop_frame_switch", Boolean.valueOf(true))).booleanValue();
    QLog.d("ReadInJoyDropFrameHelper", 1, "ReadInJoyDropFrameHelper | Report enable :" + bool);
    return bool;
  }
  
  public void a(int paramInt, niq paramniq)
  {
    if (this.b != null) {
    ...
    {
      if (!((List)localObject).contains(paramniq)) {
        ((List)localObject).add(paramniq);
      }
  ...
  public void b(int paramInt, niq paramniq)
  {
    if ((this.b != null) && (this.b.get(Integer.valueOf(paramInt)) != null)) {
      ((List)this.b.get(Integer.valueOf(paramInt))).remove(paramniq);
    }
  }
