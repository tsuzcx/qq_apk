...
public class bffh
  extends BaseAdapter
  implements apbf, URLDrawableDownListener
{
  ...
  public bffh(Context paramContext, Gallery paramGallery)
  {
    this.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_a_of_type_AndroidViewLayoutInflater = LayoutInflater.from(paramContext);
    this.jdField_a_of_type_ComTencentWidgetGallery = paramGallery;
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130838097);
    this.jdField_a_of_type_AndroidUtilSparseArray = new SparseArray();
    paramContext = (apbm)((AppInterface)BaseApplicationImpl.getApplication().getRuntime()).getManager(180);
    if (paramContext == null) {}
    this.jdField_a_of_type_Apbd = paramContext.a();
    this.jdField_a_of_type_Apbd.a(this);
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Apbd != null) {
      this.jdField_a_of_type_Apbd.b(this);
    }
  }
  ...
  protected void a(int paramInt, MediaPreviewInfo paramMediaPreviewInfo, bffj parambffj)
  {
    long l = System.currentTimeMillis();
    if ((parambffj == null) || (paramMediaPreviewInfo == null)) {
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.i("MediaPreviewAdapter", 2, "loadVideo() mediaInfo = " + paramMediaPreviewInfo);
    }
    parambffj.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
    File localFile;
    boolean bool2;
    if (!TextUtils.isEmpty(paramMediaPreviewInfo.c))
    {
      ...
      if (bool2) {
        a(paramInt, parambffj.jdField_a_of_type_ComTencentImageURLImageView, localFile, paramMediaPreviewInfo.jdField_a_of_type_JavaLangString);
      }
      bool1 = bool2;
      if (QLog.isColorLevel()) {
    ...
    for (boolean bool1 = bool2;; bool1 = false)
    {
      ...
      if (!bool1)
      {
        ...
        {
          bool1 = apbd.b(paramMediaPreviewInfo.b);
          if (bool1)
          {
            localFile = apbd.a(paramMediaPreviewInfo.b);
            a(paramInt, parambffj.jdField_a_of_type_ComTencentImageURLImageView, localFile, paramMediaPreviewInfo.jdField_a_of_type_JavaLangString);
          }
          bool2 = bool1;
          if (QLog.isColorLevel())
      ...
      if (!bool2)
      {
        ...
        parambffj.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(a(paramMediaPreviewInfo.jdField_a_of_type_JavaLangString));
        if (NetworkUtil.isWifiEnabled(this.jdField_a_of_type_AndroidContentContext)) {
          break label401;
        }
        parambffj.jdField_a_of_type_AndroidWidgetImageView.setVisibility(0);
        parambffj.jdField_a_of_type_AndroidWidgetImageView.setOnClickListener(new bffi(this, parambffj, paramMediaPreviewInfo));
      }
      while (QLog.isColorLevel())
      {
        ...
        label401:
        parambffj.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
        b(paramMediaPreviewInfo, parambffj);
        continue;
        label419:
        parambffj.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
        if (QLog.isColorLevel()) {
  ...
  public void a(MediaPreviewInfo paramMediaPreviewInfo, bffj parambffj)
  {
    if ((parambffj == null) || (paramMediaPreviewInfo == null)) {}
    for (;;)
    {
      ...
      try
      {
        ...
        for (paramMediaPreviewInfo = new File(paramMediaPreviewInfo).toURL();; paramMediaPreviewInfo = new URL(paramMediaPreviewInfo))
        {
          ...
          a(parambffj.jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle);
          parambffj.jdField_a_of_type_AndroidWidgetImageView.setVisibility(8);
          paramMediaPreviewInfo = URLDrawable.getDrawable(paramMediaPreviewInfo, (URLDrawable.URLDrawableOptions)localObject);
          parambffj.jdField_a_of_type_ComTencentImageURLImageView.setImageDrawable(paramMediaPreviewInfo);
          parambffj.jdField_a_of_type_ComTencentImageURLImageView.setTag(parambffj);
          parambffj.jdField_a_of_type_ComTencentImageURLImageView.setURLDrawableDownListener(this);
          return;
        }
        if (!QLog.isColorLevel()) {}
      }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    for (localObject = null;; localObject = ((View)localObject).getTag())
    {
      ...
      if ((localMediaPreviewInfo != null) && (paramString.equals(localMediaPreviewInfo.b)) && ((localObject instanceof bffj)))
      {
        a(((bffj)localObject).jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle, paramInt);
        if (QLog.isColorLevel()) {
  ...
  public void a(String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (localObject = null;; localObject = ((View)localObject).getTag())
    {
      ...
      if ((localMediaPreviewInfo != null) && (paramString.equals(localMediaPreviewInfo.b)) && ((localObject instanceof bffj)))
      {
        localObject = (bffj)localObject;
        boolean bool = false;
        paramBoolean2 = bool;
        if (paramBoolean1)
        {
          paramBoolean2 = bool;
          if (apbd.b(localMediaPreviewInfo.b))
          {
            File localFile = apbd.a(localMediaPreviewInfo.b);
            ((bffj)localObject).jdField_a_of_type_ComTencentImageURLImageView.post(new MediaPreviewAdapter.3(this, (bffj)localObject, i, localFile, localMediaPreviewInfo));
            paramBoolean2 = true;
          }
        }
        if (!paramBoolean2)
        {
          ...
          ((bffj)localObject).jdField_a_of_type_ComTencentImageURLImageView.post(new MediaPreviewAdapter.4(this, (bffj)localObject));
        }
      }
      return;
    }
  ...
  protected void b(MediaPreviewInfo paramMediaPreviewInfo, bffj parambffj)
  {
    long l = System.currentTimeMillis();
    if (this.jdField_a_of_type_Apbd != null) {
      this.jdField_a_of_type_Apbd.a(paramMediaPreviewInfo.b);
    }
    a(parambffj.jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle, 0);
    if (QLog.isColorLevel()) {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2131559336, null);
      paramView = new bffj(this);
      ...
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131377717));
    ...
    for (;;)
    {
      ...
      return localView;
      localObject = (bffj)paramView.getTag();
      localView = paramView;
  ...
  {
    a(((bffj)paramView.getTag()).jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle, paramInt);
  }
  
  public void onLoadSuccessed(View paramView, URLDrawable paramURLDrawable)
  {
    paramView = (bffj)paramView.getTag();
    a(paramView.jdField_a_of_type_ComTencentMobileqqWidgetImageProgressCircle);
