  ...
  implements bngj
{
  ...
  private void a(WebViewPlugin paramWebViewPlugin, bioy parambioy, String... paramVarArgs)
  {
    if ((paramVarArgs != null) && (paramVarArgs.length > 0))
    {
      ...
      {
        a(this.jdField_a_of_type_JavaLangString, null, anzj.a(2131711177), -1);
      ...
      String str2 = ((TicketManager)parambioy.a().getManager(2)).getSkey(parambioy.a().getAccount());
      int i = bmtd.a(paramWebViewPlugin, parambioy, 8);
      bmtd.a(parambioy.a(), (bmtk)localObject, str2, l, paramVarArgs, str1, i);
    }
  }
  ...
  public void a(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    {
      a(this.jdField_a_of_type_JavaLangString, null, anzj.a(2131711175), 0);
      return;
    }
    a(this.jdField_a_of_type_JavaLangString, null, anzj.a(2131711178), -1);
  }
  ...
  protected void a(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin != null)
    {
      ...
      {
        paramInt = -1;
        paramString3 = anzj.a(2131711176);
      }
  ...
  public void onWebEvent(String paramString, Bundle paramBundle)
  {
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString))
    {
      a(this.jdField_a_of_type_JavaLangString, null, anzj.a(2131711174), -1);
      return;
    }
    a(this.jdField_a_of_type_JavaLangString, null, anzj.a(2131711179), 0);
  }
}
