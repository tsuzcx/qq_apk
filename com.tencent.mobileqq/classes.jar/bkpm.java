...
{
  public bkpm(QQAppInterface paramQQAppInterface)
  {
  ...
  private oidb_cmd0xd68.ForwardDataWireReqBody a(String paramString1, String paramString2, String paramString3, byte[] paramArrayOfByte, String paramString4, String paramString5, long paramLong)
  {
    ...
    boolean bool = FileUtil.fileExistsAndNotEmpty(paramString1);
    if ((TextUtils.isEmpty(paramString5)) && (bool))
    {
      localForwardDataWireReqBody.str_file_name.set(FileUtil.getFileNameNoEx(paramString1));
      localForwardDataWireReqBody.uint64_file_size.set(FileUtil.getFileSize(paramString1));
    }
  ...
  private void a(ToServiceMsg paramToServiceMsg, oidb_cmd0xd68.RspBody paramRspBody)
  {
    ...
    do
    {
      ...
      paramToServiceMsg = this.app.getFileManagerDataCenter().a(l);
    ...
    afoa.a().a(this.app, paramToServiceMsg.msgSeq);
  ...
  private void b(ToServiceMsg paramToServiceMsg, oidb_cmd0xd68.RspBody paramRspBody)
  {
    ...
    for (int i = 1; i == 0; i = 0)
    {
      if (paramToServiceMsg.status != 2)
      {
        ...
        this.app.getFileManagerDataCenter().c(paramToServiceMsg);
      }
      QLog.e("QfavFileForwardHandler", 1, "Id[" + paramToServiceMsg.nSessionId + "]wk,handleOfflineRsp-->failed ret_code:" + j);
      this.app.getFileManagerNotifyCenter().a(paramToServiceMsg.uniseq, paramToServiceMsg.nSessionId, paramToServiceMsg.peerUin, paramToServiceMsg.peerType, 15, null, j, str);
      return;
    }
    ...
    this.app.getFileManagerDataCenter().a();
    this.app.getFileManagerDataCenter().c(paramToServiceMsg);
    paramToServiceMsg.status = 2;
    aszt.b(paramToServiceMsg.nSessionId);
    ...
    if (paramToServiceMsg.peerType == 3000)
    {
      ...
      this.app.getFileTransferHandler().a(paramToServiceMsg.nSessionId, paramToServiceMsg.peerUin, this.app.getCurrentAccountUin(), paramToServiceMsg.fileName, paramToServiceMsg.fileSize, paramToServiceMsg.Uuid, paramToServiceMsg.uniseq, paramToServiceMsg.msgUid, null);
    }
    for (;;)
    {
      this.app.getFileManagerNotifyCenter().a(paramToServiceMsg, 10, "");
      paramRspBody = new aszs();
      paramRspBody.b = "send_file_suc";
      paramRspBody.a = 1;
      aszr.a(this.app.getCurrentAccountUin(), paramRspBody);
      aszt.a(this.app, paramToServiceMsg);
      return;
      ...
      this.app.getFileTransferHandler().a(paramRspBody, paramToServiceMsg, null);
    }
  }
  ...
  private void c(ToServiceMsg paramToServiceMsg, oidb_cmd0xd68.RspBody paramRspBody)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        paramToServiceMsg = (amqd)this.app.getBusinessHandler(8);
        ...
        paramRspBody = this.app.getMessageFacade().getDatalineMessageManager(i).a(l);
      ...
      {
        localObject = this.app.getFileManagerDataCenter().a(paramRspBody.entityID);
        if (localObject != null)
        {
