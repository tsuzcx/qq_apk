  ...
  extends BusinessHandler
{
  ...
  public mvo(QQAppInterface paramQQAppInterface)
  {
  ...
  public ToServiceMsg a(long paramLong1, String paramString, int paramInt1, int paramInt2, int paramInt3, byte[] paramArrayOfByte, long paramLong2)
  {
    ...
    paramLong1 = auea.b();
    long l = auea.a();
    Object localObject = new bcsf();
    ((bcsf)localObject).jdField_a_of_type_Int = paramInt2;
    ((bcsf)localObject).jdField_a_of_type_ArrayOfByte = paramArrayOfByte;
    paramString = a(13, paramString, (bcsf)localObject, l, bcsc.b(paramLong1), paramLong2);
