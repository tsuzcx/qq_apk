  ...
  public SpannableStringBuilder a(List<SocializeFeedsInfo.BiuCommentInfo> paramList, Context paramContext, EditText paramEditText, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (localBiuCommentInfo.jdField_a_of_type_JavaLangString == null)
      {
        ...
        localArrayList.add(new shd(j, j + ((String)localObject).length(), new BiuNicknameSpan(localBiuCommentInfo.jdField_a_of_type_JavaLangLong.toString(), localBiuCommentInfo.b.longValue(), (CharSequence)localObject, paramContext, paramEditText.getPaint(), paramInt)));
        j = localStringBuilder.length();
        i += 1;
        break;
        ...
        if (localBiuCommentInfo.jdField_a_of_type_JavaLangString == null)
        {
          ...
          localArrayList.add(new shd(j, str2.length() + j, new shb(str3, 13421772)));
          continue;
        }
        ...
        if (localBiuCommentInfo.jdField_a_of_type_JavaLangString == null)
        {
          ...
          localArrayList.add(new shd(j, str2.length() + j, new TopicSpan((TopicInfo)localObject)));
          continue;
        }
        localObject = localBiuCommentInfo.jdField_a_of_type_JavaLangString;
        continue;
      ...
      {
        paramEditText = (shd)paramContext.next();
