  ...
  extends ayoi
{
  ...
  public aywp(BaseApplicationImpl paramBaseApplicationImpl)
  {
  ...
  private File a(String paramString, DownloadParams paramDownloadParams)
  {
    if ((paramDownloadParams.url != null) && (!TextUtils.isEmpty(paramDownloadParams.url.getFile())))
    {
      ...
      {
        str1 = str1;
        str1 = ajsd.aW + paramString + str1 + File.separator + str2;
      ...
      paramDownloadParams = new bbwu(paramDownloadParams, paramString);
      paramDownloadParams.e = anvx.b;
  ...
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    for (;;)
    {
      ...
      if (bool1)
      {
        paramURLDrawableHandler = anqz.a(3, paramOutputStream);
      ...
      for (;;)
      {
        try
        {
          ...
          {
            return localObject2;
            paramURLDrawableHandler = anqz.a(4, paramOutputStream);
            break label195;
          }
          if (!bool1) {
            continue;
          ...
          paramOutputStream = anqz.b(3, paramOutputStream);
        }
        ...
        localObject2 = new bbwu(paramURLDrawableHandler, (File)localObject1);
        ((bbwu)localObject2).e = anvx.b;
        if (bbww.a((bbwu)localObject2, null) != 0) {
          break;
        }
        if (((paramDownloadParams.mExtraInfo instanceof aoaz)) && (("FAVORITE_PANEL_THUMB".equals(str)) || ("FAVORITE_PANEL_THUMB_NEW".equals(str)))) {
          a((aoaz)paramDownloadParams.mExtraInfo);
        }
        if (QLog.isColorLevel()) {
          QLog.i("VasExtensionDownloader", 2, "download sucessful " + paramURLDrawableHandler + " to path " + paramOutputStream);
        }
        return localObject1;
        paramOutputStream = anqz.b(17, paramOutputStream);
        continue;
        if (!((Boolean)localObject1).booleanValue()) {
          paramOutputStream = anqz.b(4, paramOutputStream);
        } else {
          paramOutputStream = anqz.b(18, paramOutputStream);
        }
      }
      if (("FAVOROTE_PANEL_DYNAMIC".equals(str)) || ("BUSINESS_CAMERA_EMO_PANEL_DYNAMIC".equals(str)))
      {
        ...
        if ((paramDownloadParams.mExtraInfo instanceof aoaz))
        {
          localObject1 = ((aoaz)paramDownloadParams.mExtraInfo).e;
        ...
        {
          break label256;
          if ((paramDownloadParams.mExtraInfo instanceof anxv))
          {
            localObject1 = ((anxv)paramDownloadParams.mExtraInfo).e;
            paramURLDrawableHandler = (URLDrawableHandler)localObject1;
            if (QLog.isColorLevel())
            {
              QLog.i("VasExtensionDownloader", 2, String.format("File path %s is not exits, now need download %s", new Object[] { paramOutputStream, localObject1 }));
      ...
      if (("FAVORITE_PANEL_THUMB".equals(str)) || ("FAVORITE_PANEL_THUMB_NEW".equals(str)))
      {
        ...
        localObject2 = ((aoaz)paramDownloadParams.mExtraInfo).e;
      ...
      for (paramURLDrawableHandler = (URLDrawableHandler)localObject2;; paramURLDrawableHandler = null)
      {
        ...
        if ("BUSINESS_CAMERA_EMO_PANEL_THUMB".equals(str))
        {
          ...
          localObject2 = ((anxv)paramDownloadParams.mExtraInfo).e;
          paramURLDrawableHandler = (URLDrawableHandler)localObject2;
          localObject1 = paramOutputStream;
          if (QLog.isColorLevel())
          {
        ...
        for (paramURLDrawableHandler = (URLDrawableHandler)localObject2;; paramURLDrawableHandler = null)
        {
          ...
          if ("REDPACKET_SEND_PIC".equals(str))
          {
            ...
            catch (Throwable paramOutputStream)
            {
              ...
              paramOutputStream = (ajzd)paramOutputStream.getManager(131);
            }
          ...
          if (("COMMERCIAL_DRAINAGE".equals(str)) || ("IP_SITE_IMAGE".equals(str)))
          {
            ...
            for (int i = 22;; i = 23)
            {
              paramDownloadParams = anqz.a(i, paramURLDrawableHandler, MD5.toMD5(paramDownloadParams.url.getFile()));
              if (QLog.isColorLevel()) {
            ...
            paramOutputStream = new bbwu(paramOutputStream, paramDownloadParams);
            paramOutputStream.e = anvx.b;
            if (bbww.a(paramOutputStream, null) != 0) {
              break;
            }
            return paramDownloadParams;
          }
  ...
  public void a(aoaz paramaoaz)
  {
    if (paramaoaz == null) {
      return;
    }
    ThreadManager.post(new VasExtensionDownloader.1(this, paramaoaz), 5, null, false);
  }
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    //   242: astore_3
    //   243: aload_3
    //   244: invokestatic 444	anqz:b	(Ljava/lang/String;)Z
    //   247: ifeq +52 -> 299
    ...
    //   331: aload_3
    //   332: invokestatic 457	anqz:b	(Ljava/lang/String;)[B
    //   335: astore_1
    //   336: aload_1
    //   337: ifnull +92 -> 429
    //   340: aconst_null
    ...
    //   765: invokespecial 525	aywq:<init>	(Laywp;Ljava/io/File;ZF)V
    //   768: astore_1
    //   769: aload_1
    //   770: areturn
    //   771: astore_1
    ...
    //   874: invokestatic 550	bbef:a	(Landroid/graphics/BitmapFactory$Options;II)I
    ...
    //   976: invokevirtual 560	aywp:a	(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    //   979: areturn
    //   980: aload 6
    ...
    //   1595: aload_0
    //   1596: aload_2
    //   1597: invokespecial 595	aywp:a	(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    //   1600: areturn
    //   1601: astore_1
    //   1602: ldc 181
    //   1604: iconst_1
    ...
    //   1679: aload_2
    //   1680: iconst_1
    //   1681: invokespecial 18	aywp:a	(Landroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
    //   1684: areturn
    //   1685: ldc_w 386
    //   1688: aload_3
    ...
    //   1726: aload_2
    //   1727: aload_0
    //   1728: getfield 13	aywp:a	Lcom/tencent/common/app/BaseApplicationImpl;
    ...
    //   1761: aload_2
    //   1762: invokestatic 624	baxi:a	(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    //   1765: areturn
    //   1766: aload 6
    //   1768: areturn
  ...
  public JobQueue getQueue(URL paramURL)
  {
    try
    {
      ...
      paramURL = (anvx)((QQAppInterface)BaseApplicationImpl.getApplication().getAppRuntime(paramURL)).getManager(43);
      if (paramURL != null) {
        return paramURL.a;
      }
    }
