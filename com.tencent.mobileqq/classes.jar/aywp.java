...
public class aywp
  implements aywu
{
  public aywp(OlympicManager paramOlympicManager) {}
  ...
  public void a(String paramString1, String paramString2, Object paramObject, int paramInt, String paramString3)
  {
    ...
    do
    {
      ...
      {
        return;
        ayym.b("OlympicManager", new Object[] { "onDownloadFinish, url=", paramString1, ", md5=", paramString2, ", errCode=", Integer.valueOf(paramInt) });
        if (paramInt == 0) {
        ...
        else if ("shuayishua_anim".equals(str))
        {
          if (paramInt == 0) {
            try
            {
              ...
              paramString1 = ayws.a(paramString2);
        ...
        else if ("ActConfig".equals(str))
        {
          ...
          ayym.a("OlympicManager", new Object[] { "mDownloadListener.onDownloadFinish, type=", str, ", itemType=", paramObject, ", url=", paramString1, ", md5=", paramString2, ", errCode=", Integer.valueOf(paramInt), ", filePath=", paramString3 });
