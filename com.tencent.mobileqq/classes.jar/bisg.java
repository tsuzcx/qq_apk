...
public class bisg
{
  ...
  private bish jdField_a_of_type_Bish;
  ...
  public Frame a(Frame paramFrame, int paramInt1, int paramInt2, List<List<PointF>> paramList, List<float[]> paramList1)
  {
    ...
    for (;;)
    {
      if ((this.jdField_b_of_type_Boolean) && (this.jdField_a_of_type_Bish != null))
      {
        GLES20.glEnable(3042);
        GLES20.glBlendFunc(770, 771);
        float f1 = -1.0F + this.jdField_a_of_type_Bish.jdField_a_of_type_Float * 2.0F;
        float f2 = -1.0F + this.jdField_a_of_type_Bish.b * 2.0F;
        float f3 = this.jdField_a_of_type_Bish.c * 2.0F + f1;
        float f4 = this.jdField_a_of_type_Bish.d * 2.0F + f2;
        this.jdField_a_of_type_ComTencentFilterBaseFilter.setPositions(new float[] { f1, f2, f1, f4, f3, f4, f3, f2 });
        this.jdField_a_of_type_ComTencentFilterBaseFilter.RenderProcess(this.jdField_a_of_type_Bish.jdField_a_of_type_Int, paramFrame.width, paramFrame.height, -1, 0.0D, paramFrame);
  ...
  {
    this.jdField_a_of_type_Bish = new bish(this);
    bisn localbisn = new bisn((int)(320.0F * paramFloat3), (int)(320.0F * paramFloat4));
    localbisn.a(paramString1);
    localbisn.a(paramInt1);
    localbisn.b(paramString2);
    localbisn.c(paramString3);
    localbisn.a(paramInt2);
    localbisn.b();
    paramString1 = localbisn.a();
    this.jdField_a_of_type_Bish.jdField_a_of_type_Int = RendererUtils.createTexture(paramString1);
    localbisn.c();
    this.jdField_a_of_type_Bish.jdField_a_of_type_Float = paramFloat1;
    this.jdField_a_of_type_Bish.b = paramFloat2;
    this.jdField_a_of_type_Bish.c = paramFloat3;
    this.jdField_a_of_type_Bish.d = paramFloat4;
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Bish != null)
    {
      int[] arrayOfInt = new int[1];
      arrayOfInt[0] = this.jdField_a_of_type_Bish.jdField_a_of_type_Int;
