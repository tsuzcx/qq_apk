  ...
  implements IEventReceiver
{
  ...
  private void a(View paramView)
  {
    ...
    paramView = new SpannableString(ajjy.a(2131645004));
    ...
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx.addTextChangedListener(new bisi(this));
    this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setOnEditorActionListener(new bish(this));
  }
