...
public class wpe
  implements uvi
{
  private ulk<String, FeedVideoInfo> a = new ulk(300);
  ...
  public FeedVideoInfo a(int paramInt1, String paramString1, int paramInt2, List<StoryVideoItem> paramList, String paramString2, boolean paramBoolean1, int paramInt3, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (wxe.a()) {
          wxe.b("Q.qqstory.home.data.FeedVideoManager", "**before** update feed video list:" + localFeedVideoInfo);
        }
        ...
        paramString1 = new wpf(paramString1, paramInt1);
        umc.a().dispatch(paramString1);
        if (wxe.a()) {
          wxe.a("Q.qqstory.home.data.FeedVideoManager", "**after** update feed video list:%s", paramList);
        }
  ...
  public FeedVideoInfo a(String paramString, int paramInt)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 20	wpe:a	Lulk;
    //   6: aload_0
    //   7: aload_1
    //   8: iload_2
    //   9: invokespecial 68	wpe:a	(Ljava/lang/String;I)Ljava/lang/String;
    //   12: invokevirtual 71	ulk:a	(Ljava/lang/Object;)Lulj;
    ...
    //   82: invokestatic 87	wxe:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   85: aload_3
    //   86: astore_1
    //   87: goto -64 -> 23
    //   90: astore_1
  ...
  public void a(FeedVideoInfo paramFeedVideoInfo)
  {
    ...
    new wjb(4, paramFeedVideoInfo).c();
    wxe.d("Q.qqstory.home.data.FeedVideoManager", "triggerSyncVideoList for %s", new Object[] { paramFeedVideoInfo });
  }
