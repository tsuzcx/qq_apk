...
public class bjld
{
  public static final SparseArray<ConcurrentHashMap<String, bjld>> a;
  public static final AccelerateInterpolator a;
  public static final ConcurrentHashMap<String, bjld> a;
  public byte a;
  float jdField_a_of_type_Float = 1.0F;
  long jdField_a_of_type_Long;
  public ArrayList<WeakReference<bjle>> a;
  long b = 0L;
  long c = 0L;
  ...
  static bjld a(int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      bjld localbjld2 = (bjld)localConcurrentHashMap.get(paramString);
      bjld localbjld1 = localbjld2;
      if (localbjld2 == null)
      {
        localbjld1 = new bjld();
        localConcurrentHashMap.put(paramString, localbjld1);
      }
      return localbjld1;
    }
  }
  
  public static bjld a(Object paramObject)
  {
    bjld localbjld = null;
    if ((paramObject instanceof bjcq)) {
      localbjld = a(1, ((bjcq)paramObject).a());
    }
    do
    {
      return localbjld;
      ...
      if ((paramObject instanceof bire)) {
        return a(3, ((bire)paramObject).a);
      }
      if ((paramObject instanceof MusicItemInfo)) {
        return a(2, ((MusicItemInfo)paramObject).mMusicName);
      }
      if ((paramObject instanceof bjct)) {
        return a(4, ((bjct)paramObject).a());
      }
    } while (!(paramObject instanceof bjda));
    return a(5, ((bjda)paramObject).a());
  }
  ...
  public void a(float paramFloat)
  {
    ...
    if (i >= 0)
    {
      bjle localbjle = (bjle)((WeakReference)this.jdField_a_of_type_JavaUtilArrayList.get(i)).get();
      if (localbjle == null) {
  ...
  public void a(bjle parambjle)
  {
    int i = this.jdField_a_of_type_JavaUtilArrayList.size() - 1;
    while (i >= 0)
    {
      bjle localbjle = (bjle)((WeakReference)this.jdField_a_of_type_JavaUtilArrayList.get(i)).get();
      if ((localbjle == null) || (localbjle == parambjle)) {
        this.jdField_a_of_type_JavaUtilArrayList.remove(i);
      }
      i -= 1;
    }
  ...
  public void b(bjle parambjle)
  {
    this.jdField_a_of_type_JavaUtilArrayList.add(new WeakReference(parambjle));
  }
