  ...
  extends shb
{
  ...
  phr(ArticleInfo paramArticleInfo, WeakReference<Activity> paramWeakReference)
  {
  ...
  protected boolean a(Integer paramInteger)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localObject2 = ((qcz)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo.a.jdField_a_of_type_JavaUtilArrayList.get(0)).c;
      ...
      try
      {
        ...
        localJSONObject.put("sourceName", ajyc.a(2131702708));
        ...
        localJSONObject.put("desc", ((Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get()).getString(2131718565));
        localJSONObject.put("menu_title", ajyc.a(2131713579));
        ...
        localJSONObject.put("weibo_title", ajyc.a(2131713025));
        localJSONObject.put("uin", "");
        localJSONObject.put("puin", 0);
        if (pgz.a(this.jdField_a_of_type_Pgz) == null) {
          pgz.a(this.jdField_a_of_type_Pgz, new rym());
        }
        pgz.a(this.jdField_a_of_type_Pgz).a(localJSONObject, paramInteger.intValue(), (Activity)this.jdField_a_of_type_JavaLangRefWeakReference.get());
      }
