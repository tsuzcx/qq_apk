...
public class afbf
{
  ...
  AdapterView.OnItemClickListener jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener = new afbg(this);
  ...
  public afbf(FragmentActivity paramFragmentActivity, QQAppInterface paramQQAppInterface, IntimateInfo paramIntimateInfo, Bitmap paramBitmap1, Bitmap paramBitmap2, Bitmap paramBitmap3)
  {
    ...
    if ((this.c == null) || (this.c.isRecycled())) {
      this.c = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130846316);
    }
    if ((this.d == null) || (this.d.isRecycled())) {
      this.d = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130846316);
    }
    jdField_a_of_type_JavaLangString = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693182) + this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693183) + this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693184);
  }
  ...
  private void a(Bitmap paramBitmap, int paramInt)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqWxapiWXShareHelper$WXShareListener = new afbh(this);
    ...
    do
    {
      ...
      if (paramInt == 3)
      {
        WXShareHelper.getInstance().shareImageToWX(str, paramBitmap, 0);
        return;
      }
    } while (paramInt != 4);
    WXShareHelper.getInstance().shareImageToWX(str, paramBitmap, 1);
  }
  ...
  private void b(Bitmap paramBitmap)
  {
    ...
    QZoneHelper.forwardToPublishMood(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, localUserInfo, paramBitmap, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693186), "", 20001);
  }
  
  private void c()
  {
    this.jdField_a_of_type_Bfyx = new bfyx(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    this.jdField_a_of_type_ArrayOfJavaUtilList = a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity);
    this.jdField_a_of_type_Bfyx.setActionSheetItems(this.jdField_a_of_type_ArrayOfJavaUtilList);
    this.jdField_a_of_type_Bfyx.setItemClickListener(this.jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener);
  }
  ...
  private void c(Bitmap paramBitmap)
  {
    try
    {
      ...
      atky.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, (Intent)localObject, 21);
      return;
    }
  ...
  private void e(Bitmap paramBitmap)
  {
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      {
        this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.requestPermissions(new afbi(this, paramBitmap), 1, new String[] { "android.permission.WRITE_EXTERNAL_STORAGE" });
        return;
      }
      a(paramBitmap);
      return;
  ...
  public Bitmap a()
  {
    ...
    try
    {
      localObject2 = new gv().a((String)localObject1, 100, 100, (Map)localObject2);
      k = ((gr)localObject2).a();
      m = ((gr)localObject2).b();
  ...
  public Bitmap a(Bitmap paramBitmap)
  {
    ...
    localCanvas.restore();
    localCanvas.drawBitmap(a(BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840486), 194, 40), 512.0F, 1185.0F, null);
    return paramBitmap;
  }
  ...
  public Bitmap a(IntimateInfo paramIntimateInfo)
  {
    ...
    {
    default: 
      localObject1 = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693174);
      j = Color.parseColor("#03081A");
      i = Color.parseColor("#878B99");
      localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840482);
      ...
      a(localCanvas, localTextPaint, 8.0F + (f + 146.0F), 410.0F, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693126, new Object[] { "" }));
      ...
      localStringBuilder.append(((Resources)localObject1).getString(2131693169));
      localStringBuilder.append("\r\n");
      localStringBuilder.append(((Resources)localObject1).getString(2131693170));
      localStringBuilder.append("\r\n");
      j = 2;
      if ((paramIntimateInfo.commonTroopInfoList != null) && (paramIntimateInfo.commonTroopInfoList.size() > 0))
      {
        localStringBuilder.append(((Resources)localObject1).getString(2131693153));
        localStringBuilder.append(this.jdField_a_of_type_ComTencentMobileqqDataIntimateInfo.commonTroopInfoList.size());
        localStringBuilder.append(((Resources)localObject1).getString(2131693141));
        localStringBuilder.append("\r\n");
        label509:
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (k < j)
        {
          ...
          k += 1;
          continue;
          localObject1 = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693177);
          j = Color.parseColor("#FF6FA3");
          i = Color.parseColor("#FF8AB5");
          localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840485);
          break;
          localObject1 = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693175);
          j = Color.parseColor("#FF8A2D");
          i = Color.parseColor("#FF9F40");
          localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840483);
          break;
          localObject1 = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693181);
          j = Color.parseColor("#8173FF");
          i = Color.parseColor("#8173FF");
          localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840487);
          break;
          localObject1 = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources().getString(2131693176);
          j = Color.parseColor("#2493FF");
          i = Color.parseColor("#4DA7FF");
          localObject2 = BitmapFactory.decodeResource(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources(), 2130840484);
          break;
          j = 3;
          break label509;
        }
      }
      localStringBuilder.append(((Resources)localObject1).getString(2131693171));
      localStringBuilder.append("\r\n");
      localStringBuilder.append(((Resources)localObject1).getString(2131693172));
  ...
  public String a(Bitmap paramBitmap)
  {
    ...
    //   13: invokestatic 698	java/lang/System:currentTimeMillis	()J
    //   16: invokevirtual 701	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   19: aload_0
    //   20: getfield 35	afbf:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   23: invokevirtual 704	com/tencent/mobileqq/app/QQAppInterface:getCurrentAccountUin	()Ljava/lang/String;
    ...
    //   38: astore 4
    //   40: new 363	java/io/File
    //   43: dup
    //   44: new 363	java/io/File
    //   47: dup
    //   48: getstatic 711	com/tencent/mobileqq/app/AppConstants:SDCARD_PATH	Ljava/lang/String;
    //   51: ldc_w 713
    //   54: invokespecial 715	java/io/File:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   57: invokevirtual 718	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   60: invokestatic 724	com/tencent/mobileqq/vfs/VFSAssistantUtils:getSDKPrivatePath	(Ljava/lang/String;)Ljava/lang/String;
    //   63: invokespecial 364	java/io/File:<init>	(Ljava/lang/String;)V
    //   66: astore_3
    //   67: aload_3
    //   68: invokevirtual 727	java/io/File:mkdirs	()Z
    //   71: pop
    //   72: aload_3
    //   73: astore_2
    //   74: aload_3
    //   75: ifnonnull +11 -> 86
    //   78: aload_0
    //   79: getfield 33	afbf:jdField_a_of_type_AndroidSupportV4AppFragmentActivity	Landroid/support/v4/app/FragmentActivity;
    //   82: invokevirtual 731	android/support/v4/app/FragmentActivity:getCacheDir	()Ljava/io/File;
    //   85: astore_2
    //   86: aload_2
    //   87: ifnull +143 -> 230
    //   90: aload_2
    //   91: invokevirtual 734	java/io/File:canWrite	()Z
    //   94: ifeq +136 -> 230
    //   97: new 363	java/io/File
    //   100: dup
    //   101: aload_2
    //   102: invokevirtual 718	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   105: aload 4
    //   107: invokespecial 715	java/io/File:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   110: astore_2
    //   111: aload_2
    //   112: invokevirtual 718	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   115: astore 4
    //   117: aload_2
    //   118: invokevirtual 737	java/io/File:exists	()Z
    //   121: ifeq +8 -> 129
    //   124: aload_2
    //   125: invokevirtual 740	java/io/File:delete	()Z
    //   128: pop
    //   129: new 742	java/io/BufferedOutputStream
    //   132: dup
    //   133: new 744	java/io/FileOutputStream
    //   136: dup
    //   137: aload_2
    //   138: invokespecial 747	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   141: invokespecial 750	java/io/BufferedOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   144: astore_3
    //   145: aload_3
    //   146: astore_2
    //   147: aload_1
    //   148: getstatic 756	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   151: bipush 100
    //   153: aload_3
    //   154: invokevirtual 760	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   157: pop
    //   158: aload_3
    //   159: astore_2
    //   160: aload_3
    //   161: invokevirtual 763	java/io/BufferedOutputStream:flush	()V
    //   164: aload_3
    //   165: ifnull +7 -> 172
    //   168: aload_3
    //   169: invokevirtual 766	java/io/BufferedOutputStream:close	()V
    //   172: aload 4
    //   174: areturn
    //   175: astore_1
    //   176: invokestatic 330	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   179: ifeq -7 -> 172
    //   182: ldc_w 332
    //   185: iconst_2
    //   186: aload_1
    //   187: invokevirtual 769	java/io/IOException:getMessage	()Ljava/lang/String;
    //   190: invokestatic 337	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   193: aload 4
    //   195: areturn
    //   196: astore 4
    //   198: aconst_null
    ...
    //   200: aload_1
    //   201: astore_2
    //   202: invokestatic 330	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   205: ifeq +17 -> 222
    //   208: aload_1
    //   209: astore_2
    //   210: ldc_w 332
    //   213: iconst_2
    //   214: aload 4
    //   216: invokevirtual 770	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   219: invokestatic 337	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   222: aload_1
    //   223: ifnull +7 -> 230
    //   226: aload_1
    //   227: invokevirtual 766	java/io/BufferedOutputStream:close	()V
    //   230: aconst_null
    //   231: areturn
    //   232: astore_1
    //   233: invokestatic 330	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   236: ifeq -6 -> 230
    //   239: ldc_w 332
    //   242: iconst_2
    //   243: aload_1
    //   244: invokevirtual 769	java/io/IOException:getMessage	()Ljava/lang/String;
    //   247: invokestatic 337	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   250: goto -20 -> 230
    //   253: astore_1
    //   254: aconst_null
    //   255: astore_2
    ...
    //   257: ifnull +7 -> 264
    //   260: aload_2
    //   261: invokevirtual 766	java/io/BufferedOutputStream:close	()V
    //   264: aload_1
    //   265: athrow
    //   266: astore_2
    //   267: invokestatic 330	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   270: ifeq -6 -> 264
    //   273: ldc_w 332
    //   276: iconst_2
    //   277: aload_2
    //   278: invokevirtual 769	java/io/IOException:getMessage	()Ljava/lang/String;
    //   281: invokestatic 337	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   284: goto -20 -> 264
    //   287: astore_1
    //   288: goto -32 -> 256
    //   291: astore 4
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Bfyx.a(this.jdField_a_of_type_AndroidGraphicsBitmap);
    this.jdField_a_of_type_Bfyx.show();
  }
  ...
  public void a(int paramInt, Bitmap paramBitmap)
  {
    if ((paramInt == 3) || (paramInt == 4))
    {
      ...
      QQToast.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131693179), 0).b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
    }
    for (;;)
    {
      d();
      ...
      if (!WXShareHelper.getInstance().isWXsupportApi()) {
        QQToast.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131693187), 0).b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
      }
    }
  }
  ...
  public List<ShareActionSheetBuilder.ActionSheetItem>[] a(Context paramContext)
  {
    ...
    localArrayList.add(localActionSheetItem);
    localActionSheetItem = new ShareActionSheetBuilder.ActionSheetItem();
    localActionSheetItem.label = paramContext.getString(2131693189);
    localActionSheetItem.icon = 2130840197;
    localActionSheetItem.iconNeedBg = true;
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Bfyx != null) {
      this.jdField_a_of_type_Bfyx.dismiss();
    }
  }
}
