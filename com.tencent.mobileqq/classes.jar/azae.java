...
public class azae
{
  ...
  public azae(ListView paramListView, azcl paramazcl, List<azcq> paramList)
  {
    this.jdField_a_of_type_AndroidWidgetListView = paramListView;
    this.jdField_a_of_type_Azcl = paramazcl;
    this.jdField_a_of_type_Azcl.a(paramList);
    a(this.jdField_a_of_type_AndroidWidgetListView);
    paramazcl = this.jdField_a_of_type_AndroidWidgetListView.getLayoutParams();
    paramazcl.height = this.jdField_a_of_type_Int;
    paramazcl.width = this.jdField_b_of_type_Int;
    paramListView.setLayoutParams(paramazcl);
    this.jdField_a_of_type_AndroidWidgetListView.setPadding(bawz.a(this.jdField_a_of_type_AndroidWidgetListView.getContext(), 8.0F), -this.jdField_a_of_type_Int, 0, 0);
  }
  
  public static List<azcq> a(JSONArray paramJSONArray)
  {
    ...
    for (;;)
    {
      if (i < paramJSONArray.length())
      {
        ...
        azcq localazcq = new azcq();
        try
        {
          localazcq.a(localJSONObject);
          if (localazcq.a()) {
            localArrayList.add(localazcq);
          }
          i += 1;
        }
  ...
  private void d()
  {
    ...
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addUpdateListener(new azaf(this));
    this.jdField_a_of_type_AndroidAnimationValueAnimator.addListener(new azag(this));
  }
  ...
  private void e()
  {
    ...
    this.jdField_b_of_type_AndroidAnimationValueAnimator.addUpdateListener(new azah(this));
    this.jdField_b_of_type_AndroidAnimationValueAnimator.addListener(new azai(this));
  }
  ...
  public void a(ListView paramListView)
  {
    ...
    this.jdField_b_of_type_Int += bawz.a(this.jdField_a_of_type_AndroidWidgetListView.getContext(), 8.0F);
  }
