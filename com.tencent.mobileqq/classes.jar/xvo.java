  ...
  extends xsw
{
  ...
  private ArrayList<xsx> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private ConcurrentHashMap<Long, xsy> jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap(20);
  
  public xvo(QQAppInterface paramQQAppInterface)
  {
  ...
  private void b(MessageForDeviceFile paramMessageForDeviceFile)
  {
    ...
    {
      Object localObject = (xsx)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((xsx)localObject).a();
      localObject = ((xsx)localObject).a();
      if ((localView != null) && (localObject != null)) {
        ((amsl)localObject).a(localView, paramMessageForDeviceFile);
      }
      for (;;)
      {
        i += 1;
  ...
  {
    paramLong = (xsy)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramLong);
    if (paramLong == null) {
      return null;
    }
  ...
  public MessageForDeviceFile a(String paramString, MessageForDeviceFile paramMessageForDeviceFile)
  {
    ...
    MessageForDeviceFile localMessageForDeviceFile = (MessageForDeviceFile)awbi.a(paramMessageForDeviceFile);
    if ("device_groupchat".equals(paramMessageForDeviceFile.extStr))
    {
      ...
      localMessageForDeviceFile.srcFileName = apck.a(localMessageForDeviceFile.filePath);
      localMessageForDeviceFile.fileSize = apck.a(localMessageForDeviceFile.filePath);
      localMessageForDeviceFile.msgStatus = 2;
      localMessageForDeviceFile.nFileStatus = 1;
      localMessageForDeviceFile.progress = 0.0F;
      ((ajrm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).a(localMessageForDeviceFile);
      ...
      paramString = bacm.a(BaseApplication.getContext(), Uri.parse(localMessageForDeviceFile.filePath));
      bacm.a(BaseApplication.getContext(), localMessageForDeviceFile.filePath, paramString, 160, 160);
      aecw.a(((xrh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(localMessageForDeviceFile.frienduin), localMessageForDeviceFile.filePath, paramString), localMessageForDeviceFile);
    ...
    localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131626018);
    if (paramString.compareTo(xvq.d) == 0)
    {
      localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131626019);
      label361:
      ((ajrm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).a(localMessageForDeviceFile);
      paramMessageForDeviceFile = (xrh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51);
    ...
    for (;;)
    {
      localMessageForDeviceFile.fileSize = apck.a(str1);
      if (!badq.d(BaseApplication.getContext()))
      {
        localMessageForDeviceFile.nFileStatus = 6;
        localMessageForDeviceFile.msgStatus = 1;
      ...
      break;
      if (paramString.compareTo(xvq.c) != 0) {
        break label361;
      }
      localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131626017);
      ...
      break label361;
      label545:
      if (paramString.compareTo(xvq.f) == 0)
      {
  ...
  public void a(long paramLong1, String paramString, int paramInt, long paramLong2)
  {
    ...
    {
      paramString = new xsy(this, paramString, paramInt, paramLong2);
  ...
  public void a(View paramView, amsl paramamsl)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilArrayList.iterator();
    while (localIterator.hasNext())
    {
      xsx localxsx = (xsx)localIterator.next();
      if (localxsx.a() == paramView)
      {
        localxsx.b = new WeakReference(paramamsl);
        return;
      }
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(new xsx(this, paramView, paramamsl));
  }
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    Object localObject2 = ((xrh)localObject1).a(Long.parseLong(localMessageForDeviceFile.frienduin));
    int i = 0;
    long l = 0L;
    ...
    if (paramSession.actionInfo.strServiceName.compareTo(xvq.d) == 0)
    {
    ...
    for (int j = 0;; j = 1)
    {
      yds.a((AppRuntime)localObject2, l, "Net_SendMsg_Pic", 0, j, i);
      if ((paramSession.actionInfo.strServiceName.compareTo(xvq.c) == 0) && (paramSession.bSend) && (paramBoolean))
      {
        ...
        ((xrh)localObject1).a(Long.parseLong(localMessageForDeviceFile.frienduin), str, String.valueOf(((Session)localObject2).uSessionID), paramSession.strFileNameSrc, paramSession.emFileType, localBundle);
        localObject1 = (MessageForDeviceFile)awbi.a(-4500);
        ((MessageForDeviceFile)localObject1).strServiceName = xvq.c;
        ...
        ((MessageForDeviceFile)localObject1).time = awao.a();
        ...
        ((MessageForDeviceFile)localObject1).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131626017);
  ...
  public void a(String paramString, long paramLong, boolean paramBoolean)
  {
    ...
    DeviceInfo localDeviceInfo = ((xrh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(localMessageForDeviceFile.frienduin));
    ...
    for (int i = localDeviceInfo.productId;; i = 0)
    {
      ...
      if (paramBoolean)
      {
        ...
        label76:
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131625716);
        if (paramString.compareTo(xvq.d) != 0) {
          break label251;
        }
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131625721);
      }
      for (;;)
      {
        if (QLog.isDevelopLevel()) {
        ...
        if (paramString.compareTo(xvq.c) == 0)
        {
          ...
          if (!paramBoolean)
          {
            ...
            if (localMessageForDeviceFile.isSend())
            {
              ...
              if (apck.a(localMessageForDeviceFile.filePath) == 0) {
                yds.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 1, 2, i);
              } else {
                yds.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 2, 2, i);
              }
            }
            else
            {
              ...
              for (;;)
              {
                yds.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendPrint", 2, j, i);
                break;
          ...
          {
            if (apck.a(localMessageForDeviceFile.filePath) == 0) {
              yds.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 1, 1, i);
            } else {
              yds.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 2, 1, i);
            }
          }
          else
          {
            yds.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendPrint", 1, 0, i);
          }
        }
      }
    }
  ...
  {
    MessageForStructing localMessageForStructing = awbi.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), 9501, 100L, paramAbsStructMsg);
    ...
    ((xrh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(paramString), paramAbsStructMsg);
  }
  ...
  public void a(String paramString1, String paramString2, List<String> paramList, Bundle paramBundle)
  {
    ...
    if (paramList.hasNext())
    {
      ...
      MessageForDeviceFile localMessageForDeviceFile = (MessageForDeviceFile)awbi.a(-4500);
      ...
      localMessageForDeviceFile.srcFileName = apck.a((String)localObject1);
      localMessageForDeviceFile.fileSize = apck.a((String)localObject1);
      ...
      localMessageForDeviceFile.msgStatus = 2;
      localMessageForDeviceFile.nFileStatus = 1;
      localMessageForDeviceFile.time = awao.a();
      localMessageForDeviceFile.progress = 0.0F;
      localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131626018);
      localMessageForDeviceFile.nFileMsgType = 1;
      if (paramString1.compareTo(xvq.d) == 0)
      {
        localMessageForDeviceFile.nFileMsgType = 2;
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131626019);
      }
      int i;
      if (paramString1.compareTo(xvq.c) == 0)
      {
        int i3 = 1;
        int i2 = 1;
        int i1 = 1;
      ...
      if ((localObject2 != null) && (((xrh)localObject2).a(paramString2))) {
        if (paramString1.compareTo(xvq.d) == 0)
        {
          String str = bacm.a(BaseApplication.getContext(), Uri.parse((String)localObject1));
          bacm.a(BaseApplication.getContext(), (String)localObject1, str, 160, 160);
          localMessageForDeviceFile.uSessionID = ((xrh)localObject2).a(Long.parseLong(paramString2), (String)localObject1, str);
        }
      }
      for (;;)
      {
        ...
        localArrayList.add(localMessageForDeviceFile);
        break;
        if (paramString1.compareTo(xvq.f) == 0)
        {
          localMessageForDeviceFile.uSessionID = ((xrh)localObject2).a(Long.parseLong(paramString2), (String)localObject1, 0);
        }
        else
        {
          if (paramString1.compareTo(xvq.c) == 0)
          {
            localObject2 = ((xrh)localObject2).a(Long.parseLong(paramString2));
            i = 0;
            if (localObject2 != null) {
              i = ((DeviceInfo)localObject2).productId;
            }
            ...
            yds.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 1, 0, i);
          }
          for (;;)
          {
            ...
            break label526;
            label722:
            yds.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "Usr_CloudPrint_SendFile", 2, 0, i);
          }
          localObject1 = ((DeviceFileHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(50)).a((String)localObject1, paramString1, null, Long.parseLong(paramString2));
          if (localObject1 == null) {
            break;
  ...
  public void a(String paramString, List<String> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      MessageForDeviceFile localMessageForDeviceFile = (MessageForDeviceFile)awbi.a(-4500);
      localMessageForDeviceFile.strServiceName = xvq.d;
      localMessageForDeviceFile.msgtype = -4500;
      localMessageForDeviceFile.istroop = 9501;
      localMessageForDeviceFile.filePath = str;
      localMessageForDeviceFile.srcFileName = apck.a(str);
      localMessageForDeviceFile.fileSize = apck.a(str);
      localMessageForDeviceFile.issend = 1;
      localMessageForDeviceFile.isread = true;
      localMessageForDeviceFile.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
      localMessageForDeviceFile.senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
      ...
      localMessageForDeviceFile.time = awao.a();
      localMessageForDeviceFile.progress = 0.0F;
      localMessageForDeviceFile.msg = (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131628854) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131626019));
      localMessageForDeviceFile.nFileMsgType = 2;
      ...
      str = bacm.a(BaseApplication.getContext(), Uri.parse(localMessageForDeviceFile.filePath));
      bacm.a(BaseApplication.getContext(), localMessageForDeviceFile.filePath, str, 160, 160);
      int i = ((xrh)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(Long.parseLong(localMessageForDeviceFile.frienduin), localMessageForDeviceFile.filePath, str);
      localMessageForDeviceFile.uSessionID = i;
      a(localMessageForDeviceFile.uSessionID, localMessageForDeviceFile.frienduin, localMessageForDeviceFile.istroop, localMessageForDeviceFile.uniseq);
      aecw.a(i, localMessageForDeviceFile);
    }
  }
  ...
  public boolean a(String paramString, List<FileInfo> paramList)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        {
          localMessageForDeviceFile.strServiceName = xvq.b;
          continue;
          label512:
          if (localMessageForDeviceFile.strServiceName.compareTo(xvq.f) == 0)
          {
            localMessageForDeviceFile.uSessionID = localxrh.a(Long.parseLong(paramString), ((FileInfo)localObject).c(), 0);
          }
          else
          {
    ...
    if ((localxrh != null) && (localxrh.a(l1, 9))) {}
    for (int i = 1;; i = 0)
    {
      ArrayList localArrayList = new ArrayList();
      paramList = paramList.iterator();
      for (;;)
      {
        ...
        localMessageForDeviceFile = (MessageForDeviceFile)awbi.a(-4500);
        ...
        localMessageForDeviceFile.srcFileName = apck.a(((FileInfo)localObject).c());
        localMessageForDeviceFile.fileSize = apck.a(((FileInfo)localObject).c());
        localMessageForDeviceFile.issend = 1;
        localMessageForDeviceFile.isread = true;
        localMessageForDeviceFile.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
        localMessageForDeviceFile.senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin();
        ...
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131626018);
        localMessageForDeviceFile.nFileMsgType = 1;
        if (localMessageForDeviceFile.strServiceName.compareTo(xvq.d) == 0)
        {
          localMessageForDeviceFile.nFileMsgType = 2;
          localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getString(2131626019);
        }
        ((ajrm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).a(localMessageForDeviceFile);
        if ((localxrh == null) || (!localxrh.a(paramString))) {
          break label600;
        }
        if (localMessageForDeviceFile.strServiceName.compareTo(xvq.d) != 0) {
          break label512;
        }
        localMessageForDeviceFile.uSessionID = localxrh.a(Long.parseLong(paramString), ((FileInfo)localObject).c(), null);
        if (!badq.d(BaseApplication.getContext()))
        {
          localMessageForDeviceFile.nFileStatus = 6;
          localMessageForDeviceFile.msgStatus = 1;
  ...
  public void b(Bundle paramBundle)
  {
    ...
    Object localObject = ((xrh)localObject).a(Long.parseLong(paramBundle.frienduin));
    long l = 0L;
    int i;
    if (localObject != null)
    {
    ...
    {
      int j;
      if (paramBundle.strServiceName.compareTo(xvq.d) == 0)
      {
        localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
        if (m == 0)
        {
          j = 0;
          yds.a((AppRuntime)localObject, l, "Net_SendMsg_Pic", 0, j, i);
        }
      }
      else
      {
