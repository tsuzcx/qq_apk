...
public class oci
{
  public static int a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    if (obz.d(paramBaseArticleInfo)) {
      return 3;
    }
    if (obz.a(paramBaseArticleInfo)) {
      return 2;
    }
    return 0;
  }
  ...
  public static Intent a(Context paramContext, ArticleInfo paramArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      paramContext.putExtra("req_create_time", oby.a(paramArticleInfo.mTime));
  ...
  {
    // Byte code:
    //   0: invokestatic 213	obz:a	()Lmqq/app/AppRuntime;
  ...
  public static Intent b(Context paramContext, ArticleInfo paramArticleInfo)
  {
    if (obz.a(paramArticleInfo.mArticleContentUrl, paramArticleInfo.mChannelID, paramArticleInfo.mFeedType, paramArticleInfo))
    {
      ...
      if (localObject1 != null) {
        ((oph)localObject1).a(paramArticleInfo.mArticleContentUrl, String.valueOf(paramArticleInfo.innerUniqueID), paramArticleInfo.mSubscribeID, 1, null);
      }
    ...
    if (qoe.b(paramArticleInfo))
    {
      ...
      if (!qoe.f(paramArticleInfo)) {
        localObject1 = ((prx)paramArticleInfo.mSocialFeedInfo.a.a.get(0)).b;
      }
    }
    ...
    else
    {
      ...
      localBundle.putBoolean("preload_tool_white_list", obz.g());
      ...
      if ((bace.b(ajed.cE + paramContext)) && (PreloadManager.a().b(paramContext) != null))
      {
        ...
        if (!ogy.a().a(paramArticleInfo.mArticleID))
        {
          ...
          {
            ThreadManager.post(new ReadinjoyJumpUtils.1(paramArticleInfo, (rsf)paramContext.get(0)), 5, null, false);
            if (paramContext.size() <= 1) {
              break label746;
            }
            localBundle.putString("preload_iamge_url", ((rsf)paramContext.get(1)).a);
          }
        }
      }
    }
    for (;;)
    {
      ...
      paramContext = paramArticleInfo.a(paramContext);
      if ((paramContext != null) && (paramContext.size() > 0)) {
        localBundle.putString("preload_iamge_url", ((rsf)paramContext.get(0)).a);
      } else {
        localBundle.putString("preload_iamge_url", null);
      }
    }
