  ...
  extends BusinessHandler
{
  ...
  public avec(QQAppInterface paramQQAppInterface)
  {
    super(paramQQAppInterface);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private avdr a(GameUserInfo paramGameUserInfo)
  {
    ...
    if (GameUserInfo.isUsrInfoUpdate(localavds.a(paramGameUserInfo.mRoleId), paramGameUserInfo))
    {
      QLog.i(b, 1, "[notifyGameUsrInfoChanged], roleId:" + paramGameUserInfo.mRoleId);
      return avdr.a(localavds.a(paramGameUserInfo.mAppId), paramGameUserInfo);
    }
    return null;
  }
      ...
      try
      {
        if (paramFromServiceMsg.isSuccess())
        {
          ...
          if (paramIntent != null)
          {
            ...
            ((avds)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.GAME_CENTER_MSG_MANAGER)).c(paramFromServiceMsg);
          }
        }
      }
      catch (Throwable paramIntent)
  ...
  private void e(Intent paramIntent, FromServiceMsg paramFromServiceMsg, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      paramIntent = (avds)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(QQManagerFactory.GAME_CENTER_MSG_MANAGER);
  ...
  public void a()
  {
    ...
    try
    {
      ...
      localObject = new NewIntent(this.app.getApp(), avee.class);
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      ...
      paramString = new NewIntent(this.app.getApp(), avee.class);
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1 = new NewIntent(this.app.getApp(), avee.class);
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    try
    {
      ...
      ((WebSSOAgent.UniSsoServerReqComm)localObject1).mqqver.set("8.4.10");
    ...
    paramArrayList = new NewIntent(this.app.getApp(), avee.class);
  ...
  public void a(JSONObject paramJSONObject)
  {
    try
    {
      ...
      localUniSsoServerReq.reqdata.set(((JSONObject)localObject).toString());
      paramJSONObject = new NewIntent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), avee.class);
