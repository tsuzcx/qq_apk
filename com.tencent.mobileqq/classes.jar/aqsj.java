  ...
  extends MSFServlet
{
  ...
  private void a(aqsd paramaqsd, oidb_0xdea.GetBarrageListRspBody paramGetBarrageListRspBody)
  {
    ...
    paramaqsd.a(aqsc.a().a(localList1, paramaqsd.jdField_a_of_type_Aqsb.b)).b(localList2).a(m).b(n).c(k).a(bool).a();
  }
  
  void a(aqsd paramaqsd)
  {
    if (paramaqsd == null)
    {
      if (QLog.isColorLevel()) {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("DanmuDataHolder", 2, "request called, param:" + paramaqsd.a());
    }
    Object localObject = new oidb_0xdea.GetBarrageListReqBody();
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint64_group_code.set(paramaqsd.jdField_a_of_type_Aqsb.b);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint64_barrage_seq.set(paramaqsd.jdField_a_of_type_Aqsb.jdField_a_of_type_Long);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_last_update_time.set(paramaqsd.jdField_a_of_type_Int);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_start_index.set(paramaqsd.e);
    ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_barrage_count.set(paramaqsd.f);
    int i;
    if ((paramaqsd.jdField_a_of_type_Aqsb.jdField_a_of_type_Int == 101) || (paramaqsd.jdField_a_of_type_Aqsb.jdField_a_of_type_Int == 103))
    {
      i = 1;
      if (i == 0) {
        break label327;
      }
      ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_video_start_time.set(paramaqsd.jdField_c_of_type_Int);
      ((oidb_0xdea.GetBarrageListReqBody)localObject).uint32_video_end_time.set(paramaqsd.jdField_d_of_type_Int);
      label182:
      ((oidb_0xdea.GetBarrageListReqBody)localObject).terminal.set(0);
      switch (paramaqsd.jdField_a_of_type_Aqsb.jdField_a_of_type_Int)
      {
      }
    }
    for (;;)
    {
      ...
      localObject = aqsc.a().a();
      NewIntent localNewIntent = new NewIntent(((QQAppInterface)localObject).getApp(), aqsj.class);
      localNewIntent.putExtra("KEY_SEND_DATA", localReqBody.toByteArray());
      localNewIntent.putExtra("KEY_GROUP_UIN", paramaqsd.jdField_a_of_type_Aqsb.b);
      localNewIntent.putExtra("KEY_TOPIC_UIN", paramaqsd.jdField_a_of_type_Aqsb.jdField_a_of_type_Long);
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if ((l1 == 0L) || (l2 == 0L))
    {
      ...
      for (;;)
      {
        aqsl.a(bool1, i, -1, false, "onReceive, topicUin:0, groupUin:0");
        return;
        bool1 = false;
      }
    }
    paramIntent = aqsc.a().a(l2, l1);
    aqsd localaqsd = aqsc.a().a(paramIntent);
    if (localaqsd == null)
    {
      if (QLog.isColorLevel()) {
      ...
      {
        aqsl.a(bool1, i, -1, false, "onReceive, holder null");
        return;
      }
    }
    ...
    for (bool1 = true;; bool1 = false)
    {
      ...
      {
        bool2 = true;
        int j = localaqsd.jdField_a_of_type_Aqsb.jdField_a_of_type_Int;
        if (!bool1) {
          break label379;
        }
        paramIntent = "DanmuRsp Valid";
        label246:
        aqsl.a(bool2, i, j, bool1, paramIntent);
        if (!bool1) {
          break label395;
        }
        paramFromServiceMsg = localaqsd.jdField_a_of_type_Aqsh;
        aqsb localaqsb = localaqsd.jdField_a_of_type_Aqsb;
        bool2 = localaqsd.jdField_a_of_type_Boolean;
        i = localaqsd.b;
        if (!localaqsd.jdField_a_of_type_Aqsb.jdField_a_of_type_Boolean) {
          break label386;
        }
        paramIntent = localaqsd.jdField_c_of_type_JavaUtilList;
        label305:
        paramFromServiceMsg.a(localaqsb, true, bool2, i, (ArrayList)paramIntent, localaqsd.jdField_a_of_type_JavaUtilList);
        localaqsd.jdField_a_of_type_Aqsb.jdField_a_of_type_Boolean = true;
      }
      for (;;)
      {
        if ((!bool1) || (localaqsd.jdField_a_of_type_Boolean)) {
          break label424;
        }
        if (QLog.isColorLevel()) {
        ...
        break label246;
        label386:
        paramIntent = localaqsd.jdField_d_of_type_JavaUtilList;
        break label305;
        label395:
        localaqsd.jdField_a_of_type_Aqsh.a(localaqsd.jdField_a_of_type_Aqsb, false, localaqsd.jdField_a_of_type_Boolean, localaqsd.b, null, null);
      }
      label424:
      break;
    }
