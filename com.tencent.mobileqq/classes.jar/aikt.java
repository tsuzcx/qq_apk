...
public final class aikt
{
  public static void a(Activity paramActivity)
  {
    ...
    {
      localObject = new zcp(paramActivity);
      ((TextView)((zcp)localObject).findViewById(2131377893)).setText(alpo.a(2131713977));
      QQAppInterface localQQAppInterface = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      str2 = localQQAppInterface.getApplication().getString(2131719909) + str2;
      paramActivity = new aikz(paramActivity, str1, str3, localQQAppInterface);
      ((zcp)localObject).a(str2, paramActivity);
      ((zcp)localObject).a(paramActivity);
      ((zcp)localObject).setCancelable(false);
      ((zcp)localObject).show();
      return;
    }
  ...
  public static void a(Activity paramActivity, String paramString)
  {
    ...
    String str3 = localQQAppInterface.getApplication().getString(2131719909) + (String)localObject1;
    ...
    for (;;)
    {
      try
      {
        ...
        localObject1 = bdcv.a(((MessageDigest)localObject2).digest());
      }
      ...
      azmj.b(localQQAppInterface, "dc00898", "", "", "0X8009DFB", "0X8009DFB", 0, 0, str2, "1", "", "");
      try
      {
        paramString = bdcd.a(paramActivity, 230);
        paramString.setMessage(alpo.a(2131713976));
        paramString.setNegativeButton(2131690648, new aiku(paramActivity));
    ...
    absn.a(paramActivity, 1, str2, (Bundle)localObject2).a("sdk_dynamic_avatar_edit", null, new aikv(localQQAppInterface, str2, paramActivity, str3, str5, paramString, localIntent));
  }
  ...
  private static void b(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    try
    {
      zcp localzcp = new zcp(paramActivity);
      ((TextView)localzcp.findViewById(2131377893)).setText(paramString1);
      paramString1 = localzcp.findViewById(2131365226);
      View localView = localzcp.findViewById(2131363561);
      paramString1.setVisibility(8);
      localView.setVisibility(8);
      localzcp.findViewById(2131377894).setVisibility(8);
      localzcp.a(paramString2, new aikx(paramActivity, paramString3, paramString4));
      localzcp.setCancelable(false);
      localzcp.show();
      return;
    }
    catch (Exception paramActivity)
  ...
  private static void c(Activity paramActivity)
  {
    ...
    try
    {
      ...
      localObject = bdcd.a(paramActivity, 230);
      ((bdfq)localObject).setMessage(alpo.a(2131713978));
      ((bdfq)localObject).setTitle(2131692310);
      paramActivity = new aiky(paramActivity, str1, str2);
      ((bdfq)localObject).setNegativeButton(2131690648, paramActivity);
      ((bdfq)localObject).setPositiveButton(2131719919, paramActivity);
