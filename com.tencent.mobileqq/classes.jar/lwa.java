...
{
  public lwa(MultiVideoMembersListviewAvtivity paramMultiVideoMembersListviewAvtivity) {}
  
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    if (this.a.jdField_a_of_type_Boolean)
    {
      paramAdapterView = (kth)this.a.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
      ...
      for (paramAdapterView = "https://qvideo.qq.com/mobile/client/level/detail.html?_bid=2176&uin=" + str;; paramAdapterView = "https://qvideo.qq.com/mobile/client/level/pk.html?_bid=2176&my=" + str + "&pk=" + paramAdapterView)
      {
        ...
        awqx.b(null, "P_CliOper", "Grp_qiqiqun", "", "show_member", "Clk_people", 0, 0, "" + this.a.jdField_a_of_type_ComTencentAvVideoController.a, "" + this.a.jdField_a_of_type_ComTencentAvAppVideoAppInterface.getCurrentAccountUin(), "", "");
        return;
      }
    }
    paramAdapterView = (kth)this.a.jdField_a_of_type_JavaUtilArrayList.get(paramInt);
