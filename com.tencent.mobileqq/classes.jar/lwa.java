...
public class lwa
{
  ...
  static volatile lwa jdField_a_of_type_Lwa;
  ...
  private void c()
  {
    ...
    //   3: dup
    //   4: getstatic 21	lwa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   91: aload 4
    //   93: iconst_1
    //   94: invokevirtual 199	lwa:a	(Ljava/lang/String;Z)Z
    //   97: ifne -38 -> 59
    //   100: aload_3
    ...
    //   115: astore_3
    //   116: aload_0
    //   117: getfield 36	lwa:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    ...
    //   194: aload 4
    //   196: aload_0
    //   197: getfield 29	lwa:jdField_a_of_type_Long	J
    ...
    //   253: aload_0
    //   254: aload 4
    //   256: invokespecial 256	lwa:a	(Ljava/lang/String;)Ljava/lang/String;
    //   259: astore_2
    //   260: aload_0
    //   261: getfield 36	lwa:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    ...
    //   319: aload_0
    //   320: aload 4
    //   322: invokespecial 263	lwa:a	(Ljava/lang/String;)V
    //   325: iload_1
    //   326: iconst_1
    //   327: iadd
    //   328: istore_1
    ...
    //   406: invokestatic 296	com/tencent/mobileqq/statistics/StatisticCollector:getInstance	(Landroid/content/Context;)Lcom/tencent/mobileqq/statistics/StatisticCollector;
    //   409: aload_2
    //   410: ldc_w 298
    //   413: iconst_1
    //   414: lconst_0
    ...
    //   418: ldc 19
    //   420: iconst_1
    //   421: invokevirtual 302	com/tencent/mobileqq/statistics/StatisticCollector:collectPerformance	(Ljava/lang/String;Ljava/lang/String;ZJJLjava/util/HashMap;Ljava/lang/String;Z)V
    //   424: aload_0
    //   425: aload 4
    //   427: invokespecial 263	lwa:a	(Ljava/lang/String;)V
    //   430: goto -105 -> 325
    //   433: astore 4
    //   435: goto -306 -> 129
    //   438: astore 4
  ...
  private void d()
  {
    ...
    //   90: ifeq -27 -> 63
    //   93: aload 12
    //   95: invokevirtual 312	java/io/File:length	()J
    //   98: lstore 4
    //   100: lload 4
    //   102: lconst_0
    //   103: lcmp
    ...
    //   156: aconst_null
    //   157: astore 7
    //   159: new 316	java/io/FileInputStream
    //   162: dup
    //   163: aload 12
    //   165: invokespecial 319	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   168: astore 6
    //   170: aload 6
    //   172: aload 9
    //   174: invokevirtual 323	java/io/FileInputStream:read	([B)I
    //   177: pop
    //   178: iload_3
    //   179: istore_2
    //   180: aload 6
    //   182: ifnull +10 -> 192
    //   185: aload 6
    //   187: invokevirtual 326	java/io/FileInputStream:close	()V
    //   190: iload_3
    //   191: istore_2
    //   192: iload_2
    //   193: ifeq +9 -> 202
    ...
    //   225: ifnull +8 -> 233
    //   228: aload 6
    //   230: invokevirtual 326	java/io/FileInputStream:close	()V
    //   233: aload 12
    ...
    //   250: ifnull +8 -> 258
    //   253: aload 6
    //   255: invokevirtual 326	java/io/FileInputStream:close	()V
    //   258: aload 12
    ...
    //   275: ifnull +8 -> 283
    //   278: aload 7
    //   280: invokevirtual 326	java/io/FileInputStream:close	()V
    //   283: iconst_1
    //   284: istore_2
    //   285: iload_2
    //   286: ifeq +9 -> 295
    ...
    //   314: aload 9
    //   316: ldc_w 328
    //   319: new 330	SharpSvrPack/SharpVideoMsg
    //   322: dup
    //   323: invokespecial 331	SharpSvrPack/SharpVideoMsg:<init>	()V
    //   326: invokestatic 337	mqq/app/Packet:decodePacket	([BLjava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    //   329: checkcast 330	SharpSvrPack/SharpVideoMsg
    //   332: astore 7
    //   334: iconst_1
    //   335: istore_2
    //   336: iload_2
    ...
    //   342: ifnull +34 -> 376
    //   345: aload 7
    //   347: getfield 340	SharpSvrPack/SharpVideoMsg:msg_type	J
    //   350: ldc2_w 341
    //   353: lcmp
    //   354: ifne +22 -> 376
    //   357: aload 7
    //   359: getfield 346	SharpSvrPack/SharpVideoMsg:to_uin	Ljava/util/ArrayList;
    //   362: ifnull +14 -> 376
    //   365: aload 7
    //   367: getfield 346	SharpSvrPack/SharpVideoMsg:to_uin	Ljava/util/ArrayList;
    ...
    //   421: aload 10
    //   423: ldc 48
    //   425: invokevirtual 349	java/lang/String:lastIndexOf	(Ljava/lang/String;)I
    //   428: invokevirtual 234	java/lang/String:substring	(II)Ljava/lang/String;
    //   431: astore 9
    //   433: aload 10
    //   435: aload 10
    //   437: ldc 48
    //   439: invokevirtual 349	java/lang/String:lastIndexOf	(Ljava/lang/String;)I
    //   442: iconst_1
    //   443: iadd
    //   444: aload 10
    //   446: ldc_w 351
    ...
    //   549: astore 6
    //   551: aload 9
    //   553: invokestatic 356	java/lang/Long:valueOf	(Ljava/lang/String;)Ljava/lang/Long;
    //   556: invokevirtual 359	java/lang/Long:longValue	()J
    //   559: lstore 4
    //   561: aload 8
    //   563: invokestatic 364	java/lang/Integer:valueOf	(Ljava/lang/String;)Ljava/lang/Integer;
    //   566: invokevirtual 367	java/lang/Integer:intValue	()I
    //   569: istore_2
    //   570: aload_0
    //   571: aload 6
    //   573: aload 7
    //   575: getfield 340	SharpSvrPack/SharpVideoMsg:msg_type	J
    //   578: aload 7
    //   580: getfield 370	SharpSvrPack/SharpVideoMsg:msg_seq	J
    //   583: lload 4
    //   585: aload 7
    //   587: getfield 346	SharpSvrPack/SharpVideoMsg:to_uin	Ljava/util/ArrayList;
    //   590: iconst_0
    //   591: invokevirtual 254	java/util/ArrayList:get	(I)Ljava/lang/Object;
    //   594: checkcast 353	java/lang/Long
    //   597: invokevirtual 359	java/lang/Long:longValue	()J
    //   600: aload 7
    //   602: getfield 373	SharpSvrPack/SharpVideoMsg:from_uin	J
    //   605: iload_2
    //   606: invokevirtual 376	lwa:a	(Ljava/lang/String;JJJJJI)Z
    //   609: pop
    //   610: aload 12
  ...
  boolean a(String paramString, long paramLong1, long paramLong2, long paramLong3, long paramLong4, long paramLong5, int paramInt)
  {
    ...
    //   98: invokestatic 403	android/os/SystemClock:elapsedRealtime	()J
    ...
    //   146: lload 10
    //   148: iload 12
    //   150: invokespecial 406	com/tencent/av/report/VideoSerializeData:<init>	(Ljava/lang/String;JJJJJI)V
    //   153: astore 24
    //   155: aload 24
    //   157: ifnonnull +5 -> 162
    //   160: iconst_0
    ...
    //   185: getstatic 21	lwa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   202: astore 15
    //   204: new 408	java/io/FileOutputStream
    //   207: dup
    //   208: aload 15
    //   210: invokespecial 409	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   213: astore_1
    //   214: aload 15
    //   216: invokevirtual 312	java/io/File:length	()J
    //   219: lstore_2
    //   220: lload_2
    //   221: l2i
    //   222: istore 12
    ...
    //   228: lcmp
    //   229: ifne +653 -> 882
    //   232: new 411	java/io/ByteArrayOutputStream
    //   235: dup
    //   236: iload 12
    //   238: invokespecial 414	java/io/ByteArrayOutputStream:<init>	(I)V
    //   241: astore 15
    //   243: new 416	java/io/ObjectOutputStream
    //   246: dup
    //   247: aload 15
    //   249: invokespecial 419	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   252: astore 16
    //   254: aload 16
    //   256: aload 24
    //   258: invokevirtual 423	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   261: aload 16
    //   263: invokevirtual 426	java/io/ObjectOutputStream:flush	()V
    //   266: aload 15
    //   268: aload_1
    //   269: invokevirtual 429	java/io/ByteArrayOutputStream:writeTo	(Ljava/io/OutputStream;)V
    //   272: aload 15
    //   274: invokevirtual 430	java/io/ByteArrayOutputStream:flush	()V
    //   277: aload 16
    //   279: ifnull +8 -> 287
    //   282: aload 16
    //   284: invokevirtual 431	java/io/ObjectOutputStream:close	()V
    //   287: iconst_1
    //   288: istore 14
    //   290: iload 14
    //   292: istore 13
    ...
    //   296: ifnull +12 -> 308
    //   299: aload 15
    //   301: invokevirtual 432	java/io/ByteArrayOutputStream:close	()V
    //   304: iload 14
    //   306: istore 13
    //   308: iload 13
    //   310: istore 14
    ...
    //   313: ifnull +11 -> 324
    //   316: aload_1
    //   317: invokevirtual 433	java/io/FileOutputStream:close	()V
    //   320: iload 13
    //   322: istore 14
    //   324: iload 14
    //   326: istore 13
    ...
    //   344: getstatic 21	lwa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   423: ifnull +8 -> 431
    //   426: aload 16
    //   428: invokevirtual 431	java/io/ObjectOutputStream:close	()V
    //   431: aload 15
    //   433: ifnull +443 -> 876
    //   436: aload 15
    //   438: invokevirtual 432	java/io/ByteArrayOutputStream:close	()V
    //   441: iconst_0
    //   442: istore 13
    //   444: aload_1
    //   445: ifnull +424 -> 869
    //   448: aload_1
    //   449: invokevirtual 433	java/io/FileOutputStream:close	()V
    //   452: iload 13
    //   454: istore 14
    ...
    //   467: getstatic 21	lwa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   546: ifnull +8 -> 554
    //   549: aload 16
    //   551: invokevirtual 431	java/io/ObjectOutputStream:close	()V
    //   554: aload 15
    //   556: ifnull +8 -> 564
    //   559: aload 15
    //   561: invokevirtual 432	java/io/ByteArrayOutputStream:close	()V
    //   564: aload_1
    //   565: ifnull +7 -> 572
    //   568: aload_1
    //   569: invokevirtual 433	java/io/FileOutputStream:close	()V
    //   572: iconst_0
    //   573: istore 14
    ...
    //   586: getstatic 21	lwa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   658: ifnull +8 -> 666
    //   661: aload 16
    //   663: invokevirtual 431	java/io/ObjectOutputStream:close	()V
    //   666: iconst_1
    //   667: istore 14
    //   669: iload 14
    //   671: istore 13
    ...
    //   675: ifnull +12 -> 687
    //   678: aload 15
    //   680: invokevirtual 432	java/io/ByteArrayOutputStream:close	()V
    //   683: iload 14
    //   685: istore 13
    //   687: iload 13
    //   689: istore 14
    ...
    //   692: ifnull +11 -> 703
    //   695: aload_1
    //   696: invokevirtual 433	java/io/FileOutputStream:close	()V
    //   699: iload 13
    //   701: istore 14
    //   703: iload 14
    //   705: istore 13
    ...
    //   723: getstatic 21	lwa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
  ...
  boolean a(String paramString, boolean paramBoolean)
  {
    ...
    //   10: iconst_0
    //   11: ireturn
    //   12: new 439	java/io/ByteArrayInputStream
    //   15: dup
    ...
    //   27: getstatic 21	lwa:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   43: invokestatic 444	zeb:b	(Ljava/io/File;)[B
    //   46: invokespecial 447	java/io/ByteArrayInputStream:<init>	([B)V
    //   49: astore 5
    //   51: new 449	java/io/ObjectInputStream
    //   54: dup
    //   55: aload 5
    //   57: invokespecial 452	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   60: astore 6
    //   62: aload 6
    //   64: ifnull +13 -> 77
    //   67: aload 6
    //   69: invokevirtual 455	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   72: checkcast 60	com/tencent/av/report/VideoSerializeData
    //   75: astore 7
    //   77: aload 5
    //   79: ifnull +463 -> 542
    //   82: aload 5
    //   84: invokevirtual 456	java/io/ByteArrayInputStream:close	()V
    //   87: iconst_1
    //   88: istore_3
    //   89: aload 6
    //   91: ifnull +8 -> 99
    //   94: aload 6
    //   96: invokevirtual 457	java/io/ObjectInputStream:close	()V
    //   99: aload 7
    ...
    //   114: goto -25 -> 89
    //   117: aload 7
    //   119: getfield 460	com/tencent/av/report/VideoSerializeData:msgType	J
    //   122: ldc2_w 341
    //   125: lcmp
    //   126: ifeq +40 -> 166
    ...
    //   180: aload 7
    //   182: getfield 463	com/tencent/av/report/VideoSerializeData:msgSeq	J
    //   185: invokestatic 241	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   188: invokevirtual 46	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   191: ldc 48
    //   193: invokevirtual 46	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   196: aload 7
    //   198: getfield 466	com/tencent/av/report/VideoSerializeData:type	Ljava/lang/String;
    ...
    //   207: astore 5
    //   209: aload_0
    //   210: getfield 36	lwa:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   213: aload 5
    //   215: aload 7
    //   217: invokevirtual 467	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   220: pop
    //   221: aload_0
    //   222: getfield 38	lwa:jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   225: aload 5
    //   227: aload_1
    //   228: invokevirtual 467	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   231: pop
    //   232: iload_3
    //   233: istore 4
    //   235: goto -128 -> 107
    ...
    //   245: ifnull +7 -> 252
    //   248: aload_1
    //   249: invokevirtual 456	java/io/ByteArrayInputStream:close	()V
    //   252: aload 5
    //   254: ifnull +8 -> 262
    //   257: aload 5
    //   259: invokevirtual 457	java/io/ObjectInputStream:close	()V
    //   262: iconst_0
    //   263: ifeq -253 -> 10
    //   266: new 179	java/lang/NullPointerException
    //   269: dup
    //   270: invokespecial 468	java/lang/NullPointerException:<init>	()V
    //   273: athrow
    //   274: astore_1
    //   275: aconst_null
    //   276: astore 5
    ...
    //   283: ifnull +8 -> 291
    //   286: aload 5
    //   288: invokevirtual 456	java/io/ByteArrayInputStream:close	()V
    //   291: aload 6
    //   293: ifnull +8 -> 301
    //   296: aload 6
    //   298: invokevirtual 457	java/io/ObjectInputStream:close	()V
    //   301: iconst_0
    //   302: ifeq -292 -> 10
    //   305: new 179	java/lang/NullPointerException
    //   308: dup
    //   309: invokespecial 468	java/lang/NullPointerException:<init>	()V
    //   312: athrow
    //   313: astore_1
    //   314: aconst_null
    //   315: astore 5
    ...
    //   322: ifnull +8 -> 330
    //   325: aload 5
    //   327: invokevirtual 456	java/io/ByteArrayInputStream:close	()V
    //   330: aload 6
    //   332: ifnull +8 -> 340
    //   335: aload 6
    //   337: invokevirtual 457	java/io/ObjectInputStream:close	()V
    //   340: iconst_0
    //   341: ifeq -331 -> 10
    //   344: new 179	java/lang/NullPointerException
    //   347: dup
    //   348: invokespecial 468	java/lang/NullPointerException:<init>	()V
    //   351: athrow
    //   352: astore_1
    //   353: aconst_null
    //   354: astore 5
    ...
    //   361: ifnull +8 -> 369
    //   364: aload 5
    //   366: invokevirtual 456	java/io/ByteArrayInputStream:close	()V
    //   369: aload 6
    //   371: ifnull +8 -> 379
    //   374: aload 6
    //   376: invokevirtual 457	java/io/ObjectInputStream:close	()V
    //   379: iconst_0
    //   380: ifeq -370 -> 10
    //   383: new 179	java/lang/NullPointerException
    //   386: dup
    //   387: invokespecial 468	java/lang/NullPointerException:<init>	()V
    //   390: athrow
    //   391: astore_1
    //   392: aconst_null
    //   393: astore 5
    ...
    //   400: ifnull +137 -> 537
    //   403: aload 5
    //   405: invokevirtual 456	java/io/ByteArrayInputStream:close	()V
    //   408: iconst_1
    //   409: istore_2
    //   410: aload 6
    //   412: ifnull +8 -> 420
    //   415: aload 6
    //   417: invokevirtual 457	java/io/ObjectInputStream:close	()V
    //   420: iconst_0
    //   421: ifeq -411 -> 10
    //   424: new 179	java/lang/NullPointerException
    //   427: dup
    //   428: invokespecial 468	java/lang/NullPointerException:<init>	()V
    //   431: athrow
    //   432: astore_1
    //   433: iconst_0
    //   434: istore_2
