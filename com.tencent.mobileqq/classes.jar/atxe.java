...
public class atxe
{
  ...
  @SuppressLint({"NewApi"})
  public static void a(View paramView, String paramString1, atxe paramatxe, String paramString2)
  {
    if ((paramView == null) || (paramatxe == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2)) || (a(paramatxe.jdField_o_of_type_Long))) {}
    do
    {
      do
      {
          ...
          do
          {
            do
            {
              do
              {
                do
                {
                  do
                  {
                    do
                    {
                      do
                      {
                        do
                        {
                          do
                          {
                              ...
                              do
                              {
                                do
                                {
                                  do
                                  {
                                    ...
                                    {
                                      return;
                                      paramatxe = paramatxe.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString2);
                                    } while (paramatxe == null);
                                    if ((!paramString1.equalsIgnoreCase("color")) || (!(paramView instanceof TextView))) {
                                      break;
                                    }
                                    paramView = (TextView)paramView;
                                    if ((paramatxe instanceof ColorStateList))
                                    {
                                      paramView.setTextColor((ColorStateList)paramatxe);
                                      return;
                                    }
                                  } while (!(paramatxe instanceof String));
                                  paramString1 = (String)paramatxe;
                            ...
                            if ((paramatxe instanceof Drawable))
                            {
                              paramString1 = ((Drawable)paramatxe).getConstantState().newDrawable();
                              paramatxe = new Rect();
                              paramString1.getPadding(paramatxe);
                              int i1 = paramView.getPaddingTop();
                              int i2 = paramatxe.top;
                              int i3 = paramView.getPaddingLeft();
                              int i4 = paramatxe.left;
                              int i5 = paramView.getPaddingRight();
                              int i6 = paramatxe.right;
                              int i7 = paramView.getPaddingBottom();
                              int i8 = paramatxe.bottom;
                              paramatxe = paramView.findViewById(2131307374);
                              if (Build.VERSION.SDK_INT >= 16)
                              {
                                paramView.setBackground(paramString1);
                                if (paramatxe != null) {
                                  paramatxe.setBackground(paramString1);
                                }
                              }
                              for (;;)
                              {
                                ...
                                if (paramatxe != null) {
                                  paramatxe.setBackgroundDrawable(paramString1);
                                }
                              }
                            }
                          } while (!(paramatxe instanceof String));
                      ...
                      } while (!(paramatxe instanceof Drawable));
                      paramView = (TextView)paramView;
                    } while (!(paramatxe instanceof Drawable));
                    paramView.setCompoundDrawablesWithIntrinsicBounds(((Drawable)paramatxe).getConstantState().newDrawable(), null, null, null);
                    return;
                ...
                paramView.setCompoundDrawablesWithIntrinsicBounds(null, null, ((Drawable)paramatxe).getConstantState().newDrawable(), null);
                return;
            ...
            paramView.setImageDrawable(((Drawable)paramatxe).getConstantState().newDrawable());
            return;
        ...
        paramView.setContentBackground(((Drawable)paramatxe).getConstantState().newDrawable());
        return;
        if ((!paramString1.equalsIgnoreCase("apngDrawable")) || (!(paramView instanceof ImageView))) {
          break;
        }
      } while (!(paramatxe instanceof URLDrawable));
      ((ImageView)paramView).setImageDrawable((URLDrawable)paramatxe);
      return;
    } while ((!paramString1.equalsIgnoreCase("shimmer_mask")) || (!(paramView instanceof ShimmerLinearLayout)) || (!(paramatxe instanceof BitmapDrawable)));
    paramString1 = (BitmapDrawable)paramatxe;
    paramatxe = (ShimmerLinearLayout)paramView;
  ...
  public Drawable a(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Object localObject3 = azyk.a(paramQQAppInterface, -1L);
        localObject1 = str;
  ...
  public JSONObject a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    //   47: lcmp
    //   48: ifne +23 -> 71
    //   51: getstatic 785	atxe:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   54: ifnull +17 -> 71
    //   57: getstatic 785	atxe:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   60: astore_1
    //   61: aload_1
    //   62: areturn
    //   63: ldc_w 787
    ...
    //   73: lcmp
    //   74: ifeq +13 -> 87
    //   77: getstatic 789	atxe:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   80: ifnull +7 -> 87
    //   83: getstatic 789	atxe:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   86: areturn
    ...
    //   121: aload_1
    //   122: ldc2_w 559
    //   125: invokestatic 565	azyk:a	(Lcom/tencent/mobileqq/app/QQAppInterface;J)Ljava/lang/String;
    //   128: astore_1
    //   129: aload_1
    //   130: ifnull +142 -> 272
    //   133: aload_1
    ...
    //   336: putstatic 785	atxe:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   339: aload 5
    //   341: astore_1
    //   342: getstatic 785	atxe:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   345: astore 6
    //   347: aload 6
    //   349: astore_1
    //   350: aload 5
    ...
    //   383: putstatic 789	atxe:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   386: aload 5
    //   388: astore_1
    //   389: getstatic 789	atxe:jdField_b_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    //   392: astore 6
    //   394: aload 6
    //   396: astore_1
    //   397: aload 5
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        catch (Exception paramQQAppInterface)
        {
          ...
          if (!atyl.a(paramQQAppInterface)) {
            continue;
          }
          str1 = atyo.a(paramQQAppInterface.getApp());
          localObject2 = baop.a(paramQQAppInterface, str1 + "logo.png", "-wzry-card-logo-", a(paramQQAppInterface, str1 + "logo.png", true, true), new int[] { 7 }, "-wzry-card-logo-", null);
