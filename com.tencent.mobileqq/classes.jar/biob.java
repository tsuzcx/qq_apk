  ...
  extends BaseAdapter
{
  ...
  public biob(DraggableGridView paramDraggableGridView, int paramInt)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      binz localbinz = new binz(this.jdField_a_of_type_ComTencentMobileqqWidgetDraggableGridView, this.jdField_a_of_type_Int, paramInt);
      paramView.setOnClickListener(localbinz);
      paramView.setOnLongClickListener(localbinz);
