  ...
  extends AbsDownloader
{
  ...
  public static URLDrawable a(boolean paramBoolean1, String paramString1, URLDrawable.URLDrawableOptions paramURLDrawableOptions, String paramString2, boolean paramBoolean2)
  {
    ...
    if (!paramBoolean1) {}
    for (String str = amip.k + "boxcard/" + paramString1;; str = paramString1)
    {
      ...
      if (localURLDrawableOptions.mExtraInfo == null) {
        localURLDrawableOptions.mExtraInfo = new amdo();
      }
      paramBoolean1 = paramBoolean2;
      if ((localURLDrawableOptions.mExtraInfo instanceof amdo))
      {
        paramURLDrawableOptions = (amdo)localURLDrawableOptions.mExtraInfo;
  ...
  public static boolean a(String paramString)
  {
    ...
    {
      return false;
      String str = amip.k + paramString.substring(paramString.lastIndexOf("/") + 1);
  ...
  public Object decodeFile(File paramFile, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    amdo localamdo;
    if ((paramFile != null) && (paramDownloadParams.mExtraInfo != null) && ((paramDownloadParams.mExtraInfo instanceof amdo)))
    {
      localamdo = (amdo)paramDownloadParams.mExtraInfo;
      if (localamdo.jdField_a_of_type_Int != jdField_a_of_type_Int) {
        break label102;
      }
    }
    for (;;)
    {
      try
      {
        ...
        localBitmap = bfvo.a(localBitmap, localBitmap.getWidth(), localBitmap.getHeight());
      ...
      } while (localamdo.jdField_a_of_type_Int != b);
      if (paramFile.exists())
      {
        ...
        paramURLDrawableHandler.inSampleSize = bfvo.a(paramURLDrawableHandler, paramDownloadParams.reqWidth, paramDownloadParams.reqHeight);
        ...
        try
        {
          ...
          if (paramFile != null) {
            if (localamdo.jdField_a_of_type_Boolean)
            {
              i = 2130849917;
              paramDownloadParams = bfvo.a(paramFile, i, paramDownloadParams.reqWidth, paramDownloadParams.reqHeight, true);
  ...
  public File downloadImage(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    if ((paramDownloadParams.mExtraInfo != null) && ((paramDownloadParams.mExtraInfo instanceof amdo)))
    {
      paramOutputStream = (amdo)paramDownloadParams.mExtraInfo;
      ...
      do
      {
        ...
        bgoe localbgoe = new bgoe(paramOutputStream, paramDownloadParams);
        localbgoe.b = 1;
        localbgoe.p = false;
        localbgoe.q = true;
        localbgoe.r = true;
        i = bgog.a(localbgoe, null);
        if (i != 0) {
          break;
        }
        if (paramURLDrawableHandler != null) {
