  ...
  extends bhrq
{
  ...
  public bhrh()
  {
    this.jdField_a_of_type_JavaLangString = bhrh.class.getSimpleName();
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          abtu.a(this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a(), paramString3, PublicTransFragmentActivity.class, ActivateFriendShareFragment.class);
          return false;
        }
