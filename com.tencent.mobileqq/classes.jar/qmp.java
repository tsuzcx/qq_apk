...
public class qmp
{
  ...
  {
    if ((this.jdField_a_of_type_Slt == null) || (this.jdField_a_of_type_Slt.a() == null)) {
      return null;
    }
  ...
  {
    pay.a(this.jdField_a_of_type_Slt.a(), paramArticleInfo, paramString);
    uhz.a(paramArticleInfo, this.jdField_a_of_type_Slt.a());
    paramString = uhv.b(this.jdField_a_of_type_Slt.a());
    if (!TextUtils.isEmpty(paramString)) {
      odq.a(null, pay.d(paramArticleInfo), paramString, paramString, 0, 0, phd.a(paramArticleInfo.mFeedId), String.valueOf(paramArticleInfo.mArticleID), String.valueOf(paramArticleInfo.mStrategyId), qod.a(paramArticleInfo, paramHashMap), false);
    }
    qmf.c(paramArticleInfo);
    qmf.b(a(paramArticleInfo));
  }
  ...
  private void a(PTSComposer paramPTSComposer, HashMap<String, String> paramHashMap)
  {
    ...
    try
    {
      ...
      qnn.a.a(paramPTSComposer, i, str1, paramHashMap);
      return;
    }
  ...
  private void a(String paramString, View paramView, ArticleInfo paramArticleInfo)
  {
    ...
    if (paramString != null)
    {
      ...
      paramString = (ArticleInfo)this.jdField_a_of_type_Slt.getItem(i + 1);
      j = qmh.a(paramArticleInfo);
      localView = a(i);
    ...
    do
    {
      ...
      i = -1;
      break;
      pwe localpwe = new pwe(this.jdField_a_of_type_Slt.a(), paramArticleInfo, j, this.jdField_a_of_type_Slt.a(), this.jdField_a_of_type_Slt.b(), i, this.jdField_a_of_type_Slt.b(), this.jdField_a_of_type_Slt.getCount(), paramString, this.jdField_a_of_type_Slt);
      localqrx = new qrx(this.jdField_a_of_type_Slt.a(), this.jdField_a_of_type_Slt.a(), this.jdField_a_of_type_Slt);
      localqrx.a(localpwe);
      localqrx.a(localView);
      localqrx.a(paramView);
      paramView = a(paramArticleInfo);
    } while (paramView == null);
    localqrx.a(new pwe(this.jdField_a_of_type_Slt.a(), paramView, j, this.jdField_a_of_type_Slt.a(), this.jdField_a_of_type_Slt.b(), i, this.jdField_a_of_type_Slt.b(), this.jdField_a_of_type_Slt.getCount(), paramString, this.jdField_a_of_type_Slt));
  }
  ...
  {
    if ((TextUtils.isEmpty(paramString)) || (paramHashMap == null) || (paramView == null) || (this.jdField_a_of_type_Slt == null) || (this.jdField_a_of_type_JavaUtilHashMap == null) || (this.b == null)) {
    ...
    odq.a(null, pay.d(localArticleInfo), str3, str3, 0, 0, phd.a(localArticleInfo.mFeedId), String.valueOf(localArticleInfo.mArticleID), String.valueOf(localArticleInfo.mStrategyId), qod.a(localArticleInfo, paramHashMap), false);
  }
}
