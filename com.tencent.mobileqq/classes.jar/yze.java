...
public class yze
{
  ...
  public static int a(String paramString, int paramInt)
  {
    ...
    {
      yxs.d("GdtUIUtils", "getColor error", paramString);
    }
    return paramInt;
  }
  ...
  public static Drawable a(@ColorInt int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      localPaintDrawable.setShaderFactory(new yzf(f1, f3, f2, f4, arrayOfInt));
  ...
  public static void a(Activity paramActivity)
  {
    ...
    {
      a(paramActivity);
      yxs.a("GdtMvViewController", "enableNotch && updateLiuhaiTopHeight 0");
    }
  }
  ...
  public static boolean a(Activity paramActivity)
  {
    ...
    yxs.a("GdtMvViewController", "hasTopLiuHai  " + bkur.a);
    return bkur.a;
  }
  ...
  private static int b(Activity paramActivity)
  {
    ...
    if (i > 27) {
      return bkur.a(paramActivity);
    }
    return bkur.b(paramActivity);
  }
  ...
  public static int b(Context paramContext)
  {
    ...
    {
      yxs.d("GdtUIUtils", "getScreenWidth error");
      return -2147483648;
    }
  ...
  public static int d(Context paramContext)
  {
    ...
    while ((paramContext.getResources() == null) || (paramContext.getResources().getDisplayMetrics() == null))
    {
      yxs.d("GdtUIUtils", "getScreenHeight error");
      return -2147483648;
    }
