  ...
  implements Handler.Callback, Manager
{
  ...
  ArrayList<avqe> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private Comparator<avqe> jdField_a_of_type_JavaUtilComparator = new altd(this);
  private HashSet<String> jdField_a_of_type_JavaUtilHashSet = new HashSet();
  private LinkedList<alti> jdField_a_of_type_JavaUtilLinkedList = new LinkedList();
  ...
  ArrayList<avpz> jdField_b_of_type_JavaUtilArrayList = new ArrayList();
  private Comparator<SysSuspiciousMsg> jdField_b_of_type_JavaUtilComparator = new alte(this);
  public boolean b;
  private int jdField_c_of_type_Int;
  private Comparator<Object> jdField_c_of_type_JavaUtilComparator = new alth(this);
  public boolean c;
  private int d = -1;
  public boolean d;
  ...
  static
  {
    jdField_a_of_type_JavaLangString = alpo.a(2131707862);
  }
  
  public altc(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppPhoneContactManagerImp.a(this.jdField_a_of_type_Aubn);
  ...
  private void a(avqe paramavqe)
  {
    ...
    do
    {
      ...
      localRecentUser = localamjk.a(aljq.D, 4000);
    ...
    if ((paramavqe != null) && ((paramavqe instanceof avqb)))
    {
      localRecentUser.lastmsgdrafttime = paramavqe.jdField_a_of_type_Long;
      localRecentUser.msg = paramavqe.jdField_a_of_type_JavaLangString;
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      return;
      if ((paramavqe != null) && ((paramavqe instanceof avpz)) && (!TextUtils.isEmpty(paramavqe.jdField_a_of_type_JavaLangString)))
      {
        if (paramavqe.jdField_a_of_type_Long > 0L) {
          localRecentUser.lastmsgtime = paramavqe.jdField_a_of_type_Long;
        }
        localRecentUser.msg = paramavqe.jdField_a_of_type_JavaLangString;
        if (QLog.isColorLevel()) {
  ...
  private void a(ArrayList<MayKnowRecommend> paramArrayList, ArrayList<avqe> paramArrayList1)
  {
    ...
    do
    {
      ...
      localArrayList = ((anuj)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(112)).a();
      if (QLog.isColorLevel()) {
    ...
    localObject = new avqa((ConnectsExplorationBanner)localObject);
  ...
  private boolean a(avqe paramavqe)
  {
    ...
    do
    {
      return false;
      localamjk = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
    } while ((paramavqe == null) || (localamjk == null) || ((paramavqe.a()) && (!localamjk.a(aljq.D, 4000))));
    return true;
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    while ((!paramString.equals(aljq.D)) && (!paramString.equals(aljq.ax)) && (!paramString.equals(aljq.M)) && (!paramString.equals(aljq.aF))) {
      return false;
    }
    return true;
  }
  ...
  public static boolean a(MessageRecord paramMessageRecord)
  {
    ...
    try
    {
      boolean bool = avpz.a(MessageForSystemMsg.parseStructMsg(paramMessageRecord.msgData));
      return bool;
    }
  ...
  private ArrayList<avpz> d()
  {
    for (;;)
    {
      try
      {
        ...
        Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(aljq.M, 0);
        if ((localObject1 != null) && (((List)localObject1).size() > 0))
        {
          ...
          if (((Iterator)localObject1).hasNext())
          {
            ...
            if (((((MessageForSystemMsg)localMessageRecord).structMsg.msg.sub_type.get() == 13) && (this.jdField_a_of_type_Aloz.b(String.valueOf(((MessageForSystemMsg)localMessageRecord).structMsg.req_uin.get())))) || (localMessageRecord.isread)) {
              continue;
            }
            if (QLog.isColorLevel()) {
            ...
            avpz localavpz = (avpz)localIterator.next();
            if ((localavpz.jdField_a_of_type_ComTencentMobileqqSystemmsgMessageForSystemMsg == null) || (!localavpz.jdField_a_of_type_ComTencentMobileqqSystemmsgMessageForSystemMsg.senderuin.equals(localMessageRecord.senderuin))) {
              continue;
            }
            i = 1;
            if (i != 0) {
            ...
            this.jdField_b_of_type_JavaUtilArrayList.add(new avpz((MessageForSystemMsg)localMessageRecord));
            continue;
          }
        }
        if (!QLog.isColorLevel()) {
  ...
  private void m()
  {
    ...
    Object localObject = (ArrayList)localawbw.a(QIMFollwerAdd.class);
    if (localObject != null)
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        localawbw.a(localQIMFollwerAdd);
      }
    }
    localawbw.a();
  }
  ...
  public aoki a()
  {
    if (this.jdField_a_of_type_Aoki == null) {
      this.jdField_a_of_type_Aoki = aokk.a();
    }
    return this.jdField_a_of_type_Aoki;
  }
  ...
  public avqe a()
  {
    ...
    {
      localavqe1 = (avqe)((ArrayList)localObject).get(i);
      if ((localavqe1 == null) || (localavqe1.a())) {}
    }
    for (;;)
    {
      if ((localavqe1 != null) && (!(localavqe1 instanceof avpx)) && (!(localavqe1 instanceof avqb)))
      {
        i = j;
        if (!(localavqe1 instanceof avpy)) {
          break label80;
        }
      }
      for (;;)
      {
        ...
        do
        {
          ...
          localavqe2 = (avqe)((ArrayList)localObject).get(i);
        } while ((localavqe2 == null) || (localavqe2.a()) || ((localavqe2 instanceof avpz)));
        while (localavqe2 != null)
        {
          localObject = localavqe2;
          if (localavqe1.jdField_a_of_type_Long >= localavqe2.jdField_a_of_type_Long) {
            localObject = localavqe1;
          }
          return localObject;
          localavqe2 = null;
        }
  ...
  public List<Object> a()
  {
    ...
    {
      localObject = (avqe)localIterator.next();
      if ((localObject != null) && (!((avqe)localObject).a())) {
        if ((localObject instanceof avpz))
        {
          i += 1;
        }
        else if ((localObject instanceof avpx))
        {
    ...
    if (QLog.isColorLevel())
    {
      ...
      if (localArrayList.size() > 0)
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          } else if ((localObject instanceof avpz)) {
            QLog.d("NewFriendManager", 2, "getAllUnreadMsg FriendSystemMessage time  = " + ((avpz)localObject).jdField_a_of_type_Long * 1000L);
          } else if ((localObject instanceof avpy)) {
            QLog.d("NewFriendManager", 2, "getAllUnreadMsg ContactMatchMessage time  = " + ((avpy)localObject).jdField_a_of_type_Long * 1000L);
          }
        }
      }
    }
  ...
  public void a(long paramLong)
  {
    ...
    if ((this.jdField_a_of_type_Awbw != null) && (this.jdField_a_of_type_Awbw.a()))
    {
      ...
      localSysSuspiciousMsg = (SysSuspiciousMsg)this.jdField_a_of_type_Awbw.a(SysSuspiciousMsg.class, paramLong);
    }
    label114:
    for (;;)
    {
      boolean bool = false;
      if (localSysSuspiciousMsg != null) {
        bool = this.jdField_a_of_type_Awbw.b(localSysSuspiciousMsg);
      }
      if (QLog.isColorLevel()) {
  ...
  public void a(alti paramalti)
  {
    synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
    {
      if (!this.jdField_a_of_type_JavaUtilLinkedList.contains(paramalti)) {
        this.jdField_a_of_type_JavaUtilLinkedList.add(paramalti);
      }
      return;
    }
  }
  
  public void a(avpz paramavpz)
  {
    long l = baaz.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(aljq.M, 0, l).iterator();
    ...
    for (localObject = new avpz((MessageForSystemMsg)localMessageRecord);; localObject = null)
    {
      if (localObject != null)
      {
        ((avpz)localObject).jdField_a_of_type_Long = paramavpz.jdField_a_of_type_Long;
        ((avpz)localObject).jdField_a_of_type_JavaLangString = paramavpz.jdField_a_of_type_JavaLangString;
        a((avqe)localObject);
        setChanged();
  ...
  {
    if ((paramSysSuspiciousMsg != null) && (this.jdField_a_of_type_Awbw != null) && (this.jdField_a_of_type_Awbw.a()))
    {
      this.jdField_a_of_type_Awbw.b(paramSysSuspiciousMsg);
  ...
  public void a(boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (this.jdField_a_of_type_Boolean)
        {
          ...
          {
            long l = baaz.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
            localObject7 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(aljq.M, 0, l);
            ...
            if (this.jdField_a_of_type_Aloz.b(String.valueOf(((MessageForSystemMsg)localObject7).structMsg.req_uin.get()))) {
              continue;
            }
            k = i + 1;
            i = k;
            ...
            label399:
            localArrayList3.add(new avpz((MessageForSystemMsg)localObject7));
            break label2655;
          }
        }
        else
        {
          ...
          localArrayList1.add(new avqd(a(), this.jdField_b_of_type_Boolean));
          continue;
        }
        localObject3 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(aljq.M, 0);
      }
      finally {}
    }
    Object localObject3 = (FlashChatManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(217);
    Object localObject6 = this.jdField_a_of_type_Alvf.a(false);
    ...
    if ((((FlashChatManager)localObject3).b()) && (localObject5 != null) && (((ArrayList)localObject5).size() > 0))
    {
      ...
      while (((Iterator)localObject3).hasNext()) {
        localArrayList3.add(new avqo((QIMFollwerAdd)((Iterator)localObject3).next()));
      }
    }
    if ((this.jdField_b_of_type_Boolean) && (localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
    {
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        localArrayList3.add(new avqn((PhoneContactAdd)localObject4));
        if (QLog.isColorLevel()) {
    ...
    boolean bool2 = this.jdField_a_of_type_Alro.e();
    if (bool2)
    {
      localObject4 = this.jdField_a_of_type_Alro.a();
      if ((localObject4 == null) || (((ArrayList)localObject4).isEmpty())) {
        break label2664;
      }
      localObject3 = this.jdField_a_of_type_Alro.a(paramInt);
      ...
      for (;;)
      {
        if (((Iterator)localObject3).hasNext())
        {
          ...
          {
            localArrayList2.add(new avqb((MayKnowRecommend)localObject5));
            if (QLog.isColorLevel())
            {
              ...
              if (this.jdField_b_of_type_Boolean)
              {
                ...
                if ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
                {
                  ...
                  localObject6 = (ahjb)((Iterator)localObject8).next();
                  if (j != 0)
                  {
                    ...
                    if ((localObject3 != null) && (QLog.isColorLevel())) {
                      QLog.d("NewFriendManager", 2, "loadNewFriendMsg init defaultTabInfo.recommend_count = " + ((ahjb)localObject3).jdField_b_of_type_Int);
                    }
                    ...
                    {
                      localObject8 = (awbv)((Iterator)localObject6).next();
                      if ((localObject8 instanceof ContactMatch))
                      {
                        if (paramBoolean) {
                          localArrayList2.add(new avpy((ContactMatch)localObject8));
                        }
                        if (localObject3 != null) {
                          ((ahjb)localObject3).jdField_b_of_type_Int += 1;
                        }
                        if (QLog.isColorLevel()) {
                      ...
                      {
                        if (paramBoolean) {
                          localArrayList2.add(new avpx((ContactBinded)localObject8));
                        }
                        if (QLog.isColorLevel()) {
                    ...
                    QLog.d("NewFriendManager", 2, "loadNewFriendMsg result defaultTabInfo.recommend_count = " + ((ahjb)localObject3).jdField_b_of_type_Int);
                    break label2700;
                    label1303:
                    paramInt = ambq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a();
                    localObject5 = "";
                    if (paramInt == 1)
                    {
                      localObject5 = ambq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).jdField_a_of_type_JavaLangString;
                      localArrayList1.add(new avqm((String)localObject5));
                    }
                    if (QLog.isColorLevel()) {
                    ...
                    if (localArrayList3.size() > 0)
                    {
                      ...
                      ((NewFriendSubTitle)localObject5).title = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getResources().getString(2131694789);
                      if (paramInt != 3) {
                        break label2707;
                      }
                      paramBoolean = true;
                      ...
                      localArrayList1.add(new avqh((NewFriendSubTitle)localObject5));
                      if (QLog.isColorLevel()) {
                      ...
                      if (((this.jdField_b_of_type_Boolean) && (localObject3 != null) && (((ArrayList)localObject3).size() > 0)) || (bool2) || ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty())))
                      {
                        ...
                        if (localArrayList3.size() > 1)
                        {
                          ...
                          label1602:
                          if ((paramInt >= 0) && (((avqe)localArrayList3.get(paramInt)).a())) {
                            break label2712;
                          }
                          if (QLog.isColorLevel()) {
                            QLog.d("NewFriendManager", 2, "loadNewFriendMsg|lastUnReadIndex = " + paramInt);
                          }
                          k = baaz.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
                          if (paramInt > 0) {
                            break label2719;
                          }
                          paramInt = 0;
                          while (paramInt < 1)
                          {
                            localArrayList1.add((avqe)localArrayList3.get(paramInt));
                            paramInt += 1;
                          }
                          ...
                          if (paramBoolean)
                          {
                            ...
                            ((NewFriendMoreInfo)localObject3).moreInfo = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getResources().getString(2131694783);
                            ((NewFriendMoreInfo)localObject3).type = 1000;
                            localArrayList1.add(new avqf((NewFriendMoreInfo)localObject3));
                          }
                          label1770:
    ...
    {
      localArrayList1.add(new avql((ArrayList)localObject4, paramBoolean));
      if (((ArrayList)localObject4).size() > 1) {
        localArrayList1.add(new avqg((ArrayList)localObject4));
      }
      if (j != 0)
      {
        if (localArrayList2.size() == 0) {
          localArrayList1.add(new avqj());
        }
        label1874:
        if (localArrayList2.size() > 0)
        {
        ...
        for (;;)
        {
          if (((Iterator)localObject3).hasNext())
          {
            localObject4 = (avqe)((Iterator)localObject3).next();
            if ((localObject4 != null) && (!((avqe)localObject4).a()) && ((localObject4 instanceof avpz)))
            {
              paramInt += 1;
              continue;
              while (i <= paramInt)
              {
                localArrayList1.add((avqe)localArrayList3.get(i));
                i += 1;
              }
              ...
              if (baaz.a().b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) {
                break label2724;
              }
              paramBoolean = true;
              break;
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          localArrayList1.addAll(localArrayList3);
          if (((k % 20 != 0) || (baaz.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) && ((k <= 20) || (baaz.a().b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)))) {
            break label1779;
          }
          localObject3 = new NewFriendMoreInfo();
          ((NewFriendMoreInfo)localObject3).moreInfo = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getApplicationContext().getResources().getString(2131694783);
          ...
          localArrayList1.add(new avqh((NewFriendSubTitle)localObject3));
          break label1874;
  ...
  {
    avqe localavqe = a();
    return (localavqe != null) && (localavqe.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
  }
  ...
  public List<SysSuspiciousMsg> b()
  {
    ...
    for (;;)
    {
      ...
      for (localObject2 = Integer.valueOf(((List)localObject1).size());; localObject2 = "null")
      {
        ...
        localObject1 = this.jdField_a_of_type_Awbw.a(SysSuspiciousMsg.class);
  ...
  public void b(alti paramalti)
  {
    synchronized (this.jdField_a_of_type_JavaUtilLinkedList)
    {
      this.jdField_a_of_type_JavaUtilLinkedList.remove(paramalti);
      return;
    }
  }
  ...
  {
    awbw localawbw = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getEntityManagerFactory().createEntityManager();
    localawbw.b(paramQIMFollwerAdd);
    localawbw.a();
    b();
  ...
  public int c()
  {
    return baaz.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  }
  ...
  public int d()
  {
    int k = baaz.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
    Iterator localIterator = b().iterator();
    int j = 0;
    int i = 0;
    while (localIterator.hasNext())
    {
      avqe localavqe = (avqe)localIterator.next();
      if ((localavqe == null) || (localavqe.a())) {
        break label158;
      }
  ...
  public void e()
  {
    ...
    do
    {
      return;
      localamjk = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
      localRecentUser = localamjk.b(aljq.D, 4000);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    case 3: 
      ...
      m();
      this.jdField_a_of_type_Alvf.b();
      baaz.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0);
  ...
  public void j()
  {
    Object localObject = (aubm)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(11);
    SharedPreferences localSharedPreferences = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getPreferences();
    int i = ((aubm)localObject).d();
    if ((i == 1) || (i == 5))
    {
    ...
    localObject = a();
    if (QLog.isColorLevel()) {
      QLog.i("NewFriendManager", 2, String.format("updateBindContactGuideState [%s, %s, %s, %s]", new Object[] { Boolean.valueOf(((aoki)localObject).jdField_a_of_type_Boolean), Boolean.valueOf(bool), Integer.valueOf(i), Integer.valueOf(((aoki)localObject).jdField_a_of_type_Int) }));
    }
    if ((((aoki)localObject).jdField_a_of_type_Boolean) && ((!bool) || (i >= ((aoki)localObject).jdField_a_of_type_Int)))
    {
  ...
  public void l()
  {
    ...
    if ((this.jdField_a_of_type_Awbw != null) && (this.jdField_a_of_type_Awbw.a()))
    {
      boolean bool = this.jdField_a_of_type_Awbw.a(SysSuspiciousMsg.class);
      if (QLog.isColorLevel()) {
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppPhoneContactManagerImp.b(this.jdField_a_of_type_Aubn);
