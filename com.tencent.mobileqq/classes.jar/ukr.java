...
public class ukr
{
  ...
  public static boolean a(AdvertisementInfo paramAdvertisementInfo, ProteusBannerVideoItemData paramProteusBannerVideoItemData, Context paramContext, int paramInt)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        paramAdvertisementInfo = pqu.a();
        if (QLog.isColorLevel()) {
          QLog.d("ReadInJoyAdSwitchUtil", 2, " isADVideoAutoPlayFlag adFlag = " + paramInt + " kandianVideoAutoPlaySetting = " + paramAdvertisementInfo);
        }
        if (pqu.c.equals(paramAdvertisementInfo)) {
          break;
        }
        if (!pqu.a.equals(paramAdvertisementInfo)) {
          break label184;
        }
        if (paramInt == 0) {
          break;
        }
        if ((paramInt != 1) || (paramContext == null) || ((!sge.a(paramContext)) && (!a(paramContext)))) {
          break label166;
        }
        return true;
        if (paramInt == 2)
    ...
    } while ((!pqu.b.equals(paramAdvertisementInfo)) || (paramInt == 0));
    if ((paramInt == 1) && (paramContext != null) && ((sge.a(paramContext)) || (a(paramContext)))) {
      return true;
    }
    if ((paramInt == 2) && (paramContext != null) && (sge.a(paramContext))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
