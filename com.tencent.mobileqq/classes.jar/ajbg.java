  ...
  implements Handler.Callback, Manager
{
  ...
  private amng jdField_a_of_type_Amng = new ajbh(this);
  ...
  public ajbg(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Amnf = ((amnf)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(148));
    this.jdField_a_of_type_Amcj = new amcj(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_Amcg);
    this.jdField_a_of_type_Bdbw = new bdbw(ThreadManagerV2.getSubThreadLooper(), this);
    this.jdField_a_of_type_Bdbw.sendEmptyMessage(1);
  ...
  public static com.tencent.mobileqq.applets.data.AppletInfo a(byte[] paramArrayOfByte)
  {
    ...
    //   7: dup
    //   8: aload_0
    //   9: invokespecial 177	java/io/ByteArrayInputStream:<init>	([B)V
    //   12: invokespecial 180	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   15: astore_1
    //   16: aload_1
    //   17: astore_0
    //   18: aload_1
    //   19: invokevirtual 184	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   22: astore_2
    //   23: aload_1
    //   24: astore_0
    //   25: aload_2
    ...
    //   33: astore_0
    //   34: aload_2
    //   35: checkcast 186	com/tencent/mobileqq/applets/data/AppletInfo
    //   38: astore_2
    //   39: aload_1
    //   40: ifnull +7 -> 47
    //   43: aload_1
    ...
    //   49: astore_0
    //   50: aload_0
    //   51: invokevirtual 192	java/io/IOException:printStackTrace	()V
    //   54: aload_2
    //   55: areturn
    //   56: aload_1
    //   57: ifnull +7 -> 64
    //   60: aload_1
    //   61: invokevirtual 189	java/io/ObjectInputStream:close	()V
    //   64: aconst_null
    //   65: areturn
    //   66: astore_0
    //   67: aload_0
    //   68: invokevirtual 192	java/io/IOException:printStackTrace	()V
    //   71: goto -7 -> 64
    //   74: astore_2
    //   75: aconst_null
    //   76: astore_1
    ...
    //   78: astore_0
    //   79: aload_2
    //   80: invokevirtual 192	java/io/IOException:printStackTrace	()V
    //   83: aload_1
    //   84: ifnull +7 -> 91
    //   87: aload_1
    //   88: invokevirtual 189	java/io/ObjectInputStream:close	()V
    //   91: aconst_null
    //   92: areturn
    //   93: astore_0
    //   94: aload_0
    //   95: invokevirtual 192	java/io/IOException:printStackTrace	()V
    //   98: goto -7 -> 91
    //   101: astore_2
    //   102: aconst_null
    //   103: astore_1
    ...
    //   105: astore_0
    //   106: aload_2
    //   107: invokevirtual 193	java/lang/ClassNotFoundException:printStackTrace	()V
    //   110: aload_1
    //   111: ifnull -20 -> 91
    //   114: aload_1
    //   115: invokevirtual 189	java/io/ObjectInputStream:close	()V
    //   118: goto -27 -> 91
    //   121: astore_0
    //   122: aload_0
    //   123: invokevirtual 192	java/io/IOException:printStackTrace	()V
    //   126: goto -35 -> 91
    //   129: astore_1
    //   130: aconst_null
    //   131: astore_0
    ...
    //   133: ifnull +7 -> 140
    //   136: aload_0
    //   137: invokevirtual 189	java/io/ObjectInputStream:close	()V
    //   140: aload_1
    //   141: athrow
    //   142: astore_0
    //   143: aload_0
  ...
  public static boolean a(boolean paramBoolean)
  {
    ...
    {
      aohh localaohh = (aohh)aogj.a().a(597);
      if (localaohh == null) {
        break label85;
      }
      if (!localaohh.jdField_a_of_type_Boolean) {
        break label80;
      }
      i = 1;
  ...
  public static byte[] a(com.tencent.mobileqq.applets.data.AppletInfo paramAppletInfo)
  {
    ...
    //   10: aload_1
    //   11: areturn
    //   12: new 253	java/io/ByteArrayOutputStream
    //   15: dup
    //   16: invokespecial 254	java/io/ByteArrayOutputStream:<init>	()V
    //   19: astore_3
    //   20: new 256	java/io/ObjectOutputStream
    //   23: dup
    //   24: aload_3
    //   25: invokespecial 259	java/io/ObjectOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   28: astore_2
    //   29: aload_2
    //   30: astore_1
    //   31: aload_2
    //   32: aload_0
    //   33: invokevirtual 263	java/io/ObjectOutputStream:writeObject	(Ljava/lang/Object;)V
    //   36: aload_2
    //   37: astore_1
    //   38: aload_3
    //   39: invokevirtual 267	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   42: astore_0
    //   43: aload_0
    //   44: astore_1
    //   45: aload_2
    //   46: ifnull -36 -> 10
    //   49: aload_2
    //   50: invokevirtual 268	java/io/ObjectOutputStream:close	()V
    //   53: aload_0
    //   54: areturn
    //   55: astore_1
    //   56: aload_1
    //   57: invokevirtual 192	java/io/IOException:printStackTrace	()V
    //   60: aload_0
    //   61: areturn
    //   62: astore_3
    //   63: aconst_null
    ...
    //   75: ifnull -65 -> 10
    //   78: aload_0
    //   79: invokevirtual 268	java/io/ObjectOutputStream:close	()V
    //   82: aconst_null
    //   83: areturn
    //   84: astore_0
    //   85: aload_0
    //   86: invokevirtual 192	java/io/IOException:printStackTrace	()V
    //   89: aconst_null
    //   90: areturn
    //   91: astore_0
    //   92: aconst_null
    ...
    //   95: ifnull +7 -> 102
    //   98: aload_1
    //   99: invokevirtual 268	java/io/ObjectOutputStream:close	()V
    //   102: aload_0
    //   103: athrow
    //   104: astore_1
    //   105: aload_1
    //   106: invokevirtual 192	java/io/IOException:printStackTrace	()V
    //   109: goto -7 -> 102
    //   112: astore_0
    //   113: goto -19 -> 94
    //   116: astore_3
  ...
  public int a(QQMessageFacade.Message paramMessage)
  {
    ...
    {
      str = paramMessage.getExtInfoFromExtStr(ayvj.x);
  ...
  public int a(QQMessageFacade.Message paramMessage, RecentUser paramRecentUser)
  {
    ...
    if (paramMessage != null)
    {
      paramMessage = paramMessage.getExtInfoFromExtStr(ayvj.x);
  ...
  {
    paramString = this.jdField_a_of_type_Amcj.a(paramString);
  ...
  public void a(AppletsAccountInfo paramAppletsAccountInfo)
  {
    if (paramAppletsAccountInfo != null)
    {
      ...
      this.jdField_a_of_type_Amcj.a(paramAppletsAccountInfo);
    }
    if (QLog.isColorLevel()) {
  ...
  public void a(RecentUser paramRecentUser)
  {
    if (paramRecentUser != null)
    {
      ...
      this.jdField_a_of_type_Bdbw.obtainMessage(3, 0, 0, paramRecentUser).sendToTarget();
    }
  }
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    this.jdField_a_of_type_Amnf.a(localArrayList);
