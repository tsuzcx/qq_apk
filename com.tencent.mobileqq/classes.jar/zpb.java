  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        boolean bool2 = bjxx.a().a(paramMessage);
        boolean bool3 = bdee.h(BaseApplicationImpl.getContext());
        boolean bool4 = bdcb.e();
        if (bdcs.a() <= 1.048576E+008F) {
          bool1 = true;
        }
        zpa.a(this.a, "SmartDeviceProxyMgr check plugin: isInstalled " + bool2 + " isWifiConnected " + bool3 + " lowPhone = " + bool4 + " lowMemory = " + bool1);
      ...
      try
      {
        if (zpa.a(this.a) != null)
        {
          paramMessage = new Bundle();
          paramMessage.putString("notify_cmd", "getServerDeviceList");
          paramMessage = zpa.a(this.a).a(paramMessage);
          if (paramMessage != null)
          {
            ...
            if (paramMessage != null)
            {
              ...
              zpa.a(this.a, arrayOfDeviceInfo);
