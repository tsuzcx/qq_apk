  ...
  implements View.OnClickListener
{
  ...
  Handler.Callback jdField_a_of_type_AndroidOsHandler$Callback = new anph(this);
  ...
  public anpg(View paramView, ansk paramansk, anov paramanov, Activity paramActivity)
  {
    super(paramView);
    ...
    this.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131299132);
    ...
    this.jdField_a_of_type_Int = aciy.a(4.0F, paramActivity.getResources());
    this.jdField_a_of_type_JavaUtilList = new ArrayList();
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131301804));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131301767));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131301768));
    this.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131301769));
    this.d = ((ImageView)paramView.findViewById(2131301770));
    this.e = ((ImageView)paramView.findViewById(2131301771));
    this.f = ((ImageView)paramView.findViewById(2131301772));
    int i = 0;
    while (i < this.jdField_a_of_type_AndroidWidgetRelativeLayout.getChildCount())
    {
      paramansk = (ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.getChildAt(i);
      paramansk.setVisibility(8);
      this.jdField_a_of_type_JavaUtilList.add(paramansk);
      i += 1;
    }
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131311534));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131311535));
    ...
    ((FeedBannerItemGradientLinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131301523)).a(bajq.a(24.0F), -20771, -31578);
    paramView = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131299238);
    paramansk = Drawable.createFromPath(ansv.a(1));
    if (paramansk != null) {
      paramView.setImageDrawable(paramansk);
    }
    paramView = this.jdField_a_of_type_AndroidViewView.findViewById(2131306199);
    paramansk = this.jdField_a_of_type_AndroidViewView.findViewById(2131301545);
    paramanov = this.jdField_a_of_type_AndroidViewView.findViewById(2131297266);
    this.jdField_a_of_type_AndroidViewView.setOnTouchListener(new anpi(this, paramView, paramansk, paramanov));
  }
  ...
  void a(anpd paramanpd)
  {
    Object localObject = new ArrayList();
    ((List)localObject).addAll(paramanpd.jdField_a_of_type_JavaUtilList);
    ...
    do
    {
      ...
      if (j > 0)
      {
        ...
        localObject = (String)paramanpd.jdField_a_of_type_JavaUtilList.get(i);
        ...
        localObject = azwp.a(localQQAppInterface, 1, (String)localObject, 4, localDrawable, localDrawable);
        localDrawable = localImageView.getDrawable();
        if ((localDrawable != null) && (localDrawable != localObject) && ((localDrawable instanceof azwp))) {
      ...
      for (;;)
      {
        ...
        localObject = null;
        break label234;
        localImageView.setImageDrawable(bacm.a(true));
        localImageView.setVisibility(0);
        continue;
    ...
    label334:
    label352:
    paramanpd = (String)this.jdField_b_of_type_JavaUtilList.get(this.jdField_b_of_type_JavaUtilList.size() - 1);
    if (localQQAppInterface != null)
    {
      localObject = bacm.a(true);
      azwp.a(localQQAppInterface, 1, paramanpd, 4, (Drawable)localObject, (Drawable)localObject);
    }
  ...
  public void a(anpg paramanpg, anpd paramanpd, int paramInt)
  {
    int i = paramanpd.jdField_a_of_type_JavaUtilList.size();
    String str = String.format(this.jdField_a_of_type_AndroidAppActivity.getString(2131633230), new Object[] { Integer.valueOf(paramanpd.c) });
    if (QLog.isColorLevel()) {
      QLog.d("MatchViewHolder", 0, "bindView infoListSize = " + i + ",onlineNum = " + paramanpd.c);
    }
    if (paramanpd.c > 0) {
    ...
    paramanpd = Message.obtain(this.jdField_a_of_type_AndroidOsHandler, 2, paramanpd);
    this.jdField_a_of_type_AndroidOsHandler.sendMessage(paramanpd);
    if ((paramanpg.jdField_b_of_type_AndroidViewView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams))
    {
      ((ViewGroup.MarginLayoutParams)paramanpg.jdField_b_of_type_AndroidViewView.getLayoutParams()).topMargin = paramInt;
      paramanpg.jdField_b_of_type_AndroidViewView.requestLayout();
    }
  }
  ...
  void b()
  {
    ...
    int i = aciy.a(1.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    this.g.setPadding(i, i, i, i);
    this.g.setBackgroundResource(2130844229);
    ...
    ((RelativeLayout.LayoutParams)localObject2).addRule(7, 2131301767);
    ((RelativeLayout.LayoutParams)localObject2).addRule(6, 2131301767);
    ...
    try
    {
      ...
      ((ScaleAnimation)localObject1).setAnimationListener(new anpj(this));
  ...
  void c()
  {
    int j = this.jdField_a_of_type_AndroidWidgetImageView.getWidth() - aciy.a(5.0F, this.jdField_a_of_type_AndroidAppActivity.getResources());
    ...
    localObject2 = new anpl(this, localAnimatorSet);
