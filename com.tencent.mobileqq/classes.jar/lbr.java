...
public class lbr
{
  ...
  {
    Object localObject2 = (DoodleSurfaceView)paramViewGroup.findViewById(2131306542);
    ...
    if (localObject2 == null)
    {
      ...
      localView = paramViewGroup.findViewById(2131306822);
      if (localView == null) {
        break label67;
      }
    }
  ...
  public static lbm a(int paramInt)
  {
    Object localObject;
    switch (paramInt)
    {
    ...
    for (;;)
    {
      ((lbm)localObject).a = paramInt;
      return localObject;
      localObject = new lbs();
      continue;
      localObject = new lbx(2130903118);
    }
  }
  
  public static void a(ViewGroup paramViewGroup)
  {
    View localView = paramViewGroup.findViewById(2131306542);
    if (localView != null) {
  ...
  public static boolean b()
  {
    ...
    if (i < 4)
    {
      krx.c("DoodleUtils", "isSupportOfDevice error cpucount = " + i);
      return false;
    }
    long l = lbk.c();
    if (l < 1400000L)
    {
      krx.c("DoodleUtils", "isSupportOfDevice error cpuFrequency = " + l);
      return false;
    }
    l = babp.d();
    if (l < 1073741824L)
    {
      krx.c("DoodleUtils", "isSupportOfDevice error memory = " + l);
      return false;
    }
    return true;
  }
