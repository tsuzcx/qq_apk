  ...
  extends BaseAdapter
{
  ...
  private wuk(CountryActivity paramCountryActivity) {}
  
  private int a(wui paramwui)
  {
    if (paramwui.a) {
      return 0;
    }
    ...
    String str2 = paramwui.c;
    String str3 = paramwui.b;
    String str1 = paramwui.d;
    paramwui = str1;
    if (str1 != null) {
      paramwui = str1.toLowerCase();
    }
    str1 = ChnToSpell.a(str3, 1);
    String str4 = ChnToSpell.a(str3, 2);
    if ((str2.equals(this.jdField_a_of_type_JavaLangString)) || (str3.equals(this.jdField_a_of_type_JavaLangString)) || (str1.equals(this.jdField_a_of_type_JavaLangString)) || (str4.equals(this.jdField_a_of_type_JavaLangString)) || ((paramwui != null) && (paramwui.equals(this.jdField_a_of_type_JavaLangString)))) {
      return 3;
    }
    if ((str2.indexOf(this.jdField_a_of_type_JavaLangString) == 0) || (str3.indexOf(this.jdField_a_of_type_JavaLangString) == 0) || (str1.indexOf(this.jdField_a_of_type_JavaLangString) == 0) || (str4.indexOf(this.jdField_a_of_type_JavaLangString) == 0) || ((paramwui != null) && (paramwui.indexOf(this.jdField_a_of_type_JavaLangString) == 0))) {
      return 2;
    }
  ...
  public void a(String paramString)
  {
    ...
    if (((String)localObject).startsWith(this.jdField_a_of_type_JavaLangString))
    {
      ...
      localwui = (wui)paramString.next();
      k = a(localwui);
      if (k != 3) {
        break label141;
      }
      ((ArrayList)localObject).add(j, localwui);
      j += 1;
    }
    for (;;)
    {
      ...
      if (k == 2)
      {
        ((ArrayList)localObject).add(i + j, localwui);
        i += 1;
      }
      else if (k == 1)
      {
        ((ArrayList)localObject).add(localwui);
      }
    }
    label181:
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    CountryActivity.a(localView, (wui)this.jdField_a_of_type_JavaUtilArrayList.get(paramInt));
    return localView;
  }
}
