...
public class azlr
{
  ...
  public static void a()
  {
    ...
    for (;;)
    {
      ...
      Object localObject = aekh.a;
      if ((localObject == null) || (((aekg)localObject).f != 1)) {
        continue;
      }
      b = true;
      ...
      try
      {
        ...
        azmz.a(BaseApplicationImpl.getContext()).a(str3, "FightReporter_deviceid", true, 0L, 0L, localHashMap, null);
  ...
  public static void a(AbsStructMsg paramAbsStructMsg)
  {
    ...
    do
    {
      try
      {
        ...
        aekg localaekg2 = aekh.a;
        localaekg1 = localaekg2;
        if (!a) {
          continue;
        }
        localaekg1 = localaekg2;
      ...
      return;
    } while (localaekg1 != null);
  }
  
  public static void a(String paramString)
  {
    azlf.a(new Throwable(paramString));
  }
  
  public static void a(String paramString1, String paramString2)
  {
    azlf.a(new Throwable(paramString1), paramString2);
  }
  ...
  public static void b()
  {
    ...
    for (Object localObject = Build.SUPPORTED_ABIS[0];; localObject = Build.CPU_ABI)
    {
      ...
      azmz.a(BaseApplicationImpl.getContext()).a(str, "FightReporter_cpu_abi", true, 0L, 0L, localHashMap, null);
      if (!QLog.isDevelopLevel()) {
        break;
      }
  ...
  {
    aekg localaekg = aekh.a;
    if ((localaekg != null) && (localaekg.e == 1)) {
