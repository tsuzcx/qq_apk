...
public class bfji
{
  ...
  private CopyOnWriteArrayList<bfjk> jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList = new CopyOnWriteArrayList();
  
  public bfji()
  {
    bfkk.a("MobileQQprotect.QSecCb", new bfjj(this));
    a();
  }
  ...
  private String a()
  {
    return bfhr.a() + File.separator + "QSecCb.dat";
  }
  
  private void a()
  {
    byte[] arrayOfByte = new bfkg().a(a(), null, 1);
    if (arrayOfByte != null) {
      a(arrayOfByte);
    }
  }
  ...
  private void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception paramString)
      {
        ...
        ((bfjk)paramString.next()).a(localLinkedList);
        continue;
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    //   37: astore_1
    //   38: aload_0
    //   39: getfield 18	bfji:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   42: iload_3
  ...
  private byte[] a()
  {
    ...
    //   16: astore 4
    //   18: aload_0
    //   19: getfield 18	bfji:jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap	Ljava/util/concurrent/ConcurrentHashMap;
  ...
  private void b()
  {
    byte[] arrayOfByte = a();
    if (arrayOfByte != null) {
      new bfkg().a(a(), arrayOfByte, null, 1);
    }
  }
  ...
  public void a(bfjk parambfjk)
  {
    this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(parambfjk);
  }
  ...
  public void a(boolean paramBoolean)
  {
    try
    {
      ...
      bfkk.a("MobileQQprotect.QSecCb", localQSecCbQuery.toByteArray());
      return;
    }
