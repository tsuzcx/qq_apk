...
public class ppx
{
  ...
  private List<tkq> jdField_a_of_type_JavaUtilList = new ArrayList();
  private oxo jdField_a_of_type_Oxo;
  private tnf jdField_a_of_type_Tnf;
  ...
  public oxo a()
  {
    return this.jdField_a_of_type_Oxo;
  }
  ...
  public void a()
  {
    ...
    {
      tkq localtkq = (tkq)localIterator.next();
      if ((localtkq instanceof ReadInJoyDiandianHeaderController)) {
        localtkq.e();
      }
    }
  }
  ...
  {
    if ((!rmu.b) && ((paramActivity instanceof SplashActivity))) {}
    do
    {
      do
      {
  ...
  {
    ReadInjoySlideAnimLayout localReadInjoySlideAnimLayout = (ReadInjoySlideAnimLayout)paramActivity.findViewById(2131362003);
    View localView = paramActivity.findViewById(2131379027);
    ...
    paramView = paramView.findViewById(2131367180);
  ...
  public void a(Activity paramActivity, ReadInJoyXListView paramReadInJoyXListView, View paramView, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    ReadInjoySlideAnimLayout localReadInjoySlideAnimLayout = (ReadInjoySlideAnimLayout)paramActivity.findViewById(2131362002);
    View localView = paramActivity.findViewById(2131378030);
    paramView = paramView.findViewById(2131367180);
    if (paramBoolean1)
    {
      i = 2131298772;
    ...
    for (int i = ImmersiveUtils.getStatusBarHeight(paramActivity) + i;; i = AIOUtils.dp2px(50.0F, paramActivity.getResources()) + ImmersiveUtils.getStatusBarHeight(paramActivity) + i)
    {
      ...
      int m = paramActivity.getResources().getDimensionPixelOffset(2131298776);
      paramView.setPadding(0, i, 0, 0);
      paramReadInJoyXListView.setPadding(0, i, 0, 0);
      paramReadInJoyXListView.initPaddingManual();
      if (QLog.isColorLevel()) {
  ...
  public void a(View paramView, int paramInt)
  {
    ...
    {
      if (this.b == null) {
        this.b = ((ChannelTopPositionView)paramView.findViewById(2131376238));
      }
      a(0);
    }
  }
  
  public void a(TopBannerInfo paramTopBannerInfo, ReadInJoyXListView paramReadInJoyXListView, Activity paramActivity, int paramInt, szd paramszd)
  {
    ...
    this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewWidgetBannerChannelTopBanner.a(paramszd, paramTopBannerInfo);
  }
  
  public void a(ReadInJoyXListView paramReadInJoyXListView)
  {
    if (paramReadInJoyXListView != null) {
      paramReadInJoyXListView.a(this.jdField_a_of_type_Tnf);
    }
  }
  ...
  public void a(ReadInJoyXListView paramReadInJoyXListView, Context paramContext, int paramInt)
  {
    if (paramInt == 0) {
      if (!bmhv.n()) {
        this.jdField_a_of_type_JavaUtilList.add(new tkx(paramContext));
      }
    }
    for (;;)
    {
      ...
      while (paramContext.hasNext()) {
        ((tkq)paramContext.next()).a(paramReadInJoyXListView);
      }
      if (paramInt == 56)
      {
        if (bmhv.v(pkh.a()) != 2)
        {
          this.jdField_a_of_type_Oxo = new oxo(paramContext, paramInt, paramReadInJoyXListView);
          a(this.jdField_a_of_type_Oxo.a(), paramContext);
        }
      }
      else if (paramInt == 70)
      {
      ...
      else if ((paramInt == 41523) && (bmhv.w(pkh.a()) != 1))
      {
        this.jdField_a_of_type_Oxo = new oxo(paramContext, paramInt, paramReadInJoyXListView);
        this.jdField_a_of_type_Oxo.a().setBackgroundColor(-1);
        a(this.jdField_a_of_type_Oxo.a(), paramContext);
      }
    }
  }
  
  public void a(tnf paramtnf, ReadInJoyXListView paramReadInJoyXListView)
  {
    if (paramReadInJoyXListView != null)
    {
      paramReadInJoyXListView.a(paramtnf);
  ...
  public void d()
  {
    ...
    {
      this.jdField_a_of_type_Oxo.a();
      this.jdField_a_of_type_Oxo = null;
    }
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext()) {
      ((tkq)localIterator.next()).b();
    }
    if (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewSlideActiveAnimController != null) {
