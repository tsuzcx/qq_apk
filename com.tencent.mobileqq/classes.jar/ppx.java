...
public class ppx
{
  ...
  public ppx(pon parampon)
  {
    this.jdField_a_of_type_Pon = parampon;
  }
  ...
  public static List<BaseArticleInfo> a(List<BaseArticleInfo> paramList)
  {
    ...
    if (i < j)
    {
      ...
      if (!ozs.h(localBaseArticleInfo1)) {
      ...
      for (;;)
      {
        ...
        while ((i + 1 < j) && (ozs.a(localBaseArticleInfo1, (BaseArticleInfo)paramList.get(i + 1))))
        {
        ...
        if ((ozs.l(localBaseArticleInfo1)) && (localArticleInfo.mGroupSubArticleList.size() >= 1))
        {
          localArrayList.add(localArticleInfo);
          if (QLog.isColorLevel()) {
            QLog.d("PolymericSmallVideo_" + ppx.class.getSimpleName(), 2, localStringBuilder.toString());
          }
        }
    ...
    if ((localArrayList.size() > 1) && (ozs.j((BaseArticleInfo)localArrayList.get(localArrayList.size() - 1)))) {
  ...
  static void a(BaseArticleInfo paramBaseArticleInfo)
  {
    if ((paramBaseArticleInfo.mNewPolymericInfo != null) && (paramBaseArticleInfo.mNewPolymericInfo.jdField_a_of_type_JavaUtilList != null) && (paramBaseArticleInfo.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.size() > 0))
    {
      ...
      try
      {
        ...
        {
          localqwp = (qwp)((Iterator)localObject).next();
          ...
          localArticleInfo.mAlgorithmID = localqwp.b;
          localArticleInfo.innerUniqueID = localqwp.g;
          localArticleInfo.mArticleContentUrl = localqwp.jdField_d_of_type_JavaLangString;
          localArticleInfo.mSubscribeID = localqwp.e;
          if (localqwp.jdField_c_of_type_Int == 1)
          {
            bool = true;
            localArticleInfo.mIsPolymericGallery = bool;
            localArticleInfo.mGalleryPicNumber = localqwp.jdField_d_of_type_Int;
            localArticleInfo.mSinglePicture = ozs.a(localqwp.jdField_c_of_type_JavaLangString);
            if (localqwp.jdField_a_of_type_Qws != null)
            {
              localArticleInfo.mVideoCoverUrl = ozs.a(localqwp.jdField_c_of_type_JavaLangString);
              localArticleInfo.mVideoVid = localqwp.jdField_a_of_type_Qws.a;
            }
            localArticleInfo.mNewPolymericInfo = new qwo();
      ...
      catch (Exception localException1)
      {
        try
        {
          for (;;)
          {
            ...
            localArticleInfo.mNewPolymericInfo.jdField_a_of_type_JavaUtilList.add((qwp)localqwp.clone());
            if (sel.g(paramBaseArticleInfo))
            {
              localqwp.jdField_a_of_type_Boolean = true;
  ...
  public void a(Integer paramInteger, List<Long> paramList)
  {
    ...
    for (;;)
    {
      if (i < k)
      {
        localObject1 = this.jdField_a_of_type_Pon.a(paramInteger, (Long)paramList.get(i));
  ...
  public void a(Integer paramInteger, List<ArticleInfo> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (!paramBoolean)
      {
        ...
        paramInteger = this.jdField_a_of_type_Pon.a(paramInteger.intValue(), 10, localArticleInfo1.mRecommendSeq, true).iterator();
        while (paramInteger.hasNext())
        {
