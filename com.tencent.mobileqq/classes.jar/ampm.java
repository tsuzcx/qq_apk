  ...
  implements Manager
{
  ...
  private ampr jdField_a_of_type_Ampr;
  private amsu jdField_a_of_type_Amsu = new ampo(this);
  ...
  static
  {
    ...
    jdField_a_of_type_ArrayOfInt = new int[] { 2130845797, 2130844813, 2130844813, 2130844813, 2130845534, 2130845534, 2130845815, 2130845815, 2130845318, 2130845318, 2130845318, 2130845797, 2130845797, 2130845595, 2130845797 };
  ...
  public ampm(QQAppInterface paramQQAppInterface)
  {
  ...
  public int a(int paramInt, boolean paramBoolean)
  {
    ...
    if (paramInt == 1)
    {
      ...
      else
      {
        ...
        localObject = ((PreDownloadController)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(193)).cancelPreDownload(this.jdField_a_of_type_JavaLangString);
        if (QLog.isColorLevel()) {
          QLog.d("ConditionSearch.Manager", 2, "update, find task=" + localObject);
        }
        if ((localObject != null) && ((localObject instanceof ampp))) {
          ((ampp)localObject).realStart();
        }
      }
    }
    label246:
    while (paramInt != 2)
    {
      ...
      for (paramBoolean = true;; paramBoolean = false)
      {
        ...
        localObject = (ampt)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(4);
        ((ampt)localObject).a(null, new GetResourceReqInfo[] { ((ampt)localObject).e() });
        return 0;
      }
    }
    label264:
  ...
  public List<BaseAddress> a()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqConditionsearchDataAddressData != null)
    {
      ...
      Collections.sort(localArrayList, new ampn(this));
    }
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Ampr != null) {
      this.jdField_a_of_type_Ampr.a();
    }
  }
  ...
  public void a(ampr paramampr)
  {
    this.jdField_a_of_type_Ampr = paramampr;
  }
  ...
  public void a(GetResourceRespInfo paramGetResourceRespInfo)
  {
    ...
    do
    {
      ...
      paramGetResourceRespInfo = new ampp(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, paramGetResourceRespInfo, localFile);
      ...
      bool = ((PreDownloadController)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(193)).requestPreDownload(10023, "prd", (String)localObject, 0, (String)localObject, localFile.getAbsolutePath(), 2, 0, false, paramGetResourceRespInfo);
      if (QLog.isColorLevel()) {
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt1, int paramInt2, int paramInt3, String[] paramArrayOfString1, String[] paramArrayOfString2, int paramInt4, int paramInt5, int paramInt6)
  {
    ...
    while (this.jdField_e_of_type_Boolean)
    {
      ...
      ((FriendListHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(1)).searchFriendCondtional(this.jdField_a_of_type_Long, this.jdField_f_of_type_Int + 1, this.jdField_b_of_type_Long, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Int, this.jdField_b_of_type_Int, this.jdField_c_of_type_Int, this.jdField_f_of_type_ArrayOfJavaLangString, this.jdField_g_of_type_ArrayOfJavaLangString, this.jdField_d_of_type_Int, this.jdField_e_of_type_Int, paramInt6);
      return;
    }
  ...
  void a(boolean paramBoolean1, List<CondFitUser> paramList, boolean paramBoolean2, int paramInt)
  {
    ...
    if (this.jdField_b_of_type_JavaUtilLinkedList != null)
    {
      ...
      while (((Iterator)localObject).hasNext()) {
        ((amps)((Iterator)localObject).next()).a(paramBoolean1, paramList, paramBoolean2, paramInt);
      }
    }
  }
  ...
  public void c(Object paramObject)
  {
    ...
    do
    {
      this.jdField_a_of_type_JavaUtilLinkedList.add((ampq)paramObject);
      do
      {
        return;
      } while (!(paramObject instanceof amps));
      if (this.jdField_b_of_type_JavaUtilLinkedList == null) {
    ...
    this.jdField_b_of_type_JavaUtilLinkedList.add((amps)paramObject);
  }
  ...
  public void d(Object paramObject)
  {
    ...
    while ((!(paramObject instanceof amps)) || (this.jdField_b_of_type_JavaUtilLinkedList == null)) {
      return;
    }
