...
public class sqp
{
  private static sqp jdField_a_of_type_Sqp;
  ...
  private Map<spg, Boolean> jdField_a_of_type_JavaUtilMap = new WeakHashMap();
  private Timer jdField_a_of_type_JavaUtilTimer;
  private sqq jdField_a_of_type_Sqq;
  private sqr jdField_a_of_type_Sqr;
  ...
  public static sqp a()
  {
    if (jdField_a_of_type_Sqp == null) {}
    try
    {
      if (jdField_a_of_type_Sqp == null) {
        jdField_a_of_type_Sqp = new sqp();
      }
      return jdField_a_of_type_Sqp;
    }
    finally {}
  }
  ...
  public void a(Activity paramActivity)
  {
    ...
    if (this.jdField_a_of_type_Sqs == null) {
      this.jdField_a_of_type_Sqs = new sqs(this, null);
    }
    ...
    this.l = true;
    BaseApplicationImpl.getApplication().getBaseContext().registerReceiver(this.jdField_a_of_type_Sqs, paramActivity);
    if (this.jdField_a_of_type_Sqq == null) {
      this.jdField_a_of_type_Sqq = new sqq(this);
    }
    ThreadManager.excute(new VideoVolumeControl.2(this), 16, null, true);
    if (this.jdField_a_of_type_Sqr == null) {
      this.jdField_a_of_type_Sqr = new sqr(this);
    }
  ...
  public void a(spg paramspg)
  {
    ...
    {
      paramspg.c(b());
      if (!this.jdField_a_of_type_JavaUtilMap.containsKey(paramspg)) {
        this.jdField_a_of_type_JavaUtilMap.put(paramspg, Boolean.valueOf(true));
      }
      paramspg.a(this.jdField_a_of_type_Sqr);
      this.jdField_d_of_type_Int = 1;
    }
    if (QLog.isColorLevel()) {
      QLog.d("Q.readinjoy.video.VideoVolumeControl", 2, "addVideoManager :" + paramspg + " list:" + this.jdField_a_of_type_JavaUtilMap);
    }
  }
  ...
  public void a(boolean paramBoolean, String paramString)
  {
    ...
    //   2: aload_0
    //   3: iload_1
    //   4: putfield 149	sqp:k	Z
    //   7: aload_0
    //   8: getfield 75	sqp:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   11: ifnull +82 -> 93
    //   14: aload_0
    //   15: getfield 89	sqp:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   18: ifnull +75 -> 93
    ...
    //   63: aload_0
    //   64: getfield 75	sqp:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   67: aload_0
    //   68: getfield 89	sqp:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   71: invokevirtual 326	android/os/Handler:removeCallbacks	(Ljava/lang/Runnable;)V
    //   74: aload_0
    //   75: getfield 149	sqp:k	Z
    //   78: ifeq +18 -> 96
    //   81: aload_0
    //   82: getfield 75	sqp:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   85: aload_0
    //   86: getfield 89	sqp:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    ...
    //   95: return
    //   96: aload_0
    //   97: getfield 75	sqp:jdField_a_of_type_AndroidOsHandler	Landroid/os/Handler;
    //   100: aload_0
    //   101: getfield 89	sqp:jdField_a_of_type_JavaLangRunnable	Ljava/lang/Runnable;
    //   104: ldc2_w 175
  ...
  public void a(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if ((paramInt == 1) || (paramInt == 0))
    {
      ...
      Object localObject;
      for (boolean bool1 = false; paramString.hasNext(); bool1 = ((spg)localObject).b() | bool1)
      {
        localObject = (spg)paramString.next();
        if (localObject == null) {
          break label450;
        }
        ((spg)localObject).c(paramBoolean);
      }
    ...
    for (;;)
    {
      try
      {
        if (paramInt < this.jdField_a_of_type_JavaUtilArrayList.size())
        {
          ...
          ((ImageView)paramString.get()).setImageDrawable(((ImageView)paramString.get()).getResources().getDrawable(2130843121));
          ((ImageView)paramString.get()).setContentDescription(anvx.a(2131715815));
        }
      }
      ...
      return;
      label399:
      ((ImageView)paramString.get()).setImageDrawable(((ImageView)paramString.get()).getResources().getDrawable(2130843122));
      ((ImageView)paramString.get()).setContentDescription(anvx.a(2131715816));
      break label459;
      label444:
      paramInt = n;
      break label241;
  ...
  public void b(Activity paramActivity)
  {
    if (this.jdField_b_of_type_JavaLangString.equals(paramActivity.toString()))
    {
      ...
      if (!"".equals(this.jdField_b_of_type_JavaLangString))
      {
        BaseApplicationImpl.getApplication().getBaseContext().unregisterReceiver(this.jdField_a_of_type_Sqs);
        ThreadManager.excute(new VideoVolumeControl.4(this), 16, null, true);
      }
      this.jdField_a_of_type_Sqr = null;
      this.jdField_a_of_type_Sqs = null;
  ...
  public void b(spg paramspg)
  {
    if (paramspg != null) {
      this.jdField_a_of_type_JavaUtilMap.remove(paramspg);
    }
    if (QLog.isColorLevel()) {
      QLog.d("Q.readinjoy.video.VideoVolumeControl", 2, "removeVideoManager :" + paramspg + " list:" + this.jdField_a_of_type_JavaUtilMap);
    }
  }
