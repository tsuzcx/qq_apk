  ...
  implements aoyz
{
  ...
  {
    QQAppInterface localQQAppInterface = (QQAppInterface)aoza.a(this.a).get();
    ...
    synchronized (aoza.a(this.a))
    {
      if ((Bundle)aoza.a(this.a).get(Long.valueOf(l)) != null)
      {
        aoza.a(this.a).remove(Long.valueOf(l));
        aoza.a(this.a).removeMessages(1, localObject1);
    ...
    aoza.a(this.a, localQQAppInterface, (MessageForArkApp)localObject1);
  }
}
