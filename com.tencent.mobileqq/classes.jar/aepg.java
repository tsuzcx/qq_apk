...
{
  public aepg(NearbyPeopleProfileActivity paramNearbyPeopleProfileActivity) {}
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (TextUtils.isEmpty(paramString)) {
          paramArrayOfByte = ((Activity)localObject).getResources().getString(2131437948);
        }
        DatingUtil.a(this.a, paramArrayOfByte);
        continue;
        DatingUtil.a((Activity)localObject, ((Activity)localObject).getString(2131437949));
      }
    }
  }
  ...
  protected void a(boolean paramBoolean, String paramString)
  {
    ...
    return;
    label144:
    this.a.jdField_a_of_type_ComTencentImageURLDrawable.setURLDrawableListener(new aeph(this, paramString));
  ...
  protected void a(boolean paramBoolean, String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (!paramBoolean)
      {
        this.a.b(this.a.getResources().getString(2131435770));
