...
public class aepg
  ...
  implements atcg
{
  BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new aepu(this);
  protected atcf a;
  bcic jdField_a_of_type_Bcic;
  bciq jdField_a_of_type_Bciq = new aepn(this);
  public bcis a;
  ...
  boolean ad = false;
  boolean ae = true;
  BroadcastReceiver jdField_b_of_type_AndroidContentBroadcastReceiver = new aepv(this);
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new aepy(this);
  ...
  public aepg(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
  ...
  public void G()
  {
    if (this.jdField_a_of_type_Bcis != null) {
      this.jdField_a_of_type_Bcis.a(this);
    }
    if ((this.N) || (!this.ad))
    {
    ...
    this.ad = false;
    if (this.ab) {
      this.jdField_a_of_type_Bcic.a(this.jdField_a_of_type_ComTencentMobileqqDataHotChatInfo, new aepz(this));
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Bciq);
    ...
    try
    {
      if ((this.jdField_d_of_type_Bcpq != null) && (this.jdField_d_of_type_Bcpq.isShowing()))
      {
        this.jdField_d_of_type_Bcpq.dismiss();
        this.jdField_d_of_type_Bcpq = null;
      }
  ...
  public void L()
  {
    ...
    localbcir = this.jdField_a_of_type_Bcis.a();
    if ((localbcir != null) && (HotChatManager.jdField_a_of_type_Boolean)) {
      localbcir.c();
    }
    HotChatManager.jdField_a_of_type_Boolean = true;
    if (((this.jdField_a_of_type_Bcis.b()) || (!this.aa)) && (!this.ab) && (this.ae))
    {
      this.jdField_a_of_type_Atcf.a(1, null, l1, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d);
      if ((localbcir != null) && (localbcir.b())) {
        axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_wolf", "", "in_game", "mini_ball", 0, 0, "", "", "", "");
      }
    }
    this.ae = true;
    this.jdField_a_of_type_Atcf.jdField_a_of_type_Boolean = false;
  }
  ...
  public void O()
  {
    ...
    this.jdField_a_of_type_Atcf.jdField_a_of_type_Boolean = true;
    this.jdField_a_of_type_Atcf.d = false;
    if (!this.jdField_a_of_type_Atcf.a()) {
      this.jdField_a_of_type_Atcf.a(this);
    }
    bcir localbcir = this.jdField_a_of_type_Bcis.a();
    if (localbcir != null) {
      localbcir.d();
    }
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    Object localObject = this.jdField_a_of_type_Bcis.a();
    if (localObject != null)
    {
      localObject = ((bcir)localObject).b();
      if (localObject == null) {
  ...
  public void a(int paramInt1, int paramInt2, Intent paramIntent)
  {
    if ((paramInt1 == 2000) && (paramInt2 == -1) && (paramIntent != null) && (paramIntent.getExtras() != null))
    {
      ...
      if (this.ab) {
        this.jdField_a_of_type_Atcf.a(this.jdField_a_of_type_AndroidContentContext);
      }
    }
  ...
  {
    long l1 = ((Long)atbg.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), "game_room_last_time", Long.valueOf(0L))).longValue();
    if (paramList.size() != 0)
    {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((this.jdField_a_of_type_Bcic.jdField_a_of_type_JavaLangString != null) && (this.jdField_a_of_type_Bcic.jdField_a_of_type_JavaLangString.equals(paramCharSequence.senderuin))) {
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Bcic = ((bcic)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(107));
    this.jdField_a_of_type_Bcis = this.jdField_a_of_type_Bcic.a((String)localObject);
    ...
    for (;;)
    {
      ...
      this.ad = true;
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Bciq);
      this.jdField_a_of_type_Atcf.a(this.jdField_a_of_type_AndroidContentContext);
  ...
  public void bA()
  {
    ...
    int i = localbcir.b();
    int j = localbcir.a();
    this.jdField_a_of_type_Bcic.a(localHotChatInfo, i, j, new aepw(this));
    axqw.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "grp_lbs", "", "wolf", "die_newgame", 0, 0, "" + i, "" + j, "", "");
  }
  ...
  public void bt()
  {
    ...
    do
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Atcf.a(l1, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d);
        return;
      }
      catch (Exception localException) {}
  ...
  public void by()
  {
    bfol localbfol = (bfol)bfoy.a(a(), null);
    localbfol.a(ajyc.a(2131705090));
    localbfol.a(ajyc.a(2131705077), 3);
    localbfol.c(2131690596);
    localbfol.a(new aeps(this, localbfol));
    localbfol.show();
  }
  ...
  {
    super.d(paramInt);
    this.jdField_a_of_type_Atcf.a(paramInt);
    bcir localbcir = this.jdField_a_of_type_Bcis.a();
    if (localbcir != null) {
      localbcir.a(paramInt);
    }
  }
  ...
  public void e(Intent paramIntent)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription(ajyc.a(2131705118));
  ...
  public void e(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    this.jdField_a_of_type_Bcic.jdField_a_of_type_Boolean = paramBoolean1;
    a(0, true);
    ...
    {
      return;
      HashMap localHashMap1 = localbcir.b();
      HashMap localHashMap2 = localbcir.a();
  ...
  public void f()
  {
    ...
    if ((localObject == null) || (((String)localObject).equals("1000")))
    {
      ...
      ((RelativeLayout.LayoutParams)localObject).topMargin = bawz.a(this.jdField_a_of_type_AndroidContentContext, 295.0F);
      ...
      ((RelativeLayout.LayoutParams)localObject).height = bawz.a(this.jdField_a_of_type_AndroidContentContext, 50.0F);
      ...
      new RelativeLayout.LayoutParams(-1, bawz.a(this.jdField_a_of_type_AndroidContentContext, 50.0F)).addRule(12);
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout.setPadding(0, 0, 0, bawz.a(this.jdField_a_of_type_AndroidContentContext, 0.0F));
      ...
      int k = bawz.a(this.jdField_a_of_type_AndroidContentContext, 5.0F);
      ...
      label588:
      this.l.setBackgroundResource(2130848771);
      this.l.setTextSize(16.0F);
      this.l.setText(ajyc.a(2131705125));
      this.l.setMinHeight(bawz.a(this.jdField_a_of_type_AndroidContentContext, 35.0F));
      this.l.setEnabled(false);
      localObject = new RelativeLayout.LayoutParams(-1, -2);
      ((RelativeLayout.LayoutParams)localObject).addRule(12);
      ((RelativeLayout.LayoutParams)localObject).leftMargin = bawz.a(this.jdField_a_of_type_AndroidContentContext, 86.0F);
      ((RelativeLayout.LayoutParams)localObject).rightMargin = bawz.a(this.jdField_a_of_type_AndroidContentContext, 10.0F);
      ((RelativeLayout.LayoutParams)localObject).bottomMargin = bawz.a(this.jdField_a_of_type_AndroidContentContext, 7.0F);
      this.jdField_a_of_type_AndroidWidgetRelativeLayout.addView(this.l, (ViewGroup.LayoutParams)localObject);
      this.l.setOnTouchListener(new aeph(this));
      this.jdField_f_of_type_AndroidWidgetRelativeLayout = new RelativeLayout(this.jdField_a_of_type_AndroidContentContext);
      this.jdField_f_of_type_AndroidWidgetRelativeLayout.setOnTouchListener(new aepp(this));
      ...
      this.m.setText(ajyc.a(2131705139));
      this.m.setEnabled(true);
      this.m.setVisibility(0);
      localObject = new RelativeLayout.LayoutParams(-1, bawz.a(this.jdField_a_of_type_AndroidContentContext, 50.0F));
      ((RelativeLayout.LayoutParams)localObject).addRule(12);
      this.m.setOnTouchListener(new aepx(this));
      this.jdField_f_of_type_AndroidWidgetRelativeLayout.addView(this.m, (ViewGroup.LayoutParams)localObject);
      localObject = new RelativeLayout.LayoutParams(-1, bawz.a(this.jdField_a_of_type_AndroidContentContext, 245.0F));
      ((RelativeLayout.LayoutParams)localObject).topMargin = bawz.a(this.jdField_a_of_type_AndroidContentContext, 50.0F);
      i = j;
      label982:
  ...
  public void f(String paramString)
  {
    this.ab = true;
    this.ac = false;
    bbgg localbbgg = bbcv.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 230);
    localbbgg.setMessage(paramString);
    localbbgg.setPositiveButton(2131694793, new aepo(this));
    localbbgg.setOnDismissListener(new aepq(this));
    if (QLog.isColorLevel()) {
  ...
  public void f(boolean paramBoolean)
  {
    ...
    if (!this.jdField_a_of_type_Bcis.b())
    {
      super.f(paramBoolean);
      this.aa = true;
      this.ab = true;
    ...
    if ((localbcir.b()) && (!localbcir.c()))
    {
      bbcv.a(this.jdField_a_of_type_AndroidContentContext, 230, null, ajyc.a(2131705126), ajyc.a(2131705072), ajyc.a(2131705105), new aepj(this, paramBoolean), new aepk(this)).show();
      return;
    }
    bbcv.a(this.jdField_a_of_type_AndroidContentContext, 230, null, ajyc.a(2131705102), ajyc.a(2131705059), ajyc.a(2131705113), new aepl(this, paramBoolean, localbcir), new aepm(this)).show();
  }
  ...
  public boolean i()
  {
    ...
    if ((localbcir.b()) && (!localbcir.c()))
    {
      bbcv.a(this.jdField_a_of_type_AndroidContentContext, 230, null, ajyc.a(2131705097), ajyc.a(2131705123), ajyc.a(2131705107), new aeqa(this), new aeqb(this)).show();
      return true;
    }
    bbcv.a(this.jdField_a_of_type_AndroidContentContext, 230, null, ajyc.a(2131705131), ajyc.a(2131705087), ajyc.a(2131705065), new aeqc(this, localbcir), new aepi(this)).show();
    return true;
  }
  ...
  public void onNetMobile2None()
  {
    ...
    bcpw.a(this.jdField_a_of_type_AndroidContentContext, 1, 2131694610, 0).a();
  }
  ...
  public void t(boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      ...
      if (this.jdField_p_of_type_AndroidViewView == null)
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqActivityAioInputLinearLayout.getMeasuredWidth() != 0)
        {
          ...
          if ((localbcir == null) || (!localbcir.c())) {
            break label292;
          }
          this.l.setText(ajyc.a(2131705122));
          label209:
          if (!this.W) {
            this.jdField_f_of_type_AndroidWidgetRelativeLayout.setVisibility(8);
          }
    ...
    do
    {
      ...
      break label177;
      this.l.setText(ajyc.a(2131705075));
      break label209;
      this.l.setText(ajyc.a(2131705098));
  ...
  public void x()
  {
    ...
    if (localbcir != null)
    {
      bool = localbcir.c();
      if (bool) {
        localbfol.a(ajyc.a(2131705056), 3);
      }
      if (!bool) {
        break label102;
      }
      localbfol.c(ajyc.a(2131705120));
    }
    for (;;)
    {
      localbfol.c(ajyc.a(2131705127));
      localbfol.d(ajyc.a(2131705081));
      localbfol.a(new aepr(this, bool, localbfol));
      localbfol.show();
      return;
      bool = false;
      break;
      label102:
      localbfol.a(ajyc.a(2131705078), 3);
    }
  }
}
