...
public class aepg
  extends BaseAdapter
  implements View.OnClickListener, beke
{
  public static int a;
  ...
  public aepg(Context paramContext, QQAppInterface paramQQAppInterface, BaseActivity paramBaseActivity, SessionInfo paramSessionInfo, MqqHandler paramMqqHandler)
  {
    ...
    {
      this.jdField_b_of_type_JavaUtilList.add(new aepi());
      i += 1;
    }
    this.jdField_a_of_type_JavaUtilList.addAll(this.jdField_b_of_type_JavaUtilList);
    this.jdField_a_of_type_Float = this.jdField_a_of_type_AndroidContentContext.getResources().getDisplayMetrics().density;
    this.c = aciy.a(85.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.d = aciy.a(85.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.e = aciy.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.f = aciy.a(80.0F, this.jdField_a_of_type_AndroidContentContext.getResources());
    this.g = aciy.a(2.5F, this.jdField_a_of_type_AndroidContentContext.getResources());
  }
  
  public aepi a(int paramInt)
  {
    if (paramInt < this.jdField_a_of_type_JavaUtilList.size()) {
      return (aepi)this.jdField_a_of_type_JavaUtilList.get(paramInt);
    }
    return null;
  }
  ...
  public void a(int paramInt, String paramString)
  {
    ...
    {
      this.jdField_a_of_type_JavaUtilList.clear();
      awqx.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00898", "", "", "0X8008C71", "0X8008C71", aeor.a(aeor.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a()), 0, "", "", "", "");
    }
    this.jdField_a_of_type_JavaLangString = paramString;
    while (i < paramInt)
    {
      this.jdField_a_of_type_JavaUtilList.add(new aepi());
      i += 1;
    }
    this.jdField_b_of_type_Int = -1;
    notifyDataSetChanged();
  ...
  public void a(aepi paramaepi)
  {
    if (paramaepi != null)
    {
      int i = paramaepi.jdField_a_of_type_Int;
      if ((i >= 0) && (i < this.jdField_a_of_type_JavaUtilList.size())) {
        ((aepi)this.jdField_a_of_type_JavaUtilList.get(i)).a(paramaepi);
      }
      notifyDataSetChanged();
    }
  }
  ...
  public void b()
  {
    ...
    if (TextUtils.isEmpty(((aepi)this.jdField_a_of_type_JavaUtilList.get(i - 1)).d)) {}
    while (i <= this.jdField_b_of_type_Int) {
      return;
    }
    this.jdField_b_of_type_Int = i;
    aeor.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.jdField_a_of_type_JavaUtilList.size(), this.jdField_a_of_type_JavaLangString);
  }
  
  public void b(View paramView)
  {
    if ((paramView != null) && ((paramView.getTag() instanceof aeph)))
    {
      paramView = (aeph)paramView.getTag();
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((paramView == null) || (paramView.getTag() == null))
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetProgressBar.setIndeterminateDrawable(this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839113));
      ...
      paramViewGroup.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(localaepi);
      paramViewGroup.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(0);
      if (!localaepi.jdField_a_of_type_Boolean) {
        break label822;
      }
      String str = aeor.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(localaepi);
      localObject2 = aeor.a(str);
      localObject1 = localObject2;
      if (localObject2 == null)
      {
        aeor.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).c(localaepi);
        localObject1 = localObject2;
        if (QLog.isColorLevel()) {
    ...
    {
      if ((localaepi.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null) || (localObject1 != null))
      {
        paramViewGroup.jdField_a_of_type_AndroidWidgetRelativeLayout.setMinimumWidth(0);
        localObject2 = localaepi.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
        paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetBubbleImageView.setTag(localaepi.jdField_a_of_type_JavaLangString + localaepi.e);
      ...
      for (localObject1 = new GifDrawable((AbstractGifImage)localObject1);; localObject1 = localObject2)
      {
        ...
        for (;;)
        {
          if ((localaepi.jdField_a_of_type_Aepj != null) && (!localaepi.jdField_a_of_type_Aepj.jdField_a_of_type_Boolean))
          {
            aeor.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).b(localaepi);
            localaepi.jdField_a_of_type_Aepj.jdField_a_of_type_Boolean = true;
          }
          return paramView;
          paramViewGroup = (aeph)paramView.getTag();
          break;
          if (j > this.f)
          {
            i = i * this.f / j;
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      if ((paramView != null) && ((paramView instanceof aeph))) {}
      for (paramView = (aeph)paramView;; paramView = null)
      {
        if (paramView == null) {
          break label149;
        }
        paramView = (aepi)paramView.jdField_a_of_type_JavaLangRefWeakReference.get();
        if ((paramView == null) || (paramView.jdField_a_of_type_JavaLangString == null) || (paramView.jdField_a_of_type_Aepj == null)) {
          break;
        }
        ThreadManager.post(new ZhituPicAdapter.1(this, paramView), 8, null, false);
        aeor.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(paramView);
