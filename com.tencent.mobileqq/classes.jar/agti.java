  ...
  extends BaseChatPie
{
  ...
  private bicq jdField_a_of_type_Bicq = new aguu(this);
  ...
  private BusinessObserver jdField_a_of_type_MqqObserverBusinessObserver = new agtv(this);
  public nrc a;
  public nti a;
  nub jdField_a_of_type_Nub = new agur(this);
  public int[] a;
  private boolean aA;
  private boolean aB;
  public boolean aa;
  ...
  private boolean ay;
  private boolean az;
  private amrw jdField_b_of_type_Amrw;
  ...
  public agti(QQAppInterface paramQQAppInterface, ViewGroup paramViewGroup, FragmentActivity paramFragmentActivity, Context paramContext)
  {
    ...
    this.jdField_u_of_type_Int = 2130837731;
    this.jdField_v_of_type_Int = 2130837730;
    this.jdField_k_of_type_Long = 9223372036854775807L;
    this.jdField_j_of_type_Long = 0L;
    this.jdField_G_of_type_Int = -1;
    this.jdField_a_of_type_Astc = new astc("web_public_account", "com.tencent.mobileqq:tool");
    this.jdField_a_of_type_AndroidOsHandler = new agtj(this);
    this.jdField_a_of_type_Alwx = new agtl(this);
    this.jdField_a_of_type_Alzr = new aguq(this);
    this.jdField_a_of_type_Bfzo = new aguv(this);
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new aguy(this);
  }
  ...
  private void a(View paramView, int paramInt1, int paramInt2, Animator.AnimatorListener paramAnimatorListener)
  {
    ...
    localValueAnimator.addUpdateListener(new agtm(this, paramView, paramInt1, paramInt2));
  ...
  public static boolean a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    if (localObject != null) {}
    for (localObject = ((alzl)localObject).b(paramString);; localObject = null)
    {
      if (localObject == null)
      {
  ...
  private void bM()
  {
    ...
    for (localObject = ((TicketManager)localObject).getSkey(str);; localObject = null)
    {
      ...
      new bcky("https://buluo.qq.com/cgi-bin/bar/extra/clean_temp_follow_state", "", new agty(this), 1000, null).a(localHashMap);
      bt();
      return;
    }
  }
  ...
  private void bN()
  {
    ...
    PublicAccountInfo localPublicAccountInfo = ((alzl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56)).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
  ...
  private void bO()
  {
    ...
    localHashMap.put("net_type", "" + bavg.a().a());
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      azri.a(BaseApplication.getContext()).a(null, "actPublicAccountWebviewPreload", bool, l1, 0L, localHashMap, "");
  ...
  private void bP()
  {
    ...
    try
    {
      ...
      ((NewIntent)localObject).setObserver(new aguf(this));
  ...
  private void bQ()
  {
    if (this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo == null)
    {
      ...
      if (localalzl != null) {
        this.jdField_a_of_type_ComTencentMobileqqDataPublicAccountInfo = localalzl.c(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      }
    }
  ...
  private void bR()
  {
    ...
    if (Build.VERSION.SDK_INT >= 23)
    {
      ...
      {
        this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.requestPermissions(new agun(this), 1, new String[] { "android.permission.ACCESS_FINE_LOCATION" });
        return;
      }
      bS();
      return;
  ...
  private void bS()
  {
    SosoInterface.a(new aguo(this, 1, true, true, 0L, false, false, "PublicAccountChatPie"));
  }
  ...
  private void bU()
  {
    ...
    if (localObject != null)
    {
      localObject = ((alzl)localObject).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      if ((localObject != null) && (syb.a(((PublicAccountInfo)localObject).accountFlag2) == -10L))
      {
        this.aA = true;
        localObject = bdbk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 115, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
        if (localObject != null)
        {
  ...
  private void bV()
  {
    ...
    if (localPublicAccountInfo != null) {
      ajkm.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localPublicAccountInfo.uin + "", l1 - l2, localPublicAccountInfo.name + "");
    }
  ...
  private void c(AccountDetail paramAccountDetail)
  {
    ...
    Object localObject1 = (TextView)this.jdField_o_of_type_AndroidViewView.findViewById(2131379269);
    Object localObject2 = (TextView)this.jdField_o_of_type_AndroidViewView.findViewById(2131379268);
    ImageView localImageView = (ImageView)this.jdField_o_of_type_AndroidViewView.findViewById(2131367819);
    if (this.ay) {
      if ((this.jdField_a_of_type_Bbrh != null) && (this.jdField_a_of_type_Bbrh.b > 0) && (this.jdField_a_of_type_Bbrh.jdField_a_of_type_JavaUtilList.size() > 0))
      {
        TroopInfo localTroopInfo = (TroopInfo)this.jdField_a_of_type_Bbrh.jdField_a_of_type_JavaUtilList.get(0);
        ((TextView)localObject1).setText(localTroopInfo.troopname);
        ((TextView)localObject2).setText(String.format(this.jdField_a_of_type_AndroidContentContext.getString(2131695705), new Object[] { paramAccountDetail.name }));
        localImageView.setImageDrawable(bdbk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 4, localTroopInfo.troopuin));
        localObject1 = "";
        if (this.jdField_a_of_type_Bbrh.jdField_a_of_type_JavaUtilList.size() > 0) {
          localObject1 = ((TroopInfo)this.jdField_a_of_type_Bbrh.jdField_a_of_type_JavaUtilList.get(0)).troopuin;
        }
        if (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo != null) {
          break label318;
        }
        localObject2 = "";
        azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_public", "", "oper", "exp_temp", 0, 0, (String)localObject1, "" + (String)localObject2, "", "");
      }
    }
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_Altm = new aguj(this, localImageView);
        this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.addObserver(this.jdField_a_of_type_Altm);
      }
      localObject1 = (ImageView)this.jdField_o_of_type_AndroidViewView.findViewById(2131364085);
      ...
      localImageView.setImageDrawable(bdbk.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, a().jdField_a_of_type_JavaLangString, (byte)3));
    }
    label375:
  ...
  private void g(String paramString)
  {
    ...
    if (localObject != null)
    {
      localObject = ((alzl)localObject).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      ...
      this.jdField_b_of_type_MqqObserverBusinessObserver = new agtz(this, paramString);
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_Amrw = new amrw(new agua(this, paramString));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_b_of_type_Amrw);
      amsb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 0);
    }
  }
  
  public void A(int paramInt)
  {
    if (this.jdField_d_of_type_Bety == null) {
      this.jdField_d_of_type_Bety = new bety(this.jdField_a_of_type_AndroidWidgetRelativeLayout.getContext(), this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getTitleBarHeight());
    }
    if ((!this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.isFinishing()) && (this.jdField_d_of_type_Bety != null))
    {
      this.jdField_d_of_type_Bety.c(paramInt);
      if (!this.jdField_d_of_type_Bety.isShowing()) {
        this.jdField_d_of_type_Bety.show();
      }
    }
  }
  ...
  public void D(int paramInt)
  {
    try
    {
      ...
      for (;;)
      {
        ...
        return;
        this.jdField_m_of_type_AndroidWidgetTextView.setText(2131720343);
        continue;
        this.jdField_m_of_type_AndroidWidgetTextView.setText(2131720337);
        continue;
        this.jdField_m_of_type_AndroidWidgetTextView.setText(2131695731);
      }
      return;
    }
    catch (Exception localException) {}
  ...
  public void E(int paramInt)
  {
    if (this.jdField_h_of_type_AndroidAppDialog == null)
    {
      ...
      this.jdField_h_of_type_AndroidAppDialog.setContentView(2131560721);
    }
    TextView localTextView1 = (TextView)this.jdField_h_of_type_AndroidAppDialog.findViewById(2131377938);
    ...
    for (;;)
    {
      this.jdField_h_of_type_AndroidAppDialog.setOnCancelListener(new aguw(this));
      this.jdField_h_of_type_AndroidAppDialog.show();
      return;
      localTextView1.setText(2131698563);
      localTextView2.setText(2131698569);
      continue;
      localTextView1.setText(2131698564);
      localTextView2.setText(2131698565);
      continue;
      localTextView1.setText(2131698567);
      localTextView2.setText(2131698565);
    }
  }
  ...
  public boolean E()
  {
    Object localObject = (alzl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56);
    if (localObject != null) {}
    for (localObject = ((alzl)localObject).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);; localObject = null)
    {
  ...
  public void H()
  {
    oxp.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_l_of_type_Long, this.ac, this.jdField_a_of_type_Aeqo.a());
    ...
    for (;;)
    {
      ...
      try
      {
        this.jdField_a_of_type_AndroidContentContext.unregisterReceiver(this.jdField_a_of_type_Agvb);
        label89:
        ...
        if (this.jdField_a_of_type_Altm != null)
        {
          this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.removeObserver(this.jdField_a_of_type_Altm);
        ...
        Iterator localIterator = this.jdField_a_of_type_Aeqo.a().iterator();
        ...
        if (this.jdField_a_of_type_Bbrh != null) {
          this.jdField_a_of_type_Bbrh.a();
        }
        ...
        if (this.jdField_l_of_type_Long != 0L)
        {
          ...
          azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", "" + this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0X80064D5", "0X80064D5", 0, 0, "", "" + this.jdField_l_of_type_Long, "" + this.J, "");
  ...
  public void M()
  {
    ...
    for (;;)
    {
      ...
      return;
      amrz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_G_of_type_Int, 2, System.currentTimeMillis() - this.jdField_n_of_type_Long);
      continue;
      amrz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_G_of_type_Int, 3, System.currentTimeMillis() - this.jdField_n_of_type_Long);
      continue;
      amrz.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_G_of_type_Int, 4, System.currentTimeMillis() - this.jdField_n_of_type_Long);
    }
  }
  ...
  public void N()
  {
    ...
    if (this.jdField_a_of_type_Bbrh.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_Bbrh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      this.jdField_a_of_type_Bbrh.c();
    }
    if ((afwq.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) && (this.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)) {
      this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setHint(alud.a(2131709138));
    }
    if ((!this.au) && (this.av))
    {
      this.av = false;
    ...
    if (mdj.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin()))
    {
      this.jdField_d_of_type_AndroidWidgetImageView.setVisibility(0);
      this.jdField_d_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setRight2Icon(2130846632);
      return;
    }
    this.jdField_d_of_type_AndroidWidgetImageView.setVisibility(8);
  }
  ...
  public void P()
  {
    ...
    try
    {
      ...
      azqs.b(null, "dc00898", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "auth_aio", "exp", 0, 0, "", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d, "");
      return;
    }
    ...
    if (paramAbsStructMsg != null) {
      try
      {
        if ((paramAbsStructMsg instanceof StructMsgForGeneralShare))
        {
          ...
          {
            paramAbsStructMsg = bhsz.b(paramAbsStructMsg.substring(paramAbsStructMsg.indexOf("?") + 1));
  ...
  {
    alrr localalrr = (alrr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(21);
    if (localalrr != null) {
      localalrr.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 3, paramInt, 1, paramBusinessObserver);
    }
  }
  ...
  public void a(Intent paramIntent)
  {
    ...
    if (afwq.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
    {
  ...
  public void a(QQMessageFacade.Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Bbrh != null)
      {
        Iterator localIterator = this.jdField_a_of_type_Bbrh.jdField_a_of_type_JavaUtilList.iterator();
        do
        {
  ...
  public void a(PublicAccountInfo paramPublicAccountInfo)
  {
    ...
    for (;;)
    {
      ...
      {
        String str1 = this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131692261);
        String str2 = String.format(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131692259), new Object[] { this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d });
        this.jdField_g_of_type_AndroidAppDialog = bdgm.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, 230, str1, str2, 2131692258, 2131692260, new agug(this, paramPublicAccountInfo, localalzl), new aguh(this, paramPublicAccountInfo, localalzl));
        this.jdField_g_of_type_AndroidAppDialog.setOnDismissListener(new agui(this));
  ...
  void a(AbsListView paramAbsListView)
  {
    ...
    {
      localChatMessage = (ChatMessage)this.jdField_a_of_type_Aeqo.getItem(i1);
  ...
  public void a(List<ChatMessage> paramList, CharSequence paramCharSequence)
  {
    ...
    for (;;)
    {
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Pb_account_lifeservice", "" + this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0X80064D4", "0X80064D4", 0, 0, "", "" + i1, "" + l1, "");
      return;
      label174:
      continue;
      label177:
      ...
      try
      {
        if ((J()) && (nvd.a()) && (paramList.size() > 0))
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            azus localazus = nur.a((MessageRecord)localObject);
            if ((localazus == null) || (localazus.h != 1)) {
              break label106;
            }
  ...
  public void a(Map<String, String> paramMap)
  {
    ...
    for (;;)
    {
      this.jdField_a_of_type_Nrc.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramMap, (String)localObject, null, new agux(this));
      return;
      localObject = null;
      paramMap = null;
    }
  ...
  public boolean a(int paramInt, View paramView, ListView paramListView)
  {
    ...
    if ((this.jdField_a_of_type_Aeqo != null) && (this.jdField_a_of_type_Aeqo.getCount() > 0))
    {
      this.ab = true;
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 21, this.jdField_a_of_type_Abts);
    }
    return true;
  }
  ...
  public boolean a(boolean paramBoolean)
  {
    ...
    this.jdField_a_of_type_Agvb = new agvb(this, null);
    ...
    this.jdField_a_of_type_AndroidContentContext.registerReceiver(this.jdField_a_of_type_Agvb, (IntentFilter)localObject1);
    this.N = false;
    ...
    this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.setDrawFinishedListener(this.jdField_a_of_type_Bicq);
    this.jdField_a_of_type_Bbrh = new bbrh();
    this.jdField_a_of_type_Bbrh.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, a(), this, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_AndroidWidgetRelativeLayout, this.jdField_a_of_type_Aeqo, this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView);
    this.jdField_a_of_type_Bbrh.addObserver(this);
    ...
    if (!this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.isFinishing())
    {
      ...
      this.ax = true;
      bv();
      this.jdField_a_of_type_Bbrh.f();
      if (this.jdField_a_of_type_Bbrh.b > 0) {
        break label483;
      }
      this.jdField_a_of_type_Bbrh.a(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString).longValue(), 1);
    }
    for (;;)
    {
      ...
      return true;
      label483:
      int i2 = ((bcml)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(132)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      if (i2 == -1)
      {
        this.jdField_a_of_type_Bbrh.a(Long.valueOf(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString).longValue(), 2);
      }
      else
      {
        int i1;
        ...
        for (;;)
        {
          ...
          break label554;
          label584:
          this.jdField_a_of_type_Bbrh.e();
          this.jdField_a_of_type_Bbrh.b();
        }
        label601:
        bK();
      }
    ...
    if ((bdin.b(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getApplicationContext()) == 1) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString != null) && (this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString.equals("2632129500"))) {
      nbv.b("108", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, new agus(this));
    }
    if ("3105932915".equals(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
    {
      localObject1 = (biml)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(142);
      if (localObject1 != null) {
        bimi.a(((biml)localObject1).a(5));
      }
    }
    ...
    for (;;)
    {
      ...
      if (((alzl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56)).a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
        this.V = true;
      }
      if ((I()) && (this.E > 0)) {
      ...
      if (J())
      {
        ArkAppNotifyCenter.setNotify("com.tencent.gouwu.video", new WeakReference(new ankv()));
      ...
      if (afwq.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
        akgt.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 5);
      }
      return true;
      ...
      {
        azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X80090E2", "0X80090E2", 0, 0, "", "", "", "");
        azqp.a(2);
      }
    }
  }
  ...
  public void ai()
  {
    ...
    for (;;)
    {
      ...
      if (("3026775809".equals(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) && (Build.VERSION.SDK_INT >= 19) && (((SensorManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext().getSystemService("sensor")).getDefaultSensor(19) != null)) {
        ((bdys)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(260)).a("public account");
      }
    }
  }
  ...
  {
    int i1 = this.jdField_a_of_type_Aeqo.a(paramChatMessage) + 1;
    if ((i1 >= 0) && (i1 <= this.jdField_a_of_type_Aeqo.getCount() - 1))
    {
      ChatMessage localChatMessage = (ChatMessage)this.jdField_a_of_type_Aeqo.getItem(i1);
  ...
  {
    azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004EF8", "0X8004EF8", 0, 0, Integer.toString(paramInt), "", "", "");
    if (this.jdField_b_of_type_MqqAppNewIntent != null)
    {
      nrc.a().a(this.jdField_b_of_type_MqqAppNewIntent);
      this.jdField_b_of_type_MqqAppNewIntent = null;
    }
    this.jdField_b_of_type_MqqAppNewIntent = nrc.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, paramInt, paramBoolean, BaseApplication.getContext(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new aguk(this));
  }
  ...
  public boolean b(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      localObject = ((alzl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56)).b(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      if (localObject != null) {
  ...
  protected void bB()
  {
    ...
    do
    {
      ...
      this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130844438);
    ...
    if (this.jdField_f_of_type_Int == 2)
    {
      ...
      {
        if (CustomMenuBar.a()) {
          this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130849319);
        }
        for (;;)
        {
          this.jdField_p_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidContentContext.getString(2131698777));
          return;
          this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130849715);
        }
      }
      if (CustomMenuBar.a()) {
        this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130849318);
      }
      for (;;)
      {
        this.jdField_p_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidContentContext.getString(2131698776));
        return;
        this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130849716);
      }
    }
    this.jdField_p_of_type_AndroidWidgetImageView.setEnabled(true);
    if (this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a() == 3)
  ...
  public void bC()
  {
    this.jdField_v_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131559497, null);
    this.jdField_l_of_type_AndroidWidgetTextView = ((TextView)this.jdField_v_of_type_AndroidViewView.findViewById(2131375593));
    if (!this.aa) {
      this.jdField_l_of_type_AndroidWidgetTextView.setVisibility(8);
    }
    this.jdField_m_of_type_AndroidWidgetTextView = ((TextView)this.jdField_v_of_type_AndroidViewView.findViewById(2131375587));
    this.jdField_t_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_v_of_type_AndroidViewView.findViewById(2131375585));
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)this.jdField_v_of_type_AndroidViewView.findViewById(2131375588));
  }
  ...
  void bD()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_i_of_type_JavaLangString))
    {
      ...
      this.jdField_a_of_type_Bfyh.a(str, this.jdField_j_of_type_JavaLangString);
      return;
    }
    this.jdField_j_of_type_JavaLangString = this.jdField_a_of_type_Bfyh.b(str);
  ...
  public void bH()
  {
    ...
    if (this.ao) {
      if (((alzl)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(56)).c(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString) == null) {
        break label292;
      }
    }
    label292:
    for (int i1 = 1;; i1 = 0)
    {
      ...
      for (;;)
      {
        ...
        if (this.jdField_s_of_type_AndroidWidgetImageView == null) {
          this.jdField_s_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131365904));
        }
  ...
  public void bI()
  {
    ...
    do
    {
      ...
      {
        amkl.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp().getResources().getString(2131698566), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, false, true);
        return;
      }
  ...
  public void br()
  {
    ChatMessage localChatMessage;
    String str1;
    if (this.jdField_a_of_type_Aeqo.getCount() >= 1)
    {
      localChatMessage = (ChatMessage)this.jdField_a_of_type_Aeqo.a().get(this.jdField_a_of_type_Aeqo.getCount() - 1);
      str1 = "0";
      if (localChatMessage != null)
      {
    ...
    catch (Exception localException)
    {
      ...
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0X8005D17", "0X8005D17", 0, 1, 0, "old", String.valueOf(l1 - this.jdField_h_of_type_Long), "", "");
    }
    Object localObject = localChatMessage.getExtInfoFromExtStr("pa_msgId");
    azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "" + localChatMessage.frienduin, "0X8005C38", "0X8005C38", 0, 1, 0, (String)localObject, String.valueOf(NetConnInfoCenter.getServerTime() * 1000L), "", str1);
    if (this.Z)
    {
      l1 = NetConnInfoCenter.getServerTime() * 1000L;
      if (this.aa) {
        azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0X8005D17", "0X8005D17", 0, 1, 0, "new", String.valueOf(l1 - this.jdField_h_of_type_Long), "", "");
      }
    }
    else
    {
  ...
  public void bs()
  {
    if ((!this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.isFinishing()) && (this.jdField_d_of_type_Bety != null) && (this.jdField_d_of_type_Bety.isShowing())) {
      this.jdField_d_of_type_Bety.dismiss();
    }
  }
  ...
  void bt()
  {
    ...
    a(this.jdField_u_of_type_AndroidViewView, this.jdField_u_of_type_AndroidViewView.getHeight(), 0, new agtn(this));
    ...
    localTranslateAnimation.setAnimationListener(new agto(this));
  ...
  void bu()
  {
    ...
    do
    {
      ...
      this.jdField_o_of_type_AndroidViewView.findViewById(2131367819).setOnClickListener(new agtr(this));
      if (this.jdField_q_of_type_Int != 2) {
        break;
      }
      this.jdField_o_of_type_AndroidViewView.findViewById(2131372434).setVisibility(8);
      this.jdField_o_of_type_AndroidViewView.findViewById(2131372420).setVisibility(8);
    ...
    if (this.jdField_q_of_type_Int == 2)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar = ((PublicMenuBar)this.jdField_o_of_type_AndroidViewView.findViewById(2131372417));
      this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.setOnMenuItemClickListener(new agts(this));
      ...
      i1 = 2131691962;
      localObject = new yxj("DO_NOT_FOLLOW", ((FragmentActivity)localObject).getString(i1), a().getResources().getDrawable(2130841412), 0);
      localyxj1 = new yxj("DO_FOLLOW", this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131691959), a().getResources().getDrawable(2130841311), 1);
      this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.a((yxj)localObject, 2131559845);
      this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.a(localyxj1, 2131559845);
    }
    for (;;)
    {
      ...
      break label380;
      label613:
      localObject = new yxj("DO_CANCEL", this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131690653), a().getResources().getDrawable(2130841412), 0);
      localyxj1 = new yxj("DO_FOLLOW", this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131691959), a().getResources().getDrawable(2130841311), 1);
      yxj localyxj2 = new yxj("DO_NOT_FOLLOW", this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getString(2131691962), a().getResources().getDrawable(2130841412), 0);
      this.jdField_r_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.a((yxj)localObject, 2131559845);
      this.jdField_q_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.a(localyxj2, 2131559845);
      this.jdField_s_of_type_AndroidViewView = this.jdField_a_of_type_ComTencentMobileqqWidgetPublicMenuBar.a(localyxj1, 2131559845);
    }
    label768:
  ...
  void bw()
  {
    ...
    {
      this.jdField_a_of_type_Bhuf = ((bhuf)bhus.a(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity, null));
      this.jdField_a_of_type_Bhuf.a(alud.a(2131709185));
      this.jdField_a_of_type_Bhuf.a(alud.a(2131709181), 3);
      this.jdField_a_of_type_Bhuf.c(2131690648);
      this.jdField_a_of_type_Bhuf.setOnDismissListener(new agtw(this));
      this.jdField_a_of_type_Bhuf.a(new agtx(this));
    }
  ...
  void bx()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidWidgetRelativeLayout != null)
      {
        ...
        this.jdField_s_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131365904));
        if (this.jdField_s_of_type_AndroidWidgetImageView != null) {
          this.jdField_s_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getText(2131696906));
        }
        ...
        for (;;)
        {
          ...
          if (this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView != null)
          {
            ...
            if ((localObject3 != null) && (localObject2 != null) && ((localObject3 instanceof RelativeLayout.LayoutParams)) && ((localObject2 instanceof RelativeLayout.LayoutParams)))
            {
              ...
              if ((arrayOfInt.length > 2) && (arrayOfInt[2] == 2131368344))
              {
                ((RelativeLayout.LayoutParams)localObject3).addRule(2, 2131365903);
          ...
          if (this.Y)
          {
            localObject1 = new TranslateAnimation(0.0F, 0.0F, aepi.a(34.0F, (Resources)localObject1), 0.0F);
            ((TranslateAnimation)localObject1).setDuration(250L);
            ((TranslateAnimation)localObject1).setFillAfter(true);
            ((TranslateAnimation)localObject1).setAnimationListener(new agub(this));
            this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.startAnimation((Animation)localObject1);
          }
          localObject1 = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131365902);
          ((View)localObject1).setOnClickListener(new aguc(this));
          this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setCoverView((View)localObject1);
          this.jdField_t_of_type_AndroidViewView = this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131371516);
          bN();
          ...
          this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setOnMenuItemClickListener(new agud(this));
          this.jdField_a_of_type_ComTencentBizUiCustomMenuBar.setOnBackClickListner(new ague(this));
          ...
          if ((((Intent)localObject1).hasExtra("pub_account_type")) && ("type_ecshop_account".equals(((Intent)localObject1).getStringExtra("pub_account_type"))))
          {
            ...
            azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Shop_lifeservice", "", "Shop_nearbyiconPv", "Pv_shopnearbyicon", 0, 0, "", "", "", "");
          }
          if ((!I()) || (!asnk.a())) {
            break;
          }
  ...
  void bz()
  {
    ...
    for (;;)
    {
      ...
      label212:
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Amrw);
      this.jdField_a_of_type_Amrw = new amrw(new agum(this));
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Amrw);
      amsb.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, 0);
    }
  }
  ...
  public void c(int paramInt1, int paramInt2)
  {
    ...
    if (paramInt2 == 8) {
      if (this.jdField_q_of_type_AndroidWidgetImageView != null)
      {
        ...
        this.jdField_q_of_type_AndroidWidgetImageView.setImageResource(2130849368);
      }
    }
    for (;;)
    {
      if (!this.jdField_f_of_type_Boolean)
      {
        ...
        {
          localObject = new ImageSpan(this.jdField_a_of_type_AndroidContentContext, 2130837979);
          localSpannableString = new SpannableString(alud.a(2131709191));
        ...
        {
          localObject = new ImageSpan(this.jdField_a_of_type_AndroidContentContext, 2130838258);
          localSpannableString = new SpannableString(alud.a(2131709187));
          localSpannableString.setSpan(localObject, 0, localSpannableString.length(), 33);
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelAudioPanel != null) && (paramInt1 != 2) && (aeox.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) {
          this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelAudioPanel.a(false);
        }
      }
      return;
      label295:
      this.jdField_q_of_type_AndroidWidgetImageView.setImageResource(2130849290);
      continue;
      if (this.jdField_q_of_type_AndroidWidgetImageView != null) {
        if (CustomMenuBar.a()) {
          this.jdField_q_of_type_AndroidWidgetImageView.setImageResource(2130849367);
        } else {
          this.jdField_q_of_type_AndroidWidgetImageView.setImageResource(2130849289);
        }
      }
    }
  ...
  public void c(View paramView)
  {
    ...
    ((afgt)this.jdField_a_of_type_Afev.a(22)).a(paramView);
  }
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentBizUiCustomMenuBar != null)
      {
        ...
        else
        {
          ...
          Object localObject1;
          if ((paramList != null) && (afwq.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)))
          {
            localObject1 = new mobileqq_mp.ButtonInfo();
            ((mobileqq_mp.ButtonInfo)localObject1).id.set(0);
            ((mobileqq_mp.ButtonInfo)localObject1).name.set(alud.a(2131714231));
          ...
          while ((i1 < i3) && (i1 <= 2))
          {
            ...
            if (((mobileqq_mp.ButtonInfo)localObject2).key.has())
            {
              ...
              localyxj = new yxj((String)localObject1, str, null, i2);
              localyxj.a((mobileqq_mp.ButtonInfo)localObject2);
            ...
            {
              localObject1 = new yxj((String)localObject1, str, null, i2);
              ((yxj)localObject1).a(localButtonInfo);
              localyxj.a((yxj)localObject1);
              break label419;
              localObject1 = "";
              break;
              str = "";
  ...
  {
    int i1 = this.jdField_a_of_type_Aeqo.a(paramChatMessage);
    if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Aeqo.a(paramChatMessage);
  }
  
  public void f()
  {
    super.f();
    this.jdField_c_of_type_ComTencentWidgetPatchedButton = ((PatchedButton)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131367006));
    this.jdField_c_of_type_ComTencentWidgetPatchedButton.setContentDescription(alud.a(2131709197));
    ...
    this.jdField_c_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_c_of_type_AndroidViewViewGroup.findViewById(2131367007));
    ...
    for (;;)
    {
      ...
      this.jdField_q_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_d_of_type_AndroidWidgetLinearLayout.findViewById(2131372121));
      this.jdField_q_of_type_AndroidWidgetImageView.setOnClickListener(this);
      this.jdField_p_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_d_of_type_AndroidWidgetLinearLayout.findViewById(2131365645));
      this.jdField_p_of_type_AndroidWidgetImageView.setOnClickListener(this);
      if (!CustomMenuBar.a())
      {
        this.jdField_p_of_type_AndroidWidgetImageView.setImageResource(2130847428);
        this.jdField_q_of_type_AndroidWidgetImageView.setImageResource(2130837925);
      }
      if (this.jdField_a_of_type_ComTencentWidgetXEditTextEx != null)
      {
        int i1 = aepi.a(3.0F, this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getResources());
        if (CustomMenuBar.a())
        {
          this.jdField_a_of_type_ComTencentWidgetXEditTextEx.setBackgroundResource(2130849422);
  ...
  public boolean handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Ahap.a(1000, new Object[0]);
      continue;
  ...
  public void j()
  {
    ahag localahag = new ahag(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, this.jdField_a_of_type_Ahap, this, this.jdField_a_of_type_MqqOsMqqHandler);
    this.jdField_a_of_type_Ahap.a(localahag);
  }
  ...
  public void o(int paramInt)
  {
    ...
    if (paramInt != this.jdField_f_of_type_Int)
    {
      ...
      if (this.jdField_a_of_type_AndroidTextSpannableString == null)
      {
        localImageSpan = new ImageSpan(this.jdField_a_of_type_AndroidContentContext, 2130837979);
        localSpannableString = new SpannableString(alud.a(2131709203));
    ...
    for (;;)
    {
      ...
      if (paramInt == 2)
      {
        if (this.jdField_b_of_type_AndroidTextSpannableString == null)
        {
          localImageSpan = new ImageSpan(this.jdField_a_of_type_AndroidContentContext, 2130838258);
          localSpannableString = new SpannableString(alud.a(2131709132));
          localSpannableString.setSpan(localImageSpan, 0, localSpannableString.length(), 33);
          this.jdField_b_of_type_AndroidTextSpannableString = localSpannableString;
        }
      ...
      else
      {
        ...
        {
          localImageSpan = new ImageSpan(this.jdField_a_of_type_AndroidContentContext, 2130838258);
          localSpannableString = new SpannableString(alud.a(2131709178));
          localSpannableString.setSpan(localImageSpan, 0, localSpannableString.length(), 33);
          this.jdField_b_of_type_AndroidTextSpannableString = localSpannableString;
        }
        if (this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getText().length() > 0) {
  ...
  public void onClick(View paramView)
  {
    ...
    if (2131368638 == paramView.getId())
    {
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004EFD", "0X8004EFD", 0, 0, "", "", "", "");
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8004F08", "0X8004F08", 0, 0, "", "", "", "");
      bdiu.a(null, "pubAcc_profile_display", "");
    }
    if (paramView.getId() == 2131367006)
    {
      ...
      if ((this.jdField_a_of_type_ComTencentWidgetXEditTextEx.getText().length() > 0) && (this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a() != 2) && (this.jdField_r_of_type_AndroidWidgetImageView != null) && (this.jdField_r_of_type_AndroidWidgetImageView.getVisibility() != 0))
      {
        ...
        if (afwq.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString))
        {
          ...
          akgt.a().a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 6);
        }
      }
      if (QLog.isColorLevel())
      {
    ...
    if ((paramView.getId() == 2131365645) && (this.jdField_f_of_type_Int != 1))
    {
      if (this.jdField_a_of_type_ComTencentWidgetXPanelContainer.a() != 3) {
        break label892;
      }
    ...
    else
    {
      ...
      default: 
        label776:
        if ((this.Z) && (paramView.getId() == 2131367006)) {
          azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "0X8005C9C", "0X8005C9C", 0, 1, 0, "", "", "", "");
        }
    ...
    do
    {
      ...
      break label709;
      azqs.b(null, "dc00898", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "auth_aio", "clk_return", 0, 0, "", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d, "");
      break label776;
      ...
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Shop_lifeservice", "", "Shop_nearbyiconClk", "Clk_shopnearbyicon", 0, 0, "", "", "", "");
      if (paramView.getId() != 2131368633) {
        break label1409;
      }
    ...
    if (((alto)localObject1).b((String)localObject2)) {
      localIntent.putExtra("uintype", 0);
    }
    for (;;)
    {
      this.jdField_a_of_type_AndroidContentContext.startActivity(localIntent);
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "Shop_customservice", "Clk_shopcustomservice", 0, 0, "", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin());
      label1409:
      super.onClick(paramView);
      return;
      localIntent.putExtra("uintype", 1005);
      localIntent.putExtra("uinname", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d + alud.a(2131709173));
  ...
  public void onScroll(AbsListView paramAbsListView, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    ((afgt)this.jdField_a_of_type_Afev.a(22)).a(paramAbsListView, paramInt1, paramInt2, paramInt3);
    b(paramAbsListView);
    if ((this.an) || (this.as)) {}
    label273:
    label275:
    ...
    do
    {
      ...
      paramAbsListView.setAnimationListener(new agtp(this));
    ...
    paramAbsListView.setFillAfter(true);
    paramAbsListView.setDuration(250L);
    paramAbsListView.setAnimationListener(new agtq(this));
    this.jdField_o_of_type_AndroidViewView.startAnimation(paramAbsListView);
  }
  ...
  public void onScrollStateChanged(AbsListView paramAbsListView, int paramInt)
  {
    ...
    ((afgt)this.jdField_a_of_type_Afev.a(22)).a(paramAbsListView, paramInt);
  }
  ...
  protected void u(boolean paramBoolean)
  {
    ...
    for (int i1 = 4;; i1 = 0)
    {
      ...
      {
        localObject = new ImageSpan(this.jdField_a_of_type_AndroidContentContext, 2130837979);
        SpannableString localSpannableString = new SpannableString(alud.a(2131709164));
        localSpannableString.setSpan(localObject, 0, localSpannableString.length(), 33);
        this.jdField_a_of_type_AndroidTextSpannableString = localSpannableString;
      }
      this.jdField_c_of_type_ComTencentWidgetPatchedButton.setText(this.jdField_a_of_type_AndroidTextSpannableString);
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    if ((bkbq.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)) && ((paramObject instanceof MessageRecord))) {
    ...
    int i1;
    if ((paramObservable instanceof bbrh)) {
  ...
  public void x()
  {
    if (this.aA)
    {
      ...
      ybt.a(a(), this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
      azqs.b(null, "dc00898", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, "auth_aio", "clk_head", 0, 0, "", "", this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d, "");
      return;
    }
  ...
  public boolean y()
  {
    ...
    {
      this.aj = true;
      this.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.setSelection(this.jdField_a_of_type_Aeqo.getCount() - 1);
    }
  ...
  public void z()
  {
    if (this.jdField_a_of_type_AndroidWidgetImageView != null)
    {
      if ("2277373213".equals(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString)) {
        this.jdField_a_of_type_ComTencentMobileqqWidgetNavbarNavBarAIO.setRight1Icon(2130846877);
      }
    }
    else {
      return;
    ...
    this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(this.jdField_a_of_type_AndroidSupportV4AppFragmentActivity.getText(2131696898));
  }
}
