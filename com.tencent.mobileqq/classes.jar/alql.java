...
public class alql
  extends alpd
{
  private alqq jdField_a_of_type_Alqq;
  ...
  alql(ark.Application paramApplication, long paramLong)
  {
    super(paramApplication, paramLong);
    QLog.i("ArkApp.downloadyyb.module", 1, "init");
    bdgv.a();
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList();
    this.jdField_a_of_type_Bdko = new alqn(this);
  }
  ...
  private int a(String paramString)
  {
    ...
    //   34: ldc 80
    //   36: aload 14
    //   38: getstatic 86	bdkm:I	Ljava/lang/String;
    //   41: invokevirtual 90	org/json/JSONObject:optString	(Ljava/lang/String;)Ljava/lang/String;
    //   44: invokestatic 95	bdjc:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   82: aload 14
    //   84: getstatic 116	bdkm:j	Ljava/lang/String;
    ...
    //   262: astore 12
    //   264: aload 14
    //   266: getstatic 187	bdkm:K	Ljava/lang/String;
    //   269: ldc 181
    ...
    //   287: astore_1
    //   288: aload 14
    //   290: getstatic 194	bdkm:r	Ljava/lang/String;
    //   293: invokevirtual 136	org/json/JSONObject:optInt	(Ljava/lang/String;)I
    //   296: invokestatic 160	alql:a	(I)Z
    //   299: istore 5
    //   301: aload 14
    //   303: ldc 196
    ...
    //   416: astore 21
    //   418: aload_0
    //   419: getfield 209	alql:jdField_a_of_type_Bdfq	Lbdfq;
    ...
    //   432: aload 25
    //   434: iload_3
    //   435: invokespecial 214	bdfq:<init>	(Ljava/lang/String;Ljava/lang/String;I)V
    //   438: putfield 209	alql:jdField_a_of_type_Bdfq	Lbdfq;
    //   441: invokestatic 29	bdgv:a	()Lbdgv;
    //   444: aload 23
    //   446: invokevirtual 218	bdgv:b	(Ljava/lang/String;)Lcom/tencent/open/downloadnew/DownloadInfo;
    //   449: astore 11
    //   451: aload 11
    ...
    //   548: aload 11
    //   550: aload 14
    //   552: getstatic 252	bdkm:jdField_e_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   561: aload 11
    //   563: aload 14
    //   565: getstatic 257	bdkm:G	Ljava/lang/String;
    ...
    //   648: astore_1
    //   649: aload_1
    //   650: invokestatic 294	bdho:d	(Landroid/content/Context;)Z
    //   653: istore 6
    //   655: aload_1
    //   656: invokestatic 297	bdho:c	(Landroid/content/Context;)Z
    //   659: istore 7
    //   661: aload 11
    //   663: ifnull +149 -> 812
    //   666: aload 11
    ...
    //   710: aload 11
    //   712: invokevirtual 303	alql:a	(Landroid/app/Activity;Lcom/tencent/open/downloadnew/DownloadInfo;)V
    //   715: goto +102 -> 817
    ...
    //   725: goto -437 -> 288
    //   728: aload_0
    //   729: getfield 209	alql:jdField_a_of_type_Bdfq	Lbdfq;
    //   732: aload 27
    //   734: aload 25
    //   736: iload_3
    //   737: invokevirtual 306	bdfq:a	(Ljava/lang/String;Ljava/lang/String;I)Z
    //   740: ifeq -299 -> 441
    //   743: ldc 16
    //   745: iconst_1
    //   746: ldc_w 308
    ...
    //   795: aload 11
    //   797: iload_3
    //   798: invokespecial 318	alql:a	(Lcom/tencent/open/downloadnew/DownloadInfo;I)V
    //   801: goto +16 -> 817
    //   804: astore 14
    //   806: goto -232 -> 574
    //   809: goto -326 -> 483
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramInt < i)
        {
          ...
          localObject1 = bdgv.a().b(((DownloadInfo)localObject1).jdField_d_of_type_JavaLangString);
      ...
      if (localArrayList.size() > 0)
      {
        ...
        while (paramInt < localArrayList.size())
        {
          ...
          boolean bool = bbfd.a(paramJSONArray, ((DownloadInfo)localObject2).jdField_e_of_type_JavaLangString);
  ...
  private void a(DownloadInfo paramDownloadInfo, int paramInt)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      break label159;
      bdgv.a().b(paramDownloadInfo);
      return;
      bdgv.a().b(paramDownloadInfo);
      return;
      bdgv.a().a(paramDownloadInfo.jdField_d_of_type_JavaLangString);
      return;
      bdgv.a().a(paramDownloadInfo.jdField_d_of_type_JavaLangString, true);
      return;
      ...
      bdjc.a("305", paramDownloadInfo.jdField_h_of_type_JavaLangString, paramDownloadInfo.jdField_c_of_type_JavaLangString, paramDownloadInfo.o);
  ...
  public void Destruct()
  {
    ...
    this.jdField_a_of_type_Alqq = null;
  ...
  {
    if (!aloz.a(this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentArkArk$Application, "permission.YYB_DOWNLOAD"))
    {
    ...
    do
    {
      ...
      {
        if (this.jdField_a_of_type_Alqq == null)
        {
    ...
    if ((paramArrayOfVariantWrapper != null) && (paramArrayOfVariantWrapper.length >= 1))
    {
      ...
      this.jdField_a_of_type_Alqq = new alqm(this);
