...
public class alql
  implements Runnable
{
  public alql(MyAppApi.YYBDownloadListener paramYYBDownloadListener, DownloadInfo paramDownloadInfo) {}
  ...
  public void run()
  {
    ...
    new Handler(Looper.getMainLooper()).postAtTime(new alqm(this), 1000L);
  }
}
