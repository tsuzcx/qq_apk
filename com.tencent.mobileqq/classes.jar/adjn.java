...
{
  public adjn(GroupVideoLoadingFragment paramGroupVideoLoadingFragment) {}
  ...
  public void a(int paramInt, Bundle paramBundle)
  {
    ...
    GroupVideoLoadingFragment.a(this.a).a("立即更新(" + GVideoLoadingUI.a(l) + ")", new adjq(this.a, null));
    return;
    ...
    GroupVideoLoadingFragment.a(this.a).a("重新下载", new adjq(this.a, null));
    return;
    GroupVideoLoadingFragment.a(this.a).b();
    GroupVideoLoadingFragment.a(this.a).a("加载失败", "");
    GroupVideoLoadingFragment.a(this.a).a("重新加载", new adjq(this.a, null));
    return;
    ...
    GroupVideoLoadingFragment.a(this.a).postDelayed(new adjo(this), 1500L);
  }
}
