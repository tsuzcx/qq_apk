...
public class bgsk
{
  ...
  private bgsm jdField_a_of_type_Bgsm;
  private boolean jdField_a_of_type_Boolean = true;
  private int b;
  
  public bgsk(View paramView, int paramInt, bgsm parambgsm)
  {
    this.jdField_a_of_type_Int = paramInt;
    this.jdField_a_of_type_AndroidViewView = paramView;
    this.jdField_a_of_type_Bgsm = parambgsm;
    b();
  }
  ...
  public static int a(int paramInt)
  {
    int i;
    if (paramInt == 0) {
      i = afur.a(210.0F, BaseApplicationImpl.getContext().getResources());
    }
    do
    {
      return i;
  ...
  private static int b()
  {
    ...
    if (bkqv.a(localBaseApplication)) {
      i = bkqv.a(localBaseApplication);
    }
  ...
  private void b()
  {
    this.jdField_a_of_type_AndroidViewViewTreeObserver$OnGlobalLayoutListener = new bgsl(this);
  }
  ...
  public int a()
  {
    ...
    if (localSharedPreferences.contains("key_height"))
    {
      ...
      this.jdField_a_of_type_Bgsm.a(i, true);
    }
    for (;;)
    {
      if (QLog.isColorLevel()) {
