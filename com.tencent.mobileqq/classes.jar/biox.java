  ...
  extends bion
{
  ...
  public biox(@NonNull String paramString)
  {
    super(paramString);
  ...
  public int a(int paramInt)
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return ((bioz)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_a_of_type_Int;
    }
    return 0;
  }
  ...
  public int a(String paramString)
  {
    if ((!baip.a(paramString)) && (this.jdField_a_of_type_JavaUtilList != null))
    {
      ...
      {
        bioz localbioz = (bioz)localIterator.next();
        if (paramString.equals(localbioz.jdField_a_of_type_JavaLangString)) {
          return localbioz.jdField_a_of_type_Int;
        }
      }
    }
    return 0;
  ...
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return ((bioz)this.jdField_a_of_type_JavaUtilList.get(paramInt)).b;
    }
    return null;
  }
  ...
  public List<bioz> a()
  {
    ...
    {
      File[] arrayOfFile = ((File)localObject).listFiles(new bioy(this));
      if (arrayOfFile != null)
      {
    ...
    for (;;)
    {
      ...
      {
        localArrayList.add(new bioz(str, localFile1.toURI().toString(), i, (String)localObject));
        j += 1;
        break;
        if (!str.endsWith(".gif")) {
          break label293;
  ...
  public void a(List<bioz> paramList)
  {
    if (paramList == null) {
      return;
    }
  ...
  {
    if ((paramInt >= 0) && (paramInt < this.jdField_a_of_type_JavaUtilList.size())) {
      return ((bioz)this.jdField_a_of_type_JavaUtilList.get(paramInt)).jdField_c_of_type_JavaLangString;
    }
    return null;
  }
