...
public class axao
{
    ...
    for (;;)
    {
      ...
      if ((str.charAt(k) == '\024') && (k + 1 < str.length()))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "localeCode value:" + j + ",max len:" + axas.a.length);
        }
        if ((j >= 0) && (j < axas.a.length))
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.MessageHandler", 2, "---faceIndex:" + axas.a[j]);
          }
          paramString = new im_msg_body.Face();
          paramString.index.set(axas.a[j]);
        ...
        arrayOfInt = anqu.a((char[])localObject2);
      ...
      for (paramString = paramString.getSharedPreferences("Last_Login", j).getString("uin", "");; paramString = null) {
        for (;;)
        {
          try
          {
            ...
            localObject1 = ayki.jdField_c_of_type_JavaLangString;
            if (paramString == null) {
              break label1013;
            }
  ...
  public static long a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (long l1 = bbmj.a(arrayOfByte, 0);; l1 = 0L)
    {
  ...
  public static axae a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, long paramLong1, boolean paramBoolean1, boolean paramBoolean2, long paramLong2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        if (!paramMessageHandler.app.a().a((apeu)localObject))
        {
          if (QLog.isColorLevel()) {
        ...
        if (!((apeu)localObject).jdField_b_of_type_Boolean)
        {
          if (QLog.isColorLevel()) {
        ...
        paramMessageHandler.app.a().b(i, String.valueOf(paramLong1), paramMsg, l, s, paramBoolean1, 0, null, (apeu)localObject, paramLong2, paramInt);
      }
      else
      {
        if (QLog.isColorLevel()) {
  ...
  public static axau a(msg_comm.Msg paramMsg)
  {
    ...
    if (!localC2CTmpMsgHead.c2c_type.has())
    {
      ...
      localaxau.jdField_b_of_type_Int = localC2CTmpMsgHead.direction_flag.get();
      ...
      default: 
        label284:
        localaxau.jdField_a_of_type_Int = i;
        localaxau.jdField_a_of_type_Long = -1L;
        localaxau.jdField_b_of_type_Long = -1L;
        switch (k)
        {
        }
        break;
    ...
    for (;;)
    {
      if (QLog.isColorLevel())
      {
        ...
        paramMsg.append(" c2cType:").append(j).append(" serviceType:").append(k).append("direction_flag:").append(localaxau.jdField_b_of_type_Int).append(" info:").append(localaxau.toString());
      ...
      break label284;
      i = 1024;
      if ((!myy.a(BaseApplicationImpl.getContext(), String.valueOf(paramMsg.msg_head.from_uin.get()))) && (!myy.a(BaseApplicationImpl.getContext(), String.valueOf(paramMsg.msg_head.to_uin.get())))) {
        break label284;
      }
      i = 1025;
      break label284;
      ...
      i = 1044;
      break label284;
      localaxau.jdField_a_of_type_Long = localC2CTmpMsgHead.group_code.get();
      localaxau.jdField_b_of_type_Long = localC2CTmpMsgHead.group_uin.get();
      continue;
      localaxau.jdField_a_of_type_Long = localC2CTmpMsgHead.group_code.get();
      localaxau.jdField_b_of_type_Long = localC2CTmpMsgHead.group_code.get();
      continue;
      localaxau.jdField_a_of_type_Long = localC2CTmpMsgHead.group_code.get();
      localaxau.jdField_b_of_type_Long = localC2CTmpMsgHead.group_uin.get();
    }
    ...
    for (;;)
    {
      try
      {
        ...
        if (localMsgBody.uint32_anchor_status.get() == 1)
        {
          ...
          paramArrayOfByte.senderuin = String.valueOf(ajsf.l + l1);
          paramArrayOfByte.frienduin = String.valueOf(ajsf.l + l1);
          ...
          axqw.b(null, "dc00899", "grp_lbs", "", "msg_box", "view_live_message", 0, 0, "", "", "", "");
  ...
  public static MessageRecord a(List<MessageRecord> paramList, byte[] paramArrayOfByte, azmj paramazmj)
  {
    ...
    paramList = (MessageForMixedMsg)axaq.a(-1035);
    paramList.msgtype = -1035;
    paramList.msgData = localMsg.toByteArray();
    if ((paramazmj != null) && (paramazmj.jdField_a_of_type_Int == 3000)) {
      paramList.frienduin = paramazmj.jdField_a_of_type_JavaLangString;
    }
    if (i != 0) {
      bafh.a(paramazmj.jdField_a_of_type_Int, localJSONObject.toString(), paramList);
    }
    if (paramArrayOfByte != null) {
      paramList.saveExtInfoToExtStr("sens_msg_ctrl_info", bbdm.a(paramArrayOfByte));
    }
    paramList.parse();
    return paramList;
  }
  ...
  public static String a(String paramString)
  {
    ...
    if (i < paramString.length())
    {
      if ((paramString.charAt(i) == '\024') && (i + 1 < paramString.length()))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "localeCode value:" + k + ",max len:" + axas.a.length);
        }
        j = i;
        if (k >= 0)
        {
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, int paramInt1, String paramString, axav paramaxav, long paramLong, int paramInt2)
  {
    if (paramaxav == null) {
    ...
    do
    {
      ...
      {
        l = 0x0 | paramaxav.jdField_a_of_type_ArrayOfByte.length << 16 | 0xA6;
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "<PbSendMsg><S>--->createPbSendMsgReq: routingType:" + paramInt1 + ",toUin:" + paramString + ",msgUid:" + l + ",msgSeq:" + paramLong + ",uint32Seq:" + k + ",shortSeq:" + j + ",randomNum:" + paramInt2 + ",msgContext:" + paramaxav);
        }
      ...
      for (;;)
      {
        ...
        ((msg_svc.TransMsg)localObject).c2c_cmd.set(paramaxav.jdField_a_of_type_Int);
        ...
        ((msg_svc.Trans0x211)localObject).cc_cmd.set(paramaxav.jdField_a_of_type_Int);
        paramString = paramString.replace("+", "");
        ((msg_svc.Trans0x211)localObject).to_uin.set(mqx.a(paramString));
      ...
      localMsgBody.msg_content.set(ByteStringMicro.copyFrom(paramaxav.jdField_a_of_type_ArrayOfByte));
      ...
      paramaxav = paramQQAppInterface.a();
      paramQQAppInterface = paramString;
    } while (paramaxav == null);
    paramString.sync_cookie.set(ByteStringMicro.copyFrom(paramaxav));
    return paramString;
  }
  ...
  public static msg_svc.PbSendMsgReq a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, im_msg_body.RichText paramRichText, int paramInt)
  {
    ...
    do
    {
      ...
      k = axas.a(l);
      localawzw = paramQQAppInterface.a();
      localRoutingHead = new msg_svc.RoutingHead();
    ...
    if ((i != 2) && (i != 4) && (i != 21))
    {
      paramQQAppInterface = localawzw.a();
  ...
  public static im_msg_body.RichText a(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      byte[] arrayOfByte = axwh.b((byte[])localObject3);
      localObject1 = localObject2;
      if (arrayOfByte == null) {
        continue;
      }
      ...
      try
      {
        ...
        for (;;)
        {
          ...
          if ((paramChatMessage == null) || (paramChatMessage.length() == 0)) {
            localObject1 = BaseApplication.getContext().getString(2131693793);
          } else {
            localObject1 = String.format(BaseApplication.getContext().getString(2131693794), new Object[] { paramChatMessage });
          }
        }
        return null;
      }
  ...
  public static im_msg_body.RichText a(MessageForMarketFace paramMessageForMarketFace)
  {
    ...
    for (String str = ajyc.a(2131706648);; str = "[" + paramMessageForMarketFace.mMarkFaceMessage.faceName + "]")
    {
      boolean bool = true;
  ...
  public static im_msg_body.RichText a(MessageForReplyText paramMessageForReplyText)
  {
    ...
    try
    {
      String str = bbdm.a(akwb.a(paramMessageForReplyText.mSourceMsgInfo));
      localObject1 = str;
      localObject2 = str;
      ...
      if ((paramMessageForStructing.structingMsg instanceof AbsShareMsg))
      {
        ...
        if (localObject1 != null)
        {
          ...
          for (;;)
          {
            ...
            {
              localObject2 = ((axuo)localObject2).a;
              if (localObject2 != null)
              {
  ...
  public static im_msg_body.RichText a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject4))
      {
        try
        {
          localSourceMsgInfo = (MessageForReplyText.SourceMsgInfo)akwb.a(bbdm.a((String)localObject4));
  ...
  {
    ldd localldd = ldd.a();
    localldd.a(0L, paramLong1, paramLong2);
    localldd.a(paramInt, 2, paramLong2);
  }
    ...
    do
    {
      do
      {
        do
        {
          ...
          return;
          ((akgh)paramMessageHandler.app.a(18)).a(((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray());
          ...
          return;
          ((ayah)paramMessageHandler.app.getManager(17)).a(((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray());
          return;
          ...
          ((akhq)paramMessageHandler.app.a(20)).a(((msg_comm.MsgType0x210)localObject1).msg_content.get().toByteArray());
          return;
          if (QLog.isColorLevel()) {
          ...
          agxa.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramMessageHandler, paramLong, i, l1, j);
          return;
          if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        localObject2 = (anme)paramMessageHandler.app.getManager(71);
        if (localObject2 != null) {
          ((anme)localObject2).a().a((SubMsgType0x6f.MCardNotificationLike)localObject4);
        }
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
      }
    ...
    for (;;)
    {
      for (;;)
      {
        for (;;)
        {
          ...
          ((akjo)paramMessageHandler.app.a(27)).a((String)localObject4, (String)localObject2);
          break label1914;
          if ((i == 2003) && (((SubMsgType0x6f.ForwardBody)localObject2).msg_push_lost_dev_found.has()))
          {
            ...
            ((yak)paramMessageHandler.app.a(51)).a(111, (Bundle)localObject4);
            break label1914;
          }
          ...
          ((QIMNotifyAddFriend)localObject4).pushTime = awzw.a();
          if (QLog.isColorLevel()) {
            QLog.d("QIMNewNotifyPush_offLine", 2, "receive data= " + ((QIMNotifyAddFriend)localObject4).toString());
          }
          ((akdr)paramMessageHandler.app.getManager(257)).a((QIMNotifyAddFriend)localObject4);
          break label1914;
          if (QLog.isColorLevel()) {
            QLog.d("TurnBrand", 2, "decode recv msg0x210.Submsgtype0x6e");
          }
          localObject2 = (akfd)paramMessageHandler.app.getManager(22);
          if (localObject2 != null) {
            ((akfd)localObject2).a();
          }
          a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          ...
          try
          {
            ...
            if (((submsgtype0x67.MsgBody)localObject4).rpt_msg_grpinfo.has())
            {
              ...
              localObject4 = (ajzl)paramMessageHandler.app.a(3);
              if (localObject4 != null) {
                ((ajzl)localObject4).a((List)localObject2);
              }
            }
            a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
            return;
          ...
          ((akdv)paramMessageHandler.app.a(47)).a(true);
          a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          return;
          ...
          try
          {
            ...
            ((awyj)paramMessageHandler.app.getManager(94)).a(paramMsg, 1);
            return;
          }
          catch (InvalidProtocolBufferMicroException paramMessageHandler) {}
        }
        ...
        try
        {
          ...
          if (((SubMsgType0x87.MsgBody)localObject4).rpt_msg_msg_notify.has()) {
            afjm.a(paramMessageHandler.app, (SubMsgType0x87.MsgBody)localObject4);
          }
          a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          return;
        }
        ...
        try
        {
          ...
          ((aqug)paramMessageHandler.app.getManager(156)).a((SubMsgType0xaa.MsgBody)localObject4, true);
          a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
          return;
        }
        ...
        label4681:
        paramMsg = ((akqf)paramMessageHandler.a("businessbase_processor")).a(localException5.msg_content.get().toByteArray());
        if (TextUtils.isEmpty(paramMsg)) {
          break;
        }
        paramBoolean1 = ((ajxn)paramMessageHandler.app.getManager(51)).b(paramMsg);
        if (QLog.isColorLevel()) {
        ...
        ((akqf)paramMessageHandler.a("businessbase_processor")).a(localException5.msg_content.get().toByteArray(), paramMsg.msg_head.msg_time.get());
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "handleMsgType0x210SubMsgType0xee receive 0xee push message");
        }
        ((akqf)paramMessageHandler.a("businessbase_processor")).b(localException5.msg_content.get().toByteArray(), paramMsg.msg_head.msg_time.get());
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
        localObject4 = (akqf)paramMessageHandler.a("businessbase_processor");
        ...
        ((akqf)localObject4).a(localException5.msg_content.get().toByteArray(), 2, (MsgInfo)localObject5);
        ...
        ((MsgInfo)localObject5).lMsgUid = paramMsg.msg_head.msg_uid.get();
        ((MsgInfo)localObject5).shMsgType = ((short)paramMsg.msg_head.msg_type.get());
        ((akqf)localObject4).a(localException5.msg_content.get().toByteArray(), 2);
        a(paramMessageHandler, ((MsgInfo)localObject5).lFromUin, ((MsgInfo)localObject5).shMsgSeq, ((MsgInfo)localObject5).lMsgUid, ((MsgInfo)localObject5).shMsgType);
        return;
        if (QLog.isColorLevel()) {
        ...
        paramMsg = new akqn(paramLong, i, l1, j, k, false);
        ((akqf)paramMessageHandler.a("businessbase_processor")).a(localException5.msg_content.get().toByteArray(), paramMsg);
        a(paramMessageHandler, paramLong, i, l1, j);
        return;
        if (QLog.isColorLevel()) {
        ...
        if ((localObject3 == null) || (akau.a(paramMessageHandler.app, (MessageRecord)localObject3, true)) || (((MessageRecord)localObject3).msgtype != -2053)) {
          break;
        }
        ...
        localObject4 = (airz)paramMessageHandler.app.getManager(153);
        if (localObject4 != null) {
          ((airz)localObject4).a(((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray());
        }
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
        ...
        try
        {
          ...
          paramMessageHandler = (aist)paramMessageHandler.app.getManager(227);
      ...
      paramMessageHandler = (ssu)paramMessageHandler.app.getManager(253);
      ...
      try
      {
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if (paramMessageHandler.app != null) {
            ((atzk)paramMessageHandler.app.getManager(266)).b((NowPushMsgList.NowPushMsg)localObject4);
          }
          if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        akac.a(paramMessageHandler.app, (byte[])localObject3);
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
      }
      catch (Exception paramMessageHandler)
      ...
      arrj.a(paramMessageHandler.app, (byte[])localObject3, paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_time.get(), true);
      a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
      return;
      if (QLog.isColorLevel()) {
      ...
      localObject3 = ((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray();
      localObject4 = ((ayna)paramMessageHandler.app.getManager(339)).a(4);
      if (localObject4 != null) {
        ((aynl)localObject4).a(paramMessageHandler.app, (byte[])localObject3, paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_time.get(), true);
      }
      a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
      return;
      if (QLog.isColorLevel()) {
      ...
      localObject3 = anma.a(paramMessageHandler.app, ((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray(), paramMsg);
      paramMessageHandler.app.a().a((MessageRecord)localObject3, paramMessageHandler.app.getCurrentAccountUin());
      a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
      return;
      if (QLog.isColorLevel()) {
      ...
      localObject3 = anne.a(paramMessageHandler.app, ((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray(), paramMsg);
      paramMessageHandler.app.a().a((MessageRecord)localObject3, paramMessageHandler.app.getCurrentAccountUin());
      a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
      return;
      if (!QLog.isColorLevel()) {
      ...
      try
      {
        ...
        if (!ayfv.a(paramMsg.msg_head.msg_seq.get()))
        {
          ayfv.a(paramMessageHandler.app, (SubMsgType0x119.MsgBody)localObject4);
      ...
      {
        aqva.a(paramMessageHandler, (byte[])localObject3, (MsgInfo)localObject4, paramBoolean1);
        return;
      }
      if (QLog.isColorLevel()) {
      ...
      try
      {
        ...
        ((aoeo)paramMessageHandler.app.a(127)).a((submsgtype0x128.MsgBody)localObject4);
      ...
      {
        localObject3 = ((msg_comm.MsgType0x210)localObject3).msg_content.get().toByteArray();
        localObject4 = (afhx)paramMessageHandler.app.a(169);
        if (localObject4 != null) {
          ((afhx)localObject4).a((byte[])localObject3);
        }
        a(paramMessageHandler, paramMsg.msg_head.from_uin.get(), paramMsg.msg_head.msg_seq.get(), paramMsg.msg_head.msg_uid.get(), paramMsg.msg_head.msg_type.get());
        return;
      }
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (!paramMessageHandler.a().a(str))
        {
          ...
          if ((paramInt1 == 241) || (axas.a(str, paramInt1)))
          {
            ...
            paramMsg = (MessageForPic)axaq.a(-2000);
        ...
        for (;;)
        {
          ...
          QLog.d("Q.msg.MessageHandler", 2, localStringBuilder.toString());
          return;
          if ((paramInt1 != 242) && (!axas.b(str, paramInt1))) {
            break;
          }
          ...
          for (;;)
          {
            paramMsg = aywi.a((String)localObject1, paramLong1, 2, false, (String)localObject1, null, "ftn");
            ...
            aytl.a(paramMessageHandler.app, 1, false, 4);
            break;
            if (QLog.isColorLevel()) {
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg)
  {
    ...
    Object localObject4;
    long l2;
    if (ayah.a(paramMessageHandler.app))
    {
      i4 = 1;
      l1 = -1L;
      localObject2 = "";
      ...
      i2 = localObject7[i1];
      i1 += 1;
      i5 = bbmj.a((byte[])localObject7, i1);
      i6 = i1 + 2;
      if (i2 != 3) {
        break label514;
      }
      localObject4 = new byte[i5];
      bbmj.a((byte[])localObject4, 0, (byte[])localObject7, i6, i5);
      l2 = bbmj.a((byte[])localObject4, 0);
      if (l2 > 0L) {
        l1 = l2;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      if (i2 == 9)
      {
        localObject4 = new byte[i5];
        bbmj.a((byte[])localObject4, 0, (byte[])localObject7, i6, i5);
        n = bbis.b(bbbd.a(bbmj.a((byte[])localObject4, 0)));
        localObject4 = localObject1;
        localObject1 = localObject2;
        localObject2 = localObject4;
      }
      else if (i2 == 8)
      {
        localObject4 = new byte[i5];
        bbmj.a((byte[])localObject4, 0, (byte[])localObject7, i6, i5);
        m = (int)bbmj.a((byte[])localObject4, 0);
        localObject4 = localObject1;
        localObject1 = localObject2;
        localObject2 = localObject4;
      }
      else
      {
        ...
        bbmj.a((byte[])localObject5, 0, (byte[])localObject7, i6, i5);
    ...
    for (;;)
    {
      ...
      for (localObject4 = ((ByteStringMicro)localObject4).toStringUtf8();; localObject4 = "") {
        for (;;)
        {
          ...
          {
            i1 = 1;
            axqw.b(paramMessageHandler.app, "CliOper", "", "", "0X80060E4", "0X80060E4", i1, 0, "", "", "", "8.2.8");
            ...
            localObject8 = bbdm.a(((im_msg_body.Ptt)localObject6).bytes_file_md5.get().toByteArray());
          }
          try
          {
            ...
            for (;;)
            {
              try
              {
                ...
                if (((generalflags.ResvAttr)localObject6).bytes_pb_ptt_waveform.has())
                {
                  ...
                  ((MessageForPtt)localObject5).waveformArray = bbfm.a((ptt_waveform.PttWaveform)localObject7);
                  if (QLog.isColorLevel())
                  {
            ...
            if (localRichText.elems.has())
            {
              ...
              while (paramList.hasNext())
              {
                ...
                if ((((im_msg_body.Elem)localObject3).common_elem.has()) && (21 == ((im_msg_body.Elem)localObject3).common_elem.uint32_service_type.get()))
                {
                  ...
                  amns.a(paramMsg, (im_msg_body.Elem)localObject3, localArrayList, paramMessageHandler.app);
                }
              }
            }
            ahjm.b((String)localObject1, (MessageRecord)localObject4);
            return;
          }
        }
      }
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, long paramLong1, long paramLong2, boolean paramBoolean)
  {
    ...
    if (paramMsg.appshare_info.has())
    {
      ...
      localObject1 = bbbo.a((msg_comm.PluginInfo)localObject1);
      if (QLog.isColorLevel()) {
      ...
      if (localObject2 == null)
      {
        paramMessageHandler.a().a((aukm)localObject1);
        if (QLog.isColorLevel()) {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if ((paramMsg.msg_body.has()) && (((im_msg_body.MsgBody)paramMsg.msg_body.get()).rich_text.has()))
      {
        ...
        paramMsg = null;
        localObject2 = BaseApplication.getContext().getString(2131719419);
          ...
          for (localObject1 = localObject4;; localObject1 = null)
          {
            if (localObject1 != null)
            {
              ...
              if (localObject1 != null)
              {
                ...
                localObject2 = localObject1;
                ((PBStringField)localObject4).set((String)localObject2);
                localObject2 = aywi.a((String)localObject1, j, 1, false, (String)localObject1);
                if (QLog.isColorLevel()) {
            ...
            for (localObject1 = localObject3;; localObject1 = localObject3)
            {
              ...
              for (;;)
              {
                ...
                {
                  paramMessageHandler.a().b((aukm)localObject2);
                  paramMessageHandler.a().a((aukm)localObject1);
                  if (!QLog.isColorLevel()) {
                    break;
                  }
                ...
                else if (((im_msg_body.Elem)localObject1).custom_face.has())
                {
                  ...
                  localObject7 = bbdm.a((byte[])localObject7);
                  localObject5 = bbdm.a((byte[])localObject5);
                  localObject6 = bbdm.a((byte[])localObject6);
                  if (QLog.isColorLevel()) {
                  ...
                  {
                    ((PBStringField)localObject4).set((String)localObject2);
                    localObject2 = aywi.a((String)localObject1, 0L, 1, false, (String)localObject1);
                    paramBoolean = true;
                    break;
                    localObject2 = "";
                    break label1455;
                  ...
                  for (;;)
                  {
                    ...
                    do
                    {
                      ...
                      if ((!paramBoolean) && (bool1))
                      {
                        paramMessageHandler = (MessageForText)axaq.a(-1000);
                    ...
                    paramMessageHandler.d(String.valueOf(bbbo.b(l1)));
                    paramMsg = bbbg.a(localAppShareInfo.appshare_cookie.get().toByteArray());
                    if (QLog.isColorLevel()) {
                    ...
                    localObject1 = bbbg.a((String)localObject2, (String)localObject1, l1, paramMsg.jdField_a_of_type_JavaLangString);
                    if (QLog.isColorLevel()) {
                      QLog.d("Q.msg.MessageHandler", 2, "<--decodeC2CMsgPkg_AppShared : content:" + (String)localObject2 + ",encodeMsg:" + (String)localObject1);
                    }
                    localObject2 = axaq.a(paramMsg.jdField_b_of_type_Int);
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (paramBoolean2 = true;; paramBoolean2 = false)
    {
      ...
      paramMsg = new axal().a((List)localObject);
      if (TextUtils.isEmpty(paramMsg)) {
        break;
      }
      paramMessageHandler = paramMessageHandler + " " + paramMsg;
      paramMsg = axaq.a(-10000);
    ...
    do
    {
      ...
      do
      {
              ...
              if (QLog.isColorLevel())
              {
                ...
                if (QLog.isColorLevel())
                {
                  ...
                  try
                  {
                    ...
                    if (!paramBoolean4)
                    {
                      ((ajuo)paramMessageHandler.app.a(8)).a(paramMsg, paramList);
                      return;
                    }
                  }
                  catch (InvalidProtocolBufferMicroException paramMessageHandler) {}
        ...
        try
        {
          ...
          if (paramMsg != null)
          {
            apeh.a(String.valueOf(paramLong1), paramMsg);
            paramList = (List<MessageRecord>)localObject1;
          }
        }
      ...
      ((yak)paramMessageHandler.app.a(51)).a(paramLong1, paramLong2, paramInt, l1, i, "im_push.msg_push", (byte[])localObject2);
    } while (!QLog.isColorLevel());
    label801:
    label943:
  ...
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, axau paramaxau, awzu paramawzu)
  {
    ...
    do
    {
      ...
      if ((paramawzu.d) || (paramaxau.jdField_a_of_type_Int != 1006)) {
        break label260;
      }
    ...
    return;
    label222:
    bbcl.a(paramMessageHandler.app, ((msg_comm.C2CTmpMsgHead)localObject1).from_phone.get(), paramawzu.e + "");
    label260:
    if ((!paramawzu.d) && (((msg_comm.C2CTmpMsgHead)localObject1).sig.has()))
    {
      localObject3 = ((msg_comm.C2CTmpMsgHead)localObject1).sig.get().toByteArray();
      localObject1 = localObject3;
      if (QLog.isDevelopLevel()) {
        QLog.d("Q.msg.MessageHandler", 4, "tempHead.sig.get()----> sig:" + bbdm.a((byte[])localObject3) + ",length:" + localObject3.length);
      }
    }
    label520:
    label1269:
    ...
    for (localObject1 = localObject3;; localObject2 = null)
    {
      for (;;)
      {
        ...
        for (i = 1;; i = 0)
        {
          ...
          if (paramawzu.jdField_b_of_type_Boolean) {
            break;
          }
          ...
          bbmj.a((byte[])localObject3, 2, (byte[])localObject1, 0, localObject1.length);
          paramMessageHandler.app.a().a(String.valueOf(paramawzu.e), (byte[])localObject3);
          break label520;
          localObject3 = new byte[localObject1.length + 2];
          localObject3[0] = ((byte)i);
          localObject3[1] = ((byte)k);
          bbmj.a((byte[])localObject3, 2, (byte[])localObject1, 0, localObject1.length);
          paramMessageHandler.app.a().b(String.valueOf(paramawzu.e), (byte[])localObject3);
          break label520;
          paramMessageHandler.app.a().c(String.valueOf(paramawzu.e), (byte[])localObject1);
          break label520;
          localObject3 = new byte[localObject1.length + 2];
          localObject3[0] = ((byte)i);
          localObject3[1] = ((byte)k);
          bbmj.a((byte[])localObject3, 2, (byte[])localObject1, 0, localObject1.length);
          paramMessageHandler.app.a().e(String.valueOf(paramawzu.e), (byte[])localObject3);
          break label520;
          localObject3 = new byte[localObject1.length + 2];
          localObject3[0] = ((byte)i);
          localObject3[1] = ((byte)k);
          bbmj.a((byte[])localObject3, 2, (byte[])localObject1, 0, localObject1.length);
          paramMessageHandler.app.a().f(String.valueOf(paramawzu.e), (byte[])localObject3);
          break label520;
          paramMessageHandler.app.a().g(String.valueOf(paramawzu.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().h(String.valueOf(paramawzu.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().i(String.valueOf(paramawzu.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().j(String.valueOf(paramawzu.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().m(String.valueOf(paramawzu.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().o(String.valueOf(paramawzu.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().l(String.valueOf(paramawzu.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().k(String.valueOf(paramawzu.e), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().a(String.valueOf(paramawzu.e), String.valueOf(paramawzu.jdField_a_of_type_Long), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().b(String.valueOf(paramawzu.e), String.valueOf(paramawzu.jdField_a_of_type_Long), (byte[])localObject1);
          break label520;
          paramMessageHandler.app.a().c(String.valueOf(paramawzu.e), String.valueOf(paramawzu.jdField_a_of_type_Long), (byte[])localObject1);
          break label520;
        }
        if (paramaxau == null) {
          break;
        ...
        {
          paramawzu = ((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.get().toByteArray();
          localObject1 = new im_msg_body.TmpPtt();
          try
          {
            paramawzu = (im_msg_body.TmpPtt)((im_msg_body.TmpPtt)localObject1).mergeFrom(paramawzu);
            if ((paramawzu == null) || (!paramawzu.uint32_file_type.has()) || (paramawzu.uint32_file_type.get() != 4) || (!paramawzu.bytes_file_uuid.has())) {
              break;
            }
            localObject1 = paramawzu.bytes_file_uuid.get().toStringUtf8();
            if (QLog.isColorLevel()) {
            ...
            localPttRec.localPath.set(paramawzu.bytes_file_uuid.get().toStringUtf8());
            localPttRec.size.set(paramawzu.uint32_file_size.get());
            ...
            i = 0;
            k = i;
            if (paramawzu.uint32_user_type.has())
            {
              j = paramawzu.uint32_user_type.get();
              if (j != 1)
              {
                k = i;
                if (j != 2) {}
            ...
            localObject3 = "";
            localObject1 = localObject3;
            if (paramawzu.bytes_pb_reserve.has())
            {
            ...
            try
            {
              ((ptt_reserve.ReserveStruct)localObject1).mergeFrom(paramawzu.bytes_pb_reserve.get().toByteArray());
              j = n;
              i = m;
            ...
            localPttRec.busiType.set(paramawzu.uint32_busi_type.get());
            localPttRec.autototext_voice.set(j);
            localPttRec.sttText.set((String)localObject1);
            localObject1 = axaq.a(-2002);
            ((MessageRecord)localObject1).msgtype = -2002;
            ((MessageRecord)localObject1).msgData = localPttRec.toByteArray();
            ((MessageForPtt)localObject1).parse();
            if ((paramawzu.uint64_msg_id.has()) && (paramawzu.uint64_msg_id.get() != 0L)) {
              ((MessageRecord)localObject1).saveExtInfoToExtStr("pa_msgId", paramawzu.uint64_msg_id.get() + "");
            }
            amns.a(paramMsg, (MessageRecord)localObject1, paramMessageHandler.app);
            bdvj.a(paramaxau, paramMsg, (MessageRecord)localObject1);
            paramList.add(localObject1);
            return;
          }
          catch (InvalidProtocolBufferMicroException paramawzu)
          {
            for (;;)
            {
              paramawzu.printStackTrace();
              paramawzu = null;
            }
          }
        }
      }
      localObject1 = new azmj();
      ((azmj)localObject1).jdField_a_of_type_JavaLangString = String.valueOf(paramawzu.e);
      a(paramMessageHandler, paramList, paramMsg, true, paramawzu.jdField_b_of_type_Boolean, (azmj)localObject1, paramaxau);
      return;
    }
  }
  
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, azmj paramazmj)
  {
    a(paramMessageHandler, paramList, paramMsg, paramBoolean1, paramBoolean2, paramazmj, null);
  }
  
  public static void a(MessageHandler paramMessageHandler, List<MessageRecord> paramList, msg_comm.Msg paramMsg, boolean paramBoolean1, boolean paramBoolean2, azmj paramazmj, axau paramaxau)
  {
    ...
    Object localObject2 = axak.a(localList);
    int i = axak.a((ArrayList)localObject2);
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      if (paramList.isEmpty()) {
        localaxal.g(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazmj);
      }
      if (paramList.isEmpty()) {
        localaxal.i(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazmj);
      }
      localaxal.a(localList, paramList);
      if (axak.a((ArrayList)localObject2)) {
        localaxal.a((ArrayList)localObject2, localList, paramList, (StringBuilder)localObject1, paramMsg, paramazmj, paramaxau);
      }
      if (!QLog.isColorLevel()) {
        break;
      }
      ...
      return;
      localaxal.a(localList, paramList, (StringBuilder)localObject1, paramBoolean2);
      continue;
      localaxal.a(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      localaxal.b(localList, paramList, (StringBuilder)localObject1, paramBoolean1);
      continue;
      localaxal.a(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      localaxal.d(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazmj);
      continue;
      localaxal.b(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazmj);
      continue;
      localaxal.c(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazmj);
      continue;
      localaxal.e(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazmj);
      continue;
      localaxal.c(localList, paramList, (StringBuilder)localObject1);
      continue;
      localaxal.a(localList, paramList, (StringBuilder)localObject1);
      continue;
      localaxal.d(localList, paramList, (StringBuilder)localObject1);
      continue;
      localaxal.h(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazmj);
      continue;
      localaxal.b(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      localaxal.f(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazmj);
      continue;
      localaxal.h(localList, paramList, (StringBuilder)localObject1);
      continue;
      localaxal.i(localList, paramList, (StringBuilder)localObject1);
      continue;
      localaxal.g(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazmj);
      continue;
      localaxal.a(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazmj, paramBoolean1);
      continue;
      localaxal.a(paramMessageHandler, localList, paramList, (StringBuilder)localObject1, paramMsg, paramazmj, paramBoolean1);
      continue;
      localaxal.a(paramMessageHandler, localList, paramList, (StringBuilder)localObject1, paramMsg, paramazmj);
      continue;
      localaxal.i(localList, paramList, (StringBuilder)localObject1, paramMsg, paramazmj);
      continue;
      localaxal.a(localList, paramList, (StringBuilder)localObject1, paramMsg, paramBoolean1);
      continue;
      localaxal.b(localList, paramList, (StringBuilder)localObject1, paramMsg, paramBoolean1);
      continue;
      localaxal.e(localList, paramList, (StringBuilder)localObject1);
      continue;
      localaxal.f(localList, paramList, (StringBuilder)localObject1);
      continue;
      if (paramBoolean1)
      {
        ...
        {
          localaxal.a(localList, paramList, (StringBuilder)localObject1, paramMsg, paramMessageHandler);
          break;
        }
      }
      if (paramazmj != null) {}
      for (paramMessageHandler = paramazmj.jdField_a_of_type_JavaLangString;; paramMessageHandler = paramMsg.msg_head.to_uin.get() + "") {
        break;
      }
      localaxal.g(localList, paramList, (StringBuilder)localObject1);
      continue;
      localaxal.c(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      amon.a(localList, paramList, (StringBuilder)localObject1, paramMsg);
      continue;
      localaxal.j(localList, paramList, (StringBuilder)localObject1);
      continue;
      localaxal.b(localList, paramList, (StringBuilder)localObject1);
      continue;
      aryw.a(paramMessageHandler.app, localList, paramList, (StringBuilder)localObject1, paramMsg, paramBoolean1, paramazmj);
    }
  }
  
  public static void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, awzu paramawzu)
  {
    if ((!paramMsg.msg_body.has()) || (!((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has())) {
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        i = ldz.a(arrayOfByte2, 4);
        int j = arrayOfByte1.length - 8 - i;
        if (j >= 0)
        {
          arrayOfByte2 = new byte[j];
          System.arraycopy(arrayOfByte1, i + 8, arrayOfByte2, 0, j);
          bool = llr.a(arrayOfByte2);
          if (((!paramawzu.jdField_a_of_type_Boolean) && (!paramawzu.f)) || ((paramawzu.jdField_a_of_type_Long != paramawzu.jdField_b_of_type_Long) || ((paramawzu.jdField_a_of_type_Long == paramawzu.jdField_b_of_type_Long) && (!bool))))
          {
            if (QLog.isColorLevel()) {
              QLog.e("Q.msg.MessageHandler", 2, "<---decodeC2CMsgPkg_SharpVideo return null:,isReaded:" + paramawzu.jdField_a_of_type_Boolean + "syncOther:" + paramawzu.f + ",isSharpRequest" + bool);
            }
          }
          else
          {
            ...
            else
            {
              ...
              try
              {
                ...
                if (-1 == i)
                {
                  VideoMsgTools.a(paramMessageHandler.app, 0, 6, true, paramawzu, String.valueOf(l4), false, null, false, new Object[] { paramMsg });
                  a(l4, l2, 208);
                  if (!QLog.isColorLevel()) {
                    continue;
                  }
    ...
    {
      VideoMsgTools.a(paramMessageHandler.app, 0, 6, bool, paramawzu, String.valueOf(l2), false, null, false, new Object[] { paramMsg });
      break;
    }
    label775:
    if (bool) {
  ...
  public static void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, List<MessageRecord> paramList)
  {
    ...
    for (Object localObject5 = ((ByteStringMicro)localObject5).toStringUtf8();; localObject5 = "")
    {
      ...
      localObject2 = bbdm.a((byte[])localObject2);
      Object localObject6 = bbdm.a((byte[])localObject1);
      ...
      for (localObject1 = localPtt.bytes_group_file_key.get().toByteArray();; localMessageRecord = null) {
        try
        {
          ...
          if (localObject6 == null)
          {
            ...
            if (localPtt.bytes_pb_reserve.has())
            {
              ...
              ((RichMsg.PttRec)localObject7).voiceLength.set(bbbd.a(l1));
              ...
              new axal().a((List)localObject3, paramList);
              ahjm.b((String)localObject2, (MessageRecord)localObject1);
              if (localObject1 == null)
              {
                return;
                m = 0;
        ...
        catch (UnsupportedEncodingException localUnsupportedEncodingException)
        {
          for (;;)
          {
              ...
              for (;;)
              {
                ...
                try
                {
                  ...
                  if (paramList.uint32_holiday_flag.has())
                  {
                    ...
                    if (j == 1) {
                      localMessageRecord.saveExtInfoToExtStr(axad.jdField_c_of_type_JavaLangString, String.valueOf(j));
                    }
                    if (QLog.isColorLevel()) {
                ...
                try
                {
                  ...
                  ((MessageForPtt)localMessageRecord).waveformArray = bbfm.a((ptt_waveform.PttWaveform)localObject2);
                  if (QLog.isColorLevel())
                  {
                    ...
                    for (;;)
                    {
                      if (j < k)
                      {
                        ...
                        new axal().a((List)localObject5, paramMsg, (StringBuilder)localObject4);
                        break;
                      }
                    }
            ...
            bool = ((balw)paramMessageHandler.app.getManager(203)).a(((msg_comm.MsgHead)paramMsg.msg_head.get()).from_uin.get());
            ...
            amns.a(paramMsg, localMessageRecord, paramMessageHandler.app);
            if (QLog.isColorLevel())
            {
              QLog.d("Q.msg.MessageHandler", 2, ((StringBuilder)localObject4).toString());
              return;
  ...
  public static void a(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, boolean paramBoolean)
  {
    ...
    ((ajuo)paramMessageHandler.app.a(8)).a(paramMsg);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Submsgtype0x8a.ReqBody paramReqBody, long paramLong, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (!((ArrayList)localObject2).isEmpty())
      {
        ...
        if (localayav != null)
        {
          List localList = localayav.a(str1);
          paramReqBody = null;
          localObject1 = null;
          ...
          for (;;)
          {
            ...
            localObject2 = ajyc.a(2131706654);
            localObject3 = (SubAccountMessage)((SubAccountMessage)localObject1).deepCopyByReflect();
            ((SubAccountMessage)localObject3).msg = ((String)localObject2).concat(BaseApplicationImpl.getApplication().getString(2131694428));
            ...
            ((SubAccountMessage)localObject3).mTimeString = bbkb.a(((SubAccountMessage)localObject3).time * 1000L, true, ayao.jdField_a_of_type_JavaLangString);
            ((SubAccountMessage)localObject3).mEmoRecentMsg = new ayki(((SubAccountMessage)localObject3).msg, 0);
            if (localayav != null) {
              localayav.a((SubAccountMessage)localObject3);
            }
            ayao.a(paramQQAppInterface, str1, 6);
  ...
  public static void a(QQAppInterface paramQQAppInterface, byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      if ((TroopNotificationCache)paramArrayOfByte.a(TroopNotificationCache.class, "troopUin=? and feedsId=?", new String[] { String.valueOf(l2), str }) != null)
      {
        ...
        balq.a(paramQQAppInterface, i, l1, l2, l3, str, j, "OidbSvc.0x852_35", (short)23, false, false);
      }
    }
    paramArrayOfByte.a();
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, msg_svc.RoutingHead paramRoutingHead)
  {
    ...
    for (;;)
    {
      ...
      continue;
      paramQQAppInterface = ((awzw)localObject1).b(paramMessageRecord.frienduin);
      ...
      if (paramQQAppInterface != null)
      {
        ...
        bbmj.a(paramMessageRecord, 0, paramQQAppInterface, 2, paramQQAppInterface.length - 2);
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "wpa------>" + bbdm.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
      ...
      continue;
      paramQQAppInterface = ((awzw)localObject1).c(paramMessageRecord.frienduin);
      ...
      continue;
      Object localObject2 = ((awzw)localObject1).d(paramMessageRecord.frienduin);
      paramQQAppInterface = new msg_svc.BusinessWPATmp();
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      if (localObject2 != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "conversation------>sig:" + bbdm.a((byte[])localObject2) + ",length:" + localObject2.length);
        }
      ...
      for (;;)
      {
        ...
        break;
        paramMessageRecord = ((awzw)localObject1).e(paramMessageRecord.frienduin);
        if (paramMessageRecord != null)
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.msg.MessageHandler", 2, "conversation------>sigt:" + bbdm.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
          }
      ...
      paramMessageRecord = ((awzw)localObject1).f(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "sameState------>" + bbdm.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
      ...
      continue;
      paramQQAppInterface = ((awzw)localObject1).a(paramMessageRecord.frienduin);
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awzw)localObject1).j(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "sameState------>" + bbdm.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
      ...
      paramQQAppInterface = ((awzw)localObject1).m(paramMessageRecord.frienduin);
      if (paramQQAppInterface != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("fight_accost", 4, "发送附近人临时会消息 有keyLBSFriend------>" + bbdm.a(paramQQAppInterface) + ",length:" + paramQQAppInterface.length);
        }
      ...
      paramQQAppInterface = ((awzw)localObject1).k(paramMessageRecord.frienduin);
      if (paramQQAppInterface != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("fight_accost", 4, "发送兴趣部落临时会消息 有key------>" + bbdm.a(paramQQAppInterface) + ",length:" + paramQQAppInterface.length);
        }
      ...
      paramMessageRecord = ((awzw)localObject1).l(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "movieTicket------>" + bbdm.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awzw)localObject1).g(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "circleGroup------>" + bbdm.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awzw)localObject1).i(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isColorLevel()) {
          QLog.d("Q.msg.MessageHandler", 2, "friendValidation------>" + bbdm.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      ...
      paramQQAppInterface = ((awzw)localObject1).p(paramMessageRecord.frienduin);
      if (paramQQAppInterface != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("nearby_dating", 4, "发送附近人约会临时会话消息 有keyNearbyDating------>" + bbdm.a(paramQQAppInterface) + ",length:" + paramQQAppInterface.length);
        }
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awzw)localObject1).o(paramMessageRecord.frienduin);
      if (paramMessageRecord != null)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d("nearby_assistant", 4, "发送附近人助手临时会话消息 有NearbyAssistantKey------>" + bbdm.a(paramMessageRecord) + ",length:" + paramMessageRecord.length);
        }
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awzw)localObject1).n(paramMessageRecord.frienduin);
      if (paramMessageRecord != null) {
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awzw)localObject1).a(paramMessageRecord.frienduin, paramMessageRecord.selfuin);
      if (paramMessageRecord != null) {
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awzw)localObject1).b(paramMessageRecord.frienduin, paramMessageRecord.selfuin);
      if (paramMessageRecord != null) {
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
      ...
      paramQQAppInterface.to_uin.set(Long.valueOf(paramMessageRecord.frienduin).longValue());
      paramMessageRecord = ((awzw)localObject1).c(paramMessageRecord.frienduin, paramMessageRecord.selfuin);
      if (paramMessageRecord != null) {
        paramQQAppInterface.sig.set(ByteStringMicro.copyFrom(paramMessageRecord));
      }
      paramRoutingHead.comm_tmp.set(paramQQAppInterface);
  ...
  {
    Object localObject2 = paramQQAppInterface.a().b(ajsf.ad, 0);
        ...
        for (;;)
        {
          ...
          if (paramArrayOfByte.hasNext())
          {
            ...
            if ((localObject2 instanceof MessageForActivateFriends))
            {
              ...
              paramQQAppInterface.a().b(ajsf.ad, 0, ((MessageForActivateFriends)localObject2).uniseq);
              continue;
              return false;
            }
          }
    ...
    do
    {
      ...
      break label113;
      paramArrayOfByte = axaq.a(-5003);
      paramArrayOfByte.selfuin = paramQQAppInterface.getCurrentAccountUin();
      paramArrayOfByte.frienduin = ajsf.ad;
      paramArrayOfByte.istroop = 9002;
      paramArrayOfByte.senderuin = "";
      localObject2 = (ajxn)paramQQAppInterface.getManager(51);
      localakjw = (akjw)paramQQAppInterface.getManager(85);
      if (j != 1) {
        break label584;
      }
      ...
      ((MessageForActivateFriends)localObject2).msg = akjw.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
      ...
      break label883;
      axqw.b(paramQQAppInterface, "CliOper", "", "", (String)localObject1, (String)localObject2, localakjw.jdField_a_of_type_Int, 0, "", "", "", "");
    ...
    if (QLog.isColorLevel())
    {
      ...
      if (j == 2)
      {
        ...
        if (((List)localObject2).size() > 0)
        {
          ...
          localMessageForActivateFriends.msg = akjw.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
      ...
      else
      {
        ...
        if (((List)localObject2).size() > 0)
        {
          ...
          localMessageForActivateFriends.msgData = ((SubMsgType0x76.MsgBody)localObject1).toByteArray();
          localMessageForActivateFriends.msg = akjw.a(paramQQAppInterface.getApp(), (SubMsgType0x76.MsgBody)localObject1);
          axqw.b(paramQQAppInterface, "dc00898", "", "", "0X8007AD4", "0X8007AD4", (int)((SubMsgType0x76.OneMemorialDayInfo)localObject2).uint32_type.get(), 0, "", "", "", "");
        }
        else
        {
          if (!QLog.isColorLevel()) {
  ...
  public static im_msg_body.RichText b(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage != null) && ((paramChatMessage instanceof MessageForLimitChatConfirm)))
    {
      ...
      for (int i = 1;; i = 2)
      {
        ...
        ((im_msg_body.Text)localObject2).str.set(ByteStringMicro.copyFromUtf8(ajyc.a(2131706651)));
  ...
  public static im_msg_body.RichText b(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    localObject2 = axwh.b((byte[])localObject2);
    if ((localObject2 == null) || (localObject2.length == 0)) {
      return null;
    }
    ...
    if (((MessageForArkApp)localObject1).ark_app_message.containStructMsg != null)
    {
      ...
      if (!"1".equals(paramChatMessage.getExtInfoFromExtStr(axad.e))) {
        break label469;
      }
    }
    label469:
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        if ((localObject1 == null) || (((String)localObject1).length() == 0)) {
          ...
          localObject1 = String.format(BaseApplication.getContext().getString(2131693794), new Object[] { localObject1 });
        }
      }
    }
  }
  ...
  public static im_msg_body.RichText b(MessageForApollo paramMessageForApollo)
  {
    ...
    localApolloActMsg.uint32_peer_uin.set(bbbd.a(localApolloMessage.peer_uin));
    localApolloActMsg.uint32_sender_ts.set(bbbd.a(localApolloMessage.sender_ts));
    localApolloActMsg.uint32_peer_ts.set(bbbd.a(localApolloMessage.peer_ts));
    ...
    localObject1 = ajyc.a(2131706652);
  ...
  public static void b(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, awzu paramawzu)
  {
    if ((!paramMsg.msg_body.has()) || (!((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has())) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      for (;;)
      {
        ...
        else
        {
          ...
          int i = ldz.a((byte[])localObject1, 4);
          int j = ldz.a((byte[])localObject2, 4);
          if ((i <= 0) || (j <= 0))
          {
            if (QLog.isColorLevel()) {
          ...
          else
          {
            ...
            catch (Exception localException)
            {
              ...
              boolean bool = llr.a(paramMsg);
              if (((!paramawzu.jdField_a_of_type_Boolean) && (!paramawzu.f)) || ((paramawzu.jdField_a_of_type_Long != paramawzu.jdField_b_of_type_Long) || ((paramawzu.jdField_a_of_type_Long == paramawzu.jdField_b_of_type_Long) && (!bool))))
              {
                if (QLog.isColorLevel()) {
                  QLog.e("decodeC2CMsgPkg_QCall", 2, "<---decodeC2CMsgPkg_QCall return null:,isReaded:" + paramawzu.jdField_a_of_type_Boolean + "syncOther:" + paramawzu.f + ",isSharpRequest" + bool);
                }
              }
              else
              {
                ...
                try
                {
                  new lxv(BaseApplicationImpl.getContext()).a(new axap(paramMsg, l3 - l1, paramMessageHandler, l4, l2, l1, bool));
                  return;
                }
                catch (Exception paramMessageHandler) {}
              }
  ...
  private static void b(QQAppInterface paramQQAppInterface, submsgtype0xb1.InviteInfo paramInviteInfo, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      paramInviteInfo.putExtra("memberType", mud.a(paramQQAppInterface, paramQQAppInterface.getCurrentAccountUin(), localInviteInfo.uint64_group_code.get() + ""));
  ...
  public static im_msg_body.RichText c(ChatMessage paramChatMessage)
  {
    ...
    do
    {
      ...
      localObject2 = axwh.b((byte[])localObject1);
    ...
    try
    {
      ...
      paramChatMessage = a(axas.a(paramChatMessage.getSummery(), true, null), null);
      paramChatMessage.elems.add((MessageMicro)localObject2);
      return paramChatMessage;
    }
    catch (Exception paramChatMessage) {}
  ...
  public static im_msg_body.RichText c(ChatMessage paramChatMessage, boolean paramBoolean)
  {
    ...
    paramChatMessage = axwh.b(paramChatMessage);
    if ((paramChatMessage == null) || (paramChatMessage.length == 0)) {
      return null;
    }
  ...
  public static void c(MessageHandler paramMessageHandler, msg_comm.Msg paramMsg, awzu paramawzu)
  {
    if ((!paramMsg.msg_body.has()) || (!((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has()) || (paramawzu.jdField_a_of_type_Boolean) || (paramawzu.f)) {
      if (QLog.isColorLevel()) {
        QLog.e("Q.msg.MessageHandler", 2, "<---decodeC2CMsgPkg_Video return null:hasBody:" + paramMsg.msg_body.has() + ",hasMsgContent" + ((im_msg_body.MsgBody)paramMsg.msg_body.get()).msg_content.has() + ",isReaded:" + paramawzu.jdField_a_of_type_Boolean + "syncOther:" + paramawzu.f);
      }
    }
    long l1;
    long l2;
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          return;
          localHashMap = (HashMap)paramawzu.a(1000);
          paramawzu = (HashSet)paramawzu.a(1001);
          if (i != 1) {
            break label511;
          }
          if (lmb.c()) {
  ...
  public static im_msg_body.RichText e(ChatMessage paramChatMessage)
  {
    ...
    paramChatMessage = new im_msg_body.Elem();
    paramChatMessage.common_elem.set((MessageMicro)localObject1);
    Object localObject2 = ajyc.a(2131706650);
    localObject1 = new im_msg_body.Text();
    ((im_msg_body.Text)localObject1).str.set(ByteStringMicro.copyFromUtf8((String)localObject2));
    localObject2 = new im_msg_body.Elem();
    ((im_msg_body.Elem)localObject2).text.set((MessageMicro)localObject1);
  ...
  public static im_msg_body.RichText f(ChatMessage paramChatMessage)
  {
    ...
    Object localObject2 = ajyc.a(2131706655);
    Object localObject1 = "";
  ...
  public static im_msg_body.RichText g(ChatMessage paramChatMessage)
  {
    if ((paramChatMessage != null) && ((paramChatMessage instanceof MessageForScribble)))
    {
      ...
      localObject1 = new im_msg_body.Elem();
      localObject2 = new im_msg_body.Text();
      ((im_msg_body.Text)localObject2).str.set(ByteStringMicro.copyFromUtf8(ajyc.a(2131706647)));
      ((im_msg_body.Elem)localObject1).text.set((MessageMicro)localObject2);
      ((im_msg_body.Elem)localObject1).text.setHasFlag(true);
      localObject2 = new im_msg_body.RichText();
      ((im_msg_body.RichText)localObject2).elems.add((MessageMicro)localObject1);
