...
public class bddf
{
  ...
  public static ArrayList<awra> a;
  ...
  public static Intent a(Intent paramIntent, String paramString, QQAppInterface paramQQAppInterface, ProfileActivity.AllInOne paramAllInOne, BusinessCard paramBusinessCard)
  {
    ...
    String str = String.format("http://ti.qq.com/qcard/index.html?qq=%s&appid=%s&version=%s&_wv=1027", new Object[] { paramString, String.valueOf(paramQQAppInterface.getAppid()), "android-8.3.5" });
    paramString = str;
    if (b()) {
  ...
  public static SpannableString a(Context paramContext, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    if (!bdwo.a(paramContext, paramInt2)) {
      bdwo.a((QQAppInterface)localAppInterface, paramInt2, null, false);
    }
    Object localObject1;
    if (paramInt3 == 0)
    {
      ...
      paramContext = paramContext.getResources().getDrawable(2130845441);
      paramContext = bduc.a(localAppInterface, a(paramInt2, jdField_a_of_type_Int), "", paramContext, bduc.b, "halfstar", false, null);
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        try
        {
          localObject5 = paramContext.getResources().getDrawable(2130850143);
        ...
        localObject2 = localObject6;
        localObject4 = localObject8;
        localObject5 = paramContext.getResources().getDrawable(2130845439);
        localObject2 = localObject6;
        localObject4 = localObject8;
        localObject5 = bduc.a(localAppInterface, a(paramInt2, jdField_e_of_type_Int), "", (Drawable)localObject5, bduc.b, "crown", false, null);
        ...
        localObject2 = localObject5;
        localObject4 = localObject5;
        localObject6 = paramContext.getResources().getDrawable(2130845443);
        localObject2 = localObject5;
        localObject4 = localObject5;
        localObject6 = bduc.a(localAppInterface, a(paramInt2, jdField_d_of_type_Int), "", (Drawable)localObject6, bduc.b, "sun", false, null);
        ...
        localObject2 = localObject6;
        localObject4 = localObject6;
        localObject5 = paramContext.getResources().getDrawable(2130845440);
        localObject2 = localObject6;
        localObject4 = localObject6;
        localObject5 = bduc.a(localAppInterface, a(paramInt2, jdField_c_of_type_Int), "", (Drawable)localObject5, bduc.b, "moon", false, null);
        localObject2 = localObject5;
        localObject4 = localObject5;
        if (!"%".equalsIgnoreCase(localObject7.substring(paramInt3, paramInt3 + 1))) {
          break label934;
      ...
      if (paramInt3 < localObject7.length())
      {
        ...
        localObject2 = localObject5;
        localObject4 = localObject5;
        localObject6 = paramContext.getResources().getDrawable(2130845442);
        localObject2 = localObject5;
        localObject4 = localObject5;
        localObject5 = bduc.a(localAppInterface, a(paramInt2, jdField_b_of_type_Int), "", (Drawable)localObject6, bduc.b, "star", false, null);
      }
      label934:
  ...
  public static awra a(awra paramawra)
  {
    if (paramawra == null) {
      return null;
    }
    awra localawra = new awra();
    localawra.jdField_o_of_type_Long = paramawra.jdField_o_of_type_Long;
    localawra.jdField_a_of_type_JavaLangString = paramawra.jdField_a_of_type_JavaLangString;
    localawra.jdField_b_of_type_JavaLangString = paramawra.jdField_b_of_type_JavaLangString;
    localawra.jdField_c_of_type_JavaLangString = paramawra.jdField_c_of_type_JavaLangString;
    localawra.jdField_a_of_type_Int = paramawra.jdField_a_of_type_Int;
    localawra.jdField_b_of_type_Int = paramawra.jdField_b_of_type_Int;
    localawra.jdField_c_of_type_Int = paramawra.jdField_c_of_type_Int;
    localawra.jdField_d_of_type_JavaLangString = paramawra.jdField_d_of_type_JavaLangString;
    localawra.jdField_e_of_type_JavaLangString = paramawra.jdField_e_of_type_JavaLangString;
    localawra.jdField_f_of_type_JavaLangString = paramawra.jdField_f_of_type_JavaLangString;
    localawra.jdField_g_of_type_JavaLangString = paramawra.jdField_g_of_type_JavaLangString;
    localawra.jdField_h_of_type_JavaLangString = paramawra.jdField_h_of_type_JavaLangString;
    localawra.jdField_i_of_type_JavaLangString = paramawra.jdField_i_of_type_JavaLangString;
    localawra.jdField_j_of_type_JavaLangString = paramawra.jdField_j_of_type_JavaLangString;
    localawra.jdField_k_of_type_JavaLangString = paramawra.jdField_k_of_type_JavaLangString;
    localawra.jdField_d_of_type_Int = paramawra.jdField_d_of_type_Int;
    localawra.p = paramawra.p;
    localawra.q = paramawra.q;
    localawra.r = paramawra.r;
    localawra.s = paramawra.s;
    localawra.jdField_l_of_type_JavaLangString = paramawra.jdField_l_of_type_JavaLangString;
    localawra.n = paramawra.n;
    localawra.m = paramawra.m;
    localawra.jdField_o_of_type_JavaLangString = paramawra.jdField_o_of_type_JavaLangString;
    localawra.jdField_h_of_type_Int = paramawra.jdField_h_of_type_Int;
    localawra.t = paramawra.t;
    localawra.jdField_i_of_type_Int = paramawra.jdField_i_of_type_Int;
    localawra.jdField_j_of_type_Int = paramawra.jdField_j_of_type_Int;
    localawra.jdField_k_of_type_Int = paramawra.jdField_k_of_type_Int;
    localawra.jdField_e_of_type_Int = paramawra.jdField_e_of_type_Int;
    localawra.jdField_f_of_type_Int = paramawra.jdField_f_of_type_Int;
    localawra.jdField_g_of_type_Int = paramawra.jdField_g_of_type_Int;
    localawra.jdField_l_of_type_Int = paramawra.jdField_l_of_type_Int;
    localawra.jdField_a_of_type_Boolean = paramawra.jdField_a_of_type_Boolean;
    return localawra;
  }
  
  public static awra a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean)
  {
    int k = 0;
    if (paramLong == awra.jdField_a_of_type_Long) {
      return null;
    }
    ...
    if (i < m)
    {
      paramQQAppInterface = (awra)localArrayList.get(i);
  ...
  public static bayh a(QQAppInterface paramQQAppInterface, String paramString, Intent paramIntent)
  {
    String str = a();
    bdhj.a(paramString, str, 1080, 1080, 100);
    return a(paramQQAppInterface, str, paramIntent, true);
  }
  
  private static bayh a(QQAppInterface paramQQAppInterface, String paramString, Intent paramIntent, boolean paramBoolean)
  {
    Object localObject = new File(paramString);
    long l = ((File)localObject).length();
    bayh localbayh = new bayh();
    if (!((File)localObject).exists())
    {
      localbayh.jdField_a_of_type_Int = -10000;
      localbayh.jdField_a_of_type_JavaLangString = "file not exist";
      a("onAvatarChanged", localbayh.jdField_a_of_type_Int, localbayh.jdField_a_of_type_JavaLangString);
      return localbayh;
    }
    if (!bdin.d(paramQQAppInterface.getApp()))
    {
      localbayh.jdField_a_of_type_Int = -10001;
      localbayh.jdField_a_of_type_JavaLangString = "network error";
      a("onAvatarChanged", localbayh.jdField_a_of_type_Int, localbayh.jdField_a_of_type_JavaLangString);
      return localbayh;
    }
    if ((l <= 0L) || (l >= 1749600L))
    {
      ...
      localbayh.jdField_a_of_type_Int = -10000;
      localbayh.jdField_a_of_type_JavaLangString = "image illegal, size must be square.";
      a("onAvatarChanged", localbayh.jdField_a_of_type_Int, localbayh.jdField_a_of_type_JavaLangString);
      return localbayh;
    }
    if (paramBoolean)
    ...
    localbayh.jdField_a_of_type_Int = 0;
    localbayh.jdField_a_of_type_JavaLangString = "ok";
    a(paramString);
    paramQQAppInterface.a().a(paramQQAppInterface, paramString, paramIntent);
    return localbayh;
  }
  
  public static bdsu a(String paramString)
  {
    if ((paramString != null) && (!paramString.equals("")))
    {
      ...
      bdsu localbdsu = new bdsu();
      try
      {
        paramString = new JSONObject(paramString);
        localbdsu.jdField_b_of_type_Int = paramString.getInt("frameInterval");
        localbdsu.jdField_a_of_type_Int = paramString.getInt("frameNumber");
        localbdsu.jdField_a_of_type_Float = ((float)paramString.getDouble("positionX"));
        localbdsu.jdField_b_of_type_Float = ((float)paramString.getDouble("positionY"));
        localbdsu.c = ((float)paramString.getDouble("width"));
        localbdsu.d = ((float)paramString.getDouble("height"));
        return localbdsu;
      }
  ...
  public static FriendProfileCardBgDrawable a(Resources paramResources, String paramString1, String paramString2)
  {
    ...
    {
      localbdsu = a(bdhb.a(new File(paramString1, "config.json"), -1));
      if (localbdsu != null)
      {
        String[] arrayOfString = new String[localbdsu.jdField_a_of_type_Int];
        int i = 0;
        while (i < localbdsu.jdField_a_of_type_Int)
        {
          arrayOfString[i] = (paramString1 + "/" + (i + 1) + ".png");
          i += 1;
        }
        localbdsu.jdField_a_of_type_ArrayOfJavaLangString = arrayOfString;
      }
    }
    paramString1 = localbdsu;
    if (localbdsu == null) {
      paramString1 = new bdsu();
    }
  ...
  public static Card a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    try
    {
      ...
      localObject1 = localalto.e(paramString);
      paramQQAppInterface = localalto.b(paramString);
      if (paramQQAppInterface == null)
      {
        if (QLog.isColorLevel()) {
        ...
        for (;;)
        {
          ...
          localalto.a(paramQQAppInterface);
          label381:
          if (paramQQAppInterface != null) {
    ...
    boolean bool2;
    boolean bool1;
    if (!bdeu.a(((Friends)localObject1).alias, paramQQAppInterface.strShowName))
    {
      paramQQAppInterface.strShowName = ((Friends)localObject1).alias;
      i = 1;
  ...
  public static BusinessInfoCheckUpdate.RedTypeInfo a()
  {
    ...
    avsm localavsm = (avsm)BaseApplicationImpl.getApplication().getRuntime().getManager(160);
    RedTouchItem localRedTouchItem = localavsm.a(-4);
    if ((localavsm.a(localRedTouchItem, true)) && (localRedTouchItem.count > 0))
    {
  ...
  public static String a()
  {
    ...
    localStringBuilder.append(alpk.jdField_a_of_type_JavaLangString).append("temp").append("/").append(System.currentTimeMillis()).append("_portrait.tmp");
  ...
  public static String a(byte paramByte)
  {
    ...
    default: 
      return null;
    case 1: 
      return alud.a(2131708836);
    case 2: 
      return alud.a(2131708828);
    case 3: 
      return alud.a(2131708854);
    case 4: 
      return alud.a(2131708826);
    case 5: 
      return alud.a(2131708833);
    case 6: 
      return alud.a(2131708832);
    case 7: 
      return alud.a(2131708846);
    case 8: 
      return alud.a(2131708859);
    case 9: 
      return alud.a(2131708868);
    case 10: 
      return alud.a(2131708876);
    case 11: 
      return alud.a(2131708856);
    }
    return alud.a(2131708848);
  }
  ...
  {
    bdwo localbdwo = bdwo.a;
    switch (paramInt2)
    {
    default: 
      return "_";
    case 0: 
      return localbdwo.getDir(BaseApplicationImpl.getApplication(), localbdwo.getScid(paramInt1)) + "/half.png";
    case 1: 
      return localbdwo.getDir(BaseApplicationImpl.getApplication(), localbdwo.getScid(paramInt1)) + "/star.png";
    case 2: 
      return localbdwo.getDir(BaseApplicationImpl.getApplication(), localbdwo.getScid(paramInt1)) + "/moon.png";
    case 3: 
      return localbdwo.getDir(BaseApplicationImpl.getApplication(), localbdwo.getScid(paramInt1)) + "/sun.png";
    case 4: 
      return localbdwo.getDir(BaseApplicationImpl.getApplication(), localbdwo.getScid(paramInt1)) + "/crown.png";
    }
    return localbdwo.getDir(BaseApplicationImpl.getApplication(), localbdwo.getScid(paramInt1)) + "/more.png";
  }
  
  public static String a(Context paramContext)
  {
    paramContext = paramContext.getDir(".profilecard", 0);
    return paramContext.getAbsolutePath() + File.separator + "qvip_profile_label_config.json" + "8.3.5";
  }
  ...
  public static String a(Context paramContext, int paramInt1, int paramInt2, int paramInt3, String paramString1, String paramString2, String paramString3)
  {
    ...
    if (paramInt1 == 0)
    {
      localStringBuilder.append(paramContext.getString(2131694192));
    ...
    for (;;)
    {
      if (paramInt2 != 0)
      {
        ...
        localStringBuilder.append(paramContext.getString(2131720518));
        localStringBuilder.append("  ");
      }
      paramContext = bdda.c(paramInt3);
      ...
      {
        paramContext = str;
        if (!alud.a(2131708867).equals(paramString1)) {
      ...
      if (paramInt1 == 1)
      {
        localStringBuilder.append(paramContext.getString(2131692471));
        localStringBuilder.append("  ");
      }
    }
  }
  ...
  public static String a(Context paramContext, int paramInt1, int paramInt2, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      {
        paramContext = str;
        if (!alud.a(2131708840).equals(paramString1)) {
          paramContext = "" + paramString1;
        }
      }
      paramString1 = paramContext;
  ...
  public static String a(Context paramContext, awqt paramawqt)
  {
    ...
    if (localCard != null)
    {
      ...
      if (i > 0)
      {
        localObject = paramawqt;
        if (!b()) {
          localObject = i + paramContext.getString(2131720518);
        }
      }
      paramawqt = "";
      if (localCard == null) {
      ...
      paramContext = paramawqt;
      if (!TextUtils.isEmpty(localCard.strCountry))
      {
        paramContext = paramawqt;
        if (!alud.a(2131708838).equals(localCard.strCountry)) {
          paramContext = "" + localCard.strCountry;
        }
      }
      paramawqt = paramContext;
      if (!TextUtils.isEmpty(localCard.strProvince))
      {
        ...
        paramawqt = paramawqt + localCard.strProvince;
      }
      paramContext = paramawqt;
    ...
    label554:
    for (paramawqt = "" + " " + (String)localObject;; paramawqt = "")
    {
      localObject = paramawqt;
      if (paramContext != null)
      {
        ...
        if (paramContext.length() > 0) {
          localObject = paramawqt + " " + paramContext;
        }
      }
      return localObject;
      ...
      {
        paramContext = paramawqt;
        if (!alud.a(2131708851).equals(localContactCard.strCountry)) {
      ...
      if (!TextUtils.isEmpty(localContactCard.strProvince))
      {
        ...
        paramawqt = paramawqt + localContactCard.strProvince;
      }
      paramContext = paramawqt;
  ...
  public static String a(awqt paramawqt, QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    if ((paramawqt == null) || (paramawqt.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne == null) || (TextUtils.isEmpty(paramawqt.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString)) || (paramQQAppInterface == null) || (paramActivity == null)) {
      paramQQAppInterface = null;
    }
    do
    {
      return paramQQAppInterface;
      String str2 = paramawqt.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_JavaLangString;
      String str1 = paramawqt.jdField_a_of_type_JavaLangString;
      paramawqt = (bfyh)paramQQAppInterface.getManager(165);
      if (paramawqt.a(str2)) {
        return String.format("https://datacard.qidian.qq.com/static/1_%s_more.htm?appid=%s&version=%s&_wv=1027", new Object[] { str2, String.valueOf(paramQQAppInterface.getAppid()), "android-8.3.5" });
      }
      if (paramawqt.f(str2)) {
        return paramActivity.getIntent().getStringExtra("key_qidian_detail_url");
      }
      paramQQAppInterface = String.format("http://ti.qq.com/qcard/index.html?qq=%s&appid=%s&version=%s&_wv=1027", new Object[] { str2, String.valueOf(paramQQAppInterface.getAppid()), "android-8.3.5" });
      paramawqt = paramQQAppInterface;
      if (!TextUtils.isEmpty(str1)) {
        paramawqt = paramQQAppInterface + "&troopUin=" + str1;
      }
      paramQQAppInterface = paramawqt;
    } while (!b());
    return paramawqt + "&intl=1";
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder(alof.cn);
  ...
  public static String a(QQAppInterface paramQQAppInterface, long paramLong)
  {
    ...
    if ((paramLong != awra.jdField_a_of_type_Long) && (paramLong > 0L)) {
  ...
  public static String a(String paramString)
  {
    ...
    localStringBuilder.append(alpk.jdField_a_of_type_JavaLangString).append("HDAvatar").append("/").append(paramString).append(".jpg");
    return bdzf.a(localStringBuilder.toString());
  }
  ...
  /* Error */
  public static ArrayList<awra> a(QQAppInterface paramQQAppInterface, boolean paramBoolean)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 6
    ...
    //   23: astore_0
    //   24: aload_0
    //   25: invokestatic 1231	bddf:b	(Landroid/content/Context;)Ljava/lang/String;
    //   28: astore 8
    ...
    //   53: ldc_w 1233
    //   56: astore 8
    //   58: getstatic 32	bddf:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   61: aload 8
    //   63: invokestatic 1236	android/text/TextUtils:equals	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    //   66: ifeq +20 -> 86
    //   69: getstatic 28	bddf:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   72: invokevirtual 1238	java/util/ArrayList:isEmpty	()Z
    //   75: ifne +11 -> 86
    //   78: iload_1
    //   79: ifne +7 -> 86
    //   82: getstatic 28	bddf:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   85: areturn
    ...
    //   203: aload 8
    //   205: putstatic 32	bddf:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   208: aload 10
    //   210: putstatic 28	bddf:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   213: aload 10
    //   215: areturn
    //   216: aload_0
    ...
    //   308: new 561	awra
    //   311: dup
    //   312: invokespecial 562	awra:<init>	()V
    //   315: astore 11
    //   317: aload 11
    //   319: aload 9
    //   321: ldc_w 1295
    ...
    //   754: putfield 634	awra:jdField_l_of_type_Int	I
    //   757: iload 4
    //   759: iconst_1
    ...
    //   765: aload 11
    //   767: iload_1
    //   768: putfield 636	awra:jdField_a_of_type_Boolean	Z
    //   771: aload 10
    //   773: aload 11
    ...
    //   786: new 561	awra
    //   789: dup
    //   790: invokespecial 562	awra:<init>	()V
    //   793: astore 6
    //   795: aload 6
    //   797: ldc2_w 1370
    //   800: putfield 565	awra:jdField_o_of_type_Long	J
    //   803: aload 6
    //   805: iconst_1
    //   806: putfield 636	awra:jdField_a_of_type_Boolean	Z
    //   809: aload 10
    //   811: aload 6
    ...
    //   817: new 561	awra
    //   820: dup
    //   821: invokespecial 562	awra:<init>	()V
    //   824: astore 6
    //   826: aload 6
    //   828: ldc2_w 1372
    //   831: putfield 565	awra:jdField_o_of_type_Long	J
    //   834: aload 6
    //   836: iconst_1
    //   837: putfield 636	awra:jdField_a_of_type_Boolean	Z
    //   840: aload 10
    //   842: aload 6
    ...
    //   848: new 561	awra
    //   851: dup
    //   852: invokespecial 562	awra:<init>	()V
    //   855: astore 6
    //   857: aload 6
    //   859: ldc2_w 1374
    //   862: putfield 565	awra:jdField_o_of_type_Long	J
    //   865: aload 6
    //   867: iconst_1
    //   868: putfield 636	awra:jdField_a_of_type_Boolean	Z
    //   871: aload 10
    //   873: aload 6
  ...
  public static ArrayList<awra> a(QQAppInterface paramQQAppInterface, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (QLog.isColorLevel()) {
    ...
    if (!((ArrayList)localObject).isEmpty())
    {
      ...
      {
        awra localawra = (awra)((Iterator)localObject).next();
        if ((paramBoolean1) || (!localawra.jdField_a_of_type_Boolean)) {
          if (paramBoolean2) {
            localArrayList.add(localawra);
          } else if (a(paramQQAppInterface, localawra)) {
            localArrayList.add(localawra);
          }
        }
      }
  ...
  public static List<Pair<String, String>> a(Context paramContext, Card paramCard)
  {
    ...
    if (i == 0) {
      localArrayList.add(Pair.create(paramContext.getString(2131694192), ""));
    }
    for (;;)
    {
      ...
      if ((!TextUtils.isEmpty(paramContext)) && (!alud.a(2131708847).equals(paramContext))) {
        localStringBuilder.append(paramContext);
      }
      if (!TextUtils.isEmpty(str1))
      {
      ...
      paramContext = d(bdda.c(paramCard.constellation));
      if (TextUtils.isEmpty(paramContext)) {
        break;
      }
      ...
      return localArrayList;
      if (i == 1) {
        localArrayList.add(Pair.create(paramContext.getString(2131692471), ""));
      }
    }
  }
  ...
  public static List<SpannableString> a(QQAppInterface paramQQAppInterface, Context paramContext, Card paramCard)
  {
    ...
    if (i == 0)
    {
      localArrayList.add(new SpannableString(paramContext.getString(2131694192)));
      ...
      if (!TextUtils.isEmpty(str))
      {
        ...
        localArrayList.add(a(str, true, 2130844770, 2131298024, 2131298023, paramContext, paramQQAppInterface));
      }
    }
    for (;;)
    {
      ...
      localArrayList.add(new SpannableString(paramContext.getString(2131692471)));
      break;
      label190:
    ...
    StringBuilder localStringBuilder = new StringBuilder(50);
    if ((!TextUtils.isEmpty(paramQQAppInterface)) && (!alud.a(2131708847).equals(paramQQAppInterface))) {
      localStringBuilder.append(paramQQAppInterface);
    }
    if (!TextUtils.isEmpty(paramContext))
    {
    ...
    paramQQAppInterface = d(bdda.c(paramCard.constellation));
    if (!TextUtils.isEmpty(paramQQAppInterface)) {
      localArrayList.add(new SpannableString(paramQQAppInterface));
    }
    return localArrayList;
  ...
  public static void a(Activity paramActivity, View paramView, String paramString, boolean paramBoolean1, boolean paramBoolean2, ProfileActivity.AllInOne paramAllInOne)
  {
    Intent localIntent = new Intent(paramActivity, FriendProfileImageActivity.class);
    localIntent.putExtra("friendUin", paramString);
    localIntent.putExtra("KEY_THUMBNAL_BOUND", zjc.a(paramView));
    localIntent.putExtra("requestType", 881);
  ...
  public static void a(Activity paramActivity, BusinessCard paramBusinessCard, ProfileActivity.AllInOne paramAllInOne, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (paramAllInOne.jdField_a_of_type_Int == 0)
    {
      azqs.b(null, "CliOper", "", "", "0X8006A7F", "0X8006A7F", 0, 0, "", "", "", "");
      return;
    }
    azqs.b(null, "CliOper", "", "", "0X8006A93", "0X8006A93", 0, 0, "", "", "", "");
  }
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, String paramString3, boolean paramBoolean1, boolean paramBoolean2, String paramString4)
  {
    ...
    paramString2 = bdtg.a(paramActivity, "card", paramString2);
  ...
  public static void a(Activity paramActivity, String paramString1, String paramString2, int paramInt, String paramString3)
  {
    try
    {
      ...
      paramString1.jdField_h_of_type_JavaLangString = bdgc.a((QQAppInterface)localObject, paramString2);
      ...
      paramString2 = aoae.a((QQAppInterface)localObject, paramString2);
      if (paramString2.mobilesNum.size() >= 3)
      {
        QQToast.a(paramActivity, 0, 2131695219, 0).a();
        return;
      }
  ...
  public static void a(Context paramContext)
  {
    ...
    paramContext = (avsm)BaseApplicationImpl.getApplication().getRuntime().getManager(160);
  ...
  public static void a(Context paramContext, long paramLong, String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString)) {
      str = String.format(bdtg.a("rareCard"), new Object[] { Long.valueOf(paramLong) });
    }
  ...
  public static void a(TextView paramTextView, String paramString1, String paramString2, View.OnLongClickListener paramOnLongClickListener)
  {
    ...
    {
      localawoc.a("复制QQ号", paramString1);
      if ((paramString2 != null) && (paramString2.length() > 0) && (str.length() > paramString1.length() + 2)) {
        localawoc.a(alud.a(2131708878), paramString2);
      }
    }
    for (;;)
    {
      paramTextView.setTag(new awor(89, localawoc));
      ...
      if ((paramString2 != null) && (str.contains(paramString2))) {
        localawoc.a(alud.a(2131708844), paramString2);
      } else {
        localawoc.a(alud.a(2131708829), str);
      }
    }
  }
  
  public static void a(awqt paramawqt, QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    if ((paramawqt == null) || (paramQQAppInterface == null) || (paramActivity == null)) {}
    do
    {
      return;
      paramawqt = a(paramawqt, paramQQAppInterface, paramActivity);
      if (QLog.isColorLevel()) {
        QLog.i("Q.profilecard.FrdProfileCard", 2, String.format(Locale.getDefault(), "openDetails url: %s", new Object[] { paramawqt }));
      }
    } while (TextUtils.isEmpty(paramawqt));
    Intent localIntent = new Intent(paramActivity, QQBrowserActivity.class);
    localIntent.putExtra("url", paramawqt);
  ...
  {
    zdv.a(paramBaseActivity, paramLong, paramString1, paramString2, paramInt, "", new Bundle());
  }
  ...
  {
    zdv.a(paramBaseActivity, paramLong, paramString1, paramString2, paramInt, paramString3, paramBundle);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, View paramView, String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      bdar localbdar = ((DynamicAvatarView)paramView).a;
      if ((localbdar != null) && (localbdar.jdField_a_of_type_Boolean) && (!TextUtils.isEmpty(localbdar.jdField_c_of_type_JavaLangString)))
      {
        b(paramActivity, paramView, localbdar.jdField_c_of_type_JavaLangString);
        paramInt1 = 1;
        if (paramInt2 == 0) {
          if (paramInt1 == 0) {
            break label159;
    ...
    {
      azqs.b(paramQQAppInterface, "dc00898", "", "", "0X8007103", "0X8007103", 0, 0, paramActivity, "", "", "");
      return;
      if (paramInt2 == 1)
      {
  ...
  public static void a(String paramString1, int paramInt1, boolean paramBoolean, String paramString2, String paramString3, long paramLong1, int paramInt2, int paramInt3, long paramLong2, String paramString4, String paramString5)
  {
    ...
    for (localObject = "actIntroPttUpload";; localObject = "actIntroPttDownload")
    {
      ...
      azri.a(BaseApplication.getContext()).a(paramString1, (String)localObject, paramBoolean, paramLong1, paramLong2, localHashMap, "", false);
      return;
    }
    if (!barf.a(paramInt3, localHashMap))
    {
      ...
      {
        localHashMap.put(barf.jdField_k_of_type_JavaLangString, paramString4);
        label316:
        if (paramInt1 == 1) {
  ...
  public static void a(String paramString, QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    localbjea.jdField_b_of_type_JavaLangString = bdgc.h(paramQQAppInterface, localbjea.jdField_a_of_type_JavaLangString);
    bjdt.a(paramActivity, localbjea, paramString, paramActivity.getString(2131692303), "", -1);
  }
  ...
  public static void a(String paramString, QQAppInterface paramQQAppInterface, Activity paramActivity, boolean paramBoolean)
  {
    ...
    paramString.putExtra("url", awov.jdField_c_of_type_JavaLangString);
  ...
  public static void a(byte[] paramArrayOfByte)
  {
    try
    {
      paramArrayOfByte = bdhe.a(paramArrayOfByte);
      String str = bdhe.a(paramArrayOfByte);
  ...
  public static boolean a(awqr paramawqr)
  {
    return paramawqr.jdField_a_of_type_Int == 160;
  }
  ...
  private static boolean a(QQAppInterface paramQQAppInterface, awra paramawra)
  {
    long l = NetConnInfoCenter.getServerTime();
    if (((paramawra.jdField_j_of_type_Int > 100) && (l < paramawra.jdField_j_of_type_Int)) || ((paramawra.jdField_k_of_type_Int > 100) && (l > paramawra.jdField_k_of_type_Int)))
    {
      if (QLog.isColorLevel()) {
        QLog.w("ProfileCardUtil", 2, "filterTemplate->sytle:" + paramawra.jdField_o_of_type_Long + ",beginTime:" + paramawra.jdField_j_of_type_Int + ",endTime:" + paramawra.jdField_k_of_type_Int);
      }
      return false;
    }
    return true;
  ...
  {
    if (beat.a(paramQQAppInterface, "show_diy_template_guide_for_guest_time", 0) >= 3) {}
    long l;
    do
    {
      return false;
  ...
  public static byte[] a(String paramString)
  {
    ...
    if (!TextUtils.isEmpty(paramString)) {
      arrayOfByte = bdhe.a(paramString);
    }
    return arrayOfByte;
  }
  ...
  public static long b()
  {
    ...
    {
      if (bdeu.a()) {
        return bdeu.a(new File(alof.aW));
      }
      long l = bdeu.a(new File(Environment.getRootDirectory().getPath()));
      return l;
    }
    catch (Exception localException) {}
    return -1L;
  ...
  {
    paramContext = paramContext.getDir(".profilecard", 0);
    return paramContext.getAbsolutePath() + File.separator + "qvip_profile_template.json" + "8.3.5";
  }
  
  public static String b(Context paramContext, awqt paramawqt)
  {
    int j = -1;
    String str = "";
    Card localCard = paramawqt.jdField_a_of_type_ComTencentMobileqqDataCard;
    ...
    if ((paramawqt.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Byte == 0) || (paramawqt.jdField_a_of_type_ComTencentMobileqqActivityProfileActivity$AllInOne.jdField_a_of_type_Byte == 1))
    {
      ...
      str = paramContext.getString(2131694192);
    }
    for (;;)
    {
      return str + a(paramContext, paramawqt);
      ...
      label150:
      if (i == 1) {
        str = paramContext.getString(2131692471);
      }
    }
  }
  ...
  public static String b(String paramString)
  {
    StringBuilder localStringBuilder = new StringBuilder();
    paramString = MD5.toMD5(MD5.toMD5(MD5.toMD5(paramString)));
    localStringBuilder.append(alpk.jdField_a_of_type_JavaLangString).append("FHDAvatar").append("/").append(paramString).append(".jpg");
    return bdzf.a(localStringBuilder.toString());
  }
  ...
  public static void b(Activity paramActivity, View paramView, String paramString)
  {
    ...
    ((Intent)localObject).putExtra("KEY_THUMBNAL_BOUND", zjc.a(paramView));
  ...
  {
    beat.a(paramQQAppInterface, "show_diy_template_guide_for_guest_time", beat.a(paramQQAppInterface, "show_diy_template_guide_for_guest_time", 0) + 1);
  }
  ...
  public static void b(String paramString, QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    try
    {
      biva.b(paramString).a(paramActivity, paramQQAppInterface.getCurrentAccountUin());
      return;
    }
    catch (Exception paramString)
    {
      ...
      QQToast.a(paramActivity, paramActivity.getResources().getString(2131692988), 0).a();
    }
  }
  ...
  {
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append(alpk.jdField_a_of_type_JavaLangString).append("temp").append("/").append(System.currentTimeMillis()).append("_cardbg.tmp");
    return bdzf.a(localStringBuilder.toString());
  }
