  ...
  extends awoj
{
  ...
  public String b;
  public List<MayKnowRecommend.MayKnowRecommendLabel> b;
  public boolean b;
  public int c;
  public long c;
  public String c;
  ...
  public awng()
  {
    this.jdField_c_of_type_Int = 2131166929;
  ...
  public awng(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, long paramLong, List<String> paramList, int paramInt)
  {
    this.jdField_c_of_type_Int = 2131166929;
    this.jdField_f_of_type_Int = -1;
    this.jdField_a_of_type_ArrayOfInt = new int[3];
  ...
  private void a()
  {
    ...
    if (!TextUtils.isEmpty(this.jdField_f_of_type_JavaLangString))
    {
      ...
      for (;;)
      {
        try
        {
          ...
          bduf.a((QQAppInterface)localObject3, this.jdField_i_of_type_Int, this.jdField_b_of_type_JavaLangString);
          bduf.a((QQAppInterface)localObject3, this.jdField_b_of_type_JavaLangString, str1);
          if ((!bduf.b(this.jdField_i_of_type_Int)) && (!bduf.c(this.jdField_i_of_type_Int))) {
            break;
          }
      ...
      if (TextUtils.isEmpty((CharSequence)localObject2)) {
        localObject1 = this.jdField_a_of_type_AndroidContentContext.getString(2131696446);
      }
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      for (;;)
      {
        ...
        localObject2 = awvo.a(Long.parseLong(((JSONObject)localObject3).optString("create_time")));
  ...
  public CharSequence a()
  {
    ...
    do
    {
      try
      {
        CharSequence localCharSequence = awwa.a(this.jdField_c_of_type_JavaLangString, a(), true);
      ...
      localObject = new awvp(this.jdField_a_of_type_JavaUtilList, a());
      if (d() != 1002) {
        break;
      }
      this.jdField_c_of_type_JavaLangString = awwa.a(this.jdField_c_of_type_JavaLangString);
      localSpannableString = ((awvp)localObject).a(this.jdField_c_of_type_JavaLangString, true);
      localObject = localSpannableString;
    } while (localSpannableString != null);
    return "";
    this.jdField_c_of_type_JavaLangString = awwa.a(this.jdField_c_of_type_JavaLangString);
    SpannableString localSpannableString = ((awvp)localObject).a(this.jdField_c_of_type_JavaLangString, true);
    if (((awvp)localObject).jdField_a_of_type_Int > 0) {}
    for (;;)
    {
  ...
  public Object a(String paramString)
  {
    ...
    {
      paramString = BaseApplicationImpl.getApplication().getResources().getString(2131699608);
      ...
      for (;;)
      {
        ...
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131699610);
        continue;
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131699608);
        bool = true;
        continue;
        paramString = BaseApplicationImpl.getApplication().getResources().getString(2131699609);
      }
    }
  ...
  public void a(View paramView)
  {
    ...
    default: 
      ...
      if ((localObject2 instanceof awip))
      {
        localObject3 = (awip)localObject2;
        if (((awip)localObject3).b()) {}
        localObject1 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
        localObject1 = ((awip)localObject3).a();
        if (!(localObject1 instanceof awio)) {
          break label2491;
        }
      }
      break;
    ...
    label2485:
    label2491:
    for (Object localObject1 = (awio)localObject1;; localObject1 = null)
    {
      label204:
      Object localObject4;
      switch (((awip)localObject3).a())
      {
      default: 
        if (d() == 268435456)
        {
          awwa.a("all_result", "clk_function", new String[] { "" + this.jdField_a_of_type_JavaLangString, "" + this.jdField_b_of_type_JavaLangString, "" + (this.jdField_g_of_type_Int + 1) });
          if (((paramView.getContext() instanceof UniteSearchActivity)) && (awiw.jdField_b_of_type_JavaUtilHashMap.containsKey(this)))
          {
            localObject1 = (awix)awiw.jdField_b_of_type_JavaUtilHashMap.get(this);
            localObject3 = (QQAppInterface)BaseApplicationImpl.getApplication().getRuntime();
      ...
      do
      {
        try
        {
          for (;;)
          {
            ((JSONObject)localObject4).put("project", awsq.a());
            ((JSONObject)localObject4).put("event_src", "client");
            ((JSONObject)localObject4).put("obj_lct", ((awix)localObject1).jdField_a_of_type_Int);
            ((JSONObject)localObject4).put("get_src", "native");
            awsq.a(null, new ReportModelDC02528().module("all_result").action("clk_item").obj1(((awix)localObject1).jdField_a_of_type_Long + "").obj2(((awix)localObject1).jdField_b_of_type_JavaLangString).ver1(((awix)localObject1).jdField_a_of_type_JavaLangString).ver2(awsq.a(UniteSearchActivity.jdField_d_of_type_Int)).ver7(((JSONObject)localObject4).toString()).session_id(((QQAppInterface)localObject3).getCurrentAccountUin() + awiw.jdField_a_of_type_Long));
            ...
            return;
            awwa.a(this.jdField_a_of_type_JavaLangString, 70, 0, this.jdField_g_of_type_Int, paramView);
            if (this.jdField_l_of_type_Int == 1)
            {
              axqy.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 0, 0, "", "", "", "");
              axqy.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 2, 0, "", "", "", "");
              break;
            }
            axqy.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 0, 0, "", "", "", "");
            axqy.b(null, "dc00898", "", "", "0X800A33A", "0X800A33A", 1, 0, "", "", "", "");
            break;
            awwa.a(this.jdField_a_of_type_JavaLangString, 80, 0, this.jdField_g_of_type_Int, paramView);
            break;
            awwa.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), this.jdField_a_of_type_JavaLangString, this.jdField_n_of_type_JavaLangString, e(), e());
            awwa.a(this.jdField_a_of_type_JavaLangString, 120, 0, this.jdField_g_of_type_Int, paramView);
            if ((this.jdField_n_of_type_JavaLangString != null) && (!TextUtils.isEmpty(this.jdField_n_of_type_JavaLangString)))
            {
              awsq.a(null, 0, this.jdField_a_of_type_Int, "0X8009D31", 4, 0, this.jdField_b_of_type_JavaLangString, null);
              break;
            }
            ...
            {
              awsq.a(null, 0, this.jdField_a_of_type_Int, "0X8009D35", 0, 0, this.jdField_b_of_type_JavaLangString, null);
              break;
            }
            awsq.a(null, 0, this.jdField_a_of_type_Int, "0X8009D49", 0, 0, this.jdField_b_of_type_JavaLangString, null);
            break;
            QQAppInterface localQQAppInterface;
            JSONObject localJSONObject;
            if ((awiw.jdField_b_of_type_JavaUtilHashMap.containsKey(this)) && (d() != 268435456))
            {
              localObject4 = (awix)awiw.jdField_b_of_type_JavaUtilHashMap.get(this);
            ...
            try
            {
              ...
              localJSONObject.put("obj_lct", ((awix)localObject4).jdField_a_of_type_Int);
              localJSONObject.put("get_src", "web");
              awsq.a(null, new ReportModelDC02528().module("all_result").action("clk_item").obj1(this.jdField_a_of_type_Long + "").obj2(((awix)localObject4).jdField_b_of_type_JavaLangString).ver1(this.jdField_a_of_type_JavaLangString).ver2(awsq.a(this.jdField_a_of_type_Int)).ver7(localJSONObject.toString()).session_id(localQQAppInterface.getCurrentAccountUin() + awiw.jdField_a_of_type_Long));
              if (awwa.a(this.jdField_a_of_type_Long)) {
                if (awiw.jdField_a_of_type_JavaUtilHashMap.containsKey(this))
                {
                  localObject4 = (awix)awiw.jdField_a_of_type_JavaUtilHashMap.get(this);
                  if (((awix)localObject4).jdField_b_of_type_Boolean)
                  {
                    i1 = 2;
                    awwa.a("all_result", "clk_object", i1, 0, new String[] { this.jdField_a_of_type_JavaLangString, "" + this.jdField_a_of_type_Long, ((awix)localObject4).jdField_b_of_type_JavaLangString + "", ((awix)localObject4).jdField_a_of_type_Int + "" });
                  }
                }
                else
                {
                  if ((localObject1 == null) || (!((awio)localObject1).b())) {
                    break label204;
                  }
                  ((awio)localObject1).a(true);
                  awwa.a("all_result", "clk_first_result", new String[] { ((awip)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(3), awwa.a("dynamic_tab_search.1", ((awip)localObject3).a()) });
                }
              }
            }
            catch (JSONException localJSONException2)
            {
              ...
              if (awiw.jdField_b_of_type_Boolean) {}
              for (i1 = 2;; i1 = 1)
              {
                awwa.a("all_result", "clk_content", i1, 0, new String[] { ((awip)localObject3).a(), "" + this.jdField_a_of_type_Long, "", awwa.a("dynamic_tab_search.1", ((awip)localObject3).a()) });
                if ((localObject1 == null) || (!((awio)localObject1).b())) {
                  break;
                }
                ((awio)localObject1).a(true);
                awwa.a("all_result", "clk_first_result", new String[] { ((awip)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), awwa.a("dynamic_tab_search.1", ((awip)localObject3).a()) });
                break;
              }
            }
          }
          ...
          {
            ((awio)localObject1).a(true);
            awwa.a("all_result", "clk_tab_first_result", new String[] { ((awip)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), awwa.a("dynamic_tab_search.1", ((awip)localObject3).a()) });
          }
          awwa.a("all_result", "clk_tab_result", new String[] { ((awip)localObject3).a(), "" + this.jdField_a_of_type_Long, "", awwa.a("dynamic_tab_search.1", ((awip)localObject3).a()) });
          break label204;
          if ((localObject1 != null) && (((awio)localObject1).b()))
          {
            ((awio)localObject1).a(true);
            awwa.a("sub_result", "clk_sub_first_result", new String[] { ((awip)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), awwa.a("dynamic_tab_search.1", ((awip)localObject3).a()) });
          }
          awwa.a("sub_result", "clk_result", new String[] { ((awip)localObject3).a(), "" + this.jdField_a_of_type_Long, "" + a(2), awwa.a("dynamic_tab_search.1", ((awip)localObject3).a()) });
        }
        catch (JSONException localJSONException1)
        {
          for (;;)
          ...
          {
            paramView = bbex.a(((BaseActivity)paramView.getContext()).app, (Context)localObject2, this.jdField_e_of_type_JavaLangString);
            if (paramView != null)
            {
              paramView.c();
              return;
        ...
        {
          awwa.a(paramView.getContext(), Integer.valueOf(this.jdField_b_of_type_JavaLangString).intValue(), this.jdField_a_of_type_Int);
          return;
        }
        if (this.jdField_a_of_type_Long == 1001L)
        {
          ...
          if (bail.b((QQAppInterface)localObject1, this.jdField_b_of_type_JavaLangString))
          {
      ...
      for (i2 = 113;; i2 = 104)
      {
        ...
        banb.a(paramView.getContext(), (Bundle)localObject1, 2);
        return;
      }
    }
  }
  ...
  {
    Object localObject = new awvp(this.jdField_a_of_type_JavaUtilList, a());
    this.jdField_g_of_type_JavaLangString = awwa.a(this.jdField_g_of_type_JavaLangString);
    SpannableString localSpannableString = ((awvp)localObject).a(this.jdField_g_of_type_JavaLangString);
    localObject = localSpannableString;
    if (localSpannableString == null) {
      localObject = "";
    }
  ...
  {
    boolean bool = false;
    awvp localawvp = new awvp(this.jdField_a_of_type_JavaUtilList, a());
    this.jdField_a_of_type_JavaLangCharSequence = awwa.a(this.jdField_a_of_type_JavaLangCharSequence);
    SpannableString localSpannableString = localawvp.a(this.jdField_a_of_type_JavaLangCharSequence, false, false, false);
    if (localawvp.jdField_a_of_type_Int > 0) {
      bool = true;
    }
    this.h = bool;
    if (localSpannableString == null) {
  ...
  public CharSequence d()
  {
    ...
    {
      return localObject;
      localSpannableString = new awvp(this.jdField_a_of_type_JavaUtilList, a()).a(this.jdField_b_of_type_JavaLangCharSequence, false, this.jdField_a_of_type_Boolean);
      localObject = localSpannableString;
    } while (localSpannableString != null);
    return "";
  }
