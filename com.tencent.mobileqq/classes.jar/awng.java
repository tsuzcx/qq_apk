  ...
  extends awoh
{
  ...
  public awng(AccountSearchPb.hotwordrecord paramhotwordrecord, String paramString1, CharSequence paramCharSequence1, String paramString2, CharSequence paramCharSequence2)
  {
  ...
  public awng(AccountSearchPb.record paramrecord, String paramString, CharSequence paramCharSequence)
  {
  ...
  public void a(View paramView)
  {
    ...
    if (this.jdField_a_of_type_ComTencentPbAddcontactsAccountSearchPb$hotwordrecord != null)
    {
      ...
      noo.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8006F28", "0X8006F28", 0, 0, a(), this.jdField_a_of_type_ComTencentPbAddcontactsAccountSearchPb$hotwordrecord.hotword.get(), String.valueOf(this.jdField_a_of_type_ComTencentPbAddcontactsAccountSearchPb$hotwordrecord.hotword_type.get()), "1");
    }
    for (;;)
    {
      paramView.getContext().startActivity(localIntent);
      if (this.jdField_a_of_type_ComTencentPbAddcontactsAccountSearchPb$record != null) {
        noo.a(null, "CliOper", "", "", "0X8006536", "0X8006536", 0, 0, "", "", this.jdField_a_of_type_JavaLangString, String.valueOf(this.jdField_a_of_type_ComTencentPbAddcontactsAccountSearchPb$record.account_id.get()));
      }
      return;
