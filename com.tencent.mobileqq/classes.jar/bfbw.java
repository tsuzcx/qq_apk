...
public class bfbw
{
  private static bfbw jdField_a_of_type_Bfbw;
  bfbv jdField_a_of_type_Bfbv;
  bfbx jdField_a_of_type_Bfbx = new bfbx();
  ...
  public static String a(bfbv parambfbv)
  {
    return a() + "gme_sdk_" + parambfbv.a + "_" + parambfbv.b + ".zip";
  }
  ...
  public static boolean b(bfbv parambfbv)
  {
    String str1 = parambfbv.b;
    parambfbv = a(parambfbv);
    String str2 = b();
    ...
    QLog.d("TMG_Downloader", 4, String.format("isSoReady, file no exist,  fileName[%s]", new Object[] { parambfbv }));
    return false;
    a();
    return true;
  }
  
  boolean a(bfbv parambfbv)
  {
    ...
    return this.jdField_a_of_type_Bfbx.a(parambfbv, this.jdField_a_of_type_Bfbz);
  }
