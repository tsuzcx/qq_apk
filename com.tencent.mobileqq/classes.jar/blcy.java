...
public class blcy
{
  ...
  private List<blcz> jdField_a_of_type_JavaUtilList;
  ...
  private Pair<Integer, List<blcz>> a(String paramString, int paramInt)
  {
    Object localObject = null;
    byte[] arrayOfByte = new bldt().a(paramString, null, 1);
  ...
  /* Error */
  private Pair<Integer, List<blcz>> a(byte[] paramArrayOfByte, int paramInt)
  {
    // Byte code:
    ...
    //   42: aload_0
    //   43: aload 7
    //   45: invokespecial 155	blcy:a	(Lorg/w3c/dom/Element;)I
    //   48: istore_3
    //   49: iload_3
    //   50: ifeq +8 -> 58
    //   53: iload_3
    ...
    //   208: aload_0
    //   209: aload 8
    //   211: invokespecial 172	blcy:a	(Lorg/w3c/dom/Node;)Lblcz;
    //   214: astore 8
    //   216: aload 8
    //   218: ifnull +127 -> 345
    //   221: aload 5
  ...
  private blcz a(Node paramNode)
  {
    ...
    do
    {
      for (;;)
      {
          ...
          else
          {
            ...
            if (str != null)
            {
              ...
              if (localObject != null) {
                ...
                {
                  localblcz.jdField_a_of_type_Int = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("type"))
                {
                  localblcz.jdField_b_of_type_Int = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("flags"))
                {
                  localblcz.c = Integer.parseInt((String)localObject);
                  i = k + 1;
                }
                else if (str.equalsIgnoreCase("path"))
                {
                  localblcz.jdField_b_of_type_JavaLangString = ((String)localObject);
                  i = k + 1;
                }
                else
                {
                  ...
                  {
                    localblcz.jdField_a_of_type_JavaLangString = ((String)localObject);
                    i = k + 1;
                  }
                }
              }
        ...
        localblcz.jdField_a_of_type_AndroidOsBundle = a(paramNode);
        return localblcz;
        j += 1;
        k = i;
      }
  ...
  private String a()
  {
    return blbe.a() + File.separator + "QSec.dat";
  }
  ...
  private boolean a(String paramString, int paramInt, List<blcz> paramList)
  {
    paramList = a(paramInt, paramList);
    if (paramList == null) {
      return false;
    }
    return new bldt().a(paramString, paramList, null, 1);
  }
  
  /* Error */
  private byte[] a(int paramInt, List<blcz> paramList)
  {
    // Byte code:
    ...
    //   132: ldc 182
    //   134: aload 6
    //   136: getfield 183	blcz:jdField_a_of_type_Int	I
    ...
    //   154: ldc 185
    //   156: aload 6
    //   158: getfield 188	blcz:jdField_b_of_type_Int	I
    ...
    //   198: ldc 200
    //   200: aload 6
    //   202: getfield 202	blcz:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   217: ldc 195
    //   219: aload 6
    //   221: getfield 198	blcz:jdField_b_of_type_JavaLangString	Ljava/lang/String;
  ...
  private blcz b(int paramInt)
  {
    Iterator localIterator = this.jdField_a_of_type_JavaUtilList.iterator();
    while (localIterator.hasNext())
    {
      blcz localblcz = (blcz)localIterator.next();
      if (localblcz.jdField_a_of_type_Int == paramInt) {
        return localblcz;
      }
    }
    return null;
  ...
  {
    blcz localblcz = b(paramInt);
    if (localblcz == null) {}
    do
    {
      return;
      this.jdField_a_of_type_JavaUtilList.remove(localblcz);
    } while (!paramBoolean);
  ...
  public boolean a(blcz paramblcz, boolean paramBoolean)
  {
    if (a(paramblcz.jdField_a_of_type_Int)) {
      return false;
    }
    this.jdField_a_of_type_JavaUtilList.add(paramblcz);
    if (paramBoolean) {
      return a();
    }
    return true;
