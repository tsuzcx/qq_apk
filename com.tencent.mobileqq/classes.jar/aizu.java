  ...
  extends QIPCModule
{
  ...
  public static void a()
  {
    ...
    if (!a)
    {
      QIPCClientHelper.getInstance().register(localaizu);
      a = true;
    }
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    try
    {
      ...
      {
        ajae.a(paramBundle.getInt("gameId"));
      }
    ...
    else if ("action_set_sso_rule".equals(paramString))
    {
      ...
      ajcq localajcq = ajae.a();
      if (localajcq != null) {
        localajcq.a(paramString.gameId, paramBundle);
      }
    }
    else
    {
      ...
      if (bool)
      {
        try
        {
          ...
          if (l >= 0L)
          {
            ...
            axrl.a(BaseApplicationImpl.getApplication()).a(null, "cmgame_ipc_start_receive", true, l, 0L, paramBundle, "", false);
          }
          ajae.a(paramString);
        }
        catch (Exception paramString)
      ...
      else if ("action_check_game_data".equals(paramString))
      {
        ...
        paramString = ajae.a(paramString.gameId);
        if (paramString != null) {
