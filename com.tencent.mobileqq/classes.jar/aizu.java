...
{
  public aizu(Context paramContext)
  {
  ...
  /* Error */
  public void a(String paramString, java.util.List<aizv> paramList)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 6
    ...
    //   29: aload_0
    //   30: invokevirtual 132	aizu:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   33: astore 4
    //   35: aload 8
    //   37: astore_3
    //   38: aload 4
    ...
    //   143: astore 5
    //   145: aload_1
    //   146: invokestatic 155	aizv:a	(Landroid/database/Cursor;)Laizv;
    //   149: astore 7
    //   151: aload 7
    //   153: ifnull +21 -> 174
    //   156: aload_1
    ...
    //   0	418	2	paramList	java.util.List<aizv>
  ...
  /* Error */
  public void b(String paramString, java.util.List<aizv> paramList)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_3
    ...
    //   19: return
    //   20: aload_0
    //   21: invokevirtual 76	aizu:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   24: astore_1
    //   25: aload_2
    ...
    //   68: ldc 35
    //   70: aload 4
    //   72: getfield 193	aizv:jdField_a_of_type_Long	J
    ...
    //   96: aload 4
    //   98: getfield 216	aizv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   128: aload 4
    //   130: getfield 224	aizv:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    ...
    //   178: aload 4
    //   180: getfield 216	aizv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   217: aload 4
    //   219: getfield 216	aizv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   295: return
    //   296: aload 4
    //   298: getfield 216	aizv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   301: astore_2
    //   302: goto -195 -> 107
    //   305: aload 4
    //   307: getfield 224	aizv:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    ...
    //   0	367	2	paramList	java.util.List<aizv>
    //   1	362	3	localIterator	java.util.Iterator
    //   50	256	4	localaizv	aizv
  ...
  /* Error */
  public void c(String paramString, java.util.List<aizv> paramList)
  {
    // Byte code:
    //   0: aload_1
    //   1: ifnull +16 -> 17
    ...
    //   75: ldc 35
    //   77: aload 5
    //   79: getfield 193	aizv:jdField_a_of_type_Long	J
    ...
    //   103: aload 5
    //   105: getfield 216	aizv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   122: aload 5
    //   124: getfield 224	aizv:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    ...
    //   157: iconst_1
    //   158: aload 5
    //   160: getfield 205	aizv:b	I
    //   163: invokestatic 245	java/lang/String:valueOf	(I)Ljava/lang/String;
    //   166: aastore
    //   167: dup
    //   168: iconst_2
    //   169: aload 5
    //   171: getfield 216	aizv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   174: aastore
    ...
    //   200: aload 5
    //   202: getfield 216	aizv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   239: aload 5
    //   241: getfield 216	aizv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    ...
    //   319: return
    //   320: aload 5
    //   322: getfield 216	aizv:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   325: astore_2
    //   326: goto -212 -> 114
    //   329: aload 5
    //   331: getfield 224	aizv:jdField_a_of_type_OrgJsonJSONObject	Lorg/json/JSONObject;
    ...
    //   0	395	2	paramList	java.util.List<aizv>
    //   19	372	3	localObject1	Object
    //   24	24	4	localObject2	Object
    //   57	273	5	localaizv	aizv
