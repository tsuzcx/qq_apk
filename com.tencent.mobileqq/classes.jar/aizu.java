  ...
  extends QIPCModule
{
  ...
  private ajcl jdField_a_of_type_Ajcl = new ajcl();
  ...
  public aizu(String paramString)
  {
    super(paramString);
  }
  ...
  public static void b()
  {
    ...
    {
      QIPCServerHelper.getInstance().register(localaizu);
  ...
  public int a()
  {
    if (this.jdField_a_of_type_Ajcl != null) {
      return this.jdField_a_of_type_Ajcl.a();
    }
  ...
  {
    if (this.jdField_a_of_type_Ajcl != null) {
      return this.jdField_a_of_type_Ajcl.a(paramInt);
    }
    return null;
  }
  ...
  public void a()
  {
    ...
    if (this.jdField_a_of_type_Ajcl != null)
    {
      List localList = this.jdField_a_of_type_Ajcl.a();
      if (localList != null)
      {
        int i = 0;
        while (i < localList.size())
        {
          ajck localajck = (ajck)localList.get(i);
          if ((localajck != null) && (!ajac.a(localajck.a())) && (!ajac.a(localajck.a())))
          {
            aizs.a(localajck.a());
            QLog.i("cmgame_process.CmGameServerQIPCModule", 1, "closeAllGame gameId:" + localajck.a());
          }
          i += 1;
        }
      }
  ...
  public void a(CmGameStartChecker.StartCheckParam paramStartCheckParam, long paramLong, CmGameInitParams paramCmGameInitParams)
  {
    ...
    this.c = true;
    if ((this.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) && (ajac.a(BaseApplicationImpl.getContext())))
    {
  ...
  public void a(ArrayList<String> paramArrayList)
  {
    ...
    for (int i = paramArrayList.size();; i = 0)
    {
      ...
      QIPCServerHelper.getInstance().callClient(LocalMultiProcConfig.PROCESS_NAME, "cm_game_client_module", "action_dress_changed", (Bundle)localObject, new ajaa(this));
      return;
    }
  }
  ...
  public EIPCResult onCall(String paramString, Bundle paramBundle, int paramInt)
  {
    ...
    try
    {
      if ("action_aduio_query_voice_status".equals(paramString))
      {
        ...
        paramBundle = (airx)((QQAppInterface)localObject1).getManager(153);
        localObject1 = new Bundle();
        ((Bundle)localObject1).putBoolean("isOpen", paramBundle.a().a(paramString));
        ((Bundle)localObject1).putBoolean("display", aiyp.b);
      ...
      {
        paramString = paramBundle.getString("key_game_friUin");
        ((airx)((QQAppInterface)localObject1).getManager(153)).a().c(paramString, 318);
      }
    }
    ...
    if ("action_aduio_enter_room".equals(paramString))
    {
      ...
      paramBundle = ((airx)((QQAppInterface)localObject1).getManager(153)).a();
      if ((bool) || ((aiyp.jdField_a_of_type_Boolean) && (!paramBundle.b()))) {
    ...
    {
      paramString = paramBundle.getString("key_game_friUin");
      ((airx)((QQAppInterface)localObject1).getManager(153)).a().a(paramString, 318);
    }
    ...
    else if ("action_loadyoutu".equals(paramString))
    {
      ...
      if ((paramString != null) && ((paramString instanceof QQAppInterface)))
      {
        ...
        break label2203;
        paramString = new oee(paramString, BaseApplicationImpl.getContext());
        b = true;
        paramString.a(new aizv(this, paramInt));
        paramString.a();
        break label2201;
      }
    }
    else
    {
      ...
      if ("game_activity_lifecycle".equals(paramString))
      {
        ...
        if ((paramString != null) && ((paramString instanceof CmGameStartChecker.StartCheckParam)))
        {
          ...
          this.jdField_a_of_type_Ajcl.a(paramInt, i, j, paramString);
          break label2201;
        }
      }
    ...
    while (paramString != null)
    {
      ...
      if ("action_update_game_push".equals(paramString))
      {
        ...
        paramString = (QQAppInterface)ajac.a();
        if (paramString == null) {
          return null;
        }
        paramBundle = (CmGamePushItem)paramBundle.getSerializable("CmGamePushItem");
        if (paramBundle != null) {
          ((airx)paramString.getManager(153)).a().a(paramBundle);
        }
      }
      ...
      {
        if ((localObject1 instanceof QQAppInterface)) {
          ajki.a((QQAppInterface)localObject1);
        }
        paramString = new Bundle();
        paramString.putString("sApolloBaseScriptId", ajms.au);
      ...
      else
      {
        ...
        if ("action_init_cmshow_data".equals(paramString))
        {
          ...
          if ((localObject1 instanceof QQAppInterface))
          {
            Object localObject3 = (airx)((QQAppInterface)localObject1).getManager(153);
            localObject1 = (bbrd)((QQAppInterface)localObject1).a(71);
            localObject2 = ((airx)localObject3).b(paramString);
            ApolloBaseInfo localApolloBaseInfo = ((airx)localObject3).b(paramBundle);
            ...
            if (!((List)localObject3).isEmpty())
            {
              ...
              ((bbrd)localObject1).a(new aizw(this, (List)localObject3, paramString, paramBundle, paramInt));
              ((bbrd)localObject1).a((String[])localObject2);
            }
            else
            {
              i = airx.a(ApolloUtil.a(), paramString, true);
              j = airx.a(ApolloUtil.a(), paramBundle, true);
              paramString = new Bundle();
        ...
        else if ("action_render_view_preload_res".equals(paramString))
        {
          ...
          else
          {
            ...
            {
              localObject1 = ajfh.a(ApolloUtil.a(), paramString[i]);
              localObject2 = new ajib(3, paramString[i]);
              ((ajib)localObject2).c = ((ApolloActionData)localObject1).actionType;
              paramBundle.add(localObject2);
              i += 1;
            }
            ajhu.a(ApolloUtil.a(), "", new aizy(this, paramInt), paramBundle, false);
          }
        }
        ...
        else if ("action_render_view_change_mode".equals(paramString))
        {
          ...
          paramString = (bbrd)((QQAppInterface)localObject1).a(71);
          paramString.a(new aizz(this, paramString, paramInt));
          if (i == 2) {}
