...
class aizu
  extends Handler
{
  aizu(aizt paramaizt, Looper paramLooper)
  {
    super(paramLooper);
  }
  ...
  public void handleMessage(Message arg1)
  {
    ...
    case 1: 
      synchronized (aizt.a())
      {
        ...
        if ((ReportInfo)aizt.a(this.a).get(Long.valueOf(localReportHeader.seqno)) != null)
        {
          if (QLog.isColorLevel()) {
      ...
      if (localObject5 != null)
      {
        ...
        aizt.a(this.a).add(localObject5);
      }
      aizt.a(this.a).put(Long.valueOf(localObject1.seqno), localReportInfo);
      aizt.b(this.a).add(localObject1);
      aizt.a().notify();
      return;
    case 2: 
      for (;;)
      {
        synchronized (aizt.a())
        {
          ...
          localObject5 = (ReportInfo)aizt.a(this.a).get(Long.valueOf(l));
          if (localObject5 != null) {
            break;
          }
          if (QLog.isColorLevel())
    ...
    case 3: 
      for (;;)
      {
        synchronized (aizt.a())
        {
          ...
          localObject4 = (ReportInfo)aizt.a(this.a).get(Long.valueOf(l));
      ...
      else
      {
        ...
        aizt.a(this.a).add(???);
        aizt.b(this.a, 5);
        localObject4 = aizt.b(this.a).obtainMessage();
        if (localObject4 != null)
        {
          ((Message)localObject4).arg1 = 5;
          ((Message)localObject4).obj = new Object[] { Long.valueOf(l), ??? };
          aizt.b(this.a).sendMessageDelayed((Message)localObject4, 10000L);
        }
        return;
      }
      break;
    ...
    for (??? = ???.step;; ??? = ".")
    {
      ...
      synchronized (aizt.a())
      {
        ...
        if ((ReportInfo)aizt.a(this.a).get(Long.valueOf(((ReportHeader)???).seqno)) != null)
        {
          if (QLog.isColorLevel()) {
      ...
      localReportInfo.body.reportItems.add(localObject5);
      aizt.a(this.a).put(Long.valueOf(localObject3.seqno), localReportInfo);
      aizt.b(this.a).add(localObject3);
      aizt.a(this.a).add(localObject5);
      aizt.a(this.a, 1);
      return;
      ??? = ".";
