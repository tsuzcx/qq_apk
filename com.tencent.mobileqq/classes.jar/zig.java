  ...
  extends ziu<zih, zih>
{
  protected void a(JobContext paramJobContext, zih paramzih)
  {
    ...
    if (paramzih.jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry.thumbPath == null)
    {
    ...
    int j = paramzih.jdField_a_of_type_Int;
    ...
    for (;;)
    {
      ...
      try
      {
        Bitmap localBitmap = zoc.a(str2, null);
      ...
      catch (Throwable localThrowable)
      {
        try
        {
          ...
          {
            i = 90;
            paramJobContext = zii.a(paramJobContext, i);
            if (paramJobContext == null) {
              break label338;
            }
            if (j == 0) {
        ...
        {
          yuk.c("Q.qqstory.publish.edit.DoodleRotateSegment", "decodeFile failed", localOutOfMemoryError);
        }
        try
        {
          zoc.a(paramJobContext, str2, null);
          bool1 = true;
          bool2 = bool1;
          if (!bool1)
          {
            bool2 = bool1;
            if (str1 != null) {
              bool2 = zoc.a(paramJobContext, Bitmap.CompressFormat.PNG, 60, str1);
            }
          }
        ...
        {
          yuk.c("Q.qqstory.publish.edit.DoodleRotateSegment", "serializeBitmapToFile failed", localIOException);
        }
        localThrowable = localThrowable;
        yuk.c("Q.qqstory.publish.edit.DoodleRotateSegment", "unSerializeBitmapFromFile failed", localThrowable);
      }
      continue;
      label269:
      continue;
