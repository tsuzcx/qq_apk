  ...
  implements amad
{
  ...
  private GestureDetector.OnGestureListener jdField_a_of_type_AndroidViewGestureDetector$OnGestureListener = new amag(this);
  ...
  public amaf(amae paramamae, String paramString, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2, int paramInt3, float paramFloat3, int paramInt4)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetScroller = new Scroller(this.jdField_a_of_type_Amae.getContext());
    this.jdField_a_of_type_AndroidViewGestureDetector = new GestureDetector(this.jdField_a_of_type_Amae.getContext(), this.jdField_a_of_type_AndroidViewGestureDetector$OnGestureListener);
    this.jdField_a_of_type_Amac = new amac(this);
    ...
    for (this.jdField_a_of_type_Amaj = new VideoFramesRetriever(paramString, paramFloat1);; this.jdField_a_of_type_Amaj = new VideoFramesFetcher())
    {
      this.jdField_a_of_type_Amaj.a(paramInt4, paramInt1, this.jdField_a_of_type_Amac);
      this.jdField_a_of_type_Amaj.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      return;
    }
  }
  ...
  private void c()
  {
    if ((this.jdField_a_of_type_Amac == null) || (this.jdField_a_of_type_Amac.a())) {}
    int j;
    do
    {
      return;
  ...
  private void d()
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetScroller.computeScrollOffset())
    {
      ...
      c();
      if (this.jdField_a_of_type_Amae != null) {
    ...
    label157:
    while (this.jdField_a_of_type_Amai == null)
    {
      return;
      this.jdField_a_of_type_Amaj.a(this.jdField_a_of_type_Int, this.jdField_b_of_type_Int);
      break;
    }
    this.jdField_a_of_type_Amai.a(this.jdField_d_of_type_Float, -this.jdField_d_of_type_Float, this.f - this.jdField_d_of_type_Float);
  }
  
  public void a()
  {
    this.jdField_a_of_type_Amae.postInvalidate();
  }
  ...
  {
    this.jdField_a_of_type_Amai = paramamai;
  ...
  public void a(Canvas paramCanvas)
  {
    ...
    while (j < m)
    {
      amah localamah = this.jdField_a_of_type_Amac.a(j);
      if (localamah != null)
      {
        ...
        this.jdField_a_of_type_AndroidGraphicsCanvas.drawBitmap(localamah.jdField_a_of_type_AndroidGraphicsBitmap, this.jdField_c_of_type_AndroidGraphicsRect, this.jdField_c_of_type_AndroidGraphicsRect, this.jdField_a_of_type_AndroidGraphicsPaint);
      }
