...
public class ailo
{
  ...
  public ailo(String paramString)
  {
    this.jdField_a_of_type_Ailu = new ApolloGameInterfaceProxy(this, paramString);
  ...
  {
    if (ailn.a(this.jdField_a_of_type_JavaLangString))
    {
      paramString2 = ailn.b(paramString2);
      if (QLog.isColorLevel()) {
        QLog.d("ApolloJSContext", 1, "[notifyJSEVent] " + paramString1 + " " + paramString2);
      }
      a(String.format("if(window.__dispatchEvent){window.__dispatchEvent(%s,'%s','%s')}", new Object[] { Integer.valueOf(paramInt), paramString1, paramString2 }), new ailp(this));
      return;
    }
  ...
  {
    if ((paramCustomWebView != null) && (this.jdField_a_of_type_Ailu != null))
    {
      if (QLog.isColorLevel()) {
      ...
      {
        paramCustomWebView.addJavascriptInterface(this.jdField_a_of_type_Ailu, "__browserMsg");
        return;
      }
  ...
  {
    if ((this.jdField_a_of_type_Ailu != null) && ((this.jdField_a_of_type_Ailu instanceof ApolloGameInterfaceProxy))) {
      ((ApolloGameInterfaceProxy)this.jdField_a_of_type_Ailu).send(paramString2, paramString1);
    }
  }
  ...
  public void b()
  {
    ...
    if ((this.jdField_a_of_type_Ailu != null) && ((this.jdField_a_of_type_Ailu instanceof ApolloGameInterfaceProxy))) {
      ((ApolloGameInterfaceProxy)this.jdField_a_of_type_Ailu).h();
    }
  ...
  public void b(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Ailu != null)
    {
      ...
      for (;;)
      {
        this.jdField_a_of_type_Ailu.a(this);
        return;
        label36:
        d();
      }
