...
public class bkgu
{
  ...
  public static bkgf a;
  public static bkgs a;
  public static bkhb a;
  ...
  public static bkgg a(bgve parambgve, bkgc parambkgc)
  {
    if (jdField_a_of_type_Bkgf == null) {
      return null;
    }
    return jdField_a_of_type_Bkgf.a(parambgve, parambkgc);
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    bkgt.a(BaseApplicationImpl.getApplication().getRuntime(), 1, 1, 0L);
    a(localIntent);
    if ((bgev.a() instanceof Serializable)) {
      localIntent.putExtra("urlMap", (Serializable)bgev.a());
    }
    bkkz localbkkz = new bkkz(0);
    localbkkz.b = "comic_plugin.apk";
    localbkkz.d = "comic_plugin";
    localbkkz.jdField_a_of_type_JavaLangString = BaseApplicationImpl.getApplication().getRuntime().getAccount();
    localbkkz.e = "com.qqcomic.app.VipPreloadComicProcess";
  ...
  public static void a(Intent paramIntent)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (DeviceProfileManager.a(str, arrayOfInteger, new amqv()) >= arrayOfInteger.length)
        {
  ...
  {
    if (jdField_a_of_type_Bkgs == null) {
      jdField_a_of_type_Bkgs = new bkgs();
    }
    for (;;)
    {
      jdField_a_of_type_Bkgs.addObserver(paramObserver);
      return;
      jdField_a_of_type_Bkgs.deleteObservers();
    }
  }
  
  public static boolean a(Activity paramActivity, Intent paramIntent, String paramString, aufm paramaufm)
  {
    ...
    localbkkz.jdField_a_of_type_JavaLangClass = VipComicProxyActivity.a(paramString);
    localbkkz.jdField_a_of_type_AndroidContentIntent = paramIntent;
    localbkkz.c = 10000;
    localbkkz.jdField_a_of_type_Aufm = paramaufm;
  ...
  public static boolean a(AppRuntime paramAppRuntime)
  {
    ...
    do
    {
      do
      {
        ...
        paramAppRuntime = (bkkq)paramAppRuntime.getManager(27);
  ...
  public static boolean a(AppRuntime paramAppRuntime, boolean paramBoolean, bkgx arg2)
  {
    boolean bool = false;
  ...
  {
    if (jdField_a_of_type_Bkhb == null) {
      jdField_a_of_type_Bkhb = new bkhb();
    }
    for (;;)
    {
      jdField_a_of_type_Bkhb.addObserver(paramObserver);
      return;
      jdField_a_of_type_Bkhb.deleteObservers();
    }
  }
  
  public static void c(Observer paramObserver)
  {
    if ((jdField_a_of_type_Bkhb != null) && (paramObserver != null)) {
      jdField_a_of_type_Bkhb.deleteObserver(paramObserver);
    }
  }
}
