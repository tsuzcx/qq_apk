  ...
  implements BusinessObserver
{
  ...
  private boolean a(babc parambabc)
  {
    if ((parambabc == null) || (parambabc.b == null) || (parambabc.a == null)) {}
    while ((parambabc.a.equals("")) && (parambabc.b.equals(""))) {
      return false;
    }
    return true;
  }
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    localbabc.b = (str2 + "\n" + str1 + "\n");
    localbabc.a = str1;
    localbabc.k = paramBundle;
    localbabc.j = str8;
    localbabc.c = (NumberFormat.getNumberInstance().format(l2) + "\n同比:" + str3 + "\n环比:" + str4 + "\n");
    localbabc.d = str3;
    localbabc.e = str4;
    localbabc.f = (NumberFormat.getNumberInstance().format(l3) + "\n同比:" + str5 + "\n环比:" + str6 + "\n");
    localbabc.g = str5;
    localbabc.h = str6;
    localbabc.i = str7;
