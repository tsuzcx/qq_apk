...
public class ampj
{
  ...
  public static amrk a(int paramInt)
  {
    amrt localamrt = a();
    if (localamrt == null) {
      return null;
  ...
  public static amrk a(int paramInt1, int paramInt2)
  {
    amrt localamrt = a();
    if (localamrt == null) {
      return null;
    }
    return localamrt.a(paramInt1, paramInt2);
  }
  
  public static amrk a(long paramLong)
  {
  ...
  public static amrt a()
  {
    ...
    if ((localAppInterface instanceof CmGameAppInterface)) {
      return (amrt)((CmGameAppInterface)localAppInterface).getManager(255);
    }
    return null;
  }
  
  public static amry a(int paramInt)
  {
    amrk localamrk = a(paramInt);
    if (localamrk != null) {
      return localamrk.a();
    }
  ...
  public static amry a(long paramLong)
  {
    amrk localamrk = b(paramLong);
    if (localamrk != null) {
      return localamrk.a();
  ...
  public static ApolloSurfaceView a()
  {
    ...
    {
      return null;
      localObject = ((amrt)localObject).a();
    } while (localObject == null);
    return ((amrk)localObject).a();
  }
  ...
  public static void a(Activity paramActivity, Conversation paramConversation)
  {
    ...
    {
      return;
      localamhd = (amhd)a().getManager(153);
      if (a(null)) {
        localamhd.k = true;
      }
    } while ((localamhd == null) || (!localamhd.j) || (paramActivity == null) || (!(paramActivity instanceof SplashActivity)) || (paramActivity.isFinishing()) || (!((SplashActivity)paramActivity).isResume()) || (paramConversation == null));
    if (FrameHelperActivity.b())
    {
      FrameHelperActivity.c(true);
      FrameHelperActivity.s();
    }
    a(paramConversation.b, localamhd.a());
    localamhd.j = false;
  ...
  public static void a(View paramView, String paramString)
  {
    ...
    try
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        localTextView.setBackgroundResource(2130838594);
        localTextView.setPadding((int)(bgln.jdField_a_of_type_Float * 7.0F), (int)(bgln.jdField_a_of_type_Float * 7.0F), (int)(bgln.jdField_a_of_type_Float * 7.0F), 0);
        ...
        int i = (int)((float)bgln.k() - bgln.jdField_a_of_type_Float * 7.0F - localTextView.getMeasuredWidth());
        int j = (int)(localRect.bottom - 6.0F * bgln.jdField_a_of_type_Float);
  ...
  public static void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, int paramInt3, long paramLong, JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      ((JSONObject)localObject).put("sqVersion", "8.4.1.4680");
      ...
      paramJSONObject = new NewIntent(paramAppInterface.getApp(), amln.class);
      ...
      paramJSONObject.setObserver(new ampk());
  ...
  public static void a(CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    else
    {
      ...
      if ((paramStartCheckParam.mStartType == 2) || (paramStartCheckParam.mStartType == 1) || (paramStartCheckParam.mStartType == 3))
      {
        ...
        if (localList != null)
        {
          ...
          if (i < localList.size())
          {
            localObject3 = (amrw)localList.get(i);
            if ((localObject3 == null) || (((amrw)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam == null)) {
              break label713;
            }
            localObject1 = localamrt.a(((amrw)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
            if (localObject1 == null) {
              break label713;
            }
            localObject4 = ((amrk)localObject1).a();
            if ((((amrk)localObject1).a() != paramStartCheckParam.gameId) || ((paramStartCheckParam.roomId != 0L) && (paramStartCheckParam.roomId != ((angn)localObject4).jdField_a_of_type_Long))) {
              break label713;
            }
            if (((amrk)localObject1).a() == null) {
              break label1490;
            }
          }
        }
    ...
    label849:
    label1490:
    for (localObject1 = ((amrk)localObject1).a().getClass();; localObject1 = null)
    {
      QLog.i("cmgame_process.CmGameUtil", 1, " launchGame found old task.mStartCheckParam:" + ((amrw)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam);
      if (localObject1 == null)
      {
        if ((localList != null) && (localList.size() >= amrt.jdField_a_of_type_ArrayOfJavaLangClass.length))
        {
          localObject2 = (amrw)localList.get(0);
          if ((localObject2 != null) && (((amrw)localObject2).jdField_a_of_type_JavaLangRefWeakReference != null))
          {
            localObject3 = (Activity)((amrw)localObject2).jdField_a_of_type_JavaLangRefWeakReference.get();
            if (localObject3 != null)
            {
              ((Activity)localObject3).finish();
              if (((amrw)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
              {
                amqz.a("cs.close_room.local", "{}", false, null, ((amrw)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                QLog.i("cmgame_process.CmGameUtil", 1, " launchGame close old  task.mStartCheckParam.gameId:" + ((amrw)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
              }
            }
          }
          localamrt.jdField_a_of_type_JavaUtilList.remove(0);
        }
        localObject2 = new HashMap();
        i = 0;
        for (;;)
        {
          if (i < localamrt.jdField_a_of_type_JavaUtilList.size())
          {
            localObject3 = (amrw)localamrt.jdField_a_of_type_JavaUtilList.get(i);
            if ((localObject3 != null) && (((amrw)localObject3).jdField_a_of_type_JavaLangString != null)) {
              ((HashMap)localObject2).put(((amrw)localObject3).jdField_a_of_type_JavaLangString, ((amrw)localObject3).jdField_a_of_type_JavaLangString);
            }
            i += 1;
            continue;
            i += 1;
        ...
        i = 0;
        if (i >= amrt.jdField_a_of_type_ArrayOfJavaLangClass.length) {
          break label1483;
        }
        if (TextUtils.isEmpty((String)((HashMap)localObject2).get(amrt.jdField_a_of_type_ArrayOfJavaLangClass[i].getSimpleName())))
        {
          localObject2 = amrt.jdField_a_of_type_ArrayOfJavaLangClass[i];
      ...
      for (;;)
      {
        ...
        {
          localObject1 = amrt.jdField_a_of_type_ArrayOfJavaLangClass[0];
          QLog.e("cmgame_process.CmGameUtil", 1, "can not find activityClass, use first class");
        }
        localObject2 = new amrw();
        ((amrw)localObject2).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam = paramStartCheckParam;
        ((amrw)localObject2).jdField_a_of_type_JavaLangString = ((Class)localObject1).getSimpleName();
        localamrt.jdField_a_of_type_JavaUtilList.add(localObject2);
        for (;;)
        {
          if (QLog.isColorLevel())
          {
            localObject2 = localamrt.jdField_a_of_type_JavaUtilList.iterator();
            for (;;)
            {
              if (((Iterator)localObject2).hasNext())
              {
                localObject3 = (amrw)((Iterator)localObject2).next();
                QLog.d("cmgame_process.CmGameUtil", 2, "launchGame task:" + ((amrw)localObject3).jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                continue;
                i += 1;
                break;
                ...
                {
                  amrw localamrw = (amrw)localList.get(i);
                  boolean bool2 = false;
                  localObject3 = localObject1;
                  if (localamrw != null)
                  {
                    localObject3 = localObject1;
                    if (localamrw.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null)
                    {
                      localObject3 = localamrt.a(localamrw.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                      boolean bool1 = bool2;
                      localObject2 = localObject1;
                      if (localObject3 != null)
                      {
                        angn localangn = ((amrk)localObject3).a();
                        bool1 = bool2;
                        localObject2 = localObject1;
                        if (((amrk)localObject3).a() == paramStartCheckParam.gameId) {
                          if (paramStartCheckParam.roomId != 0L)
                          {
                            bool1 = bool2;
                            localObject2 = localObject1;
                            if (paramStartCheckParam.roomId != localangn.jdField_a_of_type_Long) {}
                          }
                          else
                          {
                            bool2 = true;
                            bool1 = bool2;
                            localObject2 = localObject1;
                            if (((amrk)localObject3).a() != null)
                            {
                              localObject2 = ((amrk)localObject3).a().getClass();
                              bool1 = bool2;
                            }
                          }
                        }
                      ...
                      if (!bool1)
                      {
                        ...
                        {
                          localObject1 = (Activity)localamrw.jdField_a_of_type_JavaLangRefWeakReference.get();
                          if (localObject1 != null)
                          {
                            ((Activity)localObject1).finish();
                            if (localamrw.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam != null) {
                              amqz.a("cs.close_room.local", "{}", false, null, localamrw.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                            }
                            QLog.i("cmgame_process.CmGameUtil", 1, " launchGame close old  task.mStartCheckParam.gameId:" + localamrw.jdField_a_of_type_ComTencentMobileqqApolloCmgameCmGameStartChecker$StartCheckParam.gameId);
                          }
                        }
                        ((List)localObject4).add(localamrw);
                        localObject3 = localObject2;
                      }
                    }
                  }
        ...
        for (;;)
        {
          ...
          localObject2 = amrt.jdField_a_of_type_ArrayOfJavaLangClass[0];
          break;
  ...
  public static void a(String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      localamst = a();
    } while (localamst == null);
    localamst.a(paramString1, paramString2, -1L, 4, false, null);
  }
  ...
  public static void a(Object... paramVarArgs)
  {
    amlz localamlz = a();
    if (localamlz != null) {
      localamlz.a("cmg_launch", 4, paramVarArgs);
    }
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, CmGameStartChecker.StartCheckParam paramStartCheckParam)
  {
    ...
    ApolloGameData localApolloGameData = ((ancd)localObject).a(paramStartCheckParam.gameId);
    amhd localamhd = (amhd)paramQQAppInterface.getManager(153);
    if (localamhd != null)
    {
      paramStartCheckParam.game = localApolloGameData;
      if ((localApolloGameData != null) && ((((ancd)localObject).a(paramStartCheckParam.gameId)) || (paramStartCheckParam.isRequestConf))) {
        break label244;
      }
    }
    label244:
    for (boolean bool = true;; bool = false)
    {
      ...
      paramStartCheckParam.isWhiteUsr = localamhd.c((String)localObject);
      paramStartCheckParam.apolloStatus = localamhd.b((String)localObject);
      paramStartCheckParam.pushItem = localamhd.a().a();
      ...
      paramStartCheckParam.gender = ((axby)paramQQAppInterface.getManager(106)).b();
      paramStartCheckParam.isEnableMSAA = c(paramStartCheckParam.gameId);
      paramStartCheckParam.mIsTransGame = anca.c.contains(Integer.valueOf(paramStartCheckParam.gameId));
      return true;
    }
  }
  ...
  public static int b()
  {
    ...
    amhd localamhd = (amhd)a().getManager(153);
    if ((localamhd != null) && (localamhd.j())) {
      return 1;
    }
    return 0;
  }
  ...
  public static int b(int paramInt)
  {
    try
    {
      ...
      ((StringBuilder)localObject).append(ancb.s).append(paramInt).append(File.separator).append("gameConfig.json");
      ...
      localObject = new JSONObject(bgmg.b((File)localObject)).optJSONArray("subpackages");
      if (localObject != null)
      {
  ...
  public static amrk b(int paramInt1, int paramInt2)
  {
    amrt localamrt = a();
    if (localamrt == null) {
      return null;
    }
    return localamrt.b(paramInt1, paramInt2);
  }
  
  public static amrk b(long paramLong)
  {
    amrt localamrt = a();
    if (localamrt == null) {
      return null;
    }
    return localamrt.a(paramLong);
  }
  ...
  public static String b(CmGameInitParams paramCmGameInitParams)
  {
    ...
    for (;;)
    {
      try
      {
        localJSONObject1 = ancm.a(0, amxb.a);
        ...
        if (("1".equals(paramCmGameInitParams.mGameName)) || ("2".equals(paramCmGameInitParams.mGameName)))
        {
          ...
          if ((!ApolloGameStateMachine.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.getAndSet(false)) || (ApolloGameStateMachine.jdField_a_of_type_Amnj == null)) {
            break label999;
          }
          localJSONObject1.put("freeMemory", ApolloGameStateMachine.jdField_a_of_type_Amnj.jdField_b_of_type_Long);
          localJSONObject1.put("totalMemory", ApolloGameStateMachine.jdField_a_of_type_Amnj.jdField_c_of_type_Long);
          localJSONObject1.put("osVersion", amnj.jdField_a_of_type_JavaLangString);
          localJSONObject1.put("model", amnj.jdField_b_of_type_JavaLangString);
          localJSONObject1.put("cpuType", amnj.jdField_c_of_type_JavaLangString);
          localJSONObject1.put("cpuNumber", amnj.jdField_a_of_type_Int);
          localJSONObject1.put("cpuFrequency", amnj.jdField_a_of_type_Long);
          localJSONObject1.put("gameVersion", paramCmGameInitParams.mVersion);
          localJSONObject1.put("QQVer", "8.4.1.4680");
      ...
      localJSONObject1.put("connType", bgnt.a(BaseApplicationImpl.getContext()));
      ...
      continue;
      label999:
      localJSONObject1.put("freeMemory", bgln.a(Process.myPid()));
      localJSONObject1.put("totalMemory", bgln.f());
      localJSONObject1.put("osVersion", bgln.e());
      localJSONObject1.put("model", bgln.i());
      localJSONObject1.put("cpuType", bgln.g());
      localJSONObject1.put("cpuNumber", bgln.b());
      localJSONObject1.put("cpuFrequency", bgln.a());
    }
  }
  ...
  public static void b()
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localObject = (amhd)a().getManager(153);
        if ((localObject != null) && (((amhd)localObject).k())) {
          ((amhd)localObject).a().b();
        }
        i = a();
      } while (-1 == i);
      localObject = ampb.a().a(i);
    } while (localObject == null);
    ((amrp)localObject).c();
  }
  ...
  public static boolean c(int paramInt)
  {
    ...
    try
    {
      ...
      int i = new JSONObject(bgmg.b((File)localObject)).optInt("enableMSAA");
  ...
  public static int e()
  {
    ...
    if (jdField_a_of_type_Float < 0.0F) {
      jdField_a_of_type_Float = (float)bgln.a() / 1.0F / 1024.0F;
    }
    if (d < 0L) {
      d = Math.ceil(bgln.d() / 1073741824.0D);
    }
    if (QLog.isColorLevel()) {
