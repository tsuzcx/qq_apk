...
public class alqy
  extends bggc
{
  public alqy(SettingMeApolloViewController paramSettingMeApolloViewController) {}
  ...
  protected void onGetExploreMsg(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean) {
      try
      {
        ...
        localObject = new altg(localQQAppInterface, (JSONObject)localObject, localQQSettingMe);
        this.a.jdField_a_of_type_Altc.a((alte)localObject);
        if ((localQQSettingMe.a()) && (SettingMeApolloViewController.a(this.a) > 0)) {
          this.a.jdField_a_of_type_Altc.a(SettingMeApolloViewController.a(this.a), localViewGroup.getContext(), localQQAppInterface, this.a.jdField_a_of_type_Int);
        }
