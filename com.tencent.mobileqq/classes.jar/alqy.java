...
public class alqy
{
  ...
  public static Map<String, List<alqz>> a;
  ...
  private alrj jdField_a_of_type_Alrj;
  ...
  public alqy(ArkAppCenter paramArkAppCenter)
  {
    this.jdField_a_of_type_ComTencentMobileqqArkArkAppCenter = paramArkAppCenter;
    Object localObject = amqr.b(159).a();
    if ((localObject != null) && (((amqp)localObject).a() != null))
    {
      localObject = ((amqp)localObject).a();
      jdField_a_of_type_Boolean = ((amrj)localObject).jdField_a_of_type_Boolean;
      f = ((amrj)localObject).jdField_b_of_type_Boolean;
    }
    this.jdField_a_of_type_Alrj = new alrj(paramArkAppCenter.b());
    this.jdField_a_of_type_Alrm = new alrm(paramArkAppCenter.b());
    d();
    a();
    paramArkAppCenter = amqr.b(186).a();
  ...
  {
    return bbaj.a(BaseApplication.getContext(), paramString + a());
  }
  
  public static void a(String paramString1, String paramString2)
  {
    bbaj.a(BaseApplication.getContext(), paramString1 + a(), paramString2);
  }
  ...
  public static void a(boolean paramBoolean)
  {
    ...
    {
      bbaj.a(BaseApplication.getContext(), "ark_use_android_http_" + a(), str);
      return;
    }
  }
  ...
  public static boolean a()
  {
    try
    {
      boolean bool = "open".equals(bbaj.a(BaseApplication.getContext(), "ark_use_android_http_" + a()));
      return bool;
    }
  ...
  public static void b(boolean paramBoolean)
  {
    ...
    for (String str = "open";; str = "close") {
      try
      {
        bbaj.a(BaseApplication.getContext(), "ark_support_android9_emoji", str);
        return;
      }
      catch (Exception localException)
      {
  ...
  public static boolean b()
  {
    try
    {
      boolean bool = "open".equals(bbaj.a(BaseApplication.getContext(), "ark_support_android9_emoji"));
      return bool;
    }
    catch (Exception localException)
    {
  ...
  private void d()
  {
    alrj.a(this.jdField_a_of_type_ComTencentMobileqqArkArkAppCenter.b());
  }
  
  public void a()
  {
    this.jdField_a_of_type_Alrm.a();
  }
  
  public void a(amro paramamro)
  {
    if (paramamro == null)
    {
    ...
    e = paramamro.jdField_a_of_type_Boolean;
    d = this.jdField_a_of_type_Alrm.a(paramamro.jdField_b_of_type_JavaLangString);
    g = paramamro.jdField_b_of_type_Boolean;
    a(g);
    ...
    for (;;)
    {
      ...
      jdField_a_of_type_JavaLangString = paramamro.jdField_a_of_type_JavaLangString;
      boolean bool;
      if (ArkAppCenter.jdField_b_of_type_Boolean)
      {
  ...
  public void b()
  {
    alrj localalrj = this.jdField_a_of_type_Alrj;
    alrj.b(this.jdField_a_of_type_ComTencentMobileqqArkArkAppCenter.a());
  }
  
  public void c()
  {
    this.jdField_a_of_type_Alrj.b();
  }
}
