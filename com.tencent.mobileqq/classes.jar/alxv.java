...
public class alxv
  extends ajfb
{
  public alxv(QQAppInterface paramQQAppInterface)
  {
      ...
      try
      {
        ...
        if (n == 0)
        {
          ...
          if (localRspBody.uint32_result.has())
          {
            ...
            alyc.a(this.app, str, alxu.e, k, m, paramToServiceMsg);
            label169:
          ...
          while (QLog.isColorLevel())
          {
            ...
            break label141;
            label280:
            alyc.a(this.app, str, k, m, paramToServiceMsg);
            break label169;
            label297:
  ...
  private void b(QQAppInterface paramQQAppInterface, alxu paramalxu)
  {
    int i = 0;
    long l1 = awao.a();
    ...
    alxu.a(paramQQAppInterface, "redpoint_box_show", l1);
    alyc.a(paramQQAppInterface, false, true);
    paramQQAppInterface.a().a().d(ajed.aL, 1032);
    akeu localakeu = paramQQAppInterface.a().a();
    RecentUser localRecentUser = localakeu.b(ajed.aL, 1032);
    if (localRecentUser == null)
    {
      paramQQAppInterface = new RecentUser(ajed.aL, 1032);
  ...
  private void c(QQAppInterface paramQQAppInterface, alxu paramalxu)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ConfessHandler", 2, "onNeedShowLebaRedPoint");
    }
    alxu.a(paramQQAppInterface, "redpoint_leba_show", awao.a());
  }
  ...
  public void a(alyk paramalyk)
  {
    if (this.app == null) {
      return;
    }
    if (this.app.a().a().b(ajed.aL, 1032) != null)
    {
    ...
    notifyUI(2, true, paramalyk);
  }
  
  public void a(QQAppInterface paramQQAppInterface, alxu paramalxu)
  {
    if (QLog.isColorLevel()) {
      QLog.i("ConfessHandler", 2, String.format("onGetNewConfig boxEntry:%d contactEntry:%d", new Object[] { Integer.valueOf(paramalxu.h), Integer.valueOf(paramalxu.i) }));
    }
    if (paramalxu.h == 2) {
      b(paramQQAppInterface, paramalxu);
    }
    if (paramalxu.i == 2) {
      c(paramQQAppInterface, paramalxu);
    }
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, ConfessInfo paramConfessInfo, int paramInt3)
  {
    ...
    if (paramInt3 == -1)
    {
      ...
      awqx.b(this.app, "dc00898", "", "", (String)localObject, (String)localObject, 0, 0, "", "", "", "");
  ...
  public void b(alyk paramalyk)
  {
    ...
    if ((paramalyk != null) && (paramalyk.a()))
    {
      localakeu = this.app.a().a();
      localRecentUser2 = localakeu.b(ajed.aL, 1032);
      i = 0;
      if (localRecentUser2 != null) {
        break label123;
      }
      localRecentUser1 = new RecentUser();
      localRecentUser1.uin = ajed.aL;
      localRecentUser1.setType(1032);
      localRecentUser1.lastmsgtime = paramalyk.a;
      i = 1;
    }
    for (;;)
    {
      if (i != 0)
      {
        ...
        paramalyk = this.mApp.getHandler(Conversation.class);
        if (paramalyk != null) {
          paramalyk.sendEmptyMessage(1009);
        }
      }
      ...
      if (localRecentUser2.lastmsgtime < paramalyk.a)
      {
        localRecentUser2.lastmsgtime = paramalyk.a;
        i = 1;
        localRecentUser1 = localRecentUser2;
      }
    }
