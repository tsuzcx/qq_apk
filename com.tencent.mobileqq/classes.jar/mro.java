  ...
  extends WebViewPlugin
{
  ...
  public mro()
  {
    this.jdField_a_of_type_Ajfe = new mrp(this);
  ...
  private void a(int paramInt, long paramLong, String paramString1, String paramString2)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_Bafb == null) {
        this.jdField_a_of_type_Bafb = Utils.createPluginSetDialogForWeb(this.mRuntime.a(), this.jdField_a_of_type_Wis, this.jdField_a_of_type_Ajfe, paramInt, paramLong, paramString1, paramString2);
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (l != -1L)
        {
          ...
          this.jdField_a_of_type_Wis.a(18, paramString2, this.jdField_a_of_type_Ajfe);
        }
      }
      ...
      if (paramString3.equals("getPluginStatus")) {
        try
        {
          ...
          this.jdField_a_of_type_Wis.a(18, paramString1, this.jdField_a_of_type_Ajfe);
        }
        catch (JSONException paramJsBridgeListener)
        {
          paramJsBridgeListener.printStackTrace();
        ...
        try
        {
          ...
          if (!TextUtils.isEmpty(paramJsBridgeListener))
          {
            ...
            avwf.a("hot_list", "clk_hot_list", new String[] { paramJsBridgeListener });
          }
        }
        catch (JSONException paramJsBridgeListener)
        {
