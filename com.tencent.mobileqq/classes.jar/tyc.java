  ...
  extends bdvl
{
  ...
  public tyc(BaseApplicationImpl paramBaseApplicationImpl)
  {
    this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl = paramBaseApplicationImpl;
    this.jdField_a_of_type_Boolean = puu.a.h();
  }
  ...
  public static URL a(String paramString, int paramInt, Object paramObject, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramObject = bkgj.a(paramString);
      ...
      return paramString;
      paramString = bkgj.a(paramString, "busiType", paramInt + "");
      continue;
    ...
    for (;;)
    {
      try
      {
        ...
        if (i < k)
        {
          ...
          if (bdvy.a(((IpData)localObject3).mIp))
          {
            j = 1;
  ...
  {
    return axlo.a(paramInputStream, (int)paramLong);
  }
  ...
  public File a(OutputStream paramOutputStream, DownloadParams paramDownloadParams, URLDrawableHandler paramURLDrawableHandler)
  {
    ...
    for (;;)
    {
      Object localObject1 = bkgj.a(str);
      ...
      for (;;)
      {
        try
        {
          ...
          localtye = new tye(this, this.jdField_a_of_type_ComTencentCommonAppBaseApplicationImpl, i);
          localtye.a(paramDownloadParams, (Map)localObject1);
          localObject1 = null;
      ...
      {
        tyd localtyd = new tyd(this, paramOutputStream);
        ...
        for (;;)
        {
          try
          {
            ...
            localObject1 = localObject3;
            localObject4 = localObject3;
            localObject3 = super.a(localtyd, paramDownloadParams, localtye.a(paramURLDrawableHandler));
            ...
            localtye.a(j, paramDownloadParams);
            localObject1 = localObject3;
          }
          ...
          finally
          {
            ...
            continue;
            localObject4 = localObject2;
            localtye.a(-1, localIOException.getMessage());
            continue;
            localObject4 = localObject2;
            try
            {
            ...
            catch (Exception localException)
            {
              ...
              if ((i == -1) || (i == 0))
              {
                if ((tye.a(localtye) != 0) && (paramDownloadParams.retryCount != tdw.g)) {
                  break label799;
                }
                localtye.a(j, paramDownloadParams);
                continue;
  ...
  {
    if ((paramURLDrawableHandler instanceof tyf))
    {
      tye localtye = ((tyf)paramURLDrawableHandler).a();
      if (localtye != null)
      {
        localtye.a(parambdwt, parambdwt.a);
        ((tyf)paramURLDrawableHandler).a("image/" + tye.a(localtye));
      }
    }
  }
