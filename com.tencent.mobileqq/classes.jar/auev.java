...
public class auev
  extends ajtb
{
  public auev(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    {
      augv.b("OlympicHandler", new Object[] { "handleDeliverTorch, req or res or data == null, return" });
      return;
    }
    augv.b("OlympicHandler", new Object[] { "handleDeliverTorch, req=", paramToServiceMsg, ", res=", paramFromServiceMsg, ", data=", paramObject });
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramToServiceMsg.msg_rsp_head.has())
        {
          ...
          augv.b("OlympicHandler", new Object[] { "handleDeliverTorch, rspHead or torchInfo == null, result set to -100" });
      ...
      {
        augv.b("OlympicHandler", new Object[] { "handleDeliverTorch, InvalidProtocolBufferMicroException, result set to -101, msg=", paramToServiceMsg.getMessage() });
        if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      augv.b("OlympicHandler", new Object[] { "handleDeliverTorch, result=", Integer.valueOf(k), ", errMsg=", paramFromServiceMsg, ", minUpdateTime=", Integer.valueOf(i), ", expireTime=", Integer.valueOf(j), ", sig=", paramObject });
      return;
  ...
  public void a(torch_transfer.TorchbearerInfo paramTorchbearerInfo)
  {
    ...
    {
      augv.b("OlympicHandler", new Object[] { "handlePush0xb4, torchInfo == null, return" });
      return;
    }
    augv.b("OlympicHandler", new Object[] { "handlePush0xb4, torchInfo=", paramTorchbearerInfo });
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    if ((paramToServiceMsg == null) || (paramFromServiceMsg == null) || (paramObject == null))
    {
      augv.b("OlympicHandler", new Object[] { "handleClearTorchFlag, req or res or data == null, return" });
      return;
    }
    augv.b("OlympicHandler", new Object[] { "handleClearTorchFlag, req=", paramToServiceMsg.toString(), ", res=", paramFromServiceMsg.toString(), ", data=", paramObject.toString() });
    ...
    for (;;)
    {
      ...
      {
        label150:
        augv.b("OlympicHandler", new Object[] { "handleClearTorchFlag, InvalidProtocolBufferMicroException, result set to -101, msg=", paramToServiceMsg.getMessage() });
        if (!QLog.isColorLevel()) {
          continue;
        }
        paramToServiceMsg.printStackTrace();
      ...
      if (i == 0)
      {
        ...
        augv.b("OlympicHandler", new Object[] { "handleClearTorchFlag, result=", Integer.valueOf(i), ", errMsg=", paramToServiceMsg });
        return;
        label242:
        paramToServiceMsg = null;
      }
