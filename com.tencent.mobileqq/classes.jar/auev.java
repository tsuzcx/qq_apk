  ...
  extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
  ...
  public auev(HiBoomPanelView paramHiBoomPanelView)
  {
  ...
  {
    auew localauew;
    if ((paramViewHolder instanceof auew))
    {
      localauew = (auew)paramViewHolder;
      localauew.jdField_a_of_type_Int = paramInt;
      if (localauew.jdField_a_of_type_Boolean) {
        break label41;
      }
    }
    for (;;)
    {
      ...
      label41:
      int i = a(paramInt);
      ViewGroup.LayoutParams localLayoutParams = localauew.itemView.getLayoutParams();
      localLayoutParams.height = HiBoomPanelView.jdField_a_of_type_Int;
      localLayoutParams.width = HiBoomPanelView.b;
      localauew.itemView.setPadding(0, 0, HiBoomPanelView.c, HiBoomPanelView.c);
      localLayoutParams = localauew.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomTextView.getLayoutParams();
      ...
      this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.a(localauew, i);
    }
  }
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup paramViewGroup, int paramInt)
  {
    ...
    try
    {
      paramViewGroup = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.getContext()).inflate(2131562981, paramViewGroup, false);
      localObject = paramViewGroup;
      if (paramViewGroup == null) {
        localObject = new View(this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView.getContext());
      }
      return new auew(this.jdField_a_of_type_ComTencentMobileqqHiboomHiBoomPanelView, (View)localObject, bool);
    }
