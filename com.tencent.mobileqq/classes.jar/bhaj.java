...
public class bhaj
  implements ITLog
{
  private static bhaj jdField_a_of_type_Bhaj;
  private static final String[] jdField_a_of_type_ArrayOfJavaLangString = { "log", "info", "warn", "error" };
  
  public static bhaj a()
  {
    if (jdField_a_of_type_Bhaj == null) {}
    try
    {
      jdField_a_of_type_Bhaj = new bhaj();
      return jdField_a_of_type_Bhaj;
    }
    finally {}
  }
  ...
  {
    bhao localbhao = bhar.a().a(Process.myPid());
    if (localbhao != null) {
      localbhao.a("error", paramString);
    }
  }
  ...
  public static void a(String paramString1, String paramString2)
  {
    bhao localbhao = bhar.a().a(Process.myPid());
    if (localbhao != null) {
      localbhao.a(paramString1, paramString2);
    }
  }
