  ...
  implements Manager
{
  ...
  public axho(AppInterface paramAppInterface)
  {
  ...
  public static String a(BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    StringBuilder localStringBuilder = aekt.a().append(paramAppInfo.path.get()).append(":");
  ...
  {
    if (paramInt == 6) {
      bjfw.a().a(paramAppInfo, 102);
    }
    while (paramInt != 1) {
      return;
    }
    bjfw.a().a(paramAppInfo, 101);
  }
  ...
  private void a(BusinessInfoCheckUpdate.AppInfo paramAppInfo, String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      setChanged();
      if (i != 0) {
        alwx.a((QQAppInterface)this.jdField_a_of_type_ComTencentCommonAppAppInterface);
      }
      return;
      ...
      try
      {
        ...
        if ((localTimeRspBody != null) && (localTimeRspBody.rptMsgAppInfo.has()))
        {
          ...
          if (i < localTimeRspBody.rptMsgAppInfo.size())
          {
            ...
            localObject = (aywz)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(12);
            if (localObject != null) {
              ((aywz)localObject).a(paramString);
            }
          }
        }
        a(localTimeRspBody);
  ...
  private int b(String paramString, int paramInt)
  {
    ...
    //   1: istore 4
    //   3: aload_0
    //   4: getfield 35	axho:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   7: astore 5
    //   9: aload 5
    //   11: monitorenter
    //   12: aload_1
    ...
    //   20: ireturn
    //   21: aload_0
    //   22: invokevirtual 82	axho:a	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody;
    //   25: astore 6
    //   27: iload 4
    //   29: istore_3
    //   30: aload 6
    ...
    //   61: ifnonnull +19 -> 80
    //   64: ldc 192
    //   66: invokestatic 52	axho:a	(Ljava/lang/String;)V
    //   69: aload 5
    //   71: monitorexit
    //   72: iconst_0
    //   73: ireturn
  ...
  private void b(BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    for (int i = 1;; i = 2)
    {
      azmj.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), "dc00899", "Grp_tribe", "", "dynamic", "Clk_tribe", 0, 0, i + "", "", "", "");
  ...
  private void c()
  {
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        try
        {
          byte[] arrayOfByte = bdcs.a(localFile);
          if (arrayOfByte != null) {
            break;
          }
  ...
  private void d()
  {
    ...
    {
      ((alwx)((QQAppInterface)localObject).a(87)).a(true, true);
      return;
    }
  ...
  public int a(axhr paramaxhr)
  {
    return a(paramaxhr, false);
  }
  
  public int a(axhr paramaxhr, boolean paramBoolean)
  {
    int n = 0;
    ...
    if (paramaxhr != null)
    {
      ...
      if ((paramaxhr == null) && (this.jdField_b_of_type_Long <= 0L) && (!paramBoolean)) {
        break label202;
      }
      j = 1;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((j != 0) && (k > 0))
        {
          ...
          a((long[])localObject2, "QQCircleRedCircle", new axhp(this, paramaxhr, m));
          return m;
        }
        if (paramaxhr == null) {
          break label378;
      ...
      catch (Exception paramaxhr)
      {
        paramaxhr.printStackTrace();
        QLog.e("RedPointManage", 1, "getPassiveRedNumQQCircle", paramaxhr);
        return m;
      }
    }
    label378:
  ...
  public BusinessInfoCheckUpdate.RedTypeInfo a(QQAppInterface paramQQAppInterface, boolean paramBoolean, Map<Long, LebaPluginInfo> paramMap)
  {
    ...
    for (;;)
    {
      ...
      else if (!alrc.a(paramQQAppInterface, ((BusinessInfoCheckUpdate.AppInfo)localObject5).uiAppId.get(), paramBoolean, paramMap))
      {
    ...
    if (paramArrayOfByte != null) {
      try
      {
        ...
        while (paramArrayOfByte.hasNext())
        {
          ...
          if ((a((Submsgtype0x89.NumRedBusiInfo)localObject)) && (axht.a((Submsgtype0x89.NumRedBusiInfo)localObject))) {
  ...
  public void a(long[] paramArrayOfLong, String paramString, axhi paramaxhi)
  {
    ((axhj)this.jdField_a_of_type_ComTencentCommonAppAppInterface.getManager(65)).a(paramArrayOfLong, paramString, paramaxhi);
  }
  ...
  public boolean a(BusinessInfoCheckUpdate.TimeRspBody paramTimeRspBody)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	axho:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    //   4: invokevirtual 142	com/tencent/common/app/AppInterface:getCurrentAccountUin	()Ljava/lang/String;
    //   7: astore 5
    //   9: aload_0
    //   10: getfield 35	axho:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   13: astore 4
    //   15: aload 4
    //   17: monitorenter
    //   18: aload_1
    ...
    //   24: aload 4
    //   26: monitorexit
    //   27: getstatic 30	axho:jdField_b_of_type_JavaLangObject	Ljava/lang/Object;
    //   30: astore 4
    //   32: aload 4
    //   34: monitorenter
    //   35: getstatic 25	axho:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   38: invokevirtual 1155	java/util/concurrent/atomic/AtomicInteger:incrementAndGet	()I
    //   41: istore_2
    //   42: new 692	java/io/File
    //   45: dup
    //   46: aload_0
    //   47: getfield 37	axho:jdField_a_of_type_ComTencentCommonAppAppInterface	Lcom/tencent/common/app/AppInterface;
    ...
    //   83: aload 6
    //   85: iconst_0
    //   86: invokestatic 1161	bdcs:a	(Ljava/lang/String;[BZ)Z
    //   89: istore_3
    //   90: iload_3
    //   91: ifeq +91 -> 182
    //   94: getstatic 1164	aywz:a	Ljava/util/concurrent/ConcurrentHashMap;
    //   97: aload 5
    //   99: iconst_0
    ...
    //   109: monitorexit
    //   110: aload_0
    //   111: getfield 35	axho:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   114: astore 4
    //   116: aload 4
    //   118: monitorenter
    //   119: iload_3
    //   120: ifeq +18 -> 138
    //   123: iload_2
    //   124: getstatic 25	axho:jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger	Ljava/util/concurrent/atomic/AtomicInteger;
    //   127: invokevirtual 1173	java/util/concurrent/atomic/AtomicInteger:get	()I
    //   130: if_icmpne +8 -> 138
    //   133: aload_0
    //   134: aload_1
    //   135: invokespecial 1175	axho:b	(Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody;)V
    //   138: aload 4
    //   140: monitorexit
    //   141: iload_3
    //   142: ireturn
  ...
  public boolean b(int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 35	axho:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   4: astore_3
    //   5: aload_3
    //   6: monitorenter
    //   7: iload_1
    ...
    //   14: ireturn
    //   15: aload_0
    //   16: invokevirtual 82	axho:a	()Lcom/tencent/pb/getbusiinfo/BusinessInfoCheckUpdate$TimeRspBody;
    //   19: astore 4
    //   21: aload 4
    //   23: ifnonnull +7 -> 30
    //   26: aload_3
