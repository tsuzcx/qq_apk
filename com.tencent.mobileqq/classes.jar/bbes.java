  ...
  extends bdvm
{
  ...
  protected void i(boolean paramBoolean, HashMap<String, Object> paramHashMap)
  {
    ...
    do
    {
      do
      {
        ...
        bbeg.a(this.jdField_a_of_type_Bbeg).removeObserver(this.jdField_a_of_type_Bbeg.jdField_a_of_type_Bdvm);
      } while (!paramBoolean);
      ...
      localIntent.setComponent(new ComponentName(this.jdField_a_of_type_Bbeg.jdField_a_of_type_AndroidContentContext, ChatActivity.class));
      localIntent.addFlags(67108864);
      i = ((Integer)paramHashMap.get("key_aio_type")).intValue();
    } while (localObject == null);
    if (str1 != null) {
      localIntent.putExtra("sigt", bbea.a(str1));
    }
    if (i == 1) {
      if (((ajxl)bbeg.a(this.jdField_a_of_type_Bbeg).getManager(51)).b((String)localObject))
      {
        localIntent.putExtra("uintype", 0);
        localIntent.putExtra("uinname", bbcz.i(bbeg.a(this.jdField_a_of_type_Bbeg), (String)localObject));
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_Bbeg.jdField_a_of_type_AndroidContentContext.startActivity(localIntent);
      return;
      localIntent.setComponent(new ComponentName(this.jdField_a_of_type_Bbeg.jdField_a_of_type_AndroidContentContext, SplashActivity.class));
  ...
  protected void j(boolean paramBoolean, HashMap<String, Object> paramHashMap)
  {
    ...
    for (int i = ((Integer)paramHashMap.get("key_aio_type")).intValue();; i = 2)
    {
      ...
      if ((TextUtils.isEmpty(paramHashMap)) || (paramHashMap.equals("NO")))
      {
        ...
        if (!((ajxl)bbeg.a(this.jdField_a_of_type_Bbeg).getManager(51)).b(str2)) {
          break label276;
        }
        localIntent.putExtra("uintype", 0);
        localIntent.putExtra("uinname", bbcz.i(bbeg.a(this.jdField_a_of_type_Bbeg), str2));
        if (QLog.isColorLevel()) {
  ...
  protected void k(boolean paramBoolean, HashMap<String, Object> paramHashMap)
  {
    ...
    if ((paramBoolean) && (paramHashMap != null))
    {
      ...
      this.jdField_a_of_type_Bbeg.jdField_a_of_type_JavaUtilHashMap.put("uin", paramHashMap);
      if (this.jdField_a_of_type_Bbeg.jdField_a_of_type_JavaUtilHashMap.containsKey("isPrivate")) {
        this.jdField_a_of_type_Bbeg.jdField_a_of_type_JavaUtilHashMap.remove("isPrivate");
      }
      bbeg.b(this.jdField_a_of_type_Bbeg);
      return;
    }
    bcql.a(BaseApplicationImpl.getContext(), 1, BaseApplicationImpl.getContext().getString(2131718748), 0).a();
  }
}
