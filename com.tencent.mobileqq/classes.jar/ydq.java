  ...
  extends RecyclerView.AdapterDataObserver
{
  ...
  {
    ydp.a(this.a).post(new ComponentAdapter.1.1(this));
  }
  
  public void onItemRangeChanged(int paramInt1, int paramInt2)
  {
    ydp.a(this.a).post(new ComponentAdapter.1.2(this, paramInt1, paramInt2));
  }
  
  public void onItemRangeChanged(int paramInt1, int paramInt2, Object paramObject)
  {
    ydp.a(this.a).post(new ComponentAdapter.1.3(this, paramInt1, paramInt2, paramObject));
  }
  
  public void onItemRangeInserted(int paramInt1, int paramInt2)
  {
    ydp.a(this.a).post(new ComponentAdapter.1.4(this, paramInt1, paramInt2));
  }
  
  public void onItemRangeMoved(int paramInt1, int paramInt2, int paramInt3)
  {
    ydp.a(this.a).post(new ComponentAdapter.1.6(this, paramInt1, paramInt2));
  }
  
  public void onItemRangeRemoved(int paramInt1, int paramInt2)
  {
    ydp.a(this.a).post(new ComponentAdapter.1.5(this, paramInt1, paramInt2));
  }
}
