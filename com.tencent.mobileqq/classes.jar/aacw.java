...
{
  public aacw(aacp paramaacp, View paramView)
  {
    super(paramView);
  }
  ...
  public void a(CertifiedAccountMeta.StFeed paramStFeed, ExtraTypeInfo paramExtraTypeInfo)
  {
    ...
    {
      ((RelativeFeedItemView)this.itemView).setIsInNightMode(aacp.a(this.a));
    ...
    for (;;)
    {
      if (aacp.a(this.a) != null) {
        this.itemView.setOnClickListener(new aacx(this, paramStFeed));
      }
      this.itemView.setOnLongClickListener(new aacy(this, paramExtraTypeInfo, paramStFeed));
      return;
      if ((this.itemView instanceof RelativeAdFeedItemView))
      {
        ((RelativeAdFeedItemView)this.itemView).setIsInNightMode(aacp.a(this.a));
