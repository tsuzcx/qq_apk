  ...
  implements blfg
{
  ...
  private View.OnClickListener jdField_a_of_type_AndroidViewView$OnClickListener = new ajer(this);
  protected View a;
  ...
  private View.OnClickListener jdField_b_of_type_AndroidViewView$OnClickListener = new ajes(this);
  View jdField_b_of_type_AndroidViewView;
  protected List<RecommendTroopItem> b;
  public boolean b;
  private final int jdField_c_of_type_Int = 1;
  private View.OnClickListener jdField_c_of_type_AndroidViewView$OnClickListener = new ajet(this);
  ...
  public ajep(QQAppInterface paramQQAppInterface, Context paramContext, ajdx paramajdx, aiyp paramaiyp)
  {
    ...
    this.jdField_a_of_type_Aiyp = paramaiyp;
    this.jdField_i_of_type_Boolean = false;
    this.jdField_a_of_type_Ajdz = new ajdz(this.jdField_a_of_type_AndroidContentContext);
  }
  ...
  private void a(RecommendTroopItem paramRecommendTroopItem)
  {
    ...
    do
    {
      ...
      bhbu.a("Grp_contacts_news", "notice", "recom_exp_grp", 0, 0, new String[] { str1, paramRecommendTroopItem });
  ...
  private void b(View paramView)
  {
    ...
    ajgr.a((structmsg.StructMsg)localObject, paramView.uniseq, AppConstants.TROOP_SYSTEM_MSG_UIN);
    if (this.jdField_a_of_type_Ajdx != null) {
      this.jdField_a_of_type_Ajdx.a().sendEmptyMessage(108);
    }
    ajgr.a((structmsg.StructMsg)localObject, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false);
  }
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    int j;
    if ((paramView == null) || (!(paramView.getTag() instanceof ajeg)))
    {
      paramViewGroup = new ajeg();
      paramView = this.jdField_a_of_type_Ajdz.a(this.jdField_a_of_type_AndroidContentContext, 2131559954, paramViewGroup);
      Object localObject2 = new ajef();
      ((ajef)localObject2).jdField_a_of_type_AndroidViewView = paramView.findViewById(2131373804);
      ((ajef)localObject2).jdField_a_of_type_AndroidWidgetTextView = ((TextView)((ajef)localObject2).jdField_a_of_type_AndroidViewView.findViewById(2131373816));
      ((ajef)localObject2).jdField_b_of_type_AndroidWidgetTextView = ((TextView)((ajef)localObject2).jdField_a_of_type_AndroidViewView.findViewById(2131373817));
      ((ajef)localObject2).jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)((ajef)localObject2).jdField_a_of_type_AndroidViewView.findViewById(2131373813));
      paramViewGroup.jdField_a_of_type_Ajef = ((ajef)localObject2);
      paramViewGroup.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131373819));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131373803));
      paramViewGroup.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)paramView.findViewById(2131373811));
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131373823));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131373809));
      paramViewGroup.jdField_b_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131373820));
      paramViewGroup.jdField_c_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131373822));
      paramViewGroup.d = ((TextView)paramView.findViewById(2131373810));
      paramViewGroup.jdField_a_of_type_AndroidWidgetButton = ((Button)paramView.findViewById(2131373818));
      paramViewGroup.jdField_a_of_type_ComTencentMobileqqWidgetShaderAnimLayout = ((ShaderAnimLayout)paramView.findViewById(2131379575));
      localObject2 = (Button)paramView.findViewById(2131379574);
      paramView.setTag(paramViewGroup);
      this.jdField_a_of_type_Ajdz.a(this.jdField_a_of_type_AndroidContentContext, paramView, paramInt, localObject1, paramViewGroup, new ajev(this), this.jdField_i_of_type_Int);
      paramViewGroup.jdField_b_of_type_Int = paramInt;
      localObject1 = (aqxt)aqxe.a().a(634);
      if (localObject1 == null) {
        break label509;
      }
      if (((aqxt)localObject1).jdField_e_of_type_Int != 1) {
        break label425;
      }
      j = 1;
    }
    for (;;)
    {
      ...
      {
        aiyz.a(paramViewGroup.jdField_a_of_type_AndroidWidgetLinearLayout, true);
        label371:
      ...
      for (;;)
      {
        ...
        {
          this.jdField_a_of_type_Aiyp.a(paramViewGroup, paramInt);
          return paramView;
        }
      }
      label509:
  ...
  public void a(LinearLayout paramLinearLayout)
  {
    ...
    for (;;)
    {
      ...
      ((ImageView)paramLinearLayout.findViewById(2131368143)).setImageDrawable((Drawable)localObject);
      return;
  ...
  public void a(aoce paramaoce)
  {
    ...
    int j;
    Object localObject;
    if ((this.jdField_a_of_type_JavaUtilList != null) && (paramaoce != null))
    {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      {
        localObject1 = paramView;
        if ((paramView.getTag() instanceof ajcz)) {}
      }
      else
      {
        localObject1 = ajcw.a(this.jdField_a_of_type_AndroidContentContext, this.jdField_b_of_type_AndroidViewView$OnClickListener, this.jdField_a_of_type_AndroidViewView$OnClickListener, this.jdField_c_of_type_AndroidViewView$OnClickListener);
      }
      ajcw.a((ajcz)((View)localObject1).getTag(), (RecommendTroopItem)localObject3, (Drawable)localObject2);
      a((RecommendTroopItem)localObject3);
      paramView = (View)localObject1;
      break;
      if (this.jdField_a_of_type_Bghp != null)
      {
        localObject1 = this.jdField_a_of_type_Bghp.a(((RecommendTroopItem)localObject3).uin, true);
        if (localObject1 != null)
        {
          ...
          if (j == 2)
          {
            bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_contacts_news", "", "notice", "verify_exp", 0, 0, "", "", "", "");
            localObject2 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131563013, null);
            localObject3 = (TextView)((View)localObject2).findViewById(2131377266);
            localObject1 = null;
            ...
            for (;;)
            {
              ...
              ((View)localObject2).setOnClickListener(new ajeq(this, (View)localObject2));
              if (!this.jdField_c_of_type_Boolean)
              {
                bhbu.a("Grp_contacts_news", "notice", "verify_clk", 2, 0, new String[0]);
                this.jdField_c_of_type_Boolean = true;
              }
              localObject1 = localObject2;
              break;
              if (this.jdField_a_of_type_Int > c() - 2) {
                localObject1 = anvx.a(2131707093) + this.jdField_a_of_type_Int + anvx.a(2131707095);
              } else {
                localObject1 = anvx.a(2131707092);
              }
            }
          }
          if (j == 4)
          {
            ...
            this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131560729, null);
            this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131371857));
            this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidViewView.findViewById(2131371843);
            if (j != 0)
            {
          ...
          if (j == 5)
          {
            localObject1 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131563014, null);
            ((TextView)((View)localObject1).findViewById(2131368155)).setText(anvx.a(2131707091));
            ((LinearLayout)((View)localObject1).findViewById(2131372096)).setVisibility(8);
            break;
          }
          if (j == 6)
          {
            localObject1 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131563014, null);
            ((TextView)((View)localObject1).findViewById(2131368155)).setText(anvx.a(2131707090));
            ((LinearLayout)((View)localObject1).findViewById(2131372096)).setVisibility(8);
            break;
          }
          if (j == 3)
          {
            localObject1 = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2131563014, null);
            localObject2 = (TextView)((View)localObject1).findViewById(2131368155);
            ((TextView)localObject2).setText(anvx.a(2131707094));
            ((TextView)localObject2).setVisibility(8);
            localObject2 = (LinearLayout)((View)localObject1).findViewById(2131372096);
