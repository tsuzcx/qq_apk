...
public class ajep
{
  ...
  private void a(ApolloActionData paramApolloActionData)
  {
    ...
    ((ajfe)this.a.a().getManager(249)).a().a(localSpriteTaskParam);
  }
  ...
  public void a(int paramInt)
  {
    ...
    ApolloActionData localApolloActionData = ((ajmu)localQQAppInterface.getManager(155)).a(paramInt);
    String str = ajya.a(2131714316);
    ...
    {
      ((airx)localQQAppInterface.getManager(153)).a(localApolloActionData, 4);
      a(str);
      return;
    }
      ...
      try
      {
        ...
        if (localJSONArray != null)
        {
          ...
          if (localJSONArray.length() > 0)
          {
            ...
            {
              paramMessageForApollo = (ApolloSlaveInfo)bazp.a(localJSONArray.getJSONObject(i), ApolloSlaveInfo.class);
