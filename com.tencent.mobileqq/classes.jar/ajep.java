  ...
  extends ajjx
{
  protected void a()
  {
    ...
    {
      f1 = ajlz.a().d;
      if ((f2 >= f1) && (ajlz.a().c) && (this.a.a == null))
      {
      ...
      localHashMap.put("ramSize", String.valueOf(babp.d() / 1024L));
  ...
  protected void b(String paramString)
  {
    ...
    BaseApplicationImpl.sApplication.getRuntime().onGuardEvent(2, ajjv.a().a, 0L);
