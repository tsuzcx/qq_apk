  ...
  implements Manager
{
  ...
  private WeakReference<akds> jdField_a_of_type_JavaLangRefWeakReference;
  private ArrayList<QIMNotifyAddFriend> jdField_a_of_type_JavaUtilArrayList = new ArrayList();
  private AtomicBoolean jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean = new AtomicBoolean(false);
  private AtomicBoolean b = new AtomicBoolean(false);
  
  public akdq(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    String str = bbcz.j(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(paramLong2));
  ...
  public ArrayList<QIMNotifyAddFriend> a()
  {
    ...
    {
      ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_Aukp.a(QIMNotifyAddFriend.class);
  ...
  public ArrayList<atzl> a(boolean paramBoolean)
  {
    ...
    if (((FlashChatManager)???).c())
    {
      synchronized (this.jdField_a_of_type_JavaLangObject)
      {
        ...
        if (localIterator.hasNext()) {
          localArrayList.add(new atzl((QIMNotifyAddFriend)localIterator.next()));
        }
      }
      this.b.set(true);
      if (QLog.isColorLevel()) {
  ...
  public void a(akds paramakds)
  {
    if (QLog.isColorLevel()) {
      QLog.d("QIMNewFriendManager", 2, "addListener");
    }
    this.jdField_a_of_type_JavaLangRefWeakReference = new WeakReference(paramakds);
  }
  ...
  public void a(QIMNotifyAddFriend paramQIMNotifyAddFriend)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      this.jdField_a_of_type_Aukp.b(paramQIMNotifyAddFriend);
      ((akbn)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(34)).b();
      ...
      if (this.jdField_a_of_type_JavaLangRefWeakReference != null)
      {
        paramQIMNotifyAddFriend = (akds)this.jdField_a_of_type_JavaLangRefWeakReference.get();
  ...
  public void a(ArrayList<QIMNotifyAddFriend> paramArrayList)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 29	akdq:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   4: astore_2
    //   5: aload_2
    //   6: monitorenter
    //   7: aload_0
    //   8: getfield 54	akdq:jdField_a_of_type_Aukp	Laukp;
    //   11: invokevirtual 254	aukp:a	()Laukr;
    //   14: astore_3
    //   15: aload_3
    //   16: invokevirtual 257	aukr:a	()V
    //   19: aload_1
    ...
    //   42: astore 4
    //   44: aload_0
    //   45: getfield 27	akdq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   95: aload_0
    //   96: aload 6
    //   98: invokevirtual 264	akdq:a	(Lauko;)Z
    //   101: pop
    //   102: goto -78 -> 24
    //   105: astore_1
    ...
    //   122: aload_3
    //   123: invokevirtual 270	aukr:b	()V
    //   126: aload_2
    //   127: monitorexit
    //   128: return
    //   129: aload_3
    //   130: invokevirtual 272	aukr:c	()V
    //   133: aload_3
    //   134: invokevirtual 270	aukr:b	()V
    //   137: goto -11 -> 126
    //   140: astore_1
    //   141: aload_2
    //   142: monitorexit
    ...
    //   145: astore_1
    //   146: aload_3
    //   147: invokevirtual 270	aukr:b	()V
    //   150: aload_1
    //   151: athrow
  ...
  public void a(List<QIMNotifyAddFriend> paramList)
  {
    ...
    //   44: astore 4
    //   46: aload_0
    //   47: getfield 27	akdq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   97: aload_0
    //   98: aload 6
    //   100: invokevirtual 264	akdq:a	(Lauko;)Z
    //   103: pop
    //   104: goto -78 -> 26
    //   107: astore_1
    ...
    //   124: aload_3
    //   125: invokevirtual 270	aukr:b	()V
    //   128: aload_2
    //   129: monitorexit
    //   130: aload_0
    //   131: getfield 40	akdq:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   134: bipush 34
    //   136: invokevirtual 156	com/tencent/mobileqq/app/QQAppInterface:getManager	(I)Lmqq/manager/Manager;
    //   139: checkcast 227	akbn
    //   142: invokevirtual 229	akbn:b	()V
    //   145: return
    //   146: aload_3
    //   147: invokevirtual 272	aukr:c	()V
    //   150: aload_3
    //   151: invokevirtual 270	aukr:b	()V
    //   154: goto -26 -> 128
    //   157: astore_1
    //   158: aload_2
    //   159: monitorexit
    ...
    //   162: astore_1
    //   163: aload_3
    //   164: invokevirtual 270	aukr:b	()V
    //   167: aload_1
    //   168: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  protected boolean a(auko paramauko)
  {
    ...
    QLog.d("QIMNewFriendManager", 2, "updateEntity em closed e=" + paramauko.getTableName());
    return false;
  }
  ...
  public ArrayList<QIMNotifyAddFriend> b()
  {
    ...
    if ((((FlashChatManager)???).c()) && (((FlashChatManager)???).d()))
    {
      ...
      Collections.sort(localList, new akdr(this));
    }
    while (!QLog.isColorLevel())
    {
      Iterator localIterator;
  ...
  public void b()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 38	akdq:b	Ljava/util/concurrent/atomic/AtomicBoolean;
    //   4: invokevirtual 161	java/util/concurrent/atomic/AtomicBoolean:get	()Z
    //   7: ifeq +97 -> 104
    //   10: aload_0
    //   11: getfield 29	akdq:jdField_a_of_type_JavaLangObject	Ljava/lang/Object;
    //   14: astore_1
    //   15: aload_1
    //   16: monitorenter
    //   17: aload_0
    //   18: getfield 54	akdq:jdField_a_of_type_Aukp	Laukp;
    //   21: invokevirtual 254	aukp:a	()Laukr;
    //   24: astore_2
    //   25: aload_2
    //   26: invokevirtual 257	aukr:a	()V
    //   29: aload_0
    //   30: getfield 27	akdq:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    ...
    //   71: aload_0
    //   72: aload 4
    //   74: invokevirtual 264	akdq:a	(Lauko;)Z
    //   77: pop
    //   78: goto -41 -> 37
    //   81: astore_3
    ...
    //   98: aload_2
    //   99: invokevirtual 270	aukr:b	()V
    //   102: aload_1
    //   103: monitorexit
    //   104: return
    //   105: aload_2
    //   106: invokevirtual 272	aukr:c	()V
    //   109: aload_2
    //   110: invokevirtual 270	aukr:b	()V
    //   113: goto -11 -> 102
    //   116: astore_2
    //   117: aload_1
    //   118: monitorexit
