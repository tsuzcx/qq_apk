...
public class bgoh
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (k - 10 < c())
    {
      ...
      {
        paramString = (bftx)paramQQAppInterface.getManager(203);
        localObject2 = (bjft)paramQQAppInterface.getManager(165);
        ...
        while (((Iterator)localObject3).hasNext())
        {
          ...
          if ((paramString.b(((TroopMemberInfo)localObject1).memberuin)) || (((bjft)localObject2).f(((TroopMemberInfo)localObject1).memberuin))) {
  ...
  public static int a(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString)
  {
    ...
    return ((ankw)paramQQAppInterface.getManager(53)).a(paramString);
  }
  ...
  public static Bundle a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    boolean bool3 = ((bfsk)localObject).a(paramString, paramQQAppInterface.getCurrentAccountUin());
    boolean bool4 = ((bfsk)localObject).a(paramString);
    boolean bool5 = ((bfsk)localObject).b(paramString);
    paramQQAppInterface = ((bfsk)localObject).a(paramString);
    int j = 0;
    boolean bool2 = false;
    int i;
    boolean bool1;
  ...
  {
    paramString = bgok.a(paramString);
    try
    {
      a = paramString;
      return;
  ...
  public static void a(String paramString1, QQAppInterface paramQQAppInterface, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramQQAppInterface.addObserver(new bgoi(l, paramString1, paramQQAppInterface, str));
        localanwd.b(l, 480, 0);
        paramString2 = ((TroopManager)paramQQAppInterface.getManager(52)).c(paramString2);
        if (paramString2.maxInviteMemNum == 0)
        {
          paramQQAppInterface.addObserver(new bgoj(str, paramQQAppInterface, paramString1));
          localanwd.j(str);
        }
  ...
  {
    paramQQAppInterface = (bfsk)paramQQAppInterface.getManager(48);
    ...
    {
      AudioHelper.a(anni.a(2131707688));
      return true;
    }
    return bool1;
  }
  ...
  public static boolean a(String paramString1, QQAppInterface paramQQAppInterface, String paramString2)
  {
    ...
    if (localTroopInfo != null)
    {
      ...
      bool1 = true;
      str = anni.a(2131707685);
      label91:
      if ((!bool1) || (!localTroopInfo.isAdmin())) {
        break label735;
      }
      str = str + anni.a(2131707690);
    }
    label158:
    label210:
    label597:
    ...
    for (boolean bool5 = false;; bool5 = bool1)
    {
      ...
      for (;;)
      {
        ...
        {
          bool1 = false;
          paramQQAppInterface = ((bfsk)paramQQAppInterface.getManager(48)).a(paramString2);
