...
public final class bhkt
{
  ...
  static
  {
    ...
    jdField_b_of_type_JavaLangString = antf.ba + "avatarPendantIcons";
  ...
  public static String a(File paramFile)
  {
    ...
    try
    {
      paramFile = new String(bhmi.a(paramFile));
  ...
  {
    return antf.bT + "font_info/" + paramString + File.separator + paramString + ".ttf";
  }
  
  public static void a()
  {
    File localFile = new File(antf.ba + "avatarPendantDefaultHead");
    if (!localFile.exists()) {
      localFile.mkdir();
    }
    localFile = new File(antf.bT);
    if (!localFile.exists()) {
      localFile.mkdir();
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, avsm paramavsm)
  {
    if ((paramContext == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      if (QLog.isColorLevel()) {
    ...
    do
    {
      ...
      paramQQAppInterface.a(-1, new bhku(paramavsm));
      return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, boolean paramBoolean, ProfileActivity.AllInOne paramAllInOne)
  {
    ...
    if (paramAllInOne != null)
    {
      ...
      if ((i == 1) || (i == 0))
      {
        ...
        localbbav = (bbav)paramQQAppInterface.getManager(36);
        localbbav.b("100005.100006");
        ...
        i2 = 1;
        label202:
        if (!((gc)paramQQAppInterface.getManager(42)).jdField_a_of_type_Boolean) {
          break label495;
        }
    ...
    for (;;)
    {
      ...
      if (paramAllInOne == null)
      {
        ...
        localIntent.putExtra("url", bhyk.a(paramContext, "pendant", ""));
      ...
      for (i = 40202;; i = 40201)
      {
        ...
        bdll.b(paramQQAppInterface, "CliOper", "", "", "PendantMarket", "OtherEntrance", 0, 0, "", "", "", "");
        return;
  ...
  {
    ((VasExtensionHandler)paramQQAppInterface.a(71)).a(new String[] { paramString }, new int[] { 27235 });
  }
  ...
  public static String b(long paramLong, int paramInt)
  {
    ...
    localStringBuilder.append(antf.bT).append(paramLong).append(File.separator);
    switch (paramInt)
    {
    }
    for (;;)
  ...
  {
    return antf.bT + "font_info/" + paramString + "/";
  }
  ...
  public static boolean b(String paramString)
  {
    ...
    return new File(antf.bT + "sticker_info", paramString).exists();
  }
  ...
  public static String c(long paramLong, int paramInt)
  {
    ...
    for (;;)
    {
      return asfa.a("VIP_avatar", localStringBuilder.toString());
      localStringBuilder.append("aio_50.png");
      continue;
      localStringBuilder.append("aio_file.zip");
      continue;
  ...
  {
    return antf.bT + "sticker_info/" + paramString + ".png";
  }
}
