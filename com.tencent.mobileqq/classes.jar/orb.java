  ...
  extends oqo<BaseArticleInfo>
{
  ...
  public int a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    {
      actn.a("DynamicItemViewHelperCompat", "", new IllegalArgumentException(ajyc.a(2131703570)));
      return b;
    }
  ...
  protected TemplateBean a(BaseArticleInfo paramBaseArticleInfo)
  {
    ...
    try
    {
      ...
      JSONObject localJSONObject = this.jdField_a_of_type_Pfw.a(i, paramBaseArticleInfo);
      localTemplateBean1 = localTemplateBean2;
      localTemplateBean2 = this.jdField_a_of_type_Pfw.a(i, localJSONObject);
      localTemplateBean1 = localTemplateBean2;
  ...
  public void a(ProteusItemView paramProteusItemView, int paramInt1, BaseArticleInfo paramBaseArticleInfo, VafContext paramVafContext, int paramInt2)
  {
    ...
    if (localTemplateBean1 != null)
    {
      ...
      if (localTemplateBean2 != null)
      {
        ...
        if (!localTemplateBean2.equals(localTemplateBean1))
        {
          ...
          if (localObject != null)
          {
            ((Container)localObject).setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841265));
    ...
    if (localTemplateBean2 != null) {
      olr.a(paramBaseArticleInfo, (TemplateBean)localObject, localTemplateBean2);
    }
    olr.a(paramBaseArticleInfo, paramVafContext, localTemplateBean2);
    bfwd.a();
  }
