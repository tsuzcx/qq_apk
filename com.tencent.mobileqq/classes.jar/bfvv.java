...
public class bfvv
{
  ...
  public static String a(QQAppInterface paramQQAppInterface, ChatMessage paramChatMessage)
  {
    ...
    if (TextUtils.isEmpty(str2)) {
      str1 = bfua.a(paramQQAppInterface, paramChatMessage.senderuin);
    }
  ...
  public static void a(aywa paramaywa, msg_comm.Msg paramMsg, MessageRecord paramMessageRecord)
  {
    if ((paramaywa != null) && (paramaywa.a == 1024) && (paramMsg.msg_body.rich_text.has()) && (paramMsg.msg_body.rich_text.elems.has()))
    {
      paramaywa = paramMsg.msg_body.rich_text.elems.get().iterator();
      while (paramaywa.hasNext())
      {
        paramMsg = (im_msg_body.Elem)paramaywa.next();
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, long paramLong)
  {
    ...
    {
      i = paramString4.indexOf(paramQQAppInterface.getApp().getString(2131698537));
      if (i != -1) {}
    }
    else
    {
    ...
    paramString4 = new aslp(paramString1, paramQQAppInterface.getCurrentAccountUin(), paramString4, paramInt, -5023, 1245186, ayvc.a());
  ...
  public static void a(QQAppInterface paramQQAppInterface, Crm.CrmCCNotify paramCrmCCNotify, msg_comm.Msg paramMsg, aywa paramaywa)
  {
    long l = paramMsg.msg_head.from_uin.get();
    if (paramaywa == null) {}
    for (int i = 0;; i = paramaywa.a)
    {
  ...
  private static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        azmj.b(paramQQAppInterface, "dc00899", "Qidian", paramString1, str2, "1", 1, 0, str1, "0", String.valueOf(paramInt3), paramString2);
        return;
        if (paramInt2 == -2000)
        {
          str1 = "2";
  ...
  {
    long l = ayvc.a();
    paramString1 = new aslp(paramString1, paramQQAppInterface.getCurrentAccountUin(), paramString2, paramInt, -5020, 1245187, l);
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<MessageRecord> paramList, msg_comm.Msg paramMsg, aywa paramaywa, Crm.CrmCCNotify paramCrmCCNotify)
  {
    int i = 0;
  ...
  public static void a(QQAppInterface paramQQAppInterface, List<MessageRecord> paramList, im_msg_body.NotOnlineFile paramNotOnlineFile, msg_comm.Msg paramMsg, aywa paramaywa)
  {
    ...
    try
    {
      ...
      a(paramQQAppInterface, (Crm.CrmCCNotify)localObject, paramMsg, paramaywa);
      return;
    }
