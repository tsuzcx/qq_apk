  ...
  implements wjy
{
  private boolean a(List<String> paramList)
  {
    ...
    {
      yqp.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleAlbumEntraConfig type: 日迹主页影集入口配置, content: \n", paramList);
      paramList = (wca)wpm.a(30);
        ...
        catch (NumberFormatException localNumberFormatException3)
        {
          try
          {
            for (;;)
            {
              ...
              yqp.e("Q.qqstory.config.QQStoryConfigServletHandler", "get enableCqMode= " + str11 + " from json error:" + localNumberFormatException1);
              continue;
              localNumberFormatException2 = localNumberFormatException2;
              yqp.e("Q.qqstory.config.QQStoryConfigServletHandler", "get highBitrate= " + str11 + " from json error:" + localNumberFormatException2);
              continue;
              bool = false;
            }
            localNumberFormatException3 = localNumberFormatException3;
            yqp.e("Q.qqstory.config.QQStoryConfigServletHandler", "get codecProfile= " + str11 + " from json error:" + localNumberFormatException3);
          }
          catch (NumberFormatException localNumberFormatException4)
          {
            for (;;)
            {
              yqp.e("Q.qqstory.config.QQStoryConfigServletHandler", "get maxVideoSize= " + str11 + " from json error:" + localNumberFormatException4);
            }
          }
        }
      }
  ...
  private boolean a(List<String> paramList, String paramString)
  {
    ...
    {
      return false;
      yqp.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleQzoneSync2QQStory config=%s", paramList);
    ...
    catch (Throwable paramString)
    {
      for (;;)
      {
        yqp.e("Q.qqstory.config.QQStoryConfigServletHandler", "handleQzoneSync2QQStory  parseLong error");
      }
    }
  ...
  private boolean b(List<String> paramList)
  {
    ...
    for (paramList = "";; paramList = str)
    {
      yqp.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleAlbumConfig type: 影集配置, content: \n", paramList);
      if ((!TextUtils.isEmpty(str)) && (str.trim().length() != 0)) {
        break;
      }
      localwca.f();
  ...
  private boolean b(List<String> paramList, int paramInt)
  {
    ...
    return ((wpj)wpm.a(5)).a(paramList);
  }
  ...
  private boolean c(List<String> paramList)
  {
    ...
    wsm localwsm = (wsm)QQStoryContext.a().getManager(252);
    String str = (String)paramList.get(0);
    if (str == null) {}
    for (paramList = "";; paramList = str)
    {
      yqp.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleMsgTabTakeVideoNodeConfig type: 日迹拍摄配置, content: \n", paramList);
      if ((!TextUtils.isEmpty(str)) && (str.trim().length() != 0)) {
        break;
      }
      localwsm.a();
  ...
  private boolean d(List<String> paramList)
  {
    ...
    paramList = (String)paramList.get(0);
    yqp.a("Q.qqstory.config.QQStoryConfigServletHandler", "handledAIOSyncToStory config=%s", paramList);
    if (TextUtils.isEmpty(paramList))
    {
      yqp.d("Q.qqstory.config.QQStoryConfigServletHandler", "handledAIOSyncToStory content is null!!");
      bozs.b();
      return true;
    }
    try
  ...
  private boolean e(List<String> paramList)
  {
    ...
    yqp.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig config=%s", paramList);
    paramList = (String)paramList.get(0);
    if (TextUtils.isEmpty(paramList))
    {
      yqp.d("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig clear config");
      wpf.c(false);
      wpf.e(false);
      return true;
    }
    try
    {
      ...
      yqp.a("Q.qqstory.config.QQStoryConfigServletHandler", "handleStorySync2QzoneConfig showSyncBtn = %d,defaultStatus=%d", Integer.valueOf(i), Integer.valueOf(j));
      if (i == 1)
      {
        bool = true;
        wpf.c(bool);
    ...
    {
      zkb.a("handleStorySync2QzoneConfig:" + paramList.toString(), new Object[0]);
      paramList.printStackTrace();
    }
  }
  ...
  private boolean f(List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        paramList = (wph)JsonORM.a(new JSONObject(paramList), wph.class);
        localwpf = (wpf)wpm.a(10);
        localwpf.b("boolean_enable_revert_play_mode", Boolean.valueOf(true));
        localwpf.b("boolean_enable_fast_play_mode", Boolean.valueOf(true));
        localwpf.b("boolean_enable_slow_play_mode", Boolean.valueOf(true));
        localwpf.b("boolean_enable_hw_encode_pic_to_video", Boolean.valueOf(true));
        localwpf.b("boolean_enable_flow_decode", Boolean.valueOf(true));
        localwpf.b("boolean_use_flow_decode_first", Boolean.valueOf(false));
        localwpf.b("key_story_home_preload_count", Integer.valueOf(4));
        localwpf.b("key_story_video_preload_duration", Integer.valueOf(2));
        wpi[] arrayOfwpi;
        int k;
        if (paramList.f != null)
        {
          arrayOfwpi = paramList.f;
          k = arrayOfwpi.length;
          i = 0;
          if (i < k)
          {
            ...
            localwpf.b("boolean_use_flow_decode_first", Boolean.valueOf(true));
          }
        }
        if (paramList.jdField_a_of_type_ArrayOfWpi != null)
        {
          arrayOfwpi = paramList.jdField_a_of_type_ArrayOfWpi;
          k = arrayOfwpi.length;
          i = 0;
          if (i < k)
          {
            ...
            localwpf.b("boolean_enable_revert_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.jdField_b_of_type_ArrayOfWpi != null)
        {
          arrayOfwpi = paramList.jdField_b_of_type_ArrayOfWpi;
          k = arrayOfwpi.length;
          i = 0;
          if (i < k)
          {
            ...
            localwpf.b("boolean_enable_fast_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.c != null)
        {
          arrayOfwpi = paramList.c;
          k = arrayOfwpi.length;
          i = 0;
          if (i < k)
          {
            ...
            localwpf.b("boolean_enable_slow_play_mode", Boolean.valueOf(false));
          }
        }
        if (paramList.d != null)
        {
          arrayOfwpi = paramList.d;
          k = arrayOfwpi.length;
          i = 0;
          if (i < k)
          {
            ...
            localwpf.b("boolean_enable_hw_encode_pic_to_video", Boolean.valueOf(false));
          }
        }
        if (paramList.e != null)
        {
          arrayOfwpi = paramList.e;
          k = arrayOfwpi.length;
          i = 0;
          if (i < k)
          {
            ...
            localwpf.b("boolean_enable_flow_decode", Boolean.valueOf(false));
          }
        }
      ...
      localwpf.b("string_story_global_log_level", Integer.valueOf(i));
      localwpf.b("string_auto_play_report_control", paramList.jdField_b_of_type_JavaLangString);
      if ((paramList.jdField_a_of_type_Int > 0) && (paramList.jdField_a_of_type_Int < 20)) {
        localwpf.b("key_story_home_preload_count", Integer.valueOf(paramList.jdField_a_of_type_Int));
      }
      if ((paramList.jdField_b_of_type_Int > 0) && (paramList.jdField_b_of_type_Int < 10))
      {
        localwpf.b("key_story_video_preload_duration", Integer.valueOf(paramList.jdField_b_of_type_Int));
        break label726;
        i = j;
  ...
  private boolean g(List<String> paramList)
  {
    ...
    paramList = (String)paramList.get(0);
    if (!TextUtils.isEmpty(paramList)) {
      bgsg.i(localQQAppInterface.getApp(), localQQAppInterface.c(), paramList);
    }
    for (;;)
    {
      ((wfg)localQQAppInterface.getManager(181)).b(paramList);
      if (QLog.isColorLevel()) {
        QLog.d("Q.qqstory.config.QQStoryConfigServletHandler", 2, "handleStoryPlayerProxyConfigCmd configContent = " + paramList);
      }
      return true;
      bgsg.i(localQQAppInterface.getApp(), localQQAppInterface.c(), null);
    }
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject2 != null)
        {
          ...
          if ((!TextUtils.isEmpty((CharSequence)localObject1)) && (nlw.a((String)localObject2)))
          {
            localwpf.b("CertificationLinkText", localObject1);
            localwpf.b("CertificationLinkUrl", localObject2);
            ...
            localwpf.b("localVideoScanInterval", String.valueOf(i));
            localObject1 = localJSONObject.optJSONObject("mainHallConfig");
            if (localObject1 == null) {
              break label554;
            }
            localwpf.b("mainHallConfig", ((JSONObject)localObject1).toString());
            localObject1 = localJSONObject.optJSONObject("troopStoryHallConfig");
            if (localObject1 == null) {
              break label567;
            }
            localwpf.b("troopStoryHallConfig", ((JSONObject)localObject1).toString());
            ...
            bool = true;
            localwpf.b("key_share_encrypt_flag", Boolean.valueOf(bool));
            ...
            bool = true;
            localwpf.b("key_show_in_friend_story_main_page", Boolean.valueOf(bool));
            ...
            localwpf.b("boolean_enable_multi_video_fragment", Boolean.valueOf(true));
            i = 0;
            if (i < j)
            {
              ...
              localwpf.b("boolean_enable_multi_video_fragment", Boolean.valueOf(false));
            }
            i = localJSONObject.optInt("qim_sync_to_qq", 0);
            QLog.d("Q.qqstory.commonConfig", 2, "qim_sync_to_qq: " + paramList);
            localwpf.b("key_qim_int_qim_sync_to_qq_default", Integer.valueOf(i));
            return true;
          }
          localwpf.b("CertificationLinkText", "");
          localwpf.b("CertificationLinkUrl", "");
          continue;
        }
        localwpf.b("CertificationLinkText", "");
      }
      ...
      continue;
      label540:
      localwpf.b("localVideoScanInterval", "1441");
      continue;
      label554:
      localwpf.b("mainHallConfig", "");
      continue;
      label567:
      localwpf.b("troopStoryHallConfig", "");
      continue;
      label580:
      localwpf.b("key_share_encrypt_flag", Boolean.valueOf(false));
      continue;
      label595:
      localwpf.b("key_show_in_friend_story_main_page", Boolean.valueOf(true));
      continue;
      label610:
      localwpf.b("boolean_enable_multi_video_fragment", Boolean.valueOf(true));
      continue;
  ...
  public boolean a(int paramInt, Intent paramIntent, ConfigurationService.Config paramConfig)
  {
    ...
    Object localObject = wpf.a(paramInt);
    int i = bgsg.a(QQStoryContext.a().getApp(), (String)localObject, str);
    int j = paramConfig.version.get();
    localObject = arcj.a(paramConfig, i, paramInt);
    if (localObject == null) {
      return bool2;
    }
    switch (paramInt)
