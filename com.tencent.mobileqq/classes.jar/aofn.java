  ...
  extends ServerConfigObserver
{
  ...
  public void onGetPluginConfig(boolean paramBoolean, int paramInt, GetResourceRespV2 paramGetResourceRespV2)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        localObject1 = aofm.a(this.a).getEntityManagerFactory().createEntityManager();
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          if (localGetResourceRespInfoV2.iPluginType == 32)
          {
            ...
            if (aofu.a((awbw)localObject1, aofm.a(this.a), localGetResourceRespInfoV2).cDefaultState != 0) {
              break label515;
            }
            paramInt = 1;
            i = 1;
    ...
    for (;;)
    {
      for (;;)
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          {
            ResourcePluginInfo.remove((awbw)localObject1, localGetResourceRespInfoV2.strPkgName);
            i = 1;
          }
        }
        ...
        while (paramGetResourceRespV2.hasNext())
        {
          ...
          {
            aofu.a((awbw)localObject1, aofm.a(this.a), (GetResourceRespInfoV2)localObject2);
            i = 1;
          }
        }
        ((awbw)localObject1).a();
        ...
        if (i != 0)
        {
          paramGetResourceRespV2 = new ArrayList(aofm.a(this.a)).iterator();
          while (paramGetResourceRespV2.hasNext())
          {
        ...
        label415:
        if (k >= aofm.a(this.a).size()) {
          break;
        }
        try
        {
          ResourcePluginListener.a((ResourcePluginListener)aofm.a(this.a).get(k), (byte)1, 2);
          label454:
          k += 1;
          break label415;
          while (paramInt < aofm.a(this.a).size()) {
            try
            {
              ResourcePluginListener.a((ResourcePluginListener)aofm.a(this.a).get(paramInt), (byte)-1, 2);
              label500:
              paramInt += 1;
            }
