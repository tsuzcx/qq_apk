...
{
  public avza(LocationPickFragment paramLocationPickFragment, BaseActivity paramBaseActivity) {}
  
  public void deny(int paramInt, String[] paramArrayOfString, int[] paramArrayOfInt)
  {
    paramArrayOfString = bglp.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity);
    if (paramArrayOfString != null) {
      paramArrayOfString.setOnDismissListener(new avzb(this));
    }
    ...
    paramArrayOfInt = avwv.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.app);
