...
public class avza
{
  ...
  private void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if ((paramBoolean) && (this.jdField_a_of_type_Avze != null)) {
          this.jdField_a_of_type_Avze.k();
        }
        return;
        if (QLog.isColorLevel()) {
  ...
  {
    if (QLog.isColorLevel()) {
      if (this.jdField_a_of_type_Avzr != null) {
        break label61;
      }
    }
    label61:
    ...
    if (this.jdField_a_of_type_Avze != null) {
      this.jdField_a_of_type_Avze.a(this.jdField_a_of_type_AndroidMediaMediaFormat);
    }
    return;
    label114:
    this.jdField_a_of_type_Avzr.a(0, paramMediaFormat);
  }
  ...
  public void a(avyy paramavyy)
  {
    ...
    if (paramavyy.j != -1) {
      ((MediaFormat)localObject).setInteger("bitrate-mode", paramavyy.j);
    }
    if (paramavyy.k != -1)
    {
    ...
    if (paramavyy.jdField_b_of_type_Boolean)
    {
      ((MediaFormat)localObject).setInteger("profile", 1);
      ((MediaFormat)localObject).setInteger("level", 512);
    }
    if (QLog.isColorLevel()) {
      QLog.d("HWVideoEncoder", 2, "start : encodeConfig = + " + paramavyy.toString() + " ; format: " + localObject);
    }
    ...
    if (paramavyy.jdField_a_of_type_Avzr == null)
    {
    ...
    for (;;)
    {
      if (paramavyy.jdField_a_of_type_Avze != null) {
        this.jdField_a_of_type_Avze = paramavyy.jdField_a_of_type_Avze;
      }
      this.jdField_a_of_type_Int = -1;
      this.jdField_a_of_type_Boolean = false;
      return;
      this.jdField_a_of_type_Avzr = paramavyy.jdField_a_of_type_Avzr;
      this.jdField_a_of_type_Avzr.jdField_a_of_type_AndroidMediaMediaMuxer.setOrientationHint(paramavyy.g);
    }
  }
  ...
  public void a(ByteBuffer paramByteBuffer, MediaCodec.BufferInfo paramBufferInfo)
  {
    if (this.jdField_a_of_type_Avzr == null)
    {
      ...
      if (this.jdField_a_of_type_Avze != null)
      {
        ...
        this.jdField_a_of_type_Avze.a(paramBufferInfo);
    ...
    this.jdField_a_of_type_Avzr.a(0, paramByteBuffer, paramBufferInfo);
  }
    ...
    catch (Exception localException1)
    {
      try
      {
        for (;;)
        {
          ...
          if ((this.jdField_a_of_type_Avzr != null) || (this.jdField_a_of_type_AndroidMediaMediaMuxer == null)) {
            break label237;
          }
          try
          {
      ...
      catch (Exception localException2)
      {
        ...
        } while (this.jdField_a_of_type_Avzr == null);
