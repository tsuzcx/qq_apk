...
public final class bbac
{
  ...
  public static <T> void a(WebView paramWebView, bbah<T> parambbah)
  {
    ...
    if (paramWebView == null)
    {
      ...
      parambbah.a(new NullPointerException("mWebView is null"));
      return;
    }
    ...
    if (localObject1 == null)
    {
      ...
      parambbah.a(new NullPointerException("context is null"));
      return;
    }
    AtomicBoolean localAtomicBoolean = new AtomicBoolean(false);
    localObject1 = new audu((Context)localObject1);
    ((audu)localObject1).a(ajyc.a(2131699360));
    ((audu)localObject1).a(true);
    ((audu)localObject1).a(new bbad(localAtomicBoolean, (audu)localObject1));
    ((audu)localObject1).show();
    ...
    Object localObject2 = new bbae((audu)localObject1);
    ...
    ((audu)localObject1).setOnDismissListener(new bbaf((AnimatorSet)localObject2));
    a(paramWebView, new bbag(localAtomicBoolean, (audu)localObject1, parambbah, paramWebView, (AnimatorSet)localObject2));
  }
  
  public static void a(WebView paramWebView, bbai parambbai)
  {
    if ((paramWebView == null) || (parambbai == null)) {}
    int i;
    int j;
    Bitmap localBitmap;
    do
            ...
            try
            {
              ...
              try
              {
                if (jdField_a_of_type_JavaLangReflectMethod != null) {
                  jdField_a_of_type_JavaLangReflectMethod.invoke(paramWebView.getX5WebViewExtension(), new Object[] { localBitmap, Boolean.valueOf(true), Boolean.valueOf(true), Boolean.valueOf(true), Boolean.valueOf(true), Integer.valueOf(1), Integer.valueOf(1), new ScreenShotUtil.1(parambbai, localBitmap) });
                }
                i = 1;
              }
  ...
  public static <T> boolean a(WebView paramWebView, bbah<T> parambbah)
  {
    ...
    for (;;)
    {
      ...
      if ((i <= 0) || (j <= 0) || (k <= 0))
      {
        ...
        parambbah.a(new IllegalStateException("measuredWidth <= 0 || contentWidth <= 0 || contentHeight <= 0"));
        return false;
      }
      float f = i / j;
      j = (int)(k * f);
      if (j > 20000)
      {
        ...
        parambbah.a(new IllegalStateException(ajyc.a(2131719038)));
        return false;
      }
      try
      {
        ...
        if (localBitmap != null)
        {
          Canvas localCanvas = new Canvas(localBitmap);
          localCanvas.scale(f, f);
          ThreadManagerV2.executeOnNetWorkThread(new ScreenShotUtil.2(paramWebView, localCanvas, parambbah, localBitmap));
          return true;
        }
      }
