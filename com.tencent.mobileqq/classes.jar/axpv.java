...
public class axpv
{
  ...
  static
  {
    jdField_a_of_type_ArrayOfInt = new int[] { 101, 2130845516 };
    jdField_b_of_type_ArrayOfInt = new int[] { 102, 2130845519 };
    jdField_c_of_type_ArrayOfInt = new int[] { 103, 2130845515 };
    jdField_d_of_type_ArrayOfInt = new int[] { 104, 2130845522 };
  }
  
  public axpv(int paramInt)
  {
