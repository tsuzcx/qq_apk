...
public class axpv
{
  ...
  {
    this.jdField_a_of_type_Float = paramaxpv.jdField_a_of_type_Float;
    this.b = paramaxpv.b;
    this.c = paramaxpv.c;
    this.d = paramaxpv.d;
    this.jdField_a_of_type_AndroidGraphicsMatrix.set(paramaxpv.jdField_a_of_type_AndroidGraphicsMatrix);
  }
