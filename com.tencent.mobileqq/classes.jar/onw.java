  ...
  extends MSFServlet
{
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      onu localonu = (onu)((QQAppInterface)super.getAppRuntime()).getBusinessHandler(BusinessHandlerFactory.ECSHOP_HANDLER);
      if (localonu != null) {
        localonu.a(paramIntent, paramFromServiceMsg, arrayOfByte);
      }
