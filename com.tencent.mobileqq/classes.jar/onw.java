...
{
  onw(onu paramonu, long paramLong, NewIntent paramNewIntent, ony paramony, String paramString) {}
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (!paramBoolean)
    {
      if (this.jdField_a_of_type_Ony != null) {
        this.jdField_a_of_type_Ony.a(this.jdField_a_of_type_JavaLangString, "error");
      }
      if (QLog.isColorLevel()) {
    ...
    do
    {
      do
      {
        ...
        if (this.jdField_a_of_type_Ony != null)
        {
          ...
          this.jdField_a_of_type_Ony.a(this.jdField_a_of_type_JavaLangString, paramBundle);
        }
      } while (!QLog.isColorLevel());
