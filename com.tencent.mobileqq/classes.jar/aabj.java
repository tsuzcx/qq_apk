  ...
  public boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    if ("goShare".equals(paramString3))
    {
      ...
      try
      {
        ...
        {
          bfhq.a().a(this.mRuntime.a().getString(2131721266));
          return true;
        }
      }
      catch (JSONException paramJsBridgeListener)
      {
        bfhq.a().a(this.mRuntime.a().getString(2131690337));
        return true;
      }
    ...
    try
    {
      bfhg.c(this.TAG, "doReport");
      paramJsBridgeListener = new JSONObject(paramVarArgs[0]);
      aabm.a(null, paramJsBridgeListener.optString("actionName"), paramJsBridgeListener.optInt("fromType"), paramJsBridgeListener.optInt("actionResult"), paramJsBridgeListener.optInt("ext2"));
      return true;
    }
    catch (JSONException paramJsBridgeListener)
    {
    ...
    try
    {
      paramString1 = new String(bdbi.decode(paramString1, 0));
    ...
    if ("jumpPublicDevice".equals(paramString3)) {
      try
      {
        bfhg.c(this.TAG, "METHOD_JUMP_PUBLICDEVICE");
