...
public class bfeq
{
  ...
  public bfeq(QQAppInterface paramQQAppInterface, PinnedFooterExpandableListView paramPinnedFooterExpandableListView, bfes parambfes)
  {
    ...
    this.jdField_a_of_type_Bfem = new bfem(paramQQAppInterface);
  }
  ...
  private void e()
  {
    ...
    if (localbfgz != null)
    {
      ArrayList localArrayList1 = this.jdField_a_of_type_Bfes.a();
      if (localArrayList1 != null)
      {
        ...
        localbfgz.a(localArrayList2, new bfer(this));
      }
    }
  }
  ...
  public View a(int paramInt1, int paramInt2, View paramView, ViewGroup paramViewGroup, Context paramContext, View.OnClickListener paramOnClickListener, RelationTroopEntity paramRelationTroopEntity)
  {
    if (paramView == null)
    {
      paramView = LayoutInflater.from(paramContext).inflate(2131560479, paramViewGroup, false);
      paramViewGroup = new bfdu();
      paramViewGroup.c = ((ImageView)paramView.findViewById(2131368381));
  ...
  public void a()
  {
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "friendlist_exp", a(), 0, "", "", "", "");
  }
  ...
  public void a(ArrayList<Groups> paramArrayList, SparseArray<ArrayList<Entity>> paramSparseArray)
  {
    ...
    if (!this.b.isEmpty())
    {
      ...
      ((Groups)localObject2).group_name = anvx.a(2131718028);
    ...
    if (!this.jdField_a_of_type_JavaUtilArrayList.isEmpty())
    {
      ...
      ((Groups)localObject1).group_name = anvx.a(2131718027);
  ...
  public void b()
  {
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "friendlist_clk", a(), 0, "", "", "", "");
  }
  
  public void c()
  {
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "grplist_exp", a(), 0, "", "", "", "");
  }
  
  public void d()
  {
    bdla.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "Grp_create", "", "grptab", "grplist_clk", a(), 0, "", "", "", "");
  }
}
