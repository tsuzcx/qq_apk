...
public class bdli
{
  ...
  public static Pair<CharSequence, CharSequence> a(ayjh paramayjh)
  {
    if ((paramayjh instanceof ayhw)) {
      return ((ayhw)paramayjh).a();
    }
    if ((paramayjh instanceof ayhv)) {
      return ((ayhv)paramayjh).a();
    }
    return null;
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, int paramInt, String paramString2)
  {
    ...
    do
    {
      ...
      {
      default: 
        return bdbt.a(paramQQAppInterface, paramString1, paramInt);
      }
      if (aljq.G.equals(paramString1)) {
        return paramContext.getString(2131720520);
      }
      if (aljq.J.equals(paramString1)) {
        return paramContext.getString(2131720519);
      }
      if (aljq.E.equals(paramString1)) {
        return paramContext.getString(2131720587);
      }
      if (paramInt != 1000) {
        break;
      }
    ...
    return bdbt.a(paramQQAppInterface, paramString1, paramContext.b(paramString2), paramString2, true, null);
    if (paramInt == 1004)
    {
      paramContext = bdbt.c(paramQQAppInterface, paramString2, paramString1);
      if ((paramContext != null) && (paramContext.equals(paramString1))) {
        return bdbt.b(paramQQAppInterface, paramString1, true);
      }
    }
    else
    {
  ...
  public static String a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localasez = new asez(new StringReader(paramString), paramString.length());
        paramString = null;
      }
  ...
  public static ArrayList<bdlk> a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    if (j >= 3)
    {
      ...
      if (j >= 3)
      {
        ...
        localObject2 = bdbt.b(paramQQAppInterface, (String)localObject1, true);
        ...
        ((SpannableStringBuilder)localObject2).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131167038)), 0, paramString.length(), 17);
        localArrayList.add(new bdlk((String)localObject1, 0, new Pair(localObject2, null)));
        i = m + 1;
      }
      label193:
      paramQQAppInterface = new ayox(paramQQAppInterface, 10001, 29, null);
      paramQQAppInterface.a();
      paramQQAppInterface = paramQQAppInterface.a(new ayql(paramString));
    ...
    for (;;)
    {
      ...
      {
        paramString = (ayjh)((Iterator)localObject1).next();
        if ((paramString.b() & 0xFFFFFFFF & 0xFF000000) >> 24 != 2L) {
          if (localArrayList.size() < i)
          {
            if ((paramString.d() == 0) || (paramString.d() == 1004))
            {
              ...
              localArrayList.add(new bdlk(paramString.b(), paramString.d(), paramQQAppInterface));
              j = m;
              if (!QLog.isColorLevel()) {
                continue;
              }
            ...
            for (paramString = "null";; paramString = paramString.a())
            {
              ...
              if (((String)localObject1).toLowerCase().startsWith(paramString.toLowerCase()))
              {
                ...
                ((SpannableStringBuilder)localObject3).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131167038)), 1, paramString.length() + 1, 17);
                localArrayList.add(new bdlk((String)localObject1, 0, new Pair(localObject2, localObject3)));
                i = m + 1;
                break label193;
              }
              Object localObject3 = ayrd.a((String)localObject2, paramString, 1);
              if (localObject3[0] == 0)
              {
                i = localObject3[1];
                localObject2 = new SpannableStringBuilder((CharSequence)localObject2);
                ((SpannableStringBuilder)localObject2).setSpan(new ForegroundColorSpan(BaseApplicationImpl.sApplication.getResources().getColor(2131167038)), 0, i, 17);
                localArrayList.add(new bdlk((String)localObject1, 0, new Pair(localObject2, null)));
                i = m + 1;
                break label193;
              }
              localObject3 = ayrd.a((String)localObject2, paramString, 2);
              i = m;
              if (localObject3[0] != 0) {
                break label193;
              }
              ...
              i = m + 1;
              break label193;
              localArrayList.add(new bdlk(paramString.b(), paramString.d(), null));
              m = j;
              break label349;
              label767:
  ...
  public static void a(View paramView)
  {
    ...
    bdlj.jdField_c_of_type_Int = a(paramView.getContext());
    paramView = (Integer)paramView.getTag(2131379914);
    if (paramView != null) {}
    for (int i = paramView.intValue();; i = -1)
    {
      bdlj.jdField_e_of_type_Int = i + 1;
      if (bdlj.jdField_f_of_type_Int == 1)
      {
        bdlj.jdField_a_of_type_Long = bdlj.jdField_d_of_type_Long + (System.nanoTime() - bdlj.jdField_c_of_type_Long) / 1000000L;
        bdlj.jdField_b_of_type_Long = bdlj.jdField_f_of_type_Long + (System.nanoTime() - bdlj.jdField_e_of_type_Long) / 1000000L;
      }
      if (bdlj.jdField_d_of_type_Int == 1)
      {
        bdlj.h = -1;
        bdlj.i = -1;
        bdlj.j = -1;
      }
      localHashMap.put("keyNum", String.valueOf(bdlj.jdField_a_of_type_Int));
      localHashMap.put("firstKeyLen", String.valueOf(bdlj.jdField_b_of_type_Int));
      localHashMap.put("itemPage", String.valueOf(bdlj.jdField_c_of_type_Int));
      localHashMap.put("itemSearchStrategy", String.valueOf(bdlj.jdField_d_of_type_Int));
      localHashMap.put("itemPosition", String.valueOf(bdlj.jdField_e_of_type_Int));
      localHashMap.put("itemType", String.valueOf(bdlj.jdField_f_of_type_Int));
      localHashMap.put("itemUinType", String.valueOf(bdlj.g));
      if (bdlj.jdField_f_of_type_Int == 1)
      {
        localHashMap.put("totalCost", String.valueOf(bdlj.jdField_a_of_type_Long));
        localHashMap.put("searchCost", String.valueOf(bdlj.jdField_b_of_type_Long));
      }
      localHashMap.put("senderNum", String.valueOf(bdlj.h));
      localHashMap.put("friendNum", String.valueOf(bdlj.i));
      localHashMap.put("friendIndex", String.valueOf(bdlj.j));
      azmz.a(BaseApplicationImpl.getApplication()).a(null, "actFtsItemClickEvent", true, bdlj.jdField_a_of_type_Long, bdlj.jdField_b_of_type_Long, localHashMap, "", false);
      if ((bdlj.jdField_f_of_type_Int == 1) && (QLog.isColorLevel())) {
        QLog.d("Q.fts.utils", 2, "actFtsItemClickEvent: totalCost = " + bdlj.jdField_a_of_type_Long + ", searchCost = " + bdlj.jdField_b_of_type_Long);
      }
      return;
    }
  }
  ...
  public static boolean b()
  {
    ...
    if (a())
    {
      ...
      if (!e((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()))
      {
        ...
        ((HashMap)localObject1).put("param_ROM", bdcb.j());
        azmz.a(BaseApplication.getContext()).a(null, "actQQInstallExternal", true, -1L, 0L, (HashMap)localObject1, null, false);
        c((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), true);
      }
    }
    Object localObject1 = bdcb.a();
    if (QLog.isColorLevel()) {
    ...
    try
    {
      ...
      if (!f((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()))
      {
        ...
        ((HashMap)localObject2).put("param_ROM", bdcb.j());
        ...
        azmz.a(BaseApplication.getContext()).a(null, "actLowRomForFTS", true, -1L, 0L, (HashMap)localObject2, null, false);
  ...
  public static String[] b(String paramString)
  {
    ...
    paramString = new asfa(new StringReader(paramString));
    try
    {
      for (;;)
      {
        asew localasew = paramString.a();
        if (localasew == null) {
          break;
        }
        if (!TextUtils.isEmpty(localasew.a()))
        {
          ((StringBuilder)localObject).append(localasew.a());
