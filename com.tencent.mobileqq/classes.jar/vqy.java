  ...
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          ...
          localObject = new vrk();
          ((vrk)localObject).jdField_b_of_type_JavaLangString = paramIntent.optString("title");
          ((vrk)localObject).jdField_b_of_type_Int = 2;
          ((vrk)localObject).a = String.valueOf(i);
          ((vrk)localObject).g = paramContext;
          vqx.a(this.a).a((vrk)localObject);
        }
        ...
        vqx.a(this.a, paramIntent.optBoolean("is_from_story", false));
        vqx.a(this.a, paramContext.mSongMid);
      }
    ...
    vqx.a(this.a).sendEmptyMessage(1);
  }
}
