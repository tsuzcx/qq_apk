...
public class voc
{
  public ArrayList<Long> a(List<String> paramList)
  {
    ...
    {
      l = avam.a((String)paramList.next()) + l;
  ...
  public ArrayList<Long> a(List<String> paramList, String paramString)
  {
    ...
    long l2 = avam.a(paramString);
    paramString = new ArrayList();
    Iterator localIterator = paramList.iterator();
    long l1 = 0L;
    while (localIterator.hasNext())
    {
      l1 = avam.a((String)localIterator.next()) + l1;
  ...
  public boolean a(List<String> paramList, String paramString, int paramInt1, int paramInt2, MediaFormat paramMediaFormat)
  {
    ...
    {
      localObject4 = new bjli();
      try
      {
        i = bjlh.a((String)paramList.get(0), (bjli)localObject4);
      ...
      paramInt1 = j;
      if (AudioHelper.f()) {
        return bjlc.a(paramList, paramString, i);
      }
      ...
      localObject5 = new auzf(paramString, paramInt1, paramInt2, awje.r, 1, false, i);
      ((auzf)localObject5).b = true;
    }
    for (;;)
    {
      Object localObject3;
      try
      {
        ...
        localObject3 = new File(((auzf)localObject5).a);
        if (!((File)localObject3).exists()) {
          bace.c(((File)localObject3).getAbsolutePath());
        }
        localObject3 = new MediaMuxer(((auzf)localObject5).a, 0);
        ((MediaMuxer)localObject3).setOrientationHint(((auzf)localObject5).g);
  ...
  public ArrayList<Long> b(List<String> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      {
        localLinkedHashMap.put(localObject, Long.valueOf(avam.a((String)localObject)));
      }
    }
  ...
  public ArrayList<Long> b(List<String> paramList, String paramString)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      {
        paramString.put(localObject, Long.valueOf(avam.a((String)localObject)));
      }
    }
    paramList = new ArrayList();
