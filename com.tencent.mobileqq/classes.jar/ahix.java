...
public class ahix
{
  public static Bundle a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo)
  {
    ...
    for (;;)
    {
      ...
      {
        j = 5;
        localObject = bbcl.q(paramQQAppInterface, paramQQAppInterface.getCurrentAccountUin());
        paramSessionInfo = (SessionInfo)localObject;
        i = j;
  ...
  public static String a(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = ((ajxn)paramQQAppInterface.getManager(51)).e(str);
      ...
      catch (Exception paramSessionInfo)
      {
        try
        {
          do
          {
            ...
            paramSessionInfo.put("senderuin", akpy.c(paramMessageForQQWalletMsg));
            return paramSessionInfo;
            paramSessionInfo = paramSessionInfo;
          } while (!QLog.isDevelopLevel());
          paramSessionInfo.printStackTrace();
  ...
  public static boolean a(Context paramContext)
  {
    ...
    if (bawz.a(paramContext, 650.0F) < localDisplayMetrics.heightPixels) {}
