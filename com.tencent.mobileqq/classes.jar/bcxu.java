  ...
  implements bcxo
{
  ...
  public bcxu(bcxp parambcxp)
  {
    bcxm localbcxm = parambcxp.a;
    if (localbcxm != null) {
      localbcxm.setNetTransportEventListener("sig_check", this);
    }
    this.jdField_a_of_type_Bcxp = parambcxp;
  }
  
  public void a(bcxv parambcxv)
  {
    this.jdField_a_of_type_Bcxv = parambcxv;
  }
  ...
  public void a(Object paramObject1, Object paramObject2)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          {
            return;
          } while (this.jdField_a_of_type_Bcxp == null);
          paramObject1 = this.jdField_a_of_type_Bcxp.a;
    ...
    try
    {
      ...
      try
      {
        ...
        this.jdField_a_of_type_Bcxv.a(paramObject1.toString());
        return;
      }
  ...
  public void a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        l2 = l1;
        continue;
        localObject2 = this.jdField_a_of_type_Bcxp.a;
        if (localObject2 == null) {
          continue;
        }
        localObject1 = paramString.toByteArray();
        localObject4 = ((bcxm)localObject2).getCodec("sig_check");
        paramString = (String)localObject1;
        if (localObject4 != null) {
          paramString = ((bcxn)localObject4).encode(localObject1);
        }
        ((bcxm)localObject2).send(paramString);
        return;
      }
      try
      {
