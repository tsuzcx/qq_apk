...
public class agrs
  implements Runnable
{
  public agrs(RedTouchWebviewHandler paramRedTouchWebviewHandler, String paramString, long paramLong) {}
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouchWebviewHandler.mRuntime != null)
      {
        ...
        if (localObject1 != null) {
          ((Activity)localObject1).runOnUiThread(new agrt(this, (String)localObject4, localJSONObject1, (BusinessInfoCheckUpdate.AppInfo)localObject6, k, i, localArrayList, localObject7, localObject8));
        }
      }
      return;
      localObject1 = "";
