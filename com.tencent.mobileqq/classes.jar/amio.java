...
public class amio
{
  ...
  protected static String a(String paramString)
  {
    ...
    return paramString.replace("[client]", "androidQQ").replace("[version]", "8.4.8.4810").replace("[platformId]", "2").replace("[device]", Build.DEVICE).replace("[system]", Build.VERSION.RELEASE).replace("[systemInt]", Integer.toString(Build.VERSION.SDK_INT));
  }
  ...
  public static void a(String paramString)
  {
    ...
    {
      return;
      amip.ah = a(paramString);
    } while (!QLog.isColorLevel());
    QLog.d("ApolloConfigUtils", 2, "sApolloStoreUrl = " + amip.ah);
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject1 != null)
        {
          ...
          bfyz.j((Context)localObject2, Integer.parseInt(paramString));
          ...
          bfyz.k((Context)localObject2, Integer.parseInt((String)localObject3));
        }
      }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (i < paramString.length())
        {
          ...
          if (!a("8.4.8", ((JSONObject)localObject3).optString("minVersion"), ((JSONObject)localObject3).optString("maxVersion"))) {
            break label1466;
          }
        ...
        if (((JSONObject)localObject1).has("freqConfig"))
        {
          ...
          if (paramString != null)
          {
            ...
            if (oge.jdField_a_of_type_Int < i) {
              oge.jdField_a_of_type_Int = i;
            }
          }
        }
        ...
        if (((JSONObject)localObject1).has("gameConfig"))
        {
          ...
          if ((paramString != null) && (paramString.has("aio")))
          {
            ...
            if (!TextUtils.isEmpty((CharSequence)localObject1)) {
              amip.aD = (String)localObject1;
            }
            if (!TextUtils.isEmpty((CharSequence)localObject2)) {
              amip.aE = ((String)localObject2).trim();
            }
            if (!TextUtils.isEmpty((CharSequence)localObject3)) {
              amip.aF = ((String)localObject3).trim();
            }
          }
        }
        if (alnr.a.get()) {
        ...
        paramString = (alnr)paramQQAppInterface.getManager(153);
        alnr.a.set(true);
        paramString.h();
        return;
        label1466:
                          ...
                          do
                          {
                            do
                            {
                              do
                              {
                                ...
                                amip.ai = a(paramString2);
                              } while (!QLog.isColorLevel());
                              QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloStoreInteractUrl=", amip.ai });
                              return;
                            ...
                            amip.aj = a(paramString2);
                          } while (!QLog.isColorLevel());
                          QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloNewStoreUrl=", amip.aj });
                          return;
                          if (!"game_center".equals(paramString1)) {
                            break;
                          }
                        } while (TextUtils.isEmpty(paramString2));
                        amip.ak = a(paramString2);
                      } while (!QLog.isColorLevel());
                      QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloGameCenterUrl=", amip.ak });
                      return;
                      if (!"new_interact".equals(paramString1)) {
                        break;
                      }
                    } while (TextUtils.isEmpty(paramString2));
                    amip.al = a(paramString2);
                  } while (!QLog.isColorLevel());
                  QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloNewInteractUrl=", amip.al });
                  return;
                  if (!"game_city".equals(paramString1)) {
                    break;
                  }
                } while (TextUtils.isEmpty(paramString2));
                amip.am = a(paramString2);
              } while (!QLog.isColorLevel());
              QLog.d("ApolloConfigUtils", 2, new Object[] { "[handleConfigUrl] sApolloGameCityUrl=", amip.am });
              return;
              if ("apollo_drawer_game_box_lottie".equals(paramString1))
              {
                amip.ar = paramString2;
                return;
              }
      ...
      try
      {
        ...
        if (paramJSONObject != null)
        {
          ...
          if (i < paramJSONObject.length())
          {
            ...
            if (!a("8.4.8", localJSONObject.optString("minVersion"), localJSONObject.optString("maxVersion"))) {
              continue;
            }
      ...
      try
      {
        ...
        if (localJSONArray != null)
        {
          ...
          if (i < localJSONArray.length())
          {
            ...
            if (a("8.4.8", str1, str2))
            {
              if (!TextUtils.isEmpty((CharSequence)localObject2))
              {
                amip.at = (String)localObject2;
                amip.au = localJSONObject.optString("id");
                amip.av = amip.jdField_a_of_type_JavaLangString + "/script/" + amip.au + "/";
                if (paramBoolean)
                {
              ...
              if (QLog.isColorLevel())
              {
                QLog.d("ApolloConfigUtils", 2, new Object[] { "parseBaseScriptConfig: localversion target.url=" + (String)localObject2, ",scriptId:", amip.au, ",isUpdate:", Boolean.valueOf(paramBoolean) });
                localObject3 = localObject1;
              }
            }
            else
            {
              ...
              if (a("8.4.8", str1) < 0)
              {
                ...
                if (a((String)localObject1, str1) < 0)
                {
                  if (!TextUtils.isEmpty((CharSequence)localObject2))
                  {
                    amip.aw = (String)localObject2;
                    amip.ax = localJSONObject.optString("id");
                    amip.ay = amip.jdField_a_of_type_JavaLangString + "/script/" + amip.ax + "/";
                  }
                  if (QLog.isColorLevel()) {
                    QLog.d("ApolloConfigUtils", 2, "parseBaseScriptConfig: newestMinVersion=" + str1 + " target.url=" + (String)localObject2 + ", id=" + amip.ax);
                  }
                  localObject3 = str1;
                }
              }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localApolloPreDownloadData.resId = bjkf.b(localApolloPreDownloadData.url);
          ...
          if ((!TextUtils.isEmpty(localApolloPreDownloadData.minVer)) && (!TextUtils.isEmpty(localApolloPreDownloadData.maxVer)) && (!a("8.4.8", localApolloPreDownloadData.minVer, localApolloPreDownloadData.maxVer))) {
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        alvd.a(jdField_a_of_type_OrgJsonJSONArray);
        ...
        if (localJSONObject2 != null)
        {
          altm.a("aio.enter.bg", localJSONObject2.optString("entranceBkgUrl"));
          ...
          else
          {
            ...
            altm.a("aio.enter", paramQQAppInterface);
            altm.a("aio.enter.name", localJSONObject2.optString("entranceName"));
          }
        }
        else
        {
