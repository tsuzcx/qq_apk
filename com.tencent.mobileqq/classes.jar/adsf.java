...
import com.tencent.mobileqq.activity.ChatSettingForTroop.37.1;
...
public class adsf
  extends aofu
{
  public adsf(ChatSettingForTroop paramChatSettingForTroop) {}
  ...
  protected boolean a(ArrayList<TroopMemberCardInfo> paramArrayList)
  {
    ...
    if ((localObject == null) && (i < paramArrayList.size()))
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        if (bhbx.a(localTroopMemberCardInfo.troopuin, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin))
        {
          localObject = localTroopMemberCardInfo;
          if (bhbx.a(localTroopMemberCardInfo.memberuin, this.a.app.getCurrentAccountUin())) {}
        }
        else
        {
          localObject = null;
    ...
    if ((localObject != null) && (!bhbx.a(paramArrayList, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopCard)))
    {
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopColorNickId = localObject.colorNickId;
  ...
  protected void onGetMutilTroopInfoResult(boolean paramBoolean, ArrayList<TroopInfo> paramArrayList)
  {
    ...
    try
    {
      ...
      bglm.a(this.a.app, 0, l2, l1, 0L, "", 0, "OidbSvc.0x852_48", (short)23, false, false);
      return;
    }
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        ...
        if ((paramRspBody != null) && (paramRspBody.isShown())) {
          bhbu.a("Grp_game", "Grp_data", "rank_exp", 0, 0, new String[] { this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin });
        }
        paramRspBody = this.a.jdField_a_of_type_ArrayOfAndroidViewView[30];
      } while ((paramRspBody == null) || (!paramRspBody.isShown()));
      bhbu.a("Grp_game", "Grp_data", "feeds_exp", 0, 0, new String[] { this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin });
      return;
    }
  ...
  protected void onGetTroopInfoResult(boolean paramBoolean, String paramString)
  {
    ...
    do
    {
      ...
      {
        return;
      } while ((!paramBoolean) || (!bhbx.a(paramString, this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin)));
  ...
  {
    ThreadManager.post(new ChatSettingForTroop.37.1(this), 8, null, true);
  }
  ...
  protected void onModifyMemberGameCardSwitch(boolean paramBoolean, long paramLong1, long paramLong2, String paramString)
  {
    ...
    if (!paramBoolean)
    {
      ...
      QQToast.a(this.a, 1, anvx.a(2131697148), 0).b(this.a.getTitleBarHeight());
    }
  ...
  protected void onModifyTroopInfo(boolean paramBoolean, long paramLong, int paramInt, TroopInfo paramTroopInfo)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while (!bhbx.a(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin, String.valueOf(paramLong)));
        if (QLog.isColorLevel()) {
        ...
        if ((this.a.jdField_a_of_type_JavaUtilList != null) && (this.a.jdField_a_of_type_JavaUtilList.contains(Integer.valueOf(paramInt))))
        {
          ...
          if (paramBoolean)
          {
            this.a.jdField_a_of_type_Biso.a(1, this.a.getString(2131693285), 1000);
            return;
          }
          this.a.jdField_a_of_type_Biso.a(2, this.a.getString(2131693284), 1000);
  ...
  protected void onModifyTroopInfoResult(boolean paramBoolean, ArrayList<TroopMemberCardInfo> paramArrayList, String paramString)
  {
    ...
    do
    {
      ...
      for (bool = false;; bool = a(paramArrayList))
      {
        ...
        this.a.jdField_a_of_type_Biso.a(2, paramString, 1000);
        return;
      }
      if ((!paramBoolean) && ((this.a.b & 0x1) == 1))
      {
        ...
        this.a.jdField_a_of_type_Biso.b(2, 2131694030, 1000);
        return;
      }
    } while ((!bool) || ((this.a.b & 0x1) != 1));
    paramArrayList = this.a;
    paramArrayList.b &= 0xFFFFFFFE;
    this.a.jdField_a_of_type_Biso.b(1, 2131694031, 1000);
  }
  ...
  protected void onTroopFileRedDotForTimShow(boolean paramBoolean, String paramString)
  {
    if (paramBoolean)
    {
      this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.nNewFileMsgNum = bhdf.a(this.a.app.getCurrentAccountUin(), "troop_file_new", this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
  ...
  protected void onUpdateGameOnlineSwitchStatus(boolean paramBoolean1, String paramString, boolean paramBoolean2)
  {
    if (paramBoolean1) {
      if ((paramBoolean2) && (this.a.app != null)) {
        ((bgth)this.a.app.getManager(QQManagerFactory.TROOP_ONLINE_MEMBER_MANAGER)).a(this.a.jdField_a_of_type_ComTencentMobileqqTroopinfoTroopInfoData.troopUin);
      }
    }
    for (;;)
    {
      ...
      return;
      QQToast.a(BaseApplication.getContext(), 2131695849, 0).b(this.a.getTitleBarHeight());
    }
  }
}
