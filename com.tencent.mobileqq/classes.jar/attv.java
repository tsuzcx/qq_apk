  ...
  implements attu, Manager
{
  ...
  private attr[] jdField_a_of_type_ArrayOfAttr = new attr[jdField_a_of_type_JavaUtilSet.size()];
  ...
  public attv(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_Atmp = paramQQAppInterface.getEntityManagerFactory().createEntityManager();
    this.jdField_a_of_type_Attx = new attx(paramQQAppInterface, this);
    this.jdField_a_of_type_Attt = attt.a();
    this.jdField_a_of_type_Attw = new attw(this);
  ...
  private PrecoverRetryInfo a(PrecoverResource paramPrecoverResource)
  {
    ...
    try
    {
      paramPrecoverResource = this.jdField_a_of_type_Atmp.a(PrecoverRetryInfo.class, false, "pk = ?", new String[] { paramPrecoverResource.businessId + "_" + paramPrecoverResource.md5 }, null, null, null, null);
  ...
  private void a(atmo paramatmo)
  {
    ...
    label37:
    for (Object localObject = "null";; localObject = paramatmo)
    {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("PrecoverManager", 2, new Object[] { "insertEntity, entity.Name=", paramatmo.getClass().getSimpleName() });
    }
    localObject = this.jdField_a_of_type_Atmp.a();
    try
    {
      ((atmr)localObject).a();
    ...
    catch (Exception paramatmo)
    {
      if (QLog.isColorLevel())
      {
        QLog.d("PrecoverManager", 2, new Object[] { "insertEntity, exception=", paramatmo.getMessage() });
        paramatmo.printStackTrace();
      }
      return;
    }
    finally
  ...
  private boolean a(Class<? extends atmo> paramClass)
  {
    return a("delete_all", paramClass);
  }
  
  /* Error */
  private boolean a(String paramString, Class<? extends atmo> paramClass)
  {
    // Byte code:
    ...
    //   83: goto -70 -> 13
    //   86: aload_0
    //   87: getfield 82	attv:jdField_a_of_type_Atmp	Latmp;
    //   90: invokevirtual 241	atmp:a	()Latmr;
    //   93: astore_3
    //   94: aload_3
    //   95: invokevirtual 245	atmr:a	()V
    //   98: aload_2
    ...
    //   154: aload_0
    //   155: getfield 82	attv:jdField_a_of_type_Atmp	Latmp;
    //   158: aload_1
    //   159: invokevirtual 298	atmp:b	(Ljava/lang/String;)Z
    //   162: pop
    //   163: aload_3
    //   164: invokevirtual 250	atmr:c	()V
    //   167: aload_3
    //   168: invokevirtual 251	atmr:b	()V
    //   171: iconst_1
    //   172: ireturn
    //   173: ldc_w 300
    //   176: iconst_2
    ...
    //   229: aload_3
    //   230: invokevirtual 251	atmr:b	()V
    //   233: iconst_0
    //   234: ireturn
    //   235: astore_1
    //   236: aload_3
    //   237: invokevirtual 251	atmr:b	()V
    //   240: aload_1
    //   241: athrow
    ...
    //   0	242	2	paramClass	Class<? extends atmo>
  ...
  private boolean b()
  {
    ...
    int i = this.jdField_a_of_type_Attt.a;
    if (i == 2)
    {
      if (QLog.isColorLevel()) {
  ...
  public int a()
  {
    if (this.jdField_a_of_type_Attt != null) {
      return this.jdField_a_of_type_Attt.a;
    }
    return 0;
  }
  ...
  public attt a()
  {
    return this.jdField_a_of_type_Attt;
  }
  
  public attw a()
  {
    return this.jdField_a_of_type_Attw;
  }
  
  public attx a()
  {
    return this.jdField_a_of_type_Attx;
  }
  ...
  protected <T extends atmo> List<T> a(String paramString, String[] paramArrayOfString, Class<T> paramClass)
  {
    String str;
    if (QLog.isColorLevel())
    {
    ...
    {
      label123:
      paramString = this.jdField_a_of_type_Atmp.a(paramClass, false, paramString, paramArrayOfString, null, null, null, null);
      return paramString;
    }
  ...
  public void a(int paramInt, String paramString, PrecoverResource paramPrecoverResource, Object paramObject)
  {
    ...
    this.jdField_a_of_type_Attx.b(this);
  ...
  protected void a(PrecoverResource paramPrecoverResource)
  {
    ...
    paramPrecoverResource = this.jdField_a_of_type_Atmp.a();
    try
    {
      paramPrecoverResource.a();
      this.jdField_a_of_type_Atmp.b(localPrecoverRetryInfo);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (???.hasNext())
        {
          ...
          localObject5 = atub.a((String)((Pair)localObject4).second);
          if ((localObject5 == null) || (((Pair)localObject5).first == null) || (((Pair)localObject5).second == null)) {
            continue;
          }
          if (QLog.isColorLevel()) {
            QLog.d("PrecoverManager", 2, new Object[] { "onHandleConfigs, businessid=", ((atts)((Pair)localObject5).first).a, ", name=", ((atts)((Pair)localObject5).first).b, ", list.size=", Integer.valueOf(((List)((Pair)localObject5).second).size()) });
          }
          if (TextUtils.isEmpty(((atts)((Pair)localObject5).first).a)) {
            continue;
          }
          String str = ((atts)((Pair)localObject5).first).a;
  ...
  {
    boolean bool = atub.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + "_config_cover");
    if (QLog.isColorLevel()) {
      QLog.d("PrecoverManager", 2, new Object[] { "checkReportConfigCover, succ=", Boolean.valueOf(paramBoolean), ", need=", Boolean.valueOf(bool) });
    }
    if (bool)
    {
      atub.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin() + "_config_cover");
      this.jdField_a_of_type_Attw.a(paramBoolean);
    }
  }
  
  public boolean a()
  {
    boolean bool = atub.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "get_config_time");
    int j = atub.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "get_config_count", 0);
    if (bool)
    {
      atub.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp(), "get_config_time");
      atub.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "get_config_count", 1);
      return true;
    }
    if (a() != null) {}
    ...
    atub.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "get_config_count", j + 1);
    return true;
  }
  ...
  protected boolean a(PrecoverResource paramPrecoverResource)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (localPrecoverRetryInfo.totalRetryCount <= this.jdField_a_of_type_Attt.c) {
          break;
        }
      } while (!QLog.isColorLevel());
      ...
      if (localPrecoverRetryInfo.itemRetryCount < this.jdField_a_of_type_Attt.b)
      {
        localPrecoverRetryInfo.itemRetryCount += 1;
        localPrecoverRetryInfo.totalRetryCount += 1;
        localPrecoverRetryInfo.retryUpdateTime = l;
