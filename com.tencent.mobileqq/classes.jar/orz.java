...
public class orz
  implements Runnable
{
  public orz(QRDisplayActivity paramQRDisplayActivity) {}
  ...
  public void run()
  {
    ...
    if ((j >= 540) && (k >= 740))
    {
      ...
      if (this.a.jdField_a_of_type_AndroidGraphicsBitmap == null) {
        ThreadManager.post(new osa(this), 8, null, false);
      }
    ...
    for (;;)
    {
      ...
      QRUtils.a(this.a.app, this.a, str, i, (String)localObject1, (String)localObject2, new osb(this, str, i));
      continue;
      label606:
      ...
      this.a.findViewById(2131367491).setOnClickListener(this.a);
      if ((this.a.jdField_d_of_type_JavaLangString == null) || (this.a.jdField_e_of_type_JavaLangString == null) || (i == 0)) {
        break label851;
      }
      ((TextView)this.a.findViewById(2131367490)).setText(this.a.jdField_d_of_type_JavaLangString);
