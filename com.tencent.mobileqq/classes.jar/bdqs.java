  ...
  implements Handler.Callback, Manager
{
  ...
  awej<bdqp, QQAppInterface> jdField_a_of_type_Awej;
  bdqv jdField_a_of_type_Bdqv = new bdqt(this);
  ...
  public bdqs(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
    this.jdField_a_of_type_Awej = new bdqu(this);
    this.jdField_a_of_type_JavaUtilSet = Collections.synchronizedSet(new HashSet());
    this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager = paramQQAppInterface.a().createEntityManager();
    paramQQAppInterface.addObserver(this.jdField_a_of_type_Bdqv, true);
  }
  ...
  private void a(String paramString, int paramInt)
  {
    ...
    if ((bgnt.a()) && (a(paramString, localList))) {}
  ...
  private void a(boolean paramBoolean, String paramString, List<oidb_0xe61.BeancurdCubeInfoResult> paramList)
  {
    ...
    try
    {
      ...
      a(paramList, new bdql(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localafwx, this.jdField_a_of_type_Awej));
  ...
  protected List<TofuItem> a(String paramString, int paramInt)
  {
    ...
    ArrayList localArrayList = new ArrayList(bdqn.a.length);
    long l = System.currentTimeMillis() / 1000L;
    int i = 0;
    while (i < bdqn.a.length)
    {
      bdqm localbdqm = ((bdqp)this.jdField_a_of_type_Awej.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)).a(i);
      ...
      localTofuItem1 = localbdqm.a(localTofuItem1, l, paramInt);
  ...
  {
    // Byte code:
    //   0: invokestatic 250	java/lang/System:currentTimeMillis	()J
    //   3: lstore 4
    //   5: aload_0
    //   6: getfield 82	bdqs:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    ...
    //   44: checkcast 106	com/tencent/mobileqq/tofumsg/TofuItem
    //   47: astore 8
    //   49: aload_0
    //   50: aload_0
    //   51: getfield 82	bdqs:jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager	Lcom/tencent/mobileqq/persistence/EntityManager;
    //   54: aload 8
    //   56: invokespecial 346	bdqs:a	(Lcom/tencent/mobileqq/persistence/EntityManager;Lcom/tencent/mobileqq/persistence/Entity;)Z
    //   59: pop
    //   60: goto -33 -> 27
    //   63: astore 7
    //   65: ldc 136
    //   67: iconst_1
    //   68: new 222	java/lang/StringBuilder
    //   71: dup
    ...
    //   81: aload 7
    //   83: invokevirtual 282	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   86: invokevirtual 229	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   89: invokevirtual 236	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   92: aload 7
    //   94: invokestatic 285	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   97: aload 6
    //   99: invokevirtual 351	com/tencent/mobileqq/persistence/EntityTransaction:end	()V
    //   102: iload_3
    //   103: ifeq +25 -> 128
    //   106: aload_0
    //   107: getfield 31	bdqs:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   110: astore 6
    //   112: aload 6
    //   114: monitorenter
    //   115: aload_0
    //   116: getfield 31	bdqs:jdField_a_of_type_ComTencentCommonsdkCacheQQLruCache	Lcom/tencent/commonsdk/cache/QQLruCache;
    //   119: aload_1
    //   120: aload_2
    //   121: invokevirtual 270	com/tencent/commonsdk/cache/QQLruCache:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   124: pop
    //   125: aload 6
    //   127: monitorexit
    ...
    //   149: iconst_1
    //   150: aload_2
    //   151: invokeinterface 148 1 0
    //   156: invokestatic 154	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   159: aastore
    //   160: dup
    //   161: iconst_2
    //   162: invokestatic 250	java/lang/System:currentTimeMillis	()J
    //   165: lload 4
    //   167: lsub
    //   168: invokestatic 277	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   171: aastore
    //   172: dup
    //   173: iconst_3
    //   174: iload_3
    //   175: invokestatic 159	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   178: aastore
    //   179: invokestatic 165	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   182: invokestatic 169	com/tencent/qphone/base/util/QLog:i	(Ljava/lang/String;ILjava/lang/String;)V
    //   185: return
    //   186: aload 6
  ...
  protected boolean a(String paramString, List<TofuItem> paramList)
  {
    ...
    {
      TofuItem localTofuItem = (TofuItem)paramList.next();
      localArrayList.add(((bdqp)this.jdField_a_of_type_Awej.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)).a(localTofuItem.busId).a(localTofuItem));
    }
    ((bdqq)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(177)).a(paramString, localArrayList);
    return true;
  }
  ...
  protected boolean a(String paramString, List<oidb_0xe61.BeancurdCubeInfoResult> paramList, List<TofuItem> paramList1)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      int i = bdqn.b((int)((oidb_0xe61.BeancurdCubeInfo)localBeancurdCubeInfoResult.beancurdCubeInfo.get()).uint64_busi_id.get());
      if (i != -1)
      {
        ...
        bool = true;
        label145:
        ((bdqp)this.jdField_a_of_type_Awej.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)).a(i).a(paramList, localBeancurdCubeInfoResult, l);
      }
    }
    label180:
    label183:
  ...
  public void onDestroy()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Bdqv);
    this.jdField_a_of_type_AndroidOsHandler.removeCallbacksAndMessages(null);
    ((bdqp)this.jdField_a_of_type_Awej.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface)).a();
  }
}
