  ...
  extends bdom
{
  ...
  public bdqs(Collection<bdol> paramCollection)
  {
  ...
  {
    return agej.a(5.0F, paramResources);
  }
  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    int n = localResources.getDimensionPixelSize(2131298913);
    int i1 = localResources.getDimensionPixelSize(2131298914);
    int i = agej.a(5.0F, localResources);
    ...
    for (int k = 6;; k = 10)
    {
      ...
      if ((paramView != null) && ((paramView instanceof LinearLayout)))
      {
        ...
        if (j < k)
        {
          localObject2 = (bdol)((ArrayList)localObject1).get(j);
          ...
          localView = ((bdol)localObject2).a(paramContext, paramView.getChildAt(j), paramBundle);
          if (localView != null) {}
        }
        else
        {
      ...
      for (int j = a(paramContext, k) + i;; j = i)
      {
        ...
        i = j;
        break;
        m = agej.a(10.0F, localResources);
        LinearLayout.LayoutParams localLayoutParams = new LinearLayout.LayoutParams(-1, -2);
        if (j > 0) {
          localLayoutParams.topMargin = a(localResources, j, (bdol)localObject2);
        }
