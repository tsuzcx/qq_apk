...
public class ltt
  implements Handler.Callback, ltz
{
  public int a;
  public Handler a;
  ...
  public ltt(VideoAppInterface paramVideoAppInterface, AVActivity paramAVActivity)
  {
  ...
  {
    ViewGroup localViewGroup = (ViewGroup)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131365324);
    Object localObject1 = null;
    Object localObject2;
    View localView;
    if (localViewGroup != null)
    {
      localObject2 = (RedPacketGameView)localViewGroup.findViewById(2131372450);
      ...
      if (localObject2 == null)
      {
        ...
        localView = localViewGroup.findViewById(2131372417);
        if (localView == null) {
          break label128;
        }
      }
  ...
  {
    ViewGroup localViewGroup = (ViewGroup)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131365324);
    RedPacketGameView localRedPacketGameView = (RedPacketGameView)localViewGroup.findViewById(2131372450);
  ...
  public void a(int paramInt)
  {
    ...
    c();
    RedPacketGameView localRedPacketGameView = (RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131372450);
  ...
  public void a(int paramInt, lua paramlua)
  {
    if (QLog.isColorLevel()) {
    ...
    catch (Exception paramlua)
    {
      if (QLog.isColorLevel()) {
        QLog.d("AVRedPacketManager", 2, "AVRedPacketGameControl.preLoadRes  exception", paramlua);
      }
    }
  }
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    {
      return;
      localRedPacketGameView = (RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131372450);
  ...
  public boolean a()
  {
    Object localObject = (RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131372450);
  ...
  public void b()
  {
    ...
    ((RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131372450)).d();
  }
  ...
  public void b(AVRedPacketManager.LocalFrameSyncInfo paramLocalFrameSyncInfo)
  {
    ...
    ((RedPacketGameView)this.jdField_a_of_type_ComTencentAvUiAVActivity.findViewById(2131372450)).b(paramLocalFrameSyncInfo);
  }
