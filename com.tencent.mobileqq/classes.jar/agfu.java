...
public class agfu
  implements DialogInterface.OnDismissListener, AdapterView.OnItemClickListener, bknt
{
  ...
  public agfu(Activity paramActivity, WebView paramWebView)
  {
  ...
  public void a(int paramInt, String paramString, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if (paramInt == 1)
      {
        ...
        zvc.a(2, 2131691142);
        if ((this.h) && (!TextUtils.isEmpty(this.jdField_a_of_type_Abcr.p))) {
      ...
      for (;;)
      {
        ...
        if (paramInt == 11)
        {
          ...
          try
          {
            ...
            if (i != 0)
            {
              ...
              localObject1 = bita.b(paramString + 200 + (String)localObject3 + "jubao@article@123");
              ...
              oat.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1008, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
            }
          }
        ...
        else
        {
          if (paramInt == 2)
          {
            ...
            for (;;)
            {
              this.jdField_a_of_type_Abcr.g = bool1;
          ...
          if (paramInt == 4)
          {
            ...
            try
            {
              ...
              bcst.b(null, "P_CliOper", "VIPCOMIC", "", "0X800619F", "0X800619F", 1000, 0, nmj.b(str2, new String[0]), null, null, null);
              bcst.b(null, "P_CliOper", "Pb_account_lifeservice", "", "mp_msg_webview_48", "browser_share", 0, 1, 0, "", "", "", "");
              if ((str3 == null) || ("".equals(str3))) {
                continue;
              }
              oat.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1006, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
            }
          ...
          else if (paramInt != 5)
          {
            if (paramInt == 3)
            {
              ...
              tzo.a(1002, (String)localObject1, this.jdField_b_of_type_Int);
              if (!TextUtils.isEmpty(this.jdField_a_of_type_Abcr.p)) {
                this.jdField_a_of_type_Abcr.a((String)localObject4, 2, false);
              }
              for (;;)
              {
            ...
            if (paramInt == 6)
            {
              if (this.jdField_a_of_type_Abcr.a((String)localObject4)) {
                this.jdField_a_of_type_Abcr.a((String)localObject4, 9, false);
              }
              if ((str3 != null) && (!"".equals(str3))) {
                oat.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1007, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
              }
            }
            else if ((paramInt == 9) || (paramInt == 10))
            {
              ...
              if (paramInt == 9)
              {
                tzo.a(1003, (String)localObject1, this.jdField_b_of_type_Int);
              ...
              for (;;)
              {
                ...
                break;
                tzo.a(1004, (String)localObject1, this.jdField_b_of_type_Int);
                break label1289;
              ...
              {
                if (!TextUtils.isEmpty(this.jdField_a_of_type_Abcr.p)) {
                  this.jdField_a_of_type_Abcr.a((String)localObject4, 3, true);
                }
                for (;;)
                {
                  ...
                  oat.a(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005B07", "0X8005B07", 1003, 0, str3, str1, str2, AccountDetailActivity.a(str2), false);
                  break;
              ...
              if (!TextUtils.isEmpty(this.jdField_a_of_type_Abcr.p)) {
                this.jdField_a_of_type_Abcr.a((String)localObject4, 4, true);
              }
              for (;;)
              {
            ...
            {
              this.jdField_a_of_type_Abcr.a((String)localObject4, 5, true);
            }
            else if (paramInt == 15)
            {
              if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewFragment == null) {
              ...
              a().a(j, new agfv(this));
              bcst.b(null, "P_CliOper", "Grp_open", "", "third_app", "add_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 16)
            {
              ...
              this.jdField_a_of_type_AndroidAppActivity.startActivity(paramString);
              bcst.b(null, "P_CliOper", "Grp_open", "", "third_app", "detail_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 17)
            {
              paramString = "";
              ...
              paramBundle.putExtra("hide_more_button", true);
              this.jdField_a_of_type_AndroidAppActivity.startActivity(paramBundle);
              bcst.b(null, "P_CliOper", "Grp_open", "", "third_app", "share_menu", 0, 1, 0, "" + i, "" + j, "", "");
            }
            else if (paramInt == 7)
            {
              b();
            ...
            else if ((paramInt == 19) || (paramInt == 20))
            {
              ...
              for (i = 6;; i = 7)
              {
                ...
                this.jdField_a_of_type_Abcr.a((String)localObject4, i, false);
                break;
              }
              this.jdField_a_of_type_Abcr.a((String)localObject4, i, true);
            }
            else
            {
              if (paramInt == 12)
              {
                if (!TextUtils.isEmpty(this.jdField_a_of_type_Abcr.p)) {
                  this.jdField_a_of_type_Abcr.a((String)localObject4, 8, false);
                }
                for (;;)
                {
                  ...
                  oat.a(null, "", "0X800787A", "0X800787A", 0, 0, (String)localObject1, paramBundle, "", "");
                  tzo.a(1005, paramBundle, this.jdField_b_of_type_Int);
                  break;
                  this.jdField_a_of_type_Abcr.a((String)localObject4, 8, false);
                }
              }
              ...
              else if (paramInt == 35)
              {
                ...
                if (this.jdField_b_of_type_JavaUtilArrayList != null)
                {
                  ...
                  do
                  {
                    ...
                    paramString = (nzw)((Iterator)localObject2).next();
  ...
  public void a(abcr paramabcr)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_Long = this.jdField_a_of_type_Agfw.jdField_a_of_type_Long;
      a();
      c();
      ...
      this.jdField_a_of_type_ComTencentMobileqqUtilsShareActionSheetBuilder.setActionSheetTitle(BaseApplicationImpl.getApplication().getString(2131718027));
  ...
  public void a(String paramString)
  {
    ...
    {
      return;
      this.jdField_a_of_type_Agfw = new agfw();
      ...
      try
      {
        this.jdField_a_of_type_Agfw.jdField_a_of_type_Long = Long.parseLong(str, 10);
      ...
      catch (NumberFormatException localNumberFormatException2)
      {
        try
        {
          this.jdField_a_of_type_Agfw.jdField_b_of_type_Long = Long.parseLong(str, 10);
        ...
        catch (NumberFormatException localNumberFormatException2)
        {
          try
          {
            for (;;)
            {
              this.jdField_a_of_type_Agfw.c = Long.parseLong(str, 10);
              ...
              try
              {
                this.jdField_a_of_type_Agfw.d = Long.parseLong(paramString, 10);
                return;
              }
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      tzo.a(1001, paramString3, this.jdField_b_of_type_Int);
      if (!TextUtils.isEmpty(this.jdField_a_of_type_Abcr.p)) {
  ...
  public List<ShareActionSheetBuilder.ActionSheetItem>[] a()
  {
    ...
    for (Object localObject1 = BaseApplicationImpl.getApplication().getRuntime();; localObject1 = null)
    {
      if ((localObject1 != null) && (!TextUtils.isEmpty(((AppRuntime)localObject1).getAccount())) && (!tym.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:qq")) && ((this.jdField_a_of_type_Long & 0x8) == 0L))
      {
        ...
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695695);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839083;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695708);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839084;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
      ...
      if (((this.jdField_a_of_type_Long & 0x8000000) != 0L) && (bmqa.a()) && (!tym.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:kandian")) && (localObject1 != null))
      {
        ...
        {
          localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
          ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695709);
          ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839082;
          ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695715);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839087;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695698);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839081;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695712);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130839086;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695691);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130842607;
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695692);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130842603;
      ...
      if ((!tym.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:share:qiDian")) && ((this.jdField_a_of_type_Long & 0x10) == 0L)) {
        bjft.a(this.jdField_a_of_type_AndroidAppActivity, localArrayList);
      }
      ...
      {
        localObject2 = new ShareActionSheetBuilder.ActionSheetItem();
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).label = BaseApplicationImpl.getApplication().getString(2131695706);
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).iconNeedBg = true;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject2).icon = 2130844424;
      ...
      if ((this.jdField_e_of_type_Boolean) && (this.jdField_b_of_type_JavaUtilArrayList != null))
      {
        ...
        {
          localObject3 = (nzw)localIterator.next();
          ...
          case 2: 
            ...
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).label = BaseApplicationImpl.getApplication().getString(2131694650);
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).icon = 2130842601;
      ...
      if ((this.jdField_f_of_type_Boolean) && (this.jdField_b_of_type_JavaUtilArrayList != null))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          case 3: 
            localObject3 = new ShareActionSheetBuilder.ActionSheetItem();
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).label = BaseApplicationImpl.getApplication().getString(2131695696);
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).icon = 2130842610;
            ((ShareActionSheetBuilder.ActionSheetItem)localObject3).iconNeedBg = true;
      ...
      if ((localObject1 != null) && (!TextUtils.isEmpty(((AppRuntime)localObject1).getAccount())) && (!tym.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:favorite")) && ((this.jdField_a_of_type_Long & 0x2000) == 0L))
      {
        ...
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).icon = 2130844188;
      ...
      if ((!tym.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:setFont")) && (!this.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_Boolean))
      {
        ...
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).icon = 2130842605;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).iconNeedBg = true;
      ...
      if ((!tym.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:copyUrl")) && ((this.jdField_a_of_type_Long & 0x20) == 0L))
      {
        ...
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).icon = 2130839079;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).iconNeedBg = true;
      ...
      if ((!tym.a(this.jdField_a_of_type_JavaUtilArrayList, "menuItem:exposeArticle")) && (this.jdField_b_of_type_Boolean))
      {
        ...
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).icon = 2130842593;
        ((ShareActionSheetBuilder.ActionSheetItem)localObject1).iconNeedBg = true;
  ...
  public void b()
  {
    Object localObject = this.jdField_a_of_type_AndroidAppActivity.getLayoutInflater().inflate(2131559154, null);
    ...
    ArrayList localArrayList = new ArrayList();
    localArrayList.add(new bknx(anni.a(2131701223), TypedValue.applyDimension(1, 15.0F, anll.a)));
    localArrayList.add(new bknx(anni.a(2131701227), TypedValue.applyDimension(1, 16.0F, anll.a)));
    localArrayList.add(new bknx("", TypedValue.applyDimension(1, 17.0F, anll.a)));
    localArrayList.add(new bknx("", TypedValue.applyDimension(1, 17.0F, anll.a)));
    localArrayList.add(new bknx(anni.a(2131701226), TypedValue.applyDimension(1, 18.0F, anll.a)));
    ...
    localArrayList.add(BaseApplicationImpl.getApplication().getString(2131690967));
    localArrayList.add(BaseApplicationImpl.getApplication().getString(2131690968));
    localArrayList.add(BaseApplicationImpl.getApplication().getString(2131690969));
    localArrayList.add(BaseApplicationImpl.getApplication().getString(2131690970));
    localArrayList.add(BaseApplicationImpl.getApplication().getString(2131690971));
