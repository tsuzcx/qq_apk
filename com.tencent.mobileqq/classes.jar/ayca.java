  ...
  implements Handler.Callback, Manager
{
  ...
  public ayca(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_Aycb = new aycb(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    this.jdField_a_of_type_AndroidOsHandler = new Handler(ThreadManager.getSubThreadLooper(), this);
  }
  
  private void a(aybz paramaybz)
  {
    int i = this.jdField_a_of_type_Aycb.a(paramaybz);
  ...
  private void b(aybz paramaybz)
  {
    ThreadManager.post(new ScribbleDownloader.1(this, paramaybz), 5, null, false);
  }
  
  private void d()
  {
    if (this.jdField_a_of_type_Aycb.a() < 2)
    {
      aybz localaybz = this.jdField_a_of_type_Aycb.a();
      if (localaybz == null)
      {
  ...
  {
    int i = this.jdField_a_of_type_Aycb.a(paramMessageForScribble);
  ...
  public void a(MessageForScribble paramMessageForScribble)
  {
    ...
    if (a())
    {
      a(new aybz(paramMessageForScribble, 200));
      return;
    }
  ...
  public void b(MessageForScribble paramMessageForScribble)
  {
    ...
    a(new aybz(paramMessageForScribble, 201));
  }
