...
{
  public bfrs(HongBaoListView paramHongBaoListView) {}
      ...
      do
      {
        do
        {
          do
          {
            ...
            this.a.jdField_a_of_type_Auqw.a(this.a.e / 5, 300L);
            this.a.springBackTo(-this.a.e);
            if (this.a.jdField_a_of_type_Bfrt != null) {
              this.a.jdField_a_of_type_Bfrt.b(false);
            }
          ...
          } while (this.a.jdField_a_of_type_Bfrt == null);
          this.a.jdField_a_of_type_Bfrt.a(false);
          return false;
          this.a.setIsShowingPreguide(true);
          i = this.a.e / 2;
