...
public class bppn
{
  ...
  {
    if ((paramInt1 <= 0) || (paramInt2 <= 0) || (bgsp.a(paramString)))
    {
  ...
  public static bphj a(Context paramContext, @NonNull Drawable paramDrawable, @NonNull String paramString, int paramInt)
  {
    int i = afur.a(47.0F, paramContext.getResources());
    int k = afur.a(27.0F, paramContext.getResources());
    int m = afur.a(14.0F, paramContext.getResources());
    Paint localPaint = new Paint();
    localPaint.setTextSize(m);
    int j = (int)localPaint.measureText(paramString) + (afur.a(10.0F, paramContext.getResources()) + paramDrawable.getBounds().width() + afur.a(6.0F, paramContext.getResources())) + afur.a(8.0F, paramContext.getResources());
    if (j < i) {}
    for (;;)
    {
      paramContext = new bphj(i, k, -1, m, paramInt);
      yqp.b("DoodleUtil", "LayerParams:" + paramContext.toString());
      return paramContext;
      i = j;
    }
  }
  
  public static bphu a(bpix parambpix, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    return new bphu(paramFloat1, paramFloat2, paramFloat3, 0.0F, 0.0F, 0.0F, parambpix.jdField_a_of_type_AndroidGraphicsDrawableDrawable.getIntrinsicWidth(), parambpix.jdField_a_of_type_AndroidGraphicsDrawableDrawable.getIntrinsicHeight());
  }
  
  public static bphu a(bpnj parambpnj, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2)
  {
    if (!a(parambpnj)) {
      return null;
    }
    yqp.b("DoodleUtil", "item:" + parambpnj.toString());
    int i = 0;
    paramInt2 = 0;
    if (parambpnj.jdField_a_of_type_AndroidGraphicsDrawableDrawable != null)
    {
      i = parambpnj.jdField_a_of_type_AndroidGraphicsDrawableDrawable.getBounds().width();
      paramInt2 = parambpnj.jdField_a_of_type_AndroidGraphicsDrawableDrawable.getBounds().height();
    }
    float f2 = parambpnj.jdField_a_of_type_Bpnk.c;
    float f1 = parambpnj.jdField_a_of_type_Bpnk.d;
    float f3 = parambpnj.jdField_a_of_type_Bpnk.e;
    f2 = f2 * (paramInt1 / f3) / i;
    paramInt1 = (int)(parambpnj.jdField_a_of_type_Bpnk.b / f1 * paramInt2);
    parambpnj = new bphu(paramFloat1, paramFloat2, f2, 0.0F, 0.0F, 0.0F, i, paramInt2 + a(parambpnj.b, paramInt1, i) * 2 + 32, parambpnj.b, Color.parseColor(parambpnj.jdField_a_of_type_Bpnk.a), paramInt1);
    yqp.b("DoodleUtil", "LayerParams:" + parambpnj.toString());
    return parambpnj;
  }
  
  public static bphu a(bpnj parambpnj, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    if (!a(parambpnj)) {
      return null;
    }
    ...
    float f = parambpnj.jdField_a_of_type_Bpnk.c;
    f = parambpnj.jdField_a_of_type_Bpnk.d;
    paramFloat3 = paramInt1 * paramFloat3 / i;
    paramInt1 = (int)(parambpnj.jdField_a_of_type_Bpnk.b / f * paramInt2);
    parambpnj = new bphu(paramFloat1, paramFloat2, paramFloat3, 0.0F, 0.0F, 0.0F, i, paramInt2 + a(parambpnj.b, paramInt1, i) * 2 + 32, parambpnj.b, Color.parseColor(parambpnj.jdField_a_of_type_Bpnk.a), paramInt1);
    yqp.b("DoodleUtil", "LayerParams:" + parambpnj.toString());
    return parambpnj;
  }
  ...
  public static ArrayList<DynamicStickerData> a(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          localDynamicStickerData.mGifDecoder = new booa(localDynamicStickerData.path);
        ...
        localDynamicStickerData.mGifDecoder = new bonz(localDynamicStickerData.type, localDynamicStickerData.data);
        continue;
        if (!QLog.isColorLevel()) {
          break;
        }
  ...
  public static boolean a(bpnj parambpnj)
  {
    if (parambpnj == null)
    {
    ...
    if (TextUtils.isEmpty(parambpnj.e))
    {
    ...
    if (!parambpnj.a())
    {
      yqp.e("DoodleUtil", "parseJson error:" + parambpnj.e);
      return false;
    }
    if (parambpnj.jdField_a_of_type_Bpnk.b < 0)
    {
      yqp.e("DoodleUtil", "item textSize < 0. textSize:" + parambpnj.jdField_a_of_type_Bpnk.b);
      return false;
    }
    if ((parambpnj.jdField_a_of_type_Bpnk.c <= 0) || (parambpnj.jdField_a_of_type_Bpnk.d <= 0))
    {
      yqp.e("DoodleUtil", "item pictureWidth <= 0 or item pictureHeight <= 0. pictureWidth:" + parambpnj.jdField_a_of_type_Bpnk.c + ",pictureHeight:" + parambpnj.jdField_a_of_type_Bpnk.d);
      return false;
    }
    if ((parambpnj.jdField_a_of_type_Bpnk.e <= 0) || (parambpnj.jdField_a_of_type_Bpnk.f <= 0))
    {
      yqp.e("DoodleUtil", "item standardWidth <= 0 or item standardHeight <= 0. standardWidth:" + parambpnj.jdField_a_of_type_Bpnk.e + ",standardHeight:" + parambpnj.jdField_a_of_type_Bpnk.f);
      return false;
    }
    try
    {
      Color.parseColor(parambpnj.jdField_a_of_type_Bpnk.a);
      return true;
    }
    catch (Exception localException)
    {
      yqp.e("DoodleUtil", "item color is illegal:" + parambpnj.jdField_a_of_type_Bpnk.a);
