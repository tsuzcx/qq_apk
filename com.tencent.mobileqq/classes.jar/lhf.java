...
public class lhf
{
  ...
  private lhg jdField_a_of_type_Lhg;
  
  public lhf(VideoAppInterface paramVideoAppInterface)
  {
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface = paramVideoAppInterface;
    this.jdField_a_of_type_Lhg = new lhg(this);
    this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(this.jdField_a_of_type_Lhg);
  }
  ...
  private void a(Observable paramObservable, Object paramObject)
  {
    ...
    case 203: 
      ...
      {
        return;
        a(mtj.a(paramObservable, 1), 2, null);
        return;
  ...
  {
    if (((paramInt == 3) || (paramInt == 1)) && (!((liz)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(5)).a(3, paramInt, paramString))) {
      ((lhr)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(3)).a(paramInt, paramString);
    }
    return 0;
  }
  ...
  public int a(String paramString)
  {
    ...
    label660:
    label677:
    for (ljp localljp = localObject[0];; localljp = null)
    {
      if (localljp == null) {
        return 0;
      }
      ...
      for (String str2 = localObject[2];; str2 = null)
      {
        ...
        for (long l1 = AudioHelper.a(localObject[3]);; l1 = 0L)
        {
          ...
          int i;
          if (localljp.startsWith("EMPTY_ITEM"))
          {
            if (!ZimuToolbar.isSupport()) {
              break;
            }
            localljp = (ljp)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
            localObject = (ZimuItem)localljp.a();
            if ((localObject == null) || (TextUtils.isEmpty(((ZimuItem)localObject).getId()))) {
              break label660;
            }
            QLog.w("BusinessMessageCenter", 1, "onReceivedChangingZimuOfPeer, 对方取消字幕, info[" + paramString + "], sessionid[" + str1 + "], cmdSeq[" + str2 + "], seq[" + l3 + "], sendTime[" + l1 + "], offset[" + (l2 - l1) + "], isTranslation[" + localljp.c() + "], cur[" + ((ZimuItem)localObject).getId() + "]");
            paramString = (ljp)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
            paramString.a("onReceivedChangingZimuOfPeer", l3);
            new mcl(l3, "onReceivedChangingZimuOfPeer", 3, "0").a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
          ...
          for (;;)
          {
            ...
            localObject = (ljp)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(0);
            ZimuItem localZimuItem1 = (ZimuItem)((ljp)localObject).a(localljp);
            ZimuItem localZimuItem2 = (ZimuItem)((ljp)localObject).a();
            QLog.w("BusinessMessageCenter", 1, "onReceivedChangingZimuOfPeer, 对方选择字幕, info[" + paramString + "], zimuId[" + localljp + "], sessionid[" + str1 + "], cmdSeq[" + str2 + "], seq[" + l3 + "], sendTime[" + l1 + "], offset[" + (l2 - l1) + "], isTranslation[" + ((ljp)localObject).c() + "], ZimuItem[" + localZimuItem1 + "], CurItem[" + localZimuItem2 + "]");
            boolean bool;
            if (localZimuItem1 != null) {
              if (localZimuItem2 == null)
              {
                ...
                ((ljp)localObject).a("onReceivedChangingZimuOfPeer", false, l3, str1);
                ((ljp)localObject).a(l3, localljp);
                if (!localZimuItem1.isUsable()) {
                  ((ljp)localObject).a(l3, localZimuItem1);
                }
                new mcl(l3, "onReceivedChangingZimuOfPeer", 1, localljp).a(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface);
                if (localZimuItem2 != null) {
                  break label650;
                }
                i = 3;
  ...
  {
    lcg.c("BusinessMessageCenter", "notifyEvent :" + paramInteger + "|" + paramObject);
  ...
  public int b(int paramInt, String paramString)
  {
    ...
    do
    {
      ...
      {
        return 0;
      } while (((liz)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(5)).a(0, paramInt, paramString));
      a(paramString);
      return 0;
    } while (((liz)this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a(5)).a(0, paramInt, paramString));
    ...
    paramString = new lhc(this.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().a().d, str, str, 2);
    paramString.a = true;
