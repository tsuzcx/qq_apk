  ...
  extends alpd
{
  ...
  public amqn(QQAppInterface paramQQAppInterface)
  {
  ...
  {
    return BaseApplicationImpl.getApplication().getSharedPreferences("apollo_sp", 0).getLong("apollo_client_script_" + aliu.ax, 0L);
  }
  
  public static String a()
  {
    return "client_script_config_" + aliu.au;
  }
  
  public static void a(long paramLong)
  {
    BaseApplicationImpl.getApplication().getSharedPreferences("apollo_sp", 0).edit().putLong("apollo_client_script_" + aliu.ax, paramLong).commit();
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    if (paramQQAppInterface != null)
    {
      ...
      b(0L);
      amqn localamqn = (amqn)paramQQAppInterface.a(115);
      if (localamqn == null) {
        break label49;
      }
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    if (i == 0) {
      ((aknx)paramQQAppInterface.getManager(153)).a(true, "checkApolloPanelJsonVer : local ver==0", paramInt);
    }
    for (;;)
    {
  ...
  {
    return BaseApplicationImpl.getApplication().getSharedPreferences("apollo_sp", 0).getLong("apollo_client_script_" + aliu.au, 0L);
  }
  
  public static String b()
  {
    return "client_script_config_" + aliu.ax;
  }
  
  public static void b(long paramLong)
  {
    BaseApplicationImpl.getApplication().getSharedPreferences("apollo_sp", 0).edit().putLong("apollo_client_script_" + aliu.au, paramLong).commit();
    QLog.i("ApolloContentUpdateHandler", 1, "updateApolloBaseResVersion version: " + paramLong);
  }
  
  private static void b(QQAppInterface paramQQAppInterface)
  {
    aldv.a(paramQQAppInterface, aliu.av + "base.zip", aliu.at, null, new amqp());
  }
  ...
  protected ClubContentUpdateInfoPb.ReqAppInfo a()
  {
    ...
    if (i == 0)
    {
      ((aknx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(true, "login : local ver==0", 1);
      return null;
    }
    ((aknx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(false, "login : check action", 1);
  ...
  protected void a(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    if ((paramRspAppInfo.rpt_msg_rspiteminfo.has()) && (paramRspAppInfo.rpt_msg_rspiteminfo.size() > 0))
    {
      ...
      ((aknx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).a(true, "12h update...", 1);
    }
    for (;;)
    {
      ...
      try
      {
        ...
        ((aknx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).b();
      }
  ...
  public void a(ArrayList<ClubContentUpdateInfoPb.ReqAppInfo> paramArrayList)
  {
    ...
    if (paramArrayList == null)
    {
      ...
      if (aknx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApp()))
      {
        i = ((aknx)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(153)).b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
    ...
    for (;;)
    {
      ...
      break;
      if (arso.a(ApolloUtil.a)) {
        aknx.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
      }
  ...
  protected void b(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    {
      alfs.a(null, (AppInterface)localObject, i, bool);
  ...
  {
    if (!aknx.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
    {
  ...
  public ClubContentUpdateInfoPb.ReqAppInfo c()
  {
    ...
    Object localObject2 = new File(aliu.c, "/def/role/0/config.json");
    ...
    for (;;)
    {
      try
      {
        long l = new JSONObject(bdhb.a((File)localObject2)).optLong("version");
        ...
        localObject2 = new File(aliu.g);
        if ((((File)localObject2).exists()) && (((File)localObject2).isDirectory())) {
          ((File)localObject2).listFiles(new amqo(this, (SparseArray)localObject1));
        }
        localObject2 = new ArrayList();
        i = 0;
    ...
    if ((paramRspAppInfo.rpt_msg_rspiteminfo.has()) && (paramRspAppInfo.rpt_msg_rspiteminfo.size() > 0))
    {
      ...
      while (paramRspAppInfo.hasNext())
      {
        ...
        try
        {
          ...
          if ((k & 0x1) == 1) {
            aldv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getCurrentAccountUin(), null, i, null, -1, -1, true);
          }
  ...
  public void d(ClubContentUpdateInfoPb.RspAppInfo paramRspAppInfo)
  {
    ...
    for (;;)
    {
      localObject = aliu.av + "base.zip";
      Bundle localBundle;
      if ((1 == (j & 0x1)) || (bool))
      {
        localBundle = new Bundle();
        localBundle.putLong("version", i);
        aldv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, aliu.at, localBundle, new amqp());
      }
      ...
      if ((((File)localObject).list() == null) || (((File)localObject).list().length == 0))
      {
        ...
        for (;;)
        {
          localObject = aliu.ay + "base.zip";
          if ((1 == (j & 0x1)) || (bool))
          {
            localBundle = new Bundle();
            localBundle.putLong("version", i);
            aldv.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject, aliu.aw, localBundle, new amqq());
          }
