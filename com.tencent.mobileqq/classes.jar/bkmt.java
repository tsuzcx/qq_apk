...
public class bkmt
{
  ...
  public bkmt(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
  }
  
  private void a(Activity paramActivity, int paramInt, String paramString, yxq paramyxq)
  {
    if (paramActivity == null) {
      return;
    }
    String str = amtj.a(2131709811);
    if (1 == paramInt) {
      paramString = str + amtj.a(2131709814) + paramString + amtj.a(2131709809);
    }
    for (;;)
    {
      bfur.a(paramActivity, 230, paramActivity.getString(2131697774), paramString, 2131697768, 2131697768, new bknc(this, paramyxq), null).show();
      return;
      if (2 == paramInt) {
        paramString = str + amtj.a(2131709813) + paramString + amtj.a(2131709808);
      } else {
        paramString = amtj.a(2131709810);
      }
    }
  }
  ...
  public static void a(Context paramContext, int paramInt, Bundle paramBundle)
  {
    if (paramContext == null)
    {
      ...
      Toast.makeText(BaseApplication.getContext(), amtj.a(2131709812), 0).show();
      return;
    }
    ...
    if ((paramContext instanceof zzt)) {
  ...
  private void h()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 161	bkmt:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnull +6 -> 14
    //   11: aload_0
    ...
    //   30: putfield 161	bkmt:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   33: aload_0
    //   34: getfield 161	bkmt:jdField_a_of_type_JavaUtilTimer	Ljava/util/Timer;
    //   37: new 170	cooperation/qlink/QQProxyForQlink$9
    //   40: dup
    //   41: aload_0
    //   42: invokespecial 172	cooperation/qlink/QQProxyForQlink$9:<init>	(Lbkmt;)V
    //   45: lconst_0
    //   46: ldc2_w 173
  ...
  private void j()
  {
    ...
    {
      this.jdField_b_of_type_AndroidContentBroadcastReceiver = new bkmu(this);
  ...
  private void l()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 223	bkmt:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   8: ifnonnull +58 -> 66
    //   11: aload_0
    //   12: new 225	bkmv
    //   15: dup
    //   16: aload_0
    //   17: invokespecial 226	bkmv:<init>	(Lbkmt;)V
    //   20: putfield 223	bkmt:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   37: aload_0
    //   38: getfield 28	bkmt:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   41: ifnull +11 -> 52
    //   44: aload_0
    //   45: getfield 28	bkmt:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   56: aload_1
    //   57: aload_0
    //   58: getfield 223	bkmt:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   61: aload_2
    ...
    //   77: aload_0
    //   78: aconst_null
    //   79: putfield 223	bkmt:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   82: goto -16 -> 66
    //   85: astore_1
    //   86: aload_0
    //   87: monitorexit
  ...
  private void m()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 223	bkmt:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   6: ifnull +28 -> 34
    //   9: aload_0
    //   10: getfield 28	bkmt:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   13: ifnull +13 -> 26
    //   16: aload_0
    //   17: getfield 28	bkmt:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    //   44: aload_0
    //   45: getfield 223	bkmt:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    ...
    //   51: aload_0
    //   52: aconst_null
    //   53: putfield 223	bkmt:jdField_a_of_type_AndroidContentBroadcastReceiver	Landroid/content/BroadcastReceiver;
    //   56: goto -22 -> 34
    //   59: astore_1
    //   60: aload_0
    //   61: monitorexit
  ...
  public void a(Activity paramActivity, DialogInterface.OnClickListener paramOnClickListener1, DialogInterface.OnClickListener paramOnClickListener2, DialogInterface.OnClickListener paramOnClickListener3, String paramString)
  {
    ...
    for (;;)
    {
      ...
      {
        a("0X8004854", 1);
        paramOnClickListener3 = paramActivity.getResources().getString(2131697814) + str1 + paramActivity.getResources().getString(2131697815);
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bfur.a(paramActivity, 230, paramActivity.getResources().getString(2131697775), paramOnClickListener3, paramActivity.getResources().getString(2131697816), paramActivity.getResources().getString(2131697816), paramOnClickListener2, null);
          label194:
      ...
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setOnDismissListener(new bkmz(this));
        return;
        label224:
        str1 = this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerUin;
        break;
        this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bfur.a(paramActivity, 230, paramActivity.getResources().getString(2131697775), paramOnClickListener3, paramActivity.getResources().getString(2131697816), paramActivity.getResources().getString(2131697817), paramOnClickListener1, paramOnClickListener2);
        break label194;
        if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mMode == 2)
        {
          a("0X8004856", 1);
          paramOnClickListener1 = str1 + paramActivity.getResources().getString(2131697813);
          this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = bfur.a(paramActivity, 230, paramActivity.getResources().getString(2131697775), paramOnClickListener1, paramActivity.getResources().getString(2131697812), paramActivity.getResources().getString(2131697812), paramOnClickListener3, null);
          this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.show();
        }
  ...
  public void a(Activity paramActivity, ArrayList<String> paramArrayList, int paramInt1, int paramInt2, boolean paramBoolean, String paramString)
  {
    ...
    paramActivity.finish();
    return;
    a(paramActivity, new bkmw(this, paramArrayList, paramActivity, paramInt1, paramBoolean), new bkmx(this), new bkmy(this), paramString);
  }
  ...
  public void a(QlAndQQInterface.InsertFMFileInfo paramInsertFMFileInfo)
  {
    ...
    String str = aszt.a(paramInsertFMFileInfo.filePath);
    long l1 = aszt.a(paramInsertFMFileInfo.filePath);
    long l2 = bbli.a(-1000).uniseq;
    ...
    localFileManagerEntity.nFileType = aszt.a(paramInsertFMFileInfo.filePath);
    ...
    if (localamsw.e(String.valueOf(localFileManagerEntity.peerUin)) != null)
    {
      localFileManagerEntity.peerType = 0;
      localFileManagerEntity.peerNick = aszt.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramInsertFMFileInfo.uin, null, 0);
      localFileManagerEntity.status = 1;
      if ((!localamsw.b(paramInsertFMFileInfo.uin)) && (!paramInsertFMFileInfo.bSend)) {
        break label356;
      }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    bcef.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", paramString, paramString, 0, paramInt, 0, "", "", "", "");
  }
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean, long paramLong1, long paramLong2, HashMap<String, String> paramHashMap)
  {
    ...
    bknh.a(paramString1, paramString2, paramBoolean, paramLong1, paramLong2, paramHashMap);
  }
  
  public void a(AppActivity paramAppActivity, String paramString, yxq paramyxq)
  {
    if ((paramAppActivity == null) || (paramString == null)) {
      return;
    }
    bkng localbkng = bknf.a(paramString);
    if (localbkng == null)
    {
      bfur.a(paramAppActivity, 230, paramAppActivity.getString(2131697774), paramAppActivity.getString(2131697794), 2131697768, 2131697768, new bkna(this, paramyxq), null).show();
      return;
    }
    if (this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mWorking)
    {
      a(paramAppActivity, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mMode, this.jdField_a_of_type_CooperationQlinkQlAndQQInterface$WorkState.mPeerNick, paramyxq);
      return;
    }
    ...
    paramyxq = new Bundle();
    paramyxq.putString("url", paramString);
    paramyxq.putString("key", localbkng.a);
    paramyxq.putString("peerUin", localbkng.b);
    paramyxq.putString("peerNick", localbkng.c);
    paramyxq.putString("peerOS", localbkng.d);
    paramyxq.putString("apSSID", localbkng.e);
    paramyxq.putString("preSharedKey", localbkng.f);
    paramyxq.putBoolean("fromqlink", bool);
    paramString = paramAppActivity.getIntent().getStringExtra("subfrom");
    if (paramString != null) {
      paramyxq.putString("subfrom", paramString);
    }
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getQQProxyForQlink();
    a(paramAppActivity, 11, paramyxq);
    paramAppActivity.finish();
  }
  
  public void a(AppActivity paramAppActivity, yxq paramyxq)
  {
    if (paramAppActivity == null) {
      return;
    }
    bfur.a(paramAppActivity, 230, paramAppActivity.getString(2131697792), paramAppActivity.getString(2131697793), 2131697768, 2131697768, new bknb(this, paramyxq), null).show();
  }
  ...
  public boolean a(String paramString, List<String> paramList)
  {
    ...
    while (paramString.hasNext())
    {
      ...
      localSendFileInfo.sessionid = aszt.a().longValue();
      localSendFileInfo.filePath = paramList;
      localSendFileInfo.fileSize = aszt.a(paramList);
  ...
  {
    if (1 == paramInt) {
      aszt.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getApplicationContext());
    }
  }
