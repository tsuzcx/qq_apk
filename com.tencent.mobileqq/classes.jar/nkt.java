  ...
  extends ajtb
{
  ...
  private nkv jdField_a_of_type_Nkv;
  
  public nkt(QQAppInterface paramQQAppInterface)
  {
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_Nkv = new nku(this);
    this.mApp.addObserver(this.jdField_a_of_type_Nkv);
  ...
  {
    super.onDestroy();
    this.mApp.removeObserver(this.jdField_a_of_type_Nkv);
  }
