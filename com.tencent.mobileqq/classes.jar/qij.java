...
public class qij
{
      ...
      try
      {
        ...
        else
        {
          ...
          if (paramArticleSummary.msg_video_data.has())
          {
            ...
            localObject2 = new psc();
            localWeiShiVideoArticleInfo.videoData = ((psc)localObject2);
            if (((Readinjoy.VideoData)localObject1).uint32_busi_type.has()) {
              ((psc)localObject2).jdField_a_of_type_Int = ((Readinjoy.VideoData)localObject1).uint32_busi_type.get();
            }
            if (((Readinjoy.VideoData)localObject1).uint32_duration.has()) {
              ((psc)localObject2).jdField_b_of_type_Int = ((Readinjoy.VideoData)localObject1).uint32_duration.get();
            }
            if (((Readinjoy.VideoData)localObject1).uint32_width.has()) {
              ((psc)localObject2).c = ((Readinjoy.VideoData)localObject1).uint32_width.get();
            }
            if (((Readinjoy.VideoData)localObject1).uint32_height.has()) {
              ((psc)localObject2).d = ((Readinjoy.VideoData)localObject1).uint32_height.get();
            }
            if (((Readinjoy.VideoData)localObject1).bytes_vid.has()) {
              ((psc)localObject2).jdField_a_of_type_JavaLangString = ((Readinjoy.VideoData)localObject1).bytes_vid.get().toStringUtf8();
            }
            if (((Readinjoy.VideoData)localObject1).uint32_file_size.has()) {
              ((psc)localObject2).e = ((Readinjoy.VideoData)localObject1).uint32_file_size.get();
            }
            if (((Readinjoy.VideoData)localObject1).bytes_video_url.has()) {
              ((psc)localObject2).jdField_b_of_type_JavaLangString = ((Readinjoy.VideoData)localObject1).bytes_video_url.get().toStringUtf8();
            }
          }
  ...
  public static WeiShiVideoArticleInfo a(oidb_cmd0xbed.ArticleSummary paramArticleSummary, int paramInt1, int paramInt2)
  {
    ...
    if (paramArticleSummary != null)
    {
      ...
      for (;;)
      {
          ...
          else
          {
            ...
            if (paramArticleSummary.msg_video_data.has())
            {
              ...
              if (((oidb_cmd0xbed.VideoData)localObject1).uint32_busi_type.has()) {
                ((psc)localObject2).jdField_a_of_type_Int = ((oidb_cmd0xbed.VideoData)localObject1).uint32_busi_type.get();
              }
              if (((oidb_cmd0xbed.VideoData)localObject1).uint32_duration.has()) {
                ((psc)localObject2).jdField_b_of_type_Int = ((oidb_cmd0xbed.VideoData)localObject1).uint32_duration.get();
              }
              if (((oidb_cmd0xbed.VideoData)localObject1).uint32_width.has()) {
                ((psc)localObject2).c = ((oidb_cmd0xbed.VideoData)localObject1).uint32_width.get();
              }
              if (((oidb_cmd0xbed.VideoData)localObject1).uint32_height.has()) {
                ((psc)localObject2).d = ((oidb_cmd0xbed.VideoData)localObject1).uint32_height.get();
              }
              if (((oidb_cmd0xbed.VideoData)localObject1).bytes_vid.has()) {
                ((psc)localObject2).jdField_a_of_type_JavaLangString = ((oidb_cmd0xbed.VideoData)localObject1).bytes_vid.get().toStringUtf8();
              }
              if (((oidb_cmd0xbed.VideoData)localObject1).uint32_file_size.has()) {
                ((psc)localObject2).e = ((oidb_cmd0xbed.VideoData)localObject1).uint32_file_size.get();
              }
              if (((oidb_cmd0xbed.VideoData)localObject1).bytes_video_url.has()) {
                ((psc)localObject2).jdField_b_of_type_JavaLangString = ((oidb_cmd0xbed.VideoData)localObject1).bytes_video_url.get().toStringUtf8();
              }
            }
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.e("VideoProtoHelper", 0, "cmd0xbedToWeiShiVideoArticleInfo error:" + obz.a(paramArticleSummary));
          }
        }
        bool = false;
      }
  ...
  public static Readinjoy.ArticleSummary a(BaseVideoArticleInfo paramBaseVideoArticleInfo)
  {
    ...
    for (;;)
    {
      ...
      catch (Throwable paramBaseVideoArticleInfo)
      {
        ...
        QLog.e("VideoProtoHelper", 0, "videoArticleinfoCovert2LocalPB error:" + obz.a(paramBaseVideoArticleInfo));
      }
  ...
  public static Readinjoy.VideoData a(psc parampsc)
  {
    Object localObject;
    if (parampsc == null) {
      localObject = null;
    ...
    do
    {
      ...
      localVideoData.uint32_busi_type.set(parampsc.jdField_a_of_type_Int);
      localVideoData.uint32_duration.set(parampsc.jdField_b_of_type_Int);
      localVideoData.uint32_width.set(parampsc.c);
      localVideoData.uint32_height.set(parampsc.d);
      if (!TextUtils.isEmpty(parampsc.jdField_a_of_type_JavaLangString)) {
        localVideoData.bytes_vid.set(ByteStringMicro.copyFromUtf8(parampsc.jdField_a_of_type_JavaLangString));
      }
      localVideoData.uint32_file_size.set(parampsc.e);
      localObject = localVideoData;
    } while (TextUtils.isEmpty(parampsc.jdField_b_of_type_JavaLangString));
    localVideoData.bytes_video_url.set(ByteStringMicro.copyFromUtf8(parampsc.jdField_b_of_type_JavaLangString));
    return localVideoData;
  }
  
  public static psc a(Readinjoy.VideoData paramVideoData)
  {
    ...
    do
    {
      ...
      if (paramVideoData.uint32_busi_type.has()) {
        localpsc.jdField_a_of_type_Int = paramVideoData.uint32_busi_type.get();
      }
      if (paramVideoData.uint32_duration.has()) {
        localpsc.jdField_b_of_type_Int = paramVideoData.uint32_duration.get();
      }
      if (paramVideoData.uint32_width.has()) {
        localpsc.c = paramVideoData.uint32_width.get();
      }
      if (paramVideoData.uint32_height.has()) {
        localpsc.d = paramVideoData.uint32_height.get();
      }
      if (paramVideoData.bytes_vid.has()) {
        localpsc.jdField_a_of_type_JavaLangString = paramVideoData.bytes_vid.get().toStringUtf8();
      }
      if (paramVideoData.uint32_file_size.has()) {
        localpsc.e = paramVideoData.uint32_file_size.get();
      }
      localObject = localpsc;
    } while (!paramVideoData.bytes_video_url.has());
    localpsc.jdField_b_of_type_JavaLangString = paramVideoData.bytes_video_url.get().toStringUtf8();
    return localpsc;
  }
}
