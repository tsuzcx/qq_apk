  ...
  extends ahex
{
  ...
  public bcig(QQAppInterface paramQQAppInterface, Context paramContext, XListView paramXListView, ahfa paramahfa, String paramString, boolean paramBoolean, TextView paramTextView, View paramView)
  {
  ...
  protected ahes a()
  {
    return new bcif(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, true);
  }
  ...
  {
    ((amdu)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(20)).a(this.jdField_a_of_type_Long, this.jdField_a_of_type_Int, 25);
  }
