...
public class alem
{
  ...
  public static int a(QQAppInterface paramQQAppInterface)
  {
    ...
    {
      paramQQAppInterface = bfza.a(localSharedPreferences, "special_sound" + paramQQAppInterface.getCurrentAccountUin(), null);
  ...
  public static void a(QQAppInterface paramQQAppInterface)
  {
    ...
    Object localObject = bfza.a(paramQQAppInterface.getApp().getSharedPreferences("com.tencent.mobileqq_preferences", 4), "special_sound" + paramQQAppInterface.getCurrentAccountUin(), null);
    if (localObject != null)
    {
  ...
  public static void a(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      localObject2 = bfza.a((SharedPreferences)localObject1, "special_sound" + paramQQAppInterface.getCurrentAccountUin(), null);
      ...
      bfza.a(localEditor, "special_sound" + paramQQAppInterface.getCurrentAccountUin(), paramString).commit();
      return;
    }
  }
  ...
  {
    paramQQAppInterface = (amzm)paramQQAppInterface.getBusinessHandler(15);
    if (paramQQAppInterface != null) {
  ...
  public static void a(List<String> paramList, QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        localObject1 = bfza.a((SharedPreferences)localObject1, "special_sound" + paramQQAppInterface.getCurrentAccountUin(), null);
      ...
      bfza.a(localEditor, "special_sound" + paramQQAppInterface.getCurrentAccountUin(), paramList).commit();
      return;
    }
  }
  ...
  public static void b(String paramString, QQAppInterface paramQQAppInterface)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      localObject2 = bfza.a((SharedPreferences)localObject2, "special_sound" + paramQQAppInterface.getCurrentAccountUin(), null);
      if (localObject2 != null)
      {
