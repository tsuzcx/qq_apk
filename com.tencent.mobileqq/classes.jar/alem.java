  ...
  implements alel
{
  ...
  public static alel a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.tencent.mobileqq.ar.aidl.IArMiniCallback");
    if ((localIInterface != null) && ((localIInterface instanceof alel))) {
      return (alel)localIInterface;
    }
    return new alen(paramIBinder);
  }
