  ...
  implements Manager
{
  ...
  private aypr jdField_a_of_type_Aypr = new aypp(this);
  ...
  private ArrayList<WeakReference<aypq>> jdField_a_of_type_JavaUtilArrayList;
  private List<Integer> jdField_a_of_type_JavaUtilList;
  
  public aypo(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = paramQQAppInterface;
    paramQQAppInterface.registObserver(this.jdField_a_of_type_Aypr);
  ...
  private Pair<Boolean, List<Integer>> a(List<Integer> paramList)
  {
    ...
    List localList = ((aqqh)aqlk.a().a(652)).a.a(false);
    if (localList.size() <= 0)
    {
      localArrayList.addAll(paramList);
      return new Pair(Boolean.valueOf(false), localArrayList);
    ...
    if (paramList.hasNext())
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        if (localInteger.intValue() != localaysb.a) {
          break label208;
        }
  ...
  private void a()
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        Object localObject1 = bgjb.a(BaseApplication.getContext(), "smart_selected_list" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
  ...
  /* Error */
  private void a(aypq paramaypq)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 42	aypo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   6: invokevirtual 219	java/util/ArrayList:iterator	()Ljava/util/Iterator;
    //   9: astore_2
    //   10: aload_2
    ...
    //   25: checkcast 221	mqq/util/WeakReference
    //   28: astore_3
    //   29: aload_3
    ...
    //   71: return
    //   72: aload_0
    //   73: getfield 42	aypo:jdField_a_of_type_JavaUtilArrayList	Ljava/util/ArrayList;
    //   76: new 221	mqq/util/WeakReference
    //   79: dup
    //   80: aload_1
  ...
  private void b()
  {
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = (aypq)((WeakReference)localObject2).get();
          ((aypq)localObject2).a(this.jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusFriendsPermissionItem, a());
          if (QLog.isColorLevel()) {
  ...
  private boolean c(List<Integer> paramList)
  {
    if (paramList.size() == 0)
    {
      bgjb.a(BaseApplication.getContext(), "smart_selected_list" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c());
      return true;
    }
    ...
    bgjb.a(BaseApplication.getContext(), "smart_selected_list" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c(), localStringBuilder.toString());
    return true;
  }
  
  /* Error */
  @android.support.annotation.Nullable
  public OnlineStatusFriendsPermissionItem a(long paramLong, boolean paramBoolean, aypq paramaypq)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   23: iconst_1
    //   24: lload_1
    //   25: invokestatic 286	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   28: aastore
    //   29: dup
    //   30: iconst_2
    //   31: ldc_w 288
    ...
    //   36: iconst_3
    //   37: aload_0
    //   38: getfield 22	aypo:jdField_a_of_type_Int	I
    ...
    //   61: aload_0
    //   62: getfield 52	aypo:jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusFriendsPermissionItem	Lcom/tencent/mobileqq/onlinestatus/OnlineStatusFriendsPermissionItem;
    //   65: ifnull +14 -> 79
    //   68: aload_0
    //   69: getfield 52	aypo:jdField_a_of_type_ComTencentMobileqqOnlinestatusOnlineStatusFriendsPermissionItem	Lcom/tencent/mobileqq/onlinestatus/OnlineStatusFriendsPermissionItem;
    //   72: astore 4
    //   74: aload_0
    //   75: monitorexit
    //   76: aload 4
    ...
    //   106: aload_0
    //   107: aload 4
    //   109: invokespecial 294	aypo:a	(Laypq;)V
    //   112: iload_3
    //   113: ifeq +9 -> 122
    //   116: aload_0
    //   117: lload_1
    //   118: iconst_0
    //   119: invokevirtual 297	aypo:a	(JZ)V
    //   122: aconst_null
    //   123: astore 4
    //   125: goto -51 -> 74
    //   128: astore 4
  ...
  {
    ayps.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramLong, paramBoolean, false);
  }
  ...
  public boolean a()
  {
    return !TextUtils.isEmpty(bgjb.a(BaseApplication.getContext(), "smart_selected_list" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.c()));
  }
  
  public boolean a(OnlineStatusPermissionChecker.OnlineStatusPermissionItem paramOnlineStatusPermissionItem, aypq paramaypq)
  {
    ...
    do
    {
      ...
      {
        return false;
        paramaypq = a(40001L, false, paramaypq);
        if (paramaypq != null) {
          break;
        }
      ...
      return false;
      if (paramaypq.allHasPermission != paramOnlineStatusPermissionItem.isAllHasPermission())
      {
        if (QLog.isColorLevel()) {
          QLog.d("OnlineStatusPermissionManager", 2, new Object[] { " hasPermissionChange entity.allHasPermission=", Boolean.valueOf(paramaypq.allHasPermission), " item.isAllHasPermission=", paramOnlineStatusPermissionItem.getPermissionUins() });
        }
        return true;
      }
      if (paramaypq.permissionUins.size() != paramOnlineStatusPermissionItem.getPermissionUins().size())
      {
        if (QLog.isColorLevel()) {
          QLog.d("OnlineStatusPermissionManager", 2, new Object[] { " hasPermissionChange entity.size=", Integer.valueOf(paramaypq.permissionUins.size()), " item.size=", Integer.valueOf(paramOnlineStatusPermissionItem.getPermissionUins().size()) });
        }
        return true;
      }
    } while (paramaypq.permissionUins.containsAll(paramOnlineStatusPermissionItem.getPermissionUins()));
    if (QLog.isColorLevel()) {
  ...
  public boolean a(ArrayList<aypi> paramArrayList)
  {
    ...
    for (;;)
    {
      ...
      {
        aypi localaypi = (aypi)paramArrayList.next();
        Iterator localIterator = localList.iterator();
        ...
        } while (localaypi.a != localInteger.intValue());
      }
      for (int i = 1; i == 0; i = 0)
      {
        return true;
