...
public class asfs
  extends BaseAdapter
{
  public asfs(LangSettingFragment paramLangSettingFragment) {}
  
  private View.OnClickListener a(int paramInt)
  {
    return new asft(this, paramInt);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramInt == LangSettingFragment.a(this.a)) {
      paramView.setRightIcon(this.a.getResources().getDrawable(2130844319));
    }
    for (;;)
    {
