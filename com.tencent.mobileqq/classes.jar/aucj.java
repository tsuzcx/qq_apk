  ...
  implements auca
{
  ...
  public aucj(QQAppInterface paramQQAppInterface) {}
  ...
  public static String b(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    if ((paramMsgBackupResEntity != null) && (!TextUtils.isEmpty(paramMsgBackupResEntity.extraDataStr))) {
      try
      {
        paramMessageRecord = aufh.b(new JSONObject(paramMsgBackupResEntity.extraDataStr).optString("uuid"));
  ...
  public aucn a(MessageRecord paramMessageRecord, MsgBackupResEntity paramMsgBackupResEntity)
  {
    ...
    localaucn.jdField_a_of_type_JavaLangString = a(paramMessageRecord, paramMsgBackupResEntity);
    localaucn.jdField_a_of_type_Boolean = true;
    return localaucn;
  }
  ...
  public boolean a(MessageRecord paramMessageRecord)
  {
    if ((paramMessageRecord instanceof ChatMessage)) {
      return aule.a((ChatMessage)paramMessageRecord);
    }
    return false;
  }
