...
public class svs
{
  public static void a(ArticleInfo paramArticleInfo, FastWebArticleInfo paramFastWebArticleInfo, FastWebActivity paramFastWebActivity, JSONObject paramJSONObject, List<BaseData> paramList, ArrayList<String> paramArrayList)
  {
    ...
    try
    {
          ...
          if (bool) {
            try
            {
              ...
              if (((ProteusItemData)localObject).u == 2) {
                paramArrayList.add(pay.f(((ProteusItemData)localObject).c.getString("articleImageUrl")));
              }
            }
      ...
      beqn.a(paramFastWebActivity, paramArrayList.indexOf(pay.f(paramJSONObject)), paramArrayList, null, null, false, true, "4", 1000, null, null, null, null, "", true);
    }
    ...
    {
      swy.a(paramArticleInfo, "0X8008996", pay.a(paramFastWebActivity, paramArticleInfo, 0, paramFastWebArticleInfo).toString());
      return;
    }
  }
  ...
  public static boolean a(JSONObject paramJSONObject, String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      try
      {
        i = svv.a(BaseApplicationImpl.getContext());
