  ...
  extends BaseAdapter
{
  ...
  public ayzf(List<ParagraphInfo> paramList, Set<Integer> paramSet)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      localView = LayoutInflater.from(paramViewGroup.getContext()).inflate(2131494797, paramViewGroup, false);
    }
    Object localObject1 = (CheckBox)localView.findViewById(2131298633);
    paramView = (TextView)localView.findViewById(2131312289);
    ...
    ((SpannableString)localObject2).setSpan(new azme(paramViewGroup.getContext(), paramViewGroup.getContext().getResources().getColor(2131101332), 17, 4, 3, 12, Color.parseColor("#777777"), (String)localObject1), 0, ((String)localObject1).length(), 33);
