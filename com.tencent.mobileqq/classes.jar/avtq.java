...
public class avtq
{
  ...
  public static String a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      if (paramInt3 == 3) {
        return anni.a(2131693252);
      }
      if (paramInt3 == 2) {
        return anni.a(2131693261);
      }
      if (paramInt3 == 1) {
        return anni.a(2131693273);
      }
      return anni.a(2131693269);
    }
    if (paramInt2 > 1) {
      return paramInt2 + anni.a(2131693267);
    }
    if (paramInt2 == 1) {
      return paramInt2 + anni.a(2131693283);
    }
    return anni.a(2131693269);
  }
  ...
  public static String a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, String paramString2)
  {
    ...
    if (paramInt == 2) {
      str = bglf.a(paramQQAppInterface, paramString2);
    }
    for (;;)
    {
      ...
      break;
      if (paramInt == 1) {
        str = bglf.h(paramQQAppInterface, paramString1, paramString2);
      }
    }
  }
  ...
  public static void a(Activity paramActivity, int paramInt, String paramString)
  {
    ...
    localIntent.putExtra("url", bkgj.a(bkgj.a(bkgj.a(bkgj.a(QzoneConfig.getInstance().getConfig("H5Url", "YQHMusicPersonalPlayerUrl", "https://zb.vip.qq.com/v2/musicTheme"), "uin", paramString), "uinType", String.valueOf(paramInt)), "type", "2"), "_wv", "5123"));
    paramActivity.startActivity(localIntent);
    bcst.b(null, "dc00898", "", "", "qq_vip", "0X800A5C2", 1, 0, "", "", VipUtils.a((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime()), "");
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Activity paramActivity, int paramInt, String paramString)
  {
    ...
    paramQQAppInterface.putExtra("url", bkgj.a(bkgj.a(bkgj.a(bkgj.a("https://web.qun.qq.com/qunmusic/listener", "uin", paramString), "uinType", String.valueOf(paramInt)), "_wwv", "128"), "_wv", "2"));
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt1, String paramString, int paramInt2)
  {
    ...
    for (boolean bool = ((TroopInfo)localObject).isAdmin();; bool = false)
    {
      if (!bool)
      {
        ...
        {
          QQToast.a(BaseApplication.getContext(), 2131693264, 0).a();
          return;
        }
  ...
  {
    if (bdrb.a(paramQQAppInterface).a(paramContext, 1, paramString, paramInt2)) {
      return;
    }
    Intent localIntent = new Intent(paramContext, QQBrowserActivity.class);
    String str2 = bkgj.a("https://web.qun.qq.com/qunmusic/index", "uin", paramString);
    ...
    if (!TextUtils.isEmpty(str3)) {
      str1 = bkgj.a(str2, "themeId", str3);
    }
    str2 = bkgj.a(str1, "uinType", String.valueOf(paramInt1));
    if (bool)
    {
      str1 = "1";
      str2 = bkgj.a(bkgj.a(bkgj.a(str2, "showlrc", str1), "_wv", "2"), "_wwv", "128");
      if (!localListenTogetherManager.b(paramInt1, paramString)) {
        break label260;
      }
      str1 = "1";
      label160:
      str2 = bkgj.a(bkgj.a(str2, "isJoin", str1), "from", String.valueOf(paramInt2));
    ...
    for (str1 = "1";; str1 = "0")
    {
      localIntent.putExtra("url", bkgj.a(str2, "isNew", str1));
