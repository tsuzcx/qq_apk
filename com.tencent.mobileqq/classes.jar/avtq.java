...
{
  public static int a;
  private static volatile avtq jdField_a_of_type_Avtq;
  ...
  public avtm a;
  private avtn jdField_a_of_type_Avtn = new avtn(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface);
  private avue jdField_a_of_type_Avue;
  private avwk jdField_a_of_type_Avwk = avwk.a();
  ...
  private avtm b;
  public ConcurrentHashMap<String, avum> b;
  public ConcurrentHashMap<String, avum> c;
  private int d;
  public ConcurrentHashMap<Long, avwq> d;
  ...
  public ConcurrentHashMap<Long, avwq> e;
  private int f;
  public ConcurrentHashMap<Long, avun> f;
  public ConcurrentHashMap<Long, avun> g;
  ...
  private avtq()
  {
    ...
    this.jdField_a_of_type_Avtg = new avtr(this);
    this.jdField_b_of_type_Avtm = new avtt(this);
  ...
  {
    if (jdField_a_of_type_Avtq == null) {}
    try
    {
      if (jdField_a_of_type_Avtq == null) {
        jdField_a_of_type_Avtq = new avtq();
      }
      return jdField_a_of_type_Avtq;
    }
    finally {}
  }
  ...
  private void a(int paramInt)
  {
    ...
    if (paramInt == 6) {
      if (this.jdField_a_of_type_Avti != null) {
        this.jdField_a_of_type_Avti.a();
      }
    }
    while (paramInt != 20) {
      return;
  ...
  private void a(avua paramavua)
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      QLog.d("MsgBackup.BackupAndMigrateManager", 2, "processPush0x11aSucc: client ip = " + paramavua + ", udpport = " + k + ", tcpport = " + j);
    }
    Object localObject = a();
    ((avwk)localObject).d(str1);
    a().b(str2);
    a().a(i);
    ((avwk)localObject).b(paramavua);
    ((avwk)localObject).b(j);
    ((avwk)localObject).a(k);
    if (i == 1)
    {
      ((avwk)localObject).g(2);
      ((avwk)localObject).f(2);
    }
    for (;;)
    {
      paramavua = new Intent();
      if (BaseActivity.sTopActivity != null) {
        break;
      }
      avwu.a("MsgBackup.BackupAndMigrateManager", "activity is null! please check whether is assigned!", new Object[0]);
      return;
      if (i == 2)
      {
        ((avwk)localObject).g(1);
        ((avwk)localObject).f(1);
      }
    }
    PublicFragmentActivity.a(BaseActivity.sTopActivity, paramavua, MsgBackupPCConfirmFragment.class, 1000);
  }
  ...
  public avtf a()
  {
    if (this.jdField_a_of_type_Avtf == null) {
      this.jdField_a_of_type_Avtf = avtf.a();
    }
    return this.jdField_a_of_type_Avtf;
  }
  
  public avue a()
  {
    return this.jdField_a_of_type_Avue;
  }
  
  public avwk a()
  {
    if (this.jdField_a_of_type_Avwk == null) {
      this.jdField_a_of_type_Avwk = avwk.a();
    }
    return this.jdField_a_of_type_Avwk;
  }
  ...
  public void a(int paramInt, avtw paramavtw, Object paramObject)
  {
    if (paramavtw.jdField_a_of_type_Int == 0) {}
    while (paramavtw.jdField_a_of_type_Int != 2) {
      return;
    }
  }
  ...
  {
    this.jdField_a_of_type_Avwk.a(this.jdField_e_of_type_JavaLangString, paramInt, paramString);
  }
  ...
  public void a(long paramLong, int paramInt1, int paramInt2, BaseActivity paramBaseActivity)
  {
    ...
    for (;;)
    {
      localMessage.obj = String.format(str1, new Object[] { str2, avwu.a(paramLong) + "B/s" });
      localMessage.arg1 = paramInt2;
      avtf.a().a(paramInt2);
      localMqqHandler.sendMessage(localMessage);
      avwk.a().a(null);
      avwk.a().a(this.jdField_b_of_type_Avtm);
      a(paramBaseActivity);
  ...
  public void a(avtw paramavtw)
  {
    ...
    paramavtw.jdField_a_of_type_Avtk = this;
    this.jdField_a_of_type_Avtn.a(paramavtw, 10000);
  }
  
  public void a(avtw paramavtw, Object paramObject)
  {
    if (paramavtw.jdField_a_of_type_Int == 0) {
      if ((paramObject != null) && ((paramObject instanceof avum)))
      {
        paramavtw = (avum)paramObject;
        paramObject = new File(avwu.a(paramavtw.jdField_a_of_type_JavaLangString, avwu.b(paramavtw.jdField_a_of_type_Int), paramavtw.jdField_b_of_type_JavaLangString));
    ...
    label72:
    while ((paramavtw.jdField_a_of_type_Int != 2) || (this.jdField_a_of_type_Avtm == null))
    {
      return;
      paramavtw.jdField_a_of_type_Long = paramObject.length();
      this.jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(avwu.b(paramavtw.jdField_a_of_type_JavaLangString, avwu.b(paramavtw.jdField_a_of_type_Int)), paramavtw);
      if (QLog.isColorLevel()) {
        QLog.d("MsgBackup.BackupAndMigrateManager", 2, "onProgress, db prepared! result = 0, sessionInfo.uin = " + paramavtw.jdField_a_of_type_JavaLangString);
      }
      a().i(257);
      return;
    }
    this.jdField_a_of_type_Avtm.b(paramavtw.jdField_c_of_type_Int + 1, paramavtw.jdField_b_of_type_Int);
  }
  ...
  public void a(avuh paramavuh)
  {
    ...
    int i = paramavuh.a();
    a().a(i);
    paramavuh = paramavuh.a();
    a().a(paramavuh);
    localIntent.putExtra("0x11bpush_extra", paramavuh);
  ...
  {
    if ((paramObject instanceof avua))
    {
  ...
  {
    if (paramString != null) {
      ((avte)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(162)).c(paramString);
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    {
      a().a(i);
      this.jdField_a_of_type_Avwk.a(this.jdField_e_of_type_JavaLangString, paramBoolean);
      return;
      this.jdField_a_of_type_Avue = null;
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.addObserver(this.jdField_a_of_type_Avtg);
    }
  }
  ...
  public void b(avtw paramavtw)
  {
    ...
    paramavtw.jdField_a_of_type_Avtk = this;
    this.jdField_a_of_type_Avtn.a(paramavtw, 10001);
  }
  ...
  public void c(avtw paramavtw)
  {
    ...
    paramavtw.jdField_a_of_type_Avtk = this;
    this.jdField_a_of_type_Avtn.a(paramavtw, -1);
  }
  
  public void d()
  {
    avwu.a("MsgBackup.BackupAndMigrateManager", "onDestory ......", new Object[0]);
    this.jdField_a_of_type_Avwk.b();
    b();
    jdField_b_of_type_Boolean = false;
    this.jdField_a_of_type_Avtn.a();
    avwr.c();
  ...
  public void e()
  {
    this.jdField_a_of_type_Avtn.b();
    jdField_g_of_type_Boolean = false;
    jdField_a_of_type_Avtq = null;
  }
  ...
  public void g()
  {
    ((avte)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(162)).a();
  }
  
  public void h()
  {
    avwu.b("MsgBackup.BackupAndMigrateManager", "sFileMeta = %s", new Object[] { jdField_a_of_type_JavaLangString });
    if (TextUtils.isEmpty(jdField_a_of_type_JavaLangString)) {}
    ((avte)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getBusinessHandler(162)).b(jdField_a_of_type_JavaLangString);
  }
  
  public void i()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.removeObserver(this.jdField_a_of_type_Avtg);
  }
  
  public void j()
  {
    this.jdField_a_of_type_Avwk.a(this.jdField_e_of_type_JavaLangString);
  }
  ...
  public void k()
  {
    ...
    if (this.jdField_a_of_type_MqqAppAppRuntime$InterceptKickListener == null) {
      this.jdField_a_of_type_MqqAppAppRuntime$InterceptKickListener = new avts(this);
    }
