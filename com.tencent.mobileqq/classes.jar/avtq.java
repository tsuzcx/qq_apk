...
public class avtq
{
  private static avtq jdField_a_of_type_Avtq;
  private String jdField_a_of_type_JavaLangString;
  private Map<Integer, ahwv> jdField_a_of_type_JavaUtilMap = new HashMap();
  ...
  private Map<Integer, ahwv> e = new HashMap();
  private Map<Integer, Integer> f = new HashMap();
  
  private avtq()
  {
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(1), new ahwv(960, 720));
    this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(2), new ahwv(960, 720));
  ...
  private void a()
  {
    ...
    for (;;)
    {
      ...
      for (j = arrayOfString2.length - 1;; j = 0)
      {
        ...
        {
          this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(2), new ahwv(arrayOfInt3[i], arrayOfInt2[i]));
          this.jdField_a_of_type_JavaUtilMap.put(Integer.valueOf(1), new ahwv(arrayOfInt3[i], arrayOfInt2[i]));
          this.e.put(Integer.valueOf(2), new ahwv(arrayOfInt3[j], arrayOfInt2[j]));
          this.e.put(Integer.valueOf(1), new ahwv(arrayOfInt3[j], arrayOfInt2[j]));
        }
        if (localObject != null)
        {
  ...
  public ahwv a(int paramInt)
  {
    if (this.jdField_a_of_type_JavaUtilMap.containsKey(Integer.valueOf(paramInt))) {
      return (ahwv)this.jdField_a_of_type_JavaUtilMap.get(Integer.valueOf(paramInt));
    }
    return new ahwv(960, 720);
  }
  
  public ahwv b(int paramInt)
  {
    if (this.e.containsKey(Integer.valueOf(paramInt))) {
      return (ahwv)this.e.get(Integer.valueOf(paramInt));
    }
    return new ahwv(640, 480);
  }
}
