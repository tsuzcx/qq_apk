...
public class rjd
{
  ...
  public static String a(int paramInt, ArticleInfo paramArticleInfo)
  {
    ...
    for (str = b(paramArticleInfo);; str = c(paramArticleInfo)) {
      ...
      } while ((!ppe.g(paramArticleInfo)) && (paramInt != 76));
    }
  }
  ...
  private static String a(ArticleInfo paramArticleInfo)
  {
    ...
    do
    {
      ...
      str = ((rsj)paramArticleInfo.mTopicRecommendFeedsInfo.a.get(0)).b;
  ...
  private static String b(ArticleInfo paramArticleInfo)
  {
    ...
    paramArticleInfo = pjj.k + bhcu.encodeToString(String.valueOf(l1).getBytes(), 2);
  ...
  private static String c(ArticleInfo paramArticleInfo)
  {
    ...
    if (paramArticleInfo.mSocialFeedInfo != null)
    {
      ...
      {
        long l = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rrq.a;
        paramArticleInfo = pjj.g + bhcu.encodeToString(String.valueOf(l).getBytes(), 2);
        localObject = paramArticleInfo;
        if (QLog.isColorLevel())
        {
  ...
  private static String d(ArticleInfo paramArticleInfo)
  {
    ...
    do
    {
      do
      {
        ...
        str1 = pjj.g + bhcu.encodeToString(String.valueOf(l1).getBytes(), 2);
      ...
      l1 = paramArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rqy.a;
      str1 = pjj.g + bhcu.encodeToString(String.valueOf(l1).getBytes(), 2);
      paramArticleInfo = str1;
    } while (!QLog.isColorLevel());
