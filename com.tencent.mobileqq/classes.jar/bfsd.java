  ...
  implements bfpr
{
  ...
  public bfsd(WadlJsBridge paramWadlJsBridge, String paramString)
  {
  ...
  public void a(String paramString)
  {
    ...
    bfrz.a("WadlJsBridge", "##@!JsCheckUpdateCallback onException >>> " + paramString);
  ...
  {
    bfrz.c("WadlJsBridge", "##@checkUpdate(End) onResult()");
    if (!this.jdField_a_of_type_ComTencentOpenWadlWadlJsBridge.hasRight()) {
      return;
    }
