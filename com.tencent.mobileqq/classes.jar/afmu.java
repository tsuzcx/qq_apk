...
public class afmu
  extends akav
{
  public afmu(NotificationView paramNotificationView) {}
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2, List<MessageRecord> paramList)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if (this.a.jdField_a_of_type_Afmp != null)
          {
            this.a.jdField_a_of_type_Afmp.a(this.a.jdField_a_of_type_JavaUtilList);
            ...
            if (this.a.b)
            {
              ...
              this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(ajsf.W, 9000, 0 - aydb.a().a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
              aydb.a().a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 0);
    ...
    paramList = this.a.jdField_a_of_type_AndroidContentContext.getResources().getString(2131719988);
    bcpw.a(this.a.jdField_a_of_type_AndroidContentContext, 1, paramList, 0).b(this.a.a());
  }
