...
public class afmu
{
  ...
  public static void a(@NonNull String paramString1, String paramString2, String paramString3, @NonNull afmv paramafmv)
  {
    if (TextUtils.isEmpty(paramString1))
    {
      paramafmv.queryHasSetNotify(a(4, "params error"), null);
      if (QLog.isColorLevel()) {
    ...
    {
      afnn.b((QQAppInterface)BaseApplicationImpl.getApplication().getRuntime(), paramString1, new afmp(paramafmv, null));
      return;
    }
    paramString1 = a(paramString1, paramString2, paramString3);
    QIPCClientHelper.getInstance().callServer("QQNotifyIPCModule", "query", paramString1, new afmp(paramafmv, null));
  }
}
