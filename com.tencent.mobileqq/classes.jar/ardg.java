  ...
  implements Manager
{
  ...
  private ardj jdField_a_of_type_Ardj;
  ...
  public ardg(QQAppInterface paramQQAppInterface)
  {
  ...
  private static MessageRecord a(String paramString, niv paramniv)
  {
    MessageRecord localMessageRecord = new MessageRecord();
    localMessageRecord.selfuin = paramString;
    localMessageRecord.frienduin = paramniv.jdField_a_of_type_JavaLangString;
    localMessageRecord.senderuin = paramniv.jdField_a_of_type_JavaLangString;
    localMessageRecord.msgtype = -1000;
    localMessageRecord.msg = paramniv.f;
    localMessageRecord.time = paramniv.jdField_c_of_type_Long;
    localMessageRecord.shmsgseq = paramniv.jdField_a_of_type_Short;
    localMessageRecord.msgUid = paramniv.d;
  ...
  private void a()
  {
    ardf.b("installTVKSdk");
    this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_UserInfo = new TVK_UserInfo(a(), "");
    this.jdField_a_of_type_Ardj = new ardj(this, this);
    AppNetConnInfo.registerConnectionChangeReceiver(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_Ardj);
    try
    {
      TVK_SDKMgr.setOnLogListener(new ardh(this));
      ...
      {
        TVK_SDKMgr.installPlugin(this.jdField_a_of_type_AndroidContentContext, new ardi(this));
        return;
      }
      b();
      return;
  ...
  private void a(int paramInt)
  {
    ...
    {
      ardf.b("startVideoDownload queueType:" + paramInt);
      if (this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr == null)
      {
        ardf.b("startVideoDownload cache manager not init!");
        c();
        return;
      }
      if (paramInt <= this.jdField_a_of_type_Int)
      {
        ardf.b("startVideoDownload queue(" + this.jdField_a_of_type_Int + ") already run!");
        return;
      }
    }
    if (this.jdField_a_of_type_Int != 0)
    {
      ardf.b("startVideoDownload break current queue(" + this.jdField_a_of_type_Int + ")!");
    ...
    for (;;)
    {
      ...
      {
        ardf.b("startVideoDownload no task to download");
        c();
        return;
      ...
      else
      {
        ...
        if (!TextUtils.isEmpty(str1)) {
          ...
          {
            i = a(str1);
            ardf.b("startVideoDownload vid:" + str1 + ", cacheState:" + i);
            if (i != 2) {
        ...
        for (;;)
        {
          try
          {
            ...
            ardf.b("startVideoDownload vid:" + str1);
            return;
          }
          catch (IOException localIOException)
          {
            ardf.b("startVideoDownload create tmp file failed for vid:" + str1);
            continue;
          }
          i = bbev.a(BaseApplication.getContext());
          ardf.b("startVideoDownload vid:" + str1 + ", networkType:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mNetworkType + ", curNetType:" + i + ", no valid network, skip to next task");
          b(paramInt);
          continue;
          ...
          b(paramInt);
          continue;
          ardf.b("startVideoDownload vid:" + str1 + ", expireTime:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mExpireTime + ", task expired, clean cache and skip to next task");
          b(paramInt);
          if (a(str1) != 0)
          {
            ThreadManager.executeOnFileThread(new ImaxAdVideoPreloadManager.7(this, str1));
            continue;
            ardf.b("startVideoDownload empty vid, skip to next task");
            b(paramInt);
          }
        }
        switch (paramInt)
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, aukn paramaukn, aktg paramaktg)
  {
    ...
    {
      ardd.a().a(((niv)localObject1).jdField_a_of_type_JavaLangString);
      ardd.a().a((niv)localObject1);
      ...
      paramMessageRecord.saveExtInfoToExtStr("recent_list_advertisement_uin_head_url", ((niv)localObject1).e);
    ...
    else
    {
      while (((Iterator)localObject1).hasNext())
      {
        ...
        paramaukn.b((aukm)localObject2);
        ahpf.b(paramQQAppInterface, ((MessageRecord)localObject2).frienduin, ((MessageRecord)localObject2).istroop);
        localObject3 = paramaktg.a(paramMessageRecord.frienduin, paramMessageRecord.istroop);
        if (localObject3 != null)
        {
          ahnn.a().a(paramMessageRecord.frienduin + "-" + paramMessageRecord.istroop);
          paramaktg.b((RecentUser)localObject3);
        }
  ...
  private void a(List<PAAdPreloadTask> paramList, niv paramniv, niw paramniw)
  {
    ...
    localPAAdPreloadTask.mVideoVid = paramniw.b;
    localPAAdPreloadTask.mMsgId = paramniv.jdField_c_of_type_JavaLangString;
    localPAAdPreloadTask.mSource = 2;
    if (paramniv.jdField_a_of_type_Long > 0L) {}
    for (long l = paramniv.jdField_a_of_type_Long;; l = NetConnInfoCenter.getServerTimeMillis())
    {
      localPAAdPreloadTask.mReceiveTime = l;
      localPAAdPreloadTask.mExpireTime = paramniv.b;
  ...
  private void b()
  {
    ...
    if (localTVK_IProxyFactory != null)
    {
      ...
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setPreloadCallback(new ardk(this, null));
      this.jdField_a_of_type_ComTencentQqliveMediaplayerApiTVK_ICacheMgr.setOnPreLoadCompleteCallback(new ardl(this, null));
    }
  ...
  {
    ardf.b("continueDownload queueType:" + paramInt);
  ...
  {
    ardf.b("clearCacheVideo vid:" + paramString);
    if (!TextUtils.isEmpty(paramString))
    {
  ...
  private void b(niv paramniv)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d("ImaxAdvertisement", 2, "insertToMsgSystem 0xf9 advertisementItem:" + paramniv.jdField_a_of_type_JavaLangString);
    }
    ...
    MessageRecord localMessageRecord = a(str, paramniv);
    localMessageRecord.advertisementItem = paramniv;
    paramniv = new ArrayList();
    paramniv.add(localMessageRecord);
    localQQAppInterface.a().a(paramniv, str, false, true, true);
  ...
  {
    paramString = ardd.a().a(paramString).iterator();
    while (paramString.hasNext())
    {
      niv localniv = (niv)paramString.next();
      b(localniv);
      localniv.jdField_a_of_type_Int = 1;
      ardf.b(a(), localniv.jdField_a_of_type_JavaLangString, localniv.a());
    }
  }
  ...
  private void d()
  {
    if (this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask != null)
    {
      axqw.a(null, "dc00898", "", "", "0X8008F77", "0X8008F77", 0, 0, "", "", this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mVideoVid, String.valueOf(this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mSource));
      return;
    }
    axqw.a(null, "dc00898", "", "", "0X8008F77", "0X8008F77", 0, 0, "", "", "", "");
  }
  ...
  private void d(String paramString)
  {
    ...
    {
      njf.b((String)localObject, paramString);
      return;
    }
  }
  ...
  {
    if (this.jdField_a_of_type_Int == 0) {
      ardf.b("onNetworkChange, no queue is working");
    }
    do
    {
      return;
      if (this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask == null)
      {
        ardf.b("onNetworkChange, no valid task");
        return;
      }
      if (this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.isNetworkValid())
      {
        ardf.b("onNetworkChange, vid:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mVideoVid + ", networkType:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mNetworkType + ", valid network, going on");
        return;
      }
      ardf.b("onNetworkChange, vid:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mVideoVid + ", networkType:" + this.jdField_a_of_type_ComTencentBizPubaccountPersistenceEntityPAAdPreloadTask.mNetworkType + ", invalid network, skip to next task");
  ...
  {
    ardf.b("loadLocalConfigTaskForImax uin:" + paramString);
    Object localObject3 = ardf.a(paramString);
    ??? = new ArrayList();
    Object localObject2 = new ArrayList();
    paramString = a();
    arda.a().b(ardf.a(paramString, "delete_uin_list"));
    Object localObject5;
    if (localObject3 != null)
    {
      ardf.b("loadLocalConfigTaskForImax sp size:" + ((Map)localObject3).size());
      localObject4 = ((Map)localObject3).keySet().iterator();
      while (((Iterator)localObject4).hasNext())
      {
        localObject5 = niv.a((String)((Map)localObject3).get((String)((Iterator)localObject4).next()));
        if (localObject5 != null)
        {
          ardd.a().a((niv)localObject5);
          ((List)???).add(localObject5);
          if ((((niv)localObject5).c()) || (arda.a().a(paramString, ((niv)localObject5).jdField_a_of_type_JavaLangString)))
          {
            ((List)localObject2).add(localObject5);
            if ((((niv)localObject5).jdField_a_of_type_JavaUtilArrayList != null) && (((niv)localObject5).jdField_a_of_type_JavaUtilArrayList.size() > 0))
            {
              localObject5 = ((niv)localObject5).jdField_a_of_type_JavaUtilArrayList.iterator();
              while (((Iterator)localObject5).hasNext()) {
                b(((niw)((Iterator)localObject5).next()).b);
              }
            }
          }
        }
    ...
    {
      localObject5 = ((aktg)localObject4).a(true);
      int i = 0;
      while (i < ((List)localObject5).size())
      {
        RecentUser localRecentUser = (RecentUser)((List)localObject5).get(i);
        niv localniv = ardd.a().b(localRecentUser.uin);
        if ((localRecentUser.getType() == 10005) && (localniv != null))
        {
          ((List)localObject3).add(localniv);
          if ((localniv.c()) || (arda.a().a(paramString, localniv.jdField_a_of_type_JavaLangString)))
          {
            ahnn.a().a(localRecentUser.uin + "-" + localRecentUser.getType());
            ((aktg)localObject4).b(localRecentUser);
            ahpf.b(paramQQAppInterface, localRecentUser.uin, 10005);
    ...
    {
      localObject4 = (niv)paramQQAppInterface.next();
      ardd.a().a((niv)localObject4);
      ardf.b(paramString, ((niv)localObject4).jdField_a_of_type_JavaLangString, ((niv)localObject4).a());
    }
    ardf.b("loadLocalConfigTaskForImax recentImaxAdList:" + ((List)localObject3).size() + " expiredImaxAdList:" + ((List)localObject2).size() + " imaxAdList:" + ((List)???).size());
    paramQQAppInterface = new ArrayList();
    ??? = ((List)???).iterator();
    while (((Iterator)???).hasNext())
    {
      localObject2 = (niv)((Iterator)???).next();
      if ((((niv)localObject2).jdField_a_of_type_JavaUtilArrayList != null) && (((niv)localObject2).jdField_a_of_type_JavaUtilArrayList.size() > 0))
      {
        localObject4 = (niw)((niv)localObject2).jdField_a_of_type_JavaUtilArrayList.get(0);
        if (!((List)localObject3).contains(localObject2)) {
          a(paramQQAppInterface, (niv)localObject2, (niw)localObject4);
        } else if (a(((niw)localObject4).b) != 2) {
          a(paramQQAppInterface, (niv)localObject2, (niw)localObject4);
        }
      }
    }
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      if (paramQQAppInterface.size() > 0)
      {
        ...
        ardf.b("loadLocalConfigTaskForImax taskSize:" + paramQQAppInterface.size());
        ThreadManager.executeOnNetWorkThread(new ImaxAdVideoPreloadManager.3(this));
        arda.a().c(paramString);
        return;
      }
      ardf.b("loadLocalConfigTaskForImax tasklist null");
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    synchronized (this.jdField_a_of_type_JavaLangObject)
    {
      ...
      {
        localPAAdPreloadTask.mMsgId = bdhv.d(localPAAdPreloadTask.mVideoVid);
        localPAAdPreloadTask.mSource = 2;
        ...
        ardf.b("handlePreloadTaskFromMessage msgid:" + localPAAdPreloadTask.mMsgId + ", vid:" + localPAAdPreloadTask.mVideoVid + ", add to queue");
        return;
      }
      ardf.b("handlePreloadTaskFromMessage msgid:" + localPAAdPreloadTask.mMsgId + ", vid:" + localPAAdPreloadTask.mVideoVid + ", exist in queue, ignore");
    }
  }
  ...
  public void a(niv paramniv)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          ardf.b("handlePreloadTaskFromMessage invalid item");
          return;
        }
        ardf.b("handlePreloadTaskFromMessage adItem " + paramniv.jdField_a_of_type_JavaLangString);
        nix localnix = paramniv.jdField_a_of_type_Nix;
        ...
        if (!TextUtils.isEmpty(localniw.b))
        {
          ...
          if (paramniv.jdField_a_of_type_Long > 0L)
          {
            ...
            ardf.b("handlePreloadTaskFromMessage msgid:" + paramniv.jdField_c_of_type_JavaLangString + ", vid:" + localniw.b + ", add to queue");
          }
        }
        else
        {
      ...
      continue;
      label287:
      ardf.b("handlePreloadTaskFromMessage msgid:" + paramniv.jdField_c_of_type_JavaLangString + ", vid:" + localniw.b + ", exist in queue, ignore");
    }
  }
  
  public void a(byte[] paramArrayOfByte, int paramInt)
  {
    ardf.b("processMsg0x210Sub0xfd " + paramInt);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        arda.a().a(paramArrayOfByte);
        ardf.a(a(), "delete_uin_list", arda.a().a());
        ardf.a(a(), "delete_st_" + paramArrayOfByte, String.valueOf(NetConnInfoCenter.getServerTimeMillis()));
        if (this.jdField_a_of_type_JavaLangRefWeakReference.get() != null)
        {
          arda.a().a((QQAppInterface)this.jdField_a_of_type_JavaLangRefWeakReference.get(), paramArrayOfByte);
          return;
        }
      }
  ...
  {
    ardf.b("processMsg0x210Sub0xf9 " + paramInt);
    if (paramArrayOfByte == null)
    {
    ...
    for (;;)
    {
      try
      {
        ...
        paramArrayOfByte = ardf.a(paramArrayOfByte.bytes_zip_AdInfo.get().toByteArray());
        if ((paramArrayOfByte == null) || (paramArrayOfByte.length == 0))
        {
          ardf.b("output == null " + paramInt);
          return;
        }
      }
      catch (Exception paramArrayOfByte)
      ...
      paramArrayOfByte = niv.a((submsgtype0xf9.AdInfo)localObject, paramMsgInfo);
      if (arda.a().a(a(), paramArrayOfByte.jdField_a_of_type_JavaLangString))
      {
        ardf.b("processMsg0x210Sub0xf9 InDeleteFilter mSenderUin " + paramArrayOfByte.jdField_a_of_type_JavaLangString);
        return;
      }
      ardd.a().a(paramArrayOfByte.jdField_a_of_type_JavaLangString);
      ardd.a().a(paramArrayOfByte);
      ardf.b("processMsg0x210Sub0xf9 sp :advertisementItem " + paramArrayOfByte.jdField_a_of_type_JavaLangString);
      ardf.b(a(), paramArrayOfByte.jdField_a_of_type_JavaLangString, paramArrayOfByte.a());
  ...
  public void onDestroy()
  {
    ...
    if (this.jdField_a_of_type_Ardj != null)
    {
      this.jdField_a_of_type_Ardj.a();
      AppNetConnInfo.unregisterNetInfoHandler(this.jdField_a_of_type_Ardj);
      this.jdField_a_of_type_Ardj = null;
    }
