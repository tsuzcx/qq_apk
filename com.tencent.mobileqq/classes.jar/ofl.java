...
public class ofl
  extends ofd<DynamicChannelDataModel>
{
  ...
  protected TemplateBean a(DynamicChannelDataModel paramDynamicChannelDataModel)
  {
    ...
    if ((paramDynamicChannelDataModel.mTemplateBean != null) && (!((rdg)this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext.getTemplateFactory()).a(paramDynamicChannelDataModel.mTemplateBean))) {
    ...
    {
      localJSONObject = off.a(paramDynamicChannelDataModel.proteusData);
      localTemplateBean = off.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyViewProteusVirtualviewCoreVafContext, localJSONObject, ReadInJoyDynamicChannelBaseFragment.a(paramDynamicChannelDataModel.channelID));
  ...
  public void a(ProteusItemView paramProteusItemView, int paramInt1, DynamicChannelDataModel paramDynamicChannelDataModel, VafContext paramVafContext, int paramInt2)
  {
    ...
    if (localObject != null)
    {
      ...
      if (localTemplateBean != null)
      {
        ...
        if (!localTemplateBean.equals(localObject))
        {
          ...
          if (paramDynamicChannelDataModel != null)
          {
            paramDynamicChannelDataModel.setBackgroundDrawable(paramVafContext.getContext().getResources().getDrawable(2130841186));
    ...
    if (localTemplateBean != null) {
      oag.a((Container)localObject, paramDynamicChannelDataModel, localTemplateBean);
    }
    oag.a((Container)localObject, paramVafContext, localTemplateBean);
    beoj.a();
  }
