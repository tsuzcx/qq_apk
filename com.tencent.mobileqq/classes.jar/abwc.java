  ...
  implements abvv
{
  ...
  public abwc(HandlerThread paramHandlerThread)
  {
  ...
  public boolean a(ResultObject paramResultObject, abvw paramabvw)
  {
    if (this.a == null) {
      return false;
    }
    ...
    if (localJSONObject != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localObject3 = new YunYingFileUploadRunnable((URL)localObject2, (String)localObject3, paramabvw, paramResultObject.dbId, this.a);
    ...
    paramResultObject = new JsonUploadRunnable(new URL("http://zhizi.qq.com/json.php"), localJSONObject, paramabvw, paramResultObject.dbId, this.a);
