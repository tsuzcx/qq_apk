  ...
  implements ayww
{
  ...
  public agls(Context paramContext, LocalMediaInfo paramLocalMediaInfo)
  {
  ...
  {
    int i = bbbj.a(paramLocalMediaInfo);
    ...
    if (i == 0) {
      try
      {
        ...
        if ((!paramContext.isInJustDecodeBounds) && (paramContext.needRegionDecode))
        {
          ...
          localaxrl.a(null, "safeDecode", bool, l, paramContext.rawWidth * i, paramOptions, "");
        }
  ...
  public Bitmap a(URL paramURL)
  {
    ...
    int i = aywk.a(localLocalMediaInfo.path);
