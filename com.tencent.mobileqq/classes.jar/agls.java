...
public class agls
{
  ...
  public agls(agln paramagln, Context paramContext, ViewGroup paramViewGroup)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetRelativeLayout.setOnTouchListener(new aglt(this, paramagln));
    this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams = new RelativeLayout.LayoutParams(-1, -1);
    this.jdField_c_of_type_AndroidWidgetRelativeLayout$LayoutParams.topMargin = paramagln.a;
    ...
    this.jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new aglu(this, paramagln);
    this.jdField_a_of_type_JavaLangRunnable = new PhotoListPanel.SwipeUpAndDragListener.GestureHandler.3(this, paramagln);
    this.jdField_b_of_type_JavaLangRunnable = new PhotoListPanel.SwipeUpAndDragListener.GestureHandler.4(this, paramagln);
  }
  ...
  public boolean a(aglk paramaglk, int paramInt)
  {
    this.jdField_a_of_type_Aglk = paramaglk;
    this.jdField_b_of_type_Int = paramInt;
    paramaglk.itemView.getLocationInWindow(this.jdField_c_of_type_ArrayOfInt);
    paramaglk = this.jdField_a_of_type_Aglk.a.getDrawable();
    this.jdField_a_of_type_ComTencentWidgetRoundRectImageView.setImageDrawable(paramaglk);
  ...
  void b()
  {
    ...
    try
    {
      this.jdField_a_of_type_Aglk.itemView.clearAnimation();
