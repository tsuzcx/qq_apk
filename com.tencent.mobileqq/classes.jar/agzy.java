  ...
  implements ahan, View.OnClickListener
{
  ...
  public agzy(QQAppInterface paramQQAppInterface, ahap paramahap, SessionInfo paramSessionInfo, Activity paramActivity)
  {
  ...
  public View a(Object... paramVarArgs)
  {
    ...
    if (this.jdField_a_of_type_AndroidViewView == null)
    {
      ...
      paramVarArgs = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369418);
      if (this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable != null)
      {
        paramVarArgs.setImageDrawable(this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable);
        paramVarArgs = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369421);
        ...
        paramVarArgs.setContentDescription(this.jdField_a_of_type_JavaLangString + alud.a(2131706413));
        paramVarArgs.setOnClickListener(this);
        paramVarArgs = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131369420);
        if (AppSetting.c) {
          paramVarArgs.setContentDescription(alud.a(2131706412));
        }
        paramVarArgs.setOnClickListener(this);
      }
    }
    for (;;)
    {
      for (;;)
      {
        ...
        File localFile = new File(agzz.c);
        if ((localFile != null) && (localFile.exists())) {}
        try
        {
          this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = new BitmapDrawable(this.jdField_a_of_type_AndroidAppActivity.getResources(), bdal.a(agzz.c));
        ...
        catch (Throwable localThrowable)
        {
          for (;;)
          {
            ...
            this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = ((BitmapDrawable)this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130844443));
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    do
    {
      do
      {
        ...
        } while (!(this.jdField_a_of_type_Ahap.a() instanceof agzy));
        this.jdField_a_of_type_Ahap.a();
        return;
      } while (!this.jdField_a_of_type_Ahap.a(this, new Object[0]));
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X800510F", "0X800510F", 0, 0, "" + (paramInt + 1), "", "", "");
  ...
  public void onClick(View paramView)
  {
    ...
    for (;;)
    {
      ...
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005111", "0X8005111", 0, 0, "", "", "", "");
      continue;
      azqs.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005110", "0X8005110", 0, 0, "", "", "", "");
    }
  }
}
