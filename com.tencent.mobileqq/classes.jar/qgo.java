  ...
  implements ViewBase.OnClickListener
{
  ...
  public qgo(ArticleInfo paramArticleInfo, Context paramContext, int paramInt)
  {
  ...
  private long a()
  {
    long l2 = 0L;
    long l1;
    if ((snh.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo)) || (this.jdField_a_of_type_Int == 77) || (this.jdField_a_of_type_Int == 78))
    {
      l1 = l2;
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              do
              {
                do
                {
                  ...
                  if ((!snh.g(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo)) && (this.jdField_a_of_type_Int != 72) && (this.jdField_a_of_type_Int != 74)) {
                    break;
                  }
                  l1 = l2;
                } while (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo == null);
                l1 = l2;
              } while (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rhs == null);
              return this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rhs.jdField_a_of_type_Long;
            ...
            l1 = l2;
          } while (this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rha == null);
          return this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo.mSocialFeedInfo.jdField_a_of_type_Rha.jdField_a_of_type_Long;
          if ((snh.f(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo)) || (this.jdField_a_of_type_Int == 73)) {
            break;
          }
          l1 = l2;
  ...
  private void a()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("feeds_type", pha.a(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
        ...
        if (NetworkState.isWifiConn())
        {
          ...
          localJSONObject.put("feeds_source", pha.d(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
  ...
  public void onClick(ViewBase paramViewBase)
  {
    ...
    if ((paramViewBase != null) && (!paramViewBase.isEmpty()))
    {
      ...
      localBundle.putString("feeds_source", pha.d(this.jdField_a_of_type_ComTencentBizPubaccountReadinjoyStructArticleInfo));
      ...
      aevv.a(this.jdField_a_of_type_AndroidContentContext, localIntent, PublicTransFragmentActivity.class, ReadInjoyFriendsBiuComponentFragment.class);
    }
    a();
    if (QLog.isColorLevel()) {
