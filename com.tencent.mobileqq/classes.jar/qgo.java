...
public class qgo
{
  private static Pattern a = Pattern.compile(bbft.c.pattern() + "|" + bbft.d.pattern(), 2);
  ...
  private static int a(Spannable paramSpannable, int paramInt1, int paramInt2)
  {
    ...
    while (localMatcher.find())
    {
      ...
      paramInt2 += 1;
      paramSpannable.setSpan(new rrd(str), i, j, 0);
    }
    return paramInt2;
  }
  ...
  public static boolean a(Spannable paramSpannable)
  {
    ...
    {
      return false;
      if (bbft.b.matcher(paramSpannable).find())
      {
        Object localObject = (rrd[])paramSpannable.getSpans(0, m, rrd.class);
        int j;
        int n;
        int i;
        ...
        int k = 0;
        localObject = (rrb[])paramSpannable.getSpans(0, m, rrb.class);
        if ((localObject != null) && (localObject.length > 0))
        {
          Arrays.sort((Object[])localObject, new qgp(paramSpannable));
  ...
  public static boolean a(EditText paramEditText, String paramString, boolean paramBoolean1, boolean paramBoolean2, List<SocializeFeedsInfo.BiuCommentInfo> paramList)
  {
    ...
    paramEditText = onf.b(a(localEditable.toString(), str));
    if (TextUtils.isEmpty(paramEditText))
    {
      paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), ""));
      return true;
    }
    rrb[] arrayOfrrb = (rrb[])localEditable.getSpans(0, localEditable.length(), rrb.class);
    if ((arrayOfrrb == null) || (arrayOfrrb.length <= 0))
    {
      if (paramBoolean1) {
        break label650;
      }
    ...
    for (;;)
    {
      paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), axau.a(b((String)localObject + paramEditText, str))));
      return true;
      int m = arrayOfrrb.length;
      Arrays.sort(arrayOfrrb, new qgp(localEditable));
      paramEditText = axau.a(b(localEditable.subSequence(0, localEditable.getSpanStart(arrayOfrrb[0])).toString(), str));
      ...
      if (i < m)
      {
        ...
        if (i == m - 1)
        {
          ...
          paramEditText = "";
          if (j - n > 0) {
            paramEditText = axau.a(b(localEditable.subSequence(n, j).toString(), str));
          }
        ...
        for (;;)
        {
          i += 1;
          break;
          j = localEditable.getSpanStart(arrayOfrrb[(i + 1)]);
          break label372;
          label481:
          ...
          else if ((localObject instanceof rrc))
          {
            paramList.add(new SocializeFeedsInfo.BiuCommentInfo(paramString, Long.valueOf(0L), paramEditText, 3, new SocializeFeedsInfo.JumpInfo(0L, ajya.a(2131716029), ((rrc)localObject).a())));
          }
        }
      }
      return false;
