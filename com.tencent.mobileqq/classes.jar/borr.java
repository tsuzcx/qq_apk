...
public class borr
  extends botu
{
  public borr(@NonNull botw parambotw)
  {
    super(parambotw);
  }
  ...
  public void a(int paramInt, @NonNull bpel parambpel)
  {
    ...
    //   1: iload_1
    //   2: aload_2
    //   3: invokespecial 17	botu:a	(ILbpel;)V
    //   6: invokestatic 22	bpjt:a	()Lbpjt;
    //   9: invokevirtual 26	bpjt:c	()I
    //   12: istore_3
    //   13: iload_3
    //   14: ifgt +4 -> 18
    //   17: return
    //   18: invokestatic 22	bpjt:a	()Lbpjt;
    //   21: iload_3
    //   22: invokevirtual 29	bpjt:a	(I)Ldov/com/qq/im/capture/data/QIMFilterCategoryItem;
    //   25: astore 6
    //   27: invokestatic 22	bpjt:a	()Lbpjt;
    //   30: iload_3
    //   31: invokevirtual 32	bpjt:b	(I)Ldov/com/qq/im/capture/data/QIMFilterCategoryItem;
    //   34: astore 7
    //   36: invokestatic 37	bogd:a	()Lbogd;
    //   39: bipush 8
    //   41: invokevirtual 40	bogd:c	(I)Lbogb;
    //   44: checkcast 42	boje
    //   47: invokevirtual 45	boje:a	()Lcom/tencent/mobileqq/richmedia/capture/data/MusicItemInfo;
    //   50: astore 5
    ...
    //   63: ifnull +97 -> 160
    //   66: aload_2
    //   67: getfield 55	bpel:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   73: ifnonnull +17 -> 90
    //   76: aload_2
    //   77: getfield 55	bpel:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   90: aload_2
    //   91: getfield 55	bpel:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   105: aload_2
    //   106: getfield 55	bpel:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   128: ifne +210 -> 338
    //   131: aload 4
    //   133: getstatic 91	wuc:B	Ljava/lang/String;
    //   136: aload 6
    ...
    //   144: pop
    //   145: aload_2
    //   146: getfield 55	bpel:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   181: ifne +86 -> 267
    //   184: aload_2
    //   185: getfield 55	bpel:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   194: aload_2
    //   195: getfield 55	bpel:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   208: aload_2
    //   209: getfield 55	bpel:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   223: aload_2
    //   224: getfield 55	bpel:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   238: aload_2
    //   239: getfield 55	bpel:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   253: aload 4
    //   255: getstatic 116	wuc:z	Ljava/lang/String;
    //   258: aload 7
    ...
    //   280: ifne +17 -> 297
    //   283: aload 4
    //   285: getstatic 124	wuc:A	Ljava/lang/String;
    //   288: aload 5
    ...
    //   297: aload_0
    //   298: ldc 126
    //   300: invokevirtual 129	borr:a	(Ljava/lang/Class;)Lbotv;
    //   303: checkcast 126	bors
    //   306: astore 5
    //   308: aload 5
    //   310: ifnull +13 -> 323
    //   313: aload 5
    ...
    //   346: ifne -186 -> 160
    //   349: aload 4
    //   351: getstatic 91	wuc:B	Ljava/lang/String;
    //   354: aload 6
    ...
    //   362: pop
    //   363: aload_2
    //   364: getfield 55	bpel:jdField_a_of_type_ComTencentMobileqqTribeTribeVideoPublishParams	Lcom/tencent/mobileqq/tribe/TribeVideoPublishParams;
    ...
    //   388: invokevirtual 153	dov/com/tencent/biz/qqstory/takevideo/doodle/ui/doodle/DoodleLayout:a	()Lbovr;
    //   391: astore 6
    //   393: ldc 155
    //   395: getstatic 158	bogm:b	Ljava/lang/String;
    //   398: invokevirtual 164	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   401: ifeq +16 -> 417
    //   404: aload 6
    //   406: ifnull +25 -> 431
    //   409: aload 6
    //   411: invokevirtual 168	bovr:a	()Z
    //   414: ifne +17 -> 431
    //   417: aload 4
    //   419: getstatic 171	wuc:y	Ljava/lang/String;
    //   422: ldc 172
    //   424: invokestatic 177	anvx:a	(I)Ljava/lang/String;
    ...
    //   449: ifne +14 -> 463
    //   452: aload 4
    //   454: getstatic 181	wuc:x	Ljava/lang/String;
    //   457: aload 5
    ...
    //   472: ldc 187
    //   474: aload 4
    //   476: invokestatic 192	ykq:a	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    //   479: aload_2
    //   480: getfield 195	bpel:jdField_a_of_type_ComTencentBizQqstoryDatabasePublishVideoEntry	Lcom/tencent/biz/qqstory/database/PublishVideoEntry;
    //   483: ldc 197
    //   485: aload 4
