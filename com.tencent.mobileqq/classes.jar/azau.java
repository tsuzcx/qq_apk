  ...
  extends zhu
{
  ...
  {
    paramFromServiceMsg = bjet.a(paramFromServiceMsg.getWupBuffer());
  ...
  {
    paramFromServiceMsg = bjds.a(paramFromServiceMsg.getWupBuffer());
    if (QLog.isColorLevel()) {
  ...
  private byte[] b(ToServiceMsg paramToServiceMsg)
  {
    ...
    return bdpd.a(localUniPacket.encode());
  }
  
  private Object c(FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    paramFromServiceMsg = bjdq.a(paramFromServiceMsg.getWupBuffer());
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      catch (Exception paramToServiceMsg)
      {
        try
        {
          ...
          l3 = l1;
          return new bjet(l3, l2, localInteger.intValue()).encode();
        }
        catch (Exception paramToServiceMsg)
        {
          long l1;
    ...
    for (;;)
    {
      ...
      catch (Exception paramToServiceMsg)
      {
        try
        {
          l2 = Long.parseLong(paramToServiceMsg.getUin());
          l3 = l1;
          return new bjdq(l3, l2, str1, localLong).encode();
        }
        catch (Exception paramToServiceMsg)
        {
          long l1;
    ...
    for (;;)
    {
      ...
      catch (Exception paramToServiceMsg)
      {
        try
        {
          l2 = Long.parseLong(paramToServiceMsg.getUin());
          l3 = l1;
          return new bjds(l3, l2, str1).encode();
        }
        catch (Exception paramToServiceMsg)
        {
          long l1;
