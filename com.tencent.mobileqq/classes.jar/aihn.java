...
public class aihn
  implements acwb, anqi
{
  private final aihr jdField_a_of_type_Aihr = new aihr(null);
  private Activity jdField_a_of_type_AndroidAppActivity;
  private anqg jdField_a_of_type_Anqg;
  private anun jdField_a_of_type_Anun = new aiho(this);
  private QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private String jdField_a_of_type_JavaLangString;
  private Calendar jdField_a_of_type_JavaUtilCalendar;
  private List<ChatMessage> jdField_a_of_type_JavaUtilList;
  private boolean jdField_a_of_type_Boolean;
  private final aihr jdField_b_of_type_Aihr = new aihr(null);
  private boolean jdField_b_of_type_Boolean;
  private final aihr jdField_c_of_type_Aihr = new aihr(null);
  private boolean jdField_c_of_type_Boolean;
  private final aihr jdField_d_of_type_Aihr = new aihr(null);
  private boolean jdField_d_of_type_Boolean;
  private final aihr jdField_e_of_type_Aihr = new aihr(null);
  private boolean jdField_e_of_type_Boolean;
  private final aihr jdField_f_of_type_Aihr = new aihr(null);
  private boolean jdField_f_of_type_Boolean;
  private boolean g;
  
  public aihn(QQAppInterface paramQQAppInterface, Activity paramActivity, String paramString)
  {
  ...
  private Calendar a()
  {
    return this.jdField_a_of_type_Anqg.a();
  }
  ...
  private List<ChatMessage> a(int paramInt)
  {
    ...
    {
      localObject = this.jdField_a_of_type_Anqg.a();
      if (localObject != null) {
        break label87;
      }
    }
    ...
    if (this.jdField_a_of_type_Anqg.a() == null)
    {
      QLog.e("C2CMsgRoamProxy", 1, "current page date is null, show roam flag: " + this.jdField_a_of_type_Anqg.e());
      return null;
    }
    Object localObject = this.jdField_a_of_type_Anqg.a(paramInt);
    if ((localObject != null) && (((RoamMessagePreloadInfo)localObject).curday != null))
    {
      l1 = SystemClock.uptimeMillis();
      this.jdField_a_of_type_Aihr.a();
      this.jdField_a_of_type_Anqg.a(((RoamMessagePreloadInfo)localObject).curday, null, false, false);
      if (QLog.isColorLevel()) {
        QLog.d("C2CMsgRoamProxy", 2, "getHistorySig wait");
      }
      this.jdField_a_of_type_Aihr.a(30000L);
    ...
    for (;;)
    {
      this.jdField_a_of_type_JavaUtilCalendar = this.jdField_a_of_type_Anqg.a();
    ...
    for (;;)
    {
      ...
      while (localIterator1.hasNext())
      {
        ...
        while (localIterator2.hasNext())
        {
          ...
          if (acwh.a(localMessageRecord, localChatMessage, true)) {
            localArrayList.add(localChatMessage);
          }
        }
      }
      ((List)localObject).removeAll(localArrayList);
      if ((((List)localObject).size() > 0) && (paramMessageRecord != null) && (auxd.a(paramMessageRecord)) && (((ChatMessage)((List)localObject).get(0)).time >= paramMessageRecord.time))
      {
        if (QLog.isColorLevel()) {
  ...
  private void a(int paramInt)
  {
    ...
    RoamDate localRoamDate = this.jdField_a_of_type_Anqg.a().a(this.jdField_a_of_type_JavaLangString, localCalendar.get(1), localCalendar.get(2) + 1);
  ...
  {
    paramQQAppInterface = (anqg)paramQQAppInterface.getManager(92);
  ...
  {
    this.jdField_a_of_type_Anqg.a(paramCalendar.get(1), paramCalendar.get(2), paramCalendar.get(5));
    this.jdField_a_of_type_JavaUtilCalendar = this.jdField_a_of_type_Anqg.a();
  }
    ...
    if ((!this.jdField_a_of_type_Boolean) || (paramBoolean)) {
      try
      {
        if ((!this.jdField_a_of_type_Boolean) || (paramBoolean))
        {
          ...
          this.jdField_a_of_type_Anqg = ((anqg)((QQAppInterface)localObject1).getManager(92));
          this.jdField_a_of_type_Anqg.a(this.jdField_a_of_type_JavaLangString, false);
          localObject1 = Calendar.getInstance();
          ((Calendar)localObject1).setTimeInMillis(NetConnInfoCenter.getServerTimeMillis());
          this.jdField_a_of_type_Anqg.a(((Calendar)localObject1).get(1), ((Calendar)localObject1).get(2), ((Calendar)localObject1).get(5));
          this.jdField_a_of_type_JavaUtilCalendar = this.jdField_a_of_type_Anqg.a();
  ...
  {
    int j = this.jdField_a_of_type_Anqg.b();
    ...
    {
      this.jdField_f_of_type_Aihr.a();
      ((AccountManager)localObject2).refreshDA2(((QQAppInterface)localObject1).getCurrentAccountUin(), new aihq(this));
      this.jdField_f_of_type_Aihr.a(30000L);
      return;
    }
    this.g = false;
    return;
  ...
  private void b(boolean paramBoolean)
  {
    ...
    long l1 = SystemClock.uptimeMillis();
    this.jdField_b_of_type_Aihr.a();
    this.jdField_a_of_type_Anqg.a(paramBoolean);
    this.jdField_b_of_type_Aihr.a(30000L);
    a(3);
    long l2 = SystemClock.uptimeMillis();
    if (QLog.isColorLevel()) {
    ...
    this.jdField_a_of_type_Anqg.c(this.jdField_c_of_type_Boolean);
  }
  ...
  private boolean b()
  {
    ...
    do
    {
      ...
      do
      {
        ...
        b();
        l1 = SystemClock.uptimeMillis();
        bool3 = bgnt.d(BaseApplication.getContext());
        c();
        bool4 = this.jdField_a_of_type_Anqg.h();
        bool1 = bool2;
      } while (!bool3);
      bool1 = bool2;
    } while (!bool4);
  ...
  private void c()
  {
    if (this.jdField_a_of_type_Anqg.i()) {}
    long l1;
    long l2;
    do
    {
      ...
      l1 = SystemClock.uptimeMillis();
      ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).addObserver(this.jdField_a_of_type_Anun);
      VasExtensionHandler localVasExtensionHandler = (VasExtensionHandler)localQQAppInterface.a(71);
      this.jdField_c_of_type_Aihr.a();
  ...
  private void c(int paramInt1, int paramInt2, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.jdField_c_of_type_Boolean = false;
        break;
        QQToast.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131692656), 0).a();
      }
      this.jdField_c_of_type_Boolean = false;
      continue;
  ...
  private void c(boolean paramBoolean)
  {
    ...
    this.jdField_e_of_type_Aihr.a();
    int[] arrayOfInt = new int[1];
    DevlockInfo[] arrayOfDevlockInfo = new DevlockInfo[1];
    asfr.a().a(localQQAppInterface, localQQAppInterface.getCurrentAccountUin(), new aihp(this, l, arrayOfInt, arrayOfDevlockInfo));
    this.jdField_e_of_type_Aihr.a(30000L);
  ...
  private boolean d()
  {
    ...
    localObject = (aopx)((QQAppInterface)localObject).a(59);
    if (localObject != null)
    {
      long l1 = SystemClock.uptimeMillis();
      this.jdField_d_of_type_Aihr.a();
      ((aopx)localObject).a();
      this.jdField_d_of_type_Aihr.a(30000L);
      long l2 = SystemClock.uptimeMillis();
      if (QLog.isColorLevel()) {
  ...
  private void e(int paramInt1, int paramInt2, Object paramObject)
  {
    ...
    if (localObject == null)
    {
      ...
      this.jdField_a_of_type_Aihr.b();
      return;
    }
    localObject = (anqg)((QQAppInterface)localObject).getManager(92);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (i == 0) {
        ((anqg)localObject).a(localCalendar, false);
      }
      switch (paramInt1)
      {
      case 3: 
    ...
    for (;;)
    {
      ((anqg)localObject).e();
      return;
      paramObject = ((anqg)localObject).a();
      if (paramObject != null) {
        QQToast.a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_AndroidAppActivity.getString(2131692658, new Object[] { Integer.valueOf(paramObject.get(2) + 1), Integer.valueOf(paramObject.get(5)) }), 0).a();
      }
    }
    ((anqg)localObject).e();
  }
  ...
  private boolean e()
  {
    Object localObject2 = this.jdField_a_of_type_Anqg.c();
    ...
    if (this.jdField_a_of_type_Anqg.b() == null)
    {
      QLog.e("C2CMsgRoamProxy", 1, "can not get first page date, roam flag: " + this.jdField_a_of_type_Anqg.e());
      return true;
    }
    long l = this.jdField_a_of_type_Anqg.b().getTimeInMillis();
    while (((Calendar)localObject1).getTimeInMillis() >= l)
    {
      int i = ((Calendar)localObject1).get(5);
      localObject2 = this.jdField_a_of_type_Anqg.a().a(this.jdField_a_of_type_JavaLangString, ((Calendar)localObject1).get(1), ((Calendar)localObject1).get(2) + 1);
      if (localObject2 == null)
      {
        if (QLog.isColorLevel()) {
      ...
      {
        this.jdField_a_of_type_Anqg.a(((Calendar)localObject1).get(1), ((Calendar)localObject1).get(2), i);
  ...
  public void a()
  {
    if (this.jdField_a_of_type_Anqg != null)
    {
      ...
      ((BaseActivity)this.jdField_a_of_type_AndroidAppActivity).removeObserver(this.jdField_a_of_type_Anun);
    }
  ...
  public boolean a(String paramString, int paramInt1, int paramInt2, acwr paramacwr, ArrayList<MessageRecord> paramArrayList, MessageRecord paramMessageRecord, long paramLong)
  {
    ...
    if (paramMessageRecord == null)
    {
      ...
      if ((paramMessageRecord != null) && ((this.jdField_a_of_type_Anqg == null) || (!this.jdField_a_of_type_Anqg.e()) || (this.jdField_a_of_type_Anqg.a() != null))) {
        break label116;
      }
    }
    label116:
    ...
    if (a() == null)
    {
      ...
      paramacwr = this.jdField_a_of_type_Anqg.d;
      a(true);
      if (paramacwr == null) {
        break label203;
      }
    ...
    if ((paramMessageRecord != null) && (i == 2)) {
      a(paramString, paramInt1, paramArrayList, paramInt2 - j, l, paramacwr);
    }
