...
public class orx
{
  ...
  public static long a(pdh parampdh)
  {
    if (!a())
    {
    ...
    QLog.d("FeedsPreloadHelper", 1, new Object[] { "updateRequestVersionAndGet, channelID = ", Integer.valueOf(parampdh.b), ", beginSeq = ", Long.valueOf(parampdh.a) });
    if ((parampdh.b == 0) && (parampdh.a == -1L))
    {
  ...
  public static void a()
  {
    ...
    bgmq.a("sp_key_readinjoy_feeds_preload_last_enter_kd_millisecond", Long.valueOf(l));
  }
  ...
  public static boolean a()
  {
    ...
    if (!((Boolean)bgmq.a("sp_key_readinjoy_feeds_preload_switch", Boolean.valueOf(false))).booleanValue())
    {
  ...
  public static boolean a(pdh parampdh)
  {
    if ((parampdh != null) && (a()) && (parampdh.b == 0) && (parampdh.a == -1L))
    {
  ...
  public static boolean a(boolean paramBoolean)
  {
    ...
    long l1 = ((Long)bgmq.a("sp_key_readinjoy_feeds_preload_last_enter_kd_millisecond", Long.valueOf(-1L))).longValue();
    if (l1 == -1L)
    {
    ...
    long l3 = ((Long)bgmq.a("sp_key_readinjoy_feeds_preload_last_enter_kd_day", Long.valueOf(90L))).longValue();
    ...
    l2 = ((Long)bgmq.a("sp_key_readinjoy_feeds_preload_last_preload_millisecond", Long.valueOf(-1L))).longValue();
    if (l2 != -1L)
    {
      l3 = System.currentTimeMillis();
      l1 = ((Long)bgmq.a("sp_key_readinjoy_feeds_preload_interval", Long.valueOf(30L))).longValue();
      l2 = (l3 - l2) / 1000L / 60L;
  ...
  public static void b()
  {
    ...
    bgmq.a("sp_key_readinjoy_feeds_preload_last_preload_millisecond", Long.valueOf(l));
  }
  ...
  public static boolean b(pdh parampdh)
  {
    if (parampdh != null)
    {
      if ((parampdh.i & 0x100) != 0) {}
